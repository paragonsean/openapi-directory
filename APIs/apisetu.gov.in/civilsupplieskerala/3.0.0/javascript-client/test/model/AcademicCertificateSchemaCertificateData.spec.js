...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CivilSuppliesDepartmentKerala.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new CivilSuppliesDepartmentKerala.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(CivilSuppliesDepartmentKerala.AcademicCertificateSchemaCertificateData);
    });
