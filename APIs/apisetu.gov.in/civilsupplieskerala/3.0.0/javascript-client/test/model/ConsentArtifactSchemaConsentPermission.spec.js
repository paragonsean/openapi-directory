...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CivilSuppliesDepartmentKerala.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new CivilSuppliesDepartmentKerala.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(CivilSuppliesDepartmentKerala.ConsentArtifactSchemaConsentPermission);
    });
