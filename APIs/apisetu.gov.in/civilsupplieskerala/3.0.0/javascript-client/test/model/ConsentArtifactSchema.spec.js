...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CivilSuppliesDepartmentKerala.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new CivilSuppliesDepartmentKerala.ConsentArtifactSchema();
      //expect(instance).to.be.a(CivilSuppliesDepartmentKerala.ConsentArtifactSchema);
    });
