...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CivilSuppliesDepartmentKerala.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new CivilSuppliesDepartmentKerala.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(CivilSuppliesDepartmentKerala.ConsentArtifactSchemaConsentUser);
    });
