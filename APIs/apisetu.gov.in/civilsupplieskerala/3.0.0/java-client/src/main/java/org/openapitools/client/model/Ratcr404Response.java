...
public class Ratcr404Response {
  ...
  public Ratcr404Response() {
  }

  public Ratcr404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ratcr404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ratcr404Response ratcr404Response = (Ratcr404Response) o;
    return Objects.equals(this.error, ratcr404Response.error) &&
        Objects.equals(this.errorDescription, ratcr404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ratcr404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ratcr404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ratcr404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ratcr404Response is not found in the empty JSON string", Ratcr404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ratcr404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ratcr404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ratcr404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ratcr404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ratcr404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ratcr404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ratcr404Response>() {
           @Override
           public void write(JsonWriter out, Ratcr404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ratcr404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ratcr404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ratcr404Response
   * @throws IOException if the JSON string is invalid with respect to Ratcr404Response
   */
  public static Ratcr404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ratcr404Response.class);
  }

  /**
   * Convert an instance of Ratcr404Response to an JSON string
   *
   * @return JSON string
   */
