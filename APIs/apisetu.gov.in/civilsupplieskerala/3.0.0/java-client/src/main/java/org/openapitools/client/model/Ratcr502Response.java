...
public class Ratcr502Response {
  ...
  public Ratcr502Response() {
  }

  public Ratcr502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ratcr502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ratcr502Response ratcr502Response = (Ratcr502Response) o;
    return Objects.equals(this.error, ratcr502Response.error) &&
        Objects.equals(this.errorDescription, ratcr502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ratcr502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ratcr502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ratcr502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ratcr502Response is not found in the empty JSON string", Ratcr502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ratcr502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ratcr502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ratcr502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ratcr502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ratcr502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ratcr502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ratcr502Response>() {
           @Override
           public void write(JsonWriter out, Ratcr502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ratcr502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ratcr502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ratcr502Response
   * @throws IOException if the JSON string is invalid with respect to Ratcr502Response
   */
  public static Ratcr502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ratcr502Response.class);
  }

  /**
   * Convert an instance of Ratcr502Response to an JSON string
   *
   * @return JSON string
   */
