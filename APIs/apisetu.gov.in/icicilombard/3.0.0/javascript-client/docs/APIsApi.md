...
```javascript
import IciciLombardGicLtd from 'icici_lombard_gic_ltd_';
let defaultClient = IciciLombardGicLtd.ApiClient.instance;
...
let apiInstance = new IciciLombardGicLtd.APIsApi();
let opts = {
