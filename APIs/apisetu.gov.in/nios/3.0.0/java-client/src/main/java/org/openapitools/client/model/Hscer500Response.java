...
public class Hscer500Response {
  ...
  public Hscer500Response() {
  }

  public Hscer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hscer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hscer500Response hscer500Response = (Hscer500Response) o;
    return Objects.equals(this.error, hscer500Response.error) &&
        Objects.equals(this.errorDescription, hscer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hscer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hscer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hscer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hscer500Response is not found in the empty JSON string", Hscer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hscer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hscer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hscer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hscer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hscer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hscer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hscer500Response>() {
           @Override
           public void write(JsonWriter out, Hscer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hscer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hscer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hscer500Response
   * @throws IOException if the JSON string is invalid with respect to Hscer500Response
   */
  public static Hscer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hscer500Response.class);
  }

  /**
   * Convert an instance of Hscer500Response to an JSON string
   *
   * @return JSON string
   */
