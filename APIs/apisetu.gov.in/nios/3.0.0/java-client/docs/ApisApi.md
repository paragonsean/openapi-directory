...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/nios/v3");
    ...
    HscerRequest hscerRequest = new HscerRequest(); // HscerRequest | Request format
    try {
      apiInstance.hscer(hscerRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    HscerRequest hscerRequest = new HscerRequest(); // HscerRequest | Request format
    try {
      apiInstance.hsmgr(hscerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#hsmgr");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    HscerRequest hscerRequest = new HscerRequest(); // HscerRequest | Request format
    try {
      apiInstance.hvcer(hscerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#hvcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    HscerRequest hscerRequest = new HscerRequest(); // HscerRequest | Request format
    try {
      apiInstance.sscer(hscerRequest);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    HscerRequest hscerRequest = new HscerRequest(); // HscerRequest | Request format
    try {
      apiInstance.ssmgr(hscerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#ssmgr");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    HscerRequest hscerRequest = new HscerRequest(); // HscerRequest | Request format
    try {
      apiInstance.svcer(hscerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#svcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
