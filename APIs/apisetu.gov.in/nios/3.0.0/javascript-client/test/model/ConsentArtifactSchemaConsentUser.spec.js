...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfOpenSchooling.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new NationalInstituteOfOpenSchooling.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(NationalInstituteOfOpenSchooling.ConsentArtifactSchemaConsentUser);
    });
