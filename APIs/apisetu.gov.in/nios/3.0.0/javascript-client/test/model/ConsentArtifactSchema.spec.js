...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfOpenSchooling.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new NationalInstituteOfOpenSchooling.ConsentArtifactSchema();
      //expect(instance).to.be.a(NationalInstituteOfOpenSchooling.ConsentArtifactSchema);
    });
