...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfOpenSchooling.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new NationalInstituteOfOpenSchooling.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(NationalInstituteOfOpenSchooling.AcademicCertificateSchemaCertificateData);
    });
