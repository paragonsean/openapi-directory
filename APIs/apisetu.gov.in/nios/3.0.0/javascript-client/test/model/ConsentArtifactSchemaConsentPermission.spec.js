...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfOpenSchooling.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new NationalInstituteOfOpenSchooling.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(NationalInstituteOfOpenSchooling.ConsentArtifactSchemaConsentPermission);
    });
