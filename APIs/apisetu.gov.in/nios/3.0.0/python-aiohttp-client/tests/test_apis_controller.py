...
async def test_hscer(client):
    ...
    response = await client.request(
        method='POST',
        path='/nios/v3/hscer/certificate',
        headers=headers,
        json=body,
        )
...
async def test_hsmgr(client):
    ...
    response = await client.request(
        method='POST',
        path='/nios/v3/hsmgr/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hvcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/nios/v3/hvcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sscer(client):
    ...
    response = await client.request(
        method='POST',
        path='/nios/v3/sscer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_ssmgr(client):
    ...
    response = await client.request(
        method='POST',
        path='/nios/v3/ssmgr/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_svcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/nios/v3/svcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
