...
/*
 * OAIEgcer_502_response.h
 *
 * 
 */

#ifndef OAIEgcer_502_response_H
#define OAIEgcer_502_response_H
...
class OAIEgcer_502_response : public OAIObject {
public:
    OAIEgcer_502_response();
    OAIEgcer_502_response(QString json);
    ~OAIEgcer_502_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEgcer_502_response)

#endif // OAIEgcer_502_response_H
