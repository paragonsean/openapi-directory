...
/*
 * OAIEgcer_503_response.h
 *
 * 
 */

#ifndef OAIEgcer_503_response_H
#define OAIEgcer_503_response_H
...
class OAIEgcer_503_response : public OAIObject {
public:
    OAIEgcer_503_response();
    OAIEgcer_503_response(QString json);
    ~OAIEgcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEgcer_503_response)

#endif // OAIEgcer_503_response_H
