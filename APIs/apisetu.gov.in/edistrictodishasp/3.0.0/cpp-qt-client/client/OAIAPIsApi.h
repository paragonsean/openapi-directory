...
#include "OAIEgcer_503_response.h"
...
public:
    ...
    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void egcer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());

    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void ewcer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());

    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void incer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());

    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void lhcer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());

    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void obcer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());

    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void rscer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());

    /**
    * @param[in]  oai_egcer_request OAIEgcer_request [optional]
    */
    virtual void shcer(const ::OpenAPI::OptionalParam<OAIEgcer_request> &oai_egcer_request = ::OpenAPI::OptionalParam<OAIEgcer_request>());
...
private:
    ...
    void egcerCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void egcerSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use egcerSignalError() instead")
    void egcerSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void egcerSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use egcerSignalErrorFull() instead")
    void egcerSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void egcerSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
