...
/*
 * OAIEgcer_404_response.h
 *
 * 
 */

#ifndef OAIEgcer_404_response_H
#define OAIEgcer_404_response_H
...
class OAIEgcer_404_response : public OAIObject {
public:
    OAIEgcer_404_response();
    OAIEgcer_404_response(QString json);
    ~OAIEgcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEgcer_404_response)

#endif // OAIEgcer_404_response_H
