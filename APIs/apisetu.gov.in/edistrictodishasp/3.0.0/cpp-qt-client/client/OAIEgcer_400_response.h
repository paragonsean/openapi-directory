...
/*
 * OAIEgcer_400_response.h
 *
 * 
 */

#ifndef OAIEgcer_400_response_H
#define OAIEgcer_400_response_H
...
class OAIEgcer_400_response : public OAIObject {
public:
    OAIEgcer_400_response();
    OAIEgcer_400_response(QString json);
    ~OAIEgcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEgcer_400_response)

#endif // OAIEgcer_400_response_H
