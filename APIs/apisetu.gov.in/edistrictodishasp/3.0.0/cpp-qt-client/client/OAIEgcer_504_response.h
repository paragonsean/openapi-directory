...
/*
 * OAIEgcer_504_response.h
 *
 * 
 */

#ifndef OAIEgcer_504_response_H
#define OAIEgcer_504_response_H
...
class OAIEgcer_504_response : public OAIObject {
public:
    OAIEgcer_504_response();
    OAIEgcer_504_response(QString json);
    ~OAIEgcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEgcer_504_response)

#endif // OAIEgcer_504_response_H
