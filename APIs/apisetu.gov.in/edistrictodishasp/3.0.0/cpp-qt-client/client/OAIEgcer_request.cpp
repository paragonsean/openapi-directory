...
OAIEgcer_request::OAIEgcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEgcer_request::OAIEgcer_request() {
    this->initializeModel();
}

OAIEgcer_request::~OAIEgcer_request() {}

void OAIEgcer_request::initializeModel() {
...
void OAIEgcer_request::fromJson(QString jsonString) {
...
void OAIEgcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIEgcer_request::asJson() const {
...
QJsonObject OAIEgcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIEgcer_request_certificateParameters OAIEgcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIEgcer_request::setCertificateParameters(const OAIEgcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIEgcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIEgcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIEgcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIEgcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIEgcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIEgcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIEgcer_request::getFormat() const {
    return m_format;
}
void OAIEgcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIEgcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIEgcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIEgcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIEgcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIEgcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIEgcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIEgcer_request::isSet() const {
...
bool OAIEgcer_request::isValid() const {
