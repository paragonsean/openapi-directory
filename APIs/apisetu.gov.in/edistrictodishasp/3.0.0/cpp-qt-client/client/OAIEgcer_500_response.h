...
/*
 * OAIEgcer_500_response.h
 *
 * 
 */

#ifndef OAIEgcer_500_response_H
#define OAIEgcer_500_response_H
...
class OAIEgcer_500_response : public OAIObject {
public:
    OAIEgcer_500_response();
    OAIEgcer_500_response(QString json);
    ~OAIEgcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEgcer_500_response)

#endif // OAIEgcer_500_response_H
