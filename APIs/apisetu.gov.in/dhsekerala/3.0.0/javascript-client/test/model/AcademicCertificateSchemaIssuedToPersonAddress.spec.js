...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BoardOfHigherSecondaryExaminationKeralaKerala.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new BoardOfHigherSecondaryExaminationKeralaKerala.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(BoardOfHigherSecondaryExaminationKeralaKerala.AcademicCertificateSchemaIssuedToPersonAddress);
    });
