...
public class Hpcer401Response {
  ...
  public Hpcer401Response() {
  }

  public Hpcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hpcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hpcer401Response hpcer401Response = (Hpcer401Response) o;
    return Objects.equals(this.error, hpcer401Response.error) &&
        Objects.equals(this.errorDescription, hpcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hpcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hpcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hpcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hpcer401Response is not found in the empty JSON string", Hpcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hpcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hpcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hpcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hpcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hpcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hpcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hpcer401Response>() {
           @Override
           public void write(JsonWriter out, Hpcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hpcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hpcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hpcer401Response
   * @throws IOException if the JSON string is invalid with respect to Hpcer401Response
   */
  public static Hpcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hpcer401Response.class);
  }

  /**
   * Convert an instance of Hpcer401Response to an JSON string
   *
   * @return JSON string
   */
