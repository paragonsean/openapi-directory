...
public class Hpcer404Response {
  ...
  public Hpcer404Response() {
  }

  public Hpcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hpcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hpcer404Response hpcer404Response = (Hpcer404Response) o;
    return Objects.equals(this.error, hpcer404Response.error) &&
        Objects.equals(this.errorDescription, hpcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hpcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hpcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hpcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hpcer404Response is not found in the empty JSON string", Hpcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hpcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hpcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hpcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hpcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hpcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hpcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hpcer404Response>() {
           @Override
           public void write(JsonWriter out, Hpcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hpcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hpcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hpcer404Response
   * @throws IOException if the JSON string is invalid with respect to Hpcer404Response
   */
  public static Hpcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hpcer404Response.class);
  }

  /**
   * Convert an instance of Hpcer404Response to an JSON string
   *
   * @return JSON string
   */
