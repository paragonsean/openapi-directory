...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JharsewaEDistrictJharkhand.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new JharsewaEDistrictJharkhand.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(JharsewaEDistrictJharkhand.ConsentArtifactSchemaConsentPermission);
    });
