...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JharsewaEDistrictJharkhand.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new JharsewaEDistrictJharkhand.ConsentArtifactSchema();
      //expect(instance).to.be.a(JharsewaEDistrictJharkhand.ConsentArtifactSchema);
    });
