...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JharsewaEDistrictJharkhand.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new JharsewaEDistrictJharkhand.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(JharsewaEDistrictJharkhand.AcademicCertificateSchemaCertificateData);
    });
