...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JharsewaEDistrictJharkhand.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new JharsewaEDistrictJharkhand.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(JharsewaEDistrictJharkhand.ConsentArtifactSchemaConsentUser);
    });
