...
/*
 * OAICasteCertificateSchema_IssuedBy_Organization_Address.h
 *
 * 
 */

#ifndef OAICasteCertificateSchema_IssuedBy_Organization_Address_H
#define OAICasteCertificateSchema_IssuedBy_Organization_Address_H
...
class OAICasteCertificateSchema_IssuedBy_Organization_Address : public OAIObject {
public:
    OAICasteCertificateSchema_IssuedBy_Organization_Address();
    OAICasteCertificateSchema_IssuedBy_Organization_Address(QString json);
    ~OAICasteCertificateSchema_IssuedBy_Organization_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICasteCertificateSchema_IssuedBy_Organization_Address)

#endif // OAICasteCertificateSchema_IssuedBy_Organization_Address_H
