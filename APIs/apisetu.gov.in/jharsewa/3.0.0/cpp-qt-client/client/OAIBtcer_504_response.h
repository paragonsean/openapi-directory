...
/*
 * OAIBtcer_504_response.h
 *
 * 
 */

#ifndef OAIBtcer_504_response_H
#define OAIBtcer_504_response_H
...
class OAIBtcer_504_response : public OAIObject {
public:
    OAIBtcer_504_response();
    OAIBtcer_504_response(QString json);
    ~OAIBtcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBtcer_504_response)

#endif // OAIBtcer_504_response_H
