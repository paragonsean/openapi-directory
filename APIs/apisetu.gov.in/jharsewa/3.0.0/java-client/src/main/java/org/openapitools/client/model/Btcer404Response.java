...
public class Btcer404Response {
  ...
  public Btcer404Response() {
  }

  public Btcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer404Response btcer404Response = (Btcer404Response) o;
    return Objects.equals(this.error, btcer404Response.error) &&
        Objects.equals(this.errorDescription, btcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer404Response is not found in the empty JSON string", Btcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer404Response>() {
           @Override
           public void write(JsonWriter out, Btcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer404Response
   * @throws IOException if the JSON string is invalid with respect to Btcer404Response
   */
  public static Btcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer404Response.class);
  }

  /**
   * Convert an instance of Btcer404Response to an JSON string
   *
   * @return JSON string
   */
