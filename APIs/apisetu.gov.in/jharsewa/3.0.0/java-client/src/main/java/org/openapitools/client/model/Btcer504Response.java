...
public class Btcer504Response {
  ...
  public Btcer504Response() {
  }

  public Btcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer504Response btcer504Response = (Btcer504Response) o;
    return Objects.equals(this.error, btcer504Response.error) &&
        Objects.equals(this.errorDescription, btcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer504Response is not found in the empty JSON string", Btcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer504Response>() {
           @Override
           public void write(JsonWriter out, Btcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer504Response
   * @throws IOException if the JSON string is invalid with respect to Btcer504Response
   */
  public static Btcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer504Response.class);
  }

  /**
   * Convert an instance of Btcer504Response to an JSON string
   *
   * @return JSON string
   */
