...
public class Btcer400Response {
  ...
  public Btcer400Response() {
  }

  public Btcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer400Response btcer400Response = (Btcer400Response) o;
    return Objects.equals(this.error, btcer400Response.error) &&
        Objects.equals(this.errorDescription, btcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer400Response is not found in the empty JSON string", Btcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer400Response>() {
           @Override
           public void write(JsonWriter out, Btcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer400Response
   * @throws IOException if the JSON string is invalid with respect to Btcer400Response
   */
  public static Btcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer400Response.class);
  }

  /**
   * Convert an instance of Btcer400Response to an JSON string
   *
   * @return JSON string
   */
