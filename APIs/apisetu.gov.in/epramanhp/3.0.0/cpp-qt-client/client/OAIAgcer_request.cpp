...
OAIAgcer_request::OAIAgcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAgcer_request::OAIAgcer_request() {
    this->initializeModel();
}

OAIAgcer_request::~OAIAgcer_request() {}

void OAIAgcer_request::initializeModel() {
...
void OAIAgcer_request::fromJson(QString jsonString) {
...
void OAIAgcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIAgcer_request::asJson() const {
...
QJsonObject OAIAgcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAgcer_request_certificateParameters OAIAgcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIAgcer_request::setCertificateParameters(const OAIAgcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIAgcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIAgcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIAgcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIAgcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIAgcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIAgcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIAgcer_request::getFormat() const {
    return m_format;
}
void OAIAgcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIAgcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIAgcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIAgcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIAgcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIAgcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIAgcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIAgcer_request::isSet() const {
...
bool OAIAgcer_request::isValid() const {
