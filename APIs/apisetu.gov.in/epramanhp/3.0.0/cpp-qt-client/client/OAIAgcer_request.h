...
#ifndef OAIAgcer_request_H
#define OAIAgcer_request_H
...
namespace OpenAPI {
class OAIAgcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIAgcer_request : public OAIObject {
public:
    OAIAgcer_request();
    OAIAgcer_request(QString json);
    ~OAIAgcer_request() override;
    ...
    OAIAgcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIAgcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIAgcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAgcer_request)

#endif // OAIAgcer_request_H
