...
/*
 * OAIAgcer_404_response.h
 *
 * 
 */

#ifndef OAIAgcer_404_response_H
#define OAIAgcer_404_response_H
...
class OAIAgcer_404_response : public OAIObject {
public:
    OAIAgcer_404_response();
    OAIAgcer_404_response(QString json);
    ~OAIAgcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAgcer_404_response)

#endif // OAIAgcer_404_response_H
