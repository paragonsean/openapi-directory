...
OAIAgcer_request Example::create(){
    OAIAgcer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::agcerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::agcerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAgcer_request oai_agcer_request = create(); // OAIAgcer_request | Request format
      apiInstance.agcer(oai_agcer_request);
