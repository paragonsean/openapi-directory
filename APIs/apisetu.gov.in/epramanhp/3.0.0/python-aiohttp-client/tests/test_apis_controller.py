...
async def test_agcer(client):
    """Test case for agcer

    Agriculture/ Agriculturist Certificate
    """
    body = openapi_server.AgcerRequest()
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/agcer/certificate',
        headers=headers,
        json=body,
        )
...
async def test_bacer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/bacer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_bhcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/bhcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_chcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/chcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_dccer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/dccer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_ffcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/ffcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_incer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/incer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_lhcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/lhcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_mncer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/mncer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_obcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/obcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_psprt(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/psprt/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_racer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/racer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_rmcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/rmcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_shcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/epramanhp/v3/shcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
