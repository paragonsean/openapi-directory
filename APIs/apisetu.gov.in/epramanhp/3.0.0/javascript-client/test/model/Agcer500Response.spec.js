...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.Agcer500Response();
  });
  ...
  describe('Agcer500Response', function() {
    it('should create an instance of Agcer500Response', function() {
      // uncomment below and update the code to test Agcer500Response
      //var instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.Agcer500Response();
      //expect(instance).to.be.a(HimachalPradeshDepartmentOfRevenueHimachalPradesh.Agcer500Response);
    });
