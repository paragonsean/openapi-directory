...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.AcademicCertificateSchemaIssuedTo();
  });
  ...
  describe('AcademicCertificateSchemaIssuedTo', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedTo', function() {
      ...
      //var instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.AcademicCertificateSchemaIssuedTo();
      //expect(instance).to.be.a(HimachalPradeshDepartmentOfRevenueHimachalPradesh.AcademicCertificateSchemaIssuedTo);
    });
