...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(HimachalPradeshDepartmentOfRevenueHimachalPradesh.ConsentArtifactSchemaConsentPermission);
    });
