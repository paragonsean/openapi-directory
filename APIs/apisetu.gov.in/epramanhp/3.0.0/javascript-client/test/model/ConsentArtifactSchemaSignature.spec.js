...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.ConsentArtifactSchemaSignature();
  });
  ...
  describe('ConsentArtifactSchemaSignature', function() {
    it('should create an instance of ConsentArtifactSchemaSignature', function() {
      ...
      //var instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.ConsentArtifactSchemaSignature();
      //expect(instance).to.be.a(HimachalPradeshDepartmentOfRevenueHimachalPradesh.ConsentArtifactSchemaSignature);
    });
