...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.AcademicCertificateSchemaCertificateDataExamination();
  });
  ...
  describe('AcademicCertificateSchemaCertificateDataExamination', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateDataExamination', function() {
      ...
      //var instance = new HimachalPradeshDepartmentOfRevenueHimachalPradesh.AcademicCertificateSchemaCertificateDataExamination();
      //expect(instance).to.be.a(HimachalPradeshDepartmentOfRevenueHimachalPradesh.AcademicCertificateSchemaCertificateDataExamination);
    });
