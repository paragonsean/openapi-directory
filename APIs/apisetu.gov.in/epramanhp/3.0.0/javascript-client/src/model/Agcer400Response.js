...
/**
 * The Agcer400Response model module.
 * @module model/Agcer400Response
 * @version 3.0.0
 */
class Agcer400Response {
    /**
     * Constructs a new <code>Agcer400Response</code>.
     * @alias module:model/Agcer400Response
     */
    constructor() { 
        
        Agcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Agcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Agcer400Response} obj Optional instance to populate.
     * @return {module:model/Agcer400Response} The populated <code>Agcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Agcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Agcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Agcer400Response</code>.
     */
...
/**
 * @member {module:model/Agcer400Response.ErrorEnum} error
 */
Agcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Agcer400Response.ErrorDescriptionEnum} errorDescription
 */
Agcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Agcer400Response['ErrorDescriptionEnum'] = {
...
export default Agcer400Response;
