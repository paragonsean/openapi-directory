...
public class Agcer503Response {
  ...
  public Agcer503Response() {
  }

  public Agcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer503Response agcer503Response = (Agcer503Response) o;
    return Objects.equals(this.error, agcer503Response.error) &&
        Objects.equals(this.errorDescription, agcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer503Response is not found in the empty JSON string", Agcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer503Response>() {
           @Override
           public void write(JsonWriter out, Agcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer503Response
   * @throws IOException if the JSON string is invalid with respect to Agcer503Response
   */
  public static Agcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer503Response.class);
  }

  /**
   * Convert an instance of Agcer503Response to an JSON string
   *
   * @return JSON string
   */
