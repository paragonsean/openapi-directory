...
public class Agcer404Response {
  ...
  public Agcer404Response() {
  }

  public Agcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer404Response agcer404Response = (Agcer404Response) o;
    return Objects.equals(this.error, agcer404Response.error) &&
        Objects.equals(this.errorDescription, agcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer404Response is not found in the empty JSON string", Agcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer404Response>() {
           @Override
           public void write(JsonWriter out, Agcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer404Response
   * @throws IOException if the JSON string is invalid with respect to Agcer404Response
   */
  public static Agcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer404Response.class);
  }

  /**
   * Convert an instance of Agcer404Response to an JSON string
   *
   * @return JSON string
   */
