...
public class Agcer401Response {
  ...
  public Agcer401Response() {
  }

  public Agcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer401Response agcer401Response = (Agcer401Response) o;
    return Objects.equals(this.error, agcer401Response.error) &&
        Objects.equals(this.errorDescription, agcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer401Response is not found in the empty JSON string", Agcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer401Response>() {
           @Override
           public void write(JsonWriter out, Agcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer401Response
   * @throws IOException if the JSON string is invalid with respect to Agcer401Response
   */
  public static Agcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer401Response.class);
  }

  /**
   * Convert an instance of Agcer401Response to an JSON string
   *
   * @return JSON string
   */
