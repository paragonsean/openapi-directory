...
public class Agcer500Response {
  ...
  public Agcer500Response() {
  }

  public Agcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer500Response agcer500Response = (Agcer500Response) o;
    return Objects.equals(this.error, agcer500Response.error) &&
        Objects.equals(this.errorDescription, agcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer500Response is not found in the empty JSON string", Agcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer500Response>() {
           @Override
           public void write(JsonWriter out, Agcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer500Response
   * @throws IOException if the JSON string is invalid with respect to Agcer500Response
   */
  public static Agcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer500Response.class);
  }

  /**
   * Convert an instance of Agcer500Response to an JSON string
   *
   * @return JSON string
   */
