...
public class Agcer504Response {
  ...
  public Agcer504Response() {
  }

  public Agcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer504Response agcer504Response = (Agcer504Response) o;
    return Objects.equals(this.error, agcer504Response.error) &&
        Objects.equals(this.errorDescription, agcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer504Response is not found in the empty JSON string", Agcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer504Response>() {
           @Override
           public void write(JsonWriter out, Agcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer504Response
   * @throws IOException if the JSON string is invalid with respect to Agcer504Response
   */
  public static Agcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer504Response.class);
  }

  /**
   * Convert an instance of Agcer504Response to an JSON string
   *
   * @return JSON string
   */
