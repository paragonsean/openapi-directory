...
public class Agcer400Response {
  ...
  public Agcer400Response() {
  }

  public Agcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer400Response agcer400Response = (Agcer400Response) o;
    return Objects.equals(this.error, agcer400Response.error) &&
        Objects.equals(this.errorDescription, agcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer400Response is not found in the empty JSON string", Agcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer400Response>() {
           @Override
           public void write(JsonWriter out, Agcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer400Response
   * @throws IOException if the JSON string is invalid with respect to Agcer400Response
   */
  public static Agcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer400Response.class);
  }

  /**
   * Convert an instance of Agcer400Response to an JSON string
   *
   * @return JSON string
   */
