...
public class Agcer502Response {
  ...
  public Agcer502Response() {
  }

  public Agcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Agcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Agcer502Response agcer502Response = (Agcer502Response) o;
    return Objects.equals(this.error, agcer502Response.error) &&
        Objects.equals(this.errorDescription, agcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Agcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Agcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Agcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Agcer502Response is not found in the empty JSON string", Agcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Agcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Agcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Agcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Agcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Agcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Agcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Agcer502Response>() {
           @Override
           public void write(JsonWriter out, Agcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Agcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Agcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Agcer502Response
   * @throws IOException if the JSON string is invalid with respect to Agcer502Response
   */
  public static Agcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Agcer502Response.class);
  }

  /**
   * Convert an instance of Agcer502Response to an JSON string
   *
   * @return JSON string
   */
