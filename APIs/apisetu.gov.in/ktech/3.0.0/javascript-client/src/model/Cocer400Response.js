...
/**
 * The Cocer400Response model module.
 * @module model/Cocer400Response
 * @version 3.0.0
 */
class Cocer400Response {
    /**
     * Constructs a new <code>Cocer400Response</code>.
     * @alias module:model/Cocer400Response
     */
    constructor() { 
        
        Cocer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Cocer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cocer400Response} obj Optional instance to populate.
     * @return {module:model/Cocer400Response} The populated <code>Cocer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cocer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Cocer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cocer400Response</code>.
     */
...
/**
 * @member {module:model/Cocer400Response.ErrorEnum} error
 */
Cocer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Cocer400Response.ErrorDescriptionEnum} errorDescription
 */
Cocer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Cocer400Response['ErrorDescriptionEnum'] = {
...
export default Cocer400Response;
