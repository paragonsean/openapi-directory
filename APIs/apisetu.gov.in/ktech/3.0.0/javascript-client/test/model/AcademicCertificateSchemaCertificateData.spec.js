...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfItAndBtKarnataka.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new DepartmentOfItAndBtKarnataka.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(DepartmentOfItAndBtKarnataka.AcademicCertificateSchemaCertificateData);
    });
