...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfItAndBtKarnataka.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new DepartmentOfItAndBtKarnataka.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(DepartmentOfItAndBtKarnataka.ConsentArtifactSchemaConsentPermission);
    });
