...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfItAndBtKarnataka.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new DepartmentOfItAndBtKarnataka.ConsentArtifactSchema();
      //expect(instance).to.be.a(DepartmentOfItAndBtKarnataka.ConsentArtifactSchema);
    });
