...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfItAndBtKarnataka.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new DepartmentOfItAndBtKarnataka.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(DepartmentOfItAndBtKarnataka.ConsentArtifactSchemaConsentUser);
    });
