...
public class Cocer400Response {
  ...
  public Cocer400Response() {
  }

  public Cocer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cocer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cocer400Response cocer400Response = (Cocer400Response) o;
    return Objects.equals(this.error, cocer400Response.error) &&
        Objects.equals(this.errorDescription, cocer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cocer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cocer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cocer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cocer400Response is not found in the empty JSON string", Cocer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cocer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cocer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cocer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cocer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cocer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cocer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cocer400Response>() {
           @Override
           public void write(JsonWriter out, Cocer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cocer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cocer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cocer400Response
   * @throws IOException if the JSON string is invalid with respect to Cocer400Response
   */
  public static Cocer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cocer400Response.class);
  }

  /**
   * Convert an instance of Cocer400Response to an JSON string
   *
   * @return JSON string
   */
