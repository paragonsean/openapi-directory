...
public class Cocer503Response {
  ...
  public Cocer503Response() {
  }

  public Cocer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cocer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cocer503Response cocer503Response = (Cocer503Response) o;
    return Objects.equals(this.error, cocer503Response.error) &&
        Objects.equals(this.errorDescription, cocer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cocer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cocer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cocer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cocer503Response is not found in the empty JSON string", Cocer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cocer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cocer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cocer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cocer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cocer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cocer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cocer503Response>() {
           @Override
           public void write(JsonWriter out, Cocer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cocer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cocer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cocer503Response
   * @throws IOException if the JSON string is invalid with respect to Cocer503Response
   */
  public static Cocer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cocer503Response.class);
  }

  /**
   * Convert an instance of Cocer503Response to an JSON string
   *
   * @return JSON string
   */
