...
public class Cocer502Response {
  ...
  public Cocer502Response() {
  }

  public Cocer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cocer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cocer502Response cocer502Response = (Cocer502Response) o;
    return Objects.equals(this.error, cocer502Response.error) &&
        Objects.equals(this.errorDescription, cocer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cocer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cocer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cocer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cocer502Response is not found in the empty JSON string", Cocer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cocer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cocer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cocer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cocer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cocer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cocer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cocer502Response>() {
           @Override
           public void write(JsonWriter out, Cocer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cocer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cocer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cocer502Response
   * @throws IOException if the JSON string is invalid with respect to Cocer502Response
   */
  public static Cocer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cocer502Response.class);
  }

  /**
   * Convert an instance of Cocer502Response to an JSON string
   *
   * @return JSON string
   */
