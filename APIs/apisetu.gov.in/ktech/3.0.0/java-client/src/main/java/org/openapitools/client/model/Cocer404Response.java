...
public class Cocer404Response {
  ...
  public Cocer404Response() {
  }

  public Cocer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cocer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cocer404Response cocer404Response = (Cocer404Response) o;
    return Objects.equals(this.error, cocer404Response.error) &&
        Objects.equals(this.errorDescription, cocer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cocer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cocer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cocer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cocer404Response is not found in the empty JSON string", Cocer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cocer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cocer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cocer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cocer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cocer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cocer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cocer404Response>() {
           @Override
           public void write(JsonWriter out, Cocer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cocer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cocer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cocer404Response
   * @throws IOException if the JSON string is invalid with respect to Cocer404Response
   */
  public static Cocer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cocer404Response.class);
  }

  /**
   * Convert an instance of Cocer404Response to an JSON string
   *
   * @return JSON string
   */
