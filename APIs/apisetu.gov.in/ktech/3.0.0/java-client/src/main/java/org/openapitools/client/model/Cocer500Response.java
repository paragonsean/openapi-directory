...
public class Cocer500Response {
  ...
  public Cocer500Response() {
  }

  public Cocer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cocer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cocer500Response cocer500Response = (Cocer500Response) o;
    return Objects.equals(this.error, cocer500Response.error) &&
        Objects.equals(this.errorDescription, cocer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cocer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cocer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cocer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cocer500Response is not found in the empty JSON string", Cocer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cocer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cocer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cocer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cocer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cocer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cocer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cocer500Response>() {
           @Override
           public void write(JsonWriter out, Cocer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cocer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cocer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cocer500Response
   * @throws IOException if the JSON string is invalid with respect to Cocer500Response
   */
  public static Cocer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cocer500Response.class);
  }

  /**
   * Convert an instance of Cocer500Response to an JSON string
   *
   * @return JSON string
   */
