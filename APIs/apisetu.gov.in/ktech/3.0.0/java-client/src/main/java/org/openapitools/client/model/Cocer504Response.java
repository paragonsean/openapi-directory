...
public class Cocer504Response {
  ...
  public Cocer504Response() {
  }

  public Cocer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cocer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cocer504Response cocer504Response = (Cocer504Response) o;
    return Objects.equals(this.error, cocer504Response.error) &&
        Objects.equals(this.errorDescription, cocer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cocer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cocer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cocer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cocer504Response is not found in the empty JSON string", Cocer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cocer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cocer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cocer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cocer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cocer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cocer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cocer504Response>() {
           @Override
           public void write(JsonWriter out, Cocer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cocer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cocer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cocer504Response
   * @throws IOException if the JSON string is invalid with respect to Cocer504Response
   */
  public static Cocer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cocer504Response.class);
  }

  /**
   * Convert an instance of Cocer504Response to an JSON string
   *
   * @return JSON string
   */
