...
OAICocer_request::OAICocer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICocer_request::OAICocer_request() {
    this->initializeModel();
}

OAICocer_request::~OAICocer_request() {}

void OAICocer_request::initializeModel() {
...
void OAICocer_request::fromJson(QString jsonString) {
...
void OAICocer_request::fromJsonObject(QJsonObject json) {
...
QString OAICocer_request::asJson() const {
...
QJsonObject OAICocer_request::asJsonObject() const {
    QJsonObject obj;
...
OAICocer_request_certificateParameters OAICocer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAICocer_request::setCertificateParameters(const OAICocer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAICocer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAICocer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAICocer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAICocer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAICocer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAICocer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAICocer_request::getFormat() const {
    return m_format;
}
void OAICocer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICocer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAICocer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAICocer_request::getTxnId() const {
    return m_txn_id;
}
void OAICocer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAICocer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAICocer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAICocer_request::isSet() const {
...
bool OAICocer_request::isValid() const {
