...
/*
 * OAIRdcer_500_response.h
 *
 * 
 */

#ifndef OAIRdcer_500_response_H
#define OAIRdcer_500_response_H
...
class OAIRdcer_500_response : public OAIObject {
public:
    OAIRdcer_500_response();
    OAIRdcer_500_response(QString json);
    ~OAIRdcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRdcer_500_response)

#endif // OAIRdcer_500_response_H
