...
OAIRdcer_request::OAIRdcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRdcer_request::OAIRdcer_request() {
    this->initializeModel();
}

OAIRdcer_request::~OAIRdcer_request() {}

void OAIRdcer_request::initializeModel() {
...
void OAIRdcer_request::fromJson(QString jsonString) {
...
void OAIRdcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIRdcer_request::asJson() const {
...
QJsonObject OAIRdcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRdcer_request_certificateParameters OAIRdcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRdcer_request::setCertificateParameters(const OAIRdcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRdcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRdcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRdcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRdcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRdcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRdcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRdcer_request::getFormat() const {
    return m_format;
}
void OAIRdcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRdcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRdcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRdcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIRdcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRdcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRdcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRdcer_request::isSet() const {
...
bool OAIRdcer_request::isValid() const {
