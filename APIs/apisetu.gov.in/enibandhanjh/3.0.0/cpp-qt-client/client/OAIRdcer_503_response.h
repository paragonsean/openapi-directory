...
/*
 * OAIRdcer_503_response.h
 *
 * 
 */

#ifndef OAIRdcer_503_response_H
#define OAIRdcer_503_response_H
...
class OAIRdcer_503_response : public OAIObject {
public:
    OAIRdcer_503_response();
    OAIRdcer_503_response(QString json);
    ~OAIRdcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRdcer_503_response)

#endif // OAIRdcer_503_response_H
