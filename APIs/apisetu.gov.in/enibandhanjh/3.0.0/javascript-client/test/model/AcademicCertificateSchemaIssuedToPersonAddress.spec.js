...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RevenueRegistrationLandReformsDepartmentJharkhand.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new RevenueRegistrationLandReformsDepartmentJharkhand.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(RevenueRegistrationLandReformsDepartmentJharkhand.AcademicCertificateSchemaIssuedToPersonAddress);
    });
