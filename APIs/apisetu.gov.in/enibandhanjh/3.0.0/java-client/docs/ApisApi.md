...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/enibandhanjh/v3");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    RegriiRequest regriiRequest = new RegriiRequest(); // RegriiRequest | Request format
    try {
      apiInstance.regrii(regriiRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#regrii");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    RegriiRequest regriiRequest = new RegriiRequest(); // RegriiRequest | Request format
    try {
      apiInstance.rmcer(regriiRequest);
    } catch (ApiException e) {
