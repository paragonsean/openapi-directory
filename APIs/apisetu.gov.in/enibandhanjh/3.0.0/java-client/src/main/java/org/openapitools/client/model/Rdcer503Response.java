...
public class Rdcer503Response {
  ...
  public Rdcer503Response() {
  }

  public Rdcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rdcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rdcer503Response rdcer503Response = (Rdcer503Response) o;
    return Objects.equals(this.error, rdcer503Response.error) &&
        Objects.equals(this.errorDescription, rdcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rdcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rdcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rdcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rdcer503Response is not found in the empty JSON string", Rdcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rdcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rdcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rdcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rdcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rdcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rdcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rdcer503Response>() {
           @Override
           public void write(JsonWriter out, Rdcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rdcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rdcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rdcer503Response
   * @throws IOException if the JSON string is invalid with respect to Rdcer503Response
   */
  public static Rdcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rdcer503Response.class);
  }

  /**
   * Convert an instance of Rdcer503Response to an JSON string
   *
   * @return JSON string
   */
