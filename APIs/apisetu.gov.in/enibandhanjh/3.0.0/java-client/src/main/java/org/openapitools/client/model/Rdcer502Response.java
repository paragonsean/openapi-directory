...
public class Rdcer502Response {
  ...
  public Rdcer502Response() {
  }

  public Rdcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rdcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rdcer502Response rdcer502Response = (Rdcer502Response) o;
    return Objects.equals(this.error, rdcer502Response.error) &&
        Objects.equals(this.errorDescription, rdcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rdcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rdcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rdcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rdcer502Response is not found in the empty JSON string", Rdcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rdcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rdcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rdcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rdcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rdcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rdcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rdcer502Response>() {
           @Override
           public void write(JsonWriter out, Rdcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rdcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rdcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rdcer502Response
   * @throws IOException if the JSON string is invalid with respect to Rdcer502Response
   */
  public static Rdcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rdcer502Response.class);
  }

  /**
   * Convert an instance of Rdcer502Response to an JSON string
   *
   * @return JSON string
   */
