...
public class Rdcer401Response {
  ...
  public Rdcer401Response() {
  }

  public Rdcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rdcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rdcer401Response rdcer401Response = (Rdcer401Response) o;
    return Objects.equals(this.error, rdcer401Response.error) &&
        Objects.equals(this.errorDescription, rdcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rdcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rdcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rdcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rdcer401Response is not found in the empty JSON string", Rdcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rdcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rdcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rdcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rdcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rdcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rdcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rdcer401Response>() {
           @Override
           public void write(JsonWriter out, Rdcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rdcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rdcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rdcer401Response
   * @throws IOException if the JSON string is invalid with respect to Rdcer401Response
   */
  public static Rdcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rdcer401Response.class);
  }

  /**
   * Convert an instance of Rdcer401Response to an JSON string
   *
   * @return JSON string
   */
