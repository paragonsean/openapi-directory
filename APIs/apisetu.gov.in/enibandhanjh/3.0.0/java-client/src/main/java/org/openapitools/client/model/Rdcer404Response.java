...
public class Rdcer404Response {
  ...
  public Rdcer404Response() {
  }

  public Rdcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rdcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rdcer404Response rdcer404Response = (Rdcer404Response) o;
    return Objects.equals(this.error, rdcer404Response.error) &&
        Objects.equals(this.errorDescription, rdcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rdcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rdcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rdcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rdcer404Response is not found in the empty JSON string", Rdcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rdcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rdcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rdcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rdcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rdcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rdcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rdcer404Response>() {
           @Override
           public void write(JsonWriter out, Rdcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rdcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rdcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rdcer404Response
   * @throws IOException if the JSON string is invalid with respect to Rdcer404Response
   */
  public static Rdcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rdcer404Response.class);
  }

  /**
   * Convert an instance of Rdcer404Response to an JSON string
   *
   * @return JSON string
   */
