...
/**
 * The Cmcer400Response model module.
 * @module model/Cmcer400Response
 * @version 3.0.0
 */
class Cmcer400Response {
    /**
     * Constructs a new <code>Cmcer400Response</code>.
     * @alias module:model/Cmcer400Response
     */
    constructor() { 
        
        Cmcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Cmcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cmcer400Response} obj Optional instance to populate.
     * @return {module:model/Cmcer400Response} The populated <code>Cmcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cmcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Cmcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cmcer400Response</code>.
     */
...
/**
 * @member {module:model/Cmcer400Response.ErrorEnum} error
 */
Cmcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Cmcer400Response.ErrorDescriptionEnum} errorDescription
 */
Cmcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Cmcer400Response['ErrorDescriptionEnum'] = {
...
export default Cmcer400Response;
