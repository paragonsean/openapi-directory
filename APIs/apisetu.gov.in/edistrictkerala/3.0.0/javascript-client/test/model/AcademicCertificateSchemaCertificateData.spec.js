...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EDistrictKeralaKerala.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EDistrictKeralaKerala.AcademicCertificateSchemaCertificateData);
    });
