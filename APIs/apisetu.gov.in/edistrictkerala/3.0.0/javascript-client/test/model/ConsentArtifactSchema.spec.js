...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new EDistrictKeralaKerala.ConsentArtifactSchema();
      //expect(instance).to.be.a(EDistrictKeralaKerala.ConsentArtifactSchema);
    });
