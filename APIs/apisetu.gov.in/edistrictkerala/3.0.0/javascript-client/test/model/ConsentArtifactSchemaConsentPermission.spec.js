...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new EDistrictKeralaKerala.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(EDistrictKeralaKerala.ConsentArtifactSchemaConsentPermission);
    });
