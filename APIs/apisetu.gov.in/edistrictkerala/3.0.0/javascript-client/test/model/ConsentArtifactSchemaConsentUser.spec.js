...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new EDistrictKeralaKerala.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(EDistrictKeralaKerala.ConsentArtifactSchemaConsentUser);
    });
