...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.ConsentArtifactSchemaSignature();
  });
  ...
  describe('ConsentArtifactSchemaSignature', function() {
    it('should create an instance of ConsentArtifactSchemaSignature', function() {
      ...
      //var instance = new EDistrictKeralaKerala.ConsentArtifactSchemaSignature();
      //expect(instance).to.be.a(EDistrictKeralaKerala.ConsentArtifactSchemaSignature);
    });
