...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.CasteCertificateSchemaCertificateData();
  });
  ...
  describe('CasteCertificateSchemaCertificateData', function() {
    it('should create an instance of CasteCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EDistrictKeralaKerala.CasteCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EDistrictKeralaKerala.CasteCertificateSchemaCertificateData);
    });
