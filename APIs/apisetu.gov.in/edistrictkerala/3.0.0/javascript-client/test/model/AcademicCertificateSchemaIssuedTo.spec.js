...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictKeralaKerala.AcademicCertificateSchemaIssuedTo();
  });
  ...
  describe('AcademicCertificateSchemaIssuedTo', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedTo', function() {
      ...
      //var instance = new EDistrictKeralaKerala.AcademicCertificateSchemaIssuedTo();
      //expect(instance).to.be.a(EDistrictKeralaKerala.AcademicCertificateSchemaIssuedTo);
    });
