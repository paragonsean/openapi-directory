...
OAICmcer_request::OAICmcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICmcer_request::OAICmcer_request() {
    this->initializeModel();
}

OAICmcer_request::~OAICmcer_request() {}

void OAICmcer_request::initializeModel() {
...
void OAICmcer_request::fromJson(QString jsonString) {
...
void OAICmcer_request::fromJsonObject(QJsonObject json) {
...
QString OAICmcer_request::asJson() const {
...
QJsonObject OAICmcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAICmcer_request_certificateParameters OAICmcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAICmcer_request::setCertificateParameters(const OAICmcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAICmcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAICmcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAICmcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAICmcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAICmcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAICmcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAICmcer_request::getFormat() const {
    return m_format;
}
void OAICmcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICmcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAICmcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAICmcer_request::getTxnId() const {
    return m_txn_id;
}
void OAICmcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAICmcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAICmcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAICmcer_request::isSet() const {
...
bool OAICmcer_request::isValid() const {
