...
/*
 * OAICmcer_404_response.h
 *
 * 
 */

#ifndef OAICmcer_404_response_H
#define OAICmcer_404_response_H
...
class OAICmcer_404_response : public OAIObject {
public:
    OAICmcer_404_response();
    OAICmcer_404_response(QString json);
    ~OAICmcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICmcer_404_response)

#endif // OAICmcer_404_response_H
