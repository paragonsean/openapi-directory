...
public class Cmcer401Response {
  ...
  public Cmcer401Response() {
  }

  public Cmcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer401Response cmcer401Response = (Cmcer401Response) o;
    return Objects.equals(this.error, cmcer401Response.error) &&
        Objects.equals(this.errorDescription, cmcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer401Response is not found in the empty JSON string", Cmcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer401Response>() {
           @Override
           public void write(JsonWriter out, Cmcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer401Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer401Response
   */
  public static Cmcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer401Response.class);
  }

  /**
   * Convert an instance of Cmcer401Response to an JSON string
   *
   * @return JSON string
   */
