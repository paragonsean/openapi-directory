...
public class Cmcer503Response {
  ...
  public Cmcer503Response() {
  }

  public Cmcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer503Response cmcer503Response = (Cmcer503Response) o;
    return Objects.equals(this.error, cmcer503Response.error) &&
        Objects.equals(this.errorDescription, cmcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer503Response is not found in the empty JSON string", Cmcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer503Response>() {
           @Override
           public void write(JsonWriter out, Cmcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer503Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer503Response
   */
  public static Cmcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer503Response.class);
  }

  /**
   * Convert an instance of Cmcer503Response to an JSON string
   *
   * @return JSON string
   */
