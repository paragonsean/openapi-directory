...
public class Cmcer500Response {
  ...
  public Cmcer500Response() {
  }

  public Cmcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer500Response cmcer500Response = (Cmcer500Response) o;
    return Objects.equals(this.error, cmcer500Response.error) &&
        Objects.equals(this.errorDescription, cmcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer500Response is not found in the empty JSON string", Cmcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer500Response>() {
           @Override
           public void write(JsonWriter out, Cmcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer500Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer500Response
   */
  public static Cmcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer500Response.class);
  }

  /**
   * Convert an instance of Cmcer500Response to an JSON string
   *
   * @return JSON string
   */
