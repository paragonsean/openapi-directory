...
public class Cmcer400Response {
  ...
  public Cmcer400Response() {
  }

  public Cmcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer400Response cmcer400Response = (Cmcer400Response) o;
    return Objects.equals(this.error, cmcer400Response.error) &&
        Objects.equals(this.errorDescription, cmcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer400Response is not found in the empty JSON string", Cmcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer400Response>() {
           @Override
           public void write(JsonWriter out, Cmcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer400Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer400Response
   */
  public static Cmcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer400Response.class);
  }

  /**
   * Convert an instance of Cmcer400Response to an JSON string
   *
   * @return JSON string
   */
