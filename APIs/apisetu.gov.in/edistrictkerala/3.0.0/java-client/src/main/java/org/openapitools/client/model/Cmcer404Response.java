...
public class Cmcer404Response {
  ...
  public Cmcer404Response() {
  }

  public Cmcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer404Response cmcer404Response = (Cmcer404Response) o;
    return Objects.equals(this.error, cmcer404Response.error) &&
        Objects.equals(this.errorDescription, cmcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer404Response is not found in the empty JSON string", Cmcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer404Response>() {
           @Override
           public void write(JsonWriter out, Cmcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer404Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer404Response
   */
  public static Cmcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer404Response.class);
  }

  /**
   * Convert an instance of Cmcer404Response to an JSON string
   *
   * @return JSON string
   */
