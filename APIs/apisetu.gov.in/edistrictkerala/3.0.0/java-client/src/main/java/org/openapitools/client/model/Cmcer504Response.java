...
public class Cmcer504Response {
  ...
  public Cmcer504Response() {
  }

  public Cmcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer504Response cmcer504Response = (Cmcer504Response) o;
    return Objects.equals(this.error, cmcer504Response.error) &&
        Objects.equals(this.errorDescription, cmcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer504Response is not found in the empty JSON string", Cmcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer504Response>() {
           @Override
           public void write(JsonWriter out, Cmcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer504Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer504Response
   */
  public static Cmcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer504Response.class);
  }

  /**
   * Convert an instance of Cmcer504Response to an JSON string
   *
   * @return JSON string
   */
