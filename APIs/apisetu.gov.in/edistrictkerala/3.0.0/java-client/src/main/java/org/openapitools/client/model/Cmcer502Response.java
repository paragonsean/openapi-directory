...
public class Cmcer502Response {
  ...
  public Cmcer502Response() {
  }

  public Cmcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cmcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cmcer502Response cmcer502Response = (Cmcer502Response) o;
    return Objects.equals(this.error, cmcer502Response.error) &&
        Objects.equals(this.errorDescription, cmcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cmcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cmcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cmcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cmcer502Response is not found in the empty JSON string", Cmcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cmcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cmcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cmcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cmcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cmcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cmcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cmcer502Response>() {
           @Override
           public void write(JsonWriter out, Cmcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cmcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cmcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cmcer502Response
   * @throws IOException if the JSON string is invalid with respect to Cmcer502Response
   */
  public static Cmcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cmcer502Response.class);
  }

  /**
   * Convert an instance of Cmcer502Response to an JSON string
   *
   * @return JSON string
   */
