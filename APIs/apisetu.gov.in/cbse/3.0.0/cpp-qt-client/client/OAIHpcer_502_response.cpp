...
OAIHpcer_502_response::OAIHpcer_502_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHpcer_502_response::OAIHpcer_502_response() {
    this->initializeModel();
}

OAIHpcer_502_response::~OAIHpcer_502_response() {}

void OAIHpcer_502_response::initializeModel() {
...
void OAIHpcer_502_response::fromJson(QString jsonString) {
...
void OAIHpcer_502_response::fromJsonObject(QJsonObject json) {
...
QString OAIHpcer_502_response::asJson() const {
...
QJsonObject OAIHpcer_502_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIHpcer_502_response::getError() const {
    return m_error;
}
void OAIHpcer_502_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIHpcer_502_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIHpcer_502_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIHpcer_502_response::getErrorDescription() const {
    return m_error_description;
}
void OAIHpcer_502_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIHpcer_502_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIHpcer_502_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIHpcer_502_response::isSet() const {
...
bool OAIHpcer_502_response::isValid() const {
