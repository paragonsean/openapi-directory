...
OAIHpcer_401_response::OAIHpcer_401_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHpcer_401_response::OAIHpcer_401_response() {
    this->initializeModel();
}

OAIHpcer_401_response::~OAIHpcer_401_response() {}

void OAIHpcer_401_response::initializeModel() {
...
void OAIHpcer_401_response::fromJson(QString jsonString) {
...
void OAIHpcer_401_response::fromJsonObject(QJsonObject json) {
...
QString OAIHpcer_401_response::asJson() const {
...
QJsonObject OAIHpcer_401_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIHpcer_401_response::getError() const {
    return m_error;
}
void OAIHpcer_401_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIHpcer_401_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIHpcer_401_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIHpcer_401_response::getErrorDescription() const {
    return m_error_description;
}
void OAIHpcer_401_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIHpcer_401_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIHpcer_401_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIHpcer_401_response::isSet() const {
...
bool OAIHpcer_401_response::isValid() const {
