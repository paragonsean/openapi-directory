...
OAIHpcer_request_certificateParameters OAIHscer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIHscer_request::setCertificateParameters(const OAIHpcer_request_certificateParameters &certificate_parameters) {
