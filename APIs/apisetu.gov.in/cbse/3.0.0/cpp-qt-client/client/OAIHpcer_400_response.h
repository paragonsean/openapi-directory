...
/*
 * OAIHpcer_400_response.h
 *
 * 
 */

#ifndef OAIHpcer_400_response_H
#define OAIHpcer_400_response_H
...
class OAIHpcer_400_response : public OAIObject {
public:
    OAIHpcer_400_response();
    OAIHpcer_400_response(QString json);
    ~OAIHpcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHpcer_400_response)

#endif // OAIHpcer_400_response_H
