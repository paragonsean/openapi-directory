...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.AcademicCertificateSchemaIssuedBy();
  });
  ...
  describe('AcademicCertificateSchemaIssuedBy', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedBy', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.AcademicCertificateSchemaIssuedBy();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.AcademicCertificateSchemaIssuedBy);
    });
