...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.ConsentArtifactSchemaConsentUser);
    });
