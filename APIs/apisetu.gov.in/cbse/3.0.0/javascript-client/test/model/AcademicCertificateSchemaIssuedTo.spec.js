...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.AcademicCertificateSchemaIssuedTo();
  });
  ...
  describe('AcademicCertificateSchemaIssuedTo', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedTo', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.AcademicCertificateSchemaIssuedTo();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.AcademicCertificateSchemaIssuedTo);
    });
