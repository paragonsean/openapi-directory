...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchemaConsentPurpose();
  });
  ...
  describe('ConsentArtifactSchemaConsentPurpose', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPurpose', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchemaConsentPurpose();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.ConsentArtifactSchemaConsentPurpose);
    });
