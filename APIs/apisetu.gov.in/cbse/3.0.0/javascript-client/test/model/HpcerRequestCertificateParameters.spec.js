...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.HpcerRequestCertificateParameters();
  });
  ...
  describe('HpcerRequestCertificateParameters', function() {
    it('should create an instance of HpcerRequestCertificateParameters', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.HpcerRequestCertificateParameters();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.HpcerRequestCertificateParameters);
    });
