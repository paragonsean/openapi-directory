...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchemaSignature();
  });
  ...
  describe('ConsentArtifactSchemaSignature', function() {
    it('should create an instance of ConsentArtifactSchemaSignature', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchemaSignature();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.ConsentArtifactSchemaSignature);
    });
