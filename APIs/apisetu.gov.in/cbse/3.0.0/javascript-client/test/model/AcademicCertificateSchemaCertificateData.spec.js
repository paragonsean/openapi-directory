...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.AcademicCertificateSchemaCertificateData);
    });
