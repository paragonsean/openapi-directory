...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new CentralBoardOfSecondaryEducation.ConsentArtifactSchema();
      //expect(instance).to.be.a(CentralBoardOfSecondaryEducation.ConsentArtifactSchema);
    });
