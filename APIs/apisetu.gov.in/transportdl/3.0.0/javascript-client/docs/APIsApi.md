# TransportDepartmentDelhi.APIsApi
...
```javascript
import TransportDepartmentDelhi from 'transport_department_delhi';
let defaultClient = TransportDepartmentDelhi.ApiClient.instance;
...
let apiInstance = new TransportDepartmentDelhi.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentDelhi.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentDelhi.RvcerRequest() // RvcerRequest | Request format
};
