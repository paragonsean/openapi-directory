# TransportDepartmentMizoram.APIsApi
...
```javascript
import TransportDepartmentMizoram from 'transport_department_mizoram';
let defaultClient = TransportDepartmentMizoram.ApiClient.instance;
...
let apiInstance = new TransportDepartmentMizoram.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentMizoram.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentMizoram.RvcerRequest() // RvcerRequest | Request format
};
