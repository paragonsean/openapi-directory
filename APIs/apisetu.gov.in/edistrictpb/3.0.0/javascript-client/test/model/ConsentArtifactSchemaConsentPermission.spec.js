...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PunjabStateEGovernanceSocietyPunjab.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new PunjabStateEGovernanceSocietyPunjab.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(PunjabStateEGovernanceSocietyPunjab.ConsentArtifactSchemaConsentPermission);
    });
