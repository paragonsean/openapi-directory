...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PunjabStateEGovernanceSocietyPunjab.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new PunjabStateEGovernanceSocietyPunjab.ConsentArtifactSchema();
      //expect(instance).to.be.a(PunjabStateEGovernanceSocietyPunjab.ConsentArtifactSchema);
    });
