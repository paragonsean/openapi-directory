...
OAIEwcer_request::OAIEwcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEwcer_request::OAIEwcer_request() {
    this->initializeModel();
}

OAIEwcer_request::~OAIEwcer_request() {}

void OAIEwcer_request::initializeModel() {
...
void OAIEwcer_request::fromJson(QString jsonString) {
...
void OAIEwcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIEwcer_request::asJson() const {
...
QJsonObject OAIEwcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIEwcer_request_certificateParameters OAIEwcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIEwcer_request::setCertificateParameters(const OAIEwcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIEwcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIEwcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIEwcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIEwcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIEwcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIEwcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIEwcer_request::getFormat() const {
    return m_format;
}
void OAIEwcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIEwcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIEwcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIEwcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIEwcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIEwcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIEwcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIEwcer_request::isSet() const {
...
bool OAIEwcer_request::isValid() const {
