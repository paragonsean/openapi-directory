...
OAIObcer_request::OAIObcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObcer_request::OAIObcer_request() {
    this->initializeModel();
}

OAIObcer_request::~OAIObcer_request() {}

void OAIObcer_request::initializeModel() {
...
void OAIObcer_request::fromJson(QString jsonString) {
...
void OAIObcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIObcer_request::asJson() const {
...
QJsonObject OAIObcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIObcer_request_certificateParameters OAIObcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIObcer_request::setCertificateParameters(const OAIObcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIObcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIObcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIObcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIObcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIObcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIObcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIObcer_request::getFormat() const {
    return m_format;
}
void OAIObcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIObcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIObcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIObcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIObcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIObcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIObcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIObcer_request::isSet() const {
...
bool OAIObcer_request::isValid() const {
