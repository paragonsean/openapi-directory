...
#ifndef OAIShcer_request_H
#define OAIShcer_request_H
...
namespace OpenAPI {
class OAIShcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIShcer_request : public OAIObject {
public:
    OAIShcer_request();
    OAIShcer_request(QString json);
    ~OAIShcer_request() override;
    ...
    OAIShcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIShcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIShcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShcer_request)

#endif // OAIShcer_request_H
