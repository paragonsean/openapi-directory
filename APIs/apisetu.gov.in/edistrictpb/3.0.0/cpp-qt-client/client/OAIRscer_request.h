...
#ifndef OAIRscer_request_H
#define OAIRscer_request_H
...
namespace OpenAPI {
class OAIRscer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIRscer_request : public OAIObject {
public:
    OAIRscer_request();
    OAIRscer_request(QString json);
    ~OAIRscer_request() override;
    ...
    OAIRscer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIRscer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIRscer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRscer_request)

#endif // OAIRscer_request_H
