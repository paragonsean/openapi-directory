...
OAIRscer_request::OAIRscer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRscer_request::OAIRscer_request() {
    this->initializeModel();
}

OAIRscer_request::~OAIRscer_request() {}

void OAIRscer_request::initializeModel() {
...
void OAIRscer_request::fromJson(QString jsonString) {
...
void OAIRscer_request::fromJsonObject(QJsonObject json) {
...
QString OAIRscer_request::asJson() const {
...
QJsonObject OAIRscer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRscer_request_certificateParameters OAIRscer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRscer_request::setCertificateParameters(const OAIRscer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRscer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRscer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRscer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRscer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRscer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRscer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRscer_request::getFormat() const {
    return m_format;
}
void OAIRscer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRscer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRscer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRscer_request::getTxnId() const {
    return m_txn_id;
}
void OAIRscer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRscer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRscer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRscer_request::isSet() const {
...
bool OAIRscer_request::isValid() const {
