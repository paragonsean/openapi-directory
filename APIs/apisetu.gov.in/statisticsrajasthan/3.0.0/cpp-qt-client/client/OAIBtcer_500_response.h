...
/*
 * OAIBtcer_500_response.h
 *
 * 
 */

#ifndef OAIBtcer_500_response_H
#define OAIBtcer_500_response_H
...
class OAIBtcer_500_response : public OAIObject {
public:
    OAIBtcer_500_response();
    OAIBtcer_500_response(QString json);
    ~OAIBtcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBtcer_500_response)

#endif // OAIBtcer_500_response_H
