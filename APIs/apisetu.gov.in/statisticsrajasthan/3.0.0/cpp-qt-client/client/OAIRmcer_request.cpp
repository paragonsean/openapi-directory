...
OAIRmcer_request::OAIRmcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRmcer_request::OAIRmcer_request() {
    this->initializeModel();
}

OAIRmcer_request::~OAIRmcer_request() {}

void OAIRmcer_request::initializeModel() {
...
void OAIRmcer_request::fromJson(QString jsonString) {
...
void OAIRmcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIRmcer_request::asJson() const {
...
QJsonObject OAIRmcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRmcer_request_certificateParameters OAIRmcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRmcer_request::setCertificateParameters(const OAIRmcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRmcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRmcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRmcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRmcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRmcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRmcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRmcer_request::getFormat() const {
    return m_format;
}
void OAIRmcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRmcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRmcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRmcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIRmcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRmcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRmcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRmcer_request::isSet() const {
...
bool OAIRmcer_request::isValid() const {
