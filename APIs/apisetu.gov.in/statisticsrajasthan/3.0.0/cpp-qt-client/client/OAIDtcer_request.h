...
namespace OpenAPI {
class OAIDtcer_request_certificateParameters;
...
public:
    ...
    OAIDtcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIDtcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIDtcer_request_certificateParameters m_certificate_parameters;
