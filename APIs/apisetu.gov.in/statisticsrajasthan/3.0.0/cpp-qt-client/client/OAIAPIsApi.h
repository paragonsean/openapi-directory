...
public:
    ...
    */
    ...
    /**
    * @param[in]  oai_rmcer_request OAIRmcer_request [optional]
    */
    virtual void rmcer(const ::OpenAPI::OptionalParam<OAIRmcer_request> &oai_rmcer_request = ::OpenAPI::OptionalParam<OAIRmcer_request>());
