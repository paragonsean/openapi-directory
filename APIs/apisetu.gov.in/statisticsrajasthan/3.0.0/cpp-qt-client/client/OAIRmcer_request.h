...
#ifndef OAIRmcer_request_H
#define OAIRmcer_request_H
...
namespace OpenAPI {
class OAIRmcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIRmcer_request : public OAIObject {
public:
    OAIRmcer_request();
    OAIRmcer_request(QString json);
    ~OAIRmcer_request() override;
    ...
    OAIRmcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIRmcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIRmcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRmcer_request)

#endif // OAIRmcer_request_H
