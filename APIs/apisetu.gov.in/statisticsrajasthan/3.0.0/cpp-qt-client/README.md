...
OAIBtcer_request Example::create(){
    OAIBtcer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::btcerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::btcerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIBtcer_request oai_btcer_request = create(); // OAIBtcer_request | Request format
      apiInstance.btcer(oai_btcer_request);
