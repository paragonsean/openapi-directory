...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfEconomicsAndStatisticsCumChiefRegistrarRajasthanRajasthan.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new DirectorateOfEconomicsAndStatisticsCumChiefRegistrarRajasthanRajasthan.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(DirectorateOfEconomicsAndStatisticsCumChiefRegistrarRajasthanRajasthan.AcademicCertificateSchemaIssuedToPersonAddress);
    });
