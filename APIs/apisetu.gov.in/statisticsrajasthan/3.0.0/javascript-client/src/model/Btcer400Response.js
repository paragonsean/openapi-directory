...
/**
 * The Btcer400Response model module.
 * @module model/Btcer400Response
 * @version 3.0.0
 */
class Btcer400Response {
    /**
     * Constructs a new <code>Btcer400Response</code>.
     * @alias module:model/Btcer400Response
     */
    constructor() { 
        
        Btcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Btcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Btcer400Response} obj Optional instance to populate.
     * @return {module:model/Btcer400Response} The populated <code>Btcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Btcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Btcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Btcer400Response</code>.
     */
...
/**
 * @member {module:model/Btcer400Response.ErrorEnum} error
 */
Btcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Btcer400Response.ErrorDescriptionEnum} errorDescription
 */
Btcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Btcer400Response['ErrorDescriptionEnum'] = {
...
export default Btcer400Response;
