...
public class Btcer502Response {
  ...
  public Btcer502Response() {
  }

  public Btcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer502Response btcer502Response = (Btcer502Response) o;
    return Objects.equals(this.error, btcer502Response.error) &&
        Objects.equals(this.errorDescription, btcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer502Response is not found in the empty JSON string", Btcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer502Response>() {
           @Override
           public void write(JsonWriter out, Btcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer502Response
   * @throws IOException if the JSON string is invalid with respect to Btcer502Response
   */
  public static Btcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer502Response.class);
  }

  /**
   * Convert an instance of Btcer502Response to an JSON string
   *
   * @return JSON string
   */
