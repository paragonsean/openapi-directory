...
public class Btcer401Response {
  ...
  public Btcer401Response() {
  }

  public Btcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer401Response btcer401Response = (Btcer401Response) o;
    return Objects.equals(this.error, btcer401Response.error) &&
        Objects.equals(this.errorDescription, btcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer401Response is not found in the empty JSON string", Btcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer401Response>() {
           @Override
           public void write(JsonWriter out, Btcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer401Response
   * @throws IOException if the JSON string is invalid with respect to Btcer401Response
   */
  public static Btcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer401Response.class);
  }

  /**
   * Convert an instance of Btcer401Response to an JSON string
   *
   * @return JSON string
   */
