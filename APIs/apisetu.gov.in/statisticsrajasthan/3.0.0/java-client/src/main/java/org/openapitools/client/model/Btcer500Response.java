...
public class Btcer500Response {
  ...
  public Btcer500Response() {
  }

  public Btcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer500Response btcer500Response = (Btcer500Response) o;
    return Objects.equals(this.error, btcer500Response.error) &&
        Objects.equals(this.errorDescription, btcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer500Response is not found in the empty JSON string", Btcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer500Response>() {
           @Override
           public void write(JsonWriter out, Btcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer500Response
   * @throws IOException if the JSON string is invalid with respect to Btcer500Response
   */
  public static Btcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer500Response.class);
  }

  /**
   * Convert an instance of Btcer500Response to an JSON string
   *
   * @return JSON string
   */
