...
public class ApiClient {
    ...
    private String basePath = "https://apisetu.gov.in/statisticsrajasthan/v3";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apisetu.gov.in/statisticsrajasthan/v3
