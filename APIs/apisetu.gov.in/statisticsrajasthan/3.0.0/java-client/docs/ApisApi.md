...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/statisticsrajasthan/v3");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    DtcerRequest dtcerRequest = new DtcerRequest(); // DtcerRequest | Request format
    try {
      apiInstance.dtcer(dtcerRequest);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    RmcerRequest rmcerRequest = new RmcerRequest(); // RmcerRequest | Request format
    try {
      apiInstance.rmcer(rmcerRequest);
    } catch (ApiException e) {
