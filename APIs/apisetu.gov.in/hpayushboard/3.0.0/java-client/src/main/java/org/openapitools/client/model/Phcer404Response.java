...
public class Phcer404Response {
  ...
  public Phcer404Response() {
  }

  public Phcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer404Response phcer404Response = (Phcer404Response) o;
    return Objects.equals(this.error, phcer404Response.error) &&
        Objects.equals(this.errorDescription, phcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer404Response is not found in the empty JSON string", Phcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer404Response>() {
           @Override
           public void write(JsonWriter out, Phcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer404Response
   * @throws IOException if the JSON string is invalid with respect to Phcer404Response
   */
  public static Phcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer404Response.class);
  }

  /**
   * Convert an instance of Phcer404Response to an JSON string
   *
   * @return JSON string
   */
