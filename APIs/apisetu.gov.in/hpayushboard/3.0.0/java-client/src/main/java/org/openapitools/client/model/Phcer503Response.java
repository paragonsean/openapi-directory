...
public class Phcer503Response {
  ...
  public Phcer503Response() {
  }

  public Phcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer503Response phcer503Response = (Phcer503Response) o;
    return Objects.equals(this.error, phcer503Response.error) &&
        Objects.equals(this.errorDescription, phcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer503Response is not found in the empty JSON string", Phcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer503Response>() {
           @Override
           public void write(JsonWriter out, Phcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer503Response
   * @throws IOException if the JSON string is invalid with respect to Phcer503Response
   */
  public static Phcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer503Response.class);
  }

  /**
   * Convert an instance of Phcer503Response to an JSON string
   *
   * @return JSON string
   */
