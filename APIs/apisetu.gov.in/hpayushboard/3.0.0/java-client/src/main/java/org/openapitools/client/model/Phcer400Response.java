...
public class Phcer400Response {
  ...
  public Phcer400Response() {
  }

  public Phcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer400Response phcer400Response = (Phcer400Response) o;
    return Objects.equals(this.error, phcer400Response.error) &&
        Objects.equals(this.errorDescription, phcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer400Response is not found in the empty JSON string", Phcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer400Response>() {
           @Override
           public void write(JsonWriter out, Phcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer400Response
   * @throws IOException if the JSON string is invalid with respect to Phcer400Response
   */
  public static Phcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer400Response.class);
  }

  /**
   * Convert an instance of Phcer400Response to an JSON string
   *
   * @return JSON string
   */
