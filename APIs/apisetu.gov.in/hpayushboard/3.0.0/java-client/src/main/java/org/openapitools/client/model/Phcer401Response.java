...
public class Phcer401Response {
  ...
  public Phcer401Response() {
  }

  public Phcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer401Response phcer401Response = (Phcer401Response) o;
    return Objects.equals(this.error, phcer401Response.error) &&
        Objects.equals(this.errorDescription, phcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer401Response is not found in the empty JSON string", Phcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer401Response>() {
           @Override
           public void write(JsonWriter out, Phcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer401Response
   * @throws IOException if the JSON string is invalid with respect to Phcer401Response
   */
  public static Phcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer401Response.class);
  }

  /**
   * Convert an instance of Phcer401Response to an JSON string
   *
   * @return JSON string
   */
