...
public class Phcer500Response {
  ...
  public Phcer500Response() {
  }

  public Phcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer500Response phcer500Response = (Phcer500Response) o;
    return Objects.equals(this.error, phcer500Response.error) &&
        Objects.equals(this.errorDescription, phcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer500Response is not found in the empty JSON string", Phcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer500Response>() {
           @Override
           public void write(JsonWriter out, Phcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer500Response
   * @throws IOException if the JSON string is invalid with respect to Phcer500Response
   */
  public static Phcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer500Response.class);
  }

  /**
   * Convert an instance of Phcer500Response to an JSON string
   *
   * @return JSON string
   */
