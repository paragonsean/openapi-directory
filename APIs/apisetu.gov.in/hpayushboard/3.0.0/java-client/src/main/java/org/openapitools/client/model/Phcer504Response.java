...
public class Phcer504Response {
  ...
  public Phcer504Response() {
  }

  public Phcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer504Response phcer504Response = (Phcer504Response) o;
    return Objects.equals(this.error, phcer504Response.error) &&
        Objects.equals(this.errorDescription, phcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer504Response is not found in the empty JSON string", Phcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer504Response>() {
           @Override
           public void write(JsonWriter out, Phcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer504Response
   * @throws IOException if the JSON string is invalid with respect to Phcer504Response
   */
  public static Phcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer504Response.class);
  }

  /**
   * Convert an instance of Phcer504Response to an JSON string
   *
   * @return JSON string
   */
