...
public class Phcer502Response {
  ...
  public Phcer502Response() {
  }

  public Phcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Phcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Phcer502Response phcer502Response = (Phcer502Response) o;
    return Objects.equals(this.error, phcer502Response.error) &&
        Objects.equals(this.errorDescription, phcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Phcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Phcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Phcer502Response is not found in the empty JSON string", Phcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Phcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Phcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Phcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Phcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Phcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Phcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Phcer502Response>() {
           @Override
           public void write(JsonWriter out, Phcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Phcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Phcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Phcer502Response
   * @throws IOException if the JSON string is invalid with respect to Phcer502Response
   */
  public static Phcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Phcer502Response.class);
  }

  /**
   * Convert an instance of Phcer502Response to an JSON string
   *
   * @return JSON string
   */
