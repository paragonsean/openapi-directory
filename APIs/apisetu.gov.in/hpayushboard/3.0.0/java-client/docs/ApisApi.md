...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/hpayushboard/v3");
    ...
    PhcerRequest phcerRequest = new PhcerRequest(); // PhcerRequest | Request format
    try {
      apiInstance.phcer(phcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#phcer");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    RpcerRequest rpcerRequest = new RpcerRequest(); // RpcerRequest | Request format
    try {
      apiInstance.rpcer(rpcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#rpcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
