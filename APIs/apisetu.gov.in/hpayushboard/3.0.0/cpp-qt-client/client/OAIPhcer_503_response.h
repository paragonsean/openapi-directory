...
/*
 * OAIPhcer_503_response.h
 *
 * 
 */

#ifndef OAIPhcer_503_response_H
#define OAIPhcer_503_response_H
...
class OAIPhcer_503_response : public OAIObject {
public:
    OAIPhcer_503_response();
    OAIPhcer_503_response(QString json);
    ~OAIPhcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhcer_503_response)

#endif // OAIPhcer_503_response_H
