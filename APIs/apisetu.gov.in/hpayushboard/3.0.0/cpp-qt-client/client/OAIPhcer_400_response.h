...
/*
 * OAIPhcer_400_response.h
 *
 * 
 */

#ifndef OAIPhcer_400_response_H
#define OAIPhcer_400_response_H
...
class OAIPhcer_400_response : public OAIObject {
public:
    OAIPhcer_400_response();
    OAIPhcer_400_response(QString json);
    ~OAIPhcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhcer_400_response)

#endif // OAIPhcer_400_response_H
