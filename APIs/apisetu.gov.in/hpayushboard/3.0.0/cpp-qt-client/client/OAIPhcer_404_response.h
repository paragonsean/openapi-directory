...
/*
 * OAIPhcer_404_response.h
 *
 * 
 */

#ifndef OAIPhcer_404_response_H
#define OAIPhcer_404_response_H
...
class OAIPhcer_404_response : public OAIObject {
public:
    OAIPhcer_404_response();
    OAIPhcer_404_response(QString json);
    ~OAIPhcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhcer_404_response)

#endif // OAIPhcer_404_response_H
