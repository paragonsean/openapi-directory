...
OAIRpcer_request::OAIRpcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRpcer_request::OAIRpcer_request() {
    this->initializeModel();
}

OAIRpcer_request::~OAIRpcer_request() {}

void OAIRpcer_request::initializeModel() {
...
void OAIRpcer_request::fromJson(QString jsonString) {
...
void OAIRpcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIRpcer_request::asJson() const {
...
QJsonObject OAIRpcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRpcer_request_certificateParameters OAIRpcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRpcer_request::setCertificateParameters(const OAIRpcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRpcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRpcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRpcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRpcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRpcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRpcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRpcer_request::getFormat() const {
    return m_format;
}
void OAIRpcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRpcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRpcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRpcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIRpcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRpcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRpcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRpcer_request::isSet() const {
...
bool OAIRpcer_request::isValid() const {
