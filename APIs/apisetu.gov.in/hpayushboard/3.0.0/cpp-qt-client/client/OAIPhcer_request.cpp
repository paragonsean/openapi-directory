...
OAIPhcer_request::OAIPhcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPhcer_request::OAIPhcer_request() {
    this->initializeModel();
}

OAIPhcer_request::~OAIPhcer_request() {}

void OAIPhcer_request::initializeModel() {
...
void OAIPhcer_request::fromJson(QString jsonString) {
...
void OAIPhcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIPhcer_request::asJson() const {
...
QJsonObject OAIPhcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPhcer_request_certificateParameters OAIPhcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIPhcer_request::setCertificateParameters(const OAIPhcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIPhcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIPhcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIPhcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIPhcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIPhcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIPhcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIPhcer_request::getFormat() const {
    return m_format;
}
void OAIPhcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPhcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPhcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPhcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIPhcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIPhcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIPhcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIPhcer_request::isSet() const {
...
bool OAIPhcer_request::isValid() const {
