...
#ifndef OAIPhcer_request_H
#define OAIPhcer_request_H

#include <QJsonObject>

#include "OAIConsentArtifactSchema.h"
#include "OAIPhcer_request_certificateParameters.h"
#include <QString>
...
namespace OpenAPI {
class OAIPhcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIPhcer_request : public OAIObject {
public:
    OAIPhcer_request();
    OAIPhcer_request(QString json);
    ~OAIPhcer_request() override;
    ...
    OAIPhcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIPhcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIPhcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhcer_request)

#endif // OAIPhcer_request_H
