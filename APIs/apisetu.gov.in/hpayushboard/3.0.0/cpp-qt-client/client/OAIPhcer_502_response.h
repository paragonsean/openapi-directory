...
/*
 * OAIPhcer_502_response.h
 *
 * 
 */

#ifndef OAIPhcer_502_response_H
#define OAIPhcer_502_response_H
...
class OAIPhcer_502_response : public OAIObject {
public:
    OAIPhcer_502_response();
    OAIPhcer_502_response(QString json);
    ~OAIPhcer_502_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhcer_502_response)

#endif // OAIPhcer_502_response_H
