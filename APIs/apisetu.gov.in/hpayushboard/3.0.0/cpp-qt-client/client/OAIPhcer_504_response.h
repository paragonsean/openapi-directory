...
/*
 * OAIPhcer_504_response.h
 *
 * 
 */

#ifndef OAIPhcer_504_response_H
#define OAIPhcer_504_response_H
...
class OAIPhcer_504_response : public OAIObject {
public:
    OAIPhcer_504_response();
    OAIPhcer_504_response(QString json);
    ~OAIPhcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPhcer_504_response)

#endif // OAIPhcer_504_response_H
