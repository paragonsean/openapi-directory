...
/**
 * The Phcer400Response model module.
 * @module model/Phcer400Response
 * @version 3.0.0
 */
class Phcer400Response {
    /**
     * Constructs a new <code>Phcer400Response</code>.
     * @alias module:model/Phcer400Response
     */
    constructor() { 
        
        Phcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Phcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Phcer400Response} obj Optional instance to populate.
     * @return {module:model/Phcer400Response} The populated <code>Phcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Phcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Phcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Phcer400Response</code>.
     */
...
/**
 * @member {module:model/Phcer400Response.ErrorEnum} error
 */
Phcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Phcer400Response.ErrorDescriptionEnum} errorDescription
 */
Phcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Phcer400Response['ErrorDescriptionEnum'] = {
...
export default Phcer400Response;
