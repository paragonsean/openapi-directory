...
OAIDtcer_request_certificateParameters OAIDtcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDtcer_request::setCertificateParameters(const OAIDtcer_request_certificateParameters &certificate_parameters) {
