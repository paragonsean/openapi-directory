...
OAIBtcer_request::OAIBtcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBtcer_request::OAIBtcer_request() {
    this->initializeModel();
}

OAIBtcer_request::~OAIBtcer_request() {}

void OAIBtcer_request::initializeModel() {
...
void OAIBtcer_request::fromJson(QString jsonString) {
...
void OAIBtcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIBtcer_request::asJson() const {
...
QJsonObject OAIBtcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIBtcer_request_certificateParameters OAIBtcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIBtcer_request::setCertificateParameters(const OAIBtcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIBtcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIBtcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIBtcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIBtcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIBtcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIBtcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIBtcer_request::getFormat() const {
    return m_format;
}
void OAIBtcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIBtcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIBtcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIBtcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIBtcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIBtcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIBtcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIBtcer_request::isSet() const {
...
bool OAIBtcer_request::isValid() const {
