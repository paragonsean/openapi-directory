...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GreaterChennaiCorporationTamilNadu.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new GreaterChennaiCorporationTamilNadu.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(GreaterChennaiCorporationTamilNadu.ConsentArtifactSchemaConsentUser);
    });
