# MotorVehicleDepartmentKerala.APIsApi
...
```javascript
import MotorVehicleDepartmentKerala from 'motor_vehicle_department_kerala';
let defaultClient = MotorVehicleDepartmentKerala.ApiClient.instance;
...
let apiInstance = new MotorVehicleDepartmentKerala.APIsApi();
let opts = {
...
let apiInstance = new MotorVehicleDepartmentKerala.APIsApi();
let opts = {
  'rvcerRequest': new MotorVehicleDepartmentKerala.RvcerRequest() // RvcerRequest | Request format
};
