# TransportDepartmentDamanDiu.APIsApi
...
```javascript
import TransportDepartmentDamanDiu from 'transport_department_daman__diu';
let defaultClient = TransportDepartmentDamanDiu.ApiClient.instance;
...
let apiInstance = new TransportDepartmentDamanDiu.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentDamanDiu.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentDamanDiu.RvcerRequest() // RvcerRequest | Request format
};
