# TransportDepartmentBihar.APIsApi
...
```javascript
import TransportDepartmentBihar from 'transport_department_bihar';
let defaultClient = TransportDepartmentBihar.ApiClient.instance;
...
let apiInstance = new TransportDepartmentBihar.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentBihar.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentBihar.RvcerRequest() // RvcerRequest | Request format
};
