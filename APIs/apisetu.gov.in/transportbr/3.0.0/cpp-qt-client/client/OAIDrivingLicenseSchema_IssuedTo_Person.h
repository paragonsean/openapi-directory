...
/*
 * OAIDrivingLicenseSchema_IssuedTo_Person.h
 *
 * 
 */

#ifndef OAIDrivingLicenseSchema_IssuedTo_Person_H
#define OAIDrivingLicenseSchema_IssuedTo_Person_H
...
class OAIDrivingLicenseSchema_IssuedTo_Person : public OAIObject {
public:
    OAIDrivingLicenseSchema_IssuedTo_Person();
    OAIDrivingLicenseSchema_IssuedTo_Person(QString json);
    ~OAIDrivingLicenseSchema_IssuedTo_Person() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDrivingLicenseSchema_IssuedTo_Person)

#endif // OAIDrivingLicenseSchema_IssuedTo_Person_H
