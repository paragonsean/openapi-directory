...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/scvtup/v3");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    SkmstRequest skmstRequest = new SkmstRequest(); // SkmstRequest | Request format
    try {
      apiInstance.skmst(skmstRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#skmst");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
