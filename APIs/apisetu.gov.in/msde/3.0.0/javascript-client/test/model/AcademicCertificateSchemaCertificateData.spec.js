...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.AcademicCertificateSchemaCertificateData);
    });
