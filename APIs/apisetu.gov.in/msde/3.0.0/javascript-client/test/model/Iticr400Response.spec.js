...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr400Response();
  });
  ...
  describe('Iticr400Response', function() {
    it('should create an instance of Iticr400Response', function() {
      // uncomment below and update the code to test Iticr400Response
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr400Response();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr400Response);
    });
