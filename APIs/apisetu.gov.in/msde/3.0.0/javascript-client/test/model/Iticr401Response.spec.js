...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr401Response();
  });
  ...
  describe('Iticr401Response', function() {
    it('should create an instance of Iticr401Response', function() {
      // uncomment below and update the code to test Iticr401Response
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr401Response();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr401Response);
    });
