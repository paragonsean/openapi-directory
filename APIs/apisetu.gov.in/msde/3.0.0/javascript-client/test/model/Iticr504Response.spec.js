...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr504Response();
  });
  ...
  describe('Iticr504Response', function() {
    it('should create an instance of Iticr504Response', function() {
      // uncomment below and update the code to test Iticr504Response
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr504Response();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr504Response);
    });
