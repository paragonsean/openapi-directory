...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr404Response();
  });
  ...
  describe('Iticr404Response', function() {
    it('should create an instance of Iticr404Response', function() {
      // uncomment below and update the code to test Iticr404Response
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr404Response();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr404Response);
    });
