...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.ConsentArtifactSchema();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.ConsentArtifactSchema);
    });
