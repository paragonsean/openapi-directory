...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr500Response();
  });
  ...
  describe('Iticr500Response', function() {
    it('should create an instance of Iticr500Response', function() {
      // uncomment below and update the code to test Iticr500Response
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr500Response();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr500Response);
    });
