...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr503Response();
  });
  ...
  describe('Iticr503Response', function() {
    it('should create an instance of Iticr503Response', function() {
      // uncomment below and update the code to test Iticr503Response
      //var instance = new MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr503Response();
      //expect(instance).to.be.a(MinistryOfSkillDevelopmentAndEntrepreneurship.Iticr503Response);
    });
