...
/**
 * The Iticr503Response model module.
 * @module model/Iticr503Response
 * @version 3.0.0
 */
class Iticr503Response {
    /**
     * Constructs a new <code>Iticr503Response</code>.
     * @alias module:model/Iticr503Response
     */
    constructor() { 
        
        Iticr503Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Iticr503Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Iticr503Response} obj Optional instance to populate.
     * @return {module:model/Iticr503Response} The populated <code>Iticr503Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Iticr503Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Iticr503Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Iticr503Response</code>.
     */
...
/**
 * @member {module:model/Iticr503Response.ErrorEnum} error
 */
Iticr503Response.prototype['error'] = undefined;

/**
 * @member {module:model/Iticr503Response.ErrorDescriptionEnum} errorDescription
 */
Iticr503Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Iticr503Response['ErrorDescriptionEnum'] = {
...
export default Iticr503Response;
