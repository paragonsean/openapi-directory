...
OAIIticr_request::OAIIticr_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIticr_request::OAIIticr_request() {
    this->initializeModel();
}

OAIIticr_request::~OAIIticr_request() {}

void OAIIticr_request::initializeModel() {
...
void OAIIticr_request::fromJson(QString jsonString) {
...
void OAIIticr_request::fromJsonObject(QJsonObject json) {
...
QString OAIIticr_request::asJson() const {
...
QJsonObject OAIIticr_request::asJsonObject() const {
    QJsonObject obj;
...
OAIIticr_request_certificateParameters OAIIticr_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIIticr_request::setCertificateParameters(const OAIIticr_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIIticr_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIIticr_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIIticr_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIIticr_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIIticr_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIIticr_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIIticr_request::getFormat() const {
    return m_format;
}
void OAIIticr_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIIticr_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIIticr_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIIticr_request::getTxnId() const {
    return m_txn_id;
}
void OAIIticr_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIIticr_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIIticr_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIIticr_request::isSet() const {
...
bool OAIIticr_request::isValid() const {
