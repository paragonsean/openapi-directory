...
OAIIticr_request Example::create(){
    OAIIticr_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::iticrSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::iticrSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIIticr_request oai_iticr_request = create(); // OAIIticr_request | Request format
      apiInstance.iticr(oai_iticr_request);
