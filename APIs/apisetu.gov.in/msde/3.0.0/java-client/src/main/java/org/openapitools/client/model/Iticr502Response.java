...
public class Iticr502Response {
  ...
  public Iticr502Response() {
  }

  public Iticr502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr502Response iticr502Response = (Iticr502Response) o;
    return Objects.equals(this.error, iticr502Response.error) &&
        Objects.equals(this.errorDescription, iticr502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr502Response is not found in the empty JSON string", Iticr502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr502Response>() {
           @Override
           public void write(JsonWriter out, Iticr502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr502Response
   * @throws IOException if the JSON string is invalid with respect to Iticr502Response
   */
  public static Iticr502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr502Response.class);
  }

  /**
   * Convert an instance of Iticr502Response to an JSON string
   *
   * @return JSON string
   */
