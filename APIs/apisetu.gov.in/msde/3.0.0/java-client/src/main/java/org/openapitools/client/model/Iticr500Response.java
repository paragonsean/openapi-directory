...
public class Iticr500Response {
  ...
  public Iticr500Response() {
  }

  public Iticr500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr500Response iticr500Response = (Iticr500Response) o;
    return Objects.equals(this.error, iticr500Response.error) &&
        Objects.equals(this.errorDescription, iticr500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr500Response is not found in the empty JSON string", Iticr500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr500Response>() {
           @Override
           public void write(JsonWriter out, Iticr500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr500Response
   * @throws IOException if the JSON string is invalid with respect to Iticr500Response
   */
  public static Iticr500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr500Response.class);
  }

  /**
   * Convert an instance of Iticr500Response to an JSON string
   *
   * @return JSON string
   */
