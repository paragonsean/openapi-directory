...
public class Iticr400Response {
  ...
  public Iticr400Response() {
  }

  public Iticr400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr400Response iticr400Response = (Iticr400Response) o;
    return Objects.equals(this.error, iticr400Response.error) &&
        Objects.equals(this.errorDescription, iticr400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr400Response is not found in the empty JSON string", Iticr400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr400Response>() {
           @Override
           public void write(JsonWriter out, Iticr400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr400Response
   * @throws IOException if the JSON string is invalid with respect to Iticr400Response
   */
  public static Iticr400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr400Response.class);
  }

  /**
   * Convert an instance of Iticr400Response to an JSON string
   *
   * @return JSON string
   */
