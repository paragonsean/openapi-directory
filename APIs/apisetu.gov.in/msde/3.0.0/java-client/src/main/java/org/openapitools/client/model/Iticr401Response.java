...
public class Iticr401Response {
  ...
  public Iticr401Response() {
  }

  public Iticr401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr401Response iticr401Response = (Iticr401Response) o;
    return Objects.equals(this.error, iticr401Response.error) &&
        Objects.equals(this.errorDescription, iticr401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr401Response is not found in the empty JSON string", Iticr401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr401Response>() {
           @Override
           public void write(JsonWriter out, Iticr401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr401Response
   * @throws IOException if the JSON string is invalid with respect to Iticr401Response
   */
  public static Iticr401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr401Response.class);
  }

  /**
   * Convert an instance of Iticr401Response to an JSON string
   *
   * @return JSON string
   */
