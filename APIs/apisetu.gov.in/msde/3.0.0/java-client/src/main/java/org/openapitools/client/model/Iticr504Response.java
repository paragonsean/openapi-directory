...
public class Iticr504Response {
  ...
  public Iticr504Response() {
  }

  public Iticr504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr504Response iticr504Response = (Iticr504Response) o;
    return Objects.equals(this.error, iticr504Response.error) &&
        Objects.equals(this.errorDescription, iticr504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr504Response is not found in the empty JSON string", Iticr504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr504Response>() {
           @Override
           public void write(JsonWriter out, Iticr504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr504Response
   * @throws IOException if the JSON string is invalid with respect to Iticr504Response
   */
  public static Iticr504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr504Response.class);
  }

  /**
   * Convert an instance of Iticr504Response to an JSON string
   *
   * @return JSON string
   */
