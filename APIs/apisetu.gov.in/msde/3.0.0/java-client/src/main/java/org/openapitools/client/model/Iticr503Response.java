...
public class Iticr503Response {
  ...
  public Iticr503Response() {
  }

  public Iticr503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr503Response iticr503Response = (Iticr503Response) o;
    return Objects.equals(this.error, iticr503Response.error) &&
        Objects.equals(this.errorDescription, iticr503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr503Response is not found in the empty JSON string", Iticr503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr503Response>() {
           @Override
           public void write(JsonWriter out, Iticr503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr503Response
   * @throws IOException if the JSON string is invalid with respect to Iticr503Response
   */
  public static Iticr503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr503Response.class);
  }

  /**
   * Convert an instance of Iticr503Response to an JSON string
   *
   * @return JSON string
   */
