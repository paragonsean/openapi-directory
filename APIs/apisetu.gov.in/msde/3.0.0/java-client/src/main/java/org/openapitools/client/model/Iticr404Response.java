...
public class Iticr404Response {
  ...
  public Iticr404Response() {
  }

  public Iticr404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Iticr404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Iticr404Response iticr404Response = (Iticr404Response) o;
    return Objects.equals(this.error, iticr404Response.error) &&
        Objects.equals(this.errorDescription, iticr404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Iticr404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Iticr404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Iticr404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Iticr404Response is not found in the empty JSON string", Iticr404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Iticr404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Iticr404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Iticr404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Iticr404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Iticr404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Iticr404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Iticr404Response>() {
           @Override
           public void write(JsonWriter out, Iticr404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Iticr404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Iticr404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Iticr404Response
   * @throws IOException if the JSON string is invalid with respect to Iticr404Response
   */
  public static Iticr404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Iticr404Response.class);
  }

  /**
   * Convert an instance of Iticr404Response to an JSON string
   *
   * @return JSON string
   */
