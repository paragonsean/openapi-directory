# TransportDepartmentTamilNadu.APIsApi
...
```javascript
import TransportDepartmentTamilNadu from 'transport_department_tamil_nadu';
let defaultClient = TransportDepartmentTamilNadu.ApiClient.instance;
...
let apiInstance = new TransportDepartmentTamilNadu.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentTamilNadu.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentTamilNadu.RvcerRequest() // RvcerRequest | Request format
};
