...
public class Aecmw500Response {
  ...
  public Aecmw500Response() {
  }

  public Aecmw500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Aecmw500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Aecmw500Response aecmw500Response = (Aecmw500Response) o;
    return Objects.equals(this.error, aecmw500Response.error) &&
        Objects.equals(this.errorDescription, aecmw500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Aecmw500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aecmw500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aecmw500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aecmw500Response is not found in the empty JSON string", Aecmw500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aecmw500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aecmw500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aecmw500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aecmw500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aecmw500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aecmw500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Aecmw500Response>() {
           @Override
           public void write(JsonWriter out, Aecmw500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aecmw500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aecmw500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aecmw500Response
   * @throws IOException if the JSON string is invalid with respect to Aecmw500Response
   */
  public static Aecmw500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aecmw500Response.class);
  }

  /**
   * Convert an instance of Aecmw500Response to an JSON string
   *
   * @return JSON string
   */
