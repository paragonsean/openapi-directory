...
public class Aecmw404Response {
  ...
  public Aecmw404Response() {
  }

  public Aecmw404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Aecmw404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Aecmw404Response aecmw404Response = (Aecmw404Response) o;
    return Objects.equals(this.error, aecmw404Response.error) &&
        Objects.equals(this.errorDescription, aecmw404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Aecmw404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aecmw404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aecmw404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aecmw404Response is not found in the empty JSON string", Aecmw404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aecmw404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aecmw404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aecmw404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aecmw404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aecmw404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aecmw404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Aecmw404Response>() {
           @Override
           public void write(JsonWriter out, Aecmw404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aecmw404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aecmw404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aecmw404Response
   * @throws IOException if the JSON string is invalid with respect to Aecmw404Response
   */
  public static Aecmw404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aecmw404Response.class);
  }

  /**
   * Convert an instance of Aecmw404Response to an JSON string
   *
   * @return JSON string
   */
