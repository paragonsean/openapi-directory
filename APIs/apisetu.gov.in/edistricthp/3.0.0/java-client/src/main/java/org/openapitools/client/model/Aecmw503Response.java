...
public class Aecmw503Response {
  ...
  public Aecmw503Response() {
  }

  public Aecmw503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Aecmw503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Aecmw503Response aecmw503Response = (Aecmw503Response) o;
    return Objects.equals(this.error, aecmw503Response.error) &&
        Objects.equals(this.errorDescription, aecmw503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Aecmw503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aecmw503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aecmw503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aecmw503Response is not found in the empty JSON string", Aecmw503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aecmw503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aecmw503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aecmw503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aecmw503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aecmw503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aecmw503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Aecmw503Response>() {
           @Override
           public void write(JsonWriter out, Aecmw503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aecmw503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aecmw503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aecmw503Response
   * @throws IOException if the JSON string is invalid with respect to Aecmw503Response
   */
  public static Aecmw503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aecmw503Response.class);
  }

  /**
   * Convert an instance of Aecmw503Response to an JSON string
   *
   * @return JSON string
   */
