...
public class Aecmw401Response {
  ...
  public Aecmw401Response() {
  }

  public Aecmw401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Aecmw401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Aecmw401Response aecmw401Response = (Aecmw401Response) o;
    return Objects.equals(this.error, aecmw401Response.error) &&
        Objects.equals(this.errorDescription, aecmw401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Aecmw401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aecmw401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aecmw401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aecmw401Response is not found in the empty JSON string", Aecmw401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aecmw401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aecmw401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aecmw401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aecmw401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aecmw401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aecmw401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Aecmw401Response>() {
           @Override
           public void write(JsonWriter out, Aecmw401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aecmw401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aecmw401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aecmw401Response
   * @throws IOException if the JSON string is invalid with respect to Aecmw401Response
   */
  public static Aecmw401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aecmw401Response.class);
  }

  /**
   * Convert an instance of Aecmw401Response to an JSON string
   *
   * @return JSON string
   */
