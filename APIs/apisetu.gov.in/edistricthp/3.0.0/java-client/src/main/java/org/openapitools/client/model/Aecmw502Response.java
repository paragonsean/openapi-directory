...
public class Aecmw502Response {
  ...
  public Aecmw502Response() {
  }

  public Aecmw502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Aecmw502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Aecmw502Response aecmw502Response = (Aecmw502Response) o;
    return Objects.equals(this.error, aecmw502Response.error) &&
        Objects.equals(this.errorDescription, aecmw502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Aecmw502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aecmw502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aecmw502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aecmw502Response is not found in the empty JSON string", Aecmw502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aecmw502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aecmw502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aecmw502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aecmw502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aecmw502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aecmw502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Aecmw502Response>() {
           @Override
           public void write(JsonWriter out, Aecmw502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aecmw502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aecmw502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aecmw502Response
   * @throws IOException if the JSON string is invalid with respect to Aecmw502Response
   */
  public static Aecmw502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aecmw502Response.class);
  }

  /**
   * Convert an instance of Aecmw502Response to an JSON string
   *
   * @return JSON string
   */
