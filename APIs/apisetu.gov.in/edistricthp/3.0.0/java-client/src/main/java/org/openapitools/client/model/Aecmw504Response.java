...
public class Aecmw504Response {
  ...
  public Aecmw504Response() {
  }

  public Aecmw504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Aecmw504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Aecmw504Response aecmw504Response = (Aecmw504Response) o;
    return Objects.equals(this.error, aecmw504Response.error) &&
        Objects.equals(this.errorDescription, aecmw504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Aecmw504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Aecmw504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Aecmw504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Aecmw504Response is not found in the empty JSON string", Aecmw504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Aecmw504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aecmw504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Aecmw504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Aecmw504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Aecmw504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Aecmw504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Aecmw504Response>() {
           @Override
           public void write(JsonWriter out, Aecmw504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Aecmw504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Aecmw504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Aecmw504Response
   * @throws IOException if the JSON string is invalid with respect to Aecmw504Response
   */
  public static Aecmw504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Aecmw504Response.class);
  }

  /**
   * Convert an instance of Aecmw504Response to an JSON string
   *
   * @return JSON string
   */
