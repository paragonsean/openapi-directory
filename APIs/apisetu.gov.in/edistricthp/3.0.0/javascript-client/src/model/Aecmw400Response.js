...
/**
 * The Aecmw400Response model module.
 * @module model/Aecmw400Response
 * @version 3.0.0
 */
class Aecmw400Response {
    /**
     * Constructs a new <code>Aecmw400Response</code>.
     * @alias module:model/Aecmw400Response
     */
    constructor() { 
        
        Aecmw400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Aecmw400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Aecmw400Response} obj Optional instance to populate.
     * @return {module:model/Aecmw400Response} The populated <code>Aecmw400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Aecmw400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Aecmw400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Aecmw400Response</code>.
     */
...
/**
 * @member {module:model/Aecmw400Response.ErrorEnum} error
 */
Aecmw400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Aecmw400Response.ErrorDescriptionEnum} errorDescription
 */
Aecmw400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Aecmw400Response['ErrorDescriptionEnum'] = {
...
export default Aecmw400Response;
