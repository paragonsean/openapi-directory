...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.Aecmw500Response();
  });
  ...
  describe('Aecmw500Response', function() {
    it('should create an instance of Aecmw500Response', function() {
      // uncomment below and update the code to test Aecmw500Response
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.Aecmw500Response();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.Aecmw500Response);
    });
