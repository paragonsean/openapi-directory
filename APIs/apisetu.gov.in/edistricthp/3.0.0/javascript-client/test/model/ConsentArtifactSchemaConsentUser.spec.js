...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaConsentUser);
    });
