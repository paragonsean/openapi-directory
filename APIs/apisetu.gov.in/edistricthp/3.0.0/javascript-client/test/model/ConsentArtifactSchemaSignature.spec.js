...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaSignature();
  });
  ...
  describe('ConsentArtifactSchemaSignature', function() {
    it('should create an instance of ConsentArtifactSchemaSignature', function() {
      ...
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaSignature();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaSignature);
    });
