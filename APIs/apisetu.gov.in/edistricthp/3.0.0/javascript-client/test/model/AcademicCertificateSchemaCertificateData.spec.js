...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.AcademicCertificateSchemaCertificateData);
    });
