...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.AcademicCertificateSchemaCertificateDataExamination();
  });
  ...
  describe('AcademicCertificateSchemaCertificateDataExamination', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateDataExamination', function() {
      ...
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.AcademicCertificateSchemaCertificateDataExamination();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.AcademicCertificateSchemaCertificateDataExamination);
    });
