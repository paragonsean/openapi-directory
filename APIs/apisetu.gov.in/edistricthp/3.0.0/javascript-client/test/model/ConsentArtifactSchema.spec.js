...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchema();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchema);
    });
