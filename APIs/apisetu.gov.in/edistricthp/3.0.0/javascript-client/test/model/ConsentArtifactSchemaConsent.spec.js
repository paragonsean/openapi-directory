...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaConsent();
  });
  ...
  describe('ConsentArtifactSchemaConsent', function() {
    it('should create an instance of ConsentArtifactSchemaConsent', function() {
      ...
      //var instance = new EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaConsent();
      //expect(instance).to.be.a(EDistrictHimachalPradeshHimachalPradesh.ConsentArtifactSchemaConsent);
    });
