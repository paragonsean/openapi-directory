...
OAIAecmw_request Example::create(){
    OAIAecmw_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::aecmwSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::aecmwSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAecmw_request oai_aecmw_request = create(); // OAIAecmw_request | Request format
      apiInstance.aecmw(oai_aecmw_request);
