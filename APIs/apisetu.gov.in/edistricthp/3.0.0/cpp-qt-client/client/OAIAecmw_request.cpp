...
OAIAecmw_request::OAIAecmw_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAecmw_request::OAIAecmw_request() {
    this->initializeModel();
}

OAIAecmw_request::~OAIAecmw_request() {}

void OAIAecmw_request::initializeModel() {
...
void OAIAecmw_request::fromJson(QString jsonString) {
...
void OAIAecmw_request::fromJsonObject(QJsonObject json) {
...
QString OAIAecmw_request::asJson() const {
...
QJsonObject OAIAecmw_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAecmw_request_certificateParameters OAIAecmw_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIAecmw_request::setCertificateParameters(const OAIAecmw_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIAecmw_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIAecmw_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIAecmw_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIAecmw_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIAecmw_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIAecmw_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIAecmw_request::getFormat() const {
    return m_format;
}
void OAIAecmw_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIAecmw_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIAecmw_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIAecmw_request::getTxnId() const {
    return m_txn_id;
}
void OAIAecmw_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIAecmw_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIAecmw_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIAecmw_request::isSet() const {
...
bool OAIAecmw_request::isValid() const {
