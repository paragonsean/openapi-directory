...
#ifndef OAIAecmw_request_H
#define OAIAecmw_request_H
...
namespace OpenAPI {
class OAIAecmw_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIAecmw_request : public OAIObject {
public:
    OAIAecmw_request();
    OAIAecmw_request(QString json);
    ~OAIAecmw_request() override;
    ...
    OAIAecmw_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIAecmw_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIAecmw_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAecmw_request)

#endif // OAIAecmw_request_H
