...
public class Labrp500Response {
  ...
  public Labrp500Response() {
  }

  public Labrp500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Labrp500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Labrp500Response labrp500Response = (Labrp500Response) o;
    return Objects.equals(this.error, labrp500Response.error) &&
        Objects.equals(this.errorDescription, labrp500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Labrp500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Labrp500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Labrp500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Labrp500Response is not found in the empty JSON string", Labrp500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Labrp500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Labrp500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Labrp500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Labrp500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Labrp500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Labrp500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Labrp500Response>() {
           @Override
           public void write(JsonWriter out, Labrp500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Labrp500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Labrp500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Labrp500Response
   * @throws IOException if the JSON string is invalid with respect to Labrp500Response
   */
  public static Labrp500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Labrp500Response.class);
  }

  /**
   * Convert an instance of Labrp500Response to an JSON string
   *
   * @return JSON string
   */
