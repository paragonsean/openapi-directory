...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AiimsMangalagiri.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new AiimsMangalagiri.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(AiimsMangalagiri.ConsentArtifactSchemaConsentPermission);
    });
