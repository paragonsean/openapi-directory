...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AiimsMangalagiri.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new AiimsMangalagiri.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(AiimsMangalagiri.AcademicCertificateSchemaCertificateData);
    });
