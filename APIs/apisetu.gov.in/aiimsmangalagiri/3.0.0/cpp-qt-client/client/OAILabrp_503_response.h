...
/*
 * OAILabrp_503_response.h
 *
 * 
 */

#ifndef OAILabrp_503_response_H
#define OAILabrp_503_response_H
...
class OAILabrp_503_response : public OAIObject {
public:
    OAILabrp_503_response();
    OAILabrp_503_response(QString json);
    ~OAILabrp_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabrp_503_response)

#endif // OAILabrp_503_response_H
