...
QString OAIHscer_request_certificateParameters::getCname() const {
    return m_cname;
}
void OAIHscer_request_certificateParameters::setCname(const QString &cname) {
    m_cname = cname;
    m_cname_isSet = true;
}

bool OAIHscer_request_certificateParameters::is_cname_Set() const{
    return m_cname_isSet;
}

bool OAIHscer_request_certificateParameters::is_cname_Valid() const{
    return m_cname_isValid;
}

QString OAIHscer_request_certificateParameters::getRoll() const {
    return m_roll;
}
void OAIHscer_request_certificateParameters::setRoll(const QString &roll) {
    m_roll = roll;
    m_roll_isSet = true;
}

bool OAIHscer_request_certificateParameters::is_roll_Set() const{
    return m_roll_isSet;
}

bool OAIHscer_request_certificateParameters::is_roll_Valid() const{
