...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RajasthanBoardOfSecondaryEducation.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new RajasthanBoardOfSecondaryEducation.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(RajasthanBoardOfSecondaryEducation.ConsentArtifactSchemaConsentPermission);
    });
