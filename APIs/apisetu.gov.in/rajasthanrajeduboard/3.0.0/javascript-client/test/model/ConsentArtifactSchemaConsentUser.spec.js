...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RajasthanBoardOfSecondaryEducation.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new RajasthanBoardOfSecondaryEducation.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(RajasthanBoardOfSecondaryEducation.ConsentArtifactSchemaConsentUser);
    });
