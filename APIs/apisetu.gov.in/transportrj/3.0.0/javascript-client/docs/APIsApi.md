# TransportDepartmentRajasthan.APIsApi
...
```javascript
import TransportDepartmentRajasthan from 'transport_department_rajasthan';
let defaultClient = TransportDepartmentRajasthan.ApiClient.instance;
...
let apiInstance = new TransportDepartmentRajasthan.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentRajasthan.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentRajasthan.RvcerRequest() // RvcerRequest | Request format
};
