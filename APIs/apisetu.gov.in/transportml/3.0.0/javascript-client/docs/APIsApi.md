# TransportDepartmentMeghalaya.APIsApi
...
```javascript
import TransportDepartmentMeghalaya from 'transport_department_meghalaya';
let defaultClient = TransportDepartmentMeghalaya.ApiClient.instance;
...
let apiInstance = new TransportDepartmentMeghalaya.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentMeghalaya.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentMeghalaya.RvcerRequest() // RvcerRequest | Request format
};
