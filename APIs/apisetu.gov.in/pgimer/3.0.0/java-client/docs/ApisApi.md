...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/pgimer/v3");
    ...
    LabrpRequest labrpRequest = new LabrpRequest(); // LabrpRequest | Request format
    try {
      apiInstance.labrp(labrpRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#labrp");
