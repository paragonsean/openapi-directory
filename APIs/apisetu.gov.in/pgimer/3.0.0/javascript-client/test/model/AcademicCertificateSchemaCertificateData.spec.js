...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PgimerChandigarh.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new PgimerChandigarh.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(PgimerChandigarh.AcademicCertificateSchemaCertificateData);
    });
