...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PgimerChandigarh.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new PgimerChandigarh.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(PgimerChandigarh.ConsentArtifactSchemaConsentPermission);
    });
