...
public class Dgmst502Response {
  ...
  public Dgmst502Response() {
  }

  public Dgmst502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst502Response dgmst502Response = (Dgmst502Response) o;
    return Objects.equals(this.error, dgmst502Response.error) &&
        Objects.equals(this.errorDescription, dgmst502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst502Response is not found in the empty JSON string", Dgmst502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst502Response>() {
           @Override
           public void write(JsonWriter out, Dgmst502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst502Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst502Response
   */
  public static Dgmst502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst502Response.class);
  }

  /**
   * Convert an instance of Dgmst502Response to an JSON string
   *
   * @return JSON string
   */
