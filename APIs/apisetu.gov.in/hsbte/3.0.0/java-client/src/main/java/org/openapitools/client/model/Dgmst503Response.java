...
public class Dgmst503Response {
  ...
  public Dgmst503Response() {
  }

  public Dgmst503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst503Response dgmst503Response = (Dgmst503Response) o;
    return Objects.equals(this.error, dgmst503Response.error) &&
        Objects.equals(this.errorDescription, dgmst503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst503Response is not found in the empty JSON string", Dgmst503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst503Response>() {
           @Override
           public void write(JsonWriter out, Dgmst503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst503Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst503Response
   */
  public static Dgmst503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst503Response.class);
  }

  /**
   * Convert an instance of Dgmst503Response to an JSON string
   *
   * @return JSON string
   */
