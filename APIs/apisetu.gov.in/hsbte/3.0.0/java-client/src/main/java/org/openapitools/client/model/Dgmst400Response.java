...
public class Dgmst400Response {
  ...
  public Dgmst400Response() {
  }

  public Dgmst400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst400Response dgmst400Response = (Dgmst400Response) o;
    return Objects.equals(this.error, dgmst400Response.error) &&
        Objects.equals(this.errorDescription, dgmst400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst400Response is not found in the empty JSON string", Dgmst400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst400Response>() {
           @Override
           public void write(JsonWriter out, Dgmst400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst400Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst400Response
   */
  public static Dgmst400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst400Response.class);
  }

  /**
   * Convert an instance of Dgmst400Response to an JSON string
   *
   * @return JSON string
   */
