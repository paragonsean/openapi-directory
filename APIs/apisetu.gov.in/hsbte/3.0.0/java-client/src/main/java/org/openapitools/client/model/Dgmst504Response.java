...
public class Dgmst504Response {
  ...
  public Dgmst504Response() {
  }

  public Dgmst504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst504Response dgmst504Response = (Dgmst504Response) o;
    return Objects.equals(this.error, dgmst504Response.error) &&
        Objects.equals(this.errorDescription, dgmst504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst504Response is not found in the empty JSON string", Dgmst504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst504Response>() {
           @Override
           public void write(JsonWriter out, Dgmst504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst504Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst504Response
   */
  public static Dgmst504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst504Response.class);
  }

  /**
   * Convert an instance of Dgmst504Response to an JSON string
   *
   * @return JSON string
   */
