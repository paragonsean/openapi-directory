...
public class Dgmst401Response {
  ...
  public Dgmst401Response() {
  }

  public Dgmst401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst401Response dgmst401Response = (Dgmst401Response) o;
    return Objects.equals(this.error, dgmst401Response.error) &&
        Objects.equals(this.errorDescription, dgmst401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst401Response is not found in the empty JSON string", Dgmst401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst401Response>() {
           @Override
           public void write(JsonWriter out, Dgmst401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst401Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst401Response
   */
  public static Dgmst401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst401Response.class);
  }

  /**
   * Convert an instance of Dgmst401Response to an JSON string
   *
   * @return JSON string
   */
