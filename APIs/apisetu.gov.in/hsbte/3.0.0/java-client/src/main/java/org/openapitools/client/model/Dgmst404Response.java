...
public class Dgmst404Response {
  ...
  public Dgmst404Response() {
  }

  public Dgmst404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst404Response dgmst404Response = (Dgmst404Response) o;
    return Objects.equals(this.error, dgmst404Response.error) &&
        Objects.equals(this.errorDescription, dgmst404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst404Response is not found in the empty JSON string", Dgmst404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst404Response>() {
           @Override
           public void write(JsonWriter out, Dgmst404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst404Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst404Response
   */
  public static Dgmst404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst404Response.class);
  }

  /**
   * Convert an instance of Dgmst404Response to an JSON string
   *
   * @return JSON string
   */
