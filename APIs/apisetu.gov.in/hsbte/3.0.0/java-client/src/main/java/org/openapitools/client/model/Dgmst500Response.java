...
public class Dgmst500Response {
  ...
  public Dgmst500Response() {
  }

  public Dgmst500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgmst500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgmst500Response dgmst500Response = (Dgmst500Response) o;
    return Objects.equals(this.error, dgmst500Response.error) &&
        Objects.equals(this.errorDescription, dgmst500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgmst500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgmst500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgmst500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgmst500Response is not found in the empty JSON string", Dgmst500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgmst500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgmst500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgmst500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgmst500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgmst500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgmst500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgmst500Response>() {
           @Override
           public void write(JsonWriter out, Dgmst500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgmst500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgmst500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgmst500Response
   * @throws IOException if the JSON string is invalid with respect to Dgmst500Response
   */
  public static Dgmst500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgmst500Response.class);
  }

  /**
   * Convert an instance of Dgmst500Response to an JSON string
   *
   * @return JSON string
   */
