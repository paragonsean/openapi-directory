...
/*
 * OAIDgmst_404_response.h
 *
 * 
 */

#ifndef OAIDgmst_404_response_H
#define OAIDgmst_404_response_H
...
class OAIDgmst_404_response : public OAIObject {
public:
    OAIDgmst_404_response();
    OAIDgmst_404_response(QString json);
    ~OAIDgmst_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDgmst_404_response)

#endif // OAIDgmst_404_response_H
