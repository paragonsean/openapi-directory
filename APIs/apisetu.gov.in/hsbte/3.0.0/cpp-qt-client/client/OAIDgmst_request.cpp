...
OAIDgmst_request::OAIDgmst_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDgmst_request::OAIDgmst_request() {
    this->initializeModel();
}

OAIDgmst_request::~OAIDgmst_request() {}

void OAIDgmst_request::initializeModel() {
...
void OAIDgmst_request::fromJson(QString jsonString) {
...
void OAIDgmst_request::fromJsonObject(QJsonObject json) {
...
QString OAIDgmst_request::asJson() const {
...
QJsonObject OAIDgmst_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDgmst_request_certificateParameters OAIDgmst_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDgmst_request::setCertificateParameters(const OAIDgmst_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDgmst_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDgmst_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDgmst_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDgmst_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDgmst_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDgmst_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDgmst_request::getFormat() const {
    return m_format;
}
void OAIDgmst_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDgmst_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDgmst_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDgmst_request::getTxnId() const {
    return m_txn_id;
}
void OAIDgmst_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDgmst_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDgmst_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDgmst_request::isSet() const {
...
bool OAIDgmst_request::isValid() const {
