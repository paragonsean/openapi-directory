...
/**
 * The Dgmst400Response model module.
 * @module model/Dgmst400Response
 * @version 3.0.0
 */
class Dgmst400Response {
    /**
     * Constructs a new <code>Dgmst400Response</code>.
     * @alias module:model/Dgmst400Response
     */
    constructor() { 
        
        Dgmst400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Dgmst400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Dgmst400Response} obj Optional instance to populate.
     * @return {module:model/Dgmst400Response} The populated <code>Dgmst400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Dgmst400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Dgmst400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Dgmst400Response</code>.
     */
...
/**
 * @member {module:model/Dgmst400Response.ErrorEnum} error
 */
Dgmst400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Dgmst400Response.ErrorDescriptionEnum} errorDescription
 */
Dgmst400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Dgmst400Response['ErrorDescriptionEnum'] = {
...
export default Dgmst400Response;
