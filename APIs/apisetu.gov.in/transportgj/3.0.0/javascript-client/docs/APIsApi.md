# TransportDepartmentGujarat.APIsApi
...
```javascript
import TransportDepartmentGujarat from 'transport_department_gujarat';
let defaultClient = TransportDepartmentGujarat.ApiClient.instance;
...
let apiInstance = new TransportDepartmentGujarat.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentGujarat.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentGujarat.RvcerRequest() // RvcerRequest | Request format
};
