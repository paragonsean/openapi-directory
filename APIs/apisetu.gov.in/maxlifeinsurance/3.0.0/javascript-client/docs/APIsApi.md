...
```javascript
import MaxLifeInsuranceCoLtd from 'max_life_insurance_co__ltd_';
let defaultClient = MaxLifeInsuranceCoLtd.ApiClient.instance;
...
let apiInstance = new MaxLifeInsuranceCoLtd.APIsApi();
let opts = {
