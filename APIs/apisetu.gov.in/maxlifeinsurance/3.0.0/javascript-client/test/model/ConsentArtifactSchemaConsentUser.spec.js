...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MaxLifeInsuranceCoLtd.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new MaxLifeInsuranceCoLtd.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(MaxLifeInsuranceCoLtd.ConsentArtifactSchemaConsentUser);
    });
