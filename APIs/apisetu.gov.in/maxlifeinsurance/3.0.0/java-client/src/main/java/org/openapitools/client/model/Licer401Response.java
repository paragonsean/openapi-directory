...
public class Licer401Response {
  ...
  public Licer401Response() {
  }

  public Licer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Licer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Licer401Response licer401Response = (Licer401Response) o;
    return Objects.equals(this.error, licer401Response.error) &&
        Objects.equals(this.errorDescription, licer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Licer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Licer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Licer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Licer401Response is not found in the empty JSON string", Licer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Licer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Licer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Licer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Licer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Licer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Licer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Licer401Response>() {
           @Override
           public void write(JsonWriter out, Licer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Licer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Licer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Licer401Response
   * @throws IOException if the JSON string is invalid with respect to Licer401Response
   */
  public static Licer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Licer401Response.class);
  }

  /**
   * Convert an instance of Licer401Response to an JSON string
   *
   * @return JSON string
   */
