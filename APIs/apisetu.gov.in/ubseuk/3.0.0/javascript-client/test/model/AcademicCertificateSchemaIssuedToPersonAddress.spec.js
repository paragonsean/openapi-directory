...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UttarakhandStateBoardOfSchoolEducationUttarakhand.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new UttarakhandStateBoardOfSchoolEducationUttarakhand.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(UttarakhandStateBoardOfSchoolEducationUttarakhand.AcademicCertificateSchemaIssuedToPersonAddress);
    });
