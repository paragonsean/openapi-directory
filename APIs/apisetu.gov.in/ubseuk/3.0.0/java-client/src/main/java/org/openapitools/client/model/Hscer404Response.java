...
public class Hscer404Response {
  ...
  public Hscer404Response() {
  }

  public Hscer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hscer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hscer404Response hscer404Response = (Hscer404Response) o;
    return Objects.equals(this.error, hscer404Response.error) &&
        Objects.equals(this.errorDescription, hscer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hscer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hscer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hscer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hscer404Response is not found in the empty JSON string", Hscer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hscer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hscer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hscer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hscer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hscer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hscer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hscer404Response>() {
           @Override
           public void write(JsonWriter out, Hscer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hscer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hscer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hscer404Response
   * @throws IOException if the JSON string is invalid with respect to Hscer404Response
   */
  public static Hscer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hscer404Response.class);
  }

  /**
   * Convert an instance of Hscer404Response to an JSON string
   *
   * @return JSON string
   */
