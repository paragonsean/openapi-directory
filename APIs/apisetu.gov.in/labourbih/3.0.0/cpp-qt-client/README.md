...
OAIAlimw_request Example::create(){
    OAIAlimw_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::alimwSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::alimwSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAlimw_request oai_alimw_request = create(); // OAIAlimw_request | Request format
      apiInstance.alimw(oai_alimw_request);
