...
#ifndef OAIAlimw_request_H
#define OAIAlimw_request_H
...
namespace OpenAPI {
class OAIAlimw_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIAlimw_request : public OAIObject {
public:
    OAIAlimw_request();
    OAIAlimw_request(QString json);
    ~OAIAlimw_request() override;
    ...
    OAIAlimw_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIAlimw_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIAlimw_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlimw_request)

#endif // OAIAlimw_request_H
