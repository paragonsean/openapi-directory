...
OAIAlimw_request::OAIAlimw_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlimw_request::OAIAlimw_request() {
    this->initializeModel();
}

OAIAlimw_request::~OAIAlimw_request() {}

void OAIAlimw_request::initializeModel() {
...
void OAIAlimw_request::fromJson(QString jsonString) {
...
void OAIAlimw_request::fromJsonObject(QJsonObject json) {
...
QString OAIAlimw_request::asJson() const {
...
QJsonObject OAIAlimw_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAlimw_request_certificateParameters OAIAlimw_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIAlimw_request::setCertificateParameters(const OAIAlimw_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIAlimw_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIAlimw_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIAlimw_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIAlimw_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIAlimw_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIAlimw_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIAlimw_request::getFormat() const {
    return m_format;
}
void OAIAlimw_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIAlimw_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIAlimw_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIAlimw_request::getTxnId() const {
    return m_txn_id;
}
void OAIAlimw_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIAlimw_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIAlimw_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIAlimw_request::isSet() const {
...
bool OAIAlimw_request::isValid() const {
