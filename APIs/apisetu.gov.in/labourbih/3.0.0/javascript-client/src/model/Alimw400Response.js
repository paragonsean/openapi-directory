...
/**
 * The Alimw400Response model module.
 * @module model/Alimw400Response
 * @version 3.0.0
 */
class Alimw400Response {
    /**
     * Constructs a new <code>Alimw400Response</code>.
     * @alias module:model/Alimw400Response
     */
    constructor() { 
        
        Alimw400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Alimw400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Alimw400Response} obj Optional instance to populate.
     * @return {module:model/Alimw400Response} The populated <code>Alimw400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Alimw400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Alimw400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Alimw400Response</code>.
     */
...
/**
 * @member {module:model/Alimw400Response.ErrorEnum} error
 */
Alimw400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Alimw400Response.ErrorDescriptionEnum} errorDescription
 */
Alimw400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Alimw400Response['ErrorDescriptionEnum'] = {
...
export default Alimw400Response;
