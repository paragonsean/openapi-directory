...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LabourResourceDepartmentBihar.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new LabourResourceDepartmentBihar.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(LabourResourceDepartmentBihar.ConsentArtifactSchemaConsentUser);
    });
