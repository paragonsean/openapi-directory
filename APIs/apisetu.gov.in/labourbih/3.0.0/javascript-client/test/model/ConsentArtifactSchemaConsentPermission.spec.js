...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LabourResourceDepartmentBihar.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new LabourResourceDepartmentBihar.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(LabourResourceDepartmentBihar.ConsentArtifactSchemaConsentPermission);
    });
