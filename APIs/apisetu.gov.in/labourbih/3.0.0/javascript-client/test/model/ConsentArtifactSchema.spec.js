...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LabourResourceDepartmentBihar.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new LabourResourceDepartmentBihar.ConsentArtifactSchema();
      //expect(instance).to.be.a(LabourResourceDepartmentBihar.ConsentArtifactSchema);
    });
