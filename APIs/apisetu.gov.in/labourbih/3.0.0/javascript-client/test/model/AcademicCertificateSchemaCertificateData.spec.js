...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LabourResourceDepartmentBihar.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new LabourResourceDepartmentBihar.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(LabourResourceDepartmentBihar.AcademicCertificateSchemaCertificateData);
    });
