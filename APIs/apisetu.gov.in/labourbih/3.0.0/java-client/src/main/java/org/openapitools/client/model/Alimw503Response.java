...
public class Alimw503Response {
  ...
  public Alimw503Response() {
  }

  public Alimw503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw503Response alimw503Response = (Alimw503Response) o;
    return Objects.equals(this.error, alimw503Response.error) &&
        Objects.equals(this.errorDescription, alimw503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw503Response is not found in the empty JSON string", Alimw503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw503Response>() {
           @Override
           public void write(JsonWriter out, Alimw503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw503Response
   * @throws IOException if the JSON string is invalid with respect to Alimw503Response
   */
  public static Alimw503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw503Response.class);
  }

  /**
   * Convert an instance of Alimw503Response to an JSON string
   *
   * @return JSON string
   */
