...
public class Alimw400Response {
  ...
  public Alimw400Response() {
  }

  public Alimw400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw400Response alimw400Response = (Alimw400Response) o;
    return Objects.equals(this.error, alimw400Response.error) &&
        Objects.equals(this.errorDescription, alimw400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw400Response is not found in the empty JSON string", Alimw400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw400Response>() {
           @Override
           public void write(JsonWriter out, Alimw400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw400Response
   * @throws IOException if the JSON string is invalid with respect to Alimw400Response
   */
  public static Alimw400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw400Response.class);
  }

  /**
   * Convert an instance of Alimw400Response to an JSON string
   *
   * @return JSON string
   */
