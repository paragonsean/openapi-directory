...
public class Alimw404Response {
  ...
  public Alimw404Response() {
  }

  public Alimw404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw404Response alimw404Response = (Alimw404Response) o;
    return Objects.equals(this.error, alimw404Response.error) &&
        Objects.equals(this.errorDescription, alimw404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw404Response is not found in the empty JSON string", Alimw404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw404Response>() {
           @Override
           public void write(JsonWriter out, Alimw404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw404Response
   * @throws IOException if the JSON string is invalid with respect to Alimw404Response
   */
  public static Alimw404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw404Response.class);
  }

  /**
   * Convert an instance of Alimw404Response to an JSON string
   *
   * @return JSON string
   */
