...
public class Alimw401Response {
  ...
  public Alimw401Response() {
  }

  public Alimw401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw401Response alimw401Response = (Alimw401Response) o;
    return Objects.equals(this.error, alimw401Response.error) &&
        Objects.equals(this.errorDescription, alimw401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw401Response is not found in the empty JSON string", Alimw401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw401Response>() {
           @Override
           public void write(JsonWriter out, Alimw401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw401Response
   * @throws IOException if the JSON string is invalid with respect to Alimw401Response
   */
  public static Alimw401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw401Response.class);
  }

  /**
   * Convert an instance of Alimw401Response to an JSON string
   *
   * @return JSON string
   */
