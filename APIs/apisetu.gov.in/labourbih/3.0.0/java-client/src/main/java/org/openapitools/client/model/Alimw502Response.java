...
public class Alimw502Response {
  ...
  public Alimw502Response() {
  }

  public Alimw502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw502Response alimw502Response = (Alimw502Response) o;
    return Objects.equals(this.error, alimw502Response.error) &&
        Objects.equals(this.errorDescription, alimw502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw502Response is not found in the empty JSON string", Alimw502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw502Response>() {
           @Override
           public void write(JsonWriter out, Alimw502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw502Response
   * @throws IOException if the JSON string is invalid with respect to Alimw502Response
   */
  public static Alimw502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw502Response.class);
  }

  /**
   * Convert an instance of Alimw502Response to an JSON string
   *
   * @return JSON string
   */
