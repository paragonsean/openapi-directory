...
public class Alimw500Response {
  ...
  public Alimw500Response() {
  }

  public Alimw500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw500Response alimw500Response = (Alimw500Response) o;
    return Objects.equals(this.error, alimw500Response.error) &&
        Objects.equals(this.errorDescription, alimw500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw500Response is not found in the empty JSON string", Alimw500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw500Response>() {
           @Override
           public void write(JsonWriter out, Alimw500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw500Response
   * @throws IOException if the JSON string is invalid with respect to Alimw500Response
   */
  public static Alimw500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw500Response.class);
  }

  /**
   * Convert an instance of Alimw500Response to an JSON string
   *
   * @return JSON string
   */
