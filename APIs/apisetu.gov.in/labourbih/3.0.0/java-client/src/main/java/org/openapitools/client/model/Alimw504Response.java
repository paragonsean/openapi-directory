...
public class Alimw504Response {
  ...
  public Alimw504Response() {
  }

  public Alimw504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alimw504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alimw504Response alimw504Response = (Alimw504Response) o;
    return Objects.equals(this.error, alimw504Response.error) &&
        Objects.equals(this.errorDescription, alimw504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alimw504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alimw504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alimw504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alimw504Response is not found in the empty JSON string", Alimw504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alimw504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alimw504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alimw504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alimw504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alimw504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alimw504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alimw504Response>() {
           @Override
           public void write(JsonWriter out, Alimw504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alimw504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alimw504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alimw504Response
   * @throws IOException if the JSON string is invalid with respect to Alimw504Response
   */
  public static Alimw504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alimw504Response.class);
  }

  /**
   * Convert an instance of Alimw504Response to an JSON string
   *
   * @return JSON string
   */
