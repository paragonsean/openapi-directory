...
/**
 * The Dpcer400Response model module.
 * @module model/Dpcer400Response
 * @version 3.0.0
 */
class Dpcer400Response {
    /**
     * Constructs a new <code>Dpcer400Response</code>.
     * @alias module:model/Dpcer400Response
     */
    constructor() { 
        
        Dpcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Dpcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Dpcer400Response} obj Optional instance to populate.
     * @return {module:model/Dpcer400Response} The populated <code>Dpcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Dpcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Dpcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Dpcer400Response</code>.
     */
...
/**
 * @member {module:model/Dpcer400Response.ErrorEnum} error
 */
Dpcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Dpcer400Response.ErrorDescriptionEnum} errorDescription
 */
Dpcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Dpcer400Response['ErrorDescriptionEnum'] = {
...
export default Dpcer400Response;
