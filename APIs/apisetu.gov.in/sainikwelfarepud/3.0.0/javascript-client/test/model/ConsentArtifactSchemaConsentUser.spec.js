...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchemaConsentUser);
    });
