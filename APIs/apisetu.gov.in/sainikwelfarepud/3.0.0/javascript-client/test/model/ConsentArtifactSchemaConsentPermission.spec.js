...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchemaConsentPermission);
    });
