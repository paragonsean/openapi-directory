...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchema();
      //expect(instance).to.be.a(DepartmentOfSainikWelfarePuducherry.ConsentArtifactSchema);
    });
