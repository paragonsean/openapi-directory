...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfSainikWelfarePuducherry.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new DepartmentOfSainikWelfarePuducherry.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(DepartmentOfSainikWelfarePuducherry.AcademicCertificateSchemaCertificateData);
    });
