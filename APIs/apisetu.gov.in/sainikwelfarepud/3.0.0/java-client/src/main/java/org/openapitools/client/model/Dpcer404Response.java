...
public class Dpcer404Response {
  ...
  public Dpcer404Response() {
  }

  public Dpcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpcer404Response dpcer404Response = (Dpcer404Response) o;
    return Objects.equals(this.error, dpcer404Response.error) &&
        Objects.equals(this.errorDescription, dpcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpcer404Response is not found in the empty JSON string", Dpcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpcer404Response>() {
           @Override
           public void write(JsonWriter out, Dpcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpcer404Response
   * @throws IOException if the JSON string is invalid with respect to Dpcer404Response
   */
  public static Dpcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpcer404Response.class);
  }

  /**
   * Convert an instance of Dpcer404Response to an JSON string
   *
   * @return JSON string
   */
