...
public class Dpcer504Response {
  ...
  public Dpcer504Response() {
  }

  public Dpcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpcer504Response dpcer504Response = (Dpcer504Response) o;
    return Objects.equals(this.error, dpcer504Response.error) &&
        Objects.equals(this.errorDescription, dpcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpcer504Response is not found in the empty JSON string", Dpcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpcer504Response>() {
           @Override
           public void write(JsonWriter out, Dpcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpcer504Response
   * @throws IOException if the JSON string is invalid with respect to Dpcer504Response
   */
  public static Dpcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpcer504Response.class);
  }

  /**
   * Convert an instance of Dpcer504Response to an JSON string
   *
   * @return JSON string
   */
