...
public class Dpcer502Response {
  ...
  public Dpcer502Response() {
  }

  public Dpcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpcer502Response dpcer502Response = (Dpcer502Response) o;
    return Objects.equals(this.error, dpcer502Response.error) &&
        Objects.equals(this.errorDescription, dpcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpcer502Response is not found in the empty JSON string", Dpcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpcer502Response>() {
           @Override
           public void write(JsonWriter out, Dpcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpcer502Response
   * @throws IOException if the JSON string is invalid with respect to Dpcer502Response
   */
  public static Dpcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpcer502Response.class);
  }

  /**
   * Convert an instance of Dpcer502Response to an JSON string
   *
   * @return JSON string
   */
