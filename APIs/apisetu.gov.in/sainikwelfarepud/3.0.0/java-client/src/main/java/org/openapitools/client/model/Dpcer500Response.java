...
public class Dpcer500Response {
  ...
  public Dpcer500Response() {
  }

  public Dpcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpcer500Response dpcer500Response = (Dpcer500Response) o;
    return Objects.equals(this.error, dpcer500Response.error) &&
        Objects.equals(this.errorDescription, dpcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpcer500Response is not found in the empty JSON string", Dpcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpcer500Response>() {
           @Override
           public void write(JsonWriter out, Dpcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpcer500Response
   * @throws IOException if the JSON string is invalid with respect to Dpcer500Response
   */
  public static Dpcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpcer500Response.class);
  }

  /**
   * Convert an instance of Dpcer500Response to an JSON string
   *
   * @return JSON string
   */
