...
public class Dpcer401Response {
  ...
  public Dpcer401Response() {
  }

  public Dpcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpcer401Response dpcer401Response = (Dpcer401Response) o;
    return Objects.equals(this.error, dpcer401Response.error) &&
        Objects.equals(this.errorDescription, dpcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpcer401Response is not found in the empty JSON string", Dpcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpcer401Response>() {
           @Override
           public void write(JsonWriter out, Dpcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpcer401Response
   * @throws IOException if the JSON string is invalid with respect to Dpcer401Response
   */
  public static Dpcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpcer401Response.class);
  }

  /**
   * Convert an instance of Dpcer401Response to an JSON string
   *
   * @return JSON string
   */
