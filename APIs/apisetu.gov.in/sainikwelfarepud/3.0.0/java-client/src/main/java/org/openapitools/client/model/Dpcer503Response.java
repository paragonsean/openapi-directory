...
public class Dpcer503Response {
  ...
  public Dpcer503Response() {
  }

  public Dpcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpcer503Response dpcer503Response = (Dpcer503Response) o;
    return Objects.equals(this.error, dpcer503Response.error) &&
        Objects.equals(this.errorDescription, dpcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpcer503Response is not found in the empty JSON string", Dpcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpcer503Response>() {
           @Override
           public void write(JsonWriter out, Dpcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpcer503Response
   * @throws IOException if the JSON string is invalid with respect to Dpcer503Response
   */
  public static Dpcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpcer503Response.class);
  }

  /**
   * Convert an instance of Dpcer503Response to an JSON string
   *
   * @return JSON string
   */
