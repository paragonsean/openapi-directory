...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/sainikwelfarepud/v3");
    ...
    DpcerRequest dpcerRequest = new DpcerRequest(); // DpcerRequest | Request format
    try {
      apiInstance.dpcer(dpcerRequest);
