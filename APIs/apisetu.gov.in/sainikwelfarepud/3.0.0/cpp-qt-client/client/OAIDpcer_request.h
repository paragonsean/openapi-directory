...
#ifndef OAIDpcer_request_H
#define OAIDpcer_request_H
...
namespace OpenAPI {
class OAIDpcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIDpcer_request : public OAIObject {
public:
    OAIDpcer_request();
    OAIDpcer_request(QString json);
    ~OAIDpcer_request() override;
    ...
    OAIDpcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIDpcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIDpcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpcer_request)

#endif // OAIDpcer_request_H
