...
public:
    ...
    /**
    * @param[in]  oai_dpcer_request OAIDpcer_request [optional]
    */
    virtual void dpcer(const ::OpenAPI::OptionalParam<OAIDpcer_request> &oai_dpcer_request = ::OpenAPI::OptionalParam<OAIDpcer_request>());
