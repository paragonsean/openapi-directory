...
OAIDpcer_request::OAIDpcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDpcer_request::OAIDpcer_request() {
    this->initializeModel();
}

OAIDpcer_request::~OAIDpcer_request() {}

void OAIDpcer_request::initializeModel() {
...
void OAIDpcer_request::fromJson(QString jsonString) {
...
void OAIDpcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIDpcer_request::asJson() const {
...
QJsonObject OAIDpcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDpcer_request_certificateParameters OAIDpcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDpcer_request::setCertificateParameters(const OAIDpcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDpcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDpcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDpcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDpcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDpcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDpcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDpcer_request::getFormat() const {
    return m_format;
}
void OAIDpcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDpcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDpcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDpcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIDpcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDpcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDpcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDpcer_request::isSet() const {
...
bool OAIDpcer_request::isValid() const {
