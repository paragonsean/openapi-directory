...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfTechnologyArunachalPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new NationalInstituteOfTechnologyArunachalPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(NationalInstituteOfTechnologyArunachalPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
