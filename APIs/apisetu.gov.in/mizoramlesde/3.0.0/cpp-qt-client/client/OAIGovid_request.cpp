...
OAIGovid_request::OAIGovid_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGovid_request::OAIGovid_request() {
    this->initializeModel();
}

OAIGovid_request::~OAIGovid_request() {}

void OAIGovid_request::initializeModel() {
...
void OAIGovid_request::fromJson(QString jsonString) {
...
void OAIGovid_request::fromJsonObject(QJsonObject json) {
...
QString OAIGovid_request::asJson() const {
...
QJsonObject OAIGovid_request::asJsonObject() const {
    QJsonObject obj;
...
OAIGovid_request_certificateParameters OAIGovid_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIGovid_request::setCertificateParameters(const OAIGovid_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIGovid_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIGovid_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIGovid_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIGovid_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIGovid_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIGovid_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIGovid_request::getFormat() const {
    return m_format;
}
void OAIGovid_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIGovid_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIGovid_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIGovid_request::getTxnId() const {
    return m_txn_id;
}
void OAIGovid_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIGovid_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIGovid_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIGovid_request::isSet() const {
...
bool OAIGovid_request::isValid() const {
