...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LabourEmploymentSkillDevelopmentAndEntrepreneurshipMizoram.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new LabourEmploymentSkillDevelopmentAndEntrepreneurshipMizoram.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(LabourEmploymentSkillDevelopmentAndEntrepreneurshipMizoram.AcademicCertificateSchemaIssuedToPersonAddress);
    });
