...
OAIPrcpt_request::OAIPrcpt_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPrcpt_request::OAIPrcpt_request() {
    this->initializeModel();
}

OAIPrcpt_request::~OAIPrcpt_request() {}

void OAIPrcpt_request::initializeModel() {
...
void OAIPrcpt_request::fromJson(QString jsonString) {
...
void OAIPrcpt_request::fromJsonObject(QJsonObject json) {
...
QString OAIPrcpt_request::asJson() const {
...
QJsonObject OAIPrcpt_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPrcpt_request_certificateParameters OAIPrcpt_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIPrcpt_request::setCertificateParameters(const OAIPrcpt_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIPrcpt_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIPrcpt_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIPrcpt_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIPrcpt_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIPrcpt_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIPrcpt_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIPrcpt_request::getFormat() const {
    return m_format;
}
void OAIPrcpt_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPrcpt_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPrcpt_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPrcpt_request::getTxnId() const {
    return m_txn_id;
}
void OAIPrcpt_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIPrcpt_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIPrcpt_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIPrcpt_request::isSet() const {
...
bool OAIPrcpt_request::isValid() const {
