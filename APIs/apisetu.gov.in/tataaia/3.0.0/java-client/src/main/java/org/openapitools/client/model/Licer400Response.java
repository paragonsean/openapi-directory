...
public class Licer400Response {
  ...
  public Licer400Response() {
  }

  public Licer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Licer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Licer400Response licer400Response = (Licer400Response) o;
    return Objects.equals(this.error, licer400Response.error) &&
        Objects.equals(this.errorDescription, licer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Licer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Licer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Licer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Licer400Response is not found in the empty JSON string", Licer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Licer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Licer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Licer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Licer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Licer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Licer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Licer400Response>() {
           @Override
           public void write(JsonWriter out, Licer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Licer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Licer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Licer400Response
   * @throws IOException if the JSON string is invalid with respect to Licer400Response
   */
  public static Licer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Licer400Response.class);
  }

  /**
   * Convert an instance of Licer400Response to an JSON string
   *
   * @return JSON string
   */
