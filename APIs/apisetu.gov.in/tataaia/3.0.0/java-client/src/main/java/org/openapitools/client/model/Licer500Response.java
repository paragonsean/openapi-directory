...
public class Licer500Response {
  ...
  public Licer500Response() {
  }

  public Licer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Licer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Licer500Response licer500Response = (Licer500Response) o;
    return Objects.equals(this.error, licer500Response.error) &&
        Objects.equals(this.errorDescription, licer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Licer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Licer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Licer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Licer500Response is not found in the empty JSON string", Licer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Licer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Licer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Licer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Licer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Licer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Licer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Licer500Response>() {
           @Override
           public void write(JsonWriter out, Licer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Licer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Licer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Licer500Response
   * @throws IOException if the JSON string is invalid with respect to Licer500Response
   */
  public static Licer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Licer500Response.class);
  }

  /**
   * Convert an instance of Licer500Response to an JSON string
   *
   * @return JSON string
   */
