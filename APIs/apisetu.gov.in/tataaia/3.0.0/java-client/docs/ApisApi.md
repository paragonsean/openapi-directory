...
| [**prcpt**](ApisApi.md#prcpt) | **POST** /prcpt/certificate | Premium Receipt |
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    PrcptRequest prcptRequest = new PrcptRequest(); // PrcptRequest | Request format
    try {
      apiInstance.prcpt(prcptRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#prcpt");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **prcptRequest** | [**PrcptRequest**](PrcptRequest.md)| Request format | [optional] |
