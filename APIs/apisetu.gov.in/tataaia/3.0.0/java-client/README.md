...
- API version: 3.0.0
  - Build date: 2024-10-12T12:37:07.064524-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/tataaia/v3");
...
*ApisApi* | [**prcpt**](docs/ApisApi.md#prcpt) | **POST** /prcpt/certificate | Premium Receipt
...
## Documentation for Models
 ...
 - [PrcptRequest](docs/PrcptRequest.md)
 - [PrcptRequestCertificateParameters](docs/PrcptRequestCertificateParameters.md)
