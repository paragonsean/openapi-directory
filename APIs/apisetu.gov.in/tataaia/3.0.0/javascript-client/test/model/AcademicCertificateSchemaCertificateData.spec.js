...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TataAiaLifeInsuranceCoLtd.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new TataAiaLifeInsuranceCoLtd.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(TataAiaLifeInsuranceCoLtd.AcademicCertificateSchemaCertificateData);
    });
