...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TataAiaLifeInsuranceCoLtd.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new TataAiaLifeInsuranceCoLtd.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(TataAiaLifeInsuranceCoLtd.ConsentArtifactSchemaConsentPermission);
    });
