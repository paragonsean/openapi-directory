...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TataAiaLifeInsuranceCoLtd.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new TataAiaLifeInsuranceCoLtd.ConsentArtifactSchema();
      //expect(instance).to.be.a(TataAiaLifeInsuranceCoLtd.ConsentArtifactSchema);
    });
