...
/**
 * The AcademicCertificateSchemaIssuedToPersonAddress model module.
 * @module model/AcademicCertificateSchemaIssuedToPersonAddress
 * @version 3.0.0
 */
class AcademicCertificateSchemaIssuedToPersonAddress {
    /**
     * Constructs a new <code>AcademicCertificateSchemaIssuedToPersonAddress</code>.
     * @alias module:model/AcademicCertificateSchemaIssuedToPersonAddress
    ...
    constructor(country, district, house, landmark, line1, line2, locality, pin, state, type, vtc) { 
        ...
        AcademicCertificateSchemaIssuedToPersonAddress.initialize(this, country, district, house, landmark, line1, line2, locality, pin, state, type, vtc);
    }
    ...
    /**
     * Constructs a <code>AcademicCertificateSchemaIssuedToPersonAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AcademicCertificateSchemaIssuedToPersonAddress} obj Optional instance to populate.
     * @return {module:model/AcademicCertificateSchemaIssuedToPersonAddress} The populated <code>AcademicCertificateSchemaIssuedToPersonAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AcademicCertificateSchemaIssuedToPersonAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>AcademicCertificateSchemaIssuedToPersonAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AcademicCertificateSchemaIssuedToPersonAddress</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AcademicCertificateSchemaIssuedToPersonAddress.RequiredProperties) {
...
AcademicCertificateSchemaIssuedToPersonAddress.RequiredProperties = ["country", "district", "house", "landmark", "line1", "line2", "locality", "pin", "state", "type", "vtc"];

/**
 * @member {String} country
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['country'] = undefined;

/**
 * @member {String} district
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['district'] = undefined;

/**
 * @member {String} house
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['house'] = undefined;

/**
 * @member {String} landmark
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['landmark'] = undefined;

/**
 * @member {String} line1
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['line1'] = undefined;

/**
 * @member {String} line2
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['line2'] = undefined;

/**
 * @member {String} locality
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['locality'] = undefined;

/**
 * @member {String} pin
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['pin'] = undefined;

/**
 * @member {String} state
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['state'] = undefined;

/**
 * @member {String} type
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['type'] = undefined;

/**
 * @member {String} vtc
 */
AcademicCertificateSchemaIssuedToPersonAddress.prototype['vtc'] = undefined;
...
export default AcademicCertificateSchemaIssuedToPersonAddress;
