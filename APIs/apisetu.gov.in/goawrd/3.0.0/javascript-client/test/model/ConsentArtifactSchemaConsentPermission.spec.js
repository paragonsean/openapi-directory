...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoaWaterResourcesDepartmentGoa.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new GoaWaterResourcesDepartmentGoa.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(GoaWaterResourcesDepartmentGoa.ConsentArtifactSchemaConsentPermission);
    });
