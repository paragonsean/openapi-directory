...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoaWaterResourcesDepartmentGoa.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new GoaWaterResourcesDepartmentGoa.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(GoaWaterResourcesDepartmentGoa.AcademicCertificateSchemaCertificateData);
    });
