...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoaWaterResourcesDepartmentGoa.ErcerRequestCertificateParameters();
  });
  ...
  describe('ErcerRequestCertificateParameters', function() {
    it('should create an instance of ErcerRequestCertificateParameters', function() {
      // uncomment below and update the code to test ErcerRequestCertificateParameters
      //var instance = new GoaWaterResourcesDepartmentGoa.ErcerRequestCertificateParameters();
      //expect(instance).to.be.a(GoaWaterResourcesDepartmentGoa.ErcerRequestCertificateParameters);
    });
