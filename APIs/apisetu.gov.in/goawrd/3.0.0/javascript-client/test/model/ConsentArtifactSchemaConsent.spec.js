...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoaWaterResourcesDepartmentGoa.ConsentArtifactSchemaConsent();
  });
  ...
  describe('ConsentArtifactSchemaConsent', function() {
    it('should create an instance of ConsentArtifactSchemaConsent', function() {
      ...
      //var instance = new GoaWaterResourcesDepartmentGoa.ConsentArtifactSchemaConsent();
      //expect(instance).to.be.a(GoaWaterResourcesDepartmentGoa.ConsentArtifactSchemaConsent);
    });
