...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoaWaterResourcesDepartmentGoa.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new GoaWaterResourcesDepartmentGoa.ConsentArtifactSchema();
      //expect(instance).to.be.a(GoaWaterResourcesDepartmentGoa.ConsentArtifactSchema);
    });
