...
/**
 * The Ercer400Response model module.
 * @module model/Ercer400Response
 * @version 3.0.0
 */
class Ercer400Response {
    /**
     * Constructs a new <code>Ercer400Response</code>.
     * @alias module:model/Ercer400Response
     */
    constructor() { 
        
        Ercer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ercer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ercer400Response} obj Optional instance to populate.
     * @return {module:model/Ercer400Response} The populated <code>Ercer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ercer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Ercer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ercer400Response</code>.
     */
...
/**
 * @member {module:model/Ercer400Response.ErrorEnum} error
 */
Ercer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Ercer400Response.ErrorDescriptionEnum} errorDescription
 */
Ercer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Ercer400Response['ErrorDescriptionEnum'] = {
...
export default Ercer400Response;
