...
public class Ercer404Response {
  ...
  public Ercer404Response() {
  }

  public Ercer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer404Response ercer404Response = (Ercer404Response) o;
    return Objects.equals(this.error, ercer404Response.error) &&
        Objects.equals(this.errorDescription, ercer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer404Response is not found in the empty JSON string", Ercer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer404Response>() {
           @Override
           public void write(JsonWriter out, Ercer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer404Response
   * @throws IOException if the JSON string is invalid with respect to Ercer404Response
   */
  public static Ercer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer404Response.class);
  }

  /**
   * Convert an instance of Ercer404Response to an JSON string
   *
   * @return JSON string
   */
