...
public class Ercer500Response {
  ...
  public Ercer500Response() {
  }

  public Ercer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer500Response ercer500Response = (Ercer500Response) o;
    return Objects.equals(this.error, ercer500Response.error) &&
        Objects.equals(this.errorDescription, ercer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer500Response is not found in the empty JSON string", Ercer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer500Response>() {
           @Override
           public void write(JsonWriter out, Ercer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer500Response
   * @throws IOException if the JSON string is invalid with respect to Ercer500Response
   */
  public static Ercer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer500Response.class);
  }

  /**
   * Convert an instance of Ercer500Response to an JSON string
   *
   * @return JSON string
   */
