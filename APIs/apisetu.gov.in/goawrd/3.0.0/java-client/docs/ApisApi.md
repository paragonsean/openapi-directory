...
public class Example {
  public static void main(String[] args) {
    ...
    ErcerRequest ercerRequest = new ErcerRequest(); // ErcerRequest | Request format
    try {
      apiInstance.pfdaw(ercerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#pfdaw");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ErcerRequest ercerRequest = new ErcerRequest(); // ErcerRequest | Request format
    try {
      apiInstance.tpcer(ercerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#tpcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
