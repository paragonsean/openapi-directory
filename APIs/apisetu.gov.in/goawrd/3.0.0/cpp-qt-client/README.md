...
OAIErcer_request Example::create(){
    OAIErcer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::ercerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::ercerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIErcer_request oai_ercer_request = create(); // OAIErcer_request | Request format
      apiInstance.ercer(oai_ercer_request);
