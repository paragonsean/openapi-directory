...
/*
 * OAIErcer_503_response.h
 *
 * 
 */

#ifndef OAIErcer_503_response_H
#define OAIErcer_503_response_H
...
class OAIErcer_503_response : public OAIObject {
public:
    OAIErcer_503_response();
    OAIErcer_503_response(QString json);
    ~OAIErcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErcer_503_response)

#endif // OAIErcer_503_response_H
