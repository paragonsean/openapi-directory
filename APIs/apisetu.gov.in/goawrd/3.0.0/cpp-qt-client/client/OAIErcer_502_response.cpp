...
OAIErcer_502_response::OAIErcer_502_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErcer_502_response::OAIErcer_502_response() {
    this->initializeModel();
}

OAIErcer_502_response::~OAIErcer_502_response() {}

void OAIErcer_502_response::initializeModel() {
...
void OAIErcer_502_response::fromJson(QString jsonString) {
...
void OAIErcer_502_response::fromJsonObject(QJsonObject json) {
...
QString OAIErcer_502_response::asJson() const {
...
QJsonObject OAIErcer_502_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIErcer_502_response::getError() const {
    return m_error;
}
void OAIErcer_502_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIErcer_502_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIErcer_502_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIErcer_502_response::getErrorDescription() const {
    return m_error_description;
}
void OAIErcer_502_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIErcer_502_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIErcer_502_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIErcer_502_response::isSet() const {
...
bool OAIErcer_502_response::isValid() const {
