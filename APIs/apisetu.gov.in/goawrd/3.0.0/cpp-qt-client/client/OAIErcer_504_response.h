...
/*
 * OAIErcer_504_response.h
 *
 * 
 */

#ifndef OAIErcer_504_response_H
#define OAIErcer_504_response_H
...
class OAIErcer_504_response : public OAIObject {
public:
    OAIErcer_504_response();
    OAIErcer_504_response(QString json);
    ~OAIErcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErcer_504_response)

#endif // OAIErcer_504_response_H
