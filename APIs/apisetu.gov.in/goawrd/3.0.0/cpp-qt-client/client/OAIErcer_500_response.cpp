...
OAIErcer_500_response::OAIErcer_500_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIErcer_500_response::OAIErcer_500_response() {
    this->initializeModel();
}

OAIErcer_500_response::~OAIErcer_500_response() {}

void OAIErcer_500_response::initializeModel() {
...
void OAIErcer_500_response::fromJson(QString jsonString) {
...
void OAIErcer_500_response::fromJsonObject(QJsonObject json) {
...
QString OAIErcer_500_response::asJson() const {
...
QJsonObject OAIErcer_500_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIErcer_500_response::getError() const {
    return m_error;
}
void OAIErcer_500_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIErcer_500_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIErcer_500_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIErcer_500_response::getErrorDescription() const {
    return m_error_description;
}
void OAIErcer_500_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIErcer_500_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIErcer_500_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIErcer_500_response::isSet() const {
...
bool OAIErcer_500_response::isValid() const {
