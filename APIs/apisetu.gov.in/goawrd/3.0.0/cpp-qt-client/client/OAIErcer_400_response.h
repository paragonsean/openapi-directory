...
/*
 * OAIErcer_400_response.h
 *
 * 
 */

#ifndef OAIErcer_400_response_H
#define OAIErcer_400_response_H
...
class OAIErcer_400_response : public OAIObject {
public:
    OAIErcer_400_response();
    OAIErcer_400_response(QString json);
    ~OAIErcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErcer_400_response)

#endif // OAIErcer_400_response_H
