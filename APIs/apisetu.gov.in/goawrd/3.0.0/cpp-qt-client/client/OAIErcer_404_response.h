...
/*
 * OAIErcer_404_response.h
 *
 * 
 */

#ifndef OAIErcer_404_response_H
#define OAIErcer_404_response_H
...
class OAIErcer_404_response : public OAIObject {
public:
    OAIErcer_404_response();
    OAIErcer_404_response(QString json);
    ~OAIErcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErcer_404_response)

#endif // OAIErcer_404_response_H
