...
/*
 * OAIErcer_500_response.h
 *
 * 
 */

#ifndef OAIErcer_500_response_H
#define OAIErcer_500_response_H
...
class OAIErcer_500_response : public OAIObject {
public:
    OAIErcer_500_response();
    OAIErcer_500_response(QString json);
    ~OAIErcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIErcer_500_response)

#endif // OAIErcer_500_response_H
