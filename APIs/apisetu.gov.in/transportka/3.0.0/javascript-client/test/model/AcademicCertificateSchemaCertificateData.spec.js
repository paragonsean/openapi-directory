...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaDepartmentOfTransportKarnataka.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new KarnatakaDepartmentOfTransportKarnataka.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(KarnatakaDepartmentOfTransportKarnataka.AcademicCertificateSchemaCertificateData);
    });
