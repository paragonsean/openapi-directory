...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaDepartmentOfTransportKarnataka.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new KarnatakaDepartmentOfTransportKarnataka.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(KarnatakaDepartmentOfTransportKarnataka.ConsentArtifactSchemaConsentUser);
    });
