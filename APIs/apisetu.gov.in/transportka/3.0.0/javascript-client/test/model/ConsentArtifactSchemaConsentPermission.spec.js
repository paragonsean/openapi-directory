...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaDepartmentOfTransportKarnataka.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new KarnatakaDepartmentOfTransportKarnataka.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(KarnatakaDepartmentOfTransportKarnataka.ConsentArtifactSchemaConsentPermission);
    });
