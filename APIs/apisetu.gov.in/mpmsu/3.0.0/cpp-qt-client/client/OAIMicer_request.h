...
#ifndef OAIMicer_request_H
#define OAIMicer_request_H
...
namespace OpenAPI {
class OAIMicer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIMicer_request : public OAIObject {
public:
    OAIMicer_request();
    OAIMicer_request(QString json);
    ~OAIMicer_request() override;
    ...
    OAIMicer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIMicer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIMicer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMicer_request)

#endif // OAIMicer_request_H
