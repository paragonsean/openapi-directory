...
OAIMicer_request::OAIMicer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMicer_request::OAIMicer_request() {
    this->initializeModel();
}

OAIMicer_request::~OAIMicer_request() {}

void OAIMicer_request::initializeModel() {
...
void OAIMicer_request::fromJson(QString jsonString) {
...
void OAIMicer_request::fromJsonObject(QJsonObject json) {
...
QString OAIMicer_request::asJson() const {
...
QJsonObject OAIMicer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIMicer_request_certificateParameters OAIMicer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIMicer_request::setCertificateParameters(const OAIMicer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIMicer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIMicer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIMicer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIMicer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIMicer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIMicer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIMicer_request::getFormat() const {
    return m_format;
}
void OAIMicer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIMicer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIMicer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIMicer_request::getTxnId() const {
    return m_txn_id;
}
void OAIMicer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIMicer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIMicer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIMicer_request::isSet() const {
...
bool OAIMicer_request::isValid() const {
