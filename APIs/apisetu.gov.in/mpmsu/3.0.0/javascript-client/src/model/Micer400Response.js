...
/**
 * The Micer400Response model module.
 * @module model/Micer400Response
 * @version 3.0.0
 */
class Micer400Response {
    /**
     * Constructs a new <code>Micer400Response</code>.
     * @alias module:model/Micer400Response
     */
    constructor() { 
        
        Micer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Micer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Micer400Response} obj Optional instance to populate.
     * @return {module:model/Micer400Response} The populated <code>Micer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Micer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Micer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Micer400Response</code>.
     */
...
/**
 * @member {module:model/Micer400Response.ErrorEnum} error
 */
Micer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Micer400Response.ErrorDescriptionEnum} errorDescription
 */
Micer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Micer400Response['ErrorDescriptionEnum'] = {
...
export default Micer400Response;
