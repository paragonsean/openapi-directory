...
/**
 * The Dpicr400Response model module.
 * @module model/Dpicr400Response
 * @version 3.0.0
 */
class Dpicr400Response {
    /**
     * Constructs a new <code>Dpicr400Response</code>.
     * @alias module:model/Dpicr400Response
     */
    constructor() { 
        
        Dpicr400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Dpicr400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Dpicr400Response} obj Optional instance to populate.
     * @return {module:model/Dpicr400Response} The populated <code>Dpicr400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Dpicr400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Dpicr400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Dpicr400Response</code>.
     */
...
/**
 * @member {module:model/Dpicr400Response.ErrorEnum} error
 */
Dpicr400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Dpicr400Response.ErrorDescriptionEnum} errorDescription
 */
Dpicr400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Dpicr400Response['ErrorDescriptionEnum'] = {
...
export default Dpicr400Response;
