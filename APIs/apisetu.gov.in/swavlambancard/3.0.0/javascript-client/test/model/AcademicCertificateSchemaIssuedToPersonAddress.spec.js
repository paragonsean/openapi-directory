...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfEmpowermentOfPersonsWithDisabilities.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new DepartmentOfEmpowermentOfPersonsWithDisabilities.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(DepartmentOfEmpowermentOfPersonsWithDisabilities.AcademicCertificateSchemaIssuedToPersonAddress);
    });
