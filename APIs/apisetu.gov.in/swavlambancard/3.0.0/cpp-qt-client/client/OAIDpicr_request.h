...
#ifndef OAIDpicr_request_H
#define OAIDpicr_request_H
...
class OAIDpicr_request : public OAIObject {
public:
    OAIDpicr_request();
    OAIDpicr_request(QString json);
    ~OAIDpicr_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpicr_request)

#endif // OAIDpicr_request_H
