...
/*
 * OAIDpicr_504_response.h
 *
 * 
 */

#ifndef OAIDpicr_504_response_H
#define OAIDpicr_504_response_H
...
class OAIDpicr_504_response : public OAIObject {
public:
    OAIDpicr_504_response();
    OAIDpicr_504_response(QString json);
    ~OAIDpicr_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpicr_504_response)

#endif // OAIDpicr_504_response_H
