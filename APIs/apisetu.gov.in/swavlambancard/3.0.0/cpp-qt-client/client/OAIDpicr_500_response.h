...
/*
 * OAIDpicr_500_response.h
 *
 * 
 */

#ifndef OAIDpicr_500_response_H
#define OAIDpicr_500_response_H
...
class OAIDpicr_500_response : public OAIObject {
public:
    OAIDpicr_500_response();
    OAIDpicr_500_response(QString json);
    ~OAIDpicr_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpicr_500_response)

#endif // OAIDpicr_500_response_H
