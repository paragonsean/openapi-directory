...
/*
 * OAIDpicr_503_response.h
 *
 * 
 */

#ifndef OAIDpicr_503_response_H
#define OAIDpicr_503_response_H
...
class OAIDpicr_503_response : public OAIObject {
public:
    OAIDpicr_503_response();
    OAIDpicr_503_response(QString json);
    ~OAIDpicr_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpicr_503_response)

#endif // OAIDpicr_503_response_H
