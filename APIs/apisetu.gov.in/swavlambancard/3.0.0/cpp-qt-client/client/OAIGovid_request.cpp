...
OAIDpicr_request_certificateParameters OAIGovid_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIGovid_request::setCertificateParameters(const OAIDpicr_request_certificateParameters &certificate_parameters) {
