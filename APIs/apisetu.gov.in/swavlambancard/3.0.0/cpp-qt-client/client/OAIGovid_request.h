...
#ifndef OAIGovid_request_H
#define OAIGovid_request_H
...
namespace OpenAPI {
class OAIDpicr_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIGovid_request : public OAIObject {
public:
    OAIGovid_request();
    OAIGovid_request(QString json);
    ~OAIGovid_request() override;
    ...
    OAIDpicr_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIDpicr_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIDpicr_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGovid_request)

#endif // OAIGovid_request_H
