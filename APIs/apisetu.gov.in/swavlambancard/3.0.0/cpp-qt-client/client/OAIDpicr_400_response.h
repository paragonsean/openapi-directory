...
/*
 * OAIDpicr_400_response.h
 *
 * 
 */

#ifndef OAIDpicr_400_response_H
#define OAIDpicr_400_response_H
...
class OAIDpicr_400_response : public OAIObject {
public:
    OAIDpicr_400_response();
    OAIDpicr_400_response(QString json);
    ~OAIDpicr_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpicr_400_response)

#endif // OAIDpicr_400_response_H
