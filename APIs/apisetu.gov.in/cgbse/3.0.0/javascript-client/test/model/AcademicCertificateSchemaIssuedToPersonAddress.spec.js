...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ChhattisgarhStateBoardOfSecondaryEducationChhattisgarh.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new ChhattisgarhStateBoardOfSecondaryEducationChhattisgarh.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(ChhattisgarhStateBoardOfSecondaryEducationChhattisgarh.AcademicCertificateSchemaIssuedToPersonAddress);
    });
