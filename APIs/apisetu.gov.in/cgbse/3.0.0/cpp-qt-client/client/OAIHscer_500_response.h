...
/*
 * OAIHscer_500_response.h
 *
 * 
 */

#ifndef OAIHscer_500_response_H
#define OAIHscer_500_response_H
...
class OAIHscer_500_response : public OAIObject {
public:
    OAIHscer_500_response();
    OAIHscer_500_response(QString json);
    ~OAIHscer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHscer_500_response)

#endif // OAIHscer_500_response_H
