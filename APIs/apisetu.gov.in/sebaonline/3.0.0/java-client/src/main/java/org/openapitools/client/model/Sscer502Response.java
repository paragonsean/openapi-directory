...
public class Sscer502Response {
  ...
  public Sscer502Response() {
  }

  public Sscer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Sscer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Sscer502Response sscer502Response = (Sscer502Response) o;
    return Objects.equals(this.error, sscer502Response.error) &&
        Objects.equals(this.errorDescription, sscer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Sscer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sscer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sscer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sscer502Response is not found in the empty JSON string", Sscer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sscer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sscer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sscer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sscer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sscer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sscer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Sscer502Response>() {
           @Override
           public void write(JsonWriter out, Sscer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sscer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sscer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sscer502Response
   * @throws IOException if the JSON string is invalid with respect to Sscer502Response
   */
  public static Sscer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sscer502Response.class);
  }

  /**
   * Convert an instance of Sscer502Response to an JSON string
   *
   * @return JSON string
   */
