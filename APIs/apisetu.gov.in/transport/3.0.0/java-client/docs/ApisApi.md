...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/transport/v3");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    FitcerRequest fitcerRequest = new FitcerRequest(); // FitcerRequest | Request format
    try {
      apiInstance.fitcer(fitcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#fitcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    RvcerRequest rvcerRequest = new RvcerRequest(); // RvcerRequest | Request format
    try {
      apiInstance.rvcer(rvcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#rvcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    VhinscRequest vhinscRequest = new VhinscRequest(); // VhinscRequest | Request format
    try {
      apiInstance.vhinsc(vhinscRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#vhinsc");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    VhtaxRequest vhtaxRequest = new VhtaxRequest(); // VhtaxRequest | Request format
    try {
      apiInstance.vhtax(vhtaxRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#vhtax");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
