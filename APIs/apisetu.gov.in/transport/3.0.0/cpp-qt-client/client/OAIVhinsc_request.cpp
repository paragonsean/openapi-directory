...
OAIVhinsc_request::OAIVhinsc_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVhinsc_request::OAIVhinsc_request() {
    this->initializeModel();
}

OAIVhinsc_request::~OAIVhinsc_request() {}

void OAIVhinsc_request::initializeModel() {
...
void OAIVhinsc_request::fromJson(QString jsonString) {
...
void OAIVhinsc_request::fromJsonObject(QJsonObject json) {
...
QString OAIVhinsc_request::asJson() const {
...
QJsonObject OAIVhinsc_request::asJsonObject() const {
    QJsonObject obj;
...
OAIVhinsc_request_certificateParameters OAIVhinsc_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIVhinsc_request::setCertificateParameters(const OAIVhinsc_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIVhinsc_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIVhinsc_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIVhinsc_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIVhinsc_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIVhinsc_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIVhinsc_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIVhinsc_request::getFormat() const {
    return m_format;
}
void OAIVhinsc_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIVhinsc_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIVhinsc_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIVhinsc_request::getTxnId() const {
    return m_txn_id;
}
void OAIVhinsc_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIVhinsc_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIVhinsc_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIVhinsc_request::isSet() const {
...
bool OAIVhinsc_request::isValid() const {
