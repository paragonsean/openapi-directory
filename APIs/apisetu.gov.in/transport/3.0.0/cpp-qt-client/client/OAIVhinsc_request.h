...
#ifndef OAIVhinsc_request_H
#define OAIVhinsc_request_H

#include <QJsonObject>

#include "OAIConsentArtifactSchema.h"
#include "OAIVhinsc_request_certificateParameters.h"
#include <QString>
...
namespace OpenAPI {
class OAIVhinsc_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIVhinsc_request : public OAIObject {
public:
    OAIVhinsc_request();
    OAIVhinsc_request(QString json);
    ~OAIVhinsc_request() override;
    ...
    OAIVhinsc_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIVhinsc_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIVhinsc_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVhinsc_request)

#endif // OAIVhinsc_request_H
