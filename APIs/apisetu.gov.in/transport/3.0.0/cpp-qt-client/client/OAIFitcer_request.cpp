...
OAIFitcer_request::OAIFitcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFitcer_request::OAIFitcer_request() {
    this->initializeModel();
}

OAIFitcer_request::~OAIFitcer_request() {}

void OAIFitcer_request::initializeModel() {
...
void OAIFitcer_request::fromJson(QString jsonString) {
...
void OAIFitcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIFitcer_request::asJson() const {
...
QJsonObject OAIFitcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIFitcer_request_certificateParameters OAIFitcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIFitcer_request::setCertificateParameters(const OAIFitcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIFitcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIFitcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIFitcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIFitcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIFitcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIFitcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIFitcer_request::getFormat() const {
    return m_format;
}
void OAIFitcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIFitcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIFitcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIFitcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIFitcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIFitcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIFitcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIFitcer_request::isSet() const {
...
bool OAIFitcer_request::isValid() const {
