...
#ifndef OAIFitcer_request_H
#define OAIFitcer_request_H
...
namespace OpenAPI {
class OAIFitcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIFitcer_request : public OAIObject {
public:
    OAIFitcer_request();
    OAIFitcer_request(QString json);
    ~OAIFitcer_request() override;
    ...
    OAIFitcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIFitcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIFitcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFitcer_request)

#endif // OAIFitcer_request_H
