...
OAIVhtax_request::OAIVhtax_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVhtax_request::OAIVhtax_request() {
    this->initializeModel();
}

OAIVhtax_request::~OAIVhtax_request() {}

void OAIVhtax_request::initializeModel() {
...
void OAIVhtax_request::fromJson(QString jsonString) {
...
void OAIVhtax_request::fromJsonObject(QJsonObject json) {
...
QString OAIVhtax_request::asJson() const {
...
QJsonObject OAIVhtax_request::asJsonObject() const {
    QJsonObject obj;
...
OAIVhtax_request_certificateParameters OAIVhtax_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIVhtax_request::setCertificateParameters(const OAIVhtax_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIVhtax_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIVhtax_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIVhtax_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIVhtax_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIVhtax_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIVhtax_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIVhtax_request::getFormat() const {
    return m_format;
}
void OAIVhtax_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIVhtax_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIVhtax_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIVhtax_request::getTxnId() const {
    return m_txn_id;
}
void OAIVhtax_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIVhtax_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIVhtax_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIVhtax_request::isSet() const {
...
bool OAIVhtax_request::isValid() const {
