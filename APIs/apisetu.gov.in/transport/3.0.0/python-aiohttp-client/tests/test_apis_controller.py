...
async def test_drvlc(client):
    ...
    response = await client.request(
        method='POST',
        path='/transport/v3/drvlc/certificate',
        headers=headers,
        json=body,
        )
...
async def test_fitcer(client):
    """Test case for fitcer

    Fitness Certificate
    """
    body = openapi_server.FitcerRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'clientId': 'special-key',
    ...
    response = await client.request(
        method='POST',
        path='/transport/v3/fitcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_rvcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/transport/v3/rvcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vhinsc(client):
    """Test case for vhinsc

    Vehicle Insurance Certificate
    """
    body = openapi_server.VhinscRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'clientId': 'special-key',
    ...
    response = await client.request(
        method='POST',
        path='/transport/v3/vhinsc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vhtax(client):
    """Test case for vhtax

    Vehicle Tax Receipt
    """
    body = openapi_server.VhtaxRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'clientId': 'special-key',
    ...
    response = await client.request(
        method='POST',
        path='/transport/v3/vhtax/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
