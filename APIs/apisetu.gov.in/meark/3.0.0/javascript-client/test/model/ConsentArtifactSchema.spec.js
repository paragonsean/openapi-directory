...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MearkEnterprisePvtLtd.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new MearkEnterprisePvtLtd.ConsentArtifactSchema();
      //expect(instance).to.be.a(MearkEnterprisePvtLtd.ConsentArtifactSchema);
    });
