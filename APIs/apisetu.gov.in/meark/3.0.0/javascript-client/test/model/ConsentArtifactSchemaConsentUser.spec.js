...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MearkEnterprisePvtLtd.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new MearkEnterprisePvtLtd.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(MearkEnterprisePvtLtd.ConsentArtifactSchemaConsentUser);
    });
