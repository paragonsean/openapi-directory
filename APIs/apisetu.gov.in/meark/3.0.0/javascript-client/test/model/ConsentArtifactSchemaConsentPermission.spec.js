...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MearkEnterprisePvtLtd.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new MearkEnterprisePvtLtd.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(MearkEnterprisePvtLtd.ConsentArtifactSchemaConsentPermission);
    });
