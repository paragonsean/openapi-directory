...
public class Adcrd404Response {
  ...
  public Adcrd404Response() {
  }

  public Adcrd404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Adcrd404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Adcrd404Response adcrd404Response = (Adcrd404Response) o;
    return Objects.equals(this.error, adcrd404Response.error) &&
        Objects.equals(this.errorDescription, adcrd404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adcrd404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Adcrd404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Adcrd404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adcrd404Response is not found in the empty JSON string", Adcrd404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Adcrd404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Adcrd404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adcrd404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adcrd404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adcrd404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adcrd404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Adcrd404Response>() {
           @Override
           public void write(JsonWriter out, Adcrd404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Adcrd404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Adcrd404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Adcrd404Response
   * @throws IOException if the JSON string is invalid with respect to Adcrd404Response
   */
  public static Adcrd404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adcrd404Response.class);
  }

  /**
   * Convert an instance of Adcrd404Response to an JSON string
   *
   * @return JSON string
   */
