...
public class Adcrd500Response {
  ...
  public Adcrd500Response() {
  }

  public Adcrd500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Adcrd500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Adcrd500Response adcrd500Response = (Adcrd500Response) o;
    return Objects.equals(this.error, adcrd500Response.error) &&
        Objects.equals(this.errorDescription, adcrd500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adcrd500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Adcrd500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Adcrd500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adcrd500Response is not found in the empty JSON string", Adcrd500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Adcrd500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Adcrd500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adcrd500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adcrd500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adcrd500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adcrd500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Adcrd500Response>() {
           @Override
           public void write(JsonWriter out, Adcrd500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Adcrd500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Adcrd500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Adcrd500Response
   * @throws IOException if the JSON string is invalid with respect to Adcrd500Response
   */
  public static Adcrd500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adcrd500Response.class);
  }

  /**
   * Convert an instance of Adcrd500Response to an JSON string
   *
   * @return JSON string
   */
