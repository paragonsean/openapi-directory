...
public class Adcrd503Response {
  ...
  public Adcrd503Response() {
  }

  public Adcrd503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Adcrd503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Adcrd503Response adcrd503Response = (Adcrd503Response) o;
    return Objects.equals(this.error, adcrd503Response.error) &&
        Objects.equals(this.errorDescription, adcrd503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adcrd503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Adcrd503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Adcrd503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adcrd503Response is not found in the empty JSON string", Adcrd503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Adcrd503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Adcrd503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adcrd503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adcrd503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adcrd503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adcrd503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Adcrd503Response>() {
           @Override
           public void write(JsonWriter out, Adcrd503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Adcrd503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Adcrd503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Adcrd503Response
   * @throws IOException if the JSON string is invalid with respect to Adcrd503Response
   */
  public static Adcrd503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adcrd503Response.class);
  }

  /**
   * Convert an instance of Adcrd503Response to an JSON string
   *
   * @return JSON string
   */
