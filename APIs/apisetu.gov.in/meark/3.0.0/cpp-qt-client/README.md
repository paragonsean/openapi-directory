...
OAIAdcrd_request Example::create(){
    OAIAdcrd_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::adcrdSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::adcrdSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAdcrd_request oai_adcrd_request = create(); // OAIAdcrd_request | Request format
      apiInstance.adcrd(oai_adcrd_request);
