...
/*
 * OAIAdcrd_503_response.h
 *
 * 
 */

#ifndef OAIAdcrd_503_response_H
#define OAIAdcrd_503_response_H
...
class OAIAdcrd_503_response : public OAIObject {
public:
    OAIAdcrd_503_response();
    OAIAdcrd_503_response(QString json);
    ~OAIAdcrd_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdcrd_503_response)

#endif // OAIAdcrd_503_response_H
