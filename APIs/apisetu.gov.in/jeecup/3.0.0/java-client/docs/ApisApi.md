...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/jeecup/v3");
    ...
    AdcrdRequest adcrdRequest = new AdcrdRequest(); // AdcrdRequest | Request format
    try {
      apiInstance.adcrd(adcrdRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#adcrd");
