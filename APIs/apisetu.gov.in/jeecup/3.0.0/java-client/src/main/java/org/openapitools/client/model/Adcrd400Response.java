...
public class Adcrd400Response {
  ...
  public Adcrd400Response() {
  }

  public Adcrd400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Adcrd400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Adcrd400Response adcrd400Response = (Adcrd400Response) o;
    return Objects.equals(this.error, adcrd400Response.error) &&
        Objects.equals(this.errorDescription, adcrd400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adcrd400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Adcrd400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Adcrd400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adcrd400Response is not found in the empty JSON string", Adcrd400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Adcrd400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Adcrd400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adcrd400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adcrd400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adcrd400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adcrd400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Adcrd400Response>() {
           @Override
           public void write(JsonWriter out, Adcrd400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Adcrd400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Adcrd400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Adcrd400Response
   * @throws IOException if the JSON string is invalid with respect to Adcrd400Response
   */
  public static Adcrd400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adcrd400Response.class);
  }

  /**
   * Convert an instance of Adcrd400Response to an JSON string
   *
   * @return JSON string
   */
