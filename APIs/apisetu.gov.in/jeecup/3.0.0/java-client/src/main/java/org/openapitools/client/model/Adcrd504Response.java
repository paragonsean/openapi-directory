...
public class Adcrd504Response {
  ...
  public Adcrd504Response() {
  }

  public Adcrd504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Adcrd504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Adcrd504Response adcrd504Response = (Adcrd504Response) o;
    return Objects.equals(this.error, adcrd504Response.error) &&
        Objects.equals(this.errorDescription, adcrd504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adcrd504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Adcrd504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Adcrd504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adcrd504Response is not found in the empty JSON string", Adcrd504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Adcrd504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Adcrd504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adcrd504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adcrd504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adcrd504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adcrd504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Adcrd504Response>() {
           @Override
           public void write(JsonWriter out, Adcrd504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Adcrd504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Adcrd504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Adcrd504Response
   * @throws IOException if the JSON string is invalid with respect to Adcrd504Response
   */
  public static Adcrd504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adcrd504Response.class);
  }

  /**
   * Convert an instance of Adcrd504Response to an JSON string
   *
   * @return JSON string
   */
