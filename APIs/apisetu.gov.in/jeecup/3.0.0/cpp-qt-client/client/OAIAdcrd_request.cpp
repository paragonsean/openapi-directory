...
OAIAdcrd_request::OAIAdcrd_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdcrd_request::OAIAdcrd_request() {
    this->initializeModel();
}

OAIAdcrd_request::~OAIAdcrd_request() {}

void OAIAdcrd_request::initializeModel() {
...
void OAIAdcrd_request::fromJson(QString jsonString) {
...
void OAIAdcrd_request::fromJsonObject(QJsonObject json) {
...
QString OAIAdcrd_request::asJson() const {
...
QJsonObject OAIAdcrd_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAdcrd_request_certificateParameters OAIAdcrd_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIAdcrd_request::setCertificateParameters(const OAIAdcrd_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIAdcrd_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIAdcrd_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIAdcrd_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIAdcrd_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIAdcrd_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIAdcrd_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIAdcrd_request::getFormat() const {
    return m_format;
}
void OAIAdcrd_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIAdcrd_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIAdcrd_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIAdcrd_request::getTxnId() const {
    return m_txn_id;
}
void OAIAdcrd_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIAdcrd_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIAdcrd_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIAdcrd_request::isSet() const {
...
bool OAIAdcrd_request::isValid() const {
