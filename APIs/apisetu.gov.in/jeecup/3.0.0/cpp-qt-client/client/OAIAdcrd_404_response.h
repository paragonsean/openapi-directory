...
/*
 * OAIAdcrd_404_response.h
 *
 * 
 */

#ifndef OAIAdcrd_404_response_H
#define OAIAdcrd_404_response_H
...
class OAIAdcrd_404_response : public OAIObject {
public:
    OAIAdcrd_404_response();
    OAIAdcrd_404_response(QString json);
    ~OAIAdcrd_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdcrd_404_response)

#endif // OAIAdcrd_404_response_H
