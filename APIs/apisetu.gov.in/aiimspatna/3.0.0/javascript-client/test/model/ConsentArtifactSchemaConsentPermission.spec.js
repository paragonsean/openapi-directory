...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AiimsPatna.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new AiimsPatna.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(AiimsPatna.ConsentArtifactSchemaConsentPermission);
    });
