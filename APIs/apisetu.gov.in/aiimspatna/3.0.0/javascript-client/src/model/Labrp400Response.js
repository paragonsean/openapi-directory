...
/**
 * The Labrp400Response model module.
 * @module model/Labrp400Response
 * @version 3.0.0
 */
class Labrp400Response {
    /**
     * Constructs a new <code>Labrp400Response</code>.
     * @alias module:model/Labrp400Response
     */
    constructor() { 
        
        Labrp400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Labrp400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Labrp400Response} obj Optional instance to populate.
     * @return {module:model/Labrp400Response} The populated <code>Labrp400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Labrp400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Labrp400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Labrp400Response</code>.
     */
...
/**
 * @member {module:model/Labrp400Response.ErrorEnum} error
 */
Labrp400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Labrp400Response.ErrorDescriptionEnum} errorDescription
 */
Labrp400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Labrp400Response['ErrorDescriptionEnum'] = {
...
export default Labrp400Response;
