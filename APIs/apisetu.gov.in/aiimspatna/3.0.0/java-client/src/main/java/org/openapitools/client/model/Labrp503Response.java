...
public class Labrp503Response {
  ...
  public Labrp503Response() {
  }

  public Labrp503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Labrp503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Labrp503Response labrp503Response = (Labrp503Response) o;
    return Objects.equals(this.error, labrp503Response.error) &&
        Objects.equals(this.errorDescription, labrp503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Labrp503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Labrp503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Labrp503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Labrp503Response is not found in the empty JSON string", Labrp503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Labrp503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Labrp503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Labrp503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Labrp503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Labrp503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Labrp503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Labrp503Response>() {
           @Override
           public void write(JsonWriter out, Labrp503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Labrp503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Labrp503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Labrp503Response
   * @throws IOException if the JSON string is invalid with respect to Labrp503Response
   */
  public static Labrp503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Labrp503Response.class);
  }

  /**
   * Convert an instance of Labrp503Response to an JSON string
   *
   * @return JSON string
   */
