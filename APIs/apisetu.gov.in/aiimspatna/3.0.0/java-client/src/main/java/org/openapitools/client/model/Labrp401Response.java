...
public class Labrp401Response {
  ...
  public Labrp401Response() {
  }

  public Labrp401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Labrp401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Labrp401Response labrp401Response = (Labrp401Response) o;
    return Objects.equals(this.error, labrp401Response.error) &&
        Objects.equals(this.errorDescription, labrp401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Labrp401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Labrp401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Labrp401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Labrp401Response is not found in the empty JSON string", Labrp401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Labrp401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Labrp401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Labrp401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Labrp401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Labrp401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Labrp401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Labrp401Response>() {
           @Override
           public void write(JsonWriter out, Labrp401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Labrp401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Labrp401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Labrp401Response
   * @throws IOException if the JSON string is invalid with respect to Labrp401Response
   */
  public static Labrp401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Labrp401Response.class);
  }

  /**
   * Convert an instance of Labrp401Response to an JSON string
   *
   * @return JSON string
   */
