...
public class Labrp504Response {
  ...
  public Labrp504Response() {
  }

  public Labrp504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Labrp504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Labrp504Response labrp504Response = (Labrp504Response) o;
    return Objects.equals(this.error, labrp504Response.error) &&
        Objects.equals(this.errorDescription, labrp504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Labrp504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Labrp504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Labrp504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Labrp504Response is not found in the empty JSON string", Labrp504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Labrp504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Labrp504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Labrp504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Labrp504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Labrp504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Labrp504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Labrp504Response>() {
           @Override
           public void write(JsonWriter out, Labrp504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Labrp504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Labrp504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Labrp504Response
   * @throws IOException if the JSON string is invalid with respect to Labrp504Response
   */
  public static Labrp504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Labrp504Response.class);
  }

  /**
   * Convert an instance of Labrp504Response to an JSON string
   *
   * @return JSON string
   */
