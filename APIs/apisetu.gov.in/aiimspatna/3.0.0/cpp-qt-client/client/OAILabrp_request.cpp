...
OAILabrp_request::OAILabrp_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabrp_request::OAILabrp_request() {
    this->initializeModel();
}

OAILabrp_request::~OAILabrp_request() {}

void OAILabrp_request::initializeModel() {
...
void OAILabrp_request::fromJson(QString jsonString) {
...
void OAILabrp_request::fromJsonObject(QJsonObject json) {
...
QString OAILabrp_request::asJson() const {
...
QJsonObject OAILabrp_request::asJsonObject() const {
    QJsonObject obj;
...
OAILabrp_request_certificateParameters OAILabrp_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAILabrp_request::setCertificateParameters(const OAILabrp_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAILabrp_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAILabrp_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAILabrp_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAILabrp_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAILabrp_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAILabrp_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAILabrp_request::getFormat() const {
    return m_format;
}
void OAILabrp_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAILabrp_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAILabrp_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAILabrp_request::getTxnId() const {
    return m_txn_id;
}
void OAILabrp_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAILabrp_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAILabrp_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAILabrp_request::isSet() const {
...
bool OAILabrp_request::isValid() const {
