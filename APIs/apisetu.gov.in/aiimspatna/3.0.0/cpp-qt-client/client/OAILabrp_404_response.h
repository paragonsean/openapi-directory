...
/*
 * OAILabrp_404_response.h
 *
 * 
 */

#ifndef OAILabrp_404_response_H
#define OAILabrp_404_response_H
...
class OAILabrp_404_response : public OAIObject {
public:
    OAILabrp_404_response();
    OAILabrp_404_response(QString json);
    ~OAILabrp_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabrp_404_response)

#endif // OAILabrp_404_response_H
