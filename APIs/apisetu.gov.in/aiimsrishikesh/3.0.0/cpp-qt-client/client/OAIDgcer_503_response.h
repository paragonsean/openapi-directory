...
/*
 * OAIDgcer_503_response.h
 *
 * 
 */

#ifndef OAIDgcer_503_response_H
#define OAIDgcer_503_response_H
...
class OAIDgcer_503_response : public OAIObject {
public:
    OAIDgcer_503_response();
    OAIDgcer_503_response(QString json);
    ~OAIDgcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDgcer_503_response)

#endif // OAIDgcer_503_response_H
