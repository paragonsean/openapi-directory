# TransportDepartmentHaryana.APIsApi
...
```javascript
import TransportDepartmentHaryana from 'transport_department_haryana';
let defaultClient = TransportDepartmentHaryana.ApiClient.instance;
...
let apiInstance = new TransportDepartmentHaryana.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentHaryana.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentHaryana.RvcerRequest() // RvcerRequest | Request format
};
