...
public class Govid401Response {
  ...
  public Govid401Response() {
  }

  public Govid401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Govid401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Govid401Response govid401Response = (Govid401Response) o;
    return Objects.equals(this.error, govid401Response.error) &&
        Objects.equals(this.errorDescription, govid401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Govid401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Govid401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Govid401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Govid401Response is not found in the empty JSON string", Govid401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Govid401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Govid401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Govid401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Govid401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Govid401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Govid401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Govid401Response>() {
           @Override
           public void write(JsonWriter out, Govid401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Govid401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Govid401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Govid401Response
   * @throws IOException if the JSON string is invalid with respect to Govid401Response
   */
  public static Govid401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Govid401Response.class);
  }

  /**
   * Convert an instance of Govid401Response to an JSON string
   *
   * @return JSON string
   */
