...
namespace OpenAPI {
class OAIGovid_request_certificateParameters;
...
public:
    ...
    OAIGovid_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIGovid_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIGovid_request_certificateParameters m_certificate_parameters;
