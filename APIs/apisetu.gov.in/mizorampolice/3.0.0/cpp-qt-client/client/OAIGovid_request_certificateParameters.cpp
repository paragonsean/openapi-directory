...
void OAIGovid_request_certificateParameters::setCardNo(const QString &card_no) {
    m_card_no = card_no;
    m_card_no_isSet = true;
}

bool OAIGovid_request_certificateParameters::is_card_no_Set() const{
    return m_card_no_isSet;
}

bool OAIGovid_request_certificateParameters::is_card_no_Valid() const{
...
bool OAIGovid_request_certificateParameters::isValid() const {
    ...
    return m_card_no_isValid && m_full_name_isValid && true;
}
