...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MizoramPoliceMizoram.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new MizoramPoliceMizoram.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(MizoramPoliceMizoram.ConsentArtifactSchemaConsentUser);
    });
