...
/**
 * The Tdcer400Response model module.
 * @module model/Tdcer400Response
 * @version 3.0.0
 */
class Tdcer400Response {
    /**
     * Constructs a new <code>Tdcer400Response</code>.
     * @alias module:model/Tdcer400Response
     */
    constructor() { 
        
        Tdcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Tdcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Tdcer400Response} obj Optional instance to populate.
     * @return {module:model/Tdcer400Response} The populated <code>Tdcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Tdcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Tdcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Tdcer400Response</code>.
     */
...
/**
 * @member {module:model/Tdcer400Response.ErrorEnum} error
 */
Tdcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Tdcer400Response.ErrorDescriptionEnum} errorDescription
 */
Tdcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Tdcer400Response['ErrorDescriptionEnum'] = {
...
export default Tdcer400Response;
