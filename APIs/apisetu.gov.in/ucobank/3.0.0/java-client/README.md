...
UCO Bank
- API version: 3.0.0
  - Build date: 2024-10-12T12:36:02.173232-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/ucobank/v3");
    ...
    TdcerRequest tdcerRequest = new TdcerRequest(); // TdcerRequest | Request format
    try {
      apiInstance.tdcer(tdcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#tdcer");
...
------------ | ------------- | ------------- | -------------
*ApisApi* | [**tdcer**](docs/ApisApi.md#tdcer) | **POST** /tdcer/certificate | TDS Certificate
...
## Documentation for Models
 ...
 - [Tdcer400Response](docs/Tdcer400Response.md)
 - [Tdcer401Response](docs/Tdcer401Response.md)
 - [Tdcer404Response](docs/Tdcer404Response.md)
 - [Tdcer500Response](docs/Tdcer500Response.md)
 - [Tdcer502Response](docs/Tdcer502Response.md)
 - [Tdcer503Response](docs/Tdcer503Response.md)
 - [Tdcer504Response](docs/Tdcer504Response.md)
 - [TdcerRequest](docs/TdcerRequest.md)
 - [TdcerRequestCertificateParameters](docs/TdcerRequestCertificateParameters.md)
