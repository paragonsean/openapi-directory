...
#ifndef OAITdcer_request_H
#define OAITdcer_request_H
...
namespace OpenAPI {
class OAITdcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAITdcer_request : public OAIObject {
public:
    OAITdcer_request();
    OAITdcer_request(QString json);
    ~OAITdcer_request() override;
    ...
    OAITdcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAITdcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAITdcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAITdcer_request)

#endif // OAITdcer_request_H
