...
OAITdcer_request::OAITdcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITdcer_request::OAITdcer_request() {
    this->initializeModel();
}

OAITdcer_request::~OAITdcer_request() {}

void OAITdcer_request::initializeModel() {
...
void OAITdcer_request::fromJson(QString jsonString) {
...
void OAITdcer_request::fromJsonObject(QJsonObject json) {
...
QString OAITdcer_request::asJson() const {
...
QJsonObject OAITdcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAITdcer_request_certificateParameters OAITdcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAITdcer_request::setCertificateParameters(const OAITdcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAITdcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAITdcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAITdcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAITdcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAITdcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAITdcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAITdcer_request::getFormat() const {
    return m_format;
}
void OAITdcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAITdcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAITdcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAITdcer_request::getTxnId() const {
    return m_txn_id;
}
void OAITdcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAITdcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAITdcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAITdcer_request::isSet() const {
...
bool OAITdcer_request::isValid() const {
