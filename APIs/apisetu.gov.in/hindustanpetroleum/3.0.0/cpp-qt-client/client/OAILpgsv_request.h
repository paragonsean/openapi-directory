...
#ifndef OAILpgsv_request_H
#define OAILpgsv_request_H
...
namespace OpenAPI {
class OAILpgsv_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAILpgsv_request : public OAIObject {
public:
    OAILpgsv_request();
    OAILpgsv_request(QString json);
    ~OAILpgsv_request() override;
    ...
    OAILpgsv_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAILpgsv_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAILpgsv_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAILpgsv_request)

#endif // OAILpgsv_request_H
