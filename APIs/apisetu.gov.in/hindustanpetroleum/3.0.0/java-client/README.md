...
- API version: 3.0.0
  - Build date: 2024-10-12T12:35:09.543975-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/hindustanpetroleum/v3");
    ...
    LpgsvRequest lpgsvRequest = new LpgsvRequest(); // LpgsvRequest | Request format
    try {
      apiInstance.lpgsv(lpgsvRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#lpgsv");
...
------------ | ------------- | ------------- | -------------
*ApisApi* | [**lpgsv**](docs/ApisApi.md#lpgsv) | **POST** /lpgsv/certificate | LPG Subscription Voucher
...
## Documentation for Models
 ...
 - [Lpgsv400Response](docs/Lpgsv400Response.md)
 - [Lpgsv401Response](docs/Lpgsv401Response.md)
 - [Lpgsv404Response](docs/Lpgsv404Response.md)
 - [Lpgsv500Response](docs/Lpgsv500Response.md)
 - [Lpgsv502Response](docs/Lpgsv502Response.md)
 - [Lpgsv503Response](docs/Lpgsv503Response.md)
 - [Lpgsv504Response](docs/Lpgsv504Response.md)
 - [LpgsvRequest](docs/LpgsvRequest.md)
 - [LpgsvRequestCertificateParameters](docs/LpgsvRequestCertificateParameters.md)
