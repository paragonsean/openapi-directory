...
/**
 * The Lpgsv400Response model module.
 * @module model/Lpgsv400Response
 * @version 3.0.0
 */
class Lpgsv400Response {
    /**
     * Constructs a new <code>Lpgsv400Response</code>.
     * @alias module:model/Lpgsv400Response
     */
    constructor() { 
        
        Lpgsv400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Lpgsv400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Lpgsv400Response} obj Optional instance to populate.
     * @return {module:model/Lpgsv400Response} The populated <code>Lpgsv400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Lpgsv400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Lpgsv400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Lpgsv400Response</code>.
     */
...
/**
 * @member {module:model/Lpgsv400Response.ErrorEnum} error
 */
Lpgsv400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Lpgsv400Response.ErrorDescriptionEnum} errorDescription
 */
Lpgsv400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Lpgsv400Response['ErrorDescriptionEnum'] = {
...
export default Lpgsv400Response;
