...
OAIAlltr_request Example::create(){
    OAIAlltr_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::alltrSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::alltrSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIAlltr_request oai_alltr_request = create(); // OAIAlltr_request | Request format
      apiInstance.alltr(oai_alltr_request);
