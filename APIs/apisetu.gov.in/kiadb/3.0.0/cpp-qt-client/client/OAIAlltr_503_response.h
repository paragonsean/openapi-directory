...
/*
 * OAIAlltr_503_response.h
 *
 * 
 */

#ifndef OAIAlltr_503_response_H
#define OAIAlltr_503_response_H
...
class OAIAlltr_503_response : public OAIObject {
public:
    OAIAlltr_503_response();
    OAIAlltr_503_response(QString json);
    ~OAIAlltr_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlltr_503_response)

#endif // OAIAlltr_503_response_H
