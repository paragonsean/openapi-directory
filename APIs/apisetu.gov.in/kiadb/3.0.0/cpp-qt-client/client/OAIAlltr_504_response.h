...
/*
 * OAIAlltr_504_response.h
 *
 * 
 */

#ifndef OAIAlltr_504_response_H
#define OAIAlltr_504_response_H
...
class OAIAlltr_504_response : public OAIObject {
public:
    OAIAlltr_504_response();
    OAIAlltr_504_response(QString json);
    ~OAIAlltr_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlltr_504_response)

#endif // OAIAlltr_504_response_H
