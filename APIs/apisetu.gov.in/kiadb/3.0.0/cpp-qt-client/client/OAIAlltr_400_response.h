...
/*
 * OAIAlltr_400_response.h
 *
 * 
 */

#ifndef OAIAlltr_400_response_H
#define OAIAlltr_400_response_H
...
class OAIAlltr_400_response : public OAIObject {
public:
    OAIAlltr_400_response();
    OAIAlltr_400_response(QString json);
    ~OAIAlltr_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlltr_400_response)

#endif // OAIAlltr_400_response_H
