...
/*
 * OAIAlltr_404_response.h
 *
 * 
 */

#ifndef OAIAlltr_404_response_H
#define OAIAlltr_404_response_H
...
class OAIAlltr_404_response : public OAIObject {
public:
    OAIAlltr_404_response();
    OAIAlltr_404_response(QString json);
    ~OAIAlltr_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlltr_404_response)

#endif // OAIAlltr_404_response_H
