...
OAIAlltr_request::OAIAlltr_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlltr_request::OAIAlltr_request() {
    this->initializeModel();
}

OAIAlltr_request::~OAIAlltr_request() {}

void OAIAlltr_request::initializeModel() {
...
void OAIAlltr_request::fromJson(QString jsonString) {
...
void OAIAlltr_request::fromJsonObject(QJsonObject json) {
...
QString OAIAlltr_request::asJson() const {
...
QJsonObject OAIAlltr_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAlltr_request_certificateParameters OAIAlltr_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIAlltr_request::setCertificateParameters(const OAIAlltr_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIAlltr_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIAlltr_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIAlltr_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIAlltr_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIAlltr_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIAlltr_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIAlltr_request::getFormat() const {
    return m_format;
}
void OAIAlltr_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIAlltr_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIAlltr_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIAlltr_request::getTxnId() const {
    return m_txn_id;
}
void OAIAlltr_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIAlltr_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIAlltr_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIAlltr_request::isSet() const {
...
bool OAIAlltr_request::isValid() const {
