...
/**
 * The Alltr400Response model module.
 * @module model/Alltr400Response
 * @version 3.0.0
 */
class Alltr400Response {
    /**
     * Constructs a new <code>Alltr400Response</code>.
     * @alias module:model/Alltr400Response
     */
    constructor() { 
        
        Alltr400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Alltr400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Alltr400Response} obj Optional instance to populate.
     * @return {module:model/Alltr400Response} The populated <code>Alltr400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Alltr400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Alltr400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Alltr400Response</code>.
     */
...
/**
 * @member {module:model/Alltr400Response.ErrorEnum} error
 */
Alltr400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Alltr400Response.ErrorDescriptionEnum} errorDescription
 */
Alltr400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Alltr400Response['ErrorDescriptionEnum'] = {
...
export default Alltr400Response;
