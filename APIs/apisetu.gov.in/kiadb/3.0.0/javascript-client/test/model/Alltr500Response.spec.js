...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr500Response();
  });
  ...
  describe('Alltr500Response', function() {
    it('should create an instance of Alltr500Response', function() {
      // uncomment below and update the code to test Alltr500Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr500Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr500Response);
    });
