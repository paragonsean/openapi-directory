...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr401Response();
  });
  ...
  describe('Alltr401Response', function() {
    it('should create an instance of Alltr401Response', function() {
      // uncomment below and update the code to test Alltr401Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr401Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr401Response);
    });
