...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr504Response();
  });
  ...
  describe('Alltr504Response', function() {
    it('should create an instance of Alltr504Response', function() {
      // uncomment below and update the code to test Alltr504Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr504Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr504Response);
    });
