...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.ConsentArtifactSchema();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.ConsentArtifactSchema);
    });
