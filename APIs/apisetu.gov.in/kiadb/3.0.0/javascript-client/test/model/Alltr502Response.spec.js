...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr502Response();
  });
  ...
  describe('Alltr502Response', function() {
    it('should create an instance of Alltr502Response', function() {
      // uncomment below and update the code to test Alltr502Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr502Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr502Response);
    });
