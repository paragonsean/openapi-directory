...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr404Response();
  });
  ...
  describe('Alltr404Response', function() {
    it('should create an instance of Alltr404Response', function() {
      // uncomment below and update the code to test Alltr404Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr404Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr404Response);
    });
