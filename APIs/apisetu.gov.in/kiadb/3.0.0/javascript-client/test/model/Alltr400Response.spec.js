...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr400Response();
  });
  ...
  describe('Alltr400Response', function() {
    it('should create an instance of Alltr400Response', function() {
      // uncomment below and update the code to test Alltr400Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr400Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr400Response);
    });
