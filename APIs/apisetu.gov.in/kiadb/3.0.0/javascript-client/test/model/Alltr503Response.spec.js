...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr503Response();
  });
  ...
  describe('Alltr503Response', function() {
    it('should create an instance of Alltr503Response', function() {
      // uncomment below and update the code to test Alltr503Response
      //var instance = new KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr503Response();
      //expect(instance).to.be.a(KarnatakaIndustrialAreasDevelopmentBoardKarnataka.Alltr503Response);
    });
