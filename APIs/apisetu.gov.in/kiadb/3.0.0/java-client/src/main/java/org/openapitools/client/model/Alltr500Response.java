...
public class Alltr500Response {
  ...
  public Alltr500Response() {
  }

  public Alltr500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr500Response alltr500Response = (Alltr500Response) o;
    return Objects.equals(this.error, alltr500Response.error) &&
        Objects.equals(this.errorDescription, alltr500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr500Response is not found in the empty JSON string", Alltr500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr500Response>() {
           @Override
           public void write(JsonWriter out, Alltr500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr500Response
   * @throws IOException if the JSON string is invalid with respect to Alltr500Response
   */
  public static Alltr500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr500Response.class);
  }

  /**
   * Convert an instance of Alltr500Response to an JSON string
   *
   * @return JSON string
   */
