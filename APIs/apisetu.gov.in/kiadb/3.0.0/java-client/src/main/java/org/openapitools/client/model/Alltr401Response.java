...
public class Alltr401Response {
  ...
  public Alltr401Response() {
  }

  public Alltr401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr401Response alltr401Response = (Alltr401Response) o;
    return Objects.equals(this.error, alltr401Response.error) &&
        Objects.equals(this.errorDescription, alltr401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr401Response is not found in the empty JSON string", Alltr401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr401Response>() {
           @Override
           public void write(JsonWriter out, Alltr401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr401Response
   * @throws IOException if the JSON string is invalid with respect to Alltr401Response
   */
  public static Alltr401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr401Response.class);
  }

  /**
   * Convert an instance of Alltr401Response to an JSON string
   *
   * @return JSON string
   */
