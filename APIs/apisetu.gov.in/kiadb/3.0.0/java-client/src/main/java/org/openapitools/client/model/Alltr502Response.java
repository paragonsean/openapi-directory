...
public class Alltr502Response {
  ...
  public Alltr502Response() {
  }

  public Alltr502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr502Response alltr502Response = (Alltr502Response) o;
    return Objects.equals(this.error, alltr502Response.error) &&
        Objects.equals(this.errorDescription, alltr502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr502Response is not found in the empty JSON string", Alltr502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr502Response>() {
           @Override
           public void write(JsonWriter out, Alltr502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr502Response
   * @throws IOException if the JSON string is invalid with respect to Alltr502Response
   */
  public static Alltr502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr502Response.class);
  }

  /**
   * Convert an instance of Alltr502Response to an JSON string
   *
   * @return JSON string
   */
