...
public class Alltr504Response {
  ...
  public Alltr504Response() {
  }

  public Alltr504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr504Response alltr504Response = (Alltr504Response) o;
    return Objects.equals(this.error, alltr504Response.error) &&
        Objects.equals(this.errorDescription, alltr504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr504Response is not found in the empty JSON string", Alltr504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr504Response>() {
           @Override
           public void write(JsonWriter out, Alltr504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr504Response
   * @throws IOException if the JSON string is invalid with respect to Alltr504Response
   */
  public static Alltr504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr504Response.class);
  }

  /**
   * Convert an instance of Alltr504Response to an JSON string
   *
   * @return JSON string
   */
