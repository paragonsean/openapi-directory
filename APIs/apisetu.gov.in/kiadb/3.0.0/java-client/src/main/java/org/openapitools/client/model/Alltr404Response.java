...
public class Alltr404Response {
  ...
  public Alltr404Response() {
  }

  public Alltr404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr404Response alltr404Response = (Alltr404Response) o;
    return Objects.equals(this.error, alltr404Response.error) &&
        Objects.equals(this.errorDescription, alltr404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr404Response is not found in the empty JSON string", Alltr404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr404Response>() {
           @Override
           public void write(JsonWriter out, Alltr404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr404Response
   * @throws IOException if the JSON string is invalid with respect to Alltr404Response
   */
  public static Alltr404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr404Response.class);
  }

  /**
   * Convert an instance of Alltr404Response to an JSON string
   *
   * @return JSON string
   */
