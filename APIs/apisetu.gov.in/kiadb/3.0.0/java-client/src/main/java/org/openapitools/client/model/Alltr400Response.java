...
public class Alltr400Response {
  ...
  public Alltr400Response() {
  }

  public Alltr400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr400Response alltr400Response = (Alltr400Response) o;
    return Objects.equals(this.error, alltr400Response.error) &&
        Objects.equals(this.errorDescription, alltr400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr400Response is not found in the empty JSON string", Alltr400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr400Response>() {
           @Override
           public void write(JsonWriter out, Alltr400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr400Response
   * @throws IOException if the JSON string is invalid with respect to Alltr400Response
   */
  public static Alltr400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr400Response.class);
  }

  /**
   * Convert an instance of Alltr400Response to an JSON string
   *
   * @return JSON string
   */
