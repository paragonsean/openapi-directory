...
public class Alltr503Response {
  ...
  public Alltr503Response() {
  }

  public Alltr503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alltr503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alltr503Response alltr503Response = (Alltr503Response) o;
    return Objects.equals(this.error, alltr503Response.error) &&
        Objects.equals(this.errorDescription, alltr503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alltr503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alltr503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alltr503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alltr503Response is not found in the empty JSON string", Alltr503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alltr503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alltr503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alltr503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alltr503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alltr503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alltr503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alltr503Response>() {
           @Override
           public void write(JsonWriter out, Alltr503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alltr503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alltr503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alltr503Response
   * @throws IOException if the JSON string is invalid with respect to Alltr503Response
   */
  public static Alltr503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alltr503Response.class);
  }

  /**
   * Convert an instance of Alltr503Response to an JSON string
   *
   * @return JSON string
   */
