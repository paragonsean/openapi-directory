...
OAILicer_request::OAILicer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILicer_request::OAILicer_request() {
    this->initializeModel();
}

OAILicer_request::~OAILicer_request() {}

void OAILicer_request::initializeModel() {
...
void OAILicer_request::fromJson(QString jsonString) {
...
void OAILicer_request::fromJsonObject(QJsonObject json) {
...
QString OAILicer_request::asJson() const {
...
QJsonObject OAILicer_request::asJsonObject() const {
    QJsonObject obj;
...
OAILicer_request_certificateParameters OAILicer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAILicer_request::setCertificateParameters(const OAILicer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAILicer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAILicer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAILicer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAILicer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAILicer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAILicer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAILicer_request::getFormat() const {
    return m_format;
}
void OAILicer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAILicer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAILicer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAILicer_request::getTxnId() const {
    return m_txn_id;
}
void OAILicer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAILicer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAILicer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAILicer_request::isSet() const {
...
bool OAILicer_request::isValid() const {
