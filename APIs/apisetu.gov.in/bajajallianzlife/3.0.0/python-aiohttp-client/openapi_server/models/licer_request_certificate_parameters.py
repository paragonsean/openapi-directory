...
class LicerRequestCertificateParameters(Model):
    ...
    def __init__(self, dob: str=None, full_name: str=None, policy_number: str=None):
        ...
        :param policy_number: The policy_number of this LicerRequestCertificateParameters.
        """
        self.openapi_types = {
            'dob': str,
            'full_name': str,
    ...
    def policy_number(self):
        """Gets the policy_number of this LicerRequestCertificateParameters.

        PolicyNumber

        :return: The policy_number of this LicerRequestCertificateParameters.
        :rtype: str
        """
    ...
    def policy_number(self, policy_number):
        """Sets the policy_number of this LicerRequestCertificateParameters.
