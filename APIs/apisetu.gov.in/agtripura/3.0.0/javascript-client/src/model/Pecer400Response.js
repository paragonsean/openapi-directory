...
/**
 * The Pecer400Response model module.
 * @module model/Pecer400Response
 * @version 3.0.0
 */
class Pecer400Response {
    /**
     * Constructs a new <code>Pecer400Response</code>.
     * @alias module:model/Pecer400Response
     */
    constructor() { 
        
        Pecer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Pecer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pecer400Response} obj Optional instance to populate.
     * @return {module:model/Pecer400Response} The populated <code>Pecer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Pecer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Pecer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pecer400Response</code>.
     */
...
/**
 * @member {module:model/Pecer400Response.ErrorEnum} error
 */
Pecer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Pecer400Response.ErrorDescriptionEnum} errorDescription
 */
Pecer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Pecer400Response['ErrorDescriptionEnum'] = {
...
export default Pecer400Response;
