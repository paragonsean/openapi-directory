...
/*
 * OAIPecer_503_response.h
 *
 * 
 */

#ifndef OAIPecer_503_response_H
#define OAIPecer_503_response_H
...
class OAIPecer_503_response : public OAIObject {
public:
    OAIPecer_503_response();
    OAIPecer_503_response(QString json);
    ~OAIPecer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPecer_503_response)

#endif // OAIPecer_503_response_H
