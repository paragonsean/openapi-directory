...
/*
 * OAIPecer_404_response.h
 *
 * 
 */

#ifndef OAIPecer_404_response_H
#define OAIPecer_404_response_H
...
class OAIPecer_404_response : public OAIObject {
public:
    OAIPecer_404_response();
    OAIPecer_404_response(QString json);
    ~OAIPecer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPecer_404_response)

#endif // OAIPecer_404_response_H
