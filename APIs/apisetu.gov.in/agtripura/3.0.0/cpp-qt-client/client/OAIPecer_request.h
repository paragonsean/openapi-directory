...
#ifndef OAIPecer_request_H
#define OAIPecer_request_H
...
namespace OpenAPI {
class OAIPecer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIPecer_request : public OAIObject {
public:
    OAIPecer_request();
    OAIPecer_request(QString json);
    ~OAIPecer_request() override;
    ...
    OAIPecer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIPecer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIPecer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPecer_request)

#endif // OAIPecer_request_H
