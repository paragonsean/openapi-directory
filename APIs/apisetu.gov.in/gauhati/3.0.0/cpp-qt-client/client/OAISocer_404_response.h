...
/*
 * OAISocer_404_response.h
 *
 * 
 */

#ifndef OAISocer_404_response_H
#define OAISocer_404_response_H
...
class OAISocer_404_response : public OAIObject {
public:
    OAISocer_404_response();
    OAISocer_404_response(QString json);
    ~OAISocer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISocer_404_response)

#endif // OAISocer_404_response_H
