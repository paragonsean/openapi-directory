...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GauhatiUniversity.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new GauhatiUniversity.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(GauhatiUniversity.AcademicCertificateSchemaCertificateData);
    });
