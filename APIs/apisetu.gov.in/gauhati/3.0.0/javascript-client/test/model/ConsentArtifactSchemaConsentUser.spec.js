...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GauhatiUniversity.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new GauhatiUniversity.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(GauhatiUniversity.ConsentArtifactSchemaConsentUser);
    });
