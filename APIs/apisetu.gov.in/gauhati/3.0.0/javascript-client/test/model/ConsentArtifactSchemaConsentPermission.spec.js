...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GauhatiUniversity.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new GauhatiUniversity.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(GauhatiUniversity.ConsentArtifactSchemaConsentPermission);
    });
