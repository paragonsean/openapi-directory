...
/**
 * The Socer400Response model module.
 * @module model/Socer400Response
 * @version 3.0.0
 */
class Socer400Response {
    /**
     * Constructs a new <code>Socer400Response</code>.
     * @alias module:model/Socer400Response
     */
    constructor() { 
        
        Socer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Socer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Socer400Response} obj Optional instance to populate.
     * @return {module:model/Socer400Response} The populated <code>Socer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Socer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Socer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Socer400Response</code>.
     */
...
/**
 * @member {module:model/Socer400Response.ErrorEnum} error
 */
Socer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Socer400Response.ErrorDescriptionEnum} errorDescription
 */
Socer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Socer400Response['ErrorDescriptionEnum'] = {
...
export default Socer400Response;
