...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UpStateBoardOfHighSchoolAndIntermediateEducationUttarPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new UpStateBoardOfHighSchoolAndIntermediateEducationUttarPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(UpStateBoardOfHighSchoolAndIntermediateEducationUttarPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
