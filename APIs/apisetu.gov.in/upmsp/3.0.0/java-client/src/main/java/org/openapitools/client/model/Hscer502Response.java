...
public class Hscer502Response {
  ...
  public Hscer502Response() {
  }

  public Hscer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hscer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hscer502Response hscer502Response = (Hscer502Response) o;
    return Objects.equals(this.error, hscer502Response.error) &&
        Objects.equals(this.errorDescription, hscer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hscer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hscer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hscer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hscer502Response is not found in the empty JSON string", Hscer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hscer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hscer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hscer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hscer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hscer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hscer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hscer502Response>() {
           @Override
           public void write(JsonWriter out, Hscer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hscer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hscer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hscer502Response
   * @throws IOException if the JSON string is invalid with respect to Hscer502Response
   */
  public static Hscer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hscer502Response.class);
  }

  /**
   * Convert an instance of Hscer502Response to an JSON string
   *
   * @return JSON string
   */
