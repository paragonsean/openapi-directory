...
setup(
    name=NAME,
    version=VERSION,
    description="UP State Board of High School and Intermediate Education, Uttar Pradesh",
    author_email="",
    url="",
    keywords=["OpenAPI", "UP State Board of High School and Intermediate Education, Uttar Pradesh"],
