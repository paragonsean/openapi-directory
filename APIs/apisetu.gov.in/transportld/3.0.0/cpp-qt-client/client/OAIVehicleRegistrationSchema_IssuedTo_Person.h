...
/*
 * OAIVehicleRegistrationSchema_IssuedTo_Person.h
 *
 * 
 */

#ifndef OAIVehicleRegistrationSchema_IssuedTo_Person_H
#define OAIVehicleRegistrationSchema_IssuedTo_Person_H
...
class OAIVehicleRegistrationSchema_IssuedTo_Person : public OAIObject {
public:
    OAIVehicleRegistrationSchema_IssuedTo_Person();
    OAIVehicleRegistrationSchema_IssuedTo_Person(QString json);
    ~OAIVehicleRegistrationSchema_IssuedTo_Person() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVehicleRegistrationSchema_IssuedTo_Person)

#endif // OAIVehicleRegistrationSchema_IssuedTo_Person_H
