...
public class Hscer401Response {
  ...
  public Hscer401Response() {
  }

  public Hscer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hscer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hscer401Response hscer401Response = (Hscer401Response) o;
    return Objects.equals(this.error, hscer401Response.error) &&
        Objects.equals(this.errorDescription, hscer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hscer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hscer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hscer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hscer401Response is not found in the empty JSON string", Hscer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hscer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hscer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hscer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hscer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hscer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hscer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hscer401Response>() {
           @Override
           public void write(JsonWriter out, Hscer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hscer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hscer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hscer401Response
   * @throws IOException if the JSON string is invalid with respect to Hscer401Response
   */
  public static Hscer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hscer401Response.class);
  }

  /**
   * Convert an instance of Hscer401Response to an JSON string
   *
   * @return JSON string
   */
