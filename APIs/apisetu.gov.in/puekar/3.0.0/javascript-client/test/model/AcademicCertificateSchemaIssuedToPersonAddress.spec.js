...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaStateBoardDepartmentOfPreUniversityEducationKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new KarnatakaStateBoardDepartmentOfPreUniversityEducationKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(KarnatakaStateBoardDepartmentOfPreUniversityEducationKarnataka.AcademicCertificateSchemaIssuedToPersonAddress);
    });
