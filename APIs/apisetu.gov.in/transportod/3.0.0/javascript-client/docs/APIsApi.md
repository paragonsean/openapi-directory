# MotorVehicleDepartmentOdisha.APIsApi
...
```javascript
import MotorVehicleDepartmentOdisha from 'motor_vehicle_department_odisha';
let defaultClient = MotorVehicleDepartmentOdisha.ApiClient.instance;
...
let apiInstance = new MotorVehicleDepartmentOdisha.APIsApi();
let opts = {
...
let apiInstance = new MotorVehicleDepartmentOdisha.APIsApi();
let opts = {
  'rvcerRequest': new MotorVehicleDepartmentOdisha.RvcerRequest() // RvcerRequest | Request format
};
