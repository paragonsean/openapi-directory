...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportDepartmentArunachalPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new TransportDepartmentArunachalPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(TransportDepartmentArunachalPradesh.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
