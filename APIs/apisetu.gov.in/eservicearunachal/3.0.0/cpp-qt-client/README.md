...
OAIChcer_request Example::create(){
    OAIChcer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::chcerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::chcerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIChcer_request oai_chcer_request = create(); // OAIChcer_request | Request format
      apiInstance.chcer(oai_chcer_request);
