...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EServiceEDistrictArunachalPradesh.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new EServiceEDistrictArunachalPradesh.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(EServiceEDistrictArunachalPradesh.ConsentArtifactSchemaConsentPermission);
    });
