...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EServiceEDistrictArunachalPradesh.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EServiceEDistrictArunachalPradesh.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EServiceEDistrictArunachalPradesh.AcademicCertificateSchemaCertificateData);
    });
