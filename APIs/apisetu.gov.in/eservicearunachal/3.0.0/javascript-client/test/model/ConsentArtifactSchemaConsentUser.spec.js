...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EServiceEDistrictArunachalPradesh.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new EServiceEDistrictArunachalPradesh.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(EServiceEDistrictArunachalPradesh.ConsentArtifactSchemaConsentUser);
    });
