...
public class Chcer401Response {
  ...
  public Chcer401Response() {
  }

  public Chcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer401Response chcer401Response = (Chcer401Response) o;
    return Objects.equals(this.error, chcer401Response.error) &&
        Objects.equals(this.errorDescription, chcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer401Response is not found in the empty JSON string", Chcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer401Response>() {
           @Override
           public void write(JsonWriter out, Chcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer401Response
   * @throws IOException if the JSON string is invalid with respect to Chcer401Response
   */
  public static Chcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer401Response.class);
  }

  /**
   * Convert an instance of Chcer401Response to an JSON string
   *
   * @return JSON string
   */
