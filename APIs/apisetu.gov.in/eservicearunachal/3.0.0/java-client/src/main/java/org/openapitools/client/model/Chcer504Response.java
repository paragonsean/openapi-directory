...
public class Chcer504Response {
  ...
  public Chcer504Response() {
  }

  public Chcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer504Response chcer504Response = (Chcer504Response) o;
    return Objects.equals(this.error, chcer504Response.error) &&
        Objects.equals(this.errorDescription, chcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer504Response is not found in the empty JSON string", Chcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer504Response>() {
           @Override
           public void write(JsonWriter out, Chcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer504Response
   * @throws IOException if the JSON string is invalid with respect to Chcer504Response
   */
  public static Chcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer504Response.class);
  }

  /**
   * Convert an instance of Chcer504Response to an JSON string
   *
   * @return JSON string
   */
