...
/*
 * OAIRatcr_400_response.h
 *
 * 
 */

#ifndef OAIRatcr_400_response_H
#define OAIRatcr_400_response_H
...
class OAIRatcr_400_response : public OAIObject {
public:
    OAIRatcr_400_response();
    OAIRatcr_400_response(QString json);
    ~OAIRatcr_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatcr_400_response)

#endif // OAIRatcr_400_response_H
