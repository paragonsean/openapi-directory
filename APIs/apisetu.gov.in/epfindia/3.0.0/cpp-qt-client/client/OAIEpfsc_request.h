...
#ifndef OAIEpfsc_request_H
#define OAIEpfsc_request_H
...
namespace OpenAPI {
class OAIEpfsc_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIEpfsc_request : public OAIObject {
public:
    OAIEpfsc_request();
    OAIEpfsc_request(QString json);
    ~OAIEpfsc_request() override;
    ...
    OAIEpfsc_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIEpfsc_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIEpfsc_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEpfsc_request)

#endif // OAIEpfsc_request_H
