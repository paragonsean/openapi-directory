...
OAIEpfsc_request::OAIEpfsc_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEpfsc_request::OAIEpfsc_request() {
    this->initializeModel();
}

OAIEpfsc_request::~OAIEpfsc_request() {}

void OAIEpfsc_request::initializeModel() {
...
void OAIEpfsc_request::fromJson(QString jsonString) {
...
void OAIEpfsc_request::fromJsonObject(QJsonObject json) {
...
QString OAIEpfsc_request::asJson() const {
...
QJsonObject OAIEpfsc_request::asJsonObject() const {
    QJsonObject obj;
...
OAIEpfsc_request_certificateParameters OAIEpfsc_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIEpfsc_request::setCertificateParameters(const OAIEpfsc_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIEpfsc_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIEpfsc_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIEpfsc_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIEpfsc_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIEpfsc_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIEpfsc_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIEpfsc_request::getFormat() const {
    return m_format;
}
void OAIEpfsc_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIEpfsc_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIEpfsc_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIEpfsc_request::getTxnId() const {
    return m_txn_id;
}
void OAIEpfsc_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIEpfsc_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIEpfsc_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIEpfsc_request::isSet() const {
...
bool OAIEpfsc_request::isValid() const {
