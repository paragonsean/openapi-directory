...
OAIUncrd_request::OAIUncrd_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUncrd_request::OAIUncrd_request() {
    this->initializeModel();
}

OAIUncrd_request::~OAIUncrd_request() {}

void OAIUncrd_request::initializeModel() {
...
void OAIUncrd_request::fromJson(QString jsonString) {
...
void OAIUncrd_request::fromJsonObject(QJsonObject json) {
...
QString OAIUncrd_request::asJson() const {
...
QJsonObject OAIUncrd_request::asJsonObject() const {
    QJsonObject obj;
...
OAIUncrd_request_certificateParameters OAIUncrd_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIUncrd_request::setCertificateParameters(const OAIUncrd_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIUncrd_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIUncrd_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIUncrd_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIUncrd_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIUncrd_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIUncrd_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIUncrd_request::getFormat() const {
    return m_format;
}
void OAIUncrd_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIUncrd_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIUncrd_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIUncrd_request::getTxnId() const {
    return m_txn_id;
}
void OAIUncrd_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIUncrd_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIUncrd_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIUncrd_request::isSet() const {
...
bool OAIUncrd_request::isValid() const {
