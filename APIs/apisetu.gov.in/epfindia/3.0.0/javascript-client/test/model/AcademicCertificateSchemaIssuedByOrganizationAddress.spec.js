...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EmployeesProvidentFundOrganization.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new EmployeesProvidentFundOrganization.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(EmployeesProvidentFundOrganization.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
