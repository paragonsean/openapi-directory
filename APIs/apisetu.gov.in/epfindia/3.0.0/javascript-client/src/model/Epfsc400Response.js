...
/**
 * The Epfsc400Response model module.
 * @module model/Epfsc400Response
 * @version 3.0.0
 */
class Epfsc400Response {
    /**
     * Constructs a new <code>Epfsc400Response</code>.
     * @alias module:model/Epfsc400Response
     */
    constructor() { 
        
        Epfsc400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Epfsc400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Epfsc400Response} obj Optional instance to populate.
     * @return {module:model/Epfsc400Response} The populated <code>Epfsc400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Epfsc400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Epfsc400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Epfsc400Response</code>.
     */
...
/**
 * @member {module:model/Epfsc400Response.ErrorEnum} error
 */
Epfsc400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Epfsc400Response.ErrorDescriptionEnum} errorDescription
 */
Epfsc400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Epfsc400Response['ErrorDescriptionEnum'] = {
...
export default Epfsc400Response;
