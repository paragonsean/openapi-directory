...
OAIHpcer_request::OAIHpcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHpcer_request::OAIHpcer_request() {
    this->initializeModel();
}

OAIHpcer_request::~OAIHpcer_request() {}

void OAIHpcer_request::initializeModel() {
...
void OAIHpcer_request::fromJson(QString jsonString) {
...
void OAIHpcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIHpcer_request::asJson() const {
...
QJsonObject OAIHpcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIHpcer_request_certificateParameters OAIHpcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIHpcer_request::setCertificateParameters(const OAIHpcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIHpcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIHpcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIHpcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIHpcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIHpcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIHpcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIHpcer_request::getFormat() const {
    return m_format;
}
void OAIHpcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIHpcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIHpcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIHpcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIHpcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIHpcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIHpcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIHpcer_request::isSet() const {
...
bool OAIHpcer_request::isValid() const {
