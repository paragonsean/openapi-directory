...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MizoramStateBoardOfSchoolEducation.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new MizoramStateBoardOfSchoolEducation.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(MizoramStateBoardOfSchoolEducation.AcademicCertificateSchemaCertificateData);
    });
