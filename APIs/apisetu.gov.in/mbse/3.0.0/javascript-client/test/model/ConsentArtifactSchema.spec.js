...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MizoramStateBoardOfSchoolEducation.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new MizoramStateBoardOfSchoolEducation.ConsentArtifactSchema();
      //expect(instance).to.be.a(MizoramStateBoardOfSchoolEducation.ConsentArtifactSchema);
    });
