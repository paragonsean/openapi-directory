...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MizoramStateBoardOfSchoolEducation.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new MizoramStateBoardOfSchoolEducation.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(MizoramStateBoardOfSchoolEducation.ConsentArtifactSchemaConsentPermission);
    });
