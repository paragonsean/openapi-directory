...
public class ApiClient {
    ...
    private String basePath = "https://apisetu.gov.in/dgft";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "X-APISETU-APIKEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apisetu.gov.in/dgft
