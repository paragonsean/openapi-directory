...
public class Hscer504Response {
  ...
  public Hscer504Response() {
  }

  public Hscer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hscer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hscer504Response hscer504Response = (Hscer504Response) o;
    return Objects.equals(this.error, hscer504Response.error) &&
        Objects.equals(this.errorDescription, hscer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hscer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hscer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hscer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hscer504Response is not found in the empty JSON string", Hscer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hscer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hscer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hscer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hscer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hscer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hscer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hscer504Response>() {
           @Override
           public void write(JsonWriter out, Hscer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hscer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hscer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hscer504Response
   * @throws IOException if the JSON string is invalid with respect to Hscer504Response
   */
  public static Hscer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hscer504Response.class);
  }

  /**
   * Convert an instance of Hscer504Response to an JSON string
   *
   * @return JSON string
   */
