...
OAIHscer_request Example::create(){
    OAIHscer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::hscerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::hscerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIHscer_request oai_hscer_request = create(); // OAIHscer_request | Request format
      apiInstance.hscer(oai_hscer_request);
