...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TamilNaduStateBoardTamilNaduDirectorateOfGovernmentExaminationsTamilNadu.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new TamilNaduStateBoardTamilNaduDirectorateOfGovernmentExaminationsTamilNadu.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(TamilNaduStateBoardTamilNaduDirectorateOfGovernmentExaminationsTamilNadu.AcademicCertificateSchemaIssuedToPersonAddress);
    });
