...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfFoodPublicDistributionConsumerAffairsPdsJharkhand.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new DepartmentOfFoodPublicDistributionConsumerAffairsPdsJharkhand.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(DepartmentOfFoodPublicDistributionConsumerAffairsPdsJharkhand.ConsentArtifactSchemaConsentUser);
    });
