...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfFoodPublicDistributionConsumerAffairsPdsJharkhand.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new DepartmentOfFoodPublicDistributionConsumerAffairsPdsJharkhand.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(DepartmentOfFoodPublicDistributionConsumerAffairsPdsJharkhand.AcademicCertificateSchemaCertificateData);
    });
