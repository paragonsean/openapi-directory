...
public class Ratcr504Response {
  ...
  public Ratcr504Response() {
  }

  public Ratcr504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ratcr504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ratcr504Response ratcr504Response = (Ratcr504Response) o;
    return Objects.equals(this.error, ratcr504Response.error) &&
        Objects.equals(this.errorDescription, ratcr504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ratcr504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ratcr504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ratcr504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ratcr504Response is not found in the empty JSON string", Ratcr504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ratcr504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ratcr504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ratcr504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ratcr504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ratcr504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ratcr504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ratcr504Response>() {
           @Override
           public void write(JsonWriter out, Ratcr504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ratcr504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ratcr504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ratcr504Response
   * @throws IOException if the JSON string is invalid with respect to Ratcr504Response
   */
  public static Ratcr504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ratcr504Response.class);
  }

  /**
   * Convert an instance of Ratcr504Response to an JSON string
   *
   * @return JSON string
   */
