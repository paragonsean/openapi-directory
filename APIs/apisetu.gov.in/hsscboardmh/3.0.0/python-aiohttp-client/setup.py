...
setup(
    name=NAME,
    version=VERSION,
    description="Maharashtra State Board of Secondary and Higher Secondary Education, Maharashtra",
    author_email="",
    url="",
    keywords=["OpenAPI", "Maharashtra State Board of Secondary and Higher Secondary Education, Maharashtra"],
