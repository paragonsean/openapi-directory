...
#ifndef OAISpcer_request_H
#define OAISpcer_request_H
...
namespace OpenAPI {
class OAISpcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAISpcer_request : public OAIObject {
public:
    OAISpcer_request();
    OAISpcer_request(QString json);
    ~OAISpcer_request() override;
    ...
    OAISpcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAISpcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAISpcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAISpcer_request)

#endif // OAISpcer_request_H
