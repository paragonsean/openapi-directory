...
public:
    ...
    */
    ...
    /**
    * @param[in]  oai_spcer_request OAISpcer_request [optional]
    */
    virtual void spcer(const ::OpenAPI::OptionalParam<OAISpcer_request> &oai_spcer_request = ::OpenAPI::OptionalParam<OAISpcer_request>());

    /**
    * @param[in]  oai_spcer_request OAISpcer_request [optional]
    */
    virtual void sscer(const ::OpenAPI::OptionalParam<OAISpcer_request> &oai_spcer_request = ::OpenAPI::OptionalParam<OAISpcer_request>());
