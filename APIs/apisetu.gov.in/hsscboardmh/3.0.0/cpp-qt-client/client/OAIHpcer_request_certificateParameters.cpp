...
QString OAIHpcer_request_certificateParameters::getExsession() const {
    return m_exsession;
}
void OAIHpcer_request_certificateParameters::setExsession(const QString &exsession) {
    m_exsession = exsession;
    m_exsession_isSet = true;
}

bool OAIHpcer_request_certificateParameters::is_exsession_Set() const{
    return m_exsession_isSet;
}

bool OAIHpcer_request_certificateParameters::is_exsession_Valid() const{
    return m_exsession_isValid;
}

QString OAIHpcer_request_certificateParameters::getRollnumber() const {
    return m_rollnumber;
}
void OAIHpcer_request_certificateParameters::setRollnumber(const QString &rollnumber) {
    m_rollnumber = rollnumber;
    m_rollnumber_isSet = true;
}

bool OAIHpcer_request_certificateParameters::is_rollnumber_Set() const{
    return m_rollnumber_isSet;
}

bool OAIHpcer_request_certificateParameters::is_rollnumber_Valid() const{
    return m_rollnumber_isValid;
}

QString OAIHpcer_request_certificateParameters::getTotalmarks() const {
    return m_totalmarks;
}
void OAIHpcer_request_certificateParameters::setTotalmarks(const QString &totalmarks) {
    m_totalmarks = totalmarks;
    m_totalmarks_isSet = true;
}

bool OAIHpcer_request_certificateParameters::is_totalmarks_Set() const{
    return m_totalmarks_isSet;
}

bool OAIHpcer_request_certificateParameters::is_totalmarks_Valid() const{
