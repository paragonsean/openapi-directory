...
/*
 * OAIHpcer_404_response.h
 *
 * 
 */

#ifndef OAIHpcer_404_response_H
#define OAIHpcer_404_response_H
...
class OAIHpcer_404_response : public OAIObject {
public:
    OAIHpcer_404_response();
    OAIHpcer_404_response(QString json);
    ~OAIHpcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHpcer_404_response)

#endif // OAIHpcer_404_response_H
