# MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.APIsApi
...
```javascript
import MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra from 'maharashtra_state_board_of_secondary_and_higher_secondary_education_maharashtra';
let defaultClient = MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.ApiClient.instance;
...
let apiInstance = new MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.APIsApi();
let opts = {
...
let apiInstance = new MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.APIsApi();
let opts = {
  'spcerRequest': new MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.SpcerRequest() // SpcerRequest | Request format
};
