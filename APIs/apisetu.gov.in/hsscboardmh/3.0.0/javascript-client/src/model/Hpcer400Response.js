...
/**
 * The Hpcer400Response model module.
 * @module model/Hpcer400Response
 * @version 3.0.0
 */
class Hpcer400Response {
    /**
     * Constructs a new <code>Hpcer400Response</code>.
     * @alias module:model/Hpcer400Response
     */
    constructor() { 
        
        Hpcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Hpcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Hpcer400Response} obj Optional instance to populate.
     * @return {module:model/Hpcer400Response} The populated <code>Hpcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Hpcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Hpcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Hpcer400Response</code>.
     */
...
/**
 * @member {module:model/Hpcer400Response.ErrorEnum} error
 */
Hpcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Hpcer400Response.ErrorDescriptionEnum} errorDescription
 */
Hpcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Hpcer400Response['ErrorDescriptionEnum'] = {
...
export default Hpcer400Response;
