...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(MaharashtraStateBoardOfSecondaryAndHigherSecondaryEducationMaharashtra.AcademicCertificateSchemaIssuedToPersonAddress);
    });
