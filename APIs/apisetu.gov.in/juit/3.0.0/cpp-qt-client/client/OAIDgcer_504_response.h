...
/*
 * OAIDgcer_504_response.h
 *
 * 
 */

#ifndef OAIDgcer_504_response_H
#define OAIDgcer_504_response_H
...
class OAIDgcer_504_response : public OAIObject {
public:
    OAIDgcer_504_response();
    OAIDgcer_504_response(QString json);
    ~OAIDgcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDgcer_504_response)

#endif // OAIDgcer_504_response_H
