...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchemaConsentUser);
    });
