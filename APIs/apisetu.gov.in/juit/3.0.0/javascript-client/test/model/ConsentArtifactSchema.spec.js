...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchema();
      //expect(instance).to.be.a(JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchema);
    });
