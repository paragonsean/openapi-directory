...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(JaypeeUniversityOfInformationTechnologyWaknaghatHP.AcademicCertificateSchemaIssuedToPersonAddress);
    });
