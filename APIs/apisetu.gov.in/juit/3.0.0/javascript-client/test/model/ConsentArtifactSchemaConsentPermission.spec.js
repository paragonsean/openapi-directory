...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(JaypeeUniversityOfInformationTechnologyWaknaghatHP.ConsentArtifactSchemaConsentPermission);
    });
