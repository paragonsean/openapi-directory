...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new JaypeeUniversityOfInformationTechnologyWaknaghatHP.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(JaypeeUniversityOfInformationTechnologyWaknaghatHP.AcademicCertificateSchemaCertificateData);
    });
