# FutureGeneraliTotalInsuranceSolutions.APIsApi
...
```javascript
import FutureGeneraliTotalInsuranceSolutions from 'future_generali_total_insurance_solutions';
let defaultClient = FutureGeneraliTotalInsuranceSolutions.ApiClient.instance;
...
let apiInstance = new FutureGeneraliTotalInsuranceSolutions.APIsApi();
let opts = {
