...
async def test_cripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/futuregenerali/v3/cripc/certificate',
        headers=headers,
        json=body,
        )
...
async def test_cvipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/futuregenerali/v3/cvipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hmipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/futuregenerali/v3/hmipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/futuregenerali/v3/tripc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_twipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/futuregenerali/v3/twipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
