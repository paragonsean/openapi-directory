...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/hpsbys/v3");
    ...
    RsbycRequest rsbycRequest = new RsbycRequest(); // RsbycRequest | Request format
    try {
      apiInstance.rsbyc(rsbycRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#rsbyc");
