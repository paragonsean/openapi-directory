...
public class Rsbyc502Response {
  ...
  public Rsbyc502Response() {
  }

  public Rsbyc502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc502Response rsbyc502Response = (Rsbyc502Response) o;
    return Objects.equals(this.error, rsbyc502Response.error) &&
        Objects.equals(this.errorDescription, rsbyc502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc502Response is not found in the empty JSON string", Rsbyc502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc502Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc502Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc502Response
   */
  public static Rsbyc502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc502Response.class);
  }

  /**
   * Convert an instance of Rsbyc502Response to an JSON string
   *
   * @return JSON string
   */
