...
public class Rsbyc504Response {
  ...
  public Rsbyc504Response() {
  }

  public Rsbyc504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc504Response rsbyc504Response = (Rsbyc504Response) o;
    return Objects.equals(this.error, rsbyc504Response.error) &&
        Objects.equals(this.errorDescription, rsbyc504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc504Response is not found in the empty JSON string", Rsbyc504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc504Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc504Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc504Response
   */
  public static Rsbyc504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc504Response.class);
  }

  /**
   * Convert an instance of Rsbyc504Response to an JSON string
   *
   * @return JSON string
   */
