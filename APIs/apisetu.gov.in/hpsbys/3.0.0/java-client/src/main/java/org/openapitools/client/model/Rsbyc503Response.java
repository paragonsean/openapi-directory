 ...
 * Rsbyc503Response
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:34:34.161302-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Rsbyc503Response {
  /**
   * Gets or Sets error
   */
  ...
  public Rsbyc503Response() {
  }

  public Rsbyc503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc503Response rsbyc503Response = (Rsbyc503Response) o;
    return Objects.equals(this.error, rsbyc503Response.error) &&
        Objects.equals(this.errorDescription, rsbyc503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc503Response is not found in the empty JSON string", Rsbyc503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc503Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc503Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc503Response
   */
  public static Rsbyc503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc503Response.class);
  }

  /**
   * Convert an instance of Rsbyc503Response to an JSON string
   *
   * @return JSON string
   */
