...
public class Rsbyc400Response {
  ...
  public Rsbyc400Response() {
  }

  public Rsbyc400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc400Response rsbyc400Response = (Rsbyc400Response) o;
    return Objects.equals(this.error, rsbyc400Response.error) &&
        Objects.equals(this.errorDescription, rsbyc400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc400Response is not found in the empty JSON string", Rsbyc400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc400Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc400Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc400Response
   */
  public static Rsbyc400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc400Response.class);
  }

  /**
   * Convert an instance of Rsbyc400Response to an JSON string
   *
   * @return JSON string
   */
