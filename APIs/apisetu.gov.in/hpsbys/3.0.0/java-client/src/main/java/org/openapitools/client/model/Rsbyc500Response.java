...
public class Rsbyc500Response {
  ...
  public Rsbyc500Response() {
  }

  public Rsbyc500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc500Response rsbyc500Response = (Rsbyc500Response) o;
    return Objects.equals(this.error, rsbyc500Response.error) &&
        Objects.equals(this.errorDescription, rsbyc500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc500Response is not found in the empty JSON string", Rsbyc500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc500Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc500Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc500Response
   */
  public static Rsbyc500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc500Response.class);
  }

  /**
   * Convert an instance of Rsbyc500Response to an JSON string
   *
   * @return JSON string
   */
