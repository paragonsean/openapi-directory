...
public class Rsbyc401Response {
  ...
  public Rsbyc401Response() {
  }

  public Rsbyc401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc401Response rsbyc401Response = (Rsbyc401Response) o;
    return Objects.equals(this.error, rsbyc401Response.error) &&
        Objects.equals(this.errorDescription, rsbyc401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc401Response is not found in the empty JSON string", Rsbyc401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc401Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc401Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc401Response
   */
  public static Rsbyc401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc401Response.class);
  }

  /**
   * Convert an instance of Rsbyc401Response to an JSON string
   *
   * @return JSON string
   */
