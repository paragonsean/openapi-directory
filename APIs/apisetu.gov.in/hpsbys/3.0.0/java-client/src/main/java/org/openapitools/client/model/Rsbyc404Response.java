...
public class Rsbyc404Response {
  ...
  public Rsbyc404Response() {
  }

  public Rsbyc404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rsbyc404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rsbyc404Response rsbyc404Response = (Rsbyc404Response) o;
    return Objects.equals(this.error, rsbyc404Response.error) &&
        Objects.equals(this.errorDescription, rsbyc404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rsbyc404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rsbyc404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rsbyc404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rsbyc404Response is not found in the empty JSON string", Rsbyc404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rsbyc404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rsbyc404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rsbyc404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rsbyc404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rsbyc404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rsbyc404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rsbyc404Response>() {
           @Override
           public void write(JsonWriter out, Rsbyc404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rsbyc404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rsbyc404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rsbyc404Response
   * @throws IOException if the JSON string is invalid with respect to Rsbyc404Response
   */
  public static Rsbyc404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rsbyc404Response.class);
  }

  /**
   * Convert an instance of Rsbyc404Response to an JSON string
   *
   * @return JSON string
   */
