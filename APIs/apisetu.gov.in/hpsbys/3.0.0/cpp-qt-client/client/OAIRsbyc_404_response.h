...
/*
 * OAIRsbyc_404_response.h
 *
 * 
 */

#ifndef OAIRsbyc_404_response_H
#define OAIRsbyc_404_response_H
...
class OAIRsbyc_404_response : public OAIObject {
public:
    OAIRsbyc_404_response();
    OAIRsbyc_404_response(QString json);
    ~OAIRsbyc_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRsbyc_404_response)

#endif // OAIRsbyc_404_response_H
