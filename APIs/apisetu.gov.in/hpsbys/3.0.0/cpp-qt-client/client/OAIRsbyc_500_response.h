...
/*
 * OAIRsbyc_500_response.h
 *
 * 
 */

#ifndef OAIRsbyc_500_response_H
#define OAIRsbyc_500_response_H
...
class OAIRsbyc_500_response : public OAIObject {
public:
    OAIRsbyc_500_response();
    OAIRsbyc_500_response(QString json);
    ~OAIRsbyc_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRsbyc_500_response)

#endif // OAIRsbyc_500_response_H
