...
/*
 * OAIRsbyc_400_response.h
 *
 * 
 */

#ifndef OAIRsbyc_400_response_H
#define OAIRsbyc_400_response_H
...
class OAIRsbyc_400_response : public OAIObject {
public:
    OAIRsbyc_400_response();
    OAIRsbyc_400_response(QString json);
    ~OAIRsbyc_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRsbyc_400_response)

#endif // OAIRsbyc_400_response_H
