...
/*
 * OAIRsbyc_503_response.h
 *
 * 
 */

#ifndef OAIRsbyc_503_response_H
#define OAIRsbyc_503_response_H
...
class OAIRsbyc_503_response : public OAIObject {
public:
    OAIRsbyc_503_response();
    OAIRsbyc_503_response(QString json);
    ~OAIRsbyc_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRsbyc_503_response)

#endif // OAIRsbyc_503_response_H
