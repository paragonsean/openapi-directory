...
OAIRsbyc_request Example::create(){
    OAIRsbyc_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::rsbycSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::rsbycSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIRsbyc_request oai_rsbyc_request = create(); // OAIRsbyc_request | Request format
      apiInstance.rsbyc(oai_rsbyc_request);
