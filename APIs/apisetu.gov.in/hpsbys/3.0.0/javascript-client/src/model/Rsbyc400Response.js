...
/**
 * The Rsbyc400Response model module.
 * @module model/Rsbyc400Response
 * @version 3.0.0
 */
class Rsbyc400Response {
    /**
     * Constructs a new <code>Rsbyc400Response</code>.
     * @alias module:model/Rsbyc400Response
     */
    constructor() { 
        
        Rsbyc400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Rsbyc400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rsbyc400Response} obj Optional instance to populate.
     * @return {module:model/Rsbyc400Response} The populated <code>Rsbyc400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Rsbyc400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Rsbyc400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rsbyc400Response</code>.
     */
...
/**
 * @member {module:model/Rsbyc400Response.ErrorEnum} error
 */
Rsbyc400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Rsbyc400Response.ErrorDescriptionEnum} errorDescription
 */
Rsbyc400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Rsbyc400Response['ErrorDescriptionEnum'] = {
...
export default Rsbyc400Response;
