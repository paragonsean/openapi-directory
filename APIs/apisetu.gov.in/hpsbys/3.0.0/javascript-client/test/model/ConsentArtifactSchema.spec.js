...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HpSwasthyaBimaYojnaSocietyHimachalPradesh.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new HpSwasthyaBimaYojnaSocietyHimachalPradesh.ConsentArtifactSchema();
      //expect(instance).to.be.a(HpSwasthyaBimaYojnaSocietyHimachalPradesh.ConsentArtifactSchema);
    });
