...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HpSwasthyaBimaYojnaSocietyHimachalPradesh.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new HpSwasthyaBimaYojnaSocietyHimachalPradesh.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(HpSwasthyaBimaYojnaSocietyHimachalPradesh.ConsentArtifactSchemaConsentUser);
    });
