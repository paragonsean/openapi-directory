...
public class Hpcer502Response {
  ...
  public Hpcer502Response() {
  }

  public Hpcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hpcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hpcer502Response hpcer502Response = (Hpcer502Response) o;
    return Objects.equals(this.error, hpcer502Response.error) &&
        Objects.equals(this.errorDescription, hpcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hpcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hpcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hpcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hpcer502Response is not found in the empty JSON string", Hpcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hpcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hpcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hpcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hpcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hpcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hpcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hpcer502Response>() {
           @Override
           public void write(JsonWriter out, Hpcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hpcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hpcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hpcer502Response
   * @throws IOException if the JSON string is invalid with respect to Hpcer502Response
   */
  public static Hpcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hpcer502Response.class);
  }

  /**
   * Convert an instance of Hpcer502Response to an JSON string
   *
   * @return JSON string
   */
