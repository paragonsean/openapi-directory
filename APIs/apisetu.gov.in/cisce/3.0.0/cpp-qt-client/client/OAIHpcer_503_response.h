...
/*
 * OAIHpcer_503_response.h
 *
 * 
 */

#ifndef OAIHpcer_503_response_H
#define OAIHpcer_503_response_H
...
class OAIHpcer_503_response : public OAIObject {
public:
    OAIHpcer_503_response();
    OAIHpcer_503_response(QString json);
    ~OAIHpcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHpcer_503_response)

#endif // OAIHpcer_503_response_H
