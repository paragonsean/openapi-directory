...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cisce.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new Cisce.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(Cisce.ConsentArtifactSchemaConsentPermission);
    });
