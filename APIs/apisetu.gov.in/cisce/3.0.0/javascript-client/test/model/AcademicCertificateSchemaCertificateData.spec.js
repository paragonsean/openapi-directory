...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cisce.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new Cisce.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(Cisce.AcademicCertificateSchemaCertificateData);
    });
