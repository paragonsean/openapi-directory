...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cisce.ConsentArtifactSchemaSignature();
  });
  ...
  describe('ConsentArtifactSchemaSignature', function() {
    it('should create an instance of ConsentArtifactSchemaSignature', function() {
      ...
      //var instance = new Cisce.ConsentArtifactSchemaSignature();
      //expect(instance).to.be.a(Cisce.ConsentArtifactSchemaSignature);
    });
