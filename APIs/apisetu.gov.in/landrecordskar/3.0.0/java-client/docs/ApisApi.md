...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    MutanRequest mutanRequest = new MutanRequest(); // MutanRequest | Request format
    try {
      apiInstance.mutan(mutanRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#mutan");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
