...
- API version: 3.0.0
  - Build date: 2024-10-12T12:34:46.468981-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/landrecordskar/v3");
    ...
    CncerRequest cncerRequest = new CncerRequest(); // CncerRequest | Request format
    try {
      apiInstance.cncer(cncerRequest);
...
*ApisApi* | [**mutan**](docs/ApisApi.md#mutan) | **POST** /mutan/certificate | Mutation Report/ePattadar Passbook
...
## Documentation for Models
 ...
 - [Cncer400Response](docs/Cncer400Response.md)
 - [Cncer401Response](docs/Cncer401Response.md)
 - [Cncer404Response](docs/Cncer404Response.md)
 - [Cncer500Response](docs/Cncer500Response.md)
 - [Cncer502Response](docs/Cncer502Response.md)
 - [Cncer503Response](docs/Cncer503Response.md)
 - [Cncer504Response](docs/Cncer504Response.md)
 - [CncerRequest](docs/CncerRequest.md)
 - [CncerRequestCertificateParameters](docs/CncerRequestCertificateParameters.md)
 ...
 - [MutanRequest](docs/MutanRequest.md)
 - [MutanRequestCertificateParameters](docs/MutanRequestCertificateParameters.md)
