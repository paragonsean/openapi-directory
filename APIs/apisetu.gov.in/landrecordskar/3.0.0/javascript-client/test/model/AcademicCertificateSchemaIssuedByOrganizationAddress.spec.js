...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RevenueDepartmentLandRecordsKarnataka.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new RevenueDepartmentLandRecordsKarnataka.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(RevenueDepartmentLandRecordsKarnataka.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
