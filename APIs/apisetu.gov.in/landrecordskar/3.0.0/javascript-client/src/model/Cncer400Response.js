...
/**
 * The Cncer400Response model module.
 * @module model/Cncer400Response
 * @version 3.0.0
 */
class Cncer400Response {
    /**
     * Constructs a new <code>Cncer400Response</code>.
     * @alias module:model/Cncer400Response
     */
    constructor() { 
        
        Cncer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Cncer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cncer400Response} obj Optional instance to populate.
     * @return {module:model/Cncer400Response} The populated <code>Cncer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cncer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Cncer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cncer400Response</code>.
     */
...
/**
 * @member {module:model/Cncer400Response.ErrorEnum} error
 */
Cncer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Cncer400Response.ErrorDescriptionEnum} errorDescription
 */
Cncer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Cncer400Response['ErrorDescriptionEnum'] = {
...
export default Cncer400Response;
