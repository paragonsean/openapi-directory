...
#ifndef OAIMutan_request_H
#define OAIMutan_request_H

#include <QJsonObject>

#include "OAIConsentArtifactSchema.h"
#include "OAIMutan_request_certificateParameters.h"
#include <QString>
...
namespace OpenAPI {
class OAIMutan_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIMutan_request : public OAIObject {
public:
    OAIMutan_request();
    OAIMutan_request(QString json);
    ~OAIMutan_request() override;
    ...
    OAIMutan_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIMutan_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIMutan_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMutan_request)

#endif // OAIMutan_request_H
