...
/*
 * OAICncer_404_response.h
 *
 * 
 */

#ifndef OAICncer_404_response_H
#define OAICncer_404_response_H
...
class OAICncer_404_response : public OAIObject {
public:
    OAICncer_404_response();
    OAICncer_404_response(QString json);
    ~OAICncer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICncer_404_response)

#endif // OAICncer_404_response_H
