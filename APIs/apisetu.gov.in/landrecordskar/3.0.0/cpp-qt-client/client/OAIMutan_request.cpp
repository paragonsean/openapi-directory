...
OAIMutan_request::OAIMutan_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMutan_request::OAIMutan_request() {
    this->initializeModel();
}

OAIMutan_request::~OAIMutan_request() {}

void OAIMutan_request::initializeModel() {
...
void OAIMutan_request::fromJson(QString jsonString) {
...
void OAIMutan_request::fromJsonObject(QJsonObject json) {
...
QString OAIMutan_request::asJson() const {
...
QJsonObject OAIMutan_request::asJsonObject() const {
    QJsonObject obj;
...
OAIMutan_request_certificateParameters OAIMutan_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIMutan_request::setCertificateParameters(const OAIMutan_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIMutan_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIMutan_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIMutan_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIMutan_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIMutan_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIMutan_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIMutan_request::getFormat() const {
    return m_format;
}
void OAIMutan_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIMutan_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIMutan_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIMutan_request::getTxnId() const {
    return m_txn_id;
}
void OAIMutan_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIMutan_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIMutan_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIMutan_request::isSet() const {
...
bool OAIMutan_request::isValid() const {
