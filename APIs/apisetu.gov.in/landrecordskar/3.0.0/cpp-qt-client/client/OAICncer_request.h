...
#ifndef OAICncer_request_H
#define OAICncer_request_H
...
namespace OpenAPI {
class OAICncer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAICncer_request : public OAIObject {
public:
    OAICncer_request();
    OAICncer_request(QString json);
    ~OAICncer_request() override;
    ...
    OAICncer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAICncer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAICncer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICncer_request)

#endif // OAICncer_request_H
