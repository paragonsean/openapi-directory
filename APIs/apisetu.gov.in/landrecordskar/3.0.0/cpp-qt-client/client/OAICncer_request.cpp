...
OAICncer_request::OAICncer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICncer_request::OAICncer_request() {
    this->initializeModel();
}

OAICncer_request::~OAICncer_request() {}

void OAICncer_request::initializeModel() {
...
void OAICncer_request::fromJson(QString jsonString) {
...
void OAICncer_request::fromJsonObject(QJsonObject json) {
...
QString OAICncer_request::asJson() const {
...
QJsonObject OAICncer_request::asJsonObject() const {
    QJsonObject obj;
...
OAICncer_request_certificateParameters OAICncer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAICncer_request::setCertificateParameters(const OAICncer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAICncer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAICncer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAICncer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAICncer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAICncer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAICncer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAICncer_request::getFormat() const {
    return m_format;
}
void OAICncer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICncer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAICncer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAICncer_request::getTxnId() const {
    return m_txn_id;
}
void OAICncer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAICncer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAICncer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAICncer_request::isSet() const {
...
bool OAICncer_request::isValid() const {
