...
/*
 * OAIOtcer_400_response.h
 *
 * 
 */

#ifndef OAIOtcer_400_response_H
#define OAIOtcer_400_response_H
...
class OAIOtcer_400_response : public OAIObject {
public:
    OAIOtcer_400_response();
    OAIOtcer_400_response(QString json);
    ~OAIOtcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOtcer_400_response)

#endif // OAIOtcer_400_response_H
