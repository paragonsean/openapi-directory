...
/*
 * OAIOtcer_404_response.h
 *
 * 
 */

#ifndef OAIOtcer_404_response_H
#define OAIOtcer_404_response_H
...
class OAIOtcer_404_response : public OAIObject {
public:
    OAIOtcer_404_response();
    OAIOtcer_404_response(QString json);
    ~OAIOtcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOtcer_404_response)

#endif // OAIOtcer_404_response_H
