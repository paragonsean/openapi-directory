...
/*
 * OAIOtcer_503_response.h
 *
 * 
 */

#ifndef OAIOtcer_503_response_H
#define OAIOtcer_503_response_H
...
class OAIOtcer_503_response : public OAIObject {
public:
    OAIOtcer_503_response();
    OAIOtcer_503_response(QString json);
    ~OAIOtcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOtcer_503_response)

#endif // OAIOtcer_503_response_H
