...
#include "OAIOtcer_401_response.h"
...
OAIOtcer_401_response::OAIOtcer_401_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOtcer_401_response::OAIOtcer_401_response() {
    this->initializeModel();
}

OAIOtcer_401_response::~OAIOtcer_401_response() {}

void OAIOtcer_401_response::initializeModel() {
...
void OAIOtcer_401_response::fromJson(QString jsonString) {
...
void OAIOtcer_401_response::fromJsonObject(QJsonObject json) {
...
QString OAIOtcer_401_response::asJson() const {
...
QJsonObject OAIOtcer_401_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIOtcer_401_response::getError() const {
    return m_error;
}
void OAIOtcer_401_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIOtcer_401_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIOtcer_401_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIOtcer_401_response::getErrorDescription() const {
    return m_error_description;
}
void OAIOtcer_401_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIOtcer_401_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIOtcer_401_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIOtcer_401_response::isSet() const {
...
bool OAIOtcer_401_response::isValid() const {
