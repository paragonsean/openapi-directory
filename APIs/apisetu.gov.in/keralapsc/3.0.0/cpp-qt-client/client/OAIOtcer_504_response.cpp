...
OAIOtcer_504_response::OAIOtcer_504_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOtcer_504_response::OAIOtcer_504_response() {
    this->initializeModel();
}

OAIOtcer_504_response::~OAIOtcer_504_response() {}

void OAIOtcer_504_response::initializeModel() {
...
void OAIOtcer_504_response::fromJson(QString jsonString) {
...
void OAIOtcer_504_response::fromJsonObject(QJsonObject json) {
...
QString OAIOtcer_504_response::asJson() const {
...
QJsonObject OAIOtcer_504_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIOtcer_504_response::getError() const {
    return m_error;
}
void OAIOtcer_504_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIOtcer_504_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIOtcer_504_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIOtcer_504_response::getErrorDescription() const {
    return m_error_description;
}
void OAIOtcer_504_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIOtcer_504_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIOtcer_504_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIOtcer_504_response::isSet() const {
...
bool OAIOtcer_504_response::isValid() const {
