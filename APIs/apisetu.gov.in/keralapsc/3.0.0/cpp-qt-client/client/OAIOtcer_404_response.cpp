...
#include "OAIOtcer_404_response.h"
...
OAIOtcer_404_response::OAIOtcer_404_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOtcer_404_response::OAIOtcer_404_response() {
    this->initializeModel();
}

OAIOtcer_404_response::~OAIOtcer_404_response() {}

void OAIOtcer_404_response::initializeModel() {
...
void OAIOtcer_404_response::fromJson(QString jsonString) {
...
void OAIOtcer_404_response::fromJsonObject(QJsonObject json) {
...
QString OAIOtcer_404_response::asJson() const {
...
QJsonObject OAIOtcer_404_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIOtcer_404_response::getError() const {
    return m_error;
}
void OAIOtcer_404_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIOtcer_404_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIOtcer_404_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIOtcer_404_response::getErrorDescription() const {
    return m_error_description;
}
void OAIOtcer_404_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIOtcer_404_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIOtcer_404_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIOtcer_404_response::isSet() const {
...
bool OAIOtcer_404_response::isValid() const {
