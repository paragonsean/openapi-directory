...
#ifndef OAIOtcer_request_H
#define OAIOtcer_request_H
...
namespace OpenAPI {
class OAIOtcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIOtcer_request : public OAIObject {
public:
    OAIOtcer_request();
    OAIOtcer_request(QString json);
    ~OAIOtcer_request() override;
    ...
    OAIOtcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIOtcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIOtcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOtcer_request)

#endif // OAIOtcer_request_H
