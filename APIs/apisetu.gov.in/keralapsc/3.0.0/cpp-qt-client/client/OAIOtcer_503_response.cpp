...
#include "OAIOtcer_503_response.h"
...
OAIOtcer_503_response::OAIOtcer_503_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOtcer_503_response::OAIOtcer_503_response() {
    this->initializeModel();
}

OAIOtcer_503_response::~OAIOtcer_503_response() {}

void OAIOtcer_503_response::initializeModel() {
...
void OAIOtcer_503_response::fromJson(QString jsonString) {
...
void OAIOtcer_503_response::fromJsonObject(QJsonObject json) {
...
QString OAIOtcer_503_response::asJson() const {
...
QJsonObject OAIOtcer_503_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAIOtcer_503_response::getError() const {
    return m_error;
}
void OAIOtcer_503_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAIOtcer_503_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAIOtcer_503_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAIOtcer_503_response::getErrorDescription() const {
    return m_error_description;
}
void OAIOtcer_503_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIOtcer_503_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIOtcer_503_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIOtcer_503_response::isSet() const {
...
bool OAIOtcer_503_response::isValid() const {
