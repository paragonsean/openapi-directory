...
public class Otcer500Response {
  ...
  public Otcer500Response() {
  }

  public Otcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Otcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Otcer500Response otcer500Response = (Otcer500Response) o;
    return Objects.equals(this.error, otcer500Response.error) &&
        Objects.equals(this.errorDescription, otcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Otcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Otcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Otcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Otcer500Response is not found in the empty JSON string", Otcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Otcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Otcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Otcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Otcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Otcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Otcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Otcer500Response>() {
           @Override
           public void write(JsonWriter out, Otcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Otcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Otcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Otcer500Response
   * @throws IOException if the JSON string is invalid with respect to Otcer500Response
   */
  public static Otcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Otcer500Response.class);
  }

  /**
   * Convert an instance of Otcer500Response to an JSON string
   *
   * @return JSON string
   */
