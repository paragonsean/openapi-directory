...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.APIsApi();
  });
  ...
  describe('APIsApi', function() {
    describe('otcer', function() {
      it('should call otcer successfully', function(done) {
        //uncomment below and update the code to test otcer
        //instance.otcer(function(error) {
