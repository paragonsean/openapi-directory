...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.AcademicCertificateSchemaIssuedTo();
  });
  ...
  describe('AcademicCertificateSchemaIssuedTo', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedTo', function() {
      ...
      //var instance = new KeralaPublicServiceCommissionKerala.AcademicCertificateSchemaIssuedTo();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.AcademicCertificateSchemaIssuedTo);
    });
