...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new KeralaPublicServiceCommissionKerala.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.ConsentArtifactSchemaConsentPermission);
    });
