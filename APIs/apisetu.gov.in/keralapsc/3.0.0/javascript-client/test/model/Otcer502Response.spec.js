...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.Otcer502Response();
  });
  ...
  describe('Otcer502Response', function() {
    it('should create an instance of Otcer502Response', function() {
      // uncomment below and update the code to test Otcer502Response
      //var instance = new KeralaPublicServiceCommissionKerala.Otcer502Response();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.Otcer502Response);
    });
