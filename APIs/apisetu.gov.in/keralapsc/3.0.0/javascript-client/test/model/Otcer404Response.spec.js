...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.Otcer404Response();
  });
  ...
  describe('Otcer404Response', function() {
    it('should create an instance of Otcer404Response', function() {
      // uncomment below and update the code to test Otcer404Response
      //var instance = new KeralaPublicServiceCommissionKerala.Otcer404Response();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.Otcer404Response);
    });
