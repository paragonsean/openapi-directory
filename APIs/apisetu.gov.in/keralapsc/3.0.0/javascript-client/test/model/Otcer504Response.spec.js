...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.Otcer504Response();
  });
  ...
  describe('Otcer504Response', function() {
    it('should create an instance of Otcer504Response', function() {
      // uncomment below and update the code to test Otcer504Response
      //var instance = new KeralaPublicServiceCommissionKerala.Otcer504Response();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.Otcer504Response);
    });
