...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.Otcer503Response();
  });
  ...
  describe('Otcer503Response', function() {
    it('should create an instance of Otcer503Response', function() {
      // uncomment below and update the code to test Otcer503Response
      //var instance = new KeralaPublicServiceCommissionKerala.Otcer503Response();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.Otcer503Response);
    });
