...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.Otcer401Response();
  });
  ...
  describe('Otcer401Response', function() {
    it('should create an instance of Otcer401Response', function() {
      // uncomment below and update the code to test Otcer401Response
      //var instance = new KeralaPublicServiceCommissionKerala.Otcer401Response();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.Otcer401Response);
    });
