...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.OtcerRequestCertificateParameters();
  });
  ...
  describe('OtcerRequestCertificateParameters', function() {
    it('should create an instance of OtcerRequestCertificateParameters', function() {
      // uncomment below and update the code to test OtcerRequestCertificateParameters
      //var instance = new KeralaPublicServiceCommissionKerala.OtcerRequestCertificateParameters();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.OtcerRequestCertificateParameters);
    });
