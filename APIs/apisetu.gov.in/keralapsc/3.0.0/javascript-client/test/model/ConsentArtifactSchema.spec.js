...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new KeralaPublicServiceCommissionKerala.ConsentArtifactSchema();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.ConsentArtifactSchema);
    });
