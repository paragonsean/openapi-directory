...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeralaPublicServiceCommissionKerala.Otcer500Response();
  });
  ...
  describe('Otcer500Response', function() {
    it('should create an instance of Otcer500Response', function() {
      // uncomment below and update the code to test Otcer500Response
      //var instance = new KeralaPublicServiceCommissionKerala.Otcer500Response();
      //expect(instance).to.be.a(KeralaPublicServiceCommissionKerala.Otcer500Response);
    });
