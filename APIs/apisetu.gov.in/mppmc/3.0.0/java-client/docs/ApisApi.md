...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/mppmc/v3");
    ...
    SocerRequest socerRequest = new SocerRequest(); // SocerRequest | Request format
    try {
      apiInstance.socer(socerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#socer");
