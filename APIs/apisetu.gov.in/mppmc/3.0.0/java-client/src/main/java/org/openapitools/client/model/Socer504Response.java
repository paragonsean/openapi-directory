...
public class Socer504Response {
  ...
  public Socer504Response() {
  }

  public Socer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Socer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Socer504Response socer504Response = (Socer504Response) o;
    return Objects.equals(this.error, socer504Response.error) &&
        Objects.equals(this.errorDescription, socer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Socer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Socer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Socer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Socer504Response is not found in the empty JSON string", Socer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Socer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Socer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Socer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Socer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Socer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Socer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Socer504Response>() {
           @Override
           public void write(JsonWriter out, Socer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Socer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Socer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Socer504Response
   * @throws IOException if the JSON string is invalid with respect to Socer504Response
   */
  public static Socer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Socer504Response.class);
  }

  /**
   * Convert an instance of Socer504Response to an JSON string
   *
   * @return JSON string
   */
