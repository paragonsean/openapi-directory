...
public class Socer400Response {
  ...
  public Socer400Response() {
  }

  public Socer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Socer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Socer400Response socer400Response = (Socer400Response) o;
    return Objects.equals(this.error, socer400Response.error) &&
        Objects.equals(this.errorDescription, socer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Socer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Socer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Socer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Socer400Response is not found in the empty JSON string", Socer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Socer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Socer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Socer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Socer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Socer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Socer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Socer400Response>() {
           @Override
           public void write(JsonWriter out, Socer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Socer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Socer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Socer400Response
   * @throws IOException if the JSON string is invalid with respect to Socer400Response
   */
  public static Socer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Socer400Response.class);
  }

  /**
   * Convert an instance of Socer400Response to an JSON string
   *
   * @return JSON string
   */
