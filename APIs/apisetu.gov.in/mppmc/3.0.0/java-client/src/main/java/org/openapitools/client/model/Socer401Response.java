...
public class Socer401Response {
  ...
  public Socer401Response() {
  }

  public Socer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Socer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Socer401Response socer401Response = (Socer401Response) o;
    return Objects.equals(this.error, socer401Response.error) &&
        Objects.equals(this.errorDescription, socer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Socer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Socer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Socer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Socer401Response is not found in the empty JSON string", Socer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Socer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Socer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Socer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Socer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Socer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Socer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Socer401Response>() {
           @Override
           public void write(JsonWriter out, Socer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Socer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Socer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Socer401Response
   * @throws IOException if the JSON string is invalid with respect to Socer401Response
   */
  public static Socer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Socer401Response.class);
  }

  /**
   * Convert an instance of Socer401Response to an JSON string
   *
   * @return JSON string
   */
