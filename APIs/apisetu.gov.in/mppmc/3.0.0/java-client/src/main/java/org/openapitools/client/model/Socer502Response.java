...
public class Socer502Response {
  ...
  public Socer502Response() {
  }

  public Socer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Socer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Socer502Response socer502Response = (Socer502Response) o;
    return Objects.equals(this.error, socer502Response.error) &&
        Objects.equals(this.errorDescription, socer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Socer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Socer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Socer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Socer502Response is not found in the empty JSON string", Socer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Socer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Socer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Socer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Socer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Socer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Socer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Socer502Response>() {
           @Override
           public void write(JsonWriter out, Socer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Socer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Socer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Socer502Response
   * @throws IOException if the JSON string is invalid with respect to Socer502Response
   */
  public static Socer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Socer502Response.class);
  }

  /**
   * Convert an instance of Socer502Response to an JSON string
   *
   * @return JSON string
   */
