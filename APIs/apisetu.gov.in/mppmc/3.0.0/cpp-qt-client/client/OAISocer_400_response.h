...
/*
 * OAISocer_400_response.h
 *
 * 
 */

#ifndef OAISocer_400_response_H
#define OAISocer_400_response_H
...
class OAISocer_400_response : public OAIObject {
public:
    OAISocer_400_response();
    OAISocer_400_response(QString json);
    ~OAISocer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISocer_400_response)

#endif // OAISocer_400_response_H
