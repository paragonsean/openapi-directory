...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParamedicalCouncilMadhyaPradesh.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new ParamedicalCouncilMadhyaPradesh.ConsentArtifactSchema();
      //expect(instance).to.be.a(ParamedicalCouncilMadhyaPradesh.ConsentArtifactSchema);
    });
