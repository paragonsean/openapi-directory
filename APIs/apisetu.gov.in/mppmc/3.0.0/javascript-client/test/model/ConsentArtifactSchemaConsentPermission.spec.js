...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ParamedicalCouncilMadhyaPradesh.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new ParamedicalCouncilMadhyaPradesh.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(ParamedicalCouncilMadhyaPradesh.ConsentArtifactSchemaConsentPermission);
    });
