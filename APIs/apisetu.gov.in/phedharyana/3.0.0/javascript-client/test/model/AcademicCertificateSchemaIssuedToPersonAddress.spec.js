...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PublicHealthEngineeringDepartmentHaryanaHaryana.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new PublicHealthEngineeringDepartmentHaryanaHaryana.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(PublicHealthEngineeringDepartmentHaryanaHaryana.AcademicCertificateSchemaIssuedToPersonAddress);
    });
