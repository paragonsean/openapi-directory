...
/**
 * The Etcer400Response model module.
 * @module model/Etcer400Response
 * @version 3.0.0
 */
class Etcer400Response {
    /**
     * Constructs a new <code>Etcer400Response</code>.
     * @alias module:model/Etcer400Response
     */
    constructor() { 
        
        Etcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Etcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Etcer400Response} obj Optional instance to populate.
     * @return {module:model/Etcer400Response} The populated <code>Etcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Etcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Etcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Etcer400Response</code>.
     */
...
/**
 * @member {module:model/Etcer400Response.ErrorEnum} error
 */
Etcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Etcer400Response.ErrorDescriptionEnum} errorDescription
 */
Etcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Etcer400Response['ErrorDescriptionEnum'] = {
...
export default Etcer400Response;
