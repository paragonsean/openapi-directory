...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/phedharyana/v3");
    ...
    EtcerRequest etcerRequest = new EtcerRequest(); // EtcerRequest | Request format
    try {
      apiInstance.etcer(etcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#etcer");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    SicerRequest sicerRequest = new SicerRequest(); // SicerRequest | Request format
    try {
      apiInstance.sicer(sicerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#sicer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
