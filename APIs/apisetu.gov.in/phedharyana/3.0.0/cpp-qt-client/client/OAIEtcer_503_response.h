...
/*
 * OAIEtcer_503_response.h
 *
 * 
 */

#ifndef OAIEtcer_503_response_H
#define OAIEtcer_503_response_H
...
class OAIEtcer_503_response : public OAIObject {
public:
    OAIEtcer_503_response();
    OAIEtcer_503_response(QString json);
    ~OAIEtcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_503_response)

#endif // OAIEtcer_503_response_H
