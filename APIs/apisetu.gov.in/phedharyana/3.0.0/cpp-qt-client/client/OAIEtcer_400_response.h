...
/*
 * OAIEtcer_400_response.h
 *
 * 
 */

#ifndef OAIEtcer_400_response_H
#define OAIEtcer_400_response_H
...
class OAIEtcer_400_response : public OAIObject {
public:
    OAIEtcer_400_response();
    OAIEtcer_400_response(QString json);
    ~OAIEtcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_400_response)

#endif // OAIEtcer_400_response_H
