...
#ifndef OAISicer_request_H
#define OAISicer_request_H
...
namespace OpenAPI {
class OAISicer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAISicer_request : public OAIObject {
public:
    OAISicer_request();
    OAISicer_request(QString json);
    ~OAISicer_request() override;
    ...
    OAISicer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAISicer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAISicer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAISicer_request)

#endif // OAISicer_request_H
