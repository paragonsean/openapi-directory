...
/*
 * OAIEtcer_502_response.h
 *
 * 
 */

#ifndef OAIEtcer_502_response_H
#define OAIEtcer_502_response_H
...
class OAIEtcer_502_response : public OAIObject {
public:
    OAIEtcer_502_response();
    OAIEtcer_502_response(QString json);
    ~OAIEtcer_502_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_502_response)

#endif // OAIEtcer_502_response_H
