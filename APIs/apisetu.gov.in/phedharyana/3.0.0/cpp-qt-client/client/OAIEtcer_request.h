...
#ifndef OAIEtcer_request_H
#define OAIEtcer_request_H
...
namespace OpenAPI {
class OAIEtcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIEtcer_request : public OAIObject {
public:
    OAIEtcer_request();
    OAIEtcer_request(QString json);
    ~OAIEtcer_request() override;
    ...
    OAIEtcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIEtcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIEtcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_request)

#endif // OAIEtcer_request_H
