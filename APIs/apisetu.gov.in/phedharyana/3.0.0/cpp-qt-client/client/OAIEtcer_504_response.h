...
/*
 * OAIEtcer_504_response.h
 *
 * 
 */

#ifndef OAIEtcer_504_response_H
#define OAIEtcer_504_response_H
...
class OAIEtcer_504_response : public OAIObject {
public:
    OAIEtcer_504_response();
    OAIEtcer_504_response(QString json);
    ~OAIEtcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_504_response)

#endif // OAIEtcer_504_response_H
