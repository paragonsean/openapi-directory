...
OAISicer_request::OAISicer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISicer_request::OAISicer_request() {
    this->initializeModel();
}

OAISicer_request::~OAISicer_request() {}

void OAISicer_request::initializeModel() {
...
void OAISicer_request::fromJson(QString jsonString) {
...
void OAISicer_request::fromJsonObject(QJsonObject json) {
...
QString OAISicer_request::asJson() const {
...
QJsonObject OAISicer_request::asJsonObject() const {
    QJsonObject obj;
...
OAISicer_request_certificateParameters OAISicer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAISicer_request::setCertificateParameters(const OAISicer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAISicer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAISicer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAISicer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAISicer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAISicer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAISicer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAISicer_request::getFormat() const {
    return m_format;
}
void OAISicer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAISicer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAISicer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAISicer_request::getTxnId() const {
    return m_txn_id;
}
void OAISicer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAISicer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAISicer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAISicer_request::isSet() const {
...
bool OAISicer_request::isValid() const {
