...
/*
 * OAIEtcer_404_response.h
 *
 * 
 */

#ifndef OAIEtcer_404_response_H
#define OAIEtcer_404_response_H
...
class OAIEtcer_404_response : public OAIObject {
public:
    OAIEtcer_404_response();
    OAIEtcer_404_response(QString json);
    ~OAIEtcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_404_response)

#endif // OAIEtcer_404_response_H
