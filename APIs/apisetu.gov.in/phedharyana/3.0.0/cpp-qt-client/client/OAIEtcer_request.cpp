...
OAIEtcer_request::OAIEtcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEtcer_request::OAIEtcer_request() {
    this->initializeModel();
}

OAIEtcer_request::~OAIEtcer_request() {}

void OAIEtcer_request::initializeModel() {
...
void OAIEtcer_request::fromJson(QString jsonString) {
...
void OAIEtcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIEtcer_request::asJson() const {
...
QJsonObject OAIEtcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIEtcer_request_certificateParameters OAIEtcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIEtcer_request::setCertificateParameters(const OAIEtcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIEtcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIEtcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIEtcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIEtcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIEtcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIEtcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIEtcer_request::getFormat() const {
    return m_format;
}
void OAIEtcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIEtcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIEtcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIEtcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIEtcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIEtcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIEtcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIEtcer_request::isSet() const {
...
bool OAIEtcer_request::isValid() const {
