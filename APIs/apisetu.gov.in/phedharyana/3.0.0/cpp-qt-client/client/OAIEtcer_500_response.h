...
/*
 * OAIEtcer_500_response.h
 *
 * 
 */

#ifndef OAIEtcer_500_response_H
#define OAIEtcer_500_response_H
...
class OAIEtcer_500_response : public OAIObject {
public:
    OAIEtcer_500_response();
    OAIEtcer_500_response(QString json);
    ~OAIEtcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEtcer_500_response)

#endif // OAIEtcer_500_response_H
