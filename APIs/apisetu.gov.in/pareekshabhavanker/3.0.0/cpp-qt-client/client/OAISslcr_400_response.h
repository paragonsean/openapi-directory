...
/*
 * OAISslcr_400_response.h
 *
 * 
 */

#ifndef OAISslcr_400_response_H
#define OAISslcr_400_response_H
...
class OAISslcr_400_response : public OAIObject {
public:
    OAISslcr_400_response();
    OAISslcr_400_response(QString json);
    ~OAISslcr_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslcr_400_response)

#endif // OAISslcr_400_response_H
