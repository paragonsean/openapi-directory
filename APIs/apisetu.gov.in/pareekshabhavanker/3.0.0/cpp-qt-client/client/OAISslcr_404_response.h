...
/*
 * OAISslcr_404_response.h
 *
 * 
 */

#ifndef OAISslcr_404_response_H
#define OAISslcr_404_response_H
...
class OAISslcr_404_response : public OAIObject {
public:
    OAISslcr_404_response();
    OAISslcr_404_response(QString json);
    ~OAISslcr_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslcr_404_response)

#endif // OAISslcr_404_response_H
