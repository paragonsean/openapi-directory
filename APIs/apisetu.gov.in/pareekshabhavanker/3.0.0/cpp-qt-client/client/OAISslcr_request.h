...
#ifndef OAISslcr_request_H
#define OAISslcr_request_H
...
namespace OpenAPI {
class OAISslcr_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAISslcr_request : public OAIObject {
public:
    OAISslcr_request();
    OAISslcr_request(QString json);
    ~OAISslcr_request() override;
    ...
    OAISslcr_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAISslcr_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAISslcr_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAISslcr_request)

#endif // OAISslcr_request_H
