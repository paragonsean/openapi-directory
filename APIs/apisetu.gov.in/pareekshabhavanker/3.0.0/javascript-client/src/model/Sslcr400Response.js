...
/**
 * The Sslcr400Response model module.
 * @module model/Sslcr400Response
 * @version 3.0.0
 */
class Sslcr400Response {
    /**
     * Constructs a new <code>Sslcr400Response</code>.
     * @alias module:model/Sslcr400Response
     */
    constructor() { 
        
        Sslcr400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Sslcr400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Sslcr400Response} obj Optional instance to populate.
     * @return {module:model/Sslcr400Response} The populated <code>Sslcr400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Sslcr400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Sslcr400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Sslcr400Response</code>.
     */
...
/**
 * @member {module:model/Sslcr400Response.ErrorEnum} error
 */
Sslcr400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Sslcr400Response.ErrorDescriptionEnum} errorDescription
 */
Sslcr400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Sslcr400Response['ErrorDescriptionEnum'] = {
...
export default Sslcr400Response;
