...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransportDepartmentDadraNagarHaveli.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new TransportDepartmentDadraNagarHaveli.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(TransportDepartmentDadraNagarHaveli.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
