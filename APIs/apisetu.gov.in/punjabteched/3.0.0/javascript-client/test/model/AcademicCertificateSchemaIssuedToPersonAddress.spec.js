...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ThePunjabStateBoardOfTechnicalEducationIndustrialTraining.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new ThePunjabStateBoardOfTechnicalEducationIndustrialTraining.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(ThePunjabStateBoardOfTechnicalEducationIndustrialTraining.AcademicCertificateSchemaIssuedToPersonAddress);
    });
