...
/*
 * OAILicer_404_response.h
 *
 * 
 */

#ifndef OAILicer_404_response_H
#define OAILicer_404_response_H
...
class OAILicer_404_response : public OAIObject {
public:
    OAILicer_404_response();
    OAILicer_404_response(QString json);
    ~OAILicer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicer_404_response)

#endif // OAILicer_404_response_H
