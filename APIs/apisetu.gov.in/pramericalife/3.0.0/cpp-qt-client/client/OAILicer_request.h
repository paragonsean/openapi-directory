...
#ifndef OAILicer_request_H
#define OAILicer_request_H
...
namespace OpenAPI {
class OAILicer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAILicer_request : public OAIObject {
public:
    OAILicer_request();
    OAILicer_request(QString json);
    ~OAILicer_request() override;
    ...
    OAILicer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAILicer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAILicer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicer_request)

#endif // OAILicer_request_H
