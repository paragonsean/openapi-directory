...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManavRachnaInternationalInstituteOfResearchStudies.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new ManavRachnaInternationalInstituteOfResearchStudies.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(ManavRachnaInternationalInstituteOfResearchStudies.AcademicCertificateSchemaCertificateData);
    });
