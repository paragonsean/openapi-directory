...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManavRachnaInternationalInstituteOfResearchStudies.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new ManavRachnaInternationalInstituteOfResearchStudies.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(ManavRachnaInternationalInstituteOfResearchStudies.ConsentArtifactSchemaConsentUser);
    });
