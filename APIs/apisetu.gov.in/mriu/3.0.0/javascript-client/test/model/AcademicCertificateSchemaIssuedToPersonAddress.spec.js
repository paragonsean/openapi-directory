...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManavRachnaInternationalInstituteOfResearchStudies.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new ManavRachnaInternationalInstituteOfResearchStudies.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(ManavRachnaInternationalInstituteOfResearchStudies.AcademicCertificateSchemaIssuedToPersonAddress);
    });
