...
public class Escer404Response {
  ...
  public Escer404Response() {
  }

  public Escer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer404Response escer404Response = (Escer404Response) o;
    return Objects.equals(this.error, escer404Response.error) &&
        Objects.equals(this.errorDescription, escer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer404Response is not found in the empty JSON string", Escer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer404Response>() {
           @Override
           public void write(JsonWriter out, Escer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer404Response
   * @throws IOException if the JSON string is invalid with respect to Escer404Response
   */
  public static Escer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer404Response.class);
  }

  /**
   * Convert an instance of Escer404Response to an JSON string
   *
   * @return JSON string
   */
