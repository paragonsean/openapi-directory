...
public class Escer500Response {
  ...
  public Escer500Response() {
  }

  public Escer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer500Response escer500Response = (Escer500Response) o;
    return Objects.equals(this.error, escer500Response.error) &&
        Objects.equals(this.errorDescription, escer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer500Response is not found in the empty JSON string", Escer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer500Response>() {
           @Override
           public void write(JsonWriter out, Escer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer500Response
   * @throws IOException if the JSON string is invalid with respect to Escer500Response
   */
  public static Escer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer500Response.class);
  }

  /**
   * Convert an instance of Escer500Response to an JSON string
   *
   * @return JSON string
   */
