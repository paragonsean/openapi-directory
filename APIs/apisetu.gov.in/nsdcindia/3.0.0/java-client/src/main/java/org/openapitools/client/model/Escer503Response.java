...
public class Escer503Response {
  ...
  public Escer503Response() {
  }

  public Escer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer503Response escer503Response = (Escer503Response) o;
    return Objects.equals(this.error, escer503Response.error) &&
        Objects.equals(this.errorDescription, escer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer503Response is not found in the empty JSON string", Escer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer503Response>() {
           @Override
           public void write(JsonWriter out, Escer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer503Response
   * @throws IOException if the JSON string is invalid with respect to Escer503Response
   */
  public static Escer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer503Response.class);
  }

  /**
   * Convert an instance of Escer503Response to an JSON string
   *
   * @return JSON string
   */
