...
public class Escer502Response {
  ...
  public Escer502Response() {
  }

  public Escer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer502Response escer502Response = (Escer502Response) o;
    return Objects.equals(this.error, escer502Response.error) &&
        Objects.equals(this.errorDescription, escer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer502Response is not found in the empty JSON string", Escer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer502Response>() {
           @Override
           public void write(JsonWriter out, Escer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer502Response
   * @throws IOException if the JSON string is invalid with respect to Escer502Response
   */
  public static Escer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer502Response.class);
  }

  /**
   * Convert an instance of Escer502Response to an JSON string
   *
   * @return JSON string
   */
