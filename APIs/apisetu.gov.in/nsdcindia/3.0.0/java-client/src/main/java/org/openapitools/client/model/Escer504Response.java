...
public class Escer504Response {
  ...
  public Escer504Response() {
  }

  public Escer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer504Response escer504Response = (Escer504Response) o;
    return Objects.equals(this.error, escer504Response.error) &&
        Objects.equals(this.errorDescription, escer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer504Response is not found in the empty JSON string", Escer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer504Response>() {
           @Override
           public void write(JsonWriter out, Escer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer504Response
   * @throws IOException if the JSON string is invalid with respect to Escer504Response
   */
  public static Escer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer504Response.class);
  }

  /**
   * Convert an instance of Escer504Response to an JSON string
   *
   * @return JSON string
   */
