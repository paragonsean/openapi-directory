...
public class Escer401Response {
  ...
  public Escer401Response() {
  }

  public Escer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer401Response escer401Response = (Escer401Response) o;
    return Objects.equals(this.error, escer401Response.error) &&
        Objects.equals(this.errorDescription, escer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer401Response is not found in the empty JSON string", Escer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer401Response>() {
           @Override
           public void write(JsonWriter out, Escer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer401Response
   * @throws IOException if the JSON string is invalid with respect to Escer401Response
   */
  public static Escer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer401Response.class);
  }

  /**
   * Convert an instance of Escer401Response to an JSON string
   *
   * @return JSON string
   */
