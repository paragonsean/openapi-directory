...
public class Escer400Response {
  ...
  public Escer400Response() {
  }

  public Escer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Escer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Escer400Response escer400Response = (Escer400Response) o;
    return Objects.equals(this.error, escer400Response.error) &&
        Objects.equals(this.errorDescription, escer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Escer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Escer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Escer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Escer400Response is not found in the empty JSON string", Escer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Escer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Escer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Escer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Escer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Escer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Escer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Escer400Response>() {
           @Override
           public void write(JsonWriter out, Escer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Escer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Escer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Escer400Response
   * @throws IOException if the JSON string is invalid with respect to Escer400Response
   */
  public static Escer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Escer400Response.class);
  }

  /**
   * Convert an instance of Escer400Response to an JSON string
   *
   * @return JSON string
   */
