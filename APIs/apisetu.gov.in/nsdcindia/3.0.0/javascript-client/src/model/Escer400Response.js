...
/**
 * The Escer400Response model module.
 * @module model/Escer400Response
 * @version 3.0.0
 */
class Escer400Response {
    /**
     * Constructs a new <code>Escer400Response</code>.
     * @alias module:model/Escer400Response
     */
    constructor() { 
        
        Escer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Escer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Escer400Response} obj Optional instance to populate.
     * @return {module:model/Escer400Response} The populated <code>Escer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Escer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Escer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Escer400Response</code>.
     */
...
/**
 * @member {module:model/Escer400Response.ErrorEnum} error
 */
Escer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Escer400Response.ErrorDescriptionEnum} errorDescription
 */
Escer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Escer400Response['ErrorDescriptionEnum'] = {
...
export default Escer400Response;
