...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalSkillDevelopmentCorporationNsdc.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new NationalSkillDevelopmentCorporationNsdc.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(NationalSkillDevelopmentCorporationNsdc.AcademicCertificateSchemaCertificateData);
    });
