...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalSkillDevelopmentCorporationNsdc.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new NationalSkillDevelopmentCorporationNsdc.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(NationalSkillDevelopmentCorporationNsdc.ConsentArtifactSchemaConsentUser);
    });
