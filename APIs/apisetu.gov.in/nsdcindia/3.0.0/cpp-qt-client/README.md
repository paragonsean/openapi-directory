...
OAIEscer_request Example::create(){
    OAIEscer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::escerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::escerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIEscer_request oai_escer_request = create(); // OAIEscer_request | Request format
      apiInstance.escer(oai_escer_request);
