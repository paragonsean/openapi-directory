...
/*
 * OAIEscer_400_response.h
 *
 * 
 */

#ifndef OAIEscer_400_response_H
#define OAIEscer_400_response_H
...
class OAIEscer_400_response : public OAIObject {
public:
    OAIEscer_400_response();
    OAIEscer_400_response(QString json);
    ~OAIEscer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEscer_400_response)

#endif // OAIEscer_400_response_H
