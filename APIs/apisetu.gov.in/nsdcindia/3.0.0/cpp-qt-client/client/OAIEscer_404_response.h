...
/*
 * OAIEscer_404_response.h
 *
 * 
 */

#ifndef OAIEscer_404_response_H
#define OAIEscer_404_response_H
...
class OAIEscer_404_response : public OAIObject {
public:
    OAIEscer_404_response();
    OAIEscer_404_response(QString json);
    ~OAIEscer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEscer_404_response)

#endif // OAIEscer_404_response_H
