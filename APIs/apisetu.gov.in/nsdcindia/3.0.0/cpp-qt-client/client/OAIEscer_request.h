...
#ifndef OAIEscer_request_H
#define OAIEscer_request_H
...
namespace OpenAPI {
class OAIEscer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIEscer_request : public OAIObject {
public:
    OAIEscer_request();
    OAIEscer_request(QString json);
    ~OAIEscer_request() override;
    ...
    OAIEscer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIEscer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIEscer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEscer_request)

#endif // OAIEscer_request_H
