...
/**
 * The PANVerificationRecordSchemaIssuedToPerson model module.
 * @module model/PANVerificationRecordSchemaIssuedToPerson
 * @version 3.0.0
 */
class PANVerificationRecordSchemaIssuedToPerson {
    /**
     * Constructs a new <code>PANVerificationRecordSchemaIssuedToPerson</code>.
     * @alias module:model/PANVerificationRecordSchemaIssuedToPerson
    ...
    constructor(address, photo, dob, email, gender, maritalStatus, name, phone, religion, swd, swdIndicator, title, uid) { 
        ...
        PANVerificationRecordSchemaIssuedToPerson.initialize(this, address, photo, dob, email, gender, maritalStatus, name, phone, religion, swd, swdIndicator, title, uid);
    }
    ...
    /**
     * Constructs a <code>PANVerificationRecordSchemaIssuedToPerson</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PANVerificationRecordSchemaIssuedToPerson} obj Optional instance to populate.
     * @return {module:model/PANVerificationRecordSchemaIssuedToPerson} The populated <code>PANVerificationRecordSchemaIssuedToPerson</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PANVerificationRecordSchemaIssuedToPerson();
    ...
    /**
     * Validates the JSON data with respect to <code>PANVerificationRecordSchemaIssuedToPerson</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PANVerificationRecordSchemaIssuedToPerson</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PANVerificationRecordSchemaIssuedToPerson.RequiredProperties) {
...
PANVerificationRecordSchemaIssuedToPerson.RequiredProperties = ["Address", "Photo", "dob", "email", "gender", "maritalStatus", "name", "phone", "religion", "swd", "swdIndicator", "title", "uid"];

/**
 * @member {module:model/AcademicCertificateSchemaIssuedToPersonAddress} Address
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['Address'] = undefined;

/**
 * @member {module:model/AcademicCertificateSchemaIssuedToPersonPhoto} Photo
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['Photo'] = undefined;

/**
 * @member {String} dob
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['dob'] = undefined;

/**
 * @member {String} email
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['email'] = undefined;

/**
 * @member {String} gender
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['gender'] = undefined;

/**
 * @member {String} maritalStatus
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['maritalStatus'] = undefined;

/**
 * @member {String} name
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['name'] = undefined;

/**
 * @member {String} phone
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['phone'] = undefined;

/**
 * @member {String} religion
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['religion'] = undefined;

/**
 * @member {String} swd
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['swd'] = undefined;

/**
 * @member {String} swdIndicator
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['swdIndicator'] = undefined;

/**
 * @member {String} title
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['title'] = undefined;

/**
 * @member {String} uid
 */
PANVerificationRecordSchemaIssuedToPerson.prototype['uid'] = undefined;
...
export default PANVerificationRecordSchemaIssuedToPerson;
