...
/**
 * The Pancr400Response model module.
 * @module model/Pancr400Response
 * @version 3.0.0
 */
class Pancr400Response {
    /**
     * Constructs a new <code>Pancr400Response</code>.
     * @alias module:model/Pancr400Response
     */
    constructor() { 
        
        Pancr400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Pancr400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pancr400Response} obj Optional instance to populate.
     * @return {module:model/Pancr400Response} The populated <code>Pancr400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Pancr400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Pancr400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pancr400Response</code>.
     */
...
/**
 * @member {module:model/Pancr400Response.ErrorEnum} error
 */
Pancr400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Pancr400Response.ErrorDescriptionEnum} errorDescription
 */
Pancr400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Pancr400Response['ErrorDescriptionEnum'] = {
...
export default Pancr400Response;
