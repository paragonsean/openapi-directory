...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncomeTaxDepartment.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new IncomeTaxDepartment.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(IncomeTaxDepartment.AcademicCertificateSchemaCertificateData);
    });
