...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncomeTaxDepartment.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new IncomeTaxDepartment.ConsentArtifactSchema();
      //expect(instance).to.be.a(IncomeTaxDepartment.ConsentArtifactSchema);
    });
