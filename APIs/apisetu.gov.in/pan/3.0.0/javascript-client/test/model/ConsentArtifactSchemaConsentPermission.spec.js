...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IncomeTaxDepartment.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new IncomeTaxDepartment.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(IncomeTaxDepartment.ConsentArtifactSchemaConsentPermission);
    });
