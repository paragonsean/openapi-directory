...
public class Pancr404Response {
  ...
  public Pancr404Response() {
  }

  public Pancr404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr404Response pancr404Response = (Pancr404Response) o;
    return Objects.equals(this.error, pancr404Response.error) &&
        Objects.equals(this.errorDescription, pancr404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr404Response is not found in the empty JSON string", Pancr404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr404Response>() {
           @Override
           public void write(JsonWriter out, Pancr404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr404Response
   * @throws IOException if the JSON string is invalid with respect to Pancr404Response
   */
  public static Pancr404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr404Response.class);
  }

  /**
   * Convert an instance of Pancr404Response to an JSON string
   *
   * @return JSON string
   */
