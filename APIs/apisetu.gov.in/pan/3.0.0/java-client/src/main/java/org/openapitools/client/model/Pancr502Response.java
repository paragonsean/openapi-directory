...
public class Pancr502Response {
  ...
  public Pancr502Response() {
  }

  public Pancr502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr502Response pancr502Response = (Pancr502Response) o;
    return Objects.equals(this.error, pancr502Response.error) &&
        Objects.equals(this.errorDescription, pancr502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr502Response is not found in the empty JSON string", Pancr502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr502Response>() {
           @Override
           public void write(JsonWriter out, Pancr502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr502Response
   * @throws IOException if the JSON string is invalid with respect to Pancr502Response
   */
  public static Pancr502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr502Response.class);
  }

  /**
   * Convert an instance of Pancr502Response to an JSON string
   *
   * @return JSON string
   */
