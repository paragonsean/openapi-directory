...
public class Pancr503Response {
  ...
  public Pancr503Response() {
  }

  public Pancr503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr503Response pancr503Response = (Pancr503Response) o;
    return Objects.equals(this.error, pancr503Response.error) &&
        Objects.equals(this.errorDescription, pancr503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr503Response is not found in the empty JSON string", Pancr503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr503Response>() {
           @Override
           public void write(JsonWriter out, Pancr503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr503Response
   * @throws IOException if the JSON string is invalid with respect to Pancr503Response
   */
  public static Pancr503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr503Response.class);
  }

  /**
   * Convert an instance of Pancr503Response to an JSON string
   *
   * @return JSON string
   */
