...
public class Pancr504Response {
  ...
  public Pancr504Response() {
  }

  public Pancr504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr504Response pancr504Response = (Pancr504Response) o;
    return Objects.equals(this.error, pancr504Response.error) &&
        Objects.equals(this.errorDescription, pancr504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr504Response is not found in the empty JSON string", Pancr504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr504Response>() {
           @Override
           public void write(JsonWriter out, Pancr504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr504Response
   * @throws IOException if the JSON string is invalid with respect to Pancr504Response
   */
  public static Pancr504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr504Response.class);
  }

  /**
   * Convert an instance of Pancr504Response to an JSON string
   *
   * @return JSON string
   */
