...
public class Pancr401Response {
  ...
  public Pancr401Response() {
  }

  public Pancr401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr401Response pancr401Response = (Pancr401Response) o;
    return Objects.equals(this.error, pancr401Response.error) &&
        Objects.equals(this.errorDescription, pancr401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr401Response is not found in the empty JSON string", Pancr401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr401Response>() {
           @Override
           public void write(JsonWriter out, Pancr401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr401Response
   * @throws IOException if the JSON string is invalid with respect to Pancr401Response
   */
  public static Pancr401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr401Response.class);
  }

  /**
   * Convert an instance of Pancr401Response to an JSON string
   *
   * @return JSON string
   */
