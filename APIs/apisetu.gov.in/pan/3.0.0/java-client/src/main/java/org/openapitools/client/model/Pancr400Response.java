...
public class Pancr400Response {
  ...
  public Pancr400Response() {
  }

  public Pancr400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr400Response pancr400Response = (Pancr400Response) o;
    return Objects.equals(this.error, pancr400Response.error) &&
        Objects.equals(this.errorDescription, pancr400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr400Response is not found in the empty JSON string", Pancr400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr400Response>() {
           @Override
           public void write(JsonWriter out, Pancr400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr400Response
   * @throws IOException if the JSON string is invalid with respect to Pancr400Response
   */
  public static Pancr400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr400Response.class);
  }

  /**
   * Convert an instance of Pancr400Response to an JSON string
   *
   * @return JSON string
   */
