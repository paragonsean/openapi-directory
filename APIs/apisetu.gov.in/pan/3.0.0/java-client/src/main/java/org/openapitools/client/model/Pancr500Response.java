...
public class Pancr500Response {
  ...
  public Pancr500Response() {
  }

  public Pancr500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pancr500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pancr500Response pancr500Response = (Pancr500Response) o;
    return Objects.equals(this.error, pancr500Response.error) &&
        Objects.equals(this.errorDescription, pancr500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pancr500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pancr500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pancr500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pancr500Response is not found in the empty JSON string", Pancr500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pancr500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pancr500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pancr500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pancr500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pancr500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pancr500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pancr500Response>() {
           @Override
           public void write(JsonWriter out, Pancr500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pancr500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pancr500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pancr500Response
   * @throws IOException if the JSON string is invalid with respect to Pancr500Response
   */
  public static Pancr500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pancr500Response.class);
  }

  /**
   * Convert an instance of Pancr500Response to an JSON string
   *
   * @return JSON string
   */
