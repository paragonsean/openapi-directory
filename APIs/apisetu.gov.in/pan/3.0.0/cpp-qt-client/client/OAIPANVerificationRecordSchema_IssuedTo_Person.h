...
/*
 * OAIPANVerificationRecordSchema_IssuedTo_Person.h
 *
 * 
 */

#ifndef OAIPANVerificationRecordSchema_IssuedTo_Person_H
#define OAIPANVerificationRecordSchema_IssuedTo_Person_H
...
class OAIPANVerificationRecordSchema_IssuedTo_Person : public OAIObject {
public:
    OAIPANVerificationRecordSchema_IssuedTo_Person();
    OAIPANVerificationRecordSchema_IssuedTo_Person(QString json);
    ~OAIPANVerificationRecordSchema_IssuedTo_Person() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPANVerificationRecordSchema_IssuedTo_Person)

#endif // OAIPANVerificationRecordSchema_IssuedTo_Person_H
