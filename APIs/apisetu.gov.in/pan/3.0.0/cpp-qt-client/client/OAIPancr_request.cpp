...
OAIPancr_request::OAIPancr_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPancr_request::OAIPancr_request() {
    this->initializeModel();
}

OAIPancr_request::~OAIPancr_request() {}

void OAIPancr_request::initializeModel() {
...
void OAIPancr_request::fromJson(QString jsonString) {
...
void OAIPancr_request::fromJsonObject(QJsonObject json) {
...
QString OAIPancr_request::asJson() const {
...
QJsonObject OAIPancr_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPancr_request_certificateParameters OAIPancr_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIPancr_request::setCertificateParameters(const OAIPancr_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIPancr_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIPancr_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIPancr_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIPancr_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIPancr_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIPancr_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIPancr_request::getFormat() const {
    return m_format;
}
void OAIPancr_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPancr_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPancr_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPancr_request::getTxnId() const {
    return m_txn_id;
}
void OAIPancr_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIPancr_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIPancr_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIPancr_request::isSet() const {
...
bool OAIPancr_request::isValid() const {
