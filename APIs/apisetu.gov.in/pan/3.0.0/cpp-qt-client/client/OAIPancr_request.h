...
#ifndef OAIPancr_request_H
#define OAIPancr_request_H
...
namespace OpenAPI {
class OAIPancr_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIPancr_request : public OAIObject {
public:
    OAIPancr_request();
    OAIPancr_request(QString json);
    ~OAIPancr_request() override;
    ...
    OAIPancr_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIPancr_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIPancr_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPancr_request)

#endif // OAIPancr_request_H
