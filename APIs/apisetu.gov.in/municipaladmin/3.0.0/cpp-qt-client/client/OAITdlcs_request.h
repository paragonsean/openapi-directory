...
#ifndef OAITdlcs_request_H
#define OAITdlcs_request_H

#include <QJsonObject>

#include "OAIConsentArtifactSchema.h"
#include "OAITdlcs_request_certificateParameters.h"
#include <QString>
...
namespace OpenAPI {
class OAITdlcs_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAITdlcs_request : public OAIObject {
public:
    OAITdlcs_request();
    OAITdlcs_request(QString json);
    ~OAITdlcs_request() override;
    ...
    OAITdlcs_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAITdlcs_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAITdlcs_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAITdlcs_request)

#endif // OAITdlcs_request_H
