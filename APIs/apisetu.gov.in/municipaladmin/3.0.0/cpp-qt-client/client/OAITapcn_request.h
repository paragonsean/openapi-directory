...
#ifndef OAITapcn_request_H
#define OAITapcn_request_H

#include <QJsonObject>

#include "OAIConsentArtifactSchema.h"
#include "OAITapcn_request_certificateParameters.h"
#include <QString>
...
namespace OpenAPI {
class OAITapcn_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAITapcn_request : public OAIObject {
public:
    OAITapcn_request();
    OAITapcn_request(QString json);
    ~OAITapcn_request() override;
    ...
    OAITapcn_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAITapcn_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAITapcn_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAITapcn_request)

#endif // OAITapcn_request_H
