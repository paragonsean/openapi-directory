...
OAITapcn_request::OAITapcn_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITapcn_request::OAITapcn_request() {
    this->initializeModel();
}

OAITapcn_request::~OAITapcn_request() {}

void OAITapcn_request::initializeModel() {
...
void OAITapcn_request::fromJson(QString jsonString) {
...
void OAITapcn_request::fromJsonObject(QJsonObject json) {
...
QString OAITapcn_request::asJson() const {
...
QJsonObject OAITapcn_request::asJsonObject() const {
    QJsonObject obj;
...
OAITapcn_request_certificateParameters OAITapcn_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAITapcn_request::setCertificateParameters(const OAITapcn_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAITapcn_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAITapcn_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAITapcn_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAITapcn_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAITapcn_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAITapcn_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAITapcn_request::getFormat() const {
    return m_format;
}
void OAITapcn_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAITapcn_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAITapcn_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAITapcn_request::getTxnId() const {
    return m_txn_id;
}
void OAITapcn_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAITapcn_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAITapcn_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAITapcn_request::isSet() const {
...
bool OAITapcn_request::isValid() const {
