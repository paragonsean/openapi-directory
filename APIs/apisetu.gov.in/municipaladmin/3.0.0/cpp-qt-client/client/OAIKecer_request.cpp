...
OAIKecer_request::OAIKecer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKecer_request::OAIKecer_request() {
    this->initializeModel();
}

OAIKecer_request::~OAIKecer_request() {}

void OAIKecer_request::initializeModel() {
...
void OAIKecer_request::fromJson(QString jsonString) {
...
void OAIKecer_request::fromJsonObject(QJsonObject json) {
...
QString OAIKecer_request::asJson() const {
...
QJsonObject OAIKecer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIKecer_request_certificateParameters OAIKecer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIKecer_request::setCertificateParameters(const OAIKecer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIKecer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIKecer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIKecer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIKecer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIKecer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIKecer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIKecer_request::getFormat() const {
    return m_format;
}
void OAIKecer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIKecer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIKecer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIKecer_request::getTxnId() const {
    return m_txn_id;
}
void OAIKecer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIKecer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIKecer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIKecer_request::isSet() const {
...
bool OAIKecer_request::isValid() const {
