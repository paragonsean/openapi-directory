...
/*
 * OAIKecer_500_response.h
 *
 * 
 */

#ifndef OAIKecer_500_response_H
#define OAIKecer_500_response_H
...
class OAIKecer_500_response : public OAIObject {
public:
    OAIKecer_500_response();
    OAIKecer_500_response(QString json);
    ~OAIKecer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKecer_500_response)

#endif // OAIKecer_500_response_H
