...
/*
 * OAIKecer_404_response.h
 *
 * 
 */

#ifndef OAIKecer_404_response_H
#define OAIKecer_404_response_H
...
class OAIKecer_404_response : public OAIObject {
public:
    OAIKecer_404_response();
    OAIKecer_404_response(QString json);
    ~OAIKecer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKecer_404_response)

#endif // OAIKecer_404_response_H
