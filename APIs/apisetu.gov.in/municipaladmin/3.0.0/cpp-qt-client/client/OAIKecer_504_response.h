...
/*
 * OAIKecer_504_response.h
 *
 * 
 */

#ifndef OAIKecer_504_response_H
#define OAIKecer_504_response_H
...
class OAIKecer_504_response : public OAIObject {
public:
    OAIKecer_504_response();
    OAIKecer_504_response(QString json);
    ~OAIKecer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKecer_504_response)

#endif // OAIKecer_504_response_H
