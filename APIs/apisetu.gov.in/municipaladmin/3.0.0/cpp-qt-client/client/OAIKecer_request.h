...
#ifndef OAIKecer_request_H
#define OAIKecer_request_H
...
namespace OpenAPI {
class OAIKecer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIKecer_request : public OAIObject {
public:
    OAIKecer_request();
    OAIKecer_request(QString json);
    ~OAIKecer_request() override;
    ...
    OAIKecer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIKecer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIKecer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKecer_request)

#endif // OAIKecer_request_H
