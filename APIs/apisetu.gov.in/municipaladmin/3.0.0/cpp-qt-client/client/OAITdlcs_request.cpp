...
OAITdlcs_request::OAITdlcs_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITdlcs_request::OAITdlcs_request() {
    this->initializeModel();
}

OAITdlcs_request::~OAITdlcs_request() {}

void OAITdlcs_request::initializeModel() {
...
void OAITdlcs_request::fromJson(QString jsonString) {
...
void OAITdlcs_request::fromJsonObject(QJsonObject json) {
...
QString OAITdlcs_request::asJson() const {
...
QJsonObject OAITdlcs_request::asJsonObject() const {
    QJsonObject obj;
...
OAITdlcs_request_certificateParameters OAITdlcs_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAITdlcs_request::setCertificateParameters(const OAITdlcs_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAITdlcs_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAITdlcs_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAITdlcs_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAITdlcs_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAITdlcs_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAITdlcs_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAITdlcs_request::getFormat() const {
    return m_format;
}
void OAITdlcs_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAITdlcs_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAITdlcs_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAITdlcs_request::getTxnId() const {
    return m_txn_id;
}
void OAITdlcs_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAITdlcs_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAITdlcs_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAITdlcs_request::isSet() const {
...
bool OAITdlcs_request::isValid() const {
