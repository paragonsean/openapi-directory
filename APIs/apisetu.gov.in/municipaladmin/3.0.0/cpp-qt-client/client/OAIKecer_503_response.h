...
/*
 * OAIKecer_503_response.h
 *
 * 
 */

#ifndef OAIKecer_503_response_H
#define OAIKecer_503_response_H
...
class OAIKecer_503_response : public OAIObject {
public:
    OAIKecer_503_response();
    OAIKecer_503_response(QString json);
    ~OAIKecer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKecer_503_response)

#endif // OAIKecer_503_response_H
