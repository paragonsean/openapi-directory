...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    TapcnRequest tapcnRequest = new TapcnRequest(); // TapcnRequest | Request format
    try {
      apiInstance.tapcn(tapcnRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#tapcn");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    TdlcsRequest tdlcsRequest = new TdlcsRequest(); // TdlcsRequest | Request format
    try {
      apiInstance.tdlcs(tdlcsRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#tdlcs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    TapcnRequest tapcnRequest = new TapcnRequest(); // TapcnRequest | Request format
    try {
      apiInstance.ugdcn(tapcnRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#ugdcn");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
