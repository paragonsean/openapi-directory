...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfMunicipalAdministrationKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new DirectorateOfMunicipalAdministrationKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(DirectorateOfMunicipalAdministrationKarnataka.AcademicCertificateSchemaIssuedToPersonAddress);
    });
