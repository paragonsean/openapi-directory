...
/**
 * The Kecer400Response model module.
 * @module model/Kecer400Response
 * @version 3.0.0
 */
class Kecer400Response {
    /**
     * Constructs a new <code>Kecer400Response</code>.
     * @alias module:model/Kecer400Response
     */
    constructor() { 
        
        Kecer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Kecer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Kecer400Response} obj Optional instance to populate.
     * @return {module:model/Kecer400Response} The populated <code>Kecer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Kecer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Kecer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Kecer400Response</code>.
     */
...
/**
 * @member {module:model/Kecer400Response.ErrorEnum} error
 */
Kecer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Kecer400Response.ErrorDescriptionEnum} errorDescription
 */
Kecer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Kecer400Response['ErrorDescriptionEnum'] = {
...
export default Kecer400Response;
