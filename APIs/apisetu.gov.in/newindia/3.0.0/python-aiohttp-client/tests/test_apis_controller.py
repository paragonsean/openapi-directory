...
async def test_cripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/cripc/certificate',
        headers=headers,
        json=body,
        )
...
async def test_cvipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/cvipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_egipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/egipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hlipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/hlipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_miipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/miipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/tripc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_twipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/newindia/v3/twipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
