...
#ifndef OAICripc_request_H
#define OAICripc_request_H
...
namespace OpenAPI {
class OAICripc_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAICripc_request : public OAIObject {
public:
    OAICripc_request();
    OAICripc_request(QString json);
    ~OAICripc_request() override;
    ...
    OAICripc_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAICripc_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAICripc_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICripc_request)

#endif // OAICripc_request_H
