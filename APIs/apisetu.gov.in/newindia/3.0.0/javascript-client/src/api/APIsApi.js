...
export default class APIsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the miipc operation.
     * @callback module:api/APIsApi~miipcCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CripcRequest} [cripcRequest] Request format
     * @param {module:api/APIsApi~miipcCallback} callback The callback function, accepting three arguments: error, data, response
     */
    miipc(opts, callback) {
      opts = opts || {};
      let postBody = opts['cripcRequest'];
