...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NewIndiaAssuranceCoLtd.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new NewIndiaAssuranceCoLtd.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(NewIndiaAssuranceCoLtd.ConsentArtifactSchemaConsentUser);
    });
