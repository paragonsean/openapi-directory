...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NewIndiaAssuranceCoLtd.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new NewIndiaAssuranceCoLtd.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(NewIndiaAssuranceCoLtd.AcademicCertificateSchemaCertificateData);
    });
