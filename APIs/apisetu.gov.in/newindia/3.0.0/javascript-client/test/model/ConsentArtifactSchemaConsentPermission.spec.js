...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NewIndiaAssuranceCoLtd.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new NewIndiaAssuranceCoLtd.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(NewIndiaAssuranceCoLtd.ConsentArtifactSchemaConsentPermission);
    });
