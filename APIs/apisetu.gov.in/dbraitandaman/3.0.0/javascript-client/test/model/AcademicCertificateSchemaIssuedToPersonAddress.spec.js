...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DrBRAmbedkarInstituteOfTechnologyandamanNicobarIslands.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new DrBRAmbedkarInstituteOfTechnologyandamanNicobarIslands.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(DrBRAmbedkarInstituteOfTechnologyandamanNicobarIslands.AcademicCertificateSchemaIssuedToPersonAddress);
    });
