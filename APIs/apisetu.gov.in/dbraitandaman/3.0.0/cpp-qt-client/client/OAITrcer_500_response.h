...
/*
 * OAITrcer_500_response.h
 *
 * 
 */

#ifndef OAITrcer_500_response_H
#define OAITrcer_500_response_H
...
class OAITrcer_500_response : public OAIObject {
public:
    OAITrcer_500_response();
    OAITrcer_500_response(QString json);
    ~OAITrcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrcer_500_response)

#endif // OAITrcer_500_response_H
