...
/*
 * OAITrcer_404_response.h
 *
 * 
 */

#ifndef OAITrcer_404_response_H
#define OAITrcer_404_response_H
...
class OAITrcer_404_response : public OAIObject {
public:
    OAITrcer_404_response();
    OAITrcer_404_response(QString json);
    ~OAITrcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrcer_404_response)

#endif // OAITrcer_404_response_H
