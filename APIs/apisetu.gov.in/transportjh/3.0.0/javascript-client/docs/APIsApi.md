# TransportDepartmentJharkhand.APIsApi
...
```javascript
import TransportDepartmentJharkhand from 'transport_department_jharkhand';
let defaultClient = TransportDepartmentJharkhand.ApiClient.instance;
...
let apiInstance = new TransportDepartmentJharkhand.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentJharkhand.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentJharkhand.RvcerRequest() // RvcerRequest | Request format
};
