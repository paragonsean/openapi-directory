...
#ifndef OAIPmjay_request_H
#define OAIPmjay_request_H
...
namespace OpenAPI {
class OAIPmjay_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIPmjay_request : public OAIObject {
public:
    OAIPmjay_request();
    OAIPmjay_request(QString json);
    ~OAIPmjay_request() override;
    ...
    OAIPmjay_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIPmjay_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIPmjay_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPmjay_request)

#endif // OAIPmjay_request_H
