...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalHealthAuthority.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new NationalHealthAuthority.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(NationalHealthAuthority.ConsentArtifactSchemaConsentPermission);
    });
