...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalHealthAuthority.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new NationalHealthAuthority.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(NationalHealthAuthority.AcademicCertificateSchemaCertificateData);
    });
