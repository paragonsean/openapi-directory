...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalHealthAuthority.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new NationalHealthAuthority.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(NationalHealthAuthority.ConsentArtifactSchemaConsentUser);
    });
