...
/**
 * The Pmjay400Response model module.
 * @module model/Pmjay400Response
 * @version 3.0.0
 */
class Pmjay400Response {
    /**
     * Constructs a new <code>Pmjay400Response</code>.
     * @alias module:model/Pmjay400Response
     */
    constructor() { 
        
        Pmjay400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Pmjay400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pmjay400Response} obj Optional instance to populate.
     * @return {module:model/Pmjay400Response} The populated <code>Pmjay400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Pmjay400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Pmjay400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pmjay400Response</code>.
     */
...
/**
 * @member {module:model/Pmjay400Response.ErrorEnum} error
 */
Pmjay400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Pmjay400Response.ErrorDescriptionEnum} errorDescription
 */
Pmjay400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Pmjay400Response['ErrorDescriptionEnum'] = {
...
export default Pmjay400Response;
