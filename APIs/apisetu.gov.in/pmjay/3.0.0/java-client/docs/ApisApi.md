...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/pmjay/v3");
    ...
    PmjayRequest pmjayRequest = new PmjayRequest(); // PmjayRequest | Request format
    try {
      apiInstance.pmjay(pmjayRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#pmjay");
