...
public class Pmjay401Response {
  ...
  public Pmjay401Response() {
  }

  public Pmjay401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pmjay401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pmjay401Response pmjay401Response = (Pmjay401Response) o;
    return Objects.equals(this.error, pmjay401Response.error) &&
        Objects.equals(this.errorDescription, pmjay401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pmjay401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pmjay401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pmjay401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pmjay401Response is not found in the empty JSON string", Pmjay401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pmjay401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pmjay401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pmjay401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pmjay401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pmjay401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pmjay401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pmjay401Response>() {
           @Override
           public void write(JsonWriter out, Pmjay401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pmjay401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pmjay401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pmjay401Response
   * @throws IOException if the JSON string is invalid with respect to Pmjay401Response
   */
  public static Pmjay401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pmjay401Response.class);
  }

  /**
   * Convert an instance of Pmjay401Response to an JSON string
   *
   * @return JSON string
   */
