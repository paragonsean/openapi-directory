...
/*
 * OAILpgsv_404_response.h
 *
 * 
 */

#ifndef OAILpgsv_404_response_H
#define OAILpgsv_404_response_H
...
class OAILpgsv_404_response : public OAIObject {
public:
    OAILpgsv_404_response();
    OAILpgsv_404_response(QString json);
    ~OAILpgsv_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILpgsv_404_response)

#endif // OAILpgsv_404_response_H
