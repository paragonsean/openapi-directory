# TransportDepartmentManipur.APIsApi
...
```javascript
import TransportDepartmentManipur from 'transport_department_manipur';
let defaultClient = TransportDepartmentManipur.ApiClient.instance;
...
let apiInstance = new TransportDepartmentManipur.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentManipur.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentManipur.RvcerRequest() // RvcerRequest | Request format
};
