...
#ifndef OAINncer_request_H
#define OAINncer_request_H
...
namespace OpenAPI {
class OAINncer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAINncer_request : public OAIObject {
public:
    OAINncer_request();
    OAINncer_request(QString json);
    ~OAINncer_request() override;
    ...
    OAINncer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAINncer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAINncer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAINncer_request)

#endif // OAINncer_request_H
