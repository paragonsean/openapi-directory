...
/*
 * OAINncer_404_response.h
 *
 * 
 */

#ifndef OAINncer_404_response_H
#define OAINncer_404_response_H
...
class OAINncer_404_response : public OAIObject {
public:
    OAINncer_404_response();
    OAINncer_404_response(QString json);
    ~OAINncer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINncer_404_response)

#endif // OAINncer_404_response_H
