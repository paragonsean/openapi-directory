...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RevenueDisasterManagementDepartmentAssamAssam.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new RevenueDisasterManagementDepartmentAssamAssam.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(RevenueDisasterManagementDepartmentAssamAssam.AcademicCertificateSchemaIssuedToPersonAddress);
    });
