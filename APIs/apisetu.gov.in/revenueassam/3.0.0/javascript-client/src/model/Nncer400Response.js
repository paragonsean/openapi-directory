...
/**
 * The Nncer400Response model module.
 * @module model/Nncer400Response
 * @version 3.0.0
 */
class Nncer400Response {
    /**
     * Constructs a new <code>Nncer400Response</code>.
     * @alias module:model/Nncer400Response
     */
    constructor() { 
        
        Nncer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Nncer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Nncer400Response} obj Optional instance to populate.
     * @return {module:model/Nncer400Response} The populated <code>Nncer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Nncer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Nncer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Nncer400Response</code>.
     */
...
/**
 * @member {module:model/Nncer400Response.ErrorEnum} error
 */
Nncer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Nncer400Response.ErrorDescriptionEnum} errorDescription
 */
Nncer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Nncer400Response['ErrorDescriptionEnum'] = {
...
export default Nncer400Response;
