...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/revenueassam/v3");
    ...
    NncerRequest nncerRequest = new NncerRequest(); // NncerRequest | Request format
    try {
      apiInstance.nncer(nncerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#nncer");
