...
setup(
    name=NAME,
    version=VERSION,
    description="HP Staff Selection Commission - HPSSC - Himachal Pradesh, Himachal Pradesh",
    author_email="",
    url="",
    keywords=["OpenAPI", "HP Staff Selection Commission - HPSSC - Himachal Pradesh, Himachal Pradesh"],
