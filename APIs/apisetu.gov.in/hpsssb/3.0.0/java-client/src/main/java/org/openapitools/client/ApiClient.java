...
public class ApiClient {
    ...
    private String basePath = "https://apisetu.gov.in/hpsssb/v3";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://apisetu.gov.in/hpsssb/v3",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apisetu.gov.in/hpsssb/v3
