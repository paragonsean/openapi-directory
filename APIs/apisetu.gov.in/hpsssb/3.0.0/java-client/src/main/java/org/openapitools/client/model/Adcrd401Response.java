...
public class Adcrd401Response {
  ...
  public Adcrd401Response() {
  }

  public Adcrd401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Adcrd401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Adcrd401Response adcrd401Response = (Adcrd401Response) o;
    return Objects.equals(this.error, adcrd401Response.error) &&
        Objects.equals(this.errorDescription, adcrd401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adcrd401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Adcrd401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Adcrd401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adcrd401Response is not found in the empty JSON string", Adcrd401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Adcrd401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Adcrd401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adcrd401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adcrd401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adcrd401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adcrd401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Adcrd401Response>() {
           @Override
           public void write(JsonWriter out, Adcrd401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Adcrd401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Adcrd401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Adcrd401Response
   * @throws IOException if the JSON string is invalid with respect to Adcrd401Response
   */
  public static Adcrd401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adcrd401Response.class);
  }

  /**
   * Convert an instance of Adcrd401Response to an JSON string
   *
   * @return JSON string
   */
