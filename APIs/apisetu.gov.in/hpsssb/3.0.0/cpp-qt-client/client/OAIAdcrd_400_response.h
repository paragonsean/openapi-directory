...
/*
 * OAIAdcrd_400_response.h
 *
 * 
 */

#ifndef OAIAdcrd_400_response_H
#define OAIAdcrd_400_response_H
...
class OAIAdcrd_400_response : public OAIObject {
public:
    OAIAdcrd_400_response();
    OAIAdcrd_400_response(QString json);
    ~OAIAdcrd_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdcrd_400_response)

#endif // OAIAdcrd_400_response_H
