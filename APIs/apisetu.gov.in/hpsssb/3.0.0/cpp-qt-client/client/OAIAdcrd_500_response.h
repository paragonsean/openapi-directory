...
/*
 * OAIAdcrd_500_response.h
 *
 * 
 */

#ifndef OAIAdcrd_500_response_H
#define OAIAdcrd_500_response_H
...
class OAIAdcrd_500_response : public OAIObject {
public:
    OAIAdcrd_500_response();
    OAIAdcrd_500_response(QString json);
    ~OAIAdcrd_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdcrd_500_response)

#endif // OAIAdcrd_500_response_H
