# TransportDepartmentSikkim.APIsApi
...
```javascript
import TransportDepartmentSikkim from 'transport_department_sikkim';
let defaultClient = TransportDepartmentSikkim.ApiClient.instance;
...
let apiInstance = new TransportDepartmentSikkim.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentSikkim.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentSikkim.RvcerRequest() // RvcerRequest | Request format
};
