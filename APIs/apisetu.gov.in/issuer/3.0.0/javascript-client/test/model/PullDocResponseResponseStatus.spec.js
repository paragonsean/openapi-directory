...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigiLockerIssuerApis.PullDocResponseResponseStatus();
  });
  ...
  describe('PullDocResponseResponseStatus', function() {
    it('should create an instance of PullDocResponseResponseStatus', function() {
      // uncomment below and update the code to test PullDocResponseResponseStatus
      //var instance = new DigiLockerIssuerApis.PullDocResponseResponseStatus();
      //expect(instance).to.be.a(DigiLockerIssuerApis.PullDocResponseResponseStatus);
    });
