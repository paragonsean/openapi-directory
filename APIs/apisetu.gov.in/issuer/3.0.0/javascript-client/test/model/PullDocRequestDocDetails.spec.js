...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigiLockerIssuerApis.PullDocRequestDocDetails();
  });
  ...
  describe('PullDocRequestDocDetails', function() {
    it('should create an instance of PullDocRequestDocDetails', function() {
      // uncomment below and update the code to test PullDocRequestDocDetails
      //var instance = new DigiLockerIssuerApis.PullDocRequestDocDetails();
      //expect(instance).to.be.a(DigiLockerIssuerApis.PullDocRequestDocDetails);
    });
