...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigiLockerIssuerApis.PullURIResponse();
  });
  ...
  describe('PullURIResponse', function() {
    it('should create an instance of PullURIResponse', function() {
      // uncomment below and update the code to test PullURIResponse
      //var instance = new DigiLockerIssuerApis.PullURIResponse();
      //expect(instance).to.be.a(DigiLockerIssuerApis.PullURIResponse);
    });
