...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigiLockerIssuerApis.PullURIRequest();
  });
  ...
  describe('PullURIRequest', function() {
    it('should create an instance of PullURIRequest', function() {
      // uncomment below and update the code to test PullURIRequest
      //var instance = new DigiLockerIssuerApis.PullURIRequest();
      //expect(instance).to.be.a(DigiLockerIssuerApis.PullURIRequest);
    });
