...
/**
 * The PullDocResponseResponseStatus model module.
 * @module model/PullDocResponseResponseStatus
 * @version 3.0.0
 */
class PullDocResponseResponseStatus {
    /**
     * Constructs a new <code>PullDocResponseResponseStatus</code>.
     * @alias module:model/PullDocResponseResponseStatus
     * @param status {String} 1 for success, 0 for error.
    ...
    constructor(status, ts, txn) { 
        ...
        PullDocResponseResponseStatus.initialize(this, status, ts, txn);
    }
    ...
    /**
     * Constructs a <code>PullDocResponseResponseStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PullDocResponseResponseStatus} obj Optional instance to populate.
     * @return {module:model/PullDocResponseResponseStatus} The populated <code>PullDocResponseResponseStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PullDocResponseResponseStatus();
    ...
    /**
     * Validates the JSON data with respect to <code>PullDocResponseResponseStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PullDocResponseResponseStatus</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PullDocResponseResponseStatus.RequiredProperties) {
...
PullDocResponseResponseStatus.RequiredProperties = ["Status", "ts", "txn"];

/**
 * 1 for success, 0 for error.
 * @member {String} Status
 */
PullDocResponseResponseStatus.prototype['Status'] = undefined;

/**
 * A timestamp value as sent in the request.
 * @member {String} ts
 */
PullDocResponseResponseStatus.prototype['ts'] = undefined;

/**
 * Transaction id value as sent in the request.
 * @member {String} txn
 */
PullDocResponseResponseStatus.prototype['txn'] = undefined;
...
export default PullDocResponseResponseStatus;
