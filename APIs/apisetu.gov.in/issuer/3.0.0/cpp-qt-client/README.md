...
QString Example::create(){
    QString obj;
OAIPullDocRequest Example::create(){
    OAIPullDocRequest obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::pull_DocSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::pull_DocSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString content_type = create(); // QString | application/xml
      ...
      OAIPullDocRequest oai_pull_doc_request = create(); // OAIPullDocRequest | 
      apiInstance.pull_Doc(content_typex_digilocker_hmacoai_pull_doc_request);
