...
#ifndef OAIPullURIRequest_H
#define OAIPullURIRequest_H
...
namespace OpenAPI {
class OAIPullURIRequest_DocDetails;

class OAIPullURIRequest : public OAIObject {
public:
    OAIPullURIRequest();
    OAIPullURIRequest(QString json);
    ~OAIPullURIRequest() override;
    ...
    OAIPullURIRequest_DocDetails getDocDetails() const;
    void setDocDetails(const OAIPullURIRequest_DocDetails &doc_details);
...
private:
    ...
    OAIPullURIRequest_DocDetails m_doc_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullURIRequest)

#endif // OAIPullURIRequest_H
