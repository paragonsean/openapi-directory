...
OAIPullURIRequest::OAIPullURIRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPullURIRequest::OAIPullURIRequest() {
    this->initializeModel();
}

OAIPullURIRequest::~OAIPullURIRequest() {}

void OAIPullURIRequest::initializeModel() {
...
void OAIPullURIRequest::fromJson(QString jsonString) {
...
void OAIPullURIRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPullURIRequest::asJson() const {
...
QJsonObject OAIPullURIRequest::asJsonObject() const {
    QJsonObject obj;
...
OAIPullURIRequest_DocDetails OAIPullURIRequest::getDocDetails() const {
    return m_doc_details;
}
void OAIPullURIRequest::setDocDetails(const OAIPullURIRequest_DocDetails &doc_details) {
    m_doc_details = doc_details;
    m_doc_details_isSet = true;
}

bool OAIPullURIRequest::is_doc_details_Set() const{
    return m_doc_details_isSet;
}

bool OAIPullURIRequest::is_doc_details_Valid() const{
    return m_doc_details_isValid;
}

QString OAIPullURIRequest::getFormat() const {
    return m_format;
}
void OAIPullURIRequest::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPullURIRequest::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPullURIRequest::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPullURIRequest::getOrgId() const {
    return m_org_id;
}
void OAIPullURIRequest::setOrgId(const QString &org_id) {
    m_org_id = org_id;
    m_org_id_isSet = true;
}

bool OAIPullURIRequest::is_org_id_Set() const{
    return m_org_id_isSet;
}

bool OAIPullURIRequest::is_org_id_Valid() const{
    return m_org_id_isValid;
}

QString OAIPullURIRequest::getTs() const {
    return m_ts;
}
void OAIPullURIRequest::setTs(const QString &ts) {
    m_ts = ts;
    m_ts_isSet = true;
}

bool OAIPullURIRequest::is_ts_Set() const{
    return m_ts_isSet;
}

bool OAIPullURIRequest::is_ts_Valid() const{
    return m_ts_isValid;
}

QString OAIPullURIRequest::getTxn() const {
    return m_txn;
}
void OAIPullURIRequest::setTxn(const QString &txn) {
    m_txn = txn;
    m_txn_isSet = true;
}

bool OAIPullURIRequest::is_txn_Set() const{
    return m_txn_isSet;
}

bool OAIPullURIRequest::is_txn_Valid() const{
    return m_txn_isValid;
}

QString OAIPullURIRequest::getVer() const {
    return m_ver;
}
void OAIPullURIRequest::setVer(const QString &ver) {
    m_ver = ver;
    m_ver_isSet = true;
}

bool OAIPullURIRequest::is_ver_Set() const{
    return m_ver_isSet;
}

bool OAIPullURIRequest::is_ver_Valid() const{
    return m_ver_isValid;
}

bool OAIPullURIRequest::isSet() const {
...
bool OAIPullURIRequest::isValid() const {
