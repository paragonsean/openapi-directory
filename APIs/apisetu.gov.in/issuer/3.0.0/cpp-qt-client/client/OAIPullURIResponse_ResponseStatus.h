...
/*
 * OAIPullURIResponse_ResponseStatus.h
 *
 * 
 */

#ifndef OAIPullURIResponse_ResponseStatus_H
#define OAIPullURIResponse_ResponseStatus_H
...
class OAIPullURIResponse_ResponseStatus : public OAIObject {
public:
    OAIPullURIResponse_ResponseStatus();
    OAIPullURIResponse_ResponseStatus(QString json);
    ~OAIPullURIResponse_ResponseStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPullURIResponse_ResponseStatus)

#endif // OAIPullURIResponse_ResponseStatus_H
