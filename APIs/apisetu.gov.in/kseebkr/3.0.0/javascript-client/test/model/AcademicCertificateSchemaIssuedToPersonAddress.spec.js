...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KarnatakaSecondaryEducationExaminationBoardKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new KarnatakaSecondaryEducationExaminationBoardKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(KarnatakaSecondaryEducationExaminationBoardKarnataka.AcademicCertificateSchemaIssuedToPersonAddress);
    });
