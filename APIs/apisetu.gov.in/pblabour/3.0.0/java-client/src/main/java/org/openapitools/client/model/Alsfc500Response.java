...
public class Alsfc500Response {
  ...
  public Alsfc500Response() {
  }

  public Alsfc500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Alsfc500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Alsfc500Response alsfc500Response = (Alsfc500Response) o;
    return Objects.equals(this.error, alsfc500Response.error) &&
        Objects.equals(this.errorDescription, alsfc500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Alsfc500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Alsfc500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Alsfc500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Alsfc500Response is not found in the empty JSON string", Alsfc500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Alsfc500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Alsfc500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Alsfc500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Alsfc500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Alsfc500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Alsfc500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Alsfc500Response>() {
           @Override
           public void write(JsonWriter out, Alsfc500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Alsfc500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Alsfc500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Alsfc500Response
   * @throws IOException if the JSON string is invalid with respect to Alsfc500Response
   */
  public static Alsfc500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Alsfc500Response.class);
  }

  /**
   * Convert an instance of Alsfc500Response to an JSON string
   *
   * @return JSON string
   */
