...
/*
 * OAIAlsfc_404_response.h
 *
 * 
 */

#ifndef OAIAlsfc_404_response_H
#define OAIAlsfc_404_response_H
...
class OAIAlsfc_404_response : public OAIObject {
public:
    OAIAlsfc_404_response();
    OAIAlsfc_404_response(QString json);
    ~OAIAlsfc_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlsfc_404_response)

#endif // OAIAlsfc_404_response_H
