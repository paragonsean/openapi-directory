...
/*
 * OAIAlsfc_400_response.h
 *
 * 
 */

#ifndef OAIAlsfc_400_response_H
#define OAIAlsfc_400_response_H
...
class OAIAlsfc_400_response : public OAIObject {
public:
    OAIAlsfc_400_response();
    OAIAlsfc_400_response(QString json);
    ~OAIAlsfc_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlsfc_400_response)

#endif // OAIAlsfc_400_response_H
