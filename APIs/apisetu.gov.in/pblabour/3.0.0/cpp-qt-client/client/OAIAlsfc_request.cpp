...
OAIAlsfc_request::OAIAlsfc_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAlsfc_request::OAIAlsfc_request() {
    this->initializeModel();
}

OAIAlsfc_request::~OAIAlsfc_request() {}

void OAIAlsfc_request::initializeModel() {
...
void OAIAlsfc_request::fromJson(QString jsonString) {
...
void OAIAlsfc_request::fromJsonObject(QJsonObject json) {
...
QString OAIAlsfc_request::asJson() const {
...
QJsonObject OAIAlsfc_request::asJsonObject() const {
    QJsonObject obj;
...
OAIAlsfc_request_certificateParameters OAIAlsfc_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIAlsfc_request::setCertificateParameters(const OAIAlsfc_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIAlsfc_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIAlsfc_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIAlsfc_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIAlsfc_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIAlsfc_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIAlsfc_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIAlsfc_request::getFormat() const {
    return m_format;
}
void OAIAlsfc_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIAlsfc_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIAlsfc_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIAlsfc_request::getTxnId() const {
    return m_txn_id;
}
void OAIAlsfc_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIAlsfc_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIAlsfc_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIAlsfc_request::isSet() const {
...
bool OAIAlsfc_request::isValid() const {
