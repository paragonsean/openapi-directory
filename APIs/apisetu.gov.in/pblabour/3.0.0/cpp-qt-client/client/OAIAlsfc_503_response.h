...
/*
 * OAIAlsfc_503_response.h
 *
 * 
 */

#ifndef OAIAlsfc_503_response_H
#define OAIAlsfc_503_response_H
...
class OAIAlsfc_503_response : public OAIObject {
public:
    OAIAlsfc_503_response();
    OAIAlsfc_503_response(QString json);
    ~OAIAlsfc_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAlsfc_503_response)

#endif // OAIAlsfc_503_response_H
