...
/**
 * The Alsfc400Response model module.
 * @module model/Alsfc400Response
 * @version 3.0.0
 */
class Alsfc400Response {
    /**
     * Constructs a new <code>Alsfc400Response</code>.
     * @alias module:model/Alsfc400Response
     */
    constructor() { 
        
        Alsfc400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Alsfc400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Alsfc400Response} obj Optional instance to populate.
     * @return {module:model/Alsfc400Response} The populated <code>Alsfc400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Alsfc400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Alsfc400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Alsfc400Response</code>.
     */
...
/**
 * @member {module:model/Alsfc400Response.ErrorEnum} error
 */
Alsfc400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Alsfc400Response.ErrorDescriptionEnum} errorDescription
 */
Alsfc400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Alsfc400Response['ErrorDescriptionEnum'] = {
...
export default Alsfc400Response;
