...
/*
 * OAICvcer_500_response.h
 *
 * 
 */

#ifndef OAICvcer_500_response_H
#define OAICvcer_500_response_H
...
class OAICvcer_500_response : public OAIObject {
public:
    OAICvcer_500_response();
    OAICvcer_500_response(QString json);
    ~OAICvcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_500_response)

#endif // OAICvcer_500_response_H
