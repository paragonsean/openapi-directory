...
/*
 * OAICvcer_504_response.h
 *
 * 
 */

#ifndef OAICvcer_504_response_H
#define OAICvcer_504_response_H
...
class OAICvcer_504_response : public OAIObject {
public:
    OAICvcer_504_response();
    OAICvcer_504_response(QString json);
    ~OAICvcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_504_response)

#endif // OAICvcer_504_response_H
