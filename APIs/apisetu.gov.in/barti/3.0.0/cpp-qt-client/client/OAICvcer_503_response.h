...
/*
 * OAICvcer_503_response.h
 *
 * 
 */

#ifndef OAICvcer_503_response_H
#define OAICvcer_503_response_H
...
class OAICvcer_503_response : public OAIObject {
public:
    OAICvcer_503_response();
    OAICvcer_503_response(QString json);
    ~OAICvcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_503_response)

#endif // OAICvcer_503_response_H
