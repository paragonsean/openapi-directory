...
#ifndef OAICvcer_request_H
#define OAICvcer_request_H
...
namespace OpenAPI {
class OAICvcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAICvcer_request : public OAIObject {
public:
    OAICvcer_request();
    OAICvcer_request(QString json);
    ~OAICvcer_request() override;
    ...
    OAICvcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAICvcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAICvcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_request)

#endif // OAICvcer_request_H
