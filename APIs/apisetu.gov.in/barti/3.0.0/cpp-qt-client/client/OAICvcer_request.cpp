...
OAICvcer_request::OAICvcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICvcer_request::OAICvcer_request() {
    this->initializeModel();
}

OAICvcer_request::~OAICvcer_request() {}

void OAICvcer_request::initializeModel() {
...
void OAICvcer_request::fromJson(QString jsonString) {
...
void OAICvcer_request::fromJsonObject(QJsonObject json) {
...
QString OAICvcer_request::asJson() const {
...
QJsonObject OAICvcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAICvcer_request_certificateParameters OAICvcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAICvcer_request::setCertificateParameters(const OAICvcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAICvcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAICvcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAICvcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAICvcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAICvcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAICvcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAICvcer_request::getFormat() const {
    return m_format;
}
void OAICvcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICvcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAICvcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAICvcer_request::getTxnId() const {
    return m_txn_id;
}
void OAICvcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAICvcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAICvcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAICvcer_request::isSet() const {
...
bool OAICvcer_request::isValid() const {
