...
/*
 * OAICvcer_502_response.h
 *
 * 
 */

#ifndef OAICvcer_502_response_H
#define OAICvcer_502_response_H
...
class OAICvcer_502_response : public OAIObject {
public:
    OAICvcer_502_response();
    OAICvcer_502_response(QString json);
    ~OAICvcer_502_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_502_response)

#endif // OAICvcer_502_response_H
