...
/*
 * OAICvcer_404_response.h
 *
 * 
 */

#ifndef OAICvcer_404_response_H
#define OAICvcer_404_response_H
...
class OAICvcer_404_response : public OAIObject {
public:
    OAICvcer_404_response();
    OAICvcer_404_response(QString json);
    ~OAICvcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_404_response)

#endif // OAICvcer_404_response_H
