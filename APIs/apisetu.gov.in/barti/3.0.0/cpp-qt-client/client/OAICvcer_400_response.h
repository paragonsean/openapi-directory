...
/*
 * OAICvcer_400_response.h
 *
 * 
 */

#ifndef OAICvcer_400_response_H
#define OAICvcer_400_response_H
...
class OAICvcer_400_response : public OAIObject {
public:
    OAICvcer_400_response();
    OAICvcer_400_response(QString json);
    ~OAICvcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICvcer_400_response)

#endif // OAICvcer_400_response_H
