...
public class Cvcer401Response {
  ...
  public Cvcer401Response() {
  }

  public Cvcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cvcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cvcer401Response cvcer401Response = (Cvcer401Response) o;
    return Objects.equals(this.error, cvcer401Response.error) &&
        Objects.equals(this.errorDescription, cvcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cvcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cvcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cvcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cvcer401Response is not found in the empty JSON string", Cvcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cvcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cvcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cvcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cvcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cvcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cvcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cvcer401Response>() {
           @Override
           public void write(JsonWriter out, Cvcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cvcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cvcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cvcer401Response
   * @throws IOException if the JSON string is invalid with respect to Cvcer401Response
   */
  public static Cvcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cvcer401Response.class);
  }

  /**
   * Convert an instance of Cvcer401Response to an JSON string
   *
   * @return JSON string
   */
