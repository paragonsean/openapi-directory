...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/barti/v3");
    ...
    CvcerRequest cvcerRequest = new CvcerRequest(); // CvcerRequest | Request format
    try {
      apiInstance.cvcer(cvcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#cvcer");
