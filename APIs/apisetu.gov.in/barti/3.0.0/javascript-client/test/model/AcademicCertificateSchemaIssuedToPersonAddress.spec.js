...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DrBabasahebAmbedkarResearchTrainingInstituteMaharashtra.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new DrBabasahebAmbedkarResearchTrainingInstituteMaharashtra.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(DrBabasahebAmbedkarResearchTrainingInstituteMaharashtra.AcademicCertificateSchemaIssuedToPersonAddress);
    });
