...
/**
 * The Cvcer400Response model module.
 * @module model/Cvcer400Response
 * @version 3.0.0
 */
class Cvcer400Response {
    /**
     * Constructs a new <code>Cvcer400Response</code>.
     * @alias module:model/Cvcer400Response
     */
    constructor() { 
        
        Cvcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Cvcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cvcer400Response} obj Optional instance to populate.
     * @return {module:model/Cvcer400Response} The populated <code>Cvcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cvcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Cvcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cvcer400Response</code>.
     */
...
/**
 * @member {module:model/Cvcer400Response.ErrorEnum} error
 */
Cvcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Cvcer400Response.ErrorDescriptionEnum} errorDescription
 */
Cvcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Cvcer400Response['ErrorDescriptionEnum'] = {
...
export default Cvcer400Response;
