# TransportDepartmentPuducherry.APIsApi
...
```javascript
import TransportDepartmentPuducherry from 'transport_department_puducherry';
let defaultClient = TransportDepartmentPuducherry.ApiClient.instance;
...
let apiInstance = new TransportDepartmentPuducherry.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentPuducherry.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentPuducherry.RvcerRequest() // RvcerRequest | Request format
};
