...
/*
 * OAINbcer_400_response.h
 *
 * 
 */

#ifndef OAINbcer_400_response_H
#define OAINbcer_400_response_H
...
class OAINbcer_400_response : public OAIObject {
public:
    OAINbcer_400_response();
    OAINbcer_400_response(QString json);
    ~OAINbcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINbcer_400_response)

#endif // OAINbcer_400_response_H
