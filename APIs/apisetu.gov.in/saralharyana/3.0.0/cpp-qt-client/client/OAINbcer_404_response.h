...
/*
 * OAINbcer_404_response.h
 *
 * 
 */

#ifndef OAINbcer_404_response_H
#define OAINbcer_404_response_H
...
class OAINbcer_404_response : public OAIObject {
public:
    OAINbcer_404_response();
    OAINbcer_404_response(QString json);
    ~OAINbcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINbcer_404_response)

#endif // OAINbcer_404_response_H
