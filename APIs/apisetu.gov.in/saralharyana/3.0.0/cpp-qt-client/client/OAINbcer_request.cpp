...
OAINbcer_request::OAINbcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINbcer_request::OAINbcer_request() {
    this->initializeModel();
}

OAINbcer_request::~OAINbcer_request() {}

void OAINbcer_request::initializeModel() {
...
void OAINbcer_request::fromJson(QString jsonString) {
...
void OAINbcer_request::fromJsonObject(QJsonObject json) {
...
QString OAINbcer_request::asJson() const {
...
QJsonObject OAINbcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAINbcer_request_certificateParameters OAINbcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAINbcer_request::setCertificateParameters(const OAINbcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAINbcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAINbcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAINbcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAINbcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAINbcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAINbcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAINbcer_request::getFormat() const {
    return m_format;
}
void OAINbcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAINbcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAINbcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAINbcer_request::getTxnId() const {
    return m_txn_id;
}
void OAINbcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAINbcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAINbcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAINbcer_request::isSet() const {
...
bool OAINbcer_request::isValid() const {
