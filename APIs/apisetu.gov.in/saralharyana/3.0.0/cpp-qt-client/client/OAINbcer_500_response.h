...
/*
 * OAINbcer_500_response.h
 *
 * 
 */

#ifndef OAINbcer_500_response_H
#define OAINbcer_500_response_H
...
class OAINbcer_500_response : public OAIObject {
public:
    OAINbcer_500_response();
    OAINbcer_500_response(QString json);
    ~OAINbcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINbcer_500_response)

#endif // OAINbcer_500_response_H
