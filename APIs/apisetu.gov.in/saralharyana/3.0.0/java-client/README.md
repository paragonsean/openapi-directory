...
- API version: 3.0.0
  - Build date: 2024-10-12T12:34:14.153527-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/saralharyana/v3");
    ...
    NbcerRequest nbcerRequest = new NbcerRequest(); // NbcerRequest | Request format
    try {
      apiInstance.nbcer(nbcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#nbcer");
...
------------ | ------------- | ------------- | -------------
*ApisApi* | [**nbcer**](docs/ApisApi.md#nbcer) | **POST** /nbcer/certificate | NAC/Birth/Death Certificate
...
## Documentation for Models
 ...
 - [Nbcer400Response](docs/Nbcer400Response.md)
 - [Nbcer401Response](docs/Nbcer401Response.md)
 - [Nbcer404Response](docs/Nbcer404Response.md)
 - [Nbcer500Response](docs/Nbcer500Response.md)
 - [Nbcer502Response](docs/Nbcer502Response.md)
 - [Nbcer503Response](docs/Nbcer503Response.md)
 - [Nbcer504Response](docs/Nbcer504Response.md)
 - [NbcerRequest](docs/NbcerRequest.md)
 - [NbcerRequestCertificateParameters](docs/NbcerRequestCertificateParameters.md)
