...
/**
 * The Hvcer400Response model module.
 * @module model/Hvcer400Response
 * @version 3.0.0
 */
class Hvcer400Response {
    /**
     * Constructs a new <code>Hvcer400Response</code>.
     * @alias module:model/Hvcer400Response
     */
    constructor() { 
        
        Hvcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Hvcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Hvcer400Response} obj Optional instance to populate.
     * @return {module:model/Hvcer400Response} The populated <code>Hvcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Hvcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Hvcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Hvcer400Response</code>.
     */
...
/**
 * @member {module:model/Hvcer400Response.ErrorEnum} error
 */
Hvcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Hvcer400Response.ErrorDescriptionEnum} errorDescription
 */
Hvcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Hvcer400Response['ErrorDescriptionEnum'] = {
...
export default Hvcer400Response;
