...
/*
 * OAIHvcer_500_response.h
 *
 * 
 */

#ifndef OAIHvcer_500_response_H
#define OAIHvcer_500_response_H
...
class OAIHvcer_500_response : public OAIObject {
public:
    OAIHvcer_500_response();
    OAIHvcer_500_response(QString json);
    ~OAIHvcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHvcer_500_response)

#endif // OAIHvcer_500_response_H
