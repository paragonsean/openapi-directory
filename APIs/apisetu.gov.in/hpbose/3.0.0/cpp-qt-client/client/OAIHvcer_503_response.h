...
/*
 * OAIHvcer_503_response.h
 *
 * 
 */

#ifndef OAIHvcer_503_response_H
#define OAIHvcer_503_response_H
...
class OAIHvcer_503_response : public OAIObject {
public:
    OAIHvcer_503_response();
    OAIHvcer_503_response(QString json);
    ~OAIHvcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHvcer_503_response)

#endif // OAIHvcer_503_response_H
