...
#ifndef OAIHvcer_request_H
#define OAIHvcer_request_H
...
namespace OpenAPI {
class OAIHvcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIHvcer_request : public OAIObject {
public:
    OAIHvcer_request();
    OAIHvcer_request(QString json);
    ~OAIHvcer_request() override;
    ...
    OAIHvcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIHvcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIHvcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHvcer_request)

#endif // OAIHvcer_request_H
