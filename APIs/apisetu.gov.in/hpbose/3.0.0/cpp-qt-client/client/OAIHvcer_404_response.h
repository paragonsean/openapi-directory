...
/*
 * OAIHvcer_404_response.h
 *
 * 
 */

#ifndef OAIHvcer_404_response_H
#define OAIHvcer_404_response_H
...
class OAIHvcer_404_response : public OAIObject {
public:
    OAIHvcer_404_response();
    OAIHvcer_404_response(QString json);
    ~OAIHvcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHvcer_404_response)

#endif // OAIHvcer_404_response_H
