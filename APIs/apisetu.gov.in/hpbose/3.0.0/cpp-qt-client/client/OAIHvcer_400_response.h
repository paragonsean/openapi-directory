...
/*
 * OAIHvcer_400_response.h
 *
 * 
 */

#ifndef OAIHvcer_400_response_H
#define OAIHvcer_400_response_H
...
class OAIHvcer_400_response : public OAIObject {
public:
    OAIHvcer_400_response();
    OAIHvcer_400_response(QString json);
    ~OAIHvcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHvcer_400_response)

#endif // OAIHvcer_400_response_H
