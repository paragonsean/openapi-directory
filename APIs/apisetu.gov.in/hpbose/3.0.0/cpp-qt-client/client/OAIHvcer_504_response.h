...
/*
 * OAIHvcer_504_response.h
 *
 * 
 */

#ifndef OAIHvcer_504_response_H
#define OAIHvcer_504_response_H
...
class OAIHvcer_504_response : public OAIObject {
public:
    OAIHvcer_504_response();
    OAIHvcer_504_response(QString json);
    ~OAIHvcer_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHvcer_504_response)

#endif // OAIHvcer_504_response_H
