...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/hpbose/v3");
    ...
    HvcerRequest hvcerRequest = new HvcerRequest(); // HvcerRequest | Request format
    try {
      apiInstance.hvcer(hvcerRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    HvcerRequest hvcerRequest = new HvcerRequest(); // HvcerRequest | Request format
    try {
      apiInstance.svcer(hvcerRequest);
    } catch (ApiException e) {
