...
public class Hvcer503Response {
  ...
  public Hvcer503Response() {
  }

  public Hvcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer503Response hvcer503Response = (Hvcer503Response) o;
    return Objects.equals(this.error, hvcer503Response.error) &&
        Objects.equals(this.errorDescription, hvcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer503Response is not found in the empty JSON string", Hvcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer503Response>() {
           @Override
           public void write(JsonWriter out, Hvcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer503Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer503Response
   */
  public static Hvcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer503Response.class);
  }

  /**
   * Convert an instance of Hvcer503Response to an JSON string
   *
   * @return JSON string
   */
