...
public class Hvcer404Response {
  ...
  public Hvcer404Response() {
  }

  public Hvcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer404Response hvcer404Response = (Hvcer404Response) o;
    return Objects.equals(this.error, hvcer404Response.error) &&
        Objects.equals(this.errorDescription, hvcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer404Response is not found in the empty JSON string", Hvcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer404Response>() {
           @Override
           public void write(JsonWriter out, Hvcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer404Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer404Response
   */
  public static Hvcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer404Response.class);
  }

  /**
   * Convert an instance of Hvcer404Response to an JSON string
   *
   * @return JSON string
   */
