...
public class Hvcer401Response {
  ...
  public Hvcer401Response() {
  }

  public Hvcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer401Response hvcer401Response = (Hvcer401Response) o;
    return Objects.equals(this.error, hvcer401Response.error) &&
        Objects.equals(this.errorDescription, hvcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer401Response is not found in the empty JSON string", Hvcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer401Response>() {
           @Override
           public void write(JsonWriter out, Hvcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer401Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer401Response
   */
  public static Hvcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer401Response.class);
  }

  /**
   * Convert an instance of Hvcer401Response to an JSON string
   *
   * @return JSON string
   */
