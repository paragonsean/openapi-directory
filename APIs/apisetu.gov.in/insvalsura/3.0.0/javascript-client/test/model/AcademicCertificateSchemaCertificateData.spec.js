...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IndianNavyInsValsura.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new IndianNavyInsValsura.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(IndianNavyInsValsura.AcademicCertificateSchemaCertificateData);
    });
