...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IndianNavyInsValsura.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new IndianNavyInsValsura.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(IndianNavyInsValsura.ConsentArtifactSchemaConsentUser);
    });
