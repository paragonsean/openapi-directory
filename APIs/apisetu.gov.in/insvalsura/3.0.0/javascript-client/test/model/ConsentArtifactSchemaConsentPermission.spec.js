...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IndianNavyInsValsura.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new IndianNavyInsValsura.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(IndianNavyInsValsura.ConsentArtifactSchemaConsentPermission);
    });
