...
/*
 * OAISkcer_400_response.h
 *
 * 
 */

#ifndef OAISkcer_400_response_H
#define OAISkcer_400_response_H
...
class OAISkcer_400_response : public OAIObject {
public:
    OAISkcer_400_response();
    OAISkcer_400_response(QString json);
    ~OAISkcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkcer_400_response)

#endif // OAISkcer_400_response_H
