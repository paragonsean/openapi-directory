...
- API version: 3.0.0
  - Build date: 2024-10-12T12:38:58.098791-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/insvalsura/v3");
    ...
    SkcerRequest skcerRequest = new SkcerRequest(); // SkcerRequest | Request format
    try {
      apiInstance.skcer(skcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#skcer");
...
*ApisApi* | [**skmst**](docs/ApisApi.md#skmst) | **POST** /skmst/certificate | Skill Marksheet/ Score Card
...
## Documentation for Models
 ...
 - [Skcer400Response](docs/Skcer400Response.md)
 - [Skcer401Response](docs/Skcer401Response.md)
 - [Skcer404Response](docs/Skcer404Response.md)
 - [Skcer500Response](docs/Skcer500Response.md)
 - [Skcer502Response](docs/Skcer502Response.md)
 - [Skcer503Response](docs/Skcer503Response.md)
 - [Skcer504Response](docs/Skcer504Response.md)
