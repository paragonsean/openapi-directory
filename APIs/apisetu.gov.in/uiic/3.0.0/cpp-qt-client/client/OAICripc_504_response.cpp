...
OAICripc_504_response::OAICripc_504_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICripc_504_response::OAICripc_504_response() {
    this->initializeModel();
}

OAICripc_504_response::~OAICripc_504_response() {}

void OAICripc_504_response::initializeModel() {
...
void OAICripc_504_response::fromJson(QString jsonString) {
...
void OAICripc_504_response::fromJsonObject(QJsonObject json) {
...
QString OAICripc_504_response::asJson() const {
...
QJsonObject OAICripc_504_response::asJsonObject() const {
    QJsonObject obj;
    if (m_error_isSet) {
...
QString OAICripc_504_response::getError() const {
    return m_error;
}
void OAICripc_504_response::setError(const QString &error) {
    m_error = error;
    m_error_isSet = true;
}

bool OAICripc_504_response::is_error_Set() const{
    return m_error_isSet;
}

bool OAICripc_504_response::is_error_Valid() const{
    return m_error_isValid;
}

QString OAICripc_504_response::getErrorDescription() const {
    return m_error_description;
}
void OAICripc_504_response::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAICripc_504_response::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAICripc_504_response::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAICripc_504_response::isSet() const {
...
bool OAICripc_504_response::isValid() const {
