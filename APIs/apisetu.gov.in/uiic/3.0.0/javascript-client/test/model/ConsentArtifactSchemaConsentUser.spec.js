...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchemaConsentUser);
    });
