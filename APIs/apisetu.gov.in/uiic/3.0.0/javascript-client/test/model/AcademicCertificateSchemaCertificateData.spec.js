...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UnitedIndiaInsuranceCompanyLimited.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new UnitedIndiaInsuranceCompanyLimited.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(UnitedIndiaInsuranceCompanyLimited.AcademicCertificateSchemaCertificateData);
    });
