...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchemaConsentPermission);
    });
