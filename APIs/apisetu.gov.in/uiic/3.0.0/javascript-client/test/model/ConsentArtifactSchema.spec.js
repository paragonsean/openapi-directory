...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchema();
      //expect(instance).to.be.a(UnitedIndiaInsuranceCompanyLimited.ConsentArtifactSchema);
    });
