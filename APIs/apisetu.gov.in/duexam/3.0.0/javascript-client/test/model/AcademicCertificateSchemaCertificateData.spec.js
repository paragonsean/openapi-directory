...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UniversityOfDelhi.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new UniversityOfDelhi.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(UniversityOfDelhi.AcademicCertificateSchemaCertificateData);
    });
