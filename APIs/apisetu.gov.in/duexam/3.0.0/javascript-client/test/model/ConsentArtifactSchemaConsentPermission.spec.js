...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UniversityOfDelhi.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new UniversityOfDelhi.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(UniversityOfDelhi.ConsentArtifactSchemaConsentPermission);
    });
