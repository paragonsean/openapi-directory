...
class DgcerRequestCertificateParameters {
     ...
     */
    constructor(CNAME, RROLL, YEAR) { 
        
        DgcerRequestCertificateParameters.initialize(this, CNAME, RROLL, YEAR);
    }
     ...
     */
    static initialize(obj, CNAME, RROLL, YEAR) { 
        obj['CNAME'] = CNAME;
        obj['RROLL'] = RROLL;
        obj['YEAR'] = YEAR;
    }
...
DgcerRequestCertificateParameters.RequiredProperties = ["CNAME", "RROLL", "YEAR"];
