...
/*
 * OAIDgcer_500_response.h
 *
 * 
 */

#ifndef OAIDgcer_500_response_H
#define OAIDgcer_500_response_H
...
class OAIDgcer_500_response : public OAIObject {
public:
    OAIDgcer_500_response();
    OAIDgcer_500_response(QString json);
    ~OAIDgcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDgcer_500_response)

#endif // OAIDgcer_500_response_H
