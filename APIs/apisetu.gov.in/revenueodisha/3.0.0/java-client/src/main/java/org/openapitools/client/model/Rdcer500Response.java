...
public class Rdcer500Response {
  ...
  public Rdcer500Response() {
  }

  public Rdcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Rdcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Rdcer500Response rdcer500Response = (Rdcer500Response) o;
    return Objects.equals(this.error, rdcer500Response.error) &&
        Objects.equals(this.errorDescription, rdcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Rdcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rdcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rdcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rdcer500Response is not found in the empty JSON string", Rdcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rdcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rdcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rdcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rdcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rdcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rdcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Rdcer500Response>() {
           @Override
           public void write(JsonWriter out, Rdcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rdcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rdcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rdcer500Response
   * @throws IOException if the JSON string is invalid with respect to Rdcer500Response
   */
  public static Rdcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rdcer500Response.class);
  }

  /**
   * Convert an instance of Rdcer500Response to an JSON string
   *
   * @return JSON string
   */
