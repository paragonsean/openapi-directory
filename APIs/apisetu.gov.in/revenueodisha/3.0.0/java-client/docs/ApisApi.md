...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/revenueodisha/v3");
    ...
    RdcerRequest rdcerRequest = new RdcerRequest(); // RdcerRequest | Request format
    try {
      apiInstance.rdcer(rdcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#rdcer");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    Ror1bRequest ror1bRequest = new Ror1bRequest(); // Ror1bRequest | Request format
    try {
      apiInstance.ror1b(ror1bRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#ror1b");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
