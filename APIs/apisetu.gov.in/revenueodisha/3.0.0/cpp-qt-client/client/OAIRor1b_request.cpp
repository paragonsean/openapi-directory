...
OAIRor1b_request::OAIRor1b_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRor1b_request::OAIRor1b_request() {
    this->initializeModel();
}

OAIRor1b_request::~OAIRor1b_request() {}

void OAIRor1b_request::initializeModel() {
...
void OAIRor1b_request::fromJson(QString jsonString) {
...
void OAIRor1b_request::fromJsonObject(QJsonObject json) {
...
QString OAIRor1b_request::asJson() const {
...
QJsonObject OAIRor1b_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRor1b_request_certificateParameters OAIRor1b_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRor1b_request::setCertificateParameters(const OAIRor1b_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRor1b_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRor1b_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRor1b_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRor1b_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRor1b_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRor1b_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRor1b_request::getFormat() const {
    return m_format;
}
void OAIRor1b_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRor1b_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRor1b_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRor1b_request::getTxnId() const {
    return m_txn_id;
}
void OAIRor1b_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRor1b_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRor1b_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRor1b_request::isSet() const {
...
bool OAIRor1b_request::isValid() const {
