...
#ifndef OAIRor1b_request_H
#define OAIRor1b_request_H
...
namespace OpenAPI {
class OAIRor1b_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIRor1b_request : public OAIObject {
public:
    OAIRor1b_request();
    OAIRor1b_request(QString json);
    ~OAIRor1b_request() override;
    ...
    OAIRor1b_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIRor1b_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIRor1b_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRor1b_request)

#endif // OAIRor1b_request_H
