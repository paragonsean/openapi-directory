...
/*
 * OAIRdcer_404_response.h
 *
 * 
 */

#ifndef OAIRdcer_404_response_H
#define OAIRdcer_404_response_H
...
class OAIRdcer_404_response : public OAIObject {
public:
    OAIRdcer_404_response();
    OAIRdcer_404_response(QString json);
    ~OAIRdcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRdcer_404_response)

#endif // OAIRdcer_404_response_H
