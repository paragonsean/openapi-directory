...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RevenueDepartmentOdisha.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new RevenueDepartmentOdisha.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(RevenueDepartmentOdisha.ConsentArtifactSchemaConsentUser);
    });
