...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RevenueDepartmentOdisha.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new RevenueDepartmentOdisha.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(RevenueDepartmentOdisha.ConsentArtifactSchemaConsentPermission);
    });
