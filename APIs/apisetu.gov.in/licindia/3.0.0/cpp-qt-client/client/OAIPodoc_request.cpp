...
OAIPodoc_request::OAIPodoc_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPodoc_request::OAIPodoc_request() {
    this->initializeModel();
}

OAIPodoc_request::~OAIPodoc_request() {}

void OAIPodoc_request::initializeModel() {
...
void OAIPodoc_request::fromJson(QString jsonString) {
...
void OAIPodoc_request::fromJsonObject(QJsonObject json) {
...
QString OAIPodoc_request::asJson() const {
...
QJsonObject OAIPodoc_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPodoc_request_certificateParameters OAIPodoc_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIPodoc_request::setCertificateParameters(const OAIPodoc_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIPodoc_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIPodoc_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIPodoc_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIPodoc_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIPodoc_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIPodoc_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIPodoc_request::getFormat() const {
    return m_format;
}
void OAIPodoc_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPodoc_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPodoc_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPodoc_request::getTxnId() const {
    return m_txn_id;
}
void OAIPodoc_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIPodoc_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIPodoc_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIPodoc_request::isSet() const {
...
bool OAIPodoc_request::isValid() const {
