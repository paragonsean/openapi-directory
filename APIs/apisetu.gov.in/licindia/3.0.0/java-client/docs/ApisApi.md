...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/licindia/v3");
    ...
    PodocRequest podocRequest = new PodocRequest(); // PodocRequest | Request format
    try {
      apiInstance.podoc(podocRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#podoc");
