...
class DgcerRequestCertificateParameters {
     ...
     */
    constructor(CNAME, REGNO, YEAR) { 
        
        DgcerRequestCertificateParameters.initialize(this, CNAME, REGNO, YEAR);
    }
     ...
     */
    static initialize(obj, CNAME, REGNO, YEAR) { 
        obj['CNAME'] = CNAME;
        obj['REGNO'] = REGNO;
        obj['YEAR'] = YEAR;
    }
...
DgcerRequestCertificateParameters.RequiredProperties = ["CNAME", "REGNO", "YEAR"];
