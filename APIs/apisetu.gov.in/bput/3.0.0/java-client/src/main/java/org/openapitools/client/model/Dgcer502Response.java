...
public class Dgcer502Response {
  ...
  public Dgcer502Response() {
  }

  public Dgcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgcer502Response dgcer502Response = (Dgcer502Response) o;
    return Objects.equals(this.error, dgcer502Response.error) &&
        Objects.equals(this.errorDescription, dgcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgcer502Response is not found in the empty JSON string", Dgcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgcer502Response>() {
           @Override
           public void write(JsonWriter out, Dgcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgcer502Response
   * @throws IOException if the JSON string is invalid with respect to Dgcer502Response
   */
  public static Dgcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgcer502Response.class);
  }

  /**
   * Convert an instance of Dgcer502Response to an JSON string
   *
   * @return JSON string
   */
