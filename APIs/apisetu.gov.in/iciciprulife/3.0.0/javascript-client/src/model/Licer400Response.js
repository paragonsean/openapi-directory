...
/**
 * The Licer400Response model module.
 * @module model/Licer400Response
 * @version 3.0.0
 */
class Licer400Response {
    /**
     * Constructs a new <code>Licer400Response</code>.
     * @alias module:model/Licer400Response
     */
    constructor() { 
        
        Licer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Licer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Licer400Response} obj Optional instance to populate.
     * @return {module:model/Licer400Response} The populated <code>Licer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Licer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Licer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Licer400Response</code>.
     */
...
/**
 * @member {module:model/Licer400Response.ErrorEnum} error
 */
Licer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Licer400Response.ErrorDescriptionEnum} errorDescription
 */
Licer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Licer400Response['ErrorDescriptionEnum'] = {
...
export default Licer400Response;
