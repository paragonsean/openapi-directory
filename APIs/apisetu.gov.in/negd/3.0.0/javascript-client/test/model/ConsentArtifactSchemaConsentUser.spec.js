...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalEGovernanceDivision.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new NationalEGovernanceDivision.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(NationalEGovernanceDivision.ConsentArtifactSchemaConsentUser);
    });
