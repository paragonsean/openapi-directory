...
/*
 * OAIGovid_504_response.h
 *
 * 
 */

#ifndef OAIGovid_504_response_H
#define OAIGovid_504_response_H
...
class OAIGovid_504_response : public OAIObject {
public:
    OAIGovid_504_response();
    OAIGovid_504_response(QString json);
    ~OAIGovid_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGovid_504_response)

#endif // OAIGovid_504_response_H
