...
/*
 * OAIGovid_400_response.h
 *
 * 
 */

#ifndef OAIGovid_400_response_H
#define OAIGovid_400_response_H
...
class OAIGovid_400_response : public OAIObject {
public:
    OAIGovid_400_response();
    OAIGovid_400_response(QString json);
    ~OAIGovid_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGovid_400_response)

#endif // OAIGovid_400_response_H
