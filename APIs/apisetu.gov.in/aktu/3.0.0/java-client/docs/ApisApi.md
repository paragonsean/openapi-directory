...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    DgmstRequest dgmstRequest = new DgmstRequest(); // DgmstRequest | Request format
    try {
      apiInstance.dgmst(dgmstRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#dgmst");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
