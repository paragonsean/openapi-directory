...
/*
 * OAIApmcl_503_response.h
 *
 * 
 */

#ifndef OAIApmcl_503_response_H
#define OAIApmcl_503_response_H
...
class OAIApmcl_503_response : public OAIObject {
public:
    OAIApmcl_503_response();
    OAIApmcl_503_response(QString json);
    ~OAIApmcl_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApmcl_503_response)

#endif // OAIApmcl_503_response_H
