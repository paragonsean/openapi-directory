...
OAIApmcl_request::OAIApmcl_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIApmcl_request::OAIApmcl_request() {
    this->initializeModel();
}

OAIApmcl_request::~OAIApmcl_request() {}

void OAIApmcl_request::initializeModel() {
...
void OAIApmcl_request::fromJson(QString jsonString) {
...
void OAIApmcl_request::fromJsonObject(QJsonObject json) {
...
QString OAIApmcl_request::asJson() const {
...
QJsonObject OAIApmcl_request::asJsonObject() const {
    QJsonObject obj;
...
OAIApmcl_request_certificateParameters OAIApmcl_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIApmcl_request::setCertificateParameters(const OAIApmcl_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIApmcl_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIApmcl_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIApmcl_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIApmcl_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIApmcl_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIApmcl_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIApmcl_request::getFormat() const {
    return m_format;
}
void OAIApmcl_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIApmcl_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIApmcl_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIApmcl_request::getTxnId() const {
    return m_txn_id;
}
void OAIApmcl_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIApmcl_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIApmcl_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIApmcl_request::isSet() const {
...
bool OAIApmcl_request::isValid() const {
