...
/*
 * OAIApmcl_400_response.h
 *
 * 
 */

#ifndef OAIApmcl_400_response_H
#define OAIApmcl_400_response_H
...
class OAIApmcl_400_response : public OAIObject {
public:
    OAIApmcl_400_response();
    OAIApmcl_400_response(QString json);
    ~OAIApmcl_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApmcl_400_response)

#endif // OAIApmcl_400_response_H
