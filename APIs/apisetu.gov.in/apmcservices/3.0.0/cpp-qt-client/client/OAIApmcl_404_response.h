...
/*
 * OAIApmcl_404_response.h
 *
 * 
 */

#ifndef OAIApmcl_404_response_H
#define OAIApmcl_404_response_H
...
class OAIApmcl_404_response : public OAIObject {
public:
    OAIApmcl_404_response();
    OAIApmcl_404_response(QString json);
    ~OAIApmcl_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApmcl_404_response)

#endif // OAIApmcl_404_response_H
