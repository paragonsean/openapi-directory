...
/**
 * The Apmcl400Response model module.
 * @module model/Apmcl400Response
 * @version 3.0.0
 */
class Apmcl400Response {
    /**
     * Constructs a new <code>Apmcl400Response</code>.
     * @alias module:model/Apmcl400Response
     */
    constructor() { 
        
        Apmcl400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Apmcl400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Apmcl400Response} obj Optional instance to populate.
     * @return {module:model/Apmcl400Response} The populated <code>Apmcl400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Apmcl400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Apmcl400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Apmcl400Response</code>.
     */
...
/**
 * @member {module:model/Apmcl400Response.ErrorEnum} error
 */
Apmcl400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Apmcl400Response.ErrorDescriptionEnum} errorDescription
 */
Apmcl400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Apmcl400Response['ErrorDescriptionEnum'] = {
...
export default Apmcl400Response;
