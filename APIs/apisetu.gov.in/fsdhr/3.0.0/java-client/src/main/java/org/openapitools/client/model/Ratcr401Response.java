...
public class Ratcr401Response {
  ...
  public Ratcr401Response() {
  }

  public Ratcr401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ratcr401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ratcr401Response ratcr401Response = (Ratcr401Response) o;
    return Objects.equals(this.error, ratcr401Response.error) &&
        Objects.equals(this.errorDescription, ratcr401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ratcr401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ratcr401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ratcr401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ratcr401Response is not found in the empty JSON string", Ratcr401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ratcr401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ratcr401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ratcr401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ratcr401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ratcr401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ratcr401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ratcr401Response>() {
           @Override
           public void write(JsonWriter out, Ratcr401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ratcr401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ratcr401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ratcr401Response
   * @throws IOException if the JSON string is invalid with respect to Ratcr401Response
   */
  public static Ratcr401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ratcr401Response.class);
  }

  /**
   * Convert an instance of Ratcr401Response to an JSON string
   *
   * @return JSON string
   */
