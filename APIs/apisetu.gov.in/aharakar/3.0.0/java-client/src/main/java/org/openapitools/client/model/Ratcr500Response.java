...
public class Ratcr500Response {
  ...
  public Ratcr500Response() {
  }

  public Ratcr500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ratcr500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ratcr500Response ratcr500Response = (Ratcr500Response) o;
    return Objects.equals(this.error, ratcr500Response.error) &&
        Objects.equals(this.errorDescription, ratcr500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ratcr500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ratcr500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ratcr500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ratcr500Response is not found in the empty JSON string", Ratcr500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ratcr500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ratcr500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ratcr500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ratcr500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ratcr500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ratcr500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ratcr500Response>() {
           @Override
           public void write(JsonWriter out, Ratcr500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ratcr500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ratcr500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ratcr500Response
   * @throws IOException if the JSON string is invalid with respect to Ratcr500Response
   */
  public static Ratcr500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ratcr500Response.class);
  }

  /**
   * Convert an instance of Ratcr500Response to an JSON string
   *
   * @return JSON string
   */
