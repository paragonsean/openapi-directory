...
OAIRatcr_request::OAIRatcr_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRatcr_request::OAIRatcr_request() {
    this->initializeModel();
}

OAIRatcr_request::~OAIRatcr_request() {}

void OAIRatcr_request::initializeModel() {
...
void OAIRatcr_request::fromJson(QString jsonString) {
...
void OAIRatcr_request::fromJsonObject(QJsonObject json) {
...
QString OAIRatcr_request::asJson() const {
...
QJsonObject OAIRatcr_request::asJsonObject() const {
    QJsonObject obj;
...
OAIRatcr_request_certificateParameters OAIRatcr_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIRatcr_request::setCertificateParameters(const OAIRatcr_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIRatcr_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIRatcr_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIRatcr_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIRatcr_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIRatcr_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIRatcr_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIRatcr_request::getFormat() const {
    return m_format;
}
void OAIRatcr_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIRatcr_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIRatcr_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIRatcr_request::getTxnId() const {
    return m_txn_id;
}
void OAIRatcr_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIRatcr_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIRatcr_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIRatcr_request::isSet() const {
...
bool OAIRatcr_request::isValid() const {
