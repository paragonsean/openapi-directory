...
/*
 * OAIRatcr_404_response.h
 *
 * 
 */

#ifndef OAIRatcr_404_response_H
#define OAIRatcr_404_response_H
...
class OAIRatcr_404_response : public OAIObject {
public:
    OAIRatcr_404_response();
    OAIRatcr_404_response(QString json);
    ~OAIRatcr_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRatcr_404_response)

#endif // OAIRatcr_404_response_H
