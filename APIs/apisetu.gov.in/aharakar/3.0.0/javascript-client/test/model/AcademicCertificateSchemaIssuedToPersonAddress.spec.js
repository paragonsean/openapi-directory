...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FoodCivilSuppliesAndConsumerAffairsDepartmentKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new FoodCivilSuppliesAndConsumerAffairsDepartmentKarnataka.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(FoodCivilSuppliesAndConsumerAffairsDepartmentKarnataka.AcademicCertificateSchemaIssuedToPersonAddress);
    });
