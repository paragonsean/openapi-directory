...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BiharStateBoardOfSchoolExaminationBihar.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new BiharStateBoardOfSchoolExaminationBihar.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(BiharStateBoardOfSchoolExaminationBihar.ConsentArtifactSchemaConsentUser);
    });
