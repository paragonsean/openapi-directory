...
OAISscer_request::OAISscer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISscer_request::OAISscer_request() {
    this->initializeModel();
}

OAISscer_request::~OAISscer_request() {}

void OAISscer_request::initializeModel() {
...
void OAISscer_request::fromJson(QString jsonString) {
...
void OAISscer_request::fromJsonObject(QJsonObject json) {
...
QString OAISscer_request::asJson() const {
...
QJsonObject OAISscer_request::asJsonObject() const {
    QJsonObject obj;
...
OAISscer_request_certificateParameters OAISscer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAISscer_request::setCertificateParameters(const OAISscer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAISscer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAISscer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAISscer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAISscer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAISscer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAISscer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAISscer_request::getFormat() const {
    return m_format;
}
void OAISscer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAISscer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAISscer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAISscer_request::getTxnId() const {
    return m_txn_id;
}
void OAISscer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAISscer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAISscer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAISscer_request::isSet() const {
...
bool OAISscer_request::isValid() const {
