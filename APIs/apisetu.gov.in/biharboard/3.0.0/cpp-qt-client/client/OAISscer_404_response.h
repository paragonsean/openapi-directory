...
/*
 * OAISscer_404_response.h
 *
 * 
 */

#ifndef OAISscer_404_response_H
#define OAISscer_404_response_H
...
class OAISscer_404_response : public OAIObject {
public:
    OAISscer_404_response();
    OAISscer_404_response(QString json);
    ~OAISscer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISscer_404_response)

#endif // OAISscer_404_response_H
