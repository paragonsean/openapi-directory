...
/*
 * OAISscer_400_response.h
 *
 * 
 */

#ifndef OAISscer_400_response_H
#define OAISscer_400_response_H
...
class OAISscer_400_response : public OAIObject {
public:
    OAISscer_400_response();
    OAISscer_400_response(QString json);
    ~OAISscer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISscer_400_response)

#endif // OAISscer_400_response_H
