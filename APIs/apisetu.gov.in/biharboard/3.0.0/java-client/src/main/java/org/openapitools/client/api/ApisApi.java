...
public class ApisApi {
     ...
     */
    public okhttp3.Call svcerCall(SscerRequest sscerRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call svcerValidateBeforeCall(SscerRequest sscerRequest, final ApiCallback _callback) throws ApiException {
        return svcerCall(sscerRequest, _callback);
     ...
     */
    public void svcer(SscerRequest sscerRequest) throws ApiException {
        svcerWithHttpInfo(sscerRequest);
    }
     ...
     */
    public ApiResponse<Void> svcerWithHttpInfo(SscerRequest sscerRequest) throws ApiException {
        okhttp3.Call localVarCall = svcerValidateBeforeCall(sscerRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call svcerAsync(SscerRequest sscerRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = svcerValidateBeforeCall(sscerRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
