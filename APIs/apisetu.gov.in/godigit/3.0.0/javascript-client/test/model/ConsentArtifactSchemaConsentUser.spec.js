...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoDigitGeneralInsuranceLtd.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new GoDigitGeneralInsuranceLtd.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(GoDigitGeneralInsuranceLtd.ConsentArtifactSchemaConsentUser);
    });
