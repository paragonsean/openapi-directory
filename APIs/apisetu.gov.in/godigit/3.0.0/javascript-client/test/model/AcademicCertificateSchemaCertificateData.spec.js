...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoDigitGeneralInsuranceLtd.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new GoDigitGeneralInsuranceLtd.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(GoDigitGeneralInsuranceLtd.AcademicCertificateSchemaCertificateData);
    });
