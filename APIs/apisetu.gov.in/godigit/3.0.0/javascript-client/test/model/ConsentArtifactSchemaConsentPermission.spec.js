...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoDigitGeneralInsuranceLtd.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new GoDigitGeneralInsuranceLtd.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(GoDigitGeneralInsuranceLtd.ConsentArtifactSchemaConsentPermission);
    });
