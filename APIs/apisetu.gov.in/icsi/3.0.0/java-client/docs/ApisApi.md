...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    MbcerRequest mbcerRequest = new MbcerRequest(); // MbcerRequest | Request format
    try {
      apiInstance.mbcer(mbcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#mbcer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
