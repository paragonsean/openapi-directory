...
- API version: 3.0.0
  - Build date: 2024-10-12T12:39:25.706975-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/icsi/v3");
...
*ApisApi* | [**mbcer**](docs/ApisApi.md#mbcer) | **POST** /mbcer/certificate | Membership Certificate
...
## Documentation for Models
 ...
 - [MbcerRequest](docs/MbcerRequest.md)
 - [MbcerRequestCertificateParameters](docs/MbcerRequestCertificateParameters.md)
