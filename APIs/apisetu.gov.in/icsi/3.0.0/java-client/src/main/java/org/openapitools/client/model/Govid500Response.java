...
public class Govid500Response {
  ...
  public Govid500Response() {
  }

  public Govid500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Govid500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Govid500Response govid500Response = (Govid500Response) o;
    return Objects.equals(this.error, govid500Response.error) &&
        Objects.equals(this.errorDescription, govid500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Govid500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Govid500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Govid500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Govid500Response is not found in the empty JSON string", Govid500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Govid500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Govid500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Govid500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Govid500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Govid500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Govid500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Govid500Response>() {
           @Override
           public void write(JsonWriter out, Govid500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Govid500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Govid500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Govid500Response
   * @throws IOException if the JSON string is invalid with respect to Govid500Response
   */
  public static Govid500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Govid500Response.class);
  }

  /**
   * Convert an instance of Govid500Response to an JSON string
   *
   * @return JSON string
   */
