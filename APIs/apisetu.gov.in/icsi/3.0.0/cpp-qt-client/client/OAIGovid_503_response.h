...
/*
 * OAIGovid_503_response.h
 *
 * 
 */

#ifndef OAIGovid_503_response_H
#define OAIGovid_503_response_H
...
class OAIGovid_503_response : public OAIObject {
public:
    OAIGovid_503_response();
    OAIGovid_503_response(QString json);
    ~OAIGovid_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGovid_503_response)

#endif // OAIGovid_503_response_H
