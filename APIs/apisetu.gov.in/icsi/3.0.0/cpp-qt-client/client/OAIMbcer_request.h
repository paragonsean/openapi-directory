...
#ifndef OAIMbcer_request_H
#define OAIMbcer_request_H
...
namespace OpenAPI {
class OAIMbcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIMbcer_request : public OAIObject {
public:
    OAIMbcer_request();
    OAIMbcer_request(QString json);
    ~OAIMbcer_request() override;
    ...
    OAIMbcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIMbcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIMbcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMbcer_request)

#endif // OAIMbcer_request_H
