...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstituteOfCompanySecretariesOfIndia.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new InstituteOfCompanySecretariesOfIndia.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(InstituteOfCompanySecretariesOfIndia.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
