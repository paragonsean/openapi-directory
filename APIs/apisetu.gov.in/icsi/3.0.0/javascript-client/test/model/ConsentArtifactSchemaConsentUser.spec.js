...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InstituteOfCompanySecretariesOfIndia.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new InstituteOfCompanySecretariesOfIndia.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(InstituteOfCompanySecretariesOfIndia.ConsentArtifactSchemaConsentUser);
    });
