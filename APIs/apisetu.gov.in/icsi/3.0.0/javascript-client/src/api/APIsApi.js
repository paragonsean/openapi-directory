...
export default class APIsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the mbcer operation.
     * @callback module:api/APIsApi~mbcerCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/MbcerRequest} [mbcerRequest] Request format
     * @param {module:api/APIsApi~mbcerCallback} callback The callback function, accepting three arguments: error, data, response
     */
    mbcer(opts, callback) {
      opts = opts || {};
      let postBody = opts['mbcerRequest'];
