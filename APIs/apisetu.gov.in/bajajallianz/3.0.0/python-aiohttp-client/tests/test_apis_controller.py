...
async def test_cripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/cripc/certificate',
        headers=headers,
        json=body,
        )
...
async def test_cvipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/cvipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_cyipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/cyipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hlipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/hlipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hmipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/hmipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/tripc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_twipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/bajajallianz/v3/twipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
