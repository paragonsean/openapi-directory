...
export default class APIsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the cyipc operation.
     * @callback module:api/APIsApi~cyipcCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CripcRequest} [cripcRequest] Request format
     * @param {module:api/APIsApi~cyipcCallback} callback The callback function, accepting three arguments: error, data, response
     */
    cyipc(opts, callback) {
      opts = opts || {};
      let postBody = opts['cripcRequest'];
