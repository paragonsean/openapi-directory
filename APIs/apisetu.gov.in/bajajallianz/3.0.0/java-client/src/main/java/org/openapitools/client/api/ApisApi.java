...
public class ApisApi {
     ...
     */
    public okhttp3.Call cyipcCall(CripcRequest cripcRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/cyipc/certificate";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call cyipcValidateBeforeCall(CripcRequest cripcRequest, final ApiCallback _callback) throws ApiException {
        return cyipcCall(cripcRequest, _callback);
     ...
     */
    public void cyipc(CripcRequest cripcRequest) throws ApiException {
        cyipcWithHttpInfo(cripcRequest);
    }
     ...
     */
    public ApiResponse<Void> cyipcWithHttpInfo(CripcRequest cripcRequest) throws ApiException {
        okhttp3.Call localVarCall = cyipcValidateBeforeCall(cripcRequest, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Insurance Policy - Cyber (asynchronously)
     * API to verify Insurance Policy - Cyber.
     * @param cripcRequest Request format (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call cyipcAsync(CripcRequest cripcRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = cyipcValidateBeforeCall(cripcRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
