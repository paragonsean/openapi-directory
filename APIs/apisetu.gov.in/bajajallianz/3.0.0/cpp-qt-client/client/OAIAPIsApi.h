...
public:
    ...
    * @param[in]  oai_cripc_request OAICripc_request [optional]
    */
    virtual void cyipc(const ::OpenAPI::OptionalParam<OAICripc_request> &oai_cripc_request = ::OpenAPI::OptionalParam<OAICripc_request>());
...
private:
    ...
    void cyipcCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void cyipcSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use cyipcSignalError() instead")
    void cyipcSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void cyipcSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use cyipcSignalErrorFull() instead")
    void cyipcSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void cyipcSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
