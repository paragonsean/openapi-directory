...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BoardOfVocationalHigherSecondaryExaminationsKerala.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new BoardOfVocationalHigherSecondaryExaminationsKerala.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(BoardOfVocationalHigherSecondaryExaminationsKerala.AcademicCertificateSchemaIssuedToPersonAddress);
    });
