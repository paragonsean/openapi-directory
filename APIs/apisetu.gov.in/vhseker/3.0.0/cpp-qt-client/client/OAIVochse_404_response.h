...
/*
 * OAIVochse_404_response.h
 *
 * 
 */

#ifndef OAIVochse_404_response_H
#define OAIVochse_404_response_H
...
class OAIVochse_404_response : public OAIObject {
public:
    OAIVochse_404_response();
    OAIVochse_404_response(QString json);
    ~OAIVochse_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVochse_404_response)

#endif // OAIVochse_404_response_H
