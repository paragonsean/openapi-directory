...
/*
 * OAIVochse_502_response.h
 *
 * 
 */

#ifndef OAIVochse_502_response_H
#define OAIVochse_502_response_H
...
class OAIVochse_502_response : public OAIObject {
public:
    OAIVochse_502_response();
    OAIVochse_502_response(QString json);
    ~OAIVochse_502_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVochse_502_response)

#endif // OAIVochse_502_response_H
