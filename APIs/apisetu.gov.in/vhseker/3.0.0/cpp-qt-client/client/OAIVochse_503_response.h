...
/*
 * OAIVochse_503_response.h
 *
 * 
 */

#ifndef OAIVochse_503_response_H
#define OAIVochse_503_response_H
...
class OAIVochse_503_response : public OAIObject {
public:
    OAIVochse_503_response();
    OAIVochse_503_response(QString json);
    ~OAIVochse_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVochse_503_response)

#endif // OAIVochse_503_response_H
