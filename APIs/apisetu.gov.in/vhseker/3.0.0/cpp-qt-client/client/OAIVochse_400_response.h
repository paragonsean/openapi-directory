...
/*
 * OAIVochse_400_response.h
 *
 * 
 */

#ifndef OAIVochse_400_response_H
#define OAIVochse_400_response_H
...
class OAIVochse_400_response : public OAIObject {
public:
    OAIVochse_400_response();
    OAIVochse_400_response(QString json);
    ~OAIVochse_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVochse_400_response)

#endif // OAIVochse_400_response_H
