...
#ifndef OAIVochse_request_H
#define OAIVochse_request_H
...
namespace OpenAPI {
class OAIVochse_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIVochse_request : public OAIObject {
public:
    OAIVochse_request();
    OAIVochse_request(QString json);
    ~OAIVochse_request() override;
    ...
    OAIVochse_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIVochse_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIVochse_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVochse_request)

#endif // OAIVochse_request_H
