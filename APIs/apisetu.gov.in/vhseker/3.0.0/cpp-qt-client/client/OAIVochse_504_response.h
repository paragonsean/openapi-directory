...
/*
 * OAIVochse_504_response.h
 *
 * 
 */

#ifndef OAIVochse_504_response_H
#define OAIVochse_504_response_H
...
class OAIVochse_504_response : public OAIObject {
public:
    OAIVochse_504_response();
    OAIVochse_504_response(QString json);
    ~OAIVochse_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVochse_504_response)

#endif // OAIVochse_504_response_H
