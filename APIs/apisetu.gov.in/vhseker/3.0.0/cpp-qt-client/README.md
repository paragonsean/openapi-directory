...
OAIVochse_request Example::create(){
    OAIVochse_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::vochseSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::vochseSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIVochse_request oai_vochse_request = create(); // OAIVochse_request | Request format
      apiInstance.vochse(oai_vochse_request);
