...
public class Vochse504Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse504Response() {
  }

  public Vochse504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse504Response vochse504Response = (Vochse504Response) o;
    return Objects.equals(this.error, vochse504Response.error) &&
        Objects.equals(this.errorDescription, vochse504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse504Response is not found in the empty JSON string", Vochse504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse504Response>() {
           @Override
           public void write(JsonWriter out, Vochse504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse504Response
   * @throws IOException if the JSON string is invalid with respect to Vochse504Response
   */
  public static Vochse504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse504Response.class);
  }

  /**
   * Convert an instance of Vochse504Response to an JSON string
   *
   * @return JSON string
   */
