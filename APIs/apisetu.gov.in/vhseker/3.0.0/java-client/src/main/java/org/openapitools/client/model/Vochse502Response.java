...
public class Vochse502Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse502Response() {
  }

  public Vochse502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse502Response vochse502Response = (Vochse502Response) o;
    return Objects.equals(this.error, vochse502Response.error) &&
        Objects.equals(this.errorDescription, vochse502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse502Response is not found in the empty JSON string", Vochse502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse502Response>() {
           @Override
           public void write(JsonWriter out, Vochse502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse502Response
   * @throws IOException if the JSON string is invalid with respect to Vochse502Response
   */
  public static Vochse502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse502Response.class);
  }

  /**
   * Convert an instance of Vochse502Response to an JSON string
   *
   * @return JSON string
   */
