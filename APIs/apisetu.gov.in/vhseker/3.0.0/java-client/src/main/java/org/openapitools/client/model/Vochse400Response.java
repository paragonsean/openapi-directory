...
public class Vochse400Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse400Response() {
  }

  public Vochse400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse400Response vochse400Response = (Vochse400Response) o;
    return Objects.equals(this.error, vochse400Response.error) &&
        Objects.equals(this.errorDescription, vochse400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse400Response is not found in the empty JSON string", Vochse400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse400Response>() {
           @Override
           public void write(JsonWriter out, Vochse400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse400Response
   * @throws IOException if the JSON string is invalid with respect to Vochse400Response
   */
  public static Vochse400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse400Response.class);
  }

  /**
   * Convert an instance of Vochse400Response to an JSON string
   *
   * @return JSON string
   */
