...
public class Vochse404Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse404Response() {
  }

  public Vochse404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse404Response vochse404Response = (Vochse404Response) o;
    return Objects.equals(this.error, vochse404Response.error) &&
        Objects.equals(this.errorDescription, vochse404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse404Response is not found in the empty JSON string", Vochse404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse404Response>() {
           @Override
           public void write(JsonWriter out, Vochse404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse404Response
   * @throws IOException if the JSON string is invalid with respect to Vochse404Response
   */
  public static Vochse404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse404Response.class);
  }

  /**
   * Convert an instance of Vochse404Response to an JSON string
   *
   * @return JSON string
   */
