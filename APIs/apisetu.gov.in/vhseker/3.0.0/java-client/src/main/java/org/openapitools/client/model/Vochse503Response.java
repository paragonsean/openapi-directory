...
public class Vochse503Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse503Response() {
  }

  public Vochse503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse503Response vochse503Response = (Vochse503Response) o;
    return Objects.equals(this.error, vochse503Response.error) &&
        Objects.equals(this.errorDescription, vochse503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse503Response is not found in the empty JSON string", Vochse503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse503Response>() {
           @Override
           public void write(JsonWriter out, Vochse503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse503Response
   * @throws IOException if the JSON string is invalid with respect to Vochse503Response
   */
  public static Vochse503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse503Response.class);
  }

  /**
   * Convert an instance of Vochse503Response to an JSON string
   *
   * @return JSON string
   */
