...
public class Vochse401Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse401Response() {
  }

  public Vochse401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse401Response vochse401Response = (Vochse401Response) o;
    return Objects.equals(this.error, vochse401Response.error) &&
        Objects.equals(this.errorDescription, vochse401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse401Response is not found in the empty JSON string", Vochse401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse401Response>() {
           @Override
           public void write(JsonWriter out, Vochse401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse401Response
   * @throws IOException if the JSON string is invalid with respect to Vochse401Response
   */
  public static Vochse401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse401Response.class);
  }

  /**
   * Convert an instance of Vochse401Response to an JSON string
   *
   * @return JSON string
   */
