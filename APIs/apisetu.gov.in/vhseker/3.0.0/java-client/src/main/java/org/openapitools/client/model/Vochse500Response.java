...
public class Vochse500Response {
  /**
   * Gets or Sets error
   */
  ...
  public Vochse500Response() {
  }

  public Vochse500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Vochse500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Vochse500Response vochse500Response = (Vochse500Response) o;
    return Objects.equals(this.error, vochse500Response.error) &&
        Objects.equals(this.errorDescription, vochse500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Vochse500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Vochse500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Vochse500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Vochse500Response is not found in the empty JSON string", Vochse500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Vochse500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Vochse500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Vochse500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Vochse500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Vochse500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Vochse500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Vochse500Response>() {
           @Override
           public void write(JsonWriter out, Vochse500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Vochse500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Vochse500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Vochse500Response
   * @throws IOException if the JSON string is invalid with respect to Vochse500Response
   */
  public static Vochse500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Vochse500Response.class);
  }

  /**
   * Convert an instance of Vochse500Response to an JSON string
   *
   * @return JSON string
   */
