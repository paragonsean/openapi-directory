...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/vhseker/v3");
    ...
    VochseRequest vochseRequest = new VochseRequest(); // VochseRequest | Request format
    try {
      apiInstance.vochse(vochseRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#vochse");
