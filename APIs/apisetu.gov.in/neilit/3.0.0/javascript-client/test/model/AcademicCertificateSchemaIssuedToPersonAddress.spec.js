...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfElectronicsAndInformationTechnology.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new NationalInstituteOfElectronicsAndInformationTechnology.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(NationalInstituteOfElectronicsAndInformationTechnology.AcademicCertificateSchemaIssuedToPersonAddress);
    });
