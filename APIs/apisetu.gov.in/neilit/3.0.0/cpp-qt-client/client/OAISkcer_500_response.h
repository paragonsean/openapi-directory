...
/*
 * OAISkcer_500_response.h
 *
 * 
 */

#ifndef OAISkcer_500_response_H
#define OAISkcer_500_response_H
...
class OAISkcer_500_response : public OAIObject {
public:
    OAISkcer_500_response();
    OAISkcer_500_response(QString json);
    ~OAISkcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkcer_500_response)

#endif // OAISkcer_500_response_H
