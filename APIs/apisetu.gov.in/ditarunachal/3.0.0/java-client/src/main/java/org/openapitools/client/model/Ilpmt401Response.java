...
public class Ilpmt401Response {
  ...
  public Ilpmt401Response() {
  }

  public Ilpmt401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ilpmt401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ilpmt401Response ilpmt401Response = (Ilpmt401Response) o;
    return Objects.equals(this.error, ilpmt401Response.error) &&
        Objects.equals(this.errorDescription, ilpmt401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ilpmt401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ilpmt401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ilpmt401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ilpmt401Response is not found in the empty JSON string", Ilpmt401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ilpmt401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ilpmt401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ilpmt401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ilpmt401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ilpmt401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ilpmt401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ilpmt401Response>() {
           @Override
           public void write(JsonWriter out, Ilpmt401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ilpmt401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ilpmt401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ilpmt401Response
   * @throws IOException if the JSON string is invalid with respect to Ilpmt401Response
   */
  public static Ilpmt401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ilpmt401Response.class);
  }

  /**
   * Convert an instance of Ilpmt401Response to an JSON string
   *
   * @return JSON string
   */
