...
OAIIlpmt_request::OAIIlpmt_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIlpmt_request::OAIIlpmt_request() {
    this->initializeModel();
}

OAIIlpmt_request::~OAIIlpmt_request() {}

void OAIIlpmt_request::initializeModel() {
...
void OAIIlpmt_request::fromJson(QString jsonString) {
...
void OAIIlpmt_request::fromJsonObject(QJsonObject json) {
...
QString OAIIlpmt_request::asJson() const {
...
QJsonObject OAIIlpmt_request::asJsonObject() const {
    QJsonObject obj;
...
OAIIlpmt_request_certificateParameters OAIIlpmt_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIIlpmt_request::setCertificateParameters(const OAIIlpmt_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIIlpmt_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIIlpmt_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIIlpmt_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIIlpmt_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIIlpmt_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIIlpmt_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIIlpmt_request::getFormat() const {
    return m_format;
}
void OAIIlpmt_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIIlpmt_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIIlpmt_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIIlpmt_request::getTxnId() const {
    return m_txn_id;
}
void OAIIlpmt_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIIlpmt_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIIlpmt_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIIlpmt_request::isSet() const {
...
bool OAIIlpmt_request::isValid() const {
