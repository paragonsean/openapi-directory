...
/*
 * OAIIlpmt_504_response.h
 *
 * 
 */

#ifndef OAIIlpmt_504_response_H
#define OAIIlpmt_504_response_H
...
class OAIIlpmt_504_response : public OAIObject {
public:
    OAIIlpmt_504_response();
    OAIIlpmt_504_response(QString json);
    ~OAIIlpmt_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIlpmt_504_response)

#endif // OAIIlpmt_504_response_H
