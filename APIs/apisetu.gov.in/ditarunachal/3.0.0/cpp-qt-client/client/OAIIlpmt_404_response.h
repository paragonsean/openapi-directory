...
/*
 * OAIIlpmt_404_response.h
 *
 * 
 */

#ifndef OAIIlpmt_404_response_H
#define OAIIlpmt_404_response_H
...
class OAIIlpmt_404_response : public OAIObject {
public:
    OAIIlpmt_404_response();
    OAIIlpmt_404_response(QString json);
    ~OAIIlpmt_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIlpmt_404_response)

#endif // OAIIlpmt_404_response_H
