...
/*
 * OAIIlpmt_503_response.h
 *
 * 
 */

#ifndef OAIIlpmt_503_response_H
#define OAIIlpmt_503_response_H
...
class OAIIlpmt_503_response : public OAIObject {
public:
    OAIIlpmt_503_response();
    OAIIlpmt_503_response(QString json);
    ~OAIIlpmt_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIlpmt_503_response)

#endif // OAIIlpmt_503_response_H
