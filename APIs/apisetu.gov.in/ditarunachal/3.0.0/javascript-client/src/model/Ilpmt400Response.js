...
/**
 * The Ilpmt400Response model module.
 * @module model/Ilpmt400Response
 * @version 3.0.0
 */
class Ilpmt400Response {
    /**
     * Constructs a new <code>Ilpmt400Response</code>.
     * @alias module:model/Ilpmt400Response
     */
    constructor() { 
        
        Ilpmt400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ilpmt400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ilpmt400Response} obj Optional instance to populate.
     * @return {module:model/Ilpmt400Response} The populated <code>Ilpmt400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ilpmt400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Ilpmt400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ilpmt400Response</code>.
     */
...
/**
 * @member {module:model/Ilpmt400Response.ErrorEnum} error
 */
Ilpmt400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Ilpmt400Response.ErrorDescriptionEnum} errorDescription
 */
Ilpmt400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Ilpmt400Response['ErrorDescriptionEnum'] = {
...
export default Ilpmt400Response;
