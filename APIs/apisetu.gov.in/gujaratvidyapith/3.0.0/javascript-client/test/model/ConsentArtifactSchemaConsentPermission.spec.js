...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GujaratVidyapithAhmedabad.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new GujaratVidyapithAhmedabad.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(GujaratVidyapithAhmedabad.ConsentArtifactSchemaConsentPermission);
    });
