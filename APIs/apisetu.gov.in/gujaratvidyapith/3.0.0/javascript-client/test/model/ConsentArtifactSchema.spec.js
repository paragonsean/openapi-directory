...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GujaratVidyapithAhmedabad.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new GujaratVidyapithAhmedabad.ConsentArtifactSchema();
      //expect(instance).to.be.a(GujaratVidyapithAhmedabad.ConsentArtifactSchema);
    });
