...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GujaratVidyapithAhmedabad.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new GujaratVidyapithAhmedabad.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(GujaratVidyapithAhmedabad.ConsentArtifactSchemaConsentUser);
    });
