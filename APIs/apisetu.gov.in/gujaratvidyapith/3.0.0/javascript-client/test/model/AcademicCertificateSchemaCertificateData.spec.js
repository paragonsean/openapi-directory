...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GujaratVidyapithAhmedabad.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new GujaratVidyapithAhmedabad.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(GujaratVidyapithAhmedabad.AcademicCertificateSchemaCertificateData);
    });
