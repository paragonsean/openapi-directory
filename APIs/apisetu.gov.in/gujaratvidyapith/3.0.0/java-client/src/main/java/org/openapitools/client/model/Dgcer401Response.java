...
public class Dgcer401Response {
  ...
  public Dgcer401Response() {
  }

  public Dgcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgcer401Response dgcer401Response = (Dgcer401Response) o;
    return Objects.equals(this.error, dgcer401Response.error) &&
        Objects.equals(this.errorDescription, dgcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgcer401Response is not found in the empty JSON string", Dgcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgcer401Response>() {
           @Override
           public void write(JsonWriter out, Dgcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgcer401Response
   * @throws IOException if the JSON string is invalid with respect to Dgcer401Response
   */
  public static Dgcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgcer401Response.class);
  }

  /**
   * Convert an instance of Dgcer401Response to an JSON string
   *
   * @return JSON string
   */
