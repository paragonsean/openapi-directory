...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DepartmentOfRegistrationStampsMaharashtra.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new DepartmentOfRegistrationStampsMaharashtra.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(DepartmentOfRegistrationStampsMaharashtra.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
