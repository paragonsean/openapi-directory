...
/**
 * The Llcer400Response model module.
 * @module model/Llcer400Response
 * @version 3.0.0
 */
class Llcer400Response {
    /**
     * Constructs a new <code>Llcer400Response</code>.
     * @alias module:model/Llcer400Response
     */
    constructor() { 
        
        Llcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Llcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Llcer400Response} obj Optional instance to populate.
     * @return {module:model/Llcer400Response} The populated <code>Llcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Llcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Llcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Llcer400Response</code>.
     */
...
/**
 * @member {module:model/Llcer400Response.ErrorEnum} error
 */
Llcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Llcer400Response.ErrorDescriptionEnum} errorDescription
 */
Llcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Llcer400Response['ErrorDescriptionEnum'] = {
...
export default Llcer400Response;
