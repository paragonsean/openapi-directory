...
- API version: 3.0.0
  - Build date: 2024-10-12T12:36:52.067437-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/igrmaharashtra/v3");
    ...
    LlcerRequest llcerRequest = new LlcerRequest(); // LlcerRequest | Request format
    try {
      apiInstance.llcer(llcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#llcer");
...
------------ | ------------- | ------------- | -------------
*ApisApi* | [**llcer**](docs/ApisApi.md#llcer) | **POST** /llcer/certificate | Leave and License Certificate
...
## Documentation for Models
 ...
 - [Llcer400Response](docs/Llcer400Response.md)
 - [Llcer401Response](docs/Llcer401Response.md)
 - [Llcer404Response](docs/Llcer404Response.md)
 - [Llcer500Response](docs/Llcer500Response.md)
 - [Llcer502Response](docs/Llcer502Response.md)
 - [Llcer503Response](docs/Llcer503Response.md)
 - [Llcer504Response](docs/Llcer504Response.md)
 - [LlcerRequest](docs/LlcerRequest.md)
 - [LlcerRequestCertificateParameters](docs/LlcerRequestCertificateParameters.md)
