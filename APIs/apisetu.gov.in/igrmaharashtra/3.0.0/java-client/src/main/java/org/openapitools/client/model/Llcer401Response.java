...
public class Llcer401Response {
  ...
  public Llcer401Response() {
  }

  public Llcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer401Response llcer401Response = (Llcer401Response) o;
    return Objects.equals(this.error, llcer401Response.error) &&
        Objects.equals(this.errorDescription, llcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer401Response is not found in the empty JSON string", Llcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer401Response>() {
           @Override
           public void write(JsonWriter out, Llcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer401Response
   * @throws IOException if the JSON string is invalid with respect to Llcer401Response
   */
  public static Llcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer401Response.class);
  }

  /**
   * Convert an instance of Llcer401Response to an JSON string
   *
   * @return JSON string
   */
