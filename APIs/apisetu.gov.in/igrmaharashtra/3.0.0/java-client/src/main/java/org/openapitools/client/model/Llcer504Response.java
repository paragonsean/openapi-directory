...
public class Llcer504Response {
  ...
  public Llcer504Response() {
  }

  public Llcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer504Response llcer504Response = (Llcer504Response) o;
    return Objects.equals(this.error, llcer504Response.error) &&
        Objects.equals(this.errorDescription, llcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer504Response is not found in the empty JSON string", Llcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer504Response>() {
           @Override
           public void write(JsonWriter out, Llcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer504Response
   * @throws IOException if the JSON string is invalid with respect to Llcer504Response
   */
  public static Llcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer504Response.class);
  }

  /**
   * Convert an instance of Llcer504Response to an JSON string
   *
   * @return JSON string
   */
