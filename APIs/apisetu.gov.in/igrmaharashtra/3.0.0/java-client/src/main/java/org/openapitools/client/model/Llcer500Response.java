...
public class Llcer500Response {
  ...
  public Llcer500Response() {
  }

  public Llcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer500Response llcer500Response = (Llcer500Response) o;
    return Objects.equals(this.error, llcer500Response.error) &&
        Objects.equals(this.errorDescription, llcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer500Response is not found in the empty JSON string", Llcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer500Response>() {
           @Override
           public void write(JsonWriter out, Llcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer500Response
   * @throws IOException if the JSON string is invalid with respect to Llcer500Response
   */
  public static Llcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer500Response.class);
  }

  /**
   * Convert an instance of Llcer500Response to an JSON string
   *
   * @return JSON string
   */
