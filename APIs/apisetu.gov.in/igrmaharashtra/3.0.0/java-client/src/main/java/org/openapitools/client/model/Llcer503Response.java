...
public class Llcer503Response {
  ...
  public Llcer503Response() {
  }

  public Llcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer503Response llcer503Response = (Llcer503Response) o;
    return Objects.equals(this.error, llcer503Response.error) &&
        Objects.equals(this.errorDescription, llcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer503Response is not found in the empty JSON string", Llcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer503Response>() {
           @Override
           public void write(JsonWriter out, Llcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer503Response
   * @throws IOException if the JSON string is invalid with respect to Llcer503Response
   */
  public static Llcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer503Response.class);
  }

  /**
   * Convert an instance of Llcer503Response to an JSON string
   *
   * @return JSON string
   */
