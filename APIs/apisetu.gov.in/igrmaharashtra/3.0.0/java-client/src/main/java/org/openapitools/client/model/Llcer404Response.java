...
public class Llcer404Response {
  ...
  public Llcer404Response() {
  }

  public Llcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer404Response llcer404Response = (Llcer404Response) o;
    return Objects.equals(this.error, llcer404Response.error) &&
        Objects.equals(this.errorDescription, llcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer404Response is not found in the empty JSON string", Llcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer404Response>() {
           @Override
           public void write(JsonWriter out, Llcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer404Response
   * @throws IOException if the JSON string is invalid with respect to Llcer404Response
   */
  public static Llcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer404Response.class);
  }

  /**
   * Convert an instance of Llcer404Response to an JSON string
   *
   * @return JSON string
   */
