...
public class Llcer502Response {
  ...
  public Llcer502Response() {
  }

  public Llcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer502Response llcer502Response = (Llcer502Response) o;
    return Objects.equals(this.error, llcer502Response.error) &&
        Objects.equals(this.errorDescription, llcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer502Response is not found in the empty JSON string", Llcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer502Response>() {
           @Override
           public void write(JsonWriter out, Llcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer502Response
   * @throws IOException if the JSON string is invalid with respect to Llcer502Response
   */
  public static Llcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer502Response.class);
  }

  /**
   * Convert an instance of Llcer502Response to an JSON string
   *
   * @return JSON string
   */
