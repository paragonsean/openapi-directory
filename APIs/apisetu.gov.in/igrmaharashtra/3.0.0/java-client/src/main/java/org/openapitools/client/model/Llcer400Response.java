...
public class Llcer400Response {
  ...
  public Llcer400Response() {
  }

  public Llcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Llcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Llcer400Response llcer400Response = (Llcer400Response) o;
    return Objects.equals(this.error, llcer400Response.error) &&
        Objects.equals(this.errorDescription, llcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Llcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Llcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Llcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Llcer400Response is not found in the empty JSON string", Llcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Llcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Llcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Llcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Llcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Llcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Llcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Llcer400Response>() {
           @Override
           public void write(JsonWriter out, Llcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Llcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Llcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Llcer400Response
   * @throws IOException if the JSON string is invalid with respect to Llcer400Response
   */
  public static Llcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Llcer400Response.class);
  }

  /**
   * Convert an instance of Llcer400Response to an JSON string
   *
   * @return JSON string
   */
