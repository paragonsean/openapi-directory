...
/*
 * OAIAcademicCertificateSchema_IssuedTo_Person_Address.h
 *
 * 
 */

#ifndef OAIAcademicCertificateSchema_IssuedTo_Person_Address_H
#define OAIAcademicCertificateSchema_IssuedTo_Person_Address_H
...
class OAIAcademicCertificateSchema_IssuedTo_Person_Address : public OAIObject {
public:
    OAIAcademicCertificateSchema_IssuedTo_Person_Address();
    OAIAcademicCertificateSchema_IssuedTo_Person_Address(QString json);
    ~OAIAcademicCertificateSchema_IssuedTo_Person_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcademicCertificateSchema_IssuedTo_Person_Address)

#endif // OAIAcademicCertificateSchema_IssuedTo_Person_Address_H
