...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Niesbud.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new Niesbud.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(Niesbud.AcademicCertificateSchemaCertificateData);
    });
