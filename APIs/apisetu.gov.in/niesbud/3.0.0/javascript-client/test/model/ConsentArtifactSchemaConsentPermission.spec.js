...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Niesbud.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new Niesbud.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(Niesbud.ConsentArtifactSchemaConsentPermission);
    });
