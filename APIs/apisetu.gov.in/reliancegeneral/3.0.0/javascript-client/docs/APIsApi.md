# RelianceGeneralInsuranceCompanyLtd.APIsApi
...
```javascript
import RelianceGeneralInsuranceCompanyLtd from 'reliance_general_insurance_company_ltd';
let defaultClient = RelianceGeneralInsuranceCompanyLtd.ApiClient.instance;
...
let apiInstance = new RelianceGeneralInsuranceCompanyLtd.APIsApi();
let opts = {
