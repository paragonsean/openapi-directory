...
public class Lpgsv401Response {
  ...
  public Lpgsv401Response() {
  }

  public Lpgsv401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Lpgsv401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Lpgsv401Response lpgsv401Response = (Lpgsv401Response) o;
    return Objects.equals(this.error, lpgsv401Response.error) &&
        Objects.equals(this.errorDescription, lpgsv401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Lpgsv401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Lpgsv401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Lpgsv401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Lpgsv401Response is not found in the empty JSON string", Lpgsv401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Lpgsv401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Lpgsv401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Lpgsv401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Lpgsv401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Lpgsv401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Lpgsv401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Lpgsv401Response>() {
           @Override
           public void write(JsonWriter out, Lpgsv401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Lpgsv401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Lpgsv401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Lpgsv401Response
   * @throws IOException if the JSON string is invalid with respect to Lpgsv401Response
   */
  public static Lpgsv401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Lpgsv401Response.class);
  }

  /**
   * Convert an instance of Lpgsv401Response to an JSON string
   *
   * @return JSON string
   */
