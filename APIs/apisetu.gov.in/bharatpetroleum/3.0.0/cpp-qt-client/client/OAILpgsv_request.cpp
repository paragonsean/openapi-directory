...
OAILpgsv_request::OAILpgsv_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILpgsv_request::OAILpgsv_request() {
    this->initializeModel();
}

OAILpgsv_request::~OAILpgsv_request() {}

void OAILpgsv_request::initializeModel() {
...
void OAILpgsv_request::fromJson(QString jsonString) {
...
void OAILpgsv_request::fromJsonObject(QJsonObject json) {
...
QString OAILpgsv_request::asJson() const {
...
QJsonObject OAILpgsv_request::asJsonObject() const {
    QJsonObject obj;
...
OAILpgsv_request_certificateParameters OAILpgsv_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAILpgsv_request::setCertificateParameters(const OAILpgsv_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAILpgsv_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAILpgsv_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAILpgsv_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAILpgsv_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAILpgsv_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAILpgsv_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAILpgsv_request::getFormat() const {
    return m_format;
}
void OAILpgsv_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAILpgsv_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAILpgsv_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAILpgsv_request::getTxnId() const {
    return m_txn_id;
}
void OAILpgsv_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAILpgsv_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAILpgsv_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAILpgsv_request::isSet() const {
...
bool OAILpgsv_request::isValid() const {
