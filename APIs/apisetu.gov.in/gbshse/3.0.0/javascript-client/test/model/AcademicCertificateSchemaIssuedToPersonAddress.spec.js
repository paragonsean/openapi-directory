...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoaStateBoardOfSecondaryAndHigherSecondaryEducationGoa.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new GoaStateBoardOfSecondaryAndHigherSecondaryEducationGoa.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(GoaStateBoardOfSecondaryAndHigherSecondaryEducationGoa.AcademicCertificateSchemaIssuedToPersonAddress);
    });
