...
OAICemst_request::OAICemst_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICemst_request::OAICemst_request() {
    this->initializeModel();
}

OAICemst_request::~OAICemst_request() {}

void OAICemst_request::initializeModel() {
...
void OAICemst_request::fromJson(QString jsonString) {
...
void OAICemst_request::fromJsonObject(QJsonObject json) {
...
QString OAICemst_request::asJson() const {
...
QJsonObject OAICemst_request::asJsonObject() const {
    QJsonObject obj;
...
OAICemst_request_certificateParameters OAICemst_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAICemst_request::setCertificateParameters(const OAICemst_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAICemst_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAICemst_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAICemst_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAICemst_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAICemst_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAICemst_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAICemst_request::getFormat() const {
    return m_format;
}
void OAICemst_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAICemst_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAICemst_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAICemst_request::getTxnId() const {
    return m_txn_id;
}
void OAICemst_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAICemst_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAICemst_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAICemst_request::isSet() const {
...
bool OAICemst_request::isValid() const {
