...
OAICemst_request Example::create(){
    OAICemst_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::cemstSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::cemstSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICemst_request oai_cemst_request = create(); // OAICemst_request | Request format
      apiInstance.cemst(oai_cemst_request);
