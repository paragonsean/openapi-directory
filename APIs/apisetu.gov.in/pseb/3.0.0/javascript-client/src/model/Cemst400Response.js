...
/**
 * The Cemst400Response model module.
 * @module model/Cemst400Response
 * @version 3.0.0
 */
class Cemst400Response {
    /**
     * Constructs a new <code>Cemst400Response</code>.
     * @alias module:model/Cemst400Response
     */
    constructor() { 
        
        Cemst400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Cemst400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cemst400Response} obj Optional instance to populate.
     * @return {module:model/Cemst400Response} The populated <code>Cemst400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cemst400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Cemst400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cemst400Response</code>.
     */
...
/**
 * @member {module:model/Cemst400Response.ErrorEnum} error
 */
Cemst400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Cemst400Response.ErrorDescriptionEnum} errorDescription
 */
Cemst400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Cemst400Response['ErrorDescriptionEnum'] = {
...
export default Cemst400Response;
