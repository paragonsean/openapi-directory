...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PunjabSchoolEducationBoardPunjab.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new PunjabSchoolEducationBoardPunjab.ConsentArtifactSchema();
      //expect(instance).to.be.a(PunjabSchoolEducationBoardPunjab.ConsentArtifactSchema);
    });
