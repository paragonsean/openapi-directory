...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PunjabSchoolEducationBoardPunjab.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new PunjabSchoolEducationBoardPunjab.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(PunjabSchoolEducationBoardPunjab.ConsentArtifactSchemaConsentUser);
    });
