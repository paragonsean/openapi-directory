...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PunjabSchoolEducationBoardPunjab.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new PunjabSchoolEducationBoardPunjab.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(PunjabSchoolEducationBoardPunjab.ConsentArtifactSchemaConsentPermission);
    });
