...
public class Cemst404Response {
  ...
  public Cemst404Response() {
  }

  public Cemst404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst404Response cemst404Response = (Cemst404Response) o;
    return Objects.equals(this.error, cemst404Response.error) &&
        Objects.equals(this.errorDescription, cemst404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst404Response is not found in the empty JSON string", Cemst404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst404Response>() {
           @Override
           public void write(JsonWriter out, Cemst404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst404Response
   * @throws IOException if the JSON string is invalid with respect to Cemst404Response
   */
  public static Cemst404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst404Response.class);
  }

  /**
   * Convert an instance of Cemst404Response to an JSON string
   *
   * @return JSON string
   */
