...
public class Cemst503Response {
  ...
  public Cemst503Response() {
  }

  public Cemst503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst503Response cemst503Response = (Cemst503Response) o;
    return Objects.equals(this.error, cemst503Response.error) &&
        Objects.equals(this.errorDescription, cemst503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst503Response is not found in the empty JSON string", Cemst503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst503Response>() {
           @Override
           public void write(JsonWriter out, Cemst503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst503Response
   * @throws IOException if the JSON string is invalid with respect to Cemst503Response
   */
  public static Cemst503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst503Response.class);
  }

  /**
   * Convert an instance of Cemst503Response to an JSON string
   *
   * @return JSON string
   */
