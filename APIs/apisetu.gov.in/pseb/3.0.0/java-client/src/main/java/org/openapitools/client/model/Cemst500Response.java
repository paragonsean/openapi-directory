...
public class Cemst500Response {
  ...
  public Cemst500Response() {
  }

  public Cemst500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst500Response cemst500Response = (Cemst500Response) o;
    return Objects.equals(this.error, cemst500Response.error) &&
        Objects.equals(this.errorDescription, cemst500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst500Response is not found in the empty JSON string", Cemst500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst500Response>() {
           @Override
           public void write(JsonWriter out, Cemst500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst500Response
   * @throws IOException if the JSON string is invalid with respect to Cemst500Response
   */
  public static Cemst500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst500Response.class);
  }

  /**
   * Convert an instance of Cemst500Response to an JSON string
   *
   * @return JSON string
   */
