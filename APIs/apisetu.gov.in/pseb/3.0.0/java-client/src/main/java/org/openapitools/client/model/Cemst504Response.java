...
public class Cemst504Response {
  ...
  public Cemst504Response() {
  }

  public Cemst504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst504Response cemst504Response = (Cemst504Response) o;
    return Objects.equals(this.error, cemst504Response.error) &&
        Objects.equals(this.errorDescription, cemst504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst504Response is not found in the empty JSON string", Cemst504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst504Response>() {
           @Override
           public void write(JsonWriter out, Cemst504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst504Response
   * @throws IOException if the JSON string is invalid with respect to Cemst504Response
   */
  public static Cemst504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst504Response.class);
  }

  /**
   * Convert an instance of Cemst504Response to an JSON string
   *
   * @return JSON string
   */
