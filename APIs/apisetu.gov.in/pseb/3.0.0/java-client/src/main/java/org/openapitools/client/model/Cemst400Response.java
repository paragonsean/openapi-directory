...
public class Cemst400Response {
  ...
  public Cemst400Response() {
  }

  public Cemst400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst400Response cemst400Response = (Cemst400Response) o;
    return Objects.equals(this.error, cemst400Response.error) &&
        Objects.equals(this.errorDescription, cemst400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst400Response is not found in the empty JSON string", Cemst400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst400Response>() {
           @Override
           public void write(JsonWriter out, Cemst400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst400Response
   * @throws IOException if the JSON string is invalid with respect to Cemst400Response
   */
  public static Cemst400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst400Response.class);
  }

  /**
   * Convert an instance of Cemst400Response to an JSON string
   *
   * @return JSON string
   */
