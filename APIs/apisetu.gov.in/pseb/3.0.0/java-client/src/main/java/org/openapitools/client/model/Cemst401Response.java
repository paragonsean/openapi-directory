...
public class Cemst401Response {
  ...
  public Cemst401Response() {
  }

  public Cemst401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst401Response cemst401Response = (Cemst401Response) o;
    return Objects.equals(this.error, cemst401Response.error) &&
        Objects.equals(this.errorDescription, cemst401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst401Response is not found in the empty JSON string", Cemst401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst401Response>() {
           @Override
           public void write(JsonWriter out, Cemst401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst401Response
   * @throws IOException if the JSON string is invalid with respect to Cemst401Response
   */
  public static Cemst401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst401Response.class);
  }

  /**
   * Convert an instance of Cemst401Response to an JSON string
   *
   * @return JSON string
   */
