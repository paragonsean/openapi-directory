...
public class Cemst502Response {
  ...
  public Cemst502Response() {
  }

  public Cemst502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Cemst502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Cemst502Response cemst502Response = (Cemst502Response) o;
    return Objects.equals(this.error, cemst502Response.error) &&
        Objects.equals(this.errorDescription, cemst502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Cemst502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cemst502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cemst502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cemst502Response is not found in the empty JSON string", Cemst502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cemst502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cemst502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cemst502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cemst502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cemst502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cemst502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Cemst502Response>() {
           @Override
           public void write(JsonWriter out, Cemst502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cemst502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cemst502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cemst502Response
   * @throws IOException if the JSON string is invalid with respect to Cemst502Response
   */
  public static Cemst502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cemst502Response.class);
  }

  /**
   * Convert an instance of Cemst502Response to an JSON string
   *
   * @return JSON string
   */
