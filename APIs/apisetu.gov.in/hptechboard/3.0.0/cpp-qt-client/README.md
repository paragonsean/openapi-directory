...
OAIDipcr_request Example::create(){
    OAIDipcr_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::dipcrSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::dipcrSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIDipcr_request oai_dipcr_request = create(); // OAIDipcr_request | Request format
      apiInstance.dipcr(oai_dipcr_request);
