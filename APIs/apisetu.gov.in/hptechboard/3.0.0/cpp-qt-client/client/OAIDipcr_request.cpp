...
OAIDipcr_request::OAIDipcr_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDipcr_request::OAIDipcr_request() {
    this->initializeModel();
}

OAIDipcr_request::~OAIDipcr_request() {}

void OAIDipcr_request::initializeModel() {
...
void OAIDipcr_request::fromJson(QString jsonString) {
...
void OAIDipcr_request::fromJsonObject(QJsonObject json) {
...
QString OAIDipcr_request::asJson() const {
...
QJsonObject OAIDipcr_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDipcr_request_certificateParameters OAIDipcr_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDipcr_request::setCertificateParameters(const OAIDipcr_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDipcr_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDipcr_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDipcr_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDipcr_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDipcr_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDipcr_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDipcr_request::getFormat() const {
    return m_format;
}
void OAIDipcr_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDipcr_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDipcr_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDipcr_request::getTxnId() const {
    return m_txn_id;
}
void OAIDipcr_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDipcr_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDipcr_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDipcr_request::isSet() const {
...
bool OAIDipcr_request::isValid() const {
