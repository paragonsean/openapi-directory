...
#ifndef OAIDipcr_request_H
#define OAIDipcr_request_H
...
namespace OpenAPI {
class OAIDipcr_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIDipcr_request : public OAIObject {
public:
    OAIDipcr_request();
    OAIDipcr_request(QString json);
    ~OAIDipcr_request() override;
    ...
    OAIDipcr_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIDipcr_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIDipcr_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDipcr_request)

#endif // OAIDipcr_request_H
