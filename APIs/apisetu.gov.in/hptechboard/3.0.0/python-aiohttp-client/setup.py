...
setup(
    name=NAME,
    version=VERSION,
    description="Himachal Pradesh Takniki Shiksha Board Dharamshala, Himachal Pradesh",
    author_email="",
    url="",
    keywords=["OpenAPI", "Himachal Pradesh Takniki Shiksha Board Dharamshala, Himachal Pradesh"],
