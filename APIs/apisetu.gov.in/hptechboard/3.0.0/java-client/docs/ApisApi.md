...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/hptechboard/v3");
    ...
    DipcrRequest dipcrRequest = new DipcrRequest(); // DipcrRequest | Request format
    try {
      apiInstance.dipcr(dipcrRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#dipcr");
