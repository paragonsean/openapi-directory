...
public class Dipcr502Response {
  ...
  public Dipcr502Response() {
  }

  public Dipcr502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr502Response dipcr502Response = (Dipcr502Response) o;
    return Objects.equals(this.error, dipcr502Response.error) &&
        Objects.equals(this.errorDescription, dipcr502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr502Response is not found in the empty JSON string", Dipcr502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr502Response>() {
           @Override
           public void write(JsonWriter out, Dipcr502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr502Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr502Response
   */
  public static Dipcr502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr502Response.class);
  }

  /**
   * Convert an instance of Dipcr502Response to an JSON string
   *
   * @return JSON string
   */
