...
public class Dipcr504Response {
  ...
  public Dipcr504Response() {
  }

  public Dipcr504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr504Response dipcr504Response = (Dipcr504Response) o;
    return Objects.equals(this.error, dipcr504Response.error) &&
        Objects.equals(this.errorDescription, dipcr504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr504Response is not found in the empty JSON string", Dipcr504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr504Response>() {
           @Override
           public void write(JsonWriter out, Dipcr504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr504Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr504Response
   */
  public static Dipcr504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr504Response.class);
  }

  /**
   * Convert an instance of Dipcr504Response to an JSON string
   *
   * @return JSON string
   */
