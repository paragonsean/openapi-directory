...
public class Dipcr503Response {
  ...
  public Dipcr503Response() {
  }

  public Dipcr503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr503Response dipcr503Response = (Dipcr503Response) o;
    return Objects.equals(this.error, dipcr503Response.error) &&
        Objects.equals(this.errorDescription, dipcr503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr503Response is not found in the empty JSON string", Dipcr503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr503Response>() {
           @Override
           public void write(JsonWriter out, Dipcr503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr503Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr503Response
   */
  public static Dipcr503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr503Response.class);
  }

  /**
   * Convert an instance of Dipcr503Response to an JSON string
   *
   * @return JSON string
   */
