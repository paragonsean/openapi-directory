...
public class Dipcr404Response {
  ...
  public Dipcr404Response() {
  }

  public Dipcr404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr404Response dipcr404Response = (Dipcr404Response) o;
    return Objects.equals(this.error, dipcr404Response.error) &&
        Objects.equals(this.errorDescription, dipcr404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr404Response is not found in the empty JSON string", Dipcr404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr404Response>() {
           @Override
           public void write(JsonWriter out, Dipcr404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr404Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr404Response
   */
  public static Dipcr404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr404Response.class);
  }

  /**
   * Convert an instance of Dipcr404Response to an JSON string
   *
   * @return JSON string
   */
