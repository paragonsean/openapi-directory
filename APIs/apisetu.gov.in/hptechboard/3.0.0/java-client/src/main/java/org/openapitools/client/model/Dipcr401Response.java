...
public class Dipcr401Response {
  ...
  public Dipcr401Response() {
  }

  public Dipcr401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr401Response dipcr401Response = (Dipcr401Response) o;
    return Objects.equals(this.error, dipcr401Response.error) &&
        Objects.equals(this.errorDescription, dipcr401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr401Response is not found in the empty JSON string", Dipcr401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr401Response>() {
           @Override
           public void write(JsonWriter out, Dipcr401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr401Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr401Response
   */
  public static Dipcr401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr401Response.class);
  }

  /**
   * Convert an instance of Dipcr401Response to an JSON string
   *
   * @return JSON string
   */
