...
public class Dipcr500Response {
  ...
  public Dipcr500Response() {
  }

  public Dipcr500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr500Response dipcr500Response = (Dipcr500Response) o;
    return Objects.equals(this.error, dipcr500Response.error) &&
        Objects.equals(this.errorDescription, dipcr500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr500Response is not found in the empty JSON string", Dipcr500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr500Response>() {
           @Override
           public void write(JsonWriter out, Dipcr500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr500Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr500Response
   */
  public static Dipcr500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr500Response.class);
  }

  /**
   * Convert an instance of Dipcr500Response to an JSON string
   *
   * @return JSON string
   */
