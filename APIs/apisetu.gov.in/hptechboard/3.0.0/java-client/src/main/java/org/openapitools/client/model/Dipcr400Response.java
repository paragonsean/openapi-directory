...
public class Dipcr400Response {
  ...
  public Dipcr400Response() {
  }

  public Dipcr400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dipcr400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dipcr400Response dipcr400Response = (Dipcr400Response) o;
    return Objects.equals(this.error, dipcr400Response.error) &&
        Objects.equals(this.errorDescription, dipcr400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dipcr400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dipcr400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dipcr400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dipcr400Response is not found in the empty JSON string", Dipcr400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dipcr400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dipcr400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dipcr400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dipcr400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dipcr400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dipcr400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dipcr400Response>() {
           @Override
           public void write(JsonWriter out, Dipcr400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dipcr400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dipcr400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dipcr400Response
   * @throws IOException if the JSON string is invalid with respect to Dipcr400Response
   */
  public static Dipcr400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dipcr400Response.class);
  }

  /**
   * Convert an instance of Dipcr400Response to an JSON string
   *
   * @return JSON string
   */
