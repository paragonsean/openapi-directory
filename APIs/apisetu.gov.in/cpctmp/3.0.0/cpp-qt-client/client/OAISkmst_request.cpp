...
OAISkmst_request::OAISkmst_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISkmst_request::OAISkmst_request() {
    this->initializeModel();
}

OAISkmst_request::~OAISkmst_request() {}

void OAISkmst_request::initializeModel() {
...
void OAISkmst_request::fromJson(QString jsonString) {
...
void OAISkmst_request::fromJsonObject(QJsonObject json) {
...
QString OAISkmst_request::asJson() const {
...
QJsonObject OAISkmst_request::asJsonObject() const {
    QJsonObject obj;
...
OAISkmst_request_certificateParameters OAISkmst_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAISkmst_request::setCertificateParameters(const OAISkmst_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAISkmst_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAISkmst_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAISkmst_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAISkmst_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAISkmst_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAISkmst_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAISkmst_request::getFormat() const {
    return m_format;
}
void OAISkmst_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAISkmst_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAISkmst_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAISkmst_request::getTxnId() const {
    return m_txn_id;
}
void OAISkmst_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAISkmst_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAISkmst_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAISkmst_request::isSet() const {
...
bool OAISkmst_request::isValid() const {
