...
/*
 * OAISkmst_400_response.h
 *
 * 
 */

#ifndef OAISkmst_400_response_H
#define OAISkmst_400_response_H
...
class OAISkmst_400_response : public OAIObject {
public:
    OAISkmst_400_response();
    OAISkmst_400_response(QString json);
    ~OAISkmst_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkmst_400_response)

#endif // OAISkmst_400_response_H
