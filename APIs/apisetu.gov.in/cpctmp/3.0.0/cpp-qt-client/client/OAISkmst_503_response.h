...
/*
 * OAISkmst_503_response.h
 *
 * 
 */

#ifndef OAISkmst_503_response_H
#define OAISkmst_503_response_H
...
class OAISkmst_503_response : public OAIObject {
public:
    OAISkmst_503_response();
    OAISkmst_503_response(QString json);
    ~OAISkmst_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkmst_503_response)

#endif // OAISkmst_503_response_H
