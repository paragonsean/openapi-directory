...
/*
 * OAISkmst_504_response.h
 *
 * 
 */

#ifndef OAISkmst_504_response_H
#define OAISkmst_504_response_H
...
class OAISkmst_504_response : public OAIObject {
public:
    OAISkmst_504_response();
    OAISkmst_504_response(QString json);
    ~OAISkmst_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkmst_504_response)

#endif // OAISkmst_504_response_H
