...
OAISkmst_request Example::create(){
    OAISkmst_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::skmstSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::skmstSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAISkmst_request oai_skmst_request = create(); // OAISkmst_request | Request format
      apiInstance.skmst(oai_skmst_request);
