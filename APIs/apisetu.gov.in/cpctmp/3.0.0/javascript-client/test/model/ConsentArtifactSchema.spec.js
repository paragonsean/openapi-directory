...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CpctMapitMadhyaPradesh.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new CpctMapitMadhyaPradesh.ConsentArtifactSchema();
      //expect(instance).to.be.a(CpctMapitMadhyaPradesh.ConsentArtifactSchema);
    });
