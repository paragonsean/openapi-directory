...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CpctMapitMadhyaPradesh.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new CpctMapitMadhyaPradesh.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(CpctMapitMadhyaPradesh.AcademicCertificateSchemaCertificateData);
    });
