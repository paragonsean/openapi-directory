...
public class Skmst502Response {
  ...
  public Skmst502Response() {
  }

  public Skmst502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst502Response skmst502Response = (Skmst502Response) o;
    return Objects.equals(this.error, skmst502Response.error) &&
        Objects.equals(this.errorDescription, skmst502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst502Response is not found in the empty JSON string", Skmst502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst502Response>() {
           @Override
           public void write(JsonWriter out, Skmst502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst502Response
   * @throws IOException if the JSON string is invalid with respect to Skmst502Response
   */
  public static Skmst502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst502Response.class);
  }

  /**
   * Convert an instance of Skmst502Response to an JSON string
   *
   * @return JSON string
   */
