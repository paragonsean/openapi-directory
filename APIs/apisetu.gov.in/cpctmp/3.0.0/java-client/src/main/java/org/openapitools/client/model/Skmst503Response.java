...
public class Skmst503Response {
  ...
  public Skmst503Response() {
  }

  public Skmst503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst503Response skmst503Response = (Skmst503Response) o;
    return Objects.equals(this.error, skmst503Response.error) &&
        Objects.equals(this.errorDescription, skmst503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst503Response is not found in the empty JSON string", Skmst503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst503Response>() {
           @Override
           public void write(JsonWriter out, Skmst503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst503Response
   * @throws IOException if the JSON string is invalid with respect to Skmst503Response
   */
  public static Skmst503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst503Response.class);
  }

  /**
   * Convert an instance of Skmst503Response to an JSON string
   *
   * @return JSON string
   */
