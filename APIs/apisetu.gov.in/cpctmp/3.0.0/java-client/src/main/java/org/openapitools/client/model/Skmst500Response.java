...
public class Skmst500Response {
  ...
  public Skmst500Response() {
  }

  public Skmst500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst500Response skmst500Response = (Skmst500Response) o;
    return Objects.equals(this.error, skmst500Response.error) &&
        Objects.equals(this.errorDescription, skmst500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst500Response is not found in the empty JSON string", Skmst500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst500Response>() {
           @Override
           public void write(JsonWriter out, Skmst500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst500Response
   * @throws IOException if the JSON string is invalid with respect to Skmst500Response
   */
  public static Skmst500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst500Response.class);
  }

  /**
   * Convert an instance of Skmst500Response to an JSON string
   *
   * @return JSON string
   */
