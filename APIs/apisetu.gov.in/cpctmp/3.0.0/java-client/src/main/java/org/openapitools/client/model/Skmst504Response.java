...
public class Skmst504Response {
  ...
  public Skmst504Response() {
  }

  public Skmst504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst504Response skmst504Response = (Skmst504Response) o;
    return Objects.equals(this.error, skmst504Response.error) &&
        Objects.equals(this.errorDescription, skmst504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst504Response is not found in the empty JSON string", Skmst504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst504Response>() {
           @Override
           public void write(JsonWriter out, Skmst504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst504Response
   * @throws IOException if the JSON string is invalid with respect to Skmst504Response
   */
  public static Skmst504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst504Response.class);
  }

  /**
   * Convert an instance of Skmst504Response to an JSON string
   *
   * @return JSON string
   */
