...
public class Skmst400Response {
  ...
  public Skmst400Response() {
  }

  public Skmst400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst400Response skmst400Response = (Skmst400Response) o;
    return Objects.equals(this.error, skmst400Response.error) &&
        Objects.equals(this.errorDescription, skmst400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst400Response is not found in the empty JSON string", Skmst400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst400Response>() {
           @Override
           public void write(JsonWriter out, Skmst400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst400Response
   * @throws IOException if the JSON string is invalid with respect to Skmst400Response
   */
  public static Skmst400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst400Response.class);
  }

  /**
   * Convert an instance of Skmst400Response to an JSON string
   *
   * @return JSON string
   */
