...
public class Skmst404Response {
  ...
  public Skmst404Response() {
  }

  public Skmst404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst404Response skmst404Response = (Skmst404Response) o;
    return Objects.equals(this.error, skmst404Response.error) &&
        Objects.equals(this.errorDescription, skmst404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst404Response is not found in the empty JSON string", Skmst404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst404Response>() {
           @Override
           public void write(JsonWriter out, Skmst404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst404Response
   * @throws IOException if the JSON string is invalid with respect to Skmst404Response
   */
  public static Skmst404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst404Response.class);
  }

  /**
   * Convert an instance of Skmst404Response to an JSON string
   *
   * @return JSON string
   */
