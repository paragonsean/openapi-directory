...
public class Skmst401Response {
  ...
  public Skmst401Response() {
  }

  public Skmst401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skmst401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skmst401Response skmst401Response = (Skmst401Response) o;
    return Objects.equals(this.error, skmst401Response.error) &&
        Objects.equals(this.errorDescription, skmst401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skmst401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skmst401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skmst401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skmst401Response is not found in the empty JSON string", Skmst401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skmst401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skmst401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skmst401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skmst401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skmst401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skmst401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skmst401Response>() {
           @Override
           public void write(JsonWriter out, Skmst401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skmst401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skmst401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skmst401Response
   * @throws IOException if the JSON string is invalid with respect to Skmst401Response
   */
  public static Skmst401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skmst401Response.class);
  }

  /**
   * Convert an instance of Skmst401Response to an JSON string
   *
   * @return JSON string
   */
