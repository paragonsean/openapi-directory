...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs500Response();
  });
  ...
  describe('Brlcs500Response', function() {
    it('should create an instance of Brlcs500Response', function() {
      // uncomment below and update the code to test Brlcs500Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs500Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs500Response);
    });
