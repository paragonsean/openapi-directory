...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs400Response();
  });
  ...
  describe('Brlcs400Response', function() {
    it('should create an instance of Brlcs400Response', function() {
      // uncomment below and update the code to test Brlcs400Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs400Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs400Response);
    });
