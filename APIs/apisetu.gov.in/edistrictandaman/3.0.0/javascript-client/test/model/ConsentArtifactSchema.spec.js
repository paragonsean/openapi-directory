...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchema();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchema);
    });
