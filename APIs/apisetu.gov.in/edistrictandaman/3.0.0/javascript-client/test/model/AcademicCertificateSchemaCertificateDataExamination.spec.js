...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaCertificateDataExamination();
  });
  ...
  describe('AcademicCertificateSchemaCertificateDataExamination', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateDataExamination', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaCertificateDataExamination();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaCertificateDataExamination);
    });
