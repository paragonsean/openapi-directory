...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.BrlcsRequestCertificateParameters();
  });
  ...
  describe('BrlcsRequestCertificateParameters', function() {
    it('should create an instance of BrlcsRequestCertificateParameters', function() {
      // uncomment below and update the code to test BrlcsRequestCertificateParameters
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.BrlcsRequestCertificateParameters();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.BrlcsRequestCertificateParameters);
    });
