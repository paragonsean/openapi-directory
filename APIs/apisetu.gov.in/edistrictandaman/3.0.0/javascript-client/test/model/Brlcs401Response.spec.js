...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs401Response();
  });
  ...
  describe('Brlcs401Response', function() {
    it('should create an instance of Brlcs401Response', function() {
      // uncomment below and update the code to test Brlcs401Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs401Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs401Response);
    });
