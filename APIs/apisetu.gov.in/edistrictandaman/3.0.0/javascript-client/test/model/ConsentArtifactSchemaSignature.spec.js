...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaSignature();
  });
  ...
  describe('ConsentArtifactSchemaSignature', function() {
    it('should create an instance of ConsentArtifactSchemaSignature', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaSignature();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaSignature);
    });
