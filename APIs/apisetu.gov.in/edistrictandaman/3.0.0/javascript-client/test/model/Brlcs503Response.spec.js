...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs503Response();
  });
  ...
  describe('Brlcs503Response', function() {
    it('should create an instance of Brlcs503Response', function() {
      // uncomment below and update the code to test Brlcs503Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs503Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs503Response);
    });
