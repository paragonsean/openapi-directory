...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs404Response();
  });
  ...
  describe('Brlcs404Response', function() {
    it('should create an instance of Brlcs404Response', function() {
      // uncomment below and update the code to test Brlcs404Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs404Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs404Response);
    });
