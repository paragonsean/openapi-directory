...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaConsentPermission);
    });
