...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaCertificateData);
    });
