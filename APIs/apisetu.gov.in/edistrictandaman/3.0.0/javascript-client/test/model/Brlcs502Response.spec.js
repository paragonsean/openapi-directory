...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs502Response();
  });
  ...
  describe('Brlcs502Response', function() {
    it('should create an instance of Brlcs502Response', function() {
      // uncomment below and update the code to test Brlcs502Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs502Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs502Response);
    });
