...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaIssuedToPersonAddress);
    });
