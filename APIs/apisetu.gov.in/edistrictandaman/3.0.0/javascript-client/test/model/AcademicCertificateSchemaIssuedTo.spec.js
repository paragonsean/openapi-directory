...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaIssuedTo();
  });
  ...
  describe('AcademicCertificateSchemaIssuedTo', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedTo', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaIssuedTo();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchemaIssuedTo);
    });
