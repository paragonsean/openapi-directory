...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs504Response();
  });
  ...
  describe('Brlcs504Response', function() {
    it('should create an instance of Brlcs504Response', function() {
      // uncomment below and update the code to test Brlcs504Response
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs504Response();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.Brlcs504Response);
    });
