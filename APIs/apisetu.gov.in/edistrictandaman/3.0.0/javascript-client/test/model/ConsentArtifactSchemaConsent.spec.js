...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaConsent();
  });
  ...
  describe('ConsentArtifactSchemaConsent', function() {
    it('should create an instance of ConsentArtifactSchemaConsent', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaConsent();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.ConsentArtifactSchemaConsent);
    });
