...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchema();
  });
  ...
  describe('AcademicCertificateSchema', function() {
    it('should create an instance of AcademicCertificateSchema', function() {
      ...
      //var instance = new EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchema();
      //expect(instance).to.be.a(EDistrictAndamanNicobarIslandsAndamanNicobar.AcademicCertificateSchema);
    });
