...
public class Brlcs500Response {
  ...
  public Brlcs500Response() {
  }

  public Brlcs500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs500Response brlcs500Response = (Brlcs500Response) o;
    return Objects.equals(this.error, brlcs500Response.error) &&
        Objects.equals(this.errorDescription, brlcs500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs500Response is not found in the empty JSON string", Brlcs500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs500Response>() {
           @Override
           public void write(JsonWriter out, Brlcs500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs500Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs500Response
   */
  public static Brlcs500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs500Response.class);
  }

  /**
   * Convert an instance of Brlcs500Response to an JSON string
   *
   * @return JSON string
   */
