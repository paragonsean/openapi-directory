 ...
 * Brlcs503Response
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-12T12:34:29.203620-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Brlcs503Response {
  /**
   * Gets or Sets error
   */
  ...
  public Brlcs503Response() {
  }

  public Brlcs503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs503Response brlcs503Response = (Brlcs503Response) o;
    return Objects.equals(this.error, brlcs503Response.error) &&
        Objects.equals(this.errorDescription, brlcs503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs503Response is not found in the empty JSON string", Brlcs503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs503Response>() {
           @Override
           public void write(JsonWriter out, Brlcs503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs503Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs503Response
   */
  public static Brlcs503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs503Response.class);
  }

  /**
   * Convert an instance of Brlcs503Response to an JSON string
   *
   * @return JSON string
   */
