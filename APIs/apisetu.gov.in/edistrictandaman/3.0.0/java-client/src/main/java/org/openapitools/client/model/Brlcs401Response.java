...
public class Brlcs401Response {
  ...
  public Brlcs401Response() {
  }

  public Brlcs401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs401Response brlcs401Response = (Brlcs401Response) o;
    return Objects.equals(this.error, brlcs401Response.error) &&
        Objects.equals(this.errorDescription, brlcs401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs401Response is not found in the empty JSON string", Brlcs401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs401Response>() {
           @Override
           public void write(JsonWriter out, Brlcs401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs401Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs401Response
   */
  public static Brlcs401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs401Response.class);
  }

  /**
   * Convert an instance of Brlcs401Response to an JSON string
   *
   * @return JSON string
   */
