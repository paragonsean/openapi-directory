...
public class Brlcs404Response {
  ...
  public Brlcs404Response() {
  }

  public Brlcs404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs404Response brlcs404Response = (Brlcs404Response) o;
    return Objects.equals(this.error, brlcs404Response.error) &&
        Objects.equals(this.errorDescription, brlcs404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs404Response is not found in the empty JSON string", Brlcs404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs404Response>() {
           @Override
           public void write(JsonWriter out, Brlcs404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs404Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs404Response
   */
  public static Brlcs404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs404Response.class);
  }

  /**
   * Convert an instance of Brlcs404Response to an JSON string
   *
   * @return JSON string
   */
