...
public class Brlcs504Response {
  ...
  public Brlcs504Response() {
  }

  public Brlcs504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs504Response brlcs504Response = (Brlcs504Response) o;
    return Objects.equals(this.error, brlcs504Response.error) &&
        Objects.equals(this.errorDescription, brlcs504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs504Response is not found in the empty JSON string", Brlcs504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs504Response>() {
           @Override
           public void write(JsonWriter out, Brlcs504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs504Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs504Response
   */
  public static Brlcs504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs504Response.class);
  }

  /**
   * Convert an instance of Brlcs504Response to an JSON string
   *
   * @return JSON string
   */
