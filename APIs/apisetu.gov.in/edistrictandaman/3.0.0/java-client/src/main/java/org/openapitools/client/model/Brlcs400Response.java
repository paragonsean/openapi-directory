...
public class Brlcs400Response {
  ...
  public Brlcs400Response() {
  }

  public Brlcs400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs400Response brlcs400Response = (Brlcs400Response) o;
    return Objects.equals(this.error, brlcs400Response.error) &&
        Objects.equals(this.errorDescription, brlcs400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs400Response is not found in the empty JSON string", Brlcs400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs400Response>() {
           @Override
           public void write(JsonWriter out, Brlcs400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs400Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs400Response
   */
  public static Brlcs400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs400Response.class);
  }

  /**
   * Convert an instance of Brlcs400Response to an JSON string
   *
   * @return JSON string
   */
