...
public class Brlcs502Response {
  ...
  public Brlcs502Response() {
  }

  public Brlcs502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Brlcs502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Brlcs502Response brlcs502Response = (Brlcs502Response) o;
    return Objects.equals(this.error, brlcs502Response.error) &&
        Objects.equals(this.errorDescription, brlcs502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Brlcs502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Brlcs502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Brlcs502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Brlcs502Response is not found in the empty JSON string", Brlcs502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Brlcs502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Brlcs502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Brlcs502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Brlcs502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Brlcs502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Brlcs502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Brlcs502Response>() {
           @Override
           public void write(JsonWriter out, Brlcs502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Brlcs502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Brlcs502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Brlcs502Response
   * @throws IOException if the JSON string is invalid with respect to Brlcs502Response
   */
  public static Brlcs502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Brlcs502Response.class);
  }

  /**
   * Convert an instance of Brlcs502Response to an JSON string
   *
   * @return JSON string
   */
