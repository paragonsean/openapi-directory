...
OAIBrlcs_request Example::create(){
    OAIBrlcs_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::brlcsSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::brlcsSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIBrlcs_request oai_brlcs_request = create(); // OAIBrlcs_request | Request format
      apiInstance.brlcs(oai_brlcs_request);
