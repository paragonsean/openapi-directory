...
#ifndef OAIBrlcs_request_H
#define OAIBrlcs_request_H
...
namespace OpenAPI {
class OAIBrlcs_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIBrlcs_request : public OAIObject {
public:
    OAIBrlcs_request();
    OAIBrlcs_request(QString json);
    ~OAIBrlcs_request() override;
    ...
    OAIBrlcs_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIBrlcs_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIBrlcs_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrlcs_request)

#endif // OAIBrlcs_request_H
