...
OAIBrlcs_request::OAIBrlcs_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBrlcs_request::OAIBrlcs_request() {
    this->initializeModel();
}

OAIBrlcs_request::~OAIBrlcs_request() {}

void OAIBrlcs_request::initializeModel() {
...
void OAIBrlcs_request::fromJson(QString jsonString) {
...
void OAIBrlcs_request::fromJsonObject(QJsonObject json) {
...
QString OAIBrlcs_request::asJson() const {
...
QJsonObject OAIBrlcs_request::asJsonObject() const {
    QJsonObject obj;
...
OAIBrlcs_request_certificateParameters OAIBrlcs_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIBrlcs_request::setCertificateParameters(const OAIBrlcs_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIBrlcs_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIBrlcs_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIBrlcs_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIBrlcs_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIBrlcs_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIBrlcs_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIBrlcs_request::getFormat() const {
    return m_format;
}
void OAIBrlcs_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIBrlcs_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIBrlcs_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIBrlcs_request::getTxnId() const {
    return m_txn_id;
}
void OAIBrlcs_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIBrlcs_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIBrlcs_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIBrlcs_request::isSet() const {
...
bool OAIBrlcs_request::isValid() const {
