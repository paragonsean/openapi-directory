...
/*
 * OAIIncer_404_response.h
 *
 * 
 */

#ifndef OAIIncer_404_response_H
#define OAIIncer_404_response_H
...
class OAIIncer_404_response : public OAIObject {
public:
    OAIIncer_404_response();
    OAIIncer_404_response(QString json);
    ~OAIIncer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIncer_404_response)

#endif // OAIIncer_404_response_H
