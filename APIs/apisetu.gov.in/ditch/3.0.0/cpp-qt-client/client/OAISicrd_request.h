...
#ifndef OAISicrd_request_H
#define OAISicrd_request_H
...
namespace OpenAPI {
class OAISicrd_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAISicrd_request : public OAIObject {
public:
    OAISicrd_request();
    OAISicrd_request(QString json);
    ~OAISicrd_request() override;
    ...
    OAISicrd_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAISicrd_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAISicrd_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAISicrd_request)

#endif // OAISicrd_request_H
