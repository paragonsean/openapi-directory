...
OAISicrd_request::OAISicrd_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISicrd_request::OAISicrd_request() {
    this->initializeModel();
}

OAISicrd_request::~OAISicrd_request() {}

void OAISicrd_request::initializeModel() {
...
void OAISicrd_request::fromJson(QString jsonString) {
...
void OAISicrd_request::fromJsonObject(QJsonObject json) {
...
QString OAISicrd_request::asJson() const {
...
QJsonObject OAISicrd_request::asJsonObject() const {
    QJsonObject obj;
...
OAISicrd_request_certificateParameters OAISicrd_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAISicrd_request::setCertificateParameters(const OAISicrd_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAISicrd_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAISicrd_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAISicrd_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAISicrd_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAISicrd_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAISicrd_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAISicrd_request::getFormat() const {
    return m_format;
}
void OAISicrd_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAISicrd_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAISicrd_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAISicrd_request::getTxnId() const {
    return m_txn_id;
}
void OAISicrd_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAISicrd_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAISicrd_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAISicrd_request::isSet() const {
...
bool OAISicrd_request::isValid() const {
