...
OAIIncer_request::OAIIncer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIncer_request::OAIIncer_request() {
    this->initializeModel();
}

OAIIncer_request::~OAIIncer_request() {}

void OAIIncer_request::initializeModel() {
...
void OAIIncer_request::fromJson(QString jsonString) {
...
void OAIIncer_request::fromJsonObject(QJsonObject json) {
...
QString OAIIncer_request::asJson() const {
...
QJsonObject OAIIncer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIIncer_request_certificateParameters OAIIncer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIIncer_request::setCertificateParameters(const OAIIncer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIIncer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIIncer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIIncer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIIncer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIIncer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIIncer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIIncer_request::getFormat() const {
    return m_format;
}
void OAIIncer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIIncer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIIncer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIIncer_request::getTxnId() const {
    return m_txn_id;
}
void OAIIncer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIIncer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIIncer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIIncer_request::isSet() const {
...
bool OAIIncer_request::isValid() const {
