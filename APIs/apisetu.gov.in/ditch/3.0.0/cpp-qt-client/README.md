...
OAIIncer_request Example::create(){
    OAIIncer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::incerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::incerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIIncer_request oai_incer_request = create(); // OAIIncer_request | Request format
      apiInstance.incer(oai_incer_request);
