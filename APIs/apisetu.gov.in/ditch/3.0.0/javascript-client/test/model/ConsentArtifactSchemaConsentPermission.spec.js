...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictChandigarhChandigarh.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new EDistrictChandigarhChandigarh.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(EDistrictChandigarhChandigarh.ConsentArtifactSchemaConsentPermission);
    });
