...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictChandigarhChandigarh.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new EDistrictChandigarhChandigarh.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(EDistrictChandigarhChandigarh.ConsentArtifactSchemaConsentUser);
    });
