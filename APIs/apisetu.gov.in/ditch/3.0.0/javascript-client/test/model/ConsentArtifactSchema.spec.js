...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictChandigarhChandigarh.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new EDistrictChandigarhChandigarh.ConsentArtifactSchema();
      //expect(instance).to.be.a(EDistrictChandigarhChandigarh.ConsentArtifactSchema);
    });
