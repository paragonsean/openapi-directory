...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictChandigarhChandigarh.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EDistrictChandigarhChandigarh.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EDistrictChandigarhChandigarh.AcademicCertificateSchemaCertificateData);
    });
