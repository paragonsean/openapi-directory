...
public class Incer500Response {
  ...
  public Incer500Response() {
  }

  public Incer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer500Response incer500Response = (Incer500Response) o;
    return Objects.equals(this.error, incer500Response.error) &&
        Objects.equals(this.errorDescription, incer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer500Response is not found in the empty JSON string", Incer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer500Response>() {
           @Override
           public void write(JsonWriter out, Incer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer500Response
   * @throws IOException if the JSON string is invalid with respect to Incer500Response
   */
  public static Incer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer500Response.class);
  }

  /**
   * Convert an instance of Incer500Response to an JSON string
   *
   * @return JSON string
   */
