...
public class Incer502Response {
  ...
  public Incer502Response() {
  }

  public Incer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer502Response incer502Response = (Incer502Response) o;
    return Objects.equals(this.error, incer502Response.error) &&
        Objects.equals(this.errorDescription, incer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer502Response is not found in the empty JSON string", Incer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer502Response>() {
           @Override
           public void write(JsonWriter out, Incer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer502Response
   * @throws IOException if the JSON string is invalid with respect to Incer502Response
   */
  public static Incer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer502Response.class);
  }

  /**
   * Convert an instance of Incer502Response to an JSON string
   *
   * @return JSON string
   */
