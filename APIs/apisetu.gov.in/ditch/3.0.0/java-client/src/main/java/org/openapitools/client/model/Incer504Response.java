...
public class Incer504Response {
  ...
  public Incer504Response() {
  }

  public Incer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer504Response incer504Response = (Incer504Response) o;
    return Objects.equals(this.error, incer504Response.error) &&
        Objects.equals(this.errorDescription, incer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer504Response is not found in the empty JSON string", Incer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer504Response>() {
           @Override
           public void write(JsonWriter out, Incer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer504Response
   * @throws IOException if the JSON string is invalid with respect to Incer504Response
   */
  public static Incer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer504Response.class);
  }

  /**
   * Convert an instance of Incer504Response to an JSON string
   *
   * @return JSON string
   */
