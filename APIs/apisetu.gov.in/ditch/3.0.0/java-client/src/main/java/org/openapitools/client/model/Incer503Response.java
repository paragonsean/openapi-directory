...
public class Incer503Response {
  ...
  public Incer503Response() {
  }

  public Incer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer503Response incer503Response = (Incer503Response) o;
    return Objects.equals(this.error, incer503Response.error) &&
        Objects.equals(this.errorDescription, incer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer503Response is not found in the empty JSON string", Incer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer503Response>() {
           @Override
           public void write(JsonWriter out, Incer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer503Response
   * @throws IOException if the JSON string is invalid with respect to Incer503Response
   */
  public static Incer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer503Response.class);
  }

  /**
   * Convert an instance of Incer503Response to an JSON string
   *
   * @return JSON string
   */
