...
public class Incer400Response {
  ...
  public Incer400Response() {
  }

  public Incer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer400Response incer400Response = (Incer400Response) o;
    return Objects.equals(this.error, incer400Response.error) &&
        Objects.equals(this.errorDescription, incer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer400Response is not found in the empty JSON string", Incer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer400Response>() {
           @Override
           public void write(JsonWriter out, Incer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer400Response
   * @throws IOException if the JSON string is invalid with respect to Incer400Response
   */
  public static Incer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer400Response.class);
  }

  /**
   * Convert an instance of Incer400Response to an JSON string
   *
   * @return JSON string
   */
