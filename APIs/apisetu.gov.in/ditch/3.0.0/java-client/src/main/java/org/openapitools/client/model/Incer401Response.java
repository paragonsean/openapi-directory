...
public class Incer401Response {
  ...
  public Incer401Response() {
  }

  public Incer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer401Response incer401Response = (Incer401Response) o;
    return Objects.equals(this.error, incer401Response.error) &&
        Objects.equals(this.errorDescription, incer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer401Response is not found in the empty JSON string", Incer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer401Response>() {
           @Override
           public void write(JsonWriter out, Incer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer401Response
   * @throws IOException if the JSON string is invalid with respect to Incer401Response
   */
  public static Incer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer401Response.class);
  }

  /**
   * Convert an instance of Incer401Response to an JSON string
   *
   * @return JSON string
   */
