...
public class Incer404Response {
  ...
  public Incer404Response() {
  }

  public Incer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Incer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Incer404Response incer404Response = (Incer404Response) o;
    return Objects.equals(this.error, incer404Response.error) &&
        Objects.equals(this.errorDescription, incer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Incer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Incer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Incer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Incer404Response is not found in the empty JSON string", Incer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Incer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Incer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Incer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Incer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Incer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Incer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Incer404Response>() {
           @Override
           public void write(JsonWriter out, Incer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Incer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Incer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Incer404Response
   * @throws IOException if the JSON string is invalid with respect to Incer404Response
   */
  public static Incer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Incer404Response.class);
  }

  /**
   * Convert an instance of Incer404Response to an JSON string
   *
   * @return JSON string
   */
