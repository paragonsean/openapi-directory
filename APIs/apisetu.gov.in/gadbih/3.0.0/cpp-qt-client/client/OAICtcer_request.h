...
#ifndef OAICtcer_request_H
#define OAICtcer_request_H
...
namespace OpenAPI {
class OAICtcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAICtcer_request : public OAIObject {
public:
    OAICtcer_request();
    OAICtcer_request(QString json);
    ~OAICtcer_request() override;
    ...
    OAICtcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAICtcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAICtcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAICtcer_request)

#endif // OAICtcer_request_H
