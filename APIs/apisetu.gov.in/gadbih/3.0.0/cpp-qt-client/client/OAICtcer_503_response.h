...
/*
 * OAICtcer_503_response.h
 *
 * 
 */

#ifndef OAICtcer_503_response_H
#define OAICtcer_503_response_H
...
class OAICtcer_503_response : public OAIObject {
public:
    OAICtcer_503_response();
    OAICtcer_503_response(QString json);
    ~OAICtcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICtcer_503_response)

#endif // OAICtcer_503_response_H
