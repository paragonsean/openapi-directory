...
public:
    ...
    * @param[in]  oai_ctcer_request OAICtcer_request [optional]
    */
    virtual void incer(const ::OpenAPI::OptionalParam<OAICtcer_request> &oai_ctcer_request = ::OpenAPI::OptionalParam<OAICtcer_request>());

    /**
    * @param[in]  oai_ctcer_request OAICtcer_request [optional]
    */
    virtual void rscer(const ::OpenAPI::OptionalParam<OAICtcer_request> &oai_ctcer_request = ::OpenAPI::OptionalParam<OAICtcer_request>());
