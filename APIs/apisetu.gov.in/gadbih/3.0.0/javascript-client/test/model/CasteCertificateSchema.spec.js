...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneralAdministrationDepartmentBihar.CasteCertificateSchema();
  });
  ...
  describe('CasteCertificateSchema', function() {
    it('should create an instance of CasteCertificateSchema', function() {
      // uncomment below and update the code to test CasteCertificateSchema
      //var instance = new GeneralAdministrationDepartmentBihar.CasteCertificateSchema();
      //expect(instance).to.be.a(GeneralAdministrationDepartmentBihar.CasteCertificateSchema);
    });
