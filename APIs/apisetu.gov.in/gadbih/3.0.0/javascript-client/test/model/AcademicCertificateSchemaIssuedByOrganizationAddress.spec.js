...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeneralAdministrationDepartmentBihar.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new GeneralAdministrationDepartmentBihar.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(GeneralAdministrationDepartmentBihar.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
