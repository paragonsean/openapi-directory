...
OAISkcer_request::OAISkcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISkcer_request::OAISkcer_request() {
    this->initializeModel();
}

OAISkcer_request::~OAISkcer_request() {}

void OAISkcer_request::initializeModel() {
...
void OAISkcer_request::fromJson(QString jsonString) {
...
void OAISkcer_request::fromJsonObject(QJsonObject json) {
...
QString OAISkcer_request::asJson() const {
...
QJsonObject OAISkcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAISkcer_request_certificateParameters OAISkcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAISkcer_request::setCertificateParameters(const OAISkcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAISkcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAISkcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAISkcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAISkcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAISkcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAISkcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAISkcer_request::getFormat() const {
    return m_format;
}
void OAISkcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAISkcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAISkcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAISkcer_request::getTxnId() const {
    return m_txn_id;
}
void OAISkcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAISkcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAISkcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAISkcer_request::isSet() const {
...
bool OAISkcer_request::isValid() const {
