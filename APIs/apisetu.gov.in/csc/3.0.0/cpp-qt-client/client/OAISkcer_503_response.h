...
/*
 * OAISkcer_503_response.h
 *
 * 
 */

#ifndef OAISkcer_503_response_H
#define OAISkcer_503_response_H
...
class OAISkcer_503_response : public OAIObject {
public:
    OAISkcer_503_response();
    OAISkcer_503_response(QString json);
    ~OAISkcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISkcer_503_response)

#endif // OAISkcer_503_response_H
