...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommonServiceCentreCsc.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new CommonServiceCentreCsc.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(CommonServiceCentreCsc.AcademicCertificateSchemaCertificateData);
    });
