...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommonServiceCentreCsc.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new CommonServiceCentreCsc.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(CommonServiceCentreCsc.ConsentArtifactSchemaConsentPermission);
    });
