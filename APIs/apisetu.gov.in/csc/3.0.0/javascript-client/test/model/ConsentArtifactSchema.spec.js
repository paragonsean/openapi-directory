...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CommonServiceCentreCsc.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new CommonServiceCentreCsc.ConsentArtifactSchema();
      //expect(instance).to.be.a(CommonServiceCentreCsc.ConsentArtifactSchema);
    });
