...
public class Skcer401Response {
  ...
  public Skcer401Response() {
  }

  public Skcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skcer401Response skcer401Response = (Skcer401Response) o;
    return Objects.equals(this.error, skcer401Response.error) &&
        Objects.equals(this.errorDescription, skcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skcer401Response is not found in the empty JSON string", Skcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skcer401Response>() {
           @Override
           public void write(JsonWriter out, Skcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skcer401Response
   * @throws IOException if the JSON string is invalid with respect to Skcer401Response
   */
  public static Skcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skcer401Response.class);
  }

  /**
   * Convert an instance of Skcer401Response to an JSON string
   *
   * @return JSON string
   */
