...
public class Skcer504Response {
  ...
  public Skcer504Response() {
  }

  public Skcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skcer504Response skcer504Response = (Skcer504Response) o;
    return Objects.equals(this.error, skcer504Response.error) &&
        Objects.equals(this.errorDescription, skcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skcer504Response is not found in the empty JSON string", Skcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skcer504Response>() {
           @Override
           public void write(JsonWriter out, Skcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skcer504Response
   * @throws IOException if the JSON string is invalid with respect to Skcer504Response
   */
  public static Skcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skcer504Response.class);
  }

  /**
   * Convert an instance of Skcer504Response to an JSON string
   *
   * @return JSON string
   */
