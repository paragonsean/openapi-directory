...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TripuraStateBoardOfSecondaryEducationTripura.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new TripuraStateBoardOfSecondaryEducationTripura.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(TripuraStateBoardOfSecondaryEducationTripura.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
