...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfTechnologyPatna.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new NationalInstituteOfTechnologyPatna.ConsentArtifactSchema();
      //expect(instance).to.be.a(NationalInstituteOfTechnologyPatna.ConsentArtifactSchema);
    });
