...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfTechnologyPatna.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new NationalInstituteOfTechnologyPatna.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(NationalInstituteOfTechnologyPatna.ConsentArtifactSchemaConsentUser);
    });
