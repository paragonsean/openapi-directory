...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfTechnologyPatna.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new NationalInstituteOfTechnologyPatna.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(NationalInstituteOfTechnologyPatna.ConsentArtifactSchemaConsentPermission);
    });
