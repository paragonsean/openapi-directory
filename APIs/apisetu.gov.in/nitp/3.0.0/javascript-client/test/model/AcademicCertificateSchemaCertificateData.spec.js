...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NationalInstituteOfTechnologyPatna.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new NationalInstituteOfTechnologyPatna.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(NationalInstituteOfTechnologyPatna.AcademicCertificateSchemaCertificateData);
    });
