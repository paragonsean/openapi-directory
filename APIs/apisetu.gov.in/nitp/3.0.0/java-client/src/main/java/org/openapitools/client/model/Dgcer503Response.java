...
public class Dgcer503Response {
  ...
  public Dgcer503Response() {
  }

  public Dgcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgcer503Response dgcer503Response = (Dgcer503Response) o;
    return Objects.equals(this.error, dgcer503Response.error) &&
        Objects.equals(this.errorDescription, dgcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgcer503Response is not found in the empty JSON string", Dgcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgcer503Response>() {
           @Override
           public void write(JsonWriter out, Dgcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgcer503Response
   * @throws IOException if the JSON string is invalid with respect to Dgcer503Response
   */
  public static Dgcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgcer503Response.class);
  }

  /**
   * Convert an instance of Dgcer503Response to an JSON string
   *
   * @return JSON string
   */
