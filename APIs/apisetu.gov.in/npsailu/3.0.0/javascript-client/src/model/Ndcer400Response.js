...
/**
 * The Ndcer400Response model module.
 * @module model/Ndcer400Response
 * @version 3.0.0
 */
class Ndcer400Response {
    /**
     * Constructs a new <code>Ndcer400Response</code>.
     * @alias module:model/Ndcer400Response
     */
    constructor() { 
        
        Ndcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Ndcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ndcer400Response} obj Optional instance to populate.
     * @return {module:model/Ndcer400Response} The populated <code>Ndcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Ndcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Ndcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ndcer400Response</code>.
     */
...
/**
 * @member {module:model/Ndcer400Response.ErrorEnum} error
 */
Ndcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Ndcer400Response.ErrorDescriptionEnum} errorDescription
 */
Ndcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Ndcer400Response['ErrorDescriptionEnum'] = {
...
export default Ndcer400Response;
