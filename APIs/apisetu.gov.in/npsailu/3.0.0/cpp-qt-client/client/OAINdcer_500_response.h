...
/*
 * OAINdcer_500_response.h
 *
 * 
 */

#ifndef OAINdcer_500_response_H
#define OAINdcer_500_response_H
...
class OAINdcer_500_response : public OAIObject {
public:
    OAINdcer_500_response();
    OAINdcer_500_response(QString json);
    ~OAINdcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINdcer_500_response)

#endif // OAINdcer_500_response_H
