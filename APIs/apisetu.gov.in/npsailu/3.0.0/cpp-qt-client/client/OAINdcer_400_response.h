...
/*
 * OAINdcer_400_response.h
 *
 * 
 */

#ifndef OAINdcer_400_response_H
#define OAINdcer_400_response_H
...
class OAINdcer_400_response : public OAIObject {
public:
    OAINdcer_400_response();
    OAINdcer_400_response(QString json);
    ~OAINdcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINdcer_400_response)

#endif // OAINdcer_400_response_H
