...
/*
 * OAINdcer_503_response.h
 *
 * 
 */

#ifndef OAINdcer_503_response_H
#define OAINdcer_503_response_H
...
class OAINdcer_503_response : public OAIObject {
public:
    OAINdcer_503_response();
    OAINdcer_503_response(QString json);
    ~OAINdcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINdcer_503_response)

#endif // OAINdcer_503_response_H
