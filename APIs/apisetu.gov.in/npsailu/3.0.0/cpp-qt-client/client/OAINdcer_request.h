...
#ifndef OAINdcer_request_H
#define OAINdcer_request_H
...
namespace OpenAPI {
class OAINdcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAINdcer_request : public OAIObject {
public:
    OAINdcer_request();
    OAINdcer_request(QString json);
    ~OAINdcer_request() override;
    ...
    OAINdcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAINdcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAINdcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAINdcer_request)

#endif // OAINdcer_request_H
