...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/npsailu/v3");
    ...
    NdcerRequest ndcerRequest = new NdcerRequest(); // NdcerRequest | Request format
    try {
      apiInstance.ndcer(ndcerRequest);
