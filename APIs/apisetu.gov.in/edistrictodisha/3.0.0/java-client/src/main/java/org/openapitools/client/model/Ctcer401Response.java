...
public class Ctcer401Response {
  ...
  public Ctcer401Response() {
  }

  public Ctcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ctcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ctcer401Response ctcer401Response = (Ctcer401Response) o;
    return Objects.equals(this.error, ctcer401Response.error) &&
        Objects.equals(this.errorDescription, ctcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ctcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ctcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ctcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ctcer401Response is not found in the empty JSON string", Ctcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ctcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ctcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ctcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ctcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ctcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ctcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ctcer401Response>() {
           @Override
           public void write(JsonWriter out, Ctcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ctcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ctcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ctcer401Response
   * @throws IOException if the JSON string is invalid with respect to Ctcer401Response
   */
  public static Ctcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ctcer401Response.class);
  }

  /**
   * Convert an instance of Ctcer401Response to an JSON string
   *
   * @return JSON string
   */
