...
public class Ctcer504Response {
  ...
  public Ctcer504Response() {
  }

  public Ctcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ctcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ctcer504Response ctcer504Response = (Ctcer504Response) o;
    return Objects.equals(this.error, ctcer504Response.error) &&
        Objects.equals(this.errorDescription, ctcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ctcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ctcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ctcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ctcer504Response is not found in the empty JSON string", Ctcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ctcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ctcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ctcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ctcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ctcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ctcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ctcer504Response>() {
           @Override
           public void write(JsonWriter out, Ctcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ctcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ctcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ctcer504Response
   * @throws IOException if the JSON string is invalid with respect to Ctcer504Response
   */
  public static Ctcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ctcer504Response.class);
  }

  /**
   * Convert an instance of Ctcer504Response to an JSON string
   *
   * @return JSON string
   */
