...
public class Ctcer503Response {
  ...
  public Ctcer503Response() {
  }

  public Ctcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ctcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ctcer503Response ctcer503Response = (Ctcer503Response) o;
    return Objects.equals(this.error, ctcer503Response.error) &&
        Objects.equals(this.errorDescription, ctcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ctcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ctcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ctcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ctcer503Response is not found in the empty JSON string", Ctcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ctcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ctcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ctcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ctcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ctcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ctcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ctcer503Response>() {
           @Override
           public void write(JsonWriter out, Ctcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ctcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ctcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ctcer503Response
   * @throws IOException if the JSON string is invalid with respect to Ctcer503Response
   */
  public static Ctcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ctcer503Response.class);
  }

  /**
   * Convert an instance of Ctcer503Response to an JSON string
   *
   * @return JSON string
   */
