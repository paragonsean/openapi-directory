...
public class Ctcer500Response {
  ...
  public Ctcer500Response() {
  }

  public Ctcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ctcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ctcer500Response ctcer500Response = (Ctcer500Response) o;
    return Objects.equals(this.error, ctcer500Response.error) &&
        Objects.equals(this.errorDescription, ctcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ctcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ctcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ctcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ctcer500Response is not found in the empty JSON string", Ctcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ctcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ctcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ctcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ctcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ctcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ctcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ctcer500Response>() {
           @Override
           public void write(JsonWriter out, Ctcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ctcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ctcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ctcer500Response
   * @throws IOException if the JSON string is invalid with respect to Ctcer500Response
   */
  public static Ctcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ctcer500Response.class);
  }

  /**
   * Convert an instance of Ctcer500Response to an JSON string
   *
   * @return JSON string
   */
