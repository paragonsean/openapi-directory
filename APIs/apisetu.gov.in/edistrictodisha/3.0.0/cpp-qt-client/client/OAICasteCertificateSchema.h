...
/*
 * OAICasteCertificateSchema.h
 *
 * 
 */

#ifndef OAICasteCertificateSchema_H
#define OAICasteCertificateSchema_H
...
namespace OpenAPI {
class OAICasteCertificateSchema_CertificateData;
class OAICasteCertificateSchema_IssuedBy;
class OAICasteCertificateSchema_IssuedTo;

class OAICasteCertificateSchema : public OAIObject {
public:
    OAICasteCertificateSchema();
    OAICasteCertificateSchema(QString json);
    ~OAICasteCertificateSchema() override;
    ...
    OAICasteCertificateSchema_CertificateData getCertificateData() const;
    void setCertificateData(const OAICasteCertificateSchema_CertificateData &certificate_data);
    bool is_certificate_data_Set() const;
    bool is_certificate_data_Valid() const;

    OAICasteCertificateSchema_IssuedBy getIssuedBy() const;
    void setIssuedBy(const OAICasteCertificateSchema_IssuedBy &issued_by);
    bool is_issued_by_Set() const;
    bool is_issued_by_Valid() const;

    OAICasteCertificateSchema_IssuedTo getIssuedTo() const;
    void setIssuedTo(const OAICasteCertificateSchema_IssuedTo &issued_to);
...
private:
    ...
    OAICasteCertificateSchema_CertificateData m_certificate_data;
    bool m_certificate_data_isSet;
    bool m_certificate_data_isValid;

    OAICasteCertificateSchema_IssuedBy m_issued_by;
    bool m_issued_by_isSet;
    bool m_issued_by_isValid;

    OAICasteCertificateSchema_IssuedTo m_issued_to;
...
Q_DECLARE_METATYPE(OpenAPI::OAICasteCertificateSchema)

#endif // OAICasteCertificateSchema_H
