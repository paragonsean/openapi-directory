...
/*
 * OAICtcer_400_response.h
 *
 * 
 */

#ifndef OAICtcer_400_response_H
#define OAICtcer_400_response_H
...
class OAICtcer_400_response : public OAIObject {
public:
    OAICtcer_400_response();
    OAICtcer_400_response(QString json);
    ~OAICtcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICtcer_400_response)

#endif // OAICtcer_400_response_H
