...
/*
 * OAICasteCertificateSchema_IssuedTo_Person.h
 *
 * 
 */

#ifndef OAICasteCertificateSchema_IssuedTo_Person_H
#define OAICasteCertificateSchema_IssuedTo_Person_H
...
class OAICasteCertificateSchema_IssuedTo_Person : public OAIObject {
public:
    OAICasteCertificateSchema_IssuedTo_Person();
    OAICasteCertificateSchema_IssuedTo_Person(QString json);
    ~OAICasteCertificateSchema_IssuedTo_Person() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICasteCertificateSchema_IssuedTo_Person)

#endif // OAICasteCertificateSchema_IssuedTo_Person_H
