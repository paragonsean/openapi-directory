...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictOdishaOdisha.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new EDistrictOdishaOdisha.ConsentArtifactSchema();
      //expect(instance).to.be.a(EDistrictOdishaOdisha.ConsentArtifactSchema);
    });
