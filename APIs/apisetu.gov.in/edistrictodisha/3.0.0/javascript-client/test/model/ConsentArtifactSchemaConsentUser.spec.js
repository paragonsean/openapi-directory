...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictOdishaOdisha.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new EDistrictOdishaOdisha.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(EDistrictOdishaOdisha.ConsentArtifactSchemaConsentUser);
    });
