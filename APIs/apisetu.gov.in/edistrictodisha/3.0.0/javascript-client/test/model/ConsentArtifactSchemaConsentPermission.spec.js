...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictOdishaOdisha.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new EDistrictOdishaOdisha.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(EDistrictOdishaOdisha.ConsentArtifactSchemaConsentPermission);
    });
