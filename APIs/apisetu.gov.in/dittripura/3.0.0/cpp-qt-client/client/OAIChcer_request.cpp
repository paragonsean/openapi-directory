...
OAIChcer_request::OAIChcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChcer_request::OAIChcer_request() {
    this->initializeModel();
}

OAIChcer_request::~OAIChcer_request() {}

void OAIChcer_request::initializeModel() {
...
void OAIChcer_request::fromJson(QString jsonString) {
...
void OAIChcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIChcer_request::asJson() const {
...
QJsonObject OAIChcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIChcer_request_certificateParameters OAIChcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIChcer_request::setCertificateParameters(const OAIChcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIChcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIChcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIChcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIChcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIChcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIChcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIChcer_request::getFormat() const {
    return m_format;
}
void OAIChcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIChcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIChcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIChcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIChcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIChcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIChcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIChcer_request::isSet() const {
...
bool OAIChcer_request::isValid() const {
