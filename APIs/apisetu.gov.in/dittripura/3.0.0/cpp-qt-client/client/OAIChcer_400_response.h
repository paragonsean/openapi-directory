...
/*
 * OAIChcer_400_response.h
 *
 * 
 */

#ifndef OAIChcer_400_response_H
#define OAIChcer_400_response_H
...
class OAIChcer_400_response : public OAIObject {
public:
    OAIChcer_400_response();
    OAIChcer_400_response(QString json);
    ~OAIChcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChcer_400_response)

#endif // OAIChcer_400_response_H
