...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer500Response();
  });
  ...
  describe('Chcer500Response', function() {
    it('should create an instance of Chcer500Response', function() {
      // uncomment below and update the code to test Chcer500Response
      //var instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer500Response();
      //expect(instance).to.be.a(DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer500Response);
    });
