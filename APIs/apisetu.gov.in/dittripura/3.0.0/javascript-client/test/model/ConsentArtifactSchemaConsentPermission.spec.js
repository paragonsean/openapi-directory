...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.ConsentArtifactSchemaConsentPermission);
    });
