...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer503Response();
  });
  ...
  describe('Chcer503Response', function() {
    it('should create an instance of Chcer503Response', function() {
      // uncomment below and update the code to test Chcer503Response
      //var instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer503Response();
      //expect(instance).to.be.a(DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer503Response);
    });
