...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer400Response();
  });
  ...
  describe('Chcer400Response', function() {
    it('should create an instance of Chcer400Response', function() {
      // uncomment below and update the code to test Chcer400Response
      //var instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer400Response();
      //expect(instance).to.be.a(DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.Chcer400Response);
    });
