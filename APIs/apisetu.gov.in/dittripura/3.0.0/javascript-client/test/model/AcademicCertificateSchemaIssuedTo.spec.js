...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.AcademicCertificateSchemaIssuedTo();
  });
  ...
  describe('AcademicCertificateSchemaIssuedTo', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedTo', function() {
      ...
      //var instance = new DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.AcademicCertificateSchemaIssuedTo();
      //expect(instance).to.be.a(DirectorateOfInformationTechnologyGovernmentOfTripuraTripura.AcademicCertificateSchemaIssuedTo);
    });
