...
public class Chcer503Response {
  ...
  public Chcer503Response() {
  }

  public Chcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer503Response chcer503Response = (Chcer503Response) o;
    return Objects.equals(this.error, chcer503Response.error) &&
        Objects.equals(this.errorDescription, chcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer503Response is not found in the empty JSON string", Chcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer503Response>() {
           @Override
           public void write(JsonWriter out, Chcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer503Response
   * @throws IOException if the JSON string is invalid with respect to Chcer503Response
   */
  public static Chcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer503Response.class);
  }

  /**
   * Convert an instance of Chcer503Response to an JSON string
   *
   * @return JSON string
   */
