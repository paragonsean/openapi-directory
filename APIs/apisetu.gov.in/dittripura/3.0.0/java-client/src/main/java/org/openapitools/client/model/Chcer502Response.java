...
public class Chcer502Response {
  ...
  public Chcer502Response() {
  }

  public Chcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer502Response chcer502Response = (Chcer502Response) o;
    return Objects.equals(this.error, chcer502Response.error) &&
        Objects.equals(this.errorDescription, chcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer502Response is not found in the empty JSON string", Chcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer502Response>() {
           @Override
           public void write(JsonWriter out, Chcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer502Response
   * @throws IOException if the JSON string is invalid with respect to Chcer502Response
   */
  public static Chcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer502Response.class);
  }

  /**
   * Convert an instance of Chcer502Response to an JSON string
   *
   * @return JSON string
   */
