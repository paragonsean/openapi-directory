...
public class Chcer500Response {
  ...
  public Chcer500Response() {
  }

  public Chcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer500Response chcer500Response = (Chcer500Response) o;
    return Objects.equals(this.error, chcer500Response.error) &&
        Objects.equals(this.errorDescription, chcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer500Response is not found in the empty JSON string", Chcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer500Response>() {
           @Override
           public void write(JsonWriter out, Chcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer500Response
   * @throws IOException if the JSON string is invalid with respect to Chcer500Response
   */
  public static Chcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer500Response.class);
  }

  /**
   * Convert an instance of Chcer500Response to an JSON string
   *
   * @return JSON string
   */
