...
public class Chcer400Response {
  ...
  public Chcer400Response() {
  }

  public Chcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer400Response chcer400Response = (Chcer400Response) o;
    return Objects.equals(this.error, chcer400Response.error) &&
        Objects.equals(this.errorDescription, chcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer400Response is not found in the empty JSON string", Chcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer400Response>() {
           @Override
           public void write(JsonWriter out, Chcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer400Response
   * @throws IOException if the JSON string is invalid with respect to Chcer400Response
   */
  public static Chcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer400Response.class);
  }

  /**
   * Convert an instance of Chcer400Response to an JSON string
   *
   * @return JSON string
   */
