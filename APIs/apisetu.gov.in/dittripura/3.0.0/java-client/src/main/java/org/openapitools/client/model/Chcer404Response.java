...
public class Chcer404Response {
  ...
  public Chcer404Response() {
  }

  public Chcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Chcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Chcer404Response chcer404Response = (Chcer404Response) o;
    return Objects.equals(this.error, chcer404Response.error) &&
        Objects.equals(this.errorDescription, chcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Chcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Chcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Chcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Chcer404Response is not found in the empty JSON string", Chcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Chcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Chcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Chcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Chcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Chcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Chcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Chcer404Response>() {
           @Override
           public void write(JsonWriter out, Chcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Chcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Chcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Chcer404Response
   * @throws IOException if the JSON string is invalid with respect to Chcer404Response
   */
  public static Chcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Chcer404Response.class);
  }

  /**
   * Convert an instance of Chcer404Response to an JSON string
   *
   * @return JSON string
   */
