...
async def test_chcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/chcer/certificate',
        headers=headers,
        json=body,
        )
...
async def test_dncer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/dncer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_dpcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/dpcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_fslcs(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/fslcs/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_grred(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/grred/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_incer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/incer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_isoal(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/isoal/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_lvcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/lvcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_malcs(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/malcs/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_mpkby(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/mpkby/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_obcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/obcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_ritin(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/ritin/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_rmcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/rmcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_rscer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/rscer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_shcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/shcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_smcer(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/smcer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sslcs(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/sslcs/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_vrwmi(client):
    ...
    response = await client.request(
        method='POST',
        path='/dittripura/v3/vrwmi/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
