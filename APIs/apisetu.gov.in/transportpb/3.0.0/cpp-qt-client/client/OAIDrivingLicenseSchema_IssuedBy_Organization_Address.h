...
/*
 * OAIDrivingLicenseSchema_IssuedBy_Organization_Address.h
 *
 * 
 */

#ifndef OAIDrivingLicenseSchema_IssuedBy_Organization_Address_H
#define OAIDrivingLicenseSchema_IssuedBy_Organization_Address_H
...
class OAIDrivingLicenseSchema_IssuedBy_Organization_Address : public OAIObject {
public:
    OAIDrivingLicenseSchema_IssuedBy_Organization_Address();
    OAIDrivingLicenseSchema_IssuedBy_Organization_Address(QString json);
    ~OAIDrivingLicenseSchema_IssuedBy_Organization_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDrivingLicenseSchema_IssuedBy_Organization_Address)

#endif // OAIDrivingLicenseSchema_IssuedBy_Organization_Address_H
