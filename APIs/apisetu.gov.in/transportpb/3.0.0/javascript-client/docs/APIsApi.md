# TransportDepartmentPunjab.APIsApi
...
```javascript
import TransportDepartmentPunjab from 'transport_department_punjab';
let defaultClient = TransportDepartmentPunjab.ApiClient.instance;
...
let apiInstance = new TransportDepartmentPunjab.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentPunjab.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentPunjab.RvcerRequest() // RvcerRequest | Request format
};
