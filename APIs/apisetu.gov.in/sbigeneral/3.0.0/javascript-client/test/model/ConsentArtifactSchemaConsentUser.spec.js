...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SbiGeneralInsuranceCompanyLtd.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new SbiGeneralInsuranceCompanyLtd.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(SbiGeneralInsuranceCompanyLtd.ConsentArtifactSchemaConsentUser);
    });
