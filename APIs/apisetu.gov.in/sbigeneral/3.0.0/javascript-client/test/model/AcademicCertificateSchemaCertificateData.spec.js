...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SbiGeneralInsuranceCompanyLtd.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new SbiGeneralInsuranceCompanyLtd.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(SbiGeneralInsuranceCompanyLtd.AcademicCertificateSchemaCertificateData);
    });
