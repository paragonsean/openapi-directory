...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SbiGeneralInsuranceCompanyLtd.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new SbiGeneralInsuranceCompanyLtd.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(SbiGeneralInsuranceCompanyLtd.ConsentArtifactSchemaConsentPermission);
    });
