# SbiGeneralInsuranceCompanyLtd.APIsApi
...
```javascript
import SbiGeneralInsuranceCompanyLtd from 'sbi_general_insurance_company_ltd';
let defaultClient = SbiGeneralInsuranceCompanyLtd.ApiClient.instance;
...
let apiInstance = new SbiGeneralInsuranceCompanyLtd.APIsApi();
let opts = {
