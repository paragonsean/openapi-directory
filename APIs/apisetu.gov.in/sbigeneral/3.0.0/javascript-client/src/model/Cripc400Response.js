...
/**
 * The Cripc400Response model module.
 * @module model/Cripc400Response
 * @version 3.0.0
 */
class Cripc400Response {
    /**
     * Constructs a new <code>Cripc400Response</code>.
     * @alias module:model/Cripc400Response
     */
    constructor() { 
        
        Cripc400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Cripc400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cripc400Response} obj Optional instance to populate.
     * @return {module:model/Cripc400Response} The populated <code>Cripc400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Cripc400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Cripc400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cripc400Response</code>.
     */
...
/**
 * @member {module:model/Cripc400Response.ErrorEnum} error
 */
Cripc400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Cripc400Response.ErrorDescriptionEnum} errorDescription
 */
Cripc400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Cripc400Response['ErrorDescriptionEnum'] = {
...
export default Cripc400Response;
