...
OAIPecer_request::OAIPecer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPecer_request::OAIPecer_request() {
    this->initializeModel();
}

OAIPecer_request::~OAIPecer_request() {}

void OAIPecer_request::initializeModel() {
...
void OAIPecer_request::fromJson(QString jsonString) {
...
void OAIPecer_request::fromJsonObject(QJsonObject json) {
...
QString OAIPecer_request::asJson() const {
...
QJsonObject OAIPecer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIPecer_request_certificateParameters OAIPecer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIPecer_request::setCertificateParameters(const OAIPecer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIPecer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIPecer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIPecer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIPecer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIPecer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIPecer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIPecer_request::getFormat() const {
    return m_format;
}
void OAIPecer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIPecer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIPecer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIPecer_request::getTxnId() const {
    return m_txn_id;
}
void OAIPecer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIPecer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIPecer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIPecer_request::isSet() const {
...
bool OAIPecer_request::isValid() const {
