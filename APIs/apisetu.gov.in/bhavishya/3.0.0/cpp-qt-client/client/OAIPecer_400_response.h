...
/*
 * OAIPecer_400_response.h
 *
 * 
 */

#ifndef OAIPecer_400_response_H
#define OAIPecer_400_response_H
...
class OAIPecer_400_response : public OAIObject {
public:
    OAIPecer_400_response();
    OAIPecer_400_response(QString json);
    ~OAIPecer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPecer_400_response)

#endif // OAIPecer_400_response_H
