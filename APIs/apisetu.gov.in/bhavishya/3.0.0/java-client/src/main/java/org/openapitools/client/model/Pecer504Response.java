...
public class Pecer504Response {
  ...
  public Pecer504Response() {
  }

  public Pecer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pecer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pecer504Response pecer504Response = (Pecer504Response) o;
    return Objects.equals(this.error, pecer504Response.error) &&
        Objects.equals(this.errorDescription, pecer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pecer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pecer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pecer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pecer504Response is not found in the empty JSON string", Pecer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pecer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pecer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pecer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pecer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pecer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pecer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pecer504Response>() {
           @Override
           public void write(JsonWriter out, Pecer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pecer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pecer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pecer504Response
   * @throws IOException if the JSON string is invalid with respect to Pecer504Response
   */
  public static Pecer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pecer504Response.class);
  }

  /**
   * Convert an instance of Pecer504Response to an JSON string
   *
   * @return JSON string
   */
