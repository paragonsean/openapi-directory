...
public class Pecer401Response {
  ...
  public Pecer401Response() {
  }

  public Pecer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pecer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pecer401Response pecer401Response = (Pecer401Response) o;
    return Objects.equals(this.error, pecer401Response.error) &&
        Objects.equals(this.errorDescription, pecer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pecer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pecer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pecer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pecer401Response is not found in the empty JSON string", Pecer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pecer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pecer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pecer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pecer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pecer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pecer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pecer401Response>() {
           @Override
           public void write(JsonWriter out, Pecer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pecer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pecer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pecer401Response
   * @throws IOException if the JSON string is invalid with respect to Pecer401Response
   */
  public static Pecer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pecer401Response.class);
  }

  /**
   * Convert an instance of Pecer401Response to an JSON string
   *
   * @return JSON string
   */
