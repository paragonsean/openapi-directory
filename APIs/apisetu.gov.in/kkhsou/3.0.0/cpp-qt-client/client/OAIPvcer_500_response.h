...
/*
 * OAIPvcer_500_response.h
 *
 * 
 */

#ifndef OAIPvcer_500_response_H
#define OAIPvcer_500_response_H
...
class OAIPvcer_500_response : public OAIObject {
public:
    OAIPvcer_500_response();
    OAIPvcer_500_response(QString json);
    ~OAIPvcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPvcer_500_response)

#endif // OAIPvcer_500_response_H
