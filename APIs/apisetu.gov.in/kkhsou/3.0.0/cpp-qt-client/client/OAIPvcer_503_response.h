...
/*
 * OAIPvcer_503_response.h
 *
 * 
 */

#ifndef OAIPvcer_503_response_H
#define OAIPvcer_503_response_H
...
class OAIPvcer_503_response : public OAIObject {
public:
    OAIPvcer_503_response();
    OAIPvcer_503_response(QString json);
    ~OAIPvcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPvcer_503_response)

#endif // OAIPvcer_503_response_H
