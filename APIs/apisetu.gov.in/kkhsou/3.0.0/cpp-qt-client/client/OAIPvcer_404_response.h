...
/*
 * OAIPvcer_404_response.h
 *
 * 
 */

#ifndef OAIPvcer_404_response_H
#define OAIPvcer_404_response_H
...
class OAIPvcer_404_response : public OAIObject {
public:
    OAIPvcer_404_response();
    OAIPvcer_404_response(QString json);
    ~OAIPvcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPvcer_404_response)

#endif // OAIPvcer_404_response_H
