...
/*
 * OAIPvcer_400_response.h
 *
 * 
 */

#ifndef OAIPvcer_400_response_H
#define OAIPvcer_400_response_H
...
class OAIPvcer_400_response : public OAIObject {
public:
    OAIPvcer_400_response();
    OAIPvcer_400_response(QString json);
    ~OAIPvcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPvcer_400_response)

#endif // OAIPvcer_400_response_H
