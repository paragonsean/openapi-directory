...
OAIPvcer_request Example::create(){
    OAIPvcer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::pvcerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::pvcerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIPvcer_request oai_pvcer_request = create(); // OAIPvcer_request | Request format
      apiInstance.pvcer(oai_pvcer_request);
