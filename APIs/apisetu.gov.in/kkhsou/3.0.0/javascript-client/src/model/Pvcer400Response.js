...
/**
 * The Pvcer400Response model module.
 * @module model/Pvcer400Response
 * @version 3.0.0
 */
class Pvcer400Response {
    /**
     * Constructs a new <code>Pvcer400Response</code>.
     * @alias module:model/Pvcer400Response
     */
    constructor() { 
        
        Pvcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Pvcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Pvcer400Response} obj Optional instance to populate.
     * @return {module:model/Pvcer400Response} The populated <code>Pvcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Pvcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Pvcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Pvcer400Response</code>.
     */
...
/**
 * @member {module:model/Pvcer400Response.ErrorEnum} error
 */
Pvcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Pvcer400Response.ErrorDescriptionEnum} errorDescription
 */
Pvcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Pvcer400Response['ErrorDescriptionEnum'] = {
...
export default Pvcer400Response;
