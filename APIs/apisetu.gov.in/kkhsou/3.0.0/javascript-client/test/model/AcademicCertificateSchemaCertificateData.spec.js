...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.AcademicCertificateSchemaCertificateData);
    });
