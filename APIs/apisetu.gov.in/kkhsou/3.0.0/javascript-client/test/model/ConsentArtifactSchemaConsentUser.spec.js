...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.ConsentArtifactSchemaConsentUser);
    });
