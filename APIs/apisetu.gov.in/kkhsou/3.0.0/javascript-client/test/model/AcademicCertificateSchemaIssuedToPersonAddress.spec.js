...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(KrishnaKantaHandiqueStateOpenUniversityKkhsouAssam.AcademicCertificateSchemaIssuedToPersonAddress);
    });
