...
public class Pvcer400Response {
  ...
  public Pvcer400Response() {
  }

  public Pvcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer400Response pvcer400Response = (Pvcer400Response) o;
    return Objects.equals(this.error, pvcer400Response.error) &&
        Objects.equals(this.errorDescription, pvcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer400Response is not found in the empty JSON string", Pvcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer400Response>() {
           @Override
           public void write(JsonWriter out, Pvcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer400Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer400Response
   */
  public static Pvcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer400Response.class);
  }

  /**
   * Convert an instance of Pvcer400Response to an JSON string
   *
   * @return JSON string
   */
