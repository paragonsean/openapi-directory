...
public class Pvcer503Response {
  ...
  public Pvcer503Response() {
  }

  public Pvcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer503Response pvcer503Response = (Pvcer503Response) o;
    return Objects.equals(this.error, pvcer503Response.error) &&
        Objects.equals(this.errorDescription, pvcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer503Response is not found in the empty JSON string", Pvcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer503Response>() {
           @Override
           public void write(JsonWriter out, Pvcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer503Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer503Response
   */
  public static Pvcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer503Response.class);
  }

  /**
   * Convert an instance of Pvcer503Response to an JSON string
   *
   * @return JSON string
   */
