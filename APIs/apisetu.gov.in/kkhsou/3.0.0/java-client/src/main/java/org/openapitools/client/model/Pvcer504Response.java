...
public class Pvcer504Response {
  ...
  public Pvcer504Response() {
  }

  public Pvcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer504Response pvcer504Response = (Pvcer504Response) o;
    return Objects.equals(this.error, pvcer504Response.error) &&
        Objects.equals(this.errorDescription, pvcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer504Response is not found in the empty JSON string", Pvcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer504Response>() {
           @Override
           public void write(JsonWriter out, Pvcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer504Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer504Response
   */
  public static Pvcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer504Response.class);
  }

  /**
   * Convert an instance of Pvcer504Response to an JSON string
   *
   * @return JSON string
   */
