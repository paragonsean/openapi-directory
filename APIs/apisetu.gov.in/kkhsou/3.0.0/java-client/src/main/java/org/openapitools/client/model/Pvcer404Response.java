...
public class Pvcer404Response {
  ...
  public Pvcer404Response() {
  }

  public Pvcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer404Response pvcer404Response = (Pvcer404Response) o;
    return Objects.equals(this.error, pvcer404Response.error) &&
        Objects.equals(this.errorDescription, pvcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer404Response is not found in the empty JSON string", Pvcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer404Response>() {
           @Override
           public void write(JsonWriter out, Pvcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer404Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer404Response
   */
  public static Pvcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer404Response.class);
  }

  /**
   * Convert an instance of Pvcer404Response to an JSON string
   *
   * @return JSON string
   */
