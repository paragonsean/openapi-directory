...
public class Pvcer500Response {
  ...
  public Pvcer500Response() {
  }

  public Pvcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer500Response pvcer500Response = (Pvcer500Response) o;
    return Objects.equals(this.error, pvcer500Response.error) &&
        Objects.equals(this.errorDescription, pvcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer500Response is not found in the empty JSON string", Pvcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer500Response>() {
           @Override
           public void write(JsonWriter out, Pvcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer500Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer500Response
   */
  public static Pvcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer500Response.class);
  }

  /**
   * Convert an instance of Pvcer500Response to an JSON string
   *
   * @return JSON string
   */
