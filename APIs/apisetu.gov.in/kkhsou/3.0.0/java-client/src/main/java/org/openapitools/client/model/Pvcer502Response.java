...
public class Pvcer502Response {
  ...
  public Pvcer502Response() {
  }

  public Pvcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer502Response pvcer502Response = (Pvcer502Response) o;
    return Objects.equals(this.error, pvcer502Response.error) &&
        Objects.equals(this.errorDescription, pvcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer502Response is not found in the empty JSON string", Pvcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer502Response>() {
           @Override
           public void write(JsonWriter out, Pvcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer502Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer502Response
   */
  public static Pvcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer502Response.class);
  }

  /**
   * Convert an instance of Pvcer502Response to an JSON string
   *
   * @return JSON string
   */
