...
public class Pvcer401Response {
  ...
  public Pvcer401Response() {
  }

  public Pvcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Pvcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Pvcer401Response pvcer401Response = (Pvcer401Response) o;
    return Objects.equals(this.error, pvcer401Response.error) &&
        Objects.equals(this.errorDescription, pvcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Pvcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Pvcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Pvcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pvcer401Response is not found in the empty JSON string", Pvcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Pvcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Pvcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pvcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pvcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pvcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pvcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Pvcer401Response>() {
           @Override
           public void write(JsonWriter out, Pvcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Pvcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Pvcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Pvcer401Response
   * @throws IOException if the JSON string is invalid with respect to Pvcer401Response
   */
  public static Pvcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pvcer401Response.class);
  }

  /**
   * Convert an instance of Pvcer401Response to an JSON string
   *
   * @return JSON string
   */
