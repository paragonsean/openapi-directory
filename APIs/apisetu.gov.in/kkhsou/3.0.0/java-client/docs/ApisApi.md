...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/kkhsou/v3");
    ...
    PvcerRequest pvcerRequest = new PvcerRequest(); // PvcerRequest | Request format
    try {
      apiInstance.pvcer(pvcerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#pvcer");
