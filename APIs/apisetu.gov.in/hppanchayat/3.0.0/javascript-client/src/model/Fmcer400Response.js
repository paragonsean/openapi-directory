...
/**
 * The Fmcer400Response model module.
 * @module model/Fmcer400Response
 * @version 3.0.0
 */
class Fmcer400Response {
    /**
     * Constructs a new <code>Fmcer400Response</code>.
     * @alias module:model/Fmcer400Response
     */
    constructor() { 
        
        Fmcer400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Fmcer400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Fmcer400Response} obj Optional instance to populate.
     * @return {module:model/Fmcer400Response} The populated <code>Fmcer400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Fmcer400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Fmcer400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Fmcer400Response</code>.
     */
...
/**
 * @member {module:model/Fmcer400Response.ErrorEnum} error
 */
Fmcer400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Fmcer400Response.ErrorDescriptionEnum} errorDescription
 */
Fmcer400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Fmcer400Response['ErrorDescriptionEnum'] = {
...
export default Fmcer400Response;
