...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PanchayatiRajDepartmentHimachalPradeshHimachalPradesh.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new PanchayatiRajDepartmentHimachalPradeshHimachalPradesh.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(PanchayatiRajDepartmentHimachalPradeshHimachalPradesh.AcademicCertificateSchemaIssuedToPersonAddress);
    });
