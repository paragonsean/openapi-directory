...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/hppanchayat/v3");
    ...
    FmcerRequest fmcerRequest = new FmcerRequest(); // FmcerRequest | Request format
    try {
      apiInstance.fmcer(fmcerRequest);
