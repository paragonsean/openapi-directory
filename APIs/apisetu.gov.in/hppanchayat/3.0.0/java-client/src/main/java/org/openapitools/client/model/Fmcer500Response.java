...
public class Fmcer500Response {
  ...
  public Fmcer500Response() {
  }

  public Fmcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer500Response fmcer500Response = (Fmcer500Response) o;
    return Objects.equals(this.error, fmcer500Response.error) &&
        Objects.equals(this.errorDescription, fmcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer500Response is not found in the empty JSON string", Fmcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer500Response>() {
           @Override
           public void write(JsonWriter out, Fmcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer500Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer500Response
   */
  public static Fmcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer500Response.class);
  }

  /**
   * Convert an instance of Fmcer500Response to an JSON string
   *
   * @return JSON string
   */
