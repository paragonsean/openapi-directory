...
public class Fmcer404Response {
  ...
  public Fmcer404Response() {
  }

  public Fmcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer404Response fmcer404Response = (Fmcer404Response) o;
    return Objects.equals(this.error, fmcer404Response.error) &&
        Objects.equals(this.errorDescription, fmcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer404Response is not found in the empty JSON string", Fmcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer404Response>() {
           @Override
           public void write(JsonWriter out, Fmcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer404Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer404Response
   */
  public static Fmcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer404Response.class);
  }

  /**
   * Convert an instance of Fmcer404Response to an JSON string
   *
   * @return JSON string
   */
