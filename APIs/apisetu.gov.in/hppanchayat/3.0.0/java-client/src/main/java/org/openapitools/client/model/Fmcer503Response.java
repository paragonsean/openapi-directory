...
public class Fmcer503Response {
  ...
  public Fmcer503Response() {
  }

  public Fmcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer503Response fmcer503Response = (Fmcer503Response) o;
    return Objects.equals(this.error, fmcer503Response.error) &&
        Objects.equals(this.errorDescription, fmcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer503Response is not found in the empty JSON string", Fmcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer503Response>() {
           @Override
           public void write(JsonWriter out, Fmcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer503Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer503Response
   */
  public static Fmcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer503Response.class);
  }

  /**
   * Convert an instance of Fmcer503Response to an JSON string
   *
   * @return JSON string
   */
