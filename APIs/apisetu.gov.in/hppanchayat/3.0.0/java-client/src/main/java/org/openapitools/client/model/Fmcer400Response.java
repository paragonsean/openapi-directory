...
public class Fmcer400Response {
  ...
  public Fmcer400Response() {
  }

  public Fmcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer400Response fmcer400Response = (Fmcer400Response) o;
    return Objects.equals(this.error, fmcer400Response.error) &&
        Objects.equals(this.errorDescription, fmcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer400Response is not found in the empty JSON string", Fmcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer400Response>() {
           @Override
           public void write(JsonWriter out, Fmcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer400Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer400Response
   */
  public static Fmcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer400Response.class);
  }

  /**
   * Convert an instance of Fmcer400Response to an JSON string
   *
   * @return JSON string
   */
