...
public class Fmcer504Response {
  ...
  public Fmcer504Response() {
  }

  public Fmcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer504Response fmcer504Response = (Fmcer504Response) o;
    return Objects.equals(this.error, fmcer504Response.error) &&
        Objects.equals(this.errorDescription, fmcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer504Response is not found in the empty JSON string", Fmcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer504Response>() {
           @Override
           public void write(JsonWriter out, Fmcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer504Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer504Response
   */
  public static Fmcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer504Response.class);
  }

  /**
   * Convert an instance of Fmcer504Response to an JSON string
   *
   * @return JSON string
   */
