...
public class Fmcer401Response {
  ...
  public Fmcer401Response() {
  }

  public Fmcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer401Response fmcer401Response = (Fmcer401Response) o;
    return Objects.equals(this.error, fmcer401Response.error) &&
        Objects.equals(this.errorDescription, fmcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer401Response is not found in the empty JSON string", Fmcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer401Response>() {
           @Override
           public void write(JsonWriter out, Fmcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer401Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer401Response
   */
  public static Fmcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer401Response.class);
  }

  /**
   * Convert an instance of Fmcer401Response to an JSON string
   *
   * @return JSON string
   */
