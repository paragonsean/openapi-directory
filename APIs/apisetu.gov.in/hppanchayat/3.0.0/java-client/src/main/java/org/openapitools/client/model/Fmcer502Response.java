...
public class Fmcer502Response {
  ...
  public Fmcer502Response() {
  }

  public Fmcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Fmcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Fmcer502Response fmcer502Response = (Fmcer502Response) o;
    return Objects.equals(this.error, fmcer502Response.error) &&
        Objects.equals(this.errorDescription, fmcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Fmcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Fmcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fmcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Fmcer502Response is not found in the empty JSON string", Fmcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fmcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Fmcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Fmcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Fmcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Fmcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Fmcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Fmcer502Response>() {
           @Override
           public void write(JsonWriter out, Fmcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Fmcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Fmcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Fmcer502Response
   * @throws IOException if the JSON string is invalid with respect to Fmcer502Response
   */
  public static Fmcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Fmcer502Response.class);
  }

  /**
   * Convert an instance of Fmcer502Response to an JSON string
   *
   * @return JSON string
   */
