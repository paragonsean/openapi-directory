...
/*
 * OAIFmcer_404_response.h
 *
 * 
 */

#ifndef OAIFmcer_404_response_H
#define OAIFmcer_404_response_H
...
class OAIFmcer_404_response : public OAIObject {
public:
    OAIFmcer_404_response();
    OAIFmcer_404_response(QString json);
    ~OAIFmcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFmcer_404_response)

#endif // OAIFmcer_404_response_H
