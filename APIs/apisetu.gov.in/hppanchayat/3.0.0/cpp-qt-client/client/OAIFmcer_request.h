...
#ifndef OAIFmcer_request_H
#define OAIFmcer_request_H
...
namespace OpenAPI {
class OAIFmcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIFmcer_request : public OAIObject {
public:
    OAIFmcer_request();
    OAIFmcer_request(QString json);
    ~OAIFmcer_request() override;
    ...
    OAIFmcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIFmcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIFmcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFmcer_request)

#endif // OAIFmcer_request_H
