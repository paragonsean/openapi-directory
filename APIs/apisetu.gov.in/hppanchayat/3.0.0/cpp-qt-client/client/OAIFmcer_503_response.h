...
/*
 * OAIFmcer_503_response.h
 *
 * 
 */

#ifndef OAIFmcer_503_response_H
#define OAIFmcer_503_response_H
...
class OAIFmcer_503_response : public OAIObject {
public:
    OAIFmcer_503_response();
    OAIFmcer_503_response(QString json);
    ~OAIFmcer_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFmcer_503_response)

#endif // OAIFmcer_503_response_H
