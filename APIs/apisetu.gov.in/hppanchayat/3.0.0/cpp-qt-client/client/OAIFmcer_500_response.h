...
/*
 * OAIFmcer_500_response.h
 *
 * 
 */

#ifndef OAIFmcer_500_response_H
#define OAIFmcer_500_response_H
...
class OAIFmcer_500_response : public OAIObject {
public:
    OAIFmcer_500_response();
    OAIFmcer_500_response(QString json);
    ~OAIFmcer_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFmcer_500_response)

#endif // OAIFmcer_500_response_H
