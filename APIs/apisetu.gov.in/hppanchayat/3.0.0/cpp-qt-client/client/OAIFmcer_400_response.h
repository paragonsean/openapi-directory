...
/*
 * OAIFmcer_400_response.h
 *
 * 
 */

#ifndef OAIFmcer_400_response_H
#define OAIFmcer_400_response_H
...
class OAIFmcer_400_response : public OAIObject {
public:
    OAIFmcer_400_response();
    OAIFmcer_400_response(QString json);
    ~OAIFmcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFmcer_400_response)

#endif // OAIFmcer_400_response_H
