...
OAIFmcer_request::OAIFmcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFmcer_request::OAIFmcer_request() {
    this->initializeModel();
}

OAIFmcer_request::~OAIFmcer_request() {}

void OAIFmcer_request::initializeModel() {
...
void OAIFmcer_request::fromJson(QString jsonString) {
...
void OAIFmcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIFmcer_request::asJson() const {
...
QJsonObject OAIFmcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIFmcer_request_certificateParameters OAIFmcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIFmcer_request::setCertificateParameters(const OAIFmcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIFmcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIFmcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIFmcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIFmcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIFmcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIFmcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIFmcer_request::getFormat() const {
    return m_format;
}
void OAIFmcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIFmcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIFmcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIFmcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIFmcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIFmcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIFmcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIFmcer_request::isSet() const {
...
bool OAIFmcer_request::isValid() const {
