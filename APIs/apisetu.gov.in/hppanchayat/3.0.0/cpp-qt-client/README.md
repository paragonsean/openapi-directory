...
OAIFmcer_request Example::create(){
    OAIFmcer_request obj;
 return obj;
}
...
void Example::exampleFunction1(){
     OAIAPIsApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIAPIsApi::fmcerSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAPIsApi::fmcerSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAIFmcer_request oai_fmcer_request = create(); // OAIFmcer_request | Request format
      apiInstance.fmcer(oai_fmcer_request);
