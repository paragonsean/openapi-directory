...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheOrientalInsuranceCoLtd.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new TheOrientalInsuranceCoLtd.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(TheOrientalInsuranceCoLtd.ConsentArtifactSchemaConsentUser);
    });
