...
public class Delcs401Response {
  ...
  public Delcs401Response() {
  }

  public Delcs401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Delcs401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Delcs401Response delcs401Response = (Delcs401Response) o;
    return Objects.equals(this.error, delcs401Response.error) &&
        Objects.equals(this.errorDescription, delcs401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Delcs401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Delcs401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Delcs401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Delcs401Response is not found in the empty JSON string", Delcs401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Delcs401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Delcs401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Delcs401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Delcs401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Delcs401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Delcs401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Delcs401Response>() {
           @Override
           public void write(JsonWriter out, Delcs401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Delcs401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Delcs401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Delcs401Response
   * @throws IOException if the JSON string is invalid with respect to Delcs401Response
   */
  public static Delcs401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Delcs401Response.class);
  }

  /**
   * Convert an instance of Delcs401Response to an JSON string
   *
   * @return JSON string
   */
