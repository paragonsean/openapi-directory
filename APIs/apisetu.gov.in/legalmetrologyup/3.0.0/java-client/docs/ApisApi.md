...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/legalmetrologyup/v3");
    ...
    DelcsRequest delcsRequest = new DelcsRequest(); // DelcsRequest | Request format
    try {
      apiInstance.delcs(delcsRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#delcs");
...
public class Example {
  public static void main(String[] args) {
    ...
    DelcsRequest delcsRequest = new DelcsRequest(); // DelcsRequest | Request format
    try {
      apiInstance.malcs(delcsRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#malcs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DelcsRequest delcsRequest = new DelcsRequest(); // DelcsRequest | Request format
    try {
      apiInstance.palcs(delcsRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#palcs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    DelcsRequest delcsRequest = new DelcsRequest(); // DelcsRequest | Request format
    try {
      apiInstance.relcs(delcsRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#relcs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
