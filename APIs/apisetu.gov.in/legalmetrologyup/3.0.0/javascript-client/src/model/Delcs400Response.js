...
/**
 * The Delcs400Response model module.
 * @module model/Delcs400Response
 * @version 3.0.0
 */
class Delcs400Response {
    /**
     * Constructs a new <code>Delcs400Response</code>.
     * @alias module:model/Delcs400Response
     */
    constructor() { 
        
        Delcs400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Delcs400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Delcs400Response} obj Optional instance to populate.
     * @return {module:model/Delcs400Response} The populated <code>Delcs400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Delcs400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Delcs400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Delcs400Response</code>.
     */
...
/**
 * @member {module:model/Delcs400Response.ErrorEnum} error
 */
Delcs400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Delcs400Response.ErrorDescriptionEnum} errorDescription
 */
Delcs400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Delcs400Response['ErrorDescriptionEnum'] = {
...
export default Delcs400Response;
