...
/*
 * OAIDelcs_500_response.h
 *
 * 
 */

#ifndef OAIDelcs_500_response_H
#define OAIDelcs_500_response_H
...
class OAIDelcs_500_response : public OAIObject {
public:
    OAIDelcs_500_response();
    OAIDelcs_500_response(QString json);
    ~OAIDelcs_500_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDelcs_500_response)

#endif // OAIDelcs_500_response_H
