...
OAIDelcs_request::OAIDelcs_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDelcs_request::OAIDelcs_request() {
    this->initializeModel();
}

OAIDelcs_request::~OAIDelcs_request() {}

void OAIDelcs_request::initializeModel() {
...
void OAIDelcs_request::fromJson(QString jsonString) {
...
void OAIDelcs_request::fromJsonObject(QJsonObject json) {
...
QString OAIDelcs_request::asJson() const {
...
QJsonObject OAIDelcs_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDelcs_request_certificateParameters OAIDelcs_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDelcs_request::setCertificateParameters(const OAIDelcs_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDelcs_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDelcs_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDelcs_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDelcs_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDelcs_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDelcs_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDelcs_request::getFormat() const {
    return m_format;
}
void OAIDelcs_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDelcs_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDelcs_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDelcs_request::getTxnId() const {
    return m_txn_id;
}
void OAIDelcs_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDelcs_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDelcs_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDelcs_request::isSet() const {
...
bool OAIDelcs_request::isValid() const {
