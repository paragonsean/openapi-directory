...
/*
 * OAIDelcs_504_response.h
 *
 * 
 */

#ifndef OAIDelcs_504_response_H
#define OAIDelcs_504_response_H
...
class OAIDelcs_504_response : public OAIObject {
public:
    OAIDelcs_504_response();
    OAIDelcs_504_response(QString json);
    ~OAIDelcs_504_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDelcs_504_response)

#endif // OAIDelcs_504_response_H
