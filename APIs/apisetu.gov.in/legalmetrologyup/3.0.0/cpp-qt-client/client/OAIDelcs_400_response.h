...
/*
 * OAIDelcs_400_response.h
 *
 * 
 */

#ifndef OAIDelcs_400_response_H
#define OAIDelcs_400_response_H
...
class OAIDelcs_400_response : public OAIObject {
public:
    OAIDelcs_400_response();
    OAIDelcs_400_response(QString json);
    ~OAIDelcs_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDelcs_400_response)

#endif // OAIDelcs_400_response_H
