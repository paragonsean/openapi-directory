...
/*
 * OAIDelcs_503_response.h
 *
 * 
 */

#ifndef OAIDelcs_503_response_H
#define OAIDelcs_503_response_H
...
class OAIDelcs_503_response : public OAIObject {
public:
    OAIDelcs_503_response();
    OAIDelcs_503_response(QString json);
    ~OAIDelcs_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDelcs_503_response)

#endif // OAIDelcs_503_response_H
