...
/*
 * OAIDelcs_404_response.h
 *
 * 
 */

#ifndef OAIDelcs_404_response_H
#define OAIDelcs_404_response_H
...
class OAIDelcs_404_response : public OAIObject {
public:
    OAIDelcs_404_response();
    OAIDelcs_404_response(QString json);
    ~OAIDelcs_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDelcs_404_response)

#endif // OAIDelcs_404_response_H
