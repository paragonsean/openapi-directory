...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchema();
      //expect(instance).to.be.a(GeetanjaliUniversityUdaipur.ConsentArtifactSchema);
    });
