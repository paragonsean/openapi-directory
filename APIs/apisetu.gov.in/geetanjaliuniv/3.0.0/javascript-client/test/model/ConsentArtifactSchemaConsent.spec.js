...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsent();
  });
  ...
  describe('ConsentArtifactSchemaConsent', function() {
    it('should create an instance of ConsentArtifactSchemaConsent', function() {
      ...
      //var instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsent();
      //expect(instance).to.be.a(GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsent);
    });
