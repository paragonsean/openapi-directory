...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsentPermission);
    });
