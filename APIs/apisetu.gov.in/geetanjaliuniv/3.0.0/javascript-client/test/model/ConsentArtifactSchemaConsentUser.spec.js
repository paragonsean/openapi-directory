...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(GeetanjaliUniversityUdaipur.ConsentArtifactSchemaConsentUser);
    });
