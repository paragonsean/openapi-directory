...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeetanjaliUniversityUdaipur.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new GeetanjaliUniversityUdaipur.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(GeetanjaliUniversityUdaipur.AcademicCertificateSchemaCertificateData);
    });
