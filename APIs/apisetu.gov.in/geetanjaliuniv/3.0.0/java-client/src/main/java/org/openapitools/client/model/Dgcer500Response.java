...
public class Dgcer500Response {
  ...
  public Dgcer500Response() {
  }

  public Dgcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dgcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dgcer500Response dgcer500Response = (Dgcer500Response) o;
    return Objects.equals(this.error, dgcer500Response.error) &&
        Objects.equals(this.errorDescription, dgcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dgcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dgcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dgcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dgcer500Response is not found in the empty JSON string", Dgcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dgcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dgcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dgcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dgcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dgcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dgcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dgcer500Response>() {
           @Override
           public void write(JsonWriter out, Dgcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dgcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dgcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dgcer500Response
   * @throws IOException if the JSON string is invalid with respect to Dgcer500Response
   */
  public static Dgcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dgcer500Response.class);
  }

  /**
   * Convert an instance of Dgcer500Response to an JSON string
   *
   * @return JSON string
   */
