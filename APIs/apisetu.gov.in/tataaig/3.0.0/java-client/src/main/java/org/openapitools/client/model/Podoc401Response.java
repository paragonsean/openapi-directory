...
public class Podoc401Response {
  ...
  public Podoc401Response() {
  }

  public Podoc401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Podoc401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Podoc401Response podoc401Response = (Podoc401Response) o;
    return Objects.equals(this.error, podoc401Response.error) &&
        Objects.equals(this.errorDescription, podoc401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Podoc401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Podoc401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Podoc401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Podoc401Response is not found in the empty JSON string", Podoc401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Podoc401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Podoc401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Podoc401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Podoc401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Podoc401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Podoc401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Podoc401Response>() {
           @Override
           public void write(JsonWriter out, Podoc401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Podoc401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Podoc401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Podoc401Response
   * @throws IOException if the JSON string is invalid with respect to Podoc401Response
   */
  public static Podoc401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Podoc401Response.class);
  }

  /**
   * Convert an instance of Podoc401Response to an JSON string
   *
   * @return JSON string
   */
