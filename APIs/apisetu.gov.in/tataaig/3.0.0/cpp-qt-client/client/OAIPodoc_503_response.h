...
/*
 * OAIPodoc_503_response.h
 *
 * 
 */

#ifndef OAIPodoc_503_response_H
#define OAIPodoc_503_response_H
...
class OAIPodoc_503_response : public OAIObject {
public:
    OAIPodoc_503_response();
    OAIPodoc_503_response(QString json);
    ~OAIPodoc_503_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPodoc_503_response)

#endif // OAIPodoc_503_response_H
