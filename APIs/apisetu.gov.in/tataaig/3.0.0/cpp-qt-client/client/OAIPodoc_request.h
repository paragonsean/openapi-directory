...
#ifndef OAIPodoc_request_H
#define OAIPodoc_request_H
...
namespace OpenAPI {
class OAIPodoc_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIPodoc_request : public OAIObject {
public:
    OAIPodoc_request();
    OAIPodoc_request(QString json);
    ~OAIPodoc_request() override;
    ...
    OAIPodoc_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIPodoc_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIPodoc_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPodoc_request)

#endif // OAIPodoc_request_H
