...
/*
 * OAIPodoc_404_response.h
 *
 * 
 */

#ifndef OAIPodoc_404_response_H
#define OAIPodoc_404_response_H
...
class OAIPodoc_404_response : public OAIObject {
public:
    OAIPodoc_404_response();
    OAIPodoc_404_response(QString json);
    ~OAIPodoc_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPodoc_404_response)

#endif // OAIPodoc_404_response_H
