...
/**
 * The Podoc400Response model module.
 * @module model/Podoc400Response
 * @version 3.0.0
 */
class Podoc400Response {
    /**
     * Constructs a new <code>Podoc400Response</code>.
     * @alias module:model/Podoc400Response
     */
    constructor() { 
        
        Podoc400Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Podoc400Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Podoc400Response} obj Optional instance to populate.
     * @return {module:model/Podoc400Response} The populated <code>Podoc400Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Podoc400Response();
    ...
    /**
     * Validates the JSON data with respect to <code>Podoc400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Podoc400Response</code>.
     */
...
/**
 * @member {module:model/Podoc400Response.ErrorEnum} error
 */
Podoc400Response.prototype['error'] = undefined;

/**
 * @member {module:model/Podoc400Response.ErrorDescriptionEnum} errorDescription
 */
Podoc400Response.prototype['errorDescription'] = undefined;
 ...
 * @readonly
 */
Podoc400Response['ErrorDescriptionEnum'] = {
...
export default Podoc400Response;
