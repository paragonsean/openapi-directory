...
public:
    ...
    * @param[in]  oai_cripc_request OAICripc_request [optional]
    */
    virtual void mripc(const ::OpenAPI::OptionalParam<OAICripc_request> &oai_cripc_request = ::OpenAPI::OptionalParam<OAICripc_request>());

    /**
    * @param[in]  oai_cripc_request OAICripc_request [optional]
    */
    virtual void pripc(const ::OpenAPI::OptionalParam<OAICripc_request> &oai_cripc_request = ::OpenAPI::OptionalParam<OAICripc_request>());
...
private:
    ...
    void mripcCallback(OAIHttpRequestWorker *worker);
    void pripcCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void mripcSignalFull(OAIHttpRequestWorker *worker);
    void pripcSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use mripcSignalError() instead")
    void mripcSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void mripcSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use pripcSignalError() instead")
    void pripcSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void pripcSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use mripcSignalErrorFull() instead")
    void mripcSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void mripcSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use pripcSignalErrorFull() instead")
    void pripcSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pripcSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
