...
/*
 * OAICripc_400_response.h
 *
 * 
 */

#ifndef OAICripc_400_response_H
#define OAICripc_400_response_H
...
class OAICripc_400_response : public OAIObject {
public:
    OAICripc_400_response();
    OAICripc_400_response(QString json);
    ~OAICripc_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICripc_400_response)

#endif // OAICripc_400_response_H
