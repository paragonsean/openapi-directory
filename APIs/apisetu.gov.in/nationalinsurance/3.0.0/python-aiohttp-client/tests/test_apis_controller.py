...
async def test_cripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/cripc/certificate',
        headers=headers,
        json=body,
        )
...
async def test_cvipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/cvipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_egipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/egipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gicer(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/gicer/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hlipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/hlipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_hmipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/hmipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_miipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/miipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_mripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/mripc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pripc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/pripc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_twipc(client):
    ...
    response = await client.request(
        method='POST',
        path='/nationalinsurance/v3/twipc/certificate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
