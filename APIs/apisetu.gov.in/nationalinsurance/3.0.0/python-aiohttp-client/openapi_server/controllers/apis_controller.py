...
async def egipc(request: web.Request, body=None) -> web.Response:
...
async def mripc(request: web.Request, body=None) -> web.Response:
...
async def pripc(request: web.Request, body=None) -> web.Response:
