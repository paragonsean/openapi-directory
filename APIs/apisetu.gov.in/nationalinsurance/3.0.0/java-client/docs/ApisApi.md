...
public class Example {
  public static void main(String[] args) {
    ...
    CripcRequest cripcRequest = new CripcRequest(); // CripcRequest | Request format
    try {
      apiInstance.gicer(cripcRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#gicer");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CripcRequest cripcRequest = new CripcRequest(); // CripcRequest | Request format
    try {
      apiInstance.mripc(cripcRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#mripc");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    CripcRequest cripcRequest = new CripcRequest(); // CripcRequest | Request format
    try {
      apiInstance.pripc(cripcRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#pripc");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
