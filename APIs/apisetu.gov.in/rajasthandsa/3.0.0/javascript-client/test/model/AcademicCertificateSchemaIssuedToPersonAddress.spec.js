...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SocialJusticeAndEmpowermentDepartmentRajasthan.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new SocialJusticeAndEmpowermentDepartmentRajasthan.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(SocialJusticeAndEmpowermentDepartmentRajasthan.AcademicCertificateSchemaIssuedToPersonAddress);
    });
