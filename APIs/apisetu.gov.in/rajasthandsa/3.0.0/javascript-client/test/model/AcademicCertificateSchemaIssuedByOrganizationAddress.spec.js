...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SocialJusticeAndEmpowermentDepartmentRajasthan.AcademicCertificateSchemaIssuedByOrganizationAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedByOrganizationAddress', function() {
      ...
      //var instance = new SocialJusticeAndEmpowermentDepartmentRajasthan.AcademicCertificateSchemaIssuedByOrganizationAddress();
      //expect(instance).to.be.a(SocialJusticeAndEmpowermentDepartmentRajasthan.AcademicCertificateSchemaIssuedByOrganizationAddress);
    });
