...
/*
 * OAIDpicr_404_response.h
 *
 * 
 */

#ifndef OAIDpicr_404_response_H
#define OAIDpicr_404_response_H
...
class OAIDpicr_404_response : public OAIObject {
public:
    OAIDpicr_404_response();
    OAIDpicr_404_response(QString json);
    ~OAIDpicr_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDpicr_404_response)

#endif // OAIDpicr_404_response_H
