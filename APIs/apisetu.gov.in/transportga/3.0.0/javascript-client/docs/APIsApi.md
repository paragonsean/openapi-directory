# TransportDepartmentGoa.APIsApi
...
```javascript
import TransportDepartmentGoa from 'transport_department_goa';
let defaultClient = TransportDepartmentGoa.ApiClient.instance;
...
let apiInstance = new TransportDepartmentGoa.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentGoa.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentGoa.RvcerRequest() // RvcerRequest | Request format
};
