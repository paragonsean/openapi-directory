...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ncert.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new Ncert.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(Ncert.ConsentArtifactSchemaConsentPermission);
    });
