...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Ncert.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new Ncert.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(Ncert.AcademicCertificateSchemaCertificateData);
    });
