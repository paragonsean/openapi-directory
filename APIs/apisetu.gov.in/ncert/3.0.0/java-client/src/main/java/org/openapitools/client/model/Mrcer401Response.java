...
public class Mrcer401Response {
  ...
  public Mrcer401Response() {
  }

  public Mrcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Mrcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Mrcer401Response mrcer401Response = (Mrcer401Response) o;
    return Objects.equals(this.error, mrcer401Response.error) &&
        Objects.equals(this.errorDescription, mrcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Mrcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mrcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mrcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mrcer401Response is not found in the empty JSON string", Mrcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mrcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mrcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mrcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mrcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mrcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mrcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Mrcer401Response>() {
           @Override
           public void write(JsonWriter out, Mrcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mrcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mrcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mrcer401Response
   * @throws IOException if the JSON string is invalid with respect to Mrcer401Response
   */
  public static Mrcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mrcer401Response.class);
  }

  /**
   * Convert an instance of Mrcer401Response to an JSON string
   *
   * @return JSON string
   */
