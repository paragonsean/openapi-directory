...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://apisetu.gov.in/kotakgeneralinsurance/v3') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://apisetu.gov.in/kotakgeneralinsurance/v3
         */
        ...
        this.authentications = {
            'apiKey': {type: 'apiKey', 'in': 'header', name: 'X-APISETU-APIKEY'},
            'clientId': {type: 'apiKey', 'in': 'header', name: 'X-APISETU-CLIENTID'}
        }
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://apisetu.gov.in/kotakgeneralinsurance/v3",
