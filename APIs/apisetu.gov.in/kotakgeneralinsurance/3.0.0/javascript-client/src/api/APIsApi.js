...
export default class APIsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the gicer operation.
     * @callback module:api/APIsApi~gicerCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CripcRequest} [cripcRequest] Request format
     * @param {module:api/APIsApi~gicerCallback} callback The callback function, accepting three arguments: error, data, response
     */
    gicer(opts, callback) {
      opts = opts || {};
      let postBody = opts['cripcRequest'];
