...
public class Hpcer500Response {
  ...
  public Hpcer500Response() {
  }

  public Hpcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hpcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hpcer500Response hpcer500Response = (Hpcer500Response) o;
    return Objects.equals(this.error, hpcer500Response.error) &&
        Objects.equals(this.errorDescription, hpcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hpcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hpcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hpcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hpcer500Response is not found in the empty JSON string", Hpcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hpcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hpcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hpcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hpcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hpcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hpcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hpcer500Response>() {
           @Override
           public void write(JsonWriter out, Hpcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hpcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hpcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hpcer500Response
   * @throws IOException if the JSON string is invalid with respect to Hpcer500Response
   */
  public static Hpcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hpcer500Response.class);
  }

  /**
   * Convert an instance of Hpcer500Response to an JSON string
   *
   * @return JSON string
   */
