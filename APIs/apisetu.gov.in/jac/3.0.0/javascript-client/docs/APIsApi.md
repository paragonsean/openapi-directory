# JharkhandStateBoardJharkhandAcademicCouncilJharkhand.APIsApi
...
```javascript
import JharkhandStateBoardJharkhandAcademicCouncilJharkhand from 'jharkhand_state_board__jharkhand_academic_council_jharkhand';
let defaultClient = JharkhandStateBoardJharkhandAcademicCouncilJharkhand.ApiClient.instance;
...
let apiInstance = new JharkhandStateBoardJharkhandAcademicCouncilJharkhand.APIsApi();
let opts = {
