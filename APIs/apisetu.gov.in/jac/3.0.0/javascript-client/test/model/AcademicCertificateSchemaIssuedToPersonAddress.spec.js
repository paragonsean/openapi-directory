...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JharkhandStateBoardJharkhandAcademicCouncilJharkhand.AcademicCertificateSchemaIssuedToPersonAddress();
  });
  ...
  describe('AcademicCertificateSchemaIssuedToPersonAddress', function() {
    it('should create an instance of AcademicCertificateSchemaIssuedToPersonAddress', function() {
      ...
      //var instance = new JharkhandStateBoardJharkhandAcademicCouncilJharkhand.AcademicCertificateSchemaIssuedToPersonAddress();
      //expect(instance).to.be.a(JharkhandStateBoardJharkhandAcademicCouncilJharkhand.AcademicCertificateSchemaIssuedToPersonAddress);
    });
