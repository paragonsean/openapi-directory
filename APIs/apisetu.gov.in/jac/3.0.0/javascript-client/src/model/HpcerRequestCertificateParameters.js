...
class HpcerRequestCertificateParameters {
     ...
     * @param rollcode {String} Roll Code
     * @param rollno {String} Roll No
     * @param year {String} Year
     */
    constructor(fullName, rollcode, rollno, year) { 
        
        HpcerRequestCertificateParameters.initialize(this, fullName, rollcode, rollno, year);
    }
     ...
     */
    static initialize(obj, fullName, rollcode, rollno, year) { 
        obj['FullName'] = fullName;
        obj['rollcode'] = rollcode;
        obj['rollno'] = rollno;
        obj['year'] = year;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rollcode')) {
                obj['rollcode'] = ApiClient.convertToType(data['rollcode'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['rollcode'] && !(typeof data['rollcode'] === 'string' || data['rollcode'] instanceof String)) {
            throw new Error("Expected the field `rollcode` to be a primitive type in the JSON string but got " + data['rollcode']);
        }
        // ensure the json data is a string
...
HpcerRequestCertificateParameters.RequiredProperties = ["FullName", "rollcode", "rollno", "year"];
...
/**
 * Roll Code
 * @member {String} rollcode
 */
HpcerRequestCertificateParameters.prototype['rollcode'] = undefined;
