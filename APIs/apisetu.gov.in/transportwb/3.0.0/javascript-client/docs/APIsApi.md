# TransportDepartmentWestBengal.APIsApi
...
```javascript
import TransportDepartmentWestBengal from 'transport_department_west_bengal';
let defaultClient = TransportDepartmentWestBengal.ApiClient.instance;
...
let apiInstance = new TransportDepartmentWestBengal.APIsApi();
let opts = {
...
let apiInstance = new TransportDepartmentWestBengal.APIsApi();
let opts = {
  'rvcerRequest': new TransportDepartmentWestBengal.RvcerRequest() // RvcerRequest | Request format
};
