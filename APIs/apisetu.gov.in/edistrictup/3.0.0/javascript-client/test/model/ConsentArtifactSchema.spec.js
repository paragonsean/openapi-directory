...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchema();
  });
  ...
  describe('ConsentArtifactSchema', function() {
    it('should create an instance of ConsentArtifactSchema', function() {
      ...
      //var instance = new EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchema();
      //expect(instance).to.be.a(EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchema);
    });
