...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictUttarPradeshUttarPradesh.AcademicCertificateSchemaCertificateData();
  });
  ...
  describe('AcademicCertificateSchemaCertificateData', function() {
    it('should create an instance of AcademicCertificateSchemaCertificateData', function() {
      ...
      //var instance = new EDistrictUttarPradeshUttarPradesh.AcademicCertificateSchemaCertificateData();
      //expect(instance).to.be.a(EDistrictUttarPradeshUttarPradesh.AcademicCertificateSchemaCertificateData);
    });
