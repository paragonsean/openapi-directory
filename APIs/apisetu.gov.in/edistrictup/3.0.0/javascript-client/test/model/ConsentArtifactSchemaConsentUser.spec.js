...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchemaConsentUser();
  });
  ...
  describe('ConsentArtifactSchemaConsentUser', function() {
    it('should create an instance of ConsentArtifactSchemaConsentUser', function() {
      ...
      //var instance = new EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchemaConsentUser();
      //expect(instance).to.be.a(EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchemaConsentUser);
    });
