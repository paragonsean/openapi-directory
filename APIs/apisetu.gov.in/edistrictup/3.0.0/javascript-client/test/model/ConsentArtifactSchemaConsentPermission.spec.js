...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchemaConsentPermission();
  });
  ...
  describe('ConsentArtifactSchemaConsentPermission', function() {
    it('should create an instance of ConsentArtifactSchemaConsentPermission', function() {
      ...
      //var instance = new EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchemaConsentPermission();
      //expect(instance).to.be.a(EDistrictUttarPradeshUttarPradesh.ConsentArtifactSchemaConsentPermission);
    });
