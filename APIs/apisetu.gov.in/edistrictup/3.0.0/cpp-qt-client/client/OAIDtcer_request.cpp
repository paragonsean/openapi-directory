...
OAIDtcer_request::OAIDtcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDtcer_request::OAIDtcer_request() {
    this->initializeModel();
}

OAIDtcer_request::~OAIDtcer_request() {}

void OAIDtcer_request::initializeModel() {
...
void OAIDtcer_request::fromJson(QString jsonString) {
...
void OAIDtcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIDtcer_request::asJson() const {
...
QJsonObject OAIDtcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIBtcer_request_certificateParameters OAIDtcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDtcer_request::setCertificateParameters(const OAIBtcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDtcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDtcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDtcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDtcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDtcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDtcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDtcer_request::getFormat() const {
    return m_format;
}
void OAIDtcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDtcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDtcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDtcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIDtcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDtcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDtcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDtcer_request::isSet() const {
...
bool OAIDtcer_request::isValid() const {
