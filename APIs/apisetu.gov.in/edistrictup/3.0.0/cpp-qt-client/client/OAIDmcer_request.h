...
#ifndef OAIDmcer_request_H
#define OAIDmcer_request_H
...
namespace OpenAPI {
class OAIDmcer_request_certificateParameters;
class OAIConsentArtifactSchema;

class OAIDmcer_request : public OAIObject {
public:
    OAIDmcer_request();
    OAIDmcer_request(QString json);
    ~OAIDmcer_request() override;
    ...
    OAIDmcer_request_certificateParameters getCertificateParameters() const;
    void setCertificateParameters(const OAIDmcer_request_certificateParameters &certificate_parameters);
...
private:
    ...
    OAIDmcer_request_certificateParameters m_certificate_parameters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDmcer_request)

#endif // OAIDmcer_request_H
