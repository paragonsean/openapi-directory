...
OAIDmcer_request::OAIDmcer_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDmcer_request::OAIDmcer_request() {
    this->initializeModel();
}

OAIDmcer_request::~OAIDmcer_request() {}

void OAIDmcer_request::initializeModel() {
...
void OAIDmcer_request::fromJson(QString jsonString) {
...
void OAIDmcer_request::fromJsonObject(QJsonObject json) {
...
QString OAIDmcer_request::asJson() const {
...
QJsonObject OAIDmcer_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDmcer_request_certificateParameters OAIDmcer_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDmcer_request::setCertificateParameters(const OAIDmcer_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDmcer_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDmcer_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDmcer_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDmcer_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDmcer_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDmcer_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDmcer_request::getFormat() const {
    return m_format;
}
void OAIDmcer_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDmcer_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDmcer_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDmcer_request::getTxnId() const {
    return m_txn_id;
}
void OAIDmcer_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDmcer_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDmcer_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDmcer_request::isSet() const {
...
bool OAIDmcer_request::isValid() const {
