...
/*
 * OAIBtcer_400_response.h
 *
 * 
 */

#ifndef OAIBtcer_400_response_H
#define OAIBtcer_400_response_H
...
class OAIBtcer_400_response : public OAIObject {
public:
    OAIBtcer_400_response();
    OAIBtcer_400_response(QString json);
    ~OAIBtcer_400_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBtcer_400_response)

#endif // OAIBtcer_400_response_H
