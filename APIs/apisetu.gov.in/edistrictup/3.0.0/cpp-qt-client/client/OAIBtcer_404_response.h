...
/*
 * OAIBtcer_404_response.h
 *
 * 
 */

#ifndef OAIBtcer_404_response_H
#define OAIBtcer_404_response_H
...
class OAIBtcer_404_response : public OAIObject {
public:
    OAIBtcer_404_response();
    OAIBtcer_404_response(QString json);
    ~OAIBtcer_404_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBtcer_404_response)

#endif // OAIBtcer_404_response_H
