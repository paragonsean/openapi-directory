...
QString OAICtcer_request_certificateParameters::getApplicationNo() const {
    return m_application_no;
}
void OAICtcer_request_certificateParameters::setApplicationNo(const QString &application_no) {
    m_application_no = application_no;
    m_application_no_isSet = true;
}

bool OAICtcer_request_certificateParameters::is_application_no_Set() const{
    return m_application_no_isSet;
}

bool OAICtcer_request_certificateParameters::is_application_no_Valid() const{
    return m_application_no_isValid;
}

QString OAICtcer_request_certificateParameters::getCertificateId() const {
    return m_certificate_id;
}
void OAICtcer_request_certificateParameters::setCertificateId(const QString &certificate_id) {
    m_certificate_id = certificate_id;
    m_certificate_id_isSet = true;
}

bool OAICtcer_request_certificateParameters::is_certificate_id_Set() const{
    return m_certificate_id_isSet;
}

bool OAICtcer_request_certificateParameters::is_certificate_id_Valid() const{
