...
OAIDpicr_request::OAIDpicr_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDpicr_request::OAIDpicr_request() {
    this->initializeModel();
}

OAIDpicr_request::~OAIDpicr_request() {}

void OAIDpicr_request::initializeModel() {
...
void OAIDpicr_request::fromJson(QString jsonString) {
...
void OAIDpicr_request::fromJsonObject(QJsonObject json) {
...
QString OAIDpicr_request::asJson() const {
...
QJsonObject OAIDpicr_request::asJsonObject() const {
    QJsonObject obj;
...
OAIDpicr_request_certificateParameters OAIDpicr_request::getCertificateParameters() const {
    return m_certificate_parameters;
}
void OAIDpicr_request::setCertificateParameters(const OAIDpicr_request_certificateParameters &certificate_parameters) {
    m_certificate_parameters = certificate_parameters;
    m_certificate_parameters_isSet = true;
}

bool OAIDpicr_request::is_certificate_parameters_Set() const{
    return m_certificate_parameters_isSet;
}

bool OAIDpicr_request::is_certificate_parameters_Valid() const{
    return m_certificate_parameters_isValid;
}

OAIConsentArtifactSchema OAIDpicr_request::getConsentArtifact() const {
    return m_consent_artifact;
}
void OAIDpicr_request::setConsentArtifact(const OAIConsentArtifactSchema &consent_artifact) {
    m_consent_artifact = consent_artifact;
    m_consent_artifact_isSet = true;
}

bool OAIDpicr_request::is_consent_artifact_Set() const{
    return m_consent_artifact_isSet;
}

bool OAIDpicr_request::is_consent_artifact_Valid() const{
    return m_consent_artifact_isValid;
}

QString OAIDpicr_request::getFormat() const {
    return m_format;
}
void OAIDpicr_request::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIDpicr_request::is_format_Set() const{
    return m_format_isSet;
}

bool OAIDpicr_request::is_format_Valid() const{
    return m_format_isValid;
}

QString OAIDpicr_request::getTxnId() const {
    return m_txn_id;
}
void OAIDpicr_request::setTxnId(const QString &txn_id) {
    m_txn_id = txn_id;
    m_txn_id_isSet = true;
}

bool OAIDpicr_request::is_txn_id_Set() const{
    return m_txn_id_isSet;
}

bool OAIDpicr_request::is_txn_id_Valid() const{
    return m_txn_id_isValid;
}

bool OAIDpicr_request::isSet() const {
...
bool OAIDpicr_request::isValid() const {
