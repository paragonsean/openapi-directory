...
#ifndef OAIDtcer_request_H
#define OAIDtcer_request_H
...
class OAIDtcer_request : public OAIObject {
public:
    OAIDtcer_request();
    OAIDtcer_request(QString json);
    ~OAIDtcer_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDtcer_request)

#endif // OAIDtcer_request_H
