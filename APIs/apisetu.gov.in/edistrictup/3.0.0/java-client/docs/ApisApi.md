...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/edistrictup/v3");
...
public class Example {
  public static void main(String[] args) {
    ...
    ApisApi apiInstance = new ApisApi(defaultClient);
    DmcerRequest dmcerRequest = new DmcerRequest(); // DmcerRequest | Request format
    try {
      apiInstance.dmcer(dmcerRequest);
    } catch (ApiException e) {
