...
public class Btcer503Response {
  ...
  public Btcer503Response() {
  }

  public Btcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Btcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Btcer503Response btcer503Response = (Btcer503Response) o;
    return Objects.equals(this.error, btcer503Response.error) &&
        Objects.equals(this.errorDescription, btcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Btcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Btcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Btcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Btcer503Response is not found in the empty JSON string", Btcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Btcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Btcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Btcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Btcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Btcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Btcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Btcer503Response>() {
           @Override
           public void write(JsonWriter out, Btcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Btcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Btcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Btcer503Response
   * @throws IOException if the JSON string is invalid with respect to Btcer503Response
   */
  public static Btcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Btcer503Response.class);
  }

  /**
   * Convert an instance of Btcer503Response to an JSON string
   *
   * @return JSON string
   */
