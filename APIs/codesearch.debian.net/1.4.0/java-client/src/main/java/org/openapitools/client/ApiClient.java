...
public class ApiClient {
    ...
    private String basePath = "https://codesearch.debian.net/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "x-dcs-apikey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://codesearch.debian.net/api/v1
