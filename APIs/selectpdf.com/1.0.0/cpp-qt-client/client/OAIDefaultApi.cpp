...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://selectpdf.com/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("api2ConvertPost", defaultConf);
    _serverIndices.insert("api2ConvertPost", 0);
}
...
void OAIDefaultApi::api2ConvertPost(const ::OpenAPI::OptionalParam<OAIConversionParameters> &parameters) {
    QString fullPath = QString(_serverConfigs["api2ConvertPost"][_serverIndices.value("api2ConvertPost")].URL()+"/api2/convert");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::api2ConvertPostCallback);
...
void OAIDefaultApi::api2ConvertPostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT api2ConvertPostSignal();
        Q_EMIT api2ConvertPostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT api2ConvertPostSignalE(error_type, error_str);
        Q_EMIT api2ConvertPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT api2ConvertPostSignalError(error_type, error_str);
        Q_EMIT api2ConvertPostSignalErrorFull(worker, error_type, error_str);
    }
}
