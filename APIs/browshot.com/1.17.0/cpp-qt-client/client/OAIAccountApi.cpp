...
void OAIAccountApi::getAccountInfo(const ::OpenAPI::OptionalParam<qint32> &details) {
    QString fullPath = QString(_serverConfigs["getAccountInfo"][_serverIndices.value("getAccountInfo")].URL()+"/account/info");
