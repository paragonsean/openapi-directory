...
OAIAdministration::OAIAdministration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdministration::OAIAdministration() {
    this->initializeModel();
}

OAIAdministration::~OAIAdministration() {}

void OAIAdministration::initializeModel() {
...
void OAIAdministration::fromJson(QString jsonString) {
...
void OAIAdministration::fromJsonObject(QJsonObject json) {
...
QString OAIAdministration::asJson() const {
...
QJsonObject OAIAdministration::asJsonObject() const {
    QJsonObject obj;
    if (m_email_isSet) {
...
QString OAIAdministration::getEmail() const {
    return m_email;
}
void OAIAdministration::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIAdministration::is_email_Set() const{
    return m_email_isSet;
}

bool OAIAdministration::is_email_Valid() const{
    return m_email_isValid;
}

qint64 OAIAdministration::getId() const {
    return m_id;
}
void OAIAdministration::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIAdministration::is_id_Set() const{
    return m_id_isSet;
}

bool OAIAdministration::is_id_Valid() const{
    return m_id_isValid;
}

qint64 OAIAdministration::getLegalEntityId() const {
    return m_legal_entity_id;
}
void OAIAdministration::setLegalEntityId(const qint64 &legal_entity_id) {
    m_legal_entity_id = legal_entity_id;
    m_legal_entity_id_isSet = true;
}

bool OAIAdministration::is_legal_entity_id_Set() const{
    return m_legal_entity_id_isSet;
}

bool OAIAdministration::is_legal_entity_id_Valid() const{
    return m_legal_entity_id_isValid;
}

QString OAIAdministration::getPackageVersion() const {
    return m_package_version;
}
void OAIAdministration::setPackageVersion(const QString &package_version) {
    m_package_version = package_version;
    m_package_version_isSet = true;
}

bool OAIAdministration::is_package_version_Set() const{
    return m_package_version_isSet;
}

bool OAIAdministration::is_package_version_Valid() const{
    return m_package_version_isValid;
}

QString OAIAdministration::getPackaging() const {
    return m_packaging;
}
void OAIAdministration::setPackaging(const QString &packaging) {
    m_packaging = packaging;
    m_packaging_isSet = true;
}

bool OAIAdministration::is_packaging_Set() const{
    return m_packaging_isSet;
}

bool OAIAdministration::is_packaging_Valid() const{
    return m_packaging_isValid;
}

qint64 OAIAdministration::getSenderEmailIdentityId() const {
    return m_sender_email_identity_id;
}
void OAIAdministration::setSenderEmailIdentityId(const qint64 &sender_email_identity_id) {
    m_sender_email_identity_id = sender_email_identity_id;
    m_sender_email_identity_id_isSet = true;
}

bool OAIAdministration::is_sender_email_identity_id_Set() const{
    return m_sender_email_identity_id_isSet;
}

bool OAIAdministration::is_sender_email_identity_id_Valid() const{
    return m_sender_email_identity_id_isValid;
}

bool OAIAdministration::isSet() const {
...
bool OAIAdministration::isValid() const {
