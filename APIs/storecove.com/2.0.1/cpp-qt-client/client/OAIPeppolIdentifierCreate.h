...
/*
 * OAIPeppolIdentifierCreate.h
 *
 * 
 */

#ifndef OAIPeppolIdentifierCreate_H
#define OAIPeppolIdentifierCreate_H
...
namespace OpenAPI {
class OAICorpPassCreate;

class OAIPeppolIdentifierCreate : public OAIObject {
public:
    OAIPeppolIdentifierCreate();
    OAIPeppolIdentifierCreate(QString json);
    ~OAIPeppolIdentifierCreate() override;
    ...
    OAICorpPassCreate getCorppass() const;
    void setCorppass(const OAICorpPassCreate &corppass);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPeppolIdentifierCreate)

#endif // OAIPeppolIdentifierCreate_H
