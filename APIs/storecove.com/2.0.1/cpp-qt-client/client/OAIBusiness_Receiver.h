...
/*
 * OAIBusiness_Receiver.h
 *
 * The business receiver of the document.
 */

#ifndef OAIBusiness_Receiver_H
#define OAIBusiness_Receiver_H
...
class OAIBusiness_Receiver : public OAIObject {
public:
    OAIBusiness_Receiver();
    OAIBusiness_Receiver(QString json);
    ~OAIBusiness_Receiver() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBusiness_Receiver)

#endif // OAIBusiness_Receiver_H
