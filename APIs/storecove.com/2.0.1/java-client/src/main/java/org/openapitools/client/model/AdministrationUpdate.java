...
public class AdministrationUpdate {
  ...
  public AdministrationUpdate() {
  }

  public AdministrationUpdate email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AdministrationUpdate packageVersion(PackageVersionEnum packageVersion) {
  ...
  public AdministrationUpdate packaging(PackagingEnum packaging) {
  ...
  public AdministrationUpdate senderEmailIdentityId(Long senderEmailIdentityId) {
  ...
  public boolean equals(Object o) {
    ...
    AdministrationUpdate administrationUpdate = (AdministrationUpdate) o;
    return Objects.equals(this.email, administrationUpdate.email) &&
        Objects.equals(this.packageVersion, administrationUpdate.packageVersion) &&
        Objects.equals(this.packaging, administrationUpdate.packaging) &&
        Objects.equals(this.senderEmailIdentityId, administrationUpdate.senderEmailIdentityId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, packageVersion, packaging, senderEmailIdentityId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdministrationUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdministrationUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdministrationUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdministrationUpdate is not found in the empty JSON string", AdministrationUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdministrationUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdministrationUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdministrationUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdministrationUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdministrationUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdministrationUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<AdministrationUpdate>() {
           @Override
           public void write(JsonWriter out, AdministrationUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdministrationUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdministrationUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdministrationUpdate
   * @throws IOException if the JSON string is invalid with respect to AdministrationUpdate
   */
  public static AdministrationUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdministrationUpdate.class);
  }

  /**
   * Convert an instance of AdministrationUpdate to an JSON string
   *
   * @return JSON string
   */
