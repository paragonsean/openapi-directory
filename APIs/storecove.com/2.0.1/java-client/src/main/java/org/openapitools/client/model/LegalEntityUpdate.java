...
public class LegalEntityUpdate {
  ...
  public LegalEntityUpdate advertisements(List<AdvertisementsEnum> advertisements) {
    this.advertisements = advertisements;
    return this;
  }

  public LegalEntityUpdate addAdvertisementsItem(AdvertisementsEnum advertisementsItem) {
  ...
  public LegalEntityUpdate city(String city) {
    this.city = city;
    return this;
  }
  ...
  public LegalEntityUpdate country(Country country) {
  ...
  public LegalEntityUpdate county(String county) {
    this.county = county;
    return this;
  }
  ...
  public LegalEntityUpdate id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public LegalEntityUpdate line1(String line1) {
    this.line1 = line1;
    return this;
  }
  ...
  public LegalEntityUpdate line2(String line2) {
    this.line2 = line2;
    return this;
  }
  ...
  public LegalEntityUpdate partyName(String partyName) {
  ...
  public LegalEntityUpdate _public(Boolean _public) {
  ...
  public LegalEntityUpdate rea(Rea rea) {
    this.rea = rea;
    return this;
  }
  ...
  public LegalEntityUpdate smartInbox(String smartInbox) {
  ...
  public LegalEntityUpdate tenantId(String tenantId) {
  ...
  public LegalEntityUpdate thirdPartyPassword(String thirdPartyPassword) {
  ...
  public LegalEntityUpdate thirdPartyUsername(String thirdPartyUsername) {
  ...
  public LegalEntityUpdate zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LegalEntityUpdate legalEntityUpdate = (LegalEntityUpdate) o;
    return Objects.equals(this.advertisements, legalEntityUpdate.advertisements) &&
        Objects.equals(this.city, legalEntityUpdate.city) &&
        Objects.equals(this.country, legalEntityUpdate.country) &&
        Objects.equals(this.county, legalEntityUpdate.county) &&
        Objects.equals(this.id, legalEntityUpdate.id) &&
        Objects.equals(this.line1, legalEntityUpdate.line1) &&
        Objects.equals(this.line2, legalEntityUpdate.line2) &&
        Objects.equals(this.partyName, legalEntityUpdate.partyName) &&
        Objects.equals(this._public, legalEntityUpdate._public) &&
        Objects.equals(this.rea, legalEntityUpdate.rea) &&
        Objects.equals(this.smartInbox, legalEntityUpdate.smartInbox) &&
        Objects.equals(this.tenantId, legalEntityUpdate.tenantId) &&
        Objects.equals(this.thirdPartyPassword, legalEntityUpdate.thirdPartyPassword) &&
        Objects.equals(this.thirdPartyUsername, legalEntityUpdate.thirdPartyUsername) &&
        Objects.equals(this.zip, legalEntityUpdate.zip);
  }

  @Override
  public int hashCode() {
    return Objects.hash(advertisements, city, country, county, id, line1, line2, partyName, _public, rea, smartInbox, tenantId, thirdPartyPassword, thirdPartyUsername, zip);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LegalEntityUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LegalEntityUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LegalEntityUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LegalEntityUpdate is not found in the empty JSON string", LegalEntityUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegalEntityUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegalEntityUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LegalEntityUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LegalEntityUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LegalEntityUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LegalEntityUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<LegalEntityUpdate>() {
           @Override
           public void write(JsonWriter out, LegalEntityUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LegalEntityUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LegalEntityUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LegalEntityUpdate
   * @throws IOException if the JSON string is invalid with respect to LegalEntityUpdate
   */
  public static LegalEntityUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LegalEntityUpdate.class);
  }

  /**
   * Convert an instance of LegalEntityUpdate to an JSON string
   *
   * @return JSON string
   */
