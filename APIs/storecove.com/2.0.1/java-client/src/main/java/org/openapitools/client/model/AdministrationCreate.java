...
public class AdministrationCreate {
  ...
  private PackageVersionEnum packageVersion = PackageVersionEnum.PEPPOL_BIS_V3;
  ...
  private PackagingEnum packaging = PackagingEnum.UBL;
  ...
  public AdministrationCreate() {
  }

  public AdministrationCreate email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AdministrationCreate legalEntityId(Long legalEntityId) {
  ...
  public AdministrationCreate packageVersion(PackageVersionEnum packageVersion) {
  ...
  public AdministrationCreate packaging(PackagingEnum packaging) {
  ...
  public AdministrationCreate senderEmailIdentityId(Long senderEmailIdentityId) {
  ...
  public boolean equals(Object o) {
    ...
    AdministrationCreate administrationCreate = (AdministrationCreate) o;
    return Objects.equals(this.email, administrationCreate.email) &&
        Objects.equals(this.legalEntityId, administrationCreate.legalEntityId) &&
        Objects.equals(this.packageVersion, administrationCreate.packageVersion) &&
        Objects.equals(this.packaging, administrationCreate.packaging) &&
        Objects.equals(this.senderEmailIdentityId, administrationCreate.senderEmailIdentityId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, legalEntityId, packageVersion, packaging, senderEmailIdentityId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdministrationCreate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdministrationCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdministrationCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdministrationCreate is not found in the empty JSON string", AdministrationCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdministrationCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdministrationCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdministrationCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdministrationCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdministrationCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdministrationCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<AdministrationCreate>() {
           @Override
           public void write(JsonWriter out, AdministrationCreate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdministrationCreate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdministrationCreate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdministrationCreate
   * @throws IOException if the JSON string is invalid with respect to AdministrationCreate
   */
  public static AdministrationCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdministrationCreate.class);
  }

  /**
   * Convert an instance of AdministrationCreate to an JSON string
   *
   * @return JSON string
   */
