...
|**allowPartialDelivery** | **Boolean** | Whether or not the line items must be delivered in a single shipment. |  [optional] |
|**allowanceCharges** | [**List&lt;LineAllowanceCharge&gt;**](LineAllowanceCharge.md) | An array of allowance charges. |  [optional] |
|**amountExcludingTax** | **BigDecimal** | The amount excluding tax. Should equal quantity x itemPrice + allowanceCharge. |  |
|**baseQuantity** | **BigDecimal** | The number of items the price is for. |  [optional] |
...
|**lotNumberIds** | **List&lt;String&gt;** | An identifier for the production lot which the line items come from. |  [optional] |
|**name** | **String** | A short name for this line. |  [optional] |
|**note** | **String** | A note to add to the line |  [optional] |
|**quantity** | **BigDecimal** | The number of items (may be fractional). |  |
