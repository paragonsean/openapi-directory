...
/**
 * The LegalEntityUpdate model module.
 * @module model/LegalEntityUpdate
 * @version 2.0.1
 */
class LegalEntityUpdate {
    /**
     * Constructs a new <code>LegalEntityUpdate</code>.
     * @alias module:model/LegalEntityUpdate
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>LegalEntityUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LegalEntityUpdate} obj Optional instance to populate.
     * @return {module:model/LegalEntityUpdate} The populated <code>LegalEntityUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LegalEntityUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>LegalEntityUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LegalEntityUpdate</code>.
     */
 ...
 * @readonly
 */
LegalEntityUpdate['AdvertisementsEnum'] = {
