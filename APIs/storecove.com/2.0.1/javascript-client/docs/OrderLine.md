# StorecoveApi.OrderLine

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**accountingCost** | **String** | The buyer&#39;s accounting cost centre for this line. | [optional] 
...
**allowPartialDelivery** | **Boolean** | Whether or not the line items must be delivered in a single shipment. | [optional] [default to false]
**allowanceCharges** | [**[LineAllowanceCharge]**](LineAllowanceCharge.md) | An array of allowance charges. | [optional] 
**amountExcludingTax** | **Number** | The amount excluding tax. Should equal quantity x itemPrice + allowanceCharge. | 
**baseQuantity** | **Number** | The number of items the price is for. | [optional] [default to 1]
**delivery** | [**LineDelivery**](LineDelivery.md) |  | [optional] 
**description** | **String** | The description for this line. | [optional] 
**itemPrice** | **Number** | The price per item (may be fractional) | [optional] [default to 1]
**lineId** | **String** | The id for this invoice line. | 
**lotNumberIds** | **[String]** | An identifier for the production lot which the line items come from. | [optional] 
**name** | **String** | A short name for this line. | [optional] 
**note** | **String** | A note to add to the line | [optional] 
**quantity** | **Number** | The number of items (may be fractional). | [default to 1]
