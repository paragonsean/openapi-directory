...
------------ | ------------- | ------------- | -------------
**attachments** | [**[Attachment]**](Attachment.md) | An array of attachments. You may provide up to 10 attchments, but the total size must not exceed 10MB after Base64 encoding. | [optional] 
...
**documentUrl** | **String** | DEPRECATED. Use attachments. | [optional] 
...
**legalEntityId** | **Number** | The id of the LegalEntity this invoice should be sent for. | [optional] 
**legalSupplierId** | **Number** | DEPRECATED. Use legalEntityId | [optional] 
**mode** | **String** | DEPRECATED. | [optional] 
**routing** | [**Routing**](Routing.md) |  | [optional] 
**supplierId** | **Number** | DEPRECATED. | [optional] 
