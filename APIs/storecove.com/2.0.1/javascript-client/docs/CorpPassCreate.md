...
**enabled** | **Boolean** | DEPRECATED. Whether or not to enable the CorpPass flow. Must be true if provided. | [optional] [default to true]
**flowType** | **String** | The CorpPass flow type. | 
