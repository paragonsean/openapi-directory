...
**id** | **Number** | The Storecove assigned id for the LegalEntity. | [optional] 
...
**additionalTaxIdentifiers** | [**[AdditionalTaxIdentifier]**](AdditionalTaxIdentifier.md) |  | [optional] 
