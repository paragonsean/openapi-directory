...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.DocumentSubmissionEvidenceDocument();
  });
  ...
  describe('DocumentSubmissionEvidenceDocument', function() {
    it('should create an instance of DocumentSubmissionEvidenceDocument', function() {
      // uncomment below and update the code to test DocumentSubmissionEvidenceDocument
      //var instance = new StorecoveApi.DocumentSubmissionEvidenceDocument();
      //expect(instance).to.be.a(StorecoveApi.DocumentSubmissionEvidenceDocument);
    });
