...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.InvoiceSubmission();
  });
  ...
  describe('InvoiceSubmission', function() {
    it('should create an instance of InvoiceSubmission', function() {
      // uncomment below and update the code to test InvoiceSubmission
      //var instance = new StorecoveApi.InvoiceSubmission();
      //expect(instance).to.be.a(StorecoveApi.InvoiceSubmission);
    });
    ...
    it('should have the property legalSupplierId (base name: "legalSupplierId")', function() {
      // uncomment below and update the code to test the property legalSupplierId
      //var instance = new StorecoveApi.InvoiceSubmission();
      //expect(instance).to.be();
    });
