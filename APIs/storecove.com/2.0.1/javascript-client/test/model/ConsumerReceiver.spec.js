...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.ConsumerReceiver();
  });
  ...
  describe('ConsumerReceiver', function() {
    it('should create an instance of ConsumerReceiver', function() {
      // uncomment below and update the code to test ConsumerReceiver
      //var instance = new StorecoveApi.ConsumerReceiver();
      //expect(instance).to.be.a(StorecoveApi.ConsumerReceiver);
    });
