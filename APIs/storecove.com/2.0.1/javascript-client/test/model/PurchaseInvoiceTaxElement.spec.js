...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.PurchaseInvoiceTaxElement();
  });
  ...
  describe('PurchaseInvoiceTaxElement', function() {
    it('should create an instance of PurchaseInvoiceTaxElement', function() {
      // uncomment below and update the code to test PurchaseInvoiceTaxElement
      //var instance = new StorecoveApi.PurchaseInvoiceTaxElement();
      //expect(instance).to.be.a(StorecoveApi.PurchaseInvoiceTaxElement);
    });
