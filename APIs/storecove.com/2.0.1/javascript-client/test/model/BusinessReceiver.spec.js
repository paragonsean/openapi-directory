...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.BusinessReceiver();
  });
  ...
  describe('BusinessReceiver', function() {
    it('should create an instance of BusinessReceiver', function() {
      // uncomment below and update the code to test BusinessReceiver
      //var instance = new StorecoveApi.BusinessReceiver();
      //expect(instance).to.be.a(StorecoveApi.BusinessReceiver);
    });
