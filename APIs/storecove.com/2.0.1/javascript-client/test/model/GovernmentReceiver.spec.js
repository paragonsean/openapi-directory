...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.GovernmentReceiver();
  });
  ...
  describe('GovernmentReceiver', function() {
    it('should create an instance of GovernmentReceiver', function() {
      // uncomment below and update the code to test GovernmentReceiver
      //var instance = new StorecoveApi.GovernmentReceiver();
      //expect(instance).to.be.a(StorecoveApi.GovernmentReceiver);
    });
