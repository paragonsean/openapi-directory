...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StorecoveApi.ReceivedDocumentsApi();
  });
  ...
  describe('ReceivedDocumentsApi', function() {
    ...
    describe('receiveDocument', function() {
      it('should call receiveDocument successfully', function(done) {
        //uncomment below and update the code to test receiveDocument
        //instance.receiveDocument(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
