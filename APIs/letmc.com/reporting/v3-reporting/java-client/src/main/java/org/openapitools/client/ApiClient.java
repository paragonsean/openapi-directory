...
public class ApiClient {
    ...
    private String basePath = "https://live-api.letmc.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v3-reporting/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://live-api.letmc.com
