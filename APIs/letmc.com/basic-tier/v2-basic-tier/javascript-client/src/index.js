...
import ViewingControllerApi from './api/ViewingControllerApi';
...
* <pre>
* var LetMcApiV2BasicTier2 = require('index'); // See note below*.
* var xxxSvc = new LetMcApiV2BasicTier2.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new LetMcApiV2BasicTier2.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new LetMcApiV2BasicTier2.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new LetMcApiV2BasicTier2.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
export {
    ...
    /**
     * The ViewingBookingModel model constructor.
     * @property {module:model/ViewingBookingModel}
     */
    ViewingBookingModel,
    ...
    */
    ...
    /**
    * The ViewingControllerApi service constructor.
    * @property {module:api/ViewingControllerApi}
    */
