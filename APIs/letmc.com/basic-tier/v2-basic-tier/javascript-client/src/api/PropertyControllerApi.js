    ...
    */
    ...
    propertyControllerGetPropertiesFacilities(shortName, propertyID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/property/properties/{propertyID}/facilities', 'GET',
    ...
    propertyControllerGetPropertiesPhotos(shortName, propertyID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/property/properties/{propertyID}/photos', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    propertyControllerGetPropertiesRooms(shortName, propertyID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/property/properties/{propertyID}/rooms', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    propertyControllerGetPropertiesTenancies(shortName, propertyID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/property/properties/{propertyID}/tenancies', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    propertyControllerGetPropertyEERDownload(shortName, propertyStructureID, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/property/structures/{propertyStructureID}/reports/eer', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    propertyControllerGetPropertyEIRDownload(shortName, propertyStructureID, callback) {
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/property/structures/{propertyStructureID}/reports/eir', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNamePropertyPropertiesGet operation.
     * @callback module:api/PropertyControllerApi~v2Tier2ShortNamePropertyPropertiesGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} offset The index of the first item to return
     * @param {Number} count The maximum number of items to return (up to 1000 per request)
     * @param {module:api/PropertyControllerApi~v2Tier2ShortNamePropertyPropertiesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PropertyModelResults}
     */
    v2Tier2ShortNamePropertyPropertiesGet(shortName, offset, count, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNamePropertyPropertiesGet");
      }
      // verify the required parameter 'offset' is set
      if (offset === undefined || offset === null) {
        throw new Error("Missing the required parameter 'offset' when calling v2Tier2ShortNamePropertyPropertiesGet");
      }
      // verify the required parameter 'count' is set
      if (count === undefined || count === null) {
        throw new Error("Missing the required parameter 'count' when calling v2Tier2ShortNamePropertyPropertiesGet");
      }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNamePropertyPropertiesPropertyIDGet operation.
     * @callback module:api/PropertyControllerApi~v2Tier2ShortNamePropertyPropertiesPropertyIDGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} shortName The unique client short-name
     * @param {String} propertyID The unique ID of the Property
     * @param {module:api/PropertyControllerApi~v2Tier2ShortNamePropertyPropertiesPropertyIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PropertyModel}
     */
    v2Tier2ShortNamePropertyPropertiesPropertyIDGet(shortName, propertyID, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNamePropertyPropertiesPropertyIDGet");
      }
      // verify the required parameter 'propertyID' is set
      if (propertyID === undefined || propertyID === null) {
        throw new Error("Missing the required parameter 'propertyID' when calling v2Tier2ShortNamePropertyPropertiesPropertyIDGet");
      }
