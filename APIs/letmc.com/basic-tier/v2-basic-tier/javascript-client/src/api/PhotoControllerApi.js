    ...
    */
    ...
    photoControllerGetPhotoDownload(shortName, photoID, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/photos/photo/{photoID}/download', 'GET',
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNamePhotoPhotosGet operation.
     * @callback module:api/PhotoControllerApi~v2Tier2ShortNamePhotoPhotosGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PhotoControllerApi~v2Tier2ShortNamePhotoPhotosGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PhotoModelResults}
     */
    v2Tier2ShortNamePhotoPhotosGet(shortName, offset, count, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNamePhotoPhotosGet");
      }
      // verify the required parameter 'offset' is set
      if (offset === undefined || offset === null) {
        throw new Error("Missing the required parameter 'offset' when calling v2Tier2ShortNamePhotoPhotosGet");
      }
      // verify the required parameter 'count' is set
      if (count === undefined || count === null) {
        throw new Error("Missing the required parameter 'count' when calling v2Tier2ShortNamePhotoPhotosGet");
      }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNamePhotoPhotosPhotoIDGet operation.
     * @callback module:api/PhotoControllerApi~v2Tier2ShortNamePhotoPhotosPhotoIDGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PhotoControllerApi~v2Tier2ShortNamePhotoPhotosPhotoIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PhotoModel}
     */
    v2Tier2ShortNamePhotoPhotosPhotoIDGet(shortName, photoID, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNamePhotoPhotosPhotoIDGet");
      }
      // verify the required parameter 'photoID' is set
      if (photoID === undefined || photoID === null) {
        throw new Error("Missing the required parameter 'photoID' when calling v2Tier2ShortNamePhotoPhotosPhotoIDGet");
      }
