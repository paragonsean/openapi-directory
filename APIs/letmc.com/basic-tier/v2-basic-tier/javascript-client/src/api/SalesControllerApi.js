    ...
    */
    ...
    salesControllerGetAdvertisedSales(shortName, branchID, offset, count, onlyDevelopement, onlyInvestements, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/advertisedsales', 'GET',
    ...
    salesControllerGetEER(shortName, salesInstructionID, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/reports/eer/{salesInstructionID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    salesControllerGetEIR(shortName, salesInstructionID, callback) {
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/reports/eir/{salesInstructionID}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    salesControllerGetSalesInstructionsFeatures(shortName, salesInstructionID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/salesinstructions/{salesInstructionID}/features', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    salesControllerGetSalesInstructionsFloorPlans(shortName, salesInstructionID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/salesinstructions/{salesInstructionID}/floorplans', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    salesControllerGetSalesInstructionsPhotos(shortName, salesInstructionID, offset, count, callback) {
      ...
      let returnType = PhotoModelResults;
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/salesinstructions/{salesInstructionID}/photos', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    salesControllerGetSalesInstructionsRooms(shortName, salesInstructionID, offset, count, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier2/{shortName}/sales/salesinstructions/{salesInstructionID}/rooms', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNameSalesSalesfeaturetypesGet operation.
     * @callback module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesfeaturetypesGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} offset The index of the first item to return
     * @param {Number} count The maximum number of items to return (up to 1000 per request)
     * @param {module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesfeaturetypesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesFeatureTypeModelResults}
     */
    v2Tier2ShortNameSalesSalesfeaturetypesGet(shortName, offset, count, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNameSalesSalesfeaturetypesGet");
      }
      // verify the required parameter 'offset' is set
      if (offset === undefined || offset === null) {
        throw new Error("Missing the required parameter 'offset' when calling v2Tier2ShortNameSalesSalesfeaturetypesGet");
      }
      // verify the required parameter 'count' is set
      if (count === undefined || count === null) {
        throw new Error("Missing the required parameter 'count' when calling v2Tier2ShortNameSalesSalesfeaturetypesGet");
      }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet operation.
     * @callback module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesFeatureTypeModel}
     */
    v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet(shortName, salesFeatureTypeID, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet");
      }
      // verify the required parameter 'salesFeatureTypeID' is set
      if (salesFeatureTypeID === undefined || salesFeatureTypeID === null) {
        throw new Error("Missing the required parameter 'salesFeatureTypeID' when calling v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet");
      }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNameSalesSalesinstructionsGet operation.
     * @callback module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesinstructionsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SalesInstructionModelResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} offset The index of the first item to return
     * @param {Number} count The maximum number of items to return (up to 1000 per request)
     * @param {module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesinstructionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesInstructionModelResults}
     */
    v2Tier2ShortNameSalesSalesinstructionsGet(shortName, offset, count, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNameSalesSalesinstructionsGet");
      }
      // verify the required parameter 'offset' is set
      if (offset === undefined || offset === null) {
        throw new Error("Missing the required parameter 'offset' when calling v2Tier2ShortNameSalesSalesinstructionsGet");
      }
      // verify the required parameter 'count' is set
      if (count === undefined || count === null) {
        throw new Error("Missing the required parameter 'count' when calling v2Tier2ShortNameSalesSalesinstructionsGet");
      }
    ...
    /**
     * Callback function to receive the result of the v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet operation.
     * @callback module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} shortName The unique client short-name
     * @param {String} salesInstructionID The unique ID of the SalesInstruction
     * @param {module:api/SalesControllerApi~v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SalesInstructionModel}
     */
    v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet(shortName, salesInstructionID, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet");
      }
      // verify the required parameter 'salesInstructionID' is set
      if (salesInstructionID === undefined || salesInstructionID === null) {
        throw new Error("Missing the required parameter 'salesInstructionID' when calling v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet");
      }
