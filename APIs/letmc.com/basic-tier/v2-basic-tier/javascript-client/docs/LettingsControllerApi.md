# LetMcApiV2BasicTier2.LettingsControllerApi
...
let apiInstance = new LetMcApiV2BasicTier2.LettingsControllerApi();
...
let offset = 56; // Number | The index of the first item to return
let count = 56; // Number | The maximum number of items to return (up to 1000 per request)
apiInstance.v2Tier2ShortNameLettingsTenanciesGet(shortName, offset, count, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let shortName = "shortName_example"; // String | The unique client short-name
let tenancyID = "tenancyID_example"; // String | The unique ID of the Tenancy
apiInstance.v2Tier2ShortNameLettingsTenanciesTenancyIDGet(shortName, tenancyID, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
