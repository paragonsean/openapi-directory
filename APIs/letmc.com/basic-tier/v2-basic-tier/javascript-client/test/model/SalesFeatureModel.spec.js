...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.SalesFeatureModel();
  });
  ...
  describe('SalesFeatureModel', function() {
    it('should create an instance of SalesFeatureModel', function() {
      ...
      //var instance = new LetMcApiV2BasicTier2.SalesFeatureModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.SalesFeatureModel);
    });
