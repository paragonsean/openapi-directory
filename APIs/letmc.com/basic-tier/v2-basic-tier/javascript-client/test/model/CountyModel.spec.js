...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.CountyModel();
  });
  ...
  describe('CountyModel', function() {
    it('should create an instance of CountyModel', function() {
      // uncomment below and update the code to test CountyModel
      //var instance = new LetMcApiV2BasicTier2.CountyModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.CountyModel);
    });
