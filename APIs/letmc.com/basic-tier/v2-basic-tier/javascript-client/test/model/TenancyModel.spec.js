...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.TenancyModel();
  });
  ...
  describe('TenancyModel', function() {
    it('should create an instance of TenancyModel', function() {
      ...
      //var instance = new LetMcApiV2BasicTier2.TenancyModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.TenancyModel);
    });
