...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.DiaryAllocationModel();
  });
  ...
  describe('DiaryAllocationModel', function() {
    it('should create an instance of DiaryAllocationModel', function() {
      ...
      //var instance = new LetMcApiV2BasicTier2.DiaryAllocationModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.DiaryAllocationModel);
    });
