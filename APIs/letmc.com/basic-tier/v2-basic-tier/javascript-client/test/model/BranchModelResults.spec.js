...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.BranchModelResults();
  });
  ...
  describe('BranchModelResults', function() {
    it('should create an instance of BranchModelResults', function() {
      ...
      //var instance = new LetMcApiV2BasicTier2.BranchModelResults();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.BranchModelResults);
    });
