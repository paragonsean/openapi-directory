...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.PropertyModel();
  });
  ...
  describe('PropertyModel', function() {
    it('should create an instance of PropertyModel', function() {
      ...
      //var instance = new LetMcApiV2BasicTier2.PropertyModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.PropertyModel);
    });
