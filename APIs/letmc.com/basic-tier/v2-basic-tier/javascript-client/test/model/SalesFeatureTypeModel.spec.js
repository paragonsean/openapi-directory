...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.SalesFeatureTypeModel();
  });
  ...
  describe('SalesFeatureTypeModel', function() {
    it('should create an instance of SalesFeatureTypeModel', function() {
      // uncomment below and update the code to test SalesFeatureTypeModel
      //var instance = new LetMcApiV2BasicTier2.SalesFeatureTypeModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.SalesFeatureTypeModel);
    });
