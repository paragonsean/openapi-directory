...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2BasicTier2.BranchModel();
  });
  ...
  describe('BranchModel', function() {
    it('should create an instance of BranchModel', function() {
      ...
      //var instance = new LetMcApiV2BasicTier2.BranchModel();
      //expect(instance).to.be.a(LetMcApiV2BasicTier2.BranchModel);
    });
