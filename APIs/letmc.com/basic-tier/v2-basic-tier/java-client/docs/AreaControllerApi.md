...
<a id="v2Tier2ShortNameAreaAreasAreaIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AreaModel result = apiInstance.v2Tier2ShortNameAreaAreasAreaIDGet(shortName, areaID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AreaControllerApi#v2Tier2ShortNameAreaAreasAreaIDGet");
...
<a id="v2Tier2ShortNameAreaAreasGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AreaModelResults result = apiInstance.v2Tier2ShortNameAreaAreasGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AreaControllerApi#v2Tier2ShortNameAreaAreasGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
