...
<a id="v2Tier2ShortNameSalesSalesfeaturetypesGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer count = 56; // Integer | The maximum number of items to return (up to 1000 per request)
    try {
      SalesFeatureTypeModelResults result = apiInstance.v2Tier2ShortNameSalesSalesfeaturetypesGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SalesControllerApi#v2Tier2ShortNameSalesSalesfeaturetypesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SalesFeatureTypeModel result = apiInstance.v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet(shortName, salesFeatureTypeID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SalesControllerApi#v2Tier2ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier2ShortNameSalesSalesinstructionsGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer count = 56; // Integer | The maximum number of items to return (up to 1000 per request)
    try {
      SalesInstructionModelResults result = apiInstance.v2Tier2ShortNameSalesSalesinstructionsGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SalesControllerApi#v2Tier2ShortNameSalesSalesinstructionsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    String salesInstructionID = "salesInstructionID_example"; // String | The unique ID of the SalesInstruction
    try {
      SalesInstructionModel result = apiInstance.v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet(shortName, salesInstructionID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SalesControllerApi#v2Tier2ShortNameSalesSalesinstructionsSalesInstructionIDGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
