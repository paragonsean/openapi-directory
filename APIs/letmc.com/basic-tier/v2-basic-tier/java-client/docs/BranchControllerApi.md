...
<a id="v2Tier2ShortNameBranchBranchesBranchIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      BranchModel result = apiInstance.v2Tier2ShortNameBranchBranchesBranchIDGet(shortName, branchID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BranchControllerApi#v2Tier2ShortNameBranchBranchesBranchIDGet");
...
<a id="v2Tier2ShortNameBranchBranchesGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      BranchModelResults result = apiInstance.v2Tier2ShortNameBranchBranchesGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BranchControllerApi#v2Tier2ShortNameBranchBranchesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
