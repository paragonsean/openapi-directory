...
|------------- | ------------- | -------------|
| [**lettingsControllerGetAdvertised**](LettingsControllerApi.md#lettingsControllerGetAdvertised) | **GET** /v2/tier2/{shortName}/lettings/advertised | Search all properties available for rent given a range of search criteria. |
| [**lettingsControllerGetAdvertisedBetweenDates**](LettingsControllerApi.md#lettingsControllerGetAdvertisedBetweenDates) | **GET** /v2/tier2/{shortName}/lettings/advertisedbetweendates | Search all properties available for rent given a range of search criteria and dates. |
| [**lettingsControllerGetTenancyBrochure**](LettingsControllerApi.md#lettingsControllerGetTenancyBrochure) | **GET** /v2/tier2/{shortName}/lettings/tenancies/{tenancyID}/brochure | Downloads the brochure relating to the latest advertised rental of a property |
| [**v2Tier2ShortNameLettingsTenanciesGet**](LettingsControllerApi.md#v2Tier2ShortNameLettingsTenanciesGet) | **GET** /v2/tier2/{shortName}/lettings/tenancies | A collection of all the company&#39;s tenancies |
| [**v2Tier2ShortNameLettingsTenanciesTenancyIDGet**](LettingsControllerApi.md#v2Tier2ShortNameLettingsTenanciesTenancyIDGet) | **GET** /v2/tier2/{shortName}/lettings/tenancies/{tenancyID} | Get a specific tenancy given its unique Object ID (OID) |
...
<a id="v2Tier2ShortNameLettingsTenanciesGet"></a>
# **v2Tier2ShortNameLettingsTenanciesGet**
> TenancyModelResults v2Tier2ShortNameLettingsTenanciesGet(shortName, offset, count)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer count = 56; // Integer | The maximum number of items to return (up to 1000 per request)
    try {
      TenancyModelResults result = apiInstance.v2Tier2ShortNameLettingsTenanciesGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LettingsControllerApi#v2Tier2ShortNameLettingsTenanciesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier2ShortNameLettingsTenanciesTenancyIDGet"></a>
# **v2Tier2ShortNameLettingsTenanciesTenancyIDGet**
> TenancyModel v2Tier2ShortNameLettingsTenanciesTenancyIDGet(shortName, tenancyID)
...
public class Example {
  public static void main(String[] args) {
    ...
    String tenancyID = "tenancyID_example"; // String | The unique ID of the Tenancy
    try {
      TenancyModel result = apiInstance.v2Tier2ShortNameLettingsTenanciesTenancyIDGet(shortName, tenancyID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LettingsControllerApi#v2Tier2ShortNameLettingsTenanciesTenancyIDGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
