...
public:
    ...
    * @param[in]  count qint32 [required]
    */
    virtual void v2Tier2ShortNamePropertyPropertiesGet(const QString &short_name, const qint32 &offset, const qint32 &count);

    /**
    * @param[in]  short_name QString [required]
    * @param[in]  property_id QString [required]
    */
    virtual void v2Tier2ShortNamePropertyPropertiesPropertyIDGet(const QString &short_name, const QString &property_id);
...
private:
    ...
    void v2Tier2ShortNamePropertyPropertiesGetCallback(OAIHttpRequestWorker *worker);
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void v2Tier2ShortNamePropertyPropertiesGetSignal(OAIPropertyModelResults summary);
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignal(OAIPropertyModel summary);
    ...
    void v2Tier2ShortNamePropertyPropertiesGetSignalFull(OAIHttpRequestWorker *worker, OAIPropertyModelResults summary);
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalFull(OAIHttpRequestWorker *worker, OAIPropertyModel summary);
    ...
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNamePropertyPropertiesGetSignalError() instead")
    void v2Tier2ShortNamePropertyPropertiesGetSignalE(OAIPropertyModelResults summary, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNamePropertyPropertiesGetSignalError(OAIPropertyModelResults summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalError() instead")
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalE(OAIPropertyModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalError(OAIPropertyModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNamePropertyPropertiesGetSignalErrorFull() instead")
    void v2Tier2ShortNamePropertyPropertiesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNamePropertyPropertiesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalErrorFull() instead")
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNamePropertyPropertiesPropertyIDGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
