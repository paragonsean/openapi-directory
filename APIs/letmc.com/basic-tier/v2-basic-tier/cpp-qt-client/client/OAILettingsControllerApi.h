...
public:
    ...
    * @param[in]  count qint32 [required]
    */
    virtual void v2Tier2ShortNameLettingsTenanciesGet(const QString &short_name, const qint32 &offset, const qint32 &count);

    /**
    * @param[in]  short_name QString [required]
    * @param[in]  tenancy_id QString [required]
    */
    virtual void v2Tier2ShortNameLettingsTenanciesTenancyIDGet(const QString &short_name, const QString &tenancy_id);
...
private:
    ...
    void v2Tier2ShortNameLettingsTenanciesGetCallback(OAIHttpRequestWorker *worker);
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void v2Tier2ShortNameLettingsTenanciesGetSignal(OAITenancyModelResults summary);
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignal(OAITenancyModel summary);
    ...
    void v2Tier2ShortNameLettingsTenanciesGetSignalFull(OAIHttpRequestWorker *worker, OAITenancyModelResults summary);
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalFull(OAIHttpRequestWorker *worker, OAITenancyModel summary);
    ...
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNameLettingsTenanciesGetSignalError() instead")
    void v2Tier2ShortNameLettingsTenanciesGetSignalE(OAITenancyModelResults summary, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNameLettingsTenanciesGetSignalError(OAITenancyModelResults summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalError() instead")
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalE(OAITenancyModel summary, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalError(OAITenancyModel summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNameLettingsTenanciesGetSignalErrorFull() instead")
    void v2Tier2ShortNameLettingsTenanciesGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNameLettingsTenanciesGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalErrorFull() instead")
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void v2Tier2ShortNameLettingsTenanciesTenancyIDGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
