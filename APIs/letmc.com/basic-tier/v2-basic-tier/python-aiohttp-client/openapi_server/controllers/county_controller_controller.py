...
async def v2_tier2_short_name_county_counties_county_idget(request: web.Request, short_name, county_id) -> web.Response:
...
async def v2_tier2_short_name_county_counties_get(request: web.Request, short_name, offset, count) -> web.Response:
