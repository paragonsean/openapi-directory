...
async def v2_tier2_short_name_sales_salesfeaturetypes_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier2_short_name_sales_salesfeaturetypes_sales_feature_type_idget(request: web.Request, short_name, sales_feature_type_id) -> web.Response:
...
async def v2_tier2_short_name_sales_salesinstructions_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier2_short_name_sales_salesinstructions_sales_instruction_idget(request: web.Request, short_name, sales_instruction_id) -> web.Response:
