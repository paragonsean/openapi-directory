...
async def v2_tier2_short_name_area_areas_area_idget(request: web.Request, short_name, area_id) -> web.Response:
...
async def v2_tier2_short_name_area_areas_get(request: web.Request, short_name, offset, count) -> web.Response:
