...
async def v2_tier2_short_name_photo_photos_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier2_short_name_photo_photos_photo_idget(request: web.Request, short_name, photo_id) -> web.Response:
