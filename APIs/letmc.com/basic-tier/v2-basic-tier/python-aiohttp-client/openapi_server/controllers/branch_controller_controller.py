...
async def v2_tier2_short_name_branch_branches_branch_idget(request: web.Request, short_name, branch_id) -> web.Response:
...
async def v2_tier2_short_name_branch_branches_get(request: web.Request, short_name, offset, count) -> web.Response:
