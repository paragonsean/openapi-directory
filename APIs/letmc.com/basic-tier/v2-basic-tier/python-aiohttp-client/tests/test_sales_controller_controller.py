...
async def test_sales_controller_get_advertised_sales(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/advertisedsales'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
...
async def test_sales_controller_get_eer(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/reports/eer/{sales_instruction_id}'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sales_controller_get_eir(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/reports/eir/{sales_instruction_id}'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sales_controller_get_sales_instructions_features(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesinstructions/{sales_instruction_id}/features'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sales_controller_get_sales_instructions_floor_plans(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesinstructions/{sales_instruction_id}/floorplans'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sales_controller_get_sales_instructions_photos(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesinstructions/{sales_instruction_id}/photos'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_sales_controller_get_sales_instructions_rooms(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesinstructions/{sales_instruction_id}/rooms'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier2_short_name_sales_salesfeaturetypes_get(client):
    """Test case for v2_tier2_short_name_sales_salesfeaturetypes_get
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesfeaturetypes'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier2_short_name_sales_salesfeaturetypes_sales_feature_type_idget(client):
    """Test case for v2_tier2_short_name_sales_salesfeaturetypes_sales_feature_type_idget
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesfeaturetypes/{sales_feature_type_id}'.format(short_name='short_name_example', sales_feature_type_id='sales_feature_type_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier2_short_name_sales_salesinstructions_get(client):
    """Test case for v2_tier2_short_name_sales_salesinstructions_get
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesinstructions'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier2_short_name_sales_salesinstructions_sales_instruction_idget(client):
    """Test case for v2_tier2_short_name_sales_salesinstructions_sales_instruction_idget
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier2/{short_name}/sales/salesinstructions/{sales_instruction_id}'.format(short_name='short_name_example', sales_instruction_id='sales_instruction_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
