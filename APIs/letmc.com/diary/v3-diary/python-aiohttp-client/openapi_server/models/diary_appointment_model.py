...
class DiaryAppointmentModel(Model):
    ...
    def __init__(self, appointment_type: str=None, cancelled: bool=None, comment: str=None, created_at: datetime=None, created_by: str=None, e_tag: str=None, end: datetime=None, linked_guest: List[LinkedGuestModel]=None, linked_properties: List[LinkedPropertiesModel]=None, next_recurring_date: datetime=None, oid: str=None, recurrence: int=None, recurrence_type: str=None, remind_at: datetime=None, remind_before: str=None, staff: str=None, start: datetime=None, subject: str=None):
        ...
        :param linked_guest: The linked_guest of this DiaryAppointmentModel.
        :param linked_properties: The linked_properties of this DiaryAppointmentModel.
        :param next_recurring_date: The next_recurring_date of this DiaryAppointmentModel.
        :param oid: The oid of this DiaryAppointmentModel.
        :param recurrence: The recurrence of this DiaryAppointmentModel.
        :param recurrence_type: The recurrence_type of this DiaryAppointmentModel.
        ...
        self.openapi_types = {
            ...
            'e_tag': str,
            'end': datetime,
            'linked_guest': List[LinkedGuestModel],
            'linked_properties': List[LinkedPropertiesModel],
        ...
        self._e_tag = e_tag
        self._end = end
        self._linked_guest = linked_guest
        self._linked_properties = linked_properties
        self._next_recurring_date = next_recurring_date
        self._oid = oid
    ...
    @property
    def linked_guest(self):
        """Gets the linked_guest of this DiaryAppointmentModel.

        Linked Guest Model:-

        :return: The linked_guest of this DiaryAppointmentModel.
        :rtype: List[LinkedGuestModel]
        """
        return self._linked_guest

    @linked_guest.setter
    def linked_guest(self, linked_guest):
        """Sets the linked_guest of this DiaryAppointmentModel.

        Linked Guest Model:-

        :param linked_guest: The linked_guest of this DiaryAppointmentModel.
        :type linked_guest: List[LinkedGuestModel]
        """
    ...
    def linked_properties(self):
        """Gets the linked_properties of this DiaryAppointmentModel.

        A collection of properties linked to the appointment:-

        :return: The linked_properties of this DiaryAppointmentModel.
        :rtype: List[LinkedPropertiesModel]
        """
        return self._linked_properties

    @linked_properties.setter
    def linked_properties(self, linked_properties):
        """Sets the linked_properties of this DiaryAppointmentModel.

        A collection of properties linked to the appointment:-

        :param linked_properties: The linked_properties of this DiaryAppointmentModel.
        :type linked_properties: List[LinkedPropertiesModel]
        """

        self._linked_properties = linked_properties

    @property
    def next_recurring_date(self):
        """Gets the next_recurring_date of this DiaryAppointmentModel.

        Date appointment next repeats:-

        :return: The next_recurring_date of this DiaryAppointmentModel.
        :rtype: datetime
        """
        return self._next_recurring_date

    @next_recurring_date.setter
    def next_recurring_date(self, next_recurring_date):
        """Sets the next_recurring_date of this DiaryAppointmentModel.

        Date appointment next repeats:-

        :param next_recurring_date: The next_recurring_date of this DiaryAppointmentModel.
        :type next_recurring_date: datetime
        """
    ...
    @property
    def recurrence(self):
        """Gets the recurrence of this DiaryAppointmentModel.

        The reccurrence interval for the appointment:-

        :return: The recurrence of this DiaryAppointmentModel.
        :rtype: int
        """
    ...
    def recurrence(self, recurrence):
        """Sets the recurrence of this DiaryAppointmentModel.
    ...
    def recurrence_type(self):
        """Gets the recurrence_type of this DiaryAppointmentModel.

        The type of recurrence:-

        :return: The recurrence_type of this DiaryAppointmentModel.
        :rtype: str
        """
    ...
    def recurrence_type(self, recurrence_type):
        """Sets the recurrence_type of this DiaryAppointmentModel.
