...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV3DiaryCallGroup.LinkedLandlordModel();
  });
  ...
  describe('LinkedLandlordModel', function() {
    it('should create an instance of LinkedLandlordModel', function() {
      // uncomment below and update the code to test LinkedLandlordModel
      //var instance = new AgentOsApiV3DiaryCallGroup.LinkedLandlordModel();
      //expect(instance).to.be.a(AgentOsApiV3DiaryCallGroup.LinkedLandlordModel);
    });
