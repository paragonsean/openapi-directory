...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV3DiaryCallGroup.AdvertisingBranchModel();
  });
  ...
  describe('AdvertisingBranchModel', function() {
    it('should create an instance of AdvertisingBranchModel', function() {
      // uncomment below and update the code to test AdvertisingBranchModel
      //var instance = new AgentOsApiV3DiaryCallGroup.AdvertisingBranchModel();
      //expect(instance).to.be.a(AgentOsApiV3DiaryCallGroup.AdvertisingBranchModel);
    });
