...
import LinkedGuestModel from './LinkedGuestModel';
...
class DiaryAppointmentModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('LinkedGuest')) {
                obj['LinkedGuest'] = ApiClient.convertToType(data['LinkedGuest'], [LinkedGuestModel]);
            }
            if (data.hasOwnProperty('LinkedProperties')) {
                obj['LinkedProperties'] = ApiClient.convertToType(data['LinkedProperties'], [LinkedPropertiesModel]);
            }
            if (data.hasOwnProperty('NextRecurringDate')) {
                obj['NextRecurringDate'] = ApiClient.convertToType(data['NextRecurringDate'], 'Date');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['LinkedGuest']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['LinkedGuest'])) {
                throw new Error("Expected the field `LinkedGuest` to be an array in the JSON data but got " + data['LinkedGuest']);
            }
            // validate the optional field `LinkedGuest` (array)
            for (const item of data['LinkedGuest']) {
                LinkedGuestModel.validateJSON(item);
            };
        }
        if (data['LinkedProperties']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['LinkedProperties'])) {
                throw new Error("Expected the field `LinkedProperties` to be an array in the JSON data but got " + data['LinkedProperties']);
            }
            // validate the optional field `LinkedProperties` (array)
            for (const item of data['LinkedProperties']) {
                LinkedPropertiesModel.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
/**
 * Linked Guest Model:-
 * @member {Array.<module:model/LinkedGuestModel>} LinkedGuest
 */
DiaryAppointmentModel.prototype['LinkedGuest'] = undefined;

/**
 * A collection of properties linked to the appointment:-
 * @member {Array.<module:model/LinkedPropertiesModel>} LinkedProperties
 */
DiaryAppointmentModel.prototype['LinkedProperties'] = undefined;

/**
 * Date appointment next repeats:-
 * @member {Date} NextRecurringDate
 */
DiaryAppointmentModel.prototype['NextRecurringDate'] = undefined;
 ...
 */
DiaryAppointmentModel.prototype['Recurrence'] = undefined;

/**
 * The type of recurrence:-
 * @member {String} RecurrenceType
 */
DiaryAppointmentModel.prototype['RecurrenceType'] = undefined;
