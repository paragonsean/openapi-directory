...
/**
 * The AdvertisingBranchModel model module.
 * @module model/AdvertisingBranchModel
 * @version v3-diary
 */
class AdvertisingBranchModel {
    /**
     * Constructs a new <code>AdvertisingBranchModel</code>.
     * Defines a single branch of a client.
     * @alias module:model/AdvertisingBranchModel
     */
    constructor() { 
        
        AdvertisingBranchModel.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdvertisingBranchModel</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdvertisingBranchModel} obj Optional instance to populate.
     * @return {module:model/AdvertisingBranchModel} The populated <code>AdvertisingBranchModel</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdvertisingBranchModel();
    ...
    /**
     * Validates the JSON data with respect to <code>AdvertisingBranchModel</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdvertisingBranchModel</code>.
     */
 ...
 */
AdvertisingBranchModel.prototype['Address1'] = undefined;

/**
 * Branch address line 2.
 * @member {String} Address2
 */
AdvertisingBranchModel.prototype['Address2'] = undefined;

/**
 * Branch address line 3.
 * @member {String} Address3
 */
AdvertisingBranchModel.prototype['Address3'] = undefined;

/**
 * Branch address line 4.
 * @member {String} Address4
 */
AdvertisingBranchModel.prototype['Address4'] = undefined;

/**
 * The relevant company name, if not the one specified on the branch then the one on company.
 * @member {String} CompanyName
 */
AdvertisingBranchModel.prototype['CompanyName'] = undefined;

/**
 * County
 * @member {String} County
 */
AdvertisingBranchModel.prototype['County'] = undefined;

/**
 * Branch email address.
 * @member {String} EMailAddress
 */
AdvertisingBranchModel.prototype['EMailAddress'] = undefined;

/**
 * A unique identifier defining the object and change revision.
 * @member {String} ETag
 */
AdvertisingBranchModel.prototype['ETag'] = undefined;

/**
 * Branch fax phone number.
 * @member {String} FaxPhone
 */
AdvertisingBranchModel.prototype['FaxPhone'] = undefined;

/**
 * Branch land phone number.
 * @member {String} LandPhone
 */
AdvertisingBranchModel.prototype['LandPhone'] = undefined;

/**
 * The branch name.
 * @member {String} Name
 */
AdvertisingBranchModel.prototype['Name'] = undefined;

/**
 * The unique Object ID (OID).
 * @member {String} OID
 */
AdvertisingBranchModel.prototype['OID'] = undefined;

/**
 * Branch address postcode.
 * @member {String} Postcode
 */
AdvertisingBranchModel.prototype['Postcode'] = undefined;

/**
 * Branch web address.
 * @member {String} WebAddress
 */
AdvertisingBranchModel.prototype['WebAddress'] = undefined;
...
export default AdvertisingBranchModel;
