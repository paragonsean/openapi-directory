...
/*
 * OAILinkedLandlordModel.h
 *
 * Holds information on landlords
 */

#ifndef OAILinkedLandlordModel_H
#define OAILinkedLandlordModel_H
...
class OAILinkedLandlordModel : public OAIObject {
public:
    OAILinkedLandlordModel();
    OAILinkedLandlordModel(QString json);
    ~OAILinkedLandlordModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinkedLandlordModel)

#endif // OAILinkedLandlordModel_H
