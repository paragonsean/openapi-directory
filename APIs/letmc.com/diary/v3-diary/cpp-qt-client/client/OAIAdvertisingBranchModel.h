...
/*
 * OAIAdvertisingBranchModel.h
 *
 * Defines a single branch of a client.
 */

#ifndef OAIAdvertisingBranchModel_H
#define OAIAdvertisingBranchModel_H
...
class OAIAdvertisingBranchModel : public OAIObject {
public:
    OAIAdvertisingBranchModel();
    OAIAdvertisingBranchModel(QString json);
    ~OAIAdvertisingBranchModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvertisingBranchModel)

#endif // OAIAdvertisingBranchModel_H
