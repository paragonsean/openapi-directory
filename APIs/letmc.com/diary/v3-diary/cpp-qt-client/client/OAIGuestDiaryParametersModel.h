...
/*
 * OAIGuestDiaryParametersModel.h
 *
 * Guest Diary Parameters Model
 */

#ifndef OAIGuestDiaryParametersModel_H
#define OAIGuestDiaryParametersModel_H
...
class OAIGuestDiaryParametersModel : public OAIObject {
public:
    OAIGuestDiaryParametersModel();
    OAIGuestDiaryParametersModel(QString json);
    ~OAIGuestDiaryParametersModel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGuestDiaryParametersModel)

#endif // OAIGuestDiaryParametersModel_H
