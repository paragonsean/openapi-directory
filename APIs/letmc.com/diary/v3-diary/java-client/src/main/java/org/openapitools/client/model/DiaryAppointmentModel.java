...
public class DiaryAppointmentModel {
  ...
  public static final String SERIALIZED_NAME_LINKED_GUEST = "LinkedGuest";
  @SerializedName(SERIALIZED_NAME_LINKED_GUEST)
  private List<LinkedGuestModel> linkedGuest = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKED_PROPERTIES = "LinkedProperties";
  @SerializedName(SERIALIZED_NAME_LINKED_PROPERTIES)
  private List<LinkedPropertiesModel> linkedProperties = new ArrayList<>();

  public static final String SERIALIZED_NAME_NEXT_RECURRING_DATE = "NextRecurringDate";
  @SerializedName(SERIALIZED_NAME_NEXT_RECURRING_DATE)
  private OffsetDateTime nextRecurringDate;
  ...
  public DiaryAppointmentModel(
     List<LinkedGuestModel> linkedGuest
  ) {
    this();
   ...
   */
  @javax.annotation.Nullable
  public List<LinkedGuestModel> getLinkedGuest() {
    return linkedGuest;
  }



  public DiaryAppointmentModel linkedProperties(List<LinkedPropertiesModel> linkedProperties) {
    this.linkedProperties = linkedProperties;
    return this;
  }

  public DiaryAppointmentModel addLinkedPropertiesItem(LinkedPropertiesModel linkedPropertiesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<LinkedPropertiesModel> getLinkedProperties() {
    return linkedProperties;
  }

  public void setLinkedProperties(List<LinkedPropertiesModel> linkedProperties) {
    this.linkedProperties = linkedProperties;
  }


  public DiaryAppointmentModel nextRecurringDate(OffsetDateTime nextRecurringDate) {
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getNextRecurringDate() {
    return nextRecurringDate;
  }

  public void setNextRecurringDate(OffsetDateTime nextRecurringDate) {
    this.nextRecurringDate = nextRecurringDate;
  }
  ...
  public DiaryAppointmentModel recurrence(Integer recurrence) {
  ...
  public DiaryAppointmentModel recurrenceType(String recurrenceType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appointmentType, diaryAppointmentModel.appointmentType) &&
        ...
        Objects.equals(this.linkedGuest, diaryAppointmentModel.linkedGuest) &&
        Objects.equals(this.linkedProperties, diaryAppointmentModel.linkedProperties) &&
        Objects.equals(this.nextRecurringDate, diaryAppointmentModel.nextRecurringDate) &&
        Objects.equals(this.OID, diaryAppointmentModel.OID) &&
        Objects.equals(this.recurrence, diaryAppointmentModel.recurrence) &&
        Objects.equals(this.recurrenceType, diaryAppointmentModel.recurrenceType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(appointmentType, cancelled, comment, createdAt, createdBy, etag, end, linkedGuest, linkedProperties, nextRecurringDate, OID, recurrence, recurrenceType, remindAt, remindBefore, staff, start, subject);
  }
  ...
  public String toString() {
    ...
    sb.append("    linkedGuest: ").append(toIndentedString(linkedGuest)).append("\n");
    sb.append("    linkedProperties: ").append(toIndentedString(linkedProperties)).append("\n");
    sb.append("    nextRecurringDate: ").append(toIndentedString(nextRecurringDate)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LinkedGuest");
    openapiFields.add("LinkedProperties");
    openapiFields.add("NextRecurringDate");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("LinkedGuest") != null && !jsonObj.get("LinkedGuest").isJsonNull()) {
        JsonArray jsonArraylinkedGuest = jsonObj.getAsJsonArray("LinkedGuest");
        if (jsonArraylinkedGuest != null) {
          // ensure the json data is an array
          if (!jsonObj.get("LinkedGuest").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `LinkedGuest` to be an array in the JSON string but got `%s`", jsonObj.get("LinkedGuest").toString()));
          }

          // validate the optional field `LinkedGuest` (array)
          for (int i = 0; i < jsonArraylinkedGuest.size(); i++) {
            LinkedGuestModel.validateJsonElement(jsonArraylinkedGuest.get(i));
          };
        }
      }
      if (jsonObj.get("LinkedProperties") != null && !jsonObj.get("LinkedProperties").isJsonNull()) {
        JsonArray jsonArraylinkedProperties = jsonObj.getAsJsonArray("LinkedProperties");
        if (jsonArraylinkedProperties != null) {
          // ensure the json data is an array
          if (!jsonObj.get("LinkedProperties").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `LinkedProperties` to be an array in the JSON string but got `%s`", jsonObj.get("LinkedProperties").toString()));
          }

          // validate the optional field `LinkedProperties` (array)
          for (int i = 0; i < jsonArraylinkedProperties.size(); i++) {
            LinkedPropertiesModel.validateJsonElement(jsonArraylinkedProperties.get(i));
          };
        }
      }
