...
class KeyValuePairStringString {
    ...
    constructor() { 
        ...
        KeyValuePairStringString.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>KeyValuePairStringString</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyValuePairStringString</code>.
     */
 ...
 * @member {String} key
 */
KeyValuePairStringString.prototype['key'] = undefined;

/**
 * @member {String} value
 */
KeyValuePairStringString.prototype['value'] = undefined;
...
export default KeyValuePairStringString;
