...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordSummaryModel();
  });
  ...
  describe('LandlordSummaryModel', function() {
    it('should create an instance of LandlordSummaryModel', function() {
      // uncomment below and update the code to test LandlordSummaryModel
      //var instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordSummaryModel();
      //expect(instance).to.be.a(AgentOsApiV2CustomerLoginCallGroup.LandlordSummaryModel);
    });
