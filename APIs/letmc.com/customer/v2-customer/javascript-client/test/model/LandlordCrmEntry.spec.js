...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordCrmEntry();
  });
  ...
  describe('LandlordCrmEntry', function() {
    it('should create an instance of LandlordCrmEntry', function() {
      // uncomment below and update the code to test LandlordCrmEntry
      //var instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordCrmEntry();
      //expect(instance).to.be.a(AgentOsApiV2CustomerLoginCallGroup.LandlordCrmEntry);
    });
