...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV2CustomerLoginCallGroup.BranchModelResults();
  });
  ...
  describe('BranchModelResults', function() {
    it('should create an instance of BranchModelResults', function() {
      ...
      //var instance = new AgentOsApiV2CustomerLoginCallGroup.BranchModelResults();
      //expect(instance).to.be.a(AgentOsApiV2CustomerLoginCallGroup.BranchModelResults);
    });
