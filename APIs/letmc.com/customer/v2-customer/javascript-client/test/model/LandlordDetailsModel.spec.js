...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordDetailsModel();
  });
  ...
  describe('LandlordDetailsModel', function() {
    it('should create an instance of LandlordDetailsModel', function() {
      // uncomment below and update the code to test LandlordDetailsModel
      //var instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordDetailsModel();
      //expect(instance).to.be.a(AgentOsApiV2CustomerLoginCallGroup.LandlordDetailsModel);
    });
