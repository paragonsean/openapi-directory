...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordAccountingModel();
  });
  ...
  describe('LandlordAccountingModel', function() {
    it('should create an instance of LandlordAccountingModel', function() {
      // uncomment below and update the code to test LandlordAccountingModel
      //var instance = new AgentOsApiV2CustomerLoginCallGroup.LandlordAccountingModel();
      //expect(instance).to.be.a(AgentOsApiV2CustomerLoginCallGroup.LandlordAccountingModel);
    });
    ...
    it('should have the property paymentHistory (base name: "PaymentHistory")', function() {
