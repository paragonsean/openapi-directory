...
public class BranchModel {
  ...
  public BranchModel address1(String address1) {
  ...
  public BranchModel address2(String address2) {
  ...
  public BranchModel address3(String address3) {
  ...
  public BranchModel address4(String address4) {
  ...
  public BranchModel companyName(String companyName) {
  ...
  public BranchModel county(String county) {
    this.county = county;
    return this;
  }
  ...
  public BranchModel emailAddress(String emailAddress) {
  ...
  public BranchModel etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public BranchModel faxPhone(String faxPhone) {
  ...
  public BranchModel landPhone(String landPhone) {
  ...
  public BranchModel OID(String OID) {
    this.OID = OID;
    return this;
  }
  ...
  public BranchModel postcode(String postcode) {
  ...
  public BranchModel webAddress(String webAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, branchModel.address1) &&
        Objects.equals(this.address2, branchModel.address2) &&
        Objects.equals(this.address3, branchModel.address3) &&
        Objects.equals(this.address4, branchModel.address4) &&
        Objects.equals(this.companyName, branchModel.companyName) &&
        Objects.equals(this.county, branchModel.county) &&
        Objects.equals(this.emailAddress, branchModel.emailAddress) &&
        Objects.equals(this.etag, branchModel.etag) &&
        Objects.equals(this.faxPhone, branchModel.faxPhone) &&
        Objects.equals(this.landPhone, branchModel.landPhone) &&
        Objects.equals(this.name, branchModel.name) &&
        Objects.equals(this.OID, branchModel.OID) &&
        Objects.equals(this.postcode, branchModel.postcode) &&
        Objects.equals(this.webAddress, branchModel.webAddress);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BranchModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BranchModel is not found in the empty JSON string", BranchModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BranchModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BranchModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BranchModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BranchModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BranchModel.class));

       return (TypeAdapter<T>) new TypeAdapter<BranchModel>() {
           @Override
           public void write(JsonWriter out, BranchModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BranchModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BranchModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BranchModel
   * @throws IOException if the JSON string is invalid with respect to BranchModel
   */
  public static BranchModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BranchModel.class);
  }

  /**
   * Convert an instance of BranchModel to an JSON string
   *
   * @return JSON string
   */
