...
async def branch_controller_get_branches(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_customer_short_name_branch_branches_branch_idget(request: web.Request, short_name, branch_id) -> web.Response:
