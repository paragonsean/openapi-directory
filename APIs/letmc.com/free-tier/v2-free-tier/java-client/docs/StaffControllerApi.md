...
<a id="v2Tier1ShortNameStaffStaffApplicationStaffIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApplicationStaffModel result = apiInstance.v2Tier1ShortNameStaffStaffApplicationStaffIDGet(shortName, applicationStaffID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StaffControllerApi#v2Tier1ShortNameStaffStaffApplicationStaffIDGet");
...
<a id="v2Tier1ShortNameStaffStaffGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ApplicationStaffModelResults result = apiInstance.v2Tier1ShortNameStaffStaffGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StaffControllerApi#v2Tier1ShortNameStaffStaffGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
