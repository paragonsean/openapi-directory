...
<a id="v2Tier1ShortNameDiaryAllocationsDiaryAllocationIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DiaryAllocationModel result = apiInstance.v2Tier1ShortNameDiaryAllocationsDiaryAllocationIDGet(shortName, diaryAllocationID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DiaryControllerApi#v2Tier1ShortNameDiaryAllocationsDiaryAllocationIDGet");
...
<a id="v2Tier1ShortNameDiaryAllocationsGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DiaryAllocationModelResults result = apiInstance.v2Tier1ShortNameDiaryAllocationsGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DiaryControllerApi#v2Tier1ShortNameDiaryAllocationsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier1ShortNameDiaryAppointmentsDiaryAppointmentIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DiaryAppointmentModel result = apiInstance.v2Tier1ShortNameDiaryAppointmentsDiaryAppointmentIDGet(shortName, diaryAppointmentID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DiaryControllerApi#v2Tier1ShortNameDiaryAppointmentsDiaryAppointmentIDGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier1ShortNameDiaryAppointmentsGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer count = 56; // Integer | The maximum number of items to return (up to 1000 per request)
    try {
      DiaryAppointmentModelResults result = apiInstance.v2Tier1ShortNameDiaryAppointmentsGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DiaryControllerApi#v2Tier1ShortNameDiaryAppointmentsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier1ShortNameDiaryAppointmenttypesDiaryAppointmentTypeIDGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DiaryAppointmentTypeModel result = apiInstance.v2Tier1ShortNameDiaryAppointmenttypesDiaryAppointmentTypeIDGet(shortName, diaryAppointmentTypeID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DiaryControllerApi#v2Tier1ShortNameDiaryAppointmenttypesDiaryAppointmentTypeIDGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier1ShortNameDiaryAppointmenttypesGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer count = 56; // Integer | The maximum number of items to return (up to 1000 per request)
    try {
      DiaryAppointmentTypeModelResults result = apiInstance.v2Tier1ShortNameDiaryAppointmenttypesGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DiaryControllerApi#v2Tier1ShortNameDiaryAppointmenttypesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
