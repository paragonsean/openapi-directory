...
|------------- | ------------- | -------------|
| [**propertyControllerGetPropertiesFacilities**](PropertyControllerApi.md#propertyControllerGetPropertiesFacilities) | **GET** /v2/tier1/{shortName}/property/properties/{propertyID}/facilities | A collection of facilities linked to a block, property or room |
| [**propertyControllerGetPropertiesPhotos**](PropertyControllerApi.md#propertyControllerGetPropertiesPhotos) | **GET** /v2/tier1/{shortName}/property/properties/{propertyID}/photos | A collection showing all the photos linked to a specific block, property or room |
| [**propertyControllerGetPropertiesRooms**](PropertyControllerApi.md#propertyControllerGetPropertiesRooms) | **GET** /v2/tier1/{shortName}/property/properties/{propertyID}/rooms | A collection of the rooms that belong to this property or block |
| [**propertyControllerGetPropertiesTenancies**](PropertyControllerApi.md#propertyControllerGetPropertiesTenancies) | **GET** /v2/tier1/{shortName}/property/properties/{propertyID}/tenancies | A collection of all tenancies associated with this block, property or room |
| [**propertyControllerGetPropertyEERDownload**](PropertyControllerApi.md#propertyControllerGetPropertyEERDownload) | **GET** /v2/tier1/{shortName}/property/structures/{propertyStructureID}/reports/eer | Downloads the energy efficiency report (EER) graph for a property |
| [**propertyControllerGetPropertyEIRDownload**](PropertyControllerApi.md#propertyControllerGetPropertyEIRDownload) | **GET** /v2/tier1/{shortName}/property/structures/{propertyStructureID}/reports/eir | Downloads the environmental impact report (EIR) graph for a property |
| [**v2Tier1ShortNamePropertyPropertiesGet**](PropertyControllerApi.md#v2Tier1ShortNamePropertyPropertiesGet) | **GET** /v2/tier1/{shortName}/property/properties | A collection of all properties within a company |
| [**v2Tier1ShortNamePropertyPropertiesPropertyIDGet**](PropertyControllerApi.md#v2Tier1ShortNamePropertyPropertiesPropertyIDGet) | **GET** /v2/tier1/{shortName}/property/properties/{propertyID} | Get a specific property given its unique Object ID (OID) |
...
<a id="v2Tier1ShortNamePropertyPropertiesGet"></a>
# **v2Tier1ShortNamePropertyPropertiesGet**
> PropertyModelResults v2Tier1ShortNamePropertyPropertiesGet(shortName, offset, count)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer count = 56; // Integer | The maximum number of items to return (up to 1000 per request)
    try {
      PropertyModelResults result = apiInstance.v2Tier1ShortNamePropertyPropertiesGet(shortName, offset, count);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PropertyControllerApi#v2Tier1ShortNamePropertyPropertiesGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="v2Tier1ShortNamePropertyPropertiesPropertyIDGet"></a>
# **v2Tier1ShortNamePropertyPropertiesPropertyIDGet**
> PropertyModel v2Tier1ShortNamePropertyPropertiesPropertyIDGet(shortName, propertyID)
...
public class Example {
  public static void main(String[] args) {
    ...
    String propertyID = "propertyID_example"; // String | The unique ID of the Property
    try {
      PropertyModel result = apiInstance.v2Tier1ShortNamePropertyPropertiesPropertyIDGet(shortName, propertyID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PropertyControllerApi#v2Tier1ShortNamePropertyPropertiesPropertyIDGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
