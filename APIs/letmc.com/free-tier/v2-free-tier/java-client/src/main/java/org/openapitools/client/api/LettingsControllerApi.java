...
public class LettingsControllerApi {
    ...
    public okhttp3.Call lettingsControllerGetAdvertisedCall(String shortName, String branchID, Integer offset, Integer count, String areaID, Double rentMinimum, Double rentMaximum, Integer maximumTenants, Boolean wantSharedProperties, Boolean wantStudentProperties, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/tier1/{shortName}/lettings/advertised"
    ...
    public okhttp3.Call lettingsControllerGetAdvertisedBetweenDatesCall(String shortName, String branchID, Integer offset, Integer count, OffsetDateTime rangeStartDate, OffsetDateTime rangeEndDate, String areaID, Double rentMinimum, Double rentMaximum, Integer maximumTenants, Boolean wantSharedProperties, Boolean wantStudentProperties, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/lettings/advertisedbetweendates"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()));
    ...
    public okhttp3.Call lettingsControllerGetTenancyBrochureCall(String shortName, String tenancyID, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/lettings/tenancies/{tenancyID}/brochure"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
    ...
    /**
     * Build call for v2Tier1ShortNameLettingsTenanciesGet
     * @param shortName The unique client short-name (required)
     * @param offset The index of the first item to return (required)
     * @param count The maximum number of items to return (up to 1000 per request) (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call v2Tier1ShortNameLettingsTenanciesGetCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/lettings/tenancies"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNameLettingsTenanciesGetValidateBeforeCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNameLettingsTenanciesGet(Async)");
        }

        // verify the required parameter 'offset' is set
        if (offset == null) {
            throw new ApiException("Missing the required parameter 'offset' when calling v2Tier1ShortNameLettingsTenanciesGet(Async)");
        }

        // verify the required parameter 'count' is set
        if (count == null) {
            throw new ApiException("Missing the required parameter 'count' when calling v2Tier1ShortNameLettingsTenanciesGet(Async)");
        }

        return v2Tier1ShortNameLettingsTenanciesGetCall(shortName, offset, count, _callback);
     ...
     */
    public TenancyModelResults v2Tier1ShortNameLettingsTenanciesGet(String shortName, Integer offset, Integer count) throws ApiException {
        ApiResponse<TenancyModelResults> localVarResp = v2Tier1ShortNameLettingsTenanciesGetWithHttpInfo(shortName, offset, count);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TenancyModelResults> v2Tier1ShortNameLettingsTenanciesGetWithHttpInfo(String shortName, Integer offset, Integer count) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNameLettingsTenanciesGetValidateBeforeCall(shortName, offset, count, null);
        Type localVarReturnType = new TypeToken<TenancyModelResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call v2Tier1ShortNameLettingsTenanciesGetAsync(String shortName, Integer offset, Integer count, final ApiCallback<TenancyModelResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNameLettingsTenanciesGetValidateBeforeCall(shortName, offset, count, _callback);
        Type localVarReturnType = new TypeToken<TenancyModelResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for v2Tier1ShortNameLettingsTenanciesTenancyIDGet
     * @param shortName The unique client short-name (required)
     * @param tenancyID The unique ID of the Tenancy (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call v2Tier1ShortNameLettingsTenanciesTenancyIDGetCall(String shortName, String tenancyID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/lettings/tenancies/{tenancyID}"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "tenancyID" + "}", localVarApiClient.escapeString(tenancyID.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNameLettingsTenanciesTenancyIDGetValidateBeforeCall(String shortName, String tenancyID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNameLettingsTenanciesTenancyIDGet(Async)");
        }

        // verify the required parameter 'tenancyID' is set
        if (tenancyID == null) {
            throw new ApiException("Missing the required parameter 'tenancyID' when calling v2Tier1ShortNameLettingsTenanciesTenancyIDGet(Async)");
        }

        return v2Tier1ShortNameLettingsTenanciesTenancyIDGetCall(shortName, tenancyID, _callback);
     ...
     */
    public TenancyModel v2Tier1ShortNameLettingsTenanciesTenancyIDGet(String shortName, String tenancyID) throws ApiException {
        ApiResponse<TenancyModel> localVarResp = v2Tier1ShortNameLettingsTenanciesTenancyIDGetWithHttpInfo(shortName, tenancyID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TenancyModel> v2Tier1ShortNameLettingsTenanciesTenancyIDGetWithHttpInfo(String shortName, String tenancyID) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNameLettingsTenanciesTenancyIDGetValidateBeforeCall(shortName, tenancyID, null);
     ...
     */
    public okhttp3.Call v2Tier1ShortNameLettingsTenanciesTenancyIDGetAsync(String shortName, String tenancyID, final ApiCallback<TenancyModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNameLettingsTenanciesTenancyIDGetValidateBeforeCall(shortName, tenancyID, _callback);
        Type localVarReturnType = new TypeToken<TenancyModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
