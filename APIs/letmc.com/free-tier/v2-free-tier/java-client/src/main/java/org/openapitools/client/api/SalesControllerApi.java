...
public class SalesControllerApi {
    ...
    public okhttp3.Call salesControllerGetAdvertisedSalesCall(String shortName, String branchID, Integer offset, Integer count, Boolean onlyDevelopement, Boolean onlyInvestements, Double minimumPrice, Double maximumPrice, Integer minimumBeds, Integer minimumBathrooms, Integer minimumEnsuites, Integer minimumToilets, Integer minimumReception, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/tier1/{shortName}/sales/advertisedsales"
    ...
    public okhttp3.Call salesControllerGetEERCall(String shortName, String salesInstructionID, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/reports/eer/{salesInstructionID}"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
    ...
    public okhttp3.Call salesControllerGetEIRCall(String shortName, String salesInstructionID, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/reports/eir/{salesInstructionID}"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "salesInstructionID" + "}", localVarApiClient.escapeString(salesInstructionID.toString()));
    ...
    public okhttp3.Call salesControllerGetSalesInstructionsFeaturesCall(String shortName, String salesInstructionID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesinstructions/{salesInstructionID}/features"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "salesInstructionID" + "}", localVarApiClient.escapeString(salesInstructionID.toString()));
    ...
    public okhttp3.Call salesControllerGetSalesInstructionsFloorPlansCall(String shortName, String salesInstructionID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesinstructions/{salesInstructionID}/floorplans"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "salesInstructionID" + "}", localVarApiClient.escapeString(salesInstructionID.toString()));
    ...
    public okhttp3.Call salesControllerGetSalesInstructionsPhotosCall(String shortName, String salesInstructionID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesinstructions/{salesInstructionID}/photos"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "salesInstructionID" + "}", localVarApiClient.escapeString(salesInstructionID.toString()));
    ...
    public okhttp3.Call salesControllerGetSalesInstructionsRoomsCall(String shortName, String salesInstructionID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesinstructions/{salesInstructionID}/rooms"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "salesInstructionID" + "}", localVarApiClient.escapeString(salesInstructionID.toString()));
    ...
    /**
     * Build call for v2Tier1ShortNameSalesSalesfeaturetypesGet
     * @param shortName The unique client short-name (required)
     * @param offset The index of the first item to return (required)
     * @param count The maximum number of items to return (up to 1000 per request) (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesfeaturetypesGetCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesfeaturetypes"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNameSalesSalesfeaturetypesGetValidateBeforeCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNameSalesSalesfeaturetypesGet(Async)");
        }

        // verify the required parameter 'offset' is set
        if (offset == null) {
            throw new ApiException("Missing the required parameter 'offset' when calling v2Tier1ShortNameSalesSalesfeaturetypesGet(Async)");
        }

        // verify the required parameter 'count' is set
        if (count == null) {
            throw new ApiException("Missing the required parameter 'count' when calling v2Tier1ShortNameSalesSalesfeaturetypesGet(Async)");
        }

        return v2Tier1ShortNameSalesSalesfeaturetypesGetCall(shortName, offset, count, _callback);
     ...
     */
    public SalesFeatureTypeModelResults v2Tier1ShortNameSalesSalesfeaturetypesGet(String shortName, Integer offset, Integer count) throws ApiException {
        ApiResponse<SalesFeatureTypeModelResults> localVarResp = v2Tier1ShortNameSalesSalesfeaturetypesGetWithHttpInfo(shortName, offset, count);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SalesFeatureTypeModelResults> v2Tier1ShortNameSalesSalesfeaturetypesGetWithHttpInfo(String shortName, Integer offset, Integer count) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesfeaturetypesGetValidateBeforeCall(shortName, offset, count, null);
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesfeaturetypesGetAsync(String shortName, Integer offset, Integer count, final ApiCallback<SalesFeatureTypeModelResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesfeaturetypesGetValidateBeforeCall(shortName, offset, count, _callback);
        Type localVarReturnType = new TypeToken<SalesFeatureTypeModelResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet
     * @param shortName The unique client short-name (required)
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetCall(String shortName, String salesFeatureTypeID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesfeaturetypes/{salesFeatureTypeID}"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetValidateBeforeCall(String shortName, String salesFeatureTypeID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet(Async)");
        }

        // verify the required parameter 'salesFeatureTypeID' is set
        if (salesFeatureTypeID == null) {
            throw new ApiException("Missing the required parameter 'salesFeatureTypeID' when calling v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet(Async)");
        }

        return v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetCall(shortName, salesFeatureTypeID, _callback);
     ...
     */
    public SalesFeatureTypeModel v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGet(String shortName, String salesFeatureTypeID) throws ApiException {
        ApiResponse<SalesFeatureTypeModel> localVarResp = v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetWithHttpInfo(shortName, salesFeatureTypeID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SalesFeatureTypeModel> v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetWithHttpInfo(String shortName, String salesFeatureTypeID) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetValidateBeforeCall(shortName, salesFeatureTypeID, null);
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetAsync(String shortName, String salesFeatureTypeID, final ApiCallback<SalesFeatureTypeModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesfeaturetypesSalesFeatureTypeIDGetValidateBeforeCall(shortName, salesFeatureTypeID, _callback);
        Type localVarReturnType = new TypeToken<SalesFeatureTypeModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for v2Tier1ShortNameSalesSalesinstructionsGet
     * @param shortName The unique client short-name (required)
     * @param offset The index of the first item to return (required)
     * @param count The maximum number of items to return (up to 1000 per request) (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesinstructionsGetCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesinstructions"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNameSalesSalesinstructionsGetValidateBeforeCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNameSalesSalesinstructionsGet(Async)");
        }

        // verify the required parameter 'offset' is set
        if (offset == null) {
            throw new ApiException("Missing the required parameter 'offset' when calling v2Tier1ShortNameSalesSalesinstructionsGet(Async)");
        }

        // verify the required parameter 'count' is set
        if (count == null) {
            throw new ApiException("Missing the required parameter 'count' when calling v2Tier1ShortNameSalesSalesinstructionsGet(Async)");
        }

        return v2Tier1ShortNameSalesSalesinstructionsGetCall(shortName, offset, count, _callback);
     ...
     */
    public SalesInstructionModelResults v2Tier1ShortNameSalesSalesinstructionsGet(String shortName, Integer offset, Integer count) throws ApiException {
        ApiResponse<SalesInstructionModelResults> localVarResp = v2Tier1ShortNameSalesSalesinstructionsGetWithHttpInfo(shortName, offset, count);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SalesInstructionModelResults> v2Tier1ShortNameSalesSalesinstructionsGetWithHttpInfo(String shortName, Integer offset, Integer count) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesinstructionsGetValidateBeforeCall(shortName, offset, count, null);
        Type localVarReturnType = new TypeToken<SalesInstructionModelResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesinstructionsGetAsync(String shortName, Integer offset, Integer count, final ApiCallback<SalesInstructionModelResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesinstructionsGetValidateBeforeCall(shortName, offset, count, _callback);
        Type localVarReturnType = new TypeToken<SalesInstructionModelResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGet
     * @param shortName The unique client short-name (required)
     * @param salesInstructionID The unique ID of the SalesInstruction (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetCall(String shortName, String salesInstructionID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/sales/salesinstructions/{salesInstructionID}"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "salesInstructionID" + "}", localVarApiClient.escapeString(salesInstructionID.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetValidateBeforeCall(String shortName, String salesInstructionID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGet(Async)");
        }

        // verify the required parameter 'salesInstructionID' is set
        if (salesInstructionID == null) {
            throw new ApiException("Missing the required parameter 'salesInstructionID' when calling v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGet(Async)");
        }

        return v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetCall(shortName, salesInstructionID, _callback);
     ...
     */
    public SalesInstructionModel v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGet(String shortName, String salesInstructionID) throws ApiException {
        ApiResponse<SalesInstructionModel> localVarResp = v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetWithHttpInfo(shortName, salesInstructionID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SalesInstructionModel> v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetWithHttpInfo(String shortName, String salesInstructionID) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetValidateBeforeCall(shortName, salesInstructionID, null);
     ...
     */
    public okhttp3.Call v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetAsync(String shortName, String salesInstructionID, final ApiCallback<SalesInstructionModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNameSalesSalesinstructionsSalesInstructionIDGetValidateBeforeCall(shortName, salesInstructionID, _callback);
        Type localVarReturnType = new TypeToken<SalesInstructionModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
