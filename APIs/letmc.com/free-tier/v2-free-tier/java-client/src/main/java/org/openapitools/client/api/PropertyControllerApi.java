...
public class PropertyControllerApi {
    ...
    public okhttp3.Call propertyControllerGetPropertiesFacilitiesCall(String shortName, String propertyID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/tier1/{shortName}/property/properties/{propertyID}/facilities"
    ...
    public okhttp3.Call propertyControllerGetPropertiesPhotosCall(String shortName, String propertyID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/properties/{propertyID}/photos"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "propertyID" + "}", localVarApiClient.escapeString(propertyID.toString()));
    ...
    public okhttp3.Call propertyControllerGetPropertiesRoomsCall(String shortName, String propertyID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/properties/{propertyID}/rooms"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "propertyID" + "}", localVarApiClient.escapeString(propertyID.toString()));
    ...
    public okhttp3.Call propertyControllerGetPropertiesTenanciesCall(String shortName, String propertyID, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/properties/{propertyID}/tenancies"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "propertyID" + "}", localVarApiClient.escapeString(propertyID.toString()));
    ...
    public okhttp3.Call propertyControllerGetPropertyEERDownloadCall(String shortName, String propertyStructureID, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/structures/{propertyStructureID}/reports/eer"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
    ...
    public okhttp3.Call propertyControllerGetPropertyEIRDownloadCall(String shortName, String propertyStructureID, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/structures/{propertyStructureID}/reports/eir"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "propertyStructureID" + "}", localVarApiClient.escapeString(propertyStructureID.toString()));
    ...
    /**
     * Build call for v2Tier1ShortNamePropertyPropertiesGet
     * @param shortName The unique client short-name (required)
     * @param offset The index of the first item to return (required)
     * @param count The maximum number of items to return (up to 1000 per request) (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call v2Tier1ShortNamePropertyPropertiesGetCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/properties"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNamePropertyPropertiesGetValidateBeforeCall(String shortName, Integer offset, Integer count, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNamePropertyPropertiesGet(Async)");
        }

        // verify the required parameter 'offset' is set
        if (offset == null) {
            throw new ApiException("Missing the required parameter 'offset' when calling v2Tier1ShortNamePropertyPropertiesGet(Async)");
        }

        // verify the required parameter 'count' is set
        if (count == null) {
            throw new ApiException("Missing the required parameter 'count' when calling v2Tier1ShortNamePropertyPropertiesGet(Async)");
        }

        return v2Tier1ShortNamePropertyPropertiesGetCall(shortName, offset, count, _callback);
     ...
     */
    public PropertyModelResults v2Tier1ShortNamePropertyPropertiesGet(String shortName, Integer offset, Integer count) throws ApiException {
        ApiResponse<PropertyModelResults> localVarResp = v2Tier1ShortNamePropertyPropertiesGetWithHttpInfo(shortName, offset, count);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PropertyModelResults> v2Tier1ShortNamePropertyPropertiesGetWithHttpInfo(String shortName, Integer offset, Integer count) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNamePropertyPropertiesGetValidateBeforeCall(shortName, offset, count, null);
     ...
     */
    public okhttp3.Call v2Tier1ShortNamePropertyPropertiesGetAsync(String shortName, Integer offset, Integer count, final ApiCallback<PropertyModelResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNamePropertyPropertiesGetValidateBeforeCall(shortName, offset, count, _callback);
        Type localVarReturnType = new TypeToken<PropertyModelResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for v2Tier1ShortNamePropertyPropertiesPropertyIDGet
     * @param shortName The unique client short-name (required)
     * @param propertyID The unique ID of the Property (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call v2Tier1ShortNamePropertyPropertiesPropertyIDGetCall(String shortName, String propertyID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/tier1/{shortName}/property/properties/{propertyID}"
            .replace("{" + "shortName" + "}", localVarApiClient.escapeString(shortName.toString()))
            .replace("{" + "propertyID" + "}", localVarApiClient.escapeString(propertyID.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v2Tier1ShortNamePropertyPropertiesPropertyIDGetValidateBeforeCall(String shortName, String propertyID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'shortName' is set
        if (shortName == null) {
            throw new ApiException("Missing the required parameter 'shortName' when calling v2Tier1ShortNamePropertyPropertiesPropertyIDGet(Async)");
        }

        // verify the required parameter 'propertyID' is set
        if (propertyID == null) {
            throw new ApiException("Missing the required parameter 'propertyID' when calling v2Tier1ShortNamePropertyPropertiesPropertyIDGet(Async)");
        }

        return v2Tier1ShortNamePropertyPropertiesPropertyIDGetCall(shortName, propertyID, _callback);
     ...
     */
    public PropertyModel v2Tier1ShortNamePropertyPropertiesPropertyIDGet(String shortName, String propertyID) throws ApiException {
        ApiResponse<PropertyModel> localVarResp = v2Tier1ShortNamePropertyPropertiesPropertyIDGetWithHttpInfo(shortName, propertyID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PropertyModel> v2Tier1ShortNamePropertyPropertiesPropertyIDGetWithHttpInfo(String shortName, String propertyID) throws ApiException {
        okhttp3.Call localVarCall = v2Tier1ShortNamePropertyPropertiesPropertyIDGetValidateBeforeCall(shortName, propertyID, null);
     ...
     */
    public okhttp3.Call v2Tier1ShortNamePropertyPropertiesPropertyIDGetAsync(String shortName, String propertyID, final ApiCallback<PropertyModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = v2Tier1ShortNamePropertyPropertiesPropertyIDGetValidateBeforeCall(shortName, propertyID, _callback);
        Type localVarReturnType = new TypeToken<PropertyModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
