# LetMcApiV2FreeTier1.PropertyRoomModel
...
**heightCentimeters** | **Number** | Gets the CentiMeter part of the room Height. | [optional] 
**heightMeters** | **Number** | Gets the Meter part of the room Height. | [optional] 
**lengthCentimeters** | **Number** | Gets the CentiMeter part of the room Length. | [optional] 
**lengthMeters** | **Number** | Gets the Meter part of the room Length. | [optional] 
...
**roomFloor** | **String** | Gets and sets the room floor. | [optional] 
**roomName** | **String** | The room name (if applicable). | [optional] 
**widthCentiMeters** | **Number** | Gets the CentiMeter part of the room width. | [optional] 
**widthMeters** | **Number** | Gets the Meter part of the room width. | [optional] 
