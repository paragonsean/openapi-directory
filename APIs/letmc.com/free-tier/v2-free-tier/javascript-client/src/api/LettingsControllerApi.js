    ...
    */
    ...
    lettingsControllerGetAdvertised(shortName, branchID, offset, count, opts, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier1/{shortName}/lettings/advertised', 'GET',
    ...
    lettingsControllerGetAdvertisedBetweenDates(shortName, branchID, offset, count, rangeStartDate, rangeEndDate, opts, callback) {
      ...
      let returnType = TenancyModelResults;
      return this.apiClient.callApi(
        '/v2/tier1/{shortName}/lettings/advertisedbetweendates', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    lettingsControllerGetTenancyBrochure(shortName, tenancyID, callback) {
      ...
      return this.apiClient.callApi(
        '/v2/tier1/{shortName}/lettings/tenancies/{tenancyID}/brochure', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the v2Tier1ShortNameLettingsTenanciesGet operation.
     * @callback module:api/LettingsControllerApi~v2Tier1ShortNameLettingsTenanciesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TenancyModelResults} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} offset The index of the first item to return
     * @param {Number} count The maximum number of items to return (up to 1000 per request)
     * @param {module:api/LettingsControllerApi~v2Tier1ShortNameLettingsTenanciesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TenancyModelResults}
     */
    v2Tier1ShortNameLettingsTenanciesGet(shortName, offset, count, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier1ShortNameLettingsTenanciesGet");
      }
      // verify the required parameter 'offset' is set
      if (offset === undefined || offset === null) {
        throw new Error("Missing the required parameter 'offset' when calling v2Tier1ShortNameLettingsTenanciesGet");
      }
      // verify the required parameter 'count' is set
      if (count === undefined || count === null) {
        throw new Error("Missing the required parameter 'count' when calling v2Tier1ShortNameLettingsTenanciesGet");
      }
    ...
    /**
     * Callback function to receive the result of the v2Tier1ShortNameLettingsTenanciesTenancyIDGet operation.
     * @callback module:api/LettingsControllerApi~v2Tier1ShortNameLettingsTenanciesTenancyIDGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} shortName The unique client short-name
     * @param {String} tenancyID The unique ID of the Tenancy
     * @param {module:api/LettingsControllerApi~v2Tier1ShortNameLettingsTenanciesTenancyIDGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TenancyModel}
     */
    v2Tier1ShortNameLettingsTenanciesTenancyIDGet(shortName, tenancyID, callback) {
      let postBody = null;
      // verify the required parameter 'shortName' is set
      if (shortName === undefined || shortName === null) {
        throw new Error("Missing the required parameter 'shortName' when calling v2Tier1ShortNameLettingsTenanciesTenancyIDGet");
      }
      // verify the required parameter 'tenancyID' is set
      if (tenancyID === undefined || tenancyID === null) {
        throw new Error("Missing the required parameter 'tenancyID' when calling v2Tier1ShortNameLettingsTenanciesTenancyIDGet");
      }
