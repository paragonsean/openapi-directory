...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2FreeTier1.AreaModel();
  });
  ...
  describe('AreaModel', function() {
    it('should create an instance of AreaModel', function() {
      // uncomment below and update the code to test AreaModel
      //var instance = new LetMcApiV2FreeTier1.AreaModel();
      //expect(instance).to.be.a(LetMcApiV2FreeTier1.AreaModel);
    });
    ...
    it('should have the property showOnSites (base name: "ShowOnSites")', function() {
      // uncomment below and update the code to test the property showOnSites
      //var instance = new LetMcApiV2FreeTier1.AreaModel();
      //expect(instance).to.be();
    });
