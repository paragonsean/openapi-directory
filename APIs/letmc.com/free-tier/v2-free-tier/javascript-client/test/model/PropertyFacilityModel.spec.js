...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2FreeTier1.PropertyFacilityModel();
  });
  ...
  describe('PropertyFacilityModel', function() {
    it('should create an instance of PropertyFacilityModel', function() {
      ...
      //var instance = new LetMcApiV2FreeTier1.PropertyFacilityModel();
      //expect(instance).to.be.a(LetMcApiV2FreeTier1.PropertyFacilityModel);
    });
