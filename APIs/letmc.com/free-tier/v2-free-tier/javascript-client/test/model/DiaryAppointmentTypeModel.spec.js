...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2FreeTier1.DiaryAppointmentTypeModel();
  });
  ...
  describe('DiaryAppointmentTypeModel', function() {
    it('should create an instance of DiaryAppointmentTypeModel', function() {
      ...
      //var instance = new LetMcApiV2FreeTier1.DiaryAppointmentTypeModel();
      //expect(instance).to.be.a(LetMcApiV2FreeTier1.DiaryAppointmentTypeModel);
    });
