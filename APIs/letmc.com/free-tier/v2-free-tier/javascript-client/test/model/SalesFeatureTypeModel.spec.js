...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2FreeTier1.SalesFeatureTypeModel();
  });
  ...
  describe('SalesFeatureTypeModel', function() {
    it('should create an instance of SalesFeatureTypeModel', function() {
      ...
      //var instance = new LetMcApiV2FreeTier1.SalesFeatureTypeModel();
      //expect(instance).to.be.a(LetMcApiV2FreeTier1.SalesFeatureTypeModel);
    });
