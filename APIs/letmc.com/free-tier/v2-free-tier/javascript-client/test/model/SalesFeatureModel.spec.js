...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LetMcApiV2FreeTier1.SalesFeatureModel();
  });
  ...
  describe('SalesFeatureModel', function() {
    it('should create an instance of SalesFeatureModel', function() {
      // uncomment below and update the code to test SalesFeatureModel
      //var instance = new LetMcApiV2FreeTier1.SalesFeatureModel();
      //expect(instance).to.be.a(LetMcApiV2FreeTier1.SalesFeatureModel);
    });
