...
async def test_property_controller_get_properties_facilities(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/properties/{property_id}/facilities'.format(short_name='short_name_example', property_id='property_id_example'),
        headers=headers,
        params=params,
        )
...
async def test_property_controller_get_properties_photos(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/properties/{property_id}/photos'.format(short_name='short_name_example', property_id='property_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_property_controller_get_properties_rooms(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/properties/{property_id}/rooms'.format(short_name='short_name_example', property_id='property_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_property_controller_get_properties_tenancies(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/properties/{property_id}/tenancies'.format(short_name='short_name_example', property_id='property_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_property_controller_get_property_eer_download(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/structures/{property_structure_id}/reports/eer'.format(short_name='short_name_example', property_structure_id='property_structure_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_property_controller_get_property_eir_download(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/structures/{property_structure_id}/reports/eir'.format(short_name='short_name_example', property_structure_id='property_structure_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier1_short_name_property_properties_get(client):
    """Test case for v2_tier1_short_name_property_properties_get
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/properties'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier1_short_name_property_properties_property_idget(client):
    """Test case for v2_tier1_short_name_property_properties_property_idget
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/property/properties/{property_id}'.format(short_name='short_name_example', property_id='property_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
