...
async def test_lettings_controller_get_advertised(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/lettings/advertised'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
...
async def test_lettings_controller_get_advertised_between_dates(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/lettings/advertisedbetweendates'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_lettings_controller_get_tenancy_brochure(client):
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/lettings/tenancies/{tenancy_id}/brochure'.format(short_name='short_name_example', tenancy_id='tenancy_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier1_short_name_lettings_tenancies_get(client):
    """Test case for v2_tier1_short_name_lettings_tenancies_get
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/lettings/tenancies'.format(short_name='short_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_v2_tier1_short_name_lettings_tenancies_tenancy_idget(client):
    """Test case for v2_tier1_short_name_lettings_tenancies_tenancy_idget
    ...
    response = await client.request(
        method='GET',
        path='/v2/tier1/{short_name}/lettings/tenancies/{tenancy_id}'.format(short_name='short_name_example', tenancy_id='tenancy_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
