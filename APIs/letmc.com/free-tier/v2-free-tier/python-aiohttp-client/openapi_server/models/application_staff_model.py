...
class ApplicationStaffModel(Model):
    ...
    def __init__(self, e_tag: str=None, forename: str=None, global_reference: str=None, is_enabled: bool=None, managed_by: str=None, middlename: str=None, oid: str=None, surname: str=None, title: str=None):
