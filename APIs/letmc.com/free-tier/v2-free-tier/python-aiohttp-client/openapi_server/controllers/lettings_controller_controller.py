...
async def v2_tier1_short_name_lettings_tenancies_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier1_short_name_lettings_tenancies_tenancy_idget(request: web.Request, short_name, tenancy_id) -> web.Response:
