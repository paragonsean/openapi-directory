...
async def v2_tier1_short_name_staff_staff_application_staff_idget(request: web.Request, short_name, application_staff_id) -> web.Response:
...
async def v2_tier1_short_name_staff_staff_get(request: web.Request, short_name, offset, count) -> web.Response:
