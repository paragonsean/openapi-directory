...
async def v2_tier1_short_name_property_properties_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier1_short_name_property_properties_property_idget(request: web.Request, short_name, property_id) -> web.Response:
