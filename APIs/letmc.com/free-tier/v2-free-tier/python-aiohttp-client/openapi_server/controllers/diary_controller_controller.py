...
async def v2_tier1_short_name_diary_allocations_diary_allocation_idget(request: web.Request, short_name, diary_allocation_id) -> web.Response:
...
async def v2_tier1_short_name_diary_allocations_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier1_short_name_diary_appointments_diary_appointment_idget(request: web.Request, short_name, diary_appointment_id) -> web.Response:
...
async def v2_tier1_short_name_diary_appointments_get(request: web.Request, short_name, offset, count) -> web.Response:
...
async def v2_tier1_short_name_diary_appointmenttypes_diary_appointment_type_idget(request: web.Request, short_name, diary_appointment_type_id) -> web.Response:
...
async def v2_tier1_short_name_diary_appointmenttypes_get(request: web.Request, short_name, offset, count) -> web.Response:
