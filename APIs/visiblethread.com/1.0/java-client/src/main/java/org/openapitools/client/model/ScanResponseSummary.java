...
import org.openapitools.client.model.ScanSummary;
...
public class ScanResponseSummary {
  ...
  public ScanResponseSummary() {
  }

  public ScanResponseSummary completed(OffsetDateTime completed) {
  ...
  public ScanResponseSummary eta(OffsetDateTime eta) {
    this.eta = eta;
    return this;
  }
  ...
  public ScanResponseSummary id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public ScanResponseSummary scan(ScanSummary scan) {
    this.scan = scan;
    return this;
  }
  ...
  public void setScan(ScanSummary scan) {
    this.scan = scan;
  }


  public ScanResponseSummary started(OffsetDateTime started) {
  ...
  public boolean equals(Object o) {
    ...
    ScanResponseSummary scanResponseSummary = (ScanResponseSummary) o;
    return Objects.equals(this.completed, scanResponseSummary.completed) &&
        Objects.equals(this.eta, scanResponseSummary.eta) &&
        Objects.equals(this.id, scanResponseSummary.id) &&
        Objects.equals(this.scan, scanResponseSummary.scan) &&
        Objects.equals(this.started, scanResponseSummary.started);
  }

  @Override
  public int hashCode() {
    return Objects.hash(completed, eta, id, scan, started);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScanResponseSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScanResponseSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScanResponseSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScanResponseSummary is not found in the empty JSON string", ScanResponseSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScanResponseSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScanResponseSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `scan`
      if (jsonObj.get("scan") != null && !jsonObj.get("scan").isJsonNull()) {
        ScanSummary.validateJsonElement(jsonObj.get("scan"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScanResponseSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScanResponseSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScanResponseSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScanResponseSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ScanResponseSummary>() {
           @Override
           public void write(JsonWriter out, ScanResponseSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScanResponseSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScanResponseSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScanResponseSummary
   * @throws IOException if the JSON string is invalid with respect to ScanResponseSummary
   */
  public static ScanResponseSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScanResponseSummary.class);
  }

  /**
   * Convert an instance of ScanResponseSummary to an JSON string
   *
   * @return JSON string
   */
