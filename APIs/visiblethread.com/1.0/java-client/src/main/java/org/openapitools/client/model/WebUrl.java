...
public class WebUrl {
  ...
  public WebUrl analysis(Analysis analysis) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webUrl.id) &&
        ...
        Objects.equals(this.analysis, webUrl.analysis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, url, analysis);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebUrl is not found in the empty JSON string", WebUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebUrl.openapiRequiredFields) {
      ...
      Analysis.validateJsonElement(jsonObj.get("analysis"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<WebUrl>() {
           @Override
           public void write(JsonWriter out, WebUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebUrl
   * @throws IOException if the JSON string is invalid with respect to WebUrl
   */
  public static WebUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebUrl.class);
  }

  /**
   * Convert an instance of WebUrl to an JSON string
   *
   * @return JSON string
   */
