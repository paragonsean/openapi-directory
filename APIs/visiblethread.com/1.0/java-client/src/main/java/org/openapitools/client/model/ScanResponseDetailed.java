...
import org.openapitools.client.model.ScanDetailed;
...
public class ScanResponseDetailed {
  ...
  private ScanDetailed scan;

  public static final String SERIALIZED_NAME_STARTED = "started";
  @SerializedName(SERIALIZED_NAME_STARTED)
  private OffsetDateTime started;

  public ScanResponseDetailed() {
  }

  public ScanResponseDetailed completed(OffsetDateTime completed) {
  ...
  public ScanResponseDetailed eta(OffsetDateTime eta) {
    this.eta = eta;
    return this;
  }
  ...
  public ScanResponseDetailed id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public ScanResponseDetailed scan(ScanDetailed scan) {
    this.scan = scan;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ScanDetailed getScan() {
    return scan;
  }

  public void setScan(ScanDetailed scan) {
    this.scan = scan;
  }


  public ScanResponseDetailed started(OffsetDateTime started) {
  ...
  public boolean equals(Object o) {
    ...
    ScanResponseDetailed scanResponseDetailed = (ScanResponseDetailed) o;
    return Objects.equals(this.completed, scanResponseDetailed.completed) &&
        Objects.equals(this.eta, scanResponseDetailed.eta) &&
        Objects.equals(this.id, scanResponseDetailed.id) &&
        Objects.equals(this.scan, scanResponseDetailed.scan) &&
        Objects.equals(this.started, scanResponseDetailed.started);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScanResponseDetailed {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScanResponseDetailed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScanResponseDetailed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScanResponseDetailed is not found in the empty JSON string", ScanResponseDetailed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScanResponseDetailed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScanResponseDetailed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `scan`
      if (jsonObj.get("scan") != null && !jsonObj.get("scan").isJsonNull()) {
        ScanDetailed.validateJsonElement(jsonObj.get("scan"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScanResponseDetailed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScanResponseDetailed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScanResponseDetailed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScanResponseDetailed.class));

       return (TypeAdapter<T>) new TypeAdapter<ScanResponseDetailed>() {
           @Override
           public void write(JsonWriter out, ScanResponseDetailed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScanResponseDetailed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScanResponseDetailed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScanResponseDetailed
   * @throws IOException if the JSON string is invalid with respect to ScanResponseDetailed
   */
  public static ScanResponseDetailed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScanResponseDetailed.class);
  }

  /**
   * Convert an instance of ScanResponseDetailed to an JSON string
   *
   * @return JSON string
   */
