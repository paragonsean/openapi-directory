...
public class NewScanResponseWebUrlsInner {
  ...
  public NewScanResponseWebUrlsInner() {
  }

  public NewScanResponseWebUrlsInner id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public NewScanResponseWebUrlsInner url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NewScanResponseWebUrlsInner newScanResponseWebUrlsInner = (NewScanResponseWebUrlsInner) o;
    return Objects.equals(this.id, newScanResponseWebUrlsInner.id) &&
        Objects.equals(this.url, newScanResponseWebUrlsInner.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewScanResponseWebUrlsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewScanResponseWebUrlsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewScanResponseWebUrlsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewScanResponseWebUrlsInner is not found in the empty JSON string", NewScanResponseWebUrlsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewScanResponseWebUrlsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewScanResponseWebUrlsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewScanResponseWebUrlsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewScanResponseWebUrlsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewScanResponseWebUrlsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewScanResponseWebUrlsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewScanResponseWebUrlsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NewScanResponseWebUrlsInner>() {
           @Override
           public void write(JsonWriter out, NewScanResponseWebUrlsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewScanResponseWebUrlsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewScanResponseWebUrlsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewScanResponseWebUrlsInner
   * @throws IOException if the JSON string is invalid with respect to NewScanResponseWebUrlsInner
   */
  public static NewScanResponseWebUrlsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewScanResponseWebUrlsInner.class);
  }

  /**
   * Convert an instance of NewScanResponseWebUrlsInner to an JSON string
   *
   * @return JSON string
   */
