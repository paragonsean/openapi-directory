...
public class WebResponseNotReady {
  ...
  public WebResponseNotReady() {
  }

  public WebResponseNotReady eta(OffsetDateTime eta) {
    this.eta = eta;
    return this;
  }
  ...
  public WebResponseNotReady id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public WebResponseNotReady started(OffsetDateTime started) {
  ...
  public boolean equals(Object o) {
    ...
    WebResponseNotReady webResponseNotReady = (WebResponseNotReady) o;
    return Objects.equals(this.eta, webResponseNotReady.eta) &&
        Objects.equals(this.id, webResponseNotReady.id) &&
        Objects.equals(this.started, webResponseNotReady.started);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebResponseNotReady {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebResponseNotReady
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebResponseNotReady.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebResponseNotReady is not found in the empty JSON string", WebResponseNotReady.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebResponseNotReady.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebResponseNotReady` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebResponseNotReady.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebResponseNotReady' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebResponseNotReady> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebResponseNotReady.class));

       return (TypeAdapter<T>) new TypeAdapter<WebResponseNotReady>() {
           @Override
           public void write(JsonWriter out, WebResponseNotReady value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebResponseNotReady read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebResponseNotReady given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebResponseNotReady
   * @throws IOException if the JSON string is invalid with respect to WebResponseNotReady
   */
  public static WebResponseNotReady fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebResponseNotReady.class);
  }

  /**
   * Convert an instance of WebResponseNotReady to an JSON string
   *
   * @return JSON string
   */
