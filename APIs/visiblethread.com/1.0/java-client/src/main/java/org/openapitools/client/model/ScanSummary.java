...
import org.openapitools.client.model.WebUrlHeader;
...
public class ScanSummary {
  ...
  private List<WebUrlHeader> webUrls = new ArrayList<>();

  public ScanSummary() {
  }

  public ScanSummary title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ScanSummary webUrls(List<WebUrlHeader> webUrls) {
    this.webUrls = webUrls;
    return this;
  }

  public ScanSummary addWebUrlsItem(WebUrlHeader webUrlsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<WebUrlHeader> getWebUrls() {
    return webUrls;
  }

  public void setWebUrls(List<WebUrlHeader> webUrls) {
    this.webUrls = webUrls;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, scanSummary.title) &&
        Objects.equals(this.webUrls, scanSummary.webUrls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, webUrls);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraywebUrls.size(); i++) {
        WebUrlHeader.validateJsonElement(jsonArraywebUrls.get(i));
      };
  }
