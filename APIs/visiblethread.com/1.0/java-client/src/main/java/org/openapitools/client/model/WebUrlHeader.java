...
public class WebUrlHeader {
  ...
  public WebUrlHeader id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public WebUrlHeader url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebUrlHeader webUrlHeader = (WebUrlHeader) o;
    return Objects.equals(this.id, webUrlHeader.id) &&
        Objects.equals(this.url, webUrlHeader.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebUrlHeader
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebUrlHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebUrlHeader is not found in the empty JSON string", WebUrlHeader.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebUrlHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebUrlHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebUrlHeader.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebUrlHeader.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebUrlHeader' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebUrlHeader> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebUrlHeader.class));

       return (TypeAdapter<T>) new TypeAdapter<WebUrlHeader>() {
           @Override
           public void write(JsonWriter out, WebUrlHeader value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebUrlHeader read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebUrlHeader given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebUrlHeader
   * @throws IOException if the JSON string is invalid with respect to WebUrlHeader
   */
  public static WebUrlHeader fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebUrlHeader.class);
  }

  /**
   * Convert an instance of WebUrlHeader to an JSON string
   *
   * @return JSON string
   */
