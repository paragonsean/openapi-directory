...
public class NewScanScanSettings {
  ...
  public NewScanScanSettings() {
  }

  public NewScanScanSettings longSentenceWordCount(Integer longSentenceWordCount) {
  ...
  public NewScanScanSettings veryLongSentenceWordCount(Integer veryLongSentenceWordCount) {
  ...
  public boolean equals(Object o) {
    ...
    NewScanScanSettings newScanScanSettings = (NewScanScanSettings) o;
    return Objects.equals(this.longSentenceWordCount, newScanScanSettings.longSentenceWordCount) &&
        Objects.equals(this.veryLongSentenceWordCount, newScanScanSettings.veryLongSentenceWordCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewScanScanSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewScanScanSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewScanScanSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewScanScanSettings is not found in the empty JSON string", NewScanScanSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewScanScanSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewScanScanSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewScanScanSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewScanScanSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewScanScanSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewScanScanSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<NewScanScanSettings>() {
           @Override
           public void write(JsonWriter out, NewScanScanSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewScanScanSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewScanScanSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewScanScanSettings
   * @throws IOException if the JSON string is invalid with respect to NewScanScanSettings
   */
  public static NewScanScanSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewScanScanSettings.class);
  }

  /**
   * Convert an instance of NewScanScanSettings to an JSON string
   *
   * @return JSON string
   */
