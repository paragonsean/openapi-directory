...
public class DocumentResponseNotReady {
  ...
  public DocumentResponseNotReady() {
  }

  public DocumentResponseNotReady eta(OffsetDateTime eta) {
    this.eta = eta;
    return this;
  }
  ...
  public DocumentResponseNotReady id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public DocumentResponseNotReady started(OffsetDateTime started) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentResponseNotReady documentResponseNotReady = (DocumentResponseNotReady) o;
    return Objects.equals(this.eta, documentResponseNotReady.eta) &&
        Objects.equals(this.id, documentResponseNotReady.id) &&
        Objects.equals(this.started, documentResponseNotReady.started);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eta, id, started);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentResponseNotReady {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentResponseNotReady
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentResponseNotReady.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentResponseNotReady is not found in the empty JSON string", DocumentResponseNotReady.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentResponseNotReady.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentResponseNotReady` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentResponseNotReady.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentResponseNotReady' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentResponseNotReady> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentResponseNotReady.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentResponseNotReady>() {
           @Override
           public void write(JsonWriter out, DocumentResponseNotReady value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentResponseNotReady read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentResponseNotReady given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentResponseNotReady
   * @throws IOException if the JSON string is invalid with respect to DocumentResponseNotReady
   */
  public static DocumentResponseNotReady fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentResponseNotReady.class);
  }

  /**
   * Convert an instance of DocumentResponseNotReady to an JSON string
   *
   * @return JSON string
   */
