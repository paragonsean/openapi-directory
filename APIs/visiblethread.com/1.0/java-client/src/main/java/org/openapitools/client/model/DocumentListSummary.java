...
public class DocumentListSummary {
  ...
  public DocumentListSummary() {
  }

  public DocumentListSummary id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public DocumentListSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DocumentListSummary documentListSummary = (DocumentListSummary) o;
    return Objects.equals(this.id, documentListSummary.id) &&
        Objects.equals(this.name, documentListSummary.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentListSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DocumentListSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentListSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentListSummary is not found in the empty JSON string", DocumentListSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentListSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DocumentListSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DocumentListSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DocumentListSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DocumentListSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DocumentListSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<DocumentListSummary>() {
           @Override
           public void write(JsonWriter out, DocumentListSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DocumentListSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DocumentListSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DocumentListSummary
   * @throws IOException if the JSON string is invalid with respect to DocumentListSummary
   */
  public static DocumentListSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DocumentListSummary.class);
  }

  /**
   * Convert an instance of DocumentListSummary to an JSON string
   *
   * @return JSON string
   */
