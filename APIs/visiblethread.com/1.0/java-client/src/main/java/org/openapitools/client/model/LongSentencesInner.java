...
public class LongSentencesInner {
  ...
  public LongSentencesInner() {
  }

  public LongSentencesInner end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public LongSentencesInner start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public LongSentencesInner wordCount(Integer wordCount) {
  ...
  public boolean equals(Object o) {
    ...
    LongSentencesInner longSentencesInner = (LongSentencesInner) o;
    return Objects.equals(this.end, longSentencesInner.end) &&
        Objects.equals(this.start, longSentencesInner.start) &&
        Objects.equals(this.wordCount, longSentencesInner.wordCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class LongSentencesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LongSentencesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LongSentencesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LongSentencesInner is not found in the empty JSON string", LongSentencesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LongSentencesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LongSentencesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LongSentencesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LongSentencesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LongSentencesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LongSentencesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LongSentencesInner>() {
           @Override
           public void write(JsonWriter out, LongSentencesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LongSentencesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LongSentencesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LongSentencesInner
   * @throws IOException if the JSON string is invalid with respect to LongSentencesInner
   */
  public static LongSentencesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LongSentencesInner.class);
  }

  /**
   * Convert an instance of LongSentencesInner to an JSON string
   *
   * @return JSON string
   */
