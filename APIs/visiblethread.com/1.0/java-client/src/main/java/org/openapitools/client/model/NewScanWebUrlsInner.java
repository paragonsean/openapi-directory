...
public class NewScanWebUrlsInner {
  public static final String SERIALIZED_NAME_URL = "url";
  @SerializedName(SERIALIZED_NAME_URL)
  private String url;

  public NewScanWebUrlsInner() {
  }

  public NewScanWebUrlsInner url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NewScanWebUrlsInner newScanWebUrlsInner = (NewScanWebUrlsInner) o;
    return Objects.equals(this.url, newScanWebUrlsInner.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewScanWebUrlsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NewScanWebUrlsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NewScanWebUrlsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NewScanWebUrlsInner is not found in the empty JSON string", NewScanWebUrlsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NewScanWebUrlsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NewScanWebUrlsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NewScanWebUrlsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NewScanWebUrlsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NewScanWebUrlsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NewScanWebUrlsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NewScanWebUrlsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NewScanWebUrlsInner>() {
           @Override
           public void write(JsonWriter out, NewScanWebUrlsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NewScanWebUrlsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NewScanWebUrlsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NewScanWebUrlsInner
   * @throws IOException if the JSON string is invalid with respect to NewScanWebUrlsInner
   */
  public static NewScanWebUrlsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NewScanWebUrlsInner.class);
  }

  /**
   * Convert an instance of NewScanWebUrlsInner to an JSON string
   *
   * @return JSON string
   */
