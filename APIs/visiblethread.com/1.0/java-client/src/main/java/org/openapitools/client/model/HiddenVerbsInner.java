...
public class HiddenVerbsInner {
  public static final String SERIALIZED_NAME_END = "end";
  @SerializedName(SERIALIZED_NAME_END)
  private Integer end;

  public static final String SERIALIZED_NAME_NOUN = "noun";
  @SerializedName(SERIALIZED_NAME_NOUN)
  private String noun;
  ...
  public HiddenVerbsInner() {
  }

  public HiddenVerbsInner end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public HiddenVerbsInner noun(String noun) {
    this.noun = noun;
    return this;
  }
  ...
  public HiddenVerbsInner start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public HiddenVerbsInner text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HiddenVerbsInner hiddenVerbsInner = (HiddenVerbsInner) o;
    return Objects.equals(this.end, hiddenVerbsInner.end) &&
        Objects.equals(this.noun, hiddenVerbsInner.noun) &&
        Objects.equals(this.start, hiddenVerbsInner.start) &&
        Objects.equals(this.text, hiddenVerbsInner.text);
  }

  @Override
  public int hashCode() {
    return Objects.hash(end, noun, start, text);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HiddenVerbsInner {\n");
    sb.append("    end: ").append(toIndentedString(end)).append("\n");
    sb.append("    noun: ").append(toIndentedString(noun)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HiddenVerbsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HiddenVerbsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HiddenVerbsInner is not found in the empty JSON string", HiddenVerbsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HiddenVerbsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HiddenVerbsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("noun") != null && !jsonObj.get("noun").isJsonNull()) && !jsonObj.get("noun").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `noun` to be a primitive type in the JSON string but got `%s`", jsonObj.get("noun").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HiddenVerbsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HiddenVerbsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HiddenVerbsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HiddenVerbsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<HiddenVerbsInner>() {
           @Override
           public void write(JsonWriter out, HiddenVerbsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HiddenVerbsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HiddenVerbsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HiddenVerbsInner
   * @throws IOException if the JSON string is invalid with respect to HiddenVerbsInner
   */
  public static HiddenVerbsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HiddenVerbsInner.class);
  }

  /**
   * Convert an instance of HiddenVerbsInner to an JSON string
   *
   * @return JSON string
   */
