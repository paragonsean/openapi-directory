...
public class PassivesInner {
  public static final String SERIALIZED_NAME_END = "end";
  @SerializedName(SERIALIZED_NAME_END)
  private Integer end;

  public static final String SERIALIZED_NAME_PASSIVE_PIECE = "passivePiece";
  @SerializedName(SERIALIZED_NAME_PASSIVE_PIECE)
  private String passivePiece;
  ...
  public PassivesInner() {
  }

  public PassivesInner end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public PassivesInner passivePiece(String passivePiece) {
   ...
   */
  @javax.annotation.Nullable
  public String getPassivePiece() {
    return passivePiece;
  }

  public void setPassivePiece(String passivePiece) {
    this.passivePiece = passivePiece;
  }


  public PassivesInner start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public PassivesInner verb(String verb) {
    this.verb = verb;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PassivesInner passivesInner = (PassivesInner) o;
    return Objects.equals(this.end, passivesInner.end) &&
        Objects.equals(this.passivePiece, passivesInner.passivePiece) &&
        Objects.equals(this.start, passivesInner.start) &&
        Objects.equals(this.verb, passivesInner.verb);
  }

  @Override
  public int hashCode() {
    return Objects.hash(end, passivePiece, start, verb);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassivesInner {\n");
    sb.append("    end: ").append(toIndentedString(end)).append("\n");
    sb.append("    passivePiece: ").append(toIndentedString(passivePiece)).append("\n");
  ...
  static {
    ...
    openapiFields.add("passivePiece");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PassivesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PassivesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PassivesInner is not found in the empty JSON string", PassivesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PassivesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PassivesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("passivePiece") != null && !jsonObj.get("passivePiece").isJsonNull()) && !jsonObj.get("passivePiece").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `passivePiece` to be a primitive type in the JSON string but got `%s`", jsonObj.get("passivePiece").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PassivesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PassivesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PassivesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PassivesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PassivesInner>() {
           @Override
           public void write(JsonWriter out, PassivesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PassivesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PassivesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PassivesInner
   * @throws IOException if the JSON string is invalid with respect to PassivesInner
   */
  public static PassivesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PassivesInner.class);
  }

  /**
   * Convert an instance of PassivesInner to an JSON string
   *
   * @return JSON string
   */
