...
public class AdverbsInner {
  ...
  public AdverbsInner end(Integer end) {
    this.end = end;
    return this;
  }
  ...
  public AdverbsInner start(Integer start) {
    this.start = start;
    return this;
  }
  ...
  public AdverbsInner text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdverbsInner adverbsInner = (AdverbsInner) o;
    return Objects.equals(this.end, adverbsInner.end) &&
        Objects.equals(this.start, adverbsInner.start) &&
        Objects.equals(this.text, adverbsInner.text);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AdverbsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AdverbsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AdverbsInner is not found in the empty JSON string", AdverbsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AdverbsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AdverbsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AdverbsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AdverbsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AdverbsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AdverbsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AdverbsInner>() {
           @Override
           public void write(JsonWriter out, AdverbsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AdverbsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AdverbsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AdverbsInner
   * @throws IOException if the JSON string is invalid with respect to AdverbsInner
   */
  public static AdverbsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AdverbsInner.class);
  }

  /**
   * Convert an instance of AdverbsInner to an JSON string
   *
   * @return JSON string
   */
