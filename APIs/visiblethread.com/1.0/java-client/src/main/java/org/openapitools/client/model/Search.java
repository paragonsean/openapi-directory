...
public class Search {
  public static final String SERIALIZED_NAME_DICT_ID = "dictId";
  @SerializedName(SERIALIZED_NAME_DICT_ID)
  private Long dictId;
  ...
  public Search dictId(Long dictId) {
    this.dictId = dictId;
    return this;
  }
  ...
  public Search docId(Long docId) {
    this.docId = docId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dictId, search.dictId) &&
        Objects.equals(this.docId, search.docId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dictId, docId);
  }
  ...
  static {
    ...
    openapiFields.add("dictId");
    openapiFields.add("docId");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("dictId");
