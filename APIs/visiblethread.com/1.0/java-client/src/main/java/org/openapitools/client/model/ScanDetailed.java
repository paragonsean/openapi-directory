...
import org.openapitools.client.model.WebUrl;
...
public class ScanDetailed {
  ...
  private List<WebUrl> webUrls = new ArrayList<>();

  public ScanDetailed() {
  }

  public ScanDetailed stats(Stats stats) {
    this.stats = stats;
    return this;
  }
  ...
  public ScanDetailed title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ScanDetailed webUrls(List<WebUrl> webUrls) {
    this.webUrls = webUrls;
    return this;
  }

  public ScanDetailed addWebUrlsItem(WebUrl webUrlsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ScanDetailed scanDetailed = (ScanDetailed) o;
    return Objects.equals(this.stats, scanDetailed.stats) &&
        Objects.equals(this.title, scanDetailed.title) &&
        Objects.equals(this.webUrls, scanDetailed.webUrls);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stats, title, webUrls);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScanDetailed {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScanDetailed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScanDetailed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScanDetailed is not found in the empty JSON string", ScanDetailed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScanDetailed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScanDetailed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScanDetailed.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraywebUrls.size(); i++) {
        WebUrl.validateJsonElement(jsonArraywebUrls.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScanDetailed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScanDetailed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScanDetailed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScanDetailed.class));

       return (TypeAdapter<T>) new TypeAdapter<ScanDetailed>() {
           @Override
           public void write(JsonWriter out, ScanDetailed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScanDetailed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScanDetailed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScanDetailed
   * @throws IOException if the JSON string is invalid with respect to ScanDetailed
   */
  public static ScanDetailed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScanDetailed.class);
  }

  /**
   * Convert an instance of ScanDetailed to an JSON string
   *
   * @return JSON string
   */
