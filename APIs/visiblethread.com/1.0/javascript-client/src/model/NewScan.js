...
import NewScanScanSettings from './NewScanScanSettings';
import NewScanWebUrlsInner from './NewScanWebUrlsInner';

/**
 * The NewScan model module.
 * @module model/NewScan
 * @version 1.0
 */
class NewScan {
    /**
     * Constructs a new <code>NewScan</code>.
     * @alias module:model/NewScan
     * @param title {String} 
     * @param webUrls {Array.<module:model/NewScanWebUrlsInner>} 
     */
    constructor(title, webUrls) { 
        
        NewScan.initialize(this, title, webUrls);
    }
    ...
    /**
     * Constructs a <code>NewScan</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewScan} obj Optional instance to populate.
     * @return {module:model/NewScan} The populated <code>NewScan</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scanSettings')) {
                obj['scanSettings'] = NewScanScanSettings.constructFromObject(data['scanSettings']);
            }
            if (data.hasOwnProperty('title')) {
                obj['title'] = ApiClient.convertToType(data['title'], 'String');
            }
            if (data.hasOwnProperty('webUrls')) {
                obj['webUrls'] = ApiClient.convertToType(data['webUrls'], [NewScanWebUrlsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewScan</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewScan</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewScan.RequiredProperties) {
        ...
        if (data['scanSettings']) { // data not null
          NewScanScanSettings.validateJSON(data['scanSettings']);
        }
        ...
        if (data['webUrls']) { // data not null
            ...
            for (const item of data['webUrls']) {
                NewScanWebUrlsInner.validateJSON(item);
            };
        }
...
NewScan.RequiredProperties = ["title", "webUrls"];

/**
 * @member {module:model/NewScanScanSettings} scanSettings
 */
NewScan.prototype['scanSettings'] = undefined;

/**
 * @member {String} title
 */
NewScan.prototype['title'] = undefined;

/**
 * @member {Array.<module:model/NewScanWebUrlsInner>} webUrls
 */
NewScan.prototype['webUrls'] = undefined;
