...
class Search {
     ...
     * @param docId {Number} 
     */
    constructor(dictId, docId) { 
        
        Search.initialize(this, dictId, docId);
    }
     ...
     */
    static initialize(obj, dictId, docId) { 
        obj['dictId'] = dictId;
        obj['docId'] = docId;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('dictId')) {
                obj['dictId'] = ApiClient.convertToType(data['dictId'], 'Number');
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of Search.RequiredProperties) {
...
Search.RequiredProperties = ["dictId", "docId"];

/**
 * @member {Number} dictId
 */
Search.prototype['dictId'] = undefined;

/**
 * @member {Number} docId
 */
Search.prototype['docId'] = undefined;
