...
/**
 * The AdverbsInner model module.
 * @module model/AdverbsInner
 * @version 1.0
 */
class AdverbsInner {
    /**
     * Constructs a new <code>AdverbsInner</code>.
     * @alias module:model/AdverbsInner
     */
    constructor() { 
        
        AdverbsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AdverbsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AdverbsInner} obj Optional instance to populate.
     * @return {module:model/AdverbsInner} The populated <code>AdverbsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AdverbsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>AdverbsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AdverbsInner</code>.
     */
 ...
 * @member {Number} end
 */
AdverbsInner.prototype['end'] = undefined;

/**
 * @member {Number} start
 */
AdverbsInner.prototype['start'] = undefined;

/**
 * @member {String} text
 */
AdverbsInner.prototype['text'] = undefined;
