...
/**
 * The DocumentResponseNotReady model module.
 * @module model/DocumentResponseNotReady
 * @version 1.0
 */
class DocumentResponseNotReady {
    /**
     * Constructs a new <code>DocumentResponseNotReady</code>.
     * @alias module:model/DocumentResponseNotReady
     */
    constructor() { 
        
        DocumentResponseNotReady.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentResponseNotReady</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentResponseNotReady} obj Optional instance to populate.
     * @return {module:model/DocumentResponseNotReady} The populated <code>DocumentResponseNotReady</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentResponseNotReady();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentResponseNotReady</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentResponseNotReady</code>.
     */
 ...
 * @member {Date} eta
 */
DocumentResponseNotReady.prototype['eta'] = undefined;

/**
 * @member {Number} id
 */
DocumentResponseNotReady.prototype['id'] = undefined;

/**
 * @member {Date} started
 */
DocumentResponseNotReady.prototype['started'] = undefined;
...
export default DocumentResponseNotReady;
