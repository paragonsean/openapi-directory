...
/**
 * The DocumentListSummary model module.
 * @module model/DocumentListSummary
 * @version 1.0
 */
class DocumentListSummary {
    /**
     * Constructs a new <code>DocumentListSummary</code>.
     * @alias module:model/DocumentListSummary
     */
    constructor() { 
        
        DocumentListSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentListSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentListSummary} obj Optional instance to populate.
     * @return {module:model/DocumentListSummary} The populated <code>DocumentListSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentListSummary();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentListSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentListSummary</code>.
     */
 ...
 * @member {Number} id
 */
DocumentListSummary.prototype['id'] = undefined;

/**
 * @member {String} name
 */
DocumentListSummary.prototype['name'] = undefined;
...
export default DocumentListSummary;
