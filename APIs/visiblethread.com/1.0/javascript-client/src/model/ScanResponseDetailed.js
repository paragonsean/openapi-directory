...
import ScanDetailed from './ScanDetailed';

/**
 * The ScanResponseDetailed model module.
 * @module model/ScanResponseDetailed
 * @version 1.0
 */
class ScanResponseDetailed {
    /**
     * Constructs a new <code>ScanResponseDetailed</code>.
     * @alias module:model/ScanResponseDetailed
     */
    constructor() { 
        
        ScanResponseDetailed.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScanResponseDetailed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScanResponseDetailed} obj Optional instance to populate.
     * @return {module:model/ScanResponseDetailed} The populated <code>ScanResponseDetailed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScanResponseDetailed();
            ...
            if (data.hasOwnProperty('scan')) {
                obj['scan'] = ScanDetailed.constructFromObject(data['scan']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ScanResponseDetailed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScanResponseDetailed</code>.
     */
    static validateJSON(data) {
        // validate the optional field `scan`
        if (data['scan']) { // data not null
          ScanDetailed.validateJSON(data['scan']);
        }
 ...
 */
ScanResponseDetailed.prototype['completed'] = undefined;

/**
 * @member {Date} eta
 */
ScanResponseDetailed.prototype['eta'] = undefined;

/**
 * @member {Number} id
 */
ScanResponseDetailed.prototype['id'] = undefined;

/**
 * @member {module:model/ScanDetailed} scan
 */
ScanResponseDetailed.prototype['scan'] = undefined;

/**
 * @member {Date} started
 */
ScanResponseDetailed.prototype['started'] = undefined;
...
export default ScanResponseDetailed;
