...
/**
 * The WebResponseNotReady model module.
 * @module model/WebResponseNotReady
 * @version 1.0
 */
class WebResponseNotReady {
    /**
     * Constructs a new <code>WebResponseNotReady</code>.
     * @alias module:model/WebResponseNotReady
     */
    constructor() { 
        
        WebResponseNotReady.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebResponseNotReady</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebResponseNotReady} obj Optional instance to populate.
     * @return {module:model/WebResponseNotReady} The populated <code>WebResponseNotReady</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebResponseNotReady();
    ...
    /**
     * Validates the JSON data with respect to <code>WebResponseNotReady</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebResponseNotReady</code>.
     */
 ...
 * @member {Date} eta
 */
WebResponseNotReady.prototype['eta'] = undefined;

/**
 * @member {Number} id
 */
WebResponseNotReady.prototype['id'] = undefined;

/**
 * @member {Date} started
 */
WebResponseNotReady.prototype['started'] = undefined;
...
export default WebResponseNotReady;
