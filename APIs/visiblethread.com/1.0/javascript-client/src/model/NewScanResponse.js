...
import NewScanResponseWebUrlsInner from './NewScanResponseWebUrlsInner';

/**
 * The NewScanResponse model module.
 * @module model/NewScanResponse
 * @version 1.0
 */
class NewScanResponse {
    /**
     * Constructs a new <code>NewScanResponse</code>.
     * @alias module:model/NewScanResponse
     * @param id {Number} 
     * @param title {String} 
     * @param webUrls {Array.<module:model/NewScanResponseWebUrlsInner>} 
     */
    constructor(id, title, webUrls) { 
        
        NewScanResponse.initialize(this, id, title, webUrls);
    }
     ...
     */
    static initialize(obj, id, title, webUrls) { 
        obj['id'] = id;
        obj['title'] = title;
        obj['webUrls'] = webUrls;
    }
    ...
    /**
     * Constructs a <code>NewScanResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewScanResponse} obj Optional instance to populate.
     * @return {module:model/NewScanResponse} The populated <code>NewScanResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewScanResponse();
            ...
            if (data.hasOwnProperty('webUrls')) {
                obj['webUrls'] = ApiClient.convertToType(data['webUrls'], [NewScanResponseWebUrlsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewScanResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewScanResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewScanResponse.RequiredProperties) {
        ...
        if (data['webUrls']) { // data not null
            ...
            for (const item of data['webUrls']) {
                NewScanResponseWebUrlsInner.validateJSON(item);
            };
        }
...
NewScanResponse.RequiredProperties = ["id", "title", "webUrls"];

/**
 * @member {Number} id
 */
NewScanResponse.prototype['id'] = undefined;

/**
 * @member {String} title
 */
NewScanResponse.prototype['title'] = undefined;

/**
 * @member {Array.<module:model/NewScanResponseWebUrlsInner>} webUrls
 */
NewScanResponse.prototype['webUrls'] = undefined;
...
export default NewScanResponse;
