...
class ScanSummary {
     ...
     * @param title {String} 
     * @param webUrls {Array.<module:model/WebUrlHeader>} 
     */
    constructor(title, webUrls) { 
        
        ScanSummary.initialize(this, title, webUrls);
    }
     ...
     */
    static initialize(obj, title, webUrls) { 
        obj['title'] = title;
        obj['webUrls'] = webUrls;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('webUrls')) {
                obj['webUrls'] = ApiClient.convertToType(data['webUrls'], [WebUrlHeader]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['webUrls']) { // data not null
            ...
            for (const item of data['webUrls']) {
                WebUrlHeader.validateJSON(item);
            };
        }
...
ScanSummary.RequiredProperties = ["title", "webUrls"];

/**
 * @member {String} title
 */
ScanSummary.prototype['title'] = undefined;

/**
 * @member {Array.<module:model/WebUrlHeader>} webUrls
 */
ScanSummary.prototype['webUrls'] = undefined;
