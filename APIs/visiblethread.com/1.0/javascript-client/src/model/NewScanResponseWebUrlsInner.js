...
/**
 * The NewScanResponseWebUrlsInner model module.
 * @module model/NewScanResponseWebUrlsInner
 * @version 1.0
 */
class NewScanResponseWebUrlsInner {
    /**
     * Constructs a new <code>NewScanResponseWebUrlsInner</code>.
     * @alias module:model/NewScanResponseWebUrlsInner
     * @param id {Number} 
     * @param url {String} 
     */
    constructor(id, url) { 
        
        NewScanResponseWebUrlsInner.initialize(this, id, url);
    }
    ...
    /**
     * Constructs a <code>NewScanResponseWebUrlsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewScanResponseWebUrlsInner} obj Optional instance to populate.
     * @return {module:model/NewScanResponseWebUrlsInner} The populated <code>NewScanResponseWebUrlsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewScanResponseWebUrlsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>NewScanResponseWebUrlsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewScanResponseWebUrlsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewScanResponseWebUrlsInner.RequiredProperties) {
...
NewScanResponseWebUrlsInner.RequiredProperties = ["id", "url"];

/**
 * @member {Number} id
 */
NewScanResponseWebUrlsInner.prototype['id'] = undefined;

/**
 * @member {String} url
 */
NewScanResponseWebUrlsInner.prototype['url'] = undefined;
...
export default NewScanResponseWebUrlsInner;
