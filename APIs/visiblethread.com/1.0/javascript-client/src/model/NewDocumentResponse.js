...
/**
 * The NewDocumentResponse model module.
 * @module model/NewDocumentResponse
 * @version 1.0
 */
class NewDocumentResponse {
    /**
     * Constructs a new <code>NewDocumentResponse</code>.
     * @alias module:model/NewDocumentResponse
     * @param docId {Number} 
     * @param scanSettings {module:model/DocumentResponseDetailedScanSettings} 
     * @param task {String} 
     */
    constructor(docId, scanSettings, task) { 
        
        NewDocumentResponse.initialize(this, docId, scanSettings, task);
    }
     ...
     */
    static initialize(obj, docId, scanSettings, task) { 
        obj['docId'] = docId;
        obj['scanSettings'] = scanSettings;
        obj['task'] = task;
    }

    /**
     * Constructs a <code>NewDocumentResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewDocumentResponse} obj Optional instance to populate.
     * @return {module:model/NewDocumentResponse} The populated <code>NewDocumentResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewDocumentResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>NewDocumentResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewDocumentResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewDocumentResponse.RequiredProperties) {
...
NewDocumentResponse.RequiredProperties = ["docId", "scanSettings", "task"];

/**
 * @member {Number} docId
 */
NewDocumentResponse.prototype['docId'] = undefined;

/**
 * @member {module:model/DocumentResponseDetailedScanSettings} scanSettings
 */
NewDocumentResponse.prototype['scanSettings'] = undefined;

/**
 * @member {String} task
 */
NewDocumentResponse.prototype['task'] = undefined;
...
export default NewDocumentResponse;
