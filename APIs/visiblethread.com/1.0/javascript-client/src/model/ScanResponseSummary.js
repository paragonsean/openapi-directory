...
/**
 * The ScanResponseSummary model module.
 * @module model/ScanResponseSummary
 * @version 1.0
 */
class ScanResponseSummary {
    /**
     * Constructs a new <code>ScanResponseSummary</code>.
     * @alias module:model/ScanResponseSummary
     */
    constructor() { 
        
        ScanResponseSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ScanResponseSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScanResponseSummary} obj Optional instance to populate.
     * @return {module:model/ScanResponseSummary} The populated <code>ScanResponseSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScanResponseSummary();
            ...
            if (data.hasOwnProperty('scan')) {
                obj['scan'] = ScanSummary.constructFromObject(data['scan']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ScanResponseSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScanResponseSummary</code>.
     */
    static validateJSON(data) {
        // validate the optional field `scan`
        if (data['scan']) { // data not null
          ScanSummary.validateJSON(data['scan']);
        }
 ...
 */
ScanResponseSummary.prototype['completed'] = undefined;

/**
 * @member {Date} eta
 */
ScanResponseSummary.prototype['eta'] = undefined;

/**
 * @member {Number} id
 */
ScanResponseSummary.prototype['id'] = undefined;

/**
 * @member {module:model/ScanSummary} scan
 */
ScanResponseSummary.prototype['scan'] = undefined;

/**
 * @member {Date} started
 */
ScanResponseSummary.prototype['started'] = undefined;
...
export default ScanResponseSummary;
