...
/**
 * The NewScanScanSettings model module.
 * @module model/NewScanScanSettings
 * @version 1.0
 */
class NewScanScanSettings {
    /**
     * Constructs a new <code>NewScanScanSettings</code>.
     * @alias module:model/NewScanScanSettings
     */
    constructor() { 
        
        NewScanScanSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NewScanScanSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewScanScanSettings} obj Optional instance to populate.
     * @return {module:model/NewScanScanSettings} The populated <code>NewScanScanSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewScanScanSettings();

            if (data.hasOwnProperty('longSentenceWordCount')) {
                obj['longSentenceWordCount'] = ApiClient.convertToType(data['longSentenceWordCount'], 'Number');
            }
            if (data.hasOwnProperty('veryLongSentenceWordCount')) {
                obj['veryLongSentenceWordCount'] = ApiClient.convertToType(data['veryLongSentenceWordCount'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewScanScanSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewScanScanSettings</code>.
     */
...
/**
 * @member {Number} longSentenceWordCount
 */
NewScanScanSettings.prototype['longSentenceWordCount'] = undefined;

/**
 * @member {Number} veryLongSentenceWordCount
 */
NewScanScanSettings.prototype['veryLongSentenceWordCount'] = undefined;
...
export default NewScanScanSettings;
