...
/**
 * The PassivesInner model module.
 * @module model/PassivesInner
 * @version 1.0
 */
class PassivesInner {
    /**
     * Constructs a new <code>PassivesInner</code>.
     * @alias module:model/PassivesInner
     */
    constructor() { 
        
        PassivesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PassivesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PassivesInner} obj Optional instance to populate.
     * @return {module:model/PassivesInner} The populated <code>PassivesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PassivesInner();

            if (data.hasOwnProperty('end')) {
                obj['end'] = ApiClient.convertToType(data['end'], 'Number');
            }
            if (data.hasOwnProperty('passivePiece')) {
                obj['passivePiece'] = ApiClient.convertToType(data['passivePiece'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PassivesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PassivesInner</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['passivePiece'] && !(typeof data['passivePiece'] === 'string' || data['passivePiece'] instanceof String)) {
            throw new Error("Expected the field `passivePiece` to be a primitive type in the JSON string but got " + data['passivePiece']);
        }
        // ensure the json data is a string
 ...
 * @member {Number} end
 */
PassivesInner.prototype['end'] = undefined;

/**
 * @member {String} passivePiece
 */
PassivesInner.prototype['passivePiece'] = undefined;

/**
 * @member {Number} start
 */
PassivesInner.prototype['start'] = undefined;

/**
 * @member {String} verb
 */
PassivesInner.prototype['verb'] = undefined;
