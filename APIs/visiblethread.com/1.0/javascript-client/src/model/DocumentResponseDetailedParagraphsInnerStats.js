...
import AdverbsInner from './AdverbsInner';
import HiddenVerbsInner from './HiddenVerbsInner';
import LongSentencesInner from './LongSentencesInner';
import PassivesInner from './PassivesInner';
import VeryLongSentencesInner from './VeryLongSentencesInner';

/**
 * The DocumentResponseDetailedParagraphsInnerStats model module.
 * @module model/DocumentResponseDetailedParagraphsInnerStats
 * @version 1.0
 */
class DocumentResponseDetailedParagraphsInnerStats {
    /**
     * Constructs a new <code>DocumentResponseDetailedParagraphsInnerStats</code>.
     * @alias module:model/DocumentResponseDetailedParagraphsInnerStats
     */
    constructor() { 
        
        DocumentResponseDetailedParagraphsInnerStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentResponseDetailedParagraphsInnerStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentResponseDetailedParagraphsInnerStats} obj Optional instance to populate.
     * @return {module:model/DocumentResponseDetailedParagraphsInnerStats} The populated <code>DocumentResponseDetailedParagraphsInnerStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentResponseDetailedParagraphsInnerStats();

            if (data.hasOwnProperty('adverbs')) {
                obj['adverbs'] = ApiClient.convertToType(data['adverbs'], [Array]);
            }
            if (data.hasOwnProperty('hiddenVerbs')) {
                obj['hiddenVerbs'] = ApiClient.convertToType(data['hiddenVerbs'], [Array]);
            }
            if (data.hasOwnProperty('longSentences')) {
                obj['longSentences'] = ApiClient.convertToType(data['longSentences'], [Array]);
            }
            if (data.hasOwnProperty('passives')) {
                obj['passives'] = ApiClient.convertToType(data['passives'], [Array]);
            }
            if (data.hasOwnProperty('veryLongSentences')) {
                obj['veryLongSentences'] = ApiClient.convertToType(data['veryLongSentences'], [Array]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentResponseDetailedParagraphsInnerStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentResponseDetailedParagraphsInnerStats</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['adverbs'])) {
            throw new Error("Expected the field `adverbs` to be an array in the JSON data but got " + data['adverbs']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['hiddenVerbs'])) {
            throw new Error("Expected the field `hiddenVerbs` to be an array in the JSON data but got " + data['hiddenVerbs']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['longSentences'])) {
            throw new Error("Expected the field `longSentences` to be an array in the JSON data but got " + data['longSentences']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['passives'])) {
            throw new Error("Expected the field `passives` to be an array in the JSON data but got " + data['passives']);
        }
        // ensure the json data is an array
        if (!Array.isArray(data['veryLongSentences'])) {
            throw new Error("Expected the field `veryLongSentences` to be an array in the JSON data but got " + data['veryLongSentences']);
        }
...
/**
 * @member {Array.<Array.<module:model/AdverbsInner>>} adverbs
 */
DocumentResponseDetailedParagraphsInnerStats.prototype['adverbs'] = undefined;

/**
 * @member {Array.<Array.<module:model/HiddenVerbsInner>>} hiddenVerbs
 */
DocumentResponseDetailedParagraphsInnerStats.prototype['hiddenVerbs'] = undefined;

/**
 * @member {Array.<Array.<module:model/LongSentencesInner>>} longSentences
 */
DocumentResponseDetailedParagraphsInnerStats.prototype['longSentences'] = undefined;

/**
 * @member {Array.<Array.<module:model/PassivesInner>>} passives
 */
DocumentResponseDetailedParagraphsInnerStats.prototype['passives'] = undefined;

/**
 * @member {Array.<Array.<module:model/VeryLongSentencesInner>>} veryLongSentences
 */
DocumentResponseDetailedParagraphsInnerStats.prototype['veryLongSentences'] = undefined;
...
export default DocumentResponseDetailedParagraphsInnerStats;
