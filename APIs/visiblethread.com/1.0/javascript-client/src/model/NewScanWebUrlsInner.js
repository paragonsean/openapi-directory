...
/**
 * The NewScanWebUrlsInner model module.
 * @module model/NewScanWebUrlsInner
 * @version 1.0
 */
class NewScanWebUrlsInner {
    /**
     * Constructs a new <code>NewScanWebUrlsInner</code>.
     * @alias module:model/NewScanWebUrlsInner
     * @param url {String} 
     */
    constructor(url) { 
        
        NewScanWebUrlsInner.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>NewScanWebUrlsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewScanWebUrlsInner} obj Optional instance to populate.
     * @return {module:model/NewScanWebUrlsInner} The populated <code>NewScanWebUrlsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewScanWebUrlsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>NewScanWebUrlsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewScanWebUrlsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewScanWebUrlsInner.RequiredProperties) {
...
NewScanWebUrlsInner.RequiredProperties = ["url"];

/**
 * @member {String} url
 */
NewScanWebUrlsInner.prototype['url'] = undefined;
...
export default NewScanWebUrlsInner;
