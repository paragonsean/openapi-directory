...
/**
 * The WebUrlDetail model module.
 * @module model/WebUrlDetail
 * @version 1.0
 */
class WebUrlDetail {
    /**
     * Constructs a new <code>WebUrlDetail</code>.
     * @alias module:model/WebUrlDetail
     * @param stats {module:model/Stats} 
     * @param title {String} 
     * @param url {String} 
     */
    constructor(stats, title, url) { 
        
        WebUrlDetail.initialize(this, stats, title, url);
    }
     ...
     */
    static initialize(obj, stats, title, url) { 
        obj['stats'] = stats;
        obj['title'] = title;
        obj['url'] = url;
    }
    ...
    /**
     * Constructs a <code>WebUrlDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebUrlDetail} obj Optional instance to populate.
     * @return {module:model/WebUrlDetail} The populated <code>WebUrlDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebUrlDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>WebUrlDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebUrlDetail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebUrlDetail.RequiredProperties) {
...
WebUrlDetail.RequiredProperties = ["stats", "title", "url"];

/**
 * @member {Array.<module:model/DocumentResponseDetailedParagraphsInner>} paragraphs
 */
WebUrlDetail.prototype['paragraphs'] = undefined;

/**
 * @member {module:model/Stats} stats
 */
WebUrlDetail.prototype['stats'] = undefined;

/**
 * @member {String} title
 */
WebUrlDetail.prototype['title'] = undefined;

/**
 * @member {String} url
 */
WebUrlDetail.prototype['url'] = undefined;
