...
/**
 * The LongSentencesInner model module.
 * @module model/LongSentencesInner
 * @version 1.0
 */
class LongSentencesInner {
    /**
     * Constructs a new <code>LongSentencesInner</code>.
     * @alias module:model/LongSentencesInner
     */
    constructor() { 
        
        LongSentencesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LongSentencesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LongSentencesInner} obj Optional instance to populate.
     * @return {module:model/LongSentencesInner} The populated <code>LongSentencesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LongSentencesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>LongSentencesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LongSentencesInner</code>.
     */
 ...
 * @member {Number} end
 */
LongSentencesInner.prototype['end'] = undefined;

/**
 * @member {Number} start
 */
LongSentencesInner.prototype['start'] = undefined;

/**
 * @member {Number} wordCount
 */
LongSentencesInner.prototype['wordCount'] = undefined;
...
export default LongSentencesInner;
