...
/**
 * The DocumentResponseDetailedScanSettings model module.
 * @module model/DocumentResponseDetailedScanSettings
 * @version 1.0
 */
class DocumentResponseDetailedScanSettings {
    /**
     * Constructs a new <code>DocumentResponseDetailedScanSettings</code>.
     * @alias module:model/DocumentResponseDetailedScanSettings
     */
    constructor() { 
        
        DocumentResponseDetailedScanSettings.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentResponseDetailedScanSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentResponseDetailedScanSettings} obj Optional instance to populate.
     * @return {module:model/DocumentResponseDetailedScanSettings} The populated <code>DocumentResponseDetailedScanSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentResponseDetailedScanSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentResponseDetailedScanSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentResponseDetailedScanSettings</code>.
     */
 ...
 */
DocumentResponseDetailedScanSettings.prototype['longSentenceWordCount'] = undefined;

/**
 * @member {Number} veryLongSentenceWordCount
 */
DocumentResponseDetailedScanSettings.prototype['veryLongSentenceWordCount'] = undefined;
...
export default DocumentResponseDetailedScanSettings;
