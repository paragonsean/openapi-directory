...
class Stats {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('avgSentenceLength')) {
                obj['avgSentenceLength'] = ApiClient.convertToType(data['avgSentenceLength'], 'Number');
            }
            if (data.hasOwnProperty('fleschKincaidGradeLevel')) {
                obj['fleschKincaidGradeLevel'] = ApiClient.convertToType(data['fleschKincaidGradeLevel'], 'Number');
            }
            if (data.hasOwnProperty('fleschReadingLevel')) {
                obj['fleschReadingLevel'] = ApiClient.convertToType(data['fleschReadingLevel'], 'Number');
            }
            if (data.hasOwnProperty('longSentenceCount')) {
                obj['longSentenceCount'] = ApiClient.convertToType(data['longSentenceCount'], 'Number');
            }
            if (data.hasOwnProperty('passiveSentenceCount')) {
                obj['passiveSentenceCount'] = ApiClient.convertToType(data['passiveSentenceCount'], 'Number');
            }
...
/**
 * @member {Number} avgSentenceLength
 */
Stats.prototype['avgSentenceLength'] = undefined;

/**
 * @member {Number} fleschKincaidGradeLevel
 */
Stats.prototype['fleschKincaidGradeLevel'] = undefined;

/**
 * @member {Number} fleschReadingLevel
 */
Stats.prototype['fleschReadingLevel'] = undefined;

/**
 * @member {Number} longSentenceCount
 */
Stats.prototype['longSentenceCount'] = undefined;

/**
 * @member {Number} passiveSentenceCount
 */
Stats.prototype['passiveSentenceCount'] = undefined;

/**
 * @member {Number} sentenceCount
 */
Stats.prototype['sentenceCount'] = undefined;

/**
 * @member {Number} wordCount
 */
Stats.prototype['wordCount'] = undefined;
