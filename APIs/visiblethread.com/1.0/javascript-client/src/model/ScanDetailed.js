...
/**
 * The ScanDetailed model module.
 * @module model/ScanDetailed
 * @version 1.0
 */
class ScanDetailed {
    /**
     * Constructs a new <code>ScanDetailed</code>.
     * @alias module:model/ScanDetailed
     * @param stats {module:model/Stats} 
     * @param title {String} 
     * @param webUrls {Array.<module:model/WebUrl>} 
     */
    constructor(stats, title, webUrls) { 
        
        ScanDetailed.initialize(this, stats, title, webUrls);
    }
     ...
     */
    static initialize(obj, stats, title, webUrls) { 
        obj['stats'] = stats;
        obj['title'] = title;
        obj['webUrls'] = webUrls;
    }
    ...
    /**
     * Constructs a <code>ScanDetailed</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ScanDetailed} obj Optional instance to populate.
     * @return {module:model/ScanDetailed} The populated <code>ScanDetailed</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScanDetailed();
            ...
            if (data.hasOwnProperty('webUrls')) {
                obj['webUrls'] = ApiClient.convertToType(data['webUrls'], [WebUrl]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScanDetailed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScanDetailed</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScanDetailed.RequiredProperties) {
        ...
        if (data['webUrls']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['webUrls'])) {
                throw new Error("Expected the field `webUrls` to be an array in the JSON data but got " + data['webUrls']);
            }
            // validate the optional field `webUrls` (array)
            for (const item of data['webUrls']) {
                WebUrl.validateJSON(item);
            };
        }
...
ScanDetailed.RequiredProperties = ["stats", "title", "webUrls"];

/**
 * @member {module:model/Stats} stats
 */
ScanDetailed.prototype['stats'] = undefined;

/**
 * @member {String} title
 */
ScanDetailed.prototype['title'] = undefined;

/**
 * @member {Array.<module:model/WebUrl>} webUrls
 */
ScanDetailed.prototype['webUrls'] = undefined;
