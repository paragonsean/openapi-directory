...
/**
 * The VeryLongSentencesInner model module.
 * @module model/VeryLongSentencesInner
 * @version 1.0
 */
class VeryLongSentencesInner {
    /**
     * Constructs a new <code>VeryLongSentencesInner</code>.
     * @alias module:model/VeryLongSentencesInner
     */
    constructor() { 
        
        VeryLongSentencesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>VeryLongSentencesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VeryLongSentencesInner} obj Optional instance to populate.
     * @return {module:model/VeryLongSentencesInner} The populated <code>VeryLongSentencesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VeryLongSentencesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>VeryLongSentencesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VeryLongSentencesInner</code>.
     */
 ...
 * @member {Number} end
 */
VeryLongSentencesInner.prototype['end'] = undefined;

/**
 * @member {Number} start
 */
VeryLongSentencesInner.prototype['start'] = undefined;

/**
 * @member {Number} wordCount
 */
VeryLongSentencesInner.prototype['wordCount'] = undefined;
...
export default VeryLongSentencesInner;
