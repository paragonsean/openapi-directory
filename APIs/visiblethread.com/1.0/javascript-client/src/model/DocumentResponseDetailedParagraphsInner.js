...
import DocumentResponseDetailedParagraphsInnerStats from './DocumentResponseDetailedParagraphsInnerStats';

/**
 * The DocumentResponseDetailedParagraphsInner model module.
 * @module model/DocumentResponseDetailedParagraphsInner
 * @version 1.0
 */
class DocumentResponseDetailedParagraphsInner {
    /**
     * Constructs a new <code>DocumentResponseDetailedParagraphsInner</code>.
     * @alias module:model/DocumentResponseDetailedParagraphsInner
     */
    constructor() { 
        
        DocumentResponseDetailedParagraphsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentResponseDetailedParagraphsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentResponseDetailedParagraphsInner} obj Optional instance to populate.
     * @return {module:model/DocumentResponseDetailedParagraphsInner} The populated <code>DocumentResponseDetailedParagraphsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentResponseDetailedParagraphsInner();

            if (data.hasOwnProperty('paragraphCounter')) {
                obj['paragraphCounter'] = ApiClient.convertToType(data['paragraphCounter'], 'Number');
            }
            if (data.hasOwnProperty('paragraphIndex')) {
                obj['paragraphIndex'] = ApiClient.convertToType(data['paragraphIndex'], 'Number');
            }
            if (data.hasOwnProperty('stats')) {
                obj['stats'] = DocumentResponseDetailedParagraphsInnerStats.constructFromObject(data['stats']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentResponseDetailedParagraphsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentResponseDetailedParagraphsInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `stats`
        if (data['stats']) { // data not null
          DocumentResponseDetailedParagraphsInnerStats.validateJSON(data['stats']);
        }
...
/**
 * @member {Number} paragraphCounter
 */
DocumentResponseDetailedParagraphsInner.prototype['paragraphCounter'] = undefined;

/**
 * @member {Number} paragraphIndex
 */
DocumentResponseDetailedParagraphsInner.prototype['paragraphIndex'] = undefined;

/**
 * @member {module:model/DocumentResponseDetailedParagraphsInnerStats} stats
 */
DocumentResponseDetailedParagraphsInner.prototype['stats'] = undefined;

/**
 * @member {String} text
 */
DocumentResponseDetailedParagraphsInner.prototype['text'] = undefined;
...
export default DocumentResponseDetailedParagraphsInner;
