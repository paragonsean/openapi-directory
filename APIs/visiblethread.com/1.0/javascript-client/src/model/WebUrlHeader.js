...
/**
 * The WebUrlHeader model module.
 * @module model/WebUrlHeader
 * @version 1.0
 */
class WebUrlHeader {
    /**
     * Constructs a new <code>WebUrlHeader</code>.
     * @alias module:model/WebUrlHeader
     * @param id {Number} 
     * @param url {String} 
     */
    constructor(id, url) { 
    ...
    /**
     * Constructs a <code>WebUrlHeader</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebUrlHeader} obj Optional instance to populate.
     * @return {module:model/WebUrlHeader} The populated <code>WebUrlHeader</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebUrlHeader();
    ...
    /**
     * Validates the JSON data with respect to <code>WebUrlHeader</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebUrlHeader</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WebUrlHeader.RequiredProperties) {
...
WebUrlHeader.RequiredProperties = ["id", "url"];
