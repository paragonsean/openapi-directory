...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.PassivesInner();
  });
  ...
  describe('PassivesInner', function() {
    it('should create an instance of PassivesInner', function() {
      // uncomment below and update the code to test PassivesInner
      //var instance = new VisibleThreadApi.PassivesInner();
      //expect(instance).to.be.a(VisibleThreadApi.PassivesInner);
    });
    ...
    it('should have the property passivePiece (base name: "passivePiece")', function() {
      // uncomment below and update the code to test the property passivePiece
      //var instance = new VisibleThreadApi.PassivesInner();
      //expect(instance).to.be();
    });
