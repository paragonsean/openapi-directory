...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.NewDocumentResponse();
  });
  ...
  describe('NewDocumentResponse', function() {
    it('should create an instance of NewDocumentResponse', function() {
      // uncomment below and update the code to test NewDocumentResponse
      //var instance = new VisibleThreadApi.NewDocumentResponse();
      //expect(instance).to.be.a(VisibleThreadApi.NewDocumentResponse);
    });
