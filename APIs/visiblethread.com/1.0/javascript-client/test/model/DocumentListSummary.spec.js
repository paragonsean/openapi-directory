...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.DocumentListSummary();
  });
  ...
  describe('DocumentListSummary', function() {
    it('should create an instance of DocumentListSummary', function() {
      // uncomment below and update the code to test DocumentListSummary
      //var instance = new VisibleThreadApi.DocumentListSummary();
      //expect(instance).to.be.a(VisibleThreadApi.DocumentListSummary);
    });
