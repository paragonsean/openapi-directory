...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.NewScanWebUrlsInner();
  });
  ...
  describe('NewScanWebUrlsInner', function() {
    it('should create an instance of NewScanWebUrlsInner', function() {
      // uncomment below and update the code to test NewScanWebUrlsInner
      //var instance = new VisibleThreadApi.NewScanWebUrlsInner();
      //expect(instance).to.be.a(VisibleThreadApi.NewScanWebUrlsInner);
    });
