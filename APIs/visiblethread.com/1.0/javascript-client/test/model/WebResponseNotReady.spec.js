...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.WebResponseNotReady();
  });
  ...
  describe('WebResponseNotReady', function() {
    it('should create an instance of WebResponseNotReady', function() {
      // uncomment below and update the code to test WebResponseNotReady
      //var instance = new VisibleThreadApi.WebResponseNotReady();
      //expect(instance).to.be.a(VisibleThreadApi.WebResponseNotReady);
    });
