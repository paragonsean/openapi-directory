...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.DocumentResponseNotReady();
  });
  ...
  describe('DocumentResponseNotReady', function() {
    it('should create an instance of DocumentResponseNotReady', function() {
      // uncomment below and update the code to test DocumentResponseNotReady
      //var instance = new VisibleThreadApi.DocumentResponseNotReady();
      //expect(instance).to.be.a(VisibleThreadApi.DocumentResponseNotReady);
    });
