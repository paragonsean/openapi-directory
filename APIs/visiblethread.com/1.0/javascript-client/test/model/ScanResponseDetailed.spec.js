...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.ScanResponseDetailed();
  });
  ...
  describe('ScanResponseDetailed', function() {
    it('should create an instance of ScanResponseDetailed', function() {
      // uncomment below and update the code to test ScanResponseDetailed
      //var instance = new VisibleThreadApi.ScanResponseDetailed();
      //expect(instance).to.be.a(VisibleThreadApi.ScanResponseDetailed);
    });
