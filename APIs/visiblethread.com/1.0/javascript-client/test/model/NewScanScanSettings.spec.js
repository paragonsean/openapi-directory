...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.NewScanScanSettings();
  });
  ...
  describe('NewScanScanSettings', function() {
    it('should create an instance of NewScanScanSettings', function() {
      // uncomment below and update the code to test NewScanScanSettings
      //var instance = new VisibleThreadApi.NewScanScanSettings();
      //expect(instance).to.be.a(VisibleThreadApi.NewScanScanSettings);
    });

    it('should have the property longSentenceWordCount (base name: "longSentenceWordCount")', function() {
      // uncomment below and update the code to test the property longSentenceWordCount
      //var instance = new VisibleThreadApi.NewScanScanSettings();
      //expect(instance).to.be();
    });

    it('should have the property veryLongSentenceWordCount (base name: "veryLongSentenceWordCount")', function() {
      // uncomment below and update the code to test the property veryLongSentenceWordCount
      //var instance = new VisibleThreadApi.NewScanScanSettings();
      //expect(instance).to.be();
    });
