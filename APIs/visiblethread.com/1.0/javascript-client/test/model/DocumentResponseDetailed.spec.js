...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.DocumentResponseDetailed();
  });
  ...
  describe('DocumentResponseDetailed', function() {
    it('should create an instance of DocumentResponseDetailed', function() {
      // uncomment below and update the code to test DocumentResponseDetailed
      //var instance = new VisibleThreadApi.DocumentResponseDetailed();
      //expect(instance).to.be.a(VisibleThreadApi.DocumentResponseDetailed);
    });
