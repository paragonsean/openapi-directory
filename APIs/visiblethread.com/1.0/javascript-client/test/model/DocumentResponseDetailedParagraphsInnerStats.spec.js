...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
  });
  ...
  describe('DocumentResponseDetailedParagraphsInnerStats', function() {
    it('should create an instance of DocumentResponseDetailedParagraphsInnerStats', function() {
      // uncomment below and update the code to test DocumentResponseDetailedParagraphsInnerStats
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
      //expect(instance).to.be.a(VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats);
    });

    it('should have the property adverbs (base name: "adverbs")', function() {
      // uncomment below and update the code to test the property adverbs
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
      //expect(instance).to.be();
    });

    it('should have the property hiddenVerbs (base name: "hiddenVerbs")', function() {
      // uncomment below and update the code to test the property hiddenVerbs
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
      //expect(instance).to.be();
    });

    it('should have the property longSentences (base name: "longSentences")', function() {
      // uncomment below and update the code to test the property longSentences
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
      //expect(instance).to.be();
    });

    it('should have the property passives (base name: "passives")', function() {
      // uncomment below and update the code to test the property passives
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
      //expect(instance).to.be();
    });

    it('should have the property veryLongSentences (base name: "veryLongSentences")', function() {
      // uncomment below and update the code to test the property veryLongSentences
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInnerStats();
      //expect(instance).to.be();
    });
