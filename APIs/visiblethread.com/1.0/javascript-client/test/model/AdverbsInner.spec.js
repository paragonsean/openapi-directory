...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.AdverbsInner();
  });
  ...
  describe('AdverbsInner', function() {
    it('should create an instance of AdverbsInner', function() {
      // uncomment below and update the code to test AdverbsInner
      //var instance = new VisibleThreadApi.AdverbsInner();
      //expect(instance).to.be.a(VisibleThreadApi.AdverbsInner);
    });
