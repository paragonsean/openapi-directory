...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.HiddenVerbsInner();
  });
  ...
  describe('HiddenVerbsInner', function() {
    it('should create an instance of HiddenVerbsInner', function() {
      // uncomment below and update the code to test HiddenVerbsInner
      //var instance = new VisibleThreadApi.HiddenVerbsInner();
      //expect(instance).to.be.a(VisibleThreadApi.HiddenVerbsInner);
    });
    ...
    it('should have the property noun (base name: "noun")', function() {
      // uncomment below and update the code to test the property noun
      //var instance = new VisibleThreadApi.HiddenVerbsInner();
      //expect(instance).to.be();
    });
