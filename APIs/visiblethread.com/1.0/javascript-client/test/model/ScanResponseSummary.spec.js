...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.ScanResponseSummary();
  });
  ...
  describe('ScanResponseSummary', function() {
    it('should create an instance of ScanResponseSummary', function() {
      // uncomment below and update the code to test ScanResponseSummary
      //var instance = new VisibleThreadApi.ScanResponseSummary();
      //expect(instance).to.be.a(VisibleThreadApi.ScanResponseSummary);
    });
