...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.WebUrlDetail();
  });
  ...
  describe('WebUrlDetail', function() {
    it('should create an instance of WebUrlDetail', function() {
      // uncomment below and update the code to test WebUrlDetail
      //var instance = new VisibleThreadApi.WebUrlDetail();
      //expect(instance).to.be.a(VisibleThreadApi.WebUrlDetail);
    });
