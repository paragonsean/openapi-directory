...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.ScanDetailed();
  });
  ...
  describe('ScanDetailed', function() {
    it('should create an instance of ScanDetailed', function() {
      // uncomment below and update the code to test ScanDetailed
      //var instance = new VisibleThreadApi.ScanDetailed();
      //expect(instance).to.be.a(VisibleThreadApi.ScanDetailed);
    });
