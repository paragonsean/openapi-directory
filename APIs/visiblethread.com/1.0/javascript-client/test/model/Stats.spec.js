...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.Stats();
  });
  ...
  describe('Stats', function() {
    it('should create an instance of Stats', function() {
      ...
      //var instance = new VisibleThreadApi.Stats();
      //expect(instance).to.be.a(VisibleThreadApi.Stats);
    });

    it('should have the property avgSentenceLength (base name: "avgSentenceLength")', function() {
      // uncomment below and update the code to test the property avgSentenceLength
      //var instance = new VisibleThreadApi.Stats();
      //expect(instance).to.be();
    });

    it('should have the property fleschKincaidGradeLevel (base name: "fleschKincaidGradeLevel")', function() {
      // uncomment below and update the code to test the property fleschKincaidGradeLevel
      //var instance = new VisibleThreadApi.Stats();
      //expect(instance).to.be();
    });

    it('should have the property fleschReadingLevel (base name: "fleschReadingLevel")', function() {
      // uncomment below and update the code to test the property fleschReadingLevel
      //var instance = new VisibleThreadApi.Stats();
      //expect(instance).to.be();
    });

    it('should have the property longSentenceCount (base name: "longSentenceCount")', function() {
      // uncomment below and update the code to test the property longSentenceCount
      //var instance = new VisibleThreadApi.Stats();
      //expect(instance).to.be();
    });

    it('should have the property passiveSentenceCount (base name: "passiveSentenceCount")', function() {
      // uncomment below and update the code to test the property passiveSentenceCount
      //var instance = new VisibleThreadApi.Stats();
      //expect(instance).to.be();
    });
