...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.LongSentencesInner();
  });
  ...
  describe('LongSentencesInner', function() {
    it('should create an instance of LongSentencesInner', function() {
      // uncomment below and update the code to test LongSentencesInner
      //var instance = new VisibleThreadApi.LongSentencesInner();
      //expect(instance).to.be.a(VisibleThreadApi.LongSentencesInner);
    });
