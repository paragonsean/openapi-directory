...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.WebUrlHeader();
  });
  ...
  describe('WebUrlHeader', function() {
    it('should create an instance of WebUrlHeader', function() {
      // uncomment below and update the code to test WebUrlHeader
      //var instance = new VisibleThreadApi.WebUrlHeader();
      //expect(instance).to.be.a(VisibleThreadApi.WebUrlHeader);
    });
