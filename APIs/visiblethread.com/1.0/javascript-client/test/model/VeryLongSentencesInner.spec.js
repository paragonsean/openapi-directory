...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.VeryLongSentencesInner();
  });
  ...
  describe('VeryLongSentencesInner', function() {
    it('should create an instance of VeryLongSentencesInner', function() {
      // uncomment below and update the code to test VeryLongSentencesInner
      //var instance = new VisibleThreadApi.VeryLongSentencesInner();
      //expect(instance).to.be.a(VisibleThreadApi.VeryLongSentencesInner);
    });
