...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.Search();
  });
  ...
  describe('Search', function() {
    it('should create an instance of Search', function() {
      ...
      //var instance = new VisibleThreadApi.Search();
      //expect(instance).to.be.a(VisibleThreadApi.Search);
    });

    it('should have the property dictId (base name: "dictId")', function() {
      // uncomment below and update the code to test the property dictId
      //var instance = new VisibleThreadApi.Search();
