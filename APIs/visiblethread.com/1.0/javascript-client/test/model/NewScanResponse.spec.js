...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.NewScanResponse();
  });
  ...
  describe('NewScanResponse', function() {
    it('should create an instance of NewScanResponse', function() {
      // uncomment below and update the code to test NewScanResponse
      //var instance = new VisibleThreadApi.NewScanResponse();
      //expect(instance).to.be.a(VisibleThreadApi.NewScanResponse);
    });
