...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInner();
  });
  ...
  describe('DocumentResponseDetailedParagraphsInner', function() {
    it('should create an instance of DocumentResponseDetailedParagraphsInner', function() {
      // uncomment below and update the code to test DocumentResponseDetailedParagraphsInner
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInner();
      //expect(instance).to.be.a(VisibleThreadApi.DocumentResponseDetailedParagraphsInner);
    });

    it('should have the property paragraphCounter (base name: "paragraphCounter")', function() {
      // uncomment below and update the code to test the property paragraphCounter
      //var instance = new VisibleThreadApi.DocumentResponseDetailedParagraphsInner();
