...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.NewScan();
  });
  ...
  describe('NewScan', function() {
    it('should create an instance of NewScan', function() {
      // uncomment below and update the code to test NewScan
      //var instance = new VisibleThreadApi.NewScan();
      //expect(instance).to.be.a(VisibleThreadApi.NewScan);
    });

    it('should have the property scanSettings (base name: "scanSettings")', function() {
      // uncomment below and update the code to test the property scanSettings
      //var instance = new VisibleThreadApi.NewScan();
    ...
    it('should have the property webUrls (base name: "webUrls")', function() {
      // uncomment below and update the code to test the property webUrls
      //var instance = new VisibleThreadApi.NewScan();
      //expect(instance).to.be();
    });
