...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.DocumentsApi();
  });
  ...
  describe('DocumentsApi', function() {
    describe('dictionariesGet', function() {
      it('should call dictionariesGet successfully', function(done) {
        //uncomment below and update the code to test dictionariesGet
        //instance.dictionariesGet(function(error) {
    ...
    describe('getDocById', function() {
      it('should call getDocById successfully', function(done) {
        //uncomment below and update the code to test getDocById
        //instance.getDocById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('runSearch', function() {
      it('should call runSearch successfully', function(done) {
        //uncomment below and update the code to test runSearch
        //instance.runSearch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('searchesGet', function() {
      it('should call searchesGet successfully', function(done) {
        //uncomment below and update the code to test searchesGet
        //instance.searchesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadDictionary', function() {
      it('should call uploadDictionary successfully', function(done) {
        //uncomment below and update the code to test uploadDictionary
        //instance.uploadDictionary(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadDoc', function() {
      it('should call uploadDoc successfully', function(done) {
        //uncomment below and update the code to test uploadDoc
        //instance.uploadDoc(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
