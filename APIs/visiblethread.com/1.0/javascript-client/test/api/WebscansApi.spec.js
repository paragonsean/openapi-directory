...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VisibleThreadApi.WebscansApi();
  });
  ...
  describe('WebscansApi', function() {
    describe('getScanById', function() {
      it('should call getScanById successfully', function(done) {
        //uncomment below and update the code to test getScanById
        //instance.getScanById(function(error) {
    ...
    describe('getScanUrlById', function() {
      it('should call getScanUrlById successfully', function(done) {
        //uncomment below and update the code to test getScanUrlById
        //instance.getScanUrlById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('runScan', function() {
      it('should call runScan successfully', function(done) {
        //uncomment below and update the code to test runScan
        //instance.runScan(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('webscansGet', function() {
      it('should call webscansGet successfully', function(done) {
        //uncomment below and update the code to test webscansGet
        //instance.webscansGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
