...
OAIScanResponseDetailed::OAIScanResponseDetailed(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScanResponseDetailed::OAIScanResponseDetailed() {
    this->initializeModel();
}

OAIScanResponseDetailed::~OAIScanResponseDetailed() {}

void OAIScanResponseDetailed::initializeModel() {
...
void OAIScanResponseDetailed::fromJson(QString jsonString) {
...
void OAIScanResponseDetailed::fromJsonObject(QJsonObject json) {
...
QString OAIScanResponseDetailed::asJson() const {
...
QJsonObject OAIScanResponseDetailed::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIScanResponseDetailed::getCompleted() const {
    return m_completed;
}
void OAIScanResponseDetailed::setCompleted(const QDateTime &completed) {
    m_completed = completed;
    m_completed_isSet = true;
}

bool OAIScanResponseDetailed::is_completed_Set() const{
    return m_completed_isSet;
}

bool OAIScanResponseDetailed::is_completed_Valid() const{
    return m_completed_isValid;
}

QDateTime OAIScanResponseDetailed::getEta() const {
    return m_eta;
}
void OAIScanResponseDetailed::setEta(const QDateTime &eta) {
    m_eta = eta;
    m_eta_isSet = true;
}

bool OAIScanResponseDetailed::is_eta_Set() const{
    return m_eta_isSet;
}

bool OAIScanResponseDetailed::is_eta_Valid() const{
    return m_eta_isValid;
}

qint64 OAIScanResponseDetailed::getId() const {
    return m_id;
}
void OAIScanResponseDetailed::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIScanResponseDetailed::is_id_Set() const{
    return m_id_isSet;
}

bool OAIScanResponseDetailed::is_id_Valid() const{
    return m_id_isValid;
}

OAIScanDetailed OAIScanResponseDetailed::getScan() const {
    return m_scan;
}
void OAIScanResponseDetailed::setScan(const OAIScanDetailed &scan) {
    m_scan = scan;
    m_scan_isSet = true;
}

bool OAIScanResponseDetailed::is_scan_Set() const{
    return m_scan_isSet;
}

bool OAIScanResponseDetailed::is_scan_Valid() const{
    return m_scan_isValid;
}

QDateTime OAIScanResponseDetailed::getStarted() const {
    return m_started;
}
void OAIScanResponseDetailed::setStarted(const QDateTime &started) {
    m_started = started;
    m_started_isSet = true;
}

bool OAIScanResponseDetailed::is_started_Set() const{
    return m_started_isSet;
}

bool OAIScanResponseDetailed::is_started_Valid() const{
    return m_started_isValid;
}

bool OAIScanResponseDetailed::isSet() const {
...
bool OAIScanResponseDetailed::isValid() const {
