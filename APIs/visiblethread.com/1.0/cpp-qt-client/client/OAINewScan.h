...
#include "OAINewScan_webUrls_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAINewScan_scanSettings;
class OAINewScan_webUrls_inner;

class OAINewScan : public OAIObject {
public:
    OAINewScan();
    OAINewScan(QString json);
    ~OAINewScan() override;
    ...
    OAINewScan_scanSettings getScanSettings() const;
    void setScanSettings(const OAINewScan_scanSettings &scan_settings);
    bool is_scan_settings_Set() const;
    bool is_scan_settings_Valid() const;
    ...
    QList<OAINewScan_webUrls_inner> getWebUrls() const;
    void setWebUrls(const QList<OAINewScan_webUrls_inner> &web_urls);
    bool is_web_urls_Set() const;
    bool is_web_urls_Valid() const;
...
private:
    ...
    OAINewScan_scanSettings m_scan_settings;
    bool m_scan_settings_isSet;
    bool m_scan_settings_isValid;

    QString m_title;
    bool m_title_isSet;
    bool m_title_isValid;

    QList<OAINewScan_webUrls_inner> m_web_urls;
    bool m_web_urls_isSet;
    bool m_web_urls_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAINewScan)
