...
OAIDocumentListSummary::OAIDocumentListSummary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentListSummary::OAIDocumentListSummary() {
    this->initializeModel();
}

OAIDocumentListSummary::~OAIDocumentListSummary() {}

void OAIDocumentListSummary::initializeModel() {
...
void OAIDocumentListSummary::fromJson(QString jsonString) {
...
void OAIDocumentListSummary::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentListSummary::asJson() const {
...
QJsonObject OAIDocumentListSummary::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint64 OAIDocumentListSummary::getId() const {
    return m_id;
}
void OAIDocumentListSummary::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDocumentListSummary::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDocumentListSummary::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDocumentListSummary::getName() const {
    return m_name;
}
void OAIDocumentListSummary::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDocumentListSummary::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDocumentListSummary::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDocumentListSummary::isSet() const {
...
bool OAIDocumentListSummary::isValid() const {
