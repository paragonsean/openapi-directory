...
#include "OAINewScanResponse_webUrls_inner.h"
...
OAINewScanResponse_webUrls_inner::OAINewScanResponse_webUrls_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewScanResponse_webUrls_inner::OAINewScanResponse_webUrls_inner() {
    this->initializeModel();
}

OAINewScanResponse_webUrls_inner::~OAINewScanResponse_webUrls_inner() {}

void OAINewScanResponse_webUrls_inner::initializeModel() {
...
void OAINewScanResponse_webUrls_inner::fromJson(QString jsonString) {
...
void OAINewScanResponse_webUrls_inner::fromJsonObject(QJsonObject json) {
...
QString OAINewScanResponse_webUrls_inner::asJson() const {
...
QJsonObject OAINewScanResponse_webUrls_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint64 OAINewScanResponse_webUrls_inner::getId() const {
    return m_id;
}
void OAINewScanResponse_webUrls_inner::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINewScanResponse_webUrls_inner::is_id_Set() const{
    return m_id_isSet;
}

bool OAINewScanResponse_webUrls_inner::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINewScanResponse_webUrls_inner::getUrl() const {
    return m_url;
}
void OAINewScanResponse_webUrls_inner::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAINewScanResponse_webUrls_inner::is_url_Set() const{
    return m_url_isSet;
}

bool OAINewScanResponse_webUrls_inner::is_url_Valid() const{
    return m_url_isValid;
}

bool OAINewScanResponse_webUrls_inner::isSet() const {
...
bool OAINewScanResponse_webUrls_inner::isValid() const {
