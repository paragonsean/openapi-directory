...
/*
 * OAIWebResponseNotReady.h
 *
 * 
 */

#ifndef OAIWebResponseNotReady_H
#define OAIWebResponseNotReady_H
...
class OAIWebResponseNotReady : public OAIObject {
public:
    OAIWebResponseNotReady();
    OAIWebResponseNotReady(QString json);
    ~OAIWebResponseNotReady() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebResponseNotReady)

#endif // OAIWebResponseNotReady_H
