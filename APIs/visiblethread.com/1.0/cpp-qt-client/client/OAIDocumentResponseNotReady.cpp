...
OAIDocumentResponseNotReady::OAIDocumentResponseNotReady(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDocumentResponseNotReady::OAIDocumentResponseNotReady() {
    this->initializeModel();
}

OAIDocumentResponseNotReady::~OAIDocumentResponseNotReady() {}

void OAIDocumentResponseNotReady::initializeModel() {
...
void OAIDocumentResponseNotReady::fromJson(QString jsonString) {
...
void OAIDocumentResponseNotReady::fromJsonObject(QJsonObject json) {
...
QString OAIDocumentResponseNotReady::asJson() const {
...
QJsonObject OAIDocumentResponseNotReady::asJsonObject() const {
    QJsonObject obj;
    if (m_eta_isSet) {
...
QDateTime OAIDocumentResponseNotReady::getEta() const {
    return m_eta;
}
void OAIDocumentResponseNotReady::setEta(const QDateTime &eta) {
    m_eta = eta;
    m_eta_isSet = true;
}

bool OAIDocumentResponseNotReady::is_eta_Set() const{
    return m_eta_isSet;
}

bool OAIDocumentResponseNotReady::is_eta_Valid() const{
    return m_eta_isValid;
}

qint64 OAIDocumentResponseNotReady::getId() const {
    return m_id;
}
void OAIDocumentResponseNotReady::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDocumentResponseNotReady::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDocumentResponseNotReady::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIDocumentResponseNotReady::getStarted() const {
    return m_started;
}
void OAIDocumentResponseNotReady::setStarted(const QDateTime &started) {
    m_started = started;
    m_started_isSet = true;
}

bool OAIDocumentResponseNotReady::is_started_Set() const{
    return m_started_isSet;
}

bool OAIDocumentResponseNotReady::is_started_Valid() const{
    return m_started_isValid;
}

bool OAIDocumentResponseNotReady::isSet() const {
...
bool OAIDocumentResponseNotReady::isValid() const {
