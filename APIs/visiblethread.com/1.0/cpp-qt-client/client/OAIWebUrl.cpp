...
OAIWebUrl::OAIWebUrl(QString json) {
...
void OAIWebUrl::initializeModel() {
...
void OAIWebUrl::fromJson(QString jsonString) {
...
void OAIWebUrl::fromJsonObject(QJsonObject json) {
...
QString OAIWebUrl::asJson() const {
...
QJsonObject OAIWebUrl::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint64 OAIWebUrl::getId() const {
    return m_id;
}
void OAIWebUrl::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWebUrl::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWebUrl::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIWebUrl::getUrl() const {
    return m_url;
}
void OAIWebUrl::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWebUrl::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWebUrl::is_url_Valid() const{
    return m_url_isValid;
}

OAIAnalysis OAIWebUrl::getAnalysis() const {
    return m_analysis;
}
void OAIWebUrl::setAnalysis(const OAIAnalysis &analysis) {
    m_analysis = analysis;
    m_analysis_isSet = true;
}

bool OAIWebUrl::is_analysis_Set() const{
    return m_analysis_isSet;
}

bool OAIWebUrl::is_analysis_Valid() const{
    return m_analysis_isValid;
}

bool OAIWebUrl::isSet() const {
...
bool OAIWebUrl::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_url_isValid && m_analysis_isValid && true;
}
