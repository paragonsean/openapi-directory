...
/*
 * OAINewScan_scanSettings.h
 *
 * 
 */

#ifndef OAINewScan_scanSettings_H
#define OAINewScan_scanSettings_H
...
class OAINewScan_scanSettings : public OAIObject {
public:
    OAINewScan_scanSettings();
    OAINewScan_scanSettings(QString json);
    ~OAINewScan_scanSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewScan_scanSettings)

#endif // OAINewScan_scanSettings_H
