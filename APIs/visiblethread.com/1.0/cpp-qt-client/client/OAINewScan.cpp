...
OAINewScan::OAINewScan(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewScan::OAINewScan() {
    this->initializeModel();
}

OAINewScan::~OAINewScan() {}

void OAINewScan::initializeModel() {
...
void OAINewScan::fromJson(QString jsonString) {
...
void OAINewScan::fromJsonObject(QJsonObject json) {
...
QString OAINewScan::asJson() const {
...
QJsonObject OAINewScan::asJsonObject() const {
    QJsonObject obj;
...
OAINewScan_scanSettings OAINewScan::getScanSettings() const {
    return m_scan_settings;
}
void OAINewScan::setScanSettings(const OAINewScan_scanSettings &scan_settings) {
    m_scan_settings = scan_settings;
    m_scan_settings_isSet = true;
}

bool OAINewScan::is_scan_settings_Set() const{
    return m_scan_settings_isSet;
}

bool OAINewScan::is_scan_settings_Valid() const{
    return m_scan_settings_isValid;
}

QString OAINewScan::getTitle() const {
    return m_title;
}
void OAINewScan::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAINewScan::is_title_Set() const{
    return m_title_isSet;
}

bool OAINewScan::is_title_Valid() const{
    return m_title_isValid;
}

QList<OAINewScan_webUrls_inner> OAINewScan::getWebUrls() const {
    return m_web_urls;
}
void OAINewScan::setWebUrls(const QList<OAINewScan_webUrls_inner> &web_urls) {
    m_web_urls = web_urls;
    m_web_urls_isSet = true;
}

bool OAINewScan::is_web_urls_Set() const{
    return m_web_urls_isSet;
}

bool OAINewScan::is_web_urls_Valid() const{
    return m_web_urls_isValid;
}

bool OAINewScan::isSet() const {
