...
/*
 * OAIDocumentResponseDetailed_paragraphs_inner_stats.h
 *
 * 
 */

#ifndef OAIDocumentResponseDetailed_paragraphs_inner_stats_H
#define OAIDocumentResponseDetailed_paragraphs_inner_stats_H

#include <QJsonObject>

#include "OAIAdverbs_inner.h"
#include "OAIHiddenVerbs_inner.h"
#include "OAILongSentences_inner.h"
#include "OAIPassives_inner.h"
...
namespace OpenAPI {
class OAIAdverbs_inner;
class OAIHiddenVerbs_inner;
class OAILongSentences_inner;
class OAIPassives_inner;
class OAIVeryLongSentences_inner;

class OAIDocumentResponseDetailed_paragraphs_inner_stats : public OAIObject {
public:
    OAIDocumentResponseDetailed_paragraphs_inner_stats();
    OAIDocumentResponseDetailed_paragraphs_inner_stats(QString json);
    ~OAIDocumentResponseDetailed_paragraphs_inner_stats() override;
    ...
    QList<QList> getAdverbs() const;
    void setAdverbs(const QList<QList> &adverbs);
    bool is_adverbs_Set() const;
    bool is_adverbs_Valid() const;

    QList<QList> getHiddenVerbs() const;
    void setHiddenVerbs(const QList<QList> &hidden_verbs);
    bool is_hidden_verbs_Set() const;
    bool is_hidden_verbs_Valid() const;

    QList<QList> getLongSentences() const;
    void setLongSentences(const QList<QList> &long_sentences);
    bool is_long_sentences_Set() const;
    bool is_long_sentences_Valid() const;

    QList<QList> getPassives() const;
    void setPassives(const QList<QList> &passives);
    bool is_passives_Set() const;
    bool is_passives_Valid() const;

    QList<QList> getVeryLongSentences() const;
    void setVeryLongSentences(const QList<QList> &very_long_sentences);
    bool is_very_long_sentences_Set() const;
    bool is_very_long_sentences_Valid() const;
...
private:
    ...
    QList<QList> m_adverbs;
    bool m_adverbs_isSet;
    bool m_adverbs_isValid;

    QList<QList> m_hidden_verbs;
    bool m_hidden_verbs_isSet;
    bool m_hidden_verbs_isValid;

    QList<QList> m_long_sentences;
    bool m_long_sentences_isSet;
    bool m_long_sentences_isValid;

    QList<QList> m_passives;
    bool m_passives_isSet;
    bool m_passives_isValid;

    QList<QList> m_very_long_sentences;
    bool m_very_long_sentences_isSet;
    bool m_very_long_sentences_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDocumentResponseDetailed_paragraphs_inner_stats)

#endif // OAIDocumentResponseDetailed_paragraphs_inner_stats_H
