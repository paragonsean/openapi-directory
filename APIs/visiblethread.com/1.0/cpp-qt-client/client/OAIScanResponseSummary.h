...
/*
 * OAIScanResponseSummary.h
 *
 * 
 */

#ifndef OAIScanResponseSummary_H
#define OAIScanResponseSummary_H
...
namespace OpenAPI {
class OAIScanSummary;

class OAIScanResponseSummary : public OAIObject {
public:
    OAIScanResponseSummary();
    OAIScanResponseSummary(QString json);
    ~OAIScanResponseSummary() override;
    ...
    OAIScanSummary getScan() const;
    void setScan(const OAIScanSummary &scan);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScanResponseSummary)

#endif // OAIScanResponseSummary_H
