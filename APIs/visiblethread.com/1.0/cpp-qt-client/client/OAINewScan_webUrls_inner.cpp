...
OAINewScan_webUrls_inner::OAINewScan_webUrls_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewScan_webUrls_inner::OAINewScan_webUrls_inner() {
    this->initializeModel();
}

OAINewScan_webUrls_inner::~OAINewScan_webUrls_inner() {}

void OAINewScan_webUrls_inner::initializeModel() {

    m_url_isSet = false;
    m_url_isValid = false;
}

void OAINewScan_webUrls_inner::fromJson(QString jsonString) {
...
void OAINewScan_webUrls_inner::fromJsonObject(QJsonObject json) {

    m_url_isValid = ::OpenAPI::fromJsonValue(m_url, json[QString("url")]);
    m_url_isSet = !json[QString("url")].isNull() && m_url_isValid;
}

QString OAINewScan_webUrls_inner::asJson() const {
...
QJsonObject OAINewScan_webUrls_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_url_isSet) {
...
QString OAINewScan_webUrls_inner::getUrl() const {
    return m_url;
}
void OAINewScan_webUrls_inner::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAINewScan_webUrls_inner::is_url_Set() const{
    return m_url_isSet;
}

bool OAINewScan_webUrls_inner::is_url_Valid() const{
    return m_url_isValid;
}

bool OAINewScan_webUrls_inner::isSet() const {
...
bool OAINewScan_webUrls_inner::isValid() const {
