...
OAIAdverbs_inner::OAIAdverbs_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAdverbs_inner::OAIAdverbs_inner() {
    this->initializeModel();
}

OAIAdverbs_inner::~OAIAdverbs_inner() {}

void OAIAdverbs_inner::initializeModel() {
...
void OAIAdverbs_inner::fromJson(QString jsonString) {
...
void OAIAdverbs_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAdverbs_inner::asJson() const {
...
QJsonObject OAIAdverbs_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_end_isSet) {
...
qint32 OAIAdverbs_inner::getEnd() const {
    return m_end;
}
void OAIAdverbs_inner::setEnd(const qint32 &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAIAdverbs_inner::is_end_Set() const{
    return m_end_isSet;
}

bool OAIAdverbs_inner::is_end_Valid() const{
    return m_end_isValid;
}

qint32 OAIAdverbs_inner::getStart() const {
    return m_start;
}
void OAIAdverbs_inner::setStart(const qint32 &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAIAdverbs_inner::is_start_Set() const{
    return m_start_isSet;
}

bool OAIAdverbs_inner::is_start_Valid() const{
    return m_start_isValid;
}

QString OAIAdverbs_inner::getText() const {
    return m_text;
}
void OAIAdverbs_inner::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIAdverbs_inner::is_text_Set() const{
    return m_text_isSet;
}

bool OAIAdverbs_inner::is_text_Valid() const{
    return m_text_isValid;
}

bool OAIAdverbs_inner::isSet() const {
...
bool OAIAdverbs_inner::isValid() const {
