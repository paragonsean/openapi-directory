...
OAINewScanResponse::OAINewScanResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewScanResponse::OAINewScanResponse() {
    this->initializeModel();
}

OAINewScanResponse::~OAINewScanResponse() {}

void OAINewScanResponse::initializeModel() {
...
void OAINewScanResponse::fromJson(QString jsonString) {
...
void OAINewScanResponse::fromJsonObject(QJsonObject json) {
...
QString OAINewScanResponse::asJson() const {
...
QJsonObject OAINewScanResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint64 OAINewScanResponse::getId() const {
    return m_id;
}
void OAINewScanResponse::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINewScanResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAINewScanResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINewScanResponse::getTitle() const {
    return m_title;
}
void OAINewScanResponse::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAINewScanResponse::is_title_Set() const{
    return m_title_isSet;
}

bool OAINewScanResponse::is_title_Valid() const{
    return m_title_isValid;
}

QList<OAINewScanResponse_webUrls_inner> OAINewScanResponse::getWebUrls() const {
    return m_web_urls;
}
void OAINewScanResponse::setWebUrls(const QList<OAINewScanResponse_webUrls_inner> &web_urls) {
    m_web_urls = web_urls;
    m_web_urls_isSet = true;
}

bool OAINewScanResponse::is_web_urls_Set() const{
    return m_web_urls_isSet;
}

bool OAINewScanResponse::is_web_urls_Valid() const{
    return m_web_urls_isValid;
}

bool OAINewScanResponse::isSet() const {
...
bool OAINewScanResponse::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_id_isValid && m_title_isValid && m_web_urls_isValid && true;
}
