...
/*
 * OAIDocumentResponseDetailed_scanSettings.h
 *
 * 
 */

#ifndef OAIDocumentResponseDetailed_scanSettings_H
#define OAIDocumentResponseDetailed_scanSettings_H
...
class OAIDocumentResponseDetailed_scanSettings : public OAIObject {
public:
    OAIDocumentResponseDetailed_scanSettings();
    OAIDocumentResponseDetailed_scanSettings(QString json);
    ~OAIDocumentResponseDetailed_scanSettings() override;
    ...
    qint32 getLongSentenceWordCount() const;
    void setLongSentenceWordCount(const qint32 &long_sentence_word_count);
    bool is_long_sentence_word_count_Set() const;
    bool is_long_sentence_word_count_Valid() const;

    qint32 getVeryLongSentenceWordCount() const;
    void setVeryLongSentenceWordCount(const qint32 &very_long_sentence_word_count);
    bool is_very_long_sentence_word_count_Set() const;
    bool is_very_long_sentence_word_count_Valid() const;
...
private:
    ...
    qint32 m_long_sentence_word_count;
    bool m_long_sentence_word_count_isSet;
    bool m_long_sentence_word_count_isValid;

    qint32 m_very_long_sentence_word_count;
    bool m_very_long_sentence_word_count_isSet;
    bool m_very_long_sentence_word_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDocumentResponseDetailed_scanSettings)

#endif // OAIDocumentResponseDetailed_scanSettings_H
