...
/*
 * OAIDocumentResponseNotReady.h
 *
 * 
 */

#ifndef OAIDocumentResponseNotReady_H
#define OAIDocumentResponseNotReady_H
...
class OAIDocumentResponseNotReady : public OAIObject {
public:
    OAIDocumentResponseNotReady();
    OAIDocumentResponseNotReady(QString json);
    ~OAIDocumentResponseNotReady() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentResponseNotReady)

#endif // OAIDocumentResponseNotReady_H
