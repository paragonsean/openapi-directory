...
#ifndef OAIWebUrlDetail_H
#define OAIWebUrlDetail_H
...
namespace OpenAPI {
class OAIDocumentResponseDetailed_paragraphs_inner;
class OAIStats;

class OAIWebUrlDetail : public OAIObject {
public:
    OAIWebUrlDetail();
    OAIWebUrlDetail(QString json);
    ~OAIWebUrlDetail() override;
    ...
    QList<OAIDocumentResponseDetailed_paragraphs_inner> getParagraphs() const;
    void setParagraphs(const QList<OAIDocumentResponseDetailed_paragraphs_inner> &paragraphs);
...
private:
    ...
    QList<OAIDocumentResponseDetailed_paragraphs_inner> m_paragraphs;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebUrlDetail)

#endif // OAIWebUrlDetail_H
