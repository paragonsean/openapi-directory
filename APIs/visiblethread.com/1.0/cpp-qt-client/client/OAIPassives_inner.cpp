...
OAIPassives_inner::OAIPassives_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPassives_inner::OAIPassives_inner() {
    this->initializeModel();
}

OAIPassives_inner::~OAIPassives_inner() {}

void OAIPassives_inner::initializeModel() {

    m_end_isSet = false;
    m_end_isValid = false;

    m_passive_piece_isSet = false;
    m_passive_piece_isValid = false;
...
void OAIPassives_inner::fromJson(QString jsonString) {
...
void OAIPassives_inner::fromJsonObject(QJsonObject json) {

    m_end_isValid = ::OpenAPI::fromJsonValue(m_end, json[QString("end")]);
    m_end_isSet = !json[QString("end")].isNull() && m_end_isValid;

    m_passive_piece_isValid = ::OpenAPI::fromJsonValue(m_passive_piece, json[QString("passivePiece")]);
    m_passive_piece_isSet = !json[QString("passivePiece")].isNull() && m_passive_piece_isValid;
...
QString OAIPassives_inner::asJson() const {
...
QJsonObject OAIPassives_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_end_isSet) {
        obj.insert(QString("end"), ::OpenAPI::toJsonValue(m_end));
    }
    if (m_passive_piece_isSet) {
        obj.insert(QString("passivePiece"), ::OpenAPI::toJsonValue(m_passive_piece));
    }
    if (m_start_isSet) {
...
qint32 OAIPassives_inner::getEnd() const {
    return m_end;
}
void OAIPassives_inner::setEnd(const qint32 &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAIPassives_inner::is_end_Set() const{
    return m_end_isSet;
}

bool OAIPassives_inner::is_end_Valid() const{
    return m_end_isValid;
}

QString OAIPassives_inner::getPassivePiece() const {
    return m_passive_piece;
}
void OAIPassives_inner::setPassivePiece(const QString &passive_piece) {
    m_passive_piece = passive_piece;
    m_passive_piece_isSet = true;
}

bool OAIPassives_inner::is_passive_piece_Set() const{
    return m_passive_piece_isSet;
}

bool OAIPassives_inner::is_passive_piece_Valid() const{
    return m_passive_piece_isValid;
}

qint32 OAIPassives_inner::getStart() const {
    return m_start;
}
void OAIPassives_inner::setStart(const qint32 &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAIPassives_inner::is_start_Set() const{
    return m_start_isSet;
}

bool OAIPassives_inner::is_start_Valid() const{
    return m_start_isValid;
}

QString OAIPassives_inner::getVerb() const {
    return m_verb;
}
void OAIPassives_inner::setVerb(const QString &verb) {
    m_verb = verb;
    m_verb_isSet = true;
}

bool OAIPassives_inner::is_verb_Set() const{
    return m_verb_isSet;
}

bool OAIPassives_inner::is_verb_Valid() const{
    return m_verb_isValid;
}

bool OAIPassives_inner::isSet() const {
...
bool OAIPassives_inner::isValid() const {
