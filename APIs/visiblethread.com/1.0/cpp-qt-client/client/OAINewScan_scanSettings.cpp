...
#include "OAINewScan_scanSettings.h"
...
OAINewScan_scanSettings::OAINewScan_scanSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINewScan_scanSettings::OAINewScan_scanSettings() {
    this->initializeModel();
}

OAINewScan_scanSettings::~OAINewScan_scanSettings() {}

void OAINewScan_scanSettings::initializeModel() {
...
void OAINewScan_scanSettings::fromJson(QString jsonString) {
...
void OAINewScan_scanSettings::fromJsonObject(QJsonObject json) {
...
QString OAINewScan_scanSettings::asJson() const {
...
QJsonObject OAINewScan_scanSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAINewScan_scanSettings::getLongSentenceWordCount() const {
    return m_long_sentence_word_count;
}
void OAINewScan_scanSettings::setLongSentenceWordCount(const qint32 &long_sentence_word_count) {
    m_long_sentence_word_count = long_sentence_word_count;
    m_long_sentence_word_count_isSet = true;
}

bool OAINewScan_scanSettings::is_long_sentence_word_count_Set() const{
    return m_long_sentence_word_count_isSet;
}

bool OAINewScan_scanSettings::is_long_sentence_word_count_Valid() const{
    return m_long_sentence_word_count_isValid;
}

qint32 OAINewScan_scanSettings::getVeryLongSentenceWordCount() const {
    return m_very_long_sentence_word_count;
}
void OAINewScan_scanSettings::setVeryLongSentenceWordCount(const qint32 &very_long_sentence_word_count) {
    m_very_long_sentence_word_count = very_long_sentence_word_count;
    m_very_long_sentence_word_count_isSet = true;
}

bool OAINewScan_scanSettings::is_very_long_sentence_word_count_Set() const{
    return m_very_long_sentence_word_count_isSet;
}

bool OAINewScan_scanSettings::is_very_long_sentence_word_count_Valid() const{
    return m_very_long_sentence_word_count_isValid;
}

bool OAINewScan_scanSettings::isSet() const {
...
bool OAINewScan_scanSettings::isValid() const {
