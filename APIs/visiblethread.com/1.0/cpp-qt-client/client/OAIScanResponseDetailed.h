...
/*
 * OAIScanResponseDetailed.h
 *
 * 
 */

#ifndef OAIScanResponseDetailed_H
#define OAIScanResponseDetailed_H
...
namespace OpenAPI {
class OAIScanDetailed;

class OAIScanResponseDetailed : public OAIObject {
public:
    OAIScanResponseDetailed();
    OAIScanResponseDetailed(QString json);
    ~OAIScanResponseDetailed() override;
    ...
    OAIScanDetailed getScan() const;
    void setScan(const OAIScanDetailed &scan);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScanResponseDetailed)

#endif // OAIScanResponseDetailed_H
