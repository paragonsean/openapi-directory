...
/*
 * OAIHiddenVerbs_inner.h
 *
 * 
 */

#ifndef OAIHiddenVerbs_inner_H
#define OAIHiddenVerbs_inner_H
...
class OAIHiddenVerbs_inner : public OAIObject {
public:
    OAIHiddenVerbs_inner();
    OAIHiddenVerbs_inner(QString json);
    ~OAIHiddenVerbs_inner() override;
    ...
    QString getNoun() const;
    void setNoun(const QString &noun);
    bool is_noun_Set() const;
    bool is_noun_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHiddenVerbs_inner)

#endif // OAIHiddenVerbs_inner_H
