...
#ifndef OAIScanDetailed_H
#define OAIScanDetailed_H
...
class OAIScanDetailed : public OAIObject {
public:
    OAIScanDetailed();
    OAIScanDetailed(QString json);
    ~OAIScanDetailed() override;
    ...
    QList<OAIWebUrl> getWebUrls() const;
    void setWebUrls(const QList<OAIWebUrl> &web_urls);
...
Q_DECLARE_METATYPE(OpenAPI::OAIScanDetailed)

#endif // OAIScanDetailed_H
