...
/*
 * OAINewScan_webUrls_inner.h
 *
 * 
 */

#ifndef OAINewScan_webUrls_inner_H
#define OAINewScan_webUrls_inner_H
...
class OAINewScan_webUrls_inner : public OAIObject {
public:
    OAINewScan_webUrls_inner();
    OAINewScan_webUrls_inner(QString json);
    ~OAINewScan_webUrls_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewScan_webUrls_inner)

#endif // OAINewScan_webUrls_inner_H
