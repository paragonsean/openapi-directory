...
/*
 * OAINewScanResponse.h
 *
 * 
 */

#ifndef OAINewScanResponse_H
#define OAINewScanResponse_H
...
namespace OpenAPI {
class OAINewScanResponse_webUrls_inner;

class OAINewScanResponse : public OAIObject {
public:
    OAINewScanResponse();
    OAINewScanResponse(QString json);
    ~OAINewScanResponse() override;
    ...
    QList<OAINewScanResponse_webUrls_inner> getWebUrls() const;
    void setWebUrls(const QList<OAINewScanResponse_webUrls_inner> &web_urls);
...
private:
    ...
    QList<OAINewScanResponse_webUrls_inner> m_web_urls;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewScanResponse)

#endif // OAINewScanResponse_H
