...
OAIWebUrlHeader::OAIWebUrlHeader(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebUrlHeader::OAIWebUrlHeader() {
    this->initializeModel();
}

OAIWebUrlHeader::~OAIWebUrlHeader() {}

void OAIWebUrlHeader::initializeModel() {
...
void OAIWebUrlHeader::fromJson(QString jsonString) {
...
void OAIWebUrlHeader::fromJsonObject(QJsonObject json) {
...
QString OAIWebUrlHeader::asJson() const {
...
QJsonObject OAIWebUrlHeader::asJsonObject() const {
    QJsonObject obj;
    if (m_id_isSet) {
...
qint64 OAIWebUrlHeader::getId() const {
    return m_id;
}
void OAIWebUrlHeader::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWebUrlHeader::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWebUrlHeader::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIWebUrlHeader::getUrl() const {
    return m_url;
}
void OAIWebUrlHeader::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIWebUrlHeader::is_url_Set() const{
    return m_url_isSet;
}

bool OAIWebUrlHeader::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIWebUrlHeader::isSet() const {
...
bool OAIWebUrlHeader::isValid() const {
