...
OAIScanDetailed::OAIScanDetailed(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScanDetailed::OAIScanDetailed() {
    this->initializeModel();
}

OAIScanDetailed::~OAIScanDetailed() {}

void OAIScanDetailed::initializeModel() {
...
void OAIScanDetailed::fromJson(QString jsonString) {
...
void OAIScanDetailed::fromJsonObject(QJsonObject json) {
...
QString OAIScanDetailed::asJson() const {
...
QJsonObject OAIScanDetailed::asJsonObject() const {
    QJsonObject obj;
    if (m_stats.isSet()) {
...
OAIStats OAIScanDetailed::getStats() const {
    return m_stats;
}
void OAIScanDetailed::setStats(const OAIStats &stats) {
    m_stats = stats;
    m_stats_isSet = true;
}

bool OAIScanDetailed::is_stats_Set() const{
    return m_stats_isSet;
}

bool OAIScanDetailed::is_stats_Valid() const{
    return m_stats_isValid;
}

QString OAIScanDetailed::getTitle() const {
    return m_title;
}
void OAIScanDetailed::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIScanDetailed::is_title_Set() const{
    return m_title_isSet;
}

bool OAIScanDetailed::is_title_Valid() const{
    return m_title_isValid;
}

QList<OAIWebUrl> OAIScanDetailed::getWebUrls() const {
    return m_web_urls;
}
void OAIScanDetailed::setWebUrls(const QList<OAIWebUrl> &web_urls) {
    m_web_urls = web_urls;
    m_web_urls_isSet = true;
}

bool OAIScanDetailed::is_web_urls_Set() const{
    return m_web_urls_isSet;
}

bool OAIScanDetailed::is_web_urls_Valid() const{
    return m_web_urls_isValid;
}

bool OAIScanDetailed::isSet() const {
...
bool OAIScanDetailed::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_stats_isValid && m_title_isValid && m_web_urls_isValid && true;
}
