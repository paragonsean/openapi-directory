...
#include "OAIHiddenVerbs_inner.h"
...
OAIHiddenVerbs_inner::OAIHiddenVerbs_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHiddenVerbs_inner::OAIHiddenVerbs_inner() {
    this->initializeModel();
}

OAIHiddenVerbs_inner::~OAIHiddenVerbs_inner() {}

void OAIHiddenVerbs_inner::initializeModel() {

    m_end_isSet = false;
    m_end_isValid = false;

    m_noun_isSet = false;
    m_noun_isValid = false;
...
void OAIHiddenVerbs_inner::fromJson(QString jsonString) {
...
void OAIHiddenVerbs_inner::fromJsonObject(QJsonObject json) {

    m_end_isValid = ::OpenAPI::fromJsonValue(m_end, json[QString("end")]);
    m_end_isSet = !json[QString("end")].isNull() && m_end_isValid;

    m_noun_isValid = ::OpenAPI::fromJsonValue(m_noun, json[QString("noun")]);
    m_noun_isSet = !json[QString("noun")].isNull() && m_noun_isValid;
...
QString OAIHiddenVerbs_inner::asJson() const {
...
QJsonObject OAIHiddenVerbs_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_end_isSet) {
        obj.insert(QString("end"), ::OpenAPI::toJsonValue(m_end));
    }
    if (m_noun_isSet) {
        obj.insert(QString("noun"), ::OpenAPI::toJsonValue(m_noun));
    }
    if (m_start_isSet) {
...
qint32 OAIHiddenVerbs_inner::getEnd() const {
    return m_end;
}
void OAIHiddenVerbs_inner::setEnd(const qint32 &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAIHiddenVerbs_inner::is_end_Set() const{
    return m_end_isSet;
}

bool OAIHiddenVerbs_inner::is_end_Valid() const{
    return m_end_isValid;
}

QString OAIHiddenVerbs_inner::getNoun() const {
    return m_noun;
}
void OAIHiddenVerbs_inner::setNoun(const QString &noun) {
    m_noun = noun;
    m_noun_isSet = true;
}

bool OAIHiddenVerbs_inner::is_noun_Set() const{
    return m_noun_isSet;
}

bool OAIHiddenVerbs_inner::is_noun_Valid() const{
    return m_noun_isValid;
}

qint32 OAIHiddenVerbs_inner::getStart() const {
    return m_start;
}
void OAIHiddenVerbs_inner::setStart(const qint32 &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAIHiddenVerbs_inner::is_start_Set() const{
    return m_start_isSet;
}

bool OAIHiddenVerbs_inner::is_start_Valid() const{
    return m_start_isValid;
}

QString OAIHiddenVerbs_inner::getText() const {
    return m_text;
}
void OAIHiddenVerbs_inner::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIHiddenVerbs_inner::is_text_Set() const{
    return m_text_isSet;
}

bool OAIHiddenVerbs_inner::is_text_Valid() const{
    return m_text_isValid;
}

bool OAIHiddenVerbs_inner::isSet() const {
...
bool OAIHiddenVerbs_inner::isValid() const {
