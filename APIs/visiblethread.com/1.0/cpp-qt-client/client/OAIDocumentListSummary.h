...
/*
 * OAIDocumentListSummary.h
 *
 * 
 */

#ifndef OAIDocumentListSummary_H
#define OAIDocumentListSummary_H
...
class OAIDocumentListSummary : public OAIObject {
public:
    OAIDocumentListSummary();
    OAIDocumentListSummary(QString json);
    ~OAIDocumentListSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentListSummary)

#endif // OAIDocumentListSummary_H
