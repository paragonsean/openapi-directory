...
#ifndef OAIPassives_inner_H
#define OAIPassives_inner_H
...
class OAIPassives_inner : public OAIObject {
public:
    OAIPassives_inner();
    OAIPassives_inner(QString json);
    ~OAIPassives_inner() override;
    ...
    QString getPassivePiece() const;
    void setPassivePiece(const QString &passive_piece);
    bool is_passive_piece_Set() const;
    bool is_passive_piece_Valid() const;
...
private:
    ...
    QString m_passive_piece;
    bool m_passive_piece_isSet;
    bool m_passive_piece_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPassives_inner)

#endif // OAIPassives_inner_H
