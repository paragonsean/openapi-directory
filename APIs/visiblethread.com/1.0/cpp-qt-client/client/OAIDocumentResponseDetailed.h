...
/*
 * OAIDocumentResponseDetailed.h
 *
 * 
 */

#ifndef OAIDocumentResponseDetailed_H
#define OAIDocumentResponseDetailed_H
...
class OAIDocumentResponseDetailed_scanSettings;
class OAIStats;

class OAIDocumentResponseDetailed : public OAIObject {
public:
    OAIDocumentResponseDetailed();
    OAIDocumentResponseDetailed(QString json);
    ~OAIDocumentResponseDetailed() override;
    ...
    OAIDocumentResponseDetailed_scanSettings getScanSettings() const;
    void setScanSettings(const OAIDocumentResponseDetailed_scanSettings &scan_settings);
...
private:
    ...
    OAIDocumentResponseDetailed_scanSettings m_scan_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDocumentResponseDetailed)

#endif // OAIDocumentResponseDetailed_H
