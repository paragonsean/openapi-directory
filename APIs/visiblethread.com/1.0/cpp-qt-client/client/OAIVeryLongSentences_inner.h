...
/*
 * OAIVeryLongSentences_inner.h
 *
 * 
 */

#ifndef OAIVeryLongSentences_inner_H
#define OAIVeryLongSentences_inner_H
...
class OAIVeryLongSentences_inner : public OAIObject {
public:
    OAIVeryLongSentences_inner();
    OAIVeryLongSentences_inner(QString json);
    ~OAIVeryLongSentences_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVeryLongSentences_inner)

#endif // OAIVeryLongSentences_inner_H
