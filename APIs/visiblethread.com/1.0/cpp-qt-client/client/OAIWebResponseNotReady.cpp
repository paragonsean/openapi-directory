...
OAIWebResponseNotReady::OAIWebResponseNotReady(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIWebResponseNotReady::OAIWebResponseNotReady() {
    this->initializeModel();
}

OAIWebResponseNotReady::~OAIWebResponseNotReady() {}

void OAIWebResponseNotReady::initializeModel() {
...
void OAIWebResponseNotReady::fromJson(QString jsonString) {
...
void OAIWebResponseNotReady::fromJsonObject(QJsonObject json) {
...
QString OAIWebResponseNotReady::asJson() const {
...
QJsonObject OAIWebResponseNotReady::asJsonObject() const {
    QJsonObject obj;
    if (m_eta_isSet) {
...
QDateTime OAIWebResponseNotReady::getEta() const {
    return m_eta;
}
void OAIWebResponseNotReady::setEta(const QDateTime &eta) {
    m_eta = eta;
    m_eta_isSet = true;
}

bool OAIWebResponseNotReady::is_eta_Set() const{
    return m_eta_isSet;
}

bool OAIWebResponseNotReady::is_eta_Valid() const{
    return m_eta_isValid;
}

qint64 OAIWebResponseNotReady::getId() const {
    return m_id;
}
void OAIWebResponseNotReady::setId(const qint64 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIWebResponseNotReady::is_id_Set() const{
    return m_id_isSet;
}

bool OAIWebResponseNotReady::is_id_Valid() const{
    return m_id_isValid;
}

QDateTime OAIWebResponseNotReady::getStarted() const {
    return m_started;
}
void OAIWebResponseNotReady::setStarted(const QDateTime &started) {
    m_started = started;
    m_started_isSet = true;
}

bool OAIWebResponseNotReady::is_started_Set() const{
    return m_started_isSet;
}

bool OAIWebResponseNotReady::is_started_Valid() const{
    return m_started_isValid;
}

bool OAIWebResponseNotReady::isSet() const {
...
bool OAIWebResponseNotReady::isValid() const {
