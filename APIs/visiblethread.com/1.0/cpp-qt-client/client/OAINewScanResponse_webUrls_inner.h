...
/*
 * OAINewScanResponse_webUrls_inner.h
 *
 * 
 */

#ifndef OAINewScanResponse_webUrls_inner_H
#define OAINewScanResponse_webUrls_inner_H
...
class OAINewScanResponse_webUrls_inner : public OAIObject {
public:
    OAINewScanResponse_webUrls_inner();
    OAINewScanResponse_webUrls_inner(QString json);
    ~OAINewScanResponse_webUrls_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewScanResponse_webUrls_inner)

#endif // OAINewScanResponse_webUrls_inner_H
