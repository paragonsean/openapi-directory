...
public:
    ...
    qint64 getDictId() const;
    void setDictId(const qint64 &dict_id);
    bool is_dict_id_Set() const;
    bool is_dict_id_Valid() const;

    qint64 getDocId() const;
    void setDocId(const qint64 &doc_id);
...
private:
    ...
    qint64 m_dict_id;
    bool m_dict_id_isSet;
    bool m_dict_id_isValid;
