...
OAILongSentences_inner::OAILongSentences_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILongSentences_inner::OAILongSentences_inner() {
    this->initializeModel();
}

OAILongSentences_inner::~OAILongSentences_inner() {}

void OAILongSentences_inner::initializeModel() {
...
void OAILongSentences_inner::fromJson(QString jsonString) {
...
void OAILongSentences_inner::fromJsonObject(QJsonObject json) {
...
QString OAILongSentences_inner::asJson() const {
...
QJsonObject OAILongSentences_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_end_isSet) {
...
qint32 OAILongSentences_inner::getEnd() const {
    return m_end;
}
void OAILongSentences_inner::setEnd(const qint32 &end) {
    m_end = end;
    m_end_isSet = true;
}

bool OAILongSentences_inner::is_end_Set() const{
    return m_end_isSet;
}

bool OAILongSentences_inner::is_end_Valid() const{
    return m_end_isValid;
}

qint32 OAILongSentences_inner::getStart() const {
    return m_start;
}
void OAILongSentences_inner::setStart(const qint32 &start) {
    m_start = start;
    m_start_isSet = true;
}

bool OAILongSentences_inner::is_start_Set() const{
    return m_start_isSet;
}

bool OAILongSentences_inner::is_start_Valid() const{
    return m_start_isValid;
}

qint32 OAILongSentences_inner::getWordCount() const {
    return m_word_count;
}
void OAILongSentences_inner::setWordCount(const qint32 &word_count) {
    m_word_count = word_count;
    m_word_count_isSet = true;
}

bool OAILongSentences_inner::is_word_count_Set() const{
    return m_word_count_isSet;
}

bool OAILongSentences_inner::is_word_count_Valid() const{
    return m_word_count_isValid;
}

bool OAILongSentences_inner::isSet() const {
...
bool OAILongSentences_inner::isValid() const {
