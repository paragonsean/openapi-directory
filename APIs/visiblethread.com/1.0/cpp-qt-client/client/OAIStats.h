...
public:
    ...
    qint32 getAvgSentenceLength() const;
    void setAvgSentenceLength(const qint32 &avg_sentence_length);
    bool is_avg_sentence_length_Set() const;
    bool is_avg_sentence_length_Valid() const;

    float getFleschKincaidGradeLevel() const;
    void setFleschKincaidGradeLevel(const float &flesch_kincaid_grade_level);
    bool is_flesch_kincaid_grade_level_Set() const;
    bool is_flesch_kincaid_grade_level_Valid() const;

    qint32 getFleschReadingLevel() const;
    void setFleschReadingLevel(const qint32 &flesch_reading_level);
    bool is_flesch_reading_level_Set() const;
    bool is_flesch_reading_level_Valid() const;

    qint32 getLongSentenceCount() const;
    void setLongSentenceCount(const qint32 &long_sentence_count);
    bool is_long_sentence_count_Set() const;
    bool is_long_sentence_count_Valid() const;

    qint32 getPassiveSentenceCount() const;
    void setPassiveSentenceCount(const qint32 &passive_sentence_count);
    bool is_passive_sentence_count_Set() const;
    bool is_passive_sentence_count_Valid() const;

    qint32 getSentenceCount() const;
    void setSentenceCount(const qint32 &sentence_count);
    bool is_sentence_count_Set() const;
    bool is_sentence_count_Valid() const;
...
private:
    ...
    qint32 m_avg_sentence_length;
    bool m_avg_sentence_length_isSet;
    bool m_avg_sentence_length_isValid;

    float m_flesch_kincaid_grade_level;
    bool m_flesch_kincaid_grade_level_isSet;
    bool m_flesch_kincaid_grade_level_isValid;

    qint32 m_flesch_reading_level;
    bool m_flesch_reading_level_isSet;
    bool m_flesch_reading_level_isValid;

    qint32 m_long_sentence_count;
    bool m_long_sentence_count_isSet;
    bool m_long_sentence_count_isValid;

    qint32 m_passive_sentence_count;
    bool m_passive_sentence_count_isSet;
    bool m_passive_sentence_count_isValid;

    qint32 m_sentence_count;
    bool m_sentence_count_isSet;
    bool m_sentence_count_isValid;
