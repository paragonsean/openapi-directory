...
/*
 * OAINewDocumentResponse.h
 *
 * 
 */

#ifndef OAINewDocumentResponse_H
#define OAINewDocumentResponse_H
...
class OAINewDocumentResponse : public OAIObject {
public:
    OAINewDocumentResponse();
    OAINewDocumentResponse(QString json);
    ~OAINewDocumentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewDocumentResponse)

#endif // OAINewDocumentResponse_H
