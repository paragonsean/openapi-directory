...
#ifndef OAIWebUrlHeader_H
#define OAIWebUrlHeader_H
...
class OAIWebUrlHeader : public OAIObject {
public:
    OAIWebUrlHeader();
    OAIWebUrlHeader(QString json);
    ~OAIWebUrlHeader() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebUrlHeader)

#endif // OAIWebUrlHeader_H
