...
OAIStats OAIAnalysis::getStats() const {
    return m_stats;
}
void OAIAnalysis::setStats(const OAIStats &stats) {
    m_stats = stats;
    m_stats_isSet = true;
}

bool OAIAnalysis::is_stats_Set() const{
    return m_stats_isSet;
}

bool OAIAnalysis::is_stats_Valid() const{
    return m_stats_isValid;
}

QString OAIAnalysis::getTitle() const {
    return m_title;
}
void OAIAnalysis::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIAnalysis::is_title_Set() const{
    return m_title_isSet;
}

bool OAIAnalysis::is_title_Valid() const{
