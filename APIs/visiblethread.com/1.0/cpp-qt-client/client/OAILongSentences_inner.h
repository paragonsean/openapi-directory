...
/*
 * OAILongSentences_inner.h
 *
 * 
 */

#ifndef OAILongSentences_inner_H
#define OAILongSentences_inner_H
...
class OAILongSentences_inner : public OAIObject {
public:
    OAILongSentences_inner();
    OAILongSentences_inner(QString json);
    ~OAILongSentences_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILongSentences_inner)

#endif // OAILongSentences_inner_H
