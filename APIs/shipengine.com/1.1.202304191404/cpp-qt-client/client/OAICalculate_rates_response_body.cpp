...
OAICalculate_rates_response_body::OAICalculate_rates_response_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICalculate_rates_response_body::OAICalculate_rates_response_body() {
    this->initializeModel();
}

OAICalculate_rates_response_body::~OAICalculate_rates_response_body() {}

void OAICalculate_rates_response_body::initializeModel() {
...
void OAICalculate_rates_response_body::fromJson(QString jsonString) {
...
void OAICalculate_rates_response_body::fromJsonObject(QJsonObject json) {
...
QString OAICalculate_rates_response_body::asJson() const {
...
QJsonObject OAICalculate_rates_response_body::asJsonObject() const {
    QJsonObject obj;
...
OAIAdvanced_shipment_options OAICalculate_rates_response_body::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAICalculate_rates_response_body::setAdvancedOptions(const OAIAdvanced_shipment_options &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAICalculate_rates_response_body::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAICalculate_rates_response_body::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

QString OAICalculate_rates_response_body::getCarrierId() const {
    return m_carrier_id;
}
void OAICalculate_rates_response_body::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAICalculate_rates_response_body::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAICalculate_rates_response_body::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

OAIDelivery_confirmation OAICalculate_rates_response_body::getConfirmation() const {
    return m_confirmation;
}
void OAICalculate_rates_response_body::setConfirmation(const OAIDelivery_confirmation &confirmation) {
    m_confirmation = confirmation;
    m_confirmation_isSet = true;
}

bool OAICalculate_rates_response_body::is_confirmation_Set() const{
    return m_confirmation_isSet;
}

bool OAICalculate_rates_response_body::is_confirmation_Valid() const{
    return m_confirmation_isValid;
}

QDateTime OAICalculate_rates_response_body::getCreatedAt() const {
    return m_created_at;
}
void OAICalculate_rates_response_body::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICalculate_rates_response_body::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICalculate_rates_response_body::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIInternational_shipment_options OAICalculate_rates_response_body::getCustoms() const {
    return m_customs;
}
void OAICalculate_rates_response_body::setCustoms(const OAIInternational_shipment_options &customs) {
    m_customs = customs;
    m_customs_isSet = true;
}

bool OAICalculate_rates_response_body::is_customs_Set() const{
    return m_customs_isSet;
}

bool OAICalculate_rates_response_body::is_customs_Valid() const{
    return m_customs_isValid;
}

QString OAICalculate_rates_response_body::getExternalOrderId() const {
    return m_external_order_id;
}
void OAICalculate_rates_response_body::setExternalOrderId(const QString &external_order_id) {
    m_external_order_id = external_order_id;
    m_external_order_id_isSet = true;
}

bool OAICalculate_rates_response_body::is_external_order_id_Set() const{
    return m_external_order_id_isSet;
}

bool OAICalculate_rates_response_body::is_external_order_id_Valid() const{
    return m_external_order_id_isValid;
}

QString OAICalculate_rates_response_body::getExternalShipmentId() const {
    return m_external_shipment_id;
}
void OAICalculate_rates_response_body::setExternalShipmentId(const QString &external_shipment_id) {
    m_external_shipment_id = external_shipment_id;
    m_external_shipment_id_isSet = true;
}

bool OAICalculate_rates_response_body::is_external_shipment_id_Set() const{
    return m_external_shipment_id_isSet;
}

bool OAICalculate_rates_response_body::is_external_shipment_id_Valid() const{
    return m_external_shipment_id_isValid;
}

OAIInsurance_provider OAICalculate_rates_response_body::getInsuranceProvider() const {
    return m_insurance_provider;
}
void OAICalculate_rates_response_body::setInsuranceProvider(const OAIInsurance_provider &insurance_provider) {
    m_insurance_provider = insurance_provider;
    m_insurance_provider_isSet = true;
}

bool OAICalculate_rates_response_body::is_insurance_provider_Set() const{
    return m_insurance_provider_isSet;
}

bool OAICalculate_rates_response_body::is_insurance_provider_Valid() const{
    return m_insurance_provider_isValid;
}

bool OAICalculate_rates_response_body::isIsReturn() const {
    return m_is_return;
}
void OAICalculate_rates_response_body::setIsReturn(const bool &is_return) {
    m_is_return = is_return;
    m_is_return_isSet = true;
}

bool OAICalculate_rates_response_body::is_is_return_Set() const{
    return m_is_return_isSet;
}

bool OAICalculate_rates_response_body::is_is_return_Valid() const{
    return m_is_return_isValid;
}

QList<OAIShipment_item> OAICalculate_rates_response_body::getItems() const {
    return m_items;
}
void OAICalculate_rates_response_body::setItems(const QList<OAIShipment_item> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAICalculate_rates_response_body::is_items_Set() const{
    return m_items_isSet;
}

bool OAICalculate_rates_response_body::is_items_Valid() const{
    return m_items_isValid;
}

QDateTime OAICalculate_rates_response_body::getModifiedAt() const {
    return m_modified_at;
}
void OAICalculate_rates_response_body::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAICalculate_rates_response_body::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAICalculate_rates_response_body::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

OAIOrder_source_name OAICalculate_rates_response_body::getOrderSourceCode() const {
    return m_order_source_code;
}
void OAICalculate_rates_response_body::setOrderSourceCode(const OAIOrder_source_name &order_source_code) {
    m_order_source_code = order_source_code;
    m_order_source_code_isSet = true;
}

bool OAICalculate_rates_response_body::is_order_source_code_Set() const{
    return m_order_source_code_isSet;
}

bool OAICalculate_rates_response_body::is_order_source_code_Valid() const{
    return m_order_source_code_isValid;
}

OAIOrigin_type OAICalculate_rates_response_body::getOriginType() const {
    return m_origin_type;
}
void OAICalculate_rates_response_body::setOriginType(const OAIOrigin_type &origin_type) {
    m_origin_type = origin_type;
    m_origin_type_isSet = true;
}

bool OAICalculate_rates_response_body::is_origin_type_Set() const{
    return m_origin_type_isSet;
}

bool OAICalculate_rates_response_body::is_origin_type_Valid() const{
    return m_origin_type_isValid;
}

QList<OAIPackage> OAICalculate_rates_response_body::getPackages() const {
    return m_packages;
}
void OAICalculate_rates_response_body::setPackages(const QList<OAIPackage> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAICalculate_rates_response_body::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAICalculate_rates_response_body::is_packages_Valid() const{
    return m_packages_isValid;
}

OAIShipping_address OAICalculate_rates_response_body::getReturnTo() const {
    return m_return_to;
}
void OAICalculate_rates_response_body::setReturnTo(const OAIShipping_address &return_to) {
    m_return_to = return_to;
    m_return_to_isSet = true;
}

bool OAICalculate_rates_response_body::is_return_to_Set() const{
    return m_return_to_isSet;
}

bool OAICalculate_rates_response_body::is_return_to_Valid() const{
    return m_return_to_isValid;
}

QString OAICalculate_rates_response_body::getServiceCode() const {
    return m_service_code;
}
void OAICalculate_rates_response_body::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAICalculate_rates_response_body::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAICalculate_rates_response_body::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QDateTime OAICalculate_rates_response_body::getShipDate() const {
    return m_ship_date;
}
void OAICalculate_rates_response_body::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAICalculate_rates_response_body::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAICalculate_rates_response_body::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIShipping_address OAICalculate_rates_response_body::getShipFrom() const {
    return m_ship_from;
}
void OAICalculate_rates_response_body::setShipFrom(const OAIShipping_address &ship_from) {
    m_ship_from = ship_from;
    m_ship_from_isSet = true;
}

bool OAICalculate_rates_response_body::is_ship_from_Set() const{
    return m_ship_from_isSet;
}

bool OAICalculate_rates_response_body::is_ship_from_Valid() const{
    return m_ship_from_isValid;
}

OAIShipping_address OAICalculate_rates_response_body::getShipTo() const {
    return m_ship_to;
}
void OAICalculate_rates_response_body::setShipTo(const OAIShipping_address &ship_to) {
    m_ship_to = ship_to;
    m_ship_to_isSet = true;
}

bool OAICalculate_rates_response_body::is_ship_to_Set() const{
    return m_ship_to_isSet;
}

bool OAICalculate_rates_response_body::is_ship_to_Valid() const{
    return m_ship_to_isValid;
}

QString OAICalculate_rates_response_body::getShipmentId() const {
    return m_shipment_id;
}
void OAICalculate_rates_response_body::setShipmentId(const QString &shipment_id) {
    m_shipment_id = shipment_id;
    m_shipment_id_isSet = true;
}

bool OAICalculate_rates_response_body::is_shipment_id_Set() const{
    return m_shipment_id_isSet;
}

bool OAICalculate_rates_response_body::is_shipment_id_Valid() const{
    return m_shipment_id_isValid;
}

QString OAICalculate_rates_response_body::getShipmentNumber() const {
    return m_shipment_number;
}
void OAICalculate_rates_response_body::setShipmentNumber(const QString &shipment_number) {
    m_shipment_number = shipment_number;
    m_shipment_number_isSet = true;
}

bool OAICalculate_rates_response_body::is_shipment_number_Set() const{
    return m_shipment_number_isSet;
}

bool OAICalculate_rates_response_body::is_shipment_number_Valid() const{
    return m_shipment_number_isValid;
}

OAIShipment_status OAICalculate_rates_response_body::getShipmentStatus() const {
    return m_shipment_status;
}
void OAICalculate_rates_response_body::setShipmentStatus(const OAIShipment_status &shipment_status) {
    m_shipment_status = shipment_status;
    m_shipment_status_isSet = true;
}

bool OAICalculate_rates_response_body::is_shipment_status_Set() const{
    return m_shipment_status_isSet;
}

bool OAICalculate_rates_response_body::is_shipment_status_Valid() const{
    return m_shipment_status_isValid;
}

QList<OAITag> OAICalculate_rates_response_body::getTags() const {
    return m_tags;
}
void OAICalculate_rates_response_body::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICalculate_rates_response_body::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICalculate_rates_response_body::is_tags_Valid() const{
    return m_tags_isValid;
}

QList<OAITax_identifier> OAICalculate_rates_response_body::getTaxIdentifiers() const {
    return m_tax_identifiers;
}
void OAICalculate_rates_response_body::setTaxIdentifiers(const QList<OAITax_identifier> &tax_identifiers) {
    m_tax_identifiers = tax_identifiers;
    m_tax_identifiers_isSet = true;
}

bool OAICalculate_rates_response_body::is_tax_identifiers_Set() const{
    return m_tax_identifiers_isSet;
}

bool OAICalculate_rates_response_body::is_tax_identifiers_Valid() const{
    return m_tax_identifiers_isValid;
}

OAIWeight OAICalculate_rates_response_body::getTotalWeight() const {
    return m_total_weight;
}
void OAICalculate_rates_response_body::setTotalWeight(const OAIWeight &total_weight) {
    m_total_weight = total_weight;
    m_total_weight_isSet = true;
}

bool OAICalculate_rates_response_body::is_total_weight_Set() const{
    return m_total_weight_isSet;
}

bool OAICalculate_rates_response_body::is_total_weight_Valid() const{
    return m_total_weight_isValid;
}

QString OAICalculate_rates_response_body::getWarehouseId() const {
    return m_warehouse_id;
}
void OAICalculate_rates_response_body::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAICalculate_rates_response_body::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAICalculate_rates_response_body::is_warehouse_id_Valid() const{
    return m_warehouse_id_isValid;
}

OAIRates_information OAICalculate_rates_response_body::getRateResponse() const {
    return m_rate_response;
}
void OAICalculate_rates_response_body::setRateResponse(const OAIRates_information &rate_response) {
    m_rate_response = rate_response;
    m_rate_response_isSet = true;
}

bool OAICalculate_rates_response_body::is_rate_response_Set() const{
    return m_rate_response_isSet;
}

bool OAICalculate_rates_response_body::is_rate_response_Valid() const{
    return m_rate_response_isValid;
}

bool OAICalculate_rates_response_body::isSet() const {
...
bool OAICalculate_rates_response_body::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_advanced_options_isValid && m_confirmation_isValid && m_created_at_isValid && m_customs_isValid && m_insurance_provider_isValid && m_modified_at_isValid && m_packages_isValid && m_return_to_isValid && m_ship_date_isValid && m_shipment_id_isValid && m_shipment_status_isValid && m_tags_isValid && m_total_weight_isValid && m_rate_response_isValid && true;
}
