...
/*
 * OAICreate_package_type_request_body.h
 *
 * A create package type request body
 */

#ifndef OAICreate_package_type_request_body_H
#define OAICreate_package_type_request_body_H
...
class OAICreate_package_type_request_body : public OAIObject {
public:
    OAICreate_package_type_request_body();
    OAICreate_package_type_request_body(QString json);
    ~OAICreate_package_type_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreate_package_type_request_body)

#endif // OAICreate_package_type_request_body_H
