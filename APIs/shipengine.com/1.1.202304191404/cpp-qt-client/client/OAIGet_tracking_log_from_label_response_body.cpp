...
OAIGet_tracking_log_from_label_response_body::OAIGet_tracking_log_from_label_response_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_tracking_log_from_label_response_body::OAIGet_tracking_log_from_label_response_body() {
    this->initializeModel();
}

OAIGet_tracking_log_from_label_response_body::~OAIGet_tracking_log_from_label_response_body() {}

void OAIGet_tracking_log_from_label_response_body::initializeModel() {
...
void OAIGet_tracking_log_from_label_response_body::fromJson(QString jsonString) {
...
void OAIGet_tracking_log_from_label_response_body::fromJsonObject(QJsonObject json) {
...
QString OAIGet_tracking_log_from_label_response_body::asJson() const {
...
QJsonObject OAIGet_tracking_log_from_label_response_body::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIGet_tracking_log_from_label_response_body::getActualDeliveryDate() const {
    return m_actual_delivery_date;
}
void OAIGet_tracking_log_from_label_response_body::setActualDeliveryDate(const QDateTime &actual_delivery_date) {
    m_actual_delivery_date = actual_delivery_date;
    m_actual_delivery_date_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_actual_delivery_date_Set() const{
    return m_actual_delivery_date_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_actual_delivery_date_Valid() const{
    return m_actual_delivery_date_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getCarrierCode() const {
    return m_carrier_code;
}
void OAIGet_tracking_log_from_label_response_body::setCarrierCode(const QString &carrier_code) {
    m_carrier_code = carrier_code;
    m_carrier_code_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_code_Set() const{
    return m_carrier_code_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_code_Valid() const{
    return m_carrier_code_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getCarrierDetailCode() const {
    return m_carrier_detail_code;
}
void OAIGet_tracking_log_from_label_response_body::setCarrierDetailCode(const QString &carrier_detail_code) {
    m_carrier_detail_code = carrier_detail_code;
    m_carrier_detail_code_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_detail_code_Set() const{
    return m_carrier_detail_code_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_detail_code_Valid() const{
    return m_carrier_detail_code_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getCarrierId() const {
    return m_carrier_id;
}
void OAIGet_tracking_log_from_label_response_body::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getCarrierStatusCode() const {
    return m_carrier_status_code;
}
void OAIGet_tracking_log_from_label_response_body::setCarrierStatusCode(const QString &carrier_status_code) {
    m_carrier_status_code = carrier_status_code;
    m_carrier_status_code_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_status_code_Set() const{
    return m_carrier_status_code_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_status_code_Valid() const{
    return m_carrier_status_code_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getCarrierStatusDescription() const {
    return m_carrier_status_description;
}
void OAIGet_tracking_log_from_label_response_body::setCarrierStatusDescription(const QString &carrier_status_description) {
    m_carrier_status_description = carrier_status_description;
    m_carrier_status_description_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_status_description_Set() const{
    return m_carrier_status_description_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_carrier_status_description_Valid() const{
    return m_carrier_status_description_isValid;
}

QDateTime OAIGet_tracking_log_from_label_response_body::getEstimatedDeliveryDate() const {
    return m_estimated_delivery_date;
}
void OAIGet_tracking_log_from_label_response_body::setEstimatedDeliveryDate(const QDateTime &estimated_delivery_date) {
    m_estimated_delivery_date = estimated_delivery_date;
    m_estimated_delivery_date_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_estimated_delivery_date_Set() const{
    return m_estimated_delivery_date_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_estimated_delivery_date_Valid() const{
    return m_estimated_delivery_date_isValid;
}

QList<OAITrack_event> OAIGet_tracking_log_from_label_response_body::getEvents() const {
    return m_events;
}
void OAIGet_tracking_log_from_label_response_body::setEvents(const QList<OAITrack_event> &events) {
    m_events = events;
    m_events_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_events_Set() const{
    return m_events_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_events_Valid() const{
    return m_events_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getExceptionDescription() const {
    return m_exception_description;
}
void OAIGet_tracking_log_from_label_response_body::setExceptionDescription(const QString &exception_description) {
    m_exception_description = exception_description;
    m_exception_description_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_exception_description_Set() const{
    return m_exception_description_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_exception_description_Valid() const{
    return m_exception_description_isValid;
}

QDateTime OAIGet_tracking_log_from_label_response_body::getShipDate() const {
    return m_ship_date;
}
void OAIGet_tracking_log_from_label_response_body::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIStatus_code OAIGet_tracking_log_from_label_response_body::getStatusCode() const {
    return m_status_code;
}
void OAIGet_tracking_log_from_label_response_body::setStatusCode(const OAIStatus_code &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_status_code_Valid() const{
    return m_status_code_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getStatusDescription() const {
    return m_status_description;
}
void OAIGet_tracking_log_from_label_response_body::setStatusDescription(const QString &status_description) {
    m_status_description = status_description;
    m_status_description_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_status_description_Set() const{
    return m_status_description_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_status_description_Valid() const{
    return m_status_description_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getTrackingNumber() const {
    return m_tracking_number;
}
void OAIGet_tracking_log_from_label_response_body::setTrackingNumber(const QString &tracking_number) {
    m_tracking_number = tracking_number;
    m_tracking_number_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_tracking_number_Set() const{
    return m_tracking_number_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_tracking_number_Valid() const{
    return m_tracking_number_isValid;
}

QString OAIGet_tracking_log_from_label_response_body::getTrackingUrl() const {
    return m_tracking_url;
}
void OAIGet_tracking_log_from_label_response_body::setTrackingUrl(const QString &tracking_url) {
    m_tracking_url = tracking_url;
    m_tracking_url_isSet = true;
}

bool OAIGet_tracking_log_from_label_response_body::is_tracking_url_Set() const{
    return m_tracking_url_isSet;
}

bool OAIGet_tracking_log_from_label_response_body::is_tracking_url_Valid() const{
    return m_tracking_url_isValid;
}

bool OAIGet_tracking_log_from_label_response_body::isSet() const {
...
bool OAIGet_tracking_log_from_label_response_body::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_carrier_status_code_isValid && m_estimated_delivery_date_isValid && m_events_isValid && m_status_code_isValid && m_tracking_number_isValid && true;
}
