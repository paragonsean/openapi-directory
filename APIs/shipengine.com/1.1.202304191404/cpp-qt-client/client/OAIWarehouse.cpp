...
bool OAIWarehouse::isIsDefault() const {
    return m_is_default;
}
void OAIWarehouse::setIsDefault(const bool &is_default) {
    m_is_default = is_default;
    m_is_default_isSet = true;
}

bool OAIWarehouse::is_is_default_Set() const{
    return m_is_default_isSet;
}

bool OAIWarehouse::is_is_default_Valid() const{
...
OAIAddress OAIWarehouse::getOriginAddress() const {
    return m_origin_address;
}
void OAIWarehouse::setOriginAddress(const OAIAddress &origin_address) {
    m_origin_address = origin_address;
    m_origin_address_isSet = true;
}

bool OAIWarehouse::is_origin_address_Set() const{
    return m_origin_address_isSet;
}

bool OAIWarehouse::is_origin_address_Valid() const{
    return m_origin_address_isValid;
}

OAIAddress OAIWarehouse::getReturnAddress() const {
    return m_return_address;
}
void OAIWarehouse::setReturnAddress(const OAIAddress &return_address) {
    m_return_address = return_address;
    m_return_address_isSet = true;
}

bool OAIWarehouse::is_return_address_Set() const{
    return m_return_address_isSet;
}

bool OAIWarehouse::is_return_address_Valid() const{
    return m_return_address_isValid;
}

QString OAIWarehouse::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIWarehouse::setWarehouseId(const QString &warehouse_id) {
