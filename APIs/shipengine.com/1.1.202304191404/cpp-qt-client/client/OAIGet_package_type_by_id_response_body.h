...
/*
 * OAIGet_package_type_by_id_response_body.h
 *
 * A get package type by id response body
 */

#ifndef OAIGet_package_type_by_id_response_body_H
#define OAIGet_package_type_by_id_response_body_H
...
class OAIGet_package_type_by_id_response_body : public OAIObject {
public:
    OAIGet_package_type_by_id_response_body();
    OAIGet_package_type_by_id_response_body(QString json);
    ~OAIGet_package_type_by_id_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_package_type_by_id_response_body)

#endif // OAIGet_package_type_by_id_response_body_H
