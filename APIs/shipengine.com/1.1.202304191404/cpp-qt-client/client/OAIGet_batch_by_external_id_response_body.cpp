...
OAIGet_batch_by_external_id_response_body::OAIGet_batch_by_external_id_response_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_batch_by_external_id_response_body::OAIGet_batch_by_external_id_response_body() {
    this->initializeModel();
}

OAIGet_batch_by_external_id_response_body::~OAIGet_batch_by_external_id_response_body() {}

void OAIGet_batch_by_external_id_response_body::initializeModel() {
...
void OAIGet_batch_by_external_id_response_body::fromJson(QString jsonString) {
...
void OAIGet_batch_by_external_id_response_body::fromJsonObject(QJsonObject json) {
...
QString OAIGet_batch_by_external_id_response_body::asJson() const {
...
QJsonObject OAIGet_batch_by_external_id_response_body::asJsonObject() const {
    QJsonObject obj;
...
OAIOptional_link OAIGet_batch_by_external_id_response_body::getBatchErrorsUrl() const {
    return m_batch_errors_url;
}
void OAIGet_batch_by_external_id_response_body::setBatchErrorsUrl(const OAIOptional_link &batch_errors_url) {
    m_batch_errors_url = batch_errors_url;
    m_batch_errors_url_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_errors_url_Set() const{
    return m_batch_errors_url_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_errors_url_Valid() const{
    return m_batch_errors_url_isValid;
}

QString OAIGet_batch_by_external_id_response_body::getBatchId() const {
    return m_batch_id;
}
void OAIGet_batch_by_external_id_response_body::setBatchId(const QString &batch_id) {
    m_batch_id = batch_id;
    m_batch_id_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_id_Set() const{
    return m_batch_id_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_id_Valid() const{
    return m_batch_id_isValid;
}

OAIOptional_link OAIGet_batch_by_external_id_response_body::getBatchLabelsUrl() const {
    return m_batch_labels_url;
}
void OAIGet_batch_by_external_id_response_body::setBatchLabelsUrl(const OAIOptional_link &batch_labels_url) {
    m_batch_labels_url = batch_labels_url;
    m_batch_labels_url_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_labels_url_Set() const{
    return m_batch_labels_url_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_labels_url_Valid() const{
    return m_batch_labels_url_isValid;
}

QString OAIGet_batch_by_external_id_response_body::getBatchNotes() const {
    return m_batch_notes;
}
void OAIGet_batch_by_external_id_response_body::setBatchNotes(const QString &batch_notes) {
    m_batch_notes = batch_notes;
    m_batch_notes_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_notes_Set() const{
    return m_batch_notes_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_notes_Valid() const{
    return m_batch_notes_isValid;
}

QString OAIGet_batch_by_external_id_response_body::getBatchNumber() const {
    return m_batch_number;
}
void OAIGet_batch_by_external_id_response_body::setBatchNumber(const QString &batch_number) {
    m_batch_number = batch_number;
    m_batch_number_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_number_Set() const{
    return m_batch_number_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_number_Valid() const{
    return m_batch_number_isValid;
}

OAIOptional_link OAIGet_batch_by_external_id_response_body::getBatchShipmentsUrl() const {
    return m_batch_shipments_url;
}
void OAIGet_batch_by_external_id_response_body::setBatchShipmentsUrl(const OAIOptional_link &batch_shipments_url) {
    m_batch_shipments_url = batch_shipments_url;
    m_batch_shipments_url_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_shipments_url_Set() const{
    return m_batch_shipments_url_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_batch_shipments_url_Valid() const{
    return m_batch_shipments_url_isValid;
}

qint32 OAIGet_batch_by_external_id_response_body::getCompleted() const {
    return m_completed;
}
void OAIGet_batch_by_external_id_response_body::setCompleted(const qint32 &completed) {
    m_completed = completed;
    m_completed_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_completed_Set() const{
    return m_completed_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_completed_Valid() const{
    return m_completed_isValid;
}

qint32 OAIGet_batch_by_external_id_response_body::getCount() const {
    return m_count;
}
void OAIGet_batch_by_external_id_response_body::setCount(const qint32 &count) {
    m_count = count;
    m_count_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_count_Set() const{
    return m_count_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_count_Valid() const{
    return m_count_isValid;
}

QDateTime OAIGet_batch_by_external_id_response_body::getCreatedAt() const {
    return m_created_at;
}
void OAIGet_batch_by_external_id_response_body::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_created_at_Valid() const{
    return m_created_at_isValid;
}

qint32 OAIGet_batch_by_external_id_response_body::getErrors() const {
    return m_errors;
}
void OAIGet_batch_by_external_id_response_body::setErrors(const qint32 &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAIGet_batch_by_external_id_response_body::getExternalBatchId() const {
    return m_external_batch_id;
}
void OAIGet_batch_by_external_id_response_body::setExternalBatchId(const QString &external_batch_id) {
    m_external_batch_id = external_batch_id;
    m_external_batch_id_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_external_batch_id_Set() const{
    return m_external_batch_id_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_external_batch_id_Valid() const{
    return m_external_batch_id_isValid;
}

OAIOptional_link OAIGet_batch_by_external_id_response_body::getFormDownload() const {
    return m_form_download;
}
void OAIGet_batch_by_external_id_response_body::setFormDownload(const OAIOptional_link &form_download) {
    m_form_download = form_download;
    m_form_download_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_form_download_Set() const{
    return m_form_download_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_form_download_Valid() const{
    return m_form_download_isValid;
}

qint32 OAIGet_batch_by_external_id_response_body::getForms() const {
    return m_forms;
}
void OAIGet_batch_by_external_id_response_body::setForms(const qint32 &forms) {
    m_forms = forms;
    m_forms_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_forms_Set() const{
    return m_forms_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_forms_Valid() const{
    return m_forms_isValid;
}

OAILabel_download OAIGet_batch_by_external_id_response_body::getLabelDownload() const {
    return m_label_download;
}
void OAIGet_batch_by_external_id_response_body::setLabelDownload(const OAILabel_download &label_download) {
    m_label_download = label_download;
    m_label_download_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_label_download_Set() const{
    return m_label_download_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_label_download_Valid() const{
    return m_label_download_isValid;
}

OAILabel_format OAIGet_batch_by_external_id_response_body::getLabelFormat() const {
    return m_label_format;
}
void OAIGet_batch_by_external_id_response_body::setLabelFormat(const OAILabel_format &label_format) {
    m_label_format = label_format;
    m_label_format_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_label_format_Set() const{
    return m_label_format_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_label_format_Valid() const{
    return m_label_format_isValid;
}

OAILabel_layout OAIGet_batch_by_external_id_response_body::getLabelLayout() const {
    return m_label_layout;
}
void OAIGet_batch_by_external_id_response_body::setLabelLayout(const OAILabel_layout &label_layout) {
    m_label_layout = label_layout;
    m_label_layout_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_label_layout_Set() const{
    return m_label_layout_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_label_layout_Valid() const{
    return m_label_layout_isValid;
}

QDateTime OAIGet_batch_by_external_id_response_body::getProcessedAt() const {
    return m_processed_at;
}
void OAIGet_batch_by_external_id_response_body::setProcessedAt(const QDateTime &processed_at) {
    m_processed_at = processed_at;
    m_processed_at_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_processed_at_Set() const{
    return m_processed_at_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_processed_at_Valid() const{
    return m_processed_at_isValid;
}

OAIBatch_status OAIGet_batch_by_external_id_response_body::getStatus() const {
    return m_status;
}
void OAIGet_batch_by_external_id_response_body::setStatus(const OAIBatch_status &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_status_Set() const{
    return m_status_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_status_Valid() const{
    return m_status_isValid;
}

qint32 OAIGet_batch_by_external_id_response_body::getWarnings() const {
    return m_warnings;
}
void OAIGet_batch_by_external_id_response_body::setWarnings(const qint32 &warnings) {
    m_warnings = warnings;
    m_warnings_isSet = true;
}

bool OAIGet_batch_by_external_id_response_body::is_warnings_Set() const{
    return m_warnings_isSet;
}

bool OAIGet_batch_by_external_id_response_body::is_warnings_Valid() const{
    return m_warnings_isValid;
}

bool OAIGet_batch_by_external_id_response_body::isSet() const {
...
bool OAIGet_batch_by_external_id_response_body::isValid() const {
