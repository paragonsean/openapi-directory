...
public:
    ...
    OAIManifest_download getManifestDownload() const;
    void setManifestDownload(const OAIManifest_download &manifest_download);
    bool is_manifest_download_Set() const;
    bool is_manifest_download_Valid() const;
    ...
    qint32 getShipments() const;
    void setShipments(const qint32 &shipments);
