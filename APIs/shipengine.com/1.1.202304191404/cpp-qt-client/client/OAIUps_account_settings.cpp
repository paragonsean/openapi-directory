...
#include "OAIUps_account_settings.h"
...
OAIUps_account_settings::OAIUps_account_settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUps_account_settings::OAIUps_account_settings() {
    this->initializeModel();
}

OAIUps_account_settings::~OAIUps_account_settings() {}

void OAIUps_account_settings::initializeModel() {
...
void OAIUps_account_settings::fromJson(QString jsonString) {
...
void OAIUps_account_settings::fromJsonObject(QJsonObject json) {
...
QString OAIUps_account_settings::asJson() const {
...
QJsonObject OAIUps_account_settings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUps_account_settings::getAccountPostalCode() const {
    return m_account_postal_code;
}
void OAIUps_account_settings::setAccountPostalCode(const QString &account_postal_code) {
    m_account_postal_code = account_postal_code;
    m_account_postal_code_isSet = true;
}

bool OAIUps_account_settings::is_account_postal_code_Set() const{
    return m_account_postal_code_isSet;
}

bool OAIUps_account_settings::is_account_postal_code_Valid() const{
    return m_account_postal_code_isValid;
}

OAIUps_invoice OAIUps_account_settings::getInvoice() const {
    return m_invoice;
}
void OAIUps_account_settings::setInvoice(const OAIUps_invoice &invoice) {
    m_invoice = invoice;
    m_invoice_isSet = true;
}

bool OAIUps_account_settings::is_invoice_Set() const{
    return m_invoice_isSet;
}

bool OAIUps_account_settings::is_invoice_Valid() const{
    return m_invoice_isValid;
}

bool OAIUps_account_settings::isIsPrimaryAccount() const {
    return m_is_primary_account;
}
void OAIUps_account_settings::setIsPrimaryAccount(const bool &is_primary_account) {
    m_is_primary_account = is_primary_account;
    m_is_primary_account_isSet = true;
}

bool OAIUps_account_settings::is_is_primary_account_Set() const{
    return m_is_primary_account_isSet;
}

bool OAIUps_account_settings::is_is_primary_account_Valid() const{
    return m_is_primary_account_isValid;
}

QString OAIUps_account_settings::getMailInnovationsCostCenter() const {
    return m_mail_innovations_cost_center;
}
void OAIUps_account_settings::setMailInnovationsCostCenter(const QString &mail_innovations_cost_center) {
    m_mail_innovations_cost_center = mail_innovations_cost_center;
    m_mail_innovations_cost_center_isSet = true;
}

bool OAIUps_account_settings::is_mail_innovations_cost_center_Set() const{
    return m_mail_innovations_cost_center_isSet;
}

bool OAIUps_account_settings::is_mail_innovations_cost_center_Valid() const{
    return m_mail_innovations_cost_center_isValid;
}

OAIAncillary_service_endorsement OAIUps_account_settings::getMailInnovationsEndorsement() const {
    return m_mail_innovations_endorsement;
}
void OAIUps_account_settings::setMailInnovationsEndorsement(const OAIAncillary_service_endorsement &mail_innovations_endorsement) {
    m_mail_innovations_endorsement = mail_innovations_endorsement;
    m_mail_innovations_endorsement_isSet = true;
}

bool OAIUps_account_settings::is_mail_innovations_endorsement_Set() const{
    return m_mail_innovations_endorsement_isSet;
}

bool OAIUps_account_settings::is_mail_innovations_endorsement_Valid() const{
    return m_mail_innovations_endorsement_isValid;
}

QString OAIUps_account_settings::getNickname() const {
    return m_nickname;
}
void OAIUps_account_settings::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAIUps_account_settings::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAIUps_account_settings::is_nickname_Valid() const{
    return m_nickname_isValid;
}

OAIUps_pickup_type OAIUps_account_settings::getPickupType() const {
    return m_pickup_type;
}
void OAIUps_account_settings::setPickupType(const OAIUps_pickup_type &pickup_type) {
    m_pickup_type = pickup_type;
    m_pickup_type_isSet = true;
}

bool OAIUps_account_settings::is_pickup_type_Set() const{
    return m_pickup_type_isSet;
}

bool OAIUps_account_settings::is_pickup_type_Valid() const{
    return m_pickup_type_isValid;
}

bool OAIUps_account_settings::isUseCarbonNeutralShippingProgram() const {
    return m_use_carbon_neutral_shipping_program;
}
void OAIUps_account_settings::setUseCarbonNeutralShippingProgram(const bool &use_carbon_neutral_shipping_program) {
...
bool OAIUps_account_settings::is_use_carbon_neutral_shipping_program_Set() const{
    return m_use_carbon_neutral_shipping_program_isSet;
}

bool OAIUps_account_settings::is_use_carbon_neutral_shipping_program_Valid() const{
    return m_use_carbon_neutral_shipping_program_isValid;
}

bool OAIUps_account_settings::isUseConsolidationServices() const {
    return m_use_consolidation_services;
}
void OAIUps_account_settings::setUseConsolidationServices(const bool &use_consolidation_services) {
    m_use_consolidation_services = use_consolidation_services;
    m_use_consolidation_services_isSet = true;
}

bool OAIUps_account_settings::is_use_consolidation_services_Set() const{
    return m_use_consolidation_services_isSet;
}

bool OAIUps_account_settings::is_use_consolidation_services_Valid() const{
    return m_use_consolidation_services_isValid;
}

bool OAIUps_account_settings::isUseGroundFreightPricing() const {
    return m_use_ground_freight_pricing;
}
void OAIUps_account_settings::setUseGroundFreightPricing(const bool &use_ground_freight_pricing) {
    m_use_ground_freight_pricing = use_ground_freight_pricing;
    m_use_ground_freight_pricing_isSet = true;
}

bool OAIUps_account_settings::is_use_ground_freight_pricing_Set() const{
    return m_use_ground_freight_pricing_isSet;
}

bool OAIUps_account_settings::is_use_ground_freight_pricing_Valid() const{
    return m_use_ground_freight_pricing_isValid;
}

bool OAIUps_account_settings::isUseNegotiatedRates() const {
    return m_use_negotiated_rates;
}
void OAIUps_account_settings::setUseNegotiatedRates(const bool &use_negotiated_rates) {
    m_use_negotiated_rates = use_negotiated_rates;
    m_use_negotiated_rates_isSet = true;
}

bool OAIUps_account_settings::is_use_negotiated_rates_Set() const{
    return m_use_negotiated_rates_isSet;
}

bool OAIUps_account_settings::is_use_negotiated_rates_Valid() const{
    return m_use_negotiated_rates_isValid;
}

bool OAIUps_account_settings::isUseOrderNumberOnMailInnovationsLabels() const {
    return m_use_order_number_on_mail_innovations_labels;
}
void OAIUps_account_settings::setUseOrderNumberOnMailInnovationsLabels(const bool &use_order_number_on_mail_innovations_labels) {
...
bool OAIUps_account_settings::is_use_order_number_on_mail_innovations_labels_Set() const{
    return m_use_order_number_on_mail_innovations_labels_isSet;
}

bool OAIUps_account_settings::is_use_order_number_on_mail_innovations_labels_Valid() const{
    return m_use_order_number_on_mail_innovations_labels_isValid;
}

bool OAIUps_account_settings::isSet() const {
...
bool OAIUps_account_settings::isValid() const {
