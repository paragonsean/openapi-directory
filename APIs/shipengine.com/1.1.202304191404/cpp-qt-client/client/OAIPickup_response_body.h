...
/*
 * OAIPickup_response_body.h
 *
 * A pickup response body
 */

#ifndef OAIPickup_response_body_H
#define OAIPickup_response_body_H
...
class OAIPickup_response_body : public OAIObject {
public:
    OAIPickup_response_body();
    OAIPickup_response_body(QString json);
    ~OAIPickup_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPickup_response_body)

#endif // OAIPickup_response_body_H
