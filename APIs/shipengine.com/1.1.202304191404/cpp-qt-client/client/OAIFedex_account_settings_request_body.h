...
/*
 * OAIFedex_account_settings_request_body.h
 *
 * A Fedex account settings request body
 */

#ifndef OAIFedex_account_settings_request_body_H
#define OAIFedex_account_settings_request_body_H
...
class OAIFedex_account_settings_request_body : public OAIObject {
public:
    OAIFedex_account_settings_request_body();
    OAIFedex_account_settings_request_body(QString json);
    ~OAIFedex_account_settings_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFedex_account_settings_request_body)

#endif // OAIFedex_account_settings_request_body_H
