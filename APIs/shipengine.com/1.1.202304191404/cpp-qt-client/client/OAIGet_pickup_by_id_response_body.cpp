...
OAIGet_pickup_by_id_response_body::OAIGet_pickup_by_id_response_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_pickup_by_id_response_body::OAIGet_pickup_by_id_response_body() {
    this->initializeModel();
}

OAIGet_pickup_by_id_response_body::~OAIGet_pickup_by_id_response_body() {}

void OAIGet_pickup_by_id_response_body::initializeModel() {
...
void OAIGet_pickup_by_id_response_body::fromJson(QString jsonString) {
...
void OAIGet_pickup_by_id_response_body::fromJsonObject(QJsonObject json) {
...
QString OAIGet_pickup_by_id_response_body::asJson() const {
...
QJsonObject OAIGet_pickup_by_id_response_body::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIGet_pickup_by_id_response_body::getCancelledAt() const {
    return m_cancelled_at;
}
void OAIGet_pickup_by_id_response_body::setCancelledAt(const QDateTime &cancelled_at) {
    m_cancelled_at = cancelled_at;
    m_cancelled_at_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_cancelled_at_Set() const{
    return m_cancelled_at_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_cancelled_at_Valid() const{
    return m_cancelled_at_isValid;
}

QString OAIGet_pickup_by_id_response_body::getCarrierId() const {
    return m_carrier_id;
}
void OAIGet_pickup_by_id_response_body::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAIGet_pickup_by_id_response_body::getConfirmationNumber() const {
    return m_confirmation_number;
}
void OAIGet_pickup_by_id_response_body::setConfirmationNumber(const QString &confirmation_number) {
    m_confirmation_number = confirmation_number;
    m_confirmation_number_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_confirmation_number_Set() const{
    return m_confirmation_number_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_confirmation_number_Valid() const{
    return m_confirmation_number_isValid;
}

OAIContact_details OAIGet_pickup_by_id_response_body::getContactDetails() const {
    return m_contact_details;
}
void OAIGet_pickup_by_id_response_body::setContactDetails(const OAIContact_details &contact_details) {
    m_contact_details = contact_details;
    m_contact_details_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_contact_details_Set() const{
    return m_contact_details_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_contact_details_Valid() const{
    return m_contact_details_isValid;
}

QDateTime OAIGet_pickup_by_id_response_body::getCreatedAt() const {
    return m_created_at;
}
void OAIGet_pickup_by_id_response_body::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QList<QString> OAIGet_pickup_by_id_response_body::getLabelIds() const {
    return m_label_ids;
}
void OAIGet_pickup_by_id_response_body::setLabelIds(const QList<QString> &label_ids) {
    m_label_ids = label_ids;
    m_label_ids_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_label_ids_Set() const{
    return m_label_ids_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_label_ids_Valid() const{
    return m_label_ids_isValid;
}

OAIAddress OAIGet_pickup_by_id_response_body::getPickupAddress() const {
    return m_pickup_address;
}
void OAIGet_pickup_by_id_response_body::setPickupAddress(const OAIAddress &pickup_address) {
    m_pickup_address = pickup_address;
    m_pickup_address_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_address_Set() const{
    return m_pickup_address_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_address_Valid() const{
    return m_pickup_address_isValid;
}

QString OAIGet_pickup_by_id_response_body::getPickupId() const {
    return m_pickup_id;
}
void OAIGet_pickup_by_id_response_body::setPickupId(const QString &pickup_id) {
    m_pickup_id = pickup_id;
    m_pickup_id_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_id_Set() const{
    return m_pickup_id_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_id_Valid() const{
    return m_pickup_id_isValid;
}

QString OAIGet_pickup_by_id_response_body::getPickupNotes() const {
    return m_pickup_notes;
}
void OAIGet_pickup_by_id_response_body::setPickupNotes(const QString &pickup_notes) {
    m_pickup_notes = pickup_notes;
    m_pickup_notes_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_notes_Set() const{
    return m_pickup_notes_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_notes_Valid() const{
    return m_pickup_notes_isValid;
}

OAIPickup_window OAIGet_pickup_by_id_response_body::getPickupWindow() const {
    return m_pickup_window;
}
void OAIGet_pickup_by_id_response_body::setPickupWindow(const OAIPickup_window &pickup_window) {
    m_pickup_window = pickup_window;
    m_pickup_window_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_window_Set() const{
    return m_pickup_window_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_window_Valid() const{
    return m_pickup_window_isValid;
}

QList<OAIPickup_windows> OAIGet_pickup_by_id_response_body::getPickupWindows() const {
    return m_pickup_windows;
}
void OAIGet_pickup_by_id_response_body::setPickupWindows(const QList<OAIPickup_windows> &pickup_windows) {
    m_pickup_windows = pickup_windows;
    m_pickup_windows_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_windows_Set() const{
    return m_pickup_windows_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_pickup_windows_Valid() const{
    return m_pickup_windows_isValid;
}

QString OAIGet_pickup_by_id_response_body::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIGet_pickup_by_id_response_body::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_warehouse_id_Valid() const{
    return m_warehouse_id_isValid;
}

QList<OAIError> OAIGet_pickup_by_id_response_body::getErrors() const {
    return m_errors;
}
void OAIGet_pickup_by_id_response_body::setErrors(const QList<OAIError> &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_errors_Valid() const{
    return m_errors_isValid;
}

QString OAIGet_pickup_by_id_response_body::getRequestId() const {
    return m_request_id;
}
void OAIGet_pickup_by_id_response_body::setRequestId(const QString &request_id) {
    m_request_id = request_id;
    m_request_id_isSet = true;
}

bool OAIGet_pickup_by_id_response_body::is_request_id_Set() const{
    return m_request_id_isSet;
}

bool OAIGet_pickup_by_id_response_body::is_request_id_Valid() const{
    return m_request_id_isValid;
}

bool OAIGet_pickup_by_id_response_body::isSet() const {
...
bool OAIGet_pickup_by_id_response_body::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_carrier_id_isValid && m_confirmation_number_isValid && m_contact_details_isValid && m_created_at_isValid && m_label_ids_isValid && m_pickup_address_isValid && m_pickup_id_isValid && m_pickup_window_isValid && m_warehouse_id_isValid && m_errors_isValid && m_request_id_isValid && true;
}
