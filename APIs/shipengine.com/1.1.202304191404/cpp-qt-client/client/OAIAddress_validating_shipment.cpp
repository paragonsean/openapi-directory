...
#include "OAIAddress_validating_shipment.h"
...
OAIAddress_validating_shipment::OAIAddress_validating_shipment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddress_validating_shipment::OAIAddress_validating_shipment() {
    this->initializeModel();
}

OAIAddress_validating_shipment::~OAIAddress_validating_shipment() {}

void OAIAddress_validating_shipment::initializeModel() {
...
void OAIAddress_validating_shipment::fromJson(QString jsonString) {
...
void OAIAddress_validating_shipment::fromJsonObject(QJsonObject json) {
...
QString OAIAddress_validating_shipment::asJson() const {
...
QJsonObject OAIAddress_validating_shipment::asJsonObject() const {
    QJsonObject obj;
...
OAIValidate_address OAIAddress_validating_shipment::getValidateAddress() const {
    return m_validate_address;
}
void OAIAddress_validating_shipment::setValidateAddress(const OAIValidate_address &validate_address) {
    m_validate_address = validate_address;
    m_validate_address_isSet = true;
}

bool OAIAddress_validating_shipment::is_validate_address_Set() const{
    return m_validate_address_isSet;
}

bool OAIAddress_validating_shipment::is_validate_address_Valid() const{
    return m_validate_address_isValid;
}

OAIAdvanced_shipment_options OAIAddress_validating_shipment::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAIAddress_validating_shipment::setAdvancedOptions(const OAIAdvanced_shipment_options &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAIAddress_validating_shipment::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAIAddress_validating_shipment::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

QString OAIAddress_validating_shipment::getCarrierId() const {
    return m_carrier_id;
}
void OAIAddress_validating_shipment::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIAddress_validating_shipment::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIAddress_validating_shipment::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

OAIDelivery_confirmation OAIAddress_validating_shipment::getConfirmation() const {
    return m_confirmation;
}
void OAIAddress_validating_shipment::setConfirmation(const OAIDelivery_confirmation &confirmation) {
    m_confirmation = confirmation;
    m_confirmation_isSet = true;
}

bool OAIAddress_validating_shipment::is_confirmation_Set() const{
    return m_confirmation_isSet;
}

bool OAIAddress_validating_shipment::is_confirmation_Valid() const{
    return m_confirmation_isValid;
}

QDateTime OAIAddress_validating_shipment::getCreatedAt() const {
    return m_created_at;
}
void OAIAddress_validating_shipment::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIAddress_validating_shipment::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIAddress_validating_shipment::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIInternational_shipment_options OAIAddress_validating_shipment::getCustoms() const {
    return m_customs;
}
void OAIAddress_validating_shipment::setCustoms(const OAIInternational_shipment_options &customs) {
    m_customs = customs;
    m_customs_isSet = true;
}

bool OAIAddress_validating_shipment::is_customs_Set() const{
    return m_customs_isSet;
}

bool OAIAddress_validating_shipment::is_customs_Valid() const{
    return m_customs_isValid;
}

QString OAIAddress_validating_shipment::getExternalOrderId() const {
    return m_external_order_id;
}
void OAIAddress_validating_shipment::setExternalOrderId(const QString &external_order_id) {
    m_external_order_id = external_order_id;
    m_external_order_id_isSet = true;
}

bool OAIAddress_validating_shipment::is_external_order_id_Set() const{
    return m_external_order_id_isSet;
}

bool OAIAddress_validating_shipment::is_external_order_id_Valid() const{
    return m_external_order_id_isValid;
}

QString OAIAddress_validating_shipment::getExternalShipmentId() const {
    return m_external_shipment_id;
}
void OAIAddress_validating_shipment::setExternalShipmentId(const QString &external_shipment_id) {
    m_external_shipment_id = external_shipment_id;
    m_external_shipment_id_isSet = true;
}

bool OAIAddress_validating_shipment::is_external_shipment_id_Set() const{
    return m_external_shipment_id_isSet;
}

bool OAIAddress_validating_shipment::is_external_shipment_id_Valid() const{
    return m_external_shipment_id_isValid;
}

OAIInsurance_provider OAIAddress_validating_shipment::getInsuranceProvider() const {
    return m_insurance_provider;
}
void OAIAddress_validating_shipment::setInsuranceProvider(const OAIInsurance_provider &insurance_provider) {
    m_insurance_provider = insurance_provider;
    m_insurance_provider_isSet = true;
}

bool OAIAddress_validating_shipment::is_insurance_provider_Set() const{
    return m_insurance_provider_isSet;
}

bool OAIAddress_validating_shipment::is_insurance_provider_Valid() const{
    return m_insurance_provider_isValid;
}

bool OAIAddress_validating_shipment::isIsReturn() const {
    return m_is_return;
}
void OAIAddress_validating_shipment::setIsReturn(const bool &is_return) {
    m_is_return = is_return;
    m_is_return_isSet = true;
}

bool OAIAddress_validating_shipment::is_is_return_Set() const{
    return m_is_return_isSet;
}

bool OAIAddress_validating_shipment::is_is_return_Valid() const{
    return m_is_return_isValid;
}

QList<OAIShipment_item> OAIAddress_validating_shipment::getItems() const {
    return m_items;
}
void OAIAddress_validating_shipment::setItems(const QList<OAIShipment_item> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIAddress_validating_shipment::is_items_Set() const{
    return m_items_isSet;
}

bool OAIAddress_validating_shipment::is_items_Valid() const{
    return m_items_isValid;
}

QDateTime OAIAddress_validating_shipment::getModifiedAt() const {
    return m_modified_at;
}
void OAIAddress_validating_shipment::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIAddress_validating_shipment::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIAddress_validating_shipment::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

OAIOrder_source_name OAIAddress_validating_shipment::getOrderSourceCode() const {
    return m_order_source_code;
}
void OAIAddress_validating_shipment::setOrderSourceCode(const OAIOrder_source_name &order_source_code) {
    m_order_source_code = order_source_code;
    m_order_source_code_isSet = true;
}

bool OAIAddress_validating_shipment::is_order_source_code_Set() const{
    return m_order_source_code_isSet;
}

bool OAIAddress_validating_shipment::is_order_source_code_Valid() const{
    return m_order_source_code_isValid;
}

OAIOrigin_type OAIAddress_validating_shipment::getOriginType() const {
    return m_origin_type;
}
void OAIAddress_validating_shipment::setOriginType(const OAIOrigin_type &origin_type) {
    m_origin_type = origin_type;
    m_origin_type_isSet = true;
}

bool OAIAddress_validating_shipment::is_origin_type_Set() const{
    return m_origin_type_isSet;
}

bool OAIAddress_validating_shipment::is_origin_type_Valid() const{
    return m_origin_type_isValid;
}

QList<OAIPackage> OAIAddress_validating_shipment::getPackages() const {
    return m_packages;
}
void OAIAddress_validating_shipment::setPackages(const QList<OAIPackage> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAIAddress_validating_shipment::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAIAddress_validating_shipment::is_packages_Valid() const{
    return m_packages_isValid;
}

OAIShipping_address OAIAddress_validating_shipment::getReturnTo() const {
    return m_return_to;
}
void OAIAddress_validating_shipment::setReturnTo(const OAIShipping_address &return_to) {
    m_return_to = return_to;
    m_return_to_isSet = true;
}

bool OAIAddress_validating_shipment::is_return_to_Set() const{
    return m_return_to_isSet;
}

bool OAIAddress_validating_shipment::is_return_to_Valid() const{
    return m_return_to_isValid;
}

QString OAIAddress_validating_shipment::getServiceCode() const {
    return m_service_code;
}
void OAIAddress_validating_shipment::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIAddress_validating_shipment::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIAddress_validating_shipment::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QDateTime OAIAddress_validating_shipment::getShipDate() const {
    return m_ship_date;
}
void OAIAddress_validating_shipment::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIAddress_validating_shipment::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIAddress_validating_shipment::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIShipping_address OAIAddress_validating_shipment::getShipFrom() const {
    return m_ship_from;
}
void OAIAddress_validating_shipment::setShipFrom(const OAIShipping_address &ship_from) {
    m_ship_from = ship_from;
    m_ship_from_isSet = true;
}

bool OAIAddress_validating_shipment::is_ship_from_Set() const{
    return m_ship_from_isSet;
}

bool OAIAddress_validating_shipment::is_ship_from_Valid() const{
    return m_ship_from_isValid;
}

OAIShipping_address OAIAddress_validating_shipment::getShipTo() const {
    return m_ship_to;
}
void OAIAddress_validating_shipment::setShipTo(const OAIShipping_address &ship_to) {
    m_ship_to = ship_to;
    m_ship_to_isSet = true;
}

bool OAIAddress_validating_shipment::is_ship_to_Set() const{
    return m_ship_to_isSet;
}

bool OAIAddress_validating_shipment::is_ship_to_Valid() const{
    return m_ship_to_isValid;
}

QString OAIAddress_validating_shipment::getShipmentId() const {
    return m_shipment_id;
}
void OAIAddress_validating_shipment::setShipmentId(const QString &shipment_id) {
    m_shipment_id = shipment_id;
    m_shipment_id_isSet = true;
}

bool OAIAddress_validating_shipment::is_shipment_id_Set() const{
    return m_shipment_id_isSet;
}

bool OAIAddress_validating_shipment::is_shipment_id_Valid() const{
    return m_shipment_id_isValid;
}

QString OAIAddress_validating_shipment::getShipmentNumber() const {
    return m_shipment_number;
}
void OAIAddress_validating_shipment::setShipmentNumber(const QString &shipment_number) {
    m_shipment_number = shipment_number;
    m_shipment_number_isSet = true;
}

bool OAIAddress_validating_shipment::is_shipment_number_Set() const{
    return m_shipment_number_isSet;
}

bool OAIAddress_validating_shipment::is_shipment_number_Valid() const{
    return m_shipment_number_isValid;
}

OAIShipment_status OAIAddress_validating_shipment::getShipmentStatus() const {
    return m_shipment_status;
}
void OAIAddress_validating_shipment::setShipmentStatus(const OAIShipment_status &shipment_status) {
    m_shipment_status = shipment_status;
    m_shipment_status_isSet = true;
}

bool OAIAddress_validating_shipment::is_shipment_status_Set() const{
    return m_shipment_status_isSet;
}

bool OAIAddress_validating_shipment::is_shipment_status_Valid() const{
    return m_shipment_status_isValid;
}

QList<OAITag> OAIAddress_validating_shipment::getTags() const {
    return m_tags;
}
void OAIAddress_validating_shipment::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIAddress_validating_shipment::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIAddress_validating_shipment::is_tags_Valid() const{
    return m_tags_isValid;
}

QList<OAITax_identifier> OAIAddress_validating_shipment::getTaxIdentifiers() const {
    return m_tax_identifiers;
}
void OAIAddress_validating_shipment::setTaxIdentifiers(const QList<OAITax_identifier> &tax_identifiers) {
    m_tax_identifiers = tax_identifiers;
    m_tax_identifiers_isSet = true;
}

bool OAIAddress_validating_shipment::is_tax_identifiers_Set() const{
    return m_tax_identifiers_isSet;
}

bool OAIAddress_validating_shipment::is_tax_identifiers_Valid() const{
    return m_tax_identifiers_isValid;
}

OAIWeight OAIAddress_validating_shipment::getTotalWeight() const {
    return m_total_weight;
}
void OAIAddress_validating_shipment::setTotalWeight(const OAIWeight &total_weight) {
    m_total_weight = total_weight;
    m_total_weight_isSet = true;
}

bool OAIAddress_validating_shipment::is_total_weight_Set() const{
    return m_total_weight_isSet;
}

bool OAIAddress_validating_shipment::is_total_weight_Valid() const{
    return m_total_weight_isValid;
}

QString OAIAddress_validating_shipment::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIAddress_validating_shipment::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAIAddress_validating_shipment::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAIAddress_validating_shipment::is_warehouse_id_Valid() const{
    return m_warehouse_id_isValid;
}

bool OAIAddress_validating_shipment::isSet() const {
...
bool OAIAddress_validating_shipment::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_carrier_id_isValid && m_service_code_isValid && m_ship_from_isValid && m_ship_to_isValid && m_shipment_id_isValid && true;
}
