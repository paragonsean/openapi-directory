...
QString OAIManifest::getCarrierId() const {
    return m_carrier_id;
}
void OAIManifest::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIManifest::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIManifest::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QDateTime OAIManifest::getCreatedAt() const {
    return m_created_at;
}
void OAIManifest::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIManifest::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIManifest::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIManifest::getFormId() const {
    return m_form_id;
}
void OAIManifest::setFormId(const QString &form_id) {
    m_form_id = form_id;
    m_form_id_isSet = true;
}

bool OAIManifest::is_form_id_Set() const{
    return m_form_id_isSet;
}

bool OAIManifest::is_form_id_Valid() const{
    return m_form_id_isValid;
}

QList<QString> OAIManifest::getLabelIds() const {
    return m_label_ids;
}
void OAIManifest::setLabelIds(const QList<QString> &label_ids) {
    m_label_ids = label_ids;
    m_label_ids_isSet = true;
}

bool OAIManifest::is_label_ids_Set() const{
    return m_label_ids_isSet;
}

bool OAIManifest::is_label_ids_Valid() const{
    return m_label_ids_isValid;
}

OAIManifest_download OAIManifest::getManifestDownload() const {
    return m_manifest_download;
}
void OAIManifest::setManifestDownload(const OAIManifest_download &manifest_download) {
    m_manifest_download = manifest_download;
    m_manifest_download_isSet = true;
}

bool OAIManifest::is_manifest_download_Set() const{
    return m_manifest_download_isSet;
}

bool OAIManifest::is_manifest_download_Valid() const{
    return m_manifest_download_isValid;
}

QString OAIManifest::getManifestId() const {
    return m_manifest_id;
}
void OAIManifest::setManifestId(const QString &manifest_id) {
    m_manifest_id = manifest_id;
    m_manifest_id_isSet = true;
}

bool OAIManifest::is_manifest_id_Set() const{
    return m_manifest_id_isSet;
}

bool OAIManifest::is_manifest_id_Valid() const{
    return m_manifest_id_isValid;
}

QDateTime OAIManifest::getShipDate() const {
    return m_ship_date;
}
void OAIManifest::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIManifest::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIManifest::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

qint32 OAIManifest::getShipments() const {
    return m_shipments;
}
void OAIManifest::setShipments(const qint32 &shipments) {
    m_shipments = shipments;
    m_shipments_isSet = true;
}

bool OAIManifest::is_shipments_Set() const{
    return m_shipments_isSet;
}

bool OAIManifest::is_shipments_Valid() const{
    return m_shipments_isValid;
}

QString OAIManifest::getSubmissionId() const {
    return m_submission_id;
}
void OAIManifest::setSubmissionId(const QString &submission_id) {
    m_submission_id = submission_id;
    m_submission_id_isSet = true;
}

bool OAIManifest::is_submission_id_Set() const{
    return m_submission_id_isSet;
}

bool OAIManifest::is_submission_id_Valid() const{
    return m_submission_id_isValid;
}

QString OAIManifest::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIManifest::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAIManifest::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAIManifest::is_warehouse_id_Valid() const{
