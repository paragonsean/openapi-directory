...
#ifndef OAIPickup_window_H
#define OAIPickup_window_H
...
class OAIPickup_window : public OAIObject {
public:
    OAIPickup_window();
    OAIPickup_window(QString json);
    ~OAIPickup_window() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPickup_window)

#endif // OAIPickup_window_H
