...
/*
 * OAIGet_tracking_log_response_body.h
 *
 * A get tracking log response body
 */

#ifndef OAIGet_tracking_log_response_body_H
#define OAIGet_tracking_log_response_body_H
...
class OAIGet_tracking_log_response_body : public OAIObject {
public:
    OAIGet_tracking_log_response_body();
    OAIGet_tracking_log_response_body(QString json);
    ~OAIGet_tracking_log_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_tracking_log_response_body)

#endif // OAIGet_tracking_log_response_body_H
