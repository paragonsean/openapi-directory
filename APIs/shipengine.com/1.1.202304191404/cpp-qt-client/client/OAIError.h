...
public:
    ...
    OAIError_code getErrorCode() const;
    void setErrorCode(const OAIError_code &error_code);
    bool is_error_code_Set() const;
    bool is_error_code_Valid() const;

    OAIError_source getErrorSource() const;
    void setErrorSource(const OAIError_source &error_source);
    bool is_error_source_Set() const;
    bool is_error_source_Valid() const;

    OAIError_type getErrorType() const;
    void setErrorType(const OAIError_type &error_type);
