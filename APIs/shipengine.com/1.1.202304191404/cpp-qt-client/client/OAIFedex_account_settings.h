...
/*
 * OAIFedex_account_settings.h
 *
 * A Fedex account settings request body
 */

#ifndef OAIFedex_account_settings_H
#define OAIFedex_account_settings_H
...
class OAIFedex_account_settings : public OAIObject {
public:
    OAIFedex_account_settings();
    OAIFedex_account_settings(QString json);
    ~OAIFedex_account_settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFedex_account_settings)

#endif // OAIFedex_account_settings_H
