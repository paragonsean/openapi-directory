...
/*
 * OAIConnect_australia_post_request_body.h
 *
 * An Australia Post account information request body
 */

#ifndef OAIConnect_australia_post_request_body_H
#define OAIConnect_australia_post_request_body_H
...
class OAIConnect_australia_post_request_body : public OAIObject {
public:
    OAIConnect_australia_post_request_body();
    OAIConnect_australia_post_request_body(QString json);
    ~OAIConnect_australia_post_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnect_australia_post_request_body)

#endif // OAIConnect_australia_post_request_body_H
