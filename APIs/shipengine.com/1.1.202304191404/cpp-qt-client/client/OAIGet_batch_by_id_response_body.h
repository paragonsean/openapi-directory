...
/*
 * OAIGet_batch_by_id_response_body.h
 *
 * A get batch by id response body
 */

#ifndef OAIGet_batch_by_id_response_body_H
#define OAIGet_batch_by_id_response_body_H
...
class OAIGet_batch_by_id_response_body : public OAIObject {
public:
    OAIGet_batch_by_id_response_body();
    OAIGet_batch_by_id_response_body(QString json);
    ~OAIGet_batch_by_id_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_batch_by_id_response_body)

#endif // OAIGet_batch_by_id_response_body_H
