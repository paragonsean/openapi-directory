...
OAISchedule_pickup_request_body::OAISchedule_pickup_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISchedule_pickup_request_body::OAISchedule_pickup_request_body() {
    this->initializeModel();
}

OAISchedule_pickup_request_body::~OAISchedule_pickup_request_body() {}

void OAISchedule_pickup_request_body::initializeModel() {
...
void OAISchedule_pickup_request_body::fromJson(QString jsonString) {
...
void OAISchedule_pickup_request_body::fromJsonObject(QJsonObject json) {
...
QString OAISchedule_pickup_request_body::asJson() const {
...
QJsonObject OAISchedule_pickup_request_body::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAISchedule_pickup_request_body::getCancelledAt() const {
    return m_cancelled_at;
}
void OAISchedule_pickup_request_body::setCancelledAt(const QDateTime &cancelled_at) {
    m_cancelled_at = cancelled_at;
    m_cancelled_at_isSet = true;
}

bool OAISchedule_pickup_request_body::is_cancelled_at_Set() const{
    return m_cancelled_at_isSet;
}

bool OAISchedule_pickup_request_body::is_cancelled_at_Valid() const{
    return m_cancelled_at_isValid;
}

QString OAISchedule_pickup_request_body::getCarrierId() const {
    return m_carrier_id;
}
void OAISchedule_pickup_request_body::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAISchedule_pickup_request_body::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAISchedule_pickup_request_body::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAISchedule_pickup_request_body::getConfirmationNumber() const {
    return m_confirmation_number;
}
void OAISchedule_pickup_request_body::setConfirmationNumber(const QString &confirmation_number) {
    m_confirmation_number = confirmation_number;
    m_confirmation_number_isSet = true;
}

bool OAISchedule_pickup_request_body::is_confirmation_number_Set() const{
    return m_confirmation_number_isSet;
}

bool OAISchedule_pickup_request_body::is_confirmation_number_Valid() const{
    return m_confirmation_number_isValid;
}

OAIContact_details OAISchedule_pickup_request_body::getContactDetails() const {
    return m_contact_details;
}
void OAISchedule_pickup_request_body::setContactDetails(const OAIContact_details &contact_details) {
    m_contact_details = contact_details;
    m_contact_details_isSet = true;
}

bool OAISchedule_pickup_request_body::is_contact_details_Set() const{
    return m_contact_details_isSet;
}

bool OAISchedule_pickup_request_body::is_contact_details_Valid() const{
    return m_contact_details_isValid;
}

QDateTime OAISchedule_pickup_request_body::getCreatedAt() const {
    return m_created_at;
}
void OAISchedule_pickup_request_body::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAISchedule_pickup_request_body::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAISchedule_pickup_request_body::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QList<QString> OAISchedule_pickup_request_body::getLabelIds() const {
    return m_label_ids;
}
void OAISchedule_pickup_request_body::setLabelIds(const QList<QString> &label_ids) {
    m_label_ids = label_ids;
    m_label_ids_isSet = true;
}

bool OAISchedule_pickup_request_body::is_label_ids_Set() const{
    return m_label_ids_isSet;
}

bool OAISchedule_pickup_request_body::is_label_ids_Valid() const{
    return m_label_ids_isValid;
}

OAIAddress OAISchedule_pickup_request_body::getPickupAddress() const {
    return m_pickup_address;
}
void OAISchedule_pickup_request_body::setPickupAddress(const OAIAddress &pickup_address) {
    m_pickup_address = pickup_address;
    m_pickup_address_isSet = true;
}

bool OAISchedule_pickup_request_body::is_pickup_address_Set() const{
    return m_pickup_address_isSet;
}

bool OAISchedule_pickup_request_body::is_pickup_address_Valid() const{
    return m_pickup_address_isValid;
}

QString OAISchedule_pickup_request_body::getPickupId() const {
    return m_pickup_id;
}
void OAISchedule_pickup_request_body::setPickupId(const QString &pickup_id) {
    m_pickup_id = pickup_id;
    m_pickup_id_isSet = true;
}

bool OAISchedule_pickup_request_body::is_pickup_id_Set() const{
    return m_pickup_id_isSet;
}

bool OAISchedule_pickup_request_body::is_pickup_id_Valid() const{
    return m_pickup_id_isValid;
}

QString OAISchedule_pickup_request_body::getPickupNotes() const {
    return m_pickup_notes;
}
void OAISchedule_pickup_request_body::setPickupNotes(const QString &pickup_notes) {
    m_pickup_notes = pickup_notes;
    m_pickup_notes_isSet = true;
}

bool OAISchedule_pickup_request_body::is_pickup_notes_Set() const{
    return m_pickup_notes_isSet;
}

bool OAISchedule_pickup_request_body::is_pickup_notes_Valid() const{
    return m_pickup_notes_isValid;
}

OAIPickup_window OAISchedule_pickup_request_body::getPickupWindow() const {
    return m_pickup_window;
}
void OAISchedule_pickup_request_body::setPickupWindow(const OAIPickup_window &pickup_window) {
    m_pickup_window = pickup_window;
    m_pickup_window_isSet = true;
}

bool OAISchedule_pickup_request_body::is_pickup_window_Set() const{
    return m_pickup_window_isSet;
}

bool OAISchedule_pickup_request_body::is_pickup_window_Valid() const{
    return m_pickup_window_isValid;
}

QList<OAIPickup_windows> OAISchedule_pickup_request_body::getPickupWindows() const {
    return m_pickup_windows;
}
void OAISchedule_pickup_request_body::setPickupWindows(const QList<OAIPickup_windows> &pickup_windows) {
    m_pickup_windows = pickup_windows;
    m_pickup_windows_isSet = true;
}

bool OAISchedule_pickup_request_body::is_pickup_windows_Set() const{
    return m_pickup_windows_isSet;
}

bool OAISchedule_pickup_request_body::is_pickup_windows_Valid() const{
    return m_pickup_windows_isValid;
}

QString OAISchedule_pickup_request_body::getWarehouseId() const {
    return m_warehouse_id;
}
void OAISchedule_pickup_request_body::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAISchedule_pickup_request_body::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAISchedule_pickup_request_body::is_warehouse_id_Valid() const{
    return m_warehouse_id_isValid;
}

bool OAISchedule_pickup_request_body::isSet() const {
...
bool OAISchedule_pickup_request_body::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_contact_details_isValid && m_label_ids_isValid && m_pickup_window_isValid && true;
}
