...
#include "OAIFedex_account_settings_request_body.h"
...
OAIFedex_account_settings_request_body::OAIFedex_account_settings_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFedex_account_settings_request_body::OAIFedex_account_settings_request_body() {
    this->initializeModel();
}

OAIFedex_account_settings_request_body::~OAIFedex_account_settings_request_body() {}

void OAIFedex_account_settings_request_body::initializeModel() {
...
void OAIFedex_account_settings_request_body::fromJson(QString jsonString) {
...
void OAIFedex_account_settings_request_body::fromJsonObject(QJsonObject json) {
...
QString OAIFedex_account_settings_request_body::asJson() const {
...
QJsonObject OAIFedex_account_settings_request_body::asJsonObject() const {
    QJsonObject obj;
...
bool OAIFedex_account_settings_request_body::isIsPrimaryAccount() const {
    return m_is_primary_account;
}
void OAIFedex_account_settings_request_body::setIsPrimaryAccount(const bool &is_primary_account) {
    m_is_primary_account = is_primary_account;
    m_is_primary_account_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_is_primary_account_Set() const{
    return m_is_primary_account_isSet;
}

bool OAIFedex_account_settings_request_body::is_is_primary_account_Valid() const{
    return m_is_primary_account_isValid;
}

QString OAIFedex_account_settings_request_body::getLetterheadImage() const {
    return m_letterhead_image;
}
void OAIFedex_account_settings_request_body::setLetterheadImage(const QString &letterhead_image) {
    m_letterhead_image = letterhead_image;
    m_letterhead_image_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_letterhead_image_Set() const{
    return m_letterhead_image_isSet;
}

bool OAIFedex_account_settings_request_body::is_letterhead_image_Valid() const{
    return m_letterhead_image_isValid;
}

QString OAIFedex_account_settings_request_body::getNickname() const {
    return m_nickname;
}
void OAIFedex_account_settings_request_body::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAIFedex_account_settings_request_body::is_nickname_Valid() const{
    return m_nickname_isValid;
}

OAIFedex_pickup_type OAIFedex_account_settings_request_body::getPickupType() const {
    return m_pickup_type;
}
void OAIFedex_account_settings_request_body::setPickupType(const OAIFedex_pickup_type &pickup_type) {
    m_pickup_type = pickup_type;
    m_pickup_type_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_pickup_type_Set() const{
    return m_pickup_type_isSet;
}

bool OAIFedex_account_settings_request_body::is_pickup_type_Valid() const{
    return m_pickup_type_isValid;
}

QString OAIFedex_account_settings_request_body::getSignatureImage() const {
    return m_signature_image;
}
void OAIFedex_account_settings_request_body::setSignatureImage(const QString &signature_image) {
    m_signature_image = signature_image;
    m_signature_image_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_signature_image_Set() const{
    return m_signature_image_isSet;
}

bool OAIFedex_account_settings_request_body::is_signature_image_Valid() const{
    return m_signature_image_isValid;
}

OAIAncillary_service_endorsement OAIFedex_account_settings_request_body::getSmartPostEndorsement() const {
    return m_smart_post_endorsement;
}
void OAIFedex_account_settings_request_body::setSmartPostEndorsement(const OAIAncillary_service_endorsement &smart_post_endorsement) {
    m_smart_post_endorsement = smart_post_endorsement;
    m_smart_post_endorsement_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_smart_post_endorsement_Set() const{
    return m_smart_post_endorsement_isSet;
}

bool OAIFedex_account_settings_request_body::is_smart_post_endorsement_Valid() const{
    return m_smart_post_endorsement_isValid;
}

OAISmart_post_hub OAIFedex_account_settings_request_body::getSmartPostHub() const {
    return m_smart_post_hub;
}
void OAIFedex_account_settings_request_body::setSmartPostHub(const OAISmart_post_hub &smart_post_hub) {
    m_smart_post_hub = smart_post_hub;
    m_smart_post_hub_isSet = true;
}

bool OAIFedex_account_settings_request_body::is_smart_post_hub_Set() const{
    return m_smart_post_hub_isSet;
}

bool OAIFedex_account_settings_request_body::is_smart_post_hub_Valid() const{
    return m_smart_post_hub_isValid;
}

bool OAIFedex_account_settings_request_body::isSet() const {
...
bool OAIFedex_account_settings_request_body::isValid() const {
