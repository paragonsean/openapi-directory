...
/*
 * OAIGet_pickup_by_id_response_body.h
 *
 * 
 */

#ifndef OAIGet_pickup_by_id_response_body_H
#define OAIGet_pickup_by_id_response_body_H
...
class OAIGet_pickup_by_id_response_body : public OAIObject {
public:
    OAIGet_pickup_by_id_response_body();
    OAIGet_pickup_by_id_response_body(QString json);
    ~OAIGet_pickup_by_id_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_pickup_by_id_response_body)

#endif // OAIGet_pickup_by_id_response_body_H
