...
#include "OAIFedex_account_settings.h"
...
OAIFedex_account_settings::OAIFedex_account_settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFedex_account_settings::OAIFedex_account_settings() {
    this->initializeModel();
}

OAIFedex_account_settings::~OAIFedex_account_settings() {}

void OAIFedex_account_settings::initializeModel() {
...
void OAIFedex_account_settings::fromJson(QString jsonString) {
...
void OAIFedex_account_settings::fromJsonObject(QJsonObject json) {
...
QString OAIFedex_account_settings::asJson() const {
...
QJsonObject OAIFedex_account_settings::asJsonObject() const {
    QJsonObject obj;
...
bool OAIFedex_account_settings::isIsPrimaryAccount() const {
    return m_is_primary_account;
}
void OAIFedex_account_settings::setIsPrimaryAccount(const bool &is_primary_account) {
    m_is_primary_account = is_primary_account;
    m_is_primary_account_isSet = true;
}

bool OAIFedex_account_settings::is_is_primary_account_Set() const{
    return m_is_primary_account_isSet;
}

bool OAIFedex_account_settings::is_is_primary_account_Valid() const{
    return m_is_primary_account_isValid;
}

QString OAIFedex_account_settings::getLetterheadImage() const {
    return m_letterhead_image;
}
void OAIFedex_account_settings::setLetterheadImage(const QString &letterhead_image) {
    m_letterhead_image = letterhead_image;
    m_letterhead_image_isSet = true;
}

bool OAIFedex_account_settings::is_letterhead_image_Set() const{
    return m_letterhead_image_isSet;
}

bool OAIFedex_account_settings::is_letterhead_image_Valid() const{
    return m_letterhead_image_isValid;
}

QString OAIFedex_account_settings::getNickname() const {
    return m_nickname;
}
void OAIFedex_account_settings::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAIFedex_account_settings::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAIFedex_account_settings::is_nickname_Valid() const{
    return m_nickname_isValid;
}

OAIFedex_pickup_type OAIFedex_account_settings::getPickupType() const {
    return m_pickup_type;
}
void OAIFedex_account_settings::setPickupType(const OAIFedex_pickup_type &pickup_type) {
    m_pickup_type = pickup_type;
    m_pickup_type_isSet = true;
}

bool OAIFedex_account_settings::is_pickup_type_Set() const{
    return m_pickup_type_isSet;
}

bool OAIFedex_account_settings::is_pickup_type_Valid() const{
    return m_pickup_type_isValid;
}

QString OAIFedex_account_settings::getSignatureImage() const {
    return m_signature_image;
}
void OAIFedex_account_settings::setSignatureImage(const QString &signature_image) {
    m_signature_image = signature_image;
    m_signature_image_isSet = true;
}

bool OAIFedex_account_settings::is_signature_image_Set() const{
    return m_signature_image_isSet;
}

bool OAIFedex_account_settings::is_signature_image_Valid() const{
    return m_signature_image_isValid;
}

OAIAncillary_service_endorsement OAIFedex_account_settings::getSmartPostEndorsement() const {
    return m_smart_post_endorsement;
}
void OAIFedex_account_settings::setSmartPostEndorsement(const OAIAncillary_service_endorsement &smart_post_endorsement) {
    m_smart_post_endorsement = smart_post_endorsement;
    m_smart_post_endorsement_isSet = true;
}

bool OAIFedex_account_settings::is_smart_post_endorsement_Set() const{
    return m_smart_post_endorsement_isSet;
}

bool OAIFedex_account_settings::is_smart_post_endorsement_Valid() const{
    return m_smart_post_endorsement_isValid;
}

OAISmart_post_hub OAIFedex_account_settings::getSmartPostHub() const {
    return m_smart_post_hub;
}
void OAIFedex_account_settings::setSmartPostHub(const OAISmart_post_hub &smart_post_hub) {
    m_smart_post_hub = smart_post_hub;
    m_smart_post_hub_isSet = true;
}

bool OAIFedex_account_settings::is_smart_post_hub_Set() const{
    return m_smart_post_hub_isSet;
}

bool OAIFedex_account_settings::is_smart_post_hub_Valid() const{
    return m_smart_post_hub_isValid;
}

bool OAIFedex_account_settings::isSet() const {
...
bool OAIFedex_account_settings::isValid() const {
