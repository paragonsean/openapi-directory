...
OAICreate_return_label_request_body::OAICreate_return_label_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreate_return_label_request_body::OAICreate_return_label_request_body() {
    this->initializeModel();
}

OAICreate_return_label_request_body::~OAICreate_return_label_request_body() {}

void OAICreate_return_label_request_body::initializeModel() {
...
void OAICreate_return_label_request_body::fromJson(QString jsonString) {
...
void OAICreate_return_label_request_body::fromJsonObject(QJsonObject json) {
...
QString OAICreate_return_label_request_body::asJson() const {
...
QJsonObject OAICreate_return_label_request_body::asJsonObject() const {
    QJsonObject obj;
...
OAILabel_charge_event OAICreate_return_label_request_body::getChargeEvent() const {
    return m_charge_event;
}
void OAICreate_return_label_request_body::setChargeEvent(const OAILabel_charge_event &charge_event) {
    m_charge_event = charge_event;
    m_charge_event_isSet = true;
}

bool OAICreate_return_label_request_body::is_charge_event_Set() const{
    return m_charge_event_isSet;
}

bool OAICreate_return_label_request_body::is_charge_event_Valid() const{
    return m_charge_event_isValid;
}

OAIDisplay_scheme OAICreate_return_label_request_body::getDisplayScheme() const {
    return m_display_scheme;
}
void OAICreate_return_label_request_body::setDisplayScheme(const OAIDisplay_scheme &display_scheme) {
    m_display_scheme = display_scheme;
    m_display_scheme_isSet = true;
}

bool OAICreate_return_label_request_body::is_display_scheme_Set() const{
    return m_display_scheme_isSet;
}

bool OAICreate_return_label_request_body::is_display_scheme_Valid() const{
    return m_display_scheme_isValid;
}

OAILabel_download_type OAICreate_return_label_request_body::getLabelDownloadType() const {
    return m_label_download_type;
}
void OAICreate_return_label_request_body::setLabelDownloadType(const OAILabel_download_type &label_download_type) {
    m_label_download_type = label_download_type;
    m_label_download_type_isSet = true;
}

bool OAICreate_return_label_request_body::is_label_download_type_Set() const{
    return m_label_download_type_isSet;
}

bool OAICreate_return_label_request_body::is_label_download_type_Valid() const{
    return m_label_download_type_isValid;
}

OAILabel_format OAICreate_return_label_request_body::getLabelFormat() const {
    return m_label_format;
}
void OAICreate_return_label_request_body::setLabelFormat(const OAILabel_format &label_format) {
    m_label_format = label_format;
    m_label_format_isSet = true;
}

bool OAICreate_return_label_request_body::is_label_format_Set() const{
    return m_label_format_isSet;
}

bool OAICreate_return_label_request_body::is_label_format_Valid() const{
    return m_label_format_isValid;
}

QString OAICreate_return_label_request_body::getLabelImageId() const {
    return m_label_image_id;
}
void OAICreate_return_label_request_body::setLabelImageId(const QString &label_image_id) {
    m_label_image_id = label_image_id;
    m_label_image_id_isSet = true;
}

bool OAICreate_return_label_request_body::is_label_image_id_Set() const{
    return m_label_image_id_isSet;
}

bool OAICreate_return_label_request_body::is_label_image_id_Valid() const{
    return m_label_image_id_isValid;
}

OAILabel_layout OAICreate_return_label_request_body::getLabelLayout() const {
    return m_label_layout;
}
void OAICreate_return_label_request_body::setLabelLayout(const OAILabel_layout &label_layout) {
    m_label_layout = label_layout;
    m_label_layout_isSet = true;
}

bool OAICreate_return_label_request_body::is_label_layout_Set() const{
    return m_label_layout_isSet;
}

bool OAICreate_return_label_request_body::is_label_layout_Valid() const{
    return m_label_layout_isValid;
}

bool OAICreate_return_label_request_body::isSet() const {
...
bool OAICreate_return_label_request_body::isValid() const {
