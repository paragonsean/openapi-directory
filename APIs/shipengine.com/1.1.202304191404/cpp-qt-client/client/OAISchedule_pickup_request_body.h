...
/*
 * OAISchedule_pickup_request_body.h
 *
 * A schedule pickup request body
 */

#ifndef OAISchedule_pickup_request_body_H
#define OAISchedule_pickup_request_body_H
...
class OAISchedule_pickup_request_body : public OAIObject {
public:
    OAISchedule_pickup_request_body();
    OAISchedule_pickup_request_body(QString json);
    ~OAISchedule_pickup_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISchedule_pickup_request_body)

#endif // OAISchedule_pickup_request_body_H
