...
/*
 * OAIConnect_ups_request_body.h
 *
 * A UPS account information request body
 */

#ifndef OAIConnect_ups_request_body_H
#define OAIConnect_ups_request_body_H
...
class OAIConnect_ups_request_body : public OAIObject {
public:
    OAIConnect_ups_request_body();
    OAIConnect_ups_request_body(QString json);
    ~OAIConnect_ups_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnect_ups_request_body)

#endif // OAIConnect_ups_request_body_H
