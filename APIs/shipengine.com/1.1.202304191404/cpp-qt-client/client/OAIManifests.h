...
#ifndef OAIManifests_H
#define OAIManifests_H
...
class OAIManifests : public OAIObject {
public:
    OAIManifests();
    OAIManifests(QString json);
    ~OAIManifests() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManifests)

#endif // OAIManifests_H
