...
/*
 * OAITracking_information.h
 *
 * A tracking information resource
 */

#ifndef OAITracking_information_H
#define OAITracking_information_H
...
class OAITracking_information : public OAIObject {
public:
    OAITracking_information();
    OAITracking_information(QString json);
    ~OAITracking_information() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITracking_information)

#endif // OAITracking_information_H
