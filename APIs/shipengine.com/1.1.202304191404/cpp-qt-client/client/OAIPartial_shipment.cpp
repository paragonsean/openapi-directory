...
OAIPartial_shipment::OAIPartial_shipment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPartial_shipment::OAIPartial_shipment() {
    this->initializeModel();
}

OAIPartial_shipment::~OAIPartial_shipment() {}

void OAIPartial_shipment::initializeModel() {
...
void OAIPartial_shipment::fromJson(QString jsonString) {
...
void OAIPartial_shipment::fromJsonObject(QJsonObject json) {
...
QString OAIPartial_shipment::asJson() const {
...
QJsonObject OAIPartial_shipment::asJsonObject() const {
    QJsonObject obj;
...
OAIAdvanced_shipment_options OAIPartial_shipment::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAIPartial_shipment::setAdvancedOptions(const OAIAdvanced_shipment_options &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAIPartial_shipment::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAIPartial_shipment::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

QString OAIPartial_shipment::getCarrierId() const {
    return m_carrier_id;
}
void OAIPartial_shipment::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIPartial_shipment::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIPartial_shipment::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

OAIDelivery_confirmation OAIPartial_shipment::getConfirmation() const {
    return m_confirmation;
}
void OAIPartial_shipment::setConfirmation(const OAIDelivery_confirmation &confirmation) {
    m_confirmation = confirmation;
    m_confirmation_isSet = true;
}

bool OAIPartial_shipment::is_confirmation_Set() const{
    return m_confirmation_isSet;
}

bool OAIPartial_shipment::is_confirmation_Valid() const{
    return m_confirmation_isValid;
}

QDateTime OAIPartial_shipment::getCreatedAt() const {
    return m_created_at;
}
void OAIPartial_shipment::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPartial_shipment::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPartial_shipment::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIInternational_shipment_options OAIPartial_shipment::getCustoms() const {
    return m_customs;
}
void OAIPartial_shipment::setCustoms(const OAIInternational_shipment_options &customs) {
    m_customs = customs;
    m_customs_isSet = true;
}

bool OAIPartial_shipment::is_customs_Set() const{
    return m_customs_isSet;
}

bool OAIPartial_shipment::is_customs_Valid() const{
    return m_customs_isValid;
}

QString OAIPartial_shipment::getExternalOrderId() const {
    return m_external_order_id;
}
void OAIPartial_shipment::setExternalOrderId(const QString &external_order_id) {
    m_external_order_id = external_order_id;
    m_external_order_id_isSet = true;
}

bool OAIPartial_shipment::is_external_order_id_Set() const{
    return m_external_order_id_isSet;
}

bool OAIPartial_shipment::is_external_order_id_Valid() const{
    return m_external_order_id_isValid;
}

QString OAIPartial_shipment::getExternalShipmentId() const {
    return m_external_shipment_id;
}
void OAIPartial_shipment::setExternalShipmentId(const QString &external_shipment_id) {
    m_external_shipment_id = external_shipment_id;
    m_external_shipment_id_isSet = true;
}

bool OAIPartial_shipment::is_external_shipment_id_Set() const{
    return m_external_shipment_id_isSet;
}

bool OAIPartial_shipment::is_external_shipment_id_Valid() const{
    return m_external_shipment_id_isValid;
}

OAIInsurance_provider OAIPartial_shipment::getInsuranceProvider() const {
    return m_insurance_provider;
}
void OAIPartial_shipment::setInsuranceProvider(const OAIInsurance_provider &insurance_provider) {
    m_insurance_provider = insurance_provider;
    m_insurance_provider_isSet = true;
}

bool OAIPartial_shipment::is_insurance_provider_Set() const{
    return m_insurance_provider_isSet;
}

bool OAIPartial_shipment::is_insurance_provider_Valid() const{
    return m_insurance_provider_isValid;
}

bool OAIPartial_shipment::isIsReturn() const {
    return m_is_return;
}
void OAIPartial_shipment::setIsReturn(const bool &is_return) {
    m_is_return = is_return;
    m_is_return_isSet = true;
}

bool OAIPartial_shipment::is_is_return_Set() const{
    return m_is_return_isSet;
}

bool OAIPartial_shipment::is_is_return_Valid() const{
    return m_is_return_isValid;
}

QList<OAIShipment_item> OAIPartial_shipment::getItems() const {
    return m_items;
}
void OAIPartial_shipment::setItems(const QList<OAIShipment_item> &items) {
    m_items = items;
    m_items_isSet = true;
}

bool OAIPartial_shipment::is_items_Set() const{
    return m_items_isSet;
}

bool OAIPartial_shipment::is_items_Valid() const{
    return m_items_isValid;
}

QDateTime OAIPartial_shipment::getModifiedAt() const {
    return m_modified_at;
}
void OAIPartial_shipment::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIPartial_shipment::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIPartial_shipment::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

OAIOrder_source_name OAIPartial_shipment::getOrderSourceCode() const {
    return m_order_source_code;
}
void OAIPartial_shipment::setOrderSourceCode(const OAIOrder_source_name &order_source_code) {
    m_order_source_code = order_source_code;
    m_order_source_code_isSet = true;
}

bool OAIPartial_shipment::is_order_source_code_Set() const{
    return m_order_source_code_isSet;
}

bool OAIPartial_shipment::is_order_source_code_Valid() const{
    return m_order_source_code_isValid;
}

OAIOrigin_type OAIPartial_shipment::getOriginType() const {
    return m_origin_type;
}
void OAIPartial_shipment::setOriginType(const OAIOrigin_type &origin_type) {
    m_origin_type = origin_type;
    m_origin_type_isSet = true;
}

bool OAIPartial_shipment::is_origin_type_Set() const{
    return m_origin_type_isSet;
}

bool OAIPartial_shipment::is_origin_type_Valid() const{
    return m_origin_type_isValid;
}

QList<OAIPackage> OAIPartial_shipment::getPackages() const {
    return m_packages;
}
void OAIPartial_shipment::setPackages(const QList<OAIPackage> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAIPartial_shipment::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAIPartial_shipment::is_packages_Valid() const{
    return m_packages_isValid;
}

OAIShipping_address OAIPartial_shipment::getReturnTo() const {
    return m_return_to;
}
void OAIPartial_shipment::setReturnTo(const OAIShipping_address &return_to) {
    m_return_to = return_to;
    m_return_to_isSet = true;
}

bool OAIPartial_shipment::is_return_to_Set() const{
    return m_return_to_isSet;
}

bool OAIPartial_shipment::is_return_to_Valid() const{
    return m_return_to_isValid;
}

QString OAIPartial_shipment::getServiceCode() const {
    return m_service_code;
}
void OAIPartial_shipment::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIPartial_shipment::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIPartial_shipment::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QDateTime OAIPartial_shipment::getShipDate() const {
    return m_ship_date;
}
void OAIPartial_shipment::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIPartial_shipment::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIPartial_shipment::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIShipping_address OAIPartial_shipment::getShipFrom() const {
    return m_ship_from;
}
void OAIPartial_shipment::setShipFrom(const OAIShipping_address &ship_from) {
    m_ship_from = ship_from;
    m_ship_from_isSet = true;
}

bool OAIPartial_shipment::is_ship_from_Set() const{
    return m_ship_from_isSet;
}

bool OAIPartial_shipment::is_ship_from_Valid() const{
    return m_ship_from_isValid;
}

OAIShipping_address OAIPartial_shipment::getShipTo() const {
    return m_ship_to;
}
void OAIPartial_shipment::setShipTo(const OAIShipping_address &ship_to) {
    m_ship_to = ship_to;
    m_ship_to_isSet = true;
}

bool OAIPartial_shipment::is_ship_to_Set() const{
    return m_ship_to_isSet;
}

bool OAIPartial_shipment::is_ship_to_Valid() const{
    return m_ship_to_isValid;
}

QString OAIPartial_shipment::getShipmentId() const {
    return m_shipment_id;
}
void OAIPartial_shipment::setShipmentId(const QString &shipment_id) {
    m_shipment_id = shipment_id;
    m_shipment_id_isSet = true;
}

bool OAIPartial_shipment::is_shipment_id_Set() const{
    return m_shipment_id_isSet;
}

bool OAIPartial_shipment::is_shipment_id_Valid() const{
    return m_shipment_id_isValid;
}

QString OAIPartial_shipment::getShipmentNumber() const {
    return m_shipment_number;
}
void OAIPartial_shipment::setShipmentNumber(const QString &shipment_number) {
    m_shipment_number = shipment_number;
    m_shipment_number_isSet = true;
}

bool OAIPartial_shipment::is_shipment_number_Set() const{
    return m_shipment_number_isSet;
}

bool OAIPartial_shipment::is_shipment_number_Valid() const{
    return m_shipment_number_isValid;
}

OAIShipment_status OAIPartial_shipment::getShipmentStatus() const {
    return m_shipment_status;
}
void OAIPartial_shipment::setShipmentStatus(const OAIShipment_status &shipment_status) {
    m_shipment_status = shipment_status;
    m_shipment_status_isSet = true;
}

bool OAIPartial_shipment::is_shipment_status_Set() const{
    return m_shipment_status_isSet;
}

bool OAIPartial_shipment::is_shipment_status_Valid() const{
    return m_shipment_status_isValid;
}

QList<OAITag> OAIPartial_shipment::getTags() const {
    return m_tags;
}
void OAIPartial_shipment::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIPartial_shipment::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIPartial_shipment::is_tags_Valid() const{
    return m_tags_isValid;
}

QList<OAITax_identifier> OAIPartial_shipment::getTaxIdentifiers() const {
    return m_tax_identifiers;
}
void OAIPartial_shipment::setTaxIdentifiers(const QList<OAITax_identifier> &tax_identifiers) {
    m_tax_identifiers = tax_identifiers;
    m_tax_identifiers_isSet = true;
}

bool OAIPartial_shipment::is_tax_identifiers_Set() const{
    return m_tax_identifiers_isSet;
}

bool OAIPartial_shipment::is_tax_identifiers_Valid() const{
    return m_tax_identifiers_isValid;
}

OAIWeight OAIPartial_shipment::getTotalWeight() const {
    return m_total_weight;
}
void OAIPartial_shipment::setTotalWeight(const OAIWeight &total_weight) {
    m_total_weight = total_weight;
    m_total_weight_isSet = true;
}

bool OAIPartial_shipment::is_total_weight_Set() const{
    return m_total_weight_isSet;
}

bool OAIPartial_shipment::is_total_weight_Valid() const{
    return m_total_weight_isValid;
}

QString OAIPartial_shipment::getWarehouseId() const {
    return m_warehouse_id;
}
void OAIPartial_shipment::setWarehouseId(const QString &warehouse_id) {
    m_warehouse_id = warehouse_id;
    m_warehouse_id_isSet = true;
}

bool OAIPartial_shipment::is_warehouse_id_Set() const{
    return m_warehouse_id_isSet;
}

bool OAIPartial_shipment::is_warehouse_id_Valid() const{
    return m_warehouse_id_isValid;
}

bool OAIPartial_shipment::isSet() const {
...
bool OAIPartial_shipment::isValid() const {
