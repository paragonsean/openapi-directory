...
OAIRate_estimate::OAIRate_estimate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRate_estimate::OAIRate_estimate() {
    this->initializeModel();
}

OAIRate_estimate::~OAIRate_estimate() {}

void OAIRate_estimate::initializeModel() {
...
void OAIRate_estimate::fromJson(QString jsonString) {
...
void OAIRate_estimate::fromJsonObject(QJsonObject json) {
...
QString OAIRate_estimate::asJson() const {
...
QJsonObject OAIRate_estimate::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRate_estimate::getCarrierCode() const {
    return m_carrier_code;
}
void OAIRate_estimate::setCarrierCode(const QString &carrier_code) {
    m_carrier_code = carrier_code;
    m_carrier_code_isSet = true;
}

bool OAIRate_estimate::is_carrier_code_Set() const{
    return m_carrier_code_isSet;
}

bool OAIRate_estimate::is_carrier_code_Valid() const{
    return m_carrier_code_isValid;
}

QString OAIRate_estimate::getCarrierDeliveryDays() const {
    return m_carrier_delivery_days;
}
void OAIRate_estimate::setCarrierDeliveryDays(const QString &carrier_delivery_days) {
    m_carrier_delivery_days = carrier_delivery_days;
    m_carrier_delivery_days_isSet = true;
}

bool OAIRate_estimate::is_carrier_delivery_days_Set() const{
    return m_carrier_delivery_days_isSet;
}

bool OAIRate_estimate::is_carrier_delivery_days_Valid() const{
    return m_carrier_delivery_days_isValid;
}

QString OAIRate_estimate::getCarrierFriendlyName() const {
    return m_carrier_friendly_name;
}
void OAIRate_estimate::setCarrierFriendlyName(const QString &carrier_friendly_name) {
    m_carrier_friendly_name = carrier_friendly_name;
    m_carrier_friendly_name_isSet = true;
}

bool OAIRate_estimate::is_carrier_friendly_name_Set() const{
    return m_carrier_friendly_name_isSet;
}

bool OAIRate_estimate::is_carrier_friendly_name_Valid() const{
    return m_carrier_friendly_name_isValid;
}

QString OAIRate_estimate::getCarrierId() const {
    return m_carrier_id;
}
void OAIRate_estimate::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIRate_estimate::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIRate_estimate::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAIRate_estimate::getCarrierNickname() const {
    return m_carrier_nickname;
}
void OAIRate_estimate::setCarrierNickname(const QString &carrier_nickname) {
    m_carrier_nickname = carrier_nickname;
    m_carrier_nickname_isSet = true;
}

bool OAIRate_estimate::is_carrier_nickname_Set() const{
    return m_carrier_nickname_isSet;
}

bool OAIRate_estimate::is_carrier_nickname_Valid() const{
    return m_carrier_nickname_isValid;
}

OAIMonetary_value OAIRate_estimate::getConfirmationAmount() const {
    return m_confirmation_amount;
}
void OAIRate_estimate::setConfirmationAmount(const OAIMonetary_value &confirmation_amount) {
    m_confirmation_amount = confirmation_amount;
    m_confirmation_amount_isSet = true;
}

bool OAIRate_estimate::is_confirmation_amount_Set() const{
    return m_confirmation_amount_isSet;
}

bool OAIRate_estimate::is_confirmation_amount_Valid() const{
    return m_confirmation_amount_isValid;
}

qint32 OAIRate_estimate::getDeliveryDays() const {
    return m_delivery_days;
}
void OAIRate_estimate::setDeliveryDays(const qint32 &delivery_days) {
    m_delivery_days = delivery_days;
    m_delivery_days_isSet = true;
}

bool OAIRate_estimate::is_delivery_days_Set() const{
    return m_delivery_days_isSet;
}

bool OAIRate_estimate::is_delivery_days_Valid() const{
    return m_delivery_days_isValid;
}

QList<QString> OAIRate_estimate::getErrorMessages() const {
    return m_error_messages;
}
void OAIRate_estimate::setErrorMessages(const QList<QString> &error_messages) {
    m_error_messages = error_messages;
    m_error_messages_isSet = true;
}

bool OAIRate_estimate::is_error_messages_Set() const{
    return m_error_messages_isSet;
}

bool OAIRate_estimate::is_error_messages_Valid() const{
    return m_error_messages_isValid;
}

QDateTime OAIRate_estimate::getEstimatedDeliveryDate() const {
    return m_estimated_delivery_date;
}
void OAIRate_estimate::setEstimatedDeliveryDate(const QDateTime &estimated_delivery_date) {
    m_estimated_delivery_date = estimated_delivery_date;
    m_estimated_delivery_date_isSet = true;
}

bool OAIRate_estimate::is_estimated_delivery_date_Set() const{
    return m_estimated_delivery_date_isSet;
}

bool OAIRate_estimate::is_estimated_delivery_date_Valid() const{
    return m_estimated_delivery_date_isValid;
}

bool OAIRate_estimate::isGuaranteedService() const {
    return m_guaranteed_service;
}
void OAIRate_estimate::setGuaranteedService(const bool &guaranteed_service) {
    m_guaranteed_service = guaranteed_service;
    m_guaranteed_service_isSet = true;
}

bool OAIRate_estimate::is_guaranteed_service_Set() const{
    return m_guaranteed_service_isSet;
}

bool OAIRate_estimate::is_guaranteed_service_Valid() const{
    return m_guaranteed_service_isValid;
}

OAIMonetary_value OAIRate_estimate::getInsuranceAmount() const {
    return m_insurance_amount;
}
void OAIRate_estimate::setInsuranceAmount(const OAIMonetary_value &insurance_amount) {
    m_insurance_amount = insurance_amount;
    m_insurance_amount_isSet = true;
}

bool OAIRate_estimate::is_insurance_amount_Set() const{
    return m_insurance_amount_isSet;
}

bool OAIRate_estimate::is_insurance_amount_Valid() const{
    return m_insurance_amount_isValid;
}

bool OAIRate_estimate::isNegotiatedRate() const {
    return m_negotiated_rate;
}
void OAIRate_estimate::setNegotiatedRate(const bool &negotiated_rate) {
    m_negotiated_rate = negotiated_rate;
    m_negotiated_rate_isSet = true;
}

bool OAIRate_estimate::is_negotiated_rate_Set() const{
    return m_negotiated_rate_isSet;
}

bool OAIRate_estimate::is_negotiated_rate_Valid() const{
    return m_negotiated_rate_isValid;
}

OAIMonetary_value OAIRate_estimate::getOtherAmount() const {
    return m_other_amount;
}
void OAIRate_estimate::setOtherAmount(const OAIMonetary_value &other_amount) {
    m_other_amount = other_amount;
    m_other_amount_isSet = true;
}

bool OAIRate_estimate::is_other_amount_Set() const{
    return m_other_amount_isSet;
}

bool OAIRate_estimate::is_other_amount_Valid() const{
    return m_other_amount_isValid;
}

QString OAIRate_estimate::getPackageType() const {
    return m_package_type;
}
void OAIRate_estimate::setPackageType(const QString &package_type) {
    m_package_type = package_type;
    m_package_type_isSet = true;
}

bool OAIRate_estimate::is_package_type_Set() const{
    return m_package_type_isSet;
}

bool OAIRate_estimate::is_package_type_Valid() const{
    return m_package_type_isValid;
}

OAIRate_type OAIRate_estimate::getRateType() const {
    return m_rate_type;
}
void OAIRate_estimate::setRateType(const OAIRate_type &rate_type) {
    m_rate_type = rate_type;
    m_rate_type_isSet = true;
}

bool OAIRate_estimate::is_rate_type_Set() const{
    return m_rate_type_isSet;
}

bool OAIRate_estimate::is_rate_type_Valid() const{
    return m_rate_type_isValid;
}

QString OAIRate_estimate::getServiceCode() const {
    return m_service_code;
}
void OAIRate_estimate::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIRate_estimate::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIRate_estimate::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QString OAIRate_estimate::getServiceType() const {
    return m_service_type;
}
void OAIRate_estimate::setServiceType(const QString &service_type) {
    m_service_type = service_type;
    m_service_type_isSet = true;
}

bool OAIRate_estimate::is_service_type_Set() const{
    return m_service_type_isSet;
}

bool OAIRate_estimate::is_service_type_Valid() const{
    return m_service_type_isValid;
}

QDateTime OAIRate_estimate::getShipDate() const {
    return m_ship_date;
}
void OAIRate_estimate::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIRate_estimate::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIRate_estimate::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIMonetary_value OAIRate_estimate::getShippingAmount() const {
    return m_shipping_amount;
}
void OAIRate_estimate::setShippingAmount(const OAIMonetary_value &shipping_amount) {
    m_shipping_amount = shipping_amount;
    m_shipping_amount_isSet = true;
}

bool OAIRate_estimate::is_shipping_amount_Set() const{
    return m_shipping_amount_isSet;
}

bool OAIRate_estimate::is_shipping_amount_Valid() const{
    return m_shipping_amount_isValid;
}

OAIMonetary_value OAIRate_estimate::getTaxAmount() const {
    return m_tax_amount;
}
void OAIRate_estimate::setTaxAmount(const OAIMonetary_value &tax_amount) {
    m_tax_amount = tax_amount;
    m_tax_amount_isSet = true;
}

bool OAIRate_estimate::is_tax_amount_Set() const{
    return m_tax_amount_isSet;
}

bool OAIRate_estimate::is_tax_amount_Valid() const{
    return m_tax_amount_isValid;
}

bool OAIRate_estimate::isTrackable() const {
    return m_trackable;
}
void OAIRate_estimate::setTrackable(const bool &trackable) {
    m_trackable = trackable;
    m_trackable_isSet = true;
}

bool OAIRate_estimate::is_trackable_Set() const{
    return m_trackable_isSet;
}

bool OAIRate_estimate::is_trackable_Valid() const{
    return m_trackable_isValid;
}

OAIValidation_status OAIRate_estimate::getValidationStatus() const {
    return m_validation_status;
}
void OAIRate_estimate::setValidationStatus(const OAIValidation_status &validation_status) {
    m_validation_status = validation_status;
    m_validation_status_isSet = true;
}

bool OAIRate_estimate::is_validation_status_Set() const{
    return m_validation_status_isSet;
}

bool OAIRate_estimate::is_validation_status_Valid() const{
    return m_validation_status_isValid;
}

QList<QString> OAIRate_estimate::getWarningMessages() const {
    return m_warning_messages;
}
void OAIRate_estimate::setWarningMessages(const QList<QString> &warning_messages) {
    m_warning_messages = warning_messages;
    m_warning_messages_isSet = true;
}

bool OAIRate_estimate::is_warning_messages_Set() const{
    return m_warning_messages_isSet;
}

bool OAIRate_estimate::is_warning_messages_Valid() const{
    return m_warning_messages_isValid;
}

qint32 OAIRate_estimate::getZone() const {
    return m_zone;
}
void OAIRate_estimate::setZone(const qint32 &zone) {
    m_zone = zone;
    m_zone_isSet = true;
}

bool OAIRate_estimate::is_zone_Set() const{
    return m_zone_isSet;
}

bool OAIRate_estimate::is_zone_Valid() const{
    return m_zone_isValid;
}

bool OAIRate_estimate::isSet() const {
