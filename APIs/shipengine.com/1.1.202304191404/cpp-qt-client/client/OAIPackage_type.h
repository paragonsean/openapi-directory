...
#ifndef OAIPackage_type_H
#define OAIPackage_type_H
...
class OAIPackage_type : public OAIObject {
public:
    OAIPackage_type();
    OAIPackage_type(QString json);
    ~OAIPackage_type() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPackage_type)

#endif // OAIPackage_type_H
