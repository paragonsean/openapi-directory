...
/*
 * OAIGet_carrier_by_id_response_body.h
 *
 * A get carrier by id response body
 */

#ifndef OAIGet_carrier_by_id_response_body_H
#define OAIGet_carrier_by_id_response_body_H
...
class OAIGet_carrier_by_id_response_body : public OAIObject {
public:
    OAIGet_carrier_by_id_response_body();
    OAIGet_carrier_by_id_response_body(QString json);
    ~OAIGet_carrier_by_id_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_carrier_by_id_response_body)

#endif // OAIGet_carrier_by_id_response_body_H
