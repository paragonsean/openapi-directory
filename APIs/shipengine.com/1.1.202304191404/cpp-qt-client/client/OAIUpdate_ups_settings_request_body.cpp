...
#include "OAIUpdate_ups_settings_request_body.h"
...
OAIUpdate_ups_settings_request_body::OAIUpdate_ups_settings_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdate_ups_settings_request_body::OAIUpdate_ups_settings_request_body() {
    this->initializeModel();
}

OAIUpdate_ups_settings_request_body::~OAIUpdate_ups_settings_request_body() {}

void OAIUpdate_ups_settings_request_body::initializeModel() {
...
void OAIUpdate_ups_settings_request_body::fromJson(QString jsonString) {
...
void OAIUpdate_ups_settings_request_body::fromJsonObject(QJsonObject json) {
...
QString OAIUpdate_ups_settings_request_body::asJson() const {
...
QJsonObject OAIUpdate_ups_settings_request_body::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdate_ups_settings_request_body::getAccountPostalCode() const {
    return m_account_postal_code;
}
void OAIUpdate_ups_settings_request_body::setAccountPostalCode(const QString &account_postal_code) {
    m_account_postal_code = account_postal_code;
    m_account_postal_code_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_account_postal_code_Set() const{
    return m_account_postal_code_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_account_postal_code_Valid() const{
    return m_account_postal_code_isValid;
}

OAIUps_invoice OAIUpdate_ups_settings_request_body::getInvoice() const {
    return m_invoice;
}
void OAIUpdate_ups_settings_request_body::setInvoice(const OAIUps_invoice &invoice) {
    m_invoice = invoice;
    m_invoice_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_invoice_Set() const{
    return m_invoice_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_invoice_Valid() const{
    return m_invoice_isValid;
}

bool OAIUpdate_ups_settings_request_body::isIsPrimaryAccount() const {
    return m_is_primary_account;
}
void OAIUpdate_ups_settings_request_body::setIsPrimaryAccount(const bool &is_primary_account) {
    m_is_primary_account = is_primary_account;
    m_is_primary_account_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_is_primary_account_Set() const{
    return m_is_primary_account_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_is_primary_account_Valid() const{
    return m_is_primary_account_isValid;
}

QString OAIUpdate_ups_settings_request_body::getMailInnovationsCostCenter() const {
    return m_mail_innovations_cost_center;
}
void OAIUpdate_ups_settings_request_body::setMailInnovationsCostCenter(const QString &mail_innovations_cost_center) {
    m_mail_innovations_cost_center = mail_innovations_cost_center;
    m_mail_innovations_cost_center_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_mail_innovations_cost_center_Set() const{
    return m_mail_innovations_cost_center_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_mail_innovations_cost_center_Valid() const{
    return m_mail_innovations_cost_center_isValid;
}

OAIAncillary_service_endorsement OAIUpdate_ups_settings_request_body::getMailInnovationsEndorsement() const {
    return m_mail_innovations_endorsement;
}
void OAIUpdate_ups_settings_request_body::setMailInnovationsEndorsement(const OAIAncillary_service_endorsement &mail_innovations_endorsement) {
    m_mail_innovations_endorsement = mail_innovations_endorsement;
    m_mail_innovations_endorsement_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_mail_innovations_endorsement_Set() const{
    return m_mail_innovations_endorsement_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_mail_innovations_endorsement_Valid() const{
    return m_mail_innovations_endorsement_isValid;
}

QString OAIUpdate_ups_settings_request_body::getNickname() const {
    return m_nickname;
}
void OAIUpdate_ups_settings_request_body::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_nickname_Valid() const{
    return m_nickname_isValid;
}

OAIUps_pickup_type OAIUpdate_ups_settings_request_body::getPickupType() const {
    return m_pickup_type;
}
void OAIUpdate_ups_settings_request_body::setPickupType(const OAIUps_pickup_type &pickup_type) {
    m_pickup_type = pickup_type;
    m_pickup_type_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_pickup_type_Set() const{
    return m_pickup_type_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_pickup_type_Valid() const{
    return m_pickup_type_isValid;
}

bool OAIUpdate_ups_settings_request_body::isUseCarbonNeutralShippingProgram() const {
    return m_use_carbon_neutral_shipping_program;
}
void OAIUpdate_ups_settings_request_body::setUseCarbonNeutralShippingProgram(const bool &use_carbon_neutral_shipping_program) {
...
bool OAIUpdate_ups_settings_request_body::is_use_carbon_neutral_shipping_program_Set() const{
    return m_use_carbon_neutral_shipping_program_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_use_carbon_neutral_shipping_program_Valid() const{
    return m_use_carbon_neutral_shipping_program_isValid;
}

bool OAIUpdate_ups_settings_request_body::isUseConsolidationServices() const {
    return m_use_consolidation_services;
}
void OAIUpdate_ups_settings_request_body::setUseConsolidationServices(const bool &use_consolidation_services) {
    m_use_consolidation_services = use_consolidation_services;
    m_use_consolidation_services_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_use_consolidation_services_Set() const{
    return m_use_consolidation_services_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_use_consolidation_services_Valid() const{
    return m_use_consolidation_services_isValid;
}

bool OAIUpdate_ups_settings_request_body::isUseGroundFreightPricing() const {
    return m_use_ground_freight_pricing;
}
void OAIUpdate_ups_settings_request_body::setUseGroundFreightPricing(const bool &use_ground_freight_pricing) {
    m_use_ground_freight_pricing = use_ground_freight_pricing;
    m_use_ground_freight_pricing_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_use_ground_freight_pricing_Set() const{
    return m_use_ground_freight_pricing_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_use_ground_freight_pricing_Valid() const{
    return m_use_ground_freight_pricing_isValid;
}

bool OAIUpdate_ups_settings_request_body::isUseNegotiatedRates() const {
    return m_use_negotiated_rates;
}
void OAIUpdate_ups_settings_request_body::setUseNegotiatedRates(const bool &use_negotiated_rates) {
    m_use_negotiated_rates = use_negotiated_rates;
    m_use_negotiated_rates_isSet = true;
}

bool OAIUpdate_ups_settings_request_body::is_use_negotiated_rates_Set() const{
    return m_use_negotiated_rates_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_use_negotiated_rates_Valid() const{
    return m_use_negotiated_rates_isValid;
}

bool OAIUpdate_ups_settings_request_body::isUseOrderNumberOnMailInnovationsLabels() const {
    return m_use_order_number_on_mail_innovations_labels;
}
void OAIUpdate_ups_settings_request_body::setUseOrderNumberOnMailInnovationsLabels(const bool &use_order_number_on_mail_innovations_labels) {
...
bool OAIUpdate_ups_settings_request_body::is_use_order_number_on_mail_innovations_labels_Set() const{
    return m_use_order_number_on_mail_innovations_labels_isSet;
}

bool OAIUpdate_ups_settings_request_body::is_use_order_number_on_mail_innovations_labels_Valid() const{
    return m_use_order_number_on_mail_innovations_labels_isValid;
}

bool OAIUpdate_ups_settings_request_body::isSet() const {
...
bool OAIUpdate_ups_settings_request_body::isValid() const {
