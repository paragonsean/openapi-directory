...
OAIAdvanced_shipment_options OAIShipment::getAdvancedOptions() const {
    return m_advanced_options;
}
void OAIShipment::setAdvancedOptions(const OAIAdvanced_shipment_options &advanced_options) {
    m_advanced_options = advanced_options;
    m_advanced_options_isSet = true;
}

bool OAIShipment::is_advanced_options_Set() const{
    return m_advanced_options_isSet;
}

bool OAIShipment::is_advanced_options_Valid() const{
    return m_advanced_options_isValid;
}

QString OAIShipment::getCarrierId() const {
    return m_carrier_id;
}
void OAIShipment::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIShipment::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIShipment::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

OAIDelivery_confirmation OAIShipment::getConfirmation() const {
    return m_confirmation;
}
void OAIShipment::setConfirmation(const OAIDelivery_confirmation &confirmation) {
    m_confirmation = confirmation;
    m_confirmation_isSet = true;
}

bool OAIShipment::is_confirmation_Set() const{
    return m_confirmation_isSet;
}

bool OAIShipment::is_confirmation_Valid() const{
    return m_confirmation_isValid;
}

QDateTime OAIShipment::getCreatedAt() const {
    return m_created_at;
}
void OAIShipment::setCreatedAt(const QDateTime &created_at) {
...
OAIInternational_shipment_options OAIShipment::getCustoms() const {
    return m_customs;
}
void OAIShipment::setCustoms(const OAIInternational_shipment_options &customs) {
    m_customs = customs;
    m_customs_isSet = true;
}

bool OAIShipment::is_customs_Set() const{
    return m_customs_isSet;
}

bool OAIShipment::is_customs_Valid() const{
    return m_customs_isValid;
}

QString OAIShipment::getExternalOrderId() const {
    return m_external_order_id;
}
void OAIShipment::setExternalOrderId(const QString &external_order_id) {
    m_external_order_id = external_order_id;
    m_external_order_id_isSet = true;
}

bool OAIShipment::is_external_order_id_Set() const{
    return m_external_order_id_isSet;
}

bool OAIShipment::is_external_order_id_Valid() const{
    return m_external_order_id_isValid;
}

QString OAIShipment::getExternalShipmentId() const {
    return m_external_shipment_id;
}
void OAIShipment::setExternalShipmentId(const QString &external_shipment_id) {
    m_external_shipment_id = external_shipment_id;
    m_external_shipment_id_isSet = true;
}

bool OAIShipment::is_external_shipment_id_Set() const{
    return m_external_shipment_id_isSet;
}

bool OAIShipment::is_external_shipment_id_Valid() const{
    return m_external_shipment_id_isValid;
}

OAIInsurance_provider OAIShipment::getInsuranceProvider() const {
    return m_insurance_provider;
}
void OAIShipment::setInsuranceProvider(const OAIInsurance_provider &insurance_provider) {
    m_insurance_provider = insurance_provider;
    m_insurance_provider_isSet = true;
}

bool OAIShipment::is_insurance_provider_Set() const{
    return m_insurance_provider_isSet;
}

bool OAIShipment::is_insurance_provider_Valid() const{
    return m_insurance_provider_isValid;
}

bool OAIShipment::isIsReturn() const {
    return m_is_return;
}
void OAIShipment::setIsReturn(const bool &is_return) {
    m_is_return = is_return;
    m_is_return_isSet = true;
}

bool OAIShipment::is_is_return_Set() const{
    return m_is_return_isSet;
}

bool OAIShipment::is_is_return_Valid() const{
...
QDateTime OAIShipment::getModifiedAt() const {
    return m_modified_at;
}
void OAIShipment::setModifiedAt(const QDateTime &modified_at) {
    m_modified_at = modified_at;
    m_modified_at_isSet = true;
}

bool OAIShipment::is_modified_at_Set() const{
    return m_modified_at_isSet;
}

bool OAIShipment::is_modified_at_Valid() const{
    return m_modified_at_isValid;
}

OAIOrder_source_name OAIShipment::getOrderSourceCode() const {
    return m_order_source_code;
}
void OAIShipment::setOrderSourceCode(const OAIOrder_source_name &order_source_code) {
    m_order_source_code = order_source_code;
    m_order_source_code_isSet = true;
}

bool OAIShipment::is_order_source_code_Set() const{
    return m_order_source_code_isSet;
}

bool OAIShipment::is_order_source_code_Valid() const{
    return m_order_source_code_isValid;
}

OAIOrigin_type OAIShipment::getOriginType() const {
    return m_origin_type;
}
void OAIShipment::setOriginType(const OAIOrigin_type &origin_type) {
    m_origin_type = origin_type;
    m_origin_type_isSet = true;
}

bool OAIShipment::is_origin_type_Set() const{
    return m_origin_type_isSet;
}

bool OAIShipment::is_origin_type_Valid() const{
    return m_origin_type_isValid;
}

QList<OAIPackage> OAIShipment::getPackages() const {
    return m_packages;
}
void OAIShipment::setPackages(const QList<OAIPackage> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAIShipment::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAIShipment::is_packages_Valid() const{
    return m_packages_isValid;
}

OAIShipping_address OAIShipment::getReturnTo() const {
    return m_return_to;
}
void OAIShipment::setReturnTo(const OAIShipping_address &return_to) {
...
QString OAIShipment::getServiceCode() const {
    return m_service_code;
}
void OAIShipment::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIShipment::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIShipment::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QDateTime OAIShipment::getShipDate() const {
    return m_ship_date;
}
void OAIShipment::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIShipment::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIShipment::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIShipping_address OAIShipment::getShipFrom() const {
    return m_ship_from;
}
void OAIShipment::setShipFrom(const OAIShipping_address &ship_from) {
...
OAIShipping_address OAIShipment::getShipTo() const {
    return m_ship_to;
}
void OAIShipment::setShipTo(const OAIShipping_address &ship_to) {
    m_ship_to = ship_to;
...
QString OAIShipment::getShipmentNumber() const {
    return m_shipment_number;
}
void OAIShipment::setShipmentNumber(const QString &shipment_number) {
    m_shipment_number = shipment_number;
    m_shipment_number_isSet = true;
}

bool OAIShipment::is_shipment_number_Set() const{
    return m_shipment_number_isSet;
}

bool OAIShipment::is_shipment_number_Valid() const{
    return m_shipment_number_isValid;
}

OAIShipment_status OAIShipment::getShipmentStatus() const {
    return m_shipment_status;
}
void OAIShipment::setShipmentStatus(const OAIShipment_status &shipment_status) {
    m_shipment_status = shipment_status;
    m_shipment_status_isSet = true;
}

bool OAIShipment::is_shipment_status_Set() const{
    return m_shipment_status_isSet;
}

bool OAIShipment::is_shipment_status_Valid() const{
    return m_shipment_status_isValid;
}

QList<OAITag> OAIShipment::getTags() const {
    return m_tags;
}
void OAIShipment::setTags(const QList<OAITag> &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIShipment::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIShipment::is_tags_Valid() const{
    return m_tags_isValid;
}

QList<OAITax_identifier> OAIShipment::getTaxIdentifiers() const {
    return m_tax_identifiers;
}
void OAIShipment::setTaxIdentifiers(const QList<OAITax_identifier> &tax_identifiers) {
    m_tax_identifiers = tax_identifiers;
    m_tax_identifiers_isSet = true;
}

bool OAIShipment::is_tax_identifiers_Set() const{
    return m_tax_identifiers_isSet;
}

bool OAIShipment::is_tax_identifiers_Valid() const{
    return m_tax_identifiers_isValid;
}

OAIWeight OAIShipment::getTotalWeight() const {
    return m_total_weight;
}
void OAIShipment::setTotalWeight(const OAIWeight &total_weight) {
    m_total_weight = total_weight;
    m_total_weight_isSet = true;
}

bool OAIShipment::is_total_weight_Set() const{
    return m_total_weight_isSet;
}

bool OAIShipment::is_total_weight_Valid() const{
