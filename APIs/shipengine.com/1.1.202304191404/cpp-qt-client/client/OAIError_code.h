...
#ifndef OAIError_code_H
#define OAIError_code_H
...
class OAIError_code : public OAIEnum {
public:
    OAIError_code();
    OAIError_code(QString json);
    ~OAIError_code() override;
    ...
    OAIError_code::eOAIError_code getValue() const;
    void setValue(const OAIError_code::eOAIError_code& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIError_code)

#endif // OAIError_code_H
