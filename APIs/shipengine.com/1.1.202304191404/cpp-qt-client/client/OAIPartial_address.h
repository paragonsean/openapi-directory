...
/*
 * OAIPartial_address.h
 *
 * A complete or partial mailing address.
 */

#ifndef OAIPartial_address_H
#define OAIPartial_address_H
...
class OAIPartial_address : public OAIObject {
public:
    OAIPartial_address();
    OAIPartial_address(QString json);
    ~OAIPartial_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPartial_address)

#endif // OAIPartial_address_H
