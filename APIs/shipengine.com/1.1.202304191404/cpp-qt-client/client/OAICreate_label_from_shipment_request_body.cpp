...
OAICreate_label_from_shipment_request_body::OAICreate_label_from_shipment_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreate_label_from_shipment_request_body::OAICreate_label_from_shipment_request_body() {
    this->initializeModel();
}

OAICreate_label_from_shipment_request_body::~OAICreate_label_from_shipment_request_body() {}

void OAICreate_label_from_shipment_request_body::initializeModel() {
...
void OAICreate_label_from_shipment_request_body::fromJson(QString jsonString) {
...
void OAICreate_label_from_shipment_request_body::fromJsonObject(QJsonObject json) {
...
QString OAICreate_label_from_shipment_request_body::asJson() const {
...
QJsonObject OAICreate_label_from_shipment_request_body::asJsonObject() const {
    QJsonObject obj;
...
OAIDisplay_scheme OAICreate_label_from_shipment_request_body::getDisplayScheme() const {
    return m_display_scheme;
}
void OAICreate_label_from_shipment_request_body::setDisplayScheme(const OAIDisplay_scheme &display_scheme) {
    m_display_scheme = display_scheme;
    m_display_scheme_isSet = true;
}

bool OAICreate_label_from_shipment_request_body::is_display_scheme_Set() const{
    return m_display_scheme_isSet;
}

bool OAICreate_label_from_shipment_request_body::is_display_scheme_Valid() const{
    return m_display_scheme_isValid;
}

OAILabel_download_type OAICreate_label_from_shipment_request_body::getLabelDownloadType() const {
    return m_label_download_type;
}
void OAICreate_label_from_shipment_request_body::setLabelDownloadType(const OAILabel_download_type &label_download_type) {
    m_label_download_type = label_download_type;
    m_label_download_type_isSet = true;
}

bool OAICreate_label_from_shipment_request_body::is_label_download_type_Set() const{
    return m_label_download_type_isSet;
}

bool OAICreate_label_from_shipment_request_body::is_label_download_type_Valid() const{
    return m_label_download_type_isValid;
}

OAILabel_format OAICreate_label_from_shipment_request_body::getLabelFormat() const {
    return m_label_format;
}
void OAICreate_label_from_shipment_request_body::setLabelFormat(const OAILabel_format &label_format) {
    m_label_format = label_format;
    m_label_format_isSet = true;
}

bool OAICreate_label_from_shipment_request_body::is_label_format_Set() const{
    return m_label_format_isSet;
}

bool OAICreate_label_from_shipment_request_body::is_label_format_Valid() const{
    return m_label_format_isValid;
}

OAILabel_layout OAICreate_label_from_shipment_request_body::getLabelLayout() const {
    return m_label_layout;
}
void OAICreate_label_from_shipment_request_body::setLabelLayout(const OAILabel_layout &label_layout) {
    m_label_layout = label_layout;
    m_label_layout_isSet = true;
}

bool OAICreate_label_from_shipment_request_body::is_label_layout_Set() const{
    return m_label_layout_isSet;
}

bool OAICreate_label_from_shipment_request_body::is_label_layout_Valid() const{
    return m_label_layout_isValid;
}

OAIValidate_address OAICreate_label_from_shipment_request_body::getValidateAddress() const {
    return m_validate_address;
}
void OAICreate_label_from_shipment_request_body::setValidateAddress(const OAIValidate_address &validate_address) {
    m_validate_address = validate_address;
    m_validate_address_isSet = true;
}

bool OAICreate_label_from_shipment_request_body::is_validate_address_Set() const{
    return m_validate_address_isSet;
}

bool OAICreate_label_from_shipment_request_body::is_validate_address_Valid() const{
    return m_validate_address_isValid;
}

bool OAICreate_label_from_shipment_request_body::isSet() const {
...
bool OAICreate_label_from_shipment_request_body::isValid() const {
