...
OAIEstimate_rates_request_body::OAIEstimate_rates_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEstimate_rates_request_body::OAIEstimate_rates_request_body() {
    this->initializeModel();
}

OAIEstimate_rates_request_body::~OAIEstimate_rates_request_body() {}

void OAIEstimate_rates_request_body::initializeModel() {
...
void OAIEstimate_rates_request_body::fromJson(QString jsonString) {
...
void OAIEstimate_rates_request_body::fromJsonObject(QJsonObject json) {
...
QString OAIEstimate_rates_request_body::asJson() const {
...
QJsonObject OAIEstimate_rates_request_body::asJsonObject() const {
    QJsonObject obj;
...
OAIAddress_residential_indicator OAIEstimate_rates_request_body::getAddressResidentialIndicator() const {
    return m_address_residential_indicator;
}
void OAIEstimate_rates_request_body::setAddressResidentialIndicator(const OAIAddress_residential_indicator &address_residential_indicator) {
    m_address_residential_indicator = address_residential_indicator;
    m_address_residential_indicator_isSet = true;
}

bool OAIEstimate_rates_request_body::is_address_residential_indicator_Set() const{
    return m_address_residential_indicator_isSet;
}

bool OAIEstimate_rates_request_body::is_address_residential_indicator_Valid() const{
    return m_address_residential_indicator_isValid;
}

OAIDelivery_confirmation OAIEstimate_rates_request_body::getConfirmation() const {
    return m_confirmation;
}
void OAIEstimate_rates_request_body::setConfirmation(const OAIDelivery_confirmation &confirmation) {
    m_confirmation = confirmation;
    m_confirmation_isSet = true;
}

bool OAIEstimate_rates_request_body::is_confirmation_Set() const{
    return m_confirmation_isSet;
}

bool OAIEstimate_rates_request_body::is_confirmation_Valid() const{
    return m_confirmation_isValid;
}

OAIDimensions OAIEstimate_rates_request_body::getDimensions() const {
    return m_dimensions;
}
void OAIEstimate_rates_request_body::setDimensions(const OAIDimensions &dimensions) {
    m_dimensions = dimensions;
    m_dimensions_isSet = true;
}

bool OAIEstimate_rates_request_body::is_dimensions_Set() const{
    return m_dimensions_isSet;
}

bool OAIEstimate_rates_request_body::is_dimensions_Valid() const{
    return m_dimensions_isValid;
}

QString OAIEstimate_rates_request_body::getFromCityLocality() const {
    return m_from_city_locality;
}
void OAIEstimate_rates_request_body::setFromCityLocality(const QString &from_city_locality) {
    m_from_city_locality = from_city_locality;
    m_from_city_locality_isSet = true;
}

bool OAIEstimate_rates_request_body::is_from_city_locality_Set() const{
    return m_from_city_locality_isSet;
}

bool OAIEstimate_rates_request_body::is_from_city_locality_Valid() const{
    return m_from_city_locality_isValid;
}

QString OAIEstimate_rates_request_body::getFromCountryCode() const {
    return m_from_country_code;
}
void OAIEstimate_rates_request_body::setFromCountryCode(const QString &from_country_code) {
    m_from_country_code = from_country_code;
    m_from_country_code_isSet = true;
}

bool OAIEstimate_rates_request_body::is_from_country_code_Set() const{
    return m_from_country_code_isSet;
}

bool OAIEstimate_rates_request_body::is_from_country_code_Valid() const{
    return m_from_country_code_isValid;
}

QString OAIEstimate_rates_request_body::getFromPostalCode() const {
    return m_from_postal_code;
}
void OAIEstimate_rates_request_body::setFromPostalCode(const QString &from_postal_code) {
    m_from_postal_code = from_postal_code;
    m_from_postal_code_isSet = true;
}

bool OAIEstimate_rates_request_body::is_from_postal_code_Set() const{
    return m_from_postal_code_isSet;
}

bool OAIEstimate_rates_request_body::is_from_postal_code_Valid() const{
    return m_from_postal_code_isValid;
}

QString OAIEstimate_rates_request_body::getFromStateProvince() const {
    return m_from_state_province;
}
void OAIEstimate_rates_request_body::setFromStateProvince(const QString &from_state_province) {
    m_from_state_province = from_state_province;
    m_from_state_province_isSet = true;
}

bool OAIEstimate_rates_request_body::is_from_state_province_Set() const{
    return m_from_state_province_isSet;
}

bool OAIEstimate_rates_request_body::is_from_state_province_Valid() const{
    return m_from_state_province_isValid;
}

QDateTime OAIEstimate_rates_request_body::getShipDate() const {
    return m_ship_date;
}
void OAIEstimate_rates_request_body::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAIEstimate_rates_request_body::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAIEstimate_rates_request_body::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

QString OAIEstimate_rates_request_body::getToCityLocality() const {
    return m_to_city_locality;
}
void OAIEstimate_rates_request_body::setToCityLocality(const QString &to_city_locality) {
    m_to_city_locality = to_city_locality;
    m_to_city_locality_isSet = true;
}

bool OAIEstimate_rates_request_body::is_to_city_locality_Set() const{
    return m_to_city_locality_isSet;
}

bool OAIEstimate_rates_request_body::is_to_city_locality_Valid() const{
    return m_to_city_locality_isValid;
}

QString OAIEstimate_rates_request_body::getToCountryCode() const {
    return m_to_country_code;
}
void OAIEstimate_rates_request_body::setToCountryCode(const QString &to_country_code) {
    m_to_country_code = to_country_code;
    m_to_country_code_isSet = true;
}

bool OAIEstimate_rates_request_body::is_to_country_code_Set() const{
    return m_to_country_code_isSet;
}

bool OAIEstimate_rates_request_body::is_to_country_code_Valid() const{
    return m_to_country_code_isValid;
}

QString OAIEstimate_rates_request_body::getToPostalCode() const {
    return m_to_postal_code;
}
void OAIEstimate_rates_request_body::setToPostalCode(const QString &to_postal_code) {
    m_to_postal_code = to_postal_code;
    m_to_postal_code_isSet = true;
}

bool OAIEstimate_rates_request_body::is_to_postal_code_Set() const{
    return m_to_postal_code_isSet;
}

bool OAIEstimate_rates_request_body::is_to_postal_code_Valid() const{
    return m_to_postal_code_isValid;
}

QString OAIEstimate_rates_request_body::getToStateProvince() const {
    return m_to_state_province;
}
void OAIEstimate_rates_request_body::setToStateProvince(const QString &to_state_province) {
    m_to_state_province = to_state_province;
    m_to_state_province_isSet = true;
}

bool OAIEstimate_rates_request_body::is_to_state_province_Set() const{
    return m_to_state_province_isSet;
}

bool OAIEstimate_rates_request_body::is_to_state_province_Valid() const{
    return m_to_state_province_isValid;
}

OAIWeight OAIEstimate_rates_request_body::getWeight() const {
    return m_weight;
}
void OAIEstimate_rates_request_body::setWeight(const OAIWeight &weight) {
    m_weight = weight;
    m_weight_isSet = true;
}

bool OAIEstimate_rates_request_body::is_weight_Set() const{
    return m_weight_isSet;
}

bool OAIEstimate_rates_request_body::is_weight_Valid() const{
    return m_weight_isValid;
}

bool OAIEstimate_rates_request_body::isSet() const {
...
bool OAIEstimate_rates_request_body::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_from_city_locality_isValid && m_from_country_code_isValid && m_from_postal_code_isValid && m_from_state_province_isValid && m_ship_date_isValid && m_to_city_locality_isValid && m_to_country_code_isValid && m_to_postal_code_isValid && m_to_state_province_isValid && m_weight_isValid && true;
}
