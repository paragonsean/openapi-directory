...
/*
 * OAIList_manifests_response_body.h
 *
 * A list manifests response body
 */

#ifndef OAIList_manifests_response_body_H
#define OAIList_manifests_response_body_H
...
class OAIList_manifests_response_body : public OAIObject {
public:
    OAIList_manifests_response_body();
    OAIList_manifests_response_body(QString json);
    ~OAIList_manifests_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIList_manifests_response_body)

#endif // OAIList_manifests_response_body_H
