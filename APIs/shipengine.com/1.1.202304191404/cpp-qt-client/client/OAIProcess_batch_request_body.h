...
/*
 * OAIProcess_batch_request_body.h
 *
 * A process batch request body
 */

#ifndef OAIProcess_batch_request_body_H
#define OAIProcess_batch_request_body_H
...
class OAIProcess_batch_request_body : public OAIObject {
public:
    OAIProcess_batch_request_body();
    OAIProcess_batch_request_body(QString json);
    ~OAIProcess_batch_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProcess_batch_request_body)

#endif // OAIProcess_batch_request_body_H
