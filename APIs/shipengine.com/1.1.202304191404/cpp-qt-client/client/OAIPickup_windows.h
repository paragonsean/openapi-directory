...
#ifndef OAIPickup_windows_H
#define OAIPickup_windows_H
...
class OAIPickup_windows : public OAIObject {
public:
    OAIPickup_windows();
    OAIPickup_windows(QString json);
    ~OAIPickup_windows() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPickup_windows)

#endif // OAIPickup_windows_H
