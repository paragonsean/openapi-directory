...
OAIOptional_link OAIBatch::getBatchErrorsUrl() const {
    return m_batch_errors_url;
}
void OAIBatch::setBatchErrorsUrl(const OAIOptional_link &batch_errors_url) {
    m_batch_errors_url = batch_errors_url;
    m_batch_errors_url_isSet = true;
}

bool OAIBatch::is_batch_errors_url_Set() const{
    return m_batch_errors_url_isSet;
}

bool OAIBatch::is_batch_errors_url_Valid() const{
    return m_batch_errors_url_isValid;
}

QString OAIBatch::getBatchId() const {
    return m_batch_id;
}
void OAIBatch::setBatchId(const QString &batch_id) {
    m_batch_id = batch_id;
    m_batch_id_isSet = true;
}

bool OAIBatch::is_batch_id_Set() const{
    return m_batch_id_isSet;
}

bool OAIBatch::is_batch_id_Valid() const{
    return m_batch_id_isValid;
}

OAIOptional_link OAIBatch::getBatchLabelsUrl() const {
    return m_batch_labels_url;
}
void OAIBatch::setBatchLabelsUrl(const OAIOptional_link &batch_labels_url) {
    m_batch_labels_url = batch_labels_url;
    m_batch_labels_url_isSet = true;
}

bool OAIBatch::is_batch_labels_url_Set() const{
    return m_batch_labels_url_isSet;
}

bool OAIBatch::is_batch_labels_url_Valid() const{
    return m_batch_labels_url_isValid;
}

QString OAIBatch::getBatchNotes() const {
    return m_batch_notes;
}
void OAIBatch::setBatchNotes(const QString &batch_notes) {
    m_batch_notes = batch_notes;
    m_batch_notes_isSet = true;
}

bool OAIBatch::is_batch_notes_Set() const{
    return m_batch_notes_isSet;
}

bool OAIBatch::is_batch_notes_Valid() const{
    return m_batch_notes_isValid;
}

QString OAIBatch::getBatchNumber() const {
    return m_batch_number;
}
void OAIBatch::setBatchNumber(const QString &batch_number) {
    m_batch_number = batch_number;
    m_batch_number_isSet = true;
}

bool OAIBatch::is_batch_number_Set() const{
    return m_batch_number_isSet;
}

bool OAIBatch::is_batch_number_Valid() const{
    return m_batch_number_isValid;
}

OAIOptional_link OAIBatch::getBatchShipmentsUrl() const {
    return m_batch_shipments_url;
}
void OAIBatch::setBatchShipmentsUrl(const OAIOptional_link &batch_shipments_url) {
    m_batch_shipments_url = batch_shipments_url;
    m_batch_shipments_url_isSet = true;
}

bool OAIBatch::is_batch_shipments_url_Set() const{
    return m_batch_shipments_url_isSet;
}

bool OAIBatch::is_batch_shipments_url_Valid() const{
    return m_batch_shipments_url_isValid;
}

qint32 OAIBatch::getCompleted() const {
    return m_completed;
}
void OAIBatch::setCompleted(const qint32 &completed) {
...
QDateTime OAIBatch::getCreatedAt() const {
    return m_created_at;
}
void OAIBatch::setCreatedAt(const QDateTime &created_at) {
...
qint32 OAIBatch::getErrors() const {
    return m_errors;
}
void OAIBatch::setErrors(const qint32 &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}
...
QString OAIBatch::getExternalBatchId() const {
    return m_external_batch_id;
}
void OAIBatch::setExternalBatchId(const QString &external_batch_id) {
    m_external_batch_id = external_batch_id;
    m_external_batch_id_isSet = true;
}

bool OAIBatch::is_external_batch_id_Set() const{
    return m_external_batch_id_isSet;
}

bool OAIBatch::is_external_batch_id_Valid() const{
    return m_external_batch_id_isValid;
}

OAIOptional_link OAIBatch::getFormDownload() const {
    return m_form_download;
}
void OAIBatch::setFormDownload(const OAIOptional_link &form_download) {
    m_form_download = form_download;
    m_form_download_isSet = true;
}

bool OAIBatch::is_form_download_Set() const{
    return m_form_download_isSet;
}

bool OAIBatch::is_form_download_Valid() const{
    return m_form_download_isValid;
}

qint32 OAIBatch::getForms() const {
    return m_forms;
}
void OAIBatch::setForms(const qint32 &forms) {
    m_forms = forms;
    m_forms_isSet = true;
}

bool OAIBatch::is_forms_Set() const{
    return m_forms_isSet;
}

bool OAIBatch::is_forms_Valid() const{
    return m_forms_isValid;
}

OAILabel_download OAIBatch::getLabelDownload() const {
    return m_label_download;
}
void OAIBatch::setLabelDownload(const OAILabel_download &label_download) {
    m_label_download = label_download;
    m_label_download_isSet = true;
}

bool OAIBatch::is_label_download_Set() const{
    return m_label_download_isSet;
}

bool OAIBatch::is_label_download_Valid() const{
    return m_label_download_isValid;
}

OAILabel_format OAIBatch::getLabelFormat() const {
    return m_label_format;
}
void OAIBatch::setLabelFormat(const OAILabel_format &label_format) {
    m_label_format = label_format;
    m_label_format_isSet = true;
}

bool OAIBatch::is_label_format_Set() const{
    return m_label_format_isSet;
}

bool OAIBatch::is_label_format_Valid() const{
    return m_label_format_isValid;
}

OAILabel_layout OAIBatch::getLabelLayout() const {
    return m_label_layout;
}
void OAIBatch::setLabelLayout(const OAILabel_layout &label_layout) {
    m_label_layout = label_layout;
    m_label_layout_isSet = true;
}

bool OAIBatch::is_label_layout_Set() const{
    return m_label_layout_isSet;
}

bool OAIBatch::is_label_layout_Valid() const{
    return m_label_layout_isValid;
}

QDateTime OAIBatch::getProcessedAt() const {
    return m_processed_at;
}
void OAIBatch::setProcessedAt(const QDateTime &processed_at) {
    m_processed_at = processed_at;
    m_processed_at_isSet = true;
}

bool OAIBatch::is_processed_at_Set() const{
    return m_processed_at_isSet;
}

bool OAIBatch::is_processed_at_Valid() const{
    return m_processed_at_isValid;
}

OAIBatch_status OAIBatch::getStatus() const {
    return m_status;
}
void OAIBatch::setStatus(const OAIBatch_status &status) {
    m_status = status;
    m_status_isSet = true;
}
...
qint32 OAIBatch::getWarnings() const {
    return m_warnings;
}
void OAIBatch::setWarnings(const qint32 &warnings) {
    m_warnings = warnings;
    m_warnings_isSet = true;
}

bool OAIBatch::is_warnings_Set() const{
    return m_warnings_isSet;
}

bool OAIBatch::is_warnings_Valid() const{
