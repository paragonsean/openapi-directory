...
class OAIRedirect : public OAIEnum {
public:
    OAIRedirect();
    ...
    enum class eOAIRedirect {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SHIPENGINE_DASHBOARD
    };
    OAIRedirect::eOAIRedirect getValue() const;
    void setValue(const OAIRedirect::eOAIRedirect& value);
