...
/*
 * OAIConnect_fedex_uk_request_body.h
 *
 * A Fedex UK account information request body
 */

#ifndef OAIConnect_fedex_uk_request_body_H
#define OAIConnect_fedex_uk_request_body_H
...
class OAIConnect_fedex_uk_request_body : public OAIObject {
public:
    OAIConnect_fedex_uk_request_body();
    OAIConnect_fedex_uk_request_body(QString json);
    ~OAIConnect_fedex_uk_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnect_fedex_uk_request_body)

#endif // OAIConnect_fedex_uk_request_body_H
