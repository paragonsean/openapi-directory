...
QString OAIRate::getCarrierCode() const {
    return m_carrier_code;
}
void OAIRate::setCarrierCode(const QString &carrier_code) {
    m_carrier_code = carrier_code;
    m_carrier_code_isSet = true;
}

bool OAIRate::is_carrier_code_Set() const{
    return m_carrier_code_isSet;
}

bool OAIRate::is_carrier_code_Valid() const{
    return m_carrier_code_isValid;
}

QString OAIRate::getCarrierDeliveryDays() const {
    return m_carrier_delivery_days;
}
void OAIRate::setCarrierDeliveryDays(const QString &carrier_delivery_days) {
    m_carrier_delivery_days = carrier_delivery_days;
    m_carrier_delivery_days_isSet = true;
}

bool OAIRate::is_carrier_delivery_days_Set() const{
    return m_carrier_delivery_days_isSet;
}

bool OAIRate::is_carrier_delivery_days_Valid() const{
    return m_carrier_delivery_days_isValid;
}

QString OAIRate::getCarrierFriendlyName() const {
    return m_carrier_friendly_name;
}
void OAIRate::setCarrierFriendlyName(const QString &carrier_friendly_name) {
    m_carrier_friendly_name = carrier_friendly_name;
    m_carrier_friendly_name_isSet = true;
}

bool OAIRate::is_carrier_friendly_name_Set() const{
    return m_carrier_friendly_name_isSet;
}

bool OAIRate::is_carrier_friendly_name_Valid() const{
    return m_carrier_friendly_name_isValid;
}

QString OAIRate::getCarrierId() const {
    return m_carrier_id;
}
void OAIRate::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIRate::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIRate::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAIRate::getCarrierNickname() const {
    return m_carrier_nickname;
}
void OAIRate::setCarrierNickname(const QString &carrier_nickname) {
    m_carrier_nickname = carrier_nickname;
    m_carrier_nickname_isSet = true;
}

bool OAIRate::is_carrier_nickname_Set() const{
    return m_carrier_nickname_isSet;
}

bool OAIRate::is_carrier_nickname_Valid() const{
    return m_carrier_nickname_isValid;
}

OAIMonetary_value OAIRate::getConfirmationAmount() const {
    return m_confirmation_amount;
}
void OAIRate::setConfirmationAmount(const OAIMonetary_value &confirmation_amount) {
    m_confirmation_amount = confirmation_amount;
    m_confirmation_amount_isSet = true;
}

bool OAIRate::is_confirmation_amount_Set() const{
    return m_confirmation_amount_isSet;
}

bool OAIRate::is_confirmation_amount_Valid() const{
    return m_confirmation_amount_isValid;
}

qint32 OAIRate::getDeliveryDays() const {
    return m_delivery_days;
}
void OAIRate::setDeliveryDays(const qint32 &delivery_days) {
    m_delivery_days = delivery_days;
    m_delivery_days_isSet = true;
}

bool OAIRate::is_delivery_days_Set() const{
    return m_delivery_days_isSet;
}

bool OAIRate::is_delivery_days_Valid() const{
    return m_delivery_days_isValid;
}

QList<QString> OAIRate::getErrorMessages() const {
    return m_error_messages;
}
void OAIRate::setErrorMessages(const QList<QString> &error_messages) {
    m_error_messages = error_messages;
    m_error_messages_isSet = true;
}

bool OAIRate::is_error_messages_Set() const{
    return m_error_messages_isSet;
}

bool OAIRate::is_error_messages_Valid() const{
    return m_error_messages_isValid;
}

QDateTime OAIRate::getEstimatedDeliveryDate() const {
    return m_estimated_delivery_date;
}
void OAIRate::setEstimatedDeliveryDate(const QDateTime &estimated_delivery_date) {
    m_estimated_delivery_date = estimated_delivery_date;
    m_estimated_delivery_date_isSet = true;
}

bool OAIRate::is_estimated_delivery_date_Set() const{
    return m_estimated_delivery_date_isSet;
}

bool OAIRate::is_estimated_delivery_date_Valid() const{
    return m_estimated_delivery_date_isValid;
}

bool OAIRate::isGuaranteedService() const {
    return m_guaranteed_service;
}
void OAIRate::setGuaranteedService(const bool &guaranteed_service) {
    m_guaranteed_service = guaranteed_service;
    m_guaranteed_service_isSet = true;
}

bool OAIRate::is_guaranteed_service_Set() const{
    return m_guaranteed_service_isSet;
}

bool OAIRate::is_guaranteed_service_Valid() const{
    return m_guaranteed_service_isValid;
}

OAIMonetary_value OAIRate::getInsuranceAmount() const {
    return m_insurance_amount;
}
void OAIRate::setInsuranceAmount(const OAIMonetary_value &insurance_amount) {
    m_insurance_amount = insurance_amount;
    m_insurance_amount_isSet = true;
}

bool OAIRate::is_insurance_amount_Set() const{
    return m_insurance_amount_isSet;
}

bool OAIRate::is_insurance_amount_Valid() const{
    return m_insurance_amount_isValid;
}

bool OAIRate::isNegotiatedRate() const {
    return m_negotiated_rate;
}
void OAIRate::setNegotiatedRate(const bool &negotiated_rate) {
    m_negotiated_rate = negotiated_rate;
    m_negotiated_rate_isSet = true;
}

bool OAIRate::is_negotiated_rate_Set() const{
    return m_negotiated_rate_isSet;
}

bool OAIRate::is_negotiated_rate_Valid() const{
    return m_negotiated_rate_isValid;
}

OAIMonetary_value OAIRate::getOtherAmount() const {
    return m_other_amount;
}
void OAIRate::setOtherAmount(const OAIMonetary_value &other_amount) {
    m_other_amount = other_amount;
    m_other_amount_isSet = true;
}

bool OAIRate::is_other_amount_Set() const{
    return m_other_amount_isSet;
}

bool OAIRate::is_other_amount_Valid() const{
    return m_other_amount_isValid;
}

QString OAIRate::getPackageType() const {
    return m_package_type;
}
void OAIRate::setPackageType(const QString &package_type) {
    m_package_type = package_type;
    m_package_type_isSet = true;
}

bool OAIRate::is_package_type_Set() const{
    return m_package_type_isSet;
}

bool OAIRate::is_package_type_Valid() const{
...
OAIRate_type OAIRate::getRateType() const {
    return m_rate_type;
}
void OAIRate::setRateType(const OAIRate_type &rate_type) {
    m_rate_type = rate_type;
    m_rate_type_isSet = true;
}

bool OAIRate::is_rate_type_Set() const{
    return m_rate_type_isSet;
}

bool OAIRate::is_rate_type_Valid() const{
    return m_rate_type_isValid;
}

QString OAIRate::getServiceCode() const {
    return m_service_code;
}
void OAIRate::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIRate::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIRate::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QString OAIRate::getServiceType() const {
    return m_service_type;
}
void OAIRate::setServiceType(const QString &service_type) {
    m_service_type = service_type;
    m_service_type_isSet = true;
}

bool OAIRate::is_service_type_Set() const{
    return m_service_type_isSet;
}

bool OAIRate::is_service_type_Valid() const{
    return m_service_type_isValid;
}

QDateTime OAIRate::getShipDate() const {
    return m_ship_date;
}
void OAIRate::setShipDate(const QDateTime &ship_date) {
...
OAIMonetary_value OAIRate::getShippingAmount() const {
    return m_shipping_amount;
}
void OAIRate::setShippingAmount(const OAIMonetary_value &shipping_amount) {
    m_shipping_amount = shipping_amount;
    m_shipping_amount_isSet = true;
}

bool OAIRate::is_shipping_amount_Set() const{
    return m_shipping_amount_isSet;
}

bool OAIRate::is_shipping_amount_Valid() const{
    return m_shipping_amount_isValid;
}

OAIMonetary_value OAIRate::getTaxAmount() const {
    return m_tax_amount;
}
void OAIRate::setTaxAmount(const OAIMonetary_value &tax_amount) {
    m_tax_amount = tax_amount;
    m_tax_amount_isSet = true;
}

bool OAIRate::is_tax_amount_Set() const{
    return m_tax_amount_isSet;
}

bool OAIRate::is_tax_amount_Valid() const{
    return m_tax_amount_isValid;
}

bool OAIRate::isTrackable() const {
    return m_trackable;
}
void OAIRate::setTrackable(const bool &trackable) {
    m_trackable = trackable;
    m_trackable_isSet = true;
}

bool OAIRate::is_trackable_Set() const{
    return m_trackable_isSet;
}

bool OAIRate::is_trackable_Valid() const{
    return m_trackable_isValid;
}

OAIValidation_status OAIRate::getValidationStatus() const {
    return m_validation_status;
}
void OAIRate::setValidationStatus(const OAIValidation_status &validation_status) {
    m_validation_status = validation_status;
    m_validation_status_isSet = true;
}

bool OAIRate::is_validation_status_Set() const{
    return m_validation_status_isSet;
}

bool OAIRate::is_validation_status_Valid() const{
    return m_validation_status_isValid;
}

QList<QString> OAIRate::getWarningMessages() const {
    return m_warning_messages;
}
void OAIRate::setWarningMessages(const QList<QString> &warning_messages) {
    m_warning_messages = warning_messages;
    m_warning_messages_isSet = true;
}

bool OAIRate::is_warning_messages_Set() const{
    return m_warning_messages_isSet;
}

bool OAIRate::is_warning_messages_Valid() const{
    return m_warning_messages_isValid;
}

qint32 OAIRate::getZone() const {
    return m_zone;
}
void OAIRate::setZone(const qint32 &zone) {
    m_zone = zone;
    m_zone_isSet = true;
}

bool OAIRate::is_zone_Set() const{
    return m_zone_isSet;
}

bool OAIRate::is_zone_Valid() const{
