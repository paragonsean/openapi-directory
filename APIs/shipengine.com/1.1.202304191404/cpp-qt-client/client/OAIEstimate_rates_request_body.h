...
/*
 * OAIEstimate_rates_request_body.h
 *
 * A rate estimate request body
 */

#ifndef OAIEstimate_rates_request_body_H
#define OAIEstimate_rates_request_body_H
...
class OAIEstimate_rates_request_body : public OAIObject {
public:
    OAIEstimate_rates_request_body();
    OAIEstimate_rates_request_body(QString json);
    ~OAIEstimate_rates_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstimate_rates_request_body)

#endif // OAIEstimate_rates_request_body_H
