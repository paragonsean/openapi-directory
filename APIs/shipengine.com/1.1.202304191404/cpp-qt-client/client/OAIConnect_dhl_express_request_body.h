...
/*
 * OAIConnect_dhl_express_request_body.h
 *
 * A DHL express account information request body
 */

#ifndef OAIConnect_dhl_express_request_body_H
#define OAIConnect_dhl_express_request_body_H
...
class OAIConnect_dhl_express_request_body : public OAIObject {
public:
    OAIConnect_dhl_express_request_body();
    OAIConnect_dhl_express_request_body(QString json);
    ~OAIConnect_dhl_express_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnect_dhl_express_request_body)

#endif // OAIConnect_dhl_express_request_body_H
