...
#ifndef OAILabel_status_H
#define OAILabel_status_H
...
class OAILabel_status : public OAIEnum {
public:
    OAILabel_status();
    OAILabel_status(QString json);
    ~OAILabel_status() override;
    ...
    OAILabel_status::eOAILabel_status getValue() const;
    void setValue(const OAILabel_status::eOAILabel_status& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAILabel_status)

#endif // OAILabel_status_H
