...
/*
 * OAIShipping_address.h
 *
 * 
 */

#ifndef OAIShipping_address_H
#define OAIShipping_address_H
...
class OAIShipping_address : public OAIObject {
public:
    OAIShipping_address();
    OAIShipping_address(QString json);
    ~OAIShipping_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIShipping_address)

#endif // OAIShipping_address_H
