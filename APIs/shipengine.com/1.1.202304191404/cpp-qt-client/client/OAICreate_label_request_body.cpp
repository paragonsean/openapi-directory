...
OAICreate_label_request_body::OAICreate_label_request_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreate_label_request_body::OAICreate_label_request_body() {
    this->initializeModel();
}

OAICreate_label_request_body::~OAICreate_label_request_body() {}

void OAICreate_label_request_body::initializeModel() {

    m_ship_from_service_point_id_isSet = false;
    m_ship_from_service_point_id_isValid = false;

    m_ship_to_service_point_id_isSet = false;
    m_ship_to_service_point_id_isValid = false;
...
void OAICreate_label_request_body::fromJson(QString jsonString) {
...
void OAICreate_label_request_body::fromJsonObject(QJsonObject json) {

    m_ship_from_service_point_id_isValid = ::OpenAPI::fromJsonValue(m_ship_from_service_point_id, json[QString("ship_from_service_point_id")]);
    m_ship_from_service_point_id_isSet = !json[QString("ship_from_service_point_id")].isNull() && m_ship_from_service_point_id_isValid;

    m_ship_to_service_point_id_isValid = ::OpenAPI::fromJsonValue(m_ship_to_service_point_id, json[QString("ship_to_service_point_id")]);
    m_ship_to_service_point_id_isSet = !json[QString("ship_to_service_point_id")].isNull() && m_ship_to_service_point_id_isValid;
...
QString OAICreate_label_request_body::asJson() const {
...
QJsonObject OAICreate_label_request_body::asJsonObject() const {
    QJsonObject obj;
    if (m_ship_from_service_point_id_isSet) {
        obj.insert(QString("ship_from_service_point_id"), ::OpenAPI::toJsonValue(m_ship_from_service_point_id));
    }
    if (m_ship_to_service_point_id_isSet) {
        obj.insert(QString("ship_to_service_point_id"), ::OpenAPI::toJsonValue(m_ship_to_service_point_id));
    }
...
QString OAICreate_label_request_body::getShipFromServicePointId() const {
    return m_ship_from_service_point_id;
}
void OAICreate_label_request_body::setShipFromServicePointId(const QString &ship_from_service_point_id) {
    m_ship_from_service_point_id = ship_from_service_point_id;
    m_ship_from_service_point_id_isSet = true;
}

bool OAICreate_label_request_body::is_ship_from_service_point_id_Set() const{
    return m_ship_from_service_point_id_isSet;
}

bool OAICreate_label_request_body::is_ship_from_service_point_id_Valid() const{
    return m_ship_from_service_point_id_isValid;
}

QString OAICreate_label_request_body::getShipToServicePointId() const {
    return m_ship_to_service_point_id;
}
void OAICreate_label_request_body::setShipToServicePointId(const QString &ship_to_service_point_id) {
    m_ship_to_service_point_id = ship_to_service_point_id;
    m_ship_to_service_point_id_isSet = true;
}

bool OAICreate_label_request_body::is_ship_to_service_point_id_Set() const{
    return m_ship_to_service_point_id_isSet;
}

bool OAICreate_label_request_body::is_ship_to_service_point_id_Valid() const{
    return m_ship_to_service_point_id_isValid;
}

QList<OAIAlternative_identifier> OAICreate_label_request_body::getAlternativeIdentifiers() const {
    return m_alternative_identifiers;
}
void OAICreate_label_request_body::setAlternativeIdentifiers(const QList<OAIAlternative_identifier> &alternative_identifiers) {
    m_alternative_identifiers = alternative_identifiers;
    m_alternative_identifiers_isSet = true;
}

bool OAICreate_label_request_body::is_alternative_identifiers_Set() const{
    return m_alternative_identifiers_isSet;
}

bool OAICreate_label_request_body::is_alternative_identifiers_Valid() const{
    return m_alternative_identifiers_isValid;
}

QString OAICreate_label_request_body::getBatchId() const {
    return m_batch_id;
}
void OAICreate_label_request_body::setBatchId(const QString &batch_id) {
    m_batch_id = batch_id;
    m_batch_id_isSet = true;
}

bool OAICreate_label_request_body::is_batch_id_Set() const{
    return m_batch_id_isSet;
}

bool OAICreate_label_request_body::is_batch_id_Valid() const{
    return m_batch_id_isValid;
}

QString OAICreate_label_request_body::getCarrierCode() const {
    return m_carrier_code;
}
void OAICreate_label_request_body::setCarrierCode(const QString &carrier_code) {
    m_carrier_code = carrier_code;
    m_carrier_code_isSet = true;
}

bool OAICreate_label_request_body::is_carrier_code_Set() const{
    return m_carrier_code_isSet;
}

bool OAICreate_label_request_body::is_carrier_code_Valid() const{
    return m_carrier_code_isValid;
}

QString OAICreate_label_request_body::getCarrierId() const {
    return m_carrier_id;
}
void OAICreate_label_request_body::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAICreate_label_request_body::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAICreate_label_request_body::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

OAILabel_charge_event OAICreate_label_request_body::getChargeEvent() const {
    return m_charge_event;
}
void OAICreate_label_request_body::setChargeEvent(const OAILabel_charge_event &charge_event) {
    m_charge_event = charge_event;
    m_charge_event_isSet = true;
}

bool OAICreate_label_request_body::is_charge_event_Set() const{
    return m_charge_event_isSet;
}

bool OAICreate_label_request_body::is_charge_event_Valid() const{
    return m_charge_event_isValid;
}

QDateTime OAICreate_label_request_body::getCreatedAt() const {
    return m_created_at;
}
void OAICreate_label_request_body::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAICreate_label_request_body::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAICreate_label_request_body::is_created_at_Valid() const{
    return m_created_at_isValid;
}

OAIDisplay_scheme OAICreate_label_request_body::getDisplayScheme() const {
    return m_display_scheme;
}
void OAICreate_label_request_body::setDisplayScheme(const OAIDisplay_scheme &display_scheme) {
    m_display_scheme = display_scheme;
    m_display_scheme_isSet = true;
}

bool OAICreate_label_request_body::is_display_scheme_Set() const{
    return m_display_scheme_isSet;
}

bool OAICreate_label_request_body::is_display_scheme_Valid() const{
    return m_display_scheme_isValid;
}

OAILink OAICreate_label_request_body::getFormDownload() const {
    return m_form_download;
}
void OAICreate_label_request_body::setFormDownload(const OAILink &form_download) {
    m_form_download = form_download;
    m_form_download_isSet = true;
}

bool OAICreate_label_request_body::is_form_download_Set() const{
    return m_form_download_isSet;
}

bool OAICreate_label_request_body::is_form_download_Valid() const{
    return m_form_download_isValid;
}

OAILink OAICreate_label_request_body::getInsuranceClaim() const {
    return m_insurance_claim;
}
void OAICreate_label_request_body::setInsuranceClaim(const OAILink &insurance_claim) {
    m_insurance_claim = insurance_claim;
    m_insurance_claim_isSet = true;
}

bool OAICreate_label_request_body::is_insurance_claim_Set() const{
    return m_insurance_claim_isSet;
}

bool OAICreate_label_request_body::is_insurance_claim_Valid() const{
    return m_insurance_claim_isValid;
}

OAIMonetary_value OAICreate_label_request_body::getInsuranceCost() const {
    return m_insurance_cost;
}
void OAICreate_label_request_body::setInsuranceCost(const OAIMonetary_value &insurance_cost) {
    m_insurance_cost = insurance_cost;
    m_insurance_cost_isSet = true;
}

bool OAICreate_label_request_body::is_insurance_cost_Set() const{
    return m_insurance_cost_isSet;
}

bool OAICreate_label_request_body::is_insurance_cost_Valid() const{
    return m_insurance_cost_isValid;
}

bool OAICreate_label_request_body::isIsInternational() const {
    return m_is_international;
}
void OAICreate_label_request_body::setIsInternational(const bool &is_international) {
    m_is_international = is_international;
    m_is_international_isSet = true;
}

bool OAICreate_label_request_body::is_is_international_Set() const{
    return m_is_international_isSet;
}

bool OAICreate_label_request_body::is_is_international_Valid() const{
    return m_is_international_isValid;
}

bool OAICreate_label_request_body::isIsReturnLabel() const {
    return m_is_return_label;
}
void OAICreate_label_request_body::setIsReturnLabel(const bool &is_return_label) {
    m_is_return_label = is_return_label;
    m_is_return_label_isSet = true;
}

bool OAICreate_label_request_body::is_is_return_label_Set() const{
    return m_is_return_label_isSet;
}

bool OAICreate_label_request_body::is_is_return_label_Valid() const{
    return m_is_return_label_isValid;
}

OAILabel_download OAICreate_label_request_body::getLabelDownload() const {
    return m_label_download;
}
void OAICreate_label_request_body::setLabelDownload(const OAILabel_download &label_download) {
    m_label_download = label_download;
    m_label_download_isSet = true;
}

bool OAICreate_label_request_body::is_label_download_Set() const{
    return m_label_download_isSet;
}

bool OAICreate_label_request_body::is_label_download_Valid() const{
    return m_label_download_isValid;
}

OAILabel_download_type OAICreate_label_request_body::getLabelDownloadType() const {
    return m_label_download_type;
}
void OAICreate_label_request_body::setLabelDownloadType(const OAILabel_download_type &label_download_type) {
    m_label_download_type = label_download_type;
    m_label_download_type_isSet = true;
}

bool OAICreate_label_request_body::is_label_download_type_Set() const{
    return m_label_download_type_isSet;
}

bool OAICreate_label_request_body::is_label_download_type_Valid() const{
    return m_label_download_type_isValid;
}

OAILabel_format OAICreate_label_request_body::getLabelFormat() const {
    return m_label_format;
}
void OAICreate_label_request_body::setLabelFormat(const OAILabel_format &label_format) {
    m_label_format = label_format;
    m_label_format_isSet = true;
}

bool OAICreate_label_request_body::is_label_format_Set() const{
    return m_label_format_isSet;
}

bool OAICreate_label_request_body::is_label_format_Valid() const{
    return m_label_format_isValid;
}

QString OAICreate_label_request_body::getLabelId() const {
    return m_label_id;
}
void OAICreate_label_request_body::setLabelId(const QString &label_id) {
    m_label_id = label_id;
    m_label_id_isSet = true;
}

bool OAICreate_label_request_body::is_label_id_Set() const{
    return m_label_id_isSet;
}

bool OAICreate_label_request_body::is_label_id_Valid() const{
    return m_label_id_isValid;
}

QString OAICreate_label_request_body::getLabelImageId() const {
    return m_label_image_id;
}
void OAICreate_label_request_body::setLabelImageId(const QString &label_image_id) {
    m_label_image_id = label_image_id;
    m_label_image_id_isSet = true;
}

bool OAICreate_label_request_body::is_label_image_id_Set() const{
    return m_label_image_id_isSet;
}

bool OAICreate_label_request_body::is_label_image_id_Valid() const{
    return m_label_image_id_isValid;
}

OAILabel_layout OAICreate_label_request_body::getLabelLayout() const {
    return m_label_layout;
}
void OAICreate_label_request_body::setLabelLayout(const OAILabel_layout &label_layout) {
    m_label_layout = label_layout;
    m_label_layout_isSet = true;
}

bool OAICreate_label_request_body::is_label_layout_Set() const{
    return m_label_layout_isSet;
}

bool OAICreate_label_request_body::is_label_layout_Valid() const{
    return m_label_layout_isValid;
}

QString OAICreate_label_request_body::getOutboundLabelId() const {
    return m_outbound_label_id;
}
void OAICreate_label_request_body::setOutboundLabelId(const QString &outbound_label_id) {
    m_outbound_label_id = outbound_label_id;
    m_outbound_label_id_isSet = true;
}

bool OAICreate_label_request_body::is_outbound_label_id_Set() const{
    return m_outbound_label_id_isSet;
}

bool OAICreate_label_request_body::is_outbound_label_id_Valid() const{
    return m_outbound_label_id_isValid;
}

QString OAICreate_label_request_body::getPackageCode() const {
    return m_package_code;
}
void OAICreate_label_request_body::setPackageCode(const QString &package_code) {
    m_package_code = package_code;
    m_package_code_isSet = true;
}

bool OAICreate_label_request_body::is_package_code_Set() const{
    return m_package_code_isSet;
}

bool OAICreate_label_request_body::is_package_code_Valid() const{
    return m_package_code_isValid;
}

QList<OAIPackage> OAICreate_label_request_body::getPackages() const {
    return m_packages;
}
void OAICreate_label_request_body::setPackages(const QList<OAIPackage> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAICreate_label_request_body::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAICreate_label_request_body::is_packages_Valid() const{
    return m_packages_isValid;
}

QString OAICreate_label_request_body::getRmaNumber() const {
    return m_rma_number;
}
void OAICreate_label_request_body::setRmaNumber(const QString &rma_number) {
    m_rma_number = rma_number;
    m_rma_number_isSet = true;
}

bool OAICreate_label_request_body::is_rma_number_Set() const{
    return m_rma_number_isSet;
}

bool OAICreate_label_request_body::is_rma_number_Valid() const{
    return m_rma_number_isValid;
}

QString OAICreate_label_request_body::getServiceCode() const {
    return m_service_code;
}
void OAICreate_label_request_body::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAICreate_label_request_body::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAICreate_label_request_body::is_service_code_Valid() const{
    return m_service_code_isValid;
}

QDateTime OAICreate_label_request_body::getShipDate() const {
    return m_ship_date;
}
void OAICreate_label_request_body::setShipDate(const QDateTime &ship_date) {
    m_ship_date = ship_date;
    m_ship_date_isSet = true;
}

bool OAICreate_label_request_body::is_ship_date_Set() const{
    return m_ship_date_isSet;
}

bool OAICreate_label_request_body::is_ship_date_Valid() const{
    return m_ship_date_isValid;
}

OAIShipment OAICreate_label_request_body::getShipment() const {
    return m_shipment;
}
void OAICreate_label_request_body::setShipment(const OAIShipment &shipment) {
    m_shipment = shipment;
    m_shipment_isSet = true;
}

bool OAICreate_label_request_body::is_shipment_Set() const{
    return m_shipment_isSet;
}

bool OAICreate_label_request_body::is_shipment_Valid() const{
    return m_shipment_isValid;
}

OAIMonetary_value OAICreate_label_request_body::getShipmentCost() const {
    return m_shipment_cost;
}
void OAICreate_label_request_body::setShipmentCost(const OAIMonetary_value &shipment_cost) {
    m_shipment_cost = shipment_cost;
    m_shipment_cost_isSet = true;
}

bool OAICreate_label_request_body::is_shipment_cost_Set() const{
    return m_shipment_cost_isSet;
}

bool OAICreate_label_request_body::is_shipment_cost_Valid() const{
    return m_shipment_cost_isValid;
}

QString OAICreate_label_request_body::getShipmentId() const {
    return m_shipment_id;
}
void OAICreate_label_request_body::setShipmentId(const QString &shipment_id) {
    m_shipment_id = shipment_id;
    m_shipment_id_isSet = true;
}

bool OAICreate_label_request_body::is_shipment_id_Set() const{
    return m_shipment_id_isSet;
}

bool OAICreate_label_request_body::is_shipment_id_Valid() const{
    return m_shipment_id_isValid;
}

OAILabel_status OAICreate_label_request_body::getStatus() const {
    return m_status;
}
void OAICreate_label_request_body::setStatus(const OAILabel_status &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAICreate_label_request_body::is_status_Set() const{
    return m_status_isSet;
}

bool OAICreate_label_request_body::is_status_Valid() const{
    return m_status_isValid;
}

bool OAICreate_label_request_body::isTestLabel() const {
    return m_test_label;
}
void OAICreate_label_request_body::setTestLabel(const bool &test_label) {
    m_test_label = test_label;
    m_test_label_isSet = true;
}

bool OAICreate_label_request_body::is_test_label_Set() const{
    return m_test_label_isSet;
}

bool OAICreate_label_request_body::is_test_label_Valid() const{
    return m_test_label_isValid;
}

bool OAICreate_label_request_body::isTrackable() const {
    return m_trackable;
}
void OAICreate_label_request_body::setTrackable(const bool &trackable) {
    m_trackable = trackable;
    m_trackable_isSet = true;
}

bool OAICreate_label_request_body::is_trackable_Set() const{
    return m_trackable_isSet;
}

bool OAICreate_label_request_body::is_trackable_Valid() const{
    return m_trackable_isValid;
}

QString OAICreate_label_request_body::getTrackingNumber() const {
    return m_tracking_number;
}
void OAICreate_label_request_body::setTrackingNumber(const QString &tracking_number) {
    m_tracking_number = tracking_number;
    m_tracking_number_isSet = true;
}

bool OAICreate_label_request_body::is_tracking_number_Set() const{
    return m_tracking_number_isSet;
}

bool OAICreate_label_request_body::is_tracking_number_Valid() const{
    return m_tracking_number_isValid;
}

OAITracking_status OAICreate_label_request_body::getTrackingStatus() const {
    return m_tracking_status;
}
void OAICreate_label_request_body::setTrackingStatus(const OAITracking_status &tracking_status) {
    m_tracking_status = tracking_status;
    m_tracking_status_isSet = true;
}

bool OAICreate_label_request_body::is_tracking_status_Set() const{
    return m_tracking_status_isSet;
}

bool OAICreate_label_request_body::is_tracking_status_Valid() const{
    return m_tracking_status_isValid;
}

OAIValidate_address OAICreate_label_request_body::getValidateAddress() const {
    return m_validate_address;
}
void OAICreate_label_request_body::setValidateAddress(const OAIValidate_address &validate_address) {
    m_validate_address = validate_address;
    m_validate_address_isSet = true;
}

bool OAICreate_label_request_body::is_validate_address_Set() const{
    return m_validate_address_isSet;
}

bool OAICreate_label_request_body::is_validate_address_Valid() const{
    return m_validate_address_isValid;
}

bool OAICreate_label_request_body::isVoided() const {
    return m_voided;
}
void OAICreate_label_request_body::setVoided(const bool &voided) {
    m_voided = voided;
    m_voided_isSet = true;
}

bool OAICreate_label_request_body::is_voided_Set() const{
    return m_voided_isSet;
}

bool OAICreate_label_request_body::is_voided_Valid() const{
    return m_voided_isValid;
}

QDateTime OAICreate_label_request_body::getVoidedAt() const {
    return m_voided_at;
}
void OAICreate_label_request_body::setVoidedAt(const QDateTime &voided_at) {
    m_voided_at = voided_at;
    m_voided_at_isSet = true;
}

bool OAICreate_label_request_body::is_voided_at_Set() const{
    return m_voided_at_isSet;
}

bool OAICreate_label_request_body::is_voided_at_Valid() const{
    return m_voided_at_isValid;
}

bool OAICreate_label_request_body::isSet() const {
...
bool OAICreate_label_request_body::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_shipment_isValid && true;
}
