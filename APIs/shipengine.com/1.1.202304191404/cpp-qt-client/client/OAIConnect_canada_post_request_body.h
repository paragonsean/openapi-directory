...
/*
 * OAIConnect_canada_post_request_body.h
 *
 * A Canada Post account information request body
 */

#ifndef OAIConnect_canada_post_request_body_H
#define OAIConnect_canada_post_request_body_H
...
class OAIConnect_canada_post_request_body : public OAIObject {
public:
    OAIConnect_canada_post_request_body();
    OAIConnect_canada_post_request_body(QString json);
    ~OAIConnect_canada_post_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnect_canada_post_request_body)

#endif // OAIConnect_canada_post_request_body_H
