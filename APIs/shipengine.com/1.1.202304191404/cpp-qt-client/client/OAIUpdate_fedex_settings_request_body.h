...
/*
 * OAIUpdate_fedex_settings_request_body.h
 *
 * An update Fedex settings request body
 */

#ifndef OAIUpdate_fedex_settings_request_body_H
#define OAIUpdate_fedex_settings_request_body_H
...
class OAIUpdate_fedex_settings_request_body : public OAIObject {
public:
    OAIUpdate_fedex_settings_request_body();
    OAIUpdate_fedex_settings_request_body(QString json);
    ~OAIUpdate_fedex_settings_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdate_fedex_settings_request_body)

#endif // OAIUpdate_fedex_settings_request_body_H
