...
public:
    ...
    /**
    * @param[in]  subdir QString [required]
    ...
    */
    virtual void downloadFile(const QString &subdir, const QString &filename, const QString &dir, const ::OpenAPI::OptionalParam<QString> &download = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &rotation = ::OpenAPI::OptionalParam<qint32>());
