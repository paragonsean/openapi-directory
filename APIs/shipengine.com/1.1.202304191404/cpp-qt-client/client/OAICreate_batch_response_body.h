...
/*
 * OAICreate_batch_response_body.h
 *
 * A create batch response body
 */

#ifndef OAICreate_batch_response_body_H
#define OAICreate_batch_response_body_H
...
class OAICreate_batch_response_body : public OAIObject {
public:
    OAICreate_batch_response_body();
    OAICreate_batch_response_body(QString json);
    ~OAICreate_batch_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreate_batch_response_body)

#endif // OAICreate_batch_response_body_H
