...
/*
 * OAIGet_service_points_request_body_address.h
 *
 * Structured address to search by.
 */

#ifndef OAIGet_service_points_request_body_address_H
#define OAIGet_service_points_request_body_address_H
...
class OAIGet_service_points_request_body_address : public OAIObject {
public:
    OAIGet_service_points_request_body_address();
    OAIGet_service_points_request_body_address(QString json);
    ~OAIGet_service_points_request_body_address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGet_service_points_request_body_address)

#endif // OAIGet_service_points_request_body_address_H
