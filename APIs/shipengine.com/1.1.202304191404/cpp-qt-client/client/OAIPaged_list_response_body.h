...
#ifndef OAIPaged_list_response_body_H
#define OAIPaged_list_response_body_H
...
class OAIPaged_list_response_body : public OAIObject {
public:
    OAIPaged_list_response_body();
    OAIPaged_list_response_body(QString json);
    ~OAIPaged_list_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPaged_list_response_body)

#endif // OAIPaged_list_response_body_H
