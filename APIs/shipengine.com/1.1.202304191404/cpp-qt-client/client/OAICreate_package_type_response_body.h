...
/*
 * OAICreate_package_type_response_body.h
 *
 * A create package type response body
 */

#ifndef OAICreate_package_type_response_body_H
#define OAICreate_package_type_response_body_H
...
class OAICreate_package_type_response_body : public OAIObject {
public:
    OAICreate_package_type_response_body();
    OAICreate_package_type_response_body(QString json);
    ~OAICreate_package_type_response_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreate_package_type_response_body)

#endif // OAICreate_package_type_response_body_H
