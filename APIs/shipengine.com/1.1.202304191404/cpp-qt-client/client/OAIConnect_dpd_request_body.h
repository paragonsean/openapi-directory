...
/*
 * OAIConnect_dpd_request_body.h
 *
 * A DPD account information request body
 */

#ifndef OAIConnect_dpd_request_body_H
#define OAIConnect_dpd_request_body_H
...
class OAIConnect_dpd_request_body : public OAIObject {
public:
    OAIConnect_dpd_request_body();
    OAIConnect_dpd_request_body(QString json);
    ~OAIConnect_dpd_request_body() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnect_dpd_request_body)

#endif // OAIConnect_dpd_request_body_H
