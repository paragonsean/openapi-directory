...
#include "OAIDhl_express_settings_response_body.h"
...
OAIDhl_express_settings_response_body::OAIDhl_express_settings_response_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDhl_express_settings_response_body::OAIDhl_express_settings_response_body() {
    this->initializeModel();
}

OAIDhl_express_settings_response_body::~OAIDhl_express_settings_response_body() {}

void OAIDhl_express_settings_response_body::initializeModel() {
...
void OAIDhl_express_settings_response_body::fromJson(QString jsonString) {
...
void OAIDhl_express_settings_response_body::fromJsonObject(QJsonObject json) {
...
QString OAIDhl_express_settings_response_body::asJson() const {
...
QJsonObject OAIDhl_express_settings_response_body::asJsonObject() const {
    QJsonObject obj;
...
bool OAIDhl_express_settings_response_body::isIsPrimaryAccount() const {
    return m_is_primary_account;
}
void OAIDhl_express_settings_response_body::setIsPrimaryAccount(const bool &is_primary_account) {
    m_is_primary_account = is_primary_account;
    m_is_primary_account_isSet = true;
}

bool OAIDhl_express_settings_response_body::is_is_primary_account_Set() const{
    return m_is_primary_account_isSet;
}

bool OAIDhl_express_settings_response_body::is_is_primary_account_Valid() const{
    return m_is_primary_account_isValid;
}

QString OAIDhl_express_settings_response_body::getNickname() const {
    return m_nickname;
}
void OAIDhl_express_settings_response_body::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAIDhl_express_settings_response_body::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAIDhl_express_settings_response_body::is_nickname_Valid() const{
    return m_nickname_isValid;
}

bool OAIDhl_express_settings_response_body::isShouldHideAccountNumberOnArchiveDoc() const {
    return m_should_hide_account_number_on_archive_doc;
}
void OAIDhl_express_settings_response_body::setShouldHideAccountNumberOnArchiveDoc(const bool &should_hide_account_number_on_archive_doc) {
...
bool OAIDhl_express_settings_response_body::is_should_hide_account_number_on_archive_doc_Set() const{
    return m_should_hide_account_number_on_archive_doc_isSet;
}

bool OAIDhl_express_settings_response_body::is_should_hide_account_number_on_archive_doc_Valid() const{
    return m_should_hide_account_number_on_archive_doc_isValid;
}

bool OAIDhl_express_settings_response_body::isSet() const {
...
bool OAIDhl_express_settings_response_body::isValid() const {
