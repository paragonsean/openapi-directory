...
OAIAddress_residential_indicator OAIAddress::getAddressResidentialIndicator() const {
    return m_address_residential_indicator;
}
void OAIAddress::setAddressResidentialIndicator(const OAIAddress_residential_indicator &address_residential_indicator) {
    m_address_residential_indicator = address_residential_indicator;
    m_address_residential_indicator_isSet = true;
}

bool OAIAddress::is_address_residential_indicator_Set() const{
    return m_address_residential_indicator_isSet;
}

bool OAIAddress::is_address_residential_indicator_Valid() const{
    return m_address_residential_indicator_isValid;
}

QString OAIAddress::getCityLocality() const {
    return m_city_locality;
}
void OAIAddress::setCityLocality(const QString &city_locality) {
    m_city_locality = city_locality;
    m_city_locality_isSet = true;
}

bool OAIAddress::is_city_locality_Set() const{
    return m_city_locality_isSet;
}

bool OAIAddress::is_city_locality_Valid() const{
...
QString OAIAddress::getStateProvince() const {
    return m_state_province;
}
void OAIAddress::setStateProvince(const QString &state_province) {
    m_state_province = state_province;
    m_state_province_isSet = true;
}

bool OAIAddress::is_state_province_Set() const{
    return m_state_province_isSet;
}

bool OAIAddress::is_state_province_Valid() const{
