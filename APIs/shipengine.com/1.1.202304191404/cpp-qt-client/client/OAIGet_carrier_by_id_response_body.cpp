...
OAIGet_carrier_by_id_response_body::OAIGet_carrier_by_id_response_body(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGet_carrier_by_id_response_body::OAIGet_carrier_by_id_response_body() {
    this->initializeModel();
}

OAIGet_carrier_by_id_response_body::~OAIGet_carrier_by_id_response_body() {}

void OAIGet_carrier_by_id_response_body::initializeModel() {
...
void OAIGet_carrier_by_id_response_body::fromJson(QString jsonString) {
...
void OAIGet_carrier_by_id_response_body::fromJsonObject(QJsonObject json) {
...
QString OAIGet_carrier_by_id_response_body::asJson() const {
...
QJsonObject OAIGet_carrier_by_id_response_body::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGet_carrier_by_id_response_body::getAccountNumber() const {
    return m_account_number;
}
void OAIGet_carrier_by_id_response_body::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_account_number_Valid() const{
    return m_account_number_isValid;
}

double OAIGet_carrier_by_id_response_body::getBalance() const {
    return m_balance;
}
void OAIGet_carrier_by_id_response_body::setBalance(const double &balance) {
    m_balance = balance;
    m_balance_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_balance_Set() const{
    return m_balance_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_balance_Valid() const{
    return m_balance_isValid;
}

QString OAIGet_carrier_by_id_response_body::getCarrierCode() const {
    return m_carrier_code;
}
void OAIGet_carrier_by_id_response_body::setCarrierCode(const QString &carrier_code) {
    m_carrier_code = carrier_code;
    m_carrier_code_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_carrier_code_Set() const{
    return m_carrier_code_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_carrier_code_Valid() const{
    return m_carrier_code_isValid;
}

QString OAIGet_carrier_by_id_response_body::getCarrierId() const {
    return m_carrier_id;
}
void OAIGet_carrier_by_id_response_body::setCarrierId(const QString &carrier_id) {
    m_carrier_id = carrier_id;
    m_carrier_id_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_carrier_id_Set() const{
    return m_carrier_id_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_carrier_id_Valid() const{
    return m_carrier_id_isValid;
}

QString OAIGet_carrier_by_id_response_body::getFriendlyName() const {
    return m_friendly_name;
}
void OAIGet_carrier_by_id_response_body::setFriendlyName(const QString &friendly_name) {
    m_friendly_name = friendly_name;
    m_friendly_name_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_friendly_name_Set() const{
    return m_friendly_name_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_friendly_name_Valid() const{
    return m_friendly_name_isValid;
}

bool OAIGet_carrier_by_id_response_body::isHasMultiPackageSupportingServices() const {
    return m_has_multi_package_supporting_services;
}
void OAIGet_carrier_by_id_response_body::setHasMultiPackageSupportingServices(const bool &has_multi_package_supporting_services) {
...
bool OAIGet_carrier_by_id_response_body::is_has_multi_package_supporting_services_Set() const{
    return m_has_multi_package_supporting_services_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_has_multi_package_supporting_services_Valid() const{
    return m_has_multi_package_supporting_services_isValid;
}

QString OAIGet_carrier_by_id_response_body::getNickname() const {
    return m_nickname;
}
void OAIGet_carrier_by_id_response_body::setNickname(const QString &nickname) {
    m_nickname = nickname;
    m_nickname_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_nickname_Set() const{
    return m_nickname_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_nickname_Valid() const{
    return m_nickname_isValid;
}

QList<OAICarrier_advanced_option> OAIGet_carrier_by_id_response_body::getOptions() const {
    return m_options;
}
void OAIGet_carrier_by_id_response_body::setOptions(const QList<OAICarrier_advanced_option> &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_options_Set() const{
    return m_options_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_options_Valid() const{
    return m_options_isValid;
}

QList<OAIPackage_type> OAIGet_carrier_by_id_response_body::getPackages() const {
    return m_packages;
}
void OAIGet_carrier_by_id_response_body::setPackages(const QList<OAIPackage_type> &packages) {
    m_packages = packages;
    m_packages_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_packages_Set() const{
    return m_packages_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_packages_Valid() const{
    return m_packages_isValid;
}

bool OAIGet_carrier_by_id_response_body::isPrimary() const {
    return m_primary;
}
void OAIGet_carrier_by_id_response_body::setPrimary(const bool &primary) {
    m_primary = primary;
    m_primary_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_primary_Set() const{
    return m_primary_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_primary_Valid() const{
    return m_primary_isValid;
}

bool OAIGet_carrier_by_id_response_body::isRequiresFundedAmount() const {
    return m_requires_funded_amount;
}
void OAIGet_carrier_by_id_response_body::setRequiresFundedAmount(const bool &requires_funded_amount) {
    m_requires_funded_amount = requires_funded_amount;
    m_requires_funded_amount_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_requires_funded_amount_Set() const{
    return m_requires_funded_amount_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_requires_funded_amount_Valid() const{
    return m_requires_funded_amount_isValid;
}

QList<OAIService> OAIGet_carrier_by_id_response_body::getServices() const {
    return m_services;
}
void OAIGet_carrier_by_id_response_body::setServices(const QList<OAIService> &services) {
    m_services = services;
    m_services_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_services_Set() const{
    return m_services_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_services_Valid() const{
    return m_services_isValid;
}

bool OAIGet_carrier_by_id_response_body::isSupportsLabelMessages() const {
    return m_supports_label_messages;
}
void OAIGet_carrier_by_id_response_body::setSupportsLabelMessages(const bool &supports_label_messages) {
    m_supports_label_messages = supports_label_messages;
    m_supports_label_messages_isSet = true;
}

bool OAIGet_carrier_by_id_response_body::is_supports_label_messages_Set() const{
    return m_supports_label_messages_isSet;
}

bool OAIGet_carrier_by_id_response_body::is_supports_label_messages_Valid() const{
    return m_supports_label_messages_isValid;
}

bool OAIGet_carrier_by_id_response_body::isSet() const {
...
bool OAIGet_carrier_by_id_response_body::isValid() const {
