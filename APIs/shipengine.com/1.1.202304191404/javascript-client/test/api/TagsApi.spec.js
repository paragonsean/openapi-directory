...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.TagsApi();
  });
  ...
  describe('TagsApi', function() {
    ...
    describe('renameTag', function() {
      it('should call renameTag successfully', function(done) {
        //uncomment below and update the code to test renameTag
        //instance.renameTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
