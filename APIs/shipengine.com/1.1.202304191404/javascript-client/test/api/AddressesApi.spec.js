...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.AddressesApi();
  });
  ...
  describe('AddressesApi', function() {
    describe('parseAddress', function() {
      it('should call parseAddress successfully', function(done) {
        //uncomment below and update the code to test parseAddress
        //instance.parseAddress(function(error) {
