...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetRateByIdResponseBody();
  });
  ...
  describe('GetRateByIdResponseBody', function() {
    it('should create an instance of GetRateByIdResponseBody', function() {
      // uncomment below and update the code to test GetRateByIdResponseBody
      //var instance = new ShipEngineApi.GetRateByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetRateByIdResponseBody);
    });
