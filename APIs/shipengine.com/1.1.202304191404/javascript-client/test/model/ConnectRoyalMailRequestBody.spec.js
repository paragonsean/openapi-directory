...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectRoyalMailRequestBody();
  });
  ...
  describe('ConnectRoyalMailRequestBody', function() {
    it('should create an instance of ConnectRoyalMailRequestBody', function() {
      // uncomment below and update the code to test ConnectRoyalMailRequestBody
      //var instance = new ShipEngineApi.ConnectRoyalMailRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectRoyalMailRequestBody);
    });
