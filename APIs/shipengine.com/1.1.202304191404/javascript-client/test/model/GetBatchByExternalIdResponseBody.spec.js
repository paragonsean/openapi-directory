...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetBatchByExternalIdResponseBody();
  });
  ...
  describe('GetBatchByExternalIdResponseBody', function() {
    it('should create an instance of GetBatchByExternalIdResponseBody', function() {
      // uncomment below and update the code to test GetBatchByExternalIdResponseBody
      //var instance = new ShipEngineApi.GetBatchByExternalIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetBatchByExternalIdResponseBody);
    });
