...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetAccountSettingsImagesResponseBody();
  });
  ...
  describe('GetAccountSettingsImagesResponseBody', function() {
    it('should create an instance of GetAccountSettingsImagesResponseBody', function() {
      // uncomment below and update the code to test GetAccountSettingsImagesResponseBody
      //var instance = new ShipEngineApi.GetAccountSettingsImagesResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetAccountSettingsImagesResponseBody);
    });
    ...
    it('should have the property imageContentType (base name: "image_content_type")', function() {
      // uncomment below and update the code to test the property imageContentType
      //var instance = new ShipEngineApi.GetAccountSettingsImagesResponseBody();
      //expect(instance).to.be();
    });
