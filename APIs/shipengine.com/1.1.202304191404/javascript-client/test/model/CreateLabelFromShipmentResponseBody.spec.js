...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateLabelFromShipmentResponseBody();
  });
  ...
  describe('CreateLabelFromShipmentResponseBody', function() {
    it('should create an instance of CreateLabelFromShipmentResponseBody', function() {
      // uncomment below and update the code to test CreateLabelFromShipmentResponseBody
      //var instance = new ShipEngineApi.CreateLabelFromShipmentResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateLabelFromShipmentResponseBody);
    });
