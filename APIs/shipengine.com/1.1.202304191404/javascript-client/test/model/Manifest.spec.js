...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.Manifest();
  });
  ...
  describe('Manifest', function() {
    it('should create an instance of Manifest', function() {
      ...
      //var instance = new ShipEngineApi.Manifest();
      //expect(instance).to.be.a(ShipEngineApi.Manifest);
    });
    ...
    it('should have the property manifestDownload (base name: "manifest_download")', function() {
      // uncomment below and update the code to test the property manifestDownload
      //var instance = new ShipEngineApi.Manifest();
      //expect(instance).to.be();
    });

    it('should have the property manifestId (base name: "manifest_id")', function() {
