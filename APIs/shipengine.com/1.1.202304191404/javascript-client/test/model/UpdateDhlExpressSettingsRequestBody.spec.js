...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpdateDhlExpressSettingsRequestBody();
  });
  ...
  describe('UpdateDhlExpressSettingsRequestBody', function() {
    it('should create an instance of UpdateDhlExpressSettingsRequestBody', function() {
      // uncomment below and update the code to test UpdateDhlExpressSettingsRequestBody
      //var instance = new ShipEngineApi.UpdateDhlExpressSettingsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.UpdateDhlExpressSettingsRequestBody);
    });
