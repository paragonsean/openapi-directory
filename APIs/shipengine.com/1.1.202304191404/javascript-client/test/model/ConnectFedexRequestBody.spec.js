...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectFedexRequestBody();
  });
  ...
  describe('ConnectFedexRequestBody', function() {
    it('should create an instance of ConnectFedexRequestBody', function() {
      // uncomment below and update the code to test ConnectFedexRequestBody
      //var instance = new ShipEngineApi.ConnectFedexRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectFedexRequestBody);
    });
