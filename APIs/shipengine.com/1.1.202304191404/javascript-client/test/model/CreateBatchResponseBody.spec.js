...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateBatchResponseBody();
  });
  ...
  describe('CreateBatchResponseBody', function() {
    it('should create an instance of CreateBatchResponseBody', function() {
      // uncomment below and update the code to test CreateBatchResponseBody
      //var instance = new ShipEngineApi.CreateBatchResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateBatchResponseBody);
    });
