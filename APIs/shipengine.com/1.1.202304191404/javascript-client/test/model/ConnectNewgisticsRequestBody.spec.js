...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectNewgisticsRequestBody();
  });
  ...
  describe('ConnectNewgisticsRequestBody', function() {
    it('should create an instance of ConnectNewgisticsRequestBody', function() {
      // uncomment below and update the code to test ConnectNewgisticsRequestBody
      //var instance = new ShipEngineApi.ConnectNewgisticsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectNewgisticsRequestBody);
    });
