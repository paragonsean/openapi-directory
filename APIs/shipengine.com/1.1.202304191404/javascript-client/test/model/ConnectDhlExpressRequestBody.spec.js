...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectDhlExpressRequestBody();
  });
  ...
  describe('ConnectDhlExpressRequestBody', function() {
    it('should create an instance of ConnectDhlExpressRequestBody', function() {
      // uncomment below and update the code to test ConnectDhlExpressRequestBody
      //var instance = new ShipEngineApi.ConnectDhlExpressRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectDhlExpressRequestBody);
    });
