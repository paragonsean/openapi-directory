...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateLabelFromRateResponseBody();
  });
  ...
  describe('CreateLabelFromRateResponseBody', function() {
    it('should create an instance of CreateLabelFromRateResponseBody', function() {
      // uncomment below and update the code to test CreateLabelFromRateResponseBody
      //var instance = new ShipEngineApi.CreateLabelFromRateResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateLabelFromRateResponseBody);
    });
