...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetBatchByIdResponseBody();
  });
  ...
  describe('GetBatchByIdResponseBody', function() {
    it('should create an instance of GetBatchByIdResponseBody', function() {
      // uncomment below and update the code to test GetBatchByIdResponseBody
      //var instance = new ShipEngineApi.GetBatchByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetBatchByIdResponseBody);
    });
