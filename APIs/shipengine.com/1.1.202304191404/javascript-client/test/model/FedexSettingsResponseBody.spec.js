...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.FedexSettingsResponseBody();
  });
  ...
  describe('FedexSettingsResponseBody', function() {
    it('should create an instance of FedexSettingsResponseBody', function() {
      // uncomment below and update the code to test FedexSettingsResponseBody
      //var instance = new ShipEngineApi.FedexSettingsResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.FedexSettingsResponseBody);
    });
