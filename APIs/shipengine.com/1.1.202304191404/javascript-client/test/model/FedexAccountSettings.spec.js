...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.FedexAccountSettings();
  });
  ...
  describe('FedexAccountSettings', function() {
    it('should create an instance of FedexAccountSettings', function() {
      // uncomment below and update the code to test FedexAccountSettings
      //var instance = new ShipEngineApi.FedexAccountSettings();
      //expect(instance).to.be.a(ShipEngineApi.FedexAccountSettings);
    });
