...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateLabelRequestBody();
  });
  ...
  describe('CreateLabelRequestBody', function() {
    it('should create an instance of CreateLabelRequestBody', function() {
      // uncomment below and update the code to test CreateLabelRequestBody
      //var instance = new ShipEngineApi.CreateLabelRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateLabelRequestBody);
    });

    it('should have the property shipFromServicePointId (base name: "ship_from_service_point_id")', function() {
      // uncomment below and update the code to test the property shipFromServicePointId
      //var instance = new ShipEngineApi.CreateLabelRequestBody();
      //expect(instance).to.be();
    });

    it('should have the property shipToServicePointId (base name: "ship_to_service_point_id")', function() {
      // uncomment below and update the code to test the property shipToServicePointId
      //var instance = new ShipEngineApi.CreateLabelRequestBody();
      //expect(instance).to.be();
    });
