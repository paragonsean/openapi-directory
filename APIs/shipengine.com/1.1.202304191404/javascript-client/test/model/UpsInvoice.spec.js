...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpsInvoice();
  });
  ...
  describe('UpsInvoice', function() {
    it('should create an instance of UpsInvoice', function() {
      // uncomment below and update the code to test UpsInvoice
      //var instance = new ShipEngineApi.UpsInvoice();
      //expect(instance).to.be.a(ShipEngineApi.UpsInvoice);
    });

    it('should have the property controlId (base name: "control_id")', function() {
