...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.DeprecatedManifest();
  });
  ...
  describe('DeprecatedManifest', function() {
    it('should create an instance of DeprecatedManifest', function() {
      // uncomment below and update the code to test DeprecatedManifest
      //var instance = new ShipEngineApi.DeprecatedManifest();
      //expect(instance).to.be.a(ShipEngineApi.DeprecatedManifest);
    });
