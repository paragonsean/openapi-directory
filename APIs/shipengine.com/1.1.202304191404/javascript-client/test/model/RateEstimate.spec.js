...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.RateEstimate();
  });
  ...
  describe('RateEstimate', function() {
    it('should create an instance of RateEstimate', function() {
      // uncomment below and update the code to test RateEstimate
      //var instance = new ShipEngineApi.RateEstimate();
      //expect(instance).to.be.a(ShipEngineApi.RateEstimate);
    });
