...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateReturnLabelRequestBody();
  });
  ...
  describe('CreateReturnLabelRequestBody', function() {
    it('should create an instance of CreateReturnLabelRequestBody', function() {
      // uncomment below and update the code to test CreateReturnLabelRequestBody
      //var instance = new ShipEngineApi.CreateReturnLabelRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateReturnLabelRequestBody);
    });
