...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetCarrierByIdResponseBody();
  });
  ...
  describe('GetCarrierByIdResponseBody', function() {
    it('should create an instance of GetCarrierByIdResponseBody', function() {
      // uncomment below and update the code to test GetCarrierByIdResponseBody
      //var instance = new ShipEngineApi.GetCarrierByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetCarrierByIdResponseBody);
    });
