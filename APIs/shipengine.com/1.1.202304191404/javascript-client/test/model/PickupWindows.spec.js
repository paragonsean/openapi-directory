...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.PickupWindows();
  });
  ...
  describe('PickupWindows', function() {
    it('should create an instance of PickupWindows', function() {
      // uncomment below and update the code to test PickupWindows
      //var instance = new ShipEngineApi.PickupWindows();
      //expect(instance).to.be.a(ShipEngineApi.PickupWindows);
    });
