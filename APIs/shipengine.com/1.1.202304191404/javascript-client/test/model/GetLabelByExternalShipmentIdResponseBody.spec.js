...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetLabelByExternalShipmentIdResponseBody();
  });
  ...
  describe('GetLabelByExternalShipmentIdResponseBody', function() {
    it('should create an instance of GetLabelByExternalShipmentIdResponseBody', function() {
      // uncomment below and update the code to test GetLabelByExternalShipmentIdResponseBody
      //var instance = new ShipEngineApi.GetLabelByExternalShipmentIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetLabelByExternalShipmentIdResponseBody);
    });
