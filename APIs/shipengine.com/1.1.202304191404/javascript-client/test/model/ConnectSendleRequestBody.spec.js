...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectSendleRequestBody();
  });
  ...
  describe('ConnectSendleRequestBody', function() {
    it('should create an instance of ConnectSendleRequestBody', function() {
      // uncomment below and update the code to test ConnectSendleRequestBody
      //var instance = new ShipEngineApi.ConnectSendleRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectSendleRequestBody);
    });
