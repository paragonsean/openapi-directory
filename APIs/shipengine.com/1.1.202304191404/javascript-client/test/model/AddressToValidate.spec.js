...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.AddressToValidate();
  });
  ...
  describe('AddressToValidate', function() {
    it('should create an instance of AddressToValidate', function() {
      // uncomment below and update the code to test AddressToValidate
      //var instance = new ShipEngineApi.AddressToValidate();
      //expect(instance).to.be.a(ShipEngineApi.AddressToValidate);
    });
