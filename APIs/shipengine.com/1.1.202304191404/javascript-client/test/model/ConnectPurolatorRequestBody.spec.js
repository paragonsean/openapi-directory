...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectPurolatorRequestBody();
  });
  ...
  describe('ConnectPurolatorRequestBody', function() {
    it('should create an instance of ConnectPurolatorRequestBody', function() {
      // uncomment below and update the code to test ConnectPurolatorRequestBody
      //var instance = new ShipEngineApi.ConnectPurolatorRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectPurolatorRequestBody);
    });
