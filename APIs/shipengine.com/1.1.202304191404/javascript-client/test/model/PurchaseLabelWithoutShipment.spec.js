...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.PurchaseLabelWithoutShipment();
  });
  ...
  describe('PurchaseLabelWithoutShipment', function() {
    it('should create an instance of PurchaseLabelWithoutShipment', function() {
      // uncomment below and update the code to test PurchaseLabelWithoutShipment
      //var instance = new ShipEngineApi.PurchaseLabelWithoutShipment();
      //expect(instance).to.be.a(ShipEngineApi.PurchaseLabelWithoutShipment);
    });
