...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpdateUpsSettingsRequestBody();
  });
  ...
  describe('UpdateUpsSettingsRequestBody', function() {
    it('should create an instance of UpdateUpsSettingsRequestBody', function() {
      // uncomment below and update the code to test UpdateUpsSettingsRequestBody
      //var instance = new ShipEngineApi.UpdateUpsSettingsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.UpdateUpsSettingsRequestBody);
    });
