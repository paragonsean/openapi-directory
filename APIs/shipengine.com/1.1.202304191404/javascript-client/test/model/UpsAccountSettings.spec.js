...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpsAccountSettings();
  });
  ...
  describe('UpsAccountSettings', function() {
    it('should create an instance of UpsAccountSettings', function() {
      // uncomment below and update the code to test UpsAccountSettings
      //var instance = new ShipEngineApi.UpsAccountSettings();
      //expect(instance).to.be.a(ShipEngineApi.UpsAccountSettings);
    });
