...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.Carrier();
  });
  ...
  describe('Carrier', function() {
    it('should create an instance of Carrier', function() {
      ...
      //var instance = new ShipEngineApi.Carrier();
      //expect(instance).to.be.a(ShipEngineApi.Carrier);
    });
    ...
    it('should have the property hasMultiPackageSupportingServices (base name: "has_multi_package_supporting_services")', function() {
      // uncomment below and update the code to test the property hasMultiPackageSupportingServices
      //var instance = new ShipEngineApi.Carrier();
      //expect(instance).to.be();
    });
    ...
    it('should have the property requiresFundedAmount (base name: "requires_funded_amount")', function() {
      // uncomment below and update the code to test the property requiresFundedAmount
      //var instance = new ShipEngineApi.Carrier();
      //expect(instance).to.be();
    });
    ...
    it('should have the property supportsLabelMessages (base name: "supports_label_messages")', function() {
      // uncomment below and update the code to test the property supportsLabelMessages
      //var instance = new ShipEngineApi.Carrier();
      //expect(instance).to.be();
    });
