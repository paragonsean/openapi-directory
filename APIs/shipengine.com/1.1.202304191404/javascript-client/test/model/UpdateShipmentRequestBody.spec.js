...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpdateShipmentRequestBody();
  });
  ...
  describe('UpdateShipmentRequestBody', function() {
    it('should create an instance of UpdateShipmentRequestBody', function() {
      // uncomment below and update the code to test UpdateShipmentRequestBody
      //var instance = new ShipEngineApi.UpdateShipmentRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.UpdateShipmentRequestBody);
    });
