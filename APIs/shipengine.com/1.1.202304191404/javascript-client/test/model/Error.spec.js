...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.Error();
  });
  ...
  describe('Error', function() {
    it('should create an instance of Error', function() {
      ...
      //var instance = new ShipEngineApi.Error();
      //expect(instance).to.be.a(ShipEngineApi.Error);
    });
    ...
    it('should have the property errorSource (base name: "error_source")', function() {
