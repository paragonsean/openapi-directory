...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectFirstmileRequestBody();
  });
  ...
  describe('ConnectFirstmileRequestBody', function() {
    it('should create an instance of ConnectFirstmileRequestBody', function() {
      // uncomment below and update the code to test ConnectFirstmileRequestBody
      //var instance = new ShipEngineApi.ConnectFirstmileRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectFirstmileRequestBody);
    });
