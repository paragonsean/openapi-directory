...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateManifestRequestBody();
  });
  ...
  describe('CreateManifestRequestBody', function() {
    it('should create an instance of CreateManifestRequestBody', function() {
      // uncomment below and update the code to test CreateManifestRequestBody
      //var instance = new ShipEngineApi.CreateManifestRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateManifestRequestBody);
    });
