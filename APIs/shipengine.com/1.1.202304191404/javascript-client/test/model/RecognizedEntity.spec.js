...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.RecognizedEntity();
  });
  ...
  describe('RecognizedEntity', function() {
    it('should create an instance of RecognizedEntity', function() {
      // uncomment below and update the code to test RecognizedEntity
      //var instance = new ShipEngineApi.RecognizedEntity();
      //expect(instance).to.be.a(ShipEngineApi.RecognizedEntity);
    });
