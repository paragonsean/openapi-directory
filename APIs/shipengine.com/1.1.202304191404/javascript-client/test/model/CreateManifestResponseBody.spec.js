...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateManifestResponseBody();
  });
  ...
  describe('CreateManifestResponseBody', function() {
    it('should create an instance of CreateManifestResponseBody', function() {
      // uncomment below and update the code to test CreateManifestResponseBody
      //var instance = new ShipEngineApi.CreateManifestResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateManifestResponseBody);
    });
