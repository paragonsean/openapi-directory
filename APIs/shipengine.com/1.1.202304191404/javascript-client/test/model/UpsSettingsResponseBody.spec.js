...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpsSettingsResponseBody();
  });
  ...
  describe('UpsSettingsResponseBody', function() {
    it('should create an instance of UpsSettingsResponseBody', function() {
      // uncomment below and update the code to test UpsSettingsResponseBody
      //var instance = new ShipEngineApi.UpsSettingsResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.UpsSettingsResponseBody);
    });
