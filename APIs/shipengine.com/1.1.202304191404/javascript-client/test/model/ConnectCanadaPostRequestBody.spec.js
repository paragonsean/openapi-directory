...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectCanadaPostRequestBody();
  });
  ...
  describe('ConnectCanadaPostRequestBody', function() {
    it('should create an instance of ConnectCanadaPostRequestBody', function() {
      // uncomment below and update the code to test ConnectCanadaPostRequestBody
      //var instance = new ShipEngineApi.ConnectCanadaPostRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectCanadaPostRequestBody);
    });
