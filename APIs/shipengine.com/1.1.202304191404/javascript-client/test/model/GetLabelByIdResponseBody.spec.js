...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetLabelByIdResponseBody();
  });
  ...
  describe('GetLabelByIdResponseBody', function() {
    it('should create an instance of GetLabelByIdResponseBody', function() {
      // uncomment below and update the code to test GetLabelByIdResponseBody
      //var instance = new ShipEngineApi.GetLabelByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetLabelByIdResponseBody);
    });
