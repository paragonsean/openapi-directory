...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateReturnLabelResponseBody();
  });
  ...
  describe('CreateReturnLabelResponseBody', function() {
    it('should create an instance of CreateReturnLabelResponseBody', function() {
      // uncomment below and update the code to test CreateReturnLabelResponseBody
      //var instance = new ShipEngineApi.CreateReturnLabelResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateReturnLabelResponseBody);
    });
