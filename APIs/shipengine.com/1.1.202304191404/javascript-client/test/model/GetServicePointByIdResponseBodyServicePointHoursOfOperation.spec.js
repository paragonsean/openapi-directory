...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetServicePointByIdResponseBodyServicePointHoursOfOperation();
  });
  ...
  describe('GetServicePointByIdResponseBodyServicePointHoursOfOperation', function() {
    it('should create an instance of GetServicePointByIdResponseBodyServicePointHoursOfOperation', function() {
      // uncomment below and update the code to test GetServicePointByIdResponseBodyServicePointHoursOfOperation
      //var instance = new ShipEngineApi.GetServicePointByIdResponseBodyServicePointHoursOfOperation();
      //expect(instance).to.be.a(ShipEngineApi.GetServicePointByIdResponseBodyServicePointHoursOfOperation);
    });
