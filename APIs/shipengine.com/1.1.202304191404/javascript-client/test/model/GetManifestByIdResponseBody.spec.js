...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetManifestByIdResponseBody();
  });
  ...
  describe('GetManifestByIdResponseBody', function() {
    it('should create an instance of GetManifestByIdResponseBody', function() {
      // uncomment below and update the code to test GetManifestByIdResponseBody
      //var instance = new ShipEngineApi.GetManifestByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetManifestByIdResponseBody);
    });
