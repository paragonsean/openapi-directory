...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectDhlEcommerceRequestBody();
  });
  ...
  describe('ConnectDhlEcommerceRequestBody', function() {
    it('should create an instance of ConnectDhlEcommerceRequestBody', function() {
      // uncomment below and update the code to test ConnectDhlEcommerceRequestBody
      //var instance = new ShipEngineApi.ConnectDhlEcommerceRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectDhlEcommerceRequestBody);
    });
