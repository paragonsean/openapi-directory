...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.DhlExpressAccountSettings();
  });
  ...
  describe('DhlExpressAccountSettings', function() {
    it('should create an instance of DhlExpressAccountSettings', function() {
      // uncomment below and update the code to test DhlExpressAccountSettings
      //var instance = new ShipEngineApi.DhlExpressAccountSettings();
      //expect(instance).to.be.a(ShipEngineApi.DhlExpressAccountSettings);
    });
