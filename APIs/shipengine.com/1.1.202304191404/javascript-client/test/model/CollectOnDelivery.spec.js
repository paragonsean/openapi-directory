...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CollectOnDelivery();
  });
  ...
  describe('CollectOnDelivery', function() {
    it('should create an instance of CollectOnDelivery', function() {
      // uncomment below and update the code to test CollectOnDelivery
      //var instance = new ShipEngineApi.CollectOnDelivery();
      //expect(instance).to.be.a(ShipEngineApi.CollectOnDelivery);
    });
