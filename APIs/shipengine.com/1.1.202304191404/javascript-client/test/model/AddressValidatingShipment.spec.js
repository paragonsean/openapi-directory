...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.AddressValidatingShipment();
  });
  ...
  describe('AddressValidatingShipment', function() {
    it('should create an instance of AddressValidatingShipment', function() {
      // uncomment below and update the code to test AddressValidatingShipment
      //var instance = new ShipEngineApi.AddressValidatingShipment();
      //expect(instance).to.be.a(ShipEngineApi.AddressValidatingShipment);
    });
