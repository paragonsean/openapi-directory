...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.AccountSettingsImages();
  });
  ...
  describe('AccountSettingsImages', function() {
    it('should create an instance of AccountSettingsImages', function() {
      // uncomment below and update the code to test AccountSettingsImages
      //var instance = new ShipEngineApi.AccountSettingsImages();
      //expect(instance).to.be.a(ShipEngineApi.AccountSettingsImages);
    });
