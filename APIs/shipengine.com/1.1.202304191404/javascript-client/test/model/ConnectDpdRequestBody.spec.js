...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectDpdRequestBody();
  });
  ...
  describe('ConnectDpdRequestBody', function() {
    it('should create an instance of ConnectDpdRequestBody', function() {
      // uncomment below and update the code to test ConnectDpdRequestBody
      //var instance = new ShipEngineApi.ConnectDpdRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectDpdRequestBody);
    });
