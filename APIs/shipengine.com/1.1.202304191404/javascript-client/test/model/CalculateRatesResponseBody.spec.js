...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CalculateRatesResponseBody();
  });
  ...
  describe('CalculateRatesResponseBody', function() {
    it('should create an instance of CalculateRatesResponseBody', function() {
      // uncomment below and update the code to test CalculateRatesResponseBody
      //var instance = new ShipEngineApi.CalculateRatesResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.CalculateRatesResponseBody);
    });
    ...
    it('should have the property rateResponse (base name: "rate_response")', function() {
      // uncomment below and update the code to test the property rateResponse
      //var instance = new ShipEngineApi.CalculateRatesResponseBody();
      //expect(instance).to.be();
    });
