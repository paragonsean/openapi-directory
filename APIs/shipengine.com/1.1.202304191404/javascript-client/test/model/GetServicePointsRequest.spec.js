...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetServicePointsRequest();
  });
  ...
  describe('GetServicePointsRequest', function() {
    it('should create an instance of GetServicePointsRequest', function() {
      // uncomment below and update the code to test GetServicePointsRequest
      //var instance = new ShipEngineApi.GetServicePointsRequest();
      //expect(instance).to.be.a(ShipEngineApi.GetServicePointsRequest);
    });
    ...
    it('should have the property addressQuery (base name: "address_query")', function() {
      // uncomment below and update the code to test the property addressQuery
      //var instance = new ShipEngineApi.GetServicePointsRequest();
      //expect(instance).to.be();
    });
