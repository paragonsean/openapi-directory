...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.DhlExpressSettingsResponseBody();
  });
  ...
  describe('DhlExpressSettingsResponseBody', function() {
    it('should create an instance of DhlExpressSettingsResponseBody', function() {
      // uncomment below and update the code to test DhlExpressSettingsResponseBody
      //var instance = new ShipEngineApi.DhlExpressSettingsResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.DhlExpressSettingsResponseBody);
    });
