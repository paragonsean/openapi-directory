...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpdateFedexSettingsRequestBody();
  });
  ...
  describe('UpdateFedexSettingsRequestBody', function() {
    it('should create an instance of UpdateFedexSettingsRequestBody', function() {
      // uncomment below and update the code to test UpdateFedexSettingsRequestBody
      //var instance = new ShipEngineApi.UpdateFedexSettingsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.UpdateFedexSettingsRequestBody);
    });
