...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetCarrierSettingsResponseBody();
  });
  ...
  describe('GetCarrierSettingsResponseBody', function() {
    it('should create an instance of GetCarrierSettingsResponseBody', function() {
      // uncomment below and update the code to test GetCarrierSettingsResponseBody
      //var instance = new ShipEngineApi.GetCarrierSettingsResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetCarrierSettingsResponseBody);
    });
