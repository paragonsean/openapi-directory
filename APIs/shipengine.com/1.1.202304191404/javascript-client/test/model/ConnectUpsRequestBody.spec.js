...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectUpsRequestBody();
  });
  ...
  describe('ConnectUpsRequestBody', function() {
    it('should create an instance of ConnectUpsRequestBody', function() {
      // uncomment below and update the code to test ConnectUpsRequestBody
      //var instance = new ShipEngineApi.ConnectUpsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectUpsRequestBody);
    });
