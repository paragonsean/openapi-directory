...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectOntracRequestBody();
  });
  ...
  describe('ConnectOntracRequestBody', function() {
    it('should create an instance of ConnectOntracRequestBody', function() {
      // uncomment below and update the code to test ConnectOntracRequestBody
      //var instance = new ShipEngineApi.ConnectOntracRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectOntracRequestBody);
    });
