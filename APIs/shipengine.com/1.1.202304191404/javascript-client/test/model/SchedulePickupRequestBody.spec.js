...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.SchedulePickupRequestBody();
  });
  ...
  describe('SchedulePickupRequestBody', function() {
    it('should create an instance of SchedulePickupRequestBody', function() {
      // uncomment below and update the code to test SchedulePickupRequestBody
      //var instance = new ShipEngineApi.SchedulePickupRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.SchedulePickupRequestBody);
    });
