...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.PickupWindow();
  });
  ...
  describe('PickupWindow', function() {
    it('should create an instance of PickupWindow', function() {
      // uncomment below and update the code to test PickupWindow
      //var instance = new ShipEngineApi.PickupWindow();
      //expect(instance).to.be.a(ShipEngineApi.PickupWindow);
    });
