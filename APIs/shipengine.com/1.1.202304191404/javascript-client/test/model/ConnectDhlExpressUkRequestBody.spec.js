...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectDhlExpressUkRequestBody();
  });
  ...
  describe('ConnectDhlExpressUkRequestBody', function() {
    it('should create an instance of ConnectDhlExpressUkRequestBody', function() {
      // uncomment below and update the code to test ConnectDhlExpressUkRequestBody
      //var instance = new ShipEngineApi.ConnectDhlExpressUkRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectDhlExpressUkRequestBody);
    });
