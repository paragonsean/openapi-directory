...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectAsendiaRequestBody();
  });
  ...
  describe('ConnectAsendiaRequestBody', function() {
    it('should create an instance of ConnectAsendiaRequestBody', function() {
      // uncomment below and update the code to test ConnectAsendiaRequestBody
      //var instance = new ShipEngineApi.ConnectAsendiaRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectAsendiaRequestBody);
    });
