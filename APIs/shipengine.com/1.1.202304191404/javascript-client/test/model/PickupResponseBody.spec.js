...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.PickupResponseBody();
  });
  ...
  describe('PickupResponseBody', function() {
    it('should create an instance of PickupResponseBody', function() {
      // uncomment below and update the code to test PickupResponseBody
      //var instance = new ShipEngineApi.PickupResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.PickupResponseBody);
    });
