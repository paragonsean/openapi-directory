...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateLabelFromRateRequestBody();
  });
  ...
  describe('CreateLabelFromRateRequestBody', function() {
    it('should create an instance of CreateLabelFromRateRequestBody', function() {
      // uncomment below and update the code to test CreateLabelFromRateRequestBody
      //var instance = new ShipEngineApi.CreateLabelFromRateRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateLabelFromRateRequestBody);
    });
