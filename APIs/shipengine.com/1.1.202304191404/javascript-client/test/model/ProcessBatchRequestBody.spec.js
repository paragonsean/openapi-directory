...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ProcessBatchRequestBody();
  });
  ...
  describe('ProcessBatchRequestBody', function() {
    it('should create an instance of ProcessBatchRequestBody', function() {
      // uncomment below and update the code to test ProcessBatchRequestBody
      //var instance = new ShipEngineApi.ProcessBatchRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ProcessBatchRequestBody);
    });
