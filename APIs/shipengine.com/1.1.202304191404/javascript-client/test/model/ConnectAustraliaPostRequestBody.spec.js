...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectAustraliaPostRequestBody();
  });
  ...
  describe('ConnectAustraliaPostRequestBody', function() {
    it('should create an instance of ConnectAustraliaPostRequestBody', function() {
      // uncomment below and update the code to test ConnectAustraliaPostRequestBody
      //var instance = new ShipEngineApi.ConnectAustraliaPostRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectAustraliaPostRequestBody);
    });
