...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.UpdateAccountSettingsImageRequestBody();
  });
  ...
  describe('UpdateAccountSettingsImageRequestBody', function() {
    it('should create an instance of UpdateAccountSettingsImageRequestBody', function() {
      // uncomment below and update the code to test UpdateAccountSettingsImageRequestBody
      //var instance = new ShipEngineApi.UpdateAccountSettingsImageRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.UpdateAccountSettingsImageRequestBody);
    });
