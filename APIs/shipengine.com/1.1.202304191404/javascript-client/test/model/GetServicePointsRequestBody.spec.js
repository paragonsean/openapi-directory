...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetServicePointsRequestBody();
  });
  ...
  describe('GetServicePointsRequestBody', function() {
    it('should create an instance of GetServicePointsRequestBody', function() {
      // uncomment below and update the code to test GetServicePointsRequestBody
      //var instance = new ShipEngineApi.GetServicePointsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.GetServicePointsRequestBody);
    });
