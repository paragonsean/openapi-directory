...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectFedexUkRequestBody();
  });
  ...
  describe('ConnectFedexUkRequestBody', function() {
    it('should create an instance of ConnectFedexUkRequestBody', function() {
      // uncomment below and update the code to test ConnectFedexUkRequestBody
      //var instance = new ShipEngineApi.ConnectFedexUkRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectFedexUkRequestBody);
    });
