...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.FedexAccountSettingsRequestBody();
  });
  ...
  describe('FedexAccountSettingsRequestBody', function() {
    it('should create an instance of FedexAccountSettingsRequestBody', function() {
      // uncomment below and update the code to test FedexAccountSettingsRequestBody
      //var instance = new ShipEngineApi.FedexAccountSettingsRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.FedexAccountSettingsRequestBody);
    });
