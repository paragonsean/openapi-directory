...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.CreateManifestByObjectRequestBody();
  });
  ...
  describe('CreateManifestByObjectRequestBody', function() {
    it('should create an instance of CreateManifestByObjectRequestBody', function() {
      // uncomment below and update the code to test CreateManifestByObjectRequestBody
      //var instance = new ShipEngineApi.CreateManifestByObjectRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.CreateManifestByObjectRequestBody);
    });
    ...
    it('should have the property excludedLabelIds (base name: "excluded_label_ids")', function() {
      // uncomment below and update the code to test the property excludedLabelIds
      //var instance = new ShipEngineApi.CreateManifestByObjectRequestBody();
      //expect(instance).to.be();
    });
