...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetShipmentByIdResponseBody();
  });
  ...
  describe('GetShipmentByIdResponseBody', function() {
    it('should create an instance of GetShipmentByIdResponseBody', function() {
      // uncomment below and update the code to test GetShipmentByIdResponseBody
      //var instance = new ShipEngineApi.GetShipmentByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetShipmentByIdResponseBody);
    });
