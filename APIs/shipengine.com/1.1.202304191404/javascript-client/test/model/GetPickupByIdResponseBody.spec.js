...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.GetPickupByIdResponseBody();
  });
  ...
  describe('GetPickupByIdResponseBody', function() {
    it('should create an instance of GetPickupByIdResponseBody', function() {
      // uncomment below and update the code to test GetPickupByIdResponseBody
      //var instance = new ShipEngineApi.GetPickupByIdResponseBody();
      //expect(instance).to.be.a(ShipEngineApi.GetPickupByIdResponseBody);
    });
