...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ShipEngineApi.ConnectSekoRequestBody();
  });
  ...
  describe('ConnectSekoRequestBody', function() {
    it('should create an instance of ConnectSekoRequestBody', function() {
      // uncomment below and update the code to test ConnectSekoRequestBody
      //var instance = new ShipEngineApi.ConnectSekoRequestBody();
      //expect(instance).to.be.a(ShipEngineApi.ConnectSekoRequestBody);
    });
