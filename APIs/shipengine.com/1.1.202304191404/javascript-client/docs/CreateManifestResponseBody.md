# ShipEngineApi.CreateManifestResponseBody
...
**manifestRequests** | [**[ManifestRequest]**](ManifestRequest.md) | Resulting manifest requests with statuses | [optional] 
**carrierId** | **String** | A string that uniquely identifies the carrier | 
**createdAt** | **Date** | The date-time that the manifest was created | 
**formId** | **String** | A string that uniquely identifies the form | 
**labelIds** | **[String]** | An array of the label ids used in this manifest. | [optional] [readonly] 
**manifestDownload** | [**ManifestDownload**](ManifestDownload.md) |  | 
**manifestId** | **String** | A string that uniquely identifies the manifest | 
**shipDate** | **Date** | The date-time that the manifests shipments will be picked up | 
