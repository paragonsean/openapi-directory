...
**carrierOccurredAt** | **Date** | Carrier timestamp for the event, it is assumed to be the local time of where the event occurred. | [optional] 
...
**latitude** | **Number** | Latitude coordinate of tracking event. | [optional] 
**longitude** | **Number** | Longitude coordinate of tracking event. | [optional] 
**occurredAt** | **Date** | Timestamp for carrier event | 
