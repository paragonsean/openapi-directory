# ShipEngineApi.DeprecatedManifest
...
**createdAt** | **Date** | The date-time that the manifest was created | [optional] 
...
**shipDate** | **Date** | The date-time that the manifests shipments will be picked up | [optional] 
**shipments** | **Number** | The number of shipments that are included in this manifest | [optional] [readonly] 
