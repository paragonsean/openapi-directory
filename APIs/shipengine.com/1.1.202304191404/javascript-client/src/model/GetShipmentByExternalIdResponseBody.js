...
/**
 * The GetShipmentByExternalIdResponseBody model module.
 * @module model/GetShipmentByExternalIdResponseBody
 * @version 1.1.202304191404
 */
class GetShipmentByExternalIdResponseBody {
    /**
     * Constructs a new <code>GetShipmentByExternalIdResponseBody</code>.
     * A get shipment by external id response body
     * @alias module:model/GetShipmentByExternalIdResponseBody
    ...
    constructor(advancedOptions, carrierId, confirmation, createdAt, customs, insuranceProvider, modifiedAt, packages, returnTo, serviceCode, shipDate, shipFrom, shipTo, shipmentId, shipmentStatus, tags, totalWeight, warehouseId) { 
        ...
        GetShipmentByExternalIdResponseBody.initialize(this, advancedOptions, carrierId, confirmation, createdAt, customs, insuranceProvider, modifiedAt, packages, returnTo, serviceCode, shipDate, shipFrom, shipTo, shipmentId, shipmentStatus, tags, totalWeight, warehouseId);
    }
    ...
    /**
     * Constructs a <code>GetShipmentByExternalIdResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetShipmentByExternalIdResponseBody} obj Optional instance to populate.
     * @return {module:model/GetShipmentByExternalIdResponseBody} The populated <code>GetShipmentByExternalIdResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetShipmentByExternalIdResponseBody();
    ...
    /**
     * Validates the JSON data with respect to <code>GetShipmentByExternalIdResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetShipmentByExternalIdResponseBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetShipmentByExternalIdResponseBody.RequiredProperties) {
...
GetShipmentByExternalIdResponseBody.RequiredProperties = ["advanced_options", "carrier_id", "confirmation", "created_at", "customs", "insurance_provider", "modified_at", "packages", "return_to", "service_code", "ship_date", "ship_from", "ship_to", "shipment_id", "shipment_status", "tags", "total_weight", "warehouse_id"];

/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
GetShipmentByExternalIdResponseBody.prototype['advanced_options'] = undefined;

/**
 * The carrier account that is billed for the shipping charges
 * @member {String} carrier_id
 */
GetShipmentByExternalIdResponseBody.prototype['carrier_id'] = undefined;

/**
 * The type of delivery confirmation that is required for this shipment.
 * @member {module:model/DeliveryConfirmation} confirmation
 */
GetShipmentByExternalIdResponseBody.prototype['confirmation'] = undefined;

/**
 * The date and time that the shipment was created in ShipEngine.
 * @member {Date} created_at
 */
GetShipmentByExternalIdResponseBody.prototype['created_at'] = undefined;

/**
 * Customs information.  This is usually only needed for international shipments. 
 * @member {module:model/InternationalShipmentOptions} customs
 */
GetShipmentByExternalIdResponseBody.prototype['customs'] = undefined;

/**
 * ID that the Order Source assigned
 * @member {String} external_order_id
 */
GetShipmentByExternalIdResponseBody.prototype['external_order_id'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['external_shipment_id'] = undefined;

/**
 * The insurance provider to use for any insured packages in the shipment. 
 * @member {module:model/InsuranceProvider} insurance_provider
 */
GetShipmentByExternalIdResponseBody.prototype['insurance_provider'] = undefined;
 ...
 * @default false
 */
GetShipmentByExternalIdResponseBody.prototype['is_return'] = false;

/**
 * Describe the packages included in this shipment as related to potential metadata that was imported from external order sources 
 * @member {Array.<module:model/ShipmentItem>} items
 */
GetShipmentByExternalIdResponseBody.prototype['items'] = undefined;

/**
 * The date and time that the shipment was created or last modified.
 * @member {Date} modified_at
 */
GetShipmentByExternalIdResponseBody.prototype['modified_at'] = undefined;

/**
 * @member {module:model/OrderSourceName} order_source_code
 */
GetShipmentByExternalIdResponseBody.prototype['order_source_code'] = undefined;

/**
 * Indicates if the package will be picked up or dropped off by the carrier
 * @member {module:model/OriginType} origin_type
 */
GetShipmentByExternalIdResponseBody.prototype['origin_type'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['packages'] = undefined;

/**
 * The return address for this shipment.  Defaults to the `ship_from` address. 
 * @member {module:model/ShippingAddress} return_to
 */
GetShipmentByExternalIdResponseBody.prototype['return_to'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['service_code'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['ship_date'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['ship_from'] = undefined;

/**
 * The recipient's mailing address
 * @member {module:model/ShippingAddress} ship_to
 */
GetShipmentByExternalIdResponseBody.prototype['ship_to'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
GetShipmentByExternalIdResponseBody.prototype['shipment_id'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['shipment_number'] = undefined;

/**
 * The current status of the shipment
 * @member {module:model/ShipmentStatus} shipment_status
 */
GetShipmentByExternalIdResponseBody.prototype['shipment_status'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['tags'] = undefined;

/**
 * @member {Array.<module:model/TaxIdentifier>} tax_identifiers
 */
GetShipmentByExternalIdResponseBody.prototype['tax_identifiers'] = undefined;

/**
 * The combined weight of all packages in the shipment
 * @member {module:model/Weight} total_weight
 */
GetShipmentByExternalIdResponseBody.prototype['total_weight'] = undefined;
 ...
 */
GetShipmentByExternalIdResponseBody.prototype['warehouse_id'] = undefined;
...
export default GetShipmentByExternalIdResponseBody;
