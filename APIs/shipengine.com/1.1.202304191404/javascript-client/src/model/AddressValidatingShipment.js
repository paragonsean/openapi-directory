...
import ValidateShipmentFields from './ValidateShipmentFields';
import Weight from './Weight';

/**
 * The AddressValidatingShipment model module.
 * @module model/AddressValidatingShipment
 * @version 1.1.202304191404
 */
class AddressValidatingShipment {
    /**
     * Constructs a new <code>AddressValidatingShipment</code>.
     * An address validating shipment
     * @alias module:model/AddressValidatingShipment
     * @implements module:model/ValidateShipmentFields
     ...
     */
    constructor(carrierId, serviceCode, shipFrom, shipTo, shipmentId) { 
        ValidateShipmentFields.initialize(this);PartialShipment.initialize(this);
        AddressValidatingShipment.initialize(this, carrierId, serviceCode, shipFrom, shipTo, shipmentId);
    }
     ...
     */
    static initialize(obj, carrierId, serviceCode, shipFrom, shipTo, shipmentId) { 
    ...
    /**
     * Constructs a <code>AddressValidatingShipment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddressValidatingShipment} obj Optional instance to populate.
     * @return {module:model/AddressValidatingShipment} The populated <code>AddressValidatingShipment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddressValidatingShipment();
            ValidateShipmentFields.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>AddressValidatingShipment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressValidatingShipment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddressValidatingShipment.RequiredProperties) {
...
AddressValidatingShipment.RequiredProperties = ["carrier_id", "service_code", "ship_from", "ship_to", "shipment_id"];

/**
 * @member {module:model/ValidateAddress} validate_address
 */
AddressValidatingShipment.prototype['validate_address'] = undefined;

/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
AddressValidatingShipment.prototype['advanced_options'] = undefined;

/**
 * The carrier account that is billed for the shipping charges
 * @member {String} carrier_id
 */
AddressValidatingShipment.prototype['carrier_id'] = undefined;

/**
 * The type of delivery confirmation that is required for this shipment.
 * @member {module:model/DeliveryConfirmation} confirmation
 */
AddressValidatingShipment.prototype['confirmation'] = undefined;

/**
 * The date and time that the shipment was created in ShipEngine.
 * @member {Date} created_at
 */
AddressValidatingShipment.prototype['created_at'] = undefined;

/**
 * Customs information.  This is usually only needed for international shipments. 
 * @member {module:model/InternationalShipmentOptions} customs
 */
AddressValidatingShipment.prototype['customs'] = undefined;

/**
 * ID that the Order Source assigned
 * @member {String} external_order_id
 */
AddressValidatingShipment.prototype['external_order_id'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['external_shipment_id'] = undefined;

/**
 * The insurance provider to use for any insured packages in the shipment. 
 * @member {module:model/InsuranceProvider} insurance_provider
 */
AddressValidatingShipment.prototype['insurance_provider'] = undefined;
 ...
 * @default false
 */
AddressValidatingShipment.prototype['is_return'] = false;

/**
 * Describe the packages included in this shipment as related to potential metadata that was imported from external order sources 
 * @member {Array.<module:model/ShipmentItem>} items
 */
AddressValidatingShipment.prototype['items'] = undefined;

/**
 * The date and time that the shipment was created or last modified.
 * @member {Date} modified_at
 */
AddressValidatingShipment.prototype['modified_at'] = undefined;

/**
 * @member {module:model/OrderSourceName} order_source_code
 */
AddressValidatingShipment.prototype['order_source_code'] = undefined;

/**
 * Indicates if the package will be picked up or dropped off by the carrier
 * @member {module:model/OriginType} origin_type
 */
AddressValidatingShipment.prototype['origin_type'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['packages'] = undefined;

/**
 * The return address for this shipment.  Defaults to the `ship_from` address. 
 * @member {module:model/ShippingAddress} return_to
 */
AddressValidatingShipment.prototype['return_to'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['service_code'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['ship_date'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['ship_from'] = undefined;

/**
 * The recipient's mailing address
 * @member {module:model/ShippingAddress} ship_to
 */
AddressValidatingShipment.prototype['ship_to'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
AddressValidatingShipment.prototype['shipment_id'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['shipment_number'] = undefined;

/**
 * The current status of the shipment
 * @member {module:model/ShipmentStatus} shipment_status
 */
AddressValidatingShipment.prototype['shipment_status'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['tags'] = undefined;

/**
 * @member {Array.<module:model/TaxIdentifier>} tax_identifiers
 */
AddressValidatingShipment.prototype['tax_identifiers'] = undefined;

/**
 * The combined weight of all packages in the shipment
 * @member {module:model/Weight} total_weight
 */
AddressValidatingShipment.prototype['total_weight'] = undefined;
 ...
 */
AddressValidatingShipment.prototype['warehouse_id'] = undefined;


// Implement ValidateShipmentFields interface:
/**
 * @member {module:model/ValidateAddress} validate_address
 */
ValidateShipmentFields.prototype['validate_address'] = undefined;
...
export default AddressValidatingShipment;
