...
class Link {
     ...
     * @implements module:model/OptionalLink
     * @param href {String} The URL of the linked resource, if any
     */
    constructor(href) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Link();
            OptionalLink.constructFromObject(data, obj);
...
// Implement OptionalLink interface:
/**
 * The URL of the linked resource, if any
 * @member {String} href
 */
