...
/**
 * The ConnectFedexUkRequestBody model module.
 * @module model/ConnectFedexUkRequestBody
 * @version 1.1.202304191404
 */
class ConnectFedexUkRequestBody {
    /**
     * Constructs a new <code>ConnectFedexUkRequestBody</code>.
     * A Fedex UK account information request body
     * @alias module:model/ConnectFedexUkRequestBody
    ...
    constructor(accountNumber, address1, agreeToEula, city, countryCode, email, firstName, lastName, nickname, phone, postalCode, state) { 
        ...
        ConnectFedexUkRequestBody.initialize(this, accountNumber, address1, agreeToEula, city, countryCode, email, firstName, lastName, nickname, phone, postalCode, state);
    }
    ...
    /**
     * Constructs a <code>ConnectFedexUkRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConnectFedexUkRequestBody} obj Optional instance to populate.
     * @return {module:model/ConnectFedexUkRequestBody} The populated <code>ConnectFedexUkRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConnectFedexUkRequestBody();
    ...
    /**
     * Validates the JSON data with respect to <code>ConnectFedexUkRequestBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConnectFedexUkRequestBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConnectFedexUkRequestBody.RequiredProperties) {
...
ConnectFedexUkRequestBody.RequiredProperties = ["account_number", "address1", "agree_to_eula", "city", "country_code", "email", "first_name", "last_name", "nickname", "phone", "postal_code", "state"];

/**
 * Account number
 * @member {String} account_number
 */
ConnectFedexUkRequestBody.prototype['account_number'] = undefined;

/**
 * Address
 * @member {String} address1
 */
ConnectFedexUkRequestBody.prototype['address1'] = undefined;

/**
 * Address
 * @member {String} address2
 */
ConnectFedexUkRequestBody.prototype['address2'] = undefined;

/**
 * Boolean signaling agreement to the Fedex End User License Agreement
 * @member {Boolean} agree_to_eula
 */
ConnectFedexUkRequestBody.prototype['agree_to_eula'] = undefined;

/**
 * The city
 * @member {String} city
 */
ConnectFedexUkRequestBody.prototype['city'] = undefined;

/**
 * The company
 * @member {String} company
 */
ConnectFedexUkRequestBody.prototype['company'] = undefined;

/**
 * Country code
 * @member {String} country_code
 */
ConnectFedexUkRequestBody.prototype['country_code'] = undefined;

/**
 * The email address
 * @member {String} email
 */
ConnectFedexUkRequestBody.prototype['email'] = undefined;

/**
 * First name
 * @member {String} first_name
 */
ConnectFedexUkRequestBody.prototype['first_name'] = undefined;

/**
 * Last name
 * @member {String} last_name
 */
ConnectFedexUkRequestBody.prototype['last_name'] = undefined;

/**
 * Meter number
 * @member {String} meter_number
 */
ConnectFedexUkRequestBody.prototype['meter_number'] = undefined;

/**
 * Nickname
 * @member {String} nickname
 */
ConnectFedexUkRequestBody.prototype['nickname'] = undefined;

/**
 * Phone number
 * @member {String} phone
 */
ConnectFedexUkRequestBody.prototype['phone'] = undefined;

/**
 * Postal Code
 * @member {String} postal_code
 */
ConnectFedexUkRequestBody.prototype['postal_code'] = undefined;

/**
 * State
 * @member {String} state
 */
ConnectFedexUkRequestBody.prototype['state'] = undefined;
...
export default ConnectFedexUkRequestBody;
