...
import UpdateShipmentFields from './UpdateShipmentFields';
import ValidateAddress from './ValidateAddress';
import Weight from './Weight';

/**
 * The UpdateShipmentRequestBody model module.
 * @module model/UpdateShipmentRequestBody
 * @version 1.1.202304191404
 */
class UpdateShipmentRequestBody {
    /**
     * Constructs a new <code>UpdateShipmentRequestBody</code>.
     * An update shipment request body
     * @alias module:model/UpdateShipmentRequestBody
     * @implements module:model/PartialShipment
     * @implements module:model/UpdateShipmentFields
     ...
     */
    constructor(shipFrom, shipTo) { 
        PartialShipment.initialize(this);UpdateShipmentFields.initialize(this);
        UpdateShipmentRequestBody.initialize(this, shipFrom, shipTo);
    }
     ...
     */
    static initialize(obj, shipFrom, shipTo) { 
        obj['is_return'] = false;
    ...
    /**
     * Constructs a <code>UpdateShipmentRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateShipmentRequestBody} obj Optional instance to populate.
     * @return {module:model/UpdateShipmentRequestBody} The populated <code>UpdateShipmentRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateShipmentRequestBody();
            PartialShipment.constructFromObject(data, obj);
            UpdateShipmentFields.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateShipmentRequestBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateShipmentRequestBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateShipmentRequestBody.RequiredProperties) {
...
UpdateShipmentRequestBody.RequiredProperties = ["ship_from", "ship_to"];

/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
UpdateShipmentRequestBody.prototype['advanced_options'] = undefined;

/**
 * The carrier account that is billed for the shipping charges
 * @member {String} carrier_id
 */
UpdateShipmentRequestBody.prototype['carrier_id'] = undefined;

/**
 * The type of delivery confirmation that is required for this shipment.
 * @member {module:model/DeliveryConfirmation} confirmation
 */
UpdateShipmentRequestBody.prototype['confirmation'] = undefined;

/**
 * The date and time that the shipment was created in ShipEngine.
 * @member {Date} created_at
 */
UpdateShipmentRequestBody.prototype['created_at'] = undefined;

/**
 * Customs information.  This is usually only needed for international shipments. 
 * @member {module:model/InternationalShipmentOptions} customs
 */
UpdateShipmentRequestBody.prototype['customs'] = undefined;

/**
 * ID that the Order Source assigned
 * @member {String} external_order_id
 */
UpdateShipmentRequestBody.prototype['external_order_id'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['external_shipment_id'] = undefined;

/**
 * The insurance provider to use for any insured packages in the shipment. 
 * @member {module:model/InsuranceProvider} insurance_provider
 */
UpdateShipmentRequestBody.prototype['insurance_provider'] = undefined;
 ...
 * @default false
 */
UpdateShipmentRequestBody.prototype['is_return'] = false;

/**
 * Describe the packages included in this shipment as related to potential metadata that was imported from external order sources 
 * @member {Array.<module:model/ShipmentItem>} items
 */
UpdateShipmentRequestBody.prototype['items'] = undefined;

/**
 * The date and time that the shipment was created or last modified.
 * @member {Date} modified_at
 */
UpdateShipmentRequestBody.prototype['modified_at'] = undefined;

/**
 * @member {module:model/OrderSourceName} order_source_code
 */
UpdateShipmentRequestBody.prototype['order_source_code'] = undefined;

/**
 * Indicates if the package will be picked up or dropped off by the carrier
 * @member {module:model/OriginType} origin_type
 */
UpdateShipmentRequestBody.prototype['origin_type'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['packages'] = undefined;

/**
 * The return address for this shipment.  Defaults to the `ship_from` address. 
 * @member {module:model/ShippingAddress} return_to
 */
UpdateShipmentRequestBody.prototype['return_to'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['service_code'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['ship_date'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['ship_from'] = undefined;

/**
 * The recipient's mailing address
 * @member {module:model/ShippingAddress} ship_to
 */
UpdateShipmentRequestBody.prototype['ship_to'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
UpdateShipmentRequestBody.prototype['shipment_id'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['shipment_number'] = undefined;

/**
 * The current status of the shipment
 * @member {module:model/ShipmentStatus} shipment_status
 */
UpdateShipmentRequestBody.prototype['shipment_status'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['tags'] = undefined;

/**
 * @member {Array.<module:model/TaxIdentifier>} tax_identifiers
 */
UpdateShipmentRequestBody.prototype['tax_identifiers'] = undefined;

/**
 * The combined weight of all packages in the shipment
 * @member {module:model/Weight} total_weight
 */
UpdateShipmentRequestBody.prototype['total_weight'] = undefined;
 ...
 */
UpdateShipmentRequestBody.prototype['warehouse_id'] = undefined;

/**
 * @member {module:model/ValidateAddress} validate_address
 */
UpdateShipmentRequestBody.prototype['validate_address'] = undefined;
...
// Implement UpdateShipmentFields interface:
/**
 * @member {module:model/ValidateAddress} validate_address
 */
...
export default UpdateShipmentRequestBody;
