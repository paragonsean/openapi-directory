...
/**
* Enum class AncillaryServiceEndorsement.
* @enum {}
* @readonly
*/
export default class AncillaryServiceEndorsement {
    ...
    /**
    * Returns a <code>AncillaryServiceEndorsement</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AncillaryServiceEndorsement} The enum <code>AncillaryServiceEndorsement</code> value.
    */
