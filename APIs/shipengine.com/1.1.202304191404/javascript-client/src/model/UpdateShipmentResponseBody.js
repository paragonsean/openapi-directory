...
/**
 * The UpdateShipmentResponseBody model module.
 * @module model/UpdateShipmentResponseBody
 * @version 1.1.202304191404
 */
class UpdateShipmentResponseBody {
    /**
     * Constructs a new <code>UpdateShipmentResponseBody</code>.
     * An update shipment response body
     * @alias module:model/UpdateShipmentResponseBody
     * @implements module:model/CreateAndValidateShipment
     ...
     * @param addressValidation {module:model/AddressValidationResult} The address validation
     * @param errors {Array.<String>} An array of errors that occurred while creating shipment.
     */
    constructor(advancedOptions, carrierId, confirmation, createdAt, customs, insuranceProvider, packages, returnTo, serviceCode, shipDate, shipFrom, shipTo, shipmentId, shipmentStatus, tags, totalWeight, addressValidation, errors) { 
        CreateAndValidateShipment.initialize(this);
        UpdateShipmentResponseBody.initialize(this, advancedOptions, carrierId, confirmation, createdAt, customs, insuranceProvider, packages, returnTo, serviceCode, shipDate, shipFrom, shipTo, shipmentId, shipmentStatus, tags, totalWeight, addressValidation, errors);
    }
     ...
     */
    static initialize(obj, advancedOptions, carrierId, confirmation, createdAt, customs, insuranceProvider, packages, returnTo, serviceCode, shipDate, shipFrom, shipTo, shipmentId, shipmentStatus, tags, totalWeight, addressValidation, errors) { 
        ...
        obj['address_validation'] = addressValidation;
        obj['errors'] = errors;
    }

    /**
     * Constructs a <code>UpdateShipmentResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateShipmentResponseBody} obj Optional instance to populate.
     * @return {module:model/UpdateShipmentResponseBody} The populated <code>UpdateShipmentResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateShipmentResponseBody();
            CreateAndValidateShipment.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateShipmentResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateShipmentResponseBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateShipmentResponseBody.RequiredProperties) {
...
UpdateShipmentResponseBody.RequiredProperties = ["advanced_options", "carrier_id", "confirmation", "created_at", "customs", "insurance_provider", "packages", "return_to", "service_code", "ship_date", "ship_from", "ship_to", "shipment_id", "shipment_status", "tags", "total_weight", "address_validation", "errors"];

/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
UpdateShipmentResponseBody.prototype['advanced_options'] = undefined;

/**
 * The carrier account that is billed for the shipping charges
 * @member {String} carrier_id
 */
UpdateShipmentResponseBody.prototype['carrier_id'] = undefined;

/**
 * The type of delivery confirmation that is required for this shipment.
 * @member {module:model/DeliveryConfirmation} confirmation
 */
UpdateShipmentResponseBody.prototype['confirmation'] = undefined;

/**
 * The date and time that the shipment was created in ShipEngine.
 * @member {Date} created_at
 */
UpdateShipmentResponseBody.prototype['created_at'] = undefined;

/**
 * Customs information.  This is usually only needed for international shipments. 
 * @member {module:model/InternationalShipmentOptions} customs
 */
UpdateShipmentResponseBody.prototype['customs'] = undefined;

/**
 * ID that the Order Source assigned
 * @member {String} external_order_id
 */
UpdateShipmentResponseBody.prototype['external_order_id'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['external_shipment_id'] = undefined;

/**
 * The insurance provider to use for any insured packages in the shipment. 
 * @member {module:model/InsuranceProvider} insurance_provider
 */
UpdateShipmentResponseBody.prototype['insurance_provider'] = undefined;
 ...
 * @default false
 */
UpdateShipmentResponseBody.prototype['is_return'] = false;

/**
 * Describe the packages included in this shipment as related to potential metadata that was imported from external order sources 
 * @member {Array.<module:model/ShipmentItem>} items
 */
UpdateShipmentResponseBody.prototype['items'] = undefined;

/**
 * The date and time that the shipment was created or last modified.
 * @member {Date} modified_at
 */
UpdateShipmentResponseBody.prototype['modified_at'] = undefined;

/**
 * @member {module:model/OrderSourceName} order_source_code
 */
UpdateShipmentResponseBody.prototype['order_source_code'] = undefined;

/**
 * Indicates if the package will be picked up or dropped off by the carrier
 * @member {module:model/OriginType} origin_type
 */
UpdateShipmentResponseBody.prototype['origin_type'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['packages'] = undefined;

/**
 * The return address for this shipment.  Defaults to the `ship_from` address. 
 * @member {module:model/ShippingAddress} return_to
 */
UpdateShipmentResponseBody.prototype['return_to'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['service_code'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['ship_date'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['ship_from'] = undefined;

/**
 * The recipient's mailing address
 * @member {module:model/ShippingAddress} ship_to
 */
UpdateShipmentResponseBody.prototype['ship_to'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
UpdateShipmentResponseBody.prototype['shipment_id'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['shipment_number'] = undefined;

/**
 * The current status of the shipment
 * @member {module:model/ShipmentStatus} shipment_status
 */
UpdateShipmentResponseBody.prototype['shipment_status'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['tags'] = undefined;

/**
 * @member {Array.<module:model/TaxIdentifier>} tax_identifiers
 */
UpdateShipmentResponseBody.prototype['tax_identifiers'] = undefined;

/**
 * The combined weight of all packages in the shipment
 * @member {module:model/Weight} total_weight
 */
UpdateShipmentResponseBody.prototype['total_weight'] = undefined;
 ...
 */
UpdateShipmentResponseBody.prototype['warehouse_id'] = undefined;

/**
 * The address validation
 * @member {module:model/AddressValidationResult} address_validation
 */
UpdateShipmentResponseBody.prototype['address_validation'] = undefined;

/**
 * An array of errors that occurred while creating shipment.
 * @member {Array.<String>} errors
 */
UpdateShipmentResponseBody.prototype['errors'] = undefined;


// Implement CreateAndValidateShipment interface:
/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
...
export default UpdateShipmentResponseBody;
