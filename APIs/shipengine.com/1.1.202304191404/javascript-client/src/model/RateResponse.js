...
class RateResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rate_response')) {
                obj['rate_response'] = ApiClient.convertToType(data['rate_response'], RatesInformation);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['rate_response']) { // data not null
          RatesInformation.validateJSON(data['rate_response']);
        }
...
/**
 * The rates response
 * @member {module:model/RatesInformation} rate_response
 */
RateResponse.prototype['rate_response'] = undefined;
