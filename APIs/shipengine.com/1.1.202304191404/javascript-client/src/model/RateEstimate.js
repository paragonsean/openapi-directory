...
/**
 * The RateEstimate model module.
 * @module model/RateEstimate
 * @version 1.1.202304191404
 */
class RateEstimate {
    /**
     * Constructs a new <code>RateEstimate</code>.
     * A rate estimate
     * @alias module:model/RateEstimate
     ...
     */
    constructor(carrierCode, carrierFriendlyName, carrierId, carrierNickname, confirmationAmount, errorMessages, guaranteedService, insuranceAmount, negotiatedRate, otherAmount, packageType, rateType, serviceCode, serviceType, shippingAmount, trackable, validationStatus, warningMessages, zone) { 
        
        RateEstimate.initialize(this, carrierCode, carrierFriendlyName, carrierId, carrierNickname, confirmationAmount, errorMessages, guaranteedService, insuranceAmount, negotiatedRate, otherAmount, packageType, rateType, serviceCode, serviceType, shippingAmount, trackable, validationStatus, warningMessages, zone);
    }
     ...
     */
    static initialize(obj, carrierCode, carrierFriendlyName, carrierId, carrierNickname, confirmationAmount, errorMessages, guaranteedService, insuranceAmount, negotiatedRate, otherAmount, packageType, rateType, serviceCode, serviceType, shippingAmount, trackable, validationStatus, warningMessages, zone) { 
    ...
    /**
     * Constructs a <code>RateEstimate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RateEstimate} obj Optional instance to populate.
     * @return {module:model/RateEstimate} The populated <code>RateEstimate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RateEstimate();
    ...
    /**
     * Validates the JSON data with respect to <code>RateEstimate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RateEstimate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RateEstimate.RequiredProperties) {
...
RateEstimate.RequiredProperties = ["carrier_code", "carrier_friendly_name", "carrier_id", "carrier_nickname", "confirmation_amount", "error_messages", "guaranteed_service", "insurance_amount", "negotiated_rate", "other_amount", "package_type", "rate_type", "service_code", "service_type", "shipping_amount", "trackable", "validation_status", "warning_messages", "zone"];

/**
 * carrier code
 * @member {String} carrier_code
 */
RateEstimate.prototype['carrier_code'] = undefined;

/**
 * The carrier delivery days
 * @member {String} carrier_delivery_days
 */
RateEstimate.prototype['carrier_delivery_days'] = undefined;

/**
 * carrier friendly name
 * @member {String} carrier_friendly_name
 */
RateEstimate.prototype['carrier_friendly_name'] = undefined;

/**
 * A string that uniquely identifies the carrier
 * @member {String} carrier_id
 */
RateEstimate.prototype['carrier_id'] = undefined;

/**
 * carrier nickname
 * @member {String} carrier_nickname
 */
RateEstimate.prototype['carrier_nickname'] = undefined;

/**
 * The confirmation amount
 * @member {module:model/MonetaryValue} confirmation_amount
 */
RateEstimate.prototype['confirmation_amount'] = undefined;
 ...
 */
RateEstimate.prototype['delivery_days'] = undefined;

/**
 * The error messages
 * @member {Array.<String>} error_messages
 */
RateEstimate.prototype['error_messages'] = undefined;
 ...
 * @member {Number} zone
 */
RateEstimate.prototype['zone'] = undefined;
