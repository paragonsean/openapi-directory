...
class ContactDetails {
     ...
     * @param name {String} 
     * @param phone {String} Phone number associated
     */
    constructor(email, name, phone) { 
        
        ContactDetails.initialize(this, email, name, phone);
    }
...
ContactDetails.RequiredProperties = ["email", "name", "phone"];
 ...
 * @member {String} name
 */
ContactDetails.prototype['name'] = undefined;
