...
/**
 * The CalculateRatesResponseBody model module.
 * @module model/CalculateRatesResponseBody
 * @version 1.1.202304191404
 */
class CalculateRatesResponseBody {
    /**
     * Constructs a new <code>CalculateRatesResponseBody</code>.
     * A rate shipment response body
     * @alias module:model/CalculateRatesResponseBody
     * @implements module:model/PartialShipment
     * @implements module:model/RateResponse
     ...
     * @param rateResponse {module:model/RatesInformation} The rates response
     */
    constructor(advancedOptions, confirmation, createdAt, customs, insuranceProvider, modifiedAt, packages, returnTo, shipDate, shipmentId, shipmentStatus, tags, totalWeight, rateResponse) { 
        PartialShipment.initialize(this);RateResponse.initialize(this);
        CalculateRatesResponseBody.initialize(this, advancedOptions, confirmation, createdAt, customs, insuranceProvider, modifiedAt, packages, returnTo, shipDate, shipmentId, shipmentStatus, tags, totalWeight, rateResponse);
    }
     ...
     */
    static initialize(obj, advancedOptions, confirmation, createdAt, customs, insuranceProvider, modifiedAt, packages, returnTo, shipDate, shipmentId, shipmentStatus, tags, totalWeight, rateResponse) { 
        ...
        obj['rate_response'] = rateResponse;
    }

    /**
     * Constructs a <code>CalculateRatesResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CalculateRatesResponseBody} obj Optional instance to populate.
     * @return {module:model/CalculateRatesResponseBody} The populated <code>CalculateRatesResponseBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CalculateRatesResponseBody();
            PartialShipment.constructFromObject(data, obj);
            RateResponse.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CalculateRatesResponseBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CalculateRatesResponseBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CalculateRatesResponseBody.RequiredProperties) {
...
CalculateRatesResponseBody.RequiredProperties = ["advanced_options", "confirmation", "created_at", "customs", "insurance_provider", "modified_at", "packages", "return_to", "ship_date", "shipment_id", "shipment_status", "tags", "total_weight", "rate_response"];

/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
CalculateRatesResponseBody.prototype['advanced_options'] = undefined;

/**
 * The carrier account that is billed for the shipping charges
 * @member {String} carrier_id
 */
CalculateRatesResponseBody.prototype['carrier_id'] = undefined;

/**
 * The type of delivery confirmation that is required for this shipment.
 * @member {module:model/DeliveryConfirmation} confirmation
 */
CalculateRatesResponseBody.prototype['confirmation'] = undefined;

/**
 * The date and time that the shipment was created in ShipEngine.
 * @member {Date} created_at
 */
CalculateRatesResponseBody.prototype['created_at'] = undefined;

/**
 * Customs information.  This is usually only needed for international shipments. 
 * @member {module:model/InternationalShipmentOptions} customs
 */
CalculateRatesResponseBody.prototype['customs'] = undefined;

/**
 * ID that the Order Source assigned
 * @member {String} external_order_id
 */
CalculateRatesResponseBody.prototype['external_order_id'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['external_shipment_id'] = undefined;

/**
 * The insurance provider to use for any insured packages in the shipment. 
 * @member {module:model/InsuranceProvider} insurance_provider
 */
CalculateRatesResponseBody.prototype['insurance_provider'] = undefined;
 ...
 * @default false
 */
CalculateRatesResponseBody.prototype['is_return'] = false;

/**
 * Describe the packages included in this shipment as related to potential metadata that was imported from external order sources 
 * @member {Array.<module:model/ShipmentItem>} items
 */
CalculateRatesResponseBody.prototype['items'] = undefined;

/**
 * The date and time that the shipment was created or last modified.
 * @member {Date} modified_at
 */
CalculateRatesResponseBody.prototype['modified_at'] = undefined;

/**
 * @member {module:model/OrderSourceName} order_source_code
 */
CalculateRatesResponseBody.prototype['order_source_code'] = undefined;

/**
 * Indicates if the package will be picked up or dropped off by the carrier
 * @member {module:model/OriginType} origin_type
 */
CalculateRatesResponseBody.prototype['origin_type'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['packages'] = undefined;

/**
 * The return address for this shipment.  Defaults to the `ship_from` address. 
 * @member {module:model/ShippingAddress} return_to
 */
CalculateRatesResponseBody.prototype['return_to'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['service_code'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['ship_date'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['ship_from'] = undefined;

/**
 * The recipient's mailing address
 * @member {module:model/ShippingAddress} ship_to
 */
CalculateRatesResponseBody.prototype['ship_to'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
CalculateRatesResponseBody.prototype['shipment_id'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['shipment_number'] = undefined;

/**
 * The current status of the shipment
 * @member {module:model/ShipmentStatus} shipment_status
 */
CalculateRatesResponseBody.prototype['shipment_status'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['tags'] = undefined;

/**
 * @member {Array.<module:model/TaxIdentifier>} tax_identifiers
 */
CalculateRatesResponseBody.prototype['tax_identifiers'] = undefined;

/**
 * The combined weight of all packages in the shipment
 * @member {module:model/Weight} total_weight
 */
CalculateRatesResponseBody.prototype['total_weight'] = undefined;
 ...
 */
CalculateRatesResponseBody.prototype['warehouse_id'] = undefined;

/**
 * The rates response
 * @member {module:model/RatesInformation} rate_response
 */
CalculateRatesResponseBody.prototype['rate_response'] = undefined;
...
// Implement RateResponse interface:
/**
 * The rates response
 * @member {module:model/RatesInformation} rate_response
 */
...
export default CalculateRatesResponseBody;
