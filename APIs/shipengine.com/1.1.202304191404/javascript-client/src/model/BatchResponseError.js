...
class BatchResponseError {
    ...
    /**
     * Validates the JSON data with respect to <code>BatchResponseError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchResponseError</code>.
     */
 ...
 * @member {String} error
 */
BatchResponseError.prototype['error'] = undefined;

/**
 * An external shipment id associated with the shipment
 * @member {String} external_shipment_id
 */
BatchResponseError.prototype['external_shipment_id'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
BatchResponseError.prototype['shipment_id'] = undefined;
