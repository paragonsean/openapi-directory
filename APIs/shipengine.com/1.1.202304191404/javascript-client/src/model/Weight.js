...
class Weight {
     ...
     * @param unit {module:model/WeightUnit} 
     * @param value {Number} The weight, in the specified unit
     */
    constructor(unit, value) { 
        
        Weight.initialize(this, unit, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('unit')) {
                obj['unit'] = ApiClient.convertToType(data['unit'], WeightUnit);
            }
...
Weight.RequiredProperties = ["unit", "value"];

/**
 * @member {module:model/WeightUnit} unit
 */
