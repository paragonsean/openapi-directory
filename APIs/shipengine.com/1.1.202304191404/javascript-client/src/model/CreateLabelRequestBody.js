...
/**
 * The CreateLabelRequestBody model module.
 * @module model/CreateLabelRequestBody
 * @version 1.1.202304191404
 */
class CreateLabelRequestBody {
    /**
     * Constructs a new <code>CreateLabelRequestBody</code>.
     * A purchase label request body
     * @alias module:model/CreateLabelRequestBody
     * @implements module:model/Label
     * @param shipment {module:model/Shipment} The shipment information used to generate the label
     */
    constructor(shipment) { 
        Label.initialize(this);
        CreateLabelRequestBody.initialize(this, shipment);
    }
     ...
     */
    static initialize(obj, shipment) { 
        obj['shipment'] = shipment;
        obj['test_label'] = false;
    }

    /**
     * Constructs a <code>CreateLabelRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLabelRequestBody} obj Optional instance to populate.
     * @return {module:model/CreateLabelRequestBody} The populated <code>CreateLabelRequestBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLabelRequestBody();
            Label.constructFromObject(data, obj);

            if (data.hasOwnProperty('ship_from_service_point_id')) {
                obj['ship_from_service_point_id'] = ApiClient.convertToType(data['ship_from_service_point_id'], 'String');
            }
            if (data.hasOwnProperty('ship_to_service_point_id')) {
                obj['ship_to_service_point_id'] = ApiClient.convertToType(data['ship_to_service_point_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLabelRequestBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLabelRequestBody</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLabelRequestBody.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['ship_from_service_point_id'] && !(typeof data['ship_from_service_point_id'] === 'string' || data['ship_from_service_point_id'] instanceof String)) {
            throw new Error("Expected the field `ship_from_service_point_id` to be a primitive type in the JSON string but got " + data['ship_from_service_point_id']);
        }
        // ensure the json data is a string
        if (data['ship_to_service_point_id'] && !(typeof data['ship_to_service_point_id'] === 'string' || data['ship_to_service_point_id'] instanceof String)) {
            throw new Error("Expected the field `ship_to_service_point_id` to be a primitive type in the JSON string but got " + data['ship_to_service_point_id']);
        }
...
CreateLabelRequestBody.RequiredProperties = ["shipment"];
 ...
 * @member {String} ship_from_service_point_id
 */
CreateLabelRequestBody.prototype['ship_from_service_point_id'] = undefined;
 ...
 * @member {String} ship_to_service_point_id
 */
CreateLabelRequestBody.prototype['ship_to_service_point_id'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['alternative_identifiers'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['batch_id'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['carrier_code'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['carrier_id'] = undefined;

/**
 * The label charge event. 
 * @member {module:model/LabelChargeEvent} charge_event
 */
CreateLabelRequestBody.prototype['charge_event'] = undefined;

/**
 * The date and time that the label was created in ShipEngine.
 * @member {Date} created_at
 */
CreateLabelRequestBody.prototype['created_at'] = undefined;

/**
 * The display format that the label should be shown in.
 * @member {module:model/DisplayScheme} display_scheme
 */
CreateLabelRequestBody.prototype['display_scheme'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['form_download'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['insurance_claim'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['insurance_cost'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['is_international'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['is_return_label'] = undefined;

/**
 * @member {module:model/LabelDownload} label_download
 */
CreateLabelRequestBody.prototype['label_download'] = undefined;

/**
 * @member {module:model/LabelDownloadType} label_download_type
 */
CreateLabelRequestBody.prototype['label_download_type'] = undefined;

/**
 * The file format that you want the label to be in.  We recommend `pdf` format because it is supported by all carriers, whereas some carriers do not support the `png` or `zpl` formats. 
 * @member {module:model/LabelFormat} label_format
 */
CreateLabelRequestBody.prototype['label_format'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['label_id'] = undefined;

/**
 * The label image resource that was used to create a custom label image.
 * @member {String} label_image_id
 */
CreateLabelRequestBody.prototype['label_image_id'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['label_layout'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['outbound_label_id'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['package_code'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['packages'] = undefined;

/**
 * An optional Return Merchandise Authorization number.  This field is useful for return labels.  You can set it to any string value. 
 * @member {String} rma_number
 */
CreateLabelRequestBody.prototype['rma_number'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['service_code'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['ship_date'] = undefined;

/**
 * The shipment information used to generate the label
 * @member {module:model/Shipment} shipment
 */
CreateLabelRequestBody.prototype['shipment'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['shipment_cost'] = undefined;
 ...
 */
CreateLabelRequestBody.prototype['shipment_id'] = undefined;

/**
 * @member {module:model/LabelStatus} status
 */
CreateLabelRequestBody.prototype['status'] = undefined;
 ...
 * @default false
 */
CreateLabelRequestBody.prototype['test_label'] = false;
 ...
 */
CreateLabelRequestBody.prototype['voided_at'] = undefined;
...
export default CreateLabelRequestBody;
