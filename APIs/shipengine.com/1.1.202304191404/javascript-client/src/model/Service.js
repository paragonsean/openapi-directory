    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('domestic')) {
                obj['domestic'] = ApiClient.convertToType(data['domestic'], 'Boolean');
            }
            if (data.hasOwnProperty('international')) {
                obj['international'] = ApiClient.convertToType(data['international'], 'Boolean');
            }
            if (data.hasOwnProperty('is_multi_package_supported')) {
                obj['is_multi_package_supported'] = ApiClient.convertToType(data['is_multi_package_supported'], 'Boolean');
            }
 ...
 */
Service.prototype['carrier_code'] = undefined;

/**
 * A string that uniquely identifies the carrier
 * @member {String} carrier_id
 */
Service.prototype['carrier_id'] = undefined;

/**
 * Supports domestic shipping
 * @member {Boolean} domestic
 */
Service.prototype['domestic'] = undefined;

/**
 * Supports international shipping.
 * @member {Boolean} international
 */
Service.prototype['international'] = undefined;

/**
 * Carrier supports multiple packages per shipment
 * @member {Boolean} is_multi_package_supported
 */
Service.prototype['is_multi_package_supported'] = undefined;
 ...
 */
Service.prototype['service_code'] = undefined;
