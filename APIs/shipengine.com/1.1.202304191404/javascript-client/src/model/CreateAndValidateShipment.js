...
import CreateShipmentResponseBodyFields from './CreateShipmentResponseBodyFields';
...
/**
 * The CreateAndValidateShipment model module.
 * @module model/CreateAndValidateShipment
 * @version 1.1.202304191404
 */
class CreateAndValidateShipment {
    /**
     * Constructs a new <code>CreateAndValidateShipment</code>.
     * A create and validate shipment resource
     * @alias module:model/CreateAndValidateShipment
     * @implements module:model/PartialShipment
     * @implements module:model/CreateShipmentResponseBodyFields
     */
    constructor() { 
        PartialShipment.initialize(this);CreateShipmentResponseBodyFields.initialize(this);
        CreateAndValidateShipment.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateAndValidateShipment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateAndValidateShipment} obj Optional instance to populate.
     * @return {module:model/CreateAndValidateShipment} The populated <code>CreateAndValidateShipment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateAndValidateShipment();
            PartialShipment.constructFromObject(data, obj);
            CreateShipmentResponseBodyFields.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('address_validation')) {
                obj['address_validation'] = ApiClient.convertToType(data['address_validation'], AddressValidationResult);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAndValidateShipment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAndValidateShipment</code>.
     */
    static validateJSON(data) {
        ...
        if (data['address_validation']) { // data not null
          AddressValidationResult.validateJSON(data['address_validation']);
        }
        // ensure the json data is an array
 ...
 */
CreateAndValidateShipment.prototype['advanced_options'] = undefined;

/**
 * The carrier account that is billed for the shipping charges
 * @member {String} carrier_id
 */
CreateAndValidateShipment.prototype['carrier_id'] = undefined;

/**
 * The type of delivery confirmation that is required for this shipment.
 * @member {module:model/DeliveryConfirmation} confirmation
 */
CreateAndValidateShipment.prototype['confirmation'] = undefined;

/**
 * The date and time that the shipment was created in ShipEngine.
 * @member {Date} created_at
 */
CreateAndValidateShipment.prototype['created_at'] = undefined;

/**
 * Customs information.  This is usually only needed for international shipments. 
 * @member {module:model/InternationalShipmentOptions} customs
 */
CreateAndValidateShipment.prototype['customs'] = undefined;

/**
 * ID that the Order Source assigned
 * @member {String} external_order_id
 */
CreateAndValidateShipment.prototype['external_order_id'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['external_shipment_id'] = undefined;

/**
 * The insurance provider to use for any insured packages in the shipment. 
 * @member {module:model/InsuranceProvider} insurance_provider
 */
CreateAndValidateShipment.prototype['insurance_provider'] = undefined;
 ...
 * @default false
 */
CreateAndValidateShipment.prototype['is_return'] = false;

/**
 * Describe the packages included in this shipment as related to potential metadata that was imported from external order sources 
 * @member {Array.<module:model/ShipmentItem>} items
 */
CreateAndValidateShipment.prototype['items'] = undefined;

/**
 * The date and time that the shipment was created or last modified.
 * @member {Date} modified_at
 */
CreateAndValidateShipment.prototype['modified_at'] = undefined;

/**
 * @member {module:model/OrderSourceName} order_source_code
 */
CreateAndValidateShipment.prototype['order_source_code'] = undefined;

/**
 * Indicates if the package will be picked up or dropped off by the carrier
 * @member {module:model/OriginType} origin_type
 */
CreateAndValidateShipment.prototype['origin_type'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['packages'] = undefined;

/**
 * The return address for this shipment.  Defaults to the `ship_from` address. 
 * @member {module:model/ShippingAddress} return_to
 */
CreateAndValidateShipment.prototype['return_to'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['service_code'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['ship_date'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['ship_from'] = undefined;

/**
 * The recipient's mailing address
 * @member {module:model/ShippingAddress} ship_to
 */
CreateAndValidateShipment.prototype['ship_to'] = undefined;

/**
 * A string that uniquely identifies the shipment
 * @member {String} shipment_id
 */
CreateAndValidateShipment.prototype['shipment_id'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['shipment_number'] = undefined;

/**
 * The current status of the shipment
 * @member {module:model/ShipmentStatus} shipment_status
 */
CreateAndValidateShipment.prototype['shipment_status'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['tags'] = undefined;

/**
 * @member {Array.<module:model/TaxIdentifier>} tax_identifiers
 */
CreateAndValidateShipment.prototype['tax_identifiers'] = undefined;

/**
 * The combined weight of all packages in the shipment
 * @member {module:model/Weight} total_weight
 */
CreateAndValidateShipment.prototype['total_weight'] = undefined;
 ...
 */
CreateAndValidateShipment.prototype['warehouse_id'] = undefined;

/**
 * The address validation
 * @member {module:model/AddressValidationResult} address_validation
 */
CreateAndValidateShipment.prototype['address_validation'] = undefined;

/**
 * An array of errors that occurred while creating shipment.
 * @member {Array.<String>} errors
 */
CreateAndValidateShipment.prototype['errors'] = undefined;


// Implement PartialShipment interface:
/**
 * Advanced shipment options.  These are entirely optional.
 * @member {module:model/AdvancedShipmentOptions} advanced_options
 */
...
// Implement CreateShipmentResponseBodyFields interface:
/**
 * The address validation
 * @member {module:model/AddressValidationResult} address_validation
 */
CreateShipmentResponseBodyFields.prototype['address_validation'] = undefined;
/**
 * An array of errors that occurred while creating shipment.
 * @member {Array.<String>} errors
 */
CreateShipmentResponseBodyFields.prototype['errors'] = undefined;




export default CreateAndValidateShipment;
