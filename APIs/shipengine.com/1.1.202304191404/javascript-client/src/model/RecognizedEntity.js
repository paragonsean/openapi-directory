...
class RecognizedEntity {
     ...
     * @param endIndex {Number} The index of the last character of this entity within the original text
     * @param score {Number} A confidence score between zero and one that indicates how certain the API is that it correctly recognized this entity 
     * @param startIndex {Number} The index of the first character of this entity within the original text
     * @param text {String} The substring from the original text that was recognized as this entity
     * @param type {String} The Entity type (e.g. \"weight\", \"person\", \"address_line1\", etc.)
     */
    constructor(endIndex, score, startIndex, text, type) { 
        
        RecognizedEntity.initialize(this, endIndex, score, startIndex, text, type);
    }
     ...
     */
    static initialize(obj, endIndex, score, startIndex, text, type) { 
...
RecognizedEntity.RequiredProperties = ["end_index", "score", "start_index", "text", "type"];

/**
 * The index of the last character of this entity within the original text
 * @member {Number} end_index
 */
RecognizedEntity.prototype['end_index'] = undefined;
