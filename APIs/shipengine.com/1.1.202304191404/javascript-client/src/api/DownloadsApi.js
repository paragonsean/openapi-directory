...
export default class DownloadsApi {
    ...
    */
     ...
     * @callback module:api/DownloadsApi~downloadFileCallback
     ...
     * @param {module:api/DownloadsApi~downloadFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
    downloadFile(subdir, filename, dir, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'subdir' is set
      if (subdir === undefined || subdir === null) {
        throw new Error("Missing the required parameter 'subdir' when calling downloadFile");
      }
      ...
      if (dir === undefined || dir === null) {
        throw new Error("Missing the required parameter 'dir' when calling downloadFile");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/pdf', 'application/zpl', 'image/png', 'application/json'];
      let returnType = File;
