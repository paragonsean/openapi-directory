...
public class SchedulePickupRequestBody {
  ...
  public SchedulePickupRequestBody() {
  }
  ...
  public SchedulePickupRequestBody contactDetails(ContactDetails contactDetails) {
  ...
  public SchedulePickupRequestBody labelIds(List<String> labelIds) {
    this.labelIds = labelIds;
    return this;
  }

  public SchedulePickupRequestBody addLabelIdsItem(String labelIdsItem) {
  ...
  public SchedulePickupRequestBody pickupNotes(String pickupNotes) {
  ...
  public SchedulePickupRequestBody pickupWindow(PickupWindow pickupWindow) {
  ...
  public boolean equals(Object o) {
    ...
    SchedulePickupRequestBody schedulePickupRequestBody = (SchedulePickupRequestBody) o;
    return Objects.equals(this.cancelledAt, schedulePickupRequestBody.cancelledAt) &&
        Objects.equals(this.carrierId, schedulePickupRequestBody.carrierId) &&
        Objects.equals(this.confirmationNumber, schedulePickupRequestBody.confirmationNumber) &&
        Objects.equals(this.contactDetails, schedulePickupRequestBody.contactDetails) &&
        Objects.equals(this.createdAt, schedulePickupRequestBody.createdAt) &&
        Objects.equals(this.labelIds, schedulePickupRequestBody.labelIds) &&
        Objects.equals(this.pickupAddress, schedulePickupRequestBody.pickupAddress) &&
        Objects.equals(this.pickupId, schedulePickupRequestBody.pickupId) &&
        Objects.equals(this.pickupNotes, schedulePickupRequestBody.pickupNotes) &&
        Objects.equals(this.pickupWindow, schedulePickupRequestBody.pickupWindow) &&
        Objects.equals(this.pickupWindows, schedulePickupRequestBody.pickupWindows) &&
        Objects.equals(this.warehouseId, schedulePickupRequestBody.warehouseId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cancelledAt, carrierId, confirmationNumber, contactDetails, createdAt, labelIds, pickupAddress, pickupId, pickupNotes, pickupWindow, pickupWindows, warehouseId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SchedulePickupRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchedulePickupRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SchedulePickupRequestBody is not found in the empty JSON string", SchedulePickupRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SchedulePickupRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SchedulePickupRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SchedulePickupRequestBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SchedulePickupRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SchedulePickupRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SchedulePickupRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SchedulePickupRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<SchedulePickupRequestBody>() {
           @Override
           public void write(JsonWriter out, SchedulePickupRequestBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SchedulePickupRequestBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SchedulePickupRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SchedulePickupRequestBody
   * @throws IOException if the JSON string is invalid with respect to SchedulePickupRequestBody
   */
  public static SchedulePickupRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SchedulePickupRequestBody.class);
  }

  /**
   * Convert an instance of SchedulePickupRequestBody to an JSON string
   *
   * @return JSON string
   */
