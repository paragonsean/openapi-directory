...
public class FedexSettingsResponseBody {
  ...
  public FedexSettingsResponseBody() {
  }

  public FedexSettingsResponseBody isPrimaryAccount(Boolean isPrimaryAccount) {
  ...
  public FedexSettingsResponseBody letterheadImage(String letterheadImage) {
  ...
  public FedexSettingsResponseBody nickname(String nickname) {
  ...
  public FedexSettingsResponseBody pickupType(FedexPickupType pickupType) {
  ...
  public FedexSettingsResponseBody signatureImage(String signatureImage) {
  ...
  public FedexSettingsResponseBody smartPostEndorsement(AncillaryServiceEndorsement smartPostEndorsement) {
  ...
  public FedexSettingsResponseBody smartPostHub(SmartPostHub smartPostHub) {
  ...
  public boolean equals(Object o) {
    ...
    FedexSettingsResponseBody fedexSettingsResponseBody = (FedexSettingsResponseBody) o;
    return Objects.equals(this.isPrimaryAccount, fedexSettingsResponseBody.isPrimaryAccount) &&
        Objects.equals(this.letterheadImage, fedexSettingsResponseBody.letterheadImage) &&
        Objects.equals(this.nickname, fedexSettingsResponseBody.nickname) &&
        Objects.equals(this.pickupType, fedexSettingsResponseBody.pickupType) &&
        Objects.equals(this.signatureImage, fedexSettingsResponseBody.signatureImage) &&
        Objects.equals(this.smartPostEndorsement, fedexSettingsResponseBody.smartPostEndorsement) &&
        Objects.equals(this.smartPostHub, fedexSettingsResponseBody.smartPostHub);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FedexSettingsResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FedexSettingsResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FedexSettingsResponseBody is not found in the empty JSON string", FedexSettingsResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FedexSettingsResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FedexSettingsResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FedexSettingsResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FedexSettingsResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FedexSettingsResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FedexSettingsResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<FedexSettingsResponseBody>() {
           @Override
           public void write(JsonWriter out, FedexSettingsResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FedexSettingsResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FedexSettingsResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FedexSettingsResponseBody
   * @throws IOException if the JSON string is invalid with respect to FedexSettingsResponseBody
   */
  public static FedexSettingsResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FedexSettingsResponseBody.class);
  }

  /**
   * Convert an instance of FedexSettingsResponseBody to an JSON string
   *
   * @return JSON string
   */
