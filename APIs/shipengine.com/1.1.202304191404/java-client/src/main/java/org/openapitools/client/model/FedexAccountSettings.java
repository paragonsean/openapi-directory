...
public class FedexAccountSettings {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isPrimaryAccount, fedexAccountSettings.isPrimaryAccount) &&
        Objects.equals(this.letterheadImage, fedexAccountSettings.letterheadImage) &&
        Objects.equals(this.nickname, fedexAccountSettings.nickname) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to FedexAccountSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FedexAccountSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FedexAccountSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FedexAccountSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
