...
public class ConnectNewgisticsRequestBody {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inductionSite, connectNewgisticsRequestBody.inductionSite) &&
        Objects.equals(this.mailerId, connectNewgisticsRequestBody.mailerId) &&
        Objects.equals(this.merchantId, connectNewgisticsRequestBody.merchantId) &&
        Objects.equals(this.nickname, connectNewgisticsRequestBody.nickname);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inductionSite, mailerId, merchantId, nickname);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectNewgisticsRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectNewgisticsRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectNewgisticsRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectNewgisticsRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
