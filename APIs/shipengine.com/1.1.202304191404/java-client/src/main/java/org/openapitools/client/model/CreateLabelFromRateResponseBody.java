...
public class CreateLabelFromRateResponseBody {
  ...
  public CreateLabelFromRateResponseBody() {
  }
  ...
  public CreateLabelFromRateResponseBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public CreateLabelFromRateResponseBody displayScheme(DisplayScheme displayScheme) {
  ...
  public CreateLabelFromRateResponseBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public CreateLabelFromRateResponseBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public CreateLabelFromRateResponseBody labelFormat(LabelFormat labelFormat) {
  ...
  public CreateLabelFromRateResponseBody labelImageId(String labelImageId) {
  ...
  public CreateLabelFromRateResponseBody labelLayout(LabelLayout labelLayout) {
  ...
  public CreateLabelFromRateResponseBody outboundLabelId(String outboundLabelId) {
  ...
  public CreateLabelFromRateResponseBody rmaNumber(String rmaNumber) {
  ...
  public CreateLabelFromRateResponseBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public CreateLabelFromRateResponseBody testLabel(Boolean testLabel) {
  ...
  public CreateLabelFromRateResponseBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLabelFromRateResponseBody createLabelFromRateResponseBody = (CreateLabelFromRateResponseBody) o;
    return Objects.equals(this.alternativeIdentifiers, createLabelFromRateResponseBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, createLabelFromRateResponseBody.batchId) &&
        Objects.equals(this.carrierCode, createLabelFromRateResponseBody.carrierCode) &&
        Objects.equals(this.carrierId, createLabelFromRateResponseBody.carrierId) &&
        Objects.equals(this.chargeEvent, createLabelFromRateResponseBody.chargeEvent) &&
        Objects.equals(this.createdAt, createLabelFromRateResponseBody.createdAt) &&
        Objects.equals(this.displayScheme, createLabelFromRateResponseBody.displayScheme) &&
        Objects.equals(this.formDownload, createLabelFromRateResponseBody.formDownload) &&
        Objects.equals(this.insuranceClaim, createLabelFromRateResponseBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, createLabelFromRateResponseBody.insuranceCost) &&
        Objects.equals(this.isInternational, createLabelFromRateResponseBody.isInternational) &&
        Objects.equals(this.isReturnLabel, createLabelFromRateResponseBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, createLabelFromRateResponseBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, createLabelFromRateResponseBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, createLabelFromRateResponseBody.labelFormat) &&
        Objects.equals(this.labelId, createLabelFromRateResponseBody.labelId) &&
        Objects.equals(this.labelImageId, createLabelFromRateResponseBody.labelImageId) &&
        Objects.equals(this.labelLayout, createLabelFromRateResponseBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, createLabelFromRateResponseBody.outboundLabelId) &&
        Objects.equals(this.packageCode, createLabelFromRateResponseBody.packageCode) &&
        Objects.equals(this.packages, createLabelFromRateResponseBody.packages) &&
        Objects.equals(this.rmaNumber, createLabelFromRateResponseBody.rmaNumber) &&
        Objects.equals(this.serviceCode, createLabelFromRateResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, createLabelFromRateResponseBody.shipDate) &&
        Objects.equals(this.shipment, createLabelFromRateResponseBody.shipment) &&
        Objects.equals(this.shipmentCost, createLabelFromRateResponseBody.shipmentCost) &&
        Objects.equals(this.shipmentId, createLabelFromRateResponseBody.shipmentId) &&
        Objects.equals(this.status, createLabelFromRateResponseBody.status) &&
        Objects.equals(this.testLabel, createLabelFromRateResponseBody.testLabel) &&
        Objects.equals(this.trackable, createLabelFromRateResponseBody.trackable) &&
        Objects.equals(this.trackingNumber, createLabelFromRateResponseBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, createLabelFromRateResponseBody.trackingStatus) &&
        Objects.equals(this.validateAddress, createLabelFromRateResponseBody.validateAddress) &&
        Objects.equals(this.voided, createLabelFromRateResponseBody.voided) &&
        Objects.equals(this.voidedAt, createLabelFromRateResponseBody.voidedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLabelFromRateResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLabelFromRateResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLabelFromRateResponseBody is not found in the empty JSON string", CreateLabelFromRateResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLabelFromRateResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLabelFromRateResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLabelFromRateResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLabelFromRateResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLabelFromRateResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLabelFromRateResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLabelFromRateResponseBody>() {
           @Override
           public void write(JsonWriter out, CreateLabelFromRateResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLabelFromRateResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLabelFromRateResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLabelFromRateResponseBody
   * @throws IOException if the JSON string is invalid with respect to CreateLabelFromRateResponseBody
   */
  public static CreateLabelFromRateResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLabelFromRateResponseBody.class);
  }

  /**
   * Convert an instance of CreateLabelFromRateResponseBody to an JSON string
   *
   * @return JSON string
   */
