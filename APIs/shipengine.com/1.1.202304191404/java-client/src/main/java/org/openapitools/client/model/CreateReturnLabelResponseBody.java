...
public class CreateReturnLabelResponseBody {
  ...
  public CreateReturnLabelResponseBody() {
  }
  ...
  public CreateReturnLabelResponseBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public CreateReturnLabelResponseBody displayScheme(DisplayScheme displayScheme) {
  ...
  public CreateReturnLabelResponseBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public CreateReturnLabelResponseBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public CreateReturnLabelResponseBody labelFormat(LabelFormat labelFormat) {
  ...
  public CreateReturnLabelResponseBody labelImageId(String labelImageId) {
  ...
  public CreateReturnLabelResponseBody labelLayout(LabelLayout labelLayout) {
  ...
  public CreateReturnLabelResponseBody outboundLabelId(String outboundLabelId) {
  ...
  public CreateReturnLabelResponseBody rmaNumber(String rmaNumber) {
  ...
  public CreateReturnLabelResponseBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public CreateReturnLabelResponseBody testLabel(Boolean testLabel) {
  ...
  public CreateReturnLabelResponseBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateReturnLabelResponseBody createReturnLabelResponseBody = (CreateReturnLabelResponseBody) o;
    return Objects.equals(this.alternativeIdentifiers, createReturnLabelResponseBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, createReturnLabelResponseBody.batchId) &&
        Objects.equals(this.carrierCode, createReturnLabelResponseBody.carrierCode) &&
        Objects.equals(this.carrierId, createReturnLabelResponseBody.carrierId) &&
        Objects.equals(this.chargeEvent, createReturnLabelResponseBody.chargeEvent) &&
        Objects.equals(this.createdAt, createReturnLabelResponseBody.createdAt) &&
        Objects.equals(this.displayScheme, createReturnLabelResponseBody.displayScheme) &&
        Objects.equals(this.formDownload, createReturnLabelResponseBody.formDownload) &&
        Objects.equals(this.insuranceClaim, createReturnLabelResponseBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, createReturnLabelResponseBody.insuranceCost) &&
        Objects.equals(this.isInternational, createReturnLabelResponseBody.isInternational) &&
        Objects.equals(this.isReturnLabel, createReturnLabelResponseBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, createReturnLabelResponseBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, createReturnLabelResponseBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, createReturnLabelResponseBody.labelFormat) &&
        Objects.equals(this.labelId, createReturnLabelResponseBody.labelId) &&
        Objects.equals(this.labelImageId, createReturnLabelResponseBody.labelImageId) &&
        Objects.equals(this.labelLayout, createReturnLabelResponseBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, createReturnLabelResponseBody.outboundLabelId) &&
        Objects.equals(this.packageCode, createReturnLabelResponseBody.packageCode) &&
        Objects.equals(this.packages, createReturnLabelResponseBody.packages) &&
        Objects.equals(this.rmaNumber, createReturnLabelResponseBody.rmaNumber) &&
        Objects.equals(this.serviceCode, createReturnLabelResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, createReturnLabelResponseBody.shipDate) &&
        Objects.equals(this.shipment, createReturnLabelResponseBody.shipment) &&
        Objects.equals(this.shipmentCost, createReturnLabelResponseBody.shipmentCost) &&
        Objects.equals(this.shipmentId, createReturnLabelResponseBody.shipmentId) &&
        Objects.equals(this.status, createReturnLabelResponseBody.status) &&
        Objects.equals(this.testLabel, createReturnLabelResponseBody.testLabel) &&
        Objects.equals(this.trackable, createReturnLabelResponseBody.trackable) &&
        Objects.equals(this.trackingNumber, createReturnLabelResponseBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, createReturnLabelResponseBody.trackingStatus) &&
        Objects.equals(this.validateAddress, createReturnLabelResponseBody.validateAddress) &&
        Objects.equals(this.voided, createReturnLabelResponseBody.voided) &&
        Objects.equals(this.voidedAt, createReturnLabelResponseBody.voidedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateReturnLabelResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateReturnLabelResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateReturnLabelResponseBody is not found in the empty JSON string", CreateReturnLabelResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateReturnLabelResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateReturnLabelResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateReturnLabelResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateReturnLabelResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateReturnLabelResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateReturnLabelResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateReturnLabelResponseBody>() {
           @Override
           public void write(JsonWriter out, CreateReturnLabelResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateReturnLabelResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateReturnLabelResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateReturnLabelResponseBody
   * @throws IOException if the JSON string is invalid with respect to CreateReturnLabelResponseBody
   */
  public static CreateReturnLabelResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateReturnLabelResponseBody.class);
  }

  /**
   * Convert an instance of CreateReturnLabelResponseBody to an JSON string
   *
   * @return JSON string
   */
