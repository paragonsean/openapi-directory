...
public class ModifyBatch {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rateIds, modifyBatch.rateIds) &&
        Objects.equals(this.shipmentIds, modifyBatch.shipmentIds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyBatch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyBatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyBatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyBatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
