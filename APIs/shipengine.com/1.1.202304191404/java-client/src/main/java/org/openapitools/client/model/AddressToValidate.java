...
public class AddressToValidate {
  ...
  public AddressToValidate addressLine1(String addressLine1) {
  ...
  public AddressToValidate addressLine2(String addressLine2) {
  ...
  public AddressToValidate addressLine3(String addressLine3) {
  ...
  public AddressToValidate addressResidentialIndicator(AddressResidentialIndicator addressResidentialIndicator) {
  ...
  public AddressToValidate cityLocality(String cityLocality) {
  ...
  public AddressToValidate companyName(String companyName) {
  ...
  public AddressToValidate countryCode(String countryCode) {
  ...
  public AddressToValidate email(String email) {
    this.email = email;
    return this;
  }
  ...
  public AddressToValidate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AddressToValidate phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public AddressToValidate postalCode(String postalCode) {
  ...
  public AddressToValidate stateProvince(String stateProvince) {
  ...
  public boolean equals(Object o) {
    ...
    AddressToValidate addressToValidate = (AddressToValidate) o;
    return Objects.equals(this.addressLine1, addressToValidate.addressLine1) &&
        Objects.equals(this.addressLine2, addressToValidate.addressLine2) &&
        Objects.equals(this.addressLine3, addressToValidate.addressLine3) &&
        Objects.equals(this.addressResidentialIndicator, addressToValidate.addressResidentialIndicator) &&
        Objects.equals(this.cityLocality, addressToValidate.cityLocality) &&
        Objects.equals(this.companyName, addressToValidate.companyName) &&
        Objects.equals(this.countryCode, addressToValidate.countryCode) &&
        Objects.equals(this.email, addressToValidate.email) &&
        Objects.equals(this.name, addressToValidate.name) &&
        Objects.equals(this.phone, addressToValidate.phone) &&
        Objects.equals(this.postalCode, addressToValidate.postalCode) &&
        Objects.equals(this.stateProvince, addressToValidate.stateProvince);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddressToValidate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressToValidate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressToValidate is not found in the empty JSON string", AddressToValidate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressToValidate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressToValidate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddressToValidate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressToValidate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressToValidate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressToValidate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressToValidate.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressToValidate>() {
           @Override
           public void write(JsonWriter out, AddressToValidate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddressToValidate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddressToValidate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddressToValidate
   * @throws IOException if the JSON string is invalid with respect to AddressToValidate
   */
  public static AddressToValidate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressToValidate.class);
  }

  /**
   * Convert an instance of AddressToValidate to an JSON string
   *
   * @return JSON string
   */
