...
public class PartialShipment {
  ...
  private InternationalShipmentOptions customs = null;
  ...
  public PartialShipment advancedOptions(AdvancedShipmentOptions advancedOptions) {
  ...
  public PartialShipment carrierId(String carrierId) {
  ...
  public PartialShipment confirmation(DeliveryConfirmation confirmation) {
  ...
  public PartialShipment customs(InternationalShipmentOptions customs) {
  ...
  public PartialShipment externalOrderId(String externalOrderId) {
  ...
  public PartialShipment externalShipmentId(String externalShipmentId) {
  ...
  public PartialShipment insuranceProvider(InsuranceProvider insuranceProvider) {
  ...
  public PartialShipment isReturn(Boolean isReturn) {
  ...
  public PartialShipment items(List<ShipmentItem> items) {
    this.items = items;
    return this;
  }

  public PartialShipment addItemsItem(ShipmentItem itemsItem) {
    if (this.items == null) {
  ...
  public PartialShipment orderSourceCode(OrderSourceName orderSourceCode) {
  ...
  public PartialShipment originType(OriginType originType) {
  ...
  public PartialShipment packages(List<ModelPackage> packages) {
    this.packages = packages;
    return this;
  }

  public PartialShipment addPackagesItem(ModelPackage packagesItem) {
  ...
  public PartialShipment returnTo(ShippingAddress returnTo) {
  ...
  public PartialShipment serviceCode(String serviceCode) {
  ...
  public PartialShipment shipDate(OffsetDateTime shipDate) {
  ...
  public PartialShipment shipFrom(ShippingAddress shipFrom) {
  ...
  public PartialShipment shipTo(ShippingAddress shipTo) {
    this.shipTo = shipTo;
    return this;
  }
  ...
  public PartialShipment shipmentNumber(String shipmentNumber) {
  ...
  public PartialShipment taxIdentifiers(List<TaxIdentifier> taxIdentifiers) {
    this.taxIdentifiers = taxIdentifiers;
    return this;
  }

  public PartialShipment addTaxIdentifiersItem(TaxIdentifier taxIdentifiersItem) {
  ...
  public PartialShipment warehouseId(String warehouseId) {
  ...
  public boolean equals(Object o) {
    ...
    PartialShipment partialShipment = (PartialShipment) o;
    return Objects.equals(this.advancedOptions, partialShipment.advancedOptions) &&
        Objects.equals(this.carrierId, partialShipment.carrierId) &&
        Objects.equals(this.confirmation, partialShipment.confirmation) &&
        Objects.equals(this.createdAt, partialShipment.createdAt) &&
        Objects.equals(this.customs, partialShipment.customs) &&
        Objects.equals(this.externalOrderId, partialShipment.externalOrderId) &&
        Objects.equals(this.externalShipmentId, partialShipment.externalShipmentId) &&
        Objects.equals(this.insuranceProvider, partialShipment.insuranceProvider) &&
        Objects.equals(this.isReturn, partialShipment.isReturn) &&
        Objects.equals(this.items, partialShipment.items) &&
        Objects.equals(this.modifiedAt, partialShipment.modifiedAt) &&
        Objects.equals(this.orderSourceCode, partialShipment.orderSourceCode) &&
        Objects.equals(this.originType, partialShipment.originType) &&
        Objects.equals(this.packages, partialShipment.packages) &&
        Objects.equals(this.returnTo, partialShipment.returnTo) &&
        Objects.equals(this.serviceCode, partialShipment.serviceCode) &&
        Objects.equals(this.shipDate, partialShipment.shipDate) &&
        Objects.equals(this.shipFrom, partialShipment.shipFrom) &&
        Objects.equals(this.shipTo, partialShipment.shipTo) &&
        Objects.equals(this.shipmentId, partialShipment.shipmentId) &&
        Objects.equals(this.shipmentNumber, partialShipment.shipmentNumber) &&
        Objects.equals(this.shipmentStatus, partialShipment.shipmentStatus) &&
        Objects.equals(this.tags, partialShipment.tags) &&
        Objects.equals(this.taxIdentifiers, partialShipment.taxIdentifiers) &&
        Objects.equals(this.totalWeight, partialShipment.totalWeight) &&
        Objects.equals(this.warehouseId, partialShipment.warehouseId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PartialShipment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PartialShipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PartialShipment is not found in the empty JSON string", PartialShipment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PartialShipment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PartialShipment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PartialShipment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PartialShipment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PartialShipment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PartialShipment.class));

       return (TypeAdapter<T>) new TypeAdapter<PartialShipment>() {
           @Override
           public void write(JsonWriter out, PartialShipment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PartialShipment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PartialShipment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PartialShipment
   * @throws IOException if the JSON string is invalid with respect to PartialShipment
   */
  public static PartialShipment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PartialShipment.class);
  }

  /**
   * Convert an instance of PartialShipment to an JSON string
   *
   * @return JSON string
   */
