...
public class CreateLabelFromRateRequestBody {
  ...
  public CreateLabelFromRateRequestBody displayScheme(DisplayScheme displayScheme) {
  ...
  public CreateLabelFromRateRequestBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public CreateLabelFromRateRequestBody labelFormat(LabelFormat labelFormat) {
  ...
  public CreateLabelFromRateRequestBody labelLayout(LabelLayout labelLayout) {
  ...
  public CreateLabelFromRateRequestBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLabelFromRateRequestBody createLabelFromRateRequestBody = (CreateLabelFromRateRequestBody) o;
    return Objects.equals(this.displayScheme, createLabelFromRateRequestBody.displayScheme) &&
        Objects.equals(this.labelDownloadType, createLabelFromRateRequestBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, createLabelFromRateRequestBody.labelFormat) &&
        Objects.equals(this.labelLayout, createLabelFromRateRequestBody.labelLayout) &&
        Objects.equals(this.validateAddress, createLabelFromRateRequestBody.validateAddress);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLabelFromRateRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLabelFromRateRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLabelFromRateRequestBody is not found in the empty JSON string", CreateLabelFromRateRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLabelFromRateRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLabelFromRateRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLabelFromRateRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLabelFromRateRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLabelFromRateRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLabelFromRateRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLabelFromRateRequestBody>() {
           @Override
           public void write(JsonWriter out, CreateLabelFromRateRequestBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLabelFromRateRequestBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLabelFromRateRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLabelFromRateRequestBody
   * @throws IOException if the JSON string is invalid with respect to CreateLabelFromRateRequestBody
   */
  public static CreateLabelFromRateRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLabelFromRateRequestBody.class);
  }

  /**
   * Convert an instance of CreateLabelFromRateRequestBody to an JSON string
   *
   * @return JSON string
   */
