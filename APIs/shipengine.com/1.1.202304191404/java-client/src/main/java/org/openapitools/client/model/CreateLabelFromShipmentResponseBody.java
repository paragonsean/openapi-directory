...
public class CreateLabelFromShipmentResponseBody {
  ...
  public CreateLabelFromShipmentResponseBody() {
  }
  ...
  public CreateLabelFromShipmentResponseBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public CreateLabelFromShipmentResponseBody displayScheme(DisplayScheme displayScheme) {
  ...
  public CreateLabelFromShipmentResponseBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public CreateLabelFromShipmentResponseBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public CreateLabelFromShipmentResponseBody labelFormat(LabelFormat labelFormat) {
  ...
  public CreateLabelFromShipmentResponseBody labelImageId(String labelImageId) {
  ...
  public CreateLabelFromShipmentResponseBody labelLayout(LabelLayout labelLayout) {
  ...
  public CreateLabelFromShipmentResponseBody outboundLabelId(String outboundLabelId) {
  ...
  public CreateLabelFromShipmentResponseBody rmaNumber(String rmaNumber) {
  ...
  public CreateLabelFromShipmentResponseBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public CreateLabelFromShipmentResponseBody testLabel(Boolean testLabel) {
  ...
  public CreateLabelFromShipmentResponseBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLabelFromShipmentResponseBody createLabelFromShipmentResponseBody = (CreateLabelFromShipmentResponseBody) o;
    return Objects.equals(this.alternativeIdentifiers, createLabelFromShipmentResponseBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, createLabelFromShipmentResponseBody.batchId) &&
        Objects.equals(this.carrierCode, createLabelFromShipmentResponseBody.carrierCode) &&
        Objects.equals(this.carrierId, createLabelFromShipmentResponseBody.carrierId) &&
        Objects.equals(this.chargeEvent, createLabelFromShipmentResponseBody.chargeEvent) &&
        Objects.equals(this.createdAt, createLabelFromShipmentResponseBody.createdAt) &&
        Objects.equals(this.displayScheme, createLabelFromShipmentResponseBody.displayScheme) &&
        Objects.equals(this.formDownload, createLabelFromShipmentResponseBody.formDownload) &&
        Objects.equals(this.insuranceClaim, createLabelFromShipmentResponseBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, createLabelFromShipmentResponseBody.insuranceCost) &&
        Objects.equals(this.isInternational, createLabelFromShipmentResponseBody.isInternational) &&
        Objects.equals(this.isReturnLabel, createLabelFromShipmentResponseBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, createLabelFromShipmentResponseBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, createLabelFromShipmentResponseBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, createLabelFromShipmentResponseBody.labelFormat) &&
        Objects.equals(this.labelId, createLabelFromShipmentResponseBody.labelId) &&
        Objects.equals(this.labelImageId, createLabelFromShipmentResponseBody.labelImageId) &&
        Objects.equals(this.labelLayout, createLabelFromShipmentResponseBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, createLabelFromShipmentResponseBody.outboundLabelId) &&
        Objects.equals(this.packageCode, createLabelFromShipmentResponseBody.packageCode) &&
        Objects.equals(this.packages, createLabelFromShipmentResponseBody.packages) &&
        Objects.equals(this.rmaNumber, createLabelFromShipmentResponseBody.rmaNumber) &&
        Objects.equals(this.serviceCode, createLabelFromShipmentResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, createLabelFromShipmentResponseBody.shipDate) &&
        Objects.equals(this.shipment, createLabelFromShipmentResponseBody.shipment) &&
        Objects.equals(this.shipmentCost, createLabelFromShipmentResponseBody.shipmentCost) &&
        Objects.equals(this.shipmentId, createLabelFromShipmentResponseBody.shipmentId) &&
        Objects.equals(this.status, createLabelFromShipmentResponseBody.status) &&
        Objects.equals(this.testLabel, createLabelFromShipmentResponseBody.testLabel) &&
        Objects.equals(this.trackable, createLabelFromShipmentResponseBody.trackable) &&
        Objects.equals(this.trackingNumber, createLabelFromShipmentResponseBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, createLabelFromShipmentResponseBody.trackingStatus) &&
        Objects.equals(this.validateAddress, createLabelFromShipmentResponseBody.validateAddress) &&
        Objects.equals(this.voided, createLabelFromShipmentResponseBody.voided) &&
        Objects.equals(this.voidedAt, createLabelFromShipmentResponseBody.voidedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLabelFromShipmentResponseBody {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLabelFromShipmentResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLabelFromShipmentResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLabelFromShipmentResponseBody is not found in the empty JSON string", CreateLabelFromShipmentResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLabelFromShipmentResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLabelFromShipmentResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLabelFromShipmentResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLabelFromShipmentResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLabelFromShipmentResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLabelFromShipmentResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLabelFromShipmentResponseBody>() {
           @Override
           public void write(JsonWriter out, CreateLabelFromShipmentResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLabelFromShipmentResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLabelFromShipmentResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLabelFromShipmentResponseBody
   * @throws IOException if the JSON string is invalid with respect to CreateLabelFromShipmentResponseBody
   */
  public static CreateLabelFromShipmentResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLabelFromShipmentResponseBody.class);
  }

  /**
   * Convert an instance of CreateLabelFromShipmentResponseBody to an JSON string
   *
   * @return JSON string
   */
