...
public class ConnectFirstmileRequestBody {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mailerId, connectFirstmileRequestBody.mailerId) &&
        Objects.equals(this.nickname, connectFirstmileRequestBody.nickname) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mailerId, nickname, password, profileName);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectFirstmileRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectFirstmileRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectFirstmileRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConnectFirstmileRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
