...
public class UpsAccountSettings {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountPostalCode, upsAccountSettings.accountPostalCode) &&
        ...
        Objects.equals(this.nickname, upsAccountSettings.nickname) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsAccountSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsAccountSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsAccountSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsAccountSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
