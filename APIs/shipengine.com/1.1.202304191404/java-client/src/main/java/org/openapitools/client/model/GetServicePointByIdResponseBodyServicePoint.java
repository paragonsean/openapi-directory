...
public class GetServicePointByIdResponseBodyServicePoint {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressLine1, getServicePointByIdResponseBodyServicePoint.addressLine1) &&
        Objects.equals(this.carrierCode, getServicePointByIdResponseBodyServicePoint.carrierCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressLine1, carrierCode, cityLocality, companyName, countryCode, features, hoursOfOperation, lat, _long, phoneNumber, postalCode, serviceCodes, servicePointId, stateProvince, type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetServicePointByIdResponseBodyServicePoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetServicePointByIdResponseBodyServicePoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetServicePointByIdResponseBodyServicePoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetServicePointByIdResponseBodyServicePoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
