...
public class AddressValidatingShipment {
  ...
  public AddressValidatingShipment customs(InternationalShipmentOptions customs) {
  ...
  public AddressValidatingShipment originType(OriginType originType) {
  ...
  public AddressValidatingShipment shipTo(ShippingAddress shipTo) {
    this.shipTo = shipTo;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.validateAddress, addressValidatingShipment.validateAddress) &&
        ...
        Objects.equals(this.originType, addressValidatingShipment.originType) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddressValidatingShipment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressValidatingShipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressValidatingShipment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressValidatingShipment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
