...
public class CreateLabelResponseBody {
  ...
  public CreateLabelResponseBody() {
  }
  ...
  public CreateLabelResponseBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public CreateLabelResponseBody displayScheme(DisplayScheme displayScheme) {
  ...
  public CreateLabelResponseBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public CreateLabelResponseBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public CreateLabelResponseBody labelFormat(LabelFormat labelFormat) {
  ...
  public CreateLabelResponseBody labelImageId(String labelImageId) {
  ...
  public CreateLabelResponseBody labelLayout(LabelLayout labelLayout) {
  ...
  public CreateLabelResponseBody outboundLabelId(String outboundLabelId) {
  ...
  public CreateLabelResponseBody rmaNumber(String rmaNumber) {
  ...
  public CreateLabelResponseBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public CreateLabelResponseBody testLabel(Boolean testLabel) {
  ...
  public CreateLabelResponseBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLabelResponseBody createLabelResponseBody = (CreateLabelResponseBody) o;
    return Objects.equals(this.alternativeIdentifiers, createLabelResponseBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, createLabelResponseBody.batchId) &&
        Objects.equals(this.carrierCode, createLabelResponseBody.carrierCode) &&
        Objects.equals(this.carrierId, createLabelResponseBody.carrierId) &&
        Objects.equals(this.chargeEvent, createLabelResponseBody.chargeEvent) &&
        Objects.equals(this.createdAt, createLabelResponseBody.createdAt) &&
        Objects.equals(this.displayScheme, createLabelResponseBody.displayScheme) &&
        Objects.equals(this.formDownload, createLabelResponseBody.formDownload) &&
        Objects.equals(this.insuranceClaim, createLabelResponseBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, createLabelResponseBody.insuranceCost) &&
        Objects.equals(this.isInternational, createLabelResponseBody.isInternational) &&
        Objects.equals(this.isReturnLabel, createLabelResponseBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, createLabelResponseBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, createLabelResponseBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, createLabelResponseBody.labelFormat) &&
        Objects.equals(this.labelId, createLabelResponseBody.labelId) &&
        Objects.equals(this.labelImageId, createLabelResponseBody.labelImageId) &&
        Objects.equals(this.labelLayout, createLabelResponseBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, createLabelResponseBody.outboundLabelId) &&
        Objects.equals(this.packageCode, createLabelResponseBody.packageCode) &&
        Objects.equals(this.packages, createLabelResponseBody.packages) &&
        Objects.equals(this.rmaNumber, createLabelResponseBody.rmaNumber) &&
        Objects.equals(this.serviceCode, createLabelResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, createLabelResponseBody.shipDate) &&
        Objects.equals(this.shipment, createLabelResponseBody.shipment) &&
        Objects.equals(this.shipmentCost, createLabelResponseBody.shipmentCost) &&
        Objects.equals(this.shipmentId, createLabelResponseBody.shipmentId) &&
        Objects.equals(this.status, createLabelResponseBody.status) &&
        Objects.equals(this.testLabel, createLabelResponseBody.testLabel) &&
        Objects.equals(this.trackable, createLabelResponseBody.trackable) &&
        Objects.equals(this.trackingNumber, createLabelResponseBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, createLabelResponseBody.trackingStatus) &&
        Objects.equals(this.validateAddress, createLabelResponseBody.validateAddress) &&
        Objects.equals(this.voided, createLabelResponseBody.voided) &&
        Objects.equals(this.voidedAt, createLabelResponseBody.voidedAt);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("charge_event");
    openapiRequiredFields.add("created_at");
    openapiRequiredFields.add("display_scheme");
    openapiRequiredFields.add("form_download");
    openapiRequiredFields.add("insurance_claim");
    openapiRequiredFields.add("insurance_cost");
    openapiRequiredFields.add("is_international");
    openapiRequiredFields.add("is_return_label");
    openapiRequiredFields.add("label_download");
    openapiRequiredFields.add("label_format");
    openapiRequiredFields.add("label_id");
    openapiRequiredFields.add("label_image_id");
    openapiRequiredFields.add("label_layout");
    openapiRequiredFields.add("package_code");
    openapiRequiredFields.add("packages");
    openapiRequiredFields.add("rma_number");
    openapiRequiredFields.add("service_code");
    openapiRequiredFields.add("ship_date");
    openapiRequiredFields.add("shipment_cost");
    openapiRequiredFields.add("shipment_id");
    openapiRequiredFields.add("status");
    openapiRequiredFields.add("trackable");
    openapiRequiredFields.add("tracking_number");
    openapiRequiredFields.add("tracking_status");
    openapiRequiredFields.add("voided");
    openapiRequiredFields.add("voided_at");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLabelResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLabelResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLabelResponseBody is not found in the empty JSON string", CreateLabelResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLabelResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLabelResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLabelResponseBody.openapiRequiredFields) {
      ...
      // validate the required field `charge_event`
      LabelChargeEvent.validateJsonElement(jsonObj.get("charge_event"));
      // validate the required field `display_scheme`
      ...
      // validate the required field `insurance_claim`
      Link.validateJsonElement(jsonObj.get("insurance_claim"));
      // validate the required field `insurance_cost`
      ...
      // validate the required field `shipment_cost`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLabelResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLabelResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLabelResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLabelResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLabelResponseBody>() {
           @Override
           public void write(JsonWriter out, CreateLabelResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLabelResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLabelResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLabelResponseBody
   * @throws IOException if the JSON string is invalid with respect to CreateLabelResponseBody
   */
  public static CreateLabelResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLabelResponseBody.class);
  }

  /**
   * Convert an instance of CreateLabelResponseBody to an JSON string
   *
   * @return JSON string
   */
