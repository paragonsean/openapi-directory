...
public class UpsSettingsResponseBody {
  ...
  public UpsSettingsResponseBody accountPostalCode(String accountPostalCode) {
  ...
  public UpsSettingsResponseBody invoice(UpsInvoice invoice) {
  ...
  public UpsSettingsResponseBody isPrimaryAccount(Boolean isPrimaryAccount) {
  ...
  public UpsSettingsResponseBody mailInnovationsCostCenter(String mailInnovationsCostCenter) {
  ...
  public UpsSettingsResponseBody mailInnovationsEndorsement(AncillaryServiceEndorsement mailInnovationsEndorsement) {
  ...
  public UpsSettingsResponseBody nickname(String nickname) {
  ...
  public UpsSettingsResponseBody pickupType(UpsPickupType pickupType) {
  ...
  public UpsSettingsResponseBody useCarbonNeutralShippingProgram(Boolean useCarbonNeutralShippingProgram) {
  ...
  public UpsSettingsResponseBody useConsolidationServices(Boolean useConsolidationServices) {
  ...
  public UpsSettingsResponseBody useGroundFreightPricing(Boolean useGroundFreightPricing) {
  ...
  public UpsSettingsResponseBody useNegotiatedRates(Boolean useNegotiatedRates) {
  ...
  public UpsSettingsResponseBody useOrderNumberOnMailInnovationsLabels(Boolean useOrderNumberOnMailInnovationsLabels) {
  ...
  public boolean equals(Object o) {
    ...
    UpsSettingsResponseBody upsSettingsResponseBody = (UpsSettingsResponseBody) o;
    return Objects.equals(this.accountPostalCode, upsSettingsResponseBody.accountPostalCode) &&
        Objects.equals(this.invoice, upsSettingsResponseBody.invoice) &&
        Objects.equals(this.isPrimaryAccount, upsSettingsResponseBody.isPrimaryAccount) &&
        Objects.equals(this.mailInnovationsCostCenter, upsSettingsResponseBody.mailInnovationsCostCenter) &&
        Objects.equals(this.mailInnovationsEndorsement, upsSettingsResponseBody.mailInnovationsEndorsement) &&
        Objects.equals(this.nickname, upsSettingsResponseBody.nickname) &&
        Objects.equals(this.pickupType, upsSettingsResponseBody.pickupType) &&
        Objects.equals(this.useCarbonNeutralShippingProgram, upsSettingsResponseBody.useCarbonNeutralShippingProgram) &&
        Objects.equals(this.useConsolidationServices, upsSettingsResponseBody.useConsolidationServices) &&
        Objects.equals(this.useGroundFreightPricing, upsSettingsResponseBody.useGroundFreightPricing) &&
        Objects.equals(this.useNegotiatedRates, upsSettingsResponseBody.useNegotiatedRates) &&
        Objects.equals(this.useOrderNumberOnMailInnovationsLabels, upsSettingsResponseBody.useOrderNumberOnMailInnovationsLabels);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpsSettingsResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpsSettingsResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpsSettingsResponseBody is not found in the empty JSON string", UpsSettingsResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsSettingsResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsSettingsResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpsSettingsResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpsSettingsResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpsSettingsResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpsSettingsResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<UpsSettingsResponseBody>() {
           @Override
           public void write(JsonWriter out, UpsSettingsResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpsSettingsResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpsSettingsResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsSettingsResponseBody
   * @throws IOException if the JSON string is invalid with respect to UpsSettingsResponseBody
   */
  public static UpsSettingsResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpsSettingsResponseBody.class);
  }

  /**
   * Convert an instance of UpsSettingsResponseBody to an JSON string
   *
   * @return JSON string
   */
