...
public class PickupResponseBody {
  ...
  public PickupResponseBody contactDetails(ContactDetails contactDetails) {
  ...
  public PickupResponseBody labelIds(List<String> labelIds) {
    this.labelIds = labelIds;
    return this;
  }

  public PickupResponseBody addLabelIdsItem(String labelIdsItem) {
  ...
  public PickupResponseBody pickupNotes(String pickupNotes) {
  ...
  public PickupResponseBody pickupWindow(PickupWindow pickupWindow) {
  ...
  public boolean equals(Object o) {
    ...
    PickupResponseBody pickupResponseBody = (PickupResponseBody) o;
    return Objects.equals(this.cancelledAt, pickupResponseBody.cancelledAt) &&
        Objects.equals(this.carrierId, pickupResponseBody.carrierId) &&
        Objects.equals(this.confirmationNumber, pickupResponseBody.confirmationNumber) &&
        Objects.equals(this.contactDetails, pickupResponseBody.contactDetails) &&
        Objects.equals(this.createdAt, pickupResponseBody.createdAt) &&
        Objects.equals(this.labelIds, pickupResponseBody.labelIds) &&
        Objects.equals(this.pickupAddress, pickupResponseBody.pickupAddress) &&
        Objects.equals(this.pickupId, pickupResponseBody.pickupId) &&
        Objects.equals(this.pickupNotes, pickupResponseBody.pickupNotes) &&
        Objects.equals(this.pickupWindow, pickupResponseBody.pickupWindow) &&
        Objects.equals(this.pickupWindows, pickupResponseBody.pickupWindows) &&
        Objects.equals(this.warehouseId, pickupResponseBody.warehouseId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PickupResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PickupResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PickupResponseBody is not found in the empty JSON string", PickupResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PickupResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PickupResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PickupResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PickupResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PickupResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PickupResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PickupResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<PickupResponseBody>() {
           @Override
           public void write(JsonWriter out, PickupResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PickupResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PickupResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PickupResponseBody
   * @throws IOException if the JSON string is invalid with respect to PickupResponseBody
   */
  public static PickupResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PickupResponseBody.class);
  }

  /**
   * Convert an instance of PickupResponseBody to an JSON string
   *
   * @return JSON string
   */
