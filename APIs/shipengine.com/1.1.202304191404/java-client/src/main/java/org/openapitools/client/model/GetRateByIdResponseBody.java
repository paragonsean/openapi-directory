...
public class GetRateByIdResponseBody {
  ...
  public GetRateByIdResponseBody() {
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRateByIdResponseBody getRateByIdResponseBody = (GetRateByIdResponseBody) o;
    return Objects.equals(this.carrierCode, getRateByIdResponseBody.carrierCode) &&
        Objects.equals(this.carrierDeliveryDays, getRateByIdResponseBody.carrierDeliveryDays) &&
        Objects.equals(this.carrierFriendlyName, getRateByIdResponseBody.carrierFriendlyName) &&
        Objects.equals(this.carrierId, getRateByIdResponseBody.carrierId) &&
        Objects.equals(this.carrierNickname, getRateByIdResponseBody.carrierNickname) &&
        Objects.equals(this.confirmationAmount, getRateByIdResponseBody.confirmationAmount) &&
        Objects.equals(this.deliveryDays, getRateByIdResponseBody.deliveryDays) &&
        Objects.equals(this.errorMessages, getRateByIdResponseBody.errorMessages) &&
        Objects.equals(this.estimatedDeliveryDate, getRateByIdResponseBody.estimatedDeliveryDate) &&
        Objects.equals(this.guaranteedService, getRateByIdResponseBody.guaranteedService) &&
        Objects.equals(this.insuranceAmount, getRateByIdResponseBody.insuranceAmount) &&
        Objects.equals(this.negotiatedRate, getRateByIdResponseBody.negotiatedRate) &&
        Objects.equals(this.otherAmount, getRateByIdResponseBody.otherAmount) &&
        Objects.equals(this.packageType, getRateByIdResponseBody.packageType) &&
        Objects.equals(this.rateId, getRateByIdResponseBody.rateId) &&
        Objects.equals(this.rateType, getRateByIdResponseBody.rateType) &&
        Objects.equals(this.serviceCode, getRateByIdResponseBody.serviceCode) &&
        Objects.equals(this.serviceType, getRateByIdResponseBody.serviceType) &&
        Objects.equals(this.shipDate, getRateByIdResponseBody.shipDate) &&
        Objects.equals(this.shippingAmount, getRateByIdResponseBody.shippingAmount) &&
        Objects.equals(this.taxAmount, getRateByIdResponseBody.taxAmount) &&
        Objects.equals(this.trackable, getRateByIdResponseBody.trackable) &&
        Objects.equals(this.validationStatus, getRateByIdResponseBody.validationStatus) &&
        Objects.equals(this.warningMessages, getRateByIdResponseBody.warningMessages) &&
        Objects.equals(this.zone, getRateByIdResponseBody.zone);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRateByIdResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRateByIdResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRateByIdResponseBody is not found in the empty JSON string", GetRateByIdResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRateByIdResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRateByIdResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRateByIdResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRateByIdResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRateByIdResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRateByIdResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRateByIdResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRateByIdResponseBody>() {
           @Override
           public void write(JsonWriter out, GetRateByIdResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRateByIdResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRateByIdResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRateByIdResponseBody
   * @throws IOException if the JSON string is invalid with respect to GetRateByIdResponseBody
   */
  public static GetRateByIdResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRateByIdResponseBody.class);
  }

  /**
   * Convert an instance of GetRateByIdResponseBody to an JSON string
   *
   * @return JSON string
   */
