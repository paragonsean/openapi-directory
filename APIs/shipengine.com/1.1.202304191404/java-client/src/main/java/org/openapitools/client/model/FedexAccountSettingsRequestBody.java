...
public class FedexAccountSettingsRequestBody {
  ...
  public FedexAccountSettingsRequestBody() {
  }

  public FedexAccountSettingsRequestBody isPrimaryAccount(Boolean isPrimaryAccount) {
  ...
  public FedexAccountSettingsRequestBody letterheadImage(String letterheadImage) {
  ...
  public FedexAccountSettingsRequestBody nickname(String nickname) {
  ...
  public FedexAccountSettingsRequestBody pickupType(FedexPickupType pickupType) {
  ...
  public FedexAccountSettingsRequestBody signatureImage(String signatureImage) {
  ...
  public FedexAccountSettingsRequestBody smartPostEndorsement(AncillaryServiceEndorsement smartPostEndorsement) {
  ...
  public FedexAccountSettingsRequestBody smartPostHub(SmartPostHub smartPostHub) {
  ...
  public boolean equals(Object o) {
    ...
    FedexAccountSettingsRequestBody fedexAccountSettingsRequestBody = (FedexAccountSettingsRequestBody) o;
    return Objects.equals(this.isPrimaryAccount, fedexAccountSettingsRequestBody.isPrimaryAccount) &&
        Objects.equals(this.letterheadImage, fedexAccountSettingsRequestBody.letterheadImage) &&
        Objects.equals(this.nickname, fedexAccountSettingsRequestBody.nickname) &&
        Objects.equals(this.pickupType, fedexAccountSettingsRequestBody.pickupType) &&
        Objects.equals(this.signatureImage, fedexAccountSettingsRequestBody.signatureImage) &&
        Objects.equals(this.smartPostEndorsement, fedexAccountSettingsRequestBody.smartPostEndorsement) &&
        Objects.equals(this.smartPostHub, fedexAccountSettingsRequestBody.smartPostHub);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FedexAccountSettingsRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FedexAccountSettingsRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FedexAccountSettingsRequestBody is not found in the empty JSON string", FedexAccountSettingsRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FedexAccountSettingsRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FedexAccountSettingsRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FedexAccountSettingsRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FedexAccountSettingsRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FedexAccountSettingsRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FedexAccountSettingsRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<FedexAccountSettingsRequestBody>() {
           @Override
           public void write(JsonWriter out, FedexAccountSettingsRequestBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FedexAccountSettingsRequestBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FedexAccountSettingsRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FedexAccountSettingsRequestBody
   * @throws IOException if the JSON string is invalid with respect to FedexAccountSettingsRequestBody
   */
  public static FedexAccountSettingsRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FedexAccountSettingsRequestBody.class);
  }

  /**
   * Convert an instance of FedexAccountSettingsRequestBody to an JSON string
   *
   * @return JSON string
   */
