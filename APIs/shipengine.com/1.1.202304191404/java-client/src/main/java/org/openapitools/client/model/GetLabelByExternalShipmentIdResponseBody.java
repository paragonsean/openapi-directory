...
public class GetLabelByExternalShipmentIdResponseBody {
  ...
  public GetLabelByExternalShipmentIdResponseBody() {
  }
  ...
  public GetLabelByExternalShipmentIdResponseBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public GetLabelByExternalShipmentIdResponseBody displayScheme(DisplayScheme displayScheme) {
  ...
  public GetLabelByExternalShipmentIdResponseBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public GetLabelByExternalShipmentIdResponseBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public GetLabelByExternalShipmentIdResponseBody labelFormat(LabelFormat labelFormat) {
  ...
  public GetLabelByExternalShipmentIdResponseBody labelImageId(String labelImageId) {
  ...
  public GetLabelByExternalShipmentIdResponseBody labelLayout(LabelLayout labelLayout) {
  ...
  public GetLabelByExternalShipmentIdResponseBody outboundLabelId(String outboundLabelId) {
  ...
  public GetLabelByExternalShipmentIdResponseBody rmaNumber(String rmaNumber) {
  ...
  public GetLabelByExternalShipmentIdResponseBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public GetLabelByExternalShipmentIdResponseBody testLabel(Boolean testLabel) {
  ...
  public GetLabelByExternalShipmentIdResponseBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    GetLabelByExternalShipmentIdResponseBody getLabelByExternalShipmentIdResponseBody = (GetLabelByExternalShipmentIdResponseBody) o;
    return Objects.equals(this.alternativeIdentifiers, getLabelByExternalShipmentIdResponseBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, getLabelByExternalShipmentIdResponseBody.batchId) &&
        Objects.equals(this.carrierCode, getLabelByExternalShipmentIdResponseBody.carrierCode) &&
        Objects.equals(this.carrierId, getLabelByExternalShipmentIdResponseBody.carrierId) &&
        Objects.equals(this.chargeEvent, getLabelByExternalShipmentIdResponseBody.chargeEvent) &&
        Objects.equals(this.createdAt, getLabelByExternalShipmentIdResponseBody.createdAt) &&
        Objects.equals(this.displayScheme, getLabelByExternalShipmentIdResponseBody.displayScheme) &&
        Objects.equals(this.formDownload, getLabelByExternalShipmentIdResponseBody.formDownload) &&
        Objects.equals(this.insuranceClaim, getLabelByExternalShipmentIdResponseBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, getLabelByExternalShipmentIdResponseBody.insuranceCost) &&
        Objects.equals(this.isInternational, getLabelByExternalShipmentIdResponseBody.isInternational) &&
        Objects.equals(this.isReturnLabel, getLabelByExternalShipmentIdResponseBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, getLabelByExternalShipmentIdResponseBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, getLabelByExternalShipmentIdResponseBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, getLabelByExternalShipmentIdResponseBody.labelFormat) &&
        Objects.equals(this.labelId, getLabelByExternalShipmentIdResponseBody.labelId) &&
        Objects.equals(this.labelImageId, getLabelByExternalShipmentIdResponseBody.labelImageId) &&
        Objects.equals(this.labelLayout, getLabelByExternalShipmentIdResponseBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, getLabelByExternalShipmentIdResponseBody.outboundLabelId) &&
        Objects.equals(this.packageCode, getLabelByExternalShipmentIdResponseBody.packageCode) &&
        Objects.equals(this.packages, getLabelByExternalShipmentIdResponseBody.packages) &&
        Objects.equals(this.rmaNumber, getLabelByExternalShipmentIdResponseBody.rmaNumber) &&
        Objects.equals(this.serviceCode, getLabelByExternalShipmentIdResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, getLabelByExternalShipmentIdResponseBody.shipDate) &&
        Objects.equals(this.shipment, getLabelByExternalShipmentIdResponseBody.shipment) &&
        Objects.equals(this.shipmentCost, getLabelByExternalShipmentIdResponseBody.shipmentCost) &&
        Objects.equals(this.shipmentId, getLabelByExternalShipmentIdResponseBody.shipmentId) &&
        Objects.equals(this.status, getLabelByExternalShipmentIdResponseBody.status) &&
        Objects.equals(this.testLabel, getLabelByExternalShipmentIdResponseBody.testLabel) &&
        Objects.equals(this.trackable, getLabelByExternalShipmentIdResponseBody.trackable) &&
        Objects.equals(this.trackingNumber, getLabelByExternalShipmentIdResponseBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, getLabelByExternalShipmentIdResponseBody.trackingStatus) &&
        Objects.equals(this.validateAddress, getLabelByExternalShipmentIdResponseBody.validateAddress) &&
        Objects.equals(this.voided, getLabelByExternalShipmentIdResponseBody.voided) &&
        Objects.equals(this.voidedAt, getLabelByExternalShipmentIdResponseBody.voidedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLabelByExternalShipmentIdResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLabelByExternalShipmentIdResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLabelByExternalShipmentIdResponseBody is not found in the empty JSON string", GetLabelByExternalShipmentIdResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLabelByExternalShipmentIdResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLabelByExternalShipmentIdResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLabelByExternalShipmentIdResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLabelByExternalShipmentIdResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLabelByExternalShipmentIdResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLabelByExternalShipmentIdResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLabelByExternalShipmentIdResponseBody>() {
           @Override
           public void write(JsonWriter out, GetLabelByExternalShipmentIdResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLabelByExternalShipmentIdResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLabelByExternalShipmentIdResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLabelByExternalShipmentIdResponseBody
   * @throws IOException if the JSON string is invalid with respect to GetLabelByExternalShipmentIdResponseBody
   */
  public static GetLabelByExternalShipmentIdResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLabelByExternalShipmentIdResponseBody.class);
  }

  /**
   * Convert an instance of GetLabelByExternalShipmentIdResponseBody to an JSON string
   *
   * @return JSON string
   */
