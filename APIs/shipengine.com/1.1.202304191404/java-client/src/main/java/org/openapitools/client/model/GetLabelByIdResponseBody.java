...
public class GetLabelByIdResponseBody {
  ...
  public GetLabelByIdResponseBody() {
  }
  ...
  public GetLabelByIdResponseBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public GetLabelByIdResponseBody displayScheme(DisplayScheme displayScheme) {
  ...
  public GetLabelByIdResponseBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public GetLabelByIdResponseBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public GetLabelByIdResponseBody labelFormat(LabelFormat labelFormat) {
  ...
  public GetLabelByIdResponseBody labelImageId(String labelImageId) {
  ...
  public GetLabelByIdResponseBody labelLayout(LabelLayout labelLayout) {
  ...
  public GetLabelByIdResponseBody outboundLabelId(String outboundLabelId) {
  ...
  public GetLabelByIdResponseBody rmaNumber(String rmaNumber) {
  ...
  public GetLabelByIdResponseBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public GetLabelByIdResponseBody testLabel(Boolean testLabel) {
  ...
  public GetLabelByIdResponseBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    GetLabelByIdResponseBody getLabelByIdResponseBody = (GetLabelByIdResponseBody) o;
    return Objects.equals(this.alternativeIdentifiers, getLabelByIdResponseBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, getLabelByIdResponseBody.batchId) &&
        Objects.equals(this.carrierCode, getLabelByIdResponseBody.carrierCode) &&
        Objects.equals(this.carrierId, getLabelByIdResponseBody.carrierId) &&
        Objects.equals(this.chargeEvent, getLabelByIdResponseBody.chargeEvent) &&
        Objects.equals(this.createdAt, getLabelByIdResponseBody.createdAt) &&
        Objects.equals(this.displayScheme, getLabelByIdResponseBody.displayScheme) &&
        Objects.equals(this.formDownload, getLabelByIdResponseBody.formDownload) &&
        Objects.equals(this.insuranceClaim, getLabelByIdResponseBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, getLabelByIdResponseBody.insuranceCost) &&
        Objects.equals(this.isInternational, getLabelByIdResponseBody.isInternational) &&
        Objects.equals(this.isReturnLabel, getLabelByIdResponseBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, getLabelByIdResponseBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, getLabelByIdResponseBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, getLabelByIdResponseBody.labelFormat) &&
        Objects.equals(this.labelId, getLabelByIdResponseBody.labelId) &&
        Objects.equals(this.labelImageId, getLabelByIdResponseBody.labelImageId) &&
        Objects.equals(this.labelLayout, getLabelByIdResponseBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, getLabelByIdResponseBody.outboundLabelId) &&
        Objects.equals(this.packageCode, getLabelByIdResponseBody.packageCode) &&
        Objects.equals(this.packages, getLabelByIdResponseBody.packages) &&
        Objects.equals(this.rmaNumber, getLabelByIdResponseBody.rmaNumber) &&
        Objects.equals(this.serviceCode, getLabelByIdResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, getLabelByIdResponseBody.shipDate) &&
        Objects.equals(this.shipment, getLabelByIdResponseBody.shipment) &&
        Objects.equals(this.shipmentCost, getLabelByIdResponseBody.shipmentCost) &&
        Objects.equals(this.shipmentId, getLabelByIdResponseBody.shipmentId) &&
        Objects.equals(this.status, getLabelByIdResponseBody.status) &&
        Objects.equals(this.testLabel, getLabelByIdResponseBody.testLabel) &&
        Objects.equals(this.trackable, getLabelByIdResponseBody.trackable) &&
        Objects.equals(this.trackingNumber, getLabelByIdResponseBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, getLabelByIdResponseBody.trackingStatus) &&
        Objects.equals(this.validateAddress, getLabelByIdResponseBody.validateAddress) &&
        Objects.equals(this.voided, getLabelByIdResponseBody.voided) &&
        Objects.equals(this.voidedAt, getLabelByIdResponseBody.voidedAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLabelByIdResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLabelByIdResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetLabelByIdResponseBody is not found in the empty JSON string", GetLabelByIdResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLabelByIdResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetLabelByIdResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLabelByIdResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLabelByIdResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLabelByIdResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLabelByIdResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLabelByIdResponseBody>() {
           @Override
           public void write(JsonWriter out, GetLabelByIdResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLabelByIdResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLabelByIdResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLabelByIdResponseBody
   * @throws IOException if the JSON string is invalid with respect to GetLabelByIdResponseBody
   */
  public static GetLabelByIdResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLabelByIdResponseBody.class);
  }

  /**
   * Convert an instance of GetLabelByIdResponseBody to an JSON string
   *
   * @return JSON string
   */
