...
public class CalculateRatesResponseBody {
  ...
  public CalculateRatesResponseBody() {
  }
  ...
  public CalculateRatesResponseBody advancedOptions(AdvancedShipmentOptions advancedOptions) {
  ...
  public CalculateRatesResponseBody carrierId(String carrierId) {
  ...
  public CalculateRatesResponseBody confirmation(DeliveryConfirmation confirmation) {
  ...
  public CalculateRatesResponseBody customs(InternationalShipmentOptions customs) {
  ...
  public CalculateRatesResponseBody externalOrderId(String externalOrderId) {
  ...
  public CalculateRatesResponseBody externalShipmentId(String externalShipmentId) {
  ...
  public CalculateRatesResponseBody insuranceProvider(InsuranceProvider insuranceProvider) {
  ...
  public CalculateRatesResponseBody isReturn(Boolean isReturn) {
  ...
  public CalculateRatesResponseBody items(List<ShipmentItem> items) {
    this.items = items;
    return this;
  }

  public CalculateRatesResponseBody addItemsItem(ShipmentItem itemsItem) {
    if (this.items == null) {
  ...
  public CalculateRatesResponseBody orderSourceCode(OrderSourceName orderSourceCode) {
  ...
  public CalculateRatesResponseBody originType(OriginType originType) {
  ...
  public CalculateRatesResponseBody packages(List<ModelPackage> packages) {
    this.packages = packages;
    return this;
  }

  public CalculateRatesResponseBody addPackagesItem(ModelPackage packagesItem) {
  ...
  public CalculateRatesResponseBody returnTo(ShippingAddress returnTo) {
  ...
  public CalculateRatesResponseBody serviceCode(String serviceCode) {
  ...
  public CalculateRatesResponseBody shipDate(OffsetDateTime shipDate) {
  ...
  public CalculateRatesResponseBody shipFrom(ShippingAddress shipFrom) {
  ...
  public CalculateRatesResponseBody shipTo(ShippingAddress shipTo) {
    this.shipTo = shipTo;
    return this;
  }
  ...
  public CalculateRatesResponseBody shipmentNumber(String shipmentNumber) {
  ...
  public CalculateRatesResponseBody taxIdentifiers(List<TaxIdentifier> taxIdentifiers) {
    this.taxIdentifiers = taxIdentifiers;
    return this;
  }

  public CalculateRatesResponseBody addTaxIdentifiersItem(TaxIdentifier taxIdentifiersItem) {
  ...
  public CalculateRatesResponseBody warehouseId(String warehouseId) {
  ...
  public CalculateRatesResponseBody rateResponse(RatesInformation rateResponse) {
  ...
  public boolean equals(Object o) {
    ...
    CalculateRatesResponseBody calculateRatesResponseBody = (CalculateRatesResponseBody) o;
    return Objects.equals(this.advancedOptions, calculateRatesResponseBody.advancedOptions) &&
        Objects.equals(this.carrierId, calculateRatesResponseBody.carrierId) &&
        Objects.equals(this.confirmation, calculateRatesResponseBody.confirmation) &&
        Objects.equals(this.createdAt, calculateRatesResponseBody.createdAt) &&
        Objects.equals(this.customs, calculateRatesResponseBody.customs) &&
        Objects.equals(this.externalOrderId, calculateRatesResponseBody.externalOrderId) &&
        Objects.equals(this.externalShipmentId, calculateRatesResponseBody.externalShipmentId) &&
        Objects.equals(this.insuranceProvider, calculateRatesResponseBody.insuranceProvider) &&
        Objects.equals(this.isReturn, calculateRatesResponseBody.isReturn) &&
        Objects.equals(this.items, calculateRatesResponseBody.items) &&
        Objects.equals(this.modifiedAt, calculateRatesResponseBody.modifiedAt) &&
        Objects.equals(this.orderSourceCode, calculateRatesResponseBody.orderSourceCode) &&
        Objects.equals(this.originType, calculateRatesResponseBody.originType) &&
        Objects.equals(this.packages, calculateRatesResponseBody.packages) &&
        Objects.equals(this.returnTo, calculateRatesResponseBody.returnTo) &&
        Objects.equals(this.serviceCode, calculateRatesResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, calculateRatesResponseBody.shipDate) &&
        Objects.equals(this.shipFrom, calculateRatesResponseBody.shipFrom) &&
        Objects.equals(this.shipTo, calculateRatesResponseBody.shipTo) &&
        Objects.equals(this.shipmentId, calculateRatesResponseBody.shipmentId) &&
        Objects.equals(this.shipmentNumber, calculateRatesResponseBody.shipmentNumber) &&
        Objects.equals(this.shipmentStatus, calculateRatesResponseBody.shipmentStatus) &&
        Objects.equals(this.tags, calculateRatesResponseBody.tags) &&
        Objects.equals(this.taxIdentifiers, calculateRatesResponseBody.taxIdentifiers) &&
        Objects.equals(this.totalWeight, calculateRatesResponseBody.totalWeight) &&
        Objects.equals(this.warehouseId, calculateRatesResponseBody.warehouseId) &&
        Objects.equals(this.rateResponse, calculateRatesResponseBody.rateResponse);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("rate_response");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateRatesResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateRatesResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CalculateRatesResponseBody is not found in the empty JSON string", CalculateRatesResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateRatesResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CalculateRatesResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CalculateRatesResponseBody.openapiRequiredFields) {
      ...
      // validate the required field `rate_response`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateRatesResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateRatesResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateRatesResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateRatesResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateRatesResponseBody>() {
           @Override
           public void write(JsonWriter out, CalculateRatesResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateRatesResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateRatesResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateRatesResponseBody
   * @throws IOException if the JSON string is invalid with respect to CalculateRatesResponseBody
   */
  public static CalculateRatesResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateRatesResponseBody.class);
  }

  /**
   * Convert an instance of CalculateRatesResponseBody to an JSON string
   *
   * @return JSON string
   */
