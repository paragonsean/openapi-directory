...
public class PurchaseLabelWithoutShipment {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayScheme, purchaseLabelWithoutShipment.displayScheme) &&
        ...
        Objects.equals(this.validateAddress, purchaseLabelWithoutShipment.validateAddress);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PurchaseLabelWithoutShipment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PurchaseLabelWithoutShipment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PurchaseLabelWithoutShipment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PurchaseLabelWithoutShipment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
