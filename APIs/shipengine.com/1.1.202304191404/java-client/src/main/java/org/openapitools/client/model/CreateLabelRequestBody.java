...
public class CreateLabelRequestBody {
  public static final String SERIALIZED_NAME_SHIP_FROM_SERVICE_POINT_ID = "ship_from_service_point_id";
  @SerializedName(SERIALIZED_NAME_SHIP_FROM_SERVICE_POINT_ID)
  private String shipFromServicePointId;

  public static final String SERIALIZED_NAME_SHIP_TO_SERVICE_POINT_ID = "ship_to_service_point_id";
  @SerializedName(SERIALIZED_NAME_SHIP_TO_SERVICE_POINT_ID)
  private String shipToServicePointId;
  ...
  public CreateLabelRequestBody shipFromServicePointId(String shipFromServicePointId) {
   ...
   * @return shipFromServicePointId
   */
  @javax.annotation.Nullable
  public String getShipFromServicePointId() {
    return shipFromServicePointId;
  }

  public void setShipFromServicePointId(String shipFromServicePointId) {
    this.shipFromServicePointId = shipFromServicePointId;
  }


  public CreateLabelRequestBody shipToServicePointId(String shipToServicePointId) {
   ...
   * @return shipToServicePointId
   */
  @javax.annotation.Nullable
  public String getShipToServicePointId() {
    return shipToServicePointId;
  }

  public void setShipToServicePointId(String shipToServicePointId) {
    this.shipToServicePointId = shipToServicePointId;
  }
  ...
  public CreateLabelRequestBody chargeEvent(LabelChargeEvent chargeEvent) {
  ...
  public CreateLabelRequestBody displayScheme(DisplayScheme displayScheme) {
  ...
  public CreateLabelRequestBody isReturnLabel(Boolean isReturnLabel) {
  ...
  public CreateLabelRequestBody labelDownloadType(LabelDownloadType labelDownloadType) {
  ...
  public CreateLabelRequestBody labelFormat(LabelFormat labelFormat) {
  ...
  public CreateLabelRequestBody labelImageId(String labelImageId) {
  ...
  public CreateLabelRequestBody labelLayout(LabelLayout labelLayout) {
  ...
  public CreateLabelRequestBody outboundLabelId(String outboundLabelId) {
  ...
  public CreateLabelRequestBody rmaNumber(String rmaNumber) {
  ...
  public CreateLabelRequestBody shipment(Shipment shipment) {
  ...
  @Deprecated
  public CreateLabelRequestBody testLabel(Boolean testLabel) {
  ...
  public CreateLabelRequestBody validateAddress(ValidateAddress validateAddress) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLabelRequestBody createLabelRequestBody = (CreateLabelRequestBody) o;
    return Objects.equals(this.shipFromServicePointId, createLabelRequestBody.shipFromServicePointId) &&
        Objects.equals(this.shipToServicePointId, createLabelRequestBody.shipToServicePointId) &&
        Objects.equals(this.alternativeIdentifiers, createLabelRequestBody.alternativeIdentifiers) &&
        Objects.equals(this.batchId, createLabelRequestBody.batchId) &&
        Objects.equals(this.carrierCode, createLabelRequestBody.carrierCode) &&
        Objects.equals(this.carrierId, createLabelRequestBody.carrierId) &&
        Objects.equals(this.chargeEvent, createLabelRequestBody.chargeEvent) &&
        Objects.equals(this.createdAt, createLabelRequestBody.createdAt) &&
        Objects.equals(this.displayScheme, createLabelRequestBody.displayScheme) &&
        Objects.equals(this.formDownload, createLabelRequestBody.formDownload) &&
        Objects.equals(this.insuranceClaim, createLabelRequestBody.insuranceClaim) &&
        Objects.equals(this.insuranceCost, createLabelRequestBody.insuranceCost) &&
        Objects.equals(this.isInternational, createLabelRequestBody.isInternational) &&
        Objects.equals(this.isReturnLabel, createLabelRequestBody.isReturnLabel) &&
        Objects.equals(this.labelDownload, createLabelRequestBody.labelDownload) &&
        Objects.equals(this.labelDownloadType, createLabelRequestBody.labelDownloadType) &&
        Objects.equals(this.labelFormat, createLabelRequestBody.labelFormat) &&
        Objects.equals(this.labelId, createLabelRequestBody.labelId) &&
        Objects.equals(this.labelImageId, createLabelRequestBody.labelImageId) &&
        Objects.equals(this.labelLayout, createLabelRequestBody.labelLayout) &&
        Objects.equals(this.outboundLabelId, createLabelRequestBody.outboundLabelId) &&
        Objects.equals(this.packageCode, createLabelRequestBody.packageCode) &&
        Objects.equals(this.packages, createLabelRequestBody.packages) &&
        Objects.equals(this.rmaNumber, createLabelRequestBody.rmaNumber) &&
        Objects.equals(this.serviceCode, createLabelRequestBody.serviceCode) &&
        Objects.equals(this.shipDate, createLabelRequestBody.shipDate) &&
        Objects.equals(this.shipment, createLabelRequestBody.shipment) &&
        Objects.equals(this.shipmentCost, createLabelRequestBody.shipmentCost) &&
        Objects.equals(this.shipmentId, createLabelRequestBody.shipmentId) &&
        Objects.equals(this.status, createLabelRequestBody.status) &&
        Objects.equals(this.testLabel, createLabelRequestBody.testLabel) &&
        Objects.equals(this.trackable, createLabelRequestBody.trackable) &&
        Objects.equals(this.trackingNumber, createLabelRequestBody.trackingNumber) &&
        Objects.equals(this.trackingStatus, createLabelRequestBody.trackingStatus) &&
        Objects.equals(this.validateAddress, createLabelRequestBody.validateAddress) &&
        Objects.equals(this.voided, createLabelRequestBody.voided) &&
        Objects.equals(this.voidedAt, createLabelRequestBody.voidedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("    shipFromServicePointId: ").append(toIndentedString(shipFromServicePointId)).append("\n");
    sb.append("    shipToServicePointId: ").append(toIndentedString(shipToServicePointId)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLabelRequestBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLabelRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLabelRequestBody is not found in the empty JSON string", CreateLabelRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLabelRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLabelRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLabelRequestBody.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("ship_from_service_point_id") != null && !jsonObj.get("ship_from_service_point_id").isJsonNull()) && !jsonObj.get("ship_from_service_point_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ship_from_service_point_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ship_from_service_point_id").toString()));
      }
      if ((jsonObj.get("ship_to_service_point_id") != null && !jsonObj.get("ship_to_service_point_id").isJsonNull()) && !jsonObj.get("ship_to_service_point_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `ship_to_service_point_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ship_to_service_point_id").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLabelRequestBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLabelRequestBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLabelRequestBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLabelRequestBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLabelRequestBody>() {
           @Override
           public void write(JsonWriter out, CreateLabelRequestBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLabelRequestBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLabelRequestBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLabelRequestBody
   * @throws IOException if the JSON string is invalid with respect to CreateLabelRequestBody
   */
  public static CreateLabelRequestBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLabelRequestBody.class);
  }

  /**
   * Convert an instance of CreateLabelRequestBody to an JSON string
   *
   * @return JSON string
   */
