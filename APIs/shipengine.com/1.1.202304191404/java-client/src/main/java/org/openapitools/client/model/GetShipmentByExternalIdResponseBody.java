...
public class GetShipmentByExternalIdResponseBody {
  ...
  public GetShipmentByExternalIdResponseBody() {
  }
  ...
  public GetShipmentByExternalIdResponseBody advancedOptions(AdvancedShipmentOptions advancedOptions) {
  ...
  public GetShipmentByExternalIdResponseBody carrierId(String carrierId) {
  ...
  public GetShipmentByExternalIdResponseBody confirmation(DeliveryConfirmation confirmation) {
  ...
  public GetShipmentByExternalIdResponseBody customs(InternationalShipmentOptions customs) {
  ...
  public GetShipmentByExternalIdResponseBody externalOrderId(String externalOrderId) {
  ...
  public GetShipmentByExternalIdResponseBody externalShipmentId(String externalShipmentId) {
  ...
  public GetShipmentByExternalIdResponseBody insuranceProvider(InsuranceProvider insuranceProvider) {
  ...
  public GetShipmentByExternalIdResponseBody isReturn(Boolean isReturn) {
  ...
  public GetShipmentByExternalIdResponseBody items(List<ShipmentItem> items) {
    this.items = items;
    return this;
  }

  public GetShipmentByExternalIdResponseBody addItemsItem(ShipmentItem itemsItem) {
    if (this.items == null) {
  ...
  public GetShipmentByExternalIdResponseBody orderSourceCode(OrderSourceName orderSourceCode) {
  ...
  public GetShipmentByExternalIdResponseBody originType(OriginType originType) {
  ...
  public GetShipmentByExternalIdResponseBody packages(List<ModelPackage> packages) {
    this.packages = packages;
    return this;
  }

  public GetShipmentByExternalIdResponseBody addPackagesItem(ModelPackage packagesItem) {
  ...
  public GetShipmentByExternalIdResponseBody returnTo(ShippingAddress returnTo) {
  ...
  public GetShipmentByExternalIdResponseBody serviceCode(String serviceCode) {
  ...
  public GetShipmentByExternalIdResponseBody shipDate(OffsetDateTime shipDate) {
  ...
  public GetShipmentByExternalIdResponseBody shipFrom(ShippingAddress shipFrom) {
  ...
  public GetShipmentByExternalIdResponseBody shipTo(ShippingAddress shipTo) {
    this.shipTo = shipTo;
    return this;
  }
  ...
  public GetShipmentByExternalIdResponseBody shipmentNumber(String shipmentNumber) {
  ...
  public GetShipmentByExternalIdResponseBody taxIdentifiers(List<TaxIdentifier> taxIdentifiers) {
    this.taxIdentifiers = taxIdentifiers;
    return this;
  }

  public GetShipmentByExternalIdResponseBody addTaxIdentifiersItem(TaxIdentifier taxIdentifiersItem) {
  ...
  public GetShipmentByExternalIdResponseBody warehouseId(String warehouseId) {
  ...
  public boolean equals(Object o) {
    ...
    GetShipmentByExternalIdResponseBody getShipmentByExternalIdResponseBody = (GetShipmentByExternalIdResponseBody) o;
    return Objects.equals(this.advancedOptions, getShipmentByExternalIdResponseBody.advancedOptions) &&
        Objects.equals(this.carrierId, getShipmentByExternalIdResponseBody.carrierId) &&
        Objects.equals(this.confirmation, getShipmentByExternalIdResponseBody.confirmation) &&
        Objects.equals(this.createdAt, getShipmentByExternalIdResponseBody.createdAt) &&
        Objects.equals(this.customs, getShipmentByExternalIdResponseBody.customs) &&
        Objects.equals(this.externalOrderId, getShipmentByExternalIdResponseBody.externalOrderId) &&
        Objects.equals(this.externalShipmentId, getShipmentByExternalIdResponseBody.externalShipmentId) &&
        Objects.equals(this.insuranceProvider, getShipmentByExternalIdResponseBody.insuranceProvider) &&
        Objects.equals(this.isReturn, getShipmentByExternalIdResponseBody.isReturn) &&
        Objects.equals(this.items, getShipmentByExternalIdResponseBody.items) &&
        Objects.equals(this.modifiedAt, getShipmentByExternalIdResponseBody.modifiedAt) &&
        Objects.equals(this.orderSourceCode, getShipmentByExternalIdResponseBody.orderSourceCode) &&
        Objects.equals(this.originType, getShipmentByExternalIdResponseBody.originType) &&
        Objects.equals(this.packages, getShipmentByExternalIdResponseBody.packages) &&
        Objects.equals(this.returnTo, getShipmentByExternalIdResponseBody.returnTo) &&
        Objects.equals(this.serviceCode, getShipmentByExternalIdResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, getShipmentByExternalIdResponseBody.shipDate) &&
        Objects.equals(this.shipFrom, getShipmentByExternalIdResponseBody.shipFrom) &&
        Objects.equals(this.shipTo, getShipmentByExternalIdResponseBody.shipTo) &&
        Objects.equals(this.shipmentId, getShipmentByExternalIdResponseBody.shipmentId) &&
        Objects.equals(this.shipmentNumber, getShipmentByExternalIdResponseBody.shipmentNumber) &&
        Objects.equals(this.shipmentStatus, getShipmentByExternalIdResponseBody.shipmentStatus) &&
        Objects.equals(this.tags, getShipmentByExternalIdResponseBody.tags) &&
        Objects.equals(this.taxIdentifiers, getShipmentByExternalIdResponseBody.taxIdentifiers) &&
        Objects.equals(this.totalWeight, getShipmentByExternalIdResponseBody.totalWeight) &&
        Objects.equals(this.warehouseId, getShipmentByExternalIdResponseBody.warehouseId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetShipmentByExternalIdResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetShipmentByExternalIdResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetShipmentByExternalIdResponseBody is not found in the empty JSON string", GetShipmentByExternalIdResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetShipmentByExternalIdResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetShipmentByExternalIdResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetShipmentByExternalIdResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetShipmentByExternalIdResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetShipmentByExternalIdResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetShipmentByExternalIdResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetShipmentByExternalIdResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetShipmentByExternalIdResponseBody>() {
           @Override
           public void write(JsonWriter out, GetShipmentByExternalIdResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetShipmentByExternalIdResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetShipmentByExternalIdResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetShipmentByExternalIdResponseBody
   * @throws IOException if the JSON string is invalid with respect to GetShipmentByExternalIdResponseBody
   */
  public static GetShipmentByExternalIdResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetShipmentByExternalIdResponseBody.class);
  }

  /**
   * Convert an instance of GetShipmentByExternalIdResponseBody to an JSON string
   *
   * @return JSON string
   */
