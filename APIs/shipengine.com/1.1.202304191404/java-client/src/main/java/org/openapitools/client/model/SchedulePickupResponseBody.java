...
public class SchedulePickupResponseBody {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cancelledAt, schedulePickupResponseBody.cancelledAt) &&
        ...
        Objects.equals(this.pickupId, schedulePickupResponseBody.pickupId) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SchedulePickupResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchedulePickupResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SchedulePickupResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SchedulePickupResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
