...
public class AccountSettingsImages {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, accountSettingsImages.createdAt) &&
        ...
        Objects.equals(this.labelImageId, accountSettingsImages.labelImageId) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AccountSettingsImages
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccountSettingsImages.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountSettingsImages.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountSettingsImages` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
