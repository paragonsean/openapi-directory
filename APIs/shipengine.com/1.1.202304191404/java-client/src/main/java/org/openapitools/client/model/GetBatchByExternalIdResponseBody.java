...
public class GetBatchByExternalIdResponseBody {
  ...
  public GetBatchByExternalIdResponseBody() {
  }
  ...
  public GetBatchByExternalIdResponseBody batchLabelsUrl(OptionalLink batchLabelsUrl) {
  ...
  public GetBatchByExternalIdResponseBody batchShipmentsUrl(OptionalLink batchShipmentsUrl) {
  ...
  public boolean equals(Object o) {
    ...
    GetBatchByExternalIdResponseBody getBatchByExternalIdResponseBody = (GetBatchByExternalIdResponseBody) o;
    return Objects.equals(this.batchErrorsUrl, getBatchByExternalIdResponseBody.batchErrorsUrl) &&
        Objects.equals(this.batchId, getBatchByExternalIdResponseBody.batchId) &&
        Objects.equals(this.batchLabelsUrl, getBatchByExternalIdResponseBody.batchLabelsUrl) &&
        Objects.equals(this.batchNotes, getBatchByExternalIdResponseBody.batchNotes) &&
        Objects.equals(this.batchNumber, getBatchByExternalIdResponseBody.batchNumber) &&
        Objects.equals(this.batchShipmentsUrl, getBatchByExternalIdResponseBody.batchShipmentsUrl) &&
        Objects.equals(this.completed, getBatchByExternalIdResponseBody.completed) &&
        Objects.equals(this.count, getBatchByExternalIdResponseBody.count) &&
        Objects.equals(this.createdAt, getBatchByExternalIdResponseBody.createdAt) &&
        Objects.equals(this.errors, getBatchByExternalIdResponseBody.errors) &&
        Objects.equals(this.externalBatchId, getBatchByExternalIdResponseBody.externalBatchId) &&
        Objects.equals(this.formDownload, getBatchByExternalIdResponseBody.formDownload) &&
        Objects.equals(this.forms, getBatchByExternalIdResponseBody.forms) &&
        Objects.equals(this.labelDownload, getBatchByExternalIdResponseBody.labelDownload) &&
        Objects.equals(this.labelFormat, getBatchByExternalIdResponseBody.labelFormat) &&
        Objects.equals(this.labelLayout, getBatchByExternalIdResponseBody.labelLayout) &&
        Objects.equals(this.processedAt, getBatchByExternalIdResponseBody.processedAt) &&
        Objects.equals(this.status, getBatchByExternalIdResponseBody.status) &&
        Objects.equals(this.warnings, getBatchByExternalIdResponseBody.warnings);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBatchByExternalIdResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBatchByExternalIdResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBatchByExternalIdResponseBody is not found in the empty JSON string", GetBatchByExternalIdResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBatchByExternalIdResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBatchByExternalIdResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetBatchByExternalIdResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBatchByExternalIdResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBatchByExternalIdResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBatchByExternalIdResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBatchByExternalIdResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBatchByExternalIdResponseBody>() {
           @Override
           public void write(JsonWriter out, GetBatchByExternalIdResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBatchByExternalIdResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBatchByExternalIdResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBatchByExternalIdResponseBody
   * @throws IOException if the JSON string is invalid with respect to GetBatchByExternalIdResponseBody
   */
  public static GetBatchByExternalIdResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBatchByExternalIdResponseBody.class);
  }

  /**
   * Convert an instance of GetBatchByExternalIdResponseBody to an JSON string
   *
   * @return JSON string
   */
