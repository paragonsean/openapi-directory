 ...
 */
@JsonAdapter(CarrierName.Adapter.class)
public enum CarrierName {
  ...
  public static CarrierName fromValue(String value) {
    for (CarrierName b : CarrierName.values()) {
  ...
  public static class Adapter extends TypeAdapter<CarrierName> {
    @Override
    public void write(final JsonWriter jsonWriter, final CarrierName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CarrierName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CarrierName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CarrierName.fromValue(value);
  }
}
