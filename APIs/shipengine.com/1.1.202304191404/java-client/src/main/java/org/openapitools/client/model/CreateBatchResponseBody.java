...
public class CreateBatchResponseBody {
  ...
  public CreateBatchResponseBody batchLabelsUrl(OptionalLink batchLabelsUrl) {
  ...
  public CreateBatchResponseBody batchShipmentsUrl(OptionalLink batchShipmentsUrl) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBatchResponseBody createBatchResponseBody = (CreateBatchResponseBody) o;
    return Objects.equals(this.batchErrorsUrl, createBatchResponseBody.batchErrorsUrl) &&
        Objects.equals(this.batchId, createBatchResponseBody.batchId) &&
        Objects.equals(this.batchLabelsUrl, createBatchResponseBody.batchLabelsUrl) &&
        Objects.equals(this.batchNotes, createBatchResponseBody.batchNotes) &&
        Objects.equals(this.batchNumber, createBatchResponseBody.batchNumber) &&
        Objects.equals(this.batchShipmentsUrl, createBatchResponseBody.batchShipmentsUrl) &&
        Objects.equals(this.completed, createBatchResponseBody.completed) &&
        Objects.equals(this.count, createBatchResponseBody.count) &&
        Objects.equals(this.createdAt, createBatchResponseBody.createdAt) &&
        Objects.equals(this.errors, createBatchResponseBody.errors) &&
        Objects.equals(this.externalBatchId, createBatchResponseBody.externalBatchId) &&
        Objects.equals(this.formDownload, createBatchResponseBody.formDownload) &&
        Objects.equals(this.forms, createBatchResponseBody.forms) &&
        Objects.equals(this.labelDownload, createBatchResponseBody.labelDownload) &&
        Objects.equals(this.labelFormat, createBatchResponseBody.labelFormat) &&
        Objects.equals(this.labelLayout, createBatchResponseBody.labelLayout) &&
        Objects.equals(this.processedAt, createBatchResponseBody.processedAt) &&
        Objects.equals(this.status, createBatchResponseBody.status) &&
        Objects.equals(this.warnings, createBatchResponseBody.warnings);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBatchResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBatchResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBatchResponseBody is not found in the empty JSON string", CreateBatchResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBatchResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBatchResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateBatchResponseBody.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBatchResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBatchResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBatchResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBatchResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBatchResponseBody>() {
           @Override
           public void write(JsonWriter out, CreateBatchResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBatchResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBatchResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBatchResponseBody
   * @throws IOException if the JSON string is invalid with respect to CreateBatchResponseBody
   */
  public static CreateBatchResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBatchResponseBody.class);
  }

  /**
   * Convert an instance of CreateBatchResponseBody to an JSON string
   *
   * @return JSON string
   */
