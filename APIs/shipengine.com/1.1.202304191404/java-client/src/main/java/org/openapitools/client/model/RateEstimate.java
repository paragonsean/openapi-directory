...
public class RateEstimate {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.carrierCode, rateEstimate.carrierCode) &&
        ...
        Objects.equals(this.rateType, rateEstimate.rateType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(carrierCode, carrierDeliveryDays, carrierFriendlyName, carrierId, carrierNickname, confirmationAmount, deliveryDays, errorMessages, estimatedDeliveryDate, guaranteedService, insuranceAmount, negotiatedRate, otherAmount, packageType, rateType, serviceCode, serviceType, shipDate, shippingAmount, taxAmount, trackable, validationStatus, warningMessages, zone);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RateEstimate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RateEstimate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RateEstimate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RateEstimate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
