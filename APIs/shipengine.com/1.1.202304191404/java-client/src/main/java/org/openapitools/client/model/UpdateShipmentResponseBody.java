...
public class UpdateShipmentResponseBody {
  ...
  public UpdateShipmentResponseBody advancedOptions(AdvancedShipmentOptions advancedOptions) {
  ...
  public UpdateShipmentResponseBody carrierId(String carrierId) {
  ...
  public UpdateShipmentResponseBody confirmation(DeliveryConfirmation confirmation) {
  ...
  public UpdateShipmentResponseBody customs(InternationalShipmentOptions customs) {
  ...
  public UpdateShipmentResponseBody externalOrderId(String externalOrderId) {
  ...
  public UpdateShipmentResponseBody externalShipmentId(String externalShipmentId) {
  ...
  public UpdateShipmentResponseBody insuranceProvider(InsuranceProvider insuranceProvider) {
  ...
  public UpdateShipmentResponseBody isReturn(Boolean isReturn) {
  ...
  public UpdateShipmentResponseBody items(List<ShipmentItem> items) {
    this.items = items;
    return this;
  }

  public UpdateShipmentResponseBody addItemsItem(ShipmentItem itemsItem) {
    if (this.items == null) {
  ...
  public UpdateShipmentResponseBody orderSourceCode(OrderSourceName orderSourceCode) {
  ...
  public UpdateShipmentResponseBody originType(OriginType originType) {
  ...
  public UpdateShipmentResponseBody packages(List<ModelPackage> packages) {
    this.packages = packages;
    return this;
  }

  public UpdateShipmentResponseBody addPackagesItem(ModelPackage packagesItem) {
  ...
  public UpdateShipmentResponseBody returnTo(ShippingAddress returnTo) {
  ...
  public UpdateShipmentResponseBody serviceCode(String serviceCode) {
  ...
  public UpdateShipmentResponseBody shipDate(OffsetDateTime shipDate) {
  ...
  public UpdateShipmentResponseBody shipFrom(ShippingAddress shipFrom) {
  ...
  public UpdateShipmentResponseBody shipTo(ShippingAddress shipTo) {
    this.shipTo = shipTo;
    return this;
  }
  ...
  public UpdateShipmentResponseBody shipmentNumber(String shipmentNumber) {
  ...
  public UpdateShipmentResponseBody taxIdentifiers(List<TaxIdentifier> taxIdentifiers) {
    this.taxIdentifiers = taxIdentifiers;
    return this;
  }

  public UpdateShipmentResponseBody addTaxIdentifiersItem(TaxIdentifier taxIdentifiersItem) {
  ...
  public UpdateShipmentResponseBody warehouseId(String warehouseId) {
  ...
  public UpdateShipmentResponseBody addressValidation(AddressValidationResult addressValidation) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateShipmentResponseBody updateShipmentResponseBody = (UpdateShipmentResponseBody) o;
    return Objects.equals(this.advancedOptions, updateShipmentResponseBody.advancedOptions) &&
        Objects.equals(this.carrierId, updateShipmentResponseBody.carrierId) &&
        Objects.equals(this.confirmation, updateShipmentResponseBody.confirmation) &&
        Objects.equals(this.createdAt, updateShipmentResponseBody.createdAt) &&
        Objects.equals(this.customs, updateShipmentResponseBody.customs) &&
        Objects.equals(this.externalOrderId, updateShipmentResponseBody.externalOrderId) &&
        Objects.equals(this.externalShipmentId, updateShipmentResponseBody.externalShipmentId) &&
        Objects.equals(this.insuranceProvider, updateShipmentResponseBody.insuranceProvider) &&
        Objects.equals(this.isReturn, updateShipmentResponseBody.isReturn) &&
        Objects.equals(this.items, updateShipmentResponseBody.items) &&
        Objects.equals(this.modifiedAt, updateShipmentResponseBody.modifiedAt) &&
        Objects.equals(this.orderSourceCode, updateShipmentResponseBody.orderSourceCode) &&
        Objects.equals(this.originType, updateShipmentResponseBody.originType) &&
        Objects.equals(this.packages, updateShipmentResponseBody.packages) &&
        Objects.equals(this.returnTo, updateShipmentResponseBody.returnTo) &&
        Objects.equals(this.serviceCode, updateShipmentResponseBody.serviceCode) &&
        Objects.equals(this.shipDate, updateShipmentResponseBody.shipDate) &&
        Objects.equals(this.shipFrom, updateShipmentResponseBody.shipFrom) &&
        Objects.equals(this.shipTo, updateShipmentResponseBody.shipTo) &&
        Objects.equals(this.shipmentId, updateShipmentResponseBody.shipmentId) &&
        Objects.equals(this.shipmentNumber, updateShipmentResponseBody.shipmentNumber) &&
        Objects.equals(this.shipmentStatus, updateShipmentResponseBody.shipmentStatus) &&
        Objects.equals(this.tags, updateShipmentResponseBody.tags) &&
        Objects.equals(this.taxIdentifiers, updateShipmentResponseBody.taxIdentifiers) &&
        Objects.equals(this.totalWeight, updateShipmentResponseBody.totalWeight) &&
        Objects.equals(this.warehouseId, updateShipmentResponseBody.warehouseId) &&
        Objects.equals(this.addressValidation, updateShipmentResponseBody.addressValidation) &&
        Objects.equals(this.errors, updateShipmentResponseBody.errors);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("address_validation");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateShipmentResponseBody
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateShipmentResponseBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateShipmentResponseBody is not found in the empty JSON string", UpdateShipmentResponseBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateShipmentResponseBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateShipmentResponseBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateShipmentResponseBody.openapiRequiredFields) {
      ...
      // validate the required field `address_validation`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateShipmentResponseBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateShipmentResponseBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateShipmentResponseBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateShipmentResponseBody.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateShipmentResponseBody>() {
           @Override
           public void write(JsonWriter out, UpdateShipmentResponseBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateShipmentResponseBody read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateShipmentResponseBody given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateShipmentResponseBody
   * @throws IOException if the JSON string is invalid with respect to UpdateShipmentResponseBody
   */
  public static UpdateShipmentResponseBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateShipmentResponseBody.class);
  }

  /**
   * Convert an instance of UpdateShipmentResponseBody to an JSON string
   *
   * @return JSON string
   */
