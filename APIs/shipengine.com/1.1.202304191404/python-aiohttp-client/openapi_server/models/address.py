...
class Address(Model):
    ...
    def __init__(self, address_line1: str=None, address_line2: str=None, address_line3: str=None, address_residential_indicator: AddressResidentialIndicator=None, city_locality: str=None, company_name: str=None, country_code: str=None, email: str=None, name: str=None, phone: str=None, postal_code: str=None, state_province: str=None):
        ...
        :param address_residential_indicator: The address_residential_indicator of this Address.
        :param city_locality: The city_locality of this Address.
        ...
        :param state_province: The state_province of this Address.
        """
        self.openapi_types = {
            'address_line1': str,
            'address_line2': str,
    ...
    def address_residential_indicator(self):
        """Gets the address_residential_indicator of this Address.

        Indicates whether this is a residential address.

        :return: The address_residential_indicator of this Address.
    ...
    def address_residential_indicator(self, address_residential_indicator):
        """Sets the address_residential_indicator of this Address.
        ...
        """
        if address_residential_indicator is None:
            raise ValueError("Invalid value for `address_residential_indicator`, must not be `None`")

        self._address_residential_indicator = address_residential_indicator

    @property
    def city_locality(self):
        """Gets the city_locality of this Address.

        The name of the city or locality

        :return: The city_locality of this Address.
        :rtype: str
        """
    ...
    def city_locality(self, city_locality):
        """Sets the city_locality of this Address.
    ...
    def state_province(self):
        """Gets the state_province of this Address.

        The state or province.  For some countries (including the U.S.) only abbreviations are allowed.  Other countries allow the full name or abbreviation. 

        :return: The state_province of this Address.
        :rtype: str
        """
