...
class Warehouse(Model):
    ...
    def __init__(self, created_at: datetime=None, is_default: bool=False, name: str=None, origin_address: Address=None, return_address: Address=None, warehouse_id: str=None):
        ...
        :param created_at: The created_at of this Warehouse.
        :param is_default: The is_default of this Warehouse.
        :param name: The name of this Warehouse.
        :param origin_address: The origin_address of this Warehouse.
        :param return_address: The return_address of this Warehouse.
        :param warehouse_id: The warehouse_id of this Warehouse.
        """
        self.openapi_types = {
            'created_at': datetime,
            'is_default': bool,
    ...
    @property
    def created_at(self):
        """Gets the created_at of this Warehouse.

        Timestamp that indicates when the warehouse was created

        :return: The created_at of this Warehouse.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this Warehouse.
    ...
    @property
    def is_default(self):
        """Gets the is_default of this Warehouse.

        Designates which single warehouse is the default on the account

        :return: The is_default of this Warehouse.
        :rtype: bool
        """
    ...
    def is_default(self, is_default):
        """Sets the is_default of this Warehouse.
    ...
    def origin_address(self):
        """Gets the origin_address of this Warehouse.

        The origin address of the warehouse

        :return: The origin_address of this Warehouse.
        :rtype: Address
        """
    ...
    def origin_address(self, origin_address):
        """Sets the origin_address of this Warehouse.
    ...
    def return_address(self):
        """Gets the return_address of this Warehouse.

        The return address associated with the warehouse

        :return: The return_address of this Warehouse.
        :rtype: Address
        """
    ...
    def return_address(self, return_address):
        """Sets the return_address of this Warehouse.
    ...
    def warehouse_id(self):
        """Gets the warehouse_id of this Warehouse.

        A string that uniquely identifies the warehouse

        :return: The warehouse_id of this Warehouse.
        :rtype: str
        """
