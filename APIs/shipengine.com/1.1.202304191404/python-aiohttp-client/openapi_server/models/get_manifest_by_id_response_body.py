...
class GetManifestByIdResponseBody(Model):
    ...
    def __init__(self, carrier_id: str=None, created_at: datetime=None, form_id: str=None, label_ids: List[str]=None, manifest_download: ManifestDownload=None, manifest_id: str=None, ship_date: datetime=None, shipments: int=None, submission_id: str=None, warehouse_id: str=None):
        """GetManifestByIdResponseBody - a model defined in OpenAPI

        :param carrier_id: The carrier_id of this GetManifestByIdResponseBody.
        :param created_at: The created_at of this GetManifestByIdResponseBody.
        :param form_id: The form_id of this GetManifestByIdResponseBody.
        :param label_ids: The label_ids of this GetManifestByIdResponseBody.
        :param manifest_download: The manifest_download of this GetManifestByIdResponseBody.
        :param manifest_id: The manifest_id of this GetManifestByIdResponseBody.
        :param ship_date: The ship_date of this GetManifestByIdResponseBody.
        :param shipments: The shipments of this GetManifestByIdResponseBody.
        :param submission_id: The submission_id of this GetManifestByIdResponseBody.
        :param warehouse_id: The warehouse_id of this GetManifestByIdResponseBody.
        """
        self.openapi_types = {
            'carrier_id': str,
            'created_at': datetime,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetManifestByIdResponseBody':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_manifest_by_id_response_body of this GetManifestByIdResponseBody.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def carrier_id(self):
        """Gets the carrier_id of this GetManifestByIdResponseBody.

        A string that uniquely identifies the carrier

        :return: The carrier_id of this GetManifestByIdResponseBody.
        :rtype: str
        """
    ...
    def carrier_id(self, carrier_id):
        """Sets the carrier_id of this GetManifestByIdResponseBody.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this GetManifestByIdResponseBody.

        The date-time that the manifest was created

        :return: The created_at of this GetManifestByIdResponseBody.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this GetManifestByIdResponseBody.
    ...
    @property
    def form_id(self):
        """Gets the form_id of this GetManifestByIdResponseBody.

        A string that uniquely identifies the form

        :return: The form_id of this GetManifestByIdResponseBody.
        :rtype: str
        """
    ...
    def form_id(self, form_id):
        """Sets the form_id of this GetManifestByIdResponseBody.
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this GetManifestByIdResponseBody.

        An array of the label ids used in this manifest.

        :return: The label_ids of this GetManifestByIdResponseBody.
        :rtype: List[str]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this GetManifestByIdResponseBody.
    ...
    def manifest_download(self):
        """Gets the manifest_download of this GetManifestByIdResponseBody.


        :return: The manifest_download of this GetManifestByIdResponseBody.
    ...
    def manifest_download(self, manifest_download):
        """Sets the manifest_download of this GetManifestByIdResponseBody.
    ...
    def manifest_id(self):
        """Gets the manifest_id of this GetManifestByIdResponseBody.

        A string that uniquely identifies the manifest

        :return: The manifest_id of this GetManifestByIdResponseBody.
        :rtype: str
        """
    ...
    def manifest_id(self, manifest_id):
        """Sets the manifest_id of this GetManifestByIdResponseBody.
    ...
    @property
    def ship_date(self):
        """Gets the ship_date of this GetManifestByIdResponseBody.

        The date-time that the manifests shipments will be picked up

        :return: The ship_date of this GetManifestByIdResponseBody.
        :rtype: datetime
        """
    ...
    def ship_date(self, ship_date):
        """Sets the ship_date of this GetManifestByIdResponseBody.
    ...
    @property
    def shipments(self):
        """Gets the shipments of this GetManifestByIdResponseBody.

        The number of shipments that are included in this manifest

        :return: The shipments of this GetManifestByIdResponseBody.
        :rtype: int
        """
    ...
    def shipments(self, shipments):
        """Sets the shipments of this GetManifestByIdResponseBody.
    ...
    def submission_id(self):
        """Gets the submission_id of this GetManifestByIdResponseBody.

        A string that uniquely identifies the submission

        :return: The submission_id of this GetManifestByIdResponseBody.
        :rtype: str
        """
    ...
    def submission_id(self, submission_id):
        """Sets the submission_id of this GetManifestByIdResponseBody.
    ...
    def warehouse_id(self):
        """Gets the warehouse_id of this GetManifestByIdResponseBody.

        A string that uniquely identifies the warehouse

        :return: The warehouse_id of this GetManifestByIdResponseBody.
        :rtype: str
        """
    ...
    def warehouse_id(self, warehouse_id):
        """Sets the warehouse_id of this GetManifestByIdResponseBody.
