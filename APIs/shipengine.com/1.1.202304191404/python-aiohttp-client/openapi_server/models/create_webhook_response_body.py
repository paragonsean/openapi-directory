...
class CreateWebhookResponseBody(Model):
    ...
    def __init__(self, event: WebhookEvent=None, url: str=None, webhook_id: str=None):
        """CreateWebhookResponseBody - a model defined in OpenAPI

        :param event: The event of this CreateWebhookResponseBody.
        :param url: The url of this CreateWebhookResponseBody.
        :param webhook_id: The webhook_id of this CreateWebhookResponseBody.
        """
        self.openapi_types = {
            'event': WebhookEvent,
            'url': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateWebhookResponseBody':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The create_webhook_response_body of this CreateWebhookResponseBody.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def event(self):
        """Gets the event of this CreateWebhookResponseBody.


        :return: The event of this CreateWebhookResponseBody.
        :rtype: WebhookEvent
        """
        return self._event
    ...
    def event(self, event):
        """Sets the event of this CreateWebhookResponseBody.
    ...
    @property
    def url(self):
        """Gets the url of this CreateWebhookResponseBody.

        The url that the webhook sends the request to

        :return: The url of this CreateWebhookResponseBody.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this CreateWebhookResponseBody.
    ...
    @property
    def webhook_id(self):
        """Gets the webhook_id of this CreateWebhookResponseBody.

        A string that uniquely identifies the webhook

        :return: The webhook_id of this CreateWebhookResponseBody.
        :rtype: str
        """
    ...
    def webhook_id(self, webhook_id):
        """Sets the webhook_id of this CreateWebhookResponseBody.
