...
class AddressToValidate(Model):
    ...
    def __init__(self, address_line1: str=None, address_line2: str=None, address_line3: str=None, address_residential_indicator: AddressResidentialIndicator=None, city_locality: str=None, company_name: str=None, country_code: str=None, email: str=None, name: str=None, phone: str=None, postal_code: str=None, state_province: str=None):
        """AddressToValidate - a model defined in OpenAPI

        :param address_line1: The address_line1 of this AddressToValidate.
        :param address_line2: The address_line2 of this AddressToValidate.
        :param address_line3: The address_line3 of this AddressToValidate.
        :param address_residential_indicator: The address_residential_indicator of this AddressToValidate.
        :param city_locality: The city_locality of this AddressToValidate.
        :param company_name: The company_name of this AddressToValidate.
        :param country_code: The country_code of this AddressToValidate.
        :param email: The email of this AddressToValidate.
        :param name: The name of this AddressToValidate.
        :param phone: The phone of this AddressToValidate.
        :param postal_code: The postal_code of this AddressToValidate.
        :param state_province: The state_province of this AddressToValidate.
        """
        self.openapi_types = {
            'address_line1': str,
            'address_line2': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AddressToValidate':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The address_to_validate of this AddressToValidate.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def address_line1(self):
        """Gets the address_line1 of this AddressToValidate.

        The first line of the street address.  For some addresses, this may be the only line.  Other addresses may require 2 or 3 lines. 

        :return: The address_line1 of this AddressToValidate.
        :rtype: str
        """
    ...
    def address_line1(self, address_line1):
        """Sets the address_line1 of this AddressToValidate.
    ...
    def address_line2(self):
        """Gets the address_line2 of this AddressToValidate.

        The second line of the street address.  For some addresses, this line may not be needed. 

        :return: The address_line2 of this AddressToValidate.
        :rtype: str
        """
    ...
    def address_line2(self, address_line2):
        """Sets the address_line2 of this AddressToValidate.
    ...
    def address_line3(self):
        """Gets the address_line3 of this AddressToValidate.

        The third line of the street address.  For some addresses, this line may not be needed. 

        :return: The address_line3 of this AddressToValidate.
        :rtype: str
        """
    ...
    def address_line3(self, address_line3):
        """Sets the address_line3 of this AddressToValidate.
    ...
    def address_residential_indicator(self):
        """Gets the address_residential_indicator of this AddressToValidate.

        Indicates whether this is a residential address.

        :return: The address_residential_indicator of this AddressToValidate.
    ...
    def address_residential_indicator(self, address_residential_indicator):
        """Sets the address_residential_indicator of this AddressToValidate.
    ...
    def city_locality(self):
        """Gets the city_locality of this AddressToValidate.

        The name of the city or locality

        :return: The city_locality of this AddressToValidate.
        :rtype: str
        """
    ...
    def city_locality(self, city_locality):
        """Sets the city_locality of this AddressToValidate.
    ...
    def company_name(self):
        """Gets the company_name of this AddressToValidate.

        If this is a business address, then the company name should be specified here. 

        :return: The company_name of this AddressToValidate.
        :rtype: str
        """
    ...
    def company_name(self, company_name):
        """Sets the company_name of this AddressToValidate.
    ...
    def country_code(self):
        """Gets the country_code of this AddressToValidate.

        The two-letter [ISO 3166-1 country code](https://en.wikipedia.org/wiki/ISO_3166-1) 

        :return: The country_code of this AddressToValidate.
        :rtype: str
        """
    ...
    def country_code(self, country_code):
        """Sets the country_code of this AddressToValidate.
    ...
    @property
    def email(self):
        """Gets the email of this AddressToValidate.

        Email for the address owner. 

        :return: The email of this AddressToValidate.
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this AddressToValidate.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AddressToValidate.
    ...
    @property
    def phone(self):
        """Gets the phone of this AddressToValidate.

        The phone number of a contact person at this address.  The format of this phone number varies depending on the country. 

        :return: The phone of this AddressToValidate.
        :rtype: str
        """
        return self._phone
    ...
    def phone(self, phone):
        """Sets the phone of this AddressToValidate.
    ...
    def postal_code(self):
        """Gets the postal_code of this AddressToValidate.

        postal code

        :return: The postal_code of this AddressToValidate.
        :rtype: str
        """
    ...
    def postal_code(self, postal_code):
        """Sets the postal_code of this AddressToValidate.
    ...
    def state_province(self):
        """Gets the state_province of this AddressToValidate.

        The state or province.  For some countries (including the U.S.) only abbreviations are allowed.  Other countries allow the full name or abbreviation. 

        :return: The state_province of this AddressToValidate.
        :rtype: str
        """
    ...
    def state_province(self, state_province):
        """Sets the state_province of this AddressToValidate.
