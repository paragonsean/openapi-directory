...
class GetBatchByIdResponseBody(Model):
    ...
    def __init__(self, batch_errors_url: OptionalLink=None, batch_id: str=None, batch_labels_url: OptionalLink=None, batch_notes: str='', batch_number: str=None, batch_shipments_url: OptionalLink=None, completed: int=None, count: int=None, created_at: datetime=None, errors: int=None, external_batch_id: str=None, form_download: OptionalLink=None, forms: int=None, label_download: LabelDownload=None, label_format: LabelFormat=None, label_layout: LabelLayout=None, processed_at: datetime=None, status: BatchStatus=None, warnings: int=None):
        """GetBatchByIdResponseBody - a model defined in OpenAPI

        :param batch_errors_url: The batch_errors_url of this GetBatchByIdResponseBody.
        :param batch_id: The batch_id of this GetBatchByIdResponseBody.
        :param batch_labels_url: The batch_labels_url of this GetBatchByIdResponseBody.
        :param batch_notes: The batch_notes of this GetBatchByIdResponseBody.
        :param batch_number: The batch_number of this GetBatchByIdResponseBody.
        :param batch_shipments_url: The batch_shipments_url of this GetBatchByIdResponseBody.
        :param completed: The completed of this GetBatchByIdResponseBody.
        :param count: The count of this GetBatchByIdResponseBody.
        :param created_at: The created_at of this GetBatchByIdResponseBody.
        :param errors: The errors of this GetBatchByIdResponseBody.
        :param external_batch_id: The external_batch_id of this GetBatchByIdResponseBody.
        :param form_download: The form_download of this GetBatchByIdResponseBody.
        :param forms: The forms of this GetBatchByIdResponseBody.
        :param label_download: The label_download of this GetBatchByIdResponseBody.
        :param label_format: The label_format of this GetBatchByIdResponseBody.
        :param label_layout: The label_layout of this GetBatchByIdResponseBody.
        :param processed_at: The processed_at of this GetBatchByIdResponseBody.
        :param status: The status of this GetBatchByIdResponseBody.
        :param warnings: The warnings of this GetBatchByIdResponseBody.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetBatchByIdResponseBody':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The get_batch_by_id_response_body of this GetBatchByIdResponseBody.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def batch_errors_url(self):
        """Gets the batch_errors_url of this GetBatchByIdResponseBody.

        Link to batch errors endpoint

        :return: The batch_errors_url of this GetBatchByIdResponseBody.
        :rtype: OptionalLink
        """
    ...
    def batch_errors_url(self, batch_errors_url):
        """Sets the batch_errors_url of this GetBatchByIdResponseBody.
    ...
    @property
    def batch_id(self):
        """Gets the batch_id of this GetBatchByIdResponseBody.

        A string that uniquely identifies the batch

        :return: The batch_id of this GetBatchByIdResponseBody.
        :rtype: str
        """
    ...
    def batch_id(self, batch_id):
        """Sets the batch_id of this GetBatchByIdResponseBody.
    ...
    def batch_labels_url(self):
        """Gets the batch_labels_url of this GetBatchByIdResponseBody.

        Link to batch labels query

        :return: The batch_labels_url of this GetBatchByIdResponseBody.
        :rtype: OptionalLink
        """
    ...
    def batch_labels_url(self, batch_labels_url):
        """Sets the batch_labels_url of this GetBatchByIdResponseBody.
    ...
    def batch_notes(self):
        """Gets the batch_notes of this GetBatchByIdResponseBody.

        Custom notes you can add for each created batch

        :return: The batch_notes of this GetBatchByIdResponseBody.
        :rtype: str
        """
    ...
    def batch_notes(self, batch_notes):
        """Sets the batch_notes of this GetBatchByIdResponseBody.
    ...
    def batch_number(self):
        """Gets the batch_number of this GetBatchByIdResponseBody.

        The batch number.

        :return: The batch_number of this GetBatchByIdResponseBody.
        :rtype: str
        """
    ...
    def batch_number(self, batch_number):
        """Sets the batch_number of this GetBatchByIdResponseBody.
    ...
    def batch_shipments_url(self):
        """Gets the batch_shipments_url of this GetBatchByIdResponseBody.

        The batch shipments endpoint

        :return: The batch_shipments_url of this GetBatchByIdResponseBody.
        :rtype: OptionalLink
        """
    ...
    def batch_shipments_url(self, batch_shipments_url):
        """Sets the batch_shipments_url of this GetBatchByIdResponseBody.
    ...
    @property
    def completed(self):
        """Gets the completed of this GetBatchByIdResponseBody.

        The number of labels generated in the batch

        :return: The completed of this GetBatchByIdResponseBody.
        :rtype: int
        """
    ...
    def completed(self, completed):
        """Sets the completed of this GetBatchByIdResponseBody.
    ...
    @property
    def count(self):
        """Gets the count of this GetBatchByIdResponseBody.

        The total of errors, warnings, and completed properties

        :return: The count of this GetBatchByIdResponseBody.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this GetBatchByIdResponseBody.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this GetBatchByIdResponseBody.

        The date and time the batch was created in ShipEngine

        :return: The created_at of this GetBatchByIdResponseBody.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this GetBatchByIdResponseBody.
    ...
    @property
    def errors(self):
        """Gets the errors of this GetBatchByIdResponseBody.

        The number of errors that occurred while generating the batch

        :return: The errors of this GetBatchByIdResponseBody.
        :rtype: int
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this GetBatchByIdResponseBody.
    ...
    def external_batch_id(self):
        """Gets the external_batch_id of this GetBatchByIdResponseBody.

        A string that uniquely identifies the external batch

        :return: The external_batch_id of this GetBatchByIdResponseBody.
        :rtype: str
        """
    ...
    def external_batch_id(self, external_batch_id):
        """Sets the external_batch_id of this GetBatchByIdResponseBody.
    ...
    def form_download(self):
        """Gets the form_download of this GetBatchByIdResponseBody.

        The form download for any customs that are needed

        :return: The form_download of this GetBatchByIdResponseBody.
        :rtype: OptionalLink
        """
    ...
    def form_download(self, form_download):
        """Sets the form_download of this GetBatchByIdResponseBody.
    ...
    @property
    def forms(self):
        """Gets the forms of this GetBatchByIdResponseBody.

        The number of forms for customs that are available for download

        :return: The forms of this GetBatchByIdResponseBody.
        :rtype: int
        """
        return self._forms
    ...
    def forms(self, forms):
        """Sets the forms of this GetBatchByIdResponseBody.
    ...
    def label_download(self):
        """Gets the label_download of this GetBatchByIdResponseBody.

        The label download for the batch

        :return: The label_download of this GetBatchByIdResponseBody.
        :rtype: LabelDownload
        """
    ...
    def label_download(self, label_download):
        """Sets the label_download of this GetBatchByIdResponseBody.
    ...
    def label_format(self):
        """Gets the label_format of this GetBatchByIdResponseBody.


        :return: The label_format of this GetBatchByIdResponseBody.
        :rtype: LabelFormat
        """
    ...
    def label_format(self, label_format):
        """Sets the label_format of this GetBatchByIdResponseBody.
    ...
    def label_layout(self):
        """Gets the label_layout of this GetBatchByIdResponseBody.

        label layout

        :return: The label_layout of this GetBatchByIdResponseBody.
        :rtype: LabelLayout
        """
    ...
    def label_layout(self, label_layout):
        """Sets the label_layout of this GetBatchByIdResponseBody.
    ...
    def processed_at(self):
        """Gets the processed_at of this GetBatchByIdResponseBody.

        The date and time the batch was processed in ShipEngine

        :return: The processed_at of this GetBatchByIdResponseBody.
        :rtype: datetime
        """
    ...
    def processed_at(self, processed_at):
        """Sets the processed_at of this GetBatchByIdResponseBody.
    ...
    @property
    def status(self):
        """Gets the status of this GetBatchByIdResponseBody.


        :return: The status of this GetBatchByIdResponseBody.
        :rtype: BatchStatus
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this GetBatchByIdResponseBody.
    ...
    @property
    def warnings(self):
        """Gets the warnings of this GetBatchByIdResponseBody.

        The number of warnings that occurred while generating the batch

        :return: The warnings of this GetBatchByIdResponseBody.
        :rtype: int
        """
    ...
    def warnings(self, warnings):
        """Sets the warnings of this GetBatchByIdResponseBody.
