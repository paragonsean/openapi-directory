...
class ShippingAddress(Model):
    ...
    def __init__(self, address_line1: str=None, address_line2: str=None, address_line3: str=None, address_residential_indicator: AddressResidentialIndicator=None, city_locality: str=None, company_name: str=None, country_code: str=None, email: str=None, name: str=None, phone: str=None, postal_code: str=None, state_province: str=None, instructions: str=None):
        """ShippingAddress - a model defined in OpenAPI

        :param address_line1: The address_line1 of this ShippingAddress.
        :param address_line2: The address_line2 of this ShippingAddress.
        :param address_line3: The address_line3 of this ShippingAddress.
        :param address_residential_indicator: The address_residential_indicator of this ShippingAddress.
        :param city_locality: The city_locality of this ShippingAddress.
        ...
        :param state_province: The state_province of this ShippingAddress.
        :param instructions: The instructions of this ShippingAddress.
        """
        self.openapi_types = {
            'address_line1': str,
            'address_line2': str,
    ...
    def from_dict(cls, dikt: dict) -> 'ShippingAddress':
        ...
        :param dikt: A dict.
        :return: The shipping_address of this ShippingAddress.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def address_line1(self):
        """Gets the address_line1 of this ShippingAddress.

        The first line of the street address.  For some addresses, this may be the only line.  Other addresses may require 2 or 3 lines. 

        :return: The address_line1 of this ShippingAddress.
        :rtype: str
        """
    ...
    def address_line2(self):
        """Gets the address_line2 of this ShippingAddress.

        The second line of the street address.  For some addresses, this line may not be needed. 

        :return: The address_line2 of this ShippingAddress.
        :rtype: str
        """
    ...
    def address_line3(self):
        """Gets the address_line3 of this ShippingAddress.

        The third line of the street address.  For some addresses, this line may not be needed. 

        :return: The address_line3 of this ShippingAddress.
        :rtype: str
        """
    ...
    def address_line3(self, address_line3):
        """Sets the address_line3 of this ShippingAddress.
    ...
    def address_residential_indicator(self):
        """Gets the address_residential_indicator of this ShippingAddress.

        Indicates whether this is a residential address.

        :return: The address_residential_indicator of this ShippingAddress.
    ...
    def address_residential_indicator(self, address_residential_indicator):
        """Sets the address_residential_indicator of this ShippingAddress.
    ...
    def city_locality(self):
        """Gets the city_locality of this ShippingAddress.

        The name of the city or locality

        :return: The city_locality of this ShippingAddress.
        :rtype: str
        """
    ...
    def city_locality(self, city_locality):
        """Sets the city_locality of this ShippingAddress.
    ...
    def state_province(self):
        """Gets the state_province of this ShippingAddress.

        The state or province.  For some countries (including the U.S.) only abbreviations are allowed.  Other countries allow the full name or abbreviation. 

        :return: The state_province of this ShippingAddress.
        :rtype: str
        """
    ...
    def state_province(self, state_province):
        """Sets the state_province of this ShippingAddress.
    ...
    def instructions(self):
        """Gets the instructions of this ShippingAddress.

        Additional text about how to handle the shipment at this address. 

        :return: The instructions of this ShippingAddress.
        :rtype: str
        """
    ...
    def instructions(self, instructions):
        """Sets the instructions of this ShippingAddress.
