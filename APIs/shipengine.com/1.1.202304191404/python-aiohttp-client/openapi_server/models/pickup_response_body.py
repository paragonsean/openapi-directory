...
class PickupResponseBody(Model):
    ...
    def __init__(self, cancelled_at: datetime=None, carrier_id: str=None, confirmation_number: str=None, contact_details: ContactDetails=None, created_at: datetime=None, label_ids: List[str]=None, pickup_address: Address=None, pickup_id: str=None, pickup_notes: str=None, pickup_window: PickupWindow=None, pickup_windows: List[PickupWindows]=None, warehouse_id: str=None):
        """PickupResponseBody - a model defined in OpenAPI

        :param cancelled_at: The cancelled_at of this PickupResponseBody.
        :param carrier_id: The carrier_id of this PickupResponseBody.
        :param confirmation_number: The confirmation_number of this PickupResponseBody.
        :param contact_details: The contact_details of this PickupResponseBody.
        :param created_at: The created_at of this PickupResponseBody.
        :param label_ids: The label_ids of this PickupResponseBody.
        :param pickup_address: The pickup_address of this PickupResponseBody.
        :param pickup_id: The pickup_id of this PickupResponseBody.
        :param pickup_notes: The pickup_notes of this PickupResponseBody.
        :param pickup_window: The pickup_window of this PickupResponseBody.
        :param pickup_windows: The pickup_windows of this PickupResponseBody.
        :param warehouse_id: The warehouse_id of this PickupResponseBody.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PickupResponseBody':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The pickup_response_body of this PickupResponseBody.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def cancelled_at(self):
        """Gets the cancelled_at of this PickupResponseBody.

        The date and time that the pickup was cancelled in ShipEngine.

        :return: The cancelled_at of this PickupResponseBody.
        :rtype: datetime
        """
    ...
    def cancelled_at(self, cancelled_at):
        """Sets the cancelled_at of this PickupResponseBody.
    ...
    @property
    def carrier_id(self):
        """Gets the carrier_id of this PickupResponseBody.

        The carrier_id associated with the pickup

        :return: The carrier_id of this PickupResponseBody.
        :rtype: str
        """
    ...
    def carrier_id(self, carrier_id):
        """Sets the carrier_id of this PickupResponseBody.
    ...
    def confirmation_number(self):
        """Gets the confirmation_number of this PickupResponseBody.

        The carrier confirmation number for the scheduled pickup.

        :return: The confirmation_number of this PickupResponseBody.
        :rtype: str
        """
    ...
    def confirmation_number(self, confirmation_number):
        """Sets the confirmation_number of this PickupResponseBody.
    ...
    def contact_details(self):
        """Gets the contact_details of this PickupResponseBody.


        :return: The contact_details of this PickupResponseBody.
    ...
    def contact_details(self, contact_details):
        """Sets the contact_details of this PickupResponseBody.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this PickupResponseBody.

        The date and time that the pickup was created in ShipEngine.

        :return: The created_at of this PickupResponseBody.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this PickupResponseBody.
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this PickupResponseBody.

        Label IDs that will be included in the pickup request

        :return: The label_ids of this PickupResponseBody.
        :rtype: List[str]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this PickupResponseBody.
    ...
    def pickup_address(self):
        """Gets the pickup_address of this PickupResponseBody.


        :return: The pickup_address of this PickupResponseBody.
        :rtype: Address
        """
    ...
    def pickup_address(self, pickup_address):
        """Sets the pickup_address of this PickupResponseBody.
    ...
    @property
    def pickup_id(self):
        """Gets the pickup_id of this PickupResponseBody.

        Pickup Resource ID

        :return: The pickup_id of this PickupResponseBody.
        :rtype: str
        """
    ...
    def pickup_id(self, pickup_id):
        """Sets the pickup_id of this PickupResponseBody.
    ...
    def pickup_notes(self):
        """Gets the pickup_notes of this PickupResponseBody.

        Used by some carriers to give special instructions for a package pickup

        :return: The pickup_notes of this PickupResponseBody.
        :rtype: str
        """
    ...
    def pickup_notes(self, pickup_notes):
        """Sets the pickup_notes of this PickupResponseBody.
    ...
    def pickup_window(self):
        """Gets the pickup_window of this PickupResponseBody.


        :return: The pickup_window of this PickupResponseBody.
        :rtype: PickupWindow
        """
    ...
    def pickup_window(self, pickup_window):
        """Sets the pickup_window of this PickupResponseBody.
    ...
    def pickup_windows(self):
        """Gets the pickup_windows of this PickupResponseBody.

        An array of available pickup windows. Carriers can return multiple times that they will pickup packages. 

        :return: The pickup_windows of this PickupResponseBody.
    ...
    def pickup_windows(self, pickup_windows):
        """Sets the pickup_windows of this PickupResponseBody.
    ...
    def warehouse_id(self):
        """Gets the warehouse_id of this PickupResponseBody.

        The warehouse_id associated with the pickup

        :return: The warehouse_id of this PickupResponseBody.
        :rtype: str
        """
    ...
    def warehouse_id(self, warehouse_id):
        """Sets the warehouse_id of this PickupResponseBody.
