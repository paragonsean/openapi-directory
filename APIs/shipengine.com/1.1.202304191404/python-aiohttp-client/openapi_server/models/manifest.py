...
class Manifest(Model):
    ...
    def __init__(self, carrier_id: str=None, created_at: datetime=None, form_id: str=None, label_ids: List[str]=None, manifest_download: ManifestDownload=None, manifest_id: str=None, ship_date: datetime=None, shipments: int=None, submission_id: str=None, warehouse_id: str=None):
        ...
        :param carrier_id: The carrier_id of this Manifest.
        :param created_at: The created_at of this Manifest.
        :param form_id: The form_id of this Manifest.
        :param label_ids: The label_ids of this Manifest.
        :param manifest_download: The manifest_download of this Manifest.
        :param manifest_id: The manifest_id of this Manifest.
        :param ship_date: The ship_date of this Manifest.
        :param shipments: The shipments of this Manifest.
        :param submission_id: The submission_id of this Manifest.
        :param warehouse_id: The warehouse_id of this Manifest.
        """
        self.openapi_types = {
            'carrier_id': str,
            'created_at': datetime,
    ...
    @property
    def carrier_id(self):
        """Gets the carrier_id of this Manifest.

        A string that uniquely identifies the carrier

        :return: The carrier_id of this Manifest.
        :rtype: str
        """
    ...
    def carrier_id(self, carrier_id):
        """Sets the carrier_id of this Manifest.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this Manifest.

        The date-time that the manifest was created

        :return: The created_at of this Manifest.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this Manifest.
    ...
    @property
    def form_id(self):
        """Gets the form_id of this Manifest.

        A string that uniquely identifies the form

        :return: The form_id of this Manifest.
        :rtype: str
        """
    ...
    def form_id(self, form_id):
        """Sets the form_id of this Manifest.
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this Manifest.

        An array of the label ids used in this manifest.

        :return: The label_ids of this Manifest.
        :rtype: List[str]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this Manifest.
    ...
    def manifest_download(self):
        """Gets the manifest_download of this Manifest.


        :return: The manifest_download of this Manifest.
    ...
    def manifest_download(self, manifest_download):
        """Sets the manifest_download of this Manifest.
    ...
    def manifest_id(self):
        """Gets the manifest_id of this Manifest.

        A string that uniquely identifies the manifest

        :return: The manifest_id of this Manifest.
        :rtype: str
        """
    ...
    @property
    def ship_date(self):
        """Gets the ship_date of this Manifest.

        The date-time that the manifests shipments will be picked up

        :return: The ship_date of this Manifest.
        :rtype: datetime
        """
    ...
    def ship_date(self, ship_date):
        """Sets the ship_date of this Manifest.
    ...
    @property
    def shipments(self):
        """Gets the shipments of this Manifest.

        The number of shipments that are included in this manifest

        :return: The shipments of this Manifest.
        :rtype: int
        """
    ...
    def shipments(self, shipments):
        """Sets the shipments of this Manifest.
    ...
    def submission_id(self):
        """Gets the submission_id of this Manifest.

        A string that uniquely identifies the submission

        :return: The submission_id of this Manifest.
        :rtype: str
        """
    ...
    def submission_id(self, submission_id):
        """Sets the submission_id of this Manifest.
    ...
    def warehouse_id(self):
        """Gets the warehouse_id of this Manifest.

        A string that uniquely identifies the warehouse

        :return: The warehouse_id of this Manifest.
        :rtype: str
        """
    ...
    def warehouse_id(self, warehouse_id):
        """Sets the warehouse_id of this Manifest.
