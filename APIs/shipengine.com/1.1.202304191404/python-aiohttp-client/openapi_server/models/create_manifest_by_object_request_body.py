...
class CreateManifestByObjectRequestBody(Model):
    ...
    def __init__(self, carrier_id: str=None, excluded_label_ids: List[str]=None, label_ids: List[str]=None, ship_date: datetime=None, warehouse_id: str=None):
        """CreateManifestByObjectRequestBody - a model defined in OpenAPI

        :param carrier_id: The carrier_id of this CreateManifestByObjectRequestBody.
        :param excluded_label_ids: The excluded_label_ids of this CreateManifestByObjectRequestBody.
        :param label_ids: The label_ids of this CreateManifestByObjectRequestBody.
        :param ship_date: The ship_date of this CreateManifestByObjectRequestBody.
        :param warehouse_id: The warehouse_id of this CreateManifestByObjectRequestBody.
        """
        self.openapi_types = {
            'carrier_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateManifestByObjectRequestBody':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The create_manifest_by_object_request_body of this CreateManifestByObjectRequestBody.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def carrier_id(self):
        """Gets the carrier_id of this CreateManifestByObjectRequestBody.

        A string that uniquely identifies the carrier

        :return: The carrier_id of this CreateManifestByObjectRequestBody.
        :rtype: str
        """
    ...
    def carrier_id(self, carrier_id):
        """Sets the carrier_id of this CreateManifestByObjectRequestBody.
    ...
    def excluded_label_ids(self):
        """Gets the excluded_label_ids of this CreateManifestByObjectRequestBody.

        The list of label ids to exclude from the manifest

        :return: The excluded_label_ids of this CreateManifestByObjectRequestBody.
        :rtype: List[str]
        """
    ...
    def excluded_label_ids(self, excluded_label_ids):
        """Sets the excluded_label_ids of this CreateManifestByObjectRequestBody.
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this CreateManifestByObjectRequestBody.

        The list of label ids to include for the manifest

        :return: The label_ids of this CreateManifestByObjectRequestBody.
        :rtype: List[str]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this CreateManifestByObjectRequestBody.
    ...
    @property
    def ship_date(self):
        """Gets the ship_date of this CreateManifestByObjectRequestBody.

        The ship date that the shipment will be sent out on

        :return: The ship_date of this CreateManifestByObjectRequestBody.
        :rtype: datetime
        """
    ...
    def ship_date(self, ship_date):
        """Sets the ship_date of this CreateManifestByObjectRequestBody.
    ...
    def warehouse_id(self):
        """Gets the warehouse_id of this CreateManifestByObjectRequestBody.

        A string that uniquely identifies the warehouse

        :return: The warehouse_id of this CreateManifestByObjectRequestBody.
        :rtype: str
        """
    ...
    def warehouse_id(self, warehouse_id):
        """Sets the warehouse_id of this CreateManifestByObjectRequestBody.
