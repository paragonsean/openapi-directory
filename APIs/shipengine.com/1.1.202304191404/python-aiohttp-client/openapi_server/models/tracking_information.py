...
class TrackingInformation(Model):
    ...
    def __init__(self, actual_delivery_date: datetime=None, carrier_code: str=None, carrier_detail_code: str=None, carrier_id: str=None, carrier_status_code: str=None, carrier_status_description: str=None, estimated_delivery_date: datetime=None, events: List[TrackEvent]=None, exception_description: str=None, ship_date: datetime=None, status_code: StatusCode=None, status_description: str=None, tracking_number: str=None, tracking_url: str=None):
        ...
        :param actual_delivery_date: The actual_delivery_date of this TrackingInformation.
        :param carrier_code: The carrier_code of this TrackingInformation.
        :param carrier_detail_code: The carrier_detail_code of this TrackingInformation.
        :param carrier_id: The carrier_id of this TrackingInformation.
        :param carrier_status_code: The carrier_status_code of this TrackingInformation.
        :param carrier_status_description: The carrier_status_description of this TrackingInformation.
        :param estimated_delivery_date: The estimated_delivery_date of this TrackingInformation.
        :param events: The events of this TrackingInformation.
        :param exception_description: The exception_description of this TrackingInformation.
        :param ship_date: The ship_date of this TrackingInformation.
        :param status_code: The status_code of this TrackingInformation.
        :param status_description: The status_description of this TrackingInformation.
        :param tracking_number: The tracking_number of this TrackingInformation.
        :param tracking_url: The tracking_url of this TrackingInformation.
        """
        self.openapi_types = {
    ...
    def from_dict(cls, dikt: dict) -> 'TrackingInformation':
        ...
        :param dikt: A dict.
        :return: The tracking_information of this TrackingInformation.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def actual_delivery_date(self):
        """Gets the actual_delivery_date of this TrackingInformation.

        An [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) string that represents a date and time. 

        :return: The actual_delivery_date of this TrackingInformation.
        :rtype: datetime
        """
    ...
    def actual_delivery_date(self, actual_delivery_date):
        """Sets the actual_delivery_date of this TrackingInformation.
    ...
    def carrier_code(self, carrier_code):
        """Sets the carrier_code of this TrackingInformation.
    ...
    def carrier_detail_code(self):
        """Gets the carrier_detail_code of this TrackingInformation.

        Carrier detail code

        :return: The carrier_detail_code of this TrackingInformation.
        :rtype: str
        """
    ...
    def carrier_detail_code(self, carrier_detail_code):
        """Sets the carrier_detail_code of this TrackingInformation.
    ...
    @property
    def carrier_id(self):
        """Gets the carrier_id of this TrackingInformation.

        A string that uniquely identifies a ShipEngine resource, such as a carrier, label, shipment, etc.

        :return: The carrier_id of this TrackingInformation.
        :rtype: str
        """
    ...
    def carrier_id(self, carrier_id):
        """Sets the carrier_id of this TrackingInformation.
    ...
    def carrier_status_code(self):
        """Gets the carrier_status_code of this TrackingInformation.

        Carrier status code

        :return: The carrier_status_code of this TrackingInformation.
        :rtype: str
        """
    ...
    def carrier_status_code(self, carrier_status_code):
        """Sets the carrier_status_code of this TrackingInformation.
    ...
    def carrier_status_description(self):
        """Gets the carrier_status_description of this TrackingInformation.

        carrier status description

        :return: The carrier_status_description of this TrackingInformation.
        :rtype: str
        """
    ...
    def carrier_status_description(self, carrier_status_description):
        """Sets the carrier_status_description of this TrackingInformation.
    ...
    def estimated_delivery_date(self):
        """Gets the estimated_delivery_date of this TrackingInformation.

        An [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) string that represents a date and time. 

        :return: The estimated_delivery_date of this TrackingInformation.
        :rtype: datetime
        """
    ...
    def estimated_delivery_date(self, estimated_delivery_date):
        """Sets the estimated_delivery_date of this TrackingInformation.
    ...
    @property
    def events(self):
        """Gets the events of this TrackingInformation.

        The events that have occured during the lifetime of this tracking number.

        :return: The events of this TrackingInformation.
    ...
    def events(self, events):
        """Sets the events of this TrackingInformation.
    ...
    def exception_description(self):
        """Gets the exception_description of this TrackingInformation.

        Exception description

        :return: The exception_description of this TrackingInformation.
        :rtype: str
        """
    ...
    def exception_description(self, exception_description):
        """Sets the exception_description of this TrackingInformation.
    ...
    @property
    def ship_date(self):
        """Gets the ship_date of this TrackingInformation.

        An [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) string that represents a date and time. 

        :return: The ship_date of this TrackingInformation.
        :rtype: datetime
        """
    ...
    def ship_date(self, ship_date):
        """Sets the ship_date of this TrackingInformation.
    ...
    def status_code(self):
        """Gets the status_code of this TrackingInformation.


        :return: The status_code of this TrackingInformation.
        :rtype: StatusCode
        """
    ...
    def status_code(self, status_code):
        """Sets the status_code of this TrackingInformation.
    ...
    def status_description(self):
        """Gets the status_description of this TrackingInformation.

        Status description

        :return: The status_description of this TrackingInformation.
        :rtype: str
        """
    ...
    def status_description(self, status_description):
        """Sets the status_description of this TrackingInformation.
    ...
    def tracking_url(self):
        """Gets the tracking_url of this TrackingInformation.

        Carrier Tracking Url, if available

        :return: The tracking_url of this TrackingInformation.
        :rtype: str
        """
    ...
    def tracking_url(self, tracking_url):
        """Sets the tracking_url of this TrackingInformation.
