...
class PackageType(Model):
    ...
    def __init__(self, description: str=None, dimensions: Dimensions=None, name: str=None, package_code: str=None, package_id: str=None):
        ...
        :param description: The description of this PackageType.
        :param dimensions: The dimensions of this PackageType.
        :param name: The name of this PackageType.
        :param package_code: The package_code of this PackageType.
        :param package_id: The package_id of this PackageType.
        """
        self.openapi_types = {
            'description': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PackageType':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The package_type of this PackageType.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def description(self):
        """Gets the description of this PackageType.

        Provides a helpful description for the custom package.

        :return: The description of this PackageType.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PackageType.
    ...
    @property
    def dimensions(self):
        """Gets the dimensions of this PackageType.

        The custom dimensions for the package.

        :return: The dimensions of this PackageType.
        :rtype: Dimensions
        """
    ...
    def dimensions(self, dimensions):
        """Sets the dimensions of this PackageType.
    ...
    @property
    def name(self):
        """Gets the name of this PackageType.


        :return: The name of this PackageType.
        :rtype: str
        """
        return self._name
    ...
    def package_code(self):
        """Gets the package_code of this PackageType.
        ...
        :return: The package_code of this PackageType.
        :rtype: str
        """
    ...
    def package_code(self, package_code):
        """Sets the package_code of this PackageType.
    ...
    @property
    def package_id(self):
        """Gets the package_id of this PackageType.

        A string that uniquely identifies the package.

        :return: The package_id of this PackageType.
        :rtype: str
        """
    ...
    def package_id(self, package_id):
        """Sets the package_id of this PackageType.
