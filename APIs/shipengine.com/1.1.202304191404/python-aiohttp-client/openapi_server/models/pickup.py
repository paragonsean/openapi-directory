...
class Pickup(Model):
    ...
    def __init__(self, cancelled_at: datetime=None, carrier_id: str=None, confirmation_number: str=None, contact_details: ContactDetails=None, created_at: datetime=None, label_ids: List[str]=None, pickup_address: Address=None, pickup_id: str=None, pickup_notes: str=None, pickup_window: PickupWindow=None, pickup_windows: List[PickupWindows]=None, warehouse_id: str=None):
        ...
        :param cancelled_at: The cancelled_at of this Pickup.
        :param carrier_id: The carrier_id of this Pickup.
        :param confirmation_number: The confirmation_number of this Pickup.
        :param contact_details: The contact_details of this Pickup.
        :param created_at: The created_at of this Pickup.
        :param label_ids: The label_ids of this Pickup.
        :param pickup_address: The pickup_address of this Pickup.
        :param pickup_id: The pickup_id of this Pickup.
        :param pickup_notes: The pickup_notes of this Pickup.
        :param pickup_window: The pickup_window of this Pickup.
        :param pickup_windows: The pickup_windows of this Pickup.
        :param warehouse_id: The warehouse_id of this Pickup.
        """
        self.openapi_types = {
    ...
    def cancelled_at(self):
        """Gets the cancelled_at of this Pickup.

        The date and time that the pickup was cancelled in ShipEngine.

        :return: The cancelled_at of this Pickup.
        :rtype: datetime
        """
    ...
    def cancelled_at(self, cancelled_at):
        """Sets the cancelled_at of this Pickup.
    ...
    @property
    def carrier_id(self):
        """Gets the carrier_id of this Pickup.

        The carrier_id associated with the pickup

        :return: The carrier_id of this Pickup.
        :rtype: str
        """
    ...
    def confirmation_number(self):
        """Gets the confirmation_number of this Pickup.

        The carrier confirmation number for the scheduled pickup.

        :return: The confirmation_number of this Pickup.
        :rtype: str
        """
    ...
    def contact_details(self):
        """Gets the contact_details of this Pickup.


        :return: The contact_details of this Pickup.
    ...
    def contact_details(self, contact_details):
        """Sets the contact_details of this Pickup.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this Pickup.

        The date and time that the pickup was created in ShipEngine.

        :return: The created_at of this Pickup.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this Pickup.
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this Pickup.

        Label IDs that will be included in the pickup request

        :return: The label_ids of this Pickup.
        :rtype: List[str]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this Pickup.
    ...
    def pickup_address(self):
        """Gets the pickup_address of this Pickup.


        :return: The pickup_address of this Pickup.
        :rtype: Address
        """
    ...
    def pickup_address(self, pickup_address):
        """Sets the pickup_address of this Pickup.
    ...
    @property
    def pickup_id(self):
        """Gets the pickup_id of this Pickup.

        Pickup Resource ID

        :return: The pickup_id of this Pickup.
        :rtype: str
        """
    ...
    def pickup_id(self, pickup_id):
        """Sets the pickup_id of this Pickup.
    ...
    def pickup_notes(self):
        """Gets the pickup_notes of this Pickup.

        Used by some carriers to give special instructions for a package pickup

        :return: The pickup_notes of this Pickup.
        :rtype: str
        """
    ...
    def pickup_notes(self, pickup_notes):
        """Sets the pickup_notes of this Pickup.
    ...
    def pickup_window(self):
        """Gets the pickup_window of this Pickup.


        :return: The pickup_window of this Pickup.
        :rtype: PickupWindow
        """
    ...
    def pickup_window(self, pickup_window):
        """Sets the pickup_window of this Pickup.
    ...
    def pickup_windows(self, pickup_windows):
        """Sets the pickup_windows of this Pickup.
    ...
    def warehouse_id(self):
        """Gets the warehouse_id of this Pickup.

        The warehouse_id associated with the pickup

        :return: The warehouse_id of this Pickup.
        :rtype: str
        """
    ...
    def warehouse_id(self, warehouse_id):
        """Sets the warehouse_id of this Pickup.
