...
class CreateBatchResponseBody(Model):
    ...
    def __init__(self, batch_errors_url: OptionalLink=None, batch_id: str=None, batch_labels_url: OptionalLink=None, batch_notes: str='', batch_number: str=None, batch_shipments_url: OptionalLink=None, completed: int=None, count: int=None, created_at: datetime=None, errors: int=None, external_batch_id: str=None, form_download: OptionalLink=None, forms: int=None, label_download: LabelDownload=None, label_format: LabelFormat=None, label_layout: LabelLayout=None, processed_at: datetime=None, status: BatchStatus=None, warnings: int=None):
        """CreateBatchResponseBody - a model defined in OpenAPI

        :param batch_errors_url: The batch_errors_url of this CreateBatchResponseBody.
        :param batch_id: The batch_id of this CreateBatchResponseBody.
        :param batch_labels_url: The batch_labels_url of this CreateBatchResponseBody.
        :param batch_notes: The batch_notes of this CreateBatchResponseBody.
        :param batch_number: The batch_number of this CreateBatchResponseBody.
        :param batch_shipments_url: The batch_shipments_url of this CreateBatchResponseBody.
        :param completed: The completed of this CreateBatchResponseBody.
        :param count: The count of this CreateBatchResponseBody.
        :param created_at: The created_at of this CreateBatchResponseBody.
        :param errors: The errors of this CreateBatchResponseBody.
        :param external_batch_id: The external_batch_id of this CreateBatchResponseBody.
        :param form_download: The form_download of this CreateBatchResponseBody.
        :param forms: The forms of this CreateBatchResponseBody.
        :param label_download: The label_download of this CreateBatchResponseBody.
        :param label_format: The label_format of this CreateBatchResponseBody.
        :param label_layout: The label_layout of this CreateBatchResponseBody.
        :param processed_at: The processed_at of this CreateBatchResponseBody.
        :param status: The status of this CreateBatchResponseBody.
        :param warnings: The warnings of this CreateBatchResponseBody.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateBatchResponseBody':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The create_batch_response_body of this CreateBatchResponseBody.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def batch_errors_url(self):
        """Gets the batch_errors_url of this CreateBatchResponseBody.

        Link to batch errors endpoint

        :return: The batch_errors_url of this CreateBatchResponseBody.
        :rtype: OptionalLink
        """
    ...
    def batch_errors_url(self, batch_errors_url):
        """Sets the batch_errors_url of this CreateBatchResponseBody.
    ...
    @property
    def batch_id(self):
        """Gets the batch_id of this CreateBatchResponseBody.

        A string that uniquely identifies the batch

        :return: The batch_id of this CreateBatchResponseBody.
        :rtype: str
        """
    ...
    def batch_id(self, batch_id):
        """Sets the batch_id of this CreateBatchResponseBody.
    ...
    def batch_labels_url(self):
        """Gets the batch_labels_url of this CreateBatchResponseBody.

        Link to batch labels query

        :return: The batch_labels_url of this CreateBatchResponseBody.
        :rtype: OptionalLink
        """
    ...
    def batch_labels_url(self, batch_labels_url):
        """Sets the batch_labels_url of this CreateBatchResponseBody.
    ...
    def batch_notes(self):
        """Gets the batch_notes of this CreateBatchResponseBody.

        Custom notes you can add for each created batch

        :return: The batch_notes of this CreateBatchResponseBody.
        :rtype: str
        """
    ...
    def batch_notes(self, batch_notes):
        """Sets the batch_notes of this CreateBatchResponseBody.
    ...
    def batch_number(self):
        """Gets the batch_number of this CreateBatchResponseBody.

        The batch number.

        :return: The batch_number of this CreateBatchResponseBody.
        :rtype: str
        """
    ...
    def batch_number(self, batch_number):
        """Sets the batch_number of this CreateBatchResponseBody.
    ...
    def batch_shipments_url(self):
        """Gets the batch_shipments_url of this CreateBatchResponseBody.

        The batch shipments endpoint

        :return: The batch_shipments_url of this CreateBatchResponseBody.
        :rtype: OptionalLink
        """
    ...
    def batch_shipments_url(self, batch_shipments_url):
        """Sets the batch_shipments_url of this CreateBatchResponseBody.
    ...
    @property
    def completed(self):
        """Gets the completed of this CreateBatchResponseBody.

        The number of labels generated in the batch

        :return: The completed of this CreateBatchResponseBody.
        :rtype: int
        """
    ...
    def completed(self, completed):
        """Sets the completed of this CreateBatchResponseBody.
    ...
    @property
    def count(self):
        """Gets the count of this CreateBatchResponseBody.

        The total of errors, warnings, and completed properties

        :return: The count of this CreateBatchResponseBody.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this CreateBatchResponseBody.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this CreateBatchResponseBody.

        The date and time the batch was created in ShipEngine

        :return: The created_at of this CreateBatchResponseBody.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this CreateBatchResponseBody.
    ...
    @property
    def errors(self):
        """Gets the errors of this CreateBatchResponseBody.

        The number of errors that occurred while generating the batch

        :return: The errors of this CreateBatchResponseBody.
        :rtype: int
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this CreateBatchResponseBody.
    ...
    def external_batch_id(self):
        """Gets the external_batch_id of this CreateBatchResponseBody.

        A string that uniquely identifies the external batch

        :return: The external_batch_id of this CreateBatchResponseBody.
        :rtype: str
        """
    ...
    def external_batch_id(self, external_batch_id):
        """Sets the external_batch_id of this CreateBatchResponseBody.
    ...
    def form_download(self):
        """Gets the form_download of this CreateBatchResponseBody.

        The form download for any customs that are needed

        :return: The form_download of this CreateBatchResponseBody.
        :rtype: OptionalLink
        """
    ...
    def form_download(self, form_download):
        """Sets the form_download of this CreateBatchResponseBody.
    ...
    @property
    def forms(self):
        """Gets the forms of this CreateBatchResponseBody.

        The number of forms for customs that are available for download

        :return: The forms of this CreateBatchResponseBody.
        :rtype: int
        """
        return self._forms
    ...
    def forms(self, forms):
        """Sets the forms of this CreateBatchResponseBody.
    ...
    def label_download(self):
        """Gets the label_download of this CreateBatchResponseBody.

        The label download for the batch

        :return: The label_download of this CreateBatchResponseBody.
        :rtype: LabelDownload
        """
    ...
    def label_download(self, label_download):
        """Sets the label_download of this CreateBatchResponseBody.
    ...
    def label_format(self):
        """Gets the label_format of this CreateBatchResponseBody.


        :return: The label_format of this CreateBatchResponseBody.
        :rtype: LabelFormat
        """
    ...
    def label_format(self, label_format):
        """Sets the label_format of this CreateBatchResponseBody.
    ...
    def label_layout(self):
        """Gets the label_layout of this CreateBatchResponseBody.

        label layout

        :return: The label_layout of this CreateBatchResponseBody.
        :rtype: LabelLayout
        """
    ...
    def label_layout(self, label_layout):
        """Sets the label_layout of this CreateBatchResponseBody.
    ...
    def processed_at(self):
        """Gets the processed_at of this CreateBatchResponseBody.

        The date and time the batch was processed in ShipEngine

        :return: The processed_at of this CreateBatchResponseBody.
        :rtype: datetime
        """
    ...
    def processed_at(self, processed_at):
        """Sets the processed_at of this CreateBatchResponseBody.
    ...
    @property
    def status(self):
        """Gets the status of this CreateBatchResponseBody.


        :return: The status of this CreateBatchResponseBody.
        :rtype: BatchStatus
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CreateBatchResponseBody.
    ...
    @property
    def warnings(self):
        """Gets the warnings of this CreateBatchResponseBody.

        The number of warnings that occurred while generating the batch

        :return: The warnings of this CreateBatchResponseBody.
        :rtype: int
        """
    ...
    def warnings(self, warnings):
        """Sets the warnings of this CreateBatchResponseBody.
