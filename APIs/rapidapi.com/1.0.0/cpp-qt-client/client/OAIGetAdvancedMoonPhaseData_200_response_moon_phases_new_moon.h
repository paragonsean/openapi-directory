...
/*
 * OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon.h
 *
 * 
 */

#ifndef OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_H
#define OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_H

#include <QJsonObject>

#include "OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current.h"
...
namespace OpenAPI {
class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current;
class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next;

class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon : public OAIObject {
public:
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon();
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon(QString json);
    ~OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon() override;
    ...
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current getCurrent() const;
    void setCurrent(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current &current);
    bool is_current_Set() const;
    bool is_current_Valid() const;

    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next getNext() const;
    void setNext(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next &next);
...
private:
    ...
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current m_current;
    bool m_current_isSet;
    bool m_current_isValid;

    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next m_next;
    bool m_next_isSet;
    bool m_next_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon)

#endif // OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_H
