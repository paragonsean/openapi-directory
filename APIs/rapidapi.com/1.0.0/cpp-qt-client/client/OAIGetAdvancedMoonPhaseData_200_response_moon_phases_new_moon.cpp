...
OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon() {
    this->initializeModel();
}

OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::~OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon() {}

void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::initializeModel() {
...
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::fromJson(QString jsonString) {
...
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::fromJsonObject(QJsonObject json) {
...
QString OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::asJson() const {
...
QJsonObject OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::asJsonObject() const {
    QJsonObject obj;
    if (m_current.isSet()) {
...
OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::getCurrent() const {
    return m_current;
}
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::setCurrent(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_current &current) {
    m_current = current;
    m_current_isSet = true;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::is_current_Set() const{
    return m_current_isSet;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::is_current_Valid() const{
    return m_current_isValid;
}

OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::getNext() const {
    return m_next;
}
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::setNext(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next &next) {
    m_next = next;
    m_next_isSet = true;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::is_next_Set() const{
    return m_next_isSet;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::is_next_Valid() const{
    return m_next_isValid;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::isSet() const {
...
bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon::isValid() const {
