...
OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter() {
    this->initializeModel();
}

OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::~OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter() {}

void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::initializeModel() {
...
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::fromJson(QString jsonString) {
...
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::fromJsonObject(QJsonObject json) {
...
QString OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::asJson() const {
...
QJsonObject OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::asJsonObject() const {
    QJsonObject obj;
    if (m_current.isSet()) {
...
OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter_current OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::getCurrent() const {
    return m_current;
}
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::setCurrent(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter_current &current) {
    m_current = current;
    m_current_isSet = true;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::is_current_Set() const{
    return m_current_isSet;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::is_current_Valid() const{
    return m_current_isValid;
}

OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter_next OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::getNext() const {
    return m_next;
}
void OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::setNext(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter_next &next) {
    m_next = next;
    m_next_isSet = true;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::is_next_Set() const{
    return m_next_isSet;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::is_next_Valid() const{
    return m_next_isValid;
}

bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::isSet() const {
...
bool OAIGetAdvancedMoonPhaseData_200_response_moon_phases_first_quarter::isValid() const {
