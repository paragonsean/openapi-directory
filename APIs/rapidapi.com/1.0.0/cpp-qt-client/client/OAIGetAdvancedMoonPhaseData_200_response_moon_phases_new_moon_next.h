...
/*
 * OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next.h
 *
 * 
 */

#ifndef OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next_H
#define OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next_H
...
class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next : public OAIObject {
public:
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next();
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next(QString json);
    ~OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next() override;
    ...
    double getDaysAhead() const;
    void setDaysAhead(const double &days_ahead);
    bool is_days_ahead_Set() const;
    bool is_days_ahead_Valid() const;
...
private:
    ...
    double m_days_ahead;
    bool m_days_ahead_isSet;
    bool m_days_ahead_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next)

#endif // OAIGetAdvancedMoonPhaseData_200_response_moon_phases_new_moon_next_H
