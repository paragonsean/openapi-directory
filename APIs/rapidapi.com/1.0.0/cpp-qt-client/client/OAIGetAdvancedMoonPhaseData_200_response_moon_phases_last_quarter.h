...
/*
 * OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter.h
 *
 * 
 */

#ifndef OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_H
#define OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_H

#include <QJsonObject>

#include "OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_current.h"
#include "OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_next.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_current;
class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_next;

class OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter : public OAIObject {
public:
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter();
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter(QString json);
    ~OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter() override;
    ...
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_current getCurrent() const;
    void setCurrent(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_current &current);
    bool is_current_Set() const;
    bool is_current_Valid() const;

    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_next getNext() const;
    void setNext(const OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_next &next);
...
private:
    ...
    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_current m_current;
    bool m_current_isSet;
    bool m_current_isValid;

    OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_next m_next;
    bool m_next_isSet;
    bool m_next_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter)

#endif // OAIGetAdvancedMoonPhaseData_200_response_moon_phases_last_quarter_H
