...
/**
 * The GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext model module.
 * @module model/GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext
 * @version 1.0.0
 */
class GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext {
    /**
     * Constructs a new <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext</code>.
     * @alias module:model/GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext
     */
    constructor() { 
        
        GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext} obj Optional instance to populate.
     * @return {module:model/GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext} The populated <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext();
    ...
    /**
     * Validates the JSON data with respect to <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext</code>.
     */
 ...
 */
GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext.prototype['datestamp'] = undefined;

/**
 * @member {Number} days_ahead
 */
GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext.prototype['days_ahead'] = undefined;

/**
 * @member {Number} timestamp
 */
GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext.prototype['timestamp'] = undefined;
...
export default GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonNext;
