...
/**
 * The GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext model module.
 * @module model/GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext
 * @version 1.0.0
 */
class GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext {
    /**
     * Constructs a new <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext</code>.
     * @alias module:model/GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext
     */
    constructor() { 
        
        GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext} obj Optional instance to populate.
     * @return {module:model/GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext} The populated <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext();

            if (data.hasOwnProperty('datestamp')) {
                obj['datestamp'] = ApiClient.convertToType(data['datestamp'], 'String');
            }
            if (data.hasOwnProperty('days_ahead')) {
                obj['days_ahead'] = ApiClient.convertToType(data['days_ahead'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext</code>.
     */
 ...
 */
GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext.prototype['datestamp'] = undefined;

/**
 * @member {Number} days_ahead
 */
GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext.prototype['days_ahead'] = undefined;

/**
 * @member {Number} timestamp
 */
GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext.prototype['timestamp'] = undefined;
...
export default GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext;
