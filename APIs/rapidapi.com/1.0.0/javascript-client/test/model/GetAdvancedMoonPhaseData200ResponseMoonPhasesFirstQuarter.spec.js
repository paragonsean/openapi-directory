...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarter);
    });
