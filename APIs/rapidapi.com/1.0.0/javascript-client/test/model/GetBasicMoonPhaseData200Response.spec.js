...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetBasicMoonPhaseData200Response();
  });
  ...
  describe('GetBasicMoonPhaseData200Response', function() {
    it('should create an instance of GetBasicMoonPhaseData200Response', function() {
      // uncomment below and update the code to test GetBasicMoonPhaseData200Response
      //var instance = new MoonApi.GetBasicMoonPhaseData200Response();
      //expect(instance).to.be.a(MoonApi.GetBasicMoonPhaseData200Response);
    });

    it('should have the property daysUntilNextFullMoon (base name: "days_until_next_full_moon")', function() {
      // uncomment below and update the code to test the property daysUntilNextFullMoon
      //var instance = new MoonApi.GetBasicMoonPhaseData200Response();
      //expect(instance).to.be();
    });

    it('should have the property daysUntilNextNewMoon (base name: "days_until_next_new_moon")', function() {
      // uncomment below and update the code to test the property daysUntilNextNewMoon
      //var instance = new MoonApi.GetBasicMoonPhaseData200Response();
      //expect(instance).to.be();
    });
