...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterNext);
    });
