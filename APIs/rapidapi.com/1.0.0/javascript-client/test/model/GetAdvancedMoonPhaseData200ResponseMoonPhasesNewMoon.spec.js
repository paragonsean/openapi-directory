...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoon);
    });
