...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonNext);
    });
