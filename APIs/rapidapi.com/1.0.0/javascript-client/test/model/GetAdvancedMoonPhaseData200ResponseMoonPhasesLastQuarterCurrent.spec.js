...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarterCurrent);
    });
