...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterNext);
    });
