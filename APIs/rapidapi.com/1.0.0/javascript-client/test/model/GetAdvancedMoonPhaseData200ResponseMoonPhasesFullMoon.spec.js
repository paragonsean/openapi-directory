...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoon);
    });
