...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFirstQuarterCurrent);
    });
