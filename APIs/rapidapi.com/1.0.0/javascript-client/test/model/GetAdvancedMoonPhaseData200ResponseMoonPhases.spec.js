...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhases', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhases', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhases
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases);
    });

    it('should have the property firstQuarter (base name: "first_quarter")', function() {
      // uncomment below and update the code to test the property firstQuarter
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases();
      //expect(instance).to.be();
    });

    it('should have the property fullMoon (base name: "full_moon")', function() {
      // uncomment below and update the code to test the property fullMoon
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases();
      //expect(instance).to.be();
    });

    it('should have the property lastQuarter (base name: "last_quarter")', function() {
      // uncomment below and update the code to test the property lastQuarter
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases();
      //expect(instance).to.be();
    });

    it('should have the property newMoon (base name: "new_moon")', function() {
      // uncomment below and update the code to test the property newMoon
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhases();
      //expect(instance).to.be();
    });
