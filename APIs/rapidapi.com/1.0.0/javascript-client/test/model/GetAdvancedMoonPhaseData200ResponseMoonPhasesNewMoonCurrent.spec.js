...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesNewMoonCurrent);
    });
