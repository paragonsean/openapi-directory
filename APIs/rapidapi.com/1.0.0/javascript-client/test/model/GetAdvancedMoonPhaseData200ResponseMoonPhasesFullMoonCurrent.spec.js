...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent);
    });
    ...
    it('should have the property daysAgo (base name: "days_ago")', function() {
      // uncomment below and update the code to test the property daysAgo
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesFullMoonCurrent();
      //expect(instance).to.be();
    });
