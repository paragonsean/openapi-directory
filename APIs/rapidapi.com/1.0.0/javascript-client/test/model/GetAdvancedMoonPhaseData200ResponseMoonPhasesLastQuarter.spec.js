...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter();
  });
  ...
  describe('GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter', function() {
    it('should create an instance of GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter', function() {
      // uncomment below and update the code to test GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter
      //var instance = new MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter();
      //expect(instance).to.be.a(MoonApi.GetAdvancedMoonPhaseData200ResponseMoonPhasesLastQuarter);
    });
