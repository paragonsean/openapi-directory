...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MoonApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('getAdvancedMoonPhaseData', function() {
      it('should call getAdvancedMoonPhaseData successfully', function(done) {
        //uncomment below and update the code to test getAdvancedMoonPhaseData
        //instance.getAdvancedMoonPhaseData(function(error) {
    ...
    describe('getBasicMoonPhaseData', function() {
      it('should call getBasicMoonPhaseData successfully', function(done) {
        //uncomment below and update the code to test getBasicMoonPhaseData
        //instance.getBasicMoonPhaseData(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEmojiOfMoonPhase', function() {
      it('should call getEmojiOfMoonPhase successfully', function(done) {
        //uncomment below and update the code to test getEmojiOfMoonPhase
        //instance.getEmojiOfMoonPhase(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getLunarCalendar', function() {
      it('should call getLunarCalendar successfully', function(done) {
        //uncomment below and update the code to test getLunarCalendar
        //instance.getLunarCalendar(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPlainTextMoonPhaseData', function() {
      it('should call getPlainTextMoonPhaseData successfully', function(done) {
        //uncomment below and update the code to test getPlainTextMoonPhaseData
        //instance.getPlainTextMoonPhaseData(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
