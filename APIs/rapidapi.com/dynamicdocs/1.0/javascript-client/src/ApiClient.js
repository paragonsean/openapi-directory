...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://dynamicdocs.p.rapidapi.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://dynamicdocs.p.rapidapi.com
         */
        ...
        this.authentications = {
            'Adv-Security-Token': {type: 'apiKey', 'in': 'header', name: 'ADVICEment API Key'},
            'X-RapidAPI-Key': {type: 'apiKey', 'in': 'header', name: 'RapidAPI.com API Key'}
        }
