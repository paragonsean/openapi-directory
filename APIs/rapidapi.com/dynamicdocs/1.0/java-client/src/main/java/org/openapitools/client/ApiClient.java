...
public class ApiClient {
    ...
    private String basePath = "https://dynamicdocs.p.rapidapi.com";
    ...
    public ApiClient() {
        ...
        authentications.put("Adv-Security-Token", new ApiKeyAuth("header", "ADVICEment API Key"));
        authentications.put("X-RapidAPI-Key", new ApiKeyAuth("header", "RapidAPI.com API Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dynamicdocs.p.rapidapi.com
