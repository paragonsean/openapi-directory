...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://language-identification-prediction.p.rapidapi.com/v1/"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("recognizeLanguagePost", defaultConf);
    _serverIndices.insert("recognizeLanguagePost", 0);
}
...
void OAIDefaultApi::recognizeLanguagePost(const QString &x_rapid_api_host, const QString &x_rapid_api_key, const QString &text) {
    QString fullPath = QString(_serverConfigs["recognizeLanguagePost"][_serverIndices.value("recognizeLanguagePost")].URL()+"/recognize-language/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::recognizeLanguagePostCallback);
...
void OAIDefaultApi::recognizeLanguagePostCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT recognizeLanguagePostSignal();
        Q_EMIT recognizeLanguagePostSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT recognizeLanguagePostSignalE(error_type, error_str);
        Q_EMIT recognizeLanguagePostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT recognizeLanguagePostSignalError(error_type, error_str);
        Q_EMIT recognizeLanguagePostSignalErrorFull(worker, error_type, error_str);
    }
}
