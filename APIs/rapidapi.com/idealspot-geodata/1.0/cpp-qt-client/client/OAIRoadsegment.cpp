...
OAIRoadsegment::OAIRoadsegment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRoadsegment::OAIRoadsegment() {
    this->initializeModel();
}

OAIRoadsegment::~OAIRoadsegment() {}

void OAIRoadsegment::initializeModel() {
...
void OAIRoadsegment::fromJson(QString jsonString) {
...
void OAIRoadsegment::fromJsonObject(QJsonObject json) {
...
QString OAIRoadsegment::asJson() const {
...
QJsonObject OAIRoadsegment::asJsonObject() const {
    QJsonObject obj;
...
QList<QList<double>> OAIRoadsegment::getCoordinates() const {
    return m_coordinates;
}
void OAIRoadsegment::setCoordinates(const QList<QList<double>> &coordinates) {
    m_coordinates = coordinates;
    m_coordinates_isSet = true;
}

bool OAIRoadsegment::is_coordinates_Set() const{
    return m_coordinates_isSet;
}

bool OAIRoadsegment::is_coordinates_Valid() const{
    return m_coordinates_isValid;
}

QString OAIRoadsegment::getType() const {
    return m_type;
}
void OAIRoadsegment::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIRoadsegment::is_type_Set() const{
    return m_type_isSet;
}

bool OAIRoadsegment::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIRoadsegment::isSet() const {
...
bool OAIRoadsegment::isValid() const {
