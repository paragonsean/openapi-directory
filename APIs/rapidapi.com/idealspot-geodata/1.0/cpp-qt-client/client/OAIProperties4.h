...
#ifndef OAIProperties4_H
#define OAIProperties4_H
...
class OAIProperties4 : public OAIObject {
public:
    OAIProperties4();
    OAIProperties4(QString json);
    ~OAIProperties4() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProperties4)

#endif // OAIProperties4_H
