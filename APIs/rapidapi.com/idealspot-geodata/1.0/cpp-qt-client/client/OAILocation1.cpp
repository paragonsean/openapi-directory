...
QString OAILocation1::getAreatype() const {
    return m_areatype;
}
void OAILocation1::setAreatype(const QString &areatype) {
    m_areatype = areatype;
    m_areatype_isSet = true;
}

bool OAILocation1::is_areatype_Set() const{
    return m_areatype_isSet;
}

bool OAILocation1::is_areatype_Valid() const{
    return m_areatype_isValid;
}

double OAILocation1::getLatitude() const {
    return m_latitude;
}
void OAILocation1::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAILocation1::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAILocation1::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAILocation1::getLongitude() const {
    return m_longitude;
}
void OAILocation1::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAILocation1::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAILocation1::is_longitude_Valid() const{
    return m_longitude_isValid;
}

qint32 OAILocation1::getRadius() const {
    return m_radius;
}
void OAILocation1::setRadius(const qint32 &radius) {
    m_radius = radius;
    m_radius_isSet = true;
}

bool OAILocation1::is_radius_Set() const{
    return m_radius_isSet;
}

bool OAILocation1::is_radius_Valid() const{
    return m_radius_isValid;
}

QString OAILocation1::getType() const {
    return m_type;
}
void OAILocation1::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILocation1::is_type_Set() const{
    return m_type_isSet;
}

bool OAILocation1::is_type_Valid() const{
    return m_type_isValid;
}

QString OAILocation1::getUnits() const {
    return m_units;
}
void OAILocation1::setUnits(const QString &units) {
    m_units = units;
    m_units_isSet = true;
}

bool OAILocation1::is_units_Set() const{
    return m_units_isSet;
}

bool OAILocation1::is_units_Valid() const{
