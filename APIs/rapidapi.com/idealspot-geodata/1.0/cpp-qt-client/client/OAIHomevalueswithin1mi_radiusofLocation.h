...
/*
 * OAIHomevalueswithin1mi_radiusofLocation.h
 *
 * 
 */

#ifndef OAIHomevalueswithin1mi_radiusofLocation_H
#define OAIHomevalueswithin1mi_radiusofLocation_H
...
class OAIHomevalueswithin1mi_radiusofLocation : public OAIObject {
public:
    OAIHomevalueswithin1mi_radiusofLocation();
    OAIHomevalueswithin1mi_radiusofLocation(QString json);
    ~OAIHomevalueswithin1mi_radiusofLocation() override;
    ...
    QList<OAIData1> getData() const;
    void setData(const QList<OAIData1> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIHomevalueswithin1mi_radiusofLocation)

#endif // OAIHomevalueswithin1mi_radiusofLocation_H
