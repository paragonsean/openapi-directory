...
#include "OAIDescribe_occupation_Insight.h"
...
OAIDescribe_occupation_Insight::OAIDescribe_occupation_Insight(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribe_occupation_Insight::OAIDescribe_occupation_Insight() {
    this->initializeModel();
}

OAIDescribe_occupation_Insight::~OAIDescribe_occupation_Insight() {}

void OAIDescribe_occupation_Insight::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIDescribe_occupation_Insight::fromJson(QString jsonString) {
...
void OAIDescribe_occupation_Insight::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIDescribe_occupation_Insight::asJson() const {
...
QJsonObject OAIDescribe_occupation_Insight::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIData OAIDescribe_occupation_Insight::getData() const {
    return m_data;
}
void OAIDescribe_occupation_Insight::setData(const OAIData &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDescribe_occupation_Insight::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDescribe_occupation_Insight::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIDescribe_occupation_Insight::isSet() const {
...
bool OAIDescribe_occupation_Insight::isValid() const {
