...
OAIListAllLocalInsights::OAIListAllLocalInsights(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListAllLocalInsights::OAIListAllLocalInsights() {
    this->initializeModel();
}

OAIListAllLocalInsights::~OAIListAllLocalInsights() {}

void OAIListAllLocalInsights::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIListAllLocalInsights::fromJson(QString jsonString) {
...
void OAIListAllLocalInsights::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIListAllLocalInsights::asJson() const {
...
QJsonObject OAIListAllLocalInsights::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIDatum> OAIListAllLocalInsights::getData() const {
    return m_data;
}
void OAIListAllLocalInsights::setData(const QList<OAIDatum> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIListAllLocalInsights::is_data_Set() const{
    return m_data_isSet;
}

bool OAIListAllLocalInsights::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIListAllLocalInsights::isSet() const {
...
bool OAIListAllLocalInsights::isValid() const {
