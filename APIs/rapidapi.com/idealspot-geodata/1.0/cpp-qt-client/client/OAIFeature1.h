...
#ifndef OAIFeature1_H
#define OAIFeature1_H
...
namespace OpenAPI {
class OAIGeometry;
class OAIProperties3;

class OAIFeature1 : public OAIObject {
public:
    OAIFeature1();
    OAIFeature1(QString json);
    ~OAIFeature1() override;
    ...
    OAIProperties3 getProperties() const;
    void setProperties(const OAIProperties3 &properties);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFeature1)
