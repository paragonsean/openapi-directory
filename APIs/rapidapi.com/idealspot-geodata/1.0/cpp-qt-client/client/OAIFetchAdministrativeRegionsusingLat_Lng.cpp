...
OAIFetchAdministrativeRegionsusingLat_Lng::OAIFetchAdministrativeRegionsusingLat_Lng(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFetchAdministrativeRegionsusingLat_Lng::OAIFetchAdministrativeRegionsusingLat_Lng() {
    this->initializeModel();
}

OAIFetchAdministrativeRegionsusingLat_Lng::~OAIFetchAdministrativeRegionsusingLat_Lng() {}

void OAIFetchAdministrativeRegionsusingLat_Lng::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIFetchAdministrativeRegionsusingLat_Lng::fromJson(QString jsonString) {
...
void OAIFetchAdministrativeRegionsusingLat_Lng::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIFetchAdministrativeRegionsusingLat_Lng::asJson() const {
...
QJsonObject OAIFetchAdministrativeRegionsusingLat_Lng::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIData2> OAIFetchAdministrativeRegionsusingLat_Lng::getData() const {
    return m_data;
}
void OAIFetchAdministrativeRegionsusingLat_Lng::setData(const QList<OAIData2> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIFetchAdministrativeRegionsusingLat_Lng::is_data_Set() const{
    return m_data_isSet;
}

bool OAIFetchAdministrativeRegionsusingLat_Lng::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIFetchAdministrativeRegionsusingLat_Lng::isSet() const {
...
bool OAIFetchAdministrativeRegionsusingLat_Lng::isValid() const {
