...
public:
    ...
    QList<QList<QString>> getDatetime() const;
    void setDatetime(const QList<QList<QString>> &datetime);
    bool is_datetime_Set() const;
    bool is_datetime_Valid() const;

    QList<QList<QString>> getDisplayGroups() const;
    void setDisplayGroups(const QList<QList<QString>> &display_groups);
    bool is_display_groups_Set() const;
    bool is_display_groups_Valid() const;

    OAIUnits getUnits() const;
    void setUnits(const OAIUnits &units);
...
private:
    ...
    QList<QList<QString>> m_datetime;
    bool m_datetime_isSet;
    bool m_datetime_isValid;

    QList<QList<QString>> m_display_groups;
    bool m_display_groups_isSet;
    bool m_display_groups_isValid;
