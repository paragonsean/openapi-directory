...
#ifndef OAIProperties2_H
#define OAIProperties2_H
...
class OAIProperties2 : public OAIObject {
public:
    OAIProperties2();
    OAIProperties2(QString json);
    ~OAIProperties2() override;
    ...
    double getCalculatedAreaSqMeters() const;
    void setCalculatedAreaSqMeters(const double &calculated_area_sq_meters);
    bool is_calculated_area_sq_meters_Set() const;
    bool is_calculated_area_sq_meters_Valid() const;

    OAILocation3 getLocation() const;
    void setLocation(const OAILocation3 &location);
...
private:
    ...
    double m_calculated_area_sq_meters;
    bool m_calculated_area_sq_meters_isSet;
    bool m_calculated_area_sq_meters_isValid;

    OAILocation3 m_location;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProperties2)

#endif // OAIProperties2_H
