...
OAISearchRoadSegments::OAISearchRoadSegments(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchRoadSegments::OAISearchRoadSegments() {
    this->initializeModel();
}

OAISearchRoadSegments::~OAISearchRoadSegments() {}

void OAISearchRoadSegments::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAISearchRoadSegments::fromJson(QString jsonString) {
...
void OAISearchRoadSegments::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAISearchRoadSegments::asJson() const {
...
QJsonObject OAISearchRoadSegments::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIData4 OAISearchRoadSegments::getData() const {
    return m_data;
}
void OAISearchRoadSegments::setData(const OAIData4 &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAISearchRoadSegments::is_data_Set() const{
    return m_data_isSet;
}

bool OAISearchRoadSegments::is_data_Valid() const{
    return m_data_isValid;
}

bool OAISearchRoadSegments::isSet() const {
...
bool OAISearchRoadSegments::isValid() const {
