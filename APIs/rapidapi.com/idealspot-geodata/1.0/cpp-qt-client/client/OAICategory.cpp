...
QString OAICategory::getLabel() const {
    return m_label;
}
void OAICategory::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAICategory::is_label_Set() const{
    return m_label_isSet;
}

bool OAICategory::is_label_Valid() const{
...
bool OAICategory::isValid() const {
    ...
    return m_description_isValid && m_id_isValid && m_label_isValid && m_parent_id_isValid && true;
}
