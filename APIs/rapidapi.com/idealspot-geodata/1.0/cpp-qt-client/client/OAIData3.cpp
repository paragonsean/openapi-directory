...
QList<OAIFeature> OAIData3::getFeatures() const {
    return m_features;
}
void OAIData3::setFeatures(const QList<OAIFeature> &features) {
    m_features = features;
    m_features_isSet = true;
}

bool OAIData3::is_features_Set() const{
    return m_features_isSet;
}

bool OAIData3::is_features_Valid() const{
    return m_features_isValid;
}

QString OAIData3::getType() const {
    return m_type;
}
void OAIData3::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIData3::is_type_Set() const{
    return m_type_isSet;
}

bool OAIData3::is_type_Valid() const{
