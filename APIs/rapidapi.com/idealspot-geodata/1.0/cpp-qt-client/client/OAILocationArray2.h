...
#ifndef OAILocationArray2_H
#define OAILocationArray2_H
...
class OAILocationArray2 : public OAIObject {
public:
    OAILocationArray2();
    OAILocationArray2(QString json);
    ~OAILocationArray2() override;
    ...
    void setRegiontype(const QString &regiontype);
    bool is_regiontype_Set() const;
    bool is_regiontype_Valid() const;
...
private:
    ...
    QString m_regiontype;
    bool m_regiontype_isSet;
    bool m_regiontype_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationArray2)

#endif // OAILocationArray2_H
