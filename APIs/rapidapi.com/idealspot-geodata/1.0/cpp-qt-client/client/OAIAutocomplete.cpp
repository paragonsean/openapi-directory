...
OAIAutocomplete::OAIAutocomplete(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAutocomplete::OAIAutocomplete() {
    this->initializeModel();
}

OAIAutocomplete::~OAIAutocomplete() {}

void OAIAutocomplete::initializeModel() {

    m_input_isSet = false;
    m_input_isValid = false;
}

void OAIAutocomplete::fromJson(QString jsonString) {
...
void OAIAutocomplete::fromJsonObject(QJsonObject json) {

    m_input_isValid = ::OpenAPI::fromJsonValue(m_input, json[QString("input")]);
    m_input_isSet = !json[QString("input")].isNull() && m_input_isValid;
}

QString OAIAutocomplete::asJson() const {
...
QJsonObject OAIAutocomplete::asJsonObject() const {
    QJsonObject obj;
    if (m_input.size() > 0) {
...
QList<QString> OAIAutocomplete::getInput() const {
    return m_input;
}
void OAIAutocomplete::setInput(const QList<QString> &input) {
    m_input = input;
    m_input_isSet = true;
}

bool OAIAutocomplete::is_input_Set() const{
    return m_input_isSet;
}

bool OAIAutocomplete::is_input_Valid() const{
    return m_input_isValid;
}

bool OAIAutocomplete::isSet() const {
...
bool OAIAutocomplete::isValid() const {
