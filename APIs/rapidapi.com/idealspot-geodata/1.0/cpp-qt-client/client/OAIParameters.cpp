...
QList<OAICategory> OAIParameters::getCategory() const {
    return m_category;
}
void OAIParameters::setCategory(const QList<OAICategory> &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIParameters::is_category_Set() const{
    return m_category_isSet;
}

bool OAIParameters::is_category_Valid() const{
