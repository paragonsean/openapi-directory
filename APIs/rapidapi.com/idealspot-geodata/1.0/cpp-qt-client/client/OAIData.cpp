...
QString OAIData::getDescription() const {
    return m_description;
}
void OAIData::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIData::is_description_Set() const{
    return m_description_isSet;
}

bool OAIData::is_description_Valid() const{
    return m_description_isValid;
}

QList<QString> OAIData::getGroups() const {
    return m_groups;
}
void OAIData::setGroups(const QList<QString> &groups) {
    m_groups = groups;
    m_groups_isSet = true;
}

bool OAIData::is_groups_Set() const{
    return m_groups_isSet;
}

bool OAIData::is_groups_Valid() const{
...
OAIParameters OAIData::getParameters() const {
    return m_parameters;
}
void OAIData::setParameters(const OAIParameters &parameters) {
    m_parameters = parameters;
    m_parameters_isSet = true;
}

bool OAIData::is_parameters_Set() const{
    return m_parameters_isSet;
}

bool OAIData::is_parameters_Valid() const{
    return m_parameters_isValid;
}

QList<QString> OAIData::getPeriods() const {
    return m_periods;
}
void OAIData::setPeriods(const QList<QString> &periods) {
    m_periods = periods;
    m_periods_isSet = true;
}

bool OAIData::is_periods_Set() const{
    return m_periods_isSet;
}

bool OAIData::is_periods_Valid() const{
    return m_periods_isValid;
}

QString OAIData::getSlug() const {
    return m_slug;
}
void OAIData::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIData::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIData::is_slug_Valid() const{
    return m_slug_isValid;
}

QString OAIData::getVersion() const {
    return m_version;
}
void OAIData::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIData::is_version_Set() const{
    return m_version_isSet;
}

bool OAIData::is_version_Valid() const{
...
bool OAIData::isValid() const {
    ...
    return m_description_isValid && m_groups_isValid && m_id_isValid && m_name_isValid && m_parameters_isValid && m_periods_isValid && m_slug_isValid && m_version_isValid && true;
}
