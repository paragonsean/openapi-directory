...
/*
 * OAIFetchAdministrativeRegionsusingLat_Lng.h
 *
 * 
 */

#ifndef OAIFetchAdministrativeRegionsusingLat_Lng_H
#define OAIFetchAdministrativeRegionsusingLat_Lng_H
...
class OAIFetchAdministrativeRegionsusingLat_Lng : public OAIObject {
public:
    OAIFetchAdministrativeRegionsusingLat_Lng();
    OAIFetchAdministrativeRegionsusingLat_Lng(QString json);
    ~OAIFetchAdministrativeRegionsusingLat_Lng() override;
    ...
    QList<OAIData2> getData() const;
    void setData(const QList<OAIData2> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFetchAdministrativeRegionsusingLat_Lng)

#endif // OAIFetchAdministrativeRegionsusingLat_Lng_H
