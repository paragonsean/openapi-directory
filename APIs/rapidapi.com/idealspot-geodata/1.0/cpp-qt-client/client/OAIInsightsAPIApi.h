...
#include "OAIHomevalueswithin1mi_radiusofLocation.h"
#include "OAIListAllLocalInsights.h"
#include <QString>
...
public:
    ...
    */
    virtual void fetchAvailableInsights(const QString &x_rapid_api_key, const QString &x_rapid_api_host);
    ...
    * @param[in]  x_rapid_api_host QString [required]
    */
    virtual void fetchInsightQueryParameters(const QString &insight_id, const QString &x_rapid_api_key, const QString &x_rapid_api_host);
    ...
    * @param[in]  x_rapid_api_host QString [required]
    */
    virtual void queryInsightatLocation(const QString &version, const QString &location, const QString &insight_id, const QString &x_rapid_api_key, const QString &x_rapid_api_host);
...
private:
    ...
    void fetchAvailableInsightsCallback(OAIHttpRequestWorker *worker);
    void fetchInsightQueryParametersCallback(OAIHttpRequestWorker *worker);
    void queryInsightatLocationCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAvailableInsightsSignal(OAIListAllLocalInsights summary);
    void fetchInsightQueryParametersSignal(OAIDescribe_occupation_Insight summary);
    void queryInsightatLocationSignal(OAIHomevalueswithin1mi_radiusofLocation summary);


    void fetchAvailableInsightsSignalFull(OAIHttpRequestWorker *worker, OAIListAllLocalInsights summary);
    void fetchInsightQueryParametersSignalFull(OAIHttpRequestWorker *worker, OAIDescribe_occupation_Insight summary);
    void queryInsightatLocationSignalFull(OAIHttpRequestWorker *worker, OAIHomevalueswithin1mi_radiusofLocation summary);

    Q_DECL_DEPRECATED_X("Use fetchAvailableInsightsSignalError() instead")
    void fetchAvailableInsightsSignalE(OAIListAllLocalInsights summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAvailableInsightsSignalError(OAIListAllLocalInsights summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchInsightQueryParametersSignalError() instead")
    void fetchInsightQueryParametersSignalE(OAIDescribe_occupation_Insight summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchInsightQueryParametersSignalError(OAIDescribe_occupation_Insight summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use queryInsightatLocationSignalError() instead")
    void queryInsightatLocationSignalE(OAIHomevalueswithin1mi_radiusofLocation summary, QNetworkReply::NetworkError error_type, QString error_str);
    void queryInsightatLocationSignalError(OAIHomevalueswithin1mi_radiusofLocation summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAvailableInsightsSignalErrorFull() instead")
    void fetchAvailableInsightsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAvailableInsightsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchInsightQueryParametersSignalErrorFull() instead")
    void fetchInsightQueryParametersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchInsightQueryParametersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use queryInsightatLocationSignalErrorFull() instead")
    void queryInsightatLocationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void queryInsightatLocationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
