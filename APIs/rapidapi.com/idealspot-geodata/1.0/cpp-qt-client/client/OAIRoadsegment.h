...
#ifndef OAIRoadsegment_H
#define OAIRoadsegment_H
...
class OAIRoadsegment : public OAIObject {
public:
    OAIRoadsegment();
    OAIRoadsegment(QString json);
    ~OAIRoadsegment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoadsegment)

#endif // OAIRoadsegment_H
