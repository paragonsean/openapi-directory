...
namespace OpenAPI {
class OAIMetadata1;
class OAIRoadsegment;
class OAIStats;

class OAIData5 : public OAIObject {
public:
    OAIData5();
    OAIData5(QString json);
    ~OAIData5() override;
    ...
    OAIMetadata1 getMetadata() const;
    void setMetadata(const OAIMetadata1 &metadata);
    bool is_metadata_Set() const;
    bool is_metadata_Valid() const;

    OAIRoadsegment getRoadsegment() const;
    void setRoadsegment(const OAIRoadsegment &roadsegment);
    bool is_roadsegment_Set() const;
    bool is_roadsegment_Valid() const;
...
private:
    ...
    OAIMetadata1 m_metadata;
    bool m_metadata_isSet;
    bool m_metadata_isValid;

    OAIRoadsegment m_roadsegment;
    bool m_roadsegment_isSet;
    bool m_roadsegment_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIData5)
