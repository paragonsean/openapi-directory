...
#ifndef OAILocationArray_H
#define OAILocationArray_H
...
class OAILocationArray : public OAIObject {
public:
    OAILocationArray();
    OAILocationArray(QString json);
    ~OAILocationArray() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocationArray)

#endif // OAILocationArray_H
