...
OAIVehicleTrafficCountsforRoadSegment::OAIVehicleTrafficCountsforRoadSegment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVehicleTrafficCountsforRoadSegment::OAIVehicleTrafficCountsforRoadSegment() {
    this->initializeModel();
}

OAIVehicleTrafficCountsforRoadSegment::~OAIVehicleTrafficCountsforRoadSegment() {}

void OAIVehicleTrafficCountsforRoadSegment::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIVehicleTrafficCountsforRoadSegment::fromJson(QString jsonString) {
...
void OAIVehicleTrafficCountsforRoadSegment::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIVehicleTrafficCountsforRoadSegment::asJson() const {
...
QJsonObject OAIVehicleTrafficCountsforRoadSegment::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIData5> OAIVehicleTrafficCountsforRoadSegment::getData() const {
    return m_data;
}
void OAIVehicleTrafficCountsforRoadSegment::setData(const QList<OAIData5> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIVehicleTrafficCountsforRoadSegment::is_data_Set() const{
    return m_data_isSet;
}

bool OAIVehicleTrafficCountsforRoadSegment::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIVehicleTrafficCountsforRoadSegment::isSet() const {
...
bool OAIVehicleTrafficCountsforRoadSegment::isValid() const {
