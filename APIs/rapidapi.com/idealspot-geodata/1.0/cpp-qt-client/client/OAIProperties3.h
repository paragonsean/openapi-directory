...
#ifndef OAIProperties3_H
#define OAIProperties3_H
...
class OAIProperties3 : public OAIObject {
public:
    OAIProperties3();
    OAIProperties3(QString json);
    ~OAIProperties3() override;
    ...
    bool is_roadname_Set() const;
    bool is_roadname_Valid() const;
...
private:
    ...
    QString m_roadname;
    bool m_roadname_isSet;
    bool m_roadname_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProperties3)

#endif // OAIProperties3_H
