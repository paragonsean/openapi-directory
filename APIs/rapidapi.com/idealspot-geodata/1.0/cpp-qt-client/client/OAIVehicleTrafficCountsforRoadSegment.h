...
/*
 * OAIVehicleTrafficCountsforRoadSegment.h
 *
 * 
 */

#ifndef OAIVehicleTrafficCountsforRoadSegment_H
#define OAIVehicleTrafficCountsforRoadSegment_H
...
class OAIVehicleTrafficCountsforRoadSegment : public OAIObject {
public:
    OAIVehicleTrafficCountsforRoadSegment();
    OAIVehicleTrafficCountsforRoadSegment(QString json);
    ~OAIVehicleTrafficCountsforRoadSegment() override;
    ...
    QList<OAIData5> getData() const;
    void setData(const QList<OAIData5> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVehicleTrafficCountsforRoadSegment)

#endif // OAIVehicleTrafficCountsforRoadSegment_H
