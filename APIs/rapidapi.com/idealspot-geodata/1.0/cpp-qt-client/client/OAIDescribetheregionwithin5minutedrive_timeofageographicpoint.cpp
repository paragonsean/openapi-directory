...
OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::OAIDescribetheregionwithin5minutedrive_timeofageographicpoint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::OAIDescribetheregionwithin5minutedrive_timeofageographicpoint() {
    this->initializeModel();
}

OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::~OAIDescribetheregionwithin5minutedrive_timeofageographicpoint() {}

void OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::fromJson(QString jsonString) {
...
void OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::asJson() const {
...
QJsonObject OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::asJsonObject() const {
    QJsonObject obj;
    if (m_data.isSet()) {
...
OAIData3 OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::getData() const {
    return m_data;
}
void OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::setData(const OAIData3 &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::is_data_Set() const{
    return m_data_isSet;
}

bool OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::isSet() const {
...
bool OAIDescribetheregionwithin5minutedrive_timeofageographicpoint::isValid() const {
