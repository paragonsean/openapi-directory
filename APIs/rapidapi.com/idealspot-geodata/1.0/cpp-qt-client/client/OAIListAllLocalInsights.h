...
/*
 * OAIListAllLocalInsights.h
 *
 * 
 */

#ifndef OAIListAllLocalInsights_H
#define OAIListAllLocalInsights_H
...
class OAIListAllLocalInsights : public OAIObject {
public:
    OAIListAllLocalInsights();
    OAIListAllLocalInsights(QString json);
    ~OAIListAllLocalInsights() override;
    ...
    QList<OAIDatum> getData() const;
    void setData(const QList<OAIDatum> &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIListAllLocalInsights)

#endif // OAIListAllLocalInsights_H
