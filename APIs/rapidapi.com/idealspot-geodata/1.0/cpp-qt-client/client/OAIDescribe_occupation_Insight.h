...
/*
 * OAIDescribe_occupation_Insight.h
 *
 * 
 */

#ifndef OAIDescribe_occupation_Insight_H
#define OAIDescribe_occupation_Insight_H
...
class OAIDescribe_occupation_Insight : public OAIObject {
public:
    OAIDescribe_occupation_Insight();
    OAIDescribe_occupation_Insight(QString json);
    ~OAIDescribe_occupation_Insight() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribe_occupation_Insight)

#endif // OAIDescribe_occupation_Insight_H
