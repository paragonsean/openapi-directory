...
QString OAILocation3::getAreatype() const {
    return m_areatype;
}
void OAILocation3::setAreatype(const QString &areatype) {
    m_areatype = areatype;
    m_areatype_isSet = true;
}

bool OAILocation3::is_areatype_Set() const{
    return m_areatype_isSet;
}

bool OAILocation3::is_areatype_Valid() const{
    return m_areatype_isValid;
}

double OAILocation3::getLatitude() const {
    return m_latitude;
}
void OAILocation3::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAILocation3::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAILocation3::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAILocation3::getLongitude() const {
    return m_longitude;
}
void OAILocation3::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAILocation3::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAILocation3::is_longitude_Valid() const{
    return m_longitude_isValid;
}

QString OAILocation3::getRadius() const {
    return m_radius;
}
void OAILocation3::setRadius(const QString &radius) {
    m_radius = radius;
    m_radius_isSet = true;
}

bool OAILocation3::is_radius_Set() const{
    return m_radius_isSet;
}

bool OAILocation3::is_radius_Valid() const{
    return m_radius_isValid;
}

QString OAILocation3::getType() const {
    return m_type;
}
void OAILocation3::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILocation3::is_type_Set() const{
    return m_type_isSet;
}

bool OAILocation3::is_type_Valid() const{
    return m_type_isValid;
}

QString OAILocation3::getUnits() const {
    return m_units;
}
void OAILocation3::setUnits(const QString &units) {
    m_units = units;
    m_units_isSet = true;
}

bool OAILocation3::is_units_Set() const{
    return m_units_isSet;
}

bool OAILocation3::is_units_Valid() const{
