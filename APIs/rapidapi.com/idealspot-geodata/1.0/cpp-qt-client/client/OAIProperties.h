...
namespace OpenAPI {
class OAIProperties1;
class OAIAutocomplete;
...
public:
    ...
    OAIProperties1 getProperties() const;
    void setProperties(const OAIProperties1 &_properties);
    bool is__properties_Set() const;
    bool is__properties_Valid() const;

    QString getAltname() const;
    void setAltname(const QString &altname);
    bool is_altname_Set() const;
    bool is_altname_Valid() const;

    OAIAutocomplete getAutocomplete() const;
    void setAutocomplete(const OAIAutocomplete &autocomplete);
...
private:
    ...
    OAIProperties1 m__properties;
    bool m__properties_isSet;
    bool m__properties_isValid;

    QString m_altname;
    bool m_altname_isSet;
    bool m_altname_isValid;

    OAIAutocomplete m_autocomplete;
