...
OAIGeometry OAIData2::getGeometry() const {
    return m_geometry;
}
void OAIData2::setGeometry(const OAIGeometry &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAIData2::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAIData2::is_geometry_Valid() const{
    return m_geometry_isValid;
}

OAIProperties OAIData2::getProperties() const {
    return m_properties;
}
void OAIData2::setProperties(const OAIProperties &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIData2::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIData2::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIData2::getType() const {
    return m_type;
}
void OAIData2::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIData2::is_type_Set() const{
    return m_type_isSet;
}

bool OAIData2::is_type_Valid() const{
