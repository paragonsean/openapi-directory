...
#ifndef OAI_OAIGeometriesAPIApi_H
#define OAI_OAIGeometriesAPIApi_H
...
#include "OAIDescribetheregionwithin5minutedrive_timeofageographicpoint.h"
#include "OAIFetchAdministrativeRegionsusingLat_Lng.h"
#include <QString>
...
class OAIGeometriesAPIApi : public QObject {
    Q_OBJECT

public:
    OAIGeometriesAPIApi(const int timeOut = 0);
    ~OAIGeometriesAPIApi();
    ...
    */
    virtual void fetchAdministrativeRegionsusingLat_Lng(const double &latitude, const double &longitude, const QString &x_rapid_api_key, const QString &x_rapid_api_host);
    ...
    * @param[in]  x_rapid_api_host QString [required]
    */
    virtual void fetchGeometries(const QString &location, const QString &x_rapid_api_key, const QString &x_rapid_api_host);
...
private:
    ...
    void fetchAdministrativeRegionsusingLat_LngCallback(OAIHttpRequestWorker *worker);
    void fetchGeometriesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void fetchAdministrativeRegionsusingLat_LngSignal(OAIFetchAdministrativeRegionsusingLat_Lng summary);
    void fetchGeometriesSignal(OAIDescribetheregionwithin5minutedrive_timeofageographicpoint summary);


    void fetchAdministrativeRegionsusingLat_LngSignalFull(OAIHttpRequestWorker *worker, OAIFetchAdministrativeRegionsusingLat_Lng summary);
    void fetchGeometriesSignalFull(OAIHttpRequestWorker *worker, OAIDescribetheregionwithin5minutedrive_timeofageographicpoint summary);

    Q_DECL_DEPRECATED_X("Use fetchAdministrativeRegionsusingLat_LngSignalError() instead")
    void fetchAdministrativeRegionsusingLat_LngSignalE(OAIFetchAdministrativeRegionsusingLat_Lng summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAdministrativeRegionsusingLat_LngSignalError(OAIFetchAdministrativeRegionsusingLat_Lng summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchGeometriesSignalError() instead")
    void fetchGeometriesSignalE(OAIDescribetheregionwithin5minutedrive_timeofageographicpoint summary, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchGeometriesSignalError(OAIDescribetheregionwithin5minutedrive_timeofageographicpoint summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use fetchAdministrativeRegionsusingLat_LngSignalErrorFull() instead")
    void fetchAdministrativeRegionsusingLat_LngSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchAdministrativeRegionsusingLat_LngSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use fetchGeometriesSignalErrorFull() instead")
    void fetchGeometriesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void fetchGeometriesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
