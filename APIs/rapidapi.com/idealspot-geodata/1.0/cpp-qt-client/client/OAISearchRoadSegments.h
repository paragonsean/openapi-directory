...
/*
 * OAISearchRoadSegments.h
 *
 * 
 */

#ifndef OAISearchRoadSegments_H
#define OAISearchRoadSegments_H
...
class OAISearchRoadSegments : public OAIObject {
public:
    OAISearchRoadSegments();
    OAISearchRoadSegments(QString json);
    ~OAISearchRoadSegments() override;
    ...
    OAIData4 getData() const;
    void setData(const OAIData4 &data);
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchRoadSegments)

#endif // OAISearchRoadSegments_H
