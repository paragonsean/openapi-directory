...
OAIProperties4::OAIProperties4(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProperties4::OAIProperties4() {
    this->initializeModel();
}

OAIProperties4::~OAIProperties4() {}

void OAIProperties4::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIProperties4::fromJson(QString jsonString) {
...
void OAIProperties4::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("name")]);
    m_name_isSet = !json[QString("name")].isNull() && m_name_isValid;
}

QString OAIProperties4::asJson() const {
...
QJsonObject OAIProperties4::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIProperties4::getName() const {
    return m_name;
}
void OAIProperties4::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProperties4::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProperties4::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIProperties4::isSet() const {
...
bool OAIProperties4::isValid() const {
