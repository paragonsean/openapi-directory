...
void OAIStats::fromJsonObject(QJsonObject json) {
    ...
    m_aadt_isValid = ::OpenAPI::fromJsonValue(m_aadt, json[QString("aadt")]);
    m_aadt_isSet = !json[QString("aadt")].isNull() && m_aadt_isValid;
}
...
QJsonObject OAIStats::asJsonObject() const {
    QJsonObject obj;
    if (m_aadt_isSet) {
        obj.insert(QString("aadt"), ::OpenAPI::toJsonValue(m_aadt));
    }
    return obj;
}

qint32 OAIStats::getAadt() const {
    return m_aadt;
}
void OAIStats::setAadt(const qint32 &aadt) {
    m_aadt = aadt;
    m_aadt_isSet = true;
}

bool OAIStats::is_aadt_Set() const{
    return m_aadt_isSet;
}

bool OAIStats::is_aadt_Valid() const{
    return m_aadt_isValid;
}
