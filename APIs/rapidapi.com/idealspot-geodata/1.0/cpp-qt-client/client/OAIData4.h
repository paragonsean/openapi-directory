...
class OAIData4 : public OAIObject {
public:
    OAIData4();
    OAIData4(QString json);
    ~OAIData4() override;
    ...
    QList<OAIFeature1> getFeatures() const;
    void setFeatures(const QList<OAIFeature1> &features);
...
Q_DECLARE_METATYPE(OpenAPI::OAIData4)
