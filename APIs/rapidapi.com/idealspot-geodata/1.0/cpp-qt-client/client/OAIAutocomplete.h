...
#ifndef OAIAutocomplete_H
#define OAIAutocomplete_H
...
class OAIAutocomplete : public OAIObject {
public:
    OAIAutocomplete();
    OAIAutocomplete(QString json);
    ~OAIAutocomplete() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutocomplete)

#endif // OAIAutocomplete_H
