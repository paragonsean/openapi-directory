...
OAIHomevalueswithin1mi_radiusofLocation::OAIHomevalueswithin1mi_radiusofLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHomevalueswithin1mi_radiusofLocation::OAIHomevalueswithin1mi_radiusofLocation() {
    this->initializeModel();
}

OAIHomevalueswithin1mi_radiusofLocation::~OAIHomevalueswithin1mi_radiusofLocation() {}

void OAIHomevalueswithin1mi_radiusofLocation::initializeModel() {

    m_data_isSet = false;
    m_data_isValid = false;
}

void OAIHomevalueswithin1mi_radiusofLocation::fromJson(QString jsonString) {
...
void OAIHomevalueswithin1mi_radiusofLocation::fromJsonObject(QJsonObject json) {

    m_data_isValid = ::OpenAPI::fromJsonValue(m_data, json[QString("data")]);
    m_data_isSet = !json[QString("data")].isNull() && m_data_isValid;
}

QString OAIHomevalueswithin1mi_radiusofLocation::asJson() const {
...
QJsonObject OAIHomevalueswithin1mi_radiusofLocation::asJsonObject() const {
    QJsonObject obj;
    if (m_data.size() > 0) {
...
QList<OAIData1> OAIHomevalueswithin1mi_radiusofLocation::getData() const {
    return m_data;
}
void OAIHomevalueswithin1mi_radiusofLocation::setData(const QList<OAIData1> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIHomevalueswithin1mi_radiusofLocation::is_data_Set() const{
    return m_data_isSet;
}

bool OAIHomevalueswithin1mi_radiusofLocation::is_data_Valid() const{
    return m_data_isValid;
}

bool OAIHomevalueswithin1mi_radiusofLocation::isSet() const {
...
bool OAIHomevalueswithin1mi_radiusofLocation::isValid() const {
