...
class Data2 {
    ...
    constructor(geometry, properties, type) { 
        ...
        Data2.initialize(this, geometry, properties, type);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Data2.RequiredProperties) {
...
Data2.RequiredProperties = ["geometry", "properties", "type"];

/**
 * @member {module:model/Geometry} geometry
 */
Data2.prototype['geometry'] = undefined;

/**
 * @member {module:model/Properties} properties
 */
Data2.prototype['properties'] = undefined;

/**
 * @member {String} type
 */
Data2.prototype['type'] = undefined;
