...
/**
 * The LocationArray2 model module.
 * @module model/LocationArray2
 * @version 1.0
 */
class LocationArray2 {
    /**
     * Constructs a new <code>LocationArray2</code>.
     * @alias module:model/LocationArray2
     * @param regionId {String} 
     * @param regiontype {String} 
     * @param type {String} 
     */
    constructor(regionId, regiontype, type) { 
        
        LocationArray2.initialize(this, regionId, regiontype, type);
    }
     ...
     */
    static initialize(obj, regionId, regiontype, type) { 
    ...
    /**
     * Constructs a <code>LocationArray2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocationArray2} obj Optional instance to populate.
     * @return {module:model/LocationArray2} The populated <code>LocationArray2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocationArray2();
    ...
    /**
     * Validates the JSON data with respect to <code>LocationArray2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocationArray2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LocationArray2.RequiredProperties) {
...
LocationArray2.RequiredProperties = ["region_id", "regiontype", "type"];

/**
 * @member {String} region_id
 */
LocationArray2.prototype['region_id'] = undefined;

/**
 * @member {String} regiontype
 */
LocationArray2.prototype['regiontype'] = undefined;

/**
 * @member {String} type
 */
LocationArray2.prototype['type'] = undefined;
