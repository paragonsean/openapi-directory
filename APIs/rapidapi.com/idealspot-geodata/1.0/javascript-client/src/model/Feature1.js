...
/**
 * The Feature1 model module.
 * @module model/Feature1
 * @version 1.0
 */
class Feature1 {
    /**
     * Constructs a new <code>Feature1</code>.
     * @alias module:model/Feature1
     * @param geometry {module:model/Geometry} 
     * @param properties {module:model/Properties3} 
     * @param type {String} 
     */
    constructor(geometry, properties, type) { 
        
        Feature1.initialize(this, geometry, properties, type);
    }
    ...
    /**
     * Constructs a <code>Feature1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Feature1} obj Optional instance to populate.
     * @return {module:model/Feature1} The populated <code>Feature1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Feature1();

            if (data.hasOwnProperty('geometry')) {
                obj['geometry'] = Geometry.constructFromObject(data['geometry']);
            }
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = Properties3.constructFromObject(data['properties']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Feature1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Feature1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Feature1.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          Properties3.validateJSON(data['properties']);
        }
...
Feature1.RequiredProperties = ["geometry", "properties", "type"];

/**
 * @member {module:model/Geometry} geometry
 */
Feature1.prototype['geometry'] = undefined;

/**
 * @member {module:model/Properties3} properties
 */
Feature1.prototype['properties'] = undefined;

/**
 * @member {String} type
 */
Feature1.prototype['type'] = undefined;
