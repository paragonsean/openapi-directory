...
/**
 * The DescribeOccupationInsight model module.
 * @module model/DescribeOccupationInsight
 * @version 1.0
 */
class DescribeOccupationInsight {
    /**
     * Constructs a new <code>DescribeOccupationInsight</code>.
     * @alias module:model/DescribeOccupationInsight
     * @param data {module:model/Data} 
     */
    constructor(data) { 
        
        DescribeOccupationInsight.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>DescribeOccupationInsight</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeOccupationInsight} obj Optional instance to populate.
     * @return {module:model/DescribeOccupationInsight} The populated <code>DescribeOccupationInsight</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeOccupationInsight();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeOccupationInsight</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeOccupationInsight</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeOccupationInsight.RequiredProperties) {
...
DescribeOccupationInsight.RequiredProperties = ["data"];

/**
 * @member {module:model/Data} data
 */
DescribeOccupationInsight.prototype['data'] = undefined;
...
export default DescribeOccupationInsight;
