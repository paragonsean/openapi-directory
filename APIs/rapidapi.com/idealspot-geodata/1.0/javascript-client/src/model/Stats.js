...
class Stats {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('aadt')) {
                obj['aadt'] = ApiClient.convertToType(data['aadt'], 'Number');
            }
        }
        return obj;
    }
...
Stats.RequiredProperties = ["aadt"];

/**
 * @member {Number} aadt
 */
Stats.prototype['aadt'] = undefined;
