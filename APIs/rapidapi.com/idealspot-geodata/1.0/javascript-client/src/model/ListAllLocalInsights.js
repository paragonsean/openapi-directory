...
/**
 * The ListAllLocalInsights model module.
 * @module model/ListAllLocalInsights
 * @version 1.0
 */
class ListAllLocalInsights {
    /**
     * Constructs a new <code>ListAllLocalInsights</code>.
     * @alias module:model/ListAllLocalInsights
     * @param data {Array.<module:model/Datum>} 
     */
    constructor(data) { 
        
        ListAllLocalInsights.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>ListAllLocalInsights</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllLocalInsights} obj Optional instance to populate.
     * @return {module:model/ListAllLocalInsights} The populated <code>ListAllLocalInsights</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListAllLocalInsights();
    ...
    /**
     * Validates the JSON data with respect to <code>ListAllLocalInsights</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListAllLocalInsights</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListAllLocalInsights.RequiredProperties) {
...
ListAllLocalInsights.RequiredProperties = ["data"];

/**
 * @member {Array.<module:model/Datum>} data
 */
ListAllLocalInsights.prototype['data'] = undefined;
...
export default ListAllLocalInsights;
