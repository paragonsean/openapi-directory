...
/**
 * The Properties4 model module.
 * @module model/Properties4
 * @version 1.0
 */
class Properties4 {
    /**
     * Constructs a new <code>Properties4</code>.
     * @alias module:model/Properties4
     * @param name {String} 
     */
    constructor(name) { 
        
        Properties4.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>Properties4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Properties4} obj Optional instance to populate.
     * @return {module:model/Properties4} The populated <code>Properties4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Properties4();
    ...
    /**
     * Validates the JSON data with respect to <code>Properties4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Properties4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Properties4.RequiredProperties) {
...
Properties4.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
Properties4.prototype['name'] = undefined;
