...
/**
 * The Homevalueswithin1miRadiusofLocation model module.
 * @module model/Homevalueswithin1miRadiusofLocation
 * @version 1.0
 */
class Homevalueswithin1miRadiusofLocation {
    /**
     * Constructs a new <code>Homevalueswithin1miRadiusofLocation</code>.
     * @alias module:model/Homevalueswithin1miRadiusofLocation
     * @param data {Array.<module:model/Data1>} 
     */
    constructor(data) { 
        
        Homevalueswithin1miRadiusofLocation.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>Homevalueswithin1miRadiusofLocation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Homevalueswithin1miRadiusofLocation} obj Optional instance to populate.
     * @return {module:model/Homevalueswithin1miRadiusofLocation} The populated <code>Homevalueswithin1miRadiusofLocation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Homevalueswithin1miRadiusofLocation();
    ...
    /**
     * Validates the JSON data with respect to <code>Homevalueswithin1miRadiusofLocation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Homevalueswithin1miRadiusofLocation</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Homevalueswithin1miRadiusofLocation.RequiredProperties) {
...
Homevalueswithin1miRadiusofLocation.RequiredProperties = ["data"];

/**
 * @member {Array.<module:model/Data1>} data
 */
Homevalueswithin1miRadiusofLocation.prototype['data'] = undefined;
...
export default Homevalueswithin1miRadiusofLocation;
