...
class Metadata {
     ...
     * @param datetime {Array.<Array.<String>>} 
     * @param displayGroups {Array.<Array.<String>>} 
     * @param units {module:model/Units} 
     */
    constructor(datetime, displayGroups, units) { 
        
        Metadata.initialize(this, datetime, displayGroups, units);
    }
     ...
     */
    static initialize(obj, datetime, displayGroups, units) { 
        obj['datetime'] = datetime;
        obj['display_groups'] = displayGroups;
        obj['units'] = units;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('display_groups')) {
                obj['display_groups'] = ApiClient.convertToType(data['display_groups'], [['String']]);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['display_groups'])) {
            throw new Error("Expected the field `display_groups` to be an array in the JSON data but got " + data['display_groups']);
        }
        // validate the optional field `units`
        if (data['units']) { // data not null
          Units.validateJSON(data['units']);
        }
...
Metadata.RequiredProperties = ["datetime", "display_groups", "units"];

/**
 * @member {Array.<Array.<String>>} datetime
 */
Metadata.prototype['datetime'] = undefined;

/**
 * @member {Array.<Array.<String>>} display_groups
 */
Metadata.prototype['display_groups'] = undefined;

/**
 * @member {module:model/Units} units
 */
Metadata.prototype['units'] = undefined;
