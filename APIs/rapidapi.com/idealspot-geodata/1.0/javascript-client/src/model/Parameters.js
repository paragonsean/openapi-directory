...
class Parameters {
     ...
     * @param category {Array.<module:model/Category>} 
     */
    constructor(category) { 
        
        Parameters.initialize(this, category);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Parameters.RequiredProperties) {
...
Parameters.RequiredProperties = ["category"];

/**
 * @member {Array.<module:model/Category>} category
 */
Parameters.prototype['category'] = undefined;
