...
class Category {
     ...
     */
    constructor(description, id, label, parentId) { 
        
        Category.initialize(this, description, id, label, parentId);
    }
     ...
     */
    static initialize(obj, description, id, label, parentId) { 
...
Category.RequiredProperties = ["description", "id", "label", "parent_id"];
