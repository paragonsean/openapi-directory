...
class Data1 {
     ...
     */
    constructor(data, location, locationIndex, metadata) { 
        
        Data1.initialize(this, data, location, locationIndex, metadata);
    }
     ...
     */
    static initialize(obj, data, location, locationIndex, metadata) { 
        obj['data'] = data;
        obj['location'] = location;
        obj['location_index'] = locationIndex;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('location_index')) {
                obj['location_index'] = ApiClient.convertToType(data['location_index'], 'Number');
            }
...
Data1.RequiredProperties = ["data", "location", "location_index", "metadata"];

/**
 * @member {Array.<Array.<String>>} data
 */
Data1.prototype['data'] = undefined;

/**
 * @member {module:model/Location1} location
 */
Data1.prototype['location'] = undefined;

/**
 * @member {Number} location_index
 */
Data1.prototype['location_index'] = undefined;

/**
 * @member {module:model/Metadata} metadata
 */
Data1.prototype['metadata'] = undefined;
