...
class Crs {
     ...
     * @param properties {module:model/Properties4} 
     * @param type {String} 
     */
    constructor(properties, type) { 
        
        Crs.initialize(this, properties, type);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = Properties4.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of Crs.RequiredProperties) {
        ...
        if (data['properties']) { // data not null
          Properties4.validateJSON(data['properties']);
        }
...
Crs.RequiredProperties = ["properties", "type"];

/**
 * @member {module:model/Properties4} properties
 */
