...
class Feature {
     ...
     * @param properties {module:model/Properties2} 
     * @param type {String} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('properties')) {
                obj['properties'] = Properties2.constructFromObject(data['properties']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['properties']) { // data not null
          Properties2.validateJSON(data['properties']);
        }
...
/**
 * @member {module:model/Properties2} properties
 */
