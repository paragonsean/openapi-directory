...
/**
 * The FetchAdministrativeRegionsusingLatLng model module.
 * @module model/FetchAdministrativeRegionsusingLatLng
 * @version 1.0
 */
class FetchAdministrativeRegionsusingLatLng {
    /**
     * Constructs a new <code>FetchAdministrativeRegionsusingLatLng</code>.
     * @alias module:model/FetchAdministrativeRegionsusingLatLng
     * @param data {Array.<module:model/Data2>} 
     */
    constructor(data) { 
        
        FetchAdministrativeRegionsusingLatLng.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>FetchAdministrativeRegionsusingLatLng</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FetchAdministrativeRegionsusingLatLng} obj Optional instance to populate.
     * @return {module:model/FetchAdministrativeRegionsusingLatLng} The populated <code>FetchAdministrativeRegionsusingLatLng</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FetchAdministrativeRegionsusingLatLng();
    ...
    /**
     * Validates the JSON data with respect to <code>FetchAdministrativeRegionsusingLatLng</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FetchAdministrativeRegionsusingLatLng</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FetchAdministrativeRegionsusingLatLng.RequiredProperties) {
...
FetchAdministrativeRegionsusingLatLng.RequiredProperties = ["data"];

/**
 * @member {Array.<module:model/Data2>} data
 */
FetchAdministrativeRegionsusingLatLng.prototype['data'] = undefined;
...
export default FetchAdministrativeRegionsusingLatLng;
