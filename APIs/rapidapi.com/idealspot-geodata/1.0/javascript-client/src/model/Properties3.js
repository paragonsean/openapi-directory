...
/**
 * The Properties3 model module.
 * @module model/Properties3
 * @version 1.0
 */
class Properties3 {
    /**
     * Constructs a new <code>Properties3</code>.
     * @alias module:model/Properties3
     * @param bearing {String} 
     * @param roadname {String} 
     * @param segmentId {String} 
     * @param state {String} 
     */
    constructor(bearing, roadname, segmentId, state) { 
        
        Properties3.initialize(this, bearing, roadname, segmentId, state);
    }
     ...
     */
    static initialize(obj, bearing, roadname, segmentId, state) { 
        obj['bearing'] = bearing;
    ...
    /**
     * Constructs a <code>Properties3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Properties3} obj Optional instance to populate.
     * @return {module:model/Properties3} The populated <code>Properties3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Properties3();

            if (data.hasOwnProperty('bearing')) {
                obj['bearing'] = ApiClient.convertToType(data['bearing'], 'String');
            }
            if (data.hasOwnProperty('roadname')) {
                obj['roadname'] = ApiClient.convertToType(data['roadname'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Properties3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Properties3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Properties3.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['roadname'] && !(typeof data['roadname'] === 'string' || data['roadname'] instanceof String)) {
            throw new Error("Expected the field `roadname` to be a primitive type in the JSON string but got " + data['roadname']);
        }
        // ensure the json data is a string
...
Properties3.RequiredProperties = ["bearing", "roadname", "segment_id", "state"];

/**
 * @member {String} bearing
 */
Properties3.prototype['bearing'] = undefined;

/**
 * @member {String} roadname
 */
Properties3.prototype['roadname'] = undefined;

/**
 * @member {String} segment_id
 */
Properties3.prototype['segment_id'] = undefined;

/**
 * @member {String} state
 */
Properties3.prototype['state'] = undefined;
