...
/**
 * The Describetheregionwithin5minutedriveTimeofageographicpoint model module.
 * @module model/Describetheregionwithin5minutedriveTimeofageographicpoint
 * @version 1.0
 */
class Describetheregionwithin5minutedriveTimeofageographicpoint {
    /**
     * Constructs a new <code>Describetheregionwithin5minutedriveTimeofageographicpoint</code>.
     * @alias module:model/Describetheregionwithin5minutedriveTimeofageographicpoint
     * @param data {module:model/Data3} 
     */
    constructor(data) { 
        
        Describetheregionwithin5minutedriveTimeofageographicpoint.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>Describetheregionwithin5minutedriveTimeofageographicpoint</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Describetheregionwithin5minutedriveTimeofageographicpoint} obj Optional instance to populate.
     * @return {module:model/Describetheregionwithin5minutedriveTimeofageographicpoint} The populated <code>Describetheregionwithin5minutedriveTimeofageographicpoint</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Describetheregionwithin5minutedriveTimeofageographicpoint();
    ...
    /**
     * Validates the JSON data with respect to <code>Describetheregionwithin5minutedriveTimeofageographicpoint</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Describetheregionwithin5minutedriveTimeofageographicpoint</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Describetheregionwithin5minutedriveTimeofageographicpoint.RequiredProperties) {
...
Describetheregionwithin5minutedriveTimeofageographicpoint.RequiredProperties = ["data"];

/**
 * @member {module:model/Data3} data
 */
Describetheregionwithin5minutedriveTimeofageographicpoint.prototype['data'] = undefined;
...
export default Describetheregionwithin5minutedriveTimeofageographicpoint;
