...
class Data4 {
     ...
     * @param crs {module:model/Crs} 
     * @param features {Array.<module:model/Feature1>} 
     * @param type {String} 
     */
    constructor(crs, features, type) { 
        
        Data4.initialize(this, crs, features, type);
    }
     ...
     */
    static initialize(obj, crs, features, type) { 
        obj['crs'] = crs;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('features')) {
                obj['features'] = ApiClient.convertToType(data['features'], [Feature1]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Data4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Data4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Data4.RequiredProperties) {
...
Data4.RequiredProperties = ["crs", "features", "type"];

/**
 * @member {module:model/Crs} crs
 */
Data4.prototype['crs'] = undefined;

/**
 * @member {Array.<module:model/Feature1>} features
 */
Data4.prototype['features'] = undefined;

/**
 * @member {String} type
 */
Data4.prototype['type'] = undefined;
