...
/**
 * The Properties2 model module.
 * @module model/Properties2
 * @version 1.0
 */
class Properties2 {
    /**
     * Constructs a new <code>Properties2</code>.
     * @alias module:model/Properties2
     * @param calculatedAreaSqMeters {Number} 
     * @param location {module:model/Location3} 
     * @param status {Number} 
     */
    constructor(calculatedAreaSqMeters, location, status) { 
        
        Properties2.initialize(this, calculatedAreaSqMeters, location, status);
    }
     ...
     */
    static initialize(obj, calculatedAreaSqMeters, location, status) { 
    ...
    /**
     * Constructs a <code>Properties2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Properties2} obj Optional instance to populate.
     * @return {module:model/Properties2} The populated <code>Properties2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Properties2();
            ...
            if (data.hasOwnProperty('location')) {
                obj['location'] = Location3.constructFromObject(data['location']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Properties2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Properties2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Properties2.RequiredProperties) {
        ...
        if (data['location']) { // data not null
          Location3.validateJSON(data['location']);
        }
...
Properties2.RequiredProperties = ["calculated_area_sq_meters", "location", "status"];

/**
 * @member {Number} calculated_area_sq_meters
 */
Properties2.prototype['calculated_area_sq_meters'] = undefined;

/**
 * @member {module:model/Location3} location
 */
Properties2.prototype['location'] = undefined;

/**
 * @member {Number} status
 */
Properties2.prototype['status'] = undefined;
