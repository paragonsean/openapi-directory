...
class Data {
     ...
     * @param periods {Array.<String>} 
     * @param slug {String} 
     * @param version {String} 
     */
    constructor(description, groups, id, name, parameters, periods, slug, version) { 
        
        Data.initialize(this, description, groups, id, name, parameters, periods, slug, version);
    }
     ...
     */
    static initialize(obj, description, groups, id, name, parameters, periods, slug, version) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of Data.RequiredProperties) {
        ...
        if (data['parameters']) { // data not null
          Parameters.validateJSON(data['parameters']);
        }
        // ensure the json data is an array
...
Data.RequiredProperties = ["description", "groups", "id", "name", "parameters", "periods", "slug", "version"];

/**
 * @member {String} description
 */
Data.prototype['description'] = undefined;

/**
 * @member {Array.<String>} groups
 */
Data.prototype['groups'] = undefined;
 ...
 */
Data.prototype['parameters'] = undefined;

/**
 * @member {Array.<String>} periods
 */
Data.prototype['periods'] = undefined;

/**
 * @member {String} slug
 */
Data.prototype['slug'] = undefined;

/**
 * @member {String} version
 */
Data.prototype['version'] = undefined;
