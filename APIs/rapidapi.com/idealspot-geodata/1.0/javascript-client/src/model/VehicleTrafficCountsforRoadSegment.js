...
/**
 * The VehicleTrafficCountsforRoadSegment model module.
 * @module model/VehicleTrafficCountsforRoadSegment
 * @version 1.0
 */
class VehicleTrafficCountsforRoadSegment {
    /**
     * Constructs a new <code>VehicleTrafficCountsforRoadSegment</code>.
     * @alias module:model/VehicleTrafficCountsforRoadSegment
     * @param data {Array.<module:model/Data5>} 
     */
    constructor(data) { 
        
        VehicleTrafficCountsforRoadSegment.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>VehicleTrafficCountsforRoadSegment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/VehicleTrafficCountsforRoadSegment} obj Optional instance to populate.
     * @return {module:model/VehicleTrafficCountsforRoadSegment} The populated <code>VehicleTrafficCountsforRoadSegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new VehicleTrafficCountsforRoadSegment();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Data5]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>VehicleTrafficCountsforRoadSegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>VehicleTrafficCountsforRoadSegment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of VehicleTrafficCountsforRoadSegment.RequiredProperties) {
...
VehicleTrafficCountsforRoadSegment.RequiredProperties = ["data"];

/**
 * @member {Array.<module:model/Data5>} data
 */
VehicleTrafficCountsforRoadSegment.prototype['data'] = undefined;
...
export default VehicleTrafficCountsforRoadSegment;
