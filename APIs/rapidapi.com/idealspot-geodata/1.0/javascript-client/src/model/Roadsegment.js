...
/**
 * The Roadsegment model module.
 * @module model/Roadsegment
 * @version 1.0
 */
class Roadsegment {
    /**
     * Constructs a new <code>Roadsegment</code>.
     * @alias module:model/Roadsegment
     * @param coordinates {Array.<Array.<Number>>} 
     * @param type {String} 
     */
    constructor(coordinates, type) { 
        
        Roadsegment.initialize(this, coordinates, type);
    }
    ...
    /**
     * Constructs a <code>Roadsegment</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Roadsegment} obj Optional instance to populate.
     * @return {module:model/Roadsegment} The populated <code>Roadsegment</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Roadsegment();
    ...
    /**
     * Validates the JSON data with respect to <code>Roadsegment</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Roadsegment</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Roadsegment.RequiredProperties) {
...
Roadsegment.RequiredProperties = ["coordinates", "type"];

/**
 * @member {Array.<Array.<Number>>} coordinates
 */
Roadsegment.prototype['coordinates'] = undefined;

/**
 * @member {String} type
 */
Roadsegment.prototype['type'] = undefined;
