...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.DescribeOccupationInsight();
  });
  ...
  describe('DescribeOccupationInsight', function() {
    it('should create an instance of DescribeOccupationInsight', function() {
      // uncomment below and update the code to test DescribeOccupationInsight
      //var instance = new IdealSpotGeoData.DescribeOccupationInsight();
      //expect(instance).to.be.a(IdealSpotGeoData.DescribeOccupationInsight);
    });
