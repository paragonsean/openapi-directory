...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Properties3();
  });
  ...
  describe('Properties3', function() {
    it('should create an instance of Properties3', function() {
      // uncomment below and update the code to test Properties3
      //var instance = new IdealSpotGeoData.Properties3();
      //expect(instance).to.be.a(IdealSpotGeoData.Properties3);
    });
    ...
    it('should have the property roadname (base name: "roadname")', function() {
      // uncomment below and update the code to test the property roadname
      //var instance = new IdealSpotGeoData.Properties3();
      //expect(instance).to.be();
    });
