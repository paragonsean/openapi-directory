...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Metadata1();
  });
  ...
  describe('Metadata1', function() {
    it('should create an instance of Metadata1', function() {
      // uncomment below and update the code to test Metadata1
      //var instance = new IdealSpotGeoData.Metadata1();
      //expect(instance).to.be.a(IdealSpotGeoData.Metadata1);
    });
