...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Data5();
  });
  ...
  describe('Data5', function() {
    it('should create an instance of Data5', function() {
      ...
      //var instance = new IdealSpotGeoData.Data5();
      //expect(instance).to.be.a(IdealSpotGeoData.Data5);
    });
    ...
    it('should have the property roadsegment (base name: "roadsegment")', function() {
      // uncomment below and update the code to test the property roadsegment
      //var instance = new IdealSpotGeoData.Data5();
      //expect(instance).to.be();
    });
