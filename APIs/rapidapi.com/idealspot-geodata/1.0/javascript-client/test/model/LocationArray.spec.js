...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.LocationArray();
  });
  ...
  describe('LocationArray', function() {
    it('should create an instance of LocationArray', function() {
      // uncomment below and update the code to test LocationArray
      //var instance = new IdealSpotGeoData.LocationArray();
      //expect(instance).to.be.a(IdealSpotGeoData.LocationArray);
    });
