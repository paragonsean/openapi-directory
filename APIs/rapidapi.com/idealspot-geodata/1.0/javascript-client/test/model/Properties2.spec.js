...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Properties2();
  });
  ...
  describe('Properties2', function() {
    it('should create an instance of Properties2', function() {
      // uncomment below and update the code to test Properties2
      //var instance = new IdealSpotGeoData.Properties2();
      //expect(instance).to.be.a(IdealSpotGeoData.Properties2);
    });
