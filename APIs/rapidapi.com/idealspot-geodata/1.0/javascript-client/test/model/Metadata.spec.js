...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Metadata();
  });
  ...
  describe('Metadata', function() {
    it('should create an instance of Metadata', function() {
      ...
      //var instance = new IdealSpotGeoData.Metadata();
      //expect(instance).to.be.a(IdealSpotGeoData.Metadata);
    });
    ...
    it('should have the property displayGroups (base name: "display_groups")', function() {
      // uncomment below and update the code to test the property displayGroups
      //var instance = new IdealSpotGeoData.Metadata();
      //expect(instance).to.be();
    });
