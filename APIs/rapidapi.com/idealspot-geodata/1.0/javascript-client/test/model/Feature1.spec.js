...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Feature1();
  });
  ...
  describe('Feature1', function() {
    it('should create an instance of Feature1', function() {
      // uncomment below and update the code to test Feature1
      //var instance = new IdealSpotGeoData.Feature1();
      //expect(instance).to.be.a(IdealSpotGeoData.Feature1);
    });
