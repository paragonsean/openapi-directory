...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Properties();
  });
  ...
  describe('Properties', function() {
    it('should create an instance of Properties', function() {
      ...
      //var instance = new IdealSpotGeoData.Properties();
      //expect(instance).to.be.a(IdealSpotGeoData.Properties);
    });

    it('should have the property properties (base name: "_properties")', function() {
      // uncomment below and update the code to test the property properties
      //var instance = new IdealSpotGeoData.Properties();
      //expect(instance).to.be();
    });

    it('should have the property altname (base name: "altname")', function() {
    ...
    it('should have the property calculatedAreaSqMeters (base name: "calculated_area_sq_meters")', function() {
      // uncomment below and update the code to test the property calculatedAreaSqMeters
      //var instance = new IdealSpotGeoData.Properties();
      //expect(instance).to.be();
    });
