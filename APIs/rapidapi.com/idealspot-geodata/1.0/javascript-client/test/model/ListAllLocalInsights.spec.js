...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.ListAllLocalInsights();
  });
  ...
  describe('ListAllLocalInsights', function() {
    it('should create an instance of ListAllLocalInsights', function() {
      // uncomment below and update the code to test ListAllLocalInsights
      //var instance = new IdealSpotGeoData.ListAllLocalInsights();
      //expect(instance).to.be.a(IdealSpotGeoData.ListAllLocalInsights);
    });
