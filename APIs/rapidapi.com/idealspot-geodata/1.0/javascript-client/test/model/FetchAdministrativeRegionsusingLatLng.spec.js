...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.FetchAdministrativeRegionsusingLatLng();
  });
  ...
  describe('FetchAdministrativeRegionsusingLatLng', function() {
    it('should create an instance of FetchAdministrativeRegionsusingLatLng', function() {
      // uncomment below and update the code to test FetchAdministrativeRegionsusingLatLng
      //var instance = new IdealSpotGeoData.FetchAdministrativeRegionsusingLatLng();
      //expect(instance).to.be.a(IdealSpotGeoData.FetchAdministrativeRegionsusingLatLng);
    });
