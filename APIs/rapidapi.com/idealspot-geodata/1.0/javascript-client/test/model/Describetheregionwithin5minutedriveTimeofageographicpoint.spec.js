...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Describetheregionwithin5minutedriveTimeofageographicpoint();
  });
  ...
  describe('Describetheregionwithin5minutedriveTimeofageographicpoint', function() {
    it('should create an instance of Describetheregionwithin5minutedriveTimeofageographicpoint', function() {
      // uncomment below and update the code to test Describetheregionwithin5minutedriveTimeofageographicpoint
      //var instance = new IdealSpotGeoData.Describetheregionwithin5minutedriveTimeofageographicpoint();
      //expect(instance).to.be.a(IdealSpotGeoData.Describetheregionwithin5minutedriveTimeofageographicpoint);
    });
