...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.VehicleTrafficCountsforRoadSegment();
  });
  ...
  describe('VehicleTrafficCountsforRoadSegment', function() {
    it('should create an instance of VehicleTrafficCountsforRoadSegment', function() {
      // uncomment below and update the code to test VehicleTrafficCountsforRoadSegment
      //var instance = new IdealSpotGeoData.VehicleTrafficCountsforRoadSegment();
      //expect(instance).to.be.a(IdealSpotGeoData.VehicleTrafficCountsforRoadSegment);
    });
