...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.LocationArray2();
  });
  ...
  describe('LocationArray2', function() {
    it('should create an instance of LocationArray2', function() {
      // uncomment below and update the code to test LocationArray2
      //var instance = new IdealSpotGeoData.LocationArray2();
      //expect(instance).to.be.a(IdealSpotGeoData.LocationArray2);
    });
