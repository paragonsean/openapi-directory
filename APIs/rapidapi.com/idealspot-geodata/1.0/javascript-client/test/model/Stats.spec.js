...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Stats();
  });
  ...
  describe('Stats', function() {
    it('should create an instance of Stats', function() {
      ...
      //var instance = new IdealSpotGeoData.Stats();
      //expect(instance).to.be.a(IdealSpotGeoData.Stats);
    });

    it('should have the property aadt (base name: "aadt")', function() {
      // uncomment below and update the code to test the property aadt
      //var instance = new IdealSpotGeoData.Stats();
