...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Roadsegment();
  });
  ...
  describe('Roadsegment', function() {
    it('should create an instance of Roadsegment', function() {
      // uncomment below and update the code to test Roadsegment
      //var instance = new IdealSpotGeoData.Roadsegment();
      //expect(instance).to.be.a(IdealSpotGeoData.Roadsegment);
    });
