...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Properties4();
  });
  ...
  describe('Properties4', function() {
    it('should create an instance of Properties4', function() {
      // uncomment below and update the code to test Properties4
      //var instance = new IdealSpotGeoData.Properties4();
      //expect(instance).to.be.a(IdealSpotGeoData.Properties4);
    });
