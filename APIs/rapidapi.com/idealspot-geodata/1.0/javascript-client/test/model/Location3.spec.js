...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.Location3();
  });
  ...
  describe('Location3', function() {
    it('should create an instance of Location3', function() {
      // uncomment below and update the code to test Location3
      //var instance = new IdealSpotGeoData.Location3();
      //expect(instance).to.be.a(IdealSpotGeoData.Location3);
    });
