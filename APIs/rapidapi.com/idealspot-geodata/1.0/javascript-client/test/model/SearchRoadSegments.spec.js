...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.SearchRoadSegments();
  });
  ...
  describe('SearchRoadSegments', function() {
    it('should create an instance of SearchRoadSegments', function() {
      // uncomment below and update the code to test SearchRoadSegments
      //var instance = new IdealSpotGeoData.SearchRoadSegments();
      //expect(instance).to.be.a(IdealSpotGeoData.SearchRoadSegments);
    });
