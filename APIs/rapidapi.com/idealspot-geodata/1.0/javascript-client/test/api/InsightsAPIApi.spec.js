...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.InsightsAPIApi();
  });
  ...
  describe('InsightsAPIApi', function() {
    describe('fetchAvailableInsights', function() {
      it('should call fetchAvailableInsights successfully', function(done) {
        //uncomment below and update the code to test fetchAvailableInsights
        //instance.fetchAvailableInsights(function(error) {
    ...
    describe('fetchInsightQueryParameters', function() {
      it('should call fetchInsightQueryParameters successfully', function(done) {
        //uncomment below and update the code to test fetchInsightQueryParameters
        //instance.fetchInsightQueryParameters(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('queryInsightatLocation', function() {
      it('should call queryInsightatLocation successfully', function(done) {
        //uncomment below and update the code to test queryInsightatLocation
        //instance.queryInsightatLocation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
