...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.TrafficCountAPIApi();
  });
  ...
  describe('TrafficCountAPIApi', function() {
    describe('fetchNearestRoadSegments', function() {
      it('should call fetchNearestRoadSegments successfully', function(done) {
        //uncomment below and update the code to test fetchNearestRoadSegments
        //instance.fetchNearestRoadSegments(function(error) {
    ...
    describe('vehicleTrafficCountsforRoadSegment', function() {
      it('should call vehicleTrafficCountsforRoadSegment successfully', function(done) {
        //uncomment below and update the code to test vehicleTrafficCountsforRoadSegment
        //instance.vehicleTrafficCountsforRoadSegment(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
