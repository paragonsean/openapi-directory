...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdealSpotGeoData.GeometriesAPIApi();
  });
  ...
  describe('GeometriesAPIApi', function() {
    describe('fetchAdministrativeRegionsusingLatLng', function() {
      it('should call fetchAdministrativeRegionsusingLatLng successfully', function(done) {
        //uncomment below and update the code to test fetchAdministrativeRegionsusingLatLng
        //instance.fetchAdministrativeRegionsusingLatLng(function(error) {
    ...
    describe('fetchGeometries', function() {
      it('should call fetchGeometries successfully', function(done) {
        //uncomment below and update the code to test fetchGeometries
        //instance.fetchGeometries(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
