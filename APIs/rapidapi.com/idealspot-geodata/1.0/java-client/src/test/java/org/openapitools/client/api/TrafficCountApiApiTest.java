...
/**
 * API tests for TrafficCountApiApi
 */
@Disabled
public class TrafficCountApiApiTest {

    private final TrafficCountApiApi api = new TrafficCountApiApi();
     ...
     */
    @Test
    public void fetchNearestRoadSegmentsTest() throws ApiException {
        Integer n = null;
        Double latitude = null;
        Double longitude = null;
        String xRapidAPIKey = null;
        String xRapidAPIHost = null;
        SearchRoadSegments response = api.fetchNearestRoadSegments(n, latitude, longitude, xRapidAPIKey, xRapidAPIHost);
     ...
     */
    @Test
    public void vehicleTrafficCountsforRoadSegmentTest() throws ApiException {
        Integer segmentId = null;
        String xRapidAPIKey = null;
        String xRapidAPIHost = null;
        VehicleTrafficCountsforRoadSegment response = api.vehicleTrafficCountsforRoadSegment(segmentId, xRapidAPIKey, xRapidAPIHost);
        // TODO: test validations
    }
