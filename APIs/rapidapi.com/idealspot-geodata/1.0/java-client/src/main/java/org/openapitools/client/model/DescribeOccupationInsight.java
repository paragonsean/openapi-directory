...
public class DescribeOccupationInsight {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private Data data;

  public DescribeOccupationInsight() {
  }

  public DescribeOccupationInsight data(Data data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeOccupationInsight describeOccupationInsight = (DescribeOccupationInsight) o;
    return Objects.equals(this.data, describeOccupationInsight.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeOccupationInsight {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeOccupationInsight
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeOccupationInsight.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeOccupationInsight is not found in the empty JSON string", DescribeOccupationInsight.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeOccupationInsight.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeOccupationInsight` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeOccupationInsight.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeOccupationInsight.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeOccupationInsight' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeOccupationInsight> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeOccupationInsight.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeOccupationInsight>() {
           @Override
           public void write(JsonWriter out, DescribeOccupationInsight value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeOccupationInsight read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeOccupationInsight given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeOccupationInsight
   * @throws IOException if the JSON string is invalid with respect to DescribeOccupationInsight
   */
  public static DescribeOccupationInsight fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeOccupationInsight.class);
  }

  /**
   * Convert an instance of DescribeOccupationInsight to an JSON string
   *
   * @return JSON string
   */
