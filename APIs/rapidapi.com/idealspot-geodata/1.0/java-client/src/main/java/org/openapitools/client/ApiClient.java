...
public class ApiClient {
    ...
    private String basePath = "https://idealspot-geodata.p.rapidapi.com/api/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://idealspot-geodata.p.rapidapi.com/api/v1
