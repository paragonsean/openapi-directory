...
public class Describetheregionwithin5minutedriveTimeofageographicpoint {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private Data3 data;

  public Describetheregionwithin5minutedriveTimeofageographicpoint() {
  }

  public Describetheregionwithin5minutedriveTimeofageographicpoint data(Data3 data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Describetheregionwithin5minutedriveTimeofageographicpoint describetheregionwithin5minutedriveTimeofageographicpoint = (Describetheregionwithin5minutedriveTimeofageographicpoint) o;
    return Objects.equals(this.data, describetheregionwithin5minutedriveTimeofageographicpoint.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class Describetheregionwithin5minutedriveTimeofageographicpoint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Describetheregionwithin5minutedriveTimeofageographicpoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Describetheregionwithin5minutedriveTimeofageographicpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Describetheregionwithin5minutedriveTimeofageographicpoint is not found in the empty JSON string", Describetheregionwithin5minutedriveTimeofageographicpoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Describetheregionwithin5minutedriveTimeofageographicpoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Describetheregionwithin5minutedriveTimeofageographicpoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Describetheregionwithin5minutedriveTimeofageographicpoint.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Describetheregionwithin5minutedriveTimeofageographicpoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Describetheregionwithin5minutedriveTimeofageographicpoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Describetheregionwithin5minutedriveTimeofageographicpoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Describetheregionwithin5minutedriveTimeofageographicpoint.class));

       return (TypeAdapter<T>) new TypeAdapter<Describetheregionwithin5minutedriveTimeofageographicpoint>() {
           @Override
           public void write(JsonWriter out, Describetheregionwithin5minutedriveTimeofageographicpoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Describetheregionwithin5minutedriveTimeofageographicpoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Describetheregionwithin5minutedriveTimeofageographicpoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Describetheregionwithin5minutedriveTimeofageographicpoint
   * @throws IOException if the JSON string is invalid with respect to Describetheregionwithin5minutedriveTimeofageographicpoint
   */
  public static Describetheregionwithin5minutedriveTimeofageographicpoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Describetheregionwithin5minutedriveTimeofageographicpoint.class);
  }

  /**
   * Convert an instance of Describetheregionwithin5minutedriveTimeofageographicpoint to an JSON string
   *
   * @return JSON string
   */
