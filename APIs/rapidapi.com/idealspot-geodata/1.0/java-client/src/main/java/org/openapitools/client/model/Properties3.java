...
public class Properties3 {
  ...
  public static final String SERIALIZED_NAME_ROADNAME = "roadname";
  @SerializedName(SERIALIZED_NAME_ROADNAME)
  ...
  public Properties3 bearing(String bearing) {
  ...
  public Properties3 roadname(String roadname) {
  ...
  public Properties3 segmentId(String segmentId) {
  ...
  public Properties3 state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bearing, properties3.bearing) &&
        Objects.equals(this.roadname, properties3.roadname) &&
        Objects.equals(this.segmentId, properties3.segmentId) &&
        Objects.equals(this.state, properties3.state);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bearing, roadname, segmentId, state);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("roadname");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Properties3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Properties3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Properties3 is not found in the empty JSON string", Properties3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Properties3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Properties3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Properties3.openapiRequiredFields) {
      ...
      if (!jsonObj.get("roadname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `roadname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("roadname").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Properties3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Properties3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Properties3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Properties3.class));

       return (TypeAdapter<T>) new TypeAdapter<Properties3>() {
           @Override
           public void write(JsonWriter out, Properties3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Properties3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Properties3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Properties3
   * @throws IOException if the JSON string is invalid with respect to Properties3
   */
  public static Properties3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Properties3.class);
  }

  /**
   * Convert an instance of Properties3 to an JSON string
   *
   * @return JSON string
   */
