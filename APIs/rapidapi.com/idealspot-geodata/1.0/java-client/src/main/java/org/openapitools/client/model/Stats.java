...
public class Stats {
  public static final String SERIALIZED_NAME_AADT = "aadt";
  @SerializedName(SERIALIZED_NAME_AADT)
  private Integer aadt;

  public Stats() {
  }

  public Stats aadt(Integer aadt) {
    this.aadt = aadt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Stats stats = (Stats) o;
    return Objects.equals(this.aadt, stats.aadt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aadt);
  }
  ...
  public String toString() {
    ...
    sb.append("    aadt: ").append(toIndentedString(aadt)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("aadt");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("aadt");
  }
