...
public class SearchRoadSegments {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private Data4 data;

  public SearchRoadSegments() {
  }

  public SearchRoadSegments data(Data4 data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchRoadSegments searchRoadSegments = (SearchRoadSegments) o;
    return Objects.equals(this.data, searchRoadSegments.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchRoadSegments {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchRoadSegments
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchRoadSegments.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchRoadSegments is not found in the empty JSON string", SearchRoadSegments.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchRoadSegments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchRoadSegments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchRoadSegments.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchRoadSegments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchRoadSegments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchRoadSegments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchRoadSegments.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchRoadSegments>() {
           @Override
           public void write(JsonWriter out, SearchRoadSegments value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchRoadSegments read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchRoadSegments given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchRoadSegments
   * @throws IOException if the JSON string is invalid with respect to SearchRoadSegments
   */
  public static SearchRoadSegments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchRoadSegments.class);
  }

  /**
   * Convert an instance of SearchRoadSegments to an JSON string
   *
   * @return JSON string
   */
