...
public class Roadsegment {
  ...
  public Roadsegment coordinates(List<List<Double>> coordinates) {
    this.coordinates = coordinates;
    return this;
  }

  public Roadsegment addCoordinatesItem(List<Double> coordinatesItem) {
  ...
  public Roadsegment type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.coordinates, roadsegment.coordinates) &&
        Objects.equals(this.type, roadsegment.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Roadsegment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Roadsegment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Roadsegment is not found in the empty JSON string", Roadsegment.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Roadsegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Roadsegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Roadsegment.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Roadsegment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Roadsegment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Roadsegment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Roadsegment.class));

       return (TypeAdapter<T>) new TypeAdapter<Roadsegment>() {
           @Override
           public void write(JsonWriter out, Roadsegment value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Roadsegment read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Roadsegment given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Roadsegment
   * @throws IOException if the JSON string is invalid with respect to Roadsegment
   */
  public static Roadsegment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Roadsegment.class);
  }

  /**
   * Convert an instance of Roadsegment to an JSON string
   *
   * @return JSON string
   */
