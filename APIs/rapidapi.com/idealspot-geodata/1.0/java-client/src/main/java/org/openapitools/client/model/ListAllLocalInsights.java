...
public class ListAllLocalInsights {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Datum> data = new ArrayList<>();

  public ListAllLocalInsights() {
  }

  public ListAllLocalInsights data(List<Datum> data) {
    this.data = data;
    return this;
  }

  public ListAllLocalInsights addDataItem(Datum dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    ListAllLocalInsights listAllLocalInsights = (ListAllLocalInsights) o;
    return Objects.equals(this.data, listAllLocalInsights.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListAllLocalInsights {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAllLocalInsights
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAllLocalInsights.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAllLocalInsights is not found in the empty JSON string", ListAllLocalInsights.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAllLocalInsights.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAllLocalInsights` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAllLocalInsights.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Datum.validateJsonElement(jsonArraydata.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAllLocalInsights.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAllLocalInsights' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAllLocalInsights> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAllLocalInsights.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAllLocalInsights>() {
           @Override
           public void write(JsonWriter out, ListAllLocalInsights value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAllLocalInsights read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAllLocalInsights given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAllLocalInsights
   * @throws IOException if the JSON string is invalid with respect to ListAllLocalInsights
   */
  public static ListAllLocalInsights fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAllLocalInsights.class);
  }

  /**
   * Convert an instance of ListAllLocalInsights to an JSON string
   *
   * @return JSON string
   */
