...
import org.openapitools.client.model.Properties3;
...
public class Feature1 {
  ...
  public Feature1 geometry(Geometry geometry) {
  ...
  public Feature1 properties(Properties3 properties) {
  ...
  public Feature1 type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.geometry, feature1.geometry) &&
        Objects.equals(this.properties, feature1.properties) &&
        Objects.equals(this.type, feature1.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Feature1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Feature1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Feature1 is not found in the empty JSON string", Feature1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Feature1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Feature1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Feature1.openapiRequiredFields) {
      ...
      Properties3.validateJsonElement(jsonObj.get("properties"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Feature1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Feature1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Feature1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Feature1.class));

       return (TypeAdapter<T>) new TypeAdapter<Feature1>() {
           @Override
           public void write(JsonWriter out, Feature1 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Feature1 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Feature1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Feature1
   * @throws IOException if the JSON string is invalid with respect to Feature1
   */
  public static Feature1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Feature1.class);
  }

  /**
   * Convert an instance of Feature1 to an JSON string
   *
   * @return JSON string
   */
