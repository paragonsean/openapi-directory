...
public class Properties4 {
  ...
  public Properties4 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, properties4.name);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Properties4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Properties4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Properties4 is not found in the empty JSON string", Properties4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Properties4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Properties4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Properties4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Properties4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Properties4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Properties4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Properties4.class));

       return (TypeAdapter<T>) new TypeAdapter<Properties4>() {
           @Override
           public void write(JsonWriter out, Properties4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Properties4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Properties4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Properties4
   * @throws IOException if the JSON string is invalid with respect to Properties4
   */
  public static Properties4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Properties4.class);
  }

  /**
   * Convert an instance of Properties4 to an JSON string
   *
   * @return JSON string
   */
