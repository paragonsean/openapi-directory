...
public class FetchAdministrativeRegionsusingLatLng {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Data2> data = new ArrayList<>();

  public FetchAdministrativeRegionsusingLatLng() {
  }

  public FetchAdministrativeRegionsusingLatLng data(List<Data2> data) {
    this.data = data;
    return this;
  }

  public FetchAdministrativeRegionsusingLatLng addDataItem(Data2 dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    FetchAdministrativeRegionsusingLatLng fetchAdministrativeRegionsusingLatLng = (FetchAdministrativeRegionsusingLatLng) o;
    return Objects.equals(this.data, fetchAdministrativeRegionsusingLatLng.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class FetchAdministrativeRegionsusingLatLng {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FetchAdministrativeRegionsusingLatLng
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FetchAdministrativeRegionsusingLatLng.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FetchAdministrativeRegionsusingLatLng is not found in the empty JSON string", FetchAdministrativeRegionsusingLatLng.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FetchAdministrativeRegionsusingLatLng.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FetchAdministrativeRegionsusingLatLng` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FetchAdministrativeRegionsusingLatLng.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        Data2.validateJsonElement(jsonArraydata.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FetchAdministrativeRegionsusingLatLng.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FetchAdministrativeRegionsusingLatLng' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FetchAdministrativeRegionsusingLatLng> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FetchAdministrativeRegionsusingLatLng.class));

       return (TypeAdapter<T>) new TypeAdapter<FetchAdministrativeRegionsusingLatLng>() {
           @Override
           public void write(JsonWriter out, FetchAdministrativeRegionsusingLatLng value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FetchAdministrativeRegionsusingLatLng read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FetchAdministrativeRegionsusingLatLng given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FetchAdministrativeRegionsusingLatLng
   * @throws IOException if the JSON string is invalid with respect to FetchAdministrativeRegionsusingLatLng
   */
  public static FetchAdministrativeRegionsusingLatLng fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FetchAdministrativeRegionsusingLatLng.class);
  }

  /**
   * Convert an instance of FetchAdministrativeRegionsusingLatLng to an JSON string
   *
   * @return JSON string
   */
