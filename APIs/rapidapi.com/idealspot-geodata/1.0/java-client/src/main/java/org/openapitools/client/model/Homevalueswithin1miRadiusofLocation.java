...
public class Homevalueswithin1miRadiusofLocation {
  public static final String SERIALIZED_NAME_DATA = "data";
  @SerializedName(SERIALIZED_NAME_DATA)
  private List<Data1> data = new ArrayList<>();

  public Homevalueswithin1miRadiusofLocation() {
  }

  public Homevalueswithin1miRadiusofLocation data(List<Data1> data) {
    this.data = data;
    return this;
  }

  public Homevalueswithin1miRadiusofLocation addDataItem(Data1 dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    Homevalueswithin1miRadiusofLocation homevalueswithin1miRadiusofLocation = (Homevalueswithin1miRadiusofLocation) o;
    return Objects.equals(this.data, homevalueswithin1miRadiusofLocation.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class Homevalueswithin1miRadiusofLocation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Homevalueswithin1miRadiusofLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Homevalueswithin1miRadiusofLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Homevalueswithin1miRadiusofLocation is not found in the empty JSON string", Homevalueswithin1miRadiusofLocation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Homevalueswithin1miRadiusofLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Homevalueswithin1miRadiusofLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Homevalueswithin1miRadiusofLocation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Homevalueswithin1miRadiusofLocation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Homevalueswithin1miRadiusofLocation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Homevalueswithin1miRadiusofLocation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Homevalueswithin1miRadiusofLocation.class));

       return (TypeAdapter<T>) new TypeAdapter<Homevalueswithin1miRadiusofLocation>() {
           @Override
           public void write(JsonWriter out, Homevalueswithin1miRadiusofLocation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Homevalueswithin1miRadiusofLocation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Homevalueswithin1miRadiusofLocation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Homevalueswithin1miRadiusofLocation
   * @throws IOException if the JSON string is invalid with respect to Homevalueswithin1miRadiusofLocation
   */
  public static Homevalueswithin1miRadiusofLocation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Homevalueswithin1miRadiusofLocation.class);
  }

  /**
   * Convert an instance of Homevalueswithin1miRadiusofLocation to an JSON string
   *
   * @return JSON string
   */
