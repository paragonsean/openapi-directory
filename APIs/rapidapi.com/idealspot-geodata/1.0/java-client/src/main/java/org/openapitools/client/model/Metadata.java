...
public class Metadata {
  ...
  private List<List<String>> datetime = new ArrayList<>();

  public static final String SERIALIZED_NAME_DISPLAY_GROUPS = "display_groups";
  @SerializedName(SERIALIZED_NAME_DISPLAY_GROUPS)
  private List<List<String>> displayGroups = new ArrayList<>();
  ...
  public Metadata datetime(List<List<String>> datetime) {
    this.datetime = datetime;
    return this;
  }

  public Metadata addDatetimeItem(List<String> datetimeItem) {
  ...
  public List<List<String>> getDatetime() {
    return datetime;
  }

  public void setDatetime(List<List<String>> datetime) {
    this.datetime = datetime;
  }


  public Metadata displayGroups(List<List<String>> displayGroups) {
    this.displayGroups = displayGroups;
    return this;
  }

  public Metadata addDisplayGroupsItem(List<String> displayGroupsItem) {
    if (this.displayGroups == null) {
      this.displayGroups = new ArrayList<>();
    }
    this.displayGroups.add(displayGroupsItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public List<List<String>> getDisplayGroups() {
    return displayGroups;
  }

  public void setDisplayGroups(List<List<String>> displayGroups) {
    this.displayGroups = displayGroups;
  }


  public Metadata units(Units units) {
    this.units = units;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.datetime, metadata.datetime) &&
        Objects.equals(this.displayGroups, metadata.displayGroups) &&
        Objects.equals(this.units, metadata.units);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datetime, displayGroups, units);
  }
  ...
  public String toString() {
    ...
    sb.append("    displayGroups: ").append(toIndentedString(displayGroups)).append("\n");
  ...
  static {
    ...
    openapiFields.add("display_groups");
    openapiFields.add("units");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("datetime");
    openapiRequiredFields.add("display_groups");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      } else if (!jsonObj.get("datetime").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `datetime` to be an array in the JSON string but got `%s`", jsonObj.get("datetime").toString()));
      }
      // ensure the required json array is present
      if (jsonObj.get("display_groups") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("display_groups").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `display_groups` to be an array in the JSON string but got `%s`", jsonObj.get("display_groups").toString()));
      }
      // validate the required field `units`
      Units.validateJsonElement(jsonObj.get("units"));
  }
