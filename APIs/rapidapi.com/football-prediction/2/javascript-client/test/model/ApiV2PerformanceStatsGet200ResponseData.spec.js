...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FootballPredictionApi.ApiV2PerformanceStatsGet200ResponseData();
  });
  ...
  describe('ApiV2PerformanceStatsGet200ResponseData', function() {
    it('should create an instance of ApiV2PerformanceStatsGet200ResponseData', function() {
      // uncomment below and update the code to test ApiV2PerformanceStatsGet200ResponseData
      //var instance = new FootballPredictionApi.ApiV2PerformanceStatsGet200ResponseData();
      //expect(instance).to.be.a(FootballPredictionApi.ApiV2PerformanceStatsGet200ResponseData);
    });
