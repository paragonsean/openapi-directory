...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://spellcheckpro.p.rapidapi.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("checkSpellingRussian", defaultConf);
    _serverIndices.insert("checkSpellingRussian", 0);
}
...
void OAIDefaultApi::checkSpellingRussian(const ::OpenAPI::OptionalParam<QString> &x_rapid_api_key, const ::OpenAPI::OptionalParam<OAICheckSpellingRussian_request> &oai_check_spelling_russian_request) {
    QString fullPath = QString(_serverConfigs["checkSpellingRussian"][_serverIndices.value("checkSpellingRussian")].URL()+"/check_spelling");
    ...
    if (oai_check_spelling_russian_request.hasValue()){

        
        QByteArray output = oai_check_spelling_russian_request.value().asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::checkSpellingRussianCallback);
...
void OAIDefaultApi::checkSpellingRussianCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT checkSpellingRussianSignal();
        Q_EMIT checkSpellingRussianSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT checkSpellingRussianSignalE(error_type, error_str);
        Q_EMIT checkSpellingRussianSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT checkSpellingRussianSignalError(error_type, error_str);
        Q_EMIT checkSpellingRussianSignalErrorFull(worker, error_type, error_str);
    }
}
