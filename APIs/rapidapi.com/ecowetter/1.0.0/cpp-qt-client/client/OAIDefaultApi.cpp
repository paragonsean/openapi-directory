...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://api.ecowetter.de"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("publicHistoryGet", defaultConf);
    _serverIndices.insert("publicHistoryGet", 0);
}
...
void OAIDefaultApi::publicHistoryGet(const ::OpenAPI::OptionalParam<QString> &q, const ::OpenAPI::OptionalParam<QString> &from, const ::OpenAPI::OptionalParam<QString> &to) {
    QString fullPath = QString(_serverConfigs["publicHistoryGet"][_serverIndices.value("publicHistoryGet")].URL()+"/public/history");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::publicHistoryGetCallback);
...
void OAIDefaultApi::publicHistoryGetCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT publicHistoryGetSignal(output);
        Q_EMIT publicHistoryGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT publicHistoryGetSignalE(output, error_type, error_str);
        Q_EMIT publicHistoryGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT publicHistoryGetSignalError(output, error_type, error_str);
        Q_EMIT publicHistoryGetSignalErrorFull(worker, error_type, error_str);
    }
}
