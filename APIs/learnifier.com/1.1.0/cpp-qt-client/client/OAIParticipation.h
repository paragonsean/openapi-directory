...
#ifndef OAIParticipation_H
#define OAIParticipation_H
...
class OAIParticipation : public OAIObject {
public:
    OAIParticipation();
    OAIParticipation(QString json);
    ~OAIParticipation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParticipation)

#endif // OAIParticipation_H
