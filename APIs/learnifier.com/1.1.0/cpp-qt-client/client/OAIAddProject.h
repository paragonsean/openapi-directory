...
#ifndef OAIAddProject_H
#define OAIAddProject_H
...
class OAIAddProject : public OAIObject {
public:
    OAIAddProject();
    OAIAddProject(QString json);
    ~OAIAddProject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddProject)

#endif // OAIAddProject_H
