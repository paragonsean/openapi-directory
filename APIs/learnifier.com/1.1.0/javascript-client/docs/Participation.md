...
**id** | **Number** | Unique identifier representing this participation. Id numbers are never reused | [optional] 
...
**projectId** | **Number** | The id of the project this participation belongs to | [optional] 
**userId** | **String** | The id of the user this participation belongs to | [optional] 
