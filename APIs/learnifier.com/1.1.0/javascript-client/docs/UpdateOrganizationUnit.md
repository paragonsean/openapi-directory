# Learnifier.UpdateOrganizationUnit

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**caller** | **String** | The id of the user that initiated this operation | [optional] 
...
**displayName** | **String** | The name shown for the organization unit | [optional] 
**externalId** | **String** | The external id (foreign key). Must not exceed 255 characters. | [optional] 
**parent** | **Number** | A Organization Unit id of the parent Organization Unit (optional). | [optional] 
