...
**created** | **Date** | The timestamp when this project was created. | [optional] 
**createdBy** | **String** | The id of the user that created the project. If the creator is not known this value is *null* | [optional] 
**designId** | **Number** | The id of the design this project are using or null if no design is used | [optional] 
**externalId** | **String** | The external id (foreign key). Must not exceed 255 characters. | [optional] 
**id** | **Number** | Unique identifier representing a specific project. Id numbers are never reused. | [optional] 
...
**orgId** | **Number** | The id of the organization unit this project belongs to | [optional] 
**status** | **String** | Project status. Can be either ACTIVATED, NEW or DISABLED | [optional] 
