...
**id** | **Number** | Unique identifier representing a specific organization unit. Id numbers are never reused. | 
**name** | **String** | The name of the client. | [optional] 
**parentId** | **Number** | Unique identifier of the parent or *null* if there is no parent. | [optional] 
