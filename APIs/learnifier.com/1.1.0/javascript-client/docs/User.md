...
**firstLogin** | **Date** | The timestamp when the first login was made. This value can be *null*. | [optional] 
...
**id** | **String** | The id of the user this participation belongs to | [optional] 
**lastLogin** | **Date** | The timestamp when the last login was made. This value can be *null*. | [optional] 
