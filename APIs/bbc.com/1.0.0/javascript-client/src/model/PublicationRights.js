...
/**
 * The PublicationRights model module.
 * @module model/PublicationRights
 * @version 1.0.0
 */
class PublicationRights {
    /**
     * Constructs a new <code>PublicationRights</code>.
     * @alias module:model/PublicationRights
     */
    constructor() { 
        
        PublicationRights.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicationRights</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicationRights} obj Optional instance to populate.
     * @return {module:model/PublicationRights} The populated <code>PublicationRights</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicationRights();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicationRights</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicationRights</code>.
     */
 ...
 * @member {String} #text
 */
PublicationRights.prototype['#text'] = undefined;

/**
 * @member {String} context
 */
PublicationRights.prototype['context'] = undefined;

/**
 * @member {String} platform
 */
PublicationRights.prototype['platform'] = undefined;

/**
 * @member {String} territory
 */
PublicationRights.prototype['territory'] = undefined;

/**
 * @member {String} transport
 */
PublicationRights.prototype['transport'] = undefined;
