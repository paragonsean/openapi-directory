...
import DeprecatedReferenceElement from './DeprecatedReferenceElement';
import GenreGroup from './GenreGroup';

/**
 * The GenreGroupsType model module.
 * @module model/GenreGroupsType
 * @version 1.0.0
 */
class GenreGroupsType {
    /**
     * Constructs a new <code>GenreGroupsType</code>.
     * @alias module:model/GenreGroupsType
     * @implements module:model/DeprecatedReferenceElement
     * @param href {String} 
    ...
    constructor(href, resultType, deprecated, deprecatedSince, replacedBy) { 
        ...
        GenreGroupsType.initialize(this, href, resultType, deprecated, deprecatedSince, replacedBy);
    }
    ...
    /**
     * Constructs a <code>GenreGroupsType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenreGroupsType} obj Optional instance to populate.
     * @return {module:model/GenreGroupsType} The populated <code>GenreGroupsType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenreGroupsType();
            DeprecatedReferenceElement.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GenreGroupsType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenreGroupsType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenreGroupsType.RequiredProperties) {
...
GenreGroupsType.RequiredProperties = ["href", "result_type", "deprecated", "deprecated_since", "replaced_by"];

/**
 * @member {String} href
 */
GenreGroupsType.prototype['href'] = undefined;

/**
 * @member {String} result_type
 */
GenreGroupsType.prototype['result_type'] = undefined;

/**
 * @member {Boolean} deprecated
 */
GenreGroupsType.prototype['deprecated'] = undefined;

/**
 * @member {String} deprecated_since
 */
GenreGroupsType.prototype['deprecated_since'] = undefined;

/**
 * @member {String} replaced_by
 */
GenreGroupsType.prototype['replaced_by'] = undefined;

/**
 * @member {Array.<module:model/GenreGroup>} genre_group
 */
GenreGroupsType.prototype['genre_group'] = undefined;


// Implement DeprecatedReferenceElement interface:
/**
 * @member {String} href
 */
...
export default GenreGroupsType;
