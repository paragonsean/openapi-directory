...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.SchemaApi();
  });
  ...
  describe('SchemaApi', function() {
    ...
    describe('getXSD', function() {
      it('should call getXSD successfully', function(done) {
        //uncomment below and update the code to test getXSD
        //instance.getXSD(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
