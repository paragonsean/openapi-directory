...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.AvailabilityOf();
  });
  ...
  describe('AvailabilityOf', function() {
    it('should create an instance of AvailabilityOf', function() {
      // uncomment below and update the code to test AvailabilityOf
      //var instance = new BbcNitroApi.AvailabilityOf();
      //expect(instance).to.be.a(BbcNitroApi.AvailabilityOf);
    });
