...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.ImageLinkImage();
  });
  ...
  describe('ImageLinkImage', function() {
    it('should create an instance of ImageLinkImage', function() {
      // uncomment below and update the code to test ImageLinkImage
      //var instance = new BbcNitroApi.ImageLinkImage();
      //expect(instance).to.be.a(BbcNitroApi.ImageLinkImage);
    });
