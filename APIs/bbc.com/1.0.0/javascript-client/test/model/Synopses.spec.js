...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.Synopses();
  });
  ...
  describe('Synopses', function() {
    it('should create an instance of Synopses', function() {
      // uncomment below and update the code to test Synopses
      //var instance = new BbcNitroApi.Synopses();
      //expect(instance).to.be.a(BbcNitroApi.Synopses);
    });
