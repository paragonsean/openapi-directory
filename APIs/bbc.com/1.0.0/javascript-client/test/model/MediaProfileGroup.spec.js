...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.MediaProfileGroup();
  });
  ...
  describe('MediaProfileGroup', function() {
    it('should create an instance of MediaProfileGroup', function() {
      // uncomment below and update the code to test MediaProfileGroup
      //var instance = new BbcNitroApi.MediaProfileGroup();
      //expect(instance).to.be.a(BbcNitroApi.MediaProfileGroup);
    });
