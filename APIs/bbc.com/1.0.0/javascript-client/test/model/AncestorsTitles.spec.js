...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.AncestorsTitles();
  });
  ...
  describe('AncestorsTitles', function() {
    it('should create an instance of AncestorsTitles', function() {
      // uncomment below and update the code to test AncestorsTitles
      //var instance = new BbcNitroApi.AncestorsTitles();
      //expect(instance).to.be.a(BbcNitroApi.AncestorsTitles);
    });
