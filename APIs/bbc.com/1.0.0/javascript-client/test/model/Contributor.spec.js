...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.Contributor();
  });
  ...
  describe('Contributor', function() {
    it('should create an instance of Contributor', function() {
      ...
      //var instance = new BbcNitroApi.Contributor();
      //expect(instance).to.be.a(BbcNitroApi.Contributor);
    });
    ...
    it('should have the property contributorTo (base name: "contributor_to")', function() {
      // uncomment below and update the code to test the property contributorTo
      //var instance = new BbcNitroApi.Contributor();
      //expect(instance).to.be();
    });
