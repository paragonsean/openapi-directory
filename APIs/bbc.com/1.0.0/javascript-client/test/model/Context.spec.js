...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instance = new BbcNitroApi.Context();
      //expect(instance).to.be.a(BbcNitroApi.Context);
    });

    it('should have the property cascadesToDescendants (base name: "cascades_to_descendants")', function() {
      // uncomment below and update the code to test the property cascadesToDescendants
      //var instance = new BbcNitroApi.Context();
