...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.MasterBrandSynopses();
  });
  ...
  describe('MasterBrandSynopses', function() {
    it('should create an instance of MasterBrandSynopses', function() {
      // uncomment below and update the code to test MasterBrandSynopses
      //var instance = new BbcNitroApi.MasterBrandSynopses();
      //expect(instance).to.be.a(BbcNitroApi.MasterBrandSynopses);
    });
