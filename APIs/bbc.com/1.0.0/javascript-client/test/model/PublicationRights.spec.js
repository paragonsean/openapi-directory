...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.PublicationRights();
  });
  ...
  describe('PublicationRights', function() {
    it('should create an instance of PublicationRights', function() {
      // uncomment below and update the code to test PublicationRights
      //var instance = new BbcNitroApi.PublicationRights();
      //expect(instance).to.be.a(BbcNitroApi.PublicationRights);
    });
