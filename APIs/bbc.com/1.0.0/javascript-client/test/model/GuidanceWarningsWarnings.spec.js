...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.GuidanceWarningsWarnings();
  });
  ...
  describe('GuidanceWarningsWarnings', function() {
    it('should create an instance of GuidanceWarningsWarnings', function() {
      // uncomment below and update the code to test GuidanceWarningsWarnings
      //var instance = new BbcNitroApi.GuidanceWarningsWarnings();
      //expect(instance).to.be.a(BbcNitroApi.GuidanceWarningsWarnings);
    });
