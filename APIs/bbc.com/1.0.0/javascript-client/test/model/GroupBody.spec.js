...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.GroupBody();
  });
  ...
  describe('GroupBody', function() {
    it('should create an instance of GroupBody', function() {
      // uncomment below and update the code to test GroupBody
      //var instance = new BbcNitroApi.GroupBody();
      //expect(instance).to.be.a(BbcNitroApi.GroupBody);
    });
    ...
    it('should have the property forProgrammes (base name: "for_programmes")', function() {
      // uncomment below and update the code to test the property forProgrammes
      //var instance = new BbcNitroApi.GroupBody();
      //expect(instance).to.be();
    });
