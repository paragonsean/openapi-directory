...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.FocusPoint();
  });
  ...
  describe('FocusPoint', function() {
    it('should create an instance of FocusPoint', function() {
      // uncomment below and update the code to test FocusPoint
      //var instance = new BbcNitroApi.FocusPoint();
      //expect(instance).to.be.a(BbcNitroApi.FocusPoint);
    });
