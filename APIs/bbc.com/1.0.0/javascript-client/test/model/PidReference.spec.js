...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.PidReference();
  });
  ...
  describe('PidReference', function() {
    it('should create an instance of PidReference', function() {
      // uncomment below and update the code to test PidReference
      //var instance = new BbcNitroApi.PidReference();
      //expect(instance).to.be.a(BbcNitroApi.PidReference);
    });
