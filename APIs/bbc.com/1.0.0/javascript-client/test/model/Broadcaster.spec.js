...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BbcNitroApi.Broadcaster();
  });
  ...
  describe('Broadcaster', function() {
    it('should create an instance of Broadcaster', function() {
      // uncomment below and update the code to test Broadcaster
      //var instance = new BbcNitroApi.Broadcaster();
      //expect(instance).to.be.a(BbcNitroApi.Broadcaster);
    });
