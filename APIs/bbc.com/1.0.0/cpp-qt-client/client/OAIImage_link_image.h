...
/*
 * OAIImage_link_image.h
 *
 * 
 */

#ifndef OAIImage_link_image_H
#define OAIImage_link_image_H
...
namespace OpenAPI {
class OAIImage_link_image_anyOf_image;

class OAIImage_link_image : public OAIObject {
public:
    OAIImage_link_image();
    OAIImage_link_image(QString json);
    ~OAIImage_link_image() override;
    ...
    OAIImage_link_image_anyOf_image getImage() const;
    void setImage(const OAIImage_link_image_anyOf_image &image);
...
private:
    ...
    OAIImage_link_image_anyOf_image m_image;
    bool m_image_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImage_link_image)

#endif // OAIImage_link_image_H
