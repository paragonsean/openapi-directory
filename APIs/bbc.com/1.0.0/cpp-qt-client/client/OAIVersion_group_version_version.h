...
/*
 * OAIVersion_group_version_version.h
 *
 * 
 */

#ifndef OAIVersion_group_version_version_H
#define OAIVersion_group_version_version_H
...
class OAIVersion_group_version_version : public OAIObject {
public:
    OAIVersion_group_version_version();
    OAIVersion_group_version_version(QString json);
    ~OAIVersion_group_version_version() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVersion_group_version_version)

#endif // OAIVersion_group_version_version_H
