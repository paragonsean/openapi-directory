...
#ifndef OAIBroadcaster_H
#define OAIBroadcaster_H
...
class OAIBroadcaster : public OAIObject {
public:
    OAIBroadcaster();
    OAIBroadcaster(QString json);
    ~OAIBroadcaster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBroadcaster)

#endif // OAIBroadcaster_H
