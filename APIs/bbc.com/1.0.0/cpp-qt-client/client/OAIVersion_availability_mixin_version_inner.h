...
/*
 * OAIVersion_availability_mixin_version_inner.h
 *
 * 
 */

#ifndef OAIVersion_availability_mixin_version_inner_H
#define OAIVersion_availability_mixin_version_inner_H
...
#include "OAIVersion_availability_mixin_version_inner_version_inner.h"
#include <QList>
#include <QString>
...
class OAIVersion_availability_mixin_version_inner_version_inner;

class OAIVersion_availability_mixin_version_inner : public OAIObject {
public:
    OAIVersion_availability_mixin_version_inner();
    OAIVersion_availability_mixin_version_inner(QString json);
    ~OAIVersion_availability_mixin_version_inner() override;
    ...
    QList<OAIVersion_availability_mixin_version_inner_version_inner> getVersion() const;
    void setVersion(const QList<OAIVersion_availability_mixin_version_inner_version_inner> &version);
...
private:
    ...
    QList<OAIVersion_availability_mixin_version_inner_version_inner> m_version;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVersion_availability_mixin_version_inner)

#endif // OAIVersion_availability_mixin_version_inner_H
