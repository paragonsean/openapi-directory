...
/*
 * OAIMedia_profile_group.h
 *
 * 
 */

#ifndef OAIMedia_profile_group_H
#define OAIMedia_profile_group_H
...
class OAIMedia_profile_group : public OAIObject {
public:
    OAIMedia_profile_group();
    OAIMedia_profile_group(QString json);
    ~OAIMedia_profile_group() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMedia_profile_group)

#endif // OAIMedia_profile_group_H
