...
class MessageAttemptExhaustedEventData(Model):
    ...
    def __init__(self, app_id: str=None, app_uid: str=None, endpoint_id: str=None, last_attempt: MessageAttemptFailedData=None, msg_event_id: str=None, msg_id: str=None):
        """MessageAttemptExhaustedEventData - a model defined in OpenAPI

        :param app_id: The app_id of this MessageAttemptExhaustedEventData.
        :param app_uid: The app_uid of this MessageAttemptExhaustedEventData.
        :param endpoint_id: The endpoint_id of this MessageAttemptExhaustedEventData.
        :param last_attempt: The last_attempt of this MessageAttemptExhaustedEventData.
        :param msg_event_id: The msg_event_id of this MessageAttemptExhaustedEventData.
        :param msg_id: The msg_id of this MessageAttemptExhaustedEventData.
        """
        self.openapi_types = {
            'app_id': str,
            'app_uid': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MessageAttemptExhaustedEventData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MessageAttemptExhaustedEventData of this MessageAttemptExhaustedEventData.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def app_id(self):
        """Gets the app_id of this MessageAttemptExhaustedEventData.


        :return: The app_id of this MessageAttemptExhaustedEventData.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        """Sets the app_id of this MessageAttemptExhaustedEventData.
    ...
    @property
    def app_uid(self):
        """Gets the app_uid of this MessageAttemptExhaustedEventData.

        Optional unique identifier for the application

        :return: The app_uid of this MessageAttemptExhaustedEventData.
        :rtype: str
        """
    ...
    def app_uid(self, app_uid):
        """Sets the app_uid of this MessageAttemptExhaustedEventData.
    ...
    def endpoint_id(self):
        """Gets the endpoint_id of this MessageAttemptExhaustedEventData.


        :return: The endpoint_id of this MessageAttemptExhaustedEventData.
        :rtype: str
        """
    ...
    def endpoint_id(self, endpoint_id):
        """Sets the endpoint_id of this MessageAttemptExhaustedEventData.
    ...
    def last_attempt(self):
        """Gets the last_attempt of this MessageAttemptExhaustedEventData.


        :return: The last_attempt of this MessageAttemptExhaustedEventData.
    ...
    def last_attempt(self, last_attempt):
        """Sets the last_attempt of this MessageAttemptExhaustedEventData.
    ...
    def msg_event_id(self):
        """Gets the msg_event_id of this MessageAttemptExhaustedEventData.

        Optional unique identifier for the message

        :return: The msg_event_id of this MessageAttemptExhaustedEventData.
        :rtype: str
        """
    ...
    def msg_event_id(self, msg_event_id):
        """Sets the msg_event_id of this MessageAttemptExhaustedEventData.
    ...
    @property
    def msg_id(self):
        """Gets the msg_id of this MessageAttemptExhaustedEventData.


        :return: The msg_id of this MessageAttemptExhaustedEventData.
        :rtype: str
        """
        return self._msg_id
    ...
    def msg_id(self, msg_id):
        """Sets the msg_id of this MessageAttemptExhaustedEventData.
