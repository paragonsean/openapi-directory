...
class EndpointCreatedEventData(Model):
    ...
    def __init__(self, app_id: str=None, app_uid: str=None, endpoint_id: str=None, endpoint_uid: str=None):
        """EndpointCreatedEventData - a model defined in OpenAPI

        :param app_id: The app_id of this EndpointCreatedEventData.
        :param app_uid: The app_uid of this EndpointCreatedEventData.
        :param endpoint_id: The endpoint_id of this EndpointCreatedEventData.
        :param endpoint_uid: The endpoint_uid of this EndpointCreatedEventData.
        """
        self.openapi_types = {
            'app_id': str,
            'app_uid': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EndpointCreatedEventData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EndpointCreatedEventData of this EndpointCreatedEventData.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def app_id(self):
        """Gets the app_id of this EndpointCreatedEventData.


        :return: The app_id of this EndpointCreatedEventData.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        """Sets the app_id of this EndpointCreatedEventData.
    ...
    @property
    def app_uid(self):
        """Gets the app_uid of this EndpointCreatedEventData.

        Optional unique identifier for the application

        :return: The app_uid of this EndpointCreatedEventData.
        :rtype: str
        """
    ...
    def app_uid(self, app_uid):
        """Sets the app_uid of this EndpointCreatedEventData.
    ...
    def endpoint_id(self):
        """Gets the endpoint_id of this EndpointCreatedEventData.


        :return: The endpoint_id of this EndpointCreatedEventData.
        :rtype: str
        """
    ...
    def endpoint_id(self, endpoint_id):
        """Sets the endpoint_id of this EndpointCreatedEventData.
    ...
    def endpoint_uid(self):
        """Gets the endpoint_uid of this EndpointCreatedEventData.

        Optional unique identifier for the endpoint

        :return: The endpoint_uid of this EndpointCreatedEventData.
        :rtype: str
        """
    ...
    def endpoint_uid(self, endpoint_uid):
        """Sets the endpoint_uid of this EndpointCreatedEventData.
