...
class IntegrationUpdate {
    ...
    constructor(name) { 
        ...
        IntegrationUpdate.initialize(this, name);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IntegrationUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IntegrationUpdate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IntegrationUpdate.RequiredProperties) {
...
IntegrationUpdate.RequiredProperties = ["name"];

/**
 * @member {String} name
 */
IntegrationUpdate.prototype['name'] = undefined;
