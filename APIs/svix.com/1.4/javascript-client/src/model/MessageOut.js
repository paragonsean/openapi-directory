...
class MessageOut {
     ...
     */
    constructor(eventType, id, payload, timestamp) { 
        
        MessageOut.initialize(this, eventType, id, payload, timestamp);
    }
     ...
     */
    static initialize(obj, eventType, id, payload, timestamp) { 
...
MessageOut.RequiredProperties = ["eventType", "id", "payload", "timestamp"];

/**
 * List of free-form identifiers that endpoints can filter by
 * @member {Array.<String>} channels
 */
MessageOut.prototype['channels'] = undefined;

/**
 * Optional unique identifier for the message
 * @member {String} eventId
 */
MessageOut.prototype['eventId'] = undefined;

/**
 * @member {String} eventType
 */
MessageOut.prototype['eventType'] = undefined;
 ...
 */
MessageOut.prototype['payload'] = undefined;

/**
 * @member {Date} timestamp
 */
MessageOut.prototype['timestamp'] = undefined;
