...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.MessageAttemptEndpointOut();
  });
  ...
  describe('MessageAttemptEndpointOut', function() {
    it('should create an instance of MessageAttemptEndpointOut', function() {
      // uncomment below and update the code to test MessageAttemptEndpointOut
      //var instance = new SvixApi.MessageAttemptEndpointOut();
      //expect(instance).to.be.a(SvixApi.MessageAttemptEndpointOut);
    });
