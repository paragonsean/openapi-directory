...
(function(root, factory) {
  ...
  describe('ReplayIn', function() {
    it('should create an instance of ReplayIn', function() {
      // uncomment below and update the code to test ReplayIn
      //var instance = new SvixApi.ReplayIn();
      //expect(instance).to.be.a(SvixApi.ReplayIn);
    });
