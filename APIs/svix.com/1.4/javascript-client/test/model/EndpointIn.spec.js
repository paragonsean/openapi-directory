...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.EndpointIn();
  });
  ...
  describe('EndpointIn', function() {
    it('should create an instance of EndpointIn', function() {
      // uncomment below and update the code to test EndpointIn
      //var instance = new SvixApi.EndpointIn();
      //expect(instance).to.be.a(SvixApi.EndpointIn);
    });
