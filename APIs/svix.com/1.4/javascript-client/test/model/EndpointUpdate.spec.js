...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.EndpointUpdate();
  });
  ...
  describe('EndpointUpdate', function() {
    it('should create an instance of EndpointUpdate', function() {
      // uncomment below and update the code to test EndpointUpdate
      //var instance = new SvixApi.EndpointUpdate();
      //expect(instance).to.be.a(SvixApi.EndpointUpdate);
    });
    ...
    it('should have the property filterTypes (base name: "filterTypes")', function() {
