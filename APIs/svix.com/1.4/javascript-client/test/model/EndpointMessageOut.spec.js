...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.EndpointMessageOut();
  });
  ...
  describe('EndpointMessageOut', function() {
    it('should create an instance of EndpointMessageOut', function() {
      // uncomment below and update the code to test EndpointMessageOut
      //var instance = new SvixApi.EndpointMessageOut();
      //expect(instance).to.be.a(SvixApi.EndpointMessageOut);
    });
    ...
    it('should have the property nextAttempt (base name: "nextAttempt")', function() {
