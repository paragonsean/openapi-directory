...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.WebhookTypes();
  });
  ...
  describe('WebhookTypes', function() {
    it('should create an instance of WebhookTypes', function() {
      // uncomment below and update the code to test WebhookTypes
      //var instance = new SvixApi.WebhookTypes();
      //expect(instance).to.be.a(SvixApi.WebhookTypes);
    });
    ...
    it('should have the property a1 (base name: "a1")', function() {
      // uncomment below and update the code to test the property a1
      //var instance = new SvixApi.WebhookTypes();
      //expect(instance).to.be();
    });

    it('should have the property a2 (base name: "a2")', function() {
      // uncomment below and update the code to test the property a2
      //var instance = new SvixApi.WebhookTypes();
      //expect(instance).to.be();
    });
