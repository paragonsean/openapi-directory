...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.MessageIn();
  });
  ...
  describe('MessageIn', function() {
    it('should create an instance of MessageIn', function() {
      ...
      //var instance = new SvixApi.MessageIn();
      //expect(instance).to.be.a(SvixApi.MessageIn);
    });
    ...
    it('should have the property payloadRetentionPeriod (base name: "payloadRetentionPeriod")', function() {
      // uncomment below and update the code to test the property payloadRetentionPeriod
      //var instance = new SvixApi.MessageIn();
      //expect(instance).to.be();
    });
