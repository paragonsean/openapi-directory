...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.EndpointOut();
  });
  ...
  describe('EndpointOut', function() {
    it('should create an instance of EndpointOut', function() {
      // uncomment below and update the code to test EndpointOut
      //var instance = new SvixApi.EndpointOut();
      //expect(instance).to.be.a(SvixApi.EndpointOut);
    });
