...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.MessageAttemptOut();
  });
  ...
  describe('MessageAttemptOut', function() {
    it('should create an instance of MessageAttemptOut', function() {
      // uncomment below and update the code to test MessageAttemptOut
      //var instance = new SvixApi.MessageAttemptOut();
      //expect(instance).to.be.a(SvixApi.MessageAttemptOut);
    });
