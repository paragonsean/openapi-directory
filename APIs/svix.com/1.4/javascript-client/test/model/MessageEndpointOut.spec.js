...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.MessageEndpointOut();
  });
  ...
  describe('MessageEndpointOut', function() {
    it('should create an instance of MessageEndpointOut', function() {
      // uncomment below and update the code to test MessageEndpointOut
      //var instance = new SvixApi.MessageEndpointOut();
      //expect(instance).to.be.a(SvixApi.MessageEndpointOut);
    });
