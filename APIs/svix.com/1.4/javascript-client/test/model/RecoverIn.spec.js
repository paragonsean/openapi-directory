...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvixApi.RecoverIn();
  });
  ...
  describe('RecoverIn', function() {
    it('should create an instance of RecoverIn', function() {
      // uncomment below and update the code to test RecoverIn
      //var instance = new SvixApi.RecoverIn();
      //expect(instance).to.be.a(SvixApi.RecoverIn);
    });
