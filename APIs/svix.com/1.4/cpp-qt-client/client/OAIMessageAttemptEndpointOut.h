...
/*
 * OAIMessageAttemptEndpointOut.h
 *
 * 
 */

#ifndef OAIMessageAttemptEndpointOut_H
#define OAIMessageAttemptEndpointOut_H
...
class OAIMessageAttemptEndpointOut : public OAIObject {
public:
    OAIMessageAttemptEndpointOut();
    OAIMessageAttemptEndpointOut(QString json);
    ~OAIMessageAttemptEndpointOut() override;
    ...
    OAIMessageAttemptTriggerType getTriggerType() const;
    void setTriggerType(const OAIMessageAttemptTriggerType &trigger_type);
...
private:
    ...
    OAIMessageAttemptTriggerType m_trigger_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageAttemptEndpointOut)

#endif // OAIMessageAttemptEndpointOut_H
