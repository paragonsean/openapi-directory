...
#ifndef OAIReplayIn_H
#define OAIReplayIn_H
...
class OAIReplayIn : public OAIObject {
public:
    OAIReplayIn();
    OAIReplayIn(QString json);
    ~OAIReplayIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplayIn)
