...
#ifndef OAIMessageOut_H
#define OAIMessageOut_H
...
class OAIMessageOut : public OAIObject {
public:
    OAIMessageOut();
    OAIMessageOut(QString json);
    ~OAIMessageOut() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageOut)

#endif // OAIMessageOut_H
