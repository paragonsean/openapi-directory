...
#ifndef OAIEndpointOut_H
#define OAIEndpointOut_H
...
class OAIEndpointOut : public OAIObject {
public:
    OAIEndpointOut();
    OAIEndpointOut(QString json);
    ~OAIEndpointOut() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointOut)

#endif // OAIEndpointOut_H
