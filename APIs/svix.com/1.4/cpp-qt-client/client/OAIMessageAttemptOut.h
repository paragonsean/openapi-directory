...
/*
 * OAIMessageAttemptOut.h
 *
 * 
 */

#ifndef OAIMessageAttemptOut_H
#define OAIMessageAttemptOut_H
...
class OAIMessageAttemptOut : public OAIObject {
public:
    OAIMessageAttemptOut();
    OAIMessageAttemptOut(QString json);
    ~OAIMessageAttemptOut() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageAttemptOut)

#endif // OAIMessageAttemptOut_H
