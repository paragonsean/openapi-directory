...
QString OAIMessageStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIMessageStatus::Success:
            val = QString::number(0);
            break;
        case eOAIMessageStatus::Pending:
            val = QString::number(1);
            break;
        case eOAIMessageStatus::Fail:
            val = QString::number(2);
            break;
        case eOAIMessageStatus::Sending:
...
QJsonValue OAIMessageStatus::asJsonValue() const {
    
    return QJsonValue(static_cast<int>(m_value));
}


OAIMessageStatus::eOAIMessageStatus OAIMessageStatus::getValue() const {
    return m_value;
}

void OAIMessageStatus::setValue(const OAIMessageStatus::eOAIMessageStatus& value){
    m_value = value;
    m_value_isSet = true;
}
