...
class OAIMessageStatus : public OAIEnum {
public:
    OAIMessageStatus();
    ...
    enum class eOAIMessageStatus : int {
    ...
    OAIMessageStatus::eOAIMessageStatus getValue() const;
    void setValue(const OAIMessageStatus::eOAIMessageStatus& value);
