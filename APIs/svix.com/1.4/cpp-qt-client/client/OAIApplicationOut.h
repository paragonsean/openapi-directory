...
#ifndef OAIApplicationOut_H
#define OAIApplicationOut_H
...
class OAIApplicationOut : public OAIObject {
public:
    OAIApplicationOut();
    OAIApplicationOut(QString json);
    ~OAIApplicationOut() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationOut)

#endif // OAIApplicationOut_H
