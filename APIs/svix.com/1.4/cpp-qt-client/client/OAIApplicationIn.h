...
#ifndef OAIApplicationIn_H
#define OAIApplicationIn_H
...
class OAIApplicationIn : public OAIObject {
public:
    OAIApplicationIn();
    OAIApplicationIn(QString json);
    ~OAIApplicationIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApplicationIn)

#endif // OAIApplicationIn_H
