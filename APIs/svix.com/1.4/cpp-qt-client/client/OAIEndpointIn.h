...
#ifndef OAIEndpointIn_H
#define OAIEndpointIn_H
...
class OAIEndpointIn : public OAIObject {
public:
    OAIEndpointIn();
    OAIEndpointIn(QString json);
    ~OAIEndpointIn() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointIn)

#endif // OAIEndpointIn_H
