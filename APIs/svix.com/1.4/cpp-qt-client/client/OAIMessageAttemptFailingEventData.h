...
/*
 * OAIMessageAttemptFailingEventData.h
 *
 * 
 */

#ifndef OAIMessageAttemptFailingEventData_H
#define OAIMessageAttemptFailingEventData_H
...
class OAIMessageAttemptFailingEventData : public OAIObject {
public:
    OAIMessageAttemptFailingEventData();
    OAIMessageAttemptFailingEventData(QString json);
    ~OAIMessageAttemptFailingEventData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMessageAttemptFailingEventData)

#endif // OAIMessageAttemptFailingEventData_H
