...
#ifndef OAIMessageIn_H
#define OAIMessageIn_H
...
namespace OpenAPI {
class OAIApplicationIn;

class OAIMessageIn : public OAIObject {
public:
    OAIMessageIn();
    OAIMessageIn(QString json);
    ~OAIMessageIn() override;
    ...
    OAIApplicationIn getApplication() const;
    void setApplication(const OAIApplicationIn &application);
    ...
    qint32 getPayloadRetentionPeriod() const;
    void setPayloadRetentionPeriod(const qint32 &payload_retention_period);
    bool is_payload_retention_period_Set() const;
    bool is_payload_retention_period_Valid() const;
...
private:
    ...
    OAIApplicationIn m_application;
    ...
    qint32 m_payload_retention_period;
    bool m_payload_retention_period_isSet;
    bool m_payload_retention_period_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMessageIn)

#endif // OAIMessageIn_H
