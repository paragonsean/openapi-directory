...
#ifndef OAIEndpointUpdate_H
#define OAIEndpointUpdate_H
...
class OAIEndpointUpdate : public OAIObject {
public:
    OAIEndpointUpdate();
    OAIEndpointUpdate(QString json);
    ~OAIEndpointUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointUpdate)

#endif // OAIEndpointUpdate_H
