...
#ifndef OAIEndpointHeadersOut_H
#define OAIEndpointHeadersOut_H
...
class OAIEndpointHeadersOut : public OAIObject {
public:
    OAIEndpointHeadersOut();
    OAIEndpointHeadersOut(QString json);
    ~OAIEndpointHeadersOut() override;
    ...
    QSet<QString> getSensitive() const;
    void setSensitive(const QSet<QString> &sensitive);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEndpointHeadersOut)

#endif // OAIEndpointHeadersOut_H
