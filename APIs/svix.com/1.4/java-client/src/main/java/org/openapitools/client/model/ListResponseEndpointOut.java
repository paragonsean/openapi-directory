...
public class ListResponseEndpointOut {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listResponseEndpointOut.data) &&
        ...
        Objects.equals(this.prevIterator, listResponseEndpointOut.prevIterator);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListResponseEndpointOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListResponseEndpointOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListResponseEndpointOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListResponseEndpointOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        EndpointOut.validateJsonElement(jsonArraydata.get(i));
      };
