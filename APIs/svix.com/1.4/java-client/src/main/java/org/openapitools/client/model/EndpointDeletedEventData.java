...
public class EndpointDeletedEventData {
  ...
  public boolean equals(Object o) {
    ...
    EndpointDeletedEventData endpointDeletedEventData = (EndpointDeletedEventData) o;
    return Objects.equals(this.appId, endpointDeletedEventData.appId) &&
        Objects.equals(this.appUid, endpointDeletedEventData.appUid) &&
        Objects.equals(this.endpointId, endpointDeletedEventData.endpointId) &&
        Objects.equals(this.endpointUid, endpointDeletedEventData.endpointUid);
  }
  ...
  public String toString() {
    ...
    sb.append("class EndpointDeletedEventData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointDeletedEventData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointDeletedEventData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointDeletedEventData is not found in the empty JSON string", EndpointDeletedEventData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointDeletedEventData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointDeletedEventData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EndpointDeletedEventData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointDeletedEventData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointDeletedEventData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointDeletedEventData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointDeletedEventData.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointDeletedEventData>() {
           @Override
           public void write(JsonWriter out, EndpointDeletedEventData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointDeletedEventData read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to EndpointDeletedEventData
   */
  public static EndpointDeletedEventData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointDeletedEventData.class);
  }
