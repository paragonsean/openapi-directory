...
class ModifyAntennaConfigConfigPayload(Model):
    ...
    def __init__(self, antenna_rotation: int=None, depth: float=None, x: float=None, y: float=None):
        """ModifyAntennaConfigConfigPayload - a model defined in OpenAPI

        :param antenna_rotation: The antenna_rotation of this ModifyAntennaConfigConfigPayload.
        :param depth: The depth of this ModifyAntennaConfigConfigPayload.
        :param x: The x of this ModifyAntennaConfigConfigPayload.
        :param y: The y of this ModifyAntennaConfigConfigPayload.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ModifyAntennaConfigConfigPayload':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ModifyAntennaConfigConfigPayload of this ModifyAntennaConfigConfigPayload.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def antenna_rotation(self):
        """Gets the antenna_rotation of this ModifyAntennaConfigConfigPayload.

        Configured rotation of antenna relative to forward arrow on topside housing. Clockwise is positive direction (degrees)

        :return: The antenna_rotation of this ModifyAntennaConfigConfigPayload.
        :rtype: int
        """
    ...
    def antenna_rotation(self, antenna_rotation):
        """Sets the antenna_rotation of this ModifyAntennaConfigConfigPayload.
    ...
    @property
    def depth(self):
        """Gets the depth of this ModifyAntennaConfigConfigPayload.

        Configured depth relative to surface (meter)

        :return: The depth of this ModifyAntennaConfigConfigPayload.
        :rtype: float
        """
        return self._depth
    ...
    def depth(self, depth):
        """Sets the depth of this ModifyAntennaConfigConfigPayload.
    ...
    @property
    def x(self):
        """Gets the x of this ModifyAntennaConfigConfigPayload.

        Configured f position relative to master electronics (meter)

        :return: The x of this ModifyAntennaConfigConfigPayload.
        :rtype: float
        """
        return self._x
    ...
    @x.setter
    def x(self, x):
        """Sets the x of this ModifyAntennaConfigConfigPayload.
    ...
    @property
    def y(self):
        """Gets the y of this ModifyAntennaConfigConfigPayload.

        Configured Y position relative to master electronics (meter)

        :return: The y of this ModifyAntennaConfigConfigPayload.
        :rtype: float
        """
        return self._y
    ...
    @y.setter
    def y(self, y):
        """Sets the y of this ModifyAntennaConfigConfigPayload.
