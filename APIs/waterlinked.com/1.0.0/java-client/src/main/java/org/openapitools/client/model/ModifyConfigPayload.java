...
public class ModifyConfigPayload {
  ...
  public ModifyConfigPayload() {
  }

  public ModifyConfigPayload antennaEnabled(Boolean antennaEnabled) {
  ...
  public ModifyConfigPayload channel(Integer channel) {
  ...
  public ModifyConfigPayload compass(CompassEnum compass) {
  ...
  public ModifyConfigPayload environment(EnvironmentEnum environment) {
  ...
  public ModifyConfigPayload externalPpsEnabled(Boolean externalPpsEnabled) {
  ...
  public ModifyConfigPayload gps(GpsEnum gps) {
    this.gps = gps;
    return this;
  }
  ...
  public ModifyConfigPayload imuVehicleEnabled(Boolean imuVehicleEnabled) {
  ...
  public ModifyConfigPayload locatorType(LocatorTypeEnum locatorType) {
  ...
  public ModifyConfigPayload rangeMaxX(BigDecimal rangeMaxX) {
  ...
  public ModifyConfigPayload rangeMaxY(BigDecimal rangeMaxY) {
  ...
  public ModifyConfigPayload rangeMaxZ(BigDecimal rangeMaxZ) {
  ...
  public ModifyConfigPayload rangeMinX(BigDecimal rangeMinX) {
  ...
  public ModifyConfigPayload rangeMinY(BigDecimal rangeMinY) {
  ...
  public ModifyConfigPayload searchDirection(BigDecimal searchDirection) {
  ...
  public ModifyConfigPayload searchRadius(BigDecimal searchRadius) {
  ...
  public ModifyConfigPayload searchSector(BigDecimal searchSector) {
  ...
  public ModifyConfigPayload speedOfSound(Integer speedOfSound) {
  ...
  public ModifyConfigPayload staticLat(BigDecimal staticLat) {
  ...
  public ModifyConfigPayload staticLon(BigDecimal staticLon) {
  ...
  public ModifyConfigPayload staticOrientation(BigDecimal staticOrientation) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyConfigPayload modifyConfigPayload = (ModifyConfigPayload) o;
    return Objects.equals(this.antennaEnabled, modifyConfigPayload.antennaEnabled) &&
        Objects.equals(this.channel, modifyConfigPayload.channel) &&
        Objects.equals(this.compass, modifyConfigPayload.compass) &&
        Objects.equals(this.environment, modifyConfigPayload.environment) &&
        Objects.equals(this.externalPpsEnabled, modifyConfigPayload.externalPpsEnabled) &&
        Objects.equals(this.gps, modifyConfigPayload.gps) &&
        Objects.equals(this.imuVehicleEnabled, modifyConfigPayload.imuVehicleEnabled) &&
        Objects.equals(this.locatorType, modifyConfigPayload.locatorType) &&
        Objects.equals(this.rangeMaxX, modifyConfigPayload.rangeMaxX) &&
        Objects.equals(this.rangeMaxY, modifyConfigPayload.rangeMaxY) &&
        Objects.equals(this.rangeMaxZ, modifyConfigPayload.rangeMaxZ) &&
        Objects.equals(this.rangeMinX, modifyConfigPayload.rangeMinX) &&
        Objects.equals(this.rangeMinY, modifyConfigPayload.rangeMinY) &&
        Objects.equals(this.searchDirection, modifyConfigPayload.searchDirection) &&
        Objects.equals(this.searchRadius, modifyConfigPayload.searchRadius) &&
        Objects.equals(this.searchSector, modifyConfigPayload.searchSector) &&
        Objects.equals(this.speedOfSound, modifyConfigPayload.speedOfSound) &&
        Objects.equals(this.staticLat, modifyConfigPayload.staticLat) &&
        Objects.equals(this.staticLon, modifyConfigPayload.staticLon) &&
        Objects.equals(this.staticOrientation, modifyConfigPayload.staticOrientation);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyConfigPayload {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyConfigPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyConfigPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyConfigPayload is not found in the empty JSON string", ModifyConfigPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyConfigPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyConfigPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ModifyConfigPayload.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyConfigPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyConfigPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyConfigPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyConfigPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyConfigPayload>() {
           @Override
           public void write(JsonWriter out, ModifyConfigPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyConfigPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyConfigPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyConfigPayload
   * @throws IOException if the JSON string is invalid with respect to ModifyConfigPayload
   */
  public static ModifyConfigPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyConfigPayload.class);
  }

  /**
   * Convert an instance of ModifyConfigPayload to an JSON string
   *
   * @return JSON string
   */
