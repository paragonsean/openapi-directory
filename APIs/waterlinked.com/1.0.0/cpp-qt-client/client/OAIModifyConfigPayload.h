...
/*
 * OAIModifyConfigPayload.h
 *
 * Configuration parameters
 */

#ifndef OAIModifyConfigPayload_H
#define OAIModifyConfigPayload_H
...
class OAIModifyConfigPayload : public OAIObject {
public:
    OAIModifyConfigPayload();
    OAIModifyConfigPayload(QString json);
    ~OAIModifyConfigPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyConfigPayload)

#endif // OAIModifyConfigPayload_H
