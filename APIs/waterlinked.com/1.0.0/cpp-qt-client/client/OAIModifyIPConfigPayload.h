...
/*
 * OAIModifyIPConfigPayload.h
 *
 * Configuration parameters
 */

#ifndef OAIModifyIPConfigPayload_H
#define OAIModifyIPConfigPayload_H
...
class OAIModifyIPConfigPayload : public OAIObject {
public:
    OAIModifyIPConfigPayload();
    OAIModifyIPConfigPayload(QString json);
    ~OAIModifyIPConfigPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyIPConfigPayload)

#endif // OAIModifyIPConfigPayload_H
