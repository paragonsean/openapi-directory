...
/*
 * OAIWlSatellitePosition.h
 *
 * GPS and IMU position (default view)
 */

#ifndef OAIWlSatellitePosition_H
#define OAIWlSatellitePosition_H
...
class OAIWlSatellitePosition : public OAIObject {
public:
    OAIWlSatellitePosition();
    OAIWlSatellitePosition(QString json);
    ~OAIWlSatellitePosition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWlSatellitePosition)

#endif // OAIWlSatellitePosition_H
