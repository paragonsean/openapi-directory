...
#ifndef OAIWaterlinkedPoi_H
#define OAIWaterlinkedPoi_H
...
class OAIWaterlinkedPoi : public OAIObject {
public:
    OAIWaterlinkedPoi();
    OAIWaterlinkedPoi(QString json);
    ~OAIWaterlinkedPoi() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWaterlinkedPoi)

#endif // OAIWaterlinkedPoi_H
