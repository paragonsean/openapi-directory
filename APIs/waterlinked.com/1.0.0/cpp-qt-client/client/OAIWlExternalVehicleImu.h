...
/*
 * OAIWlExternalVehicleImu.h
 *
 * Set current rotation and acceleration of vehicle (default view)
 */

#ifndef OAIWlExternalVehicleImu_H
#define OAIWlExternalVehicleImu_H
...
class OAIWlExternalVehicleImu : public OAIObject {
public:
    OAIWlExternalVehicleImu();
    OAIWlExternalVehicleImu(QString json);
    ~OAIWlExternalVehicleImu() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWlExternalVehicleImu)

#endif // OAIWlExternalVehicleImu_H
