...
/*
 * OAIUpdatePoiPayload.h
 *
 * A list of all POI
 */

#ifndef OAIUpdatePoiPayload_H
#define OAIUpdatePoiPayload_H
...
class OAIUpdatePoiPayload : public OAIObject {
public:
    OAIUpdatePoiPayload();
    OAIUpdatePoiPayload(QString json);
    ~OAIUpdatePoiPayload() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePoiPayload)

#endif // OAIUpdatePoiPayload_H
