...
OAIModifyConfigPayload::OAIModifyConfigPayload(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIModifyConfigPayload::OAIModifyConfigPayload() {
    this->initializeModel();
}

OAIModifyConfigPayload::~OAIModifyConfigPayload() {}

void OAIModifyConfigPayload::initializeModel() {
...
void OAIModifyConfigPayload::fromJson(QString jsonString) {
...
void OAIModifyConfigPayload::fromJsonObject(QJsonObject json) {
...
QString OAIModifyConfigPayload::asJson() const {
...
QJsonObject OAIModifyConfigPayload::asJsonObject() const {
    QJsonObject obj;
...
bool OAIModifyConfigPayload::isAntennaEnabled() const {
    return m_antenna_enabled;
}
void OAIModifyConfigPayload::setAntennaEnabled(const bool &antenna_enabled) {
    m_antenna_enabled = antenna_enabled;
    m_antenna_enabled_isSet = true;
}

bool OAIModifyConfigPayload::is_antenna_enabled_Set() const{
    return m_antenna_enabled_isSet;
}

bool OAIModifyConfigPayload::is_antenna_enabled_Valid() const{
    return m_antenna_enabled_isValid;
}

qint32 OAIModifyConfigPayload::getChannel() const {
    return m_channel;
}
void OAIModifyConfigPayload::setChannel(const qint32 &channel) {
    m_channel = channel;
    m_channel_isSet = true;
}

bool OAIModifyConfigPayload::is_channel_Set() const{
    return m_channel_isSet;
}

bool OAIModifyConfigPayload::is_channel_Valid() const{
    return m_channel_isValid;
}

QString OAIModifyConfigPayload::getCompass() const {
    return m_compass;
}
void OAIModifyConfigPayload::setCompass(const QString &compass) {
    m_compass = compass;
    m_compass_isSet = true;
}

bool OAIModifyConfigPayload::is_compass_Set() const{
    return m_compass_isSet;
}

bool OAIModifyConfigPayload::is_compass_Valid() const{
    return m_compass_isValid;
}

QString OAIModifyConfigPayload::getEnvironment() const {
    return m_environment;
}
void OAIModifyConfigPayload::setEnvironment(const QString &environment) {
    m_environment = environment;
    m_environment_isSet = true;
}

bool OAIModifyConfigPayload::is_environment_Set() const{
    return m_environment_isSet;
}

bool OAIModifyConfigPayload::is_environment_Valid() const{
    return m_environment_isValid;
}

bool OAIModifyConfigPayload::isExternalPpsEnabled() const {
    return m_external_pps_enabled;
}
void OAIModifyConfigPayload::setExternalPpsEnabled(const bool &external_pps_enabled) {
    m_external_pps_enabled = external_pps_enabled;
    m_external_pps_enabled_isSet = true;
}

bool OAIModifyConfigPayload::is_external_pps_enabled_Set() const{
    return m_external_pps_enabled_isSet;
}

bool OAIModifyConfigPayload::is_external_pps_enabled_Valid() const{
    return m_external_pps_enabled_isValid;
}

QString OAIModifyConfigPayload::getGps() const {
    return m_gps;
}
void OAIModifyConfigPayload::setGps(const QString &gps) {
    m_gps = gps;
    m_gps_isSet = true;
}

bool OAIModifyConfigPayload::is_gps_Set() const{
    return m_gps_isSet;
}

bool OAIModifyConfigPayload::is_gps_Valid() const{
    return m_gps_isValid;
}

bool OAIModifyConfigPayload::isImuVehicleEnabled() const {
    return m_imu_vehicle_enabled;
}
void OAIModifyConfigPayload::setImuVehicleEnabled(const bool &imu_vehicle_enabled) {
    m_imu_vehicle_enabled = imu_vehicle_enabled;
    m_imu_vehicle_enabled_isSet = true;
}

bool OAIModifyConfigPayload::is_imu_vehicle_enabled_Set() const{
    return m_imu_vehicle_enabled_isSet;
}

bool OAIModifyConfigPayload::is_imu_vehicle_enabled_Valid() const{
    return m_imu_vehicle_enabled_isValid;
}

QString OAIModifyConfigPayload::getLocatorType() const {
    return m_locator_type;
}
void OAIModifyConfigPayload::setLocatorType(const QString &locator_type) {
    m_locator_type = locator_type;
    m_locator_type_isSet = true;
}

bool OAIModifyConfigPayload::is_locator_type_Set() const{
    return m_locator_type_isSet;
}

bool OAIModifyConfigPayload::is_locator_type_Valid() const{
    return m_locator_type_isValid;
}

double OAIModifyConfigPayload::getRangeMaxX() const {
    return m_range_max_x;
}
void OAIModifyConfigPayload::setRangeMaxX(const double &range_max_x) {
    m_range_max_x = range_max_x;
    m_range_max_x_isSet = true;
}

bool OAIModifyConfigPayload::is_range_max_x_Set() const{
    return m_range_max_x_isSet;
}

bool OAIModifyConfigPayload::is_range_max_x_Valid() const{
    return m_range_max_x_isValid;
}

double OAIModifyConfigPayload::getRangeMaxY() const {
    return m_range_max_y;
}
void OAIModifyConfigPayload::setRangeMaxY(const double &range_max_y) {
    m_range_max_y = range_max_y;
    m_range_max_y_isSet = true;
}

bool OAIModifyConfigPayload::is_range_max_y_Set() const{
    return m_range_max_y_isSet;
}

bool OAIModifyConfigPayload::is_range_max_y_Valid() const{
    return m_range_max_y_isValid;
}

double OAIModifyConfigPayload::getRangeMaxZ() const {
    return m_range_max_z;
}
void OAIModifyConfigPayload::setRangeMaxZ(const double &range_max_z) {
    m_range_max_z = range_max_z;
    m_range_max_z_isSet = true;
}

bool OAIModifyConfigPayload::is_range_max_z_Set() const{
    return m_range_max_z_isSet;
}

bool OAIModifyConfigPayload::is_range_max_z_Valid() const{
    return m_range_max_z_isValid;
}

double OAIModifyConfigPayload::getRangeMinX() const {
    return m_range_min_x;
}
void OAIModifyConfigPayload::setRangeMinX(const double &range_min_x) {
    m_range_min_x = range_min_x;
    m_range_min_x_isSet = true;
}

bool OAIModifyConfigPayload::is_range_min_x_Set() const{
    return m_range_min_x_isSet;
}

bool OAIModifyConfigPayload::is_range_min_x_Valid() const{
    return m_range_min_x_isValid;
}

double OAIModifyConfigPayload::getRangeMinY() const {
    return m_range_min_y;
}
void OAIModifyConfigPayload::setRangeMinY(const double &range_min_y) {
    m_range_min_y = range_min_y;
    m_range_min_y_isSet = true;
}

bool OAIModifyConfigPayload::is_range_min_y_Set() const{
    return m_range_min_y_isSet;
}

bool OAIModifyConfigPayload::is_range_min_y_Valid() const{
    return m_range_min_y_isValid;
}

double OAIModifyConfigPayload::getSearchDirection() const {
    return m_search_direction;
}
void OAIModifyConfigPayload::setSearchDirection(const double &search_direction) {
    m_search_direction = search_direction;
    m_search_direction_isSet = true;
}

bool OAIModifyConfigPayload::is_search_direction_Set() const{
    return m_search_direction_isSet;
}

bool OAIModifyConfigPayload::is_search_direction_Valid() const{
    return m_search_direction_isValid;
}

double OAIModifyConfigPayload::getSearchRadius() const {
    return m_search_radius;
}
void OAIModifyConfigPayload::setSearchRadius(const double &search_radius) {
    m_search_radius = search_radius;
    m_search_radius_isSet = true;
}

bool OAIModifyConfigPayload::is_search_radius_Set() const{
    return m_search_radius_isSet;
}

bool OAIModifyConfigPayload::is_search_radius_Valid() const{
    return m_search_radius_isValid;
}

double OAIModifyConfigPayload::getSearchSector() const {
    return m_search_sector;
}
void OAIModifyConfigPayload::setSearchSector(const double &search_sector) {
    m_search_sector = search_sector;
    m_search_sector_isSet = true;
}

bool OAIModifyConfigPayload::is_search_sector_Set() const{
    return m_search_sector_isSet;
}

bool OAIModifyConfigPayload::is_search_sector_Valid() const{
    return m_search_sector_isValid;
}

qint32 OAIModifyConfigPayload::getSpeedOfSound() const {
    return m_speed_of_sound;
}
void OAIModifyConfigPayload::setSpeedOfSound(const qint32 &speed_of_sound) {
    m_speed_of_sound = speed_of_sound;
    m_speed_of_sound_isSet = true;
}

bool OAIModifyConfigPayload::is_speed_of_sound_Set() const{
    return m_speed_of_sound_isSet;
}

bool OAIModifyConfigPayload::is_speed_of_sound_Valid() const{
    return m_speed_of_sound_isValid;
}

double OAIModifyConfigPayload::getStaticLat() const {
    return m_static_lat;
}
void OAIModifyConfigPayload::setStaticLat(const double &static_lat) {
    m_static_lat = static_lat;
    m_static_lat_isSet = true;
}

bool OAIModifyConfigPayload::is_static_lat_Set() const{
    return m_static_lat_isSet;
}

bool OAIModifyConfigPayload::is_static_lat_Valid() const{
    return m_static_lat_isValid;
}

double OAIModifyConfigPayload::getStaticLon() const {
    return m_static_lon;
}
void OAIModifyConfigPayload::setStaticLon(const double &static_lon) {
    m_static_lon = static_lon;
    m_static_lon_isSet = true;
}

bool OAIModifyConfigPayload::is_static_lon_Set() const{
    return m_static_lon_isSet;
}

bool OAIModifyConfigPayload::is_static_lon_Valid() const{
    return m_static_lon_isValid;
}

double OAIModifyConfigPayload::getStaticOrientation() const {
    return m_static_orientation;
}
void OAIModifyConfigPayload::setStaticOrientation(const double &static_orientation) {
    m_static_orientation = static_orientation;
    m_static_orientation_isSet = true;
}

bool OAIModifyConfigPayload::is_static_orientation_Set() const{
    return m_static_orientation_isSet;
}

bool OAIModifyConfigPayload::is_static_orientation_Valid() const{
    return m_static_orientation_isValid;
}

bool OAIModifyConfigPayload::isSet() const {
...
bool OAIModifyConfigPayload::isValid() const {
