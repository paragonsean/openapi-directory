...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.ModifyReceiverConfigPayload();
  });
  ...
  describe('ModifyReceiverConfigPayload', function() {
    it('should create an instance of ModifyReceiverConfigPayload', function() {
      // uncomment below and update the code to test ModifyReceiverConfigPayload
      //var instance = new TheWaterLinkedUnderwaterGpsApi.ModifyReceiverConfigPayload();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.ModifyReceiverConfigPayload);
    });
