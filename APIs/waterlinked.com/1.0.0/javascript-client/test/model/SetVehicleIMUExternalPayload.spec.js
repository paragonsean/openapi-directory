...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.SetVehicleIMUExternalPayload();
  });
  ...
  describe('SetVehicleIMUExternalPayload', function() {
    it('should create an instance of SetVehicleIMUExternalPayload', function() {
      // uncomment below and update the code to test SetVehicleIMUExternalPayload
      //var instance = new TheWaterLinkedUnderwaterGpsApi.SetVehicleIMUExternalPayload();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.SetVehicleIMUExternalPayload);
    });
