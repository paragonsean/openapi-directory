...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.ModifyIPConfigPayload();
  });
  ...
  describe('ModifyIPConfigPayload', function() {
    it('should create an instance of ModifyIPConfigPayload', function() {
      // uncomment below and update the code to test ModifyIPConfigPayload
      //var instance = new TheWaterLinkedUnderwaterGpsApi.ModifyIPConfigPayload();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.ModifyIPConfigPayload);
    });
