...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.WaterlinkedReceiver();
  });
  ...
  describe('WaterlinkedReceiver', function() {
    it('should create an instance of WaterlinkedReceiver', function() {
      // uncomment below and update the code to test WaterlinkedReceiver
      //var instance = new TheWaterLinkedUnderwaterGpsApi.WaterlinkedReceiver();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.WaterlinkedReceiver);
    });
