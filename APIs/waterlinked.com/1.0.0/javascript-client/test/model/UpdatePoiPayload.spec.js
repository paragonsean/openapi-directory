...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.UpdatePoiPayload();
  });
  ...
  describe('UpdatePoiPayload', function() {
    it('should create an instance of UpdatePoiPayload', function() {
      // uncomment below and update the code to test UpdatePoiPayload
      //var instance = new TheWaterLinkedUnderwaterGpsApi.UpdatePoiPayload();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.UpdatePoiPayload);
    });
