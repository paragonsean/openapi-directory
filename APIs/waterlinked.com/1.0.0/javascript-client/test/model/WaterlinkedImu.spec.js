...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.WaterlinkedImu();
  });
  ...
  describe('WaterlinkedImu', function() {
    it('should create an instance of WaterlinkedImu', function() {
      // uncomment below and update the code to test WaterlinkedImu
      //var instance = new TheWaterLinkedUnderwaterGpsApi.WaterlinkedImu();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.WaterlinkedImu);
    });
