...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.WaterlinkedPoi();
  });
  ...
  describe('WaterlinkedPoi', function() {
    it('should create an instance of WaterlinkedPoi', function() {
      // uncomment below and update the code to test WaterlinkedPoi
      //var instance = new TheWaterLinkedUnderwaterGpsApi.WaterlinkedPoi();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.WaterlinkedPoi);
    });
