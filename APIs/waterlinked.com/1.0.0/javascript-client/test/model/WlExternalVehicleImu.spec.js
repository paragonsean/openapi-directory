...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.WlExternalVehicleImu();
  });
  ...
  describe('WlExternalVehicleImu', function() {
    it('should create an instance of WlExternalVehicleImu', function() {
      // uncomment below and update the code to test WlExternalVehicleImu
      //var instance = new TheWaterLinkedUnderwaterGpsApi.WlExternalVehicleImu();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.WlExternalVehicleImu);
    });
