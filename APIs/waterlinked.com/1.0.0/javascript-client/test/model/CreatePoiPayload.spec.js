...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheWaterLinkedUnderwaterGpsApi.CreatePoiPayload();
  });
  ...
  describe('CreatePoiPayload', function() {
    it('should create an instance of CreatePoiPayload', function() {
      // uncomment below and update the code to test CreatePoiPayload
      //var instance = new TheWaterLinkedUnderwaterGpsApi.CreatePoiPayload();
      //expect(instance).to.be.a(TheWaterLinkedUnderwaterGpsApi.CreatePoiPayload);
    });
