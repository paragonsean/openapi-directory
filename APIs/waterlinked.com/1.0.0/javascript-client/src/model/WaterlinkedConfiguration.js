...
/**
 * The WaterlinkedConfiguration model module.
 * @module model/WaterlinkedConfiguration
 * @version 1.0.0
 */
class WaterlinkedConfiguration {
    /**
     * Constructs a new <code>WaterlinkedConfiguration</code>.
     * Configuration parameters (default view)
     * @alias module:model/WaterlinkedConfiguration
     * @param channel {Number} Channel to use
     * @param compass {module:model/WaterlinkedConfiguration.CompassEnum} Compass provider setting
     * @param gps {module:model/WaterlinkedConfiguration.GpsEnum} GPS provider setting
     * @param locatorType {module:model/WaterlinkedConfiguration.LocatorTypeEnum} Locator type in use
    ...
    constructor(channel, compass, gps, locatorType, staticLat, staticLon, staticOrientation) { 
        ...
        WaterlinkedConfiguration.initialize(this, channel, compass, gps, locatorType, staticLat, staticLon, staticOrientation);
    }
    ...
    /**
     * Constructs a <code>WaterlinkedConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WaterlinkedConfiguration} obj Optional instance to populate.
     * @return {module:model/WaterlinkedConfiguration} The populated <code>WaterlinkedConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WaterlinkedConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>WaterlinkedConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WaterlinkedConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WaterlinkedConfiguration.RequiredProperties) {
...
WaterlinkedConfiguration.RequiredProperties = ["channel", "compass", "gps", "locator_type", "static_lat", "static_lon", "static_orientation"];

/**
 * Enable use of antenna
 * @member {Boolean} antenna_enabled
 */
WaterlinkedConfiguration.prototype['antenna_enabled'] = undefined;

/**
 * Channel to use
 * @member {Number} channel
 */
WaterlinkedConfiguration.prototype['channel'] = undefined;

/**
 * Compass provider setting
 * @member {module:model/WaterlinkedConfiguration.CompassEnum} compass
 */
WaterlinkedConfiguration.prototype['compass'] = undefined;

/**
 * [Deprecated] Environment setting
 * @member {module:model/WaterlinkedConfiguration.EnvironmentEnum} environment
 */
WaterlinkedConfiguration.prototype['environment'] = undefined;

/**
 * Enable external PPS input to master
 * @member {Boolean} external_pps_enabled
 */
WaterlinkedConfiguration.prototype['external_pps_enabled'] = undefined;

/**
 * GPS provider setting
 * @member {module:model/WaterlinkedConfiguration.GpsEnum} gps
 */
WaterlinkedConfiguration.prototype['gps'] = undefined;

/**
 * [Deprecated] Enable IMU input from vehicle
 * @member {Boolean} imu_vehicle_enabled
 */
WaterlinkedConfiguration.prototype['imu_vehicle_enabled'] = undefined;

/**
 * Locator type in use
 * @member {module:model/WaterlinkedConfiguration.LocatorTypeEnum} locator_type
 */
WaterlinkedConfiguration.prototype['locator_type'] = undefined;

/**
 * [Deprecated] Max range (meters)
 * @member {Number} range_max_x
 */
WaterlinkedConfiguration.prototype['range_max_x'] = undefined;

/**
 * [Deprecated] Max range (meters)
 * @member {Number} range_max_y
 */
WaterlinkedConfiguration.prototype['range_max_y'] = undefined;

/**
 * [Deprecated] Max range (meters)
 * @member {Number} range_max_z
 */
WaterlinkedConfiguration.prototype['range_max_z'] = undefined;

/**
 * [Deprecated] Max range (meters)
 * @member {Number} range_min_x
 */
WaterlinkedConfiguration.prototype['range_min_x'] = undefined;

/**
 * [Deprecated] Max range (meters)
 * @member {Number} range_min_y
 */
WaterlinkedConfiguration.prototype['range_min_y'] = undefined;

/**
 * Direction of circular search area section
 * @member {Number} search_direction
 */
WaterlinkedConfiguration.prototype['search_direction'] = undefined;

/**
 * Radius of circular search area
 * @member {Number} search_radius
 */
WaterlinkedConfiguration.prototype['search_radius'] = undefined;

/**
 * Sector angle of circular search area
 * @member {Number} search_sector
 */
WaterlinkedConfiguration.prototype['search_sector'] = undefined;

/**
 * Speed of sound use by the system
 * @member {Number} speed_of_sound
 */
WaterlinkedConfiguration.prototype['speed_of_sound'] = undefined;

/**
 * Latitude to use in static mode
 * @member {Number} static_lat
 */
WaterlinkedConfiguration.prototype['static_lat'] = undefined;

/**
 * Longitude to use in static mode
 * @member {Number} static_lon
 */
WaterlinkedConfiguration.prototype['static_lon'] = undefined;

/**
 * Orientation/compass reading to use in static mode (degrees)
 * @member {Number} static_orientation
 */
WaterlinkedConfiguration.prototype['static_orientation'] = undefined;
 ...
 * @readonly
 */
WaterlinkedConfiguration['CompassEnum'] = {
 ...
 * @readonly
 */
WaterlinkedConfiguration['EnvironmentEnum'] = {
 ...
 * @readonly
 */
WaterlinkedConfiguration['GpsEnum'] = {
 ...
 * @readonly
 */
WaterlinkedConfiguration['LocatorTypeEnum'] = {
...
export default WaterlinkedConfiguration;
