...
public class KeywordTask {
  ...
  public KeywordTask keyword(String keyword) {
  ...
  public KeywordTask localizationCode(LocalizationCodeEnum localizationCode) {
  ...
  public KeywordTask localizationZip(String localizationZip) {
  ...
  public KeywordTask searchEngine(SearchEngineEnum searchEngine) {
  ...
  public KeywordTask status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public KeywordTask taskId(String taskId) {
    this.taskId = taskId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    KeywordTask keywordTask = (KeywordTask) o;
    return Objects.equals(this.keyword, keywordTask.keyword) &&
        Objects.equals(this.localizationCode, keywordTask.localizationCode) &&
        Objects.equals(this.localizationZip, keywordTask.localizationZip) &&
        Objects.equals(this.searchEngine, keywordTask.searchEngine) &&
        Objects.equals(this.status, keywordTask.status) &&
        Objects.equals(this.taskId, keywordTask.taskId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, localizationCode, localizationZip, searchEngine, status, taskId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeywordTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordTask is not found in the empty JSON string", KeywordTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KeywordTask.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordTask.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordTask>() {
           @Override
           public void write(JsonWriter out, KeywordTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeywordTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KeywordTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeywordTask
   * @throws IOException if the JSON string is invalid with respect to KeywordTask
   */
  public static KeywordTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordTask.class);
  }

  /**
   * Convert an instance of KeywordTask to an JSON string
   *
   * @return JSON string
   */
