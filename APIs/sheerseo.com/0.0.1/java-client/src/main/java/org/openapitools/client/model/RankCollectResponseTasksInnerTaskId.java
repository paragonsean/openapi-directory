...
public class RankCollectResponseTasksInnerTaskId {
  ...
  public static final String SERIALIZED_NAME_LOCAL_PACK_RANK = "local_pack_rank";
  @SerializedName(SERIALIZED_NAME_LOCAL_PACK_RANK)
  private Integer localPackRank;
  ...
  public RankCollectResponseTasksInnerTaskId() {
  }

  public RankCollectResponseTasksInnerTaskId errorMessage(String errorMessage) {
  ...
  public RankCollectResponseTasksInnerTaskId keyword(String keyword) {
  ...
  public RankCollectResponseTasksInnerTaskId localPackRank(Integer localPackRank) {
    this.localPackRank = localPackRank;
    return this;
  }

  /**
   * relevent only to google: show the local pack rank of the domain in case exist
   * @return localPackRank
   */
  @javax.annotation.Nullable
  public Integer getLocalPackRank() {
    return localPackRank;
  }

  public void setLocalPackRank(Integer localPackRank) {
    this.localPackRank = localPackRank;
  }


  public RankCollectResponseTasksInnerTaskId localizationCode(LocalizationCodeEnum localizationCode) {
  ...
  public RankCollectResponseTasksInnerTaskId localizationZip(String localizationZip) {
  ...
  public RankCollectResponseTasksInnerTaskId rank(Integer rank) {
    this.rank = rank;
    return this;
  }
  ...
  public RankCollectResponseTasksInnerTaskId ready(ReadyEnum ready) {
    this.ready = ready;
    return this;
  }
  ...
  public RankCollectResponseTasksInnerTaskId searchEngine(SearchEngineEnum searchEngine) {
  ...
  public RankCollectResponseTasksInnerTaskId status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RankCollectResponseTasksInnerTaskId rankCollectResponseTasksInnerTaskId = (RankCollectResponseTasksInnerTaskId) o;
    return Objects.equals(this.errorMessage, rankCollectResponseTasksInnerTaskId.errorMessage) &&
        Objects.equals(this.keyword, rankCollectResponseTasksInnerTaskId.keyword) &&
        Objects.equals(this.localPackRank, rankCollectResponseTasksInnerTaskId.localPackRank) &&
        Objects.equals(this.localizationCode, rankCollectResponseTasksInnerTaskId.localizationCode) &&
        Objects.equals(this.localizationZip, rankCollectResponseTasksInnerTaskId.localizationZip) &&
        Objects.equals(this.rank, rankCollectResponseTasksInnerTaskId.rank) &&
        Objects.equals(this.ready, rankCollectResponseTasksInnerTaskId.ready) &&
        Objects.equals(this.searchEngine, rankCollectResponseTasksInnerTaskId.searchEngine) &&
        Objects.equals(this.status, rankCollectResponseTasksInnerTaskId.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorMessage, keyword, localPackRank, localizationCode, localizationZip, rank, ready, searchEngine, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RankCollectResponseTasksInnerTaskId {\n");
    sb.append("    errorMessage: ").append(toIndentedString(errorMessage)).append("\n");
    sb.append("    keyword: ").append(toIndentedString(keyword)).append("\n");
    sb.append("    localPackRank: ").append(toIndentedString(localPackRank)).append("\n");
  ...
  static {
    ...
    openapiFields.add("local_pack_rank");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RankCollectResponseTasksInnerTaskId
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RankCollectResponseTasksInnerTaskId.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RankCollectResponseTasksInnerTaskId is not found in the empty JSON string", RankCollectResponseTasksInnerTaskId.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RankCollectResponseTasksInnerTaskId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RankCollectResponseTasksInnerTaskId` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RankCollectResponseTasksInnerTaskId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RankCollectResponseTasksInnerTaskId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RankCollectResponseTasksInnerTaskId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RankCollectResponseTasksInnerTaskId.class));

       return (TypeAdapter<T>) new TypeAdapter<RankCollectResponseTasksInnerTaskId>() {
           @Override
           public void write(JsonWriter out, RankCollectResponseTasksInnerTaskId value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RankCollectResponseTasksInnerTaskId read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RankCollectResponseTasksInnerTaskId given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RankCollectResponseTasksInnerTaskId
   * @throws IOException if the JSON string is invalid with respect to RankCollectResponseTasksInnerTaskId
   */
  public static RankCollectResponseTasksInnerTaskId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RankCollectResponseTasksInnerTaskId.class);
  }

  /**
   * Convert an instance of RankCollectResponseTasksInnerTaskId to an JSON string
   *
   * @return JSON string
   */
