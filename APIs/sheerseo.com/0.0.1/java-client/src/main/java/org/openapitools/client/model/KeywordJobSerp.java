...
public class KeywordJobSerp {
  ...
  public KeywordJobSerp() {
  }

  public KeywordJobSerp keyword(String keyword) {
  ...
  public KeywordJobSerp localizationCode(LocalizationCodeEnum localizationCode) {
  ...
  public KeywordJobSerp localizationZip(String localizationZip) {
  ...
  public KeywordJobSerp searchEngine(SearchEngineEnum searchEngine) {
  ...
  public boolean equals(Object o) {
    ...
    KeywordJobSerp keywordJobSerp = (KeywordJobSerp) o;
    return Objects.equals(this.keyword, keywordJobSerp.keyword) &&
        Objects.equals(this.localizationCode, keywordJobSerp.localizationCode) &&
        Objects.equals(this.localizationZip, keywordJobSerp.localizationZip) &&
        Objects.equals(this.searchEngine, keywordJobSerp.searchEngine);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, localizationCode, localizationZip, searchEngine);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeywordJobSerp {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to KeywordJobSerp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KeywordJobSerp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeywordJobSerp is not found in the empty JSON string", KeywordJobSerp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KeywordJobSerp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KeywordJobSerp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KeywordJobSerp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeywordJobSerp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeywordJobSerp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeywordJobSerp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeywordJobSerp.class));

       return (TypeAdapter<T>) new TypeAdapter<KeywordJobSerp>() {
           @Override
           public void write(JsonWriter out, KeywordJobSerp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KeywordJobSerp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KeywordJobSerp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KeywordJobSerp
   * @throws IOException if the JSON string is invalid with respect to KeywordJobSerp
   */
  public static KeywordJobSerp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeywordJobSerp.class);
  }

  /**
   * Convert an instance of KeywordJobSerp to an JSON string
   *
   * @return JSON string
   */
