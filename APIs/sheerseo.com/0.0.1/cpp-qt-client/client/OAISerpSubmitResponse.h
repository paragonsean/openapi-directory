...
/*
 * OAISerpSubmitResponse.h
 *
 * Describes the result of uploading an image resource
 */

#ifndef OAISerpSubmitResponse_H
#define OAISerpSubmitResponse_H
...
class OAISerpSubmitResponse : public OAIObject {
public:
    OAISerpSubmitResponse();
    OAISerpSubmitResponse(QString json);
    ~OAISerpSubmitResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISerpSubmitResponse)

#endif // OAISerpSubmitResponse_H
