...
#ifndef OAIKeywordJobSerp_H
#define OAIKeywordJobSerp_H
...
class OAIKeywordJobSerp : public OAIObject {
public:
    OAIKeywordJobSerp();
    OAIKeywordJobSerp(QString json);
    ~OAIKeywordJobSerp() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeywordJobSerp)

#endif // OAIKeywordJobSerp_H
