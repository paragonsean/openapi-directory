...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.RankSubmitRequest();
  });
  ...
  describe('RankSubmitRequest', function() {
    it('should create an instance of RankSubmitRequest', function() {
      // uncomment below and update the code to test RankSubmitRequest
      //var instance = new SheerSeoApi.RankSubmitRequest();
      //expect(instance).to.be.a(SheerSeoApi.RankSubmitRequest);
    });
