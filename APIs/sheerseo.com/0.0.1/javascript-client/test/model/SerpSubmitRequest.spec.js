...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.SerpSubmitRequest();
  });
  ...
  describe('SerpSubmitRequest', function() {
    it('should create an instance of SerpSubmitRequest', function() {
      // uncomment below and update the code to test SerpSubmitRequest
      //var instance = new SheerSeoApi.SerpSubmitRequest();
      //expect(instance).to.be.a(SheerSeoApi.SerpSubmitRequest);
    });
