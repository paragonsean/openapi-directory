...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.SerpSubmitResponse();
  });
  ...
  describe('SerpSubmitResponse', function() {
    it('should create an instance of SerpSubmitResponse', function() {
      // uncomment below and update the code to test SerpSubmitResponse
      //var instance = new SheerSeoApi.SerpSubmitResponse();
      //expect(instance).to.be.a(SheerSeoApi.SerpSubmitResponse);
    });
