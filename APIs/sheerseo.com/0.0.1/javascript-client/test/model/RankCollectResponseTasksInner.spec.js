...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.RankCollectResponseTasksInner();
  });
  ...
  describe('RankCollectResponseTasksInner', function() {
    it('should create an instance of RankCollectResponseTasksInner', function() {
      // uncomment below and update the code to test RankCollectResponseTasksInner
      //var instance = new SheerSeoApi.RankCollectResponseTasksInner();
      //expect(instance).to.be.a(SheerSeoApi.RankCollectResponseTasksInner);
    });
