...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.SerpCollectResponseTasksInner();
  });
  ...
  describe('SerpCollectResponseTasksInner', function() {
    it('should create an instance of SerpCollectResponseTasksInner', function() {
      // uncomment below and update the code to test SerpCollectResponseTasksInner
      //var instance = new SheerSeoApi.SerpCollectResponseTasksInner();
      //expect(instance).to.be.a(SheerSeoApi.SerpCollectResponseTasksInner);
    });
