...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.RankCollectResponse();
  });
  ...
  describe('RankCollectResponse', function() {
    it('should create an instance of RankCollectResponse', function() {
      // uncomment below and update the code to test RankCollectResponse
      //var instance = new SheerSeoApi.RankCollectResponse();
      //expect(instance).to.be.a(SheerSeoApi.RankCollectResponse);
    });
