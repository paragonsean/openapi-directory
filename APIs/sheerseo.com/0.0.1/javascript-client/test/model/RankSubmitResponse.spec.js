...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SheerSeoApi.RankSubmitResponse();
  });
  ...
  describe('RankSubmitResponse', function() {
    it('should create an instance of RankSubmitResponse', function() {
      // uncomment below and update the code to test RankSubmitResponse
      //var instance = new SheerSeoApi.RankSubmitResponse();
      //expect(instance).to.be.a(SheerSeoApi.RankSubmitResponse);
    });
