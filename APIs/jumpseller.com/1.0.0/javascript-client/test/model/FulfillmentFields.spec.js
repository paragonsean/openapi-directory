...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.FulfillmentFields();
  });
  ...
  describe('FulfillmentFields', function() {
    it('should create an instance of FulfillmentFields', function() {
      // uncomment below and update the code to test FulfillmentFields
      //var instance = new JumpsellerApi.FulfillmentFields();
      //expect(instance).to.be.a(JumpsellerApi.FulfillmentFields);
    });
