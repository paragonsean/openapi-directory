...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.ProductEditFields();
  });
  ...
  describe('ProductEditFields', function() {
    it('should create an instance of ProductEditFields', function() {
      // uncomment below and update the code to test ProductEditFields
      //var instance = new JumpsellerApi.ProductEditFields();
      //expect(instance).to.be.a(JumpsellerApi.ProductEditFields);
    });
    ...
    it('should have the property packageFormat (base name: "package_format")', function() {
      // uncomment below and update the code to test the property packageFormat
      //var instance = new JumpsellerApi.ProductEditFields();
      //expect(instance).to.be();
    });
    ...
    it('should have the property stockUnlimited (base name: "stock_unlimited")', function() {
      // uncomment below and update the code to test the property stockUnlimited
      //var instance = new JumpsellerApi.ProductEditFields();
      //expect(instance).to.be();
    });
