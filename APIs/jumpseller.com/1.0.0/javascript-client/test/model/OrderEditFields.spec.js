...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.OrderEditFields();
  });
  ...
  describe('OrderEditFields', function() {
    it('should create an instance of OrderEditFields', function() {
      // uncomment below and update the code to test OrderEditFields
      //var instance = new JumpsellerApi.OrderEditFields();
      //expect(instance).to.be.a(JumpsellerApi.OrderEditFields);
    });
