...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.PageFields();
  });
  ...
  describe('PageFields', function() {
    it('should create an instance of PageFields', function() {
      // uncomment below and update the code to test PageFields
      //var instance = new JumpsellerApi.PageFields();
      //expect(instance).to.be.a(JumpsellerApi.PageFields);
    });
