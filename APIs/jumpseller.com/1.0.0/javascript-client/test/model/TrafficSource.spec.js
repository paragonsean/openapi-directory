...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.TrafficSource();
  });
  ...
  describe('TrafficSource', function() {
    it('should create an instance of TrafficSource', function() {
      // uncomment below and update the code to test TrafficSource
      //var instance = new JumpsellerApi.TrafficSource();
      //expect(instance).to.be.a(JumpsellerApi.TrafficSource);
    });
    ...
    it('should have the property firstPageVisited (base name: "first_page_visited")', function() {
      // uncomment below and update the code to test the property firstPageVisited
      //var instance = new JumpsellerApi.TrafficSource();
      //expect(instance).to.be();
    });

    it('should have the property firstPageVisitedAt (base name: "first_page_visited_at")', function() {
      // uncomment below and update the code to test the property firstPageVisitedAt
      //var instance = new JumpsellerApi.TrafficSource();
      //expect(instance).to.be();
    });
