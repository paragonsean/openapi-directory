...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.OrdersData();
  });
  ...
  describe('OrdersData', function() {
    it('should create an instance of OrdersData', function() {
      // uncomment below and update the code to test OrdersData
      //var instance = new JumpsellerApi.OrdersData();
      //expect(instance).to.be.a(JumpsellerApi.OrdersData);
    });
