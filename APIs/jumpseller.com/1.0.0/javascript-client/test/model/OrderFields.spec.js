...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.OrderFields();
  });
  ...
  describe('OrderFields', function() {
    it('should create an instance of OrderFields', function() {
      // uncomment below and update the code to test OrderFields
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be.a(JumpsellerApi.OrderFields);
    });
    ...
    it('should have the property duplicateUrl (base name: "duplicate_url")', function() {
      // uncomment below and update the code to test the property duplicateUrl
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });

    it('should have the property externalShippingRateId (base name: "external_shipping_rate_id")', function() {
      // uncomment below and update the code to test the property externalShippingRateId
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });
    ...
    it('should have the property paymentMethodName (base name: "payment_method_name")', function() {
      // uncomment below and update the code to test the property paymentMethodName
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });
    ...
    it('should have the property recoveryUrl (base name: "recovery_url")', function() {
      // uncomment below and update the code to test the property recoveryUrl
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });
    ...
    it('should have the property shippingDiscount (base name: "shipping_discount")', function() {
      // uncomment below and update the code to test the property shippingDiscount
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });

    it('should have the property shippingMethodId (base name: "shipping_method_id")', function() {
      // uncomment below and update the code to test the property shippingMethodId
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });

    it('should have the property shippingMethodName (base name: "shipping_method_name")', function() {
      // uncomment below and update the code to test the property shippingMethodName
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });

    it('should have the property shippingOption (base name: "shipping_option")', function() {
      // uncomment below and update the code to test the property shippingOption
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });

    it('should have the property shippingRequired (base name: "shipping_required")', function() {
      // uncomment below and update the code to test the property shippingRequired
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });
    ...
    it('should have the property shippingTaxes (base name: "shipping_taxes")', function() {
      // uncomment below and update the code to test the property shippingTaxes
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });
    ...
    it('should have the property trackingCompany (base name: "tracking_company")', function() {
      // uncomment below and update the code to test the property trackingCompany
      //var instance = new JumpsellerApi.OrderFields();
      //expect(instance).to.be();
    });
