...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.ProductFields();
  });
  ...
  describe('ProductFields', function() {
    it('should create an instance of ProductFields', function() {
      // uncomment below and update the code to test ProductFields
      //var instance = new JumpsellerApi.ProductFields();
      //expect(instance).to.be.a(JumpsellerApi.ProductFields);
    });
