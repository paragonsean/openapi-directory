...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.TaxEditFields();
  });
  ...
  describe('TaxEditFields', function() {
    it('should create an instance of TaxEditFields', function() {
      // uncomment below and update the code to test TaxEditFields
      //var instance = new JumpsellerApi.TaxEditFields();
      //expect(instance).to.be.a(JumpsellerApi.TaxEditFields);
    });
