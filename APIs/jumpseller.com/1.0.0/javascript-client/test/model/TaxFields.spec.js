...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.TaxFields();
  });
  ...
  describe('TaxFields', function() {
    it('should create an instance of TaxFields', function() {
      // uncomment below and update the code to test TaxFields
      //var instance = new JumpsellerApi.TaxFields();
      //expect(instance).to.be.a(JumpsellerApi.TaxFields);
    });
