...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.PageModifyFields();
  });
  ...
  describe('PageModifyFields', function() {
    it('should create an instance of PageModifyFields', function() {
      // uncomment below and update the code to test PageModifyFields
      //var instance = new JumpsellerApi.PageModifyFields();
      //expect(instance).to.be.a(JumpsellerApi.PageModifyFields);
    });
