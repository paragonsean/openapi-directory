...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JumpsellerApi.OrderBillingAddress();
  });
  ...
  describe('OrderBillingAddress', function() {
    it('should create an instance of OrderBillingAddress', function() {
      // uncomment below and update the code to test OrderBillingAddress
      //var instance = new JumpsellerApi.OrderBillingAddress();
      //expect(instance).to.be.a(JumpsellerApi.OrderBillingAddress);
    });
