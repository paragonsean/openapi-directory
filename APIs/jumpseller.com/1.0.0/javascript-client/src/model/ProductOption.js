...
class ProductOption {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('option')) {
                obj['option'] = ProductOptionFields.constructFromObject(data['option']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['option']) { // data not null
          ProductOptionFields.validateJSON(data['option']);
        }
...
/**
 * @member {module:model/ProductOptionFields} option
 */
ProductOption.prototype['option'] = undefined;
