...
class OrderBillingAddress {
    ...
    constructor() { 
        ...
        OrderBillingAddress.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderBillingAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderBillingAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderBillingAddress</code>.
     */
