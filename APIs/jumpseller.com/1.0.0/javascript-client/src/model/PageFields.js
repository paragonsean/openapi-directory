...
/**
 * The PageFields model module.
 * @module model/PageFields
 * @version 1.0.0
 */
class PageFields {
    /**
     * Constructs a new <code>PageFields</code>.
     * @alias module:model/PageFields
     */
    constructor() { 
        
        PageFields.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PageFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PageFields} obj Optional instance to populate.
     * @return {module:model/PageFields} The populated <code>PageFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PageFields();
            ...
            if (data.hasOwnProperty('template')) {
                obj['template'] = PageTemplate.constructFromObject(data['template']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PageFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PageFields</code>.
     */
    static validateJSON(data) {
        ...
        if (data['template']) { // data not null
          PageTemplate.validateJSON(data['template']);
        }
        // ensure the json data is a string
 ...
 * @member {String} body
 */
PageFields.prototype['body'] = undefined;

/**
 * Page categories to which the Page belongs to
 * @member {Array.<module:model/PageCategory>} categories
 */
PageFields.prototype['categories'] = undefined;

/**
 * Id of the Page
 * @member {Number} id
 */
PageFields.prototype['id'] = undefined;

/**
 * @member {module:model/PageFieldsImage} image
 */
PageFields.prototype['image'] = undefined;

/**
 * True if it is a legal page
 * @member {Boolean} legal
 */
PageFields.prototype['legal'] = undefined;

/**
 * Meta description of the Page
 * @member {String} meta_description
 */
PageFields.prototype['meta_description'] = undefined;

/**
 * Meta title of the Page
 * @member {String} page_title
 */
PageFields.prototype['page_title'] = undefined;

/**
 * URL of the Page
 * @member {String} permalink
 */
PageFields.prototype['permalink'] = undefined;

/**
 * Status of the Page
 * @member {module:model/PageFields.StatusEnum} status
 */
PageFields.prototype['status'] = undefined;

/**
 * @member {module:model/PageTemplate} template
 */
PageFields.prototype['template'] = undefined;

/**
 * Title of the Page
 * @member {String} title
 */
PageFields.prototype['title'] = undefined;
