...
class Type {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('stats')) {
                obj['stats'] = StoreStats.constructFromObject(data['stats']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['stats']) { // data not null
          StoreStats.validateJSON(data['stats']);
        }
...
/**
 * @member {module:model/StoreStats} stats
 */
Type.prototype['stats'] = undefined;
