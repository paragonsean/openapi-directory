...
class OrderCreate {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('order')) {
                obj['order'] = OrderCreateFields.constructFromObject(data['order']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['order']) { // data not null
          OrderCreateFields.validateJSON(data['order']);
        }
...
/**
 * @member {module:model/OrderCreateFields} order
 */
OrderCreate.prototype['order'] = undefined;
