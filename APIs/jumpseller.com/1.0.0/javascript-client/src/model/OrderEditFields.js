...
/**
 * The OrderEditFields model module.
 * @module model/OrderEditFields
 * @version 1.0.0
 */
class OrderEditFields {
    /**
     * Constructs a new <code>OrderEditFields</code>.
     * @alias module:model/OrderEditFields
     */
    constructor() { 
        
        OrderEditFields.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderEditFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderEditFields} obj Optional instance to populate.
     * @return {module:model/OrderEditFields} The populated <code>OrderEditFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderEditFields();
    ...
    /**
     * Validates the JSON data with respect to <code>OrderEditFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderEditFields</code>.
     */
 ...
 */
OrderEditFields.prototype['additional_fields'] = undefined;

/**
 * Additional information for the given Order
 * @member {String} additional_information
 */
OrderEditFields.prototype['additional_information'] = undefined;

/**
 * Status of the Order Shipping
 * @member {module:model/OrderEditFields.ShipmentStatusEnum} shipment_status
 */
OrderEditFields.prototype['shipment_status'] = undefined;

/**
 * Status of the Order
 * @member {module:model/OrderEditFields.StatusEnum} status
 */
OrderEditFields.prototype['status'] = undefined;

/**
 * Shipping Company used for the given Order
 * @member {String} tracking_company
 */
OrderEditFields.prototype['tracking_company'] = undefined;

/**
 * Shipping Tracking Number used for the given Order
 * @member {String} tracking_number
 */
OrderEditFields.prototype['tracking_number'] = undefined;

/**
 * URL to check delivery information for the given Order
 * @member {String} tracking_url
 */
OrderEditFields.prototype['tracking_url'] = undefined;
 ...
 * @readonly
 */
OrderEditFields['ShipmentStatusEnum'] = {
...
export default OrderEditFields;
