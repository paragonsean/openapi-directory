...
/**
 * The FulfillmentEditFields model module.
 * @module model/FulfillmentEditFields
 * @version 1.0.0
 */
class FulfillmentEditFields {
    /**
     * Constructs a new <code>FulfillmentEditFields</code>.
     * @alias module:model/FulfillmentEditFields
     */
    constructor() { 
        
        FulfillmentEditFields.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FulfillmentEditFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FulfillmentEditFields} obj Optional instance to populate.
     * @return {module:model/FulfillmentEditFields} The populated <code>FulfillmentEditFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FulfillmentEditFields();
    ...
    /**
     * Validates the JSON data with respect to <code>FulfillmentEditFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FulfillmentEditFields</code>.
     */
 ...
 */
FulfillmentEditFields.prototype['expected_arrival_from'] = undefined;

/**
 * Last date expected for the fulfillment to arrive at customer place
 * @member {String} expected_arrival_to
 */
FulfillmentEditFields.prototype['expected_arrival_to'] = undefined;

/**
 * Unique identifier of the Fulfillment used by the tracking company
 * @member {String} external_id
 */
FulfillmentEditFields.prototype['external_id'] = undefined;

/**
 * Order associated with the fulfillment
 * @member {String} order_id
 */
FulfillmentEditFields.prototype['order_id'] = undefined;

/**
 * Type of Service requested to the tracking company
 * @member {String} service_type
 */
FulfillmentEditFields.prototype['service_type'] = undefined;

/**
 * Status of the Fulfillment
 * @member {module:model/FulfillmentEditFields.ShipmentStatusEnum} shipment_status
 */
FulfillmentEditFields.prototype['shipment_status'] = undefined;

/**
 * Tracking company responsible for the fulfillment
 * @member {String} tracking_company
 */
FulfillmentEditFields.prototype['tracking_company'] = undefined;

/**
 * Tracking Number associated with the fulfillment
 * @member {String} tracking_number
 */
FulfillmentEditFields.prototype['tracking_number'] = undefined;

/**
 * Type of fulfillment Service used
 * @member {module:model/FulfillmentEditFields.TypeEnum} type
 */
FulfillmentEditFields.prototype['type'] = undefined;
 ...
 * @readonly
 */
FulfillmentEditFields['ShipmentStatusEnum'] = {
 ...
 * @readonly
 */
FulfillmentEditFields['TypeEnum'] = {
...
export default FulfillmentEditFields;
