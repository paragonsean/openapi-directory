...
class ShippingAddress {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['municipality'] && !(typeof data['municipality'] === 'string' || data['municipality'] instanceof String)) {
            throw new Error("Expected the field `municipality` to be a primitive type in the JSON string but got " + data['municipality']);
        }
        // ensure the json data is a string
 ...
 */
ShippingAddress.prototype['address'] = undefined;
 ...
 */
ShippingAddress.prototype['municipality'] = undefined;
