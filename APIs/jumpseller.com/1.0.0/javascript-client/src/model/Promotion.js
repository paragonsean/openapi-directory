...
class Promotion {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('promotion')) {
                obj['promotion'] = PromotionFields.constructFromObject(data['promotion']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['promotion']) { // data not null
          PromotionFields.validateJSON(data['promotion']);
        }
...
/**
 * @member {module:model/PromotionFields} promotion
 */
Promotion.prototype['promotion'] = undefined;
