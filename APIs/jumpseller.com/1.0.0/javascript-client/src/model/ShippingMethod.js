...
class ShippingMethod {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('shipping_method')) {
                obj['shipping_method'] = ShippingMethodFields.constructFromObject(data['shipping_method']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['shipping_method']) { // data not null
          ShippingMethodFields.validateJSON(data['shipping_method']);
        }
...
/**
 * @member {module:model/ShippingMethodFields} shipping_method
 */
ShippingMethod.prototype['shipping_method'] = undefined;
