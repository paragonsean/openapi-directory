...
class Fulfillment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('category')) {
                obj['category'] = FulfillmentFields.constructFromObject(data['category']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['category']) { // data not null
          FulfillmentFields.validateJSON(data['category']);
        }
...
/**
 * @member {module:model/FulfillmentFields} category
 */
Fulfillment.prototype['category'] = undefined;
