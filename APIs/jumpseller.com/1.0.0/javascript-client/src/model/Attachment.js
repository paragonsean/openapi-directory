...
class Attachment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attachment')) {
                obj['attachment'] = AttachmentFields.constructFromObject(data['attachment']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['attachment']) { // data not null
          AttachmentFields.validateJSON(data['attachment']);
        }
...
/**
 * @member {module:model/AttachmentFields} attachment
 */
