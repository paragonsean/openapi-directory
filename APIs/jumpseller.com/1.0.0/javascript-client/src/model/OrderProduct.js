    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('taxes')) {
                obj['taxes'] = ApiClient.convertToType(data['taxes'], [OrderProductTax]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['taxes']) { // data not null
            ...
            for (const item of data['taxes']) {
                OrderProductTax.validateJSON(item);
            };
        }
 ...
 */
OrderProduct.prototype['discount'] = undefined;
 ...
 * @member {String} image
 */
OrderProduct.prototype['image'] = undefined;

/**
 * Name of the Order Product
 * @member {String} name
 */
OrderProduct.prototype['name'] = undefined;

/**
 * Price of the Order Product
 * @member {Number} price
 */
OrderProduct.prototype['price'] = undefined;

/**
 * Price of the Order Product
 * @member {Number} qty
 */
OrderProduct.prototype['qty'] = undefined;

/**
 * Stock Keeping Unit of the Order Product
 * @member {String} sku
 */
OrderProduct.prototype['sku'] = undefined;

/**
 * @member {Array.<module:model/OrderProductTax>} taxes
 */
OrderProduct.prototype['taxes'] = undefined;

/**
 * Unique identifier of the original Product Variant
 * @member {Number} variant_id
 */
OrderProduct.prototype['variant_id'] = undefined;
 ...
 * @default 1
 */
OrderProduct.prototype['weight'] = 1;
