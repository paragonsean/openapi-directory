...
class PaymentMethod {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payment_method')) {
                obj['payment_method'] = PaymentMethodFields.constructFromObject(data['payment_method']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['payment_method']) { // data not null
          PaymentMethodFields.validateJSON(data['payment_method']);
        }
...
/**
 * @member {module:model/PaymentMethodFields} payment_method
 */
PaymentMethod.prototype['payment_method'] = undefined;
