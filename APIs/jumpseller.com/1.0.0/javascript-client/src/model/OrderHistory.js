...
class OrderHistory {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('order_history')) {
                obj['order_history'] = OrderHistoryFields.constructFromObject(data['order_history']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        // validate the optional field `order_history`
        if (data['order_history']) { // data not null
          OrderHistoryFields.validateJSON(data['order_history']);
        }
...
/**
 * @member {module:model/OrderHistoryFields} order_history
 */
OrderHistory.prototype['order_history'] = undefined;
