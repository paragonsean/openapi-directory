...
class CustomField {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('custom_field')) {
                obj['custom_field'] = CustomFieldFields.constructFromObject(data['custom_field']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['custom_field']) { // data not null
          CustomFieldFields.validateJSON(data['custom_field']);
        }
...
/**
 * @member {module:model/CustomFieldFields} custom_field
 */
CustomField.prototype['custom_field'] = undefined;
