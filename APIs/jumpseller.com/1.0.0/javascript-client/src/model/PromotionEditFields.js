...
/**
 * The PromotionEditFields model module.
 * @module model/PromotionEditFields
 * @version 1.0.0
 */
class PromotionEditFields {
    /**
     * Constructs a new <code>PromotionEditFields</code>.
     * @alias module:model/PromotionEditFields
     */
    constructor() { 
        
        PromotionEditFields.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromotionEditFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromotionEditFields} obj Optional instance to populate.
     * @return {module:model/PromotionEditFields} The populated <code>PromotionEditFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromotionEditFields();

            if (data.hasOwnProperty('begins_at')) {
                obj['begins_at'] = ApiClient.convertToType(data['begins_at'], 'String');
            }
            if (data.hasOwnProperty('buys_at_least')) {
                obj['buys_at_least'] = ApiClient.convertToType(data['buys_at_least'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PromotionEditFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromotionEditFields</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['buys_at_least'] && !(typeof data['buys_at_least'] === 'string' || data['buys_at_least'] instanceof String)) {
            throw new Error("Expected the field `buys_at_least` to be a primitive type in the JSON string but got " + data['buys_at_least']);
        }
        ...
        // ensure the json data is a string
        if (data['customers'] && !(typeof data['customers'] === 'string' || data['customers'] instanceof String)) {
            throw new Error("Expected the field `customers` to be a primitive type in the JSON string but got " + data['customers']);
        }
        // ensure the json data is a string
 ...
 */
PromotionEditFields.prototype['begins_at'] = undefined;

/**
 * Controls the promotion's condition ('none', 'price', 'qty')
 * @member {String} buys_at_least
 */
PromotionEditFields.prototype['buys_at_least'] = undefined;
 ...
 * @default false
 */
PromotionEditFields.prototype['cumulative'] = false;
 ...
 * @default true
 */
PromotionEditFields.prototype['enabled'] = true;

/**
 * Expiration date of the promotion (requires 'lasts' param - 'date')
 * @member {String} expires_at
 */
PromotionEditFields.prototype['expires_at'] = undefined;

/**
 * Controls when the promotion will expire ('none', 'date', 'max_times_used')
 * @member {String} lasts
 */
PromotionEditFields.prototype['lasts'] = undefined;

/**
 * Maximum amount a promotion can be used (requires 'lasts' param - 'max_times_used')
 * @member {Number} max_times_used
 */
PromotionEditFields.prototype['max_times_used'] = undefined;

/**
 * Name of the product
 * @member {String} name
 */
PromotionEditFields.prototype['name'] = undefined;
 ...
 */
PromotionEditFields.prototype['products'] = undefined;
 ...
 */
PromotionEditFields.prototype['products_x'] = undefined;
 ...
 */
PromotionEditFields.prototype['quantity_x'] = undefined;

/**
 * Controls if the discount will be a fixed area ('fix', 'percentage')
 * @member {String} type
 */
PromotionEditFields.prototype['type'] = undefined;
...
export default PromotionEditFields;
