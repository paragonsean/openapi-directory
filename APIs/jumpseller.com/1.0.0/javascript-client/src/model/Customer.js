...
class Customer {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('customer')) {
                obj['customer'] = CustomerFields.constructFromObject(data['customer']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['customer']) { // data not null
          CustomerFields.validateJSON(data['customer']);
        }
...
/**
 * @member {module:model/CustomerFields} customer
 */
Customer.prototype['customer'] = undefined;
