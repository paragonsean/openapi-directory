...
class Variant {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('variant')) {
                obj['variant'] = VariantFields.constructFromObject(data['variant']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['variant']) { // data not null
          VariantFields.validateJSON(data['variant']);
        }
...
/**
 * @member {module:model/VariantFields} variant
 */
Variant.prototype['variant'] = undefined;
