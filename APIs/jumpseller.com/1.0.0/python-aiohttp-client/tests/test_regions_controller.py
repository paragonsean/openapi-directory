...
async def test_countries_country_code_regions_json_get_0(client):
    """Test case for countries_country_code_regions_json_get_0
...
async def test_countries_country_code_regions_region_code_json_get_0(client):
    """Test case for countries_country_code_regions_region_code_json_get_0
