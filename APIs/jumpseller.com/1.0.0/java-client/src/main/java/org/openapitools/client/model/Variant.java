...
public class Variant {
  ...
  private VariantFields variant;

  public Variant() {
  }

  public Variant variant(VariantFields variant) {
  ...
  public VariantFields getVariant() {
    return variant;
  }

  public void setVariant(VariantFields variant) {
    this.variant = variant;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.variant, variant.variant);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("variant") != null && !jsonObj.get("variant").isJsonNull()) {
        VariantFields.validateJsonElement(jsonObj.get("variant"));
      }
  }
