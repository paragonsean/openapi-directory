...
import org.openapitools.client.model.ProductOptionFields;
...
public class ProductOption {
  ...
  private ProductOptionFields option;

  public ProductOption() {
  }

  public ProductOption option(ProductOptionFields option) {
    this.option = option;
    return this;
  }
  ...
  public ProductOptionFields getOption() {
    return option;
  }

  public void setOption(ProductOptionFields option) {
    this.option = option;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.option, productOption.option);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("option") != null && !jsonObj.get("option").isJsonNull()) {
        ProductOptionFields.validateJsonElement(jsonObj.get("option"));
      }
  }
