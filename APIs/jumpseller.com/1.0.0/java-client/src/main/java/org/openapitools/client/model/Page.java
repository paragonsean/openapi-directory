...
import org.openapitools.client.model.PageFields;
...
public class Page {
  ...
  private PageFields page;

  public Page() {
  }

  public Page page(PageFields page) {
    this.page = page;
    return this;
  }
  ...
  public PageFields getPage() {
    return page;
  }

  public void setPage(PageFields page) {
    this.page = page;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("page") != null && !jsonObj.get("page").isJsonNull()) {
        PageFields.validateJsonElement(jsonObj.get("page"));
      }
  }
