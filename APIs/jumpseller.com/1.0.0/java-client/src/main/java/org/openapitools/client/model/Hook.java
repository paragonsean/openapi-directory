...
import org.openapitools.client.model.HookFields;
...
public class Hook {
  ...
  private HookFields hook;

  public Hook() {
  }

  public Hook hook(HookFields hook) {
    this.hook = hook;
    return this;
  }
  ...
  public HookFields getHook() {
    return hook;
  }

  public void setHook(HookFields hook) {
    this.hook = hook;
  }
  ...
  public boolean equals(Object o) {
    ...
    Hook hook = (Hook) o;
    return Objects.equals(this.hook, hook.hook);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("hook") != null && !jsonObj.get("hook").isJsonNull()) {
        HookFields.validateJsonElement(jsonObj.get("hook"));
      }
  }
