...
public class App {
  ...
  private List<AppFields> apps = new ArrayList<>();

  public App() {
  }

  public App apps(List<AppFields> apps) {
    this.apps = apps;
    return this;
  }

  public App addAppsItem(AppFields appsItem) {
    if (this.apps == null) {
  ...
  public List<AppFields> getApps() {
    return apps;
  }

  public void setApps(List<AppFields> apps) {
    this.apps = apps;
  }
  ...
  public boolean equals(Object o) {
    ...
    App app = (App) o;
    return Objects.equals(this.apps, app.apps);
  }
      ...
      if (jsonObj.get("apps") != null && !jsonObj.get("apps").isJsonNull()) {
        ...
        if (jsonArrayapps != null) {
          ...
          for (int i = 0; i < jsonArrayapps.size(); i++) {
            AppFields.validateJsonElement(jsonArrayapps.get(i));
          };
        }
      }
  }
