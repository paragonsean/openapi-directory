...
import org.openapitools.client.model.OrderHistoryFields;
...
public class OrderHistory {
  ...
  private OrderHistoryFields orderHistory;

  public OrderHistory() {
  }

  public OrderHistory orderHistory(OrderHistoryFields orderHistory) {
  ...
  public OrderHistoryFields getOrderHistory() {
    return orderHistory;
  }

  public void setOrderHistory(OrderHistoryFields orderHistory) {
    this.orderHistory = orderHistory;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderHistory, orderHistory.orderHistory);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("order_history") != null && !jsonObj.get("order_history").isJsonNull()) {
        OrderHistoryFields.validateJsonElement(jsonObj.get("order_history"));
      }
  }
