...
public class Fulfillment {
  ...
  private FulfillmentFields category;

  public Fulfillment() {
  }

  public Fulfillment category(FulfillmentFields category) {
  ...
  public FulfillmentFields getCategory() {
    return category;
  }

  public void setCategory(FulfillmentFields category) {
    this.category = category;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, fulfillment.category);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("category") != null && !jsonObj.get("category").isJsonNull()) {
        FulfillmentFields.validateJsonElement(jsonObj.get("category"));
      }
  }
