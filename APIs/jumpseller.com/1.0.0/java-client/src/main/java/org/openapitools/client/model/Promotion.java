...
import org.openapitools.client.model.PromotionFields;
...
public class Promotion {
  ...
  private PromotionFields promotion;

  public Promotion() {
  }

  public Promotion promotion(PromotionFields promotion) {
  ...
  public PromotionFields getPromotion() {
    return promotion;
  }

  public void setPromotion(PromotionFields promotion) {
    this.promotion = promotion;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.promotion, promotion.promotion);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("promotion") != null && !jsonObj.get("promotion").isJsonNull()) {
        PromotionFields.validateJsonElement(jsonObj.get("promotion"));
      }
  }
