...
import org.openapitools.client.model.OrderFields;
...
public class Order {
  ...
  private OrderFields order;

  public Order() {
  }

  public Order order(OrderFields order) {
    this.order = order;
    return this;
  }
  ...
  public void setOrder(OrderFields order) {
    this.order = order;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("order") != null && !jsonObj.get("order").isJsonNull()) {
        OrderFields.validateJsonElement(jsonObj.get("order"));
      }
  }
