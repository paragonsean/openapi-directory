...
public class PaymentMethod {
  ...
  private PaymentMethodFields paymentMethod;

  public PaymentMethod() {
  }

  public PaymentMethod paymentMethod(PaymentMethodFields paymentMethod) {
  ...
  public PaymentMethodFields getPaymentMethod() {
    return paymentMethod;
  }

  public void setPaymentMethod(PaymentMethodFields paymentMethod) {
    this.paymentMethod = paymentMethod;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("payment_method") != null && !jsonObj.get("payment_method").isJsonNull()) {
        PaymentMethodFields.validateJsonElement(jsonObj.get("payment_method"));
      }
  }
