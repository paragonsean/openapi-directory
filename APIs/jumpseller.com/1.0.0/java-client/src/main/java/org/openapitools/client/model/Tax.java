...
import org.openapitools.client.model.TaxFields;
...
public class Tax {
  ...
  private TaxFields tax;

  public Tax() {
  }

  public Tax tax(TaxFields tax) {
    this.tax = tax;
    return this;
  }
  ...
  public TaxFields getTax() {
    return tax;
  }

  public void setTax(TaxFields tax) {
    this.tax = tax;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("tax") != null && !jsonObj.get("tax").isJsonNull()) {
        TaxFields.validateJsonElement(jsonObj.get("tax"));
      }
  }
