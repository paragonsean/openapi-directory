...
import org.openapitools.client.model.StoreStats;
...
public class Type {
  ...
  public Type stats(StoreStats stats) {
    this.stats = stats;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, type.code) &&
        Objects.equals(this.stats, type.stats);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, stats);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        StoreStats.validateJsonElement(jsonObj.get("stats"));
      }
  }
