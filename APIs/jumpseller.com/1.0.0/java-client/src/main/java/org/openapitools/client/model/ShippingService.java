...
public class ShippingService {
  ...
  public ShippingService id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ShippingService serviceCode(String serviceCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, shippingService.id) &&
        Objects.equals(this.name, shippingService.name) &&
        Objects.equals(this.serviceCode, shippingService.serviceCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, serviceCode);
  }
