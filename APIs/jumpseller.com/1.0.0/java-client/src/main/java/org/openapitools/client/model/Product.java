...
import org.openapitools.client.model.ProductFields;
...
public class Product {
  ...
  public Product product(ProductFields product) {
  ...
  public ProductFields getProduct() {
    return product;
  }

  public void setProduct(ProductFields product) {
    this.product = product;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("product") != null && !jsonObj.get("product").isJsonNull()) {
        ProductFields.validateJsonElement(jsonObj.get("product"));
      }
  }
