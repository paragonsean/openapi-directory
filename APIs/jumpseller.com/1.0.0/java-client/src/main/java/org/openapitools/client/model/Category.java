...
public class Category {
  ...
  public Category category(CategoryFields category) {
  ...
  public CategoryFields getCategory() {
    return category;
  }

  public void setCategory(CategoryFields category) {
    this.category = category;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("category") != null && !jsonObj.get("category").isJsonNull()) {
        CategoryFields.validateJsonElement(jsonObj.get("category"));
      }
  }
