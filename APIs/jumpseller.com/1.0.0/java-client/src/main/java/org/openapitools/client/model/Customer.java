...
import org.openapitools.client.model.CustomerFields;
...
public class Customer {
  ...
  public Customer customer(CustomerFields customer) {
  ...
  public CustomerFields getCustomer() {
    return customer;
  }

  public void setCustomer(CustomerFields customer) {
    this.customer = customer;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        CustomerFields.validateJsonElement(jsonObj.get("customer"));
      }
  }
