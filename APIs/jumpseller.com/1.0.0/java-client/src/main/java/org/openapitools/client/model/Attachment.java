...
import org.openapitools.client.model.AttachmentFields;
...
public class Attachment {
  ...
  private AttachmentFields attachment;

  public Attachment() {
  }

  public Attachment attachment(AttachmentFields attachment) {
  ...
  public AttachmentFields getAttachment() {
    return attachment;
  }

  public void setAttachment(AttachmentFields attachment) {
    this.attachment = attachment;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attachment") != null && !jsonObj.get("attachment").isJsonNull()) {
        AttachmentFields.validateJsonElement(jsonObj.get("attachment"));
      }
  }
