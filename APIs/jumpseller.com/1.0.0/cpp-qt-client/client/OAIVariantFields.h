...
#ifndef OAIVariantFields_H
#define OAIVariantFields_H

#include <QJsonObject>

#include "OAIImageFields.h"
#include "OAIProductOptionVariantEdit.h"
#include <QList>
#include <QString>
...
class OAIProductOptionVariantEdit;

class OAIVariantFields : public OAIObject {
public:
    OAIVariantFields();
    OAIVariantFields(QString json);
    ~OAIVariantFields() override;
    ...
    OAIImageFields getImage() const;
    void setImage(const OAIImageFields &image);
    bool is_image_Set() const;
    bool is_image_Valid() const;

    QList<OAIProductOptionVariantEdit> getOptions() const;
    void setOptions(const QList<OAIProductOptionVariantEdit> &options);
...
private:
    ...
    OAIImageFields m_image;
    bool m_image_isSet;
    bool m_image_isValid;

    QList<OAIProductOptionVariantEdit> m_options;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariantFields)

#endif // OAIVariantFields_H
