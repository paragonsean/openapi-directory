...
#ifndef OAITaxEditFields_H
#define OAITaxEditFields_H
...
class OAITaxEditFields : public OAIObject {
public:
    OAITaxEditFields();
    OAITaxEditFields(QString json);
    ~OAITaxEditFields() override;
    ...
    void setShipping(const bool &shipping);
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxEditFields)

#endif // OAITaxEditFields_H
