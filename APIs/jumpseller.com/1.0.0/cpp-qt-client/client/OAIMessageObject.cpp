...
QString OAIMessageObject::getMessage() const {
    return m_message;
}
void OAIMessageObject::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIMessageObject::is_message_Set() const{
    return m_message_isSet;
}

bool OAIMessageObject::is_message_Valid() const{
