...
/*
 * OAICustomerFieldsWithPasswordNoID.h
 *
 * 
 */

#ifndef OAICustomerFieldsWithPasswordNoID_H
#define OAICustomerFieldsWithPasswordNoID_H
...
class OAICustomerFieldsWithPasswordNoID : public OAIObject {
public:
    OAICustomerFieldsWithPasswordNoID();
    OAICustomerFieldsWithPasswordNoID(QString json);
    ~OAICustomerFieldsWithPasswordNoID() override;
    ...
    QList<qint32> getCustomerCategory() const;
    void setCustomerCategory(const QList<qint32> &customer_category);
    bool is_customer_category_Set() const;
    bool is_customer_category_Valid() const;
...
private:
    ...
    QList<qint32> m_customer_category;
    bool m_customer_category_isSet;
    bool m_customer_category_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerFieldsWithPasswordNoID)

#endif // OAICustomerFieldsWithPasswordNoID_H
