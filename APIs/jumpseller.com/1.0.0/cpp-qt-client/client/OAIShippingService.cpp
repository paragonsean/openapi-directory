...
qint32 OAIShippingService::getId() const {
    return m_id;
}
void OAIShippingService::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIShippingService::is_id_Set() const{
    return m_id_isSet;
}

bool OAIShippingService::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIShippingService::getName() const {
    return m_name;
}
void OAIShippingService::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIShippingService::is_name_Set() const{
    return m_name_isSet;
}

bool OAIShippingService::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIShippingService::getServiceCode() const {
    return m_service_code;
}
void OAIShippingService::setServiceCode(const QString &service_code) {
    m_service_code = service_code;
    m_service_code_isSet = true;
}

bool OAIShippingService::is_service_code_Set() const{
    return m_service_code_isSet;
}

bool OAIShippingService::is_service_code_Valid() const{
