...
#ifndef OAIBestSold_H
#define OAIBestSold_H
...
class OAIBestSold : public OAIObject {
public:
    OAIBestSold();
    OAIBestSold(QString json);
    ~OAIBestSold() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBestSold)
