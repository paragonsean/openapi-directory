...
/*
 * OAIOrderBillingAddress.h
 *
 * 
 */

#ifndef OAIOrderBillingAddress_H
#define OAIOrderBillingAddress_H
...
class OAIOrderBillingAddress : public OAIObject {
public:
    OAIOrderBillingAddress();
    OAIOrderBillingAddress(QString json);
    ~OAIOrderBillingAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderBillingAddress)

#endif // OAIOrderBillingAddress_H
