...
OAICustomFieldFields OAICustomField::getCustomField() const {
    return m_custom_field;
}
void OAICustomField::setCustomField(const OAICustomFieldFields &custom_field) {
    m_custom_field = custom_field;
    m_custom_field_isSet = true;
}

bool OAICustomField::is_custom_field_Set() const{
    return m_custom_field_isSet;
}

bool OAICustomField::is_custom_field_Valid() const{
