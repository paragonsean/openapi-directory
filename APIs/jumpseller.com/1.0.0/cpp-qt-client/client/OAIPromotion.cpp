...
OAIPromotionFields OAIPromotion::getPromotion() const {
    return m_promotion;
}
void OAIPromotion::setPromotion(const OAIPromotionFields &promotion) {
    m_promotion = promotion;
    m_promotion_isSet = true;
}

bool OAIPromotion::is_promotion_Set() const{
    return m_promotion_isSet;
}

bool OAIPromotion::is_promotion_Valid() const{
