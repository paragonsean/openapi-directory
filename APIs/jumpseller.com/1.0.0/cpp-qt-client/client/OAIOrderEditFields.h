...
/*
 * OAIOrderEditFields.h
 *
 * 
 */

#ifndef OAIOrderEditFields_H
#define OAIOrderEditFields_H
...
class OAIOrderEditFields : public OAIObject {
public:
    OAIOrderEditFields();
    OAIOrderEditFields(QString json);
    ~OAIOrderEditFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderEditFields)

#endif // OAIOrderEditFields_H
