...
#include "OAIFulfillmentFields.h"
...
OAIFulfillmentFields::OAIFulfillmentFields(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFulfillmentFields::OAIFulfillmentFields() {
    this->initializeModel();
}

OAIFulfillmentFields::~OAIFulfillmentFields() {}

void OAIFulfillmentFields::initializeModel() {
...
void OAIFulfillmentFields::fromJson(QString jsonString) {
...
void OAIFulfillmentFields::fromJsonObject(QJsonObject json) {
...
QString OAIFulfillmentFields::asJson() const {
...
QJsonObject OAIFulfillmentFields::asJsonObject() const {
    QJsonObject obj;
...
QString OAIFulfillmentFields::getExternalId() const {
    return m_external_id;
}
void OAIFulfillmentFields::setExternalId(const QString &external_id) {
    m_external_id = external_id;
    m_external_id_isSet = true;
}

bool OAIFulfillmentFields::is_external_id_Set() const{
    return m_external_id_isSet;
}

bool OAIFulfillmentFields::is_external_id_Valid() const{
    return m_external_id_isValid;
}

qint32 OAIFulfillmentFields::getId() const {
    return m_id;
}
void OAIFulfillmentFields::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFulfillmentFields::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFulfillmentFields::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFulfillmentFields::getOrderId() const {
    return m_order_id;
}
void OAIFulfillmentFields::setOrderId(const QString &order_id) {
    m_order_id = order_id;
    m_order_id_isSet = true;
}

bool OAIFulfillmentFields::is_order_id_Set() const{
    return m_order_id_isSet;
}

bool OAIFulfillmentFields::is_order_id_Valid() const{
    return m_order_id_isValid;
}

QString OAIFulfillmentFields::getServiceType() const {
    return m_service_type;
}
void OAIFulfillmentFields::setServiceType(const QString &service_type) {
    m_service_type = service_type;
    m_service_type_isSet = true;
}

bool OAIFulfillmentFields::is_service_type_Set() const{
    return m_service_type_isSet;
}

bool OAIFulfillmentFields::is_service_type_Valid() const{
    return m_service_type_isValid;
}

QString OAIFulfillmentFields::getShipmentStatus() const {
    return m_shipment_status;
}
void OAIFulfillmentFields::setShipmentStatus(const QString &shipment_status) {
    m_shipment_status = shipment_status;
    m_shipment_status_isSet = true;
}

bool OAIFulfillmentFields::is_shipment_status_Set() const{
    return m_shipment_status_isSet;
}

bool OAIFulfillmentFields::is_shipment_status_Valid() const{
    return m_shipment_status_isValid;
}

QString OAIFulfillmentFields::getTrackingCompany() const {
    return m_tracking_company;
}
void OAIFulfillmentFields::setTrackingCompany(const QString &tracking_company) {
    m_tracking_company = tracking_company;
    m_tracking_company_isSet = true;
}

bool OAIFulfillmentFields::is_tracking_company_Set() const{
    return m_tracking_company_isSet;
}

bool OAIFulfillmentFields::is_tracking_company_Valid() const{
    return m_tracking_company_isValid;
}

QString OAIFulfillmentFields::getTrackingNumber() const {
    return m_tracking_number;
}
void OAIFulfillmentFields::setTrackingNumber(const QString &tracking_number) {
    m_tracking_number = tracking_number;
    m_tracking_number_isSet = true;
}

bool OAIFulfillmentFields::is_tracking_number_Set() const{
    return m_tracking_number_isSet;
}

bool OAIFulfillmentFields::is_tracking_number_Valid() const{
    return m_tracking_number_isValid;
}

QString OAIFulfillmentFields::getType() const {
    return m_type;
}
void OAIFulfillmentFields::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFulfillmentFields::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFulfillmentFields::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIFulfillmentFields::isSet() const {
...
bool OAIFulfillmentFields::isValid() const {
