...
/*
 * OAICustomerFieldsWithBillingAddressAndShippingAddressFields.h
 *
 * 
 */

#ifndef OAICustomerFieldsWithBillingAddressAndShippingAddressFields_H
#define OAICustomerFieldsWithBillingAddressAndShippingAddressFields_H
...
class OAICustomerFieldsWithBillingAddressAndShippingAddressFields : public OAIObject {
public:
    OAICustomerFieldsWithBillingAddressAndShippingAddressFields();
    OAICustomerFieldsWithBillingAddressAndShippingAddressFields(QString json);
    ~OAICustomerFieldsWithBillingAddressAndShippingAddressFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerFieldsWithBillingAddressAndShippingAddressFields)

#endif // OAICustomerFieldsWithBillingAddressAndShippingAddressFields_H
