...
QString OAIShippingAddress::getAddress() const {
    return m_address;
}
void OAIShippingAddress::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAIShippingAddress::is_address_Set() const{
    return m_address_isSet;
}

bool OAIShippingAddress::is_address_Valid() const{
...
QString OAIShippingAddress::getMunicipality() const {
    return m_municipality;
}
void OAIShippingAddress::setMunicipality(const QString &municipality) {
    m_municipality = municipality;
    m_municipality_isSet = true;
}

bool OAIShippingAddress::is_municipality_Set() const{
    return m_municipality_isSet;
}

bool OAIShippingAddress::is_municipality_Valid() const{
...
QString OAIShippingAddress::getPostal() const {
    return m_postal;
}
void OAIShippingAddress::setPostal(const QString &postal) {
    m_postal = postal;
    m_postal_isSet = true;
}

bool OAIShippingAddress::is_postal_Set() const{
    return m_postal_isSet;
}

bool OAIShippingAddress::is_postal_Valid() const{
    return m_postal_isValid;
}

QString OAIShippingAddress::getRegion() const {
    return m_region;
}
void OAIShippingAddress::setRegion(const QString &region) {
    m_region = region;
    m_region_isSet = true;
}

bool OAIShippingAddress::is_region_Set() const{
    return m_region_isSet;
}

bool OAIShippingAddress::is_region_Valid() const{
    return m_region_isValid;
}

QString OAIShippingAddress::getSurname() const {
    return m_surname;
}
void OAIShippingAddress::setSurname(const QString &surname) {
    m_surname = surname;
    m_surname_isSet = true;
}

bool OAIShippingAddress::is_surname_Set() const{
    return m_surname_isSet;
}

bool OAIShippingAddress::is_surname_Valid() const{
