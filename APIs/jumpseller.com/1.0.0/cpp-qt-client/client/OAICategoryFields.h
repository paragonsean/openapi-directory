...
#ifndef OAICategoryFields_H
#define OAICategoryFields_H
...
class OAICategoryFields : public OAIObject {
public:
    OAICategoryFields();
    OAICategoryFields(QString json);
    ~OAICategoryFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICategoryFields)

#endif // OAICategoryFields_H
