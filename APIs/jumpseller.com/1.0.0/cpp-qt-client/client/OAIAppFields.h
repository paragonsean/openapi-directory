...
#ifndef OAIAppFields_H
#define OAIAppFields_H
...
class OAIAppFields : public OAIObject {
public:
    OAIAppFields();
    OAIAppFields(QString json);
    ~OAIAppFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppFields)

#endif // OAIAppFields_H
