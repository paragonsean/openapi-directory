...
OAIProductFields OAIProduct::getProduct() const {
    return m_product;
}
void OAIProduct::setProduct(const OAIProductFields &product) {
    m_product = product;
    m_product_isSet = true;
}

bool OAIProduct::is_product_Set() const{
    return m_product_isSet;
}

bool OAIProduct::is_product_Valid() const{
