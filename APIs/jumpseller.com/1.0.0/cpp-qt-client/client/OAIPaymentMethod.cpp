...
OAIPaymentMethodFields OAIPaymentMethod::getPaymentMethod() const {
    return m_payment_method;
}
void OAIPaymentMethod::setPaymentMethod(const OAIPaymentMethodFields &payment_method) {
    m_payment_method = payment_method;
    m_payment_method_isSet = true;
}

bool OAIPaymentMethod::is_payment_method_Set() const{
    return m_payment_method_isSet;
}

bool OAIPaymentMethod::is_payment_method_Valid() const{
