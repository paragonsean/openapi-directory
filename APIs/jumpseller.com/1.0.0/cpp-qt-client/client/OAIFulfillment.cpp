...
OAIFulfillmentFields OAIFulfillment::getCategory() const {
    return m_category;
}
void OAIFulfillment::setCategory(const OAIFulfillmentFields &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIFulfillment::is_category_Set() const{
    return m_category_isSet;
}

bool OAIFulfillment::is_category_Valid() const{
