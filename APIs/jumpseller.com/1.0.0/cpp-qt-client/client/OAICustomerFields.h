...
#ifndef OAICustomerFields_H
#define OAICustomerFields_H
...
class OAICustomerAdditionalField;
class OAICustomerCategory;
class OAIShippingAddress;

class OAICustomerFields : public OAIObject {
public:
    OAICustomerFields();
    OAICustomerFields(QString json);
    ~OAICustomerFields() override;
    ...
    QList<OAICustomerAdditionalField> getCustomerAdditionalFields() const;
    void setCustomerAdditionalFields(const QList<OAICustomerAdditionalField> &customer_additional_fields);
    bool is_customer_additional_fields_Set() const;
    bool is_customer_additional_fields_Valid() const;

    QList<OAICustomerCategory> getCustomerCategories() const;
    void setCustomerCategories(const QList<OAICustomerCategory> &customer_categories);
...
private:
    ...
    QList<OAICustomerAdditionalField> m_customer_additional_fields;
    bool m_customer_additional_fields_isSet;
    bool m_customer_additional_fields_isValid;

    QList<OAICustomerCategory> m_customer_categories;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerFields)

#endif // OAICustomerFields_H
