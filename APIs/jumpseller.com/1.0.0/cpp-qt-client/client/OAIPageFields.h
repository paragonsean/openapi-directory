...
#ifndef OAIPageFields_H
#define OAIPageFields_H

#include <QJsonObject>

#include "OAIPageCategory.h"
#include "OAIPageFields_image.h"
#include "OAIPageTemplate.h"
#include <QList>
#include <QString>
...
class OAIPageTemplate;

class OAIPageFields : public OAIObject {
public:
    OAIPageFields();
    OAIPageFields(QString json);
    ~OAIPageFields() override;
    ...
    OAIPageTemplate getRTemplate() const;
    void setRTemplate(const OAIPageTemplate &r_template);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPageFields)

#endif // OAIPageFields_H
