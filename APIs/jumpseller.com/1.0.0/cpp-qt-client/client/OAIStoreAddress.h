...
#ifndef OAIStoreAddress_H
#define OAIStoreAddress_H
...
class OAIStoreAddress : public OAIObject {
public:
    OAIStoreAddress();
    OAIStoreAddress(QString json);
    ~OAIStoreAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreAddress)

#endif // OAIStoreAddress_H
