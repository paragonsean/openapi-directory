...
/*
 * OAICustomerFieldsWithPassword.h
 *
 * 
 */

#ifndef OAICustomerFieldsWithPassword_H
#define OAICustomerFieldsWithPassword_H
...
class OAICustomerFieldsWithPassword : public OAIObject {
public:
    OAICustomerFieldsWithPassword();
    OAICustomerFieldsWithPassword(QString json);
    ~OAICustomerFieldsWithPassword() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomerFieldsWithPassword)

#endif // OAICustomerFieldsWithPassword_H
