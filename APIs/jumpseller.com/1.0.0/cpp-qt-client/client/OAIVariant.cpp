...
OAIVariantFields OAIVariant::getVariant() const {
    return m_variant;
}
void OAIVariant::setVariant(const OAIVariantFields &variant) {
    m_variant = variant;
    m_variant_isSet = true;
}

bool OAIVariant::is_variant_Set() const{
    return m_variant_isSet;
}

bool OAIVariant::is_variant_Valid() const{
