...
#include "OAIAttachmentFields.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIAttachmentFields;
...
public:
    ...
    OAIAttachmentFields getAttachment() const;
    void setAttachment(const OAIAttachmentFields &attachment);
...
private:
    ...
    OAIAttachmentFields m_attachment;
