...
/*
 * OAIPromotionFields.h
 *
 * 
 */

#ifndef OAIPromotionFields_H
#define OAIPromotionFields_H
...
class OAIPromotionFields : public OAIObject {
public:
    OAIPromotionFields();
    OAIPromotionFields(QString json);
    ~OAIPromotionFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromotionFields)

#endif // OAIPromotionFields_H
