...
/*
 * OAIOrderShippingAddress.h
 *
 * 
 */

#ifndef OAIOrderShippingAddress_H
#define OAIOrderShippingAddress_H
...
class OAIOrderShippingAddress : public OAIObject {
public:
    OAIOrderShippingAddress();
    OAIOrderShippingAddress(QString json);
    ~OAIOrderShippingAddress() override;
    ...
    double getStreetNumber() const;
    void setStreetNumber(const double &street_number);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderShippingAddress)

#endif // OAIOrderShippingAddress_H
