...
/*
 * OAIProductEditFields.h
 *
 * 
 */

#ifndef OAIProductEditFields_H
#define OAIProductEditFields_H
...
class OAIProductEditFields : public OAIObject {
public:
    OAIProductEditFields();
    OAIProductEditFields(QString json);
    ~OAIProductEditFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProductEditFields)

#endif // OAIProductEditFields_H
