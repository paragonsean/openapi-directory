...
#ifndef OAIOrderProduct_H
#define OAIOrderProduct_H
...
namespace OpenAPI {
class OAIOrderProductTax;

class OAIOrderProduct : public OAIObject {
public:
    OAIOrderProduct();
    OAIOrderProduct(QString json);
    ~OAIOrderProduct() override;
    ...
    QList<OAIOrderProductTax> getTaxes() const;
    void setTaxes(const QList<OAIOrderProductTax> &taxes);
...
private:
    ...
    QList<OAIOrderProductTax> m_taxes;
    bool m_taxes_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderProduct)

#endif // OAIOrderProduct_H
