...
public:
    ...
    OAIPaymentMethodFields getPaymentMethod() const;
    void setPaymentMethod(const OAIPaymentMethodFields &payment_method);
...
private:
    ...
    OAIPaymentMethodFields m_payment_method;
