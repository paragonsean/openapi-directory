...
/*
 * OAIFulfillmentCreateFields.h
 *
 * 
 */

#ifndef OAIFulfillmentCreateFields_H
#define OAIFulfillmentCreateFields_H
...
class OAIFulfillmentCreateFields : public OAIObject {
public:
    OAIFulfillmentCreateFields();
    OAIFulfillmentCreateFields(QString json);
    ~OAIFulfillmentCreateFields() override;
    ...
    QString getExpectedArrivalFrom() const;
    void setExpectedArrivalFrom(const QString &expected_arrival_from);
    bool is_expected_arrival_from_Set() const;
    bool is_expected_arrival_from_Valid() const;

    QString getExpectedArrivalTo() const;
    void setExpectedArrivalTo(const QString &expected_arrival_to);
    bool is_expected_arrival_to_Set() const;
    bool is_expected_arrival_to_Valid() const;
...
private:
    ...
    QString m_expected_arrival_from;
    bool m_expected_arrival_from_isSet;
    bool m_expected_arrival_from_isValid;

    QString m_expected_arrival_to;
    bool m_expected_arrival_to_isSet;
    bool m_expected_arrival_to_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFulfillmentCreateFields)

#endif // OAIFulfillmentCreateFields_H
