...
#ifndef OAITaxFields_H
#define OAITaxFields_H
...
class OAITaxFields : public OAIObject {
public:
    OAITaxFields();
    OAITaxFields(QString json);
    ~OAITaxFields() override;
    ...
    void setTaxAmount(const float &tax_amount);
...
Q_DECLARE_METATYPE(OpenAPI::OAITaxFields)

#endif // OAITaxFields_H
