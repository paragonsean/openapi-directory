...
public:
    ...
    OAIStoreAddress getAddress() const;
    void setAddress(const OAIStoreAddress &address);
    ...
    QString getHooksToken() const;
    void setHooksToken(const QString &hooks_token);
    bool is_hooks_token_Set() const;
    bool is_hooks_token_Valid() const;
...
private:
    ...
    QString m_hooks_token;
    bool m_hooks_token_isSet;
    bool m_hooks_token_isValid;
