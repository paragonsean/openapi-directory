...
OAICustomerFields OAICustomer::getCustomer() const {
    return m_customer;
}
void OAICustomer::setCustomer(const OAICustomerFields &customer) {
    m_customer = customer;
    m_customer_isSet = true;
}

bool OAICustomer::is_customer_Set() const{
    return m_customer_isSet;
}

bool OAICustomer::is_customer_Valid() const{
