...
OAIAttachmentFields OAIAttachment::getAttachment() const {
    return m_attachment;
}
void OAIAttachment::setAttachment(const OAIAttachmentFields &attachment) {
    m_attachment = attachment;
    m_attachment_isSet = true;
}

bool OAIAttachment::is_attachment_Set() const{
    return m_attachment_isSet;
}

bool OAIAttachment::is_attachment_Valid() const{
