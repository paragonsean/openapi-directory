...
/*
 * OAIVariantEditFields.h
 *
 * 
 */

#ifndef OAIVariantEditFields_H
#define OAIVariantEditFields_H
...
class OAIVariantEditFields : public OAIObject {
public:
    OAIVariantEditFields();
    OAIVariantEditFields(QString json);
    ~OAIVariantEditFields() override;
    ...
    qint32 getImageId() const;
    void setImageId(const qint32 &image_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVariantEditFields)

#endif // OAIVariantEditFields_H
