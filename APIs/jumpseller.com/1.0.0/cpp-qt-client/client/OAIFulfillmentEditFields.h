...
/*
 * OAIFulfillmentEditFields.h
 *
 * 
 */

#ifndef OAIFulfillmentEditFields_H
#define OAIFulfillmentEditFields_H
...
class OAIFulfillmentEditFields : public OAIObject {
public:
    OAIFulfillmentEditFields();
    OAIFulfillmentEditFields(QString json);
    ~OAIFulfillmentEditFields() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFulfillmentEditFields)

#endif // OAIFulfillmentEditFields_H
