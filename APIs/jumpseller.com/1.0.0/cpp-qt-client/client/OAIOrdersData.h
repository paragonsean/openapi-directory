...
#ifndef OAIOrdersData_H
#define OAIOrdersData_H
...
class OAIOrdersData : public OAIObject {
public:
    OAIOrdersData();
    OAIOrdersData(QString json);
    ~OAIOrdersData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrdersData)

#endif // OAIOrdersData_H
