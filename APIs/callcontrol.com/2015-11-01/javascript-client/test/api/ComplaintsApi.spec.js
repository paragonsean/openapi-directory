...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallControlApi.ComplaintsApi();
  });
  ...
  describe('ComplaintsApi', function() {
    describe('complaintsComplaints', function() {
      it('should call complaintsComplaints successfully', function(done) {
        //uncomment below and update the code to test complaintsComplaints
        //instance.complaintsComplaints(function(error) {
