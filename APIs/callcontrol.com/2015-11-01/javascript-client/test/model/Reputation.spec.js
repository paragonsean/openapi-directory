...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CallControlApi.Reputation();
  });
  ...
  describe('Reputation', function() {
    it('should create an instance of Reputation', function() {
      // uncomment below and update the code to test Reputation
      //var instance = new CallControlApi.Reputation();
      //expect(instance).to.be.a(CallControlApi.Reputation);
    });
