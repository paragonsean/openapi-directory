...
OAIUKBaseListing::OAIUKBaseListing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUKBaseListing::OAIUKBaseListing() {
    this->initializeModel();
}

OAIUKBaseListing::~OAIUKBaseListing() {}

void OAIUKBaseListing::initializeModel() {
    ...
    m_car_location_isSet = false;
    m_car_location_isValid = false;
    ...
    m_uvc_id_isSet = false;
    m_uvc_id_isValid = false;
...
void OAIUKBaseListing::fromJson(QString jsonString) {
...
void OAIUKBaseListing::fromJsonObject(QJsonObject json) {
    ...
    m_car_location_isValid = ::OpenAPI::fromJsonValue(m_car_location, json[QString("car_location")]);
    m_car_location_isSet = !json[QString("car_location")].isNull() && m_car_location_isValid;
    ...
    m_uvc_id_isValid = ::OpenAPI::fromJsonValue(m_uvc_id, json[QString("uvc_id")]);
    m_uvc_id_isSet = !json[QString("uvc_id")].isNull() && m_uvc_id_isValid;
...
QString OAIUKBaseListing::asJson() const {
...
QJsonObject OAIUKBaseListing::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_car_location.isSet()) {
        obj.insert(QString("car_location"), ::OpenAPI::toJsonValue(m_car_location));
    }
    ...
    if (m_uvc_id_isSet) {
        obj.insert(QString("uvc_id"), ::OpenAPI::toJsonValue(m_uvc_id));
    }
    if (m_vdp_url_isSet) {
...
QString OAIUKBaseListing::getBaseExtColor() const {
    return m_base_ext_color;
}
void OAIUKBaseListing::setBaseExtColor(const QString &base_ext_color) {
    m_base_ext_color = base_ext_color;
    m_base_ext_color_isSet = true;
}

bool OAIUKBaseListing::is_base_ext_color_Set() const{
    return m_base_ext_color_isSet;
}

bool OAIUKBaseListing::is_base_ext_color_Valid() const{
    return m_base_ext_color_isValid;
}

QString OAIUKBaseListing::getBaseIntColor() const {
    return m_base_int_color;
}
void OAIUKBaseListing::setBaseIntColor(const QString &base_int_color) {
    m_base_int_color = base_int_color;
    m_base_int_color_isSet = true;
}

bool OAIUKBaseListing::is_base_int_color_Set() const{
    return m_base_int_color_isSet;
}

bool OAIUKBaseListing::is_base_int_color_Valid() const{
    return m_base_int_color_isValid;
}

OAIBuild OAIUKBaseListing::getBuild() const {
    return m_build;
}
void OAIUKBaseListing::setBuild(const OAIBuild &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIUKBaseListing::is_build_Set() const{
    return m_build_isSet;
}

bool OAIUKBaseListing::is_build_Valid() const{
    return m_build_isValid;
}

OAICarLocation OAIUKBaseListing::getCarLocation() const {
    return m_car_location;
}
void OAIUKBaseListing::setCarLocation(const OAICarLocation &car_location) {
    m_car_location = car_location;
    m_car_location_isSet = true;
}

bool OAIUKBaseListing::is_car_location_Set() const{
    return m_car_location_isSet;
}

bool OAIUKBaseListing::is_car_location_Valid() const{
    return m_car_location_isValid;
}

bool OAIUKBaseListing::isCarfax1Owner() const {
    return m_carfax_1_owner;
}
void OAIUKBaseListing::setCarfax1Owner(const bool &carfax_1_owner) {
    m_carfax_1_owner = carfax_1_owner;
    m_carfax_1_owner_isSet = true;
}

bool OAIUKBaseListing::is_carfax_1_owner_Set() const{
    return m_carfax_1_owner_isSet;
}

bool OAIUKBaseListing::is_carfax_1_owner_Valid() const{
    return m_carfax_1_owner_isValid;
}

bool OAIUKBaseListing::isCarfaxCleanTitle() const {
    return m_carfax_clean_title;
}
void OAIUKBaseListing::setCarfaxCleanTitle(const bool &carfax_clean_title) {
    m_carfax_clean_title = carfax_clean_title;
    m_carfax_clean_title_isSet = true;
}

bool OAIUKBaseListing::is_carfax_clean_title_Set() const{
    return m_carfax_clean_title_isSet;
}

bool OAIUKBaseListing::is_carfax_clean_title_Valid() const{
    return m_carfax_clean_title_isValid;
}

QString OAIUKBaseListing::getCo2Emissions() const {
    return m_co2_emissions;
}
void OAIUKBaseListing::setCo2Emissions(const QString &co2_emissions) {
    m_co2_emissions = co2_emissions;
    m_co2_emissions_isSet = true;
}

bool OAIUKBaseListing::is_co2_emissions_Set() const{
    return m_co2_emissions_isSet;
}

bool OAIUKBaseListing::is_co2_emissions_Valid() const{
    return m_co2_emissions_isValid;
}

QString OAIUKBaseListing::getDataSource() const {
    return m_data_source;
}
void OAIUKBaseListing::setDataSource(const QString &data_source) {
    m_data_source = data_source;
    m_data_source_isSet = true;
}

bool OAIUKBaseListing::is_data_source_Set() const{
    return m_data_source_isSet;
}

bool OAIUKBaseListing::is_data_source_Valid() const{
    return m_data_source_isValid;
}

OAINestDealer OAIUKBaseListing::getDealer() const {
    return m_dealer;
}
void OAIUKBaseListing::setDealer(const OAINestDealer &dealer) {
    m_dealer = dealer;
    m_dealer_isSet = true;
}

bool OAIUKBaseListing::is_dealer_Set() const{
    return m_dealer_isSet;
}

bool OAIUKBaseListing::is_dealer_Valid() const{
    return m_dealer_isValid;
}

double OAIUKBaseListing::getDist() const {
    return m_dist;
}
void OAIUKBaseListing::setDist(const double &dist) {
    m_dist = dist;
    m_dist_isSet = true;
}

bool OAIUKBaseListing::is_dist_Set() const{
    return m_dist_isSet;
}

bool OAIUKBaseListing::is_dist_Valid() const{
    return m_dist_isValid;
}

qint32 OAIUKBaseListing::getDom() const {
    return m_dom;
}
void OAIUKBaseListing::setDom(const qint32 &dom) {
    m_dom = dom;
    m_dom_isSet = true;
}

bool OAIUKBaseListing::is_dom_Set() const{
    return m_dom_isSet;
}

bool OAIUKBaseListing::is_dom_Valid() const{
    return m_dom_isValid;
}

qint32 OAIUKBaseListing::getDom180() const {
    return m_dom_180;
}
void OAIUKBaseListing::setDom180(const qint32 &dom_180) {
    m_dom_180 = dom_180;
    m_dom_180_isSet = true;
}

bool OAIUKBaseListing::is_dom_180_Set() const{
    return m_dom_180_isSet;
}

bool OAIUKBaseListing::is_dom_180_Valid() const{
    return m_dom_180_isValid;
}

qint32 OAIUKBaseListing::getDomActive() const {
    return m_dom_active;
}
void OAIUKBaseListing::setDomActive(const qint32 &dom_active) {
    m_dom_active = dom_active;
    m_dom_active_isSet = true;
}

bool OAIUKBaseListing::is_dom_active_Set() const{
    return m_dom_active_isSet;
}

bool OAIUKBaseListing::is_dom_active_Valid() const{
    return m_dom_active_isValid;
}

QString OAIUKBaseListing::getExteriorColor() const {
    return m_exterior_color;
}
void OAIUKBaseListing::setExteriorColor(const QString &exterior_color) {
    m_exterior_color = exterior_color;
    m_exterior_color_isSet = true;
}

bool OAIUKBaseListing::is_exterior_color_Set() const{
    return m_exterior_color_isSet;
}

bool OAIUKBaseListing::is_exterior_color_Valid() const{
    return m_exterior_color_isValid;
}

QList<OAIListingFinance> OAIUKBaseListing::getFinancingOptions() const {
    return m_financing_options;
}
void OAIUKBaseListing::setFinancingOptions(const QList<OAIListingFinance> &financing_options) {
    m_financing_options = financing_options;
    m_financing_options_isSet = true;
}

bool OAIUKBaseListing::is_financing_options_Set() const{
    return m_financing_options_isSet;
}

bool OAIUKBaseListing::is_financing_options_Valid() const{
    return m_financing_options_isValid;
}

qint32 OAIUKBaseListing::getFirstSeenAt() const {
    return m_first_seen_at;
}
void OAIUKBaseListing::setFirstSeenAt(const qint32 &first_seen_at) {
    m_first_seen_at = first_seen_at;
    m_first_seen_at_isSet = true;
}

bool OAIUKBaseListing::is_first_seen_at_Set() const{
    return m_first_seen_at_isSet;
}

bool OAIUKBaseListing::is_first_seen_at_Valid() const{
    return m_first_seen_at_isValid;
}

QString OAIUKBaseListing::getFirstSeenAtDate() const {
    return m_first_seen_at_date;
}
void OAIUKBaseListing::setFirstSeenAtDate(const QString &first_seen_at_date) {
    m_first_seen_at_date = first_seen_at_date;
    m_first_seen_at_date_isSet = true;
}

bool OAIUKBaseListing::is_first_seen_at_date_Set() const{
    return m_first_seen_at_date_isSet;
}

bool OAIUKBaseListing::is_first_seen_at_date_Valid() const{
    return m_first_seen_at_date_isValid;
}

QString OAIUKBaseListing::getHeading() const {
    return m_heading;
}
void OAIUKBaseListing::setHeading(const QString &heading) {
    m_heading = heading;
    m_heading_isSet = true;
}

bool OAIUKBaseListing::is_heading_Set() const{
    return m_heading_isSet;
}

bool OAIUKBaseListing::is_heading_Valid() const{
    return m_heading_isValid;
}

QString OAIUKBaseListing::getId() const {
    return m_id;
}
void OAIUKBaseListing::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIUKBaseListing::is_id_Set() const{
    return m_id_isSet;
}

bool OAIUKBaseListing::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIUKBaseListing::isInTransit() const {
    return m_in_transit;
}
void OAIUKBaseListing::setInTransit(const bool &in_transit) {
    m_in_transit = in_transit;
    m_in_transit_isSet = true;
}

bool OAIUKBaseListing::is_in_transit_Set() const{
    return m_in_transit_isSet;
}

bool OAIUKBaseListing::is_in_transit_Valid() const{
    return m_in_transit_isValid;
}

QString OAIUKBaseListing::getInsuranceGroup() const {
    return m_insurance_group;
}
void OAIUKBaseListing::setInsuranceGroup(const QString &insurance_group) {
    m_insurance_group = insurance_group;
    m_insurance_group_isSet = true;
}

bool OAIUKBaseListing::is_insurance_group_Set() const{
    return m_insurance_group_isSet;
}

bool OAIUKBaseListing::is_insurance_group_Valid() const{
    return m_insurance_group_isValid;
}

QString OAIUKBaseListing::getInteriorColor() const {
    return m_interior_color;
}
void OAIUKBaseListing::setInteriorColor(const QString &interior_color) {
    m_interior_color = interior_color;
    m_interior_color_isSet = true;
}

bool OAIUKBaseListing::is_interior_color_Set() const{
    return m_interior_color_isSet;
}

bool OAIUKBaseListing::is_interior_color_Valid() const{
    return m_interior_color_isValid;
}

QString OAIUKBaseListing::getInventoryType() const {
    return m_inventory_type;
}
void OAIUKBaseListing::setInventoryType(const QString &inventory_type) {
    m_inventory_type = inventory_type;
    m_inventory_type_isSet = true;
}

bool OAIUKBaseListing::is_inventory_type_Set() const{
    return m_inventory_type_isSet;
}

bool OAIUKBaseListing::is_inventory_type_Valid() const{
    return m_inventory_type_isValid;
}

qint32 OAIUKBaseListing::getIsCertified() const {
    return m_is_certified;
}
void OAIUKBaseListing::setIsCertified(const qint32 &is_certified) {
    m_is_certified = is_certified;
    m_is_certified_isSet = true;
}

bool OAIUKBaseListing::is_is_certified_Set() const{
    return m_is_certified_isSet;
}

bool OAIUKBaseListing::is_is_certified_Valid() const{
    return m_is_certified_isValid;
}

bool OAIUKBaseListing::isIsTranslated() const {
    return m_is_translated;
}
void OAIUKBaseListing::setIsTranslated(const bool &is_translated) {
    m_is_translated = is_translated;
    m_is_translated_isSet = true;
}

bool OAIUKBaseListing::is_is_translated_Set() const{
    return m_is_translated_isSet;
}

bool OAIUKBaseListing::is_is_translated_Valid() const{
    return m_is_translated_isValid;
}

qint32 OAIUKBaseListing::getLastSeenAt() const {
    return m_last_seen_at;
}
void OAIUKBaseListing::setLastSeenAt(const qint32 &last_seen_at) {
    m_last_seen_at = last_seen_at;
    m_last_seen_at_isSet = true;
}

bool OAIUKBaseListing::is_last_seen_at_Set() const{
    return m_last_seen_at_isSet;
}

bool OAIUKBaseListing::is_last_seen_at_Valid() const{
    return m_last_seen_at_isValid;
}

QString OAIUKBaseListing::getLastSeenAtDate() const {
    return m_last_seen_at_date;
}
void OAIUKBaseListing::setLastSeenAtDate(const QString &last_seen_at_date) {
    m_last_seen_at_date = last_seen_at_date;
    m_last_seen_at_date_isSet = true;
}

bool OAIUKBaseListing::is_last_seen_at_date_Set() const{
    return m_last_seen_at_date_isSet;
}

bool OAIUKBaseListing::is_last_seen_at_date_Valid() const{
    return m_last_seen_at_date_isValid;
}

QList<OAIListingLease> OAIUKBaseListing::getLeasingOptions() const {
    return m_leasing_options;
}
void OAIUKBaseListing::setLeasingOptions(const QList<OAIListingLease> &leasing_options) {
    m_leasing_options = leasing_options;
    m_leasing_options_isSet = true;
}

bool OAIUKBaseListing::is_leasing_options_Set() const{
    return m_leasing_options_isSet;
}

bool OAIUKBaseListing::is_leasing_options_Valid() const{
    return m_leasing_options_isValid;
}

OAIListingNestMedia OAIUKBaseListing::getMedia() const {
    return m_media;
}
void OAIUKBaseListing::setMedia(const OAIListingNestMedia &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAIUKBaseListing::is_media_Set() const{
    return m_media_isSet;
}

bool OAIUKBaseListing::is_media_Valid() const{
    return m_media_isValid;
}

qint32 OAIUKBaseListing::getMiles() const {
    return m_miles;
}
void OAIUKBaseListing::setMiles(const qint32 &miles) {
    m_miles = miles;
    m_miles_isSet = true;
}

bool OAIUKBaseListing::is_miles_Set() const{
    return m_miles_isSet;
}

bool OAIUKBaseListing::is_miles_Valid() const{
    return m_miles_isValid;
}

QString OAIUKBaseListing::getModelCode() const {
    return m_model_code;
}
void OAIUKBaseListing::setModelCode(const QString &model_code) {
    m_model_code = model_code;
    m_model_code_isSet = true;
}

bool OAIUKBaseListing::is_model_code_Set() const{
    return m_model_code_isSet;
}

bool OAIUKBaseListing::is_model_code_Valid() const{
    return m_model_code_isValid;
}

qint32 OAIUKBaseListing::getMsrp() const {
    return m_msrp;
}
void OAIUKBaseListing::setMsrp(const qint32 &msrp) {
    m_msrp = msrp;
    m_msrp_isSet = true;
}

bool OAIUKBaseListing::is_msrp_Set() const{
    return m_msrp_isSet;
}

bool OAIUKBaseListing::is_msrp_Valid() const{
    return m_msrp_isValid;
}

QString OAIUKBaseListing::getNumOwners() const {
    return m_num_owners;
}
void OAIUKBaseListing::setNumOwners(const QString &num_owners) {
    m_num_owners = num_owners;
    m_num_owners_isSet = true;
}

bool OAIUKBaseListing::is_num_owners_Set() const{
    return m_num_owners_isSet;
}

bool OAIUKBaseListing::is_num_owners_Valid() const{
    return m_num_owners_isValid;
}

qint32 OAIUKBaseListing::getPrice() const {
    return m_price;
}
void OAIUKBaseListing::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIUKBaseListing::is_price_Set() const{
    return m_price_isSet;
}

bool OAIUKBaseListing::is_price_Valid() const{
    return m_price_isValid;
}

double OAIUKBaseListing::getPriceChangePercent() const {
    return m_price_change_percent;
}
void OAIUKBaseListing::setPriceChangePercent(const double &price_change_percent) {
    m_price_change_percent = price_change_percent;
    m_price_change_percent_isSet = true;
}

bool OAIUKBaseListing::is_price_change_percent_Set() const{
    return m_price_change_percent_isSet;
}

bool OAIUKBaseListing::is_price_change_percent_Valid() const{
    return m_price_change_percent_isValid;
}

QString OAIUKBaseListing::getRefMiles() const {
    return m_ref_miles;
}
void OAIUKBaseListing::setRefMiles(const QString &ref_miles) {
    m_ref_miles = ref_miles;
    m_ref_miles_isSet = true;
}

bool OAIUKBaseListing::is_ref_miles_Set() const{
    return m_ref_miles_isSet;
}

bool OAIUKBaseListing::is_ref_miles_Valid() const{
    return m_ref_miles_isValid;
}

qint32 OAIUKBaseListing::getRefMilesDt() const {
    return m_ref_miles_dt;
}
void OAIUKBaseListing::setRefMilesDt(const qint32 &ref_miles_dt) {
    m_ref_miles_dt = ref_miles_dt;
    m_ref_miles_dt_isSet = true;
}

bool OAIUKBaseListing::is_ref_miles_dt_Set() const{
    return m_ref_miles_dt_isSet;
}

bool OAIUKBaseListing::is_ref_miles_dt_Valid() const{
    return m_ref_miles_dt_isValid;
}

QString OAIUKBaseListing::getRefPrice() const {
    return m_ref_price;
}
void OAIUKBaseListing::setRefPrice(const QString &ref_price) {
    m_ref_price = ref_price;
    m_ref_price_isSet = true;
}

bool OAIUKBaseListing::is_ref_price_Set() const{
    return m_ref_price_isSet;
}

bool OAIUKBaseListing::is_ref_price_Valid() const{
    return m_ref_price_isValid;
}

qint32 OAIUKBaseListing::getRefPriceDt() const {
    return m_ref_price_dt;
}
void OAIUKBaseListing::setRefPriceDt(const qint32 &ref_price_dt) {
    m_ref_price_dt = ref_price_dt;
    m_ref_price_dt_isSet = true;
}

bool OAIUKBaseListing::is_ref_price_dt_Set() const{
    return m_ref_price_dt_isSet;
}

bool OAIUKBaseListing::is_ref_price_dt_Valid() const{
    return m_ref_price_dt_isValid;
}

double OAIUKBaseListing::getScrapedAt() const {
    return m_scraped_at;
}
void OAIUKBaseListing::setScrapedAt(const double &scraped_at) {
    m_scraped_at = scraped_at;
    m_scraped_at_isSet = true;
}

bool OAIUKBaseListing::is_scraped_at_Set() const{
    return m_scraped_at_isSet;
}

bool OAIUKBaseListing::is_scraped_at_Valid() const{
    return m_scraped_at_isValid;
}

QString OAIUKBaseListing::getScrapedAtDate() const {
    return m_scraped_at_date;
}
void OAIUKBaseListing::setScrapedAtDate(const QString &scraped_at_date) {
    m_scraped_at_date = scraped_at_date;
    m_scraped_at_date_isSet = true;
}

bool OAIUKBaseListing::is_scraped_at_date_Set() const{
    return m_scraped_at_date_isSet;
}

bool OAIUKBaseListing::is_scraped_at_date_Valid() const{
    return m_scraped_at_date_isValid;
}

QString OAIUKBaseListing::getSellerType() const {
    return m_seller_type;
}
void OAIUKBaseListing::setSellerType(const QString &seller_type) {
    m_seller_type = seller_type;
    m_seller_type_isSet = true;
}

bool OAIUKBaseListing::is_seller_type_Set() const{
    return m_seller_type_isSet;
}

bool OAIUKBaseListing::is_seller_type_Valid() const{
    return m_seller_type_isValid;
}

QString OAIUKBaseListing::getSource() const {
    return m_source;
}
void OAIUKBaseListing::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIUKBaseListing::is_source_Set() const{
    return m_source_isSet;
}

bool OAIUKBaseListing::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIUKBaseListing::getStockNo() const {
    return m_stock_no;
}
void OAIUKBaseListing::setStockNo(const QString &stock_no) {
    m_stock_no = stock_no;
    m_stock_no_isSet = true;
}

bool OAIUKBaseListing::is_stock_no_Set() const{
    return m_stock_no_isSet;
}

bool OAIUKBaseListing::is_stock_no_Valid() const{
    return m_stock_no_isValid;
}

QString OAIUKBaseListing::getTitleType() const {
    return m_title_type;
}
void OAIUKBaseListing::setTitleType(const QString &title_type) {
    m_title_type = title_type;
    m_title_type_isSet = true;
}

bool OAIUKBaseListing::is_title_type_Set() const{
    return m_title_type_isSet;
}

bool OAIUKBaseListing::is_title_type_Valid() const{
    return m_title_type_isValid;
}

QString OAIUKBaseListing::getUvcId() const {
    return m_uvc_id;
}
void OAIUKBaseListing::setUvcId(const QString &uvc_id) {
    m_uvc_id = uvc_id;
    m_uvc_id_isSet = true;
}

bool OAIUKBaseListing::is_uvc_id_Set() const{
    return m_uvc_id_isSet;
}

bool OAIUKBaseListing::is_uvc_id_Valid() const{
    return m_uvc_id_isValid;
}

QString OAIUKBaseListing::getVdpUrl() const {
    return m_vdp_url;
}
void OAIUKBaseListing::setVdpUrl(const QString &vdp_url) {
    m_vdp_url = vdp_url;
    m_vdp_url_isSet = true;
}

bool OAIUKBaseListing::is_vdp_url_Set() const{
    return m_vdp_url_isSet;
}

bool OAIUKBaseListing::is_vdp_url_Valid() const{
    return m_vdp_url_isValid;
}

QString OAIUKBaseListing::getVehicleRegistrationMark() const {
    return m_vehicle_registration_mark;
}
void OAIUKBaseListing::setVehicleRegistrationMark(const QString &vehicle_registration_mark) {
    m_vehicle_registration_mark = vehicle_registration_mark;
    m_vehicle_registration_mark_isSet = true;
}

bool OAIUKBaseListing::is_vehicle_registration_mark_Set() const{
    return m_vehicle_registration_mark_isSet;
}

bool OAIUKBaseListing::is_vehicle_registration_mark_Valid() const{
    return m_vehicle_registration_mark_isValid;
}

bool OAIUKBaseListing::isSet() const {
...
bool OAIUKBaseListing::isValid() const {
