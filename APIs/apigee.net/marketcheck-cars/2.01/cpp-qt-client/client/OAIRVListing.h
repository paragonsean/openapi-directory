...
#ifndef OAIRVListing_H
#define OAIRVListing_H
...
class OAIRVListing : public OAIObject {
public:
    OAIRVListing();
    OAIRVListing(QString json);
    ~OAIRVListing() override;
    ...
    OAIRVBuild getBuild() const;
    void setBuild(const OAIRVBuild &build);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRVListing)

#endif // OAIRVListing_H
