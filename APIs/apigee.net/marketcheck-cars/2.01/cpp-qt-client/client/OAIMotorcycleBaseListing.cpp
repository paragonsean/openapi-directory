...
OAIMotorcycleBaseListing::OAIMotorcycleBaseListing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMotorcycleBaseListing::OAIMotorcycleBaseListing() {
    this->initializeModel();
}

OAIMotorcycleBaseListing::~OAIMotorcycleBaseListing() {}

void OAIMotorcycleBaseListing::initializeModel() {
...
void OAIMotorcycleBaseListing::fromJson(QString jsonString) {
...
void OAIMotorcycleBaseListing::fromJsonObject(QJsonObject json) {
...
QString OAIMotorcycleBaseListing::asJson() const {
...
QJsonObject OAIMotorcycleBaseListing::asJsonObject() const {
    QJsonObject obj;
    if (m_build.isSet()) {
...
OAIMotorcycleBuild OAIMotorcycleBaseListing::getBuild() const {
    return m_build;
}
void OAIMotorcycleBaseListing::setBuild(const OAIMotorcycleBuild &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIMotorcycleBaseListing::is_build_Set() const{
    return m_build_isSet;
}

bool OAIMotorcycleBaseListing::is_build_Valid() const{
    return m_build_isValid;
}

QString OAIMotorcycleBaseListing::getColor() const {
    return m_color;
}
void OAIMotorcycleBaseListing::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIMotorcycleBaseListing::is_color_Set() const{
    return m_color_isSet;
}

bool OAIMotorcycleBaseListing::is_color_Valid() const{
    return m_color_isValid;
}

OAINestDealer OAIMotorcycleBaseListing::getDealer() const {
    return m_dealer;
}
void OAIMotorcycleBaseListing::setDealer(const OAINestDealer &dealer) {
    m_dealer = dealer;
    m_dealer_isSet = true;
}

bool OAIMotorcycleBaseListing::is_dealer_Set() const{
    return m_dealer_isSet;
}

bool OAIMotorcycleBaseListing::is_dealer_Valid() const{
    return m_dealer_isValid;
}

double OAIMotorcycleBaseListing::getDist() const {
    return m_dist;
}
void OAIMotorcycleBaseListing::setDist(const double &dist) {
    m_dist = dist;
    m_dist_isSet = true;
}

bool OAIMotorcycleBaseListing::is_dist_Set() const{
    return m_dist_isSet;
}

bool OAIMotorcycleBaseListing::is_dist_Valid() const{
    return m_dist_isValid;
}

QString OAIMotorcycleBaseListing::getDpUrl() const {
    return m_dp_url;
}
void OAIMotorcycleBaseListing::setDpUrl(const QString &dp_url) {
    m_dp_url = dp_url;
    m_dp_url_isSet = true;
}

bool OAIMotorcycleBaseListing::is_dp_url_Set() const{
    return m_dp_url_isSet;
}

bool OAIMotorcycleBaseListing::is_dp_url_Valid() const{
    return m_dp_url_isValid;
}

qint32 OAIMotorcycleBaseListing::getFirstSeenAt() const {
    return m_first_seen_at;
}
void OAIMotorcycleBaseListing::setFirstSeenAt(const qint32 &first_seen_at) {
    m_first_seen_at = first_seen_at;
    m_first_seen_at_isSet = true;
}

bool OAIMotorcycleBaseListing::is_first_seen_at_Set() const{
    return m_first_seen_at_isSet;
}

bool OAIMotorcycleBaseListing::is_first_seen_at_Valid() const{
    return m_first_seen_at_isValid;
}

QString OAIMotorcycleBaseListing::getFirstSeenAtDate() const {
    return m_first_seen_at_date;
}
void OAIMotorcycleBaseListing::setFirstSeenAtDate(const QString &first_seen_at_date) {
    m_first_seen_at_date = first_seen_at_date;
    m_first_seen_at_date_isSet = true;
}

bool OAIMotorcycleBaseListing::is_first_seen_at_date_Set() const{
    return m_first_seen_at_date_isSet;
}

bool OAIMotorcycleBaseListing::is_first_seen_at_date_Valid() const{
    return m_first_seen_at_date_isValid;
}

QString OAIMotorcycleBaseListing::getHeading() const {
    return m_heading;
}
void OAIMotorcycleBaseListing::setHeading(const QString &heading) {
    m_heading = heading;
    m_heading_isSet = true;
}

bool OAIMotorcycleBaseListing::is_heading_Set() const{
    return m_heading_isSet;
}

bool OAIMotorcycleBaseListing::is_heading_Valid() const{
    return m_heading_isValid;
}

QString OAIMotorcycleBaseListing::getId() const {
    return m_id;
}
void OAIMotorcycleBaseListing::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMotorcycleBaseListing::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMotorcycleBaseListing::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMotorcycleBaseListing::getInventoryType() const {
    return m_inventory_type;
}
void OAIMotorcycleBaseListing::setInventoryType(const QString &inventory_type) {
    m_inventory_type = inventory_type;
    m_inventory_type_isSet = true;
}

bool OAIMotorcycleBaseListing::is_inventory_type_Set() const{
    return m_inventory_type_isSet;
}

bool OAIMotorcycleBaseListing::is_inventory_type_Valid() const{
    return m_inventory_type_isValid;
}

qint32 OAIMotorcycleBaseListing::getLastSeenAt() const {
    return m_last_seen_at;
}
void OAIMotorcycleBaseListing::setLastSeenAt(const qint32 &last_seen_at) {
    m_last_seen_at = last_seen_at;
    m_last_seen_at_isSet = true;
}

bool OAIMotorcycleBaseListing::is_last_seen_at_Set() const{
    return m_last_seen_at_isSet;
}

bool OAIMotorcycleBaseListing::is_last_seen_at_Valid() const{
    return m_last_seen_at_isValid;
}

QString OAIMotorcycleBaseListing::getLastSeenAtDate() const {
    return m_last_seen_at_date;
}
void OAIMotorcycleBaseListing::setLastSeenAtDate(const QString &last_seen_at_date) {
    m_last_seen_at_date = last_seen_at_date;
    m_last_seen_at_date_isSet = true;
}

bool OAIMotorcycleBaseListing::is_last_seen_at_date_Set() const{
    return m_last_seen_at_date_isSet;
}

bool OAIMotorcycleBaseListing::is_last_seen_at_date_Valid() const{
    return m_last_seen_at_date_isValid;
}

OAIListingNestMedia OAIMotorcycleBaseListing::getMedia() const {
    return m_media;
}
void OAIMotorcycleBaseListing::setMedia(const OAIListingNestMedia &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAIMotorcycleBaseListing::is_media_Set() const{
    return m_media_isSet;
}

bool OAIMotorcycleBaseListing::is_media_Valid() const{
    return m_media_isValid;
}

qint32 OAIMotorcycleBaseListing::getMiles() const {
    return m_miles;
}
void OAIMotorcycleBaseListing::setMiles(const qint32 &miles) {
    m_miles = miles;
    m_miles_isSet = true;
}

bool OAIMotorcycleBaseListing::is_miles_Set() const{
    return m_miles_isSet;
}

bool OAIMotorcycleBaseListing::is_miles_Valid() const{
    return m_miles_isValid;
}

qint32 OAIMotorcycleBaseListing::getMsrp() const {
    return m_msrp;
}
void OAIMotorcycleBaseListing::setMsrp(const qint32 &msrp) {
    m_msrp = msrp;
    m_msrp_isSet = true;
}

bool OAIMotorcycleBaseListing::is_msrp_Set() const{
    return m_msrp_isSet;
}

bool OAIMotorcycleBaseListing::is_msrp_Valid() const{
    return m_msrp_isValid;
}

qint32 OAIMotorcycleBaseListing::getPrice() const {
    return m_price;
}
void OAIMotorcycleBaseListing::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIMotorcycleBaseListing::is_price_Set() const{
    return m_price_isSet;
}

bool OAIMotorcycleBaseListing::is_price_Valid() const{
    return m_price_isValid;
}

double OAIMotorcycleBaseListing::getScrapedAt() const {
    return m_scraped_at;
}
void OAIMotorcycleBaseListing::setScrapedAt(const double &scraped_at) {
    m_scraped_at = scraped_at;
    m_scraped_at_isSet = true;
}

bool OAIMotorcycleBaseListing::is_scraped_at_Set() const{
    return m_scraped_at_isSet;
}

bool OAIMotorcycleBaseListing::is_scraped_at_Valid() const{
    return m_scraped_at_isValid;
}

QString OAIMotorcycleBaseListing::getScrapedAtDate() const {
    return m_scraped_at_date;
}
void OAIMotorcycleBaseListing::setScrapedAtDate(const QString &scraped_at_date) {
    m_scraped_at_date = scraped_at_date;
    m_scraped_at_date_isSet = true;
}

bool OAIMotorcycleBaseListing::is_scraped_at_date_Set() const{
    return m_scraped_at_date_isSet;
}

bool OAIMotorcycleBaseListing::is_scraped_at_date_Valid() const{
    return m_scraped_at_date_isValid;
}

QString OAIMotorcycleBaseListing::getSellerType() const {
    return m_seller_type;
}
void OAIMotorcycleBaseListing::setSellerType(const QString &seller_type) {
    m_seller_type = seller_type;
    m_seller_type_isSet = true;
}

bool OAIMotorcycleBaseListing::is_seller_type_Set() const{
    return m_seller_type_isSet;
}

bool OAIMotorcycleBaseListing::is_seller_type_Valid() const{
    return m_seller_type_isValid;
}

QString OAIMotorcycleBaseListing::getSource() const {
    return m_source;
}
void OAIMotorcycleBaseListing::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIMotorcycleBaseListing::is_source_Set() const{
    return m_source_isSet;
}

bool OAIMotorcycleBaseListing::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIMotorcycleBaseListing::getStockNo() const {
    return m_stock_no;
}
void OAIMotorcycleBaseListing::setStockNo(const QString &stock_no) {
    m_stock_no = stock_no;
    m_stock_no_isSet = true;
}

bool OAIMotorcycleBaseListing::is_stock_no_Set() const{
    return m_stock_no_isSet;
}

bool OAIMotorcycleBaseListing::is_stock_no_Valid() const{
    return m_stock_no_isValid;
}

QString OAIMotorcycleBaseListing::getVin() const {
    return m_vin;
}
void OAIMotorcycleBaseListing::setVin(const QString &vin) {
    m_vin = vin;
    m_vin_isSet = true;
}

bool OAIMotorcycleBaseListing::is_vin_Set() const{
    return m_vin_isSet;
}

bool OAIMotorcycleBaseListing::is_vin_Valid() const{
    return m_vin_isValid;
}

bool OAIMotorcycleBaseListing::isSet() const {
...
bool OAIMotorcycleBaseListing::isValid() const {
