...
/*
 * OAIMotorcycleBaseListing.h
 *
 * Base motorcycle listing
 */

#ifndef OAIMotorcycleBaseListing_H
#define OAIMotorcycleBaseListing_H
...
class OAIMotorcycleBaseListing : public OAIObject {
public:
    OAIMotorcycleBaseListing();
    OAIMotorcycleBaseListing(QString json);
    ~OAIMotorcycleBaseListing() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMotorcycleBaseListing)

#endif // OAIMotorcycleBaseListing_H
