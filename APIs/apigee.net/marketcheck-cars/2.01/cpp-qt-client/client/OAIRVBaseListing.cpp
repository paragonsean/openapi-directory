...
OAIRVBaseListing::OAIRVBaseListing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRVBaseListing::OAIRVBaseListing() {
    this->initializeModel();
}

OAIRVBaseListing::~OAIRVBaseListing() {}

void OAIRVBaseListing::initializeModel() {
...
void OAIRVBaseListing::fromJson(QString jsonString) {
...
void OAIRVBaseListing::fromJsonObject(QJsonObject json) {
...
QString OAIRVBaseListing::asJson() const {
...
QJsonObject OAIRVBaseListing::asJsonObject() const {
    QJsonObject obj;
    if (m_build.isSet()) {
...
OAIRVBuild OAIRVBaseListing::getBuild() const {
    return m_build;
}
void OAIRVBaseListing::setBuild(const OAIRVBuild &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIRVBaseListing::is_build_Set() const{
    return m_build_isSet;
}

bool OAIRVBaseListing::is_build_Valid() const{
    return m_build_isValid;
}

OAINestDealer OAIRVBaseListing::getDealer() const {
    return m_dealer;
}
void OAIRVBaseListing::setDealer(const OAINestDealer &dealer) {
    m_dealer = dealer;
    m_dealer_isSet = true;
}

bool OAIRVBaseListing::is_dealer_Set() const{
    return m_dealer_isSet;
}

bool OAIRVBaseListing::is_dealer_Valid() const{
    return m_dealer_isValid;
}

double OAIRVBaseListing::getDist() const {
    return m_dist;
}
void OAIRVBaseListing::setDist(const double &dist) {
    m_dist = dist;
    m_dist_isSet = true;
}

bool OAIRVBaseListing::is_dist_Set() const{
    return m_dist_isSet;
}

bool OAIRVBaseListing::is_dist_Valid() const{
    return m_dist_isValid;
}

QString OAIRVBaseListing::getDpUrl() const {
    return m_dp_url;
}
void OAIRVBaseListing::setDpUrl(const QString &dp_url) {
    m_dp_url = dp_url;
    m_dp_url_isSet = true;
}

bool OAIRVBaseListing::is_dp_url_Set() const{
    return m_dp_url_isSet;
}

bool OAIRVBaseListing::is_dp_url_Valid() const{
    return m_dp_url_isValid;
}

QString OAIRVBaseListing::getExteriorColor() const {
    return m_exterior_color;
}
void OAIRVBaseListing::setExteriorColor(const QString &exterior_color) {
    m_exterior_color = exterior_color;
    m_exterior_color_isSet = true;
}

bool OAIRVBaseListing::is_exterior_color_Set() const{
    return m_exterior_color_isSet;
}

bool OAIRVBaseListing::is_exterior_color_Valid() const{
    return m_exterior_color_isValid;
}

qint32 OAIRVBaseListing::getFirstSeenAt() const {
    return m_first_seen_at;
}
void OAIRVBaseListing::setFirstSeenAt(const qint32 &first_seen_at) {
    m_first_seen_at = first_seen_at;
    m_first_seen_at_isSet = true;
}

bool OAIRVBaseListing::is_first_seen_at_Set() const{
    return m_first_seen_at_isSet;
}

bool OAIRVBaseListing::is_first_seen_at_Valid() const{
    return m_first_seen_at_isValid;
}

QString OAIRVBaseListing::getFirstSeenAtDate() const {
    return m_first_seen_at_date;
}
void OAIRVBaseListing::setFirstSeenAtDate(const QString &first_seen_at_date) {
    m_first_seen_at_date = first_seen_at_date;
    m_first_seen_at_date_isSet = true;
}

bool OAIRVBaseListing::is_first_seen_at_date_Set() const{
    return m_first_seen_at_date_isSet;
}

bool OAIRVBaseListing::is_first_seen_at_date_Valid() const{
    return m_first_seen_at_date_isValid;
}

QString OAIRVBaseListing::getHeading() const {
    return m_heading;
}
void OAIRVBaseListing::setHeading(const QString &heading) {
    m_heading = heading;
    m_heading_isSet = true;
}

bool OAIRVBaseListing::is_heading_Set() const{
    return m_heading_isSet;
}

bool OAIRVBaseListing::is_heading_Valid() const{
    return m_heading_isValid;
}

QString OAIRVBaseListing::getId() const {
    return m_id;
}
void OAIRVBaseListing::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIRVBaseListing::is_id_Set() const{
    return m_id_isSet;
}

bool OAIRVBaseListing::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIRVBaseListing::getInteriorColor() const {
    return m_interior_color;
}
void OAIRVBaseListing::setInteriorColor(const QString &interior_color) {
    m_interior_color = interior_color;
    m_interior_color_isSet = true;
}

bool OAIRVBaseListing::is_interior_color_Set() const{
    return m_interior_color_isSet;
}

bool OAIRVBaseListing::is_interior_color_Valid() const{
    return m_interior_color_isValid;
}

QString OAIRVBaseListing::getInventoryType() const {
    return m_inventory_type;
}
void OAIRVBaseListing::setInventoryType(const QString &inventory_type) {
    m_inventory_type = inventory_type;
    m_inventory_type_isSet = true;
}

bool OAIRVBaseListing::is_inventory_type_Set() const{
    return m_inventory_type_isSet;
}

bool OAIRVBaseListing::is_inventory_type_Valid() const{
    return m_inventory_type_isValid;
}

qint32 OAIRVBaseListing::getLastSeenAt() const {
    return m_last_seen_at;
}
void OAIRVBaseListing::setLastSeenAt(const qint32 &last_seen_at) {
    m_last_seen_at = last_seen_at;
    m_last_seen_at_isSet = true;
}

bool OAIRVBaseListing::is_last_seen_at_Set() const{
    return m_last_seen_at_isSet;
}

bool OAIRVBaseListing::is_last_seen_at_Valid() const{
    return m_last_seen_at_isValid;
}

QString OAIRVBaseListing::getLastSeenAtDate() const {
    return m_last_seen_at_date;
}
void OAIRVBaseListing::setLastSeenAtDate(const QString &last_seen_at_date) {
    m_last_seen_at_date = last_seen_at_date;
    m_last_seen_at_date_isSet = true;
}

bool OAIRVBaseListing::is_last_seen_at_date_Set() const{
    return m_last_seen_at_date_isSet;
}

bool OAIRVBaseListing::is_last_seen_at_date_Valid() const{
    return m_last_seen_at_date_isValid;
}

OAIListingNestMedia OAIRVBaseListing::getMedia() const {
    return m_media;
}
void OAIRVBaseListing::setMedia(const OAIListingNestMedia &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAIRVBaseListing::is_media_Set() const{
    return m_media_isSet;
}

bool OAIRVBaseListing::is_media_Valid() const{
    return m_media_isValid;
}

qint32 OAIRVBaseListing::getMiles() const {
    return m_miles;
}
void OAIRVBaseListing::setMiles(const qint32 &miles) {
    m_miles = miles;
    m_miles_isSet = true;
}

bool OAIRVBaseListing::is_miles_Set() const{
    return m_miles_isSet;
}

bool OAIRVBaseListing::is_miles_Valid() const{
    return m_miles_isValid;
}

qint32 OAIRVBaseListing::getMsrp() const {
    return m_msrp;
}
void OAIRVBaseListing::setMsrp(const qint32 &msrp) {
    m_msrp = msrp;
    m_msrp_isSet = true;
}

bool OAIRVBaseListing::is_msrp_Set() const{
    return m_msrp_isSet;
}

bool OAIRVBaseListing::is_msrp_Valid() const{
    return m_msrp_isValid;
}

qint32 OAIRVBaseListing::getPrice() const {
    return m_price;
}
void OAIRVBaseListing::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIRVBaseListing::is_price_Set() const{
    return m_price_isSet;
}

bool OAIRVBaseListing::is_price_Valid() const{
    return m_price_isValid;
}

double OAIRVBaseListing::getScrapedAt() const {
    return m_scraped_at;
}
void OAIRVBaseListing::setScrapedAt(const double &scraped_at) {
    m_scraped_at = scraped_at;
    m_scraped_at_isSet = true;
}

bool OAIRVBaseListing::is_scraped_at_Set() const{
    return m_scraped_at_isSet;
}

bool OAIRVBaseListing::is_scraped_at_Valid() const{
    return m_scraped_at_isValid;
}

QString OAIRVBaseListing::getScrapedAtDate() const {
    return m_scraped_at_date;
}
void OAIRVBaseListing::setScrapedAtDate(const QString &scraped_at_date) {
    m_scraped_at_date = scraped_at_date;
    m_scraped_at_date_isSet = true;
}

bool OAIRVBaseListing::is_scraped_at_date_Set() const{
    return m_scraped_at_date_isSet;
}

bool OAIRVBaseListing::is_scraped_at_date_Valid() const{
    return m_scraped_at_date_isValid;
}

QString OAIRVBaseListing::getSellerType() const {
    return m_seller_type;
}
void OAIRVBaseListing::setSellerType(const QString &seller_type) {
    m_seller_type = seller_type;
    m_seller_type_isSet = true;
}

bool OAIRVBaseListing::is_seller_type_Set() const{
    return m_seller_type_isSet;
}

bool OAIRVBaseListing::is_seller_type_Valid() const{
    return m_seller_type_isValid;
}

QString OAIRVBaseListing::getSource() const {
    return m_source;
}
void OAIRVBaseListing::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIRVBaseListing::is_source_Set() const{
    return m_source_isSet;
}

bool OAIRVBaseListing::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIRVBaseListing::getStockNo() const {
    return m_stock_no;
}
void OAIRVBaseListing::setStockNo(const QString &stock_no) {
    m_stock_no = stock_no;
    m_stock_no_isSet = true;
}

bool OAIRVBaseListing::is_stock_no_Set() const{
    return m_stock_no_isSet;
}

bool OAIRVBaseListing::is_stock_no_Valid() const{
    return m_stock_no_isValid;
}

QString OAIRVBaseListing::getVin() const {
    return m_vin;
}
void OAIRVBaseListing::setVin(const QString &vin) {
    m_vin = vin;
    m_vin_isSet = true;
}

bool OAIRVBaseListing::is_vin_Set() const{
    return m_vin_isSet;
}

bool OAIRVBaseListing::is_vin_Valid() const{
    return m_vin_isValid;
}

bool OAIRVBaseListing::isSet() const {
...
bool OAIRVBaseListing::isValid() const {
