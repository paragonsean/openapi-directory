...
/*
 * OAIHeavyEquipmentsBaseListing.h
 *
 * Base heavy equipment listing
 */

#ifndef OAIHeavyEquipmentsBaseListing_H
#define OAIHeavyEquipmentsBaseListing_H
...
namespace OpenAPI {
class OAIHeavyEquipmentsBuild;
class OAINestDealer;
class OAIListingNestMedia;

class OAIHeavyEquipmentsBaseListing : public OAIObject {
public:
    OAIHeavyEquipmentsBaseListing();
    OAIHeavyEquipmentsBaseListing(QString json);
    ~OAIHeavyEquipmentsBaseListing() override;
    ...
    OAIHeavyEquipmentsBuild getBuild() const;
    void setBuild(const OAIHeavyEquipmentsBuild &build);
...
private:
    ...
    OAIHeavyEquipmentsBuild m_build;
    bool m_build_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeavyEquipmentsBaseListing)

#endif // OAIHeavyEquipmentsBaseListing_H
