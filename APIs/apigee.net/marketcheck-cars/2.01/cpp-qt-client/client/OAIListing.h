...
public:
    ...
    qint32 getFirstSeenAtMc() const;
    void setFirstSeenAtMc(const qint32 &first_seen_at_mc);
    bool is_first_seen_at_mc_Set() const;
    bool is_first_seen_at_mc_Valid() const;

    QString getFirstSeenAtMcDate() const;
    void setFirstSeenAtMcDate(const QString &first_seen_at_mc_date);
    bool is_first_seen_at_mc_date_Set() const;
    bool is_first_seen_at_mc_date_Valid() const;

    qint32 getFirstSeenAtSource() const;
    void setFirstSeenAtSource(const qint32 &first_seen_at_source);
    bool is_first_seen_at_source_Set() const;
    bool is_first_seen_at_source_Valid() const;

    QString getFirstSeenAtSourceDate() const;
    void setFirstSeenAtSourceDate(const QString &first_seen_at_source_date);
    bool is_first_seen_at_source_date_Set() const;
    bool is_first_seen_at_source_date_Valid() const;
...
private:
    ...
    qint32 m_first_seen_at_mc;
    bool m_first_seen_at_mc_isSet;
    bool m_first_seen_at_mc_isValid;

    QString m_first_seen_at_mc_date;
    bool m_first_seen_at_mc_date_isSet;
    bool m_first_seen_at_mc_date_isValid;

    qint32 m_first_seen_at_source;
    bool m_first_seen_at_source_isSet;
    bool m_first_seen_at_source_isValid;

    QString m_first_seen_at_source_date;
    bool m_first_seen_at_source_date_isSet;
    bool m_first_seen_at_source_date_isValid;
