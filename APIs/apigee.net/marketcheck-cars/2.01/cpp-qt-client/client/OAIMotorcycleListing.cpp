...
OAIMotorcycleListing::OAIMotorcycleListing(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMotorcycleListing::OAIMotorcycleListing() {
    this->initializeModel();
}

OAIMotorcycleListing::~OAIMotorcycleListing() {}

void OAIMotorcycleListing::initializeModel() {
...
void OAIMotorcycleListing::fromJson(QString jsonString) {
...
void OAIMotorcycleListing::fromJsonObject(QJsonObject json) {
...
QString OAIMotorcycleListing::asJson() const {
...
QJsonObject OAIMotorcycleListing::asJsonObject() const {
    QJsonObject obj;
    if (m_build.isSet()) {
...
OAIMotorcycleBuild OAIMotorcycleListing::getBuild() const {
    return m_build;
}
void OAIMotorcycleListing::setBuild(const OAIMotorcycleBuild &build) {
    m_build = build;
    m_build_isSet = true;
}

bool OAIMotorcycleListing::is_build_Set() const{
    return m_build_isSet;
}

bool OAIMotorcycleListing::is_build_Valid() const{
    return m_build_isValid;
}

QString OAIMotorcycleListing::getColor() const {
    return m_color;
}
void OAIMotorcycleListing::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIMotorcycleListing::is_color_Set() const{
    return m_color_isSet;
}

bool OAIMotorcycleListing::is_color_Valid() const{
    return m_color_isValid;
}

OAINestDealer OAIMotorcycleListing::getDealer() const {
    return m_dealer;
}
void OAIMotorcycleListing::setDealer(const OAINestDealer &dealer) {
    m_dealer = dealer;
    m_dealer_isSet = true;
}

bool OAIMotorcycleListing::is_dealer_Set() const{
    return m_dealer_isSet;
}

bool OAIMotorcycleListing::is_dealer_Valid() const{
    return m_dealer_isValid;
}

QString OAIMotorcycleListing::getDpUrl() const {
    return m_dp_url;
}
void OAIMotorcycleListing::setDpUrl(const QString &dp_url) {
    m_dp_url = dp_url;
    m_dp_url_isSet = true;
}

bool OAIMotorcycleListing::is_dp_url_Set() const{
    return m_dp_url_isSet;
}

bool OAIMotorcycleListing::is_dp_url_Valid() const{
    return m_dp_url_isValid;
}

OAIListingNestExtraAttributes OAIMotorcycleListing::getExtra() const {
    return m_extra;
}
void OAIMotorcycleListing::setExtra(const OAIListingNestExtraAttributes &extra) {
    m_extra = extra;
    m_extra_isSet = true;
}

bool OAIMotorcycleListing::is_extra_Set() const{
    return m_extra_isSet;
}

bool OAIMotorcycleListing::is_extra_Valid() const{
    return m_extra_isValid;
}

qint32 OAIMotorcycleListing::getFirstSeenAt() const {
    return m_first_seen_at;
}
void OAIMotorcycleListing::setFirstSeenAt(const qint32 &first_seen_at) {
    m_first_seen_at = first_seen_at;
    m_first_seen_at_isSet = true;
}

bool OAIMotorcycleListing::is_first_seen_at_Set() const{
    return m_first_seen_at_isSet;
}

bool OAIMotorcycleListing::is_first_seen_at_Valid() const{
    return m_first_seen_at_isValid;
}

QString OAIMotorcycleListing::getFirstSeenAtDate() const {
    return m_first_seen_at_date;
}
void OAIMotorcycleListing::setFirstSeenAtDate(const QString &first_seen_at_date) {
    m_first_seen_at_date = first_seen_at_date;
    m_first_seen_at_date_isSet = true;
}

bool OAIMotorcycleListing::is_first_seen_at_date_Set() const{
    return m_first_seen_at_date_isSet;
}

bool OAIMotorcycleListing::is_first_seen_at_date_Valid() const{
    return m_first_seen_at_date_isValid;
}

QString OAIMotorcycleListing::getHeading() const {
    return m_heading;
}
void OAIMotorcycleListing::setHeading(const QString &heading) {
    m_heading = heading;
    m_heading_isSet = true;
}

bool OAIMotorcycleListing::is_heading_Set() const{
    return m_heading_isSet;
}

bool OAIMotorcycleListing::is_heading_Valid() const{
    return m_heading_isValid;
}

QString OAIMotorcycleListing::getId() const {
    return m_id;
}
void OAIMotorcycleListing::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMotorcycleListing::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMotorcycleListing::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMotorcycleListing::getInventoryType() const {
    return m_inventory_type;
}
void OAIMotorcycleListing::setInventoryType(const QString &inventory_type) {
    m_inventory_type = inventory_type;
    m_inventory_type_isSet = true;
}

bool OAIMotorcycleListing::is_inventory_type_Set() const{
    return m_inventory_type_isSet;
}

bool OAIMotorcycleListing::is_inventory_type_Valid() const{
    return m_inventory_type_isValid;
}

qint32 OAIMotorcycleListing::getLastSeenAt() const {
    return m_last_seen_at;
}
void OAIMotorcycleListing::setLastSeenAt(const qint32 &last_seen_at) {
    m_last_seen_at = last_seen_at;
    m_last_seen_at_isSet = true;
}

bool OAIMotorcycleListing::is_last_seen_at_Set() const{
    return m_last_seen_at_isSet;
}

bool OAIMotorcycleListing::is_last_seen_at_Valid() const{
    return m_last_seen_at_isValid;
}

QString OAIMotorcycleListing::getLastSeenAtDate() const {
    return m_last_seen_at_date;
}
void OAIMotorcycleListing::setLastSeenAtDate(const QString &last_seen_at_date) {
    m_last_seen_at_date = last_seen_at_date;
    m_last_seen_at_date_isSet = true;
}

bool OAIMotorcycleListing::is_last_seen_at_date_Set() const{
    return m_last_seen_at_date_isSet;
}

bool OAIMotorcycleListing::is_last_seen_at_date_Valid() const{
    return m_last_seen_at_date_isValid;
}

OAIListingNestMedia OAIMotorcycleListing::getMedia() const {
    return m_media;
}
void OAIMotorcycleListing::setMedia(const OAIListingNestMedia &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAIMotorcycleListing::is_media_Set() const{
    return m_media_isSet;
}

bool OAIMotorcycleListing::is_media_Valid() const{
    return m_media_isValid;
}

qint32 OAIMotorcycleListing::getMiles() const {
    return m_miles;
}
void OAIMotorcycleListing::setMiles(const qint32 &miles) {
    m_miles = miles;
    m_miles_isSet = true;
}

bool OAIMotorcycleListing::is_miles_Set() const{
    return m_miles_isSet;
}

bool OAIMotorcycleListing::is_miles_Valid() const{
    return m_miles_isValid;
}

qint32 OAIMotorcycleListing::getMsrp() const {
    return m_msrp;
}
void OAIMotorcycleListing::setMsrp(const qint32 &msrp) {
    m_msrp = msrp;
    m_msrp_isSet = true;
}

bool OAIMotorcycleListing::is_msrp_Set() const{
    return m_msrp_isSet;
}

bool OAIMotorcycleListing::is_msrp_Valid() const{
    return m_msrp_isValid;
}

qint32 OAIMotorcycleListing::getPrice() const {
    return m_price;
}
void OAIMotorcycleListing::setPrice(const qint32 &price) {
    m_price = price;
    m_price_isSet = true;
}

bool OAIMotorcycleListing::is_price_Set() const{
    return m_price_isSet;
}

bool OAIMotorcycleListing::is_price_Valid() const{
    return m_price_isValid;
}

double OAIMotorcycleListing::getScrapedAt() const {
    return m_scraped_at;
}
void OAIMotorcycleListing::setScrapedAt(const double &scraped_at) {
    m_scraped_at = scraped_at;
    m_scraped_at_isSet = true;
}

bool OAIMotorcycleListing::is_scraped_at_Set() const{
    return m_scraped_at_isSet;
}

bool OAIMotorcycleListing::is_scraped_at_Valid() const{
    return m_scraped_at_isValid;
}

QString OAIMotorcycleListing::getScrapedAtDate() const {
    return m_scraped_at_date;
}
void OAIMotorcycleListing::setScrapedAtDate(const QString &scraped_at_date) {
    m_scraped_at_date = scraped_at_date;
    m_scraped_at_date_isSet = true;
}

bool OAIMotorcycleListing::is_scraped_at_date_Set() const{
    return m_scraped_at_date_isSet;
}

bool OAIMotorcycleListing::is_scraped_at_date_Valid() const{
    return m_scraped_at_date_isValid;
}

QString OAIMotorcycleListing::getSellerType() const {
    return m_seller_type;
}
void OAIMotorcycleListing::setSellerType(const QString &seller_type) {
    m_seller_type = seller_type;
    m_seller_type_isSet = true;
}

bool OAIMotorcycleListing::is_seller_type_Set() const{
    return m_seller_type_isSet;
}

bool OAIMotorcycleListing::is_seller_type_Valid() const{
    return m_seller_type_isValid;
}

QString OAIMotorcycleListing::getSource() const {
    return m_source;
}
void OAIMotorcycleListing::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIMotorcycleListing::is_source_Set() const{
    return m_source_isSet;
}

bool OAIMotorcycleListing::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIMotorcycleListing::getStockNo() const {
    return m_stock_no;
}
void OAIMotorcycleListing::setStockNo(const QString &stock_no) {
    m_stock_no = stock_no;
    m_stock_no_isSet = true;
}

bool OAIMotorcycleListing::is_stock_no_Set() const{
    return m_stock_no_isSet;
}

bool OAIMotorcycleListing::is_stock_no_Valid() const{
    return m_stock_no_isValid;
}

QString OAIMotorcycleListing::getVin() const {
    return m_vin;
}
void OAIMotorcycleListing::setVin(const QString &vin) {
    m_vin = vin;
    m_vin_isSet = true;
}

bool OAIMotorcycleListing::is_vin_Set() const{
    return m_vin_isSet;
}

bool OAIMotorcycleListing::is_vin_Valid() const{
    return m_vin_isValid;
}

bool OAIMotorcycleListing::isSet() const {
...
bool OAIMotorcycleListing::isValid() const {
