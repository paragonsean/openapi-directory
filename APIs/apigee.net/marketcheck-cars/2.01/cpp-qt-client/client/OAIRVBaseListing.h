...
#ifndef OAIRVBaseListing_H
#define OAIRVBaseListing_H
...
class OAIRVBaseListing : public OAIObject {
public:
    OAIRVBaseListing();
    OAIRVBaseListing(QString json);
    ~OAIRVBaseListing() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRVBaseListing)

#endif // OAIRVBaseListing_H
