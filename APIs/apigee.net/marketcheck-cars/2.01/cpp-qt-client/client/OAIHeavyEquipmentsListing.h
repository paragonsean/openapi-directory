...
/*
 * OAIHeavyEquipmentsListing.h
 *
 * Represents a full list of attributes available with Marketcheck for a car
 */

#ifndef OAIHeavyEquipmentsListing_H
#define OAIHeavyEquipmentsListing_H
...
class OAIHeavyEquipmentsListing : public OAIObject {
public:
    OAIHeavyEquipmentsListing();
    OAIHeavyEquipmentsListing(QString json);
    ~OAIHeavyEquipmentsListing() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHeavyEquipmentsListing)

#endif // OAIHeavyEquipmentsListing_H
