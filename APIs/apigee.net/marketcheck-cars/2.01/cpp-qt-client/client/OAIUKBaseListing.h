...
#ifndef OAIUKBaseListing_H
#define OAIUKBaseListing_H
...
namespace OpenAPI {
class OAIBuild;
class OAICarLocation;
class OAINestDealer;
class OAIListingFinance;
class OAIListingLease;
class OAIListingNestMedia;

class OAIUKBaseListing : public OAIObject {
public:
    OAIUKBaseListing();
    OAIUKBaseListing(QString json);
    ~OAIUKBaseListing() override;
    ...
    OAICarLocation getCarLocation() const;
    void setCarLocation(const OAICarLocation &car_location);
    bool is_car_location_Set() const;
    bool is_car_location_Valid() const;
    ...
    QString getCo2Emissions() const;
    void setCo2Emissions(const QString &co2_emissions);
    ...
    QString getInsuranceGroup() const;
    void setInsuranceGroup(const QString &insurance_group);
    ...
    QString getNumOwners() const;
    void setNumOwners(const QString &num_owners);
    ...
    QString getUvcId() const;
    void setUvcId(const QString &uvc_id);
    bool is_uvc_id_Set() const;
    bool is_uvc_id_Valid() const;
    ...
    QString getVehicleRegistrationMark() const;
    void setVehicleRegistrationMark(const QString &vehicle_registration_mark);
...
private:
    ...
    OAICarLocation m_car_location;
    bool m_car_location_isSet;
    bool m_car_location_isValid;
    ...
    QString m_uvc_id;
    bool m_uvc_id_isSet;
    bool m_uvc_id_isValid;

    QString m_vdp_url;
    bool m_vdp_url_isSet;
    bool m_vdp_url_isValid;

    QString m_vehicle_registration_mark;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUKBaseListing)

#endif // OAIUKBaseListing_H
