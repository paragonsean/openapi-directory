...
/**
 * API tests for HeavyEquipmentSearchApi
 */
@Disabled
public class HeavyEquipmentSearchApiTest {

    private final HeavyEquipmentSearchApi api = new HeavyEquipmentSearchApi();
     ...
     */
    @Test
    public void listingHeavyEquipmentIdExtraGetTest() throws ApiException {
        String id = null;
        String apiKey = null;
        ListingExtraAttributes response = api.listingHeavyEquipmentIdExtraGet(id, apiKey);
     ...
     */
    @Test
    public void listingHeavyEquipmentIdGetTest() throws ApiException {
        String id = null;
        String apiKey = null;
        HeavyEquipmentsListing response = api.listingHeavyEquipmentIdGet(id, apiKey);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listingHeavyEquipmentIdMediaGetTest() throws ApiException {
        String id = null;
        String apiKey = null;
        ListingMedia response = api.listingHeavyEquipmentIdMediaGet(id, apiKey);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void searchHeavyEquipmentActiveGetTest() throws ApiException {
        String apiKey = null;
        ...
        HeavyEquipmentsSearchResponse response = api.searchHeavyEquipmentActiveGet(apiKey, priceRange, milesRange, msrpRange, latitude, longitude, radius, searchText, year, make, model, trim, vin, inventoryType, stockNo, source, dealerName, dealerId, exteriorColor, interiorColor, engine, fuelType, transmission, drivetrain, bodyType, category, subCategory, hoursUsedRange, state, city, zip, msaCode, sortBy, sortOrder, rows, start, facets, rangeFacets, facetSort, stats, lastSeenRange, firstSeenRange, lastSeenDays, firstSeenDays);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void searchHeavyEquipmentAutoCompleteGetTest() throws ApiException {
        String field = null;
        String input = null;
        String apiKey = null;
        String year = null;
        ...
        SearchAutoCompleteResponse response = api.searchHeavyEquipmentAutoCompleteGet(field, input, apiKey, year, make, model, trim, bodyType, vehicleType, transmission, drivetrain, fuelType, color, engine, state, city, inventoryType, ignoreCase, termCounts, sortBy, sellerType, radius, zip, facetMinCount);
        // TODO: test validations
    }
