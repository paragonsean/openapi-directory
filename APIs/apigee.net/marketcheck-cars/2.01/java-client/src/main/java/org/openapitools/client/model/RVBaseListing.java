...
public class RVBaseListing {
  ...
  public RVBaseListing() {
  }

  public RVBaseListing build(RVBuild build) {
    this.build = build;
    return this;
  }
  ...
  public RVBaseListing dealer(NestDealer dealer) {
    this.dealer = dealer;
    return this;
  }
  ...
  public RVBaseListing dist(Double dist) {
    this.dist = dist;
    return this;
  }
  ...
  public RVBaseListing dpUrl(String dpUrl) {
    this.dpUrl = dpUrl;
    return this;
  }
  ...
  public RVBaseListing exteriorColor(String exteriorColor) {
  ...
  public RVBaseListing firstSeenAt(Integer firstSeenAt) {
  ...
  public RVBaseListing firstSeenAtDate(String firstSeenAtDate) {
  ...
  public RVBaseListing heading(String heading) {
  ...
  public RVBaseListing id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RVBaseListing interiorColor(String interiorColor) {
  ...
  public RVBaseListing inventoryType(String inventoryType) {
  ...
  public RVBaseListing lastSeenAt(Integer lastSeenAt) {
  ...
  public RVBaseListing lastSeenAtDate(String lastSeenAtDate) {
  ...
  public RVBaseListing media(ListingNestMedia media) {
    this.media = media;
    return this;
  }
  ...
  public RVBaseListing miles(Integer miles) {
    this.miles = miles;
    return this;
  }
  ...
  public RVBaseListing msrp(Integer msrp) {
    this.msrp = msrp;
    return this;
  }
  ...
  public RVBaseListing price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public RVBaseListing scrapedAt(BigDecimal scrapedAt) {
  ...
  public RVBaseListing scrapedAtDate(String scrapedAtDate) {
  ...
  public RVBaseListing sellerType(String sellerType) {
  ...
  public RVBaseListing source(String source) {
    this.source = source;
    return this;
  }
  ...
  public RVBaseListing stockNo(String stockNo) {
  ...
  public RVBaseListing vin(String vin) {
    this.vin = vin;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RVBaseListing rvBaseListing = (RVBaseListing) o;
    return Objects.equals(this.build, rvBaseListing.build) &&
        Objects.equals(this.dealer, rvBaseListing.dealer) &&
        Objects.equals(this.dist, rvBaseListing.dist) &&
        Objects.equals(this.dpUrl, rvBaseListing.dpUrl) &&
        Objects.equals(this.exteriorColor, rvBaseListing.exteriorColor) &&
        Objects.equals(this.firstSeenAt, rvBaseListing.firstSeenAt) &&
        Objects.equals(this.firstSeenAtDate, rvBaseListing.firstSeenAtDate) &&
        Objects.equals(this.heading, rvBaseListing.heading) &&
        Objects.equals(this.id, rvBaseListing.id) &&
        Objects.equals(this.interiorColor, rvBaseListing.interiorColor) &&
        Objects.equals(this.inventoryType, rvBaseListing.inventoryType) &&
        Objects.equals(this.lastSeenAt, rvBaseListing.lastSeenAt) &&
        Objects.equals(this.lastSeenAtDate, rvBaseListing.lastSeenAtDate) &&
        Objects.equals(this.media, rvBaseListing.media) &&
        Objects.equals(this.miles, rvBaseListing.miles) &&
        Objects.equals(this.msrp, rvBaseListing.msrp) &&
        Objects.equals(this.price, rvBaseListing.price) &&
        Objects.equals(this.scrapedAt, rvBaseListing.scrapedAt) &&
        Objects.equals(this.scrapedAtDate, rvBaseListing.scrapedAtDate) &&
        Objects.equals(this.sellerType, rvBaseListing.sellerType) &&
        Objects.equals(this.source, rvBaseListing.source) &&
        Objects.equals(this.stockNo, rvBaseListing.stockNo) &&
        Objects.equals(this.vin, rvBaseListing.vin);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RVBaseListing
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RVBaseListing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RVBaseListing is not found in the empty JSON string", RVBaseListing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RVBaseListing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RVBaseListing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RVBaseListing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RVBaseListing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RVBaseListing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RVBaseListing.class));

       return (TypeAdapter<T>) new TypeAdapter<RVBaseListing>() {
           @Override
           public void write(JsonWriter out, RVBaseListing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RVBaseListing read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RVBaseListing given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RVBaseListing
   * @throws IOException if the JSON string is invalid with respect to RVBaseListing
   */
  public static RVBaseListing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RVBaseListing.class);
  }

  /**
   * Convert an instance of RVBaseListing to an JSON string
   *
   * @return JSON string
   */
