...
public class MotorcycleListing {
  ...
  public MotorcycleListing() {
  }

  public MotorcycleListing build(MotorcycleBuild build) {
    this.build = build;
    return this;
  }
  ...
  public MotorcycleListing color(String color) {
    this.color = color;
    return this;
  }
  ...
  public MotorcycleListing dealer(NestDealer dealer) {
    this.dealer = dealer;
    return this;
  }
  ...
  public MotorcycleListing dpUrl(String dpUrl) {
    this.dpUrl = dpUrl;
    return this;
  }
  ...
  public MotorcycleListing extra(ListingNestExtraAttributes extra) {
    this.extra = extra;
    return this;
  }
  ...
  public MotorcycleListing firstSeenAt(Integer firstSeenAt) {
  ...
  public MotorcycleListing firstSeenAtDate(String firstSeenAtDate) {
  ...
  public MotorcycleListing heading(String heading) {
  ...
  public MotorcycleListing id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MotorcycleListing inventoryType(String inventoryType) {
  ...
  public MotorcycleListing lastSeenAt(Integer lastSeenAt) {
  ...
  public MotorcycleListing lastSeenAtDate(String lastSeenAtDate) {
  ...
  public MotorcycleListing media(ListingNestMedia media) {
    this.media = media;
    return this;
  }
  ...
  public MotorcycleListing miles(Integer miles) {
    this.miles = miles;
    return this;
  }
  ...
  public MotorcycleListing msrp(Integer msrp) {
    this.msrp = msrp;
    return this;
  }
  ...
  public MotorcycleListing price(Integer price) {
    this.price = price;
    return this;
  }
  ...
  public MotorcycleListing scrapedAt(BigDecimal scrapedAt) {
  ...
  public MotorcycleListing scrapedAtDate(String scrapedAtDate) {
  ...
  public MotorcycleListing sellerType(String sellerType) {
  ...
  public MotorcycleListing source(String source) {
    this.source = source;
    return this;
  }
  ...
  public MotorcycleListing stockNo(String stockNo) {
  ...
  public MotorcycleListing vin(String vin) {
    this.vin = vin;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MotorcycleListing motorcycleListing = (MotorcycleListing) o;
    return Objects.equals(this.build, motorcycleListing.build) &&
        Objects.equals(this.color, motorcycleListing.color) &&
        Objects.equals(this.dealer, motorcycleListing.dealer) &&
        Objects.equals(this.dpUrl, motorcycleListing.dpUrl) &&
        Objects.equals(this.extra, motorcycleListing.extra) &&
        Objects.equals(this.firstSeenAt, motorcycleListing.firstSeenAt) &&
        Objects.equals(this.firstSeenAtDate, motorcycleListing.firstSeenAtDate) &&
        Objects.equals(this.heading, motorcycleListing.heading) &&
        Objects.equals(this.id, motorcycleListing.id) &&
        Objects.equals(this.inventoryType, motorcycleListing.inventoryType) &&
        Objects.equals(this.lastSeenAt, motorcycleListing.lastSeenAt) &&
        Objects.equals(this.lastSeenAtDate, motorcycleListing.lastSeenAtDate) &&
        Objects.equals(this.media, motorcycleListing.media) &&
        Objects.equals(this.miles, motorcycleListing.miles) &&
        Objects.equals(this.msrp, motorcycleListing.msrp) &&
        Objects.equals(this.price, motorcycleListing.price) &&
        Objects.equals(this.scrapedAt, motorcycleListing.scrapedAt) &&
        Objects.equals(this.scrapedAtDate, motorcycleListing.scrapedAtDate) &&
        Objects.equals(this.sellerType, motorcycleListing.sellerType) &&
        Objects.equals(this.source, motorcycleListing.source) &&
        Objects.equals(this.stockNo, motorcycleListing.stockNo) &&
        Objects.equals(this.vin, motorcycleListing.vin);
  }

  @Override
  public int hashCode() {
    return Objects.hash(build, color, dealer, dpUrl, extra, firstSeenAt, firstSeenAtDate, heading, id, inventoryType, lastSeenAt, lastSeenAtDate, media, miles, msrp, price, scrapedAt, scrapedAtDate, sellerType, source, stockNo, vin);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MotorcycleListing {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MotorcycleListing
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MotorcycleListing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MotorcycleListing is not found in the empty JSON string", MotorcycleListing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MotorcycleListing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MotorcycleListing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MotorcycleListing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MotorcycleListing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MotorcycleListing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MotorcycleListing.class));

       return (TypeAdapter<T>) new TypeAdapter<MotorcycleListing>() {
           @Override
           public void write(JsonWriter out, MotorcycleListing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MotorcycleListing read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MotorcycleListing given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MotorcycleListing
   * @throws IOException if the JSON string is invalid with respect to MotorcycleListing
   */
  public static MotorcycleListing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MotorcycleListing.class);
  }

  /**
   * Convert an instance of MotorcycleListing to an JSON string
   *
   * @return JSON string
   */
