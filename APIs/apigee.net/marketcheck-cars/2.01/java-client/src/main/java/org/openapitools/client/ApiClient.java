...
public class ApiClient {
    ...
    private String basePath = "https://marketcheck-prod.apigee.net/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("authorizeEndpoint", new HttpBasicAuth());
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://marketcheck-prod.apigee.net/v2
