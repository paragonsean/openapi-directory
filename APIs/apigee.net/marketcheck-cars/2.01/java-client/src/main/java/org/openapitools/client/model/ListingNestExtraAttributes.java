...
public class ListingNestExtraAttributes {
  ...
  public static final String SERIALIZED_NAME_SELLER_COMMENTS = "seller_comments";
  @SerializedName(SERIALIZED_NAME_SELLER_COMMENTS)
  ...
  public ListingNestExtraAttributes() {
  }

  public ListingNestExtraAttributes dealerAddedF(List<String> dealerAddedF) {
    this.dealerAddedF = dealerAddedF;
    return this;
  }

  public ListingNestExtraAttributes addDealerAddedFItem(String dealerAddedFItem) {
  ...
  public ListingNestExtraAttributes electronicsF(List<String> electronicsF) {
    this.electronicsF = electronicsF;
    return this;
  }

  public ListingNestExtraAttributes addElectronicsFItem(String electronicsFItem) {
  ...
  public ListingNestExtraAttributes exteriorF(List<String> exteriorF) {
    this.exteriorF = exteriorF;
    return this;
  }

  public ListingNestExtraAttributes addExteriorFItem(String exteriorFItem) {
  ...
  public ListingNestExtraAttributes features(List<String> features) {
    this.features = features;
    return this;
  }

  public ListingNestExtraAttributes addFeaturesItem(String featuresItem) {
  ...
  public ListingNestExtraAttributes interiorF(List<String> interiorF) {
    this.interiorF = interiorF;
    return this;
  }

  public ListingNestExtraAttributes addInteriorFItem(String interiorFItem) {
  ...
  public ListingNestExtraAttributes options(List<String> options) {
    this.options = options;
    return this;
  }

  public ListingNestExtraAttributes addOptionsItem(String optionsItem) {
  ...
  public ListingNestExtraAttributes safetyF(List<String> safetyF) {
    this.safetyF = safetyF;
    return this;
  }

  public ListingNestExtraAttributes addSafetyFItem(String safetyFItem) {
  ...
  public ListingNestExtraAttributes sellerComments(String sellerComments) {
  ...
  public ListingNestExtraAttributes standardF(List<String> standardF) {
    this.standardF = standardF;
    return this;
  }

  public ListingNestExtraAttributes addStandardFItem(String standardFItem) {
  ...
  public ListingNestExtraAttributes technicalF(List<String> technicalF) {
    this.technicalF = technicalF;
    return this;
  }

  public ListingNestExtraAttributes addTechnicalFItem(String technicalFItem) {
  ...
  public boolean equals(Object o) {
    ...
    ListingNestExtraAttributes listingNestExtraAttributes = (ListingNestExtraAttributes) o;
    return Objects.equals(this.dealerAddedF, listingNestExtraAttributes.dealerAddedF) &&
        Objects.equals(this.electronicsF, listingNestExtraAttributes.electronicsF) &&
        Objects.equals(this.exteriorF, listingNestExtraAttributes.exteriorF) &&
        Objects.equals(this.features, listingNestExtraAttributes.features) &&
        Objects.equals(this.interiorF, listingNestExtraAttributes.interiorF) &&
        Objects.equals(this.options, listingNestExtraAttributes.options) &&
        Objects.equals(this.safetyF, listingNestExtraAttributes.safetyF) &&
        Objects.equals(this.sellerComments, listingNestExtraAttributes.sellerComments) &&
        Objects.equals(this.standardF, listingNestExtraAttributes.standardF) &&
        Objects.equals(this.technicalF, listingNestExtraAttributes.technicalF);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dealerAddedF, electronicsF, exteriorF, features, interiorF, options, safetyF, sellerComments, standardF, technicalF);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListingNestExtraAttributes {\n");
    ...
    sb.append("    sellerComments: ").append(toIndentedString(sellerComments)).append("\n");
  ...
  static {
    ...
    openapiFields.add("seller_comments");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListingNestExtraAttributes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListingNestExtraAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListingNestExtraAttributes is not found in the empty JSON string", ListingNestExtraAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListingNestExtraAttributes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListingNestExtraAttributes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("seller_comments") != null && !jsonObj.get("seller_comments").isJsonNull()) && !jsonObj.get("seller_comments").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `seller_comments` to be a primitive type in the JSON string but got `%s`", jsonObj.get("seller_comments").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListingNestExtraAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListingNestExtraAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListingNestExtraAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListingNestExtraAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<ListingNestExtraAttributes>() {
           @Override
           public void write(JsonWriter out, ListingNestExtraAttributes value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListingNestExtraAttributes read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListingNestExtraAttributes given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListingNestExtraAttributes
   * @throws IOException if the JSON string is invalid with respect to ListingNestExtraAttributes
   */
  public static ListingNestExtraAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListingNestExtraAttributes.class);
  }

  /**
   * Convert an instance of ListingNestExtraAttributes to an JSON string
   *
   * @return JSON string
   */
