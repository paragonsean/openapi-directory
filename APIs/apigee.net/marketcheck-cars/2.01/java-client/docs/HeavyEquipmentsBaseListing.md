...
|**dist** | **Double** | Distance of the quipments&#39;s location from the specified user lcoation |  [optional] |
|**dpUrl** | **String** | Details Page url of the specific heavy equipment |  [optional] |
|**exteriorColor** | **String** | Exterior color of the heavy equipment |  [optional] |
...
|**interiorColor** | **String** | Interior color of the heavy equipment |  [optional] |
|**inventoryType** | **String** | Inventory type of heavy equipment |  [optional] |
...
|**miles** | **Integer** | Odometer reading / reported miles usage for the heavy equipment |  [optional] |
|**msrp** | **Integer** | MSRP for the heavy equipment |  [optional] |
|**price** | **Integer** | Asking price for the heavy equipment |  [optional] |
|**scrapedAt** | **BigDecimal** | Listing last seen at date timestamp |  [optional] |
|**scrapedAtDate** | **String** | Listing last seen at date |  [optional] |
|**sellerType** | **String** | Seller type for the heavy equipment |  [optional] |
|**source** | **String** | Source domain of the listing |  [optional] |
|**stockNo** | **String** | Stock number of heavy equipment in dealers inventory |  [optional] |
|**vin** | **String** | VIN for the heavy equipment |  [optional] |
