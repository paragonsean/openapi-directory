# MarketcheckApis.RankCarListingsApi
...
> CarRankResponse rankCar(carRankRequest, opts)
...
let apiInstance = new MarketcheckApis.RankCarListingsApi();
let carRankRequest = new MarketcheckApis.CarRankRequest(); // CarRankRequest | Inputs needed for ranking a group of car listings
let opts = {
...
apiInstance.rankCar(carRankRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> CarRankResponse searchAndRankCar(carRankRequest, opts)
...
let opts = {
  ...
  'milesRange': "'1-'", // String | Miles range to filter listings with miles in the given range. Range to be given in the format - min-max e.g. 1000-5000
  'priceRange': "'1-'", // String | Price range to filter listings with the price in the range given. Range to be given in the format - min-max e.g. 1000-5000
...
apiInstance.searchAndRankCar(carRankRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
