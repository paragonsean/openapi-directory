...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketcheckApis.RVBaseListing();
  });
  ...
  describe('RVBaseListing', function() {
    it('should create an instance of RVBaseListing', function() {
      // uncomment below and update the code to test RVBaseListing
      //var instance = new MarketcheckApis.RVBaseListing();
      //expect(instance).to.be.a(MarketcheckApis.RVBaseListing);
    });
