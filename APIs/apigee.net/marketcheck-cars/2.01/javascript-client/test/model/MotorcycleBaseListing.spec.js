...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketcheckApis.MotorcycleBaseListing();
  });
  ...
  describe('MotorcycleBaseListing', function() {
    it('should create an instance of MotorcycleBaseListing', function() {
      // uncomment below and update the code to test MotorcycleBaseListing
      //var instance = new MarketcheckApis.MotorcycleBaseListing();
      //expect(instance).to.be.a(MarketcheckApis.MotorcycleBaseListing);
    });
