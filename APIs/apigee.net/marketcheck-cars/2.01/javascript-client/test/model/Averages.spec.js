...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketcheckApis.Averages();
  });
  ...
  describe('Averages', function() {
    it('should create an instance of Averages', function() {
      // uncomment below and update the code to test Averages
      //var instance = new MarketcheckApis.Averages();
      //expect(instance).to.be.a(MarketcheckApis.Averages);
    });
