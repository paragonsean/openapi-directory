...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketcheckApis.RVSearchFacets();
  });
  ...
  describe('RVSearchFacets', function() {
    it('should create an instance of RVSearchFacets', function() {
      // uncomment below and update the code to test RVSearchFacets
      //var instance = new MarketcheckApis.RVSearchFacets();
      //expect(instance).to.be.a(MarketcheckApis.RVSearchFacets);
    });
    ...
    it('should have the property awnings (base name: "awnings")', function() {
      // uncomment below and update the code to test the property awnings
      //var instance = new MarketcheckApis.RVSearchFacets();
      //expect(instance).to.be();
    });
