...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketcheckApis.MotorcycleListing();
  });
  ...
  describe('MotorcycleListing', function() {
    it('should create an instance of MotorcycleListing', function() {
      // uncomment below and update the code to test MotorcycleListing
      //var instance = new MarketcheckApis.MotorcycleListing();
      //expect(instance).to.be.a(MarketcheckApis.MotorcycleListing);
    });
