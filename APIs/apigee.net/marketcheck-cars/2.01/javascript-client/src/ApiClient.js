...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://marketcheck-prod.apigee.net/v2') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://marketcheck-prod.apigee.net/v2
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2.01/Javascript'
        };
