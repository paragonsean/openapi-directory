...
/**
 * The RVListing model module.
 * @module model/RVListing
 * @version 2.01
 */
class RVListing {
    /**
     * Constructs a new <code>RVListing</code>.
     * Represents a full list of attributes available with Marketcheck for a car
     * @alias module:model/RVListing
     */
    constructor() { 
        
        RVListing.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RVListing</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RVListing} obj Optional instance to populate.
     * @return {module:model/RVListing} The populated <code>RVListing</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RVListing();
    ...
    /**
     * Validates the JSON data with respect to <code>RVListing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RVListing</code>.
     */
