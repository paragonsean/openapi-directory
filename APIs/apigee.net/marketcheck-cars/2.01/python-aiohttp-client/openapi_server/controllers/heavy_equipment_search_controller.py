...
async def listing_heavy_equipment_id_extra_get(request: web.Request, id, api_key=None) -> web.Response:
...
async def listing_heavy_equipment_id_get(request: web.Request, id, api_key=None) -> web.Response:
...
async def listing_heavy_equipment_id_media_get(request: web.Request, id, api_key=None) -> web.Response:
    """Listing media by id
...
async def search_heavy_equipment_active_get(request: web.Request, api_key=None, price_range=None, miles_range=None, msrp_range=None, latitude=None, longitude=None, radius=None, search_text=None, year=None, make=None, model=None, trim=None, vin=None, inventory_type=None, stock_no=None, source=None, dealer_name=None, dealer_id=None, exterior_color=None, interior_color=None, engine=None, fuel_type=None, transmission=None, drivetrain=None, body_type=None, category=None, sub_category=None, hours_used_range=None, state=None, city=None, zip=None, msa_code=None, sort_by=None, sort_order=None, rows=None, start=None, facets=None, range_facets=None, facet_sort=None, stats=None, last_seen_range=None, first_seen_range=None, last_seen_days=None, first_seen_days=None) -> web.Response:
