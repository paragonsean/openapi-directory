# GooglePayPassesApi.EventDateTime

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**customDoorsOpenLabel** | [**LocalizedString**](LocalizedString.md) |  | [optional] 
...
**kind** | **String** | Identifies what kind of resource this is. Value: the fixed string &#x60;\&quot;walletobjects#eventDateTime\&quot;&#x60;. | [optional] 
...
* `DOORS_OPEN_LABEL_UNSPECIFIED` (value: `"DOORS_OPEN_LABEL_UNSPECIFIED"`)

* `DOORS_OPEN` (value: `"DOORS_OPEN"`)

* `doorsOpen` (value: `"doorsOpen"`)

* `GATES_OPEN` (value: `"GATES_OPEN"`)

* `gatesOpen` (value: `"gatesOpen"`)
