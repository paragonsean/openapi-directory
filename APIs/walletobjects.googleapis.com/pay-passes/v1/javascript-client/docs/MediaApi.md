...
> UploadPrivateImageResponse walletobjectsMediaUpload(issuerId, opts)
...
let apiInstance = new GooglePayPassesApi.MediaApi();
let issuerId = "issuerId_example"; // String | The ID of the issuer sending the image.
let opts = {
  ...
  'uploadPrivateImageRequest': new GooglePayPassesApi.UploadPrivateImageRequest() // UploadPrivateImageRequest | 
};
apiInstance.walletobjectsMediaUpload(issuerId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
