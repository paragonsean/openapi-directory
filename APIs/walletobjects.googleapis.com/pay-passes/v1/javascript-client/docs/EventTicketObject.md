# GooglePayPassesApi.EventTicketObject
...
**classReference** | [**EventTicketClass**](EventTicketClass.md) |  | [optional] 
...
**kind** | **String** | Identifies what kind of resource this is. Value: the fixed string &#x60;\&quot;walletobjects#eventTicketObject\&quot;&#x60;. | [optional] 
**linkedOfferIds** | **[String]** | A list of offer objects linked to this event ticket. The offer objects must already exist. Offer object IDs should follow the format issuer ID. identifier where the former is issued by Google and latter is chosen by you. | [optional] 
...
**reservationInfo** | [**EventReservationInfo**](EventReservationInfo.md) |  | [optional] 
**rotatingBarcode** | [**RotatingBarcode**](RotatingBarcode.md) |  | [optional] 
**seatInfo** | [**EventSeat**](EventSeat.md) |  | [optional] 
...
**ticketHolderName** | **String** | Name of the ticket holder, if the ticket is assigned to a person. E.g. \&quot;John Doe\&quot; or \&quot;Jane Doe\&quot;. | [optional] 
**ticketNumber** | **String** | The number of the ticket. This can be a unique identifier across all tickets in an issuer&#39;s system, all tickets for the event (e.g. XYZ1234512345), or all tickets in the order (1, 2, 3, etc.). | [optional] 
**ticketType** | [**LocalizedString**](LocalizedString.md) |  | [optional] 
