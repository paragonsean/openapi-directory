...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePayPassesApi.FieldReference();
  });
  ...
  describe('FieldReference', function() {
    it('should create an instance of FieldReference', function() {
      // uncomment below and update the code to test FieldReference
      //var instance = new GooglePayPassesApi.FieldReference();
      //expect(instance).to.be.a(GooglePayPassesApi.FieldReference);
    });
