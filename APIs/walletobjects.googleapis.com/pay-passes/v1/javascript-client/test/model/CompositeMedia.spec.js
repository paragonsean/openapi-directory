...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GooglePayPassesApi.CompositeMedia();
  });
  ...
  describe('CompositeMedia', function() {
    it('should create an instance of CompositeMedia', function() {
      ...
      //var instance = new GooglePayPassesApi.CompositeMedia();
      //expect(instance).to.be.a(GooglePayPassesApi.CompositeMedia);
    });
