...
/**
 * The EventTicketObject model module.
 * @module model/EventTicketObject
 * @version v1
 */
class EventTicketObject {
    /**
     * Constructs a new <code>EventTicketObject</code>.
     * @alias module:model/EventTicketObject
     */
    constructor() { 
        
        EventTicketObject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventTicketObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventTicketObject} obj Optional instance to populate.
     * @return {module:model/EventTicketObject} The populated <code>EventTicketObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventTicketObject();
            ...
            if (data.hasOwnProperty('classReference')) {
                obj['classReference'] = EventTicketClass.constructFromObject(data['classReference']);
            }
            ...
            if (data.hasOwnProperty('reservationInfo')) {
                obj['reservationInfo'] = EventReservationInfo.constructFromObject(data['reservationInfo']);
            }
            if (data.hasOwnProperty('rotatingBarcode')) {
                obj['rotatingBarcode'] = RotatingBarcode.constructFromObject(data['rotatingBarcode']);
            }
            if (data.hasOwnProperty('seatInfo')) {
                obj['seatInfo'] = EventSeat.constructFromObject(data['seatInfo']);
            }
            ...
            if (data.hasOwnProperty('ticketHolderName')) {
                obj['ticketHolderName'] = ApiClient.convertToType(data['ticketHolderName'], 'String');
            }
            ...
            if (data.hasOwnProperty('ticketType')) {
                obj['ticketType'] = LocalizedString.constructFromObject(data['ticketType']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EventTicketObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventTicketObject</code>.
     */
    static validateJSON(data) {
        ...
        if (data['classReference']) { // data not null
          EventTicketClass.validateJSON(data['classReference']);
        }
        ...
        if (data['reservationInfo']) { // data not null
          EventReservationInfo.validateJSON(data['reservationInfo']);
        }
        ...
        if (data['seatInfo']) { // data not null
          EventSeat.validateJSON(data['seatInfo']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['ticketHolderName'] && !(typeof data['ticketHolderName'] === 'string' || data['ticketHolderName'] instanceof String)) {
            throw new Error("Expected the field `ticketHolderName` to be a primitive type in the JSON string but got " + data['ticketHolderName']);
        }
        // ensure the json data is a string
        ...
        if (data['ticketType']) { // data not null
          LocalizedString.validateJSON(data['ticketType']);
        }
 ...
 */
EventTicketObject.prototype['appLinkData'] = undefined;

/**
 * @member {module:model/Barcode} barcode
 */
EventTicketObject.prototype['barcode'] = undefined;
 ...
 */
EventTicketObject.prototype['classId'] = undefined;

/**
 * @member {module:model/EventTicketClass} classReference
 */
EventTicketObject.prototype['classReference'] = undefined;
 ...
 */
EventTicketObject.prototype['linkedOfferIds'] = undefined;

/**
 * @member {module:model/LinksModuleData} linksModuleData
 */
EventTicketObject.prototype['linksModuleData'] = undefined;

/**
 * Note: This field is currently not supported to trigger geo notifications.
 * @member {Array.<module:model/LatLongPoint>} locations
 */
EventTicketObject.prototype['locations'] = undefined;

/**
 * An array of messages displayed in the app. All users of this object will receive its associated messages. The maximum number of these fields is 10.
 * @member {Array.<module:model/Message>} messages
 */
EventTicketObject.prototype['messages'] = undefined;

/**
 * @member {module:model/PassConstraints} passConstraints
 */
EventTicketObject.prototype['passConstraints'] = undefined;

/**
 * @member {module:model/EventReservationInfo} reservationInfo
 */
EventTicketObject.prototype['reservationInfo'] = undefined;

/**
 * @member {module:model/RotatingBarcode} rotatingBarcode
 */
EventTicketObject.prototype['rotatingBarcode'] = undefined;

/**
 * @member {module:model/EventSeat} seatInfo
 */
EventTicketObject.prototype['seatInfo'] = undefined;
 ...
 */
EventTicketObject.prototype['smartTapRedemptionValue'] = undefined;
 ...
 * @member {module:model/EventTicketObject.StateEnum} state
 */
EventTicketObject.prototype['state'] = undefined;

/**
 * Text module data. If text module data is also defined on the class, both will be displayed. The maximum number of these fields displayed is 10 from the object and 10 from the class.
 * @member {Array.<module:model/TextModuleData>} textModulesData
 */
EventTicketObject.prototype['textModulesData'] = undefined;

/**
 * Name of the ticket holder, if the ticket is assigned to a person. E.g. \"John Doe\" or \"Jane Doe\".
 * @member {String} ticketHolderName
 */
EventTicketObject.prototype['ticketHolderName'] = undefined;
 ...
 */
EventTicketObject.prototype['ticketNumber'] = undefined;

/**
 * @member {module:model/LocalizedString} ticketType
 */
EventTicketObject.prototype['ticketType'] = undefined;

/**
 * @member {module:model/TimeInterval} validTimeInterval
 */
EventTicketObject.prototype['validTimeInterval'] = undefined;

/**
 * Deprecated
 * @member {String} version
 */
EventTicketObject.prototype['version'] = undefined;
...
export default EventTicketObject;
