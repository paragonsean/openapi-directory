...
async def test_walletobjects_issuer_insert(client):
    ...
    """
    body = {"issuerId":"issuerId","contactInfo":{"alertsEmails":["alertsEmails","alertsEmails"],"phone":"phone","name":"name","email":"email"},"homepageUrl":"homepageUrl","name":"name","smartTapMerchantData":{"smartTapMerchantId":"smartTapMerchantId","authenticationKeys":[{"publicKeyPem":"publicKeyPem","id":0},{"publicKeyPem":"publicKeyPem","id":0}]}}
    params = [('$.xgafv', 'xgafv_example'),
                    ('access_token', 'access_token_example'),
                    ('alt', 'alt_example'),
                    ('callback', 'param_callback_example'),
