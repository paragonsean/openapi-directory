...
class RotatingBarcode(Model):
    ...
    def __init__(self, alternate_text: str=None, render_encoding: str=None, show_code_text: LocalizedString=None, totp_details: RotatingBarcodeTotpDetails=None, type: str=None, value_pattern: str=None):
