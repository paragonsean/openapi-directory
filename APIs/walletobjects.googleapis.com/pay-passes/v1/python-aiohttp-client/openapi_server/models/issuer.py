...
class Issuer(Model):
    ...
    def __init__(self, contact_info: IssuerContactInfo=None, homepage_url: str=None, issuer_id: str=None, name: str=None, smart_tap_merchant_data: SmartTapMerchantData=None):
