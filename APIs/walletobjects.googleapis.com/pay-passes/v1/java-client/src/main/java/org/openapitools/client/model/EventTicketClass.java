...
public class EventTicketClass {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMultipleUsersPerObject, callbackOptions, classTemplateInfo, confirmationCodeLabel, countryCode, customConfirmationCodeLabel, customGateLabel, customRowLabel, customSeatLabel, customSectionLabel, dateTime, enableSmartTap, eventId, eventName, finePrint, gateLabel, heroImage, hexBackgroundColor, homepageUri, id, imageModulesData, infoModuleData, issuerName, kind, linksModuleData, localizedIssuerName, locations, logo, messages, multipleDevicesAndHoldersAllowedStatus, redemptionIssuers, review, reviewStatus, rowLabel, seatLabel, sectionLabel, securityAnimation, textModulesData, venue, version, viewUnlockRequirement, wordMark);
  }
