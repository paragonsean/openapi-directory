...
public class FlightObject {
  ...
  public static final String SERIALIZED_NAME_BOARDING_AND_SEATING_INFO = "boardingAndSeatingInfo";
  @SerializedName(SERIALIZED_NAME_BOARDING_AND_SEATING_INFO)
  ...
  public static final String SERIALIZED_NAME_SECURITY_PROGRAM_LOGO = "securityProgramLogo";
  @SerializedName(SERIALIZED_NAME_SECURITY_PROGRAM_LOGO)
  ...
  public FlightObject appLinkData(AppLinkData appLinkData) {
  ...
  public FlightObject barcode(Barcode barcode) {
  ...
  public FlightObject boardingAndSeatingInfo(BoardingAndSeatingInfo boardingAndSeatingInfo) {
    this.boardingAndSeatingInfo = boardingAndSeatingInfo;
    return this;
  }

  /**
   * Get boardingAndSeatingInfo
  ...
  public FlightObject classId(String classId) {
  ...
  public FlightObject classReference(FlightClass classReference) {
  ...
  public void setClassReference(FlightClass classReference) {
    this.classReference = classReference;
  }


  public FlightObject disableExpirationNotification(Boolean disableExpirationNotification) {
  ...
  public FlightObject groupingInfo(GroupingInfo groupingInfo) {
  ...
  public FlightObject hasLinkedDevice(Boolean hasLinkedDevice) {
  ...
  public FlightObject hasUsers(Boolean hasUsers) {
  ...
  public FlightObject heroImage(Image heroImage) {
  ...
  public FlightObject hexBackgroundColor(String hexBackgroundColor) {
  ...
  public FlightObject id(String id) {
    this.id = id;
    return this;
  }
  ...
  public FlightObject imageModulesData(List<ImageModuleData> imageModulesData) {
    this.imageModulesData = imageModulesData;
    return this;
  }

  public FlightObject addImageModulesDataItem(ImageModuleData imageModulesDataItem) {
  ...
  public FlightObject infoModuleData(InfoModuleData infoModuleData) {
  ...
  public FlightObject kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public FlightObject linksModuleData(LinksModuleData linksModuleData) {
  ...
  public FlightObject locations(List<LatLongPoint> locations) {
    this.locations = locations;
    return this;
  }

  public FlightObject addLocationsItem(LatLongPoint locationsItem) {
  ...
  public FlightObject messages(List<Message> messages) {
    this.messages = messages;
    return this;
  }

  public FlightObject addMessagesItem(Message messagesItem) {
  ...
  public FlightObject passConstraints(PassConstraints passConstraints) {
  ...
  public FlightObject passengerName(String passengerName) {
  ...
  public FlightObject reservationInfo(ReservationInfo reservationInfo) {
  ...
  public FlightObject rotatingBarcode(RotatingBarcode rotatingBarcode) {
  ...
  public FlightObject securityProgramLogo(Image securityProgramLogo) {
    this.securityProgramLogo = securityProgramLogo;
    return this;
  }

  /**
   * Get securityProgramLogo
  ...
  public void setSecurityProgramLogo(Image securityProgramLogo) {
    this.securityProgramLogo = securityProgramLogo;
  }


  public FlightObject smartTapRedemptionValue(String smartTapRedemptionValue) {
  ...
  public FlightObject state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  public FlightObject textModulesData(List<TextModuleData> textModulesData) {
    this.textModulesData = textModulesData;
    return this;
  }

  public FlightObject addTextModulesDataItem(TextModuleData textModulesDataItem) {
  ...
  public FlightObject validTimeInterval(TimeInterval validTimeInterval) {
  ...
  public FlightObject version(String version) {
  ...
  public boolean equals(Object o) {
    ...
    FlightObject flightObject = (FlightObject) o;
    return Objects.equals(this.appLinkData, flightObject.appLinkData) &&
        Objects.equals(this.barcode, flightObject.barcode) &&
        Objects.equals(this.boardingAndSeatingInfo, flightObject.boardingAndSeatingInfo) &&
        Objects.equals(this.classId, flightObject.classId) &&
        Objects.equals(this.classReference, flightObject.classReference) &&
        Objects.equals(this.disableExpirationNotification, flightObject.disableExpirationNotification) &&
        Objects.equals(this.groupingInfo, flightObject.groupingInfo) &&
        Objects.equals(this.hasLinkedDevice, flightObject.hasLinkedDevice) &&
        Objects.equals(this.hasUsers, flightObject.hasUsers) &&
        Objects.equals(this.heroImage, flightObject.heroImage) &&
        Objects.equals(this.hexBackgroundColor, flightObject.hexBackgroundColor) &&
        Objects.equals(this.id, flightObject.id) &&
        Objects.equals(this.imageModulesData, flightObject.imageModulesData) &&
        Objects.equals(this.infoModuleData, flightObject.infoModuleData) &&
        Objects.equals(this.kind, flightObject.kind) &&
        Objects.equals(this.linksModuleData, flightObject.linksModuleData) &&
        Objects.equals(this.locations, flightObject.locations) &&
        Objects.equals(this.messages, flightObject.messages) &&
        Objects.equals(this.passConstraints, flightObject.passConstraints) &&
        Objects.equals(this.passengerName, flightObject.passengerName) &&
        Objects.equals(this.reservationInfo, flightObject.reservationInfo) &&
        Objects.equals(this.rotatingBarcode, flightObject.rotatingBarcode) &&
        Objects.equals(this.securityProgramLogo, flightObject.securityProgramLogo) &&
        Objects.equals(this.smartTapRedemptionValue, flightObject.smartTapRedemptionValue) &&
        Objects.equals(this.state, flightObject.state) &&
        Objects.equals(this.textModulesData, flightObject.textModulesData) &&
        Objects.equals(this.validTimeInterval, flightObject.validTimeInterval) &&
        Objects.equals(this.version, flightObject.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appLinkData, barcode, boardingAndSeatingInfo, classId, classReference, disableExpirationNotification, groupingInfo, hasLinkedDevice, hasUsers, heroImage, hexBackgroundColor, id, imageModulesData, infoModuleData, kind, linksModuleData, locations, messages, passConstraints, passengerName, reservationInfo, rotatingBarcode, securityProgramLogo, smartTapRedemptionValue, state, textModulesData, validTimeInterval, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FlightObject {\n");
    sb.append("    appLinkData: ").append(toIndentedString(appLinkData)).append("\n");
    sb.append("    barcode: ").append(toIndentedString(barcode)).append("\n");
    sb.append("    boardingAndSeatingInfo: ").append(toIndentedString(boardingAndSeatingInfo)).append("\n");
    ...
    sb.append("    securityProgramLogo: ").append(toIndentedString(securityProgramLogo)).append("\n");
  ...
  static {
    ...
    openapiFields.add("boardingAndSeatingInfo");
    ...
    openapiFields.add("passengerName");
    openapiFields.add("reservationInfo");
    openapiFields.add("rotatingBarcode");
    openapiFields.add("securityProgramLogo");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FlightObject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlightObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FlightObject is not found in the empty JSON string", FlightObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlightObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlightObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("boardingAndSeatingInfo") != null && !jsonObj.get("boardingAndSeatingInfo").isJsonNull()) {
        BoardingAndSeatingInfo.validateJsonElement(jsonObj.get("boardingAndSeatingInfo"));
      }
      ...
      if (jsonObj.get("classReference") != null && !jsonObj.get("classReference").isJsonNull()) {
        FlightClass.validateJsonElement(jsonObj.get("classReference"));
      }
      ...
      if ((jsonObj.get("passengerName") != null && !jsonObj.get("passengerName").isJsonNull()) && !jsonObj.get("passengerName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `passengerName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("passengerName").toString()));
      }
      // validate the optional field `reservationInfo`
      if (jsonObj.get("reservationInfo") != null && !jsonObj.get("reservationInfo").isJsonNull()) {
        ReservationInfo.validateJsonElement(jsonObj.get("reservationInfo"));
      }
      ...
      if (jsonObj.get("securityProgramLogo") != null && !jsonObj.get("securityProgramLogo").isJsonNull()) {
        Image.validateJsonElement(jsonObj.get("securityProgramLogo"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FlightObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FlightObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FlightObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FlightObject.class));

       return (TypeAdapter<T>) new TypeAdapter<FlightObject>() {
           @Override
           public void write(JsonWriter out, FlightObject value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FlightObject read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FlightObject given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FlightObject
   * @throws IOException if the JSON string is invalid with respect to FlightObject
   */
  public static FlightObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FlightObject.class);
  }

  /**
   * Convert an instance of FlightObject to an JSON string
   *
   * @return JSON string
   */
