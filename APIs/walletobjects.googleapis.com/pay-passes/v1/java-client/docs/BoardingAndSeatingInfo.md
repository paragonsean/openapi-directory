...
|------------ | ------------- | ------------- | -------------|
|**boardingDoor** | [**BoardingDoorEnum**](#BoardingDoorEnum) | Set this field only if this flight boards through more than one door or bridge and you want to explicitly print the door location on the boarding pass. Most airlines route their passengers to the right door or bridge by refering to doors/bridges by the &#x60;seatClass&#x60;. In those cases &#x60;boardingDoor&#x60; should not be set. |  [optional] |
