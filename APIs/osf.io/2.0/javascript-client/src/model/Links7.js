...
class Links7 {
    ...
    /**
     * Validates the JSON data with respect to <code>Links7</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Links7</code>.
     */
 ...
 * @member {String} html
 */
Links7.prototype['html'] = undefined;

/**
 * A link to the canonical API endpoint of this node.
 * @member {String} self
 */
Links7.prototype['self'] = undefined;
