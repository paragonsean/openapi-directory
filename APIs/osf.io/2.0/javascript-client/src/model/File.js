...
import Relationships6 from './Relationships6';
...
class File {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('attributes')) {
                obj['attributes'] = Attributes9.constructFromObject(data['attributes']);
            }
            if (data.hasOwnProperty('id')) {
                obj['id'] = ApiClient.convertToType(data['id'], 'String');
            }
            if (data.hasOwnProperty('links')) {
                obj['links'] = Links6.constructFromObject(data['links']);
            }
            if (data.hasOwnProperty('relationships')) {
                obj['relationships'] = Relationships6.constructFromObject(data['relationships']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['attributes']) { // data not null
          Attributes9.validateJSON(data['attributes']);
        }
        ...
        if (data['links']) { // data not null
          Links6.validateJSON(data['links']);
        }
        // validate the optional field `relationships`
        if (data['relationships']) { // data not null
          Relationships6.validateJSON(data['relationships']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/Attributes9} attributes
 */
...
/**
 * @member {module:model/Links6} links
 */
File.prototype['links'] = undefined;

/**
 * @member {module:model/Relationships6} relationships
 */
File.prototype['relationships'] = undefined;
