...
export default class LogsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the logsActions operation.
     * @callback module:api/LogsApi~logsActionsCallback
     ...
     * @param {module:api/LogsApi~logsActionsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    logsActions(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the logsRead operation.
     * @callback module:api/LogsApi~logsReadCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} logId The unique identifier of the log you wish to retrieve.
     * @param {module:api/LogsApi~logsReadCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Log}
     */
    logsRead(logId, callback) {
      let postBody = null;
      // verify the required parameter 'logId' is set
      if (logId === undefined || logId === null) {
        throw new Error("Missing the required parameter 'logId' when calling logsRead");
      }
