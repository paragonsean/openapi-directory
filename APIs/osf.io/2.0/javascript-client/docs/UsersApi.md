# OsfApiv2Documentation.UsersApi
...
> [AddonAccount] usersAddonAccountsList(userId, provider)
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
let provider = "provider_example"; // String | The unique identifier of the addon provider.
apiInstance.usersAddonAccountsList(userId, provider, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let userId = "userId_example"; // String | The unique identifier of the user.
let provider = "provider_example"; // String | The unique identifier of the addon provider.
let accountId = "accountId_example"; // String | The unique identifier of the addon account.
apiInstance.usersAddonAccountsRead(userId, provider, accountId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [UserAddon] usersAddonsList(userId)
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
apiInstance.usersAddonsList(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let userId = "userId_example"; // String | The unique identifier of the user.
let provider = "provider_example"; // String | The unique identifier of the addon provider.
apiInstance.usersAddonsRead(userId, provider, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Institution] usersInstitutionsList(userId)
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
apiInstance.usersInstitutionsList(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
apiInstance.usersNodesList(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
let user = new OsfApiv2Documentation.User(); // User | 
apiInstance.usersPartialUpdate(userId, user, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [Preprint] usersPreprintsList(userId)
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
apiInstance.usersPreprintsList(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
apiInstance.usersRead(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.UsersApi();
let userId = "userId_example"; // String | The unique identifier of the user.
apiInstance.usersRegistrationsList(userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
