# OsfApiv2Documentation.RegistrationsApi
...
> [Registration] registrationsChildrenList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsChildrenList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
let citationId = "citationId_example"; // String | The unique identifier of the citation.
apiInstance.registrationsCitationRead(registrationId, citationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [CitationStyle] registrationsCitationsList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsCitationsList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Comment] registrationsCommentsList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsCommentsList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Contributor] registrationsContributorsList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsContributorsList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Contributor] registrationsContributorsRead(registrationId, userId)
...
apiInstance.registrationsContributorsRead(registrationId, userId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [File] registrationsFilesList(registrationId, provider)
...
apiInstance.registrationsFilesList(registrationId, provider, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> File registrationsFilesRead(registrationId, provider, path)
...
apiInstance.registrationsFilesRead(registrationId, provider, path, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
let registration = new OsfApiv2Documentation.Registration(); // Registration | 
apiInstance.registrationsForksCreate(registrationId, registration, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> [Registration] registrationsForksList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsForksList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Identifier] registrationsIdentifiersList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsIdentifiersList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Institution] registrationsInstitutionsList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsInstitutionsList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Node] registrationsLinkedNodesList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsLinkedNodesList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
apiInstance.registrationsList((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Log] registrationsLogsList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsLogsList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
let registration = new OsfApiv2Documentation.Registration(); // Registration | 
apiInstance.registrationsPartialUpdate(registrationId, registration, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> [File] registrationsProvidersList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsProvidersList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsRead(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ViewOnlyLinks] registrationsViewOnlyLinksList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsViewOnlyLinksList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.registrationsViewOnlyLinksRead(registrationId, linkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Wiki] registrationsWikisList(registrationId)
...
let apiInstance = new OsfApiv2Documentation.RegistrationsApi();
let registrationId = "registrationId_example"; // String | The unique identifier of the registration.
apiInstance.registrationsWikisList(registrationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
