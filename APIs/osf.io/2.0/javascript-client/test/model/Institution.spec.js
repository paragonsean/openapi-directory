...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Institution();
  });
  ...
  describe('Institution', function() {
    it('should create an instance of Institution', function() {
      ...
      //var instance = new OsfApiv2Documentation.Institution();
      //expect(instance).to.be.a(OsfApiv2Documentation.Institution);
    });
