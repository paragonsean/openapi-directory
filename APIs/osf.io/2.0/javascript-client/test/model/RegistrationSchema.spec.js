...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.RegistrationSchema();
  });
  ...
  describe('RegistrationSchema', function() {
    it('should create an instance of RegistrationSchema', function() {
      ...
      //var instance = new OsfApiv2Documentation.RegistrationSchema();
      //expect(instance).to.be.a(OsfApiv2Documentation.RegistrationSchema);
    });
