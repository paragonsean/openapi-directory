...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Contributor();
  });
  ...
  describe('Contributor', function() {
    it('should create an instance of Contributor', function() {
      ...
      //var instance = new OsfApiv2Documentation.Contributor();
      //expect(instance).to.be.a(OsfApiv2Documentation.Contributor);
    });
