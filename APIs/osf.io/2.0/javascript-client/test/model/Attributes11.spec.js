...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Attributes11();
  });
  ...
  describe('Attributes11', function() {
    it('should create an instance of Attributes11', function() {
      // uncomment below and update the code to test Attributes11
      //var instance = new OsfApiv2Documentation.Attributes11();
      //expect(instance).to.be.a(OsfApiv2Documentation.Attributes11);
    });
    ...
    it('should have the property middleNames (base name: "middle_names")', function() {
