...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Relationships1();
  });
  ...
  describe('Relationships1', function() {
    it('should create an instance of Relationships1', function() {
      // uncomment below and update the code to test Relationships1
      //var instance = new OsfApiv2Documentation.Relationships1();
      //expect(instance).to.be.a(OsfApiv2Documentation.Relationships1);
    });
