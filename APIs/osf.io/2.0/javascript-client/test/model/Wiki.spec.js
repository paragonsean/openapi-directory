...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Wiki();
  });
  ...
  describe('Wiki', function() {
    it('should create an instance of Wiki', function() {
      // uncomment below and update the code to test Wiki
      //var instance = new OsfApiv2Documentation.Wiki();
      //expect(instance).to.be.a(OsfApiv2Documentation.Wiki);
    });
