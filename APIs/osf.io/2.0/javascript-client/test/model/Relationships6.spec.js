...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Relationships6();
  });
  ...
  describe('Relationships6', function() {
    it('should create an instance of Relationships6', function() {
      // uncomment below and update the code to test Relationships6
      //var instance = new OsfApiv2Documentation.Relationships6();
      //expect(instance).to.be.a(OsfApiv2Documentation.Relationships6);
    });
