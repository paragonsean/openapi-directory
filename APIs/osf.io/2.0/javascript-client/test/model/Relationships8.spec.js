...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OsfApiv2Documentation.Relationships8();
  });
  ...
  describe('Relationships8', function() {
    it('should create an instance of Relationships8', function() {
      // uncomment below and update the code to test Relationships8
      //var instance = new OsfApiv2Documentation.Relationships8();
      //expect(instance).to.be.a(OsfApiv2Documentation.Relationships8);
    });
