...
OAIAttributes_17 OAIIdentifier::getAttributes() const {
    return m_attributes;
}
void OAIIdentifier::setAttributes(const OAIAttributes_17 &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIIdentifier::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIIdentifier::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QString OAIIdentifier::getId() const {
    return m_id;
}
void OAIIdentifier::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}
...
OAILinks_13 OAIIdentifier::getLinks() const {
    return m_links;
}
void OAIIdentifier::setLinks(const OAILinks_13 &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAIIdentifier::is_links_Set() const{
    return m_links_isSet;
}

bool OAIIdentifier::is_links_Valid() const{
    return m_links_isValid;
}

OAIRelationships_10 OAIIdentifier::getRelationships() const {
    return m_relationships;
}
void OAIIdentifier::setRelationships(const OAIRelationships_10 &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIIdentifier::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIIdentifier::is_relationships_Valid() const{
