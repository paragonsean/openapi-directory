...
void OAILicensesApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("licenseList", defaultConf);
    _serverIndices.insert("licenseList", 0);
    _serverConfigs.insert("licensesRead", defaultConf);
    _serverIndices.insert("licensesRead", 0);
}
...
void OAILicensesApi::licenseList() {
    QString fullPath = QString(_serverConfigs["licenseList"][_serverIndices.value("licenseList")].URL()+"/licenses/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILicensesApi::licenseListCallback);
...
void OAILicensesApi::licenseListCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT licenseListSignal(output);
        Q_EMIT licenseListSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT licenseListSignalE(output, error_type, error_str);
        Q_EMIT licenseListSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT licenseListSignalError(output, error_type, error_str);
        Q_EMIT licenseListSignalErrorFull(worker, error_type, error_str);
    }
}

void OAILicensesApi::licensesRead(const QString &license_id) {
    QString fullPath = QString(_serverConfigs["licensesRead"][_serverIndices.value("licensesRead")].URL()+"/license/{license_id}/");
    
    
    {
        QString license_idPathParam("{");
        license_idPathParam.append("license_id").append("}");
        ...
        pathDelimiter = getParamStyleDelimiter(pathStyle, "license_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"license_id"+pathSuffix : pathPrefix;
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAILicensesApi::licensesReadCallback);
    connect(this, &OAILicensesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAILicensesApi::licensesReadCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT licensesReadSignal(output);
        Q_EMIT licensesReadSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT licensesReadSignalE(output, error_type, error_str);
        Q_EMIT licensesReadSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT licensesReadSignalError(output, error_type, error_str);
        Q_EMIT licensesReadSignalErrorFull(worker, error_type, error_str);
    }
}
