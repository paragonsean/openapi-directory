...
#ifndef OAILinks_21_H
#define OAILinks_21_H
...
class OAILinks_21 : public OAIObject {
public:
    OAILinks_21();
    OAILinks_21(QString json);
    ~OAILinks_21() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_21)
