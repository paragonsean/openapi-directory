...
OAIAttributes_3 OAIComment::getAttributes() const {
    return m_attributes;
}
void OAIComment::setAttributes(const OAIAttributes_3 &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIComment::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIComment::is_attributes_Valid() const{
...
OAILinks_1 OAIComment::getLinks() const {
    return m_links;
}
void OAIComment::setLinks(const OAILinks_1 &links) {
    m_links = links;
    m_links_isSet = true;
}
...
OAIRelationships_1 OAIComment::getRelationships() const {
    return m_relationships;
}
void OAIComment::setRelationships(const OAIRelationships_1 &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAIComment::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAIComment::is_relationships_Valid() const{
