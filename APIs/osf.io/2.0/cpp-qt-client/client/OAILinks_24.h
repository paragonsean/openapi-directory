...
#ifndef OAILinks_24_H
#define OAILinks_24_H
...
class OAILinks_24 : public OAIObject {
public:
    OAILinks_24();
    OAILinks_24(QString json);
    ~OAILinks_24() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_24)
