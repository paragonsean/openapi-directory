...
OAIAttributes_2 OAICollection::getAttributes() const {
    return m_attributes;
}
void OAICollection::setAttributes(const OAIAttributes_2 &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAICollection::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAICollection::is_attributes_Valid() const{
...
OAILinks OAICollection::getLinks() const {
    return m_links;
}
void OAICollection::setLinks(const OAILinks &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAICollection::is_links_Set() const{
    return m_links_isSet;
}

bool OAICollection::is_links_Valid() const{
    return m_links_isValid;
}

OAIRelationships OAICollection::getRelationships() const {
    return m_relationships;
}
void OAICollection::setRelationships(const OAIRelationships &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAICollection::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAICollection::is_relationships_Valid() const{
    return m_relationships_isValid;
}

QString OAICollection::getType() const {
    return m_type;
}
void OAICollection::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}
