...
#ifndef OAILinks_13_H
#define OAILinks_13_H
...
class OAILinks_13 : public OAIObject {
public:
    OAILinks_13();
    OAILinks_13(QString json);
    ~OAILinks_13() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_13)
