...
#ifndef OAILinks_20_H
#define OAILinks_20_H
...
class OAILinks_20 : public OAIObject {
public:
    OAILinks_20();
    OAILinks_20(QString json);
    ~OAILinks_20() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILinks_20)
