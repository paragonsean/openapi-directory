...
OAIAttributes_13 OAILog::getAttributes() const {
    return m_attributes;
}
void OAILog::setAttributes(const OAIAttributes_13 &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAILog::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAILog::is_attributes_Valid() const{
...
OAILinks_10 OAILog::getLinks() const {
    return m_links;
}
void OAILog::setLinks(const OAILinks_10 &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAILog::is_links_Set() const{
    return m_links_isSet;
}

bool OAILog::is_links_Valid() const{
    return m_links_isValid;
}

OAIRelationships_9 OAILog::getRelationships() const {
    return m_relationships;
}
void OAILog::setRelationships(const OAIRelationships_9 &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAILog::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAILog::is_relationships_Valid() const{
