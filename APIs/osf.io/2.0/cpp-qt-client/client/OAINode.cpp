...
OAIAttributes_10 OAINode::getAttributes() const {
    return m_attributes;
}
void OAINode::setAttributes(const OAIAttributes_10 &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAINode::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAINode::is_attributes_Valid() const{
...
OAILinks_7 OAINode::getLinks() const {
    return m_links;
}
void OAINode::setLinks(const OAILinks_7 &links) {
    m_links = links;
    m_links_isSet = true;
}

bool OAINode::is_links_Set() const{
    return m_links_isSet;
}

bool OAINode::is_links_Valid() const{
    return m_links_isValid;
}

OAIRelationships_7 OAINode::getRelationships() const {
    return m_relationships;
}
void OAINode::setRelationships(const OAIRelationships_7 &relationships) {
    m_relationships = relationships;
    m_relationships_isSet = true;
}

bool OAINode::is_relationships_Set() const{
    return m_relationships_isSet;
}

bool OAINode::is_relationships_Valid() const{
