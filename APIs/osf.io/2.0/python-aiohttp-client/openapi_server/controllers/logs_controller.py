...
async def logs_actions(request: web.Request, ) -> web.Response:
    """Actions
...
async def logs_read(request: web.Request, log_id) -> web.Response:
    """Retrieve a log
    ...
    :param log_id: The unique identifier of the log you wish to retrieve.
    :type log_id: str
