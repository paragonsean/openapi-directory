...
async def users_addon_accounts_list(request: web.Request, user_id, provider) -> web.Response:
...
async def users_addon_accounts_read(request: web.Request, user_id, provider, account_id) -> web.Response:
...
async def users_addons_list(request: web.Request, user_id) -> web.Response:
...
async def users_addons_read(request: web.Request, user_id, provider) -> web.Response:
...
async def users_institutions_list(request: web.Request, user_id) -> web.Response:
...
async def users_nodes_list(request: web.Request, user_id) -> web.Response:
    """List all nodes
...
async def users_partial_update(request: web.Request, user_id, body) -> web.Response:
    """Update a user
...
async def users_preprints_list(request: web.Request, user_id) -> web.Response:
    """List all preprints
...
async def users_read(request: web.Request, user_id) -> web.Response:
    """Retrieve a user
...
async def users_registrations_list(request: web.Request, user_id) -> web.Response:
