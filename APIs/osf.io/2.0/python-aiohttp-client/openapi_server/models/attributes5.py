...
class Attributes5(Model):
    ...
    def __init__(self, bibliographic: bool=None, index: int=None, permission: str=None, unregistered_contributor: str=None):
        """Attributes5 - a model defined in OpenAPI

        :param bibliographic: The bibliographic of this Attributes5.
        :param index: The index of this Attributes5.
        :param permission: The permission of this Attributes5.
        :param unregistered_contributor: The unregistered_contributor of this Attributes5.
        """
        self.openapi_types = {
            'bibliographic': bool,
            'index': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Attributes5':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Attributes_5 of this Attributes5.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bibliographic(self):
        """Gets the bibliographic of this Attributes5.

        Whether or not the contributor will be included in citations for the node. The default value is true.

        :return: The bibliographic of this Attributes5.
        :rtype: bool
        """
    ...
    def bibliographic(self, bibliographic):
        """Sets the bibliographic of this Attributes5.
    ...
    def index(self, index):
        """Sets the index of this Attributes5.
    ...
    @property
    def permission(self):
        """Gets the permission of this Attributes5.

        The permission level of the contributor. The default value is 'write'.

        :return: The permission of this Attributes5.
        :rtype: str
        """
    ...
    def permission(self, permission):
        """Sets the permission of this Attributes5.
    ...
    def unregistered_contributor(self):
        """Gets the unregistered_contributor of this Attributes5.

        The assigned name of the contributor if the contributor has not yet claimed their account.

        :return: The unregistered_contributor of this Attributes5.
        :rtype: str
        """
    ...
    def unregistered_contributor(self, unregistered_contributor):
        """Sets the unregistered_contributor of this Attributes5.
