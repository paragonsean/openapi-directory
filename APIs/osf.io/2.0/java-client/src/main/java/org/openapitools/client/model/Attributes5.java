...
public class Attributes5 {
  ...
  public Attributes5 bibliographic(Boolean bibliographic) {
  ...
  public Attributes5 index(Integer index) {
    this.index = index;
    return this;
  }
  ...
  public Attributes5 permission(PermissionEnum permission) {
  ...
  public boolean equals(Object o) {
    ...
    Attributes5 attributes5 = (Attributes5) o;
    return Objects.equals(this.bibliographic, attributes5.bibliographic) &&
        Objects.equals(this.index, attributes5.index) &&
        Objects.equals(this.permission, attributes5.permission) &&
        Objects.equals(this.unregisteredContributor, attributes5.unregisteredContributor);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Attributes5
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Attributes5.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Attributes5 is not found in the empty JSON string", Attributes5.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Attributes5.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Attributes5` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Attributes5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Attributes5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Attributes5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Attributes5.class));

       return (TypeAdapter<T>) new TypeAdapter<Attributes5>() {
           @Override
           public void write(JsonWriter out, Attributes5 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Attributes5 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Attributes5 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Attributes5
   * @throws IOException if the JSON string is invalid with respect to Attributes5
   */
  public static Attributes5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Attributes5.class);
  }

  /**
   * Convert an instance of Attributes5 to an JSON string
   *
   * @return JSON string
   */
