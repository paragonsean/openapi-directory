...
public class User {
  ...
  private Links8 links;

  public static final String SERIALIZED_NAME_RELATIONSHIPS = "relationships";
  @SerializedName(SERIALIZED_NAME_RELATIONSHIPS)
  private Relationships8 relationships;
  ...
  public User attributes(Attributes11 attributes) {
  ...
  public User links(Links8 links) {
    this.links = links;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public Links8 getLinks() {
    return links;
  }

  public void setLinks(Links8 links) {
    this.links = links;
  }


  public User relationships(Relationships8 relationships) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      Attributes11.validateJsonElement(jsonObj.get("attributes"));
      if (!jsonObj.get("id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("id").toString()));
      }
      // validate the required field `links`
      Links8.validateJsonElement(jsonObj.get("links"));
      // validate the required field `relationships`
      Relationships8.validateJsonElement(jsonObj.get("relationships"));
