...
public class Data {
  ...
  public Data attributes(Attributes8 attributes) {
  ...
  public Data relationships(Relationships5 relationships) {
  ...
  public boolean equals(Object o) {
    ...
    Data data = (Data) o;
    return Objects.equals(this.attributes, data.attributes) &&
        Objects.equals(this.data, data.data) &&
        Objects.equals(this.id, data.id) &&
        Objects.equals(this.relationships, data.relationships) &&
        Objects.equals(this.type, data.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, data, id, relationships, type);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        Attributes8.validateJsonElement(jsonObj.get("attributes"));
      }
