...
public class Collection {
  ...
  public Collection attributes(Attributes2 attributes) {
  ...
  public Collection links(Links links) {
    this.links = links;
    return this;
  }
  ...
  public Collection relationships(Relationships relationships) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, collection.attributes) &&
        Objects.equals(this.id, collection.id) &&
        Objects.equals(this.links, collection.links) &&
        Objects.equals(this.relationships, collection.relationships) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        Attributes2.validateJsonElement(jsonObj.get("attributes"));
      }
      ...
      if (jsonObj.get("relationships") != null && !jsonObj.get("relationships").isJsonNull()) {
        Relationships.validateJsonElement(jsonObj.get("relationships"));
      }
