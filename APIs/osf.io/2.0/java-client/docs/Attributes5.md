...
|------------ | ------------- | ------------- | -------------|
|**bibliographic** | **Boolean** | Whether or not the contributor will be included in citations for the node. The default value is true. |  [optional] |
|**index** | **Integer** | The position of this contributor in the list of project contributors and in project citations. |  [optional] |
