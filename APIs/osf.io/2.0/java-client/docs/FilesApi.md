...
<a id="filesDetail"></a>
# **filesDetail**
> List&lt;ModelFile&gt; filesDetail(fileId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fileId = "fileId_example"; // String | The unique identifier of the file you wish to retrieve.
    try {
      List<ModelFile> result = apiInstance.filesDetail(fileId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesApi#filesDetail");
...
public class Example {
  public static void main(String[] args) {
    ...
    FilesApi apiInstance = new FilesApi(defaultClient);
    String fileId = "fileId_example"; // String | The unique identifier of the file you wish to update.
    Object body = null; // Object | 
    try {
      apiInstance.filesPatch(fileId, body);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesApi#filesPatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="filesVersionDetail"></a>
# **filesVersionDetail**
> List&lt;FileVersion&gt; filesVersionDetail(fileId, versionId)
...
public class Example {
  public static void main(String[] args) {
    ...
    FilesApi apiInstance = new FilesApi(defaultClient);
    String fileId = "fileId_example"; // String | The unique identifier of the file from which you want to retrieve versions.
    String versionId = "versionId_example"; // String | The file version number you want to retrieve.
    try {
      List<FileVersion> result = apiInstance.filesVersionDetail(fileId, versionId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesApi#filesVersionDetail");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="filesVersions"></a>
# **filesVersions**
> List&lt;FileVersion&gt; filesVersions(fileId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fileId = "fileId_example"; // String | The unique identifier of the file from which you want to retrieve versions.
    try {
      List<FileVersion> result = apiInstance.filesVersions(fileId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FilesApi#filesVersions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
