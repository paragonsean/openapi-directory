...
|**currentUserPermissions** | **List&lt;String&gt;** | The current users permission level for the Draft Registration. |  [optional] [readonly] |
|**datetimeInitiated** | **OffsetDateTime** | The time at which the draft registration was first initiated, as an iso8601 formatted timestamp. |  [optional] [readonly] |
|**datetimeUpdated** | **OffsetDateTime** | The time at which the draft registration was last updated, as an iso8601 formatted timestamp. |  [optional] [readonly] |
...
|**tags** | **List&lt;String&gt;** | The searchable tags of the Draft Registration. |  [optional] |
