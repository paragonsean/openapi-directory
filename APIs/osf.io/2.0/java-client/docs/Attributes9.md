...
|**currentVersion** | **Integer** | Version number of the file. |  [optional] [readonly] |
|**dateCreated** | **OffsetDateTime** | The time at which the file was created, as an iso8601 formatted timestamp. |  [optional] [readonly] |
|**dateModified** | **OffsetDateTime** | The time at which the file was last modified, as an iso8601 formatted timestamp. |  [optional] [readonly] |
...
|**lastTouched** | **OffsetDateTime** | The time at which the file external metadata was last retrieved as an iso8601 formatted timestamp (does not apply to OSF Storage files). |  [optional] [readonly] |
...
|**size** | **Integer** | Size of the file in bytes. |  [optional] [readonly] |
|**tags** | **List&lt;String&gt;** | A list of strings that describe this file, as entered by project contributors. |  [optional] [readonly] |
