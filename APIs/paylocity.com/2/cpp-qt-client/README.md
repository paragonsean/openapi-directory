...
#include <iostream>
#include "../client/OAIAdditionalRatesApi.h"
...
QString Example::create(){
    QString obj;
OAIAdditionalRate Example::create(){
    OAIAdditionalRate obj;
 return obj;
}

void Example::exampleFunction1(){
     OAIAdditionalRatesApi apiInstance;
     
      //OAuth Authentication supported right now

      QEventLoop loop;
      connect(&apiInstance, &OAIAdditionalRatesApi::add_or_update_additional_ratesSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIAdditionalRatesApi::add_or_update_additional_ratesSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString company_id = create(); // QString | Company Id
      ...
      QString employee_id = create(); // QString | Employee Id
      ...
      OAIAdditionalRate oai_additional_rate = create(); // OAIAdditionalRate | Additional Rate Model
      apiInstance.add_or_update_additional_rates(company_idemployee_idoai_additional_rate);
