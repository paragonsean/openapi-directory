...
OAIStagedEmployee_homeAddress_inner::OAIStagedEmployee_homeAddress_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStagedEmployee_homeAddress_inner::OAIStagedEmployee_homeAddress_inner() {
    this->initializeModel();
}

OAIStagedEmployee_homeAddress_inner::~OAIStagedEmployee_homeAddress_inner() {}

void OAIStagedEmployee_homeAddress_inner::initializeModel() {
...
void OAIStagedEmployee_homeAddress_inner::fromJson(QString jsonString) {
...
void OAIStagedEmployee_homeAddress_inner::fromJsonObject(QJsonObject json) {
...
QString OAIStagedEmployee_homeAddress_inner::asJson() const {
...
QJsonObject OAIStagedEmployee_homeAddress_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_address1_isSet) {
...
QString OAIStagedEmployee_homeAddress_inner::getAddress1() const {
    return m_address1;
}
void OAIStagedEmployee_homeAddress_inner::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getAddress2() const {
    return m_address2;
}
void OAIStagedEmployee_homeAddress_inner::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getCity() const {
    return m_city;
}
void OAIStagedEmployee_homeAddress_inner::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_city_Set() const{
    return m_city_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getCountry() const {
    return m_country;
}
void OAIStagedEmployee_homeAddress_inner::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_country_Set() const{
    return m_country_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getCounty() const {
    return m_county;
}
void OAIStagedEmployee_homeAddress_inner::setCounty(const QString &county) {
    m_county = county;
    m_county_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_county_Set() const{
    return m_county_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_county_Valid() const{
    return m_county_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getEmailAddress() const {
    return m_email_address;
}
void OAIStagedEmployee_homeAddress_inner::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_email_address_Valid() const{
    return m_email_address_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getMobilePhone() const {
    return m_mobile_phone;
}
void OAIStagedEmployee_homeAddress_inner::setMobilePhone(const QString &mobile_phone) {
    m_mobile_phone = mobile_phone;
    m_mobile_phone_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_mobile_phone_Set() const{
    return m_mobile_phone_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_mobile_phone_Valid() const{
    return m_mobile_phone_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getPhone() const {
    return m_phone;
}
void OAIStagedEmployee_homeAddress_inner::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getPostalCode() const {
    return m_postal_code;
}
void OAIStagedEmployee_homeAddress_inner::setPostalCode(const QString &postal_code) {
    m_postal_code = postal_code;
    m_postal_code_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_postal_code_Set() const{
    return m_postal_code_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_postal_code_Valid() const{
    return m_postal_code_isValid;
}

QString OAIStagedEmployee_homeAddress_inner::getState() const {
    return m_state;
}
void OAIStagedEmployee_homeAddress_inner::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIStagedEmployee_homeAddress_inner::is_state_Set() const{
    return m_state_isSet;
}

bool OAIStagedEmployee_homeAddress_inner::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIStagedEmployee_homeAddress_inner::isSet() const {
...
bool OAIStagedEmployee_homeAddress_inner::isValid() const {
