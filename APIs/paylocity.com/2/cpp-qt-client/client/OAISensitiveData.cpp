...
OAISensitiveData::OAISensitiveData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData::OAISensitiveData() {
    this->initializeModel();
}

OAISensitiveData::~OAISensitiveData() {}

void OAISensitiveData::initializeModel() {

    m_disability_isSet = false;
    m_disability_isValid = false;
    ...
    m_veteran_isSet = false;
    m_veteran_isValid = false;
}

void OAISensitiveData::fromJson(QString jsonString) {
...
void OAISensitiveData::fromJsonObject(QJsonObject json) {

    m_disability_isValid = ::OpenAPI::fromJsonValue(m_disability, json[QString("disability")]);
    m_disability_isSet = !json[QString("disability")].isNull() && m_disability_isValid;
    ...
    m_veteran_isValid = ::OpenAPI::fromJsonValue(m_veteran, json[QString("veteran")]);
    m_veteran_isSet = !json[QString("veteran")].isNull() && m_veteran_isValid;
}

QString OAISensitiveData::asJson() const {
...
QJsonObject OAISensitiveData::asJsonObject() const {
    QJsonObject obj;
    if (m_disability.isSet()) {
        obj.insert(QString("disability"), ::OpenAPI::toJsonValue(m_disability));
    }
    if (m_ethnicity.isSet()) {
    ...
    if (m_veteran.isSet()) {
        obj.insert(QString("veteran"), ::OpenAPI::toJsonValue(m_veteran));
    }
    return obj;
}

OAISensitiveData_disability OAISensitiveData::getDisability() const {
    return m_disability;
}
void OAISensitiveData::setDisability(const OAISensitiveData_disability &disability) {
    m_disability = disability;
    m_disability_isSet = true;
}

bool OAISensitiveData::is_disability_Set() const{
    return m_disability_isSet;
}

bool OAISensitiveData::is_disability_Valid() const{
    return m_disability_isValid;
}

OAISensitiveData_ethnicity OAISensitiveData::getEthnicity() const {
    return m_ethnicity;
}
void OAISensitiveData::setEthnicity(const OAISensitiveData_ethnicity &ethnicity) {
    m_ethnicity = ethnicity;
    m_ethnicity_isSet = true;
}

bool OAISensitiveData::is_ethnicity_Set() const{
    return m_ethnicity_isSet;
}

bool OAISensitiveData::is_ethnicity_Valid() const{
    return m_ethnicity_isValid;
}

OAISensitiveData_gender OAISensitiveData::getGender() const {
    return m_gender;
}
void OAISensitiveData::setGender(const OAISensitiveData_gender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAISensitiveData::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAISensitiveData::is_gender_Valid() const{
    return m_gender_isValid;
}

OAISensitiveData_veteran OAISensitiveData::getVeteran() const {
    return m_veteran;
}
void OAISensitiveData::setVeteran(const OAISensitiveData_veteran &veteran) {
    m_veteran = veteran;
    m_veteran_isSet = true;
}

bool OAISensitiveData::is_veteran_Set() const{
    return m_veteran_isSet;
}

bool OAISensitiveData::is_veteran_Valid() const{
    return m_veteran_isValid;
}

bool OAISensitiveData::isSet() const {
...
bool OAISensitiveData::isValid() const {
