...
/*
 * OAIPayStatementSummary.h
 *
 * The pay statement summary model
 */

#ifndef OAIPayStatementSummary_H
#define OAIPayStatementSummary_H
...
class OAIPayStatementSummary : public OAIObject {
public:
    OAIPayStatementSummary();
    OAIPayStatementSummary(QString json);
    ~OAIPayStatementSummary() override;
    ...
    void setAutoPay(const bool &auto_pay);
    bool is_auto_pay_Set() const;
    bool is_auto_pay_Valid() const;
    ...
    qint32 getCheckNumber() const;
    void setCheckNumber(const qint32 &check_number);
    bool is_check_number_Set() const;
    bool is_check_number_Valid() const;

    double getDirectDepositAmount() const;
    void setDirectDepositAmount(const double &direct_deposit_amount);
    bool is_direct_deposit_amount_Set() const;
    bool is_direct_deposit_amount_Valid() const;
    ...
    double getNetCheck() const;
    void setNetCheck(const double &net_check);
    bool is_net_check_Set() const;
    bool is_net_check_Valid() const;
    ...
    double getOvertimeDollars() const;
    void setOvertimeDollars(const double &overtime_dollars);
    bool is_overtime_dollars_Set() const;
    bool is_overtime_dollars_Valid() const;

    double getOvertimeHours() const;
    void setOvertimeHours(const double &overtime_hours);
    bool is_overtime_hours_Set() const;
    bool is_overtime_hours_Valid() const;

    qint32 getProcess() const;
    void setProcess(const qint32 &process);
    bool is_process_Set() const;
    bool is_process_Valid() const;

    double getRegularDollars() const;
    void setRegularDollars(const double &regular_dollars);
    bool is_regular_dollars_Set() const;
    bool is_regular_dollars_Valid() const;

    double getRegularHours() const;
    void setRegularHours(const double &regular_hours);
    ...
    qint32 getVoucherNumber() const;
    void setVoucherNumber(const qint32 &voucher_number);
    bool is_voucher_number_Set() const;
    bool is_voucher_number_Valid() const;

    QString getWorkersCompCode() const;
    void setWorkersCompCode(const QString &workers_comp_code);
    bool is_workers_comp_code_Set() const;
    bool is_workers_comp_code_Valid() const;
...
private:
    ...
    bool m_auto_pay;
    bool m_auto_pay_isSet;
    bool m_auto_pay_isValid;
    ...
    qint32 m_check_number;
    bool m_check_number_isSet;
    bool m_check_number_isValid;

    double m_direct_deposit_amount;
    bool m_direct_deposit_amount_isSet;
    bool m_direct_deposit_amount_isValid;
    ...
    double m_net_check;
    bool m_net_check_isSet;
    bool m_net_check_isValid;

    double m_net_pay;
    bool m_net_pay_isSet;
    bool m_net_pay_isValid;

    double m_overtime_dollars;
    bool m_overtime_dollars_isSet;
    bool m_overtime_dollars_isValid;

    double m_overtime_hours;
    bool m_overtime_hours_isSet;
    bool m_overtime_hours_isValid;

    qint32 m_process;
    bool m_process_isSet;
    bool m_process_isValid;

    double m_regular_dollars;
    bool m_regular_dollars_isSet;
    bool m_regular_dollars_isValid;

    double m_regular_hours;
    ...
    qint32 m_voucher_number;
    bool m_voucher_number_isSet;
    bool m_voucher_number_isValid;

    QString m_workers_comp_code;
    bool m_workers_comp_code_isSet;
    bool m_workers_comp_code_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayStatementSummary)

#endif // OAIPayStatementSummary_H
