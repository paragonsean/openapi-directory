...
OAIDirectDeposit::OAIDirectDeposit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirectDeposit::OAIDirectDeposit() {
    this->initializeModel();
}

OAIDirectDeposit::~OAIDirectDeposit() {}

void OAIDirectDeposit::initializeModel() {
...
void OAIDirectDeposit::fromJson(QString jsonString) {
...
void OAIDirectDeposit::fromJsonObject(QJsonObject json) {
...
QString OAIDirectDeposit::asJson() const {
...
QJsonObject OAIDirectDeposit::asJsonObject() const {
    QJsonObject obj;
...
QList<OAIDirectDeposit_additionalDirectDeposit_inner> OAIDirectDeposit::getAdditionalDirectDeposit() const {
    return m_additional_direct_deposit;
}
void OAIDirectDeposit::setAdditionalDirectDeposit(const QList<OAIDirectDeposit_additionalDirectDeposit_inner> &additional_direct_deposit) {
    m_additional_direct_deposit = additional_direct_deposit;
    m_additional_direct_deposit_isSet = true;
}

bool OAIDirectDeposit::is_additional_direct_deposit_Set() const{
    return m_additional_direct_deposit_isSet;
}

bool OAIDirectDeposit::is_additional_direct_deposit_Valid() const{
    return m_additional_direct_deposit_isValid;
}

OAIDirectDeposit_mainDirectDeposit OAIDirectDeposit::getMainDirectDeposit() const {
    return m_main_direct_deposit;
}
void OAIDirectDeposit::setMainDirectDeposit(const OAIDirectDeposit_mainDirectDeposit &main_direct_deposit) {
    m_main_direct_deposit = main_direct_deposit;
    m_main_direct_deposit_isSet = true;
}

bool OAIDirectDeposit::is_main_direct_deposit_Set() const{
    return m_main_direct_deposit_isSet;
}

bool OAIDirectDeposit::is_main_direct_deposit_Valid() const{
    return m_main_direct_deposit_isValid;
}

bool OAIDirectDeposit::isSet() const {
...
bool OAIDirectDeposit::isValid() const {
