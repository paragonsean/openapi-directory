...
#ifndef OAI_OAIEmployeeStagingApi_H
#define OAI_OAIEmployeeStagingApi_H
...
#include "OAITrackingNumberResponse.h"
#include <QString>
...
class OAIEmployeeStagingApi : public QObject {
    Q_OBJECT

public:
    OAIEmployeeStagingApi(const int timeOut = 0);
    ~OAIEmployeeStagingApi();
    ...
    * @param[in]  oai_staged_employee OAIStagedEmployee [required]
    */
    virtual void add_new_employee_to_Web_Link(const QString &company_id, const OAIStagedEmployee &oai_staged_employee);
...
private:
    ...
    void add_new_employee_to_Web_LinkCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_new_employee_to_Web_LinkSignal(QList<OAITrackingNumberResponse> summary);


    void add_new_employee_to_Web_LinkSignalFull(OAIHttpRequestWorker *worker, QList<OAITrackingNumberResponse> summary);

    Q_DECL_DEPRECATED_X("Use add_new_employee_to_Web_LinkSignalError() instead")
    void add_new_employee_to_Web_LinkSignalE(QList<OAITrackingNumberResponse> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void add_new_employee_to_Web_LinkSignalError(QList<OAITrackingNumberResponse> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_new_employee_to_Web_LinkSignalErrorFull() instead")
    void add_new_employee_to_Web_LinkSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_new_employee_to_Web_LinkSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
