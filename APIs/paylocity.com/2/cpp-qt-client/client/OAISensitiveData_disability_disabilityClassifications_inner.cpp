...
OAISensitiveData_disability_disabilityClassifications_inner::OAISensitiveData_disability_disabilityClassifications_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData_disability_disabilityClassifications_inner::OAISensitiveData_disability_disabilityClassifications_inner() {
    this->initializeModel();
}

OAISensitiveData_disability_disabilityClassifications_inner::~OAISensitiveData_disability_disabilityClassifications_inner() {}

void OAISensitiveData_disability_disabilityClassifications_inner::initializeModel() {

    m_classification_isSet = false;
    m_classification_isValid = false;
}

void OAISensitiveData_disability_disabilityClassifications_inner::fromJson(QString jsonString) {
...
void OAISensitiveData_disability_disabilityClassifications_inner::fromJsonObject(QJsonObject json) {
...
QString OAISensitiveData_disability_disabilityClassifications_inner::asJson() const {
...
QJsonObject OAISensitiveData_disability_disabilityClassifications_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAISensitiveData_disability_disabilityClassifications_inner::getClassification() const {
    return m_classification;
}
void OAISensitiveData_disability_disabilityClassifications_inner::setClassification(const QString &classification) {
    m_classification = classification;
    m_classification_isSet = true;
}

bool OAISensitiveData_disability_disabilityClassifications_inner::is_classification_Set() const{
    return m_classification_isSet;
}

bool OAISensitiveData_disability_disabilityClassifications_inner::is_classification_Valid() const{
    return m_classification_isValid;
}

bool OAISensitiveData_disability_disabilityClassifications_inner::isSet() const {
...
bool OAISensitiveData_disability_disabilityClassifications_inner::isValid() const {
