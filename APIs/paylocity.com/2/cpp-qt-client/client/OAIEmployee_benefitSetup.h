...
class OAIEmployee_benefitSetup : public OAIObject {
public:
    OAIEmployee_benefitSetup();
    OAIEmployee_benefitSetup(QString json);
    ~OAIEmployee_benefitSetup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_benefitSetup)

#endif // OAIEmployee_benefitSetup_H
