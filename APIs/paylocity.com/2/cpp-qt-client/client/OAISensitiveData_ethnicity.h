...
/*
 * OAISensitiveData_ethnicity.h
 *
 * Add or update ethnicity data.
 */

#ifndef OAISensitiveData_ethnicity_H
#define OAISensitiveData_ethnicity_H
...
namespace OpenAPI {
class OAISensitiveData_ethnicity_ethnicRacialIdentities_inner;

class OAISensitiveData_ethnicity : public OAIObject {
public:
    OAISensitiveData_ethnicity();
    OAISensitiveData_ethnicity(QString json);
    ~OAISensitiveData_ethnicity() override;
    ...
    QList<OAISensitiveData_ethnicity_ethnicRacialIdentities_inner> getEthnicRacialIdentities() const;
    void setEthnicRacialIdentities(const QList<OAISensitiveData_ethnicity_ethnicRacialIdentities_inner> &ethnic_racial_identities);
    bool is_ethnic_racial_identities_Set() const;
    bool is_ethnic_racial_identities_Valid() const;
...
private:
    ...
    QList<OAISensitiveData_ethnicity_ethnicRacialIdentities_inner> m_ethnic_racial_identities;
    bool m_ethnic_racial_identities_isSet;
    bool m_ethnic_racial_identities_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData_ethnicity)

#endif // OAISensitiveData_ethnicity_H
