...
/*
 * OAIEmployee_nonPrimaryStateTax.h
 *
...
#ifndef OAIEmployee_nonPrimaryStateTax_H
#define OAIEmployee_nonPrimaryStateTax_H
...
class OAIEmployee_nonPrimaryStateTax : public OAIObject {
public:
    OAIEmployee_nonPrimaryStateTax();
    OAIEmployee_nonPrimaryStateTax(QString json);
    ~OAIEmployee_nonPrimaryStateTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_nonPrimaryStateTax)

#endif // OAIEmployee_nonPrimaryStateTax_H
