...
OAIStagedEmployee_webTime::OAIStagedEmployee_webTime(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStagedEmployee_webTime::OAIStagedEmployee_webTime() {
    this->initializeModel();
}

OAIStagedEmployee_webTime::~OAIStagedEmployee_webTime() {}

void OAIStagedEmployee_webTime::initializeModel() {

    m_badge_number_isSet = false;
    m_badge_number_isValid = false;

    m_charge_rate_isSet = false;
    m_charge_rate_isValid = false;

    m_is_time_labor_enabled_isSet = false;
    m_is_time_labor_enabled_isValid = false;
}

void OAIStagedEmployee_webTime::fromJson(QString jsonString) {
...
void OAIStagedEmployee_webTime::fromJsonObject(QJsonObject json) {

    m_badge_number_isValid = ::OpenAPI::fromJsonValue(m_badge_number, json[QString("badgeNumber")]);
    m_badge_number_isSet = !json[QString("badgeNumber")].isNull() && m_badge_number_isValid;
    ...
    m_is_time_labor_enabled_isValid = ::OpenAPI::fromJsonValue(m_is_time_labor_enabled, json[QString("isTimeLaborEnabled")]);
    m_is_time_labor_enabled_isSet = !json[QString("isTimeLaborEnabled")].isNull() && m_is_time_labor_enabled_isValid;
}

QString OAIStagedEmployee_webTime::asJson() const {
...
QJsonObject OAIStagedEmployee_webTime::asJsonObject() const {
    QJsonObject obj;
    if (m_badge_number_isSet) {
        obj.insert(QString("badgeNumber"), ::OpenAPI::toJsonValue(m_badge_number));
    }
    if (m_charge_rate_isSet) {
        obj.insert(QString("chargeRate"), ::OpenAPI::toJsonValue(m_charge_rate));
    }
    if (m_is_time_labor_enabled_isSet) {
        obj.insert(QString("isTimeLaborEnabled"), ::OpenAPI::toJsonValue(m_is_time_labor_enabled));
    }
    return obj;
}

QString OAIStagedEmployee_webTime::getBadgeNumber() const {
    return m_badge_number;
}
void OAIStagedEmployee_webTime::setBadgeNumber(const QString &badge_number) {
    m_badge_number = badge_number;
    m_badge_number_isSet = true;
}

bool OAIStagedEmployee_webTime::is_badge_number_Set() const{
    return m_badge_number_isSet;
}

bool OAIStagedEmployee_webTime::is_badge_number_Valid() const{
    return m_badge_number_isValid;
}

double OAIStagedEmployee_webTime::getChargeRate() const {
    return m_charge_rate;
}
void OAIStagedEmployee_webTime::setChargeRate(const double &charge_rate) {
    m_charge_rate = charge_rate;
    m_charge_rate_isSet = true;
}

bool OAIStagedEmployee_webTime::is_charge_rate_Set() const{
    return m_charge_rate_isSet;
}

bool OAIStagedEmployee_webTime::is_charge_rate_Valid() const{
    return m_charge_rate_isValid;
}

bool OAIStagedEmployee_webTime::isIsTimeLaborEnabled() const {
    return m_is_time_labor_enabled;
}
void OAIStagedEmployee_webTime::setIsTimeLaborEnabled(const bool &is_time_labor_enabled) {
    m_is_time_labor_enabled = is_time_labor_enabled;
    m_is_time_labor_enabled_isSet = true;
}

bool OAIStagedEmployee_webTime::is_is_time_labor_enabled_Set() const{
    return m_is_time_labor_enabled_isSet;
}

bool OAIStagedEmployee_webTime::is_is_time_labor_enabled_Valid() const{
    return m_is_time_labor_enabled_isValid;
}

bool OAIStagedEmployee_webTime::isSet() const {
...
bool OAIStagedEmployee_webTime::isValid() const {
