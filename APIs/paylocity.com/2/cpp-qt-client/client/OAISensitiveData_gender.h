...
/*
 * OAISensitiveData_gender.h
 *
 * Add or update gender data.
 */

#ifndef OAISensitiveData_gender_H
#define OAISensitiveData_gender_H
...
class OAISensitiveData_gender : public OAIObject {
public:
    OAISensitiveData_gender();
    OAISensitiveData_gender(QString json);
    ~OAISensitiveData_gender() override;
    ...
    bool isDisplayPronouns() const;
    void setDisplayPronouns(const bool &display_pronouns);
    bool is_display_pronouns_Set() const;
    bool is_display_pronouns_Valid() const;

    QString getGenderIdentityDescription() const;
    void setGenderIdentityDescription(const QString &gender_identity_description);
    bool is_gender_identity_description_Set() const;
    bool is_gender_identity_description_Valid() const;

    QString getIdentifyAsLegalGender() const;
    void setIdentifyAsLegalGender(const QString &identify_as_legal_gender);
    bool is_identify_as_legal_gender_Set() const;
    bool is_identify_as_legal_gender_Valid() const;

    QString getLegalGender() const;
    void setLegalGender(const QString &legal_gender);
    bool is_legal_gender_Set() const;
    bool is_legal_gender_Valid() const;
    ...
    QString getSexualOrientation() const;
    void setSexualOrientation(const QString &sexual_orientation);
    bool is_sexual_orientation_Set() const;
    bool is_sexual_orientation_Valid() const;
...
private:
    ...
    bool m_display_pronouns;
    bool m_display_pronouns_isSet;
    bool m_display_pronouns_isValid;

    QString m_gender_identity_description;
    bool m_gender_identity_description_isSet;
    bool m_gender_identity_description_isValid;

    QString m_identify_as_legal_gender;
    bool m_identify_as_legal_gender_isSet;
    bool m_identify_as_legal_gender_isValid;

    QString m_legal_gender;
    bool m_legal_gender_isSet;
    bool m_legal_gender_isValid;

    QString m_pronouns;
    bool m_pronouns_isSet;
    bool m_pronouns_isValid;

    QString m_sexual_orientation;
    bool m_sexual_orientation_isSet;
    bool m_sexual_orientation_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData_gender)

#endif // OAISensitiveData_gender_H
