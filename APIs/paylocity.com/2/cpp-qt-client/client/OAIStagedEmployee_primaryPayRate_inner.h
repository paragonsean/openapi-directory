...
/*
 * OAIStagedEmployee_primaryPayRate_inner.h
 *
 * The Primary Pay Rate model
 */

#ifndef OAIStagedEmployee_primaryPayRate_inner_H
#define OAIStagedEmployee_primaryPayRate_inner_H
...
class OAIStagedEmployee_primaryPayRate_inner : public OAIObject {
public:
    OAIStagedEmployee_primaryPayRate_inner();
    OAIStagedEmployee_primaryPayRate_inner(QString json);
    ~OAIStagedEmployee_primaryPayRate_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_primaryPayRate_inner)

#endif // OAIStagedEmployee_primaryPayRate_inner_H
