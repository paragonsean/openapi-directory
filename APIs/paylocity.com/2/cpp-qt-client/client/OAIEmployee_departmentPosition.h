...
/*
 * OAIEmployee_departmentPosition.h
 *
...
#ifndef OAIEmployee_departmentPosition_H
#define OAIEmployee_departmentPosition_H
...
class OAIEmployee_departmentPosition : public OAIObject {
public:
    OAIEmployee_departmentPosition();
    OAIEmployee_departmentPosition(QString json);
    ~OAIEmployee_departmentPosition() override;
    ...
    QString getReviewerCompanyNumber() const;
    void setReviewerCompanyNumber(const QString &reviewer_company_number);
    bool is_reviewer_company_number_Set() const;
    bool is_reviewer_company_number_Valid() const;

    QString getReviewerEmployeeId() const;
    void setReviewerEmployeeId(const QString &reviewer_employee_id);
    bool is_reviewer_employee_id_Set() const;
    bool is_reviewer_employee_id_Valid() const;
...
private:
    ...
    QString m_reviewer_company_number;
    bool m_reviewer_company_number_isSet;
    bool m_reviewer_company_number_isValid;

    QString m_reviewer_employee_id;
    bool m_reviewer_employee_id_isSet;
    bool m_reviewer_employee_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_departmentPosition)

#endif // OAIEmployee_departmentPosition_H
