...
class OAIEmployee_workAddress : public OAIObject {
public:
    OAIEmployee_workAddress();
    OAIEmployee_workAddress(QString json);
    ~OAIEmployee_workAddress() override;
    ...
    QString getMailStop() const;
    void setMailStop(const QString &mail_stop);
    bool is_mail_stop_Set() const;
    bool is_mail_stop_Valid() const;
...
private:
    ...
    QString m_mail_stop;
    bool m_mail_stop_isSet;
    bool m_mail_stop_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_workAddress)

#endif // OAIEmployee_workAddress_H
