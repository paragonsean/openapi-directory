...
/*
 * OAIPayStatementDetails.h
 *
 * The pay statement details model
 */

#ifndef OAIPayStatementDetails_H
#define OAIPayStatementDetails_H
...
class OAIPayStatementDetails : public OAIObject {
public:
    OAIPayStatementDetails();
    OAIPayStatementDetails(QString json);
    ~OAIPayStatementDetails() override;
    ...
    QString getDet() const;
    void setDet(const QString &det);
    bool is_det_Set() const;
    bool is_det_Valid() const;

    QString getDetCode() const;
    void setDetCode(const QString &det_code);
    bool is_det_code_Set() const;
    bool is_det_code_Valid() const;

    QString getDetType() const;
    void setDetType(const QString &det_type);
    bool is_det_type_Set() const;
    bool is_det_type_Valid() const;

    double getEligibleCompensation() const;
    void setEligibleCompensation(const double &eligible_compensation);
    bool is_eligible_compensation_Set() const;
    bool is_eligible_compensation_Valid() const;
...
private:
    ...
    QString m_det_code;
    bool m_det_code_isSet;
    bool m_det_code_isValid;

    QString m_det_type;
    bool m_det_type_isSet;
    bool m_det_type_isValid;

    double m_eligible_compensation;
    bool m_eligible_compensation_isSet;
    bool m_eligible_compensation_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPayStatementDetails)

#endif // OAIPayStatementDetails_H
