...
public:
    ...
    double getAnnualMaximum() const;
    void setAnnualMaximum(const double &annual_maximum);
    bool is_annual_maximum_Set() const;
    bool is_annual_maximum_Valid() const;

    QString getCalculationCode() const;
    void setCalculationCode(const QString &calculation_code);
    bool is_calculation_code_Set() const;
    bool is_calculation_code_Valid() const;
    ...
    QString getEarningCode() const;
    void setEarningCode(const QString &earning_code);
    bool is_earning_code_Set() const;
    bool is_earning_code_Valid() const;
    ...
    double getHoursOrUnits() const;
    void setHoursOrUnits(const double &hours_or_units);
    bool is_hours_or_units_Set() const;
    bool is_hours_or_units_Valid() const;

    bool isIsSelfInsured() const;
    void setIsSelfInsured(const bool &is_self_insured);
    bool is_is_self_insured_Set() const;
    bool is_is_self_insured_Valid() const;

    QString getJobCode() const;
    void setJobCode(const QString &job_code);
    bool is_job_code_Set() const;
    bool is_job_code_Valid() const;

    QString getMiscellaneousInfo() const;
    void setMiscellaneousInfo(const QString &miscellaneous_info);
    bool is_miscellaneous_info_Set() const;
    bool is_miscellaneous_info_Valid() const;

    double getPaidTowardsGoal() const;
    void setPaidTowardsGoal(const double &paid_towards_goal);
    bool is_paid_towards_goal_Set() const;
    bool is_paid_towards_goal_Valid() const;

    double getPayPeriodMaximum() const;
    void setPayPeriodMaximum(const double &pay_period_maximum);
    bool is_pay_period_maximum_Set() const;
    bool is_pay_period_maximum_Valid() const;

    double getPayPeriodMinimum() const;
    void setPayPeriodMinimum(const double &pay_period_minimum);
    bool is_pay_period_minimum_Set() const;
    bool is_pay_period_minimum_Valid() const;
...
private:
    ...
    double m_annual_maximum;
    bool m_annual_maximum_isSet;
    bool m_annual_maximum_isValid;

    QString m_calculation_code;
    bool m_calculation_code_isSet;
    bool m_calculation_code_isValid;
    ...
    QString m_earning_code;
    bool m_earning_code_isSet;
    bool m_earning_code_isValid;
    ...
    double m_hours_or_units;
    bool m_hours_or_units_isSet;
    bool m_hours_or_units_isValid;

    bool m_is_self_insured;
    bool m_is_self_insured_isSet;
    bool m_is_self_insured_isValid;

    QString m_job_code;
    bool m_job_code_isSet;
    bool m_job_code_isValid;

    QString m_miscellaneous_info;
    bool m_miscellaneous_info_isSet;
    bool m_miscellaneous_info_isValid;

    double m_paid_towards_goal;
    bool m_paid_towards_goal_isSet;
    bool m_paid_towards_goal_isValid;

    double m_pay_period_maximum;
    bool m_pay_period_maximum_isSet;
    bool m_pay_period_maximum_isValid;

    double m_pay_period_minimum;
    bool m_pay_period_minimum_isSet;
    bool m_pay_period_minimum_isValid;
