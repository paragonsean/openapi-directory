...
#include "OAINonPrimaryStateTax.h"
...
OAINonPrimaryStateTax::OAINonPrimaryStateTax(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINonPrimaryStateTax::OAINonPrimaryStateTax() {
    this->initializeModel();
}

OAINonPrimaryStateTax::~OAINonPrimaryStateTax() {}

void OAINonPrimaryStateTax::initializeModel() {
    ...
    m_reciprocity_code_isSet = false;
    m_reciprocity_code_isValid = false;
...
void OAINonPrimaryStateTax::fromJson(QString jsonString) {
...
void OAINonPrimaryStateTax::fromJsonObject(QJsonObject json) {
    ...
    m_reciprocity_code_isValid = ::OpenAPI::fromJsonValue(m_reciprocity_code, json[QString("reciprocityCode")]);
    m_reciprocity_code_isSet = !json[QString("reciprocityCode")].isNull() && m_reciprocity_code_isValid;
...
QString OAINonPrimaryStateTax::asJson() const {
...
QJsonObject OAINonPrimaryStateTax::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
    ...
    if (m_reciprocity_code_isSet) {
        obj.insert(QString("reciprocityCode"), ::OpenAPI::toJsonValue(m_reciprocity_code));
    }
...
double OAINonPrimaryStateTax::getAmount() const {
    return m_amount;
}
void OAINonPrimaryStateTax::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAINonPrimaryStateTax::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAINonPrimaryStateTax::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAINonPrimaryStateTax::getDeductionsAmount() const {
    return m_deductions_amount;
}
void OAINonPrimaryStateTax::setDeductionsAmount(const double &deductions_amount) {
    m_deductions_amount = deductions_amount;
    m_deductions_amount_isSet = true;
}

bool OAINonPrimaryStateTax::is_deductions_amount_Set() const{
    return m_deductions_amount_isSet;
}

bool OAINonPrimaryStateTax::is_deductions_amount_Valid() const{
    return m_deductions_amount_isValid;
}

double OAINonPrimaryStateTax::getDependentsAmount() const {
    return m_dependents_amount;
}
void OAINonPrimaryStateTax::setDependentsAmount(const double &dependents_amount) {
    m_dependents_amount = dependents_amount;
    m_dependents_amount_isSet = true;
}

bool OAINonPrimaryStateTax::is_dependents_amount_Set() const{
    return m_dependents_amount_isSet;
}

bool OAINonPrimaryStateTax::is_dependents_amount_Valid() const{
    return m_dependents_amount_isValid;
}

double OAINonPrimaryStateTax::getExemptions() const {
    return m_exemptions;
}
void OAINonPrimaryStateTax::setExemptions(const double &exemptions) {
    m_exemptions = exemptions;
    m_exemptions_isSet = true;
}

bool OAINonPrimaryStateTax::is_exemptions_Set() const{
    return m_exemptions_isSet;
}

bool OAINonPrimaryStateTax::is_exemptions_Valid() const{
    return m_exemptions_isValid;
}

double OAINonPrimaryStateTax::getExemptions2() const {
    return m_exemptions2;
}
void OAINonPrimaryStateTax::setExemptions2(const double &exemptions2) {
    m_exemptions2 = exemptions2;
    m_exemptions2_isSet = true;
}

bool OAINonPrimaryStateTax::is_exemptions2_Set() const{
    return m_exemptions2_isSet;
}

bool OAINonPrimaryStateTax::is_exemptions2_Valid() const{
    return m_exemptions2_isValid;
}

QString OAINonPrimaryStateTax::getFilingStatus() const {
    return m_filing_status;
}
void OAINonPrimaryStateTax::setFilingStatus(const QString &filing_status) {
    m_filing_status = filing_status;
    m_filing_status_isSet = true;
}

bool OAINonPrimaryStateTax::is_filing_status_Set() const{
    return m_filing_status_isSet;
}

bool OAINonPrimaryStateTax::is_filing_status_Valid() const{
    return m_filing_status_isValid;
}

bool OAINonPrimaryStateTax::isHigherRate() const {
    return m_higher_rate;
}
void OAINonPrimaryStateTax::setHigherRate(const bool &higher_rate) {
    m_higher_rate = higher_rate;
    m_higher_rate_isSet = true;
}

bool OAINonPrimaryStateTax::is_higher_rate_Set() const{
    return m_higher_rate_isSet;
}

bool OAINonPrimaryStateTax::is_higher_rate_Valid() const{
    return m_higher_rate_isValid;
}

double OAINonPrimaryStateTax::getOtherIncomeAmount() const {
    return m_other_income_amount;
}
void OAINonPrimaryStateTax::setOtherIncomeAmount(const double &other_income_amount) {
    m_other_income_amount = other_income_amount;
    m_other_income_amount_isSet = true;
}

bool OAINonPrimaryStateTax::is_other_income_amount_Set() const{
    return m_other_income_amount_isSet;
}

bool OAINonPrimaryStateTax::is_other_income_amount_Valid() const{
    return m_other_income_amount_isValid;
}

double OAINonPrimaryStateTax::getPercentage() const {
    return m_percentage;
}
void OAINonPrimaryStateTax::setPercentage(const double &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAINonPrimaryStateTax::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAINonPrimaryStateTax::is_percentage_Valid() const{
    return m_percentage_isValid;
}

QString OAINonPrimaryStateTax::getReciprocityCode() const {
    return m_reciprocity_code;
}
void OAINonPrimaryStateTax::setReciprocityCode(const QString &reciprocity_code) {
    m_reciprocity_code = reciprocity_code;
    m_reciprocity_code_isSet = true;
}

bool OAINonPrimaryStateTax::is_reciprocity_code_Set() const{
    return m_reciprocity_code_isSet;
}

bool OAINonPrimaryStateTax::is_reciprocity_code_Valid() const{
    return m_reciprocity_code_isValid;
}

QString OAINonPrimaryStateTax::getSpecialCheckCalc() const {
    return m_special_check_calc;
}
void OAINonPrimaryStateTax::setSpecialCheckCalc(const QString &special_check_calc) {
    m_special_check_calc = special_check_calc;
    m_special_check_calc_isSet = true;
}

bool OAINonPrimaryStateTax::is_special_check_calc_Set() const{
    return m_special_check_calc_isSet;
}

bool OAINonPrimaryStateTax::is_special_check_calc_Valid() const{
    return m_special_check_calc_isValid;
}

QString OAINonPrimaryStateTax::getTaxCalculationCode() const {
    return m_tax_calculation_code;
}
void OAINonPrimaryStateTax::setTaxCalculationCode(const QString &tax_calculation_code) {
    m_tax_calculation_code = tax_calculation_code;
    m_tax_calculation_code_isSet = true;
}

bool OAINonPrimaryStateTax::is_tax_calculation_code_Set() const{
    return m_tax_calculation_code_isSet;
}

bool OAINonPrimaryStateTax::is_tax_calculation_code_Valid() const{
    return m_tax_calculation_code_isValid;
}

QString OAINonPrimaryStateTax::getTaxCode() const {
    return m_tax_code;
}
void OAINonPrimaryStateTax::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAINonPrimaryStateTax::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAINonPrimaryStateTax::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

qint32 OAINonPrimaryStateTax::getW4FormYear() const {
    return m_w4_form_year;
}
void OAINonPrimaryStateTax::setW4FormYear(const qint32 &w4_form_year) {
    m_w4_form_year = w4_form_year;
    m_w4_form_year_isSet = true;
}

bool OAINonPrimaryStateTax::is_w4_form_year_Set() const{
    return m_w4_form_year_isSet;
}

bool OAINonPrimaryStateTax::is_w4_form_year_Valid() const{
    return m_w4_form_year_isValid;
}

bool OAINonPrimaryStateTax::isSet() const {
...
bool OAINonPrimaryStateTax::isValid() const {
