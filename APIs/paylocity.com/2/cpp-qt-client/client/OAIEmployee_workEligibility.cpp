...
OAIEmployee_workEligibility::OAIEmployee_workEligibility(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_workEligibility::OAIEmployee_workEligibility() {
    this->initializeModel();
}

OAIEmployee_workEligibility::~OAIEmployee_workEligibility() {}

void OAIEmployee_workEligibility::initializeModel() {
...
void OAIEmployee_workEligibility::fromJson(QString jsonString) {
...
void OAIEmployee_workEligibility::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_workEligibility::asJson() const {
...
QJsonObject OAIEmployee_workEligibility::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEmployee_workEligibility::getAlienOrAdmissionDocumentNumber() const {
    return m_alien_or_admission_document_number;
}
void OAIEmployee_workEligibility::setAlienOrAdmissionDocumentNumber(const QString &alien_or_admission_document_number) {
    m_alien_or_admission_document_number = alien_or_admission_document_number;
    m_alien_or_admission_document_number_isSet = true;
}

bool OAIEmployee_workEligibility::is_alien_or_admission_document_number_Set() const{
    return m_alien_or_admission_document_number_isSet;
}

bool OAIEmployee_workEligibility::is_alien_or_admission_document_number_Valid() const{
    return m_alien_or_admission_document_number_isValid;
}

QString OAIEmployee_workEligibility::getAttestedDate() const {
    return m_attested_date;
}
void OAIEmployee_workEligibility::setAttestedDate(const QString &attested_date) {
    m_attested_date = attested_date;
    m_attested_date_isSet = true;
}

bool OAIEmployee_workEligibility::is_attested_date_Set() const{
    return m_attested_date_isSet;
}

bool OAIEmployee_workEligibility::is_attested_date_Valid() const{
    return m_attested_date_isValid;
}

QString OAIEmployee_workEligibility::getCountryOfIssuance() const {
    return m_country_of_issuance;
}
void OAIEmployee_workEligibility::setCountryOfIssuance(const QString &country_of_issuance) {
    m_country_of_issuance = country_of_issuance;
    m_country_of_issuance_isSet = true;
}

bool OAIEmployee_workEligibility::is_country_of_issuance_Set() const{
    return m_country_of_issuance_isSet;
}

bool OAIEmployee_workEligibility::is_country_of_issuance_Valid() const{
    return m_country_of_issuance_isValid;
}

QString OAIEmployee_workEligibility::getForeignPassportNumber() const {
    return m_foreign_passport_number;
}
void OAIEmployee_workEligibility::setForeignPassportNumber(const QString &foreign_passport_number) {
    m_foreign_passport_number = foreign_passport_number;
    m_foreign_passport_number_isSet = true;
}

bool OAIEmployee_workEligibility::is_foreign_passport_number_Set() const{
    return m_foreign_passport_number_isSet;
}

bool OAIEmployee_workEligibility::is_foreign_passport_number_Valid() const{
    return m_foreign_passport_number_isValid;
}

QString OAIEmployee_workEligibility::getI94AdmissionNumber() const {
    return m_i94_admission_number;
}
void OAIEmployee_workEligibility::setI94AdmissionNumber(const QString &i94_admission_number) {
    m_i94_admission_number = i94_admission_number;
    m_i94_admission_number_isSet = true;
}

bool OAIEmployee_workEligibility::is_i94_admission_number_Set() const{
    return m_i94_admission_number_isSet;
}

bool OAIEmployee_workEligibility::is_i94_admission_number_Valid() const{
    return m_i94_admission_number_isValid;
}

QString OAIEmployee_workEligibility::getI9DateVerified() const {
    return m_i9_date_verified;
}
void OAIEmployee_workEligibility::setI9DateVerified(const QString &i9_date_verified) {
    m_i9_date_verified = i9_date_verified;
    m_i9_date_verified_isSet = true;
}

bool OAIEmployee_workEligibility::is_i9_date_verified_Set() const{
    return m_i9_date_verified_isSet;
}

bool OAIEmployee_workEligibility::is_i9_date_verified_Valid() const{
    return m_i9_date_verified_isValid;
}

QString OAIEmployee_workEligibility::getI9Notes() const {
    return m_i9_notes;
}
void OAIEmployee_workEligibility::setI9Notes(const QString &i9_notes) {
    m_i9_notes = i9_notes;
    m_i9_notes_isSet = true;
}

bool OAIEmployee_workEligibility::is_i9_notes_Set() const{
    return m_i9_notes_isSet;
}

bool OAIEmployee_workEligibility::is_i9_notes_Valid() const{
    return m_i9_notes_isValid;
}

bool OAIEmployee_workEligibility::isIsI9Verified() const {
    return m_is_i9_verified;
}
void OAIEmployee_workEligibility::setIsI9Verified(const bool &is_i9_verified) {
    m_is_i9_verified = is_i9_verified;
    m_is_i9_verified_isSet = true;
}

bool OAIEmployee_workEligibility::is_is_i9_verified_Set() const{
    return m_is_i9_verified_isSet;
}

bool OAIEmployee_workEligibility::is_is_i9_verified_Valid() const{
    return m_is_i9_verified_isValid;
}

bool OAIEmployee_workEligibility::isIsSsnVerified() const {
    return m_is_ssn_verified;
}
void OAIEmployee_workEligibility::setIsSsnVerified(const bool &is_ssn_verified) {
    m_is_ssn_verified = is_ssn_verified;
    m_is_ssn_verified_isSet = true;
}

bool OAIEmployee_workEligibility::is_is_ssn_verified_Set() const{
    return m_is_ssn_verified_isSet;
}

bool OAIEmployee_workEligibility::is_is_ssn_verified_Valid() const{
    return m_is_ssn_verified_isValid;
}

QString OAIEmployee_workEligibility::getSsnDateVerified() const {
    return m_ssn_date_verified;
}
void OAIEmployee_workEligibility::setSsnDateVerified(const QString &ssn_date_verified) {
    m_ssn_date_verified = ssn_date_verified;
    m_ssn_date_verified_isSet = true;
}

bool OAIEmployee_workEligibility::is_ssn_date_verified_Set() const{
    return m_ssn_date_verified_isSet;
}

bool OAIEmployee_workEligibility::is_ssn_date_verified_Valid() const{
    return m_ssn_date_verified_isValid;
}

QString OAIEmployee_workEligibility::getSsnNotes() const {
    return m_ssn_notes;
}
void OAIEmployee_workEligibility::setSsnNotes(const QString &ssn_notes) {
    m_ssn_notes = ssn_notes;
    m_ssn_notes_isSet = true;
}

bool OAIEmployee_workEligibility::is_ssn_notes_Set() const{
    return m_ssn_notes_isSet;
}

bool OAIEmployee_workEligibility::is_ssn_notes_Valid() const{
    return m_ssn_notes_isValid;
}

QString OAIEmployee_workEligibility::getVisaType() const {
    return m_visa_type;
}
void OAIEmployee_workEligibility::setVisaType(const QString &visa_type) {
    m_visa_type = visa_type;
    m_visa_type_isSet = true;
}

bool OAIEmployee_workEligibility::is_visa_type_Set() const{
    return m_visa_type_isSet;
}

bool OAIEmployee_workEligibility::is_visa_type_Valid() const{
    return m_visa_type_isValid;
}

QString OAIEmployee_workEligibility::getWorkAuthorization() const {
    return m_work_authorization;
}
void OAIEmployee_workEligibility::setWorkAuthorization(const QString &work_authorization) {
    m_work_authorization = work_authorization;
    m_work_authorization_isSet = true;
}

bool OAIEmployee_workEligibility::is_work_authorization_Set() const{
    return m_work_authorization_isSet;
}

bool OAIEmployee_workEligibility::is_work_authorization_Valid() const{
    return m_work_authorization_isValid;
}

QString OAIEmployee_workEligibility::getWorkUntil() const {
    return m_work_until;
}
void OAIEmployee_workEligibility::setWorkUntil(const QString &work_until) {
    m_work_until = work_until;
    m_work_until_isSet = true;
}

bool OAIEmployee_workEligibility::is_work_until_Set() const{
    return m_work_until_isSet;
}

bool OAIEmployee_workEligibility::is_work_until_Valid() const{
    return m_work_until_isValid;
}

bool OAIEmployee_workEligibility::isSet() const {
...
bool OAIEmployee_workEligibility::isValid() const {
