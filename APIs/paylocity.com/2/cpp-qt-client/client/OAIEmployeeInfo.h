...
#ifndef OAIEmployeeInfo_H
#define OAIEmployeeInfo_H
...
class OAIEmployeeInfo : public OAIObject {
public:
    OAIEmployeeInfo();
    OAIEmployeeInfo(QString json);
    ~OAIEmployeeInfo() override;
    ...
    QString getStatusTypeCode() const;
    void setStatusTypeCode(const QString &status_type_code);
    bool is_status_type_code_Set() const;
    bool is_status_type_code_Valid() const;
...
private:
    ...
    QString m_status_type_code;
    bool m_status_type_code_isSet;
    bool m_status_type_code_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEmployeeInfo)

#endif // OAIEmployeeInfo_H
