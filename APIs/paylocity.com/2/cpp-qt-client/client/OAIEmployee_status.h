...
#ifndef OAIEmployee_status_H
#define OAIEmployee_status_H
...
class OAIEmployee_status : public OAIObject {
public:
    OAIEmployee_status();
    OAIEmployee_status(QString json);
    ~OAIEmployee_status() override;
    ...
    QString getReHireDate() const;
    void setReHireDate(const QString &re_hire_date);
    bool is_re_hire_date_Set() const;
    bool is_re_hire_date_Valid() const;
...
private:
    ...
    QString m_re_hire_date;
    bool m_re_hire_date_isSet;
    bool m_re_hire_date_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_status)

#endif // OAIEmployee_status_H
