...
#include "OAICompanySpecificSchemaApi.h"
...
OAICompanySpecificSchemaApi::OAICompanySpecificSchemaApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAICompanySpecificSchemaApi::~OAICompanySpecificSchemaApi() {
}

void OAICompanySpecificSchemaApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_companySpecific_Open_API_documentation", defaultConf);
    _serverIndices.insert("get_companySpecific_Open_API_documentation", 0);
}
...
*/
int OAICompanySpecificSchemaApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAICompanySpecificSchemaApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAICompanySpecificSchemaApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAICompanySpecificSchemaApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAICompanySpecificSchemaApi::setUsername(const QString &username) {
    _username = username;
}

void OAICompanySpecificSchemaApi::setPassword(const QString &password) {
    _password = password;
}


void OAICompanySpecificSchemaApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAICompanySpecificSchemaApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAICompanySpecificSchemaApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAICompanySpecificSchemaApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICompanySpecificSchemaApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICompanySpecificSchemaApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAICompanySpecificSchemaApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAICompanySpecificSchemaApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAICompanySpecificSchemaApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAICompanySpecificSchemaApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAICompanySpecificSchemaApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAICompanySpecificSchemaApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAICompanySpecificSchemaApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAICompanySpecificSchemaApi::get_companySpecific_Open_API_documentation(const QString &authorization, const QString &company_id) {
    QString fullPath = QString(_serverConfigs["get_companySpecific_Open_API_documentation"][_serverIndices.value("get_companySpecific_Open_API_documentation")].URL()+"/v2/companies/{companyId}/openapi");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICompanySpecificSchemaApi::get_companySpecific_Open_API_documentationCallback);
    connect(this, &OAICompanySpecificSchemaApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICompanySpecificSchemaApi::get_companySpecific_Open_API_documentationCallback);
    connect(this, &OAICompanySpecificSchemaApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAICompanySpecificSchemaApi::get_companySpecific_Open_API_documentationCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_companySpecific_Open_API_documentationSignal();
        Q_EMIT get_companySpecific_Open_API_documentationSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_companySpecific_Open_API_documentationSignalE(error_type, error_str);
        Q_EMIT get_companySpecific_Open_API_documentationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_companySpecific_Open_API_documentationSignalError(error_type, error_str);
        Q_EMIT get_companySpecific_Open_API_documentationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICompanySpecificSchemaApi::tokenAvailable(){
