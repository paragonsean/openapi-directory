...
/*
 * OAIEmployee_customDateFields_inner.h
 *
 * 
 */

#ifndef OAIEmployee_customDateFields_inner_H
#define OAIEmployee_customDateFields_inner_H
...
class OAIEmployee_customDateFields_inner : public OAIObject {
public:
    OAIEmployee_customDateFields_inner();
    OAIEmployee_customDateFields_inner(QString json);
    ~OAIEmployee_customDateFields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_customDateFields_inner)

#endif // OAIEmployee_customDateFields_inner_H
