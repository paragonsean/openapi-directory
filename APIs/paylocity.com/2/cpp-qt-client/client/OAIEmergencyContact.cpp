...
QString OAIEmergencyContact::getAddress1() const {
    return m_address1;
}
void OAIEmergencyContact::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIEmergencyContact::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIEmergencyContact::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIEmergencyContact::getAddress2() const {
    return m_address2;
}
void OAIEmergencyContact::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIEmergencyContact::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIEmergencyContact::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIEmergencyContact::getCity() const {
    return m_city;
}
void OAIEmergencyContact::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIEmergencyContact::is_city_Set() const{
    return m_city_isSet;
}

bool OAIEmergencyContact::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIEmergencyContact::getCountry() const {
    return m_country;
}
void OAIEmergencyContact::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIEmergencyContact::is_country_Set() const{
    return m_country_isSet;
}

bool OAIEmergencyContact::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIEmergencyContact::getCounty() const {
    return m_county;
}
void OAIEmergencyContact::setCounty(const QString &county) {
    m_county = county;
    m_county_isSet = true;
}

bool OAIEmergencyContact::is_county_Set() const{
    return m_county_isSet;
}

bool OAIEmergencyContact::is_county_Valid() const{
    return m_county_isValid;
}

QString OAIEmergencyContact::getEmail() const {
    return m_email;
}
void OAIEmergencyContact::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIEmergencyContact::is_email_Set() const{
    return m_email_isSet;
}

bool OAIEmergencyContact::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIEmergencyContact::getFirstName() const {
    return m_first_name;
}
void OAIEmergencyContact::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIEmergencyContact::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIEmergencyContact::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIEmergencyContact::getHomePhone() const {
    return m_home_phone;
}
void OAIEmergencyContact::setHomePhone(const QString &home_phone) {
    m_home_phone = home_phone;
    m_home_phone_isSet = true;
}

bool OAIEmergencyContact::is_home_phone_Set() const{
    return m_home_phone_isSet;
}

bool OAIEmergencyContact::is_home_phone_Valid() const{
    return m_home_phone_isValid;
}

QString OAIEmergencyContact::getLastName() const {
    return m_last_name;
}
void OAIEmergencyContact::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIEmergencyContact::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIEmergencyContact::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAIEmergencyContact::getMobilePhone() const {
    return m_mobile_phone;
}
void OAIEmergencyContact::setMobilePhone(const QString &mobile_phone) {
    m_mobile_phone = mobile_phone;
    m_mobile_phone_isSet = true;
}

bool OAIEmergencyContact::is_mobile_phone_Set() const{
    return m_mobile_phone_isSet;
}

bool OAIEmergencyContact::is_mobile_phone_Valid() const{
    return m_mobile_phone_isValid;
}

QString OAIEmergencyContact::getNotes() const {
    return m_notes;
}
void OAIEmergencyContact::setNotes(const QString &notes) {
    m_notes = notes;
    m_notes_isSet = true;
}

bool OAIEmergencyContact::is_notes_Set() const{
    return m_notes_isSet;
}

bool OAIEmergencyContact::is_notes_Valid() const{
    return m_notes_isValid;
}

QString OAIEmergencyContact::getPager() const {
    return m_pager;
}
void OAIEmergencyContact::setPager(const QString &pager) {
    m_pager = pager;
    m_pager_isSet = true;
}

bool OAIEmergencyContact::is_pager_Set() const{
    return m_pager_isSet;
}

bool OAIEmergencyContact::is_pager_Valid() const{
    return m_pager_isValid;
}

QString OAIEmergencyContact::getPrimaryPhone() const {
    return m_primary_phone;
}
void OAIEmergencyContact::setPrimaryPhone(const QString &primary_phone) {
    m_primary_phone = primary_phone;
    m_primary_phone_isSet = true;
}

bool OAIEmergencyContact::is_primary_phone_Set() const{
    return m_primary_phone_isSet;
}

bool OAIEmergencyContact::is_primary_phone_Valid() const{
    return m_primary_phone_isValid;
}

QString OAIEmergencyContact::getPriority() const {
    return m_priority;
}
void OAIEmergencyContact::setPriority(const QString &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIEmergencyContact::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIEmergencyContact::is_priority_Valid() const{
    return m_priority_isValid;
}

QString OAIEmergencyContact::getRelationship() const {
    return m_relationship;
}
void OAIEmergencyContact::setRelationship(const QString &relationship) {
    m_relationship = relationship;
    m_relationship_isSet = true;
}

bool OAIEmergencyContact::is_relationship_Set() const{
    return m_relationship_isSet;
}

bool OAIEmergencyContact::is_relationship_Valid() const{
    return m_relationship_isValid;
}

QString OAIEmergencyContact::getState() const {
    return m_state;
}
void OAIEmergencyContact::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIEmergencyContact::is_state_Set() const{
    return m_state_isSet;
}

bool OAIEmergencyContact::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIEmergencyContact::isSyncEmployeeInfo() const {
    return m_sync_employee_info;
}
void OAIEmergencyContact::setSyncEmployeeInfo(const bool &sync_employee_info) {
    m_sync_employee_info = sync_employee_info;
    m_sync_employee_info_isSet = true;
}

bool OAIEmergencyContact::is_sync_employee_info_Set() const{
    return m_sync_employee_info_isSet;
}

bool OAIEmergencyContact::is_sync_employee_info_Valid() const{
    return m_sync_employee_info_isValid;
}

QString OAIEmergencyContact::getWorkExtension() const {
    return m_work_extension;
}
void OAIEmergencyContact::setWorkExtension(const QString &work_extension) {
    m_work_extension = work_extension;
    m_work_extension_isSet = true;
}

bool OAIEmergencyContact::is_work_extension_Set() const{
    return m_work_extension_isSet;
}

bool OAIEmergencyContact::is_work_extension_Valid() const{
    return m_work_extension_isValid;
}

QString OAIEmergencyContact::getWorkPhone() const {
    return m_work_phone;
}
void OAIEmergencyContact::setWorkPhone(const QString &work_phone) {
    m_work_phone = work_phone;
    m_work_phone_isSet = true;
}

bool OAIEmergencyContact::is_work_phone_Set() const{
    return m_work_phone_isSet;
}

bool OAIEmergencyContact::is_work_phone_Valid() const{
    return m_work_phone_isValid;
}

QString OAIEmergencyContact::getZip() const {
    return m_zip;
}
void OAIEmergencyContact::setZip(const QString &zip) {
    m_zip = zip;
    m_zip_isSet = true;
}

bool OAIEmergencyContact::is_zip_Set() const{
    return m_zip_isSet;
}

bool OAIEmergencyContact::is_zip_Valid() const{
