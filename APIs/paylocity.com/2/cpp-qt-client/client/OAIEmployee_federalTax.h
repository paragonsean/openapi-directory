...
class OAIEmployee_federalTax : public OAIObject {
public:
    OAIEmployee_federalTax();
    OAIEmployee_federalTax(QString json);
    ~OAIEmployee_federalTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_federalTax)

#endif // OAIEmployee_federalTax_H
