...
#include "OAIEmergencyContactsApi.h"
...
OAIEmergencyContactsApi::OAIEmergencyContactsApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIEmergencyContactsApi::~OAIEmergencyContactsApi() {
}

void OAIEmergencyContactsApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("add_or_update_emergency_contacts", defaultConf);
    _serverIndices.insert("add_or_update_emergency_contacts", 0);
}
...
*/
int OAIEmergencyContactsApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIEmergencyContactsApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIEmergencyContactsApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIEmergencyContactsApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIEmergencyContactsApi::setUsername(const QString &username) {
    _username = username;
}

void OAIEmergencyContactsApi::setPassword(const QString &password) {
    _password = password;
}


void OAIEmergencyContactsApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIEmergencyContactsApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIEmergencyContactsApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIEmergencyContactsApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmergencyContactsApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmergencyContactsApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIEmergencyContactsApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIEmergencyContactsApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIEmergencyContactsApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIEmergencyContactsApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIEmergencyContactsApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIEmergencyContactsApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIEmergencyContactsApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIEmergencyContactsApi::add_or_update_emergency_contacts(const QString &company_id, const QString &employee_id, const OAIEmergencyContact &oai_emergency_contact) {
    QString fullPath = QString(_serverConfigs["add_or_update_emergency_contacts"][_serverIndices.value("add_or_update_emergency_contacts")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/emergencyContacts");
...

    {
        ...
        QByteArray output = oai_emergency_contact.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmergencyContactsApi::add_or_update_emergency_contactsCallback);
    connect(this, &OAIEmergencyContactsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmergencyContactsApi::add_or_update_emergency_contactsCallback);
    connect(this, &OAIEmergencyContactsApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIEmergencyContactsApi::add_or_update_emergency_contactsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_or_update_emergency_contactsSignal();
        Q_EMIT add_or_update_emergency_contactsSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_or_update_emergency_contactsSignalE(error_type, error_str);
        Q_EMIT add_or_update_emergency_contactsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_or_update_emergency_contactsSignalError(error_type, error_str);
        Q_EMIT add_or_update_emergency_contactsSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmergencyContactsApi::tokenAvailable(){
