...
/*
 * OAIDirectDeposit_mainDirectDeposit.h
 *
 * The main Direct Deposit account.
 */

#ifndef OAIDirectDeposit_mainDirectDeposit_H
#define OAIDirectDeposit_mainDirectDeposit_H
...
class OAIDirectDeposit_mainDirectDeposit : public OAIObject {
public:
    OAIDirectDeposit_mainDirectDeposit();
    OAIDirectDeposit_mainDirectDeposit(QString json);
    ~OAIDirectDeposit_mainDirectDeposit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirectDeposit_mainDirectDeposit)

#endif // OAIDirectDeposit_mainDirectDeposit_H
