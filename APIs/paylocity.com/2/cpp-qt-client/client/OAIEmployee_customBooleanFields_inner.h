...
/*
 * OAIEmployee_customBooleanFields_inner.h
 *
 * 
 */

#ifndef OAIEmployee_customBooleanFields_inner_H
#define OAIEmployee_customBooleanFields_inner_H
...
class OAIEmployee_customBooleanFields_inner : public OAIObject {
public:
    OAIEmployee_customBooleanFields_inner();
    OAIEmployee_customBooleanFields_inner(QString json);
    ~OAIEmployee_customBooleanFields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_customBooleanFields_inner)

#endif // OAIEmployee_customBooleanFields_inner_H
