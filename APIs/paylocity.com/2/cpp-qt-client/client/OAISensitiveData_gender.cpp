...
OAISensitiveData_gender::OAISensitiveData_gender(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData_gender::OAISensitiveData_gender() {
    this->initializeModel();
}

OAISensitiveData_gender::~OAISensitiveData_gender() {}

void OAISensitiveData_gender::initializeModel() {

    m_display_pronouns_isSet = false;
    m_display_pronouns_isValid = false;

    m_gender_identity_description_isSet = false;
    m_gender_identity_description_isValid = false;

    m_identify_as_legal_gender_isSet = false;
    m_identify_as_legal_gender_isValid = false;

    m_legal_gender_isSet = false;
    m_legal_gender_isValid = false;

    m_pronouns_isSet = false;
    m_pronouns_isValid = false;

    m_sexual_orientation_isSet = false;
    m_sexual_orientation_isValid = false;
}

void OAISensitiveData_gender::fromJson(QString jsonString) {
...
void OAISensitiveData_gender::fromJsonObject(QJsonObject json) {

    m_display_pronouns_isValid = ::OpenAPI::fromJsonValue(m_display_pronouns, json[QString("displayPronouns")]);
    m_display_pronouns_isSet = !json[QString("displayPronouns")].isNull() && m_display_pronouns_isValid;

    m_gender_identity_description_isValid = ::OpenAPI::fromJsonValue(m_gender_identity_description, json[QString("genderIdentityDescription")]);
    m_gender_identity_description_isSet = !json[QString("genderIdentityDescription")].isNull() && m_gender_identity_description_isValid;

    m_identify_as_legal_gender_isValid = ::OpenAPI::fromJsonValue(m_identify_as_legal_gender, json[QString("identifyAsLegalGender")]);
    m_identify_as_legal_gender_isSet = !json[QString("identifyAsLegalGender")].isNull() && m_identify_as_legal_gender_isValid;

    m_legal_gender_isValid = ::OpenAPI::fromJsonValue(m_legal_gender, json[QString("legalGender")]);
    m_legal_gender_isSet = !json[QString("legalGender")].isNull() && m_legal_gender_isValid;
    ...
    m_sexual_orientation_isValid = ::OpenAPI::fromJsonValue(m_sexual_orientation, json[QString("sexualOrientation")]);
    m_sexual_orientation_isSet = !json[QString("sexualOrientation")].isNull() && m_sexual_orientation_isValid;
}

QString OAISensitiveData_gender::asJson() const {
...
QJsonObject OAISensitiveData_gender::asJsonObject() const {
    QJsonObject obj;
    if (m_display_pronouns_isSet) {
        obj.insert(QString("displayPronouns"), ::OpenAPI::toJsonValue(m_display_pronouns));
    }
    if (m_gender_identity_description_isSet) {
        obj.insert(QString("genderIdentityDescription"), ::OpenAPI::toJsonValue(m_gender_identity_description));
    }
    if (m_identify_as_legal_gender_isSet) {
        obj.insert(QString("identifyAsLegalGender"), ::OpenAPI::toJsonValue(m_identify_as_legal_gender));
    }
    if (m_legal_gender_isSet) {
        obj.insert(QString("legalGender"), ::OpenAPI::toJsonValue(m_legal_gender));
    }
    if (m_pronouns_isSet) {
        obj.insert(QString("pronouns"), ::OpenAPI::toJsonValue(m_pronouns));
    }
    if (m_sexual_orientation_isSet) {
        obj.insert(QString("sexualOrientation"), ::OpenAPI::toJsonValue(m_sexual_orientation));
    }
    return obj;
}

bool OAISensitiveData_gender::isDisplayPronouns() const {
    return m_display_pronouns;
}
void OAISensitiveData_gender::setDisplayPronouns(const bool &display_pronouns) {
    m_display_pronouns = display_pronouns;
    m_display_pronouns_isSet = true;
}

bool OAISensitiveData_gender::is_display_pronouns_Set() const{
    return m_display_pronouns_isSet;
}

bool OAISensitiveData_gender::is_display_pronouns_Valid() const{
    return m_display_pronouns_isValid;
}

QString OAISensitiveData_gender::getGenderIdentityDescription() const {
    return m_gender_identity_description;
}
void OAISensitiveData_gender::setGenderIdentityDescription(const QString &gender_identity_description) {
    m_gender_identity_description = gender_identity_description;
    m_gender_identity_description_isSet = true;
}

bool OAISensitiveData_gender::is_gender_identity_description_Set() const{
    return m_gender_identity_description_isSet;
}

bool OAISensitiveData_gender::is_gender_identity_description_Valid() const{
    return m_gender_identity_description_isValid;
}

QString OAISensitiveData_gender::getIdentifyAsLegalGender() const {
    return m_identify_as_legal_gender;
}
void OAISensitiveData_gender::setIdentifyAsLegalGender(const QString &identify_as_legal_gender) {
    m_identify_as_legal_gender = identify_as_legal_gender;
    m_identify_as_legal_gender_isSet = true;
}

bool OAISensitiveData_gender::is_identify_as_legal_gender_Set() const{
    return m_identify_as_legal_gender_isSet;
}

bool OAISensitiveData_gender::is_identify_as_legal_gender_Valid() const{
    return m_identify_as_legal_gender_isValid;
}

QString OAISensitiveData_gender::getLegalGender() const {
    return m_legal_gender;
}
void OAISensitiveData_gender::setLegalGender(const QString &legal_gender) {
    m_legal_gender = legal_gender;
    m_legal_gender_isSet = true;
}

bool OAISensitiveData_gender::is_legal_gender_Set() const{
    return m_legal_gender_isSet;
}

bool OAISensitiveData_gender::is_legal_gender_Valid() const{
    return m_legal_gender_isValid;
}

QString OAISensitiveData_gender::getPronouns() const {
    return m_pronouns;
}
void OAISensitiveData_gender::setPronouns(const QString &pronouns) {
    m_pronouns = pronouns;
    m_pronouns_isSet = true;
}

bool OAISensitiveData_gender::is_pronouns_Set() const{
    return m_pronouns_isSet;
}

bool OAISensitiveData_gender::is_pronouns_Valid() const{
    return m_pronouns_isValid;
}

QString OAISensitiveData_gender::getSexualOrientation() const {
    return m_sexual_orientation;
}
void OAISensitiveData_gender::setSexualOrientation(const QString &sexual_orientation) {
    m_sexual_orientation = sexual_orientation;
    m_sexual_orientation_isSet = true;
}

bool OAISensitiveData_gender::is_sexual_orientation_Set() const{
    return m_sexual_orientation_isSet;
}

bool OAISensitiveData_gender::is_sexual_orientation_Valid() const{
    return m_sexual_orientation_isValid;
}

bool OAISensitiveData_gender::isSet() const {
...
bool OAISensitiveData_gender::isValid() const {
