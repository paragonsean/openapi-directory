...
#include "OAIAdditionalRatesApi.h"
...
OAIAdditionalRatesApi::OAIAdditionalRatesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIAdditionalRatesApi::~OAIAdditionalRatesApi() {
}

void OAIAdditionalRatesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("add_or_update_additional_rates", defaultConf);
    _serverIndices.insert("add_or_update_additional_rates", 0);
}
...
*/
int OAIAdditionalRatesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIAdditionalRatesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIAdditionalRatesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIAdditionalRatesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIAdditionalRatesApi::setUsername(const QString &username) {
    _username = username;
}

void OAIAdditionalRatesApi::setPassword(const QString &password) {
    _password = password;
}


void OAIAdditionalRatesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIAdditionalRatesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIAdditionalRatesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIAdditionalRatesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAdditionalRatesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIAdditionalRatesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIAdditionalRatesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIAdditionalRatesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIAdditionalRatesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIAdditionalRatesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIAdditionalRatesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIAdditionalRatesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIAdditionalRatesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIAdditionalRatesApi::add_or_update_additional_rates(const QString &company_id, const QString &employee_id, const OAIAdditionalRate &oai_additional_rate) {
    QString fullPath = QString(_serverConfigs["add_or_update_additional_rates"][_serverIndices.value("add_or_update_additional_rates")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/additionalRates");
...

    {
        ...
        QByteArray output = oai_additional_rate.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAdditionalRatesApi::add_or_update_additional_ratesCallback);
    connect(this, &OAIAdditionalRatesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAdditionalRatesApi::add_or_update_additional_ratesCallback);
    connect(this, &OAIAdditionalRatesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIAdditionalRatesApi::add_or_update_additional_ratesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_or_update_additional_ratesSignal();
        Q_EMIT add_or_update_additional_ratesSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_or_update_additional_ratesSignalE(error_type, error_str);
        Q_EMIT add_or_update_additional_ratesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_or_update_additional_ratesSignalError(error_type, error_str);
        Q_EMIT add_or_update_additional_ratesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAdditionalRatesApi::tokenAvailable(){
