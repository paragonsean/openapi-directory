...
/*
 * OAISensitiveData_disability.h
 *
 * Add or update disability data.
 */

#ifndef OAISensitiveData_disability_H
#define OAISensitiveData_disability_H

#include <QJsonObject>

#include "OAISensitiveData_disability_disabilityClassifications_inner.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAISensitiveData_disability_disabilityClassifications_inner;

class OAISensitiveData_disability : public OAIObject {
public:
    OAISensitiveData_disability();
    OAISensitiveData_disability(QString json);
    ~OAISensitiveData_disability() override;
    ...
    QString getDisability() const;
    void setDisability(const QString &disability);
    bool is_disability_Set() const;
    bool is_disability_Valid() const;

    QList<OAISensitiveData_disability_disabilityClassifications_inner> getDisabilityClassifications() const;
    void setDisabilityClassifications(const QList<OAISensitiveData_disability_disabilityClassifications_inner> &disability_classifications);
    bool is_disability_classifications_Set() const;
    bool is_disability_classifications_Valid() const;

    QString getHasDisability() const;
    void setHasDisability(const QString &has_disability);
    bool is_has_disability_Set() const;
    bool is_has_disability_Valid() const;
...
private:
    ...
    QString m_disability;
    bool m_disability_isSet;
    bool m_disability_isValid;

    QList<OAISensitiveData_disability_disabilityClassifications_inner> m_disability_classifications;
    bool m_disability_classifications_isSet;
    bool m_disability_classifications_isValid;

    QString m_has_disability;
    bool m_has_disability_isSet;
    bool m_has_disability_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData_disability)

#endif // OAISensitiveData_disability_H
