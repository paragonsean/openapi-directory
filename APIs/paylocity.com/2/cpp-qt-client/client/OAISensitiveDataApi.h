...
#ifndef OAI_OAISensitiveDataApi_H
#define OAI_OAISensitiveDataApi_H
...
class OAISensitiveDataApi : public QObject {
    Q_OBJECT

public:
    OAISensitiveDataApi(const int timeOut = 0);
    ~OAISensitiveDataApi();
    ...
    * @param[in]  oai_sensitive_data OAISensitiveData [required]
    */
    virtual void add_or_update_Sensitive_Data(const QString &company_id, const QString &employee_id, const OAISensitiveData &oai_sensitive_data);

    /**
    * @param[in]  company_id QString [required]
    * @param[in]  employee_id QString [required]
    */
    virtual void get_sensitive_data(const QString &company_id, const QString &employee_id);
...
private:
    ...
    void add_or_update_Sensitive_DataCallback(OAIHttpRequestWorker *worker);
    void get_sensitive_dataCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_or_update_Sensitive_DataSignal();
    void get_sensitive_dataSignal(QList<OAISensitiveData> summary);


    void add_or_update_Sensitive_DataSignalFull(OAIHttpRequestWorker *worker);
    void get_sensitive_dataSignalFull(OAIHttpRequestWorker *worker, QList<OAISensitiveData> summary);

    Q_DECL_DEPRECATED_X("Use add_or_update_Sensitive_DataSignalError() instead")
    void add_or_update_Sensitive_DataSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_Sensitive_DataSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_sensitive_dataSignalError() instead")
    void get_sensitive_dataSignalE(QList<OAISensitiveData> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_sensitive_dataSignalError(QList<OAISensitiveData> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_or_update_Sensitive_DataSignalErrorFull() instead")
    void add_or_update_Sensitive_DataSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_Sensitive_DataSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_sensitive_dataSignalErrorFull() instead")
    void get_sensitive_dataSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_sensitive_dataSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
