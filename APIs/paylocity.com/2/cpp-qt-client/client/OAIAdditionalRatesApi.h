...
#ifndef OAI_OAIAdditionalRatesApi_H
#define OAI_OAIAdditionalRatesApi_H
...
class OAIAdditionalRatesApi : public QObject {
    Q_OBJECT

public:
    OAIAdditionalRatesApi(const int timeOut = 0);
    ~OAIAdditionalRatesApi();
    ...
    * @param[in]  oai_additional_rate OAIAdditionalRate [required]
    */
    virtual void add_or_update_additional_rates(const QString &company_id, const QString &employee_id, const OAIAdditionalRate &oai_additional_rate);
...
private:
    ...
    void add_or_update_additional_ratesCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_or_update_additional_ratesSignal();


    void add_or_update_additional_ratesSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use add_or_update_additional_ratesSignalError() instead")
    void add_or_update_additional_ratesSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_additional_ratesSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_or_update_additional_ratesSignalErrorFull() instead")
    void add_or_update_additional_ratesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_additional_ratesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
