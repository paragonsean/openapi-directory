...
OAISensitiveDataApi::OAISensitiveDataApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAISensitiveDataApi::~OAISensitiveDataApi() {
}

void OAISensitiveDataApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("add_or_update_Sensitive_Data", defaultConf);
    _serverIndices.insert("add_or_update_Sensitive_Data", 0);
    _serverConfigs.insert("get_sensitive_data", defaultConf);
    _serverIndices.insert("get_sensitive_data", 0);
}
...
*/
int OAISensitiveDataApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAISensitiveDataApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAISensitiveDataApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAISensitiveDataApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAISensitiveDataApi::setUsername(const QString &username) {
    _username = username;
}

void OAISensitiveDataApi::setPassword(const QString &password) {
    _password = password;
}


void OAISensitiveDataApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAISensitiveDataApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAISensitiveDataApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAISensitiveDataApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISensitiveDataApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAISensitiveDataApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAISensitiveDataApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAISensitiveDataApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAISensitiveDataApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAISensitiveDataApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAISensitiveDataApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAISensitiveDataApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAISensitiveDataApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAISensitiveDataApi::add_or_update_Sensitive_Data(const QString &company_id, const QString &employee_id, const OAISensitiveData &oai_sensitive_data) {
    QString fullPath = QString(_serverConfigs["add_or_update_Sensitive_Data"][_serverIndices.value("add_or_update_Sensitive_Data")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/sensitivedata");
...

    {
        ...
        QByteArray output = oai_sensitive_data.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISensitiveDataApi::add_or_update_Sensitive_DataCallback);
    connect(this, &OAISensitiveDataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISensitiveDataApi::add_or_update_Sensitive_DataCallback);
    connect(this, &OAISensitiveDataApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAISensitiveDataApi::add_or_update_Sensitive_DataCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_or_update_Sensitive_DataSignal();
        Q_EMIT add_or_update_Sensitive_DataSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_or_update_Sensitive_DataSignalE(error_type, error_str);
        Q_EMIT add_or_update_Sensitive_DataSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_or_update_Sensitive_DataSignalError(error_type, error_str);
        Q_EMIT add_or_update_Sensitive_DataSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISensitiveDataApi::get_sensitive_data(const QString &company_id, const QString &employee_id) {
    QString fullPath = QString(_serverConfigs["get_sensitive_data"][_serverIndices.value("get_sensitive_data")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/sensitivedata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISensitiveDataApi::get_sensitive_dataCallback);
    connect(this, &OAISensitiveDataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISensitiveDataApi::get_sensitive_dataCallback);
    connect(this, &OAISensitiveDataApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAISensitiveDataApi::get_sensitive_dataCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAISensitiveData> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAISensitiveData val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_sensitive_dataSignal(output);
        Q_EMIT get_sensitive_dataSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_sensitive_dataSignalE(output, error_type, error_str);
        Q_EMIT get_sensitive_dataSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_sensitive_dataSignalError(output, error_type, error_str);
        Q_EMIT get_sensitive_dataSignalErrorFull(worker, error_type, error_str);
    }
}

void OAISensitiveDataApi::tokenAvailable(){
