...
OAIEmployee_additionalRate_inner::OAIEmployee_additionalRate_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_additionalRate_inner::OAIEmployee_additionalRate_inner() {
    this->initializeModel();
}

OAIEmployee_additionalRate_inner::~OAIEmployee_additionalRate_inner() {}

void OAIEmployee_additionalRate_inner::initializeModel() {
...
void OAIEmployee_additionalRate_inner::fromJson(QString jsonString) {
...
void OAIEmployee_additionalRate_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_additionalRate_inner::asJson() const {
...
QJsonObject OAIEmployee_additionalRate_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEmployee_additionalRate_inner::getChangeReason() const {
    return m_change_reason;
}
void OAIEmployee_additionalRate_inner::setChangeReason(const QString &change_reason) {
    m_change_reason = change_reason;
    m_change_reason_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_change_reason_Set() const{
    return m_change_reason_isSet;
}

bool OAIEmployee_additionalRate_inner::is_change_reason_Valid() const{
    return m_change_reason_isValid;
}

QString OAIEmployee_additionalRate_inner::getCostCenter1() const {
    return m_cost_center1;
}
void OAIEmployee_additionalRate_inner::setCostCenter1(const QString &cost_center1) {
    m_cost_center1 = cost_center1;
    m_cost_center1_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_cost_center1_Set() const{
    return m_cost_center1_isSet;
}

bool OAIEmployee_additionalRate_inner::is_cost_center1_Valid() const{
    return m_cost_center1_isValid;
}

QString OAIEmployee_additionalRate_inner::getCostCenter2() const {
    return m_cost_center2;
}
void OAIEmployee_additionalRate_inner::setCostCenter2(const QString &cost_center2) {
    m_cost_center2 = cost_center2;
    m_cost_center2_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_cost_center2_Set() const{
    return m_cost_center2_isSet;
}

bool OAIEmployee_additionalRate_inner::is_cost_center2_Valid() const{
    return m_cost_center2_isValid;
}

QString OAIEmployee_additionalRate_inner::getCostCenter3() const {
    return m_cost_center3;
}
void OAIEmployee_additionalRate_inner::setCostCenter3(const QString &cost_center3) {
    m_cost_center3 = cost_center3;
    m_cost_center3_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_cost_center3_Set() const{
    return m_cost_center3_isSet;
}

bool OAIEmployee_additionalRate_inner::is_cost_center3_Valid() const{
    return m_cost_center3_isValid;
}

QString OAIEmployee_additionalRate_inner::getEffectiveDate() const {
    return m_effective_date;
}
void OAIEmployee_additionalRate_inner::setEffectiveDate(const QString &effective_date) {
    m_effective_date = effective_date;
    m_effective_date_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_effective_date_Set() const{
    return m_effective_date_isSet;
}

bool OAIEmployee_additionalRate_inner::is_effective_date_Valid() const{
    return m_effective_date_isValid;
}

QString OAIEmployee_additionalRate_inner::getEndCheckDate() const {
    return m_end_check_date;
}
void OAIEmployee_additionalRate_inner::setEndCheckDate(const QString &end_check_date) {
    m_end_check_date = end_check_date;
    m_end_check_date_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_end_check_date_Set() const{
    return m_end_check_date_isSet;
}

bool OAIEmployee_additionalRate_inner::is_end_check_date_Valid() const{
    return m_end_check_date_isValid;
}

QString OAIEmployee_additionalRate_inner::getJob() const {
    return m_job;
}
void OAIEmployee_additionalRate_inner::setJob(const QString &job) {
    m_job = job;
    m_job_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_job_Set() const{
    return m_job_isSet;
}

bool OAIEmployee_additionalRate_inner::is_job_Valid() const{
    return m_job_isValid;
}

double OAIEmployee_additionalRate_inner::getRate() const {
    return m_rate;
}
void OAIEmployee_additionalRate_inner::setRate(const double &rate) {
    m_rate = rate;
    m_rate_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_rate_Set() const{
    return m_rate_isSet;
}

bool OAIEmployee_additionalRate_inner::is_rate_Valid() const{
    return m_rate_isValid;
}

QString OAIEmployee_additionalRate_inner::getRateCode() const {
    return m_rate_code;
}
void OAIEmployee_additionalRate_inner::setRateCode(const QString &rate_code) {
    m_rate_code = rate_code;
    m_rate_code_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_rate_code_Set() const{
    return m_rate_code_isSet;
}

bool OAIEmployee_additionalRate_inner::is_rate_code_Valid() const{
    return m_rate_code_isValid;
}

QString OAIEmployee_additionalRate_inner::getRateNotes() const {
    return m_rate_notes;
}
void OAIEmployee_additionalRate_inner::setRateNotes(const QString &rate_notes) {
    m_rate_notes = rate_notes;
    m_rate_notes_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_rate_notes_Set() const{
    return m_rate_notes_isSet;
}

bool OAIEmployee_additionalRate_inner::is_rate_notes_Valid() const{
    return m_rate_notes_isValid;
}

QString OAIEmployee_additionalRate_inner::getRatePer() const {
    return m_rate_per;
}
void OAIEmployee_additionalRate_inner::setRatePer(const QString &rate_per) {
    m_rate_per = rate_per;
    m_rate_per_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_rate_per_Set() const{
    return m_rate_per_isSet;
}

bool OAIEmployee_additionalRate_inner::is_rate_per_Valid() const{
    return m_rate_per_isValid;
}

QString OAIEmployee_additionalRate_inner::getShift() const {
    return m_shift;
}
void OAIEmployee_additionalRate_inner::setShift(const QString &shift) {
    m_shift = shift;
    m_shift_isSet = true;
}

bool OAIEmployee_additionalRate_inner::is_shift_Set() const{
    return m_shift_isSet;
}

bool OAIEmployee_additionalRate_inner::is_shift_Valid() const{
    return m_shift_isValid;
}

bool OAIEmployee_additionalRate_inner::isSet() const {
...
bool OAIEmployee_additionalRate_inner::isValid() const {
