...
#ifndef OAI_OAICompanySpecificSchemaApi_H
#define OAI_OAICompanySpecificSchemaApi_H
...
class OAICompanySpecificSchemaApi : public QObject {
    Q_OBJECT

public:
    OAICompanySpecificSchemaApi(const int timeOut = 0);
    ~OAICompanySpecificSchemaApi();
    ...
    */
    virtual void get_companySpecific_Open_API_documentation(const QString &authorization, const QString &company_id);
...
private:
    ...
    void get_companySpecific_Open_API_documentationCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_companySpecific_Open_API_documentationSignal();


    void get_companySpecific_Open_API_documentationSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use get_companySpecific_Open_API_documentationSignalError() instead")
    void get_companySpecific_Open_API_documentationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void get_companySpecific_Open_API_documentationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_companySpecific_Open_API_documentationSignalErrorFull() instead")
    void get_companySpecific_Open_API_documentationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_companySpecific_Open_API_documentationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
