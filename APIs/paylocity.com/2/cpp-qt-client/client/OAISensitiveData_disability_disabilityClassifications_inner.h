...
/*
 * OAISensitiveData_disability_disabilityClassifications_inner.h
 *
 * The disabilty classifications model
 */

#ifndef OAISensitiveData_disability_disabilityClassifications_inner_H
#define OAISensitiveData_disability_disabilityClassifications_inner_H
...
class OAISensitiveData_disability_disabilityClassifications_inner : public OAIObject {
public:
    OAISensitiveData_disability_disabilityClassifications_inner();
    OAISensitiveData_disability_disabilityClassifications_inner(QString json);
    ~OAISensitiveData_disability_disabilityClassifications_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData_disability_disabilityClassifications_inner)

#endif // OAISensitiveData_disability_disabilityClassifications_inner_H
