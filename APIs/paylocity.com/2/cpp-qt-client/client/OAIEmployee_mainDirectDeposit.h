...
/*
 * OAIEmployee_mainDirectDeposit.h
 *
...
#ifndef OAIEmployee_mainDirectDeposit_H
#define OAIEmployee_mainDirectDeposit_H
...
class OAIEmployee_mainDirectDeposit : public OAIObject {
public:
    OAIEmployee_mainDirectDeposit();
    OAIEmployee_mainDirectDeposit(QString json);
    ~OAIEmployee_mainDirectDeposit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_mainDirectDeposit)

#endif // OAIEmployee_mainDirectDeposit_H
