...
#ifndef OAI_OAIEmployeeBenefitSetupApi_H
#define OAI_OAIEmployeeBenefitSetupApi_H
...
class OAIEmployeeBenefitSetupApi : public QObject {
    Q_OBJECT

public:
    OAIEmployeeBenefitSetupApi(const int timeOut = 0);
    ~OAIEmployeeBenefitSetupApi();
    ...
    * @param[in]  oai_benefit_setup OAIBenefitSetup [required]
    */
    virtual void update_or_add_employee_benefit_setup(const QString &company_id, const QString &employee_id, const OAIBenefitSetup &oai_benefit_setup);
...
private:
    ...
    void update_or_add_employee_benefit_setupCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void update_or_add_employee_benefit_setupSignal();


    void update_or_add_employee_benefit_setupSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use update_or_add_employee_benefit_setupSignalError() instead")
    void update_or_add_employee_benefit_setupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void update_or_add_employee_benefit_setupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use update_or_add_employee_benefit_setupSignalErrorFull() instead")
    void update_or_add_employee_benefit_setupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void update_or_add_employee_benefit_setupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
