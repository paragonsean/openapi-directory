...
OAIBenefitSetup::OAIBenefitSetup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBenefitSetup::OAIBenefitSetup() {
    this->initializeModel();
}

OAIBenefitSetup::~OAIBenefitSetup() {}

void OAIBenefitSetup::initializeModel() {

    m_benefit_class_isSet = false;
    m_benefit_class_isValid = false;

    m_benefit_class_effective_date_isSet = false;
    m_benefit_class_effective_date_isValid = false;

    m_benefit_salary_isSet = false;
    m_benefit_salary_isValid = false;

    m_benefit_salary_effective_date_isSet = false;
    m_benefit_salary_effective_date_isValid = false;

    m_do_not_apply_administrative_period_isSet = false;
    m_do_not_apply_administrative_period_isValid = false;

    m_is_measure_aca_eligibility_isSet = false;
    m_is_measure_aca_eligibility_isValid = false;
}

void OAIBenefitSetup::fromJson(QString jsonString) {
...
void OAIBenefitSetup::fromJsonObject(QJsonObject json) {

    m_benefit_class_isValid = ::OpenAPI::fromJsonValue(m_benefit_class, json[QString("benefitClass")]);
    m_benefit_class_isSet = !json[QString("benefitClass")].isNull() && m_benefit_class_isValid;

    m_benefit_class_effective_date_isValid = ::OpenAPI::fromJsonValue(m_benefit_class_effective_date, json[QString("benefitClassEffectiveDate")]);
    m_benefit_class_effective_date_isSet = !json[QString("benefitClassEffectiveDate")].isNull() && m_benefit_class_effective_date_isValid;

    m_benefit_salary_isValid = ::OpenAPI::fromJsonValue(m_benefit_salary, json[QString("benefitSalary")]);
    m_benefit_salary_isSet = !json[QString("benefitSalary")].isNull() && m_benefit_salary_isValid;

    m_benefit_salary_effective_date_isValid = ::OpenAPI::fromJsonValue(m_benefit_salary_effective_date, json[QString("benefitSalaryEffectiveDate")]);
    m_benefit_salary_effective_date_isSet = !json[QString("benefitSalaryEffectiveDate")].isNull() && m_benefit_salary_effective_date_isValid;

    m_do_not_apply_administrative_period_isValid = ::OpenAPI::fromJsonValue(m_do_not_apply_administrative_period, json[QString("doNotApplyAdministrativePeriod")]);
    m_do_not_apply_administrative_period_isSet = !json[QString("doNotApplyAdministrativePeriod")].isNull() && m_do_not_apply_administrative_period_isValid;

    m_is_measure_aca_eligibility_isValid = ::OpenAPI::fromJsonValue(m_is_measure_aca_eligibility, json[QString("isMeasureAcaEligibility")]);
    m_is_measure_aca_eligibility_isSet = !json[QString("isMeasureAcaEligibility")].isNull() && m_is_measure_aca_eligibility_isValid;
}

QString OAIBenefitSetup::asJson() const {
...
QJsonObject OAIBenefitSetup::asJsonObject() const {
    QJsonObject obj;
    if (m_benefit_class_isSet) {
        obj.insert(QString("benefitClass"), ::OpenAPI::toJsonValue(m_benefit_class));
    }
    if (m_benefit_class_effective_date_isSet) {
        obj.insert(QString("benefitClassEffectiveDate"), ::OpenAPI::toJsonValue(m_benefit_class_effective_date));
    }
    if (m_benefit_salary_isSet) {
        obj.insert(QString("benefitSalary"), ::OpenAPI::toJsonValue(m_benefit_salary));
    }
    if (m_benefit_salary_effective_date_isSet) {
        obj.insert(QString("benefitSalaryEffectiveDate"), ::OpenAPI::toJsonValue(m_benefit_salary_effective_date));
    }
    if (m_do_not_apply_administrative_period_isSet) {
        obj.insert(QString("doNotApplyAdministrativePeriod"), ::OpenAPI::toJsonValue(m_do_not_apply_administrative_period));
    }
    if (m_is_measure_aca_eligibility_isSet) {
        obj.insert(QString("isMeasureAcaEligibility"), ::OpenAPI::toJsonValue(m_is_measure_aca_eligibility));
    }
    return obj;
}

QString OAIBenefitSetup::getBenefitClass() const {
    return m_benefit_class;
}
void OAIBenefitSetup::setBenefitClass(const QString &benefit_class) {
    m_benefit_class = benefit_class;
    m_benefit_class_isSet = true;
}

bool OAIBenefitSetup::is_benefit_class_Set() const{
    return m_benefit_class_isSet;
}

bool OAIBenefitSetup::is_benefit_class_Valid() const{
    return m_benefit_class_isValid;
}

QString OAIBenefitSetup::getBenefitClassEffectiveDate() const {
    return m_benefit_class_effective_date;
}
void OAIBenefitSetup::setBenefitClassEffectiveDate(const QString &benefit_class_effective_date) {
    m_benefit_class_effective_date = benefit_class_effective_date;
    m_benefit_class_effective_date_isSet = true;
}

bool OAIBenefitSetup::is_benefit_class_effective_date_Set() const{
    return m_benefit_class_effective_date_isSet;
}

bool OAIBenefitSetup::is_benefit_class_effective_date_Valid() const{
    return m_benefit_class_effective_date_isValid;
}

double OAIBenefitSetup::getBenefitSalary() const {
    return m_benefit_salary;
}
void OAIBenefitSetup::setBenefitSalary(const double &benefit_salary) {
    m_benefit_salary = benefit_salary;
    m_benefit_salary_isSet = true;
}

bool OAIBenefitSetup::is_benefit_salary_Set() const{
    return m_benefit_salary_isSet;
}

bool OAIBenefitSetup::is_benefit_salary_Valid() const{
    return m_benefit_salary_isValid;
}

QString OAIBenefitSetup::getBenefitSalaryEffectiveDate() const {
    return m_benefit_salary_effective_date;
}
void OAIBenefitSetup::setBenefitSalaryEffectiveDate(const QString &benefit_salary_effective_date) {
    m_benefit_salary_effective_date = benefit_salary_effective_date;
    m_benefit_salary_effective_date_isSet = true;
}

bool OAIBenefitSetup::is_benefit_salary_effective_date_Set() const{
    return m_benefit_salary_effective_date_isSet;
}

bool OAIBenefitSetup::is_benefit_salary_effective_date_Valid() const{
    return m_benefit_salary_effective_date_isValid;
}

bool OAIBenefitSetup::isDoNotApplyAdministrativePeriod() const {
    return m_do_not_apply_administrative_period;
}
void OAIBenefitSetup::setDoNotApplyAdministrativePeriod(const bool &do_not_apply_administrative_period) {
    m_do_not_apply_administrative_period = do_not_apply_administrative_period;
    m_do_not_apply_administrative_period_isSet = true;
}

bool OAIBenefitSetup::is_do_not_apply_administrative_period_Set() const{
    return m_do_not_apply_administrative_period_isSet;
}

bool OAIBenefitSetup::is_do_not_apply_administrative_period_Valid() const{
    return m_do_not_apply_administrative_period_isValid;
}

bool OAIBenefitSetup::isIsMeasureAcaEligibility() const {
    return m_is_measure_aca_eligibility;
}
void OAIBenefitSetup::setIsMeasureAcaEligibility(const bool &is_measure_aca_eligibility) {
    m_is_measure_aca_eligibility = is_measure_aca_eligibility;
    m_is_measure_aca_eligibility_isSet = true;
}

bool OAIBenefitSetup::is_is_measure_aca_eligibility_Set() const{
    return m_is_measure_aca_eligibility_isSet;
}

bool OAIBenefitSetup::is_is_measure_aca_eligibility_Valid() const{
    return m_is_measure_aca_eligibility_isValid;
}

bool OAIBenefitSetup::isSet() const {
...
bool OAIBenefitSetup::isValid() const {
