...
/*
 * OAIStagedEmployee_webTime.h
 *
 * Add Web Time badge number and charge rate and synchronize Web Pay and Web Time employee data.
 */

#ifndef OAIStagedEmployee_webTime_H
#define OAIStagedEmployee_webTime_H
...
class OAIStagedEmployee_webTime : public OAIObject {
public:
    OAIStagedEmployee_webTime();
    OAIStagedEmployee_webTime(QString json);
    ~OAIStagedEmployee_webTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_webTime)

#endif // OAIStagedEmployee_webTime_H
