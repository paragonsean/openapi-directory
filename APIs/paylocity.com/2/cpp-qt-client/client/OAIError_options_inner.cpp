...
OAIError_options_inner::OAIError_options_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIError_options_inner::OAIError_options_inner() {
    this->initializeModel();
}

OAIError_options_inner::~OAIError_options_inner() {}

void OAIError_options_inner::initializeModel() {
...
void OAIError_options_inner::fromJson(QString jsonString) {
...
void OAIError_options_inner::fromJsonObject(QJsonObject json) {
...
QString OAIError_options_inner::asJson() const {
...
QJsonObject OAIError_options_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIError_options_inner::getCode() const {
    return m_code;
}
void OAIError_options_inner::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIError_options_inner::is_code_Set() const{
    return m_code_isSet;
}

bool OAIError_options_inner::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIError_options_inner::getDescription() const {
    return m_description;
}
void OAIError_options_inner::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIError_options_inner::is_description_Set() const{
    return m_description_isSet;
}

bool OAIError_options_inner::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIError_options_inner::isSet() const {
...
bool OAIError_options_inner::isValid() const {
