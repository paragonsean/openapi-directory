...
/*
 * OAIStagedEmployee_homeAddress_inner.h
 *
 * The address model
 */

#ifndef OAIStagedEmployee_homeAddress_inner_H
#define OAIStagedEmployee_homeAddress_inner_H
...
class OAIStagedEmployee_homeAddress_inner : public OAIObject {
public:
    OAIStagedEmployee_homeAddress_inner();
    OAIStagedEmployee_homeAddress_inner(QString json);
    ~OAIStagedEmployee_homeAddress_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_homeAddress_inner)

#endif // OAIStagedEmployee_homeAddress_inner_H
