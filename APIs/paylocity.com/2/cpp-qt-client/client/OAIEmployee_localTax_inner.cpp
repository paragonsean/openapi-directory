...
OAIEmployee_localTax_inner::OAIEmployee_localTax_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_localTax_inner::OAIEmployee_localTax_inner() {
    this->initializeModel();
}

OAIEmployee_localTax_inner::~OAIEmployee_localTax_inner() {}

void OAIEmployee_localTax_inner::initializeModel() {
...
void OAIEmployee_localTax_inner::fromJson(QString jsonString) {
...
void OAIEmployee_localTax_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_localTax_inner::asJson() const {
...
QJsonObject OAIEmployee_localTax_inner::asJsonObject() const {
    QJsonObject obj;
...
double OAIEmployee_localTax_inner::getExemptions() const {
    return m_exemptions;
}
void OAIEmployee_localTax_inner::setExemptions(const double &exemptions) {
    m_exemptions = exemptions;
    m_exemptions_isSet = true;
}

bool OAIEmployee_localTax_inner::is_exemptions_Set() const{
    return m_exemptions_isSet;
}

bool OAIEmployee_localTax_inner::is_exemptions_Valid() const{
    return m_exemptions_isValid;
}

double OAIEmployee_localTax_inner::getExemptions2() const {
    return m_exemptions2;
}
void OAIEmployee_localTax_inner::setExemptions2(const double &exemptions2) {
    m_exemptions2 = exemptions2;
    m_exemptions2_isSet = true;
}

bool OAIEmployee_localTax_inner::is_exemptions2_Set() const{
    return m_exemptions2_isSet;
}

bool OAIEmployee_localTax_inner::is_exemptions2_Valid() const{
    return m_exemptions2_isValid;
}

QString OAIEmployee_localTax_inner::getFilingStatus() const {
    return m_filing_status;
}
void OAIEmployee_localTax_inner::setFilingStatus(const QString &filing_status) {
    m_filing_status = filing_status;
    m_filing_status_isSet = true;
}

bool OAIEmployee_localTax_inner::is_filing_status_Set() const{
    return m_filing_status_isSet;
}

bool OAIEmployee_localTax_inner::is_filing_status_Valid() const{
    return m_filing_status_isValid;
}

QString OAIEmployee_localTax_inner::getResidentPsd() const {
    return m_resident_psd;
}
void OAIEmployee_localTax_inner::setResidentPsd(const QString &resident_psd) {
    m_resident_psd = resident_psd;
    m_resident_psd_isSet = true;
}

bool OAIEmployee_localTax_inner::is_resident_psd_Set() const{
    return m_resident_psd_isSet;
}

bool OAIEmployee_localTax_inner::is_resident_psd_Valid() const{
    return m_resident_psd_isValid;
}

QString OAIEmployee_localTax_inner::getTaxCode() const {
    return m_tax_code;
}
void OAIEmployee_localTax_inner::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIEmployee_localTax_inner::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIEmployee_localTax_inner::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

QString OAIEmployee_localTax_inner::getWorkPsd() const {
    return m_work_psd;
}
void OAIEmployee_localTax_inner::setWorkPsd(const QString &work_psd) {
    m_work_psd = work_psd;
    m_work_psd_isSet = true;
}

bool OAIEmployee_localTax_inner::is_work_psd_Set() const{
    return m_work_psd_isSet;
}

bool OAIEmployee_localTax_inner::is_work_psd_Valid() const{
    return m_work_psd_isValid;
}

bool OAIEmployee_localTax_inner::isSet() const {
...
bool OAIEmployee_localTax_inner::isValid() const {
