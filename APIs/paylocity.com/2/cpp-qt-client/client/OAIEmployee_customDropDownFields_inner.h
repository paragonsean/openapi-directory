...
/*
 * OAIEmployee_customDropDownFields_inner.h
 *
 * 
 */

#ifndef OAIEmployee_customDropDownFields_inner_H
#define OAIEmployee_customDropDownFields_inner_H
...
class OAIEmployee_customDropDownFields_inner : public OAIObject {
public:
    OAIEmployee_customDropDownFields_inner();
    OAIEmployee_customDropDownFields_inner(QString json);
    ~OAIEmployee_customDropDownFields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_customDropDownFields_inner)

#endif // OAIEmployee_customDropDownFields_inner_H
