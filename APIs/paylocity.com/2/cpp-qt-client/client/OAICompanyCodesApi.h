...
#ifndef OAI_OAICompanyCodesApi_H
#define OAI_OAICompanyCodesApi_H
...
class OAICompanyCodesApi : public QObject {
    Q_OBJECT

public:
    OAICompanyCodesApi(const int timeOut = 0);
    ~OAICompanyCodesApi();
    ...
    * @param[in]  code_resource QString [required]
    */
    virtual void get_All_Company_Codes_and_Descriptions_by_Resource(const QString &company_id, const QString &code_resource);
...
private:
    ...
    void get_All_Company_Codes_and_Descriptions_by_ResourceCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_All_Company_Codes_and_Descriptions_by_ResourceSignal(QList<OAICompanyCodes> summary);


    void get_All_Company_Codes_and_Descriptions_by_ResourceSignalFull(OAIHttpRequestWorker *worker, QList<OAICompanyCodes> summary);

    Q_DECL_DEPRECATED_X("Use get_All_Company_Codes_and_Descriptions_by_ResourceSignalError() instead")
    void get_All_Company_Codes_and_Descriptions_by_ResourceSignalE(QList<OAICompanyCodes> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_Company_Codes_and_Descriptions_by_ResourceSignalError(QList<OAICompanyCodes> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_All_Company_Codes_and_Descriptions_by_ResourceSignalErrorFull() instead")
    void get_All_Company_Codes_and_Descriptions_by_ResourceSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_Company_Codes_and_Descriptions_by_ResourceSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
