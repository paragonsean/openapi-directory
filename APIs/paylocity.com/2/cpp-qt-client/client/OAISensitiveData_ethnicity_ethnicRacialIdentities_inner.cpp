...
#include "OAISensitiveData_ethnicity_ethnicRacialIdentities_inner.h"
...
OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::OAISensitiveData_ethnicity_ethnicRacialIdentities_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::OAISensitiveData_ethnicity_ethnicRacialIdentities_inner() {
    this->initializeModel();
}

OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::~OAISensitiveData_ethnicity_ethnicRacialIdentities_inner() {}

void OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::initializeModel() {

    m_description_isSet = false;
    m_description_isValid = false;
}

void OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::fromJson(QString jsonString) {
...
void OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::fromJsonObject(QJsonObject json) {

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("description")]);
    m_description_isSet = !json[QString("description")].isNull() && m_description_isValid;
}

QString OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::asJson() const {
...
QJsonObject OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::getDescription() const {
    return m_description;
}
void OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::is_description_Set() const{
    return m_description_isSet;
}

bool OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::is_description_Valid() const{
    return m_description_isValid;
}

bool OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::isSet() const {
...
bool OAISensitiveData_ethnicity_ethnicRacialIdentities_inner::isValid() const {
