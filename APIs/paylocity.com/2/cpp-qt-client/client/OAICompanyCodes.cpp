...
OAICompanyCodes::OAICompanyCodes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompanyCodes::OAICompanyCodes() {
    this->initializeModel();
}

OAICompanyCodes::~OAICompanyCodes() {}

void OAICompanyCodes::initializeModel() {
...
void OAICompanyCodes::fromJson(QString jsonString) {
...
void OAICompanyCodes::fromJsonObject(QJsonObject json) {
...
QString OAICompanyCodes::asJson() const {
...
QJsonObject OAICompanyCodes::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAICompanyCodes::getCode() const {
    return m_code;
}
void OAICompanyCodes::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAICompanyCodes::is_code_Set() const{
    return m_code_isSet;
}

bool OAICompanyCodes::is_code_Valid() const{
    return m_code_isValid;
}

QString OAICompanyCodes::getDescription() const {
    return m_description;
}
void OAICompanyCodes::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICompanyCodes::is_description_Set() const{
    return m_description_isSet;
}

bool OAICompanyCodes::is_description_Valid() const{
    return m_description_isValid;
}

bool OAICompanyCodes::isSet() const {
...
bool OAICompanyCodes::isValid() const {
