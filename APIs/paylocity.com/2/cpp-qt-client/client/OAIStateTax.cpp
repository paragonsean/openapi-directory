...
OAIStateTax::OAIStateTax(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStateTax::OAIStateTax() {
    this->initializeModel();
}

OAIStateTax::~OAIStateTax() {}

void OAIStateTax::initializeModel() {
...
void OAIStateTax::fromJson(QString jsonString) {
...
void OAIStateTax::fromJsonObject(QJsonObject json) {
...
QString OAIStateTax::asJson() const {
...
QJsonObject OAIStateTax::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAIStateTax::getAmount() const {
    return m_amount;
}
void OAIStateTax::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIStateTax::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIStateTax::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIStateTax::getDeductionsAmount() const {
    return m_deductions_amount;
}
void OAIStateTax::setDeductionsAmount(const double &deductions_amount) {
    m_deductions_amount = deductions_amount;
    m_deductions_amount_isSet = true;
}

bool OAIStateTax::is_deductions_amount_Set() const{
    return m_deductions_amount_isSet;
}

bool OAIStateTax::is_deductions_amount_Valid() const{
    return m_deductions_amount_isValid;
}

double OAIStateTax::getDependentsAmount() const {
    return m_dependents_amount;
}
void OAIStateTax::setDependentsAmount(const double &dependents_amount) {
    m_dependents_amount = dependents_amount;
    m_dependents_amount_isSet = true;
}

bool OAIStateTax::is_dependents_amount_Set() const{
    return m_dependents_amount_isSet;
}

bool OAIStateTax::is_dependents_amount_Valid() const{
    return m_dependents_amount_isValid;
}

double OAIStateTax::getExemptions() const {
    return m_exemptions;
}
void OAIStateTax::setExemptions(const double &exemptions) {
    m_exemptions = exemptions;
    m_exemptions_isSet = true;
}

bool OAIStateTax::is_exemptions_Set() const{
    return m_exemptions_isSet;
}

bool OAIStateTax::is_exemptions_Valid() const{
    return m_exemptions_isValid;
}

double OAIStateTax::getExemptions2() const {
    return m_exemptions2;
}
void OAIStateTax::setExemptions2(const double &exemptions2) {
    m_exemptions2 = exemptions2;
    m_exemptions2_isSet = true;
}

bool OAIStateTax::is_exemptions2_Set() const{
    return m_exemptions2_isSet;
}

bool OAIStateTax::is_exemptions2_Valid() const{
    return m_exemptions2_isValid;
}

QString OAIStateTax::getFilingStatus() const {
    return m_filing_status;
}
void OAIStateTax::setFilingStatus(const QString &filing_status) {
    m_filing_status = filing_status;
    m_filing_status_isSet = true;
}

bool OAIStateTax::is_filing_status_Set() const{
    return m_filing_status_isSet;
}

bool OAIStateTax::is_filing_status_Valid() const{
    return m_filing_status_isValid;
}

bool OAIStateTax::isHigherRate() const {
    return m_higher_rate;
}
void OAIStateTax::setHigherRate(const bool &higher_rate) {
    m_higher_rate = higher_rate;
    m_higher_rate_isSet = true;
}

bool OAIStateTax::is_higher_rate_Set() const{
    return m_higher_rate_isSet;
}

bool OAIStateTax::is_higher_rate_Valid() const{
    return m_higher_rate_isValid;
}

double OAIStateTax::getOtherIncomeAmount() const {
    return m_other_income_amount;
}
void OAIStateTax::setOtherIncomeAmount(const double &other_income_amount) {
    m_other_income_amount = other_income_amount;
    m_other_income_amount_isSet = true;
}

bool OAIStateTax::is_other_income_amount_Set() const{
    return m_other_income_amount_isSet;
}

bool OAIStateTax::is_other_income_amount_Valid() const{
    return m_other_income_amount_isValid;
}

double OAIStateTax::getPercentage() const {
    return m_percentage;
}
void OAIStateTax::setPercentage(const double &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAIStateTax::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAIStateTax::is_percentage_Valid() const{
    return m_percentage_isValid;
}

QString OAIStateTax::getSpecialCheckCalc() const {
    return m_special_check_calc;
}
void OAIStateTax::setSpecialCheckCalc(const QString &special_check_calc) {
    m_special_check_calc = special_check_calc;
    m_special_check_calc_isSet = true;
}

bool OAIStateTax::is_special_check_calc_Set() const{
    return m_special_check_calc_isSet;
}

bool OAIStateTax::is_special_check_calc_Valid() const{
    return m_special_check_calc_isValid;
}

QString OAIStateTax::getTaxCalculationCode() const {
    return m_tax_calculation_code;
}
void OAIStateTax::setTaxCalculationCode(const QString &tax_calculation_code) {
    m_tax_calculation_code = tax_calculation_code;
    m_tax_calculation_code_isSet = true;
}

bool OAIStateTax::is_tax_calculation_code_Set() const{
    return m_tax_calculation_code_isSet;
}

bool OAIStateTax::is_tax_calculation_code_Valid() const{
    return m_tax_calculation_code_isValid;
}

QString OAIStateTax::getTaxCode() const {
    return m_tax_code;
}
void OAIStateTax::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIStateTax::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIStateTax::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

qint32 OAIStateTax::getW4FormYear() const {
    return m_w4_form_year;
}
void OAIStateTax::setW4FormYear(const qint32 &w4_form_year) {
    m_w4_form_year = w4_form_year;
    m_w4_form_year_isSet = true;
}

bool OAIStateTax::is_w4_form_year_Set() const{
    return m_w4_form_year_isSet;
}

bool OAIStateTax::is_w4_form_year_Valid() const{
    return m_w4_form_year_isValid;
}

bool OAIStateTax::isSet() const {
...
bool OAIStateTax::isValid() const {
