...
OAIEmployeeInfo::OAIEmployeeInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployeeInfo::OAIEmployeeInfo() {
    this->initializeModel();
}

OAIEmployeeInfo::~OAIEmployeeInfo() {}

void OAIEmployeeInfo::initializeModel() {
    ...
    m_status_type_code_isSet = false;
    m_status_type_code_isValid = false;
}

void OAIEmployeeInfo::fromJson(QString jsonString) {
...
void OAIEmployeeInfo::fromJsonObject(QJsonObject json) {
    ...
    m_status_type_code_isValid = ::OpenAPI::fromJsonValue(m_status_type_code, json[QString("statusTypeCode")]);
    m_status_type_code_isSet = !json[QString("statusTypeCode")].isNull() && m_status_type_code_isValid;
}

QString OAIEmployeeInfo::asJson() const {
...
QJsonObject OAIEmployeeInfo::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_status_type_code_isSet) {
        obj.insert(QString("statusTypeCode"), ::OpenAPI::toJsonValue(m_status_type_code));
    }
    return obj;
}

QString OAIEmployeeInfo::getEmployeeId() const {
    return m_employee_id;
}
void OAIEmployeeInfo::setEmployeeId(const QString &employee_id) {
    m_employee_id = employee_id;
    m_employee_id_isSet = true;
}

bool OAIEmployeeInfo::is_employee_id_Set() const{
    return m_employee_id_isSet;
}

bool OAIEmployeeInfo::is_employee_id_Valid() const{
    return m_employee_id_isValid;
}

QString OAIEmployeeInfo::getStatusCode() const {
    return m_status_code;
}
void OAIEmployeeInfo::setStatusCode(const QString &status_code) {
    m_status_code = status_code;
    m_status_code_isSet = true;
}

bool OAIEmployeeInfo::is_status_code_Set() const{
    return m_status_code_isSet;
}

bool OAIEmployeeInfo::is_status_code_Valid() const{
    return m_status_code_isValid;
}

QString OAIEmployeeInfo::getStatusTypeCode() const {
    return m_status_type_code;
}
void OAIEmployeeInfo::setStatusTypeCode(const QString &status_type_code) {
    m_status_type_code = status_type_code;
    m_status_type_code_isSet = true;
}

bool OAIEmployeeInfo::is_status_type_code_Set() const{
    return m_status_type_code_isSet;
}

bool OAIEmployeeInfo::is_status_type_code_Valid() const{
    return m_status_type_code_isValid;
}

bool OAIEmployeeInfo::isSet() const {
...
bool OAIEmployeeInfo::isValid() const {
