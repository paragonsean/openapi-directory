...
#ifndef OAICompanyCodes_H
#define OAICompanyCodes_H
...
class OAICompanyCodes : public OAIObject {
public:
    OAICompanyCodes();
    OAICompanyCodes(QString json);
    ~OAICompanyCodes() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompanyCodes)

#endif // OAICompanyCodes_H
