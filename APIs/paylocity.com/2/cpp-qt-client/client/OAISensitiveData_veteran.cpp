...
OAISensitiveData_veteran::OAISensitiveData_veteran(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData_veteran::OAISensitiveData_veteran() {
    this->initializeModel();
}

OAISensitiveData_veteran::~OAISensitiveData_veteran() {}

void OAISensitiveData_veteran::initializeModel() {

    m_is_veteran_isSet = false;
    m_is_veteran_isValid = false;

    m_veteran_isSet = false;
    m_veteran_isValid = false;
}

void OAISensitiveData_veteran::fromJson(QString jsonString) {
...
void OAISensitiveData_veteran::fromJsonObject(QJsonObject json) {

    m_is_veteran_isValid = ::OpenAPI::fromJsonValue(m_is_veteran, json[QString("isVeteran")]);
    m_is_veteran_isSet = !json[QString("isVeteran")].isNull() && m_is_veteran_isValid;
...
QString OAISensitiveData_veteran::asJson() const {
...
QJsonObject OAISensitiveData_veteran::asJsonObject() const {
    QJsonObject obj;
    if (m_is_veteran_isSet) {
        obj.insert(QString("isVeteran"), ::OpenAPI::toJsonValue(m_is_veteran));
    }
    if (m_veteran_isSet) {
...
QString OAISensitiveData_veteran::getIsVeteran() const {
    return m_is_veteran;
}
void OAISensitiveData_veteran::setIsVeteran(const QString &is_veteran) {
    m_is_veteran = is_veteran;
    m_is_veteran_isSet = true;
}

bool OAISensitiveData_veteran::is_is_veteran_Set() const{
    return m_is_veteran_isSet;
}

bool OAISensitiveData_veteran::is_is_veteran_Valid() const{
    return m_is_veteran_isValid;
}

QString OAISensitiveData_veteran::getVeteran() const {
    return m_veteran;
}
void OAISensitiveData_veteran::setVeteran(const QString &veteran) {
    m_veteran = veteran;
    m_veteran_isSet = true;
}

bool OAISensitiveData_veteran::is_veteran_Set() const{
    return m_veteran_isSet;
}

bool OAISensitiveData_veteran::is_veteran_Valid() const{
    return m_veteran_isValid;
}

bool OAISensitiveData_veteran::isSet() const {
...
bool OAISensitiveData_veteran::isValid() const {
