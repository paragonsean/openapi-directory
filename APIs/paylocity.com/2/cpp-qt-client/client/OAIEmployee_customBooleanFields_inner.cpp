...
OAIEmployee_customBooleanFields_inner::OAIEmployee_customBooleanFields_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_customBooleanFields_inner::OAIEmployee_customBooleanFields_inner() {
    this->initializeModel();
}

OAIEmployee_customBooleanFields_inner::~OAIEmployee_customBooleanFields_inner() {}

void OAIEmployee_customBooleanFields_inner::initializeModel() {
...
void OAIEmployee_customBooleanFields_inner::fromJson(QString jsonString) {
...
void OAIEmployee_customBooleanFields_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_customBooleanFields_inner::asJson() const {
...
QJsonObject OAIEmployee_customBooleanFields_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_category_isSet) {
...
QString OAIEmployee_customBooleanFields_inner::getCategory() const {
    return m_category;
}
void OAIEmployee_customBooleanFields_inner::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIEmployee_customBooleanFields_inner::is_category_Set() const{
    return m_category_isSet;
}

bool OAIEmployee_customBooleanFields_inner::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIEmployee_customBooleanFields_inner::getLabel() const {
    return m_label;
}
void OAIEmployee_customBooleanFields_inner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEmployee_customBooleanFields_inner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEmployee_customBooleanFields_inner::is_label_Valid() const{
    return m_label_isValid;
}

bool OAIEmployee_customBooleanFields_inner::isValue() const {
    return m_value;
}
void OAIEmployee_customBooleanFields_inner::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIEmployee_customBooleanFields_inner::is_value_Set() const{
    return m_value_isSet;
}

bool OAIEmployee_customBooleanFields_inner::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIEmployee_customBooleanFields_inner::isSet() const {
...
bool OAIEmployee_customBooleanFields_inner::isValid() const {
