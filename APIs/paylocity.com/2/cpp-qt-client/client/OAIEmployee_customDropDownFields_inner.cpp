...
OAIEmployee_customDropDownFields_inner::OAIEmployee_customDropDownFields_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_customDropDownFields_inner::OAIEmployee_customDropDownFields_inner() {
    this->initializeModel();
}

OAIEmployee_customDropDownFields_inner::~OAIEmployee_customDropDownFields_inner() {}

void OAIEmployee_customDropDownFields_inner::initializeModel() {
...
void OAIEmployee_customDropDownFields_inner::fromJson(QString jsonString) {
...
void OAIEmployee_customDropDownFields_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_customDropDownFields_inner::asJson() const {
...
QJsonObject OAIEmployee_customDropDownFields_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_category_isSet) {
...
QString OAIEmployee_customDropDownFields_inner::getCategory() const {
    return m_category;
}
void OAIEmployee_customDropDownFields_inner::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIEmployee_customDropDownFields_inner::is_category_Set() const{
    return m_category_isSet;
}

bool OAIEmployee_customDropDownFields_inner::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIEmployee_customDropDownFields_inner::getLabel() const {
    return m_label;
}
void OAIEmployee_customDropDownFields_inner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEmployee_customDropDownFields_inner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEmployee_customDropDownFields_inner::is_label_Valid() const{
    return m_label_isValid;
}

QString OAIEmployee_customDropDownFields_inner::getValue() const {
    return m_value;
}
void OAIEmployee_customDropDownFields_inner::setValue(const QString &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIEmployee_customDropDownFields_inner::is_value_Set() const{
    return m_value_isSet;
}

bool OAIEmployee_customDropDownFields_inner::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIEmployee_customDropDownFields_inner::isSet() const {
...
bool OAIEmployee_customDropDownFields_inner::isValid() const {
