...
/*
 * OAITrackingNumberResponse.h
 *
 * The Tracking Number Response model
 */

#ifndef OAITrackingNumberResponse_H
#define OAITrackingNumberResponse_H
...
class OAITrackingNumberResponse : public OAIObject {
public:
    OAITrackingNumberResponse();
    OAITrackingNumberResponse(QString json);
    ~OAITrackingNumberResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrackingNumberResponse)

#endif // OAITrackingNumberResponse_H
