...
class OAIEmployee_webTime : public OAIObject {
public:
    OAIEmployee_webTime();
    OAIEmployee_webTime(QString json);
    ~OAIEmployee_webTime() override;
    ...
    QString getBadgeNumber() const;
    void setBadgeNumber(const QString &badge_number);
    bool is_badge_number_Set() const;
    bool is_badge_number_Valid() const;
    ...
    bool isIsTimeLaborEnabled() const;
    void setIsTimeLaborEnabled(const bool &is_time_labor_enabled);
    bool is_is_time_labor_enabled_Set() const;
    bool is_is_time_labor_enabled_Valid() const;
...
private:
    ...
    QString m_badge_number;
    bool m_badge_number_isSet;
    bool m_badge_number_isValid;

    double m_charge_rate;
    bool m_charge_rate_isSet;
    bool m_charge_rate_isValid;

    bool m_is_time_labor_enabled;
    bool m_is_time_labor_enabled_isSet;
    bool m_is_time_labor_enabled_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_webTime)

#endif // OAIEmployee_webTime_H
