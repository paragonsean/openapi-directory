...
#ifndef OAIBenefitSetup_H
#define OAIBenefitSetup_H
...
class OAIBenefitSetup : public OAIObject {
public:
    OAIBenefitSetup();
    OAIBenefitSetup(QString json);
    ~OAIBenefitSetup() override;
    ...
    QString getBenefitClass() const;
    void setBenefitClass(const QString &benefit_class);
    bool is_benefit_class_Set() const;
    bool is_benefit_class_Valid() const;

    QString getBenefitClassEffectiveDate() const;
    void setBenefitClassEffectiveDate(const QString &benefit_class_effective_date);
    bool is_benefit_class_effective_date_Set() const;
    bool is_benefit_class_effective_date_Valid() const;

    double getBenefitSalary() const;
    void setBenefitSalary(const double &benefit_salary);
    bool is_benefit_salary_Set() const;
    bool is_benefit_salary_Valid() const;

    QString getBenefitSalaryEffectiveDate() const;
    void setBenefitSalaryEffectiveDate(const QString &benefit_salary_effective_date);
    bool is_benefit_salary_effective_date_Set() const;
    bool is_benefit_salary_effective_date_Valid() const;

    bool isDoNotApplyAdministrativePeriod() const;
    void setDoNotApplyAdministrativePeriod(const bool &do_not_apply_administrative_period);
    bool is_do_not_apply_administrative_period_Set() const;
    bool is_do_not_apply_administrative_period_Valid() const;

    bool isIsMeasureAcaEligibility() const;
    void setIsMeasureAcaEligibility(const bool &is_measure_aca_eligibility);
    bool is_is_measure_aca_eligibility_Set() const;
    bool is_is_measure_aca_eligibility_Valid() const;
...
private:
    ...
    QString m_benefit_class;
    bool m_benefit_class_isSet;
    bool m_benefit_class_isValid;

    QString m_benefit_class_effective_date;
    bool m_benefit_class_effective_date_isSet;
    bool m_benefit_class_effective_date_isValid;

    double m_benefit_salary;
    bool m_benefit_salary_isSet;
    bool m_benefit_salary_isValid;

    QString m_benefit_salary_effective_date;
    bool m_benefit_salary_effective_date_isSet;
    bool m_benefit_salary_effective_date_isValid;

    bool m_do_not_apply_administrative_period;
    bool m_do_not_apply_administrative_period_isSet;
    bool m_do_not_apply_administrative_period_isValid;

    bool m_is_measure_aca_eligibility;
    bool m_is_measure_aca_eligibility_isSet;
    bool m_is_measure_aca_eligibility_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIBenefitSetup)

#endif // OAIBenefitSetup_H
