...
OAIStagedEmployee_primaryPayRate_inner::OAIStagedEmployee_primaryPayRate_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStagedEmployee_primaryPayRate_inner::OAIStagedEmployee_primaryPayRate_inner() {
    this->initializeModel();
}

OAIStagedEmployee_primaryPayRate_inner::~OAIStagedEmployee_primaryPayRate_inner() {}

void OAIStagedEmployee_primaryPayRate_inner::initializeModel() {
...
void OAIStagedEmployee_primaryPayRate_inner::fromJson(QString jsonString) {
...
void OAIStagedEmployee_primaryPayRate_inner::fromJsonObject(QJsonObject json) {
...
QString OAIStagedEmployee_primaryPayRate_inner::asJson() const {
...
QJsonObject OAIStagedEmployee_primaryPayRate_inner::asJsonObject() const {
    QJsonObject obj;
...
double OAIStagedEmployee_primaryPayRate_inner::getBaseRate() const {
    return m_base_rate;
}
void OAIStagedEmployee_primaryPayRate_inner::setBaseRate(const double &base_rate) {
    m_base_rate = base_rate;
    m_base_rate_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_base_rate_Set() const{
    return m_base_rate_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_base_rate_Valid() const{
    return m_base_rate_isValid;
}

QString OAIStagedEmployee_primaryPayRate_inner::getChangeReason() const {
    return m_change_reason;
}
void OAIStagedEmployee_primaryPayRate_inner::setChangeReason(const QString &change_reason) {
    m_change_reason = change_reason;
    m_change_reason_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_change_reason_Set() const{
    return m_change_reason_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_change_reason_Valid() const{
    return m_change_reason_isValid;
}

double OAIStagedEmployee_primaryPayRate_inner::getDefaultHours() const {
    return m_default_hours;
}
void OAIStagedEmployee_primaryPayRate_inner::setDefaultHours(const double &default_hours) {
    m_default_hours = default_hours;
    m_default_hours_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_default_hours_Set() const{
    return m_default_hours_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_default_hours_Valid() const{
    return m_default_hours_isValid;
}

QString OAIStagedEmployee_primaryPayRate_inner::getEffectiveDate() const {
    return m_effective_date;
}
void OAIStagedEmployee_primaryPayRate_inner::setEffectiveDate(const QString &effective_date) {
    m_effective_date = effective_date;
    m_effective_date_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_effective_date_Set() const{
    return m_effective_date_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_effective_date_Valid() const{
    return m_effective_date_isValid;
}

bool OAIStagedEmployee_primaryPayRate_inner::isIsAutoPay() const {
    return m_is_auto_pay;
}
void OAIStagedEmployee_primaryPayRate_inner::setIsAutoPay(const bool &is_auto_pay) {
    m_is_auto_pay = is_auto_pay;
    m_is_auto_pay_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_is_auto_pay_Set() const{
    return m_is_auto_pay_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_is_auto_pay_Valid() const{
    return m_is_auto_pay_isValid;
}

QString OAIStagedEmployee_primaryPayRate_inner::getPayFrequency() const {
    return m_pay_frequency;
}
void OAIStagedEmployee_primaryPayRate_inner::setPayFrequency(const QString &pay_frequency) {
    m_pay_frequency = pay_frequency;
    m_pay_frequency_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_pay_frequency_Set() const{
    return m_pay_frequency_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_pay_frequency_Valid() const{
    return m_pay_frequency_isValid;
}

QString OAIStagedEmployee_primaryPayRate_inner::getPayGrade() const {
    return m_pay_grade;
}
void OAIStagedEmployee_primaryPayRate_inner::setPayGrade(const QString &pay_grade) {
    m_pay_grade = pay_grade;
    m_pay_grade_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_pay_grade_Set() const{
    return m_pay_grade_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_pay_grade_Valid() const{
    return m_pay_grade_isValid;
}

QString OAIStagedEmployee_primaryPayRate_inner::getPayType() const {
    return m_pay_type;
}
void OAIStagedEmployee_primaryPayRate_inner::setPayType(const QString &pay_type) {
    m_pay_type = pay_type;
    m_pay_type_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_pay_type_Set() const{
    return m_pay_type_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_pay_type_Valid() const{
    return m_pay_type_isValid;
}

QString OAIStagedEmployee_primaryPayRate_inner::getRatePer() const {
    return m_rate_per;
}
void OAIStagedEmployee_primaryPayRate_inner::setRatePer(const QString &rate_per) {
    m_rate_per = rate_per;
    m_rate_per_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_rate_per_Set() const{
    return m_rate_per_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_rate_per_Valid() const{
    return m_rate_per_isValid;
}

double OAIStagedEmployee_primaryPayRate_inner::getSalary() const {
    return m_salary;
}
void OAIStagedEmployee_primaryPayRate_inner::setSalary(const double &salary) {
    m_salary = salary;
    m_salary_isSet = true;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_salary_Set() const{
    return m_salary_isSet;
}

bool OAIStagedEmployee_primaryPayRate_inner::is_salary_Valid() const{
    return m_salary_isValid;
}

bool OAIStagedEmployee_primaryPayRate_inner::isSet() const {
...
bool OAIStagedEmployee_primaryPayRate_inner::isValid() const {
