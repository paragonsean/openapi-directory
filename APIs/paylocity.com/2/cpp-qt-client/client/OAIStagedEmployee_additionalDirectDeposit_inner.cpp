...
OAIStagedEmployee_additionalDirectDeposit_inner::OAIStagedEmployee_additionalDirectDeposit_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStagedEmployee_additionalDirectDeposit_inner::OAIStagedEmployee_additionalDirectDeposit_inner() {
    this->initializeModel();
}

OAIStagedEmployee_additionalDirectDeposit_inner::~OAIStagedEmployee_additionalDirectDeposit_inner() {}

void OAIStagedEmployee_additionalDirectDeposit_inner::initializeModel() {
...
void OAIStagedEmployee_additionalDirectDeposit_inner::fromJson(QString jsonString) {
...
void OAIStagedEmployee_additionalDirectDeposit_inner::fromJsonObject(QJsonObject json) {
...
QString OAIStagedEmployee_additionalDirectDeposit_inner::asJson() const {
...
QJsonObject OAIStagedEmployee_additionalDirectDeposit_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStagedEmployee_additionalDirectDeposit_inner::getAccountNumber() const {
    return m_account_number;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIStagedEmployee_additionalDirectDeposit_inner::getAccountType() const {
    return m_account_type;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_account_type_Valid() const{
    return m_account_type_isValid;
}

double OAIStagedEmployee_additionalDirectDeposit_inner::getAmount() const {
    return m_amount;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIStagedEmployee_additionalDirectDeposit_inner::getAmountType() const {
    return m_amount_type;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setAmountType(const QString &amount_type) {
    m_amount_type = amount_type;
    m_amount_type_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_amount_type_Set() const{
    return m_amount_type_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_amount_type_Valid() const{
    return m_amount_type_isValid;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::isIsSkipPreNote() const {
    return m_is_skip_pre_note;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setIsSkipPreNote(const bool &is_skip_pre_note) {
    m_is_skip_pre_note = is_skip_pre_note;
    m_is_skip_pre_note_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_is_skip_pre_note_Set() const{
    return m_is_skip_pre_note_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_is_skip_pre_note_Valid() const{
    return m_is_skip_pre_note_isValid;
}

QString OAIStagedEmployee_additionalDirectDeposit_inner::getPreNoteDate() const {
    return m_pre_note_date;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setPreNoteDate(const QString &pre_note_date) {
    m_pre_note_date = pre_note_date;
    m_pre_note_date_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_pre_note_date_Set() const{
    return m_pre_note_date_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_pre_note_date_Valid() const{
    return m_pre_note_date_isValid;
}

QString OAIStagedEmployee_additionalDirectDeposit_inner::getRoutingNumber() const {
    return m_routing_number;
}
void OAIStagedEmployee_additionalDirectDeposit_inner::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIStagedEmployee_additionalDirectDeposit_inner::isSet() const {
...
bool OAIStagedEmployee_additionalDirectDeposit_inner::isValid() const {
