...
public:
    ...
    */
    virtual void get_All_Custom_Fields_by_category(const QString &company_id, const QString &category);
...
private:
    ...
    void get_All_Custom_Fields_by_categoryCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_All_Custom_Fields_by_categorySignal(QList<OAICustomFieldDefinition> summary);


    void get_All_Custom_Fields_by_categorySignalFull(OAIHttpRequestWorker *worker, QList<OAICustomFieldDefinition> summary);

    Q_DECL_DEPRECATED_X("Use get_All_Custom_Fields_by_categorySignalError() instead")
    void get_All_Custom_Fields_by_categorySignalE(QList<OAICustomFieldDefinition> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_Custom_Fields_by_categorySignalError(QList<OAICustomFieldDefinition> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_All_Custom_Fields_by_categorySignalErrorFull() instead")
    void get_All_Custom_Fields_by_categorySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_Custom_Fields_by_categorySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
