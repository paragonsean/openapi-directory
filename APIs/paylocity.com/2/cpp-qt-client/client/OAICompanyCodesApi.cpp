...
OAICompanyCodesApi::OAICompanyCodesApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAICompanyCodesApi::~OAICompanyCodesApi() {
}

void OAICompanyCodesApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_All_Company_Codes_and_Descriptions_by_Resource", defaultConf);
    _serverIndices.insert("get_All_Company_Codes_and_Descriptions_by_Resource", 0);
}
...
*/
int OAICompanyCodesApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAICompanyCodesApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAICompanyCodesApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAICompanyCodesApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAICompanyCodesApi::setUsername(const QString &username) {
    _username = username;
}

void OAICompanyCodesApi::setPassword(const QString &password) {
    _password = password;
}


void OAICompanyCodesApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAICompanyCodesApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAICompanyCodesApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAICompanyCodesApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICompanyCodesApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAICompanyCodesApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAICompanyCodesApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAICompanyCodesApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAICompanyCodesApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAICompanyCodesApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAICompanyCodesApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAICompanyCodesApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAICompanyCodesApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAICompanyCodesApi::get_All_Company_Codes_and_Descriptions_by_Resource(const QString &company_id, const QString &code_resource) {
    QString fullPath = QString(_serverConfigs["get_All_Company_Codes_and_Descriptions_by_Resource"][_serverIndices.value("get_All_Company_Codes_and_Descriptions_by_Resource")].URL()+"/v2/companies/{companyId}/codes/{codeResource}");
    ...
    {
        QString code_resourcePathParam("{");
        code_resourcePathParam.append("codeResource").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "codeResource", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"codeResource"+pathSuffix : pathPrefix;
        fullPath.replace(code_resourcePathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(code_resource)));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICompanyCodesApi::get_All_Company_Codes_and_Descriptions_by_ResourceCallback);
    connect(this, &OAICompanyCodesApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICompanyCodesApi::get_All_Company_Codes_and_Descriptions_by_ResourceCallback);
    connect(this, &OAICompanyCodesApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAICompanyCodesApi::get_All_Company_Codes_and_Descriptions_by_ResourceCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_All_Company_Codes_and_Descriptions_by_ResourceSignal(output);
        Q_EMIT get_All_Company_Codes_and_Descriptions_by_ResourceSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_All_Company_Codes_and_Descriptions_by_ResourceSignalE(output, error_type, error_str);
        Q_EMIT get_All_Company_Codes_and_Descriptions_by_ResourceSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_All_Company_Codes_and_Descriptions_by_ResourceSignalError(output, error_type, error_str);
        Q_EMIT get_All_Company_Codes_and_Descriptions_by_ResourceSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICompanyCodesApi::tokenAvailable(){
