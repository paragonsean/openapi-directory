...
#ifndef OAIDirectDeposit_H
#define OAIDirectDeposit_H
...
class OAIDirectDeposit_mainDirectDeposit;

class OAIDirectDeposit : public OAIObject {
public:
    OAIDirectDeposit();
    OAIDirectDeposit(QString json);
    ~OAIDirectDeposit() override;
    ...
    OAIDirectDeposit_mainDirectDeposit getMainDirectDeposit() const;
    void setMainDirectDeposit(const OAIDirectDeposit_mainDirectDeposit &main_direct_deposit);
...
private:
    ...
    OAIDirectDeposit_mainDirectDeposit m_main_direct_deposit;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirectDeposit)

#endif // OAIDirectDeposit_H
