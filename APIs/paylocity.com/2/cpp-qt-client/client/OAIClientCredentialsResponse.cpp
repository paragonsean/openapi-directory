...
#include "OAIClientCredentialsResponse.h"
...
OAIClientCredentialsResponse::OAIClientCredentialsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClientCredentialsResponse::OAIClientCredentialsResponse() {
    this->initializeModel();
}

OAIClientCredentialsResponse::~OAIClientCredentialsResponse() {}

void OAIClientCredentialsResponse::initializeModel() {

    m_client_secret_isSet = false;
    m_client_secret_isValid = false;

    m_client_secret_expiration_date_isSet = false;
    m_client_secret_expiration_date_isValid = false;
}

void OAIClientCredentialsResponse::fromJson(QString jsonString) {
...
void OAIClientCredentialsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_client_secret_expiration_date_isValid = ::OpenAPI::fromJsonValue(m_client_secret_expiration_date, json[QString("clientSecretExpirationDate")]);
    m_client_secret_expiration_date_isSet = !json[QString("clientSecretExpirationDate")].isNull() && m_client_secret_expiration_date_isValid;
}

QString OAIClientCredentialsResponse::asJson() const {
...
QJsonObject OAIClientCredentialsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_client_secret_isSet) {
        obj.insert(QString("clientSecret"), ::OpenAPI::toJsonValue(m_client_secret));
    }
    if (m_client_secret_expiration_date_isSet) {
        obj.insert(QString("clientSecretExpirationDate"), ::OpenAPI::toJsonValue(m_client_secret_expiration_date));
    }
    return obj;
}

QString OAIClientCredentialsResponse::getClientSecret() const {
    return m_client_secret;
}
void OAIClientCredentialsResponse::setClientSecret(const QString &client_secret) {
    m_client_secret = client_secret;
    m_client_secret_isSet = true;
}

bool OAIClientCredentialsResponse::is_client_secret_Set() const{
    return m_client_secret_isSet;
}

bool OAIClientCredentialsResponse::is_client_secret_Valid() const{
    return m_client_secret_isValid;
}

QString OAIClientCredentialsResponse::getClientSecretExpirationDate() const {
    return m_client_secret_expiration_date;
}
void OAIClientCredentialsResponse::setClientSecretExpirationDate(const QString &client_secret_expiration_date) {
    m_client_secret_expiration_date = client_secret_expiration_date;
    m_client_secret_expiration_date_isSet = true;
}

bool OAIClientCredentialsResponse::is_client_secret_expiration_date_Set() const{
    return m_client_secret_expiration_date_isSet;
}

bool OAIClientCredentialsResponse::is_client_secret_expiration_date_Valid() const{
    return m_client_secret_expiration_date_isValid;
}

bool OAIClientCredentialsResponse::isSet() const {
...
bool OAIClientCredentialsResponse::isValid() const {
