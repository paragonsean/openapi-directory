...
/*
 * OAIEmployeeIdResponse.h
 *
 * The EmployeeId Response Model
 */

#ifndef OAIEmployeeIdResponse_H
#define OAIEmployeeIdResponse_H
...
class OAIEmployeeIdResponse : public OAIObject {
public:
    OAIEmployeeIdResponse();
    OAIEmployeeIdResponse(QString json);
    ~OAIEmployeeIdResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployeeIdResponse)

#endif // OAIEmployeeIdResponse_H
