...
QList<OAIError_options_inner> OAIError::getOptions() const {
    return m_options;
}
void OAIError::setOptions(const QList<OAIError_options_inner> &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIError::is_options_Set() const{
    return m_options_isSet;
}

bool OAIError::is_options_Valid() const{
