...
/*
 * OAIEmployee_additionalRate_inner.h
 *
 * The additional pay rate model
 */

#ifndef OAIEmployee_additionalRate_inner_H
#define OAIEmployee_additionalRate_inner_H
...
class OAIEmployee_additionalRate_inner : public OAIObject {
public:
    OAIEmployee_additionalRate_inner();
    OAIEmployee_additionalRate_inner(QString json);
    ~OAIEmployee_additionalRate_inner() override;
    ...
    QString getEndCheckDate() const;
    void setEndCheckDate(const QString &end_check_date);
    bool is_end_check_date_Set() const;
    bool is_end_check_date_Valid() const;
    ...
    QString getRateNotes() const;
    void setRateNotes(const QString &rate_notes);
    bool is_rate_notes_Set() const;
    bool is_rate_notes_Valid() const;
...
private:
    ...
    QString m_end_check_date;
    bool m_end_check_date_isSet;
    bool m_end_check_date_isValid;
    ...
    QString m_rate_notes;
    bool m_rate_notes_isSet;
    bool m_rate_notes_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_additionalRate_inner)

#endif // OAIEmployee_additionalRate_inner_H
