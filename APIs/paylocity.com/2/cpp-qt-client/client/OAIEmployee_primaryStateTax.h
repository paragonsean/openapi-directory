...
#ifndef OAIEmployee_primaryStateTax_H
#define OAIEmployee_primaryStateTax_H
...
class OAIEmployee_primaryStateTax : public OAIObject {
public:
    OAIEmployee_primaryStateTax();
    OAIEmployee_primaryStateTax(QString json);
    ~OAIEmployee_primaryStateTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_primaryStateTax)

#endif // OAIEmployee_primaryStateTax_H
