...
/*
 * OAIDirectDeposit_additionalDirectDeposit_inner.h
 *
 * The additional direct deposit model
 */

#ifndef OAIDirectDeposit_additionalDirectDeposit_inner_H
#define OAIDirectDeposit_additionalDirectDeposit_inner_H
...
class OAIDirectDeposit_additionalDirectDeposit_inner : public OAIObject {
public:
    OAIDirectDeposit_additionalDirectDeposit_inner();
    OAIDirectDeposit_additionalDirectDeposit_inner(QString json);
    ~OAIDirectDeposit_additionalDirectDeposit_inner() override;
    ...
    void setBlockSpecial(const bool &block_special);
    bool is_block_special_Set() const;
    bool is_block_special_Valid() const;

    bool isIsSkipPreNote() const;
    void setIsSkipPreNote(const bool &is_skip_pre_note);
    bool is_is_skip_pre_note_Set() const;
    bool is_is_skip_pre_note_Valid() const;
    ...
    QString getPreNoteDate() const;
    void setPreNoteDate(const QString &pre_note_date);
    bool is_pre_note_date_Set() const;
    bool is_pre_note_date_Valid() const;
...
private:
    ...
    bool m_block_special;
    bool m_block_special_isSet;
    bool m_block_special_isValid;

    bool m_is_skip_pre_note;
    bool m_is_skip_pre_note_isSet;
    bool m_is_skip_pre_note_isValid;

    QString m_name_on_account;
    bool m_name_on_account_isSet;
    bool m_name_on_account_isValid;

    QString m_pre_note_date;
    bool m_pre_note_date_isSet;
    bool m_pre_note_date_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDirectDeposit_additionalDirectDeposit_inner)

#endif // OAIDirectDeposit_additionalDirectDeposit_inner_H
