...
#ifndef OAI_OAIEmergencyContactsApi_H
#define OAI_OAIEmergencyContactsApi_H
...
class OAIEmergencyContactsApi : public QObject {
    Q_OBJECT

public:
    OAIEmergencyContactsApi(const int timeOut = 0);
    ~OAIEmergencyContactsApi();
    ...
    * @param[in]  oai_emergency_contact OAIEmergencyContact [required]
    */
    virtual void add_or_update_emergency_contacts(const QString &company_id, const QString &employee_id, const OAIEmergencyContact &oai_emergency_contact);
...
private:
    ...
    void add_or_update_emergency_contactsCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_or_update_emergency_contactsSignal();


    void add_or_update_emergency_contactsSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use add_or_update_emergency_contactsSignalError() instead")
    void add_or_update_emergency_contactsSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_emergency_contactsSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_or_update_emergency_contactsSignalErrorFull() instead")
    void add_or_update_emergency_contactsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_emergency_contactsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
