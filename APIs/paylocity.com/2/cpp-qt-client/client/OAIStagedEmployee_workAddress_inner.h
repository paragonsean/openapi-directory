...
/*
 * OAIStagedEmployee_workAddress_inner.h
 *
 * The address model
 */

#ifndef OAIStagedEmployee_workAddress_inner_H
#define OAIStagedEmployee_workAddress_inner_H
...
class OAIStagedEmployee_workAddress_inner : public OAIObject {
public:
    OAIStagedEmployee_workAddress_inner();
    OAIStagedEmployee_workAddress_inner(QString json);
    ~OAIStagedEmployee_workAddress_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_workAddress_inner)

#endif // OAIStagedEmployee_workAddress_inner_H
