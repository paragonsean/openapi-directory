...
OAIEmployee_nonPrimaryStateTax::OAIEmployee_nonPrimaryStateTax(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_nonPrimaryStateTax::OAIEmployee_nonPrimaryStateTax() {
    this->initializeModel();
}

OAIEmployee_nonPrimaryStateTax::~OAIEmployee_nonPrimaryStateTax() {}

void OAIEmployee_nonPrimaryStateTax::initializeModel() {
...
void OAIEmployee_nonPrimaryStateTax::fromJson(QString jsonString) {
...
void OAIEmployee_nonPrimaryStateTax::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_nonPrimaryStateTax::asJson() const {
...
QJsonObject OAIEmployee_nonPrimaryStateTax::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAIEmployee_nonPrimaryStateTax::getAmount() const {
    return m_amount;
}
void OAIEmployee_nonPrimaryStateTax::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIEmployee_nonPrimaryStateTax::getDeductionsAmount() const {
    return m_deductions_amount;
}
void OAIEmployee_nonPrimaryStateTax::setDeductionsAmount(const double &deductions_amount) {
    m_deductions_amount = deductions_amount;
    m_deductions_amount_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_deductions_amount_Set() const{
    return m_deductions_amount_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_deductions_amount_Valid() const{
    return m_deductions_amount_isValid;
}

double OAIEmployee_nonPrimaryStateTax::getDependentsAmount() const {
    return m_dependents_amount;
}
void OAIEmployee_nonPrimaryStateTax::setDependentsAmount(const double &dependents_amount) {
    m_dependents_amount = dependents_amount;
    m_dependents_amount_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_dependents_amount_Set() const{
    return m_dependents_amount_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_dependents_amount_Valid() const{
    return m_dependents_amount_isValid;
}

double OAIEmployee_nonPrimaryStateTax::getExemptions() const {
    return m_exemptions;
}
void OAIEmployee_nonPrimaryStateTax::setExemptions(const double &exemptions) {
    m_exemptions = exemptions;
    m_exemptions_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_exemptions_Set() const{
    return m_exemptions_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_exemptions_Valid() const{
    return m_exemptions_isValid;
}

double OAIEmployee_nonPrimaryStateTax::getExemptions2() const {
    return m_exemptions2;
}
void OAIEmployee_nonPrimaryStateTax::setExemptions2(const double &exemptions2) {
    m_exemptions2 = exemptions2;
    m_exemptions2_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_exemptions2_Set() const{
    return m_exemptions2_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_exemptions2_Valid() const{
    return m_exemptions2_isValid;
}

QString OAIEmployee_nonPrimaryStateTax::getFilingStatus() const {
    return m_filing_status;
}
void OAIEmployee_nonPrimaryStateTax::setFilingStatus(const QString &filing_status) {
    m_filing_status = filing_status;
    m_filing_status_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_filing_status_Set() const{
    return m_filing_status_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_filing_status_Valid() const{
    return m_filing_status_isValid;
}

bool OAIEmployee_nonPrimaryStateTax::isHigherRate() const {
    return m_higher_rate;
}
void OAIEmployee_nonPrimaryStateTax::setHigherRate(const bool &higher_rate) {
    m_higher_rate = higher_rate;
    m_higher_rate_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_higher_rate_Set() const{
    return m_higher_rate_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_higher_rate_Valid() const{
    return m_higher_rate_isValid;
}

double OAIEmployee_nonPrimaryStateTax::getOtherIncomeAmount() const {
    return m_other_income_amount;
}
void OAIEmployee_nonPrimaryStateTax::setOtherIncomeAmount(const double &other_income_amount) {
    m_other_income_amount = other_income_amount;
    m_other_income_amount_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_other_income_amount_Set() const{
    return m_other_income_amount_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_other_income_amount_Valid() const{
    return m_other_income_amount_isValid;
}

double OAIEmployee_nonPrimaryStateTax::getPercentage() const {
    return m_percentage;
}
void OAIEmployee_nonPrimaryStateTax::setPercentage(const double &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_percentage_Valid() const{
    return m_percentage_isValid;
}

QString OAIEmployee_nonPrimaryStateTax::getReciprocityCode() const {
    return m_reciprocity_code;
}
void OAIEmployee_nonPrimaryStateTax::setReciprocityCode(const QString &reciprocity_code) {
    m_reciprocity_code = reciprocity_code;
    m_reciprocity_code_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_reciprocity_code_Set() const{
    return m_reciprocity_code_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_reciprocity_code_Valid() const{
    return m_reciprocity_code_isValid;
}

QString OAIEmployee_nonPrimaryStateTax::getSpecialCheckCalc() const {
    return m_special_check_calc;
}
void OAIEmployee_nonPrimaryStateTax::setSpecialCheckCalc(const QString &special_check_calc) {
    m_special_check_calc = special_check_calc;
    m_special_check_calc_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_special_check_calc_Set() const{
    return m_special_check_calc_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_special_check_calc_Valid() const{
    return m_special_check_calc_isValid;
}

QString OAIEmployee_nonPrimaryStateTax::getTaxCalculationCode() const {
    return m_tax_calculation_code;
}
void OAIEmployee_nonPrimaryStateTax::setTaxCalculationCode(const QString &tax_calculation_code) {
    m_tax_calculation_code = tax_calculation_code;
    m_tax_calculation_code_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_tax_calculation_code_Set() const{
    return m_tax_calculation_code_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_tax_calculation_code_Valid() const{
    return m_tax_calculation_code_isValid;
}

QString OAIEmployee_nonPrimaryStateTax::getTaxCode() const {
    return m_tax_code;
}
void OAIEmployee_nonPrimaryStateTax::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

qint32 OAIEmployee_nonPrimaryStateTax::getW4FormYear() const {
    return m_w4_form_year;
}
void OAIEmployee_nonPrimaryStateTax::setW4FormYear(const qint32 &w4_form_year) {
    m_w4_form_year = w4_form_year;
    m_w4_form_year_isSet = true;
}

bool OAIEmployee_nonPrimaryStateTax::is_w4_form_year_Set() const{
    return m_w4_form_year_isSet;
}

bool OAIEmployee_nonPrimaryStateTax::is_w4_form_year_Valid() const{
    return m_w4_form_year_isValid;
}

bool OAIEmployee_nonPrimaryStateTax::isSet() const {
...
bool OAIEmployee_nonPrimaryStateTax::isValid() const {
