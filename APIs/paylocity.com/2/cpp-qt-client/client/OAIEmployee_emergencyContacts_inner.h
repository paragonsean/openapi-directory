...
/*
 * OAIEmployee_emergencyContacts_inner.h
 *
 * The emergency contact model
 */

#ifndef OAIEmployee_emergencyContacts_inner_H
#define OAIEmployee_emergencyContacts_inner_H
...
class OAIEmployee_emergencyContacts_inner : public OAIObject {
public:
    OAIEmployee_emergencyContacts_inner();
    OAIEmployee_emergencyContacts_inner(QString json);
    ~OAIEmployee_emergencyContacts_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_emergencyContacts_inner)

#endif // OAIEmployee_emergencyContacts_inner_H
