...
OAIEmployee_federalTax::OAIEmployee_federalTax(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_federalTax::OAIEmployee_federalTax() {
    this->initializeModel();
}

OAIEmployee_federalTax::~OAIEmployee_federalTax() {}

void OAIEmployee_federalTax::initializeModel() {
...
void OAIEmployee_federalTax::fromJson(QString jsonString) {
...
void OAIEmployee_federalTax::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_federalTax::asJson() const {
...
QJsonObject OAIEmployee_federalTax::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAIEmployee_federalTax::getAmount() const {
    return m_amount;
}
void OAIEmployee_federalTax::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIEmployee_federalTax::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIEmployee_federalTax::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIEmployee_federalTax::getDeductionsAmount() const {
    return m_deductions_amount;
}
void OAIEmployee_federalTax::setDeductionsAmount(const double &deductions_amount) {
    m_deductions_amount = deductions_amount;
    m_deductions_amount_isSet = true;
}

bool OAIEmployee_federalTax::is_deductions_amount_Set() const{
    return m_deductions_amount_isSet;
}

bool OAIEmployee_federalTax::is_deductions_amount_Valid() const{
    return m_deductions_amount_isValid;
}

double OAIEmployee_federalTax::getDependentsAmount() const {
    return m_dependents_amount;
}
void OAIEmployee_federalTax::setDependentsAmount(const double &dependents_amount) {
    m_dependents_amount = dependents_amount;
    m_dependents_amount_isSet = true;
}

bool OAIEmployee_federalTax::is_dependents_amount_Set() const{
    return m_dependents_amount_isSet;
}

bool OAIEmployee_federalTax::is_dependents_amount_Valid() const{
    return m_dependents_amount_isValid;
}

double OAIEmployee_federalTax::getExemptions() const {
    return m_exemptions;
}
void OAIEmployee_federalTax::setExemptions(const double &exemptions) {
    m_exemptions = exemptions;
    m_exemptions_isSet = true;
}

bool OAIEmployee_federalTax::is_exemptions_Set() const{
    return m_exemptions_isSet;
}

bool OAIEmployee_federalTax::is_exemptions_Valid() const{
    return m_exemptions_isValid;
}

QString OAIEmployee_federalTax::getFilingStatus() const {
    return m_filing_status;
}
void OAIEmployee_federalTax::setFilingStatus(const QString &filing_status) {
    m_filing_status = filing_status;
    m_filing_status_isSet = true;
}

bool OAIEmployee_federalTax::is_filing_status_Set() const{
    return m_filing_status_isSet;
}

bool OAIEmployee_federalTax::is_filing_status_Valid() const{
    return m_filing_status_isValid;
}

bool OAIEmployee_federalTax::isHigherRate() const {
    return m_higher_rate;
}
void OAIEmployee_federalTax::setHigherRate(const bool &higher_rate) {
    m_higher_rate = higher_rate;
    m_higher_rate_isSet = true;
}

bool OAIEmployee_federalTax::is_higher_rate_Set() const{
    return m_higher_rate_isSet;
}

bool OAIEmployee_federalTax::is_higher_rate_Valid() const{
    return m_higher_rate_isValid;
}

double OAIEmployee_federalTax::getOtherIncomeAmount() const {
    return m_other_income_amount;
}
void OAIEmployee_federalTax::setOtherIncomeAmount(const double &other_income_amount) {
    m_other_income_amount = other_income_amount;
    m_other_income_amount_isSet = true;
}

bool OAIEmployee_federalTax::is_other_income_amount_Set() const{
    return m_other_income_amount_isSet;
}

bool OAIEmployee_federalTax::is_other_income_amount_Valid() const{
    return m_other_income_amount_isValid;
}

double OAIEmployee_federalTax::getPercentage() const {
    return m_percentage;
}
void OAIEmployee_federalTax::setPercentage(const double &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAIEmployee_federalTax::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAIEmployee_federalTax::is_percentage_Valid() const{
    return m_percentage_isValid;
}

QString OAIEmployee_federalTax::getTaxCalculationCode() const {
    return m_tax_calculation_code;
}
void OAIEmployee_federalTax::setTaxCalculationCode(const QString &tax_calculation_code) {
    m_tax_calculation_code = tax_calculation_code;
    m_tax_calculation_code_isSet = true;
}

bool OAIEmployee_federalTax::is_tax_calculation_code_Set() const{
    return m_tax_calculation_code_isSet;
}

bool OAIEmployee_federalTax::is_tax_calculation_code_Valid() const{
    return m_tax_calculation_code_isValid;
}

qint32 OAIEmployee_federalTax::getW4FormYear() const {
    return m_w4_form_year;
}
void OAIEmployee_federalTax::setW4FormYear(const qint32 &w4_form_year) {
    m_w4_form_year = w4_form_year;
    m_w4_form_year_isSet = true;
}

bool OAIEmployee_federalTax::is_w4_form_year_Set() const{
    return m_w4_form_year_isSet;
}

bool OAIEmployee_federalTax::is_w4_form_year_Valid() const{
    return m_w4_form_year_isValid;
}

bool OAIEmployee_federalTax::isSet() const {
...
bool OAIEmployee_federalTax::isValid() const {
