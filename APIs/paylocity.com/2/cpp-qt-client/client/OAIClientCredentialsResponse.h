...
/*
 * OAIClientCredentialsResponse.h
 *
 * The Client Credentials Response Model
 */

#ifndef OAIClientCredentialsResponse_H
#define OAIClientCredentialsResponse_H
...
class OAIClientCredentialsResponse : public OAIObject {
public:
    OAIClientCredentialsResponse();
    OAIClientCredentialsResponse(QString json);
    ~OAIClientCredentialsResponse() override;
    ...
    QString getClientSecretExpirationDate() const;
    void setClientSecretExpirationDate(const QString &client_secret_expiration_date);
    bool is_client_secret_expiration_date_Set() const;
    bool is_client_secret_expiration_date_Valid() const;
...
private:
    ...
    QString m_client_secret_expiration_date;
    bool m_client_secret_expiration_date_isSet;
    bool m_client_secret_expiration_date_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIClientCredentialsResponse)

#endif // OAIClientCredentialsResponse_H
