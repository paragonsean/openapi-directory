...
OAITrackingNumberResponse::OAITrackingNumberResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrackingNumberResponse::OAITrackingNumberResponse() {
    this->initializeModel();
}

OAITrackingNumberResponse::~OAITrackingNumberResponse() {}

void OAITrackingNumberResponse::initializeModel() {

    m_tracking_number_isSet = false;
    m_tracking_number_isValid = false;
}

void OAITrackingNumberResponse::fromJson(QString jsonString) {
...
void OAITrackingNumberResponse::fromJsonObject(QJsonObject json) {
...
QString OAITrackingNumberResponse::asJson() const {
...
QJsonObject OAITrackingNumberResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAITrackingNumberResponse::getTrackingNumber() const {
    return m_tracking_number;
}
void OAITrackingNumberResponse::setTrackingNumber(const QString &tracking_number) {
    m_tracking_number = tracking_number;
    m_tracking_number_isSet = true;
}

bool OAITrackingNumberResponse::is_tracking_number_Set() const{
    return m_tracking_number_isSet;
}

bool OAITrackingNumberResponse::is_tracking_number_Valid() const{
    return m_tracking_number_isValid;
}

bool OAITrackingNumberResponse::isSet() const {
...
bool OAITrackingNumberResponse::isValid() const {
