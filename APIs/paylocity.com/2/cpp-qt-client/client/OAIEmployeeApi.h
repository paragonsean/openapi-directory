...
public:
    ...
    */
    virtual void add_employee(const QString &company_id, const OAIEmployee &oai_employee);
    ...
    */
    virtual void get_all_employees(const QString &company_id, const ::OpenAPI::OptionalParam<qint32> &pagesize = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &pagenumber = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<bool> &includetotalcount = ::OpenAPI::OptionalParam<bool>());

    /**
    * @param[in]  company_id QString [required]
    * @param[in]  employee_id QString [required]
    */
    virtual void get_employee(const QString &company_id, const QString &employee_id);
    ...
    * @param[in]  oai_employee OAIEmployee [required]
    */
    virtual void update_employee(const QString &company_id, const QString &employee_id, const OAIEmployee &oai_employee);
...
private:
    ...
    void add_employeeCallback(OAIHttpRequestWorker *worker);
    void get_all_employeesCallback(OAIHttpRequestWorker *worker);
    void get_employeeCallback(OAIHttpRequestWorker *worker);
    void update_employeeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_employeeSignal(OAIEmployeeIdResponse summary);
    void get_all_employeesSignal(QList<OAIEmployeeInfo> summary);
    void get_employeeSignal(OAIEmployee summary);
    void update_employeeSignal();


    void add_employeeSignalFull(OAIHttpRequestWorker *worker, OAIEmployeeIdResponse summary);
    void get_all_employeesSignalFull(OAIHttpRequestWorker *worker, QList<OAIEmployeeInfo> summary);
    void get_employeeSignalFull(OAIHttpRequestWorker *worker, OAIEmployee summary);
    void update_employeeSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use add_employeeSignalError() instead")
    void add_employeeSignalE(OAIEmployeeIdResponse summary, QNetworkReply::NetworkError error_type, QString error_str);
    void add_employeeSignalError(OAIEmployeeIdResponse summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_employeesSignalError() instead")
    void get_all_employeesSignalE(QList<OAIEmployeeInfo> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_employeesSignalError(QList<OAIEmployeeInfo> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_employeeSignalError() instead")
    void get_employeeSignalE(OAIEmployee summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_employeeSignalError(OAIEmployee summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use update_employeeSignalError() instead")
    void update_employeeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void update_employeeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_employeeSignalErrorFull() instead")
    void add_employeeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_employeeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_employeesSignalErrorFull() instead")
    void get_all_employeesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_employeesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_employeeSignalErrorFull() instead")
    void get_employeeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_employeeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use update_employeeSignalErrorFull() instead")
    void update_employeeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void update_employeeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
