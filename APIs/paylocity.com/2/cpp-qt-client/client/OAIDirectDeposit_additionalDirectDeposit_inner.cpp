...
OAIDirectDeposit_additionalDirectDeposit_inner::OAIDirectDeposit_additionalDirectDeposit_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirectDeposit_additionalDirectDeposit_inner::OAIDirectDeposit_additionalDirectDeposit_inner() {
    this->initializeModel();
}

OAIDirectDeposit_additionalDirectDeposit_inner::~OAIDirectDeposit_additionalDirectDeposit_inner() {}

void OAIDirectDeposit_additionalDirectDeposit_inner::initializeModel() {
    ...
    m_block_special_isSet = false;
    m_block_special_isValid = false;

    m_is_skip_pre_note_isSet = false;
    m_is_skip_pre_note_isValid = false;

    m_name_on_account_isSet = false;
    m_name_on_account_isValid = false;

    m_pre_note_date_isSet = false;
    m_pre_note_date_isValid = false;

    m_routing_number_isSet = false;
    m_routing_number_isValid = false;
}

void OAIDirectDeposit_additionalDirectDeposit_inner::fromJson(QString jsonString) {
...
void OAIDirectDeposit_additionalDirectDeposit_inner::fromJsonObject(QJsonObject json) {
    ...
    m_block_special_isValid = ::OpenAPI::fromJsonValue(m_block_special, json[QString("blockSpecial")]);
    m_block_special_isSet = !json[QString("blockSpecial")].isNull() && m_block_special_isValid;

    m_is_skip_pre_note_isValid = ::OpenAPI::fromJsonValue(m_is_skip_pre_note, json[QString("isSkipPreNote")]);
    m_is_skip_pre_note_isSet = !json[QString("isSkipPreNote")].isNull() && m_is_skip_pre_note_isValid;

    m_name_on_account_isValid = ::OpenAPI::fromJsonValue(m_name_on_account, json[QString("nameOnAccount")]);
    m_name_on_account_isSet = !json[QString("nameOnAccount")].isNull() && m_name_on_account_isValid;

    m_pre_note_date_isValid = ::OpenAPI::fromJsonValue(m_pre_note_date, json[QString("preNoteDate")]);
    m_pre_note_date_isSet = !json[QString("preNoteDate")].isNull() && m_pre_note_date_isValid;
...
QString OAIDirectDeposit_additionalDirectDeposit_inner::asJson() const {
...
QJsonObject OAIDirectDeposit_additionalDirectDeposit_inner::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_block_special_isSet) {
        obj.insert(QString("blockSpecial"), ::OpenAPI::toJsonValue(m_block_special));
    }
    if (m_is_skip_pre_note_isSet) {
        obj.insert(QString("isSkipPreNote"), ::OpenAPI::toJsonValue(m_is_skip_pre_note));
    }
    if (m_name_on_account_isSet) {
        obj.insert(QString("nameOnAccount"), ::OpenAPI::toJsonValue(m_name_on_account));
    }
    if (m_pre_note_date_isSet) {
        obj.insert(QString("preNoteDate"), ::OpenAPI::toJsonValue(m_pre_note_date));
    }
...
QString OAIDirectDeposit_additionalDirectDeposit_inner::getAccountNumber() const {
    return m_account_number;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIDirectDeposit_additionalDirectDeposit_inner::getAccountType() const {
    return m_account_type;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_account_type_Valid() const{
    return m_account_type_isValid;
}

double OAIDirectDeposit_additionalDirectDeposit_inner::getAmount() const {
    return m_amount;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_amount_Valid() const{
    return m_amount_isValid;
}

QString OAIDirectDeposit_additionalDirectDeposit_inner::getAmountType() const {
    return m_amount_type;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setAmountType(const QString &amount_type) {
    m_amount_type = amount_type;
    m_amount_type_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_amount_type_Set() const{
    return m_amount_type_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_amount_type_Valid() const{
    return m_amount_type_isValid;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::isBlockSpecial() const {
    return m_block_special;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setBlockSpecial(const bool &block_special) {
    m_block_special = block_special;
    m_block_special_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_block_special_Set() const{
    return m_block_special_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_block_special_Valid() const{
    return m_block_special_isValid;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::isIsSkipPreNote() const {
    return m_is_skip_pre_note;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setIsSkipPreNote(const bool &is_skip_pre_note) {
    m_is_skip_pre_note = is_skip_pre_note;
    m_is_skip_pre_note_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_is_skip_pre_note_Set() const{
    return m_is_skip_pre_note_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_is_skip_pre_note_Valid() const{
    return m_is_skip_pre_note_isValid;
}

QString OAIDirectDeposit_additionalDirectDeposit_inner::getNameOnAccount() const {
    return m_name_on_account;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setNameOnAccount(const QString &name_on_account) {
    m_name_on_account = name_on_account;
    m_name_on_account_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_name_on_account_Set() const{
    return m_name_on_account_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_name_on_account_Valid() const{
    return m_name_on_account_isValid;
}

QString OAIDirectDeposit_additionalDirectDeposit_inner::getPreNoteDate() const {
    return m_pre_note_date;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setPreNoteDate(const QString &pre_note_date) {
    m_pre_note_date = pre_note_date;
    m_pre_note_date_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_pre_note_date_Set() const{
    return m_pre_note_date_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_pre_note_date_Valid() const{
    return m_pre_note_date_isValid;
}

QString OAIDirectDeposit_additionalDirectDeposit_inner::getRoutingNumber() const {
    return m_routing_number;
}
void OAIDirectDeposit_additionalDirectDeposit_inner::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIDirectDeposit_additionalDirectDeposit_inner::isSet() const {
...
bool OAIDirectDeposit_additionalDirectDeposit_inner::isValid() const {
