...
OAIEmployee_customNumberFields_inner::OAIEmployee_customNumberFields_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_customNumberFields_inner::OAIEmployee_customNumberFields_inner() {
    this->initializeModel();
}

OAIEmployee_customNumberFields_inner::~OAIEmployee_customNumberFields_inner() {}

void OAIEmployee_customNumberFields_inner::initializeModel() {
...
void OAIEmployee_customNumberFields_inner::fromJson(QString jsonString) {
...
void OAIEmployee_customNumberFields_inner::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_customNumberFields_inner::asJson() const {
...
QJsonObject OAIEmployee_customNumberFields_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_category_isSet) {
...
QString OAIEmployee_customNumberFields_inner::getCategory() const {
    return m_category;
}
void OAIEmployee_customNumberFields_inner::setCategory(const QString &category) {
    m_category = category;
    m_category_isSet = true;
}

bool OAIEmployee_customNumberFields_inner::is_category_Set() const{
    return m_category_isSet;
}

bool OAIEmployee_customNumberFields_inner::is_category_Valid() const{
    return m_category_isValid;
}

QString OAIEmployee_customNumberFields_inner::getLabel() const {
    return m_label;
}
void OAIEmployee_customNumberFields_inner::setLabel(const QString &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAIEmployee_customNumberFields_inner::is_label_Set() const{
    return m_label_isSet;
}

bool OAIEmployee_customNumberFields_inner::is_label_Valid() const{
    return m_label_isValid;
}

double OAIEmployee_customNumberFields_inner::getValue() const {
    return m_value;
}
void OAIEmployee_customNumberFields_inner::setValue(const double &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIEmployee_customNumberFields_inner::is_value_Set() const{
    return m_value_isSet;
}

bool OAIEmployee_customNumberFields_inner::is_value_Valid() const{
    return m_value_isValid;
}

bool OAIEmployee_customNumberFields_inner::isSet() const {
...
bool OAIEmployee_customNumberFields_inner::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_category_isValid && m_label_isValid && m_value_isValid && true;
}
