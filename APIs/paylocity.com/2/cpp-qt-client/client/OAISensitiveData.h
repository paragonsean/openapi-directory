...
#ifndef OAISensitiveData_H
#define OAISensitiveData_H

#include <QJsonObject>

#include "OAISensitiveData_disability.h"
#include "OAISensitiveData_ethnicity.h"
#include "OAISensitiveData_gender.h"
#include "OAISensitiveData_veteran.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAISensitiveData_disability;
class OAISensitiveData_ethnicity;
class OAISensitiveData_gender;
class OAISensitiveData_veteran;

class OAISensitiveData : public OAIObject {
public:
    OAISensitiveData();
    OAISensitiveData(QString json);
    ~OAISensitiveData() override;
    ...
    OAISensitiveData_disability getDisability() const;
    void setDisability(const OAISensitiveData_disability &disability);
    bool is_disability_Set() const;
    bool is_disability_Valid() const;

    OAISensitiveData_ethnicity getEthnicity() const;
    void setEthnicity(const OAISensitiveData_ethnicity &ethnicity);
    bool is_ethnicity_Set() const;
    bool is_ethnicity_Valid() const;

    OAISensitiveData_gender getGender() const;
    void setGender(const OAISensitiveData_gender &gender);
    bool is_gender_Set() const;
    bool is_gender_Valid() const;

    OAISensitiveData_veteran getVeteran() const;
    void setVeteran(const OAISensitiveData_veteran &veteran);
...
private:
    ...
    OAISensitiveData_disability m_disability;
    bool m_disability_isSet;
    bool m_disability_isValid;

    OAISensitiveData_ethnicity m_ethnicity;
    bool m_ethnicity_isSet;
    bool m_ethnicity_isValid;

    OAISensitiveData_gender m_gender;
    bool m_gender_isSet;
    bool m_gender_isValid;

    OAISensitiveData_veteran m_veteran;
...
Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData)

#endif // OAISensitiveData_H
