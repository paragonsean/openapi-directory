...
/*
 * OAIStagedEmployee_primaryStateTax_inner.h
 *
 * The State Tax model
 */

#ifndef OAIStagedEmployee_primaryStateTax_inner_H
#define OAIStagedEmployee_primaryStateTax_inner_H
...
class OAIStagedEmployee_primaryStateTax_inner : public OAIObject {
public:
    OAIStagedEmployee_primaryStateTax_inner();
    OAIStagedEmployee_primaryStateTax_inner(QString json);
    ~OAIStagedEmployee_primaryStateTax_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_primaryStateTax_inner)

#endif // OAIStagedEmployee_primaryStateTax_inner_H
