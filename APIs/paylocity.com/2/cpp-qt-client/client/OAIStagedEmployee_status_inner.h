...
/*
 * OAIStagedEmployee_status_inner.h
 *
 * The employee status model
 */

#ifndef OAIStagedEmployee_status_inner_H
#define OAIStagedEmployee_status_inner_H
...
class OAIStagedEmployee_status_inner : public OAIObject {
public:
    OAIStagedEmployee_status_inner();
    OAIStagedEmployee_status_inner(QString json);
    ~OAIStagedEmployee_status_inner() override;
    ...
    QString getAdjustedSeniorityDate() const;
    void setAdjustedSeniorityDate(const QString &adjusted_seniority_date);
    bool is_adjusted_seniority_date_Set() const;
    bool is_adjusted_seniority_date_Valid() const;
    ...
    QString getEmployeeStatus() const;
    void setEmployeeStatus(const QString &employee_status);
    bool is_employee_status_Set() const;
    bool is_employee_status_Valid() const;
    ...
    bool isIsEligibleForRehire() const;
    void setIsEligibleForRehire(const bool &is_eligible_for_rehire);
    bool is_is_eligible_for_rehire_Set() const;
    bool is_is_eligible_for_rehire_Valid() const;
...
private:
    ...
    QString m_adjusted_seniority_date;
    bool m_adjusted_seniority_date_isSet;
    bool m_adjusted_seniority_date_isValid;
    ...
    QString m_employee_status;
    bool m_employee_status_isSet;
    bool m_employee_status_isValid;

    QString m_hire_date;
    bool m_hire_date_isSet;
    bool m_hire_date_isValid;

    bool m_is_eligible_for_rehire;
    bool m_is_eligible_for_rehire_isSet;
    bool m_is_eligible_for_rehire_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_status_inner)

#endif // OAIStagedEmployee_status_inner_H
