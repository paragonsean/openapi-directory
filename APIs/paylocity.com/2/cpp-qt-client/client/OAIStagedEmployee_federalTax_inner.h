...
/*
 * OAIStagedEmployee_federalTax_inner.h
 *
 * The Federal Tax model
 */

#ifndef OAIStagedEmployee_federalTax_inner_H
#define OAIStagedEmployee_federalTax_inner_H
...
class OAIStagedEmployee_federalTax_inner : public OAIObject {
public:
    OAIStagedEmployee_federalTax_inner();
    OAIStagedEmployee_federalTax_inner(QString json);
    ~OAIStagedEmployee_federalTax_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_federalTax_inner)

#endif // OAIStagedEmployee_federalTax_inner_H
