...
#ifndef OAIAdditionalRate_H
#define OAIAdditionalRate_H
...
class OAIAdditionalRate : public OAIObject {
public:
    OAIAdditionalRate();
    OAIAdditionalRate(QString json);
    ~OAIAdditionalRate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdditionalRate)

#endif // OAIAdditionalRate_H
