...
/*
 * OAICustomFieldDefinition.h
 *
 * 
 */

#ifndef OAICustomFieldDefinition_H
#define OAICustomFieldDefinition_H
...
namespace OpenAPI {
class OAICustomFieldDefinition_values_inner;

class OAICustomFieldDefinition : public OAIObject {
public:
    OAICustomFieldDefinition();
    OAICustomFieldDefinition(QString json);
    ~OAICustomFieldDefinition() override;
    ...
    QList<OAICustomFieldDefinition_values_inner> getValues() const;
    void setValues(const QList<OAICustomFieldDefinition_values_inner> &values);
...
private:
    ...
    QList<OAICustomFieldDefinition_values_inner> m_values;
    bool m_values_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldDefinition)

#endif // OAICustomFieldDefinition_H
