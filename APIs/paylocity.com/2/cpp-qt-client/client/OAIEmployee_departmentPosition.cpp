...
OAIEmployee_departmentPosition::OAIEmployee_departmentPosition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_departmentPosition::OAIEmployee_departmentPosition() {
    this->initializeModel();
}

OAIEmployee_departmentPosition::~OAIEmployee_departmentPosition() {}

void OAIEmployee_departmentPosition::initializeModel() {
    ...
    m_reviewer_company_number_isSet = false;
    m_reviewer_company_number_isValid = false;

    m_reviewer_employee_id_isSet = false;
    m_reviewer_employee_id_isValid = false;
...
void OAIEmployee_departmentPosition::fromJson(QString jsonString) {
...
void OAIEmployee_departmentPosition::fromJsonObject(QJsonObject json) {
    ...
    m_reviewer_company_number_isValid = ::OpenAPI::fromJsonValue(m_reviewer_company_number, json[QString("reviewerCompanyNumber")]);
    m_reviewer_company_number_isSet = !json[QString("reviewerCompanyNumber")].isNull() && m_reviewer_company_number_isValid;

    m_reviewer_employee_id_isValid = ::OpenAPI::fromJsonValue(m_reviewer_employee_id, json[QString("reviewerEmployeeId")]);
    m_reviewer_employee_id_isSet = !json[QString("reviewerEmployeeId")].isNull() && m_reviewer_employee_id_isValid;
...
QString OAIEmployee_departmentPosition::asJson() const {
...
QJsonObject OAIEmployee_departmentPosition::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_reviewer_company_number_isSet) {
        obj.insert(QString("reviewerCompanyNumber"), ::OpenAPI::toJsonValue(m_reviewer_company_number));
    }
    if (m_reviewer_employee_id_isSet) {
        obj.insert(QString("reviewerEmployeeId"), ::OpenAPI::toJsonValue(m_reviewer_employee_id));
    }
    if (m_shift_isSet) {
...
QString OAIEmployee_departmentPosition::getChangeReason() const {
    return m_change_reason;
}
void OAIEmployee_departmentPosition::setChangeReason(const QString &change_reason) {
    m_change_reason = change_reason;
    m_change_reason_isSet = true;
}

bool OAIEmployee_departmentPosition::is_change_reason_Set() const{
    return m_change_reason_isSet;
}

bool OAIEmployee_departmentPosition::is_change_reason_Valid() const{
    return m_change_reason_isValid;
}

QString OAIEmployee_departmentPosition::getClockBadgeNumber() const {
    return m_clock_badge_number;
}
void OAIEmployee_departmentPosition::setClockBadgeNumber(const QString &clock_badge_number) {
    m_clock_badge_number = clock_badge_number;
    m_clock_badge_number_isSet = true;
}

bool OAIEmployee_departmentPosition::is_clock_badge_number_Set() const{
    return m_clock_badge_number_isSet;
}

bool OAIEmployee_departmentPosition::is_clock_badge_number_Valid() const{
    return m_clock_badge_number_isValid;
}

QString OAIEmployee_departmentPosition::getCostCenter1() const {
    return m_cost_center1;
}
void OAIEmployee_departmentPosition::setCostCenter1(const QString &cost_center1) {
    m_cost_center1 = cost_center1;
    m_cost_center1_isSet = true;
}

bool OAIEmployee_departmentPosition::is_cost_center1_Set() const{
    return m_cost_center1_isSet;
}

bool OAIEmployee_departmentPosition::is_cost_center1_Valid() const{
    return m_cost_center1_isValid;
}

QString OAIEmployee_departmentPosition::getCostCenter2() const {
    return m_cost_center2;
}
void OAIEmployee_departmentPosition::setCostCenter2(const QString &cost_center2) {
    m_cost_center2 = cost_center2;
    m_cost_center2_isSet = true;
}

bool OAIEmployee_departmentPosition::is_cost_center2_Set() const{
    return m_cost_center2_isSet;
}

bool OAIEmployee_departmentPosition::is_cost_center2_Valid() const{
    return m_cost_center2_isValid;
}

QString OAIEmployee_departmentPosition::getCostCenter3() const {
    return m_cost_center3;
}
void OAIEmployee_departmentPosition::setCostCenter3(const QString &cost_center3) {
    m_cost_center3 = cost_center3;
    m_cost_center3_isSet = true;
}

bool OAIEmployee_departmentPosition::is_cost_center3_Set() const{
    return m_cost_center3_isSet;
}

bool OAIEmployee_departmentPosition::is_cost_center3_Valid() const{
    return m_cost_center3_isValid;
}

QString OAIEmployee_departmentPosition::getEffectiveDate() const {
    return m_effective_date;
}
void OAIEmployee_departmentPosition::setEffectiveDate(const QString &effective_date) {
    m_effective_date = effective_date;
    m_effective_date_isSet = true;
}

bool OAIEmployee_departmentPosition::is_effective_date_Set() const{
    return m_effective_date_isSet;
}

bool OAIEmployee_departmentPosition::is_effective_date_Valid() const{
    return m_effective_date_isValid;
}

QString OAIEmployee_departmentPosition::getEmployeeType() const {
    return m_employee_type;
}
void OAIEmployee_departmentPosition::setEmployeeType(const QString &employee_type) {
    m_employee_type = employee_type;
    m_employee_type_isSet = true;
}

bool OAIEmployee_departmentPosition::is_employee_type_Set() const{
    return m_employee_type_isSet;
}

bool OAIEmployee_departmentPosition::is_employee_type_Valid() const{
    return m_employee_type_isValid;
}

QString OAIEmployee_departmentPosition::getEqualEmploymentOpportunityClass() const {
    return m_equal_employment_opportunity_class;
}
void OAIEmployee_departmentPosition::setEqualEmploymentOpportunityClass(const QString &equal_employment_opportunity_class) {
    m_equal_employment_opportunity_class = equal_employment_opportunity_class;
    m_equal_employment_opportunity_class_isSet = true;
}

bool OAIEmployee_departmentPosition::is_equal_employment_opportunity_class_Set() const{
    return m_equal_employment_opportunity_class_isSet;
}

bool OAIEmployee_departmentPosition::is_equal_employment_opportunity_class_Valid() const{
    return m_equal_employment_opportunity_class_isValid;
}

bool OAIEmployee_departmentPosition::isIsMinimumWageExempt() const {
    return m_is_minimum_wage_exempt;
}
void OAIEmployee_departmentPosition::setIsMinimumWageExempt(const bool &is_minimum_wage_exempt) {
    m_is_minimum_wage_exempt = is_minimum_wage_exempt;
    m_is_minimum_wage_exempt_isSet = true;
}

bool OAIEmployee_departmentPosition::is_is_minimum_wage_exempt_Set() const{
    return m_is_minimum_wage_exempt_isSet;
}

bool OAIEmployee_departmentPosition::is_is_minimum_wage_exempt_Valid() const{
    return m_is_minimum_wage_exempt_isValid;
}

bool OAIEmployee_departmentPosition::isIsOvertimeExempt() const {
    return m_is_overtime_exempt;
}
void OAIEmployee_departmentPosition::setIsOvertimeExempt(const bool &is_overtime_exempt) {
    m_is_overtime_exempt = is_overtime_exempt;
    m_is_overtime_exempt_isSet = true;
}

bool OAIEmployee_departmentPosition::is_is_overtime_exempt_Set() const{
    return m_is_overtime_exempt_isSet;
}

bool OAIEmployee_departmentPosition::is_is_overtime_exempt_Valid() const{
    return m_is_overtime_exempt_isValid;
}

bool OAIEmployee_departmentPosition::isIsSupervisorReviewer() const {
    return m_is_supervisor_reviewer;
}
void OAIEmployee_departmentPosition::setIsSupervisorReviewer(const bool &is_supervisor_reviewer) {
    m_is_supervisor_reviewer = is_supervisor_reviewer;
    m_is_supervisor_reviewer_isSet = true;
}

bool OAIEmployee_departmentPosition::is_is_supervisor_reviewer_Set() const{
    return m_is_supervisor_reviewer_isSet;
}

bool OAIEmployee_departmentPosition::is_is_supervisor_reviewer_Valid() const{
    return m_is_supervisor_reviewer_isValid;
}

bool OAIEmployee_departmentPosition::isIsUnionDuesCollected() const {
    return m_is_union_dues_collected;
}
void OAIEmployee_departmentPosition::setIsUnionDuesCollected(const bool &is_union_dues_collected) {
    m_is_union_dues_collected = is_union_dues_collected;
    m_is_union_dues_collected_isSet = true;
}

bool OAIEmployee_departmentPosition::is_is_union_dues_collected_Set() const{
    return m_is_union_dues_collected_isSet;
}

bool OAIEmployee_departmentPosition::is_is_union_dues_collected_Valid() const{
    return m_is_union_dues_collected_isValid;
}

bool OAIEmployee_departmentPosition::isIsUnionInitiationCollected() const {
    return m_is_union_initiation_collected;
}
void OAIEmployee_departmentPosition::setIsUnionInitiationCollected(const bool &is_union_initiation_collected) {
    m_is_union_initiation_collected = is_union_initiation_collected;
    m_is_union_initiation_collected_isSet = true;
}

bool OAIEmployee_departmentPosition::is_is_union_initiation_collected_Set() const{
    return m_is_union_initiation_collected_isSet;
}

bool OAIEmployee_departmentPosition::is_is_union_initiation_collected_Valid() const{
    return m_is_union_initiation_collected_isValid;
}

QString OAIEmployee_departmentPosition::getJobTitle() const {
    return m_job_title;
}
void OAIEmployee_departmentPosition::setJobTitle(const QString &job_title) {
    m_job_title = job_title;
    m_job_title_isSet = true;
}

bool OAIEmployee_departmentPosition::is_job_title_Set() const{
    return m_job_title_isSet;
}

bool OAIEmployee_departmentPosition::is_job_title_Valid() const{
    return m_job_title_isValid;
}

QString OAIEmployee_departmentPosition::getPayGroup() const {
    return m_pay_group;
}
void OAIEmployee_departmentPosition::setPayGroup(const QString &pay_group) {
    m_pay_group = pay_group;
    m_pay_group_isSet = true;
}

bool OAIEmployee_departmentPosition::is_pay_group_Set() const{
    return m_pay_group_isSet;
}

bool OAIEmployee_departmentPosition::is_pay_group_Valid() const{
    return m_pay_group_isValid;
}

QString OAIEmployee_departmentPosition::getPositionCode() const {
    return m_position_code;
}
void OAIEmployee_departmentPosition::setPositionCode(const QString &position_code) {
    m_position_code = position_code;
    m_position_code_isSet = true;
}

bool OAIEmployee_departmentPosition::is_position_code_Set() const{
    return m_position_code_isSet;
}

bool OAIEmployee_departmentPosition::is_position_code_Valid() const{
    return m_position_code_isValid;
}

QString OAIEmployee_departmentPosition::getReviewerCompanyNumber() const {
    return m_reviewer_company_number;
}
void OAIEmployee_departmentPosition::setReviewerCompanyNumber(const QString &reviewer_company_number) {
    m_reviewer_company_number = reviewer_company_number;
    m_reviewer_company_number_isSet = true;
}

bool OAIEmployee_departmentPosition::is_reviewer_company_number_Set() const{
    return m_reviewer_company_number_isSet;
}

bool OAIEmployee_departmentPosition::is_reviewer_company_number_Valid() const{
    return m_reviewer_company_number_isValid;
}

QString OAIEmployee_departmentPosition::getReviewerEmployeeId() const {
    return m_reviewer_employee_id;
}
void OAIEmployee_departmentPosition::setReviewerEmployeeId(const QString &reviewer_employee_id) {
    m_reviewer_employee_id = reviewer_employee_id;
    m_reviewer_employee_id_isSet = true;
}

bool OAIEmployee_departmentPosition::is_reviewer_employee_id_Set() const{
    return m_reviewer_employee_id_isSet;
}

bool OAIEmployee_departmentPosition::is_reviewer_employee_id_Valid() const{
    return m_reviewer_employee_id_isValid;
}

QString OAIEmployee_departmentPosition::getShift() const {
    return m_shift;
}
void OAIEmployee_departmentPosition::setShift(const QString &shift) {
    m_shift = shift;
    m_shift_isSet = true;
}

bool OAIEmployee_departmentPosition::is_shift_Set() const{
    return m_shift_isSet;
}

bool OAIEmployee_departmentPosition::is_shift_Valid() const{
    return m_shift_isValid;
}

QString OAIEmployee_departmentPosition::getSupervisorCompanyNumber() const {
    return m_supervisor_company_number;
}
void OAIEmployee_departmentPosition::setSupervisorCompanyNumber(const QString &supervisor_company_number) {
    m_supervisor_company_number = supervisor_company_number;
    m_supervisor_company_number_isSet = true;
}

bool OAIEmployee_departmentPosition::is_supervisor_company_number_Set() const{
    return m_supervisor_company_number_isSet;
}

bool OAIEmployee_departmentPosition::is_supervisor_company_number_Valid() const{
    return m_supervisor_company_number_isValid;
}

QString OAIEmployee_departmentPosition::getSupervisorEmployeeId() const {
    return m_supervisor_employee_id;
}
void OAIEmployee_departmentPosition::setSupervisorEmployeeId(const QString &supervisor_employee_id) {
    m_supervisor_employee_id = supervisor_employee_id;
    m_supervisor_employee_id_isSet = true;
}

bool OAIEmployee_departmentPosition::is_supervisor_employee_id_Set() const{
    return m_supervisor_employee_id_isSet;
}

bool OAIEmployee_departmentPosition::is_supervisor_employee_id_Valid() const{
    return m_supervisor_employee_id_isValid;
}

QString OAIEmployee_departmentPosition::getTipped() const {
    return m_tipped;
}
void OAIEmployee_departmentPosition::setTipped(const QString &tipped) {
    m_tipped = tipped;
    m_tipped_isSet = true;
}

bool OAIEmployee_departmentPosition::is_tipped_Set() const{
    return m_tipped_isSet;
}

bool OAIEmployee_departmentPosition::is_tipped_Valid() const{
    return m_tipped_isValid;
}

QString OAIEmployee_departmentPosition::getUnionAffiliationDate() const {
    return m_union_affiliation_date;
}
void OAIEmployee_departmentPosition::setUnionAffiliationDate(const QString &union_affiliation_date) {
    m_union_affiliation_date = union_affiliation_date;
    m_union_affiliation_date_isSet = true;
}

bool OAIEmployee_departmentPosition::is_union_affiliation_date_Set() const{
    return m_union_affiliation_date_isSet;
}

bool OAIEmployee_departmentPosition::is_union_affiliation_date_Valid() const{
    return m_union_affiliation_date_isValid;
}

QString OAIEmployee_departmentPosition::getUnionCode() const {
    return m_union_code;
}
void OAIEmployee_departmentPosition::setUnionCode(const QString &union_code) {
    m_union_code = union_code;
    m_union_code_isSet = true;
}

bool OAIEmployee_departmentPosition::is_union_code_Set() const{
    return m_union_code_isSet;
}

bool OAIEmployee_departmentPosition::is_union_code_Valid() const{
    return m_union_code_isValid;
}

QString OAIEmployee_departmentPosition::getUnionPosition() const {
    return m_union_position;
}
void OAIEmployee_departmentPosition::setUnionPosition(const QString &union_position) {
    m_union_position = union_position;
    m_union_position_isSet = true;
}

bool OAIEmployee_departmentPosition::is_union_position_Set() const{
    return m_union_position_isSet;
}

bool OAIEmployee_departmentPosition::is_union_position_Valid() const{
    return m_union_position_isValid;
}

QString OAIEmployee_departmentPosition::getWorkersCompensation() const {
    return m_workers_compensation;
}
void OAIEmployee_departmentPosition::setWorkersCompensation(const QString &workers_compensation) {
    m_workers_compensation = workers_compensation;
    m_workers_compensation_isSet = true;
}

bool OAIEmployee_departmentPosition::is_workers_compensation_Set() const{
    return m_workers_compensation_isSet;
}

bool OAIEmployee_departmentPosition::is_workers_compensation_Valid() const{
    return m_workers_compensation_isValid;
}

bool OAIEmployee_departmentPosition::isSet() const {
...
bool OAIEmployee_departmentPosition::isValid() const {
