...
/*
 * OAIAddClientSecret.h
 *
 * The Add Client Secret Request Model
 */

#ifndef OAIAddClientSecret_H
#define OAIAddClientSecret_H
...
class OAIAddClientSecret : public OAIObject {
public:
    OAIAddClientSecret();
    OAIAddClientSecret(QString json);
    ~OAIAddClientSecret() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddClientSecret)

#endif // OAIAddClientSecret_H
