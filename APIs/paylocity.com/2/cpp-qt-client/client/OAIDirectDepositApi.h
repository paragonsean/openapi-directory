...
#ifndef OAI_OAIDirectDepositApi_H
#define OAI_OAIDirectDepositApi_H
...
class OAIDirectDepositApi : public QObject {
    Q_OBJECT

public:
    OAIDirectDepositApi(const int timeOut = 0);
    ~OAIDirectDepositApi();
    ...
    */
    virtual void get_All_Direct_Deposit(const QString &company_id, const QString &employee_id);
...
private:
    ...
    void get_All_Direct_DepositCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void get_All_Direct_DepositSignal(QList<OAIDirectDeposit> summary);


    void get_All_Direct_DepositSignalFull(OAIHttpRequestWorker *worker, QList<OAIDirectDeposit> summary);

    Q_DECL_DEPRECATED_X("Use get_All_Direct_DepositSignalError() instead")
    void get_All_Direct_DepositSignalE(QList<OAIDirectDeposit> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_Direct_DepositSignalError(QList<OAIDirectDeposit> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use get_All_Direct_DepositSignalErrorFull() instead")
    void get_All_Direct_DepositSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_Direct_DepositSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
