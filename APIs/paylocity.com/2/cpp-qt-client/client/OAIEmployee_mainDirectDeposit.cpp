...
OAIEmployee_mainDirectDeposit::OAIEmployee_mainDirectDeposit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_mainDirectDeposit::OAIEmployee_mainDirectDeposit() {
    this->initializeModel();
}

OAIEmployee_mainDirectDeposit::~OAIEmployee_mainDirectDeposit() {}

void OAIEmployee_mainDirectDeposit::initializeModel() {
...
void OAIEmployee_mainDirectDeposit::fromJson(QString jsonString) {
...
void OAIEmployee_mainDirectDeposit::fromJsonObject(QJsonObject json) {
...
QString OAIEmployee_mainDirectDeposit::asJson() const {
...
QJsonObject OAIEmployee_mainDirectDeposit::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEmployee_mainDirectDeposit::getAccountNumber() const {
    return m_account_number;
}
void OAIEmployee_mainDirectDeposit::setAccountNumber(const QString &account_number) {
    m_account_number = account_number;
    m_account_number_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_account_number_Set() const{
    return m_account_number_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_account_number_Valid() const{
    return m_account_number_isValid;
}

QString OAIEmployee_mainDirectDeposit::getAccountType() const {
    return m_account_type;
}
void OAIEmployee_mainDirectDeposit::setAccountType(const QString &account_type) {
    m_account_type = account_type;
    m_account_type_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_account_type_Set() const{
    return m_account_type_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_account_type_Valid() const{
    return m_account_type_isValid;
}

bool OAIEmployee_mainDirectDeposit::isBlockSpecial() const {
    return m_block_special;
}
void OAIEmployee_mainDirectDeposit::setBlockSpecial(const bool &block_special) {
    m_block_special = block_special;
    m_block_special_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_block_special_Set() const{
    return m_block_special_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_block_special_Valid() const{
    return m_block_special_isValid;
}

bool OAIEmployee_mainDirectDeposit::isIsSkipPreNote() const {
    return m_is_skip_pre_note;
}
void OAIEmployee_mainDirectDeposit::setIsSkipPreNote(const bool &is_skip_pre_note) {
    m_is_skip_pre_note = is_skip_pre_note;
    m_is_skip_pre_note_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_is_skip_pre_note_Set() const{
    return m_is_skip_pre_note_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_is_skip_pre_note_Valid() const{
    return m_is_skip_pre_note_isValid;
}

QString OAIEmployee_mainDirectDeposit::getNameOnAccount() const {
    return m_name_on_account;
}
void OAIEmployee_mainDirectDeposit::setNameOnAccount(const QString &name_on_account) {
    m_name_on_account = name_on_account;
    m_name_on_account_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_name_on_account_Set() const{
    return m_name_on_account_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_name_on_account_Valid() const{
    return m_name_on_account_isValid;
}

QString OAIEmployee_mainDirectDeposit::getPreNoteDate() const {
    return m_pre_note_date;
}
void OAIEmployee_mainDirectDeposit::setPreNoteDate(const QString &pre_note_date) {
    m_pre_note_date = pre_note_date;
    m_pre_note_date_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_pre_note_date_Set() const{
    return m_pre_note_date_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_pre_note_date_Valid() const{
    return m_pre_note_date_isValid;
}

QString OAIEmployee_mainDirectDeposit::getRoutingNumber() const {
    return m_routing_number;
}
void OAIEmployee_mainDirectDeposit::setRoutingNumber(const QString &routing_number) {
    m_routing_number = routing_number;
    m_routing_number_isSet = true;
}

bool OAIEmployee_mainDirectDeposit::is_routing_number_Set() const{
    return m_routing_number_isSet;
}

bool OAIEmployee_mainDirectDeposit::is_routing_number_Valid() const{
    return m_routing_number_isValid;
}

bool OAIEmployee_mainDirectDeposit::isSet() const {
...
bool OAIEmployee_mainDirectDeposit::isValid() const {
