...
OAIStagedEmployee_status_inner::OAIStagedEmployee_status_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStagedEmployee_status_inner::OAIStagedEmployee_status_inner() {
    this->initializeModel();
}

OAIStagedEmployee_status_inner::~OAIStagedEmployee_status_inner() {}

void OAIStagedEmployee_status_inner::initializeModel() {
...
void OAIStagedEmployee_status_inner::fromJson(QString jsonString) {
...
void OAIStagedEmployee_status_inner::fromJsonObject(QJsonObject json) {
...
QString OAIStagedEmployee_status_inner::asJson() const {
...
QJsonObject OAIStagedEmployee_status_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStagedEmployee_status_inner::getAdjustedSeniorityDate() const {
    return m_adjusted_seniority_date;
}
void OAIStagedEmployee_status_inner::setAdjustedSeniorityDate(const QString &adjusted_seniority_date) {
    m_adjusted_seniority_date = adjusted_seniority_date;
    m_adjusted_seniority_date_isSet = true;
}

bool OAIStagedEmployee_status_inner::is_adjusted_seniority_date_Set() const{
    return m_adjusted_seniority_date_isSet;
}

bool OAIStagedEmployee_status_inner::is_adjusted_seniority_date_Valid() const{
    return m_adjusted_seniority_date_isValid;
}

QString OAIStagedEmployee_status_inner::getChangeReason() const {
    return m_change_reason;
}
void OAIStagedEmployee_status_inner::setChangeReason(const QString &change_reason) {
    m_change_reason = change_reason;
    m_change_reason_isSet = true;
}

bool OAIStagedEmployee_status_inner::is_change_reason_Set() const{
    return m_change_reason_isSet;
}

bool OAIStagedEmployee_status_inner::is_change_reason_Valid() const{
    return m_change_reason_isValid;
}

QString OAIStagedEmployee_status_inner::getEffectiveDate() const {
    return m_effective_date;
}
void OAIStagedEmployee_status_inner::setEffectiveDate(const QString &effective_date) {
    m_effective_date = effective_date;
    m_effective_date_isSet = true;
}

bool OAIStagedEmployee_status_inner::is_effective_date_Set() const{
    return m_effective_date_isSet;
}

bool OAIStagedEmployee_status_inner::is_effective_date_Valid() const{
    return m_effective_date_isValid;
}

QString OAIStagedEmployee_status_inner::getEmployeeStatus() const {
    return m_employee_status;
}
void OAIStagedEmployee_status_inner::setEmployeeStatus(const QString &employee_status) {
    m_employee_status = employee_status;
    m_employee_status_isSet = true;
}

bool OAIStagedEmployee_status_inner::is_employee_status_Set() const{
    return m_employee_status_isSet;
}

bool OAIStagedEmployee_status_inner::is_employee_status_Valid() const{
    return m_employee_status_isValid;
}

QString OAIStagedEmployee_status_inner::getHireDate() const {
    return m_hire_date;
}
void OAIStagedEmployee_status_inner::setHireDate(const QString &hire_date) {
    m_hire_date = hire_date;
    m_hire_date_isSet = true;
}

bool OAIStagedEmployee_status_inner::is_hire_date_Set() const{
    return m_hire_date_isSet;
}

bool OAIStagedEmployee_status_inner::is_hire_date_Valid() const{
    return m_hire_date_isValid;
}

bool OAIStagedEmployee_status_inner::isIsEligibleForRehire() const {
    return m_is_eligible_for_rehire;
}
void OAIStagedEmployee_status_inner::setIsEligibleForRehire(const bool &is_eligible_for_rehire) {
    m_is_eligible_for_rehire = is_eligible_for_rehire;
    m_is_eligible_for_rehire_isSet = true;
}

bool OAIStagedEmployee_status_inner::is_is_eligible_for_rehire_Set() const{
    return m_is_eligible_for_rehire_isSet;
}

bool OAIStagedEmployee_status_inner::is_is_eligible_for_rehire_Valid() const{
    return m_is_eligible_for_rehire_isValid;
}

bool OAIStagedEmployee_status_inner::isSet() const {
...
bool OAIStagedEmployee_status_inner::isValid() const {
