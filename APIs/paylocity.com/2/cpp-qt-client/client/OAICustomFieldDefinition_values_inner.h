...
/*
 * OAICustomFieldDefinition_values_inner.h
 *
 * 
 */

#ifndef OAICustomFieldDefinition_values_inner_H
#define OAICustomFieldDefinition_values_inner_H
...
class OAICustomFieldDefinition_values_inner : public OAIObject {
public:
    OAICustomFieldDefinition_values_inner();
    OAICustomFieldDefinition_values_inner(QString json);
    ~OAICustomFieldDefinition_values_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomFieldDefinition_values_inner)

#endif // OAICustomFieldDefinition_values_inner_H
