...
/*
 * OAISensitiveData_ethnicity_ethnicRacialIdentities_inner.h
 *
 * The ethnic racial identity model
 */

#ifndef OAISensitiveData_ethnicity_ethnicRacialIdentities_inner_H
#define OAISensitiveData_ethnicity_ethnicRacialIdentities_inner_H
...
class OAISensitiveData_ethnicity_ethnicRacialIdentities_inner : public OAIObject {
public:
    OAISensitiveData_ethnicity_ethnicRacialIdentities_inner();
    OAISensitiveData_ethnicity_ethnicRacialIdentities_inner(QString json);
    ~OAISensitiveData_ethnicity_ethnicRacialIdentities_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData_ethnicity_ethnicRacialIdentities_inner)

#endif // OAISensitiveData_ethnicity_ethnicRacialIdentities_inner_H
