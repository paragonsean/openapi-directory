...
/*
 * OAIError_options_inner.h
 *
 * The error option model
 */

#ifndef OAIError_options_inner_H
#define OAIError_options_inner_H
...
class OAIError_options_inner : public OAIObject {
public:
    OAIError_options_inner();
    OAIError_options_inner(QString json);
    ~OAIError_options_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIError_options_inner)

#endif // OAIError_options_inner_H
