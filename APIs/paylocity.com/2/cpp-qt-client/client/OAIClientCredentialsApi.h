...
#ifndef OAI_OAIClientCredentialsApi_H
#define OAI_OAIClientCredentialsApi_H
...
class OAIClientCredentialsApi : public QObject {
    Q_OBJECT

public:
    OAIClientCredentialsApi(const int timeOut = 0);
    ~OAIClientCredentialsApi();
    ...
    /**
    * @param[in]  oai_add_client_secret OAIAddClientSecret [required]
    */
    virtual void add_Client_Secret(const OAIAddClientSecret &oai_add_client_secret);
...
private:
    ...
    void add_Client_SecretCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_Client_SecretSignal(QList<OAIClientCredentialsResponse> summary);


    void add_Client_SecretSignalFull(OAIHttpRequestWorker *worker, QList<OAIClientCredentialsResponse> summary);

    Q_DECL_DEPRECATED_X("Use add_Client_SecretSignalError() instead")
    void add_Client_SecretSignalE(QList<OAIClientCredentialsResponse> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void add_Client_SecretSignalError(QList<OAIClientCredentialsResponse> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_Client_SecretSignalErrorFull() instead")
    void add_Client_SecretSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_Client_SecretSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
