...
OAIStagedEmployee_primaryStateTax_inner::OAIStagedEmployee_primaryStateTax_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStagedEmployee_primaryStateTax_inner::OAIStagedEmployee_primaryStateTax_inner() {
    this->initializeModel();
}

OAIStagedEmployee_primaryStateTax_inner::~OAIStagedEmployee_primaryStateTax_inner() {}

void OAIStagedEmployee_primaryStateTax_inner::initializeModel() {
...
void OAIStagedEmployee_primaryStateTax_inner::fromJson(QString jsonString) {
...
void OAIStagedEmployee_primaryStateTax_inner::fromJsonObject(QJsonObject json) {
...
QString OAIStagedEmployee_primaryStateTax_inner::asJson() const {
...
QJsonObject OAIStagedEmployee_primaryStateTax_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_amount_isSet) {
...
double OAIStagedEmployee_primaryStateTax_inner::getAmount() const {
    return m_amount;
}
void OAIStagedEmployee_primaryStateTax_inner::setAmount(const double &amount) {
    m_amount = amount;
    m_amount_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_amount_Set() const{
    return m_amount_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_amount_Valid() const{
    return m_amount_isValid;
}

double OAIStagedEmployee_primaryStateTax_inner::getDeductionsAmount() const {
    return m_deductions_amount;
}
void OAIStagedEmployee_primaryStateTax_inner::setDeductionsAmount(const double &deductions_amount) {
    m_deductions_amount = deductions_amount;
    m_deductions_amount_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_deductions_amount_Set() const{
    return m_deductions_amount_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_deductions_amount_Valid() const{
    return m_deductions_amount_isValid;
}

double OAIStagedEmployee_primaryStateTax_inner::getDependentsAmount() const {
    return m_dependents_amount;
}
void OAIStagedEmployee_primaryStateTax_inner::setDependentsAmount(const double &dependents_amount) {
    m_dependents_amount = dependents_amount;
    m_dependents_amount_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_dependents_amount_Set() const{
    return m_dependents_amount_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_dependents_amount_Valid() const{
    return m_dependents_amount_isValid;
}

double OAIStagedEmployee_primaryStateTax_inner::getExemptions() const {
    return m_exemptions;
}
void OAIStagedEmployee_primaryStateTax_inner::setExemptions(const double &exemptions) {
    m_exemptions = exemptions;
    m_exemptions_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_exemptions_Set() const{
    return m_exemptions_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_exemptions_Valid() const{
    return m_exemptions_isValid;
}

double OAIStagedEmployee_primaryStateTax_inner::getExemptions2() const {
    return m_exemptions2;
}
void OAIStagedEmployee_primaryStateTax_inner::setExemptions2(const double &exemptions2) {
    m_exemptions2 = exemptions2;
    m_exemptions2_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_exemptions2_Set() const{
    return m_exemptions2_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_exemptions2_Valid() const{
    return m_exemptions2_isValid;
}

QString OAIStagedEmployee_primaryStateTax_inner::getFilingStatus() const {
    return m_filing_status;
}
void OAIStagedEmployee_primaryStateTax_inner::setFilingStatus(const QString &filing_status) {
    m_filing_status = filing_status;
    m_filing_status_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_filing_status_Set() const{
    return m_filing_status_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_filing_status_Valid() const{
    return m_filing_status_isValid;
}

bool OAIStagedEmployee_primaryStateTax_inner::isHigherRate() const {
    return m_higher_rate;
}
void OAIStagedEmployee_primaryStateTax_inner::setHigherRate(const bool &higher_rate) {
    m_higher_rate = higher_rate;
    m_higher_rate_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_higher_rate_Set() const{
    return m_higher_rate_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_higher_rate_Valid() const{
    return m_higher_rate_isValid;
}

double OAIStagedEmployee_primaryStateTax_inner::getOtherIncomeAmount() const {
    return m_other_income_amount;
}
void OAIStagedEmployee_primaryStateTax_inner::setOtherIncomeAmount(const double &other_income_amount) {
    m_other_income_amount = other_income_amount;
    m_other_income_amount_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_other_income_amount_Set() const{
    return m_other_income_amount_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_other_income_amount_Valid() const{
    return m_other_income_amount_isValid;
}

double OAIStagedEmployee_primaryStateTax_inner::getPercentage() const {
    return m_percentage;
}
void OAIStagedEmployee_primaryStateTax_inner::setPercentage(const double &percentage) {
    m_percentage = percentage;
    m_percentage_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_percentage_Set() const{
    return m_percentage_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_percentage_Valid() const{
    return m_percentage_isValid;
}

QString OAIStagedEmployee_primaryStateTax_inner::getSpecialCheckCalc() const {
    return m_special_check_calc;
}
void OAIStagedEmployee_primaryStateTax_inner::setSpecialCheckCalc(const QString &special_check_calc) {
    m_special_check_calc = special_check_calc;
    m_special_check_calc_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_special_check_calc_Set() const{
    return m_special_check_calc_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_special_check_calc_Valid() const{
    return m_special_check_calc_isValid;
}

QString OAIStagedEmployee_primaryStateTax_inner::getTaxCalculationCode() const {
    return m_tax_calculation_code;
}
void OAIStagedEmployee_primaryStateTax_inner::setTaxCalculationCode(const QString &tax_calculation_code) {
    m_tax_calculation_code = tax_calculation_code;
    m_tax_calculation_code_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_tax_calculation_code_Set() const{
    return m_tax_calculation_code_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_tax_calculation_code_Valid() const{
    return m_tax_calculation_code_isValid;
}

QString OAIStagedEmployee_primaryStateTax_inner::getTaxCode() const {
    return m_tax_code;
}
void OAIStagedEmployee_primaryStateTax_inner::setTaxCode(const QString &tax_code) {
    m_tax_code = tax_code;
    m_tax_code_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_tax_code_Set() const{
    return m_tax_code_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_tax_code_Valid() const{
    return m_tax_code_isValid;
}

qint32 OAIStagedEmployee_primaryStateTax_inner::getW4FormYear() const {
    return m_w4_form_year;
}
void OAIStagedEmployee_primaryStateTax_inner::setW4FormYear(const qint32 &w4_form_year) {
    m_w4_form_year = w4_form_year;
    m_w4_form_year_isSet = true;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_w4_form_year_Set() const{
    return m_w4_form_year_isSet;
}

bool OAIStagedEmployee_primaryStateTax_inner::is_w4_form_year_Valid() const{
    return m_w4_form_year_isValid;
}

bool OAIStagedEmployee_primaryStateTax_inner::isSet() const {
...
bool OAIStagedEmployee_primaryStateTax_inner::isValid() const {
