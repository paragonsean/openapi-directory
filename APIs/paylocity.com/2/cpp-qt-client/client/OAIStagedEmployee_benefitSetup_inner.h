...
/*
 * OAIStagedEmployee_benefitSetup_inner.h
 *
 * The benefit setup model
 */

#ifndef OAIStagedEmployee_benefitSetup_inner_H
#define OAIStagedEmployee_benefitSetup_inner_H
...
class OAIStagedEmployee_benefitSetup_inner : public OAIObject {
public:
    OAIStagedEmployee_benefitSetup_inner();
    OAIStagedEmployee_benefitSetup_inner(QString json);
    ~OAIStagedEmployee_benefitSetup_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_benefitSetup_inner)

#endif // OAIStagedEmployee_benefitSetup_inner_H
