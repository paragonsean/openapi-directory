...
#include "OAIPrimaryStateTaxApi.h"
...
OAIPrimaryStateTaxApi::OAIPrimaryStateTaxApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIPrimaryStateTaxApi::~OAIPrimaryStateTaxApi() {
}

void OAIPrimaryStateTaxApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("add_or_update_primary_state_tax", defaultConf);
    _serverIndices.insert("add_or_update_primary_state_tax", 0);
}
...
*/
int OAIPrimaryStateTaxApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIPrimaryStateTaxApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIPrimaryStateTaxApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIPrimaryStateTaxApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIPrimaryStateTaxApi::setUsername(const QString &username) {
    _username = username;
}

void OAIPrimaryStateTaxApi::setPassword(const QString &password) {
    _password = password;
}


void OAIPrimaryStateTaxApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIPrimaryStateTaxApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIPrimaryStateTaxApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIPrimaryStateTaxApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPrimaryStateTaxApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIPrimaryStateTaxApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIPrimaryStateTaxApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIPrimaryStateTaxApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIPrimaryStateTaxApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIPrimaryStateTaxApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIPrimaryStateTaxApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIPrimaryStateTaxApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIPrimaryStateTaxApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIPrimaryStateTaxApi::add_or_update_primary_state_tax(const QString &company_id, const QString &employee_id, const OAIStateTax &oai_state_tax) {
    QString fullPath = QString(_serverConfigs["add_or_update_primary_state_tax"][_serverIndices.value("add_or_update_primary_state_tax")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/primaryStateTax");
...

    {
        ...
        QByteArray output = oai_state_tax.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPrimaryStateTaxApi::add_or_update_primary_state_taxCallback);
    connect(this, &OAIPrimaryStateTaxApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIPrimaryStateTaxApi::add_or_update_primary_state_taxCallback);
    connect(this, &OAIPrimaryStateTaxApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIPrimaryStateTaxApi::add_or_update_primary_state_taxCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_or_update_primary_state_taxSignal();
        Q_EMIT add_or_update_primary_state_taxSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_or_update_primary_state_taxSignalE(error_type, error_str);
        Q_EMIT add_or_update_primary_state_taxSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_or_update_primary_state_taxSignalError(error_type, error_str);
        Q_EMIT add_or_update_primary_state_taxSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIPrimaryStateTaxApi::tokenAvailable(){
