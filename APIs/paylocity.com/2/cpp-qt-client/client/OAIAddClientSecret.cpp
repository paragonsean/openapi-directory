...
OAIAddClientSecret::OAIAddClientSecret(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAddClientSecret::OAIAddClientSecret() {
    this->initializeModel();
}

OAIAddClientSecret::~OAIAddClientSecret() {}

void OAIAddClientSecret::initializeModel() {

    m_code_isSet = false;
    m_code_isValid = false;
}

void OAIAddClientSecret::fromJson(QString jsonString) {
...
void OAIAddClientSecret::fromJsonObject(QJsonObject json) {

    m_code_isValid = ::OpenAPI::fromJsonValue(m_code, json[QString("code")]);
    m_code_isSet = !json[QString("code")].isNull() && m_code_isValid;
}

QString OAIAddClientSecret::asJson() const {
...
QJsonObject OAIAddClientSecret::asJsonObject() const {
    QJsonObject obj;
    if (m_code_isSet) {
...
QString OAIAddClientSecret::getCode() const {
    return m_code;
}
void OAIAddClientSecret::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIAddClientSecret::is_code_Set() const{
    return m_code_isSet;
}

bool OAIAddClientSecret::is_code_Valid() const{
    return m_code_isValid;
}

bool OAIAddClientSecret::isSet() const {
...
bool OAIAddClientSecret::isValid() const {
