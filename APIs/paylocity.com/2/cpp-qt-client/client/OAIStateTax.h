...
#ifndef OAIStateTax_H
#define OAIStateTax_H
...
class OAIStateTax : public OAIObject {
public:
    OAIStateTax();
    OAIStateTax(QString json);
    ~OAIStateTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStateTax)
