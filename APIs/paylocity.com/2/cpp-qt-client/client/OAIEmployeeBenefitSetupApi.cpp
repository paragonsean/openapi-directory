...
#include "OAIEmployeeBenefitSetupApi.h"
...
OAIEmployeeBenefitSetupApi::OAIEmployeeBenefitSetupApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIEmployeeBenefitSetupApi::~OAIEmployeeBenefitSetupApi() {
}

void OAIEmployeeBenefitSetupApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("update_or_add_employee_benefit_setup", defaultConf);
    _serverIndices.insert("update_or_add_employee_benefit_setup", 0);
}
...
*/
int OAIEmployeeBenefitSetupApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIEmployeeBenefitSetupApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIEmployeeBenefitSetupApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIEmployeeBenefitSetupApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIEmployeeBenefitSetupApi::setUsername(const QString &username) {
    _username = username;
}

void OAIEmployeeBenefitSetupApi::setPassword(const QString &password) {
    _password = password;
}


void OAIEmployeeBenefitSetupApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIEmployeeBenefitSetupApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIEmployeeBenefitSetupApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIEmployeeBenefitSetupApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmployeeBenefitSetupApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmployeeBenefitSetupApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIEmployeeBenefitSetupApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIEmployeeBenefitSetupApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIEmployeeBenefitSetupApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIEmployeeBenefitSetupApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIEmployeeBenefitSetupApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIEmployeeBenefitSetupApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIEmployeeBenefitSetupApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIEmployeeBenefitSetupApi::update_or_add_employee_benefit_setup(const QString &company_id, const QString &employee_id, const OAIBenefitSetup &oai_benefit_setup) {
    QString fullPath = QString(_serverConfigs["update_or_add_employee_benefit_setup"][_serverIndices.value("update_or_add_employee_benefit_setup")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/benefitSetup");
...

    {
        ...
        QByteArray output = oai_benefit_setup.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeBenefitSetupApi::update_or_add_employee_benefit_setupCallback);
    connect(this, &OAIEmployeeBenefitSetupApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeBenefitSetupApi::update_or_add_employee_benefit_setupCallback);
    connect(this, &OAIEmployeeBenefitSetupApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIEmployeeBenefitSetupApi::update_or_add_employee_benefit_setupCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT update_or_add_employee_benefit_setupSignal();
        Q_EMIT update_or_add_employee_benefit_setupSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT update_or_add_employee_benefit_setupSignalE(error_type, error_str);
        Q_EMIT update_or_add_employee_benefit_setupSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT update_or_add_employee_benefit_setupSignalError(error_type, error_str);
        Q_EMIT update_or_add_employee_benefit_setupSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeBenefitSetupApi::tokenAvailable(){
