...
#include "OAIError_options_inner.h"
#include <QList>
#include <QString>
...
public:
    ...
    QList<OAIError_options_inner> getOptions() const;
    void setOptions(const QList<OAIError_options_inner> &options);
...
private:
    ...
    QList<OAIError_options_inner> m_options;
