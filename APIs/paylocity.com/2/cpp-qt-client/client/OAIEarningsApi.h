...
#ifndef OAI_OAIEarningsApi_H
#define OAI_OAIEarningsApi_H
...
class OAIEarningsApi : public QObject {
    Q_OBJECT

public:
    OAIEarningsApi(const int timeOut = 0);
    ~OAIEarningsApi();
    ...
    * @param[in]  oai_earning OAIEarning [required]
    */
    virtual void add_or_update_an_employee_earning(const QString &company_id, const QString &employee_id, const OAIEarning &oai_earning);

    /**
    * @param[in]  company_id QString [required]
    * @param[in]  employee_id QString [required]
    * @param[in]  earning_code QString [required]
    * @param[in]  start_date QString [required]
    */
    virtual void delete_Earning_by_Earning_Code_and_Start_Date(const QString &company_id, const QString &employee_id, const QString &earning_code, const QString &start_date);

    /**
    * @param[in]  company_id QString [required]
    * @param[in]  employee_id QString [required]
    */
    virtual void get_All_Earnings(const QString &company_id, const QString &employee_id);
    ...
    * @param[in]  start_date QString [required]
    */
    virtual void get_Earning_by_Earning_Code_and_Start_Date(const QString &company_id, const QString &employee_id, const QString &earning_code, const QString &start_date);
    ...
    * @param[in]  earning_code QString [required]
    */
    virtual void get_Earnings_by_Earning_Code(const QString &company_id, const QString &employee_id, const QString &earning_code);
...
private:
    ...
    void add_or_update_an_employee_earningCallback(OAIHttpRequestWorker *worker);
    void delete_Earning_by_Earning_Code_and_Start_DateCallback(OAIHttpRequestWorker *worker);
    void get_All_EarningsCallback(OAIHttpRequestWorker *worker);
    void get_Earning_by_Earning_Code_and_Start_DateCallback(OAIHttpRequestWorker *worker);
    void get_Earnings_by_Earning_CodeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_or_update_an_employee_earningSignal();
    void delete_Earning_by_Earning_Code_and_Start_DateSignal();
    void get_All_EarningsSignal(QList<OAIEarning> summary);
    void get_Earning_by_Earning_Code_and_Start_DateSignal(OAIEarning summary);
    void get_Earnings_by_Earning_CodeSignal(QList<OAIEarning> summary);


    void add_or_update_an_employee_earningSignalFull(OAIHttpRequestWorker *worker);
    void delete_Earning_by_Earning_Code_and_Start_DateSignalFull(OAIHttpRequestWorker *worker);
    void get_All_EarningsSignalFull(OAIHttpRequestWorker *worker, QList<OAIEarning> summary);
    void get_Earning_by_Earning_Code_and_Start_DateSignalFull(OAIHttpRequestWorker *worker, OAIEarning summary);
    void get_Earnings_by_Earning_CodeSignalFull(OAIHttpRequestWorker *worker, QList<OAIEarning> summary);

    Q_DECL_DEPRECATED_X("Use add_or_update_an_employee_earningSignalError() instead")
    void add_or_update_an_employee_earningSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_an_employee_earningSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_Earning_by_Earning_Code_and_Start_DateSignalError() instead")
    void delete_Earning_by_Earning_Code_and_Start_DateSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void delete_Earning_by_Earning_Code_and_Start_DateSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_All_EarningsSignalError() instead")
    void get_All_EarningsSignalE(QList<OAIEarning> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_EarningsSignalError(QList<OAIEarning> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_Earning_by_Earning_Code_and_Start_DateSignalError() instead")
    void get_Earning_by_Earning_Code_and_Start_DateSignalE(OAIEarning summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_Earning_by_Earning_Code_and_Start_DateSignalError(OAIEarning summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_Earnings_by_Earning_CodeSignalError() instead")
    void get_Earnings_by_Earning_CodeSignalE(QList<OAIEarning> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_Earnings_by_Earning_CodeSignalError(QList<OAIEarning> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_or_update_an_employee_earningSignalErrorFull() instead")
    void add_or_update_an_employee_earningSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_an_employee_earningSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_Earning_by_Earning_Code_and_Start_DateSignalErrorFull() instead")
    void delete_Earning_by_Earning_Code_and_Start_DateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void delete_Earning_by_Earning_Code_and_Start_DateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_All_EarningsSignalErrorFull() instead")
    void get_All_EarningsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_All_EarningsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_Earning_by_Earning_Code_and_Start_DateSignalErrorFull() instead")
    void get_Earning_by_Earning_Code_and_Start_DateSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_Earning_by_Earning_Code_and_Start_DateSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_Earnings_by_Earning_CodeSignalErrorFull() instead")
    void get_Earnings_by_Earning_CodeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_Earnings_by_Earning_CodeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
