...
/*
 * OAIEmployee_localTax_inner.h
 *
 * The Local Tax model
 */

#ifndef OAIEmployee_localTax_inner_H
#define OAIEmployee_localTax_inner_H
...
class OAIEmployee_localTax_inner : public OAIObject {
public:
    OAIEmployee_localTax_inner();
    OAIEmployee_localTax_inner(QString json);
    ~OAIEmployee_localTax_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_localTax_inner)

#endif // OAIEmployee_localTax_inner_H
