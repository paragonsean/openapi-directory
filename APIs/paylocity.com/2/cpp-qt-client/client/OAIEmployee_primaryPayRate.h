...
/*
 * OAIEmployee_primaryPayRate.h
 *
 * Add or update hourly or salary pay rate, effective date, and pay frequency.
 */

#ifndef OAIEmployee_primaryPayRate_H
#define OAIEmployee_primaryPayRate_H
...
class OAIEmployee_primaryPayRate : public OAIObject {
public:
    OAIEmployee_primaryPayRate();
    OAIEmployee_primaryPayRate(QString json);
    ~OAIEmployee_primaryPayRate() override;
    ...
    void setBaseRate(const double &base_rate);
    bool is_base_rate_Set() const;
    bool is_base_rate_Valid() const;

    QString getBeginCheckDate() const;
    void setBeginCheckDate(const QString &begin_check_date);
    bool is_begin_check_date_Set() const;
    bool is_begin_check_date_Valid() const;
    ...
    double getDefaultHours() const;
    void setDefaultHours(const double &default_hours);
    bool is_default_hours_Set() const;
    bool is_default_hours_Valid() const;
    ...
    void setIsAutoPay(const bool &is_auto_pay);
    bool is_is_auto_pay_Set() const;
    bool is_is_auto_pay_Valid() const;
    ...
    QString getPayGrade() const;
    void setPayGrade(const QString &pay_grade);
    bool is_pay_grade_Set() const;
    bool is_pay_grade_Valid() const;

    QString getPayRateNote() const;
    void setPayRateNote(const QString &pay_rate_note);
    bool is_pay_rate_note_Set() const;
    bool is_pay_rate_note_Valid() const;
    ...
    QString getRatePer() const;
    void setRatePer(const QString &rate_per);
    bool is_rate_per_Set() const;
    bool is_rate_per_Valid() const;
...
private:
    ...
    double m_base_rate;
    bool m_base_rate_isSet;
    bool m_base_rate_isValid;

    QString m_begin_check_date;
    bool m_begin_check_date_isSet;
    bool m_begin_check_date_isValid;

    QString m_change_reason;
    bool m_change_reason_isSet;
    bool m_change_reason_isValid;

    double m_default_hours;
    bool m_default_hours_isSet;
    bool m_default_hours_isValid;
    ...
    bool m_is_auto_pay;
    bool m_is_auto_pay_isSet;
    bool m_is_auto_pay_isValid;
    ...
    QString m_pay_grade;
    bool m_pay_grade_isSet;
    bool m_pay_grade_isValid;

    QString m_pay_rate_note;
    bool m_pay_rate_note_isSet;
    bool m_pay_rate_note_isValid;
    ...
    QString m_rate_per;
    bool m_rate_per_isSet;
    bool m_rate_per_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_primaryPayRate)

#endif // OAIEmployee_primaryPayRate_H
