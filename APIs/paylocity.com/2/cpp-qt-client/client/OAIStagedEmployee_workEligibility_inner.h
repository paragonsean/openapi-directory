...
/*
 * OAIStagedEmployee_workEligibility_inner.h
 *
 * The Work Eligibility model
 */

#ifndef OAIStagedEmployee_workEligibility_inner_H
#define OAIStagedEmployee_workEligibility_inner_H
...
class OAIStagedEmployee_workEligibility_inner : public OAIObject {
public:
    OAIStagedEmployee_workEligibility_inner();
    OAIStagedEmployee_workEligibility_inner(QString json);
    ~OAIStagedEmployee_workEligibility_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_workEligibility_inner)

#endif // OAIStagedEmployee_workEligibility_inner_H
