...
#include "OAISensitiveData_ethnicity.h"
...
OAISensitiveData_ethnicity::OAISensitiveData_ethnicity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData_ethnicity::OAISensitiveData_ethnicity() {
    this->initializeModel();
}

OAISensitiveData_ethnicity::~OAISensitiveData_ethnicity() {}

void OAISensitiveData_ethnicity::initializeModel() {

    m_ethnic_racial_identities_isSet = false;
    m_ethnic_racial_identities_isValid = false;

    m_ethnicity_isSet = false;
    m_ethnicity_isValid = false;
}

void OAISensitiveData_ethnicity::fromJson(QString jsonString) {
...
void OAISensitiveData_ethnicity::fromJsonObject(QJsonObject json) {

    m_ethnic_racial_identities_isValid = ::OpenAPI::fromJsonValue(m_ethnic_racial_identities, json[QString("ethnicRacialIdentities")]);
    m_ethnic_racial_identities_isSet = !json[QString("ethnicRacialIdentities")].isNull() && m_ethnic_racial_identities_isValid;
...
QString OAISensitiveData_ethnicity::asJson() const {
...
QJsonObject OAISensitiveData_ethnicity::asJsonObject() const {
    QJsonObject obj;
    if (m_ethnic_racial_identities.size() > 0) {
        obj.insert(QString("ethnicRacialIdentities"), ::OpenAPI::toJsonValue(m_ethnic_racial_identities));
    }
...
QList<OAISensitiveData_ethnicity_ethnicRacialIdentities_inner> OAISensitiveData_ethnicity::getEthnicRacialIdentities() const {
    return m_ethnic_racial_identities;
}
void OAISensitiveData_ethnicity::setEthnicRacialIdentities(const QList<OAISensitiveData_ethnicity_ethnicRacialIdentities_inner> &ethnic_racial_identities) {
    m_ethnic_racial_identities = ethnic_racial_identities;
    m_ethnic_racial_identities_isSet = true;
}

bool OAISensitiveData_ethnicity::is_ethnic_racial_identities_Set() const{
    return m_ethnic_racial_identities_isSet;
}

bool OAISensitiveData_ethnicity::is_ethnic_racial_identities_Valid() const{
    return m_ethnic_racial_identities_isValid;
}

QString OAISensitiveData_ethnicity::getEthnicity() const {
    return m_ethnicity;
}
void OAISensitiveData_ethnicity::setEthnicity(const QString &ethnicity) {
    m_ethnicity = ethnicity;
    m_ethnicity_isSet = true;
}

bool OAISensitiveData_ethnicity::is_ethnicity_Set() const{
    return m_ethnicity_isSet;
}

bool OAISensitiveData_ethnicity::is_ethnicity_Valid() const{
    return m_ethnicity_isValid;
}

bool OAISensitiveData_ethnicity::isSet() const {
...
bool OAISensitiveData_ethnicity::isValid() const {
