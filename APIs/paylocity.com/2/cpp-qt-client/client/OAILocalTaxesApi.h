...
#ifndef OAI_OAILocalTaxesApi_H
#define OAI_OAILocalTaxesApi_H
...
class OAILocalTaxesApi : public QObject {
    Q_OBJECT

public:
    OAILocalTaxesApi(const int timeOut = 0);
    ~OAILocalTaxesApi();
    ...
    * @param[in]  oai_local_tax OAILocalTax [required]
    */
    virtual void add_local_tax(const QString &company_id, const QString &employee_id, const OAILocalTax &oai_local_tax);

    /**
    * @param[in]  company_id QString [required]
    * @param[in]  employee_id QString [required]
    * @param[in]  tax_code QString [required]
    */
    virtual void delete_local_tax_by_tax_code(const QString &company_id, const QString &employee_id, const QString &tax_code);

    /**
    * @param[in]  company_id QString [required]
    * @param[in]  employee_id QString [required]
    */
    virtual void get_all_local_taxes(const QString &company_id, const QString &employee_id);
    ...
    * @param[in]  tax_code QString [required]
    */
    virtual void get_local_tax_by_tax_code(const QString &company_id, const QString &employee_id, const QString &tax_code);
...
private:
    ...
    void add_local_taxCallback(OAIHttpRequestWorker *worker);
    void delete_local_tax_by_tax_codeCallback(OAIHttpRequestWorker *worker);
    void get_all_local_taxesCallback(OAIHttpRequestWorker *worker);
    void get_local_tax_by_tax_codeCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_local_taxSignal();
    void delete_local_tax_by_tax_codeSignal();
    void get_all_local_taxesSignal(QList<OAILocalTax> summary);
    void get_local_tax_by_tax_codeSignal(QList<OAILocalTax> summary);


    void add_local_taxSignalFull(OAIHttpRequestWorker *worker);
    void delete_local_tax_by_tax_codeSignalFull(OAIHttpRequestWorker *worker);
    void get_all_local_taxesSignalFull(OAIHttpRequestWorker *worker, QList<OAILocalTax> summary);
    void get_local_tax_by_tax_codeSignalFull(OAIHttpRequestWorker *worker, QList<OAILocalTax> summary);

    Q_DECL_DEPRECATED_X("Use add_local_taxSignalError() instead")
    void add_local_taxSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_local_taxSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_local_tax_by_tax_codeSignalError() instead")
    void delete_local_tax_by_tax_codeSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void delete_local_tax_by_tax_codeSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_local_taxesSignalError() instead")
    void get_all_local_taxesSignalE(QList<OAILocalTax> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_local_taxesSignalError(QList<OAILocalTax> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_local_tax_by_tax_codeSignalError() instead")
    void get_local_tax_by_tax_codeSignalE(QList<OAILocalTax> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void get_local_tax_by_tax_codeSignalError(QList<OAILocalTax> summary, QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_local_taxSignalErrorFull() instead")
    void add_local_taxSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_local_taxSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use delete_local_tax_by_tax_codeSignalErrorFull() instead")
    void delete_local_tax_by_tax_codeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void delete_local_tax_by_tax_codeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_all_local_taxesSignalErrorFull() instead")
    void get_all_local_taxesSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_all_local_taxesSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use get_local_tax_by_tax_codeSignalErrorFull() instead")
    void get_local_tax_by_tax_codeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void get_local_tax_by_tax_codeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
