...
#include "OAIEmployeeIdResponse.h"
...
OAIEmployeeIdResponse::OAIEmployeeIdResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployeeIdResponse::OAIEmployeeIdResponse() {
    this->initializeModel();
}

OAIEmployeeIdResponse::~OAIEmployeeIdResponse() {}

void OAIEmployeeIdResponse::initializeModel() {

    m_employee_id_isSet = false;
    m_employee_id_isValid = false;
}

void OAIEmployeeIdResponse::fromJson(QString jsonString) {
...
void OAIEmployeeIdResponse::fromJsonObject(QJsonObject json) {
...
QString OAIEmployeeIdResponse::asJson() const {
...
QJsonObject OAIEmployeeIdResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEmployeeIdResponse::getEmployeeId() const {
    return m_employee_id;
}
void OAIEmployeeIdResponse::setEmployeeId(const QString &employee_id) {
    m_employee_id = employee_id;
    m_employee_id_isSet = true;
}

bool OAIEmployeeIdResponse::is_employee_id_Set() const{
    return m_employee_id_isSet;
}

bool OAIEmployeeIdResponse::is_employee_id_Valid() const{
    return m_employee_id_isValid;
}

bool OAIEmployeeIdResponse::isSet() const {
...
bool OAIEmployeeIdResponse::isValid() const {
