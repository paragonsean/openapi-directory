...
#include "OAINonPrimaryStateTaxApi.h"
...
OAINonPrimaryStateTaxApi::OAINonPrimaryStateTaxApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAINonPrimaryStateTaxApi::~OAINonPrimaryStateTaxApi() {
}

void OAINonPrimaryStateTaxApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("add_or_update_nonPrimary_state_tax", defaultConf);
    _serverIndices.insert("add_or_update_nonPrimary_state_tax", 0);
}
...
*/
int OAINonPrimaryStateTaxApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAINonPrimaryStateTaxApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAINonPrimaryStateTaxApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAINonPrimaryStateTaxApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAINonPrimaryStateTaxApi::setUsername(const QString &username) {
    _username = username;
}

void OAINonPrimaryStateTaxApi::setPassword(const QString &password) {
    _password = password;
}


void OAINonPrimaryStateTaxApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAINonPrimaryStateTaxApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAINonPrimaryStateTaxApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAINonPrimaryStateTaxApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINonPrimaryStateTaxApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAINonPrimaryStateTaxApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAINonPrimaryStateTaxApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAINonPrimaryStateTaxApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAINonPrimaryStateTaxApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAINonPrimaryStateTaxApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAINonPrimaryStateTaxApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAINonPrimaryStateTaxApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAINonPrimaryStateTaxApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAINonPrimaryStateTaxApi::add_or_update_nonPrimary_state_tax(const QString &company_id, const QString &employee_id, const OAINonPrimaryStateTax &oai_non_primary_state_tax) {
    QString fullPath = QString(_serverConfigs["add_or_update_nonPrimary_state_tax"][_serverIndices.value("add_or_update_nonPrimary_state_tax")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/nonprimaryStateTax");
...

    {
        ...
        QByteArray output = oai_non_primary_state_tax.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINonPrimaryStateTaxApi::add_or_update_nonPrimary_state_taxCallback);
    connect(this, &OAINonPrimaryStateTaxApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAINonPrimaryStateTaxApi::add_or_update_nonPrimary_state_taxCallback);
    connect(this, &OAINonPrimaryStateTaxApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAINonPrimaryStateTaxApi::add_or_update_nonPrimary_state_taxCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_or_update_nonPrimary_state_taxSignal();
        Q_EMIT add_or_update_nonPrimary_state_taxSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_or_update_nonPrimary_state_taxSignalE(error_type, error_str);
        Q_EMIT add_or_update_nonPrimary_state_taxSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_or_update_nonPrimary_state_taxSignalError(error_type, error_str);
        Q_EMIT add_or_update_nonPrimary_state_taxSignalErrorFull(worker, error_type, error_str);
    }
}

void OAINonPrimaryStateTaxApi::tokenAvailable(){
