...
/*
 * OAIEmployee_workEligibility.h
 *
 * Add or update I-9 work authorization information.
 */

#ifndef OAIEmployee_workEligibility_H
#define OAIEmployee_workEligibility_H
...
class OAIEmployee_workEligibility : public OAIObject {
public:
    OAIEmployee_workEligibility();
    OAIEmployee_workEligibility(QString json);
    ~OAIEmployee_workEligibility() override;
    ...
    QString getAlienOrAdmissionDocumentNumber() const;
    void setAlienOrAdmissionDocumentNumber(const QString &alien_or_admission_document_number);
    bool is_alien_or_admission_document_number_Set() const;
    bool is_alien_or_admission_document_number_Valid() const;

    QString getAttestedDate() const;
    void setAttestedDate(const QString &attested_date);
    bool is_attested_date_Set() const;
    bool is_attested_date_Valid() const;

    QString getCountryOfIssuance() const;
    void setCountryOfIssuance(const QString &country_of_issuance);
    bool is_country_of_issuance_Set() const;
    bool is_country_of_issuance_Valid() const;

    QString getForeignPassportNumber() const;
    void setForeignPassportNumber(const QString &foreign_passport_number);
    bool is_foreign_passport_number_Set() const;
    bool is_foreign_passport_number_Valid() const;

    QString getI94AdmissionNumber() const;
    void setI94AdmissionNumber(const QString &i94_admission_number);
    bool is_i94_admission_number_Set() const;
    bool is_i94_admission_number_Valid() const;

    QString getI9DateVerified() const;
    void setI9DateVerified(const QString &i9_date_verified);
    bool is_i9_date_verified_Set() const;
    bool is_i9_date_verified_Valid() const;

    QString getI9Notes() const;
    void setI9Notes(const QString &i9_notes);
    bool is_i9_notes_Set() const;
    bool is_i9_notes_Valid() const;

    bool isIsI9Verified() const;
    void setIsI9Verified(const bool &is_i9_verified);
    bool is_is_i9_verified_Set() const;
    bool is_is_i9_verified_Valid() const;

    bool isIsSsnVerified() const;
    void setIsSsnVerified(const bool &is_ssn_verified);
    bool is_is_ssn_verified_Set() const;
    bool is_is_ssn_verified_Valid() const;

    QString getSsnDateVerified() const;
    void setSsnDateVerified(const QString &ssn_date_verified);
    bool is_ssn_date_verified_Set() const;
    bool is_ssn_date_verified_Valid() const;

    QString getSsnNotes() const;
    void setSsnNotes(const QString &ssn_notes);
    bool is_ssn_notes_Set() const;
    bool is_ssn_notes_Valid() const;

    QString getVisaType() const;
    void setVisaType(const QString &visa_type);
    bool is_visa_type_Set() const;
    bool is_visa_type_Valid() const;

    QString getWorkAuthorization() const;
    void setWorkAuthorization(const QString &work_authorization);
    bool is_work_authorization_Set() const;
    bool is_work_authorization_Valid() const;

    QString getWorkUntil() const;
    void setWorkUntil(const QString &work_until);
    bool is_work_until_Set() const;
    bool is_work_until_Valid() const;
...
private:
    ...
    QString m_alien_or_admission_document_number;
    bool m_alien_or_admission_document_number_isSet;
    bool m_alien_or_admission_document_number_isValid;

    QString m_attested_date;
    bool m_attested_date_isSet;
    bool m_attested_date_isValid;

    QString m_country_of_issuance;
    bool m_country_of_issuance_isSet;
    bool m_country_of_issuance_isValid;

    QString m_foreign_passport_number;
    bool m_foreign_passport_number_isSet;
    bool m_foreign_passport_number_isValid;

    QString m_i94_admission_number;
    bool m_i94_admission_number_isSet;
    bool m_i94_admission_number_isValid;

    QString m_i9_date_verified;
    bool m_i9_date_verified_isSet;
    bool m_i9_date_verified_isValid;

    QString m_i9_notes;
    bool m_i9_notes_isSet;
    bool m_i9_notes_isValid;

    bool m_is_i9_verified;
    bool m_is_i9_verified_isSet;
    bool m_is_i9_verified_isValid;

    bool m_is_ssn_verified;
    bool m_is_ssn_verified_isSet;
    bool m_is_ssn_verified_isValid;

    QString m_ssn_date_verified;
    bool m_ssn_date_verified_isSet;
    bool m_ssn_date_verified_isValid;

    QString m_ssn_notes;
    bool m_ssn_notes_isSet;
    bool m_ssn_notes_isValid;

    QString m_visa_type;
    bool m_visa_type_isSet;
    bool m_visa_type_isValid;

    QString m_work_authorization;
    bool m_work_authorization_isSet;
    bool m_work_authorization_isValid;

    QString m_work_until;
    bool m_work_until_isSet;
    bool m_work_until_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_workEligibility)

#endif // OAIEmployee_workEligibility_H
