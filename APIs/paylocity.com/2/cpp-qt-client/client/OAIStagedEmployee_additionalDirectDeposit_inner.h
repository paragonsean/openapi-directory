...
/*
 * OAIStagedEmployee_additionalDirectDeposit_inner.h
 *
 * The additional direct deposit model
 */

#ifndef OAIStagedEmployee_additionalDirectDeposit_inner_H
#define OAIStagedEmployee_additionalDirectDeposit_inner_H
...
class OAIStagedEmployee_additionalDirectDeposit_inner : public OAIObject {
public:
    OAIStagedEmployee_additionalDirectDeposit_inner();
    OAIStagedEmployee_additionalDirectDeposit_inner(QString json);
    ~OAIStagedEmployee_additionalDirectDeposit_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_additionalDirectDeposit_inner)

#endif // OAIStagedEmployee_additionalDirectDeposit_inner_H
