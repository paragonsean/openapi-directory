...
void OAICustomFieldsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("get_All_Custom_Fields_by_category", defaultConf);
    _serverIndices.insert("get_All_Custom_Fields_by_category", 0);
}
...
void OAICustomFieldsApi::get_All_Custom_Fields_by_category(const QString &company_id, const QString &category) {
    QString fullPath = QString(_serverConfigs["get_All_Custom_Fields_by_category"][_serverIndices.value("get_All_Custom_Fields_by_category")].URL()+"/v2/companies/{companyId}/customfields/{category}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICustomFieldsApi::get_All_Custom_Fields_by_categoryCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICustomFieldsApi::get_All_Custom_Fields_by_categoryCallback);
...
void OAICustomFieldsApi::get_All_Custom_Fields_by_categoryCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAICustomFieldDefinition> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAICustomFieldDefinition val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_All_Custom_Fields_by_categorySignal(output);
        Q_EMIT get_All_Custom_Fields_by_categorySignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_All_Custom_Fields_by_categorySignalE(output, error_type, error_str);
        Q_EMIT get_All_Custom_Fields_by_categorySignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_All_Custom_Fields_by_categorySignalError(output, error_type, error_str);
        Q_EMIT get_All_Custom_Fields_by_categorySignalErrorFull(worker, error_type, error_str);
    }
}
