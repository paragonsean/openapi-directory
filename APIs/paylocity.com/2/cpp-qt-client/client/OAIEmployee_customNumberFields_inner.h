...
/*
 * OAIEmployee_customNumberFields_inner.h
 *
 * 
 */

#ifndef OAIEmployee_customNumberFields_inner_H
#define OAIEmployee_customNumberFields_inner_H
...
class OAIEmployee_customNumberFields_inner : public OAIObject {
public:
    OAIEmployee_customNumberFields_inner();
    OAIEmployee_customNumberFields_inner(QString json);
    ~OAIEmployee_customNumberFields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_customNumberFields_inner)

#endif // OAIEmployee_customNumberFields_inner_H
