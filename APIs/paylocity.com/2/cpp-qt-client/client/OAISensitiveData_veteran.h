...
/*
 * OAISensitiveData_veteran.h
 *
 * Add or update veteran data.
 */

#ifndef OAISensitiveData_veteran_H
#define OAISensitiveData_veteran_H
...
class OAISensitiveData_veteran : public OAIObject {
public:
    OAISensitiveData_veteran();
    OAISensitiveData_veteran(QString json);
    ~OAISensitiveData_veteran() override;
    ...
    QString getIsVeteran() const;
    void setIsVeteran(const QString &is_veteran);
    bool is_is_veteran_Set() const;
    bool is_is_veteran_Valid() const;

    QString getVeteran() const;
    void setVeteran(const QString &veteran);
    bool is_veteran_Set() const;
    bool is_veteran_Valid() const;
...
private:
    ...
    QString m_is_veteran;
    bool m_is_veteran_isSet;
    bool m_is_veteran_isValid;

    QString m_veteran;
    bool m_veteran_isSet;
    bool m_veteran_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISensitiveData_veteran)

#endif // OAISensitiveData_veteran_H
