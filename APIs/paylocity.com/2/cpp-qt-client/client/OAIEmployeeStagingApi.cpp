...
#include "OAIEmployeeStagingApi.h"
...
OAIEmployeeStagingApi::OAIEmployeeStagingApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIEmployeeStagingApi::~OAIEmployeeStagingApi() {
}

void OAIEmployeeStagingApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("add_new_employee_to_Web_Link", defaultConf);
    _serverIndices.insert("add_new_employee_to_Web_Link", 0);
}
...
*/
int OAIEmployeeStagingApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIEmployeeStagingApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIEmployeeStagingApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIEmployeeStagingApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIEmployeeStagingApi::setUsername(const QString &username) {
    _username = username;
}

void OAIEmployeeStagingApi::setPassword(const QString &password) {
    _password = password;
}


void OAIEmployeeStagingApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIEmployeeStagingApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIEmployeeStagingApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIEmployeeStagingApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmployeeStagingApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIEmployeeStagingApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIEmployeeStagingApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIEmployeeStagingApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIEmployeeStagingApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIEmployeeStagingApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIEmployeeStagingApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIEmployeeStagingApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIEmployeeStagingApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIEmployeeStagingApi::add_new_employee_to_Web_Link(const QString &company_id, const OAIStagedEmployee &oai_staged_employee) {
    QString fullPath = QString(_serverConfigs["add_new_employee_to_Web_Link"][_serverIndices.value("add_new_employee_to_Web_Link")].URL()+"/v2/weblinkstaging/companies/{companyId}/employees/newemployees");
...

    {
        ...
        QByteArray output = oai_staged_employee.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeStagingApi::add_new_employee_to_Web_LinkCallback);
    connect(this, &OAIEmployeeStagingApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeStagingApi::add_new_employee_to_Web_LinkCallback);
    connect(this, &OAIEmployeeStagingApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIEmployeeStagingApi::add_new_employee_to_Web_LinkCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAITrackingNumberResponse> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAITrackingNumberResponse val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_new_employee_to_Web_LinkSignal(output);
        Q_EMIT add_new_employee_to_Web_LinkSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_new_employee_to_Web_LinkSignalE(output, error_type, error_str);
        Q_EMIT add_new_employee_to_Web_LinkSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_new_employee_to_Web_LinkSignalError(output, error_type, error_str);
        Q_EMIT add_new_employee_to_Web_LinkSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeStagingApi::tokenAvailable(){
