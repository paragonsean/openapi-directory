...
OAIEmployee_workAddress::OAIEmployee_workAddress(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmployee_workAddress::OAIEmployee_workAddress() {
    this->initializeModel();
}

OAIEmployee_workAddress::~OAIEmployee_workAddress() {}

void OAIEmployee_workAddress::initializeModel() {
    ...
    m_mail_stop_isSet = false;
    m_mail_stop_isValid = false;
...
void OAIEmployee_workAddress::fromJson(QString jsonString) {
...
void OAIEmployee_workAddress::fromJsonObject(QJsonObject json) {
    ...
    m_mail_stop_isValid = ::OpenAPI::fromJsonValue(m_mail_stop, json[QString("mailStop")]);
    m_mail_stop_isSet = !json[QString("mailStop")].isNull() && m_mail_stop_isValid;
...
QString OAIEmployee_workAddress::asJson() const {
...
QJsonObject OAIEmployee_workAddress::asJsonObject() const {
    QJsonObject obj;
    if (m_address1_isSet) {
    ...
    if (m_mail_stop_isSet) {
        obj.insert(QString("mailStop"), ::OpenAPI::toJsonValue(m_mail_stop));
    }
...
QString OAIEmployee_workAddress::getAddress1() const {
    return m_address1;
}
void OAIEmployee_workAddress::setAddress1(const QString &address1) {
    m_address1 = address1;
    m_address1_isSet = true;
}

bool OAIEmployee_workAddress::is_address1_Set() const{
    return m_address1_isSet;
}

bool OAIEmployee_workAddress::is_address1_Valid() const{
    return m_address1_isValid;
}

QString OAIEmployee_workAddress::getAddress2() const {
    return m_address2;
}
void OAIEmployee_workAddress::setAddress2(const QString &address2) {
    m_address2 = address2;
    m_address2_isSet = true;
}

bool OAIEmployee_workAddress::is_address2_Set() const{
    return m_address2_isSet;
}

bool OAIEmployee_workAddress::is_address2_Valid() const{
    return m_address2_isValid;
}

QString OAIEmployee_workAddress::getCity() const {
    return m_city;
}
void OAIEmployee_workAddress::setCity(const QString &city) {
    m_city = city;
    m_city_isSet = true;
}

bool OAIEmployee_workAddress::is_city_Set() const{
    return m_city_isSet;
}

bool OAIEmployee_workAddress::is_city_Valid() const{
    return m_city_isValid;
}

QString OAIEmployee_workAddress::getCountry() const {
    return m_country;
}
void OAIEmployee_workAddress::setCountry(const QString &country) {
    m_country = country;
    m_country_isSet = true;
}

bool OAIEmployee_workAddress::is_country_Set() const{
    return m_country_isSet;
}

bool OAIEmployee_workAddress::is_country_Valid() const{
    return m_country_isValid;
}

QString OAIEmployee_workAddress::getCounty() const {
    return m_county;
}
void OAIEmployee_workAddress::setCounty(const QString &county) {
    m_county = county;
    m_county_isSet = true;
}

bool OAIEmployee_workAddress::is_county_Set() const{
    return m_county_isSet;
}

bool OAIEmployee_workAddress::is_county_Valid() const{
    return m_county_isValid;
}

QString OAIEmployee_workAddress::getEmailAddress() const {
    return m_email_address;
}
void OAIEmployee_workAddress::setEmailAddress(const QString &email_address) {
    m_email_address = email_address;
    m_email_address_isSet = true;
}

bool OAIEmployee_workAddress::is_email_address_Set() const{
    return m_email_address_isSet;
}

bool OAIEmployee_workAddress::is_email_address_Valid() const{
    return m_email_address_isValid;
}

QString OAIEmployee_workAddress::getLocation() const {
    return m_location;
}
void OAIEmployee_workAddress::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIEmployee_workAddress::is_location_Set() const{
    return m_location_isSet;
}

bool OAIEmployee_workAddress::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIEmployee_workAddress::getMailStop() const {
    return m_mail_stop;
}
void OAIEmployee_workAddress::setMailStop(const QString &mail_stop) {
    m_mail_stop = mail_stop;
    m_mail_stop_isSet = true;
}

bool OAIEmployee_workAddress::is_mail_stop_Set() const{
    return m_mail_stop_isSet;
}

bool OAIEmployee_workAddress::is_mail_stop_Valid() const{
    return m_mail_stop_isValid;
}

QString OAIEmployee_workAddress::getMobilePhone() const {
    return m_mobile_phone;
}
void OAIEmployee_workAddress::setMobilePhone(const QString &mobile_phone) {
    m_mobile_phone = mobile_phone;
    m_mobile_phone_isSet = true;
}

bool OAIEmployee_workAddress::is_mobile_phone_Set() const{
    return m_mobile_phone_isSet;
}

bool OAIEmployee_workAddress::is_mobile_phone_Valid() const{
    return m_mobile_phone_isValid;
}

QString OAIEmployee_workAddress::getPager() const {
    return m_pager;
}
void OAIEmployee_workAddress::setPager(const QString &pager) {
    m_pager = pager;
    m_pager_isSet = true;
}

bool OAIEmployee_workAddress::is_pager_Set() const{
    return m_pager_isSet;
}

bool OAIEmployee_workAddress::is_pager_Valid() const{
    return m_pager_isValid;
}

QString OAIEmployee_workAddress::getPhone() const {
    return m_phone;
}
void OAIEmployee_workAddress::setPhone(const QString &phone) {
    m_phone = phone;
    m_phone_isSet = true;
}

bool OAIEmployee_workAddress::is_phone_Set() const{
    return m_phone_isSet;
}

bool OAIEmployee_workAddress::is_phone_Valid() const{
    return m_phone_isValid;
}

QString OAIEmployee_workAddress::getPhoneExtension() const {
    return m_phone_extension;
}
void OAIEmployee_workAddress::setPhoneExtension(const QString &phone_extension) {
    m_phone_extension = phone_extension;
    m_phone_extension_isSet = true;
}

bool OAIEmployee_workAddress::is_phone_extension_Set() const{
    return m_phone_extension_isSet;
}

bool OAIEmployee_workAddress::is_phone_extension_Valid() const{
    return m_phone_extension_isValid;
}

QString OAIEmployee_workAddress::getPostalCode() const {
    return m_postal_code;
}
void OAIEmployee_workAddress::setPostalCode(const QString &postal_code) {
    m_postal_code = postal_code;
    m_postal_code_isSet = true;
}

bool OAIEmployee_workAddress::is_postal_code_Set() const{
    return m_postal_code_isSet;
}

bool OAIEmployee_workAddress::is_postal_code_Valid() const{
    return m_postal_code_isValid;
}

QString OAIEmployee_workAddress::getState() const {
    return m_state;
}
void OAIEmployee_workAddress::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIEmployee_workAddress::is_state_Set() const{
    return m_state_isSet;
}

bool OAIEmployee_workAddress::is_state_Valid() const{
    return m_state_isValid;
}

bool OAIEmployee_workAddress::isSet() const {
...
bool OAIEmployee_workAddress::isValid() const {
