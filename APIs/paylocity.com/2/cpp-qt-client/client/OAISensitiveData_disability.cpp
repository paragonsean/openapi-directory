...
OAISensitiveData_disability::OAISensitiveData_disability(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISensitiveData_disability::OAISensitiveData_disability() {
    this->initializeModel();
}

OAISensitiveData_disability::~OAISensitiveData_disability() {}

void OAISensitiveData_disability::initializeModel() {

    m_disability_isSet = false;
    m_disability_isValid = false;

    m_disability_classifications_isSet = false;
    m_disability_classifications_isValid = false;

    m_has_disability_isSet = false;
    m_has_disability_isValid = false;
}

void OAISensitiveData_disability::fromJson(QString jsonString) {
...
void OAISensitiveData_disability::fromJsonObject(QJsonObject json) {
    ...
    m_disability_classifications_isValid = ::OpenAPI::fromJsonValue(m_disability_classifications, json[QString("disabilityClassifications")]);
    m_disability_classifications_isSet = !json[QString("disabilityClassifications")].isNull() && m_disability_classifications_isValid;

    m_has_disability_isValid = ::OpenAPI::fromJsonValue(m_has_disability, json[QString("hasDisability")]);
    m_has_disability_isSet = !json[QString("hasDisability")].isNull() && m_has_disability_isValid;
}

QString OAISensitiveData_disability::asJson() const {
...
QJsonObject OAISensitiveData_disability::asJsonObject() const {
    QJsonObject obj;
    if (m_disability_isSet) {
        obj.insert(QString("disability"), ::OpenAPI::toJsonValue(m_disability));
    }
    if (m_disability_classifications.size() > 0) {
        obj.insert(QString("disabilityClassifications"), ::OpenAPI::toJsonValue(m_disability_classifications));
    }
    if (m_has_disability_isSet) {
        obj.insert(QString("hasDisability"), ::OpenAPI::toJsonValue(m_has_disability));
    }
    return obj;
}

QString OAISensitiveData_disability::getDisability() const {
    return m_disability;
}
void OAISensitiveData_disability::setDisability(const QString &disability) {
    m_disability = disability;
    m_disability_isSet = true;
}

bool OAISensitiveData_disability::is_disability_Set() const{
    return m_disability_isSet;
}

bool OAISensitiveData_disability::is_disability_Valid() const{
    return m_disability_isValid;
}

QList<OAISensitiveData_disability_disabilityClassifications_inner> OAISensitiveData_disability::getDisabilityClassifications() const {
    return m_disability_classifications;
}
void OAISensitiveData_disability::setDisabilityClassifications(const QList<OAISensitiveData_disability_disabilityClassifications_inner> &disability_classifications) {
    m_disability_classifications = disability_classifications;
    m_disability_classifications_isSet = true;
}

bool OAISensitiveData_disability::is_disability_classifications_Set() const{
    return m_disability_classifications_isSet;
}

bool OAISensitiveData_disability::is_disability_classifications_Valid() const{
    return m_disability_classifications_isValid;
}

QString OAISensitiveData_disability::getHasDisability() const {
    return m_has_disability;
}
void OAISensitiveData_disability::setHasDisability(const QString &has_disability) {
    m_has_disability = has_disability;
    m_has_disability_isSet = true;
}

bool OAISensitiveData_disability::is_has_disability_Set() const{
    return m_has_disability_isSet;
}

bool OAISensitiveData_disability::is_has_disability_Valid() const{
    return m_has_disability_isValid;
}

bool OAISensitiveData_disability::isSet() const {
...
bool OAISensitiveData_disability::isValid() const {
