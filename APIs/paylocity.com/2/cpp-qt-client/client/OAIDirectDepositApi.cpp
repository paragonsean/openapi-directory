...
OAIDirectDepositApi::OAIDirectDepositApi(const int timeOut)
    : _timeOut(timeOut),
      _manager(nullptr),
...
OAIDirectDepositApi::~OAIDirectDepositApi() {
}

void OAIDirectDepositApi::initializeServerConfigs() {
    //Default server
    ...
    _serverConfigs.insert("get_All_Direct_Deposit", defaultConf);
    _serverIndices.insert("get_All_Direct_Deposit", 0);
}
...
*/
int OAIDirectDepositApi::setDefaultServerValue(int serverIndex, const QString &operation, const QString &variable, const QString &value) {
...
void OAIDirectDepositApi::setServerIndex(const QString &operation, int serverIndex) {
    if (_serverIndices.contains(operation) && serverIndex < _serverConfigs.find(operation).value().size()) {
        _serverIndices[operation] = serverIndex;
    }
}

void OAIDirectDepositApi::setApiKey(const QString &apiKeyName, const QString &apiKey) {
    _apiKeys.insert(apiKeyName, apiKey);
}

void OAIDirectDepositApi::setBearerToken(const QString &token) {
    _bearerToken = token;
}

void OAIDirectDepositApi::setUsername(const QString &username) {
    _username = username;
}

void OAIDirectDepositApi::setPassword(const QString &password) {
    _password = password;
}


void OAIDirectDepositApi::setTimeOut(const int timeOut) {
    _timeOut = timeOut;
}

void OAIDirectDepositApi::setWorkingDirectory(const QString &path) {
    _workingDirectory = path;
}

void OAIDirectDepositApi::setNetworkAccessManager(QNetworkAccessManager* manager) {
    _manager = manager;
}
...
/**
    ...
    */
int OAIDirectDepositApi::addServerConfiguration(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDirectDepositApi::setNewServerForAllOperations(const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
...
/**
    ...
    * @param variables A map between a variable name and its value. The value is used for substitution in the server's URL template.
    */
void OAIDirectDepositApi::setNewServer(const QString &operation, const QUrl &url, const QString &description, const QMap<QString, OAIServerVariable> &variables) {
    setServerIndex(operation, addServerConfiguration(operation, url, description, variables));
}

void OAIDirectDepositApi::addHeaders(const QString &key, const QString &value) {
    _defaultHeaders.insert(key, value);
}

void OAIDirectDepositApi::enableRequestCompression() {
    _isRequestCompressionEnabled = true;
}

void OAIDirectDepositApi::enableResponseCompression() {
    _isResponseCompressionEnabled = true;
}

void OAIDirectDepositApi::abortRequests() {
    Q_EMIT abortRequestsSignal();
}

QString OAIDirectDepositApi::getParamStylePrefix(const QString &style) {
    if (style == "matrix") {
        return ";";
    } else if (style == "label") {
        return ".";
...
QString OAIDirectDepositApi::getParamStyleSuffix(const QString &style) {
    if (style == "matrix") {
        return "=";
    } else if (style == "label") {
        return "";
...
QString OAIDirectDepositApi::getParamStyleDelimiter(const QString &style, const QString &name, bool isExplode) {
...
void OAIDirectDepositApi::get_All_Direct_Deposit(const QString &company_id, const QString &employee_id) {
    QString fullPath = QString(_serverConfigs["get_All_Direct_Deposit"][_serverIndices.value("get_All_Direct_Deposit")].URL()+"/v2/companies/{companyId}/employees/{employeeId}/directDeposit");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDirectDepositApi::get_All_Direct_DepositCallback);
    connect(this, &OAIDirectDepositApi::abortRequestsSignal, worker, &QObject::deleteLater);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDirectDepositApi::get_All_Direct_DepositCallback);
    connect(this, &OAIDirectDepositApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
...
void OAIDirectDepositApi::get_All_Direct_DepositCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAIDirectDeposit> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAIDirectDeposit val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_All_Direct_DepositSignal(output);
        Q_EMIT get_All_Direct_DepositSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_All_Direct_DepositSignalE(output, error_type, error_str);
        Q_EMIT get_All_Direct_DepositSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_All_Direct_DepositSignalError(output, error_type, error_str);
        Q_EMIT get_All_Direct_DepositSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDirectDepositApi::tokenAvailable(){
