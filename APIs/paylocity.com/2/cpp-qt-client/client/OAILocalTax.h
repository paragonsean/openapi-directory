...
#ifndef OAILocalTax_H
#define OAILocalTax_H
...
class OAILocalTax : public OAIObject {
public:
    OAILocalTax();
    OAILocalTax(QString json);
    ~OAILocalTax() override;
    ...
    QString getResidentPsd() const;
    void setResidentPsd(const QString &resident_psd);
    bool is_resident_psd_Set() const;
    bool is_resident_psd_Valid() const;
    ...
    QString getWorkPsd() const;
    void setWorkPsd(const QString &work_psd);
    bool is_work_psd_Set() const;
    bool is_work_psd_Valid() const;
...
private:
    ...
    QString m_resident_psd;
    bool m_resident_psd_isSet;
    bool m_resident_psd_isValid;
    ...
    QString m_work_psd;
    bool m_work_psd_isSet;
    bool m_work_psd_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILocalTax)
