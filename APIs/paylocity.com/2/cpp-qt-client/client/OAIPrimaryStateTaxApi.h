...
#ifndef OAI_OAIPrimaryStateTaxApi_H
#define OAI_OAIPrimaryStateTaxApi_H
...
class OAIPrimaryStateTaxApi : public QObject {
    Q_OBJECT

public:
    OAIPrimaryStateTaxApi(const int timeOut = 0);
    ~OAIPrimaryStateTaxApi();
    ...
    * @param[in]  oai_state_tax OAIStateTax [required]
    */
    virtual void add_or_update_primary_state_tax(const QString &company_id, const QString &employee_id, const OAIStateTax &oai_state_tax);
...
private:
    ...
    void add_or_update_primary_state_taxCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void add_or_update_primary_state_taxSignal();


    void add_or_update_primary_state_taxSignalFull(OAIHttpRequestWorker *worker);

    Q_DECL_DEPRECATED_X("Use add_or_update_primary_state_taxSignalError() instead")
    void add_or_update_primary_state_taxSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_primary_state_taxSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);

    Q_DECL_DEPRECATED_X("Use add_or_update_primary_state_taxSignalErrorFull() instead")
    void add_or_update_primary_state_taxSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void add_or_update_primary_state_taxSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
