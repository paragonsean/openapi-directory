...
/*
 * OAIEmployee_customTextFields_inner.h
 *
 * 
 */

#ifndef OAIEmployee_customTextFields_inner_H
#define OAIEmployee_customTextFields_inner_H
...
class OAIEmployee_customTextFields_inner : public OAIObject {
public:
    OAIEmployee_customTextFields_inner();
    OAIEmployee_customTextFields_inner(QString json);
    ~OAIEmployee_customTextFields_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmployee_customTextFields_inner)

#endif // OAIEmployee_customTextFields_inner_H
