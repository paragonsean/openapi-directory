...
/*
 * OAIStagedEmployee_mainDirectDeposit_inner.h
 *
 * The Main Direct Deposit model
 */

#ifndef OAIStagedEmployee_mainDirectDeposit_inner_H
#define OAIStagedEmployee_mainDirectDeposit_inner_H
...
class OAIStagedEmployee_mainDirectDeposit_inner : public OAIObject {
public:
    OAIStagedEmployee_mainDirectDeposit_inner();
    OAIStagedEmployee_mainDirectDeposit_inner(QString json);
    ~OAIStagedEmployee_mainDirectDeposit_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStagedEmployee_mainDirectDeposit_inner)

#endif // OAIStagedEmployee_mainDirectDeposit_inner_H
