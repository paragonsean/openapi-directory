...
/*
 * OAINonPrimaryStateTax.h
 *
 * The Non-Primary State Tax model
 */

#ifndef OAINonPrimaryStateTax_H
#define OAINonPrimaryStateTax_H
...
class OAINonPrimaryStateTax : public OAIObject {
public:
    OAINonPrimaryStateTax();
    OAINonPrimaryStateTax(QString json);
    ~OAINonPrimaryStateTax() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINonPrimaryStateTax)

#endif // OAINonPrimaryStateTax_H
