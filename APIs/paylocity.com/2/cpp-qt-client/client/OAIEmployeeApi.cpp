...
void OAIEmployeeApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("add_employee", defaultConf);
    _serverIndices.insert("add_employee", 0);
    _serverConfigs.insert("get_all_employees", defaultConf);
    _serverIndices.insert("get_all_employees", 0);
    _serverConfigs.insert("get_employee", defaultConf);
    _serverIndices.insert("get_employee", 0);
    _serverConfigs.insert("update_employee", defaultConf);
    _serverIndices.insert("update_employee", 0);
}
...
void OAIEmployeeApi::add_employee(const QString &company_id, const OAIEmployee &oai_employee) {
    QString fullPath = QString(_serverConfigs["add_employee"][_serverIndices.value("add_employee")].URL()+"/v2/companies/{companyId}/employees");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::add_employeeCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::add_employeeCallback);
...
void OAIEmployeeApi::add_employeeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIEmployeeIdResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT add_employeeSignal(output);
        Q_EMIT add_employeeSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT add_employeeSignalE(output, error_type, error_str);
        Q_EMIT add_employeeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT add_employeeSignalError(output, error_type, error_str);
        Q_EMIT add_employeeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeApi::get_all_employees(const QString &company_id, const ::OpenAPI::OptionalParam<qint32> &pagesize, const ::OpenAPI::OptionalParam<qint32> &pagenumber, const ::OpenAPI::OptionalParam<bool> &includetotalcount) {
    QString fullPath = QString(_serverConfigs["get_all_employees"][_serverIndices.value("get_all_employees")].URL()+"/v2/companies/{companyId}/employees/");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::get_all_employeesCallback);
    connect(this, &OAIEmployeeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::get_all_employeesCallback);
    connect(this, &OAIEmployeeApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeApi::get_all_employeesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_all_employeesSignal(output);
        Q_EMIT get_all_employeesSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_all_employeesSignalE(output, error_type, error_str);
        Q_EMIT get_all_employeesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_all_employeesSignalError(output, error_type, error_str);
        Q_EMIT get_all_employeesSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeApi::get_employee(const QString &company_id, const QString &employee_id) {
    QString fullPath = QString(_serverConfigs["get_employee"][_serverIndices.value("get_employee")].URL()+"/v2/companies/{companyId}/employees/{employeeId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::get_employeeCallback);
    connect(this, &OAIEmployeeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::get_employeeCallback);
    connect(this, &OAIEmployeeApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeApi::get_employeeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT get_employeeSignal(output);
        Q_EMIT get_employeeSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT get_employeeSignalE(output, error_type, error_str);
        Q_EMIT get_employeeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT get_employeeSignalError(output, error_type, error_str);
        Q_EMIT get_employeeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIEmployeeApi::update_employee(const QString &company_id, const QString &employee_id, const OAIEmployee &oai_employee) {
    QString fullPath = QString(_serverConfigs["update_employee"][_serverIndices.value("update_employee")].URL()+"/v2/companies/{companyId}/employees/{employeeId}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::update_employeeCallback);
    connect(this, &OAIEmployeeApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIEmployeeApi::update_employeeCallback);
    connect(this, &OAIEmployeeApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIEmployeeApi::update_employeeCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT update_employeeSignal();
        Q_EMIT update_employeeSignalFull(worker);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT update_employeeSignalE(error_type, error_str);
        Q_EMIT update_employeeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT update_employeeSignalError(error_type, error_str);
        Q_EMIT update_employeeSignalErrorFull(worker, error_type, error_str);
    }
}
