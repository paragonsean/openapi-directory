...
|------------ | ------------- | ------------- | -------------|
|**fitwExemptNotes** | **String** | Notes for FITW exemption.&lt;br  /&gt; Max length: 250 |  [optional] |
...
|**futaExemptNotes** | **String** | Notes for FUTA exemption.&lt;br  /&gt; Max length: 250 |  [optional] |
...
|**isPension** | **Boolean** | Indicates if employee is eligible for pension. |  [optional] |
|**isStatutory** | **Boolean** | Indicates if employee is statutory. |  [optional] |
|**medExemptNotes** | **String** | Notes for Medicare exemption.&lt;br  /&gt; Max length: 250 |  [optional] |
...
|**sitwExemptNotes** | **String** | Notes for SITW exemption.&lt;br  /&gt; Max length: 250 |  [optional] |
...
|**ssExemptNotes** | **String** | Notes for Social Security exemption.&lt;br  /&gt; Max length: 250 |  [optional] |
...
|**suiExemptNotes** | **String** | Notes for SUI exemption.&lt;br  /&gt; Max length: 250 |  [optional] |
