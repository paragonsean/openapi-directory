...
|------------ | ------------- | ------------- | -------------|
|**baseRate** | **BigDecimal** | Employee base rate, used for Hourly employees. &lt;br  /&gt;Decimal (12,2) |  [optional] |
|**changeReason** | **String** | Pay rate change reason.&lt;br  /&gt; Max length: 30 |  [optional] |
|**defaultHours** | **BigDecimal** | Employee default hours consistently worked. If autoPayType is set to D, employee will be paid hourly base rate for the defaultHours. &lt;br  /&gt;Decimal (12,2) |  [optional] |
...
|**salary** | **BigDecimal** | Employee gross salary per pay period used with payType Salary.&lt;br  /&gt;Decimal (12,6) |  [optional] |
