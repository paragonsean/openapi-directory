...
import org.openapitools.client.model.NonPrimaryStateTax;
...
public class NonPrimaryStateTaxApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public NonPrimaryStateTaxApi() {
        this(Configuration.getDefaultApiClient());
    }

    public NonPrimaryStateTaxApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addOrUpdateNonPrimaryStateTax
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param nonPrimaryStateTax Non-Primary State Tax Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateNonPrimaryStateTaxCall(String companyId, String employeeId, NonPrimaryStateTax nonPrimaryStateTax, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = nonPrimaryStateTax;
    ...
    private okhttp3.Call addOrUpdateNonPrimaryStateTaxValidateBeforeCall(String companyId, String employeeId, NonPrimaryStateTax nonPrimaryStateTax, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addOrUpdateNonPrimaryStateTax(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling addOrUpdateNonPrimaryStateTax(Async)");
        }

        // verify the required parameter 'nonPrimaryStateTax' is set
        if (nonPrimaryStateTax == null) {
            throw new ApiException("Missing the required parameter 'nonPrimaryStateTax' when calling addOrUpdateNonPrimaryStateTax(Async)");
        }

        return addOrUpdateNonPrimaryStateTaxCall(companyId, employeeId, nonPrimaryStateTax, _callback);
     ...
     */
    public void addOrUpdateNonPrimaryStateTax(String companyId, String employeeId, NonPrimaryStateTax nonPrimaryStateTax) throws ApiException {
        addOrUpdateNonPrimaryStateTaxWithHttpInfo(companyId, employeeId, nonPrimaryStateTax);
    }
     ...
     */
    public ApiResponse<Void> addOrUpdateNonPrimaryStateTaxWithHttpInfo(String companyId, String employeeId, NonPrimaryStateTax nonPrimaryStateTax) throws ApiException {
        okhttp3.Call localVarCall = addOrUpdateNonPrimaryStateTaxValidateBeforeCall(companyId, employeeId, nonPrimaryStateTax, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add/update non-primary state tax (asynchronously)
     * Sends new or updated employee non-primary state tax information directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param nonPrimaryStateTax Non-Primary State Tax Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateNonPrimaryStateTaxAsync(String companyId, String employeeId, NonPrimaryStateTax nonPrimaryStateTax, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addOrUpdateNonPrimaryStateTaxValidateBeforeCall(companyId, employeeId, nonPrimaryStateTax, _callback);
