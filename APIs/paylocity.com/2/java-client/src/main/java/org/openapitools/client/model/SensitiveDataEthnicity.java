...
import org.openapitools.client.model.SensitiveDataEthnicityEthnicRacialIdentitiesInner;
...
public class SensitiveDataEthnicity {
  public static final String SERIALIZED_NAME_ETHNIC_RACIAL_IDENTITIES = "ethnicRacialIdentities";
  @SerializedName(SERIALIZED_NAME_ETHNIC_RACIAL_IDENTITIES)
  private List<SensitiveDataEthnicityEthnicRacialIdentitiesInner> ethnicRacialIdentities = new ArrayList<>();
  ...
  public SensitiveDataEthnicity ethnicRacialIdentities(List<SensitiveDataEthnicityEthnicRacialIdentitiesInner> ethnicRacialIdentities) {
    this.ethnicRacialIdentities = ethnicRacialIdentities;
    return this;
  }

  public SensitiveDataEthnicity addEthnicRacialIdentitiesItem(SensitiveDataEthnicityEthnicRacialIdentitiesInner ethnicRacialIdentitiesItem) {
    if (this.ethnicRacialIdentities == null) {
      this.ethnicRacialIdentities = new ArrayList<>();
    }
    this.ethnicRacialIdentities.add(ethnicRacialIdentitiesItem);
    return this;
  }

  /**
   * Add or update Ethnic Racial Identity
   * @return ethnicRacialIdentities
   */
  @javax.annotation.Nullable
  public List<SensitiveDataEthnicityEthnicRacialIdentitiesInner> getEthnicRacialIdentities() {
    return ethnicRacialIdentities;
  }

  public void setEthnicRacialIdentities(List<SensitiveDataEthnicityEthnicRacialIdentitiesInner> ethnicRacialIdentities) {
    this.ethnicRacialIdentities = ethnicRacialIdentities;
  }


  public SensitiveDataEthnicity ethnicity(String ethnicity) {
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataEthnicity sensitiveDataEthnicity = (SensitiveDataEthnicity) o;
    return Objects.equals(this.ethnicRacialIdentities, sensitiveDataEthnicity.ethnicRacialIdentities) &&
        Objects.equals(this.ethnicity, sensitiveDataEthnicity.ethnicity);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ethnicRacialIdentities, ethnicity);
  }
  ...
  public String toString() {
    ...
    sb.append("class SensitiveDataEthnicity {\n");
    sb.append("    ethnicRacialIdentities: ").append(toIndentedString(ethnicRacialIdentities)).append("\n");
  ...
  static {
    ...
    openapiFields.add("ethnicRacialIdentities");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SensitiveDataEthnicity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitiveDataEthnicity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SensitiveDataEthnicity is not found in the empty JSON string", SensitiveDataEthnicity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitiveDataEthnicity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SensitiveDataEthnicity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("ethnicRacialIdentities") != null && !jsonObj.get("ethnicRacialIdentities").isJsonNull()) {
        JsonArray jsonArrayethnicRacialIdentities = jsonObj.getAsJsonArray("ethnicRacialIdentities");
        if (jsonArrayethnicRacialIdentities != null) {
          // ensure the json data is an array
          if (!jsonObj.get("ethnicRacialIdentities").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `ethnicRacialIdentities` to be an array in the JSON string but got `%s`", jsonObj.get("ethnicRacialIdentities").toString()));
          }

          // validate the optional field `ethnicRacialIdentities` (array)
          for (int i = 0; i < jsonArrayethnicRacialIdentities.size(); i++) {
            SensitiveDataEthnicityEthnicRacialIdentitiesInner.validateJsonElement(jsonArrayethnicRacialIdentities.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SensitiveDataEthnicity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SensitiveDataEthnicity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SensitiveDataEthnicity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SensitiveDataEthnicity.class));

       return (TypeAdapter<T>) new TypeAdapter<SensitiveDataEthnicity>() {
           @Override
           public void write(JsonWriter out, SensitiveDataEthnicity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SensitiveDataEthnicity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SensitiveDataEthnicity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SensitiveDataEthnicity
   * @throws IOException if the JSON string is invalid with respect to SensitiveDataEthnicity
   */
  public static SensitiveDataEthnicity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SensitiveDataEthnicity.class);
  }

  /**
   * Convert an instance of SensitiveDataEthnicity to an JSON string
   *
   * @return JSON string
   */
