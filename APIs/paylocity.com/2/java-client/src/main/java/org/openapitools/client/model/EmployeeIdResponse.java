...
public class EmployeeIdResponse {
  ...
  public EmployeeIdResponse employeeId(String employeeId) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeIdResponse employeeIdResponse = (EmployeeIdResponse) o;
    return Objects.equals(this.employeeId, employeeIdResponse.employeeId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeIdResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeIdResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeIdResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeIdResponse is not found in the empty JSON string", EmployeeIdResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeIdResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeIdResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeIdResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeIdResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeIdResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeIdResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeIdResponse>() {
           @Override
           public void write(JsonWriter out, EmployeeIdResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeIdResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeIdResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeIdResponse
   * @throws IOException if the JSON string is invalid with respect to EmployeeIdResponse
   */
  public static EmployeeIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeIdResponse.class);
  }

  /**
   * Convert an instance of EmployeeIdResponse to an JSON string
   *
   * @return JSON string
   */
