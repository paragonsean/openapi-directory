...
public class EmployeeNonPrimaryStateTax {
  ...
  public EmployeeNonPrimaryStateTax amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public EmployeeNonPrimaryStateTax deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public EmployeeNonPrimaryStateTax dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public EmployeeNonPrimaryStateTax exemptions(BigDecimal exemptions) {
  ...
  public EmployeeNonPrimaryStateTax exemptions2(BigDecimal exemptions2) {
  ...
  public EmployeeNonPrimaryStateTax filingStatus(String filingStatus) {
  ...
  public EmployeeNonPrimaryStateTax higherRate(Boolean higherRate) {
  ...
  public EmployeeNonPrimaryStateTax otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public EmployeeNonPrimaryStateTax percentage(BigDecimal percentage) {
  ...
  public EmployeeNonPrimaryStateTax reciprocityCode(String reciprocityCode) {
  ...
  public EmployeeNonPrimaryStateTax specialCheckCalc(String specialCheckCalc) {
  ...
  public EmployeeNonPrimaryStateTax taxCalculationCode(String taxCalculationCode) {
  ...
  public EmployeeNonPrimaryStateTax taxCode(String taxCode) {
  ...
  public EmployeeNonPrimaryStateTax w4FormYear(Integer w4FormYear) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeNonPrimaryStateTax employeeNonPrimaryStateTax = (EmployeeNonPrimaryStateTax) o;
    return Objects.equals(this.amount, employeeNonPrimaryStateTax.amount) &&
        Objects.equals(this.deductionsAmount, employeeNonPrimaryStateTax.deductionsAmount) &&
        Objects.equals(this.dependentsAmount, employeeNonPrimaryStateTax.dependentsAmount) &&
        Objects.equals(this.exemptions, employeeNonPrimaryStateTax.exemptions) &&
        Objects.equals(this.exemptions2, employeeNonPrimaryStateTax.exemptions2) &&
        Objects.equals(this.filingStatus, employeeNonPrimaryStateTax.filingStatus) &&
        Objects.equals(this.higherRate, employeeNonPrimaryStateTax.higherRate) &&
        Objects.equals(this.otherIncomeAmount, employeeNonPrimaryStateTax.otherIncomeAmount) &&
        Objects.equals(this.percentage, employeeNonPrimaryStateTax.percentage) &&
        Objects.equals(this.reciprocityCode, employeeNonPrimaryStateTax.reciprocityCode) &&
        Objects.equals(this.specialCheckCalc, employeeNonPrimaryStateTax.specialCheckCalc) &&
        Objects.equals(this.taxCalculationCode, employeeNonPrimaryStateTax.taxCalculationCode) &&
        Objects.equals(this.taxCode, employeeNonPrimaryStateTax.taxCode) &&
        Objects.equals(this.w4FormYear, employeeNonPrimaryStateTax.w4FormYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeNonPrimaryStateTax {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeNonPrimaryStateTax
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeNonPrimaryStateTax.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeNonPrimaryStateTax is not found in the empty JSON string", EmployeeNonPrimaryStateTax.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeNonPrimaryStateTax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeNonPrimaryStateTax` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeNonPrimaryStateTax.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeNonPrimaryStateTax' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeNonPrimaryStateTax> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeNonPrimaryStateTax.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeNonPrimaryStateTax>() {
           @Override
           public void write(JsonWriter out, EmployeeNonPrimaryStateTax value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeNonPrimaryStateTax read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeNonPrimaryStateTax given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeNonPrimaryStateTax
   * @throws IOException if the JSON string is invalid with respect to EmployeeNonPrimaryStateTax
   */
  public static EmployeeNonPrimaryStateTax fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeNonPrimaryStateTax.class);
  }

  /**
   * Convert an instance of EmployeeNonPrimaryStateTax to an JSON string
   *
   * @return JSON string
   */
