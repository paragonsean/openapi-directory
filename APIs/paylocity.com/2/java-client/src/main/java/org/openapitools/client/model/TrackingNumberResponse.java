...
public class TrackingNumberResponse {
  ...
  public TrackingNumberResponse trackingNumber(String trackingNumber) {
  ...
  public boolean equals(Object o) {
    ...
    TrackingNumberResponse trackingNumberResponse = (TrackingNumberResponse) o;
    return Objects.equals(this.trackingNumber, trackingNumberResponse.trackingNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrackingNumberResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackingNumberResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackingNumberResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackingNumberResponse is not found in the empty JSON string", TrackingNumberResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackingNumberResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackingNumberResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackingNumberResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackingNumberResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackingNumberResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackingNumberResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackingNumberResponse>() {
           @Override
           public void write(JsonWriter out, TrackingNumberResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackingNumberResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrackingNumberResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrackingNumberResponse
   * @throws IOException if the JSON string is invalid with respect to TrackingNumberResponse
   */
  public static TrackingNumberResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackingNumberResponse.class);
  }

  /**
   * Convert an instance of TrackingNumberResponse to an JSON string
   *
   * @return JSON string
   */
