...
public class DirectDepositMainDirectDeposit {
  ...
  public DirectDepositMainDirectDeposit accountNumber(String accountNumber) {
  ...
  public DirectDepositMainDirectDeposit accountType(String accountType) {
  ...
  public DirectDepositMainDirectDeposit blockSpecial(Boolean blockSpecial) {
  ...
  public DirectDepositMainDirectDeposit isSkipPreNote(Boolean isSkipPreNote) {
  ...
  public DirectDepositMainDirectDeposit nameOnAccount(String nameOnAccount) {
  ...
  public DirectDepositMainDirectDeposit preNoteDate(String preNoteDate) {
  ...
  public DirectDepositMainDirectDeposit routingNumber(String routingNumber) {
  ...
  public boolean equals(Object o) {
    ...
    DirectDepositMainDirectDeposit directDepositMainDirectDeposit = (DirectDepositMainDirectDeposit) o;
    return Objects.equals(this.accountNumber, directDepositMainDirectDeposit.accountNumber) &&
        Objects.equals(this.accountType, directDepositMainDirectDeposit.accountType) &&
        Objects.equals(this.blockSpecial, directDepositMainDirectDeposit.blockSpecial) &&
        Objects.equals(this.isSkipPreNote, directDepositMainDirectDeposit.isSkipPreNote) &&
        Objects.equals(this.nameOnAccount, directDepositMainDirectDeposit.nameOnAccount) &&
        Objects.equals(this.preNoteDate, directDepositMainDirectDeposit.preNoteDate) &&
        Objects.equals(this.routingNumber, directDepositMainDirectDeposit.routingNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectDepositMainDirectDeposit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DirectDepositMainDirectDeposit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DirectDepositMainDirectDeposit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectDepositMainDirectDeposit is not found in the empty JSON string", DirectDepositMainDirectDeposit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DirectDepositMainDirectDeposit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DirectDepositMainDirectDeposit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectDepositMainDirectDeposit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectDepositMainDirectDeposit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectDepositMainDirectDeposit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectDepositMainDirectDeposit.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectDepositMainDirectDeposit>() {
           @Override
           public void write(JsonWriter out, DirectDepositMainDirectDeposit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DirectDepositMainDirectDeposit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DirectDepositMainDirectDeposit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DirectDepositMainDirectDeposit
   * @throws IOException if the JSON string is invalid with respect to DirectDepositMainDirectDeposit
   */
  public static DirectDepositMainDirectDeposit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectDepositMainDirectDeposit.class);
  }

  /**
   * Convert an instance of DirectDepositMainDirectDeposit to an JSON string
   *
   * @return JSON string
   */
