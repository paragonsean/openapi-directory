...
public class StagedEmployeeBenefitSetupInner {
  ...
  public StagedEmployeeBenefitSetupInner() {
  }

  public StagedEmployeeBenefitSetupInner benefitClass(String benefitClass) {
  ...
  public StagedEmployeeBenefitSetupInner benefitClassEffectiveDate(String benefitClassEffectiveDate) {
  ...
  public StagedEmployeeBenefitSetupInner benefitSalary(BigDecimal benefitSalary) {
  ...
  public StagedEmployeeBenefitSetupInner benefitSalaryEffectiveDate(String benefitSalaryEffectiveDate) {
  ...
  public StagedEmployeeBenefitSetupInner doNotApplyAdministrativePeriod(Boolean doNotApplyAdministrativePeriod) {
  ...
  public StagedEmployeeBenefitSetupInner isMeasureAcaEligibility(Boolean isMeasureAcaEligibility) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeBenefitSetupInner stagedEmployeeBenefitSetupInner = (StagedEmployeeBenefitSetupInner) o;
    return Objects.equals(this.benefitClass, stagedEmployeeBenefitSetupInner.benefitClass) &&
        Objects.equals(this.benefitClassEffectiveDate, stagedEmployeeBenefitSetupInner.benefitClassEffectiveDate) &&
        Objects.equals(this.benefitSalary, stagedEmployeeBenefitSetupInner.benefitSalary) &&
        Objects.equals(this.benefitSalaryEffectiveDate, stagedEmployeeBenefitSetupInner.benefitSalaryEffectiveDate) &&
        Objects.equals(this.doNotApplyAdministrativePeriod, stagedEmployeeBenefitSetupInner.doNotApplyAdministrativePeriod) &&
        Objects.equals(this.isMeasureAcaEligibility, stagedEmployeeBenefitSetupInner.isMeasureAcaEligibility);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeBenefitSetupInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeBenefitSetupInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeBenefitSetupInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeBenefitSetupInner is not found in the empty JSON string", StagedEmployeeBenefitSetupInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeBenefitSetupInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeBenefitSetupInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeBenefitSetupInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeBenefitSetupInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeBenefitSetupInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeBenefitSetupInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeBenefitSetupInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeBenefitSetupInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeBenefitSetupInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeBenefitSetupInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeBenefitSetupInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeBenefitSetupInner
   */
  public static StagedEmployeeBenefitSetupInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeBenefitSetupInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeBenefitSetupInner to an JSON string
   *
   * @return JSON string
   */
