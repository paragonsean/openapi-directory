...
public class EmployeeCustomDropDownFieldsInner {
  /**
  ...
  public EmployeeCustomDropDownFieldsInner() {
  }

  public EmployeeCustomDropDownFieldsInner category(CategoryEnum category) {
  ...
  public EmployeeCustomDropDownFieldsInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EmployeeCustomDropDownFieldsInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeCustomDropDownFieldsInner employeeCustomDropDownFieldsInner = (EmployeeCustomDropDownFieldsInner) o;
    return Objects.equals(this.category, employeeCustomDropDownFieldsInner.category) &&
        Objects.equals(this.label, employeeCustomDropDownFieldsInner.label) &&
        Objects.equals(this.value, employeeCustomDropDownFieldsInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeCustomDropDownFieldsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeCustomDropDownFieldsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeCustomDropDownFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeCustomDropDownFieldsInner is not found in the empty JSON string", EmployeeCustomDropDownFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeCustomDropDownFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeCustomDropDownFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeCustomDropDownFieldsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeCustomDropDownFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeCustomDropDownFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeCustomDropDownFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeCustomDropDownFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeCustomDropDownFieldsInner>() {
           @Override
           public void write(JsonWriter out, EmployeeCustomDropDownFieldsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeCustomDropDownFieldsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeCustomDropDownFieldsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeCustomDropDownFieldsInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeCustomDropDownFieldsInner
   */
  public static EmployeeCustomDropDownFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeCustomDropDownFieldsInner.class);
  }

  /**
   * Convert an instance of EmployeeCustomDropDownFieldsInner to an JSON string
   *
   * @return JSON string
   */
