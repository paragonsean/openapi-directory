...
public class SensitiveDataApi {
    ...
    public SensitiveDataApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SensitiveDataApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addOrUpdateSensitiveData
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param sensitiveData Sensitive Data Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateSensitiveDataCall(String companyId, String employeeId, SensitiveData sensitiveData, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = sensitiveData;
    ...
    private okhttp3.Call addOrUpdateSensitiveDataValidateBeforeCall(String companyId, String employeeId, SensitiveData sensitiveData, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addOrUpdateSensitiveData(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling addOrUpdateSensitiveData(Async)");
        }

        // verify the required parameter 'sensitiveData' is set
        if (sensitiveData == null) {
            throw new ApiException("Missing the required parameter 'sensitiveData' when calling addOrUpdateSensitiveData(Async)");
        }

        return addOrUpdateSensitiveDataCall(companyId, employeeId, sensitiveData, _callback);
     ...
     */
    public void addOrUpdateSensitiveData(String companyId, String employeeId, SensitiveData sensitiveData) throws ApiException {
        addOrUpdateSensitiveDataWithHttpInfo(companyId, employeeId, sensitiveData);
    }
     ...
     */
    public ApiResponse<Void> addOrUpdateSensitiveDataWithHttpInfo(String companyId, String employeeId, SensitiveData sensitiveData) throws ApiException {
        okhttp3.Call localVarCall = addOrUpdateSensitiveDataValidateBeforeCall(companyId, employeeId, sensitiveData, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add/update sensitive data (asynchronously)
     * Sends new or updated employee sensitive data information directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param sensitiveData Sensitive Data Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateSensitiveDataAsync(String companyId, String employeeId, SensitiveData sensitiveData, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addOrUpdateSensitiveDataValidateBeforeCall(companyId, employeeId, sensitiveData, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSensitiveData
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getSensitiveDataCall(String companyId, String employeeId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSensitiveDataValidateBeforeCall(String companyId, String employeeId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getSensitiveData(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling getSensitiveData(Async)");
        }

        return getSensitiveDataCall(companyId, employeeId, _callback);
     ...
     */
    public List<SensitiveData> getSensitiveData(String companyId, String employeeId) throws ApiException {
        ApiResponse<List<SensitiveData>> localVarResp = getSensitiveDataWithHttpInfo(companyId, employeeId);
     ...
     */
    public ApiResponse<List<SensitiveData>> getSensitiveDataWithHttpInfo(String companyId, String employeeId) throws ApiException {
        okhttp3.Call localVarCall = getSensitiveDataValidateBeforeCall(companyId, employeeId, null);
        Type localVarReturnType = new TypeToken<List<SensitiveData>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get sensitive data (asynchronously)
     * Gets employee sensitive data information directly from Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getSensitiveDataAsync(String companyId, String employeeId, final ApiCallback<List<SensitiveData>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSensitiveDataValidateBeforeCall(companyId, employeeId, _callback);
        Type localVarReturnType = new TypeToken<List<SensitiveData>>(){}.getType();
