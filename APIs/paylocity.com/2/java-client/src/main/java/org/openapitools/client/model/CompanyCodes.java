...
public class CompanyCodes {
  ...
  public CompanyCodes code(String code) {
    this.code = code;
    return this;
  }
  ...
  public CompanyCodes description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, companyCodes.code) &&
        Objects.equals(this.description, companyCodes.description);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanyCodes
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyCodes.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyCodes.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyCodes` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
