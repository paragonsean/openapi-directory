...
public class CompanySpecificSchemaApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CompanySpecificSchemaApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CompanySpecificSchemaApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getCompanySpecificOpenAPIDocumentation
     * @param authorization Bearer + JWT (required)
     ...
     */
    public okhttp3.Call getCompanySpecificOpenAPIDocumentationCall(String authorization, String companyId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getCompanySpecificOpenAPIDocumentationValidateBeforeCall(String authorization, String companyId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling getCompanySpecificOpenAPIDocumentation(Async)");
        }

        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getCompanySpecificOpenAPIDocumentation(Async)");
        }

        return getCompanySpecificOpenAPIDocumentationCall(authorization, companyId, _callback);
     ...
     */
    public void getCompanySpecificOpenAPIDocumentation(String authorization, String companyId) throws ApiException {
        getCompanySpecificOpenAPIDocumentationWithHttpInfo(authorization, companyId);
    }
     ...
     */
    public ApiResponse<Void> getCompanySpecificOpenAPIDocumentationWithHttpInfo(String authorization, String companyId) throws ApiException {
        okhttp3.Call localVarCall = getCompanySpecificOpenAPIDocumentationValidateBeforeCall(authorization, companyId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get Company-Specific Open API Documentation (asynchronously)
     * The company-specific Open API endpoint allows the client to GET an Open API document for the Paylocity API that is customized with company-specific resource schemas. These customized resource schemas define certain properties as enumerations of pre-defined values that correspond to the company&#39;s setup with Web Pay. The customized schemas also indicate which properties are required by the company within Web Pay.&lt;br  /&gt;To learn more about Open API, click [here](https://www.openapis.org/)
     * @param authorization Bearer + JWT (required)
     * @param companyId Company Id (required)
     ...
     */
    public okhttp3.Call getCompanySpecificOpenAPIDocumentationAsync(String authorization, String companyId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompanySpecificOpenAPIDocumentationValidateBeforeCall(authorization, companyId, _callback);
