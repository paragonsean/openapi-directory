...
import org.openapitools.client.model.AddClientSecret;
import org.openapitools.client.model.ClientCredentialsResponse;
...
public class ClientCredentialsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ClientCredentialsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ClientCredentialsApi(ApiClient apiClient) {
     ...
     * @param addClientSecret Add Client Secret Model (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successfully added </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call addClientSecretCall(AddClientSecret addClientSecret, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = addClientSecret;

        // create path and map variables
        String localVarPath = "/v2/credentials/secrets";
    ...
    private okhttp3.Call addClientSecretValidateBeforeCall(AddClientSecret addClientSecret, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'addClientSecret' is set
        if (addClientSecret == null) {
            throw new ApiException("Missing the required parameter 'addClientSecret' when calling addClientSecret(Async)");
        }

        return addClientSecretCall(addClientSecret, _callback);
     ...
     * @param addClientSecret Add Client Secret Model (required)
     * @return List&lt;ClientCredentialsResponse&gt;
     ...
     */
    public List<ClientCredentialsResponse> addClientSecret(AddClientSecret addClientSecret) throws ApiException {
        ApiResponse<List<ClientCredentialsResponse>> localVarResp = addClientSecretWithHttpInfo(addClientSecret);
     ...
     * Obtain new client secret for Paylocity-issued client id. See Setup section for details.
     * @param addClientSecret Add Client Secret Model (required)
     * @return ApiResponse&lt;List&lt;ClientCredentialsResponse&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ClientCredentialsResponse>> addClientSecretWithHttpInfo(AddClientSecret addClientSecret) throws ApiException {
        okhttp3.Call localVarCall = addClientSecretValidateBeforeCall(addClientSecret, null);
        Type localVarReturnType = new TypeToken<List<ClientCredentialsResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Obtain new client secret. (asynchronously)
     * Obtain new client secret for Paylocity-issued client id. See Setup section for details.
     * @param addClientSecret Add Client Secret Model (required)
     ...
     */
    public okhttp3.Call addClientSecretAsync(AddClientSecret addClientSecret, final ApiCallback<List<ClientCredentialsResponse>> _callback) throws ApiException {

        okhttp3.Call localVarCall = addClientSecretValidateBeforeCall(addClientSecret, _callback);
        Type localVarReturnType = new TypeToken<List<ClientCredentialsResponse>>(){}.getType();
