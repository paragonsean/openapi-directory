...
public class EmployeeEmergencyContactsInner {
  ...
  public EmployeeEmergencyContactsInner() {
  }

  public EmployeeEmergencyContactsInner address1(String address1) {
  ...
  public EmployeeEmergencyContactsInner address2(String address2) {
  ...
  public EmployeeEmergencyContactsInner city(String city) {
    this.city = city;
    return this;
  }
  ...
  public EmployeeEmergencyContactsInner country(String country) {
  ...
  public EmployeeEmergencyContactsInner county(String county) {
    this.county = county;
    return this;
  }
  ...
  public EmployeeEmergencyContactsInner email(String email) {
    this.email = email;
    return this;
  }
  ...
  public EmployeeEmergencyContactsInner firstName(String firstName) {
  ...
  public EmployeeEmergencyContactsInner homePhone(String homePhone) {
  ...
  public EmployeeEmergencyContactsInner lastName(String lastName) {
  ...
  public EmployeeEmergencyContactsInner mobilePhone(String mobilePhone) {
  ...
  public EmployeeEmergencyContactsInner notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public EmployeeEmergencyContactsInner pager(String pager) {
    this.pager = pager;
    return this;
  }
  ...
  public EmployeeEmergencyContactsInner primaryPhone(String primaryPhone) {
  ...
  public EmployeeEmergencyContactsInner priority(String priority) {
  ...
  public EmployeeEmergencyContactsInner relationship(String relationship) {
  ...
  public EmployeeEmergencyContactsInner state(String state) {
    this.state = state;
    return this;
  }
  ...
  public EmployeeEmergencyContactsInner syncEmployeeInfo(Boolean syncEmployeeInfo) {
  ...
  public EmployeeEmergencyContactsInner workExtension(String workExtension) {
  ...
  public EmployeeEmergencyContactsInner workPhone(String workPhone) {
  ...
  public EmployeeEmergencyContactsInner zip(String zip) {
    this.zip = zip;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeEmergencyContactsInner employeeEmergencyContactsInner = (EmployeeEmergencyContactsInner) o;
    return Objects.equals(this.address1, employeeEmergencyContactsInner.address1) &&
        Objects.equals(this.address2, employeeEmergencyContactsInner.address2) &&
        Objects.equals(this.city, employeeEmergencyContactsInner.city) &&
        Objects.equals(this.country, employeeEmergencyContactsInner.country) &&
        Objects.equals(this.county, employeeEmergencyContactsInner.county) &&
        Objects.equals(this.email, employeeEmergencyContactsInner.email) &&
        Objects.equals(this.firstName, employeeEmergencyContactsInner.firstName) &&
        Objects.equals(this.homePhone, employeeEmergencyContactsInner.homePhone) &&
        Objects.equals(this.lastName, employeeEmergencyContactsInner.lastName) &&
        Objects.equals(this.mobilePhone, employeeEmergencyContactsInner.mobilePhone) &&
        Objects.equals(this.notes, employeeEmergencyContactsInner.notes) &&
        Objects.equals(this.pager, employeeEmergencyContactsInner.pager) &&
        Objects.equals(this.primaryPhone, employeeEmergencyContactsInner.primaryPhone) &&
        Objects.equals(this.priority, employeeEmergencyContactsInner.priority) &&
        Objects.equals(this.relationship, employeeEmergencyContactsInner.relationship) &&
        Objects.equals(this.state, employeeEmergencyContactsInner.state) &&
        Objects.equals(this.syncEmployeeInfo, employeeEmergencyContactsInner.syncEmployeeInfo) &&
        Objects.equals(this.workExtension, employeeEmergencyContactsInner.workExtension) &&
        Objects.equals(this.workPhone, employeeEmergencyContactsInner.workPhone) &&
        Objects.equals(this.zip, employeeEmergencyContactsInner.zip);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeEmergencyContactsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeEmergencyContactsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeEmergencyContactsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeEmergencyContactsInner is not found in the empty JSON string", EmployeeEmergencyContactsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeEmergencyContactsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeEmergencyContactsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeEmergencyContactsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeEmergencyContactsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeEmergencyContactsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeEmergencyContactsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeEmergencyContactsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeEmergencyContactsInner>() {
           @Override
           public void write(JsonWriter out, EmployeeEmergencyContactsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeEmergencyContactsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeEmergencyContactsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeEmergencyContactsInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeEmergencyContactsInner
   */
  public static EmployeeEmergencyContactsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeEmergencyContactsInner.class);
  }

  /**
   * Convert an instance of EmployeeEmergencyContactsInner to an JSON string
   *
   * @return JSON string
   */
