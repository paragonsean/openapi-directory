...
import org.openapitools.client.model.BenefitSetup;
...
public class EmployeeBenefitSetupApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public EmployeeBenefitSetupApi() {
        this(Configuration.getDefaultApiClient());
    }

    public EmployeeBenefitSetupApi(ApiClient apiClient) {
    ...
    /**
     * Build call for updateOrAddEmployeeBenefitSetup
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param benefitSetup BenefitSetup Model (required)
     ...
     */
    public okhttp3.Call updateOrAddEmployeeBenefitSetupCall(String companyId, String employeeId, BenefitSetup benefitSetup, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = benefitSetup;
    ...
    private okhttp3.Call updateOrAddEmployeeBenefitSetupValidateBeforeCall(String companyId, String employeeId, BenefitSetup benefitSetup, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling updateOrAddEmployeeBenefitSetup(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling updateOrAddEmployeeBenefitSetup(Async)");
        }

        // verify the required parameter 'benefitSetup' is set
        if (benefitSetup == null) {
            throw new ApiException("Missing the required parameter 'benefitSetup' when calling updateOrAddEmployeeBenefitSetup(Async)");
        }

        return updateOrAddEmployeeBenefitSetupCall(companyId, employeeId, benefitSetup, _callback);
     ...
     */
    public void updateOrAddEmployeeBenefitSetup(String companyId, String employeeId, BenefitSetup benefitSetup) throws ApiException {
        updateOrAddEmployeeBenefitSetupWithHttpInfo(companyId, employeeId, benefitSetup);
    }
     ...
     */
    public ApiResponse<Void> updateOrAddEmployeeBenefitSetupWithHttpInfo(String companyId, String employeeId, BenefitSetup benefitSetup) throws ApiException {
        okhttp3.Call localVarCall = updateOrAddEmployeeBenefitSetupValidateBeforeCall(companyId, employeeId, benefitSetup, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add/update employee&#39;s benefit setup (asynchronously)
     * Sends new or updated employee benefit setup information directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param benefitSetup BenefitSetup Model (required)
     ...
     */
    public okhttp3.Call updateOrAddEmployeeBenefitSetupAsync(String companyId, String employeeId, BenefitSetup benefitSetup, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateOrAddEmployeeBenefitSetupValidateBeforeCall(companyId, employeeId, benefitSetup, _callback);
