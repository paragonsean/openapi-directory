...
public class EmployeeAdditionalRateInner {
  ...
  public EmployeeAdditionalRateInner() {
  }

  public EmployeeAdditionalRateInner changeReason(String changeReason) {
  ...
  public EmployeeAdditionalRateInner costCenter1(String costCenter1) {
  ...
  public EmployeeAdditionalRateInner costCenter2(String costCenter2) {
  ...
  public EmployeeAdditionalRateInner costCenter3(String costCenter3) {
  ...
  public EmployeeAdditionalRateInner effectiveDate(String effectiveDate) {
  ...
  public EmployeeAdditionalRateInner endCheckDate(String endCheckDate) {
  ...
  public EmployeeAdditionalRateInner job(String job) {
    this.job = job;
    return this;
  }
  ...
  public EmployeeAdditionalRateInner rate(BigDecimal rate) {
    this.rate = rate;
    return this;
  }
  ...
  public EmployeeAdditionalRateInner rateCode(String rateCode) {
  ...
  public EmployeeAdditionalRateInner rateNotes(String rateNotes) {
  ...
  public EmployeeAdditionalRateInner ratePer(String ratePer) {
  ...
  public EmployeeAdditionalRateInner shift(String shift) {
    this.shift = shift;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeAdditionalRateInner employeeAdditionalRateInner = (EmployeeAdditionalRateInner) o;
    return Objects.equals(this.changeReason, employeeAdditionalRateInner.changeReason) &&
        Objects.equals(this.costCenter1, employeeAdditionalRateInner.costCenter1) &&
        Objects.equals(this.costCenter2, employeeAdditionalRateInner.costCenter2) &&
        Objects.equals(this.costCenter3, employeeAdditionalRateInner.costCenter3) &&
        Objects.equals(this.effectiveDate, employeeAdditionalRateInner.effectiveDate) &&
        Objects.equals(this.endCheckDate, employeeAdditionalRateInner.endCheckDate) &&
        Objects.equals(this.job, employeeAdditionalRateInner.job) &&
        Objects.equals(this.rate, employeeAdditionalRateInner.rate) &&
        Objects.equals(this.rateCode, employeeAdditionalRateInner.rateCode) &&
        Objects.equals(this.rateNotes, employeeAdditionalRateInner.rateNotes) &&
        Objects.equals(this.ratePer, employeeAdditionalRateInner.ratePer) &&
        Objects.equals(this.shift, employeeAdditionalRateInner.shift);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeAdditionalRateInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeAdditionalRateInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeAdditionalRateInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeAdditionalRateInner is not found in the empty JSON string", EmployeeAdditionalRateInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeAdditionalRateInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeAdditionalRateInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeAdditionalRateInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeAdditionalRateInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeAdditionalRateInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeAdditionalRateInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeAdditionalRateInner>() {
           @Override
           public void write(JsonWriter out, EmployeeAdditionalRateInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeAdditionalRateInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeAdditionalRateInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeAdditionalRateInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeAdditionalRateInner
   */
  public static EmployeeAdditionalRateInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeAdditionalRateInner.class);
  }

  /**
   * Convert an instance of EmployeeAdditionalRateInner to an JSON string
   *
   * @return JSON string
   */
