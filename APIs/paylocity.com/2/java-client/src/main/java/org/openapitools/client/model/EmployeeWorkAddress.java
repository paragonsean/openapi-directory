...
public class EmployeeWorkAddress {
  ...
  public EmployeeWorkAddress address1(String address1) {
  ...
  public EmployeeWorkAddress address2(String address2) {
  ...
  public EmployeeWorkAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public EmployeeWorkAddress country(String country) {
  ...
  public EmployeeWorkAddress county(String county) {
    this.county = county;
    return this;
  }
  ...
  public EmployeeWorkAddress emailAddress(String emailAddress) {
  ...
  public EmployeeWorkAddress location(String location) {
  ...
  public EmployeeWorkAddress mailStop(String mailStop) {
  ...
  public EmployeeWorkAddress mobilePhone(String mobilePhone) {
  ...
  public EmployeeWorkAddress pager(String pager) {
    this.pager = pager;
    return this;
  }
  ...
  public EmployeeWorkAddress phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public EmployeeWorkAddress phoneExtension(String phoneExtension) {
  ...
  public EmployeeWorkAddress postalCode(String postalCode) {
  ...
  public EmployeeWorkAddress state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address1, employeeWorkAddress.address1) &&
        Objects.equals(this.address2, employeeWorkAddress.address2) &&
        Objects.equals(this.city, employeeWorkAddress.city) &&
        Objects.equals(this.country, employeeWorkAddress.country) &&
        Objects.equals(this.county, employeeWorkAddress.county) &&
        Objects.equals(this.emailAddress, employeeWorkAddress.emailAddress) &&
        Objects.equals(this.location, employeeWorkAddress.location) &&
        Objects.equals(this.mailStop, employeeWorkAddress.mailStop) &&
        Objects.equals(this.mobilePhone, employeeWorkAddress.mobilePhone) &&
        Objects.equals(this.pager, employeeWorkAddress.pager) &&
        Objects.equals(this.phone, employeeWorkAddress.phone) &&
        Objects.equals(this.phoneExtension, employeeWorkAddress.phoneExtension) &&
        Objects.equals(this.postalCode, employeeWorkAddress.postalCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, city, country, county, emailAddress, location, mailStop, mobilePhone, pager, phone, phoneExtension, postalCode, state);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeWorkAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeWorkAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeWorkAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeWorkAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
