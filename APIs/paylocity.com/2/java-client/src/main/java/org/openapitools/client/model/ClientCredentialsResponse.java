...
public class ClientCredentialsResponse {
  ...
  private String clientSecretExpirationDate;

  public ClientCredentialsResponse() {
  }

  public ClientCredentialsResponse clientSecret(String clientSecret) {
  ...
  public ClientCredentialsResponse clientSecretExpirationDate(String clientSecretExpirationDate) {
   ...
   */
  @javax.annotation.Nullable
  public String getClientSecretExpirationDate() {
    return clientSecretExpirationDate;
  }

  public void setClientSecretExpirationDate(String clientSecretExpirationDate) {
    this.clientSecretExpirationDate = clientSecretExpirationDate;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientSecret, clientSecretExpirationDate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClientCredentialsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClientCredentialsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClientCredentialsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClientCredentialsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("clientSecretExpirationDate") != null && !jsonObj.get("clientSecretExpirationDate").isJsonNull()) && !jsonObj.get("clientSecretExpirationDate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `clientSecretExpirationDate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("clientSecretExpirationDate").toString()));
      }
  }
