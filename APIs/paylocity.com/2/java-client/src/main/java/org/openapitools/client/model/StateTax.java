...
public class StateTax {
  ...
  public StateTax amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public StateTax deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public StateTax dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public StateTax exemptions(BigDecimal exemptions) {
  ...
  public StateTax exemptions2(BigDecimal exemptions2) {
  ...
  public StateTax filingStatus(String filingStatus) {
  ...
  public StateTax otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public StateTax percentage(BigDecimal percentage) {
  ...
  public StateTax specialCheckCalc(String specialCheckCalc) {
  ...
  public StateTax taxCalculationCode(String taxCalculationCode) {
  ...
  public StateTax taxCode(String taxCode) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, deductionsAmount, dependentsAmount, exemptions, exemptions2, filingStatus, higherRate, otherIncomeAmount, percentage, specialCheckCalc, taxCalculationCode, taxCode, w4FormYear);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StateTax
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StateTax.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StateTax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StateTax` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
