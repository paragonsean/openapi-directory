...
public class SensitiveDataVeteran {
  public static final String SERIALIZED_NAME_IS_VETERAN = "isVeteran";
  @SerializedName(SERIALIZED_NAME_IS_VETERAN)
  ...
  public SensitiveDataVeteran isVeteran(String isVeteran) {
  ...
  public SensitiveDataVeteran veteran(String veteran) {
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataVeteran sensitiveDataVeteran = (SensitiveDataVeteran) o;
    return Objects.equals(this.isVeteran, sensitiveDataVeteran.isVeteran) &&
        Objects.equals(this.veteran, sensitiveDataVeteran.veteran);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isVeteran, veteran);
  }
  ...
  public String toString() {
    ...
    sb.append("class SensitiveDataVeteran {\n");
    sb.append("    isVeteran: ").append(toIndentedString(isVeteran)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SensitiveDataVeteran
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitiveDataVeteran.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SensitiveDataVeteran is not found in the empty JSON string", SensitiveDataVeteran.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitiveDataVeteran.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SensitiveDataVeteran` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("isVeteran") != null && !jsonObj.get("isVeteran").isJsonNull()) && !jsonObj.get("isVeteran").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `isVeteran` to be a primitive type in the JSON string but got `%s`", jsonObj.get("isVeteran").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SensitiveDataVeteran.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SensitiveDataVeteran' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SensitiveDataVeteran> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SensitiveDataVeteran.class));

       return (TypeAdapter<T>) new TypeAdapter<SensitiveDataVeteran>() {
           @Override
           public void write(JsonWriter out, SensitiveDataVeteran value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SensitiveDataVeteran read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SensitiveDataVeteran given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SensitiveDataVeteran
   * @throws IOException if the JSON string is invalid with respect to SensitiveDataVeteran
   */
  public static SensitiveDataVeteran fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SensitiveDataVeteran.class);
  }

  /**
   * Convert an instance of SensitiveDataVeteran to an JSON string
   *
   * @return JSON string
   */
