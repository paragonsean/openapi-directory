...
public class ErrorOptionsInner {
  ...
  public ErrorOptionsInner() {
  }

  public ErrorOptionsInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public ErrorOptionsInner description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorOptionsInner errorOptionsInner = (ErrorOptionsInner) o;
    return Objects.equals(this.code, errorOptionsInner.code) &&
        Objects.equals(this.description, errorOptionsInner.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorOptionsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ErrorOptionsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ErrorOptionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorOptionsInner is not found in the empty JSON string", ErrorOptionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ErrorOptionsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ErrorOptionsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorOptionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorOptionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorOptionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorOptionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorOptionsInner>() {
           @Override
           public void write(JsonWriter out, ErrorOptionsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ErrorOptionsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ErrorOptionsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ErrorOptionsInner
   * @throws IOException if the JSON string is invalid with respect to ErrorOptionsInner
   */
  public static ErrorOptionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorOptionsInner.class);
  }

  /**
   * Convert an instance of ErrorOptionsInner to an JSON string
   *
   * @return JSON string
   */
