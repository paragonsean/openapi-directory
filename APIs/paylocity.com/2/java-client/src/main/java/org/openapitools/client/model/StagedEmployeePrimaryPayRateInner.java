...
public class StagedEmployeePrimaryPayRateInner {
  ...
  public StagedEmployeePrimaryPayRateInner() {
  }

  public StagedEmployeePrimaryPayRateInner baseRate(BigDecimal baseRate) {
  ...
  public StagedEmployeePrimaryPayRateInner changeReason(String changeReason) {
  ...
  public StagedEmployeePrimaryPayRateInner defaultHours(BigDecimal defaultHours) {
  ...
  public StagedEmployeePrimaryPayRateInner effectiveDate(String effectiveDate) {
  ...
  public StagedEmployeePrimaryPayRateInner isAutoPay(Boolean isAutoPay) {
  ...
  public StagedEmployeePrimaryPayRateInner payFrequency(String payFrequency) {
  ...
  public StagedEmployeePrimaryPayRateInner payGrade(String payGrade) {
  ...
  public StagedEmployeePrimaryPayRateInner payType(String payType) {
  ...
  public StagedEmployeePrimaryPayRateInner ratePer(String ratePer) {
  ...
  public StagedEmployeePrimaryPayRateInner salary(BigDecimal salary) {
    this.salary = salary;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeePrimaryPayRateInner stagedEmployeePrimaryPayRateInner = (StagedEmployeePrimaryPayRateInner) o;
    return Objects.equals(this.baseRate, stagedEmployeePrimaryPayRateInner.baseRate) &&
        Objects.equals(this.changeReason, stagedEmployeePrimaryPayRateInner.changeReason) &&
        Objects.equals(this.defaultHours, stagedEmployeePrimaryPayRateInner.defaultHours) &&
        Objects.equals(this.effectiveDate, stagedEmployeePrimaryPayRateInner.effectiveDate) &&
        Objects.equals(this.isAutoPay, stagedEmployeePrimaryPayRateInner.isAutoPay) &&
        Objects.equals(this.payFrequency, stagedEmployeePrimaryPayRateInner.payFrequency) &&
        Objects.equals(this.payGrade, stagedEmployeePrimaryPayRateInner.payGrade) &&
        Objects.equals(this.payType, stagedEmployeePrimaryPayRateInner.payType) &&
        Objects.equals(this.ratePer, stagedEmployeePrimaryPayRateInner.ratePer) &&
        Objects.equals(this.salary, stagedEmployeePrimaryPayRateInner.salary);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseRate, changeReason, defaultHours, effectiveDate, isAutoPay, payFrequency, payGrade, payType, ratePer, salary);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeePrimaryPayRateInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeePrimaryPayRateInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeePrimaryPayRateInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeePrimaryPayRateInner is not found in the empty JSON string", StagedEmployeePrimaryPayRateInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeePrimaryPayRateInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeePrimaryPayRateInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeePrimaryPayRateInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeePrimaryPayRateInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeePrimaryPayRateInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeePrimaryPayRateInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeePrimaryPayRateInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeePrimaryPayRateInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeePrimaryPayRateInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeePrimaryPayRateInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeePrimaryPayRateInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeePrimaryPayRateInner
   */
  public static StagedEmployeePrimaryPayRateInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeePrimaryPayRateInner.class);
  }

  /**
   * Convert an instance of StagedEmployeePrimaryPayRateInner to an JSON string
   *
   * @return JSON string
   */
