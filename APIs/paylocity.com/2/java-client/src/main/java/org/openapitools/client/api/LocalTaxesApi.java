...
import org.openapitools.client.model.LocalTax;
...
public class LocalTaxesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LocalTaxesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public LocalTaxesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addLocalTax
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param localTax LocalTax Model (required)
     ...
     */
    public okhttp3.Call addLocalTaxCall(String companyId, String employeeId, LocalTax localTax, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = localTax;
    ...
    private okhttp3.Call addLocalTaxValidateBeforeCall(String companyId, String employeeId, LocalTax localTax, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addLocalTax(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling addLocalTax(Async)");
        }

        // verify the required parameter 'localTax' is set
        if (localTax == null) {
            throw new ApiException("Missing the required parameter 'localTax' when calling addLocalTax(Async)");
        }

        return addLocalTaxCall(companyId, employeeId, localTax, _callback);
     ...
     */
    public void addLocalTax(String companyId, String employeeId, LocalTax localTax) throws ApiException {
        addLocalTaxWithHttpInfo(companyId, employeeId, localTax);
    }
     ...
     */
    public ApiResponse<Void> addLocalTaxWithHttpInfo(String companyId, String employeeId, LocalTax localTax) throws ApiException {
        okhttp3.Call localVarCall = addLocalTaxValidateBeforeCall(companyId, employeeId, localTax, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add new local tax (asynchronously)
     * Sends new employee local tax information directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param localTax LocalTax Model (required)
     ...
     */
    public okhttp3.Call addLocalTaxAsync(String companyId, String employeeId, LocalTax localTax, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addLocalTaxValidateBeforeCall(companyId, employeeId, localTax, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteLocalTaxByTaxCode
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     ...
     */
    public okhttp3.Call deleteLocalTaxByTaxCodeCall(String companyId, String employeeId, String taxCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteLocalTaxByTaxCodeValidateBeforeCall(String companyId, String employeeId, String taxCode, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling deleteLocalTaxByTaxCode(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling deleteLocalTaxByTaxCode(Async)");
        }

        // verify the required parameter 'taxCode' is set
        if (taxCode == null) {
            throw new ApiException("Missing the required parameter 'taxCode' when calling deleteLocalTaxByTaxCode(Async)");
        }

        return deleteLocalTaxByTaxCodeCall(companyId, employeeId, taxCode, _callback);
     ...
     */
    public void deleteLocalTaxByTaxCode(String companyId, String employeeId, String taxCode) throws ApiException {
        deleteLocalTaxByTaxCodeWithHttpInfo(companyId, employeeId, taxCode);
    }
     ...
     */
    public ApiResponse<Void> deleteLocalTaxByTaxCodeWithHttpInfo(String companyId, String employeeId, String taxCode) throws ApiException {
        okhttp3.Call localVarCall = deleteLocalTaxByTaxCodeValidateBeforeCall(companyId, employeeId, taxCode, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete local tax by tax code (asynchronously)
     * Delete local tax by tax code
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param taxCode Tax Code (required)
     ...
     */
    public okhttp3.Call deleteLocalTaxByTaxCodeAsync(String companyId, String employeeId, String taxCode, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteLocalTaxByTaxCodeValidateBeforeCall(companyId, employeeId, taxCode, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getAllLocalTaxes
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call getAllLocalTaxesCall(String companyId, String employeeId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllLocalTaxesValidateBeforeCall(String companyId, String employeeId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getAllLocalTaxes(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling getAllLocalTaxes(Async)");
        }

        return getAllLocalTaxesCall(companyId, employeeId, _callback);
     ...
     */
    public List<LocalTax> getAllLocalTaxes(String companyId, String employeeId) throws ApiException {
        ApiResponse<List<LocalTax>> localVarResp = getAllLocalTaxesWithHttpInfo(companyId, employeeId);
     ...
     */
    public ApiResponse<List<LocalTax>> getAllLocalTaxesWithHttpInfo(String companyId, String employeeId) throws ApiException {
        okhttp3.Call localVarCall = getAllLocalTaxesValidateBeforeCall(companyId, employeeId, null);
        Type localVarReturnType = new TypeToken<List<LocalTax>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all local taxes (asynchronously)
     * Returns all local taxes for the selected employee.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getAllLocalTaxesAsync(String companyId, String employeeId, final ApiCallback<List<LocalTax>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllLocalTaxesValidateBeforeCall(companyId, employeeId, _callback);
        Type localVarReturnType = new TypeToken<List<LocalTax>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getLocalTaxByTaxCode
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param taxCode Tax Code (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getLocalTaxByTaxCodeCall(String companyId, String employeeId, String taxCode, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLocalTaxByTaxCodeValidateBeforeCall(String companyId, String employeeId, String taxCode, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getLocalTaxByTaxCode(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling getLocalTaxByTaxCode(Async)");
        }

        // verify the required parameter 'taxCode' is set
        if (taxCode == null) {
            throw new ApiException("Missing the required parameter 'taxCode' when calling getLocalTaxByTaxCode(Async)");
        }

        return getLocalTaxByTaxCodeCall(companyId, employeeId, taxCode, _callback);
     ...
     */
    public List<LocalTax> getLocalTaxByTaxCode(String companyId, String employeeId, String taxCode) throws ApiException {
        ApiResponse<List<LocalTax>> localVarResp = getLocalTaxByTaxCodeWithHttpInfo(companyId, employeeId, taxCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<LocalTax>> getLocalTaxByTaxCodeWithHttpInfo(String companyId, String employeeId, String taxCode) throws ApiException {
        okhttp3.Call localVarCall = getLocalTaxByTaxCodeValidateBeforeCall(companyId, employeeId, taxCode, null);
        Type localVarReturnType = new TypeToken<List<LocalTax>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get local taxes by tax code (asynchronously)
     * Returns all local taxes with the provided tax code for the selected employee.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param taxCode Tax Code (required)
     ...
     */
    public okhttp3.Call getLocalTaxByTaxCodeAsync(String companyId, String employeeId, String taxCode, final ApiCallback<List<LocalTax>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLocalTaxByTaxCodeValidateBeforeCall(companyId, employeeId, taxCode, _callback);
        Type localVarReturnType = new TypeToken<List<LocalTax>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
