...
public class StagedEmployeeNonPrimaryStateTaxInner {
  ...
  private BigDecimal exemptions2;
  ...
  private String reciprocityCode;
  ...
  public StagedEmployeeNonPrimaryStateTaxInner() {
  }

  public StagedEmployeeNonPrimaryStateTaxInner amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public StagedEmployeeNonPrimaryStateTaxInner deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner exemptions(BigDecimal exemptions) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner exemptions2(BigDecimal exemptions2) {
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getExemptions2() {
    return exemptions2;
  }

  public void setExemptions2(BigDecimal exemptions2) {
    this.exemptions2 = exemptions2;
  }


  public StagedEmployeeNonPrimaryStateTaxInner filingStatus(String filingStatus) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner higherRate(Boolean higherRate) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner percentage(BigDecimal percentage) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner reciprocityCode(String reciprocityCode) {
   ...
   */
  @javax.annotation.Nullable
  public String getReciprocityCode() {
    return reciprocityCode;
  }

  public void setReciprocityCode(String reciprocityCode) {
    this.reciprocityCode = reciprocityCode;
  }


  public StagedEmployeeNonPrimaryStateTaxInner specialCheckCalc(String specialCheckCalc) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner taxCalculationCode(String taxCalculationCode) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner taxCode(String taxCode) {
  ...
  public StagedEmployeeNonPrimaryStateTaxInner w4FormYear(Integer w4FormYear) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeNonPrimaryStateTaxInner stagedEmployeeNonPrimaryStateTaxInner = (StagedEmployeeNonPrimaryStateTaxInner) o;
    return Objects.equals(this.amount, stagedEmployeeNonPrimaryStateTaxInner.amount) &&
        Objects.equals(this.deductionsAmount, stagedEmployeeNonPrimaryStateTaxInner.deductionsAmount) &&
        Objects.equals(this.dependentsAmount, stagedEmployeeNonPrimaryStateTaxInner.dependentsAmount) &&
        Objects.equals(this.exemptions, stagedEmployeeNonPrimaryStateTaxInner.exemptions) &&
        Objects.equals(this.exemptions2, stagedEmployeeNonPrimaryStateTaxInner.exemptions2) &&
        Objects.equals(this.filingStatus, stagedEmployeeNonPrimaryStateTaxInner.filingStatus) &&
        Objects.equals(this.higherRate, stagedEmployeeNonPrimaryStateTaxInner.higherRate) &&
        Objects.equals(this.otherIncomeAmount, stagedEmployeeNonPrimaryStateTaxInner.otherIncomeAmount) &&
        Objects.equals(this.percentage, stagedEmployeeNonPrimaryStateTaxInner.percentage) &&
        Objects.equals(this.reciprocityCode, stagedEmployeeNonPrimaryStateTaxInner.reciprocityCode) &&
        Objects.equals(this.specialCheckCalc, stagedEmployeeNonPrimaryStateTaxInner.specialCheckCalc) &&
        Objects.equals(this.taxCalculationCode, stagedEmployeeNonPrimaryStateTaxInner.taxCalculationCode) &&
        Objects.equals(this.taxCode, stagedEmployeeNonPrimaryStateTaxInner.taxCode) &&
        Objects.equals(this.w4FormYear, stagedEmployeeNonPrimaryStateTaxInner.w4FormYear);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, deductionsAmount, dependentsAmount, exemptions, exemptions2, filingStatus, higherRate, otherIncomeAmount, percentage, reciprocityCode, specialCheckCalc, taxCalculationCode, taxCode, w4FormYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeNonPrimaryStateTaxInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeNonPrimaryStateTaxInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeNonPrimaryStateTaxInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeNonPrimaryStateTaxInner is not found in the empty JSON string", StagedEmployeeNonPrimaryStateTaxInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeNonPrimaryStateTaxInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeNonPrimaryStateTaxInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("reciprocityCode") != null && !jsonObj.get("reciprocityCode").isJsonNull()) && !jsonObj.get("reciprocityCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reciprocityCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reciprocityCode").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeNonPrimaryStateTaxInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeNonPrimaryStateTaxInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeNonPrimaryStateTaxInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeNonPrimaryStateTaxInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeNonPrimaryStateTaxInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeNonPrimaryStateTaxInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeNonPrimaryStateTaxInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeNonPrimaryStateTaxInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeNonPrimaryStateTaxInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeNonPrimaryStateTaxInner
   */
  public static StagedEmployeeNonPrimaryStateTaxInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeNonPrimaryStateTaxInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeNonPrimaryStateTaxInner to an JSON string
   *
   * @return JSON string
   */
