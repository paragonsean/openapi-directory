...
public class EmployeeHomeAddress {
  ...
  public EmployeeHomeAddress address1(String address1) {
  ...
  public EmployeeHomeAddress address2(String address2) {
  ...
  public EmployeeHomeAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public EmployeeHomeAddress country(String country) {
  ...
  public EmployeeHomeAddress county(String county) {
    this.county = county;
    return this;
  }
  ...
  public EmployeeHomeAddress emailAddress(String emailAddress) {
  ...
  public EmployeeHomeAddress mobilePhone(String mobilePhone) {
  ...
  public EmployeeHomeAddress phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public EmployeeHomeAddress postalCode(String postalCode) {
  ...
  public EmployeeHomeAddress state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeHomeAddress employeeHomeAddress = (EmployeeHomeAddress) o;
    return Objects.equals(this.address1, employeeHomeAddress.address1) &&
        Objects.equals(this.address2, employeeHomeAddress.address2) &&
        Objects.equals(this.city, employeeHomeAddress.city) &&
        Objects.equals(this.country, employeeHomeAddress.country) &&
        Objects.equals(this.county, employeeHomeAddress.county) &&
        Objects.equals(this.emailAddress, employeeHomeAddress.emailAddress) &&
        Objects.equals(this.mobilePhone, employeeHomeAddress.mobilePhone) &&
        Objects.equals(this.phone, employeeHomeAddress.phone) &&
        Objects.equals(this.postalCode, employeeHomeAddress.postalCode) &&
        Objects.equals(this.state, employeeHomeAddress.state);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeHomeAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeHomeAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeHomeAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeHomeAddress is not found in the empty JSON string", EmployeeHomeAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeHomeAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeHomeAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeHomeAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeHomeAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeHomeAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeHomeAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeHomeAddress>() {
           @Override
           public void write(JsonWriter out, EmployeeHomeAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeHomeAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeHomeAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeHomeAddress
   * @throws IOException if the JSON string is invalid with respect to EmployeeHomeAddress
   */
  public static EmployeeHomeAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeHomeAddress.class);
  }

  /**
   * Convert an instance of EmployeeHomeAddress to an JSON string
   *
   * @return JSON string
   */
