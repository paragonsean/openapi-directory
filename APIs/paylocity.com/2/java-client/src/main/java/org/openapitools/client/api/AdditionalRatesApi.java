...
import org.openapitools.client.model.AdditionalRate;
...
public class AdditionalRatesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AdditionalRatesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AdditionalRatesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addOrUpdateAdditionalRates
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param additionalRate Additional Rate Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateAdditionalRatesCall(String companyId, String employeeId, AdditionalRate additionalRate, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = additionalRate;
    ...
    private okhttp3.Call addOrUpdateAdditionalRatesValidateBeforeCall(String companyId, String employeeId, AdditionalRate additionalRate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addOrUpdateAdditionalRates(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling addOrUpdateAdditionalRates(Async)");
        }

        // verify the required parameter 'additionalRate' is set
        if (additionalRate == null) {
            throw new ApiException("Missing the required parameter 'additionalRate' when calling addOrUpdateAdditionalRates(Async)");
        }

        return addOrUpdateAdditionalRatesCall(companyId, employeeId, additionalRate, _callback);
     ...
     */
    public void addOrUpdateAdditionalRates(String companyId, String employeeId, AdditionalRate additionalRate) throws ApiException {
        addOrUpdateAdditionalRatesWithHttpInfo(companyId, employeeId, additionalRate);
    }
     ...
     */
    public ApiResponse<Void> addOrUpdateAdditionalRatesWithHttpInfo(String companyId, String employeeId, AdditionalRate additionalRate) throws ApiException {
        okhttp3.Call localVarCall = addOrUpdateAdditionalRatesValidateBeforeCall(companyId, employeeId, additionalRate, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add/update additional rates (asynchronously)
     * Sends new or updated employee additional rates information directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param additionalRate Additional Rate Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateAdditionalRatesAsync(String companyId, String employeeId, AdditionalRate additionalRate, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addOrUpdateAdditionalRatesValidateBeforeCall(companyId, employeeId, additionalRate, _callback);
