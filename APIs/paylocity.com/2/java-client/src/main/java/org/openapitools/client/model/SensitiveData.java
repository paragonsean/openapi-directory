...
import org.openapitools.client.model.SensitiveDataDisability;
import org.openapitools.client.model.SensitiveDataEthnicity;
import org.openapitools.client.model.SensitiveDataGender;
import org.openapitools.client.model.SensitiveDataVeteran;
...
public class SensitiveData {
  ...
  public SensitiveDataDisability getDisability() {
    return disability;
  }

  public void setDisability(SensitiveDataDisability disability) {
    this.disability = disability;
  }


  public SensitiveData ethnicity(SensitiveDataEthnicity ethnicity) {
   ...
   */
  @javax.annotation.Nullable
  public SensitiveDataEthnicity getEthnicity() {
    return ethnicity;
  }

  public void setEthnicity(SensitiveDataEthnicity ethnicity) {
    this.ethnicity = ethnicity;
  }


  public SensitiveData gender(SensitiveDataGender gender) {
    this.gender = gender;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SensitiveDataGender getGender() {
    return gender;
  }

  public void setGender(SensitiveDataGender gender) {
    this.gender = gender;
  }


  public SensitiveData veteran(SensitiveDataVeteran veteran) {
   ...
   */
  @javax.annotation.Nullable
  public SensitiveDataVeteran getVeteran() {
    return veteran;
  }

  public void setVeteran(SensitiveDataVeteran veteran) {
    this.veteran = veteran;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disability, ethnicity, gender, veteran);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SensitiveData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitiveData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitiveData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SensitiveData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `disability`
      if (jsonObj.get("disability") != null && !jsonObj.get("disability").isJsonNull()) {
        SensitiveDataDisability.validateJsonElement(jsonObj.get("disability"));
      }
      // validate the optional field `ethnicity`
      if (jsonObj.get("ethnicity") != null && !jsonObj.get("ethnicity").isJsonNull()) {
        SensitiveDataEthnicity.validateJsonElement(jsonObj.get("ethnicity"));
      }
      // validate the optional field `gender`
      if (jsonObj.get("gender") != null && !jsonObj.get("gender").isJsonNull()) {
        SensitiveDataGender.validateJsonElement(jsonObj.get("gender"));
      }
      // validate the optional field `veteran`
      if (jsonObj.get("veteran") != null && !jsonObj.get("veteran").isJsonNull()) {
        SensitiveDataVeteran.validateJsonElement(jsonObj.get("veteran"));
      }
  }
