...
public class EmployeeMainDirectDeposit {
  ...
  public EmployeeMainDirectDeposit accountNumber(String accountNumber) {
  ...
  public EmployeeMainDirectDeposit accountType(String accountType) {
  ...
  public EmployeeMainDirectDeposit blockSpecial(Boolean blockSpecial) {
  ...
  public EmployeeMainDirectDeposit isSkipPreNote(Boolean isSkipPreNote) {
  ...
  public EmployeeMainDirectDeposit nameOnAccount(String nameOnAccount) {
  ...
  public EmployeeMainDirectDeposit preNoteDate(String preNoteDate) {
  ...
  public EmployeeMainDirectDeposit routingNumber(String routingNumber) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeMainDirectDeposit employeeMainDirectDeposit = (EmployeeMainDirectDeposit) o;
    return Objects.equals(this.accountNumber, employeeMainDirectDeposit.accountNumber) &&
        Objects.equals(this.accountType, employeeMainDirectDeposit.accountType) &&
        Objects.equals(this.blockSpecial, employeeMainDirectDeposit.blockSpecial) &&
        Objects.equals(this.isSkipPreNote, employeeMainDirectDeposit.isSkipPreNote) &&
        Objects.equals(this.nameOnAccount, employeeMainDirectDeposit.nameOnAccount) &&
        Objects.equals(this.preNoteDate, employeeMainDirectDeposit.preNoteDate) &&
        Objects.equals(this.routingNumber, employeeMainDirectDeposit.routingNumber);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountType, blockSpecial, isSkipPreNote, nameOnAccount, preNoteDate, routingNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeMainDirectDeposit {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeMainDirectDeposit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeMainDirectDeposit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeMainDirectDeposit is not found in the empty JSON string", EmployeeMainDirectDeposit.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeMainDirectDeposit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeMainDirectDeposit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeMainDirectDeposit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeMainDirectDeposit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeMainDirectDeposit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeMainDirectDeposit.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeMainDirectDeposit>() {
           @Override
           public void write(JsonWriter out, EmployeeMainDirectDeposit value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeMainDirectDeposit read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeMainDirectDeposit given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeMainDirectDeposit
   * @throws IOException if the JSON string is invalid with respect to EmployeeMainDirectDeposit
   */
  public static EmployeeMainDirectDeposit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeMainDirectDeposit.class);
  }

  /**
   * Convert an instance of EmployeeMainDirectDeposit to an JSON string
   *
   * @return JSON string
   */
