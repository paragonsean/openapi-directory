...
public class CustomFieldDefinitionValuesInner {
  ...
  public CustomFieldDefinitionValuesInner() {
  }

  public CustomFieldDefinitionValuesInner code(String code) {
    this.code = code;
    return this;
  }
  ...
  public CustomFieldDefinitionValuesInner description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    CustomFieldDefinitionValuesInner customFieldDefinitionValuesInner = (CustomFieldDefinitionValuesInner) o;
    return Objects.equals(this.code, customFieldDefinitionValuesInner.code) &&
        Objects.equals(this.description, customFieldDefinitionValuesInner.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomFieldDefinitionValuesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomFieldDefinitionValuesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldDefinitionValuesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomFieldDefinitionValuesInner is not found in the empty JSON string", CustomFieldDefinitionValuesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomFieldDefinitionValuesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomFieldDefinitionValuesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomFieldDefinitionValuesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomFieldDefinitionValuesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomFieldDefinitionValuesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomFieldDefinitionValuesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomFieldDefinitionValuesInner>() {
           @Override
           public void write(JsonWriter out, CustomFieldDefinitionValuesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomFieldDefinitionValuesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomFieldDefinitionValuesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomFieldDefinitionValuesInner
   * @throws IOException if the JSON string is invalid with respect to CustomFieldDefinitionValuesInner
   */
  public static CustomFieldDefinitionValuesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomFieldDefinitionValuesInner.class);
  }

  /**
   * Convert an instance of CustomFieldDefinitionValuesInner to an JSON string
   *
   * @return JSON string
   */
