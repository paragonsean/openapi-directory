...
public class StagedEmployeeMainDirectDepositInner {
  ...
  public StagedEmployeeMainDirectDepositInner() {
  }

  public StagedEmployeeMainDirectDepositInner accountNumber(String accountNumber) {
  ...
  public StagedEmployeeMainDirectDepositInner accountType(String accountType) {
  ...
  public StagedEmployeeMainDirectDepositInner isSkipPreNote(Boolean isSkipPreNote) {
  ...
  public StagedEmployeeMainDirectDepositInner preNoteDate(String preNoteDate) {
  ...
  public StagedEmployeeMainDirectDepositInner routingNumber(String routingNumber) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeMainDirectDepositInner stagedEmployeeMainDirectDepositInner = (StagedEmployeeMainDirectDepositInner) o;
    return Objects.equals(this.accountNumber, stagedEmployeeMainDirectDepositInner.accountNumber) &&
        Objects.equals(this.accountType, stagedEmployeeMainDirectDepositInner.accountType) &&
        Objects.equals(this.isSkipPreNote, stagedEmployeeMainDirectDepositInner.isSkipPreNote) &&
        Objects.equals(this.preNoteDate, stagedEmployeeMainDirectDepositInner.preNoteDate) &&
        Objects.equals(this.routingNumber, stagedEmployeeMainDirectDepositInner.routingNumber);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountType, isSkipPreNote, preNoteDate, routingNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeMainDirectDepositInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeMainDirectDepositInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeMainDirectDepositInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeMainDirectDepositInner is not found in the empty JSON string", StagedEmployeeMainDirectDepositInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeMainDirectDepositInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeMainDirectDepositInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeMainDirectDepositInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeMainDirectDepositInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeMainDirectDepositInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeMainDirectDepositInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeMainDirectDepositInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeMainDirectDepositInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeMainDirectDepositInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeMainDirectDepositInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeMainDirectDepositInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeMainDirectDepositInner
   */
  public static StagedEmployeeMainDirectDepositInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeMainDirectDepositInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeMainDirectDepositInner to an JSON string
   *
   * @return JSON string
   */
