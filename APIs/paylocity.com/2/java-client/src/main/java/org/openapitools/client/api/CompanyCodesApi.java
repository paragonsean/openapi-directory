...
import org.openapitools.client.model.CompanyCodes;
...
public class CompanyCodesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public CompanyCodesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CompanyCodesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllCompanyCodesAndDescriptionsByResource
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Invalid Code Resource </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Too Many Requests </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllCompanyCodesAndDescriptionsByResourceCall(String companyId, String codeResource, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllCompanyCodesAndDescriptionsByResourceValidateBeforeCall(String companyId, String codeResource, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getAllCompanyCodesAndDescriptionsByResource(Async)");
        }

        // verify the required parameter 'codeResource' is set
        if (codeResource == null) {
            throw new ApiException("Missing the required parameter 'codeResource' when calling getAllCompanyCodesAndDescriptionsByResource(Async)");
        }

        return getAllCompanyCodesAndDescriptionsByResourceCall(companyId, codeResource, _callback);
     ...
     */
    public List<CompanyCodes> getAllCompanyCodesAndDescriptionsByResource(String companyId, String codeResource) throws ApiException {
        ApiResponse<List<CompanyCodes>> localVarResp = getAllCompanyCodesAndDescriptionsByResourceWithHttpInfo(companyId, codeResource);
     ...
     */
    public ApiResponse<List<CompanyCodes>> getAllCompanyCodesAndDescriptionsByResourceWithHttpInfo(String companyId, String codeResource) throws ApiException {
        okhttp3.Call localVarCall = getAllCompanyCodesAndDescriptionsByResourceValidateBeforeCall(companyId, codeResource, null);
        Type localVarReturnType = new TypeToken<List<CompanyCodes>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get All Company Codes (asynchronously)
     * Get All Company Codes for the selected company and resource
     * @param companyId Company Id (required)
     * @param codeResource Type of Company Code. Common values costcenter1, costcenter2, costcenter3, deductions, earnings, taxes, paygrade, positions. (required)
     ...
     */
    public okhttp3.Call getAllCompanyCodesAndDescriptionsByResourceAsync(String companyId, String codeResource, final ApiCallback<List<CompanyCodes>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllCompanyCodesAndDescriptionsByResourceValidateBeforeCall(companyId, codeResource, _callback);
        Type localVarReturnType = new TypeToken<List<CompanyCodes>>(){}.getType();
