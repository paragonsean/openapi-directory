...
public class EmergencyContactsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public EmergencyContactsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public EmergencyContactsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addOrUpdateEmergencyContacts
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param emergencyContact Emergency Contact Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateEmergencyContactsCall(String companyId, String employeeId, EmergencyContact emergencyContact, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call addOrUpdateEmergencyContactsValidateBeforeCall(String companyId, String employeeId, EmergencyContact emergencyContact, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addOrUpdateEmergencyContacts(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling addOrUpdateEmergencyContacts(Async)");
        }

        // verify the required parameter 'emergencyContact' is set
        if (emergencyContact == null) {
            throw new ApiException("Missing the required parameter 'emergencyContact' when calling addOrUpdateEmergencyContacts(Async)");
        }

        return addOrUpdateEmergencyContactsCall(companyId, employeeId, emergencyContact, _callback);
     ...
     */
    public void addOrUpdateEmergencyContacts(String companyId, String employeeId, EmergencyContact emergencyContact) throws ApiException {
        addOrUpdateEmergencyContactsWithHttpInfo(companyId, employeeId, emergencyContact);
    }
     ...
     */
    public ApiResponse<Void> addOrUpdateEmergencyContactsWithHttpInfo(String companyId, String employeeId, EmergencyContact emergencyContact) throws ApiException {
        okhttp3.Call localVarCall = addOrUpdateEmergencyContactsValidateBeforeCall(companyId, employeeId, emergencyContact, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add/update emergency contacts (asynchronously)
     * Sends new or updated employee emergency contacts directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param emergencyContact Emergency Contact Model (required)
     ...
     */
    public okhttp3.Call addOrUpdateEmergencyContactsAsync(String companyId, String employeeId, EmergencyContact emergencyContact, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addOrUpdateEmergencyContactsValidateBeforeCall(companyId, employeeId, emergencyContact, _callback);
