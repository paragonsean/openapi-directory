...
public class StagedEmployeeFederalTaxInner {
  ...
  public StagedEmployeeFederalTaxInner() {
  }

  public StagedEmployeeFederalTaxInner amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public StagedEmployeeFederalTaxInner deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public StagedEmployeeFederalTaxInner dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public StagedEmployeeFederalTaxInner exemptions(BigDecimal exemptions) {
  ...
  public StagedEmployeeFederalTaxInner filingStatus(String filingStatus) {
  ...
  public StagedEmployeeFederalTaxInner higherRate(Boolean higherRate) {
  ...
  public StagedEmployeeFederalTaxInner otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public StagedEmployeeFederalTaxInner percentage(BigDecimal percentage) {
  ...
  public StagedEmployeeFederalTaxInner taxCalculationCode(String taxCalculationCode) {
  ...
  public StagedEmployeeFederalTaxInner w4FormYear(Integer w4FormYear) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeFederalTaxInner stagedEmployeeFederalTaxInner = (StagedEmployeeFederalTaxInner) o;
    return Objects.equals(this.amount, stagedEmployeeFederalTaxInner.amount) &&
        Objects.equals(this.deductionsAmount, stagedEmployeeFederalTaxInner.deductionsAmount) &&
        Objects.equals(this.dependentsAmount, stagedEmployeeFederalTaxInner.dependentsAmount) &&
        Objects.equals(this.exemptions, stagedEmployeeFederalTaxInner.exemptions) &&
        Objects.equals(this.filingStatus, stagedEmployeeFederalTaxInner.filingStatus) &&
        Objects.equals(this.higherRate, stagedEmployeeFederalTaxInner.higherRate) &&
        Objects.equals(this.otherIncomeAmount, stagedEmployeeFederalTaxInner.otherIncomeAmount) &&
        Objects.equals(this.percentage, stagedEmployeeFederalTaxInner.percentage) &&
        Objects.equals(this.taxCalculationCode, stagedEmployeeFederalTaxInner.taxCalculationCode) &&
        Objects.equals(this.w4FormYear, stagedEmployeeFederalTaxInner.w4FormYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeFederalTaxInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeFederalTaxInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeFederalTaxInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeFederalTaxInner is not found in the empty JSON string", StagedEmployeeFederalTaxInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeFederalTaxInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeFederalTaxInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeFederalTaxInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeFederalTaxInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeFederalTaxInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeFederalTaxInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeFederalTaxInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeFederalTaxInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeFederalTaxInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeFederalTaxInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeFederalTaxInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeFederalTaxInner
   */
  public static StagedEmployeeFederalTaxInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeFederalTaxInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeFederalTaxInner to an JSON string
   *
   * @return JSON string
   */
