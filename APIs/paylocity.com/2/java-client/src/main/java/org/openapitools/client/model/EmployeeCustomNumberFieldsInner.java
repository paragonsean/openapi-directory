...
public class EmployeeCustomNumberFieldsInner {
  /**
  ...
  public EmployeeCustomNumberFieldsInner() {
  }

  public EmployeeCustomNumberFieldsInner category(CategoryEnum category) {
  ...
  public EmployeeCustomNumberFieldsInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EmployeeCustomNumberFieldsInner value(BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeCustomNumberFieldsInner employeeCustomNumberFieldsInner = (EmployeeCustomNumberFieldsInner) o;
    return Objects.equals(this.category, employeeCustomNumberFieldsInner.category) &&
        Objects.equals(this.label, employeeCustomNumberFieldsInner.label) &&
        Objects.equals(this.value, employeeCustomNumberFieldsInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeCustomNumberFieldsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeCustomNumberFieldsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeCustomNumberFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeCustomNumberFieldsInner is not found in the empty JSON string", EmployeeCustomNumberFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeCustomNumberFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeCustomNumberFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeCustomNumberFieldsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeCustomNumberFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeCustomNumberFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeCustomNumberFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeCustomNumberFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeCustomNumberFieldsInner>() {
           @Override
           public void write(JsonWriter out, EmployeeCustomNumberFieldsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeCustomNumberFieldsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeCustomNumberFieldsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeCustomNumberFieldsInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeCustomNumberFieldsInner
   */
  public static EmployeeCustomNumberFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeCustomNumberFieldsInner.class);
  }

  /**
   * Convert an instance of EmployeeCustomNumberFieldsInner to an JSON string
   *
   * @return JSON string
   */
