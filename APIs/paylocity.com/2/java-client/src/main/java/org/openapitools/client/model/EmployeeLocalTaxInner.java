...
public class EmployeeLocalTaxInner {
  ...
  public EmployeeLocalTaxInner() {
  }

  public EmployeeLocalTaxInner exemptions(BigDecimal exemptions) {
  ...
  public EmployeeLocalTaxInner exemptions2(BigDecimal exemptions2) {
  ...
  public EmployeeLocalTaxInner filingStatus(String filingStatus) {
  ...
  public EmployeeLocalTaxInner residentPSD(String residentPSD) {
  ...
  public EmployeeLocalTaxInner taxCode(String taxCode) {
  ...
  public EmployeeLocalTaxInner workPSD(String workPSD) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeLocalTaxInner employeeLocalTaxInner = (EmployeeLocalTaxInner) o;
    return Objects.equals(this.exemptions, employeeLocalTaxInner.exemptions) &&
        Objects.equals(this.exemptions2, employeeLocalTaxInner.exemptions2) &&
        Objects.equals(this.filingStatus, employeeLocalTaxInner.filingStatus) &&
        Objects.equals(this.residentPSD, employeeLocalTaxInner.residentPSD) &&
        Objects.equals(this.taxCode, employeeLocalTaxInner.taxCode) &&
        Objects.equals(this.workPSD, employeeLocalTaxInner.workPSD);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeLocalTaxInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeLocalTaxInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeLocalTaxInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeLocalTaxInner is not found in the empty JSON string", EmployeeLocalTaxInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeLocalTaxInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeLocalTaxInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeLocalTaxInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeLocalTaxInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeLocalTaxInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeLocalTaxInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeLocalTaxInner>() {
           @Override
           public void write(JsonWriter out, EmployeeLocalTaxInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeLocalTaxInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeLocalTaxInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeLocalTaxInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeLocalTaxInner
   */
  public static EmployeeLocalTaxInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeLocalTaxInner.class);
  }

  /**
   * Convert an instance of EmployeeLocalTaxInner to an JSON string
   *
   * @return JSON string
   */
