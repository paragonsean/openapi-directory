...
public class PrimaryStateTaxApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PrimaryStateTaxApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PrimaryStateTaxApi(ApiClient apiClient) {
    ...
    /**
     * Build call for addOrUpdatePrimaryStateTax
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param stateTax Primary State Tax Model (required)
     ...
     */
    public okhttp3.Call addOrUpdatePrimaryStateTaxCall(String companyId, String employeeId, StateTax stateTax, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = stateTax;

        // create path and map variables
        String localVarPath = "/v2/companies/{companyId}/employees/{employeeId}/primaryStateTax"
    ...
    private okhttp3.Call addOrUpdatePrimaryStateTaxValidateBeforeCall(String companyId, String employeeId, StateTax stateTax, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addOrUpdatePrimaryStateTax(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling addOrUpdatePrimaryStateTax(Async)");
        }

        // verify the required parameter 'stateTax' is set
        if (stateTax == null) {
            throw new ApiException("Missing the required parameter 'stateTax' when calling addOrUpdatePrimaryStateTax(Async)");
        }

        return addOrUpdatePrimaryStateTaxCall(companyId, employeeId, stateTax, _callback);
     ...
     */
    public void addOrUpdatePrimaryStateTax(String companyId, String employeeId, StateTax stateTax) throws ApiException {
        addOrUpdatePrimaryStateTaxWithHttpInfo(companyId, employeeId, stateTax);
    }
     ...
     */
    public ApiResponse<Void> addOrUpdatePrimaryStateTaxWithHttpInfo(String companyId, String employeeId, StateTax stateTax) throws ApiException {
        okhttp3.Call localVarCall = addOrUpdatePrimaryStateTaxValidateBeforeCall(companyId, employeeId, stateTax, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Add/update primary state tax (asynchronously)
     * Sends new or updated employee primary state tax information directly to Web Pay.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     * @param stateTax Primary State Tax Model (required)
     ...
     */
    public okhttp3.Call addOrUpdatePrimaryStateTaxAsync(String companyId, String employeeId, StateTax stateTax, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = addOrUpdatePrimaryStateTaxValidateBeforeCall(companyId, employeeId, stateTax, _callback);
