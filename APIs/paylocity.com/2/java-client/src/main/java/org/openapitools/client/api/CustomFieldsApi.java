...
import org.openapitools.client.model.CustomFieldDefinition;
...
public class CustomFieldsApi {
    ...
    /**
     * Build call for getAllCustomFieldsByCategory
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Invalid Category </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Too Many Requests </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllCustomFieldsByCategoryCall(String companyId, String category, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllCustomFieldsByCategoryValidateBeforeCall(String companyId, String category, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getAllCustomFieldsByCategory(Async)");
        }

        // verify the required parameter 'category' is set
        if (category == null) {
            throw new ApiException("Missing the required parameter 'category' when calling getAllCustomFieldsByCategory(Async)");
        }

        return getAllCustomFieldsByCategoryCall(companyId, category, _callback);
     ...
     */
    public List<CustomFieldDefinition> getAllCustomFieldsByCategory(String companyId, String category) throws ApiException {
        ApiResponse<List<CustomFieldDefinition>> localVarResp = getAllCustomFieldsByCategoryWithHttpInfo(companyId, category);
     ...
     */
    public ApiResponse<List<CustomFieldDefinition>> getAllCustomFieldsByCategoryWithHttpInfo(String companyId, String category) throws ApiException {
        okhttp3.Call localVarCall = getAllCustomFieldsByCategoryValidateBeforeCall(companyId, category, null);
     ...
     */
    public okhttp3.Call getAllCustomFieldsByCategoryAsync(String companyId, String category, final ApiCallback<List<CustomFieldDefinition>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllCustomFieldsByCategoryValidateBeforeCall(companyId, category, _callback);
        Type localVarReturnType = new TypeToken<List<CustomFieldDefinition>>(){}.getType();
