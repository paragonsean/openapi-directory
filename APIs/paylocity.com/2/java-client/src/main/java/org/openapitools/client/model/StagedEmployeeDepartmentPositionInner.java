...
public class StagedEmployeeDepartmentPositionInner {
  ...
  public StagedEmployeeDepartmentPositionInner() {
  }

  public StagedEmployeeDepartmentPositionInner changeReason(String changeReason) {
  ...
  public StagedEmployeeDepartmentPositionInner clockBadgeNumber(String clockBadgeNumber) {
  ...
  public StagedEmployeeDepartmentPositionInner costCenter1(String costCenter1) {
  ...
  public StagedEmployeeDepartmentPositionInner costCenter2(String costCenter2) {
  ...
  public StagedEmployeeDepartmentPositionInner costCenter3(String costCenter3) {
  ...
  public StagedEmployeeDepartmentPositionInner effectiveDate(String effectiveDate) {
  ...
  public StagedEmployeeDepartmentPositionInner employeeType(String employeeType) {
  ...
  public StagedEmployeeDepartmentPositionInner equalEmploymentOpportunityClass(String equalEmploymentOpportunityClass) {
  ...
  public StagedEmployeeDepartmentPositionInner isMinimumWageExempt(Boolean isMinimumWageExempt) {
  ...
  public StagedEmployeeDepartmentPositionInner isOvertimeExempt(Boolean isOvertimeExempt) {
  ...
  public StagedEmployeeDepartmentPositionInner isSupervisorReviewer(Boolean isSupervisorReviewer) {
  ...
  public StagedEmployeeDepartmentPositionInner isUnionDuesCollected(Boolean isUnionDuesCollected) {
  ...
  public StagedEmployeeDepartmentPositionInner isUnionInitiationCollected(Boolean isUnionInitiationCollected) {
  ...
  public StagedEmployeeDepartmentPositionInner jobTitle(String jobTitle) {
  ...
  public StagedEmployeeDepartmentPositionInner payGroup(String payGroup) {
  ...
  public StagedEmployeeDepartmentPositionInner positionCode(String positionCode) {
  ...
  public StagedEmployeeDepartmentPositionInner shift(String shift) {
    this.shift = shift;
    return this;
  }
  ...
  public StagedEmployeeDepartmentPositionInner supervisorCompanyNumber(String supervisorCompanyNumber) {
  ...
  public StagedEmployeeDepartmentPositionInner supervisorEmployeeId(String supervisorEmployeeId) {
  ...
  public StagedEmployeeDepartmentPositionInner tipped(String tipped) {
    this.tipped = tipped;
    return this;
  }
  ...
  public StagedEmployeeDepartmentPositionInner unionAffiliationDate(String unionAffiliationDate) {
  ...
  public StagedEmployeeDepartmentPositionInner unionCode(String unionCode) {
  ...
  public StagedEmployeeDepartmentPositionInner unionPosition(String unionPosition) {
  ...
  public StagedEmployeeDepartmentPositionInner workersCompensation(String workersCompensation) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeDepartmentPositionInner stagedEmployeeDepartmentPositionInner = (StagedEmployeeDepartmentPositionInner) o;
    return Objects.equals(this.changeReason, stagedEmployeeDepartmentPositionInner.changeReason) &&
        Objects.equals(this.clockBadgeNumber, stagedEmployeeDepartmentPositionInner.clockBadgeNumber) &&
        Objects.equals(this.costCenter1, stagedEmployeeDepartmentPositionInner.costCenter1) &&
        Objects.equals(this.costCenter2, stagedEmployeeDepartmentPositionInner.costCenter2) &&
        Objects.equals(this.costCenter3, stagedEmployeeDepartmentPositionInner.costCenter3) &&
        Objects.equals(this.effectiveDate, stagedEmployeeDepartmentPositionInner.effectiveDate) &&
        Objects.equals(this.employeeType, stagedEmployeeDepartmentPositionInner.employeeType) &&
        Objects.equals(this.equalEmploymentOpportunityClass, stagedEmployeeDepartmentPositionInner.equalEmploymentOpportunityClass) &&
        Objects.equals(this.isMinimumWageExempt, stagedEmployeeDepartmentPositionInner.isMinimumWageExempt) &&
        Objects.equals(this.isOvertimeExempt, stagedEmployeeDepartmentPositionInner.isOvertimeExempt) &&
        Objects.equals(this.isSupervisorReviewer, stagedEmployeeDepartmentPositionInner.isSupervisorReviewer) &&
        Objects.equals(this.isUnionDuesCollected, stagedEmployeeDepartmentPositionInner.isUnionDuesCollected) &&
        Objects.equals(this.isUnionInitiationCollected, stagedEmployeeDepartmentPositionInner.isUnionInitiationCollected) &&
        Objects.equals(this.jobTitle, stagedEmployeeDepartmentPositionInner.jobTitle) &&
        Objects.equals(this.payGroup, stagedEmployeeDepartmentPositionInner.payGroup) &&
        Objects.equals(this.positionCode, stagedEmployeeDepartmentPositionInner.positionCode) &&
        Objects.equals(this.shift, stagedEmployeeDepartmentPositionInner.shift) &&
        Objects.equals(this.supervisorCompanyNumber, stagedEmployeeDepartmentPositionInner.supervisorCompanyNumber) &&
        Objects.equals(this.supervisorEmployeeId, stagedEmployeeDepartmentPositionInner.supervisorEmployeeId) &&
        Objects.equals(this.tipped, stagedEmployeeDepartmentPositionInner.tipped) &&
        Objects.equals(this.unionAffiliationDate, stagedEmployeeDepartmentPositionInner.unionAffiliationDate) &&
        Objects.equals(this.unionCode, stagedEmployeeDepartmentPositionInner.unionCode) &&
        Objects.equals(this.unionPosition, stagedEmployeeDepartmentPositionInner.unionPosition) &&
        Objects.equals(this.workersCompensation, stagedEmployeeDepartmentPositionInner.workersCompensation);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(changeReason, clockBadgeNumber, costCenter1, costCenter2, costCenter3, effectiveDate, employeeType, equalEmploymentOpportunityClass, isMinimumWageExempt, isOvertimeExempt, isSupervisorReviewer, isUnionDuesCollected, isUnionInitiationCollected, jobTitle, payGroup, positionCode, shift, supervisorCompanyNumber, supervisorEmployeeId, tipped, unionAffiliationDate, unionCode, unionPosition, workersCompensation);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeDepartmentPositionInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeDepartmentPositionInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeDepartmentPositionInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeDepartmentPositionInner is not found in the empty JSON string", StagedEmployeeDepartmentPositionInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeDepartmentPositionInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeDepartmentPositionInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeDepartmentPositionInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeDepartmentPositionInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeDepartmentPositionInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeDepartmentPositionInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeDepartmentPositionInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeDepartmentPositionInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeDepartmentPositionInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeDepartmentPositionInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeDepartmentPositionInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeDepartmentPositionInner
   */
  public static StagedEmployeeDepartmentPositionInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeDepartmentPositionInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeDepartmentPositionInner to an JSON string
   *
   * @return JSON string
   */
