...
public class NonPrimaryStateTax {
  ...
  public NonPrimaryStateTax amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public NonPrimaryStateTax deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public NonPrimaryStateTax dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public NonPrimaryStateTax exemptions(BigDecimal exemptions) {
  ...
  public NonPrimaryStateTax exemptions2(BigDecimal exemptions2) {
  ...
  public NonPrimaryStateTax filingStatus(String filingStatus) {
  ...
  public NonPrimaryStateTax otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public NonPrimaryStateTax percentage(BigDecimal percentage) {
  ...
  public NonPrimaryStateTax reciprocityCode(String reciprocityCode) {
  ...
  public NonPrimaryStateTax specialCheckCalc(String specialCheckCalc) {
  ...
  public NonPrimaryStateTax taxCalculationCode(String taxCalculationCode) {
  ...
  public NonPrimaryStateTax taxCode(String taxCode) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to NonPrimaryStateTax
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NonPrimaryStateTax.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NonPrimaryStateTax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NonPrimaryStateTax` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
