...
public class EmployeeCustomBooleanFieldsInner {
  /**
  ...
  public EmployeeCustomBooleanFieldsInner() {
  }

  public EmployeeCustomBooleanFieldsInner category(CategoryEnum category) {
  ...
  public EmployeeCustomBooleanFieldsInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EmployeeCustomBooleanFieldsInner value(Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeCustomBooleanFieldsInner employeeCustomBooleanFieldsInner = (EmployeeCustomBooleanFieldsInner) o;
    return Objects.equals(this.category, employeeCustomBooleanFieldsInner.category) &&
        Objects.equals(this.label, employeeCustomBooleanFieldsInner.label) &&
        Objects.equals(this.value, employeeCustomBooleanFieldsInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeCustomBooleanFieldsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeCustomBooleanFieldsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeCustomBooleanFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeCustomBooleanFieldsInner is not found in the empty JSON string", EmployeeCustomBooleanFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeCustomBooleanFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeCustomBooleanFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeCustomBooleanFieldsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeCustomBooleanFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeCustomBooleanFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeCustomBooleanFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeCustomBooleanFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeCustomBooleanFieldsInner>() {
           @Override
           public void write(JsonWriter out, EmployeeCustomBooleanFieldsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeCustomBooleanFieldsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeCustomBooleanFieldsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeCustomBooleanFieldsInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeCustomBooleanFieldsInner
   */
  public static EmployeeCustomBooleanFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeCustomBooleanFieldsInner.class);
  }

  /**
   * Convert an instance of EmployeeCustomBooleanFieldsInner to an JSON string
   *
   * @return JSON string
   */
