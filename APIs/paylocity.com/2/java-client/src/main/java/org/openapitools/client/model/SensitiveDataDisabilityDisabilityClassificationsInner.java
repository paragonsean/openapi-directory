...
public class SensitiveDataDisabilityDisabilityClassificationsInner {
  public static final String SERIALIZED_NAME_CLASSIFICATION = "classification";
  @SerializedName(SERIALIZED_NAME_CLASSIFICATION)
  private String classification;

  public SensitiveDataDisabilityDisabilityClassificationsInner() {
  }

  public SensitiveDataDisabilityDisabilityClassificationsInner classification(String classification) {
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataDisabilityDisabilityClassificationsInner sensitiveDataDisabilityDisabilityClassificationsInner = (SensitiveDataDisabilityDisabilityClassificationsInner) o;
    return Objects.equals(this.classification, sensitiveDataDisabilityDisabilityClassificationsInner.classification);
  }
  ...
  public String toString() {
    ...
    sb.append("class SensitiveDataDisabilityDisabilityClassificationsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SensitiveDataDisabilityDisabilityClassificationsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitiveDataDisabilityDisabilityClassificationsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SensitiveDataDisabilityDisabilityClassificationsInner is not found in the empty JSON string", SensitiveDataDisabilityDisabilityClassificationsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitiveDataDisabilityDisabilityClassificationsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SensitiveDataDisabilityDisabilityClassificationsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SensitiveDataDisabilityDisabilityClassificationsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SensitiveDataDisabilityDisabilityClassificationsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SensitiveDataDisabilityDisabilityClassificationsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SensitiveDataDisabilityDisabilityClassificationsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SensitiveDataDisabilityDisabilityClassificationsInner>() {
           @Override
           public void write(JsonWriter out, SensitiveDataDisabilityDisabilityClassificationsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SensitiveDataDisabilityDisabilityClassificationsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SensitiveDataDisabilityDisabilityClassificationsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SensitiveDataDisabilityDisabilityClassificationsInner
   * @throws IOException if the JSON string is invalid with respect to SensitiveDataDisabilityDisabilityClassificationsInner
   */
  public static SensitiveDataDisabilityDisabilityClassificationsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SensitiveDataDisabilityDisabilityClassificationsInner.class);
  }

  /**
   * Convert an instance of SensitiveDataDisabilityDisabilityClassificationsInner to an JSON string
   *
   * @return JSON string
   */
