...
public class DirectDepositApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DirectDepositApi() {
        this(Configuration.getDefaultApiClient());
    }

    public DirectDepositApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getAllDirectDeposit
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> The employee, or direct deposit does not exist </td><td>  -  </td></tr>
        <tr><td> 429 </td><td> Too Many Requests </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Server Error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAllDirectDepositCall(String companyId, String employeeId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllDirectDepositValidateBeforeCall(String companyId, String employeeId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling getAllDirectDeposit(Async)");
        }

        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling getAllDirectDeposit(Async)");
        }

        return getAllDirectDepositCall(companyId, employeeId, _callback);
     ...
     */
    public List<DirectDeposit> getAllDirectDeposit(String companyId, String employeeId) throws ApiException {
        ApiResponse<List<DirectDeposit>> localVarResp = getAllDirectDepositWithHttpInfo(companyId, employeeId);
     ...
     */
    public ApiResponse<List<DirectDeposit>> getAllDirectDepositWithHttpInfo(String companyId, String employeeId) throws ApiException {
        okhttp3.Call localVarCall = getAllDirectDepositValidateBeforeCall(companyId, employeeId, null);
        Type localVarReturnType = new TypeToken<List<DirectDeposit>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get All Direct Deposit (asynchronously)
     * Get All Direct Deposit returns main direct deposit and all additional direct depositsfor the selected employee.
     * @param companyId Company Id (required)
     * @param employeeId Employee Id (required)
     ...
     */
    public okhttp3.Call getAllDirectDepositAsync(String companyId, String employeeId, final ApiCallback<List<DirectDeposit>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllDirectDepositValidateBeforeCall(companyId, employeeId, _callback);
        Type localVarReturnType = new TypeToken<List<DirectDeposit>>(){}.getType();
