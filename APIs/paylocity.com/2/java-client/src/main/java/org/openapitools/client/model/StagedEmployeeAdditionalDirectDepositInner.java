...
public class StagedEmployeeAdditionalDirectDepositInner {
  ...
  public StagedEmployeeAdditionalDirectDepositInner() {
  }

  public StagedEmployeeAdditionalDirectDepositInner accountNumber(String accountNumber) {
  ...
  public StagedEmployeeAdditionalDirectDepositInner accountType(String accountType) {
  ...
  public StagedEmployeeAdditionalDirectDepositInner amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public StagedEmployeeAdditionalDirectDepositInner amountType(String amountType) {
  ...
  public StagedEmployeeAdditionalDirectDepositInner isSkipPreNote(Boolean isSkipPreNote) {
  ...
  public StagedEmployeeAdditionalDirectDepositInner preNoteDate(String preNoteDate) {
  ...
  public StagedEmployeeAdditionalDirectDepositInner routingNumber(String routingNumber) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeAdditionalDirectDepositInner stagedEmployeeAdditionalDirectDepositInner = (StagedEmployeeAdditionalDirectDepositInner) o;
    return Objects.equals(this.accountNumber, stagedEmployeeAdditionalDirectDepositInner.accountNumber) &&
        Objects.equals(this.accountType, stagedEmployeeAdditionalDirectDepositInner.accountType) &&
        Objects.equals(this.amount, stagedEmployeeAdditionalDirectDepositInner.amount) &&
        Objects.equals(this.amountType, stagedEmployeeAdditionalDirectDepositInner.amountType) &&
        Objects.equals(this.isSkipPreNote, stagedEmployeeAdditionalDirectDepositInner.isSkipPreNote) &&
        Objects.equals(this.preNoteDate, stagedEmployeeAdditionalDirectDepositInner.preNoteDate) &&
        Objects.equals(this.routingNumber, stagedEmployeeAdditionalDirectDepositInner.routingNumber);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountNumber, accountType, amount, amountType, isSkipPreNote, preNoteDate, routingNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeAdditionalDirectDepositInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeAdditionalDirectDepositInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeAdditionalDirectDepositInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeAdditionalDirectDepositInner is not found in the empty JSON string", StagedEmployeeAdditionalDirectDepositInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeAdditionalDirectDepositInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeAdditionalDirectDepositInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeAdditionalDirectDepositInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeAdditionalDirectDepositInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeAdditionalDirectDepositInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeAdditionalDirectDepositInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeAdditionalDirectDepositInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeAdditionalDirectDepositInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeAdditionalDirectDepositInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeAdditionalDirectDepositInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeAdditionalDirectDepositInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeAdditionalDirectDepositInner
   */
  public static StagedEmployeeAdditionalDirectDepositInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeAdditionalDirectDepositInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeAdditionalDirectDepositInner to an JSON string
   *
   * @return JSON string
   */
