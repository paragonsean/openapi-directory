...
public class EmployeeCustomDateFieldsInner {
  /**
  ...
  public EmployeeCustomDateFieldsInner() {
  }

  public EmployeeCustomDateFieldsInner category(CategoryEnum category) {
  ...
  public EmployeeCustomDateFieldsInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EmployeeCustomDateFieldsInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeCustomDateFieldsInner employeeCustomDateFieldsInner = (EmployeeCustomDateFieldsInner) o;
    return Objects.equals(this.category, employeeCustomDateFieldsInner.category) &&
        Objects.equals(this.label, employeeCustomDateFieldsInner.label) &&
        Objects.equals(this.value, employeeCustomDateFieldsInner.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, label, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeeCustomDateFieldsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeCustomDateFieldsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeCustomDateFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeCustomDateFieldsInner is not found in the empty JSON string", EmployeeCustomDateFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeCustomDateFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeCustomDateFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeCustomDateFieldsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeCustomDateFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeCustomDateFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeCustomDateFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeCustomDateFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeCustomDateFieldsInner>() {
           @Override
           public void write(JsonWriter out, EmployeeCustomDateFieldsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeCustomDateFieldsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeCustomDateFieldsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeCustomDateFieldsInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeCustomDateFieldsInner
   */
  public static EmployeeCustomDateFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeCustomDateFieldsInner.class);
  }

  /**
   * Convert an instance of EmployeeCustomDateFieldsInner to an JSON string
   *
   * @return JSON string
   */
