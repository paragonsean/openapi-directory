...
public class StagedEmployeeWebTime {
  ...
  public StagedEmployeeWebTime badgeNumber(String badgeNumber) {
  ...
  public StagedEmployeeWebTime chargeRate(BigDecimal chargeRate) {
  ...
  public StagedEmployeeWebTime isTimeLaborEnabled(Boolean isTimeLaborEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeWebTime stagedEmployeeWebTime = (StagedEmployeeWebTime) o;
    return Objects.equals(this.badgeNumber, stagedEmployeeWebTime.badgeNumber) &&
        Objects.equals(this.chargeRate, stagedEmployeeWebTime.chargeRate) &&
        Objects.equals(this.isTimeLaborEnabled, stagedEmployeeWebTime.isTimeLaborEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeWebTime {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeWebTime
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeWebTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeWebTime is not found in the empty JSON string", StagedEmployeeWebTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeWebTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeWebTime` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeWebTime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeWebTime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeWebTime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeWebTime.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeWebTime>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeWebTime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeWebTime read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeWebTime given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeWebTime
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeWebTime
   */
  public static StagedEmployeeWebTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeWebTime.class);
  }

  /**
   * Convert an instance of StagedEmployeeWebTime to an JSON string
   *
   * @return JSON string
   */
