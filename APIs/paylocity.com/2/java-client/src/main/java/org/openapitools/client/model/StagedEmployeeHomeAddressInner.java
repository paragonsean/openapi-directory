...
public class StagedEmployeeHomeAddressInner {
  ...
  public StagedEmployeeHomeAddressInner() {
  }

  public StagedEmployeeHomeAddressInner address1(String address1) {
  ...
  public StagedEmployeeHomeAddressInner address2(String address2) {
  ...
  public StagedEmployeeHomeAddressInner city(String city) {
    this.city = city;
    return this;
  }
  ...
  public StagedEmployeeHomeAddressInner country(String country) {
  ...
  public StagedEmployeeHomeAddressInner county(String county) {
    this.county = county;
    return this;
  }
  ...
  public StagedEmployeeHomeAddressInner emailAddress(String emailAddress) {
  ...
  public StagedEmployeeHomeAddressInner mobilePhone(String mobilePhone) {
  ...
  public StagedEmployeeHomeAddressInner phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public StagedEmployeeHomeAddressInner postalCode(String postalCode) {
  ...
  public StagedEmployeeHomeAddressInner state(String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeeHomeAddressInner stagedEmployeeHomeAddressInner = (StagedEmployeeHomeAddressInner) o;
    return Objects.equals(this.address1, stagedEmployeeHomeAddressInner.address1) &&
        Objects.equals(this.address2, stagedEmployeeHomeAddressInner.address2) &&
        Objects.equals(this.city, stagedEmployeeHomeAddressInner.city) &&
        Objects.equals(this.country, stagedEmployeeHomeAddressInner.country) &&
        Objects.equals(this.county, stagedEmployeeHomeAddressInner.county) &&
        Objects.equals(this.emailAddress, stagedEmployeeHomeAddressInner.emailAddress) &&
        Objects.equals(this.mobilePhone, stagedEmployeeHomeAddressInner.mobilePhone) &&
        Objects.equals(this.phone, stagedEmployeeHomeAddressInner.phone) &&
        Objects.equals(this.postalCode, stagedEmployeeHomeAddressInner.postalCode) &&
        Objects.equals(this.state, stagedEmployeeHomeAddressInner.state);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address1, address2, city, country, county, emailAddress, mobilePhone, phone, postalCode, state);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeeHomeAddressInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeeHomeAddressInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeeHomeAddressInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeeHomeAddressInner is not found in the empty JSON string", StagedEmployeeHomeAddressInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeeHomeAddressInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeeHomeAddressInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeeHomeAddressInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeeHomeAddressInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeeHomeAddressInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeeHomeAddressInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeeHomeAddressInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeeHomeAddressInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeeHomeAddressInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeeHomeAddressInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeeHomeAddressInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeeHomeAddressInner
   */
  public static StagedEmployeeHomeAddressInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeeHomeAddressInner.class);
  }

  /**
   * Convert an instance of StagedEmployeeHomeAddressInner to an JSON string
   *
   * @return JSON string
   */
