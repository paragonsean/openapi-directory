...
import org.openapitools.client.model.DirectDepositMainDirectDeposit;
...
public class DirectDeposit {
  ...
  private DirectDepositMainDirectDeposit mainDirectDeposit;

  public DirectDeposit() {
  }

  public DirectDeposit additionalDirectDeposit(List<DirectDepositAdditionalDirectDepositInner> additionalDirectDeposit) {
    this.additionalDirectDeposit = additionalDirectDeposit;
    return this;
  }

  public DirectDeposit addAdditionalDirectDepositItem(DirectDepositAdditionalDirectDepositInner additionalDirectDepositItem) {
  ...
  public DirectDeposit mainDirectDeposit(DirectDepositMainDirectDeposit mainDirectDeposit) {
   ...
   */
  @javax.annotation.Nullable
  public DirectDepositMainDirectDeposit getMainDirectDeposit() {
    return mainDirectDeposit;
  }

  public void setMainDirectDeposit(DirectDepositMainDirectDeposit mainDirectDeposit) {
    this.mainDirectDeposit = mainDirectDeposit;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additionalDirectDeposit, mainDirectDeposit);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DirectDeposit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DirectDeposit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DirectDeposit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DirectDeposit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("mainDirectDeposit") != null && !jsonObj.get("mainDirectDeposit").isJsonNull()) {
        DirectDepositMainDirectDeposit.validateJsonElement(jsonObj.get("mainDirectDeposit"));
      }
  }
