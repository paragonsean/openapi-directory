...
import org.openapitools.client.model.StagedEmployee;
import org.openapitools.client.model.TrackingNumberResponse;
...
public class EmployeeStagingApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public EmployeeStagingApi() {
        this(Configuration.getDefaultApiClient());
    }

    public EmployeeStagingApi(ApiClient apiClient) {
     ...
     * @param stagedEmployee StagedEmployee Model (required)
     ...
     */
    public okhttp3.Call addNewEmployeeToWebLinkCall(String companyId, StagedEmployee stagedEmployee, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = stagedEmployee;
    ...
    private okhttp3.Call addNewEmployeeToWebLinkValidateBeforeCall(String companyId, StagedEmployee stagedEmployee, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling addNewEmployeeToWebLink(Async)");
        }

        // verify the required parameter 'stagedEmployee' is set
        if (stagedEmployee == null) {
            throw new ApiException("Missing the required parameter 'stagedEmployee' when calling addNewEmployeeToWebLink(Async)");
        }

        return addNewEmployeeToWebLinkCall(companyId, stagedEmployee, _callback);
     ...
     */
    public List<TrackingNumberResponse> addNewEmployeeToWebLink(String companyId, StagedEmployee stagedEmployee) throws ApiException {
        ApiResponse<List<TrackingNumberResponse>> localVarResp = addNewEmployeeToWebLinkWithHttpInfo(companyId, stagedEmployee);
     ...
     */
    public ApiResponse<List<TrackingNumberResponse>> addNewEmployeeToWebLinkWithHttpInfo(String companyId, StagedEmployee stagedEmployee) throws ApiException {
        okhttp3.Call localVarCall = addNewEmployeeToWebLinkValidateBeforeCall(companyId, stagedEmployee, null);
        Type localVarReturnType = new TypeToken<List<TrackingNumberResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Add new employee to Web Link (asynchronously)
     * Add new employee to Web Link will send partially completed or potentially erroneous new hire record to Web Link, where it can be corrected and competed by company administrator or authorized Paylocity Service Bureau employee.
     * @param companyId Company Id (required)
     * @param stagedEmployee StagedEmployee Model (required)
     ...
     */
    public okhttp3.Call addNewEmployeeToWebLinkAsync(String companyId, StagedEmployee stagedEmployee, final ApiCallback<List<TrackingNumberResponse>> _callback) throws ApiException {

        okhttp3.Call localVarCall = addNewEmployeeToWebLinkValidateBeforeCall(companyId, stagedEmployee, _callback);
        Type localVarReturnType = new TypeToken<List<TrackingNumberResponse>>(){}.getType();
