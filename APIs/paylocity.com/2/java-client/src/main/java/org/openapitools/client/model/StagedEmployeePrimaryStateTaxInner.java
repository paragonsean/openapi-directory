...
public class StagedEmployeePrimaryStateTaxInner {
  ...
  public StagedEmployeePrimaryStateTaxInner() {
  }

  public StagedEmployeePrimaryStateTaxInner amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public StagedEmployeePrimaryStateTaxInner deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public StagedEmployeePrimaryStateTaxInner dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public StagedEmployeePrimaryStateTaxInner exemptions(BigDecimal exemptions) {
  ...
  public StagedEmployeePrimaryStateTaxInner exemptions2(BigDecimal exemptions2) {
  ...
  public StagedEmployeePrimaryStateTaxInner filingStatus(String filingStatus) {
  ...
  public StagedEmployeePrimaryStateTaxInner higherRate(Boolean higherRate) {
  ...
  public StagedEmployeePrimaryStateTaxInner otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public StagedEmployeePrimaryStateTaxInner percentage(BigDecimal percentage) {
  ...
  public StagedEmployeePrimaryStateTaxInner specialCheckCalc(String specialCheckCalc) {
  ...
  public StagedEmployeePrimaryStateTaxInner taxCalculationCode(String taxCalculationCode) {
  ...
  public StagedEmployeePrimaryStateTaxInner taxCode(String taxCode) {
  ...
  public StagedEmployeePrimaryStateTaxInner w4FormYear(Integer w4FormYear) {
  ...
  public boolean equals(Object o) {
    ...
    StagedEmployeePrimaryStateTaxInner stagedEmployeePrimaryStateTaxInner = (StagedEmployeePrimaryStateTaxInner) o;
    return Objects.equals(this.amount, stagedEmployeePrimaryStateTaxInner.amount) &&
        Objects.equals(this.deductionsAmount, stagedEmployeePrimaryStateTaxInner.deductionsAmount) &&
        Objects.equals(this.dependentsAmount, stagedEmployeePrimaryStateTaxInner.dependentsAmount) &&
        Objects.equals(this.exemptions, stagedEmployeePrimaryStateTaxInner.exemptions) &&
        Objects.equals(this.exemptions2, stagedEmployeePrimaryStateTaxInner.exemptions2) &&
        Objects.equals(this.filingStatus, stagedEmployeePrimaryStateTaxInner.filingStatus) &&
        Objects.equals(this.higherRate, stagedEmployeePrimaryStateTaxInner.higherRate) &&
        Objects.equals(this.otherIncomeAmount, stagedEmployeePrimaryStateTaxInner.otherIncomeAmount) &&
        Objects.equals(this.percentage, stagedEmployeePrimaryStateTaxInner.percentage) &&
        Objects.equals(this.specialCheckCalc, stagedEmployeePrimaryStateTaxInner.specialCheckCalc) &&
        Objects.equals(this.taxCalculationCode, stagedEmployeePrimaryStateTaxInner.taxCalculationCode) &&
        Objects.equals(this.taxCode, stagedEmployeePrimaryStateTaxInner.taxCode) &&
        Objects.equals(this.w4FormYear, stagedEmployeePrimaryStateTaxInner.w4FormYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class StagedEmployeePrimaryStateTaxInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StagedEmployeePrimaryStateTaxInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StagedEmployeePrimaryStateTaxInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StagedEmployeePrimaryStateTaxInner is not found in the empty JSON string", StagedEmployeePrimaryStateTaxInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StagedEmployeePrimaryStateTaxInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StagedEmployeePrimaryStateTaxInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StagedEmployeePrimaryStateTaxInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StagedEmployeePrimaryStateTaxInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StagedEmployeePrimaryStateTaxInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StagedEmployeePrimaryStateTaxInner.class));

       return (TypeAdapter<T>) new TypeAdapter<StagedEmployeePrimaryStateTaxInner>() {
           @Override
           public void write(JsonWriter out, StagedEmployeePrimaryStateTaxInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StagedEmployeePrimaryStateTaxInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StagedEmployeePrimaryStateTaxInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StagedEmployeePrimaryStateTaxInner
   * @throws IOException if the JSON string is invalid with respect to StagedEmployeePrimaryStateTaxInner
   */
  public static StagedEmployeePrimaryStateTaxInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StagedEmployeePrimaryStateTaxInner.class);
  }

  /**
   * Convert an instance of StagedEmployeePrimaryStateTaxInner to an JSON string
   *
   * @return JSON string
   */
