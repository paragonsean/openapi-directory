...
public class LocalTax {
  ...
  public LocalTax exemptions(BigDecimal exemptions) {
  ...
  public LocalTax exemptions2(BigDecimal exemptions2) {
  ...
  public LocalTax filingStatus(String filingStatus) {
  ...
  public LocalTax residentPSD(String residentPSD) {
  ...
  public LocalTax taxCode(String taxCode) {
  ...
  public LocalTax workPSD(String workPSD) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(exemptions, exemptions2, filingStatus, residentPSD, taxCode, workPSD);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LocalTax
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LocalTax.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LocalTax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LocalTax` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
