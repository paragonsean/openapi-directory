...
public class SensitiveDataEthnicityEthnicRacialIdentitiesInner {
  public static final String SERIALIZED_NAME_DESCRIPTION = "description";
  @SerializedName(SERIALIZED_NAME_DESCRIPTION)
  private String description;

  public SensitiveDataEthnicityEthnicRacialIdentitiesInner() {
  }

  public SensitiveDataEthnicityEthnicRacialIdentitiesInner description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataEthnicityEthnicRacialIdentitiesInner sensitiveDataEthnicityEthnicRacialIdentitiesInner = (SensitiveDataEthnicityEthnicRacialIdentitiesInner) o;
    return Objects.equals(this.description, sensitiveDataEthnicityEthnicRacialIdentitiesInner.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class SensitiveDataEthnicityEthnicRacialIdentitiesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SensitiveDataEthnicityEthnicRacialIdentitiesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitiveDataEthnicityEthnicRacialIdentitiesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SensitiveDataEthnicityEthnicRacialIdentitiesInner is not found in the empty JSON string", SensitiveDataEthnicityEthnicRacialIdentitiesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitiveDataEthnicityEthnicRacialIdentitiesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SensitiveDataEthnicityEthnicRacialIdentitiesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SensitiveDataEthnicityEthnicRacialIdentitiesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SensitiveDataEthnicityEthnicRacialIdentitiesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SensitiveDataEthnicityEthnicRacialIdentitiesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SensitiveDataEthnicityEthnicRacialIdentitiesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<SensitiveDataEthnicityEthnicRacialIdentitiesInner>() {
           @Override
           public void write(JsonWriter out, SensitiveDataEthnicityEthnicRacialIdentitiesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SensitiveDataEthnicityEthnicRacialIdentitiesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SensitiveDataEthnicityEthnicRacialIdentitiesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SensitiveDataEthnicityEthnicRacialIdentitiesInner
   * @throws IOException if the JSON string is invalid with respect to SensitiveDataEthnicityEthnicRacialIdentitiesInner
   */
  public static SensitiveDataEthnicityEthnicRacialIdentitiesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SensitiveDataEthnicityEthnicRacialIdentitiesInner.class);
  }

  /**
   * Convert an instance of SensitiveDataEthnicityEthnicRacialIdentitiesInner to an JSON string
   *
   * @return JSON string
   */
