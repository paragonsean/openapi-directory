...
public class EmployeePrimaryStateTax {
  ...
  public EmployeePrimaryStateTax amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  public EmployeePrimaryStateTax deductionsAmount(BigDecimal deductionsAmount) {
  ...
  public EmployeePrimaryStateTax dependentsAmount(BigDecimal dependentsAmount) {
  ...
  public EmployeePrimaryStateTax exemptions(BigDecimal exemptions) {
  ...
  public EmployeePrimaryStateTax exemptions2(BigDecimal exemptions2) {
  ...
  public EmployeePrimaryStateTax filingStatus(String filingStatus) {
  ...
  public EmployeePrimaryStateTax higherRate(Boolean higherRate) {
  ...
  public EmployeePrimaryStateTax otherIncomeAmount(BigDecimal otherIncomeAmount) {
  ...
  public EmployeePrimaryStateTax percentage(BigDecimal percentage) {
  ...
  public EmployeePrimaryStateTax specialCheckCalc(String specialCheckCalc) {
  ...
  public EmployeePrimaryStateTax taxCalculationCode(String taxCalculationCode) {
  ...
  public EmployeePrimaryStateTax taxCode(String taxCode) {
  ...
  public EmployeePrimaryStateTax w4FormYear(Integer w4FormYear) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeePrimaryStateTax employeePrimaryStateTax = (EmployeePrimaryStateTax) o;
    return Objects.equals(this.amount, employeePrimaryStateTax.amount) &&
        Objects.equals(this.deductionsAmount, employeePrimaryStateTax.deductionsAmount) &&
        Objects.equals(this.dependentsAmount, employeePrimaryStateTax.dependentsAmount) &&
        Objects.equals(this.exemptions, employeePrimaryStateTax.exemptions) &&
        Objects.equals(this.exemptions2, employeePrimaryStateTax.exemptions2) &&
        Objects.equals(this.filingStatus, employeePrimaryStateTax.filingStatus) &&
        Objects.equals(this.higherRate, employeePrimaryStateTax.higherRate) &&
        Objects.equals(this.otherIncomeAmount, employeePrimaryStateTax.otherIncomeAmount) &&
        Objects.equals(this.percentage, employeePrimaryStateTax.percentage) &&
        Objects.equals(this.specialCheckCalc, employeePrimaryStateTax.specialCheckCalc) &&
        Objects.equals(this.taxCalculationCode, employeePrimaryStateTax.taxCalculationCode) &&
        Objects.equals(this.taxCode, employeePrimaryStateTax.taxCode) &&
        Objects.equals(this.w4FormYear, employeePrimaryStateTax.w4FormYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeePrimaryStateTax {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeePrimaryStateTax
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeePrimaryStateTax.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeePrimaryStateTax is not found in the empty JSON string", EmployeePrimaryStateTax.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeePrimaryStateTax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeePrimaryStateTax` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeePrimaryStateTax.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeePrimaryStateTax' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeePrimaryStateTax> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeePrimaryStateTax.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeePrimaryStateTax>() {
           @Override
           public void write(JsonWriter out, EmployeePrimaryStateTax value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeePrimaryStateTax read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeePrimaryStateTax given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeePrimaryStateTax
   * @throws IOException if the JSON string is invalid with respect to EmployeePrimaryStateTax
   */
  public static EmployeePrimaryStateTax fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeePrimaryStateTax.class);
  }

  /**
   * Convert an instance of EmployeePrimaryStateTax to an JSON string
   *
   * @return JSON string
   */
