...
public class EmployeeInfo {
  ...
  public static final String SERIALIZED_NAME_STATUS_TYPE_CODE = "statusTypeCode";
  @SerializedName(SERIALIZED_NAME_STATUS_TYPE_CODE)
  private String statusTypeCode;

  public EmployeeInfo() {
  }

  public EmployeeInfo employeeId(String employeeId) {
  ...
  public EmployeeInfo statusCode(String statusCode) {
  ...
  public EmployeeInfo statusTypeCode(String statusTypeCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.employeeId, employeeInfo.employeeId) &&
        Objects.equals(this.statusCode, employeeInfo.statusCode) &&
        Objects.equals(this.statusTypeCode, employeeInfo.statusTypeCode);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(employeeId, statusCode, statusTypeCode);
  }
  ...
  public String toString() {
    ...
    sb.append("    statusTypeCode: ").append(toIndentedString(statusTypeCode)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("statusTypeCode");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeInfo is not found in the empty JSON string", EmployeeInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("statusTypeCode") != null && !jsonObj.get("statusTypeCode").isJsonNull()) && !jsonObj.get("statusTypeCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `statusTypeCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("statusTypeCode").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeInfo>() {
           @Override
           public void write(JsonWriter out, EmployeeInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeInfo
   * @throws IOException if the JSON string is invalid with respect to EmployeeInfo
   */
  public static EmployeeInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeInfo.class);
  }

  /**
   * Convert an instance of EmployeeInfo to an JSON string
   *
   * @return JSON string
   */
