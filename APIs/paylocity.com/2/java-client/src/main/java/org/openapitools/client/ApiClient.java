...
public class ApiClient {
    ...
    private String basePath = "https://api.paylocity.com/api";
    ...
    public ApiClient() {
        ...
        authentications.put("paylocity_auth", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.paylocity.com/api
