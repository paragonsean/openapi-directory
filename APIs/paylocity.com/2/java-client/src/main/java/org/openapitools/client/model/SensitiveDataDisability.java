...
public class SensitiveDataDisability {
  ...
  public static final String SERIALIZED_NAME_DISABILITY_CLASSIFICATIONS = "disabilityClassifications";
  @SerializedName(SERIALIZED_NAME_DISABILITY_CLASSIFICATIONS)
  private List<SensitiveDataDisabilityDisabilityClassificationsInner> disabilityClassifications = new ArrayList<>();

  public static final String SERIALIZED_NAME_HAS_DISABILITY = "hasDisability";
  @SerializedName(SERIALIZED_NAME_HAS_DISABILITY)
  private String hasDisability;

  public SensitiveDataDisability() {
  }

  public SensitiveDataDisability disability(String disability) {
  ...
  public SensitiveDataDisability disabilityClassifications(List<SensitiveDataDisabilityDisabilityClassificationsInner> disabilityClassifications) {
    this.disabilityClassifications = disabilityClassifications;
    return this;
  }

  public SensitiveDataDisability addDisabilityClassificationsItem(SensitiveDataDisabilityDisabilityClassificationsInner disabilityClassificationsItem) {
    if (this.disabilityClassifications == null) {
      this.disabilityClassifications = new ArrayList<>();
    }
    this.disabilityClassifications.add(disabilityClassificationsItem);
    return this;
  }

  /**
   * Add or update employee&#39;s disability classifications
   * @return disabilityClassifications
   */
  @javax.annotation.Nullable
  public List<SensitiveDataDisabilityDisabilityClassificationsInner> getDisabilityClassifications() {
    return disabilityClassifications;
  }

  public void setDisabilityClassifications(List<SensitiveDataDisabilityDisabilityClassificationsInner> disabilityClassifications) {
    this.disabilityClassifications = disabilityClassifications;
  }


  public SensitiveDataDisability hasDisability(String hasDisability) {
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataDisability sensitiveDataDisability = (SensitiveDataDisability) o;
    return Objects.equals(this.disability, sensitiveDataDisability.disability) &&
        Objects.equals(this.disabilityClassifications, sensitiveDataDisability.disabilityClassifications) &&
        Objects.equals(this.hasDisability, sensitiveDataDisability.hasDisability);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disability, disabilityClassifications, hasDisability);
  }
  ...
  public String toString() {
    ...
    sb.append("class SensitiveDataDisability {\n");
    sb.append("    disability: ").append(toIndentedString(disability)).append("\n");
    sb.append("    disabilityClassifications: ").append(toIndentedString(disabilityClassifications)).append("\n");
    sb.append("    hasDisability: ").append(toIndentedString(hasDisability)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("disabilityClassifications");
    openapiFields.add("hasDisability");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SensitiveDataDisability
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SensitiveDataDisability.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SensitiveDataDisability is not found in the empty JSON string", SensitiveDataDisability.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SensitiveDataDisability.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SensitiveDataDisability` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("disabilityClassifications") != null && !jsonObj.get("disabilityClassifications").isJsonNull()) {
        JsonArray jsonArraydisabilityClassifications = jsonObj.getAsJsonArray("disabilityClassifications");
        if (jsonArraydisabilityClassifications != null) {
          // ensure the json data is an array
          if (!jsonObj.get("disabilityClassifications").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `disabilityClassifications` to be an array in the JSON string but got `%s`", jsonObj.get("disabilityClassifications").toString()));
          }

          // validate the optional field `disabilityClassifications` (array)
          for (int i = 0; i < jsonArraydisabilityClassifications.size(); i++) {
            SensitiveDataDisabilityDisabilityClassificationsInner.validateJsonElement(jsonArraydisabilityClassifications.get(i));
          };
        }
      }
      if ((jsonObj.get("hasDisability") != null && !jsonObj.get("hasDisability").isJsonNull()) && !jsonObj.get("hasDisability").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `hasDisability` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hasDisability").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SensitiveDataDisability.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SensitiveDataDisability' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SensitiveDataDisability> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SensitiveDataDisability.class));

       return (TypeAdapter<T>) new TypeAdapter<SensitiveDataDisability>() {
           @Override
           public void write(JsonWriter out, SensitiveDataDisability value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SensitiveDataDisability read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SensitiveDataDisability given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SensitiveDataDisability
   * @throws IOException if the JSON string is invalid with respect to SensitiveDataDisability
   */
  public static SensitiveDataDisability fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SensitiveDataDisability.class);
  }

  /**
   * Convert an instance of SensitiveDataDisability to an JSON string
   *
   * @return JSON string
   */
