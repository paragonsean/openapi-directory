...
public class EmployeeWebTime {
  ...
  public static final String SERIALIZED_NAME_IS_TIME_LABOR_ENABLED = "isTimeLaborEnabled";
  @SerializedName(SERIALIZED_NAME_IS_TIME_LABOR_ENABLED)
  private Boolean isTimeLaborEnabled;

  public EmployeeWebTime() {
  }

  public EmployeeWebTime badgeNumber(String badgeNumber) {
  ...
  public EmployeeWebTime chargeRate(BigDecimal chargeRate) {
  ...
  public EmployeeWebTime isTimeLaborEnabled(Boolean isTimeLaborEnabled) {
   ...
   * @return isTimeLaborEnabled
   */
  @javax.annotation.Nullable
  public Boolean getIsTimeLaborEnabled() {
    return isTimeLaborEnabled;
  }

  public void setIsTimeLaborEnabled(Boolean isTimeLaborEnabled) {
    this.isTimeLaborEnabled = isTimeLaborEnabled;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeWebTime employeeWebTime = (EmployeeWebTime) o;
    return Objects.equals(this.badgeNumber, employeeWebTime.badgeNumber) &&
        Objects.equals(this.chargeRate, employeeWebTime.chargeRate) &&
        Objects.equals(this.isTimeLaborEnabled, employeeWebTime.isTimeLaborEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(badgeNumber, chargeRate, isTimeLaborEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeWebTime {\n");
    ...
    sb.append("    isTimeLaborEnabled: ").append(toIndentedString(isTimeLaborEnabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("isTimeLaborEnabled");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeWebTime
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeWebTime.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeWebTime is not found in the empty JSON string", EmployeeWebTime.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeWebTime.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeWebTime` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("badgeNumber") != null && !jsonObj.get("badgeNumber").isJsonNull()) && !jsonObj.get("badgeNumber").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeWebTime.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeWebTime' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeWebTime> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeWebTime.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeWebTime>() {
           @Override
           public void write(JsonWriter out, EmployeeWebTime value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeWebTime read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeWebTime given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeWebTime
   * @throws IOException if the JSON string is invalid with respect to EmployeeWebTime
   */
  public static EmployeeWebTime fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeWebTime.class);
  }

  /**
   * Convert an instance of EmployeeWebTime to an JSON string
   *
   * @return JSON string
   */
