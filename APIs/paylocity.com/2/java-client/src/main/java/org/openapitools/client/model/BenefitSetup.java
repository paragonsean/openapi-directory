...
public class BenefitSetup {
  ...
  public BenefitSetup benefitClass(String benefitClass) {
  ...
  public BenefitSetup benefitClassEffectiveDate(String benefitClassEffectiveDate) {
  ...
  public BenefitSetup benefitSalary(BigDecimal benefitSalary) {
  ...
  public BenefitSetup benefitSalaryEffectiveDate(String benefitSalaryEffectiveDate) {
  ...
  public BenefitSetup doNotApplyAdministrativePeriod(Boolean doNotApplyAdministrativePeriod) {
  ...
  public BenefitSetup isMeasureAcaEligibility(Boolean isMeasureAcaEligibility) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BenefitSetup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BenefitSetup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BenefitSetup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BenefitSetup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
