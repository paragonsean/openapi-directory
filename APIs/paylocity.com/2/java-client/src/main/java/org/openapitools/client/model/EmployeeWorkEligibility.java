...
public class EmployeeWorkEligibility {
  ...
  public EmployeeWorkEligibility alienOrAdmissionDocumentNumber(String alienOrAdmissionDocumentNumber) {
  ...
  public EmployeeWorkEligibility attestedDate(String attestedDate) {
  ...
  public EmployeeWorkEligibility countryOfIssuance(String countryOfIssuance) {
  ...
  public EmployeeWorkEligibility foreignPassportNumber(String foreignPassportNumber) {
  ...
  public EmployeeWorkEligibility i94AdmissionNumber(String i94AdmissionNumber) {
  ...
  public EmployeeWorkEligibility i9DateVerified(String i9DateVerified) {
  ...
  public EmployeeWorkEligibility i9Notes(String i9Notes) {
  ...
  public EmployeeWorkEligibility isI9Verified(Boolean isI9Verified) {
  ...
  public EmployeeWorkEligibility isSsnVerified(Boolean isSsnVerified) {
  ...
  public EmployeeWorkEligibility ssnDateVerified(String ssnDateVerified) {
  ...
  public EmployeeWorkEligibility ssnNotes(String ssnNotes) {
  ...
  public EmployeeWorkEligibility visaType(String visaType) {
  ...
  public EmployeeWorkEligibility workAuthorization(String workAuthorization) {
  ...
  public EmployeeWorkEligibility workUntil(String workUntil) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeWorkEligibility employeeWorkEligibility = (EmployeeWorkEligibility) o;
    return Objects.equals(this.alienOrAdmissionDocumentNumber, employeeWorkEligibility.alienOrAdmissionDocumentNumber) &&
        Objects.equals(this.attestedDate, employeeWorkEligibility.attestedDate) &&
        Objects.equals(this.countryOfIssuance, employeeWorkEligibility.countryOfIssuance) &&
        Objects.equals(this.foreignPassportNumber, employeeWorkEligibility.foreignPassportNumber) &&
        Objects.equals(this.i94AdmissionNumber, employeeWorkEligibility.i94AdmissionNumber) &&
        Objects.equals(this.i9DateVerified, employeeWorkEligibility.i9DateVerified) &&
        Objects.equals(this.i9Notes, employeeWorkEligibility.i9Notes) &&
        Objects.equals(this.isI9Verified, employeeWorkEligibility.isI9Verified) &&
        Objects.equals(this.isSsnVerified, employeeWorkEligibility.isSsnVerified) &&
        Objects.equals(this.ssnDateVerified, employeeWorkEligibility.ssnDateVerified) &&
        Objects.equals(this.ssnNotes, employeeWorkEligibility.ssnNotes) &&
        Objects.equals(this.visaType, employeeWorkEligibility.visaType) &&
        Objects.equals(this.workAuthorization, employeeWorkEligibility.workAuthorization) &&
        Objects.equals(this.workUntil, employeeWorkEligibility.workUntil);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeWorkEligibility {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeWorkEligibility
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeWorkEligibility.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeWorkEligibility is not found in the empty JSON string", EmployeeWorkEligibility.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeWorkEligibility.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeWorkEligibility` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeWorkEligibility.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeWorkEligibility' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeWorkEligibility> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeWorkEligibility.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeWorkEligibility>() {
           @Override
           public void write(JsonWriter out, EmployeeWorkEligibility value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeWorkEligibility read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeWorkEligibility given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeWorkEligibility
   * @throws IOException if the JSON string is invalid with respect to EmployeeWorkEligibility
   */
  public static EmployeeWorkEligibility fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeWorkEligibility.class);
  }

  /**
   * Convert an instance of EmployeeWorkEligibility to an JSON string
   *
   * @return JSON string
   */
