...
public class EmployeeCustomTextFieldsInner {
  /**
  ...
  public EmployeeCustomTextFieldsInner() {
  }

  public EmployeeCustomTextFieldsInner category(CategoryEnum category) {
  ...
  public EmployeeCustomTextFieldsInner label(String label) {
    this.label = label;
    return this;
  }
  ...
  public EmployeeCustomTextFieldsInner value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmployeeCustomTextFieldsInner employeeCustomTextFieldsInner = (EmployeeCustomTextFieldsInner) o;
    return Objects.equals(this.category, employeeCustomTextFieldsInner.category) &&
        Objects.equals(this.label, employeeCustomTextFieldsInner.label) &&
        Objects.equals(this.value, employeeCustomTextFieldsInner.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeCustomTextFieldsInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmployeeCustomTextFieldsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EmployeeCustomTextFieldsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeCustomTextFieldsInner is not found in the empty JSON string", EmployeeCustomTextFieldsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmployeeCustomTextFieldsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmployeeCustomTextFieldsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeCustomTextFieldsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeCustomTextFieldsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeCustomTextFieldsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeCustomTextFieldsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeCustomTextFieldsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeCustomTextFieldsInner>() {
           @Override
           public void write(JsonWriter out, EmployeeCustomTextFieldsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmployeeCustomTextFieldsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmployeeCustomTextFieldsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmployeeCustomTextFieldsInner
   * @throws IOException if the JSON string is invalid with respect to EmployeeCustomTextFieldsInner
   */
  public static EmployeeCustomTextFieldsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeCustomTextFieldsInner.class);
  }

  /**
   * Convert an instance of EmployeeCustomTextFieldsInner to an JSON string
   *
   * @return JSON string
   */
