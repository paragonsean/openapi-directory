...
public class EmployeeBenefitSetupApiTest {
    ...
    private final EmployeeBenefitSetupApi api = new EmployeeBenefitSetupApi();
     ...
     */
    @Test
    public void updateOrAddEmployeeBenefitSetupTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        BenefitSetup benefitSetup = null;
        api.updateOrAddEmployeeBenefitSetup(companyId, employeeId, benefitSetup);
