...
public class PayStatementsApiTest {
     ...
     */
    @Test
    public void getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearTest() throws ApiException {
        ...
        List<PayStatementDetails> response = api.getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear(companyId, employeeId, year, pagesize, pagenumber, includetotalcount, codegroup);
     ...
     */
    @Test
    public void getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDateTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        String year = null;
        ...
        Boolean includetotalcount = null;
        String codegroup = null;
        List<PayStatementDetails> response = api.getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate(companyId, employeeId, year, checkDate, pagesize, pagenumber, includetotalcount, codegroup);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        String year = null;
        Integer pagesize = null;
        ...
        Boolean includetotalcount = null;
        String codegroup = null;
        List<PayStatementSummary> response = api.getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear(companyId, employeeId, year, pagesize, pagenumber, includetotalcount, codegroup);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        String year = null;
        String checkDate = null;
        ...
        Boolean includetotalcount = null;
        String codegroup = null;
        List<PayStatementSummary> response = api.getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate(companyId, employeeId, year, checkDate, pagesize, pagenumber, includetotalcount, codegroup);
        // TODO: test validations
    }
