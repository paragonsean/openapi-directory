...
public class AdditionalRatesApiTest {
    ...
    private final AdditionalRatesApi api = new AdditionalRatesApi();
     ...
     */
    @Test
    public void addOrUpdateAdditionalRatesTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        AdditionalRate additionalRate = null;
        api.addOrUpdateAdditionalRates(companyId, employeeId, additionalRate);
