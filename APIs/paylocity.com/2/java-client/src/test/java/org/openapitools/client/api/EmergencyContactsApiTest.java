...
public class EmergencyContactsApiTest {
    ...
    private final EmergencyContactsApi api = new EmergencyContactsApi();
     ...
     */
    @Test
    public void addOrUpdateEmergencyContactsTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        EmergencyContact emergencyContact = null;
        api.addOrUpdateEmergencyContacts(companyId, employeeId, emergencyContact);
