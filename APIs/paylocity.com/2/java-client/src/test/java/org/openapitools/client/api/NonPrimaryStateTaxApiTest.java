...
public class NonPrimaryStateTaxApiTest {
    ...
    private final NonPrimaryStateTaxApi api = new NonPrimaryStateTaxApi();
     ...
     */
    @Test
    public void addOrUpdateNonPrimaryStateTaxTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        NonPrimaryStateTax nonPrimaryStateTax = null;
        api.addOrUpdateNonPrimaryStateTax(companyId, employeeId, nonPrimaryStateTax);
