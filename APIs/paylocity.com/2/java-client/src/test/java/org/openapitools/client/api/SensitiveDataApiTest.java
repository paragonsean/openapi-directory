...
import org.openapitools.client.model.SensitiveData;
...
public class SensitiveDataApiTest {
    ...
    private final SensitiveDataApi api = new SensitiveDataApi();
     ...
     */
    @Test
    public void addOrUpdateSensitiveDataTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        SensitiveData sensitiveData = null;
        api.addOrUpdateSensitiveData(companyId, employeeId, sensitiveData);
     ...
     */
    @Test
    public void getSensitiveDataTest() throws ApiException {
        String companyId = null;
        String employeeId = null;
        List<SensitiveData> response = api.getSensitiveData(companyId, employeeId);
        // TODO: test validations
    }
