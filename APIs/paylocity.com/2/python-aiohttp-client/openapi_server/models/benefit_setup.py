...
class BenefitSetup(Model):
    ...
    def __init__(self, benefit_class: str=None, benefit_class_effective_date: str=None, benefit_salary: float=None, benefit_salary_effective_date: str=None, do_not_apply_administrative_period: bool=None, is_measure_aca_eligibility: bool=None):
        """BenefitSetup - a model defined in OpenAPI

        :param benefit_class: The benefit_class of this BenefitSetup.
        :param benefit_class_effective_date: The benefit_class_effective_date of this BenefitSetup.
        :param benefit_salary: The benefit_salary of this BenefitSetup.
        :param benefit_salary_effective_date: The benefit_salary_effective_date of this BenefitSetup.
        :param do_not_apply_administrative_period: The do_not_apply_administrative_period of this BenefitSetup.
        :param is_measure_aca_eligibility: The is_measure_aca_eligibility of this BenefitSetup.
        """
        self.openapi_types = {
            'benefit_class': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BenefitSetup':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The benefitSetup of this BenefitSetup.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def benefit_class(self):
        """Gets the benefit_class of this BenefitSetup.

        Benefit Class code. Values are configured in Web Pay Company > Setup > Benefits > Classes.<br  />Max length: 30

        :return: The benefit_class of this BenefitSetup.
        :rtype: str
        """
    ...
    def benefit_class(self, benefit_class):
        """Sets the benefit_class of this BenefitSetup.
    ...
    def benefit_class_effective_date(self):
        """Gets the benefit_class_effective_date of this BenefitSetup.

        Date when Benefit Class takes effect. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.

        :return: The benefit_class_effective_date of this BenefitSetup.
        :rtype: str
        """
    ...
    def benefit_class_effective_date(self, benefit_class_effective_date):
        """Sets the benefit_class_effective_date of this BenefitSetup.
    ...
    def benefit_salary(self):
        """Gets the benefit_salary of this BenefitSetup.

        Salary used to configure benefits.<br  />Decimal(12,2)

        :return: The benefit_salary of this BenefitSetup.
        :rtype: float
        """
    ...
    def benefit_salary(self, benefit_salary):
        """Sets the benefit_salary of this BenefitSetup.
    ...
    def benefit_salary_effective_date(self):
        """Gets the benefit_salary_effective_date of this BenefitSetup.

        Date when Benefit Salary takes effect. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.

        :return: The benefit_salary_effective_date of this BenefitSetup.
        :rtype: str
        """
    ...
    def benefit_salary_effective_date(self, benefit_salary_effective_date):
        """Sets the benefit_salary_effective_date of this BenefitSetup.
    ...
    def do_not_apply_administrative_period(self):
        """Gets the do_not_apply_administrative_period of this BenefitSetup.

        Applicable only for HR Enhanced clients and Benefit Classes with ACA Employment Type of Full Time.

        :return: The do_not_apply_administrative_period of this BenefitSetup.
        :rtype: bool
        """
    ...
    def do_not_apply_administrative_period(self, do_not_apply_administrative_period):
        """Sets the do_not_apply_administrative_period of this BenefitSetup.
    ...
    def is_measure_aca_eligibility(self):
        """Gets the is_measure_aca_eligibility of this BenefitSetup.

        Only valid for HR Enhanced clients and Benefit Classes that are ACA Employment Type of Full Time.

        :return: The is_measure_aca_eligibility of this BenefitSetup.
        :rtype: bool
        """
    ...
    def is_measure_aca_eligibility(self, is_measure_aca_eligibility):
        """Sets the is_measure_aca_eligibility of this BenefitSetup.
