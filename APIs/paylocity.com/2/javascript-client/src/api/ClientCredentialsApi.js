...
* @module api/ClientCredentialsApi
* @version 2
*/
export default class ClientCredentialsApi {

    /**
    * Constructs a new ClientCredentialsApi. 
    * @alias module:api/ClientCredentialsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addClientSecret operation.
     * @callback module:api/ClientCredentialsApi~addClientSecretCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ClientCredentialsResponse>} data The data returned by the service call.
     ...
     * @param {module:model/AddClientSecret} addClientSecret Add Client Secret Model
     * @param {module:api/ClientCredentialsApi~addClientSecretCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ClientCredentialsResponse>}
     */
    addClientSecret(addClientSecret, callback) {
      let postBody = addClientSecret;
      // verify the required parameter 'addClientSecret' is set
      if (addClientSecret === undefined || addClientSecret === null) {
        throw new Error("Missing the required parameter 'addClientSecret' when calling addClientSecret");
      }
      ...
      let returnType = [ClientCredentialsResponse];
