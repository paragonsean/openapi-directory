...
/**
* DirectDeposit service.
* @module api/DirectDepositApi
* @version 2
*/
export default class DirectDepositApi {

    /**
    * Constructs a new DirectDepositApi. 
    * @alias module:api/DirectDepositApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllDirectDeposit operation.
     * @callback module:api/DirectDepositApi~getAllDirectDepositCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/DirectDeposit>} data The data returned by the service call.
     ...
     * @param {module:api/DirectDepositApi~getAllDirectDepositCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/DirectDeposit>}
     */
    getAllDirectDeposit(companyId, employeeId, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getAllDirectDeposit");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getAllDirectDeposit");
      }
