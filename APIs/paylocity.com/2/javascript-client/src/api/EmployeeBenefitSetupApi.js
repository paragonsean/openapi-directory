...
/**
* EmployeeBenefitSetup service.
* @module api/EmployeeBenefitSetupApi
* @version 2
*/
export default class EmployeeBenefitSetupApi {

    /**
    * Constructs a new EmployeeBenefitSetupApi. 
    * @alias module:api/EmployeeBenefitSetupApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the updateOrAddEmployeeBenefitSetup operation.
     * @callback module:api/EmployeeBenefitSetupApi~updateOrAddEmployeeBenefitSetupCallback
     ...
     * @param {module:model/BenefitSetup} benefitSetup BenefitSetup Model
     * @param {module:api/EmployeeBenefitSetupApi~updateOrAddEmployeeBenefitSetupCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateOrAddEmployeeBenefitSetup(companyId, employeeId, benefitSetup, callback) {
      let postBody = benefitSetup;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateOrAddEmployeeBenefitSetup");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling updateOrAddEmployeeBenefitSetup");
      }
      // verify the required parameter 'benefitSetup' is set
      if (benefitSetup === undefined || benefitSetup === null) {
        throw new Error("Missing the required parameter 'benefitSetup' when calling updateOrAddEmployeeBenefitSetup");
      }
