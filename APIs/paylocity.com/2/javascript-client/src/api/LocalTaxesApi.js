...
/**
* LocalTaxes service.
* @module api/LocalTaxesApi
* @version 2
*/
export default class LocalTaxesApi {

    /**
    * Constructs a new LocalTaxesApi. 
    * @alias module:api/LocalTaxesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addLocalTax operation.
     * @callback module:api/LocalTaxesApi~addLocalTaxCallback
     ...
     * @param {module:model/LocalTax} localTax LocalTax Model
     * @param {module:api/LocalTaxesApi~addLocalTaxCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addLocalTax(companyId, employeeId, localTax, callback) {
      let postBody = localTax;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addLocalTax");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addLocalTax");
      }
      // verify the required parameter 'localTax' is set
      if (localTax === undefined || localTax === null) {
        throw new Error("Missing the required parameter 'localTax' when calling addLocalTax");
      }
    ...
    /**
     * Callback function to receive the result of the deleteLocalTaxByTaxCode operation.
     * @callback module:api/LocalTaxesApi~deleteLocalTaxByTaxCodeCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/LocalTaxesApi~deleteLocalTaxByTaxCodeCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteLocalTaxByTaxCode(companyId, employeeId, taxCode, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteLocalTaxByTaxCode");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling deleteLocalTaxByTaxCode");
      }
      // verify the required parameter 'taxCode' is set
      if (taxCode === undefined || taxCode === null) {
        throw new Error("Missing the required parameter 'taxCode' when calling deleteLocalTaxByTaxCode");
      }
    ...
    /**
     * Callback function to receive the result of the getAllLocalTaxes operation.
     * @callback module:api/LocalTaxesApi~getAllLocalTaxesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LocalTax>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} companyId Company Id
     * @param {String} employeeId Employee Id
     * @param {module:api/LocalTaxesApi~getAllLocalTaxesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LocalTax>}
     */
    getAllLocalTaxes(companyId, employeeId, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getAllLocalTaxes");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getAllLocalTaxes");
      }
    ...
    /**
     * Callback function to receive the result of the getLocalTaxByTaxCode operation.
     * @callback module:api/LocalTaxesApi~getLocalTaxByTaxCodeCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/LocalTax>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} employeeId Employee Id
     * @param {String} taxCode Tax Code
     * @param {module:api/LocalTaxesApi~getLocalTaxByTaxCodeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/LocalTax>}
     */
    getLocalTaxByTaxCode(companyId, employeeId, taxCode, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getLocalTaxByTaxCode");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getLocalTaxByTaxCode");
      }
      // verify the required parameter 'taxCode' is set
      if (taxCode === undefined || taxCode === null) {
        throw new Error("Missing the required parameter 'taxCode' when calling getLocalTaxByTaxCode");
      }
