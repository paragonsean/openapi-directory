...
/**
* PrimaryStateTax service.
* @module api/PrimaryStateTaxApi
* @version 2
*/
export default class PrimaryStateTaxApi {

    /**
    * Constructs a new PrimaryStateTaxApi. 
    * @alias module:api/PrimaryStateTaxApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrUpdatePrimaryStateTax operation.
     * @callback module:api/PrimaryStateTaxApi~addOrUpdatePrimaryStateTaxCallback
     ...
     * @param {module:model/StateTax} stateTax Primary State Tax Model
     * @param {module:api/PrimaryStateTaxApi~addOrUpdatePrimaryStateTaxCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addOrUpdatePrimaryStateTax(companyId, employeeId, stateTax, callback) {
      let postBody = stateTax;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addOrUpdatePrimaryStateTax");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addOrUpdatePrimaryStateTax");
      }
      // verify the required parameter 'stateTax' is set
      if (stateTax === undefined || stateTax === null) {
        throw new Error("Missing the required parameter 'stateTax' when calling addOrUpdatePrimaryStateTax");
      }
