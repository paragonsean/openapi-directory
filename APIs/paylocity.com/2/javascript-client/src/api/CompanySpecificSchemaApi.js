...
/**
* CompanySpecificSchema service.
* @module api/CompanySpecificSchemaApi
* @version 2
*/
export default class CompanySpecificSchemaApi {

    /**
    * Constructs a new CompanySpecificSchemaApi. 
    * @alias module:api/CompanySpecificSchemaApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCompanySpecificOpenAPIDocumentation operation.
     * @callback module:api/CompanySpecificSchemaApi~getCompanySpecificOpenAPIDocumentationCallback
     ...
     * @param {module:api/CompanySpecificSchemaApi~getCompanySpecificOpenAPIDocumentationCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getCompanySpecificOpenAPIDocumentation(authorization, companyId, callback) {
      let postBody = null;
      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling getCompanySpecificOpenAPIDocumentation");
      }
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getCompanySpecificOpenAPIDocumentation");
      }
