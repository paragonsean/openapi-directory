...
/**
* Earnings service.
* @module api/EarningsApi
* @version 2
*/
export default class EarningsApi {

    /**
    * Constructs a new EarningsApi. 
    * @alias module:api/EarningsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrUpdateAnEmployeeEarning operation.
     * @callback module:api/EarningsApi~addOrUpdateAnEmployeeEarningCallback
     ...
     * @param {module:model/Earning} earning Earning Model
     * @param {module:api/EarningsApi~addOrUpdateAnEmployeeEarningCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addOrUpdateAnEmployeeEarning(companyId, employeeId, earning, callback) {
      let postBody = earning;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addOrUpdateAnEmployeeEarning");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addOrUpdateAnEmployeeEarning");
      }
      // verify the required parameter 'earning' is set
      if (earning === undefined || earning === null) {
        throw new Error("Missing the required parameter 'earning' when calling addOrUpdateAnEmployeeEarning");
      }
    ...
    /**
     * Callback function to receive the result of the deleteEarningByEarningCodeAndStartDate operation.
     * @callback module:api/EarningsApi~deleteEarningByEarningCodeAndStartDateCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/EarningsApi~deleteEarningByEarningCodeAndStartDateCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteEarningByEarningCodeAndStartDate(companyId, employeeId, earningCode, startDate, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteEarningByEarningCodeAndStartDate");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling deleteEarningByEarningCodeAndStartDate");
      }
      // verify the required parameter 'earningCode' is set
      if (earningCode === undefined || earningCode === null) {
        throw new Error("Missing the required parameter 'earningCode' when calling deleteEarningByEarningCodeAndStartDate");
      }
      // verify the required parameter 'startDate' is set
      if (startDate === undefined || startDate === null) {
        throw new Error("Missing the required parameter 'startDate' when calling deleteEarningByEarningCodeAndStartDate");
      }
    ...
    /**
     * Callback function to receive the result of the getAllEarnings operation.
     * @callback module:api/EarningsApi~getAllEarningsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Earning>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} companyId Company Id
     * @param {String} employeeId Employee Id
     * @param {module:api/EarningsApi~getAllEarningsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Earning>}
     */
    getAllEarnings(companyId, employeeId, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getAllEarnings");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getAllEarnings");
      }
    ...
    /**
     * Callback function to receive the result of the getEarningByEarningCodeAndStartDate operation.
     * @callback module:api/EarningsApi~getEarningByEarningCodeAndStartDateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Earning} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} earningCode Earning Code
     * @param {String} startDate Start Date
     * @param {module:api/EarningsApi~getEarningByEarningCodeAndStartDateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Earning}
     */
    getEarningByEarningCodeAndStartDate(companyId, employeeId, earningCode, startDate, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getEarningByEarningCodeAndStartDate");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getEarningByEarningCodeAndStartDate");
      }
      // verify the required parameter 'earningCode' is set
      if (earningCode === undefined || earningCode === null) {
        throw new Error("Missing the required parameter 'earningCode' when calling getEarningByEarningCodeAndStartDate");
      }
      // verify the required parameter 'startDate' is set
      if (startDate === undefined || startDate === null) {
        throw new Error("Missing the required parameter 'startDate' when calling getEarningByEarningCodeAndStartDate");
      }
    ...
    /**
     * Callback function to receive the result of the getEarningsByEarningCode operation.
     * @callback module:api/EarningsApi~getEarningsByEarningCodeCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Earning>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} employeeId Employee Id
     * @param {String} earningCode Earning Code
     * @param {module:api/EarningsApi~getEarningsByEarningCodeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Earning>}
     */
    getEarningsByEarningCode(companyId, employeeId, earningCode, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getEarningsByEarningCode");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getEarningsByEarningCode");
      }
      // verify the required parameter 'earningCode' is set
      if (earningCode === undefined || earningCode === null) {
        throw new Error("Missing the required parameter 'earningCode' when calling getEarningsByEarningCode");
      }
