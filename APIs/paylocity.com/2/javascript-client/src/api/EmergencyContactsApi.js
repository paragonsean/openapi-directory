...
/**
* EmergencyContacts service.
* @module api/EmergencyContactsApi
* @version 2
*/
export default class EmergencyContactsApi {

    /**
    * Constructs a new EmergencyContactsApi. 
    * @alias module:api/EmergencyContactsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrUpdateEmergencyContacts operation.
     * @callback module:api/EmergencyContactsApi~addOrUpdateEmergencyContactsCallback
     ...
     * @param {module:model/EmergencyContact} emergencyContact Emergency Contact Model
     * @param {module:api/EmergencyContactsApi~addOrUpdateEmergencyContactsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addOrUpdateEmergencyContacts(companyId, employeeId, emergencyContact, callback) {
      let postBody = emergencyContact;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addOrUpdateEmergencyContacts");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addOrUpdateEmergencyContacts");
      }
      // verify the required parameter 'emergencyContact' is set
      if (emergencyContact === undefined || emergencyContact === null) {
        throw new Error("Missing the required parameter 'emergencyContact' when calling addOrUpdateEmergencyContacts");
      }
