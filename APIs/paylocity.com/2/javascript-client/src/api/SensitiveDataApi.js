...
/**
* SensitiveData service.
* @module api/SensitiveDataApi
* @version 2
*/
export default class SensitiveDataApi {

    /**
    * Constructs a new SensitiveDataApi. 
    * @alias module:api/SensitiveDataApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrUpdateSensitiveData operation.
     * @callback module:api/SensitiveDataApi~addOrUpdateSensitiveDataCallback
     ...
     * @param {module:model/SensitiveData} sensitiveData Sensitive Data Model
     * @param {module:api/SensitiveDataApi~addOrUpdateSensitiveDataCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addOrUpdateSensitiveData(companyId, employeeId, sensitiveData, callback) {
      let postBody = sensitiveData;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addOrUpdateSensitiveData");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addOrUpdateSensitiveData");
      }
      // verify the required parameter 'sensitiveData' is set
      if (sensitiveData === undefined || sensitiveData === null) {
        throw new Error("Missing the required parameter 'sensitiveData' when calling addOrUpdateSensitiveData");
      }
    ...
    /**
     * Callback function to receive the result of the getSensitiveData operation.
     * @callback module:api/SensitiveDataApi~getSensitiveDataCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SensitiveData>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} companyId Company Id
     * @param {String} employeeId Employee Id
     * @param {module:api/SensitiveDataApi~getSensitiveDataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SensitiveData>}
     */
    getSensitiveData(companyId, employeeId, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getSensitiveData");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getSensitiveData");
      }
