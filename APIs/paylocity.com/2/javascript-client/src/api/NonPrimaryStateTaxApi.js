...
/**
* NonPrimaryStateTax service.
* @module api/NonPrimaryStateTaxApi
* @version 2
*/
export default class NonPrimaryStateTaxApi {

    /**
    * Constructs a new NonPrimaryStateTaxApi. 
    * @alias module:api/NonPrimaryStateTaxApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrUpdateNonPrimaryStateTax operation.
     * @callback module:api/NonPrimaryStateTaxApi~addOrUpdateNonPrimaryStateTaxCallback
     ...
     * @param {module:model/NonPrimaryStateTax} nonPrimaryStateTax Non-Primary State Tax Model
     * @param {module:api/NonPrimaryStateTaxApi~addOrUpdateNonPrimaryStateTaxCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addOrUpdateNonPrimaryStateTax(companyId, employeeId, nonPrimaryStateTax, callback) {
      let postBody = nonPrimaryStateTax;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addOrUpdateNonPrimaryStateTax");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addOrUpdateNonPrimaryStateTax");
      }
      // verify the required parameter 'nonPrimaryStateTax' is set
      if (nonPrimaryStateTax === undefined || nonPrimaryStateTax === null) {
        throw new Error("Missing the required parameter 'nonPrimaryStateTax' when calling addOrUpdateNonPrimaryStateTax");
      }
