...
/**
* EmployeeStaging service.
* @module api/EmployeeStagingApi
* @version 2
*/
export default class EmployeeStagingApi {

    /**
    * Constructs a new EmployeeStagingApi. 
    * @alias module:api/EmployeeStagingApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addNewEmployeeToWebLink operation.
     * @callback module:api/EmployeeStagingApi~addNewEmployeeToWebLinkCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/TrackingNumberResponse>} data The data returned by the service call.
     ...
     * @param {module:model/StagedEmployee} stagedEmployee StagedEmployee Model
     * @param {module:api/EmployeeStagingApi~addNewEmployeeToWebLinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/TrackingNumberResponse>}
     */
    addNewEmployeeToWebLink(companyId, stagedEmployee, callback) {
      let postBody = stagedEmployee;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addNewEmployeeToWebLink");
      }
      // verify the required parameter 'stagedEmployee' is set
      if (stagedEmployee === undefined || stagedEmployee === null) {
        throw new Error("Missing the required parameter 'stagedEmployee' when calling addNewEmployeeToWebLink");
      }
      ...
      let returnType = [TrackingNumberResponse];
