...
/**
* CompanyCodes service.
* @module api/CompanyCodesApi
* @version 2
*/
export default class CompanyCodesApi {

    /**
    * Constructs a new CompanyCodesApi. 
    * @alias module:api/CompanyCodesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllCompanyCodesAndDescriptionsByResource operation.
     * @callback module:api/CompanyCodesApi~getAllCompanyCodesAndDescriptionsByResourceCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/CompanyCodes>} data The data returned by the service call.
     ...
     * @param {module:api/CompanyCodesApi~getAllCompanyCodesAndDescriptionsByResourceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CompanyCodes>}
     */
    getAllCompanyCodesAndDescriptionsByResource(companyId, codeResource, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getAllCompanyCodesAndDescriptionsByResource");
      }
      // verify the required parameter 'codeResource' is set
      if (codeResource === undefined || codeResource === null) {
        throw new Error("Missing the required parameter 'codeResource' when calling getAllCompanyCodesAndDescriptionsByResource");
      }
