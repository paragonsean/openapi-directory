...
/**
* PayStatements service.
* @module api/PayStatementsApi
* @version 2
*/
export default class PayStatementsApi {

    /**
    * Constructs a new PayStatementsApi. 
    * @alias module:api/PayStatementsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear operation.
     * @callback module:api/PayStatementsApi~getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/PayStatementDetails>} data The data returned by the service call.
     ...
     * @param {module:api/PayStatementsApi~getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PayStatementDetails>}
     */
    getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear(companyId, employeeId, year, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear");
      }
      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear");
      }
      ...
      let returnType = [PayStatementDetails];
    ...
    /**
     * Callback function to receive the result of the getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate operation.
     * @callback module:api/PayStatementsApi~getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDateCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/PayStatementDetails>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [includetotalcount] Whether to include the total record count in the header's X-Pcty-Total-Count property. Default value is true.
     * @param {String} [codegroup] Retrieve pay statement details related to specific deduction, earning or tax types. Common values include 401k, Memo, Reg, OT, Cash Tips, FED and SITW.
     * @param {module:api/PayStatementsApi~getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PayStatementDetails>}
     */
    getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate(companyId, employeeId, year, checkDate, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate");
      }
      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate");
      }
      // verify the required parameter 'checkDate' is set
      if (checkDate === undefined || checkDate === null) {
        throw new Error("Missing the required parameter 'checkDate' when calling getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate");
      }
    ...
    /**
     * Callback function to receive the result of the getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear operation.
     * @callback module:api/PayStatementsApi~getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/PayStatementSummary>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [includetotalcount] Whether to include the total record count in the header's X-Pcty-Total-Count property. Default value is true.
     * @param {String} [codegroup] Retrieve pay statement details related to specific deduction, earning or tax types. Common values include 401k, Memo, Reg, OT, Cash Tips, FED and SITW.
     * @param {module:api/PayStatementsApi~getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PayStatementSummary>}
     */
    getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear(companyId, employeeId, year, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear");
      }
      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [PayStatementSummary];
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate operation.
     * @callback module:api/PayStatementsApi~getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/PayStatementSummary>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Boolean} [includetotalcount] Whether to include the total record count in the header's X-Pcty-Total-Count property. Default value is true.
     * @param {String} [codegroup] Retrieve pay statement details related to specific deduction, earning or tax types. Common values include 401k, Memo, Reg, OT, Cash Tips, FED and SITW.
     * @param {module:api/PayStatementsApi~getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/PayStatementSummary>}
     */
    getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate(companyId, employeeId, year, checkDate, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate");
      }
      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate");
      }
      // verify the required parameter 'checkDate' is set
      if (checkDate === undefined || checkDate === null) {
        throw new Error("Missing the required parameter 'checkDate' when calling getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate");
      }
