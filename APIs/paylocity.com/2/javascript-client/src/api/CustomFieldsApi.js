...
export default class CustomFieldsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAllCustomFieldsByCategory operation.
     * @callback module:api/CustomFieldsApi~getAllCustomFieldsByCategoryCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/CustomFieldDefinition>} data The data returned by the service call.
     ...
     * @param {module:api/CustomFieldsApi~getAllCustomFieldsByCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CustomFieldDefinition>}
     */
    getAllCustomFieldsByCategory(companyId, category, callback) {
      let postBody = null;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling getAllCustomFieldsByCategory");
      }
      // verify the required parameter 'category' is set
      if (category === undefined || category === null) {
        throw new Error("Missing the required parameter 'category' when calling getAllCustomFieldsByCategory");
      }
      ...
      let returnType = [CustomFieldDefinition];
