...
/**
* AdditionalRates service.
* @module api/AdditionalRatesApi
* @version 2
*/
export default class AdditionalRatesApi {

    /**
    * Constructs a new AdditionalRatesApi. 
    * @alias module:api/AdditionalRatesApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrUpdateAdditionalRates operation.
     * @callback module:api/AdditionalRatesApi~addOrUpdateAdditionalRatesCallback
     ...
     * @param {module:model/AdditionalRate} additionalRate Additional Rate Model
     * @param {module:api/AdditionalRatesApi~addOrUpdateAdditionalRatesCallback} callback The callback function, accepting three arguments: error, data, response
     */
    addOrUpdateAdditionalRates(companyId, employeeId, additionalRate, callback) {
      let postBody = additionalRate;
      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling addOrUpdateAdditionalRates");
      }
      // verify the required parameter 'employeeId' is set
      if (employeeId === undefined || employeeId === null) {
        throw new Error("Missing the required parameter 'employeeId' when calling addOrUpdateAdditionalRates");
      }
      // verify the required parameter 'additionalRate' is set
      if (additionalRate === undefined || additionalRate === null) {
        throw new Error("Missing the required parameter 'additionalRate' when calling addOrUpdateAdditionalRates");
      }
