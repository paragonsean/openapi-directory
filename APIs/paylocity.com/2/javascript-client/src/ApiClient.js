...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://api.paylocity.com/api') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://api.paylocity.com/api
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2/Javascript'
        };
