...
/**
 * The EmployeePrimaryStateTax model module.
 * @module model/EmployeePrimaryStateTax
 * @version 2
 */
class EmployeePrimaryStateTax {
    /**
     * Constructs a new <code>EmployeePrimaryStateTax</code>.
     ...
     * @alias module:model/EmployeePrimaryStateTax
     */
    constructor() { 
        
        EmployeePrimaryStateTax.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeePrimaryStateTax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeePrimaryStateTax} obj Optional instance to populate.
     * @return {module:model/EmployeePrimaryStateTax} The populated <code>EmployeePrimaryStateTax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeePrimaryStateTax();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeePrimaryStateTax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeePrimaryStateTax</code>.
     */
 ...
 */
EmployeePrimaryStateTax.prototype['specialCheckCalc'] = undefined;
 ...
 */
EmployeePrimaryStateTax.prototype['taxCalculationCode'] = undefined;

/**
 * State tax code.<br  /> Max length: 50
 * @member {String} taxCode
 */
EmployeePrimaryStateTax.prototype['taxCode'] = undefined;

/**
 * The state W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
EmployeePrimaryStateTax.prototype['w4FormYear'] = undefined;
...
export default EmployeePrimaryStateTax;
