...
/**
 * The EmployeePrimaryPayRate model module.
 * @module model/EmployeePrimaryPayRate
 * @version 2
 */
class EmployeePrimaryPayRate {
    /**
     * Constructs a new <code>EmployeePrimaryPayRate</code>.
     * Add or update hourly or salary pay rate, effective date, and pay frequency.
     * @alias module:model/EmployeePrimaryPayRate
     */
    constructor() { 
        
        EmployeePrimaryPayRate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeePrimaryPayRate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeePrimaryPayRate} obj Optional instance to populate.
     * @return {module:model/EmployeePrimaryPayRate} The populated <code>EmployeePrimaryPayRate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeePrimaryPayRate();
            ...
            if (data.hasOwnProperty('beginCheckDate')) {
                obj['beginCheckDate'] = ApiClient.convertToType(data['beginCheckDate'], 'String');
            }
            ...
            if (data.hasOwnProperty('payRateNote')) {
                obj['payRateNote'] = ApiClient.convertToType(data['payRateNote'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeePrimaryPayRate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeePrimaryPayRate</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['beginCheckDate'] && !(typeof data['beginCheckDate'] === 'string' || data['beginCheckDate'] instanceof String)) {
            throw new Error("Expected the field `beginCheckDate` to be a primitive type in the JSON string but got " + data['beginCheckDate']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['payRateNote'] && !(typeof data['payRateNote'] === 'string' || data['payRateNote'] instanceof String)) {
            throw new Error("Expected the field `payRateNote` to be a primitive type in the JSON string but got " + data['payRateNote']);
        }
        // ensure the json data is a string
 ...
 */
EmployeePrimaryPayRate.prototype['annualSalary'] = undefined;

/**
 * Employee base rate, used for Hourly employees. <br  />Decimal (12,6)
 * @member {Number} baseRate
 */
EmployeePrimaryPayRate.prototype['baseRate'] = undefined;
 ...
 * @member {String} beginCheckDate
 */
EmployeePrimaryPayRate.prototype['beginCheckDate'] = undefined;

/**
 * Pay rate change reason.<br  /> Max length: 30
 * @member {String} changeReason
 */
EmployeePrimaryPayRate.prototype['changeReason'] = undefined;
 ...
 */
EmployeePrimaryPayRate.prototype['payFrequency'] = undefined;

/**
 * Employee pay grade. Must match Company setup. <br  /> Max length: 10
 * @member {String} payGrade
 */
EmployeePrimaryPayRate.prototype['payGrade'] = undefined;

/**
 * Pay rate notes regarding employee.<br  /> Max length: 250
 * @member {String} payRateNote
 */
EmployeePrimaryPayRate.prototype['payRateNote'] = undefined;

/**
 * Employee pay type (rate code). Valid values are *Hourly* or *Salary*. <br  />Max length: 10
 * @member {String} payType
 */
EmployeePrimaryPayRate.prototype['payType'] = undefined;
 ...
 */
EmployeePrimaryPayRate.prototype['ratePer'] = undefined;

/**
 * Employee gross salary per pay period used with payType Salary.<br  />Decimal (12,6)
 * @member {Number} salary
 */
EmployeePrimaryPayRate.prototype['salary'] = undefined;
...
export default EmployeePrimaryPayRate;
