...
/**
 * The StagedEmployeeWebTime model module.
 * @module model/StagedEmployeeWebTime
 * @version 2
 */
class StagedEmployeeWebTime {
    /**
     * Constructs a new <code>StagedEmployeeWebTime</code>.
     * Add Web Time badge number and charge rate and synchronize Web Pay and Web Time employee data.
     * @alias module:model/StagedEmployeeWebTime
     */
    constructor() { 
        
        StagedEmployeeWebTime.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeWebTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeWebTime} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeWebTime} The populated <code>StagedEmployeeWebTime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeWebTime();

            if (data.hasOwnProperty('badgeNumber')) {
                obj['badgeNumber'] = ApiClient.convertToType(data['badgeNumber'], 'String');
            }
            if (data.hasOwnProperty('chargeRate')) {
                obj['chargeRate'] = ApiClient.convertToType(data['chargeRate'], 'Number');
            }
            if (data.hasOwnProperty('isTimeLaborEnabled')) {
                obj['isTimeLaborEnabled'] = ApiClient.convertToType(data['isTimeLaborEnabled'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeWebTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeWebTime</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['badgeNumber'] && !(typeof data['badgeNumber'] === 'string' || data['badgeNumber'] instanceof String)) {
            throw new Error("Expected the field `badgeNumber` to be a primitive type in the JSON string but got " + data['badgeNumber']);
        }
 ...
 * @member {String} badgeNumber
 */
StagedEmployeeWebTime.prototype['badgeNumber'] = undefined;
 ...
 */
StagedEmployeeWebTime.prototype['chargeRate'] = undefined;

/**
 * If set to true, changes to employee data will be reflected in Web Time.
 * @member {Boolean} isTimeLaborEnabled
 */
StagedEmployeeWebTime.prototype['isTimeLaborEnabled'] = undefined;
...
export default StagedEmployeeWebTime;
