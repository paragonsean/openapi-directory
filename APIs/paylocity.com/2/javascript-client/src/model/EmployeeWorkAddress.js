...
/**
 * The EmployeeWorkAddress model module.
 * @module model/EmployeeWorkAddress
 * @version 2
 */
class EmployeeWorkAddress {
    /**
     * Constructs a new <code>EmployeeWorkAddress</code>.
     * Add or update employee&#39;s work address, phone numbers, and email. Work Location drop down field is not included.
     * @alias module:model/EmployeeWorkAddress
     */
    constructor() { 
        
        EmployeeWorkAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeWorkAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeWorkAddress} obj Optional instance to populate.
     * @return {module:model/EmployeeWorkAddress} The populated <code>EmployeeWorkAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeWorkAddress();
            ...
            if (data.hasOwnProperty('mailStop')) {
                obj['mailStop'] = ApiClient.convertToType(data['mailStop'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeWorkAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeWorkAddress</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['mailStop'] && !(typeof data['mailStop'] === 'string' || data['mailStop'] instanceof String)) {
            throw new Error("Expected the field `mailStop` to be a primitive type in the JSON string but got " + data['mailStop']);
        }
        // ensure the json data is a string
 ...
 */
EmployeeWorkAddress.prototype['address1'] = undefined;

/**
 * 2nd address line. <br  /> Max length: 40
 * @member {String} address2
 */
EmployeeWorkAddress.prototype['address2'] = undefined;

/**
 * City.<br  /> Max length: 40
 * @member {String} city
 */
EmployeeWorkAddress.prototype['city'] = undefined;

/**
 * Country.<br  /> Max length: 30
 * @member {String} country
 */
EmployeeWorkAddress.prototype['country'] = undefined;

/**
 * County.<br  /> Max length: 30
 * @member {String} county
 */
EmployeeWorkAddress.prototype['county'] = undefined;

/**
 * Email. <br  />Max length: 50
 * @member {String} emailAddress
 */
EmployeeWorkAddress.prototype['emailAddress'] = undefined;

/**
 * Work Location name. <br />Max length: 50
 * @member {String} location
 */
EmployeeWorkAddress.prototype['location'] = undefined;

/**
 * Employee mail stop.<br  /> Max length: 10
 * @member {String} mailStop
 */
EmployeeWorkAddress.prototype['mailStop'] = undefined;

/**
 * Mobile phone number.<br  /> Max length: 20
 * @member {String} mobilePhone
 */
EmployeeWorkAddress.prototype['mobilePhone'] = undefined;

/**
 * Employee pager number.<br  /> Max length: 20
 * @member {String} pager
 */
EmployeeWorkAddress.prototype['pager'] = undefined;

/**
 * Phone number.<br  /> Max length: 20
 * @member {String} phone
 */
EmployeeWorkAddress.prototype['phone'] = undefined;

/**
 * Phone number extension.<br  /> Max length: 10
 * @member {String} phoneExtension
 */
EmployeeWorkAddress.prototype['phoneExtension'] = undefined;

/**
 * Postal code.<br  /> Max length: 10
 * @member {String} postalCode
 */
EmployeeWorkAddress.prototype['postalCode'] = undefined;

/**
 * State or province.<br  /> Max length: 2
 * @member {String} state
 */
EmployeeWorkAddress.prototype['state'] = undefined;
...
export default EmployeeWorkAddress;
