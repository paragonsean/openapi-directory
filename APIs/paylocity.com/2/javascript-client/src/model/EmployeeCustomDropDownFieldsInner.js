...
/**
 * The EmployeeCustomDropDownFieldsInner model module.
 * @module model/EmployeeCustomDropDownFieldsInner
 * @version 2
 */
class EmployeeCustomDropDownFieldsInner {
    /**
     * Constructs a new <code>EmployeeCustomDropDownFieldsInner</code>.
     * 
     * @alias module:model/EmployeeCustomDropDownFieldsInner
     * @param category {module:model/EmployeeCustomDropDownFieldsInner.CategoryEnum} The custom field category.  Acceptable value is 'PayrollAndHR'.
     * @param label {String} The custom field label whose value is to be added/updated.  Must match to the label defined in Web Pay Custom Fields setup.  Max length: 255.
     * @param value {String} The custom dropdown field value.  Values are configured in Web Pay Company > Setup > List Values > Lookup Values > Custom Fields: PayrollAndHR.  Max length: 10.
     */
    constructor(category, label, value) { 
        
        EmployeeCustomDropDownFieldsInner.initialize(this, category, label, value);
    }
     ...
     */
    static initialize(obj, category, label, value) { 
    ...
    /**
     * Constructs a <code>EmployeeCustomDropDownFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeCustomDropDownFieldsInner} obj Optional instance to populate.
     * @return {module:model/EmployeeCustomDropDownFieldsInner} The populated <code>EmployeeCustomDropDownFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeCustomDropDownFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeCustomDropDownFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeCustomDropDownFieldsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmployeeCustomDropDownFieldsInner.RequiredProperties) {
...
EmployeeCustomDropDownFieldsInner.RequiredProperties = ["category", "label", "value"];

/**
 * The custom field category.  Acceptable value is 'PayrollAndHR'.
 * @member {module:model/EmployeeCustomDropDownFieldsInner.CategoryEnum} category
 */
EmployeeCustomDropDownFieldsInner.prototype['category'] = undefined;
 ...
 * @member {String} label
 */
EmployeeCustomDropDownFieldsInner.prototype['label'] = undefined;
 ...
 * @member {String} value
 */
EmployeeCustomDropDownFieldsInner.prototype['value'] = undefined;
 ...
 * @readonly
 */
EmployeeCustomDropDownFieldsInner['CategoryEnum'] = {
...
export default EmployeeCustomDropDownFieldsInner;
