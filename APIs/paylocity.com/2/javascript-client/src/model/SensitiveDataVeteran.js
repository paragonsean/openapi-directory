...
/**
 * The SensitiveDataVeteran model module.
 * @module model/SensitiveDataVeteran
 * @version 2
 */
class SensitiveDataVeteran {
    /**
     * Constructs a new <code>SensitiveDataVeteran</code>.
     * Add or update veteran data.
     * @alias module:model/SensitiveDataVeteran
     */
    constructor() { 
        
        SensitiveDataVeteran.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveDataVeteran</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveDataVeteran} obj Optional instance to populate.
     * @return {module:model/SensitiveDataVeteran} The populated <code>SensitiveDataVeteran</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveDataVeteran();

            if (data.hasOwnProperty('isVeteran')) {
                obj['isVeteran'] = ApiClient.convertToType(data['isVeteran'], 'String');
            }
            if (data.hasOwnProperty('veteran')) {
                obj['veteran'] = ApiClient.convertToType(data['veteran'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveDataVeteran</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveDataVeteran</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['isVeteran'] && !(typeof data['isVeteran'] === 'string' || data['isVeteran'] instanceof String)) {
            throw new Error("Expected the field `isVeteran` to be a primitive type in the JSON string but got " + data['isVeteran']);
        }
        // ensure the json data is a string
        if (data['veteran'] && !(typeof data['veteran'] === 'string' || data['veteran'] instanceof String)) {
            throw new Error("Expected the field `veteran` to be a primitive type in the JSON string but got " + data['veteran']);
        }
 ...
 * @member {String} isVeteran
 */
SensitiveDataVeteran.prototype['isVeteran'] = undefined;

/**
 * Employee's Veteran Notes<br  />Max length: 50
 * @member {String} veteran
 */
SensitiveDataVeteran.prototype['veteran'] = undefined;
...
export default SensitiveDataVeteran;
