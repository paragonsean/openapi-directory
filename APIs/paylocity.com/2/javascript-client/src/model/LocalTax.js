...
/**
 * The LocalTax model module.
 * @module model/LocalTax
 * @version 2
 */
class LocalTax {
    /**
     * Constructs a new <code>LocalTax</code>.
     * The Local Tax model
     * @alias module:model/LocalTax
     */
    constructor() { 
        
        LocalTax.initialize(this);
    }
    ...
    /**
     * Constructs a <code>LocalTax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocalTax} obj Optional instance to populate.
     * @return {module:model/LocalTax} The populated <code>LocalTax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LocalTax();
    ...
    /**
     * Validates the JSON data with respect to <code>LocalTax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocalTax</code>.
     */
