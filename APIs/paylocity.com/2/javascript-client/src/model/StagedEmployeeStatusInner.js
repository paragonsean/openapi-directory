...
/**
 * The StagedEmployeeStatusInner model module.
 * @module model/StagedEmployeeStatusInner
 * @version 2
 */
class StagedEmployeeStatusInner {
    /**
     * Constructs a new <code>StagedEmployeeStatusInner</code>.
     * The employee status model
     * @alias module:model/StagedEmployeeStatusInner
     */
    constructor() { 
        
        StagedEmployeeStatusInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeStatusInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeStatusInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeStatusInner} The populated <code>StagedEmployeeStatusInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeStatusInner();

            if (data.hasOwnProperty('adjustedSeniorityDate')) {
                obj['adjustedSeniorityDate'] = ApiClient.convertToType(data['adjustedSeniorityDate'], 'String');
            }
            ...
            if (data.hasOwnProperty('employeeStatus')) {
                obj['employeeStatus'] = ApiClient.convertToType(data['employeeStatus'], 'String');
            }
            if (data.hasOwnProperty('hireDate')) {
                obj['hireDate'] = ApiClient.convertToType(data['hireDate'], 'String');
            }
            if (data.hasOwnProperty('isEligibleForRehire')) {
                obj['isEligibleForRehire'] = ApiClient.convertToType(data['isEligibleForRehire'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeStatusInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeStatusInner</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['adjustedSeniorityDate'] && !(typeof data['adjustedSeniorityDate'] === 'string' || data['adjustedSeniorityDate'] instanceof String)) {
            throw new Error("Expected the field `adjustedSeniorityDate` to be a primitive type in the JSON string but got " + data['adjustedSeniorityDate']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['employeeStatus'] && !(typeof data['employeeStatus'] === 'string' || data['employeeStatus'] instanceof String)) {
            throw new Error("Expected the field `employeeStatus` to be a primitive type in the JSON string but got " + data['employeeStatus']);
        }
        // ensure the json data is a string
        if (data['hireDate'] && !(typeof data['hireDate'] === 'string' || data['hireDate'] instanceof String)) {
            throw new Error("Expected the field `hireDate` to be a primitive type in the JSON string but got " + data['hireDate']);
        }
 ...
 * @member {String} adjustedSeniorityDate
 */
StagedEmployeeStatusInner.prototype['adjustedSeniorityDate'] = undefined;

/**
 * Employee status change reason. Must match Company setup.<br  /> Max length: 15
 * @member {String} changeReason
 */
StagedEmployeeStatusInner.prototype['changeReason'] = undefined;

/**
 * Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} effectiveDate
 */
StagedEmployeeStatusInner.prototype['effectiveDate'] = undefined;

/**
 * Employee current work status. Common values are *A* (Active), *L* (Leave of Absence), *T* (Terminated). <br  />Max length: 20
 * @member {String} employeeStatus
 */
StagedEmployeeStatusInner.prototype['employeeStatus'] = undefined;

/**
 * Employee hired date. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} hireDate
 */
StagedEmployeeStatusInner.prototype['hireDate'] = undefined;

/**
 * Indicates if employee eligible for rehire.
 * @member {Boolean} isEligibleForRehire
 */
StagedEmployeeStatusInner.prototype['isEligibleForRehire'] = undefined;
...
export default StagedEmployeeStatusInner;
