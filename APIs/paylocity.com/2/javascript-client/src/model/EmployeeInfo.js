...
class EmployeeInfo {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('statusTypeCode')) {
                obj['statusTypeCode'] = ApiClient.convertToType(data['statusTypeCode'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['statusTypeCode'] && !(typeof data['statusTypeCode'] === 'string' || data['statusTypeCode'] instanceof String)) {
            throw new Error("Expected the field `statusTypeCode` to be a primitive type in the JSON string but got " + data['statusTypeCode']);
        }
 ...
 */
EmployeeInfo.prototype['employeeId'] = undefined;

/**
 * Employee current work status. Common values are *A* (Active), *L* (Leave of Absence), *T* (Terminated). <br  />Max length: 20
 * @member {String} statusCode
 */
EmployeeInfo.prototype['statusCode'] = undefined;

/**
 * Employee current work status type. <br  />Max length: 10
 * @member {String} statusTypeCode
 */
EmployeeInfo.prototype['statusTypeCode'] = undefined;
