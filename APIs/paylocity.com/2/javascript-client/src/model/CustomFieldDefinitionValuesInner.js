...
/**
 * The CustomFieldDefinitionValuesInner model module.
 * @module model/CustomFieldDefinitionValuesInner
 * @version 2
 */
class CustomFieldDefinitionValuesInner {
    /**
     * Constructs a new <code>CustomFieldDefinitionValuesInner</code>.
     * 
     * @alias module:model/CustomFieldDefinitionValuesInner
     */
    constructor() { 
        
        CustomFieldDefinitionValuesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomFieldDefinitionValuesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomFieldDefinitionValuesInner} obj Optional instance to populate.
     * @return {module:model/CustomFieldDefinitionValuesInner} The populated <code>CustomFieldDefinitionValuesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomFieldDefinitionValuesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFieldDefinitionValuesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFieldDefinitionValuesInner</code>.
     */
 ...
 * @member {String} code
 */
CustomFieldDefinitionValuesInner.prototype['code'] = undefined;

/**
 * The custom field description.
 * @member {String} description
 */
CustomFieldDefinitionValuesInner.prototype['description'] = undefined;
...
export default CustomFieldDefinitionValuesInner;
