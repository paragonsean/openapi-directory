...
import SensitiveDataEthnicityEthnicRacialIdentitiesInner from './SensitiveDataEthnicityEthnicRacialIdentitiesInner';

/**
 * The SensitiveDataEthnicity model module.
 * @module model/SensitiveDataEthnicity
 * @version 2
 */
class SensitiveDataEthnicity {
    /**
     * Constructs a new <code>SensitiveDataEthnicity</code>.
     * Add or update ethnicity data.
     * @alias module:model/SensitiveDataEthnicity
     */
    constructor() { 
        
        SensitiveDataEthnicity.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveDataEthnicity</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveDataEthnicity} obj Optional instance to populate.
     * @return {module:model/SensitiveDataEthnicity} The populated <code>SensitiveDataEthnicity</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveDataEthnicity();

            if (data.hasOwnProperty('ethnicRacialIdentities')) {
                obj['ethnicRacialIdentities'] = ApiClient.convertToType(data['ethnicRacialIdentities'], [SensitiveDataEthnicityEthnicRacialIdentitiesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveDataEthnicity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveDataEthnicity</code>.
     */
    static validateJSON(data) {
        if (data['ethnicRacialIdentities']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['ethnicRacialIdentities'])) {
                throw new Error("Expected the field `ethnicRacialIdentities` to be an array in the JSON data but got " + data['ethnicRacialIdentities']);
            }
            // validate the optional field `ethnicRacialIdentities` (array)
            for (const item of data['ethnicRacialIdentities']) {
                SensitiveDataEthnicityEthnicRacialIdentitiesInner.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/SensitiveDataEthnicityEthnicRacialIdentitiesInner>} ethnicRacialIdentities
 */
SensitiveDataEthnicity.prototype['ethnicRacialIdentities'] = undefined;
 ...
 */
SensitiveDataEthnicity.prototype['ethnicity'] = undefined;
...
export default SensitiveDataEthnicity;
