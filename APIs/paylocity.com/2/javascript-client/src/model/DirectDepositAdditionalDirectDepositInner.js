...
/**
 * The DirectDepositAdditionalDirectDepositInner model module.
 * @module model/DirectDepositAdditionalDirectDepositInner
 * @version 2
 */
class DirectDepositAdditionalDirectDepositInner {
    /**
     * Constructs a new <code>DirectDepositAdditionalDirectDepositInner</code>.
     * The additional direct deposit model
     * @alias module:model/DirectDepositAdditionalDirectDepositInner
     */
    constructor() { 
        
        DirectDepositAdditionalDirectDepositInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DirectDepositAdditionalDirectDepositInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectDepositAdditionalDirectDepositInner} obj Optional instance to populate.
     * @return {module:model/DirectDepositAdditionalDirectDepositInner} The populated <code>DirectDepositAdditionalDirectDepositInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectDepositAdditionalDirectDepositInner();
            ...
            if (data.hasOwnProperty('blockSpecial')) {
                obj['blockSpecial'] = ApiClient.convertToType(data['blockSpecial'], 'Boolean');
            }
            if (data.hasOwnProperty('isSkipPreNote')) {
                obj['isSkipPreNote'] = ApiClient.convertToType(data['isSkipPreNote'], 'Boolean');
            }
            if (data.hasOwnProperty('nameOnAccount')) {
                obj['nameOnAccount'] = ApiClient.convertToType(data['nameOnAccount'], 'String');
            }
            if (data.hasOwnProperty('preNoteDate')) {
                obj['preNoteDate'] = ApiClient.convertToType(data['preNoteDate'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DirectDepositAdditionalDirectDepositInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectDepositAdditionalDirectDepositInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['nameOnAccount'] && !(typeof data['nameOnAccount'] === 'string' || data['nameOnAccount'] instanceof String)) {
            throw new Error("Expected the field `nameOnAccount` to be a primitive type in the JSON string but got " + data['nameOnAccount']);
        }
        // ensure the json data is a string
        if (data['preNoteDate'] && !(typeof data['preNoteDate'] === 'string' || data['preNoteDate'] instanceof String)) {
            throw new Error("Expected the field `preNoteDate` to be a primitive type in the JSON string but got " + data['preNoteDate']);
        }
        // ensure the json data is a string
 ...
 */
DirectDepositAdditionalDirectDepositInner.prototype['accountNumber'] = undefined;

/**
 * Account type. Valid values are *C* (Checking), *S* (Saving), *P* (Pay Card). <br   />Max length: 1<br />
 * @member {String} accountType
 */
DirectDepositAdditionalDirectDepositInner.prototype['accountType'] = undefined;

/**
 * Amount value to be deposited to the account.<br  />Decimal (12,2)<br />
 * @member {Number} amount
 */
DirectDepositAdditionalDirectDepositInner.prototype['amount'] = undefined;
 ...
 */
DirectDepositAdditionalDirectDepositInner.prototype['amountType'] = undefined;
 ...
 */
DirectDepositAdditionalDirectDepositInner.prototype['blockSpecial'] = undefined;

/**
 * Indicates if account will not pre-note.<br />
 * @member {Boolean} isSkipPreNote
 */
DirectDepositAdditionalDirectDepositInner.prototype['isSkipPreNote'] = undefined;

/**
 * Name on the bank account. Defaults to employee's name. <br  />Max length: 30<br />
 * @member {String} nameOnAccount
 */
DirectDepositAdditionalDirectDepositInner.prototype['nameOnAccount'] = undefined;

/**
 * Date to end the pre-note of the account. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.<br />
 * @member {String} preNoteDate
 */
DirectDepositAdditionalDirectDepositInner.prototype['preNoteDate'] = undefined;

/**
 * ABA Transit Routing Number, entered without dashes or spaces. <br  />Max length: 9<br />
 * @member {String} routingNumber
 */
DirectDepositAdditionalDirectDepositInner.prototype['routingNumber'] = undefined;
...
export default DirectDepositAdditionalDirectDepositInner;
