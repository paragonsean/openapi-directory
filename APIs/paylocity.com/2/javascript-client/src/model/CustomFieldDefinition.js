...
import CustomFieldDefinitionValuesInner from './CustomFieldDefinitionValuesInner';

/**
 * The CustomFieldDefinition model module.
 * @module model/CustomFieldDefinition
 * @version 2
 */
class CustomFieldDefinition {
    /**
     * Constructs a new <code>CustomFieldDefinition</code>.
     * 
     * @alias module:model/CustomFieldDefinition
     */
    constructor() { 
        
        CustomFieldDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomFieldDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomFieldDefinition} obj Optional instance to populate.
     * @return {module:model/CustomFieldDefinition} The populated <code>CustomFieldDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomFieldDefinition();
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [CustomFieldDefinitionValuesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CustomFieldDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CustomFieldDefinition</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                CustomFieldDefinitionValuesInner.validateJSON(item);
            };
        }
 ...
 */
CustomFieldDefinition.prototype['category'] = undefined;

/**
 * Specifies the default value of the custom field.
 * @member {String} defaultValue
 */
CustomFieldDefinition.prototype['defaultValue'] = undefined;

/**
 * Indicates whether the custom field is required.
 * @member {Boolean} isRequired
 */
CustomFieldDefinition.prototype['isRequired'] = undefined;

/**
 * The custom field label.
 * @member {String} label
 */
CustomFieldDefinition.prototype['label'] = undefined;

/**
 * The custom field type.
 * @member {String} type
 */
CustomFieldDefinition.prototype['type'] = undefined;

/**
 * A set of values that are applicable to the custom field.
 * @member {Array.<module:model/CustomFieldDefinitionValuesInner>} values
 */
CustomFieldDefinition.prototype['values'] = undefined;
