...
/**
 * The PayStatementSummary model module.
 * @module model/PayStatementSummary
 * @version 2
 */
class PayStatementSummary {
    /**
     * Constructs a new <code>PayStatementSummary</code>.
     * The pay statement summary model
     * @alias module:model/PayStatementSummary
     */
    constructor() { 
        
        PayStatementSummary.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PayStatementSummary</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayStatementSummary} obj Optional instance to populate.
     * @return {module:model/PayStatementSummary} The populated <code>PayStatementSummary</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayStatementSummary();
            ...
            if (data.hasOwnProperty('directDepositAmount')) {
                obj['directDepositAmount'] = ApiClient.convertToType(data['directDepositAmount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('netCheck')) {
                obj['netCheck'] = ApiClient.convertToType(data['netCheck'], 'Number');
            }
            if (data.hasOwnProperty('netPay')) {
                obj['netPay'] = ApiClient.convertToType(data['netPay'], 'Number');
            }
            if (data.hasOwnProperty('overtimeDollars')) {
                obj['overtimeDollars'] = ApiClient.convertToType(data['overtimeDollars'], 'Number');
            }
            if (data.hasOwnProperty('overtimeHours')) {
                obj['overtimeHours'] = ApiClient.convertToType(data['overtimeHours'], 'Number');
            }
            if (data.hasOwnProperty('process')) {
                obj['process'] = ApiClient.convertToType(data['process'], 'Number');
            }
            if (data.hasOwnProperty('regularDollars')) {
                obj['regularDollars'] = ApiClient.convertToType(data['regularDollars'], 'Number');
            }
            if (data.hasOwnProperty('regularHours')) {
                obj['regularHours'] = ApiClient.convertToType(data['regularHours'], 'Number');
            }
            ...
            if (data.hasOwnProperty('voucherNumber')) {
                obj['voucherNumber'] = ApiClient.convertToType(data['voucherNumber'], 'Number');
            }
            if (data.hasOwnProperty('workersCompCode')) {
                obj['workersCompCode'] = ApiClient.convertToType(data['workersCompCode'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PayStatementSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayStatementSummary</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['workersCompCode'] && !(typeof data['workersCompCode'] === 'string' || data['workersCompCode'] instanceof String)) {
            throw new Error("Expected the field `workersCompCode` to be a primitive type in the JSON string but got " + data['workersCompCode']);
        }
 ...
 */
PayStatementSummary.prototype['autoPay'] = undefined;

/**
 * .<br />
 * @member {String} beginDate
 */
PayStatementSummary.prototype['beginDate'] = undefined;

/**
 * .<br />
 * @member {String} checkDate
 */
PayStatementSummary.prototype['checkDate'] = undefined;

/**
 * .<br />
 * @member {Number} checkNumber
 */
PayStatementSummary.prototype['checkNumber'] = undefined;

/**
 * .<br />
 * @member {Number} directDepositAmount
 */
PayStatementSummary.prototype['directDepositAmount'] = undefined;

/**
 * .<br />
 * @member {String} endDate
 */
PayStatementSummary.prototype['endDate'] = undefined;

/**
 * .<br />
 * @member {Number} grossPay
 */
PayStatementSummary.prototype['grossPay'] = undefined;

/**
 * .<br />
 * @member {Number} hours
 */
PayStatementSummary.prototype['hours'] = undefined;

/**
 * .<br />
 * @member {Number} netCheck
 */
PayStatementSummary.prototype['netCheck'] = undefined;

/**
 * .<br />
 * @member {Number} netPay
 */
PayStatementSummary.prototype['netPay'] = undefined;

/**
 * .<br />
 * @member {Number} overtimeDollars
 */
PayStatementSummary.prototype['overtimeDollars'] = undefined;

/**
 * .<br />
 * @member {Number} overtimeHours
 */
PayStatementSummary.prototype['overtimeHours'] = undefined;

/**
 * .<br />
 * @member {Number} process
 */
PayStatementSummary.prototype['process'] = undefined;

/**
 * .<br />
 * @member {Number} regularDollars
 */
PayStatementSummary.prototype['regularDollars'] = undefined;

/**
 * .<br />
 * @member {Number} regularHours
 */
PayStatementSummary.prototype['regularHours'] = undefined;

/**
 * <br />
 * @member {Number} transactionNumber
 */
PayStatementSummary.prototype['transactionNumber'] = undefined;

/**
 * .<br />
 * @member {Number} voucherNumber
 */
PayStatementSummary.prototype['voucherNumber'] = undefined;

/**
 * .<br />
 * @member {String} workersCompCode
 */
PayStatementSummary.prototype['workersCompCode'] = undefined;

/**
 * .<br />
 * @member {Number} year
 */
PayStatementSummary.prototype['year'] = undefined;
...
export default PayStatementSummary;
