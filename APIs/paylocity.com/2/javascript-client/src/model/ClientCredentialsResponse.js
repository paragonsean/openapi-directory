...
/**
 * The ClientCredentialsResponse model module.
 * @module model/ClientCredentialsResponse
 * @version 2
 */
class ClientCredentialsResponse {
    /**
     * Constructs a new <code>ClientCredentialsResponse</code>.
     * The Client Credentials Response Model
     * @alias module:model/ClientCredentialsResponse
     */
    constructor() { 
        
        ClientCredentialsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClientCredentialsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClientCredentialsResponse} obj Optional instance to populate.
     * @return {module:model/ClientCredentialsResponse} The populated <code>ClientCredentialsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClientCredentialsResponse();

            if (data.hasOwnProperty('clientSecret')) {
                obj['clientSecret'] = ApiClient.convertToType(data['clientSecret'], 'String');
            }
            if (data.hasOwnProperty('clientSecretExpirationDate')) {
                obj['clientSecretExpirationDate'] = ApiClient.convertToType(data['clientSecretExpirationDate'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ClientCredentialsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClientCredentialsResponse</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['clientSecretExpirationDate'] && !(typeof data['clientSecretExpirationDate'] === 'string' || data['clientSecretExpirationDate'] instanceof String)) {
            throw new Error("Expected the field `clientSecretExpirationDate` to be a primitive type in the JSON string but got " + data['clientSecretExpirationDate']);
        }
 ...
 */
ClientCredentialsResponse.prototype['clientSecret'] = undefined;

/**
 * The client's secret expiration date
 * @member {String} clientSecretExpirationDate
 */
ClientCredentialsResponse.prototype['clientSecretExpirationDate'] = undefined;
...
export default ClientCredentialsResponse;
