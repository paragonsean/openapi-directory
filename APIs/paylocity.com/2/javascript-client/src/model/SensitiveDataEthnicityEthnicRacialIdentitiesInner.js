...
/**
 * The SensitiveDataEthnicityEthnicRacialIdentitiesInner model module.
 * @module model/SensitiveDataEthnicityEthnicRacialIdentitiesInner
 * @version 2
 */
class SensitiveDataEthnicityEthnicRacialIdentitiesInner {
    /**
     * Constructs a new <code>SensitiveDataEthnicityEthnicRacialIdentitiesInner</code>.
     * The ethnic racial identity model
     * @alias module:model/SensitiveDataEthnicityEthnicRacialIdentitiesInner
     */
    constructor() { 
        
        SensitiveDataEthnicityEthnicRacialIdentitiesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveDataEthnicityEthnicRacialIdentitiesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveDataEthnicityEthnicRacialIdentitiesInner} obj Optional instance to populate.
     * @return {module:model/SensitiveDataEthnicityEthnicRacialIdentitiesInner} The populated <code>SensitiveDataEthnicityEthnicRacialIdentitiesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveDataEthnicityEthnicRacialIdentitiesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveDataEthnicityEthnicRacialIdentitiesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveDataEthnicityEthnicRacialIdentitiesInner</code>.
     */
 ...
 */
SensitiveDataEthnicityEthnicRacialIdentitiesInner.prototype['description'] = undefined;
...
export default SensitiveDataEthnicityEthnicRacialIdentitiesInner;
