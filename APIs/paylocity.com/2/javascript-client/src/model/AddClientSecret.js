...
/**
 * The AddClientSecret model module.
 * @module model/AddClientSecret
 * @version 2
 */
class AddClientSecret {
    /**
     * Constructs a new <code>AddClientSecret</code>.
     * The Add Client Secret Request Model
     * @alias module:model/AddClientSecret
     * @param code {String} A value sent with the 'ACTION NEEDED: Web Link API Credentials Expiring Soon.' email notification.
     */
    constructor(code) { 
        
        AddClientSecret.initialize(this, code);
    }
    ...
    /**
     * Constructs a <code>AddClientSecret</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddClientSecret} obj Optional instance to populate.
     * @return {module:model/AddClientSecret} The populated <code>AddClientSecret</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddClientSecret();
    ...
    /**
     * Validates the JSON data with respect to <code>AddClientSecret</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddClientSecret</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AddClientSecret.RequiredProperties) {
