...
/**
 * The EmployeeCustomNumberFieldsInner model module.
 * @module model/EmployeeCustomNumberFieldsInner
 * @version 2
 */
class EmployeeCustomNumberFieldsInner {
    /**
     * Constructs a new <code>EmployeeCustomNumberFieldsInner</code>.
     * 
     * @alias module:model/EmployeeCustomNumberFieldsInner
     * @param category {module:model/EmployeeCustomNumberFieldsInner.CategoryEnum} The custom field category.  Acceptable value is 'PayrollAndHR'.
     ...
     * @param value {Number} The custom number field value.  Decimal (18,6).
     */
    constructor(category, label, value) { 
        
        EmployeeCustomNumberFieldsInner.initialize(this, category, label, value);
    }
    ...
    /**
     * Constructs a <code>EmployeeCustomNumberFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeCustomNumberFieldsInner} obj Optional instance to populate.
     * @return {module:model/EmployeeCustomNumberFieldsInner} The populated <code>EmployeeCustomNumberFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeCustomNumberFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeCustomNumberFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeCustomNumberFieldsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmployeeCustomNumberFieldsInner.RequiredProperties) {
...
EmployeeCustomNumberFieldsInner.RequiredProperties = ["category", "label", "value"];

/**
 * The custom field category.  Acceptable value is 'PayrollAndHR'.
 * @member {module:model/EmployeeCustomNumberFieldsInner.CategoryEnum} category
 */
EmployeeCustomNumberFieldsInner.prototype['category'] = undefined;
 ...
 * @member {String} label
 */
EmployeeCustomNumberFieldsInner.prototype['label'] = undefined;

/**
 * The custom number field value.  Decimal (18,6).
 * @member {Number} value
 */
EmployeeCustomNumberFieldsInner.prototype['value'] = undefined;
 ...
 * @readonly
 */
EmployeeCustomNumberFieldsInner['CategoryEnum'] = {
...
export default EmployeeCustomNumberFieldsInner;
