...
/**
 * The StateTax model module.
 * @module model/StateTax
 * @version 2
 */
class StateTax {
    /**
     * Constructs a new <code>StateTax</code>.
     * The State Tax model
     * @alias module:model/StateTax
     */
    constructor() { 
        
        StateTax.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StateTax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StateTax} obj Optional instance to populate.
     * @return {module:model/StateTax} The populated <code>StateTax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StateTax();
    ...
    /**
     * Validates the JSON data with respect to <code>StateTax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StateTax</code>.
     */
 ...
 */
StateTax.prototype['specialCheckCalc'] = undefined;
 ...
 */
StateTax.prototype['taxCalculationCode'] = undefined;

/**
 * State tax code.<br  /> Max length: 50
 * @member {String} taxCode
 */
StateTax.prototype['taxCode'] = undefined;

/**
 * The state W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
StateTax.prototype['w4FormYear'] = undefined;
