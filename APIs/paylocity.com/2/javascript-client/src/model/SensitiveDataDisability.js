...
import SensitiveDataDisabilityDisabilityClassificationsInner from './SensitiveDataDisabilityDisabilityClassificationsInner';

/**
 * The SensitiveDataDisability model module.
 * @module model/SensitiveDataDisability
 * @version 2
 */
class SensitiveDataDisability {
    /**
     * Constructs a new <code>SensitiveDataDisability</code>.
     * Add or update disability data.
     * @alias module:model/SensitiveDataDisability
     */
    constructor() { 
        
        SensitiveDataDisability.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveDataDisability</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveDataDisability} obj Optional instance to populate.
     * @return {module:model/SensitiveDataDisability} The populated <code>SensitiveDataDisability</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveDataDisability();

            if (data.hasOwnProperty('disability')) {
                obj['disability'] = ApiClient.convertToType(data['disability'], 'String');
            }
            if (data.hasOwnProperty('disabilityClassifications')) {
                obj['disabilityClassifications'] = ApiClient.convertToType(data['disabilityClassifications'], [SensitiveDataDisabilityDisabilityClassificationsInner]);
            }
            if (data.hasOwnProperty('hasDisability')) {
                obj['hasDisability'] = ApiClient.convertToType(data['hasDisability'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveDataDisability</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveDataDisability</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['disability'] && !(typeof data['disability'] === 'string' || data['disability'] instanceof String)) {
            throw new Error("Expected the field `disability` to be a primitive type in the JSON string but got " + data['disability']);
        }
        if (data['disabilityClassifications']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['disabilityClassifications'])) {
                throw new Error("Expected the field `disabilityClassifications` to be an array in the JSON data but got " + data['disabilityClassifications']);
            }
            // validate the optional field `disabilityClassifications` (array)
            for (const item of data['disabilityClassifications']) {
                SensitiveDataDisabilityDisabilityClassificationsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['hasDisability'] && !(typeof data['hasDisability'] === 'string' || data['hasDisability'] instanceof String)) {
            throw new Error("Expected the field `hasDisability` to be a primitive type in the JSON string but got " + data['hasDisability']);
        }
 ...
 * @member {String} disability
 */
SensitiveDataDisability.prototype['disability'] = undefined;

/**
 * Add or update employee's disability classifications
 * @member {Array.<module:model/SensitiveDataDisabilityDisabilityClassificationsInner>} disabilityClassifications
 */
SensitiveDataDisability.prototype['disabilityClassifications'] = undefined;

/**
 * Indicates if the employee has a disability. Values include:<br  /><br  />0 = No<br  />1 = Yes<br  />2 = Prefer not to say
 * @member {String} hasDisability
 */
SensitiveDataDisability.prototype['hasDisability'] = undefined;
...
export default SensitiveDataDisability;
