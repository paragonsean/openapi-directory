...
/**
 * The StagedEmployeeBenefitSetupInner model module.
 * @module model/StagedEmployeeBenefitSetupInner
 * @version 2
 */
class StagedEmployeeBenefitSetupInner {
    /**
     * Constructs a new <code>StagedEmployeeBenefitSetupInner</code>.
     * The benefit setup model
     * @alias module:model/StagedEmployeeBenefitSetupInner
     */
    constructor() { 
        
        StagedEmployeeBenefitSetupInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeBenefitSetupInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeBenefitSetupInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeBenefitSetupInner} The populated <code>StagedEmployeeBenefitSetupInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeBenefitSetupInner();

            if (data.hasOwnProperty('benefitClass')) {
                obj['benefitClass'] = ApiClient.convertToType(data['benefitClass'], 'String');
            }
            if (data.hasOwnProperty('benefitClassEffectiveDate')) {
                obj['benefitClassEffectiveDate'] = ApiClient.convertToType(data['benefitClassEffectiveDate'], 'String');
            }
            if (data.hasOwnProperty('benefitSalary')) {
                obj['benefitSalary'] = ApiClient.convertToType(data['benefitSalary'], 'Number');
            }
            if (data.hasOwnProperty('benefitSalaryEffectiveDate')) {
                obj['benefitSalaryEffectiveDate'] = ApiClient.convertToType(data['benefitSalaryEffectiveDate'], 'String');
            }
            if (data.hasOwnProperty('doNotApplyAdministrativePeriod')) {
                obj['doNotApplyAdministrativePeriod'] = ApiClient.convertToType(data['doNotApplyAdministrativePeriod'], 'Boolean');
            }
            if (data.hasOwnProperty('isMeasureAcaEligibility')) {
                obj['isMeasureAcaEligibility'] = ApiClient.convertToType(data['isMeasureAcaEligibility'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeBenefitSetupInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeBenefitSetupInner</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['benefitClass'] && !(typeof data['benefitClass'] === 'string' || data['benefitClass'] instanceof String)) {
            throw new Error("Expected the field `benefitClass` to be a primitive type in the JSON string but got " + data['benefitClass']);
        }
        // ensure the json data is a string
        if (data['benefitClassEffectiveDate'] && !(typeof data['benefitClassEffectiveDate'] === 'string' || data['benefitClassEffectiveDate'] instanceof String)) {
            throw new Error("Expected the field `benefitClassEffectiveDate` to be a primitive type in the JSON string but got " + data['benefitClassEffectiveDate']);
        }
        // ensure the json data is a string
        if (data['benefitSalaryEffectiveDate'] && !(typeof data['benefitSalaryEffectiveDate'] === 'string' || data['benefitSalaryEffectiveDate'] instanceof String)) {
            throw new Error("Expected the field `benefitSalaryEffectiveDate` to be a primitive type in the JSON string but got " + data['benefitSalaryEffectiveDate']);
        }
 ...
 * @member {String} benefitClass
 */
StagedEmployeeBenefitSetupInner.prototype['benefitClass'] = undefined;

/**
 * Date when Benefit Class takes effect. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} benefitClassEffectiveDate
 */
StagedEmployeeBenefitSetupInner.prototype['benefitClassEffectiveDate'] = undefined;

/**
 * Salary used to configure benefits.<br  />Decimal(12,2)
 * @member {Number} benefitSalary
 */
StagedEmployeeBenefitSetupInner.prototype['benefitSalary'] = undefined;

/**
 * Date when Benefit Salary takes effect. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} benefitSalaryEffectiveDate
 */
StagedEmployeeBenefitSetupInner.prototype['benefitSalaryEffectiveDate'] = undefined;

/**
 * Applicable only for ACA Enhanced clients and Benefit Classes with ACA Employment Type of Full Time.
 * @member {Boolean} doNotApplyAdministrativePeriod
 */
StagedEmployeeBenefitSetupInner.prototype['doNotApplyAdministrativePeriod'] = undefined;

/**
 * Only valid for ACA Enhanced clients and Benefit Classes that are ACA Employment Type of Full Time.
 * @member {Boolean} isMeasureAcaEligibility
 */
StagedEmployeeBenefitSetupInner.prototype['isMeasureAcaEligibility'] = undefined;
...
export default StagedEmployeeBenefitSetupInner;
