...
/**
 * The EmployeeCustomBooleanFieldsInner model module.
 * @module model/EmployeeCustomBooleanFieldsInner
 * @version 2
 */
class EmployeeCustomBooleanFieldsInner {
    /**
     * Constructs a new <code>EmployeeCustomBooleanFieldsInner</code>.
     * 
     * @alias module:model/EmployeeCustomBooleanFieldsInner
     * @param category {module:model/EmployeeCustomBooleanFieldsInner.CategoryEnum} The custom field category.  Acceptable value is 'PayrollAndHR'.
     ...
     * @param value {Boolean} The custom boolean field value.
     */
    constructor(category, label, value) { 
        
        EmployeeCustomBooleanFieldsInner.initialize(this, category, label, value);
    }
    ...
    /**
     * Constructs a <code>EmployeeCustomBooleanFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeCustomBooleanFieldsInner} obj Optional instance to populate.
     * @return {module:model/EmployeeCustomBooleanFieldsInner} The populated <code>EmployeeCustomBooleanFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeCustomBooleanFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeCustomBooleanFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeCustomBooleanFieldsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmployeeCustomBooleanFieldsInner.RequiredProperties) {
...
EmployeeCustomBooleanFieldsInner.RequiredProperties = ["category", "label", "value"];

/**
 * The custom field category.  Acceptable value is 'PayrollAndHR'.
 * @member {module:model/EmployeeCustomBooleanFieldsInner.CategoryEnum} category
 */
EmployeeCustomBooleanFieldsInner.prototype['category'] = undefined;
 ...
 * @member {String} label
 */
EmployeeCustomBooleanFieldsInner.prototype['label'] = undefined;

/**
 * The custom boolean field value.
 * @member {Boolean} value
 */
EmployeeCustomBooleanFieldsInner.prototype['value'] = undefined;
 ...
 * @readonly
 */
EmployeeCustomBooleanFieldsInner['CategoryEnum'] = {
...
export default EmployeeCustomBooleanFieldsInner;
