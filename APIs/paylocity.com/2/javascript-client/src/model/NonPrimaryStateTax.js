...
/**
 * The NonPrimaryStateTax model module.
 * @module model/NonPrimaryStateTax
 * @version 2
 */
class NonPrimaryStateTax {
    /**
     * Constructs a new <code>NonPrimaryStateTax</code>.
     * The Non-Primary State Tax model
     * @alias module:model/NonPrimaryStateTax
     */
    constructor() { 
        
        NonPrimaryStateTax.initialize(this);
    }
    ...
    /**
     * Constructs a <code>NonPrimaryStateTax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NonPrimaryStateTax} obj Optional instance to populate.
     * @return {module:model/NonPrimaryStateTax} The populated <code>NonPrimaryStateTax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NonPrimaryStateTax();
    ...
    /**
     * Validates the JSON data with respect to <code>NonPrimaryStateTax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NonPrimaryStateTax</code>.
     */
 ...
 */
NonPrimaryStateTax.prototype['specialCheckCalc'] = undefined;
 ...
 */
NonPrimaryStateTax.prototype['taxCalculationCode'] = undefined;

/**
 * State tax code.<br  /> Max length: 50
 * @member {String} taxCode
 */
NonPrimaryStateTax.prototype['taxCode'] = undefined;

/**
 * The state W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
NonPrimaryStateTax.prototype['w4FormYear'] = undefined;
...
export default NonPrimaryStateTax;
