...
/**
 * The EmployeeIdResponse model module.
 * @module model/EmployeeIdResponse
 * @version 2
 */
class EmployeeIdResponse {
    /**
     * Constructs a new <code>EmployeeIdResponse</code>.
     * The EmployeeId Response Model
     * @alias module:model/EmployeeIdResponse
     */
    constructor() { 
        
        EmployeeIdResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeIdResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeIdResponse} obj Optional instance to populate.
     * @return {module:model/EmployeeIdResponse} The populated <code>EmployeeIdResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeIdResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeIdResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeIdResponse</code>.
     */
 ...
 */
EmployeeIdResponse.prototype['employeeId'] = undefined;
...
export default EmployeeIdResponse;
