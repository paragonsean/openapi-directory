...
/**
 * The DirectDepositMainDirectDeposit model module.
 * @module model/DirectDepositMainDirectDeposit
 * @version 2
 */
class DirectDepositMainDirectDeposit {
    /**
     * Constructs a new <code>DirectDepositMainDirectDeposit</code>.
     * The main Direct Deposit account.
     * @alias module:model/DirectDepositMainDirectDeposit
     */
    constructor() { 
        
        DirectDepositMainDirectDeposit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DirectDepositMainDirectDeposit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectDepositMainDirectDeposit} obj Optional instance to populate.
     * @return {module:model/DirectDepositMainDirectDeposit} The populated <code>DirectDepositMainDirectDeposit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectDepositMainDirectDeposit();
    ...
    /**
     * Validates the JSON data with respect to <code>DirectDepositMainDirectDeposit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectDepositMainDirectDeposit</code>.
     */
 ...
 */
DirectDepositMainDirectDeposit.prototype['accountNumber'] = undefined;

/**
 * Account type. Valid values are *C* (Checking), *S* (Saving), *P* (Pay Card). <br   />Max length: 1
 * @member {String} accountType
 */
DirectDepositMainDirectDeposit.prototype['accountType'] = undefined;
...
export default DirectDepositMainDirectDeposit;
