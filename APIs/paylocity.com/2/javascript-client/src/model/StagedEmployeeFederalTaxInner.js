...
/**
 * The StagedEmployeeFederalTaxInner model module.
 * @module model/StagedEmployeeFederalTaxInner
 * @version 2
 */
class StagedEmployeeFederalTaxInner {
    /**
     * Constructs a new <code>StagedEmployeeFederalTaxInner</code>.
     * The Federal Tax model
     * @alias module:model/StagedEmployeeFederalTaxInner
     */
    constructor() { 
        
        StagedEmployeeFederalTaxInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeFederalTaxInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeFederalTaxInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeFederalTaxInner} The populated <code>StagedEmployeeFederalTaxInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeFederalTaxInner();
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeFederalTaxInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeFederalTaxInner</code>.
     */
 ...
 */
StagedEmployeeFederalTaxInner.prototype['taxCalculationCode'] = undefined;

/**
 * The federal W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
StagedEmployeeFederalTaxInner.prototype['w4FormYear'] = undefined;
...
export default StagedEmployeeFederalTaxInner;
