...
/**
 * The CompanyCodes model module.
 * @module model/CompanyCodes
 * @version 2
 */
class CompanyCodes {
    /**
     * Constructs a new <code>CompanyCodes</code>.
     * The Company Codes model
     * @alias module:model/CompanyCodes
     */
    constructor() { 
        
        CompanyCodes.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CompanyCodes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CompanyCodes} obj Optional instance to populate.
     * @return {module:model/CompanyCodes} The populated <code>CompanyCodes</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CompanyCodes();
    ...
    /**
     * Validates the JSON data with respect to <code>CompanyCodes</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompanyCodes</code>.
     */
 ...
 * @member {String} code
 */
CompanyCodes.prototype['code'] = undefined;

/**
 * Description. <br  /> Max length: 150
 * @member {String} description
 */
CompanyCodes.prototype['description'] = undefined;
