...
/**
 * The EmployeeCustomDateFieldsInner model module.
 * @module model/EmployeeCustomDateFieldsInner
 * @version 2
 */
class EmployeeCustomDateFieldsInner {
    /**
     * Constructs a new <code>EmployeeCustomDateFieldsInner</code>.
     * 
     * @alias module:model/EmployeeCustomDateFieldsInner
     * @param category {module:model/EmployeeCustomDateFieldsInner.CategoryEnum} The custom field category.  Acceptable value is 'PayrollAndHR'.
     ...
     * @param value {String} The custom date field value.  Common formats include MM-DD-CCYY, CCYY-MM-DD.
     */
    constructor(category, label, value) { 
        
        EmployeeCustomDateFieldsInner.initialize(this, category, label, value);
    }
    ...
    /**
     * Constructs a <code>EmployeeCustomDateFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeCustomDateFieldsInner} obj Optional instance to populate.
     * @return {module:model/EmployeeCustomDateFieldsInner} The populated <code>EmployeeCustomDateFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeCustomDateFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeCustomDateFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeCustomDateFieldsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmployeeCustomDateFieldsInner.RequiredProperties) {
...
EmployeeCustomDateFieldsInner.RequiredProperties = ["category", "label", "value"];

/**
 * The custom field category.  Acceptable value is 'PayrollAndHR'.
 * @member {module:model/EmployeeCustomDateFieldsInner.CategoryEnum} category
 */
EmployeeCustomDateFieldsInner.prototype['category'] = undefined;
 ...
 * @member {String} label
 */
EmployeeCustomDateFieldsInner.prototype['label'] = undefined;

/**
 * The custom date field value.  Common formats include MM-DD-CCYY, CCYY-MM-DD.
 * @member {String} value
 */
EmployeeCustomDateFieldsInner.prototype['value'] = undefined;
 ...
 * @readonly
 */
EmployeeCustomDateFieldsInner['CategoryEnum'] = {
...
export default EmployeeCustomDateFieldsInner;
