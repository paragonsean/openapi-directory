...
/**
 * The SensitiveDataDisabilityDisabilityClassificationsInner model module.
 * @module model/SensitiveDataDisabilityDisabilityClassificationsInner
 * @version 2
 */
class SensitiveDataDisabilityDisabilityClassificationsInner {
    /**
     * Constructs a new <code>SensitiveDataDisabilityDisabilityClassificationsInner</code>.
     * The disabilty classifications model
     * @alias module:model/SensitiveDataDisabilityDisabilityClassificationsInner
     */
    constructor() { 
        
        SensitiveDataDisabilityDisabilityClassificationsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveDataDisabilityDisabilityClassificationsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveDataDisabilityDisabilityClassificationsInner} obj Optional instance to populate.
     * @return {module:model/SensitiveDataDisabilityDisabilityClassificationsInner} The populated <code>SensitiveDataDisabilityDisabilityClassificationsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveDataDisabilityDisabilityClassificationsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveDataDisabilityDisabilityClassificationsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveDataDisabilityDisabilityClassificationsInner</code>.
     */
 ...
 */
SensitiveDataDisabilityDisabilityClassificationsInner.prototype['classification'] = undefined;
...
export default SensitiveDataDisabilityDisabilityClassificationsInner;
