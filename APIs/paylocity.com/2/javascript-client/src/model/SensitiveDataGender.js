...
/**
 * The SensitiveDataGender model module.
 * @module model/SensitiveDataGender
 * @version 2
 */
class SensitiveDataGender {
    /**
     * Constructs a new <code>SensitiveDataGender</code>.
     * Add or update gender data.
     * @alias module:model/SensitiveDataGender
     */
    constructor() { 
        
        SensitiveDataGender.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveDataGender</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveDataGender} obj Optional instance to populate.
     * @return {module:model/SensitiveDataGender} The populated <code>SensitiveDataGender</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveDataGender();

            if (data.hasOwnProperty('displayPronouns')) {
                obj['displayPronouns'] = ApiClient.convertToType(data['displayPronouns'], 'Boolean');
            }
            if (data.hasOwnProperty('genderIdentityDescription')) {
                obj['genderIdentityDescription'] = ApiClient.convertToType(data['genderIdentityDescription'], 'String');
            }
            if (data.hasOwnProperty('identifyAsLegalGender')) {
                obj['identifyAsLegalGender'] = ApiClient.convertToType(data['identifyAsLegalGender'], 'String');
            }
            if (data.hasOwnProperty('legalGender')) {
                obj['legalGender'] = ApiClient.convertToType(data['legalGender'], 'String');
            }
            if (data.hasOwnProperty('pronouns')) {
                obj['pronouns'] = ApiClient.convertToType(data['pronouns'], 'String');
            }
            if (data.hasOwnProperty('sexualOrientation')) {
                obj['sexualOrientation'] = ApiClient.convertToType(data['sexualOrientation'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveDataGender</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveDataGender</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['genderIdentityDescription'] && !(typeof data['genderIdentityDescription'] === 'string' || data['genderIdentityDescription'] instanceof String)) {
            throw new Error("Expected the field `genderIdentityDescription` to be a primitive type in the JSON string but got " + data['genderIdentityDescription']);
        }
        // ensure the json data is a string
        if (data['identifyAsLegalGender'] && !(typeof data['identifyAsLegalGender'] === 'string' || data['identifyAsLegalGender'] instanceof String)) {
            throw new Error("Expected the field `identifyAsLegalGender` to be a primitive type in the JSON string but got " + data['identifyAsLegalGender']);
        }
        // ensure the json data is a string
        if (data['legalGender'] && !(typeof data['legalGender'] === 'string' || data['legalGender'] instanceof String)) {
            throw new Error("Expected the field `legalGender` to be a primitive type in the JSON string but got " + data['legalGender']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['sexualOrientation'] && !(typeof data['sexualOrientation'] === 'string' || data['sexualOrientation'] instanceof String)) {
            throw new Error("Expected the field `sexualOrientation` to be a primitive type in the JSON string but got " + data['sexualOrientation']);
        }
 ...
 * @member {Boolean} displayPronouns
 */
SensitiveDataGender.prototype['displayPronouns'] = undefined;

/**
 * Employee's preferred or chosen gender identification.<br  />Max length: 40
 * @member {String} genderIdentityDescription
 */
SensitiveDataGender.prototype['genderIdentityDescription'] = undefined;

/**
 * Employee's self-identification of legal gender. Numerical values include:<br  /><br  />0 = No<br  />1 = Yes<br  />2 = Prefer not to say
 * @member {String} identifyAsLegalGender
 */
SensitiveDataGender.prototype['identifyAsLegalGender'] = undefined;
 ...
 * @member {String} legalGender
 */
SensitiveDataGender.prototype['legalGender'] = undefined;
 ...
 */
SensitiveDataGender.prototype['pronouns'] = undefined;
 ...
 * @member {String} sexualOrientation
 */
SensitiveDataGender.prototype['sexualOrientation'] = undefined;
...
export default SensitiveDataGender;
