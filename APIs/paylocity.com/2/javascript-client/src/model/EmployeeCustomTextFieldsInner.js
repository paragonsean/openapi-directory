...
/**
 * The EmployeeCustomTextFieldsInner model module.
 * @module model/EmployeeCustomTextFieldsInner
 * @version 2
 */
class EmployeeCustomTextFieldsInner {
    /**
     * Constructs a new <code>EmployeeCustomTextFieldsInner</code>.
     * 
     * @alias module:model/EmployeeCustomTextFieldsInner
     * @param category {module:model/EmployeeCustomTextFieldsInner.CategoryEnum} The custom field category.  Acceptable value is 'PayrollAndHR'.
     ...
     * @param value {String} The custom text field value.  Max length: 255.
     */
    constructor(category, label, value) { 
        
        EmployeeCustomTextFieldsInner.initialize(this, category, label, value);
    }
    ...
    /**
     * Constructs a <code>EmployeeCustomTextFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeCustomTextFieldsInner} obj Optional instance to populate.
     * @return {module:model/EmployeeCustomTextFieldsInner} The populated <code>EmployeeCustomTextFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeCustomTextFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeCustomTextFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeCustomTextFieldsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmployeeCustomTextFieldsInner.RequiredProperties) {
...
EmployeeCustomTextFieldsInner.RequiredProperties = ["category", "label", "value"];

/**
 * The custom field category.  Acceptable value is 'PayrollAndHR'.
 * @member {module:model/EmployeeCustomTextFieldsInner.CategoryEnum} category
 */
EmployeeCustomTextFieldsInner.prototype['category'] = undefined;
 ...
 * @member {String} label
 */
EmployeeCustomTextFieldsInner.prototype['label'] = undefined;

/**
 * The custom text field value.  Max length: 255.
 * @member {String} value
 */
EmployeeCustomTextFieldsInner.prototype['value'] = undefined;
 ...
 * @readonly
 */
EmployeeCustomTextFieldsInner['CategoryEnum'] = {
...
export default EmployeeCustomTextFieldsInner;
