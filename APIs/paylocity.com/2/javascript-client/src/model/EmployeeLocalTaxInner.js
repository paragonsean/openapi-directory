...
/**
 * The EmployeeLocalTaxInner model module.
 * @module model/EmployeeLocalTaxInner
 * @version 2
 */
class EmployeeLocalTaxInner {
    /**
     * Constructs a new <code>EmployeeLocalTaxInner</code>.
     * The Local Tax model
     * @alias module:model/EmployeeLocalTaxInner
     */
    constructor() { 
        
        EmployeeLocalTaxInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeLocalTaxInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeLocalTaxInner} obj Optional instance to populate.
     * @return {module:model/EmployeeLocalTaxInner} The populated <code>EmployeeLocalTaxInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeLocalTaxInner();
            ...
            if (data.hasOwnProperty('residentPSD')) {
                obj['residentPSD'] = ApiClient.convertToType(data['residentPSD'], 'String');
            }
            if (data.hasOwnProperty('taxCode')) {
                obj['taxCode'] = ApiClient.convertToType(data['taxCode'], 'String');
            }
            if (data.hasOwnProperty('workPSD')) {
                obj['workPSD'] = ApiClient.convertToType(data['workPSD'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeLocalTaxInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeLocalTaxInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['residentPSD'] && !(typeof data['residentPSD'] === 'string' || data['residentPSD'] instanceof String)) {
            throw new Error("Expected the field `residentPSD` to be a primitive type in the JSON string but got " + data['residentPSD']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['workPSD'] && !(typeof data['workPSD'] === 'string' || data['workPSD'] instanceof String)) {
            throw new Error("Expected the field `workPSD` to be a primitive type in the JSON string but got " + data['workPSD']);
        }
...
export default EmployeeLocalTaxInner;
