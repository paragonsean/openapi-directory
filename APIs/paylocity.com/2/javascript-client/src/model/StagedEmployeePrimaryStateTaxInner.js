...
/**
 * The StagedEmployeePrimaryStateTaxInner model module.
 * @module model/StagedEmployeePrimaryStateTaxInner
 * @version 2
 */
class StagedEmployeePrimaryStateTaxInner {
    /**
     * Constructs a new <code>StagedEmployeePrimaryStateTaxInner</code>.
     * The State Tax model
     * @alias module:model/StagedEmployeePrimaryStateTaxInner
     */
    constructor() { 
        
        StagedEmployeePrimaryStateTaxInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeePrimaryStateTaxInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeePrimaryStateTaxInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeePrimaryStateTaxInner} The populated <code>StagedEmployeePrimaryStateTaxInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeePrimaryStateTaxInner();
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeePrimaryStateTaxInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeePrimaryStateTaxInner</code>.
     */
 ...
 */
StagedEmployeePrimaryStateTaxInner.prototype['specialCheckCalc'] = undefined;
 ...
 */
StagedEmployeePrimaryStateTaxInner.prototype['taxCalculationCode'] = undefined;

/**
 * State tax code.<br  /> Max length: 50
 * @member {String} taxCode
 */
StagedEmployeePrimaryStateTaxInner.prototype['taxCode'] = undefined;

/**
 * The state W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
StagedEmployeePrimaryStateTaxInner.prototype['w4FormYear'] = undefined;
...
export default StagedEmployeePrimaryStateTaxInner;
