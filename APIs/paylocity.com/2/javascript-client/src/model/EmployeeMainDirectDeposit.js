...
/**
 * The EmployeeMainDirectDeposit model module.
 * @module model/EmployeeMainDirectDeposit
 * @version 2
 */
class EmployeeMainDirectDeposit {
    /**
     * Constructs a new <code>EmployeeMainDirectDeposit</code>.
     ...
     * @alias module:model/EmployeeMainDirectDeposit
     */
    constructor() { 
        
        EmployeeMainDirectDeposit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeMainDirectDeposit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeMainDirectDeposit} obj Optional instance to populate.
     * @return {module:model/EmployeeMainDirectDeposit} The populated <code>EmployeeMainDirectDeposit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeMainDirectDeposit();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeMainDirectDeposit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeMainDirectDeposit</code>.
     */
 ...
 */
EmployeeMainDirectDeposit.prototype['accountNumber'] = undefined;

/**
 * Account type. Valid values are *C* (Checking), *S* (Saving), *P* (Pay Card). <br   />Max length: 1
 * @member {String} accountType
 */
EmployeeMainDirectDeposit.prototype['accountType'] = undefined;
...
export default EmployeeMainDirectDeposit;
