...
/**
 * The StagedEmployeeMainDirectDepositInner model module.
 * @module model/StagedEmployeeMainDirectDepositInner
 * @version 2
 */
class StagedEmployeeMainDirectDepositInner {
    /**
     * Constructs a new <code>StagedEmployeeMainDirectDepositInner</code>.
     * The Main Direct Deposit model
     * @alias module:model/StagedEmployeeMainDirectDepositInner
     */
    constructor() { 
        
        StagedEmployeeMainDirectDepositInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeMainDirectDepositInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeMainDirectDepositInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeMainDirectDepositInner} The populated <code>StagedEmployeeMainDirectDepositInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeMainDirectDepositInner();
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeMainDirectDepositInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeMainDirectDepositInner</code>.
     */
...
export default StagedEmployeeMainDirectDepositInner;
