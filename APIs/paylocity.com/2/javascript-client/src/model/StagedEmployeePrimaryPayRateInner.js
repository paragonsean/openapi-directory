...
/**
 * The StagedEmployeePrimaryPayRateInner model module.
 * @module model/StagedEmployeePrimaryPayRateInner
 * @version 2
 */
class StagedEmployeePrimaryPayRateInner {
    /**
     * Constructs a new <code>StagedEmployeePrimaryPayRateInner</code>.
     * The Primary Pay Rate model
     * @alias module:model/StagedEmployeePrimaryPayRateInner
     */
    constructor() { 
        
        StagedEmployeePrimaryPayRateInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeePrimaryPayRateInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeePrimaryPayRateInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeePrimaryPayRateInner} The populated <code>StagedEmployeePrimaryPayRateInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeePrimaryPayRateInner();
            ...
            if (data.hasOwnProperty('isAutoPay')) {
                obj['isAutoPay'] = ApiClient.convertToType(data['isAutoPay'], 'Boolean');
            }
            if (data.hasOwnProperty('payFrequency')) {
                obj['payFrequency'] = ApiClient.convertToType(data['payFrequency'], 'String');
            }
            if (data.hasOwnProperty('payGrade')) {
                obj['payGrade'] = ApiClient.convertToType(data['payGrade'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeePrimaryPayRateInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeePrimaryPayRateInner</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['payGrade'] && !(typeof data['payGrade'] === 'string' || data['payGrade'] instanceof String)) {
            throw new Error("Expected the field `payGrade` to be a primitive type in the JSON string but got " + data['payGrade']);
        }
        // ensure the json data is a string
        if (data['payType'] && !(typeof data['payType'] === 'string' || data['payType'] instanceof String)) {
            throw new Error("Expected the field `payType` to be a primitive type in the JSON string but got " + data['payType']);
        }
        // ensure the json data is a string
 ...
 */
StagedEmployeePrimaryPayRateInner.prototype['baseRate'] = undefined;

/**
 * Pay rate change reason.<br  /> Max length: 30
 * @member {String} changeReason
 */
StagedEmployeePrimaryPayRateInner.prototype['changeReason'] = undefined;
 ...
 */
StagedEmployeePrimaryPayRateInner.prototype['defaultHours'] = undefined;

/**
 * The date the employee's pay rate takes effect. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} effectiveDate
 */
StagedEmployeePrimaryPayRateInner.prototype['effectiveDate'] = undefined;

/**
 * If set to *True*, employee will be paid automatically using deafultHours.
 * @member {Boolean} isAutoPay
 */
StagedEmployeePrimaryPayRateInner.prototype['isAutoPay'] = undefined;
 ...
 * @member {String} payFrequency
 */
StagedEmployeePrimaryPayRateInner.prototype['payFrequency'] = undefined;

/**
 * Employee pay grade. Must match Company setup. <br  /> Max length: 10
 * @member {String} payGrade
 */
StagedEmployeePrimaryPayRateInner.prototype['payGrade'] = undefined;

/**
 * Employee pay type (rate code). Valid values are *Hourly* or *Salary*. <br  />Max length: 10
 * @member {String} payType
 */
StagedEmployeePrimaryPayRateInner.prototype['payType'] = undefined;
 ...
 */
StagedEmployeePrimaryPayRateInner.prototype['ratePer'] = undefined;

/**
 * Employee gross salary per pay period used with payType Salary.<br  />Decimal (12,6)
 * @member {Number} salary
 */
StagedEmployeePrimaryPayRateInner.prototype['salary'] = undefined;
...
export default StagedEmployeePrimaryPayRateInner;
