...
import DirectDepositAdditionalDirectDepositInner from './DirectDepositAdditionalDirectDepositInner';
import DirectDepositMainDirectDeposit from './DirectDepositMainDirectDeposit';

/**
 * The DirectDeposit model module.
 * @module model/DirectDeposit
 * @version 2
 */
class DirectDeposit {
    /**
     * Constructs a new <code>DirectDeposit</code>.
     * The Direct Deposit model
     * @alias module:model/DirectDeposit
     */
    constructor() { 
        
        DirectDeposit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DirectDeposit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DirectDeposit} obj Optional instance to populate.
     * @return {module:model/DirectDeposit} The populated <code>DirectDeposit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DirectDeposit();

            if (data.hasOwnProperty('additionalDirectDeposit')) {
                obj['additionalDirectDeposit'] = ApiClient.convertToType(data['additionalDirectDeposit'], [DirectDepositAdditionalDirectDepositInner]);
            }
            if (data.hasOwnProperty('mainDirectDeposit')) {
                obj['mainDirectDeposit'] = DirectDepositMainDirectDeposit.constructFromObject(data['mainDirectDeposit']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DirectDeposit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DirectDeposit</code>.
     */
    static validateJSON(data) {
        if (data['additionalDirectDeposit']) { // data not null
            ...
            for (const item of data['additionalDirectDeposit']) {
                DirectDepositAdditionalDirectDepositInner.validateJSON(item);
            };
        }
        // validate the optional field `mainDirectDeposit`
        if (data['mainDirectDeposit']) { // data not null
          DirectDepositMainDirectDeposit.validateJSON(data['mainDirectDeposit']);
        }
 ...
 * @member {Array.<module:model/DirectDepositAdditionalDirectDepositInner>} additionalDirectDeposit
 */
DirectDeposit.prototype['additionalDirectDeposit'] = undefined;

/**
 * @member {module:model/DirectDepositMainDirectDeposit} mainDirectDeposit
 */
DirectDeposit.prototype['mainDirectDeposit'] = undefined;
