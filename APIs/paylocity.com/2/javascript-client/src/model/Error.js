...
import ErrorOptionsInner from './ErrorOptionsInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('options')) {
                obj['options'] = ApiClient.convertToType(data['options'], [ErrorOptionsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['options']) { // data not null
            ...
            for (const item of data['options']) {
                ErrorOptionsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/ErrorOptionsInner>} options
 */
Error.prototype['options'] = undefined;
