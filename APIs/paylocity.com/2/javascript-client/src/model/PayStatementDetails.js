...
/**
 * The PayStatementDetails model module.
 * @module model/PayStatementDetails
 * @version 2
 */
class PayStatementDetails {
    /**
     * Constructs a new <code>PayStatementDetails</code>.
     * The pay statement details model
     * @alias module:model/PayStatementDetails
     */
    constructor() { 
        
        PayStatementDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PayStatementDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayStatementDetails} obj Optional instance to populate.
     * @return {module:model/PayStatementDetails} The populated <code>PayStatementDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayStatementDetails();
            ...
            if (data.hasOwnProperty('det')) {
                obj['det'] = ApiClient.convertToType(data['det'], 'String');
            }
            if (data.hasOwnProperty('detCode')) {
                obj['detCode'] = ApiClient.convertToType(data['detCode'], 'String');
            }
            if (data.hasOwnProperty('detType')) {
                obj['detType'] = ApiClient.convertToType(data['detType'], 'String');
            }
            if (data.hasOwnProperty('eligibleCompensation')) {
                obj['eligibleCompensation'] = ApiClient.convertToType(data['eligibleCompensation'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PayStatementDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayStatementDetails</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['det'] && !(typeof data['det'] === 'string' || data['det'] instanceof String)) {
            throw new Error("Expected the field `det` to be a primitive type in the JSON string but got " + data['det']);
        }
        // ensure the json data is a string
        if (data['detCode'] && !(typeof data['detCode'] === 'string' || data['detCode'] instanceof String)) {
            throw new Error("Expected the field `detCode` to be a primitive type in the JSON string but got " + data['detCode']);
        }
        // ensure the json data is a string
        if (data['detType'] && !(typeof data['detType'] === 'string' || data['detType'] instanceof String)) {
            throw new Error("Expected the field `detType` to be a primitive type in the JSON string but got " + data['detType']);
        }
        // ensure the json data is a string
 ...
 */
PayStatementDetails.prototype['amount'] = undefined;

/**
 * .<br />
 * @member {String} checkDate
 */
PayStatementDetails.prototype['checkDate'] = undefined;

/**
 * .<br />
 * @member {String} det
 */
PayStatementDetails.prototype['det'] = undefined;

/**
 * .<br />
 * @member {String} detCode
 */
PayStatementDetails.prototype['detCode'] = undefined;

/**
 * .<br />
 * @member {String} detType
 */
PayStatementDetails.prototype['detType'] = undefined;

/**
 * .<br />
 * @member {Number} eligibleCompensation
 */
PayStatementDetails.prototype['eligibleCompensation'] = undefined;

/**
 * .<br />
 * @member {Number} hours
 */
PayStatementDetails.prototype['hours'] = undefined;

/**
 * .<br />
 * @member {Number} rate
 */
PayStatementDetails.prototype['rate'] = undefined;

/**
 * <br />
 * @member {Number} transactionNumber
 */
PayStatementDetails.prototype['transactionNumber'] = undefined;

/**
 * .<br />
 * @member {String} transactionType
 */
PayStatementDetails.prototype['transactionType'] = undefined;

/**
 * .<br />
 * @member {Number} year
 */
PayStatementDetails.prototype['year'] = undefined;
...
export default PayStatementDetails;
