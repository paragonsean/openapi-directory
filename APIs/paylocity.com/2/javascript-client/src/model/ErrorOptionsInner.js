...
/**
 * The ErrorOptionsInner model module.
 * @module model/ErrorOptionsInner
 * @version 2
 */
class ErrorOptionsInner {
    /**
     * Constructs a new <code>ErrorOptionsInner</code>.
     * The error option model
     * @alias module:model/ErrorOptionsInner
     */
    constructor() { 
        
        ErrorOptionsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ErrorOptionsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ErrorOptionsInner} obj Optional instance to populate.
     * @return {module:model/ErrorOptionsInner} The populated <code>ErrorOptionsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorOptionsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorOptionsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorOptionsInner</code>.
     */
 ...
 * @member {String} code
 */
ErrorOptionsInner.prototype['code'] = undefined;

/**
 * The description of the option.
 * @member {String} description
 */
ErrorOptionsInner.prototype['description'] = undefined;
...
export default ErrorOptionsInner;
