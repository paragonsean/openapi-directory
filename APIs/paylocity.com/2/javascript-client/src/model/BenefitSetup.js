...
/**
 * The BenefitSetup model module.
 * @module model/BenefitSetup
 * @version 2
 */
class BenefitSetup {
    /**
     * Constructs a new <code>BenefitSetup</code>.
     * The benefit setup model
     * @alias module:model/BenefitSetup
     */
    constructor() { 
        
        BenefitSetup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BenefitSetup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BenefitSetup} obj Optional instance to populate.
     * @return {module:model/BenefitSetup} The populated <code>BenefitSetup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BenefitSetup();
    ...
    /**
     * Validates the JSON data with respect to <code>BenefitSetup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BenefitSetup</code>.
     */
 ...
 */
BenefitSetup.prototype['benefitSalaryEffectiveDate'] = undefined;
 ...
 */
BenefitSetup.prototype['doNotApplyAdministrativePeriod'] = undefined;
 ...
 */
BenefitSetup.prototype['isMeasureAcaEligibility'] = undefined;
