...
/**
 * The EmployeeNonPrimaryStateTax model module.
 * @module model/EmployeeNonPrimaryStateTax
 * @version 2
 */
class EmployeeNonPrimaryStateTax {
    /**
     * Constructs a new <code>EmployeeNonPrimaryStateTax</code>.
     ...
     * @alias module:model/EmployeeNonPrimaryStateTax
     */
    constructor() { 
        
        EmployeeNonPrimaryStateTax.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeNonPrimaryStateTax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeNonPrimaryStateTax} obj Optional instance to populate.
     * @return {module:model/EmployeeNonPrimaryStateTax} The populated <code>EmployeeNonPrimaryStateTax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeNonPrimaryStateTax();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeNonPrimaryStateTax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeNonPrimaryStateTax</code>.
     */
 ...
 */
EmployeeNonPrimaryStateTax.prototype['specialCheckCalc'] = undefined;
 ...
 */
EmployeeNonPrimaryStateTax.prototype['taxCalculationCode'] = undefined;

/**
 * State tax code.<br  /> Max length: 50
 * @member {String} taxCode
 */
EmployeeNonPrimaryStateTax.prototype['taxCode'] = undefined;

/**
 * The state W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
EmployeeNonPrimaryStateTax.prototype['w4FormYear'] = undefined;
...
export default EmployeeNonPrimaryStateTax;
