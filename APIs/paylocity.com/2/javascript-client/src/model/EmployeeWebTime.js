...
/**
 * The EmployeeWebTime model module.
 * @module model/EmployeeWebTime
 * @version 2
 */
class EmployeeWebTime {
    /**
     * Constructs a new <code>EmployeeWebTime</code>.
     * Add or update Web Time badge number and charge rate and synchronize Web Pay and Web Time employee data.
     * @alias module:model/EmployeeWebTime
     */
    constructor() { 
        
        EmployeeWebTime.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeWebTime</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeWebTime} obj Optional instance to populate.
     * @return {module:model/EmployeeWebTime} The populated <code>EmployeeWebTime</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeWebTime();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeWebTime</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeWebTime</code>.
     */
 ...
 */
EmployeeWebTime.prototype['badgeNumber'] = undefined;
...
export default EmployeeWebTime;
