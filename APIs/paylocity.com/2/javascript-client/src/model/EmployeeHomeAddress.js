...
/**
 * The EmployeeHomeAddress model module.
 * @module model/EmployeeHomeAddress
 * @version 2
 */
class EmployeeHomeAddress {
    /**
     * Constructs a new <code>EmployeeHomeAddress</code>.
     * Add or update employee&#39;s home address, personal phone numbers, and personal email.
     * @alias module:model/EmployeeHomeAddress
     */
    constructor() { 
        
        EmployeeHomeAddress.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeHomeAddress</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeHomeAddress} obj Optional instance to populate.
     * @return {module:model/EmployeeHomeAddress} The populated <code>EmployeeHomeAddress</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeHomeAddress();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeHomeAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeHomeAddress</code>.
     */
 ...
 */
EmployeeHomeAddress.prototype['address1'] = undefined;

/**
 * 2nd address line. <br  /> Max length: 40
 * @member {String} address2
 */
EmployeeHomeAddress.prototype['address2'] = undefined;

/**
 * City.<br  /> Max length: 40
 * @member {String} city
 */
EmployeeHomeAddress.prototype['city'] = undefined;

/**
 * Country.<br  /> Max length: 30
 * @member {String} country
 */
EmployeeHomeAddress.prototype['country'] = undefined;

/**
 * County.<br  /> Max length: 30
 * @member {String} county
 */
EmployeeHomeAddress.prototype['county'] = undefined;

/**
 * Email. <br  />Max length: 50
 * @member {String} emailAddress
 */
EmployeeHomeAddress.prototype['emailAddress'] = undefined;

/**
 * Mobile phone number.<br  /> Max length: 20
 * @member {String} mobilePhone
 */
EmployeeHomeAddress.prototype['mobilePhone'] = undefined;

/**
 * Phone number.<br  /> Max length: 20
 * @member {String} phone
 */
EmployeeHomeAddress.prototype['phone'] = undefined;

/**
 * Postal code.<br  /> Max length: 10
 * @member {String} postalCode
 */
EmployeeHomeAddress.prototype['postalCode'] = undefined;

/**
 * State or province.<br  /> Max length: 2
 * @member {String} state
 */
EmployeeHomeAddress.prototype['state'] = undefined;
...
export default EmployeeHomeAddress;
