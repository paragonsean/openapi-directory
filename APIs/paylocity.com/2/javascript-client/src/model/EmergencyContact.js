...
class EmergencyContact {
    ...
    constructor(firstName, lastName) { 
        ...
        EmergencyContact.initialize(this, firstName, lastName);
    }
...
EmergencyContact.RequiredProperties = ["firstName", "lastName"];

/**
 * 1st address line.
 * @member {String} address1
 */
EmergencyContact.prototype['address1'] = undefined;

/**
 * 2nd address line.
 * @member {String} address2
 */
EmergencyContact.prototype['address2'] = undefined;

/**
 * City.
 * @member {String} city
 */
EmergencyContact.prototype['city'] = undefined;

/**
 * County.
 * @member {String} country
 */
EmergencyContact.prototype['country'] = undefined;

/**
 * Country.  Must be a valid 3 character country code.  Common values are *USA* (United States), *CAN* (Canada).
 * @member {String} county
 */
EmergencyContact.prototype['county'] = undefined;

/**
 * Contact email.  Must be valid email address format.
 * @member {String} email
 */
EmergencyContact.prototype['email'] = undefined;

/**
 * Required. Contact first name. <br  />Max length: 40
 * @member {String} firstName
 */
EmergencyContact.prototype['firstName'] = undefined;
 ...
 */
EmergencyContact.prototype['homePhone'] = undefined;

/**
 * Required. Contact last name. <br  />Max length: 40
 * @member {String} lastName
 */
EmergencyContact.prototype['lastName'] = undefined;
 ...
 */
EmergencyContact.prototype['mobilePhone'] = undefined;

/**
 * Notes. <br  />Max length: 1000
 * @member {String} notes
 */
EmergencyContact.prototype['notes'] = undefined;

/**
 * Contact Pager.  Valid phone format  *(###) #######* or *######-####* or *### ### ####* or *##########* or, if international, starts with *+#*, only spaces and digits allowed.
 * @member {String} pager
 */
EmergencyContact.prototype['pager'] = undefined;
 ...
 */
EmergencyContact.prototype['workPhone'] = undefined;

/**
 * Postal code.  If U.S. address, must be a valid zip code.
 * @member {String} zip
 */
EmergencyContact.prototype['zip'] = undefined;
