...
/**
 * The StagedEmployeeHomeAddressInner model module.
 * @module model/StagedEmployeeHomeAddressInner
 * @version 2
 */
class StagedEmployeeHomeAddressInner {
    /**
     * Constructs a new <code>StagedEmployeeHomeAddressInner</code>.
     * The address model
     * @alias module:model/StagedEmployeeHomeAddressInner
     */
    constructor() { 
        
        StagedEmployeeHomeAddressInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeHomeAddressInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeHomeAddressInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeHomeAddressInner} The populated <code>StagedEmployeeHomeAddressInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeHomeAddressInner();
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeHomeAddressInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeHomeAddressInner</code>.
     */
 ...
 */
StagedEmployeeHomeAddressInner.prototype['address1'] = undefined;

/**
 * 2nd address line. <br  /> Max length: 40
 * @member {String} address2
 */
StagedEmployeeHomeAddressInner.prototype['address2'] = undefined;

/**
 * City.<br  /> Max length: 40
 * @member {String} city
 */
StagedEmployeeHomeAddressInner.prototype['city'] = undefined;

/**
 * Country.<br  /> Max length: 30
 * @member {String} country
 */
StagedEmployeeHomeAddressInner.prototype['country'] = undefined;

/**
 * County.<br  /> Max length: 30
 * @member {String} county
 */
StagedEmployeeHomeAddressInner.prototype['county'] = undefined;

/**
 * Email. <br  />Max length: 50
 * @member {String} emailAddress
 */
StagedEmployeeHomeAddressInner.prototype['emailAddress'] = undefined;

/**
 * Mobile phone number.<br  /> Max length: 12
 * @member {String} mobilePhone
 */
StagedEmployeeHomeAddressInner.prototype['mobilePhone'] = undefined;

/**
 * Phone number.<br  /> Max length: 12
 * @member {String} phone
 */
StagedEmployeeHomeAddressInner.prototype['phone'] = undefined;

/**
 * Postal code.<br  /> Max length: 10
 * @member {String} postalCode
 */
StagedEmployeeHomeAddressInner.prototype['postalCode'] = undefined;

/**
 * State or province.<br  /> Max length: 2
 * @member {String} state
 */
StagedEmployeeHomeAddressInner.prototype['state'] = undefined;
...
export default StagedEmployeeHomeAddressInner;
