...
/**
 * The EmployeeTaxSetup model module.
 * @module model/EmployeeTaxSetup
 * @version 2
 */
class EmployeeTaxSetup {
    /**
     * Constructs a new <code>EmployeeTaxSetup</code>.
     ...
     * @alias module:model/EmployeeTaxSetup
     */
    constructor() { 
        
        EmployeeTaxSetup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeTaxSetup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeTaxSetup} obj Optional instance to populate.
     * @return {module:model/EmployeeTaxSetup} The populated <code>EmployeeTaxSetup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeTaxSetup();

            if (data.hasOwnProperty('fitwExemptNotes')) {
                obj['fitwExemptNotes'] = ApiClient.convertToType(data['fitwExemptNotes'], 'String');
            }
            if (data.hasOwnProperty('fitwExemptReason')) {
                obj['fitwExemptReason'] = ApiClient.convertToType(data['fitwExemptReason'], 'String');
            }
            if (data.hasOwnProperty('futaExemptNotes')) {
                obj['futaExemptNotes'] = ApiClient.convertToType(data['futaExemptNotes'], 'String');
            }
            ...
            if (data.hasOwnProperty('isPension')) {
                obj['isPension'] = ApiClient.convertToType(data['isPension'], 'Boolean');
            }
            if (data.hasOwnProperty('isStatutory')) {
                obj['isStatutory'] = ApiClient.convertToType(data['isStatutory'], 'Boolean');
            }
            if (data.hasOwnProperty('medExemptNotes')) {
                obj['medExemptNotes'] = ApiClient.convertToType(data['medExemptNotes'], 'String');
            }
            if (data.hasOwnProperty('medExemptReason')) {
                obj['medExemptReason'] = ApiClient.convertToType(data['medExemptReason'], 'String');
            }
            if (data.hasOwnProperty('sitwExemptNotes')) {
                obj['sitwExemptNotes'] = ApiClient.convertToType(data['sitwExemptNotes'], 'String');
            }
            if (data.hasOwnProperty('sitwExemptReason')) {
                obj['sitwExemptReason'] = ApiClient.convertToType(data['sitwExemptReason'], 'String');
            }
            if (data.hasOwnProperty('ssExemptNotes')) {
                obj['ssExemptNotes'] = ApiClient.convertToType(data['ssExemptNotes'], 'String');
            }
            if (data.hasOwnProperty('ssExemptReason')) {
                obj['ssExemptReason'] = ApiClient.convertToType(data['ssExemptReason'], 'String');
            }
            if (data.hasOwnProperty('suiExemptNotes')) {
                obj['suiExemptNotes'] = ApiClient.convertToType(data['suiExemptNotes'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeTaxSetup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeTaxSetup</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['fitwExemptNotes'] && !(typeof data['fitwExemptNotes'] === 'string' || data['fitwExemptNotes'] instanceof String)) {
            throw new Error("Expected the field `fitwExemptNotes` to be a primitive type in the JSON string but got " + data['fitwExemptNotes']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['futaExemptNotes'] && !(typeof data['futaExemptNotes'] === 'string' || data['futaExemptNotes'] instanceof String)) {
            throw new Error("Expected the field `futaExemptNotes` to be a primitive type in the JSON string but got " + data['futaExemptNotes']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['medExemptNotes'] && !(typeof data['medExemptNotes'] === 'string' || data['medExemptNotes'] instanceof String)) {
            throw new Error("Expected the field `medExemptNotes` to be a primitive type in the JSON string but got " + data['medExemptNotes']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['sitwExemptNotes'] && !(typeof data['sitwExemptNotes'] === 'string' || data['sitwExemptNotes'] instanceof String)) {
            throw new Error("Expected the field `sitwExemptNotes` to be a primitive type in the JSON string but got " + data['sitwExemptNotes']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['ssExemptNotes'] && !(typeof data['ssExemptNotes'] === 'string' || data['ssExemptNotes'] instanceof String)) {
            throw new Error("Expected the field `ssExemptNotes` to be a primitive type in the JSON string but got " + data['ssExemptNotes']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['suiExemptNotes'] && !(typeof data['suiExemptNotes'] === 'string' || data['suiExemptNotes'] instanceof String)) {
            throw new Error("Expected the field `suiExemptNotes` to be a primitive type in the JSON string but got " + data['suiExemptNotes']);
        }
        // ensure the json data is a string
 ...
 * @member {String} fitwExemptNotes
 */
EmployeeTaxSetup.prototype['fitwExemptNotes'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['fitwExemptReason'] = undefined;

/**
 * Notes for FUTA exemption.<br  /> Max length: 250
 * @member {String} futaExemptNotes
 */
EmployeeTaxSetup.prototype['futaExemptNotes'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['futaExemptReason'] = undefined;

/**
 * Indicates if employee in agriculture or farming.
 * @member {Boolean} isEmployee943
 */
EmployeeTaxSetup.prototype['isEmployee943'] = undefined;

/**
 * Indicates if employee is eligible for pension.
 * @member {Boolean} isPension
 */
EmployeeTaxSetup.prototype['isPension'] = undefined;

/**
 * Indicates if employee is statutory.
 * @member {Boolean} isStatutory
 */
EmployeeTaxSetup.prototype['isStatutory'] = undefined;

/**
 * Notes for Medicare exemption.<br  /> Max length: 250
 * @member {String} medExemptNotes
 */
EmployeeTaxSetup.prototype['medExemptNotes'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['medExemptReason'] = undefined;

/**
 * Notes for SITW exemption.<br  /> Max length: 250
 * @member {String} sitwExemptNotes
 */
EmployeeTaxSetup.prototype['sitwExemptNotes'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['sitwExemptReason'] = undefined;

/**
 * Notes for Social Security exemption.<br  /> Max length: 250
 * @member {String} ssExemptNotes
 */
EmployeeTaxSetup.prototype['ssExemptNotes'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['ssExemptReason'] = undefined;

/**
 * Notes for SUI exemption.<br  /> Max length: 250
 * @member {String} suiExemptNotes
 */
EmployeeTaxSetup.prototype['suiExemptNotes'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['suiExemptReason'] = undefined;

/**
 * Employee SUI (State Unemployment Insurance) state. <br  />Max length: 2
 * @member {String} suiState
 */
EmployeeTaxSetup.prototype['suiState'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['taxDistributionCode1099R'] = undefined;
 ...
 */
EmployeeTaxSetup.prototype['taxForm'] = undefined;
