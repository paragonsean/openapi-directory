...
/**
 * The StagedEmployeeAdditionalDirectDepositInner model module.
 * @module model/StagedEmployeeAdditionalDirectDepositInner
 * @version 2
 */
class StagedEmployeeAdditionalDirectDepositInner {
    /**
     * Constructs a new <code>StagedEmployeeAdditionalDirectDepositInner</code>.
     * The additional direct deposit model
     * @alias module:model/StagedEmployeeAdditionalDirectDepositInner
     */
    constructor() { 
        
        StagedEmployeeAdditionalDirectDepositInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StagedEmployeeAdditionalDirectDepositInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StagedEmployeeAdditionalDirectDepositInner} obj Optional instance to populate.
     * @return {module:model/StagedEmployeeAdditionalDirectDepositInner} The populated <code>StagedEmployeeAdditionalDirectDepositInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StagedEmployeeAdditionalDirectDepositInner();
    ...
    /**
     * Validates the JSON data with respect to <code>StagedEmployeeAdditionalDirectDepositInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StagedEmployeeAdditionalDirectDepositInner</code>.
     */
 ...
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['accountNumber'] = undefined;

/**
 * Account type. Valid values are *C* (Checking), *S* (Saving), *P* (Pay Card). <br   />Max length: 1<br />
 * @member {String} accountType
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['accountType'] = undefined;

/**
 * Amount value to be deposited to the account.<br  />Decimal (12,2)<br />
 * @member {Number} amount
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['amount'] = undefined;
 ...
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['amountType'] = undefined;

/**
 * Indicates if account will not pre-note.<br />
 * @member {Boolean} isSkipPreNote
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['isSkipPreNote'] = undefined;

/**
 * Date to end the pre-note of the account. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.<br />
 * @member {String} preNoteDate
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['preNoteDate'] = undefined;

/**
 * ABA Transit Routing Number, entered without dashes or spaces. <br  />Max length: 9<br />
 * @member {String} routingNumber
 */
StagedEmployeeAdditionalDirectDepositInner.prototype['routingNumber'] = undefined;
...
export default StagedEmployeeAdditionalDirectDepositInner;
