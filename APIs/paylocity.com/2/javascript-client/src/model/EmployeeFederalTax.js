...
/**
 * The EmployeeFederalTax model module.
 * @module model/EmployeeFederalTax
 * @version 2
 */
class EmployeeFederalTax {
    /**
     * Constructs a new <code>EmployeeFederalTax</code>.
     * Add or update federal tax amount type (taxCalculationCode), amount or percentage, filing status, and exemptions.
     * @alias module:model/EmployeeFederalTax
     */
    constructor() { 
        
        EmployeeFederalTax.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeFederalTax</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeFederalTax} obj Optional instance to populate.
     * @return {module:model/EmployeeFederalTax} The populated <code>EmployeeFederalTax</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeFederalTax();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeFederalTax</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeFederalTax</code>.
     */
 ...
 */
EmployeeFederalTax.prototype['taxCalculationCode'] = undefined;

/**
 * The federal W4 form year <br  />Integer
 * @member {Number} w4FormYear
 */
EmployeeFederalTax.prototype['w4FormYear'] = undefined;
...
export default EmployeeFederalTax;
