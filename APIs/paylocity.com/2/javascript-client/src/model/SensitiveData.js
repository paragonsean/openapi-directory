...
import SensitiveDataDisability from './SensitiveDataDisability';
import SensitiveDataEthnicity from './SensitiveDataEthnicity';
import SensitiveDataGender from './SensitiveDataGender';
import SensitiveDataVeteran from './SensitiveDataVeteran';

/**
 * The SensitiveData model module.
 * @module model/SensitiveData
 * @version 2
 */
class SensitiveData {
    /**
     * Constructs a new <code>SensitiveData</code>.
     * The sensitive data model
     * @alias module:model/SensitiveData
     */
    constructor() { 
        
        SensitiveData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SensitiveData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SensitiveData} obj Optional instance to populate.
     * @return {module:model/SensitiveData} The populated <code>SensitiveData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SensitiveData();

            if (data.hasOwnProperty('disability')) {
                obj['disability'] = SensitiveDataDisability.constructFromObject(data['disability']);
            }
            if (data.hasOwnProperty('ethnicity')) {
                obj['ethnicity'] = SensitiveDataEthnicity.constructFromObject(data['ethnicity']);
            }
            if (data.hasOwnProperty('gender')) {
                obj['gender'] = SensitiveDataGender.constructFromObject(data['gender']);
            }
            if (data.hasOwnProperty('veteran')) {
                obj['veteran'] = SensitiveDataVeteran.constructFromObject(data['veteran']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SensitiveData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SensitiveData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `disability`
        if (data['disability']) { // data not null
          SensitiveDataDisability.validateJSON(data['disability']);
        }
        // validate the optional field `ethnicity`
        if (data['ethnicity']) { // data not null
          SensitiveDataEthnicity.validateJSON(data['ethnicity']);
        }
        // validate the optional field `gender`
        if (data['gender']) { // data not null
          SensitiveDataGender.validateJSON(data['gender']);
        }
        // validate the optional field `veteran`
        if (data['veteran']) { // data not null
          SensitiveDataVeteran.validateJSON(data['veteran']);
        }
...
/**
 * @member {module:model/SensitiveDataDisability} disability
 */
SensitiveData.prototype['disability'] = undefined;

/**
 * @member {module:model/SensitiveDataEthnicity} ethnicity
 */
SensitiveData.prototype['ethnicity'] = undefined;

/**
 * @member {module:model/SensitiveDataGender} gender
 */
SensitiveData.prototype['gender'] = undefined;

/**
 * @member {module:model/SensitiveDataVeteran} veteran
 */
SensitiveData.prototype['veteran'] = undefined;
