...
/**
 * The EmployeeStatus model module.
 * @module model/EmployeeStatus
 * @version 2
 */
class EmployeeStatus {
    /**
     * Constructs a new <code>EmployeeStatus</code>.
     ...
     * @alias module:model/EmployeeStatus
     */
    constructor() { 
        
        EmployeeStatus.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeStatus</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeStatus} obj Optional instance to populate.
     * @return {module:model/EmployeeStatus} The populated <code>EmployeeStatus</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeStatus();
            ...
            if (data.hasOwnProperty('reHireDate')) {
                obj['reHireDate'] = ApiClient.convertToType(data['reHireDate'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeStatus</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['reHireDate'] && !(typeof data['reHireDate'] === 'string' || data['reHireDate'] instanceof String)) {
            throw new Error("Expected the field `reHireDate` to be a primitive type in the JSON string but got " + data['reHireDate']);
        }
        // ensure the json data is a string
 ...
 */
EmployeeStatus.prototype['employeeStatus'] = undefined;
 ...
 */
EmployeeStatus.prototype['hireDate'] = undefined;

/**
 * Indicates if employee eligible for rehire.
 * @member {Boolean} isEligibleForRehire
 */
EmployeeStatus.prototype['isEligibleForRehire'] = undefined;
 ...
 * @member {String} reHireDate
 */
EmployeeStatus.prototype['reHireDate'] = undefined;
