...
/**
 * The TrackingNumberResponse model module.
 * @module model/TrackingNumberResponse
 * @version 2
 */
class TrackingNumberResponse {
    /**
     * Constructs a new <code>TrackingNumberResponse</code>.
     * The Tracking Number Response model
     * @alias module:model/TrackingNumberResponse
     */
    constructor() { 
        
        TrackingNumberResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TrackingNumberResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TrackingNumberResponse} obj Optional instance to populate.
     * @return {module:model/TrackingNumberResponse} The populated <code>TrackingNumberResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingNumberResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>TrackingNumberResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TrackingNumberResponse</code>.
     */
 ...
 */
TrackingNumberResponse.prototype['trackingNumber'] = undefined;
...
export default TrackingNumberResponse;
