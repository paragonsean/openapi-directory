...
/**
 * The EmployeeBenefitSetup model module.
 * @module model/EmployeeBenefitSetup
 * @version 2
 */
class EmployeeBenefitSetup {
    /**
     * Constructs a new <code>EmployeeBenefitSetup</code>.
     *  Add or update setup values used for employee benefits integration, insurance plan settings, and ACA reporting.
     * @alias module:model/EmployeeBenefitSetup
     */
    constructor() { 
        
        EmployeeBenefitSetup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeBenefitSetup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeBenefitSetup} obj Optional instance to populate.
     * @return {module:model/EmployeeBenefitSetup} The populated <code>EmployeeBenefitSetup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeBenefitSetup();
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeBenefitSetup</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeBenefitSetup</code>.
     */
 ...
 */
EmployeeBenefitSetup.prototype['benefitSalaryEffectiveDate'] = undefined;
 ...
 */
EmployeeBenefitSetup.prototype['doNotApplyAdministrativePeriod'] = undefined;
 ...
 */
EmployeeBenefitSetup.prototype['isMeasureAcaEligibility'] = undefined;
...
export default EmployeeBenefitSetup;
