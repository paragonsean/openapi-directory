...
/**
 * The EmployeeDepartmentPosition model module.
 * @module model/EmployeeDepartmentPosition
 * @version 2
 */
class EmployeeDepartmentPosition {
    /**
     * Constructs a new <code>EmployeeDepartmentPosition</code>.
     ...
     * @alias module:model/EmployeeDepartmentPosition
     */
    constructor() { 
        
        EmployeeDepartmentPosition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EmployeeDepartmentPosition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmployeeDepartmentPosition} obj Optional instance to populate.
     * @return {module:model/EmployeeDepartmentPosition} The populated <code>EmployeeDepartmentPosition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmployeeDepartmentPosition();
            ...
            if (data.hasOwnProperty('reviewerCompanyNumber')) {
                obj['reviewerCompanyNumber'] = ApiClient.convertToType(data['reviewerCompanyNumber'], 'String');
            }
            if (data.hasOwnProperty('reviewerEmployeeId')) {
                obj['reviewerEmployeeId'] = ApiClient.convertToType(data['reviewerEmployeeId'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>EmployeeDepartmentPosition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmployeeDepartmentPosition</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['reviewerCompanyNumber'] && !(typeof data['reviewerCompanyNumber'] === 'string' || data['reviewerCompanyNumber'] instanceof String)) {
            throw new Error("Expected the field `reviewerCompanyNumber` to be a primitive type in the JSON string but got " + data['reviewerCompanyNumber']);
        }
        // ensure the json data is a string
        if (data['reviewerEmployeeId'] && !(typeof data['reviewerEmployeeId'] === 'string' || data['reviewerEmployeeId'] instanceof String)) {
            throw new Error("Expected the field `reviewerEmployeeId` to be a primitive type in the JSON string but got " + data['reviewerEmployeeId']);
        }
        // ensure the json data is a string
 ...
 */
EmployeeDepartmentPosition.prototype['changeReason'] = undefined;

/**
 * Employee clock badge number. Defaults to employeeId. <br  />Max length: 10
 * @member {String} clockBadgeNumber
 */
EmployeeDepartmentPosition.prototype['clockBadgeNumber'] = undefined;
 ...
 */
EmployeeDepartmentPosition.prototype['costCenter1'] = undefined;

/**
 * Employer defined location, like *branch, division, department*, etc. Must match Company setup. <br  />Max length: 10
 * @member {String} costCenter2
 */
EmployeeDepartmentPosition.prototype['costCenter2'] = undefined;

/**
 * Employer defined location, like *branch, division, department*, etc. Must match Company setup. <br  />Max length: 10
 * @member {String} costCenter3
 */
EmployeeDepartmentPosition.prototype['costCenter3'] = undefined;

/**
 * The date the position takes effect. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} effectiveDate
 */
EmployeeDepartmentPosition.prototype['effectiveDate'] = undefined;
...
export default EmployeeDepartmentPosition;
