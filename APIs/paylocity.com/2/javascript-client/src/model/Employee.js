...
import EmployeeAdditionalRateInner from './EmployeeAdditionalRateInner';
...
import EmployeeDepartmentPosition from './EmployeeDepartmentPosition';
import EmployeeEmergencyContactsInner from './EmployeeEmergencyContactsInner';
import EmployeeFederalTax from './EmployeeFederalTax';
import EmployeeHomeAddress from './EmployeeHomeAddress';
import EmployeeLocalTaxInner from './EmployeeLocalTaxInner';
import EmployeeMainDirectDeposit from './EmployeeMainDirectDeposit';
import EmployeeNonPrimaryStateTax from './EmployeeNonPrimaryStateTax';
import EmployeePrimaryPayRate from './EmployeePrimaryPayRate';
import EmployeePrimaryStateTax from './EmployeePrimaryStateTax';
import EmployeeStatus from './EmployeeStatus';
import EmployeeTaxSetup from './EmployeeTaxSetup';
import EmployeeWebTime from './EmployeeWebTime';
import EmployeeWorkAddress from './EmployeeWorkAddress';
import EmployeeWorkEligibility from './EmployeeWorkEligibility';
...
class Employee {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additionalRate')) {
                obj['additionalRate'] = ApiClient.convertToType(data['additionalRate'], [EmployeeAdditionalRateInner]);
            }
            if (data.hasOwnProperty('benefitSetup')) {
                obj['benefitSetup'] = EmployeeBenefitSetup.constructFromObject(data['benefitSetup']);
            }
            if (data.hasOwnProperty('birthDate')) {
                obj['birthDate'] = ApiClient.convertToType(data['birthDate'], 'String');
            }
            if (data.hasOwnProperty('coEmpCode')) {
                obj['coEmpCode'] = ApiClient.convertToType(data['coEmpCode'], 'String');
            }
            if (data.hasOwnProperty('companyFEIN')) {
                obj['companyFEIN'] = ApiClient.convertToType(data['companyFEIN'], 'String');
            }
            ...
            if (data.hasOwnProperty('departmentPosition')) {
                obj['departmentPosition'] = EmployeeDepartmentPosition.constructFromObject(data['departmentPosition']);
            }
            ...
            if (data.hasOwnProperty('emergencyContacts')) {
                obj['emergencyContacts'] = ApiClient.convertToType(data['emergencyContacts'], [EmployeeEmergencyContactsInner]);
            }
            ...
            if (data.hasOwnProperty('federalTax')) {
                obj['federalTax'] = EmployeeFederalTax.constructFromObject(data['federalTax']);
            }
            ...
            if (data.hasOwnProperty('homeAddress')) {
                obj['homeAddress'] = EmployeeHomeAddress.constructFromObject(data['homeAddress']);
            }
            if (data.hasOwnProperty('isHighlyCompensated')) {
                obj['isHighlyCompensated'] = ApiClient.convertToType(data['isHighlyCompensated'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('mainDirectDeposit')) {
                obj['mainDirectDeposit'] = EmployeeMainDirectDeposit.constructFromObject(data['mainDirectDeposit']);
            }
            ...
            if (data.hasOwnProperty('nonPrimaryStateTax')) {
                obj['nonPrimaryStateTax'] = EmployeeNonPrimaryStateTax.constructFromObject(data['nonPrimaryStateTax']);
            }
            if (data.hasOwnProperty('ownerPercent')) {
                obj['ownerPercent'] = ApiClient.convertToType(data['ownerPercent'], 'Number');
            }
            ...
            if (data.hasOwnProperty('primaryPayRate')) {
                obj['primaryPayRate'] = EmployeePrimaryPayRate.constructFromObject(data['primaryPayRate']);
            }
            if (data.hasOwnProperty('primaryStateTax')) {
                obj['primaryStateTax'] = EmployeePrimaryStateTax.constructFromObject(data['primaryStateTax']);
            }
            ...
            if (data.hasOwnProperty('taxSetup')) {
                obj['taxSetup'] = EmployeeTaxSetup.constructFromObject(data['taxSetup']);
            }
            ...
            if (data.hasOwnProperty('webTime')) {
                obj['webTime'] = EmployeeWebTime.constructFromObject(data['webTime']);
            }
            if (data.hasOwnProperty('workAddress')) {
                obj['workAddress'] = EmployeeWorkAddress.constructFromObject(data['workAddress']);
            }
            if (data.hasOwnProperty('workEligibility')) {
                obj['workEligibility'] = EmployeeWorkEligibility.constructFromObject(data['workEligibility']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['additionalRate']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['additionalRate'])) {
                throw new Error("Expected the field `additionalRate` to be an array in the JSON data but got " + data['additionalRate']);
            }
            // validate the optional field `additionalRate` (array)
            for (const item of data['additionalRate']) {
                EmployeeAdditionalRateInner.validateJSON(item);
            };
        }
        // validate the optional field `benefitSetup`
        if (data['benefitSetup']) { // data not null
          EmployeeBenefitSetup.validateJSON(data['benefitSetup']);
        }
        ...
        // ensure the json data is a string
        if (data['coEmpCode'] && !(typeof data['coEmpCode'] === 'string' || data['coEmpCode'] instanceof String)) {
            throw new Error("Expected the field `coEmpCode` to be a primitive type in the JSON string but got " + data['coEmpCode']);
        }
        // ensure the json data is a string
        if (data['companyFEIN'] && !(typeof data['companyFEIN'] === 'string' || data['companyFEIN'] instanceof String)) {
            throw new Error("Expected the field `companyFEIN` to be a primitive type in the JSON string but got " + data['companyFEIN']);
        }
        // ensure the json data is a string
        ...
        if (data['departmentPosition']) { // data not null
          EmployeeDepartmentPosition.validateJSON(data['departmentPosition']);
        }
        // ensure the json data is a string
        ...
        if (data['emergencyContacts']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['emergencyContacts'])) {
                throw new Error("Expected the field `emergencyContacts` to be an array in the JSON data but got " + data['emergencyContacts']);
            }
            // validate the optional field `emergencyContacts` (array)
            for (const item of data['emergencyContacts']) {
                EmployeeEmergencyContactsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['federalTax']) { // data not null
          EmployeeFederalTax.validateJSON(data['federalTax']);
        }
        // ensure the json data is a string
        ...
        if (data['homeAddress']) { // data not null
          EmployeeHomeAddress.validateJSON(data['homeAddress']);
        }
        // ensure the json data is a string
        ...
        if (data['mainDirectDeposit']) { // data not null
          EmployeeMainDirectDeposit.validateJSON(data['mainDirectDeposit']);
        }
        // ensure the json data is a string
        ...
        if (data['nonPrimaryStateTax']) { // data not null
          EmployeeNonPrimaryStateTax.validateJSON(data['nonPrimaryStateTax']);
        }
        // ensure the json data is a string
        ...
        if (data['primaryPayRate']) { // data not null
          EmployeePrimaryPayRate.validateJSON(data['primaryPayRate']);
        }
        // validate the optional field `primaryStateTax`
        if (data['primaryStateTax']) { // data not null
          EmployeePrimaryStateTax.validateJSON(data['primaryStateTax']);
        }
        // ensure the json data is a string
        ...
        if (data['status']) { // data not null
          EmployeeStatus.validateJSON(data['status']);
        }
        // ensure the json data is a string
        ...
        if (data['taxSetup']) { // data not null
          EmployeeTaxSetup.validateJSON(data['taxSetup']);
        }
        // ensure the json data is a string
 ...
 */
Employee.prototype['additionalDirectDeposit'] = undefined;

/**
 * Add Additional Rates.
 * @member {Array.<module:model/EmployeeAdditionalRateInner>} additionalRate
 */
Employee.prototype['additionalRate'] = undefined;

/**
 * @member {module:model/EmployeeBenefitSetup} benefitSetup
 */
Employee.prototype['benefitSetup'] = undefined;

/**
 * Employee birthdate. Common formats include *MM-DD-CCYY*, *CCYY-MM-DD*.
 * @member {String} birthDate
 */
Employee.prototype['birthDate'] = undefined;

/**
 * Unique idenifier for SSO.<br  />Max length: 20
 * @member {String} coEmpCode
 */
Employee.prototype['coEmpCode'] = undefined;

/**
 * Company FEIN as defined in Web Pay, applicable with GET requests only.<br  /> Max length: 20
 * @member {String} companyFEIN
 */
Employee.prototype['companyFEIN'] = undefined;

/**
 * Company name as defined in Web Pay, applicable with GET requests only.<br  /> Max length: 50
 * @member {String} companyName
 */
Employee.prototype['companyName'] = undefined;

/**
 * Employee is paid in this currency. <br  />Max length: 30
 * @member {String} currency
 */
Employee.prototype['currency'] = undefined;
 ...
 */
Employee.prototype['customDropDownFields'] = undefined;

/**
 * Up to 8 custom fields of numeric type value.
 * @member {Array.<module:model/EmployeeCustomNumberFieldsInner>} customNumberFields
 */
Employee.prototype['customNumberFields'] = undefined;

/**
 * Up to 8 custom fields of text type value.
 * @member {Array.<module:model/EmployeeCustomTextFieldsInner>} customTextFields
 */
Employee.prototype['customTextFields'] = undefined;

/**
 * @member {module:model/EmployeeDepartmentPosition} departmentPosition
 */
Employee.prototype['departmentPosition'] = undefined;

/**
 * Indicates if employee has disability status.
 * @member {String} disabilityDescription
 */
Employee.prototype['disabilityDescription'] = undefined;

/**
 * Add or update Emergency Contacts.
 * @member {Array.<module:model/EmployeeEmergencyContactsInner>} emergencyContacts
 */
Employee.prototype['emergencyContacts'] = undefined;
...
/**
 * @member {module:model/EmployeeFederalTax} federalTax
 */
Employee.prototype['federalTax'] = undefined;
...
/**
 * @member {module:model/EmployeeHomeAddress} homeAddress
 */
Employee.prototype['homeAddress'] = undefined;

/**
 * Indicates if employee meets the highly compensated employee criteria.
 * @member {Boolean} isHighlyCompensated
 */
Employee.prototype['isHighlyCompensated'] = undefined;

/**
 * Indicates if employee is a smoker.
 * @member {Boolean} isSmoker
 */
Employee.prototype['isSmoker'] = undefined;
 ...
 */
Employee.prototype['localTax'] = undefined;

/**
 * @member {module:model/EmployeeMainDirectDeposit} mainDirectDeposit
 */
Employee.prototype['mainDirectDeposit'] = undefined;
 ...
 */
Employee.prototype['maritalStatus'] = undefined;

/**
 * Employee middle name.<br  /> Max length: 20
 * @member {String} middleName
 */
Employee.prototype['middleName'] = undefined;

/**
 * @member {module:model/EmployeeNonPrimaryStateTax} nonPrimaryStateTax
 */
Employee.prototype['nonPrimaryStateTax'] = undefined;

/**
 * Percentage of employee's ownership in the company, entered as a whole number. <br  /> Decimal (12,2)
 * @member {Number} ownerPercent
 */
Employee.prototype['ownerPercent'] = undefined;

/**
 * Employee preferred display name.<br  /> Max length: 20
 * @member {String} preferredName
 */
Employee.prototype['preferredName'] = undefined;

/**
 * @member {module:model/EmployeePrimaryPayRate} primaryPayRate
 */
Employee.prototype['primaryPayRate'] = undefined;

/**
 * @member {module:model/EmployeePrimaryStateTax} primaryStateTax
 */
Employee.prototype['primaryStateTax'] = undefined;

/**
 * Prior last name if applicable.<br  />Max length: 40
 * @member {String} priorLastName
 */
Employee.prototype['priorLastName'] = undefined;

/**
 * Employee preferred salutation. <br  />Max length: 10
 * @member {String} salutation
 */
Employee.prototype['salutation'] = undefined;
 ...
 */
Employee.prototype['suffix'] = undefined;

/**
 * @member {module:model/EmployeeTaxSetup} taxSetup
 */
Employee.prototype['taxSetup'] = undefined;

/**
 * Indicates if employee is a veteran.
 * @member {String} veteranDescription
 */
Employee.prototype['veteranDescription'] = undefined;

/**
 * @member {module:model/EmployeeWebTime} webTime
 */
Employee.prototype['webTime'] = undefined;

/**
 * @member {module:model/EmployeeWorkAddress} workAddress
 */
Employee.prototype['workAddress'] = undefined;

/**
 * @member {module:model/EmployeeWorkEligibility} workEligibility
 */
Employee.prototype['workEligibility'] = undefined;
