...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.ClientCredentialsApi();
  });
  ...
  describe('ClientCredentialsApi', function() {
    describe('addClientSecret', function() {
      it('should call addClientSecret successfully', function(done) {
        //uncomment below and update the code to test addClientSecret
        //instance.addClientSecret(function(error) {
