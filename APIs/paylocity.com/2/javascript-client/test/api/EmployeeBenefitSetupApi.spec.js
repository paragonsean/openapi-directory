...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeBenefitSetupApi();
  });
  ...
  describe('EmployeeBenefitSetupApi', function() {
    describe('updateOrAddEmployeeBenefitSetup', function() {
      it('should call updateOrAddEmployeeBenefitSetup successfully', function(done) {
        //uncomment below and update the code to test updateOrAddEmployeeBenefitSetup
        //instance.updateOrAddEmployeeBenefitSetup(function(error) {
