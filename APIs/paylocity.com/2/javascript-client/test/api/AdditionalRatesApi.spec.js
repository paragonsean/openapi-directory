...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.AdditionalRatesApi();
  });
  ...
  describe('AdditionalRatesApi', function() {
    describe('addOrUpdateAdditionalRates', function() {
      it('should call addOrUpdateAdditionalRates successfully', function(done) {
        //uncomment below and update the code to test addOrUpdateAdditionalRates
        //instance.addOrUpdateAdditionalRates(function(error) {
