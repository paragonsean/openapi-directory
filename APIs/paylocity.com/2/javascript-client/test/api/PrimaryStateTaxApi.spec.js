...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.PrimaryStateTaxApi();
  });
  ...
  describe('PrimaryStateTaxApi', function() {
    describe('addOrUpdatePrimaryStateTax', function() {
      it('should call addOrUpdatePrimaryStateTax successfully', function(done) {
        //uncomment below and update the code to test addOrUpdatePrimaryStateTax
        //instance.addOrUpdatePrimaryStateTax(function(error) {
