...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeStagingApi();
  });
  ...
  describe('EmployeeStagingApi', function() {
    describe('addNewEmployeeToWebLink', function() {
      it('should call addNewEmployeeToWebLink successfully', function(done) {
        //uncomment below and update the code to test addNewEmployeeToWebLink
        //instance.addNewEmployeeToWebLink(function(error) {
