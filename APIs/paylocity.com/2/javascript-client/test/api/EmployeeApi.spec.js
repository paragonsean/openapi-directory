...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeApi();
  });
  ...
  describe('EmployeeApi', function() {
    describe('addEmployee', function() {
      it('should call addEmployee successfully', function(done) {
        //uncomment below and update the code to test addEmployee
        //instance.addEmployee(function(error) {
    ...
    describe('getAllEmployees', function() {
      it('should call getAllEmployees successfully', function(done) {
        //uncomment below and update the code to test getAllEmployees
        //instance.getAllEmployees(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
