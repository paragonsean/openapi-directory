...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.CompanySpecificSchemaApi();
  });
  ...
  describe('CompanySpecificSchemaApi', function() {
    describe('getCompanySpecificOpenAPIDocumentation', function() {
      it('should call getCompanySpecificOpenAPIDocumentation successfully', function(done) {
        //uncomment below and update the code to test getCompanySpecificOpenAPIDocumentation
        //instance.getCompanySpecificOpenAPIDocumentation(function(error) {
