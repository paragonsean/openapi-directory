...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.DirectDepositApi();
  });
  ...
  describe('DirectDepositApi', function() {
    describe('getAllDirectDeposit', function() {
      it('should call getAllDirectDeposit successfully', function(done) {
        //uncomment below and update the code to test getAllDirectDeposit
        //instance.getAllDirectDeposit(function(error) {
