...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.CompanyCodesApi();
  });
  ...
  describe('CompanyCodesApi', function() {
    describe('getAllCompanyCodesAndDescriptionsByResource', function() {
      it('should call getAllCompanyCodesAndDescriptionsByResource successfully', function(done) {
        //uncomment below and update the code to test getAllCompanyCodesAndDescriptionsByResource
        //instance.getAllCompanyCodesAndDescriptionsByResource(function(error) {
