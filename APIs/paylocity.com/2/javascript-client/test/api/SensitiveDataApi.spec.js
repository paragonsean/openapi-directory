...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataApi();
  });
  ...
  describe('SensitiveDataApi', function() {
    describe('addOrUpdateSensitiveData', function() {
      it('should call addOrUpdateSensitiveData successfully', function(done) {
        //uncomment below and update the code to test addOrUpdateSensitiveData
        //instance.addOrUpdateSensitiveData(function(error) {
    ...
    describe('getSensitiveData', function() {
      it('should call getSensitiveData successfully', function(done) {
        //uncomment below and update the code to test getSensitiveData
        //instance.getSensitiveData(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
