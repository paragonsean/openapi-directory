...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EarningsApi();
  });
  ...
  describe('EarningsApi', function() {
    describe('addOrUpdateAnEmployeeEarning', function() {
      it('should call addOrUpdateAnEmployeeEarning successfully', function(done) {
        //uncomment below and update the code to test addOrUpdateAnEmployeeEarning
        //instance.addOrUpdateAnEmployeeEarning(function(error) {
    ...
    describe('deleteEarningByEarningCodeAndStartDate', function() {
      it('should call deleteEarningByEarningCodeAndStartDate successfully', function(done) {
        //uncomment below and update the code to test deleteEarningByEarningCodeAndStartDate
        //instance.deleteEarningByEarningCodeAndStartDate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllEarnings', function() {
      it('should call getAllEarnings successfully', function(done) {
        //uncomment below and update the code to test getAllEarnings
        //instance.getAllEarnings(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEarningByEarningCodeAndStartDate', function() {
      it('should call getEarningByEarningCodeAndStartDate successfully', function(done) {
        //uncomment below and update the code to test getEarningByEarningCodeAndStartDate
        //instance.getEarningByEarningCodeAndStartDate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEarningsByEarningCode', function() {
      it('should call getEarningsByEarningCode successfully', function(done) {
        //uncomment below and update the code to test getEarningsByEarningCode
        //instance.getEarningsByEarningCode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
