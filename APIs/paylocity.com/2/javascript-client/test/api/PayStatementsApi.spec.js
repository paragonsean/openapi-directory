...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.PayStatementsApi();
  });
  ...
  describe('PayStatementsApi', function() {
    describe('getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear', function() {
      it('should call getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear successfully', function(done) {
        //uncomment below and update the code to test getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear
        //instance.getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYear(function(error) {
    ...
    describe('getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate', function() {
      it('should call getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate successfully', function(done) {
        //uncomment below and update the code to test getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate
        //instance.getsEmployeePayStatementDetailDataBasedOnTheSpecifiedYearAndCheckDate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear', function() {
      it('should call getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear successfully', function(done) {
        //uncomment below and update the code to test getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear
        //instance.getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYear(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate', function() {
      it('should call getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate successfully', function(done) {
        //uncomment below and update the code to test getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate
        //instance.getsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
