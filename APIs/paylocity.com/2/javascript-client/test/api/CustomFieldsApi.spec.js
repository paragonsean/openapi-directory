...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.CustomFieldsApi();
  });
  ...
  describe('CustomFieldsApi', function() {
    describe('getAllCustomFieldsByCategory', function() {
      it('should call getAllCustomFieldsByCategory successfully', function(done) {
        //uncomment below and update the code to test getAllCustomFieldsByCategory
        //instance.getAllCustomFieldsByCategory(function(error) {
