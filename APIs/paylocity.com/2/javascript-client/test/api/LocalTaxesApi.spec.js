...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.LocalTaxesApi();
  });
  ...
  describe('LocalTaxesApi', function() {
    describe('addLocalTax', function() {
      it('should call addLocalTax successfully', function(done) {
        //uncomment below and update the code to test addLocalTax
        //instance.addLocalTax(function(error) {
    ...
    describe('deleteLocalTaxByTaxCode', function() {
      it('should call deleteLocalTaxByTaxCode successfully', function(done) {
        //uncomment below and update the code to test deleteLocalTaxByTaxCode
        //instance.deleteLocalTaxByTaxCode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllLocalTaxes', function() {
      it('should call getAllLocalTaxes successfully', function(done) {
        //uncomment below and update the code to test getAllLocalTaxes
        //instance.getAllLocalTaxes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getLocalTaxByTaxCode', function() {
      it('should call getLocalTaxByTaxCode successfully', function(done) {
        //uncomment below and update the code to test getLocalTaxByTaxCode
        //instance.getLocalTaxByTaxCode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
