...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.NonPrimaryStateTaxApi();
  });
  ...
  describe('NonPrimaryStateTaxApi', function() {
    describe('addOrUpdateNonPrimaryStateTax', function() {
      it('should call addOrUpdateNonPrimaryStateTax successfully', function(done) {
        //uncomment below and update the code to test addOrUpdateNonPrimaryStateTax
        //instance.addOrUpdateNonPrimaryStateTax(function(error) {
