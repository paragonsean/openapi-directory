...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmergencyContactsApi();
  });
  ...
  describe('EmergencyContactsApi', function() {
    describe('addOrUpdateEmergencyContacts', function() {
      it('should call addOrUpdateEmergencyContacts successfully', function(done) {
        //uncomment below and update the code to test addOrUpdateEmergencyContacts
        //instance.addOrUpdateEmergencyContacts(function(error) {
