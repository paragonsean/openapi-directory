...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeEmergencyContactsInner();
  });
  ...
  describe('EmployeeEmergencyContactsInner', function() {
    it('should create an instance of EmployeeEmergencyContactsInner', function() {
      // uncomment below and update the code to test EmployeeEmergencyContactsInner
      //var instance = new PaylocityApi.EmployeeEmergencyContactsInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeEmergencyContactsInner);
    });
    ...
    it('should have the property syncEmployeeInfo (base name: "syncEmployeeInfo")', function() {
      // uncomment below and update the code to test the property syncEmployeeInfo
      //var instance = new PaylocityApi.EmployeeEmergencyContactsInner();
      //expect(instance).to.be();
    });

    it('should have the property workExtension (base name: "workExtension")', function() {
      // uncomment below and update the code to test the property workExtension
      //var instance = new PaylocityApi.EmployeeEmergencyContactsInner();
      //expect(instance).to.be();
    });
