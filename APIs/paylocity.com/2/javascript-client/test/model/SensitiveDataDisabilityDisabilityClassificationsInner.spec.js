...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataDisabilityDisabilityClassificationsInner();
  });
  ...
  describe('SensitiveDataDisabilityDisabilityClassificationsInner', function() {
    it('should create an instance of SensitiveDataDisabilityDisabilityClassificationsInner', function() {
      // uncomment below and update the code to test SensitiveDataDisabilityDisabilityClassificationsInner
      //var instance = new PaylocityApi.SensitiveDataDisabilityDisabilityClassificationsInner();
      //expect(instance).to.be.a(PaylocityApi.SensitiveDataDisabilityDisabilityClassificationsInner);
    });
