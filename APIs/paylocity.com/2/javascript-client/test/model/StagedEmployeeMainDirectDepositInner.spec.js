...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeMainDirectDepositInner();
  });
  ...
  describe('StagedEmployeeMainDirectDepositInner', function() {
    it('should create an instance of StagedEmployeeMainDirectDepositInner', function() {
      // uncomment below and update the code to test StagedEmployeeMainDirectDepositInner
      //var instance = new PaylocityApi.StagedEmployeeMainDirectDepositInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeMainDirectDepositInner);
    });
