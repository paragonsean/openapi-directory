...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.PayStatementSummary();
  });
  ...
  describe('PayStatementSummary', function() {
    it('should create an instance of PayStatementSummary', function() {
      // uncomment below and update the code to test PayStatementSummary
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be.a(PaylocityApi.PayStatementSummary);
    });
    ...
    it('should have the property directDepositAmount (base name: "directDepositAmount")', function() {
      // uncomment below and update the code to test the property directDepositAmount
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property netCheck (base name: "netCheck")', function() {
      // uncomment below and update the code to test the property netCheck
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property overtimeDollars (base name: "overtimeDollars")', function() {
      // uncomment below and update the code to test the property overtimeDollars
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be();
    });

    it('should have the property overtimeHours (base name: "overtimeHours")', function() {
      // uncomment below and update the code to test the property overtimeHours
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property regularDollars (base name: "regularDollars")', function() {
      // uncomment below and update the code to test the property regularDollars
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property workersCompCode (base name: "workersCompCode")', function() {
      // uncomment below and update the code to test the property workersCompCode
      //var instance = new PaylocityApi.PayStatementSummary();
      //expect(instance).to.be();
    });
