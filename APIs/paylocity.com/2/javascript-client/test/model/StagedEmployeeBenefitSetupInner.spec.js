...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeBenefitSetupInner();
  });
  ...
  describe('StagedEmployeeBenefitSetupInner', function() {
    it('should create an instance of StagedEmployeeBenefitSetupInner', function() {
      // uncomment below and update the code to test StagedEmployeeBenefitSetupInner
      //var instance = new PaylocityApi.StagedEmployeeBenefitSetupInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeBenefitSetupInner);
    });
