...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StateTax();
  });
  ...
  describe('StateTax', function() {
    it('should create an instance of StateTax', function() {
      // uncomment below and update the code to test StateTax
      //var instance = new PaylocityApi.StateTax();
      //expect(instance).to.be.a(PaylocityApi.StateTax);
    });
