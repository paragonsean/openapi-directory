...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeHomeAddressInner();
  });
  ...
  describe('StagedEmployeeHomeAddressInner', function() {
    it('should create an instance of StagedEmployeeHomeAddressInner', function() {
      // uncomment below and update the code to test StagedEmployeeHomeAddressInner
      //var instance = new PaylocityApi.StagedEmployeeHomeAddressInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeHomeAddressInner);
    });
