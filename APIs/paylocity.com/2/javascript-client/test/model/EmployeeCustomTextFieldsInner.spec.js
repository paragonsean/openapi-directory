...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeCustomTextFieldsInner();
  });
  ...
  describe('EmployeeCustomTextFieldsInner', function() {
    it('should create an instance of EmployeeCustomTextFieldsInner', function() {
      // uncomment below and update the code to test EmployeeCustomTextFieldsInner
      //var instance = new PaylocityApi.EmployeeCustomTextFieldsInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeCustomTextFieldsInner);
    });
