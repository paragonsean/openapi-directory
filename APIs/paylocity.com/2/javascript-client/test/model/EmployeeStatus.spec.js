...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeStatus();
  });
  ...
  describe('EmployeeStatus', function() {
    it('should create an instance of EmployeeStatus', function() {
      ...
      //var instance = new PaylocityApi.EmployeeStatus();
      //expect(instance).to.be.a(PaylocityApi.EmployeeStatus);
    });
    ...
    it('should have the property reHireDate (base name: "reHireDate")', function() {
      // uncomment below and update the code to test the property reHireDate
      //var instance = new PaylocityApi.EmployeeStatus();
      //expect(instance).to.be();
    });
