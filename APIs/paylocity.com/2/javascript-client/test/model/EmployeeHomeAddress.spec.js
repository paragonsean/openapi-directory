...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeHomeAddress();
  });
  ...
  describe('EmployeeHomeAddress', function() {
    it('should create an instance of EmployeeHomeAddress', function() {
      // uncomment below and update the code to test EmployeeHomeAddress
      //var instance = new PaylocityApi.EmployeeHomeAddress();
      //expect(instance).to.be.a(PaylocityApi.EmployeeHomeAddress);
    });
