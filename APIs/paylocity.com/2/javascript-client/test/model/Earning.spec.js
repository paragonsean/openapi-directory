...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.Earning();
  });
  ...
  describe('Earning', function() {
    it('should create an instance of Earning', function() {
      ...
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be.a(PaylocityApi.Earning);
    });
    ...
    it('should have the property annualMaximum (base name: "annualMaximum")', function() {
      // uncomment below and update the code to test the property annualMaximum
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });

    it('should have the property calculationCode (base name: "calculationCode")', function() {
      // uncomment below and update the code to test the property calculationCode
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });
    ...
    it('should have the property earningCode (base name: "earningCode")', function() {
      // uncomment below and update the code to test the property earningCode
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });
    ...
    it('should have the property hoursOrUnits (base name: "hoursOrUnits")', function() {
      // uncomment below and update the code to test the property hoursOrUnits
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });

    it('should have the property isSelfInsured (base name: "isSelfInsured")', function() {
      // uncomment below and update the code to test the property isSelfInsured
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });
    ...
    it('should have the property miscellaneousInfo (base name: "miscellaneousInfo")', function() {
      // uncomment below and update the code to test the property miscellaneousInfo
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });

    it('should have the property paidTowardsGoal (base name: "paidTowardsGoal")', function() {
      // uncomment below and update the code to test the property paidTowardsGoal
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });

    it('should have the property payPeriodMaximum (base name: "payPeriodMaximum")', function() {
      // uncomment below and update the code to test the property payPeriodMaximum
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });

    it('should have the property payPeriodMinimum (base name: "payPeriodMinimum")', function() {
      // uncomment below and update the code to test the property payPeriodMinimum
      //var instance = new PaylocityApi.Earning();
      //expect(instance).to.be();
    });
