...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeCustomDateFieldsInner();
  });
  ...
  describe('EmployeeCustomDateFieldsInner', function() {
    it('should create an instance of EmployeeCustomDateFieldsInner', function() {
      // uncomment below and update the code to test EmployeeCustomDateFieldsInner
      //var instance = new PaylocityApi.EmployeeCustomDateFieldsInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeCustomDateFieldsInner);
    });
