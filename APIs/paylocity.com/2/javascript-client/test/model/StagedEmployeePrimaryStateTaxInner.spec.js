...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeePrimaryStateTaxInner();
  });
  ...
  describe('StagedEmployeePrimaryStateTaxInner', function() {
    it('should create an instance of StagedEmployeePrimaryStateTaxInner', function() {
      // uncomment below and update the code to test StagedEmployeePrimaryStateTaxInner
      //var instance = new PaylocityApi.StagedEmployeePrimaryStateTaxInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeePrimaryStateTaxInner);
    });
