...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataDisability();
  });
  ...
  describe('SensitiveDataDisability', function() {
    it('should create an instance of SensitiveDataDisability', function() {
      // uncomment below and update the code to test SensitiveDataDisability
      //var instance = new PaylocityApi.SensitiveDataDisability();
      //expect(instance).to.be.a(PaylocityApi.SensitiveDataDisability);
    });

    it('should have the property disability (base name: "disability")', function() {
      // uncomment below and update the code to test the property disability
      //var instance = new PaylocityApi.SensitiveDataDisability();
      //expect(instance).to.be();
    });

    it('should have the property disabilityClassifications (base name: "disabilityClassifications")', function() {
      // uncomment below and update the code to test the property disabilityClassifications
      //var instance = new PaylocityApi.SensitiveDataDisability();
      //expect(instance).to.be();
    });

    it('should have the property hasDisability (base name: "hasDisability")', function() {
      // uncomment below and update the code to test the property hasDisability
      //var instance = new PaylocityApi.SensitiveDataDisability();
      //expect(instance).to.be();
    });
