...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeNonPrimaryStateTaxInner();
  });
  ...
  describe('StagedEmployeeNonPrimaryStateTaxInner', function() {
    it('should create an instance of StagedEmployeeNonPrimaryStateTaxInner', function() {
      // uncomment below and update the code to test StagedEmployeeNonPrimaryStateTaxInner
      //var instance = new PaylocityApi.StagedEmployeeNonPrimaryStateTaxInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeNonPrimaryStateTaxInner);
    });
    ...
    it('should have the property reciprocityCode (base name: "reciprocityCode")', function() {
      // uncomment below and update the code to test the property reciprocityCode
      //var instance = new PaylocityApi.StagedEmployeeNonPrimaryStateTaxInner();
      //expect(instance).to.be();
    });
