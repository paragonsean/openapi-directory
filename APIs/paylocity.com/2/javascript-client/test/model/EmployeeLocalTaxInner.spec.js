...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeLocalTaxInner();
  });
  ...
  describe('EmployeeLocalTaxInner', function() {
    it('should create an instance of EmployeeLocalTaxInner', function() {
      // uncomment below and update the code to test EmployeeLocalTaxInner
      //var instance = new PaylocityApi.EmployeeLocalTaxInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeLocalTaxInner);
    });
