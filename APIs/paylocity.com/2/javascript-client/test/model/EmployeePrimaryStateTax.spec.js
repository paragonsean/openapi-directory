...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeePrimaryStateTax();
  });
  ...
  describe('EmployeePrimaryStateTax', function() {
    it('should create an instance of EmployeePrimaryStateTax', function() {
      // uncomment below and update the code to test EmployeePrimaryStateTax
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be.a(PaylocityApi.EmployeePrimaryStateTax);
    });
    ...
    it('should have the property deductionsAmount (base name: "deductionsAmount")', function() {
      // uncomment below and update the code to test the property deductionsAmount
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property dependentsAmount (base name: "dependentsAmount")', function() {
      // uncomment below and update the code to test the property dependentsAmount
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property exemptions (base name: "exemptions")', function() {
      // uncomment below and update the code to test the property exemptions
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property exemptions2 (base name: "exemptions2")', function() {
      // uncomment below and update the code to test the property exemptions2
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property filingStatus (base name: "filingStatus")', function() {
      // uncomment below and update the code to test the property filingStatus
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property higherRate (base name: "higherRate")', function() {
      // uncomment below and update the code to test the property higherRate
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property otherIncomeAmount (base name: "otherIncomeAmount")', function() {
      // uncomment below and update the code to test the property otherIncomeAmount
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });
    ...
    it('should have the property specialCheckCalc (base name: "specialCheckCalc")', function() {
      // uncomment below and update the code to test the property specialCheckCalc
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });

    it('should have the property taxCalculationCode (base name: "taxCalculationCode")', function() {
      // uncomment below and update the code to test the property taxCalculationCode
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });
    ...
    it('should have the property w4FormYear (base name: "w4FormYear")', function() {
      // uncomment below and update the code to test the property w4FormYear
      //var instance = new PaylocityApi.EmployeePrimaryStateTax();
      //expect(instance).to.be();
    });
