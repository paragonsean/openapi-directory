...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.DirectDepositMainDirectDeposit();
  });
  ...
  describe('DirectDepositMainDirectDeposit', function() {
    it('should create an instance of DirectDepositMainDirectDeposit', function() {
      // uncomment below and update the code to test DirectDepositMainDirectDeposit
      //var instance = new PaylocityApi.DirectDepositMainDirectDeposit();
      //expect(instance).to.be.a(PaylocityApi.DirectDepositMainDirectDeposit);
    });
    ...
    it('should have the property blockSpecial (base name: "blockSpecial")', function() {
      // uncomment below and update the code to test the property blockSpecial
      //var instance = new PaylocityApi.DirectDepositMainDirectDeposit();
      //expect(instance).to.be();
    });

    it('should have the property isSkipPreNote (base name: "isSkipPreNote")', function() {
      // uncomment below and update the code to test the property isSkipPreNote
      //var instance = new PaylocityApi.DirectDepositMainDirectDeposit();
      //expect(instance).to.be();
    });

    it('should have the property nameOnAccount (base name: "nameOnAccount")', function() {
      // uncomment below and update the code to test the property nameOnAccount
      //var instance = new PaylocityApi.DirectDepositMainDirectDeposit();
      //expect(instance).to.be();
    });

    it('should have the property preNoteDate (base name: "preNoteDate")', function() {
      // uncomment below and update the code to test the property preNoteDate
      //var instance = new PaylocityApi.DirectDepositMainDirectDeposit();
      //expect(instance).to.be();
    });
