...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeWebTime();
  });
  ...
  describe('StagedEmployeeWebTime', function() {
    it('should create an instance of StagedEmployeeWebTime', function() {
      // uncomment below and update the code to test StagedEmployeeWebTime
      //var instance = new PaylocityApi.StagedEmployeeWebTime();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeWebTime);
    });

    it('should have the property badgeNumber (base name: "badgeNumber")', function() {
      // uncomment below and update the code to test the property badgeNumber
      //var instance = new PaylocityApi.StagedEmployeeWebTime();
    ...
    it('should have the property isTimeLaborEnabled (base name: "isTimeLaborEnabled")', function() {
      // uncomment below and update the code to test the property isTimeLaborEnabled
      //var instance = new PaylocityApi.StagedEmployeeWebTime();
      //expect(instance).to.be();
    });
