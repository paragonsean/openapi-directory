...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveData();
  });
  ...
  describe('SensitiveData', function() {
    it('should create an instance of SensitiveData', function() {
      // uncomment below and update the code to test SensitiveData
      //var instance = new PaylocityApi.SensitiveData();
      //expect(instance).to.be.a(PaylocityApi.SensitiveData);
    });
