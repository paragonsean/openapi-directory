...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeInfo();
  });
  ...
  describe('EmployeeInfo', function() {
    it('should create an instance of EmployeeInfo', function() {
      ...
      //var instance = new PaylocityApi.EmployeeInfo();
      //expect(instance).to.be.a(PaylocityApi.EmployeeInfo);
    });
    ...
    it('should have the property statusTypeCode (base name: "statusTypeCode")', function() {
      // uncomment below and update the code to test the property statusTypeCode
      //var instance = new PaylocityApi.EmployeeInfo();
      //expect(instance).to.be();
    });
