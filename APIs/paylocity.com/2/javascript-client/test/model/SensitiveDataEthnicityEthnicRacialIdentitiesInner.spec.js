...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataEthnicityEthnicRacialIdentitiesInner();
  });
  ...
  describe('SensitiveDataEthnicityEthnicRacialIdentitiesInner', function() {
    it('should create an instance of SensitiveDataEthnicityEthnicRacialIdentitiesInner', function() {
      // uncomment below and update the code to test SensitiveDataEthnicityEthnicRacialIdentitiesInner
      //var instance = new PaylocityApi.SensitiveDataEthnicityEthnicRacialIdentitiesInner();
      //expect(instance).to.be.a(PaylocityApi.SensitiveDataEthnicityEthnicRacialIdentitiesInner);
    });
