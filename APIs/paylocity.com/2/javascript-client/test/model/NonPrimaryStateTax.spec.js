...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.NonPrimaryStateTax();
  });
  ...
  describe('NonPrimaryStateTax', function() {
    it('should create an instance of NonPrimaryStateTax', function() {
      // uncomment below and update the code to test NonPrimaryStateTax
      //var instance = new PaylocityApi.NonPrimaryStateTax();
      //expect(instance).to.be.a(PaylocityApi.NonPrimaryStateTax);
    });
