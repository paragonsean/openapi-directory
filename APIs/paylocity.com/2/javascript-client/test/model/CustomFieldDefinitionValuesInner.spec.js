...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.CustomFieldDefinitionValuesInner();
  });
  ...
  describe('CustomFieldDefinitionValuesInner', function() {
    it('should create an instance of CustomFieldDefinitionValuesInner', function() {
      // uncomment below and update the code to test CustomFieldDefinitionValuesInner
      //var instance = new PaylocityApi.CustomFieldDefinitionValuesInner();
      //expect(instance).to.be.a(PaylocityApi.CustomFieldDefinitionValuesInner);
    });
