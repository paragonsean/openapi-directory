...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.BenefitSetup();
  });
  ...
  describe('BenefitSetup', function() {
    it('should create an instance of BenefitSetup', function() {
      // uncomment below and update the code to test BenefitSetup
      //var instance = new PaylocityApi.BenefitSetup();
      //expect(instance).to.be.a(PaylocityApi.BenefitSetup);
    });
