...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataVeteran();
  });
  ...
  describe('SensitiveDataVeteran', function() {
    it('should create an instance of SensitiveDataVeteran', function() {
      // uncomment below and update the code to test SensitiveDataVeteran
      //var instance = new PaylocityApi.SensitiveDataVeteran();
      //expect(instance).to.be.a(PaylocityApi.SensitiveDataVeteran);
    });

    it('should have the property isVeteran (base name: "isVeteran")', function() {
      // uncomment below and update the code to test the property isVeteran
      //var instance = new PaylocityApi.SensitiveDataVeteran();
