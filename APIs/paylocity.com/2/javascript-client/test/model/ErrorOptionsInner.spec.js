...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.ErrorOptionsInner();
  });
  ...
  describe('ErrorOptionsInner', function() {
    it('should create an instance of ErrorOptionsInner', function() {
      // uncomment below and update the code to test ErrorOptionsInner
      //var instance = new PaylocityApi.ErrorOptionsInner();
      //expect(instance).to.be.a(PaylocityApi.ErrorOptionsInner);
    });
