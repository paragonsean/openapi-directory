...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeePrimaryPayRateInner();
  });
  ...
  describe('StagedEmployeePrimaryPayRateInner', function() {
    it('should create an instance of StagedEmployeePrimaryPayRateInner', function() {
      // uncomment below and update the code to test StagedEmployeePrimaryPayRateInner
      //var instance = new PaylocityApi.StagedEmployeePrimaryPayRateInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeePrimaryPayRateInner);
    });
