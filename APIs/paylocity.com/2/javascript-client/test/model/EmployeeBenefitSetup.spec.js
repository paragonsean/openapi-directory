...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeBenefitSetup();
  });
  ...
  describe('EmployeeBenefitSetup', function() {
    it('should create an instance of EmployeeBenefitSetup', function() {
      // uncomment below and update the code to test EmployeeBenefitSetup
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be.a(PaylocityApi.EmployeeBenefitSetup);
    });

    it('should have the property benefitClass (base name: "benefitClass")', function() {
      // uncomment below and update the code to test the property benefitClass
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be();
    });

    it('should have the property benefitClassEffectiveDate (base name: "benefitClassEffectiveDate")', function() {
      // uncomment below and update the code to test the property benefitClassEffectiveDate
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be();
    });

    it('should have the property benefitSalary (base name: "benefitSalary")', function() {
      // uncomment below and update the code to test the property benefitSalary
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be();
    });

    it('should have the property benefitSalaryEffectiveDate (base name: "benefitSalaryEffectiveDate")', function() {
      // uncomment below and update the code to test the property benefitSalaryEffectiveDate
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be();
    });

    it('should have the property doNotApplyAdministrativePeriod (base name: "doNotApplyAdministrativePeriod")', function() {
      // uncomment below and update the code to test the property doNotApplyAdministrativePeriod
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be();
    });

    it('should have the property isMeasureAcaEligibility (base name: "isMeasureAcaEligibility")', function() {
      // uncomment below and update the code to test the property isMeasureAcaEligibility
      //var instance = new PaylocityApi.EmployeeBenefitSetup();
      //expect(instance).to.be();
    });
