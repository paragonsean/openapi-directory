...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeStatusInner();
  });
  ...
  describe('StagedEmployeeStatusInner', function() {
    it('should create an instance of StagedEmployeeStatusInner', function() {
      // uncomment below and update the code to test StagedEmployeeStatusInner
      //var instance = new PaylocityApi.StagedEmployeeStatusInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeStatusInner);
    });

    it('should have the property adjustedSeniorityDate (base name: "adjustedSeniorityDate")', function() {
      // uncomment below and update the code to test the property adjustedSeniorityDate
      //var instance = new PaylocityApi.StagedEmployeeStatusInner();
    ...
    it('should have the property employeeStatus (base name: "employeeStatus")', function() {
      // uncomment below and update the code to test the property employeeStatus
      //var instance = new PaylocityApi.StagedEmployeeStatusInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isEligibleForRehire (base name: "isEligibleForRehire")', function() {
      // uncomment below and update the code to test the property isEligibleForRehire
      //var instance = new PaylocityApi.StagedEmployeeStatusInner();
      //expect(instance).to.be();
    });
