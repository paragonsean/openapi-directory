...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.ClientCredentialsResponse();
  });
  ...
  describe('ClientCredentialsResponse', function() {
    it('should create an instance of ClientCredentialsResponse', function() {
      // uncomment below and update the code to test ClientCredentialsResponse
      //var instance = new PaylocityApi.ClientCredentialsResponse();
      //expect(instance).to.be.a(PaylocityApi.ClientCredentialsResponse);
    });
    ...
    it('should have the property clientSecretExpirationDate (base name: "clientSecretExpirationDate")', function() {
      // uncomment below and update the code to test the property clientSecretExpirationDate
      //var instance = new PaylocityApi.ClientCredentialsResponse();
      //expect(instance).to.be();
    });
