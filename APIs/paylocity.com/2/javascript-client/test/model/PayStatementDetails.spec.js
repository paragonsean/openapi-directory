...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.PayStatementDetails();
  });
  ...
  describe('PayStatementDetails', function() {
    it('should create an instance of PayStatementDetails', function() {
      // uncomment below and update the code to test PayStatementDetails
      //var instance = new PaylocityApi.PayStatementDetails();
      //expect(instance).to.be.a(PaylocityApi.PayStatementDetails);
    });
    ...
    it('should have the property det (base name: "det")', function() {
      // uncomment below and update the code to test the property det
      //var instance = new PaylocityApi.PayStatementDetails();
      //expect(instance).to.be();
    });

    it('should have the property detCode (base name: "detCode")', function() {
      // uncomment below and update the code to test the property detCode
      //var instance = new PaylocityApi.PayStatementDetails();
      //expect(instance).to.be();
    });

    it('should have the property detType (base name: "detType")', function() {
      // uncomment below and update the code to test the property detType
      //var instance = new PaylocityApi.PayStatementDetails();
      //expect(instance).to.be();
    });

    it('should have the property eligibleCompensation (base name: "eligibleCompensation")', function() {
      // uncomment below and update the code to test the property eligibleCompensation
      //var instance = new PaylocityApi.PayStatementDetails();
      //expect(instance).to.be();
    });
