...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeePrimaryPayRate();
  });
  ...
  describe('EmployeePrimaryPayRate', function() {
    it('should create an instance of EmployeePrimaryPayRate', function() {
      // uncomment below and update the code to test EmployeePrimaryPayRate
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be.a(PaylocityApi.EmployeePrimaryPayRate);
    });
    ...
    it('should have the property beginCheckDate (base name: "beginCheckDate")', function() {
      // uncomment below and update the code to test the property beginCheckDate
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isAutoPay (base name: "isAutoPay")', function() {
      // uncomment below and update the code to test the property isAutoPay
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property payGrade (base name: "payGrade")', function() {
      // uncomment below and update the code to test the property payGrade
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be();
    });

    it('should have the property payRateNote (base name: "payRateNote")', function() {
      // uncomment below and update the code to test the property payRateNote
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be();
    });

    it('should have the property payType (base name: "payType")', function() {
      // uncomment below and update the code to test the property payType
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be();
    });

    it('should have the property ratePer (base name: "ratePer")', function() {
      // uncomment below and update the code to test the property ratePer
      //var instance = new PaylocityApi.EmployeePrimaryPayRate();
      //expect(instance).to.be();
    });
