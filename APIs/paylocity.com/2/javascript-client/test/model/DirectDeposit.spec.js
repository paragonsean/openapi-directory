...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.DirectDeposit();
  });
  ...
  describe('DirectDeposit', function() {
    it('should create an instance of DirectDeposit', function() {
      // uncomment below and update the code to test DirectDeposit
      //var instance = new PaylocityApi.DirectDeposit();
      //expect(instance).to.be.a(PaylocityApi.DirectDeposit);
    });

    it('should have the property additionalDirectDeposit (base name: "additionalDirectDeposit")', function() {
      // uncomment below and update the code to test the property additionalDirectDeposit
      //var instance = new PaylocityApi.DirectDeposit();
      //expect(instance).to.be();
    });

    it('should have the property mainDirectDeposit (base name: "mainDirectDeposit")', function() {
      // uncomment below and update the code to test the property mainDirectDeposit
      //var instance = new PaylocityApi.DirectDeposit();
      //expect(instance).to.be();
    });
