...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeIdResponse();
  });
  ...
  describe('EmployeeIdResponse', function() {
    it('should create an instance of EmployeeIdResponse', function() {
      // uncomment below and update the code to test EmployeeIdResponse
      //var instance = new PaylocityApi.EmployeeIdResponse();
      //expect(instance).to.be.a(PaylocityApi.EmployeeIdResponse);
    });
