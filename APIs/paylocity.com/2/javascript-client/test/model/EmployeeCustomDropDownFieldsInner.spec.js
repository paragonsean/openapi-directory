...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeCustomDropDownFieldsInner();
  });
  ...
  describe('EmployeeCustomDropDownFieldsInner', function() {
    it('should create an instance of EmployeeCustomDropDownFieldsInner', function() {
      // uncomment below and update the code to test EmployeeCustomDropDownFieldsInner
      //var instance = new PaylocityApi.EmployeeCustomDropDownFieldsInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeCustomDropDownFieldsInner);
    });
