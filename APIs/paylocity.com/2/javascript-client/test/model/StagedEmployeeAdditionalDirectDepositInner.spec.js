...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeAdditionalDirectDepositInner();
  });
  ...
  describe('StagedEmployeeAdditionalDirectDepositInner', function() {
    it('should create an instance of StagedEmployeeAdditionalDirectDepositInner', function() {
      // uncomment below and update the code to test StagedEmployeeAdditionalDirectDepositInner
      //var instance = new PaylocityApi.StagedEmployeeAdditionalDirectDepositInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeAdditionalDirectDepositInner);
    });
