...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.LocalTax();
  });
  ...
  describe('LocalTax', function() {
    it('should create an instance of LocalTax', function() {
      // uncomment below and update the code to test LocalTax
      //var instance = new PaylocityApi.LocalTax();
      //expect(instance).to.be.a(PaylocityApi.LocalTax);
    });
    ...
    it('should have the property residentPSD (base name: "residentPSD")', function() {
      // uncomment below and update the code to test the property residentPSD
      //var instance = new PaylocityApi.LocalTax();
      //expect(instance).to.be();
    });
    ...
    it('should have the property workPSD (base name: "workPSD")', function() {
      // uncomment below and update the code to test the property workPSD
      //var instance = new PaylocityApi.LocalTax();
      //expect(instance).to.be();
    });
