...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeDepartmentPosition();
  });
  ...
  describe('EmployeeDepartmentPosition', function() {
    it('should create an instance of EmployeeDepartmentPosition', function() {
      // uncomment below and update the code to test EmployeeDepartmentPosition
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be.a(PaylocityApi.EmployeeDepartmentPosition);
    });

    it('should have the property changeReason (base name: "changeReason")', function() {
      // uncomment below and update the code to test the property changeReason
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property clockBadgeNumber (base name: "clockBadgeNumber")', function() {
      // uncomment below and update the code to test the property clockBadgeNumber
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property costCenter1 (base name: "costCenter1")', function() {
      // uncomment below and update the code to test the property costCenter1
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property costCenter2 (base name: "costCenter2")', function() {
      // uncomment below and update the code to test the property costCenter2
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property costCenter3 (base name: "costCenter3")', function() {
      // uncomment below and update the code to test the property costCenter3
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property equalEmploymentOpportunityClass (base name: "equalEmploymentOpportunityClass")', function() {
      // uncomment below and update the code to test the property equalEmploymentOpportunityClass
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property isMinimumWageExempt (base name: "isMinimumWageExempt")', function() {
      // uncomment below and update the code to test the property isMinimumWageExempt
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property isOvertimeExempt (base name: "isOvertimeExempt")', function() {
      // uncomment below and update the code to test the property isOvertimeExempt
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property isSupervisorReviewer (base name: "isSupervisorReviewer")', function() {
      // uncomment below and update the code to test the property isSupervisorReviewer
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property isUnionDuesCollected (base name: "isUnionDuesCollected")', function() {
      // uncomment below and update the code to test the property isUnionDuesCollected
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property isUnionInitiationCollected (base name: "isUnionInitiationCollected")', function() {
      // uncomment below and update the code to test the property isUnionInitiationCollected
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property payGroup (base name: "payGroup")', function() {
      // uncomment below and update the code to test the property payGroup
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property positionCode (base name: "positionCode")', function() {
      // uncomment below and update the code to test the property positionCode
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property reviewerCompanyNumber (base name: "reviewerCompanyNumber")', function() {
      // uncomment below and update the code to test the property reviewerCompanyNumber
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property reviewerEmployeeId (base name: "reviewerEmployeeId")', function() {
      // uncomment below and update the code to test the property reviewerEmployeeId
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });
    ...
    it('should have the property supervisorCompanyNumber (base name: "supervisorCompanyNumber")', function() {
      // uncomment below and update the code to test the property supervisorCompanyNumber
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property supervisorEmployeeId (base name: "supervisorEmployeeId")', function() {
      // uncomment below and update the code to test the property supervisorEmployeeId
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property tipped (base name: "tipped")', function() {
      // uncomment below and update the code to test the property tipped
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property unionAffiliationDate (base name: "unionAffiliationDate")', function() {
      // uncomment below and update the code to test the property unionAffiliationDate
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property unionCode (base name: "unionCode")', function() {
      // uncomment below and update the code to test the property unionCode
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property unionPosition (base name: "unionPosition")', function() {
      // uncomment below and update the code to test the property unionPosition
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });

    it('should have the property workersCompensation (base name: "workersCompensation")', function() {
      // uncomment below and update the code to test the property workersCompensation
      //var instance = new PaylocityApi.EmployeeDepartmentPosition();
      //expect(instance).to.be();
    });
