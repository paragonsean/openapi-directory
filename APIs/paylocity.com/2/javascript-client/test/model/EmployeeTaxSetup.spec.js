...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.PaylocityApi);
  }
}(this, function(expect, PaylocityApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new PaylocityApi.EmployeeTaxSetup();
  });
  ...
  describe('EmployeeTaxSetup', function() {
    it('should create an instance of EmployeeTaxSetup', function() {
      // uncomment below and update the code to test EmployeeTaxSetup
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be.a(PaylocityApi.EmployeeTaxSetup);
    });

    it('should have the property fitwExemptNotes (base name: "fitwExemptNotes")', function() {
      // uncomment below and update the code to test the property fitwExemptNotes
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property fitwExemptReason (base name: "fitwExemptReason")', function() {
      // uncomment below and update the code to test the property fitwExemptReason
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property futaExemptNotes (base name: "futaExemptNotes")', function() {
      // uncomment below and update the code to test the property futaExemptNotes
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property futaExemptReason (base name: "futaExemptReason")', function() {
      // uncomment below and update the code to test the property futaExemptReason
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property isEmployee943 (base name: "isEmployee943")', function() {
      // uncomment below and update the code to test the property isEmployee943
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property isPension (base name: "isPension")', function() {
      // uncomment below and update the code to test the property isPension
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property isStatutory (base name: "isStatutory")', function() {
      // uncomment below and update the code to test the property isStatutory
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property medExemptNotes (base name: "medExemptNotes")', function() {
      // uncomment below and update the code to test the property medExemptNotes
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property medExemptReason (base name: "medExemptReason")', function() {
      // uncomment below and update the code to test the property medExemptReason
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property sitwExemptNotes (base name: "sitwExemptNotes")', function() {
      // uncomment below and update the code to test the property sitwExemptNotes
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property sitwExemptReason (base name: "sitwExemptReason")', function() {
      // uncomment below and update the code to test the property sitwExemptReason
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property ssExemptNotes (base name: "ssExemptNotes")', function() {
      // uncomment below and update the code to test the property ssExemptNotes
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property ssExemptReason (base name: "ssExemptReason")', function() {
      // uncomment below and update the code to test the property ssExemptReason
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property suiExemptNotes (base name: "suiExemptNotes")', function() {
      // uncomment below and update the code to test the property suiExemptNotes
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property suiExemptReason (base name: "suiExemptReason")', function() {
      // uncomment below and update the code to test the property suiExemptReason
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property suiState (base name: "suiState")', function() {
      // uncomment below and update the code to test the property suiState
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property taxDistributionCode1099R (base name: "taxDistributionCode1099R")', function() {
      // uncomment below and update the code to test the property taxDistributionCode1099R
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });

    it('should have the property taxForm (base name: "taxForm")', function() {
      // uncomment below and update the code to test the property taxForm
      //var instance = new PaylocityApi.EmployeeTaxSetup();
      //expect(instance).to.be();
    });
