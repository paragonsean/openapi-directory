...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.TrackingNumberResponse();
  });
  ...
  describe('TrackingNumberResponse', function() {
    it('should create an instance of TrackingNumberResponse', function() {
      // uncomment below and update the code to test TrackingNumberResponse
      //var instance = new PaylocityApi.TrackingNumberResponse();
      //expect(instance).to.be.a(PaylocityApi.TrackingNumberResponse);
    });
