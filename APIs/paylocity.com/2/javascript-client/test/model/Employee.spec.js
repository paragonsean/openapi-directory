...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.Employee();
  });
  ...
  describe('Employee', function() {
    it('should create an instance of Employee', function() {
      ...
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be.a(PaylocityApi.Employee);
    });
    ...
    it('should have the property additionalRate (base name: "additionalRate")', function() {
      // uncomment below and update the code to test the property additionalRate
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property benefitSetup (base name: "benefitSetup")', function() {
      // uncomment below and update the code to test the property benefitSetup
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property coEmpCode (base name: "coEmpCode")', function() {
      // uncomment below and update the code to test the property coEmpCode
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property companyFEIN (base name: "companyFEIN")', function() {
      // uncomment below and update the code to test the property companyFEIN
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property customBooleanFields (base name: "customBooleanFields")', function() {
      // uncomment below and update the code to test the property customBooleanFields
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property customDateFields (base name: "customDateFields")', function() {
      // uncomment below and update the code to test the property customDateFields
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property customDropDownFields (base name: "customDropDownFields")', function() {
      // uncomment below and update the code to test the property customDropDownFields
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property customNumberFields (base name: "customNumberFields")', function() {
      // uncomment below and update the code to test the property customNumberFields
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property customTextFields (base name: "customTextFields")', function() {
      // uncomment below and update the code to test the property customTextFields
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property departmentPosition (base name: "departmentPosition")', function() {
      // uncomment below and update the code to test the property departmentPosition
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property disabilityDescription (base name: "disabilityDescription")', function() {
      // uncomment below and update the code to test the property disabilityDescription
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property emergencyContacts (base name: "emergencyContacts")', function() {
      // uncomment below and update the code to test the property emergencyContacts
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isHighlyCompensated (base name: "isHighlyCompensated")', function() {
      // uncomment below and update the code to test the property isHighlyCompensated
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property isSmoker (base name: "isSmoker")', function() {
      // uncomment below and update the code to test the property isSmoker
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property nonPrimaryStateTax (base name: "nonPrimaryStateTax")', function() {
      // uncomment below and update the code to test the property nonPrimaryStateTax
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property ownerPercent (base name: "ownerPercent")', function() {
      // uncomment below and update the code to test the property ownerPercent
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property primaryPayRate (base name: "primaryPayRate")', function() {
      // uncomment below and update the code to test the property primaryPayRate
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property primaryStateTax (base name: "primaryStateTax")', function() {
      // uncomment below and update the code to test the property primaryStateTax
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property priorLastName (base name: "priorLastName")', function() {
      // uncomment below and update the code to test the property priorLastName
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
    ...
    it('should have the property taxSetup (base name: "taxSetup")', function() {
      // uncomment below and update the code to test the property taxSetup
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property veteranDescription (base name: "veteranDescription")', function() {
      // uncomment below and update the code to test the property veteranDescription
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property webTime (base name: "webTime")', function() {
      // uncomment below and update the code to test the property webTime
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property workAddress (base name: "workAddress")', function() {
      // uncomment below and update the code to test the property workAddress
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });

    it('should have the property workEligibility (base name: "workEligibility")', function() {
      // uncomment below and update the code to test the property workEligibility
      //var instance = new PaylocityApi.Employee();
      //expect(instance).to.be();
    });
