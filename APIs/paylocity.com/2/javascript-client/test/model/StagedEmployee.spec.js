...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployee();
  });
  ...
  describe('StagedEmployee', function() {
    it('should create an instance of StagedEmployee', function() {
      // uncomment below and update the code to test StagedEmployee
      //var instance = new PaylocityApi.StagedEmployee();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployee);
    });
