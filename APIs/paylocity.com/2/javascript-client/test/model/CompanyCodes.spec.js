...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.CompanyCodes();
  });
  ...
  describe('CompanyCodes', function() {
    it('should create an instance of CompanyCodes', function() {
      // uncomment below and update the code to test CompanyCodes
      //var instance = new PaylocityApi.CompanyCodes();
      //expect(instance).to.be.a(PaylocityApi.CompanyCodes);
    });
