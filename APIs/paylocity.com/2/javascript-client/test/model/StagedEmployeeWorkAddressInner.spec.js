...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeWorkAddressInner();
  });
  ...
  describe('StagedEmployeeWorkAddressInner', function() {
    it('should create an instance of StagedEmployeeWorkAddressInner', function() {
      // uncomment below and update the code to test StagedEmployeeWorkAddressInner
      //var instance = new PaylocityApi.StagedEmployeeWorkAddressInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeWorkAddressInner);
    });
