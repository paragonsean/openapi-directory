...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeCustomBooleanFieldsInner();
  });
  ...
  describe('EmployeeCustomBooleanFieldsInner', function() {
    it('should create an instance of EmployeeCustomBooleanFieldsInner', function() {
      // uncomment below and update the code to test EmployeeCustomBooleanFieldsInner
      //var instance = new PaylocityApi.EmployeeCustomBooleanFieldsInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeCustomBooleanFieldsInner);
    });
