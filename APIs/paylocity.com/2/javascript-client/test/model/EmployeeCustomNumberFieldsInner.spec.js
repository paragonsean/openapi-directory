...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeCustomNumberFieldsInner();
  });
  ...
  describe('EmployeeCustomNumberFieldsInner', function() {
    it('should create an instance of EmployeeCustomNumberFieldsInner', function() {
      // uncomment below and update the code to test EmployeeCustomNumberFieldsInner
      //var instance = new PaylocityApi.EmployeeCustomNumberFieldsInner();
      //expect(instance).to.be.a(PaylocityApi.EmployeeCustomNumberFieldsInner);
    });
