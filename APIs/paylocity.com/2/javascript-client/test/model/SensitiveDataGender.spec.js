...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataGender();
  });
  ...
  describe('SensitiveDataGender', function() {
    it('should create an instance of SensitiveDataGender', function() {
      // uncomment below and update the code to test SensitiveDataGender
      //var instance = new PaylocityApi.SensitiveDataGender();
      //expect(instance).to.be.a(PaylocityApi.SensitiveDataGender);
    });

    it('should have the property displayPronouns (base name: "displayPronouns")', function() {
      // uncomment below and update the code to test the property displayPronouns
      //var instance = new PaylocityApi.SensitiveDataGender();
      //expect(instance).to.be();
    });

    it('should have the property genderIdentityDescription (base name: "genderIdentityDescription")', function() {
      // uncomment below and update the code to test the property genderIdentityDescription
      //var instance = new PaylocityApi.SensitiveDataGender();
      //expect(instance).to.be();
    });

    it('should have the property identifyAsLegalGender (base name: "identifyAsLegalGender")', function() {
      // uncomment below and update the code to test the property identifyAsLegalGender
      //var instance = new PaylocityApi.SensitiveDataGender();
      //expect(instance).to.be();
    });

    it('should have the property legalGender (base name: "legalGender")', function() {
      // uncomment below and update the code to test the property legalGender
      //var instance = new PaylocityApi.SensitiveDataGender();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sexualOrientation (base name: "sexualOrientation")', function() {
      // uncomment below and update the code to test the property sexualOrientation
      //var instance = new PaylocityApi.SensitiveDataGender();
      //expect(instance).to.be();
    });
