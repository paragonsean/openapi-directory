...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.AdditionalRate();
  });
  ...
  describe('AdditionalRate', function() {
    it('should create an instance of AdditionalRate', function() {
      // uncomment below and update the code to test AdditionalRate
      //var instance = new PaylocityApi.AdditionalRate();
      //expect(instance).to.be.a(PaylocityApi.AdditionalRate);
    });
