...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeWorkEligibilityInner();
  });
  ...
  describe('StagedEmployeeWorkEligibilityInner', function() {
    it('should create an instance of StagedEmployeeWorkEligibilityInner', function() {
      // uncomment below and update the code to test StagedEmployeeWorkEligibilityInner
      //var instance = new PaylocityApi.StagedEmployeeWorkEligibilityInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeWorkEligibilityInner);
    });
