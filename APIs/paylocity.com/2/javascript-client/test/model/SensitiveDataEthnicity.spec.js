...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.SensitiveDataEthnicity();
  });
  ...
  describe('SensitiveDataEthnicity', function() {
    it('should create an instance of SensitiveDataEthnicity', function() {
      // uncomment below and update the code to test SensitiveDataEthnicity
      //var instance = new PaylocityApi.SensitiveDataEthnicity();
      //expect(instance).to.be.a(PaylocityApi.SensitiveDataEthnicity);
    });

    it('should have the property ethnicRacialIdentities (base name: "ethnicRacialIdentities")', function() {
      // uncomment below and update the code to test the property ethnicRacialIdentities
      //var instance = new PaylocityApi.SensitiveDataEthnicity();
