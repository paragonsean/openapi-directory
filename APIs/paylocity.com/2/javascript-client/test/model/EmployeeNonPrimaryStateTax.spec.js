...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeNonPrimaryStateTax();
  });
  ...
  describe('EmployeeNonPrimaryStateTax', function() {
    it('should create an instance of EmployeeNonPrimaryStateTax', function() {
      // uncomment below and update the code to test EmployeeNonPrimaryStateTax
      //var instance = new PaylocityApi.EmployeeNonPrimaryStateTax();
      //expect(instance).to.be.a(PaylocityApi.EmployeeNonPrimaryStateTax);
    });
