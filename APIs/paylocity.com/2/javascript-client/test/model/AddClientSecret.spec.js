...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.AddClientSecret();
  });
  ...
  describe('AddClientSecret', function() {
    it('should create an instance of AddClientSecret', function() {
      // uncomment below and update the code to test AddClientSecret
      //var instance = new PaylocityApi.AddClientSecret();
      //expect(instance).to.be.a(PaylocityApi.AddClientSecret);
    });
