...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.StagedEmployeeFederalTaxInner();
  });
  ...
  describe('StagedEmployeeFederalTaxInner', function() {
    it('should create an instance of StagedEmployeeFederalTaxInner', function() {
      // uncomment below and update the code to test StagedEmployeeFederalTaxInner
      //var instance = new PaylocityApi.StagedEmployeeFederalTaxInner();
      //expect(instance).to.be.a(PaylocityApi.StagedEmployeeFederalTaxInner);
    });
