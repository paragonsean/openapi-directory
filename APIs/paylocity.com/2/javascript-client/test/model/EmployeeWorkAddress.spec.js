...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeWorkAddress();
  });
  ...
  describe('EmployeeWorkAddress', function() {
    it('should create an instance of EmployeeWorkAddress', function() {
      // uncomment below and update the code to test EmployeeWorkAddress
      //var instance = new PaylocityApi.EmployeeWorkAddress();
      //expect(instance).to.be.a(PaylocityApi.EmployeeWorkAddress);
    });
    ...
    it('should have the property mailStop (base name: "mailStop")', function() {
      // uncomment below and update the code to test the property mailStop
      //var instance = new PaylocityApi.EmployeeWorkAddress();
      //expect(instance).to.be();
    });
