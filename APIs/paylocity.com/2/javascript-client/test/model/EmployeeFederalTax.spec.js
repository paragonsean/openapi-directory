...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeFederalTax();
  });
  ...
  describe('EmployeeFederalTax', function() {
    it('should create an instance of EmployeeFederalTax', function() {
      // uncomment below and update the code to test EmployeeFederalTax
      //var instance = new PaylocityApi.EmployeeFederalTax();
      //expect(instance).to.be.a(PaylocityApi.EmployeeFederalTax);
    });
