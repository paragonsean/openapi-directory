...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeWebTime();
  });
  ...
  describe('EmployeeWebTime', function() {
    it('should create an instance of EmployeeWebTime', function() {
      // uncomment below and update the code to test EmployeeWebTime
      //var instance = new PaylocityApi.EmployeeWebTime();
      //expect(instance).to.be.a(PaylocityApi.EmployeeWebTime);
    });
