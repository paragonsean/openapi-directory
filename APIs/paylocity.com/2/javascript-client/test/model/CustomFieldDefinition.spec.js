...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.CustomFieldDefinition();
  });
  ...
  describe('CustomFieldDefinition', function() {
    it('should create an instance of CustomFieldDefinition', function() {
      // uncomment below and update the code to test CustomFieldDefinition
      //var instance = new PaylocityApi.CustomFieldDefinition();
      //expect(instance).to.be.a(PaylocityApi.CustomFieldDefinition);
    });
