...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PaylocityApi.EmployeeMainDirectDeposit();
  });
  ...
  describe('EmployeeMainDirectDeposit', function() {
    it('should create an instance of EmployeeMainDirectDeposit', function() {
      // uncomment below and update the code to test EmployeeMainDirectDeposit
      //var instance = new PaylocityApi.EmployeeMainDirectDeposit();
      //expect(instance).to.be.a(PaylocityApi.EmployeeMainDirectDeposit);
    });
