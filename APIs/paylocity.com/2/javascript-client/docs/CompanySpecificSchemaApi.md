# PaylocityApi.CompanySpecificSchemaApi
...
let apiInstance = new PaylocityApi.CompanySpecificSchemaApi();
let authorization = "authorization_example"; // String | Bearer + JWT
let companyId = "companyId_example"; // String | Company Id
apiInstance.getCompanySpecificOpenAPIDocumentation(authorization, companyId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
