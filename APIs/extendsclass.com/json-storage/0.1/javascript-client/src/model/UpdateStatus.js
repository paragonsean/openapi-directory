...
class UpdateStatus {
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateStatus</code>.
     */
 ...
 * @member {Object} data
 */
UpdateStatus.prototype['data'] = undefined;

/**
 * @member {Number} status
 */
UpdateStatus.prototype['status'] = undefined;
