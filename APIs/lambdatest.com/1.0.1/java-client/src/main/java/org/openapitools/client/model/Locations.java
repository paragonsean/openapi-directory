...
public class Locations {
  ...
  private List<LocationsLocationsInner> locations = new ArrayList<>();

  public Locations() {
  }

  public Locations locations(List<LocationsLocationsInner> locations) {
    this.locations = locations;
    return this;
  }

  public Locations addLocationsItem(LocationsLocationsInner locationsItem) {
  ...
  public List<LocationsLocationsInner> getLocations() {
    return locations;
  }

  public void setLocations(List<LocationsLocationsInner> locations) {
    this.locations = locations;
  }
      ...
      if (jsonObj.get("locations") != null && !jsonObj.get("locations").isJsonNull()) {
        ...
        if (jsonArraylocations != null) {
          ...
          for (int i = 0; i < jsonArraylocations.size(); i++) {
            LocationsLocationsInner.validateJsonElement(jsonArraylocations.get(i));
          };
        }
      }
  }
