...
/**
 * The ShopperUpdate model module.
 * @module model/ShopperUpdate
 * @version 1.0.0
 */
class ShopperUpdate {
    /**
     * Constructs a new <code>ShopperUpdate</code>.
     * @alias module:model/ShopperUpdate
     */
    constructor() { 
        
        ShopperUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShopperUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShopperUpdate} obj Optional instance to populate.
     * @return {module:model/ShopperUpdate} The populated <code>ShopperUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShopperUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>ShopperUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShopperUpdate</code>.
     */
 ...
 * @member {String} email
 */
ShopperUpdate.prototype['email'] = undefined;

/**
 * @member {Number} externalId
 */
ShopperUpdate.prototype['externalId'] = undefined;

/**
 * @member {module:model/ShopperUpdate.MarketIdEnum} marketId
 */
ShopperUpdate.prototype['marketId'] = undefined;

/**
 * @member {String} nameFirst
 */
ShopperUpdate.prototype['nameFirst'] = undefined;

/**
 * @member {String} nameLast
 */
ShopperUpdate.prototype['nameLast'] = undefined;
