...
export {
    ...
    /**
     * The PasswordError model constructor.
     * @property {module:model/PasswordError}
     */
    PasswordError,
    ...
    /**
     * The Shopper model constructor.
     * @property {module:model/Shopper}
     */
    Shopper,

    /**
     * The ShopperId model constructor.
     * @property {module:model/ShopperId}
     */
    ShopperId,

    /**
     * The ShopperStatus model constructor.
     * @property {module:model/ShopperStatus}
     */
    ShopperStatus,

    /**
     * The ShopperUpdate model constructor.
     * @property {module:model/ShopperUpdate}
     */
    ShopperUpdate,

    /**
     * The SubaccountCreate model constructor.
     * @property {module:model/SubaccountCreate}
     */
    SubaccountCreate,
