...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.ShopperId();
  });
  ...
  describe('ShopperId', function() {
    it('should create an instance of ShopperId', function() {
      // uncomment below and update the code to test ShopperId
      //var instance = new OpenapiJsClient.ShopperId();
      //expect(instance).to.be.a(OpenapiJsClient.ShopperId);
    });
