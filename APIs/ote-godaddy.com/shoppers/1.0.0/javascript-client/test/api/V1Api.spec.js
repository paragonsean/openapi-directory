...
(function(root, factory) {
  ...
  describe('V1Api', function() {
    ...
    describe('createSubaccount', function() {
      it('should call createSubaccount successfully', function(done) {
        //uncomment below and update the code to test createSubaccount
        //instance.createSubaccount(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
