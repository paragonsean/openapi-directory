...
var keys = ["null"]; // {[String]} Keys for Agreements whose details are to be retrieved
var opts = {
...
------------ | ------------- | ------------- | -------------
*OpenapiJsClient.V1Api* | [**get**](docs/V1Api.md#get) | **GET** /v1/agreements | Retrieve Legal Agreements for provided agreements keys
...
## Documentation for Models
 ...
 - [OpenapiJsClient.LegalAgreement](docs/LegalAgreement.md)
