...
void OAIV1Api::get(const QList<QString> &keys, const ::OpenAPI::OptionalParam<qint32> &x_private_label_id, const ::OpenAPI::OptionalParam<QString> &x_market_id) {
    QString fullPath = QString(_serverConfigs["get"][_serverIndices.value("get")].URL()+"/v1/agreements");
    ...
    if (x_private_label_id.hasValue())
    {
        if (!::OpenAPI::toStringValue(x_private_label_id.value()).isEmpty()) {
            input.headers.insert("X-Private-Label-Id", ::OpenAPI::toStringValue(x_private_label_id.value()));
        }
        }
...
void OAIV1Api::getCallback(OAIHttpRequestWorker *worker) {
    ...
    QList<OAILegalAgreement> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAILegalAgreement val;
