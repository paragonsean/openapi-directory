...
class ErrorLimit(Model):
    ...
    def __init__(self, code: str=None, fields: List[ErrorField]=None, message: str=None, retry_after_sec: int=None, stack: List[str]=None):
        ...
        :param stack: The stack of this ErrorLimit.
        """
        self.openapi_types = {
            'code': str,
    ...
    @property
    def stack(self):
        """Gets the stack of this ErrorLimit.
        ...
        :return: The stack of this ErrorLimit.
        :rtype: List[str]
        """
        return self._stack
    ...
    def stack(self, stack):
        """Sets the stack of this ErrorLimit.
