...
QList<QString> OAIErrorLimit::getStack() const {
    return m_stack;
}
void OAIErrorLimit::setStack(const QList<QString> &stack) {
    m_stack = stack;
    m_stack_isSet = true;
}

bool OAIErrorLimit::is_stack_Set() const{
    return m_stack_isSet;
}

bool OAIErrorLimit::is_stack_Valid() const{
