...
public class State {
  ...
  public static final String SERIALIZED_NAME_STATE_KEY = "stateKey";
  ...
  public State stateKey(String stateKey) {
  ...
  public boolean equals(Object o) {
    ...
    State state = (State) o;
    return Objects.equals(this.label, state.label) &&
        Objects.equals(this.stateKey, state.stateKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, stateKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("stateKey") != null && !jsonObj.get("stateKey").isJsonNull()) && !jsonObj.get("stateKey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `stateKey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("stateKey").toString()));
      }
  }
