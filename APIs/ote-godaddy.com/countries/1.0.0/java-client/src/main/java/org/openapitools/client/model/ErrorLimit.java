...
public class ErrorLimit {
  ...
  public ErrorLimit stack(List<String> stack) {
    this.stack = stack;
    return this;
  }

  public ErrorLimit addStackItem(String stackItem) {
    if (this.stack == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, errorLimit.code) &&
        ...
        Objects.equals(this.stack, errorLimit.stack);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, fields, message, retryAfterSec, stack);
  }
