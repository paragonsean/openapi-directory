...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.AbuseTicketId();
  });
  ...
  describe('AbuseTicketId', function() {
    it('should create an instance of AbuseTicketId', function() {
      // uncomment below and update the code to test AbuseTicketId
      //var instance = new OpenapiJsClient.AbuseTicketId();
      //expect(instance).to.be.a(OpenapiJsClient.AbuseTicketId);
    });

    it('should have the property uNumber (base name: "u_number")', function() {
      // uncomment below and update the code to test the property uNumber
      //var instance = new OpenapiJsClient.AbuseTicketId();
