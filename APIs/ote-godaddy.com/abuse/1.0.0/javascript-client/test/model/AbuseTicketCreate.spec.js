...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.AbuseTicketCreate();
  });
  ...
  describe('AbuseTicketCreate', function() {
    it('should create an instance of AbuseTicketCreate', function() {
      // uncomment below and update the code to test AbuseTicketCreate
      //var instance = new OpenapiJsClient.AbuseTicketCreate();
      //expect(instance).to.be.a(OpenapiJsClient.AbuseTicketCreate);
    });
    ...
    it('should have the property intentional (base name: "intentional")', function() {
      // uncomment below and update the code to test the property intentional
      //var instance = new OpenapiJsClient.AbuseTicketCreate();
      //expect(instance).to.be();
    });
