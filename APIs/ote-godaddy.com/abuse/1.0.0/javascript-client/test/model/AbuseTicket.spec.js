...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.AbuseTicket();
  });
  ...
  describe('AbuseTicket', function() {
    it('should create an instance of AbuseTicket', function() {
      // uncomment below and update the code to test AbuseTicket
      //var instance = new OpenapiJsClient.AbuseTicket();
      //expect(instance).to.be.a(OpenapiJsClient.AbuseTicket);
    });
    ...
    it('should have the property domainIp (base name: "domainIp")', function() {
      // uncomment below and update the code to test the property domainIp
      //var instance = new OpenapiJsClient.AbuseTicket();
      //expect(instance).to.be();
    });
