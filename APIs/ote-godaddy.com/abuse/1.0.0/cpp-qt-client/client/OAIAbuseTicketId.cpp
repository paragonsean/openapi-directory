...
OAIAbuseTicketId::OAIAbuseTicketId(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAbuseTicketId::OAIAbuseTicketId() {
    this->initializeModel();
}

OAIAbuseTicketId::~OAIAbuseTicketId() {}

void OAIAbuseTicketId::initializeModel() {

    m_u_number_isSet = false;
    m_u_number_isValid = false;
}

void OAIAbuseTicketId::fromJson(QString jsonString) {
...
void OAIAbuseTicketId::fromJsonObject(QJsonObject json) {

    m_u_number_isValid = ::OpenAPI::fromJsonValue(m_u_number, json[QString("u_number")]);
    m_u_number_isSet = !json[QString("u_number")].isNull() && m_u_number_isValid;
}

QString OAIAbuseTicketId::asJson() const {
...
QJsonObject OAIAbuseTicketId::asJsonObject() const {
    QJsonObject obj;
    if (m_u_number_isSet) {
        obj.insert(QString("u_number"), ::OpenAPI::toJsonValue(m_u_number));
    }
    return obj;
}

QString OAIAbuseTicketId::getUNumber() const {
    return m_u_number;
}
void OAIAbuseTicketId::setUNumber(const QString &u_number) {
    m_u_number = u_number;
    m_u_number_isSet = true;
}

bool OAIAbuseTicketId::is_u_number_Set() const{
    return m_u_number_isSet;
}

bool OAIAbuseTicketId::is_u_number_Valid() const{
    return m_u_number_isValid;
}

bool OAIAbuseTicketId::isSet() const {
...
bool OAIAbuseTicketId::isValid() const {
