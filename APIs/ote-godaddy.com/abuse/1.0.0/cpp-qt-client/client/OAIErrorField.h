...
public:
    ...
    QString getPathRelated() const;
    void setPathRelated(const QString &path_related);
    bool is_path_related_Set() const;
    bool is_path_related_Valid() const;
...
private:
    ...
    QString m_path_related;
    bool m_path_related_isSet;
    bool m_path_related_isValid;
};
