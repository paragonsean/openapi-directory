...
OAIAbuseTicketList::OAIAbuseTicketList(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAbuseTicketList::OAIAbuseTicketList() {
    this->initializeModel();
}

OAIAbuseTicketList::~OAIAbuseTicketList() {}

void OAIAbuseTicketList::initializeModel() {
...
void OAIAbuseTicketList::fromJson(QString jsonString) {
...
void OAIAbuseTicketList::fromJsonObject(QJsonObject json) {
...
QString OAIAbuseTicketList::asJson() const {
...
QJsonObject OAIAbuseTicketList::asJsonObject() const {
    QJsonObject obj;
    if (m_pagination.isSet()) {
        obj.insert(QString("pagination"), ::OpenAPI::toJsonValue(m_pagination));
    }
    if (m_ticket_ids.size() > 0) {
        obj.insert(QString("ticketIds"), ::OpenAPI::toJsonValue(m_ticket_ids));
    }
    return obj;
}

OAIPagination OAIAbuseTicketList::getPagination() const {
    return m_pagination;
}
void OAIAbuseTicketList::setPagination(const OAIPagination &pagination) {
    m_pagination = pagination;
    m_pagination_isSet = true;
}

bool OAIAbuseTicketList::is_pagination_Set() const{
    return m_pagination_isSet;
}

bool OAIAbuseTicketList::is_pagination_Valid() const{
    return m_pagination_isValid;
}

QList<QString> OAIAbuseTicketList::getTicketIds() const {
    return m_ticket_ids;
}
void OAIAbuseTicketList::setTicketIds(const QList<QString> &ticket_ids) {
    m_ticket_ids = ticket_ids;
    m_ticket_ids_isSet = true;
}

bool OAIAbuseTicketList::is_ticket_ids_Set() const{
    return m_ticket_ids_isSet;
}

bool OAIAbuseTicketList::is_ticket_ids_Valid() const{
    return m_ticket_ids_isValid;
}

bool OAIAbuseTicketList::isSet() const {
...
bool OAIAbuseTicketList::isValid() const {
