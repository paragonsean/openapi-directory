...
#ifndef OAIAbuseTicketId_H
#define OAIAbuseTicketId_H
...
class OAIAbuseTicketId : public OAIObject {
public:
    OAIAbuseTicketId();
    OAIAbuseTicketId(QString json);
    ~OAIAbuseTicketId() override;
    ...
    QString getUNumber() const;
    void setUNumber(const QString &u_number);
    bool is_u_number_Set() const;
    bool is_u_number_Valid() const;
...
private:
    ...
    QString m_u_number;
    bool m_u_number_isSet;
    bool m_u_number_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAbuseTicketId)

#endif // OAIAbuseTicketId_H
