...
/*
 * OAIAbuseTicketList.h
 *
 * 
 */

#ifndef OAIAbuseTicketList_H
#define OAIAbuseTicketList_H
...
class OAIAbuseTicketList : public OAIObject {
public:
    OAIAbuseTicketList();
    OAIAbuseTicketList(QString json);
    ~OAIAbuseTicketList() override;
    ...
    QList<QString> getTicketIds() const;
    void setTicketIds(const QList<QString> &ticket_ids);
    bool is_ticket_ids_Set() const;
    bool is_ticket_ids_Valid() const;
...
private:
    ...
    QList<QString> m_ticket_ids;
    bool m_ticket_ids_isSet;
    bool m_ticket_ids_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIAbuseTicketList)

#endif // OAIAbuseTicketList_H
