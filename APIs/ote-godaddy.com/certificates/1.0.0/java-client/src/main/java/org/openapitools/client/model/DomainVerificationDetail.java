...
public class DomainVerificationDetail {
  ...
  public static final String SERIALIZED_NAME_CERTIFICATE_AUTHORITY_AUTHORIZATION = "certificateAuthorityAuthorization";
  @SerializedName(SERIALIZED_NAME_CERTIFICATE_AUTHORITY_AUTHORIZATION)
  private DomainVerificationDetailAllOfCertificateAuthorityAuthorization certificateAuthorityAuthorization;

  public DomainVerificationDetail() {
  }

  public DomainVerificationDetail createdAt(String createdAt) {
  ...
  public DomainVerificationDetail dceToken(String dceToken) {
  ...
  public DomainVerificationDetail domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public DomainVerificationDetail domainEntityId(Integer domainEntityId) {
  ...
  public DomainVerificationDetail modifiedAt(String modifiedAt) {
  ...
  public DomainVerificationDetail status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DomainVerificationDetail type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public DomainVerificationDetail usage(UsageEnum usage) {
    this.usage = usage;
    return this;
  }
  ...
  public DomainVerificationDetail certificateAuthorityAuthorization(DomainVerificationDetailAllOfCertificateAuthorityAuthorization certificateAuthorityAuthorization) {
    this.certificateAuthorityAuthorization = certificateAuthorityAuthorization;
    return this;
  }

  /**
   * Get certificateAuthorityAuthorization
   * @return certificateAuthorityAuthorization
   */
  @javax.annotation.Nullable
  public DomainVerificationDetailAllOfCertificateAuthorityAuthorization getCertificateAuthorityAuthorization() {
    return certificateAuthorityAuthorization;
  }

  public void setCertificateAuthorityAuthorization(DomainVerificationDetailAllOfCertificateAuthorityAuthorization certificateAuthorityAuthorization) {
    this.certificateAuthorityAuthorization = certificateAuthorityAuthorization;
  }
  ...
  public boolean equals(Object o) {
    ...
    DomainVerificationDetail domainVerificationDetail = (DomainVerificationDetail) o;
    return Objects.equals(this.createdAt, domainVerificationDetail.createdAt) &&
        Objects.equals(this.dceToken, domainVerificationDetail.dceToken) &&
        Objects.equals(this.domain, domainVerificationDetail.domain) &&
        Objects.equals(this.domainEntityId, domainVerificationDetail.domainEntityId) &&
        Objects.equals(this.modifiedAt, domainVerificationDetail.modifiedAt) &&
        Objects.equals(this.status, domainVerificationDetail.status) &&
        Objects.equals(this.type, domainVerificationDetail.type) &&
        Objects.equals(this.usage, domainVerificationDetail.usage) &&
        Objects.equals(this.certificateAuthorityAuthorization, domainVerificationDetail.certificateAuthorityAuthorization);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, dceToken, domain, domainEntityId, modifiedAt, status, type, usage, certificateAuthorityAuthorization);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DomainVerificationDetail {\n");
    ...
    sb.append("    certificateAuthorityAuthorization: ").append(toIndentedString(certificateAuthorityAuthorization)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("certificateAuthorityAuthorization");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainVerificationDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainVerificationDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainVerificationDetail is not found in the empty JSON string", DomainVerificationDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainVerificationDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainVerificationDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainVerificationDetail.openapiRequiredFields) {
      ...
      // validate the optional field `certificateAuthorityAuthorization`
      if (jsonObj.get("certificateAuthorityAuthorization") != null && !jsonObj.get("certificateAuthorityAuthorization").isJsonNull()) {
        DomainVerificationDetailAllOfCertificateAuthorityAuthorization.validateJsonElement(jsonObj.get("certificateAuthorityAuthorization"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainVerificationDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainVerificationDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainVerificationDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainVerificationDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainVerificationDetail>() {
           @Override
           public void write(JsonWriter out, DomainVerificationDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainVerificationDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainVerificationDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainVerificationDetail
   * @throws IOException if the JSON string is invalid with respect to DomainVerificationDetail
   */
  public static DomainVerificationDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainVerificationDetail.class);
  }

  /**
   * Convert an instance of DomainVerificationDetail to an JSON string
   *
   * @return JSON string
   */
