...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.CertificateCreate();
  });
  ...
  describe('CertificateCreate', function() {
    it('should create an instance of CertificateCreate', function() {
      // uncomment below and update the code to test CertificateCreate
      //var instance = new OpenapiJsClient.CertificateCreate();
      //expect(instance).to.be.a(OpenapiJsClient.CertificateCreate);
    });
    ...
    it('should have the property intelVPro (base name: "intelVPro")', function() {
      // uncomment below and update the code to test the property intelVPro
      //var instance = new OpenapiJsClient.CertificateCreate();
      //expect(instance).to.be();
    });
