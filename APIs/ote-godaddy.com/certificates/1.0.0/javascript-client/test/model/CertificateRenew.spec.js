...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.CertificateRenew();
  });
  ...
  describe('CertificateRenew', function() {
    it('should create an instance of CertificateRenew', function() {
      // uncomment below and update the code to test CertificateRenew
      //var instance = new OpenapiJsClient.CertificateRenew();
      //expect(instance).to.be.a(OpenapiJsClient.CertificateRenew);
    });
