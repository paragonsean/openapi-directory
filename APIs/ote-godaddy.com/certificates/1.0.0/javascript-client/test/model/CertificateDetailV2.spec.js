...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.CertificateDetailV2();
  });
  ...
  describe('CertificateDetailV2', function() {
    it('should create an instance of CertificateDetailV2', function() {
      // uncomment below and update the code to test CertificateDetailV2
      //var instance = new OpenapiJsClient.CertificateDetailV2();
      //expect(instance).to.be.a(OpenapiJsClient.CertificateDetailV2);
    });
