...
class DomainVerificationSummary(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, created_at: str=None, dce_token: str=None, domain: str=None, domain_entity_id: int=None, modified_at: str=None, status: str=None, type: str=None, usage: str=None):
        """DomainVerificationSummary - a model defined in OpenAPI

        :param created_at: The created_at of this DomainVerificationSummary.
        :param dce_token: The dce_token of this DomainVerificationSummary.
        :param domain: The domain of this DomainVerificationSummary.
        :param domain_entity_id: The domain_entity_id of this DomainVerificationSummary.
        :param modified_at: The modified_at of this DomainVerificationSummary.
        :param status: The status of this DomainVerificationSummary.
        :param type: The type of this DomainVerificationSummary.
        :param usage: The usage of this DomainVerificationSummary.
        """
        self.openapi_types = {
            'created_at': str,
            'dce_token': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DomainVerificationSummary':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DomainVerificationSummary of this DomainVerificationSummary.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def created_at(self):
        """Gets the created_at of this DomainVerificationSummary.

        Timestamp indicating when the domain verification process was started

        :return: The created_at of this DomainVerificationSummary.
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this DomainVerificationSummary.
    ...
    @property
    def dce_token(self):
        """Gets the dce_token of this DomainVerificationSummary.

        DCE verification type token (if DCE verification type).

        :return: The dce_token of this DomainVerificationSummary.
        :rtype: str
        """
    ...
    def dce_token(self, dce_token):
        """Sets the dce_token of this DomainVerificationSummary.
    ...
    @property
    def domain(self):
        """Gets the domain of this DomainVerificationSummary.

        Domain name

        :return: The domain of this DomainVerificationSummary.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this DomainVerificationSummary.
    ...
    def domain_entity_id(self):
        """Gets the domain_entity_id of this DomainVerificationSummary.
        ...
        :return: The domain_entity_id of this DomainVerificationSummary.
        :rtype: int
        """
    ...
    def domain_entity_id(self, domain_entity_id):
        """Sets the domain_entity_id of this DomainVerificationSummary.
    ...
    def modified_at(self):
        """Gets the modified_at of this DomainVerificationSummary.

        Timestamp indicating when the domain verification process was last updated

        :return: The modified_at of this DomainVerificationSummary.
        :rtype: str
        """
    ...
    def modified_at(self, modified_at):
        """Sets the modified_at of this DomainVerificationSummary.
    ...
    @property
    def status(self):
        """Gets the status of this DomainVerificationSummary.
        ...
        :return: The status of this DomainVerificationSummary.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this DomainVerificationSummary.
    ...
    @property
    def type(self):
        """Gets the type of this DomainVerificationSummary.
        ...
        :return: The type of this DomainVerificationSummary.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this DomainVerificationSummary.
    ...
    @property
    def usage(self):
        """Gets the usage of this DomainVerificationSummary.

        Type of domain name used for domain verification

        :return: The usage of this DomainVerificationSummary.
        :rtype: str
        """
        return self._usage
    ...
    def usage(self, usage):
        """Sets the usage of this DomainVerificationSummary.
