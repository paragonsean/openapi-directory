...
/*
 * OAICertificateAddress.h
 *
 * 
 */

#ifndef OAICertificateAddress_H
#define OAICertificateAddress_H
...
class OAICertificateAddress : public OAIObject {
public:
    OAICertificateAddress();
    OAICertificateAddress(QString json);
    ~OAICertificateAddress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAddress)

#endif // OAICertificateAddress_H
