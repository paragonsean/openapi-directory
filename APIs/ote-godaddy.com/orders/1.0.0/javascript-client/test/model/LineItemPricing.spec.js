...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.LineItemPricing();
  });
  ...
  describe('LineItemPricing', function() {
    it('should create an instance of LineItemPricing', function() {
      // uncomment below and update the code to test LineItemPricing
      //var instance = new OpenapiJsClient.LineItemPricing();
      //expect(instance).to.be.a(OpenapiJsClient.LineItemPricing);
    });
