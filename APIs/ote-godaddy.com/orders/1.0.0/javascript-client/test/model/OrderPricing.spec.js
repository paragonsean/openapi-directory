...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.OrderPricing();
  });
  ...
  describe('OrderPricing', function() {
    it('should create an instance of OrderPricing', function() {
      // uncomment below and update the code to test OrderPricing
      //var instance = new OpenapiJsClient.OrderPricing();
      //expect(instance).to.be.a(OpenapiJsClient.OrderPricing);
    });
