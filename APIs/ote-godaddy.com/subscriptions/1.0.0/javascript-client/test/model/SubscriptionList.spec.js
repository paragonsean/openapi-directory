...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.SubscriptionList();
  });
  ...
  describe('SubscriptionList', function() {
    it('should create an instance of SubscriptionList', function() {
      ...
      //var instance = new OpenapiJsClient.SubscriptionList();
      //expect(instance).to.be.a(OpenapiJsClient.SubscriptionList);
    });
