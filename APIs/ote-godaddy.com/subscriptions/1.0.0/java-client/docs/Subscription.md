...
|------------ | ------------- | ------------- | -------------|
|**addons** | [**List&lt;SubscriptionAddon&gt;**](SubscriptionAddon.md) | An array of additional products that have been purchased to augment this Subscription |  [optional] |
...
|**paymentProfileId** | **Integer** | Unique identifier of the payment profile that will be used to automatically renew this Subscription |  [optional] |
...
|**status** | [**StatusEnum**](#StatusEnum) | Whether the Subscription is active or the specific non-active state |  |
