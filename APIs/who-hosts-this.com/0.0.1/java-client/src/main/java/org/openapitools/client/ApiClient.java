...
public class ApiClient {
    ...
    private String basePath = "https://www.who-hosts-this.com/APIEndpoint";
    ...
    public ApiClient() {
        ...
        authentications.put("QueryKey", new ApiKeyAuth("query", "key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.who-hosts-this.com/APIEndpoint
