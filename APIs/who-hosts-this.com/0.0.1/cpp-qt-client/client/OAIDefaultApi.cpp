...
void OAIDefaultApi::statusGet() {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::statusGetCallback);
...
void OAIDefaultApi::statusGetCallback(OAIHttpRequestWorker *worker) {
