...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.CreatorRolesApi();
  });
  ...
  describe('CreatorRolesApi', function() {
    describe('creatorRolesList', function() {
      it('should call creatorRolesList successfully', function(done) {
        //uncomment below and update the code to test creatorRolesList
        //instance.creatorRolesList(function(error) {
