...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.StoresApi();
  });
  ...
  describe('StoresApi', function() {
    ...
    describe('storesRead', function() {
      it('should call storesRead successfully', function(done) {
        //uncomment below and update the code to test storesRead
        //instance.storesRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
