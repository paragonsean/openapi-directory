...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.PlatformsList200Response();
  });
  ...
  describe('PlatformsList200Response', function() {
    it('should create an instance of PlatformsList200Response', function() {
      // uncomment below and update the code to test PlatformsList200Response
      //var instance = new RawgVideoGamesDatabaseApi.PlatformsList200Response();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.PlatformsList200Response);
    });
