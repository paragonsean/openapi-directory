...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.Twitch();
  });
  ...
  describe('Twitch', function() {
    it('should create an instance of Twitch', function() {
      // uncomment below and update the code to test Twitch
      //var instance = new RawgVideoGamesDatabaseApi.Twitch();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.Twitch);
    });
