...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.PlatformParentSingle();
  });
  ...
  describe('PlatformParentSingle', function() {
    it('should create an instance of PlatformParentSingle', function() {
      // uncomment below and update the code to test PlatformParentSingle
      //var instance = new RawgVideoGamesDatabaseApi.PlatformParentSingle();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.PlatformParentSingle);
    });
