...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.GamePlatformsInner();
  });
  ...
  describe('GamePlatformsInner', function() {
    it('should create an instance of GamePlatformsInner', function() {
      // uncomment below and update the code to test GamePlatformsInner
      //var instance = new RawgVideoGamesDatabaseApi.GamePlatformsInner();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.GamePlatformsInner);
    });
