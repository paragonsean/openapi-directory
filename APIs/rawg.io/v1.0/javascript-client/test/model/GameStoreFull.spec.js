...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.GameStoreFull();
  });
  ...
  describe('GameStoreFull', function() {
    it('should create an instance of GameStoreFull', function() {
      // uncomment below and update the code to test GameStoreFull
      //var instance = new RawgVideoGamesDatabaseApi.GameStoreFull();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.GameStoreFull);
    });
