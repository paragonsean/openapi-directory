...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.Position();
  });
  ...
  describe('Position', function() {
    it('should create an instance of Position', function() {
      ...
      //var instance = new RawgVideoGamesDatabaseApi.Position();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.Position);
    });
