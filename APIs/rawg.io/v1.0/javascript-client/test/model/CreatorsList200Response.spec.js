...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.CreatorsList200Response();
  });
  ...
  describe('CreatorsList200Response', function() {
    it('should create an instance of CreatorsList200Response', function() {
      // uncomment below and update the code to test CreatorsList200Response
      //var instance = new RawgVideoGamesDatabaseApi.CreatorsList200Response();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.CreatorsList200Response);
    });
