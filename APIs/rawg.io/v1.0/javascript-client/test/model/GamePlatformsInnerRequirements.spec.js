...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.GamePlatformsInnerRequirements();
  });
  ...
  describe('GamePlatformsInnerRequirements', function() {
    it('should create an instance of GamePlatformsInnerRequirements', function() {
      // uncomment below and update the code to test GamePlatformsInnerRequirements
      //var instance = new RawgVideoGamesDatabaseApi.GamePlatformsInnerRequirements();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.GamePlatformsInnerRequirements);
    });
