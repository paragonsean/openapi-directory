...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.GameEsrbRating();
  });
  ...
  describe('GameEsrbRating', function() {
    it('should create an instance of GameEsrbRating', function() {
      // uncomment below and update the code to test GameEsrbRating
      //var instance = new RawgVideoGamesDatabaseApi.GameEsrbRating();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.GameEsrbRating);
    });
