...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.ParentAchievement();
  });
  ...
  describe('ParentAchievement', function() {
    it('should create an instance of ParentAchievement', function() {
      // uncomment below and update the code to test ParentAchievement
      //var instance = new RawgVideoGamesDatabaseApi.ParentAchievement();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.ParentAchievement);
    });
