...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RawgVideoGamesDatabaseApi.GamePlatformMetacritic();
  });
  ...
  describe('GamePlatformMetacritic', function() {
    it('should create an instance of GamePlatformMetacritic', function() {
      // uncomment below and update the code to test GamePlatformMetacritic
      //var instance = new RawgVideoGamesDatabaseApi.GamePlatformMetacritic();
      //expect(instance).to.be.a(RawgVideoGamesDatabaseApi.GamePlatformMetacritic);
    });
