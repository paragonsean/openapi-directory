...
/*
 * OAIGames_list_200_response.h
 *
 * 
 */

#ifndef OAIGames_list_200_response_H
#define OAIGames_list_200_response_H
...
class OAIGames_list_200_response : public OAIObject {
public:
    OAIGames_list_200_response();
    OAIGames_list_200_response(QString json);
    ~OAIGames_list_200_response() override;
    ...
    QList<OAIGame> getResults() const;
    void setResults(const QList<OAIGame> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGames_list_200_response)

#endif // OAIGames_list_200_response_H
