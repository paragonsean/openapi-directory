...
/*
 * OAIParentAchievement.h
 *
 * 
 */

#ifndef OAIParentAchievement_H
#define OAIParentAchievement_H
...
class OAIParentAchievement : public OAIObject {
public:
    OAIParentAchievement();
    OAIParentAchievement(QString json);
    ~OAIParentAchievement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParentAchievement)

#endif // OAIParentAchievement_H
