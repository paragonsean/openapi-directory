...
/*
 * OAIDevelopers_list_200_response.h
 *
 * 
 */

#ifndef OAIDevelopers_list_200_response_H
#define OAIDevelopers_list_200_response_H
...
class OAIDevelopers_list_200_response : public OAIObject {
public:
    OAIDevelopers_list_200_response();
    OAIDevelopers_list_200_response(QString json);
    ~OAIDevelopers_list_200_response() override;
    ...
    QList<OAIDeveloper> getResults() const;
    void setResults(const QList<OAIDeveloper> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDevelopers_list_200_response)

#endif // OAIDevelopers_list_200_response_H
