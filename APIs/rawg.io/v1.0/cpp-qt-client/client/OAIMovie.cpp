...
OAIObject OAIMovie::getData() const {
    return m_data;
}
void OAIMovie::setData(const OAIObject &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIMovie::is_data_Set() const{
    return m_data_isSet;
}

bool OAIMovie::is_data_Valid() const{
    return m_data_isValid;
}

qint32 OAIMovie::getId() const {
    return m_id;
}
void OAIMovie::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIMovie::is_id_Set() const{
    return m_id_isSet;
}

bool OAIMovie::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIMovie::getName() const {
    return m_name;
}
void OAIMovie::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIMovie::is_name_Set() const{
    return m_name_isSet;
}

bool OAIMovie::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIMovie::getPreview() const {
    return m_preview;
}
void OAIMovie::setPreview(const QString &preview) {
    m_preview = preview;
    m_preview_isSet = true;
}

bool OAIMovie::is_preview_Set() const{
    return m_preview_isSet;
}

bool OAIMovie::is_preview_Valid() const{
