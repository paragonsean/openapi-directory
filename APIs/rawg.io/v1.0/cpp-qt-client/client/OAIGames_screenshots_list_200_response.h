...
/*
 * OAIGames_screenshots_list_200_response.h
 *
 * 
 */

#ifndef OAIGames_screenshots_list_200_response_H
#define OAIGames_screenshots_list_200_response_H
...
class OAIGames_screenshots_list_200_response : public OAIObject {
public:
    OAIGames_screenshots_list_200_response();
    OAIGames_screenshots_list_200_response(QString json);
    ~OAIGames_screenshots_list_200_response() override;
    ...
    QList<OAIScreenShot> getResults() const;
    void setResults(const QList<OAIScreenShot> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGames_screenshots_list_200_response)

#endif // OAIGames_screenshots_list_200_response_H
