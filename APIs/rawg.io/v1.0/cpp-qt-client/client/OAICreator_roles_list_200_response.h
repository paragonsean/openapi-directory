...
/*
 * OAICreator_roles_list_200_response.h
 *
 * 
 */

#ifndef OAICreator_roles_list_200_response_H
#define OAICreator_roles_list_200_response_H
...
class OAICreator_roles_list_200_response : public OAIObject {
public:
    OAICreator_roles_list_200_response();
    OAICreator_roles_list_200_response(QString json);
    ~OAICreator_roles_list_200_response() override;
    ...
    QList<OAIPosition> getResults() const;
    void setResults(const QList<OAIPosition> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreator_roles_list_200_response)

#endif // OAICreator_roles_list_200_response_H
