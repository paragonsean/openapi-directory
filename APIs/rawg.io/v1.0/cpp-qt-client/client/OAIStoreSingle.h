...
#ifndef OAIStoreSingle_H
#define OAIStoreSingle_H
...
class OAIStoreSingle : public OAIObject {
public:
    OAIStoreSingle();
    OAIStoreSingle(QString json);
    ~OAIStoreSingle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStoreSingle)

#endif // OAIStoreSingle_H
