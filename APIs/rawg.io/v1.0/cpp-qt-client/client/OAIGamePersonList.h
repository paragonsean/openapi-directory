...
#ifndef OAIGamePersonList_H
#define OAIGamePersonList_H
...
class OAIGamePersonList : public OAIObject {
public:
    OAIGamePersonList();
    OAIGamePersonList(QString json);
    ~OAIGamePersonList() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGamePersonList)

#endif // OAIGamePersonList_H
