...
/*
 * OAIPlatforms_list_200_response.h
 *
 * 
 */

#ifndef OAIPlatforms_list_200_response_H
#define OAIPlatforms_list_200_response_H
...
class OAIPlatforms_list_200_response : public OAIObject {
public:
    OAIPlatforms_list_200_response();
    OAIPlatforms_list_200_response(QString json);
    ~OAIPlatforms_list_200_response() override;
    ...
    QList<OAIPlatform> getResults() const;
    void setResults(const QList<OAIPlatform> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPlatforms_list_200_response)

#endif // OAIPlatforms_list_200_response_H
