...
#ifndef OAIPlatformSingle_H
#define OAIPlatformSingle_H
...
class OAIPlatformSingle : public OAIObject {
public:
    OAIPlatformSingle();
    OAIPlatformSingle(QString json);
    ~OAIPlatformSingle() override;
    ...
    qint32 getYearEnd() const;
    void setYearEnd(const qint32 &year_end);
    bool is_year_end_Set() const;
    bool is_year_end_Valid() const;

    qint32 getYearStart() const;
    void setYearStart(const qint32 &year_start);
    bool is_year_start_Set() const;
    bool is_year_start_Valid() const;
...
private:
    ...
    qint32 m_year_end;
    bool m_year_end_isSet;
    bool m_year_end_isValid;

    qint32 m_year_start;
    bool m_year_start_isSet;
    bool m_year_start_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPlatformSingle)

#endif // OAIPlatformSingle_H
