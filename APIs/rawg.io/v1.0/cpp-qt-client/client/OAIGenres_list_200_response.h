...
/*
 * OAIGenres_list_200_response.h
 *
 * 
 */

#ifndef OAIGenres_list_200_response_H
#define OAIGenres_list_200_response_H
...
class OAIGenres_list_200_response : public OAIObject {
public:
    OAIGenres_list_200_response();
    OAIGenres_list_200_response(QString json);
    ~OAIGenres_list_200_response() override;
    ...
    QList<OAIGenre> getResults() const;
    void setResults(const QList<OAIGenre> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenres_list_200_response)

#endif // OAIGenres_list_200_response_H
