...
QString OAIPosition::getName() const {
    return m_name;
}
void OAIPosition::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPosition::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPosition::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPosition::getSlug() const {
    return m_slug;
}
void OAIPosition::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAIPosition::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAIPosition::is_slug_Valid() const{
