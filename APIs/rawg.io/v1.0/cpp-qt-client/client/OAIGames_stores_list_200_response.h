...
/*
 * OAIGames_stores_list_200_response.h
 *
 * 
 */

#ifndef OAIGames_stores_list_200_response_H
#define OAIGames_stores_list_200_response_H
...
namespace OpenAPI {
class OAIGameStoreFull;

class OAIGames_stores_list_200_response : public OAIObject {
public:
    OAIGames_stores_list_200_response();
    OAIGames_stores_list_200_response(QString json);
    ~OAIGames_stores_list_200_response() override;
    ...
    QList<OAIGameStoreFull> getResults() const;
    void setResults(const QList<OAIGameStoreFull> &results);
...
private:
    ...
    QList<OAIGameStoreFull> m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGames_stores_list_200_response)

#endif // OAIGames_stores_list_200_response_H
