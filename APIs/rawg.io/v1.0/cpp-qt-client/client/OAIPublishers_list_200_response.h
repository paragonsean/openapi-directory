...
/*
 * OAIPublishers_list_200_response.h
 *
 * 
 */

#ifndef OAIPublishers_list_200_response_H
#define OAIPublishers_list_200_response_H
...
class OAIPublishers_list_200_response : public OAIObject {
public:
    OAIPublishers_list_200_response();
    OAIPublishers_list_200_response(QString json);
    ~OAIPublishers_list_200_response() override;
    ...
    QList<OAIPublisher> getResults() const;
    void setResults(const QList<OAIPublisher> &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublishers_list_200_response)

#endif // OAIPublishers_list_200_response_H
