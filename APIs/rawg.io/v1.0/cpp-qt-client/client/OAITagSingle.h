...
#ifndef OAITagSingle_H
#define OAITagSingle_H
...
class OAITagSingle : public OAIObject {
public:
    OAITagSingle();
    OAITagSingle(QString json);
    ~OAITagSingle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITagSingle)

#endif // OAITagSingle_H
