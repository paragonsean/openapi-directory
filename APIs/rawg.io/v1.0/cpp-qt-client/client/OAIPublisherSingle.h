...
/*
 * OAIPublisherSingle.h
 *
 * 
 */

#ifndef OAIPublisherSingle_H
#define OAIPublisherSingle_H
...
class OAIPublisherSingle : public OAIObject {
public:
    OAIPublisherSingle();
    OAIPublisherSingle(QString json);
    ~OAIPublisherSingle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublisherSingle)

#endif // OAIPublisherSingle_H
