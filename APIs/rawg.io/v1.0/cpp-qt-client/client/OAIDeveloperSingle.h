...
/*
 * OAIDeveloperSingle.h
 *
 * 
 */

#ifndef OAIDeveloperSingle_H
#define OAIDeveloperSingle_H
...
class OAIDeveloperSingle : public OAIObject {
public:
    OAIDeveloperSingle();
    OAIDeveloperSingle(QString json);
    ~OAIDeveloperSingle() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeveloperSingle)

#endif // OAIDeveloperSingle_H
