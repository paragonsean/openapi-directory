...
/**
 * API tests for CreatorsApi
 */
@Disabled
public class CreatorsApiTest {

    private final CreatorsApi api = new CreatorsApi();
     ...
     */
    @Test
    public void creatorsListTest() throws ApiException {
        Integer page = null;
        Integer pageSize = null;
        CreatorsList200Response response = api.creatorsList(page, pageSize);
     ...
     */
    @Test
    public void creatorsReadTest() throws ApiException {
        String id = null;
        PersonSingle response = api.creatorsRead(id);
        // TODO: test validations
    }
