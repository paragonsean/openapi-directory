# GettyImages.CollectionsApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**v3CollectionsGet**](CollectionsApi.md#v3CollectionsGet) | **GET** /v3/collections | Gets collections applicable for the customer.



## v3CollectionsGet

> CollectionsList v3CollectionsGet(opts)
