...
/**
* Enum class CreativeImagesFieldValues.
* @enum {}
* @readonly
*/
export default class CreativeImagesFieldValues {
    ...
    /**
    * Returns a <code>CreativeImagesFieldValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CreativeImagesFieldValues} The enum <code>CreativeImagesFieldValues</code> value.
    */
