...
/**
 * The ImageSearchItemEditorial model module.
 * @module model/ImageSearchItemEditorial
 * @version 3
 */
class ImageSearchItemEditorial {
    /**
     * Constructs a new <code>ImageSearchItemEditorial</code>.
     * @alias module:model/ImageSearchItemEditorial
     */
    constructor() { 
        
        ImageSearchItemEditorial.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ImageSearchItemEditorial</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImageSearchItemEditorial} obj Optional instance to populate.
     * @return {module:model/ImageSearchItemEditorial} The populated <code>ImageSearchItemEditorial</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImageSearchItemEditorial();
            ...
            if (data.hasOwnProperty('editorial_source')) {
                obj['editorial_source'] = EditorialSource.constructFromObject(data['editorial_source']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ImageSearchItemEditorial</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImageSearchItemEditorial</code>.
     */
    static validateJSON(data) {
        ...
        if (data['editorial_source']) { // data not null
          EditorialSource.validateJSON(data['editorial_source']);
        }
        // ensure the json data is an array
 ...
 */
ImageSearchItemEditorial.prototype['allowed_use'] = undefined;

/**
 * @member {Object.<String, String>} alternative_ids
 */
ImageSearchItemEditorial.prototype['alternative_ids'] = undefined;

/**
 * @member {String} artist
 */
ImageSearchItemEditorial.prototype['artist'] = undefined;

/**
 * @member {String} asset_family
 */
ImageSearchItemEditorial.prototype['asset_family'] = undefined;

/**
 * @member {Boolean} call_for_image
 */
ImageSearchItemEditorial.prototype['call_for_image'] = undefined;

/**
 * @member {String} caption
 */
ImageSearchItemEditorial.prototype['caption'] = undefined;

/**
 * @member {String} collection_code
 */
ImageSearchItemEditorial.prototype['collection_code'] = undefined;

/**
 * @member {Number} collection_id
 */
ImageSearchItemEditorial.prototype['collection_id'] = undefined;

/**
 * @member {String} collection_name
 */
ImageSearchItemEditorial.prototype['collection_name'] = undefined;

/**
 * @member {String} color_type
 */
ImageSearchItemEditorial.prototype['color_type'] = undefined;

/**
 * @member {String} copyright
 */
ImageSearchItemEditorial.prototype['copyright'] = undefined;

/**
 * @member {Date} date_camera_shot
 */
ImageSearchItemEditorial.prototype['date_camera_shot'] = undefined;

/**
 * @member {Date} date_created
 */
ImageSearchItemEditorial.prototype['date_created'] = undefined;

/**
 * @member {Array.<module:model/ImageSearchItemDisplaySize>} display_sizes
 */
ImageSearchItemEditorial.prototype['display_sizes'] = undefined;

/**
 * @member {String} download_product
 */
ImageSearchItemEditorial.prototype['download_product'] = undefined;

/**
 * @member {Array.<String>} editorial_segments
 */
ImageSearchItemEditorial.prototype['editorial_segments'] = undefined;

/**
 * @member {module:model/EditorialSource} editorial_source
 */
ImageSearchItemEditorial.prototype['editorial_source'] = undefined;

/**
 * @member {Array.<Number>} event_ids
 */
ImageSearchItemEditorial.prototype['event_ids'] = undefined;

/**
 * @member {String} graphical_style
 */
ImageSearchItemEditorial.prototype['graphical_style'] = undefined;

/**
 * @member {String} id
 */
ImageSearchItemEditorial.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/Keyword>} keywords
 */
ImageSearchItemEditorial.prototype['keywords'] = undefined;

/**
 * @member {Array.<module:model/Download>} largest_downloads
 */
ImageSearchItemEditorial.prototype['largest_downloads'] = undefined;

/**
 * @member {String} license_model
 */
ImageSearchItemEditorial.prototype['license_model'] = undefined;

/**
 * @member {module:model/MaxDimensions} max_dimensions
 */
ImageSearchItemEditorial.prototype['max_dimensions'] = undefined;

/**
 * @member {String} orientation
 */
ImageSearchItemEditorial.prototype['orientation'] = undefined;

/**
 * @member {Array.<String>} people
 */
ImageSearchItemEditorial.prototype['people'] = undefined;

/**
 * @member {Array.<String>} product_types
 */
ImageSearchItemEditorial.prototype['product_types'] = undefined;

/**
 * @member {Number} quality_rank
 */
ImageSearchItemEditorial.prototype['quality_rank'] = undefined;

/**
 * @member {Array.<module:model/ReferralDestination>} referral_destinations
 */
ImageSearchItemEditorial.prototype['referral_destinations'] = undefined;

/**
 * @member {String} title
 */
ImageSearchItemEditorial.prototype['title'] = undefined;

/**
 * @member {String} uri_oembed
 */
ImageSearchItemEditorial.prototype['uri_oembed'] = undefined;
...
export default ImageSearchItemEditorial;
