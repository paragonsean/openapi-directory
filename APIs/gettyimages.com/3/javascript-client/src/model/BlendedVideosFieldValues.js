...
/**
* Enum class BlendedVideosFieldValues.
* @enum {}
* @readonly
*/
export default class BlendedVideosFieldValues {
    ...
    /**
    * Returns a <code>BlendedVideosFieldValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BlendedVideosFieldValues} The enum <code>BlendedVideosFieldValues</code> value.
    */
