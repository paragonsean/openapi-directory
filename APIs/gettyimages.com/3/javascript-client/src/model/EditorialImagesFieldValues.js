...
/**
* Enum class EditorialImagesFieldValues.
* @enum {}
* @readonly
*/
export default class EditorialImagesFieldValues {
    ...
    /**
    * Returns a <code>EditorialImagesFieldValues</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EditorialImagesFieldValues} The enum <code>EditorialImagesFieldValues</code> value.
    */
