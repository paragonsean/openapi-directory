...
/**
 * The CreativeVideoSearchItem model module.
 * @module model/CreativeVideoSearchItem
 * @version 3
 */
class CreativeVideoSearchItem {
    /**
     * Constructs a new <code>CreativeVideoSearchItem</code>.
     * @alias module:model/CreativeVideoSearchItem
     */
    constructor() { 
        
        CreativeVideoSearchItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreativeVideoSearchItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreativeVideoSearchItem} obj Optional instance to populate.
     * @return {module:model/CreativeVideoSearchItem} The populated <code>CreativeVideoSearchItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreativeVideoSearchItem();
    ...
    /**
     * Validates the JSON data with respect to <code>CreativeVideoSearchItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreativeVideoSearchItem</code>.
     */
 ...
 */
CreativeVideoSearchItem.prototype['allowed_use'] = undefined;

/**
 * @member {String} artist
 */
CreativeVideoSearchItem.prototype['artist'] = undefined;

/**
 * @member {String} asset_family
 */
CreativeVideoSearchItem.prototype['asset_family'] = undefined;

/**
 * @member {String} caption
 */
CreativeVideoSearchItem.prototype['caption'] = undefined;

/**
 * @member {String} clip_length
 */
CreativeVideoSearchItem.prototype['clip_length'] = undefined;

/**
 * @member {String} collection_code
 */
CreativeVideoSearchItem.prototype['collection_code'] = undefined;

/**
 * @member {Number} collection_id
 */
CreativeVideoSearchItem.prototype['collection_id'] = undefined;

/**
 * @member {String} collection_name
 */
CreativeVideoSearchItem.prototype['collection_name'] = undefined;

/**
 * @member {String} color_type
 */
CreativeVideoSearchItem.prototype['color_type'] = undefined;

/**
 * @member {String} copyright
 */
CreativeVideoSearchItem.prototype['copyright'] = undefined;

/**
 * @member {Date} date_created
 */
CreativeVideoSearchItem.prototype['date_created'] = undefined;

/**
 * @member {Array.<module:model/VideoSearchItemDisplaySize>} display_sizes
 */
CreativeVideoSearchItem.prototype['display_sizes'] = undefined;

/**
 * @member {String} download_product
 */
CreativeVideoSearchItem.prototype['download_product'] = undefined;

/**
 * @member {String} era
 */
CreativeVideoSearchItem.prototype['era'] = undefined;

/**
 * @member {Array.<Number>} event_ids
 */
CreativeVideoSearchItem.prototype['event_ids'] = undefined;

/**
 * @member {String} id
 */
CreativeVideoSearchItem.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/IStockLicense>} istock_licenses
 */
CreativeVideoSearchItem.prototype['istock_licenses'] = undefined;

/**
 * @member {Array.<module:model/Keyword>} keywords
 */
CreativeVideoSearchItem.prototype['keywords'] = undefined;

/**
 * @member {Array.<module:model/Download>} largest_downloads
 */
CreativeVideoSearchItem.prototype['largest_downloads'] = undefined;

/**
 * @member {String} license_model
 */
CreativeVideoSearchItem.prototype['license_model'] = undefined;

/**
 * @member {String} mastered_to
 */
CreativeVideoSearchItem.prototype['mastered_to'] = undefined;

/**
 * @member {String} originally_shot_on
 */
CreativeVideoSearchItem.prototype['originally_shot_on'] = undefined;

/**
 * @member {Array.<String>} product_types
 */
CreativeVideoSearchItem.prototype['product_types'] = undefined;

/**
 * @member {Array.<module:model/ReferralDestination>} referral_destinations
 */
CreativeVideoSearchItem.prototype['referral_destinations'] = undefined;

/**
 * @member {String} shot_speed
 */
CreativeVideoSearchItem.prototype['shot_speed'] = undefined;

/**
 * @member {String} title
 */
CreativeVideoSearchItem.prototype['title'] = undefined;
...
export default CreativeVideoSearchItem;
