...
/**
 * The BlendedVideoSearchItem model module.
 * @module model/BlendedVideoSearchItem
 * @version 3
 */
class BlendedVideoSearchItem {
    /**
     * Constructs a new <code>BlendedVideoSearchItem</code>.
     * @alias module:model/BlendedVideoSearchItem
     */
    constructor() { 
        
        BlendedVideoSearchItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BlendedVideoSearchItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlendedVideoSearchItem} obj Optional instance to populate.
     * @return {module:model/BlendedVideoSearchItem} The populated <code>BlendedVideoSearchItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlendedVideoSearchItem();
    ...
    /**
     * Validates the JSON data with respect to <code>BlendedVideoSearchItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlendedVideoSearchItem</code>.
     */
 ...
 */
BlendedVideoSearchItem.prototype['allowed_use'] = undefined;

/**
 * @member {String} artist
 */
BlendedVideoSearchItem.prototype['artist'] = undefined;

/**
 * @member {String} asset_family
 */
BlendedVideoSearchItem.prototype['asset_family'] = undefined;

/**
 * @member {String} caption
 */
BlendedVideoSearchItem.prototype['caption'] = undefined;

/**
 * @member {String} clip_length
 */
BlendedVideoSearchItem.prototype['clip_length'] = undefined;

/**
 * @member {String} collection_code
 */
BlendedVideoSearchItem.prototype['collection_code'] = undefined;

/**
 * @member {Number} collection_id
 */
BlendedVideoSearchItem.prototype['collection_id'] = undefined;

/**
 * @member {String} collection_name
 */
BlendedVideoSearchItem.prototype['collection_name'] = undefined;

/**
 * @member {String} color_type
 */
BlendedVideoSearchItem.prototype['color_type'] = undefined;

/**
 * @member {String} copyright
 */
BlendedVideoSearchItem.prototype['copyright'] = undefined;

/**
 * @member {Date} date_created
 */
BlendedVideoSearchItem.prototype['date_created'] = undefined;

/**
 * @member {Array.<module:model/VideoSearchItemDisplaySize>} display_sizes
 */
BlendedVideoSearchItem.prototype['display_sizes'] = undefined;

/**
 * @member {String} download_product
 */
BlendedVideoSearchItem.prototype['download_product'] = undefined;

/**
 * @member {String} era
 */
BlendedVideoSearchItem.prototype['era'] = undefined;

/**
 * @member {Array.<Number>} event_ids
 */
BlendedVideoSearchItem.prototype['event_ids'] = undefined;

/**
 * @member {String} id
 */
BlendedVideoSearchItem.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/IStockLicense>} istock_licenses
 */
BlendedVideoSearchItem.prototype['istock_licenses'] = undefined;

/**
 * @member {Array.<module:model/Keyword>} keywords
 */
BlendedVideoSearchItem.prototype['keywords'] = undefined;

/**
 * @member {Array.<module:model/Download>} largest_downloads
 */
BlendedVideoSearchItem.prototype['largest_downloads'] = undefined;

/**
 * @member {String} license_model
 */
BlendedVideoSearchItem.prototype['license_model'] = undefined;

/**
 * @member {String} mastered_to
 */
BlendedVideoSearchItem.prototype['mastered_to'] = undefined;

/**
 * @member {String} originally_shot_on
 */
BlendedVideoSearchItem.prototype['originally_shot_on'] = undefined;

/**
 * @member {Array.<String>} product_types
 */
BlendedVideoSearchItem.prototype['product_types'] = undefined;

/**
 * @member {Array.<module:model/ReferralDestination>} referral_destinations
 */
BlendedVideoSearchItem.prototype['referral_destinations'] = undefined;

/**
 * @member {String} shot_speed
 */
BlendedVideoSearchItem.prototype['shot_speed'] = undefined;

/**
 * @member {String} source
 */
BlendedVideoSearchItem.prototype['source'] = undefined;

/**
 * @member {String} title
 */
BlendedVideoSearchItem.prototype['title'] = undefined;
...
export default BlendedVideoSearchItem;
