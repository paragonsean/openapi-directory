...
/*
 * OAIImageSearchItemEditorial.h
 *
 * 
 */

#ifndef OAIImageSearchItemEditorial_H
#define OAIImageSearchItemEditorial_H
...
class OAIEditorialSource;
class OAIKeyword;
class OAIDownload;
class OAIMaxDimensions;
class OAIReferralDestination;

class OAIImageSearchItemEditorial : public OAIObject {
public:
    OAIImageSearchItemEditorial();
    OAIImageSearchItemEditorial(QString json);
    ~OAIImageSearchItemEditorial() override;
    ...
    OAIEditorialSource getEditorialSource() const;
    void setEditorialSource(const OAIEditorialSource &editorial_source);
    bool is_editorial_source_Set() const;
    bool is_editorial_source_Valid() const;
...
private:
    ...
    OAIEditorialSource m_editorial_source;
    bool m_editorial_source_isSet;
    bool m_editorial_source_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageSearchItemEditorial)

#endif // OAIImageSearchItemEditorial_H
