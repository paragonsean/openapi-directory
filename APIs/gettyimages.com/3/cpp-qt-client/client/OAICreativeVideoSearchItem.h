...
/*
 * OAICreativeVideoSearchItem.h
 *
 * 
 */

#ifndef OAICreativeVideoSearchItem_H
#define OAICreativeVideoSearchItem_H
...
class OAICreativeVideoSearchItem : public OAIObject {
public:
    OAICreativeVideoSearchItem();
    OAICreativeVideoSearchItem(QString json);
    ~OAICreativeVideoSearchItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreativeVideoSearchItem)

#endif // OAICreativeVideoSearchItem_H
