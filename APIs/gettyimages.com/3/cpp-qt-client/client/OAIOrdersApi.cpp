...
void OAIOrdersApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("v3OrdersIdGet", defaultConf);
    _serverIndices.insert("v3OrdersIdGet", 0);
}
...
void OAIOrdersApi::v3OrdersIdGet(const qint32 &id, const ::OpenAPI::OptionalParam<QString> &accept_language) {
    QString fullPath = QString(_serverConfigs["v3OrdersIdGet"][_serverIndices.value("v3OrdersIdGet")].URL()+"/v3/orders/{id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::v3OrdersIdGetCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOrdersApi::v3OrdersIdGetCallback);
...
void OAIOrdersApi::v3OrdersIdGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIOrderDetail output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT v3OrdersIdGetSignal(output);
        Q_EMIT v3OrdersIdGetSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT v3OrdersIdGetSignalE(output, error_type, error_str);
        Q_EMIT v3OrdersIdGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT v3OrdersIdGetSignalError(output, error_type, error_str);
        Q_EMIT v3OrdersIdGetSignalErrorFull(worker, error_type, error_str);
    }
}
