...
/*
 * OAIImageSearchItem.h
 *
 * 
 */

#ifndef OAIImageSearchItem_H
#define OAIImageSearchItem_H
...
class OAIImageSearchItem : public OAIObject {
public:
    OAIImageSearchItem();
    OAIImageSearchItem(QString json);
    ~OAIImageSearchItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageSearchItem)

#endif // OAIImageSearchItem_H
