...
/*
 * OAIEditorialVideoSearchItem.h
 *
 * 
 */

#ifndef OAIEditorialVideoSearchItem_H
#define OAIEditorialVideoSearchItem_H
...
class OAIEditorialVideoSearchItem : public OAIObject {
public:
    OAIEditorialVideoSearchItem();
    OAIEditorialVideoSearchItem(QString json);
    ~OAIEditorialVideoSearchItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEditorialVideoSearchItem)

#endif // OAIEditorialVideoSearchItem_H
