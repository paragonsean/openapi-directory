...
OAICreativeVideoSearchItem::OAICreativeVideoSearchItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreativeVideoSearchItem::OAICreativeVideoSearchItem() {
    this->initializeModel();
}

OAICreativeVideoSearchItem::~OAICreativeVideoSearchItem() {}

void OAICreativeVideoSearchItem::initializeModel() {
...
void OAICreativeVideoSearchItem::fromJson(QString jsonString) {
...
void OAICreativeVideoSearchItem::fromJsonObject(QJsonObject json) {
...
QString OAICreativeVideoSearchItem::asJson() const {
...
QJsonObject OAICreativeVideoSearchItem::asJsonObject() const {
    QJsonObject obj;
...
OAIAllowedUse OAICreativeVideoSearchItem::getAllowedUse() const {
    return m_allowed_use;
}
void OAICreativeVideoSearchItem::setAllowedUse(const OAIAllowedUse &allowed_use) {
    m_allowed_use = allowed_use;
    m_allowed_use_isSet = true;
}

bool OAICreativeVideoSearchItem::is_allowed_use_Set() const{
    return m_allowed_use_isSet;
}

bool OAICreativeVideoSearchItem::is_allowed_use_Valid() const{
    return m_allowed_use_isValid;
}

QString OAICreativeVideoSearchItem::getArtist() const {
    return m_artist;
}
void OAICreativeVideoSearchItem::setArtist(const QString &artist) {
    m_artist = artist;
    m_artist_isSet = true;
}

bool OAICreativeVideoSearchItem::is_artist_Set() const{
    return m_artist_isSet;
}

bool OAICreativeVideoSearchItem::is_artist_Valid() const{
    return m_artist_isValid;
}

QString OAICreativeVideoSearchItem::getAssetFamily() const {
    return m_asset_family;
}
void OAICreativeVideoSearchItem::setAssetFamily(const QString &asset_family) {
    m_asset_family = asset_family;
    m_asset_family_isSet = true;
}

bool OAICreativeVideoSearchItem::is_asset_family_Set() const{
    return m_asset_family_isSet;
}

bool OAICreativeVideoSearchItem::is_asset_family_Valid() const{
    return m_asset_family_isValid;
}

QString OAICreativeVideoSearchItem::getCaption() const {
    return m_caption;
}
void OAICreativeVideoSearchItem::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAICreativeVideoSearchItem::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAICreativeVideoSearchItem::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAICreativeVideoSearchItem::getClipLength() const {
    return m_clip_length;
}
void OAICreativeVideoSearchItem::setClipLength(const QString &clip_length) {
    m_clip_length = clip_length;
    m_clip_length_isSet = true;
}

bool OAICreativeVideoSearchItem::is_clip_length_Set() const{
    return m_clip_length_isSet;
}

bool OAICreativeVideoSearchItem::is_clip_length_Valid() const{
    return m_clip_length_isValid;
}

QString OAICreativeVideoSearchItem::getCollectionCode() const {
    return m_collection_code;
}
void OAICreativeVideoSearchItem::setCollectionCode(const QString &collection_code) {
    m_collection_code = collection_code;
    m_collection_code_isSet = true;
}

bool OAICreativeVideoSearchItem::is_collection_code_Set() const{
    return m_collection_code_isSet;
}

bool OAICreativeVideoSearchItem::is_collection_code_Valid() const{
    return m_collection_code_isValid;
}

qint32 OAICreativeVideoSearchItem::getCollectionId() const {
    return m_collection_id;
}
void OAICreativeVideoSearchItem::setCollectionId(const qint32 &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAICreativeVideoSearchItem::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAICreativeVideoSearchItem::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAICreativeVideoSearchItem::getCollectionName() const {
    return m_collection_name;
}
void OAICreativeVideoSearchItem::setCollectionName(const QString &collection_name) {
    m_collection_name = collection_name;
    m_collection_name_isSet = true;
}

bool OAICreativeVideoSearchItem::is_collection_name_Set() const{
    return m_collection_name_isSet;
}

bool OAICreativeVideoSearchItem::is_collection_name_Valid() const{
    return m_collection_name_isValid;
}

QString OAICreativeVideoSearchItem::getColorType() const {
    return m_color_type;
}
void OAICreativeVideoSearchItem::setColorType(const QString &color_type) {
    m_color_type = color_type;
    m_color_type_isSet = true;
}

bool OAICreativeVideoSearchItem::is_color_type_Set() const{
    return m_color_type_isSet;
}

bool OAICreativeVideoSearchItem::is_color_type_Valid() const{
    return m_color_type_isValid;
}

QString OAICreativeVideoSearchItem::getCopyright() const {
    return m_copyright;
}
void OAICreativeVideoSearchItem::setCopyright(const QString &copyright) {
    m_copyright = copyright;
    m_copyright_isSet = true;
}

bool OAICreativeVideoSearchItem::is_copyright_Set() const{
    return m_copyright_isSet;
}

bool OAICreativeVideoSearchItem::is_copyright_Valid() const{
    return m_copyright_isValid;
}

QDateTime OAICreativeVideoSearchItem::getDateCreated() const {
    return m_date_created;
}
void OAICreativeVideoSearchItem::setDateCreated(const QDateTime &date_created) {
    m_date_created = date_created;
    m_date_created_isSet = true;
}

bool OAICreativeVideoSearchItem::is_date_created_Set() const{
    return m_date_created_isSet;
}

bool OAICreativeVideoSearchItem::is_date_created_Valid() const{
    return m_date_created_isValid;
}

QList<OAIVideoSearchItemDisplaySize> OAICreativeVideoSearchItem::getDisplaySizes() const {
    return m_display_sizes;
}
void OAICreativeVideoSearchItem::setDisplaySizes(const QList<OAIVideoSearchItemDisplaySize> &display_sizes) {
    m_display_sizes = display_sizes;
    m_display_sizes_isSet = true;
}

bool OAICreativeVideoSearchItem::is_display_sizes_Set() const{
    return m_display_sizes_isSet;
}

bool OAICreativeVideoSearchItem::is_display_sizes_Valid() const{
    return m_display_sizes_isValid;
}

QString OAICreativeVideoSearchItem::getDownloadProduct() const {
    return m_download_product;
}
void OAICreativeVideoSearchItem::setDownloadProduct(const QString &download_product) {
    m_download_product = download_product;
    m_download_product_isSet = true;
}

bool OAICreativeVideoSearchItem::is_download_product_Set() const{
    return m_download_product_isSet;
}

bool OAICreativeVideoSearchItem::is_download_product_Valid() const{
    return m_download_product_isValid;
}

QString OAICreativeVideoSearchItem::getEra() const {
    return m_era;
}
void OAICreativeVideoSearchItem::setEra(const QString &era) {
    m_era = era;
    m_era_isSet = true;
}

bool OAICreativeVideoSearchItem::is_era_Set() const{
    return m_era_isSet;
}

bool OAICreativeVideoSearchItem::is_era_Valid() const{
    return m_era_isValid;
}

QList<qint32> OAICreativeVideoSearchItem::getEventIds() const {
    return m_event_ids;
}
void OAICreativeVideoSearchItem::setEventIds(const QList<qint32> &event_ids) {
    m_event_ids = event_ids;
    m_event_ids_isSet = true;
}

bool OAICreativeVideoSearchItem::is_event_ids_Set() const{
    return m_event_ids_isSet;
}

bool OAICreativeVideoSearchItem::is_event_ids_Valid() const{
    return m_event_ids_isValid;
}

QString OAICreativeVideoSearchItem::getId() const {
    return m_id;
}
void OAICreativeVideoSearchItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICreativeVideoSearchItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAICreativeVideoSearchItem::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIIStockLicense> OAICreativeVideoSearchItem::getIstockLicenses() const {
    return m_istock_licenses;
}
void OAICreativeVideoSearchItem::setIstockLicenses(const QList<OAIIStockLicense> &istock_licenses) {
    m_istock_licenses = istock_licenses;
    m_istock_licenses_isSet = true;
}

bool OAICreativeVideoSearchItem::is_istock_licenses_Set() const{
    return m_istock_licenses_isSet;
}

bool OAICreativeVideoSearchItem::is_istock_licenses_Valid() const{
    return m_istock_licenses_isValid;
}

QList<OAIKeyword> OAICreativeVideoSearchItem::getKeywords() const {
    return m_keywords;
}
void OAICreativeVideoSearchItem::setKeywords(const QList<OAIKeyword> &keywords) {
    m_keywords = keywords;
    m_keywords_isSet = true;
}

bool OAICreativeVideoSearchItem::is_keywords_Set() const{
    return m_keywords_isSet;
}

bool OAICreativeVideoSearchItem::is_keywords_Valid() const{
    return m_keywords_isValid;
}

QList<OAIDownload> OAICreativeVideoSearchItem::getLargestDownloads() const {
    return m_largest_downloads;
}
void OAICreativeVideoSearchItem::setLargestDownloads(const QList<OAIDownload> &largest_downloads) {
    m_largest_downloads = largest_downloads;
    m_largest_downloads_isSet = true;
}

bool OAICreativeVideoSearchItem::is_largest_downloads_Set() const{
    return m_largest_downloads_isSet;
}

bool OAICreativeVideoSearchItem::is_largest_downloads_Valid() const{
    return m_largest_downloads_isValid;
}

QString OAICreativeVideoSearchItem::getLicenseModel() const {
    return m_license_model;
}
void OAICreativeVideoSearchItem::setLicenseModel(const QString &license_model) {
    m_license_model = license_model;
    m_license_model_isSet = true;
}

bool OAICreativeVideoSearchItem::is_license_model_Set() const{
    return m_license_model_isSet;
}

bool OAICreativeVideoSearchItem::is_license_model_Valid() const{
    return m_license_model_isValid;
}

QString OAICreativeVideoSearchItem::getMasteredTo() const {
    return m_mastered_to;
}
void OAICreativeVideoSearchItem::setMasteredTo(const QString &mastered_to) {
    m_mastered_to = mastered_to;
    m_mastered_to_isSet = true;
}

bool OAICreativeVideoSearchItem::is_mastered_to_Set() const{
    return m_mastered_to_isSet;
}

bool OAICreativeVideoSearchItem::is_mastered_to_Valid() const{
    return m_mastered_to_isValid;
}

QString OAICreativeVideoSearchItem::getOriginallyShotOn() const {
    return m_originally_shot_on;
}
void OAICreativeVideoSearchItem::setOriginallyShotOn(const QString &originally_shot_on) {
    m_originally_shot_on = originally_shot_on;
    m_originally_shot_on_isSet = true;
}

bool OAICreativeVideoSearchItem::is_originally_shot_on_Set() const{
    return m_originally_shot_on_isSet;
}

bool OAICreativeVideoSearchItem::is_originally_shot_on_Valid() const{
    return m_originally_shot_on_isValid;
}

QList<QString> OAICreativeVideoSearchItem::getProductTypes() const {
    return m_product_types;
}
void OAICreativeVideoSearchItem::setProductTypes(const QList<QString> &product_types) {
    m_product_types = product_types;
    m_product_types_isSet = true;
}

bool OAICreativeVideoSearchItem::is_product_types_Set() const{
    return m_product_types_isSet;
}

bool OAICreativeVideoSearchItem::is_product_types_Valid() const{
    return m_product_types_isValid;
}

QList<OAIReferralDestination> OAICreativeVideoSearchItem::getReferralDestinations() const {
    return m_referral_destinations;
}
void OAICreativeVideoSearchItem::setReferralDestinations(const QList<OAIReferralDestination> &referral_destinations) {
    m_referral_destinations = referral_destinations;
    m_referral_destinations_isSet = true;
}

bool OAICreativeVideoSearchItem::is_referral_destinations_Set() const{
    return m_referral_destinations_isSet;
}

bool OAICreativeVideoSearchItem::is_referral_destinations_Valid() const{
    return m_referral_destinations_isValid;
}

QString OAICreativeVideoSearchItem::getShotSpeed() const {
    return m_shot_speed;
}
void OAICreativeVideoSearchItem::setShotSpeed(const QString &shot_speed) {
    m_shot_speed = shot_speed;
    m_shot_speed_isSet = true;
}

bool OAICreativeVideoSearchItem::is_shot_speed_Set() const{
    return m_shot_speed_isSet;
}

bool OAICreativeVideoSearchItem::is_shot_speed_Valid() const{
    return m_shot_speed_isValid;
}

QString OAICreativeVideoSearchItem::getTitle() const {
    return m_title;
}
void OAICreativeVideoSearchItem::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICreativeVideoSearchItem::is_title_Set() const{
    return m_title_isSet;
}

bool OAICreativeVideoSearchItem::is_title_Valid() const{
    return m_title_isValid;
}

bool OAICreativeVideoSearchItem::isSet() const {
...
bool OAICreativeVideoSearchItem::isValid() const {
