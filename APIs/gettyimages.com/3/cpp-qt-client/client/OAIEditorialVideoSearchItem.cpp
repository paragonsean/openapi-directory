...
OAIEditorialVideoSearchItem::OAIEditorialVideoSearchItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditorialVideoSearchItem::OAIEditorialVideoSearchItem() {
    this->initializeModel();
}

OAIEditorialVideoSearchItem::~OAIEditorialVideoSearchItem() {}

void OAIEditorialVideoSearchItem::initializeModel() {
...
void OAIEditorialVideoSearchItem::fromJson(QString jsonString) {
...
void OAIEditorialVideoSearchItem::fromJsonObject(QJsonObject json) {
...
QString OAIEditorialVideoSearchItem::asJson() const {
...
QJsonObject OAIEditorialVideoSearchItem::asJsonObject() const {
    QJsonObject obj;
...
OAIAllowedUse OAIEditorialVideoSearchItem::getAllowedUse() const {
    return m_allowed_use;
}
void OAIEditorialVideoSearchItem::setAllowedUse(const OAIAllowedUse &allowed_use) {
    m_allowed_use = allowed_use;
    m_allowed_use_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_allowed_use_Set() const{
    return m_allowed_use_isSet;
}

bool OAIEditorialVideoSearchItem::is_allowed_use_Valid() const{
    return m_allowed_use_isValid;
}

QString OAIEditorialVideoSearchItem::getArtist() const {
    return m_artist;
}
void OAIEditorialVideoSearchItem::setArtist(const QString &artist) {
    m_artist = artist;
    m_artist_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_artist_Set() const{
    return m_artist_isSet;
}

bool OAIEditorialVideoSearchItem::is_artist_Valid() const{
    return m_artist_isValid;
}

QString OAIEditorialVideoSearchItem::getAssetFamily() const {
    return m_asset_family;
}
void OAIEditorialVideoSearchItem::setAssetFamily(const QString &asset_family) {
    m_asset_family = asset_family;
    m_asset_family_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_asset_family_Set() const{
    return m_asset_family_isSet;
}

bool OAIEditorialVideoSearchItem::is_asset_family_Valid() const{
    return m_asset_family_isValid;
}

QString OAIEditorialVideoSearchItem::getCaption() const {
    return m_caption;
}
void OAIEditorialVideoSearchItem::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAIEditorialVideoSearchItem::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAIEditorialVideoSearchItem::getClipLength() const {
    return m_clip_length;
}
void OAIEditorialVideoSearchItem::setClipLength(const QString &clip_length) {
    m_clip_length = clip_length;
    m_clip_length_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_clip_length_Set() const{
    return m_clip_length_isSet;
}

bool OAIEditorialVideoSearchItem::is_clip_length_Valid() const{
    return m_clip_length_isValid;
}

QString OAIEditorialVideoSearchItem::getCollectionCode() const {
    return m_collection_code;
}
void OAIEditorialVideoSearchItem::setCollectionCode(const QString &collection_code) {
    m_collection_code = collection_code;
    m_collection_code_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_collection_code_Set() const{
    return m_collection_code_isSet;
}

bool OAIEditorialVideoSearchItem::is_collection_code_Valid() const{
    return m_collection_code_isValid;
}

qint32 OAIEditorialVideoSearchItem::getCollectionId() const {
    return m_collection_id;
}
void OAIEditorialVideoSearchItem::setCollectionId(const qint32 &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIEditorialVideoSearchItem::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAIEditorialVideoSearchItem::getCollectionName() const {
    return m_collection_name;
}
void OAIEditorialVideoSearchItem::setCollectionName(const QString &collection_name) {
    m_collection_name = collection_name;
    m_collection_name_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_collection_name_Set() const{
    return m_collection_name_isSet;
}

bool OAIEditorialVideoSearchItem::is_collection_name_Valid() const{
    return m_collection_name_isValid;
}

QString OAIEditorialVideoSearchItem::getColorType() const {
    return m_color_type;
}
void OAIEditorialVideoSearchItem::setColorType(const QString &color_type) {
    m_color_type = color_type;
    m_color_type_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_color_type_Set() const{
    return m_color_type_isSet;
}

bool OAIEditorialVideoSearchItem::is_color_type_Valid() const{
    return m_color_type_isValid;
}

QString OAIEditorialVideoSearchItem::getCopyright() const {
    return m_copyright;
}
void OAIEditorialVideoSearchItem::setCopyright(const QString &copyright) {
    m_copyright = copyright;
    m_copyright_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_copyright_Set() const{
    return m_copyright_isSet;
}

bool OAIEditorialVideoSearchItem::is_copyright_Valid() const{
    return m_copyright_isValid;
}

QDateTime OAIEditorialVideoSearchItem::getDateCreated() const {
    return m_date_created;
}
void OAIEditorialVideoSearchItem::setDateCreated(const QDateTime &date_created) {
    m_date_created = date_created;
    m_date_created_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_date_created_Set() const{
    return m_date_created_isSet;
}

bool OAIEditorialVideoSearchItem::is_date_created_Valid() const{
    return m_date_created_isValid;
}

QList<OAIVideoSearchItemDisplaySize> OAIEditorialVideoSearchItem::getDisplaySizes() const {
    return m_display_sizes;
}
void OAIEditorialVideoSearchItem::setDisplaySizes(const QList<OAIVideoSearchItemDisplaySize> &display_sizes) {
    m_display_sizes = display_sizes;
    m_display_sizes_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_display_sizes_Set() const{
    return m_display_sizes_isSet;
}

bool OAIEditorialVideoSearchItem::is_display_sizes_Valid() const{
    return m_display_sizes_isValid;
}

QString OAIEditorialVideoSearchItem::getDownloadProduct() const {
    return m_download_product;
}
void OAIEditorialVideoSearchItem::setDownloadProduct(const QString &download_product) {
    m_download_product = download_product;
    m_download_product_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_download_product_Set() const{
    return m_download_product_isSet;
}

bool OAIEditorialVideoSearchItem::is_download_product_Valid() const{
    return m_download_product_isValid;
}

QString OAIEditorialVideoSearchItem::getEra() const {
    return m_era;
}
void OAIEditorialVideoSearchItem::setEra(const QString &era) {
    m_era = era;
    m_era_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_era_Set() const{
    return m_era_isSet;
}

bool OAIEditorialVideoSearchItem::is_era_Valid() const{
    return m_era_isValid;
}

QList<qint32> OAIEditorialVideoSearchItem::getEventIds() const {
    return m_event_ids;
}
void OAIEditorialVideoSearchItem::setEventIds(const QList<qint32> &event_ids) {
    m_event_ids = event_ids;
    m_event_ids_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_event_ids_Set() const{
    return m_event_ids_isSet;
}

bool OAIEditorialVideoSearchItem::is_event_ids_Valid() const{
    return m_event_ids_isValid;
}

QString OAIEditorialVideoSearchItem::getId() const {
    return m_id;
}
void OAIEditorialVideoSearchItem::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_id_Set() const{
    return m_id_isSet;
}

bool OAIEditorialVideoSearchItem::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAIIStockLicense> OAIEditorialVideoSearchItem::getIstockLicenses() const {
    return m_istock_licenses;
}
void OAIEditorialVideoSearchItem::setIstockLicenses(const QList<OAIIStockLicense> &istock_licenses) {
    m_istock_licenses = istock_licenses;
    m_istock_licenses_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_istock_licenses_Set() const{
    return m_istock_licenses_isSet;
}

bool OAIEditorialVideoSearchItem::is_istock_licenses_Valid() const{
    return m_istock_licenses_isValid;
}

QList<OAIKeyword> OAIEditorialVideoSearchItem::getKeywords() const {
    return m_keywords;
}
void OAIEditorialVideoSearchItem::setKeywords(const QList<OAIKeyword> &keywords) {
    m_keywords = keywords;
    m_keywords_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_keywords_Set() const{
    return m_keywords_isSet;
}

bool OAIEditorialVideoSearchItem::is_keywords_Valid() const{
    return m_keywords_isValid;
}

QList<OAIDownload> OAIEditorialVideoSearchItem::getLargestDownloads() const {
    return m_largest_downloads;
}
void OAIEditorialVideoSearchItem::setLargestDownloads(const QList<OAIDownload> &largest_downloads) {
    m_largest_downloads = largest_downloads;
    m_largest_downloads_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_largest_downloads_Set() const{
    return m_largest_downloads_isSet;
}

bool OAIEditorialVideoSearchItem::is_largest_downloads_Valid() const{
    return m_largest_downloads_isValid;
}

QString OAIEditorialVideoSearchItem::getLicenseModel() const {
    return m_license_model;
}
void OAIEditorialVideoSearchItem::setLicenseModel(const QString &license_model) {
    m_license_model = license_model;
    m_license_model_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_license_model_Set() const{
    return m_license_model_isSet;
}

bool OAIEditorialVideoSearchItem::is_license_model_Valid() const{
    return m_license_model_isValid;
}

QString OAIEditorialVideoSearchItem::getMasteredTo() const {
    return m_mastered_to;
}
void OAIEditorialVideoSearchItem::setMasteredTo(const QString &mastered_to) {
    m_mastered_to = mastered_to;
    m_mastered_to_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_mastered_to_Set() const{
    return m_mastered_to_isSet;
}

bool OAIEditorialVideoSearchItem::is_mastered_to_Valid() const{
    return m_mastered_to_isValid;
}

QString OAIEditorialVideoSearchItem::getOriginallyShotOn() const {
    return m_originally_shot_on;
}
void OAIEditorialVideoSearchItem::setOriginallyShotOn(const QString &originally_shot_on) {
    m_originally_shot_on = originally_shot_on;
    m_originally_shot_on_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_originally_shot_on_Set() const{
    return m_originally_shot_on_isSet;
}

bool OAIEditorialVideoSearchItem::is_originally_shot_on_Valid() const{
    return m_originally_shot_on_isValid;
}

QList<QString> OAIEditorialVideoSearchItem::getProductTypes() const {
    return m_product_types;
}
void OAIEditorialVideoSearchItem::setProductTypes(const QList<QString> &product_types) {
    m_product_types = product_types;
    m_product_types_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_product_types_Set() const{
    return m_product_types_isSet;
}

bool OAIEditorialVideoSearchItem::is_product_types_Valid() const{
    return m_product_types_isValid;
}

QList<OAIReferralDestination> OAIEditorialVideoSearchItem::getReferralDestinations() const {
    return m_referral_destinations;
}
void OAIEditorialVideoSearchItem::setReferralDestinations(const QList<OAIReferralDestination> &referral_destinations) {
    m_referral_destinations = referral_destinations;
    m_referral_destinations_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_referral_destinations_Set() const{
    return m_referral_destinations_isSet;
}

bool OAIEditorialVideoSearchItem::is_referral_destinations_Valid() const{
    return m_referral_destinations_isValid;
}

QString OAIEditorialVideoSearchItem::getShotSpeed() const {
    return m_shot_speed;
}
void OAIEditorialVideoSearchItem::setShotSpeed(const QString &shot_speed) {
    m_shot_speed = shot_speed;
    m_shot_speed_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_shot_speed_Set() const{
    return m_shot_speed_isSet;
}

bool OAIEditorialVideoSearchItem::is_shot_speed_Valid() const{
    return m_shot_speed_isValid;
}

QString OAIEditorialVideoSearchItem::getSource() const {
    return m_source;
}
void OAIEditorialVideoSearchItem::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_source_Set() const{
    return m_source_isSet;
}

bool OAIEditorialVideoSearchItem::is_source_Valid() const{
    return m_source_isValid;
}

QString OAIEditorialVideoSearchItem::getTitle() const {
    return m_title;
}
void OAIEditorialVideoSearchItem::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIEditorialVideoSearchItem::is_title_Set() const{
    return m_title_isSet;
}

bool OAIEditorialVideoSearchItem::is_title_Valid() const{
    return m_title_isValid;
}

bool OAIEditorialVideoSearchItem::isSet() const {
...
bool OAIEditorialVideoSearchItem::isValid() const {
