...
public class Keyword {
  ...
  public static final String SERIALIZED_NAME_ENTITY_URIS = "entity_uris";
  @SerializedName(SERIALIZED_NAME_ENTITY_URIS)
  ...
  public Keyword entityTypes(List<String> entityTypes) {
    this.entityTypes = entityTypes;
    return this;
  }

  public Keyword addEntityTypesItem(String entityTypesItem) {
  ...
  public Keyword entityUris(List<String> entityUris) {
    this.entityUris = entityUris;
    return this;
  }

  public Keyword addEntityUrisItem(String entityUrisItem) {
    if (this.entityUris == null) {
      this.entityUris = new ArrayList<>();
    }
    this.entityUris.add(entityUrisItem);
    return this;
  }
  ...
  public void setEntityUris(List<String> entityUris) {
    this.entityUris = entityUris;
  }
  ...
  public Keyword relevance(Integer relevance) {
  ...
  public Keyword text(String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entityTypes, keyword.entityTypes) &&
        Objects.equals(this.entityUris, keyword.entityUris) &&
        Objects.equals(this.keywordId, keyword.keywordId) &&
        Objects.equals(this.relevance, keyword.relevance) &&
        Objects.equals(this.text, keyword.text) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(entityTypes, entityUris, keywordId, relevance, text, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    entityUris: ").append(toIndentedString(entityUris)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("entity_uris") != null && !jsonObj.get("entity_uris").isJsonNull() && !jsonObj.get("entity_uris").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `entity_uris` to be an array in the JSON string but got `%s`", jsonObj.get("entity_uris").toString()));
      }
      if ((jsonObj.get("keyword_id") != null && !jsonObj.get("keyword_id").isJsonNull()) && !jsonObj.get("keyword_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `keyword_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("keyword_id").toString()));
      }
