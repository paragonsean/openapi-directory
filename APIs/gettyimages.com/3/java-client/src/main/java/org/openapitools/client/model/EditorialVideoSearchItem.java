...
public class EditorialVideoSearchItem {
  ...
  public EditorialVideoSearchItem() {
  }

  public EditorialVideoSearchItem allowedUse(AllowedUse allowedUse) {
  ...
  public EditorialVideoSearchItem artist(String artist) {
    this.artist = artist;
    return this;
  }
  ...
  public EditorialVideoSearchItem assetFamily(String assetFamily) {
  ...
  public EditorialVideoSearchItem caption(String caption) {
  ...
  public EditorialVideoSearchItem clipLength(String clipLength) {
  ...
  public EditorialVideoSearchItem collectionCode(String collectionCode) {
  ...
  public EditorialVideoSearchItem collectionId(Integer collectionId) {
  ...
  public EditorialVideoSearchItem collectionName(String collectionName) {
  ...
  public EditorialVideoSearchItem colorType(String colorType) {
  ...
  public EditorialVideoSearchItem copyright(String copyright) {
  ...
  public EditorialVideoSearchItem dateCreated(OffsetDateTime dateCreated) {
  ...
  public EditorialVideoSearchItem displaySizes(List<VideoSearchItemDisplaySize> displaySizes) {
    this.displaySizes = displaySizes;
    return this;
  }

  public EditorialVideoSearchItem addDisplaySizesItem(VideoSearchItemDisplaySize displaySizesItem) {
  ...
  public EditorialVideoSearchItem downloadProduct(String downloadProduct) {
  ...
  public EditorialVideoSearchItem era(String era) {
    this.era = era;
    return this;
  }
  ...
  public EditorialVideoSearchItem eventIds(List<Integer> eventIds) {
    this.eventIds = eventIds;
    return this;
  }

  public EditorialVideoSearchItem addEventIdsItem(Integer eventIdsItem) {
  ...
  public EditorialVideoSearchItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  public EditorialVideoSearchItem istockLicenses(List<IStockLicense> istockLicenses) {
    this.istockLicenses = istockLicenses;
    return this;
  }

  public EditorialVideoSearchItem addIstockLicensesItem(IStockLicense istockLicensesItem) {
  ...
  public EditorialVideoSearchItem keywords(List<Keyword> keywords) {
    this.keywords = keywords;
    return this;
  }

  public EditorialVideoSearchItem addKeywordsItem(Keyword keywordsItem) {
  ...
  public EditorialVideoSearchItem largestDownloads(List<Download> largestDownloads) {
    this.largestDownloads = largestDownloads;
    return this;
  }

  public EditorialVideoSearchItem addLargestDownloadsItem(Download largestDownloadsItem) {
  ...
  public EditorialVideoSearchItem licenseModel(String licenseModel) {
  ...
  public EditorialVideoSearchItem masteredTo(String masteredTo) {
  ...
  public EditorialVideoSearchItem originallyShotOn(String originallyShotOn) {
  ...
  public EditorialVideoSearchItem productTypes(List<String> productTypes) {
    this.productTypes = productTypes;
    return this;
  }

  public EditorialVideoSearchItem addProductTypesItem(String productTypesItem) {
  ...
  public EditorialVideoSearchItem referralDestinations(List<ReferralDestination> referralDestinations) {
    this.referralDestinations = referralDestinations;
    return this;
  }

  public EditorialVideoSearchItem addReferralDestinationsItem(ReferralDestination referralDestinationsItem) {
  ...
  public EditorialVideoSearchItem shotSpeed(String shotSpeed) {
  ...
  public EditorialVideoSearchItem source(String source) {
    this.source = source;
    return this;
  }
  ...
  public EditorialVideoSearchItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EditorialVideoSearchItem editorialVideoSearchItem = (EditorialVideoSearchItem) o;
    return Objects.equals(this.allowedUse, editorialVideoSearchItem.allowedUse) &&
        Objects.equals(this.artist, editorialVideoSearchItem.artist) &&
        Objects.equals(this.assetFamily, editorialVideoSearchItem.assetFamily) &&
        Objects.equals(this.caption, editorialVideoSearchItem.caption) &&
        Objects.equals(this.clipLength, editorialVideoSearchItem.clipLength) &&
        Objects.equals(this.collectionCode, editorialVideoSearchItem.collectionCode) &&
        Objects.equals(this.collectionId, editorialVideoSearchItem.collectionId) &&
        Objects.equals(this.collectionName, editorialVideoSearchItem.collectionName) &&
        Objects.equals(this.colorType, editorialVideoSearchItem.colorType) &&
        Objects.equals(this.copyright, editorialVideoSearchItem.copyright) &&
        Objects.equals(this.dateCreated, editorialVideoSearchItem.dateCreated) &&
        Objects.equals(this.displaySizes, editorialVideoSearchItem.displaySizes) &&
        Objects.equals(this.downloadProduct, editorialVideoSearchItem.downloadProduct) &&
        Objects.equals(this.era, editorialVideoSearchItem.era) &&
        Objects.equals(this.eventIds, editorialVideoSearchItem.eventIds) &&
        Objects.equals(this.id, editorialVideoSearchItem.id) &&
        Objects.equals(this.istockLicenses, editorialVideoSearchItem.istockLicenses) &&
        Objects.equals(this.keywords, editorialVideoSearchItem.keywords) &&
        Objects.equals(this.largestDownloads, editorialVideoSearchItem.largestDownloads) &&
        Objects.equals(this.licenseModel, editorialVideoSearchItem.licenseModel) &&
        Objects.equals(this.masteredTo, editorialVideoSearchItem.masteredTo) &&
        Objects.equals(this.originallyShotOn, editorialVideoSearchItem.originallyShotOn) &&
        Objects.equals(this.productTypes, editorialVideoSearchItem.productTypes) &&
        Objects.equals(this.referralDestinations, editorialVideoSearchItem.referralDestinations) &&
        Objects.equals(this.shotSpeed, editorialVideoSearchItem.shotSpeed) &&
        Objects.equals(this.source, editorialVideoSearchItem.source) &&
        Objects.equals(this.title, editorialVideoSearchItem.title);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedUse, artist, assetFamily, caption, clipLength, collectionCode, collectionId, collectionName, colorType, copyright, dateCreated, displaySizes, downloadProduct, era, eventIds, id, istockLicenses, keywords, largestDownloads, licenseModel, masteredTo, originallyShotOn, productTypes, referralDestinations, shotSpeed, source, title);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditorialVideoSearchItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EditorialVideoSearchItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EditorialVideoSearchItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EditorialVideoSearchItem is not found in the empty JSON string", EditorialVideoSearchItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EditorialVideoSearchItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EditorialVideoSearchItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EditorialVideoSearchItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EditorialVideoSearchItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EditorialVideoSearchItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EditorialVideoSearchItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EditorialVideoSearchItem>() {
           @Override
           public void write(JsonWriter out, EditorialVideoSearchItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EditorialVideoSearchItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EditorialVideoSearchItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EditorialVideoSearchItem
   * @throws IOException if the JSON string is invalid with respect to EditorialVideoSearchItem
   */
  public static EditorialVideoSearchItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EditorialVideoSearchItem.class);
  }

  /**
   * Convert an instance of EditorialVideoSearchItem to an JSON string
   *
   * @return JSON string
   */
