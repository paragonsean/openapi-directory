...
public class ImageSearchItem {
  ...
  public ImageSearchItem allowedUse(AllowedUse allowedUse) {
  ...
  public ImageSearchItem alternativeIds(Map<String, String> alternativeIds) {
    this.alternativeIds = alternativeIds;
    return this;
  }

  public ImageSearchItem putAlternativeIdsItem(String key, String alternativeIdsItem) {
  ...
  public ImageSearchItem artist(String artist) {
    this.artist = artist;
    return this;
  }
  ...
  public ImageSearchItem assetFamily(String assetFamily) {
  ...
  public ImageSearchItem callForImage(Boolean callForImage) {
  ...
  public ImageSearchItem caption(String caption) {
  ...
  public ImageSearchItem collectionCode(String collectionCode) {
  ...
  public ImageSearchItem collectionId(Integer collectionId) {
  ...
  public ImageSearchItem collectionName(String collectionName) {
  ...
  public ImageSearchItem colorType(String colorType) {
  ...
  public ImageSearchItem copyright(String copyright) {
  ...
  public ImageSearchItem dateCameraShot(OffsetDateTime dateCameraShot) {
  ...
  public ImageSearchItem dateCreated(OffsetDateTime dateCreated) {
  ...
  public ImageSearchItem displaySizes(List<ImageSearchItemDisplaySize> displaySizes) {
    this.displaySizes = displaySizes;
    return this;
  }

  public ImageSearchItem addDisplaySizesItem(ImageSearchItemDisplaySize displaySizesItem) {
  ...
  public ImageSearchItem downloadProduct(String downloadProduct) {
  ...
  public ImageSearchItem editorialSegments(List<String> editorialSegments) {
    this.editorialSegments = editorialSegments;
    return this;
  }

  public ImageSearchItem addEditorialSegmentsItem(String editorialSegmentsItem) {
  ...
  public ImageSearchItem eventIds(List<Integer> eventIds) {
    this.eventIds = eventIds;
    return this;
  }

  public ImageSearchItem addEventIdsItem(Integer eventIdsItem) {
  ...
  public ImageSearchItem graphicalStyle(String graphicalStyle) {
  ...
  public ImageSearchItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ImageSearchItem istockLicenses(List<IStockLicense> istockLicenses) {
    this.istockLicenses = istockLicenses;
    return this;
  }

  public ImageSearchItem addIstockLicensesItem(IStockLicense istockLicensesItem) {
  ...
  public ImageSearchItem keywords(List<Keyword> keywords) {
    this.keywords = keywords;
    return this;
  }

  public ImageSearchItem addKeywordsItem(Keyword keywordsItem) {
  ...
  public ImageSearchItem largestDownloads(List<Download> largestDownloads) {
    this.largestDownloads = largestDownloads;
    return this;
  }

  public ImageSearchItem addLargestDownloadsItem(Download largestDownloadsItem) {
  ...
  public ImageSearchItem licenseModel(String licenseModel) {
  ...
  public ImageSearchItem maxDimensions(MaxDimensions maxDimensions) {
  ...
  public ImageSearchItem orientation(String orientation) {
  ...
  public ImageSearchItem people(List<String> people) {
    this.people = people;
    return this;
  }

  public ImageSearchItem addPeopleItem(String peopleItem) {
    if (this.people == null) {
  ...
  public ImageSearchItem productTypes(List<String> productTypes) {
    this.productTypes = productTypes;
    return this;
  }

  public ImageSearchItem addProductTypesItem(String productTypesItem) {
  ...
  public ImageSearchItem qualityRank(Integer qualityRank) {
  ...
  public ImageSearchItem referralDestinations(List<ReferralDestination> referralDestinations) {
    this.referralDestinations = referralDestinations;
    return this;
  }

  public ImageSearchItem addReferralDestinationsItem(ReferralDestination referralDestinationsItem) {
  ...
  public ImageSearchItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ImageSearchItem uriOembed(String uriOembed) {
  ...
  public boolean equals(Object o) {
    ...
    ImageSearchItem imageSearchItem = (ImageSearchItem) o;
    return Objects.equals(this.allowedUse, imageSearchItem.allowedUse) &&
        Objects.equals(this.alternativeIds, imageSearchItem.alternativeIds) &&
        Objects.equals(this.artist, imageSearchItem.artist) &&
        Objects.equals(this.assetFamily, imageSearchItem.assetFamily) &&
        Objects.equals(this.callForImage, imageSearchItem.callForImage) &&
        Objects.equals(this.caption, imageSearchItem.caption) &&
        Objects.equals(this.collectionCode, imageSearchItem.collectionCode) &&
        Objects.equals(this.collectionId, imageSearchItem.collectionId) &&
        Objects.equals(this.collectionName, imageSearchItem.collectionName) &&
        Objects.equals(this.colorType, imageSearchItem.colorType) &&
        Objects.equals(this.copyright, imageSearchItem.copyright) &&
        Objects.equals(this.dateCameraShot, imageSearchItem.dateCameraShot) &&
        Objects.equals(this.dateCreated, imageSearchItem.dateCreated) &&
        Objects.equals(this.displaySizes, imageSearchItem.displaySizes) &&
        Objects.equals(this.downloadProduct, imageSearchItem.downloadProduct) &&
        Objects.equals(this.editorialSegments, imageSearchItem.editorialSegments) &&
        Objects.equals(this.eventIds, imageSearchItem.eventIds) &&
        Objects.equals(this.graphicalStyle, imageSearchItem.graphicalStyle) &&
        Objects.equals(this.id, imageSearchItem.id) &&
        Objects.equals(this.istockLicenses, imageSearchItem.istockLicenses) &&
        Objects.equals(this.keywords, imageSearchItem.keywords) &&
        Objects.equals(this.largestDownloads, imageSearchItem.largestDownloads) &&
        Objects.equals(this.licenseModel, imageSearchItem.licenseModel) &&
        Objects.equals(this.maxDimensions, imageSearchItem.maxDimensions) &&
        Objects.equals(this.orientation, imageSearchItem.orientation) &&
        Objects.equals(this.people, imageSearchItem.people) &&
        Objects.equals(this.productTypes, imageSearchItem.productTypes) &&
        Objects.equals(this.qualityRank, imageSearchItem.qualityRank) &&
        Objects.equals(this.referralDestinations, imageSearchItem.referralDestinations) &&
        Objects.equals(this.title, imageSearchItem.title) &&
        Objects.equals(this.uriOembed, imageSearchItem.uriOembed);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedUse, alternativeIds, artist, assetFamily, callForImage, caption, collectionCode, collectionId, collectionName, colorType, copyright, dateCameraShot, dateCreated, displaySizes, downloadProduct, editorialSegments, eventIds, graphicalStyle, id, istockLicenses, keywords, largestDownloads, licenseModel, maxDimensions, orientation, people, productTypes, qualityRank, referralDestinations, title, uriOembed);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageSearchItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImageSearchItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImageSearchItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageSearchItem is not found in the empty JSON string", ImageSearchItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImageSearchItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ImageSearchItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageSearchItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageSearchItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageSearchItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageSearchItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageSearchItem>() {
           @Override
           public void write(JsonWriter out, ImageSearchItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImageSearchItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImageSearchItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImageSearchItem
   * @throws IOException if the JSON string is invalid with respect to ImageSearchItem
   */
  public static ImageSearchItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageSearchItem.class);
  }

  /**
   * Convert an instance of ImageSearchItem to an JSON string
   *
   * @return JSON string
   */
