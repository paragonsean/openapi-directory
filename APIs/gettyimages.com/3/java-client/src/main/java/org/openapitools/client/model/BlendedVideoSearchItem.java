...
public class BlendedVideoSearchItem {
  ...
  public BlendedVideoSearchItem() {
  }

  public BlendedVideoSearchItem allowedUse(AllowedUse allowedUse) {
  ...
  public BlendedVideoSearchItem artist(String artist) {
    this.artist = artist;
    return this;
  }
  ...
  public BlendedVideoSearchItem assetFamily(String assetFamily) {
  ...
  public BlendedVideoSearchItem caption(String caption) {
  ...
  public BlendedVideoSearchItem clipLength(String clipLength) {
  ...
  public BlendedVideoSearchItem collectionCode(String collectionCode) {
  ...
  public BlendedVideoSearchItem collectionId(Integer collectionId) {
  ...
  public BlendedVideoSearchItem collectionName(String collectionName) {
  ...
  public BlendedVideoSearchItem colorType(String colorType) {
  ...
  public BlendedVideoSearchItem copyright(String copyright) {
  ...
  public BlendedVideoSearchItem dateCreated(OffsetDateTime dateCreated) {
  ...
  public BlendedVideoSearchItem displaySizes(List<VideoSearchItemDisplaySize> displaySizes) {
    this.displaySizes = displaySizes;
    return this;
  }

  public BlendedVideoSearchItem addDisplaySizesItem(VideoSearchItemDisplaySize displaySizesItem) {
  ...
  public BlendedVideoSearchItem downloadProduct(String downloadProduct) {
  ...
  public BlendedVideoSearchItem era(String era) {
    this.era = era;
    return this;
  }
  ...
  public BlendedVideoSearchItem eventIds(List<Integer> eventIds) {
    this.eventIds = eventIds;
    return this;
  }

  public BlendedVideoSearchItem addEventIdsItem(Integer eventIdsItem) {
  ...
  public BlendedVideoSearchItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  public BlendedVideoSearchItem istockLicenses(List<IStockLicense> istockLicenses) {
    this.istockLicenses = istockLicenses;
    return this;
  }

  public BlendedVideoSearchItem addIstockLicensesItem(IStockLicense istockLicensesItem) {
  ...
  public BlendedVideoSearchItem keywords(List<Keyword> keywords) {
    this.keywords = keywords;
    return this;
  }

  public BlendedVideoSearchItem addKeywordsItem(Keyword keywordsItem) {
  ...
  public BlendedVideoSearchItem largestDownloads(List<Download> largestDownloads) {
    this.largestDownloads = largestDownloads;
    return this;
  }

  public BlendedVideoSearchItem addLargestDownloadsItem(Download largestDownloadsItem) {
  ...
  public BlendedVideoSearchItem licenseModel(String licenseModel) {
  ...
  public BlendedVideoSearchItem masteredTo(String masteredTo) {
  ...
  public BlendedVideoSearchItem originallyShotOn(String originallyShotOn) {
  ...
  public BlendedVideoSearchItem productTypes(List<String> productTypes) {
    this.productTypes = productTypes;
    return this;
  }

  public BlendedVideoSearchItem addProductTypesItem(String productTypesItem) {
  ...
  public BlendedVideoSearchItem referralDestinations(List<ReferralDestination> referralDestinations) {
    this.referralDestinations = referralDestinations;
    return this;
  }

  public BlendedVideoSearchItem addReferralDestinationsItem(ReferralDestination referralDestinationsItem) {
  ...
  public BlendedVideoSearchItem shotSpeed(String shotSpeed) {
  ...
  public BlendedVideoSearchItem source(String source) {
    this.source = source;
    return this;
  }
  ...
  public BlendedVideoSearchItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BlendedVideoSearchItem blendedVideoSearchItem = (BlendedVideoSearchItem) o;
    return Objects.equals(this.allowedUse, blendedVideoSearchItem.allowedUse) &&
        Objects.equals(this.artist, blendedVideoSearchItem.artist) &&
        Objects.equals(this.assetFamily, blendedVideoSearchItem.assetFamily) &&
        Objects.equals(this.caption, blendedVideoSearchItem.caption) &&
        Objects.equals(this.clipLength, blendedVideoSearchItem.clipLength) &&
        Objects.equals(this.collectionCode, blendedVideoSearchItem.collectionCode) &&
        Objects.equals(this.collectionId, blendedVideoSearchItem.collectionId) &&
        Objects.equals(this.collectionName, blendedVideoSearchItem.collectionName) &&
        Objects.equals(this.colorType, blendedVideoSearchItem.colorType) &&
        Objects.equals(this.copyright, blendedVideoSearchItem.copyright) &&
        Objects.equals(this.dateCreated, blendedVideoSearchItem.dateCreated) &&
        Objects.equals(this.displaySizes, blendedVideoSearchItem.displaySizes) &&
        Objects.equals(this.downloadProduct, blendedVideoSearchItem.downloadProduct) &&
        Objects.equals(this.era, blendedVideoSearchItem.era) &&
        Objects.equals(this.eventIds, blendedVideoSearchItem.eventIds) &&
        Objects.equals(this.id, blendedVideoSearchItem.id) &&
        Objects.equals(this.istockLicenses, blendedVideoSearchItem.istockLicenses) &&
        Objects.equals(this.keywords, blendedVideoSearchItem.keywords) &&
        Objects.equals(this.largestDownloads, blendedVideoSearchItem.largestDownloads) &&
        Objects.equals(this.licenseModel, blendedVideoSearchItem.licenseModel) &&
        Objects.equals(this.masteredTo, blendedVideoSearchItem.masteredTo) &&
        Objects.equals(this.originallyShotOn, blendedVideoSearchItem.originallyShotOn) &&
        Objects.equals(this.productTypes, blendedVideoSearchItem.productTypes) &&
        Objects.equals(this.referralDestinations, blendedVideoSearchItem.referralDestinations) &&
        Objects.equals(this.shotSpeed, blendedVideoSearchItem.shotSpeed) &&
        Objects.equals(this.source, blendedVideoSearchItem.source) &&
        Objects.equals(this.title, blendedVideoSearchItem.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlendedVideoSearchItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BlendedVideoSearchItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BlendedVideoSearchItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BlendedVideoSearchItem is not found in the empty JSON string", BlendedVideoSearchItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BlendedVideoSearchItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BlendedVideoSearchItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BlendedVideoSearchItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BlendedVideoSearchItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BlendedVideoSearchItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BlendedVideoSearchItem.class));

       return (TypeAdapter<T>) new TypeAdapter<BlendedVideoSearchItem>() {
           @Override
           public void write(JsonWriter out, BlendedVideoSearchItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BlendedVideoSearchItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BlendedVideoSearchItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BlendedVideoSearchItem
   * @throws IOException if the JSON string is invalid with respect to BlendedVideoSearchItem
   */
  public static BlendedVideoSearchItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BlendedVideoSearchItem.class);
  }

  /**
   * Convert an instance of BlendedVideoSearchItem to an JSON string
   *
   * @return JSON string
   */
