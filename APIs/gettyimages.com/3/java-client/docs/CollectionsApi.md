...
<a id="v3CollectionsGet"></a>
# **v3CollectionsGet**
> CollectionsList v3CollectionsGet(acceptLanguage)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CollectionsList result = apiInstance.v3CollectionsGet(acceptLanguage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CollectionsApi#v3CollectionsGet");
