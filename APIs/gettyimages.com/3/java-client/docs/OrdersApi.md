...
<a id="v3OrdersIdGet"></a>
# **v3OrdersIdGet**
> OrderDetail v3OrdersIdGet(id, acceptLanguage)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer id = 56; // Integer | An order id.
    ...
    try {
      OrderDetail result = apiInstance.v3OrdersIdGet(id, acceptLanguage);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrdersApi#v3OrdersIdGet");
