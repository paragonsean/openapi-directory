...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.MetadataApi();
  });
  ...
  describe('MetadataApi', function() {
    describe('cwaRestServicesMetadataGet', function() {
      it('should call cwaRestServicesMetadataGet successfully', function(done) {
        //uncomment below and update the code to test cwaRestServicesMetadataGet
        //instance.cwaRestServicesMetadataGet(function(error) {
    ...
    describe('cwaRestServicesMetadataPost', function() {
      it('should call cwaRestServicesMetadataPost successfully', function(done) {
        //uncomment below and update the code to test cwaRestServicesMetadataPost
        //instance.cwaRestServicesMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
