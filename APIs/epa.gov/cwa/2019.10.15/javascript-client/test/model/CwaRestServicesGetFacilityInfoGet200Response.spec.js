...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetFacilityInfoGet200Response();
  });
  ...
  describe('CwaRestServicesGetFacilityInfoGet200Response', function() {
    it('should create an instance of CwaRestServicesGetFacilityInfoGet200Response', function() {
      // uncomment below and update the code to test CwaRestServicesGetFacilityInfoGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetFacilityInfoGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetFacilityInfoGet200Response);
    });
