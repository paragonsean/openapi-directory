...
(function(root, factory) {
  ...
  describe('FormDataFPUsmex', function() {
    it('should create an instance of FormDataFPUsmex', function() {
      // uncomment below and update the code to test FormDataFPUsmex
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPUsmex();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPUsmex);
    });
