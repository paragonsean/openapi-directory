...
(function(root, factory) {
  ...
  describe('FormDataFPYsla', function() {
    it('should create an instance of FormDataFPYsla', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPYsla();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPYsla);
    });
