...
(function(root, factory) {
  ...
  describe('FormDataFPOwop', function() {
    it('should create an instance of FormDataFPOwop', function() {
      // uncomment below and update the code to test FormDataFPOwop
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPOwop();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPOwop);
    });
