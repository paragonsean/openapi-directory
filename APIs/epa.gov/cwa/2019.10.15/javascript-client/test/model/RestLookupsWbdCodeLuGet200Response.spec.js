...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsWbdCodeLuGet200Response();
  });
  ...
  describe('RestLookupsWbdCodeLuGet200Response', function() {
    it('should create an instance of RestLookupsWbdCodeLuGet200Response', function() {
      // uncomment below and update the code to test RestLookupsWbdCodeLuGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsWbdCodeLuGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsWbdCodeLuGet200Response);
    });
