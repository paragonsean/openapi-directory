...
(function(root, factory) {
  ...
  describe('FormDataFPPt', function() {
    it('should create an instance of FormDataFPPt', function() {
      // uncomment below and update the code to test FormDataFPPt
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPt);
    });
