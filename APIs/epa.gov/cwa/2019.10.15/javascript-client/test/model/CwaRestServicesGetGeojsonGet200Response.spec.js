...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetGeojsonGet200Response();
  });
  ...
  describe('CwaRestServicesGetGeojsonGet200Response', function() {
    it('should create an instance of CwaRestServicesGetGeojsonGet200Response', function() {
      // uncomment below and update the code to test CwaRestServicesGetGeojsonGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetGeojsonGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetGeojsonGet200Response);
    });
