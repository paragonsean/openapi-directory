...
(function(root, factory) {
  ...
  describe('FormDataFPFntype', function() {
    it('should create an instance of FormDataFPFntype', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFntype();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFntype);
    });
