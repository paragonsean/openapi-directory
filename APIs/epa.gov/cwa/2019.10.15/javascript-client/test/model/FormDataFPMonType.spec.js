...
(function(root, factory) {
  ...
  describe('FormDataFPMonType', function() {
    it('should create an instance of FormDataFPMonType', function() {
      // uncomment below and update the code to test FormDataFPMonType
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMonType();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMonType);
    });
