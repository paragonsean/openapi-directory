...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Cwa13();
  });
  ...
  describe('Cwa13', function() {
    it('should create an instance of Cwa13', function() {
      // uncomment below and update the code to test Cwa13
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Cwa13();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Cwa13);
    });
