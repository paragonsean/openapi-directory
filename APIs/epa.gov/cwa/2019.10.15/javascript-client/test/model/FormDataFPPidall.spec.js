...
(function(root, factory) {
  ...
  describe('FormDataFPPidall', function() {
    it('should create an instance of FormDataFPPidall', function() {
      // uncomment below and update the code to test FormDataFPPidall
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPidall();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPidall);
    });
