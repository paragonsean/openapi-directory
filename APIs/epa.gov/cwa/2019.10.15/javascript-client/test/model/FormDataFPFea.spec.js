...
(function(root, factory) {
  ...
  describe('FormDataFPFea', function() {
    it('should create an instance of FormDataFPFea', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFea();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFea);
    });
