...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsNaicsCodesGet200Response();
  });
  ...
  describe('RestLookupsNaicsCodesGet200Response', function() {
    it('should create an instance of RestLookupsNaicsCodesGet200Response', function() {
      // uncomment below and update the code to test RestLookupsNaicsCodesGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsNaicsCodesGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsNaicsCodesGet200Response);
    });
