...
(function(root, factory) {
  ...
  describe('FormDataFPPswvio', function() {
    it('should create an instance of FormDataFPPswvio', function() {
      // uncomment below and update the code to test FormDataFPPswvio
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPswvio();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPswvio);
    });
