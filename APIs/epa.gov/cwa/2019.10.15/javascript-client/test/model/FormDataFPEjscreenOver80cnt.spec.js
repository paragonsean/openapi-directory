...
(function(root, factory) {
  ...
  describe('FormDataFPEjscreenOver80cnt', function() {
    it('should create an instance of FormDataFPEjscreenOver80cnt', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPEjscreenOver80cnt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPEjscreenOver80cnt);
    });
