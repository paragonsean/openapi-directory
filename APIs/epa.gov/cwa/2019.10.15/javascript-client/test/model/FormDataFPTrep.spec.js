...
(function(root, factory) {
  ...
  describe('FormDataFPTrep', function() {
    it('should create an instance of FormDataFPTrep', function() {
      // uncomment below and update the code to test FormDataFPTrep
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPTrep();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPTrep);
    });
