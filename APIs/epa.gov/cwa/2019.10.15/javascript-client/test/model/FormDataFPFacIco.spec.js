...
(function(root, factory) {
  ...
  describe('FormDataFPFacIco', function() {
    it('should create an instance of FormDataFPFacIco', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFacIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFacIco);
    });
