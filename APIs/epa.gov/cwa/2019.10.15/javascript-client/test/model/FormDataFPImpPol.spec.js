...
(function(root, factory) {
  ...
  describe('FormDataFPImpPol', function() {
    it('should create an instance of FormDataFPImpPol', function() {
      // uncomment below and update the code to test FormDataFPImpPol
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPImpPol();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPImpPol);
    });
