...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsIcisLawSectionsGet200Response();
  });
  ...
  describe('RestLookupsIcisLawSectionsGet200Response', function() {
    it('should create an instance of RestLookupsIcisLawSectionsGet200Response', function() {
      // uncomment below and update the code to test RestLookupsIcisLawSectionsGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsIcisLawSectionsGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsIcisLawSectionsGet200Response);
    });
