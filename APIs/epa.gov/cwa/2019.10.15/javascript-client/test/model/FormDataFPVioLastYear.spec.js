...
(function(root, factory) {
  ...
  describe('FormDataFPVioLastYear', function() {
    it('should create an instance of FormDataFPVioLastYear', function() {
      // uncomment below and update the code to test FormDataFPVioLastYear
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPVioLastYear();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPVioLastYear);
    });
