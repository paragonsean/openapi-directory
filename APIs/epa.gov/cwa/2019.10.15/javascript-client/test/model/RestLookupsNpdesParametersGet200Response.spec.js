...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsNpdesParametersGet200Response();
  });
  ...
  describe('RestLookupsNpdesParametersGet200Response', function() {
    it('should create an instance of RestLookupsNpdesParametersGet200Response', function() {
      // uncomment below and update the code to test RestLookupsNpdesParametersGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsNpdesParametersGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsNpdesParametersGet200Response);
    });
