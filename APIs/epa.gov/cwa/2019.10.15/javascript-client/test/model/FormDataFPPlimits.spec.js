...
(function(root, factory) {
  ...
  describe('FormDataFPPlimits', function() {
    it('should create an instance of FormDataFPPlimits', function() {
      // uncomment below and update the code to test FormDataFPPlimits
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPlimits();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPlimits);
    });
