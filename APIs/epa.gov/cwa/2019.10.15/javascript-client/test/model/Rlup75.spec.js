...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup75();
  });
  ...
  describe('Rlup75', function() {
    it('should create an instance of Rlup75', function() {
      // uncomment below and update the code to test Rlup75
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup75();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup75);
    });
