...
(function(root, factory) {
  ...
  describe('FormDataFPPdwdist', function() {
    it('should create an instance of FormDataFPPdwdist', function() {
      // uncomment below and update the code to test FormDataFPPdwdist
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPdwdist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPdwdist);
    });
