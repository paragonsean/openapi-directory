...
(function(root, factory) {
  ...
  describe('FormDataFPFf', function() {
    it('should create an instance of FormDataFPFf', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFf();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPFf);
    });
