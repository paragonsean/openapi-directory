...
(function(root, factory) {
  ...
  describe('FormDataFPBioVioLastYear', function() {
    it('should create an instance of FormDataFPBioVioLastYear', function() {
      // uncomment below and update the code to test FormDataFPBioVioLastYear
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPBioVioLastYear();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPBioVioLastYear);
    });
