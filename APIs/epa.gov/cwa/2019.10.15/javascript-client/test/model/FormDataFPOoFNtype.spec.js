...
(function(root, factory) {
  ...
  describe('FormDataFPOoFNtype', function() {
    it('should create an instance of FormDataFPOoFNtype', function() {
      // uncomment below and update the code to test FormDataFPOoFNtype
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPOoFNtype();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPOoFNtype);
    });
