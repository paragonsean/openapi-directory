...
(function(root, factory) {
  ...
  describe('FormDataFPLastDmrWithin', function() {
    it('should create an instance of FormDataFPLastDmrWithin', function() {
      // uncomment below and update the code to test FormDataFPLastDmrWithin
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPLastDmrWithin();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPLastDmrWithin);
    });
