...
(function(root, factory) {
  ...
  describe('FormDataFPMaj', function() {
    it('should create an instance of FormDataFPMaj', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMaj();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMaj);
    });
