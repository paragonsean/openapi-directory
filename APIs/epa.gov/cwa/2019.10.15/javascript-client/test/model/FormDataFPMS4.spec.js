...
(function(root, factory) {
  ...
  describe('FormDataFPMS4', function() {
    it('should create an instance of FormDataFPMS4', function() {
      // uncomment below and update the code to test FormDataFPMS4
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMS4();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMS4);
    });
