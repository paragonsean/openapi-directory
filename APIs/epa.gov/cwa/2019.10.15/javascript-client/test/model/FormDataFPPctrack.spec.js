...
(function(root, factory) {
  ...
  describe('FormDataFPPctrack', function() {
    it('should create an instance of FormDataFPPctrack', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPctrack();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPctrack);
    });
