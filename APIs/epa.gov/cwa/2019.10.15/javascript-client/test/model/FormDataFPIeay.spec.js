...
(function(root, factory) {
  ...
  describe('FormDataFPIeay', function() {
    it('should create an instance of FormDataFPIeay', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPIeay();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPIeay);
    });
