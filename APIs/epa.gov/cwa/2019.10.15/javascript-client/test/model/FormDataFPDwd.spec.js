...
(function(root, factory) {
  ...
  describe('FormDataFPDwd', function() {
    it('should create an instance of FormDataFPDwd', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPDwd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPDwd);
    });
