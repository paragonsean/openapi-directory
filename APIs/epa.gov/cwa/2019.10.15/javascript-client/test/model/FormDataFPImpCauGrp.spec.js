...
(function(root, factory) {
  ...
  describe('FormDataFPImpCauGrp', function() {
    it('should create an instance of FormDataFPImpCauGrp', function() {
      // uncomment below and update the code to test FormDataFPImpCauGrp
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPImpCauGrp();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPImpCauGrp);
    });
