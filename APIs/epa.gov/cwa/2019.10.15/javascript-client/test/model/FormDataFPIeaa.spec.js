...
(function(root, factory) {
  ...
  describe('FormDataFPIeaa', function() {
    it('should create an instance of FormDataFPIeaa', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPIeaa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPIeaa);
    });
