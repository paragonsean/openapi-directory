...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Qp0();
  });
  ...
  describe('Qp0', function() {
    it('should create an instance of Qp0', function() {
      // uncomment below and update the code to test Qp0
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Qp0();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Qp0);
    });

    it('should have the property QP (base name: "QP")', function() {
      // uncomment below and update the code to test the property QP
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Qp0();
      //expect(instance).to.be();
    });

    it('should have the property QV (base name: "QV")', function() {
      // uncomment below and update the code to test the property QV
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Qp0();
      //expect(instance).to.be();
    });
