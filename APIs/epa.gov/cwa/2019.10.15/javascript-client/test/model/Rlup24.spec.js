...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup24();
  });
  ...
  describe('Rlup24', function() {
    it('should create an instance of Rlup24', function() {
      // uncomment below and update the code to test Rlup24
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup24();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup24);
    });

    it('should have the property luValues (base name: "LuValues")', function() {
      // uncomment below and update the code to test the property luValues
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup24();
