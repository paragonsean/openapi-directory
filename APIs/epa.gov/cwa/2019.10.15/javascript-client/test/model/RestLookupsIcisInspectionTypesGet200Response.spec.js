...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsIcisInspectionTypesGet200Response();
  });
  ...
  describe('RestLookupsIcisInspectionTypesGet200Response', function() {
    it('should create an instance of RestLookupsIcisInspectionTypesGet200Response', function() {
      // uncomment below and update the code to test RestLookupsIcisInspectionTypesGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsIcisInspectionTypesGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsIcisInspectionTypesGet200Response);
    });
