...
(function(root, factory) {
  ...
  describe('FormDataFPLimitAddr', function() {
    it('should create an instance of FormDataFPLimitAddr', function() {
      // uncomment below and update the code to test FormDataFPLimitAddr
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPLimitAddr();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPLimitAddr);
    });
