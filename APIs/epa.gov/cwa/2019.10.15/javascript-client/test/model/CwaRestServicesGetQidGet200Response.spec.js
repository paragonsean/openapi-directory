...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetQidGet200Response();
  });
  ...
  describe('CwaRestServicesGetQidGet200Response', function() {
    it('should create an instance of CwaRestServicesGetQidGet200Response', function() {
      // uncomment below and update the code to test CwaRestServicesGetQidGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetQidGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetQidGet200Response);
    });
