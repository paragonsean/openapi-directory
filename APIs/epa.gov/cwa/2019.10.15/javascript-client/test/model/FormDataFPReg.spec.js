...
(function(root, factory) {
  ...
  describe('FormDataFPReg', function() {
    it('should create an instance of FormDataFPReg', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPReg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPReg);
    });
