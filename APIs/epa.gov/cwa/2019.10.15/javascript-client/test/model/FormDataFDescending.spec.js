...
(function(root, factory) {
  ...
  describe('FormDataFDescending', function() {
    it('should create an instance of FormDataFDescending', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFDescending();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFDescending);
    });
