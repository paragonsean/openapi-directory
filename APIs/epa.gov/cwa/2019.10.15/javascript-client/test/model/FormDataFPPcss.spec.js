...
(function(root, factory) {
  ...
  describe('FormDataFPPcss', function() {
    it('should create an instance of FormDataFPPcss', function() {
      // uncomment below and update the code to test FormDataFPPcss
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPcss();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPcss);
    });
