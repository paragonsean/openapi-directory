...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup59();
  });
  ...
  describe('Rlup59', function() {
    it('should create an instance of Rlup59', function() {
      // uncomment below and update the code to test Rlup59
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup59();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup59);
    });
