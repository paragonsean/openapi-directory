...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsCwaPollutantsGet200Response();
  });
  ...
  describe('RestLookupsCwaPollutantsGet200Response', function() {
    it('should create an instance of RestLookupsCwaPollutantsGet200Response', function() {
      // uncomment below and update the code to test RestLookupsCwaPollutantsGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsCwaPollutantsGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsCwaPollutantsGet200Response);
    });
