...
(function(root, factory) {
  ...
  describe('FormDataFPYsl', function() {
    it('should create an instance of FormDataFPYsl', function() {
      // uncomment below and update the code to test FormDataFPYsl
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPYsl();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPYsl);
    });
