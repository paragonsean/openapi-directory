...
(function(root, factory) {
  ...
  describe('FormDataFPAgoo', function() {
    it('should create an instance of FormDataFPAgoo', function() {
      // uncomment below and update the code to test FormDataFPAgoo
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPAgoo();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPAgoo);
    });
