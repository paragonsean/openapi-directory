...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesMetadataGet200Response();
  });
  ...
  describe('CwaRestServicesMetadataGet200Response', function() {
    it('should create an instance of CwaRestServicesMetadataGet200Response', function() {
      // uncomment below and update the code to test CwaRestServicesMetadataGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesMetadataGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesMetadataGet200Response);
    });
