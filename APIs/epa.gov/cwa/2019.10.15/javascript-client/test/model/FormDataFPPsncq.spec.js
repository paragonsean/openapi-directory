...
(function(root, factory) {
  ...
  describe('FormDataFPPsncq', function() {
    it('should create an instance of FormDataFPPsncq', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPsncq();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPsncq);
    });
