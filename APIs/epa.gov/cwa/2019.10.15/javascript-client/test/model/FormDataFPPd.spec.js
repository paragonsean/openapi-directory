...
(function(root, factory) {
  ...
  describe('FormDataFPPd', function() {
    it('should create an instance of FormDataFPPd', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPd);
    });
