...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsCwaParametersGet200Response();
  });
  ...
  describe('RestLookupsCwaParametersGet200Response', function() {
    it('should create an instance of RestLookupsCwaParametersGet200Response', function() {
      // uncomment below and update the code to test RestLookupsCwaParametersGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsCwaParametersGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsCwaParametersGet200Response);
    });
