...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsWbdNameLuGet200Response();
  });
  ...
  describe('RestLookupsWbdNameLuGet200Response', function() {
    it('should create an instance of RestLookupsWbdNameLuGet200Response', function() {
      // uncomment below and update the code to test RestLookupsWbdNameLuGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsWbdNameLuGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsWbdNameLuGet200Response);
    });
