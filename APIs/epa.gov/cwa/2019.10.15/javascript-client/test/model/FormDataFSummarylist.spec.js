...
(function(root, factory) {
  ...
  describe('FormDataFSummarylist', function() {
    it('should create an instance of FormDataFSummarylist', function() {
      // uncomment below and update the code to test FormDataFSummarylist
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFSummarylist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFSummarylist);
    });
