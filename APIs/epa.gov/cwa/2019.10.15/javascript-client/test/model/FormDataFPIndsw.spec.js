...
(function(root, factory) {
  ...
  describe('FormDataFPIndsw', function() {
    it('should create an instance of FormDataFPIndsw', function() {
      // uncomment below and update the code to test FormDataFPIndsw
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPIndsw();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPIndsw);
    });
