...
(function(root, factory) {
  ...
  describe('FormDataFTablelist', function() {
    it('should create an instance of FormDataFTablelist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFTablelist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFTablelist);
    });
