...
(function(root, factory) {
  ...
  describe('FormDataFPPswdmp', function() {
    it('should create an instance of FormDataFPPswdmp', function() {
      // uncomment below and update the code to test FormDataFPPswdmp
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPswdmp();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPswdmp);
    });
