...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetFacilitiesGet200Response();
  });
  ...
  describe('CwaRestServicesGetFacilitiesGet200Response', function() {
    it('should create an instance of CwaRestServicesGetFacilitiesGet200Response', function() {
      // uncomment below and update the code to test CwaRestServicesGetFacilitiesGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetFacilitiesGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.CwaRestServicesGetFacilitiesGet200Response);
    });
