...
(function(root, factory) {
  ...
  describe('FormDataFPPexcd', function() {
    it('should create an instance of FormDataFPPexcd', function() {
      // uncomment below and update the code to test FormDataFPPexcd
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPexcd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPexcd);
    });
