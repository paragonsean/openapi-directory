...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup01();
  });
  ...
  describe('Rlup01', function() {
    it('should create an instance of Rlup01', function() {
      // uncomment below and update the code to test Rlup01
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup01();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.Rlup01);
    });

    it('should have the property valueCode (base name: "ValueCode")', function() {
