...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsBpTribesGet200Response();
  });
  ...
  describe('RestLookupsBpTribesGet200Response', function() {
    it('should create an instance of RestLookupsBpTribesGet200Response', function() {
      // uncomment below and update the code to test RestLookupsBpTribesGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsBpTribesGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.RestLookupsBpTribesGet200Response);
    });
