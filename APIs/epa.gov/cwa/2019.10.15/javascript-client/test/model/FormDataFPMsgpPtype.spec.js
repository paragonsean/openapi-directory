...
(function(root, factory) {
  ...
  describe('FormDataFPMsgpPtype', function() {
    it('should create an instance of FormDataFPMsgpPtype', function() {
      // uncomment below and update the code to test FormDataFPMsgpPtype
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMsgpPtype();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPMsgpPtype);
    });
