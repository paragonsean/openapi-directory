...
(function(root, factory) {
  ...
  describe('FormDataFPImpw', function() {
    it('should create an instance of FormDataFPImpw', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPImpw();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPImpw);
    });
