...
(function(root, factory) {
  ...
  describe('FormDataFPPexp', function() {
    it('should create an instance of FormDataFPPexp', function() {
      // uncomment below and update the code to test FormDataFPPexp
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPexp();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPPexp);
    });
