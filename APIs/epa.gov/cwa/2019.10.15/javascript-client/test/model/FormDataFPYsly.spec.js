...
(function(root, factory) {
  ...
  describe('FormDataFPYsly', function() {
    it('should create an instance of FormDataFPYsly', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPYsly();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanWaterActCwaRestServices.FormDataFPYsly);
    });
