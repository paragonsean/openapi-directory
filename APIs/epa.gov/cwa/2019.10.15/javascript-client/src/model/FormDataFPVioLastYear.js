...
/**
* Enum class FormDataFPVioLastYear.
* @enum {}
* @readonly
*/
export default class FormDataFPVioLastYear {
    ...
    /**
    * Returns a <code>FormDataFPVioLastYear</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPVioLastYear} The enum <code>FormDataFPVioLastYear</code> value.
    */
