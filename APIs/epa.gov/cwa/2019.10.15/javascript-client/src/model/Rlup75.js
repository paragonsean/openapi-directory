...
/**
 * The Rlup75 model module.
 * @module model/Rlup75
 * @version 2019.10.15
 */
class Rlup75 {
    /**
     * Constructs a new <code>Rlup75</code>.
     * Results Object
     * @alias module:model/Rlup75
     * @param message {String} Field to record messages (typically performance-related) about packet processing
     */
    constructor(message) { 
        
        Rlup75.initialize(this, message);
    }
    ...
    /**
     * Constructs a <code>Rlup75</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rlup75} obj Optional instance to populate.
     * @return {module:model/Rlup75} The populated <code>Rlup75</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Rlup75</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rlup75</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rlup75.RequiredProperties) {
