...
/**
* Enum class FormDataFPPsncq.
* @enum {}
* @readonly
*/
export default class FormDataFPPsncq {
    ...
    /**
    * Returns a <code>FormDataFPPsncq</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPsncq} The enum <code>FormDataFPPsncq</code> value.
    */
