...
/**
* Enum class FormDataFPLastDmrWithin.
* @enum {}
* @readonly
*/
export default class FormDataFPLastDmrWithin {
    ...
    /**
    * Returns a <code>FormDataFPLastDmrWithin</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPLastDmrWithin} The enum <code>FormDataFPLastDmrWithin</code> value.
    */
