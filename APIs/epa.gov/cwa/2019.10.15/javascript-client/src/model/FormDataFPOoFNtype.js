...
/**
* Enum class FormDataFPOoFNtype.
* @enum {}
* @readonly
*/
export default class FormDataFPOoFNtype {
    ...
    /**
    * Returns a <code>FormDataFPOoFNtype</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPOoFNtype} The enum <code>FormDataFPOoFNtype</code> value.
    */
