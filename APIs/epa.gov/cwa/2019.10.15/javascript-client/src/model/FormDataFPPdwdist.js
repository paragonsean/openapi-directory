...
/**
* Enum class FormDataFPPdwdist.
* @enum {}
* @readonly
*/
export default class FormDataFPPdwdist {
    ...
    /**
    * Returns a <code>FormDataFPPdwdist</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPdwdist} The enum <code>FormDataFPPdwdist</code> value.
    */
