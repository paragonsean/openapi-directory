...
/**
* Enum class FormDataFPYsla.
* @enum {}
* @readonly
*/
export default class FormDataFPYsla {
    ...
    /**
    * Returns a <code>FormDataFPYsla</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPYsla} The enum <code>FormDataFPYsla</code> value.
    */
