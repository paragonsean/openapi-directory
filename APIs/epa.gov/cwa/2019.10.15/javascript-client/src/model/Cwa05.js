...
/**
 * The Cwa05 model module.
 * @module model/Cwa05
 * @version 2019.10.15
 */
class Cwa05 {
    /**
     * Constructs a new <code>Cwa05</code>.
     * Cluster Data Object
     * @alias module:model/Cwa05
     ...
     */
    constructor(bioCVRows, bioV3Rows, cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows, vioLast4QRows) { 
        
        Cwa05.initialize(this, bioCVRows, bioV3Rows, cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows, vioLast4QRows);
    }
     ...
     */
    static initialize(obj, bioCVRows, bioV3Rows, cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows, vioLast4QRows) { 
    ...
    /**
     * Constructs a <code>Cwa05</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cwa05} obj Optional instance to populate.
     * @return {module:model/Cwa05} The populated <code>Cwa05</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Cwa05</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cwa05</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cwa05.RequiredProperties) {
...
Cwa05.RequiredProperties = ["BioCVRows", "BioV3Rows", "CVRows", "ClusterCount", "ClusterIcon", "ClusterLatitude", "ClusterLongitude", "ClusterName", "ClusterType", "ClusterValue", "EPARegionCode", "FEARows", "INSPRows", "IndianCountryRows", "InfFEARows", "ObjectId", "SVRows", "TotalPenalties", "V3Rows", "VioLast4QRows"];

/**
 * Number of facilities with current biosolid-related violations.
 * @member {String} BioCVRows
 */
Cwa05.prototype['BioCVRows'] = undefined;
 ...
 */
Cwa05.prototype['BioV3Rows'] = undefined;
 ...
 */
Cwa05.prototype['ClusterValue'] = undefined;
