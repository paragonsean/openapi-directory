...
/**
* Enum class FormDataFPMsgpPtype.
* @enum {}
* @readonly
*/
export default class FormDataFPMsgpPtype {
    ...
    /**
    * Returns a <code>FormDataFPMsgpPtype</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMsgpPtype} The enum <code>FormDataFPMsgpPtype</code> value.
    */
