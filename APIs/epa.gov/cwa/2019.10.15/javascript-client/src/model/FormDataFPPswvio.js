...
/**
* Enum class FormDataFPPswvio.
* @enum {}
* @readonly
*/
export default class FormDataFPPswvio {
    ...
    /**
    * Returns a <code>FormDataFPPswvio</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPswvio} The enum <code>FormDataFPPswvio</code> value.
    */
