...
/**
* Enum class FormDataFPFf.
* @enum {}
* @readonly
*/
export default class FormDataFPFf {
    ...
    /**
    * Returns a <code>FormDataFPFf</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFf} The enum <code>FormDataFPFf</code> value.
    */
