...
/**
* Enum class FormDataFPPctrack.
* @enum {}
* @readonly
*/
export default class FormDataFPPctrack {
    ...
    /**
    * Returns a <code>FormDataFPPctrack</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPctrack} The enum <code>FormDataFPPctrack</code> value.
    */
