...
/**
 * The Cwa13 model module.
 * @module model/Cwa13
 * @version 2019.10.15
 */
class Cwa13 {
    /**
     * Constructs a new <code>Cwa13</code>.
     * Results Object
     * @alias module:model/Cwa13
     * @param facilities {Array.<module:model/Cwa01>} A complex array of facility information.
    ...
    constructor(facilities, message, pageNo, queryID, queryRows) { 
        ...
        Cwa13.initialize(this, facilities, message, pageNo, queryID, queryRows);
    }
    ...
    /**
     * Constructs a <code>Cwa13</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cwa13} obj Optional instance to populate.
     * @return {module:model/Cwa13} The populated <code>Cwa13</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Cwa13</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cwa13</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cwa13.RequiredProperties) {
