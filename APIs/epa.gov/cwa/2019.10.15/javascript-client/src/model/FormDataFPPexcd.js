...
/**
* Enum class FormDataFPPexcd.
* @enum {}
* @readonly
*/
export default class FormDataFPPexcd {
    ...
    /**
    * Returns a <code>FormDataFPPexcd</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPexcd} The enum <code>FormDataFPPexcd</code> value.
    */
