...
/**
* Enum class FormDataFPMS4.
* @enum {}
* @readonly
*/
export default class FormDataFPMS4 {
    ...
    /**
    * Returns a <code>FormDataFPMS4</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMS4} The enum <code>FormDataFPMS4</code> value.
    */
