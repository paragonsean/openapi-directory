...
/**
* Enum class FormDataFPMonType.
* @enum {}
* @readonly
*/
export default class FormDataFPMonType {
    ...
    /**
    * Returns a <code>FormDataFPMonType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMonType} The enum <code>FormDataFPMonType</code> value.
    */
