...
/**
* Enum class FormDataFPPcss.
* @enum {}
* @readonly
*/
export default class FormDataFPPcss {
    ...
    /**
    * Returns a <code>FormDataFPPcss</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPcss} The enum <code>FormDataFPPcss</code> value.
    */
