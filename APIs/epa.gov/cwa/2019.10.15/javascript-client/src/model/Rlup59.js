...
/**
 * The Rlup59 model module.
 * @module model/Rlup59
 * @version 2019.10.15
 */
class Rlup59 {
    /**
     * Constructs a new <code>Rlup59</code>.
     * Results Object
     * @alias module:model/Rlup59
     * @param message {String} Field to record messages (typically performance-related) about packet processing
     */
    constructor(message) { 
        
        Rlup59.initialize(this, message);
    }
    ...
    /**
     * Constructs a <code>Rlup59</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rlup59} obj Optional instance to populate.
     * @return {module:model/Rlup59} The populated <code>Rlup59</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Rlup59</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rlup59</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rlup59.RequiredProperties) {
