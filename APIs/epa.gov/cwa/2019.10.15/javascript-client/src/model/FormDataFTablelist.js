...
/**
* Enum class FormDataFTablelist.
* @enum {}
* @readonly
*/
export default class FormDataFTablelist {
    ...
    /**
    * Returns a <code>FormDataFTablelist</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFTablelist} The enum <code>FormDataFTablelist</code> value.
    */
