...
/**
* Enum class FormDataFSummarylist.
* @enum {}
* @readonly
*/
export default class FormDataFSummarylist {
    ...
    /**
    * Returns a <code>FormDataFSummarylist</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFSummarylist} The enum <code>FormDataFSummarylist</code> value.
    */
