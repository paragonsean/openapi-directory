...
/**
* Enum class FormDataFPMed.
* @enum {}
* @readonly
*/
export default class FormDataFPMed {
    ...
    /**
    * Returns a <code>FormDataFPMed</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMed} The enum <code>FormDataFPMed</code> value.
    */
