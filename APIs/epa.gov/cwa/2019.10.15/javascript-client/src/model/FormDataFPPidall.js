...
/**
* Enum class FormDataFPPidall.
* @enum {}
* @readonly
*/
export default class FormDataFPPidall {
    ...
    /**
    * Returns a <code>FormDataFPPidall</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPidall} The enum <code>FormDataFPPidall</code> value.
    */
