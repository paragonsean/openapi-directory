...
/**
* Enum class FormDataFPPt.
* @enum {}
* @readonly
*/
export default class FormDataFPPt {
    ...
    /**
    * Returns a <code>FormDataFPPt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPt} The enum <code>FormDataFPPt</code> value.
    */
