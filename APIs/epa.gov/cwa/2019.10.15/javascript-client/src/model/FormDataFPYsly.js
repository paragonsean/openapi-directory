...
/**
* Enum class FormDataFPYsly.
* @enum {}
* @readonly
*/
export default class FormDataFPYsly {
    ...
    /**
    * Returns a <code>FormDataFPYsly</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPYsly} The enum <code>FormDataFPYsly</code> value.
    */
