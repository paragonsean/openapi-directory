...
/**
* Enum class FormDataFPImpPol.
* @enum {}
* @readonly
*/
export default class FormDataFPImpPol {
    ...
    /**
    * Returns a <code>FormDataFPImpPol</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPImpPol} The enum <code>FormDataFPImpPol</code> value.
    */
