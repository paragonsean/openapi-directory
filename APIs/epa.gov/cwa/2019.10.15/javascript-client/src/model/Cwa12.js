...
import Cwa11 from './Cwa11';

/**
 * The Cwa12 model module.
 * @module model/Cwa12
 * @version 2019.10.15
 */
class Cwa12 {
    /**
     * Constructs a new <code>Cwa12</code>.
     * Map Output Object
     * @alias module:model/Cwa12
     * @param iconBaseURL {String} URL where all the icons are located
     * @param mapData {Array.<module:model/Cwa11>} An array of facility geospatial information.
    ...
    constructor(iconBaseURL, mapData, popUpBaseURL, queryID) { 
        ...
        Cwa12.initialize(this, iconBaseURL, mapData, popUpBaseURL, queryID);
    }
    ...
    /**
     * Constructs a <code>Cwa12</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Cwa12} obj Optional instance to populate.
     * @return {module:model/Cwa12} The populated <code>Cwa12</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MapData')) {
                obj['MapData'] = ApiClient.convertToType(data['MapData'], [Cwa11]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Cwa12</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Cwa12</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Cwa12.RequiredProperties) {
