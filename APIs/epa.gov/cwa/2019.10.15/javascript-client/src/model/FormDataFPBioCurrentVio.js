...
/**
* Enum class FormDataFPBioCurrentVio.
* @enum {}
* @readonly
*/
export default class FormDataFPBioCurrentVio {
    ...
    /**
    * Returns a <code>FormDataFPBioCurrentVio</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPBioCurrentVio} The enum <code>FormDataFPBioCurrentVio</code> value.
    */
