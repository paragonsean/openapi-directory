...
/**
* Enum class FormDataFPPlimits.
* @enum {}
* @readonly
*/
export default class FormDataFPPlimits {
    ...
    /**
    * Returns a <code>FormDataFPPlimits</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPlimits} The enum <code>FormDataFPPlimits</code> value.
    */
