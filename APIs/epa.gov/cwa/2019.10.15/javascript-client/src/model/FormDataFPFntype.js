...
/**
* Enum class FormDataFPFntype.
* @enum {}
* @readonly
*/
export default class FormDataFPFntype {
    ...
    /**
    * Returns a <code>FormDataFPFntype</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFntype} The enum <code>FormDataFPFntype</code> value.
    */
