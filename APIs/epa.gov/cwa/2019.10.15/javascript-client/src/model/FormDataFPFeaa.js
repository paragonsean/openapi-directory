...
/**
* Enum class FormDataFPFeaa.
* @enum {}
* @readonly
*/
export default class FormDataFPFeaa {
    ...
    /**
    * Returns a <code>FormDataFPFeaa</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFeaa} The enum <code>FormDataFPFeaa</code> value.
    */
