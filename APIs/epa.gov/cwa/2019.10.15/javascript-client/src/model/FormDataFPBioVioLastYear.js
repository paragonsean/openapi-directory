...
/**
* Enum class FormDataFPBioVioLastYear.
* @enum {}
* @readonly
*/
export default class FormDataFPBioVioLastYear {
    ...
    /**
    * Returns a <code>FormDataFPBioVioLastYear</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPBioVioLastYear} The enum <code>FormDataFPBioVioLastYear</code> value.
    */
