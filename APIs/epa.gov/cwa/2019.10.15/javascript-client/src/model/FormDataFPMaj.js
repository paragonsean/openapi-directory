...
/**
* Enum class FormDataFPMaj.
* @enum {}
* @readonly
*/
export default class FormDataFPMaj {
    ...
    /**
    * Returns a <code>FormDataFPMaj</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMaj} The enum <code>FormDataFPMaj</code> value.
    */
