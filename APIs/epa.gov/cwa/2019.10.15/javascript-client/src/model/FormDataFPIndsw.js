...
/**
* Enum class FormDataFPIndsw.
* @enum {}
* @readonly
*/
export default class FormDataFPIndsw {
    ...
    /**
    * Returns a <code>FormDataFPIndsw</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPIndsw} The enum <code>FormDataFPIndsw</code> value.
    */
