...
/**
* Enum class FormDataFPPexp.
* @enum {}
* @readonly
*/
export default class FormDataFPPexp {
    ...
    /**
    * Returns a <code>FormDataFPPexp</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPexp} The enum <code>FormDataFPPexp</code> value.
    */
