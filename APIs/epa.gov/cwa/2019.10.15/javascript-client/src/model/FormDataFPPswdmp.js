...
/**
* Enum class FormDataFPPswdmp.
* @enum {}
* @readonly
*/
export default class FormDataFPPswdmp {
    ...
    /**
    * Returns a <code>FormDataFPPswdmp</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPswdmp} The enum <code>FormDataFPPswdmp</code> value.
    */
