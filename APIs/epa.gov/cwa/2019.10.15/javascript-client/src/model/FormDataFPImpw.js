...
/**
* Enum class FormDataFPImpw.
* @enum {}
* @readonly
*/
export default class FormDataFPImpw {
    ...
    /**
    * Returns a <code>FormDataFPImpw</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPImpw} The enum <code>FormDataFPImpw</code> value.
    */
