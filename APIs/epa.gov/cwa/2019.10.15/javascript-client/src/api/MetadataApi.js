...
export default class MetadataApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the cwaRestServicesMetadataGet operation.
     * @callback module:api/MetadataApi~cwaRestServicesMetadataGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CwaRestServicesMetadataGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/MetadataApi~cwaRestServicesMetadataGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CwaRestServicesMetadataGet200Response}
     */
    cwaRestServicesMetadataGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = CwaRestServicesMetadataGet200Response;
    ...
    /**
     * Callback function to receive the result of the cwaRestServicesMetadataPost operation.
     * @callback module:api/MetadataApi~cwaRestServicesMetadataPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CwaRestServicesMetadataGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} [output] Output Format Flag.  Enter one of the following keywords: - JSON = Data model formatted as Javascript Object Notation (default). - JSONP = Data model formatted as Javascript Object Notation with Padding.   - XML = Data model formatted as Extensible Markup Language.
     * @param {String} [callback] JSONP Callback.  For use with JSONP and GEOJSONP output only.  Enter a name of the function in which to wrap the JSON response.
     * @param {module:api/MetadataApi~cwaRestServicesMetadataPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CwaRestServicesMetadataGet200Response}
     */
    cwaRestServicesMetadataPost(opts, callback) {
      opts = opts || {};
      let postBody = null;
