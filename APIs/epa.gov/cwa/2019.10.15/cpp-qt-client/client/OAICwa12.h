...
class OAICwa12 : public OAIObject {
public:
    OAICwa12();
    OAICwa12(QString json);
    ~OAICwa12() override;
    ...
    QList<OAICwa11> getMapData() const;
    void setMapData(const QList<OAICwa11> &map_data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICwa12)
