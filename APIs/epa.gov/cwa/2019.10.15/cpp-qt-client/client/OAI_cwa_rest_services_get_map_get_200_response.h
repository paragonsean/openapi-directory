...
/*
 * OAI_cwa_rest_services_get_map_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_cwa_rest_services_get_map_get_200_response_H
#define OAI_cwa_rest_services_get_map_get_200_response_H
...
class OAI_cwa_rest_services_get_map_get_200_response : public OAIObject {
public:
    OAI_cwa_rest_services_get_map_get_200_response();
    OAI_cwa_rest_services_get_map_get_200_response(QString json);
    ~OAI_cwa_rest_services_get_map_get_200_response() override;
    ...
    OAICwa12 getMapOutput() const;
    void setMapOutput(const OAICwa12 &map_output);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_cwa_rest_services_get_map_get_200_response)

#endif // OAI_cwa_rest_services_get_map_get_200_response_H
