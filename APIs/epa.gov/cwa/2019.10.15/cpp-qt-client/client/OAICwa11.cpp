...
OAICwa11::OAICwa11(QString json) {
...
void OAICwa11::fromJson(QString jsonString) {
...
void OAICwa11::fromJsonObject(QJsonObject json) {
...
QJsonObject OAICwa11::asJsonObject() const {
    QJsonObject obj;
...
QString OAICwa11::getCwAstatus() const {
    return m_cw_astatus;
}
void OAICwa11::setCwAstatus(const QString &cw_astatus) {
    m_cw_astatus = cw_astatus;
    m_cw_astatus_isSet = true;
}

bool OAICwa11::is_cw_astatus_Set() const{
    return m_cw_astatus_isSet;
}

bool OAICwa11::is_cw_astatus_Valid() const{
    return m_cw_astatus_isValid;
}

QString OAICwa11::getFormalCount() const {
    return m_formal_count;
}
void OAICwa11::setFormalCount(const QString &formal_count) {
    m_formal_count = formal_count;
    m_formal_count_isSet = true;
}

bool OAICwa11::is_formal_count_Set() const{
    return m_formal_count_isSet;
}

bool OAICwa11::is_formal_count_Valid() const{
    return m_formal_count_isValid;
}

QString OAICwa11::getIcon() const {
    return m_icon;
}
void OAICwa11::setIcon(const QString &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAICwa11::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAICwa11::is_icon_Valid() const{
    return m_icon_isValid;
}

QString OAICwa11::getInformalCount() const {
    return m_informal_count;
}
void OAICwa11::setInformalCount(const QString &informal_count) {
    m_informal_count = informal_count;
    m_informal_count_isSet = true;
}

bool OAICwa11::is_informal_count_Set() const{
    return m_informal_count_isSet;
}

bool OAICwa11::is_informal_count_Valid() const{
    return m_informal_count_isValid;
}

QString OAICwa11::getLat() const {
    return m_lat;
}
void OAICwa11::setLat(const QString &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAICwa11::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAICwa11::is_lat_Valid() const{
    return m_lat_isValid;
}

QString OAICwa11::getLon() const {
    return m_lon;
}
void OAICwa11::setLon(const QString &lon) {
    m_lon = lon;
    m_lon_isSet = true;
}

bool OAICwa11::is_lon_Set() const{
    return m_lon_isSet;
}

bool OAICwa11::is_lon_Valid() const{
    return m_lon_isValid;
}

QString OAICwa11::getLastInsp() const {
    return m_last_insp;
}
void OAICwa11::setLastInsp(const QString &last_insp) {
    m_last_insp = last_insp;
    m_last_insp_isSet = true;
}

bool OAICwa11::is_last_insp_Set() const{
    return m_last_insp_isSet;
}

bool OAICwa11::is_last_insp_Valid() const{
    return m_last_insp_isValid;
}

QString OAICwa11::getName() const {
    return m_name;
}
void OAICwa11::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICwa11::is_name_Set() const{
    return m_name_isSet;
}

bool OAICwa11::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICwa11::getPuv() const {
    return m_puv;
}
void OAICwa11::setPuv(const QString &puv) {
    m_puv = puv;
    m_puv_isSet = true;
}

bool OAICwa11::is_puv_Set() const{
    return m_puv_isSet;
}

bool OAICwa11::is_puv_Valid() const{
    return m_puv_isValid;
}

QString OAICwa11::getType() const {
    return m_type;
}
void OAICwa11::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICwa11::is_type_Set() const{
    return m_type_isSet;
}

bool OAICwa11::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICwa11::isSet() const {
