...
class OAICwa08 : public OAIObject {
public:
    OAICwa08();
    OAICwa08(QString json);
    ~OAICwa08() override;
    ...
    OAICwa06 getClusterOutput() const;
    void setClusterOutput(const OAICwa06 &cluster_output);
    ...
    QList<OAICwa07> getFacilities() const;
    void setFacilities(const QList<OAICwa07> &facilities);
...
Q_DECLARE_METATYPE(OpenAPI::OAICwa08)
