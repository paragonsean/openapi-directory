...
class OAICwa11 : public OAIObject {
public:
    OAICwa11();
    OAICwa11(QString json);
    ~OAICwa11() override;
    ...
    QString getCwAstatus() const;
    void setCwAstatus(const QString &cw_astatus);
    bool is_cw_astatus_Set() const;
    bool is_cw_astatus_Valid() const;
...
private:
    ...
    QString m_cw_astatus;
    bool m_cw_astatus_isSet;
    bool m_cw_astatus_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICwa11)
