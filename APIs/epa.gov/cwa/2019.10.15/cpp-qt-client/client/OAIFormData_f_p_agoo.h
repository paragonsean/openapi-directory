...
class OAIFormData_f_p_agoo : public OAIEnum {
public:
    OAIFormData_f_p_agoo();
    OAIFormData_f_p_agoo(QString json);
    ~OAIFormData_f_p_agoo() override;
    ...
    enum class eOAIFormData_f_p_agoo {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AND, 
        OR
    };
    OAIFormData_f_p_agoo::eOAIFormData_f_p_agoo getValue() const;
    void setValue(const OAIFormData_f_p_agoo::eOAIFormData_f_p_agoo& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_agoo)

#endif // OAIFormData_f_p_agoo_H
