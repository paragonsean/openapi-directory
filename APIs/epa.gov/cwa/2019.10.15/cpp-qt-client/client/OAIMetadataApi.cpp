...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("cwaRestServicesMetadataGet", defaultConf);
    _serverIndices.insert("cwaRestServicesMetadataGet", 0);
    _serverConfigs.insert("cwaRestServicesMetadataPost", defaultConf);
    _serverIndices.insert("cwaRestServicesMetadataPost", 0);
}
...
void OAIMetadataApi::cwaRestServicesMetadataGet(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["cwaRestServicesMetadataGet"][_serverIndices.value("cwaRestServicesMetadataGet")].URL()+"/cwa_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::cwaRestServicesMetadataGetCallback);
...
void OAIMetadataApi::cwaRestServicesMetadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_cwa_rest_services_metadata_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cwaRestServicesMetadataGetSignal(output);
        Q_EMIT cwaRestServicesMetadataGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cwaRestServicesMetadataGetSignalE(output, error_type, error_str);
        Q_EMIT cwaRestServicesMetadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cwaRestServicesMetadataGetSignalError(output, error_type, error_str);
        Q_EMIT cwaRestServicesMetadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::cwaRestServicesMetadataPost(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["cwaRestServicesMetadataPost"][_serverIndices.value("cwaRestServicesMetadataPost")].URL()+"/cwa_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::cwaRestServicesMetadataPostCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::cwaRestServicesMetadataPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT cwaRestServicesMetadataPostSignal(output);
        Q_EMIT cwaRestServicesMetadataPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT cwaRestServicesMetadataPostSignalE(output, error_type, error_str);
        Q_EMIT cwaRestServicesMetadataPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT cwaRestServicesMetadataPostSignalError(output, error_type, error_str);
        Q_EMIT cwaRestServicesMetadataPostSignalErrorFull(worker, error_type, error_str);
    }
}
