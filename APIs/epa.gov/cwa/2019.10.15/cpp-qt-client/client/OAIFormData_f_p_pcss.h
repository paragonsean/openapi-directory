...
class OAIFormData_f_p_pcss : public OAIEnum {
public:
    OAIFormData_f_p_pcss();
    OAIFormData_f_p_pcss(QString json);
    ~OAIFormData_f_p_pcss() override;
    ...
    enum class eOAIFormData_f_p_pcss {
    ...
    OAIFormData_f_p_pcss::eOAIFormData_f_p_pcss getValue() const;
    void setValue(const OAIFormData_f_p_pcss::eOAIFormData_f_p_pcss& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_pcss)

#endif // OAIFormData_f_p_pcss_H
