...
/*
 * OAI_rest_lookups_naics_codes_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_rest_lookups_naics_codes_get_200_response_H
#define OAI_rest_lookups_naics_codes_get_200_response_H
...
class OAI_rest_lookups_naics_codes_get_200_response : public OAIObject {
public:
    OAI_rest_lookups_naics_codes_get_200_response();
    OAI_rest_lookups_naics_codes_get_200_response(QString json);
    ~OAI_rest_lookups_naics_codes_get_200_response() override;
    ...
    OAIRlup61 getResults() const;
    void setResults(const OAIRlup61 &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_rest_lookups_naics_codes_get_200_response)

#endif // OAI_rest_lookups_naics_codes_get_200_response_H
