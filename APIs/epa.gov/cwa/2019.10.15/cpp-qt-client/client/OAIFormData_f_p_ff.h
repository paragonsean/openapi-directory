...
class OAIFormData_f_p_ff : public OAIEnum {
public:
    OAIFormData_f_p_ff();
    OAIFormData_f_p_ff(QString json);
    ~OAIFormData_f_p_ff() override;
    ...
    enum class eOAIFormData_f_p_ff {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y
    };
    OAIFormData_f_p_ff::eOAIFormData_f_p_ff getValue() const;
    void setValue(const OAIFormData_f_p_ff::eOAIFormData_f_p_ff& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_ff)

#endif // OAIFormData_f_p_ff_H
