...
class OAICwa09 : public OAIObject {
public:
    OAICwa09();
    OAICwa09(QString json);
    ~OAICwa09() override;
    ...
    OAICwa10 getProperties() const;
    void setProperties(const OAICwa10 &properties);
...
Q_DECLARE_METATYPE(OpenAPI::OAICwa09)
