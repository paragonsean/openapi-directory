...
#ifndef OAIFormData_f_p_pexp_H
#define OAIFormData_f_p_pexp_H
...
class OAIFormData_f_p_pexp : public OAIEnum {
public:
    OAIFormData_f_p_pexp();
    OAIFormData_f_p_pexp(QString json);
    ~OAIFormData_f_p_pexp() override;
    ...
    enum class eOAIFormData_f_p_pexp {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        EXP, 
        EXPLE1YR, 
        EXPGT1YR
    };
    OAIFormData_f_p_pexp::eOAIFormData_f_p_pexp getValue() const;
    void setValue(const OAIFormData_f_p_pexp::eOAIFormData_f_p_pexp& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_pexp)

#endif // OAIFormData_f_p_pexp_H
