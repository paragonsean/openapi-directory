...
class OAICwa03 : public OAIObject {
public:
    OAICwa03();
    OAICwa03(QString json);
    ~OAICwa03() override;
    ...
    QList<OAICwa02> getMapData() const;
    void setMapData(const QList<OAICwa02> &map_data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICwa03)
