...
QList<double> OAIGeo::getCoordinates() const {
    return m_coordinates;
}
void OAIGeo::setCoordinates(const QList<double> &coordinates) {
    m_coordinates = coordinates;
    m_coordinates_isSet = true;
}

bool OAIGeo::is_coordinates_Set() const{
    return m_coordinates_isSet;
}

bool OAIGeo::is_coordinates_Valid() const{
