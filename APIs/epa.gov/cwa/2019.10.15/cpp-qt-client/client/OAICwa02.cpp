...
OAICwa02::OAICwa02(QString json) {
...
void OAICwa02::fromJson(QString jsonString) {
...
void OAICwa02::fromJsonObject(QJsonObject json) {
...
QJsonObject OAICwa02::asJsonObject() const {
    QJsonObject obj;
...
QString OAICwa02::getCwAstatus() const {
    return m_cw_astatus;
}
void OAICwa02::setCwAstatus(const QString &cw_astatus) {
    m_cw_astatus = cw_astatus;
    m_cw_astatus_isSet = true;
}

bool OAICwa02::is_cw_astatus_Set() const{
    return m_cw_astatus_isSet;
}

bool OAICwa02::is_cw_astatus_Valid() const{
    return m_cw_astatus_isValid;
}

QString OAICwa02::getFormalCount() const {
    return m_formal_count;
}
void OAICwa02::setFormalCount(const QString &formal_count) {
    m_formal_count = formal_count;
    m_formal_count_isSet = true;
}

bool OAICwa02::is_formal_count_Set() const{
    return m_formal_count_isSet;
}

bool OAICwa02::is_formal_count_Valid() const{
    return m_formal_count_isValid;
}

QString OAICwa02::getIcon() const {
    return m_icon;
}
void OAICwa02::setIcon(const QString &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAICwa02::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAICwa02::is_icon_Valid() const{
    return m_icon_isValid;
}

QString OAICwa02::getInformalCount() const {
    return m_informal_count;
}
void OAICwa02::setInformalCount(const QString &informal_count) {
    m_informal_count = informal_count;
    m_informal_count_isSet = true;
}

bool OAICwa02::is_informal_count_Set() const{
    return m_informal_count_isSet;
}

bool OAICwa02::is_informal_count_Valid() const{
    return m_informal_count_isValid;
}

QString OAICwa02::getLat() const {
    return m_lat;
}
void OAICwa02::setLat(const QString &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAICwa02::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAICwa02::is_lat_Valid() const{
    return m_lat_isValid;
}

QString OAICwa02::getLon() const {
    return m_lon;
}
void OAICwa02::setLon(const QString &lon) {
    m_lon = lon;
    m_lon_isSet = true;
}

bool OAICwa02::is_lon_Set() const{
    return m_lon_isSet;
}

bool OAICwa02::is_lon_Valid() const{
    return m_lon_isValid;
}

QString OAICwa02::getLastInsp() const {
    return m_last_insp;
}
void OAICwa02::setLastInsp(const QString &last_insp) {
    m_last_insp = last_insp;
    m_last_insp_isSet = true;
}

bool OAICwa02::is_last_insp_Set() const{
    return m_last_insp_isSet;
}

bool OAICwa02::is_last_insp_Valid() const{
    return m_last_insp_isValid;
}

QString OAICwa02::getName() const {
    return m_name;
}
void OAICwa02::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICwa02::is_name_Set() const{
    return m_name_isSet;
}

bool OAICwa02::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICwa02::getPuv() const {
    return m_puv;
}
void OAICwa02::setPuv(const QString &puv) {
    m_puv = puv;
    m_puv_isSet = true;
}

bool OAICwa02::is_puv_Set() const{
    return m_puv_isSet;
}

bool OAICwa02::is_puv_Valid() const{
    return m_puv_isValid;
}

QString OAICwa02::getType() const {
    return m_type;
}
void OAICwa02::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAICwa02::is_type_Set() const{
    return m_type_isSet;
}

bool OAICwa02::is_type_Valid() const{
    return m_type_isValid;
}

bool OAICwa02::isSet() const {
...
bool OAICwa02::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_cw_astatus_isValid && m_formal_count_isValid && m_icon_isValid && m_informal_count_isValid && m_lat_isValid && m_lon_isValid && m_last_insp_isValid && m_name_isValid && m_puv_isValid && m_type_isValid && true;
}
