...
/*
 * OAIFormData_f_tablelist.h
 *
 * Table List Flag. Enter a Y to display the first page of facility results.
 */

#ifndef OAIFormData_f_tablelist_H
#define OAIFormData_f_tablelist_H
...
class OAIFormData_f_tablelist : public OAIEnum {
public:
    OAIFormData_f_tablelist();
    OAIFormData_f_tablelist(QString json);
    ~OAIFormData_f_tablelist() override;
    ...
    enum class eOAIFormData_f_tablelist {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_tablelist::eOAIFormData_f_tablelist getValue() const;
    void setValue(const OAIFormData_f_tablelist::eOAIFormData_f_tablelist& value);
...
private:
    ...
    eOAIFormData_f_tablelist m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_tablelist)

#endif // OAIFormData_f_tablelist_H
