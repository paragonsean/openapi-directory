...
#ifndef OAIFormData_f_p_pm_H
#define OAIFormData_f_p_pm_H
...
class OAIFormData_f_p_pm : public OAIEnum {
public:
    OAIFormData_f_p_pm();
    OAIFormData_f_p_pm(QString json);
    ~OAIFormData_f_p_pm() override;
    ...
    enum class eOAIFormData_f_p_pm {
    ...
    OAIFormData_f_p_pm::eOAIFormData_f_p_pm getValue() const;
    void setValue(const OAIFormData_f_p_pm::eOAIFormData_f_p_pm& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_pm)

#endif // OAIFormData_f_p_pm_H
