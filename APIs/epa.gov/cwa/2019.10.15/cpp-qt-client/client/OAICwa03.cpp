...
OAICwa03::OAICwa03(QString json) {
...
void OAICwa03::fromJson(QString jsonString) {
...
void OAICwa03::fromJsonObject(QJsonObject json) {
...
QJsonObject OAICwa03::asJsonObject() const {
    QJsonObject obj;
...
QString OAICwa03::getIconBaseUrl() const {
    return m_icon_base_url;
}
void OAICwa03::setIconBaseUrl(const QString &icon_base_url) {
    m_icon_base_url = icon_base_url;
    m_icon_base_url_isSet = true;
}

bool OAICwa03::is_icon_base_url_Set() const{
    return m_icon_base_url_isSet;
}

bool OAICwa03::is_icon_base_url_Valid() const{
    return m_icon_base_url_isValid;
}

QList<OAICwa02> OAICwa03::getMapData() const {
    return m_map_data;
}
void OAICwa03::setMapData(const QList<OAICwa02> &map_data) {
    m_map_data = map_data;
    m_map_data_isSet = true;
}

bool OAICwa03::is_map_data_Set() const{
    return m_map_data_isSet;
}

bool OAICwa03::is_map_data_Valid() const{
    return m_map_data_isValid;
}

QString OAICwa03::getPopUpBaseUrl() const {
    return m_pop_up_base_url;
}
void OAICwa03::setPopUpBaseUrl(const QString &pop_up_base_url) {
    m_pop_up_base_url = pop_up_base_url;
    m_pop_up_base_url_isSet = true;
}

bool OAICwa03::is_pop_up_base_url_Set() const{
    return m_pop_up_base_url_isSet;
}

bool OAICwa03::is_pop_up_base_url_Valid() const{
    return m_pop_up_base_url_isValid;
}

QString OAICwa03::getQueryId() const {
    return m_query_id;
}
void OAICwa03::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAICwa03::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAICwa03::is_query_id_Valid() const{
    return m_query_id_isValid;
}

bool OAICwa03::isSet() const {
