...
#ifndef OAIFormData_f_p_pexcd_H
#define OAIFormData_f_p_pexcd_H
...
class OAIFormData_f_p_pexcd : public OAIEnum {
public:
    OAIFormData_f_p_pexcd();
    OAIFormData_f_p_pexcd(QString json);
    ~OAIFormData_f_p_pexcd() override;
    ...
    enum class eOAIFormData_f_p_pexcd {
    ...
    OAIFormData_f_p_pexcd::eOAIFormData_f_p_pexcd getValue() const;
    void setValue(const OAIFormData_f_p_pexcd::eOAIFormData_f_p_pexcd& value);
...
private:
    ...
    eOAIFormData_f_p_pexcd m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_pexcd)

#endif // OAIFormData_f_p_pexcd_H
