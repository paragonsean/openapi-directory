...
class OAICwa06 : public OAIObject {
public:
    OAICwa06();
    OAICwa06(QString json);
    ~OAICwa06() override;
    ...
    QList<OAICwa05> getClusterData() const;
    void setClusterData(const QList<OAICwa05> &cluster_data);
...
Q_DECLARE_METATYPE(OpenAPI::OAICwa06)
