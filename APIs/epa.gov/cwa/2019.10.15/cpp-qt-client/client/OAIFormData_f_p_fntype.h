...
#ifndef OAIFormData_f_p_fntype_H
#define OAIFormData_f_p_fntype_H
...
class OAIFormData_f_p_fntype : public OAIEnum {
public:
    OAIFormData_f_p_fntype();
    OAIFormData_f_p_fntype(QString json);
    ~OAIFormData_f_p_fntype() override;
    ...
    enum class eOAIFormData_f_p_fntype {
    ...
    OAIFormData_f_p_fntype::eOAIFormData_f_p_fntype getValue() const;
    void setValue(const OAIFormData_f_p_fntype::eOAIFormData_f_p_fntype& value);
...
private:
    ...
    eOAIFormData_f_p_fntype m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_fntype)

#endif // OAIFormData_f_p_fntype_H
