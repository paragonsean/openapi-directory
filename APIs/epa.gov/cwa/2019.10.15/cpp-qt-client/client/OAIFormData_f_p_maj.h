...
/*
 * OAIFormData_f_p_maj.h
 *
 * Major Facility Flag.  Enter Y to restrict results to Major facilities only.
 */

#ifndef OAIFormData_f_p_maj_H
#define OAIFormData_f_p_maj_H
...
class OAIFormData_f_p_maj : public OAIEnum {
public:
    OAIFormData_f_p_maj();
    OAIFormData_f_p_maj(QString json);
    ~OAIFormData_f_p_maj() override;
    ...
    enum class eOAIFormData_f_p_maj {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_maj::eOAIFormData_f_p_maj getValue() const;
    void setValue(const OAIFormData_f_p_maj::eOAIFormData_f_p_maj& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_maj)

#endif // OAIFormData_f_p_maj_H
