...
|------------ | ------------- | ------------- | -------------|
|**cwAstatus** | **String** | Quarterly compliance status for the most recent 13 quarters. Each letter indicates the compliance status for the corresponding quarter. |  |
