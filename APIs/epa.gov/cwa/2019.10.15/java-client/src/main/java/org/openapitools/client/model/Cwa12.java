...
import org.openapitools.client.model.Cwa11;
...
public class Cwa12 {
  ...
  private List<Cwa11> mapData = new ArrayList<>();
  ...
  public Cwa12 iconBaseURL(String iconBaseURL) {
  ...
  public Cwa12 mapData(List<Cwa11> mapData) {
    this.mapData = mapData;
    return this;
  }

  public Cwa12 addMapDataItem(Cwa11 mapDataItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<Cwa11> getMapData() {
    return mapData;
  }

  public void setMapData(List<Cwa11> mapData) {
    this.mapData = mapData;
  }


  public Cwa12 popUpBaseURL(String popUpBaseURL) {
  ...
  public Cwa12 queryID(String queryID) {
  ...
  public boolean equals(Object o) {
    ...
    Cwa12 cwa12 = (Cwa12) o;
    return Objects.equals(this.iconBaseURL, cwa12.iconBaseURL) &&
        Objects.equals(this.mapData, cwa12.mapData) &&
        Objects.equals(this.popUpBaseURL, cwa12.popUpBaseURL) &&
        Objects.equals(this.queryID, cwa12.queryID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cwa12
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cwa12.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cwa12 is not found in the empty JSON string", Cwa12.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cwa12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cwa12` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cwa12.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraymapData.size(); i++) {
        Cwa11.validateJsonElement(jsonArraymapData.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cwa12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cwa12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cwa12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cwa12.class));

       return (TypeAdapter<T>) new TypeAdapter<Cwa12>() {
           @Override
           public void write(JsonWriter out, Cwa12 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cwa12 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cwa12 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cwa12
   * @throws IOException if the JSON string is invalid with respect to Cwa12
   */
  public static Cwa12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cwa12.class);
  }

  /**
   * Convert an instance of Cwa12 to an JSON string
   *
   * @return JSON string
   */
