...
public class Cwa13 {
  ...
  public Cwa13 facilities(List<Cwa01> facilities) {
    this.facilities = facilities;
    return this;
  }

  public Cwa13 addFacilitiesItem(Cwa01 facilitiesItem) {
  ...
  public Cwa13 message(String message) {
  ...
  public Cwa13 pageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public Cwa13 queryID(String queryID) {
  ...
  public Cwa13 queryRows(String queryRows) {
  ...
  public boolean equals(Object o) {
    ...
    Cwa13 cwa13 = (Cwa13) o;
    return Objects.equals(this.facilities, cwa13.facilities) &&
        Objects.equals(this.message, cwa13.message) &&
        Objects.equals(this.pageNo, cwa13.pageNo) &&
        Objects.equals(this.queryID, cwa13.queryID) &&
        Objects.equals(this.queryRows, cwa13.queryRows);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cwa13
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cwa13.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cwa13 is not found in the empty JSON string", Cwa13.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cwa13.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cwa13` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cwa13.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cwa13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cwa13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cwa13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cwa13.class));

       return (TypeAdapter<T>) new TypeAdapter<Cwa13>() {
           @Override
           public void write(JsonWriter out, Cwa13 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cwa13 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cwa13 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cwa13
   * @throws IOException if the JSON string is invalid with respect to Cwa13
   */
  public static Cwa13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cwa13.class);
  }

  /**
   * Convert an instance of Cwa13 to an JSON string
   *
   * @return JSON string
   */
