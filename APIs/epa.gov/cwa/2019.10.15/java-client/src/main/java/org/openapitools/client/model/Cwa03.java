...
import org.openapitools.client.model.Cwa02;
...
public class Cwa03 {
  ...
  private List<Cwa02> mapData = new ArrayList<>();
  ...
  public Cwa03 iconBaseURL(String iconBaseURL) {
  ...
  public Cwa03 mapData(List<Cwa02> mapData) {
    this.mapData = mapData;
    return this;
  }

  public Cwa03 addMapDataItem(Cwa02 mapDataItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<Cwa02> getMapData() {
    return mapData;
  }

  public void setMapData(List<Cwa02> mapData) {
    this.mapData = mapData;
  }


  public Cwa03 popUpBaseURL(String popUpBaseURL) {
  ...
  public Cwa03 queryID(String queryID) {
  ...
  public boolean equals(Object o) {
    ...
    Cwa03 cwa03 = (Cwa03) o;
    return Objects.equals(this.iconBaseURL, cwa03.iconBaseURL) &&
        Objects.equals(this.mapData, cwa03.mapData) &&
        Objects.equals(this.popUpBaseURL, cwa03.popUpBaseURL) &&
        Objects.equals(this.queryID, cwa03.queryID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cwa03
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cwa03.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cwa03 is not found in the empty JSON string", Cwa03.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cwa03.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cwa03` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cwa03.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraymapData.size(); i++) {
        Cwa02.validateJsonElement(jsonArraymapData.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cwa03.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cwa03' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cwa03> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cwa03.class));

       return (TypeAdapter<T>) new TypeAdapter<Cwa03>() {
           @Override
           public void write(JsonWriter out, Cwa03 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cwa03 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cwa03 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cwa03
   * @throws IOException if the JSON string is invalid with respect to Cwa03
   */
  public static Cwa03 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cwa03.class);
  }

  /**
   * Convert an instance of Cwa03 to an JSON string
   *
   * @return JSON string
   */
