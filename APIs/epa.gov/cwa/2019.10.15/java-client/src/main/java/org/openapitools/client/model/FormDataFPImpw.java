 ...
 */
@JsonAdapter(FormDataFPImpw.Adapter.class)
public enum FormDataFPImpw {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPImpw> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPImpw enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPImpw read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPImpw.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPImpw.fromValue(value);
  }
}
