...
public class Cwa04 {
  ...
  private List<Cwa01> facilities = new ArrayList<>();
  ...
  public Cwa04 badSystemIDs(String badSystemIDs) {
  ...
  public Cwa04 bioCVRows(String bioCVRows) {
  ...
  public Cwa04 bioV3Rows(String bioV3Rows) {
  ...
  public Cwa04 cvRows(String cvRows) {
    this.cvRows = cvRows;
    return this;
  }
  ...
  public Cwa04 feARows(String feARows) {
  ...
  public Cwa04 facilities(List<Cwa01> facilities) {
    this.facilities = facilities;
    return this;
  }

  public Cwa04 addFacilitiesItem(Cwa01 facilitiesItem) {
  ...
  public List<Cwa01> getFacilities() {
    return facilities;
  }

  public void setFacilities(List<Cwa01> facilities) {
    this.facilities = facilities;
  }


  public Cwa04 inSPRows(String inSPRows) {
  ...
  public Cwa04 indianCountryRows(String indianCountryRows) {
  ...
  public Cwa04 infFEARows(String infFEARows) {
  ...
  public Cwa04 mapOutput(Cwa03 mapOutput) {
   ...
   */
  @javax.annotation.Nullable
  public Cwa03 getMapOutput() {
    return mapOutput;
  }

  public void setMapOutput(Cwa03 mapOutput) {
    this.mapOutput = mapOutput;
  }


  public Cwa04 message(String message) {
  ...
  public Cwa04 pageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public Cwa04 queryID(String queryID) {
  ...
  public Cwa04 queryRows(String queryRows) {
  ...
  public Cwa04 svRows(String svRows) {
    this.svRows = svRows;
    return this;
  }
  ...
  public Cwa04 totalPenalties(String totalPenalties) {
  ...
  public Cwa04 v3Rows(String v3Rows) {
    this.v3Rows = v3Rows;
    return this;
  }
  ...
  public Cwa04 version(String version) {
  ...
  public Cwa04 vioLast4QRows(String vioLast4QRows) {
  ...
  public boolean equals(Object o) {
    ...
    Cwa04 cwa04 = (Cwa04) o;
    return Objects.equals(this.badSystemIDs, cwa04.badSystemIDs) &&
        Objects.equals(this.bioCVRows, cwa04.bioCVRows) &&
        Objects.equals(this.bioV3Rows, cwa04.bioV3Rows) &&
        Objects.equals(this.cvRows, cwa04.cvRows) &&
        Objects.equals(this.feARows, cwa04.feARows) &&
        Objects.equals(this.facilities, cwa04.facilities) &&
        Objects.equals(this.inSPRows, cwa04.inSPRows) &&
        Objects.equals(this.indianCountryRows, cwa04.indianCountryRows) &&
        Objects.equals(this.infFEARows, cwa04.infFEARows) &&
        Objects.equals(this.mapOutput, cwa04.mapOutput) &&
        Objects.equals(this.message, cwa04.message) &&
        Objects.equals(this.pageNo, cwa04.pageNo) &&
        Objects.equals(this.queryID, cwa04.queryID) &&
        Objects.equals(this.queryRows, cwa04.queryRows) &&
        Objects.equals(this.svRows, cwa04.svRows) &&
        Objects.equals(this.totalPenalties, cwa04.totalPenalties) &&
        Objects.equals(this.v3Rows, cwa04.v3Rows) &&
        Objects.equals(this.version, cwa04.version) &&
        Objects.equals(this.vioLast4QRows, cwa04.vioLast4QRows);
  }

  @Override
  public int hashCode() {
    return Objects.hash(badSystemIDs, bioCVRows, bioV3Rows, cvRows, feARows, facilities, inSPRows, indianCountryRows, infFEARows, mapOutput, message, pageNo, queryID, queryRows, svRows, totalPenalties, v3Rows, version, vioLast4QRows);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Cwa04 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cwa04
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cwa04.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cwa04 is not found in the empty JSON string", Cwa04.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cwa04.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cwa04` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cwa04.openapiRequiredFields) {
      ...
      if (jsonObj.get("Facilities") != null && !jsonObj.get("Facilities").isJsonNull()) {
        ...
        if (jsonArrayfacilities != null) {
          ...
          for (int i = 0; i < jsonArrayfacilities.size(); i++) {
            Cwa01.validateJsonElement(jsonArrayfacilities.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("MapOutput") != null && !jsonObj.get("MapOutput").isJsonNull()) {
        Cwa03.validateJsonElement(jsonObj.get("MapOutput"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cwa04.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cwa04' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cwa04> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cwa04.class));

       return (TypeAdapter<T>) new TypeAdapter<Cwa04>() {
           @Override
           public void write(JsonWriter out, Cwa04 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cwa04 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cwa04 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cwa04
   * @throws IOException if the JSON string is invalid with respect to Cwa04
   */
  public static Cwa04 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cwa04.class);
  }

  /**
   * Convert an instance of Cwa04 to an JSON string
   *
   * @return JSON string
   */
