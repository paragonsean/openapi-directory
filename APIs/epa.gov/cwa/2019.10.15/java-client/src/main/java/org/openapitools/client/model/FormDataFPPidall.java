 ...
 */
@JsonAdapter(FormDataFPPidall.Adapter.class)
public enum FormDataFPPidall {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPidall> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPidall enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPidall read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPidall.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPidall.fromValue(value);
  }
}
