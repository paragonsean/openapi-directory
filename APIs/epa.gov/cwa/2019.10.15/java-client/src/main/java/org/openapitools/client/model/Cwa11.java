...
public class Cwa11 {
  ...
  public Cwa11 cwAstatus(String cwAstatus) {
  ...
  public Cwa11 formalCount(String formalCount) {
  ...
  public Cwa11 informalCount(String informalCount) {
  ...
  public Cwa11 lastInsp(String lastInsp) {
  ...
  public boolean equals(Object o) {
    ...
    Cwa11 cwa11 = (Cwa11) o;
    return Objects.equals(this.cwAstatus, cwa11.cwAstatus) &&
        Objects.equals(this.formalCount, cwa11.formalCount) &&
        Objects.equals(this.ICON, cwa11.ICON) &&
        Objects.equals(this.informalCount, cwa11.informalCount) &&
        Objects.equals(this.LAT, cwa11.LAT) &&
        Objects.equals(this.LON, cwa11.LON) &&
        Objects.equals(this.lastInsp, cwa11.lastInsp) &&
        Objects.equals(this.NAME, cwa11.NAME) &&
        Objects.equals(this.PUV, cwa11.PUV) &&
        Objects.equals(this.TYPE, cwa11.TYPE);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cwAstatus, formalCount, ICON, informalCount, LAT, LON, lastInsp, NAME, PUV, TYPE);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Cwa11 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cwa11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cwa11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cwa11 is not found in the empty JSON string", Cwa11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cwa11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cwa11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cwa11.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cwa11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cwa11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cwa11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cwa11.class));

       return (TypeAdapter<T>) new TypeAdapter<Cwa11>() {
           @Override
           public void write(JsonWriter out, Cwa11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cwa11 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cwa11 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cwa11
   * @throws IOException if the JSON string is invalid with respect to Cwa11
   */
  public static Cwa11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cwa11.class);
  }

  /**
   * Convert an instance of Cwa11 to an JSON string
   *
   * @return JSON string
   */
