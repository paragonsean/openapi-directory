 ...
 */
@JsonAdapter(FormDataFPFeay.Adapter.class)
public enum FormDataFPFeay {
  ...
  FormDataFPFeay(BigDecimal value) {
    this.value = value;
  }
  ...
  public static FormDataFPFeay fromValue(BigDecimal value) {
    for (FormDataFPFeay b : FormDataFPFeay.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPFeay> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPFeay enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPFeay read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPFeay.fromValue(new BigDecimal(value));
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPFeay.fromValue(new BigDecimal(value));
  }
}
