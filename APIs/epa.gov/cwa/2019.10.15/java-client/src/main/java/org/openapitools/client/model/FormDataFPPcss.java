 ...
 */
@JsonAdapter(FormDataFPPcss.Adapter.class)
public enum FormDataFPPcss {
  ...
  public static FormDataFPPcss fromValue(String value) {
    for (FormDataFPPcss b : FormDataFPPcss.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPcss> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPcss enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPcss read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPcss.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPcss.fromValue(value);
  }
}
