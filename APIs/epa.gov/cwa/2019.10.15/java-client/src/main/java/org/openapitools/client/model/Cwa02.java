...
public class Cwa02 {
  ...
  public Cwa02 cwAstatus(String cwAstatus) {
  ...
  public Cwa02 formalCount(String formalCount) {
  ...
  public Cwa02 informalCount(String informalCount) {
  ...
  public Cwa02 lastInsp(String lastInsp) {
  ...
  public boolean equals(Object o) {
    ...
    Cwa02 cwa02 = (Cwa02) o;
    return Objects.equals(this.cwAstatus, cwa02.cwAstatus) &&
        Objects.equals(this.formalCount, cwa02.formalCount) &&
        Objects.equals(this.ICON, cwa02.ICON) &&
        Objects.equals(this.informalCount, cwa02.informalCount) &&
        Objects.equals(this.LAT, cwa02.LAT) &&
        Objects.equals(this.LON, cwa02.LON) &&
        Objects.equals(this.lastInsp, cwa02.lastInsp) &&
        Objects.equals(this.NAME, cwa02.NAME) &&
        Objects.equals(this.PUV, cwa02.PUV) &&
        Objects.equals(this.TYPE, cwa02.TYPE);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Cwa02
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Cwa02.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Cwa02 is not found in the empty JSON string", Cwa02.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Cwa02.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Cwa02` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Cwa02.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Cwa02.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Cwa02' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Cwa02> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Cwa02.class));

       return (TypeAdapter<T>) new TypeAdapter<Cwa02>() {
           @Override
           public void write(JsonWriter out, Cwa02 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Cwa02 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Cwa02 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Cwa02
   * @throws IOException if the JSON string is invalid with respect to Cwa02
   */
  public static Cwa02 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Cwa02.class);
  }

  /**
   * Convert an instance of Cwa02 to an JSON string
   *
   * @return JSON string
   */
