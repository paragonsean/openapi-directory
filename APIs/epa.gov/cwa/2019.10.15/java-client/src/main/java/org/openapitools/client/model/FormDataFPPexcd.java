 ...
 */
@JsonAdapter(FormDataFPPexcd.Adapter.class)
public enum FormDataFPPexcd {
  ...
  public static FormDataFPPexcd fromValue(String value) {
    for (FormDataFPPexcd b : FormDataFPPexcd.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPexcd> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPexcd enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPexcd read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPexcd.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPexcd.fromValue(value);
  }
}
