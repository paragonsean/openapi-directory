 ...
 */
@JsonAdapter(FormDataFPMaj.Adapter.class)
public enum FormDataFPMaj {
  ...
  public static FormDataFPMaj fromValue(String value) {
    for (FormDataFPMaj b : FormDataFPMaj.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPMaj> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPMaj enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPMaj read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPMaj.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPMaj.fromValue(value);
  }
}
