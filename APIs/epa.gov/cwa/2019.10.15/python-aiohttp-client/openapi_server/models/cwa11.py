...
class Cwa11(Model):
    ...
    def __init__(self, cw_astatus: str=None, formal_count: str=None, icon: str=None, informal_count: str=None, lat: str=None, lon: str=None, last_insp: str=None, name: str=None, puv: str=None, type: str=None):
        """Cwa11 - a model defined in OpenAPI

        :param cw_astatus: The cw_astatus of this Cwa11.
        :param formal_count: The formal_count of this Cwa11.
        :param icon: The icon of this Cwa11.
        :param informal_count: The informal_count of this Cwa11.
        :param lat: The lat of this Cwa11.
        :param lon: The lon of this Cwa11.
        :param last_insp: The last_insp of this Cwa11.
        :param name: The name of this Cwa11.
        :param puv: The puv of this Cwa11.
        :param type: The type of this Cwa11.
        """
        self.openapi_types = {
            'cw_astatus': str,
            'formal_count': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Cwa11':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The cwa11 of this Cwa11.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def cw_astatus(self):
        """Gets the cw_astatus of this Cwa11.
        ...
        :return: The cw_astatus of this Cwa11.
        :rtype: str
        """
    ...
    def cw_astatus(self, cw_astatus):
        """Sets the cw_astatus of this Cwa11.
    ...
    def formal_count(self, formal_count):
        """Sets the formal_count of this Cwa11.
    ...
    @property
    def icon(self):
        """Gets the icon of this Cwa11.

        Name of each individual icon file within the URL base

        :return: The icon of this Cwa11.
        :rtype: str
        """
        return self._icon
    ...
    def informal_count(self, informal_count):
        """Sets the informal_count of this Cwa11.
    ...
    @property
    def last_insp(self):
        """Gets the last_insp of this Cwa11.

        The unique identifier for the last inspection

        :return: The last_insp of this Cwa11.
        :rtype: str
        """
    ...
    def last_insp(self, last_insp):
        """Sets the last_insp of this Cwa11.
    ...
    @property
    def type(self):
        """Gets the type of this Cwa11.

        For DFR, this is always facility

        :return: The type of this Cwa11.
        :rtype: str
        """
        return self._type
