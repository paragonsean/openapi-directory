...
async def cwa_rest_services_metadata_get(request: web.Request, output=None, param_callback=None) -> web.Response:
...
async def cwa_rest_services_metadata_post(request: web.Request, output=None, param_callback=None) -> web.Response:
    """Clean Water Act (CWA) Metadata Service
