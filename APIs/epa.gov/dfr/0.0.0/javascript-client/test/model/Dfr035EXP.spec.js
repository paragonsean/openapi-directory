...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr035EXP();
  });
  ...
  describe('Dfr035EXP', function() {
    it('should create an instance of Dfr035EXP', function() {
      // uncomment below and update the code to test Dfr035EXP
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr035EXP();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr035EXP);
    });
