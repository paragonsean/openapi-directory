...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr093();
  });
  ...
  describe('Dfr093', function() {
    it('should create an instance of Dfr093', function() {
      // uncomment below and update the code to test Dfr093
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr093();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr093);
    });
    ...
    it('should have the property visitReason (base name: "VisitReason")', function() {
      // uncomment below and update the code to test the property visitReason
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr093();
      //expect(instance).to.be();
    });
