...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr079S();
  });
  ...
  describe('Dfr079S', function() {
    it('should create an instance of Dfr079S', function() {
      // uncomment below and update the code to test Dfr079S
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr079S();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr079S);
    });
