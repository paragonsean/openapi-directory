...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr019();
  });
  ...
  describe('Dfr019', function() {
    it('should create an instance of Dfr019', function() {
      // uncomment below and update the code to test Dfr019
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr019();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr019);
    });
