...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr038EXP();
  });
  ...
  describe('Dfr038EXP', function() {
    it('should create an instance of Dfr038EXP', function() {
      // uncomment below and update the code to test Dfr038EXP
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr038EXP();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr038EXP);
    });
