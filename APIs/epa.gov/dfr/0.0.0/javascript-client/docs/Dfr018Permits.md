# USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr018Permits
...
**areas** | **String** | Clean Air Act stationary source program subpart designation, Clean Water Act-NPDES permit component(s), and/or other Resource Conservation and Recovery Act designations, if any. | 
**collectDesc** | **String** | ?? | 
**DQURL** | **String** | ?? | 
...
**expDate** | **String** | Date on which a given permit is scheduled to expire | 
...
**hasBioRpt** | **String** | Indicates if the facility has an associated Biosolids Facility Report. | 
**hasIcisSsoRpt** | **String** | ?? | 
**hdatumDesc** | **String** | ?? | 
**indianCountry** | **String** | Indicates whether the facility is located in Indian Country | 
**latitude** | **Number** | The latitude of the facility or permit holder as maintained in each data system. | 
**longitude** | **Number** | The longitude of the facility or permit holder as maintained in each data system | 
**NAICS** | **String** | The North American Industry Classification System codes | 
**refPointDesc** | **String** | ?? | 
