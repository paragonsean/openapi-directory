# USEpaEnforcementAndComplianceHistoryOnlineEchoDetailedFacilityReportDfr.Dfr079SViolations
...
**violation** | **String** | A designation of the type or nature of the violation. | 
**violationType** | **String** | Indicates whether a violation is a High Priority Violation (HPV) or a Federally Reportable Violation (FRV). | 
