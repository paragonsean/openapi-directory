...
/**
 * The Dfr093 model module.
 * @module model/Dfr093
 * @version 0.0.0
 */
class Dfr093 {
    /**
     * Constructs a new <code>Dfr093</code>.
     * Site Visit Object
     * @alias module:model/Dfr093
     ...
     * @param visitReason {String} Reason for the visit to the water system.
     */
    constructor(agency, dataVerification, distribution, financial, finishedWaterStorage, managementOperation, operatorCompliance, otherEvaluation, pumps, security, source, sourceID, treatment, visitDate, visitReason) { 
        
        Dfr093.initialize(this, agency, dataVerification, distribution, financial, finishedWaterStorage, managementOperation, operatorCompliance, otherEvaluation, pumps, security, source, sourceID, treatment, visitDate, visitReason);
    }
     ...
     */
    static initialize(obj, agency, dataVerification, distribution, financial, finishedWaterStorage, managementOperation, operatorCompliance, otherEvaluation, pumps, security, source, sourceID, treatment, visitDate, visitReason) { 
        obj['Agency'] = agency;
    ...
    /**
     * Constructs a <code>Dfr093</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Dfr093} obj Optional instance to populate.
     * @return {module:model/Dfr093} The populated <code>Dfr093</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('VisitReason')) {
                obj['VisitReason'] = ApiClient.convertToType(data['VisitReason'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Dfr093</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Dfr093</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Dfr093.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['VisitReason'] && !(typeof data['VisitReason'] === 'string' || data['VisitReason'] instanceof String)) {
            throw new Error("Expected the field `VisitReason` to be a primitive type in the JSON string but got " + data['VisitReason']);
        }
...
Dfr093.RequiredProperties = ["Agency", "DataVerification", "Distribution", "Financial", "FinishedWaterStorage", "ManagementOperation", "OperatorCompliance", "OtherEvaluation", "Pumps", "Security", "Source", "SourceID", "Treatment", "VisitDate", "VisitReason"];

/**
 * Identifies the lead agency (e.g., EPA, State) conducting the inspection.  Values: State abbreviation or \"EPA\"
 * @member {String} Agency
 */
Dfr093.prototype['Agency'] = undefined;
 ...
 */
Dfr093.prototype['DataVerification'] = undefined;
 ...
 */
Dfr093.prototype['Distribution'] = undefined;
 ...
 */
Dfr093.prototype['Financial'] = undefined;
 ...
 */
Dfr093.prototype['FinishedWaterStorage'] = undefined;
 ...
 */
Dfr093.prototype['ManagementOperation'] = undefined;
 ...
 */
Dfr093.prototype['OperatorCompliance'] = undefined;
 ...
 */
Dfr093.prototype['OtherEvaluation'] = undefined;
 ...
 * @member {String} Pumps
 */
Dfr093.prototype['Pumps'] = undefined;
 ...
 */
Dfr093.prototype['Security'] = undefined;
 ...
 */
Dfr093.prototype['Source'] = undefined;

/**
 * Unique Identifier assigned by EPA.
 * @member {String} SourceID
 */
Dfr093.prototype['SourceID'] = undefined;
 ...
 */
Dfr093.prototype['Treatment'] = undefined;

/**
 * Date of the sanitary survey.
 * @member {String} VisitDate
 */
Dfr093.prototype['VisitDate'] = undefined;

/**
 * Reason for the visit to the water system.
 * @member {String} VisitReason
 */
Dfr093.prototype['VisitReason'] = undefined;
