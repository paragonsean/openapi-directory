...
|------------ | ------------- | ------------- | -------------|
|**dateLastInspection** | **String** | The date on which the most recent inspection of the facility took place |  |
...
|**formalEnfActCount** | **String** | The number of formal enforcement actions that have been taken against the facility, under the corresponding statute, within the last five years. |  |
|**inspectionCount** | **String** | The total number of inspections pertaining to compliance of the designated statute |  |
