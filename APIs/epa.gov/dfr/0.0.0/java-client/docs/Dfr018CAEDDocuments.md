...
|------------ | ------------- | ------------- | -------------|
|**documentLink** | **String** | URLS for documents that EPA has colleted that are related to this Case. |  [optional] |
|**epAProgram** | **String** | The EPA Program associated with the Document URL |  [optional] |
|**facilityName** | **String** | The name of the facility. |  [optional] |
|**publishDate** | **String** | The date the document was published. |  [optional] |
