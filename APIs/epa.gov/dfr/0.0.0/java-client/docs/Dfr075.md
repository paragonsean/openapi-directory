...
|**naICSCode** | **String** | The North American Industry Classification System (NAICS) code |  |
|**naICSDesc** | **String** | The corresponding description of North American Industry Classification System (NAICS) code. |  |
