...
from openapi_server.models.eff06 import Eff06
from openapi_server.models.eff08 import Eff08
...
class Eff09(Model):
    ...
    def __init__(self, cwp_city: str=None, cwp_current_snc_status: str=None, cwp_major_minor_status_flag: str=None, cwp_name: str=None, cwp_permit_status_desc: str=None, cwp_permit_type_desc: str=None, cwp_state: str=None, cwp_street: str=None, cwp_zip: str=None, epa_system: str=None, end_date: str=None, linked_permits: List[Eff06]=None, message: str=None, perm_features: List[Eff08]=None, registry_id: str=None, source_id: str=None, start_date: str=None, statute: str=None):
        """Eff09 - a model defined in OpenAPI

        :param cwp_city: The cwp_city of this Eff09.
        :param cwp_current_snc_status: The cwp_current_snc_status of this Eff09.
        :param cwp_major_minor_status_flag: The cwp_major_minor_status_flag of this Eff09.
        :param cwp_name: The cwp_name of this Eff09.
        :param cwp_permit_status_desc: The cwp_permit_status_desc of this Eff09.
        :param cwp_permit_type_desc: The cwp_permit_type_desc of this Eff09.
        :param cwp_state: The cwp_state of this Eff09.
        :param cwp_street: The cwp_street of this Eff09.
        :param cwp_zip: The cwp_zip of this Eff09.
        :param epa_system: The epa_system of this Eff09.
        :param end_date: The end_date of this Eff09.
        :param linked_permits: The linked_permits of this Eff09.
        :param message: The message of this Eff09.
        :param perm_features: The perm_features of this Eff09.
        :param registry_id: The registry_id of this Eff09.
        :param source_id: The source_id of this Eff09.
        :param start_date: The start_date of this Eff09.
        :param statute: The statute of this Eff09.
        """
        self.openapi_types = {
            'cwp_city': str,
            ...
            'epa_system': str,
            'end_date': str,
            'linked_permits': List[Eff06],
            'message': str,
            'perm_features': List[Eff08],
            'registry_id': str,
            'source_id': str,
            'start_date': str,
            'statute': str
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Eff09':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The eff09 of this Eff09.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def cwp_city(self):
        """Gets the cwp_city of this Eff09.

        City in which the facility is located.

        :return: The cwp_city of this Eff09.
        :rtype: str
        """
    ...
    def cwp_city(self, cwp_city):
        """Sets the cwp_city of this Eff09.
    ...
    def cwp_current_snc_status(self, cwp_current_snc_status):
        """Sets the cwp_current_snc_status of this Eff09.
    ...
    def cwp_major_minor_status_flag(self):
        """Gets the cwp_major_minor_status_flag of this Eff09.

        Facilities marked \"M\" for major refers to CWA major permittees. - M = Major - N = Minor

        :return: The cwp_major_minor_status_flag of this Eff09.
        :rtype: str
        """
    ...
    def cwp_major_minor_status_flag(self, cwp_major_minor_status_flag):
        """Sets the cwp_major_minor_status_flag of this Eff09.
    ...
    @property
    def cwp_name(self):
        """Gets the cwp_name of this Eff09.

        Facility or permit holder name, as maintained in ICIS-NPDES.

        :return: The cwp_name of this Eff09.
        :rtype: str
        """
    ...
    def cwp_name(self, cwp_name):
        """Sets the cwp_name of this Eff09.
    ...
    def cwp_permit_status_desc(self):
        """Gets the cwp_permit_status_desc of this Eff09.

        The current stage/status in the NPDES permit life cycle.

        :return: The cwp_permit_status_desc of this Eff09.
        :rtype: str
        """
    ...
    def cwp_permit_status_desc(self, cwp_permit_status_desc):
        """Sets the cwp_permit_status_desc of this Eff09.
    ...
    def cwp_permit_type_desc(self):
        """Gets the cwp_permit_type_desc of this Eff09.
        ...
        :return: The cwp_permit_type_desc of this Eff09.
        :rtype: str
        """
    ...
    def cwp_permit_type_desc(self, cwp_permit_type_desc):
        """Sets the cwp_permit_type_desc of this Eff09.
    ...
    @property
    def cwp_state(self):
        """Gets the cwp_state of this Eff09.

        Facility location - two-digit state abbreviation.

        :return: The cwp_state of this Eff09.
        :rtype: str
        """
    ...
    def cwp_state(self, cwp_state):
        """Sets the cwp_state of this Eff09.
    ...
    @property
    def cwp_street(self):
        """Gets the cwp_street of this Eff09.

        Facility street address

        :return: The cwp_street of this Eff09.
        :rtype: str
        """
    ...
    def cwp_street(self, cwp_street):
        """Sets the cwp_street of this Eff09.
    ...
    @property
    def cwp_zip(self):
        """Gets the cwp_zip of this Eff09.

        Facility ZIP code

        :return: The cwp_zip of this Eff09.
        :rtype: str
        """
    ...
    def cwp_zip(self, cwp_zip):
        """Sets the cwp_zip of this Eff09.
    ...
    @property
    def epa_system(self):
        """Gets the epa_system of this Eff09.
        ...
        :return: The epa_system of this Eff09.
        :rtype: str
        """
    ...
    def epa_system(self, epa_system):
        """Sets the epa_system of this Eff09.
    ...
    @property
    def end_date(self):
        """Gets the end_date of this Eff09.

        End date for the date range of interest. Formatted as mm/dd/yyyy

        :return: The end_date of this Eff09.
        :rtype: str
        """
    ...
    def end_date(self, end_date):
        """Sets the end_date of this Eff09.
    ...
    def linked_permits(self):
        """Gets the linked_permits of this Eff09.


        :return: The linked_permits of this Eff09.
        :rtype: List[Eff06]
        """
    ...
    def linked_permits(self, linked_permits):
        """Sets the linked_permits of this Eff09.


        :param linked_permits: The linked_permits of this Eff09.
        :type linked_permits: List[Eff06]
        """
    ...
    def message(self, message):
        """Sets the message of this Eff09.
    ...
    def perm_features(self):
        """Gets the perm_features of this Eff09.


        :return: The perm_features of this Eff09.
        :rtype: List[Eff08]
        """
    ...
    def perm_features(self, perm_features):
        """Sets the perm_features of this Eff09.


        :param perm_features: The perm_features of this Eff09.
        :type perm_features: List[Eff08]
        """
    ...
    def registry_id(self):
        """Gets the registry_id of this Eff09.
        ...
        :return: The registry_id of this Eff09.
        :rtype: str
        """
    ...
    def registry_id(self, registry_id):
        """Sets the registry_id of this Eff09.
    ...
    @property
    def source_id(self):
        """Gets the source_id of this Eff09.

        Unique Identifier assigned by EPA.

        :return: The source_id of this Eff09.
        :rtype: str
        """
    ...
    def source_id(self, source_id):
        """Sets the source_id of this Eff09.
    ...
    @property
    def start_date(self):
        """Gets the start_date of this Eff09.

        Starting date for the date range of interest. Formatted as mm/dd/yyyy

        :return: The start_date of this Eff09.
        :rtype: str
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this Eff09.
    ...
    @property
    def statute(self):
        """Gets the statute of this Eff09.
        ...
        :return: The statute of this Eff09.
        :rtype: str
        """
    ...
    def statute(self, statute):
        """Sets the statute of this Eff09.
