...
import org.openapitools.client.model.Eff06;
import org.openapitools.client.model.Eff08;
...
public class Eff09 {
  ...
  public static final String SERIALIZED_NAME_LINKED_PERMITS = "LinkedPermits";
  @SerializedName(SERIALIZED_NAME_LINKED_PERMITS)
  private List<Eff06> linkedPermits = new ArrayList<>();
  ...
  private List<Eff08> permFeatures = new ArrayList<>();
  ...
  public Eff09 cwPCity(String cwPCity) {
  ...
  public Eff09 cwPCurrentSNCStatus(String cwPCurrentSNCStatus) {
  ...
  public Eff09 cwPMajorMinorStatusFlag(String cwPMajorMinorStatusFlag) {
  ...
  public Eff09 cwPName(String cwPName) {
  ...
  public Eff09 cwPPermitStatusDesc(String cwPPermitStatusDesc) {
  ...
  public Eff09 cwPPermitTypeDesc(String cwPPermitTypeDesc) {
  ...
  public Eff09 cwPState(String cwPState) {
  ...
  public Eff09 cwPStreet(String cwPStreet) {
  ...
  public Eff09 cwPZip(String cwPZip) {
    this.cwPZip = cwPZip;
    return this;
  }
  ...
  public Eff09 epASystem(String epASystem) {
  ...
  public Eff09 endDate(String endDate) {
  ...
  public Eff09 linkedPermits(List<Eff06> linkedPermits) {
    this.linkedPermits = linkedPermits;
    return this;
  }

  public Eff09 addLinkedPermitsItem(Eff06 linkedPermitsItem) {
    if (this.linkedPermits == null) {
      this.linkedPermits = new ArrayList<>();
    }
    this.linkedPermits.add(linkedPermitsItem);
    return this;
  }

  /**
   * Get linkedPermits
   * @return linkedPermits
   */
  @javax.annotation.Nullable
  public List<Eff06> getLinkedPermits() {
    return linkedPermits;
  }

  public void setLinkedPermits(List<Eff06> linkedPermits) {
    this.linkedPermits = linkedPermits;
  }


  public Eff09 message(String message) {
  ...
  public Eff09 permFeatures(List<Eff08> permFeatures) {
    this.permFeatures = permFeatures;
    return this;
  }

  public Eff09 addPermFeaturesItem(Eff08 permFeaturesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Eff08> getPermFeatures() {
    return permFeatures;
  }

  public void setPermFeatures(List<Eff08> permFeatures) {
    this.permFeatures = permFeatures;
  }


  public Eff09 registryId(String registryId) {
  ...
  public Eff09 sourceId(String sourceId) {
  ...
  public Eff09 startDate(String startDate) {
  ...
  public Eff09 statute(String statute) {
  ...
  public boolean equals(Object o) {
    ...
    Eff09 eff09 = (Eff09) o;
    return Objects.equals(this.cwPCity, eff09.cwPCity) &&
        Objects.equals(this.cwPCurrentSNCStatus, eff09.cwPCurrentSNCStatus) &&
        Objects.equals(this.cwPMajorMinorStatusFlag, eff09.cwPMajorMinorStatusFlag) &&
        Objects.equals(this.cwPName, eff09.cwPName) &&
        Objects.equals(this.cwPPermitStatusDesc, eff09.cwPPermitStatusDesc) &&
        Objects.equals(this.cwPPermitTypeDesc, eff09.cwPPermitTypeDesc) &&
        Objects.equals(this.cwPState, eff09.cwPState) &&
        Objects.equals(this.cwPStreet, eff09.cwPStreet) &&
        Objects.equals(this.cwPZip, eff09.cwPZip) &&
        Objects.equals(this.epASystem, eff09.epASystem) &&
        Objects.equals(this.endDate, eff09.endDate) &&
        Objects.equals(this.linkedPermits, eff09.linkedPermits) &&
        Objects.equals(this.message, eff09.message) &&
        Objects.equals(this.permFeatures, eff09.permFeatures) &&
        Objects.equals(this.registryId, eff09.registryId) &&
        Objects.equals(this.sourceId, eff09.sourceId) &&
        Objects.equals(this.startDate, eff09.startDate) &&
        Objects.equals(this.statute, eff09.statute);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cwPCity, cwPCurrentSNCStatus, cwPMajorMinorStatusFlag, cwPName, cwPPermitStatusDesc, cwPPermitTypeDesc, cwPState, cwPStreet, cwPZip, epASystem, endDate, linkedPermits, message, permFeatures, registryId, sourceId, startDate, statute);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Eff09 {\n");
    ...
    sb.append("    linkedPermits: ").append(toIndentedString(linkedPermits)).append("\n");
  ...
  static {
    ...
    openapiFields.add("LinkedPermits");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Eff09
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Eff09.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Eff09 is not found in the empty JSON string", Eff09.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Eff09.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Eff09` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Eff09.openapiRequiredFields) {
      ...
      if (jsonObj.get("LinkedPermits") != null && !jsonObj.get("LinkedPermits").isJsonNull()) {
        JsonArray jsonArraylinkedPermits = jsonObj.getAsJsonArray("LinkedPermits");
        if (jsonArraylinkedPermits != null) {
          // ensure the json data is an array
          if (!jsonObj.get("LinkedPermits").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `LinkedPermits` to be an array in the JSON string but got `%s`", jsonObj.get("LinkedPermits").toString()));
          }

          // validate the optional field `LinkedPermits` (array)
          for (int i = 0; i < jsonArraylinkedPermits.size(); i++) {
            Eff06.validateJsonElement(jsonArraylinkedPermits.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("PermFeatures") != null && !jsonObj.get("PermFeatures").isJsonNull()) {
        ...
        if (jsonArraypermFeatures != null) {
          ...
          for (int i = 0; i < jsonArraypermFeatures.size(); i++) {
            Eff08.validateJsonElement(jsonArraypermFeatures.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Eff09.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Eff09' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Eff09> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Eff09.class));

       return (TypeAdapter<T>) new TypeAdapter<Eff09>() {
           @Override
           public void write(JsonWriter out, Eff09 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Eff09 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Eff09 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Eff09
   * @throws IOException if the JSON string is invalid with respect to Eff09
   */
  public static Eff09 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Eff09.class);
  }

  /**
   * Convert an instance of Eff09 to an JSON string
   *
   * @return JSON string
   */
