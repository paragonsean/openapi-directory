...
import org.openapitools.client.model.Eff07;
...
public class Eff08 {
  ...
  private List<Eff07> parameters = new ArrayList<>();
  ...
  public Eff08 parameters(List<Eff07> parameters) {
    this.parameters = parameters;
    return this;
  }

  public Eff08 addParametersItem(Eff07 parametersItem) {
  ...
  public List<Eff07> getParameters() {
    return parameters;
  }

  public void setParameters(List<Eff07> parameters) {
    this.parameters = parameters;
  }


  public Eff08 permFeatureNmbr(String permFeatureNmbr) {
  ...
  public Eff08 permFeatureTypeCode(String permFeatureTypeCode) {
  ...
  public Eff08 permFeatureTypeDesc(String permFeatureTypeDesc) {
  ...
  public boolean equals(Object o) {
    ...
    Eff08 eff08 = (Eff08) o;
    return Objects.equals(this.parameters, eff08.parameters) &&
        Objects.equals(this.permFeatureNmbr, eff08.permFeatureNmbr) &&
        Objects.equals(this.permFeatureTypeCode, eff08.permFeatureTypeCode) &&
        Objects.equals(this.permFeatureTypeDesc, eff08.permFeatureTypeDesc);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Eff08
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Eff08.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Eff08 is not found in the empty JSON string", Eff08.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Eff08.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Eff08` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Eff08.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayparameters.size(); i++) {
        Eff07.validateJsonElement(jsonArrayparameters.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Eff08.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Eff08' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Eff08> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Eff08.class));

       return (TypeAdapter<T>) new TypeAdapter<Eff08>() {
           @Override
           public void write(JsonWriter out, Eff08 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Eff08 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Eff08 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Eff08
   * @throws IOException if the JSON string is invalid with respect to Eff08
   */
  public static Eff08 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Eff08.class);
  }

  /**
   * Convert an instance of Eff08 to an JSON string
   *
   * @return JSON string
   */
