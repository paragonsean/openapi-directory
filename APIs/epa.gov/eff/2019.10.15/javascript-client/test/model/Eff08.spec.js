...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff08();
  });
  ...
  describe('Eff08', function() {
    it('should create an instance of Eff08', function() {
      // uncomment below and update the code to test Eff08
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff08();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff08);
    });
