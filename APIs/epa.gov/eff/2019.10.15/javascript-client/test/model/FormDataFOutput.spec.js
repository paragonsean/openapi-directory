...
(function(root, factory) {
  ...
  describe('FormDataFOutput', function() {
    it('should create an instance of FormDataFOutput', function() {
      // uncomment below and update the code to test FormDataFOutput
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.FormDataFOutput();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.FormDataFOutput);
    });
