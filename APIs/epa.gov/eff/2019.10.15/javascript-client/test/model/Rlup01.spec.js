...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Rlup01();
  });
  ...
  describe('Rlup01', function() {
    it('should create an instance of Rlup01', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Rlup01();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Rlup01);
    });
