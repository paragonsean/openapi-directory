...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.EffRestServicesGetSummaryChartGet200Response();
  });
  ...
  describe('EffRestServicesGetSummaryChartGet200Response', function() {
    it('should create an instance of EffRestServicesGetSummaryChartGet200Response', function() {
      // uncomment below and update the code to test EffRestServicesGetSummaryChartGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.EffRestServicesGetSummaryChartGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.EffRestServicesGetSummaryChartGet200Response);
    });
