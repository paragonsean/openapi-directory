...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff07();
  });
  ...
  describe('Eff07', function() {
    it('should create an instance of Eff07', function() {
      // uncomment below and update the code to test Eff07
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff07();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff07);
    });

    it('should have the property currentVioStatus (base name: "CurrentVioStatus")', function() {
      // uncomment below and update the code to test the property currentVioStatus
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff07();
      //expect(instance).to.be();
    });

    it('should have the property maxVioStatus (base name: "MaxVioStatus")', function() {
      // uncomment below and update the code to test the property maxVioStatus
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEffluentChartingAndReporting.Eff07();
      //expect(instance).to.be();
    });
