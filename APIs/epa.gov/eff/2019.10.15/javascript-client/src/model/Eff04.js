...
import Eff03 from './Eff03';

/**
 * The Eff04 model module.
 * @module model/Eff04
 * @version 2019.10.15
 */
class Eff04 {
    /**
     * Constructs a new <code>Eff04</code>.
     * Permit Features Object
     * @alias module:model/Eff04
     * @param parameters {Array.<module:model/Eff03>} Array of Effuent Limit Parameters
    ...
    constructor(parameters, permFeatureNmbr, permFeatureTypeCode, permFeatureTypeDesc) { 
        ...
        Eff04.initialize(this, parameters, permFeatureNmbr, permFeatureTypeCode, permFeatureTypeDesc);
    }
    ...
    /**
     * Constructs a <code>Eff04</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Eff04} obj Optional instance to populate.
     * @return {module:model/Eff04} The populated <code>Eff04</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Parameters')) {
                obj['Parameters'] = ApiClient.convertToType(data['Parameters'], [Eff03]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Eff04</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Eff04</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Eff04.RequiredProperties) {
...
Eff04.RequiredProperties = ["Parameters", "PermFeatureNmbr", "PermFeatureTypeCode", "PermFeatureTypeDesc"];

/**
 * Array of Effuent Limit Parameters
 * @member {Array.<module:model/Eff03>} Parameters
 */
Eff04.prototype['Parameters'] = undefined;
 ...
 */
Eff04.prototype['PermFeatureTypeDesc'] = undefined;
