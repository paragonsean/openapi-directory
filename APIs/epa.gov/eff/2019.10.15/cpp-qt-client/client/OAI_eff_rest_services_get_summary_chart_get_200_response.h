...
/*
 * OAI_eff_rest_services_get_summary_chart_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_eff_rest_services_get_summary_chart_get_200_response_H
#define OAI_eff_rest_services_get_summary_chart_get_200_response_H
...
class OAI_eff_rest_services_get_summary_chart_get_200_response : public OAIObject {
public:
    OAI_eff_rest_services_get_summary_chart_get_200_response();
    OAI_eff_rest_services_get_summary_chart_get_200_response(QString json);
    ~OAI_eff_rest_services_get_summary_chart_get_200_response() override;
    ...
    OAIEff09 getResults() const;
    void setResults(const OAIEff09 &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_eff_rest_services_get_summary_chart_get_200_response)

#endif // OAI_eff_rest_services_get_summary_chart_get_200_response_H
