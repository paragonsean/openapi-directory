...
class OAIEff09 : public OAIObject {
public:
    OAIEff09();
    OAIEff09(QString json);
    ~OAIEff09() override;
    ...
    QList<OAIEff06> getLinkedPermits() const;
    void setLinkedPermits(const QList<OAIEff06> &linked_permits);
    bool is_linked_permits_Set() const;
    bool is_linked_permits_Valid() const;
    ...
    QList<OAIEff08> getPermFeatures() const;
    void setPermFeatures(const QList<OAIEff08> &perm_features);
...
private:
    ...
    QList<OAIEff06> m_linked_permits;
    bool m_linked_permits_isSet;
    bool m_linked_permits_isValid;

    QString m_message;
    bool m_message_isSet;
    bool m_message_isValid;

    QList<OAIEff08> m_perm_features;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEff09)
