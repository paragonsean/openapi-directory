...
class OAIEff08 : public OAIObject {
public:
    OAIEff08();
    OAIEff08(QString json);
    ~OAIEff08() override;
    ...
    QList<OAIEff07> getParameters() const;
    void setParameters(const QList<OAIEff07> &parameters);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEff08)
