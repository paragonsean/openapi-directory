...
#include "OAIFormData_f_p_pswvio.h"
...
OAIFormData_f_p_pswvio::OAIFormData_f_p_pswvio(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_pswvio::OAIFormData_f_p_pswvio() {
    this->initializeModel();
}

OAIFormData_f_p_pswvio::~OAIFormData_f_p_pswvio() {}

void OAIFormData_f_p_pswvio::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_pswvio::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_pswvio::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_pswvio::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_pswvio::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_pswvio::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_pswvio::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_pswvio::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_pswvio::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_pswvio::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_pswvio::eOAIFormData_f_p_pswvio OAIFormData_f_p_pswvio::getValue() const {
    return m_value;
}

void OAIFormData_f_p_pswvio::setValue(const OAIFormData_f_p_pswvio::eOAIFormData_f_p_pswvio& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_pswvio::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_pswvio::isValid() const {
