...
#include "OAIFormData_f_p_other.h"
...
OAIFormData_f_p_other::OAIFormData_f_p_other(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_other::OAIFormData_f_p_other() {
    this->initializeModel();
}

OAIFormData_f_p_other::~OAIFormData_f_p_other() {}

void OAIFormData_f_p_other::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_other::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_other::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_other::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_other::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_other::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_other::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_other::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_other::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_other::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_other::eOAIFormData_f_p_other OAIFormData_f_p_other::getValue() const {
    return m_value;
}

void OAIFormData_f_p_other::setValue(const OAIFormData_f_p_other::eOAIFormData_f_p_other& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_other::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_other::isValid() const {
