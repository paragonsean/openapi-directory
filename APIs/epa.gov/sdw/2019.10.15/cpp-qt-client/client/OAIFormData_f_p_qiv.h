...
#ifndef OAIFormData_f_p_qiv_H
#define OAIFormData_f_p_qiv_H
...
class OAIFormData_f_p_qiv : public OAIEnum {
public:
    OAIFormData_f_p_qiv();
    OAIFormData_f_p_qiv(QString json);
    ~OAIFormData_f_p_qiv() override;
    ...
    enum class eOAIFormData_f_p_qiv {
    ...
    OAIFormData_f_p_qiv::eOAIFormData_f_p_qiv getValue() const;
    void setValue(const OAIFormData_f_p_qiv::eOAIFormData_f_p_qiv& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_qiv)

#endif // OAIFormData_f_p_qiv_H
