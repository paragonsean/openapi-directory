...
#include "OAIFormData_f_p_ieaa.h"
...
OAIFormData_f_p_ieaa::OAIFormData_f_p_ieaa(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_ieaa::OAIFormData_f_p_ieaa() {
    this->initializeModel();
}

OAIFormData_f_p_ieaa::~OAIFormData_f_p_ieaa() {}

void OAIFormData_f_p_ieaa::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_ieaa::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_ieaa::fromJson(QString jsonString) {
    
    if ( jsonString.compare("E", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_ieaa::E;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("S", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_ieaa::S;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_ieaa::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_ieaa::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_ieaa::E:
            val = "E";
            break;
        case eOAIFormData_f_p_ieaa::S:
            val = "S";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_ieaa::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_ieaa::eOAIFormData_f_p_ieaa OAIFormData_f_p_ieaa::getValue() const {
    return m_value;
}

void OAIFormData_f_p_ieaa::setValue(const OAIFormData_f_p_ieaa::eOAIFormData_f_p_ieaa& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_ieaa::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_ieaa::isValid() const {
