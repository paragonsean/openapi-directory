...
OAIFormData_f_p_sv::OAIFormData_f_p_sv(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_sv::OAIFormData_f_p_sv() {
    this->initializeModel();
}

OAIFormData_f_p_sv::~OAIFormData_f_p_sv() {}

void OAIFormData_f_p_sv::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_sv::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_sv::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sv::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sv::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_sv::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_sv::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_sv::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_sv::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_sv::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_sv::eOAIFormData_f_p_sv OAIFormData_f_p_sv::getValue() const {
    return m_value;
}

void OAIFormData_f_p_sv::setValue(const OAIFormData_f_p_sv::eOAIFormData_f_p_sv& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_sv::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_sv::isValid() const {
