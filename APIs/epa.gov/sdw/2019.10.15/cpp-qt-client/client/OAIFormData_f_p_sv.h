...
/*
 * OAIFormData_f_p_sv.h
 *
 * Serious Violator (unresolved serious, multiple, and/or continuing violations). A value of Y will return only SDWIS systems that are Serious Violators, while a value of N will only return SDWIS Systems that are not Serious Violators.
 */

#ifndef OAIFormData_f_p_sv_H
#define OAIFormData_f_p_sv_H
...
class OAIFormData_f_p_sv : public OAIEnum {
public:
    OAIFormData_f_p_sv();
    OAIFormData_f_p_sv(QString json);
    ~OAIFormData_f_p_sv() override;
    ...
    enum class eOAIFormData_f_p_sv {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_sv::eOAIFormData_f_p_sv getValue() const;
    void setValue(const OAIFormData_f_p_sv::eOAIFormData_f_p_sv& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_sv)

#endif // OAIFormData_f_p_sv_H
