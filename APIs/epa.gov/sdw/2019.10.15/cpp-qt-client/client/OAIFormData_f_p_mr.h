...
#ifndef OAIFormData_f_p_mr_H
#define OAIFormData_f_p_mr_H
...
class OAIFormData_f_p_mr : public OAIEnum {
public:
    OAIFormData_f_p_mr();
    OAIFormData_f_p_mr(QString json);
    ~OAIFormData_f_p_mr() override;
    ...
    enum class eOAIFormData_f_p_mr {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_mr::eOAIFormData_f_p_mr getValue() const;
    void setValue(const OAIFormData_f_p_mr::eOAIFormData_f_p_mr& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_mr)

#endif // OAIFormData_f_p_mr_H
