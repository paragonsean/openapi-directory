...
OAIFormData_f_p_mr::OAIFormData_f_p_mr(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_mr::OAIFormData_f_p_mr() {
    this->initializeModel();
}

OAIFormData_f_p_mr::~OAIFormData_f_p_mr() {}

void OAIFormData_f_p_mr::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_mr::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_mr::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_mr::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_mr::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_mr::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_mr::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_mr::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_mr::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_mr::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_mr::eOAIFormData_f_p_mr OAIFormData_f_p_mr::getValue() const {
    return m_value;
}

void OAIFormData_f_p_mr::setValue(const OAIFormData_f_p_mr::eOAIFormData_f_p_mr& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_mr::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_mr::isValid() const {
