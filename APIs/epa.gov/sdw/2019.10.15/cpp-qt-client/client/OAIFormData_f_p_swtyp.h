...
#ifndef OAIFormData_f_p_swtyp_H
#define OAIFormData_f_p_swtyp_H
...
class OAIFormData_f_p_swtyp : public OAIEnum {
public:
    OAIFormData_f_p_swtyp();
    OAIFormData_f_p_swtyp(QString json);
    ~OAIFormData_f_p_swtyp() override;
    ...
    enum class eOAIFormData_f_p_swtyp {
    ...
    OAIFormData_f_p_swtyp::eOAIFormData_f_p_swtyp getValue() const;
    void setValue(const OAIFormData_f_p_swtyp::eOAIFormData_f_p_swtyp& value);
...
private:
    ...
    eOAIFormData_f_p_swtyp m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_swtyp)

#endif // OAIFormData_f_p_swtyp_H
