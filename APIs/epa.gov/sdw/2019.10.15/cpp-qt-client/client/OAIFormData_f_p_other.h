...
class OAIFormData_f_p_other : public OAIEnum {
public:
    OAIFormData_f_p_other();
    OAIFormData_f_p_other(QString json);
    ~OAIFormData_f_p_other() override;
    ...
    enum class eOAIFormData_f_p_other {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_other::eOAIFormData_f_p_other getValue() const;
    void setValue(const OAIFormData_f_p_other::eOAIFormData_f_p_other& value);
...
private:
    ...
    eOAIFormData_f_p_other m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_other)

#endif // OAIFormData_f_p_other_H
