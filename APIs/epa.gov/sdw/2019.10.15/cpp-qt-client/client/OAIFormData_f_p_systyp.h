...
#ifndef OAIFormData_f_p_systyp_H
#define OAIFormData_f_p_systyp_H
...
class OAIFormData_f_p_systyp : public OAIEnum {
public:
    OAIFormData_f_p_systyp();
    OAIFormData_f_p_systyp(QString json);
    ~OAIFormData_f_p_systyp() override;
    ...
    enum class eOAIFormData_f_p_systyp {
    ...
    OAIFormData_f_p_systyp::eOAIFormData_f_p_systyp getValue() const;
    void setValue(const OAIFormData_f_p_systyp::eOAIFormData_f_p_systyp& value);
...
private:
    ...
    eOAIFormData_f_p_systyp m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_systyp)

#endif // OAIFormData_f_p_systyp_H
