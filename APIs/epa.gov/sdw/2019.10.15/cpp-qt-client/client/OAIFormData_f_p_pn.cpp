...
OAIFormData_f_p_pn::OAIFormData_f_p_pn(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_pn::OAIFormData_f_p_pn() {
    this->initializeModel();
}

OAIFormData_f_p_pn::~OAIFormData_f_p_pn() {}

void OAIFormData_f_p_pn::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_pn::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_pn::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_pn::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_pn::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_pn::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_pn::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_pn::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_pn::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_pn::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_pn::eOAIFormData_f_p_pn OAIFormData_f_p_pn::getValue() const {
    return m_value;
}

void OAIFormData_f_p_pn::setValue(const OAIFormData_f_p_pn::eOAIFormData_f_p_pn& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_pn::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_pn::isValid() const {
