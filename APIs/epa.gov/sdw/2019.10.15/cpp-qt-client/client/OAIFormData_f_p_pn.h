...
class OAIFormData_f_p_pn : public OAIEnum {
public:
    OAIFormData_f_p_pn();
    OAIFormData_f_p_pn(QString json);
    ~OAIFormData_f_p_pn() override;
    ...
    enum class eOAIFormData_f_p_pn {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_pn::eOAIFormData_f_p_pn getValue() const;
    void setValue(const OAIFormData_f_p_pn::eOAIFormData_f_p_pn& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_pn)

#endif // OAIFormData_f_p_pn_H
