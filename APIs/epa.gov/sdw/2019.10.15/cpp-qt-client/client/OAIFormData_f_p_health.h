...
#ifndef OAIFormData_f_p_health_H
#define OAIFormData_f_p_health_H
...
class OAIFormData_f_p_health : public OAIEnum {
public:
    OAIFormData_f_p_health();
    OAIFormData_f_p_health(QString json);
    ~OAIFormData_f_p_health() override;
    ...
    enum class eOAIFormData_f_p_health {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_health::eOAIFormData_f_p_health getValue() const;
    void setValue(const OAIFormData_f_p_health::eOAIFormData_f_p_health& value);
...
private:
    ...
    eOAIFormData_f_p_health m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_health)

#endif // OAIFormData_f_p_health_H
