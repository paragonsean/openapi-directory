...
#ifndef OAIFormData_f_descending_H
#define OAIFormData_f_descending_H
...
class OAIFormData_f_descending : public OAIEnum {
public:
    OAIFormData_f_descending();
    OAIFormData_f_descending(QString json);
    ~OAIFormData_f_descending() override;
    ...
    enum class eOAIFormData_f_descending {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_descending::eOAIFormData_f_descending getValue() const;
    void setValue(const OAIFormData_f_descending::eOAIFormData_f_descending& value);
...
private:
    ...
    eOAIFormData_f_descending m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_descending)

#endif // OAIFormData_f_descending_H
