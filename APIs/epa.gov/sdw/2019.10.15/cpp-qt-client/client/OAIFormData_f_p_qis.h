...
#ifndef OAIFormData_f_p_qis_H
#define OAIFormData_f_p_qis_H
...
class OAIFormData_f_p_qis : public OAIEnum {
public:
    OAIFormData_f_p_qis();
    OAIFormData_f_p_qis(QString json);
    ~OAIFormData_f_p_qis() override;
    ...
    enum class eOAIFormData_f_p_qis {
    ...
    OAIFormData_f_p_qis::eOAIFormData_f_p_qis getValue() const;
    void setValue(const OAIFormData_f_p_qis::eOAIFormData_f_p_qis& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_qis)

#endif // OAIFormData_f_p_qis_H
