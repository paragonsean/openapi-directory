...
/*
 * OAI_sdw_rest_services_get_qid_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_sdw_rest_services_get_qid_get_200_response_H
#define OAI_sdw_rest_services_get_qid_get_200_response_H
...
class OAI_sdw_rest_services_get_qid_get_200_response : public OAIObject {
public:
    OAI_sdw_rest_services_get_qid_get_200_response();
    OAI_sdw_rest_services_get_qid_get_200_response(QString json);
    ~OAI_sdw_rest_services_get_qid_get_200_response() override;
    ...
    OAISdw02 getResults() const;
    void setResults(const OAISdw02 &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_sdw_rest_services_get_qid_get_200_response)

#endif // OAI_sdw_rest_services_get_qid_get_200_response_H
