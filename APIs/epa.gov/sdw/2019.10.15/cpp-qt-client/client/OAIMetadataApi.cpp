...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("sdwRestServicesMetadataGet", defaultConf);
    _serverIndices.insert("sdwRestServicesMetadataGet", 0);
    _serverConfigs.insert("sdwRestServicesMetadataPost", defaultConf);
    _serverIndices.insert("sdwRestServicesMetadataPost", 0);
}
...
void OAIMetadataApi::sdwRestServicesMetadataGet(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["sdwRestServicesMetadataGet"][_serverIndices.value("sdwRestServicesMetadataGet")].URL()+"/sdw_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::sdwRestServicesMetadataGetCallback);
...
void OAIMetadataApi::sdwRestServicesMetadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_sdw_rest_services_metadata_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sdwRestServicesMetadataGetSignal(output);
        Q_EMIT sdwRestServicesMetadataGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sdwRestServicesMetadataGetSignalE(output, error_type, error_str);
        Q_EMIT sdwRestServicesMetadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sdwRestServicesMetadataGetSignalError(output, error_type, error_str);
        Q_EMIT sdwRestServicesMetadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::sdwRestServicesMetadataPost(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["sdwRestServicesMetadataPost"][_serverIndices.value("sdwRestServicesMetadataPost")].URL()+"/sdw_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::sdwRestServicesMetadataPostCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::sdwRestServicesMetadataPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT sdwRestServicesMetadataPostSignal(output);
        Q_EMIT sdwRestServicesMetadataPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT sdwRestServicesMetadataPostSignalE(output, error_type, error_str);
        Q_EMIT sdwRestServicesMetadataPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT sdwRestServicesMetadataPostSignalError(output, error_type, error_str);
        Q_EMIT sdwRestServicesMetadataPostSignalErrorFull(worker, error_type, error_str);
    }
}
