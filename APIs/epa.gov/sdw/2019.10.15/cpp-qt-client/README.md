...
#include <iostream>
#include "../client/OAIMetadataApi.h"
...
void Example::exampleFunction1(){
     OAIMetadataApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIMetadataApi::sdwRestServicesMetadataGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIMetadataApi::sdwRestServicesMetadataGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.sdwRestServicesMetadataGet(outputcallback);
