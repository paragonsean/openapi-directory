...
/**
* Enum class FormDataFPQis.
* @enum {}
* @readonly
*/
export default class FormDataFPQis {
    ...
    /**
    * Returns a <code>FormDataFPQis</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPQis} The enum <code>FormDataFPQis</code> value.
    */
