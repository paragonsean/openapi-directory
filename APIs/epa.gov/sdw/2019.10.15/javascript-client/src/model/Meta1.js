...
class Meta1 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ResultColumns')) {
                obj['ResultColumns'] = ApiClient.convertToType(data['ResultColumns'], [Meta3]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['ResultColumns']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['ResultColumns'])) {
                throw new Error("Expected the field `ResultColumns` to be an array in the JSON data but got " + data['ResultColumns']);
            }
            // validate the optional field `ResultColumns` (array)
            for (const item of data['ResultColumns']) {
                Meta3.validateJSON(item);
            };
        }
...
Meta1.RequiredProperties = ["Message"];

/**
 * Field to record messages (typically performance-related) about packet processing
 * @member {String} Message
 */
Meta1.prototype['Message'] = undefined;

/**
 * @member {Array.<module:model/Meta3>} ResultColumns
 */
Meta1.prototype['ResultColumns'] = undefined;
