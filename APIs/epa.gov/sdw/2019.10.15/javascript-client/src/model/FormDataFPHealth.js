...
/**
* Enum class FormDataFPHealth.
* @enum {}
* @readonly
*/
export default class FormDataFPHealth {
    ...
    /**
    * Returns a <code>FormDataFPHealth</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPHealth} The enum <code>FormDataFPHealth</code> value.
    */
