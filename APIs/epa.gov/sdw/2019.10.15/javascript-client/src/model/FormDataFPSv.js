...
/**
* Enum class FormDataFPSv.
* @enum {}
* @readonly
*/
export default class FormDataFPSv {
    ...
    /**
    * Returns a <code>FormDataFPSv</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSv} The enum <code>FormDataFPSv</code> value.
    */
