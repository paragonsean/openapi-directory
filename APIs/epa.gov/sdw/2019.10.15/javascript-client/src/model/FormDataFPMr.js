...
/**
* Enum class FormDataFPMr.
* @enum {}
* @readonly
*/
export default class FormDataFPMr {
    ...
    /**
    * Returns a <code>FormDataFPMr</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMr} The enum <code>FormDataFPMr</code> value.
    */
