...
/**
* Enum class FormDataFPSystyp.
* @enum {}
* @readonly
*/
export default class FormDataFPSystyp {
    ...
    /**
    * Returns a <code>FormDataFPSystyp</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSystyp} The enum <code>FormDataFPSystyp</code> value.
    */
