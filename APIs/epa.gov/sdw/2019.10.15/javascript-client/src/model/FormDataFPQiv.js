...
/**
* Enum class FormDataFPQiv.
* @enum {}
* @readonly
*/
export default class FormDataFPQiv {
    ...
    /**
    * Returns a <code>FormDataFPQiv</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPQiv} The enum <code>FormDataFPQiv</code> value.
    */
