...
/**
* Enum class FormDataFPPn.
* @enum {}
* @readonly
*/
export default class FormDataFPPn {
    ...
    /**
    * Returns a <code>FormDataFPPn</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPn} The enum <code>FormDataFPPn</code> value.
    */
