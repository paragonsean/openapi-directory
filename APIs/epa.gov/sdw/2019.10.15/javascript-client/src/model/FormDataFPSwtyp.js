...
/**
* Enum class FormDataFPSwtyp.
* @enum {}
* @readonly
*/
export default class FormDataFPSwtyp {
    ...
    /**
    * Returns a <code>FormDataFPSwtyp</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSwtyp} The enum <code>FormDataFPSwtyp</code> value.
    */
