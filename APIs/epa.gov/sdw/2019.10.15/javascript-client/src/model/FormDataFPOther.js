...
/**
* Enum class FormDataFPOther.
* @enum {}
* @readonly
*/
export default class FormDataFPOther {
    ...
    /**
    * Returns a <code>FormDataFPOther</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPOther} The enum <code>FormDataFPOther</code> value.
    */
