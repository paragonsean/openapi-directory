...
/**
* Enum class FormDataFPAct.
* @enum {}
* @readonly
*/
export default class FormDataFPAct {
    ...
    /**
    * Returns a <code>FormDataFPAct</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPAct} The enum <code>FormDataFPAct</code> value.
    */
