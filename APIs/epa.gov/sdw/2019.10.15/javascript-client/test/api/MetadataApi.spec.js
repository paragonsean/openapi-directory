...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.MetadataApi();
  });
  ...
  describe('MetadataApi', function() {
    describe('sdwRestServicesMetadataGet', function() {
      it('should call sdwRestServicesMetadataGet successfully', function(done) {
        //uncomment below and update the code to test sdwRestServicesMetadataGet
        //instance.sdwRestServicesMetadataGet(function(error) {
    ...
    describe('sdwRestServicesMetadataPost', function() {
      it('should call sdwRestServicesMetadataPost successfully', function(done) {
        //uncomment below and update the code to test sdwRestServicesMetadataPost
        //instance.sdwRestServicesMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
