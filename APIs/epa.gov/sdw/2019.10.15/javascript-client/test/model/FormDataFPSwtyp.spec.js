...
(function(root, factory) {
  ...
  describe('FormDataFPSwtyp', function() {
    it('should create an instance of FormDataFPSwtyp', function() {
      // uncomment below and update the code to test FormDataFPSwtyp
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPSwtyp();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPSwtyp);
    });
