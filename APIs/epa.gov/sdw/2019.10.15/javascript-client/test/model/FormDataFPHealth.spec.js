...
(function(root, factory) {
  ...
  describe('FormDataFPHealth', function() {
    it('should create an instance of FormDataFPHealth', function() {
      // uncomment below and update the code to test FormDataFPHealth
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPHealth();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPHealth);
    });
