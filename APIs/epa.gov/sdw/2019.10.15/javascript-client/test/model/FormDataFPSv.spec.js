...
(function(root, factory) {
  ...
  describe('FormDataFPSv', function() {
    it('should create an instance of FormDataFPSv', function() {
      // uncomment below and update the code to test FormDataFPSv
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPSv();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPSv);
    });
