...
(function(root, factory) {
  ...
  describe('FormDataFPOther', function() {
    it('should create an instance of FormDataFPOther', function() {
      // uncomment below and update the code to test FormDataFPOther
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPOther();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPOther);
    });
