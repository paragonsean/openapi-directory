...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesGetQidGet200Response();
  });
  ...
  describe('SdwRestServicesGetQidGet200Response', function() {
    it('should create an instance of SdwRestServicesGetQidGet200Response', function() {
      // uncomment below and update the code to test SdwRestServicesGetQidGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesGetQidGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesGetQidGet200Response);
    });
