...
(function(root, factory) {
  ...
  describe('FormDataFPYsl', function() {
    it('should create an instance of FormDataFPYsl', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPYsl();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPYsl);
    });
