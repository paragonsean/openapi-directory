...
(function(root, factory) {
  ...
  describe('FormDataFPIco', function() {
    it('should create an instance of FormDataFPIco', function() {
      // uncomment below and update the code to test FormDataFPIco
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPIco);
    });
