...
(function(root, factory) {
  ...
  describe('FormDataFPMr', function() {
    it('should create an instance of FormDataFPMr', function() {
      // uncomment below and update the code to test FormDataFPMr
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPMr();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPMr);
    });
