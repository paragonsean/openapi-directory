...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw02();
  });
  ...
  describe('Sdw02', function() {
    it('should create an instance of Sdw02', function() {
      // uncomment below and update the code to test Sdw02
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw02();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw02);
    });
