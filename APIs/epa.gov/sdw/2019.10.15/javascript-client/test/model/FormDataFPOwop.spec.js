...
(function(root, factory) {
  ...
  describe('FormDataFPOwop', function() {
    it('should create an instance of FormDataFPOwop', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPOwop();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPOwop);
    });
