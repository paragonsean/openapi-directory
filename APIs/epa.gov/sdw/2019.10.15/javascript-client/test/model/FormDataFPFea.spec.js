...
(function(root, factory) {
  ...
  describe('FormDataFPFea', function() {
    it('should create an instance of FormDataFPFea', function() {
      // uncomment below and update the code to test FormDataFPFea
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPFea();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPFea);
    });
