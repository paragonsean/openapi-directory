...
(function(root, factory) {
  ...
  describe('FormDataFPPswvio', function() {
    it('should create an instance of FormDataFPPswvio', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPPswvio();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPPswvio);
    });
