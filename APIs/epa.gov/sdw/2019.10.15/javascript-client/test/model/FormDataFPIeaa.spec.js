...
(function(root, factory) {
  ...
  describe('FormDataFPIeaa', function() {
    it('should create an instance of FormDataFPIeaa', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPIeaa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPIeaa);
    });
