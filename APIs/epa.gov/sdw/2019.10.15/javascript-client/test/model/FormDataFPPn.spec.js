...
(function(root, factory) {
  ...
  describe('FormDataFPPn', function() {
    it('should create an instance of FormDataFPPn', function() {
      // uncomment below and update the code to test FormDataFPPn
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPPn();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPPn);
    });
