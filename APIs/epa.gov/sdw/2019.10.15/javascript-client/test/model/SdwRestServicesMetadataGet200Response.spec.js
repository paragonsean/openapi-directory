...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesMetadataGet200Response();
  });
  ...
  describe('SdwRestServicesMetadataGet200Response', function() {
    it('should create an instance of SdwRestServicesMetadataGet200Response', function() {
      // uncomment below and update the code to test SdwRestServicesMetadataGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesMetadataGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesMetadataGet200Response);
    });
