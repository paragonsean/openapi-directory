...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw03();
  });
  ...
  describe('Sdw03', function() {
    it('should create an instance of Sdw03', function() {
      // uncomment below and update the code to test Sdw03
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw03();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw03);
    });
    ...
    it('should have the property waterSystems (base name: "WaterSystems")', function() {
      // uncomment below and update the code to test the property waterSystems
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.Sdw03();
      //expect(instance).to.be();
    });
