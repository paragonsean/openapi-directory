...
(function(root, factory) {
  ...
  describe('FormDataFPSystyp', function() {
    it('should create an instance of FormDataFPSystyp', function() {
      // uncomment below and update the code to test FormDataFPSystyp
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPSystyp();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPSystyp);
    });
