...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesGetSystemsGet200Response();
  });
  ...
  describe('SdwRestServicesGetSystemsGet200Response', function() {
    it('should create an instance of SdwRestServicesGetSystemsGet200Response', function() {
      // uncomment below and update the code to test SdwRestServicesGetSystemsGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesGetSystemsGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.SdwRestServicesGetSystemsGet200Response);
    });
