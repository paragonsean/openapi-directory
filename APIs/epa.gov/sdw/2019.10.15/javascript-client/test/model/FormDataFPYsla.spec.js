...
(function(root, factory) {
  ...
  describe('FormDataFPYsla', function() {
    it('should create an instance of FormDataFPYsla', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPYsla();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPYsla);
    });
