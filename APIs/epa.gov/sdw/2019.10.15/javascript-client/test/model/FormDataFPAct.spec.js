...
(function(root, factory) {
  ...
  describe('FormDataFPAct', function() {
    it('should create an instance of FormDataFPAct', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPAct();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPAct);
    });
