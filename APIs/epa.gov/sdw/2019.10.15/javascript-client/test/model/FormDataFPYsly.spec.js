...
(function(root, factory) {
  ...
  describe('FormDataFPYsly', function() {
    it('should create an instance of FormDataFPYsly', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPYsly();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPYsly);
    });
