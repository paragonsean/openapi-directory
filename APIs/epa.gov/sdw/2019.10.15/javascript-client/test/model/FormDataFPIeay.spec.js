...
(function(root, factory) {
  ...
  describe('FormDataFPIeay', function() {
    it('should create an instance of FormDataFPIeay', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPIeay();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPIeay);
    });
