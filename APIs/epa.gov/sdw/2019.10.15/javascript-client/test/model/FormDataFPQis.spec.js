...
(function(root, factory) {
  ...
  describe('FormDataFPQis', function() {
    it('should create an instance of FormDataFPQis', function() {
      // uncomment below and update the code to test FormDataFPQis
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPQis();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoSafeDrinkingWaterAct.FormDataFPQis);
    });
