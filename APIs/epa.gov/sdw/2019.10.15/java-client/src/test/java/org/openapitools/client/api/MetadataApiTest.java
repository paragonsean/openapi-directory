...
public class MetadataApiTest {
     ...
     */
    @Test
    public void sdwRestServicesMetadataGetTest() throws ApiException {
        String output = null;
        String paramCallback = null;
        SdwRestServicesMetadataGet200Response response = api.sdwRestServicesMetadataGet(output, paramCallback);
     ...
     */
    @Test
    public void sdwRestServicesMetadataPostTest() throws ApiException {
        String output = null;
        String paramCallback = null;
        SdwRestServicesMetadataGet200Response response = api.sdwRestServicesMetadataPost(output, paramCallback);
        // TODO: test validations
    }
