...
/**
 * Last Facility Inspection [within / not within] Specified Date Range Indicator. The date range is determined by parameters p_idt1 and p_idt2 or by parameter p_ysly. - W &#x3D; within date range - N &#x3D; not within date range
 */
@JsonAdapter(FormDataFPYsl.Adapter.class)
public enum FormDataFPYsl {
  ...
  public static FormDataFPYsl fromValue(String value) {
    for (FormDataFPYsl b : FormDataFPYsl.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPYsl> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPYsl enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPYsl read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPYsl.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPYsl.fromValue(value);
  }
}
