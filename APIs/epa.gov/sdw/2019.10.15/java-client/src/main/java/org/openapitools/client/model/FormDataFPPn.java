...
/**
 * Public Notice Violations (failure to immediately alert consumers of serious problem with drinking water).
 */
@JsonAdapter(FormDataFPPn.Adapter.class)
public enum FormDataFPPn {
  ...
  public static FormDataFPPn fromValue(String value) {
    for (FormDataFPPn b : FormDataFPPn.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPn> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPn enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPn read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPn.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPn.fromValue(value);
  }
}
