...
/**
 * Violations of health-based drinking water standards (maximum contaminant levels, maximum residual disinfectant levels, or treatment technique rules).
 */
@JsonAdapter(FormDataFPHealth.Adapter.class)
public enum FormDataFPHealth {
  ...
  public static FormDataFPHealth fromValue(String value) {
    for (FormDataFPHealth b : FormDataFPHealth.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPHealth> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPHealth enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPHealth read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPHealth.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPHealth.fromValue(value);
  }
}
