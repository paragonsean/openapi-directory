 ...
 */
@JsonAdapter(FormDataFPSv.Adapter.class)
public enum FormDataFPSv {
  ...
  public static FormDataFPSv fromValue(String value) {
    for (FormDataFPSv b : FormDataFPSv.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSv> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSv enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSv read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSv.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSv.fromValue(value);
  }
}
