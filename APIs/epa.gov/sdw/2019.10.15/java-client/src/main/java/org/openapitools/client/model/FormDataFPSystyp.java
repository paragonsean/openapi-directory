 ...
 */
@JsonAdapter(FormDataFPSystyp.Adapter.class)
public enum FormDataFPSystyp {
  ...
  public static FormDataFPSystyp fromValue(String value) {
    for (FormDataFPSystyp b : FormDataFPSystyp.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSystyp> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSystyp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSystyp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSystyp.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSystyp.fromValue(value);
  }
}
