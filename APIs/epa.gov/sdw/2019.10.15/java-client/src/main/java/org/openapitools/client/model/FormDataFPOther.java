...
/**
 * Other violations, such as failing to issue annual consumer confidence reports or maintain required records.
 */
@JsonAdapter(FormDataFPOther.Adapter.class)
public enum FormDataFPOther {
  ...
  public static FormDataFPOther fromValue(String value) {
    for (FormDataFPOther b : FormDataFPOther.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPOther> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPOther enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPOther read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPOther.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPOther.fromValue(value);
  }
}
