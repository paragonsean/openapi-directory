 ...
 */
@JsonAdapter(FormDataFPQiv.Adapter.class)
public enum FormDataFPQiv {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPQiv> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPQiv enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPQiv read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPQiv.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPQiv.fromValue(value);
  }
}
