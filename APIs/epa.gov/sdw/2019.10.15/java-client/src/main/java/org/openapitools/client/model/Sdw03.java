...
public class Sdw03 {
  ...
  public Sdw03 badSystemIDs(String badSystemIDs) {
  ...
  public Sdw03 cvRows(String cvRows) {
    this.cvRows = cvRows;
    return this;
  }
  ...
  public Sdw03 feARows(String feARows) {
  ...
  public Sdw03 inSPRows(String inSPRows) {
  ...
  public Sdw03 indianCountryRows(String indianCountryRows) {
  ...
  public Sdw03 infFEARows(String infFEARows) {
  ...
  public Sdw03 message(String message) {
  ...
  public Sdw03 pageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public Sdw03 queryID(String queryID) {
  ...
  public Sdw03 queryRows(String queryRows) {
  ...
  public Sdw03 svRows(String svRows) {
    this.svRows = svRows;
    return this;
  }
  ...
  public Sdw03 v3Rows(String v3Rows) {
    this.v3Rows = v3Rows;
    return this;
  }
  ...
  public Sdw03 version(String version) {
  ...
  public Sdw03 waterSystems(List<Sdw04> waterSystems) {
    this.waterSystems = waterSystems;
    return this;
  }

  public Sdw03 addWaterSystemsItem(Sdw04 waterSystemsItem) {
  ...
  public boolean equals(Object o) {
    ...
    Sdw03 sdw03 = (Sdw03) o;
    return Objects.equals(this.badSystemIDs, sdw03.badSystemIDs) &&
        Objects.equals(this.cvRows, sdw03.cvRows) &&
        Objects.equals(this.feARows, sdw03.feARows) &&
        Objects.equals(this.inSPRows, sdw03.inSPRows) &&
        Objects.equals(this.indianCountryRows, sdw03.indianCountryRows) &&
        Objects.equals(this.infFEARows, sdw03.infFEARows) &&
        Objects.equals(this.message, sdw03.message) &&
        Objects.equals(this.pageNo, sdw03.pageNo) &&
        Objects.equals(this.queryID, sdw03.queryID) &&
        Objects.equals(this.queryRows, sdw03.queryRows) &&
        Objects.equals(this.svRows, sdw03.svRows) &&
        Objects.equals(this.v3Rows, sdw03.v3Rows) &&
        Objects.equals(this.version, sdw03.version) &&
        Objects.equals(this.waterSystems, sdw03.waterSystems);
  }

  @Override
  public int hashCode() {
    return Objects.hash(badSystemIDs, cvRows, feARows, inSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, svRows, v3Rows, version, waterSystems);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Sdw03 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sdw03
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sdw03.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sdw03 is not found in the empty JSON string", Sdw03.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sdw03.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sdw03` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Sdw03.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sdw03.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sdw03' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sdw03> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sdw03.class));

       return (TypeAdapter<T>) new TypeAdapter<Sdw03>() {
           @Override
           public void write(JsonWriter out, Sdw03 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sdw03 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sdw03 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sdw03
   * @throws IOException if the JSON string is invalid with respect to Sdw03
   */
  public static Sdw03 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sdw03.class);
  }

  /**
   * Convert an instance of Sdw03 to an JSON string
   *
   * @return JSON string
   */
