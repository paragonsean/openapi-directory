...
/**
 * Monitoring and Reporting Violations (failure to conduct regular monitoring of drinking water quality or submit monitoring results in a timely fashion).
 */
@JsonAdapter(FormDataFPMr.Adapter.class)
public enum FormDataFPMr {
  ...
  public static FormDataFPMr fromValue(String value) {
    for (FormDataFPMr b : FormDataFPMr.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPMr> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPMr enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPMr read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPMr.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPMr.fromValue(value);
  }
}
