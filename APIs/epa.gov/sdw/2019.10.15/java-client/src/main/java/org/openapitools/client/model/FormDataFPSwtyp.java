...
/**
 * Source Water Type: - SW &#x3D; Surface water  - GW&#x3D; Ground water - GU &#x3D; Ground water under direct influence of (UDI) surface water - SWP &#x3D; Purchased Surface water - GWP &#x3D; Purchased Ground water - GUP &#x3D; Purchased Ground water UDI surface water
 */
@JsonAdapter(FormDataFPSwtyp.Adapter.class)
public enum FormDataFPSwtyp {
  ...
  public static FormDataFPSwtyp fromValue(String value) {
    for (FormDataFPSwtyp b : FormDataFPSwtyp.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSwtyp> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSwtyp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSwtyp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSwtyp.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSwtyp.fromValue(value);
  }
}
