 ...
 */
@JsonAdapter(FormDataFPPswvio.Adapter.class)
public enum FormDataFPPswvio {
  ...
  public static FormDataFPPswvio fromValue(String value) {
    for (FormDataFPPswvio b : FormDataFPPswvio.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPswvio> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPswvio enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPswvio read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPswvio.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPswvio.fromValue(value);
  }
}
