...
/**
 * Owner/Operator code filter.  Enter one of the following codes to filter results: - F &#x3D; Federal Government - S &#x3D; State Government - L &#x3D; Local Government - M &#x3D; Public/Private - N &#x3D; Native American - P &#x3D; Private
 */
@JsonAdapter(FormDataFPOwop.Adapter.class)
public enum FormDataFPOwop {
  ...
  public static FormDataFPOwop fromValue(String value) {
    for (FormDataFPOwop b : FormDataFPOwop.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPOwop> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPOwop enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPOwop read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPOwop.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPOwop.fromValue(value);
  }
}
