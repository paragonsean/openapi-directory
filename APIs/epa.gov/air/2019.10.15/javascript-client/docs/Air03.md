# USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air03
...
**aIRDaysLastEval** | **String** | The number of days since the most recent compliance evaluation of the facility. | 
**aIREPARegion** | **String** | The EPA region where the AIR facility is located. | 
**aIREvalCnt** | **String** | The number of compliance evaluations, under the Clean Air Act, occurring at the facility within the last five years. | 
...
**aIRMnthsWithHpv** | **String** | The number of months in the last three years in which the permit or site is considered in High Priority Violation (HPV) status | 
...
**aIRQtrsWithHpv** | **String** | The number of quarters in the last three years in which the permit or site is considered in High Priority Violation (HPV) status. | 
**aIRQtrsWithViol** | **String** | The number of quarters in the last three years in which the permit or site has had unresolved violation(s) reported. | 
**aIRRecentViolCnt** | **String** | The number of violations reported in the last year. | 
