...
/**
* Enum class FormDataFPTriCat.
* @enum {}
* @readonly
*/
export default class FormDataFPTriCat {
    ...
    /**
    * Returns a <code>FormDataFPTriCat</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPTriCat} The enum <code>FormDataFPTriCat</code> value.
    */
