...
/**
* Enum class FormDataFPStsla.
* @enum {}
* @readonly
*/
export default class FormDataFPStsla {
    ...
    /**
    * Returns a <code>FormDataFPStsla</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPStsla} The enum <code>FormDataFPStsla</code> value.
    */
