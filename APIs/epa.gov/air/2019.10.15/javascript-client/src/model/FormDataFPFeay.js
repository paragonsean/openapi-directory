...
/**
* Enum class FormDataFPFeay.
* @enum {}
* @readonly
*/
export default class FormDataFPFeay {
    ...
    /**
    * Returns a <code>FormDataFPFeay</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFeay} The enum <code>FormDataFPFeay</code> value.
    */
