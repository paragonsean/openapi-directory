...
/**
 * The Air00 model module.
 * @module model/Air00
 * @version 2019.10.15
 */
class Air00 {
    /**
     * Constructs a new <code>Air00</code>.
     * Cluster Data Object
     * @alias module:model/Air00
    ...
    constructor(cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows) { 
        ...
        Air00.initialize(this, cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows);
    }
    ...
    /**
     * Constructs a <code>Air00</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Air00} obj Optional instance to populate.
     * @return {module:model/Air00} The populated <code>Air00</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Air00</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Air00</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Air00.RequiredProperties) {
...
Air00.RequiredProperties = ["CVRows", "ClusterCount", "ClusterIcon", "ClusterLatitude", "ClusterLongitude", "ClusterName", "ClusterType", "ClusterValue", "EPARegionCode", "FEARows", "INSPRows", "IndianCountryRows", "InfFEARows", "ObjectId", "SVRows", "TotalPenalties", "V3Rows"];
 ...
 */
Air00.prototype['ClusterValue'] = undefined;
