...
/**
* Enum class FormDataFPStsly.
* @enum {}
* @readonly
*/
export default class FormDataFPStsly {
    ...
    /**
    * Returns a <code>FormDataFPStsly</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPStsly} The enum <code>FormDataFPStsly</code> value.
    */
