...
/**
* Enum class FormDataFPGhgAmt.
* @enum {}
* @readonly
*/
export default class FormDataFPGhgAmt {
    ...
    /**
    * Returns a <code>FormDataFPGhgAmt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPGhgAmt} The enum <code>FormDataFPGhgAmt</code> value.
    */
