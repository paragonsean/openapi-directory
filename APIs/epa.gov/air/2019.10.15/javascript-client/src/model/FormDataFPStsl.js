...
/**
* Enum class FormDataFPStsl.
* @enum {}
* @readonly
*/
export default class FormDataFPStsl {
    ...
    /**
    * Returns a <code>FormDataFPStsl</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPStsl} The enum <code>FormDataFPStsl</code> value.
    */
