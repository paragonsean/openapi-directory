...
/**
* Enum class FormDataFPTriAmt.
* @enum {}
* @readonly
*/
export default class FormDataFPTriAmt {
    ...
    /**
    * Returns a <code>FormDataFPTriAmt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPTriAmt} The enum <code>FormDataFPTriAmt</code> value.
    */
