...
import Air04 from './Air04';

/**
 * The Air05 model module.
 * @module model/Air05
 * @version 2019.10.15
 */
class Air05 {
    /**
     * Constructs a new <code>Air05</code>.
     * Results Object
     * @alias module:model/Air05
    ...
    constructor(badSystemIDs, cVRows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, sVRows, totalPenalties, v3Rows) { 
        ...
        Air05.initialize(this, badSystemIDs, cVRows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, sVRows, totalPenalties, v3Rows);
    }
    ...
    /**
     * Constructs a <code>Air05</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Air05} obj Optional instance to populate.
     * @return {module:model/Air05} The populated <code>Air05</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MapOutput')) {
                obj['MapOutput'] = Air04.constructFromObject(data['MapOutput']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Air05</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Air05</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Air05.RequiredProperties) {
        ...
        if (data['MapOutput']) { // data not null
          Air04.validateJSON(data['MapOutput']);
        }
        // ensure the json data is a string
...
Air05.RequiredProperties = ["BadSystemIDs", "CVRows", "FEARows", "INSPRows", "IndianCountryRows", "InfFEARows", "Message", "PageNo", "QueryID", "QueryRows", "SVRows", "TotalPenalties", "V3Rows"];

/**
 * Identifies which passed query system identifiers are invalid.
 * @member {String} BadSystemIDs
 */
Air05.prototype['BadSystemIDs'] = undefined;
