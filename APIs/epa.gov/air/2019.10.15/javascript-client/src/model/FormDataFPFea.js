...
/**
* Enum class FormDataFPFea.
* @enum {}
* @readonly
*/
export default class FormDataFPFea {
    ...
    /**
    * Returns a <code>FormDataFPFea</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFea} The enum <code>FormDataFPFea</code> value.
    */
