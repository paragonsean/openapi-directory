...
/**
* Enum class FormDataFPSwpa.
* @enum {}
* @readonly
*/
export default class FormDataFPSwpa {
    ...
    /**
    * Returns a <code>FormDataFPSwpa</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSwpa} The enum <code>FormDataFPSwpa</code> value.
    */
