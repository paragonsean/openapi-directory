...
/**
 * The Air04 model module.
 * @module model/Air04
 * @version 2019.10.15
 */
class Air04 {
    /**
     * Constructs a new <code>Air04</code>.
     * Map Output Object
     * @alias module:model/Air04
    ...
    constructor(iconBaseURL, mapData, popUpBaseURL, queryID) { 
        ...
        Air04.initialize(this, iconBaseURL, mapData, popUpBaseURL, queryID);
    }
    ...
    /**
     * Constructs a <code>Air04</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Air04} obj Optional instance to populate.
     * @return {module:model/Air04} The populated <code>Air04</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Air04</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Air04</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Air04.RequiredProperties) {
