...
/**
 * The Air06 model module.
 * @module model/Air06
 * @version 2019.10.15
 */
class Air06 {
    /**
     * Constructs a new <code>Air06</code>.
     * Facilities Object
     * @alias module:model/Air06
     ...
     * @param aIRDaysLastEval {String} The number of days since the most recent compliance evaluation of the facility.
     * @param aIREPARegion {String} The EPA region where the AIR facility is located.
     * @param aIREvalCnt {String} The number of compliance evaluations, under the Clean Air Act, occurring at the facility within the last five years.
     ...
     * @param aIRMnthsWithHpv {String} The number of months in the last three years in which the permit or site is considered in High Priority Violation (HPV) status
     ...
     * @param aIRQtrsWithHpv {String} The number of quarters in the last three years in which the permit or site is considered in High Priority Violation (HPV) status.
     * @param aIRQtrsWithViol {String} The number of quarters in the last three years in which the permit or site has had unresolved violation(s) reported.
     * @param aIRRecentViolCnt {String} The number of violations reported in the last year.
    ...
    constructor(aIR3yrComplQtrsHistory, aIRCaseIDs, aIRCity, aIRClassification, aIRComplStatus, aIRCounty, aIRDaysLastEval, aIREPARegion, aIREvalCnt, aIRFIPSCode, aIRFacilityTypeCode, aIRFacilityTypeDesc, aIRFeaCnt, aIRHpvStatus, aIRIDs, aIRIeaCnt, aIRIndianCntryFlg, aIRLastEvalDate, aIRLastEvalDateEPA, aIRLastEvalDateState, aIRLastFeaDate, aIRLastFeaDateEPA, aIRLastFeaDateState, aIRLastIeaDate, aIRLastIeaDateEPA, aIRLastIeaDateState, aIRLastPenaltyDate, aIRLastStckDateEPA, aIRLastStckDateState, aIRLastStckTestDate, aIRLastStckTestResults, aIRLastViolDate, aIRMacts, aIRMajorFlag, aIRMnthsWithHpv, AIRNAICS, aIRName, aIRNsps, aIRNspsm, aIRPenalties, aIRPollRecentViol, aIRPrograms, aIRQtrsWithHpv, aIRQtrsWithViol, aIRRecentViolCnt, aIRStackTest5YrAll, aIRStackTest5YrFail, aIRState, aIRStatus, aIRStreet, aIRTRIbalEPAids, aIRTRIbalNames, aIRUniverse, aIRZip, activeLower48, cWAIDs, calculatedAccuracyMeters, camdIDs, censusBlockGroup, chesapeakeBayFlag, collectionMethod, currSvFlag, currVioFlag, ePASystem, ea5yrFlag, eisIDs, ejscreenFlag, ejscreenFlagUs, facCamdReporter, facCountyName, facDerivedHuc, facDerivedTRIbes, facDerivedWBD, facDerivedWBDName, facEisAIRReleases, facEisReporter, facFIPSCode, facFederalAgencyCode, facFederalAgencyName, facGHGCO2Releases, facGHGReporter, facIndianCntryFlg, facIndianSpatialFlg, facLat, facLong, facMapFlg, facMapIcon, facNaaFlag, facPercentMinority, facPopulationDensity, facSICCodes, facStdCountyName, facTRIAIRReleases, facTRICarcAIRReleases, facTRIHapsReleases, facTRIReporter, facUsMexBorderFlg, gHGIDs, hasPollRpt, infea5yrFlag, insp5yrFlag, lastDatePce, lastDatePceEPA, lastDatePceSta, localControlRegionCode, localControlRegionName, lower48, maintPollutantsNaa, maintStandardsNaa, maintStatusNaa, map, maxPctileUs, maxScore, naPollutantsNaa, naStandardsNaa, naStatusNaa, naaCategories, naaPollutants, objectId, otherPermitIDs, over80CountUs, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rCRAIDs, referencePoint, registryID, rmpIDs, sDWAIDs, score, sourceID, statute, tRIIDs, tRIbalFlag, violFlag, webDocs) { 
        ...
        Air06.initialize(this, aIR3yrComplQtrsHistory, aIRCaseIDs, aIRCity, aIRClassification, aIRComplStatus, aIRCounty, aIRDaysLastEval, aIREPARegion, aIREvalCnt, aIRFIPSCode, aIRFacilityTypeCode, aIRFacilityTypeDesc, aIRFeaCnt, aIRHpvStatus, aIRIDs, aIRIeaCnt, aIRIndianCntryFlg, aIRLastEvalDate, aIRLastEvalDateEPA, aIRLastEvalDateState, aIRLastFeaDate, aIRLastFeaDateEPA, aIRLastFeaDateState, aIRLastIeaDate, aIRLastIeaDateEPA, aIRLastIeaDateState, aIRLastPenaltyDate, aIRLastStckDateEPA, aIRLastStckDateState, aIRLastStckTestDate, aIRLastStckTestResults, aIRLastViolDate, aIRMacts, aIRMajorFlag, aIRMnthsWithHpv, AIRNAICS, aIRName, aIRNsps, aIRNspsm, aIRPenalties, aIRPollRecentViol, aIRPrograms, aIRQtrsWithHpv, aIRQtrsWithViol, aIRRecentViolCnt, aIRStackTest5YrAll, aIRStackTest5YrFail, aIRState, aIRStatus, aIRStreet, aIRTRIbalEPAids, aIRTRIbalNames, aIRUniverse, aIRZip, activeLower48, cWAIDs, calculatedAccuracyMeters, camdIDs, censusBlockGroup, chesapeakeBayFlag, collectionMethod, currSvFlag, currVioFlag, ePASystem, ea5yrFlag, eisIDs, ejscreenFlag, ejscreenFlagUs, facCamdReporter, facCountyName, facDerivedHuc, facDerivedTRIbes, facDerivedWBD, facDerivedWBDName, facEisAIRReleases, facEisReporter, facFIPSCode, facFederalAgencyCode, facFederalAgencyName, facGHGCO2Releases, facGHGReporter, facIndianCntryFlg, facIndianSpatialFlg, facLat, facLong, facMapFlg, facMapIcon, facNaaFlag, facPercentMinority, facPopulationDensity, facSICCodes, facStdCountyName, facTRIAIRReleases, facTRICarcAIRReleases, facTRIHapsReleases, facTRIReporter, facUsMexBorderFlg, gHGIDs, hasPollRpt, infea5yrFlag, insp5yrFlag, lastDatePce, lastDatePceEPA, lastDatePceSta, localControlRegionCode, localControlRegionName, lower48, maintPollutantsNaa, maintStandardsNaa, maintStatusNaa, map, maxPctileUs, maxScore, naPollutantsNaa, naStandardsNaa, naStatusNaa, naaCategories, naaPollutants, objectId, otherPermitIDs, over80CountUs, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rCRAIDs, referencePoint, registryID, rmpIDs, sDWAIDs, score, sourceID, statute, tRIIDs, tRIbalFlag, violFlag, webDocs);
    }
    ...
    /**
     * Constructs a <code>Air06</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Air06} obj Optional instance to populate.
     * @return {module:model/Air06} The populated <code>Air06</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('AIRDaysLastEval')) {
                obj['AIRDaysLastEval'] = ApiClient.convertToType(data['AIRDaysLastEval'], 'String');
            }
            ...
            if (data.hasOwnProperty('AIREvalCnt')) {
                obj['AIREvalCnt'] = ApiClient.convertToType(data['AIREvalCnt'], 'String');
            }
            ...
            if (data.hasOwnProperty('AIRMnthsWithHpv')) {
                obj['AIRMnthsWithHpv'] = ApiClient.convertToType(data['AIRMnthsWithHpv'], 'String');
            }
            ...
            if (data.hasOwnProperty('AIRQtrsWithHpv')) {
                obj['AIRQtrsWithHpv'] = ApiClient.convertToType(data['AIRQtrsWithHpv'], 'String');
            }
            if (data.hasOwnProperty('AIRQtrsWithViol')) {
                obj['AIRQtrsWithViol'] = ApiClient.convertToType(data['AIRQtrsWithViol'], 'String');
            }
            if (data.hasOwnProperty('AIRRecentViolCnt')) {
                obj['AIRRecentViolCnt'] = ApiClient.convertToType(data['AIRRecentViolCnt'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Air06</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Air06</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Air06.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['AIRDaysLastEval'] && !(typeof data['AIRDaysLastEval'] === 'string' || data['AIRDaysLastEval'] instanceof String)) {
            throw new Error("Expected the field `AIRDaysLastEval` to be a primitive type in the JSON string but got " + data['AIRDaysLastEval']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['AIREvalCnt'] && !(typeof data['AIREvalCnt'] === 'string' || data['AIREvalCnt'] instanceof String)) {
            throw new Error("Expected the field `AIREvalCnt` to be a primitive type in the JSON string but got " + data['AIREvalCnt']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['AIRMnthsWithHpv'] && !(typeof data['AIRMnthsWithHpv'] === 'string' || data['AIRMnthsWithHpv'] instanceof String)) {
            throw new Error("Expected the field `AIRMnthsWithHpv` to be a primitive type in the JSON string but got " + data['AIRMnthsWithHpv']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['AIRQtrsWithHpv'] && !(typeof data['AIRQtrsWithHpv'] === 'string' || data['AIRQtrsWithHpv'] instanceof String)) {
            throw new Error("Expected the field `AIRQtrsWithHpv` to be a primitive type in the JSON string but got " + data['AIRQtrsWithHpv']);
        }
        // ensure the json data is a string
        if (data['AIRQtrsWithViol'] && !(typeof data['AIRQtrsWithViol'] === 'string' || data['AIRQtrsWithViol'] instanceof String)) {
            throw new Error("Expected the field `AIRQtrsWithViol` to be a primitive type in the JSON string but got " + data['AIRQtrsWithViol']);
        }
        // ensure the json data is a string
        if (data['AIRRecentViolCnt'] && !(typeof data['AIRRecentViolCnt'] === 'string' || data['AIRRecentViolCnt'] instanceof String)) {
            throw new Error("Expected the field `AIRRecentViolCnt` to be a primitive type in the JSON string but got " + data['AIRRecentViolCnt']);
        }
        // ensure the json data is a string
...
Air06.RequiredProperties = ["AIR3yrComplQtrsHistory", "AIRCaseIDs", "AIRCity", "AIRClassification", "AIRComplStatus", "AIRCounty", "AIRDaysLastEval", "AIREPARegion", "AIREvalCnt", "AIRFIPSCode", "AIRFacilityTypeCode", "AIRFacilityTypeDesc", "AIRFeaCnt", "AIRHpvStatus", "AIRIDs", "AIRIeaCnt", "AIRIndianCntryFlg", "AIRLastEvalDate", "AIRLastEvalDateEPA", "AIRLastEvalDateState", "AIRLastFeaDate", "AIRLastFeaDateEPA", "AIRLastFeaDateState", "AIRLastIeaDate", "AIRLastIeaDateEPA", "AIRLastIeaDateState", "AIRLastPenaltyDate", "AIRLastStckDateEPA", "AIRLastStckDateState", "AIRLastStckTestDate", "AIRLastStckTestResults", "AIRLastViolDate", "AIRMacts", "AIRMajorFlag", "AIRMnthsWithHpv", "AIRNAICS", "AIRName", "AIRNsps", "AIRNspsm", "AIRPenalties", "AIRPollRecentViol", "AIRPrograms", "AIRQtrsWithHpv", "AIRQtrsWithViol", "AIRRecentViolCnt", "AIRStackTest5YrAll", "AIRStackTest5YrFail", "AIRState", "AIRStatus", "AIRStreet", "AIRTRIbalEPAids", "AIRTRIbalNames", "AIRUniverse", "AIRZip", "ActiveLower48", "CWAIDs", "CalculatedAccuracyMeters", "CamdIDs", "CensusBlockGroup", "ChesapeakeBayFlag", "CollectionMethod", "CurrSvFlag", "CurrVioFlag", "EPASystem", "Ea5yrFlag", "EisIDs", "EjscreenFlag", "EjscreenFlagUs", "FacCamdReporter", "FacCountyName", "FacDerivedHuc", "FacDerivedTRIbes", "FacDerivedWBD", "FacDerivedWBDName", "FacEisAIRReleases", "FacEisReporter", "FacFIPSCode", "FacFederalAgencyCode", "FacFederalAgencyName", "FacGHGCO2Releases", "FacGHGReporter", "FacIndianCntryFlg", "FacIndianSpatialFlg", "FacLat", "FacLong", "FacMapFlg", "FacMapIcon", "FacNaaFlag", "FacPercentMinority", "FacPopulationDensity", "FacSICCodes", "FacStdCountyName", "FacTRIAIRReleases", "FacTRICarcAIRReleases", "FacTRIHapsReleases", "FacTRIReporter", "FacUsMexBorderFlg", "GHGIDs", "HasPollRpt", "Infea5yrFlag", "Insp5yrFlag", "LastDatePce", "LastDatePceEPA", "LastDatePceSta", "LocalControlRegionCode", "LocalControlRegionName", "Lower48", "MaintPollutantsNaa", "MaintStandardsNaa", "MaintStatusNaa", "Map", "MaxPctileUs", "MaxScore", "NaPollutantsNaa", "NaStandardsNaa", "NaStatusNaa", "NaaCategories", "NaaPollutants", "ObjectId", "OtherPermitIDs", "Over80CountUs", "PctileCancerUs", "PctileDpmUs", "PctileO3Us", "PctilePctpre1960Us", "PctilePmUs", "PctileProximityNPDESUs", "PctileProximityNplUs", "PctileProximityRmpUs", "PctileProximityTsdfUs", "PctileRespUs", "PctileTrafficScoreUs", "RCRAIDs", "ReferencePoint", "RegistryID", "RmpIDs", "SDWAIDs", "Score", "SourceID", "Statute", "TRIIDs", "TRIbalFlag", "ViolFlag", "WebDocs"];

/**
 * The facility's 3-year compliance status history by quarter (3-month period). Each character represents a quarter of compliance, going from oldest to most recent. Character values correspond to the following compliance statuses: _ -�No Violation Identified V -�Violation Identified S -�High Priority Violation U - Undetermined
 * @member {String} AIR3yrComplQtrsHistory
 */
Air06.prototype['AIR3yrComplQtrsHistory'] = undefined;

/**
 * Space-delimited list of AIR cases associated with the facility.
 * @member {String} AIRCaseIDs
 */
Air06.prototype['AIRCaseIDs'] = undefined;

/**
 * The city where the AIR facility is located.
 * @member {String} AIRCity
 */
Air06.prototype['AIRCity'] = undefined;

/**
 * @member {String} AIRClassification
 */
Air06.prototype['AIRClassification'] = undefined;

/**
 * The facility's recent violation status under the Clean Air Act.
 * @member {String} AIRComplStatus
 */
Air06.prototype['AIRComplStatus'] = undefined;

/**
 * The name of the county where the AIR facility is located.
 * @member {String} AIRCounty
 */
Air06.prototype['AIRCounty'] = undefined;

/**
 * The number of days since the most recent compliance evaluation of the facility.
 * @member {String} AIRDaysLastEval
 */
Air06.prototype['AIRDaysLastEval'] = undefined;

/**
 * The EPA region where the AIR facility is located.
 * @member {String} AIREPARegion
 */
Air06.prototype['AIREPARegion'] = undefined;

/**
 * The number of compliance evaluations, under the Clean Air Act, occurring at the facility within the last five years.
 * @member {String} AIREvalCnt
 */
Air06.prototype['AIREvalCnt'] = undefined;
 ...
 */
Air06.prototype['AIRFIPSCode'] = undefined;

/**
 * A three-character code indicating if plant is government facility. COR - Corporation CNG - County Government DIS - District FDF - Federal Facility (U.S. Government) GOC - GOCO (Gov Owned/Contractor Operated) IND - Individual MXO - Mixed Ownership (e.g., Public/Private) MWD - Municipal or Water District CTG - Municipality NON - Non-Government POF - Privately Owned Facility SDT - School District STF - State Government TRB - Tribal Government UNK - Unknown
 * @member {String} AIRFacilityTypeCode
 */
Air06.prototype['AIRFacilityTypeCode'] = undefined;

/**
 * @member {String} AIRFacilityTypeDesc
 */
Air06.prototype['AIRFacilityTypeDesc'] = undefined;
 ...
 */
Air06.prototype['AIRFeaCnt'] = undefined;
 ...
 */
Air06.prototype['AIRHpvStatus'] = undefined;

/**
 * Air Facility System (AFS) ID.
 * @member {String} AIRIDs
 */
Air06.prototype['AIRIDs'] = undefined;
 ...
 */
Air06.prototype['AIRLastIeaDate'] = undefined;
 ...
 */
Air06.prototype['AIRLastIeaDateEPA'] = undefined;
 ...
 */
Air06.prototype['AIRLastIeaDateState'] = undefined;
 ...
 */
Air06.prototype['AIRTRIbalEPAids'] = undefined;
 ...
 */
Air06.prototype['AIRTRIbalNames'] = undefined;

/**
 * The program office defines each CAA Source ID and the associated permits as being Federally Reportable or Non-Federally Reportable. Under the CAA, federally reportable source include majors, synthetic minors, NESHAP Part 61 minors, minors with an unresolved High Priority Violation (HPV), with recent enforcement action, or included on a Compliance Monitoring Strategy plan.
 * @member {String} AIRUniverse
 */
Air06.prototype['AIRUniverse'] = undefined;

/**
 * The five-digit zip code of the AIR facility.
 * @member {String} AIRZip
 */
Air06.prototype['AIRZip'] = undefined;
 ...
 */
Air06.prototype['ActiveLower48'] = undefined;
 ...
 */
Air06.prototype['FacFIPSCode'] = undefined;
 ...
 */
Air06.prototype['FacFederalAgencyCode'] = undefined;
 ...
 */
Air06.prototype['FacFederalAgencyName'] = undefined;
 ...
 */
Air06.prototype['FacIndianSpatialFlg'] = undefined;
 ...
 */
Air06.prototype['FacLat'] = undefined;
 ...
 */
Air06.prototype['FacNaaFlag'] = undefined;
 ...
 */
Air06.prototype['FacTRIAIRReleases'] = undefined;
 ...
 */
Air06.prototype['FacTRICarcAIRReleases'] = undefined;
 ...
 */
Air06.prototype['FacTRIHapsReleases'] = undefined;
 ...
 */
Air06.prototype['LastDatePce'] = undefined;
 ...
 */
Air06.prototype['LastDatePceEPA'] = undefined;
 ...
 */
Air06.prototype['Over80CountUs'] = undefined;
 ...
 */
Air06.prototype['PctileCancerUs'] = undefined;
 ...
 */
Air06.prototype['PctileProximityNPDESUs'] = undefined;
 ...
 */
Air06.prototype['PctileProximityNplUs'] = undefined;
 ...
 */
Air06.prototype['PctileProximityRmpUs'] = undefined;
 ...
 */
Air06.prototype['PctileProximityTsdfUs'] = undefined;
 ...
 */
Air06.prototype['PctileRespUs'] = undefined;
 ...
 */
Air06.prototype['RegistryID'] = undefined;
 ...
 */
Air06.prototype['RmpIDs'] = undefined;
