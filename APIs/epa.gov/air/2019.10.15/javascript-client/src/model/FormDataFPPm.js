...
/**
* Enum class FormDataFPPm.
* @enum {}
* @readonly
*/
export default class FormDataFPPm {
    ...
    /**
    * Returns a <code>FormDataFPPm</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPm} The enum <code>FormDataFPPm</code> value.
    */
