...
/**
* Enum class FormDataFPNeiAmt.
* @enum {}
* @readonly
*/
export default class FormDataFPNeiAmt {
    ...
    /**
    * Returns a <code>FormDataFPNeiAmt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPNeiAmt} The enum <code>FormDataFPNeiAmt</code> value.
    */
