...
/**
* Enum class FormDataFPYsl.
* @enum {}
* @readonly
*/
export default class FormDataFPYsl {
    ...
    /**
    * Returns a <code>FormDataFPYsl</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPYsl} The enum <code>FormDataFPYsl</code> value.
    */
