...
/**
* Enum class FormDataFPIea.
* @enum {}
* @readonly
*/
export default class FormDataFPIea {
    ...
    /**
    * Returns a <code>FormDataFPIea</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPIea} The enum <code>FormDataFPIea</code> value.
    */
