...
/**
* Enum class FormDataFPEjscreenOver80cnt.
* @enum {}
* @readonly
*/
export default class FormDataFPEjscreenOver80cnt {
    ...
    /**
    * Returns a <code>FormDataFPEjscreenOver80cnt</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPEjscreenOver80cnt} The enum <code>FormDataFPEjscreenOver80cnt</code> value.
    */
