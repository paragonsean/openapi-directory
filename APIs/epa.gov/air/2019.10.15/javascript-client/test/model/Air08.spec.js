...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air08();
  });
  ...
  describe('Air08', function() {
    it('should create an instance of Air08', function() {
      // uncomment below and update the code to test Air08
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air08();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air08);
    });
