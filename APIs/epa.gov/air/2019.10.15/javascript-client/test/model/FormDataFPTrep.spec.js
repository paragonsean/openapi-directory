...
(function(root, factory) {
  ...
  describe('FormDataFPTrep', function() {
    it('should create an instance of FormDataFPTrep', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPTrep();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPTrep);
    });
