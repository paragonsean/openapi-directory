...
(function(root, factory) {
  ...
  describe('FormDataFPCifdi', function() {
    it('should create an instance of FormDataFPCifdi', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPCifdi();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPCifdi);
    });
