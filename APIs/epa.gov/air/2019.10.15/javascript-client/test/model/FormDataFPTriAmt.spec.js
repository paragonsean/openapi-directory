...
(function(root, factory) {
  ...
  describe('FormDataFPTriAmt', function() {
    it('should create an instance of FormDataFPTriAmt', function() {
      // uncomment below and update the code to test FormDataFPTriAmt
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPTriAmt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPTriAmt);
    });
