...
(function(root, factory) {
  ...
  describe('FormDataFPPm', function() {
    it('should create an instance of FormDataFPPm', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPm();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPm);
    });
