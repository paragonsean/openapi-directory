...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air05();
  });
  ...
  describe('Air05', function() {
    it('should create an instance of Air05', function() {
      // uncomment below and update the code to test Air05
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air05();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air05);
    });
