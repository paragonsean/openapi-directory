...
(function(root, factory) {
  ...
  describe('FormDataFPMaj', function() {
    it('should create an instance of FormDataFPMaj', function() {
      // uncomment below and update the code to test FormDataFPMaj
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPMaj();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPMaj);
    });
