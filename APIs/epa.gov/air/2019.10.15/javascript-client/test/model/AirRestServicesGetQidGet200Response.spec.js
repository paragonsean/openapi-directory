...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.AirRestServicesGetQidGet200Response();
  });
  ...
  describe('AirRestServicesGetQidGet200Response', function() {
    it('should create an instance of AirRestServicesGetQidGet200Response', function() {
      // uncomment below and update the code to test AirRestServicesGetQidGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.AirRestServicesGetQidGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.AirRestServicesGetQidGet200Response);
    });
