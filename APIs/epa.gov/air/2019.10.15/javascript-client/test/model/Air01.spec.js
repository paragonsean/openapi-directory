...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air01();
  });
  ...
  describe('Air01', function() {
    it('should create an instance of Air01', function() {
      // uncomment below and update the code to test Air01
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air01();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air01);
    });
