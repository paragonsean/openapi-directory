...
(function(root, factory) {
  ...
  describe('FormDataFPMed', function() {
    it('should create an instance of FormDataFPMed', function() {
      // uncomment below and update the code to test FormDataFPMed
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPMed();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPMed);
    });
