...
(function(root, factory) {
  ...
  describe('FormDataFPNeiAmt', function() {
    it('should create an instance of FormDataFPNeiAmt', function() {
      // uncomment below and update the code to test FormDataFPNeiAmt
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPNeiAmt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPNeiAmt);
    });
