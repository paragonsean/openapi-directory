...
(function(root, factory) {
  ...
  describe('FormDataFPTriCat', function() {
    it('should create an instance of FormDataFPTriCat', function() {
      // uncomment below and update the code to test FormDataFPTriCat
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPTriCat();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPTriCat);
    });
