...
(function(root, factory) {
  ...
  describe('FormDataFTablelist', function() {
    it('should create an instance of FormDataFTablelist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFTablelist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFTablelist);
    });
