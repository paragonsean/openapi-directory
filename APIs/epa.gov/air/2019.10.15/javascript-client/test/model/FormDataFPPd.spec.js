...
(function(root, factory) {
  ...
  describe('FormDataFPPd', function() {
    it('should create an instance of FormDataFPPd', function() {
      // uncomment below and update the code to test FormDataFPPd
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPd);
    });
