...
(function(root, factory) {
  ...
  describe('FormDataFPPidall', function() {
    it('should create an instance of FormDataFPPidall', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPidall();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPidall);
    });
