...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air12();
  });
  ...
  describe('Air12', function() {
    it('should create an instance of Air12', function() {
      // uncomment below and update the code to test Air12
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air12();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air12);
    });
