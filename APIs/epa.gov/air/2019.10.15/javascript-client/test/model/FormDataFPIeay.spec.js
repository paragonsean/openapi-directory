...
(function(root, factory) {
  ...
  describe('FormDataFPIeay', function() {
    it('should create an instance of FormDataFPIeay', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPIeay();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPIeay);
    });
