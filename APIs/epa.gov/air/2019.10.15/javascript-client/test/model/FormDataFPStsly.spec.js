...
(function(root, factory) {
  ...
  describe('FormDataFPStsly', function() {
    it('should create an instance of FormDataFPStsly', function() {
      // uncomment below and update the code to test FormDataFPStsly
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPStsly();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPStsly);
    });
