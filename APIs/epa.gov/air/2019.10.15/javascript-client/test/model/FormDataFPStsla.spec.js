...
(function(root, factory) {
  ...
  describe('FormDataFPStsla', function() {
    it('should create an instance of FormDataFPStsla', function() {
      // uncomment below and update the code to test FormDataFPStsla
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPStsla();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPStsla);
    });
