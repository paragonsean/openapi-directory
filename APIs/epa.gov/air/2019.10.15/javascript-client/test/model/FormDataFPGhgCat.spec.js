...
(function(root, factory) {
  ...
  describe('FormDataFPGhgCat', function() {
    it('should create an instance of FormDataFPGhgCat', function() {
      // uncomment below and update the code to test FormDataFPGhgCat
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPGhgCat();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPGhgCat);
    });
