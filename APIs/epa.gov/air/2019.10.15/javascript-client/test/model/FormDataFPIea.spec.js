...
(function(root, factory) {
  ...
  describe('FormDataFPIea', function() {
    it('should create an instance of FormDataFPIea', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPIea();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPIea);
    });
