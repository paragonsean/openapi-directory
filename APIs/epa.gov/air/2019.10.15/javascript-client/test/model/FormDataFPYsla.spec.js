...
(function(root, factory) {
  ...
  describe('FormDataFPYsla', function() {
    it('should create an instance of FormDataFPYsla', function() {
      // uncomment below and update the code to test FormDataFPYsla
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPYsla();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPYsla);
    });
