...
(function(root, factory) {
  ...
  describe('FormDataFPGhgAmt', function() {
    it('should create an instance of FormDataFPGhgAmt', function() {
      // uncomment below and update the code to test FormDataFPGhgAmt
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPGhgAmt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPGhgAmt);
    });
