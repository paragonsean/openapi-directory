...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.AirRestServicesMetadataGet200Response();
  });
  ...
  describe('AirRestServicesMetadataGet200Response', function() {
    it('should create an instance of AirRestServicesMetadataGet200Response', function() {
      // uncomment below and update the code to test AirRestServicesMetadataGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.AirRestServicesMetadataGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.AirRestServicesMetadataGet200Response);
    });
