...
(function(root, factory) {
  ...
  describe('FormDataFPSwpa', function() {
    it('should create an instance of FormDataFPSwpa', function() {
      // uncomment below and update the code to test FormDataFPSwpa
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPSwpa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPSwpa);
    });
