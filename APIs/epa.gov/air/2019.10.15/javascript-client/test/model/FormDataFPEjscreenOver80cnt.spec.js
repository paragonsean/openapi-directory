...
(function(root, factory) {
  ...
  describe('FormDataFPEjscreenOver80cnt', function() {
    it('should create an instance of FormDataFPEjscreenOver80cnt', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPEjscreenOver80cnt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPEjscreenOver80cnt);
    });
