...
(function(root, factory) {
  ...
  describe('FormDataFMaplist', function() {
    it('should create an instance of FormDataFMaplist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFMaplist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFMaplist);
    });
