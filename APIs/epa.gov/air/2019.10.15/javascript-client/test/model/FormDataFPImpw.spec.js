...
(function(root, factory) {
  ...
  describe('FormDataFPImpw', function() {
    it('should create an instance of FormDataFPImpw', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPImpw();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPImpw);
    });
