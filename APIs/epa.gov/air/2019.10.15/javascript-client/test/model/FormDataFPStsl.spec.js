...
(function(root, factory) {
  ...
  describe('FormDataFPStsl', function() {
    it('should create an instance of FormDataFPStsl', function() {
      // uncomment below and update the code to test FormDataFPStsl
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPStsl();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPStsl);
    });
