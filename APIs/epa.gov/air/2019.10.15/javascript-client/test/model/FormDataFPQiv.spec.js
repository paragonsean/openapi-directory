...
(function(root, factory) {
  ...
  describe('FormDataFPQiv', function() {
    it('should create an instance of FormDataFPQiv', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPQiv();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPQiv);
    });
