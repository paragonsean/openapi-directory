...
(function(root, factory) {
  ...
  describe('FormDataFPDecouple', function() {
    it('should create an instance of FormDataFPDecouple', function() {
      // uncomment below and update the code to test FormDataFPDecouple
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPDecouple();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPDecouple);
    });
