...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air09();
  });
  ...
  describe('Air09', function() {
    it('should create an instance of Air09', function() {
      // uncomment below and update the code to test Air09
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air09();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.Air09);
    });
