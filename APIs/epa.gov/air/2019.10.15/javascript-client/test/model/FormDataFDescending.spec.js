...
(function(root, factory) {
  ...
  describe('FormDataFDescending', function() {
    it('should create an instance of FormDataFDescending', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFDescending();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFDescending);
    });
