...
(function(root, factory) {
  ...
  describe('FormDataFPReg', function() {
    it('should create an instance of FormDataFPReg', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPReg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPReg);
    });
