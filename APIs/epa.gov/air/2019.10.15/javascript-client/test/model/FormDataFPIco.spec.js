...
(function(root, factory) {
  ...
  describe('FormDataFPIco', function() {
    it('should create an instance of FormDataFPIco', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPIco);
    });
