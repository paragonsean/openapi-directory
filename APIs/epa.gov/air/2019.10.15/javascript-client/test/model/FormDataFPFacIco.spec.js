...
(function(root, factory) {
  ...
  describe('FormDataFPFacIco', function() {
    it('should create an instance of FormDataFPFacIco', function() {
      // uncomment below and update the code to test FormDataFPFacIco
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPFacIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPFacIco);
    });
