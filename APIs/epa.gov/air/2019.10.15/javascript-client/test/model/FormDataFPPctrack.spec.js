...
(function(root, factory) {
  ...
  describe('FormDataFPPctrack', function() {
    it('should create an instance of FormDataFPPctrack', function() {
      // uncomment below and update the code to test FormDataFPPctrack
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPctrack();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.FormDataFPPctrack);
    });
