...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoCleanAirAct.MetadataApi();
  });
  ...
  describe('MetadataApi', function() {
    describe('airRestServicesMetadataGet', function() {
      it('should call airRestServicesMetadataGet successfully', function(done) {
        //uncomment below and update the code to test airRestServicesMetadataGet
        //instance.airRestServicesMetadataGet(function(error) {
    ...
    describe('airRestServicesMetadataPost', function() {
      it('should call airRestServicesMetadataPost successfully', function(done) {
        //uncomment below and update the code to test airRestServicesMetadataPost
        //instance.airRestServicesMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
