 ...
 */
@JsonAdapter(FormDataFPReg.Adapter.class)
public enum FormDataFPReg {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPReg> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPReg enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPReg read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPReg.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPReg.fromValue(value);
  }
}
