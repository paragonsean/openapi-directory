 ...
 */
@JsonAdapter(FormDataFPTriAmt.Adapter.class)
public enum FormDataFPTriAmt {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPTriAmt> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPTriAmt enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPTriAmt read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPTriAmt.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPTriAmt.fromValue(value);
  }
}
