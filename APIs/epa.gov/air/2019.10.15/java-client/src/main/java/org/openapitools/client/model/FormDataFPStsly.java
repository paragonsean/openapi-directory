 ...
 */
@JsonAdapter(FormDataFPStsly.Adapter.class)
public enum FormDataFPStsly {
  ...
  FormDataFPStsly(BigDecimal value) {
    this.value = value;
  }
  ...
  public static FormDataFPStsly fromValue(BigDecimal value) {
    for (FormDataFPStsly b : FormDataFPStsly.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPStsly> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPStsly enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPStsly read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPStsly.fromValue(new BigDecimal(value));
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPStsly.fromValue(new BigDecimal(value));
  }
}
