...
public class Air12 {
  ...
  public Air12 facilities(List<Air03> facilities) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Air12
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Air12.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Air12 is not found in the empty JSON string", Air12.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Air12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Air12` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Air12.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Air12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Air12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Air12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Air12.class));

       return (TypeAdapter<T>) new TypeAdapter<Air12>() {
           @Override
           public void write(JsonWriter out, Air12 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Air12 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Air12 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Air12
   * @throws IOException if the JSON string is invalid with respect to Air12
   */
  public static Air12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Air12.class);
  }

  /**
   * Convert an instance of Air12 to an JSON string
   *
   * @return JSON string
   */
