 ...
 */
@JsonAdapter(FormDataFPPsncq.Adapter.class)
public enum FormDataFPPsncq {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPsncq> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPsncq enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPsncq read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPsncq.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPsncq.fromValue(value);
  }
}
