 ...
 */
@JsonAdapter(FormDataFPGhgAmt.Adapter.class)
public enum FormDataFPGhgAmt {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPGhgAmt> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPGhgAmt enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPGhgAmt read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPGhgAmt.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPGhgAmt.fromValue(value);
  }
}
