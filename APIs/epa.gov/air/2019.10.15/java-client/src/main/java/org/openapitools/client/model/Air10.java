...
public class Air10 {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Air10
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Air10.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Air10 is not found in the empty JSON string", Air10.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Air10.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Air10` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Air10.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Air10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Air10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Air10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Air10.class));

       return (TypeAdapter<T>) new TypeAdapter<Air10>() {
           @Override
           public void write(JsonWriter out, Air10 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Air10 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Air10 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Air10
   * @throws IOException if the JSON string is invalid with respect to Air10
   */
  public static Air10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Air10.class);
  }

  /**
   * Convert an instance of Air10 to an JSON string
   *
   * @return JSON string
   */
