...
public class Air11 {
  ...
  public Air11 mapData(List<Air02> mapData) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to Air11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Air11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Air11 is not found in the empty JSON string", Air11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Air11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Air11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Air11.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Air11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Air11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Air11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Air11.class));

       return (TypeAdapter<T>) new TypeAdapter<Air11>() {
           @Override
           public void write(JsonWriter out, Air11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Air11 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Air11 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Air11
   * @throws IOException if the JSON string is invalid with respect to Air11
   */
  public static Air11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Air11.class);
  }

  /**
   * Convert an instance of Air11 to an JSON string
   *
   * @return JSON string
   */
