 ...
 */
@JsonAdapter(FormDataFPSwpa.Adapter.class)
public enum FormDataFPSwpa {
  ...
  public static FormDataFPSwpa fromValue(String value) {
    for (FormDataFPSwpa b : FormDataFPSwpa.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSwpa> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSwpa enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSwpa read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSwpa.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSwpa.fromValue(value);
  }
}
