 ...
 */
@JsonAdapter(FormDataFPPd.Adapter.class)
public enum FormDataFPPd {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPPd> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPPd enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPPd read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPPd.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPPd.fromValue(value);
  }
}
