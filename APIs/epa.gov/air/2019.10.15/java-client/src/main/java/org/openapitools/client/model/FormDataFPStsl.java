 ...
 */
@JsonAdapter(FormDataFPStsl.Adapter.class)
public enum FormDataFPStsl {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPStsl> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPStsl enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPStsl read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPStsl.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPStsl.fromValue(value);
  }
}
