...
class Air12(Model):
    ...
    def __init__(self, facilities: List[Air03]=None, message: str=None, page_no: str=None, query_id: str=None, query_rows: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Air12':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The air12 of this Air12.
        """
