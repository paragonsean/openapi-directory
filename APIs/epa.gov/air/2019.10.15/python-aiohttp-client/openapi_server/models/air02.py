...
class Air02(Model):
    ...
    def __init__(self, ca_astatus: str=None, formal_count: str=None, icon: str=None, informal_count: str=None, lat: str=None, lon: str=None, last_insp: str=None, name: str=None, puv: str=None, type: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Air02':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The air02 of this Air02.
        """
