...
class Air04(Model):
    ...
    def __init__(self, icon_base_url: str=None, map_data: List[Air02]=None, pop_up_base_url: str=None, query_id: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Air04':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The air04 of this Air04.
        """
