...
#ifndef OAIFormData_f_p_ghg_cat_H
#define OAIFormData_f_p_ghg_cat_H
...
class OAIFormData_f_p_ghg_cat : public OAIEnum {
public:
    OAIFormData_f_p_ghg_cat();
    OAIFormData_f_p_ghg_cat(QString json);
    ~OAIFormData_f_p_ghg_cat() override;
    ...
    enum class eOAIFormData_f_p_ghg_cat {
    ...
    OAIFormData_f_p_ghg_cat::eOAIFormData_f_p_ghg_cat getValue() const;
    void setValue(const OAIFormData_f_p_ghg_cat::eOAIFormData_f_p_ghg_cat& value);
...
private:
    ...
    eOAIFormData_f_p_ghg_cat m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_ghg_cat)

#endif // OAIFormData_f_p_ghg_cat_H
