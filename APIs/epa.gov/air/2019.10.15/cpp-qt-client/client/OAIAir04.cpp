...
OAIAir04::OAIAir04(QString json) {
...
void OAIAir04::fromJson(QString jsonString) {
...
void OAIAir04::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAir04::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAir04::getIconBaseUrl() const {
    return m_icon_base_url;
}
void OAIAir04::setIconBaseUrl(const QString &icon_base_url) {
    m_icon_base_url = icon_base_url;
    m_icon_base_url_isSet = true;
}

bool OAIAir04::is_icon_base_url_Set() const{
    return m_icon_base_url_isSet;
}

bool OAIAir04::is_icon_base_url_Valid() const{
    return m_icon_base_url_isValid;
}

QList<OAIAir02> OAIAir04::getMapData() const {
    return m_map_data;
}
void OAIAir04::setMapData(const QList<OAIAir02> &map_data) {
    m_map_data = map_data;
    m_map_data_isSet = true;
}

bool OAIAir04::is_map_data_Set() const{
    return m_map_data_isSet;
}

bool OAIAir04::is_map_data_Valid() const{
    return m_map_data_isValid;
}

QString OAIAir04::getPopUpBaseUrl() const {
    return m_pop_up_base_url;
}
void OAIAir04::setPopUpBaseUrl(const QString &pop_up_base_url) {
    m_pop_up_base_url = pop_up_base_url;
    m_pop_up_base_url_isSet = true;
}

bool OAIAir04::is_pop_up_base_url_Set() const{
    return m_pop_up_base_url_isSet;
}

bool OAIAir04::is_pop_up_base_url_Valid() const{
    return m_pop_up_base_url_isValid;
}

QString OAIAir04::getQueryId() const {
    return m_query_id;
}
void OAIAir04::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAIAir04::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAIAir04::is_query_id_Valid() const{
    return m_query_id_isValid;
}

bool OAIAir04::isSet() const {
