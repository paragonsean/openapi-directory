...
OAIAir02::OAIAir02(QString json) {
...
void OAIAir02::fromJson(QString jsonString) {
...
void OAIAir02::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAir02::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAir02::getCaAstatus() const {
    return m_ca_astatus;
}
void OAIAir02::setCaAstatus(const QString &ca_astatus) {
    m_ca_astatus = ca_astatus;
    m_ca_astatus_isSet = true;
}

bool OAIAir02::is_ca_astatus_Set() const{
    return m_ca_astatus_isSet;
}

bool OAIAir02::is_ca_astatus_Valid() const{
    return m_ca_astatus_isValid;
}

QString OAIAir02::getFormalCount() const {
    return m_formal_count;
}
void OAIAir02::setFormalCount(const QString &formal_count) {
    m_formal_count = formal_count;
    m_formal_count_isSet = true;
}

bool OAIAir02::is_formal_count_Set() const{
    return m_formal_count_isSet;
}

bool OAIAir02::is_formal_count_Valid() const{
    return m_formal_count_isValid;
}

QString OAIAir02::getIcon() const {
    return m_icon;
}
void OAIAir02::setIcon(const QString &icon) {
    m_icon = icon;
    m_icon_isSet = true;
}

bool OAIAir02::is_icon_Set() const{
    return m_icon_isSet;
}

bool OAIAir02::is_icon_Valid() const{
    return m_icon_isValid;
}

QString OAIAir02::getInformalCount() const {
    return m_informal_count;
}
void OAIAir02::setInformalCount(const QString &informal_count) {
    m_informal_count = informal_count;
    m_informal_count_isSet = true;
}

bool OAIAir02::is_informal_count_Set() const{
    return m_informal_count_isSet;
}

bool OAIAir02::is_informal_count_Valid() const{
    return m_informal_count_isValid;
}

QString OAIAir02::getLat() const {
    return m_lat;
}
void OAIAir02::setLat(const QString &lat) {
    m_lat = lat;
    m_lat_isSet = true;
}

bool OAIAir02::is_lat_Set() const{
    return m_lat_isSet;
}

bool OAIAir02::is_lat_Valid() const{
    return m_lat_isValid;
}

QString OAIAir02::getLon() const {
    return m_lon;
}
void OAIAir02::setLon(const QString &lon) {
    m_lon = lon;
    m_lon_isSet = true;
}

bool OAIAir02::is_lon_Set() const{
    return m_lon_isSet;
}

bool OAIAir02::is_lon_Valid() const{
    return m_lon_isValid;
}

QString OAIAir02::getLastInsp() const {
    return m_last_insp;
}
void OAIAir02::setLastInsp(const QString &last_insp) {
    m_last_insp = last_insp;
    m_last_insp_isSet = true;
}

bool OAIAir02::is_last_insp_Set() const{
    return m_last_insp_isSet;
}

bool OAIAir02::is_last_insp_Valid() const{
    return m_last_insp_isValid;
}

QString OAIAir02::getName() const {
    return m_name;
}
void OAIAir02::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAir02::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAir02::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIAir02::getPuv() const {
    return m_puv;
}
void OAIAir02::setPuv(const QString &puv) {
    m_puv = puv;
    m_puv_isSet = true;
}

bool OAIAir02::is_puv_Set() const{
    return m_puv_isSet;
}

bool OAIAir02::is_puv_Valid() const{
    return m_puv_isValid;
}

QString OAIAir02::getType() const {
    return m_type;
}
void OAIAir02::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAir02::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAir02::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAir02::isSet() const {
...
bool OAIAir02::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ca_astatus_isValid && m_formal_count_isValid && m_icon_isValid && m_informal_count_isValid && m_lat_isValid && m_lon_isValid && m_last_insp_isValid && m_name_isValid && m_puv_isValid && m_type_isValid && true;
}
