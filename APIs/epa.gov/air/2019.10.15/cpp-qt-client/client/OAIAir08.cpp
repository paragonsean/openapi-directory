...
OAIAir08::OAIAir08(QString json) {
...
void OAIAir08::fromJson(QString jsonString) {
...
void OAIAir08::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAir08::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAir08::getBadSystemIds() const {
    return m_bad_system_ids;
}
void OAIAir08::setBadSystemIds(const QString &bad_system_ids) {
    m_bad_system_ids = bad_system_ids;
    m_bad_system_ids_isSet = true;
}

bool OAIAir08::is_bad_system_ids_Set() const{
    return m_bad_system_ids_isSet;
}

bool OAIAir08::is_bad_system_ids_Valid() const{
    return m_bad_system_ids_isValid;
}

QString OAIAir08::getCvRows() const {
    return m_cv_rows;
}
void OAIAir08::setCvRows(const QString &cv_rows) {
    m_cv_rows = cv_rows;
    m_cv_rows_isSet = true;
}

bool OAIAir08::is_cv_rows_Set() const{
    return m_cv_rows_isSet;
}

bool OAIAir08::is_cv_rows_Valid() const{
    return m_cv_rows_isValid;
}

OAIAir01 OAIAir08::getClusterOutput() const {
    return m_cluster_output;
}
void OAIAir08::setClusterOutput(const OAIAir01 &cluster_output) {
    m_cluster_output = cluster_output;
    m_cluster_output_isSet = true;
}

bool OAIAir08::is_cluster_output_Set() const{
    return m_cluster_output_isSet;
}

bool OAIAir08::is_cluster_output_Valid() const{
    return m_cluster_output_isValid;
}

QString OAIAir08::getClusterRecords() const {
    return m_cluster_records;
}
void OAIAir08::setClusterRecords(const QString &cluster_records) {
    m_cluster_records = cluster_records;
    m_cluster_records_isSet = true;
}

bool OAIAir08::is_cluster_records_Set() const{
    return m_cluster_records_isSet;
}

bool OAIAir08::is_cluster_records_Valid() const{
    return m_cluster_records_isValid;
}

QString OAIAir08::getFeaRows() const {
    return m_fea_rows;
}
void OAIAir08::setFeaRows(const QString &fea_rows) {
    m_fea_rows = fea_rows;
    m_fea_rows_isSet = true;
}

bool OAIAir08::is_fea_rows_Set() const{
    return m_fea_rows_isSet;
}

bool OAIAir08::is_fea_rows_Valid() const{
    return m_fea_rows_isValid;
}

QList<OAIAir06> OAIAir08::getFacilities() const {
    return m_facilities;
}
void OAIAir08::setFacilities(const QList<OAIAir06> &facilities) {
    m_facilities = facilities;
    m_facilities_isSet = true;
}

bool OAIAir08::is_facilities_Set() const{
    return m_facilities_isSet;
}

bool OAIAir08::is_facilities_Valid() const{
    return m_facilities_isValid;
}

QString OAIAir08::getInspRows() const {
    return m_insp_rows;
}
void OAIAir08::setInspRows(const QString &insp_rows) {
    m_insp_rows = insp_rows;
    m_insp_rows_isSet = true;
}

bool OAIAir08::is_insp_rows_Set() const{
    return m_insp_rows_isSet;
}

bool OAIAir08::is_insp_rows_Valid() const{
    return m_insp_rows_isValid;
}

QString OAIAir08::getIconBaseUrl() const {
    return m_icon_base_url;
}
void OAIAir08::setIconBaseUrl(const QString &icon_base_url) {
    m_icon_base_url = icon_base_url;
    m_icon_base_url_isSet = true;
}

bool OAIAir08::is_icon_base_url_Set() const{
    return m_icon_base_url_isSet;
}

bool OAIAir08::is_icon_base_url_Valid() const{
    return m_icon_base_url_isValid;
}

QString OAIAir08::getIndianCountryRows() const {
    return m_indian_country_rows;
}
void OAIAir08::setIndianCountryRows(const QString &indian_country_rows) {
    m_indian_country_rows = indian_country_rows;
    m_indian_country_rows_isSet = true;
}

bool OAIAir08::is_indian_country_rows_Set() const{
    return m_indian_country_rows_isSet;
}

bool OAIAir08::is_indian_country_rows_Valid() const{
    return m_indian_country_rows_isValid;
}

QString OAIAir08::getInfFeaRows() const {
    return m_inf_fea_rows;
}
void OAIAir08::setInfFeaRows(const QString &inf_fea_rows) {
    m_inf_fea_rows = inf_fea_rows;
    m_inf_fea_rows_isSet = true;
}

bool OAIAir08::is_inf_fea_rows_Set() const{
    return m_inf_fea_rows_isSet;
}

bool OAIAir08::is_inf_fea_rows_Valid() const{
    return m_inf_fea_rows_isValid;
}

QString OAIAir08::getMessage() const {
    return m_message;
}
void OAIAir08::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAir08::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAir08::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIAir08::getPopUpBaseUrl() const {
    return m_pop_up_base_url;
}
void OAIAir08::setPopUpBaseUrl(const QString &pop_up_base_url) {
    m_pop_up_base_url = pop_up_base_url;
    m_pop_up_base_url_isSet = true;
}

bool OAIAir08::is_pop_up_base_url_Set() const{
    return m_pop_up_base_url_isSet;
}

bool OAIAir08::is_pop_up_base_url_Valid() const{
    return m_pop_up_base_url_isValid;
}

QString OAIAir08::getQueryId() const {
    return m_query_id;
}
void OAIAir08::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAIAir08::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAIAir08::is_query_id_Valid() const{
    return m_query_id_isValid;
}

QList<OAIQp0> OAIAir08::getQueryParameters() const {
    return m_query_parameters;
}
void OAIAir08::setQueryParameters(const QList<OAIQp0> &query_parameters) {
    m_query_parameters = query_parameters;
    m_query_parameters_isSet = true;
}

bool OAIAir08::is_query_parameters_Set() const{
    return m_query_parameters_isSet;
}

bool OAIAir08::is_query_parameters_Valid() const{
    return m_query_parameters_isValid;
}

QString OAIAir08::getQueryRows() const {
    return m_query_rows;
}
void OAIAir08::setQueryRows(const QString &query_rows) {
    m_query_rows = query_rows;
    m_query_rows_isSet = true;
}

bool OAIAir08::is_query_rows_Set() const{
    return m_query_rows_isSet;
}

bool OAIAir08::is_query_rows_Valid() const{
    return m_query_rows_isValid;
}

QString OAIAir08::getSvRows() const {
    return m_sv_rows;
}
void OAIAir08::setSvRows(const QString &sv_rows) {
    m_sv_rows = sv_rows;
    m_sv_rows_isSet = true;
}

bool OAIAir08::is_sv_rows_Set() const{
    return m_sv_rows_isSet;
}

bool OAIAir08::is_sv_rows_Valid() const{
    return m_sv_rows_isValid;
}

QString OAIAir08::getServiceBaseUrl() const {
    return m_service_base_url;
}
void OAIAir08::setServiceBaseUrl(const QString &service_base_url) {
    m_service_base_url = service_base_url;
    m_service_base_url_isSet = true;
}

bool OAIAir08::is_service_base_url_Set() const{
    return m_service_base_url_isSet;
}

bool OAIAir08::is_service_base_url_Valid() const{
    return m_service_base_url_isValid;
}

QString OAIAir08::getTotalPenalties() const {
    return m_total_penalties;
}
void OAIAir08::setTotalPenalties(const QString &total_penalties) {
    m_total_penalties = total_penalties;
    m_total_penalties_isSet = true;
}

bool OAIAir08::is_total_penalties_Set() const{
    return m_total_penalties_isSet;
}

bool OAIAir08::is_total_penalties_Valid() const{
    return m_total_penalties_isValid;
}

QString OAIAir08::getV3Rows() const {
    return m_v3_rows;
}
void OAIAir08::setV3Rows(const QString &v3_rows) {
    m_v3_rows = v3_rows;
    m_v3_rows_isSet = true;
}

bool OAIAir08::is_v3_rows_Set() const{
    return m_v3_rows_isSet;
}

bool OAIAir08::is_v3_rows_Valid() const{
    return m_v3_rows_isValid;
}

bool OAIAir08::isSet() const {
