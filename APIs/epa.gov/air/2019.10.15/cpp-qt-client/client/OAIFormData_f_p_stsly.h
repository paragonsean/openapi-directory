...
class OAIFormData_f_p_stsly : public OAIEnum {
public:
    OAIFormData_f_p_stsly();
    OAIFormData_f_p_stsly(QString json);
    ~OAIFormData_f_p_stsly() override;
    ...
    enum class eOAIFormData_f_p_stsly : int {
    ...
    OAIFormData_f_p_stsly::eOAIFormData_f_p_stsly getValue() const;
    void setValue(const OAIFormData_f_p_stsly::eOAIFormData_f_p_stsly& value);
...
private:
    ...
    eOAIFormData_f_p_stsly m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_stsly)

#endif // OAIFormData_f_p_stsly_H
