...
class OAIFormData_f_p_stsl : public OAIEnum {
public:
    OAIFormData_f_p_stsl();
    OAIFormData_f_p_stsl(QString json);
    ~OAIFormData_f_p_stsl() override;
    ...
    enum class eOAIFormData_f_p_stsl {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        W, 
        N
    };
    OAIFormData_f_p_stsl::eOAIFormData_f_p_stsl getValue() const;
    void setValue(const OAIFormData_f_p_stsl::eOAIFormData_f_p_stsl& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_stsl)

#endif // OAIFormData_f_p_stsl_H
