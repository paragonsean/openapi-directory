...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("airRestServicesMetadataGet", defaultConf);
    _serverIndices.insert("airRestServicesMetadataGet", 0);
    _serverConfigs.insert("airRestServicesMetadataPost", defaultConf);
    _serverIndices.insert("airRestServicesMetadataPost", 0);
}
...
void OAIMetadataApi::airRestServicesMetadataGet(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["airRestServicesMetadataGet"][_serverIndices.value("airRestServicesMetadataGet")].URL()+"/air_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::airRestServicesMetadataGetCallback);
...
void OAIMetadataApi::airRestServicesMetadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_air_rest_services_metadata_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT airRestServicesMetadataGetSignal(output);
        Q_EMIT airRestServicesMetadataGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT airRestServicesMetadataGetSignalE(output, error_type, error_str);
        Q_EMIT airRestServicesMetadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT airRestServicesMetadataGetSignalError(output, error_type, error_str);
        Q_EMIT airRestServicesMetadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::airRestServicesMetadataPost(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["airRestServicesMetadataPost"][_serverIndices.value("airRestServicesMetadataPost")].URL()+"/air_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::airRestServicesMetadataPostCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::airRestServicesMetadataPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT airRestServicesMetadataPostSignal(output);
        Q_EMIT airRestServicesMetadataPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT airRestServicesMetadataPostSignalE(output, error_type, error_str);
        Q_EMIT airRestServicesMetadataPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT airRestServicesMetadataPostSignalError(output, error_type, error_str);
        Q_EMIT airRestServicesMetadataPostSignalErrorFull(worker, error_type, error_str);
    }
}
