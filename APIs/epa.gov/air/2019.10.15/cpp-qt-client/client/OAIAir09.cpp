...
OAIAir09::OAIAir09(QString json) {
...
void OAIAir09::fromJson(QString jsonString) {
...
void OAIAir09::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAir09::asJsonObject() const {
    QJsonObject obj;
    if (m_geometry.isSet()) {
...
OAIGeo OAIAir09::getGeometry() const {
    return m_geometry;
}
void OAIAir09::setGeometry(const OAIGeo &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAIAir09::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAIAir09::is_geometry_Valid() const{
    return m_geometry_isValid;
}

OAIAir10 OAIAir09::getProperties() const {
    return m_properties;
}
void OAIAir09::setProperties(const OAIAir10 &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIAir09::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIAir09::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIAir09::getType() const {
    return m_type;
}
void OAIAir09::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIAir09::is_type_Set() const{
    return m_type_isSet;
}

bool OAIAir09::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIAir09::isSet() const {
