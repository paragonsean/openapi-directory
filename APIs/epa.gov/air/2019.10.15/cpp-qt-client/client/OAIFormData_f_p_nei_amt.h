...
#ifndef OAIFormData_f_p_nei_amt_H
#define OAIFormData_f_p_nei_amt_H
...
class OAIFormData_f_p_nei_amt : public OAIEnum {
public:
    OAIFormData_f_p_nei_amt();
    OAIFormData_f_p_nei_amt(QString json);
    ~OAIFormData_f_p_nei_amt() override;
    ...
    enum class eOAIFormData_f_p_nei_amt {
    ...
    OAIFormData_f_p_nei_amt::eOAIFormData_f_p_nei_amt getValue() const;
    void setValue(const OAIFormData_f_p_nei_amt::eOAIFormData_f_p_nei_amt& value);
...
private:
    ...
    eOAIFormData_f_p_nei_amt m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_nei_amt)

#endif // OAIFormData_f_p_nei_amt_H
