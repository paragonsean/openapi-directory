...
public:
    ...
    QString getQp() const;
    void setQp(const QString &qp);
    bool is_qp_Set() const;
    bool is_qp_Valid() const;

    QString getQv() const;
    void setQv(const QString &qv);
    bool is_qv_Set() const;
    bool is_qv_Valid() const;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQp0)
