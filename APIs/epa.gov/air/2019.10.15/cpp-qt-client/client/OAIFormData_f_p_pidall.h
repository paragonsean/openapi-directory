...
#ifndef OAIFormData_f_p_pidall_H
#define OAIFormData_f_p_pidall_H
...
class OAIFormData_f_p_pidall : public OAIEnum {
public:
    OAIFormData_f_p_pidall();
    OAIFormData_f_p_pidall(QString json);
    ~OAIFormData_f_p_pidall() override;
    ...
    enum class eOAIFormData_f_p_pidall {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_pidall::eOAIFormData_f_p_pidall getValue() const;
    void setValue(const OAIFormData_f_p_pidall::eOAIFormData_f_p_pidall& value);
...
private:
    ...
    eOAIFormData_f_p_pidall m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_pidall)

#endif // OAIFormData_f_p_pidall_H
