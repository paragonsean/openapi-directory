...
class OAIAir08 : public OAIObject {
public:
    OAIAir08();
    OAIAir08(QString json);
    ~OAIAir08() override;
    ...
    OAIAir01 getClusterOutput() const;
    void setClusterOutput(const OAIAir01 &cluster_output);
    ...
    QList<OAIAir06> getFacilities() const;
    void setFacilities(const QList<OAIAir06> &facilities);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAir08)
