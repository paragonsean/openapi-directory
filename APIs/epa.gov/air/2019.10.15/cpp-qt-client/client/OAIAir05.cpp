...
OAIAir05::OAIAir05(QString json) {
...
void OAIAir05::fromJson(QString jsonString) {
...
void OAIAir05::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIAir05::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAir05::getBadSystemIds() const {
    return m_bad_system_ids;
}
void OAIAir05::setBadSystemIds(const QString &bad_system_ids) {
    m_bad_system_ids = bad_system_ids;
    m_bad_system_ids_isSet = true;
}

bool OAIAir05::is_bad_system_ids_Set() const{
    return m_bad_system_ids_isSet;
}

bool OAIAir05::is_bad_system_ids_Valid() const{
    return m_bad_system_ids_isValid;
}

QString OAIAir05::getCvRows() const {
    return m_cv_rows;
}
void OAIAir05::setCvRows(const QString &cv_rows) {
    m_cv_rows = cv_rows;
    m_cv_rows_isSet = true;
}

bool OAIAir05::is_cv_rows_Set() const{
    return m_cv_rows_isSet;
}

bool OAIAir05::is_cv_rows_Valid() const{
    return m_cv_rows_isValid;
}

QString OAIAir05::getFeaRows() const {
    return m_fea_rows;
}
void OAIAir05::setFeaRows(const QString &fea_rows) {
    m_fea_rows = fea_rows;
    m_fea_rows_isSet = true;
}

bool OAIAir05::is_fea_rows_Set() const{
    return m_fea_rows_isSet;
}

bool OAIAir05::is_fea_rows_Valid() const{
    return m_fea_rows_isValid;
}

QList<OAIAir03> OAIAir05::getFacilities() const {
    return m_facilities;
}
void OAIAir05::setFacilities(const QList<OAIAir03> &facilities) {
    m_facilities = facilities;
    m_facilities_isSet = true;
}

bool OAIAir05::is_facilities_Set() const{
    return m_facilities_isSet;
}

bool OAIAir05::is_facilities_Valid() const{
    return m_facilities_isValid;
}

QString OAIAir05::getInspRows() const {
    return m_insp_rows;
}
void OAIAir05::setInspRows(const QString &insp_rows) {
    m_insp_rows = insp_rows;
    m_insp_rows_isSet = true;
}

bool OAIAir05::is_insp_rows_Set() const{
    return m_insp_rows_isSet;
}

bool OAIAir05::is_insp_rows_Valid() const{
    return m_insp_rows_isValid;
}

QString OAIAir05::getIndianCountryRows() const {
    return m_indian_country_rows;
}
void OAIAir05::setIndianCountryRows(const QString &indian_country_rows) {
    m_indian_country_rows = indian_country_rows;
    m_indian_country_rows_isSet = true;
}

bool OAIAir05::is_indian_country_rows_Set() const{
    return m_indian_country_rows_isSet;
}

bool OAIAir05::is_indian_country_rows_Valid() const{
    return m_indian_country_rows_isValid;
}

QString OAIAir05::getInfFeaRows() const {
    return m_inf_fea_rows;
}
void OAIAir05::setInfFeaRows(const QString &inf_fea_rows) {
    m_inf_fea_rows = inf_fea_rows;
    m_inf_fea_rows_isSet = true;
}

bool OAIAir05::is_inf_fea_rows_Set() const{
    return m_inf_fea_rows_isSet;
}

bool OAIAir05::is_inf_fea_rows_Valid() const{
    return m_inf_fea_rows_isValid;
}

OAIAir04 OAIAir05::getMapOutput() const {
    return m_map_output;
}
void OAIAir05::setMapOutput(const OAIAir04 &map_output) {
    m_map_output = map_output;
    m_map_output_isSet = true;
}

bool OAIAir05::is_map_output_Set() const{
    return m_map_output_isSet;
}

bool OAIAir05::is_map_output_Valid() const{
    return m_map_output_isValid;
}

QString OAIAir05::getMessage() const {
    return m_message;
}
void OAIAir05::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIAir05::is_message_Set() const{
    return m_message_isSet;
}

bool OAIAir05::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIAir05::getPageNo() const {
    return m_page_no;
}
void OAIAir05::setPageNo(const QString &page_no) {
    m_page_no = page_no;
    m_page_no_isSet = true;
}

bool OAIAir05::is_page_no_Set() const{
    return m_page_no_isSet;
}

bool OAIAir05::is_page_no_Valid() const{
    return m_page_no_isValid;
}

QString OAIAir05::getQueryId() const {
    return m_query_id;
}
void OAIAir05::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAIAir05::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAIAir05::is_query_id_Valid() const{
    return m_query_id_isValid;
}

QString OAIAir05::getQueryRows() const {
    return m_query_rows;
}
void OAIAir05::setQueryRows(const QString &query_rows) {
    m_query_rows = query_rows;
    m_query_rows_isSet = true;
}

bool OAIAir05::is_query_rows_Set() const{
    return m_query_rows_isSet;
}

bool OAIAir05::is_query_rows_Valid() const{
    return m_query_rows_isValid;
}

QString OAIAir05::getSvRows() const {
    return m_sv_rows;
}
void OAIAir05::setSvRows(const QString &sv_rows) {
    m_sv_rows = sv_rows;
    m_sv_rows_isSet = true;
}

bool OAIAir05::is_sv_rows_Set() const{
    return m_sv_rows_isSet;
}

bool OAIAir05::is_sv_rows_Valid() const{
    return m_sv_rows_isValid;
}

QString OAIAir05::getTotalPenalties() const {
    return m_total_penalties;
}
void OAIAir05::setTotalPenalties(const QString &total_penalties) {
    m_total_penalties = total_penalties;
    m_total_penalties_isSet = true;
}

bool OAIAir05::is_total_penalties_Set() const{
    return m_total_penalties_isSet;
}

bool OAIAir05::is_total_penalties_Valid() const{
    return m_total_penalties_isValid;
}

QString OAIAir05::getV3Rows() const {
    return m_v3_rows;
}
void OAIAir05::setV3Rows(const QString &v3_rows) {
    m_v3_rows = v3_rows;
    m_v3_rows_isSet = true;
}

bool OAIAir05::is_v3_rows_Set() const{
    return m_v3_rows_isSet;
}

bool OAIAir05::is_v3_rows_Valid() const{
    return m_v3_rows_isValid;
}

bool OAIAir05::isSet() const {
