...
#ifndef OAIFormData_f_p_tri_cat_H
#define OAIFormData_f_p_tri_cat_H
...
class OAIFormData_f_p_tri_cat : public OAIEnum {
public:
    OAIFormData_f_p_tri_cat();
    OAIFormData_f_p_tri_cat(QString json);
    ~OAIFormData_f_p_tri_cat() override;
    ...
    enum class eOAIFormData_f_p_tri_cat {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        TOTAL, 
        CARC, 
        HAP
    };
    OAIFormData_f_p_tri_cat::eOAIFormData_f_p_tri_cat getValue() const;
    void setValue(const OAIFormData_f_p_tri_cat::eOAIFormData_f_p_tri_cat& value);
...
private:
    ...
    eOAIFormData_f_p_tri_cat m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_tri_cat)

#endif // OAIFormData_f_p_tri_cat_H
