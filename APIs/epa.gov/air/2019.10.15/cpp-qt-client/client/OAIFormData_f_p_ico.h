...
class OAIFormData_f_p_ico : public OAIEnum {
public:
    OAIFormData_f_p_ico();
    OAIFormData_f_p_ico(QString json);
    ~OAIFormData_f_p_ico() override;
    ...
    enum class eOAIFormData_f_p_ico {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_ico::eOAIFormData_f_p_ico getValue() const;
    void setValue(const OAIFormData_f_p_ico::eOAIFormData_f_p_ico& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_ico)

#endif // OAIFormData_f_p_ico_H
