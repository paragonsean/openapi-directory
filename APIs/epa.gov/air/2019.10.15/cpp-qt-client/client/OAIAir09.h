...
class OAIAir09 : public OAIObject {
public:
    OAIAir09();
    OAIAir09(QString json);
    ~OAIAir09() override;
    ...
    OAIAir10 getProperties() const;
    void setProperties(const OAIAir10 &properties);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAir09)
