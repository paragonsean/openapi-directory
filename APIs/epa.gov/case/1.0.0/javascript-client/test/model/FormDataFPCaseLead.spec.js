...
(function(root, factory) {
  ...
  describe('FormDataFPCaseLead', function() {
    it('should create an instance of FormDataFPCaseLead', function() {
      // uncomment below and update the code to test FormDataFPCaseLead
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPCaseLead();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPCaseLead);
    });
