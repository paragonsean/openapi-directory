...
(function(root, factory) {
  ...
  describe('FormDataFPSepVal', function() {
    it('should create an instance of FormDataFPSepVal', function() {
      // uncomment below and update the code to test FormDataFPSepVal
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSepVal();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSepVal);
    });
