...
(function(root, factory) {
  ...
  describe('FormDataFPCivilCriminalIndicator', function() {
    it('should create an instance of FormDataFPCivilCriminalIndicator', function() {
      // uncomment below and update the code to test FormDataFPCivilCriminalIndicator
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPCivilCriminalIndicator();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPCivilCriminalIndicator);
    });
