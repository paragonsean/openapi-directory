...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1PollutantReductions();
  });
  ...
  describe('Crs1PollutantReductions', function() {
    it('should create an instance of Crs1PollutantReductions', function() {
      // uncomment below and update the code to test Crs1PollutantReductions
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1PollutantReductions();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1PollutantReductions);
    });
    ...
    it('should have the property environmentalImpactId (base name: "EnvironmentalImpactId")', function() {
      // uncomment below and update the code to test the property environmentalImpactId
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1PollutantReductions();
      //expect(instance).to.be();
    });
    ...
    it('should have the property pollutant (base name: "Pollutant")', function() {
      // uncomment below and update the code to test the property pollutant
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1PollutantReductions();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sEPorComp (base name: "SEPorComp")', function() {
      // uncomment below and update the code to test the property sEPorComp
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1PollutantReductions();
      //expect(instance).to.be();
    });
