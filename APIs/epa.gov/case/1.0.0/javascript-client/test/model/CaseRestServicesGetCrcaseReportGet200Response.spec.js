...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCrcaseReportGet200Response();
  });
  ...
  describe('CaseRestServicesGetCrcaseReportGet200Response', function() {
    it('should create an instance of CaseRestServicesGetCrcaseReportGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetCrcaseReportGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCrcaseReportGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCrcaseReportGet200Response);
    });
