...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CaseInformation();
  });
  ...
  describe('Crs3CaseInformation', function() {
    it('should create an instance of Crs3CaseInformation', function() {
      // uncomment below and update the code to test Crs3CaseInformation
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CaseInformation();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CaseInformation);
    });

    it('should have the property caseIdentifier (base name: "CaseIdentifier")', function() {
      // uncomment below and update the code to test the property caseIdentifier
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CaseInformation();
