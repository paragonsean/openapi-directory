...
(function(root, factory) {
  ...
  describe('FormDataFPSicPrimaryFlg', function() {
    it('should create an instance of FormDataFPSicPrimaryFlg', function() {
      // uncomment below and update the code to test FormDataFPSicPrimaryFlg
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSicPrimaryFlg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSicPrimaryFlg);
    });
