...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
  });
  ...
  describe('Crs1ComplianceSchedules', function() {
    it('should create an instance of Crs1ComplianceSchedules', function() {
      // uncomment below and update the code to test Crs1ComplianceSchedules
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules);
    });
    ...
    it('should have the property eventAmount (base name: "EventAmount")', function() {
      // uncomment below and update the code to test the property eventAmount
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
      //expect(instance).to.be();
    });

    it('should have the property facilityFRSID (base name: "FacilityFRSID")', function() {
      // uncomment below and update the code to test the property facilityFRSID
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
      //expect(instance).to.be();
    });

    it('should have the property scheduleCommentText (base name: "ScheduleCommentText")', function() {
      // uncomment below and update the code to test the property scheduleCommentText
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
      //expect(instance).to.be();
    });
    ...
    it('should have the property scheduleEventDescription (base name: "ScheduleEventDescription")', function() {
      // uncomment below and update the code to test the property scheduleEventDescription
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
      //expect(instance).to.be();
    });

    it('should have the property scheduleNumber (base name: "ScheduleNumber")', function() {
      // uncomment below and update the code to test the property scheduleNumber
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplianceSchedules();
      //expect(instance).to.be();
    });
