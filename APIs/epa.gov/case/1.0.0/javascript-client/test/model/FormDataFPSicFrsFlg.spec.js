...
(function(root, factory) {
  ...
  describe('FormDataFPSicFrsFlg', function() {
    it('should create an instance of FormDataFPSicFrsFlg', function() {
      // uncomment below and update the code to test FormDataFPSicFrsFlg
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSicFrsFlg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSicFrsFlg);
    });
