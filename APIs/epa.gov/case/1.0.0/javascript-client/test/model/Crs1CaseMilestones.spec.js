...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CaseMilestones();
  });
  ...
  describe('Crs1CaseMilestones', function() {
    it('should create an instance of Crs1CaseMilestones', function() {
      // uncomment below and update the code to test Crs1CaseMilestones
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CaseMilestones();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CaseMilestones);
    });
