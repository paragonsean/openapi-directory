...
(function(root, factory) {
  ...
  describe('FormDataFPFntype', function() {
    it('should create an instance of FormDataFPFntype', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPFntype();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPFntype);
    });
