...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0ClusterOutput();
  });
  ...
  describe('Crs0ClusterOutput', function() {
    it('should create an instance of Crs0ClusterOutput', function() {
      // uncomment below and update the code to test Crs0ClusterOutput
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0ClusterOutput();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0ClusterOutput);
    });
