...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Facilities();
  });
  ...
  describe('Crs1Facilities', function() {
    it('should create an instance of Crs1Facilities', function() {
      // uncomment below and update the code to test Crs1Facilities
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Facilities();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Facilities);
    });

    it('should have the property fRSNumber (base name: "FRSNumber")', function() {
      // uncomment below and update the code to test the property fRSNumber
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Facilities();
      //expect(instance).to.be();
    });

    it('should have the property facilityAddress (base name: "FacilityAddress")', function() {
      // uncomment below and update the code to test the property facilityAddress
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Facilities();
      //expect(instance).to.be();
    });
