...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0MapOutput();
  });
  ...
  describe('Crs0MapOutput', function() {
    it('should create an instance of Crs0MapOutput', function() {
      // uncomment below and update the code to test Crs0MapOutput
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0MapOutput();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0MapOutput);
    });
