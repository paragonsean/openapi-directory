...
(function(root, factory) {
  ...
  describe('FormDataFPTribal', function() {
    it('should create an instance of FormDataFPTribal', function() {
      // uncomment below and update the code to test FormDataFPTribal
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPTribal();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPTribal);
    });
