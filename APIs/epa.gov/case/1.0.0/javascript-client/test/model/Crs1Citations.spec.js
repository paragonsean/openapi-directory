...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Citations();
  });
  ...
  describe('Crs1Citations', function() {
    it('should create an instance of Crs1Citations', function() {
      // uncomment below and update the code to test Crs1Citations
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Citations();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Citations);
    });
