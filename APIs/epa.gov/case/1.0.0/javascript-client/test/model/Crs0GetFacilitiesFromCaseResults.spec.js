...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseResults();
  });
  ...
  describe('Crs0GetFacilitiesFromCaseResults', function() {
    it('should create an instance of Crs0GetFacilitiesFromCaseResults', function() {
      // uncomment below and update the code to test Crs0GetFacilitiesFromCaseResults
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseResults();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseResults);
    });
