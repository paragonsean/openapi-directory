...
(function(root, factory) {
  ...
  describe('FormDataFPMultimedia', function() {
    it('should create an instance of FormDataFPMultimedia', function() {
      // uncomment below and update the code to test FormDataFPMultimedia
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPMultimedia();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPMultimedia);
    });
