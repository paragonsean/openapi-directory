...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ProgramLinks();
  });
  ...
  describe('Crs1ProgramLinks', function() {
    it('should create an instance of Crs1ProgramLinks', function() {
      // uncomment below and update the code to test Crs1ProgramLinks
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ProgramLinks();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ProgramLinks);
    });
