...
(function(root, factory) {
  ...
  describe('FormDataFPCaseSummaryType', function() {
    it('should create an instance of FormDataFPCaseSummaryType', function() {
      // uncomment below and update the code to test FormDataFPCaseSummaryType
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPCaseSummaryType();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPCaseSummaryType);
    });
