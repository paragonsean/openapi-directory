...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Rlk51Results();
  });
  ...
  describe('Rlk51Results', function() {
    it('should create an instance of Rlk51Results', function() {
      // uncomment below and update the code to test Rlk51Results
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Rlk51Results();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Rlk51Results);
    });
