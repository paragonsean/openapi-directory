...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseRegistryIDs();
  });
  ...
  describe('Crs0GetFacilitiesFromCaseRegistryIDs', function() {
    it('should create an instance of Crs0GetFacilitiesFromCaseRegistryIDs', function() {
      // uncomment below and update the code to test Crs0GetFacilitiesFromCaseRegistryIDs
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseRegistryIDs();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseRegistryIDs);
    });
