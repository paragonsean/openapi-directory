...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCasesFromFacilityGet200Response();
  });
  ...
  describe('CaseRestServicesGetCasesFromFacilityGet200Response', function() {
    it('should create an instance of CaseRestServicesGetCasesFromFacilityGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetCasesFromFacilityGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCasesFromFacilityGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCasesFromFacilityGet200Response);
    });
