...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1SupplementalEnvironmentalProjects();
  });
  ...
  describe('Crs1SupplementalEnvironmentalProjects', function() {
    it('should create an instance of Crs1SupplementalEnvironmentalProjects', function() {
      // uncomment below and update the code to test Crs1SupplementalEnvironmentalProjects
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1SupplementalEnvironmentalProjects();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1SupplementalEnvironmentalProjects);
    });
    ...
    it('should have the property sEPAmount (base name: "SEPAmount")', function() {
      // uncomment below and update the code to test the property sEPAmount
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1SupplementalEnvironmentalProjects();
      //expect(instance).to.be();
    });

    it('should have the property sEPId (base name: "SEPId")', function() {
      // uncomment below and update the code to test the property sEPId
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1SupplementalEnvironmentalProjects();
      //expect(instance).to.be();
    });

    it('should have the property sEPText (base name: "SEPText")', function() {
      // uncomment below and update the code to test the property sEPText
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1SupplementalEnvironmentalProjects();
      //expect(instance).to.be();
    });
