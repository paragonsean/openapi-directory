...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCaseInfoGet200Response();
  });
  ...
  describe('CaseRestServicesGetCaseInfoGet200Response', function() {
    it('should create an instance of CaseRestServicesGetCaseInfoGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetCaseInfoGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCaseInfoGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCaseInfoGet200Response);
    });
