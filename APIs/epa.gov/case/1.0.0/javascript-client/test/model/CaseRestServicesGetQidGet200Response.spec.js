...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetQidGet200Response();
  });
  ...
  describe('CaseRestServicesGetQidGet200Response', function() {
    it('should create an instance of CaseRestServicesGetQidGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetQidGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetQidGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetQidGet200Response);
    });
