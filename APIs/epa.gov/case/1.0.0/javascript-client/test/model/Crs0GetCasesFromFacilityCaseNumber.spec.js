...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumber();
  });
  ...
  describe('Crs0GetCasesFromFacilityCaseNumber', function() {
    it('should create an instance of Crs0GetCasesFromFacilityCaseNumber', function() {
      // uncomment below and update the code to test Crs0GetCasesFromFacilityCaseNumber
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumber();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumber);
    });
