...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1LawsAndSections();
  });
  ...
  describe('Crs1LawsAndSections', function() {
    it('should create an instance of Crs1LawsAndSections', function() {
      // uncomment below and update the code to test Crs1LawsAndSections
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1LawsAndSections();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1LawsAndSections);
    });

    it('should have the property law (base name: "Law")', function() {
      // uncomment below and update the code to test the property law
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1LawsAndSections();
