...
(function(root, factory) {
  ...
  describe('FormDataFPSicAoNaics', function() {
    it('should create an instance of FormDataFPSicAoNaics', function() {
      // uncomment below and update the code to test FormDataFPSicAoNaics
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSicAoNaics();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPSicAoNaics);
    });
