...
(function(root, factory) {
  ...
  describe('FormDataFPNaicsPrimaryFlg', function() {
    it('should create an instance of FormDataFPNaicsPrimaryFlg', function() {
      // uncomment below and update the code to test FormDataFPNaicsPrimaryFlg
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPNaicsPrimaryFlg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPNaicsPrimaryFlg);
    });
