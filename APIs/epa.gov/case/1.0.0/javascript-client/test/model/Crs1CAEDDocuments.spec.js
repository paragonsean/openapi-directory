...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CAEDDocuments();
  });
  ...
  describe('Crs1CAEDDocuments', function() {
    it('should create an instance of Crs1CAEDDocuments', function() {
      // uncomment below and update the code to test Crs1CAEDDocuments
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CAEDDocuments();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CAEDDocuments);
    });
    ...
    it('should have the property documentLink (base name: "DocumentLink")', function() {
      // uncomment below and update the code to test the property documentLink
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CAEDDocuments();
      //expect(instance).to.be();
    });

    it('should have the property ePAProgram (base name: "EPAProgram")', function() {
      // uncomment below and update the code to test the property ePAProgram
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1CAEDDocuments();
      //expect(instance).to.be();
    });
