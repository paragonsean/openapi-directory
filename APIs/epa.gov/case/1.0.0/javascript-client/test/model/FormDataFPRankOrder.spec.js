...
(function(root, factory) {
  ...
  describe('FormDataFPRankOrder', function() {
    it('should create an instance of FormDataFPRankOrder', function() {
      // uncomment below and update the code to test FormDataFPRankOrder
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPRankOrder();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPRankOrder);
    });
