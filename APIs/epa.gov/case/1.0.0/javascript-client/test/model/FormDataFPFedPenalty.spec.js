...
(function(root, factory) {
  ...
  describe('FormDataFPFedPenalty', function() {
    it('should create an instance of FormDataFPFedPenalty', function() {
      // uncomment below and update the code to test FormDataFPFedPenalty
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPFedPenalty();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPFedPenalty);
    });
