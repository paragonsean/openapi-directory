...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Defendants();
  });
  ...
  describe('Crs1Defendants', function() {
    it('should create an instance of Crs1Defendants', function() {
      // uncomment below and update the code to test Crs1Defendants
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Defendants();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Defendants);
    });

    it('should have the property defendantName (base name: "DefendantName")', function() {
      // uncomment below and update the code to test the property defendantName
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Defendants();
      //expect(instance).to.be();
    });

    it('should have the property namedInComplaint (base name: "NamedInComplaint")', function() {
      // uncomment below and update the code to test the property namedInComplaint
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Defendants();
      //expect(instance).to.be();
    });

    it('should have the property namedInSettlement (base name: "NamedInSettlement")', function() {
      // uncomment below and update the code to test the property namedInSettlement
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Defendants();
      //expect(instance).to.be();
    });
