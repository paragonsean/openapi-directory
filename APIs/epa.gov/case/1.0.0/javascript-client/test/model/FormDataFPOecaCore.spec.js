...
(function(root, factory) {
  ...
  describe('FormDataFPOecaCore', function() {
    it('should create an instance of FormDataFPOecaCore', function() {
      // uncomment below and update the code to test FormDataFPOecaCore
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPOecaCore();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPOecaCore);
    });
