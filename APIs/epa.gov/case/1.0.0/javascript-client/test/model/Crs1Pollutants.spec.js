...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Pollutants();
  });
  ...
  describe('Crs1Pollutants', function() {
    it('should create an instance of Crs1Pollutants', function() {
      // uncomment below and update the code to test Crs1Pollutants
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Pollutants();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Pollutants);
    });

    it('should have the property chemicalAbstractNumber (base name: "ChemicalAbstractNumber")', function() {
      // uncomment below and update the code to test the property chemicalAbstractNumber
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Pollutants();
      //expect(instance).to.be();
    });

    it('should have the property pollutantName (base name: "PollutantName")', function() {
      // uncomment below and update the code to test the property pollutantName
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1Pollutants();
      //expect(instance).to.be();
    });
