...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Results();
  });
  ...
  describe('Crs3Results', function() {
    it('should create an instance of Crs3Results', function() {
      // uncomment below and update the code to test Crs3Results
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Results();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Results);
    });

    it('should have the property cRCaseInformation (base name: "CRCaseInformation")', function() {
      // uncomment below and update the code to test the property cRCaseInformation
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Results();
      //expect(instance).to.be();
    });

    it('should have the property cRDefendants (base name: "CRDefendants")', function() {
      // uncomment below and update the code to test the property cRDefendants
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Results();
      //expect(instance).to.be();
    });

    it('should have the property cRDetails (base name: "CRDetails")', function() {
      // uncomment below and update the code to test the property cRDetails
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Results();
      //expect(instance).to.be();
    });
