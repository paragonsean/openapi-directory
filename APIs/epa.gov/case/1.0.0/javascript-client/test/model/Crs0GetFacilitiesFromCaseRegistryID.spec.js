...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseRegistryID();
  });
  ...
  describe('Crs0GetFacilitiesFromCaseRegistryID', function() {
    it('should create an instance of Crs0GetFacilitiesFromCaseRegistryID', function() {
      // uncomment below and update the code to test Crs0GetFacilitiesFromCaseRegistryID
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseRegistryID();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetFacilitiesFromCaseRegistryID);
    });
