...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDetails();
  });
  ...
  describe('Crs3CRDetails', function() {
    it('should create an instance of Crs3CRDetails', function() {
      // uncomment below and update the code to test Crs3CRDetails
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDetails();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDetails);
    });

    it('should have the property detailCitations (base name: "DetailCitations")', function() {
      // uncomment below and update the code to test the property detailCitations
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDetails();
      //expect(instance).to.be();
    });

    it('should have the property detailDate (base name: "DetailDate")', function() {
      // uncomment below and update the code to test the property detailDate
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDetails();
      //expect(instance).to.be();
    });

    it('should have the property detailDesc (base name: "DetailDesc")', function() {
      // uncomment below and update the code to test the property detailDesc
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDetails();
      //expect(instance).to.be();
    });
