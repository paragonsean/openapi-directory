...
(function(root, factory) {
  ...
  describe('FormDataFPFedCase', function() {
    it('should create an instance of FormDataFPFedCase', function() {
      // uncomment below and update the code to test FormDataFPFedCase
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPFedCase();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPFedCase);
    });
