...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCaseReportGet200Response();
  });
  ...
  describe('CaseRestServicesGetCaseReportGet200Response', function() {
    it('should create an instance of CaseRestServicesGetCaseReportGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetCaseReportGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCaseReportGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCaseReportGet200Response);
    });
