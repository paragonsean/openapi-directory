...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Rlk00LuValues();
  });
  ...
  describe('Rlk00LuValues', function() {
    it('should create an instance of Rlk00LuValues', function() {
      // uncomment below and update the code to test Rlk00LuValues
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Rlk00LuValues();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Rlk00LuValues);
    });
