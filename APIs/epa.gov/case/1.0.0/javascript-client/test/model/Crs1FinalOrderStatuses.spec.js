...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
  });
  ...
  describe('Crs1FinalOrderStatuses', function() {
    it('should create an instance of Crs1FinalOrderStatuses', function() {
      // uncomment below and update the code to test Crs1FinalOrderStatuses
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses);
    });

    it('should have the property fiscalYear (base name: "FiscalYear")', function() {
      // uncomment below and update the code to test the property fiscalYear
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
      //expect(instance).to.be();
    });

    it('should have the property q1StatusDescription (base name: "Q1StatusDescription")', function() {
      // uncomment below and update the code to test the property q1StatusDescription
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
      //expect(instance).to.be();
    });

    it('should have the property q2StatusDescription (base name: "Q2StatusDescription")', function() {
      // uncomment below and update the code to test the property q2StatusDescription
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
      //expect(instance).to.be();
    });

    it('should have the property q3StatusDescription (base name: "Q3StatusDescription")', function() {
      // uncomment below and update the code to test the property q3StatusDescription
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
      //expect(instance).to.be();
    });

    it('should have the property q4StatusDescription (base name: "Q4StatusDescription")', function() {
      // uncomment below and update the code to test the property q4StatusDescription
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1FinalOrderStatuses();
      //expect(instance).to.be();
    });
