...
(function(root, factory) {
  ...
  describe('FormDataFMaplist', function() {
    it('should create an instance of FormDataFMaplist', function() {
      // uncomment below and update the code to test FormDataFMaplist
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFMaplist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFMaplist);
    });
