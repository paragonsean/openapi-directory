...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCasesGet200Response();
  });
  ...
  describe('CaseRestServicesGetCasesGet200Response', function() {
    it('should create an instance of CaseRestServicesGetCasesGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetCasesGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCasesGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetCasesGet200Response);
    });
