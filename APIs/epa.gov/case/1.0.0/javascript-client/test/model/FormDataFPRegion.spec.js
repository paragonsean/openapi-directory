...
(function(root, factory) {
  ...
  describe('FormDataFPRegion', function() {
    it('should create an instance of FormDataFPRegion', function() {
      // uncomment below and update the code to test FormDataFPRegion
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPRegion();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPRegion);
    });
