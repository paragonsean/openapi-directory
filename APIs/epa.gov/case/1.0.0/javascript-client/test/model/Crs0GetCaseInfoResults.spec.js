...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCaseInfoResults();
  });
  ...
  describe('Crs0GetCaseInfoResults', function() {
    it('should create an instance of Crs0GetCaseInfoResults', function() {
      // uncomment below and update the code to test Crs0GetCaseInfoResults
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCaseInfoResults();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCaseInfoResults);
    });
    ...
    it('should have the property mapLocations (base name: "MapLocations")', function() {
      // uncomment below and update the code to test the property mapLocations
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCaseInfoResults();
      //expect(instance).to.be();
    });
