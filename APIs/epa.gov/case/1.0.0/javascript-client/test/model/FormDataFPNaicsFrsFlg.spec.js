...
(function(root, factory) {
  ...
  describe('FormDataFPNaicsFrsFlg', function() {
    it('should create an instance of FormDataFPNaicsFrsFlg', function() {
      // uncomment below and update the code to test FormDataFPNaicsFrsFlg
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPNaicsFrsFlg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFPNaicsFrsFlg);
    });
