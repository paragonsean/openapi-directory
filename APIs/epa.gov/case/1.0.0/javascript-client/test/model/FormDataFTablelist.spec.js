...
(function(root, factory) {
  ...
  describe('FormDataFTablelist', function() {
    it('should create an instance of FormDataFTablelist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFTablelist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFTablelist);
    });
