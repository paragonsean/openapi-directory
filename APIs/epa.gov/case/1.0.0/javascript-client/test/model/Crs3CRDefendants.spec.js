...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDefendants();
  });
  ...
  describe('Crs3CRDefendants', function() {
    it('should create an instance of Crs3CRDefendants', function() {
      // uncomment below and update the code to test Crs3CRDefendants
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDefendants();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDefendants);
    });

    it('should have the property defendantType (base name: "DefendantType")', function() {
      // uncomment below and update the code to test the property defendantType
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDefendants();
    ...
    it('should have the property docketNumber (base name: "DocketNumber")', function() {
      // uncomment below and update the code to test the property docketNumber
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3CRDefendants();
      //expect(instance).to.be();
    });
