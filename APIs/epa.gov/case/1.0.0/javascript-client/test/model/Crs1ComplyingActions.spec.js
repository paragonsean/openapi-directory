...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions();
  });
  ...
  describe('Crs1ComplyingActions', function() {
    it('should create an instance of Crs1ComplyingActions', function() {
      // uncomment below and update the code to test Crs1ComplyingActions
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions);
    });

    it('should have the property complyingActionCategory (base name: "ComplyingActionCategory")', function() {
      // uncomment below and update the code to test the property complyingActionCategory
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions();
      //expect(instance).to.be();
    });

    it('should have the property complyingActionDescription (base name: "ComplyingActionDescription")', function() {
      // uncomment below and update the code to test the property complyingActionDescription
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions();
      //expect(instance).to.be();
    });

    it('should have the property complyingActionId (base name: "ComplyingActionId")', function() {
      // uncomment below and update the code to test the property complyingActionId
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions();
      //expect(instance).to.be();
    });

    it('should have the property complyingActionType (base name: "ComplyingActionType")', function() {
      // uncomment below and update the code to test the property complyingActionType
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs1ComplyingActions();
      //expect(instance).to.be();
    });
