...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesMetadataGet200Response();
  });
  ...
  describe('CaseRestServicesMetadataGet200Response', function() {
    it('should create an instance of CaseRestServicesMetadataGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesMetadataGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesMetadataGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesMetadataGet200Response);
    });
