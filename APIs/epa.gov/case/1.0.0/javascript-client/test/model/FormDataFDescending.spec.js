...
(function(root, factory) {
  ...
  describe('FormDataFDescending', function() {
    it('should create an instance of FormDataFDescending', function() {
      // uncomment below and update the code to test FormDataFDescending
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFDescending();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.FormDataFDescending);
    });
