...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetMapGet200Response();
  });
  ...
  describe('CaseRestServicesGetMapGet200Response', function() {
    it('should create an instance of CaseRestServicesGetMapGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetMapGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetMapGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetMapGet200Response);
    });
