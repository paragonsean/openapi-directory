...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumbers();
  });
  ...
  describe('Crs0GetCasesFromFacilityCaseNumbers', function() {
    it('should create an instance of Crs0GetCasesFromFacilityCaseNumbers', function() {
      // uncomment below and update the code to test Crs0GetCasesFromFacilityCaseNumbers
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumbers();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumbers);
    });

    it('should have the property caseNumbers (base name: "CaseNumbers")', function() {
      // uncomment below and update the code to test the property caseNumbers
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityCaseNumbers();
