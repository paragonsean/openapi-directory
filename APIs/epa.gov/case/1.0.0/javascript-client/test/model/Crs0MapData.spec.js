...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0MapData();
  });
  ...
  describe('Crs0MapData', function() {
    it('should create an instance of Crs0MapData', function() {
      // uncomment below and update the code to test Crs0MapData
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0MapData();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0MapData);
    });
