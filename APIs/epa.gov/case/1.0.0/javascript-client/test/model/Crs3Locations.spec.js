...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Locations();
  });
  ...
  describe('Crs3Locations', function() {
    it('should create an instance of Crs3Locations', function() {
      // uncomment below and update the code to test Crs3Locations
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Locations();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs3Locations);
    });
