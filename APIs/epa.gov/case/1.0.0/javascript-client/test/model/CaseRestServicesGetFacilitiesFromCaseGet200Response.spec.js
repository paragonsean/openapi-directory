...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetFacilitiesFromCaseGet200Response();
  });
  ...
  describe('CaseRestServicesGetFacilitiesFromCaseGet200Response', function() {
    it('should create an instance of CaseRestServicesGetFacilitiesFromCaseGet200Response', function() {
      // uncomment below and update the code to test CaseRestServicesGetFacilitiesFromCaseGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetFacilitiesFromCaseGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.CaseRestServicesGetFacilitiesFromCaseGet200Response);
    });
