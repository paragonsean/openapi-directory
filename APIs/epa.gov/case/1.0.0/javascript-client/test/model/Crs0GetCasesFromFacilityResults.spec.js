...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityResults();
  });
  ...
  describe('Crs0GetCasesFromFacilityResults', function() {
    it('should create an instance of Crs0GetCasesFromFacilityResults', function() {
      // uncomment below and update the code to test Crs0GetCasesFromFacilityResults
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityResults();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.Crs0GetCasesFromFacilityResults);
    });
