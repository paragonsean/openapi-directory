...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoEnforcementCaseSearch.MetadataApi();
  });
  ...
  describe('MetadataApi', function() {
    describe('caseRestServicesMetadataGet', function() {
      it('should call caseRestServicesMetadataGet successfully', function(done) {
        //uncomment below and update the code to test caseRestServicesMetadataGet
        //instance.caseRestServicesMetadataGet(function(error) {
    ...
    describe('caseRestServicesMetadataPost', function() {
      it('should call caseRestServicesMetadataPost successfully', function(done) {
        //uncomment below and update the code to test caseRestServicesMetadataPost
        //instance.caseRestServicesMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
