...
import Crs0ClusterData from './Crs0ClusterData';

/**
 * The Crs0ClusterOutput model module.
 * @module model/Crs0ClusterOutput
 * @version 1.0.0
 */
class Crs0ClusterOutput {
    /**
     * Constructs a new <code>Crs0ClusterOutput</code>.
     * Cluster Ouput Complex Object Array
     * @alias module:model/Crs0ClusterOutput
     */
    constructor() { 
        
        Crs0ClusterOutput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Crs0ClusterOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Crs0ClusterOutput} obj Optional instance to populate.
     * @return {module:model/Crs0ClusterOutput} The populated <code>Crs0ClusterOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Crs0ClusterOutput();

            if (data.hasOwnProperty('ClusterData')) {
                obj['ClusterData'] = ApiClient.convertToType(data['ClusterData'], [Crs0ClusterData]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Crs0ClusterOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Crs0ClusterOutput</code>.
     */
    static validateJSON(data) {
        if (data['ClusterData']) { // data not null
            ...
            for (const item of data['ClusterData']) {
                Crs0ClusterData.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/Crs0ClusterData>} ClusterData
 */
Crs0ClusterOutput.prototype['ClusterData'] = undefined;
...
export default Crs0ClusterOutput;
