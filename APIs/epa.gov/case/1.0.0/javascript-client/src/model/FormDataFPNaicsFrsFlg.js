...
/**
* Enum class FormDataFPNaicsFrsFlg.
* @enum {}
* @readonly
*/
export default class FormDataFPNaicsFrsFlg {
    ...
    /**
    * Returns a <code>FormDataFPNaicsFrsFlg</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPNaicsFrsFlg} The enum <code>FormDataFPNaicsFrsFlg</code> value.
    */
