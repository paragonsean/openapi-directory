...
/**
* Enum class FormDataFPSepVal.
* @enum {}
* @readonly
*/
export default class FormDataFPSepVal {
    ...
    /**
    * Returns a <code>FormDataFPSepVal</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSepVal} The enum <code>FormDataFPSepVal</code> value.
    */
