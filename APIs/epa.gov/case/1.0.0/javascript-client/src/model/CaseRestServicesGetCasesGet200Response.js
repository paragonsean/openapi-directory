...
import Crs2Results from './Crs2Results';

/**
 * The CaseRestServicesGetCasesGet200Response model module.
 * @module model/CaseRestServicesGetCasesGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetCasesGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetCasesGet200Response</code>.
     * Service call container.
     * @alias module:model/CaseRestServicesGetCasesGet200Response
     * @param results {module:model/Crs2Results} 
     */
    constructor(results) { 
        
        CaseRestServicesGetCasesGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetCasesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetCasesGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetCasesGet200Response} The populated <code>CaseRestServicesGetCasesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetCasesGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs2Results.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetCasesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetCasesGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetCasesGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs2Results.validateJSON(data['Results']);
        }
...
CaseRestServicesGetCasesGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs2Results} Results
 */
CaseRestServicesGetCasesGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesGetCasesGet200Response;
