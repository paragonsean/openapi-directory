...
/**
* Enum class FormDataFPRegion.
* @enum {}
* @readonly
*/
export default class FormDataFPRegion {
    ...
    /**
    * Returns a <code>FormDataFPRegion</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPRegion} The enum <code>FormDataFPRegion</code> value.
    */
