...
/**
* Enum class FormDataFPCaseLead.
* @enum {}
* @readonly
*/
export default class FormDataFPCaseLead {
    ...
    /**
    * Returns a <code>FormDataFPCaseLead</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPCaseLead} The enum <code>FormDataFPCaseLead</code> value.
    */
