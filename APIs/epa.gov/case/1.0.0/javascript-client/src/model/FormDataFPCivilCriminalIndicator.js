...
/**
* Enum class FormDataFPCivilCriminalIndicator.
* @enum {}
* @readonly
*/
export default class FormDataFPCivilCriminalIndicator {
    ...
    /**
    * Returns a <code>FormDataFPCivilCriminalIndicator</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPCivilCriminalIndicator} The enum <code>FormDataFPCivilCriminalIndicator</code> value.
    */
