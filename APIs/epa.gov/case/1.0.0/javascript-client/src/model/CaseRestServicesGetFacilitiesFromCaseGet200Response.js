...
import Crs0GetFacilitiesFromCaseResults from './Crs0GetFacilitiesFromCaseResults';

/**
 * The CaseRestServicesGetFacilitiesFromCaseGet200Response model module.
 * @module model/CaseRestServicesGetFacilitiesFromCaseGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetFacilitiesFromCaseGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetFacilitiesFromCaseGet200Response</code>.
     * Root Object
     * @alias module:model/CaseRestServicesGetFacilitiesFromCaseGet200Response
     * @param results {module:model/Crs0GetFacilitiesFromCaseResults} 
     */
    constructor(results) { 
        
        CaseRestServicesGetFacilitiesFromCaseGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetFacilitiesFromCaseGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetFacilitiesFromCaseGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetFacilitiesFromCaseGet200Response} The populated <code>CaseRestServicesGetFacilitiesFromCaseGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetFacilitiesFromCaseGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs0GetFacilitiesFromCaseResults.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetFacilitiesFromCaseGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetFacilitiesFromCaseGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetFacilitiesFromCaseGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs0GetFacilitiesFromCaseResults.validateJSON(data['Results']);
        }
...
CaseRestServicesGetFacilitiesFromCaseGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs0GetFacilitiesFromCaseResults} Results
 */
CaseRestServicesGetFacilitiesFromCaseGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesGetFacilitiesFromCaseGet200Response;
