...
import Crs0GetCasesFromFacilityCaseNumbers from './Crs0GetCasesFromFacilityCaseNumbers';

/**
 * The Crs0GetCasesFromFacilityResults model module.
 * @module model/Crs0GetCasesFromFacilityResults
 * @version 1.0.0
 */
class Crs0GetCasesFromFacilityResults {
    /**
     * Constructs a new <code>Crs0GetCasesFromFacilityResults</code>.
     * Results
     * @alias module:model/Crs0GetCasesFromFacilityResults
     * @param results {module:model/Crs0GetCasesFromFacilityCaseNumbers} 
     */
    constructor(results) { 
        
        Crs0GetCasesFromFacilityResults.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>Crs0GetCasesFromFacilityResults</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Crs0GetCasesFromFacilityResults} obj Optional instance to populate.
     * @return {module:model/Crs0GetCasesFromFacilityResults} The populated <code>Crs0GetCasesFromFacilityResults</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Crs0GetCasesFromFacilityResults();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs0GetCasesFromFacilityCaseNumbers.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Crs0GetCasesFromFacilityResults</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Crs0GetCasesFromFacilityResults</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Crs0GetCasesFromFacilityResults.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs0GetCasesFromFacilityCaseNumbers.validateJSON(data['Results']);
        }
...
Crs0GetCasesFromFacilityResults.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs0GetCasesFromFacilityCaseNumbers} Results
 */
Crs0GetCasesFromFacilityResults.prototype['Results'] = undefined;
...
export default Crs0GetCasesFromFacilityResults;
