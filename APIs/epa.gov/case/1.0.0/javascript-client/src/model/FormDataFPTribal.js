...
/**
* Enum class FormDataFPTribal.
* @enum {}
* @readonly
*/
export default class FormDataFPTribal {
    ...
    /**
    * Returns a <code>FormDataFPTribal</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPTribal} The enum <code>FormDataFPTribal</code> value.
    */
