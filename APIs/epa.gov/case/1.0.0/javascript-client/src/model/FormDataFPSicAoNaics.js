...
/**
* Enum class FormDataFPSicAoNaics.
* @enum {}
* @readonly
*/
export default class FormDataFPSicAoNaics {
    ...
    /**
    * Returns a <code>FormDataFPSicAoNaics</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSicAoNaics} The enum <code>FormDataFPSicAoNaics</code> value.
    */
