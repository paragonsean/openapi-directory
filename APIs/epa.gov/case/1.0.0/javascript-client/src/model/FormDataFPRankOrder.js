...
/**
* Enum class FormDataFPRankOrder.
* @enum {}
* @readonly
*/
export default class FormDataFPRankOrder {
    ...
    /**
    * Returns a <code>FormDataFPRankOrder</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPRankOrder} The enum <code>FormDataFPRankOrder</code> value.
    */
