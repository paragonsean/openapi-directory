...
/**
 * The CaseRestServicesGetMapGet200Response model module.
 * @module model/CaseRestServicesGetMapGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetMapGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetMapGet200Response</code>.
     * Service call container.
     * @alias module:model/CaseRestServicesGetMapGet200Response
     * @param mapOutput {module:model/Crs0MapOutput} 
     */
    constructor(mapOutput) { 
        
        CaseRestServicesGetMapGet200Response.initialize(this, mapOutput);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetMapGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetMapGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetMapGet200Response} The populated <code>CaseRestServicesGetMapGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetMapGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetMapGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetMapGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetMapGet200Response.RequiredProperties) {
...
CaseRestServicesGetMapGet200Response.RequiredProperties = ["MapOutput"];

/**
 * @member {module:model/Crs0MapOutput} MapOutput
 */
CaseRestServicesGetMapGet200Response.prototype['MapOutput'] = undefined;
...
export default CaseRestServicesGetMapGet200Response;
