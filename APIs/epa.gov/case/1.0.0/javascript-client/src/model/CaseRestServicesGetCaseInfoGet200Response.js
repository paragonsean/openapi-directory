...
import Crs0GetCaseInfoResults from './Crs0GetCaseInfoResults';

/**
 * The CaseRestServicesGetCaseInfoGet200Response model module.
 * @module model/CaseRestServicesGetCaseInfoGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetCaseInfoGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetCaseInfoGet200Response</code>.
     * Root Object
     * @alias module:model/CaseRestServicesGetCaseInfoGet200Response
     * @param results {module:model/Crs0GetCaseInfoResults} 
     */
    constructor(results) { 
        
        CaseRestServicesGetCaseInfoGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetCaseInfoGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetCaseInfoGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetCaseInfoGet200Response} The populated <code>CaseRestServicesGetCaseInfoGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetCaseInfoGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs0GetCaseInfoResults.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetCaseInfoGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetCaseInfoGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetCaseInfoGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs0GetCaseInfoResults.validateJSON(data['Results']);
        }
...
CaseRestServicesGetCaseInfoGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs0GetCaseInfoResults} Results
 */
CaseRestServicesGetCaseInfoGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesGetCaseInfoGet200Response;
