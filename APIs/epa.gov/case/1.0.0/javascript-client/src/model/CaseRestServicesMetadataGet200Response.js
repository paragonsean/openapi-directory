...
/**
 * The CaseRestServicesMetadataGet200Response model module.
 * @module model/CaseRestServicesMetadataGet200Response
 * @version 1.0.0
 */
class CaseRestServicesMetadataGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesMetadataGet200Response</code>.
     * Root Object
     * @alias module:model/CaseRestServicesMetadataGet200Response
     * @param results {module:model/Met1} 
     */
    constructor(results) { 
        
        CaseRestServicesMetadataGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesMetadataGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesMetadataGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesMetadataGet200Response} The populated <code>CaseRestServicesMetadataGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesMetadataGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Met1.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesMetadataGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesMetadataGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesMetadataGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Met1.validateJSON(data['Results']);
        }
...
CaseRestServicesMetadataGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Met1} Results
 */
CaseRestServicesMetadataGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesMetadataGet200Response;
