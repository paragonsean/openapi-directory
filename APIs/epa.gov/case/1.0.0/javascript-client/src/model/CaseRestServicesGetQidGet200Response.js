...
import Crs5Results from './Crs5Results';

/**
 * The CaseRestServicesGetQidGet200Response model module.
 * @module model/CaseRestServicesGetQidGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetQidGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetQidGet200Response</code>.
     * Service call container.
     * @alias module:model/CaseRestServicesGetQidGet200Response
     * @param results {module:model/Crs5Results} 
     */
    constructor(results) { 
        
        CaseRestServicesGetQidGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetQidGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetQidGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetQidGet200Response} The populated <code>CaseRestServicesGetQidGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetQidGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs5Results.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetQidGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetQidGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetQidGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs5Results.validateJSON(data['Results']);
        }
...
CaseRestServicesGetQidGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs5Results} Results
 */
CaseRestServicesGetQidGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesGetQidGet200Response;
