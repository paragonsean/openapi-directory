...
import Crs1Results from './Crs1Results';

/**
 * The CaseRestServicesGetCaseReportGet200Response model module.
 * @module model/CaseRestServicesGetCaseReportGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetCaseReportGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetCaseReportGet200Response</code>.
     * Service call container.
     * @alias module:model/CaseRestServicesGetCaseReportGet200Response
     * @param results {module:model/Crs1Results} 
     */
    constructor(results) { 
        
        CaseRestServicesGetCaseReportGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetCaseReportGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetCaseReportGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetCaseReportGet200Response} The populated <code>CaseRestServicesGetCaseReportGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetCaseReportGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs1Results.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetCaseReportGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetCaseReportGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetCaseReportGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs1Results.validateJSON(data['Results']);
        }
...
CaseRestServicesGetCaseReportGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs1Results} Results
 */
CaseRestServicesGetCaseReportGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesGetCaseReportGet200Response;
