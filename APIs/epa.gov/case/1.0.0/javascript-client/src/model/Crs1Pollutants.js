...
/**
 * The Crs1Pollutants model module.
 * @module model/Crs1Pollutants
 * @version 1.0.0
 */
class Crs1Pollutants {
    /**
     * Constructs a new <code>Crs1Pollutants</code>.
     * The common name identifying the pollutant, waste material, substance, or chemical reduced.
     * @alias module:model/Crs1Pollutants
     * @param chemicalAbstractNumber {String} This is the unique number assigned to a chemical substance by the Chemical Abstracts Service.
     * @param pollutantName {String} The name designating the waste material substance or chemical involved at the facility that has a Quantitative Environmental Impact addressed in the SEP or Complying Actions.
     */
    constructor(chemicalAbstractNumber, pollutantName) { 
        
        Crs1Pollutants.initialize(this, chemicalAbstractNumber, pollutantName);
    }
     ...
     */
    static initialize(obj, chemicalAbstractNumber, pollutantName) { 
        obj['ChemicalAbstractNumber'] = chemicalAbstractNumber;
        obj['PollutantName'] = pollutantName;
    }

    /**
     * Constructs a <code>Crs1Pollutants</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Crs1Pollutants} obj Optional instance to populate.
     * @return {module:model/Crs1Pollutants} The populated <code>Crs1Pollutants</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Crs1Pollutants();

            if (data.hasOwnProperty('ChemicalAbstractNumber')) {
                obj['ChemicalAbstractNumber'] = ApiClient.convertToType(data['ChemicalAbstractNumber'], 'String');
            }
            if (data.hasOwnProperty('PollutantName')) {
                obj['PollutantName'] = ApiClient.convertToType(data['PollutantName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Crs1Pollutants</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Crs1Pollutants</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Crs1Pollutants.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['ChemicalAbstractNumber'] && !(typeof data['ChemicalAbstractNumber'] === 'string' || data['ChemicalAbstractNumber'] instanceof String)) {
            throw new Error("Expected the field `ChemicalAbstractNumber` to be a primitive type in the JSON string but got " + data['ChemicalAbstractNumber']);
        }
        // ensure the json data is a string
        if (data['PollutantName'] && !(typeof data['PollutantName'] === 'string' || data['PollutantName'] instanceof String)) {
            throw new Error("Expected the field `PollutantName` to be a primitive type in the JSON string but got " + data['PollutantName']);
        }
...
Crs1Pollutants.RequiredProperties = ["ChemicalAbstractNumber", "PollutantName"];

/**
 * This is the unique number assigned to a chemical substance by the Chemical Abstracts Service.
 * @member {String} ChemicalAbstractNumber
 */
Crs1Pollutants.prototype['ChemicalAbstractNumber'] = undefined;
 ...
 * @member {String} PollutantName
 */
Crs1Pollutants.prototype['PollutantName'] = undefined;
