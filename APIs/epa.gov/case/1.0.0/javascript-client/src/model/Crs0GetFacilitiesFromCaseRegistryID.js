...
/**
 * The Crs0GetFacilitiesFromCaseRegistryID model module.
 * @module model/Crs0GetFacilitiesFromCaseRegistryID
 * @version 1.0.0
 */
class Crs0GetFacilitiesFromCaseRegistryID {
    /**
     * Constructs a new <code>Crs0GetFacilitiesFromCaseRegistryID</code>.
     * Registry ID
     * @alias module:model/Crs0GetFacilitiesFromCaseRegistryID
    ...
    constructor(registryID) { 
        ...
        Crs0GetFacilitiesFromCaseRegistryID.initialize(this, registryID);
    }
    ...
    /**
     * Constructs a <code>Crs0GetFacilitiesFromCaseRegistryID</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Crs0GetFacilitiesFromCaseRegistryID} obj Optional instance to populate.
     * @return {module:model/Crs0GetFacilitiesFromCaseRegistryID} The populated <code>Crs0GetFacilitiesFromCaseRegistryID</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Crs0GetFacilitiesFromCaseRegistryID();
    ...
    /**
     * Validates the JSON data with respect to <code>Crs0GetFacilitiesFromCaseRegistryID</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Crs0GetFacilitiesFromCaseRegistryID</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Crs0GetFacilitiesFromCaseRegistryID.RequiredProperties) {
...
Crs0GetFacilitiesFromCaseRegistryID.RequiredProperties = ["RegistryID"];
 ...
 */
Crs0GetFacilitiesFromCaseRegistryID.prototype['RegistryID'] = undefined;
...
export default Crs0GetFacilitiesFromCaseRegistryID;
