...
import Crs0GetFacilitiesFromCaseRegistryIDs from './Crs0GetFacilitiesFromCaseRegistryIDs';

/**
 * The Crs0GetFacilitiesFromCaseResults model module.
 * @module model/Crs0GetFacilitiesFromCaseResults
 * @version 1.0.0
 */
class Crs0GetFacilitiesFromCaseResults {
    /**
     * Constructs a new <code>Crs0GetFacilitiesFromCaseResults</code>.
     * Results
     * @alias module:model/Crs0GetFacilitiesFromCaseResults
     * @param results {module:model/Crs0GetFacilitiesFromCaseRegistryIDs} 
     */
    constructor(results) { 
        
        Crs0GetFacilitiesFromCaseResults.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>Crs0GetFacilitiesFromCaseResults</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Crs0GetFacilitiesFromCaseResults} obj Optional instance to populate.
     * @return {module:model/Crs0GetFacilitiesFromCaseResults} The populated <code>Crs0GetFacilitiesFromCaseResults</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Crs0GetFacilitiesFromCaseResults();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs0GetFacilitiesFromCaseRegistryIDs.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Crs0GetFacilitiesFromCaseResults</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Crs0GetFacilitiesFromCaseResults</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Crs0GetFacilitiesFromCaseResults.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs0GetFacilitiesFromCaseRegistryIDs.validateJSON(data['Results']);
        }
...
Crs0GetFacilitiesFromCaseResults.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs0GetFacilitiesFromCaseRegistryIDs} Results
 */
Crs0GetFacilitiesFromCaseResults.prototype['Results'] = undefined;
...
export default Crs0GetFacilitiesFromCaseResults;
