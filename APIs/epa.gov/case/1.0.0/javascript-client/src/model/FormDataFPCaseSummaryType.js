...
/**
* Enum class FormDataFPCaseSummaryType.
* @enum {}
* @readonly
*/
export default class FormDataFPCaseSummaryType {
    ...
    /**
    * Returns a <code>FormDataFPCaseSummaryType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPCaseSummaryType} The enum <code>FormDataFPCaseSummaryType</code> value.
    */
