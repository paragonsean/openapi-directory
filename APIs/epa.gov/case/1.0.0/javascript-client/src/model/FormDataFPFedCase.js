...
/**
* Enum class FormDataFPFedCase.
* @enum {}
* @readonly
*/
export default class FormDataFPFedCase {
    ...
    /**
    * Returns a <code>FormDataFPFedCase</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFedCase} The enum <code>FormDataFPFedCase</code> value.
    */
