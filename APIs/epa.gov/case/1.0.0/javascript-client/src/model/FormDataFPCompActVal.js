...
/**
* Enum class FormDataFPCompActVal.
* @enum {}
* @readonly
*/
export default class FormDataFPCompActVal {
    ...
    /**
    * Returns a <code>FormDataFPCompActVal</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPCompActVal} The enum <code>FormDataFPCompActVal</code> value.
    */
