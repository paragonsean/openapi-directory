...
import Crs0GetCasesFromFacilityResults from './Crs0GetCasesFromFacilityResults';

/**
 * The CaseRestServicesGetCasesFromFacilityGet200Response model module.
 * @module model/CaseRestServicesGetCasesFromFacilityGet200Response
 * @version 1.0.0
 */
class CaseRestServicesGetCasesFromFacilityGet200Response {
    /**
     * Constructs a new <code>CaseRestServicesGetCasesFromFacilityGet200Response</code>.
     * Root Object
     * @alias module:model/CaseRestServicesGetCasesFromFacilityGet200Response
     * @param results {module:model/Crs0GetCasesFromFacilityResults} 
     */
    constructor(results) { 
        
        CaseRestServicesGetCasesFromFacilityGet200Response.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>CaseRestServicesGetCasesFromFacilityGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CaseRestServicesGetCasesFromFacilityGet200Response} obj Optional instance to populate.
     * @return {module:model/CaseRestServicesGetCasesFromFacilityGet200Response} The populated <code>CaseRestServicesGetCasesFromFacilityGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CaseRestServicesGetCasesFromFacilityGet200Response();

            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Crs0GetCasesFromFacilityResults.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CaseRestServicesGetCasesFromFacilityGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CaseRestServicesGetCasesFromFacilityGet200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CaseRestServicesGetCasesFromFacilityGet200Response.RequiredProperties) {
        ...
        if (data['Results']) { // data not null
          Crs0GetCasesFromFacilityResults.validateJSON(data['Results']);
        }
...
CaseRestServicesGetCasesFromFacilityGet200Response.RequiredProperties = ["Results"];

/**
 * @member {module:model/Crs0GetCasesFromFacilityResults} Results
 */
CaseRestServicesGetCasesFromFacilityGet200Response.prototype['Results'] = undefined;
...
export default CaseRestServicesGetCasesFromFacilityGet200Response;
