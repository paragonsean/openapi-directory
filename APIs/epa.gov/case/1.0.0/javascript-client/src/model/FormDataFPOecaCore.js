...
/**
* Enum class FormDataFPOecaCore.
* @enum {}
* @readonly
*/
export default class FormDataFPOecaCore {
    ...
    /**
    * Returns a <code>FormDataFPOecaCore</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPOecaCore} The enum <code>FormDataFPOecaCore</code> value.
    */
