...
/**
* Enum class FormDataFPFedPenalty.
* @enum {}
* @readonly
*/
export default class FormDataFPFedPenalty {
    ...
    /**
    * Returns a <code>FormDataFPFedPenalty</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFedPenalty} The enum <code>FormDataFPFedPenalty</code> value.
    */
