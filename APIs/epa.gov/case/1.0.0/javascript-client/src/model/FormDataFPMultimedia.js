...
/**
* Enum class FormDataFPMultimedia.
* @enum {}
* @readonly
*/
export default class FormDataFPMultimedia {
    ...
    /**
    * Returns a <code>FormDataFPMultimedia</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPMultimedia} The enum <code>FormDataFPMultimedia</code> value.
    */
