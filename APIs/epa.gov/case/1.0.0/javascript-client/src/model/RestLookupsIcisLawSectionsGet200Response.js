...
import Rlk51Results from './Rlk51Results';
...
class RestLookupsIcisLawSectionsGet200Response {
     ...
     * @param results {module:model/Rlk51Results} 
     */
    constructor(results) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Results')) {
                obj['Results'] = Rlk51Results.constructFromObject(data['Results']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['Results']) { // data not null
          Rlk51Results.validateJSON(data['Results']);
        }
...
/**
 * @member {module:model/Rlk51Results} Results
 */
