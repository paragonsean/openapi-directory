...
/**
* Enum class FormDataFPNaicsPrimaryFlg.
* @enum {}
* @readonly
*/
export default class FormDataFPNaicsPrimaryFlg {
    ...
    /**
    * Returns a <code>FormDataFPNaicsPrimaryFlg</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPNaicsPrimaryFlg} The enum <code>FormDataFPNaicsPrimaryFlg</code> value.
    */
