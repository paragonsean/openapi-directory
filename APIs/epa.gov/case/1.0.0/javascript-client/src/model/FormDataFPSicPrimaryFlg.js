...
/**
* Enum class FormDataFPSicPrimaryFlg.
* @enum {}
* @readonly
*/
export default class FormDataFPSicPrimaryFlg {
    ...
    /**
    * Returns a <code>FormDataFPSicPrimaryFlg</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPSicPrimaryFlg} The enum <code>FormDataFPSicPrimaryFlg</code> value.
    */
