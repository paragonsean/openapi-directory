...
/**
 * The Met1 model module.
 * @module model/Met1
 * @version 1.0.0
 */
class Met1 {
    /**
     * Constructs a new <code>Met1</code>.
     * Results Object
     * @alias module:model/Met1
     * @param message {String} Field to record messages (typically performance-related) about packet processing
     */
    constructor(message) { 
        
        Met1.initialize(this, message);
    }
    ...
    /**
     * Constructs a <code>Met1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Met1} obj Optional instance to populate.
     * @return {module:model/Met1} The populated <code>Met1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ResultColumns')) {
                obj['ResultColumns'] = ApiClient.convertToType(data['ResultColumns'], [Met2]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Met1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Met1</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Met1.RequiredProperties) {
...
Met1.RequiredProperties = ["Message"];

/**
 * Field to record messages (typically performance-related) about packet processing
 * @member {String} Message
 */
Met1.prototype['Message'] = undefined;

/**
 * @member {Array.<module:model/Met2>} ResultColumns
 */
Met1.prototype['ResultColumns'] = undefined;
