...
/**
* Enum class FormDataFPUsmex.
* @enum {}
* @readonly
*/
export default class FormDataFPUsmex {
    ...
    /**
    * Returns a <code>FormDataFPUsmex</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPUsmex} The enum <code>FormDataFPUsmex</code> value.
    */
