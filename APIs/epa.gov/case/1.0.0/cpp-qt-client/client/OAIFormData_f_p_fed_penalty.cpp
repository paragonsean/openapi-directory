...
#include "OAIFormData_f_p_fed_penalty.h"
...
OAIFormData_f_p_fed_penalty::OAIFormData_f_p_fed_penalty(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_fed_penalty::OAIFormData_f_p_fed_penalty() {
    this->initializeModel();
}

OAIFormData_f_p_fed_penalty::~OAIFormData_f_p_fed_penalty() {}

void OAIFormData_f_p_fed_penalty::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_fed_penalty::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_fed_penalty::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ANY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::ANY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LE5000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::LE5000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT5000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::GT5000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT50000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::GT50000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT100000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::GT100000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT500000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::GT500000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT1000000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::GT1000000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT2500000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_penalty::GT2500000;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_fed_penalty::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_fed_penalty::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_fed_penalty::ANY:
            val = "ANY";
            break;
        case eOAIFormData_f_p_fed_penalty::LE5000:
            val = "LE5000";
            break;
        case eOAIFormData_f_p_fed_penalty::GT5000:
            val = "GT5000";
            break;
        case eOAIFormData_f_p_fed_penalty::GT50000:
            val = "GT50000";
            break;
        case eOAIFormData_f_p_fed_penalty::GT100000:
            val = "GT100000";
            break;
        case eOAIFormData_f_p_fed_penalty::GT500000:
            val = "GT500000";
            break;
        case eOAIFormData_f_p_fed_penalty::GT1000000:
            val = "GT1000000";
            break;
        case eOAIFormData_f_p_fed_penalty::GT2500000:
            val = "GT2500000";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_fed_penalty::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_fed_penalty::eOAIFormData_f_p_fed_penalty OAIFormData_f_p_fed_penalty::getValue() const {
    return m_value;
}

void OAIFormData_f_p_fed_penalty::setValue(const OAIFormData_f_p_fed_penalty::eOAIFormData_f_p_fed_penalty& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_fed_penalty::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_fed_penalty::isValid() const {
