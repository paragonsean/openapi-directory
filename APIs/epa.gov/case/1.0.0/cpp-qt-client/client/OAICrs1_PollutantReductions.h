...
#ifndef OAICrs1_PollutantReductions_H
#define OAICrs1_PollutantReductions_H
...
class OAICrs1_PollutantReductions : public OAIObject {
public:
    OAICrs1_PollutantReductions();
    OAICrs1_PollutantReductions(QString json);
    ~OAICrs1_PollutantReductions() override;
    ...
    QString getAnnualAmount() const;
    void setAnnualAmount(const QString &annual_amount);
    bool is_annual_amount_Set() const;
    bool is_annual_amount_Valid() const;

    QString getComplyingActionId() const;
    void setComplyingActionId(const QString &complying_action_id);
    bool is_complying_action_id_Set() const;
    bool is_complying_action_id_Valid() const;

    QString getEnvironmentalImpactId() const;
    void setEnvironmentalImpactId(const QString &environmental_impact_id);
    bool is_environmental_impact_id_Set() const;
    bool is_environmental_impact_id_Valid() const;
    ...
    QString getPollutant() const;
    void setPollutant(const QString &pollutant);
    bool is_pollutant_Set() const;
    bool is_pollutant_Valid() const;
    ...
    QString getSePorComp() const;
    void setSePorComp(const QString &se_por_comp);
    bool is_se_por_comp_Set() const;
    bool is_se_por_comp_Valid() const;
...
private:
    ...
    QString m_annual_amount;
    bool m_annual_amount_isSet;
    bool m_annual_amount_isValid;

    QString m_complying_action_id;
    bool m_complying_action_id_isSet;
    bool m_complying_action_id_isValid;

    QString m_environmental_impact_id;
    bool m_environmental_impact_id_isSet;
    bool m_environmental_impact_id_isValid;
    ...
    QString m_pollutant;
    bool m_pollutant_isSet;
    bool m_pollutant_isValid;

    QString m_sepid;
    bool m_sepid_isSet;
    bool m_sepid_isValid;

    QString m_se_por_comp;
    bool m_se_por_comp_isSet;
    bool m_se_por_comp_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_PollutantReductions)

#endif // OAICrs1_PollutantReductions_H
