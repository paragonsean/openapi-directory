...
/*
 * OAI_case_rest_services_get_case_report_get_200_response.h
 *
 * Service call container.
 */

#ifndef OAI_case_rest_services_get_case_report_get_200_response_H
#define OAI_case_rest_services_get_case_report_get_200_response_H
...
namespace OpenAPI {
class OAICrs1_Results;

class OAI_case_rest_services_get_case_report_get_200_response : public OAIObject {
public:
    OAI_case_rest_services_get_case_report_get_200_response();
    OAI_case_rest_services_get_case_report_get_200_response(QString json);
    ~OAI_case_rest_services_get_case_report_get_200_response() override;
    ...
    OAICrs1_Results getResults() const;
    void setResults(const OAICrs1_Results &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_case_rest_services_get_case_report_get_200_response)

#endif // OAI_case_rest_services_get_case_report_get_200_response_H
