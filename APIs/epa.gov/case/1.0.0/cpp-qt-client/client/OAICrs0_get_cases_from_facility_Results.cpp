...
OAICrs0_get_cases_from_facility_Results::OAICrs0_get_cases_from_facility_Results(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrs0_get_cases_from_facility_Results::OAICrs0_get_cases_from_facility_Results() {
    this->initializeModel();
}

OAICrs0_get_cases_from_facility_Results::~OAICrs0_get_cases_from_facility_Results() {}

void OAICrs0_get_cases_from_facility_Results::initializeModel() {

    m_results_isSet = false;
    m_results_isValid = false;
}

void OAICrs0_get_cases_from_facility_Results::fromJson(QString jsonString) {
...
void OAICrs0_get_cases_from_facility_Results::fromJsonObject(QJsonObject json) {

    m_results_isValid = ::OpenAPI::fromJsonValue(m_results, json[QString("Results")]);
    m_results_isSet = !json[QString("Results")].isNull() && m_results_isValid;
}

QString OAICrs0_get_cases_from_facility_Results::asJson() const {
...
QJsonObject OAICrs0_get_cases_from_facility_Results::asJsonObject() const {
    QJsonObject obj;
    if (m_results.isSet()) {
...
OAICrs0_get_cases_from_facility_CaseNumbers OAICrs0_get_cases_from_facility_Results::getResults() const {
    return m_results;
}
void OAICrs0_get_cases_from_facility_Results::setResults(const OAICrs0_get_cases_from_facility_CaseNumbers &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAICrs0_get_cases_from_facility_Results::is_results_Set() const{
    return m_results_isSet;
}

bool OAICrs0_get_cases_from_facility_Results::is_results_Valid() const{
    return m_results_isValid;
}

bool OAICrs0_get_cases_from_facility_Results::isSet() const {
...
bool OAICrs0_get_cases_from_facility_Results::isValid() const {
