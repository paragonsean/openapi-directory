...
/*
 * OAIFormData_f_p_oeca_core.h
 *
 * OECA Core Program Flag.  Enter Y or N to include or exclude core program cases.
 */

#ifndef OAIFormData_f_p_oeca_core_H
#define OAIFormData_f_p_oeca_core_H
...
class OAIFormData_f_p_oeca_core : public OAIEnum {
public:
    OAIFormData_f_p_oeca_core();
    OAIFormData_f_p_oeca_core(QString json);
    ~OAIFormData_f_p_oeca_core() override;
    ...
    enum class eOAIFormData_f_p_oeca_core {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_oeca_core::eOAIFormData_f_p_oeca_core getValue() const;
    void setValue(const OAIFormData_f_p_oeca_core::eOAIFormData_f_p_oeca_core& value);
...
private:
    ...
    eOAIFormData_f_p_oeca_core m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_oeca_core)

#endif // OAIFormData_f_p_oeca_core_H
