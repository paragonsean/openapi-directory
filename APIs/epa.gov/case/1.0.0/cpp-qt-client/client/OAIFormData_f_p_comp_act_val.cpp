...
#include "OAIFormData_f_p_comp_act_val.h"
...
OAIFormData_f_p_comp_act_val::OAIFormData_f_p_comp_act_val(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_comp_act_val::OAIFormData_f_p_comp_act_val() {
    this->initializeModel();
}

OAIFormData_f_p_comp_act_val::~OAIFormData_f_p_comp_act_val() {}

void OAIFormData_f_p_comp_act_val::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_comp_act_val::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_comp_act_val::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ANY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_comp_act_val::ANY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LE5000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_comp_act_val::LE5000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT5000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_comp_act_val::GT5000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT100000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_comp_act_val::GT100000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT1000000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_comp_act_val::GT1000000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT50000000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_comp_act_val::GT50000000;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_comp_act_val::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_comp_act_val::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_comp_act_val::ANY:
            val = "ANY";
            break;
        case eOAIFormData_f_p_comp_act_val::LE5000:
            val = "LE5000";
            break;
        case eOAIFormData_f_p_comp_act_val::GT5000:
            val = "GT5000";
            break;
        case eOAIFormData_f_p_comp_act_val::GT100000:
            val = "GT100000";
            break;
        case eOAIFormData_f_p_comp_act_val::GT1000000:
            val = "GT1000000";
            break;
        case eOAIFormData_f_p_comp_act_val::GT50000000:
            val = "GT50000000";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_comp_act_val::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_comp_act_val::eOAIFormData_f_p_comp_act_val OAIFormData_f_p_comp_act_val::getValue() const {
    return m_value;
}

void OAIFormData_f_p_comp_act_val::setValue(const OAIFormData_f_p_comp_act_val::eOAIFormData_f_p_comp_act_val& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_comp_act_val::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_comp_act_val::isValid() const {
