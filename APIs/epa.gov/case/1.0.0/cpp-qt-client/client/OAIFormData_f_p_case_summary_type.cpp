...
#include "OAIFormData_f_p_case_summary_type.h"
...
OAIFormData_f_p_case_summary_type::OAIFormData_f_p_case_summary_type(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_case_summary_type::OAIFormData_f_p_case_summary_type() {
    this->initializeModel();
}

OAIFormData_f_p_case_summary_type::~OAIFormData_f_p_case_summary_type() {}

void OAIFormData_f_p_case_summary_type::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_case_summary_type::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_case_summary_type::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ALL", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_case_summary_type::ALL;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("CONTAINS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_case_summary_type::CONTAINS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("WITHIN", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_case_summary_type::WITHIN;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_case_summary_type::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_case_summary_type::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_case_summary_type::ALL:
            val = "ALL";
            break;
        case eOAIFormData_f_p_case_summary_type::CONTAINS:
            val = "CONTAINS";
            break;
        case eOAIFormData_f_p_case_summary_type::WITHIN:
            val = "WITHIN";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_case_summary_type::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_case_summary_type::eOAIFormData_f_p_case_summary_type OAIFormData_f_p_case_summary_type::getValue() const {
    return m_value;
}

void OAIFormData_f_p_case_summary_type::setValue(const OAIFormData_f_p_case_summary_type::eOAIFormData_f_p_case_summary_type& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_case_summary_type::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_case_summary_type::isValid() const {
