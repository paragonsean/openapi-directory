...
class OAIFormData_f_p_case_lead : public OAIEnum {
public:
    OAIFormData_f_p_case_lead();
    OAIFormData_f_p_case_lead(QString json);
    ~OAIFormData_f_p_case_lead() override;
    ...
    enum class eOAIFormData_f_p_case_lead {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        E, 
        S
    };
    OAIFormData_f_p_case_lead::eOAIFormData_f_p_case_lead getValue() const;
    void setValue(const OAIFormData_f_p_case_lead::eOAIFormData_f_p_case_lead& value);
...
private:
    ...
    eOAIFormData_f_p_case_lead m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_case_lead)

#endif // OAIFormData_f_p_case_lead_H
