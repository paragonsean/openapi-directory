...
#include "OAIFormData_f_p_sic_ao_naics.h"
...
OAIFormData_f_p_sic_ao_naics::OAIFormData_f_p_sic_ao_naics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_sic_ao_naics::OAIFormData_f_p_sic_ao_naics() {
    this->initializeModel();
}

OAIFormData_f_p_sic_ao_naics::~OAIFormData_f_p_sic_ao_naics() {}

void OAIFormData_f_p_sic_ao_naics::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_sic_ao_naics::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_sic_ao_naics::fromJson(QString jsonString) {
    
    if ( jsonString.compare("AND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sic_ao_naics::AND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("OR", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sic_ao_naics::OR;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_sic_ao_naics::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_sic_ao_naics::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_sic_ao_naics::AND:
            val = "AND";
            break;
        case eOAIFormData_f_p_sic_ao_naics::OR:
            val = "OR";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_sic_ao_naics::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_sic_ao_naics::eOAIFormData_f_p_sic_ao_naics OAIFormData_f_p_sic_ao_naics::getValue() const {
    return m_value;
}

void OAIFormData_f_p_sic_ao_naics::setValue(const OAIFormData_f_p_sic_ao_naics::eOAIFormData_f_p_sic_ao_naics& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_sic_ao_naics::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_sic_ao_naics::isValid() const {
