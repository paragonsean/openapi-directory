...
/*
 * OAIFormData_f_p_case_summary_type.h
 *
...
#ifndef OAIFormData_f_p_case_summary_type_H
#define OAIFormData_f_p_case_summary_type_H
...
class OAIFormData_f_p_case_summary_type : public OAIEnum {
public:
    OAIFormData_f_p_case_summary_type();
    OAIFormData_f_p_case_summary_type(QString json);
    ~OAIFormData_f_p_case_summary_type() override;
    ...
    enum class eOAIFormData_f_p_case_summary_type {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ALL, 
        CONTAINS, 
        WITHIN
    };
    OAIFormData_f_p_case_summary_type::eOAIFormData_f_p_case_summary_type getValue() const;
    void setValue(const OAIFormData_f_p_case_summary_type::eOAIFormData_f_p_case_summary_type& value);
...
private:
    ...
    eOAIFormData_f_p_case_summary_type m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_case_summary_type)

#endif // OAIFormData_f_p_case_summary_type_H
