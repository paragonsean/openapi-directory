...
/*
 * OAIFormData_f_p_naics_frs_flg.h
 *
 * Case Location Extended FRS NAICS Search Flag.  Enter Y to expand NAICS search to include Federal Registry Service datasets.
 */

#ifndef OAIFormData_f_p_naics_frs_flg_H
#define OAIFormData_f_p_naics_frs_flg_H
...
class OAIFormData_f_p_naics_frs_flg : public OAIEnum {
public:
    OAIFormData_f_p_naics_frs_flg();
    OAIFormData_f_p_naics_frs_flg(QString json);
    ~OAIFormData_f_p_naics_frs_flg() override;
    ...
    enum class eOAIFormData_f_p_naics_frs_flg {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_naics_frs_flg::eOAIFormData_f_p_naics_frs_flg getValue() const;
    void setValue(const OAIFormData_f_p_naics_frs_flg::eOAIFormData_f_p_naics_frs_flg& value);
...
private:
    ...
    eOAIFormData_f_p_naics_frs_flg m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_naics_frs_flg)

#endif // OAIFormData_f_p_naics_frs_flg_H
