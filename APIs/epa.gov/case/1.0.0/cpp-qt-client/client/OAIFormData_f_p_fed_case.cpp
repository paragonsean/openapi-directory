...
#include "OAIFormData_f_p_fed_case.h"
...
OAIFormData_f_p_fed_case::OAIFormData_f_p_fed_case(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_fed_case::OAIFormData_f_p_fed_case() {
    this->initializeModel();
}

OAIFormData_f_p_fed_case::~OAIFormData_f_p_fed_case() {}

void OAIFormData_f_p_fed_case::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_fed_case::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_fed_case::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_case::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_fed_case::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_fed_case::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_fed_case::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_fed_case::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_fed_case::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_fed_case::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_fed_case::eOAIFormData_f_p_fed_case OAIFormData_f_p_fed_case::getValue() const {
    return m_value;
}

void OAIFormData_f_p_fed_case::setValue(const OAIFormData_f_p_fed_case::eOAIFormData_f_p_fed_case& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_fed_case::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_fed_case::isValid() const {
