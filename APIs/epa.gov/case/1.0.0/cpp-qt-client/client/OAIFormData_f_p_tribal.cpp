...
#include "OAIFormData_f_p_tribal.h"
...
OAIFormData_f_p_tribal::OAIFormData_f_p_tribal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_tribal::OAIFormData_f_p_tribal() {
    this->initializeModel();
}

OAIFormData_f_p_tribal::~OAIFormData_f_p_tribal() {}

void OAIFormData_f_p_tribal::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_tribal::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_tribal::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_tribal::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_tribal::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_tribal::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_tribal::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_tribal::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_tribal::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_tribal::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_tribal::eOAIFormData_f_p_tribal OAIFormData_f_p_tribal::getValue() const {
    return m_value;
}

void OAIFormData_f_p_tribal::setValue(const OAIFormData_f_p_tribal::eOAIFormData_f_p_tribal& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_tribal::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_tribal::isValid() const {
