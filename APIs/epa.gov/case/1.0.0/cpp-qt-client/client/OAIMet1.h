...
class OAIMet1 : public OAIObject {
public:
    OAIMet1();
    OAIMet1(QString json);
    ~OAIMet1() override;
    ...
    QList<OAIMet2> getResultColumns() const;
    void setResultColumns(const QList<OAIMet2> &result_columns);
...
private:
    ...
    QList<OAIMet2> m_result_columns;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMet1)
