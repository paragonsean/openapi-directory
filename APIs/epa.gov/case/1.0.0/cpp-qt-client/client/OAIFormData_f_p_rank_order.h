...
/*
 * OAIFormData_f_p_rank_order.h
 *
 * Law Status Rank Order Limiter.  Enter a single integer rank order to limit results.
 */

#ifndef OAIFormData_f_p_rank_order_H
#define OAIFormData_f_p_rank_order_H
...
class OAIFormData_f_p_rank_order : public OAIEnum {
public:
    OAIFormData_f_p_rank_order();
    OAIFormData_f_p_rank_order(QString json);
    ~OAIFormData_f_p_rank_order() override;
    ...
    enum class eOAIFormData_f_p_rank_order {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        _1, 
        _0
    };
    OAIFormData_f_p_rank_order::eOAIFormData_f_p_rank_order getValue() const;
    void setValue(const OAIFormData_f_p_rank_order::eOAIFormData_f_p_rank_order& value);
...
private:
    ...
    eOAIFormData_f_p_rank_order m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_rank_order)

#endif // OAIFormData_f_p_rank_order_H
