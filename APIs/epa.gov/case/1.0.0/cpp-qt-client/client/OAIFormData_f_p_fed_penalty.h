...
#ifndef OAIFormData_f_p_fed_penalty_H
#define OAIFormData_f_p_fed_penalty_H
...
class OAIFormData_f_p_fed_penalty : public OAIEnum {
public:
    OAIFormData_f_p_fed_penalty();
    OAIFormData_f_p_fed_penalty(QString json);
    ~OAIFormData_f_p_fed_penalty() override;
    ...
    enum class eOAIFormData_f_p_fed_penalty {
    ...
    OAIFormData_f_p_fed_penalty::eOAIFormData_f_p_fed_penalty getValue() const;
    void setValue(const OAIFormData_f_p_fed_penalty::eOAIFormData_f_p_fed_penalty& value);
...
private:
    ...
    eOAIFormData_f_p_fed_penalty m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_fed_penalty)

#endif // OAIFormData_f_p_fed_penalty_H
