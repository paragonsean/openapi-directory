...
/*
 * OAI_case_rest_services_metadata_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_case_rest_services_metadata_get_200_response_H
#define OAI_case_rest_services_metadata_get_200_response_H
...
class OAI_case_rest_services_metadata_get_200_response : public OAIObject {
public:
    OAI_case_rest_services_metadata_get_200_response();
    OAI_case_rest_services_metadata_get_200_response(QString json);
    ~OAI_case_rest_services_metadata_get_200_response() override;
    ...
    OAIMet1 getResults() const;
    void setResults(const OAIMet1 &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_case_rest_services_metadata_get_200_response)

#endif // OAI_case_rest_services_metadata_get_200_response_H
