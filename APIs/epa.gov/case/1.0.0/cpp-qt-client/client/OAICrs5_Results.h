...
#ifndef OAICrs5_Results_H
#define OAICrs5_Results_H
...
class OAICrs5_Results : public OAIObject {
public:
    OAICrs5_Results();
    OAICrs5_Results(QString json);
    ~OAICrs5_Results() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs5_Results)

#endif // OAICrs5_Results_H
