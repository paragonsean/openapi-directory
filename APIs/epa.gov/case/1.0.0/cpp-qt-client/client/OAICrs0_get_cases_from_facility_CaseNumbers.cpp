...
OAICrs0_get_cases_from_facility_CaseNumbers::OAICrs0_get_cases_from_facility_CaseNumbers(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrs0_get_cases_from_facility_CaseNumbers::OAICrs0_get_cases_from_facility_CaseNumbers() {
    this->initializeModel();
}

OAICrs0_get_cases_from_facility_CaseNumbers::~OAICrs0_get_cases_from_facility_CaseNumbers() {}

void OAICrs0_get_cases_from_facility_CaseNumbers::initializeModel() {

    m_case_numbers_isSet = false;
    m_case_numbers_isValid = false;
}

void OAICrs0_get_cases_from_facility_CaseNumbers::fromJson(QString jsonString) {
...
void OAICrs0_get_cases_from_facility_CaseNumbers::fromJsonObject(QJsonObject json) {

    m_case_numbers_isValid = ::OpenAPI::fromJsonValue(m_case_numbers, json[QString("CaseNumbers")]);
    m_case_numbers_isSet = !json[QString("CaseNumbers")].isNull() && m_case_numbers_isValid;
}

QString OAICrs0_get_cases_from_facility_CaseNumbers::asJson() const {
...
QJsonObject OAICrs0_get_cases_from_facility_CaseNumbers::asJsonObject() const {
    QJsonObject obj;
    if (m_case_numbers.size() > 0) {
        obj.insert(QString("CaseNumbers"), ::OpenAPI::toJsonValue(m_case_numbers));
    }
    return obj;
}

QList<OAICrs0_get_cases_from_facility_CaseNumber> OAICrs0_get_cases_from_facility_CaseNumbers::getCaseNumbers() const {
    return m_case_numbers;
}
void OAICrs0_get_cases_from_facility_CaseNumbers::setCaseNumbers(const QList<OAICrs0_get_cases_from_facility_CaseNumber> &case_numbers) {
    m_case_numbers = case_numbers;
    m_case_numbers_isSet = true;
}

bool OAICrs0_get_cases_from_facility_CaseNumbers::is_case_numbers_Set() const{
    return m_case_numbers_isSet;
}

bool OAICrs0_get_cases_from_facility_CaseNumbers::is_case_numbers_Valid() const{
    return m_case_numbers_isValid;
}

bool OAICrs0_get_cases_from_facility_CaseNumbers::isSet() const {
...
bool OAICrs0_get_cases_from_facility_CaseNumbers::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_case_numbers_isValid && true;
}
