...
/*
 * OAICrs0_get_facilities_from_case_RegistryIDs.h
 *
 * Registry IDs
 */

#ifndef OAICrs0_get_facilities_from_case_RegistryIDs_H
#define OAICrs0_get_facilities_from_case_RegistryIDs_H
...
namespace OpenAPI {
class OAICrs0_get_facilities_from_case_RegistryID;

class OAICrs0_get_facilities_from_case_RegistryIDs : public OAIObject {
public:
    OAICrs0_get_facilities_from_case_RegistryIDs();
    OAICrs0_get_facilities_from_case_RegistryIDs(QString json);
    ~OAICrs0_get_facilities_from_case_RegistryIDs() override;
    ...
    QList<OAICrs0_get_facilities_from_case_RegistryID> getRegistryIds() const;
    void setRegistryIds(const QList<OAICrs0_get_facilities_from_case_RegistryID> &registry_ids);
...
private:
    ...
    QList<OAICrs0_get_facilities_from_case_RegistryID> m_registry_ids;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs0_get_facilities_from_case_RegistryIDs)

#endif // OAICrs0_get_facilities_from_case_RegistryIDs_H
