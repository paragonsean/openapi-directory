...
#include "OAIFormData_f_p_rank_order.h"
...
OAIFormData_f_p_rank_order::OAIFormData_f_p_rank_order(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_rank_order::OAIFormData_f_p_rank_order() {
    this->initializeModel();
}

OAIFormData_f_p_rank_order::~OAIFormData_f_p_rank_order() {}

void OAIFormData_f_p_rank_order::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_rank_order::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_rank_order::fromJson(QString jsonString) {
    
    if ( jsonString.compare("1", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_rank_order::_1;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("0", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_rank_order::_0;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_rank_order::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_rank_order::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_rank_order::_1:
            val = "1";
            break;
        case eOAIFormData_f_p_rank_order::_0:
            val = "0";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_rank_order::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_rank_order::eOAIFormData_f_p_rank_order OAIFormData_f_p_rank_order::getValue() const {
    return m_value;
}

void OAIFormData_f_p_rank_order::setValue(const OAIFormData_f_p_rank_order::eOAIFormData_f_p_rank_order& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_rank_order::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_rank_order::isValid() const {
