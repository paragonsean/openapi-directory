...
class OAIFormData_f_p_region : public OAIEnum {
public:
    OAIFormData_f_p_region();
    OAIFormData_f_p_region(QString json);
    ~OAIFormData_f_p_region() override;
    ...
    enum class eOAIFormData_f_p_region {
    ...
    OAIFormData_f_p_region::eOAIFormData_f_p_region getValue() const;
    void setValue(const OAIFormData_f_p_region::eOAIFormData_f_p_region& value);
...
private:
    ...
    eOAIFormData_f_p_region m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_region)

#endif // OAIFormData_f_p_region_H
