...
class OAICrs1_Defendants : public OAIObject {
public:
    OAICrs1_Defendants();
    OAICrs1_Defendants(QString json);
    ~OAICrs1_Defendants() override;
    ...
    QString getDefendantName() const;
    void setDefendantName(const QString &defendant_name);
    bool is_defendant_name_Set() const;
    bool is_defendant_name_Valid() const;

    QString getNamedInComplaint() const;
    void setNamedInComplaint(const QString &named_in_complaint);
    bool is_named_in_complaint_Set() const;
    bool is_named_in_complaint_Valid() const;

    QString getNamedInSettlement() const;
    void setNamedInSettlement(const QString &named_in_settlement);
    bool is_named_in_settlement_Set() const;
    bool is_named_in_settlement_Valid() const;
...
private:
    ...
    QString m_defendant_name;
    bool m_defendant_name_isSet;
    bool m_defendant_name_isValid;

    QString m_named_in_complaint;
    bool m_named_in_complaint_isSet;
    bool m_named_in_complaint_isValid;

    QString m_named_in_settlement;
    bool m_named_in_settlement_isSet;
    bool m_named_in_settlement_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICrs1_Defendants)

#endif // OAICrs1_Defendants_H
