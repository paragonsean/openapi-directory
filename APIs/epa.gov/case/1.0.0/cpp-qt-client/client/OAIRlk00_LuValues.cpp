...
OAIRlk00_LuValues::OAIRlk00_LuValues(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRlk00_LuValues::OAIRlk00_LuValues() {
    this->initializeModel();
}

OAIRlk00_LuValues::~OAIRlk00_LuValues() {}

void OAIRlk00_LuValues::initializeModel() {
...
void OAIRlk00_LuValues::fromJson(QString jsonString) {
...
void OAIRlk00_LuValues::fromJsonObject(QJsonObject json) {
...
QString OAIRlk00_LuValues::asJson() const {
...
QJsonObject OAIRlk00_LuValues::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRlk00_LuValues::getValueCode() const {
    return m_value_code;
}
void OAIRlk00_LuValues::setValueCode(const QString &value_code) {
    m_value_code = value_code;
    m_value_code_isSet = true;
}

bool OAIRlk00_LuValues::is_value_code_Set() const{
    return m_value_code_isSet;
}

bool OAIRlk00_LuValues::is_value_code_Valid() const{
    return m_value_code_isValid;
}

QString OAIRlk00_LuValues::getValueDescription() const {
    return m_value_description;
}
void OAIRlk00_LuValues::setValueDescription(const QString &value_description) {
    m_value_description = value_description;
    m_value_description_isSet = true;
}

bool OAIRlk00_LuValues::is_value_description_Set() const{
    return m_value_description_isSet;
}

bool OAIRlk00_LuValues::is_value_description_Valid() const{
    return m_value_description_isValid;
}

bool OAIRlk00_LuValues::isSet() const {
...
bool OAIRlk00_LuValues::isValid() const {
