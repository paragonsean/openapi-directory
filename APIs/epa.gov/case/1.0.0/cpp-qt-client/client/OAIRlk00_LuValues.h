...
#ifndef OAIRlk00_LuValues_H
#define OAIRlk00_LuValues_H
...
class OAIRlk00_LuValues : public OAIObject {
public:
    OAIRlk00_LuValues();
    OAIRlk00_LuValues(QString json);
    ~OAIRlk00_LuValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRlk00_LuValues)

#endif // OAIRlk00_LuValues_H
