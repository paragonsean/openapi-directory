...
OAICrs0_get_case_info_Results::OAICrs0_get_case_info_Results(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrs0_get_case_info_Results::OAICrs0_get_case_info_Results() {
    this->initializeModel();
}

OAICrs0_get_case_info_Results::~OAICrs0_get_case_info_Results() {}

void OAICrs0_get_case_info_Results::initializeModel() {
    ...
    m_map_locations_isSet = false;
    m_map_locations_isValid = false;
...
void OAICrs0_get_case_info_Results::fromJson(QString jsonString) {
...
void OAICrs0_get_case_info_Results::fromJsonObject(QJsonObject json) {
    ...
    m_map_locations_isValid = ::OpenAPI::fromJsonValue(m_map_locations, json[QString("MapLocations")]);
    m_map_locations_isSet = !json[QString("MapLocations")].isNull() && m_map_locations_isValid;
...
QString OAICrs0_get_case_info_Results::asJson() const {
...
QJsonObject OAICrs0_get_case_info_Results::asJsonObject() const {
    QJsonObject obj;
    if (m_afr_rows_isSet) {
    ...
    if (m_map_locations_isSet) {
        obj.insert(QString("MapLocations"), ::OpenAPI::toJsonValue(m_map_locations));
    }
    if (m_message_isSet) {
...
QString OAICrs0_get_case_info_Results::getAfrRows() const {
    return m_afr_rows;
}
void OAICrs0_get_case_info_Results::setAfrRows(const QString &afr_rows) {
    m_afr_rows = afr_rows;
    m_afr_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_afr_rows_Set() const{
    return m_afr_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_afr_rows_Valid() const{
    return m_afr_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getCerclaRows() const {
    return m_cercla_rows;
}
void OAICrs0_get_case_info_Results::setCerclaRows(const QString &cercla_rows) {
    m_cercla_rows = cercla_rows;
    m_cercla_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_cercla_rows_Set() const{
    return m_cercla_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_cercla_rows_Valid() const{
    return m_cercla_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getCwaRows() const {
    return m_cwa_rows;
}
void OAICrs0_get_case_info_Results::setCwaRows(const QString &cwa_rows) {
    m_cwa_rows = cwa_rows;
    m_cwa_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_cwa_rows_Set() const{
    return m_cwa_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_cwa_rows_Valid() const{
    return m_cwa_rows_isValid;
}

QList<OAICrs0_Cases> OAICrs0_get_case_info_Results::getCases() const {
    return m_cases;
}
void OAICrs0_get_case_info_Results::setCases(const QList<OAICrs0_Cases> &cases) {
    m_cases = cases;
    m_cases_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_cases_Set() const{
    return m_cases_isSet;
}

bool OAICrs0_get_case_info_Results::is_cases_Valid() const{
    return m_cases_isValid;
}

OAICrs0_ClusterOutput OAICrs0_get_case_info_Results::getClusterOutput() const {
    return m_cluster_output;
}
void OAICrs0_get_case_info_Results::setClusterOutput(const OAICrs0_ClusterOutput &cluster_output) {
    m_cluster_output = cluster_output;
    m_cluster_output_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_cluster_output_Set() const{
    return m_cluster_output_isSet;
}

bool OAICrs0_get_case_info_Results::is_cluster_output_Valid() const{
    return m_cluster_output_isValid;
}

QString OAICrs0_get_case_info_Results::getClusterRecords() const {
    return m_cluster_records;
}
void OAICrs0_get_case_info_Results::setClusterRecords(const QString &cluster_records) {
    m_cluster_records = cluster_records;
    m_cluster_records_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_cluster_records_Set() const{
    return m_cluster_records_isSet;
}

bool OAICrs0_get_case_info_Results::is_cluster_records_Valid() const{
    return m_cluster_records_isValid;
}

QString OAICrs0_get_case_info_Results::getCriminalRows() const {
    return m_criminal_rows;
}
void OAICrs0_get_case_info_Results::setCriminalRows(const QString &criminal_rows) {
    m_criminal_rows = criminal_rows;
    m_criminal_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_criminal_rows_Set() const{
    return m_criminal_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_criminal_rows_Valid() const{
    return m_criminal_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getEpcraRows() const {
    return m_epcra_rows;
}
void OAICrs0_get_case_info_Results::setEpcraRows(const QString &epcra_rows) {
    m_epcra_rows = epcra_rows;
    m_epcra_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_epcra_rows_Set() const{
    return m_epcra_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_epcra_rows_Valid() const{
    return m_epcra_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getFifraRows() const {
    return m_fifra_rows;
}
void OAICrs0_get_case_info_Results::setFifraRows(const QString &fifra_rows) {
    m_fifra_rows = fifra_rows;
    m_fifra_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_fifra_rows_Set() const{
    return m_fifra_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_fifra_rows_Valid() const{
    return m_fifra_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getFedPenRows() const {
    return m_fed_pen_rows;
}
void OAICrs0_get_case_info_Results::setFedPenRows(const QString &fed_pen_rows) {
    m_fed_pen_rows = fed_pen_rows;
    m_fed_pen_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_fed_pen_rows_Set() const{
    return m_fed_pen_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_fed_pen_rows_Valid() const{
    return m_fed_pen_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getFederalRows() const {
    return m_federal_rows;
}
void OAICrs0_get_case_info_Results::setFederalRows(const QString &federal_rows) {
    m_federal_rows = federal_rows;
    m_federal_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_federal_rows_Set() const{
    return m_federal_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_federal_rows_Valid() const{
    return m_federal_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getJdcRows() const {
    return m_jdc_rows;
}
void OAICrs0_get_case_info_Results::setJdcRows(const QString &jdc_rows) {
    m_jdc_rows = jdc_rows;
    m_jdc_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_jdc_rows_Set() const{
    return m_jdc_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_jdc_rows_Valid() const{
    return m_jdc_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getMapLocations() const {
    return m_map_locations;
}
void OAICrs0_get_case_info_Results::setMapLocations(const QString &map_locations) {
    m_map_locations = map_locations;
    m_map_locations_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_map_locations_Set() const{
    return m_map_locations_isSet;
}

bool OAICrs0_get_case_info_Results::is_map_locations_Valid() const{
    return m_map_locations_isValid;
}

QString OAICrs0_get_case_info_Results::getMessage() const {
    return m_message;
}
void OAICrs0_get_case_info_Results::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_message_Set() const{
    return m_message_isSet;
}

bool OAICrs0_get_case_info_Results::is_message_Valid() const{
    return m_message_isValid;
}

QList<OAIQp0> OAICrs0_get_case_info_Results::getQueryParameters() const {
    return m_query_parameters;
}
void OAICrs0_get_case_info_Results::setQueryParameters(const QList<OAIQp0> &query_parameters) {
    m_query_parameters = query_parameters;
    m_query_parameters_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_query_parameters_Set() const{
    return m_query_parameters_isSet;
}

bool OAICrs0_get_case_info_Results::is_query_parameters_Valid() const{
    return m_query_parameters_isValid;
}

QString OAICrs0_get_case_info_Results::getQueryRows() const {
    return m_query_rows;
}
void OAICrs0_get_case_info_Results::setQueryRows(const QString &query_rows) {
    m_query_rows = query_rows;
    m_query_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_query_rows_Set() const{
    return m_query_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_query_rows_Valid() const{
    return m_query_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getRcraRows() const {
    return m_rcra_rows;
}
void OAICrs0_get_case_info_Results::setRcraRows(const QString &rcra_rows) {
    m_rcra_rows = rcra_rows;
    m_rcra_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_rcra_rows_Set() const{
    return m_rcra_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_rcra_rows_Valid() const{
    return m_rcra_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getSdwaRows() const {
    return m_sdwa_rows;
}
void OAICrs0_get_case_info_Results::setSdwaRows(const QString &sdwa_rows) {
    m_sdwa_rows = sdwa_rows;
    m_sdwa_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_sdwa_rows_Set() const{
    return m_sdwa_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_sdwa_rows_Valid() const{
    return m_sdwa_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getSepRows() const {
    return m_sep_rows;
}
void OAICrs0_get_case_info_Results::setSepRows(const QString &sep_rows) {
    m_sep_rows = sep_rows;
    m_sep_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_sep_rows_Set() const{
    return m_sep_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_sep_rows_Valid() const{
    return m_sep_rows_isValid;
}

QString OAICrs0_get_case_info_Results::getTscaRows() const {
    return m_tsca_rows;
}
void OAICrs0_get_case_info_Results::setTscaRows(const QString &tsca_rows) {
    m_tsca_rows = tsca_rows;
    m_tsca_rows_isSet = true;
}

bool OAICrs0_get_case_info_Results::is_tsca_rows_Set() const{
    return m_tsca_rows_isSet;
}

bool OAICrs0_get_case_info_Results::is_tsca_rows_Valid() const{
    return m_tsca_rows_isValid;
}

bool OAICrs0_get_case_info_Results::isSet() const {
...
bool OAICrs0_get_case_info_Results::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_afr_rows_isValid && m_cercla_rows_isValid && m_cwa_rows_isValid && m_criminal_rows_isValid && m_epcra_rows_isValid && m_fifra_rows_isValid && m_fed_pen_rows_isValid && m_federal_rows_isValid && m_jdc_rows_isValid && m_map_locations_isValid && m_message_isValid && m_query_parameters_isValid && m_query_rows_isValid && m_rcra_rows_isValid && m_sdwa_rows_isValid && m_sep_rows_isValid && m_tsca_rows_isValid && true;
}
