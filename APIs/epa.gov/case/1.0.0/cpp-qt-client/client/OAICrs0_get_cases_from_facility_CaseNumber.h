...
/*
 * OAICrs0_get_cases_from_facility_CaseNumber.h
 *
 * Case Number
 */

#ifndef OAICrs0_get_cases_from_facility_CaseNumber_H
#define OAICrs0_get_cases_from_facility_CaseNumber_H
...
class OAICrs0_get_cases_from_facility_CaseNumber : public OAIObject {
public:
    OAICrs0_get_cases_from_facility_CaseNumber();
    OAICrs0_get_cases_from_facility_CaseNumber(QString json);
    ~OAICrs0_get_cases_from_facility_CaseNumber() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs0_get_cases_from_facility_CaseNumber)

#endif // OAICrs0_get_cases_from_facility_CaseNumber_H
