...
/*
 * OAICrs0_get_cases_from_facility_CaseNumbers.h
 *
 * Case Numbers
 */

#ifndef OAICrs0_get_cases_from_facility_CaseNumbers_H
#define OAICrs0_get_cases_from_facility_CaseNumbers_H
...
namespace OpenAPI {
class OAICrs0_get_cases_from_facility_CaseNumber;

class OAICrs0_get_cases_from_facility_CaseNumbers : public OAIObject {
public:
    OAICrs0_get_cases_from_facility_CaseNumbers();
    OAICrs0_get_cases_from_facility_CaseNumbers(QString json);
    ~OAICrs0_get_cases_from_facility_CaseNumbers() override;
    ...
    QList<OAICrs0_get_cases_from_facility_CaseNumber> getCaseNumbers() const;
    void setCaseNumbers(const QList<OAICrs0_get_cases_from_facility_CaseNumber> &case_numbers);
    bool is_case_numbers_Set() const;
    bool is_case_numbers_Valid() const;
...
private:
    ...
    QList<OAICrs0_get_cases_from_facility_CaseNumber> m_case_numbers;
    bool m_case_numbers_isSet;
    bool m_case_numbers_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICrs0_get_cases_from_facility_CaseNumbers)

#endif // OAICrs0_get_cases_from_facility_CaseNumbers_H
