...
#ifndef OAICrs2_Results_H
#define OAICrs2_Results_H
...
namespace OpenAPI {
class OAICrs0_Cases;
class OAICrs0_MapOutput;

class OAICrs2_Results : public OAIObject {
public:
    OAICrs2_Results();
    OAICrs2_Results(QString json);
    ~OAICrs2_Results() override;
    ...
    OAICrs0_MapOutput getMapOutput() const;
    void setMapOutput(const OAICrs0_MapOutput &map_output);
...
private:
    ...
    OAICrs0_MapOutput m_map_output;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs2_Results)

#endif // OAICrs2_Results_H
