...
/*
 * OAICrs1_LawsAndSections.h
 *
 * Identifies the statute/law and sections cited in the enforcement action.
 */

#ifndef OAICrs1_LawsAndSections_H
#define OAICrs1_LawsAndSections_H
...
class OAICrs1_LawsAndSections : public OAIObject {
public:
    OAICrs1_LawsAndSections();
    OAICrs1_LawsAndSections(QString json);
    ~OAICrs1_LawsAndSections() override;
    ...
    void setLaw(const QString &law);
    bool is_law_Set() const;
    bool is_law_Valid() const;

    QString getPrograms() const;
    void setPrograms(const QString &programs);
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_LawsAndSections)

#endif // OAICrs1_LawsAndSections_H
