...
/*
 * OAI_case_rest_services_get_cases_from_facility_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_case_rest_services_get_cases_from_facility_get_200_response_H
#define OAI_case_rest_services_get_cases_from_facility_get_200_response_H

#include <QJsonObject>

#include "OAICrs0_get_cases_from_facility_Results.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICrs0_get_cases_from_facility_Results;

class OAI_case_rest_services_get_cases_from_facility_get_200_response : public OAIObject {
public:
    OAI_case_rest_services_get_cases_from_facility_get_200_response();
    OAI_case_rest_services_get_cases_from_facility_get_200_response(QString json);
    ~OAI_case_rest_services_get_cases_from_facility_get_200_response() override;
    ...
    OAICrs0_get_cases_from_facility_Results getResults() const;
    void setResults(const OAICrs0_get_cases_from_facility_Results &results);
...
private:
    ...
    OAICrs0_get_cases_from_facility_Results m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_case_rest_services_get_cases_from_facility_get_200_response)

#endif // OAI_case_rest_services_get_cases_from_facility_get_200_response_H
