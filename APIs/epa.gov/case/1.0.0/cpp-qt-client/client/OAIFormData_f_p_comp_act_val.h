...
class OAIFormData_f_p_comp_act_val : public OAIEnum {
public:
    OAIFormData_f_p_comp_act_val();
    OAIFormData_f_p_comp_act_val(QString json);
    ~OAIFormData_f_p_comp_act_val() override;
    ...
    enum class eOAIFormData_f_p_comp_act_val {
    ...
    OAIFormData_f_p_comp_act_val::eOAIFormData_f_p_comp_act_val getValue() const;
    void setValue(const OAIFormData_f_p_comp_act_val::eOAIFormData_f_p_comp_act_val& value);
...
private:
    ...
    eOAIFormData_f_p_comp_act_val m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_comp_act_val)

#endif // OAIFormData_f_p_comp_act_val_H
