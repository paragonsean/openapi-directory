...
#include "OAIFormData_f_p_oeca_core.h"
...
OAIFormData_f_p_oeca_core::OAIFormData_f_p_oeca_core(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_oeca_core::OAIFormData_f_p_oeca_core() {
    this->initializeModel();
}

OAIFormData_f_p_oeca_core::~OAIFormData_f_p_oeca_core() {}

void OAIFormData_f_p_oeca_core::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_oeca_core::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_oeca_core::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_oeca_core::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_oeca_core::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_oeca_core::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_oeca_core::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_oeca_core::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_oeca_core::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_oeca_core::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_oeca_core::eOAIFormData_f_p_oeca_core OAIFormData_f_p_oeca_core::getValue() const {
    return m_value;
}

void OAIFormData_f_p_oeca_core::setValue(const OAIFormData_f_p_oeca_core::eOAIFormData_f_p_oeca_core& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_oeca_core::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_oeca_core::isValid() const {
