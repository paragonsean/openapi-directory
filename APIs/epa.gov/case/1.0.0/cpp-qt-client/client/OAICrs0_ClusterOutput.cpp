...
OAICrs0_ClusterOutput::OAICrs0_ClusterOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrs0_ClusterOutput::OAICrs0_ClusterOutput() {
    this->initializeModel();
}

OAICrs0_ClusterOutput::~OAICrs0_ClusterOutput() {}

void OAICrs0_ClusterOutput::initializeModel() {

    m_cluster_data_isSet = false;
    m_cluster_data_isValid = false;
}

void OAICrs0_ClusterOutput::fromJson(QString jsonString) {
...
void OAICrs0_ClusterOutput::fromJsonObject(QJsonObject json) {
...
QString OAICrs0_ClusterOutput::asJson() const {
...
QJsonObject OAICrs0_ClusterOutput::asJsonObject() const {
    QJsonObject obj;
...
QList<OAICrs0_ClusterData> OAICrs0_ClusterOutput::getClusterData() const {
    return m_cluster_data;
}
void OAICrs0_ClusterOutput::setClusterData(const QList<OAICrs0_ClusterData> &cluster_data) {
    m_cluster_data = cluster_data;
    m_cluster_data_isSet = true;
}

bool OAICrs0_ClusterOutput::is_cluster_data_Set() const{
    return m_cluster_data_isSet;
}

bool OAICrs0_ClusterOutput::is_cluster_data_Valid() const{
    return m_cluster_data_isValid;
}

bool OAICrs0_ClusterOutput::isSet() const {
...
bool OAICrs0_ClusterOutput::isValid() const {
