...
/*
 * OAICrs1_ProgramLinks.h
 *
 * Crosswalk between programs and facilities (identified by FRS ID).
 */

#ifndef OAICrs1_ProgramLinks_H
#define OAICrs1_ProgramLinks_H
...
class OAICrs1_ProgramLinks : public OAIObject {
public:
    OAICrs1_ProgramLinks();
    OAICrs1_ProgramLinks(QString json);
    ~OAICrs1_ProgramLinks() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_ProgramLinks)

#endif // OAICrs1_ProgramLinks_H
