...
/*
 * OAICrs1_CaseMilestones.h
 *
 * The major milestone events tracked for the enforcement action.
 */

#ifndef OAICrs1_CaseMilestones_H
#define OAICrs1_CaseMilestones_H
...
class OAICrs1_CaseMilestones : public OAIObject {
public:
    OAICrs1_CaseMilestones();
    OAICrs1_CaseMilestones(QString json);
    ~OAICrs1_CaseMilestones() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_CaseMilestones)

#endif // OAICrs1_CaseMilestones_H
