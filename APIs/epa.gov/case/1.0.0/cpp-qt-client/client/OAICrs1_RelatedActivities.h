...
#ifndef OAICrs1_RelatedActivities_H
#define OAICrs1_RelatedActivities_H
...
class OAICrs1_RelatedActivities : public OAIObject {
public:
    OAICrs1_RelatedActivities();
    OAICrs1_RelatedActivities(QString json);
    ~OAICrs1_RelatedActivities() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_RelatedActivities)

#endif // OAICrs1_RelatedActivities_H
