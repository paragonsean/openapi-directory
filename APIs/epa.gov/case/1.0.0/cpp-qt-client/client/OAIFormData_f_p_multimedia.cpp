...
#include "OAIFormData_f_p_multimedia.h"
...
OAIFormData_f_p_multimedia::OAIFormData_f_p_multimedia(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_multimedia::OAIFormData_f_p_multimedia() {
    this->initializeModel();
}

OAIFormData_f_p_multimedia::~OAIFormData_f_p_multimedia() {}

void OAIFormData_f_p_multimedia::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_multimedia::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_multimedia::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_multimedia::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_multimedia::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_multimedia::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_multimedia::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_multimedia::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_multimedia::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_multimedia::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_multimedia::eOAIFormData_f_p_multimedia OAIFormData_f_p_multimedia::getValue() const {
    return m_value;
}

void OAIFormData_f_p_multimedia::setValue(const OAIFormData_f_p_multimedia::eOAIFormData_f_p_multimedia& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_multimedia::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_multimedia::isValid() const {
