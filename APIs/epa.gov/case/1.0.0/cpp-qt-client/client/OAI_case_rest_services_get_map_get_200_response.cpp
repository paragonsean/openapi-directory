...
OAI_case_rest_services_get_map_get_200_response::OAI_case_rest_services_get_map_get_200_response(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_case_rest_services_get_map_get_200_response::OAI_case_rest_services_get_map_get_200_response() {
    this->initializeModel();
}

OAI_case_rest_services_get_map_get_200_response::~OAI_case_rest_services_get_map_get_200_response() {}

void OAI_case_rest_services_get_map_get_200_response::initializeModel() {

    m_map_output_isSet = false;
    m_map_output_isValid = false;
}

void OAI_case_rest_services_get_map_get_200_response::fromJson(QString jsonString) {
...
void OAI_case_rest_services_get_map_get_200_response::fromJsonObject(QJsonObject json) {
...
QString OAI_case_rest_services_get_map_get_200_response::asJson() const {
...
QJsonObject OAI_case_rest_services_get_map_get_200_response::asJsonObject() const {
    QJsonObject obj;
...
OAICrs0_MapOutput OAI_case_rest_services_get_map_get_200_response::getMapOutput() const {
    return m_map_output;
}
void OAI_case_rest_services_get_map_get_200_response::setMapOutput(const OAICrs0_MapOutput &map_output) {
    m_map_output = map_output;
    m_map_output_isSet = true;
}

bool OAI_case_rest_services_get_map_get_200_response::is_map_output_Set() const{
    return m_map_output_isSet;
}

bool OAI_case_rest_services_get_map_get_200_response::is_map_output_Valid() const{
    return m_map_output_isValid;
}

bool OAI_case_rest_services_get_map_get_200_response::isSet() const {
...
bool OAI_case_rest_services_get_map_get_200_response::isValid() const {
