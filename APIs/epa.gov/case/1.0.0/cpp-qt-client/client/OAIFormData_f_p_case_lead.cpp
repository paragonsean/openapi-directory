...
#include "OAIFormData_f_p_case_lead.h"
...
OAIFormData_f_p_case_lead::OAIFormData_f_p_case_lead(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_case_lead::OAIFormData_f_p_case_lead() {
    this->initializeModel();
}

OAIFormData_f_p_case_lead::~OAIFormData_f_p_case_lead() {}

void OAIFormData_f_p_case_lead::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_case_lead::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_case_lead::fromJson(QString jsonString) {
    
    if ( jsonString.compare("E", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_case_lead::E;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("S", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_case_lead::S;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_case_lead::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_case_lead::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_case_lead::E:
            val = "E";
            break;
        case eOAIFormData_f_p_case_lead::S:
            val = "S";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_case_lead::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_case_lead::eOAIFormData_f_p_case_lead OAIFormData_f_p_case_lead::getValue() const {
    return m_value;
}

void OAIFormData_f_p_case_lead::setValue(const OAIFormData_f_p_case_lead::eOAIFormData_f_p_case_lead& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_case_lead::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_case_lead::isValid() const {
