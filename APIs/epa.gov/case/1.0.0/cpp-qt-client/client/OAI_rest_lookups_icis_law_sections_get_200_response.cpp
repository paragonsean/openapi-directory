...
OAIRlk51_Results OAI_rest_lookups_icis_law_sections_get_200_response::getResults() const {
    return m_results;
}
void OAI_rest_lookups_icis_law_sections_get_200_response::setResults(const OAIRlk51_Results &results) {
    m_results = results;
