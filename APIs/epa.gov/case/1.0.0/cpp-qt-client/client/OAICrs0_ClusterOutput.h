...
/*
 * OAICrs0_ClusterOutput.h
 *
 * Cluster Ouput Complex Object Array
 */

#ifndef OAICrs0_ClusterOutput_H
#define OAICrs0_ClusterOutput_H
...
namespace OpenAPI {
class OAICrs0_ClusterData;

class OAICrs0_ClusterOutput : public OAIObject {
public:
    OAICrs0_ClusterOutput();
    OAICrs0_ClusterOutput(QString json);
    ~OAICrs0_ClusterOutput() override;
    ...
    QList<OAICrs0_ClusterData> getClusterData() const;
    void setClusterData(const QList<OAICrs0_ClusterData> &cluster_data);
...
private:
    ...
    QList<OAICrs0_ClusterData> m_cluster_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs0_ClusterOutput)

#endif // OAICrs0_ClusterOutput_H
