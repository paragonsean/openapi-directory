...
/*
 * OAIFormData_f_p_fed_case.h
 *
 * Federal Facility Involvement Flag.  Enter a Y or N to include or exclude cases involving federal facilities.
 */

#ifndef OAIFormData_f_p_fed_case_H
#define OAIFormData_f_p_fed_case_H
...
class OAIFormData_f_p_fed_case : public OAIEnum {
public:
    OAIFormData_f_p_fed_case();
    OAIFormData_f_p_fed_case(QString json);
    ~OAIFormData_f_p_fed_case() override;
    ...
    enum class eOAIFormData_f_p_fed_case {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_fed_case::eOAIFormData_f_p_fed_case getValue() const;
    void setValue(const OAIFormData_f_p_fed_case::eOAIFormData_f_p_fed_case& value);
...
private:
    ...
    eOAIFormData_f_p_fed_case m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_fed_case)

#endif // OAIFormData_f_p_fed_case_H
