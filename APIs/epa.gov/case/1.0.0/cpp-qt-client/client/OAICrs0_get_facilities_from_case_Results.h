...
/*
 * OAICrs0_get_facilities_from_case_Results.h
 *
 * Results
 */

#ifndef OAICrs0_get_facilities_from_case_Results_H
#define OAICrs0_get_facilities_from_case_Results_H
...
namespace OpenAPI {
class OAICrs0_get_facilities_from_case_RegistryIDs;

class OAICrs0_get_facilities_from_case_Results : public OAIObject {
public:
    OAICrs0_get_facilities_from_case_Results();
    OAICrs0_get_facilities_from_case_Results(QString json);
    ~OAICrs0_get_facilities_from_case_Results() override;
    ...
    OAICrs0_get_facilities_from_case_RegistryIDs getResults() const;
    void setResults(const OAICrs0_get_facilities_from_case_RegistryIDs &results);
...
private:
    ...
    OAICrs0_get_facilities_from_case_RegistryIDs m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs0_get_facilities_from_case_Results)

#endif // OAICrs0_get_facilities_from_case_Results_H
