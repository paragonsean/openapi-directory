...
/*
 * OAI_case_rest_services_get_facilities_from_case_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_case_rest_services_get_facilities_from_case_get_200_response_H
#define OAI_case_rest_services_get_facilities_from_case_get_200_response_H
...
namespace OpenAPI {
class OAICrs0_get_facilities_from_case_Results;

class OAI_case_rest_services_get_facilities_from_case_get_200_response : public OAIObject {
public:
    OAI_case_rest_services_get_facilities_from_case_get_200_response();
    OAI_case_rest_services_get_facilities_from_case_get_200_response(QString json);
    ~OAI_case_rest_services_get_facilities_from_case_get_200_response() override;
    ...
    OAICrs0_get_facilities_from_case_Results getResults() const;
    void setResults(const OAICrs0_get_facilities_from_case_Results &results);
...
private:
    ...
    OAICrs0_get_facilities_from_case_Results m_results;
...
Q_DECLARE_METATYPE(OpenAPI::OAI_case_rest_services_get_facilities_from_case_get_200_response)

#endif // OAI_case_rest_services_get_facilities_from_case_get_200_response_H
