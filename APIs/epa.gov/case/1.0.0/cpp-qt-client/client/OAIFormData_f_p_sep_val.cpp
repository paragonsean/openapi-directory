...
#include "OAIFormData_f_p_sep_val.h"
...
OAIFormData_f_p_sep_val::OAIFormData_f_p_sep_val(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_sep_val::OAIFormData_f_p_sep_val() {
    this->initializeModel();
}

OAIFormData_f_p_sep_val::~OAIFormData_f_p_sep_val() {}

void OAIFormData_f_p_sep_val::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_sep_val::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_sep_val::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ANY", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::ANY;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LE10000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::LE10000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT10000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::GT10000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT50000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::GT50000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT100000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::GT100000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT500000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::GT500000;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("GT1000000", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sep_val::GT1000000;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_sep_val::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_sep_val::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_sep_val::ANY:
            val = "ANY";
            break;
        case eOAIFormData_f_p_sep_val::LE10000:
            val = "LE10000";
            break;
        case eOAIFormData_f_p_sep_val::GT10000:
            val = "GT10000";
            break;
        case eOAIFormData_f_p_sep_val::GT50000:
            val = "GT50000";
            break;
        case eOAIFormData_f_p_sep_val::GT100000:
            val = "GT100000";
            break;
        case eOAIFormData_f_p_sep_val::GT500000:
            val = "GT500000";
            break;
        case eOAIFormData_f_p_sep_val::GT1000000:
            val = "GT1000000";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_sep_val::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_sep_val::eOAIFormData_f_p_sep_val OAIFormData_f_p_sep_val::getValue() const {
    return m_value;
}

void OAIFormData_f_p_sep_val::setValue(const OAIFormData_f_p_sep_val::eOAIFormData_f_p_sep_val& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_sep_val::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_sep_val::isValid() const {
