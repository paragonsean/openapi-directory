...
#ifndef OAICrs1_ComplyingActions_H
#define OAICrs1_ComplyingActions_H
...
class OAICrs1_ComplyingActions : public OAIObject {
public:
    OAICrs1_ComplyingActions();
    OAICrs1_ComplyingActions(QString json);
    ~OAICrs1_ComplyingActions() override;
    ...
    QString getComplyingActionCategory() const;
    void setComplyingActionCategory(const QString &complying_action_category);
    bool is_complying_action_category_Set() const;
    bool is_complying_action_category_Valid() const;

    QString getComplyingActionDescription() const;
    void setComplyingActionDescription(const QString &complying_action_description);
    bool is_complying_action_description_Set() const;
    bool is_complying_action_description_Valid() const;
    ...
    QString getComplyingActionType() const;
    void setComplyingActionType(const QString &complying_action_type);
    bool is_complying_action_type_Set() const;
    bool is_complying_action_type_Valid() const;
...
private:
    ...
    QString m_complying_action_category;
    bool m_complying_action_category_isSet;
    bool m_complying_action_category_isValid;

    QString m_complying_action_description;
    bool m_complying_action_description_isSet;
    bool m_complying_action_description_isValid;

    QString m_complying_action_id;
    bool m_complying_action_id_isSet;
    bool m_complying_action_id_isValid;

    QString m_complying_action_type;
    bool m_complying_action_type_isSet;
    bool m_complying_action_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICrs1_ComplyingActions)

#endif // OAICrs1_ComplyingActions_H
