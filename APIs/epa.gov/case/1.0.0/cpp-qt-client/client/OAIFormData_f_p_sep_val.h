...
#ifndef OAIFormData_f_p_sep_val_H
#define OAIFormData_f_p_sep_val_H
...
class OAIFormData_f_p_sep_val : public OAIEnum {
public:
    OAIFormData_f_p_sep_val();
    OAIFormData_f_p_sep_val(QString json);
    ~OAIFormData_f_p_sep_val() override;
    ...
    enum class eOAIFormData_f_p_sep_val {
    ...
    OAIFormData_f_p_sep_val::eOAIFormData_f_p_sep_val getValue() const;
    void setValue(const OAIFormData_f_p_sep_val::eOAIFormData_f_p_sep_val& value);
...
private:
    ...
    eOAIFormData_f_p_sep_val m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_sep_val)

#endif // OAIFormData_f_p_sep_val_H
