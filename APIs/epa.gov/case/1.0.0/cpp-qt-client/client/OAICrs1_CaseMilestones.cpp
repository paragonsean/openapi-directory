...
OAICrs1_CaseMilestones::OAICrs1_CaseMilestones(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICrs1_CaseMilestones::OAICrs1_CaseMilestones() {
    this->initializeModel();
}

OAICrs1_CaseMilestones::~OAICrs1_CaseMilestones() {}

void OAICrs1_CaseMilestones::initializeModel() {
...
void OAICrs1_CaseMilestones::fromJson(QString jsonString) {
...
void OAICrs1_CaseMilestones::fromJsonObject(QJsonObject json) {
...
QString OAICrs1_CaseMilestones::asJson() const {
...
QJsonObject OAICrs1_CaseMilestones::asJsonObject() const {
    QJsonObject obj;
...
QString OAICrs1_CaseMilestones::getActualDate() const {
    return m_actual_date;
}
void OAICrs1_CaseMilestones::setActualDate(const QString &actual_date) {
    m_actual_date = actual_date;
    m_actual_date_isSet = true;
}

bool OAICrs1_CaseMilestones::is_actual_date_Set() const{
    return m_actual_date_isSet;
}

bool OAICrs1_CaseMilestones::is_actual_date_Valid() const{
    return m_actual_date_isValid;
}

QString OAICrs1_CaseMilestones::getEvent() const {
    return m_event;
}
void OAICrs1_CaseMilestones::setEvent(const QString &event) {
    m_event = event;
    m_event_isSet = true;
}

bool OAICrs1_CaseMilestones::is_event_Set() const{
    return m_event_isSet;
}

bool OAICrs1_CaseMilestones::is_event_Valid() const{
    return m_event_isValid;
}

bool OAICrs1_CaseMilestones::isSet() const {
...
bool OAICrs1_CaseMilestones::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_actual_date_isValid && m_event_isValid && true;
}
