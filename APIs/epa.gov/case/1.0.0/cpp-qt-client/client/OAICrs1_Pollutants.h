...
class OAICrs1_Pollutants : public OAIObject {
public:
    OAICrs1_Pollutants();
    OAICrs1_Pollutants(QString json);
    ~OAICrs1_Pollutants() override;
    ...
    QString getChemicalAbstractNumber() const;
    void setChemicalAbstractNumber(const QString &chemical_abstract_number);
    bool is_chemical_abstract_number_Set() const;
    bool is_chemical_abstract_number_Valid() const;

    QString getPollutantName() const;
    void setPollutantName(const QString &pollutant_name);
    bool is_pollutant_name_Set() const;
    bool is_pollutant_name_Valid() const;
...
private:
    ...
    QString m_chemical_abstract_number;
    bool m_chemical_abstract_number_isSet;
    bool m_chemical_abstract_number_isValid;

    QString m_pollutant_name;
    bool m_pollutant_name_isSet;
    bool m_pollutant_name_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICrs1_Pollutants)

#endif // OAICrs1_Pollutants_H
