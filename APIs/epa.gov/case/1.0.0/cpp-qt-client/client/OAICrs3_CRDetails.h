...
#ifndef OAICrs3_CRDetails_H
#define OAICrs3_CRDetails_H
...
class OAICrs3_CRDetails : public OAIObject {
public:
    OAICrs3_CRDetails();
    OAICrs3_CRDetails(QString json);
    ~OAICrs3_CRDetails() override;
    ...
    QString getDetailCitations() const;
    void setDetailCitations(const QString &detail_citations);
    bool is_detail_citations_Set() const;
    bool is_detail_citations_Valid() const;

    QString getDetailDate() const;
    void setDetailDate(const QString &detail_date);
    bool is_detail_date_Set() const;
    bool is_detail_date_Valid() const;

    QString getDetailDesc() const;
    void setDetailDesc(const QString &detail_desc);
    bool is_detail_desc_Set() const;
    bool is_detail_desc_Valid() const;
...
private:
    ...
    QString m_detail_citations;
    bool m_detail_citations_isSet;
    bool m_detail_citations_isValid;

    QString m_detail_date;
    bool m_detail_date_isSet;
    bool m_detail_date_isValid;

    QString m_detail_desc;
    bool m_detail_desc_isSet;
    bool m_detail_desc_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICrs3_CRDetails)

#endif // OAICrs3_CRDetails_H
