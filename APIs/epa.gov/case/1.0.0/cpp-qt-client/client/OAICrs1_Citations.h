...
#ifndef OAICrs1_Citations_H
#define OAICrs1_Citations_H
...
class OAICrs1_Citations : public OAIObject {
public:
    OAICrs1_Citations();
    OAICrs1_Citations(QString json);
    ~OAICrs1_Citations() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_Citations)

#endif // OAICrs1_Citations_H
