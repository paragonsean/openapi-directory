...
#include "OAIFormData_f_p_region.h"
...
OAIFormData_f_p_region::OAIFormData_f_p_region(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_region::OAIFormData_f_p_region() {
    this->initializeModel();
}

OAIFormData_f_p_region::~OAIFormData_f_p_region() {}

void OAIFormData_f_p_region::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_region::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_region::fromJson(QString jsonString) {
    
    if ( jsonString.compare("01", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_01;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("02", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_02;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("03", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_03;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("04", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_04;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("05", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_05;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("06", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_06;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("07", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_07;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("08", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_08;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("09", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_09;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("10", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_region::_10;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_region::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_region::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_region::_01:
            val = "01";
            break;
        case eOAIFormData_f_p_region::_02:
            val = "02";
            break;
        case eOAIFormData_f_p_region::_03:
            val = "03";
            break;
        case eOAIFormData_f_p_region::_04:
            val = "04";
            break;
        case eOAIFormData_f_p_region::_05:
            val = "05";
            break;
        case eOAIFormData_f_p_region::_06:
            val = "06";
            break;
        case eOAIFormData_f_p_region::_07:
            val = "07";
            break;
        case eOAIFormData_f_p_region::_08:
            val = "08";
            break;
        case eOAIFormData_f_p_region::_09:
            val = "09";
            break;
        case eOAIFormData_f_p_region::_10:
            val = "10";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_region::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_region::eOAIFormData_f_p_region OAIFormData_f_p_region::getValue() const {
    return m_value;
}

void OAIFormData_f_p_region::setValue(const OAIFormData_f_p_region::eOAIFormData_f_p_region& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_region::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_region::isValid() const {
