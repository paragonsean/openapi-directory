...
#ifndef OAIRlk51_Results_H
#define OAIRlk51_Results_H
...
namespace OpenAPI {
class OAIRlk00_LuValues;

class OAIRlk51_Results : public OAIObject {
public:
    OAIRlk51_Results();
    OAIRlk51_Results(QString json);
    ~OAIRlk51_Results() override;
    ...
    QList<OAIRlk00_LuValues> getLuValues() const;
    void setLuValues(const QList<OAIRlk00_LuValues> &lu_values);
...
private:
    ...
    QList<OAIRlk00_LuValues> m_lu_values;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRlk51_Results)

#endif // OAIRlk51_Results_H
