...
class OAIFormData_f_p_tribal : public OAIEnum {
public:
    OAIFormData_f_p_tribal();
    OAIFormData_f_p_tribal(QString json);
    ~OAIFormData_f_p_tribal() override;
    ...
    enum class eOAIFormData_f_p_tribal {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_tribal::eOAIFormData_f_p_tribal getValue() const;
    void setValue(const OAIFormData_f_p_tribal::eOAIFormData_f_p_tribal& value);
...
private:
    ...
    eOAIFormData_f_p_tribal m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_tribal)

#endif // OAIFormData_f_p_tribal_H
