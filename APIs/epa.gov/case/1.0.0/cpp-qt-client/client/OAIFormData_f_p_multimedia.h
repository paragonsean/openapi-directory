...
/*
 * OAIFormData_f_p_multimedia.h
 *
 * Enforcement Multimedia Case Flag.  Enter Y or N to include or exclude multimedia cases.
 */

#ifndef OAIFormData_f_p_multimedia_H
#define OAIFormData_f_p_multimedia_H
...
class OAIFormData_f_p_multimedia : public OAIEnum {
public:
    OAIFormData_f_p_multimedia();
    OAIFormData_f_p_multimedia(QString json);
    ~OAIFormData_f_p_multimedia() override;
    ...
    enum class eOAIFormData_f_p_multimedia {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_multimedia::eOAIFormData_f_p_multimedia getValue() const;
    void setValue(const OAIFormData_f_p_multimedia::eOAIFormData_f_p_multimedia& value);
...
private:
    ...
    eOAIFormData_f_p_multimedia m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_multimedia)

#endif // OAIFormData_f_p_multimedia_H
