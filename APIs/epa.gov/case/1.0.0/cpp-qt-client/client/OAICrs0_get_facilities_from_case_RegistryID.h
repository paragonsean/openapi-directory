...
/*
 * OAICrs0_get_facilities_from_case_RegistryID.h
 *
 * Registry ID
 */

#ifndef OAICrs0_get_facilities_from_case_RegistryID_H
#define OAICrs0_get_facilities_from_case_RegistryID_H
...
class OAICrs0_get_facilities_from_case_RegistryID : public OAIObject {
public:
    OAICrs0_get_facilities_from_case_RegistryID();
    OAICrs0_get_facilities_from_case_RegistryID(QString json);
    ~OAICrs0_get_facilities_from_case_RegistryID() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs0_get_facilities_from_case_RegistryID)

#endif // OAICrs0_get_facilities_from_case_RegistryID_H
