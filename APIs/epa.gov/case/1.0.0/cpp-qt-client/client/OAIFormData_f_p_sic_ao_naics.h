...
class OAIFormData_f_p_sic_ao_naics : public OAIEnum {
public:
    OAIFormData_f_p_sic_ao_naics();
    OAIFormData_f_p_sic_ao_naics(QString json);
    ~OAIFormData_f_p_sic_ao_naics() override;
    ...
    enum class eOAIFormData_f_p_sic_ao_naics {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        AND, 
        OR
    };
    OAIFormData_f_p_sic_ao_naics::eOAIFormData_f_p_sic_ao_naics getValue() const;
    void setValue(const OAIFormData_f_p_sic_ao_naics::eOAIFormData_f_p_sic_ao_naics& value);
...
private:
    ...
    eOAIFormData_f_p_sic_ao_naics m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_sic_ao_naics)

#endif // OAIFormData_f_p_sic_ao_naics_H
