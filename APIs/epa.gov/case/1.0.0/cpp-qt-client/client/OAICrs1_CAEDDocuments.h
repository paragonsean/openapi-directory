...
/*
 * OAICrs1_CAEDDocuments.h
 *
 * Case Related Uploaded Documents
 */

#ifndef OAICrs1_CAEDDocuments_H
#define OAICrs1_CAEDDocuments_H
...
class OAICrs1_CAEDDocuments : public OAIObject {
public:
    OAICrs1_CAEDDocuments();
    OAICrs1_CAEDDocuments(QString json);
    ~OAICrs1_CAEDDocuments() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICrs1_CAEDDocuments)

#endif // OAICrs1_CAEDDocuments_H
