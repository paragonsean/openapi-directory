...
/*
 * OAIFormData_f_p_sic_primary_flg.h
 *
 * Case Location Primary SIC Flag.  Enter Y to limit SIC search results to primary SIC codes only.
 */

#ifndef OAIFormData_f_p_sic_primary_flg_H
#define OAIFormData_f_p_sic_primary_flg_H
...
class OAIFormData_f_p_sic_primary_flg : public OAIEnum {
public:
    OAIFormData_f_p_sic_primary_flg();
    OAIFormData_f_p_sic_primary_flg(QString json);
    ~OAIFormData_f_p_sic_primary_flg() override;
    ...
    enum class eOAIFormData_f_p_sic_primary_flg {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_sic_primary_flg::eOAIFormData_f_p_sic_primary_flg getValue() const;
    void setValue(const OAIFormData_f_p_sic_primary_flg::eOAIFormData_f_p_sic_primary_flg& value);
...
private:
    ...
    eOAIFormData_f_p_sic_primary_flg m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_sic_primary_flg)

#endif // OAIFormData_f_p_sic_primary_flg_H
