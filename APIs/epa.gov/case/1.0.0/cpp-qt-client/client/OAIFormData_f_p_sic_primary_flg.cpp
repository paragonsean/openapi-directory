...
#include "OAIFormData_f_p_sic_primary_flg.h"
...
OAIFormData_f_p_sic_primary_flg::OAIFormData_f_p_sic_primary_flg(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFormData_f_p_sic_primary_flg::OAIFormData_f_p_sic_primary_flg() {
    this->initializeModel();
}

OAIFormData_f_p_sic_primary_flg::~OAIFormData_f_p_sic_primary_flg() {}

void OAIFormData_f_p_sic_primary_flg::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIFormData_f_p_sic_primary_flg::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIFormData_f_p_sic_primary_flg::fromJson(QString jsonString) {
    
    if ( jsonString.compare("Y", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sic_primary_flg::Y;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("N", Qt::CaseInsensitive) == 0) {
        m_value = eOAIFormData_f_p_sic_primary_flg::N;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIFormData_f_p_sic_primary_flg::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIFormData_f_p_sic_primary_flg::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIFormData_f_p_sic_primary_flg::Y:
            val = "Y";
            break;
        case eOAIFormData_f_p_sic_primary_flg::N:
            val = "N";
            break;
        default:
            break;
...
QJsonValue OAIFormData_f_p_sic_primary_flg::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIFormData_f_p_sic_primary_flg::eOAIFormData_f_p_sic_primary_flg OAIFormData_f_p_sic_primary_flg::getValue() const {
    return m_value;
}

void OAIFormData_f_p_sic_primary_flg::setValue(const OAIFormData_f_p_sic_primary_flg::eOAIFormData_f_p_sic_primary_flg& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIFormData_f_p_sic_primary_flg::isSet() const {
    
    return m_value_isSet;
}

bool OAIFormData_f_p_sic_primary_flg::isValid() const {
