...
/**
 * Case Lead Limiter.  Enter E or S to limit results. - E &#x3D; EPA is the case lead. - S &#x3D; The state is the case lead.
 */
@JsonAdapter(FormDataFPCaseLead.Adapter.class)
public enum FormDataFPCaseLead {
  ...
  FormDataFPCaseLead(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPCaseLead fromValue(String value) {
    for (FormDataFPCaseLead b : FormDataFPCaseLead.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPCaseLead> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPCaseLead enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPCaseLead read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPCaseLead.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPCaseLead.fromValue(value);
  }
}
