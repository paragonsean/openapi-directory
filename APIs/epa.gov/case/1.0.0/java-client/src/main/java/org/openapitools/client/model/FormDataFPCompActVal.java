 ...
 */
@JsonAdapter(FormDataFPCompActVal.Adapter.class)
public enum FormDataFPCompActVal {
  ...
  FormDataFPCompActVal(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPCompActVal fromValue(String value) {
    for (FormDataFPCompActVal b : FormDataFPCompActVal.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPCompActVal> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPCompActVal enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPCompActVal read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPCompActVal.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPCompActVal.fromValue(value);
  }
}
