...
/**
 * Case Location Extended FRS SIC Search Flag.  Enter Y to expand SIC search to include Federal Registry Service datasets.
 */
@JsonAdapter(FormDataFPSicFrsFlg.Adapter.class)
public enum FormDataFPSicFrsFlg {
  ...
  FormDataFPSicFrsFlg(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPSicFrsFlg fromValue(String value) {
    for (FormDataFPSicFrsFlg b : FormDataFPSicFrsFlg.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSicFrsFlg> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSicFrsFlg enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSicFrsFlg read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSicFrsFlg.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSicFrsFlg.fromValue(value);
  }
}
