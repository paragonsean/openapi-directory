...
/**
 * Case Location Primary NAICS Flag.  Enter Y to limit NAICS search results to primary NAICS codes only.
 */
@JsonAdapter(FormDataFPNaicsPrimaryFlg.Adapter.class)
public enum FormDataFPNaicsPrimaryFlg {
  ...
  FormDataFPNaicsPrimaryFlg(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPNaicsPrimaryFlg fromValue(String value) {
    for (FormDataFPNaicsPrimaryFlg b : FormDataFPNaicsPrimaryFlg.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPNaicsPrimaryFlg> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPNaicsPrimaryFlg enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPNaicsPrimaryFlg read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPNaicsPrimaryFlg.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPNaicsPrimaryFlg.fromValue(value);
  }
}
