...
/**
 * Civil/Criminal Case Limiter.  Provide a keyword to limit results. - ANY &#x3D; return both civil and criminal cases. - CI &#x3D; return only civil cases. - CR &#x3D; return only criminal cases.
 */
@JsonAdapter(FormDataFPCivilCriminalIndicator.Adapter.class)
public enum FormDataFPCivilCriminalIndicator {
  ...
  FormDataFPCivilCriminalIndicator(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPCivilCriminalIndicator fromValue(String value) {
    for (FormDataFPCivilCriminalIndicator b : FormDataFPCivilCriminalIndicator.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPCivilCriminalIndicator> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPCivilCriminalIndicator enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPCivilCriminalIndicator read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPCivilCriminalIndicator.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPCivilCriminalIndicator.fromValue(value);
  }
}
