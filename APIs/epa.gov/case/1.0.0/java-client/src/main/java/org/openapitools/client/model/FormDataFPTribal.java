...
/**
 * Case Location Tribal Land Flag.  Enter Y or N to include or disallow cases on tribal land.
 */
@JsonAdapter(FormDataFPTribal.Adapter.class)
public enum FormDataFPTribal {
  ...
  public static FormDataFPTribal fromValue(String value) {
    for (FormDataFPTribal b : FormDataFPTribal.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPTribal> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPTribal enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPTribal read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPTribal.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPTribal.fromValue(value);
  }
}
