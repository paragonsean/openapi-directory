...
public class Crs1Citations {
  ...
  public Crs1Citations() {
  }

  public Crs1Citations programs(String programs) {
  ...
  public Crs1Citations sections(String sections) {
  ...
  public Crs1Citations title(String title) {
    this.title = title;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Crs1Citations crs1Citations = (Crs1Citations) o;
    return Objects.equals(this.programs, crs1Citations.programs) &&
        Objects.equals(this.sections, crs1Citations.sections) &&
        Objects.equals(this.title, crs1Citations.title);
  }

  @Override
  public int hashCode() {
    return Objects.hash(programs, sections, title);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Crs1Citations {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Crs1Citations
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Crs1Citations.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Crs1Citations is not found in the empty JSON string", Crs1Citations.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Crs1Citations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Crs1Citations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Crs1Citations.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Crs1Citations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Crs1Citations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Crs1Citations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Crs1Citations.class));

       return (TypeAdapter<T>) new TypeAdapter<Crs1Citations>() {
           @Override
           public void write(JsonWriter out, Crs1Citations value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Crs1Citations read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Crs1Citations given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Crs1Citations
   * @throws IOException if the JSON string is invalid with respect to Crs1Citations
   */
  public static Crs1Citations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Crs1Citations.class);
  }

  /**
   * Convert an instance of Crs1Citations to an JSON string
   *
   * @return JSON string
   */
