 ...
 */
@JsonAdapter(FormDataFPFedCase.Adapter.class)
public enum FormDataFPFedCase {
  ...
  FormDataFPFedCase(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPFedCase fromValue(String value) {
    for (FormDataFPFedCase b : FormDataFPFedCase.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPFedCase> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPFedCase enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPFedCase read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPFedCase.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPFedCase.fromValue(value);
  }
}
