...
/**
 * Law Status Rank Order Limiter.  Enter a single integer rank order to limit results.
 */
@JsonAdapter(FormDataFPRankOrder.Adapter.class)
public enum FormDataFPRankOrder {
  ...
  FormDataFPRankOrder(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPRankOrder fromValue(String value) {
    for (FormDataFPRankOrder b : FormDataFPRankOrder.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPRankOrder> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPRankOrder enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPRankOrder read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPRankOrder.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPRankOrder.fromValue(value);
  }
}
