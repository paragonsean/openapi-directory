 ...
 */
@JsonAdapter(FormDataFPOecaCore.Adapter.class)
public enum FormDataFPOecaCore {
  ...
  FormDataFPOecaCore(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPOecaCore fromValue(String value) {
    for (FormDataFPOecaCore b : FormDataFPOecaCore.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPOecaCore> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPOecaCore enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPOecaCore read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPOecaCore.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPOecaCore.fromValue(value);
  }
}
