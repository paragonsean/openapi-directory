...
public class Crs0GetFacilitiesFromCaseRegistryID {
  public static final String SERIALIZED_NAME_REGISTRY_I_D = "RegistryID";
  @SerializedName(SERIALIZED_NAME_REGISTRY_I_D)
  private String registryID;

  public Crs0GetFacilitiesFromCaseRegistryID() {
  }

  public Crs0GetFacilitiesFromCaseRegistryID registryID(String registryID) {
  ...
  public boolean equals(Object o) {
    ...
    Crs0GetFacilitiesFromCaseRegistryID crs0GetFacilitiesFromCaseRegistryID = (Crs0GetFacilitiesFromCaseRegistryID) o;
    return Objects.equals(this.registryID, crs0GetFacilitiesFromCaseRegistryID.registryID);
  }
  ...
  public String toString() {
    ...
    sb.append("class Crs0GetFacilitiesFromCaseRegistryID {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Crs0GetFacilitiesFromCaseRegistryID
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Crs0GetFacilitiesFromCaseRegistryID.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Crs0GetFacilitiesFromCaseRegistryID is not found in the empty JSON string", Crs0GetFacilitiesFromCaseRegistryID.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Crs0GetFacilitiesFromCaseRegistryID.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Crs0GetFacilitiesFromCaseRegistryID` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Crs0GetFacilitiesFromCaseRegistryID.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Crs0GetFacilitiesFromCaseRegistryID.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Crs0GetFacilitiesFromCaseRegistryID' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Crs0GetFacilitiesFromCaseRegistryID> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Crs0GetFacilitiesFromCaseRegistryID.class));

       return (TypeAdapter<T>) new TypeAdapter<Crs0GetFacilitiesFromCaseRegistryID>() {
           @Override
           public void write(JsonWriter out, Crs0GetFacilitiesFromCaseRegistryID value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Crs0GetFacilitiesFromCaseRegistryID read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Crs0GetFacilitiesFromCaseRegistryID given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Crs0GetFacilitiesFromCaseRegistryID
   * @throws IOException if the JSON string is invalid with respect to Crs0GetFacilitiesFromCaseRegistryID
   */
  public static Crs0GetFacilitiesFromCaseRegistryID fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Crs0GetFacilitiesFromCaseRegistryID.class);
  }

  /**
   * Convert an instance of Crs0GetFacilitiesFromCaseRegistryID to an JSON string
   *
   * @return JSON string
   */
