 ...
 */
@JsonAdapter(FormDataFPCaseSummaryType.Adapter.class)
public enum FormDataFPCaseSummaryType {
  ...
  FormDataFPCaseSummaryType(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPCaseSummaryType fromValue(String value) {
    for (FormDataFPCaseSummaryType b : FormDataFPCaseSummaryType.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPCaseSummaryType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPCaseSummaryType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPCaseSummaryType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPCaseSummaryType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPCaseSummaryType.fromValue(value);
  }
}
