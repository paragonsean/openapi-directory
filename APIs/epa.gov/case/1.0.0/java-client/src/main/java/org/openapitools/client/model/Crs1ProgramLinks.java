...
public class Crs1ProgramLinks {
  ...
  public Crs1ProgramLinks() {
  }

  public Crs1ProgramLinks frSNumber(String frSNumber) {
  ...
  public Crs1ProgramLinks program(String program) {
  ...
  public Crs1ProgramLinks programID(String programID) {
  ...
  public boolean equals(Object o) {
    ...
    Crs1ProgramLinks crs1ProgramLinks = (Crs1ProgramLinks) o;
    return Objects.equals(this.frSNumber, crs1ProgramLinks.frSNumber) &&
        Objects.equals(this.program, crs1ProgramLinks.program) &&
        Objects.equals(this.programID, crs1ProgramLinks.programID);
  }

  @Override
  public int hashCode() {
    return Objects.hash(frSNumber, program, programID);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Crs1ProgramLinks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Crs1ProgramLinks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Crs1ProgramLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Crs1ProgramLinks is not found in the empty JSON string", Crs1ProgramLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Crs1ProgramLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Crs1ProgramLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Crs1ProgramLinks.openapiRequiredFields) {
      ...
      if (!jsonObj.get("ProgramID").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Crs1ProgramLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Crs1ProgramLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Crs1ProgramLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Crs1ProgramLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<Crs1ProgramLinks>() {
           @Override
           public void write(JsonWriter out, Crs1ProgramLinks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Crs1ProgramLinks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Crs1ProgramLinks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Crs1ProgramLinks
   * @throws IOException if the JSON string is invalid with respect to Crs1ProgramLinks
   */
  public static Crs1ProgramLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Crs1ProgramLinks.class);
  }

  /**
   * Convert an instance of Crs1ProgramLinks to an JSON string
   *
   * @return JSON string
   */
