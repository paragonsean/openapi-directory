 ...
 */
@JsonAdapter(FormDataFPRegion.Adapter.class)
public enum FormDataFPRegion {
  ...
  public static FormDataFPRegion fromValue(String value) {
    for (FormDataFPRegion b : FormDataFPRegion.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPRegion> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPRegion enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPRegion read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPRegion.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPRegion.fromValue(value);
  }
}
