...
public class Crs1CaseMilestones {
  ...
  public Crs1CaseMilestones() {
  }

  public Crs1CaseMilestones actualDate(String actualDate) {
  ...
  public Crs1CaseMilestones event(String event) {
    this.event = event;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Crs1CaseMilestones crs1CaseMilestones = (Crs1CaseMilestones) o;
    return Objects.equals(this.actualDate, crs1CaseMilestones.actualDate) &&
        Objects.equals(this.event, crs1CaseMilestones.event);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actualDate, event);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Crs1CaseMilestones {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Crs1CaseMilestones
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Crs1CaseMilestones.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Crs1CaseMilestones is not found in the empty JSON string", Crs1CaseMilestones.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Crs1CaseMilestones.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Crs1CaseMilestones` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Crs1CaseMilestones.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Crs1CaseMilestones.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Crs1CaseMilestones' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Crs1CaseMilestones> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Crs1CaseMilestones.class));

       return (TypeAdapter<T>) new TypeAdapter<Crs1CaseMilestones>() {
           @Override
           public void write(JsonWriter out, Crs1CaseMilestones value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Crs1CaseMilestones read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Crs1CaseMilestones given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Crs1CaseMilestones
   * @throws IOException if the JSON string is invalid with respect to Crs1CaseMilestones
   */
  public static Crs1CaseMilestones fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Crs1CaseMilestones.class);
  }

  /**
   * Convert an instance of Crs1CaseMilestones to an JSON string
   *
   * @return JSON string
   */
