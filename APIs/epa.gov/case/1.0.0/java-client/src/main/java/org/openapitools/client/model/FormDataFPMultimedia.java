 ...
 */
@JsonAdapter(FormDataFPMultimedia.Adapter.class)
public enum FormDataFPMultimedia {
  ...
  FormDataFPMultimedia(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPMultimedia fromValue(String value) {
    for (FormDataFPMultimedia b : FormDataFPMultimedia.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPMultimedia> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPMultimedia enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPMultimedia read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPMultimedia.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPMultimedia.fromValue(value);
  }
}
