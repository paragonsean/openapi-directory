...
public enum FormDataFPSepVal {
  ...
  public static FormDataFPSepVal fromValue(String value) {
    for (FormDataFPSepVal b : FormDataFPSepVal.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSepVal> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSepVal enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSepVal read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSepVal.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSepVal.fromValue(value);
  }
}
