 ...
 */
@JsonAdapter(FormDataFPSicAoNaics.Adapter.class)
public enum FormDataFPSicAoNaics {
  ...
  FormDataFPSicAoNaics(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPSicAoNaics fromValue(String value) {
    for (FormDataFPSicAoNaics b : FormDataFPSicAoNaics.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSicAoNaics> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSicAoNaics enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSicAoNaics read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSicAoNaics.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSicAoNaics.fromValue(value);
  }
}
