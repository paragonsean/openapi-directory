 ...
 */
@JsonAdapter(FormDataFPNaicsFrsFlg.Adapter.class)
public enum FormDataFPNaicsFrsFlg {
  ...
  FormDataFPNaicsFrsFlg(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPNaicsFrsFlg fromValue(String value) {
    for (FormDataFPNaicsFrsFlg b : FormDataFPNaicsFrsFlg.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPNaicsFrsFlg> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPNaicsFrsFlg enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPNaicsFrsFlg read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPNaicsFrsFlg.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPNaicsFrsFlg.fromValue(value);
  }
}
