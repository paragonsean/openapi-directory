 ...
 */
@JsonAdapter(FormDataFPSicPrimaryFlg.Adapter.class)
public enum FormDataFPSicPrimaryFlg {
  ...
  FormDataFPSicPrimaryFlg(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPSicPrimaryFlg fromValue(String value) {
    for (FormDataFPSicPrimaryFlg b : FormDataFPSicPrimaryFlg.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPSicPrimaryFlg> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPSicPrimaryFlg enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPSicPrimaryFlg read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPSicPrimaryFlg.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPSicPrimaryFlg.fromValue(value);
  }
}
