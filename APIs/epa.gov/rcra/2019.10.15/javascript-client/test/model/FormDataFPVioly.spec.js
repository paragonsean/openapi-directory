...
(function(root, factory) {
  ...
  describe('FormDataFPVioly', function() {
    it('should create an instance of FormDataFPVioly', function() {
      // uncomment below and update the code to test FormDataFPVioly
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPVioly();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPVioly);
    });
