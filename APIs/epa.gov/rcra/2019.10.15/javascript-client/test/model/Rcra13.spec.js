...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra13();
  });
  ...
  describe('Rcra13', function() {
    it('should create an instance of Rcra13', function() {
      // uncomment below and update the code to test Rcra13
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra13();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra13);
    });
