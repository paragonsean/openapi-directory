...
(function(root, factory) {
  ...
  describe('FormDataFPCifdi', function() {
    it('should create an instance of FormDataFPCifdi', function() {
      // uncomment below and update the code to test FormDataFPCifdi
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPCifdi();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPCifdi);
    });
