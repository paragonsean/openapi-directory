...
(function(root, factory) {
  ...
  describe('FormDataFPYsly', function() {
    it('should create an instance of FormDataFPYsly', function() {
      // uncomment below and update the code to test FormDataFPYsly
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPYsly();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPYsly);
    });
