...
(function(root, factory) {
  ...
  describe('FormDataFPFea', function() {
    it('should create an instance of FormDataFPFea', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPFea();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPFea);
    });
