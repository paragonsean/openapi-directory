...
(function(root, factory) {
  ...
  describe('FormDataFPIeaa', function() {
    it('should create an instance of FormDataFPIeaa', function() {
      // uncomment below and update the code to test FormDataFPIeaa
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPIeaa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPIeaa);
    });
