...
(function(root, factory) {
  ...
  describe('FormDataFPTrep', function() {
    it('should create an instance of FormDataFPTrep', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPTrep();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPTrep);
    });
