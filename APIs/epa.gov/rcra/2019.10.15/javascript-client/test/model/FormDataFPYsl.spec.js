...
(function(root, factory) {
  ...
  describe('FormDataFPYsl', function() {
    it('should create an instance of FormDataFPYsl', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPYsl();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPYsl);
    });
