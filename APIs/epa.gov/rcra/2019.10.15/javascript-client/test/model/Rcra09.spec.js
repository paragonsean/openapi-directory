...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra09();
  });
  ...
  describe('Rcra09', function() {
    it('should create an instance of Rcra09', function() {
      // uncomment below and update the code to test Rcra09
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra09();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra09);
    });
