...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetGeojsonGet200Response();
  });
  ...
  describe('RcraRestServicesGetGeojsonGet200Response', function() {
    it('should create an instance of RcraRestServicesGetGeojsonGet200Response', function() {
      // uncomment below and update the code to test RcraRestServicesGetGeojsonGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetGeojsonGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetGeojsonGet200Response);
    });
