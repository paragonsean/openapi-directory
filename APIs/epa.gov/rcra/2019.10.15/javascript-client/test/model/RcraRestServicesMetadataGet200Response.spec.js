...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesMetadataGet200Response();
  });
  ...
  describe('RcraRestServicesMetadataGet200Response', function() {
    it('should create an instance of RcraRestServicesMetadataGet200Response', function() {
      // uncomment below and update the code to test RcraRestServicesMetadataGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesMetadataGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesMetadataGet200Response);
    });
