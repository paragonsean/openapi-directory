...
(function(root, factory) {
  ...
  describe('FormDataFPOwop', function() {
    it('should create an instance of FormDataFPOwop', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPOwop();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPOwop);
    });
