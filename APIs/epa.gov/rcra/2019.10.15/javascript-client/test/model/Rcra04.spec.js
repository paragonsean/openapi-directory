...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra04();
  });
  ...
  describe('Rcra04', function() {
    it('should create an instance of Rcra04', function() {
      // uncomment below and update the code to test Rcra04
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra04();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.Rcra04);
    });
