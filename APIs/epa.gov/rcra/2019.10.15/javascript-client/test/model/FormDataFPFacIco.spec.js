...
(function(root, factory) {
  ...
  describe('FormDataFPFacIco', function() {
    it('should create an instance of FormDataFPFacIco', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPFacIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPFacIco);
    });
