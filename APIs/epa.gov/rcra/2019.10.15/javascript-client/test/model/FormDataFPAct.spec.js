...
(function(root, factory) {
  ...
  describe('FormDataFPAct', function() {
    it('should create an instance of FormDataFPAct', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPAct();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPAct);
    });
