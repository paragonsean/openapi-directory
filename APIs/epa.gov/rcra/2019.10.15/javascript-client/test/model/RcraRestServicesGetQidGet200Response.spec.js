...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetQidGet200Response();
  });
  ...
  describe('RcraRestServicesGetQidGet200Response', function() {
    it('should create an instance of RcraRestServicesGetQidGet200Response', function() {
      // uncomment below and update the code to test RcraRestServicesGetQidGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetQidGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetQidGet200Response);
    });
