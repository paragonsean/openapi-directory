...
(function(root, factory) {
  ...
  describe('FormDataFPQiv', function() {
    it('should create an instance of FormDataFPQiv', function() {
      // uncomment below and update the code to test FormDataFPQiv
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPQiv();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPQiv);
    });
