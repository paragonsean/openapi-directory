...
(function(root, factory) {
  ...
  describe('FormDataFPFeaa', function() {
    it('should create an instance of FormDataFPFeaa', function() {
      // uncomment below and update the code to test FormDataFPFeaa
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPFeaa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPFeaa);
    });
