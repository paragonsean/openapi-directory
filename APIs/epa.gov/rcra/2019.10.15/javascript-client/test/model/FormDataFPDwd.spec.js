...
(function(root, factory) {
  ...
  describe('FormDataFPDwd', function() {
    it('should create an instance of FormDataFPDwd', function() {
      // uncomment below and update the code to test FormDataFPDwd
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPDwd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPDwd);
    });
