...
(function(root, factory) {
  ...
  describe('FormDataFPImpw', function() {
    it('should create an instance of FormDataFPImpw', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPImpw();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPImpw);
    });
