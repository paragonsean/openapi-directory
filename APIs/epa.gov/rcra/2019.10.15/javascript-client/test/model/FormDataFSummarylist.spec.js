...
(function(root, factory) {
  ...
  describe('FormDataFSummarylist', function() {
    it('should create an instance of FormDataFSummarylist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFSummarylist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFSummarylist);
    });
