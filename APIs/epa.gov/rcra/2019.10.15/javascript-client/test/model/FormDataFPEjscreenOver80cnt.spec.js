...
(function(root, factory) {
  ...
  describe('FormDataFPEjscreenOver80cnt', function() {
    it('should create an instance of FormDataFPEjscreenOver80cnt', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPEjscreenOver80cnt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPEjscreenOver80cnt);
    });
