...
(function(root, factory) {
  ...
  describe('FormDataFPIea', function() {
    it('should create an instance of FormDataFPIea', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPIea();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPIea);
    });
