...
(function(root, factory) {
  ...
  describe('FormDataFPDecouple', function() {
    it('should create an instance of FormDataFPDecouple', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPDecouple();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPDecouple);
    });
