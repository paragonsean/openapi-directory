...
(function(root, factory) {
  ...
  describe('FormDataFPReg', function() {
    it('should create an instance of FormDataFPReg', function() {
      // uncomment below and update the code to test FormDataFPReg
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPReg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPReg);
    });
