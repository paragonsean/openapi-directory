...
(function(root, factory) {
  ...
  describe('FormDataFTablelist', function() {
    it('should create an instance of FormDataFTablelist', function() {
      // uncomment below and update the code to test FormDataFTablelist
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFTablelist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFTablelist);
    });
