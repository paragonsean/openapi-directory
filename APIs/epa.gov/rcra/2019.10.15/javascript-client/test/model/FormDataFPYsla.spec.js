...
(function(root, factory) {
  ...
  describe('FormDataFPYsla', function() {
    it('should create an instance of FormDataFPYsla', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPYsla();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPYsla);
    });
