...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetFacilitiesGet200Response();
  });
  ...
  describe('RcraRestServicesGetFacilitiesGet200Response', function() {
    it('should create an instance of RcraRestServicesGetFacilitiesGet200Response', function() {
      // uncomment below and update the code to test RcraRestServicesGetFacilitiesGet200Response
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetFacilitiesGet200Response();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.RcraRestServicesGetFacilitiesGet200Response);
    });
