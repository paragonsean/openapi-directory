...
(function(root, factory) {
  ...
  describe('FormDataFPIco', function() {
    it('should create an instance of FormDataFPIco', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPIco);
    });
