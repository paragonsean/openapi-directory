...
(function(root, factory) {
  ...
  describe('FormDataFPPsncq', function() {
    it('should create an instance of FormDataFPPsncq', function() {
      // uncomment below and update the code to test FormDataFPPsncq
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPPsncq();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPPsncq);
    });
