...
(function(root, factory) {
  ...
  describe('FormDataFPAgoo', function() {
    it('should create an instance of FormDataFPAgoo', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPAgoo();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPAgoo);
    });
