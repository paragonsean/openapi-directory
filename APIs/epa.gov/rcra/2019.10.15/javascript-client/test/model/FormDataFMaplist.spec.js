...
(function(root, factory) {
  ...
  describe('FormDataFMaplist', function() {
    it('should create an instance of FormDataFMaplist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFMaplist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFMaplist);
    });
