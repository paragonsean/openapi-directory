...
(function(root, factory) {
  ...
  describe('FormDataFPPd', function() {
    it('should create an instance of FormDataFPPd', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPPd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPPd);
    });
