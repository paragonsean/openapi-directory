...
(function(root, factory) {
  ...
  describe('FormDataFPMed', function() {
    it('should create an instance of FormDataFPMed', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPMed();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPMed);
    });
