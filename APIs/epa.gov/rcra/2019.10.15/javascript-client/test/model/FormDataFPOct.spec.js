...
(function(root, factory) {
  ...
  describe('FormDataFPOct', function() {
    it('should create an instance of FormDataFPOct', function() {
      // uncomment below and update the code to test FormDataFPOct
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPOct();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.FormDataFPOct);
    });
