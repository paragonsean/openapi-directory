...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.MetadataApi();
  });
  ...
  describe('MetadataApi', function() {
    describe('rcraRestServicesMetadataGet', function() {
      it('should call rcraRestServicesMetadataGet successfully', function(done) {
        //uncomment below and update the code to test rcraRestServicesMetadataGet
        //instance.rcraRestServicesMetadataGet(function(error) {
    ...
    describe('rcraRestServicesMetadataPost', function() {
      it('should call rcraRestServicesMetadataPost successfully', function(done) {
        //uncomment below and update the code to test rcraRestServicesMetadataPost
        //instance.rcraRestServicesMetadataPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
