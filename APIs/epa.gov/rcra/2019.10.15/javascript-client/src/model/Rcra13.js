...
/**
 * The Rcra13 model module.
 * @module model/Rcra13
 * @version 2019.10.15
 */
class Rcra13 {
    /**
     * Constructs a new <code>Rcra13</code>.
     * Results Object
     * @alias module:model/Rcra13
     * @param facilities {Array.<module:model/Rcra01>} A complex array of facility information.
    ...
    constructor(facilities, message, pageNo, queryID, queryRows) { 
        ...
        Rcra13.initialize(this, facilities, message, pageNo, queryID, queryRows);
    }
    ...
    /**
     * Constructs a <code>Rcra13</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rcra13} obj Optional instance to populate.
     * @return {module:model/Rcra13} The populated <code>Rcra13</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Rcra13</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rcra13</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rcra13.RequiredProperties) {
