...
/**
* Enum class FormDataFPFacIco.
* @enum {}
* @readonly
*/
export default class FormDataFPFacIco {
    ...
    /**
    * Returns a <code>FormDataFPFacIco</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPFacIco} The enum <code>FormDataFPFacIco</code> value.
    */
