...
/**
* Enum class FormDataFPOwop.
* @enum {}
* @readonly
*/
export default class FormDataFPOwop {
    ...
    /**
    * Returns a <code>FormDataFPOwop</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPOwop} The enum <code>FormDataFPOwop</code> value.
    */
