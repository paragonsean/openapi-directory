...
/**
 * The Rcra10 model module.
 * @module model/Rcra10
 * @version 2019.10.15
 */
class Rcra10 {
    /**
     * Constructs a new <code>Rcra10</code>.
     * GeoJSON Properties Object
     * @alias module:model/Rcra10
     ...
     * @param rCRAPenalties {Number} 
     * @param rCRAQtrsWithNC {Number} 
     * @param rCRAQtrsWithSNC {Number} 
    ...
    constructor(aIRIDs, activeLower48, cWAIDs, calculatedAccuracyMeters, censusBlockGroup, chemNamesRelLand, chesapeakeBayFlag, cleanupActionFlag, collectionMethod, currSvFlag, currVioFlag, currentVioCnt, dateLastRecordReview, ePASystem, ea5yrFlag, ejscreenFlag, ejscreenFlagUs, facCountyName, facDerivedHuc, facDerivedTRIbes, facDerivedWBD, facDerivedWBDName, facFIPSCode, facFederalAgencyCode, facFederalAgencyName, facIndianCntryFlg, facIndianSpatialFlg, facMapFlg, facMapIcon, facPercentMinority, facPopulationDensity, facSICCodes, facStdCountyName, facTRILandReleases, facTRIOffSiteTransfers, facTRIOnSiteReleases, facTRIReporter, facUsMexBorderFlg, infea5yrFlag, insp5yrFlag, lastViolationDate, lower48, map, maxPctileUs, maxScore, operatorCode, operatorDesc, over80CountUs, ownerCode, ownerDesc, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rCRA3yrComplQtrsHistory, rCRACaseIDs, rCRACity, rCRAComplStatus, rCRACounty, rCRADaysLastInspection, rCRAEPARegion, rCRAFIPSCode, rCRAFeaCnt, rCRAIDs, rCRAIeaCnt, rCRAImpWaterFlg, rCRAIndianCntryFlg, rCRAInspCnt, rCRALandTypeCode, rCRALastFeaDate, rCRALastFeaDateEPA, rCRALastFeaDateState, rCRALastIeaDate, rCRALastIeaDateEPA, rCRALastIeaDateState, rCRALastInspDateEPA, rCRALastInspDateState, rCRALastInspectionDate, rCRALastPenaltyDate, rCRAMapIcon, RCRANAICS, rCRAName, rCRAOldestOpenVioDate, rCRAPenalties, rCRAQtrsWithNC, rCRAQtrsWithSNC, RCRASNC, rCRAState, rCRAStateDistrict, rCRAStatus, rCRAStreet, rCRATRIbalLandCode, rCRAUniverse, rCRAViolationTypes, rCRAZip, rCRAinfoLandTypeCode, rCRAinfoLandTypeDesc, referencePoint, registryID, rmpIDs, sDWAIDs, score, semsIDs, sourceID, statute, tRIIDs, tRIbalFlag, tsdf, violFlag, webDocs) { 
        ...
        Rcra10.initialize(this, aIRIDs, activeLower48, cWAIDs, calculatedAccuracyMeters, censusBlockGroup, chemNamesRelLand, chesapeakeBayFlag, cleanupActionFlag, collectionMethod, currSvFlag, currVioFlag, currentVioCnt, dateLastRecordReview, ePASystem, ea5yrFlag, ejscreenFlag, ejscreenFlagUs, facCountyName, facDerivedHuc, facDerivedTRIbes, facDerivedWBD, facDerivedWBDName, facFIPSCode, facFederalAgencyCode, facFederalAgencyName, facIndianCntryFlg, facIndianSpatialFlg, facMapFlg, facMapIcon, facPercentMinority, facPopulationDensity, facSICCodes, facStdCountyName, facTRILandReleases, facTRIOffSiteTransfers, facTRIOnSiteReleases, facTRIReporter, facUsMexBorderFlg, infea5yrFlag, insp5yrFlag, lastViolationDate, lower48, map, maxPctileUs, maxScore, operatorCode, operatorDesc, over80CountUs, ownerCode, ownerDesc, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rCRA3yrComplQtrsHistory, rCRACaseIDs, rCRACity, rCRAComplStatus, rCRACounty, rCRADaysLastInspection, rCRAEPARegion, rCRAFIPSCode, rCRAFeaCnt, rCRAIDs, rCRAIeaCnt, rCRAImpWaterFlg, rCRAIndianCntryFlg, rCRAInspCnt, rCRALandTypeCode, rCRALastFeaDate, rCRALastFeaDateEPA, rCRALastFeaDateState, rCRALastIeaDate, rCRALastIeaDateEPA, rCRALastIeaDateState, rCRALastInspDateEPA, rCRALastInspDateState, rCRALastInspectionDate, rCRALastPenaltyDate, rCRAMapIcon, RCRANAICS, rCRAName, rCRAOldestOpenVioDate, rCRAPenalties, rCRAQtrsWithNC, rCRAQtrsWithSNC, RCRASNC, rCRAState, rCRAStateDistrict, rCRAStatus, rCRAStreet, rCRATRIbalLandCode, rCRAUniverse, rCRAViolationTypes, rCRAZip, rCRAinfoLandTypeCode, rCRAinfoLandTypeDesc, referencePoint, registryID, rmpIDs, sDWAIDs, score, semsIDs, sourceID, statute, tRIIDs, tRIbalFlag, tsdf, violFlag, webDocs);
    }
    ...
    /**
     * Constructs a <code>Rcra10</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rcra10} obj Optional instance to populate.
     * @return {module:model/Rcra10} The populated <code>Rcra10</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('RCRADaysLastInspection')) {
                obj['RCRADaysLastInspection'] = ApiClient.convertToType(data['RCRADaysLastInspection'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRAFeaCnt')) {
                obj['RCRAFeaCnt'] = ApiClient.convertToType(data['RCRAFeaCnt'], 'Number');
            }
            if (data.hasOwnProperty('RCRAIDs')) {
                obj['RCRAIDs'] = ApiClient.convertToType(data['RCRAIDs'], 'String');
            }
            if (data.hasOwnProperty('RCRAIeaCnt')) {
                obj['RCRAIeaCnt'] = ApiClient.convertToType(data['RCRAIeaCnt'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRAInspCnt')) {
                obj['RCRAInspCnt'] = ApiClient.convertToType(data['RCRAInspCnt'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRAPenalties')) {
                obj['RCRAPenalties'] = ApiClient.convertToType(data['RCRAPenalties'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRAQtrsWithSNC')) {
                obj['RCRAQtrsWithSNC'] = ApiClient.convertToType(data['RCRAQtrsWithSNC'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Rcra10</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rcra10</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rcra10.RequiredProperties) {
...
Rcra10.RequiredProperties = ["AIRIDs", "ActiveLower48", "CWAIDs", "CalculatedAccuracyMeters", "CensusBlockGroup", "ChemNamesRelLand", "ChesapeakeBayFlag", "CleanupActionFlag", "CollectionMethod", "CurrSvFlag", "CurrVioFlag", "CurrentVioCnt", "DateLastRecordReview", "EPASystem", "Ea5yrFlag", "EjscreenFlag", "EjscreenFlagUs", "FacCountyName", "FacDerivedHuc", "FacDerivedTRIbes", "FacDerivedWBD", "FacDerivedWBDName", "FacFIPSCode", "FacFederalAgencyCode", "FacFederalAgencyName", "FacIndianCntryFlg", "FacIndianSpatialFlg", "FacMapFlg", "FacMapIcon", "FacPercentMinority", "FacPopulationDensity", "FacSICCodes", "FacStdCountyName", "FacTRILandReleases", "FacTRIOffSiteTransfers", "FacTRIOnSiteReleases", "FacTRIReporter", "FacUsMexBorderFlg", "Infea5yrFlag", "Insp5yrFlag", "LastViolationDate", "Lower48", "Map", "MaxPctileUs", "MaxScore", "OperatorCode", "OperatorDesc", "Over80CountUs", "OwnerCode", "OwnerDesc", "PctileCancerUs", "PctileDpmUs", "PctileO3Us", "PctilePctpre1960Us", "PctilePmUs", "PctileProximityNPDESUs", "PctileProximityNplUs", "PctileProximityRmpUs", "PctileProximityTsdfUs", "PctileRespUs", "PctileTrafficScoreUs", "RCRA3yrComplQtrsHistory", "RCRACaseIDs", "RCRACity", "RCRAComplStatus", "RCRACounty", "RCRADaysLastInspection", "RCRAEPARegion", "RCRAFIPSCode", "RCRAFeaCnt", "RCRAIDs", "RCRAIeaCnt", "RCRAImpWaterFlg", "RCRAIndianCntryFlg", "RCRAInspCnt", "RCRALandTypeCode", "RCRALastFeaDate", "RCRALastFeaDateEPA", "RCRALastFeaDateState", "RCRALastIeaDate", "RCRALastIeaDateEPA", "RCRALastIeaDateState", "RCRALastInspDateEPA", "RCRALastInspDateState", "RCRALastInspectionDate", "RCRALastPenaltyDate", "RCRAMapIcon", "RCRANAICS", "RCRAName", "RCRAOldestOpenVioDate", "RCRAPenalties", "RCRAQtrsWithNC", "RCRAQtrsWithSNC", "RCRASNC", "RCRAState", "RCRAStateDistrict", "RCRAStatus", "RCRAStreet", "RCRATRIbalLandCode", "RCRAUniverse", "RCRAViolationTypes", "RCRAZip", "RCRAinfoLandTypeCode", "RCRAinfoLandTypeDesc", "ReferencePoint", "RegistryID", "RmpIDs", "SDWAIDs", "Score", "SemsIDs", "SourceID", "Statute", "TRIIDs", "TRIbalFlag", "Tsdf", "ViolFlag", "WebDocs"];

/**
 * Air Facility System (AFS) ID.
 * @member {String} AIRIDs
 */
Rcra10.prototype['AIRIDs'] = undefined;
 ...
 */
Rcra10.prototype['ActiveLower48'] = undefined;
 ...
 */
Rcra10.prototype['CWAIDs'] = undefined;
 ...
 */
Rcra10.prototype['CalculatedAccuracyMeters'] = undefined;
 ...
 */
Rcra10.prototype['CensusBlockGroup'] = undefined;
 ...
 */
Rcra10.prototype['EjscreenFlag'] = undefined;

/**
 * A Y/N indicator identifying whether or not the facility is within an Environmental Justice area.
 * @member {String} EjscreenFlagUs
 */
Rcra10.prototype['EjscreenFlagUs'] = undefined;

/**
 * The facility county name from EPA's Facility Registry System
 * @member {String} FacCountyName
 */
Rcra10.prototype['FacCountyName'] = undefined;
 ...
 */
Rcra10.prototype['FacFIPSCode'] = undefined;
 ...
 */
Rcra10.prototype['FacFederalAgencyCode'] = undefined;
 ...
 */
Rcra10.prototype['FacPercentMinority'] = undefined;

/**
 * The number of persons per square mile in the profiled area.
 * @member {Number} FacPopulationDensity
 */
Rcra10.prototype['FacPopulationDensity'] = undefined;
 ...
 */
Rcra10.prototype['FacSICCodes'] = undefined;

/**
 * The standardized  facility county name from EPA's Facility Registry System
 * @member {String} FacStdCountyName
 */
Rcra10.prototype['FacStdCountyName'] = undefined;

/**
 * @member {String} FacTRILandReleases
 */
Rcra10.prototype['FacTRILandReleases'] = undefined;

/**
 * @member {String} FacTRIOffSiteTransfers
 */
Rcra10.prototype['FacTRIOffSiteTransfers'] = undefined;

/**
 * @member {String} FacTRIOnSiteReleases
 */
Rcra10.prototype['FacTRIOnSiteReleases'] = undefined;
 ...
 */
Rcra10.prototype['Over80CountUs'] = undefined;

/**
 * @member {String} OwnerCode
 */
Rcra10.prototype['OwnerCode'] = undefined;

/**
 * Description of Owner code
 * @member {String} OwnerDesc
 */
Rcra10.prototype['OwnerDesc'] = undefined;
 ...
 */
Rcra10.prototype['PctileCancerUs'] = undefined;
 ...
 */
Rcra10.prototype['PctileProximityNPDESUs'] = undefined;
 ...
 */
Rcra10.prototype['PctileProximityNplUs'] = undefined;
 ...
 */
Rcra10.prototype['PctileProximityRmpUs'] = undefined;
 ...
 */
Rcra10.prototype['PctileProximityTsdfUs'] = undefined;
 ...
 */
Rcra10.prototype['PctileRespUs'] = undefined;
 ...
 */
Rcra10.prototype['PctileTrafficScoreUs'] = undefined;

/**
 * The system's 3-year compliance status history by quarter (3-month period) entered in the RCRA program database. Each character represents a quarter of compliance, going from oldest to most recent. Character values correspond to the following compliance statuses: _ -�No Violation V -�Violation S -�Significant Violation U - Undetermined
 * @member {String} RCRA3yrComplQtrsHistory
 */
Rcra10.prototype['RCRA3yrComplQtrsHistory'] = undefined;

/**
 * @member {String} RCRACaseIDs
 */
Rcra10.prototype['RCRACaseIDs'] = undefined;

/**
 * @member {String} RCRACity
 */
Rcra10.prototype['RCRACity'] = undefined;

/**
 * @member {String} RCRAComplStatus
 */
Rcra10.prototype['RCRAComplStatus'] = undefined;

/**
 * @member {String} RCRACounty
 */
Rcra10.prototype['RCRACounty'] = undefined;

/**
 * @member {Number} RCRADaysLastInspection
 */
Rcra10.prototype['RCRADaysLastInspection'] = undefined;

/**
 * @member {String} RCRAEPARegion
 */
Rcra10.prototype['RCRAEPARegion'] = undefined;

/**
 * @member {String} RCRAFIPSCode
 */
Rcra10.prototype['RCRAFIPSCode'] = undefined;

/**
 * @member {Number} RCRAFeaCnt
 */
Rcra10.prototype['RCRAFeaCnt'] = undefined;

/**
 * A unique 12-character ID assigned for each record/permit/site/facility within the RCRAInfo database.
 * @member {String} RCRAIDs
 */
Rcra10.prototype['RCRAIDs'] = undefined;

/**
 * @member {Number} RCRAIeaCnt
 */
Rcra10.prototype['RCRAIeaCnt'] = undefined;

/**
 * @member {String} RCRAImpWaterFlg
 */
Rcra10.prototype['RCRAImpWaterFlg'] = undefined;

/**
 * @member {String} RCRAIndianCntryFlg
 */
Rcra10.prototype['RCRAIndianCntryFlg'] = undefined;

/**
 * @member {Number} RCRAInspCnt
 */
Rcra10.prototype['RCRAInspCnt'] = undefined;

/**
 * @member {String} RCRALandTypeCode
 */
Rcra10.prototype['RCRALandTypeCode'] = undefined;

/**
 * @member {String} RCRALastFeaDate
 */
Rcra10.prototype['RCRALastFeaDate'] = undefined;

/**
 * @member {String} RCRALastFeaDateEPA
 */
Rcra10.prototype['RCRALastFeaDateEPA'] = undefined;

/**
 * @member {String} RCRALastFeaDateState
 */
Rcra10.prototype['RCRALastFeaDateState'] = undefined;

/**
 * @member {String} RCRALastIeaDate
 */
Rcra10.prototype['RCRALastIeaDate'] = undefined;

/**
 * @member {String} RCRALastIeaDateEPA
 */
Rcra10.prototype['RCRALastIeaDateEPA'] = undefined;

/**
 * @member {String} RCRALastIeaDateState
 */
Rcra10.prototype['RCRALastIeaDateState'] = undefined;

/**
 * @member {String} RCRALastInspDateEPA
 */
Rcra10.prototype['RCRALastInspDateEPA'] = undefined;

/**
 * @member {String} RCRALastInspDateState
 */
Rcra10.prototype['RCRALastInspDateState'] = undefined;

/**
 * @member {String} RCRALastInspectionDate
 */
Rcra10.prototype['RCRALastInspectionDate'] = undefined;
 ...
 */
Rcra10.prototype['RCRALastPenaltyDate'] = undefined;

/**
 * @member {String} RCRAMapIcon
 */
Rcra10.prototype['RCRAMapIcon'] = undefined;

/**
 * The RCRA permit's primary North American Industry Classification System (NAICS) Code.
 * @member {String} RCRANAICS
 */
Rcra10.prototype['RCRANAICS'] = undefined;

/**
 * @member {String} RCRAName
 */
Rcra10.prototype['RCRAName'] = undefined;

/**
 * @member {String} RCRAOldestOpenVioDate
 */
Rcra10.prototype['RCRAOldestOpenVioDate'] = undefined;

/**
 * @member {Number} RCRAPenalties
 */
Rcra10.prototype['RCRAPenalties'] = undefined;

/**
 * @member {Number} RCRAQtrsWithNC
 */
Rcra10.prototype['RCRAQtrsWithNC'] = undefined;

/**
 * @member {Number} RCRAQtrsWithSNC
 */
Rcra10.prototype['RCRAQtrsWithSNC'] = undefined;

/**
 * @member {String} RCRASNC
 */
Rcra10.prototype['RCRASNC'] = undefined;

/**
 * @member {String} RCRAState
 */
Rcra10.prototype['RCRAState'] = undefined;

/**
 * @member {String} RCRAStateDistrict
 */
Rcra10.prototype['RCRAStateDistrict'] = undefined;

/**
 * @member {String} RCRAStatus
 */
Rcra10.prototype['RCRAStatus'] = undefined;

/**
 * @member {String} RCRAStreet
 */
Rcra10.prototype['RCRAStreet'] = undefined;

/**
 * @member {String} RCRATRIbalLandCode
 */
Rcra10.prototype['RCRATRIbalLandCode'] = undefined;

/**
 * @member {String} RCRAUniverse
 */
Rcra10.prototype['RCRAUniverse'] = undefined;

/**
 * @member {String} RCRAViolationTypes
 */
Rcra10.prototype['RCRAViolationTypes'] = undefined;

/**
 * @member {String} RCRAZip
 */
Rcra10.prototype['RCRAZip'] = undefined;

/**
 * @member {String} RCRAinfoLandTypeCode
 */
Rcra10.prototype['RCRAinfoLandTypeCode'] = undefined;

/**
 * @member {String} RCRAinfoLandTypeDesc
 */
Rcra10.prototype['RCRAinfoLandTypeDesc'] = undefined;

/**
 * ??
 * @member {String} ReferencePoint
 */
Rcra10.prototype['ReferencePoint'] = undefined;
 ...
 */
Rcra10.prototype['RegistryID'] = undefined;
 ...
 */
Rcra10.prototype['RmpIDs'] = undefined;
 ...
 */
Rcra10.prototype['TRIIDs'] = undefined;
