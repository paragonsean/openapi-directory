...
import Rcra01 from './Rcra01';
import Rcra03 from './Rcra03';

/**
 * The Rcra04 model module.
 * @module model/Rcra04
 * @version 2019.10.15
 */
class Rcra04 {
    /**
     * Constructs a new <code>Rcra04</code>.
     * Results Object
     * @alias module:model/Rcra04
     ...
     */
    constructor(badSystemIDs, cVRows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, sVRows, totalPenalties, v3Rows) { 
        
        Rcra04.initialize(this, badSystemIDs, cVRows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, sVRows, totalPenalties, v3Rows);
    }
     ...
     */
    static initialize(obj, badSystemIDs, cVRows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, sVRows, totalPenalties, v3Rows) { 
    ...
    /**
     * Constructs a <code>Rcra04</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rcra04} obj Optional instance to populate.
     * @return {module:model/Rcra04} The populated <code>Rcra04</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Facilities')) {
                obj['Facilities'] = ApiClient.convertToType(data['Facilities'], [Rcra01]);
            }
            ...
            if (data.hasOwnProperty('MapOutput')) {
                obj['MapOutput'] = Rcra03.constructFromObject(data['MapOutput']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Rcra04</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rcra04</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rcra04.RequiredProperties) {
        ...
        if (data['MapOutput']) { // data not null
          Rcra03.validateJSON(data['MapOutput']);
        }
        // ensure the json data is a string
...
Rcra04.RequiredProperties = ["BadSystemIDs", "CVRows", "FEARows", "INSPRows", "IndianCountryRows", "InfFEARows", "Message", "PageNo", "QueryID", "QueryRows", "SVRows", "TotalPenalties", "V3Rows"];

/**
 * Identifies which passed query system identifiers are invalid.
 * @member {String} BadSystemIDs
 */
Rcra04.prototype['BadSystemIDs'] = undefined;
