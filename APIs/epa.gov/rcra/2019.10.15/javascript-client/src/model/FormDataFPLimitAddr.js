...
/**
* Enum class FormDataFPLimitAddr.
* @enum {}
* @readonly
*/
export default class FormDataFPLimitAddr {
    ...
    /**
    * Returns a <code>FormDataFPLimitAddr</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPLimitAddr} The enum <code>FormDataFPLimitAddr</code> value.
    */
