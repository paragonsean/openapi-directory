...
/**
* Enum class FormDataFPCifdi.
* @enum {}
* @readonly
*/
export default class FormDataFPCifdi {
    ...
    /**
    * Returns a <code>FormDataFPCifdi</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPCifdi} The enum <code>FormDataFPCifdi</code> value.
    */
