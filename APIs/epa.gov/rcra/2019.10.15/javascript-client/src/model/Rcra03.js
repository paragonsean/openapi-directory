...
import Rcra02 from './Rcra02';

/**
 * The Rcra03 model module.
 * @module model/Rcra03
 * @version 2019.10.15
 */
class Rcra03 {
    /**
     * Constructs a new <code>Rcra03</code>.
     * Map Output Object
     * @alias module:model/Rcra03
     * @param iconBaseURL {String} URL where all the icons are located
     * @param mapData {Array.<module:model/Rcra02>} An array of facility geospatial information.
    ...
    constructor(iconBaseURL, mapData, popUpBaseURL, queryID) { 
        ...
        Rcra03.initialize(this, iconBaseURL, mapData, popUpBaseURL, queryID);
    }
    ...
    /**
     * Constructs a <code>Rcra03</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rcra03} obj Optional instance to populate.
     * @return {module:model/Rcra03} The populated <code>Rcra03</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MapData')) {
                obj['MapData'] = ApiClient.convertToType(data['MapData'], [Rcra02]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Rcra03</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rcra03</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rcra03.RequiredProperties) {
...
Rcra03.RequiredProperties = ["IconBaseURL", "MapData", "PopUpBaseURL", "QueryID"];

/**
 * URL where all the icons are located
 * @member {String} IconBaseURL
 */
Rcra03.prototype['IconBaseURL'] = undefined;

/**
 * An array of facility geospatial information.
 * @member {Array.<module:model/Rcra02>} MapData
 */
Rcra03.prototype['MapData'] = undefined;

/**
 * Combine this URL with the PUC to get popup info
 * @member {String} PopUpBaseURL
 */
Rcra03.prototype['PopUpBaseURL'] = undefined;

/**
 * Sequential number assigned to entire search result
 * @member {String} QueryID
 */
Rcra03.prototype['QueryID'] = undefined;
