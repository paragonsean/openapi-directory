...
import Qp0 from './Qp0';
import Rcra06 from './Rcra06';
import Rcra07 from './Rcra07';

/**
 * The Rcra08 model module.
 * @module model/Rcra08
 * @version 2019.10.15
 */
class Rcra08 {
    /**
     * Constructs a new <code>Rcra08</code>.
     * Results Object
     * @alias module:model/Rcra08
    ...
    constructor(badSystemIDs, cVRows, fEARows, iNSPRows, iconBaseURL, indianCountryRows, infFEARows, message, popUpBaseURL, queryID, queryParameters, queryRows, sVRows, serviceBaseURL, totalPenalties, v3Rows) { 
        ...
        Rcra08.initialize(this, badSystemIDs, cVRows, fEARows, iNSPRows, iconBaseURL, indianCountryRows, infFEARows, message, popUpBaseURL, queryID, queryParameters, queryRows, sVRows, serviceBaseURL, totalPenalties, v3Rows);
    }
    ...
    /**
     * Constructs a <code>Rcra08</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Rcra08} obj Optional instance to populate.
     * @return {module:model/Rcra08} The populated <code>Rcra08</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ClusterOutput')) {
                obj['ClusterOutput'] = Rcra06.constructFromObject(data['ClusterOutput']);
            }
            ...
            if (data.hasOwnProperty('Facilities')) {
                obj['Facilities'] = ApiClient.convertToType(data['Facilities'], [Rcra07]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Rcra08</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Rcra08</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Rcra08.RequiredProperties) {
        ...
        if (data['ClusterOutput']) { // data not null
          Rcra06.validateJSON(data['ClusterOutput']);
        }
        // ensure the json data is a string
...
Rcra08.RequiredProperties = ["BadSystemIDs", "CVRows", "FEARows", "INSPRows", "IconBaseURL", "IndianCountryRows", "InfFEARows", "Message", "PopUpBaseURL", "QueryID", "QueryParameters", "QueryRows", "SVRows", "ServiceBaseURL", "TotalPenalties", "V3Rows"];

/**
 * Identifies which passed query system identifiers are invalid.
 * @member {String} BadSystemIDs
 */
Rcra08.prototype['BadSystemIDs'] = undefined;
