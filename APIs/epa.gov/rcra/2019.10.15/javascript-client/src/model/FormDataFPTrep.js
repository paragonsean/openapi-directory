...
/**
* Enum class FormDataFPTrep.
* @enum {}
* @readonly
*/
export default class FormDataFPTrep {
    ...
    /**
    * Returns a <code>FormDataFPTrep</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPTrep} The enum <code>FormDataFPTrep</code> value.
    */
