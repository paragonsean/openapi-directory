...
/**
* Enum class FormDataFPPd.
* @enum {}
* @readonly
*/
export default class FormDataFPPd {
    ...
    /**
    * Returns a <code>FormDataFPPd</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPPd} The enum <code>FormDataFPPd</code> value.
    */
