...
/**
* Enum class FormDataFMaplist.
* @enum {}
* @readonly
*/
export default class FormDataFMaplist {
    ...
    /**
    * Returns a <code>FormDataFMaplist</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFMaplist} The enum <code>FormDataFMaplist</code> value.
    */
