...
/**
* Enum class FormDataFPDwd.
* @enum {}
* @readonly
*/
export default class FormDataFPDwd {
    ...
    /**
    * Returns a <code>FormDataFPDwd</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPDwd} The enum <code>FormDataFPDwd</code> value.
    */
