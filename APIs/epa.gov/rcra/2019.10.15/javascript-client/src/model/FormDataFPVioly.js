...
/**
* Enum class FormDataFPVioly.
* @enum {}
* @readonly
*/
export default class FormDataFPVioly {
    ...
    /**
    * Returns a <code>FormDataFPVioly</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPVioly} The enum <code>FormDataFPVioly</code> value.
    */
