...
/**
* Enum class FormDataFPDecouple.
* @enum {}
* @readonly
*/
export default class FormDataFPDecouple {
    ...
    /**
    * Returns a <code>FormDataFPDecouple</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPDecouple} The enum <code>FormDataFPDecouple</code> value.
    */
