# USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.MetadataApi
...
> RcraRestServicesMetadataGet200Response rcraRestServicesMetadataGet(opts)
...
let apiInstance = new USEpaEnforcementAndComplianceHistoryOnlineEchoResourceConservationAndRecoveryAct.MetadataApi();
let opts = {
...
apiInstance.rcraRestServicesMetadataGet(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> RcraRestServicesMetadataGet200Response rcraRestServicesMetadataPost(opts)
...
apiInstance.rcraRestServicesMetadataPost(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
