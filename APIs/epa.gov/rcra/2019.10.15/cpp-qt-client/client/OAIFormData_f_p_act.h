...
class OAIFormData_f_p_act : public OAIEnum {
public:
    OAIFormData_f_p_act();
    OAIFormData_f_p_act(QString json);
    ~OAIFormData_f_p_act() override;
    ...
    enum class eOAIFormData_f_p_act {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N, 
        A
    };
    OAIFormData_f_p_act::eOAIFormData_f_p_act getValue() const;
    void setValue(const OAIFormData_f_p_act::eOAIFormData_f_p_act& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_act)

#endif // OAIFormData_f_p_act_H
