...
class OAIRcra12 : public OAIObject {
public:
    OAIRcra12();
    OAIRcra12(QString json);
    ~OAIRcra12() override;
    ...
    QList<OAIRcra11> getMapData() const;
    void setMapData(const QList<OAIRcra11> &map_data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRcra12)
