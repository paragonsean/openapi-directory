...
class OAIRcra03 : public OAIObject {
public:
    OAIRcra03();
    OAIRcra03(QString json);
    ~OAIRcra03() override;
    ...
    QList<OAIRcra02> getMapData() const;
    void setMapData(const QList<OAIRcra02> &map_data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRcra03)
