...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("rcraRestServicesMetadataGet", defaultConf);
    _serverIndices.insert("rcraRestServicesMetadataGet", 0);
    _serverConfigs.insert("rcraRestServicesMetadataPost", defaultConf);
    _serverIndices.insert("rcraRestServicesMetadataPost", 0);
}
...
void OAIMetadataApi::rcraRestServicesMetadataGet(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["rcraRestServicesMetadataGet"][_serverIndices.value("rcraRestServicesMetadataGet")].URL()+"/rcra_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::rcraRestServicesMetadataGetCallback);
...
void OAIMetadataApi::rcraRestServicesMetadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_rcra_rest_services_metadata_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT rcraRestServicesMetadataGetSignal(output);
        Q_EMIT rcraRestServicesMetadataGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT rcraRestServicesMetadataGetSignalE(output, error_type, error_str);
        Q_EMIT rcraRestServicesMetadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT rcraRestServicesMetadataGetSignalError(output, error_type, error_str);
        Q_EMIT rcraRestServicesMetadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::rcraRestServicesMetadataPost(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["rcraRestServicesMetadataPost"][_serverIndices.value("rcraRestServicesMetadataPost")].URL()+"/rcra_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::rcraRestServicesMetadataPostCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::rcraRestServicesMetadataPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT rcraRestServicesMetadataPostSignal(output);
        Q_EMIT rcraRestServicesMetadataPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT rcraRestServicesMetadataPostSignalE(output, error_type, error_str);
        Q_EMIT rcraRestServicesMetadataPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT rcraRestServicesMetadataPostSignalError(output, error_type, error_str);
        Q_EMIT rcraRestServicesMetadataPostSignalErrorFull(worker, error_type, error_str);
    }
}
