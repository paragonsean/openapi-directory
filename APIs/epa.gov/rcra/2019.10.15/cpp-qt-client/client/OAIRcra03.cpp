...
OAIRcra03::OAIRcra03(QString json) {
...
void OAIRcra03::initializeModel() {
...
void OAIRcra03::fromJson(QString jsonString) {
...
void OAIRcra03::fromJsonObject(QJsonObject json) {
...
QString OAIRcra03::asJson() const {
...
QJsonObject OAIRcra03::asJsonObject() const {
    QJsonObject obj;
...
QString OAIRcra03::getIconBaseUrl() const {
    return m_icon_base_url;
}
void OAIRcra03::setIconBaseUrl(const QString &icon_base_url) {
    m_icon_base_url = icon_base_url;
    m_icon_base_url_isSet = true;
}

bool OAIRcra03::is_icon_base_url_Set() const{
    return m_icon_base_url_isSet;
}

bool OAIRcra03::is_icon_base_url_Valid() const{
    return m_icon_base_url_isValid;
}

QList<OAIRcra02> OAIRcra03::getMapData() const {
    return m_map_data;
}
void OAIRcra03::setMapData(const QList<OAIRcra02> &map_data) {
    m_map_data = map_data;
    m_map_data_isSet = true;
}

bool OAIRcra03::is_map_data_Set() const{
    return m_map_data_isSet;
}

bool OAIRcra03::is_map_data_Valid() const{
    return m_map_data_isValid;
}

QString OAIRcra03::getPopUpBaseUrl() const {
    return m_pop_up_base_url;
}
void OAIRcra03::setPopUpBaseUrl(const QString &pop_up_base_url) {
    m_pop_up_base_url = pop_up_base_url;
    m_pop_up_base_url_isSet = true;
}

bool OAIRcra03::is_pop_up_base_url_Set() const{
    return m_pop_up_base_url_isSet;
}

bool OAIRcra03::is_pop_up_base_url_Valid() const{
    return m_pop_up_base_url_isValid;
}

QString OAIRcra03::getQueryId() const {
    return m_query_id;
}
void OAIRcra03::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAIRcra03::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAIRcra03::is_query_id_Valid() const{
    return m_query_id_isValid;
}

bool OAIRcra03::isSet() const {
