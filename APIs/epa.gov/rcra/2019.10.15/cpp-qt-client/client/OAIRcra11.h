...
class OAIRcra11 : public OAIObject {
public:
    OAIRcra11();
    OAIRcra11(QString json);
    ~OAIRcra11() override;
    ...
    void setRcrAstatus(const QString &rcr_astatus);
    bool is_rcr_astatus_Set() const;
    bool is_rcr_astatus_Valid() const;
...
private:
    ...
    QString m_rcr_astatus;
    bool m_rcr_astatus_isSet;
    bool m_rcr_astatus_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRcra11)
