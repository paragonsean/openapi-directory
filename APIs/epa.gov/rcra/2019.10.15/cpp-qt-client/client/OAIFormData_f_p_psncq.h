...
#ifndef OAIFormData_f_p_psncq_H
#define OAIFormData_f_p_psncq_H
...
class OAIFormData_f_p_psncq : public OAIEnum {
public:
    OAIFormData_f_p_psncq();
    OAIFormData_f_p_psncq(QString json);
    ~OAIFormData_f_p_psncq() override;
    ...
    enum class eOAIFormData_f_p_psncq {
    ...
    OAIFormData_f_p_psncq::eOAIFormData_f_p_psncq getValue() const;
    void setValue(const OAIFormData_f_p_psncq::eOAIFormData_f_p_psncq& value);
...
private:
    ...
    eOAIFormData_f_p_psncq m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_psncq)

#endif // OAIFormData_f_p_psncq_H
