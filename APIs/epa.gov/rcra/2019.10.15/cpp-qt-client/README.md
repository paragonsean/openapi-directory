...
void Example::exampleFunction1(){
     OAIMetadataApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIMetadataApi::rcraRestServicesMetadataGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIMetadataApi::rcraRestServicesMetadataGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.rcraRestServicesMetadataGet(outputcallback);
