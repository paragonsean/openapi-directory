...
class Rcra08(Model):
    ...
    def __init__(self, bad_system_ids: str=None, cv_rows: str=None, cluster_output: Rcra06=None, cluster_records: str=None, fea_rows: str=None, facilities: List[Rcra07]=None, insp_rows: str=None, icon_base_url: str=None, indian_country_rows: str=None, inf_fea_rows: str=None, message: str=None, pop_up_base_url: str=None, query_id: str=None, query_parameters: List[Qp0]=None, query_rows: str=None, sv_rows: str=None, service_base_url: str=None, total_penalties: str=None, v3_rows: str=None):
        """Rcra08 - a model defined in OpenAPI

        :param bad_system_ids: The bad_system_ids of this Rcra08.
        :param cv_rows: The cv_rows of this Rcra08.
        :param cluster_output: The cluster_output of this Rcra08.
        :param cluster_records: The cluster_records of this Rcra08.
        :param fea_rows: The fea_rows of this Rcra08.
        :param facilities: The facilities of this Rcra08.
        :param insp_rows: The insp_rows of this Rcra08.
        :param icon_base_url: The icon_base_url of this Rcra08.
        :param indian_country_rows: The indian_country_rows of this Rcra08.
        :param inf_fea_rows: The inf_fea_rows of this Rcra08.
        :param message: The message of this Rcra08.
        :param pop_up_base_url: The pop_up_base_url of this Rcra08.
        :param query_id: The query_id of this Rcra08.
        :param query_parameters: The query_parameters of this Rcra08.
        :param query_rows: The query_rows of this Rcra08.
        :param sv_rows: The sv_rows of this Rcra08.
        :param service_base_url: The service_base_url of this Rcra08.
        :param total_penalties: The total_penalties of this Rcra08.
        :param v3_rows: The v3_rows of this Rcra08.
        """
        self.openapi_types = {
            'bad_system_ids': str,
            'cv_rows': str,
            'cluster_output': Rcra06,
            'cluster_records': str,
            'fea_rows': str,
            'facilities': List[Rcra07],
            'insp_rows': str,
            'icon_base_url': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Rcra08':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The rcra08 of this Rcra08.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bad_system_ids(self):
        """Gets the bad_system_ids of this Rcra08.

        Identifies which passed query system identifiers are invalid.

        :return: The bad_system_ids of this Rcra08.
        :rtype: str
        """
    ...
    def bad_system_ids(self, bad_system_ids):
        """Sets the bad_system_ids of this Rcra08.
    ...
    def cv_rows(self, cv_rows):
        """Sets the cv_rows of this Rcra08.
    ...
    def cluster_output(self):
        """Gets the cluster_output of this Rcra08.


        :return: The cluster_output of this Rcra08.
        :rtype: Rcra06
        """
    ...
    def cluster_output(self, cluster_output):
        """Sets the cluster_output of this Rcra08.


        :param cluster_output: The cluster_output of this Rcra08.
        :type cluster_output: Rcra06
        """
    ...
    def cluster_records(self):
        """Gets the cluster_records of this Rcra08.

        Number of clusters returned.

        :return: The cluster_records of this Rcra08.
        :rtype: str
        """
    ...
    def cluster_records(self, cluster_records):
        """Sets the cluster_records of this Rcra08.
    ...
    def fea_rows(self, fea_rows):
        """Sets the fea_rows of this Rcra08.
    ...
    @property
    def facilities(self):
        """Gets the facilities of this Rcra08.

        A complex array of facility information.

        :return: The facilities of this Rcra08.
        :rtype: List[Rcra07]
        """
    ...
    def facilities(self, facilities):
        """Sets the facilities of this Rcra08.

        A complex array of facility information.

        :param facilities: The facilities of this Rcra08.
        :type facilities: List[Rcra07]
        """
    ...
    def insp_rows(self, insp_rows):
        """Sets the insp_rows of this Rcra08.
    ...
    def icon_base_url(self):
        """Gets the icon_base_url of this Rcra08.

        URL where all the icons are located

        :return: The icon_base_url of this Rcra08.
        :rtype: str
        """
    ...
    def icon_base_url(self, icon_base_url):
        """Sets the icon_base_url of this Rcra08.
    ...
    def indian_country_rows(self):
        """Gets the indian_country_rows of this Rcra08.

        Number of facilities with tribal_flag populated

        :return: The indian_country_rows of this Rcra08.
        :rtype: str
        """
    ...
    def indian_country_rows(self, indian_country_rows):
        """Sets the indian_country_rows of this Rcra08.
    ...
    def inf_fea_rows(self, inf_fea_rows):
        """Sets the inf_fea_rows of this Rcra08.
    ...
    def message(self, message):
        """Sets the message of this Rcra08.
    ...
    def pop_up_base_url(self):
        """Gets the pop_up_base_url of this Rcra08.

        Combine this URL with the PUC to get popup info

        :return: The pop_up_base_url of this Rcra08.
        :rtype: str
        """
    ...
    def pop_up_base_url(self, pop_up_base_url):
        """Sets the pop_up_base_url of this Rcra08.
    ...
    @property
    def query_id(self):
        """Gets the query_id of this Rcra08.

        Sequential number assigned to entire search result

        :return: The query_id of this Rcra08.
        :rtype: str
        """
    ...
    def query_id(self, query_id):
        """Sets the query_id of this Rcra08.
    ...
    def query_parameters(self):
        """Gets the query_parameters of this Rcra08.

        A list of submitted query parameters and their values.

        :return: The query_parameters of this Rcra08.
        :rtype: List[Qp0]
        """
    ...
    def query_parameters(self, query_parameters):
        """Sets the query_parameters of this Rcra08.
    ...
    @property
    def query_rows(self):
        """Gets the query_rows of this Rcra08.

        Number of query results returned

        :return: The query_rows of this Rcra08.
        :rtype: str
        """
    ...
    def query_rows(self, query_rows):
        """Sets the query_rows of this Rcra08.
    ...
    def sv_rows(self, sv_rows):
        """Sets the sv_rows of this Rcra08.
    ...
    def service_base_url(self):
        """Gets the service_base_url of this Rcra08.

        The base service URL.

        :return: The service_base_url of this Rcra08.
        :rtype: str
        """
    ...
    def service_base_url(self, service_base_url):
        """Sets the service_base_url of this Rcra08.
    ...
    def total_penalties(self, total_penalties):
        """Sets the total_penalties of this Rcra08.
    ...
    def v3_rows(self, v3_rows):
        """Sets the v3_rows of this Rcra08.
