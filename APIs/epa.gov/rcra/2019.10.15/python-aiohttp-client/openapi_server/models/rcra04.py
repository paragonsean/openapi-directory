...
class Rcra04(Model):
    ...
    def __init__(self, bad_system_ids: str=None, cv_rows: str=None, fea_rows: str=None, facilities: List[Rcra01]=None, insp_rows: str=None, indian_country_rows: str=None, inf_fea_rows: str=None, map_output: Rcra03=None, message: str=None, page_no: str=None, query_id: str=None, query_rows: str=None, sv_rows: str=None, total_penalties: str=None, v3_rows: str=None):
        """Rcra04 - a model defined in OpenAPI

        :param bad_system_ids: The bad_system_ids of this Rcra04.
        :param cv_rows: The cv_rows of this Rcra04.
        :param fea_rows: The fea_rows of this Rcra04.
        :param facilities: The facilities of this Rcra04.
        :param insp_rows: The insp_rows of this Rcra04.
        :param indian_country_rows: The indian_country_rows of this Rcra04.
        :param inf_fea_rows: The inf_fea_rows of this Rcra04.
        :param map_output: The map_output of this Rcra04.
        :param message: The message of this Rcra04.
        :param page_no: The page_no of this Rcra04.
        :param query_id: The query_id of this Rcra04.
        :param query_rows: The query_rows of this Rcra04.
        :param sv_rows: The sv_rows of this Rcra04.
        :param total_penalties: The total_penalties of this Rcra04.
        :param v3_rows: The v3_rows of this Rcra04.
        """
        self.openapi_types = {
            'bad_system_ids': str,
            'cv_rows': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Rcra04':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The rcra04 of this Rcra04.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def bad_system_ids(self):
        """Gets the bad_system_ids of this Rcra04.

        Identifies which passed query system identifiers are invalid.

        :return: The bad_system_ids of this Rcra04.
        :rtype: str
        """
    ...
    def bad_system_ids(self, bad_system_ids):
        """Sets the bad_system_ids of this Rcra04.
    ...
    def cv_rows(self, cv_rows):
        """Sets the cv_rows of this Rcra04.
    ...
    def fea_rows(self, fea_rows):
        """Sets the fea_rows of this Rcra04.
    ...
    @property
    def facilities(self):
        """Gets the facilities of this Rcra04.

        A complex array of facility information.

        :return: The facilities of this Rcra04.
        :rtype: List[Rcra01]
        """
    ...
    def facilities(self, facilities):
        """Sets the facilities of this Rcra04.
    ...
    def insp_rows(self, insp_rows):
        """Sets the insp_rows of this Rcra04.
    ...
    def indian_country_rows(self):
        """Gets the indian_country_rows of this Rcra04.

        Number of facilities with tribal_flag populated

        :return: The indian_country_rows of this Rcra04.
        :rtype: str
        """
    ...
    def indian_country_rows(self, indian_country_rows):
        """Sets the indian_country_rows of this Rcra04.
    ...
    def inf_fea_rows(self, inf_fea_rows):
        """Sets the inf_fea_rows of this Rcra04.
    ...
    @property
    def map_output(self):
        """Gets the map_output of this Rcra04.


        :return: The map_output of this Rcra04.
        :rtype: Rcra03
        """
    ...
    def map_output(self, map_output):
        """Sets the map_output of this Rcra04.


        :param map_output: The map_output of this Rcra04.
        :type map_output: Rcra03
        """
    ...
    def message(self, message):
        """Sets the message of this Rcra04.
    ...
    @property
    def page_no(self):
        """Gets the page_no of this Rcra04.

        The number of pages of results returned

        :return: The page_no of this Rcra04.
        :rtype: str
        """
    ...
    def page_no(self, page_no):
        """Sets the page_no of this Rcra04.
    ...
    @property
    def query_id(self):
        """Gets the query_id of this Rcra04.

        Sequential number assigned to entire search result

        :return: The query_id of this Rcra04.
        :rtype: str
        """
    ...
    def query_id(self, query_id):
        """Sets the query_id of this Rcra04.
    ...
    @property
    def query_rows(self):
        """Gets the query_rows of this Rcra04.

        Number of query results returned

        :return: The query_rows of this Rcra04.
        :rtype: str
        """
    ...
    def query_rows(self, query_rows):
        """Sets the query_rows of this Rcra04.
    ...
    def sv_rows(self, sv_rows):
        """Sets the sv_rows of this Rcra04.
    ...
    def total_penalties(self, total_penalties):
        """Sets the total_penalties of this Rcra04.
    ...
    def v3_rows(self, v3_rows):
        """Sets the v3_rows of this Rcra04.
