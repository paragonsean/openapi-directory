...
async def rcra_rest_services_metadata_get(request: web.Request, output=None, param_callback=None) -> web.Response:
...
async def rcra_rest_services_metadata_post(request: web.Request, output=None, param_callback=None) -> web.Response:
    """Resource Conservation and Recovery Act (RCRA) Metadata Service
