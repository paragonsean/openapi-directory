...
|**facPopulationDensity** | **BigDecimal** | The number of persons per square mile in the profiled area. |  |
...
|**rcRAPenalties** | **BigDecimal** |  |  |
|**rcRAQtrsWithNC** | **BigDecimal** |  |  |
|**rcRAQtrsWithSNC** | **BigDecimal** |  |  |
|**RCRASNC** | **String** |  |  |
|**rcRAState** | **String** |  |  |
