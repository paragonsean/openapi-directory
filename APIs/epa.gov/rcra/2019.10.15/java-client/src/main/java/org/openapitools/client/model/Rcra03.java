...
import org.openapitools.client.model.Rcra02;
...
public class Rcra03 {
  ...
  private List<Rcra02> mapData = new ArrayList<>();
  ...
  public Rcra03 iconBaseURL(String iconBaseURL) {
  ...
  public Rcra03 mapData(List<Rcra02> mapData) {
    this.mapData = mapData;
    return this;
  }

  public Rcra03 addMapDataItem(Rcra02 mapDataItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<Rcra02> getMapData() {
    return mapData;
  }

  public void setMapData(List<Rcra02> mapData) {
    this.mapData = mapData;
  }


  public Rcra03 popUpBaseURL(String popUpBaseURL) {
  ...
  public Rcra03 queryID(String queryID) {
  ...
  public boolean equals(Object o) {
    ...
    Rcra03 rcra03 = (Rcra03) o;
    return Objects.equals(this.iconBaseURL, rcra03.iconBaseURL) &&
        Objects.equals(this.mapData, rcra03.mapData) &&
        Objects.equals(this.popUpBaseURL, rcra03.popUpBaseURL) &&
        Objects.equals(this.queryID, rcra03.queryID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rcra03
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rcra03.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rcra03 is not found in the empty JSON string", Rcra03.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rcra03.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rcra03` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rcra03.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraymapData.size(); i++) {
        Rcra02.validateJsonElement(jsonArraymapData.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rcra03.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rcra03' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rcra03> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rcra03.class));

       return (TypeAdapter<T>) new TypeAdapter<Rcra03>() {
           @Override
           public void write(JsonWriter out, Rcra03 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rcra03 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rcra03 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rcra03
   * @throws IOException if the JSON string is invalid with respect to Rcra03
   */
  public static Rcra03 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rcra03.class);
  }

  /**
   * Convert an instance of Rcra03 to an JSON string
   *
   * @return JSON string
   */
