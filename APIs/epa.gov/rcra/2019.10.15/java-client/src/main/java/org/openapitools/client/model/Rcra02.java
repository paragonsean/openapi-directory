...
public class Rcra02 {
  ...
  public Rcra02 formalCount(String formalCount) {
  ...
  public Rcra02 ICON(String ICON) {
    this.ICON = ICON;
    return this;
  }
  ...
  public Rcra02 informalCount(String informalCount) {
  ...
  public Rcra02 lastInsp(String lastInsp) {
  ...
  public Rcra02 NAME(String NAME) {
    this.NAME = NAME;
    return this;
  }
  ...
  public Rcra02 rcRAstatus(String rcRAstatus) {
  ...
  public Rcra02 TYPE(String TYPE) {
    this.TYPE = TYPE;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Rcra02 rcra02 = (Rcra02) o;
    return Objects.equals(this.formalCount, rcra02.formalCount) &&
        Objects.equals(this.ICON, rcra02.ICON) &&
        Objects.equals(this.informalCount, rcra02.informalCount) &&
        Objects.equals(this.LAT, rcra02.LAT) &&
        Objects.equals(this.LON, rcra02.LON) &&
        Objects.equals(this.lastInsp, rcra02.lastInsp) &&
        Objects.equals(this.NAME, rcra02.NAME) &&
        Objects.equals(this.PUV, rcra02.PUV) &&
        Objects.equals(this.rcRAstatus, rcra02.rcRAstatus) &&
        Objects.equals(this.TYPE, rcra02.TYPE);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rcra02
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rcra02.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rcra02 is not found in the empty JSON string", Rcra02.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rcra02.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rcra02` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rcra02.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rcra02.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rcra02' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rcra02> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rcra02.class));

       return (TypeAdapter<T>) new TypeAdapter<Rcra02>() {
           @Override
           public void write(JsonWriter out, Rcra02 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rcra02 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rcra02 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rcra02
   * @throws IOException if the JSON string is invalid with respect to Rcra02
   */
  public static Rcra02 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rcra02.class);
  }

  /**
   * Convert an instance of Rcra02 to an JSON string
   *
   * @return JSON string
   */
