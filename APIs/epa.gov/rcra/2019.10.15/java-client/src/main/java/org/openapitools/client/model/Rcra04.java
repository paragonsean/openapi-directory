...
public class Rcra04 {
  ...
  public Rcra04 badSystemIDs(String badSystemIDs) {
  ...
  public Rcra04 cvRows(String cvRows) {
    this.cvRows = cvRows;
    return this;
  }
  ...
  public Rcra04 feARows(String feARows) {
  ...
  public Rcra04 facilities(List<Rcra01> facilities) {
    this.facilities = facilities;
    return this;
  }

  public Rcra04 addFacilitiesItem(Rcra01 facilitiesItem) {
  ...
  public Rcra04 inSPRows(String inSPRows) {
  ...
  public Rcra04 indianCountryRows(String indianCountryRows) {
  ...
  public Rcra04 infFEARows(String infFEARows) {
  ...
  public Rcra04 mapOutput(Rcra03 mapOutput) {
   ...
   */
  @javax.annotation.Nullable
  public Rcra03 getMapOutput() {
    return mapOutput;
  }

  public void setMapOutput(Rcra03 mapOutput) {
    this.mapOutput = mapOutput;
  }


  public Rcra04 message(String message) {
  ...
  public Rcra04 pageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public Rcra04 queryID(String queryID) {
  ...
  public Rcra04 queryRows(String queryRows) {
  ...
  public Rcra04 svRows(String svRows) {
    this.svRows = svRows;
    return this;
  }
  ...
  public Rcra04 totalPenalties(String totalPenalties) {
  ...
  public Rcra04 v3Rows(String v3Rows) {
    this.v3Rows = v3Rows;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Rcra04 rcra04 = (Rcra04) o;
    return Objects.equals(this.badSystemIDs, rcra04.badSystemIDs) &&
        Objects.equals(this.cvRows, rcra04.cvRows) &&
        Objects.equals(this.feARows, rcra04.feARows) &&
        Objects.equals(this.facilities, rcra04.facilities) &&
        Objects.equals(this.inSPRows, rcra04.inSPRows) &&
        Objects.equals(this.indianCountryRows, rcra04.indianCountryRows) &&
        Objects.equals(this.infFEARows, rcra04.infFEARows) &&
        Objects.equals(this.mapOutput, rcra04.mapOutput) &&
        Objects.equals(this.message, rcra04.message) &&
        Objects.equals(this.pageNo, rcra04.pageNo) &&
        Objects.equals(this.queryID, rcra04.queryID) &&
        Objects.equals(this.queryRows, rcra04.queryRows) &&
        Objects.equals(this.svRows, rcra04.svRows) &&
        Objects.equals(this.totalPenalties, rcra04.totalPenalties) &&
        Objects.equals(this.v3Rows, rcra04.v3Rows);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rcra04
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rcra04.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rcra04 is not found in the empty JSON string", Rcra04.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rcra04.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rcra04` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rcra04.openapiRequiredFields) {
      ...
      if (jsonObj.get("MapOutput") != null && !jsonObj.get("MapOutput").isJsonNull()) {
        Rcra03.validateJsonElement(jsonObj.get("MapOutput"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rcra04.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rcra04' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rcra04> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rcra04.class));

       return (TypeAdapter<T>) new TypeAdapter<Rcra04>() {
           @Override
           public void write(JsonWriter out, Rcra04 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rcra04 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rcra04 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rcra04
   * @throws IOException if the JSON string is invalid with respect to Rcra04
   */
  public static Rcra04 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rcra04.class);
  }

  /**
   * Convert an instance of Rcra04 to an JSON string
   *
   * @return JSON string
   */
