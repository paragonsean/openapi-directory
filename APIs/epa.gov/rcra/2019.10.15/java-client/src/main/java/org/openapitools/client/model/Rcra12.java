...
import org.openapitools.client.model.Rcra11;
...
public class Rcra12 {
  ...
  private List<Rcra11> mapData = new ArrayList<>();
  ...
  public Rcra12 iconBaseURL(String iconBaseURL) {
  ...
  public Rcra12 mapData(List<Rcra11> mapData) {
    this.mapData = mapData;
    return this;
  }

  public Rcra12 addMapDataItem(Rcra11 mapDataItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<Rcra11> getMapData() {
    return mapData;
  }

  public void setMapData(List<Rcra11> mapData) {
    this.mapData = mapData;
  }


  public Rcra12 popUpBaseURL(String popUpBaseURL) {
  ...
  public Rcra12 queryID(String queryID) {
  ...
  public boolean equals(Object o) {
    ...
    Rcra12 rcra12 = (Rcra12) o;
    return Objects.equals(this.iconBaseURL, rcra12.iconBaseURL) &&
        Objects.equals(this.mapData, rcra12.mapData) &&
        Objects.equals(this.popUpBaseURL, rcra12.popUpBaseURL) &&
        Objects.equals(this.queryID, rcra12.queryID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rcra12
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rcra12.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rcra12 is not found in the empty JSON string", Rcra12.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rcra12.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rcra12` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rcra12.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraymapData.size(); i++) {
        Rcra11.validateJsonElement(jsonArraymapData.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rcra12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rcra12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rcra12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rcra12.class));

       return (TypeAdapter<T>) new TypeAdapter<Rcra12>() {
           @Override
           public void write(JsonWriter out, Rcra12 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rcra12 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rcra12 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rcra12
   * @throws IOException if the JSON string is invalid with respect to Rcra12
   */
  public static Rcra12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rcra12.class);
  }

  /**
   * Convert an instance of Rcra12 to an JSON string
   *
   * @return JSON string
   */
