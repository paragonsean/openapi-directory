...
public class ApiClient {
    ...
    private String basePath = "https://echodata.epa.gov/echo";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019.10.15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://echodata.epa.gov/echo
