 ...
 */
@JsonAdapter(FormDataFPIco.Adapter.class)
public enum FormDataFPIco {
  ...
  public static FormDataFPIco fromValue(String value) {
    for (FormDataFPIco b : FormDataFPIco.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPIco> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPIco enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPIco read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPIco.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPIco.fromValue(value);
  }
}
