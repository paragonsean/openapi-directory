 ...
 */
@JsonAdapter(FormDataFPFntype.Adapter.class)
public enum FormDataFPFntype {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPFntype> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPFntype enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPFntype read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPFntype.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPFntype.fromValue(value);
  }
}
