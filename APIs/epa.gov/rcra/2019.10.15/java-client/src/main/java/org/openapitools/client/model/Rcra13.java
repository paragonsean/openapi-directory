...
public class Rcra13 {
  ...
  private List<Rcra01> facilities = new ArrayList<>();
  ...
  public Rcra13 facilities(List<Rcra01> facilities) {
    this.facilities = facilities;
    return this;
  }

  public Rcra13 addFacilitiesItem(Rcra01 facilitiesItem) {
  ...
  public List<Rcra01> getFacilities() {
    return facilities;
  }

  public void setFacilities(List<Rcra01> facilities) {
    this.facilities = facilities;
  }


  public Rcra13 message(String message) {
  ...
  public Rcra13 pageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public Rcra13 queryID(String queryID) {
  ...
  public Rcra13 queryRows(String queryRows) {
  ...
  public boolean equals(Object o) {
    ...
    Rcra13 rcra13 = (Rcra13) o;
    return Objects.equals(this.facilities, rcra13.facilities) &&
        Objects.equals(this.message, rcra13.message) &&
        Objects.equals(this.pageNo, rcra13.pageNo) &&
        Objects.equals(this.queryID, rcra13.queryID) &&
        Objects.equals(this.queryRows, rcra13.queryRows);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rcra13
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rcra13.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rcra13 is not found in the empty JSON string", Rcra13.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rcra13.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rcra13` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rcra13.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayfacilities.size(); i++) {
        Rcra01.validateJsonElement(jsonArrayfacilities.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rcra13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rcra13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rcra13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rcra13.class));

       return (TypeAdapter<T>) new TypeAdapter<Rcra13>() {
           @Override
           public void write(JsonWriter out, Rcra13 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rcra13 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rcra13 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rcra13
   * @throws IOException if the JSON string is invalid with respect to Rcra13
   */
  public static Rcra13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rcra13.class);
  }

  /**
   * Convert an instance of Rcra13 to an JSON string
   *
   * @return JSON string
   */
