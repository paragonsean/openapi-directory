...
public class Rcra10 {
  ...
  private BigDecimal rcRADaysLastInspection;
  ...
  private BigDecimal rcRAInspCnt;
  ...
  private BigDecimal rcRAPenalties;
  ...
  private BigDecimal rcRAQtrsWithSNC;
  ...
  public Rcra10 aiRIDs(String aiRIDs) {
    this.aiRIDs = aiRIDs;
    return this;
  }
  ...
  public Rcra10 activeLower48(String activeLower48) {
  ...
  public Rcra10 cwAIDs(String cwAIDs) {
    this.cwAIDs = cwAIDs;
    return this;
  }
  ...
  public Rcra10 calculatedAccuracyMeters(BigDecimal calculatedAccuracyMeters) {
  ...
  public Rcra10 censusBlockGroup(String censusBlockGroup) {
  ...
  public Rcra10 chemNamesRelLand(String chemNamesRelLand) {
  ...
  public Rcra10 chesapeakeBayFlag(String chesapeakeBayFlag) {
  ...
  public Rcra10 cleanupActionFlag(String cleanupActionFlag) {
  ...
  public Rcra10 collectionMethod(String collectionMethod) {
  ...
  public Rcra10 currSvFlag(BigDecimal currSvFlag) {
  ...
  public Rcra10 currVioFlag(BigDecimal currVioFlag) {
  ...
  public Rcra10 currentVioCnt(String currentVioCnt) {
  ...
  public Rcra10 dateLastRecordReview(String dateLastRecordReview) {
  ...
  public Rcra10 epASystem(String epASystem) {
  ...
  public Rcra10 ea5yrFlag(BigDecimal ea5yrFlag) {
  ...
  public Rcra10 ejscreenFlag(String ejscreenFlag) {
  ...
  public Rcra10 ejscreenFlagUs(String ejscreenFlagUs) {
  ...
  public Rcra10 facCountyName(String facCountyName) {
  ...
  public Rcra10 facDerivedHuc(String facDerivedHuc) {
  ...
  public Rcra10 facDerivedTRIbes(String facDerivedTRIbes) {
  ...
  public Rcra10 facDerivedWBD(String facDerivedWBD) {
  ...
  public Rcra10 facDerivedWBDName(String facDerivedWBDName) {
  ...
  public Rcra10 facFIPSCode(String facFIPSCode) {
  ...
  public Rcra10 facFederalAgencyCode(String facFederalAgencyCode) {
  ...
  public Rcra10 facFederalAgencyName(String facFederalAgencyName) {
  ...
  public Rcra10 facIndianCntryFlg(String facIndianCntryFlg) {
  ...
  public Rcra10 facIndianSpatialFlg(String facIndianSpatialFlg) {
  ...
  public Rcra10 facMapFlg(String facMapFlg) {
  ...
  public Rcra10 facMapIcon(String facMapIcon) {
  ...
  public Rcra10 facPercentMinority(BigDecimal facPercentMinority) {
  ...
  public Rcra10 facPopulationDensity(BigDecimal facPopulationDensity) {
  ...
  public Rcra10 facSICCodes(String facSICCodes) {
  ...
  public Rcra10 facStdCountyName(String facStdCountyName) {
  ...
  public Rcra10 facTRILandReleases(String facTRILandReleases) {
  ...
  public Rcra10 facTRIOffSiteTransfers(String facTRIOffSiteTransfers) {
  ...
  public Rcra10 facTRIOnSiteReleases(String facTRIOnSiteReleases) {
  ...
  public Rcra10 facTRIReporter(String facTRIReporter) {
  ...
  public Rcra10 facUsMexBorderFlg(String facUsMexBorderFlg) {
  ...
  public Rcra10 infea5yrFlag(BigDecimal infea5yrFlag) {
  ...
  public Rcra10 insp5yrFlag(BigDecimal insp5yrFlag) {
  ...
  public Rcra10 lastViolationDate(String lastViolationDate) {
  ...
  public Rcra10 lower48(String lower48) {
  ...
  public Rcra10 maxPctileUs(BigDecimal maxPctileUs) {
  ...
  public Rcra10 maxScore(BigDecimal maxScore) {
  ...
  public Rcra10 operatorCode(String operatorCode) {
  ...
  public Rcra10 operatorDesc(String operatorDesc) {
  ...
  public Rcra10 over80CountUs(BigDecimal over80CountUs) {
  ...
  public Rcra10 ownerCode(String ownerCode) {
  ...
  public Rcra10 ownerDesc(String ownerDesc) {
  ...
  public Rcra10 pctileCancerUs(BigDecimal pctileCancerUs) {
  ...
  public Rcra10 pctileDpmUs(BigDecimal pctileDpmUs) {
  ...
  public Rcra10 pctileO3Us(BigDecimal pctileO3Us) {
  ...
  public Rcra10 pctilePctpre1960Us(BigDecimal pctilePctpre1960Us) {
  ...
  public Rcra10 pctilePmUs(BigDecimal pctilePmUs) {
  ...
  public Rcra10 pctileProximityNPDESUs(BigDecimal pctileProximityNPDESUs) {
  ...
  public Rcra10 pctileProximityNplUs(BigDecimal pctileProximityNplUs) {
  ...
  public Rcra10 pctileProximityRmpUs(BigDecimal pctileProximityRmpUs) {
  ...
  public Rcra10 pctileProximityTsdfUs(BigDecimal pctileProximityTsdfUs) {
  ...
  public Rcra10 pctileRespUs(BigDecimal pctileRespUs) {
  ...
  public Rcra10 pctileTrafficScoreUs(BigDecimal pctileTrafficScoreUs) {
  ...
  public Rcra10 rcRA3yrComplQtrsHistory(String rcRA3yrComplQtrsHistory) {
  ...
  public Rcra10 rcRACaseIDs(String rcRACaseIDs) {
  ...
  public Rcra10 rcRACity(String rcRACity) {
  ...
  public Rcra10 rcRAComplStatus(String rcRAComplStatus) {
  ...
  public Rcra10 rcRACounty(String rcRACounty) {
  ...
  public Rcra10 rcRADaysLastInspection(BigDecimal rcRADaysLastInspection) {
   ...
   */
  @javax.annotation.Nonnull
  public BigDecimal getRcRADaysLastInspection() {
    return rcRADaysLastInspection;
  }

  public void setRcRADaysLastInspection(BigDecimal rcRADaysLastInspection) {
    this.rcRADaysLastInspection = rcRADaysLastInspection;
  }


  public Rcra10 rcRAEPARegion(String rcRAEPARegion) {
  ...
  public Rcra10 rcRAFIPSCode(String rcRAFIPSCode) {
  ...
  public Rcra10 rcRAFeaCnt(BigDecimal rcRAFeaCnt) {
   ...
   */
  @javax.annotation.Nonnull
  public BigDecimal getRcRAFeaCnt() {
    return rcRAFeaCnt;
  }

  public void setRcRAFeaCnt(BigDecimal rcRAFeaCnt) {
    this.rcRAFeaCnt = rcRAFeaCnt;
  }


  public Rcra10 rcRAIDs(String rcRAIDs) {
  ...
  public Rcra10 rcRAIeaCnt(BigDecimal rcRAIeaCnt) {
   ...
   */
  @javax.annotation.Nonnull
  public BigDecimal getRcRAIeaCnt() {
    return rcRAIeaCnt;
  }

  public void setRcRAIeaCnt(BigDecimal rcRAIeaCnt) {
    this.rcRAIeaCnt = rcRAIeaCnt;
  }


  public Rcra10 rcRAImpWaterFlg(String rcRAImpWaterFlg) {
  ...
  public Rcra10 rcRAIndianCntryFlg(String rcRAIndianCntryFlg) {
  ...
  public Rcra10 rcRAInspCnt(BigDecimal rcRAInspCnt) {
   ...
   */
  @javax.annotation.Nonnull
  public BigDecimal getRcRAInspCnt() {
    return rcRAInspCnt;
  }

  public void setRcRAInspCnt(BigDecimal rcRAInspCnt) {
    this.rcRAInspCnt = rcRAInspCnt;
  }


  public Rcra10 rcRALandTypeCode(String rcRALandTypeCode) {
  ...
  public Rcra10 rcRALastFeaDate(String rcRALastFeaDate) {
  ...
  public Rcra10 rcRALastFeaDateEPA(String rcRALastFeaDateEPA) {
  ...
  public Rcra10 rcRALastFeaDateState(String rcRALastFeaDateState) {
  ...
  public Rcra10 rcRALastIeaDate(String rcRALastIeaDate) {
  ...
  public Rcra10 rcRALastIeaDateEPA(String rcRALastIeaDateEPA) {
  ...
  public Rcra10 rcRALastIeaDateState(String rcRALastIeaDateState) {
  ...
  public Rcra10 rcRALastInspDateEPA(String rcRALastInspDateEPA) {
  ...
  public Rcra10 rcRALastInspDateState(String rcRALastInspDateState) {
  ...
  public Rcra10 rcRALastInspectionDate(String rcRALastInspectionDate) {
  ...
  public Rcra10 rcRALastPenaltyDate(String rcRALastPenaltyDate) {
  ...
  public Rcra10 rcRAMapIcon(String rcRAMapIcon) {
  ...
  public Rcra10 RCRANAICS(String RCRANAICS) {
  ...
  public Rcra10 rcRAName(String rcRAName) {
  ...
  public Rcra10 rcRAOldestOpenVioDate(String rcRAOldestOpenVioDate) {
  ...
  public Rcra10 rcRAPenalties(BigDecimal rcRAPenalties) {
   ...
   */
  @javax.annotation.Nonnull
  public BigDecimal getRcRAPenalties() {
    return rcRAPenalties;
  }

  public void setRcRAPenalties(BigDecimal rcRAPenalties) {
    this.rcRAPenalties = rcRAPenalties;
  }


  public Rcra10 rcRAQtrsWithNC(BigDecimal rcRAQtrsWithNC) {
  ...
  public Rcra10 rcRAQtrsWithSNC(BigDecimal rcRAQtrsWithSNC) {
   ...
   */
  @javax.annotation.Nonnull
  public BigDecimal getRcRAQtrsWithSNC() {
    return rcRAQtrsWithSNC;
  }

  public void setRcRAQtrsWithSNC(BigDecimal rcRAQtrsWithSNC) {
    this.rcRAQtrsWithSNC = rcRAQtrsWithSNC;
  }


  public Rcra10 RCRASNC(String RCRASNC) {
  ...
  public Rcra10 rcRAState(String rcRAState) {
  ...
  public Rcra10 rcRAStateDistrict(String rcRAStateDistrict) {
  ...
  public Rcra10 rcRAStatus(String rcRAStatus) {
  ...
  public Rcra10 rcRAStreet(String rcRAStreet) {
  ...
  public Rcra10 rcRATRIbalLandCode(String rcRATRIbalLandCode) {
  ...
  public Rcra10 rcRAUniverse(String rcRAUniverse) {
  ...
  public Rcra10 rcRAViolationTypes(String rcRAViolationTypes) {
  ...
  public Rcra10 rcRAZip(String rcRAZip) {
  ...
  public Rcra10 rcRAinfoLandTypeCode(String rcRAinfoLandTypeCode) {
  ...
  public Rcra10 rcRAinfoLandTypeDesc(String rcRAinfoLandTypeDesc) {
  ...
  public Rcra10 referencePoint(String referencePoint) {
  ...
  public Rcra10 registryID(String registryID) {
  ...
  public Rcra10 rmpIDs(String rmpIDs) {
    this.rmpIDs = rmpIDs;
    return this;
  }
  ...
  public Rcra10 sdWAIDs(String sdWAIDs) {
  ...
  public Rcra10 score(BigDecimal score) {
    this.score = score;
    return this;
  }
  ...
  public Rcra10 semsIDs(String semsIDs) {
  ...
  public Rcra10 sourceID(String sourceID) {
  ...
  public Rcra10 statute(String statute) {
  ...
  public Rcra10 trIIDs(String trIIDs) {
    this.trIIDs = trIIDs;
    return this;
  }
  ...
  public Rcra10 trIbalFlag(BigDecimal trIbalFlag) {
  ...
  public Rcra10 tsdf(String tsdf) {
    this.tsdf = tsdf;
    return this;
  }
  ...
  public Rcra10 violFlag(BigDecimal violFlag) {
  ...
  public Rcra10 webDocs(String webDocs) {
  ...
  public boolean equals(Object o) {
    ...
    Rcra10 rcra10 = (Rcra10) o;
    return Objects.equals(this.aiRIDs, rcra10.aiRIDs) &&
        Objects.equals(this.activeLower48, rcra10.activeLower48) &&
        Objects.equals(this.cwAIDs, rcra10.cwAIDs) &&
        Objects.equals(this.calculatedAccuracyMeters, rcra10.calculatedAccuracyMeters) &&
        Objects.equals(this.censusBlockGroup, rcra10.censusBlockGroup) &&
        Objects.equals(this.chemNamesRelLand, rcra10.chemNamesRelLand) &&
        Objects.equals(this.chesapeakeBayFlag, rcra10.chesapeakeBayFlag) &&
        Objects.equals(this.cleanupActionFlag, rcra10.cleanupActionFlag) &&
        Objects.equals(this.collectionMethod, rcra10.collectionMethod) &&
        Objects.equals(this.currSvFlag, rcra10.currSvFlag) &&
        Objects.equals(this.currVioFlag, rcra10.currVioFlag) &&
        Objects.equals(this.currentVioCnt, rcra10.currentVioCnt) &&
        Objects.equals(this.dateLastRecordReview, rcra10.dateLastRecordReview) &&
        Objects.equals(this.epASystem, rcra10.epASystem) &&
        Objects.equals(this.ea5yrFlag, rcra10.ea5yrFlag) &&
        Objects.equals(this.ejscreenFlag, rcra10.ejscreenFlag) &&
        Objects.equals(this.ejscreenFlagUs, rcra10.ejscreenFlagUs) &&
        Objects.equals(this.facCountyName, rcra10.facCountyName) &&
        Objects.equals(this.facDerivedHuc, rcra10.facDerivedHuc) &&
        Objects.equals(this.facDerivedTRIbes, rcra10.facDerivedTRIbes) &&
        Objects.equals(this.facDerivedWBD, rcra10.facDerivedWBD) &&
        Objects.equals(this.facDerivedWBDName, rcra10.facDerivedWBDName) &&
        Objects.equals(this.facFIPSCode, rcra10.facFIPSCode) &&
        Objects.equals(this.facFederalAgencyCode, rcra10.facFederalAgencyCode) &&
        Objects.equals(this.facFederalAgencyName, rcra10.facFederalAgencyName) &&
        Objects.equals(this.facIndianCntryFlg, rcra10.facIndianCntryFlg) &&
        Objects.equals(this.facIndianSpatialFlg, rcra10.facIndianSpatialFlg) &&
        Objects.equals(this.facMapFlg, rcra10.facMapFlg) &&
        Objects.equals(this.facMapIcon, rcra10.facMapIcon) &&
        Objects.equals(this.facPercentMinority, rcra10.facPercentMinority) &&
        Objects.equals(this.facPopulationDensity, rcra10.facPopulationDensity) &&
        Objects.equals(this.facSICCodes, rcra10.facSICCodes) &&
        Objects.equals(this.facStdCountyName, rcra10.facStdCountyName) &&
        Objects.equals(this.facTRILandReleases, rcra10.facTRILandReleases) &&
        Objects.equals(this.facTRIOffSiteTransfers, rcra10.facTRIOffSiteTransfers) &&
        Objects.equals(this.facTRIOnSiteReleases, rcra10.facTRIOnSiteReleases) &&
        Objects.equals(this.facTRIReporter, rcra10.facTRIReporter) &&
        Objects.equals(this.facUsMexBorderFlg, rcra10.facUsMexBorderFlg) &&
        Objects.equals(this.infea5yrFlag, rcra10.infea5yrFlag) &&
        Objects.equals(this.insp5yrFlag, rcra10.insp5yrFlag) &&
        Objects.equals(this.lastViolationDate, rcra10.lastViolationDate) &&
        Objects.equals(this.lower48, rcra10.lower48) &&
        Objects.equals(this.map, rcra10.map) &&
        Objects.equals(this.maxPctileUs, rcra10.maxPctileUs) &&
        Objects.equals(this.maxScore, rcra10.maxScore) &&
        Objects.equals(this.operatorCode, rcra10.operatorCode) &&
        Objects.equals(this.operatorDesc, rcra10.operatorDesc) &&
        Objects.equals(this.over80CountUs, rcra10.over80CountUs) &&
        Objects.equals(this.ownerCode, rcra10.ownerCode) &&
        Objects.equals(this.ownerDesc, rcra10.ownerDesc) &&
        Objects.equals(this.pctileCancerUs, rcra10.pctileCancerUs) &&
        Objects.equals(this.pctileDpmUs, rcra10.pctileDpmUs) &&
        Objects.equals(this.pctileO3Us, rcra10.pctileO3Us) &&
        Objects.equals(this.pctilePctpre1960Us, rcra10.pctilePctpre1960Us) &&
        Objects.equals(this.pctilePmUs, rcra10.pctilePmUs) &&
        Objects.equals(this.pctileProximityNPDESUs, rcra10.pctileProximityNPDESUs) &&
        Objects.equals(this.pctileProximityNplUs, rcra10.pctileProximityNplUs) &&
        Objects.equals(this.pctileProximityRmpUs, rcra10.pctileProximityRmpUs) &&
        Objects.equals(this.pctileProximityTsdfUs, rcra10.pctileProximityTsdfUs) &&
        Objects.equals(this.pctileRespUs, rcra10.pctileRespUs) &&
        Objects.equals(this.pctileTrafficScoreUs, rcra10.pctileTrafficScoreUs) &&
        Objects.equals(this.rcRA3yrComplQtrsHistory, rcra10.rcRA3yrComplQtrsHistory) &&
        Objects.equals(this.rcRACaseIDs, rcra10.rcRACaseIDs) &&
        Objects.equals(this.rcRACity, rcra10.rcRACity) &&
        Objects.equals(this.rcRAComplStatus, rcra10.rcRAComplStatus) &&
        Objects.equals(this.rcRACounty, rcra10.rcRACounty) &&
        Objects.equals(this.rcRADaysLastInspection, rcra10.rcRADaysLastInspection) &&
        Objects.equals(this.rcRAEPARegion, rcra10.rcRAEPARegion) &&
        Objects.equals(this.rcRAFIPSCode, rcra10.rcRAFIPSCode) &&
        Objects.equals(this.rcRAFeaCnt, rcra10.rcRAFeaCnt) &&
        Objects.equals(this.rcRAIDs, rcra10.rcRAIDs) &&
        Objects.equals(this.rcRAIeaCnt, rcra10.rcRAIeaCnt) &&
        Objects.equals(this.rcRAImpWaterFlg, rcra10.rcRAImpWaterFlg) &&
        Objects.equals(this.rcRAIndianCntryFlg, rcra10.rcRAIndianCntryFlg) &&
        Objects.equals(this.rcRAInspCnt, rcra10.rcRAInspCnt) &&
        Objects.equals(this.rcRALandTypeCode, rcra10.rcRALandTypeCode) &&
        Objects.equals(this.rcRALastFeaDate, rcra10.rcRALastFeaDate) &&
        Objects.equals(this.rcRALastFeaDateEPA, rcra10.rcRALastFeaDateEPA) &&
        Objects.equals(this.rcRALastFeaDateState, rcra10.rcRALastFeaDateState) &&
        Objects.equals(this.rcRALastIeaDate, rcra10.rcRALastIeaDate) &&
        Objects.equals(this.rcRALastIeaDateEPA, rcra10.rcRALastIeaDateEPA) &&
        Objects.equals(this.rcRALastIeaDateState, rcra10.rcRALastIeaDateState) &&
        Objects.equals(this.rcRALastInspDateEPA, rcra10.rcRALastInspDateEPA) &&
        Objects.equals(this.rcRALastInspDateState, rcra10.rcRALastInspDateState) &&
        Objects.equals(this.rcRALastInspectionDate, rcra10.rcRALastInspectionDate) &&
        Objects.equals(this.rcRALastPenaltyDate, rcra10.rcRALastPenaltyDate) &&
        Objects.equals(this.rcRAMapIcon, rcra10.rcRAMapIcon) &&
        Objects.equals(this.RCRANAICS, rcra10.RCRANAICS) &&
        Objects.equals(this.rcRAName, rcra10.rcRAName) &&
        Objects.equals(this.rcRAOldestOpenVioDate, rcra10.rcRAOldestOpenVioDate) &&
        Objects.equals(this.rcRAPenalties, rcra10.rcRAPenalties) &&
        Objects.equals(this.rcRAQtrsWithNC, rcra10.rcRAQtrsWithNC) &&
        Objects.equals(this.rcRAQtrsWithSNC, rcra10.rcRAQtrsWithSNC) &&
        Objects.equals(this.RCRASNC, rcra10.RCRASNC) &&
        Objects.equals(this.rcRAState, rcra10.rcRAState) &&
        Objects.equals(this.rcRAStateDistrict, rcra10.rcRAStateDistrict) &&
        Objects.equals(this.rcRAStatus, rcra10.rcRAStatus) &&
        Objects.equals(this.rcRAStreet, rcra10.rcRAStreet) &&
        Objects.equals(this.rcRATRIbalLandCode, rcra10.rcRATRIbalLandCode) &&
        Objects.equals(this.rcRAUniverse, rcra10.rcRAUniverse) &&
        Objects.equals(this.rcRAViolationTypes, rcra10.rcRAViolationTypes) &&
        Objects.equals(this.rcRAZip, rcra10.rcRAZip) &&
        Objects.equals(this.rcRAinfoLandTypeCode, rcra10.rcRAinfoLandTypeCode) &&
        Objects.equals(this.rcRAinfoLandTypeDesc, rcra10.rcRAinfoLandTypeDesc) &&
        Objects.equals(this.referencePoint, rcra10.referencePoint) &&
        Objects.equals(this.registryID, rcra10.registryID) &&
        Objects.equals(this.rmpIDs, rcra10.rmpIDs) &&
        Objects.equals(this.sdWAIDs, rcra10.sdWAIDs) &&
        Objects.equals(this.score, rcra10.score) &&
        Objects.equals(this.semsIDs, rcra10.semsIDs) &&
        Objects.equals(this.sourceID, rcra10.sourceID) &&
        Objects.equals(this.statute, rcra10.statute) &&
        Objects.equals(this.trIIDs, rcra10.trIIDs) &&
        Objects.equals(this.trIbalFlag, rcra10.trIbalFlag) &&
        Objects.equals(this.tsdf, rcra10.tsdf) &&
        Objects.equals(this.violFlag, rcra10.violFlag) &&
        Objects.equals(this.webDocs, rcra10.webDocs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aiRIDs, activeLower48, cwAIDs, calculatedAccuracyMeters, censusBlockGroup, chemNamesRelLand, chesapeakeBayFlag, cleanupActionFlag, collectionMethod, currSvFlag, currVioFlag, currentVioCnt, dateLastRecordReview, epASystem, ea5yrFlag, ejscreenFlag, ejscreenFlagUs, facCountyName, facDerivedHuc, facDerivedTRIbes, facDerivedWBD, facDerivedWBDName, facFIPSCode, facFederalAgencyCode, facFederalAgencyName, facIndianCntryFlg, facIndianSpatialFlg, facMapFlg, facMapIcon, facPercentMinority, facPopulationDensity, facSICCodes, facStdCountyName, facTRILandReleases, facTRIOffSiteTransfers, facTRIOnSiteReleases, facTRIReporter, facUsMexBorderFlg, infea5yrFlag, insp5yrFlag, lastViolationDate, lower48, map, maxPctileUs, maxScore, operatorCode, operatorDesc, over80CountUs, ownerCode, ownerDesc, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rcRA3yrComplQtrsHistory, rcRACaseIDs, rcRACity, rcRAComplStatus, rcRACounty, rcRADaysLastInspection, rcRAEPARegion, rcRAFIPSCode, rcRAFeaCnt, rcRAIDs, rcRAIeaCnt, rcRAImpWaterFlg, rcRAIndianCntryFlg, rcRAInspCnt, rcRALandTypeCode, rcRALastFeaDate, rcRALastFeaDateEPA, rcRALastFeaDateState, rcRALastIeaDate, rcRALastIeaDateEPA, rcRALastIeaDateState, rcRALastInspDateEPA, rcRALastInspDateState, rcRALastInspectionDate, rcRALastPenaltyDate, rcRAMapIcon, RCRANAICS, rcRAName, rcRAOldestOpenVioDate, rcRAPenalties, rcRAQtrsWithNC, rcRAQtrsWithSNC, RCRASNC, rcRAState, rcRAStateDistrict, rcRAStatus, rcRAStreet, rcRATRIbalLandCode, rcRAUniverse, rcRAViolationTypes, rcRAZip, rcRAinfoLandTypeCode, rcRAinfoLandTypeDesc, referencePoint, registryID, rmpIDs, sdWAIDs, score, semsIDs, sourceID, statute, trIIDs, trIbalFlag, tsdf, violFlag, webDocs);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Rcra10 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Rcra10
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Rcra10.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Rcra10 is not found in the empty JSON string", Rcra10.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Rcra10.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Rcra10` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Rcra10.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Rcra10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Rcra10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Rcra10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Rcra10.class));

       return (TypeAdapter<T>) new TypeAdapter<Rcra10>() {
           @Override
           public void write(JsonWriter out, Rcra10 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Rcra10 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Rcra10 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Rcra10
   * @throws IOException if the JSON string is invalid with respect to Rcra10
   */
  public static Rcra10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Rcra10.class);
  }

  /**
   * Convert an instance of Rcra10 to an JSON string
   *
   * @return JSON string
   */
