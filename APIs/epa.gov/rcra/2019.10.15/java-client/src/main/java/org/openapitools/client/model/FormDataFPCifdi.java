 ...
 */
@JsonAdapter(FormDataFPCifdi.Adapter.class)
public enum FormDataFPCifdi {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPCifdi> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPCifdi enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPCifdi read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPCifdi.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPCifdi.fromValue(value);
  }
}
