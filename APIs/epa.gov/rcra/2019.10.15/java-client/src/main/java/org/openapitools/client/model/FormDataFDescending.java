 ...
 */
@JsonAdapter(FormDataFDescending.Adapter.class)
public enum FormDataFDescending {
  ...
  FormDataFDescending(String value) {
    this.value = value;
  }
  ...
  public static FormDataFDescending fromValue(String value) {
    for (FormDataFDescending b : FormDataFDescending.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFDescending> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFDescending enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFDescending read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFDescending.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFDescending.fromValue(value);
  }
}
