 ...
 */
@JsonAdapter(FormDataFPYsly.Adapter.class)
public enum FormDataFPYsly {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPYsly> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPYsly enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPYsly read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPYsly.fromValue(new BigDecimal(value));
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPYsly.fromValue(new BigDecimal(value));
  }
}
