 ...
 */
@JsonAdapter(FormDataFTablelist.Adapter.class)
public enum FormDataFTablelist {
  ...
  FormDataFTablelist(String value) {
    this.value = value;
  }
  ...
  public static FormDataFTablelist fromValue(String value) {
    for (FormDataFTablelist b : FormDataFTablelist.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFTablelist> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFTablelist enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFTablelist read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFTablelist.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFTablelist.fromValue(value);
  }
}
