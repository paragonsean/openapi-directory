...
import org.openapitools.client.model.Echo01;
...
public class Echo02 {
  ...
  private List<Echo01> mapData = new ArrayList<>();
  ...
  public Echo02 iconBaseURL(String iconBaseURL) {
  ...
  public Echo02 mapData(List<Echo01> mapData) {
    this.mapData = mapData;
    return this;
  }

  public Echo02 addMapDataItem(Echo01 mapDataItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<Echo01> getMapData() {
    return mapData;
  }

  public void setMapData(List<Echo01> mapData) {
    this.mapData = mapData;
  }


  public Echo02 popUpBaseURL(String popUpBaseURL) {
  ...
  public Echo02 queryID(String queryID) {
  ...
  public boolean equals(Object o) {
    ...
    Echo02 echo02 = (Echo02) o;
    return Objects.equals(this.iconBaseURL, echo02.iconBaseURL) &&
        Objects.equals(this.mapData, echo02.mapData) &&
        Objects.equals(this.popUpBaseURL, echo02.popUpBaseURL) &&
        Objects.equals(this.queryID, echo02.queryID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Echo02
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Echo02.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Echo02 is not found in the empty JSON string", Echo02.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Echo02.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Echo02` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Echo02.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraymapData.size(); i++) {
        Echo01.validateJsonElement(jsonArraymapData.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Echo02.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Echo02' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Echo02> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Echo02.class));

       return (TypeAdapter<T>) new TypeAdapter<Echo02>() {
           @Override
           public void write(JsonWriter out, Echo02 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Echo02 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Echo02 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Echo02
   * @throws IOException if the JSON string is invalid with respect to Echo02
   */
  public static Echo02 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Echo02.class);
  }

  /**
   * Convert an instance of Echo02 to an JSON string
   *
   * @return JSON string
   */
