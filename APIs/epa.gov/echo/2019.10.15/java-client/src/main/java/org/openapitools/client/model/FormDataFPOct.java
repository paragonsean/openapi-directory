...
public enum FormDataFPOct {
  ...
  public static FormDataFPOct fromValue(String value) {
    for (FormDataFPOct b : FormDataFPOct.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPOct> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPOct enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPOct read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPOct.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPOct.fromValue(value);
  }
}
