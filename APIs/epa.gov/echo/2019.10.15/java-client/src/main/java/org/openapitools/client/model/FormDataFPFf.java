 ...
 */
@JsonAdapter(FormDataFPFf.Adapter.class)
public enum FormDataFPFf {
  
  Y("Y");

  private String value;

  FormDataFPFf(String value) {
    this.value = value;
  }
  ...
  public static FormDataFPFf fromValue(String value) {
    for (FormDataFPFf b : FormDataFPFf.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPFf> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPFf enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPFf read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPFf.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPFf.fromValue(value);
  }
}
