...
public class Echo11 {
  ...
  public Echo11 facilities(List<Echo03> facilities) {
    this.facilities = facilities;
    return this;
  }

  public Echo11 addFacilitiesItem(Echo03 facilitiesItem) {
  ...
  public Echo11 message(String message) {
  ...
  public Echo11 pageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public Echo11 queryID(String queryID) {
  ...
  public Echo11 queryRows(String queryRows) {
  ...
  public boolean equals(Object o) {
    ...
    Echo11 echo11 = (Echo11) o;
    return Objects.equals(this.facilities, echo11.facilities) &&
        Objects.equals(this.message, echo11.message) &&
        Objects.equals(this.pageNo, echo11.pageNo) &&
        Objects.equals(this.queryID, echo11.queryID) &&
        Objects.equals(this.queryRows, echo11.queryRows);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Echo11
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Echo11.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Echo11 is not found in the empty JSON string", Echo11.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Echo11.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Echo11` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Echo11.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Echo11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Echo11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Echo11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Echo11.class));

       return (TypeAdapter<T>) new TypeAdapter<Echo11>() {
           @Override
           public void write(JsonWriter out, Echo11 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Echo11 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Echo11 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Echo11
   * @throws IOException if the JSON string is invalid with respect to Echo11
   */
  public static Echo11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Echo11.class);
  }

  /**
   * Convert an instance of Echo11 to an JSON string
   *
   * @return JSON string
   */
