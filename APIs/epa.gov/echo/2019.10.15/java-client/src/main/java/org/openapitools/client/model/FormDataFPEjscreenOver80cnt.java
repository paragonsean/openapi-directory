 ...
 */
@JsonAdapter(FormDataFPEjscreenOver80cnt.Adapter.class)
public enum FormDataFPEjscreenOver80cnt {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPEjscreenOver80cnt> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPEjscreenOver80cnt enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPEjscreenOver80cnt read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPEjscreenOver80cnt.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPEjscreenOver80cnt.fromValue(value);
  }
}
