 ...
 */
@JsonAdapter(FormDataFPIeay.Adapter.class)
public enum FormDataFPIeay {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPIeay> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPIeay enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPIeay read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPIeay.fromValue(new BigDecimal(value));
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPIeay.fromValue(new BigDecimal(value));
  }
}
