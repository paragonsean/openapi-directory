 ...
 */
@JsonAdapter(FormDataFMaplist.Adapter.class)
public enum FormDataFMaplist {
  ...
  public static FormDataFMaplist fromValue(String value) {
    for (FormDataFMaplist b : FormDataFMaplist.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFMaplist> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFMaplist enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFMaplist read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFMaplist.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFMaplist.fromValue(value);
  }
}
