 ...
 */
@JsonAdapter(FormDataFPFeaa.Adapter.class)
public enum FormDataFPFeaa {
  ...
  public static FormDataFPFeaa fromValue(String value) {
    for (FormDataFPFeaa b : FormDataFPFeaa.values()) {
  ...
  public static class Adapter extends TypeAdapter<FormDataFPFeaa> {
    @Override
    public void write(final JsonWriter jsonWriter, final FormDataFPFeaa enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FormDataFPFeaa read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FormDataFPFeaa.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FormDataFPFeaa.fromValue(value);
  }
}
