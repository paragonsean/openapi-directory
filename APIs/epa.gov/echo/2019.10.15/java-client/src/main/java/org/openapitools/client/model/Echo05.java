...
public class Echo05 {
  ...
  public Echo05 cvRows(String cvRows) {
    this.cvRows = cvRows;
    return this;
  }
  ...
  public Echo05 clusterCount(String clusterCount) {
  ...
  public Echo05 clusterIcon(String clusterIcon) {
  ...
  public Echo05 clusterLatitude(String clusterLatitude) {
  ...
  public Echo05 clusterLongitude(String clusterLongitude) {
  ...
  public Echo05 clusterName(String clusterName) {
  ...
  public Echo05 clusterType(String clusterType) {
  ...
  public Echo05 clusterValue(String clusterValue) {
  ...
  public Echo05 epARegionCode(String epARegionCode) {
  ...
  public Echo05 feARows(String feARows) {
  ...
  public Echo05 inSPRows(String inSPRows) {
  ...
  public Echo05 indianCountryRows(String indianCountryRows) {
  ...
  public Echo05 infFEARows(String infFEARows) {
  ...
  public Echo05 objectId(String objectId) {
  ...
  public Echo05 svRows(String svRows) {
    this.svRows = svRows;
    return this;
  }
  ...
  public Echo05 totalPenalties(String totalPenalties) {
  ...
  public Echo05 v3Rows(String v3Rows) {
    this.v3Rows = v3Rows;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Echo05 echo05 = (Echo05) o;
    return Objects.equals(this.cvRows, echo05.cvRows) &&
        Objects.equals(this.clusterCount, echo05.clusterCount) &&
        Objects.equals(this.clusterIcon, echo05.clusterIcon) &&
        Objects.equals(this.clusterLatitude, echo05.clusterLatitude) &&
        Objects.equals(this.clusterLongitude, echo05.clusterLongitude) &&
        Objects.equals(this.clusterName, echo05.clusterName) &&
        Objects.equals(this.clusterType, echo05.clusterType) &&
        Objects.equals(this.clusterValue, echo05.clusterValue) &&
        Objects.equals(this.epARegionCode, echo05.epARegionCode) &&
        Objects.equals(this.feARows, echo05.feARows) &&
        Objects.equals(this.inSPRows, echo05.inSPRows) &&
        Objects.equals(this.indianCountryRows, echo05.indianCountryRows) &&
        Objects.equals(this.infFEARows, echo05.infFEARows) &&
        Objects.equals(this.objectId, echo05.objectId) &&
        Objects.equals(this.svRows, echo05.svRows) &&
        Objects.equals(this.totalPenalties, echo05.totalPenalties) &&
        Objects.equals(this.v3Rows, echo05.v3Rows);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Echo05
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Echo05.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Echo05 is not found in the empty JSON string", Echo05.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Echo05.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Echo05` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Echo05.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Echo05.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Echo05' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Echo05> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Echo05.class));

       return (TypeAdapter<T>) new TypeAdapter<Echo05>() {
           @Override
           public void write(JsonWriter out, Echo05 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Echo05 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Echo05 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Echo05
   * @throws IOException if the JSON string is invalid with respect to Echo05
   */
  public static Echo05 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Echo05.class);
  }

  /**
   * Convert an instance of Echo05 to an JSON string
   *
   * @return JSON string
   */
