...
|**caADaysLastEvaluation** | **BigDecimal** |  |  |
...
|**cwA13qtrsEfflntExceedances** | **BigDecimal** | The number of effluent violations at the facility in the past 13 quarters. |  |
...
|**cwADaysLastInspection** | **BigDecimal** |  |  |
...
|**cwAInformalCount** | **BigDecimal** | Indicates the number of informal enforcement actions/notices of violations (NOVs) taken against the facility within the last five years under the Clean Water Act. |  |
|**cwAInspectionCount** | **BigDecimal** | The number of inspections/compliance evaluations under the Clean Water Act, occurring at the facility within the last five years. |  |
...
|**currSvFlag** | **BigDecimal** | Indicates if the facility has a current significant violation. 1 &#x3D; Yes |  |
|**currVioFlag** | **BigDecimal** | Indicates if the facility has a current violation. 1 &#x3D; Yes |  |
|**dfrUrl** | **String** | The URL to the facility&#39;s Detailed Facility Report. |  |
|**ea5yrFlag** | **BigDecimal** | Indicates if the facility has a formal enforcement action within the last 5 years. 1 &#x3D; Yes |  |
...
|**facDaysLastInspection** | **BigDecimal** | The number of days from the last ECHO refresh to the date on which the most recent inspection of the facility took place based on data recorded into AFS, ICIS-NPDES, or RCRA Info. |  |
...
|**facFormalActionCount** | **BigDecimal** | Indicates the total number of enforcement actions taken against the facility within the last five years. NA indicates that this measure is not applicable for facilities with no associated CAA, CWA, or RCRA permits |  |
...
|**facInformalCount** | **BigDecimal** | Indicates the total number of informal enforcement actions/notices of violations (NOVs) taken against the facility within the last five years |  |
|**facInspectionCount** | **BigDecimal** | The number of inspections/compliance evaluations that have occurred at the facility, under the AIR, CWA, and RCRA, within the last five years. The last 5 years will include data from the 20 most recently completed quarters, plus data from the current quarter up until the refresh date. This count only includes inspection types that are counted as inspections in official counts. |  |
|**facLastPenaltyAmt** | **BigDecimal** | Indicates the dollar amount of the most recent assessed (or final) penalty taken against the facility. |  |
...
|**facPenaltyCount** | **BigDecimal** | The total number of penalties assessed (or final) taken against the facility within the last five years |  |
|**facPercentMinority** | **BigDecimal** | Percent Minority is the percentage of the population of the given area that is considered minority. Statistics are shown for the area within a 3-mile radius of each facility. |  |
|**facPopDen** | **BigDecimal** | The number of persons per square mile in the area being profiled. This field is the ratio of total persons (displayed in the Total Persons field) to total land area (displayed in the Land Area field). |  |
|**facProgramsWithSNC** | **BigDecimal** |  |  |
|**facQtrsWithNC** | **BigDecimal** |  |  |
...
|**facTotalPenalties** | **BigDecimal** | The total dollar amount of either assessed (or final) penalties taken against the facility within the last five years |  |
...
|**fecNumberOfCases** | **BigDecimal** |  |  |
|**fecTotalPenalties** | **BigDecimal** |  |  |
...
|**hasPollRpt** | **String** | ??? |  |
|**infea5yrFlag** | **BigDecimal** | Indicates if the facility has an informal enforcement action within the last 5 years. 1 &#x3D; Yes. |  |
|**insp5yrFlag** | **BigDecimal** | Indicates if the facility has an inspection within the last 5 years. 1 &#x3D; Yes |  |
|**lower48** | **String** | Flag showing Y/N whether location is within the contiguous (lower 48) United States. |  |
|**maxPctileUs** | **BigDecimal** | The maximum percentile from all individual EJSCREEN indicators. |  |
|**maxScore** | **BigDecimal** | [Col. 121] |  |
...
|**over80CountUs** | **BigDecimal** | The number of primary EJSCREEN environmental justice (EJ) indexes exceeding the 80th or higher national percentile for the Census block group that the facility is located in. |  |
|**pctileCancerUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN NATA air toxics cancer risk indicator. |  |
|**pctileDpmUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN diesel particulate matter indicator. |  |
|**pctileO3Us** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN ozone indicator. |  |
|**pctilePctpre1960Us** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN Lead paint indicator. |  |
|**pctilePmUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN particulate matter indicator. |  |
|**pctileProximityNPDESUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN proximity to major direct water dischargers indicator. |  |
|**pctileProximityNplUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN proximity to National Priorities List (NPL) sites indicator. |  |
|**pctileProximityRmpUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN proximity to Risk Management Plan (RMP) sites indicator. |  |
|**pctileProximityTsdfUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN proximity to Treatment Storage and Disposal Facilities (TSDFs) indicator. |  |
|**pctileRespUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN NATA respiratory hazard index indicator. |  |
|**pctileTrafficScoreUs** | **BigDecimal** | The national percentile of the census block group for the EJSCREEN Traffic proximity and volume indicator. |  |
...
|**rcRADaysLastEvaluation** | **BigDecimal** |  |  |
...
|**rcRAInspectionCount** | **BigDecimal** | The number of inspections/compliance evaluations under the Resource Conservation and Recovery Act, occurring at the facility within the last five years |  |
...
|**trIOffSiteTransfers** | **BigDecimal** |  |  |
|**trIOnSiteReleases** | **BigDecimal** |  |  |
|**trIReleasesTransfers** | **BigDecimal** | Total chemical releases, in pounds, as reported to the Toxics Release Inventory (TRI) by the facility for the most recent reporting year |  |
...
|**trIbalFlag** | **BigDecimal** | A value of \&quot;1\&quot; indicates that the facility is within an Indian Tribal or Alaskan Native Village area. |  |
...
|**violFlag** | **BigDecimal** | Indicates if the facility had a violation within the last 3 years. 1 &#x3D; Yes |  |
