...
#include <iostream>
#include "../client/OAIFacilityInfoApi.h"
...
void Example::exampleFunction1(){
     OAIFacilityInfoApi apiInstance;
     
      QEventLoop loop;
      connect(&apiInstance, &OAIFacilityInfoApi::echoRestServicesGetDownloadGetSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIFacilityInfoApi::echoRestServicesGetDownloadGetSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      apiInstance.echoRestServicesGetDownloadGet(qidoutputqcolumnsp_pretty_print);
