...
OAIEcho09::OAIEcho09(QString json) {
...
void OAIEcho09::initializeModel() {
...
void OAIEcho09::fromJson(QString jsonString) {
...
void OAIEcho09::fromJsonObject(QJsonObject json) {
...
QString OAIEcho09::asJson() const {
...
QJsonObject OAIEcho09::asJsonObject() const {
    QJsonObject obj;
    if (m_geometry.isSet()) {
...
OAIGeo OAIEcho09::getGeometry() const {
    return m_geometry;
}
void OAIEcho09::setGeometry(const OAIGeo &geometry) {
    m_geometry = geometry;
    m_geometry_isSet = true;
}

bool OAIEcho09::is_geometry_Set() const{
    return m_geometry_isSet;
}

bool OAIEcho09::is_geometry_Valid() const{
    return m_geometry_isValid;
}

OAIEcho10 OAIEcho09::getProperties() const {
    return m_properties;
}
void OAIEcho09::setProperties(const OAIEcho10 &properties) {
    m_properties = properties;
    m_properties_isSet = true;
}

bool OAIEcho09::is_properties_Set() const{
    return m_properties_isSet;
}

bool OAIEcho09::is_properties_Valid() const{
    return m_properties_isValid;
}

QString OAIEcho09::getType() const {
    return m_type;
}
void OAIEcho09::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEcho09::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEcho09::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIEcho09::isSet() const {
