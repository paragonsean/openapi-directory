...
#ifndef OAIFormData_f_p_impw_H
#define OAIFormData_f_p_impw_H
...
class OAIFormData_f_p_impw : public OAIEnum {
public:
    OAIFormData_f_p_impw();
    OAIFormData_f_p_impw(QString json);
    ~OAIFormData_f_p_impw() override;
    ...
    enum class eOAIFormData_f_p_impw {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_impw::eOAIFormData_f_p_impw getValue() const;
    void setValue(const OAIFormData_f_p_impw::eOAIFormData_f_p_impw& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_impw)

#endif // OAIFormData_f_p_impw_H
