...
class OAIFormData_f_p_ysly : public OAIEnum {
public:
    OAIFormData_f_p_ysly();
    OAIFormData_f_p_ysly(QString json);
    ~OAIFormData_f_p_ysly() override;
    ...
    enum class eOAIFormData_f_p_ysly : int {
    ...
    OAIFormData_f_p_ysly::eOAIFormData_f_p_ysly getValue() const;
    void setValue(const OAIFormData_f_p_ysly::eOAIFormData_f_p_ysly& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_ysly)

#endif // OAIFormData_f_p_ysly_H
