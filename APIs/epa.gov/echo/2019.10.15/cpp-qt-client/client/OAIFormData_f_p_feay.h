...
#ifndef OAIFormData_f_p_feay_H
#define OAIFormData_f_p_feay_H
...
class OAIFormData_f_p_feay : public OAIEnum {
public:
    OAIFormData_f_p_feay();
    OAIFormData_f_p_feay(QString json);
    ~OAIFormData_f_p_feay() override;
    ...
    enum class eOAIFormData_f_p_feay : int {
    ...
    OAIFormData_f_p_feay::eOAIFormData_f_p_feay getValue() const;
    void setValue(const OAIFormData_f_p_feay::eOAIFormData_f_p_feay& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_feay)

#endif // OAIFormData_f_p_feay_H
