...
class OAIEcho01 : public OAIObject {
public:
    OAIEcho01();
    OAIEcho01(QString json);
    ~OAIEcho01() override;
    ...
    QString getSdwAstatus() const;
    void setSdwAstatus(const QString &sdw_astatus);
    bool is_sdw_astatus_Set() const;
    bool is_sdw_astatus_Valid() const;
...
private:
    ...
    QString m_sdw_astatus;
    bool m_sdw_astatus_isSet;
    bool m_sdw_astatus_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcho01)
