...
#ifndef OAIFormData_f_p_iea_H
#define OAIFormData_f_p_iea_H
...
class OAIFormData_f_p_iea : public OAIEnum {
public:
    OAIFormData_f_p_iea();
    OAIFormData_f_p_iea(QString json);
    ~OAIFormData_f_p_iea() override;
    ...
    enum class eOAIFormData_f_p_iea {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        W, 
        N
    };
    OAIFormData_f_p_iea::eOAIFormData_f_p_iea getValue() const;
    void setValue(const OAIFormData_f_p_iea::eOAIFormData_f_p_iea& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_iea)

#endif // OAIFormData_f_p_iea_H
