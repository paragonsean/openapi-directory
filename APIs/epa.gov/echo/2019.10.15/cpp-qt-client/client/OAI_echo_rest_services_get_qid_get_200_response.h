...
/*
 * OAI_echo_rest_services_get_qid_get_200_response.h
 *
 * Root Object
 */

#ifndef OAI_echo_rest_services_get_qid_get_200_response_H
#define OAI_echo_rest_services_get_qid_get_200_response_H
...
class OAI_echo_rest_services_get_qid_get_200_response : public OAIObject {
public:
    OAI_echo_rest_services_get_qid_get_200_response();
    OAI_echo_rest_services_get_qid_get_200_response(QString json);
    ~OAI_echo_rest_services_get_qid_get_200_response() override;
    ...
    OAIEcho11 getResults() const;
    void setResults(const OAIEcho11 &results);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_echo_rest_services_get_qid_get_200_response)

#endif // OAI_echo_rest_services_get_qid_get_200_response_H
