...
class OAIFormData_f_p_usmex : public OAIEnum {
public:
    OAIFormData_f_p_usmex();
    OAIFormData_f_p_usmex(QString json);
    ~OAIFormData_f_p_usmex() override;
    ...
    enum class eOAIFormData_f_p_usmex {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_p_usmex::eOAIFormData_f_p_usmex getValue() const;
    void setValue(const OAIFormData_f_p_usmex::eOAIFormData_f_p_usmex& value);
...
private:
    ...
    eOAIFormData_f_p_usmex m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_usmex)

#endif // OAIFormData_f_p_usmex_H
