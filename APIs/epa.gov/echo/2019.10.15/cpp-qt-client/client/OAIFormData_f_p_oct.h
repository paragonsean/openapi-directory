...
#ifndef OAIFormData_f_p_oct_H
#define OAIFormData_f_p_oct_H
...
class OAIFormData_f_p_oct : public OAIEnum {
public:
    OAIFormData_f_p_oct();
    OAIFormData_f_p_oct(QString json);
    ~OAIFormData_f_p_oct() override;
    ...
    enum class eOAIFormData_f_p_oct {
    ...
    OAIFormData_f_p_oct::eOAIFormData_f_p_oct getValue() const;
    void setValue(const OAIFormData_f_p_oct::eOAIFormData_f_p_oct& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_oct)

#endif // OAIFormData_f_p_oct_H
