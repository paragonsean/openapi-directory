...
class OAIFormData_f_p_reg : public OAIEnum {
public:
    OAIFormData_f_p_reg();
    OAIFormData_f_p_reg(QString json);
    ~OAIFormData_f_p_reg() override;
    ...
    enum class eOAIFormData_f_p_reg {
    ...
    OAIFormData_f_p_reg::eOAIFormData_f_p_reg getValue() const;
    void setValue(const OAIFormData_f_p_reg::eOAIFormData_f_p_reg& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_p_reg)

#endif // OAIFormData_f_p_reg_H
