...
/*
 * OAIFormData_f_summarylist.h
 *
 * Summary List Flag.  Enter a Y to return a list of summary statistics based on the parameters submitted to the query service.
 */

#ifndef OAIFormData_f_summarylist_H
#define OAIFormData_f_summarylist_H
...
class OAIFormData_f_summarylist : public OAIEnum {
public:
    OAIFormData_f_summarylist();
    OAIFormData_f_summarylist(QString json);
    ~OAIFormData_f_summarylist() override;
    ...
    enum class eOAIFormData_f_summarylist {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        Y, 
        N
    };
    OAIFormData_f_summarylist::eOAIFormData_f_summarylist getValue() const;
    void setValue(const OAIFormData_f_summarylist::eOAIFormData_f_summarylist& value);
...
private:
    ...
    eOAIFormData_f_summarylist m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFormData_f_summarylist)

#endif // OAIFormData_f_summarylist_H
