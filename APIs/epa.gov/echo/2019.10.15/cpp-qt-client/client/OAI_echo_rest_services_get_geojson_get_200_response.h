...
/*
 * OAI_echo_rest_services_get_geojson_get_200_response.h
 *
 * GeoJSON Feature Collection Object
 */

#ifndef OAI_echo_rest_services_get_geojson_get_200_response_H
#define OAI_echo_rest_services_get_geojson_get_200_response_H
...
class OAI_echo_rest_services_get_geojson_get_200_response : public OAIObject {
public:
    OAI_echo_rest_services_get_geojson_get_200_response();
    OAI_echo_rest_services_get_geojson_get_200_response(QString json);
    ~OAI_echo_rest_services_get_geojson_get_200_response() override;
    ...
    QList<OAIEcho09> getFeatures() const;
    void setFeatures(const QList<OAIEcho09> &features);
...
Q_DECLARE_METATYPE(OpenAPI::OAI_echo_rest_services_get_geojson_get_200_response)

#endif // OAI_echo_rest_services_get_geojson_get_200_response_H
