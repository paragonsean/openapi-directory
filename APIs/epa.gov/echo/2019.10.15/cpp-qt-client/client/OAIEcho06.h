...
class OAIEcho06 : public OAIObject {
public:
    OAIEcho06();
    OAIEcho06(QString json);
    ~OAIEcho06() override;
    ...
    QList<OAIEcho05> getClusterData() const;
    void setClusterData(const QList<OAIEcho05> &cluster_data);
...
private:
    ...
    QList<OAIEcho05> m_cluster_data;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcho06)
