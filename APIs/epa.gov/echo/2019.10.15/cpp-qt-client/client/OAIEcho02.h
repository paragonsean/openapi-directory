...
class OAIEcho02 : public OAIObject {
public:
    OAIEcho02();
    OAIEcho02(QString json);
    ~OAIEcho02() override;
    ...
    QList<OAIEcho01> getMapData() const;
    void setMapData(const QList<OAIEcho01> &map_data);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcho02)
