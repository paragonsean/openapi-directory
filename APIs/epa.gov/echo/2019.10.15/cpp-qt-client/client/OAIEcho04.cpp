...
OAIEcho04::OAIEcho04(QString json) {
...
void OAIEcho04::initializeModel() {
...
void OAIEcho04::fromJson(QString jsonString) {
...
void OAIEcho04::fromJsonObject(QJsonObject json) {
...
QString OAIEcho04::asJson() const {
...
QJsonObject OAIEcho04::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEcho04::getBadSystemIds() const {
    return m_bad_system_ids;
}
void OAIEcho04::setBadSystemIds(const QString &bad_system_ids) {
    m_bad_system_ids = bad_system_ids;
    m_bad_system_ids_isSet = true;
}

bool OAIEcho04::is_bad_system_ids_Set() const{
    return m_bad_system_ids_isSet;
}

bool OAIEcho04::is_bad_system_ids_Valid() const{
    return m_bad_system_ids_isValid;
}

QString OAIEcho04::getCaaRows() const {
    return m_caa_rows;
}
void OAIEcho04::setCaaRows(const QString &caa_rows) {
    m_caa_rows = caa_rows;
    m_caa_rows_isSet = true;
}

bool OAIEcho04::is_caa_rows_Set() const{
    return m_caa_rows_isSet;
}

bool OAIEcho04::is_caa_rows_Valid() const{
    return m_caa_rows_isValid;
}

QString OAIEcho04::getCvRows() const {
    return m_cv_rows;
}
void OAIEcho04::setCvRows(const QString &cv_rows) {
    m_cv_rows = cv_rows;
    m_cv_rows_isSet = true;
}

bool OAIEcho04::is_cv_rows_Set() const{
    return m_cv_rows_isSet;
}

bool OAIEcho04::is_cv_rows_Valid() const{
    return m_cv_rows_isValid;
}

QString OAIEcho04::getCwaRows() const {
    return m_cwa_rows;
}
void OAIEcho04::setCwaRows(const QString &cwa_rows) {
    m_cwa_rows = cwa_rows;
    m_cwa_rows_isSet = true;
}

bool OAIEcho04::is_cwa_rows_Set() const{
    return m_cwa_rows_isSet;
}

bool OAIEcho04::is_cwa_rows_Valid() const{
    return m_cwa_rows_isValid;
}

QString OAIEcho04::getFeaRows() const {
    return m_fea_rows;
}
void OAIEcho04::setFeaRows(const QString &fea_rows) {
    m_fea_rows = fea_rows;
    m_fea_rows_isSet = true;
}

bool OAIEcho04::is_fea_rows_Set() const{
    return m_fea_rows_isSet;
}

bool OAIEcho04::is_fea_rows_Valid() const{
    return m_fea_rows_isValid;
}

QList<OAIEcho03> OAIEcho04::getFacilities() const {
    return m_facilities;
}
void OAIEcho04::setFacilities(const QList<OAIEcho03> &facilities) {
    m_facilities = facilities;
    m_facilities_isSet = true;
}

bool OAIEcho04::is_facilities_Set() const{
    return m_facilities_isSet;
}

bool OAIEcho04::is_facilities_Valid() const{
    return m_facilities_isValid;
}

QString OAIEcho04::getInspRows() const {
    return m_insp_rows;
}
void OAIEcho04::setInspRows(const QString &insp_rows) {
    m_insp_rows = insp_rows;
    m_insp_rows_isSet = true;
}

bool OAIEcho04::is_insp_rows_Set() const{
    return m_insp_rows_isSet;
}

bool OAIEcho04::is_insp_rows_Valid() const{
    return m_insp_rows_isValid;
}

QString OAIEcho04::getIndianCountryRows() const {
    return m_indian_country_rows;
}
void OAIEcho04::setIndianCountryRows(const QString &indian_country_rows) {
    m_indian_country_rows = indian_country_rows;
    m_indian_country_rows_isSet = true;
}

bool OAIEcho04::is_indian_country_rows_Set() const{
    return m_indian_country_rows_isSet;
}

bool OAIEcho04::is_indian_country_rows_Valid() const{
    return m_indian_country_rows_isValid;
}

QString OAIEcho04::getInfFeaRows() const {
    return m_inf_fea_rows;
}
void OAIEcho04::setInfFeaRows(const QString &inf_fea_rows) {
    m_inf_fea_rows = inf_fea_rows;
    m_inf_fea_rows_isSet = true;
}

bool OAIEcho04::is_inf_fea_rows_Set() const{
    return m_inf_fea_rows_isSet;
}

bool OAIEcho04::is_inf_fea_rows_Valid() const{
    return m_inf_fea_rows_isValid;
}

OAIEcho02 OAIEcho04::getMapOutput() const {
    return m_map_output;
}
void OAIEcho04::setMapOutput(const OAIEcho02 &map_output) {
    m_map_output = map_output;
    m_map_output_isSet = true;
}

bool OAIEcho04::is_map_output_Set() const{
    return m_map_output_isSet;
}

bool OAIEcho04::is_map_output_Valid() const{
    return m_map_output_isValid;
}

QString OAIEcho04::getMessage() const {
    return m_message;
}
void OAIEcho04::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIEcho04::is_message_Set() const{
    return m_message_isSet;
}

bool OAIEcho04::is_message_Valid() const{
    return m_message_isValid;
}

QString OAIEcho04::getPageNo() const {
    return m_page_no;
}
void OAIEcho04::setPageNo(const QString &page_no) {
    m_page_no = page_no;
    m_page_no_isSet = true;
}

bool OAIEcho04::is_page_no_Set() const{
    return m_page_no_isSet;
}

bool OAIEcho04::is_page_no_Valid() const{
    return m_page_no_isValid;
}

QString OAIEcho04::getQueryId() const {
    return m_query_id;
}
void OAIEcho04::setQueryId(const QString &query_id) {
    m_query_id = query_id;
    m_query_id_isSet = true;
}

bool OAIEcho04::is_query_id_Set() const{
    return m_query_id_isSet;
}

bool OAIEcho04::is_query_id_Valid() const{
    return m_query_id_isValid;
}

QString OAIEcho04::getQueryRows() const {
    return m_query_rows;
}
void OAIEcho04::setQueryRows(const QString &query_rows) {
    m_query_rows = query_rows;
    m_query_rows_isSet = true;
}

bool OAIEcho04::is_query_rows_Set() const{
    return m_query_rows_isSet;
}

bool OAIEcho04::is_query_rows_Valid() const{
    return m_query_rows_isValid;
}

QString OAIEcho04::getRcrRows() const {
    return m_rcr_rows;
}
void OAIEcho04::setRcrRows(const QString &rcr_rows) {
    m_rcr_rows = rcr_rows;
    m_rcr_rows_isSet = true;
}

bool OAIEcho04::is_rcr_rows_Set() const{
    return m_rcr_rows_isSet;
}

bool OAIEcho04::is_rcr_rows_Valid() const{
    return m_rcr_rows_isValid;
}

QString OAIEcho04::getSvRows() const {
    return m_sv_rows;
}
void OAIEcho04::setSvRows(const QString &sv_rows) {
    m_sv_rows = sv_rows;
    m_sv_rows_isSet = true;
}

bool OAIEcho04::is_sv_rows_Set() const{
    return m_sv_rows_isSet;
}

bool OAIEcho04::is_sv_rows_Valid() const{
    return m_sv_rows_isValid;
}

QString OAIEcho04::getTriRows() const {
    return m_tri_rows;
}
void OAIEcho04::setTriRows(const QString &tri_rows) {
    m_tri_rows = tri_rows;
    m_tri_rows_isSet = true;
}

bool OAIEcho04::is_tri_rows_Set() const{
    return m_tri_rows_isSet;
}

bool OAIEcho04::is_tri_rows_Valid() const{
    return m_tri_rows_isValid;
}

QString OAIEcho04::getTotalPenalties() const {
    return m_total_penalties;
}
void OAIEcho04::setTotalPenalties(const QString &total_penalties) {
    m_total_penalties = total_penalties;
    m_total_penalties_isSet = true;
}

bool OAIEcho04::is_total_penalties_Set() const{
    return m_total_penalties_isSet;
}

bool OAIEcho04::is_total_penalties_Valid() const{
    return m_total_penalties_isValid;
}

QString OAIEcho04::getV3Rows() const {
    return m_v3_rows;
}
void OAIEcho04::setV3Rows(const QString &v3_rows) {
    m_v3_rows = v3_rows;
    m_v3_rows_isSet = true;
}

bool OAIEcho04::is_v3_rows_Set() const{
    return m_v3_rows_isSet;
}

bool OAIEcho04::is_v3_rows_Valid() const{
    return m_v3_rows_isValid;
}

QString OAIEcho04::getVersion() const {
    return m_version;
}
void OAIEcho04::setVersion(const QString &version) {
    m_version = version;
    m_version_isSet = true;
}

bool OAIEcho04::is_version_Set() const{
    return m_version_isSet;
}

bool OAIEcho04::is_version_Valid() const{
    return m_version_isValid;
}

bool OAIEcho04::isSet() const {
...
bool OAIEcho04::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_bad_system_ids_isValid && m_caa_rows_isValid && m_cv_rows_isValid && m_cwa_rows_isValid && m_fea_rows_isValid && m_insp_rows_isValid && m_indian_country_rows_isValid && m_inf_fea_rows_isValid && m_message_isValid && m_page_no_isValid && m_query_id_isValid && m_query_rows_isValid && m_rcr_rows_isValid && m_sv_rows_isValid && m_tri_rows_isValid && m_total_penalties_isValid && m_v3_rows_isValid && m_version_isValid && true;
}
