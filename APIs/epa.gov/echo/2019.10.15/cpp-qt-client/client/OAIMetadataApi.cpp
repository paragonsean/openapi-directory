...
void OAIMetadataApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("echoRestServicesMetadataGet", defaultConf);
    _serverIndices.insert("echoRestServicesMetadataGet", 0);
    _serverConfigs.insert("echoRestServicesMetadataPost", defaultConf);
    _serverIndices.insert("echoRestServicesMetadataPost", 0);
}
...
void OAIMetadataApi::echoRestServicesMetadataGet(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["echoRestServicesMetadataGet"][_serverIndices.value("echoRestServicesMetadataGet")].URL()+"/echo_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::echoRestServicesMetadataGetCallback);
...
void OAIMetadataApi::echoRestServicesMetadataGetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAI_echo_rest_services_metadata_get_200_response output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT echoRestServicesMetadataGetSignal(output);
        Q_EMIT echoRestServicesMetadataGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT echoRestServicesMetadataGetSignalE(output, error_type, error_str);
        Q_EMIT echoRestServicesMetadataGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT echoRestServicesMetadataGetSignalError(output, error_type, error_str);
        Q_EMIT echoRestServicesMetadataGetSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIMetadataApi::echoRestServicesMetadataPost(const ::OpenAPI::OptionalParam<QString> &output, const ::OpenAPI::OptionalParam<QString> &callback) {
    QString fullPath = QString(_serverConfigs["echoRestServicesMetadataPost"][_serverIndices.value("echoRestServicesMetadataPost")].URL()+"/echo_rest_services.metadata");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIMetadataApi::echoRestServicesMetadataPostCallback);
    connect(this, &OAIMetadataApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIMetadataApi::echoRestServicesMetadataPostCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT echoRestServicesMetadataPostSignal(output);
        Q_EMIT echoRestServicesMetadataPostSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT echoRestServicesMetadataPostSignalE(output, error_type, error_str);
        Q_EMIT echoRestServicesMetadataPostSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT echoRestServicesMetadataPostSignalError(output, error_type, error_str);
        Q_EMIT echoRestServicesMetadataPostSignalErrorFull(worker, error_type, error_str);
    }
}
