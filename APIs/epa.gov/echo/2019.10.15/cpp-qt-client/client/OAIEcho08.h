...
class OAIEcho08 : public OAIObject {
public:
    OAIEcho08();
    OAIEcho08(QString json);
    ~OAIEcho08() override;
    ...
    OAIEcho06 getClusterOutput() const;
    void setClusterOutput(const OAIEcho06 &cluster_output);
    ...
    QList<OAIEcho07> getFacilities() const;
    void setFacilities(const QList<OAIEcho07> &facilities);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEcho08)
