...
async def echo_rest_services_metadata_get(request: web.Request, output=None, param_callback=None) -> web.Response:
...
async def echo_rest_services_metadata_post(request: web.Request, output=None, param_callback=None) -> web.Response:
    """Combined ECHO Metadata Service
