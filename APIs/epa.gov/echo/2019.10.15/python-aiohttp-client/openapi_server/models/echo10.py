...
class Echo10(Model):
    ...
    def __init__(self, air_flag: str=None, airids: str=None, active_lower48: str=None, biosolids_flag: str=None, caa3yr_compl_qtrs_history: str=None, caa_compliance_status: str=None, caa_date_last_formal_action: str=None, caa_days_last_evaluation: float=None, caa_evaluation_count: str=None, caa_formal_action_count: str=None, caa_hpv_flag: str=None, caa_informal_count: str=None, caa_last_penalty_amt: float=None, caa_last_penalty_date: str=None, caanaics: str=None, caa_penalties: str=None, caa_permit_types: str=None, caa_qtrs_with_nc: float=None, caasics: str=None, cwa13qtrs_compl_history: str=None, cwa13qtrs_efflnt_exceedances: float=None, cwa3_yr_qncr_codes: str=None, cwa_compliance_status: str=None, cwa_compliance_tracking: str=None, cwa_date_last_formal_action: str=None, cwa_days_last_inspection: float=None, cwa_formal_action_count: str=None, cwa_informal_count: float=None, cwa_inspection_count: float=None, cwa_last_penalty_amt: str=None, cwa_last_penalty_date: str=None, cwanaics: str=None, cwa_penalties: str=None, cwa_permit_types: str=None, cwa_qtrs_with_nc: str=None, cwasics: str=None, cwasnc_flag: str=None, camd_ids: str=None, census_block_group: str=None, curr_sv_flag: float=None, curr_vio_flag: float=None, dfr_url: str=None, ea5yr_flag: float=None, eff_charts_flag: str=None, eis_flag: str=None, eis_ids: str=None, ejscreen_flag: str=None, ejscreen_flag_us: str=None, epcra_inspections5yr: str=None, fac3yr_compliance_history: str=None, fac_accuracy_meters: float=None, fac_active_flag: str=None, fac_chesapeake_bay_flg: str=None, fac_city: str=None, fac_collection_method: str=None, fac_compliance_status: str=None, fac_county: str=None, fac_date_last_formal_act_epa: str=None, fac_date_last_formal_act_st: str=None, fac_date_last_formal_action: str=None, fac_date_last_informal_act_epa: str=None, fac_date_last_informal_act_st: str=None, fac_date_last_informal_action: str=None, fac_date_last_inspection: str=None, fac_date_last_inspection_epa: str=None, fac_date_last_inspection_state: str=None, fac_date_last_penalty: str=None, fac_days_last_inspection: float=None, fac_derived_cb2010: str=None, fac_derived_cd113: str=None, fac_derived_huc: str=None, fac_derived_rad_wbdhu12: str=None, fac_derived_rad_wbdhu12_name: str=None, fac_derived_rad_wbdhu8: str=None, fac_derived_rad_wbdhu8_name: str=None, fac_derived_stcty_fips: str=None, fac_derived_tr_ibes: str=None, fac_derived_wbd: str=None, fac_derived_wbdhu12_name: str=None, fac_derived_wbdhu8: str=None, fac_derived_wbdhu8_name: str=None, fac_derived_zip: str=None, fac_epa_region: str=None, fac_fips_code: str=None, fac_federal_agency: str=None, fac_federal_agency_name: str=None, fac_federal_flg: str=None, fac_formal_action_count: float=None, fac_imp_water_flg: str=None, fac_indian_cntry_flg: str=None, fac_indian_spatial_flg: str=None, fac_informal_count: float=None, fac_inspection_count: float=None, fac_last_penalty_amt: float=None, fac_major_flag: str=None, fac_map_flg: str=None, fac_map_icon: str=None, fac_myrtk_universe: str=None, fac_naics_codes: str=None, fac_naa_flag: str=None, fac_name: str=None, fac_penalty_count: float=None, fac_percent_minority: float=None, fac_pop_den: float=None, fac_programs_with_snc: float=None, fac_qtrs_with_nc: float=None, fac_reference_point: str=None, fac_sic_codes: str=None, fac_snc_flg: str=None, fac_state: str=None, fac_std_county_name: str=None, fac_street: str=None, fac_total_penalties: float=None, fac_us_mex_border_flg: str=None, fac_zip: str=None, fec_case_ids: str=None, fec_last_case_date: str=None, fec_number_of_cases: float=None, fec_total_penalties: float=None, fifra_inspections5yr: str=None, ghgco2_releases: str=None, ghg_flag: str=None, ghgids: str=None, has_poll_rpt: str=None, infea5yr_flag: float=None, insp5yr_flag: float=None, lower48: str=None, max_pctile_us: float=None, max_score: float=None, nc: str=None, npdes_flag: str=None, npdesids: str=None, naa_categories: str=None, naa_pollutants: str=None, over80_count_us: float=None, pctile_cancer_us: float=None, pctile_dpm_us: float=None, pctile_o3_us: float=None, pctile_pctpre1960_us: float=None, pctile_pm_us: float=None, pctile_proximity_npdesus: float=None, pctile_proximity_npl_us: float=None, pctile_proximity_rmp_us: float=None, pctile_proximity_tsdf_us: float=None, pctile_resp_us: float=None, pctile_traffic_score_us: float=None, rcra3yr_compl_qtrs_history: str=None, rcra_compliance_status: str=None, rcra_date_last_formal_action: str=None, rcra_days_last_evaluation: float=None, rcra_flag: str=None, rcra_formal_action_count: str=None, rcraids: str=None, rcra_informal_count: str=None, rcra_inspection_count: float=None, rcra_last_penalty_amt: str=None, rcra_last_penalty_date: str=None, rcranaics: str=None, rcra_penalties: str=None, rcra_permit_types: str=None, rcra_qtrs_with_nc: float=None, rcrasnc_flag: str=None, registry_id: str=None, rmp_ids: str=None, sdwa3yr_compl_qtrs_history: str=None, sdwa_compliance_status: str=None, sdwa_formal_action_count: str=None, sdwaids: str=None, sdwa_informal_count: str=None, sdwa_inspections5yr: str=None, sdwa_qtrs_with_nc: str=None, sdwasnc_flag: str=None, sdwa_system_types: str=None, sdwis_flag: str=None, score: float=None, sems_flag: str=None, sems_ids: str=None, source_id: str=None, tri_flag: str=None, triids: str=None, tri_off_site_transfers: float=None, trion_site_releases: float=None, tri_releases_transfers: float=None, tri_reporter: str=None, tri_reporter_in_past: str=None, tr_ibal_flag: float=None, tsca_flag: str=None, tsca_ids: str=None, tsca_inspections5yr: str=None, viol_flag: float=None, web_docs: str=None):
        """Echo10 - a model defined in OpenAPI

        :param air_flag: The air_flag of this Echo10.
        :param airids: The airids of this Echo10.
        :param active_lower48: The active_lower48 of this Echo10.
        :param biosolids_flag: The biosolids_flag of this Echo10.
        :param caa3yr_compl_qtrs_history: The caa3yr_compl_qtrs_history of this Echo10.
        :param caa_compliance_status: The caa_compliance_status of this Echo10.
        :param caa_date_last_formal_action: The caa_date_last_formal_action of this Echo10.
        :param caa_days_last_evaluation: The caa_days_last_evaluation of this Echo10.
        :param caa_evaluation_count: The caa_evaluation_count of this Echo10.
        :param caa_formal_action_count: The caa_formal_action_count of this Echo10.
        :param caa_hpv_flag: The caa_hpv_flag of this Echo10.
        :param caa_informal_count: The caa_informal_count of this Echo10.
        :param caa_last_penalty_amt: The caa_last_penalty_amt of this Echo10.
        :param caa_last_penalty_date: The caa_last_penalty_date of this Echo10.
        :param caanaics: The caanaics of this Echo10.
        :param caa_penalties: The caa_penalties of this Echo10.
        :param caa_permit_types: The caa_permit_types of this Echo10.
        :param caa_qtrs_with_nc: The caa_qtrs_with_nc of this Echo10.
        :param caasics: The caasics of this Echo10.
        :param cwa13qtrs_compl_history: The cwa13qtrs_compl_history of this Echo10.
        :param cwa13qtrs_efflnt_exceedances: The cwa13qtrs_efflnt_exceedances of this Echo10.
        :param cwa3_yr_qncr_codes: The cwa3_yr_qncr_codes of this Echo10.
        :param cwa_compliance_status: The cwa_compliance_status of this Echo10.
        :param cwa_compliance_tracking: The cwa_compliance_tracking of this Echo10.
        :param cwa_date_last_formal_action: The cwa_date_last_formal_action of this Echo10.
        :param cwa_days_last_inspection: The cwa_days_last_inspection of this Echo10.
        :param cwa_formal_action_count: The cwa_formal_action_count of this Echo10.
        :param cwa_informal_count: The cwa_informal_count of this Echo10.
        :param cwa_inspection_count: The cwa_inspection_count of this Echo10.
        :param cwa_last_penalty_amt: The cwa_last_penalty_amt of this Echo10.
        :param cwa_last_penalty_date: The cwa_last_penalty_date of this Echo10.
        :param cwanaics: The cwanaics of this Echo10.
        :param cwa_penalties: The cwa_penalties of this Echo10.
        :param cwa_permit_types: The cwa_permit_types of this Echo10.
        :param cwa_qtrs_with_nc: The cwa_qtrs_with_nc of this Echo10.
        :param cwasics: The cwasics of this Echo10.
        :param cwasnc_flag: The cwasnc_flag of this Echo10.
        :param camd_ids: The camd_ids of this Echo10.
        :param census_block_group: The census_block_group of this Echo10.
        :param curr_sv_flag: The curr_sv_flag of this Echo10.
        :param curr_vio_flag: The curr_vio_flag of this Echo10.
        :param dfr_url: The dfr_url of this Echo10.
        :param ea5yr_flag: The ea5yr_flag of this Echo10.
        :param eff_charts_flag: The eff_charts_flag of this Echo10.
        :param eis_flag: The eis_flag of this Echo10.
        :param eis_ids: The eis_ids of this Echo10.
        :param ejscreen_flag: The ejscreen_flag of this Echo10.
        :param ejscreen_flag_us: The ejscreen_flag_us of this Echo10.
        :param epcra_inspections5yr: The epcra_inspections5yr of this Echo10.
        :param fac3yr_compliance_history: The fac3yr_compliance_history of this Echo10.
        :param fac_accuracy_meters: The fac_accuracy_meters of this Echo10.
        :param fac_active_flag: The fac_active_flag of this Echo10.
        :param fac_chesapeake_bay_flg: The fac_chesapeake_bay_flg of this Echo10.
        :param fac_city: The fac_city of this Echo10.
        :param fac_collection_method: The fac_collection_method of this Echo10.
        :param fac_compliance_status: The fac_compliance_status of this Echo10.
        :param fac_county: The fac_county of this Echo10.
        :param fac_date_last_formal_act_epa: The fac_date_last_formal_act_epa of this Echo10.
        :param fac_date_last_formal_act_st: The fac_date_last_formal_act_st of this Echo10.
        :param fac_date_last_formal_action: The fac_date_last_formal_action of this Echo10.
        :param fac_date_last_informal_act_epa: The fac_date_last_informal_act_epa of this Echo10.
        :param fac_date_last_informal_act_st: The fac_date_last_informal_act_st of this Echo10.
        :param fac_date_last_informal_action: The fac_date_last_informal_action of this Echo10.
        :param fac_date_last_inspection: The fac_date_last_inspection of this Echo10.
        :param fac_date_last_inspection_epa: The fac_date_last_inspection_epa of this Echo10.
        :param fac_date_last_inspection_state: The fac_date_last_inspection_state of this Echo10.
        :param fac_date_last_penalty: The fac_date_last_penalty of this Echo10.
        :param fac_days_last_inspection: The fac_days_last_inspection of this Echo10.
        :param fac_derived_cb2010: The fac_derived_cb2010 of this Echo10.
        :param fac_derived_cd113: The fac_derived_cd113 of this Echo10.
        :param fac_derived_huc: The fac_derived_huc of this Echo10.
        :param fac_derived_rad_wbdhu12: The fac_derived_rad_wbdhu12 of this Echo10.
        :param fac_derived_rad_wbdhu12_name: The fac_derived_rad_wbdhu12_name of this Echo10.
        :param fac_derived_rad_wbdhu8: The fac_derived_rad_wbdhu8 of this Echo10.
        :param fac_derived_rad_wbdhu8_name: The fac_derived_rad_wbdhu8_name of this Echo10.
        :param fac_derived_stcty_fips: The fac_derived_stcty_fips of this Echo10.
        :param fac_derived_tr_ibes: The fac_derived_tr_ibes of this Echo10.
        :param fac_derived_wbd: The fac_derived_wbd of this Echo10.
        :param fac_derived_wbdhu12_name: The fac_derived_wbdhu12_name of this Echo10.
        :param fac_derived_wbdhu8: The fac_derived_wbdhu8 of this Echo10.
        :param fac_derived_wbdhu8_name: The fac_derived_wbdhu8_name of this Echo10.
        :param fac_derived_zip: The fac_derived_zip of this Echo10.
        :param fac_epa_region: The fac_epa_region of this Echo10.
        :param fac_fips_code: The fac_fips_code of this Echo10.
        :param fac_federal_agency: The fac_federal_agency of this Echo10.
        :param fac_federal_agency_name: The fac_federal_agency_name of this Echo10.
        :param fac_federal_flg: The fac_federal_flg of this Echo10.
        :param fac_formal_action_count: The fac_formal_action_count of this Echo10.
        :param fac_imp_water_flg: The fac_imp_water_flg of this Echo10.
        :param fac_indian_cntry_flg: The fac_indian_cntry_flg of this Echo10.
        :param fac_indian_spatial_flg: The fac_indian_spatial_flg of this Echo10.
        :param fac_informal_count: The fac_informal_count of this Echo10.
        :param fac_inspection_count: The fac_inspection_count of this Echo10.
        :param fac_last_penalty_amt: The fac_last_penalty_amt of this Echo10.
        :param fac_major_flag: The fac_major_flag of this Echo10.
        :param fac_map_flg: The fac_map_flg of this Echo10.
        :param fac_map_icon: The fac_map_icon of this Echo10.
        :param fac_myrtk_universe: The fac_myrtk_universe of this Echo10.
        :param fac_naics_codes: The fac_naics_codes of this Echo10.
        :param fac_naa_flag: The fac_naa_flag of this Echo10.
        :param fac_name: The fac_name of this Echo10.
        :param fac_penalty_count: The fac_penalty_count of this Echo10.
        :param fac_percent_minority: The fac_percent_minority of this Echo10.
        :param fac_pop_den: The fac_pop_den of this Echo10.
        :param fac_programs_with_snc: The fac_programs_with_snc of this Echo10.
        :param fac_qtrs_with_nc: The fac_qtrs_with_nc of this Echo10.
        :param fac_reference_point: The fac_reference_point of this Echo10.
        :param fac_sic_codes: The fac_sic_codes of this Echo10.
        :param fac_snc_flg: The fac_snc_flg of this Echo10.
        :param fac_state: The fac_state of this Echo10.
        :param fac_std_county_name: The fac_std_county_name of this Echo10.
        :param fac_street: The fac_street of this Echo10.
        :param fac_total_penalties: The fac_total_penalties of this Echo10.
        :param fac_us_mex_border_flg: The fac_us_mex_border_flg of this Echo10.
        :param fac_zip: The fac_zip of this Echo10.
        :param fec_case_ids: The fec_case_ids of this Echo10.
        :param fec_last_case_date: The fec_last_case_date of this Echo10.
        :param fec_number_of_cases: The fec_number_of_cases of this Echo10.
        :param fec_total_penalties: The fec_total_penalties of this Echo10.
        :param fifra_inspections5yr: The fifra_inspections5yr of this Echo10.
        :param ghgco2_releases: The ghgco2_releases of this Echo10.
        :param ghg_flag: The ghg_flag of this Echo10.
        :param ghgids: The ghgids of this Echo10.
        :param has_poll_rpt: The has_poll_rpt of this Echo10.
        :param infea5yr_flag: The infea5yr_flag of this Echo10.
        :param insp5yr_flag: The insp5yr_flag of this Echo10.
        :param lower48: The lower48 of this Echo10.
        :param max_pctile_us: The max_pctile_us of this Echo10.
        :param max_score: The max_score of this Echo10.
        :param nc: The nc of this Echo10.
        :param npdes_flag: The npdes_flag of this Echo10.
        :param npdesids: The npdesids of this Echo10.
        :param naa_categories: The naa_categories of this Echo10.
        :param naa_pollutants: The naa_pollutants of this Echo10.
        :param over80_count_us: The over80_count_us of this Echo10.
        :param pctile_cancer_us: The pctile_cancer_us of this Echo10.
        :param pctile_dpm_us: The pctile_dpm_us of this Echo10.
        :param pctile_o3_us: The pctile_o3_us of this Echo10.
        :param pctile_pctpre1960_us: The pctile_pctpre1960_us of this Echo10.
        :param pctile_pm_us: The pctile_pm_us of this Echo10.
        :param pctile_proximity_npdesus: The pctile_proximity_npdesus of this Echo10.
        :param pctile_proximity_npl_us: The pctile_proximity_npl_us of this Echo10.
        :param pctile_proximity_rmp_us: The pctile_proximity_rmp_us of this Echo10.
        :param pctile_proximity_tsdf_us: The pctile_proximity_tsdf_us of this Echo10.
        :param pctile_resp_us: The pctile_resp_us of this Echo10.
        :param pctile_traffic_score_us: The pctile_traffic_score_us of this Echo10.
        :param rcra3yr_compl_qtrs_history: The rcra3yr_compl_qtrs_history of this Echo10.
        :param rcra_compliance_status: The rcra_compliance_status of this Echo10.
        :param rcra_date_last_formal_action: The rcra_date_last_formal_action of this Echo10.
        :param rcra_days_last_evaluation: The rcra_days_last_evaluation of this Echo10.
        :param rcra_flag: The rcra_flag of this Echo10.
        :param rcra_formal_action_count: The rcra_formal_action_count of this Echo10.
        :param rcraids: The rcraids of this Echo10.
        :param rcra_informal_count: The rcra_informal_count of this Echo10.
        :param rcra_inspection_count: The rcra_inspection_count of this Echo10.
        :param rcra_last_penalty_amt: The rcra_last_penalty_amt of this Echo10.
        :param rcra_last_penalty_date: The rcra_last_penalty_date of this Echo10.
        :param rcranaics: The rcranaics of this Echo10.
        :param rcra_penalties: The rcra_penalties of this Echo10.
        :param rcra_permit_types: The rcra_permit_types of this Echo10.
        :param rcra_qtrs_with_nc: The rcra_qtrs_with_nc of this Echo10.
        :param rcrasnc_flag: The rcrasnc_flag of this Echo10.
        :param registry_id: The registry_id of this Echo10.
        :param rmp_ids: The rmp_ids of this Echo10.
        :param sdwa3yr_compl_qtrs_history: The sdwa3yr_compl_qtrs_history of this Echo10.
        :param sdwa_compliance_status: The sdwa_compliance_status of this Echo10.
        :param sdwa_formal_action_count: The sdwa_formal_action_count of this Echo10.
        :param sdwaids: The sdwaids of this Echo10.
        :param sdwa_informal_count: The sdwa_informal_count of this Echo10.
        :param sdwa_inspections5yr: The sdwa_inspections5yr of this Echo10.
        :param sdwa_qtrs_with_nc: The sdwa_qtrs_with_nc of this Echo10.
        :param sdwasnc_flag: The sdwasnc_flag of this Echo10.
        :param sdwa_system_types: The sdwa_system_types of this Echo10.
        :param sdwis_flag: The sdwis_flag of this Echo10.
        :param score: The score of this Echo10.
        :param sems_flag: The sems_flag of this Echo10.
        :param sems_ids: The sems_ids of this Echo10.
        :param source_id: The source_id of this Echo10.
        :param tri_flag: The tri_flag of this Echo10.
        :param triids: The triids of this Echo10.
        :param tri_off_site_transfers: The tri_off_site_transfers of this Echo10.
        :param trion_site_releases: The trion_site_releases of this Echo10.
        :param tri_releases_transfers: The tri_releases_transfers of this Echo10.
        :param tri_reporter: The tri_reporter of this Echo10.
        :param tri_reporter_in_past: The tri_reporter_in_past of this Echo10.
        :param tr_ibal_flag: The tr_ibal_flag of this Echo10.
        :param tsca_flag: The tsca_flag of this Echo10.
        :param tsca_ids: The tsca_ids of this Echo10.
        :param tsca_inspections5yr: The tsca_inspections5yr of this Echo10.
        :param viol_flag: The viol_flag of this Echo10.
        :param web_docs: The web_docs of this Echo10.
        """
        self.openapi_types = {
            'air_flag': str,
            'airids': str,
            ...
            'fac_days_last_inspection': float,
            ...
            'fac_naa_flag': str,
            'fac_name': str,
            'fac_penalty_count': float,
            'fac_percent_minority': float,
            'fac_pop_den': float,
            'fac_programs_with_snc': float,
            ...
            'fac_street': str,
            'fac_total_penalties': float,
            'fac_us_mex_border_flg': str,
            'fac_zip': str,
            'fec_case_ids': str,
            'fec_last_case_date': str,
            'fec_number_of_cases': float,
            ...
            'rcra_days_last_evaluation': float,
            'rcra_flag': str,
            'rcra_formal_action_count': str,
            'rcraids': str,
            'rcra_informal_count': str,
            'rcra_inspection_count': float,
            ...
            'tri_flag': str,
            'triids': str,
            'tri_off_site_transfers': float,
            'trion_site_releases': float,
            'tri_releases_transfers': float,
            'tri_reporter': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Echo10':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The echo10 of this Echo10.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def air_flag(self):
        """Gets the air_flag of this Echo10.

        Indicates whether the facility has a Clean Air Act (CAA) permit.

        :return: The air_flag of this Echo10.
        :rtype: str
        """
    ...
    def air_flag(self, air_flag):
        """Sets the air_flag of this Echo10.
    ...
    @property
    def airids(self):
        """Gets the airids of this Echo10.

        Air Facility System (AFS) ID.

        :return: The airids of this Echo10.
        :rtype: str
        """
        return self._airids
    ...
    def airids(self, airids):
        """Sets the airids of this Echo10.
    ...
    def active_lower48(self, active_lower48):
        """Sets the active_lower48 of this Echo10.
    ...
    def biosolids_flag(self, biosolids_flag):
        """Sets the biosolids_flag of this Echo10.
    ...
    def caa3yr_compl_qtrs_history(self):
        """Gets the caa3yr_compl_qtrs_history of this Echo10.
        ...
        :return: The caa3yr_compl_qtrs_history of this Echo10.
        :rtype: str
        """
    ...
    def caa3yr_compl_qtrs_history(self, caa3yr_compl_qtrs_history):
        """Sets the caa3yr_compl_qtrs_history of this Echo10.
    ...
    def caa_compliance_status(self):
        """Gets the caa_compliance_status of this Echo10.
        ...
        :return: The caa_compliance_status of this Echo10.
        :rtype: str
        """
    ...
    def caa_compliance_status(self, caa_compliance_status):
        """Sets the caa_compliance_status of this Echo10.
    ...
    def caa_date_last_formal_action(self):
        """Gets the caa_date_last_formal_action of this Echo10.

        The effective date of the most recent listed enforcement action entered into the CAA program database.

        :return: The caa_date_last_formal_action of this Echo10.
        :rtype: str
        """
    ...
    def caa_date_last_formal_action(self, caa_date_last_formal_action):
        """Sets the caa_date_last_formal_action of this Echo10.
    ...
    def caa_days_last_evaluation(self):
        """Gets the caa_days_last_evaluation of this Echo10.


        :return: The caa_days_last_evaluation of this Echo10.
        :rtype: float
        """
    ...
    def caa_days_last_evaluation(self, caa_days_last_evaluation):
        """Sets the caa_days_last_evaluation of this Echo10.


        :param caa_days_last_evaluation: The caa_days_last_evaluation of this Echo10.
        :type caa_days_last_evaluation: float
        """
    ...
    def caa_evaluation_count(self):
        """Gets the caa_evaluation_count of this Echo10.
        ...
        :return: The caa_evaluation_count of this Echo10.
        :rtype: str
        """
    ...
    def caa_evaluation_count(self, caa_evaluation_count):
        """Sets the caa_evaluation_count of this Echo10.
    ...
    def caa_formal_action_count(self):
        """Gets the caa_formal_action_count of this Echo10.
        ...
        :return: The caa_formal_action_count of this Echo10.
        :rtype: str
        """
    ...
    def caa_formal_action_count(self, caa_formal_action_count):
        """Sets the caa_formal_action_count of this Echo10.
    ...
    def caa_hpv_flag(self):
        """Gets the caa_hpv_flag of this Echo10.
        ...
        :return: The caa_hpv_flag of this Echo10.
        :rtype: str
        """
    ...
    def caa_hpv_flag(self, caa_hpv_flag):
        """Sets the caa_hpv_flag of this Echo10.
    ...
    def caa_informal_count(self):
        """Gets the caa_informal_count of this Echo10.
        ...
        :return: The caa_informal_count of this Echo10.
        :rtype: str
        """
    ...
    def caa_informal_count(self, caa_informal_count):
        """Sets the caa_informal_count of this Echo10.
    ...
    def caa_last_penalty_amt(self):
        """Gets the caa_last_penalty_amt of this Echo10.


        :return: The caa_last_penalty_amt of this Echo10.
        :rtype: float
        """
    ...
    def caa_last_penalty_amt(self, caa_last_penalty_amt):
        """Sets the caa_last_penalty_amt of this Echo10.


        :param caa_last_penalty_amt: The caa_last_penalty_amt of this Echo10.
        :type caa_last_penalty_amt: float
        """
    ...
    def caa_last_penalty_date(self):
        """Gets the caa_last_penalty_date of this Echo10.

        The effective date of the most recent penalty entered into the CAA program database.

        :return: The caa_last_penalty_date of this Echo10.
        :rtype: str
        """
    ...
    def caa_last_penalty_date(self, caa_last_penalty_date):
        """Sets the caa_last_penalty_date of this Echo10.
    ...
    def caanaics(self, caanaics):
        """Sets the caanaics of this Echo10.
    ...
    def caa_penalties(self):
        """Gets the caa_penalties of this Echo10.
        ...
        :return: The caa_penalties of this Echo10.
        :rtype: str
        """
    ...
    def caa_penalties(self, caa_penalties):
        """Sets the caa_penalties of this Echo10.
    ...
    def caa_permit_types(self, caa_permit_types):
        """Sets the caa_permit_types of this Echo10.
    ...
    def caa_qtrs_with_nc(self):
        """Gets the caa_qtrs_with_nc of this Echo10.


        :return: The caa_qtrs_with_nc of this Echo10.
        :rtype: float
        """
    ...
    def caa_qtrs_with_nc(self, caa_qtrs_with_nc):
        """Sets the caa_qtrs_with_nc of this Echo10.


        :param caa_qtrs_with_nc: The caa_qtrs_with_nc of this Echo10.
        :type caa_qtrs_with_nc: float
        """
    ...
    def caasics(self, caasics):
        """Sets the caasics of this Echo10.
    ...
    def cwa13qtrs_compl_history(self):
        """Gets the cwa13qtrs_compl_history of this Echo10.
        ...
        :return: The cwa13qtrs_compl_history of this Echo10.
        :rtype: str
        """
    ...
    def cwa13qtrs_compl_history(self, cwa13qtrs_compl_history):
        """Sets the cwa13qtrs_compl_history of this Echo10.
    ...
    def cwa13qtrs_efflnt_exceedances(self):
        """Gets the cwa13qtrs_efflnt_exceedances of this Echo10.

        The number of effluent violations at the facility in the past 13 quarters.

        :return: The cwa13qtrs_efflnt_exceedances of this Echo10.
        :rtype: float
        """
    ...
    def cwa13qtrs_efflnt_exceedances(self, cwa13qtrs_efflnt_exceedances):
        """Sets the cwa13qtrs_efflnt_exceedances of this Echo10.

        The number of effluent violations at the facility in the past 13 quarters.

        :param cwa13qtrs_efflnt_exceedances: The cwa13qtrs_efflnt_exceedances of this Echo10.
        :type cwa13qtrs_efflnt_exceedances: float
        """
    ...
    def cwa3_yr_qncr_codes(self):
        """Gets the cwa3_yr_qncr_codes of this Echo10.

        No longer used.  Will be deleted in nthe future.

        :return: The cwa3_yr_qncr_codes of this Echo10.
        :rtype: str
        """
    ...
    def cwa3_yr_qncr_codes(self, cwa3_yr_qncr_codes):
        """Sets the cwa3_yr_qncr_codes of this Echo10.
    ...
    def cwa_compliance_status(self):
        """Gets the cwa_compliance_status of this Echo10.
        ...
        :return: The cwa_compliance_status of this Echo10.
        :rtype: str
        """
    ...
    def cwa_compliance_status(self, cwa_compliance_status):
        """Sets the cwa_compliance_status of this Echo10.
    ...
    def cwa_compliance_tracking(self):
        """Gets the cwa_compliance_tracking of this Echo10.
        ...
        :return: The cwa_compliance_tracking of this Echo10.
        :rtype: str
        """
    ...
    def cwa_compliance_tracking(self, cwa_compliance_tracking):
        """Sets the cwa_compliance_tracking of this Echo10.
    ...
    def cwa_date_last_formal_action(self):
        """Gets the cwa_date_last_formal_action of this Echo10.

        The effective date of the most recent listed enforcement action entered into the CWA program database.

        :return: The cwa_date_last_formal_action of this Echo10.
        :rtype: str
        """
    ...
    def cwa_date_last_formal_action(self, cwa_date_last_formal_action):
        """Sets the cwa_date_last_formal_action of this Echo10.
    ...
    def cwa_days_last_inspection(self):
        """Gets the cwa_days_last_inspection of this Echo10.


        :return: The cwa_days_last_inspection of this Echo10.
        :rtype: float
        """
    ...
    def cwa_days_last_inspection(self, cwa_days_last_inspection):
        """Sets the cwa_days_last_inspection of this Echo10.


        :param cwa_days_last_inspection: The cwa_days_last_inspection of this Echo10.
        :type cwa_days_last_inspection: float
        """
    ...
    def cwa_formal_action_count(self):
        """Gets the cwa_formal_action_count of this Echo10.
        ...
        :return: The cwa_formal_action_count of this Echo10.
        :rtype: str
        """
    ...
    def cwa_formal_action_count(self, cwa_formal_action_count):
        """Sets the cwa_formal_action_count of this Echo10.
    ...
    def cwa_informal_count(self):
        """Gets the cwa_informal_count of this Echo10.
        ...
        :return: The cwa_informal_count of this Echo10.
        :rtype: float
        """
    ...
    def cwa_informal_count(self, cwa_informal_count):
        """Sets the cwa_informal_count of this Echo10.

        Indicates the number of informal enforcement actions/notices of violations (NOVs) taken against the facility within the last five years under the Clean Water Act.

        :param cwa_informal_count: The cwa_informal_count of this Echo10.
        :type cwa_informal_count: float
        """
    ...
    def cwa_inspection_count(self):
        """Gets the cwa_inspection_count of this Echo10.
        ...
        :return: The cwa_inspection_count of this Echo10.
        :rtype: float
        """
    ...
    def cwa_inspection_count(self, cwa_inspection_count):
        """Sets the cwa_inspection_count of this Echo10.

        The number of inspections/compliance evaluations under the Clean Water Act, occurring at the facility within the last five years.

        :param cwa_inspection_count: The cwa_inspection_count of this Echo10.
        :type cwa_inspection_count: float
        """
    ...
    def cwa_last_penalty_amt(self):
        """Gets the cwa_last_penalty_amt of this Echo10.

        The amount of the most recent penalty entered into the CWA program database.

        :return: The cwa_last_penalty_amt of this Echo10.
        :rtype: str
        """
    ...
    def cwa_last_penalty_amt(self, cwa_last_penalty_amt):
        """Sets the cwa_last_penalty_amt of this Echo10.
    ...
    def cwa_last_penalty_date(self):
        """Gets the cwa_last_penalty_date of this Echo10.

        The effective date of the most recent penalty entered into the CWA program database.

        :return: The cwa_last_penalty_date of this Echo10.
        :rtype: str
        """
    ...
    def cwa_last_penalty_date(self, cwa_last_penalty_date):
        """Sets the cwa_last_penalty_date of this Echo10.
    ...
    def cwanaics(self, cwanaics):
        """Sets the cwanaics of this Echo10.
    ...
    def cwa_penalties(self):
        """Gets the cwa_penalties of this Echo10.
        ...
        :return: The cwa_penalties of this Echo10.
        :rtype: str
        """
    ...
    def cwa_penalties(self, cwa_penalties):
        """Sets the cwa_penalties of this Echo10.
    ...
    def cwa_permit_types(self):
        """Gets the cwa_permit_types of this Echo10.

        Indicates the facility's permit type or designation. - Major - Minor

        :return: The cwa_permit_types of this Echo10.
        :rtype: str
        """
    ...
    def cwa_permit_types(self, cwa_permit_types):
        """Sets the cwa_permit_types of this Echo10.
    ...
    def cwa_qtrs_with_nc(self, cwa_qtrs_with_nc):
        """Sets the cwa_qtrs_with_nc of this Echo10.
    ...
    def cwasics(self, cwasics):
        """Sets the cwasics of this Echo10.
    ...
    def cwasnc_flag(self):
        """Gets the cwasnc_flag of this Echo10.
        ...
        :return: The cwasnc_flag of this Echo10.
        :rtype: str
        """
    ...
    def cwasnc_flag(self, cwasnc_flag):
        """Sets the cwasnc_flag of this Echo10.
    ...
    @property
    def camd_ids(self):
        """Gets the camd_ids of this Echo10.

        Facility identifiers for the Clean Air Markets Division database.

        :return: The camd_ids of this Echo10.
        :rtype: str
        """
    ...
    def camd_ids(self, camd_ids):
        """Sets the camd_ids of this Echo10.
    ...
    def census_block_group(self, census_block_group):
        """Sets the census_block_group of this Echo10.
    ...
    def curr_sv_flag(self):
        """Gets the curr_sv_flag of this Echo10.

        Indicates if the facility has a current significant violation. 1 = Yes

        :return: The curr_sv_flag of this Echo10.
        :rtype: float
        """
    ...
    def curr_sv_flag(self, curr_sv_flag):
        """Sets the curr_sv_flag of this Echo10.
    ...
    def curr_vio_flag(self):
        """Gets the curr_vio_flag of this Echo10.

        Indicates if the facility has a current violation. 1 = Yes

        :return: The curr_vio_flag of this Echo10.
        :rtype: float
        """
    ...
    def curr_vio_flag(self, curr_vio_flag):
        """Sets the curr_vio_flag of this Echo10.
    ...
    @property
    def dfr_url(self):
        """Gets the dfr_url of this Echo10.

        The URL to the facility's Detailed Facility Report.

        :return: The dfr_url of this Echo10.
        :rtype: str
        """
    ...
    def dfr_url(self, dfr_url):
        """Sets the dfr_url of this Echo10.
    ...
    def ea5yr_flag(self, ea5yr_flag):
        """Sets the ea5yr_flag of this Echo10.
    ...
    def eff_charts_flag(self):
        """Gets the eff_charts_flag of this Echo10.


        :return: The eff_charts_flag of this Echo10.
        :rtype: str
        """
    ...
    def eff_charts_flag(self, eff_charts_flag):
        """Sets the eff_charts_flag of this Echo10.
    ...
    def eis_flag(self, eis_flag):
        """Sets the eis_flag of this Echo10.
    ...
    def eis_ids(self, eis_ids):
        """Sets the eis_ids of this Echo10.
    ...
    def ejscreen_flag(self, ejscreen_flag):
        """Sets the ejscreen_flag of this Echo10.
    ...
    def ejscreen_flag_us(self):
        """Gets the ejscreen_flag_us of this Echo10.

        A Y/N indicator identifying whether or not the facility is within an Environmental Justice area.

        :return: The ejscreen_flag_us of this Echo10.
        :rtype: str
        """
    ...
    def ejscreen_flag_us(self, ejscreen_flag_us):
        """Sets the ejscreen_flag_us of this Echo10.
    ...
    def epcra_inspections5yr(self):
        """Gets the epcra_inspections5yr of this Echo10.

        From ICIS FE&C, the number of EPCRA inspections at the facility in the past five years.

        :return: The epcra_inspections5yr of this Echo10.
        :rtype: str
        """
    ...
    def epcra_inspections5yr(self, epcra_inspections5yr):
        """Sets the epcra_inspections5yr of this Echo10.
    ...
    def fac3yr_compliance_history(self):
        """Gets the fac3yr_compliance_history of this Echo10.
        ...
        :return: The fac3yr_compliance_history of this Echo10.
        :rtype: str
        """
    ...
    def fac3yr_compliance_history(self, fac3yr_compliance_history):
        """Sets the fac3yr_compliance_history of this Echo10.
    ...
    def fac_accuracy_meters(self):
        """Gets the fac_accuracy_meters of this Echo10.


        :return: The fac_accuracy_meters of this Echo10.
        :rtype: float
        """
    ...
    def fac_accuracy_meters(self, fac_accuracy_meters):
        """Sets the fac_accuracy_meters of this Echo10.


        :param fac_accuracy_meters: The fac_accuracy_meters of this Echo10.
        :type fac_accuracy_meters: float
        """
    ...
    def fac_active_flag(self, fac_active_flag):
        """Sets the fac_active_flag of this Echo10.
    ...
    def fac_chesapeake_bay_flg(self, fac_chesapeake_bay_flg):
        """Sets the fac_chesapeake_bay_flg of this Echo10.
    ...
    @property
    def fac_city(self):
        """Gets the fac_city of this Echo10.

        The city where the facility is located.

        :return: The fac_city of this Echo10.
        :rtype: str
        """
    ...
    def fac_city(self, fac_city):
        """Sets the fac_city of this Echo10.
    ...
    def fac_collection_method(self):
        """Gets the fac_collection_method of this Echo10.
        ...
        :return: The fac_collection_method of this Echo10.
        :rtype: str
        """
    ...
    def fac_collection_method(self, fac_collection_method):
        """Sets the fac_collection_method of this Echo10.
    ...
    def fac_compliance_status(self):
        """Gets the fac_compliance_status of this Echo10.
        ...
        :return: The fac_compliance_status of this Echo10.
        :rtype: str
        """
    ...
    def fac_compliance_status(self, fac_compliance_status):
        """Sets the fac_compliance_status of this Echo10.
    ...
    @property
    def fac_county(self):
        """Gets the fac_county of this Echo10.

        The county where the facility is located.

        :return: The fac_county of this Echo10.
        :rtype: str
        """
    ...
    def fac_county(self, fac_county):
        """Sets the fac_county of this Echo10.
    ...
    def fac_date_last_formal_act_epa(self, fac_date_last_formal_act_epa):
        """Sets the fac_date_last_formal_act_epa of this Echo10.
    ...
    def fac_date_last_formal_act_st(self, fac_date_last_formal_act_st):
        """Sets the fac_date_last_formal_act_st of this Echo10.
    ...
    def fac_date_last_formal_action(self):
        """Gets the fac_date_last_formal_action of this Echo10.

        Indicates the effective date of the most recent listed enforcement action taken against the facility.

        :return: The fac_date_last_formal_action of this Echo10.
        :rtype: str
        """
    ...
    def fac_date_last_formal_action(self, fac_date_last_formal_action):
        """Sets the fac_date_last_formal_action of this Echo10.
    ...
    def fac_date_last_informal_act_epa(self):
        """Gets the fac_date_last_informal_act_epa of this Echo10.

        Indicates the effective date of the most recent listed informal enforcement action taken against the facility.

        :return: The fac_date_last_informal_act_epa of this Echo10.
        :rtype: str
        """
    ...
    def fac_date_last_informal_act_epa(self, fac_date_last_informal_act_epa):
        """Sets the fac_date_last_informal_act_epa of this Echo10.
    ...
    def fac_date_last_informal_act_st(self, fac_date_last_informal_act_st):
        """Sets the fac_date_last_informal_act_st of this Echo10.
    ...
    def fac_date_last_informal_action(self):
        """Gets the fac_date_last_informal_action of this Echo10.

        The date of the most recent informal action or NOV taken recorded in AFS, ICIS-NPDES, RCRA Info or SDWIS.

        :return: The fac_date_last_informal_action of this Echo10.
        :rtype: str
        """
    ...
    def fac_date_last_informal_action(self, fac_date_last_informal_action):
        """Sets the fac_date_last_informal_action of this Echo10.
    ...
    def fac_date_last_inspection(self):
        """Gets the fac_date_last_inspection of this Echo10.
        ...
        :return: The fac_date_last_inspection of this Echo10.
        :rtype: str
        """
    ...
    def fac_date_last_inspection(self, fac_date_last_inspection):
        """Sets the fac_date_last_inspection of this Echo10.
    ...
    def fac_date_last_inspection_epa(self):
        """Gets the fac_date_last_inspection_epa of this Echo10.

        The date of the facility's last inspection.

        :return: The fac_date_last_inspection_epa of this Echo10.
        :rtype: str
        """
    ...
    def fac_date_last_inspection_epa(self, fac_date_last_inspection_epa):
        """Sets the fac_date_last_inspection_epa of this Echo10.
    ...
    def fac_date_last_inspection_state(self):
        """Gets the fac_date_last_inspection_state of this Echo10.

        The date on which the most recent \"olfficial\"  inspection of the facility by a state agency took place.

        :return: The fac_date_last_inspection_state of this Echo10.
        :rtype: str
        """
    ...
    def fac_date_last_inspection_state(self, fac_date_last_inspection_state):
        """Sets the fac_date_last_inspection_state of this Echo10.
    ...
    def fac_date_last_penalty(self, fac_date_last_penalty):
        """Sets the fac_date_last_penalty of this Echo10.
    ...
    def fac_days_last_inspection(self):
        """Gets the fac_days_last_inspection of this Echo10.
        ...
        :return: The fac_days_last_inspection of this Echo10.
        :rtype: float
        """
    ...
    def fac_days_last_inspection(self, fac_days_last_inspection):
        """Sets the fac_days_last_inspection of this Echo10.

        The number of days from the last ECHO refresh to the date on which the most recent inspection of the facility took place based on data recorded into AFS, ICIS-NPDES, or RCRA Info.

        :param fac_days_last_inspection: The fac_days_last_inspection of this Echo10.
        :type fac_days_last_inspection: float
        """
    ...
    def fac_derived_cb2010(self):
        """Gets the fac_derived_cb2010 of this Echo10.

        The 2010 Census Block derived from the facility coordinate.

        :return: The fac_derived_cb2010 of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_cb2010(self, fac_derived_cb2010):
        """Sets the fac_derived_cb2010 of this Echo10.
    ...
    def fac_derived_cd113(self):
        """Gets the fac_derived_cd113 of this Echo10.

        The 113th Congressional District derived from the facility coordinate.

        :return: The fac_derived_cd113 of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_cd113(self, fac_derived_cd113):
        """Sets the fac_derived_cd113 of this Echo10.
    ...
    def fac_derived_huc(self):
        """Gets the fac_derived_huc of this Echo10.
        ...
        :return: The fac_derived_huc of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_huc(self, fac_derived_huc):
        """Sets the fac_derived_huc of this Echo10.
    ...
    def fac_derived_rad_wbdhu12(self):
        """Gets the fac_derived_rad_wbdhu12 of this Echo10.
        ...
        :return: The fac_derived_rad_wbdhu12 of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_rad_wbdhu12(self, fac_derived_rad_wbdhu12):
        """Sets the fac_derived_rad_wbdhu12 of this Echo10.
    ...
    def fac_derived_rad_wbdhu12_name(self):
        """Gets the fac_derived_rad_wbdhu12_name of this Echo10.
        ...
        :return: The fac_derived_rad_wbdhu12_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_rad_wbdhu12_name(self, fac_derived_rad_wbdhu12_name):
        """Sets the fac_derived_rad_wbdhu12_name of this Echo10.
    ...
    def fac_derived_rad_wbdhu8(self):
        """Gets the fac_derived_rad_wbdhu8 of this Echo10.
        ...
        :return: The fac_derived_rad_wbdhu8 of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_rad_wbdhu8(self, fac_derived_rad_wbdhu8):
        """Sets the fac_derived_rad_wbdhu8 of this Echo10.
    ...
    def fac_derived_rad_wbdhu8_name(self):
        """Gets the fac_derived_rad_wbdhu8_name of this Echo10.
        ...
        :return: The fac_derived_rad_wbdhu8_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_rad_wbdhu8_name(self, fac_derived_rad_wbdhu8_name):
        """Sets the fac_derived_rad_wbdhu8_name of this Echo10.
    ...
    def fac_derived_stcty_fips(self):
        """Gets the fac_derived_stcty_fips of this Echo10.
        ...
        :return: The fac_derived_stcty_fips of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_stcty_fips(self, fac_derived_stcty_fips):
        """Sets the fac_derived_stcty_fips of this Echo10.
    ...
    def fac_derived_tr_ibes(self):
        """Gets the fac_derived_tr_ibes of this Echo10.

        The tribes or tribal territories located within 25 miles of the facility's location.

        :return: The fac_derived_tr_ibes of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_tr_ibes(self, fac_derived_tr_ibes):
        """Sets the fac_derived_tr_ibes of this Echo10.
    ...
    def fac_derived_wbd(self, fac_derived_wbd):
        """Sets the fac_derived_wbd of this Echo10.
    ...
    def fac_derived_wbdhu12_name(self):
        """Gets the fac_derived_wbdhu12_name of this Echo10.

        The Watershed Boundary Dataset name derived from the facility coordinate.

        :return: The fac_derived_wbdhu12_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_wbdhu12_name(self, fac_derived_wbdhu12_name):
        """Sets the fac_derived_wbdhu12_name of this Echo10.
    ...
    def fac_derived_wbdhu8(self):
        """Gets the fac_derived_wbdhu8 of this Echo10.

        Spatially derived HUC based on the facility's geographic coordinates in FRS.

        :return: The fac_derived_wbdhu8 of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_wbdhu8(self, fac_derived_wbdhu8):
        """Sets the fac_derived_wbdhu8 of this Echo10.
    ...
    def fac_derived_wbdhu8_name(self):
        """Gets the fac_derived_wbdhu8_name of this Echo10.
        ...
        :return: The fac_derived_wbdhu8_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_wbdhu8_name(self, fac_derived_wbdhu8_name):
        """Sets the fac_derived_wbdhu8_name of this Echo10.
    ...
    def fac_derived_zip(self):
        """Gets the fac_derived_zip of this Echo10.

        The ZIP Code derived from the facility coordinate.

        :return: The fac_derived_zip of this Echo10.
        :rtype: str
        """
    ...
    def fac_derived_zip(self, fac_derived_zip):
        """Sets the fac_derived_zip of this Echo10.
    ...
    def fac_epa_region(self):
        """Gets the fac_epa_region of this Echo10.
        ...
        :return: The fac_epa_region of this Echo10.
        :rtype: str
        """
    ...
    def fac_epa_region(self, fac_epa_region):
        """Sets the fac_epa_region of this Echo10.
    ...
    def fac_fips_code(self, fac_fips_code):
        """Sets the fac_fips_code of this Echo10.
    ...
    def fac_federal_agency(self):
        """Gets the fac_federal_agency of this Echo10.

        The facility's federal agency code.

        :return: The fac_federal_agency of this Echo10.
        :rtype: str
        """
    ...
    def fac_federal_agency(self, fac_federal_agency):
        """Sets the fac_federal_agency of this Echo10.
    ...
    def fac_federal_agency_name(self):
        """Gets the fac_federal_agency_name of this Echo10.
        ...
        :return: The fac_federal_agency_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_federal_agency_name(self, fac_federal_agency_name):
        """Sets the fac_federal_agency_name of this Echo10.
    ...
    def fac_federal_flg(self):
        """Gets the fac_federal_flg of this Echo10.

        Indicates whether the facility is part of a federal agency.

        :return: The fac_federal_flg of this Echo10.
        :rtype: str
        """
    ...
    def fac_federal_flg(self, fac_federal_flg):
        """Sets the fac_federal_flg of this Echo10.
    ...
    def fac_formal_action_count(self):
        """Gets the fac_formal_action_count of this Echo10.
        ...
        :return: The fac_formal_action_count of this Echo10.
        :rtype: float
        """
    ...
    def fac_formal_action_count(self, fac_formal_action_count):
        """Sets the fac_formal_action_count of this Echo10.

        Indicates the total number of enforcement actions taken against the facility within the last five years. NA indicates that this measure is not applicable for facilities with no associated CAA, CWA, or RCRA permits

        :param fac_formal_action_count: The fac_formal_action_count of this Echo10.
        :type fac_formal_action_count: float
        """
    ...
    def fac_imp_water_flg(self):
        """Gets the fac_imp_water_flg of this Echo10.
        ...
        :return: The fac_imp_water_flg of this Echo10.
        :rtype: str
        """
    ...
    def fac_imp_water_flg(self, fac_imp_water_flg):
        """Sets the fac_imp_water_flg of this Echo10.
    ...
    def fac_indian_cntry_flg(self):
        """Gets the fac_indian_cntry_flg of this Echo10.

        Flag showing Y/N whether the facility is located in Indian Country.

        :return: The fac_indian_cntry_flg of this Echo10.
        :rtype: str
        """
    ...
    def fac_indian_cntry_flg(self, fac_indian_cntry_flg):
        """Sets the fac_indian_cntry_flg of this Echo10.
    ...
    def fac_indian_spatial_flg(self):
        """Gets the fac_indian_spatial_flg of this Echo10.
        ...
        :return: The fac_indian_spatial_flg of this Echo10.
        :rtype: str
        """
    ...
    def fac_indian_spatial_flg(self, fac_indian_spatial_flg):
        """Sets the fac_indian_spatial_flg of this Echo10.
    ...
    def fac_informal_count(self):
        """Gets the fac_informal_count of this Echo10.
        ...
        :return: The fac_informal_count of this Echo10.
        :rtype: float
        """
    ...
    def fac_informal_count(self, fac_informal_count):
        """Sets the fac_informal_count of this Echo10.

        Indicates the total number of informal enforcement actions/notices of violations (NOVs) taken against the facility within the last five years

        :param fac_informal_count: The fac_informal_count of this Echo10.
        :type fac_informal_count: float
        """
    ...
    def fac_inspection_count(self):
        """Gets the fac_inspection_count of this Echo10.
        ...
        :return: The fac_inspection_count of this Echo10.
        :rtype: float
        """
    ...
    def fac_inspection_count(self, fac_inspection_count):
        """Sets the fac_inspection_count of this Echo10.

        The number of inspections/compliance evaluations that have occurred at the facility, under the AIR, CWA, and RCRA, within the last five years. The last 5 years will include data from the 20 most recently completed quarters, plus data from the current quarter up until the refresh date. This count only includes inspection types that are counted as inspections in official counts.

        :param fac_inspection_count: The fac_inspection_count of this Echo10.
        :type fac_inspection_count: float
        """
    ...
    def fac_last_penalty_amt(self, fac_last_penalty_amt):
        """Sets the fac_last_penalty_amt of this Echo10.

        Indicates the dollar amount of the most recent assessed (or final) penalty taken against the facility.

        :param fac_last_penalty_amt: The fac_last_penalty_amt of this Echo10.
        :type fac_last_penalty_amt: float
        """
    ...
    def fac_major_flag(self, fac_major_flag):
        """Sets the fac_major_flag of this Echo10.
    ...
    def fac_map_flg(self, fac_map_flg):
        """Sets the fac_map_flg of this Echo10.
    ...
    def fac_map_icon(self, fac_map_icon):
        """Sets the fac_map_icon of this Echo10.
    ...
    def fac_myrtk_universe(self):
        """Gets the fac_myrtk_universe of this Echo10.
        ...
        :return: The fac_myrtk_universe of this Echo10.
        :rtype: str
        """
    ...
    def fac_myrtk_universe(self, fac_myrtk_universe):
        """Sets the fac_myrtk_universe of this Echo10.
    ...
    def fac_naics_codes(self):
        """Gets the fac_naics_codes of this Echo10.

        The facility's North American Industry Classification System (NAICS) Codes.

        :return: The fac_naics_codes of this Echo10.
        :rtype: str
        """
    ...
    def fac_naics_codes(self, fac_naics_codes):
        """Sets the fac_naics_codes of this Echo10.
    ...
    def fac_naa_flag(self):
        """Gets the fac_naa_flag of this Echo10.
        ...
        :return: The fac_naa_flag of this Echo10.
        :rtype: str
        """
    ...
    def fac_naa_flag(self, fac_naa_flag):
        """Sets the fac_naa_flag of this Echo10.
    ...
    @property
    def fac_name(self):
        """Gets the fac_name of this Echo10.

        Name of facility

        :return: The fac_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_name(self, fac_name):
        """Sets the fac_name of this Echo10.
    ...
    def fac_penalty_count(self, fac_penalty_count):
        """Sets the fac_penalty_count of this Echo10.

        The total number of penalties assessed (or final) taken against the facility within the last five years

        :param fac_penalty_count: The fac_penalty_count of this Echo10.
        :type fac_penalty_count: float
        """
    ...
    def fac_percent_minority(self):
        """Gets the fac_percent_minority of this Echo10.
        ...
        :return: The fac_percent_minority of this Echo10.
        :rtype: float
        """
    ...
    def fac_percent_minority(self, fac_percent_minority):
        """Sets the fac_percent_minority of this Echo10.
    ...
    def fac_pop_den(self):
        """Gets the fac_pop_den of this Echo10.
        ...
        :return: The fac_pop_den of this Echo10.
        :rtype: float
        """
    ...
    def fac_pop_den(self, fac_pop_den):
        """Sets the fac_pop_den of this Echo10.

        The number of persons per square mile in the area being profiled. This field is the ratio of total persons (displayed in the Total Persons field) to total land area (displayed in the Land Area field).

        :param fac_pop_den: The fac_pop_den of this Echo10.
        :type fac_pop_den: float
        """
    ...
    def fac_programs_with_snc(self):
        """Gets the fac_programs_with_snc of this Echo10.


        :return: The fac_programs_with_snc of this Echo10.
        :rtype: float
        """
    ...
    def fac_programs_with_snc(self, fac_programs_with_snc):
        """Sets the fac_programs_with_snc of this Echo10.


        :param fac_programs_with_snc: The fac_programs_with_snc of this Echo10.
        :type fac_programs_with_snc: float
        """
    ...
    def fac_qtrs_with_nc(self):
        """Gets the fac_qtrs_with_nc of this Echo10.


        :return: The fac_qtrs_with_nc of this Echo10.
        :rtype: float
        """
    ...
    def fac_qtrs_with_nc(self, fac_qtrs_with_nc):
        """Sets the fac_qtrs_with_nc of this Echo10.


        :param fac_qtrs_with_nc: The fac_qtrs_with_nc of this Echo10.
        :type fac_qtrs_with_nc: float
        """
    ...
    def fac_reference_point(self):
        """Gets the fac_reference_point of this Echo10.

        A description of the location for the provided facility coordinate.

        :return: The fac_reference_point of this Echo10.
        :rtype: str
        """
    ...
    def fac_reference_point(self, fac_reference_point):
        """Sets the fac_reference_point of this Echo10.
    ...
    def fac_sic_codes(self):
        """Gets the fac_sic_codes of this Echo10.
        ...
        :return: The fac_sic_codes of this Echo10.
        :rtype: str
        """
    ...
    def fac_sic_codes(self, fac_sic_codes):
        """Sets the fac_sic_codes of this Echo10.
    ...
    def fac_snc_flg(self):
        """Gets the fac_snc_flg of this Echo10.

        The Significant Non-compliance (SNC) status for the facility during the most recent quarter reflects the time the records were extracted from the program data systems. \"Y\" indicates the facility is in SNC for the permit or site in question and may pose a more severe level of environmental threat. \"N\" indicates the permit or site is not considered in SNC.

        :return: The fac_snc_flg of this Echo10.
        :rtype: str
        """
    ...
    def fac_snc_flg(self, fac_snc_flg):
        """Sets the fac_snc_flg of this Echo10.
    ...
    @property
    def fac_state(self):
        """Gets the fac_state of this Echo10.

        Facility state

        :return: The fac_state of this Echo10.
        :rtype: str
        """
    ...
    def fac_state(self, fac_state):
        """Sets the fac_state of this Echo10.
    ...
    def fac_std_county_name(self):
        """Gets the fac_std_county_name of this Echo10.

        The standardized  facility county name from EPA's Facility Registry System

        :return: The fac_std_county_name of this Echo10.
        :rtype: str
        """
    ...
    def fac_std_county_name(self, fac_std_county_name):
        """Sets the fac_std_county_name of this Echo10.
    ...
    @property
    def fac_street(self):
        """Gets the fac_street of this Echo10.
        ...
        :return: The fac_street of this Echo10.
        :rtype: str
        """
    ...
    def fac_street(self, fac_street):
        """Sets the fac_street of this Echo10.
    ...
    def fac_total_penalties(self, fac_total_penalties):
        """Sets the fac_total_penalties of this Echo10.

        The total dollar amount of either assessed (or final) penalties taken against the facility within the last five years

        :param fac_total_penalties: The fac_total_penalties of this Echo10.
        :type fac_total_penalties: float
        """
    ...
    def fac_us_mex_border_flg(self):
        """Gets the fac_us_mex_border_flg of this Echo10.

        A Y/N flag indicating that the facility is within 100KM of the US-Mexico Border.

        :return: The fac_us_mex_border_flg of this Echo10.
        :rtype: str
        """
    ...
    def fac_us_mex_border_flg(self, fac_us_mex_border_flg):
        """Sets the fac_us_mex_border_flg of this Echo10.
    ...
    @property
    def fac_zip(self):
        """Gets the fac_zip of this Echo10.

        Facility ZIP code

        :return: The fac_zip of this Echo10.
        :rtype: str
        """
    ...
    def fac_zip(self, fac_zip):
        """Sets the fac_zip of this Echo10.
    ...
    def fec_case_ids(self, fec_case_ids):
        """Sets the fec_case_ids of this Echo10.
    ...
    def fec_last_case_date(self, fec_last_case_date):
        """Sets the fec_last_case_date of this Echo10.
    ...
    def fec_number_of_cases(self):
        """Gets the fec_number_of_cases of this Echo10.


        :return: The fec_number_of_cases of this Echo10.
        :rtype: float
        """
    ...
    def fec_number_of_cases(self, fec_number_of_cases):
        """Sets the fec_number_of_cases of this Echo10.


        :param fec_number_of_cases: The fec_number_of_cases of this Echo10.
        :type fec_number_of_cases: float
        """
    ...
    def fec_total_penalties(self):
        """Gets the fec_total_penalties of this Echo10.


        :return: The fec_total_penalties of this Echo10.
        :rtype: float
        """
    ...
    def fec_total_penalties(self, fec_total_penalties):
        """Sets the fec_total_penalties of this Echo10.


        :param fec_total_penalties: The fec_total_penalties of this Echo10.
        :type fec_total_penalties: float
        """
    ...
    def fifra_inspections5yr(self):
        """Gets the fifra_inspections5yr of this Echo10.

        From ICIS FE&C, the number of FIFRA inspections at the facility in the past five years.

        :return: The fifra_inspections5yr of this Echo10.
        :rtype: str
        """
    ...
    def fifra_inspections5yr(self, fifra_inspections5yr):
        """Sets the fifra_inspections5yr of this Echo10.
    ...
    def ghgco2_releases(self, ghgco2_releases):
        """Sets the ghgco2_releases of this Echo10.
    ...
    @property
    def ghg_flag(self):
        """Gets the ghg_flag of this Echo10.

        Indicates whether the facility has a Greenhouse Gas (GHG) permit.

        :return: The ghg_flag of this Echo10.
        :rtype: str
        """
    ...
    def ghg_flag(self, ghg_flag):
        """Sets the ghg_flag of this Echo10.
    ...
    def ghgids(self, ghgids):
        """Sets the ghgids of this Echo10.
    ...
    def has_poll_rpt(self):
        """Gets the has_poll_rpt of this Echo10.

        ???

        :return: The has_poll_rpt of this Echo10.
        :rtype: str
        """
    ...
    def has_poll_rpt(self, has_poll_rpt):
        """Sets the has_poll_rpt of this Echo10.
    ...
    def infea5yr_flag(self, infea5yr_flag):
        """Sets the infea5yr_flag of this Echo10.
    ...
    def insp5yr_flag(self):
        """Gets the insp5yr_flag of this Echo10.

        Indicates if the facility has an inspection within the last 5 years. 1 = Yes

        :return: The insp5yr_flag of this Echo10.
        :rtype: float
        """
    ...
    def insp5yr_flag(self, insp5yr_flag):
        """Sets the insp5yr_flag of this Echo10.
    ...
    def lower48(self, lower48):
        """Sets the lower48 of this Echo10.
    ...
    def max_pctile_us(self):
        """Gets the max_pctile_us of this Echo10.

        The maximum percentile from all individual EJSCREEN indicators.

        :return: The max_pctile_us of this Echo10.
        :rtype: float
        """
    ...
    def max_pctile_us(self, max_pctile_us):
        """Sets the max_pctile_us of this Echo10.
    ...
    @property
    def max_score(self):
        """Gets the max_score of this Echo10.

        [Col. 121]

        :return: The max_score of this Echo10.
        :rtype: float
        """
    ...
    def max_score(self, max_score):
        """Sets the max_score of this Echo10.
    ...
    @property
    def npdes_flag(self):
        """Gets the npdes_flag of this Echo10.

        Indicates whether the facility has a Clean Water Act (CWA) permit.

        :return: The npdes_flag of this Echo10.
        :rtype: str
        """
    ...
    def npdes_flag(self, npdes_flag):
        """Sets the npdes_flag of this Echo10.
    ...
    @property
    def npdesids(self):
        """Gets the npdesids of this Echo10.
        ...
        :return: The npdesids of this Echo10.
        :rtype: str
        """
    ...
    def npdesids(self, npdesids):
        """Sets the npdesids of this Echo10.
    ...
    def naa_categories(self):
        """Gets the naa_categories of this Echo10.
        ...
        :return: The naa_categories of this Echo10.
        :rtype: str
        """
    ...
    def naa_categories(self, naa_categories):
        """Sets the naa_categories of this Echo10.
    ...
    def naa_pollutants(self):
        """Gets the naa_pollutants of this Echo10.

        All criteria pollutants that the facility is in nonattainment for.

        :return: The naa_pollutants of this Echo10.
        :rtype: str
        """
    ...
    def naa_pollutants(self, naa_pollutants):
        """Sets the naa_pollutants of this Echo10.
    ...
    def over80_count_us(self):
        """Gets the over80_count_us of this Echo10.
        ...
        :return: The over80_count_us of this Echo10.
        :rtype: float
        """
    ...
    def over80_count_us(self, over80_count_us):
        """Sets the over80_count_us of this Echo10.
    ...
    def pctile_cancer_us(self, pctile_cancer_us):
        """Sets the pctile_cancer_us of this Echo10.
    ...
    def pctile_dpm_us(self, pctile_dpm_us):
        """Sets the pctile_dpm_us of this Echo10.
    ...
    def pctile_o3_us(self, pctile_o3_us):
        """Sets the pctile_o3_us of this Echo10.
    ...
    def pctile_pctpre1960_us(self):
        """Gets the pctile_pctpre1960_us of this Echo10.

        The national percentile of the census block group for the EJSCREEN Lead paint indicator.

        :return: The pctile_pctpre1960_us of this Echo10.
        :rtype: float
        """
    ...
    def pctile_pctpre1960_us(self, pctile_pctpre1960_us):
        """Sets the pctile_pctpre1960_us of this Echo10.
    ...
    def pctile_pm_us(self, pctile_pm_us):
        """Sets the pctile_pm_us of this Echo10.
    ...
    def pctile_proximity_npdesus(self, pctile_proximity_npdesus):
        """Sets the pctile_proximity_npdesus of this Echo10.
    ...
    def pctile_proximity_npl_us(self):
        """Gets the pctile_proximity_npl_us of this Echo10.
        ...
        :return: The pctile_proximity_npl_us of this Echo10.
        :rtype: float
        """
    ...
    def pctile_proximity_npl_us(self, pctile_proximity_npl_us):
        """Sets the pctile_proximity_npl_us of this Echo10.
    ...
    def pctile_proximity_rmp_us(self, pctile_proximity_rmp_us):
        """Sets the pctile_proximity_rmp_us of this Echo10.
    ...
    def pctile_proximity_tsdf_us(self):
        """Gets the pctile_proximity_tsdf_us of this Echo10.
        ...
        :return: The pctile_proximity_tsdf_us of this Echo10.
        :rtype: float
        """
    ...
    def pctile_proximity_tsdf_us(self, pctile_proximity_tsdf_us):
        """Sets the pctile_proximity_tsdf_us of this Echo10.
    ...
    def pctile_resp_us(self, pctile_resp_us):
        """Sets the pctile_resp_us of this Echo10.
    ...
    def pctile_traffic_score_us(self, pctile_traffic_score_us):
        """Sets the pctile_traffic_score_us of this Echo10.
    ...
    def rcra3yr_compl_qtrs_history(self):
        """Gets the rcra3yr_compl_qtrs_history of this Echo10.
        ...
        :return: The rcra3yr_compl_qtrs_history of this Echo10.
        :rtype: str
        """
    ...
    def rcra3yr_compl_qtrs_history(self, rcra3yr_compl_qtrs_history):
        """Sets the rcra3yr_compl_qtrs_history of this Echo10.
    ...
    def rcra_compliance_status(self):
        """Gets the rcra_compliance_status of this Echo10.
        ...
        :return: The rcra_compliance_status of this Echo10.
        :rtype: str
        """
    ...
    def rcra_compliance_status(self, rcra_compliance_status):
        """Sets the rcra_compliance_status of this Echo10.
    ...
    def rcra_date_last_formal_action(self):
        """Gets the rcra_date_last_formal_action of this Echo10.

        The effective date of the most recent listed enforcement action entered into the RCRA program database.

        :return: The rcra_date_last_formal_action of this Echo10.
        :rtype: str
        """
    ...
    def rcra_date_last_formal_action(self, rcra_date_last_formal_action):
        """Sets the rcra_date_last_formal_action of this Echo10.
    ...
    def rcra_days_last_evaluation(self):
        """Gets the rcra_days_last_evaluation of this Echo10.


        :return: The rcra_days_last_evaluation of this Echo10.
        :rtype: float
        """
    ...
    def rcra_days_last_evaluation(self, rcra_days_last_evaluation):
        """Sets the rcra_days_last_evaluation of this Echo10.


        :param rcra_days_last_evaluation: The rcra_days_last_evaluation of this Echo10.
        :type rcra_days_last_evaluation: float
        """
    ...
    def rcra_flag(self, rcra_flag):
        """Sets the rcra_flag of this Echo10.
    ...
    def rcra_formal_action_count(self):
        """Gets the rcra_formal_action_count of this Echo10.
        ...
        :return: The rcra_formal_action_count of this Echo10.
        :rtype: str
        """
    ...
    def rcra_formal_action_count(self, rcra_formal_action_count):
        """Sets the rcra_formal_action_count of this Echo10.
    ...
    def rcraids(self, rcraids):
        """Sets the rcraids of this Echo10.
    ...
    def rcra_informal_count(self):
        """Gets the rcra_informal_count of this Echo10.
        ...
        :return: The rcra_informal_count of this Echo10.
        :rtype: str
        """
    ...
    def rcra_informal_count(self, rcra_informal_count):
        """Sets the rcra_informal_count of this Echo10.
    ...
    def rcra_inspection_count(self):
        """Gets the rcra_inspection_count of this Echo10.
        ...
        :return: The rcra_inspection_count of this Echo10.
        :rtype: float
        """
    ...
    def rcra_inspection_count(self, rcra_inspection_count):
        """Sets the rcra_inspection_count of this Echo10.

        The number of inspections/compliance evaluations under the Resource Conservation and Recovery Act, occurring at the facility within the last five years

        :param rcra_inspection_count: The rcra_inspection_count of this Echo10.
        :type rcra_inspection_count: float
        """
    ...
    def rcra_last_penalty_amt(self):
        """Gets the rcra_last_penalty_amt of this Echo10.

        The amount of the most recent penalty entered into the RCRA program database.

        :return: The rcra_last_penalty_amt of this Echo10.
        :rtype: str
        """
    ...
    def rcra_last_penalty_amt(self, rcra_last_penalty_amt):
        """Sets the rcra_last_penalty_amt of this Echo10.
    ...
    def rcra_last_penalty_date(self):
        """Gets the rcra_last_penalty_date of this Echo10.
        ...
        :return: The rcra_last_penalty_date of this Echo10.
        :rtype: str
        """
    ...
    def rcra_last_penalty_date(self, rcra_last_penalty_date):
        """Sets the rcra_last_penalty_date of this Echo10.
    ...
    def rcranaics(self, rcranaics):
        """Sets the rcranaics of this Echo10.
    ...
    def rcra_penalties(self):
        """Gets the rcra_penalties of this Echo10.
        ...
        :return: The rcra_penalties of this Echo10.
        :rtype: str
        """
    ...
    def rcra_penalties(self, rcra_penalties):
        """Sets the rcra_penalties of this Echo10.
    ...
    def rcra_permit_types(self):
        """Gets the rcra_permit_types of this Echo10.
        ...
        :return: The rcra_permit_types of this Echo10.
        :rtype: str
        """
    ...
    def rcra_permit_types(self, rcra_permit_types):
        """Sets the rcra_permit_types of this Echo10.
    ...
    def rcra_qtrs_with_nc(self):
        """Gets the rcra_qtrs_with_nc of this Echo10.


        :return: The rcra_qtrs_with_nc of this Echo10.
        :rtype: float
        """
    ...
    def rcra_qtrs_with_nc(self, rcra_qtrs_with_nc):
        """Sets the rcra_qtrs_with_nc of this Echo10.
    ...
    def rcrasnc_flag(self):
        """Gets the rcrasnc_flag of this Echo10.

        The RCRA Significant Non-compliance (SNC) status for the facility during the most recent quarter reflects the time the records were extracted from the program data systems. \"Y\" indicates the facility is in SNC for the permit or site in question and may pose a more severe level of environmental threat. \"N\" indicates the permit or site is not considered in SNC.

        :return: The rcrasnc_flag of this Echo10.
        :rtype: str
        """
    ...
    def rcrasnc_flag(self, rcrasnc_flag):
        """Sets the rcrasnc_flag of this Echo10.
    ...
    def registry_id(self):
        """Gets the registry_id of this Echo10.
        ...
        :return: The registry_id of this Echo10.
        :rtype: str
        """
    ...
    def registry_id(self, registry_id):
        """Sets the registry_id of this Echo10.
    ...
    def rmp_ids(self, rmp_ids):
        """Sets the rmp_ids of this Echo10.
    ...
    def sdwa3yr_compl_qtrs_history(self):
        """Gets the sdwa3yr_compl_qtrs_history of this Echo10.
        ...
        :return: The sdwa3yr_compl_qtrs_history of this Echo10.
        :rtype: str
        """
    ...
    def sdwa3yr_compl_qtrs_history(self, sdwa3yr_compl_qtrs_history):
        """Sets the sdwa3yr_compl_qtrs_history of this Echo10.
    ...
    def sdwa_compliance_status(self):
        """Gets the sdwa_compliance_status of this Echo10.
        ...
        :return: The sdwa_compliance_status of this Echo10.
        :rtype: str
        """
    ...
    def sdwa_compliance_status(self, sdwa_compliance_status):
        """Sets the sdwa_compliance_status of this Echo10.
    ...
    def sdwa_formal_action_count(self):
        """Gets the sdwa_formal_action_count of this Echo10.
        ...
        :return: The sdwa_formal_action_count of this Echo10.
        :rtype: str
        """
    ...
    def sdwa_formal_action_count(self, sdwa_formal_action_count):
        """Sets the sdwa_formal_action_count of this Echo10.
    ...
    def sdwaids(self, sdwaids):
        """Sets the sdwaids of this Echo10.
    ...
    def sdwa_informal_count(self):
        """Gets the sdwa_informal_count of this Echo10.
        ...
        :return: The sdwa_informal_count of this Echo10.
        :rtype: str
        """
    ...
    def sdwa_informal_count(self, sdwa_informal_count):
        """Sets the sdwa_informal_count of this Echo10.
    ...
    def sdwa_inspections5yr(self):
        """Gets the sdwa_inspections5yr of this Echo10.

        The number of SDWA inspections at the facility in the past five years.

        :return: The sdwa_inspections5yr of this Echo10.
        :rtype: str
        """
    ...
    def sdwa_inspections5yr(self, sdwa_inspections5yr):
        """Sets the sdwa_inspections5yr of this Echo10.
    ...
    def sdwa_qtrs_with_nc(self, sdwa_qtrs_with_nc):
        """Sets the sdwa_qtrs_with_nc of this Echo10.
    ...
    def sdwasnc_flag(self):
        """Gets the sdwasnc_flag of this Echo10.

        Indicates whether the Water System has a Serious Violation.

        :return: The sdwasnc_flag of this Echo10.
        :rtype: str
        """
    ...
    def sdwasnc_flag(self, sdwasnc_flag):
        """Sets the sdwasnc_flag of this Echo10.
    ...
    def sdwa_system_types(self):
        """Gets the sdwa_system_types of this Echo10.

        SDWIS System Types

        :return: The sdwa_system_types of this Echo10.
        :rtype: str
        """
    ...
    def sdwa_system_types(self, sdwa_system_types):
        """Sets the sdwa_system_types of this Echo10.
    ...
    def sdwis_flag(self, sdwis_flag):
        """Sets the sdwis_flag of this Echo10.
    ...
    @property
    def score(self):
        """Gets the score of this Echo10.


        :return: The score of this Echo10.
        :rtype: float
        """
        return self._score
    ...
    @property
    def sems_flag(self):
        """Gets the sems_flag of this Echo10.


        :return: The sems_flag of this Echo10.
        :rtype: str
        """
    ...
    def sems_flag(self, sems_flag):
        """Sets the sems_flag of this Echo10.
    ...
    @property
    def sems_ids(self):
        """Gets the sems_ids of this Echo10.


        :return: The sems_ids of this Echo10.
        :rtype: str
        """
    ...
    def sems_ids(self, sems_ids):
        """Sets the sems_ids of this Echo10.
    ...
    @property
    def source_id(self):
        """Gets the source_id of this Echo10.

        Unique Identifier assigned by EPA.

        :return: The source_id of this Echo10.
        :rtype: str
        """
    ...
    def source_id(self, source_id):
        """Sets the source_id of this Echo10.
    ...
    def tri_flag(self, tri_flag):
        """Sets the tri_flag of this Echo10.
    ...
    @property
    def triids(self):
        """Gets the triids of this Echo10.
        ...
        :return: The triids of this Echo10.
        :rtype: str
        """
        return self._triids
    ...
    def triids(self, triids):
        """Sets the triids of this Echo10.
    ...
    def tri_off_site_transfers(self):
        """Gets the tri_off_site_transfers of this Echo10.


        :return: The tri_off_site_transfers of this Echo10.
        :rtype: float
        """
    ...
    def tri_off_site_transfers(self, tri_off_site_transfers):
        """Sets the tri_off_site_transfers of this Echo10.


        :param tri_off_site_transfers: The tri_off_site_transfers of this Echo10.
        :type tri_off_site_transfers: float
        """
    ...
    def trion_site_releases(self):
        """Gets the trion_site_releases of this Echo10.


        :return: The trion_site_releases of this Echo10.
        :rtype: float
        """
    ...
    def trion_site_releases(self, trion_site_releases):
        """Sets the trion_site_releases of this Echo10.


        :param trion_site_releases: The trion_site_releases of this Echo10.
        :type trion_site_releases: float
        """
    ...
    def tri_releases_transfers(self):
        """Gets the tri_releases_transfers of this Echo10.
        ...
        :return: The tri_releases_transfers of this Echo10.
        :rtype: float
        """
    ...
    def tri_releases_transfers(self, tri_releases_transfers):
        """Sets the tri_releases_transfers of this Echo10.

        Total chemical releases, in pounds, as reported to the Toxics Release Inventory (TRI) by the facility for the most recent reporting year

        :param tri_releases_transfers: The tri_releases_transfers of this Echo10.
        :type tri_releases_transfers: float
        """
    ...
    def tri_reporter(self, tri_reporter):
        """Sets the tri_reporter of this Echo10.
    ...
    def tri_reporter_in_past(self):
        """Gets the tri_reporter_in_past of this Echo10.

        A 'Y' indicates a TRI Reporter from a prior year.

        :return: The tri_reporter_in_past of this Echo10.
        :rtype: str
        """
    ...
    def tri_reporter_in_past(self, tri_reporter_in_past):
        """Sets the tri_reporter_in_past of this Echo10.
    ...
    def tr_ibal_flag(self, tr_ibal_flag):
        """Sets the tr_ibal_flag of this Echo10.
    ...
    @property
    def tsca_flag(self):
        """Gets the tsca_flag of this Echo10.

        Flag indicating whether or not a facility has a TSCA ID

        :return: The tsca_flag of this Echo10.
        :rtype: str
        """
    ...
    def tsca_flag(self, tsca_flag):
        """Sets the tsca_flag of this Echo10.
    ...
    @property
    def tsca_ids(self):
        """Gets the tsca_ids of this Echo10.

        Toxic Substances Control Act ID assigned to a facility

        :return: The tsca_ids of this Echo10.
        :rtype: str
        """
    ...
    def tsca_ids(self, tsca_ids):
        """Sets the tsca_ids of this Echo10.
    ...
    def tsca_inspections5yr(self):
        """Gets the tsca_inspections5yr of this Echo10.

        From ICIS FE&C, the number of TSCA inspections at the facility in the past five years.

        :return: The tsca_inspections5yr of this Echo10.
        :rtype: str
        """
    ...
    def tsca_inspections5yr(self, tsca_inspections5yr):
        """Sets the tsca_inspections5yr of this Echo10.
    ...
    def viol_flag(self, viol_flag):
        """Sets the viol_flag of this Echo10.
    ...
    def web_docs(self, web_docs):
        """Sets the web_docs of this Echo10.
