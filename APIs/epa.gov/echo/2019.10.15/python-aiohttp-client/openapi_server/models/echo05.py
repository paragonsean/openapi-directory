...
class Echo05(Model):
    ...
    def __init__(self, cv_rows: str=None, cluster_count: str=None, cluster_icon: str=None, cluster_latitude: str=None, cluster_longitude: str=None, cluster_name: str=None, cluster_type: str=None, cluster_value: str=None, epa_region_code: str=None, fea_rows: str=None, insp_rows: str=None, indian_country_rows: str=None, inf_fea_rows: str=None, object_id: str=None, sv_rows: str=None, total_penalties: str=None, v3_rows: str=None):
        """Echo05 - a model defined in OpenAPI

        :param cv_rows: The cv_rows of this Echo05.
        :param cluster_count: The cluster_count of this Echo05.
        :param cluster_icon: The cluster_icon of this Echo05.
        :param cluster_latitude: The cluster_latitude of this Echo05.
        :param cluster_longitude: The cluster_longitude of this Echo05.
        :param cluster_name: The cluster_name of this Echo05.
        :param cluster_type: The cluster_type of this Echo05.
        :param cluster_value: The cluster_value of this Echo05.
        :param epa_region_code: The epa_region_code of this Echo05.
        :param fea_rows: The fea_rows of this Echo05.
        :param insp_rows: The insp_rows of this Echo05.
        :param indian_country_rows: The indian_country_rows of this Echo05.
        :param inf_fea_rows: The inf_fea_rows of this Echo05.
        :param object_id: The object_id of this Echo05.
        :param sv_rows: The sv_rows of this Echo05.
        :param total_penalties: The total_penalties of this Echo05.
        :param v3_rows: The v3_rows of this Echo05.
        """
        self.openapi_types = {
            'cv_rows': str,
            'cluster_count': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'Echo05':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The echo05 of this Echo05.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def cv_rows(self):
        """Gets the cv_rows of this Echo05.

        Summary count of the number of CWA facilities or SDWA public drinking water systems with current violations.

        :return: The cv_rows of this Echo05.
        :rtype: str
        """
    ...
    def cv_rows(self, cv_rows):
        """Sets the cv_rows of this Echo05.
    ...
    def cluster_count(self):
        """Gets the cluster_count of this Echo05.

        The number of facilities or cases in the cluster.

        :return: The cluster_count of this Echo05.
        :rtype: str
        """
    ...
    def cluster_count(self, cluster_count):
        """Sets the cluster_count of this Echo05.
    ...
    def cluster_icon(self):
        """Gets the cluster_icon of this Echo05.

        The icon file used to reprsent the cluster.

        :return: The cluster_icon of this Echo05.
        :rtype: str
        """
    ...
    def cluster_icon(self, cluster_icon):
        """Sets the cluster_icon of this Echo05.
    ...
    def cluster_latitude(self):
        """Gets the cluster_latitude of this Echo05.

        The latitude in decimal degrees expressed using the NAD83 horizontal datum.

        :return: The cluster_latitude of this Echo05.
        :rtype: str
        """
    ...
    def cluster_latitude(self, cluster_latitude):
        """Sets the cluster_latitude of this Echo05.
    ...
    def cluster_longitude(self):
        """Gets the cluster_longitude of this Echo05.

        The longitude in decimal degrees expressed using the NAD83 horizontal datum.

        :return: The cluster_longitude of this Echo05.
        :rtype: str
        """
    ...
    def cluster_longitude(self, cluster_longitude):
        """Sets the cluster_longitude of this Echo05.
    ...
    def cluster_name(self, cluster_name):
        """Sets the cluster_name of this Echo05.
    ...
    def cluster_type(self, cluster_type):
        """Sets the cluster_type of this Echo05.
    ...
    def cluster_value(self):
        """Gets the cluster_value of this Echo05.
        ...
        :return: The cluster_value of this Echo05.
        :rtype: str
        """
    ...
    def cluster_value(self, cluster_value):
        """Sets the cluster_value of this Echo05.
    ...
    def epa_region_code(self):
        """Gets the epa_region_code of this Echo05.
        ...
        :return: The epa_region_code of this Echo05.
        :rtype: str
        """
    ...
    def epa_region_code(self, epa_region_code):
        """Sets the epa_region_code of this Echo05.
    ...
    def fea_rows(self, fea_rows):
        """Sets the fea_rows of this Echo05.
    ...
    def insp_rows(self, insp_rows):
        """Sets the insp_rows of this Echo05.
    ...
    def indian_country_rows(self):
        """Gets the indian_country_rows of this Echo05.

        Number of facilities with tribal_flag populated

        :return: The indian_country_rows of this Echo05.
        :rtype: str
        """
    ...
    def indian_country_rows(self, indian_country_rows):
        """Sets the indian_country_rows of this Echo05.
    ...
    def inf_fea_rows(self, inf_fea_rows):
        """Sets the inf_fea_rows of this Echo05.
    ...
    @property
    def object_id(self):
        """Gets the object_id of this Echo05.

        Sequential number assigned to each facility or cluster returned.

        :return: The object_id of this Echo05.
        :rtype: str
        """
    ...
    def object_id(self, object_id):
        """Sets the object_id of this Echo05.
    ...
    def sv_rows(self, sv_rows):
        """Sets the sv_rows of this Echo05.
    ...
    def total_penalties(self, total_penalties):
        """Sets the total_penalties of this Echo05.
    ...
    def v3_rows(self, v3_rows):
        """Sets the v3_rows of this Echo05.
