...
/**
* Enum class FormDataFDescending.
* @enum {}
* @readonly
*/
export default class FormDataFDescending {
    ...
    /**
    * Returns a <code>FormDataFDescending</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFDescending} The enum <code>FormDataFDescending</code> value.
    */
