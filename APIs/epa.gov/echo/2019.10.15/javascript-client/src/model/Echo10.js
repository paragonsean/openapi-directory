...
/**
 * The Echo10 model module.
 * @module model/Echo10
 * @version 2019.10.15
 */
class Echo10 {
    /**
     * Constructs a new <code>Echo10</code>.
     * GeoJSON Properties Object
     * @alias module:model/Echo10
     ...
     * @param cAADaysLastEvaluation {Number} 
     ...
     * @param cAALastPenaltyAmt {Number} 
     ...
     * @param cWA13qtrsEfflntExceedances {Number} The number of effluent violations at the facility in the past 13 quarters.
     ...
     * @param cWADaysLastInspection {Number} 
     ...
     * @param cWAInformalCount {Number} Indicates the number of informal enforcement actions/notices of violations (NOVs) taken against the facility within the last five years under the Clean Water Act.
     * @param cWAInspectionCount {Number} The number of inspections/compliance evaluations under the Clean Water Act, occurring at the facility within the last five years.
     ...
     * @param facAccuracyMeters {Number} 
     ...
     * @param facDaysLastInspection {Number} The number of days from the last ECHO refresh to the date on which the most recent inspection of the facility took place based on data recorded into AFS, ICIS-NPDES, or RCRA Info.
     ...
     * @param facFormalActionCount {Number} Indicates the total number of enforcement actions taken against the facility within the last five years. NA indicates that this measure is not applicable for facilities with no associated CAA, CWA, or RCRA permits
     ...
     * @param facInformalCount {Number} Indicates the total number of informal enforcement actions/notices of violations (NOVs) taken against the facility within the last five years
     * @param facInspectionCount {Number} The number of inspections/compliance evaluations that have occurred at the facility, under the AIR, CWA, and RCRA, within the last five years. The last 5 years will include data from the 20 most recently completed quarters, plus data from the current quarter up until the refresh date. This count only includes inspection types that are counted as inspections in official counts.
     * @param facLastPenaltyAmt {Number} Indicates the dollar amount of the most recent assessed (or final) penalty taken against the facility.
     ...
     * @param facPenaltyCount {Number} The total number of penalties assessed (or final) taken against the facility within the last five years
     ...
     * @param facPopDen {Number} The number of persons per square mile in the area being profiled. This field is the ratio of total persons (displayed in the Total Persons field) to total land area (displayed in the Land Area field).
     * @param facProgramsWithSNC {Number} 
     * @param facQtrsWithNC {Number} 
     ...
     * @param facTotalPenalties {Number} The total dollar amount of either assessed (or final) penalties taken against the facility within the last five years
     ...
     * @param fecNumberOfCases {Number} 
     * @param fecTotalPenalties {Number} 
     ...
     * @param rCRADaysLastEvaluation {Number} 
     ...
     * @param rCRAInspectionCount {Number} The number of inspections/compliance evaluations under the Resource Conservation and Recovery Act, occurring at the facility within the last five years
     ...
     * @param tRIOffSiteTransfers {Number} 
     * @param tRIOnSiteReleases {Number} 
     * @param tRIReleasesTransfers {Number} Total chemical releases, in pounds, as reported to the Toxics Release Inventory (TRI) by the facility for the most recent reporting year
    ...
    constructor(aIRFlag, aIRIDs, activeLower48, biosolidsFlag, cAA3yrComplQtrsHistory, cAAComplianceStatus, cAADateLastFormalAction, cAADaysLastEvaluation, cAAEvaluationCount, cAAFormalActionCount, cAAHpvFlag, cAAInformalCount, cAALastPenaltyAmt, cAALastPenaltyDate, CAANAICS, cAAPenalties, cAAPermitTypes, cAAQtrsWithNC, cAASICs, cWA13qtrsComplHistory, cWA13qtrsEfflntExceedances, cWA3YrQncrCodes, cWAComplianceStatus, cWAComplianceTracking, cWADateLastFormalAction, cWADaysLastInspection, cWAFormalActionCount, cWAInformalCount, cWAInspectionCount, cWALastPenaltyAmt, cWALastPenaltyDate, CWANAICS, cWAPenalties, cWAPermitTypes, cWAQtrsWithNC, cWASICs, cWASNCFlag, camdIDs, censusBlockGroup, currSvFlag, currVioFlag, dfrUrl, ea5yrFlag, effChartsFlag, eisFlag, eisIDs, ejscreenFlag, ejscreenFlagUs, epcraInspections5yr, fac3yrComplianceHistory, facAccuracyMeters, facActiveFlag, facChesapeakeBayFlg, facCity, facCollectionMethod, facComplianceStatus, facCounty, facDateLastFormalActEPA, facDateLastFormalActSt, facDateLastFormalAction, facDateLastInformalActEPA, facDateLastInformalActSt, facDateLastInformalAction, facDateLastInspection, facDateLastInspectionEPA, facDateLastInspectionState, facDateLastPenalty, facDaysLastInspection, facDerivedCb2010, facDerivedCd113, facDerivedHuc, facDerivedRadWBDHu12, facDerivedRadWBDHu12Name, facDerivedRadWBDHu8, facDerivedRadWBDHu8Name, facDerivedStctyFIPS, facDerivedTRIbes, facDerivedWBD, facDerivedWBDHu12Name, facDerivedWBDHu8, facDerivedWBDHu8Name, facDerivedZip, facEPARegion, facFIPSCode, facFederalAgency, facFederalAgencyName, facFederalFlg, facFormalActionCount, facImpWaterFlg, facIndianCntryFlg, facIndianSpatialFlg, facInformalCount, facInspectionCount, facLastPenaltyAmt, facMajorFlag, facMapFlg, facMapIcon, facMyrtkUniverse, facNAICSCodes, facNaaFlag, facName, facPenaltyCount, facPercentMinority, facPopDen, facProgramsWithSNC, facQtrsWithNC, facReferencePoint, facSICCodes, facSNCFlg, facState, facStdCountyName, facStreet, facTotalPenalties, facUsMexBorderFlg, facZip, fecCaseIDs, fecLastCaseDate, fecNumberOfCases, fecTotalPenalties, fifraInspections5yr, gHGCO2Releases, gHGFlag, gHGIDs, hasPollRpt, infea5yrFlag, insp5yrFlag, lower48, maxPctileUs, maxScore, NC, nPDESFlag, nPDESIDs, naaCategories, naaPollutants, over80CountUs, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rCRA3yrComplQtrsHistory, rCRAComplianceStatus, rCRADateLastFormalAction, rCRADaysLastEvaluation, rCRAFlag, rCRAFormalActionCount, rCRAIDs, rCRAInformalCount, rCRAInspectionCount, rCRALastPenaltyAmt, rCRALastPenaltyDate, RCRANAICS, rCRAPenalties, rCRAPermitTypes, rCRAQtrsWithNC, rCRASNCFlag, registryID, rmpIDs, sDWA3yrComplQtrsHistory, sDWAComplianceStatus, sDWAFormalActionCount, sDWAIDs, sDWAInformalCount, sDWAInspections5yr, sDWAQtrsWithNC, sDWASNCFlag, sDWASystemTypes, sDWISFlag, score, semsFlag, semsIDs, sourceID, tRIFlag, tRIIDs, tRIOffSiteTransfers, tRIOnSiteReleases, tRIReleasesTransfers, tRIReporter, tRIReporterInPast, tRIbalFlag, tscaFlag, tscaIDs, tscaInspections5yr, violFlag, webDocs) { 
        ...
        Echo10.initialize(this, aIRFlag, aIRIDs, activeLower48, biosolidsFlag, cAA3yrComplQtrsHistory, cAAComplianceStatus, cAADateLastFormalAction, cAADaysLastEvaluation, cAAEvaluationCount, cAAFormalActionCount, cAAHpvFlag, cAAInformalCount, cAALastPenaltyAmt, cAALastPenaltyDate, CAANAICS, cAAPenalties, cAAPermitTypes, cAAQtrsWithNC, cAASICs, cWA13qtrsComplHistory, cWA13qtrsEfflntExceedances, cWA3YrQncrCodes, cWAComplianceStatus, cWAComplianceTracking, cWADateLastFormalAction, cWADaysLastInspection, cWAFormalActionCount, cWAInformalCount, cWAInspectionCount, cWALastPenaltyAmt, cWALastPenaltyDate, CWANAICS, cWAPenalties, cWAPermitTypes, cWAQtrsWithNC, cWASICs, cWASNCFlag, camdIDs, censusBlockGroup, currSvFlag, currVioFlag, dfrUrl, ea5yrFlag, effChartsFlag, eisFlag, eisIDs, ejscreenFlag, ejscreenFlagUs, epcraInspections5yr, fac3yrComplianceHistory, facAccuracyMeters, facActiveFlag, facChesapeakeBayFlg, facCity, facCollectionMethod, facComplianceStatus, facCounty, facDateLastFormalActEPA, facDateLastFormalActSt, facDateLastFormalAction, facDateLastInformalActEPA, facDateLastInformalActSt, facDateLastInformalAction, facDateLastInspection, facDateLastInspectionEPA, facDateLastInspectionState, facDateLastPenalty, facDaysLastInspection, facDerivedCb2010, facDerivedCd113, facDerivedHuc, facDerivedRadWBDHu12, facDerivedRadWBDHu12Name, facDerivedRadWBDHu8, facDerivedRadWBDHu8Name, facDerivedStctyFIPS, facDerivedTRIbes, facDerivedWBD, facDerivedWBDHu12Name, facDerivedWBDHu8, facDerivedWBDHu8Name, facDerivedZip, facEPARegion, facFIPSCode, facFederalAgency, facFederalAgencyName, facFederalFlg, facFormalActionCount, facImpWaterFlg, facIndianCntryFlg, facIndianSpatialFlg, facInformalCount, facInspectionCount, facLastPenaltyAmt, facMajorFlag, facMapFlg, facMapIcon, facMyrtkUniverse, facNAICSCodes, facNaaFlag, facName, facPenaltyCount, facPercentMinority, facPopDen, facProgramsWithSNC, facQtrsWithNC, facReferencePoint, facSICCodes, facSNCFlg, facState, facStdCountyName, facStreet, facTotalPenalties, facUsMexBorderFlg, facZip, fecCaseIDs, fecLastCaseDate, fecNumberOfCases, fecTotalPenalties, fifraInspections5yr, gHGCO2Releases, gHGFlag, gHGIDs, hasPollRpt, infea5yrFlag, insp5yrFlag, lower48, maxPctileUs, maxScore, NC, nPDESFlag, nPDESIDs, naaCategories, naaPollutants, over80CountUs, pctileCancerUs, pctileDpmUs, pctileO3Us, pctilePctpre1960Us, pctilePmUs, pctileProximityNPDESUs, pctileProximityNplUs, pctileProximityRmpUs, pctileProximityTsdfUs, pctileRespUs, pctileTrafficScoreUs, rCRA3yrComplQtrsHistory, rCRAComplianceStatus, rCRADateLastFormalAction, rCRADaysLastEvaluation, rCRAFlag, rCRAFormalActionCount, rCRAIDs, rCRAInformalCount, rCRAInspectionCount, rCRALastPenaltyAmt, rCRALastPenaltyDate, RCRANAICS, rCRAPenalties, rCRAPermitTypes, rCRAQtrsWithNC, rCRASNCFlag, registryID, rmpIDs, sDWA3yrComplQtrsHistory, sDWAComplianceStatus, sDWAFormalActionCount, sDWAIDs, sDWAInformalCount, sDWAInspections5yr, sDWAQtrsWithNC, sDWASNCFlag, sDWASystemTypes, sDWISFlag, score, semsFlag, semsIDs, sourceID, tRIFlag, tRIIDs, tRIOffSiteTransfers, tRIOnSiteReleases, tRIReleasesTransfers, tRIReporter, tRIReporterInPast, tRIbalFlag, tscaFlag, tscaIDs, tscaInspections5yr, violFlag, webDocs);
    }
    ...
    /**
     * Constructs a <code>Echo10</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Echo10} obj Optional instance to populate.
     * @return {module:model/Echo10} The populated <code>Echo10</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CAADaysLastEvaluation')) {
                obj['CAADaysLastEvaluation'] = ApiClient.convertToType(data['CAADaysLastEvaluation'], 'Number');
            }
            ...
            if (data.hasOwnProperty('CAALastPenaltyAmt')) {
                obj['CAALastPenaltyAmt'] = ApiClient.convertToType(data['CAALastPenaltyAmt'], 'Number');
            }
            ...
            if (data.hasOwnProperty('CAAQtrsWithNC')) {
                obj['CAAQtrsWithNC'] = ApiClient.convertToType(data['CAAQtrsWithNC'], 'Number');
            }
            ...
            if (data.hasOwnProperty('CWA13qtrsEfflntExceedances')) {
                obj['CWA13qtrsEfflntExceedances'] = ApiClient.convertToType(data['CWA13qtrsEfflntExceedances'], 'Number');
            }
            ...
            if (data.hasOwnProperty('CWADaysLastInspection')) {
                obj['CWADaysLastInspection'] = ApiClient.convertToType(data['CWADaysLastInspection'], 'Number');
            }
            ...
            if (data.hasOwnProperty('CWAInformalCount')) {
                obj['CWAInformalCount'] = ApiClient.convertToType(data['CWAInformalCount'], 'Number');
            }
            if (data.hasOwnProperty('CWAInspectionCount')) {
                obj['CWAInspectionCount'] = ApiClient.convertToType(data['CWAInspectionCount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacAccuracyMeters')) {
                obj['FacAccuracyMeters'] = ApiClient.convertToType(data['FacAccuracyMeters'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacDaysLastInspection')) {
                obj['FacDaysLastInspection'] = ApiClient.convertToType(data['FacDaysLastInspection'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacFormalActionCount')) {
                obj['FacFormalActionCount'] = ApiClient.convertToType(data['FacFormalActionCount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacInformalCount')) {
                obj['FacInformalCount'] = ApiClient.convertToType(data['FacInformalCount'], 'Number');
            }
            if (data.hasOwnProperty('FacInspectionCount')) {
                obj['FacInspectionCount'] = ApiClient.convertToType(data['FacInspectionCount'], 'Number');
            }
            if (data.hasOwnProperty('FacLastPenaltyAmt')) {
                obj['FacLastPenaltyAmt'] = ApiClient.convertToType(data['FacLastPenaltyAmt'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacPenaltyCount')) {
                obj['FacPenaltyCount'] = ApiClient.convertToType(data['FacPenaltyCount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacPopDen')) {
                obj['FacPopDen'] = ApiClient.convertToType(data['FacPopDen'], 'Number');
            }
            if (data.hasOwnProperty('FacProgramsWithSNC')) {
                obj['FacProgramsWithSNC'] = ApiClient.convertToType(data['FacProgramsWithSNC'], 'Number');
            }
            if (data.hasOwnProperty('FacQtrsWithNC')) {
                obj['FacQtrsWithNC'] = ApiClient.convertToType(data['FacQtrsWithNC'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FacTotalPenalties')) {
                obj['FacTotalPenalties'] = ApiClient.convertToType(data['FacTotalPenalties'], 'Number');
            }
            ...
            if (data.hasOwnProperty('FecNumberOfCases')) {
                obj['FecNumberOfCases'] = ApiClient.convertToType(data['FecNumberOfCases'], 'Number');
            }
            if (data.hasOwnProperty('FecTotalPenalties')) {
                obj['FecTotalPenalties'] = ApiClient.convertToType(data['FecTotalPenalties'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRADaysLastEvaluation')) {
                obj['RCRADaysLastEvaluation'] = ApiClient.convertToType(data['RCRADaysLastEvaluation'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRAInspectionCount')) {
                obj['RCRAInspectionCount'] = ApiClient.convertToType(data['RCRAInspectionCount'], 'Number');
            }
            ...
            if (data.hasOwnProperty('RCRAQtrsWithNC')) {
                obj['RCRAQtrsWithNC'] = ApiClient.convertToType(data['RCRAQtrsWithNC'], 'Number');
            }
            ...
            if (data.hasOwnProperty('TRIOffSiteTransfers')) {
                obj['TRIOffSiteTransfers'] = ApiClient.convertToType(data['TRIOffSiteTransfers'], 'Number');
            }
            if (data.hasOwnProperty('TRIOnSiteReleases')) {
                obj['TRIOnSiteReleases'] = ApiClient.convertToType(data['TRIOnSiteReleases'], 'Number');
            }
            if (data.hasOwnProperty('TRIReleasesTransfers')) {
                obj['TRIReleasesTransfers'] = ApiClient.convertToType(data['TRIReleasesTransfers'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Echo10</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Echo10</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Echo10.RequiredProperties) {
...
Echo10.RequiredProperties = ["AIRFlag", "AIRIDs", "ActiveLower48", "BiosolidsFlag", "CAA3yrComplQtrsHistory", "CAAComplianceStatus", "CAADateLastFormalAction", "CAADaysLastEvaluation", "CAAEvaluationCount", "CAAFormalActionCount", "CAAHpvFlag", "CAAInformalCount", "CAALastPenaltyAmt", "CAALastPenaltyDate", "CAANAICS", "CAAPenalties", "CAAPermitTypes", "CAAQtrsWithNC", "CAASICs", "CWA13qtrsComplHistory", "CWA13qtrsEfflntExceedances", "CWA3YrQncrCodes", "CWAComplianceStatus", "CWAComplianceTracking", "CWADateLastFormalAction", "CWADaysLastInspection", "CWAFormalActionCount", "CWAInformalCount", "CWAInspectionCount", "CWALastPenaltyAmt", "CWALastPenaltyDate", "CWANAICS", "CWAPenalties", "CWAPermitTypes", "CWAQtrsWithNC", "CWASICs", "CWASNCFlag", "CamdIDs", "CensusBlockGroup", "CurrSvFlag", "CurrVioFlag", "DfrUrl", "Ea5yrFlag", "EffChartsFlag", "EisFlag", "EisIDs", "EjscreenFlag", "EjscreenFlagUs", "EpcraInspections5yr", "Fac3yrComplianceHistory", "FacAccuracyMeters", "FacActiveFlag", "FacChesapeakeBayFlg", "FacCity", "FacCollectionMethod", "FacComplianceStatus", "FacCounty", "FacDateLastFormalActEPA", "FacDateLastFormalActSt", "FacDateLastFormalAction", "FacDateLastInformalActEPA", "FacDateLastInformalActSt", "FacDateLastInformalAction", "FacDateLastInspection", "FacDateLastInspectionEPA", "FacDateLastInspectionState", "FacDateLastPenalty", "FacDaysLastInspection", "FacDerivedCb2010", "FacDerivedCd113", "FacDerivedHuc", "FacDerivedRadWBDHu12", "FacDerivedRadWBDHu12Name", "FacDerivedRadWBDHu8", "FacDerivedRadWBDHu8Name", "FacDerivedStctyFIPS", "FacDerivedTRIbes", "FacDerivedWBD", "FacDerivedWBDHu12Name", "FacDerivedWBDHu8", "FacDerivedWBDHu8Name", "FacDerivedZip", "FacEPARegion", "FacFIPSCode", "FacFederalAgency", "FacFederalAgencyName", "FacFederalFlg", "FacFormalActionCount", "FacImpWaterFlg", "FacIndianCntryFlg", "FacIndianSpatialFlg", "FacInformalCount", "FacInspectionCount", "FacLastPenaltyAmt", "FacMajorFlag", "FacMapFlg", "FacMapIcon", "FacMyrtkUniverse", "FacNAICSCodes", "FacNaaFlag", "FacName", "FacPenaltyCount", "FacPercentMinority", "FacPopDen", "FacProgramsWithSNC", "FacQtrsWithNC", "FacReferencePoint", "FacSICCodes", "FacSNCFlg", "FacState", "FacStdCountyName", "FacStreet", "FacTotalPenalties", "FacUsMexBorderFlg", "FacZip", "FecCaseIDs", "FecLastCaseDate", "FecNumberOfCases", "FecTotalPenalties", "FifraInspections5yr", "GHGCO2Releases", "GHGFlag", "GHGIDs", "HasPollRpt", "Infea5yrFlag", "Insp5yrFlag", "Lower48", "MaxPctileUs", "MaxScore", "NC", "NPDESFlag", "NPDESIDs", "NaaCategories", "NaaPollutants", "Over80CountUs", "PctileCancerUs", "PctileDpmUs", "PctileO3Us", "PctilePctpre1960Us", "PctilePmUs", "PctileProximityNPDESUs", "PctileProximityNplUs", "PctileProximityRmpUs", "PctileProximityTsdfUs", "PctileRespUs", "PctileTrafficScoreUs", "RCRA3yrComplQtrsHistory", "RCRAComplianceStatus", "RCRADateLastFormalAction", "RCRADaysLastEvaluation", "RCRAFlag", "RCRAFormalActionCount", "RCRAIDs", "RCRAInformalCount", "RCRAInspectionCount", "RCRALastPenaltyAmt", "RCRALastPenaltyDate", "RCRANAICS", "RCRAPenalties", "RCRAPermitTypes", "RCRAQtrsWithNC", "RCRASNCFlag", "RegistryID", "RmpIDs", "SDWA3yrComplQtrsHistory", "SDWAComplianceStatus", "SDWAFormalActionCount", "SDWAIDs", "SDWAInformalCount", "SDWAInspections5yr", "SDWAQtrsWithNC", "SDWASNCFlag", "SDWASystemTypes", "SDWISFlag", "Score", "SemsFlag", "SemsIDs", "SourceID", "TRIFlag", "TRIIDs", "TRIOffSiteTransfers", "TRIOnSiteReleases", "TRIReleasesTransfers", "TRIReporter", "TRIReporterInPast", "TRIbalFlag", "TscaFlag", "TscaIDs", "TscaInspections5yr", "ViolFlag", "WebDocs"];

/**
 * Indicates whether the facility has a Clean Air Act (CAA) permit.
 * @member {String} AIRFlag
 */
Echo10.prototype['AIRFlag'] = undefined;

/**
 * Air Facility System (AFS) ID.
 * @member {String} AIRIDs
 */
Echo10.prototype['AIRIDs'] = undefined;
 ...
 */
Echo10.prototype['CAADateLastFormalAction'] = undefined;

/**
 * @member {Number} CAADaysLastEvaluation
 */
Echo10.prototype['CAADaysLastEvaluation'] = undefined;
 ...
 */
Echo10.prototype['CAAEvaluationCount'] = undefined;
 ...
 */
Echo10.prototype['CAAFormalActionCount'] = undefined;

/**
 * The High Priority Violator (HPV) status for the facility during the most recent quarter reflects the time the records were extracted from the program data system. \"Y\" indicates the facility is in HPV for the permit or site in question and may pose a more severe level of environmental threat. \"N\" indicates the permit or site is not considered in HPV.
 * @member {String} CAAHpvFlag
 */
Echo10.prototype['CAAHpvFlag'] = undefined;
 ...
 */
Echo10.prototype['CAAPenalties'] = undefined;
 ...
 */
Echo10.prototype['CAAPermitTypes'] = undefined;

/**
 * @member {Number} CAAQtrsWithNC
 */
Echo10.prototype['CAAQtrsWithNC'] = undefined;

/**
 * The CAA permit's primary Standard Industrial Classification (SIC) Codes.
 * @member {String} CAASICs
 */
Echo10.prototype['CAASICs'] = undefined;

/**
 * The facility's 3-year compliance status history by quarter (3-month period) entered in the CWA program database. Each character represents a quarter of compliance, going from oldest to most recent. Character values correspond to the following compliance statuses: _ -�No Violation V -�Violation S -�Significant Violation U - Undetermined
 * @member {String} CWA13qtrsComplHistory
 */
Echo10.prototype['CWA13qtrsComplHistory'] = undefined;

/**
 * The number of effluent violations at the facility in the past 13 quarters.
 * @member {Number} CWA13qtrsEfflntExceedances
 */
Echo10.prototype['CWA13qtrsEfflntExceedances'] = undefined;

/**
 * No longer used.  Will be deleted in nthe future.
 * @member {String} CWA3YrQncrCodes
 */
Echo10.prototype['CWA3YrQncrCodes'] = undefined;

/**
 * An indication of the facility's compliance status under the Clean Water Act. When a major source is in significant noncompliance (SNC) or a non-major source has a Category I violation, the specific type of SNC/Category I will be displayed. If more than one type applies to a facility, this order of priority is used to determine which code appears: S(CSchVio) - an enforcement action has been issued, and the facility is not meeting its compliance schedule E(EffViol) - effluent violations of monthly average limits X(EffNMth) - effluent violations of non-monthly average limits T(CSchRpt) - compliance schedule reporting violation D(DMR NR) - non-receipt of discharge monitoring report
 * @member {String} CWAComplianceStatus
 */
Echo10.prototype['CWAComplianceStatus'] = undefined;
 ...
 */
Echo10.prototype['CWAComplianceTracking'] = undefined;
 ...
 */
Echo10.prototype['CWADateLastFormalAction'] = undefined;

/**
 * @member {Number} CWADaysLastInspection
 */
Echo10.prototype['CWADaysLastInspection'] = undefined;
 ...
 */
Echo10.prototype['CWAFormalActionCount'] = undefined;
 ...
 * @member {Number} CWAInformalCount
 */
Echo10.prototype['CWAInformalCount'] = undefined;
 ...
 */
Echo10.prototype['Fac3yrComplianceHistory'] = undefined;

/**
 * @member {Number} FacAccuracyMeters
 */
Echo10.prototype['FacAccuracyMeters'] = undefined;
 ...
 */
Echo10.prototype['FacActiveFlag'] = undefined;
 ...
 */
Echo10.prototype['FacChesapeakeBayFlg'] = undefined;

/**
 * The city where the facility is located.
 * @member {String} FacCity
 */
Echo10.prototype['FacCity'] = undefined;
 ...
 */
Echo10.prototype['FacCollectionMethod'] = undefined;

/**
 * An indication of the facility's known overall compliance status. Status codes include: SNC/Serious Viol [significant noncompliance (SNC), high priority violation (HPV), or serious violator, depending on statute] In Violation (in violation of an environmental regulation) No Violation (no violations recorded in the national systems of record) Not Available Unknown
 * @member {String} FacComplianceStatus
 */
Echo10.prototype['FacComplianceStatus'] = undefined;

/**
 * The county where the facility is located.
 * @member {String} FacCounty
 */
Echo10.prototype['FacCounty'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastFormalActEPA'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastFormalActSt'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastFormalAction'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastInformalActEPA'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastInformalActSt'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastInspectionState'] = undefined;
 ...
 */
Echo10.prototype['FacDateLastPenalty'] = undefined;
 ...
 */
Echo10.prototype['FacDerivedHuc'] = undefined;
 ...
 */
Echo10.prototype['FacDerivedRadWBDHu12'] = undefined;
 ...
 */
Echo10.prototype['FacDerivedRadWBDHu12Name'] = undefined;
 ...
 */
Echo10.prototype['FacDerivedRadWBDHu8'] = undefined;
 ...
 */
Echo10.prototype['FacDerivedRadWBDHu8Name'] = undefined;
 ...
 */
Echo10.prototype['FacDerivedWBDHu8Name'] = undefined;

/**
 * The ZIP Code derived from the facility coordinate.
 * @member {String} FacDerivedZip
 */
Echo10.prototype['FacDerivedZip'] = undefined;
 ...
 */
Echo10.prototype['FacEPARegion'] = undefined;
 ...
 */
Echo10.prototype['FacFIPSCode'] = undefined;

/**
 * The facility's federal agency code.
 * @member {String} FacFederalAgency
 */
Echo10.prototype['FacFederalAgency'] = undefined;
 ...
 */
Echo10.prototype['FacFederalAgencyName'] = undefined;

/**
 * Indicates whether the facility is part of a federal agency.
 * @member {String} FacFederalFlg
 */
Echo10.prototype['FacFederalFlg'] = undefined;
 ...
 * @member {Number} FacFormalActionCount
 */
Echo10.prototype['FacFormalActionCount'] = undefined;
 ...
 */
Echo10.prototype['FacIndianSpatialFlg'] = undefined;
 ...
 */
Echo10.prototype['FacNaaFlag'] = undefined;

/**
 * Name of facility
 * @member {String} FacName
 */
Echo10.prototype['FacName'] = undefined;

/**
 * The total number of penalties assessed (or final) taken against the facility within the last five years
 * @member {Number} FacPenaltyCount
 */
Echo10.prototype['FacPenaltyCount'] = undefined;
 ...
 */
Echo10.prototype['FacPercentMinority'] = undefined;
 ...
 * @member {Number} FacPopDen
 */
Echo10.prototype['FacPopDen'] = undefined;

/**
 * @member {Number} FacProgramsWithSNC
 */
Echo10.prototype['FacProgramsWithSNC'] = undefined;

/**
 * @member {Number} FacQtrsWithNC
 */
Echo10.prototype['FacQtrsWithNC'] = undefined;

/**
 * A description of the location for the provided facility coordinate.
 * @member {String} FacReferencePoint
 */
Echo10.prototype['FacReferencePoint'] = undefined;
 ...
 */
Echo10.prototype['NPDESIDs'] = undefined;
 ...
 */
Echo10.prototype['Over80CountUs'] = undefined;
 ...
 */
Echo10.prototype['PctileCancerUs'] = undefined;
 ...
 */
Echo10.prototype['PctileProximityNPDESUs'] = undefined;
 ...
 */
Echo10.prototype['PctileProximityNplUs'] = undefined;
 ...
 */
Echo10.prototype['PctileProximityRmpUs'] = undefined;
 ...
 */
Echo10.prototype['PctileProximityTsdfUs'] = undefined;
 ...
 */
Echo10.prototype['PctileRespUs'] = undefined;
 ...
 */
Echo10.prototype['RCRAComplianceStatus'] = undefined;
 ...
 */
Echo10.prototype['RCRADateLastFormalAction'] = undefined;

/**
 * @member {Number} RCRADaysLastEvaluation
 */
Echo10.prototype['RCRADaysLastEvaluation'] = undefined;

/**
 * Indicates whether the facility has a Resource Conservation and Recovery Action (RCRA) permit.
 * @member {String} RCRAFlag
 */
Echo10.prototype['RCRAFlag'] = undefined;
 ...
 */
Echo10.prototype['RCRAInformalCount'] = undefined;
 ...
 * @member {Number} RCRAInspectionCount
 */
Echo10.prototype['RCRAInspectionCount'] = undefined;

/**
 * The amount of the most recent penalty entered into the RCRA program database.
 * @member {String} RCRALastPenaltyAmt
 */
Echo10.prototype['RCRALastPenaltyAmt'] = undefined;
 ...
 */
Echo10.prototype['RCRAPenalties'] = undefined;
 ...
 */
Echo10.prototype['RCRAPermitTypes'] = undefined;

/**
 * @member {Number} RCRAQtrsWithNC
 */
Echo10.prototype['RCRAQtrsWithNC'] = undefined;

/**
 * The RCRA Significant Non-compliance (SNC) status for the facility during the most recent quarter reflects the time the records were extracted from the program data systems. \"Y\" indicates the facility is in SNC for the permit or site in question and may pose a more severe level of environmental threat. \"N\" indicates the permit or site is not considered in SNC.
 * @member {String} RCRASNCFlag
 */
Echo10.prototype['RCRASNCFlag'] = undefined;
 ...
 */
Echo10.prototype['RegistryID'] = undefined;
 ...
 */
Echo10.prototype['RmpIDs'] = undefined;

/**
 * The system's 3-year compliance status history by quarter (3-month period). Each character represents a quarter of compliance, going from oldest to most recent. Character values correspond to the following compliance statuses: _ - No Violation Identified V - Noncompliance S - Significant Noncompliance U - Undetermined
 * @member {String} SDWA3yrComplQtrsHistory
 */
Echo10.prototype['SDWA3yrComplQtrsHistory'] = undefined;
 ...
 */
Echo10.prototype['SDWAComplianceStatus'] = undefined;
 ...
 */
Echo10.prototype['SDWAFormalActionCount'] = undefined;
 ...
 */
Echo10.prototype['SDWAIDs'] = undefined;
 ...
 */
Echo10.prototype['TRIIDs'] = undefined;

/**
 * @member {Number} TRIOffSiteTransfers
 */
Echo10.prototype['TRIOffSiteTransfers'] = undefined;

/**
 * @member {Number} TRIOnSiteReleases
 */
Echo10.prototype['TRIOnSiteReleases'] = undefined;
 ...
 * @member {Number} TRIReleasesTransfers
 */
Echo10.prototype['TRIReleasesTransfers'] = undefined;
 ...
 */
Echo10.prototype['TRIReporter'] = undefined;

/**
 * A 'Y' indicates a TRI Reporter from a prior year.
 * @member {String} TRIReporterInPast
 */
Echo10.prototype['TRIReporterInPast'] = undefined;
