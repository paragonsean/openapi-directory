...
/**
 * The Echo11 model module.
 * @module model/Echo11
 * @version 2019.10.15
 */
class Echo11 {
    /**
     * Constructs a new <code>Echo11</code>.
     * Results Object
     * @alias module:model/Echo11
     * @param facilities {Array.<module:model/Echo03>} A complex array of facility information.
    ...
    constructor(facilities, message, pageNo, queryID, queryRows) { 
        ...
        Echo11.initialize(this, facilities, message, pageNo, queryID, queryRows);
    }
    ...
    /**
     * Constructs a <code>Echo11</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Echo11} obj Optional instance to populate.
     * @return {module:model/Echo11} The populated <code>Echo11</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Echo11</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Echo11</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Echo11.RequiredProperties) {
