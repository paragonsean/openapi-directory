...
/**
* Enum class FormDataFPOct.
* @enum {}
* @readonly
*/
export default class FormDataFPOct {
    ...
    /**
    * Returns a <code>FormDataFPOct</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPOct} The enum <code>FormDataFPOct</code> value.
    */
