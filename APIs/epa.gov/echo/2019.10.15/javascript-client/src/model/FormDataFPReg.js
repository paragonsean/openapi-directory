...
/**
* Enum class FormDataFPReg.
* @enum {}
* @readonly
*/
export default class FormDataFPReg {
    ...
    /**
    * Returns a <code>FormDataFPReg</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPReg} The enum <code>FormDataFPReg</code> value.
    */
