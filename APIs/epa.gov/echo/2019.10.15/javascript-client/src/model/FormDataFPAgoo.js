...
/**
* Enum class FormDataFPAgoo.
* @enum {}
* @readonly
*/
export default class FormDataFPAgoo {
    ...
    /**
    * Returns a <code>FormDataFPAgoo</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPAgoo} The enum <code>FormDataFPAgoo</code> value.
    */
