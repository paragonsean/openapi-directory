...
import Echo01 from './Echo01';

/**
 * The Echo02 model module.
 * @module model/Echo02
 * @version 2019.10.15
 */
class Echo02 {
    /**
     * Constructs a new <code>Echo02</code>.
     * Map Output Object
     * @alias module:model/Echo02
     * @param iconBaseURL {String} URL where all the icons are located
     * @param mapData {Array.<module:model/Echo01>} An array of facility geospatial information.
    ...
    constructor(iconBaseURL, mapData, popUpBaseURL, queryID) { 
        ...
        Echo02.initialize(this, iconBaseURL, mapData, popUpBaseURL, queryID);
    }
    ...
    /**
     * Constructs a <code>Echo02</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Echo02} obj Optional instance to populate.
     * @return {module:model/Echo02} The populated <code>Echo02</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MapData')) {
                obj['MapData'] = ApiClient.convertToType(data['MapData'], [Echo01]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Echo02</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Echo02</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Echo02.RequiredProperties) {
...
Echo02.RequiredProperties = ["IconBaseURL", "MapData", "PopUpBaseURL", "QueryID"];

/**
 * URL where all the icons are located
 * @member {String} IconBaseURL
 */
Echo02.prototype['IconBaseURL'] = undefined;

/**
 * An array of facility geospatial information.
 * @member {Array.<module:model/Echo01>} MapData
 */
Echo02.prototype['MapData'] = undefined;

/**
 * Combine this URL with the PUC to get popup info
 * @member {String} PopUpBaseURL
 */
Echo02.prototype['PopUpBaseURL'] = undefined;

/**
 * Sequential number assigned to entire search result
 * @member {String} QueryID
 */
Echo02.prototype['QueryID'] = undefined;
