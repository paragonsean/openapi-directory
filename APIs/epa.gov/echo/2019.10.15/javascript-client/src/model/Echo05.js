...
/**
 * The Echo05 model module.
 * @module model/Echo05
 * @version 2019.10.15
 */
class Echo05 {
    /**
     * Constructs a new <code>Echo05</code>.
     * Cluster Data Object
     * @alias module:model/Echo05
    ...
    constructor(cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows) { 
        ...
        Echo05.initialize(this, cVRows, clusterCount, clusterIcon, clusterLatitude, clusterLongitude, clusterName, clusterType, clusterValue, ePARegionCode, fEARows, iNSPRows, indianCountryRows, infFEARows, objectId, sVRows, totalPenalties, v3Rows);
    }
    ...
    /**
     * Constructs a <code>Echo05</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Echo05} obj Optional instance to populate.
     * @return {module:model/Echo05} The populated <code>Echo05</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Echo05</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Echo05</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Echo05.RequiredProperties) {
...
Echo05.RequiredProperties = ["CVRows", "ClusterCount", "ClusterIcon", "ClusterLatitude", "ClusterLongitude", "ClusterName", "ClusterType", "ClusterValue", "EPARegionCode", "FEARows", "INSPRows", "IndianCountryRows", "InfFEARows", "ObjectId", "SVRows", "TotalPenalties", "V3Rows"];
 ...
 */
Echo05.prototype['ClusterValue'] = undefined;
