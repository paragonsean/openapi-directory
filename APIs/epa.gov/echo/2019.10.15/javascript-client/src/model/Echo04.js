...
import Echo02 from './Echo02';
import Echo03 from './Echo03';

/**
 * The Echo04 model module.
 * @module model/Echo04
 * @version 2019.10.15
 */
class Echo04 {
    /**
     * Constructs a new <code>Echo04</code>.
     * Results Object
     * @alias module:model/Echo04
     ...
     */
    constructor(badSystemIDs, cAARows, cVRows, cWARows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, rCRRows, sVRows, tRIRows, totalPenalties, v3Rows, version) { 
        
        Echo04.initialize(this, badSystemIDs, cAARows, cVRows, cWARows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, rCRRows, sVRows, tRIRows, totalPenalties, v3Rows, version);
    }
     ...
     */
    static initialize(obj, badSystemIDs, cAARows, cVRows, cWARows, fEARows, iNSPRows, indianCountryRows, infFEARows, message, pageNo, queryID, queryRows, rCRRows, sVRows, tRIRows, totalPenalties, v3Rows, version) { 
    ...
    /**
     * Constructs a <code>Echo04</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Echo04} obj Optional instance to populate.
     * @return {module:model/Echo04} The populated <code>Echo04</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Facilities')) {
                obj['Facilities'] = ApiClient.convertToType(data['Facilities'], [Echo03]);
            }
            ...
            if (data.hasOwnProperty('MapOutput')) {
                obj['MapOutput'] = Echo02.constructFromObject(data['MapOutput']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>Echo04</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Echo04</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Echo04.RequiredProperties) {
        ...
        if (data['MapOutput']) { // data not null
          Echo02.validateJSON(data['MapOutput']);
        }
        // ensure the json data is a string
...
Echo04.RequiredProperties = ["BadSystemIDs", "CAARows", "CVRows", "CWARows", "FEARows", "INSPRows", "IndianCountryRows", "InfFEARows", "Message", "PageNo", "QueryID", "QueryRows", "RCRRows", "SVRows", "TRIRows", "TotalPenalties", "V3Rows", "Version"];

/**
 * Identifies which passed query system identifiers are invalid.
 * @member {String} BadSystemIDs
 */
Echo04.prototype['BadSystemIDs'] = undefined;

/**
 * The number of facilities or cases within the result set that have Clean Air Act (CAA) permits.
 * @member {String} CAARows
 */
Echo04.prototype['CAARows'] = undefined;
