...
/**
* Enum class FormDataFPCs.
* @enum {}
* @readonly
*/
export default class FormDataFPCs {
    ...
    /**
    * Returns a <code>FormDataFPCs</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/FormDataFPCs} The enum <code>FormDataFPCs</code> value.
    */
