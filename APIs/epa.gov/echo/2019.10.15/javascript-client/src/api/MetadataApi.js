...
export default class MetadataApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the echoRestServicesMetadataGet operation.
     * @callback module:api/MetadataApi~echoRestServicesMetadataGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EchoRestServicesMetadataGet200Response} data The data returned by the service call.
     ...
     * @param {module:api/MetadataApi~echoRestServicesMetadataGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EchoRestServicesMetadataGet200Response}
     */
    echoRestServicesMetadataGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = EchoRestServicesMetadataGet200Response;
    ...
    /**
     * Callback function to receive the result of the echoRestServicesMetadataPost operation.
     * @callback module:api/MetadataApi~echoRestServicesMetadataPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EchoRestServicesMetadataGet200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} [output] Output Format Flag.  Enter one of the following keywords: - JSON = Data model formatted as Javascript Object Notation (default). - JSONP = Data model formatted as Javascript Object Notation with Padding.   - XML = Data model formatted as Extensible Markup Language.
     * @param {String} [callback] JSONP Callback.  For use with JSONP and GEOJSONP output only.  Enter a name of the function in which to wrap the JSON response.
     * @param {module:api/MetadataApi~echoRestServicesMetadataPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EchoRestServicesMetadataGet200Response}
     */
    echoRestServicesMetadataPost(opts, callback) {
      opts = opts || {};
      let postBody = null;
