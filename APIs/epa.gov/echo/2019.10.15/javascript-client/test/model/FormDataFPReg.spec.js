...
(function(root, factory) {
  ...
  describe('FormDataFPReg', function() {
    it('should create an instance of FormDataFPReg', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPReg();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPReg);
    });
