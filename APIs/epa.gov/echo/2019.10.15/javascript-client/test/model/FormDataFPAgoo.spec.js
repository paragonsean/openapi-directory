...
(function(root, factory) {
  ...
  describe('FormDataFPAgoo', function() {
    it('should create an instance of FormDataFPAgoo', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPAgoo();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPAgoo);
    });
