...
(function(root, factory) {
  ...
  describe('FormDataFPAct', function() {
    it('should create an instance of FormDataFPAct', function() {
      // uncomment below and update the code to test FormDataFPAct
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPAct();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPAct);
    });
