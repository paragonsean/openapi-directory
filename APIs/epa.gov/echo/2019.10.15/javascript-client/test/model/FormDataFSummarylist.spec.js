...
(function(root, factory) {
  ...
  describe('FormDataFSummarylist', function() {
    it('should create an instance of FormDataFSummarylist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFSummarylist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFSummarylist);
    });
