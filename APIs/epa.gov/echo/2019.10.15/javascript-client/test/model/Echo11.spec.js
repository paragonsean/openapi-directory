...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo11();
  });
  ...
  describe('Echo11', function() {
    it('should create an instance of Echo11', function() {
      // uncomment below and update the code to test Echo11
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo11();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo11);
    });
