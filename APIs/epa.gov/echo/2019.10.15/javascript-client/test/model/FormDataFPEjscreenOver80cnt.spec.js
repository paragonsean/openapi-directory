...
(function(root, factory) {
  ...
  describe('FormDataFPEjscreenOver80cnt', function() {
    it('should create an instance of FormDataFPEjscreenOver80cnt', function() {
      // uncomment below and update the code to test FormDataFPEjscreenOver80cnt
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPEjscreenOver80cnt();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPEjscreenOver80cnt);
    });
