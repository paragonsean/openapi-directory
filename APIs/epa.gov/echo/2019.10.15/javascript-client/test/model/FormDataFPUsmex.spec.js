...
(function(root, factory) {
  ...
  describe('FormDataFPUsmex', function() {
    it('should create an instance of FormDataFPUsmex', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPUsmex();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPUsmex);
    });
