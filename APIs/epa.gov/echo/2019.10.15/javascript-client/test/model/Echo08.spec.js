...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo08();
  });
  ...
  describe('Echo08', function() {
    it('should create an instance of Echo08', function() {
      // uncomment below and update the code to test Echo08
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo08();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo08);
    });
