...
(function(root, factory) {
  ...
  describe('FormDataFPIeay', function() {
    it('should create an instance of FormDataFPIeay', function() {
      // uncomment below and update the code to test FormDataFPIeay
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIeay();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIeay);
    });
