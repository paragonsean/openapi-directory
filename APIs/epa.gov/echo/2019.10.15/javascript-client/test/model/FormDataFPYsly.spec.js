...
(function(root, factory) {
  ...
  describe('FormDataFPYsly', function() {
    it('should create an instance of FormDataFPYsly', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPYsly();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPYsly);
    });
