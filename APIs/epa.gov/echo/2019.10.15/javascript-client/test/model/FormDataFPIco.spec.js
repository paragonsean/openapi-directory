...
(function(root, factory) {
  ...
  describe('FormDataFPIco', function() {
    it('should create an instance of FormDataFPIco', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIco();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIco);
    });
