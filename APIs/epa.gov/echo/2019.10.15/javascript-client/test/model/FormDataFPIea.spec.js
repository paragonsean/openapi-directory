...
(function(root, factory) {
  ...
  describe('FormDataFPIea', function() {
    it('should create an instance of FormDataFPIea', function() {
      // uncomment below and update the code to test FormDataFPIea
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIea();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIea);
    });
