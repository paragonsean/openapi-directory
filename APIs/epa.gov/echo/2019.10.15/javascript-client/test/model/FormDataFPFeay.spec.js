...
(function(root, factory) {
  ...
  describe('FormDataFPFeay', function() {
    it('should create an instance of FormDataFPFeay', function() {
      // uncomment below and update the code to test FormDataFPFeay
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFeay();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFeay);
    });
