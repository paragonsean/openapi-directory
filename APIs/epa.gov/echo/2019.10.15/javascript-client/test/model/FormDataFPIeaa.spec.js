...
(function(root, factory) {
  ...
  describe('FormDataFPIeaa', function() {
    it('should create an instance of FormDataFPIeaa', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIeaa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPIeaa);
    });
