...
(function(root, factory) {
  ...
  describe('FormDataFPFf', function() {
    it('should create an instance of FormDataFPFf', function() {
      // uncomment below and update the code to test FormDataFPFf
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFf();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFf);
    });
