...
(function(root, factory) {
  ...
  describe('FormDataFPTrep', function() {
    it('should create an instance of FormDataFPTrep', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPTrep();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPTrep);
    });
