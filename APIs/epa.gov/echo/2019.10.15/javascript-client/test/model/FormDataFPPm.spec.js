...
(function(root, factory) {
  ...
  describe('FormDataFPPm', function() {
    it('should create an instance of FormDataFPPm', function() {
      // uncomment below and update the code to test FormDataFPPm
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPPm();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPPm);
    });
