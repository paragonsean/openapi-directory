...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo06();
  });
  ...
  describe('Echo06', function() {
    it('should create an instance of Echo06', function() {
      // uncomment below and update the code to test Echo06
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo06();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo06);
    });

    it('should have the property clusterData (base name: "ClusterData")', function() {
      // uncomment below and update the code to test the property clusterData
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo06();
