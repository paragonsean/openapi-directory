...
(function(root, factory) {
  ...
  describe('FormDataFTablelist', function() {
    it('should create an instance of FormDataFTablelist', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFTablelist();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFTablelist);
    });
