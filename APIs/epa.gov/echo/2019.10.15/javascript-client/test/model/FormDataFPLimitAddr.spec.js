...
(function(root, factory) {
  ...
  describe('FormDataFPLimitAddr', function() {
    it('should create an instance of FormDataFPLimitAddr', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPLimitAddr();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPLimitAddr);
    });
