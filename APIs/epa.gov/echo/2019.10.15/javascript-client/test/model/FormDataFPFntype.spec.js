...
(function(root, factory) {
  ...
  describe('FormDataFPFntype', function() {
    it('should create an instance of FormDataFPFntype', function() {
      // uncomment below and update the code to test FormDataFPFntype
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFntype();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFntype);
    });
