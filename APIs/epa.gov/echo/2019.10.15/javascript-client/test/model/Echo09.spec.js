...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo09();
  });
  ...
  describe('Echo09', function() {
    it('should create an instance of Echo09', function() {
      // uncomment below and update the code to test Echo09
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo09();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Echo09);
    });
