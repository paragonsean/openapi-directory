...
(function(root, factory) {
  ...
  describe('FormDataFPPd', function() {
    it('should create an instance of FormDataFPPd', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPPd();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPPd);
    });
