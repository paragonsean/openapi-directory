...
(function(root, factory) {
  ...
  describe('FormDataFPImpw', function() {
    it('should create an instance of FormDataFPImpw', function() {
      // uncomment below and update the code to test FormDataFPImpw
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPImpw();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPImpw);
    });
