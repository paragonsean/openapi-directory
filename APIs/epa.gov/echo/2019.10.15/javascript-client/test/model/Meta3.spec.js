...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta3();
  });
  ...
  describe('Meta3', function() {
    it('should create an instance of Meta3', function() {
      // uncomment below and update the code to test Meta3
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta3();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta3);
    });
