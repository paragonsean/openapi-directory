...
(function(root, factory) {
  ...
  describe('FormDataFPYsla', function() {
    it('should create an instance of FormDataFPYsla', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPYsla();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPYsla);
    });
