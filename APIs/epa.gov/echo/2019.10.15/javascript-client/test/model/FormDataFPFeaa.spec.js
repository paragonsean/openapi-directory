...
(function(root, factory) {
  ...
  describe('FormDataFPFeaa', function() {
    it('should create an instance of FormDataFPFeaa', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFeaa();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPFeaa);
    });
