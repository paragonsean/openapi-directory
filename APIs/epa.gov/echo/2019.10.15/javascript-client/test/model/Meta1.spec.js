...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta1();
  });
  ...
  describe('Meta1', function() {
    it('should create an instance of Meta1', function() {
      // uncomment below and update the code to test Meta1
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta1();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta1);
    });
    ...
    it('should have the property resultColumns (base name: "ResultColumns")', function() {
      // uncomment below and update the code to test the property resultColumns
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.Meta1();
      //expect(instance).to.be();
    });
