...
(function(root, factory) {
  ...
  describe('FormDataFPOct', function() {
    it('should create an instance of FormDataFPOct', function() {
      ...
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPOct();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPOct);
    });
