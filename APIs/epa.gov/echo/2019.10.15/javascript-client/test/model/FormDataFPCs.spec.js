...
(function(root, factory) {
  ...
  describe('FormDataFPCs', function() {
    it('should create an instance of FormDataFPCs', function() {
      // uncomment below and update the code to test FormDataFPCs
      //var instance = new USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPCs();
      //expect(instance).to.be.a(USEpaEnforcementAndComplianceHistoryOnlineEchoAllData.FormDataFPCs);
    });
