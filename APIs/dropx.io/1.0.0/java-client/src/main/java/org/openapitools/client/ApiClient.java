...
public class ApiClient {
    ...
    private String basePath = "http://dropx.io/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("api_key", new ApiKeyAuth("header", "access_token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://dropx.io/api/v1
