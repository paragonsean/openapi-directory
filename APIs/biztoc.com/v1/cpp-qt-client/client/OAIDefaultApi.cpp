...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://ai.biztoc.com"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("getNews", defaultConf);
    _serverIndices.insert("getNews", 0);
}
...
void OAIDefaultApi::getNews(const ::OpenAPI::OptionalParam<QString> &query) {
    QString fullPath = QString(_serverConfigs["getNews"][_serverIndices.value("getNews")].URL()+"/ai/news");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::getNewsCallback);
...
void OAIDefaultApi::getNewsCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT getNewsSignal();
        Q_EMIT getNewsSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT getNewsSignalE(error_type, error_str);
        Q_EMIT getNewsSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT getNewsSignalError(error_type, error_str);
        Q_EMIT getNewsSignalErrorFull(worker, error_type, error_str);
    }
}
