...
public class NaicsApi {
    ...
    public NaicsApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call listNaicsGETCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listNaicsGETValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return listNaicsGETCall(_callback);
     ...
     */
    public Object listNaicsGET() throws ApiException {
        ApiResponse<Object> localVarResp = listNaicsGETWithHttpInfo();
     ...
     */
    public ApiResponse<Object> listNaicsGETWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listNaicsGETValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * This endpoint lists all of the NAICS codes that are relevant to the OASIS family of vehicles (asynchronously)
     * &lt;p&gt;This endpoint lists all of the NAICS codes that are relevant to the OASIS family of vehicles. It takes no parameters.&lt;/p&gt;
     ...
     */
    public okhttp3.Call listNaicsGETAsync(final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = listNaicsGETValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
