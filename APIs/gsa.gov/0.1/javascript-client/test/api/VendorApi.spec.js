...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryMarketResearch.VendorApi();
  });
  ...
  describe('VendorApi', function() {
    describe('getVendorGET', function() {
      it('should call getVendorGET successfully', function(done) {
        //uncomment below and update the code to test getVendorGET
        //instance.getVendorGET(function(error) {
