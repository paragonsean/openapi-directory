...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryMarketResearch.ContractsApi();
  });
  ...
  describe('ContractsApi', function() {
    describe('listContractsGET', function() {
      it('should call listContractsGET successfully', function(done) {
        //uncomment below and update the code to test listContractsGET
        //instance.listContractsGET(function(error) {
