...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DiscoveryMarketResearch.NaicsApi();
  });
  ...
  describe('NaicsApi', function() {
    describe('listNaicsGET', function() {
      it('should call listNaicsGET successfully', function(done) {
        //uncomment below and update the code to test listNaicsGET
        //instance.listNaicsGET(function(error) {
