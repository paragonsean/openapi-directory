...
Q_SIGNALS:
    ...
    void metadataGETSignal(OAIObject summary);


    void metadataGETSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);

    Q_DECL_DEPRECATED_X("Use metadataGETSignalError() instead")
    void metadataGETSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void metadataGETSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
