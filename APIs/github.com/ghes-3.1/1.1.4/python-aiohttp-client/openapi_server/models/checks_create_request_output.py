...
class ChecksCreateRequestOutput(Model):
    ...
    def __init__(self, annotations: List[ChecksCreateRequestOutputAnnotationsInner]=None, images: List[ChecksCreateRequestOutputImagesInner]=None, summary: str=None, text: str=None, title: str=None):
        """ChecksCreateRequestOutput - a model defined in OpenAPI

        :param annotations: The annotations of this ChecksCreateRequestOutput.
        :param images: The images of this ChecksCreateRequestOutput.
        :param summary: The summary of this ChecksCreateRequestOutput.
        :param text: The text of this ChecksCreateRequestOutput.
        :param title: The title of this ChecksCreateRequestOutput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ChecksCreateRequestOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The checks_create_request_output of this ChecksCreateRequestOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def annotations(self):
        """Gets the annotations of this ChecksCreateRequestOutput.
        ...
        :return: The annotations of this ChecksCreateRequestOutput.
    ...
    def annotations(self, annotations):
        """Sets the annotations of this ChecksCreateRequestOutput.
    ...
    @property
    def images(self):
        """Gets the images of this ChecksCreateRequestOutput.
        ...
        :return: The images of this ChecksCreateRequestOutput.
    ...
    def images(self, images):
        """Sets the images of this ChecksCreateRequestOutput.
    ...
    @property
    def summary(self):
        """Gets the summary of this ChecksCreateRequestOutput.

        The summary of the check run. This parameter supports Markdown.

        :return: The summary of this ChecksCreateRequestOutput.
        :rtype: str
        """
    ...
    def summary(self, summary):
        """Sets the summary of this ChecksCreateRequestOutput.
    ...
    @property
    def text(self):
        """Gets the text of this ChecksCreateRequestOutput.

        The details of the check run. This parameter supports Markdown.

        :return: The text of this ChecksCreateRequestOutput.
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this ChecksCreateRequestOutput.
    ...
    @property
    def title(self):
        """Gets the title of this ChecksCreateRequestOutput.

        The title of the check run.

        :return: The title of this ChecksCreateRequestOutput.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this ChecksCreateRequestOutput.
