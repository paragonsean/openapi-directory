...
class ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions(Model):
    ...
    def __init__(self, apps: List[Integration]=None, teams: List[Team]=None, teams_url: str=None, url: str=None, users: List[SimpleUser]=None, users_url: str=None):
        """ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions - a model defined in OpenAPI

        :param apps: The apps of this ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.
    ...
    @property
    def apps(self):
        """Gets the apps of this ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.


        :return: The apps of this ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.
    ...
    @apps.setter
    def apps(self, apps):
        """Sets the apps of this ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.


        :param apps: The apps of this ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions.
        :type apps: List[Integration]
        """
