...
class ReposCreateInOrgRequest(Model):
    ...
    def __init__(self, allow_merge_commit: bool=True, allow_rebase_merge: bool=True, allow_squash_merge: bool=True, auto_init: bool=False, delete_branch_on_merge: bool=False, description: str=None, gitignore_template: str=None, has_issues: bool=True, has_projects: bool=True, has_wiki: bool=True, homepage: str=None, is_template: bool=False, license_template: str=None, name: str=None, private: bool=False, team_id: int=None, use_squash_pr_title_as_default: bool=False, visibility: str=None):
