...
class WorkflowRun(Model):
    ...
    def __init__(self, artifacts_url: str=None, cancel_url: str=None, check_suite_id: int=None, check_suite_node_id: str=None, check_suite_url: str=None, conclusion: str=None, created_at: datetime=None, event: str=None, head_branch: str=None, head_commit: NullableSimpleCommit=None, head_repository: MinimalRepository=None, head_repository_id: int=None, head_sha: str=None, html_url: str=None, id: int=None, jobs_url: str=None, logs_url: str=None, name: str=None, node_id: str=None, pull_requests: List[PullRequestMinimal]=None, repository: MinimalRepository=None, rerun_url: str=None, run_number: int=None, status: str=None, updated_at: datetime=None, url: str=None, workflow_id: int=None, workflow_url: str=None):
