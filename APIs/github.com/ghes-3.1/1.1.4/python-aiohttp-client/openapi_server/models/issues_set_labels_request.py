...
class IssuesSetLabelsRequest(Model):
    ...
    def __init__(self, labels: List[IssuesSetLabelsRequestOneOf1LabelsInner]=None):
        """IssuesSetLabelsRequest - a model defined in OpenAPI

        :param labels: The labels of this IssuesSetLabelsRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'IssuesSetLabelsRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The issues_set_labels_request of this IssuesSetLabelsRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def labels(self):
        """Gets the labels of this IssuesSetLabelsRequest.


        :return: The labels of this IssuesSetLabelsRequest.
    ...
    def labels(self, labels):
        """Sets the labels of this IssuesSetLabelsRequest.
