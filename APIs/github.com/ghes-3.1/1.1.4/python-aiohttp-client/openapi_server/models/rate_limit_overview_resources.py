...
class RateLimitOverviewResources(Model):
    ...
    def __init__(self, actions_runner_registration: RateLimit=None, code_scanning_upload: RateLimit=None, core: RateLimit=None, graphql: RateLimit=None, integration_manifest: RateLimit=None, scim: RateLimit=None, search: RateLimit=None, source_import: RateLimit=None):
        ...
        :param scim: The scim of this RateLimitOverviewResources.
    ...
    @property
    def scim(self):
        """Gets the scim of this RateLimitOverviewResources.


        :return: The scim of this RateLimitOverviewResources.
        :rtype: RateLimit
        """
        return self._scim
    ...
    @scim.setter
    def scim(self, scim):
        """Sets the scim of this RateLimitOverviewResources.
