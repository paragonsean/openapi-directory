...
class Page(Model):
    ...
    def __init__(self, build_type: str=None, cname: str=None, custom_404: bool=False, html_url: str=None, https_certificate: PagesHttpsCertificate=None, https_enforced: bool=None, pending_domain_unverified_at: datetime=None, protected_domain_state: str=None, public: bool=None, source: PagesSourceHash=None, status: str=None, url: str=None):
        """Page - a model defined in OpenAPI

        :param build_type: The build_type of this Page.
    ...
    @property
    def build_type(self):
        """Gets the build_type of this Page.

        The process in which the Page will be built.

        :return: The build_type of this Page.
        :rtype: str
        """
    ...
    def build_type(self, build_type):
        """Sets the build_type of this Page.
        ...
        :type build_type: str
        """
        allowed_values = [None,"legacy", "workflow"]  # noqa: E501
