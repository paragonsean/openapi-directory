...
class ReposUpdateRequest(Model):
    ...
    def __init__(self, allow_forking: bool=False, allow_merge_commit: bool=True, allow_rebase_merge: bool=True, allow_squash_merge: bool=True, allow_update_branch: bool=False, archived: bool=False, default_branch: str=None, delete_branch_on_merge: bool=False, description: str=None, has_issues: bool=True, has_projects: bool=True, has_wiki: bool=True, homepage: str=None, is_template: bool=False, name: str=None, private: bool=False, use_squash_pr_title_as_default: bool=False, visibility: str=None):
