...
async def actions_disable_selected_repository_github_actions_organization(request: web.Request, org, repository_id) -> web.Response:
...
async def actions_disable_workflow(request: web.Request, owner, repo, workflow_id) -> web.Response:
    """Disable a workflow
...
async def actions_enable_selected_repository_github_actions_organization(request: web.Request, org, repository_id) -> web.Response:
...
async def actions_enable_workflow(request: web.Request, owner, repo, workflow_id) -> web.Response:
    """Enable a workflow
...
async def actions_get_allowed_actions_organization(request: web.Request, org) -> web.Response:
...
async def actions_get_allowed_actions_repository(request: web.Request, owner, repo) -> web.Response:
...
async def actions_get_github_actions_permissions_organization(request: web.Request, org) -> web.Response:
...
async def actions_get_github_actions_permissions_repository(request: web.Request, owner, repo) -> web.Response:
...
async def actions_list_selected_repositories_enabled_github_actions_organization(request: web.Request, org, per_page=None, page=None) -> web.Response:
...
async def actions_list_workflow_runs(request: web.Request, owner, repo, workflow_id, actor=None, branch=None, event=None, status=None, per_page=None, page=None, created=None, exclude_pull_requests=None) -> web.Response:
    ...
    :param page: Page number of the results to fetch.
    :type page: int
    :param created: Returns workflow runs created within the given date-time range. For more information on the syntax, see \&quot;[Understanding the search syntax](https://docs.github.com/enterprise-server@3.1/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates).\&quot;
    :type created: str
    :param exclude_pull_requests: If &#x60;true&#x60; pull requests are omitted from the response (empty array).
    :type exclude_pull_requests: bool
...
async def actions_re_run_workflow(request: web.Request, owner, repo, run_id, body=None) -> web.Response:
    """Re-run a workflow
...
async def actions_set_allowed_actions_organization(request: web.Request, org, body=None) -> web.Response:
    ...
    """
    body = SelectedActions.from_dict(body)
    return web.Response(status=200)


async def actions_set_allowed_actions_repository(request: web.Request, owner, repo, body=None) -> web.Response:
...
async def actions_set_github_actions_permissions_organization(request: web.Request, org, body) -> web.Response:
    ...
    """
    body = ActionsSetGithubActionsPermissionsOrganizationRequest.from_dict(body)
    return web.Response(status=200)


async def actions_set_github_actions_permissions_repository(request: web.Request, owner, repo, body) -> web.Response:
    ...
    """
    body = ActionsSetGithubActionsPermissionsRepositoryRequest.from_dict(body)
    return web.Response(status=200)
...
async def actions_set_selected_repositories_enabled_github_actions_organization(request: web.Request, org, body) -> web.Response:
    ...
    """
    body = ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest.from_dict(body)
    return web.Response(status=200)
