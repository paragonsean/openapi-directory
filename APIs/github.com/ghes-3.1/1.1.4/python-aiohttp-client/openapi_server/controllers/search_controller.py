...
async def search_code(request: web.Request, q, sort=None, order=None, per_page=None, page=None) -> web.Response:
    ...
    :type q: str
    :param sort: Sorts the results of your query. Can only be &#x60;indexed&#x60;, which indicates how recently a file has been indexed by the GitHub Enterprise Server search infrastructure. Default: [best match](https://docs.github.com/enterprise-server@3.1/rest/reference/search#ranking-search-results)
    :type sort: str
...
async def search_commits(request: web.Request, q, sort=None, order=None, per_page=None, page=None) -> web.Response:
    ...
    :type q: str
    :param sort: Sorts the results of your query by &#x60;author-date&#x60; or &#x60;committer-date&#x60;. Default: [best match](https://docs.github.com/enterprise-server@3.1/rest/reference/search#ranking-search-results)
    :type sort: str
    :param order: Determines whether the first search result returned is the highest number of matches (&#x60;desc&#x60;) or lowest number of matches (&#x60;asc&#x60;). This parameter is ignored unless you provide &#x60;sort&#x60;.
    :type order: str
    :param per_page: The number of results per page (max 100).
...
async def search_labels(request: web.Request, repository_id, q, sort=None, order=None, per_page=None, page=None) -> web.Response:
    ...
    :param q: The search keywords. This endpoint does not accept qualifiers in the query. To learn more about the format of the query, see [Constructing a search query](https://docs.github.com/enterprise-server@3.1/rest/reference/search#constructing-a-search-query).
    :type q: str
    :param sort: Sorts the results of your query by when the label was &#x60;created&#x60; or &#x60;updated&#x60;. Default: [best match](https://docs.github.com/enterprise-server@3.1/rest/reference/search#ranking-search-results)
    :type sort: str
    :param order: Determines whether the first search result returned is the highest number of matches (&#x60;desc&#x60;) or lowest number of matches (&#x60;asc&#x60;). This parameter is ignored unless you provide &#x60;sort&#x60;.
    :type order: str
    :param per_page: The number of results per page (max 100).
...
async def search_repos(request: web.Request, q, sort=None, order=None, per_page=None, page=None) -> web.Response:
    ...
    :type q: str
    :param sort: Sorts the results of your query by number of &#x60;stars&#x60;, &#x60;forks&#x60;, or &#x60;help-wanted-issues&#x60; or how recently the items were &#x60;updated&#x60;. Default: [best match](https://docs.github.com/enterprise-server@3.1/rest/reference/search#ranking-search-results)
    :type sort: str
    :param order: Determines whether the first search result returned is the highest number of matches (&#x60;desc&#x60;) or lowest number of matches (&#x60;asc&#x60;). This parameter is ignored unless you provide &#x60;sort&#x60;.
    :type order: str
    :param per_page: The number of results per page (max 100).
...
async def search_users(request: web.Request, q, sort=None, order=None, per_page=None, page=None) -> web.Response:
    ...
    :type q: str
    :param sort: Sorts the results of your query by number of &#x60;followers&#x60; or &#x60;repositories&#x60;, or when the person &#x60;joined&#x60; GitHub Enterprise Server. Default: [best match](https://docs.github.com/enterprise-server@3.1/rest/reference/search#ranking-search-results)
    :type sort: str
    :param order: Determines whether the first search result returned is the highest number of matches (&#x60;desc&#x60;) or lowest number of matches (&#x60;asc&#x60;). This parameter is ignored unless you provide &#x60;sort&#x60;.
    :type order: str
    :param per_page: The number of results per page (max 100).
