...
async def test_projects_create_card(client):
    ...
    """
    body = {"note":"Add payload for delete Project column"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_projects_create_for_authenticated_user(client):
    ...
    """
    body = {"body":"A board to manage my personal projects.","name":"My Projects"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_projects_move_card(client):
    ...
    Move a project card
    """
    body = {"column_id":42,"position":"bottom"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_projects_update(client):
    ...
    Update a project
    """
    body = {"name":"Week One Sprint","organization_permission":"write","state":"open"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
