...
public class PullRequest {
  ...
  public PullRequest autoMerge(AutoMerge autoMerge) {
  ...
  public PullRequest labels(List<PullRequestLabelsInner> labels) {
    this.labels = labels;
    return this;
  }

  public PullRequest addLabelsItem(PullRequestLabelsInner labelsItem) {
    if (this.labels == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, pullRequest.links) &&
        ...
        Objects.equals(this.autoMerge, pullRequest.autoMerge) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraylabels.size(); i++) {
        PullRequestLabelsInner.validateJsonElement(jsonArraylabels.get(i));
      };
