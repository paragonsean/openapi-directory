...
public class Gist {
  ...
  public Gist comments(Integer comments) {
  ...
  public Gist files(Map<String, BaseGistFilesValue> files) {
    this.files = files;
    return this;
  }

  public Gist putFilesItem(String key, BaseGistFilesValue filesItem) {
    if (this.files == null) {
  ...
  public boolean equals(Object o) {
    ...
    Gist gist = (Gist) o;
    return Objects.equals(this.comments, gist.comments) &&
        ...
        Objects.equals(this.url, gist.url) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to Gist
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Gist.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Gist is not found in the empty JSON string", Gist.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Gist.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Gist` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Gist.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Gist.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Gist' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Gist> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Gist.class));

       return (TypeAdapter<T>) new TypeAdapter<Gist>() {
           @Override
           public void write(JsonWriter out, Gist value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Gist read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Gist given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Gist
   * @throws IOException if the JSON string is invalid with respect to Gist
   */
  public static Gist fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Gist.class);
  }

  /**
   * Convert an instance of Gist to an JSON string
   *
   * @return JSON string
   */
