...
public class Feed {
  ...
  public static final String SERIALIZED_NAME_SECURITY_ADVISORIES_URL = "security_advisories_url";
  @SerializedName(SERIALIZED_NAME_SECURITY_ADVISORIES_URL)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, currentUserActorUrl, currentUserOrganizationUrl, currentUserOrganizationUrls, currentUserPublicUrl, currentUserUrl, securityAdvisoriesUrl, timelineUrl, userUrl);
  }
  ...
  static {
    ...
    openapiFields.add("security_advisories_url");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("security_advisories_url") != null && !jsonObj.get("security_advisories_url").isJsonNull()) && !jsonObj.get("security_advisories_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `security_advisories_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("security_advisories_url").toString()));
      }
