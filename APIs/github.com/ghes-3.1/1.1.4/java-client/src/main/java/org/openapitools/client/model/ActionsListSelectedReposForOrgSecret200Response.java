...
public class ActionsListSelectedReposForOrgSecret200Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.repositories, actionsListSelectedReposForOrgSecret200Response.repositories) &&
        Objects.equals(this.totalCount, actionsListSelectedReposForOrgSecret200Response.totalCount);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionsListSelectedReposForOrgSecret200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionsListSelectedReposForOrgSecret200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionsListSelectedReposForOrgSecret200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionsListSelectedReposForOrgSecret200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayrepositories.size(); i++) {
        MinimalRepository.validateJsonElement(jsonArrayrepositories.get(i));
      };
  }
