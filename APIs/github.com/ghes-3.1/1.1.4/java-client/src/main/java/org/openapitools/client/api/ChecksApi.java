...
public class ChecksApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#create-a-check-run">Create a check run Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#create-a-check-suite">Create a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#get-a-check-run">Get a check run Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#get-a-check-suite">Get a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#list-check-run-annotations">List check run annotations Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#list-check-runs-for-a-git-reference">List check runs for a Git reference Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#list-check-runs-in-a-check-suite">List check runs in a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#list-check-suites-for-a-git-reference">List check suites for a Git reference Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#rerequest-a-check-suite">Rerequest a check suite Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#update-repository-preferences-for-check-suites">Update repository preferences for check suites Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.1/rest/reference/checks#update-a-check-run">Update a check run Documentation</a>
     */
