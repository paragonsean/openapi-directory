...
public class ReposCreateInOrgRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMergeCommit, allowRebaseMerge, allowSquashMerge, autoInit, deleteBranchOnMerge, description, gitignoreTemplate, hasIssues, hasProjects, hasWiki, homepage, isTemplate, licenseTemplate, name, _private, teamId, useSquashPrTitleAsDefault, visibility);
  }
