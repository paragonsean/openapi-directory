...
/*
 * OAIUnassigned_issue_event.h
 *
 * Unassigned Issue Event
 */

#ifndef OAIUnassigned_issue_event_H
#define OAIUnassigned_issue_event_H
...
class OAIUnassigned_issue_event : public OAIObject {
public:
    OAIUnassigned_issue_event();
    OAIUnassigned_issue_event(QString json);
    ~OAIUnassigned_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnassigned_issue_event)

#endif // OAIUnassigned_issue_event_H
