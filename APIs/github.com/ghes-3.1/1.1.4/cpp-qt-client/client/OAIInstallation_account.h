...
/*
 * OAIInstallation_account.h
 *
 * 
 */

#ifndef OAIInstallation_account_H
#define OAIInstallation_account_H
...
class OAIInstallation_account : public OAIObject {
public:
    OAIInstallation_account();
    OAIInstallation_account(QString json);
    ~OAIInstallation_account() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstallation_account)

#endif // OAIInstallation_account_H
