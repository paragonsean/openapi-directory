...
public:
    ...
    bool isUseSquashPrTitleAsDefault() const;
    void setUseSquashPrTitleAsDefault(const bool &use_squash_pr_title_as_default);
    bool is_use_squash_pr_title_as_default_Set() const;
    bool is_use_squash_pr_title_as_default_Valid() const;
