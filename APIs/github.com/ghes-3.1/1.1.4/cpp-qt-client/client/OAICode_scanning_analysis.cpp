...
QString OAICode_scanning_analysis::getToolName() const {
    return m_tool_name;
}
void OAICode_scanning_analysis::setToolName(const QString &tool_name) {
    m_tool_name = tool_name;
    m_tool_name_isSet = true;
}

bool OAICode_scanning_analysis::is_tool_name_Set() const{
    return m_tool_name_isSet;
}

bool OAICode_scanning_analysis::is_tool_name_Valid() const{
