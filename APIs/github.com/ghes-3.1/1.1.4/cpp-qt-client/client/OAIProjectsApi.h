...
Q_SIGNALS:
    ...
    void projects_getPermissionForUserSignal(OAIProject_collaborator_permission summary);
    ...
    void projects_getPermissionForUserSignalFull(OAIHttpRequestWorker *worker, OAIProject_collaborator_permission summary);
    ...
    void projects_getPermissionForUserSignalE(OAIProject_collaborator_permission summary, QNetworkReply::NetworkError error_type, QString error_str);
    void projects_getPermissionForUserSignalError(OAIProject_collaborator_permission summary, QNetworkReply::NetworkError error_type, const QString &error_str);
