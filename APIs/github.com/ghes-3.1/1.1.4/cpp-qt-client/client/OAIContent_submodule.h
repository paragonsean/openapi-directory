...
/*
 * OAIContent_submodule.h
 *
 * An object describing a symlink
 */

#ifndef OAIContent_submodule_H
#define OAIContent_submodule_H
...
class OAIContent_submodule : public OAIObject {
public:
    OAIContent_submodule();
    OAIContent_submodule(QString json);
    ~OAIContent_submodule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_submodule)

#endif // OAIContent_submodule_H
