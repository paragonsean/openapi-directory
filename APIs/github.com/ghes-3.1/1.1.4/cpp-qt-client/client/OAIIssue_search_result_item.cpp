...
QString OAIIssue_search_result_item::getStateReason() const {
    return m_state_reason;
}
void OAIIssue_search_result_item::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAIIssue_search_result_item::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAIIssue_search_result_item::is_state_reason_Valid() const{
