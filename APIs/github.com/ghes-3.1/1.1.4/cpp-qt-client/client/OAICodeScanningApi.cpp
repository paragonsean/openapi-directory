...
void OAICodeScanningApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("codeScanning_deleteAnalysis", defaultConf);
    _serverIndices.insert("codeScanning_deleteAnalysis", 0);
    _serverConfigs.insert("codeScanning_getAlert", defaultConf);
    _serverIndices.insert("codeScanning_getAlert", 0);
    _serverConfigs.insert("codeScanning_getAnalysis", defaultConf);
    _serverIndices.insert("codeScanning_getAnalysis", 0);
    _serverConfigs.insert("codeScanning_getSarif", defaultConf);
    _serverIndices.insert("codeScanning_getSarif", 0);
    _serverConfigs.insert("codeScanning_listAlertInstances", defaultConf);
    _serverIndices.insert("codeScanning_listAlertInstances", 0);
...
void OAICodeScanningApi::codeScanning_deleteAnalysis(const QString &owner, const QString &repo, const qint32 &analysis_id, const ::OpenAPI::OptionalParam<QString> &confirm_delete) {
    QString fullPath = QString(_serverConfigs["codeScanning_deleteAnalysis"][_serverIndices.value("codeScanning_deleteAnalysis")].URL()+"/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}");
    ...
    
    {
        ...
        analysis_idPathParam.append("analysis_id").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "analysis_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"analysis_id"+pathSuffix : pathPrefix;
        fullPath.replace(analysis_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(analysis_id)));
    }
    QString queryPrefix, querySuffix, queryDelimiter, queryStyle;
    if (confirm_delete.hasValue())
    {
        queryStyle = "form";
        if (queryStyle == "")
            queryStyle = "form";
        ...
        queryDelimiter = getParamStyleDelimiter(queryStyle, "confirm_delete", true);
        if (fullPath.indexOf("?") > 0)
            fullPath.append(queryPrefix);
        else
            fullPath.append("?");

        fullPath.append(QUrl::toPercentEncoding("confirm_delete")).append(querySuffix).append(QUrl::toPercentEncoding(confirm_delete.stringValue()));
    }
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICodeScanningApi::codeScanning_deleteAnalysisCallback);
...
void OAICodeScanningApi::codeScanning_deleteAnalysisCallback(OAIHttpRequestWorker *worker) {
    ...
    OAICode_scanning_analysis_deletion output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT codeScanning_deleteAnalysisSignal(output);
        Q_EMIT codeScanning_deleteAnalysisSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT codeScanning_deleteAnalysisSignalE(output, error_type, error_str);
        Q_EMIT codeScanning_deleteAnalysisSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT codeScanning_deleteAnalysisSignalError(output, error_type, error_str);
        Q_EMIT codeScanning_deleteAnalysisSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAICodeScanningApi::codeScanning_getAnalysis(const QString &owner, const QString &repo, const qint32 &analysis_id) {
    QString fullPath = QString(_serverConfigs["codeScanning_getAnalysis"][_serverIndices.value("codeScanning_getAnalysis")].URL()+"/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICodeScanningApi::codeScanning_getAnalysisCallback);
    connect(this, &OAICodeScanningApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICodeScanningApi::codeScanning_getAnalysisCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICode_scanning_analysis output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT codeScanning_getAnalysisSignal(output);
        Q_EMIT codeScanning_getAnalysisSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT codeScanning_getAnalysisSignalE(output, error_type, error_str);
        Q_EMIT codeScanning_getAnalysisSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT codeScanning_getAnalysisSignalError(output, error_type, error_str);
        Q_EMIT codeScanning_getAnalysisSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICodeScanningApi::codeScanning_getSarif(const QString &owner, const QString &repo, const QString &sarif_id) {
    QString fullPath = QString(_serverConfigs["codeScanning_getSarif"][_serverIndices.value("codeScanning_getSarif")].URL()+"/repos/{owner}/{repo}/code-scanning/sarifs/{sarif_id}");
    ...
    {
        QString sarif_idPathParam("{");
        sarif_idPathParam.append("sarif_id").append("}");
        QString pathPrefix, pathSuffix, pathDelimiter;
        QString pathStyle = "simple";
        if (pathStyle == "")
            pathStyle = "simple";
        pathPrefix = getParamStylePrefix(pathStyle);
        pathSuffix = getParamStyleSuffix(pathStyle);
        pathDelimiter = getParamStyleDelimiter(pathStyle, "sarif_id", false);
        QString paramString = (pathStyle == "matrix") ? pathPrefix+"sarif_id"+pathSuffix : pathPrefix;
        fullPath.replace(sarif_idPathParam, paramString+QUrl::toPercentEncoding(::OpenAPI::toStringValue(sarif_id)));
    }
    OAIHttpRequestWorker *worker = new OAIHttpRequestWorker(this, _manager);
    worker->setTimeOut(_timeOut);
    worker->setWorkingDirectory(_workingDirectory);
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICodeScanningApi::codeScanning_getSarifCallback);
    connect(this, &OAICodeScanningApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICodeScanningApi::codeScanning_getSarifCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAICode_scanning_sarifs_status output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT codeScanning_getSarifSignal(output);
        Q_EMIT codeScanning_getSarifSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT codeScanning_getSarifSignalE(output, error_type, error_str);
        Q_EMIT codeScanning_getSarifSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT codeScanning_getSarifSignalError(output, error_type, error_str);
        Q_EMIT codeScanning_getSarifSignalErrorFull(worker, error_type, error_str);
    }
}

void OAICodeScanningApi::codeScanning_listAlertInstances(const QString &owner, const QString &repo, const qint32 &alert_number, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<QString> &ref) {
    QString fullPath = QString(_serverConfigs["codeScanning_listAlertInstances"][_serverIndices.value("codeScanning_listAlertInstances")].URL()+"/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}/instances");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAICodeScanningApi::codeScanning_listAlertInstancesCallback);
    connect(this, &OAICodeScanningApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAICodeScanningApi::codeScanning_listAlertInstancesCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    QList<OAICode_scanning_alert_instance> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonArray jsonArray = doc.array();
    for (QJsonValue obj : jsonArray) {
        OAICode_scanning_alert_instance val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT codeScanning_listAlertInstancesSignal(output);
        Q_EMIT codeScanning_listAlertInstancesSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT codeScanning_listAlertInstancesSignalE(output, error_type, error_str);
        Q_EMIT codeScanning_listAlertInstancesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT codeScanning_listAlertInstancesSignalError(output, error_type, error_str);
        Q_EMIT codeScanning_listAlertInstancesSignalErrorFull(worker, error_type, error_str);
    }
}
