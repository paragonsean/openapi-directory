...
public:
    ...
    OAIRate_limit getActionsRunnerRegistration() const;
    void setActionsRunnerRegistration(const OAIRate_limit &actions_runner_registration);
    bool is_actions_runner_registration_Set() const;
    bool is_actions_runner_registration_Valid() const;
    ...
    OAIRate_limit getScim() const;
    void setScim(const OAIRate_limit &scim);
    bool is_scim_Set() const;
    bool is_scim_Valid() const;
...
private:
    ...
    OAIRate_limit m_actions_runner_registration;
    bool m_actions_runner_registration_isSet;
    bool m_actions_runner_registration_isValid;
