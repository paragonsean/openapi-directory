...
/*
 * OAIConverted_note_to_issue_issue_event.h
 *
 * Converted Note to Issue Issue Event
 */

#ifndef OAIConverted_note_to_issue_issue_event_H
#define OAIConverted_note_to_issue_issue_event_H
...
class OAIConverted_note_to_issue_issue_event : public OAIObject {
public:
    OAIConverted_note_to_issue_issue_event();
    OAIConverted_note_to_issue_issue_event(QString json);
    ~OAIConverted_note_to_issue_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConverted_note_to_issue_issue_event)

#endif // OAIConverted_note_to_issue_issue_event_H
