...
public:
    ...
    * @param[in]  repo QString [required]
    * @param[in]  branch QString [required]
    * @param[in]  oai_repos_rename_branch_request OAIRepos_rename_branch_request [required]
    */
    virtual void repos_renameBranch(const QString &owner, const QString &repo, const QString &branch, const OAIRepos_rename_branch_request &oai_repos_rename_branch_request);
    ...
    * @param[in]  repo QString [required]
    * @param[in]  hook_id qint32 [required]
    * @param[in]  oai_repos_update_webhook_config_for_repo_request OAIRepos_update_webhook_config_for_repo_request [optional]
    */
    virtual void repos_updateWebhookConfigForRepo(const QString &owner, const QString &repo, const qint32 &hook_id, const ::OpenAPI::OptionalParam<OAIRepos_update_webhook_config_for_repo_request> &oai_repos_update_webhook_config_for_repo_request = ::OpenAPI::OptionalParam<OAIRepos_update_webhook_config_for_repo_request>());
...
private:
    ...
    void repos_renameBranchCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void repos_renameBranchSignal(OAIBranch_with_protection summary);
    ...
    void repos_renameBranchSignalFull(OAIHttpRequestWorker *worker, OAIBranch_with_protection summary);
    ...
    Q_DECL_DEPRECATED_X("Use repos_renameBranchSignalError() instead")
    void repos_renameBranchSignalE(OAIBranch_with_protection summary, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_renameBranchSignalError(OAIBranch_with_protection summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_renameBranchSignalErrorFull() instead")
    void repos_renameBranchSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_renameBranchSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
