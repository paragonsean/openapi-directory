...
/*
 * OAILdap_mapping_user.h
 *
 * Ldap Private User
 */

#ifndef OAILdap_mapping_user_H
#define OAILdap_mapping_user_H
...
class OAILdap_mapping_user : public OAIObject {
public:
    OAILdap_mapping_user();
    OAILdap_mapping_user(QString json);
    ~OAILdap_mapping_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILdap_mapping_user)

#endif // OAILdap_mapping_user_H
