...
/*
 * OAIRenamed_issue_event.h
 *
 * Renamed Issue Event
 */

#ifndef OAIRenamed_issue_event_H
#define OAIRenamed_issue_event_H
...
class OAIRenamed_issue_event : public OAIObject {
public:
    OAIRenamed_issue_event();
    OAIRenamed_issue_event(QString json);
    ~OAIRenamed_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRenamed_issue_event)

#endif // OAIRenamed_issue_event_H
