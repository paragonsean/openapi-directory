...
QString OAIPage::getBuildType() const {
    return m_build_type;
}
void OAIPage::setBuildType(const QString &build_type) {
    m_build_type = build_type;
    m_build_type_isSet = true;
}

bool OAIPage::is_build_type_Set() const{
    return m_build_type_isSet;
}

bool OAIPage::is_build_type_Valid() const{
