...
export default class EnterpriseAdminApi {
    ...
    */
     ...
     */
    enterpriseAdminAddAuthorizedSshKey(authorizedKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let basePaths = ['{protocol}://{hostname}'];
     ...
     * @param {String} [settings] An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.1/rest/reference/enterprise-admin#get-settings).
     ...
     */
    enterpriseAdminDeleteGlobalWebhook(hookId, callback) {
      let postBody = null;
     ...
     * @param {Number} tokenId The unique identifier of the token.
     ...
     * @param {Number} preReceiveEnvironmentId The unique identifier of the pre-receive environment.
     ...
     * 
     * @param {Number} preReceiveHookId The unique identifier of the pre-receive hook.
     ...
     * Delete a public key
     * 
     * @param {String} keyIds The unique identifier of the key.
     ...
     */
    enterpriseAdminEnableOrDisableMaintenanceMode(maintenance, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * data is of type: {@link Array.<module:model/SshKey>}
     */
    enterpriseAdminGetAllAuthorizedSshKeys(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    enterpriseAdminGetConfigurationStatus(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * data is of type: {@link module:model/MaintenanceStatus}
     */
    enterpriseAdminGetMaintenanceStatus(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    enterpriseAdminGetSettings(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    enterpriseAdminListGlobalWebhooks(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    enterpriseAdminPingGlobalWebhook(hookId, callback) {
      let postBody = null;
      // verify the required parameter 'hookId' is set
      if (hookId === undefined || hookId === null) {
     ...
     * data is of type: {@link Array.<module:model/SshKey>}
     */
    enterpriseAdminRemoveAuthorizedSshKey(authorizedKey, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'authorizedKey' is set
      if (authorizedKey === undefined || authorizedKey === null) {
     ...
     * @param {String} settings A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.1/rest/reference/enterprise-admin#get-settings).
     ...
     */
    enterpriseAdminSetSettings(settings, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    enterpriseAdminStartConfigurationProcess(opts, callback) {
      opts = opts || {};
      let postBody = null;
