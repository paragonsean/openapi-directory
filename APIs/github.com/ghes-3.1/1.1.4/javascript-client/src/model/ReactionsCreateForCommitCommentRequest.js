...
class ReactionsCreateForCommitCommentRequest {
     ...
     * @param content {module:model/ReactionsCreateForCommitCommentRequest.ContentEnum} The [reaction type](https://docs.github.com/enterprise-server@3.1/rest/reference/reactions#reaction-types) to add to the commit comment.
     */
    constructor(content) { 
