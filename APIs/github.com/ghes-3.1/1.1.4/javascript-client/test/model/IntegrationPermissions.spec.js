...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.IntegrationPermissions();
  });
  ...
  describe('IntegrationPermissions', function() {
    it('should create an instance of IntegrationPermissions', function() {
      // uncomment below and update the code to test IntegrationPermissions
      //var instance = new GitHubV3RestApi.IntegrationPermissions();
      //expect(instance).to.be.a(GitHubV3RestApi.IntegrationPermissions);
    });
