...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullsUpdateRequest();
  });
  ...
  describe('PullsUpdateRequest', function() {
    it('should create an instance of PullsUpdateRequest', function() {
      // uncomment below and update the code to test PullsUpdateRequest
      //var instance = new GitHubV3RestApi.PullsUpdateRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.PullsUpdateRequest);
    });
