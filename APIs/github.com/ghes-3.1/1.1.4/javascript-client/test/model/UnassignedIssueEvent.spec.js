...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.UnassignedIssueEvent();
  });
  ...
  describe('UnassignedIssueEvent', function() {
    it('should create an instance of UnassignedIssueEvent', function() {
      // uncomment below and update the code to test UnassignedIssueEvent
      //var instance = new GitHubV3RestApi.UnassignedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.UnassignedIssueEvent);
    });
