...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GitCommitVerification();
  });
  ...
  describe('GitCommitVerification', function() {
    it('should create an instance of GitCommitVerification', function() {
      // uncomment below and update the code to test GitCommitVerification
      //var instance = new GitHubV3RestApi.GitCommitVerification();
      //expect(instance).to.be.a(GitHubV3RestApi.GitCommitVerification);
    });
