...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.StateChangeIssueEvent();
  });
  ...
  describe('StateChangeIssueEvent', function() {
    it('should create an instance of StateChangeIssueEvent', function() {
      // uncomment below and update the code to test StateChangeIssueEvent
      //var instance = new GitHubV3RestApi.StateChangeIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.StateChangeIssueEvent);
    });
