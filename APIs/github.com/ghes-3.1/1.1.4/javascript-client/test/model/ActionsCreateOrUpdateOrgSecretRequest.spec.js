...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ActionsCreateOrUpdateOrgSecretRequest();
  });
  ...
  describe('ActionsCreateOrUpdateOrgSecretRequest', function() {
    it('should create an instance of ActionsCreateOrUpdateOrgSecretRequest', function() {
      // uncomment below and update the code to test ActionsCreateOrUpdateOrgSecretRequest
      //var instance = new GitHubV3RestApi.ActionsCreateOrUpdateOrgSecretRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ActionsCreateOrUpdateOrgSecretRequest);
    });
