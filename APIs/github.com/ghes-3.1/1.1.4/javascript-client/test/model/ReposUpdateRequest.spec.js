...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposUpdateRequest();
  });
  ...
  describe('ReposUpdateRequest', function() {
    it('should create an instance of ReposUpdateRequest', function() {
      // uncomment below and update the code to test ReposUpdateRequest
      //var instance = new GitHubV3RestApi.ReposUpdateRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposUpdateRequest);
    });
    ...
    it('should have the property allowUpdateBranch (base name: "allow_update_branch")', function() {
      // uncomment below and update the code to test the property allowUpdateBranch
      //var instance = new GitHubV3RestApi.ReposUpdateRequest();
      //expect(instance).to.be();
    });
