...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentSubmodule();
  });
  ...
  describe('ContentSubmodule', function() {
    it('should create an instance of ContentSubmodule', function() {
      // uncomment below and update the code to test ContentSubmodule
      //var instance = new GitHubV3RestApi.ContentSubmodule();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentSubmodule);
    });
