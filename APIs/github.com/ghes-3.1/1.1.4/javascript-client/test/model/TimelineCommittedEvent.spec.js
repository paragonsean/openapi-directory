...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TimelineCommittedEvent();
  });
  ...
  describe('TimelineCommittedEvent', function() {
    it('should create an instance of TimelineCommittedEvent', function() {
      // uncomment below and update the code to test TimelineCommittedEvent
      //var instance = new GitHubV3RestApi.TimelineCommittedEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.TimelineCommittedEvent);
    });
