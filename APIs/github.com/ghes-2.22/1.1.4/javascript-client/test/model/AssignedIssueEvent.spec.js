...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.AssignedIssueEvent();
  });
  ...
  describe('AssignedIssueEvent', function() {
    it('should create an instance of AssignedIssueEvent', function() {
      // uncomment below and update the code to test AssignedIssueEvent
      //var instance = new GitHubV3RestApi.AssignedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.AssignedIssueEvent);
    });
