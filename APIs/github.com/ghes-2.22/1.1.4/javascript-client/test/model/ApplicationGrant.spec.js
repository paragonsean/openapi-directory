...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ApplicationGrant();
  });
  ...
  describe('ApplicationGrant', function() {
    it('should create an instance of ApplicationGrant', function() {
      // uncomment below and update the code to test ApplicationGrant
      //var instance = new GitHubV3RestApi.ApplicationGrant();
      //expect(instance).to.be.a(GitHubV3RestApi.ApplicationGrant);
    });
