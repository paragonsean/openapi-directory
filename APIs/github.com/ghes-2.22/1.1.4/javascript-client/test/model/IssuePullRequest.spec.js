...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.IssuePullRequest();
  });
  ...
  describe('IssuePullRequest', function() {
    it('should create an instance of IssuePullRequest', function() {
      // uncomment below and update the code to test IssuePullRequest
      //var instance = new GitHubV3RestApi.IssuePullRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.IssuePullRequest);
    });
