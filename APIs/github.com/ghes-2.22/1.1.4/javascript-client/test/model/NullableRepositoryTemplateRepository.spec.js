...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.NullableRepositoryTemplateRepository();
  });
  ...
  describe('NullableRepositoryTemplateRepository', function() {
    it('should create an instance of NullableRepositoryTemplateRepository', function() {
      // uncomment below and update the code to test NullableRepositoryTemplateRepository
      //var instance = new GitHubV3RestApi.NullableRepositoryTemplateRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.NullableRepositoryTemplateRepository);
    });
