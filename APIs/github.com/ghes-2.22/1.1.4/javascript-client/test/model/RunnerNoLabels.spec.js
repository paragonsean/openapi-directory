...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.RunnerNoLabels();
  });
  ...
  describe('RunnerNoLabels', function() {
    it('should create an instance of RunnerNoLabels', function() {
      // uncomment below and update the code to test RunnerNoLabels
      //var instance = new GitHubV3RestApi.RunnerNoLabels();
      //expect(instance).to.be.a(GitHubV3RestApi.RunnerNoLabels);
    });
