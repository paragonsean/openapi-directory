...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentSymlink();
  });
  ...
  describe('ContentSymlink', function() {
    it('should create an instance of ContentSymlink', function() {
      // uncomment below and update the code to test ContentSymlink
      //var instance = new GitHubV3RestApi.ContentSymlink();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentSymlink);
    });
