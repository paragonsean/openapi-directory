...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.UserSearchResultItem();
  });
  ...
  describe('UserSearchResultItem', function() {
    it('should create an instance of UserSearchResultItem', function() {
      // uncomment below and update the code to test UserSearchResultItem
      //var instance = new GitHubV3RestApi.UserSearchResultItem();
      //expect(instance).to.be.a(GitHubV3RestApi.UserSearchResultItem);
    });
