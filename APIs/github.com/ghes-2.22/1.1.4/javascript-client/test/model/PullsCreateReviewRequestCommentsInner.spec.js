...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullsCreateReviewRequestCommentsInner();
  });
  ...
  describe('PullsCreateReviewRequestCommentsInner', function() {
    it('should create an instance of PullsCreateReviewRequestCommentsInner', function() {
      // uncomment below and update the code to test PullsCreateReviewRequestCommentsInner
      //var instance = new GitHubV3RestApi.PullsCreateReviewRequestCommentsInner();
      //expect(instance).to.be.a(GitHubV3RestApi.PullsCreateReviewRequestCommentsInner);
    });
