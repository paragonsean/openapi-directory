...
let runId = 56; // Number | The id of the workflow run.
...
> EnterpriseAdminListSelfHostedRunnersInGroupForEnterprise200Response actionsListSelfHostedRunnersForOrg(org, opts)
...
> EnterpriseAdminListSelfHostedRunnersInGroupForEnterprise200Response actionsListSelfHostedRunnersForRepo(owner, repo, opts)
