...
let orgId = 56; // Number | Unique identifier of an organization.
 ...
 **orgId** | **Number**| Unique identifier of an organization. | 
...
let opts = {
  ...
  'settings': "settings_example" // String | An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-settings).
};
 ...
 **settings** | **String**| An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-settings). | [optional] 
...
> RunnerNoLabels enterpriseAdminGetSelfHostedRunnerForEnterprise(enterprise, runnerId)
...
[**RunnerNoLabels**](RunnerNoLabels.md)
...
> EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response enterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise(enterprise, runnerGroupId, opts)
...
[**EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response**](EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **settings** | **String**| A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-settings). | 
