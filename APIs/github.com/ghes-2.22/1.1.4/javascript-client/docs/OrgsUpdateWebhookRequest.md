# GitHubV3RestApi.OrgsUpdateWebhookRequest
...
**events** | **[String]** | Determines what [events](https://docs.github.com/enterprise-server@2.22/webhooks/event-payloads) the hook is triggered for. | [optional] 
