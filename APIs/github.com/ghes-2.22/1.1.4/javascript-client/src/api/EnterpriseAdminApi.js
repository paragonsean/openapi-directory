...
import EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response from '../model/EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response';
...
export default class EnterpriseAdminApi {
    ...
    */
     ...
     * @param {String} [settings] An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-settings).
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response}
     */
    enterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise(enterprise, runnerGroupId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response;
      return this.apiClient.callApi(
     ...
     * @param {String} settings A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-settings).
