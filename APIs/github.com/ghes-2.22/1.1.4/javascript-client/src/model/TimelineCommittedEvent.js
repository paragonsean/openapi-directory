...
/**
 * The TimelineCommittedEvent model module.
 * @module model/TimelineCommittedEvent
 * @version 1.1.4
 */
class TimelineCommittedEvent {
    /**
     * Constructs a new <code>TimelineCommittedEvent</code>.
     * Timeline Committed Event
     * @alias module:model/TimelineCommittedEvent
    ...
    constructor(author, committer, htmlUrl, message, nodeId, parents, sha, tree, url, verification) { 
        ...
        TimelineCommittedEvent.initialize(this, author, committer, htmlUrl, message, nodeId, parents, sha, tree, url, verification);
    }
    ...
    /**
     * Constructs a <code>TimelineCommittedEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimelineCommittedEvent} obj Optional instance to populate.
     * @return {module:model/TimelineCommittedEvent} The populated <code>TimelineCommittedEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimelineCommittedEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>TimelineCommittedEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimelineCommittedEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TimelineCommittedEvent.RequiredProperties) {
...
TimelineCommittedEvent.RequiredProperties = ["author", "committer", "html_url", "message", "node_id", "parents", "sha", "tree", "url", "verification"];

/**
 * @member {module:model/GitCommitAuthor} author
 */
TimelineCommittedEvent.prototype['author'] = undefined;

/**
 * @member {module:model/GitCommitAuthor} committer
 */
TimelineCommittedEvent.prototype['committer'] = undefined;

/**
 * @member {String} event
 */
TimelineCommittedEvent.prototype['event'] = undefined;

/**
 * @member {String} html_url
 */
TimelineCommittedEvent.prototype['html_url'] = undefined;

/**
 * Message describing the purpose of the commit
 * @member {String} message
 */
TimelineCommittedEvent.prototype['message'] = undefined;

/**
 * @member {String} node_id
 */
TimelineCommittedEvent.prototype['node_id'] = undefined;

/**
 * @member {Array.<module:model/GitCommitParentsInner>} parents
 */
TimelineCommittedEvent.prototype['parents'] = undefined;

/**
 * SHA for the commit
 * @member {String} sha
 */
TimelineCommittedEvent.prototype['sha'] = undefined;

/**
 * @member {module:model/GitCommitTree} tree
 */
TimelineCommittedEvent.prototype['tree'] = undefined;

/**
 * @member {String} url
 */
TimelineCommittedEvent.prototype['url'] = undefined;

/**
 * @member {module:model/GitCommitVerification} verification
 */
TimelineCommittedEvent.prototype['verification'] = undefined;
...
export default TimelineCommittedEvent;
