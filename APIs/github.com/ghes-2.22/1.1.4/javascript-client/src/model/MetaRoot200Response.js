...
/**
 * The MetaRoot200Response model module.
 * @module model/MetaRoot200Response
 * @version 1.1.4
 */
class MetaRoot200Response {
    /**
     * Constructs a new <code>MetaRoot200Response</code>.
     * @alias module:model/MetaRoot200Response
    ...
    constructor(authorizationsUrl, codeSearchUrl, commitSearchUrl, currentUserAuthorizationsHtmlUrl, currentUserRepositoriesUrl, currentUserUrl, emailsUrl, emojisUrl, eventsUrl, feedsUrl, followersUrl, followingUrl, gistsUrl, hubUrl, issueSearchUrl, issuesUrl, keysUrl, labelSearchUrl, notificationsUrl, organizationRepositoriesUrl, organizationTeamsUrl, organizationUrl, publicGistsUrl, rateLimitUrl, repositorySearchUrl, repositoryUrl, starredGistsUrl, starredUrl, userOrganizationsUrl, userRepositoriesUrl, userSearchUrl, userUrl) { 
        ...
        MetaRoot200Response.initialize(this, authorizationsUrl, codeSearchUrl, commitSearchUrl, currentUserAuthorizationsHtmlUrl, currentUserRepositoriesUrl, currentUserUrl, emailsUrl, emojisUrl, eventsUrl, feedsUrl, followersUrl, followingUrl, gistsUrl, hubUrl, issueSearchUrl, issuesUrl, keysUrl, labelSearchUrl, notificationsUrl, organizationRepositoriesUrl, organizationTeamsUrl, organizationUrl, publicGistsUrl, rateLimitUrl, repositorySearchUrl, repositoryUrl, starredGistsUrl, starredUrl, userOrganizationsUrl, userRepositoriesUrl, userSearchUrl, userUrl);
    }
    ...
    /**
     * Constructs a <code>MetaRoot200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MetaRoot200Response} obj Optional instance to populate.
     * @return {module:model/MetaRoot200Response} The populated <code>MetaRoot200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetaRoot200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>MetaRoot200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MetaRoot200Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MetaRoot200Response.RequiredProperties) {
...
MetaRoot200Response.RequiredProperties = ["authorizations_url", "code_search_url", "commit_search_url", "current_user_authorizations_html_url", "current_user_repositories_url", "current_user_url", "emails_url", "emojis_url", "events_url", "feeds_url", "followers_url", "following_url", "gists_url", "hub_url", "issue_search_url", "issues_url", "keys_url", "label_search_url", "notifications_url", "organization_repositories_url", "organization_teams_url", "organization_url", "public_gists_url", "rate_limit_url", "repository_search_url", "repository_url", "starred_gists_url", "starred_url", "user_organizations_url", "user_repositories_url", "user_search_url", "user_url"];

/**
 * @member {String} authorizations_url
 */
MetaRoot200Response.prototype['authorizations_url'] = undefined;

/**
 * @member {String} code_search_url
 */
MetaRoot200Response.prototype['code_search_url'] = undefined;

/**
 * @member {String} commit_search_url
 */
MetaRoot200Response.prototype['commit_search_url'] = undefined;

/**
 * @member {String} current_user_authorizations_html_url
 */
MetaRoot200Response.prototype['current_user_authorizations_html_url'] = undefined;

/**
 * @member {String} current_user_repositories_url
 */
MetaRoot200Response.prototype['current_user_repositories_url'] = undefined;

/**
 * @member {String} current_user_url
 */
MetaRoot200Response.prototype['current_user_url'] = undefined;

/**
 * @member {String} emails_url
 */
MetaRoot200Response.prototype['emails_url'] = undefined;

/**
 * @member {String} emojis_url
 */
MetaRoot200Response.prototype['emojis_url'] = undefined;

/**
 * @member {String} events_url
 */
MetaRoot200Response.prototype['events_url'] = undefined;

/**
 * @member {String} feeds_url
 */
MetaRoot200Response.prototype['feeds_url'] = undefined;

/**
 * @member {String} followers_url
 */
MetaRoot200Response.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
MetaRoot200Response.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
MetaRoot200Response.prototype['gists_url'] = undefined;

/**
 * @member {String} hub_url
 */
MetaRoot200Response.prototype['hub_url'] = undefined;

/**
 * @member {String} issue_search_url
 */
MetaRoot200Response.prototype['issue_search_url'] = undefined;

/**
 * @member {String} issues_url
 */
MetaRoot200Response.prototype['issues_url'] = undefined;

/**
 * @member {String} keys_url
 */
MetaRoot200Response.prototype['keys_url'] = undefined;

/**
 * @member {String} label_search_url
 */
MetaRoot200Response.prototype['label_search_url'] = undefined;

/**
 * @member {String} notifications_url
 */
MetaRoot200Response.prototype['notifications_url'] = undefined;

/**
 * @member {String} organization_repositories_url
 */
MetaRoot200Response.prototype['organization_repositories_url'] = undefined;

/**
 * @member {String} organization_teams_url
 */
MetaRoot200Response.prototype['organization_teams_url'] = undefined;

/**
 * @member {String} organization_url
 */
MetaRoot200Response.prototype['organization_url'] = undefined;

/**
 * @member {String} public_gists_url
 */
MetaRoot200Response.prototype['public_gists_url'] = undefined;

/**
 * @member {String} rate_limit_url
 */
MetaRoot200Response.prototype['rate_limit_url'] = undefined;

/**
 * @member {String} repository_search_url
 */
MetaRoot200Response.prototype['repository_search_url'] = undefined;

/**
 * @member {String} repository_url
 */
MetaRoot200Response.prototype['repository_url'] = undefined;

/**
 * @member {String} starred_gists_url
 */
MetaRoot200Response.prototype['starred_gists_url'] = undefined;

/**
 * @member {String} starred_url
 */
MetaRoot200Response.prototype['starred_url'] = undefined;

/**
 * @member {String} topic_search_url
 */
MetaRoot200Response.prototype['topic_search_url'] = undefined;

/**
 * @member {String} user_organizations_url
 */
MetaRoot200Response.prototype['user_organizations_url'] = undefined;

/**
 * @member {String} user_repositories_url
 */
MetaRoot200Response.prototype['user_repositories_url'] = undefined;

/**
 * @member {String} user_search_url
 */
MetaRoot200Response.prototype['user_search_url'] = undefined;

/**
 * @member {String} user_url
 */
MetaRoot200Response.prototype['user_url'] = undefined;
...
export default MetaRoot200Response;
