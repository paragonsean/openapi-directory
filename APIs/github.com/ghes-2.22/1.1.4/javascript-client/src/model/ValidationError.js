    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [ValidationErrorErrorsInner]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['errors']) { // data not null
            ...
            for (const item of data['errors']) {
                ValidationErrorErrorsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
ValidationError.RequiredProperties = ["documentation_url", "message"];
...
/**
 * @member {Array.<module:model/ValidationErrorErrorsInner>} errors
 */
