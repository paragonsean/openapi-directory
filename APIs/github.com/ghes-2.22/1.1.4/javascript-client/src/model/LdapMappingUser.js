...
/**
 * The LdapMappingUser model module.
 * @module model/LdapMappingUser
 * @version 1.1.4
 */
class LdapMappingUser {
    /**
     * Constructs a new <code>LdapMappingUser</code>.
     * Ldap Private User
     * @alias module:model/LdapMappingUser
    ...
    constructor(avatarUrl, bio, blog, collaborators, company, createdAt, diskUsage, email, eventsUrl, followers, followersUrl, following, followingUrl, gistsUrl, gravatarId, hireable, htmlUrl, id, location, login, name, nodeId, organizationsUrl, ownedPrivateRepos, privateGists, publicGists, publicRepos, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, totalPrivateRepos, twoFactorAuthentication, type, updatedAt, url) { 
        ...
        LdapMappingUser.initialize(this, avatarUrl, bio, blog, collaborators, company, createdAt, diskUsage, email, eventsUrl, followers, followersUrl, following, followingUrl, gistsUrl, gravatarId, hireable, htmlUrl, id, location, login, name, nodeId, organizationsUrl, ownedPrivateRepos, privateGists, publicGists, publicRepos, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, totalPrivateRepos, twoFactorAuthentication, type, updatedAt, url);
    }
    ...
    /**
     * Constructs a <code>LdapMappingUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LdapMappingUser} obj Optional instance to populate.
     * @return {module:model/LdapMappingUser} The populated <code>LdapMappingUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LdapMappingUser();
    ...
    /**
     * Validates the JSON data with respect to <code>LdapMappingUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LdapMappingUser</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LdapMappingUser.RequiredProperties) {
...
LdapMappingUser.RequiredProperties = ["avatar_url", "bio", "blog", "collaborators", "company", "created_at", "disk_usage", "email", "events_url", "followers", "followers_url", "following", "following_url", "gists_url", "gravatar_id", "hireable", "html_url", "id", "location", "login", "name", "node_id", "organizations_url", "owned_private_repos", "private_gists", "public_gists", "public_repos", "received_events_url", "repos_url", "site_admin", "starred_url", "subscriptions_url", "total_private_repos", "two_factor_authentication", "type", "updated_at", "url"];

/**
 * @member {String} avatar_url
 */
LdapMappingUser.prototype['avatar_url'] = undefined;

/**
 * @member {String} bio
 */
LdapMappingUser.prototype['bio'] = undefined;

/**
 * @member {String} blog
 */
LdapMappingUser.prototype['blog'] = undefined;

/**
 * @member {Boolean} business_plus
 */
LdapMappingUser.prototype['business_plus'] = undefined;

/**
 * @member {Number} collaborators
 */
LdapMappingUser.prototype['collaborators'] = undefined;

/**
 * @member {String} company
 */
LdapMappingUser.prototype['company'] = undefined;

/**
 * @member {Date} created_at
 */
LdapMappingUser.prototype['created_at'] = undefined;

/**
 * @member {Number} disk_usage
 */
LdapMappingUser.prototype['disk_usage'] = undefined;

/**
 * @member {String} email
 */
LdapMappingUser.prototype['email'] = undefined;

/**
 * @member {String} events_url
 */
LdapMappingUser.prototype['events_url'] = undefined;

/**
 * @member {Number} followers
 */
LdapMappingUser.prototype['followers'] = undefined;

/**
 * @member {String} followers_url
 */
LdapMappingUser.prototype['followers_url'] = undefined;

/**
 * @member {Number} following
 */
LdapMappingUser.prototype['following'] = undefined;

/**
 * @member {String} following_url
 */
LdapMappingUser.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
LdapMappingUser.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
LdapMappingUser.prototype['gravatar_id'] = undefined;

/**
 * @member {Boolean} hireable
 */
LdapMappingUser.prototype['hireable'] = undefined;

/**
 * @member {String} html_url
 */
LdapMappingUser.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
LdapMappingUser.prototype['id'] = undefined;

/**
 * @member {String} ldap_dn
 */
LdapMappingUser.prototype['ldap_dn'] = undefined;

/**
 * @member {String} location
 */
LdapMappingUser.prototype['location'] = undefined;

/**
 * @member {String} login
 */
LdapMappingUser.prototype['login'] = undefined;

/**
 * @member {String} name
 */
LdapMappingUser.prototype['name'] = undefined;

/**
 * @member {String} node_id
 */
LdapMappingUser.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
LdapMappingUser.prototype['organizations_url'] = undefined;

/**
 * @member {Number} owned_private_repos
 */
LdapMappingUser.prototype['owned_private_repos'] = undefined;

/**
 * @member {module:model/LdapMappingUserPlan} plan
 */
LdapMappingUser.prototype['plan'] = undefined;

/**
 * @member {Number} private_gists
 */
LdapMappingUser.prototype['private_gists'] = undefined;

/**
 * @member {Number} public_gists
 */
LdapMappingUser.prototype['public_gists'] = undefined;

/**
 * @member {Number} public_repos
 */
LdapMappingUser.prototype['public_repos'] = undefined;

/**
 * @member {String} received_events_url
 */
LdapMappingUser.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
LdapMappingUser.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
LdapMappingUser.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
LdapMappingUser.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
LdapMappingUser.prototype['subscriptions_url'] = undefined;

/**
 * @member {Date} suspended_at
 */
LdapMappingUser.prototype['suspended_at'] = undefined;

/**
 * @member {Number} total_private_repos
 */
LdapMappingUser.prototype['total_private_repos'] = undefined;

/**
 * @member {String} twitter_username
 */
LdapMappingUser.prototype['twitter_username'] = undefined;

/**
 * @member {Boolean} two_factor_authentication
 */
LdapMappingUser.prototype['two_factor_authentication'] = undefined;

/**
 * @member {String} type
 */
LdapMappingUser.prototype['type'] = undefined;

/**
 * @member {Date} updated_at
 */
LdapMappingUser.prototype['updated_at'] = undefined;

/**
 * @member {String} url
 */
LdapMappingUser.prototype['url'] = undefined;
...
export default LdapMappingUser;
