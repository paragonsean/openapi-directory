...
async def checks_create_suite(request: web.Request, owner, repo, body) -> web.Response:
...
async def checks_update(request: web.Request, owner, repo, check_run_id, body) -> web.Response:
    """Update a check run
