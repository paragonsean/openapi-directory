...
async def gitignore_get_template(request: web.Request, name) -> web.Response:
    ...
    The API also allows fetching the source of a single template. Use the raw [media type](https://docs.github.com/enterprise-server@2.22/rest/overview/media-types/) to get the raw contents.
