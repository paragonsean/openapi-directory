...
class CodeScanningAlert(Model):
    ...
    def __init__(self, created_at: datetime=None, dismissed_at: datetime=None, dismissed_by: NullableSimpleUser=None, dismissed_reason: CodeScanningAlertDismissedReason=None, html_url: str=None, instances: object=None, number: int=None, rule: CodeScanningAlertRule=None, state: CodeScanningAlertState=None, tool: CodeScanningAnalysisTool=None, url: str=None):
