...
class Commit(Model):
    ...
    def __init__(self, author: NullableSimpleUser=None, comments_url: str=None, commit: CommitCommit=None, committer: NullableSimpleUser=None, files: List[CommitFilesInner]=None, html_url: str=None, node_id: str=None, parents: List[CommitParentsInner]=None, sha: str=None, stats: CommitStats=None, url: str=None):
    ...
    def files(self, files):
        ...
        :param files: The files of this Commit.
        :type files: List[CommitFilesInner]
        """
