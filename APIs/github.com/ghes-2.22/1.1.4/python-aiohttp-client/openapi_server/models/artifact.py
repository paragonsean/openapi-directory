...
class Artifact(Model):
    ...
    def __init__(self, archive_download_url: str=None, created_at: datetime=None, expired: bool=None, expires_at: datetime=None, id: int=None, name: str=None, node_id: str=None, size_in_bytes: int=None, updated_at: datetime=None, url: str=None):
