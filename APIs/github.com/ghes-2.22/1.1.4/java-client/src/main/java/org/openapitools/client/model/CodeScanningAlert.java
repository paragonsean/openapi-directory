...
public class CodeScanningAlert {
  ...
  @Deprecated
  public CodeScanningAlert instances(Object instances) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, codeScanningAlert.createdAt) &&
        ...
        Objects.equals(this.instances, codeScanningAlert.instances) &&
        Objects.equals(this.number, codeScanningAlert.number) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, dismissedAt, dismissedBy, dismissedReason, htmlUrl, instances, number, rule, state, tool, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CodeScanningAlert
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeScanningAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CodeScanningAlert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CodeScanningAlert` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CodeScanningAlertRule.validateJsonElement(jsonObj.get("rule"));
