...
public class NullableSimpleUser {
  ...
  public NullableSimpleUser id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatarUrl, nullableSimpleUser.avatarUrl) &&
        ...
        Objects.equals(this.name, nullableSimpleUser.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(avatarUrl, email, eventsUrl, followersUrl, followingUrl, gistsUrl, gravatarId, htmlUrl, id, login, name, nodeId, organizationsUrl, receivedEventsUrl, reposUrl, siteAdmin, starredAt, starredUrl, subscriptionsUrl, type, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NullableSimpleUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NullableSimpleUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NullableSimpleUser is not found in the empty JSON string", NullableSimpleUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NullableSimpleUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NullableSimpleUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NullableSimpleUser.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NullableSimpleUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NullableSimpleUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NullableSimpleUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NullableSimpleUser.class));

       return (TypeAdapter<T>) new TypeAdapter<NullableSimpleUser>() {
           @Override
           public void write(JsonWriter out, NullableSimpleUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NullableSimpleUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NullableSimpleUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NullableSimpleUser
   * @throws IOException if the JSON string is invalid with respect to NullableSimpleUser
   */
  public static NullableSimpleUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NullableSimpleUser.class);
  }

  /**
   * Convert an instance of NullableSimpleUser to an JSON string
   *
   * @return JSON string
   */
