...
public class PullsApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#check-if-a-pull-request-has-been-merged">Check if a pull request has been merged Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#create-a-pull-request">Create a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#create-a-reply-for-a-review-comment">Create a reply for a review comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#create-a-review-for-a-pull-request">Create a review for a pull request Documentation</a>
     */
     ...
     * This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \&quot;[Secondary rate limits](https://docs.github.com/enterprise-server@2.22/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\&quot; and \&quot;[Dealing with secondary rate limits](https://docs.github.com/enterprise-server@2.22/rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)\&quot; for details.  Pull request reviews created in the &#x60;PENDING&#x60; state do not include the &#x60;submitted_at&#x60; property in the response.  **Note:** To comment on a specific line in a file, you need to first determine the _position_ of that line in the diff. The GitHub REST API v3 offers the &#x60;application/vnd.github.v3.diff&#x60; [media type](https://docs.github.com/enterprise-server@2.22/rest/overview/media-types#commits-commit-comparison-and-pull-requests). To see a pull request diff, add this media type to the &#x60;Accept&#x60; header of a call to the [single pull request](https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#get-a-pull-request) endpoint.  The &#x60;position&#x60; value equals the number of lines down from the first \&quot;@@\&quot; hunk header in the file you want to add a comment. The line just below the \&quot;@@\&quot; line is position 1, the next line is position 2, and so on. The position in the diff continues to increase through lines of whitespace and additional hunks until the beginning of a new file.
     * @param owner  (required)
     * @param repo  (required)
     * @param pullNumber  (required)
     * @param pullsCreateReviewRequest  (optional)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#create-a-review-comment-for-a-pull-request">Create a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#delete-a-pending-review-for-a-pull-request">Delete a pending review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#delete-a-review-comment-for-a-pull-request">Delete a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#dismiss-a-review-for-a-pull-request">Dismiss a review for a pull request Documentation</a>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Pass the appropriate [media type](https://docs.github.com/enterprise-server@2.22/rest/overview/media-types/#commits-commit-comparison-and-pull-requests) to fetch diff and patch formats. </td><td>  -  </td></tr>
        <tr><td> 304 </td><td> Not modified </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resource not found </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Error </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#get-a-pull-request">Get a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#get-a-review-for-a-pull-request">Get a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#get-a-review-comment-for-a-pull-request">Get a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-pull-requests">List pull requests Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-comments-for-a-pull-request-review">List comments for a pull request review Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-commits-on-a-pull-request">List commits on a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-pull-requests-files">List pull requests files Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-requested-reviewers-for-a-pull-request">List requested reviewers for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-review-comments-on-a-pull-request">List review comments on a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-review-comments-in-a-repository">List review comments in a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#list-reviews-for-a-pull-request">List reviews for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#merge-a-pull-request">Merge a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#remove-requested-reviewers-from-a-pull-request">Remove requested reviewers from a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#request-reviewers-for-a-pull-request">Request reviewers for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#submit-a-review-for-a-pull-request">Submit a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls/#update-a-pull-request">Update a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#update-a-pull-request-branch">Update a pull request branch Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#update-a-review-for-a-pull-request">Update a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.22/rest/reference/pulls#update-a-review-comment-for-a-pull-request">Update a review comment for a pull request Documentation</a>
     */
