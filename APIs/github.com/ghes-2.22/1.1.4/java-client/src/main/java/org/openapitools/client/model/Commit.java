...
public class Commit {
  ...
  private List<CommitFilesInner> files = new ArrayList<>();
  ...
  public Commit files(List<CommitFilesInner> files) {
    this.files = files;
    return this;
  }

  public Commit addFilesItem(CommitFilesInner filesItem) {
    if (this.files == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<CommitFilesInner> getFiles() {
    return files;
  }

  public void setFiles(List<CommitFilesInner> files) {
    this.files = files;
  }
      ...
      if (jsonObj.get("files") != null && !jsonObj.get("files").isJsonNull()) {
        ...
        if (jsonArrayfiles != null) {
          ...
          for (int i = 0; i < jsonArrayfiles.size(); i++) {
            CommitFilesInner.validateJsonElement(jsonArrayfiles.get(i));
          };
        }
      }
