...
> RunnerNoLabels actionsGetSelfHostedRunnerForOrg(org, runnerId)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer runnerId = 56; // Integer | Unique identifier of the self-hosted runner.
    try {
      RunnerNoLabels result = apiInstance.actionsGetSelfHostedRunnerForOrg(org, runnerId);
      System.out.println(result);
    } catch (ApiException e) {
...
> RunnerNoLabels actionsGetSelfHostedRunnerForRepo(owner, repo, runnerId)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer runnerId = 56; // Integer | Unique identifier of the self-hosted runner.
    try {
      RunnerNoLabels result = apiInstance.actionsGetSelfHostedRunnerForRepo(owner, repo, runnerId);
      System.out.println(result);
    } catch (ApiException e) {
...
> EnterpriseAdminListSelfHostedRunnersInGroupForEnterprise200Response actionsListSelfHostedRunnersForOrg(org, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer page = 1; // Integer | Page number of the results to fetch.
    try {
      EnterpriseAdminListSelfHostedRunnersInGroupForEnterprise200Response result = apiInstance.actionsListSelfHostedRunnersForOrg(org, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
...
> EnterpriseAdminListSelfHostedRunnersInGroupForEnterprise200Response actionsListSelfHostedRunnersForRepo(owner, repo, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer page = 1; // Integer | Page number of the results to fetch.
    try {
      EnterpriseAdminListSelfHostedRunnersInGroupForEnterprise200Response result = apiInstance.actionsListSelfHostedRunnersForRepo(owner, repo, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    String event = "event_example"; // String | Returns workflow run triggered by the event you specify. For example, `push`, `pull_request` or `issue`. For more information, see \"[Events that trigger workflows](https://help.github.com/en/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows).\"
