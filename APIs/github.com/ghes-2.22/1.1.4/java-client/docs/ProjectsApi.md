...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    Integer columnId = 56; // Integer | column_id parameter
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **columnId** | **Integer**| column_id parameter | |
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    Integer cardId = 56; // Integer | card_id parameter
    try {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **cardId** | **Integer**| card_id parameter | |
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectsApi apiInstance = new ProjectsApi(defaultClient);
    Integer columnId = 56; // Integer | column_id parameter
    String archivedState = "all"; // String | Filters the project cards that are returned by the card's state. Can be one of `all`,`archived`, or `not_archived`.
...
|------------- | ------------- | ------------- | -------------|
| **columnId** | **Integer**| column_id parameter | |
| **archivedState** | **String**| Filters the project cards that are returned by the card&#39;s state. Can be one of &#x60;all&#x60;,&#x60;archived&#x60;, or &#x60;not_archived&#x60;. | [optional] [default to not_archived] [enum: all, archived, not_archived] |
