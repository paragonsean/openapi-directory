...
public class Example {
  public static void main(String[] args) {
    ...
    String settings = "settings_example"; // String | An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-settings).
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer runnerId = 56; // Integer | Unique identifier of the self-hosted runner.
    try {
      RunnerNoLabels result = apiInstance.enterpriseAdminGetSelfHostedRunnerForEnterprise(enterprise, runnerId);
      System.out.println(result);
    } catch (ApiException e) {
...
> EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response enterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise(enterprise, runnerGroupId, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer page = 1; // Integer | Page number of the results to fetch.
    try {
      EnterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise200Response result = apiInstance.enterpriseAdminListOrgAccessToSelfHostedRunnerGroupInEnterprise(enterprise, runnerGroupId, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
