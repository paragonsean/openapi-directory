...
public class Example {
  public static void main(String[] args) {
    ...
    Integer installationId = 56; // Integer | installation_id parameter
    try {
      InstallationGhes2 result = apiInstance.appsGetInstallation(installationId);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InstallationGhes2 result = apiInstance.appsGetOrgInstallation(org);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InstallationGhes2 result = apiInstance.appsGetRepoInstallation(owner, repo);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      InstallationGhes2 result = apiInstance.appsGetUserInstallation(username);
      System.out.println(result);
    } catch (ApiException e) {
...
> List&lt;InstallationGhes2&gt; appsListInstallations(perPage, page, since, outdated)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<InstallationGhes2> result = apiInstance.appsListInstallations(perPage, page, since, outdated);
      System.out.println(result);
    } catch (ApiException e) {
