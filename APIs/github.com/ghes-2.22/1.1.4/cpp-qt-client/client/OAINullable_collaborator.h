...
/*
 * OAINullable_collaborator.h
 *
 * Collaborator
 */

#ifndef OAINullable_collaborator_H
#define OAINullable_collaborator_H
...
class OAINullable_collaborator : public OAIObject {
public:
    OAINullable_collaborator();
    OAINullable_collaborator(QString json);
    ~OAINullable_collaborator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_collaborator)

#endif // OAINullable_collaborator_H
