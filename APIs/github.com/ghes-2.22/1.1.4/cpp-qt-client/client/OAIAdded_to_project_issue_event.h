...
/*
 * OAIAdded_to_project_issue_event.h
 *
 * Added to Project Issue Event
 */

#ifndef OAIAdded_to_project_issue_event_H
#define OAIAdded_to_project_issue_event_H
...
class OAIAdded_to_project_issue_event : public OAIObject {
public:
    OAIAdded_to_project_issue_event();
    OAIAdded_to_project_issue_event(QString json);
    ~OAIAdded_to_project_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdded_to_project_issue_event)

#endif // OAIAdded_to_project_issue_event_H
