...
Q_SIGNALS:
    ...
    void actions_getSelfHostedRunnerForOrgSignal(OAIRunner_no_labels summary);
    void actions_getSelfHostedRunnerForRepoSignal(OAIRunner_no_labels summary);
    ...
    void actions_listSelfHostedRunnersForOrgSignal(OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary);
    void actions_listSelfHostedRunnersForRepoSignal(OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary);
    ...
    void actions_getSelfHostedRunnerForOrgSignalFull(OAIHttpRequestWorker *worker, OAIRunner_no_labels summary);
    void actions_getSelfHostedRunnerForRepoSignalFull(OAIHttpRequestWorker *worker, OAIRunner_no_labels summary);
    ...
    void actions_listSelfHostedRunnersForOrgSignalFull(OAIHttpRequestWorker *worker, OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary);
    void actions_listSelfHostedRunnersForRepoSignalFull(OAIHttpRequestWorker *worker, OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary);
    ...
    void actions_getSelfHostedRunnerForOrgSignalE(OAIRunner_no_labels summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getSelfHostedRunnerForOrgSignalError(OAIRunner_no_labels summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actions_getSelfHostedRunnerForRepoSignalError() instead")
    void actions_getSelfHostedRunnerForRepoSignalE(OAIRunner_no_labels summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getSelfHostedRunnerForRepoSignalError(OAIRunner_no_labels summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void actions_listSelfHostedRunnersForOrgSignalE(OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_listSelfHostedRunnersForOrgSignalError(OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actions_listSelfHostedRunnersForRepoSignalError() instead")
    void actions_listSelfHostedRunnersForRepoSignalE(OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_listSelfHostedRunnersForRepoSignalError(OAIEnterprise_admin_list_self_hosted_runners_in_group_for_enterprise_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
