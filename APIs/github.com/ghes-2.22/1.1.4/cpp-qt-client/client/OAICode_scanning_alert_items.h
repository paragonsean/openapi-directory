...
public:
    ...
    OAICode_scanning_alert_classification getClassification() const;
    void setClassification(const OAICode_scanning_alert_classification &classification);
    ...
    OAICode_scanning_alert_instance getInstance() const;
    void setInstance(const OAICode_scanning_alert_instance &instance);
...
private:
    ...
    OAICode_scanning_alert_classification m_classification;
    ...
    OAICode_scanning_alert_instance m_instance;
