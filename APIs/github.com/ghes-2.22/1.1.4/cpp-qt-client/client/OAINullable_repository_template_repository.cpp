...
QString OAINullable_repository_template_repository::getTempCloneToken() const {
    return m_temp_clone_token;
}
void OAINullable_repository_template_repository::setTempCloneToken(const QString &temp_clone_token) {
    m_temp_clone_token = temp_clone_token;
    m_temp_clone_token_isSet = true;
}

bool OAINullable_repository_template_repository::is_temp_clone_token_Set() const{
    return m_temp_clone_token_isSet;
}

bool OAINullable_repository_template_repository::is_temp_clone_token_Valid() const{
