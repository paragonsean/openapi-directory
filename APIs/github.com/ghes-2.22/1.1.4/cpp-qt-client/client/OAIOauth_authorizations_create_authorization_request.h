...
/*
 * OAIOauth_authorizations_create_authorization_request.h
 *
 * 
 */

#ifndef OAIOauth_authorizations_create_authorization_request_H
#define OAIOauth_authorizations_create_authorization_request_H
...
class OAIOauth_authorizations_create_authorization_request : public OAIObject {
public:
    OAIOauth_authorizations_create_authorization_request();
    OAIOauth_authorizations_create_authorization_request(QString json);
    ~OAIOauth_authorizations_create_authorization_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOauth_authorizations_create_authorization_request)

#endif // OAIOauth_authorizations_create_authorization_request_H
