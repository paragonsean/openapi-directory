...
Q_SIGNALS:
    ...
    void enterpriseAdmin_getSelfHostedRunnerForEnterpriseSignal(OAIRunner_no_labels summary);
    ...
    void enterpriseAdmin_listOrgAccessToSelfHostedRunnerGroupInEnterpriseSignal(OAIEnterprise_admin_list_org_access_to_self_hosted_runner_group_in_enterprise_200_response summary);
    ...
    void enterpriseAdmin_getSelfHostedRunnerForEnterpriseSignalFull(OAIHttpRequestWorker *worker, OAIRunner_no_labels summary);
    ...
    void enterpriseAdmin_listOrgAccessToSelfHostedRunnerGroupInEnterpriseSignalFull(OAIHttpRequestWorker *worker, OAIEnterprise_admin_list_org_access_to_self_hosted_runner_group_in_enterprise_200_response summary);
    ...
    void enterpriseAdmin_getSelfHostedRunnerForEnterpriseSignalE(OAIRunner_no_labels summary, QNetworkReply::NetworkError error_type, QString error_str);
    void enterpriseAdmin_getSelfHostedRunnerForEnterpriseSignalError(OAIRunner_no_labels summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void enterpriseAdmin_listOrgAccessToSelfHostedRunnerGroupInEnterpriseSignalE(OAIEnterprise_admin_list_org_access_to_self_hosted_runner_group_in_enterprise_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void enterpriseAdmin_listOrgAccessToSelfHostedRunnerGroupInEnterpriseSignalError(OAIEnterprise_admin_list_org_access_to_self_hosted_runner_group_in_enterprise_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
