...
#ifndef OAIReview_comment_H
#define OAIReview_comment_H
...
namespace OpenAPI {
class OAIReview_comment__links;
class OAIReaction_rollup;
class OAINullable_simple_user;

class OAIReview_comment : public OAIObject {
public:
    OAIReview_comment();
    OAIReview_comment(QString json);
    ~OAIReview_comment() override;
    ...
    OAIReview_comment__links getLinks() const;
    void setLinks(const OAIReview_comment__links &_links);
...
private:
    ...
    OAIReview_comment__links m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReview_comment)

#endif // OAIReview_comment_H
