...
/*
 * OAIInstallation_ghes_2_account.h
 *
 * 
 */

#ifndef OAIInstallation_ghes_2_account_H
#define OAIInstallation_ghes_2_account_H
...
class OAIInstallation_ghes_2_account : public OAIObject {
public:
    OAIInstallation_ghes_2_account();
    OAIInstallation_ghes_2_account(QString json);
    ~OAIInstallation_ghes_2_account() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstallation_ghes_2_account)

#endif // OAIInstallation_ghes_2_account_H
