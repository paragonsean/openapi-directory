...
void OAIPage::initializeModel() {
    ...
    m_pending_domain_unverified_at_isSet = false;
    m_pending_domain_unverified_at_isValid = false;

    m_protected_domain_state_isSet = false;
    m_protected_domain_state_isValid = false;
...
void OAIPage::fromJsonObject(QJsonObject json) {
    ...
    m_pending_domain_unverified_at_isValid = ::OpenAPI::fromJsonValue(m_pending_domain_unverified_at, json[QString("pending_domain_unverified_at")]);
    m_pending_domain_unverified_at_isSet = !json[QString("pending_domain_unverified_at")].isNull() && m_pending_domain_unverified_at_isValid;

    m_protected_domain_state_isValid = ::OpenAPI::fromJsonValue(m_protected_domain_state, json[QString("protected_domain_state")]);
    m_protected_domain_state_isSet = !json[QString("protected_domain_state")].isNull() && m_protected_domain_state_isValid;
...
QJsonObject OAIPage::asJsonObject() const {
    ...
    if (m_pending_domain_unverified_at_isSet) {
        obj.insert(QString("pending_domain_unverified_at"), ::OpenAPI::toJsonValue(m_pending_domain_unverified_at));
    }
    if (m_protected_domain_state_isSet) {
        obj.insert(QString("protected_domain_state"), ::OpenAPI::toJsonValue(m_protected_domain_state));
    }
    if (m_r_public_isSet) {
...
QDateTime OAIPage::getPendingDomainUnverifiedAt() const {
    return m_pending_domain_unverified_at;
}
void OAIPage::setPendingDomainUnverifiedAt(const QDateTime &pending_domain_unverified_at) {
    m_pending_domain_unverified_at = pending_domain_unverified_at;
    m_pending_domain_unverified_at_isSet = true;
}

bool OAIPage::is_pending_domain_unverified_at_Set() const{
    return m_pending_domain_unverified_at_isSet;
}

bool OAIPage::is_pending_domain_unverified_at_Valid() const{
    return m_pending_domain_unverified_at_isValid;
}

QString OAIPage::getProtectedDomainState() const {
    return m_protected_domain_state;
}
void OAIPage::setProtectedDomainState(const QString &protected_domain_state) {
    m_protected_domain_state = protected_domain_state;
    m_protected_domain_state_isSet = true;
}

bool OAIPage::is_protected_domain_state_Set() const{
    return m_protected_domain_state_isSet;
}

bool OAIPage::is_protected_domain_state_Valid() const{
    return m_protected_domain_state_isValid;
}
