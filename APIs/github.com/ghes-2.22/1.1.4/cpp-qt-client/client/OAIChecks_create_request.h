...
/*
 * OAIChecks_create_request.h
 *
 * 
 */

#ifndef OAIChecks_create_request_H
#define OAIChecks_create_request_H
...
#include "OAIChecks_create_request_output.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
class OAIChecks_create_request_output;

class OAIChecks_create_request : public OAIObject {
public:
    OAIChecks_create_request();
    OAIChecks_create_request(QString json);
    ~OAIChecks_create_request() override;
    ...
    OAIChecks_create_request_output getOutput() const;
    void setOutput(const OAIChecks_create_request_output &output);
...
private:
    ...
    OAIChecks_create_request_output m_output;
    bool m_output_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChecks_create_request)

#endif // OAIChecks_create_request_H
