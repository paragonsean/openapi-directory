...
/*
 * OAICode_scanning_alert_rule.h
 *
 * 
 */

#ifndef OAICode_scanning_alert_rule_H
#define OAICode_scanning_alert_rule_H
...
class OAICode_scanning_alert_rule : public OAIObject {
public:
    OAICode_scanning_alert_rule();
    OAICode_scanning_alert_rule(QString json);
    ~OAICode_scanning_alert_rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICode_scanning_alert_rule)

#endif // OAICode_scanning_alert_rule_H
