...
/*
 * OAINullable_repository_template_repository.h
 *
 * 
 */

#ifndef OAINullable_repository_template_repository_H
#define OAINullable_repository_template_repository_H
...
class OAINullable_repository_template_repository : public OAIObject {
public:
    OAINullable_repository_template_repository();
    OAINullable_repository_template_repository(QString json);
    ~OAINullable_repository_template_repository() override;
    ...
    OAIBranch_restriction_policy_users_inner getOwner() const;
    void setOwner(const OAIBranch_restriction_policy_users_inner &owner);
    ...
    QString getPushedAt() const;
    void setPushedAt(const QString &pushed_at);
...
private:
    ...
    OAIBranch_restriction_policy_users_inner m_owner;
    bool m_owner_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_repository_template_repository)

#endif // OAINullable_repository_template_repository_H
