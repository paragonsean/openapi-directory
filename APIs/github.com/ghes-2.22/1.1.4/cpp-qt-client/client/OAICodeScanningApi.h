...
public:
    ...
    */
    virtual void codeScanning_listAlertsForRepo(const QString &owner, const QString &repo, const ::OpenAPI::OptionalParam<QString> &tool_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tool_guid = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &ref = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICode_scanning_alert_state> &state = ::OpenAPI::OptionalParam<OAICode_scanning_alert_state>());
