...
OAINullable_collaborator OAIRepository_collaborator_permission::getUser() const {
    return m_user;
}
void OAIRepository_collaborator_permission::setUser(const OAINullable_collaborator &user) {
    m_user = user;
    m_user_isSet = true;
}
