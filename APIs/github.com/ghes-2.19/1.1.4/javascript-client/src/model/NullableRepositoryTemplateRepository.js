...
class NullableRepositoryTemplateRepository {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = AuthorizationWithUserUser.constructFromObject(data['owner']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['owner']) { // data not null
          AuthorizationWithUserUser.validateJSON(data['owner']);
        }
...
/**
 * @member {module:model/AuthorizationWithUserUser} owner
 */
