...
/**
 * The BranchRestrictionPolicyRestrictionsInnerUsersInner model module.
 * @module model/BranchRestrictionPolicyRestrictionsInnerUsersInner
 * @version 1.1.4
 */
class BranchRestrictionPolicyRestrictionsInnerUsersInner {
    /**
     * Constructs a new <code>BranchRestrictionPolicyRestrictionsInnerUsersInner</code>.
     * @alias module:model/BranchRestrictionPolicyRestrictionsInnerUsersInner
     */
    constructor() { 
        
        BranchRestrictionPolicyRestrictionsInnerUsersInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BranchRestrictionPolicyRestrictionsInnerUsersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BranchRestrictionPolicyRestrictionsInnerUsersInner} obj Optional instance to populate.
     * @return {module:model/BranchRestrictionPolicyRestrictionsInnerUsersInner} The populated <code>BranchRestrictionPolicyRestrictionsInnerUsersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BranchRestrictionPolicyRestrictionsInnerUsersInner();
    ...
    /**
     * Validates the JSON data with respect to <code>BranchRestrictionPolicyRestrictionsInnerUsersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BranchRestrictionPolicyRestrictionsInnerUsersInner</code>.
     */
 ...
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['id'] = undefined;

/**
 * @member {String} login
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['login'] = undefined;

/**
 * @member {String} node_id
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['type'] = undefined;

/**
 * @member {String} url
 */
BranchRestrictionPolicyRestrictionsInnerUsersInner.prototype['url'] = undefined;
...
export default BranchRestrictionPolicyRestrictionsInnerUsersInner;
