...
class GitCommitParentsInner {
     ...
     * @param url {String} 
     */
    constructor(htmlUrl, sha, url) { 
        
        GitCommitParentsInner.initialize(this, htmlUrl, sha, url);
    }
     ...
     */
    static initialize(obj, htmlUrl, sha, url) { 
...
GitCommitParentsInner.RequiredProperties = ["html_url", "sha", "url"];
