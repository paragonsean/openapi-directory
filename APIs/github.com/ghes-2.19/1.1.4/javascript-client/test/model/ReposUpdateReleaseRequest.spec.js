...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposUpdateReleaseRequest();
  });
  ...
  describe('ReposUpdateReleaseRequest', function() {
    it('should create an instance of ReposUpdateReleaseRequest', function() {
      // uncomment below and update the code to test ReposUpdateReleaseRequest
      //var instance = new GitHubV3RestApi.ReposUpdateReleaseRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposUpdateReleaseRequest);
    });
