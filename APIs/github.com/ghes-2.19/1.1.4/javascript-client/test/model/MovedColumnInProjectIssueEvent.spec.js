...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.MovedColumnInProjectIssueEvent();
  });
  ...
  describe('MovedColumnInProjectIssueEvent', function() {
    it('should create an instance of MovedColumnInProjectIssueEvent', function() {
      // uncomment below and update the code to test MovedColumnInProjectIssueEvent
      //var instance = new GitHubV3RestApi.MovedColumnInProjectIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.MovedColumnInProjectIssueEvent);
    });
