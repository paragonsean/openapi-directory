...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.NullableSimpleUser();
  });
  ...
  describe('NullableSimpleUser', function() {
    it('should create an instance of NullableSimpleUser', function() {
      // uncomment below and update the code to test NullableSimpleUser
      //var instance = new GitHubV3RestApi.NullableSimpleUser();
      //expect(instance).to.be.a(GitHubV3RestApi.NullableSimpleUser);
    });
