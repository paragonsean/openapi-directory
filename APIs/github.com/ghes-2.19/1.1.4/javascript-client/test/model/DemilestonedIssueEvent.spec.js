...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.DemilestonedIssueEvent();
  });
  ...
  describe('DemilestonedIssueEvent', function() {
    it('should create an instance of DemilestonedIssueEvent', function() {
      // uncomment below and update the code to test DemilestonedIssueEvent
      //var instance = new GitHubV3RestApi.DemilestonedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.DemilestonedIssueEvent);
    });
