...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LegacyReviewComment();
  });
  ...
  describe('LegacyReviewComment', function() {
    it('should create an instance of LegacyReviewComment', function() {
      // uncomment below and update the code to test LegacyReviewComment
      //var instance = new GitHubV3RestApi.LegacyReviewComment();
      //expect(instance).to.be.a(GitHubV3RestApi.LegacyReviewComment);
    });
