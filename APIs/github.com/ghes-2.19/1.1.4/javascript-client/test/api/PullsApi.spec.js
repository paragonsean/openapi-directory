...
(function(root, factory) {
  ...
  describe('PullsApi', function() {
    ...
    describe('pullsCreateReviewCommentAlternative', function() {
      it('should call pullsCreateReviewCommentAlternative successfully', function(done) {
        //uncomment below and update the code to test pullsCreateReviewCommentAlternative
        //instance.pullsCreateReviewCommentAlternative(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
