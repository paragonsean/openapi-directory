...
(function(root, factory) {
  ...
  describe('ReposApi', function() {
    describe('reposAcceptInvitation', function() {
      it('should call reposAcceptInvitation successfully', function(done) {
        //uncomment below and update the code to test reposAcceptInvitation
        //instance.reposAcceptInvitation(function(error) {
    ...
    describe('reposDeclineInvitation', function() {
      it('should call reposDeclineInvitation successfully', function(done) {
        //uncomment below and update the code to test reposDeclineInvitation
        //instance.reposDeclineInvitation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
