...
let apiInstance = new GitHubV3RestApi.GistsApi();
let gistsCreateRequest = new GitHubV3RestApi.GistsCreateRequest(); // GistsCreateRequest | 
...
let apiInstance = new GitHubV3RestApi.GistsApi();
let gistId = "gistId_example"; // String | gist_id parameter
let gistsCreateCommentRequest = new GitHubV3RestApi.GistsCreateCommentRequest(); // GistsCreateCommentRequest | 
...
let apiInstance = new GitHubV3RestApi.GistsApi();
let gistId = "gistId_example"; // String | gist_id parameter
let gistsUpdateRequest = new GitHubV3RestApi.GistsUpdateRequest(); // GistsUpdateRequest | 
