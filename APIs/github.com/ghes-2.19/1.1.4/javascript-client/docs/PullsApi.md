...
let repo = "repo_example"; // String | 
let pullNumber = 56; // Number | 
let pullsCreateReviewCommentAlternativeRequest = {"body":"Nice change"}; // PullsCreateReviewCommentAlternativeRequest | 
apiInstance.pullsCreateReviewCommentAlternative(owner, repo, pullNumber, pullsCreateReviewCommentAlternativeRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
