...
apiInstance.oauthAuthorizationsCheckAuthorization(clientId, accessToken, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let clientId = "clientId_example"; // String | The client ID of your GitHub app.
let accessToken = "accessToken_example"; // String | 
apiInstance.oauthAuthorizationsResetAuthorization(clientId, accessToken, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let clientId = "clientId_example"; // String | The client ID of your GitHub app.
let accessToken = "accessToken_example"; // String | 
apiInstance.oauthAuthorizationsRevokeAuthorizationForApplication(clientId, accessToken, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let clientId = "clientId_example"; // String | The client ID of your GitHub app.
let accessToken = "accessToken_example"; // String | 
apiInstance.oauthAuthorizationsRevokeGrantForApplication(clientId, accessToken, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
