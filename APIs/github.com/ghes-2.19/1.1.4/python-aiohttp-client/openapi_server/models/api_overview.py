...
class ApiOverview(Model):
    ...
    def __init__(self, dependabot: List[str]=None, github_services_sha: str=None, installed_version: str=None, packages: List[str]=None, verifiable_password_authentication: bool=None):
        """ApiOverview - a model defined in OpenAPI

        :param dependabot: The dependabot of this ApiOverview.
        :param github_services_sha: The github_services_sha of this ApiOverview.
        ...
        self._github_services_sha = github_services_sha
    ...
    def github_services_sha(self):
        """Gets the github_services_sha of this ApiOverview.


        :return: The github_services_sha of this ApiOverview.
        :rtype: str
        """
        return self._github_services_sha

    @github_services_sha.setter
    def github_services_sha(self, github_services_sha):
        """Sets the github_services_sha of this ApiOverview.


        :param github_services_sha: The github_services_sha of this ApiOverview.
        :type github_services_sha: str
        """
