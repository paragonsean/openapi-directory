...
class PullRequestReviewComment(Model):
    ...
    def __init__(self, links: PullRequestReviewCommentLinks=None, author_association: AuthorAssociation=None, body: str=None, body_html: str=None, body_text: str=None, commit_id: str=None, created_at: datetime=None, diff_hunk: str=None, html_url: str=None, id: int=None, in_reply_to_id: int=None, node_id: str=None, original_commit_id: str=None, original_position: int=None, path: str=None, position: int=None, pull_request_review_id: int=None, pull_request_url: str=None, reactions: ReactionRollup=None, updated_at: datetime=None, url: str=None, user: SimpleUser=None):
