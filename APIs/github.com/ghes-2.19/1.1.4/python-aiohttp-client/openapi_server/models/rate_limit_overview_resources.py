...
class RateLimitOverviewResources(Model):
    ...
    def __init__(self, code_scanning_upload: RateLimit=None, core: RateLimit=None, graphql: RateLimit=None, integration_manifest: RateLimit=None, search: RateLimit=None, source_import: RateLimit=None):
