...
async def teams_add_or_update_membership_for_user(request: web.Request, team_id, username, body=None) -> web.Response:
    ...
    """
    body = TeamsAddOrUpdateMembershipForUserRequest.from_dict(body)
    return web.Response(status=200)


async def teams_add_or_update_project_permissions(request: web.Request, accept, team_id, project_id, body=None) -> web.Response:
    ...
    """
    body = TeamsAddOrUpdateProjectPermissionsRequest.from_dict(body)
    return web.Response(status=200)


async def teams_add_or_update_repo_permissions(request: web.Request, team_id, owner, repo, body=None) -> web.Response:
    ...
    """
    body = TeamsAddOrUpdateRepoPermissionsRequest.from_dict(body)
    return web.Response(status=200)


async def teams_check_permissions_for_project(request: web.Request, accept, team_id, project_id) -> web.Response:
...
async def teams_create_discussion(request: web.Request, team_id, body) -> web.Response:
    """Create a discussion

    Creates a new discussion post on a team&#39;s page. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@2.19/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \&quot;[Secondary rate limits](https://docs.github.com/enterprise-server@2.19/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\&quot; for details.
    ...
    """
    body = TeamsCreateDiscussionRequest.from_dict(body)
    return web.Response(status=200)


async def teams_create_discussion_comment(request: web.Request, team_id, discussion_number, body) -> web.Response:
    ...
    """
    body = TeamsCreateDiscussionCommentRequest.from_dict(body)
    return web.Response(status=200)
...
async def teams_delete(request: web.Request, team_id) -> web.Response:
    ...
    To delete a team, the authenticated user must be an organization owner or team maintainer.  If you are an organization owner and you pass the &#x60;hellcat-preview&#x60; media type, deleting a parent team will delete all of its child teams as well.
...
async def teams_delete_discussion(request: web.Request, team_id, discussion_number) -> web.Response:
    """Delete a discussion
...
async def teams_delete_discussion_comment(request: web.Request, team_id, discussion_number, comment_number) -> web.Response:
...
async def teams_get_discussion(request: web.Request, team_id, discussion_number) -> web.Response:
    """Get a discussion
...
async def teams_get_discussion_comment(request: web.Request, team_id, discussion_number, comment_number) -> web.Response:
...
async def teams_get_member_legacy(request: web.Request, team_id, username) -> web.Response:
    ...
    The \&quot;Get team member\&quot; endpoint (described below) is deprecated.  We recommend using the [Get team membership for a user](https://docs.github.com/enterprise-server@2.19/rest/reference/teams#get-team-membership-for-a-user) endpoint instead. It allows you to get both active and pending memberships.  To list members in a team, the team must be visible to the authenticated user.
...
async def teams_get_membership_for_user(request: web.Request, team_id, username) -> web.Response:
    """Get team membership for a user

    If you pass the &#x60;hellcat-preview&#x60; media type, team members will include the members of child teams.  To get a user&#39;s membership with a team, the team must be visible to the authenticated user.  **Note:** The response contains the &#x60;state&#x60; of the membership and the member&#39;s &#x60;role&#x60;.  The &#x60;role&#x60; for organization owners is set to &#x60;maintainer&#x60;. For more information about &#x60;maintainer&#x60; roles, see [Create a team](https://docs.github.com/enterprise-server@2.19/rest/reference/teams#create-a-team).
...
async def teams_list_child(request: web.Request, team_id, per_page=None, page=None) -> web.Response:
    """List child teams
...
async def teams_list_discussion_comments(request: web.Request, team_id, discussion_number, direction=None, per_page=None, page=None) -> web.Response:
...
async def teams_list_discussions(request: web.Request, team_id, direction=None, per_page=None, page=None) -> web.Response:
    """List discussions
...
async def teams_list_members(request: web.Request, team_id, role=None, per_page=None, page=None) -> web.Response:
    """List team members

    If you pass the &#x60;hellcat-preview&#x60; media type, team members will include the members of child teams.  To list members in a team, the team must be visible to the authenticated user.
...
async def teams_list_projects(request: web.Request, accept, team_id, per_page=None, page=None) -> web.Response:
    """List team projects
...
async def teams_list_repos(request: web.Request, team_id, per_page=None, page=None) -> web.Response:
    """List team repositories

    **Note**: If you pass the &#x60;hellcat-preview&#x60; media type, the response will include any repositories inherited through a parent team.  If you are an [authenticated](https://docs.github.com/enterprise-server@2.19/rest/overview/resources-in-the-rest-api#authentication) site administrator for your Enterprise instance, you will be able to list all repositories for the team.
...
async def teams_remove_membership_for_user(request: web.Request, team_id, username) -> web.Response:
...
async def teams_remove_project(request: web.Request, team_id, project_id) -> web.Response:
...
async def teams_remove_repo(request: web.Request, team_id, owner, repo) -> web.Response:
...
async def teams_update_discussion(request: web.Request, team_id, discussion_number, body=None) -> web.Response:
    """Update a discussion
    ...
    """
    body = TeamsUpdateDiscussionRequest.from_dict(body)
    return web.Response(status=200)


async def teams_update_discussion_comment(request: web.Request, team_id, discussion_number, comment_number, body) -> web.Response:
