...
async def activity_list_notifications_for_authenticated_user(request: web.Request, all=None, participating=None, since=None, before=None, per_page=None, page=None) -> web.Response:
...
async def activity_list_repos_starred_by_authenticated_user(request: web.Request, sort=None, direction=None, per_page=None, page=None) -> web.Response:
    ...
    Lists repositories the authenticated user has starred.  You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@2.19/rest/overview/media-types/) via the &#x60;Accept&#x60; header:
...
async def activity_list_repos_starred_by_user(request: web.Request, username, sort=None, direction=None, per_page=None, page=None) -> web.Response:
    ...
    Lists repositories a user has starred.  You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@2.19/rest/overview/media-types/) via the &#x60;Accept&#x60; header:
...
async def activity_list_stargazers_for_repo(request: web.Request, owner, repo, per_page=None, page=None) -> web.Response:
    ...
    Lists the people that have starred the repository.  You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@2.19/rest/overview/media-types/) via the &#x60;Accept&#x60; header:
