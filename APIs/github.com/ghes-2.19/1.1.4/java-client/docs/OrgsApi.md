...
> OrgsListAppInstallations200Response orgsListAppInstallations(accept, org, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OrgsListAppInstallations200Response result = apiInstance.orgsListAppInstallations(accept, org, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
