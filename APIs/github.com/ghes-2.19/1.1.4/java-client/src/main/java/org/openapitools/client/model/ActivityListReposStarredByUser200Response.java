...
public class ActivityListReposStarredByUser200Response extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final Type typeInstanceListStarredRepository = new TypeToken<List<StarredRepository>>(){}.getType();
            final TypeAdapter<List<StarredRepository>> adapterListStarredRepository = (TypeAdapter<List<StarredRepository>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstanceListStarredRepository));

            final Type typeInstanceListRepository = new TypeToken<List<Repository>>(){}.getType();
            final TypeAdapter<List<Repository>> adapterListRepository = (TypeAdapter<List<Repository>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstanceListRepository));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ActivityListReposStarredByUser200Response>() {
                ...
                public void write(JsonWriter out, ActivityListReposStarredByUser200Response value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof List<?>) {
                        ...
                        if (list.get(0) instanceof StarredRepository) {
                            JsonArray array = adapterListStarredRepository.toJsonTree((List<StarredRepository>)value.getActualInstance()).getAsJsonArray();
                ...
                public ActivityListReposStarredByUser200Response read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        for(JsonElement element : array) {
                            StarredRepository.validateJsonElement(element);
                        }
                        actualAdapter = adapterListStarredRepository;
                        ActivityListReposStarredByUser200Response ret = new ActivityListReposStarredByUser200Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for List<StarredRepository> failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'List<StarredRepository>'", e);
                    }

                    throw new IOException(String.format("Failed deserialization for ActivityListReposStarredByUser200Response: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ActivityListReposStarredByUser200Response(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("List<StarredRepository>", List.class);
    }
     ...
     */
    public List<StarredRepository> getListStarredRepository() throws ClassCastException {
     ...
     * @throws IOException if the JSON Element is invalid with respect to ActivityListReposStarredByUser200Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for ActivityListReposStarredByUser200Response with anyOf schemas: List<Repository>, List<StarredRepository>. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
