...
public class NullableIntegration {
  ...
  public NullableIntegration clientSecret(String clientSecret) {
  ...
  public NullableIntegration id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public NullableIntegration installationsCount(Integer installationsCount) {
  ...
  public NullableIntegration owner(NullableSimpleUser owner) {
    this.owner = owner;
    return this;
  }
  ...
  public NullableIntegration pem(String pem) {
    this.pem = pem;
    return this;
  }
  ...
  public NullableIntegration webhookSecret(String webhookSecret) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, nullableIntegration.clientId) &&
        Objects.equals(this.clientSecret, nullableIntegration.clientSecret) &&
        ...
        Objects.equals(this.id, nullableIntegration.id) &&
        ...
        Objects.equals(this.pem, nullableIntegration.pem) &&
        ...
        Objects.equals(this.webhookSecret, nullableIntegration.webhookSecret);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NullableIntegration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NullableIntegration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NullableIntegration is not found in the empty JSON string", NullableIntegration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NullableIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NullableIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NullableIntegration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NullableIntegration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NullableIntegration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NullableIntegration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NullableIntegration.class));

       return (TypeAdapter<T>) new TypeAdapter<NullableIntegration>() {
           @Override
           public void write(JsonWriter out, NullableIntegration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NullableIntegration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NullableIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NullableIntegration
   * @throws IOException if the JSON string is invalid with respect to NullableIntegration
   */
  public static NullableIntegration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NullableIntegration.class);
  }

  /**
   * Convert an instance of NullableIntegration to an JSON string
   *
   * @return JSON string
   */
