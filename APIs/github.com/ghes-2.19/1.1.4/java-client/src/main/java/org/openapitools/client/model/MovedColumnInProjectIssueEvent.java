...
public class MovedColumnInProjectIssueEvent {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actor, movedColumnInProjectIssueEvent.actor) &&
        ...
        Objects.equals(this.id, movedColumnInProjectIssueEvent.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to MovedColumnInProjectIssueEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MovedColumnInProjectIssueEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MovedColumnInProjectIssueEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MovedColumnInProjectIssueEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
