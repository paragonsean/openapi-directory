...
public class ApiOverview {
  ...
  public static final String SERIALIZED_NAME_GITHUB_SERVICES_SHA = "github_services_sha";
  @SerializedName(SERIALIZED_NAME_GITHUB_SERVICES_SHA)
  ...
  public ApiOverview githubServicesSha(String githubServicesSha) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dependabot, apiOverview.dependabot) &&
        Objects.equals(this.githubServicesSha, apiOverview.githubServicesSha) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dependabot, githubServicesSha, installedVersion, packages, verifiablePasswordAuthentication);
  }
  ...
  public String toString() {
    ...
    sb.append("    githubServicesSha: ").append(toIndentedString(githubServicesSha)).append("\n");
  ...
  static {
    ...
    openapiFields.add("github_services_sha");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("github_services_sha") != null && !jsonObj.get("github_services_sha").isJsonNull()) && !jsonObj.get("github_services_sha").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `github_services_sha` to be a primitive type in the JSON string but got `%s`", jsonObj.get("github_services_sha").toString()));
      }
