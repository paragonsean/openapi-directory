...
public class CollaboratorPermissions {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.admin, collaboratorPermissions.admin) &&
        Objects.equals(this.maintain, collaboratorPermissions.maintain) &&
        Objects.equals(this.pull, collaboratorPermissions.pull) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CollaboratorPermissions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollaboratorPermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollaboratorPermissions is not found in the empty JSON string", CollaboratorPermissions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CollaboratorPermissions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CollaboratorPermissions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CollaboratorPermissions.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollaboratorPermissions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollaboratorPermissions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollaboratorPermissions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollaboratorPermissions.class));

       return (TypeAdapter<T>) new TypeAdapter<CollaboratorPermissions>() {
           @Override
           public void write(JsonWriter out, CollaboratorPermissions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CollaboratorPermissions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CollaboratorPermissions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CollaboratorPermissions
   * @throws IOException if the JSON string is invalid with respect to CollaboratorPermissions
   */
  public static CollaboratorPermissions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollaboratorPermissions.class);
  }

  /**
   * Convert an instance of CollaboratorPermissions to an JSON string
   *
   * @return JSON string
   */
