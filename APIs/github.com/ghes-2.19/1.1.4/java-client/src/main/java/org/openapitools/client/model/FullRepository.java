...
public class FullRepository {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowForking, allowMergeCommit, allowRebaseMerge, allowSquashMerge, anonymousAccessEnabled, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, codeOfConduct, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, disabled, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id, isTemplate, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, masterBranch, mergesUrl, milestonesUrl, mirrorUrl, name, networkCount, nodeId, notificationsUrl, openIssues, openIssuesCount, organization, owner, parent, permissions, _private, pullsUrl, pushedAt, releasesUrl, size, source, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersCount, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, templateRepository, topics, treesUrl, updatedAt, url, watchers, watchersCount);
  }
