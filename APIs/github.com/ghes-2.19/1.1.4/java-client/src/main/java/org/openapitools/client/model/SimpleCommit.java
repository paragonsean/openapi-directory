...
import org.openapitools.client.model.SimpleCommitAuthor;
...
public class SimpleCommit {
  ...
  public SimpleCommit author(SimpleCommitAuthor author) {
    this.author = author;
    return this;
  }
  ...
  public SimpleCommitAuthor getAuthor() {
    return author;
  }

  public void setAuthor(SimpleCommitAuthor author) {
    this.author = author;
  }


  public SimpleCommit committer(SimpleCommitAuthor committer) {
   ...
   */
  @javax.annotation.Nullable
  public SimpleCommitAuthor getCommitter() {
    return committer;
  }

  public void setCommitter(SimpleCommitAuthor committer) {
    this.committer = committer;
  }
  ...
  public SimpleCommit timestamp(OffsetDateTime timestamp) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleCommit
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleCommit.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleCommit.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleCommit` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      SimpleCommitAuthor.validateJsonElement(jsonObj.get("author"));
      // validate the required field `committer`
      SimpleCommitAuthor.validateJsonElement(jsonObj.get("committer"));
