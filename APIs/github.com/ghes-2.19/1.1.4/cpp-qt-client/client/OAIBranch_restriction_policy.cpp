...
QList<OAIBranch_restriction_policy_restrictions_inner> OAIBranch_restriction_policy::getRestrictions() const {
    return m_restrictions;
}
void OAIBranch_restriction_policy::setRestrictions(const QList<OAIBranch_restriction_policy_restrictions_inner> &restrictions) {
    m_restrictions = restrictions;
    m_restrictions_isSet = true;
}

bool OAIBranch_restriction_policy::is_restrictions_Set() const{
    return m_restrictions_isSet;
}

bool OAIBranch_restriction_policy::is_restrictions_Valid() const{
...
QList<OAIAuthorization_with_user_user> OAIBranch_restriction_policy::getUsers() const {
    return m_users;
}
void OAIBranch_restriction_policy::setUsers(const QList<OAIAuthorization_with_user_user> &users) {
    m_users = users;
    m_users_isSet = true;
}
