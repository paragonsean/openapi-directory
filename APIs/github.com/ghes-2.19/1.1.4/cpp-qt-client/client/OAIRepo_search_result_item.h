...
/*
 * OAIRepo_search_result_item.h
 *
 * Repo Search Result Item
 */

#ifndef OAIRepo_search_result_item_H
#define OAIRepo_search_result_item_H
...
class OAIRepo_search_result_item : public OAIObject {
public:
    OAIRepo_search_result_item();
    OAIRepo_search_result_item(QString json);
    ~OAIRepo_search_result_item() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepo_search_result_item)

#endif // OAIRepo_search_result_item_H
