...
void OAIApp_permissions::initializeModel() {
    ...
    m_content_references_isSet = false;
    m_content_references_isValid = false;
...
void OAIApp_permissions::fromJsonObject(QJsonObject json) {
    ...
    m_content_references_isValid = ::OpenAPI::fromJsonValue(m_content_references, json[QString("content_references")]);
    m_content_references_isSet = !json[QString("content_references")].isNull() && m_content_references_isValid;
...
QJsonObject OAIApp_permissions::asJsonObject() const {
    ...
    if (m_content_references_isSet) {
        obj.insert(QString("content_references"), ::OpenAPI::toJsonValue(m_content_references));
    }
    if (m_contents_isSet) {
...
QString OAIApp_permissions::getContentReferences() const {
    return m_content_references;
}
void OAIApp_permissions::setContentReferences(const QString &content_references) {
    m_content_references = content_references;
    m_content_references_isSet = true;
}

bool OAIApp_permissions::is_content_references_Set() const{
    return m_content_references_isSet;
}

bool OAIApp_permissions::is_content_references_Valid() const{
    return m_content_references_isValid;
}
