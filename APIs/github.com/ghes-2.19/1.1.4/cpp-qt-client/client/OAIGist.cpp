...
void OAIGist::fromJson(QString jsonString) {
...
void OAIGist::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIGist::asJsonObject() const {
    QJsonObject obj;
    if (m_comments_isSet) {
...
qint32 OAIGist::getComments() const {
    return m_comments;
}
void OAIGist::setComments(const qint32 &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIGist::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIGist::is_comments_Valid() const{
    return m_comments_isValid;
}

QString OAIGist::getCommentsUrl() const {
    return m_comments_url;
}
void OAIGist::setCommentsUrl(const QString &comments_url) {
    m_comments_url = comments_url;
    m_comments_url_isSet = true;
}

bool OAIGist::is_comments_url_Set() const{
    return m_comments_url_isSet;
}

bool OAIGist::is_comments_url_Valid() const{
    return m_comments_url_isValid;
}

QString OAIGist::getCommitsUrl() const {
    return m_commits_url;
}
void OAIGist::setCommitsUrl(const QString &commits_url) {
    m_commits_url = commits_url;
    m_commits_url_isSet = true;
}

bool OAIGist::is_commits_url_Set() const{
    return m_commits_url_isSet;
}

bool OAIGist::is_commits_url_Valid() const{
    return m_commits_url_isValid;
}

QDateTime OAIGist::getCreatedAt() const {
    return m_created_at;
}
void OAIGist::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIGist::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIGist::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIGist::getDescription() const {
    return m_description;
}
void OAIGist::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIGist::is_description_Set() const{
    return m_description_isSet;
}

bool OAIGist::is_description_Valid() const{
    return m_description_isValid;
}

QMap<QString, OAIBase_gist_files_value> OAIGist::getFiles() const {
    return m_files;
}
void OAIGist::setFiles(const QMap<QString, OAIBase_gist_files_value> &files) {
    m_files = files;
    m_files_isSet = true;
}

bool OAIGist::is_files_Set() const{
    return m_files_isSet;
}

bool OAIGist::is_files_Valid() const{
    return m_files_isValid;
}

QList<QJsonValue> OAIGist::getForks() const {
    return m_forks;
}
void OAIGist::setForks(const QList<QJsonValue> &forks) {
    m_forks = forks;
    m_forks_isSet = true;
}

bool OAIGist::is_forks_Set() const{
    return m_forks_isSet;
}

bool OAIGist::is_forks_Valid() const{
    return m_forks_isValid;
}

QString OAIGist::getForksUrl() const {
    return m_forks_url;
}
void OAIGist::setForksUrl(const QString &forks_url) {
    m_forks_url = forks_url;
    m_forks_url_isSet = true;
}

bool OAIGist::is_forks_url_Set() const{
    return m_forks_url_isSet;
}

bool OAIGist::is_forks_url_Valid() const{
    return m_forks_url_isValid;
}

QString OAIGist::getGitPullUrl() const {
    return m_git_pull_url;
}
void OAIGist::setGitPullUrl(const QString &git_pull_url) {
    m_git_pull_url = git_pull_url;
    m_git_pull_url_isSet = true;
}

bool OAIGist::is_git_pull_url_Set() const{
    return m_git_pull_url_isSet;
}

bool OAIGist::is_git_pull_url_Valid() const{
    return m_git_pull_url_isValid;
}

QString OAIGist::getGitPushUrl() const {
    return m_git_push_url;
}
void OAIGist::setGitPushUrl(const QString &git_push_url) {
    m_git_push_url = git_push_url;
    m_git_push_url_isSet = true;
}

bool OAIGist::is_git_push_url_Set() const{
    return m_git_push_url_isSet;
}

bool OAIGist::is_git_push_url_Valid() const{
    return m_git_push_url_isValid;
}

QList<QJsonValue> OAIGist::getHistory() const {
    return m_history;
}
void OAIGist::setHistory(const QList<QJsonValue> &history) {
    m_history = history;
    m_history_isSet = true;
}

bool OAIGist::is_history_Set() const{
    return m_history_isSet;
}

bool OAIGist::is_history_Valid() const{
    return m_history_isValid;
}

QString OAIGist::getHtmlUrl() const {
    return m_html_url;
}
void OAIGist::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAIGist::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAIGist::is_html_url_Valid() const{
    return m_html_url_isValid;
}

QString OAIGist::getId() const {
    return m_id;
}
void OAIGist::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIGist::is_id_Set() const{
    return m_id_isSet;
}

bool OAIGist::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIGist::getNodeId() const {
    return m_node_id;
}
void OAIGist::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAIGist::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAIGist::is_node_id_Valid() const{
    return m_node_id_isValid;
}

OAINullable_simple_user OAIGist::getOwner() const {
    return m_owner;
}
void OAIGist::setOwner(const OAINullable_simple_user &owner) {
    m_owner = owner;
    m_owner_isSet = true;
}

bool OAIGist::is_owner_Set() const{
    return m_owner_isSet;
}

bool OAIGist::is_owner_Valid() const{
    return m_owner_isValid;
}

bool OAIGist::isRPublic() const {
    return m_r_public;
}
void OAIGist::setRPublic(const bool &r_public) {
    m_r_public = r_public;
    m_r_public_isSet = true;
}

bool OAIGist::is_r_public_Set() const{
    return m_r_public_isSet;
}

bool OAIGist::is_r_public_Valid() const{
    return m_r_public_isValid;
}

bool OAIGist::isTruncated() const {
    return m_truncated;
}
void OAIGist::setTruncated(const bool &truncated) {
    m_truncated = truncated;
    m_truncated_isSet = true;
}

bool OAIGist::is_truncated_Set() const{
    return m_truncated_isSet;
}

bool OAIGist::is_truncated_Valid() const{
    return m_truncated_isValid;
}

QDateTime OAIGist::getUpdatedAt() const {
    return m_updated_at;
}
void OAIGist::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIGist::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIGist::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIGist::getUrl() const {
    return m_url;
}
void OAIGist::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIGist::is_url_Set() const{
    return m_url_isSet;
}

bool OAIGist::is_url_Valid() const{
    return m_url_isValid;
}

OAINullable_simple_user OAIGist::getUser() const {
    return m_user;
}
void OAIGist::setUser(const OAINullable_simple_user &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIGist::is_user_Set() const{
    return m_user_isSet;
}

bool OAIGist::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIGist::isSet() const {
