...
OAIIssue_simple OAITimeline_cross_referenced_event_source::getIssue() const {
    return m_issue;
}
void OAITimeline_cross_referenced_event_source::setIssue(const OAIIssue_simple &issue) {
    m_issue = issue;
    m_issue_isSet = true;
}
