...
/*
 * OAIPull_request_base_repo_owner.h
 *
 * 
 */

#ifndef OAIPull_request_base_repo_owner_H
#define OAIPull_request_base_repo_owner_H
...
class OAIPull_request_base_repo_owner : public OAIObject {
public:
    OAIPull_request_base_repo_owner();
    OAIPull_request_base_repo_owner(QString json);
    ~OAIPull_request_base_repo_owner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPull_request_base_repo_owner)

#endif // OAIPull_request_base_repo_owner_H
