...
/*
 * OAILocked_issue_event.h
 *
 * Locked Issue Event
 */

#ifndef OAILocked_issue_event_H
#define OAILocked_issue_event_H
...
class OAILocked_issue_event : public OAIObject {
public:
    OAILocked_issue_event();
    OAILocked_issue_event(QString json);
    ~OAILocked_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocked_issue_event)

#endif // OAILocked_issue_event_H
