...
namespace OpenAPI {
class OAITeam_2_parent;

class OAITeam_2 : public OAIObject {
public:
    OAITeam_2();
    OAITeam_2(QString json);
    ~OAITeam_2() override;
    ...
    OAITeam_2_parent getParent() const;
    void setParent(const OAITeam_2_parent &parent);
...
Q_DECLARE_METATYPE(OpenAPI::OAITeam_2)
