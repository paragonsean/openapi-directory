...
class OAIBranch_protection_required_conversation_resolution;
...
public:
    ...
    OAIBranch_protection_required_conversation_resolution getPages() const;
    void setPages(const OAIBranch_protection_required_conversation_resolution &pages);
...
private:
    ...
    OAIBranch_protection_required_conversation_resolution m_pages;
    bool m_pages_isSet;
