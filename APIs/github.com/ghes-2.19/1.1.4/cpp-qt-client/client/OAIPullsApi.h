...
public:
    ...
    * @param[in]  repo QString [required]
    * @param[in]  pull_number qint32 [required]
    * @param[in]  oai_pulls_create_review_comment_alternative_request OAIPulls_create_review_comment_alternative_request [required]
    */
    virtual void pulls_createReviewCommentAlternative(const QString &owner, const QString &repo, const qint32 &pull_number, const OAIPulls_create_review_comment_alternative_request &oai_pulls_create_review_comment_alternative_request);
...
private:
    ...
    void pulls_createReviewCommentAlternativeCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void pulls_createReviewCommentAlternativeSignal(OAILegacy_review_comment summary);
    ...
    void pulls_createReviewCommentAlternativeSignalFull(OAIHttpRequestWorker *worker, OAILegacy_review_comment summary);
    ...
    Q_DECL_DEPRECATED_X("Use pulls_createReviewCommentAlternativeSignalError() instead")
    void pulls_createReviewCommentAlternativeSignalE(OAILegacy_review_comment summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pulls_createReviewCommentAlternativeSignalError(OAILegacy_review_comment summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pulls_createReviewCommentAlternativeSignalErrorFull() instead")
    void pulls_createReviewCommentAlternativeSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pulls_createReviewCommentAlternativeSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
