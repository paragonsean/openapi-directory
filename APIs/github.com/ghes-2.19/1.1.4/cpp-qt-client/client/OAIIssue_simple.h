...
#ifndef OAIIssue_simple_H
#define OAIIssue_simple_H
...
class OAIIssue_simple : public OAIObject {
public:
    OAIIssue_simple();
    OAIIssue_simple(QString json);
    ~OAIIssue_simple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssue_simple)

#endif // OAIIssue_simple_H
