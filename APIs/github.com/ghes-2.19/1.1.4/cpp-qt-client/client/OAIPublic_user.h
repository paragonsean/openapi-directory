...
#ifndef OAIPublic_user_H
#define OAIPublic_user_H
...
class OAIPublic_user : public OAIObject {
public:
    OAIPublic_user();
    OAIPublic_user(QString json);
    ~OAIPublic_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPublic_user)

#endif // OAIPublic_user_H
