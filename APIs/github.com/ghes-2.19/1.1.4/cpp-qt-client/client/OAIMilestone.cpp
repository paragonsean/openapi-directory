...
qint32 OAIMilestone::getClosedIssues() const {
    return m_closed_issues;
}
void OAIMilestone::setClosedIssues(const qint32 &closed_issues) {
...
OAINullable_simple_user OAIMilestone::getCreator() const {
    return m_creator;
}
void OAIMilestone::setCreator(const OAINullable_simple_user &creator) {
    m_creator = creator;
    m_creator_isSet = true;
}

bool OAIMilestone::is_creator_Set() const{
    return m_creator_isSet;
}

bool OAIMilestone::is_creator_Valid() const{
...
QString OAIMilestone::getHtmlUrl() const {
    return m_html_url;
}
void OAIMilestone::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAIMilestone::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAIMilestone::is_html_url_Valid() const{
...
QString OAIMilestone::getLabelsUrl() const {
    return m_labels_url;
}
void OAIMilestone::setLabelsUrl(const QString &labels_url) {
    m_labels_url = labels_url;
    m_labels_url_isSet = true;
}

bool OAIMilestone::is_labels_url_Set() const{
    return m_labels_url_isSet;
}

bool OAIMilestone::is_labels_url_Valid() const{
    return m_labels_url_isValid;
}

QString OAIMilestone::getNodeId() const {
    return m_node_id;
}
void OAIMilestone::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAIMilestone::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAIMilestone::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint32 OAIMilestone::getNumber() const {
    return m_number;
}
void OAIMilestone::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIMilestone::is_number_Set() const{
    return m_number_isSet;
}

bool OAIMilestone::is_number_Valid() const{
    return m_number_isValid;
}

qint32 OAIMilestone::getOpenIssues() const {
    return m_open_issues;
}
void OAIMilestone::setOpenIssues(const qint32 &open_issues) {
...
QString OAIMilestone::getUrl() const {
    return m_url;
}
void OAIMilestone::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIMilestone::is_url_Set() const{
    return m_url_isSet;
}

bool OAIMilestone::is_url_Valid() const{
