...
/*
 * OAIAuthorization_with_user_user.h
 *
 * 
 */

#ifndef OAIAuthorization_with_user_user_H
#define OAIAuthorization_with_user_user_H
...
class OAIAuthorization_with_user_user : public OAIObject {
public:
    OAIAuthorization_with_user_user();
    OAIAuthorization_with_user_user(QString json);
    ~OAIAuthorization_with_user_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthorization_with_user_user)

#endif // OAIAuthorization_with_user_user_H
