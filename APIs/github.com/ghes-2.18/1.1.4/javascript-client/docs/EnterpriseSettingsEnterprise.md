# GitHubV3RestApi.EnterpriseSettingsEnterprise
...
**configurationId** | **Number** |  | [optional] 
**configurationRunCount** | **Number** |  | [optional] 
**customer** | [**EnterpriseSettingsEnterpriseCustomer**](EnterpriseSettingsEnterpriseCustomer.md) |  | [optional] 
**expireSessions** | **Boolean** |  | [optional] 
...
**pages** | [**BranchProtectionRequiredConversationResolution**](BranchProtectionRequiredConversationResolution.md) |  | [optional] 
**privateMode** | **Boolean** |  | [optional] 
**publicPages** | **Boolean** |  | [optional] 
**saml** | [**EnterpriseSettingsEnterpriseSaml**](EnterpriseSettingsEnterpriseSaml.md) |  | [optional] 
**signupEnabled** | **Boolean** |  | [optional] 
...
**subdomainIsolation** | **Boolean** |  | [optional] 
