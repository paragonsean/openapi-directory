...
let apiInstance = new GitHubV3RestApi.TeamsApi();
let accept = "'application/vnd.github.echo-preview+json'"; // String | This API is under preview and subject to change.
let teamId = 56; // Number | 
...
apiInstance.teamsCreateDiscussion(accept, teamId, teamsCreateDiscussionRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.teamsCreateDiscussionComment(accept, teamId, discussionNumber, teamsCreateDiscussionCommentRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let teamId = 56; // Number | 
let discussionNumber = 56; // Number | 
apiInstance.teamsDeleteDiscussion(accept, teamId, discussionNumber, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.teamsDeleteDiscussionComment(accept, teamId, discussionNumber, commentNumber, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let teamId = 56; // Number | 
let discussionNumber = 56; // Number | 
apiInstance.teamsGetDiscussion(accept, teamId, discussionNumber, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let discussionNumber = 56; // Number | 
let commentNumber = 56; // Number | 
apiInstance.teamsGetDiscussionComment(accept, teamId, discussionNumber, commentNumber, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [TeamDiscussionComment] teamsListDiscussionComments(accept, teamId, discussionNumber, opts)
...
apiInstance.teamsListDiscussionComments(accept, teamId, discussionNumber, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [TeamDiscussion] teamsListDiscussions(accept, teamId, opts)
...
apiInstance.teamsListDiscussions(accept, teamId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TeamDiscussion teamsUpdateDiscussion(accept, teamId, discussionNumber, opts)
...
apiInstance.teamsUpdateDiscussion(accept, teamId, discussionNumber, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.teamsUpdateDiscussionComment(accept, teamId, discussionNumber, commentNumber, teamsCreateDiscussionCommentRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
