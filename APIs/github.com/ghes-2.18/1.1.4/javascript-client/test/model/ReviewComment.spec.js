...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReviewComment();
  });
  ...
  describe('ReviewComment', function() {
    it('should create an instance of ReviewComment', function() {
      // uncomment below and update the code to test ReviewComment
      //var instance = new GitHubV3RestApi.ReviewComment();
      //expect(instance).to.be.a(GitHubV3RestApi.ReviewComment);
    });
