...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullsCreateRequest();
  });
  ...
  describe('PullsCreateRequest', function() {
    it('should create an instance of PullsCreateRequest', function() {
      // uncomment below and update the code to test PullsCreateRequest
      //var instance = new GitHubV3RestApi.PullsCreateRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.PullsCreateRequest);
    });
