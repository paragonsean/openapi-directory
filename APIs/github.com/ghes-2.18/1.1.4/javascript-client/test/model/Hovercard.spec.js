...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.Hovercard();
  });
  ...
  describe('Hovercard', function() {
    it('should create an instance of Hovercard', function() {
      // uncomment below and update the code to test Hovercard
      //var instance = new GitHubV3RestApi.Hovercard();
      //expect(instance).to.be.a(GitHubV3RestApi.Hovercard);
    });
