...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TeamProject();
  });
  ...
  describe('TeamProject', function() {
    it('should create an instance of TeamProject', function() {
      // uncomment below and update the code to test TeamProject
      //var instance = new GitHubV3RestApi.TeamProject();
      //expect(instance).to.be.a(GitHubV3RestApi.TeamProject);
    });
