...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.CombinedCommitStatus();
  });
  ...
  describe('CombinedCommitStatus', function() {
    it('should create an instance of CombinedCommitStatus', function() {
      // uncomment below and update the code to test CombinedCommitStatus
      //var instance = new GitHubV3RestApi.CombinedCommitStatus();
      //expect(instance).to.be.a(GitHubV3RestApi.CombinedCommitStatus);
    });
