...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyRestrictionsInnerTeamsInner();
  });
  ...
  describe('BranchRestrictionPolicyRestrictionsInnerTeamsInner', function() {
    it('should create an instance of BranchRestrictionPolicyRestrictionsInnerTeamsInner', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyRestrictionsInnerTeamsInner
      //var instance = new GitHubV3RestApi.BranchRestrictionPolicyRestrictionsInnerTeamsInner();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyRestrictionsInnerTeamsInner);
    });
