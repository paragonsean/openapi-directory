...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.MinimalRepository();
  });
  ...
  describe('MinimalRepository', function() {
    it('should create an instance of MinimalRepository', function() {
      // uncomment below and update the code to test MinimalRepository
      //var instance = new GitHubV3RestApi.MinimalRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.MinimalRepository);
    });
