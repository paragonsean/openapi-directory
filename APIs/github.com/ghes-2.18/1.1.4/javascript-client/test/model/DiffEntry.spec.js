...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.DiffEntry();
  });
  ...
  describe('DiffEntry', function() {
    it('should create an instance of DiffEntry', function() {
      // uncomment below and update the code to test DiffEntry
      //var instance = new GitHubV3RestApi.DiffEntry();
      //expect(instance).to.be.a(GitHubV3RestApi.DiffEntry);
    });
