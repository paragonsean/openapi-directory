...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposMergeRequest();
  });
  ...
  describe('ReposMergeRequest', function() {
    it('should create an instance of ReposMergeRequest', function() {
      // uncomment below and update the code to test ReposMergeRequest
      //var instance = new GitHubV3RestApi.ReposMergeRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposMergeRequest);
    });
