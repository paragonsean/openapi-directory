...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GitRef();
  });
  ...
  describe('GitRef', function() {
    it('should create an instance of GitRef', function() {
      // uncomment below and update the code to test GitRef
      //var instance = new GitHubV3RestApi.GitRef();
      //expect(instance).to.be.a(GitHubV3RestApi.GitRef);
    });
