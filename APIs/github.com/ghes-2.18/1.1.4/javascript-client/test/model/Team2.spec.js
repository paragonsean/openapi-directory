...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.Team2();
  });
  ...
  describe('Team2', function() {
    it('should create an instance of Team2', function() {
      // uncomment below and update the code to test Team2
      //var instance = new GitHubV3RestApi.Team2();
      //expect(instance).to.be.a(GitHubV3RestApi.Team2);
    });
