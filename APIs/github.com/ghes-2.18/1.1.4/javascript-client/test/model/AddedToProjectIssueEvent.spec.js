...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.AddedToProjectIssueEvent();
  });
  ...
  describe('AddedToProjectIssueEvent', function() {
    it('should create an instance of AddedToProjectIssueEvent', function() {
      // uncomment below and update the code to test AddedToProjectIssueEvent
      //var instance = new GitHubV3RestApi.AddedToProjectIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.AddedToProjectIssueEvent);
    });
