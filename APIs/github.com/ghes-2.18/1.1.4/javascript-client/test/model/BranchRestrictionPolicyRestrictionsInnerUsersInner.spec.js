...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyRestrictionsInnerUsersInner();
  });
  ...
  describe('BranchRestrictionPolicyRestrictionsInnerUsersInner', function() {
    it('should create an instance of BranchRestrictionPolicyRestrictionsInnerUsersInner', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyRestrictionsInnerUsersInner
      //var instance = new GitHubV3RestApi.BranchRestrictionPolicyRestrictionsInnerUsersInner();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyRestrictionsInnerUsersInner);
    });
