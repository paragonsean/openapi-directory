...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PrivateUser();
  });
  ...
  describe('PrivateUser', function() {
    it('should create an instance of PrivateUser', function() {
      // uncomment below and update the code to test PrivateUser
      //var instance = new GitHubV3RestApi.PrivateUser();
      //expect(instance).to.be.a(GitHubV3RestApi.PrivateUser);
    });
