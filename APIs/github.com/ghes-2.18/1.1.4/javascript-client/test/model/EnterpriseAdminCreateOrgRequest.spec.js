...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.EnterpriseAdminCreateOrgRequest();
  });
  ...
  describe('EnterpriseAdminCreateOrgRequest', function() {
    it('should create an instance of EnterpriseAdminCreateOrgRequest', function() {
      // uncomment below and update the code to test EnterpriseAdminCreateOrgRequest
      //var instance = new GitHubV3RestApi.EnterpriseAdminCreateOrgRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.EnterpriseAdminCreateOrgRequest);
    });
