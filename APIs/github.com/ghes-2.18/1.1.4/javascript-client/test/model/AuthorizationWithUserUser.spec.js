...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.AuthorizationWithUserUser();
  });
  ...
  describe('AuthorizationWithUserUser', function() {
    it('should create an instance of AuthorizationWithUserUser', function() {
      // uncomment below and update the code to test AuthorizationWithUserUser
      //var instance = new GitHubV3RestApi.AuthorizationWithUserUser();
      //expect(instance).to.be.a(GitHubV3RestApi.AuthorizationWithUserUser);
    });
