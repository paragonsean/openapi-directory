...
class RemovedFromProjectIssueEvent {
    ...
    constructor(actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url) { 
        ...
        RemovedFromProjectIssueEvent.initialize(this, actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url);
    }
...
RemovedFromProjectIssueEvent.RequiredProperties = ["actor", "commit_id", "commit_url", "created_at", "event", "id", "node_id", "performed_via_github_app", "url"];
