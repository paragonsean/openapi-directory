...
class EnterpriseSettingsEnterprise {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pages')) {
                obj['pages'] = BranchProtectionRequiredConversationResolution.constructFromObject(data['pages']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['pages']) { // data not null
          BranchProtectionRequiredConversationResolution.validateJSON(data['pages']);
        }
...
/**
 * @member {module:model/BranchProtectionRequiredConversationResolution} pages
 */
