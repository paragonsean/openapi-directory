...
/**
 * The AuthorizationWithUserUser model module.
 * @module model/AuthorizationWithUserUser
 * @version 1.1.4
 */
class AuthorizationWithUserUser {
    /**
     * Constructs a new <code>AuthorizationWithUserUser</code>.
     * @alias module:model/AuthorizationWithUserUser
     */
    constructor() { 
        
        AuthorizationWithUserUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AuthorizationWithUserUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AuthorizationWithUserUser} obj Optional instance to populate.
     * @return {module:model/AuthorizationWithUserUser} The populated <code>AuthorizationWithUserUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AuthorizationWithUserUser();
    ...
    /**
     * Validates the JSON data with respect to <code>AuthorizationWithUserUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AuthorizationWithUserUser</code>.
     */
 ...
 */
AuthorizationWithUserUser.prototype['avatar_url'] = undefined;

/**
 * @member {String} events_url
 */
AuthorizationWithUserUser.prototype['events_url'] = undefined;

/**
 * @member {String} followers_url
 */
AuthorizationWithUserUser.prototype['followers_url'] = undefined;

/**
 * @member {String} following_url
 */
AuthorizationWithUserUser.prototype['following_url'] = undefined;

/**
 * @member {String} gists_url
 */
AuthorizationWithUserUser.prototype['gists_url'] = undefined;

/**
 * @member {String} gravatar_id
 */
AuthorizationWithUserUser.prototype['gravatar_id'] = undefined;

/**
 * @member {String} html_url
 */
AuthorizationWithUserUser.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
AuthorizationWithUserUser.prototype['id'] = undefined;

/**
 * @member {String} login
 */
AuthorizationWithUserUser.prototype['login'] = undefined;

/**
 * @member {String} node_id
 */
AuthorizationWithUserUser.prototype['node_id'] = undefined;

/**
 * @member {String} organizations_url
 */
AuthorizationWithUserUser.prototype['organizations_url'] = undefined;

/**
 * @member {String} received_events_url
 */
AuthorizationWithUserUser.prototype['received_events_url'] = undefined;

/**
 * @member {String} repos_url
 */
AuthorizationWithUserUser.prototype['repos_url'] = undefined;

/**
 * @member {Boolean} site_admin
 */
AuthorizationWithUserUser.prototype['site_admin'] = undefined;

/**
 * @member {String} starred_url
 */
AuthorizationWithUserUser.prototype['starred_url'] = undefined;

/**
 * @member {String} subscriptions_url
 */
AuthorizationWithUserUser.prototype['subscriptions_url'] = undefined;

/**
 * @member {String} type
 */
AuthorizationWithUserUser.prototype['type'] = undefined;

/**
 * @member {String} url
 */
AuthorizationWithUserUser.prototype['url'] = undefined;
...
export default AuthorizationWithUserUser;
