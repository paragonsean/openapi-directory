...
export default class PullsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the pullsCreateReviewCommentAlternative operation.
     * @callback module:api/PullsApi~pullsCreateReviewCommentAlternativeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LegacyReviewComment} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo 
     * @param {Number} pullNumber 
     * @param {module:model/PullsCreateReviewCommentAlternativeRequest} pullsCreateReviewCommentAlternativeRequest 
     * @param {module:api/PullsApi~pullsCreateReviewCommentAlternativeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LegacyReviewComment}
     */
    pullsCreateReviewCommentAlternative(owner, repo, pullNumber, pullsCreateReviewCommentAlternativeRequest, callback) {
      let postBody = pullsCreateReviewCommentAlternativeRequest;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling pullsCreateReviewCommentAlternative");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling pullsCreateReviewCommentAlternative");
      }
      // verify the required parameter 'pullNumber' is set
      if (pullNumber === undefined || pullNumber === null) {
        throw new Error("Missing the required parameter 'pullNumber' when calling pullsCreateReviewCommentAlternative");
      }
      // verify the required parameter 'pullsCreateReviewCommentAlternativeRequest' is set
      if (pullsCreateReviewCommentAlternativeRequest === undefined || pullsCreateReviewCommentAlternativeRequest === null) {
        throw new Error("Missing the required parameter 'pullsCreateReviewCommentAlternativeRequest' when calling pullsCreateReviewCommentAlternative");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = LegacyReviewComment;
      return this.apiClient.callApi(
     ...
     * @param {module:model/String} [sort = 'created')] What to sort results by. Can be either `created`, `updated`, `popularity` (comment count) or `long-running` (age, filtering by pulls updated in the last month).
     * @param {module:model/String} [direction] The direction of the sort. Can be either `asc` or `desc`. Default: `desc` when sort is `created` or sort is not specified, otherwise `asc`.
     ...
     * @param {module:model/String} [direction] Can be either `asc` or `desc`. Ignored without `sort` parameter.
