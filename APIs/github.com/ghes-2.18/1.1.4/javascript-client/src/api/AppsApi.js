...
export default class AppsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/AppsListInstallationsForAuthenticatedUser200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/AppsListInstallationsForAuthenticatedUser200Response}
     */
    appsListInstallationsForAuthenticatedUser(accept, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = AppsListInstallationsForAuthenticatedUser200Response;
      return this.apiClient.callApi(
