...
GitHub v3 REST API
- API version: 1.1.4
  - Build date: 2024-10-12T10:07:06.767787-04:00[America/New_York]
...
*GitApi* | [**gitGetAllRefs**](docs/GitApi.md#gitGetAllRefs) | **GET** /repos/{owner}/{repo}/git/refs/{namespace} | Get all references
...
*OauthAuthorizationsApi* | [**oauthAuthorizationsCheckAuthorization**](docs/OauthAuthorizationsApi.md#oauthAuthorizationsCheckAuthorization) | **GET** /applications/{client_id}/tokens/{access_token} | Check an authorization
...
*OauthAuthorizationsApi* | [**oauthAuthorizationsResetAuthorization**](docs/OauthAuthorizationsApi.md#oauthAuthorizationsResetAuthorization) | **POST** /applications/{client_id}/tokens/{access_token} | Reset an authorization
*OauthAuthorizationsApi* | [**oauthAuthorizationsRevokeAuthorizationForApplication**](docs/OauthAuthorizationsApi.md#oauthAuthorizationsRevokeAuthorizationForApplication) | **DELETE** /applications/{client_id}/tokens/{access_token} | Revoke an authorization for an application
*OauthAuthorizationsApi* | [**oauthAuthorizationsRevokeGrantForApplication**](docs/OauthAuthorizationsApi.md#oauthAuthorizationsRevokeGrantForApplication) | **DELETE** /applications/{client_id}/grants/{access_token} | Revoke a grant for an application
...
*PullsApi* | [**pullsCreateReviewCommentAlternative**](docs/PullsApi.md#pullsCreateReviewCommentAlternative) | **POST** /repos/{owner}/{repo}/pulls/{pull_number}/comments | Create a review comment for a pull request (alternative)
...
*ReactionsApi* | [**reactionsCreateForTeamDiscussion**](docs/ReactionsApi.md#reactionsCreateForTeamDiscussion) | **POST** /teams/{team_id}/discussions/{discussion_number}/reactions | Create reaction for a team discussion
*ReactionsApi* | [**reactionsCreateForTeamDiscussionComment**](docs/ReactionsApi.md#reactionsCreateForTeamDiscussionComment) | **POST** /teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions | Create reaction for a team discussion comment
*ReactionsApi* | [**reactionsDelete**](docs/ReactionsApi.md#reactionsDelete) | **DELETE** /reactions/{reaction_id} | Delete a reaction
...
*ReactionsApi* | [**reactionsListForTeamDiscussion**](docs/ReactionsApi.md#reactionsListForTeamDiscussion) | **GET** /teams/{team_id}/discussions/{discussion_number}/reactions | List reactions for a team discussion
*ReactionsApi* | [**reactionsListForTeamDiscussionComment**](docs/ReactionsApi.md#reactionsListForTeamDiscussionComment) | **GET** /teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions | List reactions for a team discussion comment
...
*TeamsApi* | [**teamsAddOrUpdateMembershipForUser**](docs/TeamsApi.md#teamsAddOrUpdateMembershipForUser) | **PUT** /teams/{team_id}/memberships/{username} | Add or update team membership for a user
*TeamsApi* | [**teamsAddOrUpdateProjectPermissions**](docs/TeamsApi.md#teamsAddOrUpdateProjectPermissions) | **PUT** /teams/{team_id}/projects/{project_id} | Add or update team project permissions
*TeamsApi* | [**teamsAddOrUpdateRepoPermissions**](docs/TeamsApi.md#teamsAddOrUpdateRepoPermissions) | **PUT** /teams/{team_id}/repos/{owner}/{repo} | Add or update team repository permissions
*TeamsApi* | [**teamsCheckPermissionsForProject**](docs/TeamsApi.md#teamsCheckPermissionsForProject) | **GET** /teams/{team_id}/projects/{project_id} | Check team permissions for a project
*TeamsApi* | [**teamsCheckPermissionsForRepo**](docs/TeamsApi.md#teamsCheckPermissionsForRepo) | **GET** /teams/{team_id}/repos/{owner}/{repo} | Check team permissions for a repository
*TeamsApi* | [**teamsCreate**](docs/TeamsApi.md#teamsCreate) | **POST** /orgs/{org}/teams | Create a team
*TeamsApi* | [**teamsCreateDiscussion**](docs/TeamsApi.md#teamsCreateDiscussion) | **POST** /teams/{team_id}/discussions | Create a discussion
*TeamsApi* | [**teamsCreateDiscussionComment**](docs/TeamsApi.md#teamsCreateDiscussionComment) | **POST** /teams/{team_id}/discussions/{discussion_number}/comments | Create a discussion comment
*TeamsApi* | [**teamsDelete**](docs/TeamsApi.md#teamsDelete) | **DELETE** /teams/{team_id} | Delete a team
*TeamsApi* | [**teamsDeleteDiscussion**](docs/TeamsApi.md#teamsDeleteDiscussion) | **DELETE** /teams/{team_id}/discussions/{discussion_number} | Delete a discussion
*TeamsApi* | [**teamsDeleteDiscussionComment**](docs/TeamsApi.md#teamsDeleteDiscussionComment) | **DELETE** /teams/{team_id}/discussions/{discussion_number}/comments/{comment_number} | Delete a discussion comment
*TeamsApi* | [**teamsGet**](docs/TeamsApi.md#teamsGet) | **GET** /teams/{team_id} | Get a team
*TeamsApi* | [**teamsGetByName**](docs/TeamsApi.md#teamsGetByName) | **GET** /orgs/{org}/teams/{team_slug} | Get a team by name
*TeamsApi* | [**teamsGetDiscussion**](docs/TeamsApi.md#teamsGetDiscussion) | **GET** /teams/{team_id}/discussions/{discussion_number} | Get a discussion
*TeamsApi* | [**teamsGetDiscussionComment**](docs/TeamsApi.md#teamsGetDiscussionComment) | **GET** /teams/{team_id}/discussions/{discussion_number}/comments/{comment_number} | Get a discussion comment
...
*TeamsApi* | [**teamsGetMembershipForUser**](docs/TeamsApi.md#teamsGetMembershipForUser) | **GET** /teams/{team_id}/memberships/{username} | Get team membership for a user
*TeamsApi* | [**teamsList**](docs/TeamsApi.md#teamsList) | **GET** /orgs/{org}/teams | List teams
*TeamsApi* | [**teamsListChild**](docs/TeamsApi.md#teamsListChild) | **GET** /teams/{team_id}/teams | List child teams
*TeamsApi* | [**teamsListDiscussionComments**](docs/TeamsApi.md#teamsListDiscussionComments) | **GET** /teams/{team_id}/discussions/{discussion_number}/comments | List discussion comments
*TeamsApi* | [**teamsListDiscussions**](docs/TeamsApi.md#teamsListDiscussions) | **GET** /teams/{team_id}/discussions | List discussions
...
*TeamsApi* | [**teamsListMembers**](docs/TeamsApi.md#teamsListMembers) | **GET** /teams/{team_id}/members | List team members
*TeamsApi* | [**teamsListProjects**](docs/TeamsApi.md#teamsListProjects) | **GET** /teams/{team_id}/projects | List team projects
*TeamsApi* | [**teamsListRepos**](docs/TeamsApi.md#teamsListRepos) | **GET** /teams/{team_id}/repos | List team repositories
...
*TeamsApi* | [**teamsRemoveMembershipForUser**](docs/TeamsApi.md#teamsRemoveMembershipForUser) | **DELETE** /teams/{team_id}/memberships/{username} | Remove team membership for a user
*TeamsApi* | [**teamsRemoveProject**](docs/TeamsApi.md#teamsRemoveProject) | **DELETE** /teams/{team_id}/projects/{project_id} | Remove a project from a team
*TeamsApi* | [**teamsRemoveRepo**](docs/TeamsApi.md#teamsRemoveRepo) | **DELETE** /teams/{team_id}/repos/{owner}/{repo} | Remove a repository from a team
*TeamsApi* | [**teamsUpdate**](docs/TeamsApi.md#teamsUpdate) | **PATCH** /teams/{team_id} | Update a team
*TeamsApi* | [**teamsUpdateDiscussion**](docs/TeamsApi.md#teamsUpdateDiscussion) | **PATCH** /teams/{team_id}/discussions/{discussion_number} | Update a discussion
*TeamsApi* | [**teamsUpdateDiscussionComment**](docs/TeamsApi.md#teamsUpdateDiscussionComment) | **PATCH** /teams/{team_id}/discussions/{discussion_number}/comments/{comment_number} | Update a discussion comment
...
## Documentation for Models
 ...
 - [AppsListInstallationsForAuthenticatedUser200Response](docs/AppsListInstallationsForAuthenticatedUser200Response.md)
 ...
 - [AuthorizationWithUser](docs/AuthorizationWithUser.md)
 - [AuthorizationWithUserApp](docs/AuthorizationWithUserApp.md)
 - [AuthorizationWithUserUser](docs/AuthorizationWithUserUser.md)
 ...
 - [BranchProtectionRequiredConversationResolution](docs/BranchProtectionRequiredConversationResolution.md)
 ...
 - [BranchRestrictionPolicyRestrictionsInner](docs/BranchRestrictionPolicyRestrictionsInner.md)
 - [BranchRestrictionPolicyRestrictionsInnerTeamsInner](docs/BranchRestrictionPolicyRestrictionsInnerTeamsInner.md)
 - [BranchRestrictionPolicyRestrictionsInnerUsersInner](docs/BranchRestrictionPolicyRestrictionsInnerUsersInner.md)
 ...
 - [LegacyReviewComment](docs/LegacyReviewComment.md)
 - [LegacyReviewCommentLinks](docs/LegacyReviewCommentLinks.md)
 - [LegacyReviewCommentLinksHtml](docs/LegacyReviewCommentLinksHtml.md)
 ...
 - [PullsCreateReviewCommentAlternativeRequest](docs/PullsCreateReviewCommentAlternativeRequest.md)
 ...
 - [ReactionsCreateForTeamDiscussionCommentRequest](docs/ReactionsCreateForTeamDiscussionCommentRequest.md)
 - [ReactionsCreateForTeamDiscussionRequest](docs/ReactionsCreateForTeamDiscussionRequest.md)
 ...
 - [Team](docs/Team.md)
 - [Team2](docs/Team2.md)
 - [Team2Parent](docs/Team2Parent.md)
 ...
 - [TeamsAddOrUpdateMembershipForUserRequest](docs/TeamsAddOrUpdateMembershipForUserRequest.md)
 - [TeamsAddOrUpdateProjectPermissionsRequest](docs/TeamsAddOrUpdateProjectPermissionsRequest.md)
 - [TeamsAddOrUpdateRepoPermissionsRequest](docs/TeamsAddOrUpdateRepoPermissionsRequest.md)
 - [TeamsCreateDiscussionCommentRequest](docs/TeamsCreateDiscussionCommentRequest.md)
 - [TeamsCreateDiscussionRequest](docs/TeamsCreateDiscussionRequest.md)
 - [TeamsCreateRequest](docs/TeamsCreateRequest.md)
 - [TeamsUpdateDiscussionRequest](docs/TeamsUpdateDiscussionRequest.md)
