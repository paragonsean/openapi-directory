...
public class AuthorizationWithUserUser {
  ...
  public AuthorizationWithUserUser avatarUrl(String avatarUrl) {
  ...
  public AuthorizationWithUserUser eventsUrl(String eventsUrl) {
  ...
  public AuthorizationWithUserUser followersUrl(String followersUrl) {
  ...
  public AuthorizationWithUserUser followingUrl(String followingUrl) {
  ...
  public AuthorizationWithUserUser gistsUrl(String gistsUrl) {
  ...
  public AuthorizationWithUserUser gravatarId(String gravatarId) {
  ...
  public AuthorizationWithUserUser htmlUrl(String htmlUrl) {
  ...
  public AuthorizationWithUserUser id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public AuthorizationWithUserUser login(String login) {
    this.login = login;
    return this;
  }
  ...
  public AuthorizationWithUserUser nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public AuthorizationWithUserUser organizationsUrl(String organizationsUrl) {
  ...
  public AuthorizationWithUserUser receivedEventsUrl(String receivedEventsUrl) {
  ...
  public AuthorizationWithUserUser reposUrl(String reposUrl) {
  ...
  public AuthorizationWithUserUser siteAdmin(Boolean siteAdmin) {
  ...
  public AuthorizationWithUserUser starredUrl(String starredUrl) {
  ...
  public AuthorizationWithUserUser subscriptionsUrl(String subscriptionsUrl) {
  ...
  public AuthorizationWithUserUser type(String type) {
    this.type = type;
    return this;
  }
  ...
  public AuthorizationWithUserUser url(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AuthorizationWithUserUser authorizationWithUserUser = (AuthorizationWithUserUser) o;
    return Objects.equals(this.avatarUrl, authorizationWithUserUser.avatarUrl) &&
        Objects.equals(this.eventsUrl, authorizationWithUserUser.eventsUrl) &&
        Objects.equals(this.followersUrl, authorizationWithUserUser.followersUrl) &&
        Objects.equals(this.followingUrl, authorizationWithUserUser.followingUrl) &&
        Objects.equals(this.gistsUrl, authorizationWithUserUser.gistsUrl) &&
        Objects.equals(this.gravatarId, authorizationWithUserUser.gravatarId) &&
        Objects.equals(this.htmlUrl, authorizationWithUserUser.htmlUrl) &&
        Objects.equals(this.id, authorizationWithUserUser.id) &&
        Objects.equals(this.login, authorizationWithUserUser.login) &&
        Objects.equals(this.nodeId, authorizationWithUserUser.nodeId) &&
        Objects.equals(this.organizationsUrl, authorizationWithUserUser.organizationsUrl) &&
        Objects.equals(this.receivedEventsUrl, authorizationWithUserUser.receivedEventsUrl) &&
        Objects.equals(this.reposUrl, authorizationWithUserUser.reposUrl) &&
        Objects.equals(this.siteAdmin, authorizationWithUserUser.siteAdmin) &&
        Objects.equals(this.starredUrl, authorizationWithUserUser.starredUrl) &&
        Objects.equals(this.subscriptionsUrl, authorizationWithUserUser.subscriptionsUrl) &&
        Objects.equals(this.type, authorizationWithUserUser.type) &&
        Objects.equals(this.url, authorizationWithUserUser.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthorizationWithUserUser {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthorizationWithUserUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorizationWithUserUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizationWithUserUser is not found in the empty JSON string", AuthorizationWithUserUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthorizationWithUserUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthorizationWithUserUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizationWithUserUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizationWithUserUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizationWithUserUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizationWithUserUser.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizationWithUserUser>() {
           @Override
           public void write(JsonWriter out, AuthorizationWithUserUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthorizationWithUserUser read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthorizationWithUserUser given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthorizationWithUserUser
   * @throws IOException if the JSON string is invalid with respect to AuthorizationWithUserUser
   */
  public static AuthorizationWithUserUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizationWithUserUser.class);
  }

  /**
   * Convert an instance of AuthorizationWithUserUser to an JSON string
   *
   * @return JSON string
   */
