...
public class ThreadSubject {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.latestCommentUrl, threadSubject.latestCommentUrl) &&
        Objects.equals(this.title, threadSubject.title) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(latestCommentUrl, title, type, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ThreadSubject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThreadSubject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThreadSubject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ThreadSubject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
