...
public class EnterpriseSettingsEnterprise {
  ...
  private BranchProtectionRequiredConversationResolution pages;
  ...
  public EnterpriseSettingsEnterprise pages(BranchProtectionRequiredConversationResolution pages) {
    this.pages = pages;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public BranchProtectionRequiredConversationResolution getPages() {
    return pages;
  }

  public void setPages(BranchProtectionRequiredConversationResolution pages) {
    this.pages = pages;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("pages") != null && !jsonObj.get("pages").isJsonNull()) {
        BranchProtectionRequiredConversationResolution.validateJsonElement(jsonObj.get("pages"));
      }
