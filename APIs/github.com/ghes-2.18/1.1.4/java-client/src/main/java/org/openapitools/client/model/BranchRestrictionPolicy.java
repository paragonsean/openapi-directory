...
import org.openapitools.client.model.BranchRestrictionPolicyRestrictionsInner;
...
public class BranchRestrictionPolicy {
  ...
  private List<BranchRestrictionPolicyRestrictionsInner> restrictions = new ArrayList<>();
  ...
  private List<AuthorizationWithUserUser> users = new ArrayList<>();
  ...
  public BranchRestrictionPolicy restrictions(List<BranchRestrictionPolicyRestrictionsInner> restrictions) {
    this.restrictions = restrictions;
    return this;
  }

  public BranchRestrictionPolicy addRestrictionsItem(BranchRestrictionPolicyRestrictionsInner restrictionsItem) {
  ...
  public List<BranchRestrictionPolicyRestrictionsInner> getRestrictions() {
    return restrictions;
  }

  public void setRestrictions(List<BranchRestrictionPolicyRestrictionsInner> restrictions) {
    this.restrictions = restrictions;
  }
  ...
  public BranchRestrictionPolicy users(List<AuthorizationWithUserUser> users) {
    this.users = users;
    return this;
  }

  public BranchRestrictionPolicy addUsersItem(AuthorizationWithUserUser usersItem) {
    if (this.users == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<AuthorizationWithUserUser> getUsers() {
    return users;
  }

  public void setUsers(List<AuthorizationWithUserUser> users) {
    this.users = users;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apps, branchRestrictionPolicy.apps) &&
        ...
        Objects.equals(this.restrictions, branchRestrictionPolicy.restrictions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apps, appsUrl, restrictions, teams, teamsUrl, url, users, usersUrl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("restrictions") != null && !jsonObj.get("restrictions").isJsonNull()) {
        ...
        if (jsonArrayrestrictions != null) {
          ...
          for (int i = 0; i < jsonArrayrestrictions.size(); i++) {
            BranchRestrictionPolicyRestrictionsInner.validateJsonElement(jsonArrayrestrictions.get(i));
          };
        }
      }
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayusers.size(); i++) {
        AuthorizationWithUserUser.validateJsonElement(jsonArrayusers.get(i));
      };
