...
public class Integration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientId, clientSecret, createdAt, description, events, externalUrl, htmlUrl, id, installationsCount, name, nodeId, owner, pem, permissions, updatedAt, webhookSecret);
  }
