...
public class OrganizationFull {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(avatarUrl, billingEmail, blog, collaborators, company, createdAt, defaultRepositoryPermission, description, diskUsage, email, eventsUrl, followers, following, hasOrganizationProjects, hasRepositoryProjects, hooksUrl, htmlUrl, id, issuesUrl, location, login, membersAllowedRepositoryCreationType, membersCanCreatePages, membersCanCreatePrivatePages, membersCanCreatePublicPages, membersCanCreateRepositories, membersUrl, name, nodeId, ownedPrivateRepos, plan, privateGists, publicGists, publicMembersUrl, publicRepos, reposUrl, totalPrivateRepos, twoFactorRequirementEnabled, type, updatedAt, url);
  }
