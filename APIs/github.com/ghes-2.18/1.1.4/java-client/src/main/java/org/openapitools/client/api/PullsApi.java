...
import org.openapitools.client.model.LegacyReviewComment;
...
import org.openapitools.client.model.PullsCreateReviewCommentAlternativeRequest;
...
public class PullsApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#check-if-a-pull-request-has-been-merged">Check if a pull request has been merged Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-pull-request">Create a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-reply-for-a-review-comment">Create a reply for a review comment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-review-for-a-pull-request">Create a review for a pull request Documentation</a>
     */
    ...
    /**
     * Build call for pullsCreateReviewCommentAlternative
     * @param owner  (required)
     * @param repo  (required)
     * @param pullNumber  (required)
     * @param pullsCreateReviewCommentAlternativeRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-review-comment-for-a-pull-request">Create a review comment for a pull request (alternative) Documentation</a>
     */
    public okhttp3.Call pullsCreateReviewCommentAlternativeCall(String owner, String repo, Integer pullNumber, PullsCreateReviewCommentAlternativeRequest pullsCreateReviewCommentAlternativeRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = pullsCreateReviewCommentAlternativeRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pullsCreateReviewCommentAlternativeValidateBeforeCall(String owner, String repo, Integer pullNumber, PullsCreateReviewCommentAlternativeRequest pullsCreateReviewCommentAlternativeRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling pullsCreateReviewCommentAlternative(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling pullsCreateReviewCommentAlternative(Async)");
        }

        // verify the required parameter 'pullNumber' is set
        if (pullNumber == null) {
            throw new ApiException("Missing the required parameter 'pullNumber' when calling pullsCreateReviewCommentAlternative(Async)");
        }

        // verify the required parameter 'pullsCreateReviewCommentAlternativeRequest' is set
        if (pullsCreateReviewCommentAlternativeRequest == null) {
            throw new ApiException("Missing the required parameter 'pullsCreateReviewCommentAlternativeRequest' when calling pullsCreateReviewCommentAlternative(Async)");
        }

        return pullsCreateReviewCommentAlternativeCall(owner, repo, pullNumber, pullsCreateReviewCommentAlternativeRequest, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-review-comment-for-a-pull-request">Create a review comment for a pull request (alternative) Documentation</a>
     */
    public LegacyReviewComment pullsCreateReviewCommentAlternative(String owner, String repo, Integer pullNumber, PullsCreateReviewCommentAlternativeRequest pullsCreateReviewCommentAlternativeRequest) throws ApiException {
        ApiResponse<LegacyReviewComment> localVarResp = pullsCreateReviewCommentAlternativeWithHttpInfo(owner, repo, pullNumber, pullsCreateReviewCommentAlternativeRequest);
        return localVarResp.getData();
    }
     ...
     * @param pullNumber  (required)
     * @param pullsCreateReviewCommentAlternativeRequest  (required)
     * @return ApiResponse&lt;LegacyReviewComment&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-review-comment-for-a-pull-request">Create a review comment for a pull request (alternative) Documentation</a>
     */
    public ApiResponse<LegacyReviewComment> pullsCreateReviewCommentAlternativeWithHttpInfo(String owner, String repo, Integer pullNumber, PullsCreateReviewCommentAlternativeRequest pullsCreateReviewCommentAlternativeRequest) throws ApiException {
        okhttp3.Call localVarCall = pullsCreateReviewCommentAlternativeValidateBeforeCall(owner, repo, pullNumber, pullsCreateReviewCommentAlternativeRequest, null);
        Type localVarReturnType = new TypeToken<LegacyReviewComment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a review comment for a pull request (alternative) (asynchronously)
     * Creates a review comment in the pull request diff. To add a regular comment to a pull request timeline, see \&quot;[Create an issue comment](https://docs.github.com/enterprise-server@2.18/rest/reference/issues#create-an-issue-comment).\&quot;  **Note:** The position value equals the number of lines down from the first \&quot;@@\&quot; hunk header in the file you want to add a comment. The line just below the \&quot;@@\&quot; line is position 1, the next line is position 2, and so on. The position in the diff continues to increase through lines of whitespace and additional hunks until the beginning of a new file.  This endpoint triggers [notifications](https://docs.github.com/en/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \&quot;[Secondary rate limits](https://docs.github.com/enterprise-server@2.18/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\&quot; for details.
     * @param owner  (required)
     * @param repo  (required)
     * @param pullNumber  (required)
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#create-a-review-comment-for-a-pull-request">Create a review comment for a pull request (alternative) Documentation</a>
     */
    public okhttp3.Call pullsCreateReviewCommentAlternativeAsync(String owner, String repo, Integer pullNumber, PullsCreateReviewCommentAlternativeRequest pullsCreateReviewCommentAlternativeRequest, final ApiCallback<LegacyReviewComment> _callback) throws ApiException {

        okhttp3.Call localVarCall = pullsCreateReviewCommentAlternativeValidateBeforeCall(owner, repo, pullNumber, pullsCreateReviewCommentAlternativeRequest, _callback);
        Type localVarReturnType = new TypeToken<LegacyReviewComment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#delete-a-pending-review-for-a-pull-request">Delete a pending review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#delete-a-review-comment-for-a-pull-request">Delete a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#dismiss-a-review-for-a-pull-request">Dismiss a review for a pull request Documentation</a>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Pass the appropriate [media type](https://docs.github.com/enterprise-server@2.18/rest/overview/media-types/#commits-commit-comparison-and-pull-requests) to fetch diff and patch formats. </td><td>  -  </td></tr>
        <tr><td> 304 </td><td> Not modified </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resource not found </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal Error </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#get-a-pull-request">Get a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#get-a-review-for-a-pull-request">Get a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#get-a-review-comment-for-a-pull-request">Get a review comment for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-pull-requests">List pull requests Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-comments-for-a-pull-request-review">List comments for a pull request review Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-commits-on-a-pull-request">List commits on a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-pull-requests-files">List pull requests files Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-requested-reviewers-for-a-pull-request">List requested reviewers for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-review-comments-on-a-pull-request">List review comments on a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-review-comments-in-a-repository">List review comments in a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#list-reviews-for-a-pull-request">List reviews for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#merge-a-pull-request">Merge a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#remove-requested-reviewers-from-a-pull-request">Remove requested reviewers from a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#request-reviewers-for-a-pull-request">Request reviewers for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#submit-a-review-for-a-pull-request">Submit a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls/#update-a-pull-request">Update a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#update-a-pull-request-branch">Update a pull request branch Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#update-a-review-for-a-pull-request">Update a review for a pull request Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#update-a-review-comment-for-a-pull-request">Update a review comment for a pull request Documentation</a>
     */
