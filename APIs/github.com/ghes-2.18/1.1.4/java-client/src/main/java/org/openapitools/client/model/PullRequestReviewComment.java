...
public class PullRequestReviewComment {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, authorAssociation, body, bodyHtml, bodyText, commitId, createdAt, diffHunk, htmlUrl, id, inReplyToId, nodeId, originalCommitId, originalPosition, path, position, pullRequestReviewId, pullRequestUrl, reactions, updatedAt, url, user);
  }
