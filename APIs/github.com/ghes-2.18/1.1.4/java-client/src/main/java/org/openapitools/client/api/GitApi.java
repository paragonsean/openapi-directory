...
public class GitApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#create-a-blob">Create a blob Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#create-a-commit">Create a commit Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#create-a-reference">Create a reference Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#create-a-tag-object">Create a tag object Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#create-a-tree">Create a tree Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#delete-a-reference">Delete a reference Documentation</a>
     */
    ...
    /**
     * Build call for gitGetAllRefs
     * @param owner  (required)
     * @param repo  (required)
     * @param namespace Automatically added (required)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/enterprise/2.18/rest/reference/git#get-a-reference">Get all references Documentation</a>
     */
    public okhttp3.Call gitGetAllRefsCall(String owner, String repo, String namespace, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repos/{owner}/{repo}/git/refs/{namespace}"
            .replace("{" + "owner" + "}", localVarApiClient.escapeString(owner.toString()))
            .replace("{" + "repo" + "}", localVarApiClient.escapeString(repo.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call gitGetAllRefsValidateBeforeCall(String owner, String repo, String namespace, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
            throw new ApiException("Missing the required parameter 'owner' when calling gitGetAllRefs(Async)");
        }

        // verify the required parameter 'repo' is set
        if (repo == null) {
            throw new ApiException("Missing the required parameter 'repo' when calling gitGetAllRefs(Async)");
        }

        // verify the required parameter 'namespace' is set
        if (namespace == null) {
            throw new ApiException("Missing the required parameter 'namespace' when calling gitGetAllRefs(Async)");
        }

        return gitGetAllRefsCall(owner, repo, namespace, perPage, page, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/enterprise/2.18/rest/reference/git#get-a-reference">Get all references Documentation</a>
     */
    public List<GitRef> gitGetAllRefs(String owner, String repo, String namespace, Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<GitRef>> localVarResp = gitGetAllRefsWithHttpInfo(owner, repo, namespace, perPage, page);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/enterprise/2.18/rest/reference/git#get-a-reference">Get all references Documentation</a>
     */
    public ApiResponse<List<GitRef>> gitGetAllRefsWithHttpInfo(String owner, String repo, String namespace, Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = gitGetAllRefsValidateBeforeCall(owner, repo, namespace, perPage, page, null);
        Type localVarReturnType = new TypeToken<List<GitRef>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all references (asynchronously)
     * Returns an array of all the references from your Git database, including notes and stashes if they exist on the server. Anything in the namespace is returned, not just &#x60;heads&#x60; and &#x60;tags&#x60;. If there are no references to list, a &#x60;404&#x60; is returned.  **Note:** You need to explicitly [request a pull request](https://docs.github.com/enterprise-server@2.18/rest/reference/pulls#get-a-single-pull-request) to trigger a merge commit creation. For more information, see \&quot;[Checking mergeability of pull requests](https://docs.github.com/enterprise-server@2.18/rest/guides/getting-started-with-the-git-database-api#checking-mergeability-of-pull-requests)\&quot;.  &#x60;&#x60;&#x60; GET /repos/octocat/Hello-World/git/refs &#x60;&#x60;&#x60;  You can also request a sub-namespace. For example, to get all the tag references, you can call:  &#x60;&#x60;&#x60; GET /repos/octocat/Hello-World/git/refs/tags &#x60;&#x60;&#x60;
     * @param owner  (required)
     * @param repo  (required)
     * @param namespace Automatically added (required)
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.18/enterprise/2.18/rest/reference/git#get-a-reference">Get all references Documentation</a>
     */
    public okhttp3.Call gitGetAllRefsAsync(String owner, String repo, String namespace, Integer perPage, Integer page, final ApiCallback<List<GitRef>> _callback) throws ApiException {

        okhttp3.Call localVarCall = gitGetAllRefsValidateBeforeCall(owner, repo, namespace, perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<GitRef>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#get-a-blob">Get a blob Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#get-a-commit">Get a commit Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#get-a-tag">Get a tag Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#get-a-tree">Get a tree Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.18/rest/reference/git#update-a-reference">Update a reference Documentation</a>
     */
