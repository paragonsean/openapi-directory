...
> AppsListInstallationsForAuthenticatedUser200Response appsListInstallationsForAuthenticatedUser(accept, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer page = 1; // Integer | Page number of the results to fetch.
    try {
      AppsListInstallationsForAuthenticatedUser200Response result = apiInstance.appsListInstallationsForAuthenticatedUser(accept, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
