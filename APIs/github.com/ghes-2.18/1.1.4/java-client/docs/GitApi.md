...
<a id="gitGetAllRefs"></a>
# **gitGetAllRefs**
> List&lt;GitRef&gt; gitGetAllRefs(owner, repo, namespace, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    String owner = "owner_example"; // String | 
    String repo = "repo_example"; // String | 
    String namespace = "namespace_example"; // String | Automatically added
    Integer perPage = 30; // Integer | Results per page (max 100)
    Integer page = 1; // Integer | Page number of the results to fetch.
    try {
      List<GitRef> result = apiInstance.gitGetAllRefs(owner, repo, namespace, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GitApi#gitGetAllRefs");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
