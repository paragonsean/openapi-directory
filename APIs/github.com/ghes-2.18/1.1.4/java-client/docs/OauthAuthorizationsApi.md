...
|------------- | ------------- | -------------|
| [**oauthAuthorizationsCheckAuthorization**](OauthAuthorizationsApi.md#oauthAuthorizationsCheckAuthorization) | **GET** /applications/{client_id}/tokens/{access_token} | Check an authorization |
...
| [**oauthAuthorizationsResetAuthorization**](OauthAuthorizationsApi.md#oauthAuthorizationsResetAuthorization) | **POST** /applications/{client_id}/tokens/{access_token} | Reset an authorization |
| [**oauthAuthorizationsRevokeAuthorizationForApplication**](OauthAuthorizationsApi.md#oauthAuthorizationsRevokeAuthorizationForApplication) | **DELETE** /applications/{client_id}/tokens/{access_token} | Revoke an authorization for an application |
| [**oauthAuthorizationsRevokeGrantForApplication**](OauthAuthorizationsApi.md#oauthAuthorizationsRevokeGrantForApplication) | **DELETE** /applications/{client_id}/grants/{access_token} | Revoke a grant for an application |
...
<a id="oauthAuthorizationsCheckAuthorization"></a>
# **oauthAuthorizationsCheckAuthorization**
> AuthorizationWithUser oauthAuthorizationsCheckAuthorization(clientId, accessToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      AuthorizationWithUser result = apiInstance.oauthAuthorizationsCheckAuthorization(clientId, accessToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OauthAuthorizationsApi#oauthAuthorizationsCheckAuthorization");
...
[**AuthorizationWithUser**](AuthorizationWithUser.md)
...
<a id="oauthAuthorizationsResetAuthorization"></a>
# **oauthAuthorizationsResetAuthorization**
> AuthorizationWithUser oauthAuthorizationsResetAuthorization(clientId, accessToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accessToken = "accessToken_example"; // String | 
    try {
      AuthorizationWithUser result = apiInstance.oauthAuthorizationsResetAuthorization(clientId, accessToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OauthAuthorizationsApi#oauthAuthorizationsResetAuthorization");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="oauthAuthorizationsRevokeAuthorizationForApplication"></a>
# **oauthAuthorizationsRevokeAuthorizationForApplication**
> oauthAuthorizationsRevokeAuthorizationForApplication(clientId, accessToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accessToken = "accessToken_example"; // String | 
    try {
      apiInstance.oauthAuthorizationsRevokeAuthorizationForApplication(clientId, accessToken);
    } catch (ApiException e) {
      System.err.println("Exception when calling OauthAuthorizationsApi#oauthAuthorizationsRevokeAuthorizationForApplication");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="oauthAuthorizationsRevokeGrantForApplication"></a>
# **oauthAuthorizationsRevokeGrantForApplication**
> oauthAuthorizationsRevokeGrantForApplication(clientId, accessToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accessToken = "accessToken_example"; // String | 
    try {
      apiInstance.oauthAuthorizationsRevokeGrantForApplication(clientId, accessToken);
    } catch (ApiException e) {
      System.err.println("Exception when calling OauthAuthorizationsApi#oauthAuthorizationsRevokeGrantForApplication");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
