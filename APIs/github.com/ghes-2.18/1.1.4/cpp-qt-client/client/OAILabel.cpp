...
bool OAILabel::isRDefault() const {
    return m_r_default;
}
void OAILabel::setRDefault(const bool &r_default) {
    m_r_default = r_default;
    m_r_default_isSet = true;
}

bool OAILabel::is_r_default_Set() const{
    return m_r_default_isSet;
}

bool OAILabel::is_r_default_Valid() const{
...
QString OAILabel::getNodeId() const {
    return m_node_id;
}
void OAILabel::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAILabel::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAILabel::is_node_id_Valid() const{
