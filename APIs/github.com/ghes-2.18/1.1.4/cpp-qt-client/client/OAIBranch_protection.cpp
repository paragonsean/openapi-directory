...
OAIBranch_protection_required_conversation_resolution OAIBranch_protection::getRequiredConversationResolution() const {
    return m_required_conversation_resolution;
}
void OAIBranch_protection::setRequiredConversationResolution(const OAIBranch_protection_required_conversation_resolution &required_conversation_resolution) {
...
OAIBranch_protection_required_status_checks OAIBranch_protection::getRequiredStatusChecks() const {
    return m_required_status_checks;
}
void OAIBranch_protection::setRequiredStatusChecks(const OAIBranch_protection_required_status_checks &required_status_checks) {
