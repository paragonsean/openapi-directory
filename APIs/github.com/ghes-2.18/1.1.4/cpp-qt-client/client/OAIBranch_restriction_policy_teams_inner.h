...
/*
 * OAIBranch_restriction_policy_teams_inner.h
 *
 * 
 */

#ifndef OAIBranch_restriction_policy_teams_inner_H
#define OAIBranch_restriction_policy_teams_inner_H
...
class OAIBranch_restriction_policy_teams_inner : public OAIObject {
public:
    OAIBranch_restriction_policy_teams_inner();
    OAIBranch_restriction_policy_teams_inner(QString json);
    ~OAIBranch_restriction_policy_teams_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranch_restriction_policy_teams_inner)

#endif // OAIBranch_restriction_policy_teams_inner_H
