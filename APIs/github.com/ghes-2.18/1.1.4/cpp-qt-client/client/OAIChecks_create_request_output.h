...
/*
 * OAIChecks_create_request_output.h
 *
 * Check runs can accept a variety of data in the &#x60;output&#x60; object, including a &#x60;title&#x60; and &#x60;summary&#x60; and can optionally provide descriptive details about the run. See the [&#x60;output&#x60; object](https://docs.github.com/enterprise-server@2.18/rest/reference/checks#output-object) description.
 */

#ifndef OAIChecks_create_request_output_H
#define OAIChecks_create_request_output_H
...
class OAIChecks_create_request_output : public OAIObject {
public:
    OAIChecks_create_request_output();
    OAIChecks_create_request_output(QString json);
    ~OAIChecks_create_request_output() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIChecks_create_request_output)

#endif // OAIChecks_create_request_output_H
