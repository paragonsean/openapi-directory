...
/*
 * OAIGit_commit_verification.h
 *
 * 
 */

#ifndef OAIGit_commit_verification_H
#define OAIGit_commit_verification_H
...
class OAIGit_commit_verification : public OAIObject {
public:
    OAIGit_commit_verification();
    OAIGit_commit_verification(QString json);
    ~OAIGit_commit_verification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGit_commit_verification)

#endif // OAIGit_commit_verification_H
