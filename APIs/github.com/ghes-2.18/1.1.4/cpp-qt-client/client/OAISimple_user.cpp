...
OAISimple_user::OAISimple_user(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISimple_user::OAISimple_user() {
    this->initializeModel();
}

OAISimple_user::~OAISimple_user() {}

void OAISimple_user::initializeModel() {
...
void OAISimple_user::fromJson(QString jsonString) {
...
void OAISimple_user::fromJsonObject(QJsonObject json) {
...
QString OAISimple_user::asJson() const {
...
QJsonObject OAISimple_user::asJsonObject() const {
    QJsonObject obj;
...
QString OAISimple_user::getAvatarUrl() const {
    return m_avatar_url;
}
void OAISimple_user::setAvatarUrl(const QString &avatar_url) {
    m_avatar_url = avatar_url;
    m_avatar_url_isSet = true;
}

bool OAISimple_user::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAISimple_user::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

QString OAISimple_user::getEmail() const {
    return m_email;
}
void OAISimple_user::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAISimple_user::is_email_Set() const{
    return m_email_isSet;
}

bool OAISimple_user::is_email_Valid() const{
    return m_email_isValid;
}

QString OAISimple_user::getEventsUrl() const {
    return m_events_url;
}
void OAISimple_user::setEventsUrl(const QString &events_url) {
    m_events_url = events_url;
    m_events_url_isSet = true;
}

bool OAISimple_user::is_events_url_Set() const{
    return m_events_url_isSet;
}

bool OAISimple_user::is_events_url_Valid() const{
    return m_events_url_isValid;
}

QString OAISimple_user::getFollowersUrl() const {
    return m_followers_url;
}
void OAISimple_user::setFollowersUrl(const QString &followers_url) {
    m_followers_url = followers_url;
    m_followers_url_isSet = true;
}

bool OAISimple_user::is_followers_url_Set() const{
    return m_followers_url_isSet;
}

bool OAISimple_user::is_followers_url_Valid() const{
    return m_followers_url_isValid;
}

QString OAISimple_user::getFollowingUrl() const {
    return m_following_url;
}
void OAISimple_user::setFollowingUrl(const QString &following_url) {
    m_following_url = following_url;
    m_following_url_isSet = true;
}

bool OAISimple_user::is_following_url_Set() const{
    return m_following_url_isSet;
}

bool OAISimple_user::is_following_url_Valid() const{
    return m_following_url_isValid;
}

QString OAISimple_user::getGistsUrl() const {
    return m_gists_url;
}
void OAISimple_user::setGistsUrl(const QString &gists_url) {
    m_gists_url = gists_url;
    m_gists_url_isSet = true;
}

bool OAISimple_user::is_gists_url_Set() const{
    return m_gists_url_isSet;
}

bool OAISimple_user::is_gists_url_Valid() const{
    return m_gists_url_isValid;
}

QString OAISimple_user::getGravatarId() const {
    return m_gravatar_id;
}
void OAISimple_user::setGravatarId(const QString &gravatar_id) {
    m_gravatar_id = gravatar_id;
    m_gravatar_id_isSet = true;
}

bool OAISimple_user::is_gravatar_id_Set() const{
    return m_gravatar_id_isSet;
}

bool OAISimple_user::is_gravatar_id_Valid() const{
    return m_gravatar_id_isValid;
}

QString OAISimple_user::getHtmlUrl() const {
    return m_html_url;
}
void OAISimple_user::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAISimple_user::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAISimple_user::is_html_url_Valid() const{
    return m_html_url_isValid;
}

qint32 OAISimple_user::getId() const {
    return m_id;
}
void OAISimple_user::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAISimple_user::is_id_Set() const{
    return m_id_isSet;
}

bool OAISimple_user::is_id_Valid() const{
    return m_id_isValid;
}

QString OAISimple_user::getLogin() const {
    return m_login;
}
void OAISimple_user::setLogin(const QString &login) {
    m_login = login;
    m_login_isSet = true;
}

bool OAISimple_user::is_login_Set() const{
    return m_login_isSet;
}

bool OAISimple_user::is_login_Valid() const{
    return m_login_isValid;
}

QString OAISimple_user::getName() const {
    return m_name;
}
void OAISimple_user::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAISimple_user::is_name_Set() const{
    return m_name_isSet;
}

bool OAISimple_user::is_name_Valid() const{
    return m_name_isValid;
}

QString OAISimple_user::getNodeId() const {
    return m_node_id;
}
void OAISimple_user::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAISimple_user::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAISimple_user::is_node_id_Valid() const{
    return m_node_id_isValid;
}

QString OAISimple_user::getOrganizationsUrl() const {
    return m_organizations_url;
}
void OAISimple_user::setOrganizationsUrl(const QString &organizations_url) {
    m_organizations_url = organizations_url;
    m_organizations_url_isSet = true;
}

bool OAISimple_user::is_organizations_url_Set() const{
    return m_organizations_url_isSet;
}

bool OAISimple_user::is_organizations_url_Valid() const{
    return m_organizations_url_isValid;
}

QString OAISimple_user::getReceivedEventsUrl() const {
    return m_received_events_url;
}
void OAISimple_user::setReceivedEventsUrl(const QString &received_events_url) {
    m_received_events_url = received_events_url;
    m_received_events_url_isSet = true;
}

bool OAISimple_user::is_received_events_url_Set() const{
    return m_received_events_url_isSet;
}

bool OAISimple_user::is_received_events_url_Valid() const{
    return m_received_events_url_isValid;
}

QString OAISimple_user::getReposUrl() const {
    return m_repos_url;
}
void OAISimple_user::setReposUrl(const QString &repos_url) {
    m_repos_url = repos_url;
    m_repos_url_isSet = true;
}

bool OAISimple_user::is_repos_url_Set() const{
    return m_repos_url_isSet;
}

bool OAISimple_user::is_repos_url_Valid() const{
    return m_repos_url_isValid;
}

bool OAISimple_user::isSiteAdmin() const {
    return m_site_admin;
}
void OAISimple_user::setSiteAdmin(const bool &site_admin) {
    m_site_admin = site_admin;
    m_site_admin_isSet = true;
}

bool OAISimple_user::is_site_admin_Set() const{
    return m_site_admin_isSet;
}

bool OAISimple_user::is_site_admin_Valid() const{
    return m_site_admin_isValid;
}

QString OAISimple_user::getStarredAt() const {
    return m_starred_at;
}
void OAISimple_user::setStarredAt(const QString &starred_at) {
    m_starred_at = starred_at;
    m_starred_at_isSet = true;
}

bool OAISimple_user::is_starred_at_Set() const{
    return m_starred_at_isSet;
}

bool OAISimple_user::is_starred_at_Valid() const{
    return m_starred_at_isValid;
}

QString OAISimple_user::getStarredUrl() const {
    return m_starred_url;
}
void OAISimple_user::setStarredUrl(const QString &starred_url) {
    m_starred_url = starred_url;
    m_starred_url_isSet = true;
}

bool OAISimple_user::is_starred_url_Set() const{
    return m_starred_url_isSet;
}

bool OAISimple_user::is_starred_url_Valid() const{
    return m_starred_url_isValid;
}

QString OAISimple_user::getSubscriptionsUrl() const {
    return m_subscriptions_url;
}
void OAISimple_user::setSubscriptionsUrl(const QString &subscriptions_url) {
    m_subscriptions_url = subscriptions_url;
    m_subscriptions_url_isSet = true;
}

bool OAISimple_user::is_subscriptions_url_Set() const{
    return m_subscriptions_url_isSet;
}

bool OAISimple_user::is_subscriptions_url_Valid() const{
    return m_subscriptions_url_isValid;
}

QString OAISimple_user::getType() const {
    return m_type;
}
void OAISimple_user::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISimple_user::is_type_Set() const{
    return m_type_isSet;
}

bool OAISimple_user::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISimple_user::getUrl() const {
    return m_url;
}
void OAISimple_user::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAISimple_user::is_url_Set() const{
    return m_url_isSet;
}

bool OAISimple_user::is_url_Valid() const{
    return m_url_isValid;
}

bool OAISimple_user::isSet() const {
...
bool OAISimple_user::isValid() const {
