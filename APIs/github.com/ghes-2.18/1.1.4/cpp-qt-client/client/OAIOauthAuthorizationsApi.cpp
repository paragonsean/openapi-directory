...
void OAIOauthAuthorizationsApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("oauthAuthorizations_checkAuthorization", defaultConf);
    _serverIndices.insert("oauthAuthorizations_checkAuthorization", 0);
    ...
    _serverConfigs.insert("oauthAuthorizations_resetAuthorization", defaultConf);
    _serverIndices.insert("oauthAuthorizations_resetAuthorization", 0);
    _serverConfigs.insert("oauthAuthorizations_revokeAuthorizationForApplication", defaultConf);
    _serverIndices.insert("oauthAuthorizations_revokeAuthorizationForApplication", 0);
    _serverConfigs.insert("oauthAuthorizations_revokeGrantForApplication", defaultConf);
    _serverIndices.insert("oauthAuthorizations_revokeGrantForApplication", 0);
...
void OAIOauthAuthorizationsApi::oauthAuthorizations_checkAuthorization(const QString &client_id, const QString &access_token) {
    QString fullPath = QString(_serverConfigs["oauthAuthorizations_checkAuthorization"][_serverIndices.value("oauthAuthorizations_checkAuthorization")].URL()+"/applications/{client_id}/tokens/{access_token}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOauthAuthorizationsApi::oauthAuthorizations_checkAuthorizationCallback);
...
void OAIOauthAuthorizationsApi::oauthAuthorizations_checkAuthorizationCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAuthorization_with_user output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT oauthAuthorizations_checkAuthorizationSignal(output);
        Q_EMIT oauthAuthorizations_checkAuthorizationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT oauthAuthorizations_checkAuthorizationSignalE(output, error_type, error_str);
        Q_EMIT oauthAuthorizations_checkAuthorizationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT oauthAuthorizations_checkAuthorizationSignalError(output, error_type, error_str);
        Q_EMIT oauthAuthorizations_checkAuthorizationSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIOauthAuthorizationsApi::oauthAuthorizations_resetAuthorization(const QString &client_id, const QString &access_token) {
    QString fullPath = QString(_serverConfigs["oauthAuthorizations_resetAuthorization"][_serverIndices.value("oauthAuthorizations_resetAuthorization")].URL()+"/applications/{client_id}/tokens/{access_token}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOauthAuthorizationsApi::oauthAuthorizations_resetAuthorizationCallback);
    connect(this, &OAIOauthAuthorizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOauthAuthorizationsApi::oauthAuthorizations_resetAuthorizationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT oauthAuthorizations_resetAuthorizationSignal(output);
        Q_EMIT oauthAuthorizations_resetAuthorizationSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT oauthAuthorizations_resetAuthorizationSignalE(output, error_type, error_str);
        Q_EMIT oauthAuthorizations_resetAuthorizationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT oauthAuthorizations_resetAuthorizationSignalError(output, error_type, error_str);
        Q_EMIT oauthAuthorizations_resetAuthorizationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOauthAuthorizationsApi::oauthAuthorizations_revokeAuthorizationForApplication(const QString &client_id, const QString &access_token) {
    QString fullPath = QString(_serverConfigs["oauthAuthorizations_revokeAuthorizationForApplication"][_serverIndices.value("oauthAuthorizations_revokeAuthorizationForApplication")].URL()+"/applications/{client_id}/tokens/{access_token}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOauthAuthorizationsApi::oauthAuthorizations_revokeAuthorizationForApplicationCallback);
    connect(this, &OAIOauthAuthorizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOauthAuthorizationsApi::oauthAuthorizations_revokeAuthorizationForApplicationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT oauthAuthorizations_revokeAuthorizationForApplicationSignal();
        Q_EMIT oauthAuthorizations_revokeAuthorizationForApplicationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT oauthAuthorizations_revokeAuthorizationForApplicationSignalE(error_type, error_str);
        Q_EMIT oauthAuthorizations_revokeAuthorizationForApplicationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT oauthAuthorizations_revokeAuthorizationForApplicationSignalError(error_type, error_str);
        Q_EMIT oauthAuthorizations_revokeAuthorizationForApplicationSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIOauthAuthorizationsApi::oauthAuthorizations_revokeGrantForApplication(const QString &client_id, const QString &access_token) {
    QString fullPath = QString(_serverConfigs["oauthAuthorizations_revokeGrantForApplication"][_serverIndices.value("oauthAuthorizations_revokeGrantForApplication")].URL()+"/applications/{client_id}/grants/{access_token}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIOauthAuthorizationsApi::oauthAuthorizations_revokeGrantForApplicationCallback);
    connect(this, &OAIOauthAuthorizationsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIOauthAuthorizationsApi::oauthAuthorizations_revokeGrantForApplicationCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT oauthAuthorizations_revokeGrantForApplicationSignal();
        Q_EMIT oauthAuthorizations_revokeGrantForApplicationSignalFull(worker);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT oauthAuthorizations_revokeGrantForApplicationSignalE(error_type, error_str);
        Q_EMIT oauthAuthorizations_revokeGrantForApplicationSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT oauthAuthorizations_revokeGrantForApplicationSignalError(error_type, error_str);
        Q_EMIT oauthAuthorizations_revokeGrantForApplicationSignalErrorFull(worker, error_type, error_str);
    }
}
