...
/*
 * OAIEnterprise_admin_create_pre_receive_hook_request.h
 *
 * 
 */

#ifndef OAIEnterprise_admin_create_pre_receive_hook_request_H
#define OAIEnterprise_admin_create_pre_receive_hook_request_H
...
class OAIEnterprise_admin_create_pre_receive_hook_request : public OAIObject {
public:
    OAIEnterprise_admin_create_pre_receive_hook_request();
    OAIEnterprise_admin_create_pre_receive_hook_request(QString json);
    ~OAIEnterprise_admin_create_pre_receive_hook_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnterprise_admin_create_pre_receive_hook_request)

#endif // OAIEnterprise_admin_create_pre_receive_hook_request_H
