...
/*
 * OAIApps_list_installation_repos_for_authenticated_user_200_response.h
 *
 * 
 */

#ifndef OAIApps_list_installation_repos_for_authenticated_user_200_response_H
#define OAIApps_list_installation_repos_for_authenticated_user_200_response_H
...
class OAIApps_list_installation_repos_for_authenticated_user_200_response : public OAIObject {
public:
    OAIApps_list_installation_repos_for_authenticated_user_200_response();
    OAIApps_list_installation_repos_for_authenticated_user_200_response(QString json);
    ~OAIApps_list_installation_repos_for_authenticated_user_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApps_list_installation_repos_for_authenticated_user_200_response)

#endif // OAIApps_list_installation_repos_for_authenticated_user_200_response_H
