...
#ifndef OAIDiff_entry_H
#define OAIDiff_entry_H
...
class OAIDiff_entry : public OAIObject {
public:
    OAIDiff_entry();
    OAIDiff_entry(QString json);
    ~OAIDiff_entry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDiff_entry)

#endif // OAIDiff_entry_H
