...
OAIProtected_branch_allow_deletions OAIProtected_branch::getBlockCreations() const {
    return m_block_creations;
}
void OAIProtected_branch::setBlockCreations(const OAIProtected_branch_allow_deletions &block_creations) {
    m_block_creations = block_creations;
    m_block_creations_isSet = true;
}

bool OAIProtected_branch::is_block_creations_Set() const{
    return m_block_creations_isSet;
}

bool OAIProtected_branch::is_block_creations_Valid() const{
