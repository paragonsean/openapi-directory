...
/*
 * OAIRemoved_from_project_issue_event.h
 *
 * Removed from Project Issue Event
 */

#ifndef OAIRemoved_from_project_issue_event_H
#define OAIRemoved_from_project_issue_event_H
...
class OAIRemoved_from_project_issue_event : public OAIObject {
public:
    OAIRemoved_from_project_issue_event();
    OAIRemoved_from_project_issue_event(QString json);
    ~OAIRemoved_from_project_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoved_from_project_issue_event)

#endif // OAIRemoved_from_project_issue_event_H
