...
/*
 * OAISecret_scanning_location_commit.h
 *
 * Represents a &#39;commit&#39; secret scanning location type. This location type shows that a secret was detected inside a commit to a repository.
 */

#ifndef OAISecret_scanning_location_commit_H
#define OAISecret_scanning_location_commit_H
...
class OAISecret_scanning_location_commit : public OAIObject {
public:
    OAISecret_scanning_location_commit();
    OAISecret_scanning_location_commit(QString json);
    ~OAISecret_scanning_location_commit() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecret_scanning_location_commit)

#endif // OAISecret_scanning_location_commit_H
