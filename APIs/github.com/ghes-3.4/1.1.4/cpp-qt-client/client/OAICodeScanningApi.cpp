...
void OAICodeScanningApi::codeScanning_listAlertsForRepo(const QString &owner, const QString &repo, const ::OpenAPI::OptionalParam<QString> &tool_name, const ::OpenAPI::OptionalParam<QString> &tool_guid, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<qint32> &per_page, const ::OpenAPI::OptionalParam<QString> &ref, const ::OpenAPI::OptionalParam<QString> &direction, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<OAICode_scanning_alert_state> &state) {
