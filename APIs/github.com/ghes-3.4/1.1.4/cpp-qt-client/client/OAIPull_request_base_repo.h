...
/*
 * OAIPull_request_base_repo.h
 *
 * 
 */

#ifndef OAIPull_request_base_repo_H
#define OAIPull_request_base_repo_H
...
class OAIPull_request_base_repo : public OAIObject {
public:
    OAIPull_request_base_repo();
    OAIPull_request_base_repo(QString json);
    ~OAIPull_request_base_repo() override;
    ...
    bool isHasDiscussions() const;
    void setHasDiscussions(const bool &has_discussions);
    bool is_has_discussions_Set() const;
    bool is_has_discussions_Valid() const;
    ...
    OAIPull_request_base_repo_owner getOwner() const;
    void setOwner(const OAIPull_request_base_repo_owner &owner);
...
private:
    ...
    bool m_has_discussions;
    bool m_has_discussions_isSet;
    bool m_has_discussions_isValid;
    ...
    OAIPull_request_base_repo_owner m_owner;
    bool m_owner_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPull_request_base_repo)

#endif // OAIPull_request_base_repo_H
