...
/*
 * OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer.h
 *
 * 
 */

#ifndef OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer_H
#define OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer_H
...
class OAITeam_permissions;

class OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer : public OAIObject {
public:
    OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer();
    OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer(QString json);
    ~OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer() override;
    ...
    OAITeam_permissions getPermissions() const;
    void setPermissions(const OAITeam_permissions &permissions);
...
private:
    ...
    OAITeam_permissions m_permissions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer)

#endif // OAIEnvironment_protection_rules_inner_anyOf_1_reviewers_inner_reviewer_H
