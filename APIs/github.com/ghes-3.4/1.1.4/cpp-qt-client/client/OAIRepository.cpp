...
bool OAIRepository::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAIRepository::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAIRepository::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAIRepository::is_allow_auto_merge_Valid() const{
...
bool OAIRepository::isAllowUpdateBranch() const {
    return m_allow_update_branch;
}
void OAIRepository::setAllowUpdateBranch(const bool &allow_update_branch) {
    m_allow_update_branch = allow_update_branch;
    m_allow_update_branch_isSet = true;
}

bool OAIRepository::is_allow_update_branch_Set() const{
    return m_allow_update_branch_isSet;
}

bool OAIRepository::is_allow_update_branch_Valid() const{
...
QString OAIRepository::getTempCloneToken() const {
    return m_temp_clone_token;
}
void OAIRepository::setTempCloneToken(const QString &temp_clone_token) {
    m_temp_clone_token = temp_clone_token;
    m_temp_clone_token_isSet = true;
}

bool OAIRepository::is_temp_clone_token_Set() const{
    return m_temp_clone_token_isSet;
}

bool OAIRepository::is_temp_clone_token_Valid() const{
