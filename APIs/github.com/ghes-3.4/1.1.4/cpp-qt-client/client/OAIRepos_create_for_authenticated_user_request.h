...
/*
 * OAIRepos_create_for_authenticated_user_request.h
 *
 * 
 */

#ifndef OAIRepos_create_for_authenticated_user_request_H
#define OAIRepos_create_for_authenticated_user_request_H
...
class OAIRepos_create_for_authenticated_user_request : public OAIObject {
public:
    OAIRepos_create_for_authenticated_user_request();
    OAIRepos_create_for_authenticated_user_request(QString json);
    ~OAIRepos_create_for_authenticated_user_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepos_create_for_authenticated_user_request)

#endif // OAIRepos_create_for_authenticated_user_request_H
