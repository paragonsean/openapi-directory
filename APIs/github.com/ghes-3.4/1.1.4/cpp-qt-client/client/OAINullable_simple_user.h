...
/*
 * OAINullable_simple_user.h
 *
 * A GitHub user.
 */

#ifndef OAINullable_simple_user_H
#define OAINullable_simple_user_H
...
class OAINullable_simple_user : public OAIObject {
public:
    OAINullable_simple_user();
    OAINullable_simple_user(QString json);
    ~OAINullable_simple_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_simple_user)

#endif // OAINullable_simple_user_H
