...
bool OAINullable_repository_template_repository::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAINullable_repository_template_repository::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAINullable_repository_template_repository::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAINullable_repository_template_repository::is_allow_auto_merge_Valid() const{
...
bool OAINullable_repository_template_repository::isAllowUpdateBranch() const {
    return m_allow_update_branch;
}
void OAINullable_repository_template_repository::setAllowUpdateBranch(const bool &allow_update_branch) {
    m_allow_update_branch = allow_update_branch;
    m_allow_update_branch_isSet = true;
}

bool OAINullable_repository_template_repository::is_allow_update_branch_Set() const{
    return m_allow_update_branch_isSet;
}

bool OAINullable_repository_template_repository::is_allow_update_branch_Valid() const{
