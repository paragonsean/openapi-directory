...
/*
 * OAIPull_request_review.h
 *
 * Pull Request Reviews are reviews on pull requests.
 */

#ifndef OAIPull_request_review_H
#define OAIPull_request_review_H
...
class OAIPull_request_review : public OAIObject {
public:
    OAIPull_request_review();
    OAIPull_request_review(QString json);
    ~OAIPull_request_review() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPull_request_review)

#endif // OAIPull_request_review_H
