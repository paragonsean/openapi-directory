...
OAISecret_scanning_location_commit::OAISecret_scanning_location_commit(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISecret_scanning_location_commit::OAISecret_scanning_location_commit() {
    this->initializeModel();
}

OAISecret_scanning_location_commit::~OAISecret_scanning_location_commit() {}

void OAISecret_scanning_location_commit::initializeModel() {
...
void OAISecret_scanning_location_commit::fromJson(QString jsonString) {
...
void OAISecret_scanning_location_commit::fromJsonObject(QJsonObject json) {
...
QString OAISecret_scanning_location_commit::asJson() const {
...
QJsonObject OAISecret_scanning_location_commit::asJsonObject() const {
    QJsonObject obj;
    if (m_blob_sha_isSet) {
...
QString OAISecret_scanning_location_commit::getBlobSha() const {
    return m_blob_sha;
}
void OAISecret_scanning_location_commit::setBlobSha(const QString &blob_sha) {
    m_blob_sha = blob_sha;
    m_blob_sha_isSet = true;
}

bool OAISecret_scanning_location_commit::is_blob_sha_Set() const{
    return m_blob_sha_isSet;
}

bool OAISecret_scanning_location_commit::is_blob_sha_Valid() const{
    return m_blob_sha_isValid;
}

QString OAISecret_scanning_location_commit::getBlobUrl() const {
    return m_blob_url;
}
void OAISecret_scanning_location_commit::setBlobUrl(const QString &blob_url) {
    m_blob_url = blob_url;
    m_blob_url_isSet = true;
}

bool OAISecret_scanning_location_commit::is_blob_url_Set() const{
    return m_blob_url_isSet;
}

bool OAISecret_scanning_location_commit::is_blob_url_Valid() const{
    return m_blob_url_isValid;
}

QString OAISecret_scanning_location_commit::getCommitSha() const {
    return m_commit_sha;
}
void OAISecret_scanning_location_commit::setCommitSha(const QString &commit_sha) {
    m_commit_sha = commit_sha;
    m_commit_sha_isSet = true;
}

bool OAISecret_scanning_location_commit::is_commit_sha_Set() const{
    return m_commit_sha_isSet;
}

bool OAISecret_scanning_location_commit::is_commit_sha_Valid() const{
    return m_commit_sha_isValid;
}

QString OAISecret_scanning_location_commit::getCommitUrl() const {
    return m_commit_url;
}
void OAISecret_scanning_location_commit::setCommitUrl(const QString &commit_url) {
    m_commit_url = commit_url;
    m_commit_url_isSet = true;
}

bool OAISecret_scanning_location_commit::is_commit_url_Set() const{
    return m_commit_url_isSet;
}

bool OAISecret_scanning_location_commit::is_commit_url_Valid() const{
    return m_commit_url_isValid;
}

double OAISecret_scanning_location_commit::getEndColumn() const {
    return m_end_column;
}
void OAISecret_scanning_location_commit::setEndColumn(const double &end_column) {
    m_end_column = end_column;
    m_end_column_isSet = true;
}

bool OAISecret_scanning_location_commit::is_end_column_Set() const{
    return m_end_column_isSet;
}

bool OAISecret_scanning_location_commit::is_end_column_Valid() const{
    return m_end_column_isValid;
}

double OAISecret_scanning_location_commit::getEndLine() const {
    return m_end_line;
}
void OAISecret_scanning_location_commit::setEndLine(const double &end_line) {
    m_end_line = end_line;
    m_end_line_isSet = true;
}

bool OAISecret_scanning_location_commit::is_end_line_Set() const{
    return m_end_line_isSet;
}

bool OAISecret_scanning_location_commit::is_end_line_Valid() const{
    return m_end_line_isValid;
}

QString OAISecret_scanning_location_commit::getPath() const {
    return m_path;
}
void OAISecret_scanning_location_commit::setPath(const QString &path) {
    m_path = path;
    m_path_isSet = true;
}

bool OAISecret_scanning_location_commit::is_path_Set() const{
    return m_path_isSet;
}

bool OAISecret_scanning_location_commit::is_path_Valid() const{
    return m_path_isValid;
}

double OAISecret_scanning_location_commit::getStartColumn() const {
    return m_start_column;
}
void OAISecret_scanning_location_commit::setStartColumn(const double &start_column) {
    m_start_column = start_column;
    m_start_column_isSet = true;
}

bool OAISecret_scanning_location_commit::is_start_column_Set() const{
    return m_start_column_isSet;
}

bool OAISecret_scanning_location_commit::is_start_column_Valid() const{
    return m_start_column_isValid;
}

double OAISecret_scanning_location_commit::getStartLine() const {
    return m_start_line;
}
void OAISecret_scanning_location_commit::setStartLine(const double &start_line) {
    m_start_line = start_line;
    m_start_line_isSet = true;
}

bool OAISecret_scanning_location_commit::is_start_line_Set() const{
    return m_start_line_isSet;
}

bool OAISecret_scanning_location_commit::is_start_line_Valid() const{
    return m_start_line_isValid;
}

bool OAISecret_scanning_location_commit::isSet() const {
...
bool OAISecret_scanning_location_commit::isValid() const {
