...
public:
    ...
    OAITeam_organization getOrganization() const;
    void setOrganization(const OAITeam_organization &organization);
...
private:
    ...
    OAITeam_organization m_organization;
