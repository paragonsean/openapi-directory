...
OAIAuto_merge OAIPull_request::getAutoMerge() const {
    return m_auto_merge;
}
void OAIPull_request::setAutoMerge(const OAIAuto_merge &auto_merge) {
    m_auto_merge = auto_merge;
    m_auto_merge_isSet = true;
}

bool OAIPull_request::is_auto_merge_Set() const{
    return m_auto_merge_isSet;
}

bool OAIPull_request::is_auto_merge_Valid() const{
...
QList<OAIPull_request_labels_inner> OAIPull_request::getLabels() const {
    return m_labels;
}
void OAIPull_request::setLabels(const QList<OAIPull_request_labels_inner> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}
