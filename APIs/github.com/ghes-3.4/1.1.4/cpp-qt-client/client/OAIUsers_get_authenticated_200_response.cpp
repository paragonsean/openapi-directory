...
QString OAIUsers_get_authenticated_200_response::getTwitterUsername() const {
    return m_twitter_username;
}
void OAIUsers_get_authenticated_200_response::setTwitterUsername(const QString &twitter_username) {
    m_twitter_username = twitter_username;
    m_twitter_username_isSet = true;
}

bool OAIUsers_get_authenticated_200_response::is_twitter_username_Set() const{
    return m_twitter_username_isSet;
}

bool OAIUsers_get_authenticated_200_response::is_twitter_username_Valid() const{
