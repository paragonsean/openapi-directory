...
OAIProtected_branch_required_pull_request_reviews_bypass_pull_request_allowances OAIProtected_branch_required_pull_request_reviews::getBypassPullRequestAllowances() const {
    return m_bypass_pull_request_allowances;
}
void OAIProtected_branch_required_pull_request_reviews::setBypassPullRequestAllowances(const OAIProtected_branch_required_pull_request_reviews_bypass_pull_request_allowances &bypass_pull_request_allowances) {
    m_bypass_pull_request_allowances = bypass_pull_request_allowances;
    m_bypass_pull_request_allowances_isSet = true;
}

bool OAIProtected_branch_required_pull_request_reviews::is_bypass_pull_request_allowances_Set() const{
    return m_bypass_pull_request_allowances_isSet;
}

bool OAIProtected_branch_required_pull_request_reviews::is_bypass_pull_request_allowances_Valid() const{
