...
/*
 * OAIApps_create_from_manifest_201_response.h
 *
 * 
 */

#ifndef OAIApps_create_from_manifest_201_response_H
#define OAIApps_create_from_manifest_201_response_H
...
class OAIApps_create_from_manifest_201_response : public OAIObject {
public:
    OAIApps_create_from_manifest_201_response();
    OAIApps_create_from_manifest_201_response(QString json);
    ~OAIApps_create_from_manifest_201_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIApps_create_from_manifest_201_response)

#endif // OAIApps_create_from_manifest_201_response_H
