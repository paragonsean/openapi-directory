...
bool OAITeam_repository::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAITeam_repository::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAITeam_repository::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAITeam_repository::is_allow_auto_merge_Valid() const{
