...
public:
    ...
    QDateTime getFixedAt() const;
    void setFixedAt(const QDateTime &fixed_at);
    bool is_fixed_at_Set() const;
    bool is_fixed_at_Valid() const;
...
private:
    ...
    QDateTime m_fixed_at;
    bool m_fixed_at_isSet;
    bool m_fixed_at_isValid;
