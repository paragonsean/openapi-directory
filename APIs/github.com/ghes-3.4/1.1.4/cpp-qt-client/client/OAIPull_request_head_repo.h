...
/*
 * OAIPull_request_head_repo.h
 *
 * 
 */

#ifndef OAIPull_request_head_repo_H
#define OAIPull_request_head_repo_H
...
namespace OpenAPI {
class OAIPull_request_head_repo_license;
class OAIPull_request_base_repo_owner;
class OAICollaborator_permissions;

class OAIPull_request_head_repo : public OAIObject {
public:
    OAIPull_request_head_repo();
    OAIPull_request_head_repo(QString json);
    ~OAIPull_request_head_repo() override;
    ...
    OAIPull_request_head_repo_license getLicense() const;
    void setLicense(const OAIPull_request_head_repo_license &license);
...
private:
    ...
    OAIPull_request_head_repo_license m_license;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPull_request_head_repo)

#endif // OAIPull_request_head_repo_H
