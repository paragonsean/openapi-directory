...
public:
    ...
    * @param[in]  ref QString [required]
    */
    virtual void git_getRef(const QString &owner, const QString &repo, const QString &ref);
    ...
    * @param[in]  ref QString [required]
    */
    virtual void git_listMatchingRefs(const QString &owner, const QString &repo, const QString &ref);
...
private:
    ...
    void git_getRefCallback(OAIHttpRequestWorker *worker);
    void git_getTagCallback(OAIHttpRequestWorker *worker);
    void git_getTreeCallback(OAIHttpRequestWorker *worker);
    void git_listMatchingRefsCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void git_getRefSignal(OAIGit_ref summary);
    void git_getTagSignal(OAIGit_tag summary);
    void git_getTreeSignal(OAIGit_tree summary);
    void git_listMatchingRefsSignal(QList<OAIGit_ref> summary);
    ...
    void git_getRefSignalFull(OAIHttpRequestWorker *worker, OAIGit_ref summary);
    ...
    void git_listMatchingRefsSignalFull(OAIHttpRequestWorker *worker, QList<OAIGit_ref> summary);
    ...
    Q_DECL_DEPRECATED_X("Use git_getRefSignalError() instead")
    void git_getRefSignalE(OAIGit_ref summary, QNetworkReply::NetworkError error_type, QString error_str);
    void git_getRefSignalError(OAIGit_ref summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use git_listMatchingRefsSignalError() instead")
    void git_listMatchingRefsSignalE(QList<OAIGit_ref> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void git_listMatchingRefsSignalError(QList<OAIGit_ref> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use git_getRefSignalErrorFull() instead")
    void git_getRefSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void git_getRefSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use git_listMatchingRefsSignalErrorFull() instead")
    void git_listMatchingRefsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void git_listMatchingRefsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
