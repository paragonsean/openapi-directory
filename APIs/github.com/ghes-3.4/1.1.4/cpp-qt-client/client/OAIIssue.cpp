...
QString OAIIssue::getActiveLockReason() const {
    return m_active_lock_reason;
}
void OAIIssue::setActiveLockReason(const QString &active_lock_reason) {
    m_active_lock_reason = active_lock_reason;
    m_active_lock_reason_isSet = true;
}

bool OAIIssue::is_active_lock_reason_Set() const{
    return m_active_lock_reason_isSet;
}

bool OAIIssue::is_active_lock_reason_Valid() const{
    return m_active_lock_reason_isValid;
}

OAINullable_simple_user OAIIssue::getAssignee() const {
    return m_assignee;
}
void OAIIssue::setAssignee(const OAINullable_simple_user &assignee) {
    m_assignee = assignee;
...
QList<OAISimple_user> OAIIssue::getAssignees() const {
    return m_assignees;
}
void OAIIssue::setAssignees(const QList<OAISimple_user> &assignees) {
...
OAIAuthor_association OAIIssue::getAuthorAssociation() const {
    return m_author_association;
}
void OAIIssue::setAuthorAssociation(const OAIAuthor_association &author_association) {
    m_author_association = author_association;
    m_author_association_isSet = true;
}

bool OAIIssue::is_author_association_Set() const{
    return m_author_association_isSet;
}

bool OAIIssue::is_author_association_Valid() const{
...
QString OAIIssue::getBodyHtml() const {
    return m_body_html;
}
void OAIIssue::setBodyHtml(const QString &body_html) {
    m_body_html = body_html;
    m_body_html_isSet = true;
}

bool OAIIssue::is_body_html_Set() const{
    return m_body_html_isSet;
}

bool OAIIssue::is_body_html_Valid() const{
    return m_body_html_isValid;
}

QString OAIIssue::getBodyText() const {
    return m_body_text;
}
void OAIIssue::setBodyText(const QString &body_text) {
    m_body_text = body_text;
    m_body_text_isSet = true;
}

bool OAIIssue::is_body_text_Set() const{
    return m_body_text_isSet;
}

bool OAIIssue::is_body_text_Valid() const{
...
OAINullable_simple_user OAIIssue::getClosedBy() const {
    return m_closed_by;
}
void OAIIssue::setClosedBy(const OAINullable_simple_user &closed_by) {
    m_closed_by = closed_by;
    m_closed_by_isSet = true;
}

bool OAIIssue::is_closed_by_Set() const{
    return m_closed_by_isSet;
}

bool OAIIssue::is_closed_by_Valid() const{
    return m_closed_by_isValid;
}

qint32 OAIIssue::getComments() const {
    return m_comments;
}
void OAIIssue::setComments(const qint32 &comments) {
    m_comments = comments;
...
QString OAIIssue::getCommentsUrl() const {
    return m_comments_url;
}
void OAIIssue::setCommentsUrl(const QString &comments_url) {
    m_comments_url = comments_url;
    m_comments_url_isSet = true;
}

bool OAIIssue::is_comments_url_Set() const{
    return m_comments_url_isSet;
}

bool OAIIssue::is_comments_url_Valid() const{
...
bool OAIIssue::isDraft() const {
    return m_draft;
}
void OAIIssue::setDraft(const bool &draft) {
    m_draft = draft;
    m_draft_isSet = true;
}

bool OAIIssue::is_draft_Set() const{
    return m_draft_isSet;
}

bool OAIIssue::is_draft_Valid() const{
    return m_draft_isValid;
}

QString OAIIssue::getEventsUrl() const {
    return m_events_url;
}
void OAIIssue::setEventsUrl(const QString &events_url) {
    m_events_url = events_url;
    m_events_url_isSet = true;
}

bool OAIIssue::is_events_url_Set() const{
    return m_events_url_isSet;
}

bool OAIIssue::is_events_url_Valid() const{
...
QList<OAIIssue_labels_inner> OAIIssue::getLabels() const {
    return m_labels;
}
void OAIIssue::setLabels(const QList<OAIIssue_labels_inner> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}
...
QString OAIIssue::getLabelsUrl() const {
    return m_labels_url;
}
void OAIIssue::setLabelsUrl(const QString &labels_url) {
    m_labels_url = labels_url;
    m_labels_url_isSet = true;
}

bool OAIIssue::is_labels_url_Set() const{
    return m_labels_url_isSet;
}

bool OAIIssue::is_labels_url_Valid() const{
    return m_labels_url_isValid;
}

bool OAIIssue::isLocked() const {
    return m_locked;
}
void OAIIssue::setLocked(const bool &locked) {
    m_locked = locked;
    m_locked_isSet = true;
}

bool OAIIssue::is_locked_Set() const{
    return m_locked_isSet;
}

bool OAIIssue::is_locked_Valid() const{
    return m_locked_isValid;
}

OAINullable_milestone OAIIssue::getMilestone() const {
    return m_milestone;
}
void OAIIssue::setMilestone(const OAINullable_milestone &milestone) {
...
QString OAIIssue::getNodeId() const {
    return m_node_id;
}
void OAIIssue::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAIIssue::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAIIssue::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint32 OAIIssue::getNumber() const {
    return m_number;
}
void OAIIssue::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}
...
OAINullable_integration OAIIssue::getPerformedViaGithubApp() const {
    return m_performed_via_github_app;
}
void OAIIssue::setPerformedViaGithubApp(const OAINullable_integration &performed_via_github_app) {
    m_performed_via_github_app = performed_via_github_app;
    m_performed_via_github_app_isSet = true;
}

bool OAIIssue::is_performed_via_github_app_Set() const{
    return m_performed_via_github_app_isSet;
}

bool OAIIssue::is_performed_via_github_app_Valid() const{
    return m_performed_via_github_app_isValid;
}

OAIIssue_pull_request OAIIssue::getPullRequest() const {
    return m_pull_request;
}
void OAIIssue::setPullRequest(const OAIIssue_pull_request &pull_request) {
...
OAIReaction_rollup OAIIssue::getReactions() const {
    return m_reactions;
}
void OAIIssue::setReactions(const OAIReaction_rollup &reactions) {
    m_reactions = reactions;
    m_reactions_isSet = true;
}

bool OAIIssue::is_reactions_Set() const{
    return m_reactions_isSet;
}

bool OAIIssue::is_reactions_Valid() const{
...
QString OAIIssue::getRepositoryUrl() const {
    return m_repository_url;
}
void OAIIssue::setRepositoryUrl(const QString &repository_url) {
    m_repository_url = repository_url;
    m_repository_url_isSet = true;
}

bool OAIIssue::is_repository_url_Set() const{
    return m_repository_url_isSet;
}

bool OAIIssue::is_repository_url_Valid() const{
...
QString OAIIssue::getStateReason() const {
    return m_state_reason;
}
void OAIIssue::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAIIssue::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAIIssue::is_state_reason_Valid() const{
    return m_state_reason_isValid;
}

QString OAIIssue::getTimelineUrl() const {
    return m_timeline_url;
}
void OAIIssue::setTimelineUrl(const QString &timeline_url) {
    m_timeline_url = timeline_url;
    m_timeline_url_isSet = true;
}

bool OAIIssue::is_timeline_url_Set() const{
    return m_timeline_url_isSet;
}

bool OAIIssue::is_timeline_url_Valid() const{
...
OAINullable_simple_user OAIIssue::getUser() const {
    return m_user;
}
void OAIIssue::setUser(const OAINullable_simple_user &user) {
    m_user = user;
    m_user_isSet = true;
}
