...
/*
 * OAITimeline_unassigned_issue_event.h
 *
 * Timeline Unassigned Issue Event
 */

#ifndef OAITimeline_unassigned_issue_event_H
#define OAITimeline_unassigned_issue_event_H
...
class OAITimeline_unassigned_issue_event : public OAIObject {
public:
    OAITimeline_unassigned_issue_event();
    OAITimeline_unassigned_issue_event(QString json);
    ~OAITimeline_unassigned_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITimeline_unassigned_issue_event)

#endif // OAITimeline_unassigned_issue_event_H
