...
bool OAIRepos_create_in_org_request::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAIRepos_create_in_org_request::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAIRepos_create_in_org_request::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAIRepos_create_in_org_request::is_allow_auto_merge_Valid() const{
