...
OAIBranch_protection_allow_deletions OAIEnterprise_settings_enterprise::getPages() const {
    return m_pages;
}
void OAIEnterprise_settings_enterprise::setPages(const OAIBranch_protection_allow_deletions &pages) {
    m_pages = pages;
    m_pages_isSet = true;
}
