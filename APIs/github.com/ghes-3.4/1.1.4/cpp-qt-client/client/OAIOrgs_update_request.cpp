...
void OAIOrgs_update_request::initializeModel() {
    ...
    m_members_can_fork_private_repositories_isSet = false;
    m_members_can_fork_private_repositories_isValid = false;
...
void OAIOrgs_update_request::fromJsonObject(QJsonObject json) {
    ...
    m_members_can_fork_private_repositories_isValid = ::OpenAPI::fromJsonValue(m_members_can_fork_private_repositories, json[QString("members_can_fork_private_repositories")]);
    m_members_can_fork_private_repositories_isSet = !json[QString("members_can_fork_private_repositories")].isNull() && m_members_can_fork_private_repositories_isValid;
...
QJsonObject OAIOrgs_update_request::asJsonObject() const {
    ...
    if (m_members_can_fork_private_repositories_isSet) {
        obj.insert(QString("members_can_fork_private_repositories"), ::OpenAPI::toJsonValue(m_members_can_fork_private_repositories));
    }
    if (m_name_isSet) {
...
bool OAIOrgs_update_request::isMembersCanCreatePages() const {
    return m_members_can_create_pages;
}
void OAIOrgs_update_request::setMembersCanCreatePages(const bool &members_can_create_pages) {
    m_members_can_create_pages = members_can_create_pages;
    m_members_can_create_pages_isSet = true;
}

bool OAIOrgs_update_request::is_members_can_create_pages_Set() const{
    return m_members_can_create_pages_isSet;
}

bool OAIOrgs_update_request::is_members_can_create_pages_Valid() const{
...
bool OAIOrgs_update_request::isMembersCanForkPrivateRepositories() const {
    return m_members_can_fork_private_repositories;
}
void OAIOrgs_update_request::setMembersCanForkPrivateRepositories(const bool &members_can_fork_private_repositories) {
    m_members_can_fork_private_repositories = members_can_fork_private_repositories;
    m_members_can_fork_private_repositories_isSet = true;
}

bool OAIOrgs_update_request::is_members_can_fork_private_repositories_Set() const{
    return m_members_can_fork_private_repositories_isSet;
}

bool OAIOrgs_update_request::is_members_can_fork_private_repositories_Valid() const{
    return m_members_can_fork_private_repositories_isValid;
}
