...
/*
 * OAITeam_organization.h
 *
 * Team Organization
 */

#ifndef OAITeam_organization_H
#define OAITeam_organization_H
...
class OAITeam_organization : public OAIObject {
public:
    OAITeam_organization();
    OAITeam_organization(QString json);
    ~OAITeam_organization() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITeam_organization)

#endif // OAITeam_organization_H
