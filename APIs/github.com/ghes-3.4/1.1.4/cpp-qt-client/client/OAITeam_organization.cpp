...
bool OAITeam_organization::isMembersCanForkPrivateRepositories() const {
    return m_members_can_fork_private_repositories;
}
void OAITeam_organization::setMembersCanForkPrivateRepositories(const bool &members_can_fork_private_repositories) {
...
bool OAITeam_organization::is_members_can_fork_private_repositories_Set() const{
    return m_members_can_fork_private_repositories_isSet;
}

bool OAITeam_organization::is_members_can_fork_private_repositories_Valid() const{
