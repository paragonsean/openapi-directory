...
/*
 * OAIMigrations_start_for_org_request.h
 *
 * 
 */

#ifndef OAIMigrations_start_for_org_request_H
#define OAIMigrations_start_for_org_request_H
...
class OAIMigrations_start_for_org_request : public OAIObject {
public:
    OAIMigrations_start_for_org_request();
    OAIMigrations_start_for_org_request(QString json);
    ~OAIMigrations_start_for_org_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMigrations_start_for_org_request)

#endif // OAIMigrations_start_for_org_request_H
