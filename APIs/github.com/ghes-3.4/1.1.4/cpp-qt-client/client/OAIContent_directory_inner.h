...
/*
 * OAIContent_directory_inner.h
 *
 * 
 */

#ifndef OAIContent_directory_inner_H
#define OAIContent_directory_inner_H
...
class OAIContent_directory_inner : public OAIObject {
public:
    OAIContent_directory_inner();
    OAIContent_directory_inner(QString json);
    ~OAIContent_directory_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_directory_inner)

#endif // OAIContent_directory_inner_H
