...
QString OAIPrivate_user::getTwitterUsername() const {
    return m_twitter_username;
}
void OAIPrivate_user::setTwitterUsername(const QString &twitter_username) {
    m_twitter_username = twitter_username;
    m_twitter_username_isSet = true;
}

bool OAIPrivate_user::is_twitter_username_Set() const{
    return m_twitter_username_isSet;
}

bool OAIPrivate_user::is_twitter_username_Valid() const{
