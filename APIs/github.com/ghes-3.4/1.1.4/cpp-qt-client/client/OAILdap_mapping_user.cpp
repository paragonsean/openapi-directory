...
OAILdap_mapping_user::OAILdap_mapping_user(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILdap_mapping_user::OAILdap_mapping_user() {
    this->initializeModel();
}

OAILdap_mapping_user::~OAILdap_mapping_user() {}

void OAILdap_mapping_user::initializeModel() {
...
void OAILdap_mapping_user::fromJson(QString jsonString) {
...
void OAILdap_mapping_user::fromJsonObject(QJsonObject json) {
...
QString OAILdap_mapping_user::asJson() const {
...
QJsonObject OAILdap_mapping_user::asJsonObject() const {
    QJsonObject obj;
...
QString OAILdap_mapping_user::getAvatarUrl() const {
    return m_avatar_url;
}
void OAILdap_mapping_user::setAvatarUrl(const QString &avatar_url) {
    m_avatar_url = avatar_url;
    m_avatar_url_isSet = true;
}

bool OAILdap_mapping_user::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAILdap_mapping_user::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

QString OAILdap_mapping_user::getBio() const {
    return m_bio;
}
void OAILdap_mapping_user::setBio(const QString &bio) {
    m_bio = bio;
    m_bio_isSet = true;
}

bool OAILdap_mapping_user::is_bio_Set() const{
    return m_bio_isSet;
}

bool OAILdap_mapping_user::is_bio_Valid() const{
    return m_bio_isValid;
}

QString OAILdap_mapping_user::getBlog() const {
    return m_blog;
}
void OAILdap_mapping_user::setBlog(const QString &blog) {
    m_blog = blog;
    m_blog_isSet = true;
}

bool OAILdap_mapping_user::is_blog_Set() const{
    return m_blog_isSet;
}

bool OAILdap_mapping_user::is_blog_Valid() const{
    return m_blog_isValid;
}

bool OAILdap_mapping_user::isBusinessPlus() const {
    return m_business_plus;
}
void OAILdap_mapping_user::setBusinessPlus(const bool &business_plus) {
    m_business_plus = business_plus;
    m_business_plus_isSet = true;
}

bool OAILdap_mapping_user::is_business_plus_Set() const{
    return m_business_plus_isSet;
}

bool OAILdap_mapping_user::is_business_plus_Valid() const{
    return m_business_plus_isValid;
}

qint32 OAILdap_mapping_user::getCollaborators() const {
    return m_collaborators;
}
void OAILdap_mapping_user::setCollaborators(const qint32 &collaborators) {
    m_collaborators = collaborators;
    m_collaborators_isSet = true;
}

bool OAILdap_mapping_user::is_collaborators_Set() const{
    return m_collaborators_isSet;
}

bool OAILdap_mapping_user::is_collaborators_Valid() const{
    return m_collaborators_isValid;
}

QString OAILdap_mapping_user::getCompany() const {
    return m_company;
}
void OAILdap_mapping_user::setCompany(const QString &company) {
    m_company = company;
    m_company_isSet = true;
}

bool OAILdap_mapping_user::is_company_Set() const{
    return m_company_isSet;
}

bool OAILdap_mapping_user::is_company_Valid() const{
    return m_company_isValid;
}

QDateTime OAILdap_mapping_user::getCreatedAt() const {
    return m_created_at;
}
void OAILdap_mapping_user::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAILdap_mapping_user::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAILdap_mapping_user::is_created_at_Valid() const{
    return m_created_at_isValid;
}

qint32 OAILdap_mapping_user::getDiskUsage() const {
    return m_disk_usage;
}
void OAILdap_mapping_user::setDiskUsage(const qint32 &disk_usage) {
    m_disk_usage = disk_usage;
    m_disk_usage_isSet = true;
}

bool OAILdap_mapping_user::is_disk_usage_Set() const{
    return m_disk_usage_isSet;
}

bool OAILdap_mapping_user::is_disk_usage_Valid() const{
    return m_disk_usage_isValid;
}

QString OAILdap_mapping_user::getEmail() const {
    return m_email;
}
void OAILdap_mapping_user::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAILdap_mapping_user::is_email_Set() const{
    return m_email_isSet;
}

bool OAILdap_mapping_user::is_email_Valid() const{
    return m_email_isValid;
}

QString OAILdap_mapping_user::getEventsUrl() const {
    return m_events_url;
}
void OAILdap_mapping_user::setEventsUrl(const QString &events_url) {
    m_events_url = events_url;
    m_events_url_isSet = true;
}

bool OAILdap_mapping_user::is_events_url_Set() const{
    return m_events_url_isSet;
}

bool OAILdap_mapping_user::is_events_url_Valid() const{
    return m_events_url_isValid;
}

qint32 OAILdap_mapping_user::getFollowers() const {
    return m_followers;
}
void OAILdap_mapping_user::setFollowers(const qint32 &followers) {
    m_followers = followers;
    m_followers_isSet = true;
}

bool OAILdap_mapping_user::is_followers_Set() const{
    return m_followers_isSet;
}

bool OAILdap_mapping_user::is_followers_Valid() const{
    return m_followers_isValid;
}

QString OAILdap_mapping_user::getFollowersUrl() const {
    return m_followers_url;
}
void OAILdap_mapping_user::setFollowersUrl(const QString &followers_url) {
    m_followers_url = followers_url;
    m_followers_url_isSet = true;
}

bool OAILdap_mapping_user::is_followers_url_Set() const{
    return m_followers_url_isSet;
}

bool OAILdap_mapping_user::is_followers_url_Valid() const{
    return m_followers_url_isValid;
}

qint32 OAILdap_mapping_user::getFollowing() const {
    return m_following;
}
void OAILdap_mapping_user::setFollowing(const qint32 &following) {
    m_following = following;
    m_following_isSet = true;
}

bool OAILdap_mapping_user::is_following_Set() const{
    return m_following_isSet;
}

bool OAILdap_mapping_user::is_following_Valid() const{
    return m_following_isValid;
}

QString OAILdap_mapping_user::getFollowingUrl() const {
    return m_following_url;
}
void OAILdap_mapping_user::setFollowingUrl(const QString &following_url) {
    m_following_url = following_url;
    m_following_url_isSet = true;
}

bool OAILdap_mapping_user::is_following_url_Set() const{
    return m_following_url_isSet;
}

bool OAILdap_mapping_user::is_following_url_Valid() const{
    return m_following_url_isValid;
}

QString OAILdap_mapping_user::getGistsUrl() const {
    return m_gists_url;
}
void OAILdap_mapping_user::setGistsUrl(const QString &gists_url) {
    m_gists_url = gists_url;
    m_gists_url_isSet = true;
}

bool OAILdap_mapping_user::is_gists_url_Set() const{
    return m_gists_url_isSet;
}

bool OAILdap_mapping_user::is_gists_url_Valid() const{
    return m_gists_url_isValid;
}

QString OAILdap_mapping_user::getGravatarId() const {
    return m_gravatar_id;
}
void OAILdap_mapping_user::setGravatarId(const QString &gravatar_id) {
    m_gravatar_id = gravatar_id;
    m_gravatar_id_isSet = true;
}

bool OAILdap_mapping_user::is_gravatar_id_Set() const{
    return m_gravatar_id_isSet;
}

bool OAILdap_mapping_user::is_gravatar_id_Valid() const{
    return m_gravatar_id_isValid;
}

bool OAILdap_mapping_user::isHireable() const {
    return m_hireable;
}
void OAILdap_mapping_user::setHireable(const bool &hireable) {
    m_hireable = hireable;
    m_hireable_isSet = true;
}

bool OAILdap_mapping_user::is_hireable_Set() const{
    return m_hireable_isSet;
}

bool OAILdap_mapping_user::is_hireable_Valid() const{
    return m_hireable_isValid;
}

QString OAILdap_mapping_user::getHtmlUrl() const {
    return m_html_url;
}
void OAILdap_mapping_user::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAILdap_mapping_user::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAILdap_mapping_user::is_html_url_Valid() const{
    return m_html_url_isValid;
}

qint32 OAILdap_mapping_user::getId() const {
    return m_id;
}
void OAILdap_mapping_user::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAILdap_mapping_user::is_id_Set() const{
    return m_id_isSet;
}

bool OAILdap_mapping_user::is_id_Valid() const{
    return m_id_isValid;
}

QString OAILdap_mapping_user::getLdapDn() const {
    return m_ldap_dn;
}
void OAILdap_mapping_user::setLdapDn(const QString &ldap_dn) {
    m_ldap_dn = ldap_dn;
    m_ldap_dn_isSet = true;
}

bool OAILdap_mapping_user::is_ldap_dn_Set() const{
    return m_ldap_dn_isSet;
}

bool OAILdap_mapping_user::is_ldap_dn_Valid() const{
    return m_ldap_dn_isValid;
}

QString OAILdap_mapping_user::getLocation() const {
    return m_location;
}
void OAILdap_mapping_user::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAILdap_mapping_user::is_location_Set() const{
    return m_location_isSet;
}

bool OAILdap_mapping_user::is_location_Valid() const{
    return m_location_isValid;
}

QString OAILdap_mapping_user::getLogin() const {
    return m_login;
}
void OAILdap_mapping_user::setLogin(const QString &login) {
    m_login = login;
    m_login_isSet = true;
}

bool OAILdap_mapping_user::is_login_Set() const{
    return m_login_isSet;
}

bool OAILdap_mapping_user::is_login_Valid() const{
    return m_login_isValid;
}

QString OAILdap_mapping_user::getName() const {
    return m_name;
}
void OAILdap_mapping_user::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILdap_mapping_user::is_name_Set() const{
    return m_name_isSet;
}

bool OAILdap_mapping_user::is_name_Valid() const{
    return m_name_isValid;
}

QString OAILdap_mapping_user::getNodeId() const {
    return m_node_id;
}
void OAILdap_mapping_user::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAILdap_mapping_user::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAILdap_mapping_user::is_node_id_Valid() const{
    return m_node_id_isValid;
}

QString OAILdap_mapping_user::getOrganizationsUrl() const {
    return m_organizations_url;
}
void OAILdap_mapping_user::setOrganizationsUrl(const QString &organizations_url) {
    m_organizations_url = organizations_url;
    m_organizations_url_isSet = true;
}

bool OAILdap_mapping_user::is_organizations_url_Set() const{
    return m_organizations_url_isSet;
}

bool OAILdap_mapping_user::is_organizations_url_Valid() const{
    return m_organizations_url_isValid;
}

qint32 OAILdap_mapping_user::getOwnedPrivateRepos() const {
    return m_owned_private_repos;
}
void OAILdap_mapping_user::setOwnedPrivateRepos(const qint32 &owned_private_repos) {
    m_owned_private_repos = owned_private_repos;
    m_owned_private_repos_isSet = true;
}

bool OAILdap_mapping_user::is_owned_private_repos_Set() const{
    return m_owned_private_repos_isSet;
}

bool OAILdap_mapping_user::is_owned_private_repos_Valid() const{
    return m_owned_private_repos_isValid;
}

OAILdap_mapping_user_plan OAILdap_mapping_user::getPlan() const {
    return m_plan;
}
void OAILdap_mapping_user::setPlan(const OAILdap_mapping_user_plan &plan) {
    m_plan = plan;
    m_plan_isSet = true;
}

bool OAILdap_mapping_user::is_plan_Set() const{
    return m_plan_isSet;
}

bool OAILdap_mapping_user::is_plan_Valid() const{
    return m_plan_isValid;
}

qint32 OAILdap_mapping_user::getPrivateGists() const {
    return m_private_gists;
}
void OAILdap_mapping_user::setPrivateGists(const qint32 &private_gists) {
    m_private_gists = private_gists;
    m_private_gists_isSet = true;
}

bool OAILdap_mapping_user::is_private_gists_Set() const{
    return m_private_gists_isSet;
}

bool OAILdap_mapping_user::is_private_gists_Valid() const{
    return m_private_gists_isValid;
}

qint32 OAILdap_mapping_user::getPublicGists() const {
    return m_public_gists;
}
void OAILdap_mapping_user::setPublicGists(const qint32 &public_gists) {
    m_public_gists = public_gists;
    m_public_gists_isSet = true;
}

bool OAILdap_mapping_user::is_public_gists_Set() const{
    return m_public_gists_isSet;
}

bool OAILdap_mapping_user::is_public_gists_Valid() const{
    return m_public_gists_isValid;
}

qint32 OAILdap_mapping_user::getPublicRepos() const {
    return m_public_repos;
}
void OAILdap_mapping_user::setPublicRepos(const qint32 &public_repos) {
    m_public_repos = public_repos;
    m_public_repos_isSet = true;
}

bool OAILdap_mapping_user::is_public_repos_Set() const{
    return m_public_repos_isSet;
}

bool OAILdap_mapping_user::is_public_repos_Valid() const{
    return m_public_repos_isValid;
}

QString OAILdap_mapping_user::getReceivedEventsUrl() const {
    return m_received_events_url;
}
void OAILdap_mapping_user::setReceivedEventsUrl(const QString &received_events_url) {
    m_received_events_url = received_events_url;
    m_received_events_url_isSet = true;
}

bool OAILdap_mapping_user::is_received_events_url_Set() const{
    return m_received_events_url_isSet;
}

bool OAILdap_mapping_user::is_received_events_url_Valid() const{
    return m_received_events_url_isValid;
}

QString OAILdap_mapping_user::getReposUrl() const {
    return m_repos_url;
}
void OAILdap_mapping_user::setReposUrl(const QString &repos_url) {
    m_repos_url = repos_url;
    m_repos_url_isSet = true;
}

bool OAILdap_mapping_user::is_repos_url_Set() const{
    return m_repos_url_isSet;
}

bool OAILdap_mapping_user::is_repos_url_Valid() const{
    return m_repos_url_isValid;
}

bool OAILdap_mapping_user::isSiteAdmin() const {
    return m_site_admin;
}
void OAILdap_mapping_user::setSiteAdmin(const bool &site_admin) {
    m_site_admin = site_admin;
    m_site_admin_isSet = true;
}

bool OAILdap_mapping_user::is_site_admin_Set() const{
    return m_site_admin_isSet;
}

bool OAILdap_mapping_user::is_site_admin_Valid() const{
    return m_site_admin_isValid;
}

QString OAILdap_mapping_user::getStarredUrl() const {
    return m_starred_url;
}
void OAILdap_mapping_user::setStarredUrl(const QString &starred_url) {
    m_starred_url = starred_url;
    m_starred_url_isSet = true;
}

bool OAILdap_mapping_user::is_starred_url_Set() const{
    return m_starred_url_isSet;
}

bool OAILdap_mapping_user::is_starred_url_Valid() const{
    return m_starred_url_isValid;
}

QString OAILdap_mapping_user::getSubscriptionsUrl() const {
    return m_subscriptions_url;
}
void OAILdap_mapping_user::setSubscriptionsUrl(const QString &subscriptions_url) {
    m_subscriptions_url = subscriptions_url;
    m_subscriptions_url_isSet = true;
}

bool OAILdap_mapping_user::is_subscriptions_url_Set() const{
    return m_subscriptions_url_isSet;
}

bool OAILdap_mapping_user::is_subscriptions_url_Valid() const{
    return m_subscriptions_url_isValid;
}

QDateTime OAILdap_mapping_user::getSuspendedAt() const {
    return m_suspended_at;
}
void OAILdap_mapping_user::setSuspendedAt(const QDateTime &suspended_at) {
    m_suspended_at = suspended_at;
    m_suspended_at_isSet = true;
}

bool OAILdap_mapping_user::is_suspended_at_Set() const{
    return m_suspended_at_isSet;
}

bool OAILdap_mapping_user::is_suspended_at_Valid() const{
    return m_suspended_at_isValid;
}

qint32 OAILdap_mapping_user::getTotalPrivateRepos() const {
    return m_total_private_repos;
}
void OAILdap_mapping_user::setTotalPrivateRepos(const qint32 &total_private_repos) {
    m_total_private_repos = total_private_repos;
    m_total_private_repos_isSet = true;
}

bool OAILdap_mapping_user::is_total_private_repos_Set() const{
    return m_total_private_repos_isSet;
}

bool OAILdap_mapping_user::is_total_private_repos_Valid() const{
    return m_total_private_repos_isValid;
}

QString OAILdap_mapping_user::getTwitterUsername() const {
    return m_twitter_username;
}
void OAILdap_mapping_user::setTwitterUsername(const QString &twitter_username) {
    m_twitter_username = twitter_username;
    m_twitter_username_isSet = true;
}

bool OAILdap_mapping_user::is_twitter_username_Set() const{
    return m_twitter_username_isSet;
}

bool OAILdap_mapping_user::is_twitter_username_Valid() const{
    return m_twitter_username_isValid;
}

bool OAILdap_mapping_user::isTwoFactorAuthentication() const {
    return m_two_factor_authentication;
}
void OAILdap_mapping_user::setTwoFactorAuthentication(const bool &two_factor_authentication) {
    m_two_factor_authentication = two_factor_authentication;
    m_two_factor_authentication_isSet = true;
}

bool OAILdap_mapping_user::is_two_factor_authentication_Set() const{
    return m_two_factor_authentication_isSet;
}

bool OAILdap_mapping_user::is_two_factor_authentication_Valid() const{
    return m_two_factor_authentication_isValid;
}

QString OAILdap_mapping_user::getType() const {
    return m_type;
}
void OAILdap_mapping_user::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAILdap_mapping_user::is_type_Set() const{
    return m_type_isSet;
}

bool OAILdap_mapping_user::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAILdap_mapping_user::getUpdatedAt() const {
    return m_updated_at;
}
void OAILdap_mapping_user::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAILdap_mapping_user::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAILdap_mapping_user::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAILdap_mapping_user::getUrl() const {
    return m_url;
}
void OAILdap_mapping_user::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAILdap_mapping_user::is_url_Set() const{
    return m_url_isSet;
}

bool OAILdap_mapping_user::is_url_Valid() const{
    return m_url_isValid;
}

bool OAILdap_mapping_user::isSet() const {
...
bool OAILdap_mapping_user::isValid() const {
