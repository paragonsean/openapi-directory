...
> List&lt;CodeScanningAlertItems&gt; codeScanningListAlertsForRepo(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<CodeScanningAlertItems> result = apiInstance.codeScanningListAlertsForRepo(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state);
      System.out.println(result);
    } catch (ApiException e) {
