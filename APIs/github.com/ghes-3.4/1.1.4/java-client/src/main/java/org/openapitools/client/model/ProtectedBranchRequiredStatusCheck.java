...
public class ProtectedBranchRequiredStatusCheck {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checks, protectedBranchRequiredStatusCheck.checks) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checks, contexts, contextsUrl, enforcementLevel, strict, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraychecks.size(); i++) {
        ProtectedBranchRequiredStatusCheckChecksInner.validateJsonElement(jsonArraychecks.get(i));
      };
