...
import org.openapitools.client.model.OrgsListCustomRoles200Response;
...
public class OrgsApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#check-organization-membership-for-a-user">Check organization membership for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#check-public-organization-membership-for-a-user">Check public organization membership for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#convert-an-organization-member-to-outside-collaborator">Convert an organization member to outside collaborator Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#create-an-organization-webhook">Create an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#delete-an-organization-webhook">Delete an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-an-organization">Get an organization Documentation</a>
     */
     ...
     * @param org The organization name. The name is not case sensitive. (required)
     * @param phrase A search phrase. For more information, see [Searching the audit log](https://docs.github.com/enterprise-server@3.4/github/setting-up-and-managing-organizations-and-teams/reviewing-the-audit-log-for-your-organization#searching-the-audit-log). (optional)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-audit-log">Get the audit log for an organization Documentation</a>
     */
    public okhttp3.Call orgsGetAuditLogCall(String org, String phrase, String include, String after, String before, String order, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call orgsGetAuditLogValidateBeforeCall(String org, String phrase, String include, String after, String before, String order, Integer perPage, Integer page, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'org' is set
        if (org == null) {
            throw new ApiException("Missing the required parameter 'org' when calling orgsGetAuditLog(Async)");
        }

        return orgsGetAuditLogCall(org, phrase, include, after, before, order, perPage, page, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-audit-log">Get the audit log for an organization Documentation</a>
     */
    public List<AuditLogEvent> orgsGetAuditLog(String org, String phrase, String include, String after, String before, String order, Integer perPage, Integer page) throws ApiException {
        ApiResponse<List<AuditLogEvent>> localVarResp = orgsGetAuditLogWithHttpInfo(org, phrase, include, after, before, order, perPage, page);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-audit-log">Get the audit log for an organization Documentation</a>
     */
    public ApiResponse<List<AuditLogEvent>> orgsGetAuditLogWithHttpInfo(String org, String phrase, String include, String after, String before, String order, Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = orgsGetAuditLogValidateBeforeCall(org, phrase, include, after, before, order, perPage, page, null);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-audit-log">Get the audit log for an organization Documentation</a>
     */
    public okhttp3.Call orgsGetAuditLogAsync(String org, String phrase, String include, String after, String before, String order, Integer perPage, Integer page, final ApiCallback<List<AuditLogEvent>> _callback) throws ApiException {

        okhttp3.Call localVarCall = orgsGetAuditLogValidateBeforeCall(org, phrase, include, after, before, order, perPage, page, _callback);
        Type localVarReturnType = new TypeToken<List<AuditLogEvent>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-an-organization-membership-for-the-authenticated-user">Get an organization membership for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-organization-membership-for-a-user">Get organization membership for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-an-organization-webhook">Get an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-a-webhook-configuration-for-an-organization">Get a webhook configuration for an organization Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#get-a-webhook-delivery-for-an-organization-webhook">Get a webhook delivery for an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organizations">List organizations Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-app-installations-for-an-organization">List app installations for an organization Documentation</a>
     */
    ...
    /**
     * Build call for orgsListCustomRoles
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Response - list of custom role names </td><td>  -  </td></tr>
     </table>
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-custom-repository-roles-in-an-organization">List custom repository roles in an organization Documentation</a>
     */
    public okhttp3.Call orgsListCustomRolesCall(String organizationId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/organizations/{organization_id}/custom_roles"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call orgsListCustomRolesValidateBeforeCall(String organizationId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling orgsListCustomRoles(Async)");
        }

        return orgsListCustomRolesCall(organizationId, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-custom-repository-roles-in-an-organization">List custom repository roles in an organization Documentation</a>
     */
    public OrgsListCustomRoles200Response orgsListCustomRoles(String organizationId) throws ApiException {
        ApiResponse<OrgsListCustomRoles200Response> localVarResp = orgsListCustomRolesWithHttpInfo(organizationId);
        return localVarResp.getData();
    }
     ...
     * List the custom repository roles available in this organization. In order to see custom repository roles in an organization, the authenticated user must be an organization owner.  To use this endpoint the authenticated user must be an administrator for the organization or of an repository of the organization and must use an access token with &#x60;admin:org repo&#x60; scope. GitHub Apps must have the &#x60;organization_custom_roles:read&#x60; organization permission to use this endpoint.  For more information on custom repository roles, see \&quot;[About custom repository roles](https://docs.github.com/enterprise-server@3.4/organizations/managing-peoples-access-to-your-organization-with-roles/about-custom-repository-roles).\&quot;
     * @param organizationId The unique identifier of the organization. (required)
     * @return ApiResponse&lt;OrgsListCustomRoles200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-custom-repository-roles-in-an-organization">List custom repository roles in an organization Documentation</a>
     */
    public ApiResponse<OrgsListCustomRoles200Response> orgsListCustomRolesWithHttpInfo(String organizationId) throws ApiException {
        okhttp3.Call localVarCall = orgsListCustomRolesValidateBeforeCall(organizationId, null);
        Type localVarReturnType = new TypeToken<OrgsListCustomRoles200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List custom repository roles in an organization (asynchronously)
     * List the custom repository roles available in this organization. In order to see custom repository roles in an organization, the authenticated user must be an organization owner.  To use this endpoint the authenticated user must be an administrator for the organization or of an repository of the organization and must use an access token with &#x60;admin:org repo&#x60; scope. GitHub Apps must have the &#x60;organization_custom_roles:read&#x60; organization permission to use this endpoint.  For more information on custom repository roles, see \&quot;[About custom repository roles](https://docs.github.com/enterprise-server@3.4/organizations/managing-peoples-access-to-your-organization-with-roles/about-custom-repository-roles).\&quot;
     * @param organizationId The unique identifier of the organization. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-custom-repository-roles-in-an-organization">List custom repository roles in an organization Documentation</a>
     */
    public okhttp3.Call orgsListCustomRolesAsync(String organizationId, final ApiCallback<OrgsListCustomRoles200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = orgsListCustomRolesValidateBeforeCall(organizationId, _callback);
        Type localVarReturnType = new TypeToken<OrgsListCustomRoles200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organizations-for-the-authenticated-user">List organizations for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organizations-for-a-user">List organizations for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organization-members">List organization members Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organization-memberships-for-the-authenticated-user">List organization memberships for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-outside-collaborators-for-an-organization">List outside collaborators for an organization Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-public-organization-members">List public organization members Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-deliveries-for-an-organization-webhook">List deliveries for an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#list-organization-webhooks">List organization webhooks Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#ping-an-organization-webhook">Ping an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#redeliver-a-delivery-for-an-organization-webhook">Redeliver a delivery for an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-an-organization-member">Remove an organization member Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-organization-membership-for-a-user">Remove organization membership for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-outside-collaborator-from-an-organization">Remove outside collaborator from an organization Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#remove-public-organization-membership-for-the-authenticated-user">Remove public organization membership for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#set-organization-membership-for-a-user">Set organization membership for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#set-public-organization-membership-for-the-authenticated-user">Set public organization membership for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-an-organization">Update an organization Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-an-organization-membership-for-the-authenticated-user">Update an organization membership for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-an-organization-webhook">Update an organization webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/orgs#update-a-webhook-configuration-for-an-organization">Update a webhook configuration for an organization Documentation</a>
     */
