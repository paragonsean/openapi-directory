...
public class CodeScanningApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#delete-a-code-scanning-analysis-from-a-repository">Delete a code scanning analysis from a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#get-a-code-scanning-alert">Get a code scanning alert Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#get-a-code-scanning-analysis-for-a-repository">Get a code scanning analysis for a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-recent-code-scanning-analyses-for-a-repository">Get information about a SARIF upload Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-instances-of-a-code-scanning-alert">List instances of a code scanning alert Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListAlertsForRepoCall(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call codeScanningListAlertsForRepoValidateBeforeCall(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'owner' is set
        if (owner == null) {
        ...
        return codeScanningListAlertsForRepoCall(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public List<CodeScanningAlertItems> codeScanningListAlertsForRepo(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state) throws ApiException {
        ApiResponse<List<CodeScanningAlertItems>> localVarResp = codeScanningListAlertsForRepoWithHttpInfo(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public ApiResponse<List<CodeScanningAlertItems>> codeScanningListAlertsForRepoWithHttpInfo(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state) throws ApiException {
        okhttp3.Call localVarCall = codeScanningListAlertsForRepoValidateBeforeCall(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, null);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-alerts-for-a-repository">List code scanning alerts for a repository Documentation</a>
     */
    public okhttp3.Call codeScanningListAlertsForRepoAsync(String owner, String repo, String toolName, String toolGuid, Integer page, Integer perPage, String ref, String direction, String sort, CodeScanningAlertState state, final ApiCallback<List<CodeScanningAlertItems>> _callback) throws ApiException {

        okhttp3.Call localVarCall = codeScanningListAlertsForRepoValidateBeforeCall(owner, repo, toolName, toolGuid, page, perPage, ref, direction, sort, state, _callback);
        Type localVarReturnType = new TypeToken<List<CodeScanningAlertItems>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#list-code-scanning-analyses-for-a-repository">List code scanning analyses for a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#update-a-code-scanning-alert">Update a code scanning alert Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/code-scanning#upload-a-sarif-file">Upload an analysis as SARIF data Documentation</a>
     */
