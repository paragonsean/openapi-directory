...
public class StatusCheckPolicy {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checks, statusCheckPolicy.checks) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checks, contexts, contextsUrl, strict, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraychecks.size(); i++) {
        StatusCheckPolicyChecksInner.validateJsonElement(jsonArraychecks.get(i));
      };
