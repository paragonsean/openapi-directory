...
public class ReposUpdateBranchProtectionRequestRequiredPullRequestReviews {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bypassPullRequestAllowances, reposUpdateBranchProtectionRequestRequiredPullRequestReviews.bypassPullRequestAllowances) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bypassPullRequestAllowances, dismissStaleReviews, dismissalRestrictions, requireCodeOwnerReviews, requiredApprovingReviewCount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("bypass_pull_request_allowances") != null && !jsonObj.get("bypass_pull_request_allowances").isJsonNull()) {
        ReposUpdateBranchProtectionRequestRequiredPullRequestReviewsBypassPullRequestAllowances.validateJsonElement(jsonObj.get("bypass_pull_request_allowances"));
      }
