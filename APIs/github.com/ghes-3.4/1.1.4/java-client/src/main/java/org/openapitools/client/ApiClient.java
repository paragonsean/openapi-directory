...
public class ApiClient {
    ...
    private String basePath = "https://github.com";
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        ...
        put("protocol", new ServerVariable(
          "Self-hosted Enterprise Server or Enterprise Cloud protocol",
          "http",
          new HashSet<String>(
          )
        ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://github.com
