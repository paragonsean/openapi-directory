...
public class BranchRestrictionPolicyUsersInner {
  ...
  public BranchRestrictionPolicyUsersInner() {
  }
  ...
  public BranchRestrictionPolicyUsersInner id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatarUrl, branchRestrictionPolicyUsersInner.avatarUrl) &&
        ...
        Objects.equals(this.login, branchRestrictionPolicyUsersInner.login) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to BranchRestrictionPolicyUsersInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BranchRestrictionPolicyUsersInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BranchRestrictionPolicyUsersInner is not found in the empty JSON string", BranchRestrictionPolicyUsersInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchRestrictionPolicyUsersInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BranchRestrictionPolicyUsersInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BranchRestrictionPolicyUsersInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BranchRestrictionPolicyUsersInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BranchRestrictionPolicyUsersInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BranchRestrictionPolicyUsersInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BranchRestrictionPolicyUsersInner>() {
           @Override
           public void write(JsonWriter out, BranchRestrictionPolicyUsersInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BranchRestrictionPolicyUsersInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BranchRestrictionPolicyUsersInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BranchRestrictionPolicyUsersInner
   * @throws IOException if the JSON string is invalid with respect to BranchRestrictionPolicyUsersInner
   */
  public static BranchRestrictionPolicyUsersInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BranchRestrictionPolicyUsersInner.class);
  }

  /**
   * Convert an instance of BranchRestrictionPolicyUsersInner to an JSON string
   *
   * @return JSON string
   */
