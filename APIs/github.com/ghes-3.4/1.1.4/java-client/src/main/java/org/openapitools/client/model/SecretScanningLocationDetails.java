...
public class SecretScanningLocationDetails extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<SecretScanningLocationDetails>() {
                ...
                public void write(JsonWriter out, SecretScanningLocationDetails value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof SecretScanningLocationCommit) {
                        JsonElement element = adapterSecretScanningLocationCommit.toJsonTree((SecretScanningLocationCommit)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: SecretScanningLocationCommit");
                }
                ...
                public SecretScanningLocationDetails read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        SecretScanningLocationCommit.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for SecretScanningLocationDetails: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SecretScanningLocationDetails(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("SecretScanningLocationCommit", SecretScanningLocationCommit.class);
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be SecretScanningLocationCommit");
    }
     ...
     * SecretScanningLocationCommit
     *
     * @return The actual instance (SecretScanningLocationCommit)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to SecretScanningLocationDetails
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for SecretScanningLocationDetails with oneOf schemas: SecretScanningLocationCommit. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
