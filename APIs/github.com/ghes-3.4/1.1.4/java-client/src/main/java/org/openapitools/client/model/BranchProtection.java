...
public class BranchProtection {
  ...
  private BranchProtectionAllowDeletions blockCreations;
  ...
  public BranchProtection blockCreations(BranchProtectionAllowDeletions blockCreations) {
   ...
   */
  @javax.annotation.Nullable
  public BranchProtectionAllowDeletions getBlockCreations() {
    return blockCreations;
  }

  public void setBlockCreations(BranchProtectionAllowDeletions blockCreations) {
    this.blockCreations = blockCreations;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowDeletions, allowForcePushes, blockCreations, enabled, enforceAdmins, name, protectionUrl, requiredConversationResolution, requiredLinearHistory, requiredPullRequestReviews, requiredSignatures, requiredStatusChecks, restrictions, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("block_creations") != null && !jsonObj.get("block_creations").isJsonNull()) {
        BranchProtectionAllowDeletions.validateJsonElement(jsonObj.get("block_creations"));
      }
      ...
      if (jsonObj.get("required_status_checks") != null && !jsonObj.get("required_status_checks").isJsonNull()) {
        ProtectedBranchRequiredStatusCheck.validateJsonElement(jsonObj.get("required_status_checks"));
      }
