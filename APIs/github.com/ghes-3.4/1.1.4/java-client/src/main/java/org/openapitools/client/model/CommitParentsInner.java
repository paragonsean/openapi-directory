...
public class CommitParentsInner {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.htmlUrl, commitParentsInner.htmlUrl) &&
        Objects.equals(this.sha, commitParentsInner.sha) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommitParentsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommitParentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommitParentsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommitParentsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
