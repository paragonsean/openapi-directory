...
public class ReposUpdateBranchProtectionRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowDeletions, allowForcePushes, blockCreations, enforceAdmins, requiredConversationResolution, requiredLinearHistory, requiredPullRequestReviews, requiredStatusChecks, restrictions);
  }
