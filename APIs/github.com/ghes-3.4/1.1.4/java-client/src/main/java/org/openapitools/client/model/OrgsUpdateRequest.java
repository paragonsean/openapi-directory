...
public class OrgsUpdateRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingEmail, blog, company, defaultRepositoryPermission, description, email, hasOrganizationProjects, hasRepositoryProjects, location, membersAllowedRepositoryCreationType, membersCanCreateInternalRepositories, membersCanCreatePages, membersCanCreatePrivateRepositories, membersCanCreatePublicRepositories, membersCanCreateRepositories, membersCanForkPrivateRepositories, name, twitterUsername);
  }
