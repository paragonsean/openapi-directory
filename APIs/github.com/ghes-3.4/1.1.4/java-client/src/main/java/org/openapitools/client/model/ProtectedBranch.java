...
public class ProtectedBranch {
  ...
  private ProtectedBranchAllowDeletions blockCreations;
  ...
  public ProtectedBranch blockCreations(ProtectedBranchAllowDeletions blockCreations) {
   ...
   */
  @javax.annotation.Nullable
  public ProtectedBranchAllowDeletions getBlockCreations() {
    return blockCreations;
  }

  public void setBlockCreations(ProtectedBranchAllowDeletions blockCreations) {
    this.blockCreations = blockCreations;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowDeletions, allowForcePushes, blockCreations, enforceAdmins, requiredConversationResolution, requiredLinearHistory, requiredPullRequestReviews, requiredSignatures, requiredStatusChecks, restrictions, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("block_creations") != null && !jsonObj.get("block_creations").isJsonNull()) {
        ProtectedBranchAllowDeletions.validateJsonElement(jsonObj.get("block_creations"));
      }
