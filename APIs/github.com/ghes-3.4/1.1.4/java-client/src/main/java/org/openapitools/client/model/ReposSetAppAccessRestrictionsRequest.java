...
public class ReposSetAppAccessRestrictionsRequest extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ReposSetAppAccessRestrictionsRequest>() {
                ...
                public void write(JsonWriter out, ReposSetAppAccessRestrictionsRequest value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof ReposSetAppAccessRestrictionsRequestOneOf) {
                        JsonElement element = adapterReposSetAppAccessRestrictionsRequestOneOf.toJsonTree((ReposSetAppAccessRestrictionsRequestOneOf)value.getActualInstance());
                ...
                public ReposSetAppAccessRestrictionsRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ReposSetAppAccessRestrictionsRequestOneOf.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for ReposSetAppAccessRestrictionsRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ReposSetAppAccessRestrictionsRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ReposSetAppAccessRestrictionsRequestOneOf", ReposSetAppAccessRestrictionsRequestOneOf.class);
     ...
     * @throws IOException if the JSON Element is invalid with respect to ReposSetAppAccessRestrictionsRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ReposSetAppAccessRestrictionsRequest with oneOf schemas: List<String>, ReposSetAppAccessRestrictionsRequestOneOf. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
