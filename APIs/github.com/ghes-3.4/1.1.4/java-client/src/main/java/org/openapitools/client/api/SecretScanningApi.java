...
public class SecretScanningApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#get-a-secret-scanning-alert">Get a secret scanning alert Documentation</a>
     */
     ...
     * @param before A cursor, as given in the [Link header](https://docs.github.com/enterprise-server@3.4/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for results before this cursor. (optional)
     * @param after A cursor, as given in the [Link header](https://docs.github.com/enterprise-server@3.4/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for results after this cursor. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-enterprise">List secret scanning alerts for an enterprise Documentation</a>
     */
    public okhttp3.Call secretScanningListAlertsForEnterpriseCall(String enterprise, String state, String secretType, String resolution, Integer perPage, String before, String after, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call secretScanningListAlertsForEnterpriseValidateBeforeCall(String enterprise, String state, String secretType, String resolution, Integer perPage, String before, String after, final ApiCallback _callback) throws ApiException {
        ...
        return secretScanningListAlertsForEnterpriseCall(enterprise, state, secretType, resolution, perPage, before, after, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-enterprise">List secret scanning alerts for an enterprise Documentation</a>
     */
    public List<OrganizationSecretScanningAlert> secretScanningListAlertsForEnterprise(String enterprise, String state, String secretType, String resolution, Integer perPage, String before, String after) throws ApiException {
        ApiResponse<List<OrganizationSecretScanningAlert>> localVarResp = secretScanningListAlertsForEnterpriseWithHttpInfo(enterprise, state, secretType, resolution, perPage, before, after);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-enterprise">List secret scanning alerts for an enterprise Documentation</a>
     */
    public ApiResponse<List<OrganizationSecretScanningAlert>> secretScanningListAlertsForEnterpriseWithHttpInfo(String enterprise, String state, String secretType, String resolution, Integer perPage, String before, String after) throws ApiException {
        okhttp3.Call localVarCall = secretScanningListAlertsForEnterpriseValidateBeforeCall(enterprise, state, secretType, resolution, perPage, before, after, null);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-enterprise">List secret scanning alerts for an enterprise Documentation</a>
     */
    public okhttp3.Call secretScanningListAlertsForEnterpriseAsync(String enterprise, String state, String secretType, String resolution, Integer perPage, String before, String after, final ApiCallback<List<OrganizationSecretScanningAlert>> _callback) throws ApiException {

        okhttp3.Call localVarCall = secretScanningListAlertsForEnterpriseValidateBeforeCall(enterprise, state, secretType, resolution, perPage, before, after, _callback);
        Type localVarReturnType = new TypeToken<List<OrganizationSecretScanningAlert>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-organization">List secret scanning alerts for an organization Documentation</a>
     */
    public okhttp3.Call secretScanningListAlertsForOrgCall(String org, String state, String secretType, String resolution, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call secretScanningListAlertsForOrgValidateBeforeCall(String org, String state, String secretType, String resolution, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'org' is set
        if (org == null) {
            throw new ApiException("Missing the required parameter 'org' when calling secretScanningListAlertsForOrg(Async)");
        }

        return secretScanningListAlertsForOrgCall(org, state, secretType, resolution, page, perPage, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-organization">List secret scanning alerts for an organization Documentation</a>
     */
    public List<OrganizationSecretScanningAlert> secretScanningListAlertsForOrg(String org, String state, String secretType, String resolution, Integer page, Integer perPage) throws ApiException {
        ApiResponse<List<OrganizationSecretScanningAlert>> localVarResp = secretScanningListAlertsForOrgWithHttpInfo(org, state, secretType, resolution, page, perPage);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-organization">List secret scanning alerts for an organization Documentation</a>
     */
    public ApiResponse<List<OrganizationSecretScanningAlert>> secretScanningListAlertsForOrgWithHttpInfo(String org, String state, String secretType, String resolution, Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = secretScanningListAlertsForOrgValidateBeforeCall(org, state, secretType, resolution, page, perPage, null);
        Type localVarReturnType = new TypeToken<List<OrganizationSecretScanningAlert>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-an-organization">List secret scanning alerts for an organization Documentation</a>
     */
    public okhttp3.Call secretScanningListAlertsForOrgAsync(String org, String state, String secretType, String resolution, Integer page, Integer perPage, final ApiCallback<List<OrganizationSecretScanningAlert>> _callback) throws ApiException {

        okhttp3.Call localVarCall = secretScanningListAlertsForOrgValidateBeforeCall(org, state, secretType, resolution, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<List<OrganizationSecretScanningAlert>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-secret-scanning-alerts-for-a-repository">List secret scanning alerts for a repository Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#list-locations-for-a-secret-scanning-alert">List locations for a secret scanning alert Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.4/rest/reference/secret-scanning#update-a-secret-scanning-alert">Update a secret scanning alert Documentation</a>
     */
