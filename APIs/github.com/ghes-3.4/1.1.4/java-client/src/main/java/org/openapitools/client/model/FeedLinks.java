...
public class FeedLinks {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currentUser, currentUserActor, currentUserOrganization, currentUserOrganizations, currentUserPublic, repositoryDiscussions, repositoryDiscussionsCategory, securityAdvisories, timeline, user);
  }
