...
public class PullRequestReview {
  ...
  public PullRequestReview links(PullRequestReviewLinks links) {
    this.links = links;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.links, pullRequestReview.links) &&
        ...
        Objects.equals(this.id, pullRequestReview.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, authorAssociation, body, bodyHtml, bodyText, commitId, htmlUrl, id, nodeId, pullRequestUrl, state, submittedAt, user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestReview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestReview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestReview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
