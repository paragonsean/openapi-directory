...
import ReposListCacheInfo200ResponseInner from '../model/ReposListCacheInfo200ResponseInner';
...
export default class ReposApi {
    ...
    */
     ...
     * @param {String} branch The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
    ...
    /**
     * Callback function to receive the result of the reposListCacheInfo operation.
     * @callback module:api/ReposApi~reposListCacheInfoCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ReposListCacheInfo200ResponseInner>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     * @param {module:api/ReposApi~reposListCacheInfoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ReposListCacheInfo200ResponseInner>}
     */
    reposListCacheInfo(owner, repo, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposListCacheInfo");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposListCacheInfo");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [ReposListCacheInfo200ResponseInner];
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/replicas/caches', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
