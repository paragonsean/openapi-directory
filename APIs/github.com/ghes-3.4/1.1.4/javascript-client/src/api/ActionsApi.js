...
export default class ActionsApi {
    ...
    */
     ...
     * @param {module:model/EnterpriseAdminListLabelsForSelfHostedRunnerForEnterprise200Response} data The data returned by the service call.
     ...
     * @param {module:model/EnterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest} enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest 
     ...
     * data is of type: {@link module:model/EnterpriseAdminListLabelsForSelfHostedRunnerForEnterprise200Response}
     */
    actionsAddCustomLabelsToSelfHostedRunnerForOrg(org, runnerId, enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest, callback) {
      let postBody = enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest;
      ...
      if (enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest === undefined || enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest === null) {
        throw new Error("Missing the required parameter 'enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest' when calling actionsAddCustomLabelsToSelfHostedRunnerForOrg");
      }
      ...
      let returnType = EnterpriseAdminListLabelsForSelfHostedRunnerForEnterprise200Response;
     ...
     * data is of type: {@link module:model/EnterpriseAdminListLabelsForSelfHostedRunnerForEnterprise200Response}
     */
    actionsAddCustomLabelsToSelfHostedRunnerForRepo(owner, repo, runnerId, enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest, callback) {
      let postBody = enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest;
      ...
      // verify the required parameter 'enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest' is set
      if (enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest === undefined || enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest === null) {
        throw new Error("Missing the required parameter 'enterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest' when calling actionsAddCustomLabelsToSelfHostedRunnerForRepo");
      }
     ...
     * @param {String} [event] Returns workflow run triggered by the event you specify. For example, `push`, `pull_request` or `issue`. For more information, see \"[Events that trigger workflows](https://docs.github.com/enterprise-server@3.4/actions/automating-your-workflow-with-github-actions/events-that-trigger-workflows).\"
     ...
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     * @param {Date} [created] Returns workflow runs created within the given date-time range. For more information on the syntax, see \"[Understanding the search syntax](https://docs.github.com/enterprise-server@3.4/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates).\"
     * @param {Boolean} [excludePullRequests = false)] If `true` pull requests are omitted from the response (empty array).
     ...
     * @param {String} org The organization name. The name is not case sensitive.
     * @param {Number} runnerId Unique identifier of the self-hosted runner.
     * @param {module:model/EnterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest} enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest 
     ...
     * data is of type: {@link module:model/EnterpriseAdminListLabelsForSelfHostedRunnerForEnterprise200Response}
     */
    actionsSetCustomLabelsForSelfHostedRunnerForOrg(org, runnerId, enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest, callback) {
      let postBody = enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest;
      // verify the required parameter 'org' is set
      if (org === undefined || org === null) {
      ...
      if (enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest === undefined || enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest === null) {
        throw new Error("Missing the required parameter 'enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest' when calling actionsSetCustomLabelsForSelfHostedRunnerForOrg");
      }
     ...
     * data is of type: {@link module:model/EnterpriseAdminListLabelsForSelfHostedRunnerForEnterprise200Response}
     */
    actionsSetCustomLabelsForSelfHostedRunnerForRepo(owner, repo, runnerId, enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest, callback) {
      let postBody = enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
      ...
      // verify the required parameter 'enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest' is set
      if (enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest === undefined || enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest === null) {
        throw new Error("Missing the required parameter 'enterpriseAdminSetCustomLabelsForSelfHostedRunnerForEnterpriseRequest' when calling actionsSetCustomLabelsForSelfHostedRunnerForRepo");
      }
