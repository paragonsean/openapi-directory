...
class ReactionsCreateForTeamDiscussionInOrgRequest {
     ...
     * @param content {module:model/ReactionsCreateForTeamDiscussionInOrgRequest.ContentEnum} The [reaction type](https://docs.github.com/enterprise-server@3.4/rest/reference/reactions#reaction-types) to add to the team discussion.
     */
    constructor(content) { 
