...
class Release {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('mentions_count')) {
                obj['mentions_count'] = ApiClient.convertToType(data['mentions_count'], 'Number');
            }
...
/**
 * @member {Number} mentions_count
 */
Release.prototype['mentions_count'] = undefined;
