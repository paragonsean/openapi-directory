...
class ReactionsCreateForReleaseRequest {
     ...
     * @param content {module:model/ReactionsCreateForReleaseRequest.ContentEnum} The [reaction type](https://docs.github.com/enterprise-server@3.4/rest/reference/reactions#reaction-types) to add to the release.
     */
    constructor(content) { 
