...
class Job {
     ...
     * @param url {String} 
     */
    constructor(checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id, labels, name, nodeId, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, status, url) { 
        
        Job.initialize(this, checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id, labels, name, nodeId, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, status, url);
    }
     ...
     */
    static initialize(obj, checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id, labels, name, nodeId, runId, runUrl, runnerGroupId, runnerGroupName, runnerId, runnerName, startedAt, status, url) { 
...
Job.RequiredProperties = ["check_run_url", "completed_at", "conclusion", "head_sha", "html_url", "id", "labels", "name", "node_id", "run_id", "run_url", "runner_group_id", "runner_group_name", "runner_id", "runner_name", "started_at", "status", "url"];
