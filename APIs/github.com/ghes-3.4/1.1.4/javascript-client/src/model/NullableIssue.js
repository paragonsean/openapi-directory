...
/**
 * The NullableIssue model module.
 * @module model/NullableIssue
 * @version 1.1.4
 */
class NullableIssue {
    /**
     * Constructs a new <code>NullableIssue</code>.
     * Issues are a great way to keep track of tasks, enhancements, and bugs for your projects.
     * @alias module:model/NullableIssue
    ...
    constructor(assignee, authorAssociation, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, repositoryUrl, state, title, updatedAt, url, user) { 
        ...
        NullableIssue.initialize(this, assignee, authorAssociation, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, repositoryUrl, state, title, updatedAt, url, user);
    }
    ...
    /**
     * Constructs a <code>NullableIssue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NullableIssue} obj Optional instance to populate.
     * @return {module:model/NullableIssue} The populated <code>NullableIssue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NullableIssue();
    ...
    /**
     * Validates the JSON data with respect to <code>NullableIssue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NullableIssue</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NullableIssue.RequiredProperties) {
...
NullableIssue.RequiredProperties = ["assignee", "author_association", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels", "labels_url", "locked", "milestone", "node_id", "number", "repository_url", "state", "title", "updated_at", "url", "user"];

/**
 * @member {String} active_lock_reason
 */
NullableIssue.prototype['active_lock_reason'] = undefined;

/**
 * @member {module:model/NullableSimpleUser} assignee
 */
NullableIssue.prototype['assignee'] = undefined;

/**
 * @member {Array.<module:model/SimpleUser>} assignees
 */
NullableIssue.prototype['assignees'] = undefined;

/**
 * @member {module:model/AuthorAssociation} author_association
 */
NullableIssue.prototype['author_association'] = undefined;

/**
 * Contents of the issue
 * @member {String} body
 */
NullableIssue.prototype['body'] = undefined;

/**
 * @member {String} body_html
 */
NullableIssue.prototype['body_html'] = undefined;

/**
 * @member {String} body_text
 */
NullableIssue.prototype['body_text'] = undefined;

/**
 * @member {Date} closed_at
 */
NullableIssue.prototype['closed_at'] = undefined;

/**
 * @member {module:model/NullableSimpleUser} closed_by
 */
NullableIssue.prototype['closed_by'] = undefined;

/**
 * @member {Number} comments
 */
NullableIssue.prototype['comments'] = undefined;

/**
 * @member {String} comments_url
 */
NullableIssue.prototype['comments_url'] = undefined;

/**
 * @member {Date} created_at
 */
NullableIssue.prototype['created_at'] = undefined;

/**
 * @member {Boolean} draft
 */
NullableIssue.prototype['draft'] = undefined;

/**
 * @member {String} events_url
 */
NullableIssue.prototype['events_url'] = undefined;

/**
 * @member {String} html_url
 */
NullableIssue.prototype['html_url'] = undefined;

/**
 * @member {Number} id
 */
NullableIssue.prototype['id'] = undefined;

/**
 * Labels to associate with this issue; pass one or more label names to replace the set of labels on this issue; send an empty array to clear all labels from the issue; note that the labels are silently dropped for users without push access to the repository
 * @member {Array.<module:model/IssueLabelsInner>} labels
 */
NullableIssue.prototype['labels'] = undefined;

/**
 * @member {String} labels_url
 */
NullableIssue.prototype['labels_url'] = undefined;

/**
 * @member {Boolean} locked
 */
NullableIssue.prototype['locked'] = undefined;

/**
 * @member {module:model/NullableMilestone} milestone
 */
NullableIssue.prototype['milestone'] = undefined;

/**
 * @member {String} node_id
 */
NullableIssue.prototype['node_id'] = undefined;

/**
 * Number uniquely identifying the issue within its repository
 * @member {Number} number
 */
NullableIssue.prototype['number'] = undefined;

/**
 * @member {module:model/NullableIntegration} performed_via_github_app
 */
NullableIssue.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/IssuePullRequest} pull_request
 */
NullableIssue.prototype['pull_request'] = undefined;

/**
 * @member {module:model/ReactionRollup} reactions
 */
NullableIssue.prototype['reactions'] = undefined;

/**
 * @member {module:model/Repository} repository
 */
NullableIssue.prototype['repository'] = undefined;

/**
 * @member {String} repository_url
 */
NullableIssue.prototype['repository_url'] = undefined;

/**
 * State of the issue; either 'open' or 'closed'
 * @member {String} state
 */
NullableIssue.prototype['state'] = undefined;

/**
 * The reason for the current state
 * @member {module:model/NullableIssue.StateReasonEnum} state_reason
 */
NullableIssue.prototype['state_reason'] = undefined;

/**
 * @member {String} timeline_url
 */
NullableIssue.prototype['timeline_url'] = undefined;

/**
 * Title of the issue
 * @member {String} title
 */
NullableIssue.prototype['title'] = undefined;

/**
 * @member {Date} updated_at
 */
NullableIssue.prototype['updated_at'] = undefined;

/**
 * URL for the issue
 * @member {String} url
 */
NullableIssue.prototype['url'] = undefined;

/**
 * @member {module:model/NullableSimpleUser} user
 */
NullableIssue.prototype['user'] = undefined;
