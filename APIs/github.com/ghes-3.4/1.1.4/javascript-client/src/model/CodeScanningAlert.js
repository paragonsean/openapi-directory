...
class CodeScanningAlert {
    ...
    constructor(createdAt, dismissedAt, dismissedBy, dismissedReason, htmlUrl, instancesUrl, mostRecentInstance, number, rule, state, tool, url) { 
        ...
        CodeScanningAlert.initialize(this, createdAt, dismissedAt, dismissedBy, dismissedReason, htmlUrl, instancesUrl, mostRecentInstance, number, rule, state, tool, url);
    }
...
CodeScanningAlert.RequiredProperties = ["created_at", "dismissed_at", "dismissed_by", "dismissed_reason", "html_url", "instances_url", "most_recent_instance", "number", "rule", "state", "tool", "url"];
 ...
 */
CodeScanningAlert.prototype['fixed_at'] = undefined;
 ...
 */
CodeScanningAlert.prototype['instances_url'] = undefined;

/**
 * @member {module:model/CodeScanningAlertInstance} most_recent_instance
 */
CodeScanningAlert.prototype['most_recent_instance'] = undefined;
 ...
 */
CodeScanningAlert.prototype['updated_at'] = undefined;
