...
class DemilestonedIssueEvent {
     ...
     * @param event {String} 
     * @param id {Number} 
     * @param milestone {module:model/DemilestonedIssueEventMilestone} 
     * @param nodeId {String} 
     * @param performedViaGithubApp {module:model/NullableIntegration} 
     * @param url {String} 
     */
    constructor(actor, commitId, commitUrl, createdAt, event, id, milestone, nodeId, performedViaGithubApp, url) { 
        
        DemilestonedIssueEvent.initialize(this, actor, commitId, commitUrl, createdAt, event, id, milestone, nodeId, performedViaGithubApp, url);
    }
     ...
     */
    static initialize(obj, actor, commitId, commitUrl, createdAt, event, id, milestone, nodeId, performedViaGithubApp, url) { 
        obj['actor'] = actor;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('milestone')) {
                obj['milestone'] = DemilestonedIssueEventMilestone.constructFromObject(data['milestone']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['milestone']) { // data not null
          DemilestonedIssueEventMilestone.validateJSON(data['milestone']);
        }
        // ensure the json data is a string
...
DemilestonedIssueEvent.RequiredProperties = ["actor", "commit_id", "commit_url", "created_at", "event", "id", "milestone", "node_id", "performed_via_github_app", "url"];
...
/**
 * @member {module:model/DemilestonedIssueEventMilestone} milestone
 */
