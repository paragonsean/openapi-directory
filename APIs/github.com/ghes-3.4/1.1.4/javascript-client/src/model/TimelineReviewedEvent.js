...
class TimelineReviewedEvent {
     ...
     */
    constructor(links, authorAssociation, body, commitId, event, htmlUrl, id, nodeId, pullRequestUrl, state, user) { 
        
        TimelineReviewedEvent.initialize(this, links, authorAssociation, body, commitId, event, htmlUrl, id, nodeId, pullRequestUrl, state, user);
    }
     ...
     */
    static initialize(obj, links, authorAssociation, body, commitId, event, htmlUrl, id, nodeId, pullRequestUrl, state, user) { 
        obj['_links'] = links;
...
TimelineReviewedEvent.RequiredProperties = ["_links", "author_association", "body", "commit_id", "event", "html_url", "id", "node_id", "pull_request_url", "state", "user"];
