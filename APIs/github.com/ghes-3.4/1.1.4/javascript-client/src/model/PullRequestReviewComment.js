...
class PullRequestReviewComment {
     ...
     * @param originalPosition {Number} The index of the original line in the diff to which the comment applies. This field is deprecated; use `original_line` instead.
     * @param path {String} The relative path of the file to which the comment applies.
     * @param position {Number} The line index in the diff to which the comment applies. This field is deprecated; use `line` instead.
