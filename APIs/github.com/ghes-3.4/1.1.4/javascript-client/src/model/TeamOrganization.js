...
class TeamOrganization {
    ...
    constructor(avatarUrl, createdAt, description, eventsUrl, followers, following, hasOrganizationProjects, hasRepositoryProjects, hooksUrl, htmlUrl, id, issuesUrl, login, membersUrl, nodeId, publicGists, publicMembersUrl, publicRepos, reposUrl, type, updatedAt, url) { 
        ...
        TeamOrganization.initialize(this, avatarUrl, createdAt, description, eventsUrl, followers, following, hasOrganizationProjects, hasRepositoryProjects, hooksUrl, htmlUrl, id, issuesUrl, login, membersUrl, nodeId, publicGists, publicMembersUrl, publicRepos, reposUrl, type, updatedAt, url);
    }
...
TeamOrganization.RequiredProperties = ["avatar_url", "created_at", "description", "events_url", "followers", "following", "has_organization_projects", "has_repository_projects", "hooks_url", "html_url", "id", "issues_url", "login", "members_url", "node_id", "public_gists", "public_members_url", "public_repos", "repos_url", "type", "updated_at", "url"];
