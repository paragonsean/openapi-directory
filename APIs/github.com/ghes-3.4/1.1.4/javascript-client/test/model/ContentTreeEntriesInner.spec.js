...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentTreeEntriesInner();
  });
  ...
  describe('ContentTreeEntriesInner', function() {
    it('should create an instance of ContentTreeEntriesInner', function() {
      // uncomment below and update the code to test ContentTreeEntriesInner
      //var instance = new GitHubV3RestApi.ContentTreeEntriesInner();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentTreeEntriesInner);
    });
