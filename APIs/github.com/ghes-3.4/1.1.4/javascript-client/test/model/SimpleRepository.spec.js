...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.SimpleRepository();
  });
  ...
  describe('SimpleRepository', function() {
    it('should create an instance of SimpleRepository', function() {
      // uncomment below and update the code to test SimpleRepository
      //var instance = new GitHubV3RestApi.SimpleRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.SimpleRepository);
    });
