...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GlobalHookConfig();
  });
  ...
  describe('GlobalHookConfig', function() {
    it('should create an instance of GlobalHookConfig', function() {
      // uncomment below and update the code to test GlobalHookConfig
      //var instance = new GitHubV3RestApi.GlobalHookConfig();
      //expect(instance).to.be.a(GitHubV3RestApi.GlobalHookConfig);
    });
