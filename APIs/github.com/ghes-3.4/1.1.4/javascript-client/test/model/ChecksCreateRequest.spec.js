...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ChecksCreateRequest();
  });
  ...
  describe('ChecksCreateRequest', function() {
    it('should create an instance of ChecksCreateRequest', function() {
      // uncomment below and update the code to test ChecksCreateRequest
      //var instance = new GitHubV3RestApi.ChecksCreateRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ChecksCreateRequest);
    });
