...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.WebhookConfig();
  });
  ...
  describe('WebhookConfig', function() {
    it('should create an instance of WebhookConfig', function() {
      // uncomment below and update the code to test WebhookConfig
      //var instance = new GitHubV3RestApi.WebhookConfig();
      //expect(instance).to.be.a(GitHubV3RestApi.WebhookConfig);
    });
