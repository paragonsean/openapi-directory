...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.DependabotCreateOrUpdateOrgSecretRequest();
  });
  ...
  describe('DependabotCreateOrUpdateOrgSecretRequest', function() {
    it('should create an instance of DependabotCreateOrUpdateOrgSecretRequest', function() {
      // uncomment below and update the code to test DependabotCreateOrUpdateOrgSecretRequest
      //var instance = new GitHubV3RestApi.DependabotCreateOrUpdateOrgSecretRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.DependabotCreateOrUpdateOrgSecretRequest);
    });
