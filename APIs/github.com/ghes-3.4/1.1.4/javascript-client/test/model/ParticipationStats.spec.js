...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ParticipationStats();
  });
  ...
  describe('ParticipationStats', function() {
    it('should create an instance of ParticipationStats', function() {
      ...
      //var instance = new GitHubV3RestApi.ParticipationStats();
      //expect(instance).to.be.a(GitHubV3RestApi.ParticipationStats);
    });
