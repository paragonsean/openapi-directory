...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullRequestHeadRepo();
  });
  ...
  describe('PullRequestHeadRepo', function() {
    it('should create an instance of PullRequestHeadRepo', function() {
      // uncomment below and update the code to test PullRequestHeadRepo
      //var instance = new GitHubV3RestApi.PullRequestHeadRepo();
      //expect(instance).to.be.a(GitHubV3RestApi.PullRequestHeadRepo);
    });
    ...
    it('should have the property tempCloneToken (base name: "temp_clone_token")', function() {
      // uncomment below and update the code to test the property tempCloneToken
      //var instance = new GitHubV3RestApi.PullRequestHeadRepo();
      //expect(instance).to.be();
    });
