...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LdapMappingUserPlan();
  });
  ...
  describe('LdapMappingUserPlan', function() {
    it('should create an instance of LdapMappingUserPlan', function() {
      // uncomment below and update the code to test LdapMappingUserPlan
      //var instance = new GitHubV3RestApi.LdapMappingUserPlan();
      //expect(instance).to.be.a(GitHubV3RestApi.LdapMappingUserPlan);
    });
