...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer();
  });
  ...
  describe('EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer', function() {
    it('should create an instance of EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer', function() {
      // uncomment below and update the code to test EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer
      //var instance = new GitHubV3RestApi.EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer();
      //expect(instance).to.be.a(GitHubV3RestApi.EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer);
    });
