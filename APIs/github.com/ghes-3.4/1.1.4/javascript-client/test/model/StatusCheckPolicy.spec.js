...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.StatusCheckPolicy();
  });
  ...
  describe('StatusCheckPolicy', function() {
    it('should create an instance of StatusCheckPolicy', function() {
      // uncomment below and update the code to test StatusCheckPolicy
      //var instance = new GitHubV3RestApi.StatusCheckPolicy();
      //expect(instance).to.be.a(GitHubV3RestApi.StatusCheckPolicy);
    });
