...
> Issue issuesAddAssignees(owner, repo, issueNumber, opts)
...
let issueNumber = 56; // Number | The number that identifies the issue.
let opts = {
  'issuesAddLabelsRequest': {"labels":["bug","enhancement"]} // IssuesAddLabelsRequest | 
};
...
let issueNumber = 56; // Number | The number that identifies the issue.
let assignee = "assignee_example"; // String | 
apiInstance.issuesCheckUserCanBeAssignedToIssue(owner, repo, issueNumber, assignee, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let milestoneNumber = 56; // Number | The number that identifies the milestone.
 ...
 **owner** | **String**| The account owner of the repository. The name is not case sensitive. | 
 **repo** | **String**| The name of the repository. The name is not case sensitive. | 
 **milestoneNumber** | **Number**| The number that identifies the milestone. | 
...
> [Issue] issuesListForRepo(owner, repo, opts)
...
let issueNumber = 56; // Number | The number that identifies the issue.
let opts = {
  'issuesLockRequest': {"lock_reason":"off-topic"} // IssuesLockRequest | 
};
...
> Issue issuesRemoveAssignees(owner, repo, issueNumber, opts)
...
let name = "name_example"; // String | 
let opts = {
  'issuesUpdateLabelRequest': {"color":"b01f26","description":"Small bug fix required","new_name":"bug :bug:"} // IssuesUpdateLabelRequest | 
};
