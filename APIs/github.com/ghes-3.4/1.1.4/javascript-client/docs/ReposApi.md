...
[**reposListCacheInfo**](ReposApi.md#reposListCacheInfo) | **GET** /repos/{owner}/{repo}/replicas/caches | List repository cache replication status
...
let invitationId = 56; // Number | The unique identifier of the invitation.
apiInstance.reposAcceptInvitationForAuthenticatedUser(invitationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **invitationId** | **Number**| The unique identifier of the invitation. | 
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'reposSetAppAccessRestrictionsRequest': {"apps":["octoapp"]} // ReposSetAppAccessRestrictionsRequest | 
};
 ...
 **branch** | **String**| The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql). | 
...
let opts = {
  'reposAddCollaboratorRequest': {"permission":"triage"} // ReposAddCollaboratorRequest | 
};
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'requestBody': ["continuous-integration/travis-ci","continuous-integration/jenkins"] // [String] | 
};
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'requestBody': ["justice-league"] // [String] | 
};
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'reposSetUserAccessRestrictionsRequest': {"users":["octocat"]} // ReposSetUserAccessRestrictionsRequest | 
};
...
> CommitComparison reposCompareCommits(owner, repo, basehead, opts)
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposCreateAutolinkRequest = {"is_alphanumeric":true,"key_prefix":"TICKET-","url_template":"https://example.com/TICKET?query=<num>"}; // ReposCreateAutolinkRequest | 
apiInstance.reposCreateAutolink(owner, repo, reposCreateAutolinkRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let reposCreateCommitCommentRequest = {"body":"Great stuff","line":1,"path":"file1.txt","position":4}; // ReposCreateCommitCommentRequest | 
apiInstance.reposCreateCommitComment(owner, repo, commitSha, reposCreateCommitCommentRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let reposCreateCommitStatusRequest = {"context":"continuous-integration/jenkins","description":"The build succeeded!","state":"success","target_url":"https://example.com/build/status"}; // ReposCreateCommitStatusRequest | 
apiInstance.reposCreateCommitStatus(owner, repo, sha, reposCreateCommitStatusRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposCreateDeployKeyRequest = {"key":"ssh-rsa AAA...","read_only":true,"title":"octocat@octomac"}; // ReposCreateDeployKeyRequest | 
apiInstance.reposCreateDeployKey(owner, repo, reposCreateDeployKeyRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposCreateDeploymentRequest = {"auto_merge":false,"description":"Deploy request from hubot","payload":"{ \"deploy\": \"migrate\" }","ref":"topic-branch","required_contexts":["ci/janky","security/brakeman"]}; // ReposCreateDeploymentRequest | 
apiInstance.reposCreateDeployment(owner, repo, reposCreateDeploymentRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let deploymentBranchPolicyNamePattern = {"name":"main"}; // DeploymentBranchPolicyNamePattern | 
apiInstance.reposCreateDeploymentBranchPolicy(owner, repo, environmentName, deploymentBranchPolicyNamePattern, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let reposCreateDeploymentStatusRequest = {"description":"Deployment finished successfully.","environment":"production","log_url":"https://example.com/deployment/42/output","state":"success"}; // ReposCreateDeploymentStatusRequest | 
apiInstance.reposCreateDeploymentStatus(owner, repo, deploymentId, reposCreateDeploymentStatusRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposCreateDispatchEventRequest = {"client_payload":{"integration":true,"unit":false},"event_type":"on-demand-test"}; // ReposCreateDispatchEventRequest | 
apiInstance.reposCreateDispatchEvent(owner, repo, reposCreateDispatchEventRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new GitHubV3RestApi.ReposApi();
let reposCreateForAuthenticatedUserRequest = {"description":"This is your first repo!","homepage":"https://github.com","is_template":true,"name":"Hello-World","private":false}; // ReposCreateForAuthenticatedUserRequest | 
apiInstance.reposCreateForAuthenticatedUser(reposCreateForAuthenticatedUserRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> FullRepository reposCreateFork(owner, repo, opts)
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let opts = {
  'reposCreateForkRequest': {"default_branch_only":true,"name":"Hello-World","organization":"octocat"} // ReposCreateForkRequest | 
};
...
let reposCreateInOrgRequest = {"description":"This is your first repository","has_issues":true,"has_projects":true,"has_wiki":true,"homepage":"https://github.com","name":"Hello-World","private":false}; // ReposCreateInOrgRequest | 
apiInstance.reposCreateInOrg(org, reposCreateInOrgRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Environment reposCreateOrUpdateEnvironment(owner, repo, environmentName, opts)
...
let environmentName = "environmentName_example"; // String | The name of the environment.
let opts = {
  'reposCreateOrUpdateEnvironmentRequest': {"deployment_branch_policy":{"custom_branch_policies":true,"protected_branches":false},"reviewers":[{"id":1,"type":"User"},{"id":1,"type":"Team"}],"wait_timer":30} // ReposCreateOrUpdateEnvironmentRequest | 
};
apiInstance.reposCreateOrUpdateEnvironment(owner, repo, environmentName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let reposCreateOrUpdateFileContentsRequest = {"committer":{"email":"octocat@github.com","name":"Monalisa Octocat"},"content":"bXkgbmV3IGZpbGUgY29udGVudHM=","message":"my commit message"}; // ReposCreateOrUpdateFileContentsRequest | 
apiInstance.reposCreateOrUpdateFileContents(owner, repo, path, reposCreateOrUpdateFileContentsRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposCreatePagesSiteRequest = {"source":{"branch":"main","path":"/docs"}}; // ReposCreatePagesSiteRequest | 
apiInstance.reposCreatePagesSite(owner, repo, reposCreatePagesSiteRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposCreateReleaseRequest = {"body":"Description of the release","draft":false,"generate_release_notes":false,"name":"v1.0.0","prerelease":false,"tag_name":"v1.0.0","target_commitish":"master"}; // ReposCreateReleaseRequest | 
apiInstance.reposCreateRelease(owner, repo, reposCreateReleaseRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let reposCreateUsingTemplateRequest = {"description":"This is your first repository","include_all_branches":false,"name":"Hello-World","owner":"octocat","private":false}; // ReposCreateUsingTemplateRequest | 
apiInstance.reposCreateUsingTemplate(templateOwner, templateRepo, reposCreateUsingTemplateRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let opts = {
  'reposCreateWebhookRequest': {"active":true,"config":{"content_type":"json","insecure_ssl":"0","url":"https://example.com/webhook"},"events":["push","pull_request"],"name":"web"} // ReposCreateWebhookRequest | 
};
...
let apiInstance = new GitHubV3RestApi.ReposApi();
let invitationId = 56; // Number | The unique identifier of the invitation.
apiInstance.reposDeclineInvitationForAuthenticatedUser(invitationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let environmentName = "environmentName_example"; // String | The name of the environment.
apiInstance.reposDeleteAnEnvironment(owner, repo, environmentName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let autolinkId = 56; // Number | The unique identifier of the autolink.
apiInstance.reposDeleteAutolink(owner, repo, autolinkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **owner** | **String**| The account owner of the repository. The name is not case sensitive. | 
 **repo** | **String**| The name of the repository. The name is not case sensitive. | 
 **autolinkId** | **Number**| The unique identifier of the autolink. | 
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let environmentName = "environmentName_example"; // String | The name of the environment.
let branchPolicyId = 56; // Number | The unique identifier of the branch policy.
apiInstance.reposDeleteDeploymentBranchPolicy(owner, repo, environmentName, branchPolicyId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
 ...
 **repo** | **String**| The name of the repository. The name is not case sensitive. | 
 **environmentName** | **String**| The name of the environment. | 
 **branchPolicyId** | **Number**| The unique identifier of the branch policy. | 
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let path = "path_example"; // String | path parameter
let reposDeleteFileRequest = {"committer":{"email":"octocat@github.com","name":"Monalisa Octocat"},"message":"my commit message","sha":"329688480d39049927147c162b9d2deaf885005f"}; // ReposDeleteFileRequest | 
apiInstance.reposDeleteFile(owner, repo, path, reposDeleteFileRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let releaseId = 56; // Number | The unique identifier of the release.
 ...
 **owner** | **String**| The account owner of the repository. The name is not case sensitive. | 
 **repo** | **String**| The name of the repository. The name is not case sensitive. | 
 **releaseId** | **Number**| The unique identifier of the release. | 
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let assetId = 56; // Number | The unique identifier of the asset.
 ...
 **owner** | **String**| The account owner of the repository. The name is not case sensitive. | 
 **repo** | **String**| The name of the repository. The name is not case sensitive. | 
 **assetId** | **Number**| The unique identifier of the asset. | 
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
apiInstance.reposDisableLfsForRepo(owner, repo, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
apiInstance.reposEnableLfsForRepo(owner, repo, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposGenerateReleaseNotesRequest = {"configuration_file_path":".github/custom_release_config.yml","previous_tag_name":"v0.9.2","tag_name":"v1.0.0","target_commitish":"main"}; // ReposGenerateReleaseNotesRequest | 
apiInstance.reposGenerateReleaseNotes(owner, repo, reposGenerateReleaseNotesRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReposGetAllEnvironments200Response reposGetAllEnvironments(owner, repo, opts)
...
apiInstance.reposGetAllEnvironments(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Topic reposGetAllTopics(owner, repo, opts)
...
apiInstance.reposGetAllTopics(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let autolinkId = 56; // Number | The unique identifier of the autolink.
apiInstance.reposGetAutolink(owner, repo, autolinkId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CombinedCommitStatus reposGetCombinedStatusForRef(owner, repo, ref, opts)
...
apiInstance.reposGetCombinedStatusForRef(owner, repo, ref, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> Commit reposGetCommit(owner, repo, ref, opts)
...
apiInstance.reposGetCommit(owner, repo, ref, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReposGetContent200Response reposGetContent(owner, repo, path, opts)
...
let environmentName = "environmentName_example"; // String | The name of the environment.
let branchPolicyId = 56; // Number | The unique identifier of the branch policy.
apiInstance.reposGetDeploymentBranchPolicy(owner, repo, environmentName, branchPolicyId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let environmentName = "environmentName_example"; // String | The name of the environment.
apiInstance.reposGetEnvironment(owner, repo, environmentName, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ContentFile reposGetReadmeInDirectory(owner, repo, dir, opts)
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let dir = "dir_example"; // String | The alternate path to look for a README file
let opts = {
  'ref': "ref_example" // String | The name of the commit/branch/tag. Default: the repository’s default branch (usually `master`)
};
apiInstance.reposGetReadmeInDirectory(owner, repo, dir, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let hookId = 56; // Number | The unique identifier of the hook.
apiInstance.reposGetWebhookConfigForRepo(owner, repo, hookId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.reposGetWebhookDelivery(owner, repo, hookId, deliveryId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [Autolink] reposListAutolinks(owner, repo, opts)
...
apiInstance.reposListAutolinks(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [ReposListCacheInfo200ResponseInner] reposListCacheInfo(owner, repo, opts)
...
apiInstance.reposListCacheInfo(owner, repo, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**[ReposListCacheInfo200ResponseInner]**](ReposListCacheInfo200ResponseInner.md)
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let opts = {
  'affiliation': "'all'", // String | Filter collaborators returned by their affiliation. `outside` means all outside collaborators of an organization-owned repository. `direct` means all collaborators with permissions to an organization-owned repository, regardless of organization membership status. `all` means all collaborators the authenticated user can see.
  'perPage': 30, // Number | The number of results per page (max 100).
  'page': 1 // Number | Page number of the results to fetch.
};
...
> [Commit] reposListCommits(owner, repo, opts)
...
let opts = {
  ...
  'until': new Date("2013-10-20T19:20:30+01:00"), // Date | Only commits before this date will be returned. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: `YYYY-MM-DDTHH:MM:SSZ`.
  'perPage': 30, // Number | The number of results per page (max 100).
  'page': 1 // Number | Page number of the results to fetch.
};
 ...
 **until** | **Date**| Only commits before this date will be returned. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: &#x60;YYYY-MM-DDTHH:MM:SSZ&#x60;. | [optional] 
 **perPage** | **Number**| The number of results per page (max 100). | [optional] [default to 30]
 **page** | **Number**| Page number of the results to fetch. | [optional] [default to 1]
...
> ReposListDeploymentBranchPolicies200Response reposListDeploymentBranchPolicies(owner, repo, environmentName, opts)
...
apiInstance.reposListDeploymentBranchPolicies(owner, repo, environmentName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = {
  ...
  'sort': "'full_name'", // String | The property to sort the results by.
  'direction': "direction_example", // String | The order to sort by. Default: `asc` when using `full_name`, otherwise `desc`.
  'perPage': 30, // Number | The number of results per page (max 100).
  'page': 1, // Number | Page number of the results to fetch.
  'since': new Date("2013-10-20T19:20:30+01:00"), // Date | Only show notifications updated after the given time. This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: `YYYY-MM-DDTHH:MM:SSZ`.
...
let org = "org_example"; // String | The organization name. The name is not case sensitive.
let opts = {
  'type': "type_example", // String | Specifies the types of repositories you want returned. `internal` is not yet supported when a GitHub App calls this endpoint with an installation access token.
...
------------- | ------------- | ------------- | -------------
 **org** | **String**| The organization name. The name is not case sensitive. | 
 **type** | **String**| Specifies the types of repositories you want returned. &#x60;internal&#x60; is not yet supported when a GitHub App calls this endpoint with an installation access token. | [optional] 
...
let username = "username_example"; // String | The handle for the GitHub user account.
let opts = {
  'type': "'owner'", // String | Limit results to repositories of the specified type.
  'sort': "'full_name'", // String | The property to sort the results by.
  'direction': "direction_example", // String | The order to sort by. Default: `asc` when using `full_name`, otherwise `desc`.
  'perPage': 30, // Number | The number of results per page (max 100).
  'page': 1 // Number | Page number of the results to fetch.
...
let apiInstance = new GitHubV3RestApi.ReposApi();
let opts = {
  'since': 56, // Number | A repository ID. Only return repositories with an ID greater than this ID.
  'visibility': "all" // String | Specifies the types of repositories to return. This endpoint will only list repositories available to all users on the enterprise.
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **since** | **Number**| A repository ID. Only return repositories with an ID greater than this ID. | [optional] 
 **visibility** | **String**| Specifies the types of repositories to return. This endpoint will only list repositories available to all users on the enterprise. | [optional] [default to &#39;public&#39;]
...
> [HookDeliveryItem] reposListWebhookDeliveries(owner, repo, hookId, opts)
...
apiInstance.reposListWebhookDeliveries(owner, repo, hookId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposMergeRequest = {"base":"master","commit_message":"Shipped cool_feature!","head":"cool_feature"}; // ReposMergeRequest | 
apiInstance.reposMerge(owner, repo, reposMergeRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposMergeUpstreamRequest = {"branch":"main"}; // ReposMergeUpstreamRequest | 
apiInstance.reposMergeUpstream(owner, repo, reposMergeUpstreamRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let hookId = 56; // Number | The unique identifier of the hook.
let deliveryId = 56; // Number | 
apiInstance.reposRedeliverWebhookDelivery(owner, repo, hookId, deliveryId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'reposSetAppAccessRestrictionsRequest': {"apps":["my-app"]} // ReposSetAppAccessRestrictionsRequest | 
};
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'requestBody': ["continuous-integration/jenkins"] // [String] | 
};
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let reposRenameBranchRequest = {"new_name":"my_renamed_branch"}; // ReposRenameBranchRequest | 
apiInstance.reposRenameBranch(owner, repo, branch, reposRenameBranchRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposReplaceAllTopicsRequest = {"names":["octocat","atom","electron","api"]}; // ReposReplaceAllTopicsRequest | 
apiInstance.reposReplaceAllTopics(owner, repo, reposReplaceAllTopicsRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'requestBody': ["continuous-integration/travis-ci"] // [String] | 
};
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposTransferRequest = {"new_owner":"github","team_ids":[12,345]}; // ReposTransferRequest | 
apiInstance.reposTransfer(owner, repo, reposTransferRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let opts = {
  'reposUpdateRequest': {"description":"This is your first repository","has_issues":true,"has_projects":true,"has_wiki":true,"homepage":"https://github.com","name":"Hello-World","private":true} // ReposUpdateRequest | 
};
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let commentId = 56; // Number | The unique identifier of the comment.
let reposUpdateCommitCommentRequest = {"body":"Nice change"}; // ReposUpdateCommitCommentRequest | 
apiInstance.reposUpdateCommitComment(owner, repo, commentId, reposUpdateCommitCommentRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let environmentName = "environmentName_example"; // String | The name of the environment.
let branchPolicyId = 56; // Number | The unique identifier of the branch policy.
let deploymentBranchPolicyNamePattern = {"name":"release/*"}; // DeploymentBranchPolicyNamePattern | 
apiInstance.reposUpdateDeploymentBranchPolicy(owner, repo, environmentName, branchPolicyId, deploymentBranchPolicyNamePattern, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let owner = "owner_example"; // String | The account owner of the repository. The name is not case sensitive.
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let reposUpdateInformationAboutPagesSiteRequest = {"cname":"octocatblog.com","source":{"branch":"main","path":"/"}}; // ReposUpdateInformationAboutPagesSiteRequest | 
apiInstance.reposUpdateInformationAboutPagesSite(owner, repo, reposUpdateInformationAboutPagesSiteRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let invitationId = 56; // Number | The unique identifier of the invitation.
let opts = {
  'reposUpdateInvitationRequest': {"permissions":"write"} // ReposUpdateInvitationRequest | 
};
...
let releaseId = 56; // Number | The unique identifier of the release.
let opts = {
  'reposUpdateReleaseRequest': {"body":"Description of the release","draft":false,"name":"v1.0.0","prerelease":false,"tag_name":"v1.0.0","target_commitish":"master"} // ReposUpdateReleaseRequest | 
};
...
let assetId = 56; // Number | The unique identifier of the asset.
let opts = {
  'reposUpdateReleaseAssetRequest': {"label":"Mac binary","name":"foo-1.0.0-osx.zip"} // ReposUpdateReleaseAssetRequest | 
};
...
let branch = "branch_example"; // String | The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.4/graphql).
let opts = {
  'reposUpdateStatusCheckProtectionRequest': {"contexts":["continuous-integration/travis-ci"],"strict":true} // ReposUpdateStatusCheckProtectionRequest | 
};
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let hookId = 56; // Number | The unique identifier of the hook.
let reposUpdateWebhookRequest = {"active":true,"add_events":["pull_request"]}; // ReposUpdateWebhookRequest | 
apiInstance.reposUpdateWebhook(owner, repo, hookId, reposUpdateWebhookRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> WebhookConfig reposUpdateWebhookConfigForRepo(owner, repo, hookId, opts)
...
let hookId = 56; // Number | The unique identifier of the hook.
let opts = {
  'reposUpdateWebhookConfigForRepoRequest': {"content_type":"json","url":"https://example.com/webhook"} // ReposUpdateWebhookConfigForRepoRequest | 
};
apiInstance.reposUpdateWebhookConfigForRepo(owner, repo, hookId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ReleaseAsset reposUploadReleaseAsset(owner, repo, releaseId, name, opts)
...
let opts = {
  ...
  'body': @example.zip // File | 
};
apiInstance.reposUploadReleaseAsset(owner, repo, releaseId, name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
