...
let projectId = 56; // Number | The unique identifier of the project.
let opts = {
  'teamsAddOrUpdateProjectPermissionsLegacyRequest': {"permission":"read"} // TeamsAddOrUpdateProjectPermissionsLegacyRequest | 
};
...
let repo = "repo_example"; // String | The name of the repository. The name is not case sensitive.
let opts = {
  'teamsAddOrUpdateRepoPermissionsLegacyRequest': {"permission":"push"} // TeamsAddOrUpdateRepoPermissionsLegacyRequest | 
};
