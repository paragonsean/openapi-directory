...
class TeamFull(Model):
    ...
    def __init__(self, created_at: datetime=None, description: str=None, html_url: str=None, id: int=None, ldap_dn: str=None, members_count: int=None, members_url: str=None, name: str=None, node_id: str=None, organization: TeamOrganization=None, parent: NullableTeamSimple=None, permission: str=None, privacy: str=None, repos_count: int=None, repositories_url: str=None, slug: str=None, updated_at: datetime=None, url: str=None):
    ...
    def organization(self, organization):
        ...
        :param organization: The organization of this TeamFull.
        :type organization: TeamOrganization
        """
