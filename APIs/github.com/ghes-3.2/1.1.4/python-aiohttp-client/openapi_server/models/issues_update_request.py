...
class IssuesUpdateRequest(Model):
    ...
    def __init__(self, assignee: str=None, assignees: List[str]=None, body: str=None, labels: List[IssuesCreateRequestLabelsInner]=None, milestone: IssuesUpdateRequestMilestone=None, state: str=None, state_reason: str=None, title: IssuesUpdateRequestTitle=None):
        ...
        :param state_reason: The state_reason of this IssuesUpdateRequest.
    ...
    def state_reason(self):
        """Gets the state_reason of this IssuesUpdateRequest.

        The reason for the current state

        :return: The state_reason of this IssuesUpdateRequest.
        :rtype: str
        """
    ...
    def state_reason(self, state_reason):
        """Sets the state_reason of this IssuesUpdateRequest.
        ...
        """
        allowed_values = [None,"completed", "not_planned", "reopened"]  # noqa: E501
