...
class Hook(Model):
    ...
    def __init__(self, active: bool=None, config: HookConfig=None, created_at: datetime=None, deliveries_url: str=None, events: List[str]=None, id: int=None, last_response: HookResponse=None, name: str=None, ping_url: str=None, test_url: str=None, type: str=None, updated_at: datetime=None, url: str=None):
        ...
        :param deliveries_url: The deliveries_url of this Hook.
    ...
    def deliveries_url(self):
        """Gets the deliveries_url of this Hook.


        :return: The deliveries_url of this Hook.
        :rtype: str
        """
    ...
    def deliveries_url(self, deliveries_url):
        """Sets the deliveries_url of this Hook.
