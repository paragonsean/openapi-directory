...
class Feed(Model):
    ...
    def __init__(self, links: FeedLinks=None, current_user_actor_url: str=None, current_user_organization_url: str=None, current_user_organization_urls: List[str]=None, current_user_public_url: str=None, current_user_url: str=None, security_advisories_url: str=None, timeline_url: str=None, user_url: str=None):
        ...
        :param security_advisories_url: The security_advisories_url of this Feed.
    ...
    @property
    def security_advisories_url(self):
        """Gets the security_advisories_url of this Feed.


        :return: The security_advisories_url of this Feed.
        :rtype: str
        """
        return self._security_advisories_url

    @security_advisories_url.setter
    def security_advisories_url(self, security_advisories_url):
        """Sets the security_advisories_url of this Feed.


        :param security_advisories_url: The security_advisories_url of this Feed.
        :type security_advisories_url: str
        """
