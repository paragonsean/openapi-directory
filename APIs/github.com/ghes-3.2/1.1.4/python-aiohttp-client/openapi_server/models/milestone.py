...
class Milestone(Model):
    ...
    def __init__(self, closed_at: datetime=None, closed_issues: int=None, created_at: datetime=None, creator: NullableSimpleUser=None, description: str=None, due_on: datetime=None, html_url: str=None, id: int=None, labels_url: str=None, node_id: str=None, number: int=None, open_issues: int=None, state: str='open', title: str=None, updated_at: datetime=None, url: str=None):
        ...
        :param creator: The creator of this Milestone.
        :param description: The description of this Milestone.
        :param due_on: The due_on of this Milestone.
        :param html_url: The html_url of this Milestone.
        :param id: The id of this Milestone.
        :param labels_url: The labels_url of this Milestone.
        :param node_id: The node_id of this Milestone.
        :param number: The number of this Milestone.
        ...
        :param url: The url of this Milestone.
        """
        self.openapi_types = {
            'closed_at': datetime,
            'closed_issues': int,
    ...
    @property
    def creator(self):
        """Gets the creator of this Milestone.


        :return: The creator of this Milestone.
    ...
    def creator(self, creator):
        """Sets the creator of this Milestone.
    ...
    @property
    def html_url(self):
        """Gets the html_url of this Milestone.


        :return: The html_url of this Milestone.
        :rtype: str
        """
    ...
    @property
    def labels_url(self):
        """Gets the labels_url of this Milestone.


        :return: The labels_url of this Milestone.
        :rtype: str
        """
    ...
    def labels_url(self, labels_url):
        """Sets the labels_url of this Milestone.
    ...
    @property
    def node_id(self):
        """Gets the node_id of this Milestone.


        :return: The node_id of this Milestone.
        :rtype: str
        """
    ...
    def node_id(self, node_id):
        """Sets the node_id of this Milestone.
    ...
    @property
    def number(self):
        """Gets the number of this Milestone.

        The number of the milestone.

        :return: The number of this Milestone.
        :rtype: int
        """
        return self._number
    ...
    @property
    def url(self):
        """Gets the url of this Milestone.


        :return: The url of this Milestone.
        :rtype: str
        """
        return self._url
