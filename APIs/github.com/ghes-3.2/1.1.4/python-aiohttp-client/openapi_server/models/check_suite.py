...
class CheckSuite(Model):
    ...
    def __init__(self, after: str=None, app: NullableIntegration=None, before: str=None, check_runs_url: str=None, conclusion: str=None, created_at: datetime=None, head_branch: str=None, head_commit: SimpleCommit=None, head_sha: str=None, id: int=None, latest_check_runs_count: int=None, node_id: str=None, pull_requests: List[PullRequestMinimal]=None, repository: MinimalRepository=None, rerequestable: bool=None, runs_rerequestable: bool=None, status: str=None, updated_at: datetime=None, url: str=None):
        ...
        :param rerequestable: The rerequestable of this CheckSuite.
        :param runs_rerequestable: The runs_rerequestable of this CheckSuite.
    ...
    @property
    def rerequestable(self):
        """Gets the rerequestable of this CheckSuite.


        :return: The rerequestable of this CheckSuite.
        :rtype: bool
        """
        return self._rerequestable

    @rerequestable.setter
    def rerequestable(self, rerequestable):
        """Sets the rerequestable of this CheckSuite.


        :param rerequestable: The rerequestable of this CheckSuite.
        :type rerequestable: bool
        """

        self._rerequestable = rerequestable

    @property
    def runs_rerequestable(self):
        """Gets the runs_rerequestable of this CheckSuite.


        :return: The runs_rerequestable of this CheckSuite.
        :rtype: bool
        """
        return self._runs_rerequestable

    @runs_rerequestable.setter
    def runs_rerequestable(self, runs_rerequestable):
        """Sets the runs_rerequestable of this CheckSuite.


        :param runs_rerequestable: The runs_rerequestable of this CheckSuite.
        :type runs_rerequestable: bool
        """
