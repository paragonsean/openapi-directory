...
class Release(Model):
    ...
    def __init__(self, assets: List[ReleaseAsset]=None, assets_url: str=None, author: SimpleUser=None, body: str=None, body_html: str=None, body_text: str=None, created_at: datetime=None, draft: bool=None, html_url: str=None, id: int=None, mentions_count: int=None, name: str=None, node_id: str=None, prerelease: bool=None, published_at: datetime=None, reactions: ReactionRollup=None, tag_name: str=None, tarball_url: str=None, target_commitish: str=None, upload_url: str=None, url: str=None, zipball_url: str=None):
        ...
        :param mentions_count: The mentions_count of this Release.
    ...
    def mentions_count(self):
        """Gets the mentions_count of this Release.


        :return: The mentions_count of this Release.
        :rtype: int
        """
        return self._mentions_count

    @mentions_count.setter
    def mentions_count(self, mentions_count):
        """Sets the mentions_count of this Release.


        :param mentions_count: The mentions_count of this Release.
        :type mentions_count: int
        """
