...
class ReposUpdateBranchProtectionRequest(Model):
    ...
    def __init__(self, allow_deletions: bool=None, allow_force_pushes: bool=None, block_creations: bool=None, contexts: List[str]=None, enforce_admins: bool=None, required_conversation_resolution: bool=None, required_linear_history: bool=None, required_pull_request_reviews: ReposUpdateBranchProtectionRequestRequiredPullRequestReviews=None, required_status_checks: ReposUpdateBranchProtectionRequestRequiredStatusChecks=None, restrictions: ReposUpdateBranchProtectionRequestRestrictions=None):
        ...
        :param block_creations: The block_creations of this ReposUpdateBranchProtectionRequest.
        :param contexts: The contexts of this ReposUpdateBranchProtectionRequest.
    ...
    def block_creations(self):
        """Gets the block_creations of this ReposUpdateBranchProtectionRequest.

        If set to `true`, the `restrictions` branch protection settings which limits who can push will also block pushes which create new branches, unless the push is initiated by a user, team, or app which has the ability to push. Set to `true` to restrict new branch creation. Default: `false`.

        :return: The block_creations of this ReposUpdateBranchProtectionRequest.
        :rtype: bool
        """
    ...
    def block_creations(self, block_creations):
        """Sets the block_creations of this ReposUpdateBranchProtectionRequest.

        If set to `true`, the `restrictions` branch protection settings which limits who can push will also block pushes which create new branches, unless the push is initiated by a user, team, or app which has the ability to push. Set to `true` to restrict new branch creation. Default: `false`.

        :param block_creations: The block_creations of this ReposUpdateBranchProtectionRequest.
        :type block_creations: bool
        """
    ...
    @property
    def contexts(self):
        """Gets the contexts of this ReposUpdateBranchProtectionRequest.

        The list of status checks to require in order to merge into this branch.

        :return: The contexts of this ReposUpdateBranchProtectionRequest.
        :rtype: List[str]
        """
    ...
    def contexts(self, contexts):
        """Sets the contexts of this ReposUpdateBranchProtectionRequest.
