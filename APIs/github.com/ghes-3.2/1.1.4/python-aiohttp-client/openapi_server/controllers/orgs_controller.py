...
async def orgs_convert_member_to_outside_collaborator(request: web.Request, org, username, body=None) -> web.Response:
    ...
    """
    body = OrgsConvertMemberToOutsideCollaboratorRequest.from_dict(body)
    return web.Response(status=200)
...
async def orgs_get_webhook_delivery(request: web.Request, org, hook_id, delivery_id) -> web.Response:
...
async def orgs_list_webhook_deliveries(request: web.Request, org, hook_id, per_page=None, cursor=None) -> web.Response:
...
async def orgs_redeliver_webhook_delivery(request: web.Request, org, hook_id, delivery_id) -> web.Response:
