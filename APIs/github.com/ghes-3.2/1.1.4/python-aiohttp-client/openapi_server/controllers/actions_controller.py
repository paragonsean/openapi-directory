...
async def actions_create_or_update_environment_secret(request: web.Request, repository_id, environment_name, secret_name, body) -> web.Response:
    ...
    """
    body = ActionsCreateOrUpdateEnvironmentSecretRequest.from_dict(body)
    return web.Response(status=200)
...
async def actions_delete_environment_secret(request: web.Request, repository_id, environment_name, secret_name) -> web.Response:
...
async def actions_get_environment_public_key(request: web.Request, repository_id, environment_name) -> web.Response:
...
async def actions_get_environment_secret(request: web.Request, repository_id, environment_name, secret_name) -> web.Response:
...
async def actions_get_pending_deployments_for_run(request: web.Request, owner, repo, run_id) -> web.Response:
...
async def actions_get_reviews_for_run(request: web.Request, owner, repo, run_id) -> web.Response:
...
async def actions_list_artifacts_for_repo(request: web.Request, owner, repo, per_page=None, page=None, name=None) -> web.Response:
...
async def actions_list_environment_secrets(request: web.Request, repository_id, environment_name, per_page=None, page=None) -> web.Response:
...
async def actions_list_workflow_runs(request: web.Request, owner, repo, workflow_id, actor=None, branch=None, event=None, status=None, per_page=None, page=None, created=None, exclude_pull_requests=None) -> web.Response:
    ...
    :param page: Page number of the results to fetch.
    :type page: int
    :param created: Returns workflow runs created within the given date-time range. For more information on the syntax, see \&quot;[Understanding the search syntax](https://docs.github.com/enterprise-server@3.2/search-github/getting-started-with-searching-on-github/understanding-the-search-syntax#query-for-dates).\&quot;
    :type created: str
    :param exclude_pull_requests: If &#x60;true&#x60; pull requests are omitted from the response (empty array).
    :type exclude_pull_requests: bool
...
async def actions_review_pending_deployments_for_run(request: web.Request, owner, repo, run_id, body) -> web.Response:
    ...
    """
    body = ActionsReviewPendingDeploymentsForRunRequest.from_dict(body)
    return web.Response(status=200)
