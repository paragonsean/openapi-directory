...
async def code_scanning_delete_analysis(request: web.Request, owner, repo, analysis_id, confirm_delete=None) -> web.Response:
...
async def code_scanning_get_analysis(request: web.Request, owner, repo, analysis_id) -> web.Response:
...
async def code_scanning_get_sarif(request: web.Request, owner, repo, sarif_id) -> web.Response:
...
async def code_scanning_list_alert_instances(request: web.Request, owner, repo, alert_number, page=None, per_page=None, ref=None) -> web.Response:
