...
async def repos_add_team_access_restrictions(request: web.Request, owner, repo, branch, body=None) -> web.Response:
    ...
    """
    body = ReposAddTeamAccessRestrictionsRequest.from_dict(body)
    return web.Response(status=200)
...
async def repos_compare_commits(request: web.Request, owner, repo, basehead, page=None, per_page=None) -> web.Response:
    """Compare two commits
...
async def repos_create_deployment_branch_policy(request: web.Request, owner, repo, environment_name, body) -> web.Response:
    ...
    """
    body = DeploymentBranchPolicyNamePattern.from_dict(body)
    return web.Response(status=200)
...
async def repos_create_or_update_environment(request: web.Request, owner, repo, environment_name, body=None) -> web.Response:
    ...
    """
    body = ReposCreateOrUpdateEnvironmentRequest.from_dict(body)
    return web.Response(status=200)
...
async def repos_delete_an_environment(request: web.Request, owner, repo, environment_name) -> web.Response:
...
async def repos_delete_deployment_branch_policy(request: web.Request, owner, repo, environment_name, branch_policy_id) -> web.Response:
    ...
    :param environment_name: The name of the environment.
    :type environment_name: str
    :param branch_policy_id: The unique identifier of the branch policy.
    :type branch_policy_id: int
...
async def repos_get_all_environments(request: web.Request, owner, repo, per_page=None, page=None) -> web.Response:
    """List environments
...
async def repos_get_deployment_branch_policy(request: web.Request, owner, repo, environment_name, branch_policy_id) -> web.Response:
...
async def repos_get_environment(request: web.Request, owner, repo, environment_name) -> web.Response:
    """Get an environment
...
async def repos_get_webhook_delivery(request: web.Request, owner, repo, hook_id, delivery_id) -> web.Response:
...
async def repos_list_collaborators(request: web.Request, owner, repo, affiliation=None, permission=None, per_page=None, page=None) -> web.Response:
...
async def repos_list_deployment_branch_policies(request: web.Request, owner, repo, environment_name, per_page=None, page=None) -> web.Response:
...
async def repos_list_public(request: web.Request, since=None, visibility=None) -> web.Response:
    ...
    :type since: int
    :param visibility: Specifies the types of repositories to return. This endpoint will only list repositories available to all users on the enterprise.
    :type visibility: str
...
async def repos_list_webhook_deliveries(request: web.Request, owner, repo, hook_id, per_page=None, cursor=None) -> web.Response:
...
async def repos_redeliver_webhook_delivery(request: web.Request, owner, repo, hook_id, delivery_id) -> web.Response:
...
async def repos_rename_branch(request: web.Request, owner, repo, branch, body) -> web.Response:
    """Rename a branch
    ...
    """
    body = ReposRenameBranchRequest.from_dict(body)
    return web.Response(status=200)
...
async def repos_update_deployment_branch_policy(request: web.Request, owner, repo, environment_name, branch_policy_id, body) -> web.Response:
...
async def repos_update_webhook_config_for_repo(request: web.Request, owner, repo, hook_id, body=None) -> web.Response:
    ...
    """
    body = ReposUpdateWebhookConfigForRepoRequest.from_dict(body)
    return web.Response(status=200)
