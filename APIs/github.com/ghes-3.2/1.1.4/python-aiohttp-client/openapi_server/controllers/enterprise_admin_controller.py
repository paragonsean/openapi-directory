...
async def enterprise_admin_create_enterprise_server_license(request: web.Request, license, password=None, settings=None) -> web.Response:
    ...
    :type password: str
    :param settings: An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.2/rest/reference/enterprise-admin#get-settings).
    :type settings: str
...
async def enterprise_admin_delete_global_webhook(request: web.Request, hook_id) -> web.Response:
...
async def enterprise_admin_delete_pre_receive_environment(request: web.Request, pre_receive_environment_id) -> web.Response:
    ...
    :param pre_receive_environment_id: The unique identifier of the pre-receive environment.
...
async def enterprise_admin_delete_pre_receive_hook(request: web.Request, pre_receive_hook_id) -> web.Response:
    ...
    :param pre_receive_hook_id: The unique identifier of the pre-receive hook.
...
async def enterprise_admin_delete_public_key(request: web.Request, key_ids) -> web.Response:
    ...
    :param key_ids: The unique identifier of the key.
    :type key_ids: str
...
async def enterprise_admin_list_global_webhooks(request: web.Request, per_page=None, page=None) -> web.Response:
...
async def enterprise_admin_ping_global_webhook(request: web.Request, hook_id) -> web.Response:
...
async def enterprise_admin_set_settings(request: web.Request, settings) -> web.Response:
    ...
    :param settings: A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.2/rest/reference/enterprise-admin#get-settings).
    :type settings: str
