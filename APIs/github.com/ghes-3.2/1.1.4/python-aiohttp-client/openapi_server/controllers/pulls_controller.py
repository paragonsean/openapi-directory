...
async def pulls_create_review_comment(request: web.Request, owner, repo, pull_number, body) -> web.Response:
    ...
    """
    body = PullsCreateReviewCommentRequest.from_dict(body)
    return web.Response(status=200)
...
async def pulls_list_requested_reviewers(request: web.Request, owner, repo, pull_number) -> web.Response:
