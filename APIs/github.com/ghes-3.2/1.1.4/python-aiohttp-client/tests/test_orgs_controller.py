...
async def test_orgs_check_membership_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/members/{username}'.format(org='org_example', username='username_example'),
        headers=headers,
        )
...
async def test_orgs_check_public_membership_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/public_members/{username}'.format(org='org_example', username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_convert_member_to_outside_collaborator(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/outside_collaborators/{username}'.format(org='org_example', username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_create_webhook(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/hooks'.format(org='org_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_delete_webhook(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/hooks/{hook_id}'.format(org='org_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_get_membership_for_authenticated_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/user/memberships/orgs/{org}'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_get_membership_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/memberships/{username}'.format(org='org_example', username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_get_webhook_config_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/hooks/{hook_id}/config'.format(org='org_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_get_webhook_delivery(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/hooks/{hook_id}/deliveries/{delivery_id}'.format(org='org_example', hook_id=56, delivery_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_list_app_installations(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/installations'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_list_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/orgs'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_list_members(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/members'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_list_outside_collaborators(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/outside_collaborators'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_list_public_members(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/public_members'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_list_webhook_deliveries(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/hooks/{hook_id}/deliveries'.format(org='org_example', hook_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_ping_webhook(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/hooks/{hook_id}/pings'.format(org='org_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_orgs_redeliver_webhook_delivery(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/hooks/{hook_id}/deliveries/{delivery_id}/attempts'.format(org='org_example', hook_id=56, delivery_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
