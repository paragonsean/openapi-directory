...
async def test_gists_check_is_starred(client):
    ...
    response = await client.request(
        method='GET',
        path='/gists/{gist_id}/star'.format(gist_id='gist_id_example'),
        headers=headers,
        )
...
async def test_gists_create_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/gists/{gist_id}/comments'.format(gist_id='gist_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gists_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/gists/{gist_id}'.format(gist_id='gist_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gists_delete_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/gists/{gist_id}/comments/{comment_id}'.format(gist_id='gist_id_example', comment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gists_fork(client):
    ...
    response = await client.request(
        method='POST',
        path='/gists/{gist_id}/forks'.format(gist_id='gist_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gists_get_revision(client):
    ...
    response = await client.request(
        method='GET',
        path='/gists/{gist_id}/{sha}'.format(gist_id='gist_id_example', sha='sha_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gists_list_commits(client):
    ...
    response = await client.request(
        method='GET',
        path='/gists/{gist_id}/commits'.format(gist_id='gist_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_gists_list_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/gists'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
