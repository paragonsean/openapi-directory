...
async def test_repos_accept_invitation_for_authenticated_user(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/user/repository_invitations/{invitation_id}'.format(invitation_id=56),
        headers=headers,
        )
...
async def test_repos_add_app_access_restrictions(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_add_collaborator(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/collaborators/{username}'.format(owner='owner_example', repo='repo_example', username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_add_status_check_contexts(client):
    ...
    """
    body = {"contexts":["continuous-integration/travis-ci","continuous-integration/jenkins"]}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_add_team_access_restrictions(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_add_user_access_restrictions(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_compare_commits(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/compare/{basehead}'.format(owner='owner_example', repo='repo_example', basehead='basehead_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_commit_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/commits/{commit_sha}/comments'.format(owner='owner_example', repo='repo_example', commit_sha='commit_sha_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_commit_signature_protection(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_commit_status(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/statuses/{sha}'.format(owner='owner_example', repo='repo_example', sha='sha_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_deploy_key(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/keys'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_deployment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/deployments'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_deployment_branch_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/environments/{environment_name}/deployment-branch-policies'.format(owner='owner_example', repo='repo_example', environment_name='environment_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_deployment_status(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/deployments/{deployment_id}/statuses'.format(owner='owner_example', repo='repo_example', deployment_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_dispatch_event(client):
    """Test case for repos_create_dispatch_event

    Create a repository dispatch event
    """
    body = {"client_payload":{"integration":true,"unit":false},"event_type":"on-demand-test"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/dispatches'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_for_authenticated_user(client):
    ...
    """
    body = {"description":"This is your first repo!","homepage":"https://github.com","is_template":true,"name":"Hello-World","private":false}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_repos_create_fork(client):
    ...
    Create a fork
    """
    body = {"default_branch_only":true,"name":"Hello-World","organization":"octocat"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/forks'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_in_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/repos'.format(org='org_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_or_update_environment(client):
    """Test case for repos_create_or_update_environment

    Create or update an environment
    """
    body = {"deployment_branch_policy":{"custom_branch_policies":true,"protected_branches":false},"reviewers":[{"id":1,"type":"User"},{"id":1,"type":"Team"}],"wait_timer":30}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/environments/{environment_name}'.format(owner='owner_example', repo='repo_example', environment_name='environment_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_or_update_file_contents(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/contents/{path}'.format(owner='owner_example', repo='repo_example', path='path_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_pages_site(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pages'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_release(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/releases'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_using_template(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{template_owner}/{template_repo}/generate'.format(template_owner='template_owner_example', template_repo='template_repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_create_webhook(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/hooks'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_decline_invitation_for_authenticated_user(client):
...
async def test_repos_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_access_restrictions(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/restrictions'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_admin_branch_protection(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/enforce_admins'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_an_environment(client):
...
async def test_repos_delete_branch_protection(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/branches/{branch}/protection'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_commit_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/comments/{comment_id}'.format(owner='owner_example', repo='repo_example', comment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_deploy_key(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/keys/{key_id}'.format(owner='owner_example', repo='repo_example', key_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_deployment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/deployments/{deployment_id}'.format(owner='owner_example', repo='repo_example', deployment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_deployment_branch_policy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/environments/{environment_name}/deployment-branch-policies/{branch_policy_id}'.format(owner='owner_example', repo='repo_example', environment_name='environment_name_example', branch_policy_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_invitation(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/invitations/{invitation_id}'.format(owner='owner_example', repo='repo_example', invitation_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_pull_request_review_protection(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/required_pull_request_reviews'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_release(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/releases/{release_id}'.format(owner='owner_example', repo='repo_example', release_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_release_asset(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/releases/assets/{asset_id}'.format(owner='owner_example', repo='repo_example', asset_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_delete_webhook(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/hooks/{hook_id}'.format(owner='owner_example', repo='repo_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_download_tarball_archive(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/tarball/{ref}'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_download_zipball_archive(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/zipball/{ref}'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_all_environments(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/environments'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_all_topics(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/topics'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_apps_with_access_to_protected_branch(client):
...
async def test_repos_get_branch(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/branches/{branch}'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_code_frequency_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/stats/code_frequency'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_collaborator_permission_level(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/collaborators/{username}/permission'.format(owner='owner_example', repo='repo_example', username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_combined_status_for_ref(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/commits/{ref}/status'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_commit(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/commits/{ref}'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_commit_activity_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/stats/commit_activity'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_contributors_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/stats/contributors'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_deployment_branch_policy(client):
...
async def test_repos_get_deployment_status(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/deployments/{deployment_id}/statuses/{status_id}'.format(owner='owner_example', repo='repo_example', deployment_id=56, status_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_environment(client):
...
async def test_repos_get_latest_pages_build(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pages/builds/latest'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_latest_release(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/releases/latest'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_pages_build(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pages/builds/{build_id}'.format(owner='owner_example', repo='repo_example', build_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_participation_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/stats/participation'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_punch_card_stats(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/stats/punch_card'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_readme(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/readme'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_readme_in_directory(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/readme/{dir}'.format(owner='owner_example', repo='repo_example', dir='dir_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_release_by_tag(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/releases/tags/{tag}'.format(owner='owner_example', repo='repo_example', tag='tag_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_status_checks_protection(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_webhook_config_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/hooks/{hook_id}/config'.format(owner='owner_example', repo='repo_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_get_webhook_delivery(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/hooks/{hook_id}/deliveries/{delivery_id}'.format(owner='owner_example', repo='repo_example', hook_id=56, delivery_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_branches(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/branches'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_branches_for_head_commit(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/commits/{commit_sha}/branches-where-head'.format(owner='owner_example', repo='repo_example', commit_sha='commit_sha_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_collaborators(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/collaborators'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_commit_comments_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/comments'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_commit_statuses_for_ref(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/commits/{ref}/statuses'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_commits(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/commits'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_contributors(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/contributors'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_deployment_branch_policies(client):
...
async def test_repos_list_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/repos'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_invitations(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/invitations'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_languages(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/languages'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_pages_builds(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pages/builds'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_pull_requests_associated_with_commit(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/commits/{commit_sha}/pulls'.format(owner='owner_example', repo='repo_example', commit_sha='commit_sha_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_release_assets(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/releases/{release_id}/assets'.format(owner='owner_example', repo='repo_example', release_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_tags(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/tags'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_teams(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/teams'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_list_webhook_deliveries(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/hooks/{hook_id}/deliveries'.format(owner='owner_example', repo='repo_example', hook_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_merge(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/merges'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_ping_webhook(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/hooks/{hook_id}/pings'.format(owner='owner_example', repo='repo_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_redeliver_webhook_delivery(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/hooks/{hook_id}/deliveries/{delivery_id}/attempts'.format(owner='owner_example', repo='repo_example', hook_id=56, delivery_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_remove_app_access_restrictions(client):
...
async def test_repos_remove_status_check_contexts(client):
    ...
    """
    body = {"contexts":["continuous-integration/travis-ci"]}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_repos_rename_branch(client):
    """Test case for repos_rename_branch

    Rename a branch
    """
    body = {"new_name":"my_renamed_branch"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/branches/{branch}/rename'.format(owner='owner_example', repo='repo_example', branch='branch_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_set_app_access_restrictions(client):
...
async def test_repos_test_push_webhook(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/hooks/{hook_id}/tests'.format(owner='owner_example', repo='repo_example', hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_transfer(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/transfer'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_repos_update_deployment_branch_policy(client):
...
async def test_repos_update_information_about_pages_site(client):
    ...
    """
    body = {"cname":"octocatblog.com","source":{"branch":"main","path":"/"}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_repos_update_pull_request_review_protection(client):
    ...
    """
    body = {"bypass_pull_request_allowances":{"apps":["octoapp"],"teams":["justice-league"],"users":["octocat"]},"dismiss_stale_reviews":true,"dismissal_restrictions":{"apps":["octoapp"],"teams":["justice-league"],"users":["octocat"]},"require_code_owner_reviews":true,"required_approving_review_count":2}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_repos_update_webhook_config_for_repo(client):
    """Test case for repos_update_webhook_config_for_repo

    Update a webhook configuration for a repository
    """
    body = {"content_type":"json","url":"https://example.com/webhook"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
