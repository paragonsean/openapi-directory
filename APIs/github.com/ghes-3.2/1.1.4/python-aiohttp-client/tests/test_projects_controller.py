...
async def test_projects_add_collaborator(client):
    ...
    response = await client.request(
        method='PUT',
        path='/projects/{project_id}/collaborators/{username}'.format(project_id=56, username='username_example'),
        headers=headers,
        json=body,
        )
...
async def test_projects_create_card(client):
    ...
    response = await client.request(
        method='POST',
        path='/projects/columns/{column_id}/cards'.format(column_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_create_column(client):
    ...
    response = await client.request(
        method='POST',
        path='/projects/{project_id}/columns'.format(project_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_create_for_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/projects'.format(org='org_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_create_for_repo(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/projects'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_delete(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/{project_id}'.format(project_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_delete_card(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/columns/cards/{card_id}'.format(card_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_delete_column(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/projects/columns/{column_id}'.format(column_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_get_permission_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/projects/{project_id}/collaborators/{username}/permission'.format(project_id=56, username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_list_collaborators(client):
    ...
    response = await client.request(
        method='GET',
        path='/projects/{project_id}/collaborators'.format(project_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_list_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/projects'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_move_card(client):
    ...
    response = await client.request(
        method='POST',
        path='/projects/columns/cards/{card_id}/moves'.format(card_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_projects_move_column(client):
    ...
    response = await client.request(
        method='POST',
        path='/projects/columns/{column_id}/moves'.format(column_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
