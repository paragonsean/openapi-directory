...
async def test_reactions_create_for_commit_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/comments/{comment_id}/reactions'.format(owner='owner_example', repo='repo_example', comment_id=56),
        headers=headers,
        json=body,
        )
...
async def test_reactions_create_for_issue(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/issues/{issue_number}/reactions'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_issue_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions'.format(owner='owner_example', repo='repo_example', comment_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_pull_request_review_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions'.format(owner='owner_example', repo='repo_example', comment_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_release(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/releases/{release_id}/reactions'.format(owner='owner_example', repo='repo_example', release_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_team_discussion_comment_in_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions'.format(org='org_example', team_slug='team_slug_example', discussion_number=56, comment_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_team_discussion_comment_legacy(client):
    ...
    response = await client.request(
        method='POST',
        path='/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions'.format(team_id=56, discussion_number=56, comment_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_team_discussion_in_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions'.format(org='org_example', team_slug='team_slug_example', discussion_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_create_for_team_discussion_legacy(client):
    ...
    response = await client.request(
        method='POST',
        path='/teams/{team_id}/discussions/{discussion_number}/reactions'.format(team_id=56, discussion_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_commit_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}'.format(owner='owner_example', repo='repo_example', comment_id=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_issue(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/issues/{issue_number}/reactions/{reaction_id}'.format(owner='owner_example', repo='repo_example', issue_number=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_issue_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions/{reaction_id}'.format(owner='owner_example', repo='repo_example', comment_id=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_pull_request_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions/{reaction_id}'.format(owner='owner_example', repo='repo_example', comment_id=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_release(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/releases/{release_id}/reactions/{reaction_id}'.format(owner='owner_example', repo='repo_example', release_id=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_team_discussion(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions/{reaction_id}'.format(org='org_example', team_slug='team_slug_example', discussion_number=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_for_team_discussion_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions/{reaction_id}'.format(org='org_example', team_slug='team_slug_example', discussion_number=56, comment_number=56, reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_delete_legacy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/reactions/{reaction_id}'.format(reaction_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reactions_list_for_release(client):
