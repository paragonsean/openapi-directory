...
async def test_pulls_check_if_merged(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/merge'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        )
...
async def test_pulls_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pulls'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_create_reply_for_review_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/comments/{comment_id}/replies'.format(owner='owner_example', repo='repo_example', pull_number=56, comment_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_create_review(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/reviews'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_create_review_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/comments'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_delete_pending_review(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}'.format(owner='owner_example', repo='repo_example', pull_number=56, review_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_delete_review_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/pulls/comments/{comment_id}'.format(owner='owner_example', repo='repo_example', comment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_dismiss_review(client):
    ...
    """
    body = {"event":"DISMISS","message":"You are dismissed"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/dismissals'.format(owner='owner_example', repo='repo_example', pull_number=56, review_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/{pull_number}'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_list_comments_for_review(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/comments'.format(owner='owner_example', repo='repo_example', pull_number=56, review_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_list_commits(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/commits'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_list_files(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/files'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_list_requested_reviewers(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_list_review_comments_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pulls/comments'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_merge(client):
    ...
    """
    body = {"commit_message":"Add a new value to the merge_method enum","commit_title":"Expand enum"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_pulls_submit_review(client):
    ...
    """
    body = {"body":"Here is the body for the review.","event":"REQUEST_CHANGES"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}/events'.format(owner='owner_example', repo='repo_example', pull_number=56, review_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_pulls_update_branch(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/pulls/{pull_number}/update-branch'.format(owner='owner_example', repo='repo_example', pull_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
