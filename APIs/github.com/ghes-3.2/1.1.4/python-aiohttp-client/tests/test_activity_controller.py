...
async def test_activity_check_repo_is_starred_by_authenticated_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/user/starred/{owner}/{repo}'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
...
async def test_activity_delete_repo_subscription(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/subscription'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_delete_thread_subscription(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/notifications/threads/{thread_id}/subscription'.format(thread_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_get_thread(client):
    ...
    response = await client.request(
        method='GET',
        path='/notifications/threads/{thread_id}'.format(thread_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_events_for_authenticated_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/events'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_org_events_for_authenticated_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/events/orgs/{org}'.format(username='username_example', org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_public_events_for_repo_network(client):
    ...
    response = await client.request(
        method='GET',
        path='/networks/{owner}/{repo}/events'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_public_events_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/events/public'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_public_org_events(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/events'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_received_events_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/received_events'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_received_public_events_for_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/received_events/public'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_repo_events(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/events'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_repo_notifications_for_authenticated_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/notifications'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_repos_starred_by_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/starred'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_repos_watched_by_user(client):
    ...
    response = await client.request(
        method='GET',
        path='/users/{username}/subscriptions'.format(username='username_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_stargazers_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/stargazers'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_activity_list_watchers_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/subscribers'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
