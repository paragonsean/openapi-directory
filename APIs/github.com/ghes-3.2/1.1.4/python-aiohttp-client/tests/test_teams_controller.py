...
async def test_teams_add_member_legacy(client):
    ...
    response = await client.request(
        method='PUT',
        path='/teams/{team_id}/members/{username}'.format(team_id=56, username='username_example'),
        headers=headers,
        )
...
async def test_teams_add_or_update_membership_for_user_in_org(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/teams/{team_slug}/memberships/{username}'.format(org='org_example', team_slug='team_slug_example', username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_add_or_update_membership_for_user_legacy(client):
    ...
    response = await client.request(
        method='PUT',
        path='/teams/{team_id}/memberships/{username}'.format(team_id=56, username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_add_or_update_project_permissions_in_org(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/teams/{team_slug}/projects/{project_id}'.format(org='org_example', team_slug='team_slug_example', project_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_add_or_update_project_permissions_legacy(client):
    ...
    response = await client.request(
        method='PUT',
        path='/teams/{team_id}/projects/{project_id}'.format(team_id=56, project_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_add_or_update_repo_permissions_in_org(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}'.format(org='org_example', team_slug='team_slug_example', owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_add_or_update_repo_permissions_legacy(client):
    ...
    response = await client.request(
        method='PUT',
        path='/teams/{team_id}/repos/{owner}/{repo}'.format(team_id=56, owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/teams'.format(org='org_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_create_discussion_comment_in_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments'.format(org='org_example', team_slug='team_slug_example', discussion_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_create_discussion_comment_legacy(client):
    ...
    response = await client.request(
        method='POST',
        path='/teams/{team_id}/discussions/{discussion_number}/comments'.format(team_id=56, discussion_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_create_discussion_in_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/teams/{team_slug}/discussions'.format(org='org_example', team_slug='team_slug_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_create_discussion_legacy(client):
    ...
    response = await client.request(
        method='POST',
        path='/teams/{team_id}/discussions'.format(team_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_delete_discussion_comment_in_org(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}'.format(org='org_example', team_slug='team_slug_example', discussion_number=56, comment_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_delete_discussion_comment_legacy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.format(team_id=56, discussion_number=56, comment_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_delete_discussion_in_org(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}'.format(org='org_example', team_slug='team_slug_example', discussion_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_delete_discussion_legacy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/teams/{team_id}/discussions/{discussion_number}'.format(team_id=56, discussion_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_delete_in_org(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/teams/{team_slug}'.format(org='org_example', team_slug='team_slug_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_delete_legacy(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/teams/{team_id}'.format(team_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_child_in_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/teams/{team_slug}/teams'.format(org='org_example', team_slug='team_slug_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_child_legacy(client):
    ...
    response = await client.request(
        method='GET',
        path='/teams/{team_id}/teams'.format(team_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_members_in_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/teams/{team_slug}/members'.format(org='org_example', team_slug='team_slug_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_members_legacy(client):
    ...
    response = await client.request(
        method='GET',
        path='/teams/{team_id}/members'.format(team_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_projects_in_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/teams/{team_slug}/projects'.format(org='org_example', team_slug='team_slug_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_projects_legacy(client):
    ...
    response = await client.request(
        method='GET',
        path='/teams/{team_id}/projects'.format(team_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_repos_in_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/teams/{team_slug}/repos'.format(org='org_example', team_slug='team_slug_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_teams_list_repos_legacy(client):
    ...
    response = await client.request(
        method='GET',
        path='/teams/{team_id}/repos'.format(team_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
