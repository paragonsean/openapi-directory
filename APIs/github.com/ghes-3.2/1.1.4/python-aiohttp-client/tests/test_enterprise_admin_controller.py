...
async def test_enterprise_admin_add_org_access_to_self_hosted_runner_group_in_enterprise(client):
    ...
    response = await client.request(
        method='PUT',
        path='/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations/{org_id}'.format(enterprise='enterprise_example', runner_group_id=56, org_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_add_self_hosted_runner_to_group_for_enterprise(client):
    ...
    response = await client.request(
        method='PUT',
        path='/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/runners/{runner_id}'.format(enterprise='enterprise_example', runner_group_id=56, runner_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_create_impersonation_o_auth_token(client):
    ...
    response = await client.request(
        method='POST',
        path='/admin/users/{username}/authorizations'.format(username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_create_registration_token_for_enterprise(client):
    ...
    response = await client.request(
        method='POST',
        path='/enterprises/{enterprise}/actions/runners/registration-token'.format(enterprise='enterprise_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_create_remove_token_for_enterprise(client):
    ...
    response = await client.request(
        method='POST',
        path='/enterprises/{enterprise}/actions/runners/remove-token'.format(enterprise='enterprise_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_create_self_hosted_runner_group_for_enterprise(client):
    ...
    response = await client.request(
        method='POST',
        path='/enterprises/{enterprise}/actions/runner-groups'.format(enterprise='enterprise_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_global_webhook(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/admin/hooks/{hook_id}'.format(hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_personal_access_token(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/admin/tokens/{token_id}'.format(token_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_pre_receive_environment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/admin/pre-receive-environments/{pre_receive_environment_id}'.format(pre_receive_environment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_pre_receive_hook(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/admin/pre-receive-hooks/{pre_receive_hook_id}'.format(pre_receive_hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_public_key(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/admin/keys/{key_ids}'.format(key_ids='key_ids_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_self_hosted_runner_from_enterprise(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/enterprises/{enterprise}/actions/runners/{runner_id}'.format(enterprise='enterprise_example', runner_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_self_hosted_runner_group_from_enterprise(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}'.format(enterprise='enterprise_example', runner_group_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_delete_user(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/admin/users/{username}'.format(username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_demote_site_administrator(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/users/{username}/site_admin'.format(username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_disable_selected_organization_github_actions_enterprise(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/enterprises/{enterprise}/actions/permissions/organizations/{org_id}'.format(enterprise='enterprise_example', org_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_get_allowed_actions_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/permissions/selected-actions'.format(enterprise='enterprise_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_get_download_status_for_pre_receive_environment(client):
    ...
    response = await client.request(
        method='GET',
        path='/admin/pre-receive-environments/{pre_receive_environment_id}/downloads/latest'.format(pre_receive_environment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_get_github_actions_permissions_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/permissions'.format(enterprise='enterprise_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_get_pre_receive_hook_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}'.format(org='org_example', pre_receive_hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_get_pre_receive_hook_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}'.format(owner='owner_example', repo='repo_example', pre_receive_hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_org_access_to_self_hosted_runner_group_in_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/organizations'.format(enterprise='enterprise_example', runner_group_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_pre_receive_hooks_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/pre-receive-hooks'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_pre_receive_hooks_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/pre-receive-hooks'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_runner_applications_for_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/runners/downloads'.format(enterprise='enterprise_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_selected_organizations_enabled_github_actions_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/permissions/organizations'.format(enterprise='enterprise_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_self_hosted_runners_for_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/runners'.format(enterprise='enterprise_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_list_self_hosted_runners_in_group_for_enterprise(client):
    ...
    response = await client.request(
        method='GET',
        path='/enterprises/{enterprise}/actions/runner-groups/{runner_group_id}/runners'.format(enterprise='enterprise_example', runner_group_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_ping_global_webhook(client):
    ...
    response = await client.request(
        method='POST',
        path='/admin/hooks/{hook_id}/pings'.format(hook_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_start_pre_receive_environment_download(client):
    ...
    response = await client.request(
        method='POST',
        path='/admin/pre-receive-environments/{pre_receive_environment_id}/downloads'.format(pre_receive_environment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_suspend_user(client):
    ...
    response = await client.request(
        method='PUT',
        path='/users/{username}/suspended'.format(username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_sync_ldap_mapping_for_team(client):
    ...
    response = await client.request(
        method='POST',
        path='/admin/ldap/teams/{team_id}/sync'.format(team_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_sync_ldap_mapping_for_user(client):
    ...
    response = await client.request(
        method='POST',
        path='/admin/ldap/users/{username}/sync'.format(username='username_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_update_ldap_mapping_for_team(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/admin/ldap/teams/{team_id}/mapping'.format(team_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_update_ldap_mapping_for_user(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/admin/ldap/users/{username}/mapping'.format(username='username_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enterprise_admin_update_org_name(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/admin/organizations/{org}'.format(org='org_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
