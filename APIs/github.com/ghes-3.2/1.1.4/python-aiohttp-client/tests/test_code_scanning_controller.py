...
async def test_code_scanning_delete_analysis(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}'.format(owner='owner_example', repo='repo_example', analysis_id=56),
        headers=headers,
        params=params,
        )
...
async def test_code_scanning_get_alert(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}'.format(owner='owner_example', repo='repo_example', alert_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_code_scanning_get_sarif(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/code-scanning/sarifs/{sarif_id}'.format(owner='owner_example', repo='repo_example', sarif_id='sarif_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_code_scanning_list_alert_instances(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}/instances'.format(owner='owner_example', repo='repo_example', alert_number=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_code_scanning_list_alerts_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/code-scanning/alerts'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_code_scanning_list_recent_analyses(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/code-scanning/analyses'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_code_scanning_upload_sarif(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/code-scanning/sarifs'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
