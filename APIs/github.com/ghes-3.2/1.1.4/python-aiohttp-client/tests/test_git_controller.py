...
async def test_git_create_blob(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/git/blobs'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
...
async def test_git_create_commit(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/git/commits'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_create_ref(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/git/refs'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_create_tag(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/git/tags'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_create_tree(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/git/trees'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_delete_ref(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/git/refs/{ref}'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_get_blob(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/git/blobs/{file_sha}'.format(owner='owner_example', repo='repo_example', file_sha='file_sha_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_get_commit(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/git/commits/{commit_sha}'.format(owner='owner_example', repo='repo_example', commit_sha='commit_sha_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_get_ref(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/git/ref/{ref}'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_get_tag(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/git/tags/{tag_sha}'.format(owner='owner_example', repo='repo_example', tag_sha='tag_sha_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_get_tree(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/git/trees/{tree_sha}'.format(owner='owner_example', repo='repo_example', tree_sha='tree_sha_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_list_matching_refs(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/git/matching-refs/{ref}'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_git_update_ref(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/repos/{owner}/{repo}/git/refs/{ref}'.format(owner='owner_example', repo='repo_example', ref='refs/head/master'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
