...
async def test_issues_add_assignees(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/issues/{issue_number}/assignees'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        json=body,
        )
...
async def test_issues_add_labels(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/issues/{issue_number}/labels'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_check_user_can_be_assigned(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/assignees/{assignee}'.format(owner='owner_example', repo='repo_example', assignee='assignee_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/issues'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_create_comment(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/issues/{issue_number}/comments'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_create_label(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/labels'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_create_milestone(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/milestones'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_delete_comment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/issues/comments/{comment_id}'.format(owner='owner_example', repo='repo_example', comment_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_delete_label(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/labels/{name}'.format(owner='owner_example', repo='repo_example', name='name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_delete_milestone(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/milestones/{milestone_number}'.format(owner='owner_example', repo='repo_example', milestone_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/issues/{issue_number}'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_get_event(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/issues/events/{event_id}'.format(owner='owner_example', repo='repo_example', event_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_assignees(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/assignees'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_comments_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/issues/comments'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_events(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/issues/{issue_number}/events'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_events_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/issues/events'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_events_for_timeline(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/issues/{issue_number}/timeline'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/issues'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_list_labels_for_milestone(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/milestones/{milestone_number}/labels'.format(owner='owner_example', repo='repo_example', milestone_number=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_lock(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/issues/{issue_number}/lock'.format(owner='owner_example', repo='repo_example', issue_number=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_issues_remove_label(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/issues/{issue_number}/labels/{name}'.format(owner='owner_example', repo='repo_example', issue_number=56, name='name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
