...
async def test_actions_add_repo_access_to_self_hosted_runner_group_in_org(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/actions/runner-groups/{runner_group_id}/repositories/{repository_id}'.format(org='org_example', runner_group_id=56, repository_id=56),
        headers=headers,
        )
...
async def test_actions_add_selected_repo_to_org_secret(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/actions/secrets/{secret_name}/repositories/{repository_id}'.format(org='org_example', secret_name='secret_name_example', repository_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_add_self_hosted_runner_to_group_for_org(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/actions/runner-groups/{runner_group_id}/runners/{runner_id}'.format(org='org_example', runner_group_id=56, runner_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_cancel_workflow_run(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/cancel'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_or_update_environment_secret(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repositories/{repository_id}/environments/{environment_name}/secrets/{secret_name}'.format(repository_id=56, environment_name='environment_name_example', secret_name='secret_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_or_update_org_secret(client):
    ...
    response = await client.request(
        method='PUT',
        path='/orgs/{org}/actions/secrets/{secret_name}'.format(org='org_example', secret_name='secret_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_or_update_repo_secret(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/actions/secrets/{secret_name}'.format(owner='owner_example', repo='repo_example', secret_name='secret_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_registration_token_for_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/actions/runners/registration-token'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_registration_token_for_repo(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/actions/runners/registration-token'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_remove_token_for_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/actions/runners/remove-token'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_remove_token_for_repo(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/actions/runners/remove-token'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_self_hosted_runner_group_for_org(client):
    ...
    response = await client.request(
        method='POST',
        path='/orgs/{org}/actions/runner-groups'.format(org='org_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_create_workflow_dispatch(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/actions/workflows/{workflow_id}/dispatches'.format(owner='owner_example', repo='repo_example', workflow_id=openapi_server.ActionsGetWorkflowWorkflowIdParameter()),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_delete_artifact(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/actions/artifacts/{artifact_id}'.format(owner='owner_example', repo='repo_example', artifact_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_delete_environment_secret(client):
...
async def test_actions_delete_self_hosted_runner_from_org(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/actions/runners/{runner_id}'.format(org='org_example', runner_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_delete_self_hosted_runner_from_repo(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/actions/runners/{runner_id}'.format(owner='owner_example', repo='repo_example', runner_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_delete_self_hosted_runner_group_from_org(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/actions/runner-groups/{runner_group_id}'.format(org='org_example', runner_group_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_delete_workflow_run(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_delete_workflow_run_logs(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/logs'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_disable_selected_repository_github_actions_organization(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/orgs/{org}/actions/permissions/repositories/{repository_id}'.format(org='org_example', repository_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_disable_workflow(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/actions/workflows/{workflow_id}/disable'.format(owner='owner_example', repo='repo_example', workflow_id=openapi_server.ActionsGetWorkflowWorkflowIdParameter()),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_download_artifact(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/artifacts/{artifact_id}/{archive_format}'.format(owner='owner_example', repo='repo_example', artifact_id=56, archive_format='archive_format_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_download_job_logs_for_workflow_run(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/jobs/{job_id}/logs'.format(owner='owner_example', repo='repo_example', job_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_enable_workflow(client):
    ...
    response = await client.request(
        method='PUT',
        path='/repos/{owner}/{repo}/actions/workflows/{workflow_id}/enable'.format(owner='owner_example', repo='repo_example', workflow_id=openapi_server.ActionsGetWorkflowWorkflowIdParameter()),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_allowed_actions_organization(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/permissions/selected-actions'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_allowed_actions_repository(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/permissions/selected-actions'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_environment_public_key(client):
    ...
    response = await client.request(
        method='GET',
        path='/repositories/{repository_id}/environments/{environment_name}/secrets/public-key'.format(repository_id=56, environment_name='environment_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_environment_secret(client):
...
async def test_actions_get_github_actions_permissions_organization(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/permissions'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_github_actions_permissions_repository(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/permissions'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_job_for_workflow_run(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/jobs/{job_id}'.format(owner='owner_example', repo='repo_example', job_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_org_public_key(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/secrets/public-key'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_pending_deployments_for_run(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/pending_deployments'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_repo_public_key(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/secrets/public-key'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_reviews_for_run(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/approvals'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_get_workflow(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/workflows/{workflow_id}'.format(owner='owner_example', repo='repo_example', workflow_id=openapi_server.ActionsGetWorkflowWorkflowIdParameter()),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_artifacts_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/artifacts'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_environment_secrets(client):
    ...
    response = await client.request(
        method='GET',
        path='/repositories/{repository_id}/environments/{environment_name}/secrets'.format(repository_id=56, environment_name='environment_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_jobs_for_workflow_run(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/jobs'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_org_secrets(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/secrets'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_repo_access_to_self_hosted_runner_group_in_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/runner-groups/{runner_group_id}/repositories'.format(org='org_example', runner_group_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_repo_secrets(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/secrets'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_repo_workflows(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/workflows'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_runner_applications_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/runners/downloads'.format(org='org_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_runner_applications_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runners/downloads'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_selected_repos_for_org_secret(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/secrets/{secret_name}/repositories'.format(org='org_example', secret_name='secret_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_selected_repositories_enabled_github_actions_organization(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/permissions/repositories'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_self_hosted_runners_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/runners'.format(org='org_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_self_hosted_runners_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runners'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_self_hosted_runners_in_group_for_org(client):
    ...
    response = await client.request(
        method='GET',
        path='/orgs/{org}/actions/runner-groups/{runner_group_id}/runners'.format(org='org_example', runner_group_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_workflow_run_artifacts(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/artifacts'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_workflow_runs(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/workflows/{workflow_id}/runs'.format(owner='owner_example', repo='repo_example', workflow_id=openapi_server.ActionsGetWorkflowWorkflowIdParameter()),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_list_workflow_runs_for_repo(client):
    ...
    response = await client.request(
        method='GET',
        path='/repos/{owner}/{repo}/actions/runs'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_re_run_workflow(client):
    ...
    response = await client.request(
        method='POST',
        path='/repos/{owner}/{repo}/actions/runs/{run_id}/rerun'.format(owner='owner_example', repo='repo_example', run_id=56),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_actions_review_pending_deployments_for_run(client):
    """Test case for actions_review_pending_deployments_for_run

    Review pending deployments for a workflow run
    """
    body = {"comment":"Ship it!","environment_ids":[161171787],"state":"approved"}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
