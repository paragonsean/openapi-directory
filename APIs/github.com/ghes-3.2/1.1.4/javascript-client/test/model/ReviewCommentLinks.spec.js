...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReviewCommentLinks();
  });
  ...
  describe('ReviewCommentLinks', function() {
    it('should create an instance of ReviewCommentLinks', function() {
      // uncomment below and update the code to test ReviewCommentLinks
      //var instance = new GitHubV3RestApi.ReviewCommentLinks();
      //expect(instance).to.be.a(GitHubV3RestApi.ReviewCommentLinks);
    });
