...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GitTree();
  });
  ...
  describe('GitTree', function() {
    it('should create an instance of GitTree', function() {
      // uncomment below and update the code to test GitTree
      //var instance = new GitHubV3RestApi.GitTree();
      //expect(instance).to.be.a(GitHubV3RestApi.GitTree);
    });
