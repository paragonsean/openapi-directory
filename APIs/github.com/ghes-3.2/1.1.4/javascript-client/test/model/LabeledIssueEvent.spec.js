...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LabeledIssueEvent();
  });
  ...
  describe('LabeledIssueEvent', function() {
    it('should create an instance of LabeledIssueEvent', function() {
      // uncomment below and update the code to test LabeledIssueEvent
      //var instance = new GitHubV3RestApi.LabeledIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.LabeledIssueEvent);
    });
