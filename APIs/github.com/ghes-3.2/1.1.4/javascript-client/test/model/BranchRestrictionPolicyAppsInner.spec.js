...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyAppsInner();
  });
  ...
  describe('BranchRestrictionPolicyAppsInner', function() {
    it('should create an instance of BranchRestrictionPolicyAppsInner', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyAppsInner
      //var instance = new GitHubV3RestApi.BranchRestrictionPolicyAppsInner();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyAppsInner);
    });
