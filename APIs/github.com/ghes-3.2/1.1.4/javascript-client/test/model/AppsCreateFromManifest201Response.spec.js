...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.AppsCreateFromManifest201Response();
  });
  ...
  describe('AppsCreateFromManifest201Response', function() {
    it('should create an instance of AppsCreateFromManifest201Response', function() {
      // uncomment below and update the code to test AppsCreateFromManifest201Response
      //var instance = new GitHubV3RestApi.AppsCreateFromManifest201Response();
      //expect(instance).to.be.a(GitHubV3RestApi.AppsCreateFromManifest201Response);
    });
