...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.NullableSimpleCommit();
  });
  ...
  describe('NullableSimpleCommit', function() {
    it('should create an instance of NullableSimpleCommit', function() {
      // uncomment below and update the code to test NullableSimpleCommit
      //var instance = new GitHubV3RestApi.NullableSimpleCommit();
      //expect(instance).to.be.a(GitHubV3RestApi.NullableSimpleCommit);
    });
