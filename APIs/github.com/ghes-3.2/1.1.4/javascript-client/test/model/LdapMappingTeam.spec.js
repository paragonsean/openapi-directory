...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LdapMappingTeam();
  });
  ...
  describe('LdapMappingTeam', function() {
    it('should create an instance of LdapMappingTeam', function() {
      // uncomment below and update the code to test LdapMappingTeam
      //var instance = new GitHubV3RestApi.LdapMappingTeam();
      //expect(instance).to.be.a(GitHubV3RestApi.LdapMappingTeam);
    });
