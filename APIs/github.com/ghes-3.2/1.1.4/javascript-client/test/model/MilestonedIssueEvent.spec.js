...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.MilestonedIssueEvent();
  });
  ...
  describe('MilestonedIssueEvent', function() {
    it('should create an instance of MilestonedIssueEvent', function() {
      // uncomment below and update the code to test MilestonedIssueEvent
      //var instance = new GitHubV3RestApi.MilestonedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.MilestonedIssueEvent);
    });
