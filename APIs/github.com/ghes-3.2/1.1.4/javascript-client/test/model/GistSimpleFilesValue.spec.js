...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistSimpleFilesValue();
  });
  ...
  describe('GistSimpleFilesValue', function() {
    it('should create an instance of GistSimpleFilesValue', function() {
      // uncomment below and update the code to test GistSimpleFilesValue
      //var instance = new GitHubV3RestApi.GistSimpleFilesValue();
      //expect(instance).to.be.a(GitHubV3RestApi.GistSimpleFilesValue);
    });
