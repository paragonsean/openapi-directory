...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TimelineAssignedIssueEvent();
  });
  ...
  describe('TimelineAssignedIssueEvent', function() {
    it('should create an instance of TimelineAssignedIssueEvent', function() {
      // uncomment below and update the code to test TimelineAssignedIssueEvent
      //var instance = new GitHubV3RestApi.TimelineAssignedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.TimelineAssignedIssueEvent);
    });
