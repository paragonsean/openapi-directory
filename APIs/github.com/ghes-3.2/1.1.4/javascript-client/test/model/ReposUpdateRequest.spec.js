...
(function(root, factory) {
  ...
  describe('ReposUpdateRequest', function() {
    ...
    it('should have the property securityAndAnalysis (base name: "security_and_analysis")', function() {
      // uncomment below and update the code to test the property securityAndAnalysis
      //var instance = new GitHubV3RestApi.ReposUpdateRequest();
      //expect(instance).to.be();
    });
