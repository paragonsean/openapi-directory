...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.Blob();
  });
  ...
  describe('Blob', function() {
    it('should create an instance of Blob', function() {
      ...
      //var instance = new GitHubV3RestApi.Blob();
      //expect(instance).to.be.a(GitHubV3RestApi.Blob);
    });
    ...
    it('should have the property highlightedContent (base name: "highlighted_content")', function() {
      // uncomment below and update the code to test the property highlightedContent
      //var instance = new GitHubV3RestApi.Blob();
      //expect(instance).to.be();
    });
