...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyUsersInner();
  });
  ...
  describe('BranchRestrictionPolicyUsersInner', function() {
    it('should create an instance of BranchRestrictionPolicyUsersInner', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyUsersInner
      //var instance = new GitHubV3RestApi.BranchRestrictionPolicyUsersInner();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyUsersInner);
    });
