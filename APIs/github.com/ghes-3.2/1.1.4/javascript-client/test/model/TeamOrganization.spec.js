...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TeamOrganization();
  });
  ...
  describe('TeamOrganization', function() {
    it('should create an instance of TeamOrganization', function() {
      // uncomment below and update the code to test TeamOrganization
      //var instance = new GitHubV3RestApi.TeamOrganization();
      //expect(instance).to.be.a(GitHubV3RestApi.TeamOrganization);
    });
