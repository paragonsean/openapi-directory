...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistCommit();
  });
  ...
  describe('GistCommit', function() {
    it('should create an instance of GistCommit', function() {
      // uncomment below and update the code to test GistCommit
      //var instance = new GitHubV3RestApi.GistCommit();
      //expect(instance).to.be.a(GitHubV3RestApi.GistCommit);
    });
