...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.HookDeliveryItem();
  });
  ...
  describe('HookDeliveryItem', function() {
    it('should create an instance of HookDeliveryItem', function() {
      // uncomment below and update the code to test HookDeliveryItem
      //var instance = new GitHubV3RestApi.HookDeliveryItem();
      //expect(instance).to.be.a(GitHubV3RestApi.HookDeliveryItem);
    });
