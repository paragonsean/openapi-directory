...
export default class ReactionsApi {
    ...
    */
     ...
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a commit comment.
     ...
     * @param {Number} issueNumber The number that identifies the issue.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {Number} commentId The unique identifier of the comment.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue comment.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {Number} commentId The unique identifier of the comment.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a pull request review comment.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {Number} releaseId The unique identifier of the release.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a release.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {Number} commentNumber The number that identifies the comment.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion comment.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {Number} discussionNumber The number that identifies the discussion.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [content] Returns a single [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
