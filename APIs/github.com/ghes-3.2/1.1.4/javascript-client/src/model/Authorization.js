...
class Authorization {
    ...
    constructor(app, createdAt, expiresAt, fingerprint, hashedToken, id, note, noteUrl, scopes, token, tokenLastEight, updatedAt, url) { 
        ...
        Authorization.initialize(this, app, createdAt, expiresAt, fingerprint, hashedToken, id, note, noteUrl, scopes, token, tokenLastEight, updatedAt, url);
    }
...
Authorization.RequiredProperties = ["app", "created_at", "expires_at", "fingerprint", "hashed_token", "id", "note", "note_url", "scopes", "token", "token_last_eight", "updated_at", "url"];
