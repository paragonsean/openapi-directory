...
class ActionsCreateOrUpdateOrgSecretRequest {
     ...
     * @param visibility {module:model/ActionsCreateOrUpdateOrgSecretRequest.VisibilityEnum} Which type of organization repositories have access to the organization secret. `selected` means only the repositories specified by `selected_repository_ids` can access the secret.
     */
