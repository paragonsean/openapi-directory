...
/**
 * The MovedColumnInProjectIssueEvent model module.
 * @module model/MovedColumnInProjectIssueEvent
 * @version 1.1.4
 */
class MovedColumnInProjectIssueEvent {
    /**
     * Constructs a new <code>MovedColumnInProjectIssueEvent</code>.
     * Moved Column in Project Issue Event
     * @alias module:model/MovedColumnInProjectIssueEvent
     ...
     * @param url {String} 
     */
    constructor(actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url) { 
        
        MovedColumnInProjectIssueEvent.initialize(this, actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url);
    }
     ...
     */
    static initialize(obj, actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url) { 
        obj['actor'] = actor;
    ...
    /**
     * Constructs a <code>MovedColumnInProjectIssueEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MovedColumnInProjectIssueEvent} obj Optional instance to populate.
     * @return {module:model/MovedColumnInProjectIssueEvent} The populated <code>MovedColumnInProjectIssueEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MovedColumnInProjectIssueEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>MovedColumnInProjectIssueEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MovedColumnInProjectIssueEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MovedColumnInProjectIssueEvent.RequiredProperties) {
...
MovedColumnInProjectIssueEvent.RequiredProperties = ["actor", "commit_id", "commit_url", "created_at", "event", "id", "node_id", "performed_via_github_app", "url"];

/**
 * @member {module:model/SimpleUser} actor
 */
MovedColumnInProjectIssueEvent.prototype['actor'] = undefined;

/**
 * @member {String} commit_id
 */
MovedColumnInProjectIssueEvent.prototype['commit_id'] = undefined;

/**
 * @member {String} commit_url
 */
MovedColumnInProjectIssueEvent.prototype['commit_url'] = undefined;

/**
 * @member {String} created_at
 */
MovedColumnInProjectIssueEvent.prototype['created_at'] = undefined;

/**
 * @member {String} event
 */
MovedColumnInProjectIssueEvent.prototype['event'] = undefined;

/**
 * @member {Number} id
 */
MovedColumnInProjectIssueEvent.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
MovedColumnInProjectIssueEvent.prototype['node_id'] = undefined;

/**
 * @member {module:model/NullableIntegration} performed_via_github_app
 */
MovedColumnInProjectIssueEvent.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/AddedToProjectIssueEventProjectCard} project_card
 */
MovedColumnInProjectIssueEvent.prototype['project_card'] = undefined;

/**
 * @member {String} url
 */
MovedColumnInProjectIssueEvent.prototype['url'] = undefined;
...
export default MovedColumnInProjectIssueEvent;
