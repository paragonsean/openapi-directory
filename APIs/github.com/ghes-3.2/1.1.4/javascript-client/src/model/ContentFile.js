...
class ContentFile {
     ...
     * @param url {String} 
     */
    constructor(links, content, downloadUrl, encoding, gitUrl, htmlUrl, name, path, sha, size, type, url) { 
     ...
     */
    static initialize(obj, links, content, downloadUrl, encoding, gitUrl, htmlUrl, name, path, sha, size, type, url) { 
        obj['_links'] = links;
        obj['content'] = content;
...
ContentFile.RequiredProperties = ["_links", "content", "download_url", "encoding", "git_url", "html_url", "name", "path", "sha", "size", "type", "url"];
