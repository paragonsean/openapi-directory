...
class NullableAuthorization {
     ...
     * @param url {String} 
     */
    constructor(app, createdAt, expiresAt, fingerprint, hashedToken, id, note, noteUrl, scopes, token, tokenLastEight, updatedAt, url) { 
        
        NullableAuthorization.initialize(this, app, createdAt, expiresAt, fingerprint, hashedToken, id, note, noteUrl, scopes, token, tokenLastEight, updatedAt, url);
    }
     ...
     */
    static initialize(obj, app, createdAt, expiresAt, fingerprint, hashedToken, id, note, noteUrl, scopes, token, tokenLastEight, updatedAt, url) { 
        obj['app'] = app;
...
NullableAuthorization.RequiredProperties = ["app", "created_at", "expires_at", "fingerprint", "hashed_token", "id", "note", "note_url", "scopes", "token", "token_last_eight", "updated_at", "url"];
 ...
 */
NullableAuthorization.prototype['expires_at'] = undefined;
