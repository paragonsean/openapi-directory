...
/**
 * The StateChangeIssueEvent model module.
 * @module model/StateChangeIssueEvent
 * @version 1.1.4
 */
class StateChangeIssueEvent {
    /**
     * Constructs a new <code>StateChangeIssueEvent</code>.
     * State Change Issue Event
     * @alias module:model/StateChangeIssueEvent
    ...
    constructor(actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url) { 
        ...
        StateChangeIssueEvent.initialize(this, actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, url);
    }
    ...
    /**
     * Constructs a <code>StateChangeIssueEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StateChangeIssueEvent} obj Optional instance to populate.
     * @return {module:model/StateChangeIssueEvent} The populated <code>StateChangeIssueEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StateChangeIssueEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>StateChangeIssueEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StateChangeIssueEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StateChangeIssueEvent.RequiredProperties) {
...
StateChangeIssueEvent.RequiredProperties = ["actor", "commit_id", "commit_url", "created_at", "event", "id", "node_id", "performed_via_github_app", "url"];

/**
 * @member {module:model/SimpleUser} actor
 */
StateChangeIssueEvent.prototype['actor'] = undefined;

/**
 * @member {String} commit_id
 */
StateChangeIssueEvent.prototype['commit_id'] = undefined;

/**
 * @member {String} commit_url
 */
StateChangeIssueEvent.prototype['commit_url'] = undefined;

/**
 * @member {String} created_at
 */
StateChangeIssueEvent.prototype['created_at'] = undefined;

/**
 * @member {String} event
 */
StateChangeIssueEvent.prototype['event'] = undefined;

/**
 * @member {Number} id
 */
StateChangeIssueEvent.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
StateChangeIssueEvent.prototype['node_id'] = undefined;

/**
 * @member {module:model/NullableIntegration} performed_via_github_app
 */
StateChangeIssueEvent.prototype['performed_via_github_app'] = undefined;

/**
 * @member {String} state_reason
 */
StateChangeIssueEvent.prototype['state_reason'] = undefined;

/**
 * @member {String} url
 */
StateChangeIssueEvent.prototype['url'] = undefined;
...
export default StateChangeIssueEvent;
