...
public class ReposUpdateRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowForking, allowMergeCommit, allowRebaseMerge, allowSquashMerge, allowUpdateBranch, archived, defaultBranch, deleteBranchOnMerge, description, hasIssues, hasProjects, hasWiki, homepage, isTemplate, mergeCommitMessage, mergeCommitTitle, name, _private, securityAndAnalysis, squashMergeCommitMessage, squashMergeCommitTitle, useSquashPrTitleAsDefault, visibility);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("security_and_analysis") != null && !jsonObj.get("security_and_analysis").isJsonNull()) {
        ReposUpdateRequestSecurityAndAnalysis.validateJsonElement(jsonObj.get("security_and_analysis"));
      }
