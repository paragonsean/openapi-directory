...
public class Milestone {
  ...
  public Milestone closedIssues(Integer closedIssues) {
  ...
  public Milestone creator(NullableSimpleUser creator) {
  ...
  public Milestone id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Milestone number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public Milestone openIssues(Integer openIssues) {
