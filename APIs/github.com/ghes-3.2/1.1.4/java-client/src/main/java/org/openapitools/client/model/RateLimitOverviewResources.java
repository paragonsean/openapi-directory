...
public class RateLimitOverviewResources {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionsRunnerRegistration, rateLimitOverviewResources.actionsRunnerRegistration) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(actionsRunnerRegistration, codeScanningUpload, core, graphql, integrationManifest, scim, search, sourceImport);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("actions_runner_registration") != null && !jsonObj.get("actions_runner_registration").isJsonNull()) {
        RateLimit.validateJsonElement(jsonObj.get("actions_runner_registration"));
      }
      ...
      if (jsonObj.get("scim") != null && !jsonObj.get("scim").isJsonNull()) {
        RateLimit.validateJsonElement(jsonObj.get("scim"));
      }
