...
public class SimpleUser {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatarUrl, simpleUser.avatarUrl) &&
        ...
        Objects.equals(this.name, simpleUser.name) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimpleUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
