...
public class ReposSetUserAccessRestrictionsRequest extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ReposSetUserAccessRestrictionsRequest>() {
                ...
                public void write(JsonWriter out, ReposSetUserAccessRestrictionsRequest value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof ReposSetUserAccessRestrictionsRequestOneOf) {
                        JsonElement element = adapterReposSetUserAccessRestrictionsRequestOneOf.toJsonTree((ReposSetUserAccessRestrictionsRequestOneOf)value.getActualInstance());
                ...
                public ReposSetUserAccessRestrictionsRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ReposSetUserAccessRestrictionsRequestOneOf.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for ReposSetUserAccessRestrictionsRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ReposSetUserAccessRestrictionsRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ReposSetUserAccessRestrictionsRequestOneOf", ReposSetUserAccessRestrictionsRequestOneOf.class);
     ...
     * @throws IOException if the JSON Element is invalid with respect to ReposSetUserAccessRestrictionsRequest
     */
