...
public class AppsApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#add-a-repository-to-an-app-installation">Add a repository to an app installation Documentation</a>
     */
    ...
    /**
     * Build call for appsCheckAuthorization
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#check-an-authorization">Check an authorization Documentation</a>
     */
    @Deprecated
    public okhttp3.Call appsCheckAuthorizationCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/applications/{client_id}/tokens/{access_token}"
            .replace("{" + "client_id" + "}", localVarApiClient.escapeString(clientId.toString()))
            .replace("{" + "access_token" + "}", localVarApiClient.escapeString(accessToken.toString()));
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsCheckAuthorizationValidateBeforeCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling appsCheckAuthorization(Async)");
        }

        // verify the required parameter 'accessToken' is set
        if (accessToken == null) {
            throw new ApiException("Missing the required parameter 'accessToken' when calling appsCheckAuthorization(Async)");
        }

        return appsCheckAuthorizationCall(clientId, accessToken, _callback);
     ...
     */
    @Deprecated
    public NullableAuthorization appsCheckAuthorization(String clientId, String accessToken) throws ApiException {
        ApiResponse<NullableAuthorization> localVarResp = appsCheckAuthorizationWithHttpInfo(clientId, accessToken);
     ...
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @return ApiResponse&lt;NullableAuthorization&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    @Deprecated
    public ApiResponse<NullableAuthorization> appsCheckAuthorizationWithHttpInfo(String clientId, String accessToken) throws ApiException {
        okhttp3.Call localVarCall = appsCheckAuthorizationValidateBeforeCall(clientId, accessToken, null);
        Type localVarReturnType = new TypeToken<NullableAuthorization>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Check an authorization (asynchronously)
     * **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain &#x60;access_token&#x60; in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving &#x60;access_token&#x60; to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).  OAuth applications can use a special API method for checking OAuth token validity without exceeding the normal rate limits for failed login attempts. Authentication works differently with this particular endpoint. You must use [Basic Authentication](https://docs.github.com/enterprise-server@3.2/rest/overview/other-authentication-methods#basic-authentication) when accessing this endpoint, using the OAuth application&#39;s &#x60;client_id&#x60; and &#x60;client_secret&#x60; as the username and password. Invalid tokens will return &#x60;404 NOT FOUND&#x60;.
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call appsCheckAuthorizationAsync(String clientId, String accessToken, final ApiCallback<NullableAuthorization> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsCheckAuthorizationValidateBeforeCall(clientId, accessToken, _callback);
        Type localVarReturnType = new TypeToken<NullableAuthorization>(){}.getType();
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#check-a-token">Check a token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#create-a-content-attachment">Create a content attachment Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#create-a-github-app-from-a-manifest">Create a GitHub App from a manifest Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps/#create-an-installation-access-token-for-an-app">Create an installation access token for an app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#delete-an-app-authorization">Delete an app authorization Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#delete-an-installation-for-the-authenticated-app">Delete an installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#delete-an-app-token">Delete an app token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-the-authenticated-app">Get the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps/#get-an-app">Get an app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-an-installation-for-the-authenticated-app">Get an installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-an-organization-installation-for-the-authenticated-app">Get an organization installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-a-repository-installation-for-the-authenticated-app">Get a repository installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-a-user-installation-for-the-authenticated-app">Get a user installation for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-a-webhook-configuration-for-an-app">Get a webhook configuration for an app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#get-a-delivery-for-an-app-webhook">Get a delivery for an app webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-repositories-accessible-to-the-user-access-token">List repositories accessible to the user access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-installations-for-the-authenticated-app">List installations for the authenticated app Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-app-installations-accessible-to-the-user-access-token">List app installations accessible to the user access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-repositories-accessible-to-the-app-installation">List repositories accessible to the app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-deliveries-for-an-app-webhook">List deliveries for an app webhook Documentation</a>
     */
    public okhttp3.Call appsListWebhookDeliveriesCall(Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsListWebhookDeliveriesValidateBeforeCall(Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        return appsListWebhookDeliveriesCall(perPage, cursor, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-deliveries-for-an-app-webhook">List deliveries for an app webhook Documentation</a>
     */
    public List<HookDeliveryItem> appsListWebhookDeliveries(Integer perPage, String cursor) throws ApiException {
        ApiResponse<List<HookDeliveryItem>> localVarResp = appsListWebhookDeliveriesWithHttpInfo(perPage, cursor);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-deliveries-for-an-app-webhook">List deliveries for an app webhook Documentation</a>
     */
    public ApiResponse<List<HookDeliveryItem>> appsListWebhookDeliveriesWithHttpInfo(Integer perPage, String cursor) throws ApiException {
        okhttp3.Call localVarCall = appsListWebhookDeliveriesValidateBeforeCall(perPage, cursor, null);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#list-deliveries-for-an-app-webhook">List deliveries for an app webhook Documentation</a>
     */
    public okhttp3.Call appsListWebhookDeliveriesAsync(Integer perPage, String cursor, final ApiCallback<List<HookDeliveryItem>> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsListWebhookDeliveriesValidateBeforeCall(perPage, cursor, _callback);
        Type localVarReturnType = new TypeToken<List<HookDeliveryItem>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#redeliver-a-delivery-for-an-app-webhook">Redeliver a delivery for an app webhook Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#remove-a-repository-from-an-app-installation">Remove a repository from an app installation Documentation</a>
     */
    ...
    /**
     * Build call for appsResetAuthorization
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#reset-an-authorization">Reset an authorization Documentation</a>
     */
    @Deprecated
    public okhttp3.Call appsResetAuthorizationCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsResetAuthorizationValidateBeforeCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling appsResetAuthorization(Async)");
        }

        // verify the required parameter 'accessToken' is set
        if (accessToken == null) {
            throw new ApiException("Missing the required parameter 'accessToken' when calling appsResetAuthorization(Async)");
        }

        return appsResetAuthorizationCall(clientId, accessToken, _callback);
     ...
     */
    @Deprecated
    public Authorization appsResetAuthorization(String clientId, String accessToken) throws ApiException {
        ApiResponse<Authorization> localVarResp = appsResetAuthorizationWithHttpInfo(clientId, accessToken);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<Authorization> appsResetAuthorizationWithHttpInfo(String clientId, String accessToken) throws ApiException {
        okhttp3.Call localVarCall = appsResetAuthorizationValidateBeforeCall(clientId, accessToken, null);
        Type localVarReturnType = new TypeToken<Authorization>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Reset an authorization (asynchronously)
     * **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain &#x60;access_token&#x60; in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving &#x60;access_token&#x60; to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).  OAuth applications can use this API method to reset a valid OAuth token without end-user involvement. Applications must save the \&quot;token\&quot; property in the response because changes take effect immediately. You must use [Basic Authentication](https://docs.github.com/enterprise-server@3.2/rest/overview/other-authentication-methods#basic-authentication) when accessing this endpoint, using the OAuth application&#39;s &#x60;client_id&#x60; and &#x60;client_secret&#x60; as the username and password. Invalid tokens will return &#x60;404 NOT FOUND&#x60;.
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call appsResetAuthorizationAsync(String clientId, String accessToken, final ApiCallback<Authorization> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsResetAuthorizationValidateBeforeCall(clientId, accessToken, _callback);
        Type localVarReturnType = new TypeToken<Authorization>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#reset-a-token">Reset a token Documentation</a>
     */
    ...
    /**
     * Build call for appsRevokeAuthorizationForApplication
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#revoke-an-authorization-for-an-application">Revoke an authorization for an application Documentation</a>
     */
    @Deprecated
    public okhttp3.Call appsRevokeAuthorizationForApplicationCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsRevokeAuthorizationForApplicationValidateBeforeCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling appsRevokeAuthorizationForApplication(Async)");
        }

        // verify the required parameter 'accessToken' is set
        if (accessToken == null) {
            throw new ApiException("Missing the required parameter 'accessToken' when calling appsRevokeAuthorizationForApplication(Async)");
        }

        return appsRevokeAuthorizationForApplicationCall(clientId, accessToken, _callback);
     ...
     */
    @Deprecated
    public void appsRevokeAuthorizationForApplication(String clientId, String accessToken) throws ApiException {
        appsRevokeAuthorizationForApplicationWithHttpInfo(clientId, accessToken);
    }
     ...
     */
    @Deprecated
    public ApiResponse<Void> appsRevokeAuthorizationForApplicationWithHttpInfo(String clientId, String accessToken) throws ApiException {
        okhttp3.Call localVarCall = appsRevokeAuthorizationForApplicationValidateBeforeCall(clientId, accessToken, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Revoke an authorization for an application (asynchronously)
     * **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain &#x60;access_token&#x60; in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving &#x60;access_token&#x60; to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).  OAuth application owners can revoke a single token for an OAuth application. You must use [Basic Authentication](https://docs.github.com/enterprise-server@3.2/rest/overview/other-authentication-methods#basic-authentication) when accessing this endpoint, using the OAuth application&#39;s &#x60;client_id&#x60; and &#x60;client_secret&#x60; as the username and password.
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call appsRevokeAuthorizationForApplicationAsync(String clientId, String accessToken, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsRevokeAuthorizationForApplicationValidateBeforeCall(clientId, accessToken, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for appsRevokeGrantForApplication
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#revoke-a-grant-for-an-application">Revoke a grant for an application Documentation</a>
     */
    @Deprecated
    public okhttp3.Call appsRevokeGrantForApplicationCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/applications/{client_id}/grants/{access_token}"
            .replace("{" + "client_id" + "}", localVarApiClient.escapeString(clientId.toString()))
            .replace("{" + "access_token" + "}", localVarApiClient.escapeString(accessToken.toString()));
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call appsRevokeGrantForApplicationValidateBeforeCall(String clientId, String accessToken, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'clientId' is set
        if (clientId == null) {
            throw new ApiException("Missing the required parameter 'clientId' when calling appsRevokeGrantForApplication(Async)");
        }

        // verify the required parameter 'accessToken' is set
        if (accessToken == null) {
            throw new ApiException("Missing the required parameter 'accessToken' when calling appsRevokeGrantForApplication(Async)");
        }

        return appsRevokeGrantForApplicationCall(clientId, accessToken, _callback);
     ...
     */
    @Deprecated
    public void appsRevokeGrantForApplication(String clientId, String accessToken) throws ApiException {
        appsRevokeGrantForApplicationWithHttpInfo(clientId, accessToken);
    }
     ...
     */
    @Deprecated
    public ApiResponse<Void> appsRevokeGrantForApplicationWithHttpInfo(String clientId, String accessToken) throws ApiException {
        okhttp3.Call localVarCall = appsRevokeGrantForApplicationValidateBeforeCall(clientId, accessToken, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Revoke a grant for an application (asynchronously)
     * **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain &#x60;access_token&#x60; in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving &#x60;access_token&#x60; to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).  OAuth application owners can revoke a grant for their OAuth application and a specific user. You must use [Basic Authentication](https://docs.github.com/enterprise-server@3.2/rest/overview/other-authentication-methods#basic-authentication) when accessing this endpoint, using the OAuth application&#39;s &#x60;client_id&#x60; and &#x60;client_secret&#x60; as the username and password. You must also provide a valid token as &#x60;:access_token&#x60; and the grant for the token&#39;s owner will be deleted.  Deleting an OAuth application&#39;s grant will also delete all OAuth tokens associated with the application for the user. Once deleted, the application will have no access to the user&#39;s account and will no longer be listed on [the Applications settings page under \&quot;Authorized OAuth Apps\&quot; on GitHub Enterprise Server](https://github.com/settings/applications#authorized).
     * @param clientId The client ID of the GitHub app. (required)
     * @param accessToken  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call appsRevokeGrantForApplicationAsync(String clientId, String accessToken, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = appsRevokeGrantForApplicationValidateBeforeCall(clientId, accessToken, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#revoke-an-installation-access-token">Revoke an installation access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#create-a-scoped-access-token">Create a scoped access token Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#suspend-an-app-installation">Suspend an app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#unsuspend-an-app-installation">Unsuspend an app installation Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.2/rest/reference/apps#update-a-webhook-configuration-for-an-app">Update a webhook configuration for an app Documentation</a>
     */
