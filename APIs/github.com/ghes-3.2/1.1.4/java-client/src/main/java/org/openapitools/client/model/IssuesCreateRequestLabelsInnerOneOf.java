...
public class IssuesCreateRequestLabelsInnerOneOf {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.color, issuesCreateRequestLabelsInnerOneOf.color) &&
        Objects.equals(this.description, issuesCreateRequestLabelsInnerOneOf.description) &&
        Objects.equals(this.id, issuesCreateRequestLabelsInnerOneOf.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssuesCreateRequestLabelsInnerOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssuesCreateRequestLabelsInnerOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssuesCreateRequestLabelsInnerOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssuesCreateRequestLabelsInnerOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
