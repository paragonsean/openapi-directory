...
public class SshKey {
  ...
  public SshKey prettyPrint(String prettyPrint) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, sshKey.key) &&
        Objects.equals(this.prettyPrint, sshKey.prettyPrint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, prettyPrint);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("pretty-print") != null && !jsonObj.get("pretty-print").isJsonNull()) && !jsonObj.get("pretty-print").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `pretty-print` to be a primitive type in the JSON string but got `%s`", jsonObj.get("pretty-print").toString()));
      }
  }
