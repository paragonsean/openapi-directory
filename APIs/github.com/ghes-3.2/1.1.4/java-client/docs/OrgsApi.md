...
> List&lt;HookDeliveryItem&gt; orgsListWebhookDeliveries(org, hookId, perPage, cursor)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<HookDeliveryItem> result = apiInstance.orgsListWebhookDeliveries(org, hookId, perPage, cursor);
      System.out.println(result);
    } catch (ApiException e) {
