...
/*
 * OAILdap_mapping_team.h
 *
 * 
 */

#ifndef OAILdap_mapping_team_H
#define OAILdap_mapping_team_H
...
class OAILdap_mapping_team : public OAIObject {
public:
    OAILdap_mapping_team();
    OAILdap_mapping_team(QString json);
    ~OAILdap_mapping_team() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILdap_mapping_team)

#endif // OAILdap_mapping_team_H
