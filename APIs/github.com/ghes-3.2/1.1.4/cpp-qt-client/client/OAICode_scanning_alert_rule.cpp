...
void OAICode_scanning_alert_rule::initializeModel() {
    ...
    m_security_severity_level_isSet = false;
    m_security_severity_level_isValid = false;
...
void OAICode_scanning_alert_rule::fromJsonObject(QJsonObject json) {
    ...
    m_help_uri_isValid = ::OpenAPI::fromJsonValue(m_help_uri, json[QString("help_uri")]);
    m_help_uri_isSet = !json[QString("help_uri")].isNull() && m_help_uri_isValid;
    ...
    m_security_severity_level_isValid = ::OpenAPI::fromJsonValue(m_security_severity_level, json[QString("security_severity_level")]);
    m_security_severity_level_isSet = !json[QString("security_severity_level")].isNull() && m_security_severity_level_isValid;
...
QJsonObject OAICode_scanning_alert_rule::asJsonObject() const {
    ...
    if (m_help_uri_isSet) {
        obj.insert(QString("help_uri"), ::OpenAPI::toJsonValue(m_help_uri));
    }
    if (m_id_isSet) {
    ...
    if (m_security_severity_level_isSet) {
        obj.insert(QString("security_severity_level"), ::OpenAPI::toJsonValue(m_security_severity_level));
    }
    if (m_severity_isSet) {
...
QString OAICode_scanning_alert_rule::getHelpUri() const {
    return m_help_uri;
}
void OAICode_scanning_alert_rule::setHelpUri(const QString &help_uri) {
    m_help_uri = help_uri;
    m_help_uri_isSet = true;
}

bool OAICode_scanning_alert_rule::is_help_uri_Set() const{
    return m_help_uri_isSet;
}

bool OAICode_scanning_alert_rule::is_help_uri_Valid() const{
...
QString OAICode_scanning_alert_rule::getSecuritySeverityLevel() const {
    return m_security_severity_level;
}
void OAICode_scanning_alert_rule::setSecuritySeverityLevel(const QString &security_severity_level) {
    m_security_severity_level = security_severity_level;
    m_security_severity_level_isSet = true;
}

bool OAICode_scanning_alert_rule::is_security_severity_level_Set() const{
    return m_security_severity_level_isSet;
}

bool OAICode_scanning_alert_rule::is_security_severity_level_Valid() const{
    return m_security_severity_level_isValid;
}
