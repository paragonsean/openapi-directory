...
#ifndef OAINullable_issue_H
#define OAINullable_issue_H
...
class OAINullable_issue : public OAIObject {
public:
    OAINullable_issue();
    OAINullable_issue(QString json);
    ~OAINullable_issue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_issue)

#endif // OAINullable_issue_H
