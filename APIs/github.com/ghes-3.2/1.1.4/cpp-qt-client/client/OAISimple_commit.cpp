...
OAINullable_simple_commit_author OAISimple_commit::getAuthor() const {
    return m_author;
}
void OAISimple_commit::setAuthor(const OAINullable_simple_commit_author &author) {
    m_author = author;
    m_author_isSet = true;
}
...
OAINullable_simple_commit_author OAISimple_commit::getCommitter() const {
    return m_committer;
}
void OAISimple_commit::setCommitter(const OAINullable_simple_commit_author &committer) {
