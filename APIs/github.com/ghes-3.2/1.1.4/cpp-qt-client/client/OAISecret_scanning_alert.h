...
/*
 * OAISecret_scanning_alert.h
 *
 * 
 */

#ifndef OAISecret_scanning_alert_H
#define OAISecret_scanning_alert_H
...
class OAISecret_scanning_alert : public OAIObject {
public:
    OAISecret_scanning_alert();
    OAISecret_scanning_alert(QString json);
    ~OAISecret_scanning_alert() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISecret_scanning_alert)

#endif // OAISecret_scanning_alert_H
