...
OAINullable_simple_user::OAINullable_simple_user(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAINullable_simple_user::OAINullable_simple_user() {
    this->initializeModel();
}

OAINullable_simple_user::~OAINullable_simple_user() {}

void OAINullable_simple_user::initializeModel() {
...
void OAINullable_simple_user::fromJson(QString jsonString) {
...
void OAINullable_simple_user::fromJsonObject(QJsonObject json) {
...
QString OAINullable_simple_user::asJson() const {
...
QJsonObject OAINullable_simple_user::asJsonObject() const {
    QJsonObject obj;
...
QString OAINullable_simple_user::getAvatarUrl() const {
    return m_avatar_url;
}
void OAINullable_simple_user::setAvatarUrl(const QString &avatar_url) {
    m_avatar_url = avatar_url;
    m_avatar_url_isSet = true;
}

bool OAINullable_simple_user::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAINullable_simple_user::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

QString OAINullable_simple_user::getEmail() const {
    return m_email;
}
void OAINullable_simple_user::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAINullable_simple_user::is_email_Set() const{
    return m_email_isSet;
}

bool OAINullable_simple_user::is_email_Valid() const{
    return m_email_isValid;
}

QString OAINullable_simple_user::getEventsUrl() const {
    return m_events_url;
}
void OAINullable_simple_user::setEventsUrl(const QString &events_url) {
    m_events_url = events_url;
    m_events_url_isSet = true;
}

bool OAINullable_simple_user::is_events_url_Set() const{
    return m_events_url_isSet;
}

bool OAINullable_simple_user::is_events_url_Valid() const{
    return m_events_url_isValid;
}

QString OAINullable_simple_user::getFollowersUrl() const {
    return m_followers_url;
}
void OAINullable_simple_user::setFollowersUrl(const QString &followers_url) {
    m_followers_url = followers_url;
    m_followers_url_isSet = true;
}

bool OAINullable_simple_user::is_followers_url_Set() const{
    return m_followers_url_isSet;
}

bool OAINullable_simple_user::is_followers_url_Valid() const{
    return m_followers_url_isValid;
}

QString OAINullable_simple_user::getFollowingUrl() const {
    return m_following_url;
}
void OAINullable_simple_user::setFollowingUrl(const QString &following_url) {
    m_following_url = following_url;
    m_following_url_isSet = true;
}

bool OAINullable_simple_user::is_following_url_Set() const{
    return m_following_url_isSet;
}

bool OAINullable_simple_user::is_following_url_Valid() const{
    return m_following_url_isValid;
}

QString OAINullable_simple_user::getGistsUrl() const {
    return m_gists_url;
}
void OAINullable_simple_user::setGistsUrl(const QString &gists_url) {
    m_gists_url = gists_url;
    m_gists_url_isSet = true;
}

bool OAINullable_simple_user::is_gists_url_Set() const{
    return m_gists_url_isSet;
}

bool OAINullable_simple_user::is_gists_url_Valid() const{
    return m_gists_url_isValid;
}

QString OAINullable_simple_user::getGravatarId() const {
    return m_gravatar_id;
}
void OAINullable_simple_user::setGravatarId(const QString &gravatar_id) {
    m_gravatar_id = gravatar_id;
    m_gravatar_id_isSet = true;
}

bool OAINullable_simple_user::is_gravatar_id_Set() const{
    return m_gravatar_id_isSet;
}

bool OAINullable_simple_user::is_gravatar_id_Valid() const{
    return m_gravatar_id_isValid;
}

QString OAINullable_simple_user::getHtmlUrl() const {
    return m_html_url;
}
void OAINullable_simple_user::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAINullable_simple_user::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAINullable_simple_user::is_html_url_Valid() const{
    return m_html_url_isValid;
}

qint32 OAINullable_simple_user::getId() const {
    return m_id;
}
void OAINullable_simple_user::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAINullable_simple_user::is_id_Set() const{
    return m_id_isSet;
}

bool OAINullable_simple_user::is_id_Valid() const{
    return m_id_isValid;
}

QString OAINullable_simple_user::getLogin() const {
    return m_login;
}
void OAINullable_simple_user::setLogin(const QString &login) {
    m_login = login;
    m_login_isSet = true;
}

bool OAINullable_simple_user::is_login_Set() const{
    return m_login_isSet;
}

bool OAINullable_simple_user::is_login_Valid() const{
    return m_login_isValid;
}

QString OAINullable_simple_user::getName() const {
    return m_name;
}
void OAINullable_simple_user::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAINullable_simple_user::is_name_Set() const{
    return m_name_isSet;
}

bool OAINullable_simple_user::is_name_Valid() const{
    return m_name_isValid;
}

QString OAINullable_simple_user::getNodeId() const {
    return m_node_id;
}
void OAINullable_simple_user::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAINullable_simple_user::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAINullable_simple_user::is_node_id_Valid() const{
    return m_node_id_isValid;
}

QString OAINullable_simple_user::getOrganizationsUrl() const {
    return m_organizations_url;
}
void OAINullable_simple_user::setOrganizationsUrl(const QString &organizations_url) {
    m_organizations_url = organizations_url;
    m_organizations_url_isSet = true;
}

bool OAINullable_simple_user::is_organizations_url_Set() const{
    return m_organizations_url_isSet;
}

bool OAINullable_simple_user::is_organizations_url_Valid() const{
    return m_organizations_url_isValid;
}

QString OAINullable_simple_user::getReceivedEventsUrl() const {
    return m_received_events_url;
}
void OAINullable_simple_user::setReceivedEventsUrl(const QString &received_events_url) {
    m_received_events_url = received_events_url;
    m_received_events_url_isSet = true;
}

bool OAINullable_simple_user::is_received_events_url_Set() const{
    return m_received_events_url_isSet;
}

bool OAINullable_simple_user::is_received_events_url_Valid() const{
    return m_received_events_url_isValid;
}

QString OAINullable_simple_user::getReposUrl() const {
    return m_repos_url;
}
void OAINullable_simple_user::setReposUrl(const QString &repos_url) {
    m_repos_url = repos_url;
    m_repos_url_isSet = true;
}

bool OAINullable_simple_user::is_repos_url_Set() const{
    return m_repos_url_isSet;
}

bool OAINullable_simple_user::is_repos_url_Valid() const{
    return m_repos_url_isValid;
}

bool OAINullable_simple_user::isSiteAdmin() const {
    return m_site_admin;
}
void OAINullable_simple_user::setSiteAdmin(const bool &site_admin) {
    m_site_admin = site_admin;
    m_site_admin_isSet = true;
}

bool OAINullable_simple_user::is_site_admin_Set() const{
    return m_site_admin_isSet;
}

bool OAINullable_simple_user::is_site_admin_Valid() const{
    return m_site_admin_isValid;
}

QString OAINullable_simple_user::getStarredAt() const {
    return m_starred_at;
}
void OAINullable_simple_user::setStarredAt(const QString &starred_at) {
    m_starred_at = starred_at;
    m_starred_at_isSet = true;
}

bool OAINullable_simple_user::is_starred_at_Set() const{
    return m_starred_at_isSet;
}

bool OAINullable_simple_user::is_starred_at_Valid() const{
    return m_starred_at_isValid;
}

QString OAINullable_simple_user::getStarredUrl() const {
    return m_starred_url;
}
void OAINullable_simple_user::setStarredUrl(const QString &starred_url) {
    m_starred_url = starred_url;
    m_starred_url_isSet = true;
}

bool OAINullable_simple_user::is_starred_url_Set() const{
    return m_starred_url_isSet;
}

bool OAINullable_simple_user::is_starred_url_Valid() const{
    return m_starred_url_isValid;
}

QString OAINullable_simple_user::getSubscriptionsUrl() const {
    return m_subscriptions_url;
}
void OAINullable_simple_user::setSubscriptionsUrl(const QString &subscriptions_url) {
    m_subscriptions_url = subscriptions_url;
    m_subscriptions_url_isSet = true;
}

bool OAINullable_simple_user::is_subscriptions_url_Set() const{
    return m_subscriptions_url_isSet;
}

bool OAINullable_simple_user::is_subscriptions_url_Valid() const{
    return m_subscriptions_url_isValid;
}

QString OAINullable_simple_user::getType() const {
    return m_type;
}
void OAINullable_simple_user::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAINullable_simple_user::is_type_Set() const{
    return m_type_isSet;
}

bool OAINullable_simple_user::is_type_Valid() const{
    return m_type_isValid;
}

QString OAINullable_simple_user::getUrl() const {
    return m_url;
}
void OAINullable_simple_user::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAINullable_simple_user::is_url_Set() const{
    return m_url_isSet;
}

bool OAINullable_simple_user::is_url_Valid() const{
    return m_url_isValid;
}

bool OAINullable_simple_user::isSet() const {
...
bool OAINullable_simple_user::isValid() const {
