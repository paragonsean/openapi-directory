...
public:
    ...
    * @param[in]  page qint32 [optional]
    */
    virtual void repos_listCollaborators(const QString &owner, const QString &repo, const ::OpenAPI::OptionalParam<QString> &affiliation = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &permission = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
    ...
    */
    virtual void repos_listWebhookDeliveries(const QString &owner, const QString &repo, const qint32 &hook_id, const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &cursor = ::OpenAPI::OptionalParam<QString>());
