...
QDateTime OAINullable_authorization::getExpiresAt() const {
    return m_expires_at;
}
void OAINullable_authorization::setExpiresAt(const QDateTime &expires_at) {
    m_expires_at = expires_at;
    m_expires_at_isSet = true;
}

bool OAINullable_authorization::is_expires_at_Set() const{
    return m_expires_at_isSet;
}

bool OAINullable_authorization::is_expires_at_Valid() const{
