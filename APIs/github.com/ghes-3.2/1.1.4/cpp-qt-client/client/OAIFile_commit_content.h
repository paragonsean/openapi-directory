...
/*
 * OAIFile_commit_content.h
 *
 * 
 */

#ifndef OAIFile_commit_content_H
#define OAIFile_commit_content_H
...
namespace OpenAPI {
class OAIFile_commit_content__links;

class OAIFile_commit_content : public OAIObject {
public:
    OAIFile_commit_content();
    OAIFile_commit_content(QString json);
    ~OAIFile_commit_content() override;
    ...
    OAIFile_commit_content__links getLinks() const;
    void setLinks(const OAIFile_commit_content__links &_links);
...
private:
    ...
    OAIFile_commit_content__links m__links;
    bool m__links_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFile_commit_content)

#endif // OAIFile_commit_content_H
