...
/*
 * OAIFull_repository.h
 *
 * Full Repository
 */

#ifndef OAIFull_repository_H
#define OAIFull_repository_H
...
namespace OpenAPI {
class OAICode_of_conduct_simple;
class OAINullable_license_simple;
class OAINullable_simple_user;
class OAISimple_user;
class OAIRepository;
class OAICollaborator_permissions;
class OAISecurity_and_analysis;
class OAINullable_repository;

class OAIFull_repository : public OAIObject {
public:
    OAIFull_repository();
    OAIFull_repository(QString json);
    ~OAIFull_repository() override;
    ...
    OAICode_of_conduct_simple getCodeOfConduct() const;
    void setCodeOfConduct(const OAICode_of_conduct_simple &code_of_conduct);
    ...
    OAISecurity_and_analysis getSecurityAndAnalysis() const;
    void setSecurityAndAnalysis(const OAISecurity_and_analysis &security_and_analysis);
    ...
    OAIRepository getSource() const;
    void setSource(const OAIRepository &source);
...
private:
    ...
    OAICode_of_conduct_simple m_code_of_conduct;
    ...
    OAISecurity_and_analysis m_security_and_analysis;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFull_repository)

#endif // OAIFull_repository_H
