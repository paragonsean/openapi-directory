...
QString OAIIssues_update_request::getStateReason() const {
    return m_state_reason;
}
void OAIIssues_update_request::setStateReason(const QString &state_reason) {
    m_state_reason = state_reason;
    m_state_reason_isSet = true;
}

bool OAIIssues_update_request::is_state_reason_Set() const{
    return m_state_reason_isSet;
}

bool OAIIssues_update_request::is_state_reason_Valid() const{
