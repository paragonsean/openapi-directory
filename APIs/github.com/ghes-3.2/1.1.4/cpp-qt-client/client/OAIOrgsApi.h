...
public:
    ...
    */
    virtual void orgs_listWebhookDeliveries(const QString &org, const qint32 &hook_id, const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &cursor = ::OpenAPI::OptionalParam<QString>());
