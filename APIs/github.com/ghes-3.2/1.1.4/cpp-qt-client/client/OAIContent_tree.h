...
class OAIContent_tree_entries_inner;
...
public:
    ...
    QList<OAIContent_tree_entries_inner> getEntries() const;
    void setEntries(const QList<OAIContent_tree_entries_inner> &entries);
...
private:
    ...
    QList<OAIContent_tree_entries_inner> m_entries;
