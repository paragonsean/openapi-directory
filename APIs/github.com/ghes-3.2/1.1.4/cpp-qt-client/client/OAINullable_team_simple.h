...
/*
 * OAINullable_team_simple.h
 *
 * Groups of organization members that gives permissions on specified repositories.
 */

#ifndef OAINullable_team_simple_H
#define OAINullable_team_simple_H
...
class OAINullable_team_simple : public OAIObject {
public:
    OAINullable_team_simple();
    OAINullable_team_simple(QString json);
    ~OAINullable_team_simple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_team_simple)

#endif // OAINullable_team_simple_H
