...
#include "OAIActions_create_or_update_environment_secret_request.h"
...
public:
    ...
    * @param[in]  secret_name QString [required]
    * @param[in]  oai_actions_create_or_update_environment_secret_request OAIActions_create_or_update_environment_secret_request [required]
    */
    virtual void actions_createOrUpdateEnvironmentSecret(const qint32 &repository_id, const QString &environment_name, const QString &secret_name, const OAIActions_create_or_update_environment_secret_request &oai_actions_create_or_update_environment_secret_request);
    ...
    * @param[in]  secret_name QString [required]
    */
    virtual void actions_deleteEnvironmentSecret(const qint32 &repository_id, const QString &environment_name, const QString &secret_name);
    ...
    * @param[in]  environment_name QString [required]
    */
    virtual void actions_getEnvironmentPublicKey(const qint32 &repository_id, const QString &environment_name);
    ...
    * @param[in]  secret_name QString [required]
    */
    virtual void actions_getEnvironmentSecret(const qint32 &repository_id, const QString &environment_name, const QString &secret_name);
    ...
    * @param[in]  run_id qint32 [required]
    */
    virtual void actions_getPendingDeploymentsForRun(const QString &owner, const QString &repo, const qint32 &run_id);
    ...
    * @param[in]  run_id qint32 [required]
    */
    virtual void actions_getReviewsForRun(const QString &owner, const QString &repo, const qint32 &run_id);
    ...
    */
    virtual void actions_listArtifactsForRepo(const QString &owner, const QString &repo, const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &name = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  page qint32 [optional]
    */
    virtual void actions_listEnvironmentSecrets(const qint32 &repository_id, const QString &environment_name, const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
    ...
    */
    virtual void actions_reRunWorkflow(const QString &owner, const QString &repo, const qint32 &run_id, const ::OpenAPI::OptionalParam<OAIObject> &body = ::OpenAPI::OptionalParam<OAIObject>());
    ...
    * @param[in]  repo QString [required]
    * @param[in]  run_id qint32 [required]
    * @param[in]  oai_actions_review_pending_deployments_for_run_request OAIActions_review_pending_deployments_for_run_request [required]
    */
    virtual void actions_reviewPendingDeploymentsForRun(const QString &owner, const QString &repo, const qint32 &run_id, const OAIActions_review_pending_deployments_for_run_request &oai_actions_review_pending_deployments_for_run_request);
...
private:
    ...
    void actions_createOrUpdateEnvironmentSecretCallback(OAIHttpRequestWorker *worker);
    ...
    void actions_deleteEnvironmentSecretCallback(OAIHttpRequestWorker *worker);
    ...
    void actions_getEnvironmentPublicKeyCallback(OAIHttpRequestWorker *worker);
    void actions_getEnvironmentSecretCallback(OAIHttpRequestWorker *worker);
    ...
    void actions_getPendingDeploymentsForRunCallback(OAIHttpRequestWorker *worker);
    ...
    void actions_getReviewsForRunCallback(OAIHttpRequestWorker *worker);
    ...
    void actions_listEnvironmentSecretsCallback(OAIHttpRequestWorker *worker);
    ...
    void actions_reviewPendingDeploymentsForRunCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void actions_createOrUpdateEnvironmentSecretSignal(OAIObject summary);
    ...
    void actions_deleteEnvironmentSecretSignal();
    ...
    void actions_getEnvironmentPublicKeySignal(OAIActions_public_key summary);
    void actions_getEnvironmentSecretSignal(OAIActions_secret summary);
    ...
    void actions_getPendingDeploymentsForRunSignal(QList<OAIPending_deployment> summary);
    ...
    void actions_getReviewsForRunSignal(QList<OAIEnvironment_approvals> summary);
    ...
    void actions_listEnvironmentSecretsSignal(OAIActions_list_repo_secrets_200_response summary);
    ...
    void actions_reviewPendingDeploymentsForRunSignal(QList<OAIDeployment> summary);
    ...
    void actions_createOrUpdateEnvironmentSecretSignalFull(OAIHttpRequestWorker *worker, OAIObject summary);
    ...
    void actions_deleteEnvironmentSecretSignalFull(OAIHttpRequestWorker *worker);
    ...
    void actions_getEnvironmentPublicKeySignalFull(OAIHttpRequestWorker *worker, OAIActions_public_key summary);
    void actions_getEnvironmentSecretSignalFull(OAIHttpRequestWorker *worker, OAIActions_secret summary);
    ...
    void actions_getPendingDeploymentsForRunSignalFull(OAIHttpRequestWorker *worker, QList<OAIPending_deployment> summary);
    ...
    void actions_getReviewsForRunSignalFull(OAIHttpRequestWorker *worker, QList<OAIEnvironment_approvals> summary);
    ...
    void actions_listEnvironmentSecretsSignalFull(OAIHttpRequestWorker *worker, OAIActions_list_repo_secrets_200_response summary);
    ...
    void actions_reviewPendingDeploymentsForRunSignalFull(OAIHttpRequestWorker *worker, QList<OAIDeployment> summary);
    ...
    Q_DECL_DEPRECATED_X("Use actions_createOrUpdateEnvironmentSecretSignalError() instead")
    void actions_createOrUpdateEnvironmentSecretSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_createOrUpdateEnvironmentSecretSignalError(OAIObject summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_deleteEnvironmentSecretSignalError() instead")
    void actions_deleteEnvironmentSecretSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void actions_deleteEnvironmentSecretSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_getEnvironmentPublicKeySignalError() instead")
    void actions_getEnvironmentPublicKeySignalE(OAIActions_public_key summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getEnvironmentPublicKeySignalError(OAIActions_public_key summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actions_getEnvironmentSecretSignalError() instead")
    void actions_getEnvironmentSecretSignalE(OAIActions_secret summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getEnvironmentSecretSignalError(OAIActions_secret summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_getPendingDeploymentsForRunSignalError() instead")
    void actions_getPendingDeploymentsForRunSignalE(QList<OAIPending_deployment> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getPendingDeploymentsForRunSignalError(QList<OAIPending_deployment> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_getReviewsForRunSignalError() instead")
    void actions_getReviewsForRunSignalE(QList<OAIEnvironment_approvals> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getReviewsForRunSignalError(QList<OAIEnvironment_approvals> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_listEnvironmentSecretsSignalError() instead")
    void actions_listEnvironmentSecretsSignalE(OAIActions_list_repo_secrets_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_listEnvironmentSecretsSignalError(OAIActions_list_repo_secrets_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_reviewPendingDeploymentsForRunSignalError() instead")
    void actions_reviewPendingDeploymentsForRunSignalE(QList<OAIDeployment> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_reviewPendingDeploymentsForRunSignalError(QList<OAIDeployment> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_createOrUpdateEnvironmentSecretSignalErrorFull() instead")
    void actions_createOrUpdateEnvironmentSecretSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_createOrUpdateEnvironmentSecretSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_deleteEnvironmentSecretSignalErrorFull() instead")
    void actions_deleteEnvironmentSecretSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_deleteEnvironmentSecretSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_getEnvironmentPublicKeySignalErrorFull() instead")
    void actions_getEnvironmentPublicKeySignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getEnvironmentPublicKeySignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use actions_getEnvironmentSecretSignalErrorFull() instead")
    void actions_getEnvironmentSecretSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getEnvironmentSecretSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_getPendingDeploymentsForRunSignalErrorFull() instead")
    void actions_getPendingDeploymentsForRunSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getPendingDeploymentsForRunSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_getReviewsForRunSignalErrorFull() instead")
    void actions_getReviewsForRunSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_getReviewsForRunSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_listEnvironmentSecretsSignalErrorFull() instead")
    void actions_listEnvironmentSecretsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_listEnvironmentSecretsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use actions_reviewPendingDeploymentsForRunSignalErrorFull() instead")
    void actions_reviewPendingDeploymentsForRunSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void actions_reviewPendingDeploymentsForRunSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
