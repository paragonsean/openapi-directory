...
/*
 * OAIReview_requested_issue_event.h
 *
 * Review Requested Issue Event
 */

#ifndef OAIReview_requested_issue_event_H
#define OAIReview_requested_issue_event_H
...
class OAIReview_requested_issue_event : public OAIObject {
public:
    OAIReview_requested_issue_event();
    OAIReview_requested_issue_event(QString json);
    ~OAIReview_requested_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReview_requested_issue_event)

#endif // OAIReview_requested_issue_event_H
