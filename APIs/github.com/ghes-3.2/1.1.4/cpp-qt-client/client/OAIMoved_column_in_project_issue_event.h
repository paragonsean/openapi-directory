...
/*
 * OAIMoved_column_in_project_issue_event.h
 *
 * Moved Column in Project Issue Event
 */

#ifndef OAIMoved_column_in_project_issue_event_H
#define OAIMoved_column_in_project_issue_event_H
...
class OAIMoved_column_in_project_issue_event : public OAIObject {
public:
    OAIMoved_column_in_project_issue_event();
    OAIMoved_column_in_project_issue_event(QString json);
    ~OAIMoved_column_in_project_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMoved_column_in_project_issue_event)

#endif // OAIMoved_column_in_project_issue_event_H
