...
OAIPublic_user::OAIPublic_user(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPublic_user::OAIPublic_user() {
    this->initializeModel();
}

OAIPublic_user::~OAIPublic_user() {}

void OAIPublic_user::initializeModel() {
...
void OAIPublic_user::fromJson(QString jsonString) {
...
void OAIPublic_user::fromJsonObject(QJsonObject json) {
...
QString OAIPublic_user::asJson() const {
...
QJsonObject OAIPublic_user::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPublic_user::getAvatarUrl() const {
    return m_avatar_url;
}
void OAIPublic_user::setAvatarUrl(const QString &avatar_url) {
    m_avatar_url = avatar_url;
    m_avatar_url_isSet = true;
}

bool OAIPublic_user::is_avatar_url_Set() const{
    return m_avatar_url_isSet;
}

bool OAIPublic_user::is_avatar_url_Valid() const{
    return m_avatar_url_isValid;
}

QString OAIPublic_user::getBio() const {
    return m_bio;
}
void OAIPublic_user::setBio(const QString &bio) {
    m_bio = bio;
    m_bio_isSet = true;
}

bool OAIPublic_user::is_bio_Set() const{
    return m_bio_isSet;
}

bool OAIPublic_user::is_bio_Valid() const{
    return m_bio_isValid;
}

QString OAIPublic_user::getBlog() const {
    return m_blog;
}
void OAIPublic_user::setBlog(const QString &blog) {
    m_blog = blog;
    m_blog_isSet = true;
}

bool OAIPublic_user::is_blog_Set() const{
    return m_blog_isSet;
}

bool OAIPublic_user::is_blog_Valid() const{
    return m_blog_isValid;
}

qint32 OAIPublic_user::getCollaborators() const {
    return m_collaborators;
}
void OAIPublic_user::setCollaborators(const qint32 &collaborators) {
    m_collaborators = collaborators;
    m_collaborators_isSet = true;
}

bool OAIPublic_user::is_collaborators_Set() const{
    return m_collaborators_isSet;
}

bool OAIPublic_user::is_collaborators_Valid() const{
    return m_collaborators_isValid;
}

QString OAIPublic_user::getCompany() const {
    return m_company;
}
void OAIPublic_user::setCompany(const QString &company) {
    m_company = company;
    m_company_isSet = true;
}

bool OAIPublic_user::is_company_Set() const{
    return m_company_isSet;
}

bool OAIPublic_user::is_company_Valid() const{
    return m_company_isValid;
}

QDateTime OAIPublic_user::getCreatedAt() const {
    return m_created_at;
}
void OAIPublic_user::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIPublic_user::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIPublic_user::is_created_at_Valid() const{
    return m_created_at_isValid;
}

qint32 OAIPublic_user::getDiskUsage() const {
    return m_disk_usage;
}
void OAIPublic_user::setDiskUsage(const qint32 &disk_usage) {
    m_disk_usage = disk_usage;
    m_disk_usage_isSet = true;
}

bool OAIPublic_user::is_disk_usage_Set() const{
    return m_disk_usage_isSet;
}

bool OAIPublic_user::is_disk_usage_Valid() const{
    return m_disk_usage_isValid;
}

QString OAIPublic_user::getEmail() const {
    return m_email;
}
void OAIPublic_user::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIPublic_user::is_email_Set() const{
    return m_email_isSet;
}

bool OAIPublic_user::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIPublic_user::getEventsUrl() const {
    return m_events_url;
}
void OAIPublic_user::setEventsUrl(const QString &events_url) {
    m_events_url = events_url;
    m_events_url_isSet = true;
}

bool OAIPublic_user::is_events_url_Set() const{
    return m_events_url_isSet;
}

bool OAIPublic_user::is_events_url_Valid() const{
    return m_events_url_isValid;
}

qint32 OAIPublic_user::getFollowers() const {
    return m_followers;
}
void OAIPublic_user::setFollowers(const qint32 &followers) {
    m_followers = followers;
    m_followers_isSet = true;
}

bool OAIPublic_user::is_followers_Set() const{
    return m_followers_isSet;
}

bool OAIPublic_user::is_followers_Valid() const{
    return m_followers_isValid;
}

QString OAIPublic_user::getFollowersUrl() const {
    return m_followers_url;
}
void OAIPublic_user::setFollowersUrl(const QString &followers_url) {
    m_followers_url = followers_url;
    m_followers_url_isSet = true;
}

bool OAIPublic_user::is_followers_url_Set() const{
    return m_followers_url_isSet;
}

bool OAIPublic_user::is_followers_url_Valid() const{
    return m_followers_url_isValid;
}

qint32 OAIPublic_user::getFollowing() const {
    return m_following;
}
void OAIPublic_user::setFollowing(const qint32 &following) {
    m_following = following;
    m_following_isSet = true;
}

bool OAIPublic_user::is_following_Set() const{
    return m_following_isSet;
}

bool OAIPublic_user::is_following_Valid() const{
    return m_following_isValid;
}

QString OAIPublic_user::getFollowingUrl() const {
    return m_following_url;
}
void OAIPublic_user::setFollowingUrl(const QString &following_url) {
    m_following_url = following_url;
    m_following_url_isSet = true;
}

bool OAIPublic_user::is_following_url_Set() const{
    return m_following_url_isSet;
}

bool OAIPublic_user::is_following_url_Valid() const{
    return m_following_url_isValid;
}

QString OAIPublic_user::getGistsUrl() const {
    return m_gists_url;
}
void OAIPublic_user::setGistsUrl(const QString &gists_url) {
    m_gists_url = gists_url;
    m_gists_url_isSet = true;
}

bool OAIPublic_user::is_gists_url_Set() const{
    return m_gists_url_isSet;
}

bool OAIPublic_user::is_gists_url_Valid() const{
    return m_gists_url_isValid;
}

QString OAIPublic_user::getGravatarId() const {
    return m_gravatar_id;
}
void OAIPublic_user::setGravatarId(const QString &gravatar_id) {
    m_gravatar_id = gravatar_id;
    m_gravatar_id_isSet = true;
}

bool OAIPublic_user::is_gravatar_id_Set() const{
    return m_gravatar_id_isSet;
}

bool OAIPublic_user::is_gravatar_id_Valid() const{
    return m_gravatar_id_isValid;
}

bool OAIPublic_user::isHireable() const {
    return m_hireable;
}
void OAIPublic_user::setHireable(const bool &hireable) {
    m_hireable = hireable;
    m_hireable_isSet = true;
}

bool OAIPublic_user::is_hireable_Set() const{
    return m_hireable_isSet;
}

bool OAIPublic_user::is_hireable_Valid() const{
    return m_hireable_isValid;
}

QString OAIPublic_user::getHtmlUrl() const {
    return m_html_url;
}
void OAIPublic_user::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAIPublic_user::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAIPublic_user::is_html_url_Valid() const{
    return m_html_url_isValid;
}

qint32 OAIPublic_user::getId() const {
    return m_id;
}
void OAIPublic_user::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIPublic_user::is_id_Set() const{
    return m_id_isSet;
}

bool OAIPublic_user::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIPublic_user::getLocation() const {
    return m_location;
}
void OAIPublic_user::setLocation(const QString &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPublic_user::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPublic_user::is_location_Valid() const{
    return m_location_isValid;
}

QString OAIPublic_user::getLogin() const {
    return m_login;
}
void OAIPublic_user::setLogin(const QString &login) {
    m_login = login;
    m_login_isSet = true;
}

bool OAIPublic_user::is_login_Set() const{
    return m_login_isSet;
}

bool OAIPublic_user::is_login_Valid() const{
    return m_login_isValid;
}

QString OAIPublic_user::getName() const {
    return m_name;
}
void OAIPublic_user::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPublic_user::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPublic_user::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPublic_user::getNodeId() const {
    return m_node_id;
}
void OAIPublic_user::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAIPublic_user::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAIPublic_user::is_node_id_Valid() const{
    return m_node_id_isValid;
}

QString OAIPublic_user::getOrganizationsUrl() const {
    return m_organizations_url;
}
void OAIPublic_user::setOrganizationsUrl(const QString &organizations_url) {
    m_organizations_url = organizations_url;
    m_organizations_url_isSet = true;
}

bool OAIPublic_user::is_organizations_url_Set() const{
    return m_organizations_url_isSet;
}

bool OAIPublic_user::is_organizations_url_Valid() const{
    return m_organizations_url_isValid;
}

qint32 OAIPublic_user::getOwnedPrivateRepos() const {
    return m_owned_private_repos;
}
void OAIPublic_user::setOwnedPrivateRepos(const qint32 &owned_private_repos) {
    m_owned_private_repos = owned_private_repos;
    m_owned_private_repos_isSet = true;
}

bool OAIPublic_user::is_owned_private_repos_Set() const{
    return m_owned_private_repos_isSet;
}

bool OAIPublic_user::is_owned_private_repos_Valid() const{
    return m_owned_private_repos_isValid;
}

OAILdap_mapping_user_plan OAIPublic_user::getPlan() const {
    return m_plan;
}
void OAIPublic_user::setPlan(const OAILdap_mapping_user_plan &plan) {
    m_plan = plan;
    m_plan_isSet = true;
}

bool OAIPublic_user::is_plan_Set() const{
    return m_plan_isSet;
}

bool OAIPublic_user::is_plan_Valid() const{
    return m_plan_isValid;
}

qint32 OAIPublic_user::getPrivateGists() const {
    return m_private_gists;
}
void OAIPublic_user::setPrivateGists(const qint32 &private_gists) {
    m_private_gists = private_gists;
    m_private_gists_isSet = true;
}

bool OAIPublic_user::is_private_gists_Set() const{
    return m_private_gists_isSet;
}

bool OAIPublic_user::is_private_gists_Valid() const{
    return m_private_gists_isValid;
}

qint32 OAIPublic_user::getPublicGists() const {
    return m_public_gists;
}
void OAIPublic_user::setPublicGists(const qint32 &public_gists) {
    m_public_gists = public_gists;
    m_public_gists_isSet = true;
}

bool OAIPublic_user::is_public_gists_Set() const{
    return m_public_gists_isSet;
}

bool OAIPublic_user::is_public_gists_Valid() const{
    return m_public_gists_isValid;
}

qint32 OAIPublic_user::getPublicRepos() const {
    return m_public_repos;
}
void OAIPublic_user::setPublicRepos(const qint32 &public_repos) {
    m_public_repos = public_repos;
    m_public_repos_isSet = true;
}

bool OAIPublic_user::is_public_repos_Set() const{
    return m_public_repos_isSet;
}

bool OAIPublic_user::is_public_repos_Valid() const{
    return m_public_repos_isValid;
}

QString OAIPublic_user::getReceivedEventsUrl() const {
    return m_received_events_url;
}
void OAIPublic_user::setReceivedEventsUrl(const QString &received_events_url) {
    m_received_events_url = received_events_url;
    m_received_events_url_isSet = true;
}

bool OAIPublic_user::is_received_events_url_Set() const{
    return m_received_events_url_isSet;
}

bool OAIPublic_user::is_received_events_url_Valid() const{
    return m_received_events_url_isValid;
}

QString OAIPublic_user::getReposUrl() const {
    return m_repos_url;
}
void OAIPublic_user::setReposUrl(const QString &repos_url) {
    m_repos_url = repos_url;
    m_repos_url_isSet = true;
}

bool OAIPublic_user::is_repos_url_Set() const{
    return m_repos_url_isSet;
}

bool OAIPublic_user::is_repos_url_Valid() const{
    return m_repos_url_isValid;
}

bool OAIPublic_user::isSiteAdmin() const {
    return m_site_admin;
}
void OAIPublic_user::setSiteAdmin(const bool &site_admin) {
    m_site_admin = site_admin;
    m_site_admin_isSet = true;
}

bool OAIPublic_user::is_site_admin_Set() const{
    return m_site_admin_isSet;
}

bool OAIPublic_user::is_site_admin_Valid() const{
    return m_site_admin_isValid;
}

QString OAIPublic_user::getStarredUrl() const {
    return m_starred_url;
}
void OAIPublic_user::setStarredUrl(const QString &starred_url) {
    m_starred_url = starred_url;
    m_starred_url_isSet = true;
}

bool OAIPublic_user::is_starred_url_Set() const{
    return m_starred_url_isSet;
}

bool OAIPublic_user::is_starred_url_Valid() const{
    return m_starred_url_isValid;
}

QString OAIPublic_user::getSubscriptionsUrl() const {
    return m_subscriptions_url;
}
void OAIPublic_user::setSubscriptionsUrl(const QString &subscriptions_url) {
    m_subscriptions_url = subscriptions_url;
    m_subscriptions_url_isSet = true;
}

bool OAIPublic_user::is_subscriptions_url_Set() const{
    return m_subscriptions_url_isSet;
}

bool OAIPublic_user::is_subscriptions_url_Valid() const{
    return m_subscriptions_url_isValid;
}

QDateTime OAIPublic_user::getSuspendedAt() const {
    return m_suspended_at;
}
void OAIPublic_user::setSuspendedAt(const QDateTime &suspended_at) {
    m_suspended_at = suspended_at;
    m_suspended_at_isSet = true;
}

bool OAIPublic_user::is_suspended_at_Set() const{
    return m_suspended_at_isSet;
}

bool OAIPublic_user::is_suspended_at_Valid() const{
    return m_suspended_at_isValid;
}

qint32 OAIPublic_user::getTotalPrivateRepos() const {
    return m_total_private_repos;
}
void OAIPublic_user::setTotalPrivateRepos(const qint32 &total_private_repos) {
    m_total_private_repos = total_private_repos;
    m_total_private_repos_isSet = true;
}

bool OAIPublic_user::is_total_private_repos_Set() const{
    return m_total_private_repos_isSet;
}

bool OAIPublic_user::is_total_private_repos_Valid() const{
    return m_total_private_repos_isValid;
}

QString OAIPublic_user::getTwitterUsername() const {
    return m_twitter_username;
}
void OAIPublic_user::setTwitterUsername(const QString &twitter_username) {
    m_twitter_username = twitter_username;
    m_twitter_username_isSet = true;
}

bool OAIPublic_user::is_twitter_username_Set() const{
    return m_twitter_username_isSet;
}

bool OAIPublic_user::is_twitter_username_Valid() const{
    return m_twitter_username_isValid;
}

QString OAIPublic_user::getType() const {
    return m_type;
}
void OAIPublic_user::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPublic_user::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPublic_user::is_type_Valid() const{
    return m_type_isValid;
}

QDateTime OAIPublic_user::getUpdatedAt() const {
    return m_updated_at;
}
void OAIPublic_user::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIPublic_user::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIPublic_user::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIPublic_user::getUrl() const {
    return m_url;
}
void OAIPublic_user::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIPublic_user::is_url_Set() const{
    return m_url_isSet;
}

bool OAIPublic_user::is_url_Valid() const{
    return m_url_isValid;
}

bool OAIPublic_user::isSet() const {
...
bool OAIPublic_user::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_avatar_url_isValid && m_bio_isValid && m_blog_isValid && m_company_isValid && m_created_at_isValid && m_email_isValid && m_events_url_isValid && m_followers_isValid && m_followers_url_isValid && m_following_isValid && m_following_url_isValid && m_gists_url_isValid && m_gravatar_id_isValid && m_hireable_isValid && m_html_url_isValid && m_id_isValid && m_location_isValid && m_login_isValid && m_name_isValid && m_node_id_isValid && m_organizations_url_isValid && m_public_gists_isValid && m_public_repos_isValid && m_received_events_url_isValid && m_repos_url_isValid && m_site_admin_isValid && m_starred_url_isValid && m_subscriptions_url_isValid && m_type_isValid && m_updated_at_isValid && m_url_isValid && true;
}
