...
public class CallResponse {
  ...
  public CallResponse message(MessageEnum message) {
  ...
  public CallResponse requestUUID(String requestUUID) {
  ...
  public CallResponse restApiServer(String restApiServer) {
  ...
  public CallResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, callResponse.message) &&
        Objects.equals(this.requestUUID, callResponse.requestUUID) &&
        Objects.equals(this.restApiServer, callResponse.restApiServer) &&
        Objects.equals(this.success, callResponse.success);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CallResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CallResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CallResponse is not found in the empty JSON string", CallResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CallResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CallResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CallResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CallResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CallResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CallResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CallResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CallResponse>() {
           @Override
           public void write(JsonWriter out, CallResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CallResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CallResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CallResponse
   * @throws IOException if the JSON string is invalid with respect to CallResponse
   */
  public static CallResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CallResponse.class);
  }

  /**
   * Convert an instance of CallResponse to an JSON string
   *
   * @return JSON string
   */
