...
class Page(Model):
    ...
    def __init__(self, cname: str=None, custom_404: bool=False, html_url: str=None, https_certificate: PagesHttpsCertificate=None, https_enforced: bool=None, public: bool=None, source: PagesSourceHash=None, status: str=None, url: str=None):
