...
async def repos_accept_invitation(request: web.Request, invitation_id) -> web.Response:
...
async def repos_decline_invitation(request: web.Request, invitation_id) -> web.Response:
...
async def repos_update_webhook(request: web.Request, owner, repo, hook_id, body=None) -> web.Response:
