...
async def test_checks_create(client):
    ...
    response = await client.request(
        method='POST',
        path='/api/v3/repos/{owner}/{repo}/check-runs'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
...
async def test_checks_create_suite(client):
    ...
    response = await client.request(
        method='POST',
        path='/api/v3/repos/{owner}/{repo}/check-suites'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_get(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/v3/repos/{owner}/{repo}/check-runs/{check_run_id}'.format(owner='owner_example', repo='repo_example', check_run_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_get_suite(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/v3/repos/{owner}/{repo}/check-suites/{check_suite_id}'.format(owner='owner_example', repo='repo_example', check_suite_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_list_annotations(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/v3/repos/{owner}/{repo}/check-runs/{check_run_id}/annotations'.format(owner='owner_example', repo='repo_example', check_run_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_list_for_ref(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/v3/repos/{owner}/{repo}/commits/{ref}/check-runs'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_list_for_suite(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/v3/repos/{owner}/{repo}/check-suites/{check_suite_id}/check-runs'.format(owner='owner_example', repo='repo_example', check_suite_id=56),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_list_suites_for_ref(client):
    ...
    response = await client.request(
        method='GET',
        path='/api/v3/repos/{owner}/{repo}/commits/{ref}/check-suites'.format(owner='owner_example', repo='repo_example', ref='ref_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_rerequest_suite(client):
    ...
    response = await client.request(
        method='POST',
        path='/api/v3/repos/{owner}/{repo}/check-suites/{check_suite_id}/rerequest'.format(owner='owner_example', repo='repo_example', check_suite_id=56),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_checks_set_suites_preferences(client):
    ...
    response = await client.request(
        method='PATCH',
        path='/api/v3/repos/{owner}/{repo}/check-suites/preferences'.format(owner='owner_example', repo='repo_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
