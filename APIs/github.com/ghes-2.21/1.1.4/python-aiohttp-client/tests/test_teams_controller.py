...
async def test_teams_add_or_update_membership_for_user_in_org(client):
    ...
    """
    body = openapi_server.TeamsAddOrUpdateMembershipForUserInOrgRequest()
    headers = { 
        'Accept': 'application/json',
...
async def test_teams_add_or_update_project_permissions_in_org(client):
    ...
    """
    body = openapi_server.TeamsAddOrUpdateProjectPermissionsInOrgRequest()
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
    }
...
async def test_teams_add_or_update_repo_permissions_in_org(client):
    ...
    """
    body = openapi_server.TeamsAddOrUpdateRepoPermissionsInOrgRequest()
    headers = { 
        'Content-Type': 'application/json',
    }
    response = await client.request(
