...
bool OAITeam_repository::isAnonymousAccessEnabled() const {
    return m_anonymous_access_enabled;
}
void OAITeam_repository::setAnonymousAccessEnabled(const bool &anonymous_access_enabled) {
    m_anonymous_access_enabled = anonymous_access_enabled;
    m_anonymous_access_enabled_isSet = true;
}

bool OAITeam_repository::is_anonymous_access_enabled_Set() const{
    return m_anonymous_access_enabled_isSet;
}

bool OAITeam_repository::is_anonymous_access_enabled_Valid() const{
