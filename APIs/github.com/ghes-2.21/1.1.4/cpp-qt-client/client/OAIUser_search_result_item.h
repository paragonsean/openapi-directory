...
/*
 * OAIUser_search_result_item.h
 *
 * User Search Result Item
 */

#ifndef OAIUser_search_result_item_H
#define OAIUser_search_result_item_H
...
class OAIUser_search_result_item : public OAIObject {
public:
    OAIUser_search_result_item();
    OAIUser_search_result_item(QString json);
    ~OAIUser_search_result_item() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUser_search_result_item)

#endif // OAIUser_search_result_item_H
