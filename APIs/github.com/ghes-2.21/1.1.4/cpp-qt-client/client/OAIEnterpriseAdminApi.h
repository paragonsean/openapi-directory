...
public:
    ...
    */
    virtual void enterpriseAdmin_createGlobalWebhook(const QString &accept, const OAIEnterprise_admin_create_global_webhook_request &oai_enterprise_admin_create_global_webhook_request);

    /**
    * @param[in]  username QString [required]
    * @param[in]  oai_enterprise_admin_create_impersonation_o_auth_token_request OAIEnterprise_admin_create_impersonation_o_auth_token_request [optional]
    */
    virtual void enterpriseAdmin_createImpersonationOAuthToken(const QString &username, const ::OpenAPI::OptionalParam<OAIEnterprise_admin_create_impersonation_o_auth_token_request> &oai_enterprise_admin_create_impersonation_o_auth_token_request = ::OpenAPI::OptionalParam<OAIEnterprise_admin_create_impersonation_o_auth_token_request>());

    /**
    * @param[in]  oai_enterprise_admin_create_org_request OAIEnterprise_admin_create_org_request [optional]
    */
    virtual void enterpriseAdmin_createOrg(const ::OpenAPI::OptionalParam<OAIEnterprise_admin_create_org_request> &oai_enterprise_admin_create_org_request = ::OpenAPI::OptionalParam<OAIEnterprise_admin_create_org_request>());
    ...
    */
    virtual void enterpriseAdmin_deleteGlobalWebhook(const QString &accept, const qint32 &hook_id);
    ...
    * @param[in]  hook_id qint32 [required]
    */
    virtual void enterpriseAdmin_getGlobalWebhook(const QString &accept, const qint32 &hook_id);
    ...
    */
    virtual void enterpriseAdmin_listGlobalWebhooks(const QString &accept, const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  hook_id qint32 [required]
    */
    virtual void enterpriseAdmin_pingGlobalWebhook(const QString &accept, const qint32 &hook_id);
    ...
    * @param[in]  accept QString [required]
    * @param[in]  hook_id qint32 [required]
    * @param[in]  oai_enterprise_admin_update_global_webhook_request OAIEnterprise_admin_update_global_webhook_request [optional]
    */
    virtual void enterpriseAdmin_updateGlobalWebhook(const QString &accept, const qint32 &hook_id, const ::OpenAPI::OptionalParam<OAIEnterprise_admin_update_global_webhook_request> &oai_enterprise_admin_update_global_webhook_request = ::OpenAPI::OptionalParam<OAIEnterprise_admin_update_global_webhook_request>());

    /**
    * @param[in]  team_id qint32 [required]
    * @param[in]  oai_enterprise_admin_update_ldap_mapping_for_team_request OAIEnterprise_admin_update_ldap_mapping_for_team_request [optional]
    */
    virtual void enterpriseAdmin_updateLdapMappingForTeam(const qint32 &team_id, const ::OpenAPI::OptionalParam<OAIEnterprise_admin_update_ldap_mapping_for_team_request> &oai_enterprise_admin_update_ldap_mapping_for_team_request = ::OpenAPI::OptionalParam<OAIEnterprise_admin_update_ldap_mapping_for_team_request>());

    /**
    * @param[in]  username QString [required]
    * @param[in]  oai_enterprise_admin_update_ldap_mapping_for_team_request OAIEnterprise_admin_update_ldap_mapping_for_team_request [optional]
    */
    virtual void enterpriseAdmin_updateLdapMappingForUser(const QString &username, const ::OpenAPI::OptionalParam<OAIEnterprise_admin_update_ldap_mapping_for_team_request> &oai_enterprise_admin_update_ldap_mapping_for_team_request = ::OpenAPI::OptionalParam<OAIEnterprise_admin_update_ldap_mapping_for_team_request>());
    ...
    */
    ...
    virtual void enterpriseStatsGistsGet();
...
private:
    ...
    void enterpriseStatsGistsGetCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void enterpriseStatsGistsGetSignal(OAIEnterprise_gist_overview summary);
    ...
    void enterpriseStatsGistsGetSignalFull(OAIHttpRequestWorker *worker, OAIEnterprise_gist_overview summary);
    ...
    Q_DECL_DEPRECATED_X("Use enterpriseStatsGistsGetSignalError() instead")
    void enterpriseStatsGistsGetSignalE(OAIEnterprise_gist_overview summary, QNetworkReply::NetworkError error_type, QString error_str);
    void enterpriseStatsGistsGetSignalError(OAIEnterprise_gist_overview summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use enterpriseStatsGistsGetSignalErrorFull() instead")
    void enterpriseStatsGistsGetSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void enterpriseStatsGistsGetSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
