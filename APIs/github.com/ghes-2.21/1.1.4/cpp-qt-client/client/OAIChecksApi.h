...
public:
    ...
    * @param[in]  owner QString [required]
    * @param[in]  repo QString [required]
    * @param[in]  oai_checks_create_suite_request OAIChecks_create_suite_request [optional]
    */
    virtual void checks_createSuite(const QString &owner, const QString &repo, const ::OpenAPI::OptionalParam<OAIChecks_create_suite_request> &oai_checks_create_suite_request = ::OpenAPI::OptionalParam<OAIChecks_create_suite_request>());
    ...
    * @param[in]  repo QString [required]
    * @param[in]  check_run_id qint32 [required]
    * @param[in]  oai_checks_update_request OAIChecks_update_request [optional]
    */
    virtual void checks_update(const QString &owner, const QString &repo, const qint32 &check_run_id, const ::OpenAPI::OptionalParam<OAIChecks_update_request> &oai_checks_update_request = ::OpenAPI::OptionalParam<OAIChecks_update_request>());
