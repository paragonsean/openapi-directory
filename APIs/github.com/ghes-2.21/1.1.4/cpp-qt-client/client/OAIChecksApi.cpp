...
void OAIChecksApi::checks_createSuite(const QString &owner, const QString &repo, const ::OpenAPI::OptionalParam<OAIChecks_create_suite_request> &oai_checks_create_suite_request) {
    ...
    if (oai_checks_create_suite_request.hasValue()){

        
        QByteArray output = oai_checks_create_suite_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
...
void OAIChecksApi::checks_update(const QString &owner, const QString &repo, const qint32 &check_run_id, const ::OpenAPI::OptionalParam<OAIChecks_update_request> &oai_checks_update_request) {
    ...
    if (oai_checks_update_request.hasValue()){

        
        QByteArray output = oai_checks_update_request.value().asJson().toUtf8();
        input.request_body.append(output);
    }
    for (auto keyValueIt = _defaultHeaders.keyValueBegin(); keyValueIt != _defaultHeaders.keyValueEnd(); keyValueIt++) {
        input.headers.insert(keyValueIt->first, keyValueIt->second);
