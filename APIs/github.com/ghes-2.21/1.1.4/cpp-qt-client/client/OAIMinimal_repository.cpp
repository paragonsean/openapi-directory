...
bool OAIMinimal_repository::isAnonymousAccessEnabled() const {
    return m_anonymous_access_enabled;
}
void OAIMinimal_repository::setAnonymousAccessEnabled(const bool &anonymous_access_enabled) {
    m_anonymous_access_enabled = anonymous_access_enabled;
    m_anonymous_access_enabled_isSet = true;
}

bool OAIMinimal_repository::is_anonymous_access_enabled_Set() const{
    return m_anonymous_access_enabled_isSet;
}

bool OAIMinimal_repository::is_anonymous_access_enabled_Valid() const{
...
OAINullable_repository OAIMinimal_repository::getTemplateRepository() const {
    return m_template_repository;
}
void OAIMinimal_repository::setTemplateRepository(const OAINullable_repository &template_repository) {
    m_template_repository = template_repository;
    m_template_repository_isSet = true;
}

bool OAIMinimal_repository::is_template_repository_Set() const{
    return m_template_repository_isSet;
}

bool OAIMinimal_repository::is_template_repository_Valid() const{
