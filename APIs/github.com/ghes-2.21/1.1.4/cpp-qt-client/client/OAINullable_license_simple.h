...
/*
 * OAINullable_license_simple.h
 *
 * License Simple
 */

#ifndef OAINullable_license_simple_H
#define OAINullable_license_simple_H
...
class OAINullable_license_simple : public OAIObject {
public:
    OAINullable_license_simple();
    OAINullable_license_simple(QString json);
    ~OAINullable_license_simple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_license_simple)

#endif // OAINullable_license_simple_H
