...
/*
 * OAIUnlabeled_issue_event.h
 *
 * Unlabeled Issue Event
 */

#ifndef OAIUnlabeled_issue_event_H
#define OAIUnlabeled_issue_event_H
...
class OAIUnlabeled_issue_event : public OAIObject {
public:
    OAIUnlabeled_issue_event();
    OAIUnlabeled_issue_event(QString json);
    ~OAIUnlabeled_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnlabeled_issue_event)

#endif // OAIUnlabeled_issue_event_H
