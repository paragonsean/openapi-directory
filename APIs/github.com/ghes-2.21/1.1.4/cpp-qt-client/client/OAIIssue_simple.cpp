...
OAIIssue_simple::OAIIssue_simple(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIssue_simple::OAIIssue_simple() {
    this->initializeModel();
}

OAIIssue_simple::~OAIIssue_simple() {}

void OAIIssue_simple::initializeModel() {
...
void OAIIssue_simple::fromJson(QString jsonString) {
...
void OAIIssue_simple::fromJsonObject(QJsonObject json) {
...
QString OAIIssue_simple::asJson() const {
...
QJsonObject OAIIssue_simple::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIssue_simple::getActiveLockReason() const {
    return m_active_lock_reason;
}
void OAIIssue_simple::setActiveLockReason(const QString &active_lock_reason) {
    m_active_lock_reason = active_lock_reason;
    m_active_lock_reason_isSet = true;
}

bool OAIIssue_simple::is_active_lock_reason_Set() const{
    return m_active_lock_reason_isSet;
}

bool OAIIssue_simple::is_active_lock_reason_Valid() const{
    return m_active_lock_reason_isValid;
}

OAINullable_simple_user OAIIssue_simple::getAssignee() const {
    return m_assignee;
}
void OAIIssue_simple::setAssignee(const OAINullable_simple_user &assignee) {
    m_assignee = assignee;
    m_assignee_isSet = true;
}

bool OAIIssue_simple::is_assignee_Set() const{
    return m_assignee_isSet;
}

bool OAIIssue_simple::is_assignee_Valid() const{
    return m_assignee_isValid;
}

QList<OAISimple_user> OAIIssue_simple::getAssignees() const {
    return m_assignees;
}
void OAIIssue_simple::setAssignees(const QList<OAISimple_user> &assignees) {
    m_assignees = assignees;
    m_assignees_isSet = true;
}

bool OAIIssue_simple::is_assignees_Set() const{
    return m_assignees_isSet;
}

bool OAIIssue_simple::is_assignees_Valid() const{
    return m_assignees_isValid;
}

OAIAuthor_association OAIIssue_simple::getAuthorAssociation() const {
    return m_author_association;
}
void OAIIssue_simple::setAuthorAssociation(const OAIAuthor_association &author_association) {
    m_author_association = author_association;
    m_author_association_isSet = true;
}

bool OAIIssue_simple::is_author_association_Set() const{
    return m_author_association_isSet;
}

bool OAIIssue_simple::is_author_association_Valid() const{
    return m_author_association_isValid;
}

QString OAIIssue_simple::getBody() const {
    return m_body;
}
void OAIIssue_simple::setBody(const QString &body) {
    m_body = body;
    m_body_isSet = true;
}

bool OAIIssue_simple::is_body_Set() const{
    return m_body_isSet;
}

bool OAIIssue_simple::is_body_Valid() const{
    return m_body_isValid;
}

QString OAIIssue_simple::getBodyHtml() const {
    return m_body_html;
}
void OAIIssue_simple::setBodyHtml(const QString &body_html) {
    m_body_html = body_html;
    m_body_html_isSet = true;
}

bool OAIIssue_simple::is_body_html_Set() const{
    return m_body_html_isSet;
}

bool OAIIssue_simple::is_body_html_Valid() const{
    return m_body_html_isValid;
}

QString OAIIssue_simple::getBodyText() const {
    return m_body_text;
}
void OAIIssue_simple::setBodyText(const QString &body_text) {
    m_body_text = body_text;
    m_body_text_isSet = true;
}

bool OAIIssue_simple::is_body_text_Set() const{
    return m_body_text_isSet;
}

bool OAIIssue_simple::is_body_text_Valid() const{
    return m_body_text_isValid;
}

QDateTime OAIIssue_simple::getClosedAt() const {
    return m_closed_at;
}
void OAIIssue_simple::setClosedAt(const QDateTime &closed_at) {
    m_closed_at = closed_at;
    m_closed_at_isSet = true;
}

bool OAIIssue_simple::is_closed_at_Set() const{
    return m_closed_at_isSet;
}

bool OAIIssue_simple::is_closed_at_Valid() const{
    return m_closed_at_isValid;
}

qint32 OAIIssue_simple::getComments() const {
    return m_comments;
}
void OAIIssue_simple::setComments(const qint32 &comments) {
    m_comments = comments;
    m_comments_isSet = true;
}

bool OAIIssue_simple::is_comments_Set() const{
    return m_comments_isSet;
}

bool OAIIssue_simple::is_comments_Valid() const{
    return m_comments_isValid;
}

QString OAIIssue_simple::getCommentsUrl() const {
    return m_comments_url;
}
void OAIIssue_simple::setCommentsUrl(const QString &comments_url) {
    m_comments_url = comments_url;
    m_comments_url_isSet = true;
}

bool OAIIssue_simple::is_comments_url_Set() const{
    return m_comments_url_isSet;
}

bool OAIIssue_simple::is_comments_url_Valid() const{
    return m_comments_url_isValid;
}

QDateTime OAIIssue_simple::getCreatedAt() const {
    return m_created_at;
}
void OAIIssue_simple::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIIssue_simple::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIIssue_simple::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QString OAIIssue_simple::getEventsUrl() const {
    return m_events_url;
}
void OAIIssue_simple::setEventsUrl(const QString &events_url) {
    m_events_url = events_url;
    m_events_url_isSet = true;
}

bool OAIIssue_simple::is_events_url_Set() const{
    return m_events_url_isSet;
}

bool OAIIssue_simple::is_events_url_Valid() const{
    return m_events_url_isValid;
}

QString OAIIssue_simple::getHtmlUrl() const {
    return m_html_url;
}
void OAIIssue_simple::setHtmlUrl(const QString &html_url) {
    m_html_url = html_url;
    m_html_url_isSet = true;
}

bool OAIIssue_simple::is_html_url_Set() const{
    return m_html_url_isSet;
}

bool OAIIssue_simple::is_html_url_Valid() const{
    return m_html_url_isValid;
}

qint32 OAIIssue_simple::getId() const {
    return m_id;
}
void OAIIssue_simple::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIIssue_simple::is_id_Set() const{
    return m_id_isSet;
}

bool OAIIssue_simple::is_id_Valid() const{
    return m_id_isValid;
}

QList<OAILabel> OAIIssue_simple::getLabels() const {
    return m_labels;
}
void OAIIssue_simple::setLabels(const QList<OAILabel> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIIssue_simple::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIIssue_simple::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIIssue_simple::getLabelsUrl() const {
    return m_labels_url;
}
void OAIIssue_simple::setLabelsUrl(const QString &labels_url) {
    m_labels_url = labels_url;
    m_labels_url_isSet = true;
}

bool OAIIssue_simple::is_labels_url_Set() const{
    return m_labels_url_isSet;
}

bool OAIIssue_simple::is_labels_url_Valid() const{
    return m_labels_url_isValid;
}

bool OAIIssue_simple::isLocked() const {
    return m_locked;
}
void OAIIssue_simple::setLocked(const bool &locked) {
    m_locked = locked;
    m_locked_isSet = true;
}

bool OAIIssue_simple::is_locked_Set() const{
    return m_locked_isSet;
}

bool OAIIssue_simple::is_locked_Valid() const{
    return m_locked_isValid;
}

OAINullable_milestone OAIIssue_simple::getMilestone() const {
    return m_milestone;
}
void OAIIssue_simple::setMilestone(const OAINullable_milestone &milestone) {
    m_milestone = milestone;
    m_milestone_isSet = true;
}

bool OAIIssue_simple::is_milestone_Set() const{
    return m_milestone_isSet;
}

bool OAIIssue_simple::is_milestone_Valid() const{
    return m_milestone_isValid;
}

QString OAIIssue_simple::getNodeId() const {
    return m_node_id;
}
void OAIIssue_simple::setNodeId(const QString &node_id) {
    m_node_id = node_id;
    m_node_id_isSet = true;
}

bool OAIIssue_simple::is_node_id_Set() const{
    return m_node_id_isSet;
}

bool OAIIssue_simple::is_node_id_Valid() const{
    return m_node_id_isValid;
}

qint32 OAIIssue_simple::getNumber() const {
    return m_number;
}
void OAIIssue_simple::setNumber(const qint32 &number) {
    m_number = number;
    m_number_isSet = true;
}

bool OAIIssue_simple::is_number_Set() const{
    return m_number_isSet;
}

bool OAIIssue_simple::is_number_Valid() const{
    return m_number_isValid;
}

OAINullable_integration OAIIssue_simple::getPerformedViaGithubApp() const {
    return m_performed_via_github_app;
}
void OAIIssue_simple::setPerformedViaGithubApp(const OAINullable_integration &performed_via_github_app) {
    m_performed_via_github_app = performed_via_github_app;
    m_performed_via_github_app_isSet = true;
}

bool OAIIssue_simple::is_performed_via_github_app_Set() const{
    return m_performed_via_github_app_isSet;
}

bool OAIIssue_simple::is_performed_via_github_app_Valid() const{
    return m_performed_via_github_app_isValid;
}

OAIIssue_pull_request OAIIssue_simple::getPullRequest() const {
    return m_pull_request;
}
void OAIIssue_simple::setPullRequest(const OAIIssue_pull_request &pull_request) {
    m_pull_request = pull_request;
    m_pull_request_isSet = true;
}

bool OAIIssue_simple::is_pull_request_Set() const{
    return m_pull_request_isSet;
}

bool OAIIssue_simple::is_pull_request_Valid() const{
    return m_pull_request_isValid;
}

OAIRepository OAIIssue_simple::getRepository() const {
    return m_repository;
}
void OAIIssue_simple::setRepository(const OAIRepository &repository) {
    m_repository = repository;
    m_repository_isSet = true;
}

bool OAIIssue_simple::is_repository_Set() const{
    return m_repository_isSet;
}

bool OAIIssue_simple::is_repository_Valid() const{
    return m_repository_isValid;
}

QString OAIIssue_simple::getRepositoryUrl() const {
    return m_repository_url;
}
void OAIIssue_simple::setRepositoryUrl(const QString &repository_url) {
    m_repository_url = repository_url;
    m_repository_url_isSet = true;
}

bool OAIIssue_simple::is_repository_url_Set() const{
    return m_repository_url_isSet;
}

bool OAIIssue_simple::is_repository_url_Valid() const{
    return m_repository_url_isValid;
}

QString OAIIssue_simple::getState() const {
    return m_state;
}
void OAIIssue_simple::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIIssue_simple::is_state_Set() const{
    return m_state_isSet;
}

bool OAIIssue_simple::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIIssue_simple::getTimelineUrl() const {
    return m_timeline_url;
}
void OAIIssue_simple::setTimelineUrl(const QString &timeline_url) {
    m_timeline_url = timeline_url;
    m_timeline_url_isSet = true;
}

bool OAIIssue_simple::is_timeline_url_Set() const{
    return m_timeline_url_isSet;
}

bool OAIIssue_simple::is_timeline_url_Valid() const{
    return m_timeline_url_isValid;
}

QString OAIIssue_simple::getTitle() const {
    return m_title;
}
void OAIIssue_simple::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIIssue_simple::is_title_Set() const{
    return m_title_isSet;
}

bool OAIIssue_simple::is_title_Valid() const{
    return m_title_isValid;
}

QDateTime OAIIssue_simple::getUpdatedAt() const {
    return m_updated_at;
}
void OAIIssue_simple::setUpdatedAt(const QDateTime &updated_at) {
    m_updated_at = updated_at;
    m_updated_at_isSet = true;
}

bool OAIIssue_simple::is_updated_at_Set() const{
    return m_updated_at_isSet;
}

bool OAIIssue_simple::is_updated_at_Valid() const{
    return m_updated_at_isValid;
}

QString OAIIssue_simple::getUrl() const {
    return m_url;
}
void OAIIssue_simple::setUrl(const QString &url) {
    m_url = url;
    m_url_isSet = true;
}

bool OAIIssue_simple::is_url_Set() const{
    return m_url_isSet;
}

bool OAIIssue_simple::is_url_Valid() const{
    return m_url_isValid;
}

OAINullable_simple_user OAIIssue_simple::getUser() const {
    return m_user;
}
void OAIIssue_simple::setUser(const OAINullable_simple_user &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIIssue_simple::is_user_Set() const{
    return m_user_isSet;
}

bool OAIIssue_simple::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIIssue_simple::isSet() const {
...
bool OAIIssue_simple::isValid() const {
