...
/*
 * OAINullable_repository.h
 *
 * A git repository
 */

#ifndef OAINullable_repository_H
#define OAINullable_repository_H
...
class OAINullable_repository : public OAIObject {
public:
    OAINullable_repository();
    OAINullable_repository(QString json);
    ~OAINullable_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_repository)

#endif // OAINullable_repository_H
