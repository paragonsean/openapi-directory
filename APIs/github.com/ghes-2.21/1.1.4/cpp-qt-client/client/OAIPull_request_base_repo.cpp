...
bool OAIPull_request_base_repo::isAnonymousAccessEnabled() const {
    return m_anonymous_access_enabled;
}
void OAIPull_request_base_repo::setAnonymousAccessEnabled(const bool &anonymous_access_enabled) {
    m_anonymous_access_enabled = anonymous_access_enabled;
    m_anonymous_access_enabled_isSet = true;
}

bool OAIPull_request_base_repo::is_anonymous_access_enabled_Set() const{
    return m_anonymous_access_enabled_isSet;
}

bool OAIPull_request_base_repo::is_anonymous_access_enabled_Valid() const{
