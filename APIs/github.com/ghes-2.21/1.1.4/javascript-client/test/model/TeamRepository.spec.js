...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TeamRepository();
  });
  ...
  describe('TeamRepository', function() {
    it('should create an instance of TeamRepository', function() {
      // uncomment below and update the code to test TeamRepository
      //var instance = new GitHubV3RestApi.TeamRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.TeamRepository);
    });
