...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LockedIssueEvent();
  });
  ...
  describe('LockedIssueEvent', function() {
    it('should create an instance of LockedIssueEvent', function() {
      // uncomment below and update the code to test LockedIssueEvent
      //var instance = new GitHubV3RestApi.LockedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.LockedIssueEvent);
    });
