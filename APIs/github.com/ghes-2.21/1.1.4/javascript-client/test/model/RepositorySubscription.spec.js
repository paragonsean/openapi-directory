...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.RepositorySubscription();
  });
  ...
  describe('RepositorySubscription', function() {
    it('should create an instance of RepositorySubscription', function() {
      // uncomment below and update the code to test RepositorySubscription
      //var instance = new GitHubV3RestApi.RepositorySubscription();
      //expect(instance).to.be.a(GitHubV3RestApi.RepositorySubscription);
    });
