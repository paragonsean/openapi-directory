...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullRequestSimpleBase();
  });
  ...
  describe('PullRequestSimpleBase', function() {
    it('should create an instance of PullRequestSimpleBase', function() {
      // uncomment below and update the code to test PullRequestSimpleBase
      //var instance = new GitHubV3RestApi.PullRequestSimpleBase();
      //expect(instance).to.be.a(GitHubV3RestApi.PullRequestSimpleBase);
    });
