...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullRequestBaseRepoOwner();
  });
  ...
  describe('PullRequestBaseRepoOwner', function() {
    it('should create an instance of PullRequestBaseRepoOwner', function() {
      // uncomment below and update the code to test PullRequestBaseRepoOwner
      //var instance = new GitHubV3RestApi.PullRequestBaseRepoOwner();
      //expect(instance).to.be.a(GitHubV3RestApi.PullRequestBaseRepoOwner);
    });
