...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LabelSearchResultItem();
  });
  ...
  describe('LabelSearchResultItem', function() {
    it('should create an instance of LabelSearchResultItem', function() {
      // uncomment below and update the code to test LabelSearchResultItem
      //var instance = new GitHubV3RestApi.LabelSearchResultItem();
      //expect(instance).to.be.a(GitHubV3RestApi.LabelSearchResultItem);
    });
