...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.NullableMilestone();
  });
  ...
  describe('NullableMilestone', function() {
    it('should create an instance of NullableMilestone', function() {
      // uncomment below and update the code to test NullableMilestone
      //var instance = new GitHubV3RestApi.NullableMilestone();
      //expect(instance).to.be.a(GitHubV3RestApi.NullableMilestone);
    });
