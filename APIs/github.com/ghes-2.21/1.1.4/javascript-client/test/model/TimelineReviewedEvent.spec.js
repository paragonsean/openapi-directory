...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TimelineReviewedEvent();
  });
  ...
  describe('TimelineReviewedEvent', function() {
    it('should create an instance of TimelineReviewedEvent', function() {
      // uncomment below and update the code to test TimelineReviewedEvent
      //var instance = new GitHubV3RestApi.TimelineReviewedEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.TimelineReviewedEvent);
    });
