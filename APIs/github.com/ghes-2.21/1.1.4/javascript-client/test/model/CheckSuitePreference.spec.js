...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.CheckSuitePreference();
  });
  ...
  describe('CheckSuitePreference', function() {
    it('should create an instance of CheckSuitePreference', function() {
      // uncomment below and update the code to test CheckSuitePreference
      //var instance = new GitHubV3RestApi.CheckSuitePreference();
      //expect(instance).to.be.a(GitHubV3RestApi.CheckSuitePreference);
    });
