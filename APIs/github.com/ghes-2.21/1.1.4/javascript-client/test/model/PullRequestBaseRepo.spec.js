...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PullRequestBaseRepo();
  });
  ...
  describe('PullRequestBaseRepo', function() {
    it('should create an instance of PullRequestBaseRepo', function() {
      // uncomment below and update the code to test PullRequestBaseRepo
      //var instance = new GitHubV3RestApi.PullRequestBaseRepo();
      //expect(instance).to.be.a(GitHubV3RestApi.PullRequestBaseRepo);
    });
