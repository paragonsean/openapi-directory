...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ThreadSubscription();
  });
  ...
  describe('ThreadSubscription', function() {
    it('should create an instance of ThreadSubscription', function() {
      // uncomment below and update the code to test ThreadSubscription
      //var instance = new GitHubV3RestApi.ThreadSubscription();
      //expect(instance).to.be.a(GitHubV3RestApi.ThreadSubscription);
    });
