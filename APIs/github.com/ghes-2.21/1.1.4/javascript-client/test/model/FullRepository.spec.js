...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.FullRepository();
  });
  ...
  describe('FullRepository', function() {
    it('should create an instance of FullRepository', function() {
      // uncomment below and update the code to test FullRepository
      //var instance = new GitHubV3RestApi.FullRepository();
      //expect(instance).to.be.a(GitHubV3RestApi.FullRepository);
    });
