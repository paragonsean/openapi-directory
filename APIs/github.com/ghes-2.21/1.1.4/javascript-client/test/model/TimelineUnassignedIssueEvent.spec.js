...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TimelineUnassignedIssueEvent();
  });
  ...
  describe('TimelineUnassignedIssueEvent', function() {
    it('should create an instance of TimelineUnassignedIssueEvent', function() {
      // uncomment below and update the code to test TimelineUnassignedIssueEvent
      //var instance = new GitHubV3RestApi.TimelineUnassignedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.TimelineUnassignedIssueEvent);
    });
