...
(function(root, factory) {
  ...
  describe('GitApi', function() {
    ...
    describe('gitGetRef', function() {
      it('should call gitGetRef successfully', function(done) {
        //uncomment below and update the code to test gitGetRef
        //instance.gitGetRef(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('gitListMatchingRefs', function() {
      it('should call gitListMatchingRefs successfully', function(done) {
        //uncomment below and update the code to test gitListMatchingRefs
        //instance.gitListMatchingRefs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
