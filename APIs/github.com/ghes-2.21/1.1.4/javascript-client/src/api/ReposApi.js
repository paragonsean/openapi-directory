...
export default class ReposApi {
    ...
    */
     ...
     */
    reposAcceptInvitation(invitationId, callback) {
      let postBody = null;
     ...
     */
    reposDeclineInvitation(invitationId, callback) {
      let postBody = null;
      // verify the required parameter 'invitationId' is set
      if (invitationId === undefined || invitationId === null) {
     ...
     * data is of type: {@link module:model/Hook}
     */
    reposUpdateWebhook(owner, repo, hookId, opts, callback) {
      opts = opts || {};
      let postBody = opts['reposUpdateWebhookRequest'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
