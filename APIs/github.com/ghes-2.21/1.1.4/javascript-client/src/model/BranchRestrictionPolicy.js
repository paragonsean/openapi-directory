...
class BranchRestrictionPolicy {
     ...
     * @param apps {Array.<module:model/BranchRestrictionPolicyAppsInner>} 
     * @param appsUrl {String} 
     * @param teams {Array.<module:model/BranchRestrictionPolicyTeamsInner>} 
     * @param teamsUrl {String} 
     * @param url {String} 
     * @param users {Array.<module:model/BranchRestrictionPolicyUsersInner>} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('apps')) {
                obj['apps'] = ApiClient.convertToType(data['apps'], [BranchRestrictionPolicyAppsInner]);
            }
            if (data.hasOwnProperty('apps_url')) {
                obj['apps_url'] = ApiClient.convertToType(data['apps_url'], 'String');
            }
            if (data.hasOwnProperty('teams')) {
                obj['teams'] = ApiClient.convertToType(data['teams'], [BranchRestrictionPolicyTeamsInner]);
            }
            ...
            if (data.hasOwnProperty('users')) {
                obj['users'] = ApiClient.convertToType(data['users'], [BranchRestrictionPolicyUsersInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>BranchRestrictionPolicy</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BranchRestrictionPolicy</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BranchRestrictionPolicy.RequiredProperties) {
        ...
        if (data['apps']) { // data not null
            ...
            for (const item of data['apps']) {
                BranchRestrictionPolicyAppsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['apps_url'] && !(typeof data['apps_url'] === 'string' || data['apps_url'] instanceof String)) {
            throw new Error("Expected the field `apps_url` to be a primitive type in the JSON string but got " + data['apps_url']);
        }
        if (data['teams']) { // data not null
            ...
            for (const item of data['teams']) {
                BranchRestrictionPolicyTeamsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['users']) { // data not null
            ...
            for (const item of data['users']) {
                BranchRestrictionPolicyUsersInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
BranchRestrictionPolicy.RequiredProperties = ["apps", "apps_url", "teams", "teams_url", "url", "users", "users_url"];

/**
 * @member {Array.<module:model/BranchRestrictionPolicyAppsInner>} apps
 */
...
/**
 * @member {Array.<module:model/BranchRestrictionPolicyTeamsInner>} teams
 */
...
/**
 * @member {Array.<module:model/BranchRestrictionPolicyUsersInner>} users
 */
