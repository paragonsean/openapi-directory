...
public class Example {
  public static void main(String[] args) {
    ...
    String settings = "settings_example"; // String | An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.21/rest/reference/enterprise-admin#get-settings).
    try {
...
<a id="enterpriseStatsGistsGet"></a>
...
public class Example {
  public static void main(String[] args) {
    ...
    EnterpriseAdminApi apiInstance = new EnterpriseAdminApi(defaultClient);
    try {
      EnterpriseGistOverview result = apiInstance.enterpriseStatsGistsGet();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EnterpriseAdminApi#enterpriseStatsGistsGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
