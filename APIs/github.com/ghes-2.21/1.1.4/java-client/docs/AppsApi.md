...
|------------- | ------------- | ------------- | -------------|
| **clientId** | **String**| The client ID of your GitHub app. | |
| **appsDeleteAuthorizationRequest** | [**AppsDeleteAuthorizationRequest**](AppsDeleteAuthorizationRequest.md)|  | [optional] |
...
# **appsDeleteToken**
> appsDeleteToken(clientId, appsDeleteTokenRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    AppsApi apiInstance = new AppsApi(defaultClient);
    String clientId = "clientId_example"; // String | The client ID of your GitHub app.
    AppsDeleteTokenRequest appsDeleteTokenRequest = new AppsDeleteTokenRequest(); // AppsDeleteTokenRequest | 
    try {
      apiInstance.appsDeleteToken(clientId, appsDeleteTokenRequest);
    } catch (ApiException e) {
...
|------------- | ------------- | ------------- | -------------|
| **clientId** | **String**| The client ID of your GitHub app. | |
| **appsDeleteTokenRequest** | [**AppsDeleteTokenRequest**](AppsDeleteTokenRequest.md)|  | |
