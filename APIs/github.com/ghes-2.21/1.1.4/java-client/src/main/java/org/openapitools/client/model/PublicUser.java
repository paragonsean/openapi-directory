...
public class PublicUser {
  ...
  public PublicUser plan(LdapMappingUserPlan plan) {
    this.plan = plan;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatarUrl, publicUser.avatarUrl) &&
        ...
        Objects.equals(this.login, publicUser.login) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(avatarUrl, bio, blog, collaborators, company, createdAt, diskUsage, email, eventsUrl, followers, followersUrl, following, followingUrl, gistsUrl, gravatarId, hireable, htmlUrl, id, location, login, name, nodeId, organizationsUrl, ownedPrivateRepos, plan, privateGists, publicGists, publicRepos, receivedEventsUrl, reposUrl, siteAdmin, starredUrl, subscriptionsUrl, suspendedAt, totalPrivateRepos, type, updatedAt, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublicUser
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublicUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublicUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublicUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
