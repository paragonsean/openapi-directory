...
public class TeamProject {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.body, teamProject.body) &&
        ...
        Objects.equals(this.ownerUrl, teamProject.ownerUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(body, columnsUrl, createdAt, creator, htmlUrl, id, name, nodeId, number, organizationPermission, ownerUrl, permissions, _private, state, updatedAt, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamProject
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamProject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      SimpleUser.validateJsonElement(jsonObj.get("creator"));
      ...
      TeamProjectPermissions.validateJsonElement(jsonObj.get("permissions"));
