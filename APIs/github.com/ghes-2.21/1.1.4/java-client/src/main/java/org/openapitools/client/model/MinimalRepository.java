...
import org.openapitools.client.model.MinimalRepositoryLicense;
...
public class MinimalRepository {
  ...
  private MinimalRepositoryLicense license;
  ...
  public MinimalRepository anonymousAccessEnabled(Boolean anonymousAccessEnabled) {
  ...
  public MinimalRepository forks(Integer forks) {
    this.forks = forks;
    return this;
  }
  ...
  public MinimalRepository forksCount(Integer forksCount) {
  ...
  public MinimalRepository hasDownloads(Boolean hasDownloads) {
  ...
  public MinimalRepository id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public MinimalRepository networkCount(Integer networkCount) {
  ...
  public MinimalRepository openIssues(Integer openIssues) {
  ...
  public MinimalRepository openIssuesCount(Integer openIssuesCount) {
  ...
  public MinimalRepository size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public MinimalRepository stargazersCount(Integer stargazersCount) {
  ...
  public MinimalRepository subscribersCount(Integer subscribersCount) {
  ...
  public MinimalRepository templateRepository(NullableRepository templateRepository) {
  ...
  public MinimalRepository watchers(Integer watchers) {
  ...
  public MinimalRepository watchersCount(Integer watchersCount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowForking, minimalRepository.allowForking) &&
        Objects.equals(this.anonymousAccessEnabled, minimalRepository.anonymousAccessEnabled) &&
        ...
        Objects.equals(this.id, minimalRepository.id) &&
        ...
        Objects.equals(this.templateRepository, minimalRepository.templateRepository) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to MinimalRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MinimalRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MinimalRepository is not found in the empty JSON string", MinimalRepository.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MinimalRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MinimalRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MinimalRepository.openapiRequiredFields) {
      ...
      if (jsonObj.get("code_of_conduct") != null && !jsonObj.get("code_of_conduct").isJsonNull()) {
        CodeOfConduct.validateJsonElement(jsonObj.get("code_of_conduct"));
      }
      ...
      if (jsonObj.get("license") != null && !jsonObj.get("license").isJsonNull()) {
        MinimalRepositoryLicense.validateJsonElement(jsonObj.get("license"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MinimalRepository.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MinimalRepository' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MinimalRepository> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MinimalRepository.class));

       return (TypeAdapter<T>) new TypeAdapter<MinimalRepository>() {
           @Override
           public void write(JsonWriter out, MinimalRepository value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MinimalRepository read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MinimalRepository given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MinimalRepository
   * @throws IOException if the JSON string is invalid with respect to MinimalRepository
   */
  public static MinimalRepository fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MinimalRepository.class);
  }

  /**
   * Convert an instance of MinimalRepository to an JSON string
   *
   * @return JSON string
   */
