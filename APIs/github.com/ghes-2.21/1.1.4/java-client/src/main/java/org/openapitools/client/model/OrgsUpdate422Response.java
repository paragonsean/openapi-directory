...
public class OrgsUpdate422Response extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<OrgsUpdate422Response>() {
                ...
                public void write(JsonWriter out, OrgsUpdate422Response value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof ValidationError) {
                        JsonElement element = adapterValidationError.toJsonTree((ValidationError)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof ValidationErrorSimple) {
                        JsonElement element = adapterValidationErrorSimple.toJsonTree((ValidationErrorSimple)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public OrgsUpdate422Response read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ValidationError.validateJsonElement(jsonElement);
                    ...
                    try {
                        // validate the JSON object to see if any exception is thrown
                        ValidationErrorSimple.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for OrgsUpdate422Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public OrgsUpdate422Response(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ValidationError", ValidationError.class);
        schemas.put("ValidationErrorSimple", ValidationErrorSimple.class);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to OrgsUpdate422Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for OrgsUpdate422Response with oneOf schemas: ValidationError, ValidationErrorSimple. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
