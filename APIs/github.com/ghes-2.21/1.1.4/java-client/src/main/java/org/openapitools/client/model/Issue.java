...
public class Issue {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeLockReason, assignee, assignees, authorAssociation, body, bodyHtml, bodyText, closedAt, closedBy, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, performedViaGithubApp, pullRequest, reactions, repository, repositoryUrl, state, timelineUrl, title, updatedAt, url, user);
  }
