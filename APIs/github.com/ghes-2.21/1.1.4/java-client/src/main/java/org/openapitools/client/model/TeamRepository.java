...
public class TeamRepository {
  ...
  public TeamRepository anonymousAccessEnabled(Boolean anonymousAccessEnabled) {
  ...
  public TeamRepository permissions(CollaboratorPermissions permissions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowForking, teamRepository.allowForking) &&
        ...
        Objects.equals(this.anonymousAccessEnabled, teamRepository.anonymousAccessEnabled) &&
        ...
        Objects.equals(this.id, teamRepository.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamRepository
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamRepository.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
