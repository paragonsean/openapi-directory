...
public class ShortBlob {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sha, shortBlob.sha) &&
        Objects.equals(this.url, shortBlob.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ShortBlob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShortBlob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ShortBlob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ShortBlob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
