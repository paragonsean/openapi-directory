...
public class ConfigurationStatus {
  ...
  private List<ConfigurationStatusProgressInner> progress = new ArrayList<>();
  ...
  public ConfigurationStatus progress(List<ConfigurationStatusProgressInner> progress) {
    this.progress = progress;
    return this;
  }

  public ConfigurationStatus addProgressItem(ConfigurationStatusProgressInner progressItem) {
  ...
  public List<ConfigurationStatusProgressInner> getProgress() {
    return progress;
  }

  public void setProgress(List<ConfigurationStatusProgressInner> progress) {
    this.progress = progress;
  }


  public ConfigurationStatus status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.progress, configurationStatus.progress) &&
        Objects.equals(this.status, configurationStatus.status);
  }
      ...
      if (jsonObj.get("progress") != null && !jsonObj.get("progress").isJsonNull()) {
        ...
        if (jsonArrayprogress != null) {
          ...
          for (int i = 0; i < jsonArrayprogress.size(); i++) {
            ConfigurationStatusProgressInner.validateJsonElement(jsonArrayprogress.get(i));
          };
        }
      }
