...
public class TeamMembership {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.role, teamMembership.role) &&
        Objects.equals(this.state, teamMembership.state) &&
        Objects.equals(this.url, teamMembership.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(role, state, url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamMembership
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamMembership.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamMembership.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamMembership` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
