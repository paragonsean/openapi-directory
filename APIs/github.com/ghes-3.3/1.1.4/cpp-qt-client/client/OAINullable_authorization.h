...
/*
 * OAINullable_authorization.h
 *
 * The authorization for an OAuth app, GitHub App, or a Personal Access Token.
 */

#ifndef OAINullable_authorization_H
#define OAINullable_authorization_H
...
class OAINullable_scoped_installation;
class OAINullable_simple_user;

class OAINullable_authorization : public OAIObject {
public:
    OAINullable_authorization();
    OAINullable_authorization(QString json);
    ~OAINullable_authorization() override;
    ...
    OAINullable_scoped_installation getInstallation() const;
    void setInstallation(const OAINullable_scoped_installation &installation);
...
private:
    ...
    OAINullable_scoped_installation m_installation;
...
Q_DECLARE_METATYPE(OpenAPI::OAINullable_authorization)

#endif // OAINullable_authorization_H
