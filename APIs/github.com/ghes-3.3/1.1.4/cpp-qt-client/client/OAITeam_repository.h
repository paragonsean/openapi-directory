...
/*
 * OAITeam_repository.h
 *
 * A team&#39;s access to a repository.
 */

#ifndef OAITeam_repository_H
#define OAITeam_repository_H
...
class OAITeam_repository : public OAIObject {
public:
    OAITeam_repository();
    OAITeam_repository(QString json);
    ~OAITeam_repository() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITeam_repository)

#endif // OAITeam_repository_H
