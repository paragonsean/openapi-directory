...
/*
 * OAIState_change_issue_event.h
 *
 * State Change Issue Event
 */

#ifndef OAIState_change_issue_event_H
#define OAIState_change_issue_event_H
...
class OAIState_change_issue_event : public OAIObject {
public:
    OAIState_change_issue_event();
    OAIState_change_issue_event(QString json);
    ~OAIState_change_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIState_change_issue_event)

#endif // OAIState_change_issue_event_H
