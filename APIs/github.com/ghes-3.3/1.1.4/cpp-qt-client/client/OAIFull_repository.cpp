...
bool OAIFull_repository::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAIFull_repository::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAIFull_repository::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAIFull_repository::is_allow_auto_merge_Valid() const{
