...
/*
 * OAIBranch_restriction_policy_users_inner.h
 *
 * 
 */

#ifndef OAIBranch_restriction_policy_users_inner_H
#define OAIBranch_restriction_policy_users_inner_H
...
class OAIBranch_restriction_policy_users_inner : public OAIObject {
public:
    OAIBranch_restriction_policy_users_inner();
    OAIBranch_restriction_policy_users_inner(QString json);
    ~OAIBranch_restriction_policy_users_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBranch_restriction_policy_users_inner)

#endif // OAIBranch_restriction_policy_users_inner_H
