...
public:
    ...
    * @param[in]  repo QString [required]
    * @param[in]  branch QString [required]
    * @param[in]  oai_repos_add_team_access_restrictions_request OAIRepos_add_team_access_restrictions_request [optional]
    */
    virtual void repos_addTeamAccessRestrictions(const QString &owner, const QString &repo, const QString &branch, const ::OpenAPI::OptionalParam<OAIRepos_add_team_access_restrictions_request> &oai_repos_add_team_access_restrictions_request = ::OpenAPI::OptionalParam<OAIRepos_add_team_access_restrictions_request>());
    ...
    * @param[in]  oai_repos_add_team_access_restrictions_request OAIRepos_add_team_access_restrictions_request [optional]
    */
    virtual void repos_removeTeamAccessRestrictions(const QString &owner, const QString &repo, const QString &branch, const ::OpenAPI::OptionalParam<OAIRepos_add_team_access_restrictions_request> &oai_repos_add_team_access_restrictions_request = ::OpenAPI::OptionalParam<OAIRepos_add_team_access_restrictions_request>());
