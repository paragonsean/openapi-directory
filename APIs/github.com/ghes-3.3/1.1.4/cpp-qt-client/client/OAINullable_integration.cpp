...
QString OAINullable_integration::getSlug() const {
    return m_slug;
}
void OAINullable_integration::setSlug(const QString &slug) {
    m_slug = slug;
    m_slug_isSet = true;
}

bool OAINullable_integration::is_slug_Set() const{
    return m_slug_isSet;
}

bool OAINullable_integration::is_slug_Valid() const{
