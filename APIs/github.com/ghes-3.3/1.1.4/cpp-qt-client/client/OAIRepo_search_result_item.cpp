...
bool OAIRepo_search_result_item::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAIRepo_search_result_item::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAIRepo_search_result_item::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAIRepo_search_result_item::is_allow_auto_merge_Valid() const{
