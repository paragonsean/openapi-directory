...
/*
 * OAIDemilestoned_issue_event.h
 *
 * Demilestoned Issue Event
 */

#ifndef OAIDemilestoned_issue_event_H
#define OAIDemilestoned_issue_event_H
...
class OAIDemilestoned_issue_event : public OAIObject {
public:
    OAIDemilestoned_issue_event();
    OAIDemilestoned_issue_event(QString json);
    ~OAIDemilestoned_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDemilestoned_issue_event)

#endif // OAIDemilestoned_issue_event_H
