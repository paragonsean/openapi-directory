...
/*
 * OAIReview_request_removed_issue_event.h
 *
 * Review Request Removed Issue Event
 */

#ifndef OAIReview_request_removed_issue_event_H
#define OAIReview_request_removed_issue_event_H
...
class OAIReview_request_removed_issue_event : public OAIObject {
public:
    OAIReview_request_removed_issue_event();
    OAIReview_request_removed_issue_event(QString json);
    ~OAIReview_request_removed_issue_event() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReview_request_removed_issue_event)

#endif // OAIReview_request_removed_issue_event_H
