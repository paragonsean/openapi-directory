...
#include "OAIApps_create_content_attachment_415_response.h"
...
public:
    ...
    */
    Q_DECL_DEPRECATED virtual void apps_checkAuthorization(const QString &client_id, const QString &access_token);
    ...
    * @param[in]  access_token QString [required]
    */
    Q_DECL_DEPRECATED virtual void apps_resetAuthorization(const QString &client_id, const QString &access_token);
    ...
    * @param[in]  access_token QString [required]
    */
    Q_DECL_DEPRECATED virtual void apps_revokeAuthorizationForApplication(const QString &client_id, const QString &access_token);

    /**
    * @param[in]  client_id QString [required]
    * @param[in]  access_token QString [required]
    */
    Q_DECL_DEPRECATED virtual void apps_revokeGrantForApplication(const QString &client_id, const QString &access_token);
...
private:
    ...
    void apps_checkAuthorizationCallback(OAIHttpRequestWorker *worker);
    ...
    void apps_resetAuthorizationCallback(OAIHttpRequestWorker *worker);
    void apps_resetTokenCallback(OAIHttpRequestWorker *worker);
    void apps_revokeAuthorizationForApplicationCallback(OAIHttpRequestWorker *worker);
    void apps_revokeGrantForApplicationCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void apps_checkAuthorizationSignal(OAINullable_authorization summary);
    ...
    void apps_resetAuthorizationSignal(OAIAuthorization summary);
    void apps_resetTokenSignal(OAIAuthorization summary);
    void apps_revokeAuthorizationForApplicationSignal();
    void apps_revokeGrantForApplicationSignal();
    ...
    void apps_checkAuthorizationSignalFull(OAIHttpRequestWorker *worker, OAINullable_authorization summary);
    ...
    void apps_resetAuthorizationSignalFull(OAIHttpRequestWorker *worker, OAIAuthorization summary);
    void apps_resetTokenSignalFull(OAIHttpRequestWorker *worker, OAIAuthorization summary);
    void apps_revokeAuthorizationForApplicationSignalFull(OAIHttpRequestWorker *worker);
    void apps_revokeGrantForApplicationSignalFull(OAIHttpRequestWorker *worker);
    ...
    Q_DECL_DEPRECATED_X("Use apps_checkAuthorizationSignalError() instead")
    void apps_checkAuthorizationSignalE(OAINullable_authorization summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apps_checkAuthorizationSignalError(OAINullable_authorization summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apps_resetAuthorizationSignalError() instead")
    void apps_resetAuthorizationSignalE(OAIAuthorization summary, QNetworkReply::NetworkError error_type, QString error_str);
    void apps_resetAuthorizationSignalError(OAIAuthorization summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apps_revokeAuthorizationForApplicationSignalError() instead")
    void apps_revokeAuthorizationForApplicationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void apps_revokeAuthorizationForApplicationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apps_revokeGrantForApplicationSignalError() instead")
    void apps_revokeGrantForApplicationSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void apps_revokeGrantForApplicationSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apps_checkAuthorizationSignalErrorFull() instead")
    void apps_checkAuthorizationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apps_checkAuthorizationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apps_resetAuthorizationSignalErrorFull() instead")
    void apps_resetAuthorizationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apps_resetAuthorizationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use apps_revokeAuthorizationForApplicationSignalErrorFull() instead")
    void apps_revokeAuthorizationForApplicationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apps_revokeAuthorizationForApplicationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use apps_revokeGrantForApplicationSignalErrorFull() instead")
    void apps_revokeGrantForApplicationSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void apps_revokeGrantForApplicationSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
