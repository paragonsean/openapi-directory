...
bool OAIPull_request_head_repo::isHasDiscussions() const {
    return m_has_discussions;
}
void OAIPull_request_head_repo::setHasDiscussions(const bool &has_discussions) {
    m_has_discussions = has_discussions;
    m_has_discussions_isSet = true;
}

bool OAIPull_request_head_repo::is_has_discussions_Set() const{
    return m_has_discussions_isSet;
}

bool OAIPull_request_head_repo::is_has_discussions_Valid() const{
