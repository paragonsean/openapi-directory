...
public:
    ...
    * @param[in]  repo QString [required]
    * @param[in]  issue_number qint32 [required]
    * @param[in]  oai_issues_add_labels_request OAIIssues_add_labels_request [optional]
    */
    virtual void issues_addLabels(const QString &owner, const QString &repo, const qint32 &issue_number, const ::OpenAPI::OptionalParam<OAIIssues_add_labels_request> &oai_issues_add_labels_request = ::OpenAPI::OptionalParam<OAIIssues_add_labels_request>());
    ...
    * @param[in]  assignee QString [required]
    */
    virtual void issues_checkUserCanBeAssignedToIssue(const QString &owner, const QString &repo, const qint32 &issue_number, const QString &assignee);
...
private:
    ...
    void issues_checkUserCanBeAssignedToIssueCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void issues_addAssigneesSignal(OAIIssue summary);
    void issues_addLabelsSignal(QList<OAILabel> summary);
    void issues_checkUserCanBeAssignedSignal();
    void issues_checkUserCanBeAssignedToIssueSignal();
    ...
    void issues_listForRepoSignal(QList<OAIIssue> summary);
    ...
    void issues_removeAssigneesSignal(OAIIssue summary);
    ...
    void issues_addAssigneesSignalFull(OAIHttpRequestWorker *worker, OAIIssue summary);
    ...
    void issues_checkUserCanBeAssignedToIssueSignalFull(OAIHttpRequestWorker *worker);
    ...
    void issues_listForRepoSignalFull(OAIHttpRequestWorker *worker, QList<OAIIssue> summary);
    ...
    void issues_removeAssigneesSignalFull(OAIHttpRequestWorker *worker, OAIIssue summary);
    ...
    void issues_addAssigneesSignalE(OAIIssue summary, QNetworkReply::NetworkError error_type, QString error_str);
    void issues_addAssigneesSignalError(OAIIssue summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use issues_checkUserCanBeAssignedToIssueSignalError() instead")
    void issues_checkUserCanBeAssignedToIssueSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void issues_checkUserCanBeAssignedToIssueSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void issues_listForRepoSignalE(QList<OAIIssue> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void issues_listForRepoSignalError(QList<OAIIssue> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    void issues_removeAssigneesSignalE(OAIIssue summary, QNetworkReply::NetworkError error_type, QString error_str);
    void issues_removeAssigneesSignalError(OAIIssue summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use issues_checkUserCanBeAssignedToIssueSignalErrorFull() instead")
    void issues_checkUserCanBeAssignedToIssueSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void issues_checkUserCanBeAssignedToIssueSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
