...
bool OAINullable_repository::isAllowAutoMerge() const {
    return m_allow_auto_merge;
}
void OAINullable_repository::setAllowAutoMerge(const bool &allow_auto_merge) {
    m_allow_auto_merge = allow_auto_merge;
    m_allow_auto_merge_isSet = true;
}

bool OAINullable_repository::is_allow_auto_merge_Set() const{
    return m_allow_auto_merge_isSet;
}

bool OAINullable_repository::is_allow_auto_merge_Valid() const{
