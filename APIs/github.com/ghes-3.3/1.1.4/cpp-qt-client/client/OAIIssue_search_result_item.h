...
/*
 * OAIIssue_search_result_item.h
 *
 * Issue Search Result Item
 */

#ifndef OAIIssue_search_result_item_H
#define OAIIssue_search_result_item_H

#include <QJsonObject>

#include "OAIAuthor_association.h"
#include "OAIIssue_pull_request.h"
#include "OAIIssue_search_result_item_labels_inner.h"
...
class OAIIssue_search_result_item_labels_inner;
...
class OAIIssue_search_result_item : public OAIObject {
public:
    OAIIssue_search_result_item();
    OAIIssue_search_result_item(QString json);
    ~OAIIssue_search_result_item() override;
    ...
    QList<OAIIssue_search_result_item_labels_inner> getLabels() const;
    void setLabels(const QList<OAIIssue_search_result_item_labels_inner> &labels);
...
private:
    ...
    QList<OAIIssue_search_result_item_labels_inner> m_labels;
    bool m_labels_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssue_search_result_item)

#endif // OAIIssue_search_result_item_H
