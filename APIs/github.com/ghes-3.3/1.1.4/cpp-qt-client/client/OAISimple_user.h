...
#ifndef OAISimple_user_H
#define OAISimple_user_H
...
class OAISimple_user : public OAIObject {
public:
    OAISimple_user();
    OAISimple_user(QString json);
    ~OAISimple_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISimple_user)

#endif // OAISimple_user_H
