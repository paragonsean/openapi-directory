...
/*
 * OAIContent_tree_entries_inner.h
 *
 * 
 */

#ifndef OAIContent_tree_entries_inner_H
#define OAIContent_tree_entries_inner_H
...
class OAIContent_tree_entries_inner : public OAIObject {
public:
    OAIContent_tree_entries_inner();
    OAIContent_tree_entries_inner(QString json);
    ~OAIContent_tree_entries_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContent_tree_entries_inner)

#endif // OAIContent_tree_entries_inner_H
