...
OAIAuto_merge OAIPull_request_simple::getAutoMerge() const {
    return m_auto_merge;
}
void OAIPull_request_simple::setAutoMerge(const OAIAuto_merge &auto_merge) {
    m_auto_merge = auto_merge;
    m_auto_merge_isSet = true;
}

bool OAIPull_request_simple::is_auto_merge_Set() const{
    return m_auto_merge_isSet;
}

bool OAIPull_request_simple::is_auto_merge_Valid() const{
