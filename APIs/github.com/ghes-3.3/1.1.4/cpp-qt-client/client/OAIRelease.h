...
public:
    ...
    qint32 getMentionsCount() const;
    void setMentionsCount(const qint32 &mentions_count);
    bool is_mentions_count_Set() const;
    bool is_mentions_count_Valid() const;
...
private:
    ...
    qint32 m_mentions_count;
    bool m_mentions_count_isSet;
    bool m_mentions_count_isValid;
