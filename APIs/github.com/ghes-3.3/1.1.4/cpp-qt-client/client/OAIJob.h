...
public:
    ...
    qint32 getRunnerGroupId() const;
    void setRunnerGroupId(const qint32 &runner_group_id);
    bool is_runner_group_id_Set() const;
    bool is_runner_group_id_Valid() const;

    QString getRunnerGroupName() const;
    void setRunnerGroupName(const QString &runner_group_name);
    bool is_runner_group_name_Set() const;
    bool is_runner_group_name_Valid() const;
    ...
    QString getRunnerName() const;
    void setRunnerName(const QString &runner_name);
    bool is_runner_name_Set() const;
    bool is_runner_name_Valid() const;
...
private:
    ...
    qint32 m_runner_group_id;
    bool m_runner_group_id_isSet;
    bool m_runner_group_id_isValid;

    QString m_runner_group_name;
    bool m_runner_group_name_isSet;
    bool m_runner_group_name_isValid;

    qint32 m_runner_id;
    bool m_runner_id_isSet;
    bool m_runner_id_isValid;

    QString m_runner_name;
    bool m_runner_name_isSet;
    bool m_runner_name_isValid;
