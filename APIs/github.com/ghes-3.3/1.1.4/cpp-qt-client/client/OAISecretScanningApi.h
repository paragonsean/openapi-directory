...
public:
    ...
    */
    virtual void secretScanning_listAlertsForOrg(const QString &org, const ::OpenAPI::OptionalParam<QString> &state = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &secret_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &resolution = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  per_page qint32 [optional]
    */
    virtual void secretScanning_listLocationsForAlert(const QString &owner, const QString &repo, const qint32 &alert_number, const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>());
...
private:
    ...
    void secretScanning_listAlertsForOrgCallback(OAIHttpRequestWorker *worker);
    void secretScanning_listAlertsForRepoCallback(OAIHttpRequestWorker *worker);
    void secretScanning_listLocationsForAlertCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void secretScanning_listAlertsForOrgSignal(QList<OAIOrganization_secret_scanning_alert> summary);
    void secretScanning_listAlertsForRepoSignal(QList<OAISecret_scanning_alert> summary);
    void secretScanning_listLocationsForAlertSignal(QList<OAISecret_scanning_location> summary);
    ...
    void secretScanning_listAlertsForOrgSignalFull(OAIHttpRequestWorker *worker, QList<OAIOrganization_secret_scanning_alert> summary);
    void secretScanning_listAlertsForRepoSignalFull(OAIHttpRequestWorker *worker, QList<OAISecret_scanning_alert> summary);
    void secretScanning_listLocationsForAlertSignalFull(OAIHttpRequestWorker *worker, QList<OAISecret_scanning_location> summary);
    ...
    Q_DECL_DEPRECATED_X("Use secretScanning_listAlertsForOrgSignalError() instead")
    void secretScanning_listAlertsForOrgSignalE(QList<OAIOrganization_secret_scanning_alert> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void secretScanning_listAlertsForOrgSignalError(QList<OAIOrganization_secret_scanning_alert> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use secretScanning_listLocationsForAlertSignalError() instead")
    void secretScanning_listLocationsForAlertSignalE(QList<OAISecret_scanning_location> summary, QNetworkReply::NetworkError error_type, QString error_str);
    void secretScanning_listLocationsForAlertSignalError(QList<OAISecret_scanning_location> summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use secretScanning_listAlertsForOrgSignalErrorFull() instead")
    void secretScanning_listAlertsForOrgSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void secretScanning_listAlertsForOrgSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use secretScanning_listLocationsForAlertSignalErrorFull() instead")
    void secretScanning_listLocationsForAlertSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void secretScanning_listLocationsForAlertSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
