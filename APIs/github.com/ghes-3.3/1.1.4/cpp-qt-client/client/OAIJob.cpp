...
void OAIJob::initializeModel() {
    ...
    m_runner_group_id_isSet = false;
    m_runner_group_id_isValid = false;

    m_runner_group_name_isSet = false;
    m_runner_group_name_isValid = false;

    m_runner_id_isSet = false;
    m_runner_id_isValid = false;

    m_runner_name_isSet = false;
    m_runner_name_isValid = false;
...
void OAIJob::fromJsonObject(QJsonObject json) {
    ...
    m_runner_group_id_isValid = ::OpenAPI::fromJsonValue(m_runner_group_id, json[QString("runner_group_id")]);
    m_runner_group_id_isSet = !json[QString("runner_group_id")].isNull() && m_runner_group_id_isValid;

    m_runner_group_name_isValid = ::OpenAPI::fromJsonValue(m_runner_group_name, json[QString("runner_group_name")]);
    m_runner_group_name_isSet = !json[QString("runner_group_name")].isNull() && m_runner_group_name_isValid;
    ...
    m_runner_name_isValid = ::OpenAPI::fromJsonValue(m_runner_name, json[QString("runner_name")]);
    m_runner_name_isSet = !json[QString("runner_name")].isNull() && m_runner_name_isValid;
...
QJsonObject OAIJob::asJsonObject() const {
    ...
    if (m_runner_group_id_isSet) {
        obj.insert(QString("runner_group_id"), ::OpenAPI::toJsonValue(m_runner_group_id));
    }
    if (m_runner_group_name_isSet) {
        obj.insert(QString("runner_group_name"), ::OpenAPI::toJsonValue(m_runner_group_name));
    }
    if (m_runner_id_isSet) {
        obj.insert(QString("runner_id"), ::OpenAPI::toJsonValue(m_runner_id));
    }
    if (m_runner_name_isSet) {
        obj.insert(QString("runner_name"), ::OpenAPI::toJsonValue(m_runner_name));
    }
...
QList<QString> OAIJob::getLabels() const {
    return m_labels;
}
void OAIJob::setLabels(const QList<QString> &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}
...
qint32 OAIJob::getRunnerGroupId() const {
    return m_runner_group_id;
}
void OAIJob::setRunnerGroupId(const qint32 &runner_group_id) {
    m_runner_group_id = runner_group_id;
    m_runner_group_id_isSet = true;
}

bool OAIJob::is_runner_group_id_Set() const{
    return m_runner_group_id_isSet;
}

bool OAIJob::is_runner_group_id_Valid() const{
    return m_runner_group_id_isValid;
}

QString OAIJob::getRunnerGroupName() const {
    return m_runner_group_name;
}
void OAIJob::setRunnerGroupName(const QString &runner_group_name) {
    m_runner_group_name = runner_group_name;
    m_runner_group_name_isSet = true;
}

bool OAIJob::is_runner_group_name_Set() const{
    return m_runner_group_name_isSet;
}

bool OAIJob::is_runner_group_name_Valid() const{
    return m_runner_group_name_isValid;
}

qint32 OAIJob::getRunnerId() const {
    return m_runner_id;
}
void OAIJob::setRunnerId(const qint32 &runner_id) {
    m_runner_id = runner_id;
    m_runner_id_isSet = true;
}

bool OAIJob::is_runner_id_Set() const{
    return m_runner_id_isSet;
}

bool OAIJob::is_runner_id_Valid() const{
    return m_runner_id_isValid;
}

QString OAIJob::getRunnerName() const {
    return m_runner_name;
}
void OAIJob::setRunnerName(const QString &runner_name) {
    m_runner_name = runner_name;
    m_runner_name_isSet = true;
}

bool OAIJob::is_runner_name_Set() const{
    return m_runner_name_isSet;
}

bool OAIJob::is_runner_name_Valid() const{
    return m_runner_name_isValid;
}
...
bool OAIJob::isValid() const {
    ...
    return m_check_run_url_isValid && m_completed_at_isValid && m_conclusion_isValid && m_head_sha_isValid && m_html_url_isValid && m_id_isValid && m_labels_isValid && m_name_isValid && m_node_id_isValid && m_run_id_isValid && m_run_url_isValid && m_runner_group_id_isValid && m_runner_group_name_isValid && m_runner_id_isValid && m_runner_name_isValid && m_started_at_isValid && m_status_isValid && m_url_isValid && true;
}
