...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.IssuesUpdateRequest();
  });
  ...
  describe('IssuesUpdateRequest', function() {
    it('should create an instance of IssuesUpdateRequest', function() {
      // uncomment below and update the code to test IssuesUpdateRequest
      //var instance = new GitHubV3RestApi.IssuesUpdateRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.IssuesUpdateRequest);
    });
