...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.InstallationAccount();
  });
  ...
  describe('InstallationAccount', function() {
    it('should create an instance of InstallationAccount', function() {
      // uncomment below and update the code to test InstallationAccount
      //var instance = new GitHubV3RestApi.InstallationAccount();
      //expect(instance).to.be.a(GitHubV3RestApi.InstallationAccount);
    });
