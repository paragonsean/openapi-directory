...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyTeamsInner();
  });
  ...
  describe('BranchRestrictionPolicyTeamsInner', function() {
    it('should create an instance of BranchRestrictionPolicyTeamsInner', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyTeamsInner
      //var instance = new GitHubV3RestApi.BranchRestrictionPolicyTeamsInner();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyTeamsInner);
    });
