...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposCreateOrUpdateFileContentsRequest();
  });
  ...
  describe('ReposCreateOrUpdateFileContentsRequest', function() {
    it('should create an instance of ReposCreateOrUpdateFileContentsRequest', function() {
      // uncomment below and update the code to test ReposCreateOrUpdateFileContentsRequest
      //var instance = new GitHubV3RestApi.ReposCreateOrUpdateFileContentsRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposCreateOrUpdateFileContentsRequest);
    });
