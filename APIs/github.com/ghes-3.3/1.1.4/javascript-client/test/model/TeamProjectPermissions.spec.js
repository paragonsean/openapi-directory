...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TeamProjectPermissions();
  });
  ...
  describe('TeamProjectPermissions', function() {
    it('should create an instance of TeamProjectPermissions', function() {
      // uncomment below and update the code to test TeamProjectPermissions
      //var instance = new GitHubV3RestApi.TeamProjectPermissions();
      //expect(instance).to.be.a(GitHubV3RestApi.TeamProjectPermissions);
    });
