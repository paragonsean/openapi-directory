...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.CommitActivity();
  });
  ...
  describe('CommitActivity', function() {
    it('should create an instance of CommitActivity', function() {
      // uncomment below and update the code to test CommitActivity
      //var instance = new GitHubV3RestApi.CommitActivity();
      //expect(instance).to.be.a(GitHubV3RestApi.CommitActivity);
    });
