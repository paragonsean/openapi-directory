...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.NullableCollaborator();
  });
  ...
  describe('NullableCollaborator', function() {
    it('should create an instance of NullableCollaborator', function() {
      // uncomment below and update the code to test NullableCollaborator
      //var instance = new GitHubV3RestApi.NullableCollaborator();
      //expect(instance).to.be.a(GitHubV3RestApi.NullableCollaborator);
    });
