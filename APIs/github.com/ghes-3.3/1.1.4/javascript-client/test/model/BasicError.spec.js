...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BasicError();
  });
  ...
  describe('BasicError', function() {
    it('should create an instance of BasicError', function() {
      // uncomment below and update the code to test BasicError
      //var instance = new GitHubV3RestApi.BasicError();
      //expect(instance).to.be.a(GitHubV3RestApi.BasicError);
    });
