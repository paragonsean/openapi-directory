...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
  });
  ...
  describe('ReposCreateForAuthenticatedUserRequest', function() {
    it('should create an instance of ReposCreateForAuthenticatedUserRequest', function() {
      // uncomment below and update the code to test ReposCreateForAuthenticatedUserRequest
      //var instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest);
    });

    it('should have the property allowAutoMerge (base name: "allow_auto_merge")', function() {
      // uncomment below and update the code to test the property allowAutoMerge
      //var instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
    ...
    it('should have the property hasDiscussions (base name: "has_discussions")', function() {
      // uncomment below and update the code to test the property hasDiscussions
      //var instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mergeCommitTitle (base name: "merge_commit_title")', function() {
      // uncomment below and update the code to test the property mergeCommitTitle
      //var instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property squashMergeCommitMessage (base name: "squash_merge_commit_message")', function() {
      // uncomment below and update the code to test the property squashMergeCommitMessage
      //var instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
      //expect(instance).to.be();
    });

    it('should have the property squashMergeCommitTitle (base name: "squash_merge_commit_title")', function() {
      // uncomment below and update the code to test the property squashMergeCommitTitle
      //var instance = new GitHubV3RestApi.ReposCreateForAuthenticatedUserRequest();
      //expect(instance).to.be();
    });
