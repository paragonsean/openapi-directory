...
export default class IssuesApi {
    ...
    */
     ...
     * @param {Number} issueNumber The number that identifies the issue.
     * @param {Object} opts Optional parameters
     * @param {module:model/IssuesAddLabelsRequest} [issuesAddLabelsRequest] 
    ...
    issuesAddLabels(owner, repo, issueNumber, opts, callback) {
      opts = opts || {};
      let postBody = opts['issuesAddLabelsRequest'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
    ...
    /**
     * Callback function to receive the result of the issuesCheckUserCanBeAssignedToIssue operation.
     * @callback module:api/IssuesApi~issuesCheckUserCanBeAssignedToIssueCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} issueNumber The number that identifies the issue.
     * @param {String} assignee 
     * @param {module:api/IssuesApi~issuesCheckUserCanBeAssignedToIssueCallback} callback The callback function, accepting three arguments: error, data, response
     */
    issuesCheckUserCanBeAssignedToIssue(owner, repo, issueNumber, assignee, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling issuesCheckUserCanBeAssignedToIssue");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling issuesCheckUserCanBeAssignedToIssue");
      }
      // verify the required parameter 'issueNumber' is set
      if (issueNumber === undefined || issueNumber === null) {
        throw new Error("Missing the required parameter 'issueNumber' when calling issuesCheckUserCanBeAssignedToIssue");
      }
      // verify the required parameter 'assignee' is set
      if (assignee === undefined || assignee === null) {
        throw new Error("Missing the required parameter 'assignee' when calling issuesCheckUserCanBeAssignedToIssue");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/issues/{issue_number}/assignees/{assignee}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {Number} milestoneNumber The number that identifies the milestone.
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [filter = 'assigned')] Indicates which sorts of issues to return. `assigned` means issues assigned to you. `created` means issues created by you. `mentioned` means issues mentioning you. `subscribed` means issues you're subscribed to updates for. `all` or `repos` means all issues you can see, regardless of participation or creation.
     * @param {module:model/String} [state = 'open')] Indicates the state of the issues to return.
     * @param {String} [labels] A list of comma separated label names. Example: `bug,ui,@high`
     * @param {module:model/String} [sort = 'created')] What to sort results by.
     ...
     * @param {String} name 
     * @param {Object} opts Optional parameters
     * @param {module:model/IssuesUpdateLabelRequest} [issuesUpdateLabelRequest] 
     ...
     * data is of type: {@link module:model/Label}
     */
    issuesUpdateLabel(owner, repo, name, opts, callback) {
      opts = opts || {};
      let postBody = opts['issuesUpdateLabelRequest'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
