...
export default class ProjectsApi {
    ...
    */
     ...
     * 
     * @param {Number} columnId The unique identifier of the column.
     ...
     * 
     * @param {Number} cardId The unique identifier of the card.
     ...
     * @param {Number} columnId The unique identifier of the column.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [archivedState = 'not_archived')] Filters the project cards that are returned by the card's state.
     ...
     * @param {Number} projectId The unique identifier of the project.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [affiliation = 'all')] Filters the collaborators by their affiliation. `outside` means outside collaborators of a project that are not a member of the project's organization. `direct` means collaborators with permissions to a project, regardless of organization membership status. `all` means all collaborators the authenticated user can see.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {String} org The organization name. The name is not case sensitive.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [state = 'open')] Indicates the state of the projects to return.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
