...
export default class EnterpriseAdminApi {
    ...
    */
     ...
     * @param {String} [settings] An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.3/rest/reference/enterprise-admin#get-settings).
     ...
     */
    enterpriseAdminCreateGlobalWebhook(enterpriseAdminCreateGlobalWebhookRequest, callback) {
    ...
    /**
     * Callback function to receive the result of the enterpriseAdminGetAuditLog operation.
     * @callback module:api/EnterpriseAdminApi~enterpriseAdminGetAuditLogCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} enterprise The slug version of the enterprise name. You can also substitute this value with the enterprise id.
     * @param {Object} opts Optional parameters
     * @param {String} [phrase] A search phrase. For more information, see [Searching the audit log](https://docs.github.com/enterprise-server@3.3/github/setting-up-and-managing-organizations-and-teams/reviewing-the-audit-log-for-your-organization#searching-the-audit-log).
     * @param {String} [after] A cursor, as given in the [Link header](https://docs.github.com/enterprise-server@3.3/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for events after this cursor.
     * @param {String} [before] A cursor, as given in the [Link header](https://docs.github.com/enterprise-server@3.3/rest/overview/resources-in-the-rest-api#link-header). If specified, the query only searches for events before this cursor.
     ...
     * @param {module:api/EnterpriseAdminApi~enterpriseAdminGetAuditLogCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/AuditLogEvent>}
     */
    enterpriseAdminGetAuditLog(enterprise, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'enterprise' is set
      if (enterprise === undefined || enterprise === null) {
        throw new Error("Missing the required parameter 'enterprise' when calling enterpriseAdminGetAuditLog");
      }
     ...
     * data is of type: {@link module:model/GlobalHook}
     */
    enterpriseAdminGetGlobalWebhook(hookId, callback) {
      let postBody = null;
      // verify the required parameter 'hookId' is set
      if (hookId === undefined || hookId === null) {
     ...
     * @param {String} settings A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.3/rest/reference/enterprise-admin#get-settings).
     ...
     */
    enterpriseAdminUpdateGlobalWebhook(hookId, enterpriseAdminUpdateGlobalWebhookRequest, callback) {
      let postBody = enterpriseAdminUpdateGlobalWebhookRequest;
      // verify the required parameter 'hookId' is set
      if (hookId === undefined || hookId === null) {
      ...
      if (enterpriseAdminUpdateGlobalWebhookRequest === undefined || enterpriseAdminUpdateGlobalWebhookRequest === null) {
        throw new Error("Missing the required parameter 'enterpriseAdminUpdateGlobalWebhookRequest' when calling enterpriseAdminUpdateGlobalWebhook");
      }
