...
export default class ReposApi {
    ...
    */
     ...
     * @param {String} branch The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.3/graphql).
     ...
     * @param {String} branch The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.3/graphql).
     * @param {Object} opts Optional parameters
     * @param {module:model/ReposAddTeamAccessRestrictionsRequest} [reposAddTeamAccessRestrictionsRequest] 
    ...
    reposAddTeamAccessRestrictions(owner, repo, branch, opts, callback) {
      opts = opts || {};
      let postBody = opts['reposAddTeamAccessRestrictionsRequest'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     */
    reposCompareCommits(owner, repo, basehead, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
    ...
    /**
     * Callback function to receive the result of the reposCreateAutolink operation.
     * @callback module:api/ReposApi~reposCreateAutolinkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Autolink} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {module:model/ReposCreateAutolinkRequest} reposCreateAutolinkRequest 
     * @param {module:api/ReposApi~reposCreateAutolinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Autolink}
     */
    reposCreateAutolink(owner, repo, reposCreateAutolinkRequest, callback) {
      let postBody = reposCreateAutolinkRequest;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposCreateAutolink");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposCreateAutolink");
      }
      // verify the required parameter 'reposCreateAutolinkRequest' is set
      if (reposCreateAutolinkRequest === undefined || reposCreateAutolinkRequest === null) {
        throw new Error("Missing the required parameter 'reposCreateAutolinkRequest' when calling reposCreateAutolink");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = Autolink;
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/autolinks', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposCreateDeploymentBranchPolicy operation.
     * @callback module:api/ReposApi~reposCreateDeploymentBranchPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeploymentBranchPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/DeploymentBranchPolicyNamePattern} deploymentBranchPolicyNamePattern 
     * @param {module:api/ReposApi~reposCreateDeploymentBranchPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeploymentBranchPolicy}
     */
    reposCreateDeploymentBranchPolicy(owner, repo, environmentName, deploymentBranchPolicyNamePattern, callback) {
      let postBody = deploymentBranchPolicyNamePattern;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposCreateDeploymentBranchPolicy");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposCreateDeploymentBranchPolicy");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposCreateDeploymentBranchPolicy");
      }
      // verify the required parameter 'deploymentBranchPolicyNamePattern' is set
      if (deploymentBranchPolicyNamePattern === undefined || deploymentBranchPolicyNamePattern === null) {
        throw new Error("Missing the required parameter 'deploymentBranchPolicyNamePattern' when calling reposCreateDeploymentBranchPolicy");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = DeploymentBranchPolicy;
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/environments/{environment_name}/deployment-branch-policies', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposCreateOrUpdateEnvironment operation.
     * @callback module:api/ReposApi~reposCreateOrUpdateEnvironmentCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} environmentName The name of the environment.
     * @param {Object} opts Optional parameters
     * @param {module:model/ReposCreateOrUpdateEnvironmentRequest} [reposCreateOrUpdateEnvironmentRequest] 
     * @param {module:api/ReposApi~reposCreateOrUpdateEnvironmentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Environment}
     */
    reposCreateOrUpdateEnvironment(owner, repo, environmentName, opts, callback) {
      opts = opts || {};
      let postBody = opts['reposCreateOrUpdateEnvironmentRequest'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposCreateOrUpdateEnvironment");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposCreateOrUpdateEnvironment");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposCreateOrUpdateEnvironment");
      }
      ...
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/environments/{environment_name}', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposDeleteAnEnvironment operation.
     * @callback module:api/ReposApi~reposDeleteAnEnvironmentCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {String} environmentName The name of the environment.
     * @param {module:api/ReposApi~reposDeleteAnEnvironmentCallback} callback The callback function, accepting three arguments: error, data, response
     */
    reposDeleteAnEnvironment(owner, repo, environmentName, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposDeleteAnEnvironment");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposDeleteAnEnvironment");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposDeleteAnEnvironment");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/environments/{environment_name}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposDeleteAutolink operation.
     * @callback module:api/ReposApi~reposDeleteAutolinkCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {Number} autolinkId The unique identifier of the autolink.
     * @param {module:api/ReposApi~reposDeleteAutolinkCallback} callback The callback function, accepting three arguments: error, data, response
     */
    reposDeleteAutolink(owner, repo, autolinkId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposDeleteAutolink");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposDeleteAutolink");
      }
      // verify the required parameter 'autolinkId' is set
      if (autolinkId === undefined || autolinkId === null) {
        throw new Error("Missing the required parameter 'autolinkId' when calling reposDeleteAutolink");
      }
    ...
    /**
     * Callback function to receive the result of the reposDeleteDeploymentBranchPolicy operation.
     * @callback module:api/ReposApi~reposDeleteDeploymentBranchPolicyCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {String} environmentName The name of the environment.
     * @param {Number} branchPolicyId The unique identifier of the branch policy.
     * @param {module:api/ReposApi~reposDeleteDeploymentBranchPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     */
    reposDeleteDeploymentBranchPolicy(owner, repo, environmentName, branchPolicyId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposDeleteDeploymentBranchPolicy");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposDeleteDeploymentBranchPolicy");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposDeleteDeploymentBranchPolicy");
      }
      // verify the required parameter 'branchPolicyId' is set
      if (branchPolicyId === undefined || branchPolicyId === null) {
        throw new Error("Missing the required parameter 'branchPolicyId' when calling reposDeleteDeploymentBranchPolicy");
      }
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {Number} hookId The unique identifier of the hook.
    ...
    /**
     * Callback function to receive the result of the reposDisableLfsForRepo operation.
     * @callback module:api/ReposApi~reposDisableLfsForRepoCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {module:api/ReposApi~reposDisableLfsForRepoCallback} callback The callback function, accepting three arguments: error, data, response
     */
    reposDisableLfsForRepo(owner, repo, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposDisableLfsForRepo");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposDisableLfsForRepo");
      }
    ...
    /**
     * Callback function to receive the result of the reposEnableLfsForRepo operation.
     * @callback module:api/ReposApi~reposEnableLfsForRepoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {module:api/ReposApi~reposEnableLfsForRepoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    reposEnableLfsForRepo(owner, repo, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposEnableLfsForRepo");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposEnableLfsForRepo");
      }
    ...
    /**
     * Callback function to receive the result of the reposGenerateReleaseNotes operation.
     * @callback module:api/ReposApi~reposGenerateReleaseNotesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReleaseNotesContent} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {module:model/ReposGenerateReleaseNotesRequest} reposGenerateReleaseNotesRequest 
     * @param {module:api/ReposApi~reposGenerateReleaseNotesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReleaseNotesContent}
     */
    reposGenerateReleaseNotes(owner, repo, reposGenerateReleaseNotesRequest, callback) {
      let postBody = reposGenerateReleaseNotesRequest;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposGenerateReleaseNotes");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposGenerateReleaseNotes");
      }
      // verify the required parameter 'reposGenerateReleaseNotesRequest' is set
      if (reposGenerateReleaseNotesRequest === undefined || reposGenerateReleaseNotesRequest === null) {
        throw new Error("Missing the required parameter 'reposGenerateReleaseNotesRequest' when calling reposGenerateReleaseNotes");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ReleaseNotesContent;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the reposGetAllEnvironments operation.
     * @callback module:api/ReposApi~reposGetAllEnvironmentsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReposGetAllEnvironments200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     * @param {module:api/ReposApi~reposGetAllEnvironmentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReposGetAllEnvironments200Response}
     */
    reposGetAllEnvironments(owner, repo, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposGetAllEnvironments");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposGetAllEnvironments");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReposGetAllEnvironments200Response;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the reposGetAutolink operation.
     * @callback module:api/ReposApi~reposGetAutolinkCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Autolink} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {Number} autolinkId The unique identifier of the autolink.
     * @param {module:api/ReposApi~reposGetAutolinkCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Autolink}
     */
    reposGetAutolink(owner, repo, autolinkId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposGetAutolink");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposGetAutolink");
      }
      // verify the required parameter 'autolinkId' is set
      if (autolinkId === undefined || autolinkId === null) {
        throw new Error("Missing the required parameter 'autolinkId' when calling reposGetAutolink");
      }
      ...
      let returnType = Autolink;
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/autolinks/{autolink_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    reposGetContent(owner, repo, path, opts, callback) {
      ...
      let authNames = [];
      let contentTypes = [];
      let accepts = ['application/json', 'application/vnd.github.object'];
    ...
    /**
     * Callback function to receive the result of the reposGetDeploymentBranchPolicy operation.
     * @callback module:api/ReposApi~reposGetDeploymentBranchPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeploymentBranchPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} environmentName The name of the environment.
     * @param {Number} branchPolicyId The unique identifier of the branch policy.
     * @param {module:api/ReposApi~reposGetDeploymentBranchPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeploymentBranchPolicy}
     */
    reposGetDeploymentBranchPolicy(owner, repo, environmentName, branchPolicyId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposGetDeploymentBranchPolicy");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposGetDeploymentBranchPolicy");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposGetDeploymentBranchPolicy");
      }
      // verify the required parameter 'branchPolicyId' is set
      if (branchPolicyId === undefined || branchPolicyId === null) {
        throw new Error("Missing the required parameter 'branchPolicyId' when calling reposGetDeploymentBranchPolicy");
      }
      ...
      let returnType = DeploymentBranchPolicy;
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/environments/{environment_name}/deployment-branch-policies/{branch_policy_id}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposGetEnvironment operation.
     * @callback module:api/ReposApi~reposGetEnvironmentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Environment} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {String} environmentName The name of the environment.
     * @param {module:api/ReposApi~reposGetEnvironmentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Environment}
     */
    reposGetEnvironment(owner, repo, environmentName, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposGetEnvironment");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposGetEnvironment");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposGetEnvironment");
      }
    ...
    /**
     * Callback function to receive the result of the reposGetWebhookDelivery operation.
     * @callback module:api/ReposApi~reposGetWebhookDeliveryCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ReposApi~reposGetWebhookDeliveryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/HookDelivery}
     */
    reposGetWebhookDelivery(owner, repo, hookId, deliveryId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposGetWebhookDelivery");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposGetWebhookDelivery");
      }
      // verify the required parameter 'hookId' is set
      if (hookId === undefined || hookId === null) {
        throw new Error("Missing the required parameter 'hookId' when calling reposGetWebhookDelivery");
      }
      // verify the required parameter 'deliveryId' is set
      if (deliveryId === undefined || deliveryId === null) {
        throw new Error("Missing the required parameter 'deliveryId' when calling reposGetWebhookDelivery");
      }
    ...
    /**
     * Callback function to receive the result of the reposListAutolinks operation.
     * @callback module:api/ReposApi~reposListAutolinksCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Autolink>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} [page = 1)] Page number of the results to fetch.
     * @param {module:api/ReposApi~reposListAutolinksCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Autolink>}
     */
    reposListAutolinks(owner, repo, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposListAutolinks");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposListAutolinks");
      }
      ...
      let returnType = [Autolink];
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/autolinks', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposListDeploymentBranchPolicies operation.
     * @callback module:api/ReposApi~reposListDeploymentBranchPoliciesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ReposListDeploymentBranchPolicies200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     * @param {module:api/ReposApi~reposListDeploymentBranchPoliciesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ReposListDeploymentBranchPolicies200Response}
     */
    reposListDeploymentBranchPolicies(owner, repo, environmentName, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposListDeploymentBranchPolicies");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposListDeploymentBranchPolicies");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposListDeploymentBranchPolicies");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ReposListDeploymentBranchPolicies200Response;
      return this.apiClient.callApi(
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [visibility = 'all')] Limit results to repositories with the specified visibility.
     ...
     * @param {module:model/String} [type = 'all')] Limit results to repositories of the specified type. Will cause a `422` error if used in the same request as **visibility** or **affiliation**.
     * @param {module:model/String} [sort = 'full_name')] The property to sort the results by.
     ...
     * @param {String} org The organization name. The name is not case sensitive.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [type] Specifies the types of repositories you want returned. `internal` is not yet supported when a GitHub App calls this endpoint with an installation access token.
     ...
     * @param {String} username The handle for the GitHub user account.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [type = 'owner')] Limit results to repositories of the specified type.
     * @param {module:model/String} [sort = 'full_name')] The property to sort the results by.
     * @param {module:model/String} [direction] The order to sort by. Default: `asc` when using `full_name`, otherwise `desc`.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [sort = 'newest')] The sort order. `stargazers` will sort by star count.
     * @param {Number} [perPage = 30)] The number of results per page (max 100).
     * @param {Number} [page = 1)] Page number of the results to fetch.
     ...
     * @param {module:model/String} [visibility = 'public')] Specifies the types of repositories to return. This endpoint will only list repositories available to all users on the enterprise.
    ...
    /**
     * Callback function to receive the result of the reposListWebhookDeliveries operation.
     * @callback module:api/ReposApi~reposListWebhookDeliveriesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ReposApi~reposListWebhookDeliveriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/HookDeliveryItem>}
     */
    reposListWebhookDeliveries(owner, repo, hookId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposListWebhookDeliveries");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposListWebhookDeliveries");
      }
      // verify the required parameter 'hookId' is set
      if (hookId === undefined || hookId === null) {
        throw new Error("Missing the required parameter 'hookId' when calling reposListWebhookDeliveries");
      }
      ...
      return this.apiClient.callApi(
        '/repos/{owner}/{repo}/hooks/{hook_id}/deliveries', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the reposMergeUpstream operation.
     * @callback module:api/ReposApi~reposMergeUpstreamCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MergedUpstream} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner The account owner of the repository. The name is not case sensitive.
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {module:model/ReposMergeUpstreamRequest} reposMergeUpstreamRequest 
     * @param {module:api/ReposApi~reposMergeUpstreamCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MergedUpstream}
     */
    reposMergeUpstream(owner, repo, reposMergeUpstreamRequest, callback) {
      let postBody = reposMergeUpstreamRequest;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposMergeUpstream");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposMergeUpstream");
      }
      // verify the required parameter 'reposMergeUpstreamRequest' is set
      if (reposMergeUpstreamRequest === undefined || reposMergeUpstreamRequest === null) {
        throw new Error("Missing the required parameter 'reposMergeUpstreamRequest' when calling reposMergeUpstream");
      }
    ...
    /**
     * Callback function to receive the result of the reposRedeliverWebhookDelivery operation.
     * @callback module:api/ReposApi~reposRedeliverWebhookDeliveryCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} hookId The unique identifier of the hook.
     * @param {Number} deliveryId 
     * @param {module:api/ReposApi~reposRedeliverWebhookDeliveryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    reposRedeliverWebhookDelivery(owner, repo, hookId, deliveryId, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposRedeliverWebhookDelivery");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposRedeliverWebhookDelivery");
      }
      // verify the required parameter 'hookId' is set
      if (hookId === undefined || hookId === null) {
        throw new Error("Missing the required parameter 'hookId' when calling reposRedeliverWebhookDelivery");
      }
      // verify the required parameter 'deliveryId' is set
      if (deliveryId === undefined || deliveryId === null) {
        throw new Error("Missing the required parameter 'deliveryId' when calling reposRedeliverWebhookDelivery");
      }
    ...
    /**
     * Callback function to receive the result of the reposRenameBranch operation.
     * @callback module:api/ReposApi~reposRenameBranchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BranchWithProtection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} repo The name of the repository. The name is not case sensitive.
     * @param {String} branch The name of the branch. Cannot contain wildcard characters. To use wildcard characters in branch names, use [the GraphQL API](https://docs.github.com/enterprise-server@3.3/graphql).
     * @param {module:model/ReposRenameBranchRequest} reposRenameBranchRequest 
     * @param {module:api/ReposApi~reposRenameBranchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BranchWithProtection}
     */
    reposRenameBranch(owner, repo, branch, reposRenameBranchRequest, callback) {
      let postBody = reposRenameBranchRequest;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposRenameBranch");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposRenameBranch");
      }
      // verify the required parameter 'branch' is set
      if (branch === undefined || branch === null) {
        throw new Error("Missing the required parameter 'branch' when calling reposRenameBranch");
      }
      // verify the required parameter 'reposRenameBranchRequest' is set
      if (reposRenameBranchRequest === undefined || reposRenameBranchRequest === null) {
        throw new Error("Missing the required parameter 'reposRenameBranchRequest' when calling reposRenameBranch");
      }
    ...
    /**
     * Callback function to receive the result of the reposUpdateDeploymentBranchPolicy operation.
     * @callback module:api/ReposApi~reposUpdateDeploymentBranchPolicyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DeploymentBranchPolicy} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} branchPolicyId The unique identifier of the branch policy.
     * @param {module:model/DeploymentBranchPolicyNamePattern} deploymentBranchPolicyNamePattern 
     * @param {module:api/ReposApi~reposUpdateDeploymentBranchPolicyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DeploymentBranchPolicy}
     */
    reposUpdateDeploymentBranchPolicy(owner, repo, environmentName, branchPolicyId, deploymentBranchPolicyNamePattern, callback) {
      let postBody = deploymentBranchPolicyNamePattern;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling reposUpdateDeploymentBranchPolicy");
      }
      // verify the required parameter 'repo' is set
      if (repo === undefined || repo === null) {
        throw new Error("Missing the required parameter 'repo' when calling reposUpdateDeploymentBranchPolicy");
      }
      // verify the required parameter 'environmentName' is set
      if (environmentName === undefined || environmentName === null) {
        throw new Error("Missing the required parameter 'environmentName' when calling reposUpdateDeploymentBranchPolicy");
      }
      // verify the required parameter 'branchPolicyId' is set
      if (branchPolicyId === undefined || branchPolicyId === null) {
        throw new Error("Missing the required parameter 'branchPolicyId' when calling reposUpdateDeploymentBranchPolicy");
      }
      // verify the required parameter 'deploymentBranchPolicyNamePattern' is set
      if (deploymentBranchPolicyNamePattern === undefined || deploymentBranchPolicyNamePattern === null) {
        throw new Error("Missing the required parameter 'deploymentBranchPolicyNamePattern' when calling reposUpdateDeploymentBranchPolicy");
      }
     ...
     * @param {Number} hookId The unique identifier of the hook.
     * @param {Object} opts Optional parameters
     * @param {module:model/ReposUpdateWebhookConfigForRepoRequest} [reposUpdateWebhookConfigForRepoRequest] 
    ...
    reposUpdateWebhookConfigForRepo(owner, repo, hookId, opts, callback) {
      opts = opts || {};
      let postBody = opts['reposUpdateWebhookConfigForRepoRequest'];
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
    ...
    reposUploadReleaseAsset(owner, repo, releaseId, name, opts, callback) {
      ...
      let accepts = ['application/json'];
      let returnType = ReleaseAsset;
      let basePaths = ['https://uploads.github.com'];
