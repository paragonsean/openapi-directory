...
class BranchProtection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('block_creations')) {
                obj['block_creations'] = BranchProtectionAllowDeletions.constructFromObject(data['block_creations']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['block_creations']) { // data not null
          BranchProtectionAllowDeletions.validateJSON(data['block_creations']);
        }
...
/**
 * @member {module:model/BranchProtectionAllowDeletions} block_creations
 */
