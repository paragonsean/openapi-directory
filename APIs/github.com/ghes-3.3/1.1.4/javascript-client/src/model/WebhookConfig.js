...
class WebhookConfig {
    ...
    /**
     * Validates the JSON data with respect to <code>WebhookConfig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WebhookConfig</code>.
     */
 ...
 */
WebhookConfig.prototype['content_type'] = undefined;

/**
 * @member {module:model/WebhookConfigInsecureSsl} insecure_ssl
 */
WebhookConfig.prototype['insecure_ssl'] = undefined;
