...
class PullsCreateReviewCommentRequest {
     ...
     * @param line {Number} The line of the blob in the pull request diff that the comment applies to. For a multi-line comment, the last line of the range that your comment applies to.
