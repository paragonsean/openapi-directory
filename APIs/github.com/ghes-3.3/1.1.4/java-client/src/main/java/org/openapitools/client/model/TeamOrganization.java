...
public class TeamOrganization {
  ...
  public TeamOrganization collaborators(Integer collaborators) {
  ...
  public TeamOrganization diskUsage(Integer diskUsage) {
  ...
  public TeamOrganization followers(Integer followers) {
  ...
  public TeamOrganization following(Integer following) {
  ...
  public TeamOrganization id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public TeamOrganization ownedPrivateRepos(Integer ownedPrivateRepos) {
  ...
  public TeamOrganization privateGists(Integer privateGists) {
  ...
  public TeamOrganization publicGists(Integer publicGists) {
  ...
  public TeamOrganization publicRepos(Integer publicRepos) {
  ...
  public TeamOrganization totalPrivateRepos(Integer totalPrivateRepos) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avatarUrl, teamOrganization.avatarUrl) &&
        ...
        Objects.equals(this.login, teamOrganization.login) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamOrganization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamOrganization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamOrganization is not found in the empty JSON string", TeamOrganization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamOrganization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamOrganization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TeamOrganization.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamOrganization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamOrganization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamOrganization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamOrganization.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamOrganization>() {
           @Override
           public void write(JsonWriter out, TeamOrganization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TeamOrganization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TeamOrganization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TeamOrganization
   * @throws IOException if the JSON string is invalid with respect to TeamOrganization
   */
  public static TeamOrganization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamOrganization.class);
  }

  /**
   * Convert an instance of TeamOrganization to an JSON string
   *
   * @return JSON string
   */
