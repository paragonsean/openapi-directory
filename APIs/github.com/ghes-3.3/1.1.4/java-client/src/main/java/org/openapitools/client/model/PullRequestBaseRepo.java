...
public class PullRequestBaseRepo {
  ...
  public PullRequestBaseRepo allowForking(Boolean allowForking) {
  ...
  public PullRequestBaseRepo allowMergeCommit(Boolean allowMergeCommit) {
  ...
  public PullRequestBaseRepo allowRebaseMerge(Boolean allowRebaseMerge) {
  ...
  public PullRequestBaseRepo allowSquashMerge(Boolean allowSquashMerge) {
  ...
  public PullRequestBaseRepo archiveUrl(String archiveUrl) {
  ...
  public PullRequestBaseRepo archived(Boolean archived) {
  ...
  public PullRequestBaseRepo assigneesUrl(String assigneesUrl) {
  ...
  public PullRequestBaseRepo blobsUrl(String blobsUrl) {
  ...
  public PullRequestBaseRepo branchesUrl(String branchesUrl) {
  ...
  public PullRequestBaseRepo cloneUrl(String cloneUrl) {
  ...
  public PullRequestBaseRepo collaboratorsUrl(String collaboratorsUrl) {
  ...
  public PullRequestBaseRepo commentsUrl(String commentsUrl) {
  ...
  public PullRequestBaseRepo commitsUrl(String commitsUrl) {
  ...
  public PullRequestBaseRepo compareUrl(String compareUrl) {
  ...
  public PullRequestBaseRepo contentsUrl(String contentsUrl) {
  ...
  public PullRequestBaseRepo contributorsUrl(URI contributorsUrl) {
  ...
  public PullRequestBaseRepo createdAt(OffsetDateTime createdAt) {
  ...
  public PullRequestBaseRepo defaultBranch(String defaultBranch) {
  ...
  public PullRequestBaseRepo deploymentsUrl(URI deploymentsUrl) {
  ...
  public PullRequestBaseRepo description(String description) {
  ...
  public PullRequestBaseRepo disabled(Boolean disabled) {
  ...
  public PullRequestBaseRepo downloadsUrl(URI downloadsUrl) {
  ...
  public PullRequestBaseRepo eventsUrl(URI eventsUrl) {
  ...
  public PullRequestBaseRepo fork(Boolean fork) {
    this.fork = fork;
    return this;
  }
  ...
  public PullRequestBaseRepo forks(Integer forks) {
    this.forks = forks;
    return this;
  }
  ...
  public PullRequestBaseRepo forksCount(Integer forksCount) {
  ...
  public PullRequestBaseRepo forksUrl(URI forksUrl) {
  ...
  public PullRequestBaseRepo fullName(String fullName) {
  ...
  public PullRequestBaseRepo gitCommitsUrl(String gitCommitsUrl) {
  ...
  public PullRequestBaseRepo gitRefsUrl(String gitRefsUrl) {
  ...
  public PullRequestBaseRepo gitTagsUrl(String gitTagsUrl) {
  ...
  public PullRequestBaseRepo gitUrl(String gitUrl) {
    this.gitUrl = gitUrl;
    return this;
  }
  ...
  public PullRequestBaseRepo hasDiscussions(Boolean hasDiscussions) {
  ...
  public PullRequestBaseRepo hasDownloads(Boolean hasDownloads) {
  ...
  public PullRequestBaseRepo hasIssues(Boolean hasIssues) {
  ...
  public PullRequestBaseRepo hasPages(Boolean hasPages) {
  ...
  public PullRequestBaseRepo hasProjects(Boolean hasProjects) {
  ...
  public PullRequestBaseRepo hasWiki(Boolean hasWiki) {
  ...
  public PullRequestBaseRepo homepage(URI homepage) {
  ...
  public PullRequestBaseRepo hooksUrl(URI hooksUrl) {
  ...
  public PullRequestBaseRepo htmlUrl(URI htmlUrl) {
  ...
  public PullRequestBaseRepo id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PullRequestBaseRepo isTemplate(Boolean isTemplate) {
  ...
  public PullRequestBaseRepo issueCommentUrl(String issueCommentUrl) {
  ...
  public PullRequestBaseRepo issueEventsUrl(String issueEventsUrl) {
  ...
  public PullRequestBaseRepo issuesUrl(String issuesUrl) {
  ...
  public PullRequestBaseRepo keysUrl(String keysUrl) {
  ...
  public PullRequestBaseRepo labelsUrl(String labelsUrl) {
  ...
  public PullRequestBaseRepo language(String language) {
  ...
  public PullRequestBaseRepo languagesUrl(URI languagesUrl) {
  ...
  public PullRequestBaseRepo license(NullableLicenseSimple license) {
  ...
  public PullRequestBaseRepo masterBranch(String masterBranch) {
  ...
  public PullRequestBaseRepo mergesUrl(URI mergesUrl) {
  ...
  public PullRequestBaseRepo milestonesUrl(String milestonesUrl) {
  ...
  public PullRequestBaseRepo mirrorUrl(URI mirrorUrl) {
  ...
  public PullRequestBaseRepo name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PullRequestBaseRepo nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public PullRequestBaseRepo notificationsUrl(String notificationsUrl) {
  ...
  public PullRequestBaseRepo openIssues(Integer openIssues) {
  ...
  public PullRequestBaseRepo openIssuesCount(Integer openIssuesCount) {
  ...
  public PullRequestBaseRepo owner(PullRequestBaseRepoOwner owner) {
    this.owner = owner;
    return this;
  }
  ...
  public PullRequestBaseRepo permissions(CollaboratorPermissions permissions) {
  ...
  public PullRequestBaseRepo _private(Boolean _private) {
  ...
  public PullRequestBaseRepo pullsUrl(String pullsUrl) {
  ...
  public PullRequestBaseRepo pushedAt(OffsetDateTime pushedAt) {
  ...
  public PullRequestBaseRepo releasesUrl(String releasesUrl) {
  ...
  public PullRequestBaseRepo size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PullRequestBaseRepo sshUrl(String sshUrl) {
    this.sshUrl = sshUrl;
    return this;
  }
  ...
  public PullRequestBaseRepo stargazersCount(Integer stargazersCount) {
  ...
  public PullRequestBaseRepo stargazersUrl(URI stargazersUrl) {
  ...
  public PullRequestBaseRepo statusesUrl(String statusesUrl) {
  ...
  public PullRequestBaseRepo subscribersUrl(URI subscribersUrl) {
  ...
  public PullRequestBaseRepo subscriptionUrl(URI subscriptionUrl) {
  ...
  public PullRequestBaseRepo svnUrl(URI svnUrl) {
    this.svnUrl = svnUrl;
    return this;
  }
  ...
  public PullRequestBaseRepo tagsUrl(URI tagsUrl) {
  ...
  public PullRequestBaseRepo teamsUrl(URI teamsUrl) {
  ...
  public PullRequestBaseRepo tempCloneToken(String tempCloneToken) {
  ...
  public PullRequestBaseRepo topics(List<String> topics) {
    this.topics = topics;
    return this;
  }

  public PullRequestBaseRepo addTopicsItem(String topicsItem) {
    if (this.topics == null) {
  ...
  public PullRequestBaseRepo treesUrl(String treesUrl) {
  ...
  public PullRequestBaseRepo updatedAt(OffsetDateTime updatedAt) {
  ...
  public PullRequestBaseRepo url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public PullRequestBaseRepo visibility(String visibility) {
  ...
  public PullRequestBaseRepo watchers(Integer watchers) {
  ...
  public PullRequestBaseRepo watchersCount(Integer watchersCount) {
  ...
  public boolean equals(Object o) {
    ...
    PullRequestBaseRepo pullRequestBaseRepo = (PullRequestBaseRepo) o;
    return Objects.equals(this.allowForking, pullRequestBaseRepo.allowForking) &&
        Objects.equals(this.allowMergeCommit, pullRequestBaseRepo.allowMergeCommit) &&
        Objects.equals(this.allowRebaseMerge, pullRequestBaseRepo.allowRebaseMerge) &&
        Objects.equals(this.allowSquashMerge, pullRequestBaseRepo.allowSquashMerge) &&
        Objects.equals(this.archiveUrl, pullRequestBaseRepo.archiveUrl) &&
        Objects.equals(this.archived, pullRequestBaseRepo.archived) &&
        Objects.equals(this.assigneesUrl, pullRequestBaseRepo.assigneesUrl) &&
        Objects.equals(this.blobsUrl, pullRequestBaseRepo.blobsUrl) &&
        Objects.equals(this.branchesUrl, pullRequestBaseRepo.branchesUrl) &&
        Objects.equals(this.cloneUrl, pullRequestBaseRepo.cloneUrl) &&
        Objects.equals(this.collaboratorsUrl, pullRequestBaseRepo.collaboratorsUrl) &&
        Objects.equals(this.commentsUrl, pullRequestBaseRepo.commentsUrl) &&
        Objects.equals(this.commitsUrl, pullRequestBaseRepo.commitsUrl) &&
        Objects.equals(this.compareUrl, pullRequestBaseRepo.compareUrl) &&
        Objects.equals(this.contentsUrl, pullRequestBaseRepo.contentsUrl) &&
        Objects.equals(this.contributorsUrl, pullRequestBaseRepo.contributorsUrl) &&
        Objects.equals(this.createdAt, pullRequestBaseRepo.createdAt) &&
        Objects.equals(this.defaultBranch, pullRequestBaseRepo.defaultBranch) &&
        Objects.equals(this.deploymentsUrl, pullRequestBaseRepo.deploymentsUrl) &&
        Objects.equals(this.description, pullRequestBaseRepo.description) &&
        Objects.equals(this.disabled, pullRequestBaseRepo.disabled) &&
        Objects.equals(this.downloadsUrl, pullRequestBaseRepo.downloadsUrl) &&
        Objects.equals(this.eventsUrl, pullRequestBaseRepo.eventsUrl) &&
        Objects.equals(this.fork, pullRequestBaseRepo.fork) &&
        Objects.equals(this.forks, pullRequestBaseRepo.forks) &&
        Objects.equals(this.forksCount, pullRequestBaseRepo.forksCount) &&
        Objects.equals(this.forksUrl, pullRequestBaseRepo.forksUrl) &&
        Objects.equals(this.fullName, pullRequestBaseRepo.fullName) &&
        Objects.equals(this.gitCommitsUrl, pullRequestBaseRepo.gitCommitsUrl) &&
        Objects.equals(this.gitRefsUrl, pullRequestBaseRepo.gitRefsUrl) &&
        Objects.equals(this.gitTagsUrl, pullRequestBaseRepo.gitTagsUrl) &&
        Objects.equals(this.gitUrl, pullRequestBaseRepo.gitUrl) &&
        Objects.equals(this.hasDiscussions, pullRequestBaseRepo.hasDiscussions) &&
        Objects.equals(this.hasDownloads, pullRequestBaseRepo.hasDownloads) &&
        Objects.equals(this.hasIssues, pullRequestBaseRepo.hasIssues) &&
        Objects.equals(this.hasPages, pullRequestBaseRepo.hasPages) &&
        Objects.equals(this.hasProjects, pullRequestBaseRepo.hasProjects) &&
        Objects.equals(this.hasWiki, pullRequestBaseRepo.hasWiki) &&
        Objects.equals(this.homepage, pullRequestBaseRepo.homepage) &&
        Objects.equals(this.hooksUrl, pullRequestBaseRepo.hooksUrl) &&
        Objects.equals(this.htmlUrl, pullRequestBaseRepo.htmlUrl) &&
        Objects.equals(this.id, pullRequestBaseRepo.id) &&
        Objects.equals(this.isTemplate, pullRequestBaseRepo.isTemplate) &&
        Objects.equals(this.issueCommentUrl, pullRequestBaseRepo.issueCommentUrl) &&
        Objects.equals(this.issueEventsUrl, pullRequestBaseRepo.issueEventsUrl) &&
        Objects.equals(this.issuesUrl, pullRequestBaseRepo.issuesUrl) &&
        Objects.equals(this.keysUrl, pullRequestBaseRepo.keysUrl) &&
        Objects.equals(this.labelsUrl, pullRequestBaseRepo.labelsUrl) &&
        Objects.equals(this.language, pullRequestBaseRepo.language) &&
        Objects.equals(this.languagesUrl, pullRequestBaseRepo.languagesUrl) &&
        Objects.equals(this.license, pullRequestBaseRepo.license) &&
        Objects.equals(this.masterBranch, pullRequestBaseRepo.masterBranch) &&
        Objects.equals(this.mergesUrl, pullRequestBaseRepo.mergesUrl) &&
        Objects.equals(this.milestonesUrl, pullRequestBaseRepo.milestonesUrl) &&
        Objects.equals(this.mirrorUrl, pullRequestBaseRepo.mirrorUrl) &&
        Objects.equals(this.name, pullRequestBaseRepo.name) &&
        Objects.equals(this.nodeId, pullRequestBaseRepo.nodeId) &&
        Objects.equals(this.notificationsUrl, pullRequestBaseRepo.notificationsUrl) &&
        Objects.equals(this.openIssues, pullRequestBaseRepo.openIssues) &&
        Objects.equals(this.openIssuesCount, pullRequestBaseRepo.openIssuesCount) &&
        Objects.equals(this.owner, pullRequestBaseRepo.owner) &&
        Objects.equals(this.permissions, pullRequestBaseRepo.permissions) &&
        Objects.equals(this._private, pullRequestBaseRepo._private) &&
        Objects.equals(this.pullsUrl, pullRequestBaseRepo.pullsUrl) &&
        Objects.equals(this.pushedAt, pullRequestBaseRepo.pushedAt) &&
        Objects.equals(this.releasesUrl, pullRequestBaseRepo.releasesUrl) &&
        Objects.equals(this.size, pullRequestBaseRepo.size) &&
        Objects.equals(this.sshUrl, pullRequestBaseRepo.sshUrl) &&
        Objects.equals(this.stargazersCount, pullRequestBaseRepo.stargazersCount) &&
        Objects.equals(this.stargazersUrl, pullRequestBaseRepo.stargazersUrl) &&
        Objects.equals(this.statusesUrl, pullRequestBaseRepo.statusesUrl) &&
        Objects.equals(this.subscribersUrl, pullRequestBaseRepo.subscribersUrl) &&
        Objects.equals(this.subscriptionUrl, pullRequestBaseRepo.subscriptionUrl) &&
        Objects.equals(this.svnUrl, pullRequestBaseRepo.svnUrl) &&
        Objects.equals(this.tagsUrl, pullRequestBaseRepo.tagsUrl) &&
        Objects.equals(this.teamsUrl, pullRequestBaseRepo.teamsUrl) &&
        Objects.equals(this.tempCloneToken, pullRequestBaseRepo.tempCloneToken) &&
        Objects.equals(this.topics, pullRequestBaseRepo.topics) &&
        Objects.equals(this.treesUrl, pullRequestBaseRepo.treesUrl) &&
        Objects.equals(this.updatedAt, pullRequestBaseRepo.updatedAt) &&
        Objects.equals(this.url, pullRequestBaseRepo.url) &&
        Objects.equals(this.visibility, pullRequestBaseRepo.visibility) &&
        Objects.equals(this.watchers, pullRequestBaseRepo.watchers) &&
        Objects.equals(this.watchersCount, pullRequestBaseRepo.watchersCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowForking, allowMergeCommit, allowRebaseMerge, allowSquashMerge, archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl, contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description, disabled, downloadsUrl, eventsUrl, fork, forks, forksCount, forksUrl, fullName, gitCommitsUrl, gitRefsUrl, gitTagsUrl, gitUrl, hasDiscussions, hasDownloads, hasIssues, hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id, isTemplate, issueCommentUrl, issueEventsUrl, issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, masterBranch, mergesUrl, milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues, openIssuesCount, owner, permissions, _private, pullsUrl, pushedAt, releasesUrl, size, sshUrl, stargazersCount, stargazersUrl, statusesUrl, subscribersUrl, subscriptionUrl, svnUrl, tagsUrl, teamsUrl, tempCloneToken, topics, treesUrl, updatedAt, url, visibility, watchers, watchersCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PullRequestBaseRepo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullRequestBaseRepo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullRequestBaseRepo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullRequestBaseRepo is not found in the empty JSON string", PullRequestBaseRepo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestBaseRepo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestBaseRepo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullRequestBaseRepo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullRequestBaseRepo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullRequestBaseRepo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullRequestBaseRepo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullRequestBaseRepo.class));

       return (TypeAdapter<T>) new TypeAdapter<PullRequestBaseRepo>() {
           @Override
           public void write(JsonWriter out, PullRequestBaseRepo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullRequestBaseRepo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullRequestBaseRepo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullRequestBaseRepo
   * @throws IOException if the JSON string is invalid with respect to PullRequestBaseRepo
   */
  public static PullRequestBaseRepo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullRequestBaseRepo.class);
  }

  /**
   * Convert an instance of PullRequestBaseRepo to an JSON string
   *
   * @return JSON string
   */
