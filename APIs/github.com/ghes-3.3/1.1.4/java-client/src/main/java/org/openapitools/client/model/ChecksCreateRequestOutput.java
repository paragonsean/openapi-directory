...
public class ChecksCreateRequestOutput {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.annotations, checksCreateRequestOutput.annotations) &&
        ...
        Objects.equals(this.title, checksCreateRequestOutput.title);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChecksCreateRequestOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChecksCreateRequestOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChecksCreateRequestOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChecksCreateRequestOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
