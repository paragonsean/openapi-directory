...
public class SecretScanningLocation {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.details, secretScanningLocation.details) &&
        Objects.equals(this.type, secretScanningLocation.type);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecretScanningLocation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecretScanningLocation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SecretScanningLocation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SecretScanningLocation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      SecretScanningLocationDetails.validateJsonElement(jsonObj.get("details"));
