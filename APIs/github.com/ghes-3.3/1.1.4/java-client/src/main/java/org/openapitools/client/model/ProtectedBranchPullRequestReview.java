...
public class ProtectedBranchPullRequestReview {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dismissStaleReviews, protectedBranchPullRequestReview.dismissStaleReviews) &&
        ...
        Objects.equals(this.url, protectedBranchPullRequestReview.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProtectedBranchPullRequestReview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProtectedBranchPullRequestReview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProtectedBranchPullRequestReview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProtectedBranchPullRequestReview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("dismissal_restrictions") != null && !jsonObj.get("dismissal_restrictions").isJsonNull()) {
        ProtectedBranchPullRequestReviewDismissalRestrictions.validateJsonElement(jsonObj.get("dismissal_restrictions"));
      }
