...
public class ReposUpdateWebhookConfigForRepoRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentType, reposUpdateWebhookConfigForRepoRequest.contentType) &&
        ...
        Objects.equals(this.url, reposUpdateWebhookConfigForRepoRequest.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReposUpdateWebhookConfigForRepoRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReposUpdateWebhookConfigForRepoRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReposUpdateWebhookConfigForRepoRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReposUpdateWebhookConfigForRepoRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
