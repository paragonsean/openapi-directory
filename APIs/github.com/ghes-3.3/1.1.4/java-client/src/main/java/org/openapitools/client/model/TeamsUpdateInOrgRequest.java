...
public class TeamsUpdateInOrgRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, teamsUpdateInOrgRequest.description) &&
        Objects.equals(this.name, teamsUpdateInOrgRequest.name) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to TeamsUpdateInOrgRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TeamsUpdateInOrgRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamsUpdateInOrgRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamsUpdateInOrgRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
