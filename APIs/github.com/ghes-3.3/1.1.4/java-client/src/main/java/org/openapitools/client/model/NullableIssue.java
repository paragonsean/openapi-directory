...
public class NullableIssue {
  ...
  public NullableIssue assignee(NullableSimpleUser assignee) {
  ...
  public NullableIssue assignees(List<SimpleUser> assignees) {
  ...
  public NullableIssue comments(Integer comments) {
  ...
  public NullableIssue id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public NullableIssue number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activeLockReason, nullableIssue.activeLockReason) &&
        Objects.equals(this.assignee, nullableIssue.assignee) &&
        ...
        Objects.equals(this.id, nullableIssue.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to NullableIssue
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NullableIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NullableIssue is not found in the empty JSON string", NullableIssue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NullableIssue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NullableIssue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NullableIssue.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NullableIssue.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NullableIssue' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NullableIssue> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NullableIssue.class));

       return (TypeAdapter<T>) new TypeAdapter<NullableIssue>() {
           @Override
           public void write(JsonWriter out, NullableIssue value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NullableIssue read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NullableIssue given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NullableIssue
   * @throws IOException if the JSON string is invalid with respect to NullableIssue
   */
  public static NullableIssue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NullableIssue.class);
  }

  /**
   * Convert an instance of NullableIssue to an JSON string
   *
   * @return JSON string
   */
