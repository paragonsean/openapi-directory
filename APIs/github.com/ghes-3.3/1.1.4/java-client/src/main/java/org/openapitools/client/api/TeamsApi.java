...
public class TeamsApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-team-member-legacy">Add team member (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * The \&quot;Add team member\&quot; endpoint (described below) is deprecated.  We recommend using the [Add or update team membership for a user](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-membership-for-a-user) endpoint instead. It allows you to invite new organization members to your teams.  Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub&#39;s products](https://docs.github.com/enterprise-server@3.3/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.  To add someone to a team, the authenticated user must be an organization owner or a team maintainer in the team they&#39;re changing. The person being added to the team must be a member of the team&#39;s organization.  **Note:** When you have team synchronization set up for a team with your organization&#39;s identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team&#39;s membership. If you have access to manage group membership in your IdP, you can manage GitHub Enterprise Server team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see \&quot;[Synchronizing teams between your identity provider and GitHub Enterprise Server](https://docs.github.com/enterprise-server@3.3/articles/synchronizing-teams-between-your-identity-provider-and-github/).\&quot;  Note that you&#39;ll need to set &#x60;Content-Length&#x60; to zero when calling out to this endpoint. For more information, see \&quot;[HTTP verbs](https://docs.github.com/enterprise-server@3.3/rest/overview/resources-in-the-rest-api#http-verbs).\&quot;
     * @param teamId The unique identifier of the team. (required)
     * @param username The handle for the GitHub user account. (required)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-membership-for-a-user">Add or update team membership for a user Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-membership-for-a-user-legacy">Add or update team membership for a user (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [Add or update team membership for a user](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-membership-for-a-user) endpoint.  Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub&#39;s products](https://docs.github.com/enterprise-server@3.3/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.  If the user is already a member of the team&#39;s organization, this endpoint will add the user to the team. To add a membership between an organization member and a team, the authenticated user must be an organization owner or a team maintainer.  **Note:** When you have team synchronization set up for a team with your organization&#39;s identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team&#39;s membership. If you have access to manage group membership in your IdP, you can manage GitHub Enterprise Server team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see \&quot;[Synchronizing teams between your identity provider and GitHub Enterprise Server](https://docs.github.com/enterprise-server@3.3/articles/synchronizing-teams-between-your-identity-provider-and-github/).\&quot;  If the user is unaffiliated with the team&#39;s organization, this endpoint will send an invitation to the user via email. This newly-created membership will be in the \&quot;pending\&quot; state until the user accepts the invitation, at which point the membership will transition to the \&quot;active\&quot; state and the user will be added as a member of the team. To add a membership between an unaffiliated user and a team, the authenticated user must be an organization owner.  If the user is already a member of the team, this endpoint will update the role of the team member&#39;s role. To update the membership of a team member, the authenticated user must be an organization owner or a team maintainer.
     * @param teamId The unique identifier of the team. (required)
     * @param username The handle for the GitHub user account. (required)
     * @param teamsAddOrUpdateMembershipForUserInOrgRequest  (optional)
     * @return TeamMembership
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-project-permissions">Add or update team project permissions Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#add-or-update-team-project-permissions-legacy">Add or update team project permissions (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#add-or-update-team-repository-permissions">Add or update team repository permissions Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-repository-permissions-legacy">Add or update team repository permissions (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new \&quot;[Add or update team repository permissions](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#add-or-update-team-repository-permissions)\&quot; endpoint.  To add a repository to a team or update the team&#39;s permission on a repository, the authenticated user must have admin access to the repository, and must be able to see the team. The repository must be owned by the organization, or a direct fork of a repository owned by the organization. You will get a &#x60;422 Unprocessable Entity&#x60; status if you attempt to add a repository to a team that is not owned by the organization.  Note that, if you choose not to pass any parameters, you&#39;ll need to set &#x60;Content-Length&#x60; to zero when calling out to this endpoint. For more information, see \&quot;[HTTP verbs](https://docs.github.com/enterprise-server@3.3/rest/overview/resources-in-the-rest-api#http-verbs).\&quot;
     * @param teamId The unique identifier of the team. (required)
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param teamsAddOrUpdateRepoPermissionsLegacyRequest  (optional)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#check-team-permissions-for-a-project">Check team permissions for a project Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#check-team-permissions-for-a-project-legacy">Check team permissions for a project (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [Check team permissions for a project](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#check-team-permissions-for-a-project) endpoint.  Checks whether a team has &#x60;read&#x60;, &#x60;write&#x60;, or &#x60;admin&#x60; permissions for an organization project. The response includes projects inherited from a parent team.
     * @param teamId The unique identifier of the team. (required)
     * @param projectId The unique identifier of the project. (required)
     * @return TeamProject
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#check-team-permissions-for-a-repository">Check team permissions for a repository Documentation</a>
     */
     ...
     * Checks whether a team has &#x60;admin&#x60;, &#x60;push&#x60;, &#x60;maintain&#x60;, &#x60;triage&#x60;, or &#x60;pull&#x60; permission for a repository. Repositories inherited through a parent team will also be checked.  You can also get information about the specified repository, including what permissions the team grants on it, by passing the following custom [media type](https://docs.github.com/enterprise-server@3.3/rest/overview/media-types/) via the &#x60;application/vnd.github.v3.repository+json&#x60; accept header.  If a team doesn&#39;t have permission for the repository, you will receive a &#x60;404 Not Found&#x60; response status.  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;GET /organizations/{org_id}/team/{team_id}/repos/{owner}/{repo}&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#check-team-permissions-for-a-repository-legacy">Check team permissions for a repository (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#create-a-team">Create a team Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#create-a-discussion-comment">Create a discussion comment Documentation</a>
     */
     ...
     * Creates a new comment on a team discussion. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  This endpoint triggers [notifications](https://docs.github.com/enterprise-server@3.3/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \&quot;[Secondary rate limits](https://docs.github.com/enterprise-server@3.3/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\&quot; and \&quot;[Dealing with secondary rate limits](https://docs.github.com/enterprise-server@3.3/rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)\&quot; for details.  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;POST /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}/comments&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param teamsCreateDiscussionCommentInOrgRequest  (required)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#create-a-discussion-comment-legacy">Create a discussion comment (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#create-a-discussion">Create a discussion Documentation</a>
     */
    ...
    /**
     * Create a discussion
     * Creates a new discussion post on a team&#39;s page. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  This endpoint triggers [notifications](https://docs.github.com/enterprise-server@3.3/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See \&quot;[Secondary rate limits](https://docs.github.com/enterprise-server@3.3/rest/overview/resources-in-the-rest-api#secondary-rate-limits)\&quot; and \&quot;[Dealing with secondary rate limits](https://docs.github.com/enterprise-server@3.3/rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)\&quot; for details.  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;POST /organizations/{org_id}/team/{team_id}/discussions&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param teamsCreateDiscussionInOrgRequest  (required)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#create-a-discussion-legacy">Create a discussion (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#delete-a-discussion-comment">Delete a discussion comment Documentation</a>
     */
     ...
     * Deletes a comment on a team discussion. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;DELETE /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}/comments/{comment_number}&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param commentNumber The number that identifies the comment. (required)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#delete-a-discussion-comment-legacy">Delete a discussion comment (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#delete-a-discussion">Delete a discussion Documentation</a>
     */
    ...
    /**
     * Delete a discussion
     * Delete a discussion from a team&#39;s page. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;DELETE /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#delete-a-discussion-legacy">Delete a discussion (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#delete-a-team">Delete a team Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#delete-a-team-legacy">Delete a team (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-team-by-name">Get a team by name Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-discussion-comment">Get a discussion comment Documentation</a>
     */
     ...
     * Get a specific comment on a team discussion. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;GET /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}/comments/{comment_number}&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param commentNumber The number that identifies the comment. (required)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-discussion-comment-legacy">Get a discussion comment (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [Get a discussion comment](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-discussion-comment) endpoint.  Get a specific comment on a team discussion. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     * @param teamId The unique identifier of the team. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param commentNumber The number that identifies the comment. (required)
     * @return TeamDiscussionComment
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-discussion">Get a discussion Documentation</a>
     */
    ...
    /**
     * Get a discussion
     * Get a specific discussion on a team&#39;s page. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;GET /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @return TeamDiscussion
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-a-discussion-legacy">Get a discussion (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#get-a-team-legacy">Get a team (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-team-member-legacy">Get team member (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * The \&quot;Get team member\&quot; endpoint (described below) is deprecated.  We recommend using the [Get team membership for a user](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-team-membership-for-a-user) endpoint instead. It allows you to get both active and pending memberships.  To list members in a team, the team must be visible to the authenticated user.
     * @param teamId The unique identifier of the team. (required)
     * @param username The handle for the GitHub user account. (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-team-membership-for-a-user">Get team membership for a user Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#get-team-membership-for-a-user-legacy">Get team membership for a user (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-teams">List teams Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-child-teams">List child teams Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#list-child-teams-legacy">List child teams (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-discussion-comments">List discussion comments Documentation</a>
     */
     ...
     * List all comments on a team discussion. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;GET /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}/comments&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param direction The direction to sort the results by. (optional, default to desc)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-discussion-comments-legacy">List discussion comments (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [List discussion comments](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-discussion-comments) endpoint.  List all comments on a team discussion. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     * @param teamId The unique identifier of the team. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param direction The direction to sort the results by. (optional, default to desc)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-discussions">List discussions Documentation</a>
     */
    ...
    /**
     * List discussions
     * List all discussions on a team&#39;s page. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;GET /organizations/{org_id}/team/{team_id}/discussions&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param direction The direction to sort the results by. (optional, default to desc)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-discussions-legacy">List discussions (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [&#x60;List discussions&#x60;](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-discussions) endpoint.  List all discussions on a team&#39;s page. OAuth access tokens require the &#x60;read:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     * @param teamId The unique identifier of the team. (required)
     * @param direction The direction to sort the results by. (optional, default to desc)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-teams-for-the-authenticated-user">List teams for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-team-members">List team members Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-team-members-legacy">List team members (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-team-projects">List team projects Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#list-team-projects-legacy">List team projects (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#list-team-repositories">List team repositories Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#list-team-repositories-legacy">List team repositories (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#remove-team-member-legacy">Remove team member (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * The \&quot;Remove team member\&quot; endpoint (described below) is deprecated.  We recommend using the [Remove team membership for a user](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#remove-team-membership-for-a-user) endpoint instead. It allows you to remove both active and pending memberships.  Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub&#39;s products](https://docs.github.com/enterprise-server@3.3/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.  To remove a team member, the authenticated user must have &#39;admin&#39; permissions to the team or be an owner of the org that the team is associated with. Removing a team member does not delete the user, it just removes them from the team.  **Note:** When you have team synchronization set up for a team with your organization&#39;s identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team&#39;s membership. If you have access to manage group membership in your IdP, you can manage GitHub Enterprise Server team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see \&quot;[Synchronizing teams between your identity provider and GitHub Enterprise Server](https://docs.github.com/enterprise-server@3.3/articles/synchronizing-teams-between-your-identity-provider-and-github/).\&quot;
     * @param teamId The unique identifier of the team. (required)
     * @param username The handle for the GitHub user account. (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#remove-team-membership-for-a-user">Remove team membership for a user Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#remove-team-membership-for-a-user-legacy">Remove team membership for a user (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [Remove team membership for a user](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#remove-team-membership-for-a-user) endpoint.  Team synchronization is available for organizations using GitHub Enterprise Cloud. For more information, see [GitHub&#39;s products](https://docs.github.com/enterprise-server@3.3/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.  To remove a membership between a user and a team, the authenticated user must have &#39;admin&#39; permissions to the team or be an owner of the organization that the team is associated with. Removing team membership does not delete the user, it just removes their membership from the team.  **Note:** When you have team synchronization set up for a team with your organization&#39;s identity provider (IdP), you will see an error if you attempt to use the API for making changes to the team&#39;s membership. If you have access to manage group membership in your IdP, you can manage GitHub Enterprise Server team membership through your identity provider, which automatically adds and removes team members in an organization. For more information, see \&quot;[Synchronizing teams between your identity provider and GitHub Enterprise Server](https://docs.github.com/enterprise-server@3.3/articles/synchronizing-teams-between-your-identity-provider-and-github/).\&quot;
     * @param teamId The unique identifier of the team. (required)
     * @param username The handle for the GitHub user account. (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#remove-a-project-from-a-team">Remove a project from a team Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#remove-a-project-from-a-team-legacy">Remove a project from a team (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#remove-a-repository-from-a-team">Remove a repository from a team Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#remove-a-repository-from-a-team-legacy">Remove a repository from a team (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#update-a-discussion-comment">Update a discussion comment Documentation</a>
     */
     ...
     * Edits the body text of a discussion comment. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).  **Note:** You can also specify a team by &#x60;org_id&#x60; and &#x60;team_id&#x60; using the route &#x60;PATCH /organizations/{org_id}/team/{team_id}/discussions/{discussion_number}/comments/{comment_number}&#x60;.
     * @param org The organization name. The name is not case sensitive. (required)
     * @param teamSlug The slug of the team name. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param commentNumber The number that identifies the comment. (required)
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#update-a-discussion-comment-legacy">Update a discussion comment (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#update-a-discussion">Update a discussion Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#update-a-discussion-legacy">Update a discussion (Legacy) Documentation</a>
     */
    @Deprecated
     ...
     * **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [Update a discussion](https://docs.github.com/enterprise-server@3.3/rest/reference/teams#update-a-discussion) endpoint.  Edits the title and body text of a discussion post. Only the parameters you provide are updated. OAuth access tokens require the &#x60;write:discussion&#x60; [scope](https://docs.github.com/enterprise-server@3.3/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
     * @param teamId The unique identifier of the team. (required)
     * @param discussionNumber The number that identifies the discussion. (required)
     * @param teamsUpdateDiscussionInOrgRequest  (optional)
     * @return TeamDiscussion
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Response when the updated information already exists </td><td>  -  </td></tr>
        <tr><td> 201 </td><td> Response </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resource not found </td><td>  -  </td></tr>
        <tr><td> 422 </td><td> Validation failed, or the endpoint has been spammed. </td><td>  -  </td></tr>
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams#update-a-team">Update a team Documentation</a>
     */
     ...
     * @deprecated
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/teams/#update-a-team-legacy">Update a team (Legacy) Documentation</a>
     */
    @Deprecated
