...
public class ActivityApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#check-if-a-repository-is-starred-by-the-authenticated-user">Check if a repository is starred by the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#delete-a-repository-subscription">Delete a repository subscription Documentation</a>
     */
     ...
     * @param threadId The unique identifier of the notification thread. This corresponds to the value returned in the &#x60;id&#x60; field when you retrieve notifications (for example with the [&#x60;GET /notifications&#x60; operation](https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-notifications-for-the-authenticated-user)). (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#delete-a-thread-subscription">Delete a thread subscription Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#get-feeds">Get feeds Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#get-a-repository-subscription">Get a repository subscription Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#get-a-thread">Get a thread Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#get-a-thread-subscription-for-the-authenticated-user">Get a thread subscription for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-events-for-the-authenticated-user">List events for the authenticated user Documentation</a>
     */
     ...
     * @param page Page number of the results to fetch. (optional, default to 1)
     * @param perPage The number of results per page (max 50). (optional, default to 50)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-notifications-for-the-authenticated-user">List notifications for the authenticated user Documentation</a>
     */
    public okhttp3.Call activityListNotificationsForAuthenticatedUserCall(Boolean all, Boolean participating, OffsetDateTime since, OffsetDateTime before, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call activityListNotificationsForAuthenticatedUserValidateBeforeCall(Boolean all, Boolean participating, OffsetDateTime since, OffsetDateTime before, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        return activityListNotificationsForAuthenticatedUserCall(all, participating, since, before, page, perPage, _callback);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-notifications-for-the-authenticated-user">List notifications for the authenticated user Documentation</a>
     */
    public List<Thread> activityListNotificationsForAuthenticatedUser(Boolean all, Boolean participating, OffsetDateTime since, OffsetDateTime before, Integer page, Integer perPage) throws ApiException {
        ApiResponse<List<Thread>> localVarResp = activityListNotificationsForAuthenticatedUserWithHttpInfo(all, participating, since, before, page, perPage);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-notifications-for-the-authenticated-user">List notifications for the authenticated user Documentation</a>
     */
    public ApiResponse<List<Thread>> activityListNotificationsForAuthenticatedUserWithHttpInfo(Boolean all, Boolean participating, OffsetDateTime since, OffsetDateTime before, Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = activityListNotificationsForAuthenticatedUserValidateBeforeCall(all, participating, since, before, page, perPage, null);
     ...
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-notifications-for-the-authenticated-user">List notifications for the authenticated user Documentation</a>
     */
    public okhttp3.Call activityListNotificationsForAuthenticatedUserAsync(Boolean all, Boolean participating, OffsetDateTime since, OffsetDateTime before, Integer page, Integer perPage, final ApiCallback<List<Thread>> _callback) throws ApiException {

        okhttp3.Call localVarCall = activityListNotificationsForAuthenticatedUserValidateBeforeCall(all, participating, since, before, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<List<Thread>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-organization-events-for-the-authenticated-user">List organization events for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-public-events">List public events Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-public-events-for-a-network-of-repositories">List public events for a network of repositories Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-public-events-for-a-user">List public events for a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-public-organization-events">List public organization events Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-events-received-by-the-authenticated-user">List events received by the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-public-events-received-by-a-user">List public events received by a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-repository-events">List repository events Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-repository-notifications-for-the-authenticated-user">List repository notifications for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-repositories-starred-by-the-authenticated-user">List repositories starred by the authenticated user Documentation</a>
     */
     ...
     * Lists repositories the authenticated user has starred.  You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.3/rest/overview/media-types/) via the &#x60;Accept&#x60; header: &#x60;application/vnd.github.star+json&#x60;.
     * @param sort The property to sort the results by. &#x60;created&#x60; means when the repository was starred. &#x60;updated&#x60; means when the repository was last pushed to. (optional, default to created)
     * @param direction The direction to sort the results by. (optional, default to desc)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-repositories-starred-by-a-user">List repositories starred by a user Documentation</a>
     */
     ...
     * Lists repositories a user has starred.  You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.3/rest/overview/media-types/) via the &#x60;Accept&#x60; header: &#x60;application/vnd.github.star+json&#x60;.
     * @param username The handle for the GitHub user account. (required)
     * @param sort The property to sort the results by. &#x60;created&#x60; means when the repository was starred. &#x60;updated&#x60; means when the repository was last pushed to. (optional, default to created)
     * @param direction The direction to sort the results by. (optional, default to desc)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-repositories-watched-by-a-user">List repositories watched by a user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-stargazers">List stargazers Documentation</a>
     */
    ...
    /**
     * List stargazers
     * Lists the people that have starred the repository.  You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.3/rest/overview/media-types/) via the &#x60;Accept&#x60; header: &#x60;application/vnd.github.star+json&#x60;.
     * @param owner The account owner of the repository. The name is not case sensitive. (required)
     * @param repo The name of the repository. The name is not case sensitive. (required)
     * @param perPage The number of results per page (max 100). (optional, default to 30)
     * @param page Page number of the results to fetch. (optional, default to 1)
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-repositories-watched-by-the-authenticated-user">List repositories watched by the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#list-watchers">List watchers Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#mark-notifications-as-read">Mark notifications as read Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#mark-repository-notifications-as-read">Mark repository notifications as read Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#mark-a-thread-as-read">Mark a thread as read Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#set-a-repository-subscription">Set a repository subscription Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#set-a-thread-subscription">Set a thread subscription Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#star-a-repository-for-the-authenticated-user">Star a repository for the authenticated user Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@3.3/rest/reference/activity#unstar-a-repository-for-the-authenticated-user">Unstar a repository for the authenticated user Documentation</a>
     */
