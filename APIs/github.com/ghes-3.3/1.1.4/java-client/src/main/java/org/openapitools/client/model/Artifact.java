...
public class Artifact {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archiveDownloadUrl, artifact.archiveDownloadUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(archiveDownloadUrl, createdAt, expired, expiresAt, id, name, nodeId, sizeInBytes, updatedAt, url, workflowRun);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("workflow_run") != null && !jsonObj.get("workflow_run").isJsonNull()) {
        ArtifactWorkflowRun.validateJsonElement(jsonObj.get("workflow_run"));
      }
  }
