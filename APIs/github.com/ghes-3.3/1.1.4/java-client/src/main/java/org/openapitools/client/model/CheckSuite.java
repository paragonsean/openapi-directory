...
public class CheckSuite {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(after, app, before, checkRunsUrl, conclusion, createdAt, headBranch, headCommit, headSha, id, latestCheckRunsCount, nodeId, pullRequests, repository, rerequestable, runsRerequestable, status, updatedAt, url);
  }
