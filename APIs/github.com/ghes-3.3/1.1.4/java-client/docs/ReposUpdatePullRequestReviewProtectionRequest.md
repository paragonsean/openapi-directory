...
|**requireCodeOwnerReviews** | **Boolean** | Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.3/articles/about-code-owners/) have reviewed. |  [optional] |
