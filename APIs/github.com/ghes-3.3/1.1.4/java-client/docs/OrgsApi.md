...
# **orgsGetAuditLog**
> List&lt;AuditLogEvent&gt; orgsGetAuditLog(org, phrase, after, before, order, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<AuditLogEvent> result = apiInstance.orgsGetAuditLog(org, phrase, after, before, order, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
