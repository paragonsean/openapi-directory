...
|**draft** | **Boolean** | Indicates whether the pull request is a draft. See \&quot;[Draft Pull Requests](https://docs.github.com/enterprise-server@3.3/articles/about-pull-requests#draft-pull-requests)\&quot; in the GitHub Help documentation to learn more. |  [optional] |
...
|**maintainerCanModify** | **Boolean** | Indicates whether [maintainers can modify](https://docs.github.com/enterprise-server@3.3/articles/allowing-changes-to-a-pull-request-branch-created-from-a-fork/) the pull request. |  [optional] |
