...
/*
 * OAILicense_content.h
 *
 * License Content
 */

#ifndef OAILicense_content_H
#define OAILicense_content_H
...
class OAILicense_content : public OAIObject {
public:
    OAILicense_content();
    OAILicense_content(QString json);
    ~OAILicense_content() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILicense_content)

#endif // OAILicense_content_H
