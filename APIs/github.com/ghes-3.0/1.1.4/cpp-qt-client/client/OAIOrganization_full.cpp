...
bool OAIOrganization_full::isMembersCanForkPrivateRepositories() const {
    return m_members_can_fork_private_repositories;
}
void OAIOrganization_full::setMembersCanForkPrivateRepositories(const bool &members_can_fork_private_repositories) {
...
bool OAIOrganization_full::is_members_can_fork_private_repositories_Set() const{
    return m_members_can_fork_private_repositories_isSet;
}

bool OAIOrganization_full::is_members_can_fork_private_repositories_Valid() const{
