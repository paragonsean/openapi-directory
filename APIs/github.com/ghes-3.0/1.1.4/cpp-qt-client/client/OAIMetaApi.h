...
Q_SIGNALS:
    ...
    void meta_rootSignal(OAIMeta_root_200_response summary);
    ...
    void meta_rootSignalFull(OAIHttpRequestWorker *worker, OAIMeta_root_200_response summary);
    ...
    void meta_rootSignalE(OAIMeta_root_200_response summary, QNetworkReply::NetworkError error_type, QString error_str);
    void meta_rootSignalError(OAIMeta_root_200_response summary, QNetworkReply::NetworkError error_type, const QString &error_str);
