...
/*
 * OAIIssue_labels_inner.h
 *
 * 
 */

#ifndef OAIIssue_labels_inner_H
#define OAIIssue_labels_inner_H
...
class OAIIssue_labels_inner : public OAIObject {
public:
    OAIIssue_labels_inner();
    OAIIssue_labels_inner(QString json);
    ~OAIIssue_labels_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssue_labels_inner)

#endif // OAIIssue_labels_inner_H
