...
#include "OAIOrgs_update_webhook_config_for_org_request.h"
#include "OAIPage.h"
...
public:
    ...
    */
    virtual void repos_acceptInvitationForAuthenticatedUser(const qint32 &invitation_id);
    ...
    * @param[in]  owner QString [required]
    * @param[in]  repo QString [required]
    * @param[in]  oai_repos_create_dispatch_event_request OAIRepos_create_dispatch_event_request [required]
    */
    virtual void repos_createDispatchEvent(const QString &owner, const QString &repo, const OAIRepos_create_dispatch_event_request &oai_repos_create_dispatch_event_request);
    ...
    * @param[in]  invitation_id qint32 [required]
    */
    virtual void repos_declineInvitationForAuthenticatedUser(const qint32 &invitation_id);
    ...
    * @param[in]  deployment_id qint32 [required]
    */
    virtual void repos_deleteDeployment(const QString &owner, const QString &repo, const qint32 &deployment_id);
    ...
    * @param[in]  hook_id qint32 [required]
    */
    virtual void repos_getWebhookConfigForRepo(const QString &owner, const QString &repo, const qint32 &hook_id);
    ...
    * @param[in]  repo QString [required]
    * @param[in]  hook_id qint32 [required]
    * @param[in]  oai_repos_update_webhook_request OAIRepos_update_webhook_request [required]
    */
    virtual void repos_updateWebhook(const QString &owner, const QString &repo, const qint32 &hook_id, const OAIRepos_update_webhook_request &oai_repos_update_webhook_request);

    /**
    * @param[in]  owner QString [required]
    * @param[in]  repo QString [required]
    * @param[in]  hook_id qint32 [required]
    * @param[in]  oai_orgs_update_webhook_config_for_org_request OAIOrgs_update_webhook_config_for_org_request [optional]
    */
    virtual void repos_updateWebhookConfigForRepo(const QString &owner, const QString &repo, const qint32 &hook_id, const ::OpenAPI::OptionalParam<OAIOrgs_update_webhook_config_for_org_request> &oai_orgs_update_webhook_config_for_org_request = ::OpenAPI::OptionalParam<OAIOrgs_update_webhook_config_for_org_request>());
...
private:
    ...
    void repos_acceptInvitationForAuthenticatedUserCallback(OAIHttpRequestWorker *worker);
    ...
    void repos_createDispatchEventCallback(OAIHttpRequestWorker *worker);
    ...
    void repos_declineInvitationForAuthenticatedUserCallback(OAIHttpRequestWorker *worker);
    ...
    void repos_deleteDeploymentCallback(OAIHttpRequestWorker *worker);
    ...
    void repos_getWebhookConfigForRepoCallback(OAIHttpRequestWorker *worker);
    ...
    void repos_updateWebhookConfigForRepoCallback(OAIHttpRequestWorker *worker);
    void repos_uploadReleaseAssetCallback(OAIHttpRequestWorker *worker);

Q_SIGNALS:

    void repos_acceptInvitationForAuthenticatedUserSignal();
    ...
    void repos_createDispatchEventSignal();
    ...
    void repos_declineInvitationForAuthenticatedUserSignal();
    ...
    void repos_deleteDeploymentSignal();
    ...
    void repos_getWebhookConfigForRepoSignal(OAIWebhook_config summary);
    ...
    void repos_updateWebhookConfigForRepoSignal(OAIWebhook_config summary);
    void repos_uploadReleaseAssetSignal(OAIRelease_asset summary);


    void repos_acceptInvitationForAuthenticatedUserSignalFull(OAIHttpRequestWorker *worker);
    ...
    void repos_createDispatchEventSignalFull(OAIHttpRequestWorker *worker);
    ...
    void repos_declineInvitationForAuthenticatedUserSignalFull(OAIHttpRequestWorker *worker);
    ...
    void repos_deleteDeploymentSignalFull(OAIHttpRequestWorker *worker);
    ...
    void repos_getWebhookConfigForRepoSignalFull(OAIHttpRequestWorker *worker, OAIWebhook_config summary);
    ...
    void repos_updateWebhookConfigForRepoSignalFull(OAIHttpRequestWorker *worker, OAIWebhook_config summary);
    void repos_uploadReleaseAssetSignalFull(OAIHttpRequestWorker *worker, OAIRelease_asset summary);

    Q_DECL_DEPRECATED_X("Use repos_acceptInvitationForAuthenticatedUserSignalError() instead")
    void repos_acceptInvitationForAuthenticatedUserSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void repos_acceptInvitationForAuthenticatedUserSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_createDispatchEventSignalError() instead")
    void repos_createDispatchEventSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void repos_createDispatchEventSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_declineInvitationForAuthenticatedUserSignalError() instead")
    void repos_declineInvitationForAuthenticatedUserSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void repos_declineInvitationForAuthenticatedUserSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_deleteDeploymentSignalError() instead")
    void repos_deleteDeploymentSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void repos_deleteDeploymentSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_getWebhookConfigForRepoSignalError() instead")
    void repos_getWebhookConfigForRepoSignalE(OAIWebhook_config summary, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_getWebhookConfigForRepoSignalError(OAIWebhook_config summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_updateWebhookConfigForRepoSignalError() instead")
    void repos_updateWebhookConfigForRepoSignalE(OAIWebhook_config summary, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_updateWebhookConfigForRepoSignalError(OAIWebhook_config summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_acceptInvitationForAuthenticatedUserSignalErrorFull() instead")
    void repos_acceptInvitationForAuthenticatedUserSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_acceptInvitationForAuthenticatedUserSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_createDispatchEventSignalErrorFull() instead")
    void repos_createDispatchEventSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_createDispatchEventSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_declineInvitationForAuthenticatedUserSignalErrorFull() instead")
    void repos_declineInvitationForAuthenticatedUserSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_declineInvitationForAuthenticatedUserSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_deleteDeploymentSignalErrorFull() instead")
    void repos_deleteDeploymentSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_deleteDeploymentSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_getWebhookConfigForRepoSignalErrorFull() instead")
    void repos_getWebhookConfigForRepoSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_getWebhookConfigForRepoSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use repos_updateWebhookConfigForRepoSignalErrorFull() instead")
    void repos_updateWebhookConfigForRepoSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void repos_updateWebhookConfigForRepoSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
