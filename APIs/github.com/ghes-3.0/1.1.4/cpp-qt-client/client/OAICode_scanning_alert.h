...
/*
 * OAICode_scanning_alert.h
 *
 * 
 */

#ifndef OAICode_scanning_alert_H
#define OAICode_scanning_alert_H
...
class OAICode_scanning_alert_rule;
class OAICode_scanning_analysis_tool;

class OAICode_scanning_alert : public OAIObject {
public:
    OAICode_scanning_alert();
    OAICode_scanning_alert(QString json);
    ~OAICode_scanning_alert() override;
    ...
    Q_DECL_DEPRECATED QJsonValue getInstances() const;
    Q_DECL_DEPRECATED void setInstances(const QJsonValue &instances);
    Q_DECL_DEPRECATED bool is_instances_Set() const;
    Q_DECL_DEPRECATED bool is_instances_Valid() const;
    ...
    OAICode_scanning_alert_rule getRule() const;
    void setRule(const OAICode_scanning_alert_rule &rule);
...
private:
    ...
    OAICode_scanning_alert_rule m_rule;
    bool m_rule_isSet;
    bool m_rule_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAICode_scanning_alert)

#endif // OAICode_scanning_alert_H
