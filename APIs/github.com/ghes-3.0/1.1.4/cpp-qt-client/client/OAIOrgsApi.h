...
public:
    ...
    */
    virtual void orgs_updateWebhookConfigForOrg(const QString &org, const qint32 &hook_id, const ::OpenAPI::OptionalParam<OAIOrgs_update_webhook_config_for_org_request> &oai_orgs_update_webhook_config_for_org_request = ::OpenAPI::OptionalParam<OAIOrgs_update_webhook_config_for_org_request>());
