...
public:
    ...
    */
    virtual void apps_updateWebhookConfigForApp(const ::OpenAPI::OptionalParam<OAIApps_update_webhook_config_for_app_request> &oai_apps_update_webhook_config_for_app_request = ::OpenAPI::OptionalParam<OAIApps_update_webhook_config_for_app_request>());
