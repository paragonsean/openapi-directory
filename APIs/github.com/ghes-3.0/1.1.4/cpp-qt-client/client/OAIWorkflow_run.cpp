...
void OAIWorkflow_run::initializeModel() {
    ...
    m_previous_attempt_url_isSet = false;
    m_previous_attempt_url_isValid = false;
    ...
    m_run_started_at_isSet = false;
    m_run_started_at_isValid = false;
...
void OAIWorkflow_run::fromJsonObject(QJsonObject json) {
    ...
    m_previous_attempt_url_isValid = ::OpenAPI::fromJsonValue(m_previous_attempt_url, json[QString("previous_attempt_url")]);
    m_previous_attempt_url_isSet = !json[QString("previous_attempt_url")].isNull() && m_previous_attempt_url_isValid;
    ...
    m_run_started_at_isValid = ::OpenAPI::fromJsonValue(m_run_started_at, json[QString("run_started_at")]);
    m_run_started_at_isSet = !json[QString("run_started_at")].isNull() && m_run_started_at_isValid;
...
QJsonObject OAIWorkflow_run::asJsonObject() const {
    ...
    if (m_previous_attempt_url_isSet) {
        obj.insert(QString("previous_attempt_url"), ::OpenAPI::toJsonValue(m_previous_attempt_url));
    }
    ...
    if (m_run_started_at_isSet) {
        obj.insert(QString("run_started_at"), ::OpenAPI::toJsonValue(m_run_started_at));
    }
    if (m_status_isSet) {
...
QString OAIWorkflow_run::getPreviousAttemptUrl() const {
    return m_previous_attempt_url;
}
void OAIWorkflow_run::setPreviousAttemptUrl(const QString &previous_attempt_url) {
    m_previous_attempt_url = previous_attempt_url;
    m_previous_attempt_url_isSet = true;
}

bool OAIWorkflow_run::is_previous_attempt_url_Set() const{
    return m_previous_attempt_url_isSet;
}

bool OAIWorkflow_run::is_previous_attempt_url_Valid() const{
    return m_previous_attempt_url_isValid;
}
...
qint32 OAIWorkflow_run::getRunAttempt() const {
    return m_run_attempt;
}
void OAIWorkflow_run::setRunAttempt(const qint32 &run_attempt) {
    m_run_attempt = run_attempt;
    m_run_attempt_isSet = true;
}

bool OAIWorkflow_run::is_run_attempt_Set() const{
    return m_run_attempt_isSet;
}

bool OAIWorkflow_run::is_run_attempt_Valid() const{
...
QDateTime OAIWorkflow_run::getRunStartedAt() const {
    return m_run_started_at;
}
void OAIWorkflow_run::setRunStartedAt(const QDateTime &run_started_at) {
    m_run_started_at = run_started_at;
    m_run_started_at_isSet = true;
}

bool OAIWorkflow_run::is_run_started_at_Set() const{
    return m_run_started_at_isSet;
}

bool OAIWorkflow_run::is_run_started_at_Valid() const{
    return m_run_started_at_isValid;
}
