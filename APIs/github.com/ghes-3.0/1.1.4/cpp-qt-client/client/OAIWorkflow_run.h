...
public:
    ...
    QString getPreviousAttemptUrl() const;
    void setPreviousAttemptUrl(const QString &previous_attempt_url);
    bool is_previous_attempt_url_Set() const;
    bool is_previous_attempt_url_Valid() const;
    ...
    QDateTime getRunStartedAt() const;
    void setRunStartedAt(const QDateTime &run_started_at);
    bool is_run_started_at_Set() const;
    bool is_run_started_at_Valid() const;
...
private:
    ...
    QString m_previous_attempt_url;
    bool m_previous_attempt_url_isSet;
    bool m_previous_attempt_url_isValid;
    ...
    QDateTime m_run_started_at;
    bool m_run_started_at_isSet;
    bool m_run_started_at_isValid;
