...
/*
 * OAIIssue_event_for_issue.h
 *
 * Issue Event for Issue
 */

#ifndef OAIIssue_event_for_issue_H
#define OAIIssue_event_for_issue_H

#include <QJsonObject>

#include "OAIAdded_to_project_issue_event.h"
#include "OAIAdded_to_project_issue_event_project_card.h"
#include "OAIAssigned_issue_event.h"
...
class OAIIssue_event_for_issue : public OAIObject {
public:
    OAIIssue_event_for_issue();
    OAIIssue_event_for_issue(QString json);
    ~OAIIssue_event_for_issue() override;
    ...
    OAIIntegration getPerformedViaGithubApp() const;
    void setPerformedViaGithubApp(const OAIIntegration &performed_via_github_app);
    ...
    OAISimple_user getAssigner() const;
    void setAssigner(const OAISimple_user &assigner);
...
private:
    ...
    OAIIntegration m_performed_via_github_app;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIssue_event_for_issue)

#endif // OAIIssue_event_for_issue_H
