...
async def users_add_email_for_authenticated_user(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = UsersAddEmailForAuthenticatedUserRequest.from_dict(body)
...
async def users_create_gpg_key_for_authenticated_user(request: web.Request, body) -> web.Response:
    ...
    """
    body = UsersCreateGpgKeyForAuthenticatedUserRequest.from_dict(body)
    return web.Response(status=200)


async def users_create_public_ssh_key_for_authenticated_user(request: web.Request, body) -> web.Response:
    ...
    """
    body = UsersCreatePublicSshKeyForAuthenticatedUserRequest.from_dict(body)
    return web.Response(status=200)


async def users_delete_email_for_authenticated_user(request: web.Request, body=None) -> web.Response:
    ...
    """
    body = UsersDeleteEmailForAuthenticatedUserRequest.from_dict(body)
    return web.Response(status=200)


async def users_delete_gpg_key_for_authenticated_user(request: web.Request, gpg_key_id) -> web.Response:
...
async def users_delete_public_ssh_key_for_authenticated_user(request: web.Request, key_id) -> web.Response:
...
async def users_get_gpg_key_for_authenticated_user(request: web.Request, gpg_key_id) -> web.Response:
...
async def users_get_public_ssh_key_for_authenticated_user(request: web.Request, key_id) -> web.Response:
...
async def users_list_emails_for_authenticated_user(request: web.Request, per_page=None, page=None) -> web.Response:
...
async def users_list_followed_by_authenticated_user(request: web.Request, per_page=None, page=None) -> web.Response:
...
async def users_list_gpg_keys_for_authenticated_user(request: web.Request, per_page=None, page=None) -> web.Response:
...
async def users_list_public_emails_for_authenticated_user(request: web.Request, per_page=None, page=None) -> web.Response:
...
async def users_list_public_ssh_keys_for_authenticated_user(request: web.Request, per_page=None, page=None) -> web.Response:
