...
async def enterprise_admin_create_enterprise_server_license(request: web.Request, license, password=None, settings=None) -> web.Response:
    ...
    :type password: str
    :param settings: An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#get-settings).
    :type settings: str
...
async def enterprise_admin_disable_selected_organization_github_actions_enterprise(request: web.Request, enterprise, org_id) -> web.Response:
...
async def enterprise_admin_enable_selected_organization_github_actions_enterprise(request: web.Request, enterprise, org_id) -> web.Response:
...
async def enterprise_admin_get_allowed_actions_enterprise(request: web.Request, enterprise) -> web.Response:
...
async def enterprise_admin_get_announcement(request: web.Request, ) -> web.Response:
...
async def enterprise_admin_get_gist_stats(request: web.Request, ) -> web.Response:
    """Get gist statistics
...
async def enterprise_admin_get_github_actions_permissions_enterprise(request: web.Request, enterprise) -> web.Response:
...
async def enterprise_admin_list_selected_organizations_enabled_github_actions_enterprise(request: web.Request, enterprise, per_page=None, page=None) -> web.Response:
...
async def enterprise_admin_remove_announcement(request: web.Request, ) -> web.Response:
...
async def enterprise_admin_set_allowed_actions_enterprise(request: web.Request, enterprise, body) -> web.Response:
...
async def enterprise_admin_set_announcement(request: web.Request, body) -> web.Response:
...
async def enterprise_admin_set_github_actions_permissions_enterprise(request: web.Request, enterprise, body) -> web.Response:
    ...
    """
    body = EnterpriseAdminSetGithubActionsPermissionsEnterpriseRequest.from_dict(body)
    return web.Response(status=200)
...
async def enterprise_admin_set_selected_organizations_enabled_github_actions_enterprise(request: web.Request, enterprise, body) -> web.Response:
    ...
    """
    body = EnterpriseAdminSetSelectedOrganizationsEnabledGithubActionsEnterpriseRequest.from_dict(body)
    return web.Response(status=200)
...
async def enterprise_admin_set_settings(request: web.Request, settings) -> web.Response:
    ...
    :param settings: A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#get-settings).
    :type settings: str
