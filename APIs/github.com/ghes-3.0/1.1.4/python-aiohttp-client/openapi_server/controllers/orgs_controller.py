...
async def orgs_get_webhook_config_for_org(request: web.Request, org, hook_id) -> web.Response:
...
async def orgs_list_app_installations(request: web.Request, org, per_page=None, page=None) -> web.Response:
...
async def orgs_update_webhook_config_for_org(request: web.Request, org, hook_id, body=None) -> web.Response:
