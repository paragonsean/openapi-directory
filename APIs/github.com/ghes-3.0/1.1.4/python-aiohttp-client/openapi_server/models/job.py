...
class Job(Model):
    ...
    def __init__(self, check_run_url: str=None, completed_at: datetime=None, conclusion: str=None, head_sha: str=None, html_url: str=None, id: int=None, name: str=None, node_id: str=None, run_attempt: int=None, run_id: int=None, run_url: str=None, started_at: datetime=None, status: str=None, steps: List[JobStepsInner]=None, url: str=None):
        ...
        :param run_attempt: The run_attempt of this Job.
    ...
    def run_attempt(self):
        """Gets the run_attempt of this Job.

        Attempt number of the associated workflow run, 1 for first attempt and higher if the workflow was re-run.

        :return: The run_attempt of this Job.
        :rtype: int
        """
    ...
    def run_attempt(self, run_attempt):
        """Sets the run_attempt of this Job.
