...
public class RemovedFromProjectIssueEvent {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actor, removedFromProjectIssueEvent.actor) &&
        ...
        Objects.equals(this.id, removedFromProjectIssueEvent.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemovedFromProjectIssueEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemovedFromProjectIssueEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemovedFromProjectIssueEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemovedFromProjectIssueEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
