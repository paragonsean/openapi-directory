...
public class UsersDeleteEmailForAuthenticatedUserRequest extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<UsersDeleteEmailForAuthenticatedUserRequest>() {
                ...
                public void write(JsonWriter out, UsersDeleteEmailForAuthenticatedUserRequest value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof UsersDeleteEmailForAuthenticatedUserRequestOneOf) {
                        JsonElement element = adapterUsersDeleteEmailForAuthenticatedUserRequestOneOf.toJsonTree((UsersDeleteEmailForAuthenticatedUserRequestOneOf)value.getActualInstance());
                ...
                public UsersDeleteEmailForAuthenticatedUserRequest read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UsersDeleteEmailForAuthenticatedUserRequestOneOf.validateJsonElement(jsonElement);
                    ...
                    throw new IOException(String.format("Failed deserialization for UsersDeleteEmailForAuthenticatedUserRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UsersDeleteEmailForAuthenticatedUserRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("UsersDeleteEmailForAuthenticatedUserRequestOneOf", UsersDeleteEmailForAuthenticatedUserRequestOneOf.class);
     ...
     * @throws IOException if the JSON Element is invalid with respect to UsersDeleteEmailForAuthenticatedUserRequest
     */
