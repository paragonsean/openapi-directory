...
public class ReposUpdateBranchProtectionRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowDeletions, allowForcePushes, contexts, enforceAdmins, requiredConversationResolution, requiredLinearHistory, requiredPullRequestReviews, requiredStatusChecks, restrictions);
  }
