...
public class Example {
  public static void main(String[] args) {
    ...
    Integer orgId = 56; // Integer | Unique identifier of an organization.
    try {
...
| **orgId** | **Integer**| Unique identifier of an organization. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String settings = "settings_example"; // String | An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#get-settings).
    try {
...
| **settings** | **String**| An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#get-settings). | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    EnterpriseAdminApi apiInstance = new EnterpriseAdminApi(defaultClient);
    String accept = "application/vnd.github.superpro-preview+json"; // String | This API is under preview and subject to change.
    ...
    try {
      GlobalHook result = apiInstance.enterpriseAdminCreateGlobalWebhook(accept, enterpriseAdminCreateGlobalWebhookRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.enterpriseAdminDeleteGlobalWebhook(accept, hookId);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    EnterpriseAdminApi apiInstance = new EnterpriseAdminApi(defaultClient);
    Integer preReceiveEnvironmentId = 56; // Integer | 
    try {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **preReceiveEnvironmentId** | **Integer**|  | |
...
public class Example {
  public static void main(String[] args) {
    ...
    EnterpriseAdminApi apiInstance = new EnterpriseAdminApi(defaultClient);
    Integer preReceiveHookId = 56; // Integer | pre_receive_hook_id parameter
    try {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **preReceiveHookId** | **Integer**| pre_receive_hook_id parameter | |
...
public class Example {
  public static void main(String[] args) {
    ...
    EnterpriseAdminApi apiInstance = new EnterpriseAdminApi(defaultClient);
    String keyIds = "keyIds_example"; // String | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer hookId = 56; // Integer | 
    try {
      GlobalHook result = apiInstance.enterpriseAdminGetGlobalWebhook(accept, hookId);
      System.out.println(result);
    } catch (ApiException e) {
...
> List&lt;GlobalHook&gt; enterpriseAdminListGlobalWebhooks(accept, perPage, page)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      List<GlobalHook> result = apiInstance.enterpriseAdminListGlobalWebhooks(accept, perPage, page);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer page = 1; // Integer | Page number of the results to fetch.
    String direction = "asc"; // String | One of `asc` (ascending) or `desc` (descending).
    String sort = "created"; // String | One of `created` (when the repository was starred) or `updated` (when it was last pushed to) or `name`.
    try {
...
| **page** | **Integer**| Page number of the results to fetch. | [optional] [default to 1] |
| **direction** | **String**| One of &#x60;asc&#x60; (ascending) or &#x60;desc&#x60; (descending). | [optional] [default to desc] [enum: asc, desc] |
| **sort** | **String**| One of &#x60;created&#x60; (when the repository was starred) or &#x60;updated&#x60; (when it was last pushed to) or &#x60;name&#x60;. | [optional] [default to created] [enum: created, updated, name] |
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer hookId = 56; // Integer | 
    try {
      apiInstance.enterpriseAdminPingGlobalWebhook(accept, hookId);
    } catch (ApiException e) {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **settings** | **String**| A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@3.0/rest/reference/enterprise-admin#get-settings). | |
...
> GlobalHook2 enterpriseAdminUpdateGlobalWebhook(accept, hookId, enterpriseAdminUpdateGlobalWebhookRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GlobalHook2 result = apiInstance.enterpriseAdminUpdateGlobalWebhook(accept, hookId, enterpriseAdminUpdateGlobalWebhookRequest);
      System.out.println(result);
    } catch (ApiException e) {
