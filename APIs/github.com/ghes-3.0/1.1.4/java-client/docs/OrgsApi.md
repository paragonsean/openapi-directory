...
> WebhookConfig orgsUpdateWebhookConfigForOrg(org, hookId, orgsUpdateWebhookConfigForOrgRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    String org = "org_example"; // String | 
    Integer hookId = 56; // Integer | 
    OrgsUpdateWebhookConfigForOrgRequest orgsUpdateWebhookConfigForOrgRequest = new OrgsUpdateWebhookConfigForOrgRequest(); // OrgsUpdateWebhookConfigForOrgRequest | 
    try {
      WebhookConfig result = apiInstance.orgsUpdateWebhookConfigForOrg(org, hookId, orgsUpdateWebhookConfigForOrgRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
| **org** | **String**|  | |
| **hookId** | **Integer**|  | |
| **orgsUpdateWebhookConfigForOrgRequest** | [**OrgsUpdateWebhookConfigForOrgRequest**](OrgsUpdateWebhookConfigForOrgRequest.md)|  | [optional] |
