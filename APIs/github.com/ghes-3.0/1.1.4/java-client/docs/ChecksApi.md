...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | when the suite already existed |  -  |
...
public class Example {
  public static void main(String[] args) {
    ...
    String owner = "owner_example"; // String | 
    String repo = "repo_example"; // String | 
    Integer checkRunId = 56; // Integer | check_run_id parameter
    try {
...
| **owner** | **String**|  | |
| **repo** | **String**|  | |
| **checkRunId** | **Integer**| check_run_id parameter | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String owner = "owner_example"; // String | 
    String repo = "repo_example"; // String | 
    Integer checkSuiteId = 56; // Integer | check_suite_id parameter
    try {
...
| **owner** | **String**|  | |
| **repo** | **String**|  | |
| **checkSuiteId** | **Integer**| check_suite_id parameter | |
...
public class Example {
  public static void main(String[] args) {
    ...
    String status = "queued"; // String | Returns check runs with the specified `status`. Can be one of `queued`, `in_progress`, or `completed`.
    String filter = "latest"; // String | Filters check runs by their `completed_at` timestamp. Can be one of `latest` (returning the most recent check runs) or `all`.
    Integer perPage = 30; // Integer | Results per page (max 100)
    Integer page = 1; // Integer | Page number of the results to fetch.
...
| **status** | **String**| Returns check runs with the specified &#x60;status&#x60;. Can be one of &#x60;queued&#x60;, &#x60;in_progress&#x60;, or &#x60;completed&#x60;. | [optional] [enum: queued, in_progress, completed] |
| **filter** | **String**| Filters check runs by their &#x60;completed_at&#x60; timestamp. Can be one of &#x60;latest&#x60; (returning the most recent check runs) or &#x60;all&#x60;. | [optional] [default to latest] [enum: latest, all] |
| **perPage** | **Integer**| Results per page (max 100) | [optional] [default to 30] |
| **page** | **Integer**| Page number of the results to fetch. | [optional] [default to 1] |
