...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | **Note:** This returns an &#x60;upload_url&#x60; key corresponding to the endpoint for uploading release assets. This key is a [hypermedia resource](https://docs.github.com/enterprise-server@3.0/rest/overview/resources-in-the-rest-api#hypermedia). |  -  |
| **404** | Resource not found |  -  |
...
> WebhookConfig reposUpdateWebhookConfigForRepo(owner, repo, hookId, orgsUpdateWebhookConfigForOrgRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      WebhookConfig result = apiInstance.reposUpdateWebhookConfigForRepo(owner, repo, hookId, orgsUpdateWebhookConfigForOrgRequest);
      System.out.println(result);
    } catch (ApiException e) {
