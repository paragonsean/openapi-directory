...
|**vulnerabilityAlerts** | [**VulnerabilityAlertsEnum**](#VulnerabilityAlertsEnum) | The level of permission to grant the access token to manage Dependabot alerts. Can be one of: &#x60;read&#x60; or &#x60;write&#x60;. |  [optional] |
