...
let opts = {
  'usersAddEmailForAuthenticatedUserRequest': new GitHubV3RestApi.UsersAddEmailForAuthenticatedUserRequest() // UsersAddEmailForAuthenticatedUserRequest | 
};
...
let apiInstance = new GitHubV3RestApi.UsersApi();
let opts = {
  'usersDeleteEmailForAuthenticatedUserRequest': new GitHubV3RestApi.UsersDeleteEmailForAuthenticatedUserRequest() // UsersDeleteEmailForAuthenticatedUserRequest | 
};
