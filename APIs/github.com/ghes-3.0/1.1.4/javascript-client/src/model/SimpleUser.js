...
class SimpleUser {
    ...
    /**
     * Validates the JSON data with respect to <code>SimpleUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimpleUser</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimpleUser.RequiredProperties) {
...
SimpleUser.RequiredProperties = ["avatar_url", "events_url", "followers_url", "following_url", "gists_url", "gravatar_id", "html_url", "id", "login", "node_id", "organizations_url", "received_events_url", "repos_url", "site_admin", "starred_url", "subscriptions_url", "type", "url"];
 ...
 * @member {String} email
 */
SimpleUser.prototype['email'] = undefined;
 ...
 * @member {String} name
 */
SimpleUser.prototype['name'] = undefined;
