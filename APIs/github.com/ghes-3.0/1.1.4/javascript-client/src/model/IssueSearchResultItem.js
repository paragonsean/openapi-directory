...
class IssueSearchResultItem {
     ...
     * @param id {Number} 
     * @param labels {Array.<module:model/IssueSearchResultItemLabelsInner>} 
     ...
     */
    constructor(assignee, authorAssociation, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, repositoryUrl, score, state, title, updatedAt, url, user) { 
        
        IssueSearchResultItem.initialize(this, assignee, authorAssociation, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, repositoryUrl, score, state, title, updatedAt, url, user);
    }
     ...
     */
    static initialize(obj, assignee, authorAssociation, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, repositoryUrl, score, state, title, updatedAt, url, user) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('labels')) {
                obj['labels'] = ApiClient.convertToType(data['labels'], [IssueSearchResultItemLabelsInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IssueSearchResultItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IssueSearchResultItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IssueSearchResultItem.RequiredProperties) {
        ...
        if (data['labels']) { // data not null
            ...
            for (const item of data['labels']) {
                IssueSearchResultItemLabelsInner.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
IssueSearchResultItem.RequiredProperties = ["assignee", "author_association", "closed_at", "comments", "comments_url", "created_at", "events_url", "html_url", "id", "labels", "labels_url", "locked", "milestone", "node_id", "number", "repository_url", "score", "state", "title", "updated_at", "url", "user"];
...
/**
 * @member {Array.<module:model/IssueSearchResultItemLabelsInner>} labels
 */
 ...
 */
IssueSearchResultItem.prototype['reactions'] = undefined;
