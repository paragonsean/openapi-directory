...
/**
 * The ReviewRequestRemovedIssueEvent model module.
 * @module model/ReviewRequestRemovedIssueEvent
 * @version 1.1.4
 */
class ReviewRequestRemovedIssueEvent {
    /**
     * Constructs a new <code>ReviewRequestRemovedIssueEvent</code>.
     * Review Request Removed Issue Event
     * @alias module:model/ReviewRequestRemovedIssueEvent
    ...
    constructor(actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, reviewRequester, url) { 
        ...
        ReviewRequestRemovedIssueEvent.initialize(this, actor, commitId, commitUrl, createdAt, event, id, nodeId, performedViaGithubApp, reviewRequester, url);
    }
    ...
    /**
     * Constructs a <code>ReviewRequestRemovedIssueEvent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ReviewRequestRemovedIssueEvent} obj Optional instance to populate.
     * @return {module:model/ReviewRequestRemovedIssueEvent} The populated <code>ReviewRequestRemovedIssueEvent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReviewRequestRemovedIssueEvent();
    ...
    /**
     * Validates the JSON data with respect to <code>ReviewRequestRemovedIssueEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ReviewRequestRemovedIssueEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ReviewRequestRemovedIssueEvent.RequiredProperties) {
...
ReviewRequestRemovedIssueEvent.RequiredProperties = ["actor", "commit_id", "commit_url", "created_at", "event", "id", "node_id", "performed_via_github_app", "review_requester", "url"];

/**
 * @member {module:model/SimpleUser} actor
 */
ReviewRequestRemovedIssueEvent.prototype['actor'] = undefined;

/**
 * @member {String} commit_id
 */
ReviewRequestRemovedIssueEvent.prototype['commit_id'] = undefined;

/**
 * @member {String} commit_url
 */
ReviewRequestRemovedIssueEvent.prototype['commit_url'] = undefined;

/**
 * @member {String} created_at
 */
ReviewRequestRemovedIssueEvent.prototype['created_at'] = undefined;

/**
 * @member {String} event
 */
ReviewRequestRemovedIssueEvent.prototype['event'] = undefined;

/**
 * @member {Number} id
 */
ReviewRequestRemovedIssueEvent.prototype['id'] = undefined;

/**
 * @member {String} node_id
 */
ReviewRequestRemovedIssueEvent.prototype['node_id'] = undefined;

/**
 * @member {module:model/NullableIntegration} performed_via_github_app
 */
ReviewRequestRemovedIssueEvent.prototype['performed_via_github_app'] = undefined;

/**
 * @member {module:model/SimpleUser} requested_reviewer
 */
ReviewRequestRemovedIssueEvent.prototype['requested_reviewer'] = undefined;

/**
 * @member {module:model/Team} requested_team
 */
ReviewRequestRemovedIssueEvent.prototype['requested_team'] = undefined;

/**
 * @member {module:model/SimpleUser} review_requester
 */
ReviewRequestRemovedIssueEvent.prototype['review_requester'] = undefined;

/**
 * @member {String} url
 */
ReviewRequestRemovedIssueEvent.prototype['url'] = undefined;
...
export default ReviewRequestRemovedIssueEvent;
