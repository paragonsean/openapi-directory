...
BaseGist.RequiredProperties = ["comments", "comments_url", "commits_url", "created_at", "description", "files", "forks_url", "git_pull_url", "git_push_url", "html_url", "id", "node_id", "public", "updated_at", "url", "user"];
