...
export default class ChecksApi {
    ...
    */
     ...
     * @param {module:model/String} [status] Returns check runs with the specified `status`. Can be one of `queued`, `in_progress`, or `completed`.
     * @param {module:model/String} [filter = 'latest')] Filters check runs by their `completed_at` timestamp. Can be one of `latest` (returning the most recent check runs) or `all`.
     * @param {Number} [perPage = 30)] Results per page (max 100)
     * @param {Number} [page = 1)] Page number of the results to fetch.
     * @param {Number} [appId] 
