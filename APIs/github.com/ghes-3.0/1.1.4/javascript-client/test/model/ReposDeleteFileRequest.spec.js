...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposDeleteFileRequest();
  });
  ...
  describe('ReposDeleteFileRequest', function() {
    it('should create an instance of ReposDeleteFileRequest', function() {
      // uncomment below and update the code to test ReposDeleteFileRequest
      //var instance = new GitHubV3RestApi.ReposDeleteFileRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposDeleteFileRequest);
    });
