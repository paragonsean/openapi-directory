...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.JobStepsInner();
  });
  ...
  describe('JobStepsInner', function() {
    it('should create an instance of JobStepsInner', function() {
      // uncomment below and update the code to test JobStepsInner
      //var instance = new GitHubV3RestApi.JobStepsInner();
      //expect(instance).to.be.a(GitHubV3RestApi.JobStepsInner);
    });
