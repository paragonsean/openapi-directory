...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PublicUser();
  });
  ...
  describe('PublicUser', function() {
    it('should create an instance of PublicUser', function() {
      // uncomment below and update the code to test PublicUser
      //var instance = new GitHubV3RestApi.PublicUser();
      //expect(instance).to.be.a(GitHubV3RestApi.PublicUser);
    });
