...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LicenseContent();
  });
  ...
  describe('LicenseContent', function() {
    it('should create an instance of LicenseContent', function() {
      // uncomment below and update the code to test LicenseContent
      //var instance = new GitHubV3RestApi.LicenseContent();
      //expect(instance).to.be.a(GitHubV3RestApi.LicenseContent);
    });
