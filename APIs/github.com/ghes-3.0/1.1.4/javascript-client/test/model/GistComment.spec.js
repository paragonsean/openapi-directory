...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GistComment();
  });
  ...
  describe('GistComment', function() {
    it('should create an instance of GistComment', function() {
      // uncomment below and update the code to test GistComment
      //var instance = new GitHubV3RestApi.GistComment();
      //expect(instance).to.be.a(GitHubV3RestApi.GistComment);
    });
