...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ShortBranch();
  });
  ...
  describe('ShortBranch', function() {
    it('should create an instance of ShortBranch', function() {
      // uncomment below and update the code to test ShortBranch
      //var instance = new GitHubV3RestApi.ShortBranch();
      //expect(instance).to.be.a(GitHubV3RestApi.ShortBranch);
    });
