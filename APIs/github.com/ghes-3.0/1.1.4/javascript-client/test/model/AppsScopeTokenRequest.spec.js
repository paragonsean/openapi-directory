...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.AppsScopeTokenRequest();
  });
  ...
  describe('AppsScopeTokenRequest', function() {
    it('should create an instance of AppsScopeTokenRequest', function() {
      // uncomment below and update the code to test AppsScopeTokenRequest
      //var instance = new GitHubV3RestApi.AppsScopeTokenRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.AppsScopeTokenRequest);
    });
    ...
    it('should have the property repositoryIds (base name: "repository_ids")', function() {
      // uncomment below and update the code to test the property repositoryIds
      //var instance = new GitHubV3RestApi.AppsScopeTokenRequest();
      //expect(instance).to.be();
    });
