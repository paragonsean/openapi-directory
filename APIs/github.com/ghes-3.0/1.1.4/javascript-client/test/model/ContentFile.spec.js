...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ContentFile();
  });
  ...
  describe('ContentFile', function() {
    it('should create an instance of ContentFile', function() {
      // uncomment below and update the code to test ContentFile
      //var instance = new GitHubV3RestApi.ContentFile();
      //expect(instance).to.be.a(GitHubV3RestApi.ContentFile);
    });
