...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.IssuesCreateRequest();
  });
  ...
  describe('IssuesCreateRequest', function() {
    it('should create an instance of IssuesCreateRequest', function() {
      // uncomment below and update the code to test IssuesCreateRequest
      //var instance = new GitHubV3RestApi.IssuesCreateRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.IssuesCreateRequest);
    });
