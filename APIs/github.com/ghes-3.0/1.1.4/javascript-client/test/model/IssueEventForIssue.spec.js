...
(function(root, factory) {
  ...
  describe('IssueEventForIssue', function() {
    it('should create an instance of IssueEventForIssue', function() {
      ...
      //var instance = new GitHubV3RestApi.IssueEventForIssue();
    ...
    it('should have the property assigner (base name: "assigner")', function() {
      // uncomment below and update the code to test the property assigner
      //var instance = new GitHubV3RestApi.IssueEventForIssue();
      //expect(instance).to.be();
    });
