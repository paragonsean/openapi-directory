...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.LdapMappingUser();
  });
  ...
  describe('LdapMappingUser', function() {
    it('should create an instance of LdapMappingUser', function() {
      // uncomment below and update the code to test LdapMappingUser
      //var instance = new GitHubV3RestApi.LdapMappingUser();
      //expect(instance).to.be.a(GitHubV3RestApi.LdapMappingUser);
    });
