...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.Actor();
  });
  ...
  describe('Actor', function() {
    it('should create an instance of Actor', function() {
      ...
      //var instance = new GitHubV3RestApi.Actor();
      //expect(instance).to.be.a(GitHubV3RestApi.Actor);
    });
    ...
    it('should have the property displayLogin (base name: "display_login")', function() {
      // uncomment below and update the code to test the property displayLogin
      //var instance = new GitHubV3RestApi.Actor();
      //expect(instance).to.be();
    });
