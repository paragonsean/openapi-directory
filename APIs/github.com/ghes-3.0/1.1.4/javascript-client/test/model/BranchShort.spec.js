...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchShort();
  });
  ...
  describe('BranchShort', function() {
    it('should create an instance of BranchShort', function() {
      // uncomment below and update the code to test BranchShort
      //var instance = new GitHubV3RestApi.BranchShort();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchShort);
    });
