...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.RepoSearchResultItem();
  });
  ...
  describe('RepoSearchResultItem', function() {
    it('should create an instance of RepoSearchResultItem', function() {
      // uncomment below and update the code to test RepoSearchResultItem
      //var instance = new GitHubV3RestApi.RepoSearchResultItem();
      //expect(instance).to.be.a(GitHubV3RestApi.RepoSearchResultItem);
    });
