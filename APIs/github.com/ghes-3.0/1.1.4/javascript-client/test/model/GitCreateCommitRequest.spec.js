...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.GitCreateCommitRequest();
  });
  ...
  describe('GitCreateCommitRequest', function() {
    it('should create an instance of GitCreateCommitRequest', function() {
      // uncomment below and update the code to test GitCreateCommitRequest
      //var instance = new GitHubV3RestApi.GitCreateCommitRequest();
      //expect(instance).to.be.a(GitHubV3RestApi.GitCreateCommitRequest);
    });
