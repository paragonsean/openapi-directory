...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReviewDismissedIssueEvent();
  });
  ...
  describe('ReviewDismissedIssueEvent', function() {
    it('should create an instance of ReviewDismissedIssueEvent', function() {
      // uncomment below and update the code to test ReviewDismissedIssueEvent
      //var instance = new GitHubV3RestApi.ReviewDismissedIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.ReviewDismissedIssueEvent);
    });
