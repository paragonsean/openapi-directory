...
**events** | **[String]** | Determines what [events](https://docs.github.com/enterprise-server@2.20/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events. | [optional] 
