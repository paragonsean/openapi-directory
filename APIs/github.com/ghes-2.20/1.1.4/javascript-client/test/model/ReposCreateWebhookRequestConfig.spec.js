...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.ReposCreateWebhookRequestConfig();
  });
  ...
  describe('ReposCreateWebhookRequestConfig', function() {
    it('should create an instance of ReposCreateWebhookRequestConfig', function() {
      // uncomment below and update the code to test ReposCreateWebhookRequestConfig
      //var instance = new GitHubV3RestApi.ReposCreateWebhookRequestConfig();
      //expect(instance).to.be.a(GitHubV3RestApi.ReposCreateWebhookRequestConfig);
    });
