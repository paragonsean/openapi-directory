...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.RepositoryInvitation();
  });
  ...
  describe('RepositoryInvitation', function() {
    it('should create an instance of RepositoryInvitation', function() {
      // uncomment below and update the code to test RepositoryInvitation
      //var instance = new GitHubV3RestApi.RepositoryInvitation();
      //expect(instance).to.be.a(GitHubV3RestApi.RepositoryInvitation);
    });
