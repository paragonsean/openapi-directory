...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.TeamDiscussion();
  });
  ...
  describe('TeamDiscussion', function() {
    it('should create an instance of TeamDiscussion', function() {
      // uncomment below and update the code to test TeamDiscussion
      //var instance = new GitHubV3RestApi.TeamDiscussion();
      //expect(instance).to.be.a(GitHubV3RestApi.TeamDiscussion);
    });
    ...
    it('should have the property teamUrl (base name: "team_url")', function() {
