...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.BranchRestrictionPolicyAppsInnerPermissions();
  });
  ...
  describe('BranchRestrictionPolicyAppsInnerPermissions', function() {
    it('should create an instance of BranchRestrictionPolicyAppsInnerPermissions', function() {
      // uncomment below and update the code to test BranchRestrictionPolicyAppsInnerPermissions
      //var instance = new GitHubV3RestApi.BranchRestrictionPolicyAppsInnerPermissions();
      //expect(instance).to.be.a(GitHubV3RestApi.BranchRestrictionPolicyAppsInnerPermissions);
    });
