...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.OrgHookConfig();
  });
  ...
  describe('OrgHookConfig', function() {
    it('should create an instance of OrgHookConfig', function() {
      // uncomment below and update the code to test OrgHookConfig
      //var instance = new GitHubV3RestApi.OrgHookConfig();
      //expect(instance).to.be.a(GitHubV3RestApi.OrgHookConfig);
    });
