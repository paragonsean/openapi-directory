...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.UsersGetAuthenticated200Response();
  });
  ...
  describe('UsersGetAuthenticated200Response', function() {
    it('should create an instance of UsersGetAuthenticated200Response', function() {
      // uncomment below and update the code to test UsersGetAuthenticated200Response
      //var instance = new GitHubV3RestApi.UsersGetAuthenticated200Response();
      //expect(instance).to.be.a(GitHubV3RestApi.UsersGetAuthenticated200Response);
    });
    ...
    it('should have the property businessPlus (base name: "business_plus")', function() {
      // uncomment below and update the code to test the property businessPlus
      //var instance = new GitHubV3RestApi.UsersGetAuthenticated200Response();
      //expect(instance).to.be();
    });
    ...
    it('should have the property twoFactorAuthentication (base name: "two_factor_authentication")', function() {
      // uncomment below and update the code to test the property twoFactorAuthentication
      //var instance = new GitHubV3RestApi.UsersGetAuthenticated200Response();
      //expect(instance).to.be();
    });
