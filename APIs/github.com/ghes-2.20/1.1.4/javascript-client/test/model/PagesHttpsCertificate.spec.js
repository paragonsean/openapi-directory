...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.PagesHttpsCertificate();
  });
  ...
  describe('PagesHttpsCertificate', function() {
    it('should create an instance of PagesHttpsCertificate', function() {
      // uncomment below and update the code to test PagesHttpsCertificate
      //var instance = new GitHubV3RestApi.PagesHttpsCertificate();
      //expect(instance).to.be.a(GitHubV3RestApi.PagesHttpsCertificate);
    });
