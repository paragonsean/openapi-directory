...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.CommitParentsInner();
  });
  ...
  describe('CommitParentsInner', function() {
    it('should create an instance of CommitParentsInner', function() {
      // uncomment below and update the code to test CommitParentsInner
      //var instance = new GitHubV3RestApi.CommitParentsInner();
      //expect(instance).to.be.a(GitHubV3RestApi.CommitParentsInner);
    });
