...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.NullableTeamSimple();
  });
  ...
  describe('NullableTeamSimple', function() {
    it('should create an instance of NullableTeamSimple', function() {
      // uncomment below and update the code to test NullableTeamSimple
      //var instance = new GitHubV3RestApi.NullableTeamSimple();
      //expect(instance).to.be.a(GitHubV3RestApi.NullableTeamSimple);
    });
