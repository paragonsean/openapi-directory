...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GitHubV3RestApi.RemovedFromProjectIssueEvent();
  });
  ...
  describe('RemovedFromProjectIssueEvent', function() {
    it('should create an instance of RemovedFromProjectIssueEvent', function() {
      // uncomment below and update the code to test RemovedFromProjectIssueEvent
      //var instance = new GitHubV3RestApi.RemovedFromProjectIssueEvent();
      //expect(instance).to.be.a(GitHubV3RestApi.RemovedFromProjectIssueEvent);
    });
