...
class MinimalRepository {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('code_of_conduct')) {
                obj['code_of_conduct'] = CodeOfConduct.constructFromObject(data['code_of_conduct']);
            }
            ...
            if (data.hasOwnProperty('license')) {
                obj['license'] = MinimalRepositoryLicense.constructFromObject(data['license']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MinimalRepository</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MinimalRepository</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MinimalRepository.RequiredProperties) {
        ...
        if (data['code_of_conduct']) { // data not null
          CodeOfConduct.validateJSON(data['code_of_conduct']);
        }
        // ensure the json data is a string
        ...
        if (data['license']) { // data not null
          MinimalRepositoryLicense.validateJSON(data['license']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/CodeOfConduct} code_of_conduct
 */
MinimalRepository.prototype['code_of_conduct'] = undefined;
...
export default MinimalRepository;
