...
import InstallationGhes2Account from './InstallationGhes2Account';
import InstallationGhes2Permissions from './InstallationGhes2Permissions';
import NullableSimpleUser from './NullableSimpleUser';

/**
 * The InstallationGhes2 model module.
 * @module model/InstallationGhes2
 * @version 1.1.4
 */
class InstallationGhes2 {
    /**
     * Constructs a new <code>InstallationGhes2</code>.
     * Installation
     * @alias module:model/InstallationGhes2
     * @param accessTokensUrl {String} 
     * @param account {module:model/InstallationGhes2Account} 
     * @param appId {Number} 
     ...
     * @param permissions {module:model/InstallationGhes2Permissions} 
     * @param repositoriesUrl {String} 
     * @param repositorySelection {module:model/InstallationGhes2.RepositorySelectionEnum} Describe whether all repositories have been selected or there's a selection involved
    ...
    constructor(accessTokensUrl, account, appId, appSlug, createdAt, events, htmlUrl, id, permissions, repositoriesUrl, repositorySelection, singleFileName, targetId, targetType, updatedAt) { 
        ...
        InstallationGhes2.initialize(this, accessTokensUrl, account, appId, appSlug, createdAt, events, htmlUrl, id, permissions, repositoriesUrl, repositorySelection, singleFileName, targetId, targetType, updatedAt);
    }
    ...
    /**
     * Constructs a <code>InstallationGhes2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InstallationGhes2} obj Optional instance to populate.
     * @return {module:model/InstallationGhes2} The populated <code>InstallationGhes2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InstallationGhes2();
            ...
            if (data.hasOwnProperty('account')) {
                obj['account'] = InstallationGhes2Account.constructFromObject(data['account']);
            }
            ...
            if (data.hasOwnProperty('permissions')) {
                obj['permissions'] = InstallationGhes2Permissions.constructFromObject(data['permissions']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InstallationGhes2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstallationGhes2</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of InstallationGhes2.RequiredProperties) {
        ...
        if (data['account']) { // data not null
          InstallationGhes2Account.validateJSON(data['account']);
        }
        // ensure the json data is a string
        ...
        if (data['permissions']) { // data not null
          InstallationGhes2Permissions.validateJSON(data['permissions']);
        }
        // ensure the json data is a string
...
InstallationGhes2.RequiredProperties = ["access_tokens_url", "account", "app_id", "app_slug", "created_at", "events", "html_url", "id", "permissions", "repositories_url", "repository_selection", "single_file_name", "target_id", "target_type", "updated_at"];

/**
 * @member {String} access_tokens_url
 */
InstallationGhes2.prototype['access_tokens_url'] = undefined;

/**
 * @member {module:model/InstallationGhes2Account} account
 */
InstallationGhes2.prototype['account'] = undefined;

/**
 * @member {Number} app_id
 */
InstallationGhes2.prototype['app_id'] = undefined;

/**
 * @member {String} app_slug
 */
InstallationGhes2.prototype['app_slug'] = undefined;

/**
 * @member {String} contact_email
 */
InstallationGhes2.prototype['contact_email'] = undefined;

/**
 * @member {Date} created_at
 */
InstallationGhes2.prototype['created_at'] = undefined;

/**
 * @member {Array.<String>} events
 */
InstallationGhes2.prototype['events'] = undefined;

/**
 * @member {String} html_url
 */
InstallationGhes2.prototype['html_url'] = undefined;

/**
 * The ID of the installation.
 * @member {Number} id
 */
InstallationGhes2.prototype['id'] = undefined;

/**
 * @member {module:model/InstallationGhes2Permissions} permissions
 */
InstallationGhes2.prototype['permissions'] = undefined;

/**
 * @member {String} repositories_url
 */
InstallationGhes2.prototype['repositories_url'] = undefined;

/**
 * Describe whether all repositories have been selected or there's a selection involved
 * @member {module:model/InstallationGhes2.RepositorySelectionEnum} repository_selection
 */
InstallationGhes2.prototype['repository_selection'] = undefined;

/**
 * @member {String} single_file_name
 */
InstallationGhes2.prototype['single_file_name'] = undefined;

/**
 * @member {Date} suspended_at
 */
InstallationGhes2.prototype['suspended_at'] = undefined;

/**
 * @member {module:model/NullableSimpleUser} suspended_by
 */
InstallationGhes2.prototype['suspended_by'] = undefined;

/**
 * The ID of the user or organization this token is being scoped to.
 * @member {Number} target_id
 */
InstallationGhes2.prototype['target_id'] = undefined;

/**
 * @member {String} target_type
 */
InstallationGhes2.prototype['target_type'] = undefined;

/**
 * @member {Date} updated_at
 */
InstallationGhes2.prototype['updated_at'] = undefined;
 ...
 * @readonly
 */
InstallationGhes2['RepositorySelectionEnum'] = {
...
export default InstallationGhes2;
