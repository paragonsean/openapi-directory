...
public class Release {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assets, assetsUrl, author, body, bodyHtml, bodyText, createdAt, draft, htmlUrl, id, name, nodeId, prerelease, publishedAt, reactions, tagName, tarballUrl, targetCommitish, uploadUrl, url, zipballUrl);
  }
