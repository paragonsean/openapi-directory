...
public class UnlabeledIssueEvent {
  ...
  public UnlabeledIssueEvent id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actor, unlabeledIssueEvent.actor) &&
        ...
        Objects.equals(this.id, unlabeledIssueEvent.id) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnlabeledIssueEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnlabeledIssueEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnlabeledIssueEvent is not found in the empty JSON string", UnlabeledIssueEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnlabeledIssueEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnlabeledIssueEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnlabeledIssueEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnlabeledIssueEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnlabeledIssueEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnlabeledIssueEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnlabeledIssueEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<UnlabeledIssueEvent>() {
           @Override
           public void write(JsonWriter out, UnlabeledIssueEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnlabeledIssueEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnlabeledIssueEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnlabeledIssueEvent
   * @throws IOException if the JSON string is invalid with respect to UnlabeledIssueEvent
   */
  public static UnlabeledIssueEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnlabeledIssueEvent.class);
  }

  /**
   * Convert an instance of UnlabeledIssueEvent to an JSON string
   *
   * @return JSON string
   */
