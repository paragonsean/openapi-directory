...
public class IssueSimple {
  ...
  public IssueSimple activeLockReason(String activeLockReason) {
  ...
  public IssueSimple assignee(NullableSimpleUser assignee) {
  ...
  public IssueSimple assignees(List<SimpleUser> assignees) {
    this.assignees = assignees;
    return this;
  }

  public IssueSimple addAssigneesItem(SimpleUser assigneesItem) {
  ...
  public IssueSimple authorAssociation(AuthorAssociation authorAssociation) {
  ...
  public IssueSimple body(String body) {
    this.body = body;
    return this;
  }
  ...
  public IssueSimple bodyHtml(String bodyHtml) {
  ...
  public IssueSimple bodyText(String bodyText) {
  ...
  public IssueSimple closedAt(OffsetDateTime closedAt) {
  ...
  public IssueSimple comments(Integer comments) {
  ...
  public IssueSimple commentsUrl(URI commentsUrl) {
  ...
  public IssueSimple createdAt(OffsetDateTime createdAt) {
  ...
  public IssueSimple eventsUrl(URI eventsUrl) {
  ...
  public IssueSimple htmlUrl(URI htmlUrl) {
  ...
  public IssueSimple id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public IssueSimple labels(List<Label> labels) {
    this.labels = labels;
    return this;
  }

  public IssueSimple addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  public IssueSimple labelsUrl(String labelsUrl) {
  ...
  public IssueSimple locked(Boolean locked) {
    this.locked = locked;
    return this;
  }
  ...
  public IssueSimple milestone(NullableMilestone milestone) {
  ...
  public IssueSimple nodeId(String nodeId) {
    this.nodeId = nodeId;
    return this;
  }
  ...
  public IssueSimple number(Integer number) {
    this.number = number;
    return this;
  }
  ...
  public IssueSimple performedViaGithubApp(NullableIntegration performedViaGithubApp) {
  ...
  public IssueSimple pullRequest(IssuePullRequest pullRequest) {
  ...
  public IssueSimple repository(Repository repository) {
  ...
  public IssueSimple repositoryUrl(URI repositoryUrl) {
  ...
  public IssueSimple state(String state) {
    this.state = state;
    return this;
  }
  ...
  public IssueSimple timelineUrl(URI timelineUrl) {
  ...
  public IssueSimple title(String title) {
    this.title = title;
    return this;
  }
  ...
  public IssueSimple updatedAt(OffsetDateTime updatedAt) {
  ...
  public IssueSimple url(URI url) {
    this.url = url;
    return this;
  }
  ...
  public IssueSimple user(NullableSimpleUser user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IssueSimple issueSimple = (IssueSimple) o;
    return Objects.equals(this.activeLockReason, issueSimple.activeLockReason) &&
        Objects.equals(this.assignee, issueSimple.assignee) &&
        Objects.equals(this.assignees, issueSimple.assignees) &&
        Objects.equals(this.authorAssociation, issueSimple.authorAssociation) &&
        Objects.equals(this.body, issueSimple.body) &&
        Objects.equals(this.bodyHtml, issueSimple.bodyHtml) &&
        Objects.equals(this.bodyText, issueSimple.bodyText) &&
        Objects.equals(this.closedAt, issueSimple.closedAt) &&
        Objects.equals(this.comments, issueSimple.comments) &&
        Objects.equals(this.commentsUrl, issueSimple.commentsUrl) &&
        Objects.equals(this.createdAt, issueSimple.createdAt) &&
        Objects.equals(this.eventsUrl, issueSimple.eventsUrl) &&
        Objects.equals(this.htmlUrl, issueSimple.htmlUrl) &&
        Objects.equals(this.id, issueSimple.id) &&
        Objects.equals(this.labels, issueSimple.labels) &&
        Objects.equals(this.labelsUrl, issueSimple.labelsUrl) &&
        Objects.equals(this.locked, issueSimple.locked) &&
        Objects.equals(this.milestone, issueSimple.milestone) &&
        Objects.equals(this.nodeId, issueSimple.nodeId) &&
        Objects.equals(this.number, issueSimple.number) &&
        Objects.equals(this.performedViaGithubApp, issueSimple.performedViaGithubApp) &&
        Objects.equals(this.pullRequest, issueSimple.pullRequest) &&
        Objects.equals(this.repository, issueSimple.repository) &&
        Objects.equals(this.repositoryUrl, issueSimple.repositoryUrl) &&
        Objects.equals(this.state, issueSimple.state) &&
        Objects.equals(this.timelineUrl, issueSimple.timelineUrl) &&
        Objects.equals(this.title, issueSimple.title) &&
        Objects.equals(this.updatedAt, issueSimple.updatedAt) &&
        Objects.equals(this.url, issueSimple.url) &&
        Objects.equals(this.user, issueSimple.user);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeLockReason, assignee, assignees, authorAssociation, body, bodyHtml, bodyText, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels, labelsUrl, locked, milestone, nodeId, number, performedViaGithubApp, pullRequest, repository, repositoryUrl, state, timelineUrl, title, updatedAt, url, user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to IssueSimple
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IssueSimple.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IssueSimple is not found in the empty JSON string", IssueSimple.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IssueSimple.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssueSimple` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IssueSimple.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IssueSimple.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IssueSimple' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IssueSimple> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IssueSimple.class));

       return (TypeAdapter<T>) new TypeAdapter<IssueSimple>() {
           @Override
           public void write(JsonWriter out, IssueSimple value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IssueSimple read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IssueSimple given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IssueSimple
   * @throws IOException if the JSON string is invalid with respect to IssueSimple
   */
  public static IssueSimple fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IssueSimple.class);
  }

  /**
   * Convert an instance of IssueSimple to an JSON string
   *
   * @return JSON string
   */
