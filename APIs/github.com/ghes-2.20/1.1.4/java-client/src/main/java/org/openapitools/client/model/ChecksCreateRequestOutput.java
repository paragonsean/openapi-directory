...
public class ChecksCreateRequestOutput {
  ...
  /**
   * Adds images to the output displayed in the GitHub pull request UI. See the [&#x60;images&#x60; object](https://docs.github.com/enterprise-server@2.20/rest/reference/checks#images-object) description for details.
   * @return images
   */
  @javax.annotation.Nullable
