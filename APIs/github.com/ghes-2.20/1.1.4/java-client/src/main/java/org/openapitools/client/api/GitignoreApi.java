...
public class GitignoreApi {
     ...
     * @see <a href="https://docs.github.com/enterprise-server@2.20/rest/reference/gitignore#get-all-gitignore-templates">Get all gitignore templates Documentation</a>
     */
     ...
     * API method documentation
     * @see <a href="https://docs.github.com/enterprise-server@2.20/rest/reference/gitignore#get-a-gitignore-template">Get a gitignore template Documentation</a>
     */
     ...
     * The API also allows fetching the source of a single template. Use the raw [media type](https://docs.github.com/enterprise-server@2.20/rest/overview/media-types/) to get the raw contents.
     * @param name  (required)
