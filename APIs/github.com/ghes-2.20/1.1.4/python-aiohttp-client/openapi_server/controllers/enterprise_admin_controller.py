...
async def enterprise_admin_create_enterprise_server_license(request: web.Request, license, password=None, settings=None) -> web.Response:
    ...
    :type password: str
    :param settings: An optional JSON string containing the installation settings. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.20/rest/reference/enterprise-admin#get-settings).
    :type settings: str
...
async def enterprise_admin_create_impersonation_o_auth_token(request: web.Request, username, body=None) -> web.Response:
...
async def enterprise_admin_create_org(request: web.Request, body=None) -> web.Response:
...
async def enterprise_admin_set_settings(request: web.Request, settings) -> web.Response:
    ...
    :param settings: A JSON string with the new settings. Note that you only need to pass the specific settings you want to modify. For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.20/rest/reference/enterprise-admin#get-settings).
    :type settings: str
...
async def enterprise_admin_update_ldap_mapping_for_team(request: web.Request, team_id, body=None) -> web.Response:
...
async def enterprise_admin_update_ldap_mapping_for_user(request: web.Request, username, body=None) -> web.Response:
