...
async def reactions_list_for_commit_comment(request: web.Request, owner, repo, comment_id, content=None, per_page=None, page=None) -> web.Response:
    ...
    :param comment_id: comment_id parameter
    :type comment_id: int
    :param content: Returns a single [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a commit comment.
    :type content: str
...
async def reactions_list_for_issue(request: web.Request, owner, repo, issue_number, content=None, per_page=None, page=None) -> web.Response:
    ...
    :param issue_number: issue_number parameter
    :type issue_number: int
    :param content: Returns a single [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue.
    :type content: str
    :param per_page: Results per page (max 100)
    :type per_page: int
    :param page: Page number of the results to fetch.
...
async def reactions_list_for_issue_comment(request: web.Request, owner, repo, comment_id, content=None, per_page=None, page=None) -> web.Response:
    ...
    :param comment_id: comment_id parameter
    :type comment_id: int
    :param content: Returns a single [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue comment.
    :type content: str
    :param per_page: Results per page (max 100)
    :type per_page: int
    :param page: Page number of the results to fetch.
...
async def reactions_list_for_pull_request_review_comment(request: web.Request, owner, repo, comment_id, content=None, per_page=None, page=None) -> web.Response:
    ...
    :param comment_id: comment_id parameter
    :type comment_id: int
    :param content: Returns a single [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a pull request review comment.
    :type content: str
    :param per_page: Results per page (max 100)
    :type per_page: int
    :param page: Page number of the results to fetch.
...
async def reactions_list_for_team_discussion(request: web.Request, accept, team_id, discussion_number, content=None, per_page=None, page=None) -> web.Response:
    ...
    :param discussion_number: 
    :type discussion_number: int
    :param content: Returns a single [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion.
    :type content: str
    :param per_page: Results per page (max 100)
    :type per_page: int
    :param page: Page number of the results to fetch.
...
async def reactions_list_for_team_discussion_comment(request: web.Request, accept, team_id, discussion_number, comment_number, content=None, per_page=None, page=None) -> web.Response:
    ...
    :param comment_number: 
    :type comment_number: int
    :param content: Returns a single [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to a team discussion comment.
    :type content: str
    :param per_page: Results per page (max 100)
    :type per_page: int
    :param page: Page number of the results to fetch.
