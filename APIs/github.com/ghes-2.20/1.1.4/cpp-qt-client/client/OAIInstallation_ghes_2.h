...
/*
 * OAIInstallation_ghes_2.h
 *
 * Installation
 */

#ifndef OAIInstallation_ghes_2_H
#define OAIInstallation_ghes_2_H
...
namespace OpenAPI {
class OAIInstallation_ghes_2_account;
class OAIInstallation_ghes_2_permissions;
class OAINullable_simple_user;

class OAIInstallation_ghes_2 : public OAIObject {
public:
    OAIInstallation_ghes_2();
    OAIInstallation_ghes_2(QString json);
    ~OAIInstallation_ghes_2() override;
    ...
    OAIInstallation_ghes_2_account getAccount() const;
    void setAccount(const OAIInstallation_ghes_2_account &account);
    ...
    OAIInstallation_ghes_2_permissions getPermissions() const;
    void setPermissions(const OAIInstallation_ghes_2_permissions &permissions);
...
private:
    ...
    OAIInstallation_ghes_2_account m_account;
    ...
    OAIInstallation_ghes_2_permissions m_permissions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstallation_ghes_2)

#endif // OAIInstallation_ghes_2_H
