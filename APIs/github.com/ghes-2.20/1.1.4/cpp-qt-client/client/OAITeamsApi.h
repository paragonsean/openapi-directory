...
public:
    ...
    */
    virtual void teams_createDiscussion(const qint32 &team_id, const OAITeams_create_discussion_request &oai_teams_create_discussion_request);
    ...
    */
    virtual void teams_createDiscussionComment(const qint32 &team_id, const qint32 &discussion_number, const OAITeams_create_discussion_comment_request &oai_teams_create_discussion_comment_request);
    ...
    * @param[in]  discussion_number qint32 [required]
    */
    virtual void teams_deleteDiscussion(const qint32 &team_id, const qint32 &discussion_number);
    ...
    */
    virtual void teams_deleteDiscussionComment(const qint32 &team_id, const qint32 &discussion_number, const qint32 &comment_number);
    ...
    * @param[in]  discussion_number qint32 [required]
    */
    virtual void teams_getDiscussion(const qint32 &team_id, const qint32 &discussion_number);
    ...
    * @param[in]  comment_number qint32 [required]
    */
    virtual void teams_getDiscussionComment(const qint32 &team_id, const qint32 &discussion_number, const qint32 &comment_number);
    ...
    * @param[in]  page qint32 [optional]
    */
    virtual void teams_listDiscussions(const qint32 &team_id, const ::OpenAPI::OptionalParam<QString> &direction = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &per_page = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &page = ::OpenAPI::OptionalParam<qint32>());
    ...
    */
    virtual void teams_updateDiscussion(const qint32 &team_id, const qint32 &discussion_number, const ::OpenAPI::OptionalParam<OAITeams_update_discussion_request> &oai_teams_update_discussion_request = ::OpenAPI::OptionalParam<OAITeams_update_discussion_request>());
    ...
    * @param[in]  oai_teams_create_discussion_comment_request OAITeams_create_discussion_comment_request [required]
    */
    virtual void teams_updateDiscussionComment(const qint32 &team_id, const qint32 &discussion_number, const qint32 &comment_number, const OAITeams_create_discussion_comment_request &oai_teams_create_discussion_comment_request);
