...
/*
 * OAIUsers_get_authenticated_200_response.h
 *
 * 
 */

#ifndef OAIUsers_get_authenticated_200_response_H
#define OAIUsers_get_authenticated_200_response_H
...
class OAIUsers_get_authenticated_200_response : public OAIObject {
public:
    OAIUsers_get_authenticated_200_response();
    OAIUsers_get_authenticated_200_response(QString json);
    ~OAIUsers_get_authenticated_200_response() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUsers_get_authenticated_200_response)

#endif // OAIUsers_get_authenticated_200_response_H
