...
class OAIRepository;
class OAIFull_repository_permissions;
...
public:
    ...
    OAIFull_repository_permissions getPermissions() const;
    void setPermissions(const OAIFull_repository_permissions &permissions);
...
private:
    ...
    OAIFull_repository_permissions m_permissions;
