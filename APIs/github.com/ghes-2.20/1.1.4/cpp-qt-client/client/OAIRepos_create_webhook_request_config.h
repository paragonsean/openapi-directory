...
/*
 * OAIRepos_create_webhook_request_config.h
 *
...
#ifndef OAIRepos_create_webhook_request_config_H
#define OAIRepos_create_webhook_request_config_H
...
class OAIRepos_create_webhook_request_config : public OAIObject {
public:
    OAIRepos_create_webhook_request_config();
    OAIRepos_create_webhook_request_config(QString json);
    ~OAIRepos_create_webhook_request_config() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRepos_create_webhook_request_config)

#endif // OAIRepos_create_webhook_request_config_H
