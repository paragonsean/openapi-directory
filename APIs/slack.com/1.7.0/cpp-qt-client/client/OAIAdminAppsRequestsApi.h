...
#ifndef OAI_OAIAdminAppsRequestsApi_H
#define OAI_OAIAdminAppsRequestsApi_H
...
class OAIAdminAppsRequestsApi : public QObject {
    Q_OBJECT

public:
    OAIAdminAppsRequestsApi(const int timeOut = 0);
    ~OAIAdminAppsRequestsApi();
