...
/*
 * OAIConversations_info_success_schema.h
 *
 * Schema for successful response conversations.info
 */

#ifndef OAIConversations_info_success_schema_H
#define OAIConversations_info_success_schema_H
...
class OAIConversations_info_success_schema : public OAIObject {
public:
    OAIConversations_info_success_schema();
    OAIConversations_info_success_schema(QString json);
    ~OAIConversations_info_success_schema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_info_success_schema)

#endif // OAIConversations_info_success_schema_H
