...
OAIObjs_user_inner_anyOf::OAIObjs_user_inner_anyOf(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjs_user_inner_anyOf::OAIObjs_user_inner_anyOf() {
    this->initializeModel();
}

OAIObjs_user_inner_anyOf::~OAIObjs_user_inner_anyOf() {}

void OAIObjs_user_inner_anyOf::initializeModel() {
...
void OAIObjs_user_inner_anyOf::fromJson(QString jsonString) {
...
void OAIObjs_user_inner_anyOf::fromJsonObject(QJsonObject json) {
...
QString OAIObjs_user_inner_anyOf::asJson() const {
...
QJsonObject OAIObjs_user_inner_anyOf::asJsonObject() const {
    QJsonObject obj;
    if (m_color_isSet) {
...
QString OAIObjs_user_inner_anyOf::getColor() const {
    return m_color;
}
void OAIObjs_user_inner_anyOf::setColor(const QString &color) {
    m_color = color;
    m_color_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_color_Set() const{
    return m_color_isSet;
}

bool OAIObjs_user_inner_anyOf::is_color_Valid() const{
    return m_color_isValid;
}

bool OAIObjs_user_inner_anyOf::isDeleted() const {
    return m_deleted;
}
void OAIObjs_user_inner_anyOf::setDeleted(const bool &deleted) {
    m_deleted = deleted;
    m_deleted_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_deleted_Set() const{
    return m_deleted_isSet;
}

bool OAIObjs_user_inner_anyOf::is_deleted_Valid() const{
    return m_deleted_isValid;
}

OAIObjs_enterprise_user OAIObjs_user_inner_anyOf::getEnterpriseUser() const {
    return m_enterprise_user;
}
void OAIObjs_user_inner_anyOf::setEnterpriseUser(const OAIObjs_enterprise_user &enterprise_user) {
    m_enterprise_user = enterprise_user;
    m_enterprise_user_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_enterprise_user_Set() const{
    return m_enterprise_user_isSet;
}

bool OAIObjs_user_inner_anyOf::is_enterprise_user_Valid() const{
    return m_enterprise_user_isValid;
}

bool OAIObjs_user_inner_anyOf::isHas2fa() const {
    return m_has_2fa;
}
void OAIObjs_user_inner_anyOf::setHas2fa(const bool &has_2fa) {
    m_has_2fa = has_2fa;
    m_has_2fa_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_has_2fa_Set() const{
    return m_has_2fa_isSet;
}

bool OAIObjs_user_inner_anyOf::is_has_2fa_Valid() const{
    return m_has_2fa_isValid;
}

QString OAIObjs_user_inner_anyOf::getId() const {
    return m_id;
}
void OAIObjs_user_inner_anyOf::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_id_Set() const{
    return m_id_isSet;
}

bool OAIObjs_user_inner_anyOf::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsAdmin() const {
    return m_is_admin;
}
void OAIObjs_user_inner_anyOf::setIsAdmin(const bool &is_admin) {
    m_is_admin = is_admin;
    m_is_admin_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_admin_Set() const{
    return m_is_admin_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_admin_Valid() const{
    return m_is_admin_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsAppUser() const {
    return m_is_app_user;
}
void OAIObjs_user_inner_anyOf::setIsAppUser(const bool &is_app_user) {
    m_is_app_user = is_app_user;
    m_is_app_user_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_app_user_Set() const{
    return m_is_app_user_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_app_user_Valid() const{
    return m_is_app_user_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsBot() const {
    return m_is_bot;
}
void OAIObjs_user_inner_anyOf::setIsBot(const bool &is_bot) {
    m_is_bot = is_bot;
    m_is_bot_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_bot_Set() const{
    return m_is_bot_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_bot_Valid() const{
    return m_is_bot_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsExternal() const {
    return m_is_external;
}
void OAIObjs_user_inner_anyOf::setIsExternal(const bool &is_external) {
    m_is_external = is_external;
    m_is_external_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_external_Set() const{
    return m_is_external_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_external_Valid() const{
    return m_is_external_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsForgotten() const {
    return m_is_forgotten;
}
void OAIObjs_user_inner_anyOf::setIsForgotten(const bool &is_forgotten) {
    m_is_forgotten = is_forgotten;
    m_is_forgotten_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_forgotten_Set() const{
    return m_is_forgotten_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_forgotten_Valid() const{
    return m_is_forgotten_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsInvitedUser() const {
    return m_is_invited_user;
}
void OAIObjs_user_inner_anyOf::setIsInvitedUser(const bool &is_invited_user) {
    m_is_invited_user = is_invited_user;
    m_is_invited_user_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_invited_user_Set() const{
    return m_is_invited_user_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_invited_user_Valid() const{
    return m_is_invited_user_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsOwner() const {
    return m_is_owner;
}
void OAIObjs_user_inner_anyOf::setIsOwner(const bool &is_owner) {
    m_is_owner = is_owner;
    m_is_owner_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_owner_Set() const{
    return m_is_owner_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_owner_Valid() const{
    return m_is_owner_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsPrimaryOwner() const {
    return m_is_primary_owner;
}
void OAIObjs_user_inner_anyOf::setIsPrimaryOwner(const bool &is_primary_owner) {
    m_is_primary_owner = is_primary_owner;
    m_is_primary_owner_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_primary_owner_Set() const{
    return m_is_primary_owner_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_primary_owner_Valid() const{
    return m_is_primary_owner_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsRestricted() const {
    return m_is_restricted;
}
void OAIObjs_user_inner_anyOf::setIsRestricted(const bool &is_restricted) {
    m_is_restricted = is_restricted;
    m_is_restricted_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_restricted_Set() const{
    return m_is_restricted_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_restricted_Valid() const{
    return m_is_restricted_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsStranger() const {
    return m_is_stranger;
}
void OAIObjs_user_inner_anyOf::setIsStranger(const bool &is_stranger) {
    m_is_stranger = is_stranger;
    m_is_stranger_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_stranger_Set() const{
    return m_is_stranger_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_stranger_Valid() const{
    return m_is_stranger_isValid;
}

bool OAIObjs_user_inner_anyOf::isIsUltraRestricted() const {
    return m_is_ultra_restricted;
}
void OAIObjs_user_inner_anyOf::setIsUltraRestricted(const bool &is_ultra_restricted) {
    m_is_ultra_restricted = is_ultra_restricted;
    m_is_ultra_restricted_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_is_ultra_restricted_Set() const{
    return m_is_ultra_restricted_isSet;
}

bool OAIObjs_user_inner_anyOf::is_is_ultra_restricted_Valid() const{
    return m_is_ultra_restricted_isValid;
}

QString OAIObjs_user_inner_anyOf::getLocale() const {
    return m_locale;
}
void OAIObjs_user_inner_anyOf::setLocale(const QString &locale) {
    m_locale = locale;
    m_locale_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_locale_Set() const{
    return m_locale_isSet;
}

bool OAIObjs_user_inner_anyOf::is_locale_Valid() const{
    return m_locale_isValid;
}

QString OAIObjs_user_inner_anyOf::getName() const {
    return m_name;
}
void OAIObjs_user_inner_anyOf::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_name_Set() const{
    return m_name_isSet;
}

bool OAIObjs_user_inner_anyOf::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIObjs_user_inner_anyOf::getPresence() const {
    return m_presence;
}
void OAIObjs_user_inner_anyOf::setPresence(const QString &presence) {
    m_presence = presence;
    m_presence_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_presence_Set() const{
    return m_presence_isSet;
}

bool OAIObjs_user_inner_anyOf::is_presence_Valid() const{
    return m_presence_isValid;
}

OAIObjs_user_profile OAIObjs_user_inner_anyOf::getProfile() const {
    return m_profile;
}
void OAIObjs_user_inner_anyOf::setProfile(const OAIObjs_user_profile &profile) {
    m_profile = profile;
    m_profile_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_profile_Set() const{
    return m_profile_isSet;
}

bool OAIObjs_user_inner_anyOf::is_profile_Valid() const{
    return m_profile_isValid;
}

QString OAIObjs_user_inner_anyOf::getRealName() const {
    return m_real_name;
}
void OAIObjs_user_inner_anyOf::setRealName(const QString &real_name) {
    m_real_name = real_name;
    m_real_name_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_real_name_Set() const{
    return m_real_name_isSet;
}

bool OAIObjs_user_inner_anyOf::is_real_name_Valid() const{
    return m_real_name_isValid;
}

QString OAIObjs_user_inner_anyOf::getTeam() const {
    return m_team;
}
void OAIObjs_user_inner_anyOf::setTeam(const QString &team) {
    m_team = team;
    m_team_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_team_Set() const{
    return m_team_isSet;
}

bool OAIObjs_user_inner_anyOf::is_team_Valid() const{
    return m_team_isValid;
}

QString OAIObjs_user_inner_anyOf::getTeamId() const {
    return m_team_id;
}
void OAIObjs_user_inner_anyOf::setTeamId(const QString &team_id) {
    m_team_id = team_id;
    m_team_id_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_team_id_Set() const{
    return m_team_id_isSet;
}

bool OAIObjs_user_inner_anyOf::is_team_id_Valid() const{
    return m_team_id_isValid;
}

OAIObjs_user_inner_anyOf_team_profile OAIObjs_user_inner_anyOf::getTeamProfile() const {
    return m_team_profile;
}
void OAIObjs_user_inner_anyOf::setTeamProfile(const OAIObjs_user_inner_anyOf_team_profile &team_profile) {
    m_team_profile = team_profile;
    m_team_profile_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_team_profile_Set() const{
    return m_team_profile_isSet;
}

bool OAIObjs_user_inner_anyOf::is_team_profile_Valid() const{
    return m_team_profile_isValid;
}

QString OAIObjs_user_inner_anyOf::getTwoFactorType() const {
    return m_two_factor_type;
}
void OAIObjs_user_inner_anyOf::setTwoFactorType(const QString &two_factor_type) {
    m_two_factor_type = two_factor_type;
    m_two_factor_type_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_two_factor_type_Set() const{
    return m_two_factor_type_isSet;
}

bool OAIObjs_user_inner_anyOf::is_two_factor_type_Valid() const{
    return m_two_factor_type_isValid;
}

QList<OAIObjs_team_discoverable_inner> OAIObjs_user_inner_anyOf::getTz() const {
    return m_tz;
}
void OAIObjs_user_inner_anyOf::setTz(const QList<OAIObjs_team_discoverable_inner> &tz) {
    m_tz = tz;
    m_tz_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_tz_Set() const{
    return m_tz_isSet;
}

bool OAIObjs_user_inner_anyOf::is_tz_Valid() const{
    return m_tz_isValid;
}

QString OAIObjs_user_inner_anyOf::getTzLabel() const {
    return m_tz_label;
}
void OAIObjs_user_inner_anyOf::setTzLabel(const QString &tz_label) {
    m_tz_label = tz_label;
    m_tz_label_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_tz_label_Set() const{
    return m_tz_label_isSet;
}

bool OAIObjs_user_inner_anyOf::is_tz_label_Valid() const{
    return m_tz_label_isValid;
}

double OAIObjs_user_inner_anyOf::getTzOffset() const {
    return m_tz_offset;
}
void OAIObjs_user_inner_anyOf::setTzOffset(const double &tz_offset) {
    m_tz_offset = tz_offset;
    m_tz_offset_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_tz_offset_Set() const{
    return m_tz_offset_isSet;
}

bool OAIObjs_user_inner_anyOf::is_tz_offset_Valid() const{
    return m_tz_offset_isValid;
}

double OAIObjs_user_inner_anyOf::getUpdated() const {
    return m_updated;
}
void OAIObjs_user_inner_anyOf::setUpdated(const double &updated) {
    m_updated = updated;
    m_updated_isSet = true;
}

bool OAIObjs_user_inner_anyOf::is_updated_Set() const{
    return m_updated_isSet;
}

bool OAIObjs_user_inner_anyOf::is_updated_Valid() const{
    return m_updated_isValid;
}

bool OAIObjs_user_inner_anyOf::isSet() const {
...
bool OAIObjs_user_inner_anyOf::isValid() const {
