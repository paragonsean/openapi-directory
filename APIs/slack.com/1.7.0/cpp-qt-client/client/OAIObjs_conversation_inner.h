...
/*
 * OAIObjs_conversation_inner.h
 *
 * 
 */

#ifndef OAIObjs_conversation_inner_H
#define OAIObjs_conversation_inner_H
...
class OAIObjs_conversation_inner : public OAIObject {
public:
    OAIObjs_conversation_inner();
    OAIObjs_conversation_inner(QString json);
    ~OAIObjs_conversation_inner() override;
    ...
    bool isIsGlobalShared() const;
    void setIsGlobalShared(const bool &is_global_shared);
    bool is_is_global_shared_Set() const;
    bool is_is_global_shared_Valid() const;
    ...
    bool isIsOrgDefault() const;
    void setIsOrgDefault(const bool &is_org_default);
    bool is_is_org_default_Set() const;
    bool is_is_org_default_Valid() const;

    bool isIsOrgMandatory() const;
    void setIsOrgMandatory(const bool &is_org_mandatory);
    bool is_is_org_mandatory_Set() const;
    bool is_is_org_mandatory_Valid() const;
...
private:
    ...
    bool m_is_global_shared;
    bool m_is_global_shared_isSet;
    bool m_is_global_shared_isValid;
    ...
    bool m_is_org_default;
    bool m_is_org_default_isSet;
    bool m_is_org_default_isValid;

    bool m_is_org_mandatory;
    bool m_is_org_mandatory_isSet;
    bool m_is_org_mandatory_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjs_conversation_inner)

#endif // OAIObjs_conversation_inner_H
