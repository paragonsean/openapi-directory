...
/*
 * OAIConversations_open_success_schema_channel_inner.h
 *
 * 
 */

#ifndef OAIConversations_open_success_schema_channel_inner_H
#define OAIConversations_open_success_schema_channel_inner_H
...
class OAIConversations_open_success_schema_channel_inner : public OAIObject {
public:
    OAIConversations_open_success_schema_channel_inner();
    OAIConversations_open_success_schema_channel_inner(QString json);
    ~OAIConversations_open_success_schema_channel_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_open_success_schema_channel_inner)

#endif // OAIConversations_open_success_schema_channel_inner_H
