...
/*
 * OAIConversations_invite_error_schema.h
 *
 * Schema for successful response from conversations.invite method
 */

#ifndef OAIConversations_invite_error_schema_H
#define OAIConversations_invite_error_schema_H
...
class OAIConversations_invite_error_schema : public OAIObject {
public:
    OAIConversations_invite_error_schema();
    OAIConversations_invite_error_schema(QString json);
    ~OAIConversations_invite_error_schema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversations_invite_error_schema)

#endif // OAIConversations_invite_error_schema_H
