...
/*
 * OAIConversation_object.h
 *
 * 
 */

#ifndef OAIConversation_object_H
#define OAIConversation_object_H
...
class OAIConversation_object : public OAIObject {
public:
    OAIConversation_object();
    OAIConversation_object(QString json);
    ~OAIConversation_object() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversation_object)

#endif // OAIConversation_object_H
