...
void OAIAuthApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("authRevoke", defaultConf);
    _serverIndices.insert("authRevoke", 0);
    _serverConfigs.insert("authTest", defaultConf);
    _serverIndices.insert("authTest", 0);
}
...
void OAIAuthApi::authRevoke(const QString &token, const ::OpenAPI::OptionalParam<bool> &test) {
    QString fullPath = QString(_serverConfigs["authRevoke"][_serverIndices.value("authRevoke")].URL()+"/auth.revoke");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authRevokeCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authRevokeCallback);
...
void OAIAuthApi::authRevokeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIAuth_revoke_schema output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authRevokeSignal(output);
        Q_EMIT authRevokeSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authRevokeSignalE(output, error_type, error_str);
        Q_EMIT authRevokeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authRevokeSignalError(output, error_type, error_str);
        Q_EMIT authRevokeSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIAuthApi::authTest(const QString &token) {
    QString fullPath = QString(_serverConfigs["authTest"][_serverIndices.value("authTest")].URL()+"/auth.test");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authTestCallback);
    connect(this, &OAIAuthApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAuthApi::authTestCallback);
    connect(this, &OAIAuthApi::abortRequestsSignal, _latestWorker, &QObject::deleteLater);
    connect(_latestWorker, &QObject::destroyed, [this](){
        if(findChildren<OAIHttpRequestWorker*>().count() == 0){
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAuthApi::authTestCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIAuth_test_success_schema output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT authTestSignal(output);
        Q_EMIT authTestSignalFull(worker, output);
    } else if(worker->error_type == QNetworkReply::AuthenticationRequiredError){
        connect(&_authFlow, SIGNAL(tokenReceived()), this, SLOT(tokenAvailable()));
        QStringList scope;
        scope.append("none");
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT authTestSignalE(output, error_type, error_str);
        Q_EMIT authTestSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT authTestSignalError(output, error_type, error_str);
        Q_EMIT authTestSignalErrorFull(worker, error_type, error_str);
    }
}
