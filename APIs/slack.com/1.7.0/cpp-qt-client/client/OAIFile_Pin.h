...
#ifndef OAIFile_Pin_H
#define OAIFile_Pin_H
...
class OAIFile_Pin : public OAIObject {
public:
    OAIFile_Pin();
    OAIFile_Pin(QString json);
    ~OAIFile_Pin() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFile_Pin)
