...
/*
 * OAIObjs_user_inner_anyOf_1.h
 *
 * enterprise user
 */

#ifndef OAIObjs_user_inner_anyOf_1_H
#define OAIObjs_user_inner_anyOf_1_H
...
class OAIObjs_user_inner_anyOf_1 : public OAIObject {
public:
    OAIObjs_user_inner_anyOf_1();
    OAIObjs_user_inner_anyOf_1(QString json);
    ~OAIObjs_user_inner_anyOf_1() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjs_user_inner_anyOf_1)

#endif // OAIObjs_user_inner_anyOf_1_H
