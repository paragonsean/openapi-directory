...
/*
 * OAIReminders_add_schema.h
 *
 * Schema for successful response from reminders.add method
 */

#ifndef OAIReminders_add_schema_H
#define OAIReminders_add_schema_H
...
class OAIReminders_add_schema : public OAIObject {
public:
    OAIReminders_add_schema();
    OAIReminders_add_schema(QString json);
    ~OAIReminders_add_schema() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReminders_add_schema)

#endif // OAIReminders_add_schema_H
