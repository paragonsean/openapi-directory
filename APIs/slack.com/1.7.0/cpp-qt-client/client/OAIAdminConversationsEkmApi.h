...
#ifndef OAI_OAIAdminConversationsEkmApi_H
#define OAI_OAIAdminConversationsEkmApi_H
...
class OAIAdminConversationsEkmApi : public QObject {
    Q_OBJECT

public:
    OAIAdminConversationsEkmApi(const int timeOut = 0);
    ~OAIAdminConversationsEkmApi();
