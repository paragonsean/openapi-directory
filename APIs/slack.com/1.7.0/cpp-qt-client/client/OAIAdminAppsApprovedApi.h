...
#ifndef OAI_OAIAdminAppsApprovedApi_H
#define OAI_OAIAdminAppsApprovedApi_H
...
class OAIAdminAppsApprovedApi : public QObject {
    Q_OBJECT

public:
    OAIAdminAppsApprovedApi(const int timeOut = 0);
    ~OAIAdminAppsApprovedApi();
