...
#ifndef OAIObjs_message_H
#define OAIObjs_message_H
...
class OAIObjs_message : public OAIObject {
public:
    OAIObjs_message();
    OAIObjs_message(QString json);
    ~OAIObjs_message() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjs_message)

#endif // OAIObjs_message_H
