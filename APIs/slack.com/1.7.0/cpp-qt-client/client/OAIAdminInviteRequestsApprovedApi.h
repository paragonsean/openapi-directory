...
#ifndef OAI_OAIAdminInviteRequestsApprovedApi_H
#define OAI_OAIAdminInviteRequestsApprovedApi_H
...
class OAIAdminInviteRequestsApprovedApi : public QObject {
    Q_OBJECT

public:
    OAIAdminInviteRequestsApprovedApi(const int timeOut = 0);
    ~OAIAdminInviteRequestsApprovedApi();
