...
#ifndef OAI_OAIAdminInviteRequestsDeniedApi_H
#define OAI_OAIAdminInviteRequestsDeniedApi_H
...
class OAIAdminInviteRequestsDeniedApi : public QObject {
    Q_OBJECT

public:
    OAIAdminInviteRequestsDeniedApi(const int timeOut = 0);
    ~OAIAdminInviteRequestsDeniedApi();
