...
/*
 * OAIObjs_user_inner.h
 *
 * 
 */

#ifndef OAIObjs_user_inner_H
#define OAIObjs_user_inner_H

#include <QJsonObject>

#include "OAIObjs_enterprise_user.h"
#include "OAIObjs_team_discoverable_inner.h"
#include "OAIObjs_user_inner_anyOf.h"
...
class OAIObjs_user_inner : public OAIObject {
public:
    OAIObjs_user_inner();
    OAIObjs_user_inner(QString json);
    ~OAIObjs_user_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIObjs_user_inner)

#endif // OAIObjs_user_inner_H
