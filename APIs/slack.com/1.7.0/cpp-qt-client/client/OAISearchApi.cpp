...
void OAISearchApi::initializeServerConfigs() {
    ...
    _serverConfigs.insert("searchMessages", defaultConf);
    _serverIndices.insert("searchMessages", 0);
}
...
void OAISearchApi::searchMessages(const QString &token, const QString &query, const ::OpenAPI::OptionalParam<qint32> &count, const ::OpenAPI::OptionalParam<bool> &highlight, const ::OpenAPI::OptionalParam<qint32> &page, const ::OpenAPI::OptionalParam<QString> &sort, const ::OpenAPI::OptionalParam<QString> &sort_dir) {
    QString fullPath = QString(_serverConfigs["searchMessages"][_serverIndices.value("searchMessages")].URL()+"/search.messages");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchMessagesCallback);
    ...
    connect(_latestWorker, &OAIHttpRequestWorker::on_execution_finished, this, &OAISearchApi::searchMessagesCallback);
...
void OAISearchApi::searchMessagesCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT searchMessagesSignal(output);
        Q_EMIT searchMessagesSignalFull(worker, output);
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT searchMessagesSignalE(output, error_type, error_str);
        Q_EMIT searchMessagesSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT searchMessagesSignalError(output, error_type, error_str);
        Q_EMIT searchMessagesSignalErrorFull(worker, error_type, error_str);
    }
}
