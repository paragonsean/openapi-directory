...
#ifndef OAI_OAIAdminTeamsAdminsApi_H
#define OAI_OAIAdminTeamsAdminsApi_H
...
class OAIAdminTeamsAdminsApi : public QObject {
    Q_OBJECT

public:
    OAIAdminTeamsAdminsApi(const int timeOut = 0);
    ~OAIAdminTeamsAdminsApi();
