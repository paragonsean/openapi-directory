...
OAIObjs_channel_latest_inner::OAIObjs_channel_latest_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIObjs_channel_latest_inner::OAIObjs_channel_latest_inner() {
    this->initializeModel();
}

OAIObjs_channel_latest_inner::~OAIObjs_channel_latest_inner() {}

void OAIObjs_channel_latest_inner::initializeModel() {
...
void OAIObjs_channel_latest_inner::fromJson(QString jsonString) {
...
void OAIObjs_channel_latest_inner::fromJsonObject(QJsonObject json) {
...
QString OAIObjs_channel_latest_inner::asJson() const {
...
QJsonObject OAIObjs_channel_latest_inner::asJsonObject() const {
    QJsonObject obj;
...
QSet<OAIObjs_message_attachments_inner> OAIObjs_channel_latest_inner::getAttachments() const {
    return m_attachments;
}
void OAIObjs_channel_latest_inner::setAttachments(const QSet<OAIObjs_message_attachments_inner> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIObjs_channel_latest_inner::is_attachments_Valid() const{
    return m_attachments_isValid;
}

QList<OAIBlocks_inner> OAIObjs_channel_latest_inner::getBlocks() const {
    return m_blocks;
}
void OAIObjs_channel_latest_inner::setBlocks(const QList<OAIBlocks_inner> &blocks) {
    m_blocks = blocks;
    m_blocks_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_blocks_Set() const{
    return m_blocks_isSet;
}

bool OAIObjs_channel_latest_inner::is_blocks_Valid() const{
    return m_blocks_isValid;
}

QList<OAIObjs_message_bot_id_inner> OAIObjs_channel_latest_inner::getBotId() const {
    return m_bot_id;
}
void OAIObjs_channel_latest_inner::setBotId(const QList<OAIObjs_message_bot_id_inner> &bot_id) {
    m_bot_id = bot_id;
    m_bot_id_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_bot_id_Set() const{
    return m_bot_id_isSet;
}

bool OAIObjs_channel_latest_inner::is_bot_id_Valid() const{
    return m_bot_id_isValid;
}

OAIObjs_bot_profile OAIObjs_channel_latest_inner::getBotProfile() const {
    return m_bot_profile;
}
void OAIObjs_channel_latest_inner::setBotProfile(const OAIObjs_bot_profile &bot_profile) {
    m_bot_profile = bot_profile;
    m_bot_profile_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_bot_profile_Set() const{
    return m_bot_profile_isSet;
}

bool OAIObjs_channel_latest_inner::is_bot_profile_Valid() const{
    return m_bot_profile_isValid;
}

QString OAIObjs_channel_latest_inner::getClientMsgId() const {
    return m_client_msg_id;
}
void OAIObjs_channel_latest_inner::setClientMsgId(const QString &client_msg_id) {
    m_client_msg_id = client_msg_id;
    m_client_msg_id_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_client_msg_id_Set() const{
    return m_client_msg_id_isSet;
}

bool OAIObjs_channel_latest_inner::is_client_msg_id_Valid() const{
    return m_client_msg_id_isValid;
}

OAIObjs_comment OAIObjs_channel_latest_inner::getComment() const {
    return m_comment;
}
void OAIObjs_channel_latest_inner::setComment(const OAIObjs_comment &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIObjs_channel_latest_inner::is_comment_Valid() const{
    return m_comment_isValid;
}

bool OAIObjs_channel_latest_inner::isDisplayAsBot() const {
    return m_display_as_bot;
}
void OAIObjs_channel_latest_inner::setDisplayAsBot(const bool &display_as_bot) {
    m_display_as_bot = display_as_bot;
    m_display_as_bot_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_display_as_bot_Set() const{
    return m_display_as_bot_isSet;
}

bool OAIObjs_channel_latest_inner::is_display_as_bot_Valid() const{
    return m_display_as_bot_isValid;
}

OAIObjs_file OAIObjs_channel_latest_inner::getFile() const {
    return m_file;
}
void OAIObjs_channel_latest_inner::setFile(const OAIObjs_file &file) {
    m_file = file;
    m_file_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_file_Set() const{
    return m_file_isSet;
}

bool OAIObjs_channel_latest_inner::is_file_Valid() const{
    return m_file_isValid;
}

QSet<OAIObjs_file> OAIObjs_channel_latest_inner::getFiles() const {
    return m_files;
}
void OAIObjs_channel_latest_inner::setFiles(const QSet<OAIObjs_file> &files) {
    m_files = files;
    m_files_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_files_Set() const{
    return m_files_isSet;
}

bool OAIObjs_channel_latest_inner::is_files_Valid() const{
    return m_files_isValid;
}

OAIObjs_message_icons OAIObjs_channel_latest_inner::getIcons() const {
    return m_icons;
}
void OAIObjs_channel_latest_inner::setIcons(const OAIObjs_message_icons &icons) {
    m_icons = icons;
    m_icons_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_icons_Set() const{
    return m_icons_isSet;
}

bool OAIObjs_channel_latest_inner::is_icons_Valid() const{
    return m_icons_isValid;
}

QString OAIObjs_channel_latest_inner::getInviter() const {
    return m_inviter;
}
void OAIObjs_channel_latest_inner::setInviter(const QString &inviter) {
    m_inviter = inviter;
    m_inviter_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_inviter_Set() const{
    return m_inviter_isSet;
}

bool OAIObjs_channel_latest_inner::is_inviter_Valid() const{
    return m_inviter_isValid;
}

bool OAIObjs_channel_latest_inner::isIsDelayedMessage() const {
    return m_is_delayed_message;
}
void OAIObjs_channel_latest_inner::setIsDelayedMessage(const bool &is_delayed_message) {
    m_is_delayed_message = is_delayed_message;
    m_is_delayed_message_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_is_delayed_message_Set() const{
    return m_is_delayed_message_isSet;
}

bool OAIObjs_channel_latest_inner::is_is_delayed_message_Valid() const{
    return m_is_delayed_message_isValid;
}

bool OAIObjs_channel_latest_inner::isIsIntro() const {
    return m_is_intro;
}
void OAIObjs_channel_latest_inner::setIsIntro(const bool &is_intro) {
    m_is_intro = is_intro;
    m_is_intro_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_is_intro_Set() const{
    return m_is_intro_isSet;
}

bool OAIObjs_channel_latest_inner::is_is_intro_Valid() const{
    return m_is_intro_isValid;
}

bool OAIObjs_channel_latest_inner::isIsStarred() const {
    return m_is_starred;
}
void OAIObjs_channel_latest_inner::setIsStarred(const bool &is_starred) {
    m_is_starred = is_starred;
    m_is_starred_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_is_starred_Set() const{
    return m_is_starred_isSet;
}

bool OAIObjs_channel_latest_inner::is_is_starred_Valid() const{
    return m_is_starred_isValid;
}

QString OAIObjs_channel_latest_inner::getLastRead() const {
    return m_last_read;
}
void OAIObjs_channel_latest_inner::setLastRead(const QString &last_read) {
    m_last_read = last_read;
    m_last_read_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_last_read_Set() const{
    return m_last_read_isSet;
}

bool OAIObjs_channel_latest_inner::is_last_read_Valid() const{
    return m_last_read_isValid;
}

QString OAIObjs_channel_latest_inner::getLatestReply() const {
    return m_latest_reply;
}
void OAIObjs_channel_latest_inner::setLatestReply(const QString &latest_reply) {
    m_latest_reply = latest_reply;
    m_latest_reply_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_latest_reply_Set() const{
    return m_latest_reply_isSet;
}

bool OAIObjs_channel_latest_inner::is_latest_reply_Valid() const{
    return m_latest_reply_isValid;
}

QString OAIObjs_channel_latest_inner::getName() const {
    return m_name;
}
void OAIObjs_channel_latest_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIObjs_channel_latest_inner::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIObjs_channel_latest_inner::getOldName() const {
    return m_old_name;
}
void OAIObjs_channel_latest_inner::setOldName(const QString &old_name) {
    m_old_name = old_name;
    m_old_name_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_old_name_Set() const{
    return m_old_name_isSet;
}

bool OAIObjs_channel_latest_inner::is_old_name_Valid() const{
    return m_old_name_isValid;
}

QString OAIObjs_channel_latest_inner::getParentUserId() const {
    return m_parent_user_id;
}
void OAIObjs_channel_latest_inner::setParentUserId(const QString &parent_user_id) {
    m_parent_user_id = parent_user_id;
    m_parent_user_id_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_parent_user_id_Set() const{
    return m_parent_user_id_isSet;
}

bool OAIObjs_channel_latest_inner::is_parent_user_id_Valid() const{
    return m_parent_user_id_isValid;
}

QString OAIObjs_channel_latest_inner::getPermalink() const {
    return m_permalink;
}
void OAIObjs_channel_latest_inner::setPermalink(const QString &permalink) {
    m_permalink = permalink;
    m_permalink_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_permalink_Set() const{
    return m_permalink_isSet;
}

bool OAIObjs_channel_latest_inner::is_permalink_Valid() const{
    return m_permalink_isValid;
}

QList<QString> OAIObjs_channel_latest_inner::getPinnedTo() const {
    return m_pinned_to;
}
void OAIObjs_channel_latest_inner::setPinnedTo(const QList<QString> &pinned_to) {
    m_pinned_to = pinned_to;
    m_pinned_to_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_pinned_to_Set() const{
    return m_pinned_to_isSet;
}

bool OAIObjs_channel_latest_inner::is_pinned_to_Valid() const{
    return m_pinned_to_isValid;
}

QString OAIObjs_channel_latest_inner::getPurpose() const {
    return m_purpose;
}
void OAIObjs_channel_latest_inner::setPurpose(const QString &purpose) {
    m_purpose = purpose;
    m_purpose_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_purpose_Set() const{
    return m_purpose_isSet;
}

bool OAIObjs_channel_latest_inner::is_purpose_Valid() const{
    return m_purpose_isValid;
}

QList<OAIObjs_reaction> OAIObjs_channel_latest_inner::getReactions() const {
    return m_reactions;
}
void OAIObjs_channel_latest_inner::setReactions(const QList<OAIObjs_reaction> &reactions) {
    m_reactions = reactions;
    m_reactions_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_reactions_Set() const{
    return m_reactions_isSet;
}

bool OAIObjs_channel_latest_inner::is_reactions_Valid() const{
    return m_reactions_isValid;
}

qint32 OAIObjs_channel_latest_inner::getReplyCount() const {
    return m_reply_count;
}
void OAIObjs_channel_latest_inner::setReplyCount(const qint32 &reply_count) {
    m_reply_count = reply_count;
    m_reply_count_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_reply_count_Set() const{
    return m_reply_count_isSet;
}

bool OAIObjs_channel_latest_inner::is_reply_count_Valid() const{
    return m_reply_count_isValid;
}

QSet<QString> OAIObjs_channel_latest_inner::getReplyUsers() const {
    return m_reply_users;
}
void OAIObjs_channel_latest_inner::setReplyUsers(const QSet<QString> &reply_users) {
    m_reply_users = reply_users;
    m_reply_users_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_reply_users_Set() const{
    return m_reply_users_isSet;
}

bool OAIObjs_channel_latest_inner::is_reply_users_Valid() const{
    return m_reply_users_isValid;
}

qint32 OAIObjs_channel_latest_inner::getReplyUsersCount() const {
    return m_reply_users_count;
}
void OAIObjs_channel_latest_inner::setReplyUsersCount(const qint32 &reply_users_count) {
    m_reply_users_count = reply_users_count;
    m_reply_users_count_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_reply_users_count_Set() const{
    return m_reply_users_count_isSet;
}

bool OAIObjs_channel_latest_inner::is_reply_users_count_Valid() const{
    return m_reply_users_count_isValid;
}

QString OAIObjs_channel_latest_inner::getSourceTeam() const {
    return m_source_team;
}
void OAIObjs_channel_latest_inner::setSourceTeam(const QString &source_team) {
    m_source_team = source_team;
    m_source_team_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_source_team_Set() const{
    return m_source_team_isSet;
}

bool OAIObjs_channel_latest_inner::is_source_team_Valid() const{
    return m_source_team_isValid;
}

bool OAIObjs_channel_latest_inner::isSubscribed() const {
    return m_subscribed;
}
void OAIObjs_channel_latest_inner::setSubscribed(const bool &subscribed) {
    m_subscribed = subscribed;
    m_subscribed_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_subscribed_Set() const{
    return m_subscribed_isSet;
}

bool OAIObjs_channel_latest_inner::is_subscribed_Valid() const{
    return m_subscribed_isValid;
}

QString OAIObjs_channel_latest_inner::getSubtype() const {
    return m_subtype;
}
void OAIObjs_channel_latest_inner::setSubtype(const QString &subtype) {
    m_subtype = subtype;
    m_subtype_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_subtype_Set() const{
    return m_subtype_isSet;
}

bool OAIObjs_channel_latest_inner::is_subtype_Valid() const{
    return m_subtype_isValid;
}

QString OAIObjs_channel_latest_inner::getTeam() const {
    return m_team;
}
void OAIObjs_channel_latest_inner::setTeam(const QString &team) {
    m_team = team;
    m_team_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_team_Set() const{
    return m_team_isSet;
}

bool OAIObjs_channel_latest_inner::is_team_Valid() const{
    return m_team_isValid;
}

QString OAIObjs_channel_latest_inner::getText() const {
    return m_text;
}
void OAIObjs_channel_latest_inner::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_text_Set() const{
    return m_text_isSet;
}

bool OAIObjs_channel_latest_inner::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIObjs_channel_latest_inner::getThreadTs() const {
    return m_thread_ts;
}
void OAIObjs_channel_latest_inner::setThreadTs(const QString &thread_ts) {
    m_thread_ts = thread_ts;
    m_thread_ts_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_thread_ts_Set() const{
    return m_thread_ts_isSet;
}

bool OAIObjs_channel_latest_inner::is_thread_ts_Valid() const{
    return m_thread_ts_isValid;
}

QString OAIObjs_channel_latest_inner::getTopic() const {
    return m_topic;
}
void OAIObjs_channel_latest_inner::setTopic(const QString &topic) {
    m_topic = topic;
    m_topic_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_topic_Set() const{
    return m_topic_isSet;
}

bool OAIObjs_channel_latest_inner::is_topic_Valid() const{
    return m_topic_isValid;
}

QString OAIObjs_channel_latest_inner::getTs() const {
    return m_ts;
}
void OAIObjs_channel_latest_inner::setTs(const QString &ts) {
    m_ts = ts;
    m_ts_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_ts_Set() const{
    return m_ts_isSet;
}

bool OAIObjs_channel_latest_inner::is_ts_Valid() const{
    return m_ts_isValid;
}

QString OAIObjs_channel_latest_inner::getType() const {
    return m_type;
}
void OAIObjs_channel_latest_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAIObjs_channel_latest_inner::is_type_Valid() const{
    return m_type_isValid;
}

qint32 OAIObjs_channel_latest_inner::getUnreadCount() const {
    return m_unread_count;
}
void OAIObjs_channel_latest_inner::setUnreadCount(const qint32 &unread_count) {
    m_unread_count = unread_count;
    m_unread_count_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_unread_count_Set() const{
    return m_unread_count_isSet;
}

bool OAIObjs_channel_latest_inner::is_unread_count_Valid() const{
    return m_unread_count_isValid;
}

bool OAIObjs_channel_latest_inner::isUpload() const {
    return m_upload;
}
void OAIObjs_channel_latest_inner::setUpload(const bool &upload) {
    m_upload = upload;
    m_upload_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_upload_Set() const{
    return m_upload_isSet;
}

bool OAIObjs_channel_latest_inner::is_upload_Valid() const{
    return m_upload_isValid;
}

QString OAIObjs_channel_latest_inner::getUser() const {
    return m_user;
}
void OAIObjs_channel_latest_inner::setUser(const QString &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_user_Set() const{
    return m_user_isSet;
}

bool OAIObjs_channel_latest_inner::is_user_Valid() const{
    return m_user_isValid;
}

OAIObjs_user_profile_short OAIObjs_channel_latest_inner::getUserProfile() const {
    return m_user_profile;
}
void OAIObjs_channel_latest_inner::setUserProfile(const OAIObjs_user_profile_short &user_profile) {
    m_user_profile = user_profile;
    m_user_profile_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_user_profile_Set() const{
    return m_user_profile_isSet;
}

bool OAIObjs_channel_latest_inner::is_user_profile_Valid() const{
    return m_user_profile_isValid;
}

QString OAIObjs_channel_latest_inner::getUserTeam() const {
    return m_user_team;
}
void OAIObjs_channel_latest_inner::setUserTeam(const QString &user_team) {
    m_user_team = user_team;
    m_user_team_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_user_team_Set() const{
    return m_user_team_isSet;
}

bool OAIObjs_channel_latest_inner::is_user_team_Valid() const{
    return m_user_team_isValid;
}

QString OAIObjs_channel_latest_inner::getUsername() const {
    return m_username;
}
void OAIObjs_channel_latest_inner::setUsername(const QString &username) {
    m_username = username;
    m_username_isSet = true;
}

bool OAIObjs_channel_latest_inner::is_username_Set() const{
    return m_username_isSet;
}

bool OAIObjs_channel_latest_inner::is_username_Valid() const{
    return m_username_isValid;
}

bool OAIObjs_channel_latest_inner::isSet() const {
...
bool OAIObjs_channel_latest_inner::isValid() const {
