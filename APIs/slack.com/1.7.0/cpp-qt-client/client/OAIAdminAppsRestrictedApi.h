...
#ifndef OAI_OAIAdminAppsRestrictedApi_H
#define OAI_OAIAdminAppsRestrictedApi_H
...
class OAIAdminAppsRestrictedApi : public QObject {
    Q_OBJECT

public:
    OAIAdminAppsRestrictedApi(const int timeOut = 0);
    ~OAIAdminAppsRestrictedApi();
