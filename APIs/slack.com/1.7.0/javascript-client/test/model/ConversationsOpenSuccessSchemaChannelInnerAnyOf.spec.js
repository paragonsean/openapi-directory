...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ConversationsOpenSuccessSchemaChannelInnerAnyOf();
  });
  ...
  describe('ConversationsOpenSuccessSchemaChannelInnerAnyOf', function() {
    it('should create an instance of ConversationsOpenSuccessSchemaChannelInnerAnyOf', function() {
      // uncomment below and update the code to test ConversationsOpenSuccessSchemaChannelInnerAnyOf
      //var instance = new SlackWebApi.ConversationsOpenSuccessSchemaChannelInnerAnyOf();
      //expect(instance).to.be.a(SlackWebApi.ConversationsOpenSuccessSchemaChannelInnerAnyOf);
    });
