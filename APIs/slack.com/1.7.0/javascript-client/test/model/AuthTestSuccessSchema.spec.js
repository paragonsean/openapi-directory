...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.AuthTestSuccessSchema();
  });
  ...
  describe('AuthTestSuccessSchema', function() {
    it('should create an instance of AuthTestSuccessSchema', function() {
      // uncomment below and update the code to test AuthTestSuccessSchema
      //var instance = new SlackWebApi.AuthTestSuccessSchema();
      //expect(instance).to.be.a(SlackWebApi.AuthTestSuccessSchema);
    });
    ...
    it('should have the property isEnterpriseInstall (base name: "is_enterprise_install")', function() {
      // uncomment below and update the code to test the property isEnterpriseInstall
      //var instance = new SlackWebApi.AuthTestSuccessSchema();
      //expect(instance).to.be();
    });
