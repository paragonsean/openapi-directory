...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.RemindersInfoSchema();
  });
  ...
  describe('RemindersInfoSchema', function() {
    it('should create an instance of RemindersInfoSchema', function() {
      // uncomment below and update the code to test RemindersInfoSchema
      //var instance = new SlackWebApi.RemindersInfoSchema();
      //expect(instance).to.be.a(SlackWebApi.RemindersInfoSchema);
    });
