...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.BotsInfoSchema();
  });
  ...
  describe('BotsInfoSchema', function() {
    it('should create an instance of BotsInfoSchema', function() {
      // uncomment below and update the code to test BotsInfoSchema
      //var instance = new SlackWebApi.BotsInfoSchema();
      //expect(instance).to.be.a(SlackWebApi.BotsInfoSchema);
    });
