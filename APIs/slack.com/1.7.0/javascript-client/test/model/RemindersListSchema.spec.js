...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.RemindersListSchema();
  });
  ...
  describe('RemindersListSchema', function() {
    it('should create an instance of RemindersListSchema', function() {
      // uncomment below and update the code to test RemindersListSchema
      //var instance = new SlackWebApi.RemindersListSchema();
      //expect(instance).to.be.a(SlackWebApi.RemindersListSchema);
    });
