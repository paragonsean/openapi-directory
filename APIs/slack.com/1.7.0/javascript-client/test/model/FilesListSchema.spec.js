...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.FilesListSchema();
  });
  ...
  describe('FilesListSchema', function() {
    it('should create an instance of FilesListSchema', function() {
      // uncomment below and update the code to test FilesListSchema
      //var instance = new SlackWebApi.FilesListSchema();
      //expect(instance).to.be.a(SlackWebApi.FilesListSchema);
    });
