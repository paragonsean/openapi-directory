...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.AuthRevokeSchema();
  });
  ...
  describe('AuthRevokeSchema', function() {
    it('should create an instance of AuthRevokeSchema', function() {
      // uncomment below and update the code to test AuthRevokeSchema
      //var instance = new SlackWebApi.AuthRevokeSchema();
      //expect(instance).to.be.a(SlackWebApi.AuthRevokeSchema);
    });
