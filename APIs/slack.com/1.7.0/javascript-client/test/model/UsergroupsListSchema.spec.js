...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.UsergroupsListSchema();
  });
  ...
  describe('UsergroupsListSchema', function() {
    it('should create an instance of UsergroupsListSchema', function() {
      // uncomment below and update the code to test UsergroupsListSchema
      //var instance = new SlackWebApi.UsergroupsListSchema();
      //expect(instance).to.be.a(SlackWebApi.UsergroupsListSchema);
    });
