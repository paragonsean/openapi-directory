...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ConversationsOpenSuccessSchemaChannelInner();
  });
  ...
  describe('ConversationsOpenSuccessSchemaChannelInner', function() {
    it('should create an instance of ConversationsOpenSuccessSchemaChannelInner', function() {
      // uncomment below and update the code to test ConversationsOpenSuccessSchemaChannelInner
      //var instance = new SlackWebApi.ConversationsOpenSuccessSchemaChannelInner();
      //expect(instance).to.be.a(SlackWebApi.ConversationsOpenSuccessSchemaChannelInner);
    });
