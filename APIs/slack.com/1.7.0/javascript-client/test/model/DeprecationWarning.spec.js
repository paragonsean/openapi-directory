...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.DeprecationWarning();
  });
  ...
  describe('DeprecationWarning', function() {
    it('should create an instance of DeprecationWarning', function() {
      // uncomment below and update the code to test DeprecationWarning
      //var instance = new SlackWebApi.DeprecationWarning();
      //expect(instance).to.be.a(SlackWebApi.DeprecationWarning);
    });
