...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.TeamIntegrationLogsSchema();
  });
  ...
  describe('TeamIntegrationLogsSchema', function() {
    it('should create an instance of TeamIntegrationLogsSchema', function() {
      // uncomment below and update the code to test TeamIntegrationLogsSchema
      //var instance = new SlackWebApi.TeamIntegrationLogsSchema();
      //expect(instance).to.be.a(SlackWebApi.TeamIntegrationLogsSchema);
    });
