...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.RemindersAddSchema();
  });
  ...
  describe('RemindersAddSchema', function() {
    it('should create an instance of RemindersAddSchema', function() {
      // uncomment below and update the code to test RemindersAddSchema
      //var instance = new SlackWebApi.RemindersAddSchema();
      //expect(instance).to.be.a(SlackWebApi.RemindersAddSchema);
    });
