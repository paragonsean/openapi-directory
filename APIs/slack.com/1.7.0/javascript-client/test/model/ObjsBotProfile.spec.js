...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ObjsBotProfile();
  });
  ...
  describe('ObjsBotProfile', function() {
    it('should create an instance of ObjsBotProfile', function() {
      // uncomment below and update the code to test ObjsBotProfile
      //var instance = new SlackWebApi.ObjsBotProfile();
      //expect(instance).to.be.a(SlackWebApi.ObjsBotProfile);
    });
