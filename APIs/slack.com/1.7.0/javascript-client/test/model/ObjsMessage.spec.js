...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ObjsMessage();
  });
  ...
  describe('ObjsMessage', function() {
    it('should create an instance of ObjsMessage', function() {
      // uncomment below and update the code to test ObjsMessage
      //var instance = new SlackWebApi.ObjsMessage();
      //expect(instance).to.be.a(SlackWebApi.ObjsMessage);
    });
