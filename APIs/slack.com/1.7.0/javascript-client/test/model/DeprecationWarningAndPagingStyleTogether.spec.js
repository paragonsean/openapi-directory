...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.DeprecationWarningAndPagingStyleTogether();
  });
  ...
  describe('DeprecationWarningAndPagingStyleTogether', function() {
    it('should create an instance of DeprecationWarningAndPagingStyleTogether', function() {
      // uncomment below and update the code to test DeprecationWarningAndPagingStyleTogether
      //var instance = new SlackWebApi.DeprecationWarningAndPagingStyleTogether();
      //expect(instance).to.be.a(SlackWebApi.DeprecationWarningAndPagingStyleTogether);
    });
