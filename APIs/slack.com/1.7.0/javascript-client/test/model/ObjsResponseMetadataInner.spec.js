...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ObjsResponseMetadataInner();
  });
  ...
  describe('ObjsResponseMetadataInner', function() {
    it('should create an instance of ObjsResponseMetadataInner', function() {
      // uncomment below and update the code to test ObjsResponseMetadataInner
      //var instance = new SlackWebApi.ObjsResponseMetadataInner();
      //expect(instance).to.be.a(SlackWebApi.ObjsResponseMetadataInner);
    });
