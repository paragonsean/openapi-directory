...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf();
  });
  ...
  describe('ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf', function() {
    it('should create an instance of ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf', function() {
      // uncomment below and update the code to test ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf
      //var instance = new SlackWebApi.ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf();
      //expect(instance).to.be.a(SlackWebApi.ConversationsRepliesSuccessSchemaMessagesInnerInnerAnyOf);
    });
