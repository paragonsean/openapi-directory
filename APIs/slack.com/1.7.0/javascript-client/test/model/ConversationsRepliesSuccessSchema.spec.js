...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlackWebApi.ConversationsRepliesSuccessSchema();
  });
  ...
  describe('ConversationsRepliesSuccessSchema', function() {
    it('should create an instance of ConversationsRepliesSuccessSchema', function() {
      // uncomment below and update the code to test ConversationsRepliesSuccessSchema
      //var instance = new SlackWebApi.ConversationsRepliesSuccessSchema();
      //expect(instance).to.be.a(SlackWebApi.ConversationsRepliesSuccessSchema);
    });
