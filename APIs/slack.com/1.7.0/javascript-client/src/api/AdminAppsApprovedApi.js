...
/**
* AdminAppsApproved service.
* @module api/AdminAppsApprovedApi
* @version 1.7.0
*/
export default class AdminAppsApprovedApi {

    /**
    * Constructs a new AdminAppsApprovedApi. 
    * @alias module:api/AdminAppsApprovedApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the adminAppsApprovedList operation.
     * @callback module:api/AdminAppsApprovedApi~adminAppsApprovedListCallback
     ...
     * @param {module:api/AdminAppsApprovedApi~adminAppsApprovedListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DefaultSuccessTemplate}
     */
    adminAppsApprovedList(token, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'token' is set
      if (token === undefined || token === null) {
        throw new Error("Missing the required parameter 'token' when calling adminAppsApprovedList");
      }
