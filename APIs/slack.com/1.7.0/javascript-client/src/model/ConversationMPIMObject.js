...
/**
 * The ConversationMPIMObject model module.
 * @module model/ConversationMPIMObject
 * @version 1.7.0
 */
class ConversationMPIMObject {
    /**
     * Constructs a new <code>ConversationMPIMObject</code>.
     * @alias module:model/ConversationMPIMObject
    ...
    constructor(created, creator, id, isArchived, isChannel, isGeneral, isGroup, isIm, isMpim, isOrgShared, isPrivate, isShared, name, nameNormalized, purpose, topic) { 
        ...
        ConversationMPIMObject.initialize(this, created, creator, id, isArchived, isChannel, isGeneral, isGroup, isIm, isMpim, isOrgShared, isPrivate, isShared, name, nameNormalized, purpose, topic);
    }
    ...
    /**
     * Constructs a <code>ConversationMPIMObject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConversationMPIMObject} obj Optional instance to populate.
     * @return {module:model/ConversationMPIMObject} The populated <code>ConversationMPIMObject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConversationMPIMObject();
    ...
    /**
     * Validates the JSON data with respect to <code>ConversationMPIMObject</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConversationMPIMObject</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConversationMPIMObject.RequiredProperties) {
...
ConversationMPIMObject.RequiredProperties = ["created", "creator", "id", "is_archived", "is_channel", "is_general", "is_group", "is_im", "is_mpim", "is_org_shared", "is_private", "is_shared", "name", "name_normalized", "purpose", "topic"];

/**
 * @member {String} accepted_user
 */
ConversationMPIMObject.prototype['accepted_user'] = undefined;

/**
 * @member {Array.<String>} connected_team_ids
 */
ConversationMPIMObject.prototype['connected_team_ids'] = undefined;

/**
 * @member {String} conversation_host_id
 */
ConversationMPIMObject.prototype['conversation_host_id'] = undefined;

/**
 * @member {Number} created
 */
ConversationMPIMObject.prototype['created'] = undefined;

/**
 * @member {String} creator
 */
ConversationMPIMObject.prototype['creator'] = undefined;

/**
 * @member {module:model/ConversationObjectDisplayCounts} display_counts
 */
ConversationMPIMObject.prototype['display_counts'] = undefined;

/**
 * @member {String} id
 */
ConversationMPIMObject.prototype['id'] = undefined;

/**
 * @member {Array.<String>} internal_team_ids
 */
ConversationMPIMObject.prototype['internal_team_ids'] = undefined;

/**
 * @member {Boolean} is_archived
 */
ConversationMPIMObject.prototype['is_archived'] = undefined;

/**
 * @member {Boolean} is_channel
 */
ConversationMPIMObject.prototype['is_channel'] = undefined;

/**
 * @member {Boolean} is_ext_shared
 */
ConversationMPIMObject.prototype['is_ext_shared'] = undefined;

/**
 * @member {Boolean} is_frozen
 */
ConversationMPIMObject.prototype['is_frozen'] = undefined;

/**
 * @member {Boolean} is_general
 */
ConversationMPIMObject.prototype['is_general'] = undefined;

/**
 * @member {Boolean} is_group
 */
ConversationMPIMObject.prototype['is_group'] = undefined;

/**
 * @member {Boolean} is_im
 */
ConversationMPIMObject.prototype['is_im'] = undefined;

/**
 * @member {Boolean} is_member
 */
ConversationMPIMObject.prototype['is_member'] = undefined;

/**
 * @member {Number} is_moved
 */
ConversationMPIMObject.prototype['is_moved'] = undefined;

/**
 * @member {Boolean} is_mpim
 */
ConversationMPIMObject.prototype['is_mpim'] = undefined;

/**
 * @member {Boolean} is_non_threadable
 */
ConversationMPIMObject.prototype['is_non_threadable'] = undefined;

/**
 * @member {Boolean} is_open
 */
ConversationMPIMObject.prototype['is_open'] = undefined;

/**
 * @member {Boolean} is_org_shared
 */
ConversationMPIMObject.prototype['is_org_shared'] = undefined;

/**
 * @member {Boolean} is_pending_ext_shared
 */
ConversationMPIMObject.prototype['is_pending_ext_shared'] = undefined;

/**
 * @member {Boolean} is_private
 */
ConversationMPIMObject.prototype['is_private'] = undefined;

/**
 * @member {Boolean} is_read_only
 */
ConversationMPIMObject.prototype['is_read_only'] = undefined;

/**
 * @member {Boolean} is_shared
 */
ConversationMPIMObject.prototype['is_shared'] = undefined;

/**
 * @member {Boolean} is_starred
 */
ConversationMPIMObject.prototype['is_starred'] = undefined;

/**
 * @member {Boolean} is_thread_only
 */
ConversationMPIMObject.prototype['is_thread_only'] = undefined;

/**
 * @member {String} last_read
 */
ConversationMPIMObject.prototype['last_read'] = undefined;

/**
 * @member {Array.<module:model/ObjsChannelLatestInner>} latest
 */
ConversationMPIMObject.prototype['latest'] = undefined;

/**
 * @member {Array.<String>} members
 */
ConversationMPIMObject.prototype['members'] = undefined;

/**
 * @member {String} name
 */
ConversationMPIMObject.prototype['name'] = undefined;

/**
 * @member {String} name_normalized
 */
ConversationMPIMObject.prototype['name_normalized'] = undefined;

/**
 * @member {Number} num_members
 */
ConversationMPIMObject.prototype['num_members'] = undefined;

/**
 * @member {Array.<module:model/ConversationObjectParentConversationInner>} parent_conversation
 */
ConversationMPIMObject.prototype['parent_conversation'] = undefined;

/**
 * @member {Array.<String>} pending_connected_team_ids
 */
ConversationMPIMObject.prototype['pending_connected_team_ids'] = undefined;

/**
 * @member {Array.<String>} pending_shared
 */
ConversationMPIMObject.prototype['pending_shared'] = undefined;

/**
 * @member {Number} pin_count
 */
ConversationMPIMObject.prototype['pin_count'] = undefined;

/**
 * @member {Array.<String>} previous_names
 */
ConversationMPIMObject.prototype['previous_names'] = undefined;

/**
 * @member {Number} priority
 */
ConversationMPIMObject.prototype['priority'] = undefined;

/**
 * @member {module:model/ObjsChannelPurpose} purpose
 */
ConversationMPIMObject.prototype['purpose'] = undefined;

/**
 * @member {Array.<String>} shared_team_ids
 */
ConversationMPIMObject.prototype['shared_team_ids'] = undefined;

/**
 * @member {Array.<module:model/ConversationObjectSharesInner>} shares
 */
ConversationMPIMObject.prototype['shares'] = undefined;

/**
 * @member {Number} timezone_count
 */
ConversationMPIMObject.prototype['timezone_count'] = undefined;

/**
 * @member {module:model/ObjsChannelPurpose} topic
 */
ConversationMPIMObject.prototype['topic'] = undefined;

/**
 * @member {Number} unlinked
 */
ConversationMPIMObject.prototype['unlinked'] = undefined;

/**
 * @member {Number} unread_count
 */
ConversationMPIMObject.prototype['unread_count'] = undefined;

/**
 * @member {Number} unread_count_display
 */
ConversationMPIMObject.prototype['unread_count_display'] = undefined;

/**
 * @member {String} user
 */
ConversationMPIMObject.prototype['user'] = undefined;

/**
 * @member {Number} version
 */
ConversationMPIMObject.prototype['version'] = undefined;
...
export default ConversationMPIMObject;
