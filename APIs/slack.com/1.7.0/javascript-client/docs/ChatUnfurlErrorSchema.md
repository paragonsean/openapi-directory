# SlackWebApi.ChatUnfurlErrorSchema
...
* `cannot_unfurl_url` (value: `"cannot_unfurl_url"`)

* `cannot_find_service` (value: `"cannot_find_service"`)

* `missing_unfurls` (value: `"missing_unfurls"`)

* `cannot_prompt` (value: `"cannot_prompt"`)
