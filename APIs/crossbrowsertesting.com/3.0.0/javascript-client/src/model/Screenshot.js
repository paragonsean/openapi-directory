...
class Screenshot {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('screenshot_id')) {
                obj['screenshot_id'] = ApiClient.convertToType(data['screenshot_id'], 'Number');
            }
        }
        return obj;
    }
...
/**
 * @member {Number} screenshot_id
 */
Screenshot.prototype['screenshot_id'] = undefined;
