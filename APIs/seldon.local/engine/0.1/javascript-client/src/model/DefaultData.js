...
class DefaultData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ndarray')) {
                obj['ndarray'] = ApiClient.convertToType(data['ndarray'], [Object]);
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['ndarray'])) {
            throw new Error("Expected the field `ndarray` to be an array in the JSON data but got " + data['ndarray']);
        }
...
/**
 * @member {Array.<Object>} ndarray
 */
DefaultData.prototype['ndarray'] = undefined;
