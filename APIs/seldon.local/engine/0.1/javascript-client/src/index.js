...
import ExternalAmbassadorAPIApi from './api/ExternalAmbassadorAPIApi';
...
export {
    ...
    /**
    * The ExternalAmbassadorAPIApi service constructor.
    * @property {module:api/ExternalAmbassadorAPIApi}
    */
