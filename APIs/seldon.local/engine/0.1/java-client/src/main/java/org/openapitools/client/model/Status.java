...
import org.openapitools.client.model.StatusStatusFlag;
...
public class Status {
  ...
  private StatusStatusFlag status = StatusStatusFlag.SUCCESS;
  ...
  public Status info(String info) {
    this.info = info;
    return this;
  }
  ...
  public Status status(StatusStatusFlag status) {
    this.status = status;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public StatusStatusFlag getStatus() {
    return status;
  }

  public void setStatus(StatusStatusFlag status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, status.code) &&
        Objects.equals(this.info, status.info) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, info, reason, status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        StatusStatusFlag.validateJsonElement(jsonObj.get("status"));
      }
  }
