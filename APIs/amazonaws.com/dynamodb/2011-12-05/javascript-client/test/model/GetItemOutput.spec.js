...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.GetItemOutput();
  });
  ...
  describe('GetItemOutput', function() {
    it('should create an instance of GetItemOutput', function() {
      // uncomment below and update the code to test GetItemOutput
      //var instance = new AmazonDynamoDb.GetItemOutput();
      //expect(instance).to.be.a(AmazonDynamoDb.GetItemOutput);
    });
