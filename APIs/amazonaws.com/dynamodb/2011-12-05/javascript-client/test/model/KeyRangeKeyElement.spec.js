...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.KeyRangeKeyElement();
  });
  ...
  describe('KeyRangeKeyElement', function() {
    it('should create an instance of KeyRangeKeyElement', function() {
      // uncomment below and update the code to test KeyRangeKeyElement
      //var instance = new AmazonDynamoDb.KeyRangeKeyElement();
      //expect(instance).to.be.a(AmazonDynamoDb.KeyRangeKeyElement);
    });
