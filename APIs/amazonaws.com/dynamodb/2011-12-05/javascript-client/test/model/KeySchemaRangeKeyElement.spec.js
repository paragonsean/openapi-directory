...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.KeySchemaRangeKeyElement();
  });
  ...
  describe('KeySchemaRangeKeyElement', function() {
    it('should create an instance of KeySchemaRangeKeyElement', function() {
      // uncomment below and update the code to test KeySchemaRangeKeyElement
      //var instance = new AmazonDynamoDb.KeySchemaRangeKeyElement();
      //expect(instance).to.be.a(AmazonDynamoDb.KeySchemaRangeKeyElement);
    });
