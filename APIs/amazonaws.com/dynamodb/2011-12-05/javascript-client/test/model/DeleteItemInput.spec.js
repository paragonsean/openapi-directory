...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.DeleteItemInput();
  });
  ...
  describe('DeleteItemInput', function() {
    it('should create an instance of DeleteItemInput', function() {
      // uncomment below and update the code to test DeleteItemInput
      //var instance = new AmazonDynamoDb.DeleteItemInput();
      //expect(instance).to.be.a(AmazonDynamoDb.DeleteItemInput);
    });
