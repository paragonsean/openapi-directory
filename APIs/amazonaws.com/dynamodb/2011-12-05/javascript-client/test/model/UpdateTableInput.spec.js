...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.UpdateTableInput();
  });
  ...
  describe('UpdateTableInput', function() {
    it('should create an instance of UpdateTableInput', function() {
      // uncomment below and update the code to test UpdateTableInput
      //var instance = new AmazonDynamoDb.UpdateTableInput();
      //expect(instance).to.be.a(AmazonDynamoDb.UpdateTableInput);
    });
