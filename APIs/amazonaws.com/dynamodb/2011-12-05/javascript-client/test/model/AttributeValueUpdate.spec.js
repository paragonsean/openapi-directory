...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.AttributeValueUpdate();
  });
  ...
  describe('AttributeValueUpdate', function() {
    it('should create an instance of AttributeValueUpdate', function() {
      // uncomment below and update the code to test AttributeValueUpdate
      //var instance = new AmazonDynamoDb.AttributeValueUpdate();
      //expect(instance).to.be.a(AmazonDynamoDb.AttributeValueUpdate);
    });
