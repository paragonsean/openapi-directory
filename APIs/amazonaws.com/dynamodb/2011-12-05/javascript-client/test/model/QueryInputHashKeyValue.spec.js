...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.QueryInputHashKeyValue();
  });
  ...
  describe('QueryInputHashKeyValue', function() {
    it('should create an instance of QueryInputHashKeyValue', function() {
      // uncomment below and update the code to test QueryInputHashKeyValue
      //var instance = new AmazonDynamoDb.QueryInputHashKeyValue();
      //expect(instance).to.be.a(AmazonDynamoDb.QueryInputHashKeyValue);
    });
