...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.BatchGetItemInput();
  });
  ...
  describe('BatchGetItemInput', function() {
    it('should create an instance of BatchGetItemInput', function() {
      // uncomment below and update the code to test BatchGetItemInput
      //var instance = new AmazonDynamoDb.BatchGetItemInput();
      //expect(instance).to.be.a(AmazonDynamoDb.BatchGetItemInput);
    });
