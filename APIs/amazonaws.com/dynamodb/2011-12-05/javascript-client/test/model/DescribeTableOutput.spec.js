...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.DescribeTableOutput();
  });
  ...
  describe('DescribeTableOutput', function() {
    it('should create an instance of DescribeTableOutput', function() {
      // uncomment below and update the code to test DescribeTableOutput
      //var instance = new AmazonDynamoDb.DescribeTableOutput();
      //expect(instance).to.be.a(AmazonDynamoDb.DescribeTableOutput);
    });
