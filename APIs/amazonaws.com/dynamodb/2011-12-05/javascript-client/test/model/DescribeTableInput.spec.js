...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.DescribeTableInput();
  });
  ...
  describe('DescribeTableInput', function() {
    it('should create an instance of DescribeTableInput', function() {
      // uncomment below and update the code to test DescribeTableInput
      //var instance = new AmazonDynamoDb.DescribeTableInput();
      //expect(instance).to.be.a(AmazonDynamoDb.DescribeTableInput);
    });
