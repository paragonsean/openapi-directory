...
(function(root, factory) {
  ...
  describe('ScalarAttributeType', function() {
    it('should create an instance of ScalarAttributeType', function() {
      // uncomment below and update the code to test ScalarAttributeType
      //var instance = new AmazonDynamoDb.ScalarAttributeType();
      //expect(instance).to.be.a(AmazonDynamoDb.ScalarAttributeType);
    });
