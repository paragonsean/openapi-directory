...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.KeySchemaHashKeyElement();
  });
  ...
  describe('KeySchemaHashKeyElement', function() {
    it('should create an instance of KeySchemaHashKeyElement', function() {
      // uncomment below and update the code to test KeySchemaHashKeyElement
      //var instance = new AmazonDynamoDb.KeySchemaHashKeyElement();
      //expect(instance).to.be.a(AmazonDynamoDb.KeySchemaHashKeyElement);
    });
