...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.PutItemInput();
  });
  ...
  describe('PutItemInput', function() {
    it('should create an instance of PutItemInput', function() {
      // uncomment below and update the code to test PutItemInput
      //var instance = new AmazonDynamoDb.PutItemInput();
      //expect(instance).to.be.a(AmazonDynamoDb.PutItemInput);
    });
