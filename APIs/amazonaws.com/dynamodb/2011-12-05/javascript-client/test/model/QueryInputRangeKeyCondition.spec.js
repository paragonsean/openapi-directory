...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.QueryInputRangeKeyCondition();
  });
  ...
  describe('QueryInputRangeKeyCondition', function() {
    it('should create an instance of QueryInputRangeKeyCondition', function() {
      // uncomment below and update the code to test QueryInputRangeKeyCondition
      //var instance = new AmazonDynamoDb.QueryInputRangeKeyCondition();
      //expect(instance).to.be.a(AmazonDynamoDb.QueryInputRangeKeyCondition);
    });
