...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.BatchWriteItemOutput();
  });
  ...
  describe('BatchWriteItemOutput', function() {
    it('should create an instance of BatchWriteItemOutput', function() {
      // uncomment below and update the code to test BatchWriteItemOutput
      //var instance = new AmazonDynamoDb.BatchWriteItemOutput();
      //expect(instance).to.be.a(AmazonDynamoDb.BatchWriteItemOutput);
    });
    ...
    it('should have the property unprocessedItems (base name: "UnprocessedItems")', function() {
      // uncomment below and update the code to test the property unprocessedItems
      //var instance = new AmazonDynamoDb.BatchWriteItemOutput();
      //expect(instance).to.be();
    });
