...
/**
 * The KeyRangeKeyElement model module.
 * @module model/KeyRangeKeyElement
 * @version 2011-12-05
 */
class KeyRangeKeyElement {
    /**
     * Constructs a new <code>KeyRangeKeyElement</code>.
     * @alias module:model/KeyRangeKeyElement
     * @implements module:model/AttributeValue
     */
    constructor() { 
        AttributeValue.initialize(this);
        KeyRangeKeyElement.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KeyRangeKeyElement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyRangeKeyElement} obj Optional instance to populate.
     * @return {module:model/KeyRangeKeyElement} The populated <code>KeyRangeKeyElement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyRangeKeyElement();
    ...
    /**
     * Validates the JSON data with respect to <code>KeyRangeKeyElement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyRangeKeyElement</code>.
     */
 ...
 * @member {String} S
 */
KeyRangeKeyElement.prototype['S'] = undefined;

/**
 * @member {String} N
 */
KeyRangeKeyElement.prototype['N'] = undefined;

/**
 * @member {String} B
 */
KeyRangeKeyElement.prototype['B'] = undefined;

/**
 * @member {Array} SS
 */
KeyRangeKeyElement.prototype['SS'] = undefined;

/**
 * @member {Array} NS
 */
KeyRangeKeyElement.prototype['NS'] = undefined;

/**
 * @member {Array} BS
 */
KeyRangeKeyElement.prototype['BS'] = undefined;
...
export default KeyRangeKeyElement;
