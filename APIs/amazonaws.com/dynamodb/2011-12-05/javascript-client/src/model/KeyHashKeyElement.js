...
/**
 * The KeyHashKeyElement model module.
 * @module model/KeyHashKeyElement
 * @version 2011-12-05
 */
class KeyHashKeyElement {
    /**
     * Constructs a new <code>KeyHashKeyElement</code>.
     * @alias module:model/KeyHashKeyElement
     * @implements module:model/AttributeValue
     */
    constructor() { 
        AttributeValue.initialize(this);
        KeyHashKeyElement.initialize(this);
    }
    ...
    /**
     * Constructs a <code>KeyHashKeyElement</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyHashKeyElement} obj Optional instance to populate.
     * @return {module:model/KeyHashKeyElement} The populated <code>KeyHashKeyElement</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyHashKeyElement();
    ...
    /**
     * Validates the JSON data with respect to <code>KeyHashKeyElement</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyHashKeyElement</code>.
     */
 ...
 * @member {String} S
 */
KeyHashKeyElement.prototype['S'] = undefined;

/**
 * @member {String} N
 */
KeyHashKeyElement.prototype['N'] = undefined;

/**
 * @member {String} B
 */
KeyHashKeyElement.prototype['B'] = undefined;

/**
 * @member {Array} SS
 */
KeyHashKeyElement.prototype['SS'] = undefined;

/**
 * @member {Array} NS
 */
KeyHashKeyElement.prototype['NS'] = undefined;

/**
 * @member {Array} BS
 */
KeyHashKeyElement.prototype['BS'] = undefined;
...
export default KeyHashKeyElement;
