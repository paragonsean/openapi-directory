...
public class DeleteItemInput {
  ...
  public DeleteItemInput key(Key key) {
    this.key = key;
    return this;
  }
  ...
  public DeleteItemInput expected(Map<String, ExpectedAttributeValue> expected) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tableName, key, expected, returnValues);
  }
