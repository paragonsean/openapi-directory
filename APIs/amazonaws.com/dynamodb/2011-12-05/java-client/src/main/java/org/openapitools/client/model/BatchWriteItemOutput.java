...
public class BatchWriteItemOutput {
  ...
  public BatchWriteItemOutput responses(Map responses) {
  ...
  public BatchWriteItemOutput unprocessedItems(Map unprocessedItems) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.responses, batchWriteItemOutput.responses) &&
        Objects.equals(this.unprocessedItems, batchWriteItemOutput.unprocessedItems);
  }

  @Override
  public int hashCode() {
    return Objects.hash(responses, unprocessedItems);
  }
  ...
  static {
    ...
    openapiFields.add("UnprocessedItems");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("UnprocessedItems") != null && !jsonObj.get("UnprocessedItems").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("UnprocessedItems"));
      }
  }
