...
class DeleteRequestKey(Model):
    ...
    def __init__(self, hash_key_element: KeyHashKeyElement=None, range_key_element: KeyRangeKeyElement=None):
        """DeleteRequestKey - a model defined in OpenAPI

        :param hash_key_element: The hash_key_element of this DeleteRequestKey.
        :param range_key_element: The range_key_element of this DeleteRequestKey.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteRequestKey':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteRequest_Key of this DeleteRequestKey.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def hash_key_element(self):
        """Gets the hash_key_element of this DeleteRequestKey.


        :return: The hash_key_element of this DeleteRequestKey.
    ...
    def hash_key_element(self, hash_key_element):
        """Sets the hash_key_element of this DeleteRequestKey.
    ...
    def range_key_element(self):
        """Gets the range_key_element of this DeleteRequestKey.


        :return: The range_key_element of this DeleteRequestKey.
    ...
    def range_key_element(self, range_key_element):
        """Sets the range_key_element of this DeleteRequestKey.
