...
class QueryInputExclusiveStartKey(Model):
    ...
    def __init__(self, hash_key_element: KeyHashKeyElement=None, range_key_element: KeyRangeKeyElement=None):
        """QueryInputExclusiveStartKey - a model defined in OpenAPI

        :param hash_key_element: The hash_key_element of this QueryInputExclusiveStartKey.
        :param range_key_element: The range_key_element of this QueryInputExclusiveStartKey.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'QueryInputExclusiveStartKey':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The QueryInput_ExclusiveStartKey of this QueryInputExclusiveStartKey.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def hash_key_element(self):
        """Gets the hash_key_element of this QueryInputExclusiveStartKey.


        :return: The hash_key_element of this QueryInputExclusiveStartKey.
    ...
    def hash_key_element(self, hash_key_element):
        """Sets the hash_key_element of this QueryInputExclusiveStartKey.
    ...
    def range_key_element(self):
        """Gets the range_key_element of this QueryInputExclusiveStartKey.


        :return: The range_key_element of this QueryInputExclusiveStartKey.
    ...
    def range_key_element(self, range_key_element):
        """Sets the range_key_element of this QueryInputExclusiveStartKey.
