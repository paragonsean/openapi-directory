...
QString Example::create(){
    QString obj;
OAIBatchGetItemInput Example::create(){
    OAIBatchGetItemInput obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::batchGetItemSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::batchGetItemSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIBatchGetItemInput oai_batch_get_item_input = create(); // OAIBatchGetItemInput | 
      ...
      QString request_items = create(); // QString | Pagination token
      apiInstance.batchGetItem(x_amz_targetoai_batch_get_item_inputx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headersrequest_items);
