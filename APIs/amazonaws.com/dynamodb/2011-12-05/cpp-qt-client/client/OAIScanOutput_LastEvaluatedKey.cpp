...
OAIScanOutput_LastEvaluatedKey::OAIScanOutput_LastEvaluatedKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScanOutput_LastEvaluatedKey::OAIScanOutput_LastEvaluatedKey() {
    this->initializeModel();
}

OAIScanOutput_LastEvaluatedKey::~OAIScanOutput_LastEvaluatedKey() {}

void OAIScanOutput_LastEvaluatedKey::initializeModel() {
...
void OAIScanOutput_LastEvaluatedKey::fromJson(QString jsonString) {
...
void OAIScanOutput_LastEvaluatedKey::fromJsonObject(QJsonObject json) {
...
QString OAIScanOutput_LastEvaluatedKey::asJson() const {
...
QJsonObject OAIScanOutput_LastEvaluatedKey::asJsonObject() const {
    QJsonObject obj;
...
OAIKey_HashKeyElement OAIScanOutput_LastEvaluatedKey::getHashKeyElement() const {
    return m_hash_key_element;
}
void OAIScanOutput_LastEvaluatedKey::setHashKeyElement(const OAIKey_HashKeyElement &hash_key_element) {
    m_hash_key_element = hash_key_element;
    m_hash_key_element_isSet = true;
}

bool OAIScanOutput_LastEvaluatedKey::is_hash_key_element_Set() const{
    return m_hash_key_element_isSet;
}

bool OAIScanOutput_LastEvaluatedKey::is_hash_key_element_Valid() const{
    return m_hash_key_element_isValid;
}

OAIKey_RangeKeyElement OAIScanOutput_LastEvaluatedKey::getRangeKeyElement() const {
    return m_range_key_element;
}
void OAIScanOutput_LastEvaluatedKey::setRangeKeyElement(const OAIKey_RangeKeyElement &range_key_element) {
    m_range_key_element = range_key_element;
    m_range_key_element_isSet = true;
}

bool OAIScanOutput_LastEvaluatedKey::is_range_key_element_Set() const{
    return m_range_key_element_isSet;
}

bool OAIScanOutput_LastEvaluatedKey::is_range_key_element_Valid() const{
    return m_range_key_element_isValid;
}

bool OAIScanOutput_LastEvaluatedKey::isSet() const {
...
bool OAIScanOutput_LastEvaluatedKey::isValid() const {
