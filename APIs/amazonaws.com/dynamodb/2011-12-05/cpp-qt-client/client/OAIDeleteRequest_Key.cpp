...
OAIDeleteRequest_Key::OAIDeleteRequest_Key(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRequest_Key::OAIDeleteRequest_Key() {
    this->initializeModel();
}

OAIDeleteRequest_Key::~OAIDeleteRequest_Key() {}

void OAIDeleteRequest_Key::initializeModel() {
...
void OAIDeleteRequest_Key::fromJson(QString jsonString) {
...
void OAIDeleteRequest_Key::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRequest_Key::asJson() const {
...
QJsonObject OAIDeleteRequest_Key::asJsonObject() const {
    QJsonObject obj;
...
OAIKey_HashKeyElement OAIDeleteRequest_Key::getHashKeyElement() const {
    return m_hash_key_element;
}
void OAIDeleteRequest_Key::setHashKeyElement(const OAIKey_HashKeyElement &hash_key_element) {
    m_hash_key_element = hash_key_element;
    m_hash_key_element_isSet = true;
}

bool OAIDeleteRequest_Key::is_hash_key_element_Set() const{
    return m_hash_key_element_isSet;
}

bool OAIDeleteRequest_Key::is_hash_key_element_Valid() const{
    return m_hash_key_element_isValid;
}

OAIKey_RangeKeyElement OAIDeleteRequest_Key::getRangeKeyElement() const {
    return m_range_key_element;
}
void OAIDeleteRequest_Key::setRangeKeyElement(const OAIKey_RangeKeyElement &range_key_element) {
    m_range_key_element = range_key_element;
    m_range_key_element_isSet = true;
}

bool OAIDeleteRequest_Key::is_range_key_element_Set() const{
    return m_range_key_element_isSet;
}

bool OAIDeleteRequest_Key::is_range_key_element_Valid() const{
    return m_range_key_element_isValid;
}

bool OAIDeleteRequest_Key::isSet() const {
...
bool OAIDeleteRequest_Key::isValid() const {
