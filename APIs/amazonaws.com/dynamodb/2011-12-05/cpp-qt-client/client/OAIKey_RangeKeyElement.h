...
/*
 * OAIKey_RangeKeyElement.h
 *
 * 
 */

#ifndef OAIKey_RangeKeyElement_H
#define OAIKey_RangeKeyElement_H
...
class OAIKey_RangeKeyElement : public OAIObject {
public:
    OAIKey_RangeKeyElement();
    OAIKey_RangeKeyElement(QString json);
    ~OAIKey_RangeKeyElement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKey_RangeKeyElement)

#endif // OAIKey_RangeKeyElement_H
