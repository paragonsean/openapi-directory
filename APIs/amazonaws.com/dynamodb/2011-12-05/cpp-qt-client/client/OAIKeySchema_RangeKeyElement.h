...
/*
 * OAIKeySchema_RangeKeyElement.h
 *
 * 
 */

#ifndef OAIKeySchema_RangeKeyElement_H
#define OAIKeySchema_RangeKeyElement_H
...
class OAIKeySchema_RangeKeyElement : public OAIObject {
public:
    OAIKeySchema_RangeKeyElement();
    OAIKeySchema_RangeKeyElement(QString json);
    ~OAIKeySchema_RangeKeyElement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKeySchema_RangeKeyElement)

#endif // OAIKeySchema_RangeKeyElement_H
