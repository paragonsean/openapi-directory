...
/*
 * OAIQueryInput_HashKeyValue.h
 *
 * 
 */

#ifndef OAIQueryInput_HashKeyValue_H
#define OAIQueryInput_HashKeyValue_H
...
class OAIQueryInput_HashKeyValue : public OAIObject {
public:
    OAIQueryInput_HashKeyValue();
    OAIQueryInput_HashKeyValue(QString json);
    ~OAIQueryInput_HashKeyValue() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryInput_HashKeyValue)

#endif // OAIQueryInput_HashKeyValue_H
