...
OAIQueryInput_ExclusiveStartKey::OAIQueryInput_ExclusiveStartKey(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQueryInput_ExclusiveStartKey::OAIQueryInput_ExclusiveStartKey() {
    this->initializeModel();
}

OAIQueryInput_ExclusiveStartKey::~OAIQueryInput_ExclusiveStartKey() {}

void OAIQueryInput_ExclusiveStartKey::initializeModel() {
...
void OAIQueryInput_ExclusiveStartKey::fromJson(QString jsonString) {
...
void OAIQueryInput_ExclusiveStartKey::fromJsonObject(QJsonObject json) {
...
QString OAIQueryInput_ExclusiveStartKey::asJson() const {
...
QJsonObject OAIQueryInput_ExclusiveStartKey::asJsonObject() const {
    QJsonObject obj;
...
OAIKey_HashKeyElement OAIQueryInput_ExclusiveStartKey::getHashKeyElement() const {
    return m_hash_key_element;
}
void OAIQueryInput_ExclusiveStartKey::setHashKeyElement(const OAIKey_HashKeyElement &hash_key_element) {
    m_hash_key_element = hash_key_element;
    m_hash_key_element_isSet = true;
}

bool OAIQueryInput_ExclusiveStartKey::is_hash_key_element_Set() const{
    return m_hash_key_element_isSet;
}

bool OAIQueryInput_ExclusiveStartKey::is_hash_key_element_Valid() const{
    return m_hash_key_element_isValid;
}

OAIKey_RangeKeyElement OAIQueryInput_ExclusiveStartKey::getRangeKeyElement() const {
    return m_range_key_element;
}
void OAIQueryInput_ExclusiveStartKey::setRangeKeyElement(const OAIKey_RangeKeyElement &range_key_element) {
    m_range_key_element = range_key_element;
    m_range_key_element_isSet = true;
}

bool OAIQueryInput_ExclusiveStartKey::is_range_key_element_Set() const{
    return m_range_key_element_isSet;
}

bool OAIQueryInput_ExclusiveStartKey::is_range_key_element_Valid() const{
    return m_range_key_element_isValid;
}

bool OAIQueryInput_ExclusiveStartKey::isSet() const {
...
bool OAIQueryInput_ExclusiveStartKey::isValid() const {
