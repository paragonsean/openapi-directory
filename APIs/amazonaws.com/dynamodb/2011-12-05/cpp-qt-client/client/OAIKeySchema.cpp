...
OAIKeySchema::OAIKeySchema(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKeySchema::OAIKeySchema() {
    this->initializeModel();
}

OAIKeySchema::~OAIKeySchema() {}

void OAIKeySchema::initializeModel() {
...
void OAIKeySchema::fromJson(QString jsonString) {
...
void OAIKeySchema::fromJsonObject(QJsonObject json) {
...
QString OAIKeySchema::asJson() const {
...
QJsonObject OAIKeySchema::asJsonObject() const {
    QJsonObject obj;
...
OAIKeySchema_HashKeyElement OAIKeySchema::getHashKeyElement() const {
    return m_hash_key_element;
}
void OAIKeySchema::setHashKeyElement(const OAIKeySchema_HashKeyElement &hash_key_element) {
    m_hash_key_element = hash_key_element;
    m_hash_key_element_isSet = true;
}

bool OAIKeySchema::is_hash_key_element_Set() const{
    return m_hash_key_element_isSet;
}

bool OAIKeySchema::is_hash_key_element_Valid() const{
    return m_hash_key_element_isValid;
}

OAIKeySchema_RangeKeyElement OAIKeySchema::getRangeKeyElement() const {
    return m_range_key_element;
}
void OAIKeySchema::setRangeKeyElement(const OAIKeySchema_RangeKeyElement &range_key_element) {
    m_range_key_element = range_key_element;
    m_range_key_element_isSet = true;
}

bool OAIKeySchema::is_range_key_element_Set() const{
    return m_range_key_element_isSet;
}

bool OAIKeySchema::is_range_key_element_Valid() const{
    return m_range_key_element_isValid;
}

bool OAIKeySchema::isSet() const {
...
bool OAIKeySchema::isValid() const {
