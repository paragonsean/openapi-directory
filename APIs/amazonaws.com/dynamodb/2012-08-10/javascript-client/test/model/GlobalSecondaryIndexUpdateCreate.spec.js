...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.GlobalSecondaryIndexUpdateCreate();
  });
  ...
  describe('GlobalSecondaryIndexUpdateCreate', function() {
    it('should create an instance of GlobalSecondaryIndexUpdateCreate', function() {
      // uncomment below and update the code to test GlobalSecondaryIndexUpdateCreate
      //var instance = new AmazonDynamoDb.GlobalSecondaryIndexUpdateCreate();
      //expect(instance).to.be.a(AmazonDynamoDb.GlobalSecondaryIndexUpdateCreate);
    });
