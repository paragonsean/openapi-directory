...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.GlobalSecondaryIndexInfo();
  });
  ...
  describe('GlobalSecondaryIndexInfo', function() {
    it('should create an instance of GlobalSecondaryIndexInfo', function() {
      // uncomment below and update the code to test GlobalSecondaryIndexInfo
      //var instance = new AmazonDynamoDb.GlobalSecondaryIndexInfo();
      //expect(instance).to.be.a(AmazonDynamoDb.GlobalSecondaryIndexInfo);
    });
