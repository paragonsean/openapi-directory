...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.LocalSecondaryIndex();
  });
  ...
  describe('LocalSecondaryIndex', function() {
    it('should create an instance of LocalSecondaryIndex', function() {
      // uncomment below and update the code to test LocalSecondaryIndex
      //var instance = new AmazonDynamoDb.LocalSecondaryIndex();
      //expect(instance).to.be.a(AmazonDynamoDb.LocalSecondaryIndex);
    });
