...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.LocalSecondaryIndexInfo();
  });
  ...
  describe('LocalSecondaryIndexInfo', function() {
    it('should create an instance of LocalSecondaryIndexInfo', function() {
      // uncomment below and update the code to test LocalSecondaryIndexInfo
      //var instance = new AmazonDynamoDb.LocalSecondaryIndexInfo();
      //expect(instance).to.be.a(AmazonDynamoDb.LocalSecondaryIndexInfo);
    });
