...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.GlobalSecondaryIndex();
  });
  ...
  describe('GlobalSecondaryIndex', function() {
    it('should create an instance of GlobalSecondaryIndex', function() {
      // uncomment below and update the code to test GlobalSecondaryIndex
      //var instance = new AmazonDynamoDb.GlobalSecondaryIndex();
      //expect(instance).to.be.a(AmazonDynamoDb.GlobalSecondaryIndex);
    });
