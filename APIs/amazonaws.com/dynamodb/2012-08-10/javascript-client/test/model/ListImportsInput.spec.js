...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.ListImportsInput();
  });
  ...
  describe('ListImportsInput', function() {
    it('should create an instance of ListImportsInput', function() {
      // uncomment below and update the code to test ListImportsInput
      //var instance = new AmazonDynamoDb.ListImportsInput();
      //expect(instance).to.be.a(AmazonDynamoDb.ListImportsInput);
    });
