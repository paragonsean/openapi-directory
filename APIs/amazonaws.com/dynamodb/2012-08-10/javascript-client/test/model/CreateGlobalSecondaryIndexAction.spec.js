...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.CreateGlobalSecondaryIndexAction();
  });
  ...
  describe('CreateGlobalSecondaryIndexAction', function() {
    it('should create an instance of CreateGlobalSecondaryIndexAction', function() {
      // uncomment below and update the code to test CreateGlobalSecondaryIndexAction
      //var instance = new AmazonDynamoDb.CreateGlobalSecondaryIndexAction();
      //expect(instance).to.be.a(AmazonDynamoDb.CreateGlobalSecondaryIndexAction);
    });
