...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.ReplicaUpdate();
  });
  ...
  describe('ReplicaUpdate', function() {
    it('should create an instance of ReplicaUpdate', function() {
      // uncomment below and update the code to test ReplicaUpdate
      //var instance = new AmazonDynamoDb.ReplicaUpdate();
      //expect(instance).to.be.a(AmazonDynamoDb.ReplicaUpdate);
    });
