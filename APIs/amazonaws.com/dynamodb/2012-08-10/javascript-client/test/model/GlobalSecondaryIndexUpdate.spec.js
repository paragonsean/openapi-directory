...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.GlobalSecondaryIndexUpdate();
  });
  ...
  describe('GlobalSecondaryIndexUpdate', function() {
    it('should create an instance of GlobalSecondaryIndexUpdate', function() {
      // uncomment below and update the code to test GlobalSecondaryIndexUpdate
      //var instance = new AmazonDynamoDb.GlobalSecondaryIndexUpdate();
      //expect(instance).to.be.a(AmazonDynamoDb.GlobalSecondaryIndexUpdate);
    });
