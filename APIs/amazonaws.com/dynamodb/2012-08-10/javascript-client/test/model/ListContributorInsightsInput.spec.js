...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.ListContributorInsightsInput();
  });
  ...
  describe('ListContributorInsightsInput', function() {
    it('should create an instance of ListContributorInsightsInput', function() {
      // uncomment below and update the code to test ListContributorInsightsInput
      //var instance = new AmazonDynamoDb.ListContributorInsightsInput();
      //expect(instance).to.be.a(AmazonDynamoDb.ListContributorInsightsInput);
    });
