...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.ListTagsOfResourceInput();
  });
  ...
  describe('ListTagsOfResourceInput', function() {
    it('should create an instance of ListTagsOfResourceInput', function() {
      // uncomment below and update the code to test ListTagsOfResourceInput
      //var instance = new AmazonDynamoDb.ListTagsOfResourceInput();
      //expect(instance).to.be.a(AmazonDynamoDb.ListTagsOfResourceInput);
    });
