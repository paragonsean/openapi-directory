...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.SourceTableDetails();
  });
  ...
  describe('SourceTableDetails', function() {
    it('should create an instance of SourceTableDetails', function() {
      // uncomment below and update the code to test SourceTableDetails
      //var instance = new AmazonDynamoDb.SourceTableDetails();
      //expect(instance).to.be.a(AmazonDynamoDb.SourceTableDetails);
    });
