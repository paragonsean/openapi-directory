...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDynamoDb.ReplicationGroupUpdate();
  });
  ...
  describe('ReplicationGroupUpdate', function() {
    it('should create an instance of ReplicationGroupUpdate', function() {
      // uncomment below and update the code to test ReplicationGroupUpdate
      //var instance = new AmazonDynamoDb.ReplicationGroupUpdate();
      //expect(instance).to.be.a(AmazonDynamoDb.ReplicationGroupUpdate);
    });
