...
class Capacity(Model):
    ...
    def __init__(self, read_capacity_units: float=None, write_capacity_units: float=None, capacity_units: float=None):
        ...
        :param read_capacity_units: The read_capacity_units of this Capacity.
        :param write_capacity_units: The write_capacity_units of this Capacity.
        :param capacity_units: The capacity_units of this Capacity.
        """
        self.openapi_types = {
    ...
    def read_capacity_units(self):
        """Gets the read_capacity_units of this Capacity.


        :return: The read_capacity_units of this Capacity.
        :rtype: float
        """
    ...
    def read_capacity_units(self, read_capacity_units):
        """Sets the read_capacity_units of this Capacity.
    ...
    def write_capacity_units(self):
        """Gets the write_capacity_units of this Capacity.


        :return: The write_capacity_units of this Capacity.
        :rtype: float
        """
    ...
    def write_capacity_units(self, write_capacity_units):
        """Sets the write_capacity_units of this Capacity.
    ...
    def capacity_units(self):
        """Gets the capacity_units of this Capacity.


        :return: The capacity_units of this Capacity.
        :rtype: float
        """
    ...
    def capacity_units(self, capacity_units):
        """Sets the capacity_units of this Capacity.
