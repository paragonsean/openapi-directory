...
public class DescribeExportOutputExportDescription {
  ...
  public DescribeExportOutputExportDescription() {
  }

  public DescribeExportOutputExportDescription exportArn(String exportArn) {
  ...
  public DescribeExportOutputExportDescription exportStatus(ExportStatus exportStatus) {
  ...
  public DescribeExportOutputExportDescription startTime(OffsetDateTime startTime) {
  ...
  public DescribeExportOutputExportDescription endTime(OffsetDateTime endTime) {
  ...
  public DescribeExportOutputExportDescription exportManifest(String exportManifest) {
  ...
  public DescribeExportOutputExportDescription tableArn(String tableArn) {
  ...
  public DescribeExportOutputExportDescription tableId(String tableId) {
  ...
  public DescribeExportOutputExportDescription exportTime(OffsetDateTime exportTime) {
  ...
  public DescribeExportOutputExportDescription clientToken(String clientToken) {
  ...
  public DescribeExportOutputExportDescription s3Bucket(String s3Bucket) {
  ...
  public DescribeExportOutputExportDescription s3BucketOwner(String s3BucketOwner) {
  ...
  public DescribeExportOutputExportDescription s3Prefix(String s3Prefix) {
  ...
  public DescribeExportOutputExportDescription s3SseAlgorithm(S3SseAlgorithm s3SseAlgorithm) {
  ...
  public DescribeExportOutputExportDescription s3SseKmsKeyId(String s3SseKmsKeyId) {
  ...
  public DescribeExportOutputExportDescription failureCode(String failureCode) {
  ...
  public DescribeExportOutputExportDescription failureMessage(String failureMessage) {
  ...
  public DescribeExportOutputExportDescription exportFormat(ExportFormat exportFormat) {
  ...
  public DescribeExportOutputExportDescription billedSizeBytes(Integer billedSizeBytes) {
  ...
  public DescribeExportOutputExportDescription itemCount(Integer itemCount) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeExportOutputExportDescription describeExportOutputExportDescription = (DescribeExportOutputExportDescription) o;
    return Objects.equals(this.exportArn, describeExportOutputExportDescription.exportArn) &&
        Objects.equals(this.exportStatus, describeExportOutputExportDescription.exportStatus) &&
        Objects.equals(this.startTime, describeExportOutputExportDescription.startTime) &&
        Objects.equals(this.endTime, describeExportOutputExportDescription.endTime) &&
        Objects.equals(this.exportManifest, describeExportOutputExportDescription.exportManifest) &&
        Objects.equals(this.tableArn, describeExportOutputExportDescription.tableArn) &&
        Objects.equals(this.tableId, describeExportOutputExportDescription.tableId) &&
        Objects.equals(this.exportTime, describeExportOutputExportDescription.exportTime) &&
        Objects.equals(this.clientToken, describeExportOutputExportDescription.clientToken) &&
        Objects.equals(this.s3Bucket, describeExportOutputExportDescription.s3Bucket) &&
        Objects.equals(this.s3BucketOwner, describeExportOutputExportDescription.s3BucketOwner) &&
        Objects.equals(this.s3Prefix, describeExportOutputExportDescription.s3Prefix) &&
        Objects.equals(this.s3SseAlgorithm, describeExportOutputExportDescription.s3SseAlgorithm) &&
        Objects.equals(this.s3SseKmsKeyId, describeExportOutputExportDescription.s3SseKmsKeyId) &&
        Objects.equals(this.failureCode, describeExportOutputExportDescription.failureCode) &&
        Objects.equals(this.failureMessage, describeExportOutputExportDescription.failureMessage) &&
        Objects.equals(this.exportFormat, describeExportOutputExportDescription.exportFormat) &&
        Objects.equals(this.billedSizeBytes, describeExportOutputExportDescription.billedSizeBytes) &&
        Objects.equals(this.itemCount, describeExportOutputExportDescription.itemCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeExportOutputExportDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeExportOutputExportDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeExportOutputExportDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeExportOutputExportDescription is not found in the empty JSON string", DescribeExportOutputExportDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeExportOutputExportDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeExportOutputExportDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeExportOutputExportDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeExportOutputExportDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeExportOutputExportDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeExportOutputExportDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeExportOutputExportDescription>() {
           @Override
           public void write(JsonWriter out, DescribeExportOutputExportDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeExportOutputExportDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeExportOutputExportDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeExportOutputExportDescription
   * @throws IOException if the JSON string is invalid with respect to DescribeExportOutputExportDescription
   */
  public static DescribeExportOutputExportDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeExportOutputExportDescription.class);
  }

  /**
   * Convert an instance of DescribeExportOutputExportDescription to an JSON string
   *
   * @return JSON string
   */
