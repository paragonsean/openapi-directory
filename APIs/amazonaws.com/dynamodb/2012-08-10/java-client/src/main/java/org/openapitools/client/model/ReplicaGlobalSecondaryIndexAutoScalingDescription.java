...
public class ReplicaGlobalSecondaryIndexAutoScalingDescription {
  ...
  public ReplicaGlobalSecondaryIndexAutoScalingDescription indexName(String indexName) {
  ...
  public ReplicaGlobalSecondaryIndexAutoScalingDescription indexStatus(IndexStatus indexStatus) {
  ...
  public ReplicaGlobalSecondaryIndexAutoScalingDescription provisionedReadCapacityAutoScalingSettings(AutoScalingSettingsDescription provisionedReadCapacityAutoScalingSettings) {
  ...
  public ReplicaGlobalSecondaryIndexAutoScalingDescription provisionedWriteCapacityAutoScalingSettings(AutoScalingSettingsDescription provisionedWriteCapacityAutoScalingSettings) {
