...
public class DeleteTableOutputTableDescription {
  ...
  public DeleteTableOutputTableDescription() {
  }

  public DeleteTableOutputTableDescription attributeDefinitions(List attributeDefinitions) {
  ...
  public DeleteTableOutputTableDescription tableName(String tableName) {
  ...
  public DeleteTableOutputTableDescription keySchema(List keySchema) {
  ...
  public DeleteTableOutputTableDescription tableStatus(TableStatus tableStatus) {
  ...
  public DeleteTableOutputTableDescription creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public DeleteTableOutputTableDescription provisionedThroughput(TableDescriptionProvisionedThroughput provisionedThroughput) {
  ...
  public DeleteTableOutputTableDescription tableSizeBytes(Integer tableSizeBytes) {
  ...
  public DeleteTableOutputTableDescription itemCount(Integer itemCount) {
  ...
  public DeleteTableOutputTableDescription tableArn(String tableArn) {
  ...
  public DeleteTableOutputTableDescription tableId(String tableId) {
  ...
  public DeleteTableOutputTableDescription billingModeSummary(TableDescriptionBillingModeSummary billingModeSummary) {
  ...
  public DeleteTableOutputTableDescription localSecondaryIndexes(List localSecondaryIndexes) {
  ...
  public DeleteTableOutputTableDescription globalSecondaryIndexes(List globalSecondaryIndexes) {
  ...
  public DeleteTableOutputTableDescription streamSpecification(TableDescriptionStreamSpecification streamSpecification) {
  ...
  public DeleteTableOutputTableDescription latestStreamLabel(String latestStreamLabel) {
  ...
  public DeleteTableOutputTableDescription latestStreamArn(String latestStreamArn) {
  ...
  public DeleteTableOutputTableDescription globalTableVersion(String globalTableVersion) {
  ...
  public DeleteTableOutputTableDescription replicas(List replicas) {
  ...
  public DeleteTableOutputTableDescription restoreSummary(TableDescriptionRestoreSummary restoreSummary) {
  ...
  public DeleteTableOutputTableDescription ssEDescription(TableDescriptionSSEDescription ssEDescription) {
  ...
  public DeleteTableOutputTableDescription archivalSummary(TableDescriptionArchivalSummary archivalSummary) {
  ...
  public DeleteTableOutputTableDescription tableClassSummary(TableDescriptionTableClassSummary tableClassSummary) {
  ...
  public DeleteTableOutputTableDescription deletionProtectionEnabled(Boolean deletionProtectionEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTableOutputTableDescription deleteTableOutputTableDescription = (DeleteTableOutputTableDescription) o;
    return Objects.equals(this.attributeDefinitions, deleteTableOutputTableDescription.attributeDefinitions) &&
        Objects.equals(this.tableName, deleteTableOutputTableDescription.tableName) &&
        Objects.equals(this.keySchema, deleteTableOutputTableDescription.keySchema) &&
        Objects.equals(this.tableStatus, deleteTableOutputTableDescription.tableStatus) &&
        Objects.equals(this.creationDateTime, deleteTableOutputTableDescription.creationDateTime) &&
        Objects.equals(this.provisionedThroughput, deleteTableOutputTableDescription.provisionedThroughput) &&
        Objects.equals(this.tableSizeBytes, deleteTableOutputTableDescription.tableSizeBytes) &&
        Objects.equals(this.itemCount, deleteTableOutputTableDescription.itemCount) &&
        Objects.equals(this.tableArn, deleteTableOutputTableDescription.tableArn) &&
        Objects.equals(this.tableId, deleteTableOutputTableDescription.tableId) &&
        Objects.equals(this.billingModeSummary, deleteTableOutputTableDescription.billingModeSummary) &&
        Objects.equals(this.localSecondaryIndexes, deleteTableOutputTableDescription.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, deleteTableOutputTableDescription.globalSecondaryIndexes) &&
        Objects.equals(this.streamSpecification, deleteTableOutputTableDescription.streamSpecification) &&
        Objects.equals(this.latestStreamLabel, deleteTableOutputTableDescription.latestStreamLabel) &&
        Objects.equals(this.latestStreamArn, deleteTableOutputTableDescription.latestStreamArn) &&
        Objects.equals(this.globalTableVersion, deleteTableOutputTableDescription.globalTableVersion) &&
        Objects.equals(this.replicas, deleteTableOutputTableDescription.replicas) &&
        Objects.equals(this.restoreSummary, deleteTableOutputTableDescription.restoreSummary) &&
        Objects.equals(this.ssEDescription, deleteTableOutputTableDescription.ssEDescription) &&
        Objects.equals(this.archivalSummary, deleteTableOutputTableDescription.archivalSummary) &&
        Objects.equals(this.tableClassSummary, deleteTableOutputTableDescription.tableClassSummary) &&
        Objects.equals(this.deletionProtectionEnabled, deleteTableOutputTableDescription.deletionProtectionEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTableOutputTableDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTableOutputTableDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTableOutputTableDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTableOutputTableDescription is not found in the empty JSON string", DeleteTableOutputTableDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTableOutputTableDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTableOutputTableDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTableOutputTableDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTableOutputTableDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTableOutputTableDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTableOutputTableDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTableOutputTableDescription>() {
           @Override
           public void write(JsonWriter out, DeleteTableOutputTableDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTableOutputTableDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTableOutputTableDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTableOutputTableDescription
   * @throws IOException if the JSON string is invalid with respect to DeleteTableOutputTableDescription
   */
  public static DeleteTableOutputTableDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTableOutputTableDescription.class);
  }

  /**
   * Convert an instance of DeleteTableOutputTableDescription to an JSON string
   *
   * @return JSON string
   */
