...
public class TransactWriteItemDelete {
  ...
  public TransactWriteItemDelete() {
  }

  public TransactWriteItemDelete key(Map key) {
    this.key = key;
    return this;
  }
  ...
  public TransactWriteItemDelete tableName(String tableName) {
  ...
  public TransactWriteItemDelete conditionExpression(String conditionExpression) {
  ...
  public TransactWriteItemDelete expressionAttributeNames(Map expressionAttributeNames) {
  ...
  public TransactWriteItemDelete expressionAttributeValues(Map expressionAttributeValues) {
  ...
  public TransactWriteItemDelete returnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
  ...
  public boolean equals(Object o) {
    ...
    TransactWriteItemDelete transactWriteItemDelete = (TransactWriteItemDelete) o;
    return Objects.equals(this.key, transactWriteItemDelete.key) &&
        Objects.equals(this.tableName, transactWriteItemDelete.tableName) &&
        Objects.equals(this.conditionExpression, transactWriteItemDelete.conditionExpression) &&
        Objects.equals(this.expressionAttributeNames, transactWriteItemDelete.expressionAttributeNames) &&
        Objects.equals(this.expressionAttributeValues, transactWriteItemDelete.expressionAttributeValues) &&
        Objects.equals(this.returnValuesOnConditionCheckFailure, transactWriteItemDelete.returnValuesOnConditionCheckFailure);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactWriteItemDelete {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransactWriteItemDelete
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactWriteItemDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactWriteItemDelete is not found in the empty JSON string", TransactWriteItemDelete.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactWriteItemDelete.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactWriteItemDelete` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactWriteItemDelete.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactWriteItemDelete.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactWriteItemDelete' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactWriteItemDelete> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactWriteItemDelete.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactWriteItemDelete>() {
           @Override
           public void write(JsonWriter out, TransactWriteItemDelete value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactWriteItemDelete read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransactWriteItemDelete given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransactWriteItemDelete
   * @throws IOException if the JSON string is invalid with respect to TransactWriteItemDelete
   */
  public static TransactWriteItemDelete fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactWriteItemDelete.class);
  }

  /**
   * Convert an instance of TransactWriteItemDelete to an JSON string
   *
   * @return JSON string
   */
