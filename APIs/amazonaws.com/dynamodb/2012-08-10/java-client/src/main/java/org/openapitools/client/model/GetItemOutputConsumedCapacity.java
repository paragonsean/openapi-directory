...
public class GetItemOutputConsumedCapacity {
  ...
  public GetItemOutputConsumedCapacity() {
  }

  public GetItemOutputConsumedCapacity tableName(String tableName) {
  ...
  public GetItemOutputConsumedCapacity capacityUnits(Double capacityUnits) {
  ...
  public GetItemOutputConsumedCapacity readCapacityUnits(Double readCapacityUnits) {
  ...
  public GetItemOutputConsumedCapacity writeCapacityUnits(Double writeCapacityUnits) {
  ...
  public GetItemOutputConsumedCapacity table(ConsumedCapacityTable table) {
    this.table = table;
    return this;
  }
  ...
  public GetItemOutputConsumedCapacity localSecondaryIndexes(Map localSecondaryIndexes) {
  ...
  public GetItemOutputConsumedCapacity globalSecondaryIndexes(Map globalSecondaryIndexes) {
  ...
  public boolean equals(Object o) {
    ...
    GetItemOutputConsumedCapacity getItemOutputConsumedCapacity = (GetItemOutputConsumedCapacity) o;
    return Objects.equals(this.tableName, getItemOutputConsumedCapacity.tableName) &&
        Objects.equals(this.capacityUnits, getItemOutputConsumedCapacity.capacityUnits) &&
        Objects.equals(this.readCapacityUnits, getItemOutputConsumedCapacity.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, getItemOutputConsumedCapacity.writeCapacityUnits) &&
        Objects.equals(this.table, getItemOutputConsumedCapacity.table) &&
        Objects.equals(this.localSecondaryIndexes, getItemOutputConsumedCapacity.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, getItemOutputConsumedCapacity.globalSecondaryIndexes);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetItemOutputConsumedCapacity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetItemOutputConsumedCapacity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetItemOutputConsumedCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetItemOutputConsumedCapacity is not found in the empty JSON string", GetItemOutputConsumedCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetItemOutputConsumedCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetItemOutputConsumedCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetItemOutputConsumedCapacity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetItemOutputConsumedCapacity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetItemOutputConsumedCapacity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetItemOutputConsumedCapacity.class));

       return (TypeAdapter<T>) new TypeAdapter<GetItemOutputConsumedCapacity>() {
           @Override
           public void write(JsonWriter out, GetItemOutputConsumedCapacity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetItemOutputConsumedCapacity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetItemOutputConsumedCapacity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetItemOutputConsumedCapacity
   * @throws IOException if the JSON string is invalid with respect to GetItemOutputConsumedCapacity
   */
  public static GetItemOutputConsumedCapacity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetItemOutputConsumedCapacity.class);
  }

  /**
   * Convert an instance of GetItemOutputConsumedCapacity to an JSON string
   *
   * @return JSON string
   */
