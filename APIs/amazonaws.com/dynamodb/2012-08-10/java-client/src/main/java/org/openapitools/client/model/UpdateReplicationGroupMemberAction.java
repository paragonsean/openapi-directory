...
public class UpdateReplicationGroupMemberAction {
  ...
  public UpdateReplicationGroupMemberAction regionName(String regionName) {
  ...
  public UpdateReplicationGroupMemberAction kmSMasterKeyId(String kmSMasterKeyId) {
  ...
  public UpdateReplicationGroupMemberAction provisionedThroughputOverride(CreateReplicationGroupMemberActionProvisionedThroughputOverride provisionedThroughputOverride) {
  ...
  public UpdateReplicationGroupMemberAction globalSecondaryIndexes(List globalSecondaryIndexes) {
  ...
  public UpdateReplicationGroupMemberAction tableClassOverride(TableClass tableClassOverride) {
