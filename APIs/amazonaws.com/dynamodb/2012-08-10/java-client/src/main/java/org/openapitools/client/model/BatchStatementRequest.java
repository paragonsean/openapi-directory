...
public class BatchStatementRequest {
  ...
  public BatchStatementRequest statement(String statement) {
  ...
  public BatchStatementRequest parameters(List parameters) {
  ...
  public BatchStatementRequest consistentRead(Boolean consistentRead) {
  ...
  public BatchStatementRequest returnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
