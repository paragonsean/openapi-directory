...
public class RestoreSummary {
  ...
  public RestoreSummary sourceBackupArn(String sourceBackupArn) {
  ...
  public RestoreSummary sourceTableArn(String sourceTableArn) {
  ...
  public RestoreSummary restoreDateTime(OffsetDateTime restoreDateTime) {
  ...
  public RestoreSummary restoreInProgress(Boolean restoreInProgress) {
