...
public class SSESpecification {
  ...
  public SSESpecification enabled(Boolean enabled) {
  ...
  public SSESpecification ssEType(SSEType ssEType) {
  ...
  public SSESpecification kmSMasterKeyId(String kmSMasterKeyId) {
