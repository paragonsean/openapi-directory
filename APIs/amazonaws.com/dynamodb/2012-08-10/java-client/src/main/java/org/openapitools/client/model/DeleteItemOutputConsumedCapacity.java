...
public class DeleteItemOutputConsumedCapacity {
  ...
  public DeleteItemOutputConsumedCapacity() {
  }

  public DeleteItemOutputConsumedCapacity tableName(String tableName) {
  ...
  public DeleteItemOutputConsumedCapacity capacityUnits(Double capacityUnits) {
  ...
  public DeleteItemOutputConsumedCapacity readCapacityUnits(Double readCapacityUnits) {
  ...
  public DeleteItemOutputConsumedCapacity writeCapacityUnits(Double writeCapacityUnits) {
  ...
  public DeleteItemOutputConsumedCapacity table(ConsumedCapacityTable table) {
    this.table = table;
    return this;
  }
  ...
  public DeleteItemOutputConsumedCapacity localSecondaryIndexes(Map localSecondaryIndexes) {
  ...
  public DeleteItemOutputConsumedCapacity globalSecondaryIndexes(Map globalSecondaryIndexes) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteItemOutputConsumedCapacity deleteItemOutputConsumedCapacity = (DeleteItemOutputConsumedCapacity) o;
    return Objects.equals(this.tableName, deleteItemOutputConsumedCapacity.tableName) &&
        Objects.equals(this.capacityUnits, deleteItemOutputConsumedCapacity.capacityUnits) &&
        Objects.equals(this.readCapacityUnits, deleteItemOutputConsumedCapacity.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, deleteItemOutputConsumedCapacity.writeCapacityUnits) &&
        Objects.equals(this.table, deleteItemOutputConsumedCapacity.table) &&
        Objects.equals(this.localSecondaryIndexes, deleteItemOutputConsumedCapacity.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, deleteItemOutputConsumedCapacity.globalSecondaryIndexes);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteItemOutputConsumedCapacity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteItemOutputConsumedCapacity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteItemOutputConsumedCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteItemOutputConsumedCapacity is not found in the empty JSON string", DeleteItemOutputConsumedCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteItemOutputConsumedCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteItemOutputConsumedCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteItemOutputConsumedCapacity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteItemOutputConsumedCapacity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteItemOutputConsumedCapacity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteItemOutputConsumedCapacity.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteItemOutputConsumedCapacity>() {
           @Override
           public void write(JsonWriter out, DeleteItemOutputConsumedCapacity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteItemOutputConsumedCapacity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteItemOutputConsumedCapacity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteItemOutputConsumedCapacity
   * @throws IOException if the JSON string is invalid with respect to DeleteItemOutputConsumedCapacity
   */
  public static DeleteItemOutputConsumedCapacity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteItemOutputConsumedCapacity.class);
  }

  /**
   * Convert an instance of DeleteItemOutputConsumedCapacity to an JSON string
   *
   * @return JSON string
   */
