...
import org.openapitools.client.model.ContinuousBackupsDescriptionPointInTimeRecoveryDescription;
...
public class ContinuousBackupsDescription {
  ...
  private ContinuousBackupsDescriptionPointInTimeRecoveryDescription pointInTimeRecoveryDescription;

  public ContinuousBackupsDescription() {
  }

  public ContinuousBackupsDescription continuousBackupsStatus(ContinuousBackupsStatus continuousBackupsStatus) {
  ...
  public ContinuousBackupsDescription pointInTimeRecoveryDescription(ContinuousBackupsDescriptionPointInTimeRecoveryDescription pointInTimeRecoveryDescription) {
  ...
  public ContinuousBackupsDescriptionPointInTimeRecoveryDescription getPointInTimeRecoveryDescription() {
    return pointInTimeRecoveryDescription;
  }

  public void setPointInTimeRecoveryDescription(ContinuousBackupsDescriptionPointInTimeRecoveryDescription pointInTimeRecoveryDescription) {
    this.pointInTimeRecoveryDescription = pointInTimeRecoveryDescription;
  }
  ...
  static {
    ...
    openapiFields.add("ContinuousBackupsStatus");
    openapiFields.add("PointInTimeRecoveryDescription");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("ContinuousBackupsStatus");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("PointInTimeRecoveryDescription") != null && !jsonObj.get("PointInTimeRecoveryDescription").isJsonNull()) {
        ContinuousBackupsDescriptionPointInTimeRecoveryDescription.validateJsonElement(jsonObj.get("PointInTimeRecoveryDescription"));
      }
  }
