...
public class ExportTableToPointInTimeOutputExportDescription {
  ...
  public ExportTableToPointInTimeOutputExportDescription() {
  }

  public ExportTableToPointInTimeOutputExportDescription exportArn(String exportArn) {
  ...
  public ExportTableToPointInTimeOutputExportDescription exportStatus(ExportStatus exportStatus) {
  ...
  public ExportTableToPointInTimeOutputExportDescription startTime(OffsetDateTime startTime) {
  ...
  public ExportTableToPointInTimeOutputExportDescription endTime(OffsetDateTime endTime) {
  ...
  public ExportTableToPointInTimeOutputExportDescription exportManifest(String exportManifest) {
  ...
  public ExportTableToPointInTimeOutputExportDescription tableArn(String tableArn) {
  ...
  public ExportTableToPointInTimeOutputExportDescription tableId(String tableId) {
  ...
  public ExportTableToPointInTimeOutputExportDescription exportTime(OffsetDateTime exportTime) {
  ...
  public ExportTableToPointInTimeOutputExportDescription clientToken(String clientToken) {
  ...
  public ExportTableToPointInTimeOutputExportDescription s3Bucket(String s3Bucket) {
  ...
  public ExportTableToPointInTimeOutputExportDescription s3BucketOwner(String s3BucketOwner) {
  ...
  public ExportTableToPointInTimeOutputExportDescription s3Prefix(String s3Prefix) {
  ...
  public ExportTableToPointInTimeOutputExportDescription s3SseAlgorithm(S3SseAlgorithm s3SseAlgorithm) {
  ...
  public ExportTableToPointInTimeOutputExportDescription s3SseKmsKeyId(String s3SseKmsKeyId) {
  ...
  public ExportTableToPointInTimeOutputExportDescription failureCode(String failureCode) {
  ...
  public ExportTableToPointInTimeOutputExportDescription failureMessage(String failureMessage) {
  ...
  public ExportTableToPointInTimeOutputExportDescription exportFormat(ExportFormat exportFormat) {
  ...
  public ExportTableToPointInTimeOutputExportDescription billedSizeBytes(Integer billedSizeBytes) {
  ...
  public ExportTableToPointInTimeOutputExportDescription itemCount(Integer itemCount) {
  ...
  public boolean equals(Object o) {
    ...
    ExportTableToPointInTimeOutputExportDescription exportTableToPointInTimeOutputExportDescription = (ExportTableToPointInTimeOutputExportDescription) o;
    return Objects.equals(this.exportArn, exportTableToPointInTimeOutputExportDescription.exportArn) &&
        Objects.equals(this.exportStatus, exportTableToPointInTimeOutputExportDescription.exportStatus) &&
        Objects.equals(this.startTime, exportTableToPointInTimeOutputExportDescription.startTime) &&
        Objects.equals(this.endTime, exportTableToPointInTimeOutputExportDescription.endTime) &&
        Objects.equals(this.exportManifest, exportTableToPointInTimeOutputExportDescription.exportManifest) &&
        Objects.equals(this.tableArn, exportTableToPointInTimeOutputExportDescription.tableArn) &&
        Objects.equals(this.tableId, exportTableToPointInTimeOutputExportDescription.tableId) &&
        Objects.equals(this.exportTime, exportTableToPointInTimeOutputExportDescription.exportTime) &&
        Objects.equals(this.clientToken, exportTableToPointInTimeOutputExportDescription.clientToken) &&
        Objects.equals(this.s3Bucket, exportTableToPointInTimeOutputExportDescription.s3Bucket) &&
        Objects.equals(this.s3BucketOwner, exportTableToPointInTimeOutputExportDescription.s3BucketOwner) &&
        Objects.equals(this.s3Prefix, exportTableToPointInTimeOutputExportDescription.s3Prefix) &&
        Objects.equals(this.s3SseAlgorithm, exportTableToPointInTimeOutputExportDescription.s3SseAlgorithm) &&
        Objects.equals(this.s3SseKmsKeyId, exportTableToPointInTimeOutputExportDescription.s3SseKmsKeyId) &&
        Objects.equals(this.failureCode, exportTableToPointInTimeOutputExportDescription.failureCode) &&
        Objects.equals(this.failureMessage, exportTableToPointInTimeOutputExportDescription.failureMessage) &&
        Objects.equals(this.exportFormat, exportTableToPointInTimeOutputExportDescription.exportFormat) &&
        Objects.equals(this.billedSizeBytes, exportTableToPointInTimeOutputExportDescription.billedSizeBytes) &&
        Objects.equals(this.itemCount, exportTableToPointInTimeOutputExportDescription.itemCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportTableToPointInTimeOutputExportDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportTableToPointInTimeOutputExportDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportTableToPointInTimeOutputExportDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportTableToPointInTimeOutputExportDescription is not found in the empty JSON string", ExportTableToPointInTimeOutputExportDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportTableToPointInTimeOutputExportDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportTableToPointInTimeOutputExportDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportTableToPointInTimeOutputExportDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportTableToPointInTimeOutputExportDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportTableToPointInTimeOutputExportDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportTableToPointInTimeOutputExportDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportTableToPointInTimeOutputExportDescription>() {
           @Override
           public void write(JsonWriter out, ExportTableToPointInTimeOutputExportDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportTableToPointInTimeOutputExportDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportTableToPointInTimeOutputExportDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportTableToPointInTimeOutputExportDescription
   * @throws IOException if the JSON string is invalid with respect to ExportTableToPointInTimeOutputExportDescription
   */
  public static ExportTableToPointInTimeOutputExportDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportTableToPointInTimeOutputExportDescription.class);
  }

  /**
   * Convert an instance of ExportTableToPointInTimeOutputExportDescription to an JSON string
   *
   * @return JSON string
   */
