...
public class PutItemInput {
  ...
  public PutItemInput item(Map item) {
    this.item = item;
    return this;
  }
  ...
  public PutItemInput expected(Map expected) {
  ...
  public PutItemInput returnConsumedCapacity(ReturnConsumedCapacity returnConsumedCapacity) {
  ...
  public PutItemInput returnItemCollectionMetrics(ReturnItemCollectionMetrics returnItemCollectionMetrics) {
  ...
  public PutItemInput conditionalOperator(ConditionalOperator conditionalOperator) {
  ...
  public PutItemInput conditionExpression(String conditionExpression) {
  ...
  public PutItemInput expressionAttributeNames(Map expressionAttributeNames) {
  ...
  public PutItemInput expressionAttributeValues(Map expressionAttributeValues) {
  ...
  public PutItemInput returnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
