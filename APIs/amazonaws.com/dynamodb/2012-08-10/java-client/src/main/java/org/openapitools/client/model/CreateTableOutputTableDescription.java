...
public class CreateTableOutputTableDescription {
  ...
  public CreateTableOutputTableDescription() {
  }

  public CreateTableOutputTableDescription attributeDefinitions(List attributeDefinitions) {
  ...
  public CreateTableOutputTableDescription tableName(String tableName) {
  ...
  public CreateTableOutputTableDescription keySchema(List keySchema) {
  ...
  public CreateTableOutputTableDescription tableStatus(TableStatus tableStatus) {
  ...
  public CreateTableOutputTableDescription creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public CreateTableOutputTableDescription provisionedThroughput(TableDescriptionProvisionedThroughput provisionedThroughput) {
  ...
  public CreateTableOutputTableDescription tableSizeBytes(Integer tableSizeBytes) {
  ...
  public CreateTableOutputTableDescription itemCount(Integer itemCount) {
  ...
  public CreateTableOutputTableDescription tableArn(String tableArn) {
  ...
  public CreateTableOutputTableDescription tableId(String tableId) {
  ...
  public CreateTableOutputTableDescription billingModeSummary(TableDescriptionBillingModeSummary billingModeSummary) {
  ...
  public CreateTableOutputTableDescription localSecondaryIndexes(List localSecondaryIndexes) {
  ...
  public CreateTableOutputTableDescription globalSecondaryIndexes(List globalSecondaryIndexes) {
  ...
  public CreateTableOutputTableDescription streamSpecification(TableDescriptionStreamSpecification streamSpecification) {
  ...
  public CreateTableOutputTableDescription latestStreamLabel(String latestStreamLabel) {
  ...
  public CreateTableOutputTableDescription latestStreamArn(String latestStreamArn) {
  ...
  public CreateTableOutputTableDescription globalTableVersion(String globalTableVersion) {
  ...
  public CreateTableOutputTableDescription replicas(List replicas) {
  ...
  public CreateTableOutputTableDescription restoreSummary(TableDescriptionRestoreSummary restoreSummary) {
  ...
  public CreateTableOutputTableDescription ssEDescription(TableDescriptionSSEDescription ssEDescription) {
  ...
  public CreateTableOutputTableDescription archivalSummary(TableDescriptionArchivalSummary archivalSummary) {
  ...
  public CreateTableOutputTableDescription tableClassSummary(TableDescriptionTableClassSummary tableClassSummary) {
  ...
  public CreateTableOutputTableDescription deletionProtectionEnabled(Boolean deletionProtectionEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    CreateTableOutputTableDescription createTableOutputTableDescription = (CreateTableOutputTableDescription) o;
    return Objects.equals(this.attributeDefinitions, createTableOutputTableDescription.attributeDefinitions) &&
        Objects.equals(this.tableName, createTableOutputTableDescription.tableName) &&
        Objects.equals(this.keySchema, createTableOutputTableDescription.keySchema) &&
        Objects.equals(this.tableStatus, createTableOutputTableDescription.tableStatus) &&
        Objects.equals(this.creationDateTime, createTableOutputTableDescription.creationDateTime) &&
        Objects.equals(this.provisionedThroughput, createTableOutputTableDescription.provisionedThroughput) &&
        Objects.equals(this.tableSizeBytes, createTableOutputTableDescription.tableSizeBytes) &&
        Objects.equals(this.itemCount, createTableOutputTableDescription.itemCount) &&
        Objects.equals(this.tableArn, createTableOutputTableDescription.tableArn) &&
        Objects.equals(this.tableId, createTableOutputTableDescription.tableId) &&
        Objects.equals(this.billingModeSummary, createTableOutputTableDescription.billingModeSummary) &&
        Objects.equals(this.localSecondaryIndexes, createTableOutputTableDescription.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, createTableOutputTableDescription.globalSecondaryIndexes) &&
        Objects.equals(this.streamSpecification, createTableOutputTableDescription.streamSpecification) &&
        Objects.equals(this.latestStreamLabel, createTableOutputTableDescription.latestStreamLabel) &&
        Objects.equals(this.latestStreamArn, createTableOutputTableDescription.latestStreamArn) &&
        Objects.equals(this.globalTableVersion, createTableOutputTableDescription.globalTableVersion) &&
        Objects.equals(this.replicas, createTableOutputTableDescription.replicas) &&
        Objects.equals(this.restoreSummary, createTableOutputTableDescription.restoreSummary) &&
        Objects.equals(this.ssEDescription, createTableOutputTableDescription.ssEDescription) &&
        Objects.equals(this.archivalSummary, createTableOutputTableDescription.archivalSummary) &&
        Objects.equals(this.tableClassSummary, createTableOutputTableDescription.tableClassSummary) &&
        Objects.equals(this.deletionProtectionEnabled, createTableOutputTableDescription.deletionProtectionEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTableOutputTableDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTableOutputTableDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTableOutputTableDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTableOutputTableDescription is not found in the empty JSON string", CreateTableOutputTableDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTableOutputTableDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTableOutputTableDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTableOutputTableDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTableOutputTableDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTableOutputTableDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTableOutputTableDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTableOutputTableDescription>() {
           @Override
           public void write(JsonWriter out, CreateTableOutputTableDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTableOutputTableDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTableOutputTableDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTableOutputTableDescription
   * @throws IOException if the JSON string is invalid with respect to CreateTableOutputTableDescription
   */
  public static CreateTableOutputTableDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTableOutputTableDescription.class);
  }

  /**
   * Convert an instance of CreateTableOutputTableDescription to an JSON string
   *
   * @return JSON string
   */
