...
public class ImportTableDescription {
  ...
  public ImportTableDescription importArn(String importArn) {
  ...
  public ImportTableDescription importStatus(ImportStatus importStatus) {
  ...
  public ImportTableDescription tableArn(String tableArn) {
  ...
  public ImportTableDescription tableId(String tableId) {
  ...
  public ImportTableDescription clientToken(String clientToken) {
  ...
  public ImportTableDescription s3BucketSource(ImportTableDescriptionS3BucketSource s3BucketSource) {
  ...
  public ImportTableDescription errorCount(Integer errorCount) {
  ...
  public ImportTableDescription cloudWatchLogGroupArn(String cloudWatchLogGroupArn) {
  ...
  public ImportTableDescription inputFormat(InputFormat inputFormat) {
  ...
  public ImportTableDescription inputFormatOptions(ImportTableDescriptionInputFormatOptions inputFormatOptions) {
  ...
  public ImportTableDescription inputCompressionType(InputCompressionType inputCompressionType) {
  ...
  public ImportTableDescription tableCreationParameters(ImportTableDescriptionTableCreationParameters tableCreationParameters) {
  ...
  public ImportTableDescription startTime(OffsetDateTime startTime) {
  ...
  public ImportTableDescription endTime(OffsetDateTime endTime) {
  ...
  public ImportTableDescription processedSizeBytes(Integer processedSizeBytes) {
  ...
  public ImportTableDescription processedItemCount(Integer processedItemCount) {
  ...
  public ImportTableDescription importedItemCount(Integer importedItemCount) {
  ...
  public ImportTableDescription failureCode(String failureCode) {
  ...
  public ImportTableDescription failureMessage(String failureMessage) {
