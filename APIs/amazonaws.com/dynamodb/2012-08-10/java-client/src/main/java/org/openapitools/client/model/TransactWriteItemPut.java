...
public class TransactWriteItemPut {
  ...
  public TransactWriteItemPut() {
  }

  public TransactWriteItemPut item(Map item) {
    this.item = item;
    return this;
  }
  ...
  public TransactWriteItemPut tableName(String tableName) {
  ...
  public TransactWriteItemPut conditionExpression(String conditionExpression) {
  ...
  public TransactWriteItemPut expressionAttributeNames(Map expressionAttributeNames) {
  ...
  public TransactWriteItemPut expressionAttributeValues(Map expressionAttributeValues) {
  ...
  public TransactWriteItemPut returnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
  ...
  public boolean equals(Object o) {
    ...
    TransactWriteItemPut transactWriteItemPut = (TransactWriteItemPut) o;
    return Objects.equals(this.item, transactWriteItemPut.item) &&
        Objects.equals(this.tableName, transactWriteItemPut.tableName) &&
        Objects.equals(this.conditionExpression, transactWriteItemPut.conditionExpression) &&
        Objects.equals(this.expressionAttributeNames, transactWriteItemPut.expressionAttributeNames) &&
        Objects.equals(this.expressionAttributeValues, transactWriteItemPut.expressionAttributeValues) &&
        Objects.equals(this.returnValuesOnConditionCheckFailure, transactWriteItemPut.returnValuesOnConditionCheckFailure);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactWriteItemPut {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransactWriteItemPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactWriteItemPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactWriteItemPut is not found in the empty JSON string", TransactWriteItemPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactWriteItemPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactWriteItemPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactWriteItemPut.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactWriteItemPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactWriteItemPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactWriteItemPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactWriteItemPut.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactWriteItemPut>() {
           @Override
           public void write(JsonWriter out, TransactWriteItemPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactWriteItemPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransactWriteItemPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransactWriteItemPut
   * @throws IOException if the JSON string is invalid with respect to TransactWriteItemPut
   */
  public static TransactWriteItemPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactWriteItemPut.class);
  }

  /**
   * Convert an instance of TransactWriteItemPut to an JSON string
   *
   * @return JSON string
   */
