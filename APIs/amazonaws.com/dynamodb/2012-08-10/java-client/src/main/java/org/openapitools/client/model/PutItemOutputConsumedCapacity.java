...
public class PutItemOutputConsumedCapacity {
  ...
  public PutItemOutputConsumedCapacity() {
  }

  public PutItemOutputConsumedCapacity tableName(String tableName) {
  ...
  public PutItemOutputConsumedCapacity capacityUnits(Double capacityUnits) {
  ...
  public PutItemOutputConsumedCapacity readCapacityUnits(Double readCapacityUnits) {
  ...
  public PutItemOutputConsumedCapacity writeCapacityUnits(Double writeCapacityUnits) {
  ...
  public PutItemOutputConsumedCapacity table(ConsumedCapacityTable table) {
    this.table = table;
    return this;
  }
  ...
  public PutItemOutputConsumedCapacity localSecondaryIndexes(Map localSecondaryIndexes) {
  ...
  public PutItemOutputConsumedCapacity globalSecondaryIndexes(Map globalSecondaryIndexes) {
  ...
  public boolean equals(Object o) {
    ...
    PutItemOutputConsumedCapacity putItemOutputConsumedCapacity = (PutItemOutputConsumedCapacity) o;
    return Objects.equals(this.tableName, putItemOutputConsumedCapacity.tableName) &&
        Objects.equals(this.capacityUnits, putItemOutputConsumedCapacity.capacityUnits) &&
        Objects.equals(this.readCapacityUnits, putItemOutputConsumedCapacity.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, putItemOutputConsumedCapacity.writeCapacityUnits) &&
        Objects.equals(this.table, putItemOutputConsumedCapacity.table) &&
        Objects.equals(this.localSecondaryIndexes, putItemOutputConsumedCapacity.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, putItemOutputConsumedCapacity.globalSecondaryIndexes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PutItemOutputConsumedCapacity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutItemOutputConsumedCapacity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutItemOutputConsumedCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutItemOutputConsumedCapacity is not found in the empty JSON string", PutItemOutputConsumedCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutItemOutputConsumedCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutItemOutputConsumedCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutItemOutputConsumedCapacity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutItemOutputConsumedCapacity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutItemOutputConsumedCapacity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutItemOutputConsumedCapacity.class));

       return (TypeAdapter<T>) new TypeAdapter<PutItemOutputConsumedCapacity>() {
           @Override
           public void write(JsonWriter out, PutItemOutputConsumedCapacity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutItemOutputConsumedCapacity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutItemOutputConsumedCapacity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutItemOutputConsumedCapacity
   * @throws IOException if the JSON string is invalid with respect to PutItemOutputConsumedCapacity
   */
  public static PutItemOutputConsumedCapacity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutItemOutputConsumedCapacity.class);
  }

  /**
   * Convert an instance of PutItemOutputConsumedCapacity to an JSON string
   *
   * @return JSON string
   */
