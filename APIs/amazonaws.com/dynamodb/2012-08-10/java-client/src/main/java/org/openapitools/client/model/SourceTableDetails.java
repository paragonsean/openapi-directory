...
public class SourceTableDetails {
  ...
  public SourceTableDetails tableName(String tableName) {
  ...
  public SourceTableDetails tableId(String tableId) {
  ...
  public SourceTableDetails tableArn(String tableArn) {
  ...
  public SourceTableDetails tableSizeBytes(Integer tableSizeBytes) {
  ...
  public SourceTableDetails keySchema(List keySchema) {
  ...
  public SourceTableDetails tableCreationDateTime(OffsetDateTime tableCreationDateTime) {
  ...
  public SourceTableDetails provisionedThroughput(SourceTableDetailsProvisionedThroughput provisionedThroughput) {
  ...
  public SourceTableDetails itemCount(Integer itemCount) {
  ...
  public SourceTableDetails billingMode(BillingMode billingMode) {
