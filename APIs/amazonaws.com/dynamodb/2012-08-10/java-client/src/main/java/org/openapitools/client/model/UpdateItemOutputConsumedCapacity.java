...
public class UpdateItemOutputConsumedCapacity {
  ...
  public UpdateItemOutputConsumedCapacity() {
  }

  public UpdateItemOutputConsumedCapacity tableName(String tableName) {
  ...
  public UpdateItemOutputConsumedCapacity capacityUnits(Double capacityUnits) {
  ...
  public UpdateItemOutputConsumedCapacity readCapacityUnits(Double readCapacityUnits) {
  ...
  public UpdateItemOutputConsumedCapacity writeCapacityUnits(Double writeCapacityUnits) {
  ...
  public UpdateItemOutputConsumedCapacity table(ConsumedCapacityTable table) {
    this.table = table;
    return this;
  }
  ...
  public UpdateItemOutputConsumedCapacity localSecondaryIndexes(Map localSecondaryIndexes) {
  ...
  public UpdateItemOutputConsumedCapacity globalSecondaryIndexes(Map globalSecondaryIndexes) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateItemOutputConsumedCapacity updateItemOutputConsumedCapacity = (UpdateItemOutputConsumedCapacity) o;
    return Objects.equals(this.tableName, updateItemOutputConsumedCapacity.tableName) &&
        Objects.equals(this.capacityUnits, updateItemOutputConsumedCapacity.capacityUnits) &&
        Objects.equals(this.readCapacityUnits, updateItemOutputConsumedCapacity.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, updateItemOutputConsumedCapacity.writeCapacityUnits) &&
        Objects.equals(this.table, updateItemOutputConsumedCapacity.table) &&
        Objects.equals(this.localSecondaryIndexes, updateItemOutputConsumedCapacity.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, updateItemOutputConsumedCapacity.globalSecondaryIndexes);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateItemOutputConsumedCapacity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateItemOutputConsumedCapacity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateItemOutputConsumedCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateItemOutputConsumedCapacity is not found in the empty JSON string", UpdateItemOutputConsumedCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateItemOutputConsumedCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateItemOutputConsumedCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateItemOutputConsumedCapacity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateItemOutputConsumedCapacity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateItemOutputConsumedCapacity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateItemOutputConsumedCapacity.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateItemOutputConsumedCapacity>() {
           @Override
           public void write(JsonWriter out, UpdateItemOutputConsumedCapacity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateItemOutputConsumedCapacity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateItemOutputConsumedCapacity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateItemOutputConsumedCapacity
   * @throws IOException if the JSON string is invalid with respect to UpdateItemOutputConsumedCapacity
   */
  public static UpdateItemOutputConsumedCapacity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateItemOutputConsumedCapacity.class);
  }

  /**
   * Convert an instance of UpdateItemOutputConsumedCapacity to an JSON string
   *
   * @return JSON string
   */
