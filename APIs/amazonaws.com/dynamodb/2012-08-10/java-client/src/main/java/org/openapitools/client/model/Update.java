...
public class Update {
  ...
  public Update updateExpression(String updateExpression) {
  ...
  public Update conditionExpression(String conditionExpression) {
  ...
  public Update expressionAttributeNames(Map expressionAttributeNames) {
  ...
  public Update expressionAttributeValues(Map expressionAttributeValues) {
  ...
  public Update returnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
