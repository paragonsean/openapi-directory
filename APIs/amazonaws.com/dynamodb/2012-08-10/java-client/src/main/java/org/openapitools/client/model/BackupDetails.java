...
public class BackupDetails {
  ...
  public BackupDetails backupArn(String backupArn) {
  ...
  public BackupDetails backupName(String backupName) {
  ...
  public BackupDetails backupSizeBytes(Integer backupSizeBytes) {
  ...
  public BackupDetails backupStatus(BackupStatus backupStatus) {
  ...
  public BackupDetails backupType(BackupType backupType) {
  ...
  public BackupDetails backupCreationDateTime(OffsetDateTime backupCreationDateTime) {
  ...
  public BackupDetails backupExpiryDateTime(OffsetDateTime backupExpiryDateTime) {
