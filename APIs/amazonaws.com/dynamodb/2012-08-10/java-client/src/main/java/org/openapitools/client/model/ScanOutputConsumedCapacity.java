...
public class ScanOutputConsumedCapacity {
  ...
  public ScanOutputConsumedCapacity() {
  }

  public ScanOutputConsumedCapacity tableName(String tableName) {
  ...
  public ScanOutputConsumedCapacity capacityUnits(Double capacityUnits) {
  ...
  public ScanOutputConsumedCapacity readCapacityUnits(Double readCapacityUnits) {
  ...
  public ScanOutputConsumedCapacity writeCapacityUnits(Double writeCapacityUnits) {
  ...
  public ScanOutputConsumedCapacity table(ConsumedCapacityTable table) {
    this.table = table;
    return this;
  }
  ...
  public ScanOutputConsumedCapacity localSecondaryIndexes(Map localSecondaryIndexes) {
  ...
  public ScanOutputConsumedCapacity globalSecondaryIndexes(Map globalSecondaryIndexes) {
  ...
  public boolean equals(Object o) {
    ...
    ScanOutputConsumedCapacity scanOutputConsumedCapacity = (ScanOutputConsumedCapacity) o;
    return Objects.equals(this.tableName, scanOutputConsumedCapacity.tableName) &&
        Objects.equals(this.capacityUnits, scanOutputConsumedCapacity.capacityUnits) &&
        Objects.equals(this.readCapacityUnits, scanOutputConsumedCapacity.readCapacityUnits) &&
        Objects.equals(this.writeCapacityUnits, scanOutputConsumedCapacity.writeCapacityUnits) &&
        Objects.equals(this.table, scanOutputConsumedCapacity.table) &&
        Objects.equals(this.localSecondaryIndexes, scanOutputConsumedCapacity.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, scanOutputConsumedCapacity.globalSecondaryIndexes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScanOutputConsumedCapacity {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScanOutputConsumedCapacity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScanOutputConsumedCapacity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScanOutputConsumedCapacity is not found in the empty JSON string", ScanOutputConsumedCapacity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScanOutputConsumedCapacity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScanOutputConsumedCapacity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScanOutputConsumedCapacity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScanOutputConsumedCapacity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScanOutputConsumedCapacity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScanOutputConsumedCapacity.class));

       return (TypeAdapter<T>) new TypeAdapter<ScanOutputConsumedCapacity>() {
           @Override
           public void write(JsonWriter out, ScanOutputConsumedCapacity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScanOutputConsumedCapacity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScanOutputConsumedCapacity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScanOutputConsumedCapacity
   * @throws IOException if the JSON string is invalid with respect to ScanOutputConsumedCapacity
   */
  public static ScanOutputConsumedCapacity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScanOutputConsumedCapacity.class);
  }

  /**
   * Convert an instance of ScanOutputConsumedCapacity to an JSON string
   *
   * @return JSON string
   */
