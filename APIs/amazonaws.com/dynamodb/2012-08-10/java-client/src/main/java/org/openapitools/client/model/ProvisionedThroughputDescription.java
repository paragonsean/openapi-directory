...
public class ProvisionedThroughputDescription {
  ...
  public ProvisionedThroughputDescription lastIncreaseDateTime(OffsetDateTime lastIncreaseDateTime) {
  ...
  public ProvisionedThroughputDescription lastDecreaseDateTime(OffsetDateTime lastDecreaseDateTime) {
  ...
  public ProvisionedThroughputDescription numberOfDecreasesToday(Integer numberOfDecreasesToday) {
  ...
  public ProvisionedThroughputDescription readCapacityUnits(Integer readCapacityUnits) {
  ...
  public ProvisionedThroughputDescription writeCapacityUnits(Integer writeCapacityUnits) {
