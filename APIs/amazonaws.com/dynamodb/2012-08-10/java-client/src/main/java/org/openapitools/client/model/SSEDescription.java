...
public class SSEDescription {
  ...
  public SSEDescription status(SSEStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SSEDescription ssEType(SSEType ssEType) {
  ...
  public SSEDescription kmSMasterKeyArn(String kmSMasterKeyArn) {
  ...
  public SSEDescription inaccessibleEncryptionDateTime(OffsetDateTime inaccessibleEncryptionDateTime) {
