...
public class RestoreTableFromBackupOutputTableDescription {
  ...
  public RestoreTableFromBackupOutputTableDescription() {
  }

  public RestoreTableFromBackupOutputTableDescription attributeDefinitions(List attributeDefinitions) {
  ...
  public RestoreTableFromBackupOutputTableDescription tableName(String tableName) {
  ...
  public RestoreTableFromBackupOutputTableDescription keySchema(List keySchema) {
  ...
  public RestoreTableFromBackupOutputTableDescription tableStatus(TableStatus tableStatus) {
  ...
  public RestoreTableFromBackupOutputTableDescription creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public RestoreTableFromBackupOutputTableDescription provisionedThroughput(TableDescriptionProvisionedThroughput provisionedThroughput) {
  ...
  public RestoreTableFromBackupOutputTableDescription tableSizeBytes(Integer tableSizeBytes) {
  ...
  public RestoreTableFromBackupOutputTableDescription itemCount(Integer itemCount) {
  ...
  public RestoreTableFromBackupOutputTableDescription tableArn(String tableArn) {
  ...
  public RestoreTableFromBackupOutputTableDescription tableId(String tableId) {
  ...
  public RestoreTableFromBackupOutputTableDescription billingModeSummary(TableDescriptionBillingModeSummary billingModeSummary) {
  ...
  public RestoreTableFromBackupOutputTableDescription localSecondaryIndexes(List localSecondaryIndexes) {
  ...
  public RestoreTableFromBackupOutputTableDescription globalSecondaryIndexes(List globalSecondaryIndexes) {
  ...
  public RestoreTableFromBackupOutputTableDescription streamSpecification(TableDescriptionStreamSpecification streamSpecification) {
  ...
  public RestoreTableFromBackupOutputTableDescription latestStreamLabel(String latestStreamLabel) {
  ...
  public RestoreTableFromBackupOutputTableDescription latestStreamArn(String latestStreamArn) {
  ...
  public RestoreTableFromBackupOutputTableDescription globalTableVersion(String globalTableVersion) {
  ...
  public RestoreTableFromBackupOutputTableDescription replicas(List replicas) {
  ...
  public RestoreTableFromBackupOutputTableDescription restoreSummary(TableDescriptionRestoreSummary restoreSummary) {
  ...
  public RestoreTableFromBackupOutputTableDescription ssEDescription(TableDescriptionSSEDescription ssEDescription) {
  ...
  public RestoreTableFromBackupOutputTableDescription archivalSummary(TableDescriptionArchivalSummary archivalSummary) {
  ...
  public RestoreTableFromBackupOutputTableDescription tableClassSummary(TableDescriptionTableClassSummary tableClassSummary) {
  ...
  public RestoreTableFromBackupOutputTableDescription deletionProtectionEnabled(Boolean deletionProtectionEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    RestoreTableFromBackupOutputTableDescription restoreTableFromBackupOutputTableDescription = (RestoreTableFromBackupOutputTableDescription) o;
    return Objects.equals(this.attributeDefinitions, restoreTableFromBackupOutputTableDescription.attributeDefinitions) &&
        Objects.equals(this.tableName, restoreTableFromBackupOutputTableDescription.tableName) &&
        Objects.equals(this.keySchema, restoreTableFromBackupOutputTableDescription.keySchema) &&
        Objects.equals(this.tableStatus, restoreTableFromBackupOutputTableDescription.tableStatus) &&
        Objects.equals(this.creationDateTime, restoreTableFromBackupOutputTableDescription.creationDateTime) &&
        Objects.equals(this.provisionedThroughput, restoreTableFromBackupOutputTableDescription.provisionedThroughput) &&
        Objects.equals(this.tableSizeBytes, restoreTableFromBackupOutputTableDescription.tableSizeBytes) &&
        Objects.equals(this.itemCount, restoreTableFromBackupOutputTableDescription.itemCount) &&
        Objects.equals(this.tableArn, restoreTableFromBackupOutputTableDescription.tableArn) &&
        Objects.equals(this.tableId, restoreTableFromBackupOutputTableDescription.tableId) &&
        Objects.equals(this.billingModeSummary, restoreTableFromBackupOutputTableDescription.billingModeSummary) &&
        Objects.equals(this.localSecondaryIndexes, restoreTableFromBackupOutputTableDescription.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, restoreTableFromBackupOutputTableDescription.globalSecondaryIndexes) &&
        Objects.equals(this.streamSpecification, restoreTableFromBackupOutputTableDescription.streamSpecification) &&
        Objects.equals(this.latestStreamLabel, restoreTableFromBackupOutputTableDescription.latestStreamLabel) &&
        Objects.equals(this.latestStreamArn, restoreTableFromBackupOutputTableDescription.latestStreamArn) &&
        Objects.equals(this.globalTableVersion, restoreTableFromBackupOutputTableDescription.globalTableVersion) &&
        Objects.equals(this.replicas, restoreTableFromBackupOutputTableDescription.replicas) &&
        Objects.equals(this.restoreSummary, restoreTableFromBackupOutputTableDescription.restoreSummary) &&
        Objects.equals(this.ssEDescription, restoreTableFromBackupOutputTableDescription.ssEDescription) &&
        Objects.equals(this.archivalSummary, restoreTableFromBackupOutputTableDescription.archivalSummary) &&
        Objects.equals(this.tableClassSummary, restoreTableFromBackupOutputTableDescription.tableClassSummary) &&
        Objects.equals(this.deletionProtectionEnabled, restoreTableFromBackupOutputTableDescription.deletionProtectionEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class RestoreTableFromBackupOutputTableDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RestoreTableFromBackupOutputTableDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RestoreTableFromBackupOutputTableDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RestoreTableFromBackupOutputTableDescription is not found in the empty JSON string", RestoreTableFromBackupOutputTableDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RestoreTableFromBackupOutputTableDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RestoreTableFromBackupOutputTableDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RestoreTableFromBackupOutputTableDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RestoreTableFromBackupOutputTableDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RestoreTableFromBackupOutputTableDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RestoreTableFromBackupOutputTableDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<RestoreTableFromBackupOutputTableDescription>() {
           @Override
           public void write(JsonWriter out, RestoreTableFromBackupOutputTableDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RestoreTableFromBackupOutputTableDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RestoreTableFromBackupOutputTableDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RestoreTableFromBackupOutputTableDescription
   * @throws IOException if the JSON string is invalid with respect to RestoreTableFromBackupOutputTableDescription
   */
  public static RestoreTableFromBackupOutputTableDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RestoreTableFromBackupOutputTableDescription.class);
  }

  /**
   * Convert an instance of RestoreTableFromBackupOutputTableDescription to an JSON string
   *
   * @return JSON string
   */
