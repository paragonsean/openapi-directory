...
public class AutoScalingTargetTrackingScalingPolicyConfigurationDescription {
  ...
  public AutoScalingTargetTrackingScalingPolicyConfigurationDescription disableScaleIn(Boolean disableScaleIn) {
  ...
  public AutoScalingTargetTrackingScalingPolicyConfigurationDescription scaleInCooldown(Integer scaleInCooldown) {
  ...
  public AutoScalingTargetTrackingScalingPolicyConfigurationDescription scaleOutCooldown(Integer scaleOutCooldown) {
  ...
  public AutoScalingTargetTrackingScalingPolicyConfigurationDescription targetValue(Double targetValue) {
