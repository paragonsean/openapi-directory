...
public class DescribeTableOutputTable {
  ...
  public DescribeTableOutputTable() {
  }

  public DescribeTableOutputTable attributeDefinitions(List attributeDefinitions) {
  ...
  public DescribeTableOutputTable tableName(String tableName) {
  ...
  public DescribeTableOutputTable keySchema(List keySchema) {
  ...
  public DescribeTableOutputTable tableStatus(TableStatus tableStatus) {
  ...
  public DescribeTableOutputTable creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public DescribeTableOutputTable provisionedThroughput(TableDescriptionProvisionedThroughput provisionedThroughput) {
  ...
  public DescribeTableOutputTable tableSizeBytes(Integer tableSizeBytes) {
  ...
  public DescribeTableOutputTable itemCount(Integer itemCount) {
  ...
  public DescribeTableOutputTable tableArn(String tableArn) {
  ...
  public DescribeTableOutputTable tableId(String tableId) {
  ...
  public DescribeTableOutputTable billingModeSummary(TableDescriptionBillingModeSummary billingModeSummary) {
  ...
  public DescribeTableOutputTable localSecondaryIndexes(List localSecondaryIndexes) {
  ...
  public DescribeTableOutputTable globalSecondaryIndexes(List globalSecondaryIndexes) {
  ...
  public DescribeTableOutputTable streamSpecification(TableDescriptionStreamSpecification streamSpecification) {
  ...
  public DescribeTableOutputTable latestStreamLabel(String latestStreamLabel) {
  ...
  public DescribeTableOutputTable latestStreamArn(String latestStreamArn) {
  ...
  public DescribeTableOutputTable globalTableVersion(String globalTableVersion) {
  ...
  public DescribeTableOutputTable replicas(List replicas) {
  ...
  public DescribeTableOutputTable restoreSummary(TableDescriptionRestoreSummary restoreSummary) {
  ...
  public DescribeTableOutputTable ssEDescription(TableDescriptionSSEDescription ssEDescription) {
  ...
  public DescribeTableOutputTable archivalSummary(TableDescriptionArchivalSummary archivalSummary) {
  ...
  public DescribeTableOutputTable tableClassSummary(TableDescriptionTableClassSummary tableClassSummary) {
  ...
  public DescribeTableOutputTable deletionProtectionEnabled(Boolean deletionProtectionEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeTableOutputTable describeTableOutputTable = (DescribeTableOutputTable) o;
    return Objects.equals(this.attributeDefinitions, describeTableOutputTable.attributeDefinitions) &&
        Objects.equals(this.tableName, describeTableOutputTable.tableName) &&
        Objects.equals(this.keySchema, describeTableOutputTable.keySchema) &&
        Objects.equals(this.tableStatus, describeTableOutputTable.tableStatus) &&
        Objects.equals(this.creationDateTime, describeTableOutputTable.creationDateTime) &&
        Objects.equals(this.provisionedThroughput, describeTableOutputTable.provisionedThroughput) &&
        Objects.equals(this.tableSizeBytes, describeTableOutputTable.tableSizeBytes) &&
        Objects.equals(this.itemCount, describeTableOutputTable.itemCount) &&
        Objects.equals(this.tableArn, describeTableOutputTable.tableArn) &&
        Objects.equals(this.tableId, describeTableOutputTable.tableId) &&
        Objects.equals(this.billingModeSummary, describeTableOutputTable.billingModeSummary) &&
        Objects.equals(this.localSecondaryIndexes, describeTableOutputTable.localSecondaryIndexes) &&
        Objects.equals(this.globalSecondaryIndexes, describeTableOutputTable.globalSecondaryIndexes) &&
        Objects.equals(this.streamSpecification, describeTableOutputTable.streamSpecification) &&
        Objects.equals(this.latestStreamLabel, describeTableOutputTable.latestStreamLabel) &&
        Objects.equals(this.latestStreamArn, describeTableOutputTable.latestStreamArn) &&
        Objects.equals(this.globalTableVersion, describeTableOutputTable.globalTableVersion) &&
        Objects.equals(this.replicas, describeTableOutputTable.replicas) &&
        Objects.equals(this.restoreSummary, describeTableOutputTable.restoreSummary) &&
        Objects.equals(this.ssEDescription, describeTableOutputTable.ssEDescription) &&
        Objects.equals(this.archivalSummary, describeTableOutputTable.archivalSummary) &&
        Objects.equals(this.tableClassSummary, describeTableOutputTable.tableClassSummary) &&
        Objects.equals(this.deletionProtectionEnabled, describeTableOutputTable.deletionProtectionEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeTableOutputTable {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeTableOutputTable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeTableOutputTable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeTableOutputTable is not found in the empty JSON string", DescribeTableOutputTable.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeTableOutputTable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeTableOutputTable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeTableOutputTable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeTableOutputTable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeTableOutputTable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeTableOutputTable.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeTableOutputTable>() {
           @Override
           public void write(JsonWriter out, DescribeTableOutputTable value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeTableOutputTable read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeTableOutputTable given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeTableOutputTable
   * @throws IOException if the JSON string is invalid with respect to DescribeTableOutputTable
   */
  public static DescribeTableOutputTable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeTableOutputTable.class);
  }

  /**
   * Convert an instance of DescribeTableOutputTable to an JSON string
   *
   * @return JSON string
   */
