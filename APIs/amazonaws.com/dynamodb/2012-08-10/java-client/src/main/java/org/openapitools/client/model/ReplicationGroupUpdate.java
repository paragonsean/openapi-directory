...
import org.openapitools.client.model.ReplicationGroupUpdateCreate;
import org.openapitools.client.model.ReplicationGroupUpdateDelete;
import org.openapitools.client.model.ReplicationGroupUpdateUpdate;
...
public class ReplicationGroupUpdate {
  ...
  private ReplicationGroupUpdateCreate create;

  public static final String SERIALIZED_NAME_UPDATE = "Update";
  @SerializedName(SERIALIZED_NAME_UPDATE)
  private ReplicationGroupUpdateUpdate update;

  public static final String SERIALIZED_NAME_DELETE = "Delete";
  @SerializedName(SERIALIZED_NAME_DELETE)
  private ReplicationGroupUpdateDelete delete;

  public ReplicationGroupUpdate() {
  }

  public ReplicationGroupUpdate create(ReplicationGroupUpdateCreate create) {
    this.create = create;
    return this;
  }
  ...
  public ReplicationGroupUpdateCreate getCreate() {
    return create;
  }

  public void setCreate(ReplicationGroupUpdateCreate create) {
    this.create = create;
  }


  public ReplicationGroupUpdate update(ReplicationGroupUpdateUpdate update) {
    this.update = update;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ReplicationGroupUpdateUpdate getUpdate() {
    return update;
  }

  public void setUpdate(ReplicationGroupUpdateUpdate update) {
    this.update = update;
  }


  public ReplicationGroupUpdate delete(ReplicationGroupUpdateDelete delete) {
    this.delete = delete;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ReplicationGroupUpdateDelete getDelete() {
    return delete;
  }

  public void setDelete(ReplicationGroupUpdateDelete delete) {
    this.delete = delete;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Create") != null && !jsonObj.get("Create").isJsonNull()) {
        ReplicationGroupUpdateCreate.validateJsonElement(jsonObj.get("Create"));
      }
      // validate the optional field `Update`
      if (jsonObj.get("Update") != null && !jsonObj.get("Update").isJsonNull()) {
        ReplicationGroupUpdateUpdate.validateJsonElement(jsonObj.get("Update"));
      }
      // validate the optional field `Delete`
      if (jsonObj.get("Delete") != null && !jsonObj.get("Delete").isJsonNull()) {
        ReplicationGroupUpdateDelete.validateJsonElement(jsonObj.get("Delete"));
      }
  }
