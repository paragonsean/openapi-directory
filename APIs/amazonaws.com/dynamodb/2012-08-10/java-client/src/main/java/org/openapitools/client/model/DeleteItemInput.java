...
public class DeleteItemInput {
  ...
  public DeleteItemInput tableName(String tableName) {
  ...
  public DeleteItemInput key(Map key) {
    this.key = key;
    return this;
  }
  ...
  public DeleteItemInput expected(Map expected) {
  ...
  public DeleteItemInput conditionalOperator(ConditionalOperator conditionalOperator) {
  ...
  public DeleteItemInput returnValues(ReturnValue returnValues) {
  ...
  public DeleteItemInput returnConsumedCapacity(ReturnConsumedCapacity returnConsumedCapacity) {
  ...
  public DeleteItemInput returnItemCollectionMetrics(ReturnItemCollectionMetrics returnItemCollectionMetrics) {
  ...
  public DeleteItemInput conditionExpression(String conditionExpression) {
  ...
  public DeleteItemInput expressionAttributeNames(Map expressionAttributeNames) {
  ...
  public DeleteItemInput expressionAttributeValues(Map expressionAttributeValues) {
  ...
  public DeleteItemInput returnValuesOnConditionCheckFailure(ReturnValuesOnConditionCheckFailure returnValuesOnConditionCheckFailure) {
