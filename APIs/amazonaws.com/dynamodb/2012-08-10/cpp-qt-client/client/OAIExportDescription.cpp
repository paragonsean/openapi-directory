...
#include "OAIExportDescription.h"
...
OAIExportDescription::OAIExportDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExportDescription::OAIExportDescription() {
    this->initializeModel();
}

OAIExportDescription::~OAIExportDescription() {}

void OAIExportDescription::initializeModel() {
...
void OAIExportDescription::fromJson(QString jsonString) {
...
void OAIExportDescription::fromJsonObject(QJsonObject json) {
...
QString OAIExportDescription::asJson() const {
...
QJsonObject OAIExportDescription::asJsonObject() const {
    QJsonObject obj;
...
QString OAIExportDescription::getExportArn() const {
    return m_export_arn;
}
void OAIExportDescription::setExportArn(const QString &export_arn) {
    m_export_arn = export_arn;
    m_export_arn_isSet = true;
}

bool OAIExportDescription::is_export_arn_Set() const{
    return m_export_arn_isSet;
}

bool OAIExportDescription::is_export_arn_Valid() const{
    return m_export_arn_isValid;
}

OAIExportStatus OAIExportDescription::getExportStatus() const {
    return m_export_status;
}
void OAIExportDescription::setExportStatus(const OAIExportStatus &export_status) {
    m_export_status = export_status;
    m_export_status_isSet = true;
}

bool OAIExportDescription::is_export_status_Set() const{
    return m_export_status_isSet;
}

bool OAIExportDescription::is_export_status_Valid() const{
    return m_export_status_isValid;
}

QDateTime OAIExportDescription::getStartTime() const {
    return m_start_time;
}
void OAIExportDescription::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIExportDescription::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIExportDescription::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIExportDescription::getEndTime() const {
    return m_end_time;
}
void OAIExportDescription::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIExportDescription::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIExportDescription::is_end_time_Valid() const{
    return m_end_time_isValid;
}

QString OAIExportDescription::getExportManifest() const {
    return m_export_manifest;
}
void OAIExportDescription::setExportManifest(const QString &export_manifest) {
    m_export_manifest = export_manifest;
    m_export_manifest_isSet = true;
}

bool OAIExportDescription::is_export_manifest_Set() const{
    return m_export_manifest_isSet;
}

bool OAIExportDescription::is_export_manifest_Valid() const{
    return m_export_manifest_isValid;
}

QString OAIExportDescription::getTableArn() const {
    return m_table_arn;
}
void OAIExportDescription::setTableArn(const QString &table_arn) {
    m_table_arn = table_arn;
    m_table_arn_isSet = true;
}

bool OAIExportDescription::is_table_arn_Set() const{
    return m_table_arn_isSet;
}

bool OAIExportDescription::is_table_arn_Valid() const{
    return m_table_arn_isValid;
}

QString OAIExportDescription::getTableId() const {
    return m_table_id;
}
void OAIExportDescription::setTableId(const QString &table_id) {
    m_table_id = table_id;
    m_table_id_isSet = true;
}

bool OAIExportDescription::is_table_id_Set() const{
    return m_table_id_isSet;
}

bool OAIExportDescription::is_table_id_Valid() const{
    return m_table_id_isValid;
}

QDateTime OAIExportDescription::getExportTime() const {
    return m_export_time;
}
void OAIExportDescription::setExportTime(const QDateTime &export_time) {
    m_export_time = export_time;
    m_export_time_isSet = true;
}

bool OAIExportDescription::is_export_time_Set() const{
    return m_export_time_isSet;
}

bool OAIExportDescription::is_export_time_Valid() const{
    return m_export_time_isValid;
}

QString OAIExportDescription::getClientToken() const {
    return m_client_token;
}
void OAIExportDescription::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAIExportDescription::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAIExportDescription::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QString OAIExportDescription::getS3Bucket() const {
    return m_s3_bucket;
}
void OAIExportDescription::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAIExportDescription::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAIExportDescription::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAIExportDescription::getS3BucketOwner() const {
    return m_s3_bucket_owner;
}
void OAIExportDescription::setS3BucketOwner(const QString &s3_bucket_owner) {
    m_s3_bucket_owner = s3_bucket_owner;
    m_s3_bucket_owner_isSet = true;
}

bool OAIExportDescription::is_s3_bucket_owner_Set() const{
    return m_s3_bucket_owner_isSet;
}

bool OAIExportDescription::is_s3_bucket_owner_Valid() const{
    return m_s3_bucket_owner_isValid;
}

QString OAIExportDescription::getS3Prefix() const {
    return m_s3_prefix;
}
void OAIExportDescription::setS3Prefix(const QString &s3_prefix) {
    m_s3_prefix = s3_prefix;
    m_s3_prefix_isSet = true;
}

bool OAIExportDescription::is_s3_prefix_Set() const{
    return m_s3_prefix_isSet;
}

bool OAIExportDescription::is_s3_prefix_Valid() const{
    return m_s3_prefix_isValid;
}

OAIS3SseAlgorithm OAIExportDescription::getS3SseAlgorithm() const {
    return m_s3_sse_algorithm;
}
void OAIExportDescription::setS3SseAlgorithm(const OAIS3SseAlgorithm &s3_sse_algorithm) {
    m_s3_sse_algorithm = s3_sse_algorithm;
    m_s3_sse_algorithm_isSet = true;
}

bool OAIExportDescription::is_s3_sse_algorithm_Set() const{
    return m_s3_sse_algorithm_isSet;
}

bool OAIExportDescription::is_s3_sse_algorithm_Valid() const{
    return m_s3_sse_algorithm_isValid;
}

QString OAIExportDescription::getS3SseKmsKeyId() const {
    return m_s3_sse_kms_key_id;
}
void OAIExportDescription::setS3SseKmsKeyId(const QString &s3_sse_kms_key_id) {
    m_s3_sse_kms_key_id = s3_sse_kms_key_id;
    m_s3_sse_kms_key_id_isSet = true;
}

bool OAIExportDescription::is_s3_sse_kms_key_id_Set() const{
    return m_s3_sse_kms_key_id_isSet;
}

bool OAIExportDescription::is_s3_sse_kms_key_id_Valid() const{
    return m_s3_sse_kms_key_id_isValid;
}

QString OAIExportDescription::getFailureCode() const {
    return m_failure_code;
}
void OAIExportDescription::setFailureCode(const QString &failure_code) {
    m_failure_code = failure_code;
    m_failure_code_isSet = true;
}

bool OAIExportDescription::is_failure_code_Set() const{
    return m_failure_code_isSet;
}

bool OAIExportDescription::is_failure_code_Valid() const{
    return m_failure_code_isValid;
}

QString OAIExportDescription::getFailureMessage() const {
    return m_failure_message;
}
void OAIExportDescription::setFailureMessage(const QString &failure_message) {
    m_failure_message = failure_message;
    m_failure_message_isSet = true;
}

bool OAIExportDescription::is_failure_message_Set() const{
    return m_failure_message_isSet;
}

bool OAIExportDescription::is_failure_message_Valid() const{
    return m_failure_message_isValid;
}

OAIExportFormat OAIExportDescription::getExportFormat() const {
    return m_export_format;
}
void OAIExportDescription::setExportFormat(const OAIExportFormat &export_format) {
    m_export_format = export_format;
    m_export_format_isSet = true;
}

bool OAIExportDescription::is_export_format_Set() const{
    return m_export_format_isSet;
}

bool OAIExportDescription::is_export_format_Valid() const{
    return m_export_format_isValid;
}

qint32 OAIExportDescription::getBilledSizeBytes() const {
    return m_billed_size_bytes;
}
void OAIExportDescription::setBilledSizeBytes(const qint32 &billed_size_bytes) {
    m_billed_size_bytes = billed_size_bytes;
    m_billed_size_bytes_isSet = true;
}

bool OAIExportDescription::is_billed_size_bytes_Set() const{
    return m_billed_size_bytes_isSet;
}

bool OAIExportDescription::is_billed_size_bytes_Valid() const{
    return m_billed_size_bytes_isValid;
}

qint32 OAIExportDescription::getItemCount() const {
    return m_item_count;
}
void OAIExportDescription::setItemCount(const qint32 &item_count) {
    m_item_count = item_count;
    m_item_count_isSet = true;
}

bool OAIExportDescription::is_item_count_Set() const{
    return m_item_count_isSet;
}

bool OAIExportDescription::is_item_count_Valid() const{
    return m_item_count_isValid;
}

bool OAIExportDescription::isSet() const {
...
bool OAIExportDescription::isValid() const {
