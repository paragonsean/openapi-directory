...
/*
 * OAITableCreationParameters.h
 *
 *  The parameters for the table created as part of the import operation. 
 */

#ifndef OAITableCreationParameters_H
#define OAITableCreationParameters_H
...
class OAITableCreationParameters : public OAIObject {
public:
    OAITableCreationParameters();
    OAITableCreationParameters(QString json);
    ~OAITableCreationParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITableCreationParameters)

#endif // OAITableCreationParameters_H
