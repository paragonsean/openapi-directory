...
QMap OAIUpdate::getKey() const {
    return m_key;
}
void OAIUpdate::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIUpdate::is_key_Set() const{
    return m_key_isSet;
}

bool OAIUpdate::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIUpdate::getUpdateExpression() const {
    return m_update_expression;
}
void OAIUpdate::setUpdateExpression(const QString &update_expression) {
    m_update_expression = update_expression;
    m_update_expression_isSet = true;
}

bool OAIUpdate::is_update_expression_Set() const{
    return m_update_expression_isSet;
}

bool OAIUpdate::is_update_expression_Valid() const{
    return m_update_expression_isValid;
}

QString OAIUpdate::getTableName() const {
    return m_table_name;
}
void OAIUpdate::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIUpdate::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIUpdate::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAIUpdate::getConditionExpression() const {
    return m_condition_expression;
}
void OAIUpdate::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAIUpdate::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAIUpdate::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAIUpdate::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAIUpdate::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAIUpdate::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAIUpdate::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAIUpdate::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAIUpdate::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAIUpdate::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAIUpdate::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAIUpdate::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAIUpdate::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAIUpdate::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAIUpdate::is_return_values_on_condition_check_failure_Valid() const{
