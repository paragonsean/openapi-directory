...
#include "OAIPutItemOutput_ConsumedCapacity.h"
...
OAIPutItemOutput_ConsumedCapacity::OAIPutItemOutput_ConsumedCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutItemOutput_ConsumedCapacity::OAIPutItemOutput_ConsumedCapacity() {
    this->initializeModel();
}

OAIPutItemOutput_ConsumedCapacity::~OAIPutItemOutput_ConsumedCapacity() {}

void OAIPutItemOutput_ConsumedCapacity::initializeModel() {
...
void OAIPutItemOutput_ConsumedCapacity::fromJson(QString jsonString) {
...
void OAIPutItemOutput_ConsumedCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIPutItemOutput_ConsumedCapacity::asJson() const {
...
QJsonObject OAIPutItemOutput_ConsumedCapacity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutItemOutput_ConsumedCapacity::getTableName() const {
    return m_table_name;
}
void OAIPutItemOutput_ConsumedCapacity::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_table_name_Valid() const{
    return m_table_name_isValid;
}

double OAIPutItemOutput_ConsumedCapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIPutItemOutput_ConsumedCapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

double OAIPutItemOutput_ConsumedCapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIPutItemOutput_ConsumedCapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIPutItemOutput_ConsumedCapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIPutItemOutput_ConsumedCapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

OAIConsumedCapacity_Table OAIPutItemOutput_ConsumedCapacity::getTable() const {
    return m_table;
}
void OAIPutItemOutput_ConsumedCapacity::setTable(const OAIConsumedCapacity_Table &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_table_Set() const{
    return m_table_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAIPutItemOutput_ConsumedCapacity::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIPutItemOutput_ConsumedCapacity::setLocalSecondaryIndexes(const QMap &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QMap OAIPutItemOutput_ConsumedCapacity::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIPutItemOutput_ConsumedCapacity::setGlobalSecondaryIndexes(const QMap &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIPutItemOutput_ConsumedCapacity::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIPutItemOutput_ConsumedCapacity::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAIPutItemOutput_ConsumedCapacity::isSet() const {
...
bool OAIPutItemOutput_ConsumedCapacity::isValid() const {
