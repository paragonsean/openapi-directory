...
/*
 * OAIPutItemOutput_ConsumedCapacity.h
 *
 * 
 */

#ifndef OAIPutItemOutput_ConsumedCapacity_H
#define OAIPutItemOutput_ConsumedCapacity_H
...
class OAIPutItemOutput_ConsumedCapacity : public OAIObject {
public:
    OAIPutItemOutput_ConsumedCapacity();
    OAIPutItemOutput_ConsumedCapacity(QString json);
    ~OAIPutItemOutput_ConsumedCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutItemOutput_ConsumedCapacity)

#endif // OAIPutItemOutput_ConsumedCapacity_H
