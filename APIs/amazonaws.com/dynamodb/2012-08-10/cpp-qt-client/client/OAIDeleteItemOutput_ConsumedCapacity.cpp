...
OAIDeleteItemOutput_ConsumedCapacity::OAIDeleteItemOutput_ConsumedCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteItemOutput_ConsumedCapacity::OAIDeleteItemOutput_ConsumedCapacity() {
    this->initializeModel();
}

OAIDeleteItemOutput_ConsumedCapacity::~OAIDeleteItemOutput_ConsumedCapacity() {}

void OAIDeleteItemOutput_ConsumedCapacity::initializeModel() {
...
void OAIDeleteItemOutput_ConsumedCapacity::fromJson(QString jsonString) {
...
void OAIDeleteItemOutput_ConsumedCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteItemOutput_ConsumedCapacity::asJson() const {
...
QJsonObject OAIDeleteItemOutput_ConsumedCapacity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteItemOutput_ConsumedCapacity::getTableName() const {
    return m_table_name;
}
void OAIDeleteItemOutput_ConsumedCapacity::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_table_name_Valid() const{
    return m_table_name_isValid;
}

double OAIDeleteItemOutput_ConsumedCapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIDeleteItemOutput_ConsumedCapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

double OAIDeleteItemOutput_ConsumedCapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIDeleteItemOutput_ConsumedCapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIDeleteItemOutput_ConsumedCapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIDeleteItemOutput_ConsumedCapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

OAIConsumedCapacity_Table OAIDeleteItemOutput_ConsumedCapacity::getTable() const {
    return m_table;
}
void OAIDeleteItemOutput_ConsumedCapacity::setTable(const OAIConsumedCapacity_Table &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_table_Set() const{
    return m_table_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAIDeleteItemOutput_ConsumedCapacity::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIDeleteItemOutput_ConsumedCapacity::setLocalSecondaryIndexes(const QMap &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QMap OAIDeleteItemOutput_ConsumedCapacity::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIDeleteItemOutput_ConsumedCapacity::setGlobalSecondaryIndexes(const QMap &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIDeleteItemOutput_ConsumedCapacity::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAIDeleteItemOutput_ConsumedCapacity::isSet() const {
...
bool OAIDeleteItemOutput_ConsumedCapacity::isValid() const {
