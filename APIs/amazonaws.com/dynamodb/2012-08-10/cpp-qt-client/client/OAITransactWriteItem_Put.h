...
/*
 * OAITransactWriteItem_Put.h
 *
 * 
 */

#ifndef OAITransactWriteItem_Put_H
#define OAITransactWriteItem_Put_H
...
class OAITransactWriteItem_Put : public OAIObject {
public:
    OAITransactWriteItem_Put();
    OAITransactWriteItem_Put(QString json);
    ~OAITransactWriteItem_Put() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactWriteItem_Put)

#endif // OAITransactWriteItem_Put_H
