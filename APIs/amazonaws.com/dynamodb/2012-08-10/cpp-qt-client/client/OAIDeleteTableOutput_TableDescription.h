...
/*
 * OAIDeleteTableOutput_TableDescription.h
 *
 * 
 */

#ifndef OAIDeleteTableOutput_TableDescription_H
#define OAIDeleteTableOutput_TableDescription_H
...
class OAIDeleteTableOutput_TableDescription : public OAIObject {
public:
    OAIDeleteTableOutput_TableDescription();
    OAIDeleteTableOutput_TableDescription(QString json);
    ~OAIDeleteTableOutput_TableDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTableOutput_TableDescription)

#endif // OAIDeleteTableOutput_TableDescription_H
