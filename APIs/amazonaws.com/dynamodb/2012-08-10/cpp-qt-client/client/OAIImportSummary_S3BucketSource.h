...
/*
 * OAIImportSummary_S3BucketSource.h
 *
 * 
 */

#ifndef OAIImportSummary_S3BucketSource_H
#define OAIImportSummary_S3BucketSource_H
...
class OAIImportSummary_S3BucketSource : public OAIObject {
public:
    OAIImportSummary_S3BucketSource();
    OAIImportSummary_S3BucketSource(QString json);
    ~OAIImportSummary_S3BucketSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportSummary_S3BucketSource)

#endif // OAIImportSummary_S3BucketSource_H
