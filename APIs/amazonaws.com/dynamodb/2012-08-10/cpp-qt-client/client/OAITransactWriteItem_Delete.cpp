...
OAITransactWriteItem_Delete::OAITransactWriteItem_Delete(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransactWriteItem_Delete::OAITransactWriteItem_Delete() {
    this->initializeModel();
}

OAITransactWriteItem_Delete::~OAITransactWriteItem_Delete() {}

void OAITransactWriteItem_Delete::initializeModel() {
...
void OAITransactWriteItem_Delete::fromJson(QString jsonString) {
...
void OAITransactWriteItem_Delete::fromJsonObject(QJsonObject json) {
...
QString OAITransactWriteItem_Delete::asJson() const {
...
QJsonObject OAITransactWriteItem_Delete::asJsonObject() const {
    QJsonObject obj;
    if (m_key.isSet()) {
...
QMap OAITransactWriteItem_Delete::getKey() const {
    return m_key;
}
void OAITransactWriteItem_Delete::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAITransactWriteItem_Delete::is_key_Set() const{
    return m_key_isSet;
}

bool OAITransactWriteItem_Delete::is_key_Valid() const{
    return m_key_isValid;
}

QString OAITransactWriteItem_Delete::getTableName() const {
    return m_table_name;
}
void OAITransactWriteItem_Delete::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAITransactWriteItem_Delete::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAITransactWriteItem_Delete::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAITransactWriteItem_Delete::getConditionExpression() const {
    return m_condition_expression;
}
void OAITransactWriteItem_Delete::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAITransactWriteItem_Delete::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAITransactWriteItem_Delete::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAITransactWriteItem_Delete::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAITransactWriteItem_Delete::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAITransactWriteItem_Delete::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAITransactWriteItem_Delete::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAITransactWriteItem_Delete::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAITransactWriteItem_Delete::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAITransactWriteItem_Delete::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAITransactWriteItem_Delete::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAITransactWriteItem_Delete::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAITransactWriteItem_Delete::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAITransactWriteItem_Delete::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAITransactWriteItem_Delete::is_return_values_on_condition_check_failure_Valid() const{
    return m_return_values_on_condition_check_failure_isValid;
}

bool OAITransactWriteItem_Delete::isSet() const {
...
bool OAITransactWriteItem_Delete::isValid() const {
