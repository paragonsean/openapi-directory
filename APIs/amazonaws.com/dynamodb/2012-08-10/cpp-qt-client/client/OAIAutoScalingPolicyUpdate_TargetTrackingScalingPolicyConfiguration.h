...
/*
 * OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration.h
 *
 * 
 */

#ifndef OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration_H
#define OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration_H
...
class OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration : public OAIObject {
public:
    OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration();
    OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration(QString json);
    ~OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration)

#endif // OAIAutoScalingPolicyUpdate_TargetTrackingScalingPolicyConfiguration_H
