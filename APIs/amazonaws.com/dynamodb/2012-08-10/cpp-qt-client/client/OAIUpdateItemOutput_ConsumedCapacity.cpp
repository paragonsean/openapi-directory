...
OAIUpdateItemOutput_ConsumedCapacity::OAIUpdateItemOutput_ConsumedCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateItemOutput_ConsumedCapacity::OAIUpdateItemOutput_ConsumedCapacity() {
    this->initializeModel();
}

OAIUpdateItemOutput_ConsumedCapacity::~OAIUpdateItemOutput_ConsumedCapacity() {}

void OAIUpdateItemOutput_ConsumedCapacity::initializeModel() {
...
void OAIUpdateItemOutput_ConsumedCapacity::fromJson(QString jsonString) {
...
void OAIUpdateItemOutput_ConsumedCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateItemOutput_ConsumedCapacity::asJson() const {
...
QJsonObject OAIUpdateItemOutput_ConsumedCapacity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateItemOutput_ConsumedCapacity::getTableName() const {
    return m_table_name;
}
void OAIUpdateItemOutput_ConsumedCapacity::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_table_name_Valid() const{
    return m_table_name_isValid;
}

double OAIUpdateItemOutput_ConsumedCapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIUpdateItemOutput_ConsumedCapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

double OAIUpdateItemOutput_ConsumedCapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIUpdateItemOutput_ConsumedCapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIUpdateItemOutput_ConsumedCapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIUpdateItemOutput_ConsumedCapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

OAIConsumedCapacity_Table OAIUpdateItemOutput_ConsumedCapacity::getTable() const {
    return m_table;
}
void OAIUpdateItemOutput_ConsumedCapacity::setTable(const OAIConsumedCapacity_Table &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_table_Set() const{
    return m_table_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAIUpdateItemOutput_ConsumedCapacity::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIUpdateItemOutput_ConsumedCapacity::setLocalSecondaryIndexes(const QMap &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QMap OAIUpdateItemOutput_ConsumedCapacity::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIUpdateItemOutput_ConsumedCapacity::setGlobalSecondaryIndexes(const QMap &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIUpdateItemOutput_ConsumedCapacity::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAIUpdateItemOutput_ConsumedCapacity::isSet() const {
...
bool OAIUpdateItemOutput_ConsumedCapacity::isValid() const {
