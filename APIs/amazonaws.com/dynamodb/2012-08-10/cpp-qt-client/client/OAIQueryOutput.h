...
namespace OpenAPI {
class OAIQueryOutput_ConsumedCapacity;
...
public:
    ...
    OAIQueryOutput_ConsumedCapacity getConsumedCapacity() const;
    void setConsumedCapacity(const OAIQueryOutput_ConsumedCapacity &consumed_capacity);
...
private:
    ...
    OAIQueryOutput_ConsumedCapacity m_consumed_capacity;
