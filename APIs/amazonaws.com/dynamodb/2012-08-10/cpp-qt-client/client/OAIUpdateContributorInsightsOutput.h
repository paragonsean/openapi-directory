...
/*
 * OAIUpdateContributorInsightsOutput.h
 *
 * 
 */

#ifndef OAIUpdateContributorInsightsOutput_H
#define OAIUpdateContributorInsightsOutput_H
...
class OAIUpdateContributorInsightsOutput : public OAIObject {
public:
    OAIUpdateContributorInsightsOutput();
    OAIUpdateContributorInsightsOutput(QString json);
    ~OAIUpdateContributorInsightsOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateContributorInsightsOutput)

#endif // OAIUpdateContributorInsightsOutput_H
