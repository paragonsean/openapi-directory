...
/*
 * OAIDescribeExportOutput_ExportDescription.h
 *
 * 
 */

#ifndef OAIDescribeExportOutput_ExportDescription_H
#define OAIDescribeExportOutput_ExportDescription_H
...
class OAIDescribeExportOutput_ExportDescription : public OAIObject {
public:
    OAIDescribeExportOutput_ExportDescription();
    OAIDescribeExportOutput_ExportDescription(QString json);
    ~OAIDescribeExportOutput_ExportDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExportOutput_ExportDescription)

#endif // OAIDescribeExportOutput_ExportDescription_H
