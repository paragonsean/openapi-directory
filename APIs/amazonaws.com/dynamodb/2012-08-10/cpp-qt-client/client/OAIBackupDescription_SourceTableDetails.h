...
/*
 * OAIBackupDescription_SourceTableDetails.h
 *
 * 
 */

#ifndef OAIBackupDescription_SourceTableDetails_H
#define OAIBackupDescription_SourceTableDetails_H
...
class OAIBackupDescription_SourceTableDetails : public OAIObject {
public:
    OAIBackupDescription_SourceTableDetails();
    OAIBackupDescription_SourceTableDetails(QString json);
    ~OAIBackupDescription_SourceTableDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupDescription_SourceTableDetails)

#endif // OAIBackupDescription_SourceTableDetails_H
