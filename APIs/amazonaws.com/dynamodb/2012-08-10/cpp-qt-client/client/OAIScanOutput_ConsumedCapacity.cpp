...
OAIScanOutput_ConsumedCapacity::OAIScanOutput_ConsumedCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScanOutput_ConsumedCapacity::OAIScanOutput_ConsumedCapacity() {
    this->initializeModel();
}

OAIScanOutput_ConsumedCapacity::~OAIScanOutput_ConsumedCapacity() {}

void OAIScanOutput_ConsumedCapacity::initializeModel() {
...
void OAIScanOutput_ConsumedCapacity::fromJson(QString jsonString) {
...
void OAIScanOutput_ConsumedCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIScanOutput_ConsumedCapacity::asJson() const {
...
QJsonObject OAIScanOutput_ConsumedCapacity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIScanOutput_ConsumedCapacity::getTableName() const {
    return m_table_name;
}
void OAIScanOutput_ConsumedCapacity::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_table_name_Valid() const{
    return m_table_name_isValid;
}

double OAIScanOutput_ConsumedCapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIScanOutput_ConsumedCapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

double OAIScanOutput_ConsumedCapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIScanOutput_ConsumedCapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIScanOutput_ConsumedCapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIScanOutput_ConsumedCapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

OAIConsumedCapacity_Table OAIScanOutput_ConsumedCapacity::getTable() const {
    return m_table;
}
void OAIScanOutput_ConsumedCapacity::setTable(const OAIConsumedCapacity_Table &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_table_Set() const{
    return m_table_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAIScanOutput_ConsumedCapacity::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIScanOutput_ConsumedCapacity::setLocalSecondaryIndexes(const QMap &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QMap OAIScanOutput_ConsumedCapacity::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIScanOutput_ConsumedCapacity::setGlobalSecondaryIndexes(const QMap &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIScanOutput_ConsumedCapacity::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIScanOutput_ConsumedCapacity::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAIScanOutput_ConsumedCapacity::isSet() const {
...
bool OAIScanOutput_ConsumedCapacity::isValid() const {
