...
/*
 * OAIRestoreTableFromBackupOutput_TableDescription.h
 *
 * 
 */

#ifndef OAIRestoreTableFromBackupOutput_TableDescription_H
#define OAIRestoreTableFromBackupOutput_TableDescription_H
...
class OAIRestoreTableFromBackupOutput_TableDescription : public OAIObject {
public:
    OAIRestoreTableFromBackupOutput_TableDescription();
    OAIRestoreTableFromBackupOutput_TableDescription(QString json);
    ~OAIRestoreTableFromBackupOutput_TableDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreTableFromBackupOutput_TableDescription)

#endif // OAIRestoreTableFromBackupOutput_TableDescription_H
