...
QString OAIS3BucketSource::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAIS3BucketSource::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAIS3BucketSource::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAIS3BucketSource::is_s3_key_prefix_Valid() const{
