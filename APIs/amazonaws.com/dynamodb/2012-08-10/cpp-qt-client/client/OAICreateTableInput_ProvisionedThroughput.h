...
/*
 * OAICreateTableInput_ProvisionedThroughput.h
 *
 * 
 */

#ifndef OAICreateTableInput_ProvisionedThroughput_H
#define OAICreateTableInput_ProvisionedThroughput_H
...
class OAICreateTableInput_ProvisionedThroughput : public OAIObject {
public:
    OAICreateTableInput_ProvisionedThroughput();
    OAICreateTableInput_ProvisionedThroughput(QString json);
    ~OAICreateTableInput_ProvisionedThroughput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableInput_ProvisionedThroughput)

#endif // OAICreateTableInput_ProvisionedThroughput_H
