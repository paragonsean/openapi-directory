...
/*
 * OAIScanOutput_ConsumedCapacity.h
 *
 * 
 */

#ifndef OAIScanOutput_ConsumedCapacity_H
#define OAIScanOutput_ConsumedCapacity_H
...
class OAIScanOutput_ConsumedCapacity : public OAIObject {
public:
    OAIScanOutput_ConsumedCapacity();
    OAIScanOutput_ConsumedCapacity(QString json);
    ~OAIScanOutput_ConsumedCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScanOutput_ConsumedCapacity)

#endif // OAIScanOutput_ConsumedCapacity_H
