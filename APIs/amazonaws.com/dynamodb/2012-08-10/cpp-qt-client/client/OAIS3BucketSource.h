...
#ifndef OAIS3BucketSource_H
#define OAIS3BucketSource_H
...
class OAIS3BucketSource : public OAIObject {
public:
    OAIS3BucketSource();
    OAIS3BucketSource(QString json);
    ~OAIS3BucketSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3BucketSource)

#endif // OAIS3BucketSource_H
