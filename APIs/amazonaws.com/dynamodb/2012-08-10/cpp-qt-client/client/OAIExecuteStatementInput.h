...
/*
 * OAIExecuteStatementInput.h
 *
 * 
 */

#ifndef OAIExecuteStatementInput_H
#define OAIExecuteStatementInput_H
...
class OAIExecuteStatementInput : public OAIObject {
public:
    OAIExecuteStatementInput();
    OAIExecuteStatementInput(QString json);
    ~OAIExecuteStatementInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExecuteStatementInput)

#endif // OAIExecuteStatementInput_H
