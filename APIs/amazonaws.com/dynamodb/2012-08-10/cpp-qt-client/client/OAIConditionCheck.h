...
#ifndef OAIConditionCheck_H
#define OAIConditionCheck_H
...
class OAIConditionCheck : public OAIObject {
public:
    OAIConditionCheck();
    OAIConditionCheck(QString json);
    ~OAIConditionCheck() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionCheck)

#endif // OAIConditionCheck_H
