...
#include "OAIItemCollectionMetrics.h"
...
OAIItemCollectionMetrics::OAIItemCollectionMetrics(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIItemCollectionMetrics::OAIItemCollectionMetrics() {
    this->initializeModel();
}

OAIItemCollectionMetrics::~OAIItemCollectionMetrics() {}

void OAIItemCollectionMetrics::initializeModel() {
...
void OAIItemCollectionMetrics::fromJson(QString jsonString) {
...
void OAIItemCollectionMetrics::fromJsonObject(QJsonObject json) {
...
QString OAIItemCollectionMetrics::asJson() const {
...
QJsonObject OAIItemCollectionMetrics::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIItemCollectionMetrics::getItemCollectionKey() const {
    return m_item_collection_key;
}
void OAIItemCollectionMetrics::setItemCollectionKey(const QMap &item_collection_key) {
    m_item_collection_key = item_collection_key;
    m_item_collection_key_isSet = true;
}

bool OAIItemCollectionMetrics::is_item_collection_key_Set() const{
    return m_item_collection_key_isSet;
}

bool OAIItemCollectionMetrics::is_item_collection_key_Valid() const{
    return m_item_collection_key_isValid;
}

QList OAIItemCollectionMetrics::getSizeEstimateRangeGb() const {
    return m_size_estimate_range_gb;
}
void OAIItemCollectionMetrics::setSizeEstimateRangeGb(const QList &size_estimate_range_gb) {
    m_size_estimate_range_gb = size_estimate_range_gb;
    m_size_estimate_range_gb_isSet = true;
}

bool OAIItemCollectionMetrics::is_size_estimate_range_gb_Set() const{
    return m_size_estimate_range_gb_isSet;
}

bool OAIItemCollectionMetrics::is_size_estimate_range_gb_Valid() const{
    return m_size_estimate_range_gb_isValid;
}

bool OAIItemCollectionMetrics::isSet() const {
...
bool OAIItemCollectionMetrics::isValid() const {
