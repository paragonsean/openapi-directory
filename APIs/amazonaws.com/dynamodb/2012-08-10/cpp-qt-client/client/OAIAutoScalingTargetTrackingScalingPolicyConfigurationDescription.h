...
/*
 * OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription.h
 *
 * Represents the properties of a target tracking scaling policy.
 */

#ifndef OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription_H
#define OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription_H
...
class OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription : public OAIObject {
public:
    OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription();
    OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription(QString json);
    ~OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription)

#endif // OAIAutoScalingTargetTrackingScalingPolicyConfigurationDescription_H
