...
/*
 * OAIUpdateItemOutput_ConsumedCapacity.h
 *
 * 
 */

#ifndef OAIUpdateItemOutput_ConsumedCapacity_H
#define OAIUpdateItemOutput_ConsumedCapacity_H
...
class OAIUpdateItemOutput_ConsumedCapacity : public OAIObject {
public:
    OAIUpdateItemOutput_ConsumedCapacity();
    OAIUpdateItemOutput_ConsumedCapacity(QString json);
    ~OAIUpdateItemOutput_ConsumedCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateItemOutput_ConsumedCapacity)

#endif // OAIUpdateItemOutput_ConsumedCapacity_H
