...
/*
 * OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate.h
 *
 * Represents the settings of a target tracking scaling policy that will be modified.
 */

#ifndef OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate_H
#define OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate_H
...
class OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate : public OAIObject {
public:
    OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate();
    OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate(QString json);
    ~OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate)

#endif // OAIAutoScalingTargetTrackingScalingPolicyConfigurationUpdate_H
