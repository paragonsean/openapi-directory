...
OAIDescribeTableOutput_Table::OAIDescribeTableOutput_Table(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeTableOutput_Table::OAIDescribeTableOutput_Table() {
    this->initializeModel();
}

OAIDescribeTableOutput_Table::~OAIDescribeTableOutput_Table() {}

void OAIDescribeTableOutput_Table::initializeModel() {
...
void OAIDescribeTableOutput_Table::fromJson(QString jsonString) {
...
void OAIDescribeTableOutput_Table::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeTableOutput_Table::asJson() const {
...
QJsonObject OAIDescribeTableOutput_Table::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeTableOutput_Table::getAttributeDefinitions() const {
    return m_attribute_definitions;
}
void OAIDescribeTableOutput_Table::setAttributeDefinitions(const QList &attribute_definitions) {
    m_attribute_definitions = attribute_definitions;
    m_attribute_definitions_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_attribute_definitions_Set() const{
    return m_attribute_definitions_isSet;
}

bool OAIDescribeTableOutput_Table::is_attribute_definitions_Valid() const{
    return m_attribute_definitions_isValid;
}

QString OAIDescribeTableOutput_Table::getTableName() const {
    return m_table_name;
}
void OAIDescribeTableOutput_Table::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDescribeTableOutput_Table::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QList OAIDescribeTableOutput_Table::getKeySchema() const {
    return m_key_schema;
}
void OAIDescribeTableOutput_Table::setKeySchema(const QList &key_schema) {
    m_key_schema = key_schema;
    m_key_schema_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_key_schema_Set() const{
    return m_key_schema_isSet;
}

bool OAIDescribeTableOutput_Table::is_key_schema_Valid() const{
    return m_key_schema_isValid;
}

OAITableStatus OAIDescribeTableOutput_Table::getTableStatus() const {
    return m_table_status;
}
void OAIDescribeTableOutput_Table::setTableStatus(const OAITableStatus &table_status) {
    m_table_status = table_status;
    m_table_status_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_table_status_Set() const{
    return m_table_status_isSet;
}

bool OAIDescribeTableOutput_Table::is_table_status_Valid() const{
    return m_table_status_isValid;
}

QDateTime OAIDescribeTableOutput_Table::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAIDescribeTableOutput_Table::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAIDescribeTableOutput_Table::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

OAITableDescription_ProvisionedThroughput OAIDescribeTableOutput_Table::getProvisionedThroughput() const {
    return m_provisioned_throughput;
}
void OAIDescribeTableOutput_Table::setProvisionedThroughput(const OAITableDescription_ProvisionedThroughput &provisioned_throughput) {
    m_provisioned_throughput = provisioned_throughput;
    m_provisioned_throughput_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_provisioned_throughput_Set() const{
    return m_provisioned_throughput_isSet;
}

bool OAIDescribeTableOutput_Table::is_provisioned_throughput_Valid() const{
    return m_provisioned_throughput_isValid;
}

qint32 OAIDescribeTableOutput_Table::getTableSizeBytes() const {
    return m_table_size_bytes;
}
void OAIDescribeTableOutput_Table::setTableSizeBytes(const qint32 &table_size_bytes) {
    m_table_size_bytes = table_size_bytes;
    m_table_size_bytes_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_table_size_bytes_Set() const{
    return m_table_size_bytes_isSet;
}

bool OAIDescribeTableOutput_Table::is_table_size_bytes_Valid() const{
    return m_table_size_bytes_isValid;
}

qint32 OAIDescribeTableOutput_Table::getItemCount() const {
    return m_item_count;
}
void OAIDescribeTableOutput_Table::setItemCount(const qint32 &item_count) {
    m_item_count = item_count;
    m_item_count_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_item_count_Set() const{
    return m_item_count_isSet;
}

bool OAIDescribeTableOutput_Table::is_item_count_Valid() const{
    return m_item_count_isValid;
}

QString OAIDescribeTableOutput_Table::getTableArn() const {
    return m_table_arn;
}
void OAIDescribeTableOutput_Table::setTableArn(const QString &table_arn) {
    m_table_arn = table_arn;
    m_table_arn_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_table_arn_Set() const{
    return m_table_arn_isSet;
}

bool OAIDescribeTableOutput_Table::is_table_arn_Valid() const{
    return m_table_arn_isValid;
}

QString OAIDescribeTableOutput_Table::getTableId() const {
    return m_table_id;
}
void OAIDescribeTableOutput_Table::setTableId(const QString &table_id) {
    m_table_id = table_id;
    m_table_id_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_table_id_Set() const{
    return m_table_id_isSet;
}

bool OAIDescribeTableOutput_Table::is_table_id_Valid() const{
    return m_table_id_isValid;
}

OAITableDescription_BillingModeSummary OAIDescribeTableOutput_Table::getBillingModeSummary() const {
    return m_billing_mode_summary;
}
void OAIDescribeTableOutput_Table::setBillingModeSummary(const OAITableDescription_BillingModeSummary &billing_mode_summary) {
    m_billing_mode_summary = billing_mode_summary;
    m_billing_mode_summary_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_billing_mode_summary_Set() const{
    return m_billing_mode_summary_isSet;
}

bool OAIDescribeTableOutput_Table::is_billing_mode_summary_Valid() const{
    return m_billing_mode_summary_isValid;
}

QList OAIDescribeTableOutput_Table::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIDescribeTableOutput_Table::setLocalSecondaryIndexes(const QList &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIDescribeTableOutput_Table::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QList OAIDescribeTableOutput_Table::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIDescribeTableOutput_Table::setGlobalSecondaryIndexes(const QList &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIDescribeTableOutput_Table::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

OAITableDescription_StreamSpecification OAIDescribeTableOutput_Table::getStreamSpecification() const {
    return m_stream_specification;
}
void OAIDescribeTableOutput_Table::setStreamSpecification(const OAITableDescription_StreamSpecification &stream_specification) {
    m_stream_specification = stream_specification;
    m_stream_specification_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_stream_specification_Set() const{
    return m_stream_specification_isSet;
}

bool OAIDescribeTableOutput_Table::is_stream_specification_Valid() const{
    return m_stream_specification_isValid;
}

QString OAIDescribeTableOutput_Table::getLatestStreamLabel() const {
    return m_latest_stream_label;
}
void OAIDescribeTableOutput_Table::setLatestStreamLabel(const QString &latest_stream_label) {
    m_latest_stream_label = latest_stream_label;
    m_latest_stream_label_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_latest_stream_label_Set() const{
    return m_latest_stream_label_isSet;
}

bool OAIDescribeTableOutput_Table::is_latest_stream_label_Valid() const{
    return m_latest_stream_label_isValid;
}

QString OAIDescribeTableOutput_Table::getLatestStreamArn() const {
    return m_latest_stream_arn;
}
void OAIDescribeTableOutput_Table::setLatestStreamArn(const QString &latest_stream_arn) {
    m_latest_stream_arn = latest_stream_arn;
    m_latest_stream_arn_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_latest_stream_arn_Set() const{
    return m_latest_stream_arn_isSet;
}

bool OAIDescribeTableOutput_Table::is_latest_stream_arn_Valid() const{
    return m_latest_stream_arn_isValid;
}

QString OAIDescribeTableOutput_Table::getGlobalTableVersion() const {
    return m_global_table_version;
}
void OAIDescribeTableOutput_Table::setGlobalTableVersion(const QString &global_table_version) {
    m_global_table_version = global_table_version;
    m_global_table_version_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_global_table_version_Set() const{
    return m_global_table_version_isSet;
}

bool OAIDescribeTableOutput_Table::is_global_table_version_Valid() const{
    return m_global_table_version_isValid;
}

QList OAIDescribeTableOutput_Table::getReplicas() const {
    return m_replicas;
}
void OAIDescribeTableOutput_Table::setReplicas(const QList &replicas) {
    m_replicas = replicas;
    m_replicas_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_replicas_Set() const{
    return m_replicas_isSet;
}

bool OAIDescribeTableOutput_Table::is_replicas_Valid() const{
    return m_replicas_isValid;
}

OAITableDescription_RestoreSummary OAIDescribeTableOutput_Table::getRestoreSummary() const {
    return m_restore_summary;
}
void OAIDescribeTableOutput_Table::setRestoreSummary(const OAITableDescription_RestoreSummary &restore_summary) {
    m_restore_summary = restore_summary;
    m_restore_summary_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_restore_summary_Set() const{
    return m_restore_summary_isSet;
}

bool OAIDescribeTableOutput_Table::is_restore_summary_Valid() const{
    return m_restore_summary_isValid;
}

OAITableDescription_SSEDescription OAIDescribeTableOutput_Table::getSseDescription() const {
    return m_sse_description;
}
void OAIDescribeTableOutput_Table::setSseDescription(const OAITableDescription_SSEDescription &sse_description) {
    m_sse_description = sse_description;
    m_sse_description_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_sse_description_Set() const{
    return m_sse_description_isSet;
}

bool OAIDescribeTableOutput_Table::is_sse_description_Valid() const{
    return m_sse_description_isValid;
}

OAITableDescription_ArchivalSummary OAIDescribeTableOutput_Table::getArchivalSummary() const {
    return m_archival_summary;
}
void OAIDescribeTableOutput_Table::setArchivalSummary(const OAITableDescription_ArchivalSummary &archival_summary) {
    m_archival_summary = archival_summary;
    m_archival_summary_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_archival_summary_Set() const{
    return m_archival_summary_isSet;
}

bool OAIDescribeTableOutput_Table::is_archival_summary_Valid() const{
    return m_archival_summary_isValid;
}

OAITableDescription_TableClassSummary OAIDescribeTableOutput_Table::getTableClassSummary() const {
    return m_table_class_summary;
}
void OAIDescribeTableOutput_Table::setTableClassSummary(const OAITableDescription_TableClassSummary &table_class_summary) {
    m_table_class_summary = table_class_summary;
    m_table_class_summary_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_table_class_summary_Set() const{
    return m_table_class_summary_isSet;
}

bool OAIDescribeTableOutput_Table::is_table_class_summary_Valid() const{
    return m_table_class_summary_isValid;
}

bool OAIDescribeTableOutput_Table::getDeletionProtectionEnabled() const {
    return m_deletion_protection_enabled;
}
void OAIDescribeTableOutput_Table::setDeletionProtectionEnabled(const bool &deletion_protection_enabled) {
    m_deletion_protection_enabled = deletion_protection_enabled;
    m_deletion_protection_enabled_isSet = true;
}

bool OAIDescribeTableOutput_Table::is_deletion_protection_enabled_Set() const{
    return m_deletion_protection_enabled_isSet;
}

bool OAIDescribeTableOutput_Table::is_deletion_protection_enabled_Valid() const{
    return m_deletion_protection_enabled_isValid;
}

bool OAIDescribeTableOutput_Table::isSet() const {
...
bool OAIDescribeTableOutput_Table::isValid() const {
