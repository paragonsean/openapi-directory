...
/*
 * OAIBackupDescription_SourceTableFeatureDetails.h
 *
 * 
 */

#ifndef OAIBackupDescription_SourceTableFeatureDetails_H
#define OAIBackupDescription_SourceTableFeatureDetails_H
...
class OAIBackupDescription_SourceTableFeatureDetails : public OAIObject {
public:
    OAIBackupDescription_SourceTableFeatureDetails();
    OAIBackupDescription_SourceTableFeatureDetails(QString json);
    ~OAIBackupDescription_SourceTableFeatureDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupDescription_SourceTableFeatureDetails)

#endif // OAIBackupDescription_SourceTableFeatureDetails_H
