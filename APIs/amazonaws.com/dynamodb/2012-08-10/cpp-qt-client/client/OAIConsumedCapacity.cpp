...
OAIConsumedCapacity::OAIConsumedCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConsumedCapacity::OAIConsumedCapacity() {
    this->initializeModel();
}

OAIConsumedCapacity::~OAIConsumedCapacity() {}

void OAIConsumedCapacity::initializeModel() {
...
void OAIConsumedCapacity::fromJson(QString jsonString) {
...
void OAIConsumedCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIConsumedCapacity::asJson() const {
...
QJsonObject OAIConsumedCapacity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConsumedCapacity::getTableName() const {
    return m_table_name;
}
void OAIConsumedCapacity::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIConsumedCapacity::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIConsumedCapacity::is_table_name_Valid() const{
    return m_table_name_isValid;
}

double OAIConsumedCapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIConsumedCapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIConsumedCapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIConsumedCapacity::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

double OAIConsumedCapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIConsumedCapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIConsumedCapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIConsumedCapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIConsumedCapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIConsumedCapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIConsumedCapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIConsumedCapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

OAIConsumedCapacity_Table OAIConsumedCapacity::getTable() const {
    return m_table;
}
void OAIConsumedCapacity::setTable(const OAIConsumedCapacity_Table &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIConsumedCapacity::is_table_Set() const{
    return m_table_isSet;
}

bool OAIConsumedCapacity::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAIConsumedCapacity::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIConsumedCapacity::setLocalSecondaryIndexes(const QMap &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIConsumedCapacity::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIConsumedCapacity::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QMap OAIConsumedCapacity::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIConsumedCapacity::setGlobalSecondaryIndexes(const QMap &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIConsumedCapacity::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIConsumedCapacity::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAIConsumedCapacity::isSet() const {
...
bool OAIConsumedCapacity::isValid() const {
