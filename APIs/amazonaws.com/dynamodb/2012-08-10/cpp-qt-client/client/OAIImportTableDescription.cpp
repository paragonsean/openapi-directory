...
#include "OAIImportTableDescription.h"
...
OAIImportTableDescription::OAIImportTableDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImportTableDescription::OAIImportTableDescription() {
    this->initializeModel();
}

OAIImportTableDescription::~OAIImportTableDescription() {}

void OAIImportTableDescription::initializeModel() {
...
void OAIImportTableDescription::fromJson(QString jsonString) {
...
void OAIImportTableDescription::fromJsonObject(QJsonObject json) {
...
QString OAIImportTableDescription::asJson() const {
...
QJsonObject OAIImportTableDescription::asJsonObject() const {
    QJsonObject obj;
...
QString OAIImportTableDescription::getImportArn() const {
    return m_import_arn;
}
void OAIImportTableDescription::setImportArn(const QString &import_arn) {
    m_import_arn = import_arn;
    m_import_arn_isSet = true;
}

bool OAIImportTableDescription::is_import_arn_Set() const{
    return m_import_arn_isSet;
}

bool OAIImportTableDescription::is_import_arn_Valid() const{
    return m_import_arn_isValid;
}

OAIImportStatus OAIImportTableDescription::getImportStatus() const {
    return m_import_status;
}
void OAIImportTableDescription::setImportStatus(const OAIImportStatus &import_status) {
    m_import_status = import_status;
    m_import_status_isSet = true;
}

bool OAIImportTableDescription::is_import_status_Set() const{
    return m_import_status_isSet;
}

bool OAIImportTableDescription::is_import_status_Valid() const{
    return m_import_status_isValid;
}

QString OAIImportTableDescription::getTableArn() const {
    return m_table_arn;
}
void OAIImportTableDescription::setTableArn(const QString &table_arn) {
    m_table_arn = table_arn;
    m_table_arn_isSet = true;
}

bool OAIImportTableDescription::is_table_arn_Set() const{
    return m_table_arn_isSet;
}

bool OAIImportTableDescription::is_table_arn_Valid() const{
    return m_table_arn_isValid;
}

QString OAIImportTableDescription::getTableId() const {
    return m_table_id;
}
void OAIImportTableDescription::setTableId(const QString &table_id) {
    m_table_id = table_id;
    m_table_id_isSet = true;
}

bool OAIImportTableDescription::is_table_id_Set() const{
    return m_table_id_isSet;
}

bool OAIImportTableDescription::is_table_id_Valid() const{
    return m_table_id_isValid;
}

QString OAIImportTableDescription::getClientToken() const {
    return m_client_token;
}
void OAIImportTableDescription::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAIImportTableDescription::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAIImportTableDescription::is_client_token_Valid() const{
    return m_client_token_isValid;
}

OAIImportTableDescription_S3BucketSource OAIImportTableDescription::getS3BucketSource() const {
    return m_s3_bucket_source;
}
void OAIImportTableDescription::setS3BucketSource(const OAIImportTableDescription_S3BucketSource &s3_bucket_source) {
    m_s3_bucket_source = s3_bucket_source;
    m_s3_bucket_source_isSet = true;
}

bool OAIImportTableDescription::is_s3_bucket_source_Set() const{
    return m_s3_bucket_source_isSet;
}

bool OAIImportTableDescription::is_s3_bucket_source_Valid() const{
    return m_s3_bucket_source_isValid;
}

qint32 OAIImportTableDescription::getErrorCount() const {
    return m_error_count;
}
void OAIImportTableDescription::setErrorCount(const qint32 &error_count) {
    m_error_count = error_count;
    m_error_count_isSet = true;
}

bool OAIImportTableDescription::is_error_count_Set() const{
    return m_error_count_isSet;
}

bool OAIImportTableDescription::is_error_count_Valid() const{
    return m_error_count_isValid;
}

QString OAIImportTableDescription::getCloudWatchLogGroupArn() const {
    return m_cloud_watch_log_group_arn;
}
void OAIImportTableDescription::setCloudWatchLogGroupArn(const QString &cloud_watch_log_group_arn) {
    m_cloud_watch_log_group_arn = cloud_watch_log_group_arn;
    m_cloud_watch_log_group_arn_isSet = true;
}

bool OAIImportTableDescription::is_cloud_watch_log_group_arn_Set() const{
    return m_cloud_watch_log_group_arn_isSet;
}

bool OAIImportTableDescription::is_cloud_watch_log_group_arn_Valid() const{
    return m_cloud_watch_log_group_arn_isValid;
}

OAIInputFormat OAIImportTableDescription::getInputFormat() const {
    return m_input_format;
}
void OAIImportTableDescription::setInputFormat(const OAIInputFormat &input_format) {
    m_input_format = input_format;
    m_input_format_isSet = true;
}

bool OAIImportTableDescription::is_input_format_Set() const{
    return m_input_format_isSet;
}

bool OAIImportTableDescription::is_input_format_Valid() const{
    return m_input_format_isValid;
}

OAIImportTableDescription_InputFormatOptions OAIImportTableDescription::getInputFormatOptions() const {
    return m_input_format_options;
}
void OAIImportTableDescription::setInputFormatOptions(const OAIImportTableDescription_InputFormatOptions &input_format_options) {
    m_input_format_options = input_format_options;
    m_input_format_options_isSet = true;
}

bool OAIImportTableDescription::is_input_format_options_Set() const{
    return m_input_format_options_isSet;
}

bool OAIImportTableDescription::is_input_format_options_Valid() const{
    return m_input_format_options_isValid;
}

OAIInputCompressionType OAIImportTableDescription::getInputCompressionType() const {
    return m_input_compression_type;
}
void OAIImportTableDescription::setInputCompressionType(const OAIInputCompressionType &input_compression_type) {
    m_input_compression_type = input_compression_type;
    m_input_compression_type_isSet = true;
}

bool OAIImportTableDescription::is_input_compression_type_Set() const{
    return m_input_compression_type_isSet;
}

bool OAIImportTableDescription::is_input_compression_type_Valid() const{
    return m_input_compression_type_isValid;
}

OAIImportTableDescription_TableCreationParameters OAIImportTableDescription::getTableCreationParameters() const {
    return m_table_creation_parameters;
}
void OAIImportTableDescription::setTableCreationParameters(const OAIImportTableDescription_TableCreationParameters &table_creation_parameters) {
    m_table_creation_parameters = table_creation_parameters;
    m_table_creation_parameters_isSet = true;
}

bool OAIImportTableDescription::is_table_creation_parameters_Set() const{
    return m_table_creation_parameters_isSet;
}

bool OAIImportTableDescription::is_table_creation_parameters_Valid() const{
    return m_table_creation_parameters_isValid;
}

QDateTime OAIImportTableDescription::getStartTime() const {
    return m_start_time;
}
void OAIImportTableDescription::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIImportTableDescription::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIImportTableDescription::is_start_time_Valid() const{
    return m_start_time_isValid;
}

QDateTime OAIImportTableDescription::getEndTime() const {
    return m_end_time;
}
void OAIImportTableDescription::setEndTime(const QDateTime &end_time) {
    m_end_time = end_time;
    m_end_time_isSet = true;
}

bool OAIImportTableDescription::is_end_time_Set() const{
    return m_end_time_isSet;
}

bool OAIImportTableDescription::is_end_time_Valid() const{
    return m_end_time_isValid;
}

qint32 OAIImportTableDescription::getProcessedSizeBytes() const {
    return m_processed_size_bytes;
}
void OAIImportTableDescription::setProcessedSizeBytes(const qint32 &processed_size_bytes) {
    m_processed_size_bytes = processed_size_bytes;
    m_processed_size_bytes_isSet = true;
}

bool OAIImportTableDescription::is_processed_size_bytes_Set() const{
    return m_processed_size_bytes_isSet;
}

bool OAIImportTableDescription::is_processed_size_bytes_Valid() const{
    return m_processed_size_bytes_isValid;
}

qint32 OAIImportTableDescription::getProcessedItemCount() const {
    return m_processed_item_count;
}
void OAIImportTableDescription::setProcessedItemCount(const qint32 &processed_item_count) {
    m_processed_item_count = processed_item_count;
    m_processed_item_count_isSet = true;
}

bool OAIImportTableDescription::is_processed_item_count_Set() const{
    return m_processed_item_count_isSet;
}

bool OAIImportTableDescription::is_processed_item_count_Valid() const{
    return m_processed_item_count_isValid;
}

qint32 OAIImportTableDescription::getImportedItemCount() const {
    return m_imported_item_count;
}
void OAIImportTableDescription::setImportedItemCount(const qint32 &imported_item_count) {
    m_imported_item_count = imported_item_count;
    m_imported_item_count_isSet = true;
}

bool OAIImportTableDescription::is_imported_item_count_Set() const{
    return m_imported_item_count_isSet;
}

bool OAIImportTableDescription::is_imported_item_count_Valid() const{
    return m_imported_item_count_isValid;
}

QString OAIImportTableDescription::getFailureCode() const {
    return m_failure_code;
}
void OAIImportTableDescription::setFailureCode(const QString &failure_code) {
    m_failure_code = failure_code;
    m_failure_code_isSet = true;
}

bool OAIImportTableDescription::is_failure_code_Set() const{
    return m_failure_code_isSet;
}

bool OAIImportTableDescription::is_failure_code_Valid() const{
    return m_failure_code_isValid;
}

QString OAIImportTableDescription::getFailureMessage() const {
    return m_failure_message;
}
void OAIImportTableDescription::setFailureMessage(const QString &failure_message) {
    m_failure_message = failure_message;
    m_failure_message_isSet = true;
}

bool OAIImportTableDescription::is_failure_message_Set() const{
    return m_failure_message_isSet;
}

bool OAIImportTableDescription::is_failure_message_Valid() const{
    return m_failure_message_isValid;
}

bool OAIImportTableDescription::isSet() const {
...
bool OAIImportTableDescription::isValid() const {
