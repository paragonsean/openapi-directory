...
#ifndef OAIConsumedCapacity_H
#define OAIConsumedCapacity_H
...
class OAIConsumedCapacity : public OAIObject {
public:
    OAIConsumedCapacity();
    OAIConsumedCapacity(QString json);
    ~OAIConsumedCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConsumedCapacity)

#endif // OAIConsumedCapacity_H
