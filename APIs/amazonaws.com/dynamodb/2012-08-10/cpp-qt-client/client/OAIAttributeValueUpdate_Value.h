...
/*
 * OAIAttributeValueUpdate_Value.h
 *
 * 
 */

#ifndef OAIAttributeValueUpdate_Value_H
#define OAIAttributeValueUpdate_Value_H
...
class OAIAttributeValueUpdate_Value : public OAIObject {
public:
    OAIAttributeValueUpdate_Value();
    OAIAttributeValueUpdate_Value(QString json);
    ~OAIAttributeValueUpdate_Value() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeValueUpdate_Value)

#endif // OAIAttributeValueUpdate_Value_H
