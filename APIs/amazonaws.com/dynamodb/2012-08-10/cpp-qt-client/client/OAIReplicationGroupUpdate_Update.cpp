...
OAIReplicationGroupUpdate_Update::OAIReplicationGroupUpdate_Update(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReplicationGroupUpdate_Update::OAIReplicationGroupUpdate_Update() {
    this->initializeModel();
}

OAIReplicationGroupUpdate_Update::~OAIReplicationGroupUpdate_Update() {}

void OAIReplicationGroupUpdate_Update::initializeModel() {
...
void OAIReplicationGroupUpdate_Update::fromJson(QString jsonString) {
...
void OAIReplicationGroupUpdate_Update::fromJsonObject(QJsonObject json) {
...
QString OAIReplicationGroupUpdate_Update::asJson() const {
...
QJsonObject OAIReplicationGroupUpdate_Update::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReplicationGroupUpdate_Update::getRegionName() const {
    return m_region_name;
}
void OAIReplicationGroupUpdate_Update::setRegionName(const QString &region_name) {
    m_region_name = region_name;
    m_region_name_isSet = true;
}

bool OAIReplicationGroupUpdate_Update::is_region_name_Set() const{
    return m_region_name_isSet;
}

bool OAIReplicationGroupUpdate_Update::is_region_name_Valid() const{
    return m_region_name_isValid;
}

QString OAIReplicationGroupUpdate_Update::getKmsMasterKeyId() const {
    return m_kms_master_key_id;
}
void OAIReplicationGroupUpdate_Update::setKmsMasterKeyId(const QString &kms_master_key_id) {
    m_kms_master_key_id = kms_master_key_id;
    m_kms_master_key_id_isSet = true;
}

bool OAIReplicationGroupUpdate_Update::is_kms_master_key_id_Set() const{
    return m_kms_master_key_id_isSet;
}

bool OAIReplicationGroupUpdate_Update::is_kms_master_key_id_Valid() const{
    return m_kms_master_key_id_isValid;
}

OAICreateReplicationGroupMemberAction_ProvisionedThroughputOverride OAIReplicationGroupUpdate_Update::getProvisionedThroughputOverride() const {
    return m_provisioned_throughput_override;
}
void OAIReplicationGroupUpdate_Update::setProvisionedThroughputOverride(const OAICreateReplicationGroupMemberAction_ProvisionedThroughputOverride &provisioned_throughput_override) {
    m_provisioned_throughput_override = provisioned_throughput_override;
    m_provisioned_throughput_override_isSet = true;
}

bool OAIReplicationGroupUpdate_Update::is_provisioned_throughput_override_Set() const{
    return m_provisioned_throughput_override_isSet;
}

bool OAIReplicationGroupUpdate_Update::is_provisioned_throughput_override_Valid() const{
    return m_provisioned_throughput_override_isValid;
}

QList OAIReplicationGroupUpdate_Update::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIReplicationGroupUpdate_Update::setGlobalSecondaryIndexes(const QList &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIReplicationGroupUpdate_Update::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIReplicationGroupUpdate_Update::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

OAITableClass OAIReplicationGroupUpdate_Update::getTableClassOverride() const {
    return m_table_class_override;
}
void OAIReplicationGroupUpdate_Update::setTableClassOverride(const OAITableClass &table_class_override) {
    m_table_class_override = table_class_override;
    m_table_class_override_isSet = true;
}

bool OAIReplicationGroupUpdate_Update::is_table_class_override_Set() const{
    return m_table_class_override_isSet;
}

bool OAIReplicationGroupUpdate_Update::is_table_class_override_Valid() const{
    return m_table_class_override_isValid;
}

bool OAIReplicationGroupUpdate_Update::isSet() const {
...
bool OAIReplicationGroupUpdate_Update::isValid() const {
