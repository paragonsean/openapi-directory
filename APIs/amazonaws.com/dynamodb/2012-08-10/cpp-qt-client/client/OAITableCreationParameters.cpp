...
#include "OAITableCreationParameters.h"
...
OAITableCreationParameters::OAITableCreationParameters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITableCreationParameters::OAITableCreationParameters() {
    this->initializeModel();
}

OAITableCreationParameters::~OAITableCreationParameters() {}

void OAITableCreationParameters::initializeModel() {
...
void OAITableCreationParameters::fromJson(QString jsonString) {
...
void OAITableCreationParameters::fromJsonObject(QJsonObject json) {
...
QString OAITableCreationParameters::asJson() const {
...
QJsonObject OAITableCreationParameters::asJsonObject() const {
    QJsonObject obj;
...
QString OAITableCreationParameters::getTableName() const {
    return m_table_name;
}
void OAITableCreationParameters::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAITableCreationParameters::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAITableCreationParameters::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QList OAITableCreationParameters::getAttributeDefinitions() const {
    return m_attribute_definitions;
}
void OAITableCreationParameters::setAttributeDefinitions(const QList &attribute_definitions) {
    m_attribute_definitions = attribute_definitions;
    m_attribute_definitions_isSet = true;
}

bool OAITableCreationParameters::is_attribute_definitions_Set() const{
    return m_attribute_definitions_isSet;
}

bool OAITableCreationParameters::is_attribute_definitions_Valid() const{
    return m_attribute_definitions_isValid;
}

QList OAITableCreationParameters::getKeySchema() const {
    return m_key_schema;
}
void OAITableCreationParameters::setKeySchema(const QList &key_schema) {
    m_key_schema = key_schema;
    m_key_schema_isSet = true;
}

bool OAITableCreationParameters::is_key_schema_Set() const{
    return m_key_schema_isSet;
}

bool OAITableCreationParameters::is_key_schema_Valid() const{
    return m_key_schema_isValid;
}

OAIBillingMode OAITableCreationParameters::getBillingMode() const {
    return m_billing_mode;
}
void OAITableCreationParameters::setBillingMode(const OAIBillingMode &billing_mode) {
    m_billing_mode = billing_mode;
    m_billing_mode_isSet = true;
}

bool OAITableCreationParameters::is_billing_mode_Set() const{
    return m_billing_mode_isSet;
}

bool OAITableCreationParameters::is_billing_mode_Valid() const{
    return m_billing_mode_isValid;
}

OAIProvisionedThroughput OAITableCreationParameters::getProvisionedThroughput() const {
    return m_provisioned_throughput;
}
void OAITableCreationParameters::setProvisionedThroughput(const OAIProvisionedThroughput &provisioned_throughput) {
    m_provisioned_throughput = provisioned_throughput;
    m_provisioned_throughput_isSet = true;
}

bool OAITableCreationParameters::is_provisioned_throughput_Set() const{
    return m_provisioned_throughput_isSet;
}

bool OAITableCreationParameters::is_provisioned_throughput_Valid() const{
    return m_provisioned_throughput_isValid;
}

OAISSESpecification OAITableCreationParameters::getSseSpecification() const {
    return m_sse_specification;
}
void OAITableCreationParameters::setSseSpecification(const OAISSESpecification &sse_specification) {
    m_sse_specification = sse_specification;
    m_sse_specification_isSet = true;
}

bool OAITableCreationParameters::is_sse_specification_Set() const{
    return m_sse_specification_isSet;
}

bool OAITableCreationParameters::is_sse_specification_Valid() const{
    return m_sse_specification_isValid;
}

QList OAITableCreationParameters::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAITableCreationParameters::setGlobalSecondaryIndexes(const QList &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAITableCreationParameters::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAITableCreationParameters::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAITableCreationParameters::isSet() const {
...
bool OAITableCreationParameters::isValid() const {
