...
/*
 * OAISourceTableDetails_ProvisionedThroughput.h
 *
 * 
 */

#ifndef OAISourceTableDetails_ProvisionedThroughput_H
#define OAISourceTableDetails_ProvisionedThroughput_H
...
class OAISourceTableDetails_ProvisionedThroughput : public OAIObject {
public:
    OAISourceTableDetails_ProvisionedThroughput();
    OAISourceTableDetails_ProvisionedThroughput(QString json);
    ~OAISourceTableDetails_ProvisionedThroughput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISourceTableDetails_ProvisionedThroughput)

#endif // OAISourceTableDetails_ProvisionedThroughput_H
