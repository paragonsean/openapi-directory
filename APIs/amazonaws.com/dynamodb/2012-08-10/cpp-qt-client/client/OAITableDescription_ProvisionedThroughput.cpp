...
OAITableDescription_ProvisionedThroughput::OAITableDescription_ProvisionedThroughput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITableDescription_ProvisionedThroughput::OAITableDescription_ProvisionedThroughput() {
    this->initializeModel();
}

OAITableDescription_ProvisionedThroughput::~OAITableDescription_ProvisionedThroughput() {}

void OAITableDescription_ProvisionedThroughput::initializeModel() {
...
void OAITableDescription_ProvisionedThroughput::fromJson(QString jsonString) {
...
void OAITableDescription_ProvisionedThroughput::fromJsonObject(QJsonObject json) {
...
QString OAITableDescription_ProvisionedThroughput::asJson() const {
...
QJsonObject OAITableDescription_ProvisionedThroughput::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAITableDescription_ProvisionedThroughput::getLastIncreaseDateTime() const {
    return m_last_increase_date_time;
}
void OAITableDescription_ProvisionedThroughput::setLastIncreaseDateTime(const QDateTime &last_increase_date_time) {
    m_last_increase_date_time = last_increase_date_time;
    m_last_increase_date_time_isSet = true;
}

bool OAITableDescription_ProvisionedThroughput::is_last_increase_date_time_Set() const{
    return m_last_increase_date_time_isSet;
}

bool OAITableDescription_ProvisionedThroughput::is_last_increase_date_time_Valid() const{
    return m_last_increase_date_time_isValid;
}

QDateTime OAITableDescription_ProvisionedThroughput::getLastDecreaseDateTime() const {
    return m_last_decrease_date_time;
}
void OAITableDescription_ProvisionedThroughput::setLastDecreaseDateTime(const QDateTime &last_decrease_date_time) {
    m_last_decrease_date_time = last_decrease_date_time;
    m_last_decrease_date_time_isSet = true;
}

bool OAITableDescription_ProvisionedThroughput::is_last_decrease_date_time_Set() const{
    return m_last_decrease_date_time_isSet;
}

bool OAITableDescription_ProvisionedThroughput::is_last_decrease_date_time_Valid() const{
    return m_last_decrease_date_time_isValid;
}

qint32 OAITableDescription_ProvisionedThroughput::getNumberOfDecreasesToday() const {
    return m_number_of_decreases_today;
}
void OAITableDescription_ProvisionedThroughput::setNumberOfDecreasesToday(const qint32 &number_of_decreases_today) {
    m_number_of_decreases_today = number_of_decreases_today;
    m_number_of_decreases_today_isSet = true;
}

bool OAITableDescription_ProvisionedThroughput::is_number_of_decreases_today_Set() const{
    return m_number_of_decreases_today_isSet;
}

bool OAITableDescription_ProvisionedThroughput::is_number_of_decreases_today_Valid() const{
    return m_number_of_decreases_today_isValid;
}

qint32 OAITableDescription_ProvisionedThroughput::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAITableDescription_ProvisionedThroughput::setReadCapacityUnits(const qint32 &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAITableDescription_ProvisionedThroughput::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAITableDescription_ProvisionedThroughput::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

qint32 OAITableDescription_ProvisionedThroughput::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAITableDescription_ProvisionedThroughput::setWriteCapacityUnits(const qint32 &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAITableDescription_ProvisionedThroughput::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAITableDescription_ProvisionedThroughput::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

bool OAITableDescription_ProvisionedThroughput::isSet() const {
...
bool OAITableDescription_ProvisionedThroughput::isValid() const {
