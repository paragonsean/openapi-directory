...
OAIGetItemOutput_ConsumedCapacity::OAIGetItemOutput_ConsumedCapacity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetItemOutput_ConsumedCapacity::OAIGetItemOutput_ConsumedCapacity() {
    this->initializeModel();
}

OAIGetItemOutput_ConsumedCapacity::~OAIGetItemOutput_ConsumedCapacity() {}

void OAIGetItemOutput_ConsumedCapacity::initializeModel() {
...
void OAIGetItemOutput_ConsumedCapacity::fromJson(QString jsonString) {
...
void OAIGetItemOutput_ConsumedCapacity::fromJsonObject(QJsonObject json) {
...
QString OAIGetItemOutput_ConsumedCapacity::asJson() const {
...
QJsonObject OAIGetItemOutput_ConsumedCapacity::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetItemOutput_ConsumedCapacity::getTableName() const {
    return m_table_name;
}
void OAIGetItemOutput_ConsumedCapacity::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_table_name_Valid() const{
    return m_table_name_isValid;
}

double OAIGetItemOutput_ConsumedCapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIGetItemOutput_ConsumedCapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

double OAIGetItemOutput_ConsumedCapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIGetItemOutput_ConsumedCapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIGetItemOutput_ConsumedCapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIGetItemOutput_ConsumedCapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

OAIConsumedCapacity_Table OAIGetItemOutput_ConsumedCapacity::getTable() const {
    return m_table;
}
void OAIGetItemOutput_ConsumedCapacity::setTable(const OAIConsumedCapacity_Table &table) {
    m_table = table;
    m_table_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_table_Set() const{
    return m_table_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_table_Valid() const{
    return m_table_isValid;
}

QMap OAIGetItemOutput_ConsumedCapacity::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIGetItemOutput_ConsumedCapacity::setLocalSecondaryIndexes(const QMap &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QMap OAIGetItemOutput_ConsumedCapacity::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIGetItemOutput_ConsumedCapacity::setGlobalSecondaryIndexes(const QMap &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIGetItemOutput_ConsumedCapacity::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIGetItemOutput_ConsumedCapacity::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

bool OAIGetItemOutput_ConsumedCapacity::isSet() const {
...
bool OAIGetItemOutput_ConsumedCapacity::isValid() const {
