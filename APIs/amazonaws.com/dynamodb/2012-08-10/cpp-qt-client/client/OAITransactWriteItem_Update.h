...
/*
 * OAITransactWriteItem_Update.h
 *
 * 
 */

#ifndef OAITransactWriteItem_Update_H
#define OAITransactWriteItem_Update_H
...
class OAITransactWriteItem_Update : public OAIObject {
public:
    OAITransactWriteItem_Update();
    OAITransactWriteItem_Update(QString json);
    ~OAITransactWriteItem_Update() override;
    ...
    QString getUpdateExpression() const;
    void setUpdateExpression(const QString &update_expression);
    bool is_update_expression_Set() const;
    bool is_update_expression_Valid() const;
...
private:
    ...
    QString m_update_expression;
    bool m_update_expression_isSet;
    bool m_update_expression_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactWriteItem_Update)

#endif // OAITransactWriteItem_Update_H
