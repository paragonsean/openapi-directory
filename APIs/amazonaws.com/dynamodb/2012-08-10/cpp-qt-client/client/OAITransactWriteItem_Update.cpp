...
OAITransactWriteItem_Update::OAITransactWriteItem_Update(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransactWriteItem_Update::OAITransactWriteItem_Update() {
    this->initializeModel();
}

OAITransactWriteItem_Update::~OAITransactWriteItem_Update() {}

void OAITransactWriteItem_Update::initializeModel() {
...
void OAITransactWriteItem_Update::fromJson(QString jsonString) {
...
void OAITransactWriteItem_Update::fromJsonObject(QJsonObject json) {
...
QString OAITransactWriteItem_Update::asJson() const {
...
QJsonObject OAITransactWriteItem_Update::asJsonObject() const {
    QJsonObject obj;
    if (m_key.isSet()) {
...
QMap OAITransactWriteItem_Update::getKey() const {
    return m_key;
}
void OAITransactWriteItem_Update::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAITransactWriteItem_Update::is_key_Set() const{
    return m_key_isSet;
}

bool OAITransactWriteItem_Update::is_key_Valid() const{
    return m_key_isValid;
}

QString OAITransactWriteItem_Update::getUpdateExpression() const {
    return m_update_expression;
}
void OAITransactWriteItem_Update::setUpdateExpression(const QString &update_expression) {
    m_update_expression = update_expression;
    m_update_expression_isSet = true;
}

bool OAITransactWriteItem_Update::is_update_expression_Set() const{
    return m_update_expression_isSet;
}

bool OAITransactWriteItem_Update::is_update_expression_Valid() const{
    return m_update_expression_isValid;
}

QString OAITransactWriteItem_Update::getTableName() const {
    return m_table_name;
}
void OAITransactWriteItem_Update::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAITransactWriteItem_Update::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAITransactWriteItem_Update::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAITransactWriteItem_Update::getConditionExpression() const {
    return m_condition_expression;
}
void OAITransactWriteItem_Update::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAITransactWriteItem_Update::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAITransactWriteItem_Update::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAITransactWriteItem_Update::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAITransactWriteItem_Update::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAITransactWriteItem_Update::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAITransactWriteItem_Update::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAITransactWriteItem_Update::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAITransactWriteItem_Update::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAITransactWriteItem_Update::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAITransactWriteItem_Update::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAITransactWriteItem_Update::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAITransactWriteItem_Update::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAITransactWriteItem_Update::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAITransactWriteItem_Update::is_return_values_on_condition_check_failure_Valid() const{
    return m_return_values_on_condition_check_failure_isValid;
}

bool OAITransactWriteItem_Update::isSet() const {
...
bool OAITransactWriteItem_Update::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_key_isValid && m_update_expression_isValid && m_table_name_isValid && true;
}
