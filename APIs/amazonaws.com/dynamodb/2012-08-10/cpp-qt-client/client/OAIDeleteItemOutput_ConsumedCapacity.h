...
/*
 * OAIDeleteItemOutput_ConsumedCapacity.h
 *
 * 
 */

#ifndef OAIDeleteItemOutput_ConsumedCapacity_H
#define OAIDeleteItemOutput_ConsumedCapacity_H
...
class OAIDeleteItemOutput_ConsumedCapacity : public OAIObject {
public:
    OAIDeleteItemOutput_ConsumedCapacity();
    OAIDeleteItemOutput_ConsumedCapacity(QString json);
    ~OAIDeleteItemOutput_ConsumedCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteItemOutput_ConsumedCapacity)

#endif // OAIDeleteItemOutput_ConsumedCapacity_H
