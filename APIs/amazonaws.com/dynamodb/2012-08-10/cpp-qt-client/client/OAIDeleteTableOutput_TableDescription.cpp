...
#include "OAIDeleteTableOutput_TableDescription.h"
...
OAIDeleteTableOutput_TableDescription::OAIDeleteTableOutput_TableDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteTableOutput_TableDescription::OAIDeleteTableOutput_TableDescription() {
    this->initializeModel();
}

OAIDeleteTableOutput_TableDescription::~OAIDeleteTableOutput_TableDescription() {}

void OAIDeleteTableOutput_TableDescription::initializeModel() {
...
void OAIDeleteTableOutput_TableDescription::fromJson(QString jsonString) {
...
void OAIDeleteTableOutput_TableDescription::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteTableOutput_TableDescription::asJson() const {
...
QJsonObject OAIDeleteTableOutput_TableDescription::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDeleteTableOutput_TableDescription::getAttributeDefinitions() const {
    return m_attribute_definitions;
}
void OAIDeleteTableOutput_TableDescription::setAttributeDefinitions(const QList &attribute_definitions) {
    m_attribute_definitions = attribute_definitions;
    m_attribute_definitions_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_attribute_definitions_Set() const{
    return m_attribute_definitions_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_attribute_definitions_Valid() const{
    return m_attribute_definitions_isValid;
}

QString OAIDeleteTableOutput_TableDescription::getTableName() const {
    return m_table_name;
}
void OAIDeleteTableOutput_TableDescription::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QList OAIDeleteTableOutput_TableDescription::getKeySchema() const {
    return m_key_schema;
}
void OAIDeleteTableOutput_TableDescription::setKeySchema(const QList &key_schema) {
    m_key_schema = key_schema;
    m_key_schema_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_key_schema_Set() const{
    return m_key_schema_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_key_schema_Valid() const{
    return m_key_schema_isValid;
}

OAITableStatus OAIDeleteTableOutput_TableDescription::getTableStatus() const {
    return m_table_status;
}
void OAIDeleteTableOutput_TableDescription::setTableStatus(const OAITableStatus &table_status) {
    m_table_status = table_status;
    m_table_status_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_table_status_Set() const{
    return m_table_status_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_table_status_Valid() const{
    return m_table_status_isValid;
}

QDateTime OAIDeleteTableOutput_TableDescription::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAIDeleteTableOutput_TableDescription::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

OAITableDescription_ProvisionedThroughput OAIDeleteTableOutput_TableDescription::getProvisionedThroughput() const {
    return m_provisioned_throughput;
}
void OAIDeleteTableOutput_TableDescription::setProvisionedThroughput(const OAITableDescription_ProvisionedThroughput &provisioned_throughput) {
    m_provisioned_throughput = provisioned_throughput;
    m_provisioned_throughput_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_provisioned_throughput_Set() const{
    return m_provisioned_throughput_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_provisioned_throughput_Valid() const{
    return m_provisioned_throughput_isValid;
}

qint32 OAIDeleteTableOutput_TableDescription::getTableSizeBytes() const {
    return m_table_size_bytes;
}
void OAIDeleteTableOutput_TableDescription::setTableSizeBytes(const qint32 &table_size_bytes) {
    m_table_size_bytes = table_size_bytes;
    m_table_size_bytes_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_table_size_bytes_Set() const{
    return m_table_size_bytes_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_table_size_bytes_Valid() const{
    return m_table_size_bytes_isValid;
}

qint32 OAIDeleteTableOutput_TableDescription::getItemCount() const {
    return m_item_count;
}
void OAIDeleteTableOutput_TableDescription::setItemCount(const qint32 &item_count) {
    m_item_count = item_count;
    m_item_count_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_item_count_Set() const{
    return m_item_count_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_item_count_Valid() const{
    return m_item_count_isValid;
}

QString OAIDeleteTableOutput_TableDescription::getTableArn() const {
    return m_table_arn;
}
void OAIDeleteTableOutput_TableDescription::setTableArn(const QString &table_arn) {
    m_table_arn = table_arn;
    m_table_arn_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_table_arn_Set() const{
    return m_table_arn_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_table_arn_Valid() const{
    return m_table_arn_isValid;
}

QString OAIDeleteTableOutput_TableDescription::getTableId() const {
    return m_table_id;
}
void OAIDeleteTableOutput_TableDescription::setTableId(const QString &table_id) {
    m_table_id = table_id;
    m_table_id_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_table_id_Set() const{
    return m_table_id_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_table_id_Valid() const{
    return m_table_id_isValid;
}

OAITableDescription_BillingModeSummary OAIDeleteTableOutput_TableDescription::getBillingModeSummary() const {
    return m_billing_mode_summary;
}
void OAIDeleteTableOutput_TableDescription::setBillingModeSummary(const OAITableDescription_BillingModeSummary &billing_mode_summary) {
    m_billing_mode_summary = billing_mode_summary;
    m_billing_mode_summary_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_billing_mode_summary_Set() const{
    return m_billing_mode_summary_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_billing_mode_summary_Valid() const{
    return m_billing_mode_summary_isValid;
}

QList OAIDeleteTableOutput_TableDescription::getLocalSecondaryIndexes() const {
    return m_local_secondary_indexes;
}
void OAIDeleteTableOutput_TableDescription::setLocalSecondaryIndexes(const QList &local_secondary_indexes) {
    m_local_secondary_indexes = local_secondary_indexes;
    m_local_secondary_indexes_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_local_secondary_indexes_Set() const{
    return m_local_secondary_indexes_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_local_secondary_indexes_Valid() const{
    return m_local_secondary_indexes_isValid;
}

QList OAIDeleteTableOutput_TableDescription::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAIDeleteTableOutput_TableDescription::setGlobalSecondaryIndexes(const QList &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

OAITableDescription_StreamSpecification OAIDeleteTableOutput_TableDescription::getStreamSpecification() const {
    return m_stream_specification;
}
void OAIDeleteTableOutput_TableDescription::setStreamSpecification(const OAITableDescription_StreamSpecification &stream_specification) {
    m_stream_specification = stream_specification;
    m_stream_specification_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_stream_specification_Set() const{
    return m_stream_specification_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_stream_specification_Valid() const{
    return m_stream_specification_isValid;
}

QString OAIDeleteTableOutput_TableDescription::getLatestStreamLabel() const {
    return m_latest_stream_label;
}
void OAIDeleteTableOutput_TableDescription::setLatestStreamLabel(const QString &latest_stream_label) {
    m_latest_stream_label = latest_stream_label;
    m_latest_stream_label_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_latest_stream_label_Set() const{
    return m_latest_stream_label_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_latest_stream_label_Valid() const{
    return m_latest_stream_label_isValid;
}

QString OAIDeleteTableOutput_TableDescription::getLatestStreamArn() const {
    return m_latest_stream_arn;
}
void OAIDeleteTableOutput_TableDescription::setLatestStreamArn(const QString &latest_stream_arn) {
    m_latest_stream_arn = latest_stream_arn;
    m_latest_stream_arn_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_latest_stream_arn_Set() const{
    return m_latest_stream_arn_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_latest_stream_arn_Valid() const{
    return m_latest_stream_arn_isValid;
}

QString OAIDeleteTableOutput_TableDescription::getGlobalTableVersion() const {
    return m_global_table_version;
}
void OAIDeleteTableOutput_TableDescription::setGlobalTableVersion(const QString &global_table_version) {
    m_global_table_version = global_table_version;
    m_global_table_version_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_global_table_version_Set() const{
    return m_global_table_version_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_global_table_version_Valid() const{
    return m_global_table_version_isValid;
}

QList OAIDeleteTableOutput_TableDescription::getReplicas() const {
    return m_replicas;
}
void OAIDeleteTableOutput_TableDescription::setReplicas(const QList &replicas) {
    m_replicas = replicas;
    m_replicas_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_replicas_Set() const{
    return m_replicas_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_replicas_Valid() const{
    return m_replicas_isValid;
}

OAITableDescription_RestoreSummary OAIDeleteTableOutput_TableDescription::getRestoreSummary() const {
    return m_restore_summary;
}
void OAIDeleteTableOutput_TableDescription::setRestoreSummary(const OAITableDescription_RestoreSummary &restore_summary) {
    m_restore_summary = restore_summary;
    m_restore_summary_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_restore_summary_Set() const{
    return m_restore_summary_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_restore_summary_Valid() const{
    return m_restore_summary_isValid;
}

OAITableDescription_SSEDescription OAIDeleteTableOutput_TableDescription::getSseDescription() const {
    return m_sse_description;
}
void OAIDeleteTableOutput_TableDescription::setSseDescription(const OAITableDescription_SSEDescription &sse_description) {
    m_sse_description = sse_description;
    m_sse_description_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_sse_description_Set() const{
    return m_sse_description_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_sse_description_Valid() const{
    return m_sse_description_isValid;
}

OAITableDescription_ArchivalSummary OAIDeleteTableOutput_TableDescription::getArchivalSummary() const {
    return m_archival_summary;
}
void OAIDeleteTableOutput_TableDescription::setArchivalSummary(const OAITableDescription_ArchivalSummary &archival_summary) {
    m_archival_summary = archival_summary;
    m_archival_summary_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_archival_summary_Set() const{
    return m_archival_summary_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_archival_summary_Valid() const{
    return m_archival_summary_isValid;
}

OAITableDescription_TableClassSummary OAIDeleteTableOutput_TableDescription::getTableClassSummary() const {
    return m_table_class_summary;
}
void OAIDeleteTableOutput_TableDescription::setTableClassSummary(const OAITableDescription_TableClassSummary &table_class_summary) {
    m_table_class_summary = table_class_summary;
    m_table_class_summary_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_table_class_summary_Set() const{
    return m_table_class_summary_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_table_class_summary_Valid() const{
    return m_table_class_summary_isValid;
}

bool OAIDeleteTableOutput_TableDescription::getDeletionProtectionEnabled() const {
    return m_deletion_protection_enabled;
}
void OAIDeleteTableOutput_TableDescription::setDeletionProtectionEnabled(const bool &deletion_protection_enabled) {
    m_deletion_protection_enabled = deletion_protection_enabled;
    m_deletion_protection_enabled_isSet = true;
}

bool OAIDeleteTableOutput_TableDescription::is_deletion_protection_enabled_Set() const{
    return m_deletion_protection_enabled_isSet;
}

bool OAIDeleteTableOutput_TableDescription::is_deletion_protection_enabled_Valid() const{
    return m_deletion_protection_enabled_isValid;
}

bool OAIDeleteTableOutput_TableDescription::isSet() const {
...
bool OAIDeleteTableOutput_TableDescription::isValid() const {
