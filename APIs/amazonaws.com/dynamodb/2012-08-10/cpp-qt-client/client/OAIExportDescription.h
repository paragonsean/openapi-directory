...
/*
 * OAIExportDescription.h
 *
 * Represents the properties of the exported table.
 */

#ifndef OAIExportDescription_H
#define OAIExportDescription_H
...
class OAIExportDescription : public OAIObject {
public:
    OAIExportDescription();
    OAIExportDescription(QString json);
    ~OAIExportDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportDescription)

#endif // OAIExportDescription_H
