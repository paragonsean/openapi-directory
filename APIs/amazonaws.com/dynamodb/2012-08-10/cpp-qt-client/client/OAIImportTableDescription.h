...
/*
 * OAIImportTableDescription.h
 *
 *  Represents the properties of the table being imported into. 
 */

#ifndef OAIImportTableDescription_H
#define OAIImportTableDescription_H
...
class OAIImportTableDescription : public OAIObject {
public:
    OAIImportTableDescription();
    OAIImportTableDescription(QString json);
    ~OAIImportTableDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportTableDescription)

#endif // OAIImportTableDescription_H
