...
void OAIGet::fromJson(QString jsonString) {
...
void OAIGet::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIGet::asJsonObject() const {
    QJsonObject obj;
    if (m_key.isSet()) {
...
QMap OAIGet::getKey() const {
    return m_key;
}
void OAIGet::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIGet::is_key_Set() const{
    return m_key_isSet;
}

bool OAIGet::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIGet::getTableName() const {
    return m_table_name;
}
void OAIGet::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIGet::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIGet::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAIGet::getProjectionExpression() const {
    return m_projection_expression;
}
void OAIGet::setProjectionExpression(const QString &projection_expression) {
    m_projection_expression = projection_expression;
    m_projection_expression_isSet = true;
}

bool OAIGet::is_projection_expression_Set() const{
    return m_projection_expression_isSet;
}

bool OAIGet::is_projection_expression_Valid() const{
    return m_projection_expression_isValid;
}

QMap OAIGet::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAIGet::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAIGet::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAIGet::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

bool OAIGet::isSet() const {
