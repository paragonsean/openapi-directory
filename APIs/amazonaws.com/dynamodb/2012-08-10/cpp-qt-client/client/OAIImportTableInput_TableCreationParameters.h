...
/*
 * OAIImportTableInput_TableCreationParameters.h
 *
 * 
 */

#ifndef OAIImportTableInput_TableCreationParameters_H
#define OAIImportTableInput_TableCreationParameters_H

#include <QJsonObject>

#include "OAIBillingMode.h"
#include "OAIProvisionedThroughput.h"
#include "OAISSESpecification.h"
#include <QList>
#include <QString>
...
class OAISSESpecification;

class OAIImportTableInput_TableCreationParameters : public OAIObject {
public:
    OAIImportTableInput_TableCreationParameters();
    OAIImportTableInput_TableCreationParameters(QString json);
    ~OAIImportTableInput_TableCreationParameters() override;
    ...
    OAISSESpecification getSseSpecification() const;
    void setSseSpecification(const OAISSESpecification &sse_specification);
...
private:
    ...
    OAISSESpecification m_sse_specification;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportTableInput_TableCreationParameters)

#endif // OAIImportTableInput_TableCreationParameters_H
