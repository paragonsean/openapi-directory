...
#include "OAIGlobalSecondaryIndexInfo.h"
...
OAIGlobalSecondaryIndexInfo::OAIGlobalSecondaryIndexInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGlobalSecondaryIndexInfo::OAIGlobalSecondaryIndexInfo() {
    this->initializeModel();
}

OAIGlobalSecondaryIndexInfo::~OAIGlobalSecondaryIndexInfo() {}

void OAIGlobalSecondaryIndexInfo::initializeModel() {
...
void OAIGlobalSecondaryIndexInfo::fromJson(QString jsonString) {
...
void OAIGlobalSecondaryIndexInfo::fromJsonObject(QJsonObject json) {
...
QString OAIGlobalSecondaryIndexInfo::asJson() const {
...
QJsonObject OAIGlobalSecondaryIndexInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGlobalSecondaryIndexInfo::getIndexName() const {
    return m_index_name;
}
void OAIGlobalSecondaryIndexInfo::setIndexName(const QString &index_name) {
    m_index_name = index_name;
    m_index_name_isSet = true;
}

bool OAIGlobalSecondaryIndexInfo::is_index_name_Set() const{
    return m_index_name_isSet;
}

bool OAIGlobalSecondaryIndexInfo::is_index_name_Valid() const{
    return m_index_name_isValid;
}

QList OAIGlobalSecondaryIndexInfo::getKeySchema() const {
    return m_key_schema;
}
void OAIGlobalSecondaryIndexInfo::setKeySchema(const QList &key_schema) {
    m_key_schema = key_schema;
    m_key_schema_isSet = true;
}

bool OAIGlobalSecondaryIndexInfo::is_key_schema_Set() const{
    return m_key_schema_isSet;
}

bool OAIGlobalSecondaryIndexInfo::is_key_schema_Valid() const{
    return m_key_schema_isValid;
}

OAIGlobalSecondaryIndex_Projection OAIGlobalSecondaryIndexInfo::getProjection() const {
    return m_projection;
}
void OAIGlobalSecondaryIndexInfo::setProjection(const OAIGlobalSecondaryIndex_Projection &projection) {
    m_projection = projection;
    m_projection_isSet = true;
}

bool OAIGlobalSecondaryIndexInfo::is_projection_Set() const{
    return m_projection_isSet;
}

bool OAIGlobalSecondaryIndexInfo::is_projection_Valid() const{
    return m_projection_isValid;
}

OAIGlobalSecondaryIndexInfo_ProvisionedThroughput OAIGlobalSecondaryIndexInfo::getProvisionedThroughput() const {
    return m_provisioned_throughput;
}
void OAIGlobalSecondaryIndexInfo::setProvisionedThroughput(const OAIGlobalSecondaryIndexInfo_ProvisionedThroughput &provisioned_throughput) {
    m_provisioned_throughput = provisioned_throughput;
    m_provisioned_throughput_isSet = true;
}

bool OAIGlobalSecondaryIndexInfo::is_provisioned_throughput_Set() const{
    return m_provisioned_throughput_isSet;
}

bool OAIGlobalSecondaryIndexInfo::is_provisioned_throughput_Valid() const{
    return m_provisioned_throughput_isValid;
}

bool OAIGlobalSecondaryIndexInfo::isSet() const {
...
bool OAIGlobalSecondaryIndexInfo::isValid() const {
