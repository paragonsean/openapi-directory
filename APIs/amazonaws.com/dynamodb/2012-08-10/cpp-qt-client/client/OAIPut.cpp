...
void OAIPut::fromJson(QString jsonString) {
...
void OAIPut::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIPut::asJsonObject() const {
    QJsonObject obj;
    if (m_item.isSet()) {
...
QMap OAIPut::getItem() const {
    return m_item;
}
void OAIPut::setItem(const QMap &item) {
    m_item = item;
    m_item_isSet = true;
}

bool OAIPut::is_item_Set() const{
    return m_item_isSet;
}

bool OAIPut::is_item_Valid() const{
    return m_item_isValid;
}

QString OAIPut::getTableName() const {
    return m_table_name;
}
void OAIPut::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIPut::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIPut::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAIPut::getConditionExpression() const {
    return m_condition_expression;
}
void OAIPut::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAIPut::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAIPut::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAIPut::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAIPut::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAIPut::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAIPut::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAIPut::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAIPut::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAIPut::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAIPut::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAIPut::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAIPut::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAIPut::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAIPut::is_return_values_on_condition_check_failure_Valid() const{
    return m_return_values_on_condition_check_failure_isValid;
}

bool OAIPut::isSet() const {
