...
/*
 * OAIQueryOutput_ConsumedCapacity.h
 *
 * 
 */

#ifndef OAIQueryOutput_ConsumedCapacity_H
#define OAIQueryOutput_ConsumedCapacity_H
...
class OAIQueryOutput_ConsumedCapacity : public OAIObject {
public:
    OAIQueryOutput_ConsumedCapacity();
    OAIQueryOutput_ConsumedCapacity(QString json);
    ~OAIQueryOutput_ConsumedCapacity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIQueryOutput_ConsumedCapacity)

#endif // OAIQueryOutput_ConsumedCapacity_H
