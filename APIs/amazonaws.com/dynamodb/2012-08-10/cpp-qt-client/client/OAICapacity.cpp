...
double OAICapacity::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAICapacity::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAICapacity::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAICapacity::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAICapacity::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAICapacity::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAICapacity::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAICapacity::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

double OAICapacity::getCapacityUnits() const {
    return m_capacity_units;
}
void OAICapacity::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAICapacity::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAICapacity::is_capacity_units_Valid() const{
