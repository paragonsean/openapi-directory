...
QMap OAIDelete::getKey() const {
    return m_key;
}
void OAIDelete::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAIDelete::is_key_Set() const{
    return m_key_isSet;
}

bool OAIDelete::is_key_Valid() const{
    return m_key_isValid;
}

QString OAIDelete::getTableName() const {
    return m_table_name;
}
void OAIDelete::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAIDelete::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAIDelete::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAIDelete::getConditionExpression() const {
    return m_condition_expression;
}
void OAIDelete::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAIDelete::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAIDelete::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAIDelete::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAIDelete::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAIDelete::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAIDelete::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAIDelete::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAIDelete::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAIDelete::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAIDelete::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAIDelete::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAIDelete::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAIDelete::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAIDelete::is_return_values_on_condition_check_failure_Valid() const{
