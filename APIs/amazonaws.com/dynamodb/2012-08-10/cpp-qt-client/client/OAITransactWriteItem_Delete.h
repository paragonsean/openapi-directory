...
/*
 * OAITransactWriteItem_Delete.h
 *
 * 
 */

#ifndef OAITransactWriteItem_Delete_H
#define OAITransactWriteItem_Delete_H
...
class OAITransactWriteItem_Delete : public OAIObject {
public:
    OAITransactWriteItem_Delete();
    OAITransactWriteItem_Delete(QString json);
    ~OAITransactWriteItem_Delete() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransactWriteItem_Delete)

#endif // OAITransactWriteItem_Delete_H
