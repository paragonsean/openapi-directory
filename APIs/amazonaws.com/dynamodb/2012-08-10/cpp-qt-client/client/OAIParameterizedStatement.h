...
/*
 * OAIParameterizedStatement.h
 *
 *  Represents a PartiQL statment that uses parameters. 
 */

#ifndef OAIParameterizedStatement_H
#define OAIParameterizedStatement_H
...
class OAIParameterizedStatement : public OAIObject {
public:
    OAIParameterizedStatement();
    OAIParameterizedStatement(QString json);
    ~OAIParameterizedStatement() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterizedStatement)

#endif // OAIParameterizedStatement_H
