...
QMap OAIDeleteItemInput::getKey() const {
    return m_key;
}
void OAIDeleteItemInput::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}
...
QMap OAIDeleteItemInput::getExpected() const {
    return m_expected;
}
void OAIDeleteItemInput::setExpected(const QMap &expected) {
    m_expected = expected;
...
OAIConditionalOperator OAIDeleteItemInput::getConditionalOperator() const {
    return m_conditional_operator;
}
void OAIDeleteItemInput::setConditionalOperator(const OAIConditionalOperator &conditional_operator) {
    m_conditional_operator = conditional_operator;
    m_conditional_operator_isSet = true;
}

bool OAIDeleteItemInput::is_conditional_operator_Set() const{
    return m_conditional_operator_isSet;
}

bool OAIDeleteItemInput::is_conditional_operator_Valid() const{
...
OAIReturnConsumedCapacity OAIDeleteItemInput::getReturnConsumedCapacity() const {
    return m_return_consumed_capacity;
}
void OAIDeleteItemInput::setReturnConsumedCapacity(const OAIReturnConsumedCapacity &return_consumed_capacity) {
    m_return_consumed_capacity = return_consumed_capacity;
    m_return_consumed_capacity_isSet = true;
}

bool OAIDeleteItemInput::is_return_consumed_capacity_Set() const{
    return m_return_consumed_capacity_isSet;
}

bool OAIDeleteItemInput::is_return_consumed_capacity_Valid() const{
    return m_return_consumed_capacity_isValid;
}

OAIReturnItemCollectionMetrics OAIDeleteItemInput::getReturnItemCollectionMetrics() const {
    return m_return_item_collection_metrics;
}
void OAIDeleteItemInput::setReturnItemCollectionMetrics(const OAIReturnItemCollectionMetrics &return_item_collection_metrics) {
    m_return_item_collection_metrics = return_item_collection_metrics;
    m_return_item_collection_metrics_isSet = true;
}

bool OAIDeleteItemInput::is_return_item_collection_metrics_Set() const{
    return m_return_item_collection_metrics_isSet;
}

bool OAIDeleteItemInput::is_return_item_collection_metrics_Valid() const{
    return m_return_item_collection_metrics_isValid;
}

QString OAIDeleteItemInput::getConditionExpression() const {
    return m_condition_expression;
}
void OAIDeleteItemInput::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAIDeleteItemInput::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAIDeleteItemInput::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAIDeleteItemInput::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAIDeleteItemInput::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAIDeleteItemInput::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAIDeleteItemInput::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAIDeleteItemInput::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAIDeleteItemInput::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAIDeleteItemInput::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAIDeleteItemInput::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAIDeleteItemInput::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAIDeleteItemInput::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAIDeleteItemInput::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAIDeleteItemInput::is_return_values_on_condition_check_failure_Valid() const{
