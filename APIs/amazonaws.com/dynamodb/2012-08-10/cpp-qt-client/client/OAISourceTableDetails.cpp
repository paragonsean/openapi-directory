...
#include "OAISourceTableDetails.h"
...
OAISourceTableDetails::OAISourceTableDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceTableDetails::OAISourceTableDetails() {
    this->initializeModel();
}

OAISourceTableDetails::~OAISourceTableDetails() {}

void OAISourceTableDetails::initializeModel() {
...
void OAISourceTableDetails::fromJson(QString jsonString) {
...
void OAISourceTableDetails::fromJsonObject(QJsonObject json) {
...
QString OAISourceTableDetails::asJson() const {
...
QJsonObject OAISourceTableDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAISourceTableDetails::getTableName() const {
    return m_table_name;
}
void OAISourceTableDetails::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAISourceTableDetails::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAISourceTableDetails::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAISourceTableDetails::getTableId() const {
    return m_table_id;
}
void OAISourceTableDetails::setTableId(const QString &table_id) {
    m_table_id = table_id;
    m_table_id_isSet = true;
}

bool OAISourceTableDetails::is_table_id_Set() const{
    return m_table_id_isSet;
}

bool OAISourceTableDetails::is_table_id_Valid() const{
    return m_table_id_isValid;
}

QString OAISourceTableDetails::getTableArn() const {
    return m_table_arn;
}
void OAISourceTableDetails::setTableArn(const QString &table_arn) {
    m_table_arn = table_arn;
    m_table_arn_isSet = true;
}

bool OAISourceTableDetails::is_table_arn_Set() const{
    return m_table_arn_isSet;
}

bool OAISourceTableDetails::is_table_arn_Valid() const{
    return m_table_arn_isValid;
}

qint32 OAISourceTableDetails::getTableSizeBytes() const {
    return m_table_size_bytes;
}
void OAISourceTableDetails::setTableSizeBytes(const qint32 &table_size_bytes) {
    m_table_size_bytes = table_size_bytes;
    m_table_size_bytes_isSet = true;
}

bool OAISourceTableDetails::is_table_size_bytes_Set() const{
    return m_table_size_bytes_isSet;
}

bool OAISourceTableDetails::is_table_size_bytes_Valid() const{
    return m_table_size_bytes_isValid;
}

QList OAISourceTableDetails::getKeySchema() const {
    return m_key_schema;
}
void OAISourceTableDetails::setKeySchema(const QList &key_schema) {
    m_key_schema = key_schema;
    m_key_schema_isSet = true;
}

bool OAISourceTableDetails::is_key_schema_Set() const{
    return m_key_schema_isSet;
}

bool OAISourceTableDetails::is_key_schema_Valid() const{
    return m_key_schema_isValid;
}

QDateTime OAISourceTableDetails::getTableCreationDateTime() const {
    return m_table_creation_date_time;
}
void OAISourceTableDetails::setTableCreationDateTime(const QDateTime &table_creation_date_time) {
    m_table_creation_date_time = table_creation_date_time;
    m_table_creation_date_time_isSet = true;
}

bool OAISourceTableDetails::is_table_creation_date_time_Set() const{
    return m_table_creation_date_time_isSet;
}

bool OAISourceTableDetails::is_table_creation_date_time_Valid() const{
    return m_table_creation_date_time_isValid;
}

OAISourceTableDetails_ProvisionedThroughput OAISourceTableDetails::getProvisionedThroughput() const {
    return m_provisioned_throughput;
}
void OAISourceTableDetails::setProvisionedThroughput(const OAISourceTableDetails_ProvisionedThroughput &provisioned_throughput) {
    m_provisioned_throughput = provisioned_throughput;
    m_provisioned_throughput_isSet = true;
}

bool OAISourceTableDetails::is_provisioned_throughput_Set() const{
    return m_provisioned_throughput_isSet;
}

bool OAISourceTableDetails::is_provisioned_throughput_Valid() const{
    return m_provisioned_throughput_isValid;
}

qint32 OAISourceTableDetails::getItemCount() const {
    return m_item_count;
}
void OAISourceTableDetails::setItemCount(const qint32 &item_count) {
    m_item_count = item_count;
    m_item_count_isSet = true;
}

bool OAISourceTableDetails::is_item_count_Set() const{
    return m_item_count_isSet;
}

bool OAISourceTableDetails::is_item_count_Valid() const{
    return m_item_count_isValid;
}

OAIBillingMode OAISourceTableDetails::getBillingMode() const {
    return m_billing_mode;
}
void OAISourceTableDetails::setBillingMode(const OAIBillingMode &billing_mode) {
    m_billing_mode = billing_mode;
    m_billing_mode_isSet = true;
}

bool OAISourceTableDetails::is_billing_mode_Set() const{
    return m_billing_mode_isSet;
}

bool OAISourceTableDetails::is_billing_mode_Valid() const{
    return m_billing_mode_isValid;
}

bool OAISourceTableDetails::isSet() const {
...
bool OAISourceTableDetails::isValid() const {
