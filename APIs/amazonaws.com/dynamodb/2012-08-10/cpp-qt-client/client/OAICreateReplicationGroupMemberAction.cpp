...
#include "OAICreateReplicationGroupMemberAction.h"
...
OAICreateReplicationGroupMemberAction::OAICreateReplicationGroupMemberAction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateReplicationGroupMemberAction::OAICreateReplicationGroupMemberAction() {
    this->initializeModel();
}

OAICreateReplicationGroupMemberAction::~OAICreateReplicationGroupMemberAction() {}

void OAICreateReplicationGroupMemberAction::initializeModel() {
...
void OAICreateReplicationGroupMemberAction::fromJson(QString jsonString) {
...
void OAICreateReplicationGroupMemberAction::fromJsonObject(QJsonObject json) {
...
QString OAICreateReplicationGroupMemberAction::asJson() const {
...
QJsonObject OAICreateReplicationGroupMemberAction::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateReplicationGroupMemberAction::getRegionName() const {
    return m_region_name;
}
void OAICreateReplicationGroupMemberAction::setRegionName(const QString &region_name) {
    m_region_name = region_name;
    m_region_name_isSet = true;
}

bool OAICreateReplicationGroupMemberAction::is_region_name_Set() const{
    return m_region_name_isSet;
}

bool OAICreateReplicationGroupMemberAction::is_region_name_Valid() const{
    return m_region_name_isValid;
}

QString OAICreateReplicationGroupMemberAction::getKmsMasterKeyId() const {
    return m_kms_master_key_id;
}
void OAICreateReplicationGroupMemberAction::setKmsMasterKeyId(const QString &kms_master_key_id) {
    m_kms_master_key_id = kms_master_key_id;
    m_kms_master_key_id_isSet = true;
}

bool OAICreateReplicationGroupMemberAction::is_kms_master_key_id_Set() const{
    return m_kms_master_key_id_isSet;
}

bool OAICreateReplicationGroupMemberAction::is_kms_master_key_id_Valid() const{
    return m_kms_master_key_id_isValid;
}

OAICreateReplicationGroupMemberAction_ProvisionedThroughputOverride OAICreateReplicationGroupMemberAction::getProvisionedThroughputOverride() const {
    return m_provisioned_throughput_override;
}
void OAICreateReplicationGroupMemberAction::setProvisionedThroughputOverride(const OAICreateReplicationGroupMemberAction_ProvisionedThroughputOverride &provisioned_throughput_override) {
    m_provisioned_throughput_override = provisioned_throughput_override;
    m_provisioned_throughput_override_isSet = true;
}

bool OAICreateReplicationGroupMemberAction::is_provisioned_throughput_override_Set() const{
    return m_provisioned_throughput_override_isSet;
}

bool OAICreateReplicationGroupMemberAction::is_provisioned_throughput_override_Valid() const{
    return m_provisioned_throughput_override_isValid;
}

QList OAICreateReplicationGroupMemberAction::getGlobalSecondaryIndexes() const {
    return m_global_secondary_indexes;
}
void OAICreateReplicationGroupMemberAction::setGlobalSecondaryIndexes(const QList &global_secondary_indexes) {
    m_global_secondary_indexes = global_secondary_indexes;
    m_global_secondary_indexes_isSet = true;
}

bool OAICreateReplicationGroupMemberAction::is_global_secondary_indexes_Set() const{
    return m_global_secondary_indexes_isSet;
}

bool OAICreateReplicationGroupMemberAction::is_global_secondary_indexes_Valid() const{
    return m_global_secondary_indexes_isValid;
}

OAITableClass OAICreateReplicationGroupMemberAction::getTableClassOverride() const {
    return m_table_class_override;
}
void OAICreateReplicationGroupMemberAction::setTableClassOverride(const OAITableClass &table_class_override) {
    m_table_class_override = table_class_override;
    m_table_class_override_isSet = true;
}

bool OAICreateReplicationGroupMemberAction::is_table_class_override_Set() const{
    return m_table_class_override_isSet;
}

bool OAICreateReplicationGroupMemberAction::is_table_class_override_Valid() const{
    return m_table_class_override_isValid;
}

bool OAICreateReplicationGroupMemberAction::isSet() const {
...
bool OAICreateReplicationGroupMemberAction::isValid() const {
