...
#include "OAICreateBackupOutput_BackupDetails.h"
...
OAICreateBackupOutput_BackupDetails::OAICreateBackupOutput_BackupDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBackupOutput_BackupDetails::OAICreateBackupOutput_BackupDetails() {
    this->initializeModel();
}

OAICreateBackupOutput_BackupDetails::~OAICreateBackupOutput_BackupDetails() {}

void OAICreateBackupOutput_BackupDetails::initializeModel() {
...
void OAICreateBackupOutput_BackupDetails::fromJson(QString jsonString) {
...
void OAICreateBackupOutput_BackupDetails::fromJsonObject(QJsonObject json) {
...
QString OAICreateBackupOutput_BackupDetails::asJson() const {
...
QJsonObject OAICreateBackupOutput_BackupDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBackupOutput_BackupDetails::getBackupArn() const {
    return m_backup_arn;
}
void OAICreateBackupOutput_BackupDetails::setBackupArn(const QString &backup_arn) {
    m_backup_arn = backup_arn;
    m_backup_arn_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_arn_Set() const{
    return m_backup_arn_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_arn_Valid() const{
    return m_backup_arn_isValid;
}

QString OAICreateBackupOutput_BackupDetails::getBackupName() const {
    return m_backup_name;
}
void OAICreateBackupOutput_BackupDetails::setBackupName(const QString &backup_name) {
    m_backup_name = backup_name;
    m_backup_name_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_name_Set() const{
    return m_backup_name_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_name_Valid() const{
    return m_backup_name_isValid;
}

qint32 OAICreateBackupOutput_BackupDetails::getBackupSizeBytes() const {
    return m_backup_size_bytes;
}
void OAICreateBackupOutput_BackupDetails::setBackupSizeBytes(const qint32 &backup_size_bytes) {
    m_backup_size_bytes = backup_size_bytes;
    m_backup_size_bytes_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_size_bytes_Set() const{
    return m_backup_size_bytes_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_size_bytes_Valid() const{
    return m_backup_size_bytes_isValid;
}

OAIBackupStatus OAICreateBackupOutput_BackupDetails::getBackupStatus() const {
    return m_backup_status;
}
void OAICreateBackupOutput_BackupDetails::setBackupStatus(const OAIBackupStatus &backup_status) {
    m_backup_status = backup_status;
    m_backup_status_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_status_Set() const{
    return m_backup_status_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_status_Valid() const{
    return m_backup_status_isValid;
}

OAIBackupType OAICreateBackupOutput_BackupDetails::getBackupType() const {
    return m_backup_type;
}
void OAICreateBackupOutput_BackupDetails::setBackupType(const OAIBackupType &backup_type) {
    m_backup_type = backup_type;
    m_backup_type_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_type_Set() const{
    return m_backup_type_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_type_Valid() const{
    return m_backup_type_isValid;
}

QDateTime OAICreateBackupOutput_BackupDetails::getBackupCreationDateTime() const {
    return m_backup_creation_date_time;
}
void OAICreateBackupOutput_BackupDetails::setBackupCreationDateTime(const QDateTime &backup_creation_date_time) {
    m_backup_creation_date_time = backup_creation_date_time;
    m_backup_creation_date_time_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_creation_date_time_Set() const{
    return m_backup_creation_date_time_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_creation_date_time_Valid() const{
    return m_backup_creation_date_time_isValid;
}

QDateTime OAICreateBackupOutput_BackupDetails::getBackupExpiryDateTime() const {
    return m_backup_expiry_date_time;
}
void OAICreateBackupOutput_BackupDetails::setBackupExpiryDateTime(const QDateTime &backup_expiry_date_time) {
    m_backup_expiry_date_time = backup_expiry_date_time;
    m_backup_expiry_date_time_isSet = true;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_expiry_date_time_Set() const{
    return m_backup_expiry_date_time_isSet;
}

bool OAICreateBackupOutput_BackupDetails::is_backup_expiry_date_time_Valid() const{
    return m_backup_expiry_date_time_isValid;
}

bool OAICreateBackupOutput_BackupDetails::isSet() const {
...
bool OAICreateBackupOutput_BackupDetails::isValid() const {
