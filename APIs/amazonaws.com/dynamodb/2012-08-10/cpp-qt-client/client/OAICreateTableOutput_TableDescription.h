...
/*
 * OAICreateTableOutput_TableDescription.h
 *
 * 
 */

#ifndef OAICreateTableOutput_TableDescription_H
#define OAICreateTableOutput_TableDescription_H
...
class OAICreateTableOutput_TableDescription : public OAIObject {
public:
    OAICreateTableOutput_TableDescription();
    OAICreateTableOutput_TableDescription(QString json);
    ~OAICreateTableOutput_TableDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateTableOutput_TableDescription)

#endif // OAICreateTableOutput_TableDescription_H
