...
/*
 * OAIImportTableInput_S3BucketSource.h
 *
 * 
 */

#ifndef OAIImportTableInput_S3BucketSource_H
#define OAIImportTableInput_S3BucketSource_H
...
class OAIImportTableInput_S3BucketSource : public OAIObject {
public:
    OAIImportTableInput_S3BucketSource();
    OAIImportTableInput_S3BucketSource(QString json);
    ~OAIImportTableInput_S3BucketSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportTableInput_S3BucketSource)

#endif // OAIImportTableInput_S3BucketSource_H
