...
/*
 * OAIContinuousBackupsDescription.h
 *
 * Represents the continuous backups and point in time recovery settings on the table.
 */

#ifndef OAIContinuousBackupsDescription_H
#define OAIContinuousBackupsDescription_H
...
class OAIContinuousBackupsDescription : public OAIObject {
public:
    OAIContinuousBackupsDescription();
    OAIContinuousBackupsDescription(QString json);
    ~OAIContinuousBackupsDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContinuousBackupsDescription)

#endif // OAIContinuousBackupsDescription_H
