...
/*
 * OAILocalSecondaryIndex_Projection.h
 *
 * 
 */

#ifndef OAILocalSecondaryIndex_Projection_H
#define OAILocalSecondaryIndex_Projection_H
...
class OAILocalSecondaryIndex_Projection : public OAIObject {
public:
    OAILocalSecondaryIndex_Projection();
    OAILocalSecondaryIndex_Projection(QString json);
    ~OAILocalSecondaryIndex_Projection() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILocalSecondaryIndex_Projection)

#endif // OAILocalSecondaryIndex_Projection_H
