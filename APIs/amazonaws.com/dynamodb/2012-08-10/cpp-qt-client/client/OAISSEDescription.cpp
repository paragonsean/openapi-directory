...
OAISSEDescription::OAISSEDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISSEDescription::OAISSEDescription() {
    this->initializeModel();
}

OAISSEDescription::~OAISSEDescription() {}

void OAISSEDescription::initializeModel() {
...
void OAISSEDescription::fromJson(QString jsonString) {
...
void OAISSEDescription::fromJsonObject(QJsonObject json) {
...
QString OAISSEDescription::asJson() const {
...
QJsonObject OAISSEDescription::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAISSEStatus OAISSEDescription::getStatus() const {
    return m_status;
}
void OAISSEDescription::setStatus(const OAISSEStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAISSEDescription::is_status_Set() const{
    return m_status_isSet;
}

bool OAISSEDescription::is_status_Valid() const{
    return m_status_isValid;
}

OAISSEType OAISSEDescription::getSseType() const {
    return m_sse_type;
}
void OAISSEDescription::setSseType(const OAISSEType &sse_type) {
    m_sse_type = sse_type;
    m_sse_type_isSet = true;
}

bool OAISSEDescription::is_sse_type_Set() const{
    return m_sse_type_isSet;
}

bool OAISSEDescription::is_sse_type_Valid() const{
    return m_sse_type_isValid;
}

QString OAISSEDescription::getKmsMasterKeyArn() const {
    return m_kms_master_key_arn;
}
void OAISSEDescription::setKmsMasterKeyArn(const QString &kms_master_key_arn) {
    m_kms_master_key_arn = kms_master_key_arn;
    m_kms_master_key_arn_isSet = true;
}

bool OAISSEDescription::is_kms_master_key_arn_Set() const{
    return m_kms_master_key_arn_isSet;
}

bool OAISSEDescription::is_kms_master_key_arn_Valid() const{
    return m_kms_master_key_arn_isValid;
}

QDateTime OAISSEDescription::getInaccessibleEncryptionDateTime() const {
    return m_inaccessible_encryption_date_time;
}
void OAISSEDescription::setInaccessibleEncryptionDateTime(const QDateTime &inaccessible_encryption_date_time) {
    m_inaccessible_encryption_date_time = inaccessible_encryption_date_time;
    m_inaccessible_encryption_date_time_isSet = true;
}

bool OAISSEDescription::is_inaccessible_encryption_date_time_Set() const{
    return m_inaccessible_encryption_date_time_isSet;
}

bool OAISSEDescription::is_inaccessible_encryption_date_time_Valid() const{
    return m_inaccessible_encryption_date_time_isValid;
}

bool OAISSEDescription::isSet() const {
...
bool OAISSEDescription::isValid() const {
