...
OAITransactWriteItem_ConditionCheck::OAITransactWriteItem_ConditionCheck(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransactWriteItem_ConditionCheck::OAITransactWriteItem_ConditionCheck() {
    this->initializeModel();
}

OAITransactWriteItem_ConditionCheck::~OAITransactWriteItem_ConditionCheck() {}

void OAITransactWriteItem_ConditionCheck::initializeModel() {
...
void OAITransactWriteItem_ConditionCheck::fromJson(QString jsonString) {
...
void OAITransactWriteItem_ConditionCheck::fromJsonObject(QJsonObject json) {
...
QString OAITransactWriteItem_ConditionCheck::asJson() const {
...
QJsonObject OAITransactWriteItem_ConditionCheck::asJsonObject() const {
    QJsonObject obj;
    if (m_key.isSet()) {
...
QMap OAITransactWriteItem_ConditionCheck::getKey() const {
    return m_key;
}
void OAITransactWriteItem_ConditionCheck::setKey(const QMap &key) {
    m_key = key;
    m_key_isSet = true;
}

bool OAITransactWriteItem_ConditionCheck::is_key_Set() const{
    return m_key_isSet;
}

bool OAITransactWriteItem_ConditionCheck::is_key_Valid() const{
    return m_key_isValid;
}

QString OAITransactWriteItem_ConditionCheck::getTableName() const {
    return m_table_name;
}
void OAITransactWriteItem_ConditionCheck::setTableName(const QString &table_name) {
    m_table_name = table_name;
    m_table_name_isSet = true;
}

bool OAITransactWriteItem_ConditionCheck::is_table_name_Set() const{
    return m_table_name_isSet;
}

bool OAITransactWriteItem_ConditionCheck::is_table_name_Valid() const{
    return m_table_name_isValid;
}

QString OAITransactWriteItem_ConditionCheck::getConditionExpression() const {
    return m_condition_expression;
}
void OAITransactWriteItem_ConditionCheck::setConditionExpression(const QString &condition_expression) {
    m_condition_expression = condition_expression;
    m_condition_expression_isSet = true;
}

bool OAITransactWriteItem_ConditionCheck::is_condition_expression_Set() const{
    return m_condition_expression_isSet;
}

bool OAITransactWriteItem_ConditionCheck::is_condition_expression_Valid() const{
    return m_condition_expression_isValid;
}

QMap OAITransactWriteItem_ConditionCheck::getExpressionAttributeNames() const {
    return m_expression_attribute_names;
}
void OAITransactWriteItem_ConditionCheck::setExpressionAttributeNames(const QMap &expression_attribute_names) {
    m_expression_attribute_names = expression_attribute_names;
    m_expression_attribute_names_isSet = true;
}

bool OAITransactWriteItem_ConditionCheck::is_expression_attribute_names_Set() const{
    return m_expression_attribute_names_isSet;
}

bool OAITransactWriteItem_ConditionCheck::is_expression_attribute_names_Valid() const{
    return m_expression_attribute_names_isValid;
}

QMap OAITransactWriteItem_ConditionCheck::getExpressionAttributeValues() const {
    return m_expression_attribute_values;
}
void OAITransactWriteItem_ConditionCheck::setExpressionAttributeValues(const QMap &expression_attribute_values) {
    m_expression_attribute_values = expression_attribute_values;
    m_expression_attribute_values_isSet = true;
}

bool OAITransactWriteItem_ConditionCheck::is_expression_attribute_values_Set() const{
    return m_expression_attribute_values_isSet;
}

bool OAITransactWriteItem_ConditionCheck::is_expression_attribute_values_Valid() const{
    return m_expression_attribute_values_isValid;
}

OAIReturnValuesOnConditionCheckFailure OAITransactWriteItem_ConditionCheck::getReturnValuesOnConditionCheckFailure() const {
    return m_return_values_on_condition_check_failure;
}
void OAITransactWriteItem_ConditionCheck::setReturnValuesOnConditionCheckFailure(const OAIReturnValuesOnConditionCheckFailure &return_values_on_condition_check_failure) {
...
bool OAITransactWriteItem_ConditionCheck::is_return_values_on_condition_check_failure_Set() const{
    return m_return_values_on_condition_check_failure_isSet;
}

bool OAITransactWriteItem_ConditionCheck::is_return_values_on_condition_check_failure_Valid() const{
    return m_return_values_on_condition_check_failure_isValid;
}

bool OAITransactWriteItem_ConditionCheck::isSet() const {
...
bool OAITransactWriteItem_ConditionCheck::isValid() const {
