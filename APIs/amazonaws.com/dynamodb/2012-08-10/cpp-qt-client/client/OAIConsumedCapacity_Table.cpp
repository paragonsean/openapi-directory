...
OAIConsumedCapacity_Table::OAIConsumedCapacity_Table(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConsumedCapacity_Table::OAIConsumedCapacity_Table() {
    this->initializeModel();
}

OAIConsumedCapacity_Table::~OAIConsumedCapacity_Table() {}

void OAIConsumedCapacity_Table::initializeModel() {
...
void OAIConsumedCapacity_Table::fromJson(QString jsonString) {
...
void OAIConsumedCapacity_Table::fromJsonObject(QJsonObject json) {
...
QString OAIConsumedCapacity_Table::asJson() const {
...
QJsonObject OAIConsumedCapacity_Table::asJsonObject() const {
    QJsonObject obj;
...
double OAIConsumedCapacity_Table::getReadCapacityUnits() const {
    return m_read_capacity_units;
}
void OAIConsumedCapacity_Table::setReadCapacityUnits(const double &read_capacity_units) {
    m_read_capacity_units = read_capacity_units;
    m_read_capacity_units_isSet = true;
}

bool OAIConsumedCapacity_Table::is_read_capacity_units_Set() const{
    return m_read_capacity_units_isSet;
}

bool OAIConsumedCapacity_Table::is_read_capacity_units_Valid() const{
    return m_read_capacity_units_isValid;
}

double OAIConsumedCapacity_Table::getWriteCapacityUnits() const {
    return m_write_capacity_units;
}
void OAIConsumedCapacity_Table::setWriteCapacityUnits(const double &write_capacity_units) {
    m_write_capacity_units = write_capacity_units;
    m_write_capacity_units_isSet = true;
}

bool OAIConsumedCapacity_Table::is_write_capacity_units_Set() const{
    return m_write_capacity_units_isSet;
}

bool OAIConsumedCapacity_Table::is_write_capacity_units_Valid() const{
    return m_write_capacity_units_isValid;
}

double OAIConsumedCapacity_Table::getCapacityUnits() const {
    return m_capacity_units;
}
void OAIConsumedCapacity_Table::setCapacityUnits(const double &capacity_units) {
    m_capacity_units = capacity_units;
    m_capacity_units_isSet = true;
}

bool OAIConsumedCapacity_Table::is_capacity_units_Set() const{
    return m_capacity_units_isSet;
}

bool OAIConsumedCapacity_Table::is_capacity_units_Valid() const{
    return m_capacity_units_isValid;
}

bool OAIConsumedCapacity_Table::isSet() const {
...
bool OAIConsumedCapacity_Table::isValid() const {
