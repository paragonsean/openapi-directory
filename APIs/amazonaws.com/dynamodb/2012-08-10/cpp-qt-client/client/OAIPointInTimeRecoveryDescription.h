...
/*
 * OAIPointInTimeRecoveryDescription.h
 *
 * The description of the point in time settings applied to the table.
 */

#ifndef OAIPointInTimeRecoveryDescription_H
#define OAIPointInTimeRecoveryDescription_H
...
class OAIPointInTimeRecoveryDescription : public OAIObject {
public:
    OAIPointInTimeRecoveryDescription();
    OAIPointInTimeRecoveryDescription(QString json);
    ~OAIPointInTimeRecoveryDescription() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPointInTimeRecoveryDescription)

#endif // OAIPointInTimeRecoveryDescription_H
