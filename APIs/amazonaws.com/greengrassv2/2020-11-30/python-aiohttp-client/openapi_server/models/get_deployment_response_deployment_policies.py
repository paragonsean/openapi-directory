...
class GetDeploymentResponseDeploymentPolicies(Model):
    ...
    def __init__(self, failure_handling_policy: DeploymentFailureHandlingPolicy=None, component_update_policy: CreateDeploymentRequestDeploymentPoliciesComponentUpdatePolicy=None, configuration_validation_policy: CreateDeploymentRequestDeploymentPoliciesConfigurationValidationPolicy=None):
        """GetDeploymentResponseDeploymentPolicies - a model defined in OpenAPI

        :param failure_handling_policy: The failure_handling_policy of this GetDeploymentResponseDeploymentPolicies.
        :param component_update_policy: The component_update_policy of this GetDeploymentResponseDeploymentPolicies.
        :param configuration_validation_policy: The configuration_validation_policy of this GetDeploymentResponseDeploymentPolicies.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetDeploymentResponseDeploymentPolicies':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetDeploymentResponse_deploymentPolicies of this GetDeploymentResponseDeploymentPolicies.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def failure_handling_policy(self):
        """Gets the failure_handling_policy of this GetDeploymentResponseDeploymentPolicies.


        :return: The failure_handling_policy of this GetDeploymentResponseDeploymentPolicies.
    ...
    def failure_handling_policy(self, failure_handling_policy):
        """Sets the failure_handling_policy of this GetDeploymentResponseDeploymentPolicies.
    ...
    def component_update_policy(self):
        """Gets the component_update_policy of this GetDeploymentResponseDeploymentPolicies.


        :return: The component_update_policy of this GetDeploymentResponseDeploymentPolicies.
    ...
    def component_update_policy(self, component_update_policy):
        """Sets the component_update_policy of this GetDeploymentResponseDeploymentPolicies.
    ...
    def configuration_validation_policy(self):
        """Gets the configuration_validation_policy of this GetDeploymentResponseDeploymentPolicies.


        :return: The configuration_validation_policy of this GetDeploymentResponseDeploymentPolicies.
    ...
    def configuration_validation_policy(self, configuration_validation_policy):
        """Sets the configuration_validation_policy of this GetDeploymentResponseDeploymentPolicies.
