...
async def test_associate_service_role_to_account(client):
    """Test case for associate_service_role_to_account
...
async def test_batch_associate_client_device_with_core_device(client):
    """Test case for batch_associate_client_device_with_core_device
    ...
    response = await client.request(
        method='POST',
        path='/greengrass/v2/coreDevices/{core_device_thing_name}/associateClientDevices'.format(core_device_thing_name='core_device_thing_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_disassociate_client_device_from_core_device(client):
    """Test case for batch_disassociate_client_device_from_core_device
    ...
    response = await client.request(
        method='POST',
        path='/greengrass/v2/coreDevices/{core_device_thing_name}/disassociateClientDevices'.format(core_device_thing_name='core_device_thing_name_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_cancel_deployment(client):
    ...
    response = await client.request(
        method='POST',
        path='/greengrass/v2/deployments/{deployment_id}/cancel'.format(deployment_id='deployment_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_component_version(client):
    """Test case for create_component_version

    
    """
    body = {"lambdaFunction":{"componentDependencies":"","componentPlatforms":"","lambdaArn":"","componentName":"","componentVersion":"","componentLambdaParameters":{"maxIdleTimeInSeconds":"","execArgs":"","eventSources":"","pinned":"","maxQueueSize":"","linuxProcessParams":{"isolationMode":"","containerParams":{"mountROSysfs":"","memorySizeInKB":"","devices":"","volumes":""}},"statusTimeoutInSeconds":"","environmentVariables":"","maxInstancesCount":"","inputPayloadEncodingType":"","timeoutInSeconds":""}},"clientToken":"","inlineRecipe":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_deployment(client):
    ...
    """
    body = {"components":"","iotJobConfiguration":{"timeoutConfig":{"inProgressTimeoutInMinutes":""},"jobExecutionsRolloutConfig":{"maximumPerMinute":"","exponentialRate":{"baseRatePerMinute":"","incrementFactor":"","rateIncreaseCriteria":{"numberOfNotifiedThings":"","numberOfSucceededThings":""}}},"abortConfig":{"criteriaList":""}},"clientToken":"","deploymentPolicies":{"configurationValidationPolicy":{"timeoutInSeconds":""},"componentUpdatePolicy":{"action":"","timeoutInSeconds":""},"failureHandlingPolicy":""},"deploymentName":"","parentTargetArn":"","targetArn":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_component(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/greengrass/v2/components/{arn}'.format(arn='arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_core_device(client):
    """Test case for delete_core_device
    ...
    response = await client.request(
        method='DELETE',
        path='/greengrass/v2/coreDevices/{core_device_thing_name}'.format(core_device_thing_name='core_device_thing_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_deployment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/greengrass/v2/deployments/{deployment_id}'.format(deployment_id='deployment_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_describe_component(client):
    """Test case for describe_component
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/v2/components/{arn}/metadata'.format(arn='arn_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disassociate_service_role_from_account(client):
    """Test case for disassociate_service_role_from_account
...
async def test_get_component(client):
    ...
    """
    params = [('recipeOutputFormat', 'recipe_output_format_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
...
async def test_get_component_version_artifact(client):
    """Test case for get_component_version_artifact
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/v2/components/{arn}/artifacts/{artifact_name}'.format(arn='arn_example', artifact_name='artifact_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_connectivity_info(client):
    """Test case for get_connectivity_info
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/things/{thing_name}/connectivityInfo'.format(thing_name='thing_name_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_core_device(client):
    """Test case for get_core_device
...
async def test_get_service_role_for_account(client):
    """Test case for get_service_role_for_account
...
async def test_list_client_devices_associated_with_core_device(client):
    """Test case for list_client_devices_associated_with_core_device
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/v2/coreDevices/{core_device_thing_name}/associatedClientDevices'.format(core_device_thing_name='core_device_thing_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_component_versions(client):
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/v2/components/{arn}/versions'.format(arn='arn_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_core_devices(client):
    """Test case for list_core_devices

    
    """
    params = [('thingGroupArn', 'thing_group_arn_example'),
...
async def test_list_deployments(client):
    ...
    """
    params = [('targetArn', 'target_arn_example'),
                    ('historyFilter', 'history_filter_example'),
                    ('parentTargetArn', 'parent_target_arn_example'),
                    ('maxResults', 56),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_effective_deployments(client):
    """Test case for list_effective_deployments
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/v2/coreDevices/{core_device_thing_name}/effectiveDeployments'.format(core_device_thing_name='core_device_thing_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_installed_components(client):
    """Test case for list_installed_components

    
    """
    params = [('maxResults', 56),
                    ('nextToken', 'next_token_example'),
                    ('topologyFilter', 'topology_filter_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/greengrass/v2/coreDevices/{core_device_thing_name}/installedComponents'.format(core_device_thing_name='core_device_thing_name_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_resolve_component_candidates(client):
    """Test case for resolve_component_candidates

    
    """
    body = {"platform":{"name":"","attributes":""},"componentCandidates":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_connectivity_info(client):
    """Test case for update_connectivity_info

    
    """
    body = {"connectivityInfo":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
