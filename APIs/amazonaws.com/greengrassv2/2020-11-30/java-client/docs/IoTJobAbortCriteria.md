...
|------------ | ------------- | ------------- | -------------|
|**failureType** | [**IoTJobExecutionFailureType**](IoTJobExecutionFailureType.md) |  |  |
|**action** | [**IoTJobAbortAction**](IoTJobAbortAction.md) |  |  |
|**thresholdPercentage** | [**Double**](Double.md) |  |  |
|**minNumberOfExecutedThings** | [**Integer**](Integer.md) |  |  |
