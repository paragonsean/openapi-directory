...
public class CreateComponentVersionRequestLambdaFunction {
  ...
  public CreateComponentVersionRequestLambdaFunction() {
  }

  public CreateComponentVersionRequestLambdaFunction lambdaArn(String lambdaArn) {
  ...
  public CreateComponentVersionRequestLambdaFunction componentName(String componentName) {
  ...
  public CreateComponentVersionRequestLambdaFunction componentVersion(String componentVersion) {
  ...
  public CreateComponentVersionRequestLambdaFunction componentPlatforms(List componentPlatforms) {
  ...
  public CreateComponentVersionRequestLambdaFunction componentDependencies(Map componentDependencies) {
  ...
  public CreateComponentVersionRequestLambdaFunction componentLambdaParameters(CreateComponentVersionRequestLambdaFunctionComponentLambdaParameters componentLambdaParameters) {
  ...
  public boolean equals(Object o) {
    ...
    CreateComponentVersionRequestLambdaFunction createComponentVersionRequestLambdaFunction = (CreateComponentVersionRequestLambdaFunction) o;
    return Objects.equals(this.lambdaArn, createComponentVersionRequestLambdaFunction.lambdaArn) &&
        Objects.equals(this.componentName, createComponentVersionRequestLambdaFunction.componentName) &&
        Objects.equals(this.componentVersion, createComponentVersionRequestLambdaFunction.componentVersion) &&
        Objects.equals(this.componentPlatforms, createComponentVersionRequestLambdaFunction.componentPlatforms) &&
        Objects.equals(this.componentDependencies, createComponentVersionRequestLambdaFunction.componentDependencies) &&
        Objects.equals(this.componentLambdaParameters, createComponentVersionRequestLambdaFunction.componentLambdaParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateComponentVersionRequestLambdaFunction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateComponentVersionRequestLambdaFunction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateComponentVersionRequestLambdaFunction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateComponentVersionRequestLambdaFunction is not found in the empty JSON string", CreateComponentVersionRequestLambdaFunction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateComponentVersionRequestLambdaFunction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateComponentVersionRequestLambdaFunction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateComponentVersionRequestLambdaFunction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateComponentVersionRequestLambdaFunction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateComponentVersionRequestLambdaFunction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateComponentVersionRequestLambdaFunction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateComponentVersionRequestLambdaFunction.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateComponentVersionRequestLambdaFunction>() {
           @Override
           public void write(JsonWriter out, CreateComponentVersionRequestLambdaFunction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateComponentVersionRequestLambdaFunction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateComponentVersionRequestLambdaFunction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateComponentVersionRequestLambdaFunction
   * @throws IOException if the JSON string is invalid with respect to CreateComponentVersionRequestLambdaFunction
   */
  public static CreateComponentVersionRequestLambdaFunction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateComponentVersionRequestLambdaFunction.class);
  }

  /**
   * Convert an instance of CreateComponentVersionRequestLambdaFunction to an JSON string
   *
   * @return JSON string
   */
