...
public class LambdaExecutionParameters {
  ...
  public LambdaExecutionParameters eventSources(List eventSources) {
  ...
  public LambdaExecutionParameters maxQueueSize(Integer maxQueueSize) {
  ...
  public LambdaExecutionParameters maxInstancesCount(Integer maxInstancesCount) {
  ...
  public LambdaExecutionParameters maxIdleTimeInSeconds(Integer maxIdleTimeInSeconds) {
  ...
  public LambdaExecutionParameters timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public LambdaExecutionParameters statusTimeoutInSeconds(Integer statusTimeoutInSeconds) {
  ...
  public LambdaExecutionParameters pinned(Boolean pinned) {
    this.pinned = pinned;
    return this;
  }
  ...
  public LambdaExecutionParameters inputPayloadEncodingType(LambdaInputPayloadEncodingType inputPayloadEncodingType) {
  ...
  public LambdaExecutionParameters execArgs(List execArgs) {
  ...
  public LambdaExecutionParameters environmentVariables(Map environmentVariables) {
  ...
  public LambdaExecutionParameters linuxProcessParams(LambdaExecutionParametersLinuxProcessParams linuxProcessParams) {
  ...
  public boolean equals(Object o) {
    ...
    LambdaExecutionParameters lambdaExecutionParameters = (LambdaExecutionParameters) o;
    return Objects.equals(this.eventSources, lambdaExecutionParameters.eventSources) &&
        Objects.equals(this.maxQueueSize, lambdaExecutionParameters.maxQueueSize) &&
        Objects.equals(this.maxInstancesCount, lambdaExecutionParameters.maxInstancesCount) &&
        Objects.equals(this.maxIdleTimeInSeconds, lambdaExecutionParameters.maxIdleTimeInSeconds) &&
        Objects.equals(this.timeoutInSeconds, lambdaExecutionParameters.timeoutInSeconds) &&
        Objects.equals(this.statusTimeoutInSeconds, lambdaExecutionParameters.statusTimeoutInSeconds) &&
        Objects.equals(this.pinned, lambdaExecutionParameters.pinned) &&
        Objects.equals(this.inputPayloadEncodingType, lambdaExecutionParameters.inputPayloadEncodingType) &&
        Objects.equals(this.execArgs, lambdaExecutionParameters.execArgs) &&
        Objects.equals(this.environmentVariables, lambdaExecutionParameters.environmentVariables) &&
        Objects.equals(this.linuxProcessParams, lambdaExecutionParameters.linuxProcessParams);
  }
  ...
  public String toString() {
    ...
    sb.append("class LambdaExecutionParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LambdaExecutionParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LambdaExecutionParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LambdaExecutionParameters is not found in the empty JSON string", LambdaExecutionParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LambdaExecutionParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LambdaExecutionParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LambdaExecutionParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LambdaExecutionParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LambdaExecutionParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LambdaExecutionParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<LambdaExecutionParameters>() {
           @Override
           public void write(JsonWriter out, LambdaExecutionParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LambdaExecutionParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LambdaExecutionParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LambdaExecutionParameters
   * @throws IOException if the JSON string is invalid with respect to LambdaExecutionParameters
   */
  public static LambdaExecutionParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LambdaExecutionParameters.class);
  }

  /**
   * Convert an instance of LambdaExecutionParameters to an JSON string
   *
   * @return JSON string
   */
