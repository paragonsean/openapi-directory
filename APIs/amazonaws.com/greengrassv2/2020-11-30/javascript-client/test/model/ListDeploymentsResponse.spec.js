...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTGreengrassV2.ListDeploymentsResponse();
  });
  ...
  describe('ListDeploymentsResponse', function() {
    it('should create an instance of ListDeploymentsResponse', function() {
      // uncomment below and update the code to test ListDeploymentsResponse
      //var instance = new AwsIoTGreengrassV2.ListDeploymentsResponse();
      //expect(instance).to.be.a(AwsIoTGreengrassV2.ListDeploymentsResponse);
    });
