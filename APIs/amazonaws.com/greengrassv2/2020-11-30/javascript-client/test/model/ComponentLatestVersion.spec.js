...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTGreengrassV2.ComponentLatestVersion();
  });
  ...
  describe('ComponentLatestVersion', function() {
    it('should create an instance of ComponentLatestVersion', function() {
      // uncomment below and update the code to test ComponentLatestVersion
      //var instance = new AwsIoTGreengrassV2.ComponentLatestVersion();
      //expect(instance).to.be.a(AwsIoTGreengrassV2.ComponentLatestVersion);
    });
