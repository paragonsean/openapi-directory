...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTGreengrassV2.DescribeComponentResponse();
  });
  ...
  describe('DescribeComponentResponse', function() {
    it('should create an instance of DescribeComponentResponse', function() {
      // uncomment below and update the code to test DescribeComponentResponse
      //var instance = new AwsIoTGreengrassV2.DescribeComponentResponse();
      //expect(instance).to.be.a(AwsIoTGreengrassV2.DescribeComponentResponse);
    });
