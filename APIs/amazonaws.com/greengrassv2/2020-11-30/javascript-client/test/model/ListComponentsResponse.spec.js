...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsIoTGreengrassV2.ListComponentsResponse();
  });
  ...
  describe('ListComponentsResponse', function() {
    it('should create an instance of ListComponentsResponse', function() {
      ...
      //var instance = new AwsIoTGreengrassV2.ListComponentsResponse();
      //expect(instance).to.be.a(AwsIoTGreengrassV2.ListComponentsResponse);
    });
