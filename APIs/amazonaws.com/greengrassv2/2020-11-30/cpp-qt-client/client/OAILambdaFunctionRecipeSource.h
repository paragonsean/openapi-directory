...
/*
 * OAILambdaFunctionRecipeSource.h
 *
 * Contains information about an Lambda function to import to create a component.
 */

#ifndef OAILambdaFunctionRecipeSource_H
#define OAILambdaFunctionRecipeSource_H
...
class OAILambdaFunctionRecipeSource : public OAIObject {
public:
    OAILambdaFunctionRecipeSource();
    OAILambdaFunctionRecipeSource(QString json);
    ~OAILambdaFunctionRecipeSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaFunctionRecipeSource)

#endif // OAILambdaFunctionRecipeSource_H
