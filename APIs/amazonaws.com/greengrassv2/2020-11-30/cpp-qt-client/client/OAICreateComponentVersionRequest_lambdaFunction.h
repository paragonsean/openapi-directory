...
/*
 * OAICreateComponentVersionRequest_lambdaFunction.h
 *
 * 
 */

#ifndef OAICreateComponentVersionRequest_lambdaFunction_H
#define OAICreateComponentVersionRequest_lambdaFunction_H
...
class OAICreateComponentVersionRequest_lambdaFunction : public OAIObject {
public:
    OAICreateComponentVersionRequest_lambdaFunction();
    OAICreateComponentVersionRequest_lambdaFunction(QString json);
    ~OAICreateComponentVersionRequest_lambdaFunction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateComponentVersionRequest_lambdaFunction)

#endif // OAICreateComponentVersionRequest_lambdaFunction_H
