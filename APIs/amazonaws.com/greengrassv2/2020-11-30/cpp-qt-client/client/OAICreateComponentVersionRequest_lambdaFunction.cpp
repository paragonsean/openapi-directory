...
OAICreateComponentVersionRequest_lambdaFunction::OAICreateComponentVersionRequest_lambdaFunction(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateComponentVersionRequest_lambdaFunction::OAICreateComponentVersionRequest_lambdaFunction() {
    this->initializeModel();
}

OAICreateComponentVersionRequest_lambdaFunction::~OAICreateComponentVersionRequest_lambdaFunction() {}

void OAICreateComponentVersionRequest_lambdaFunction::initializeModel() {
...
void OAICreateComponentVersionRequest_lambdaFunction::fromJson(QString jsonString) {
...
void OAICreateComponentVersionRequest_lambdaFunction::fromJsonObject(QJsonObject json) {
...
QString OAICreateComponentVersionRequest_lambdaFunction::asJson() const {
...
QJsonObject OAICreateComponentVersionRequest_lambdaFunction::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateComponentVersionRequest_lambdaFunction::getLambdaArn() const {
    return m_lambda_arn;
}
void OAICreateComponentVersionRequest_lambdaFunction::setLambdaArn(const QString &lambda_arn) {
    m_lambda_arn = lambda_arn;
    m_lambda_arn_isSet = true;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_lambda_arn_Set() const{
    return m_lambda_arn_isSet;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_lambda_arn_Valid() const{
    return m_lambda_arn_isValid;
}

QString OAICreateComponentVersionRequest_lambdaFunction::getComponentName() const {
    return m_component_name;
}
void OAICreateComponentVersionRequest_lambdaFunction::setComponentName(const QString &component_name) {
    m_component_name = component_name;
    m_component_name_isSet = true;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_name_Set() const{
    return m_component_name_isSet;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_name_Valid() const{
    return m_component_name_isValid;
}

QString OAICreateComponentVersionRequest_lambdaFunction::getComponentVersion() const {
    return m_component_version;
}
void OAICreateComponentVersionRequest_lambdaFunction::setComponentVersion(const QString &component_version) {
    m_component_version = component_version;
    m_component_version_isSet = true;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_version_Set() const{
    return m_component_version_isSet;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_version_Valid() const{
    return m_component_version_isValid;
}

QList OAICreateComponentVersionRequest_lambdaFunction::getComponentPlatforms() const {
    return m_component_platforms;
}
void OAICreateComponentVersionRequest_lambdaFunction::setComponentPlatforms(const QList &component_platforms) {
    m_component_platforms = component_platforms;
    m_component_platforms_isSet = true;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_platforms_Set() const{
    return m_component_platforms_isSet;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_platforms_Valid() const{
    return m_component_platforms_isValid;
}

QMap OAICreateComponentVersionRequest_lambdaFunction::getComponentDependencies() const {
    return m_component_dependencies;
}
void OAICreateComponentVersionRequest_lambdaFunction::setComponentDependencies(const QMap &component_dependencies) {
    m_component_dependencies = component_dependencies;
    m_component_dependencies_isSet = true;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_dependencies_Set() const{
    return m_component_dependencies_isSet;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_dependencies_Valid() const{
    return m_component_dependencies_isValid;
}

OAICreateComponentVersion_request_lambdaFunction_componentLambdaParameters OAICreateComponentVersionRequest_lambdaFunction::getComponentLambdaParameters() const {
    return m_component_lambda_parameters;
}
void OAICreateComponentVersionRequest_lambdaFunction::setComponentLambdaParameters(const OAICreateComponentVersion_request_lambdaFunction_componentLambdaParameters &component_lambda_parameters) {
    m_component_lambda_parameters = component_lambda_parameters;
    m_component_lambda_parameters_isSet = true;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_lambda_parameters_Set() const{
    return m_component_lambda_parameters_isSet;
}

bool OAICreateComponentVersionRequest_lambdaFunction::is_component_lambda_parameters_Valid() const{
    return m_component_lambda_parameters_isValid;
}

bool OAICreateComponentVersionRequest_lambdaFunction::isSet() const {
...
bool OAICreateComponentVersionRequest_lambdaFunction::isValid() const {
