...
/*
 * OAIComponentDeploymentSpecification_runWith.h
 *
 * 
 */

#ifndef OAIComponentDeploymentSpecification_runWith_H
#define OAIComponentDeploymentSpecification_runWith_H
...
class OAIComponentDeploymentSpecification_runWith : public OAIObject {
public:
    OAIComponentDeploymentSpecification_runWith();
    OAIComponentDeploymentSpecification_runWith(QString json);
    ~OAIComponentDeploymentSpecification_runWith() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponentDeploymentSpecification_runWith)

#endif // OAIComponentDeploymentSpecification_runWith_H
