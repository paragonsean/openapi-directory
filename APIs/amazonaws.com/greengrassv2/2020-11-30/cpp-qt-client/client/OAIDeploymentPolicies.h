...
/*
 * OAIDeploymentPolicies.h
 *
 * Contains information about policies that define how a deployment updates components and handles failure.
 */

#ifndef OAIDeploymentPolicies_H
#define OAIDeploymentPolicies_H
...
class OAIDeploymentPolicies : public OAIObject {
public:
    OAIDeploymentPolicies();
    OAIDeploymentPolicies(QString json);
    ~OAIDeploymentPolicies() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentPolicies)

#endif // OAIDeploymentPolicies_H
