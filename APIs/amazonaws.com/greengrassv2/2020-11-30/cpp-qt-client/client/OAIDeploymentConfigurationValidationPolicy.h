...
/*
 * OAIDeploymentConfigurationValidationPolicy.h
 *
...
#ifndef OAIDeploymentConfigurationValidationPolicy_H
#define OAIDeploymentConfigurationValidationPolicy_H
...
class OAIDeploymentConfigurationValidationPolicy : public OAIObject {
public:
    OAIDeploymentConfigurationValidationPolicy();
    OAIDeploymentConfigurationValidationPolicy(QString json);
    ~OAIDeploymentConfigurationValidationPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentConfigurationValidationPolicy)

#endif // OAIDeploymentConfigurationValidationPolicy_H
