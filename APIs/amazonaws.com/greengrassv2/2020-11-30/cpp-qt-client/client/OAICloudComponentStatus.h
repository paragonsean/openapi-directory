...
/*
 * OAICloudComponentStatus.h
 *
 * Contains the status of a component version in the IoT Greengrass service.
 */

#ifndef OAICloudComponentStatus_H
#define OAICloudComponentStatus_H
...
class OAICloudComponentStatus : public OAIObject {
public:
    OAICloudComponentStatus();
    OAICloudComponentStatus(QString json);
    ~OAICloudComponentStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICloudComponentStatus)

#endif // OAICloudComponentStatus_H
