...
/*
 * OAIResolvedComponentVersion.h
 *
 * Contains information about a component version that is compatible to run on a Greengrass core device.
 */

#ifndef OAIResolvedComponentVersion_H
#define OAIResolvedComponentVersion_H
...
class OAIResolvedComponentVersion : public OAIObject {
public:
    OAIResolvedComponentVersion();
    OAIResolvedComponentVersion(QString json);
    ~OAIResolvedComponentVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResolvedComponentVersion)

#endif // OAIResolvedComponentVersion_H
