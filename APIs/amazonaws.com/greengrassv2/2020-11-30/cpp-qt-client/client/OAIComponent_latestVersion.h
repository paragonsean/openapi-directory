...
/*
 * OAIComponent_latestVersion.h
 *
 * 
 */

#ifndef OAIComponent_latestVersion_H
#define OAIComponent_latestVersion_H
...
class OAIComponent_latestVersion : public OAIObject {
public:
    OAIComponent_latestVersion();
    OAIComponent_latestVersion(QString json);
    ~OAIComponent_latestVersion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComponent_latestVersion)

#endif // OAIComponent_latestVersion_H
