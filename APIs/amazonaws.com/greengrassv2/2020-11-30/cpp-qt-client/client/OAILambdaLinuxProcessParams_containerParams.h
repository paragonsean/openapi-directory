...
/*
 * OAILambdaLinuxProcessParams_containerParams.h
 *
 * 
 */

#ifndef OAILambdaLinuxProcessParams_containerParams_H
#define OAILambdaLinuxProcessParams_containerParams_H
...
class OAILambdaLinuxProcessParams_containerParams : public OAIObject {
public:
    OAILambdaLinuxProcessParams_containerParams();
    OAILambdaLinuxProcessParams_containerParams(QString json);
    ~OAILambdaLinuxProcessParams_containerParams() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaLinuxProcessParams_containerParams)

#endif // OAILambdaLinuxProcessParams_containerParams_H
