...
/*
 * OAIDeploymentComponentUpdatePolicy.h
 *
...
#ifndef OAIDeploymentComponentUpdatePolicy_H
#define OAIDeploymentComponentUpdatePolicy_H
...
class OAIDeploymentComponentUpdatePolicy : public OAIObject {
public:
    OAIDeploymentComponentUpdatePolicy();
    OAIDeploymentComponentUpdatePolicy(QString json);
    ~OAIDeploymentComponentUpdatePolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeploymentComponentUpdatePolicy)

#endif // OAIDeploymentComponentUpdatePolicy_H
