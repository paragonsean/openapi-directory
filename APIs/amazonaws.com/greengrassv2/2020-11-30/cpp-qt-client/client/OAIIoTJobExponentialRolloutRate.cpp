...
#include "OAIIoTJobExponentialRolloutRate.h"
...
OAIIoTJobExponentialRolloutRate::OAIIoTJobExponentialRolloutRate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIoTJobExponentialRolloutRate::OAIIoTJobExponentialRolloutRate() {
    this->initializeModel();
}

OAIIoTJobExponentialRolloutRate::~OAIIoTJobExponentialRolloutRate() {}

void OAIIoTJobExponentialRolloutRate::initializeModel() {
...
void OAIIoTJobExponentialRolloutRate::fromJson(QString jsonString) {
...
void OAIIoTJobExponentialRolloutRate::fromJsonObject(QJsonObject json) {
...
QString OAIIoTJobExponentialRolloutRate::asJson() const {
...
QJsonObject OAIIoTJobExponentialRolloutRate::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIIoTJobExponentialRolloutRate::getBaseRatePerMinute() const {
    return m_base_rate_per_minute;
}
void OAIIoTJobExponentialRolloutRate::setBaseRatePerMinute(const qint32 &base_rate_per_minute) {
    m_base_rate_per_minute = base_rate_per_minute;
    m_base_rate_per_minute_isSet = true;
}

bool OAIIoTJobExponentialRolloutRate::is_base_rate_per_minute_Set() const{
    return m_base_rate_per_minute_isSet;
}

bool OAIIoTJobExponentialRolloutRate::is_base_rate_per_minute_Valid() const{
    return m_base_rate_per_minute_isValid;
}

double OAIIoTJobExponentialRolloutRate::getIncrementFactor() const {
    return m_increment_factor;
}
void OAIIoTJobExponentialRolloutRate::setIncrementFactor(const double &increment_factor) {
    m_increment_factor = increment_factor;
    m_increment_factor_isSet = true;
}

bool OAIIoTJobExponentialRolloutRate::is_increment_factor_Set() const{
    return m_increment_factor_isSet;
}

bool OAIIoTJobExponentialRolloutRate::is_increment_factor_Valid() const{
    return m_increment_factor_isValid;
}

OAIIoTJobExponentialRolloutRate_rateIncreaseCriteria OAIIoTJobExponentialRolloutRate::getRateIncreaseCriteria() const {
    return m_rate_increase_criteria;
}
void OAIIoTJobExponentialRolloutRate::setRateIncreaseCriteria(const OAIIoTJobExponentialRolloutRate_rateIncreaseCriteria &rate_increase_criteria) {
    m_rate_increase_criteria = rate_increase_criteria;
    m_rate_increase_criteria_isSet = true;
}

bool OAIIoTJobExponentialRolloutRate::is_rate_increase_criteria_Set() const{
    return m_rate_increase_criteria_isSet;
}

bool OAIIoTJobExponentialRolloutRate::is_rate_increase_criteria_Valid() const{
    return m_rate_increase_criteria_isValid;
}

bool OAIIoTJobExponentialRolloutRate::isSet() const {
...
bool OAIIoTJobExponentialRolloutRate::isValid() const {
