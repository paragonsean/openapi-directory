...
/*
 * OAIDescribeComponentResponse.h
 *
 * 
 */

#ifndef OAIDescribeComponentResponse_H
#define OAIDescribeComponentResponse_H
...
class OAIDescribeComponentResponse : public OAIObject {
public:
    OAIDescribeComponentResponse();
    OAIDescribeComponentResponse(QString json);
    ~OAIDescribeComponentResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeComponentResponse)

#endif // OAIDescribeComponentResponse_H
