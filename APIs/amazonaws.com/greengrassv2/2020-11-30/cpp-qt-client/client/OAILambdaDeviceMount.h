...
/*
 * OAILambdaDeviceMount.h
 *
 * Contains information about a device that Linux processes in a container can access.
 */

#ifndef OAILambdaDeviceMount_H
#define OAILambdaDeviceMount_H
...
class OAILambdaDeviceMount : public OAIObject {
public:
    OAILambdaDeviceMount();
    OAILambdaDeviceMount(QString json);
    ~OAILambdaDeviceMount() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaDeviceMount)

#endif // OAILambdaDeviceMount_H
