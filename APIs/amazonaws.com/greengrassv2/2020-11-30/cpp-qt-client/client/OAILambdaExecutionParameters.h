...
/*
 * OAILambdaExecutionParameters.h
 *
 * Contains parameters for a Lambda function that runs on IoT Greengrass.
 */

#ifndef OAILambdaExecutionParameters_H
#define OAILambdaExecutionParameters_H
...
class OAILambdaExecutionParameters : public OAIObject {
public:
    OAILambdaExecutionParameters();
    OAILambdaExecutionParameters(QString json);
    ~OAILambdaExecutionParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILambdaExecutionParameters)

#endif // OAILambdaExecutionParameters_H
