...
public class CreateControlMappingSource {
  ...
  public CreateControlMappingSource sourceName(String sourceName) {
  ...
  public CreateControlMappingSource sourceDescription(String sourceDescription) {
  ...
  public CreateControlMappingSource sourceSetUpOption(SourceSetUpOption sourceSetUpOption) {
  ...
  public CreateControlMappingSource sourceType(SourceType sourceType) {
  ...
  public CreateControlMappingSource sourceKeyword(SourceKeyword sourceKeyword) {
  ...
  public CreateControlMappingSource sourceFrequency(SourceFrequency sourceFrequency) {
  ...
  public CreateControlMappingSource troubleshootingText(String troubleshootingText) {
  ...
  public boolean equals(Object o) {
    ...
    CreateControlMappingSource createControlMappingSource = (CreateControlMappingSource) o;
    return Objects.equals(this.sourceName, createControlMappingSource.sourceName) &&
        Objects.equals(this.sourceDescription, createControlMappingSource.sourceDescription) &&
        Objects.equals(this.sourceSetUpOption, createControlMappingSource.sourceSetUpOption) &&
        Objects.equals(this.sourceType, createControlMappingSource.sourceType) &&
        Objects.equals(this.sourceKeyword, createControlMappingSource.sourceKeyword) &&
        Objects.equals(this.sourceFrequency, createControlMappingSource.sourceFrequency) &&
        Objects.equals(this.troubleshootingText, createControlMappingSource.troubleshootingText);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceName, sourceDescription, sourceSetUpOption, sourceType, sourceKeyword, sourceFrequency, troubleshootingText);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateControlMappingSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateControlMappingSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateControlMappingSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateControlMappingSource is not found in the empty JSON string", CreateControlMappingSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateControlMappingSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateControlMappingSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateControlMappingSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateControlMappingSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateControlMappingSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateControlMappingSource.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateControlMappingSource>() {
           @Override
           public void write(JsonWriter out, CreateControlMappingSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateControlMappingSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateControlMappingSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateControlMappingSource
   * @throws IOException if the JSON string is invalid with respect to CreateControlMappingSource
   */
  public static CreateControlMappingSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateControlMappingSource.class);
  }

  /**
   * Convert an instance of CreateControlMappingSource to an JSON string
   *
   * @return JSON string
   */
