...
public class UpdateSettingsResponseSettings {
  ...
  public UpdateSettingsResponseSettings() {
  }

  public UpdateSettingsResponseSettings isAwsOrgEnabled(Boolean isAwsOrgEnabled) {
  ...
  public UpdateSettingsResponseSettings snsTopic(String snsTopic) {
  ...
  public UpdateSettingsResponseSettings defaultAssessmentReportsDestination(SettingsDefaultAssessmentReportsDestination defaultAssessmentReportsDestination) {
  ...
  public UpdateSettingsResponseSettings defaultProcessOwners(List defaultProcessOwners) {
  ...
  public UpdateSettingsResponseSettings kmsKey(String kmsKey) {
    this.kmsKey = kmsKey;
    return this;
  }
  ...
  public UpdateSettingsResponseSettings evidenceFinderEnablement(SettingsEvidenceFinderEnablement evidenceFinderEnablement) {
  ...
  public UpdateSettingsResponseSettings deregistrationPolicy(SettingsDeregistrationPolicy deregistrationPolicy) {
  ...
  public UpdateSettingsResponseSettings defaultExportDestination(SettingsDefaultExportDestination defaultExportDestination) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSettingsResponseSettings updateSettingsResponseSettings = (UpdateSettingsResponseSettings) o;
    return Objects.equals(this.isAwsOrgEnabled, updateSettingsResponseSettings.isAwsOrgEnabled) &&
        Objects.equals(this.snsTopic, updateSettingsResponseSettings.snsTopic) &&
        Objects.equals(this.defaultAssessmentReportsDestination, updateSettingsResponseSettings.defaultAssessmentReportsDestination) &&
        Objects.equals(this.defaultProcessOwners, updateSettingsResponseSettings.defaultProcessOwners) &&
        Objects.equals(this.kmsKey, updateSettingsResponseSettings.kmsKey) &&
        Objects.equals(this.evidenceFinderEnablement, updateSettingsResponseSettings.evidenceFinderEnablement) &&
        Objects.equals(this.deregistrationPolicy, updateSettingsResponseSettings.deregistrationPolicy) &&
        Objects.equals(this.defaultExportDestination, updateSettingsResponseSettings.defaultExportDestination);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSettingsResponseSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSettingsResponseSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSettingsResponseSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSettingsResponseSettings is not found in the empty JSON string", UpdateSettingsResponseSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSettingsResponseSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSettingsResponseSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSettingsResponseSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSettingsResponseSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSettingsResponseSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSettingsResponseSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSettingsResponseSettings>() {
           @Override
           public void write(JsonWriter out, UpdateSettingsResponseSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSettingsResponseSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSettingsResponseSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSettingsResponseSettings
   * @throws IOException if the JSON string is invalid with respect to UpdateSettingsResponseSettings
   */
  public static UpdateSettingsResponseSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSettingsResponseSettings.class);
  }

  /**
   * Convert an instance of UpdateSettingsResponseSettings to an JSON string
   *
   * @return JSON string
   */
