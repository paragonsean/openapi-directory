...
public class GetEvidenceResponseEvidence {
  ...
  public GetEvidenceResponseEvidence() {
  }

  public GetEvidenceResponseEvidence dataSource(String dataSource) {
  ...
  public GetEvidenceResponseEvidence evidenceAwsAccountId(String evidenceAwsAccountId) {
  ...
  public GetEvidenceResponseEvidence time(OffsetDateTime time) {
    this.time = time;
    return this;
  }
  ...
  public GetEvidenceResponseEvidence eventSource(String eventSource) {
  ...
  public GetEvidenceResponseEvidence eventName(String eventName) {
  ...
  public GetEvidenceResponseEvidence evidenceByType(String evidenceByType) {
  ...
  public GetEvidenceResponseEvidence resourcesIncluded(List resourcesIncluded) {
  ...
  public GetEvidenceResponseEvidence attributes(Map attributes) {
  ...
  public GetEvidenceResponseEvidence iamId(String iamId) {
    this.iamId = iamId;
    return this;
  }
  ...
  public GetEvidenceResponseEvidence complianceCheck(String complianceCheck) {
  ...
  public GetEvidenceResponseEvidence awsOrganization(String awsOrganization) {
  ...
  public GetEvidenceResponseEvidence awsAccountId(String awsAccountId) {
  ...
  public GetEvidenceResponseEvidence evidenceFolderId(String evidenceFolderId) {
  ...
  public GetEvidenceResponseEvidence id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetEvidenceResponseEvidence assessmentReportSelection(String assessmentReportSelection) {
  ...
  public boolean equals(Object o) {
    ...
    GetEvidenceResponseEvidence getEvidenceResponseEvidence = (GetEvidenceResponseEvidence) o;
    return Objects.equals(this.dataSource, getEvidenceResponseEvidence.dataSource) &&
        Objects.equals(this.evidenceAwsAccountId, getEvidenceResponseEvidence.evidenceAwsAccountId) &&
        Objects.equals(this.time, getEvidenceResponseEvidence.time) &&
        Objects.equals(this.eventSource, getEvidenceResponseEvidence.eventSource) &&
        Objects.equals(this.eventName, getEvidenceResponseEvidence.eventName) &&
        Objects.equals(this.evidenceByType, getEvidenceResponseEvidence.evidenceByType) &&
        Objects.equals(this.resourcesIncluded, getEvidenceResponseEvidence.resourcesIncluded) &&
        Objects.equals(this.attributes, getEvidenceResponseEvidence.attributes) &&
        Objects.equals(this.iamId, getEvidenceResponseEvidence.iamId) &&
        Objects.equals(this.complianceCheck, getEvidenceResponseEvidence.complianceCheck) &&
        Objects.equals(this.awsOrganization, getEvidenceResponseEvidence.awsOrganization) &&
        Objects.equals(this.awsAccountId, getEvidenceResponseEvidence.awsAccountId) &&
        Objects.equals(this.evidenceFolderId, getEvidenceResponseEvidence.evidenceFolderId) &&
        Objects.equals(this.id, getEvidenceResponseEvidence.id) &&
        Objects.equals(this.assessmentReportSelection, getEvidenceResponseEvidence.assessmentReportSelection);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEvidenceResponseEvidence {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEvidenceResponseEvidence
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEvidenceResponseEvidence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEvidenceResponseEvidence is not found in the empty JSON string", GetEvidenceResponseEvidence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEvidenceResponseEvidence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEvidenceResponseEvidence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEvidenceResponseEvidence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEvidenceResponseEvidence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEvidenceResponseEvidence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEvidenceResponseEvidence.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEvidenceResponseEvidence>() {
           @Override
           public void write(JsonWriter out, GetEvidenceResponseEvidence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEvidenceResponseEvidence read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEvidenceResponseEvidence given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEvidenceResponseEvidence
   * @throws IOException if the JSON string is invalid with respect to GetEvidenceResponseEvidence
   */
  public static GetEvidenceResponseEvidence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEvidenceResponseEvidence.class);
  }

  /**
   * Convert an instance of GetEvidenceResponseEvidence to an JSON string
   *
   * @return JSON string
   */
