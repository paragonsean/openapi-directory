...
public class AssessmentEvidenceFolder {
  ...
  public AssessmentEvidenceFolder name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssessmentEvidenceFolder date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public AssessmentEvidenceFolder assessmentId(String assessmentId) {
  ...
  public AssessmentEvidenceFolder controlSetId(String controlSetId) {
  ...
  public AssessmentEvidenceFolder controlId(String controlId) {
  ...
  public AssessmentEvidenceFolder id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AssessmentEvidenceFolder dataSource(String dataSource) {
  ...
  public AssessmentEvidenceFolder author(String author) {
    this.author = author;
    return this;
  }
  ...
  public AssessmentEvidenceFolder totalEvidence(Integer totalEvidence) {
  ...
  public AssessmentEvidenceFolder assessmentReportSelectionCount(Integer assessmentReportSelectionCount) {
  ...
  public AssessmentEvidenceFolder controlName(String controlName) {
  ...
  public AssessmentEvidenceFolder evidenceResourcesIncludedCount(Integer evidenceResourcesIncludedCount) {
  ...
  public AssessmentEvidenceFolder evidenceByTypeConfigurationDataCount(Integer evidenceByTypeConfigurationDataCount) {
  ...
  public AssessmentEvidenceFolder evidenceByTypeManualCount(Integer evidenceByTypeManualCount) {
  ...
  public AssessmentEvidenceFolder evidenceByTypeComplianceCheckCount(Integer evidenceByTypeComplianceCheckCount) {
  ...
  public AssessmentEvidenceFolder evidenceByTypeComplianceCheckIssuesCount(Integer evidenceByTypeComplianceCheckIssuesCount) {
  ...
  public AssessmentEvidenceFolder evidenceByTypeUserActivityCount(Integer evidenceByTypeUserActivityCount) {
  ...
  public AssessmentEvidenceFolder evidenceAwsServiceSourceCount(Integer evidenceAwsServiceSourceCount) {
  ...
  public boolean equals(Object o) {
    ...
    AssessmentEvidenceFolder assessmentEvidenceFolder = (AssessmentEvidenceFolder) o;
    return Objects.equals(this.name, assessmentEvidenceFolder.name) &&
        Objects.equals(this.date, assessmentEvidenceFolder.date) &&
        Objects.equals(this.assessmentId, assessmentEvidenceFolder.assessmentId) &&
        Objects.equals(this.controlSetId, assessmentEvidenceFolder.controlSetId) &&
        Objects.equals(this.controlId, assessmentEvidenceFolder.controlId) &&
        Objects.equals(this.id, assessmentEvidenceFolder.id) &&
        Objects.equals(this.dataSource, assessmentEvidenceFolder.dataSource) &&
        Objects.equals(this.author, assessmentEvidenceFolder.author) &&
        Objects.equals(this.totalEvidence, assessmentEvidenceFolder.totalEvidence) &&
        Objects.equals(this.assessmentReportSelectionCount, assessmentEvidenceFolder.assessmentReportSelectionCount) &&
        Objects.equals(this.controlName, assessmentEvidenceFolder.controlName) &&
        Objects.equals(this.evidenceResourcesIncludedCount, assessmentEvidenceFolder.evidenceResourcesIncludedCount) &&
        Objects.equals(this.evidenceByTypeConfigurationDataCount, assessmentEvidenceFolder.evidenceByTypeConfigurationDataCount) &&
        Objects.equals(this.evidenceByTypeManualCount, assessmentEvidenceFolder.evidenceByTypeManualCount) &&
        Objects.equals(this.evidenceByTypeComplianceCheckCount, assessmentEvidenceFolder.evidenceByTypeComplianceCheckCount) &&
        Objects.equals(this.evidenceByTypeComplianceCheckIssuesCount, assessmentEvidenceFolder.evidenceByTypeComplianceCheckIssuesCount) &&
        Objects.equals(this.evidenceByTypeUserActivityCount, assessmentEvidenceFolder.evidenceByTypeUserActivityCount) &&
        Objects.equals(this.evidenceAwsServiceSourceCount, assessmentEvidenceFolder.evidenceAwsServiceSourceCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssessmentEvidenceFolder {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssessmentEvidenceFolder
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssessmentEvidenceFolder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssessmentEvidenceFolder is not found in the empty JSON string", AssessmentEvidenceFolder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssessmentEvidenceFolder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AssessmentEvidenceFolder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssessmentEvidenceFolder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssessmentEvidenceFolder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssessmentEvidenceFolder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssessmentEvidenceFolder.class));

       return (TypeAdapter<T>) new TypeAdapter<AssessmentEvidenceFolder>() {
           @Override
           public void write(JsonWriter out, AssessmentEvidenceFolder value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssessmentEvidenceFolder read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssessmentEvidenceFolder given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssessmentEvidenceFolder
   * @throws IOException if the JSON string is invalid with respect to AssessmentEvidenceFolder
   */
  public static AssessmentEvidenceFolder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssessmentEvidenceFolder.class);
  }

  /**
   * Convert an instance of AssessmentEvidenceFolder to an JSON string
   *
   * @return JSON string
   */
