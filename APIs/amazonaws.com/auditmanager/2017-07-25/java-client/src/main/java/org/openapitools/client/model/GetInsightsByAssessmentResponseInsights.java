...
/**
 * GetInsightsByAssessmentResponseInsights
 */
...
public class GetInsightsByAssessmentResponseInsights {
  ...
  public GetInsightsByAssessmentResponseInsights() {
  }

  public GetInsightsByAssessmentResponseInsights noncompliantEvidenceCount(Integer noncompliantEvidenceCount) {
  ...
  public GetInsightsByAssessmentResponseInsights compliantEvidenceCount(Integer compliantEvidenceCount) {
  ...
  public GetInsightsByAssessmentResponseInsights inconclusiveEvidenceCount(Integer inconclusiveEvidenceCount) {
  ...
  public GetInsightsByAssessmentResponseInsights assessmentControlsCountByNoncompliantEvidence(Integer assessmentControlsCountByNoncompliantEvidence) {
  ...
  public GetInsightsByAssessmentResponseInsights totalAssessmentControlsCount(Integer totalAssessmentControlsCount) {
  ...
  public GetInsightsByAssessmentResponseInsights lastUpdated(OffsetDateTime lastUpdated) {
  ...
  public boolean equals(Object o) {
    ...
    GetInsightsByAssessmentResponseInsights getInsightsByAssessmentResponseInsights = (GetInsightsByAssessmentResponseInsights) o;
    return Objects.equals(this.noncompliantEvidenceCount, getInsightsByAssessmentResponseInsights.noncompliantEvidenceCount) &&
        Objects.equals(this.compliantEvidenceCount, getInsightsByAssessmentResponseInsights.compliantEvidenceCount) &&
        Objects.equals(this.inconclusiveEvidenceCount, getInsightsByAssessmentResponseInsights.inconclusiveEvidenceCount) &&
        Objects.equals(this.assessmentControlsCountByNoncompliantEvidence, getInsightsByAssessmentResponseInsights.assessmentControlsCountByNoncompliantEvidence) &&
        Objects.equals(this.totalAssessmentControlsCount, getInsightsByAssessmentResponseInsights.totalAssessmentControlsCount) &&
        Objects.equals(this.lastUpdated, getInsightsByAssessmentResponseInsights.lastUpdated);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetInsightsByAssessmentResponseInsights {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetInsightsByAssessmentResponseInsights
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInsightsByAssessmentResponseInsights.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetInsightsByAssessmentResponseInsights is not found in the empty JSON string", GetInsightsByAssessmentResponseInsights.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInsightsByAssessmentResponseInsights.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetInsightsByAssessmentResponseInsights` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetInsightsByAssessmentResponseInsights.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetInsightsByAssessmentResponseInsights' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetInsightsByAssessmentResponseInsights> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetInsightsByAssessmentResponseInsights.class));

       return (TypeAdapter<T>) new TypeAdapter<GetInsightsByAssessmentResponseInsights>() {
           @Override
           public void write(JsonWriter out, GetInsightsByAssessmentResponseInsights value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetInsightsByAssessmentResponseInsights read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetInsightsByAssessmentResponseInsights given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetInsightsByAssessmentResponseInsights
   * @throws IOException if the JSON string is invalid with respect to GetInsightsByAssessmentResponseInsights
   */
  public static GetInsightsByAssessmentResponseInsights fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInsightsByAssessmentResponseInsights.class);
  }

  /**
   * Convert an instance of GetInsightsByAssessmentResponseInsights to an JSON string
   *
   * @return JSON string
   */
