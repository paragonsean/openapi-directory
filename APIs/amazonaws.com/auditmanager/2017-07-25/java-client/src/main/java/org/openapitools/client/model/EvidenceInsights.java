...
public class EvidenceInsights {
  ...
  public EvidenceInsights noncompliantEvidenceCount(Integer noncompliantEvidenceCount) {
  ...
  public EvidenceInsights compliantEvidenceCount(Integer compliantEvidenceCount) {
  ...
  public EvidenceInsights inconclusiveEvidenceCount(Integer inconclusiveEvidenceCount) {
  ...
  public boolean equals(Object o) {
    ...
    EvidenceInsights evidenceInsights = (EvidenceInsights) o;
    return Objects.equals(this.noncompliantEvidenceCount, evidenceInsights.noncompliantEvidenceCount) &&
        Objects.equals(this.compliantEvidenceCount, evidenceInsights.compliantEvidenceCount) &&
        Objects.equals(this.inconclusiveEvidenceCount, evidenceInsights.inconclusiveEvidenceCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvidenceInsights {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvidenceInsights
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvidenceInsights.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvidenceInsights is not found in the empty JSON string", EvidenceInsights.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvidenceInsights.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvidenceInsights` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvidenceInsights.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvidenceInsights' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvidenceInsights> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvidenceInsights.class));

       return (TypeAdapter<T>) new TypeAdapter<EvidenceInsights>() {
           @Override
           public void write(JsonWriter out, EvidenceInsights value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvidenceInsights read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvidenceInsights given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvidenceInsights
   * @throws IOException if the JSON string is invalid with respect to EvidenceInsights
   */
  public static EvidenceInsights fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvidenceInsights.class);
  }

  /**
   * Convert an instance of EvidenceInsights to an JSON string
   *
   * @return JSON string
   */
