...
public class GetSettingsResponseSettings {
  ...
  public GetSettingsResponseSettings() {
  }

  public GetSettingsResponseSettings isAwsOrgEnabled(Boolean isAwsOrgEnabled) {
  ...
  public GetSettingsResponseSettings snsTopic(String snsTopic) {
  ...
  public GetSettingsResponseSettings defaultAssessmentReportsDestination(SettingsDefaultAssessmentReportsDestination defaultAssessmentReportsDestination) {
  ...
  public GetSettingsResponseSettings defaultProcessOwners(List defaultProcessOwners) {
  ...
  public GetSettingsResponseSettings kmsKey(String kmsKey) {
    this.kmsKey = kmsKey;
    return this;
  }
  ...
  public GetSettingsResponseSettings evidenceFinderEnablement(SettingsEvidenceFinderEnablement evidenceFinderEnablement) {
  ...
  public GetSettingsResponseSettings deregistrationPolicy(SettingsDeregistrationPolicy deregistrationPolicy) {
  ...
  public GetSettingsResponseSettings defaultExportDestination(SettingsDefaultExportDestination defaultExportDestination) {
  ...
  public boolean equals(Object o) {
    ...
    GetSettingsResponseSettings getSettingsResponseSettings = (GetSettingsResponseSettings) o;
    return Objects.equals(this.isAwsOrgEnabled, getSettingsResponseSettings.isAwsOrgEnabled) &&
        Objects.equals(this.snsTopic, getSettingsResponseSettings.snsTopic) &&
        Objects.equals(this.defaultAssessmentReportsDestination, getSettingsResponseSettings.defaultAssessmentReportsDestination) &&
        Objects.equals(this.defaultProcessOwners, getSettingsResponseSettings.defaultProcessOwners) &&
        Objects.equals(this.kmsKey, getSettingsResponseSettings.kmsKey) &&
        Objects.equals(this.evidenceFinderEnablement, getSettingsResponseSettings.evidenceFinderEnablement) &&
        Objects.equals(this.deregistrationPolicy, getSettingsResponseSettings.deregistrationPolicy) &&
        Objects.equals(this.defaultExportDestination, getSettingsResponseSettings.defaultExportDestination);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSettingsResponseSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSettingsResponseSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSettingsResponseSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSettingsResponseSettings is not found in the empty JSON string", GetSettingsResponseSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSettingsResponseSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSettingsResponseSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSettingsResponseSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSettingsResponseSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSettingsResponseSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSettingsResponseSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSettingsResponseSettings>() {
           @Override
           public void write(JsonWriter out, GetSettingsResponseSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSettingsResponseSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSettingsResponseSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSettingsResponseSettings
   * @throws IOException if the JSON string is invalid with respect to GetSettingsResponseSettings
   */
  public static GetSettingsResponseSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSettingsResponseSettings.class);
  }

  /**
   * Convert an instance of GetSettingsResponseSettings to an JSON string
   *
   * @return JSON string
   */
