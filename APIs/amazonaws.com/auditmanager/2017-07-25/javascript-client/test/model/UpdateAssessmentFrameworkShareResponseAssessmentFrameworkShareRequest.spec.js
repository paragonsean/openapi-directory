...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAuditManager.UpdateAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest();
  });
  ...
  describe('UpdateAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest', function() {
    it('should create an instance of UpdateAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest', function() {
      // uncomment below and update the code to test UpdateAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest
      //var instance = new AwsAuditManager.UpdateAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest();
      //expect(instance).to.be.a(AwsAuditManager.UpdateAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest);
    });
