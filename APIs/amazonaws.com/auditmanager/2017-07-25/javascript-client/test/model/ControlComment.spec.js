...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAuditManager.ControlComment();
  });
  ...
  describe('ControlComment', function() {
    it('should create an instance of ControlComment', function() {
      // uncomment below and update the code to test ControlComment
      //var instance = new AwsAuditManager.ControlComment();
      //expect(instance).to.be.a(AwsAuditManager.ControlComment);
    });
