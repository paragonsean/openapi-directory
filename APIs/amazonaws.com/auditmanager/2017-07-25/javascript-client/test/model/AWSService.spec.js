...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAuditManager.AWSService();
  });
  ...
  describe('AWSService', function() {
    it('should create an instance of AWSService', function() {
      // uncomment below and update the code to test AWSService
      //var instance = new AwsAuditManager.AWSService();
      //expect(instance).to.be.a(AwsAuditManager.AWSService);
    });
