...
(function(root, factory) {
  ...
  describe('DeleteResources', function() {
    it('should create an instance of DeleteResources', function() {
      // uncomment below and update the code to test DeleteResources
      //var instance = new AwsAuditManager.DeleteResources();
      //expect(instance).to.be.a(AwsAuditManager.DeleteResources);
    });
