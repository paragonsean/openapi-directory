...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsAuditManager.StartAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest();
  });
  ...
  describe('StartAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest', function() {
    it('should create an instance of StartAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest', function() {
      // uncomment below and update the code to test StartAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest
      //var instance = new AwsAuditManager.StartAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest();
      //expect(instance).to.be.a(AwsAuditManager.StartAssessmentFrameworkShareResponseAssessmentFrameworkShareRequest);
    });
