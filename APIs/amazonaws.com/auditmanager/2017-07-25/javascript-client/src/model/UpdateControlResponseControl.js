...
/**
 * The UpdateControlResponseControl model module.
 * @module model/UpdateControlResponseControl
 * @version 2017-07-25
 */
class UpdateControlResponseControl {
    /**
     * Constructs a new <code>UpdateControlResponseControl</code>.
     * @alias module:model/UpdateControlResponseControl
     * @implements module:model/Control
     */
    constructor() { 
        Control.initialize(this);
        UpdateControlResponseControl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateControlResponseControl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateControlResponseControl} obj Optional instance to populate.
     * @return {module:model/UpdateControlResponseControl} The populated <code>UpdateControlResponseControl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateControlResponseControl();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateControlResponseControl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateControlResponseControl</code>.
     */
 ...
 * @member {String} arn
 */
UpdateControlResponseControl.prototype['arn'] = undefined;

/**
 * @member {String} id
 */
UpdateControlResponseControl.prototype['id'] = undefined;

/**
 * @member {module:model/ControlType} type
 */
UpdateControlResponseControl.prototype['type'] = undefined;

/**
 * @member {String} name
 */
UpdateControlResponseControl.prototype['name'] = undefined;

/**
 * @member {String} description
 */
UpdateControlResponseControl.prototype['description'] = undefined;

/**
 * @member {String} testingInformation
 */
UpdateControlResponseControl.prototype['testingInformation'] = undefined;

/**
 * @member {String} actionPlanTitle
 */
UpdateControlResponseControl.prototype['actionPlanTitle'] = undefined;

/**
 * @member {String} actionPlanInstructions
 */
UpdateControlResponseControl.prototype['actionPlanInstructions'] = undefined;

/**
 * @member {String} controlSources
 */
UpdateControlResponseControl.prototype['controlSources'] = undefined;

/**
 * @member {Array} controlMappingSources
 */
UpdateControlResponseControl.prototype['controlMappingSources'] = undefined;

/**
 * @member {Date} createdAt
 */
UpdateControlResponseControl.prototype['createdAt'] = undefined;

/**
 * @member {Date} lastUpdatedAt
 */
UpdateControlResponseControl.prototype['lastUpdatedAt'] = undefined;

/**
 * @member {String} createdBy
 */
UpdateControlResponseControl.prototype['createdBy'] = undefined;

/**
 * @member {String} lastUpdatedBy
 */
UpdateControlResponseControl.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Object} tags
 */
UpdateControlResponseControl.prototype['tags'] = undefined;
...
export default UpdateControlResponseControl;
