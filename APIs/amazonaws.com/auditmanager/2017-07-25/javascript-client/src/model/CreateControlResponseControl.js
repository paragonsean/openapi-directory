...
/**
 * The CreateControlResponseControl model module.
 * @module model/CreateControlResponseControl
 * @version 2017-07-25
 */
class CreateControlResponseControl {
    /**
     * Constructs a new <code>CreateControlResponseControl</code>.
     * @alias module:model/CreateControlResponseControl
     * @implements module:model/Control
     */
    constructor() { 
        Control.initialize(this);
        CreateControlResponseControl.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateControlResponseControl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateControlResponseControl} obj Optional instance to populate.
     * @return {module:model/CreateControlResponseControl} The populated <code>CreateControlResponseControl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateControlResponseControl();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateControlResponseControl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateControlResponseControl</code>.
     */
 ...
 * @member {String} arn
 */
CreateControlResponseControl.prototype['arn'] = undefined;

/**
 * @member {String} id
 */
CreateControlResponseControl.prototype['id'] = undefined;

/**
 * @member {module:model/ControlType} type
 */
CreateControlResponseControl.prototype['type'] = undefined;

/**
 * @member {String} name
 */
CreateControlResponseControl.prototype['name'] = undefined;

/**
 * @member {String} description
 */
CreateControlResponseControl.prototype['description'] = undefined;

/**
 * @member {String} testingInformation
 */
CreateControlResponseControl.prototype['testingInformation'] = undefined;

/**
 * @member {String} actionPlanTitle
 */
CreateControlResponseControl.prototype['actionPlanTitle'] = undefined;

/**
 * @member {String} actionPlanInstructions
 */
CreateControlResponseControl.prototype['actionPlanInstructions'] = undefined;

/**
 * @member {String} controlSources
 */
CreateControlResponseControl.prototype['controlSources'] = undefined;

/**
 * @member {Array} controlMappingSources
 */
CreateControlResponseControl.prototype['controlMappingSources'] = undefined;

/**
 * @member {Date} createdAt
 */
CreateControlResponseControl.prototype['createdAt'] = undefined;

/**
 * @member {Date} lastUpdatedAt
 */
CreateControlResponseControl.prototype['lastUpdatedAt'] = undefined;

/**
 * @member {String} createdBy
 */
CreateControlResponseControl.prototype['createdBy'] = undefined;

/**
 * @member {String} lastUpdatedBy
 */
CreateControlResponseControl.prototype['lastUpdatedBy'] = undefined;

/**
 * @member {Object} tags
 */
CreateControlResponseControl.prototype['tags'] = undefined;
...
export default CreateControlResponseControl;
