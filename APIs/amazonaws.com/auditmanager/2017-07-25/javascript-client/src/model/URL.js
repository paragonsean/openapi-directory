...
class URL {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hyperlinkName')) {
                obj['hyperlinkName'] = ApiClient.convertToType(data['hyperlinkName'], 'String');
            }
    ...
    static validateJSON(data) {
        // validate the optional field `hyperlinkName`
        if (data['hyperlinkName']) { // data not null
          String.validateJSON(data['hyperlinkName']);
        }
...
/**
 * @member {String} hyperlinkName
 */
URL.prototype['hyperlinkName'] = undefined;

/**
 * @member {String} link
 */
URL.prototype['link'] = undefined;
