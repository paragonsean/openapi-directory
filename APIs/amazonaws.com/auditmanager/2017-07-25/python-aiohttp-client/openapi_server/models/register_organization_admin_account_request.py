...
class RegisterOrganizationAdminAccountRequest(Model):
    ...
    def __init__(self, admin_account_id: str=None):
        """RegisterOrganizationAdminAccountRequest - a model defined in OpenAPI

        :param admin_account_id: The admin_account_id of this RegisterOrganizationAdminAccountRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RegisterOrganizationAdminAccountRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RegisterOrganizationAdminAccount_request of this RegisterOrganizationAdminAccountRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def admin_account_id(self):
        """Gets the admin_account_id of this RegisterOrganizationAdminAccountRequest.

         The identifier for the delegated administrator account. 

        :return: The admin_account_id of this RegisterOrganizationAdminAccountRequest.
        :rtype: str
        """
    ...
    def admin_account_id(self, admin_account_id):
        """Sets the admin_account_id of this RegisterOrganizationAdminAccountRequest.
