...
class CreateControlRequest(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, name: str=None, description: str=None, testing_information: str=None, action_plan_title: str=None, action_plan_instructions: str=None, control_mapping_sources: List[CreateControlMappingSource]=None, tags: Dict[str, str]=None):
        """CreateControlRequest - a model defined in OpenAPI

        :param name: The name of this CreateControlRequest.
        :param description: The description of this CreateControlRequest.
        :param testing_information: The testing_information of this CreateControlRequest.
        :param action_plan_title: The action_plan_title of this CreateControlRequest.
        :param action_plan_instructions: The action_plan_instructions of this CreateControlRequest.
        :param control_mapping_sources: The control_mapping_sources of this CreateControlRequest.
        :param tags: The tags of this CreateControlRequest.
        """
        self.openapi_types = {
            'name': str,
            'description': str,
            ...
            'control_mapping_sources': List[CreateControlMappingSource],
            'tags': Dict[str, str]
        }
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateControlRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateControl_request of this CreateControlRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this CreateControlRequest.

         The name of the control. 

        :return: The name of this CreateControlRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateControlRequest.
    ...
    def description(self):
        """Gets the description of this CreateControlRequest.

         The description of the control. 

        :return: The description of this CreateControlRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateControlRequest.
    ...
    def testing_information(self):
        """Gets the testing_information of this CreateControlRequest.

         The steps to follow to determine if the control is satisfied. 

        :return: The testing_information of this CreateControlRequest.
        :rtype: str
        """
    ...
    def testing_information(self, testing_information):
        """Sets the testing_information of this CreateControlRequest.
    ...
    def action_plan_title(self):
        """Gets the action_plan_title of this CreateControlRequest.

         The title of the action plan for remediating the control. 

        :return: The action_plan_title of this CreateControlRequest.
        :rtype: str
        """
    ...
    def action_plan_title(self, action_plan_title):
        """Sets the action_plan_title of this CreateControlRequest.
    ...
    def action_plan_instructions(self):
        """Gets the action_plan_instructions of this CreateControlRequest.

         The recommended actions to carry out if the control isn't fulfilled. 

        :return: The action_plan_instructions of this CreateControlRequest.
        :rtype: str
        """
    ...
    def action_plan_instructions(self, action_plan_instructions):
        """Sets the action_plan_instructions of this CreateControlRequest.
    ...
    def control_mapping_sources(self):
        """Gets the control_mapping_sources of this CreateControlRequest.

         The data mapping sources for the control. 

        :return: The control_mapping_sources of this CreateControlRequest.
        :rtype: List[CreateControlMappingSource]
        """
    ...
    def control_mapping_sources(self, control_mapping_sources):
        """Sets the control_mapping_sources of this CreateControlRequest.

         The data mapping sources for the control. 

        :param control_mapping_sources: The control_mapping_sources of this CreateControlRequest.
        :type control_mapping_sources: List[CreateControlMappingSource]
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this CreateControlRequest.

         The tags that are associated with the control. 

        :return: The tags of this CreateControlRequest.
        :rtype: Dict[str, str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CreateControlRequest.
