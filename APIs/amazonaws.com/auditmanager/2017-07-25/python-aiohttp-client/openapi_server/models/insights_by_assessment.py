...
class InsightsByAssessment(Model):
    ...
    def __init__(self, noncompliant_evidence_count: int=None, compliant_evidence_count: int=None, inconclusive_evidence_count: int=None, assessment_controls_count_by_noncompliant_evidence: int=None, total_assessment_controls_count: int=None, last_updated: datetime=None):
        """InsightsByAssessment - a model defined in OpenAPI

        :param noncompliant_evidence_count: The noncompliant_evidence_count of this InsightsByAssessment.
        :param compliant_evidence_count: The compliant_evidence_count of this InsightsByAssessment.
        :param inconclusive_evidence_count: The inconclusive_evidence_count of this InsightsByAssessment.
        :param assessment_controls_count_by_noncompliant_evidence: The assessment_controls_count_by_noncompliant_evidence of this InsightsByAssessment.
        :param total_assessment_controls_count: The total_assessment_controls_count of this InsightsByAssessment.
        :param last_updated: The last_updated of this InsightsByAssessment.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'InsightsByAssessment':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The InsightsByAssessment of this InsightsByAssessment.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def noncompliant_evidence_count(self):
        """Gets the noncompliant_evidence_count of this InsightsByAssessment.


        :return: The noncompliant_evidence_count of this InsightsByAssessment.
        :rtype: int
        """
    ...
    def noncompliant_evidence_count(self, noncompliant_evidence_count):
        """Sets the noncompliant_evidence_count of this InsightsByAssessment.
    ...
    def compliant_evidence_count(self):
        """Gets the compliant_evidence_count of this InsightsByAssessment.


        :return: The compliant_evidence_count of this InsightsByAssessment.
        :rtype: int
        """
    ...
    def compliant_evidence_count(self, compliant_evidence_count):
        """Sets the compliant_evidence_count of this InsightsByAssessment.
    ...
    def inconclusive_evidence_count(self):
        """Gets the inconclusive_evidence_count of this InsightsByAssessment.


        :return: The inconclusive_evidence_count of this InsightsByAssessment.
        :rtype: int
        """
    ...
    def inconclusive_evidence_count(self, inconclusive_evidence_count):
        """Sets the inconclusive_evidence_count of this InsightsByAssessment.
    ...
    def assessment_controls_count_by_noncompliant_evidence(self):
        """Gets the assessment_controls_count_by_noncompliant_evidence of this InsightsByAssessment.


        :return: The assessment_controls_count_by_noncompliant_evidence of this InsightsByAssessment.
        :rtype: int
        """
    ...
    def assessment_controls_count_by_noncompliant_evidence(self, assessment_controls_count_by_noncompliant_evidence):
        """Sets the assessment_controls_count_by_noncompliant_evidence of this InsightsByAssessment.
    ...
    def total_assessment_controls_count(self):
        """Gets the total_assessment_controls_count of this InsightsByAssessment.


        :return: The total_assessment_controls_count of this InsightsByAssessment.
        :rtype: int
        """
    ...
    def total_assessment_controls_count(self, total_assessment_controls_count):
        """Sets the total_assessment_controls_count of this InsightsByAssessment.
    ...
    def last_updated(self):
        """Gets the last_updated of this InsightsByAssessment.


        :return: The last_updated of this InsightsByAssessment.
        :rtype: datetime
        """
    ...
    def last_updated(self, last_updated):
        """Sets the last_updated of this InsightsByAssessment.
