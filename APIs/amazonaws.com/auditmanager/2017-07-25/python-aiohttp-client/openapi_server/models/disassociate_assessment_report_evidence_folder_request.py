...
class DisassociateAssessmentReportEvidenceFolderRequest(Model):
    ...
    def __init__(self, evidence_folder_id: str=None):
        """DisassociateAssessmentReportEvidenceFolderRequest - a model defined in OpenAPI

        :param evidence_folder_id: The evidence_folder_id of this DisassociateAssessmentReportEvidenceFolderRequest.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DisassociateAssessmentReportEvidenceFolderRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DisassociateAssessmentReportEvidenceFolder_request of this DisassociateAssessmentReportEvidenceFolderRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def evidence_folder_id(self):
        """Gets the evidence_folder_id of this DisassociateAssessmentReportEvidenceFolderRequest.

         The unique identifier for the folder that the evidence is stored in. 

        :return: The evidence_folder_id of this DisassociateAssessmentReportEvidenceFolderRequest.
        :rtype: str
        """
    ...
    def evidence_folder_id(self, evidence_folder_id):
        """Sets the evidence_folder_id of this DisassociateAssessmentReportEvidenceFolderRequest.
