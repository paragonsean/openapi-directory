...
async def test_associate_assessment_report_evidence_folder(client):
    """Test case for associate_assessment_report_evidence_folder
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/associateToAssessmentReport'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
...
async def test_batch_associate_assessment_report_evidence(client):
    """Test case for batch_associate_assessment_report_evidence
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/batchAssociateToAssessmentReport'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_create_delegation_by_assessment(client):
    """Test case for batch_create_delegation_by_assessment

    
    """
    body = {"createDelegationRequests":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/assessments/{assessment_id}/delegations'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_delete_delegation_by_assessment(client):
    """Test case for batch_delete_delegation_by_assessment
...
async def test_batch_disassociate_assessment_report_evidence(client):
    """Test case for batch_disassociate_assessment_report_evidence
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/batchDisassociateFromAssessmentReport'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_batch_import_evidence_to_assessment_control(client):
    """Test case for batch_import_evidence_to_assessment_control
    ...
    response = await client.request(
        method='POST',
        path='/assessments/{assessment_id}/controlSets/{control_set_id}/controls/{control_id}/evidence'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example', control_id='control_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_assessment(client):
    """Test case for create_assessment

    
    """
    body = {"frameworkId":"","assessmentReportsDestination":{"destination":"","destinationType":""},"scope":{"awsAccounts":"","awsServices":""},"roles":"","name":"","description":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_assessment_framework(client):
    """Test case for create_assessment_framework

    
    """
    body = {"name":"","description":"","controlSets":"","complianceType":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_create_assessment_report(client):
    """Test case for create_assessment_report

    
    """
    body = {"queryStatement":"","name":"","description":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/assessments/{assessment_id}/reports'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_control(client):
    """Test case for create_control

    
    """
    body = {"actionPlanInstructions":"","name":"","controlMappingSources":"","description":"","actionPlanTitle":"","testingInformation":"","tags":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_delete_assessment(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/assessments/{assessment_id}'.format(assessment_id='assessment_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_assessment_framework(client):
    """Test case for delete_assessment_framework
    ...
    response = await client.request(
        method='DELETE',
        path='/assessmentFrameworks/{framework_id}'.format(framework_id='framework_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_assessment_framework_share(client):
    """Test case for delete_assessment_framework_share

    
    """
    params = [('requestType', 'request_type_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='DELETE',
        path='/assessmentFrameworkShareRequests/{request_idrequest_typ}'.format(request_id='request_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_assessment_report(client):
    """Test case for delete_assessment_report
    ...
    response = await client.request(
        method='DELETE',
        path='/assessments/{assessment_id}/reports/{assessment_report_id}'.format(assessment_id='assessment_id_example', assessment_report_id='assessment_report_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_control(client):
    ...
    response = await client.request(
        method='DELETE',
        path='/controls/{control_id}'.format(control_id='control_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_deregister_account(client):
    """Test case for deregister_account
...
async def test_deregister_organization_admin_account(client):
    """Test case for deregister_organization_admin_account
...
async def test_disassociate_assessment_report_evidence_folder(client):
    """Test case for disassociate_assessment_report_evidence_folder
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/disassociateFromAssessmentReport'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_assessment(client):
...
async def test_get_assessment_framework(client):
    """Test case for get_assessment_framework
...
async def test_get_assessment_report_url(client):
    """Test case for get_assessment_report_url
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/reports/{assessment_report_id}/url'.format(assessment_report_id='assessment_report_id_example', assessment_id='assessment_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_change_logs(client):
    ...
    """
    params = [('controlSetId', 'control_set_id_example'),
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/changelogs'.format(assessment_id='assessment_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_delegations(client):
...
async def test_get_evidence(client):
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/controlSets/{control_set_id}/evidenceFolders/{evidence_folder_id}/evidence/{evidence_id}'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example', evidence_folder_id='evidence_folder_id_example', evidence_id='evidence_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_evidence_by_evidence_folder(client):
    """Test case for get_evidence_by_evidence_folder
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/controlSets/{control_set_id}/evidenceFolders/{evidence_folder_id}/evidence'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example', evidence_folder_id='evidence_folder_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_evidence_file_upload_url(client):
    """Test case for get_evidence_file_upload_url

    
    """
    params = [('fileName', 'file_name_example')]
    headers = { 
        'Accept': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
        'x_amz_date': 'x_amz_date_example',
    ...
    response = await client.request(
        method='GET',
        path='/evidenceFileUploadUrl#fileName',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_evidence_folder(client):
    """Test case for get_evidence_folder
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/controlSets/{control_set_id}/evidenceFolders/{evidence_folder_id}'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example', evidence_folder_id='evidence_folder_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_evidence_folders_by_assessment(client):
    """Test case for get_evidence_folders_by_assessment
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/evidenceFolders'.format(assessment_id='assessment_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_evidence_folders_by_assessment_control(client):
    """Test case for get_evidence_folders_by_assessment_control
    ...
    response = await client.request(
        method='GET',
        path='/assessments/{assessment_id}/evidenceFolders-by-assessment-control/{control_set_id}/{control_id}'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example', control_id='control_id_example'),
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_insights_by_assessment(client):
    """Test case for get_insights_by_assessment
    ...
    response = await client.request(
        method='GET',
        path='/insights/assessments/{assessment_id}'.format(assessment_id='assessment_id_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_organization_admin_account(client):
    """Test case for get_organization_admin_account
...
async def test_get_services_in_scope(client):
    """Test case for get_services_in_scope
...
async def test_get_settings(client):
    ...
    response = await client.request(
        method='GET',
        path='/settings/{attribute}'.format(attribute='attribute_example'),
        headers=headers,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_assessment_control_insights_by_control_domain(client):
    """Test case for list_assessment_control_insights_by_control_domain

    
    """
    params = [('controlDomainId', 'control_domain_id_example'),
                    ('assessmentId', 'assessment_id_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='GET',
        path='/insights/controls-by-assessment#controlDomainId&assessmentId',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_assessment_framework_share_requests(client):
    """Test case for list_assessment_framework_share_requests
...
async def test_list_assessment_frameworks(client):
    """Test case for list_assessment_frameworks

    
    """
    params = [('frameworkType', 'framework_type_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_assessment_reports(client):
    """Test case for list_assessment_reports
...
async def test_list_control_domain_insights(client):
    """Test case for list_control_domain_insights
...
async def test_list_control_domain_insights_by_assessment(client):
    """Test case for list_control_domain_insights_by_assessment

    
    """
    params = [('assessmentId', 'assessment_id_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='GET',
        path='/insights/control-domains-by-assessment#assessmentId',
        headers=headers,
        params=params,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_control_insights_by_control_domain(client):
    """Test case for list_control_insights_by_control_domain
...
async def test_list_controls(client):
    """Test case for list_controls

    
    """
    params = [('controlType', 'control_type_example'),
                    ('nextToken', 'next_token_example'),
                    ('maxResults', 56)]
    headers = { 
        'Accept': 'application/json',
...
async def test_list_keywords_for_data_source(client):
    """Test case for list_keywords_for_data_source
...
async def test_register_organization_admin_account(client):
    """Test case for register_organization_admin_account
...
async def test_start_assessment_framework_share(client):
    """Test case for start_assessment_framework_share

    
    """
    body = {"destinationRegion":"","comment":"","destinationAccount":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/assessmentFrameworks/{framework_id}/shareRequests'.format(framework_id='framework_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_assessment(client):
    """Test case for update_assessment

    
    """
    body = {"assessmentReportsDestination":{"destination":"","destinationType":""},"assessmentName":"","assessmentDescription":"","scope":{"awsAccounts":"","awsServices":""},"roles":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_assessment_control(client):
    """Test case for update_assessment_control
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/controlSets/{control_set_id}/controls/{control_id}'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example', control_id='control_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_assessment_control_set_status(client):
    """Test case for update_assessment_control_set_status
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/controlSets/{control_set_id}/status'.format(assessment_id='assessment_id_example', control_set_id='control_set_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_assessment_framework(client):
    """Test case for update_assessment_framework

    
    """
    body = {"name":"","description":"","controlSets":"","complianceType":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_assessment_framework_share(client):
    """Test case for update_assessment_framework_share
    ...
    response = await client.request(
        method='PUT',
        path='/assessmentFrameworkShareRequests/{request_id}'.format(request_id='request_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_assessment_status(client):
    ...
    response = await client.request(
        method='PUT',
        path='/assessments/{assessment_id}/status'.format(assessment_id='assessment_id_example'),
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_control(client):
    """Test case for update_control

    
    """
    body = {"actionPlanInstructions":"","name":"","controlMappingSources":"","description":"","actionPlanTitle":"","testingInformation":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_update_settings(client):
    ...
    """
    body = {"snsTopic":"","defaultAssessmentReportsDestination":{"destination":"","destinationType":""},"evidenceFinderEnabled":"","kmsKey":"","deregistrationPolicy":{"deleteResources":""},"defaultProcessOwners":"","defaultExportDestination":{"destination":"","destinationType":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
...
async def test_validate_assessment_report_integrity(client):
    """Test case for validate_assessment_report_integrity
