...
OAIUpdateControl_request::OAIUpdateControl_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateControl_request::OAIUpdateControl_request() {
    this->initializeModel();
}

OAIUpdateControl_request::~OAIUpdateControl_request() {}

void OAIUpdateControl_request::initializeModel() {
...
void OAIUpdateControl_request::fromJson(QString jsonString) {
...
void OAIUpdateControl_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateControl_request::asJson() const {
...
QJsonObject OAIUpdateControl_request::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIUpdateControl_request::getName() const {
    return m_name;
}
void OAIUpdateControl_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateControl_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateControl_request::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIUpdateControl_request::getDescription() const {
    return m_description;
}
void OAIUpdateControl_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateControl_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateControl_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateControl_request::getTestingInformation() const {
    return m_testing_information;
}
void OAIUpdateControl_request::setTestingInformation(const QString &testing_information) {
    m_testing_information = testing_information;
    m_testing_information_isSet = true;
}

bool OAIUpdateControl_request::is_testing_information_Set() const{
    return m_testing_information_isSet;
}

bool OAIUpdateControl_request::is_testing_information_Valid() const{
    return m_testing_information_isValid;
}

QString OAIUpdateControl_request::getActionPlanTitle() const {
    return m_action_plan_title;
}
void OAIUpdateControl_request::setActionPlanTitle(const QString &action_plan_title) {
    m_action_plan_title = action_plan_title;
    m_action_plan_title_isSet = true;
}

bool OAIUpdateControl_request::is_action_plan_title_Set() const{
    return m_action_plan_title_isSet;
}

bool OAIUpdateControl_request::is_action_plan_title_Valid() const{
    return m_action_plan_title_isValid;
}

QString OAIUpdateControl_request::getActionPlanInstructions() const {
    return m_action_plan_instructions;
}
void OAIUpdateControl_request::setActionPlanInstructions(const QString &action_plan_instructions) {
    m_action_plan_instructions = action_plan_instructions;
    m_action_plan_instructions_isSet = true;
}

bool OAIUpdateControl_request::is_action_plan_instructions_Set() const{
    return m_action_plan_instructions_isSet;
}

bool OAIUpdateControl_request::is_action_plan_instructions_Valid() const{
    return m_action_plan_instructions_isValid;
}

QList<OAIControlMappingSource> OAIUpdateControl_request::getControlMappingSources() const {
    return m_control_mapping_sources;
}
void OAIUpdateControl_request::setControlMappingSources(const QList<OAIControlMappingSource> &control_mapping_sources) {
    m_control_mapping_sources = control_mapping_sources;
    m_control_mapping_sources_isSet = true;
}

bool OAIUpdateControl_request::is_control_mapping_sources_Set() const{
    return m_control_mapping_sources_isSet;
}

bool OAIUpdateControl_request::is_control_mapping_sources_Valid() const{
    return m_control_mapping_sources_isValid;
}

bool OAIUpdateControl_request::isSet() const {
...
bool OAIUpdateControl_request::isValid() const {
