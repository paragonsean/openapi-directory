...
/*
 * OAIGetControlResponse_control.h
 *
 * 
 */

#ifndef OAIGetControlResponse_control_H
#define OAIGetControlResponse_control_H
...
class OAIGetControlResponse_control : public OAIObject {
public:
    OAIGetControlResponse_control();
    OAIGetControlResponse_control(QString json);
    ~OAIGetControlResponse_control() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetControlResponse_control)

#endif // OAIGetControlResponse_control_H
