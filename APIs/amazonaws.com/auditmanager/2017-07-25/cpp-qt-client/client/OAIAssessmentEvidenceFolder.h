...
/*
 * OAIAssessmentEvidenceFolder.h
 *
 *  The folder where Audit Manager stores evidence for an assessment. 
 */

#ifndef OAIAssessmentEvidenceFolder_H
#define OAIAssessmentEvidenceFolder_H
...
class OAIAssessmentEvidenceFolder : public OAIObject {
public:
    OAIAssessmentEvidenceFolder();
    OAIAssessmentEvidenceFolder(QString json);
    ~OAIAssessmentEvidenceFolder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssessmentEvidenceFolder)

#endif // OAIAssessmentEvidenceFolder_H
