...
/*
 * OAIAssessmentControlSet.h
 *
 *  Represents a set of controls in an Audit Manager assessment. 
 */

#ifndef OAIAssessmentControlSet_H
#define OAIAssessmentControlSet_H
...
class OAIAssessmentControlSet : public OAIObject {
public:
    OAIAssessmentControlSet();
    OAIAssessmentControlSet(QString json);
    ~OAIAssessmentControlSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssessmentControlSet)

#endif // OAIAssessmentControlSet_H
