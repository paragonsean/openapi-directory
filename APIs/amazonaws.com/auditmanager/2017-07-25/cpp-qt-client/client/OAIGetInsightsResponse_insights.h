...
/*
 * OAIGetInsightsResponse_insights.h
 *
 * 
 */

#ifndef OAIGetInsightsResponse_insights_H
#define OAIGetInsightsResponse_insights_H
...
class OAIGetInsightsResponse_insights : public OAIObject {
public:
    OAIGetInsightsResponse_insights();
    OAIGetInsightsResponse_insights(QString json);
    ~OAIGetInsightsResponse_insights() override;
    ...
    qint32 getActiveAssessmentsCount() const;
    void setActiveAssessmentsCount(const qint32 &active_assessments_count);
    bool is_active_assessments_count_Set() const;
    bool is_active_assessments_count_Valid() const;
...
private:
    ...
    qint32 m_active_assessments_count;
    bool m_active_assessments_count_isSet;
    bool m_active_assessments_count_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInsightsResponse_insights)

#endif // OAIGetInsightsResponse_insights_H
