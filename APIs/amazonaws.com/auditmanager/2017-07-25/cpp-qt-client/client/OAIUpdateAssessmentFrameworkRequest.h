...
/*
 * OAIUpdateAssessmentFrameworkRequest.h
 *
 * 
 */

#ifndef OAIUpdateAssessmentFrameworkRequest_H
#define OAIUpdateAssessmentFrameworkRequest_H
...
class OAIUpdateAssessmentFrameworkRequest : public OAIObject {
public:
    OAIUpdateAssessmentFrameworkRequest();
    OAIUpdateAssessmentFrameworkRequest(QString json);
    ~OAIUpdateAssessmentFrameworkRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAssessmentFrameworkRequest)

#endif // OAIUpdateAssessmentFrameworkRequest_H
