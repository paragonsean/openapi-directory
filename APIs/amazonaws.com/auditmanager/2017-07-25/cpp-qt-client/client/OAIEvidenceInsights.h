...
class OAIEvidenceInsights : public OAIObject {
public:
    OAIEvidenceInsights();
    OAIEvidenceInsights(QString json);
    ~OAIEvidenceInsights() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvidenceInsights)

#endif // OAIEvidenceInsights_H
