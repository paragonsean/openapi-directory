...
qint32 OAIInsights::getActiveAssessmentsCount() const {
    return m_active_assessments_count;
}
void OAIInsights::setActiveAssessmentsCount(const qint32 &active_assessments_count) {
    m_active_assessments_count = active_assessments_count;
    m_active_assessments_count_isSet = true;
}

bool OAIInsights::is_active_assessments_count_Set() const{
    return m_active_assessments_count_isSet;
}

bool OAIInsights::is_active_assessments_count_Valid() const{
    return m_active_assessments_count_isValid;
}

qint32 OAIInsights::getNoncompliantEvidenceCount() const {
    return m_noncompliant_evidence_count;
}
void OAIInsights::setNoncompliantEvidenceCount(const qint32 &noncompliant_evidence_count) {
    m_noncompliant_evidence_count = noncompliant_evidence_count;
    m_noncompliant_evidence_count_isSet = true;
}

bool OAIInsights::is_noncompliant_evidence_count_Set() const{
    return m_noncompliant_evidence_count_isSet;
}

bool OAIInsights::is_noncompliant_evidence_count_Valid() const{
    return m_noncompliant_evidence_count_isValid;
}

qint32 OAIInsights::getCompliantEvidenceCount() const {
    return m_compliant_evidence_count;
}
void OAIInsights::setCompliantEvidenceCount(const qint32 &compliant_evidence_count) {
    m_compliant_evidence_count = compliant_evidence_count;
    m_compliant_evidence_count_isSet = true;
}

bool OAIInsights::is_compliant_evidence_count_Set() const{
    return m_compliant_evidence_count_isSet;
}

bool OAIInsights::is_compliant_evidence_count_Valid() const{
    return m_compliant_evidence_count_isValid;
}

qint32 OAIInsights::getInconclusiveEvidenceCount() const {
    return m_inconclusive_evidence_count;
}
void OAIInsights::setInconclusiveEvidenceCount(const qint32 &inconclusive_evidence_count) {
    m_inconclusive_evidence_count = inconclusive_evidence_count;
    m_inconclusive_evidence_count_isSet = true;
}

bool OAIInsights::is_inconclusive_evidence_count_Set() const{
    return m_inconclusive_evidence_count_isSet;
}

bool OAIInsights::is_inconclusive_evidence_count_Valid() const{
    return m_inconclusive_evidence_count_isValid;
}

qint32 OAIInsights::getAssessmentControlsCountByNoncompliantEvidence() const {
    return m_assessment_controls_count_by_noncompliant_evidence;
}
void OAIInsights::setAssessmentControlsCountByNoncompliantEvidence(const qint32 &assessment_controls_count_by_noncompliant_evidence) {
...
bool OAIInsights::is_assessment_controls_count_by_noncompliant_evidence_Set() const{
    return m_assessment_controls_count_by_noncompliant_evidence_isSet;
}

bool OAIInsights::is_assessment_controls_count_by_noncompliant_evidence_Valid() const{
    return m_assessment_controls_count_by_noncompliant_evidence_isValid;
}

qint32 OAIInsights::getTotalAssessmentControlsCount() const {
    return m_total_assessment_controls_count;
}
void OAIInsights::setTotalAssessmentControlsCount(const qint32 &total_assessment_controls_count) {
    m_total_assessment_controls_count = total_assessment_controls_count;
    m_total_assessment_controls_count_isSet = true;
}

bool OAIInsights::is_total_assessment_controls_count_Set() const{
    return m_total_assessment_controls_count_isSet;
}

bool OAIInsights::is_total_assessment_controls_count_Valid() const{
    return m_total_assessment_controls_count_isValid;
}

QDateTime OAIInsights::getLastUpdated() const {
    return m_last_updated;
}
void OAIInsights::setLastUpdated(const QDateTime &last_updated) {
    m_last_updated = last_updated;
    m_last_updated_isSet = true;
}

bool OAIInsights::is_last_updated_Set() const{
    return m_last_updated_isSet;
}

bool OAIInsights::is_last_updated_Valid() const{
