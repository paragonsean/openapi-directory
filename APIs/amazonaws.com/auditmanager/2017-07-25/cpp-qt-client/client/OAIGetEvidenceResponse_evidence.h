...
/*
 * OAIGetEvidenceResponse_evidence.h
 *
 * 
 */

#ifndef OAIGetEvidenceResponse_evidence_H
#define OAIGetEvidenceResponse_evidence_H
...
class OAIGetEvidenceResponse_evidence : public OAIObject {
public:
    OAIGetEvidenceResponse_evidence();
    OAIGetEvidenceResponse_evidence(QString json);
    ~OAIGetEvidenceResponse_evidence() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetEvidenceResponse_evidence)

#endif // OAIGetEvidenceResponse_evidence_H
