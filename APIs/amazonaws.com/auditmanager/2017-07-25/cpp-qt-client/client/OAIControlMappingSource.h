...
/*
 * OAIControlMappingSource.h
 *
 *  The data source that determines where Audit Manager collects evidence from for the control. 
 */

#ifndef OAIControlMappingSource_H
#define OAIControlMappingSource_H
...
class OAIControlMappingSource : public OAIObject {
public:
    OAIControlMappingSource();
    OAIControlMappingSource(QString json);
    ~OAIControlMappingSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIControlMappingSource)

#endif // OAIControlMappingSource_H
