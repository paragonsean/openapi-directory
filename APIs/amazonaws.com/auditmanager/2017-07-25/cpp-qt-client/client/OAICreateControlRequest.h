...
/*
 * OAICreateControlRequest.h
 *
 * 
 */

#ifndef OAICreateControlRequest_H
#define OAICreateControlRequest_H
...
class OAICreateControlRequest : public OAIObject {
public:
    OAICreateControlRequest();
    OAICreateControlRequest(QString json);
    ~OAICreateControlRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateControlRequest)

#endif // OAICreateControlRequest_H
