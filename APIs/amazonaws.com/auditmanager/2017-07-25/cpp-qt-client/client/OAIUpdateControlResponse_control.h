...
/*
 * OAIUpdateControlResponse_control.h
 *
 * 
 */

#ifndef OAIUpdateControlResponse_control_H
#define OAIUpdateControlResponse_control_H
...
class OAIUpdateControlResponse_control : public OAIObject {
public:
    OAIUpdateControlResponse_control();
    OAIUpdateControlResponse_control(QString json);
    ~OAIUpdateControlResponse_control() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateControlResponse_control)

#endif // OAIUpdateControlResponse_control_H
