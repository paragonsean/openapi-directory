...
#ifndef OAIAssessmentReport_H
#define OAIAssessmentReport_H
...
class OAIAssessmentReport : public OAIObject {
public:
    OAIAssessmentReport();
    OAIAssessmentReport(QString json);
    ~OAIAssessmentReport() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssessmentReport)

#endif // OAIAssessmentReport_H
