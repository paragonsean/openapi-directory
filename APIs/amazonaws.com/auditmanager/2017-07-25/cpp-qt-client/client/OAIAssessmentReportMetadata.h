...
/*
 * OAIAssessmentReportMetadata.h
 *
 *  The metadata objects that are associated with the specified assessment report. 
 */

#ifndef OAIAssessmentReportMetadata_H
#define OAIAssessmentReportMetadata_H
...
class OAIAssessmentReportMetadata : public OAIObject {
public:
    OAIAssessmentReportMetadata();
    OAIAssessmentReportMetadata(QString json);
    ~OAIAssessmentReportMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssessmentReportMetadata)

#endif // OAIAssessmentReportMetadata_H
