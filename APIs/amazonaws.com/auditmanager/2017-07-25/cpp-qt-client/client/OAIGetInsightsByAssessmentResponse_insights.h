...
/*
 * OAIGetInsightsByAssessmentResponse_insights.h
 *
 * 
 */

#ifndef OAIGetInsightsByAssessmentResponse_insights_H
#define OAIGetInsightsByAssessmentResponse_insights_H
...
class OAIGetInsightsByAssessmentResponse_insights : public OAIObject {
public:
    OAIGetInsightsByAssessmentResponse_insights();
    OAIGetInsightsByAssessmentResponse_insights(QString json);
    ~OAIGetInsightsByAssessmentResponse_insights() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetInsightsByAssessmentResponse_insights)

#endif // OAIGetInsightsByAssessmentResponse_insights_H
