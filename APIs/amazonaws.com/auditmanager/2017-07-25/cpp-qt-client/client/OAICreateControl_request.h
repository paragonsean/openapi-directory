...
/*
 * OAICreateControl_request.h
 *
 * 
 */

#ifndef OAICreateControl_request_H
#define OAICreateControl_request_H
...
namespace OpenAPI {
class OAICreateControlMappingSource;

class OAICreateControl_request : public OAIObject {
public:
    OAICreateControl_request();
    OAICreateControl_request(QString json);
    ~OAICreateControl_request() override;
    ...
    QList<OAICreateControlMappingSource> getControlMappingSources() const;
    void setControlMappingSources(const QList<OAICreateControlMappingSource> &control_mapping_sources);
...
private:
    ...
    QList<OAICreateControlMappingSource> m_control_mapping_sources;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateControl_request)

#endif // OAICreateControl_request_H
