...
/*
 * OAICreateAssessmentFrameworkResponse_framework.h
 *
 * 
 */

#ifndef OAICreateAssessmentFrameworkResponse_framework_H
#define OAICreateAssessmentFrameworkResponse_framework_H
...
class OAICreateAssessmentFrameworkResponse_framework : public OAIObject {
public:
    OAICreateAssessmentFrameworkResponse_framework();
    OAICreateAssessmentFrameworkResponse_framework(QString json);
    ~OAICreateAssessmentFrameworkResponse_framework() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAssessmentFrameworkResponse_framework)

#endif // OAICreateAssessmentFrameworkResponse_framework_H
