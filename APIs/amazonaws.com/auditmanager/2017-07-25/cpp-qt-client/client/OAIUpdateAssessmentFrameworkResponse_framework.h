...
/*
 * OAIUpdateAssessmentFrameworkResponse_framework.h
 *
 * 
 */

#ifndef OAIUpdateAssessmentFrameworkResponse_framework_H
#define OAIUpdateAssessmentFrameworkResponse_framework_H
...
class OAIUpdateAssessmentFrameworkResponse_framework : public OAIObject {
public:
    OAIUpdateAssessmentFrameworkResponse_framework();
    OAIUpdateAssessmentFrameworkResponse_framework(QString json);
    ~OAIUpdateAssessmentFrameworkResponse_framework() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAssessmentFrameworkResponse_framework)

#endif // OAIUpdateAssessmentFrameworkResponse_framework_H
