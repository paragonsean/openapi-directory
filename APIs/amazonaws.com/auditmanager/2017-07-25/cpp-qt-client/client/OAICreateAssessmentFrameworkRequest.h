...
/*
 * OAICreateAssessmentFrameworkRequest.h
 *
 * 
 */

#ifndef OAICreateAssessmentFrameworkRequest_H
#define OAICreateAssessmentFrameworkRequest_H
...
class OAICreateAssessmentFrameworkRequest : public OAIObject {
public:
    OAICreateAssessmentFrameworkRequest();
    OAICreateAssessmentFrameworkRequest(QString json);
    ~OAICreateAssessmentFrameworkRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAssessmentFrameworkRequest)

#endif // OAICreateAssessmentFrameworkRequest_H
