...
OAIAssessment OAIGetAssessmentResponse::getAssessment() const {
    return m_assessment;
}
void OAIGetAssessmentResponse::setAssessment(const OAIAssessment &assessment) {
    m_assessment = assessment;
    m_assessment_isSet = true;
}

bool OAIGetAssessmentResponse::is_assessment_Set() const{
    return m_assessment_isSet;
}

bool OAIGetAssessmentResponse::is_assessment_Valid() const{
    return m_assessment_isValid;
}

OAIRole OAIGetAssessmentResponse::getUserRole() const {
    return m_user_role;
}
void OAIGetAssessmentResponse::setUserRole(const OAIRole &user_role) {
    m_user_role = user_role;
    m_user_role_isSet = true;
}

bool OAIGetAssessmentResponse::is_user_role_Set() const{
    return m_user_role_isSet;
}

bool OAIGetAssessmentResponse::is_user_role_Valid() const{
