...
QString OAIFramework::getArn() const {
    return m_arn;
}
void OAIFramework::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIFramework::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIFramework::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIFramework::getId() const {
    return m_id;
}
void OAIFramework::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIFramework::is_id_Set() const{
    return m_id_isSet;
}

bool OAIFramework::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIFramework::getName() const {
    return m_name;
}
void OAIFramework::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIFramework::is_name_Set() const{
    return m_name_isSet;
}

bool OAIFramework::is_name_Valid() const{
    return m_name_isValid;
}

OAIFrameworkType OAIFramework::getType() const {
    return m_type;
}
void OAIFramework::setType(const OAIFrameworkType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIFramework::is_type_Set() const{
    return m_type_isSet;
}

bool OAIFramework::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIFramework::getComplianceType() const {
    return m_compliance_type;
}
void OAIFramework::setComplianceType(const QString &compliance_type) {
    m_compliance_type = compliance_type;
    m_compliance_type_isSet = true;
}

bool OAIFramework::is_compliance_type_Set() const{
    return m_compliance_type_isSet;
}

bool OAIFramework::is_compliance_type_Valid() const{
    return m_compliance_type_isValid;
}

QString OAIFramework::getDescription() const {
    return m_description;
}
void OAIFramework::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIFramework::is_description_Set() const{
    return m_description_isSet;
}

bool OAIFramework::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIFramework::getLogo() const {
    return m_logo;
}
void OAIFramework::setLogo(const QString &logo) {
    m_logo = logo;
    m_logo_isSet = true;
}

bool OAIFramework::is_logo_Set() const{
    return m_logo_isSet;
}

bool OAIFramework::is_logo_Valid() const{
    return m_logo_isValid;
}

QString OAIFramework::getControlSources() const {
    return m_control_sources;
}
void OAIFramework::setControlSources(const QString &control_sources) {
    m_control_sources = control_sources;
    m_control_sources_isSet = true;
}

bool OAIFramework::is_control_sources_Set() const{
    return m_control_sources_isSet;
}

bool OAIFramework::is_control_sources_Valid() const{
    return m_control_sources_isValid;
}

QList OAIFramework::getControlSets() const {
    return m_control_sets;
}
void OAIFramework::setControlSets(const QList &control_sets) {
    m_control_sets = control_sets;
    m_control_sets_isSet = true;
}

bool OAIFramework::is_control_sets_Set() const{
    return m_control_sets_isSet;
}

bool OAIFramework::is_control_sets_Valid() const{
    return m_control_sets_isValid;
}

QDateTime OAIFramework::getCreatedAt() const {
    return m_created_at;
}
void OAIFramework::setCreatedAt(const QDateTime &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIFramework::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIFramework::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QDateTime OAIFramework::getLastUpdatedAt() const {
    return m_last_updated_at;
}
void OAIFramework::setLastUpdatedAt(const QDateTime &last_updated_at) {
    m_last_updated_at = last_updated_at;
    m_last_updated_at_isSet = true;
}

bool OAIFramework::is_last_updated_at_Set() const{
    return m_last_updated_at_isSet;
}

bool OAIFramework::is_last_updated_at_Valid() const{
    return m_last_updated_at_isValid;
}

QString OAIFramework::getCreatedBy() const {
    return m_created_by;
}
void OAIFramework::setCreatedBy(const QString &created_by) {
    m_created_by = created_by;
    m_created_by_isSet = true;
}

bool OAIFramework::is_created_by_Set() const{
    return m_created_by_isSet;
}

bool OAIFramework::is_created_by_Valid() const{
    return m_created_by_isValid;
}

QString OAIFramework::getLastUpdatedBy() const {
    return m_last_updated_by;
}
void OAIFramework::setLastUpdatedBy(const QString &last_updated_by) {
    m_last_updated_by = last_updated_by;
    m_last_updated_by_isSet = true;
}

bool OAIFramework::is_last_updated_by_Set() const{
    return m_last_updated_by_isSet;
}

bool OAIFramework::is_last_updated_by_Valid() const{
    return m_last_updated_by_isValid;
}

QMap OAIFramework::getTags() const {
    return m_tags;
}
void OAIFramework::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIFramework::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIFramework::is_tags_Valid() const{
