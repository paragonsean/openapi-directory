...
#include "OAIUpdateSettingsResponse_settings.h"
...
OAIUpdateSettingsResponse_settings::OAIUpdateSettingsResponse_settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSettingsResponse_settings::OAIUpdateSettingsResponse_settings() {
    this->initializeModel();
}

OAIUpdateSettingsResponse_settings::~OAIUpdateSettingsResponse_settings() {}

void OAIUpdateSettingsResponse_settings::initializeModel() {
...
void OAIUpdateSettingsResponse_settings::fromJson(QString jsonString) {
...
void OAIUpdateSettingsResponse_settings::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSettingsResponse_settings::asJson() const {
...
QJsonObject OAIUpdateSettingsResponse_settings::asJsonObject() const {
    QJsonObject obj;
...
bool OAIUpdateSettingsResponse_settings::getIsAwsOrgEnabled() const {
    return m_is_aws_org_enabled;
}
void OAIUpdateSettingsResponse_settings::setIsAwsOrgEnabled(const bool &is_aws_org_enabled) {
    m_is_aws_org_enabled = is_aws_org_enabled;
    m_is_aws_org_enabled_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_is_aws_org_enabled_Set() const{
    return m_is_aws_org_enabled_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_is_aws_org_enabled_Valid() const{
    return m_is_aws_org_enabled_isValid;
}

QString OAIUpdateSettingsResponse_settings::getSnsTopic() const {
    return m_sns_topic;
}
void OAIUpdateSettingsResponse_settings::setSnsTopic(const QString &sns_topic) {
    m_sns_topic = sns_topic;
    m_sns_topic_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_sns_topic_Set() const{
    return m_sns_topic_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_sns_topic_Valid() const{
    return m_sns_topic_isValid;
}

OAISettings_defaultAssessmentReportsDestination OAIUpdateSettingsResponse_settings::getDefaultAssessmentReportsDestination() const {
    return m_default_assessment_reports_destination;
}
void OAIUpdateSettingsResponse_settings::setDefaultAssessmentReportsDestination(const OAISettings_defaultAssessmentReportsDestination &default_assessment_reports_destination) {
...
bool OAIUpdateSettingsResponse_settings::is_default_assessment_reports_destination_Set() const{
    return m_default_assessment_reports_destination_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_default_assessment_reports_destination_Valid() const{
    return m_default_assessment_reports_destination_isValid;
}

QList OAIUpdateSettingsResponse_settings::getDefaultProcessOwners() const {
    return m_default_process_owners;
}
void OAIUpdateSettingsResponse_settings::setDefaultProcessOwners(const QList &default_process_owners) {
    m_default_process_owners = default_process_owners;
    m_default_process_owners_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_default_process_owners_Set() const{
    return m_default_process_owners_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_default_process_owners_Valid() const{
    return m_default_process_owners_isValid;
}

QString OAIUpdateSettingsResponse_settings::getKmsKey() const {
    return m_kms_key;
}
void OAIUpdateSettingsResponse_settings::setKmsKey(const QString &kms_key) {
    m_kms_key = kms_key;
    m_kms_key_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_kms_key_Set() const{
    return m_kms_key_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_kms_key_Valid() const{
    return m_kms_key_isValid;
}

OAISettings_evidenceFinderEnablement OAIUpdateSettingsResponse_settings::getEvidenceFinderEnablement() const {
    return m_evidence_finder_enablement;
}
void OAIUpdateSettingsResponse_settings::setEvidenceFinderEnablement(const OAISettings_evidenceFinderEnablement &evidence_finder_enablement) {
    m_evidence_finder_enablement = evidence_finder_enablement;
    m_evidence_finder_enablement_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_evidence_finder_enablement_Set() const{
    return m_evidence_finder_enablement_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_evidence_finder_enablement_Valid() const{
    return m_evidence_finder_enablement_isValid;
}

OAISettings_deregistrationPolicy OAIUpdateSettingsResponse_settings::getDeregistrationPolicy() const {
    return m_deregistration_policy;
}
void OAIUpdateSettingsResponse_settings::setDeregistrationPolicy(const OAISettings_deregistrationPolicy &deregistration_policy) {
    m_deregistration_policy = deregistration_policy;
    m_deregistration_policy_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_deregistration_policy_Set() const{
    return m_deregistration_policy_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_deregistration_policy_Valid() const{
    return m_deregistration_policy_isValid;
}

OAISettings_defaultExportDestination OAIUpdateSettingsResponse_settings::getDefaultExportDestination() const {
    return m_default_export_destination;
}
void OAIUpdateSettingsResponse_settings::setDefaultExportDestination(const OAISettings_defaultExportDestination &default_export_destination) {
    m_default_export_destination = default_export_destination;
    m_default_export_destination_isSet = true;
}

bool OAIUpdateSettingsResponse_settings::is_default_export_destination_Set() const{
    return m_default_export_destination_isSet;
}

bool OAIUpdateSettingsResponse_settings::is_default_export_destination_Valid() const{
    return m_default_export_destination_isValid;
}

bool OAIUpdateSettingsResponse_settings::isSet() const {
...
bool OAIUpdateSettingsResponse_settings::isValid() const {
