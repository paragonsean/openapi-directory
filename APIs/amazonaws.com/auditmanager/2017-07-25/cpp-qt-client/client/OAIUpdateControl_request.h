...
/*
 * OAIUpdateControl_request.h
 *
 * 
 */

#ifndef OAIUpdateControl_request_H
#define OAIUpdateControl_request_H
...
namespace OpenAPI {
class OAIControlMappingSource;

class OAIUpdateControl_request : public OAIObject {
public:
    OAIUpdateControl_request();
    OAIUpdateControl_request(QString json);
    ~OAIUpdateControl_request() override;
    ...
    QList<OAIControlMappingSource> getControlMappingSources() const;
    void setControlMappingSources(const QList<OAIControlMappingSource> &control_mapping_sources);
...
private:
    ...
    QList<OAIControlMappingSource> m_control_mapping_sources;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateControl_request)

#endif // OAIUpdateControl_request_H
