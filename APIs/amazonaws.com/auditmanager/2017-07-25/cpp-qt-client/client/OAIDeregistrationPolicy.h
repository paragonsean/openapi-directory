...
#ifndef OAIDeregistrationPolicy_H
#define OAIDeregistrationPolicy_H
...
class OAIDeregistrationPolicy : public OAIObject {
public:
    OAIDeregistrationPolicy();
    OAIDeregistrationPolicy(QString json);
    ~OAIDeregistrationPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeregistrationPolicy)

#endif // OAIDeregistrationPolicy_H
