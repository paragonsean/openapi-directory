...
/*
 * OAIStartAssessmentFrameworkShare_request.h
 *
 * 
 */

#ifndef OAIStartAssessmentFrameworkShare_request_H
#define OAIStartAssessmentFrameworkShare_request_H
...
class OAIStartAssessmentFrameworkShare_request : public OAIObject {
public:
    OAIStartAssessmentFrameworkShare_request();
    OAIStartAssessmentFrameworkShare_request(QString json);
    ~OAIStartAssessmentFrameworkShare_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartAssessmentFrameworkShare_request)

#endif // OAIStartAssessmentFrameworkShare_request_H
