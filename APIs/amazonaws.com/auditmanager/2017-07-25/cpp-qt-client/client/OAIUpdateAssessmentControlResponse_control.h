...
/*
 * OAIUpdateAssessmentControlResponse_control.h
 *
 * 
 */

#ifndef OAIUpdateAssessmentControlResponse_control_H
#define OAIUpdateAssessmentControlResponse_control_H
...
class OAIUpdateAssessmentControlResponse_control : public OAIObject {
public:
    OAIUpdateAssessmentControlResponse_control();
    OAIUpdateAssessmentControlResponse_control(QString json);
    ~OAIUpdateAssessmentControlResponse_control() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateAssessmentControlResponse_control)

#endif // OAIUpdateAssessmentControlResponse_control_H
