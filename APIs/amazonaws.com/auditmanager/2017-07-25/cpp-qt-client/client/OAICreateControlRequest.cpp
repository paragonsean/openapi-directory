...
#include "OAICreateControlRequest.h"
...
OAICreateControlRequest::OAICreateControlRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateControlRequest::OAICreateControlRequest() {
    this->initializeModel();
}

OAICreateControlRequest::~OAICreateControlRequest() {}

void OAICreateControlRequest::initializeModel() {
...
void OAICreateControlRequest::fromJson(QString jsonString) {
...
void OAICreateControlRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateControlRequest::asJson() const {
...
QJsonObject OAICreateControlRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAICreateControlRequest::getName() const {
    return m_name;
}
void OAICreateControlRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateControlRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateControlRequest::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateControlRequest::getDescription() const {
    return m_description;
}
void OAICreateControlRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateControlRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateControlRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateControlRequest::getTestingInformation() const {
    return m_testing_information;
}
void OAICreateControlRequest::setTestingInformation(const QString &testing_information) {
    m_testing_information = testing_information;
    m_testing_information_isSet = true;
}

bool OAICreateControlRequest::is_testing_information_Set() const{
    return m_testing_information_isSet;
}

bool OAICreateControlRequest::is_testing_information_Valid() const{
    return m_testing_information_isValid;
}

QString OAICreateControlRequest::getActionPlanTitle() const {
    return m_action_plan_title;
}
void OAICreateControlRequest::setActionPlanTitle(const QString &action_plan_title) {
    m_action_plan_title = action_plan_title;
    m_action_plan_title_isSet = true;
}

bool OAICreateControlRequest::is_action_plan_title_Set() const{
    return m_action_plan_title_isSet;
}

bool OAICreateControlRequest::is_action_plan_title_Valid() const{
    return m_action_plan_title_isValid;
}

QString OAICreateControlRequest::getActionPlanInstructions() const {
    return m_action_plan_instructions;
}
void OAICreateControlRequest::setActionPlanInstructions(const QString &action_plan_instructions) {
    m_action_plan_instructions = action_plan_instructions;
    m_action_plan_instructions_isSet = true;
}

bool OAICreateControlRequest::is_action_plan_instructions_Set() const{
    return m_action_plan_instructions_isSet;
}

bool OAICreateControlRequest::is_action_plan_instructions_Valid() const{
    return m_action_plan_instructions_isValid;
}

QList OAICreateControlRequest::getControlMappingSources() const {
    return m_control_mapping_sources;
}
void OAICreateControlRequest::setControlMappingSources(const QList &control_mapping_sources) {
    m_control_mapping_sources = control_mapping_sources;
    m_control_mapping_sources_isSet = true;
}

bool OAICreateControlRequest::is_control_mapping_sources_Set() const{
    return m_control_mapping_sources_isSet;
}

bool OAICreateControlRequest::is_control_mapping_sources_Valid() const{
    return m_control_mapping_sources_isValid;
}

QMap OAICreateControlRequest::getTags() const {
    return m_tags;
}
void OAICreateControlRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateControlRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateControlRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateControlRequest::isSet() const {
...
bool OAICreateControlRequest::isValid() const {
