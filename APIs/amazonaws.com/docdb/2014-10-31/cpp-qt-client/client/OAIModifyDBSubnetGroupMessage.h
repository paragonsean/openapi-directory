...
/*
 * OAIModifyDBSubnetGroupMessage.h
 *
 * Represents the input to &lt;a&gt;ModifyDBSubnetGroup&lt;/a&gt;.
 */

#ifndef OAIModifyDBSubnetGroupMessage_H
#define OAIModifyDBSubnetGroupMessage_H
...
class OAIModifyDBSubnetGroupMessage : public OAIObject {
public:
    OAIModifyDBSubnetGroupMessage();
    OAIModifyDBSubnetGroupMessage(QString json);
    ~OAIModifyDBSubnetGroupMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyDBSubnetGroupMessage)

#endif // OAIModifyDBSubnetGroupMessage_H
