...
#ifndef OAIDBCluster_H
#define OAIDBCluster_H
...
class OAIDBCluster : public OAIObject {
public:
    OAIDBCluster();
    OAIDBCluster(QString json);
    ~OAIDBCluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDBCluster)

#endif // OAIDBCluster_H
