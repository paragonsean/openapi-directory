...
/*
 * OAIDescribeDBSubnetGroupsMessage.h
 *
 * Represents the input to &lt;a&gt;DescribeDBSubnetGroups&lt;/a&gt;.
 */

#ifndef OAIDescribeDBSubnetGroupsMessage_H
#define OAIDescribeDBSubnetGroupsMessage_H
...
class OAIDescribeDBSubnetGroupsMessage : public OAIObject {
public:
    OAIDescribeDBSubnetGroupsMessage();
    OAIDescribeDBSubnetGroupsMessage(QString json);
    ~OAIDescribeDBSubnetGroupsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDBSubnetGroupsMessage)

#endif // OAIDescribeDBSubnetGroupsMessage_H
