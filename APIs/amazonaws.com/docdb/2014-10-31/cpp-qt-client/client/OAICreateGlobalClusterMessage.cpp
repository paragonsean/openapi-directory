...
QString OAICreateGlobalClusterMessage::getDatabaseName() const {
    return m_database_name;
}
void OAICreateGlobalClusterMessage::setDatabaseName(const QString &database_name) {
    m_database_name = database_name;
    m_database_name_isSet = true;
}

bool OAICreateGlobalClusterMessage::is_database_name_Set() const{
    return m_database_name_isSet;
}

bool OAICreateGlobalClusterMessage::is_database_name_Valid() const{
