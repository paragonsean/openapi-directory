...
/*
 * OAIDescribeDBClustersMessage.h
 *
 * Represents the input to &lt;a&gt;DescribeDBClusters&lt;/a&gt;.
 */

#ifndef OAIDescribeDBClustersMessage_H
#define OAIDescribeDBClustersMessage_H
...
class OAIDescribeDBClustersMessage : public OAIObject {
public:
    OAIDescribeDBClustersMessage();
    OAIDescribeDBClustersMessage(QString json);
    ~OAIDescribeDBClustersMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDBClustersMessage)

#endif // OAIDescribeDBClustersMessage_H
