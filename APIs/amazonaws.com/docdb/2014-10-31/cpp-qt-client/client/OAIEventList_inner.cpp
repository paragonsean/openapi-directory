...
QString OAIEventList_inner::getSourceArn() const {
    return m_source_arn;
}
void OAIEventList_inner::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIEventList_inner::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIEventList_inner::is_source_arn_Valid() const{
