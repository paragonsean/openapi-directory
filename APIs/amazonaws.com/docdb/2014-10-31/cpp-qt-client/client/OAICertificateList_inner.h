...
/*
 * OAICertificateList_inner.h
 *
 * 
 */

#ifndef OAICertificateList_inner_H
#define OAICertificateList_inner_H
...
class OAICertificateList_inner : public OAIObject {
public:
    OAICertificateList_inner();
    OAICertificateList_inner(QString json);
    ~OAICertificateList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateList_inner)

#endif // OAICertificateList_inner_H
