...
OAIPendingModifiedValues_PendingCloudwatchLogsExports OAIDBInstance_PendingModifiedValues::getPendingCloudwatchLogsExports() const {
    return m_pending_cloudwatch_logs_exports;
}
void OAIDBInstance_PendingModifiedValues::setPendingCloudwatchLogsExports(const OAIPendingModifiedValues_PendingCloudwatchLogsExports &pending_cloudwatch_logs_exports) {
