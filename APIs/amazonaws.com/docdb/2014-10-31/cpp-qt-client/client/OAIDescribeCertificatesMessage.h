...
/*
 * OAIDescribeCertificatesMessage.h
 *
 * 
 */

#ifndef OAIDescribeCertificatesMessage_H
#define OAIDescribeCertificatesMessage_H
...
class OAIDescribeCertificatesMessage : public OAIObject {
public:
    OAIDescribeCertificatesMessage();
    OAIDescribeCertificatesMessage(QString json);
    ~OAIDescribeCertificatesMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCertificatesMessage)

#endif // OAIDescribeCertificatesMessage_H
