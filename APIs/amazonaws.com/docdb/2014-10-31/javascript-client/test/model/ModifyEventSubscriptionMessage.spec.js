...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.ModifyEventSubscriptionMessage();
  });
  ...
  describe('ModifyEventSubscriptionMessage', function() {
    it('should create an instance of ModifyEventSubscriptionMessage', function() {
      // uncomment below and update the code to test ModifyEventSubscriptionMessage
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.ModifyEventSubscriptionMessage();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.ModifyEventSubscriptionMessage);
    });
