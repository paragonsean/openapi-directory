...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.DBClusterListInner();
  });
  ...
  describe('DBClusterListInner', function() {
    it('should create an instance of DBClusterListInner', function() {
      // uncomment below and update the code to test DBClusterListInner
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.DBClusterListInner();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.DBClusterListInner);
    });
