...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.OrderableDBInstanceOptionsListInner();
  });
  ...
  describe('OrderableDBInstanceOptionsListInner', function() {
    it('should create an instance of OrderableDBInstanceOptionsListInner', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.OrderableDBInstanceOptionsListInner();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.OrderableDBInstanceOptionsListInner);
    });
