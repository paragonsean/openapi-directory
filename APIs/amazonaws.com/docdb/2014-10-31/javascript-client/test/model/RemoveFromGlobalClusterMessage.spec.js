...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.RemoveFromGlobalClusterMessage();
  });
  ...
  describe('RemoveFromGlobalClusterMessage', function() {
    it('should create an instance of RemoveFromGlobalClusterMessage', function() {
      // uncomment below and update the code to test RemoveFromGlobalClusterMessage
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.RemoveFromGlobalClusterMessage();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.RemoveFromGlobalClusterMessage);
    });
