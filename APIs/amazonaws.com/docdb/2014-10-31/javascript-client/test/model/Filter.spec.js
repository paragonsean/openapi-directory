...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.Filter();
  });
  ...
  describe('Filter', function() {
    it('should create an instance of Filter', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.Filter();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.Filter);
    });
