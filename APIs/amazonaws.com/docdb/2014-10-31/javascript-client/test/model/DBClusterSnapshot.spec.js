...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.DBClusterSnapshot();
  });
  ...
  describe('DBClusterSnapshot', function() {
    it('should create an instance of DBClusterSnapshot', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.DBClusterSnapshot();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.DBClusterSnapshot);
    });
