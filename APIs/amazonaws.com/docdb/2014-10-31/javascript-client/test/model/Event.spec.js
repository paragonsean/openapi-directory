...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.Event();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.Event);
    });
