...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.DBInstanceListInner();
  });
  ...
  describe('DBInstanceListInner', function() {
    it('should create an instance of DBInstanceListInner', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.DBInstanceListInner();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.DBInstanceListInner);
    });
