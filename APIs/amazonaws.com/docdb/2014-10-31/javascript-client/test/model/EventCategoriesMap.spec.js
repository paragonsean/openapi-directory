...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.EventCategoriesMap();
  });
  ...
  describe('EventCategoriesMap', function() {
    it('should create an instance of EventCategoriesMap', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.EventCategoriesMap();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.EventCategoriesMap);
    });
