...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.DescribeOrderableDBInstanceOptionsMessage();
  });
  ...
  describe('DescribeOrderableDBInstanceOptionsMessage', function() {
    it('should create an instance of DescribeOrderableDBInstanceOptionsMessage', function() {
      // uncomment below and update the code to test DescribeOrderableDBInstanceOptionsMessage
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.DescribeOrderableDBInstanceOptionsMessage();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.DescribeOrderableDBInstanceOptionsMessage);
    });
