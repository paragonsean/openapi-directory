...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.DBInstancePendingModifiedValues();
  });
  ...
  describe('DBInstancePendingModifiedValues', function() {
    it('should create an instance of DBInstancePendingModifiedValues', function() {
      // uncomment below and update the code to test DBInstancePendingModifiedValues
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.DBInstancePendingModifiedValues();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.DBInstancePendingModifiedValues);
    });
