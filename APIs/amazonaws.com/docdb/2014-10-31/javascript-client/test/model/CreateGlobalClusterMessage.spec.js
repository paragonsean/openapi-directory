...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.CreateGlobalClusterMessage();
  });
  ...
  describe('CreateGlobalClusterMessage', function() {
    it('should create an instance of CreateGlobalClusterMessage', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.CreateGlobalClusterMessage();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.CreateGlobalClusterMessage);
    });
