...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.Tag();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.Tag);
    });
