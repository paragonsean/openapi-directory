...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.CreateDBClusterSnapshotMessage();
  });
  ...
  describe('CreateDBClusterSnapshotMessage', function() {
    it('should create an instance of CreateDBClusterSnapshotMessage', function() {
      // uncomment below and update the code to test CreateDBClusterSnapshotMessage
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.CreateDBClusterSnapshotMessage();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.CreateDBClusterSnapshotMessage);
    });
