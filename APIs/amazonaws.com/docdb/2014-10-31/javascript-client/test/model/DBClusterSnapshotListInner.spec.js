...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.DBClusterSnapshotListInner();
  });
  ...
  describe('DBClusterSnapshotListInner', function() {
    it('should create an instance of DBClusterSnapshotListInner', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.DBClusterSnapshotListInner();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.DBClusterSnapshotListInner);
    });
