...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonDocumentDbWithMongoDbCompatibility.OrderableDBInstanceOption();
  });
  ...
  describe('OrderableDBInstanceOption', function() {
    it('should create an instance of OrderableDBInstanceOption', function() {
      ...
      //var instance = new AmazonDocumentDbWithMongoDbCompatibility.OrderableDBInstanceOption();
      //expect(instance).to.be.a(AmazonDocumentDbWithMongoDbCompatibility.OrderableDBInstanceOption);
    });
