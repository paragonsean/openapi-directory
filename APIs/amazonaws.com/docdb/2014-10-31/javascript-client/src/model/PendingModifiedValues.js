...
import PendingModifiedValuesPendingCloudwatchLogsExports from './PendingModifiedValuesPendingCloudwatchLogsExports';

/**
 * The PendingModifiedValues model module.
 * @module model/PendingModifiedValues
 * @version 2014-10-31
 */
class PendingModifiedValues {
    /**
     * Constructs a new <code>PendingModifiedValues</code>.
     *  One or more modified settings for an instance. These modified settings have been requested, but haven&#39;t been applied yet.
     * @alias module:model/PendingModifiedValues
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>PendingModifiedValues</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PendingModifiedValues} obj Optional instance to populate.
     * @return {module:model/PendingModifiedValues} The populated <code>PendingModifiedValues</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PendingModifiedValues();
            ...
            if (data.hasOwnProperty('PendingCloudwatchLogsExports')) {
                obj['PendingCloudwatchLogsExports'] = PendingModifiedValuesPendingCloudwatchLogsExports.constructFromObject(data['PendingCloudwatchLogsExports']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PendingModifiedValues</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PendingModifiedValues</code>.
     */
    static validateJSON(data) {
        ...
        if (data['PendingCloudwatchLogsExports']) { // data not null
          PendingModifiedValuesPendingCloudwatchLogsExports.validateJSON(data['PendingCloudwatchLogsExports']);
        }
...
/**
 * @member {module:model/PendingModifiedValuesPendingCloudwatchLogsExports} PendingCloudwatchLogsExports
 */
...
export default PendingModifiedValues;
