...
/**
 * The DBInstance model module.
 * @module model/DBInstance
 * @version 2014-10-31
 */
class DBInstance {
    /**
     * Constructs a new <code>DBInstance</code>.
     * Detailed information about an instance. 
     * @alias module:model/DBInstance
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>DBInstance</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DBInstance} obj Optional instance to populate.
     * @return {module:model/DBInstance} The populated <code>DBInstance</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DBInstance();
    ...
    /**
     * Validates the JSON data with respect to <code>DBInstance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DBInstance</code>.
     */
