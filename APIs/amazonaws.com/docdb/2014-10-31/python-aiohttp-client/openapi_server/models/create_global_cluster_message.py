...
class CreateGlobalClusterMessage(Model):
    ...
    def __init__(self, global_cluster_identifier: str=None, source_db_cluster_identifier: str=None, engine: str=None, engine_version: str=None, deletion_protection: bool=None, database_name: str=None, storage_encrypted: bool=None):
        ...
        :param database_name: The database_name of this CreateGlobalClusterMessage.
    ...
    def database_name(self):
        """Gets the database_name of this CreateGlobalClusterMessage.


        :return: The database_name of this CreateGlobalClusterMessage.
        :rtype: str
        """
    ...
    def database_name(self, database_name):
        """Sets the database_name of this CreateGlobalClusterMessage.
