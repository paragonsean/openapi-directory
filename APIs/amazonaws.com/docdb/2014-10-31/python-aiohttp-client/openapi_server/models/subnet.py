...
class Subnet(Model):
    ...
    def __init__(self, subnet_identifier: str=None, subnet_availability_zone: SubnetSubnetAvailabilityZone=None, subnet_status: str=None):
        ...
        :param subnet_identifier: The subnet_identifier of this Subnet.
        :param subnet_availability_zone: The subnet_availability_zone of this Subnet.
        :param subnet_status: The subnet_status of this Subnet.
        """
        self.openapi_types = {
    ...
    def subnet_identifier(self):
        """Gets the subnet_identifier of this Subnet.


        :return: The subnet_identifier of this Subnet.
        :rtype: str
        """
    ...
    def subnet_identifier(self, subnet_identifier):
        """Sets the subnet_identifier of this Subnet.
    ...
    def subnet_availability_zone(self):
        """Gets the subnet_availability_zone of this Subnet.


        :return: The subnet_availability_zone of this Subnet.
    ...
    def subnet_availability_zone(self, subnet_availability_zone):
        """Sets the subnet_availability_zone of this Subnet.
    ...
    def subnet_status(self):
        """Gets the subnet_status of this Subnet.


        :return: The subnet_status of this Subnet.
        :rtype: str
        """
