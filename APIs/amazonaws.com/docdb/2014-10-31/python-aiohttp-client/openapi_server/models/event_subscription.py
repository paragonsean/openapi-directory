...
class EventSubscription(Model):
    ...
    def __init__(self, customer_aws_id: str=None, cust_subscription_id: str=None, sns_topic_arn: str=None, status: str=None, subscription_creation_time: str=None, source_type: str=None, source_ids_list: List=None, event_categories_list: List=None, enabled: bool=None, event_subscription_arn: str=None):
        ...
        :param event_subscription_arn: The event_subscription_arn of this EventSubscription.
        """
        self.openapi_types = {
            'customer_aws_id': str,
    ...
    def event_subscription_arn(self):
        """Gets the event_subscription_arn of this EventSubscription.


        :return: The event_subscription_arn of this EventSubscription.
        :rtype: str
        """
    ...
    def event_subscription_arn(self, event_subscription_arn):
        """Sets the event_subscription_arn of this EventSubscription.
