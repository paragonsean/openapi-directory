...
class DBCluster(Model):
    ...
    def __init__(self, availability_zones: List=None, backup_retention_period: int=None, db_cluster_identifier: str=None, db_cluster_parameter_group: str=None, db_subnet_group: str=None, status: str=None, percent_progress: str=None, earliest_restorable_time: datetime=None, endpoint: str=None, reader_endpoint: str=None, multi_az: bool=None, engine: str=None, engine_version: str=None, latest_restorable_time: datetime=None, port: int=None, master_username: str=None, preferred_backup_window: str=None, preferred_maintenance_window: str=None, replication_source_identifier: str=None, read_replica_identifiers: List=None, db_cluster_members: List=None, vpc_security_groups: List=None, hosted_zone_id: str=None, storage_encrypted: bool=None, kms_key_id: str=None, db_cluster_resource_id: str=None, db_cluster_arn: str=None, associated_roles: List=None, clone_group_id: str=None, cluster_create_time: datetime=None, enabled_cloudwatch_logs_exports: List=None, deletion_protection: bool=None):
