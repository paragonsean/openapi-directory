...
public class DBClusterSnapshot {
  ...
  public DBClusterSnapshot availabilityZones(List availabilityZones) {
  ...
  public DBClusterSnapshot dbClusterSnapshotIdentifier(String dbClusterSnapshotIdentifier) {
  ...
  public DBClusterSnapshot dbClusterIdentifier(String dbClusterIdentifier) {
  ...
  public DBClusterSnapshot snapshotCreateTime(OffsetDateTime snapshotCreateTime) {
  ...
  public DBClusterSnapshot engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public DBClusterSnapshot status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DBClusterSnapshot port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public DBClusterSnapshot vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public DBClusterSnapshot clusterCreateTime(OffsetDateTime clusterCreateTime) {
  ...
  public DBClusterSnapshot masterUsername(String masterUsername) {
  ...
  public DBClusterSnapshot engineVersion(String engineVersion) {
  ...
  public DBClusterSnapshot snapshotType(String snapshotType) {
  ...
  public DBClusterSnapshot percentProgress(Integer percentProgress) {
  ...
  public DBClusterSnapshot storageEncrypted(Boolean storageEncrypted) {
  ...
  public DBClusterSnapshot kmsKeyId(String kmsKeyId) {
  ...
  public DBClusterSnapshot dbClusterSnapshotArn(String dbClusterSnapshotArn) {
  ...
  public DBClusterSnapshot sourceDBClusterSnapshotArn(String sourceDBClusterSnapshotArn) {
