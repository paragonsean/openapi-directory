...
public class DBEngineVersion {
  ...
  public DBEngineVersion engine(String engine) {
    this.engine = engine;
    return this;
  }
  ...
  public DBEngineVersion engineVersion(String engineVersion) {
  ...
  public DBEngineVersion dbParameterGroupFamily(String dbParameterGroupFamily) {
  ...
  public DBEngineVersion dbEngineDescription(String dbEngineDescription) {
  ...
  public DBEngineVersion dbEngineVersionDescription(String dbEngineVersionDescription) {
  ...
  public DBEngineVersion validUpgradeTarget(List validUpgradeTarget) {
  ...
  public DBEngineVersion exportableLogTypes(List exportableLogTypes) {
  ...
  public DBEngineVersion supportsLogExportsToCloudwatchLogs(Boolean supportsLogExportsToCloudwatchLogs) {
