...
import org.openapitools.client.model.PendingModifiedValuesPendingCloudwatchLogsExports;
...
public class DBInstancePendingModifiedValues {
  ...
  private PendingModifiedValuesPendingCloudwatchLogsExports pendingCloudwatchLogsExports;

  public DBInstancePendingModifiedValues() {
  }

  public DBInstancePendingModifiedValues dbInstanceClass(String dbInstanceClass) {
  ...
  public DBInstancePendingModifiedValues allocatedStorage(Integer allocatedStorage) {
  ...
  public DBInstancePendingModifiedValues masterUserPassword(String masterUserPassword) {
  ...
  public DBInstancePendingModifiedValues port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public DBInstancePendingModifiedValues backupRetentionPeriod(Integer backupRetentionPeriod) {
  ...
  public DBInstancePendingModifiedValues multiAZ(Boolean multiAZ) {
  ...
  public DBInstancePendingModifiedValues engineVersion(String engineVersion) {
  ...
  public DBInstancePendingModifiedValues licenseModel(String licenseModel) {
  ...
  public DBInstancePendingModifiedValues iops(Integer iops) {
    this.iops = iops;
    return this;
  }
  ...
  public DBInstancePendingModifiedValues dbInstanceIdentifier(String dbInstanceIdentifier) {
  ...
  public DBInstancePendingModifiedValues storageType(String storageType) {
  ...
  public DBInstancePendingModifiedValues caCertificateIdentifier(String caCertificateIdentifier) {
  ...
  public DBInstancePendingModifiedValues dbSubnetGroupName(String dbSubnetGroupName) {
  ...
  public DBInstancePendingModifiedValues pendingCloudwatchLogsExports(PendingModifiedValuesPendingCloudwatchLogsExports pendingCloudwatchLogsExports) {
   ...
   */
  @javax.annotation.Nullable
  public PendingModifiedValuesPendingCloudwatchLogsExports getPendingCloudwatchLogsExports() {
    return pendingCloudwatchLogsExports;
  }

  public void setPendingCloudwatchLogsExports(PendingModifiedValuesPendingCloudwatchLogsExports pendingCloudwatchLogsExports) {
    this.pendingCloudwatchLogsExports = pendingCloudwatchLogsExports;
  }
  ...
  public boolean equals(Object o) {
    ...
    DBInstancePendingModifiedValues dbInstancePendingModifiedValues = (DBInstancePendingModifiedValues) o;
    return Objects.equals(this.dbInstanceClass, dbInstancePendingModifiedValues.dbInstanceClass) &&
        Objects.equals(this.allocatedStorage, dbInstancePendingModifiedValues.allocatedStorage) &&
        Objects.equals(this.masterUserPassword, dbInstancePendingModifiedValues.masterUserPassword) &&
        Objects.equals(this.port, dbInstancePendingModifiedValues.port) &&
        Objects.equals(this.backupRetentionPeriod, dbInstancePendingModifiedValues.backupRetentionPeriod) &&
        Objects.equals(this.multiAZ, dbInstancePendingModifiedValues.multiAZ) &&
        Objects.equals(this.engineVersion, dbInstancePendingModifiedValues.engineVersion) &&
        Objects.equals(this.licenseModel, dbInstancePendingModifiedValues.licenseModel) &&
        Objects.equals(this.iops, dbInstancePendingModifiedValues.iops) &&
        Objects.equals(this.dbInstanceIdentifier, dbInstancePendingModifiedValues.dbInstanceIdentifier) &&
        Objects.equals(this.storageType, dbInstancePendingModifiedValues.storageType) &&
        Objects.equals(this.caCertificateIdentifier, dbInstancePendingModifiedValues.caCertificateIdentifier) &&
        Objects.equals(this.dbSubnetGroupName, dbInstancePendingModifiedValues.dbSubnetGroupName) &&
        Objects.equals(this.pendingCloudwatchLogsExports, dbInstancePendingModifiedValues.pendingCloudwatchLogsExports);
  }
  ...
  public String toString() {
    ...
    sb.append("class DBInstancePendingModifiedValues {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DBInstancePendingModifiedValues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DBInstancePendingModifiedValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DBInstancePendingModifiedValues is not found in the empty JSON string", DBInstancePendingModifiedValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DBInstancePendingModifiedValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DBInstancePendingModifiedValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("PendingCloudwatchLogsExports") != null && !jsonObj.get("PendingCloudwatchLogsExports").isJsonNull()) {
        PendingModifiedValuesPendingCloudwatchLogsExports.validateJsonElement(jsonObj.get("PendingCloudwatchLogsExports"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DBInstancePendingModifiedValues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DBInstancePendingModifiedValues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DBInstancePendingModifiedValues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DBInstancePendingModifiedValues.class));

       return (TypeAdapter<T>) new TypeAdapter<DBInstancePendingModifiedValues>() {
           @Override
           public void write(JsonWriter out, DBInstancePendingModifiedValues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DBInstancePendingModifiedValues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DBInstancePendingModifiedValues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DBInstancePendingModifiedValues
   * @throws IOException if the JSON string is invalid with respect to DBInstancePendingModifiedValues
   */
  public static DBInstancePendingModifiedValues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DBInstancePendingModifiedValues.class);
  }

  /**
   * Convert an instance of DBInstancePendingModifiedValues to an JSON string
   *
   * @return JSON string
   */
