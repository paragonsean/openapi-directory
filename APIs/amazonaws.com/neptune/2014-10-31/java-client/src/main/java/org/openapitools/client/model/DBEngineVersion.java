...
public class DBEngineVersion {
  ...
  public DBEngineVersion defaultCharacterSet(DBEngineVersionDefaultCharacterSet defaultCharacterSet) {
  ...
  public DBEngineVersion supportedCharacterSets(List supportedCharacterSets) {
  ...
  public DBEngineVersion supportedTimezones(List supportedTimezones) {
  ...
  public DBEngineVersion supportsReadReplica(Boolean supportsReadReplica) {
  ...
  public DBEngineVersion supportsGlobalDatabases(Boolean supportsGlobalDatabases) {
