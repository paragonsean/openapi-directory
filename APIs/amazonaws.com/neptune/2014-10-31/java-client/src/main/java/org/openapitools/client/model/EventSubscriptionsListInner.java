...
public class EventSubscriptionsListInner {
  ...
  public EventSubscriptionsListInner() {
  }

  public EventSubscriptionsListInner customerAwsId(String customerAwsId) {
  ...
  public EventSubscriptionsListInner custSubscriptionId(String custSubscriptionId) {
  ...
  public EventSubscriptionsListInner snsTopicArn(String snsTopicArn) {
  ...
  public EventSubscriptionsListInner status(String status) {
    this.status = status;
    return this;
  }
  ...
  public EventSubscriptionsListInner subscriptionCreationTime(String subscriptionCreationTime) {
  ...
  public EventSubscriptionsListInner sourceType(String sourceType) {
  ...
  public EventSubscriptionsListInner sourceIdsList(List sourceIdsList) {
  ...
  public EventSubscriptionsListInner eventCategoriesList(List eventCategoriesList) {
  ...
  public EventSubscriptionsListInner enabled(Boolean enabled) {
  ...
  public EventSubscriptionsListInner eventSubscriptionArn(String eventSubscriptionArn) {
  ...
  public boolean equals(Object o) {
    ...
    EventSubscriptionsListInner eventSubscriptionsListInner = (EventSubscriptionsListInner) o;
    return Objects.equals(this.customerAwsId, eventSubscriptionsListInner.customerAwsId) &&
        Objects.equals(this.custSubscriptionId, eventSubscriptionsListInner.custSubscriptionId) &&
        Objects.equals(this.snsTopicArn, eventSubscriptionsListInner.snsTopicArn) &&
        Objects.equals(this.status, eventSubscriptionsListInner.status) &&
        Objects.equals(this.subscriptionCreationTime, eventSubscriptionsListInner.subscriptionCreationTime) &&
        Objects.equals(this.sourceType, eventSubscriptionsListInner.sourceType) &&
        Objects.equals(this.sourceIdsList, eventSubscriptionsListInner.sourceIdsList) &&
        Objects.equals(this.eventCategoriesList, eventSubscriptionsListInner.eventCategoriesList) &&
        Objects.equals(this.enabled, eventSubscriptionsListInner.enabled) &&
        Objects.equals(this.eventSubscriptionArn, eventSubscriptionsListInner.eventSubscriptionArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventSubscriptionsListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventSubscriptionsListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventSubscriptionsListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventSubscriptionsListInner is not found in the empty JSON string", EventSubscriptionsListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventSubscriptionsListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventSubscriptionsListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventSubscriptionsListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventSubscriptionsListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventSubscriptionsListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventSubscriptionsListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<EventSubscriptionsListInner>() {
           @Override
           public void write(JsonWriter out, EventSubscriptionsListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventSubscriptionsListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventSubscriptionsListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventSubscriptionsListInner
   * @throws IOException if the JSON string is invalid with respect to EventSubscriptionsListInner
   */
  public static EventSubscriptionsListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventSubscriptionsListInner.class);
  }

  /**
   * Convert an instance of EventSubscriptionsListInner to an JSON string
   *
   * @return JSON string
   */
