...
public class DBInstanceDBSubnetGroup {
  ...
  public DBInstanceDBSubnetGroup() {
  }

  public DBInstanceDBSubnetGroup dbSubnetGroupName(String dbSubnetGroupName) {
  ...
  public DBInstanceDBSubnetGroup dbSubnetGroupDescription(String dbSubnetGroupDescription) {
  ...
  public DBInstanceDBSubnetGroup vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public DBInstanceDBSubnetGroup subnetGroupStatus(String subnetGroupStatus) {
  ...
  public DBInstanceDBSubnetGroup subnets(List subnets) {
  ...
  public DBInstanceDBSubnetGroup dbSubnetGroupArn(String dbSubnetGroupArn) {
  ...
  public boolean equals(Object o) {
    ...
    DBInstanceDBSubnetGroup dbInstanceDBSubnetGroup = (DBInstanceDBSubnetGroup) o;
    return Objects.equals(this.dbSubnetGroupName, dbInstanceDBSubnetGroup.dbSubnetGroupName) &&
        Objects.equals(this.dbSubnetGroupDescription, dbInstanceDBSubnetGroup.dbSubnetGroupDescription) &&
        Objects.equals(this.vpcId, dbInstanceDBSubnetGroup.vpcId) &&
        Objects.equals(this.subnetGroupStatus, dbInstanceDBSubnetGroup.subnetGroupStatus) &&
        Objects.equals(this.subnets, dbInstanceDBSubnetGroup.subnets) &&
        Objects.equals(this.dbSubnetGroupArn, dbInstanceDBSubnetGroup.dbSubnetGroupArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DBInstanceDBSubnetGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DBInstanceDBSubnetGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DBInstanceDBSubnetGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DBInstanceDBSubnetGroup is not found in the empty JSON string", DBInstanceDBSubnetGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DBInstanceDBSubnetGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DBInstanceDBSubnetGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DBInstanceDBSubnetGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DBInstanceDBSubnetGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DBInstanceDBSubnetGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DBInstanceDBSubnetGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<DBInstanceDBSubnetGroup>() {
           @Override
           public void write(JsonWriter out, DBInstanceDBSubnetGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DBInstanceDBSubnetGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DBInstanceDBSubnetGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DBInstanceDBSubnetGroup
   * @throws IOException if the JSON string is invalid with respect to DBInstanceDBSubnetGroup
   */
  public static DBInstanceDBSubnetGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DBInstanceDBSubnetGroup.class);
  }

  /**
   * Convert an instance of DBInstanceDBSubnetGroup to an JSON string
   *
   * @return JSON string
   */
