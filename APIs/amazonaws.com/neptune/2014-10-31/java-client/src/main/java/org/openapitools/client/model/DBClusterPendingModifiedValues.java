...
public class DBClusterPendingModifiedValues {
  ...
  public DBClusterPendingModifiedValues() {
  }

  public DBClusterPendingModifiedValues pendingCloudwatchLogsExports(ClusterPendingModifiedValuesPendingCloudwatchLogsExports pendingCloudwatchLogsExports) {
  ...
  public DBClusterPendingModifiedValues dbClusterIdentifier(String dbClusterIdentifier) {
  ...
  public DBClusterPendingModifiedValues iaMDatabaseAuthenticationEnabled(Boolean iaMDatabaseAuthenticationEnabled) {
  ...
  public DBClusterPendingModifiedValues engineVersion(String engineVersion) {
  ...
  public DBClusterPendingModifiedValues backupRetentionPeriod(Integer backupRetentionPeriod) {
  ...
  public DBClusterPendingModifiedValues allocatedStorage(Integer allocatedStorage) {
  ...
  public DBClusterPendingModifiedValues iops(Integer iops) {
    this.iops = iops;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DBClusterPendingModifiedValues dbClusterPendingModifiedValues = (DBClusterPendingModifiedValues) o;
    return Objects.equals(this.pendingCloudwatchLogsExports, dbClusterPendingModifiedValues.pendingCloudwatchLogsExports) &&
        Objects.equals(this.dbClusterIdentifier, dbClusterPendingModifiedValues.dbClusterIdentifier) &&
        Objects.equals(this.iaMDatabaseAuthenticationEnabled, dbClusterPendingModifiedValues.iaMDatabaseAuthenticationEnabled) &&
        Objects.equals(this.engineVersion, dbClusterPendingModifiedValues.engineVersion) &&
        Objects.equals(this.backupRetentionPeriod, dbClusterPendingModifiedValues.backupRetentionPeriod) &&
        Objects.equals(this.allocatedStorage, dbClusterPendingModifiedValues.allocatedStorage) &&
        Objects.equals(this.iops, dbClusterPendingModifiedValues.iops);
  }
  ...
  public String toString() {
    ...
    sb.append("class DBClusterPendingModifiedValues {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DBClusterPendingModifiedValues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DBClusterPendingModifiedValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DBClusterPendingModifiedValues is not found in the empty JSON string", DBClusterPendingModifiedValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DBClusterPendingModifiedValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DBClusterPendingModifiedValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DBClusterPendingModifiedValues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DBClusterPendingModifiedValues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DBClusterPendingModifiedValues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DBClusterPendingModifiedValues.class));

       return (TypeAdapter<T>) new TypeAdapter<DBClusterPendingModifiedValues>() {
           @Override
           public void write(JsonWriter out, DBClusterPendingModifiedValues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DBClusterPendingModifiedValues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DBClusterPendingModifiedValues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DBClusterPendingModifiedValues
   * @throws IOException if the JSON string is invalid with respect to DBClusterPendingModifiedValues
   */
  public static DBClusterPendingModifiedValues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DBClusterPendingModifiedValues.class);
  }

  /**
   * Convert an instance of DBClusterPendingModifiedValues to an JSON string
   *
   * @return JSON string
   */
