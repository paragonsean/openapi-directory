...
public class DBClusterSnapshot {
  ...
  public DBClusterSnapshot allocatedStorage(Integer allocatedStorage) {
  ...
  public DBClusterSnapshot licenseModel(String licenseModel) {
  ...
  public DBClusterSnapshot iaMDatabaseAuthenticationEnabled(Boolean iaMDatabaseAuthenticationEnabled) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availabilityZones, dbClusterSnapshotIdentifier, dbClusterIdentifier, snapshotCreateTime, engine, allocatedStorage, status, port, vpcId, clusterCreateTime, masterUsername, engineVersion, licenseModel, snapshotType, percentProgress, storageEncrypted, kmsKeyId, dbClusterSnapshotArn, sourceDBClusterSnapshotArn, iaMDatabaseAuthenticationEnabled);
  }
