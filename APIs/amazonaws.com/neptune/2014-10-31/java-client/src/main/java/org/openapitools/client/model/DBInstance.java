...
public class DBInstance {
  ...
  public DBInstance masterUsername(String masterUsername) {
  ...
  public DBInstance allocatedStorage(Integer allocatedStorage) {
  ...
  public DBInstance dbSecurityGroups(List dbSecurityGroups) {
  ...
  public DBInstance dbParameterGroups(List dbParameterGroups) {
  ...
  public DBInstance multiAZ(Boolean multiAZ) {
  ...
  public DBInstance readReplicaSourceDBInstanceIdentifier(String readReplicaSourceDBInstanceIdentifier) {
  ...
  public DBInstance readReplicaDBInstanceIdentifiers(List readReplicaDBInstanceIdentifiers) {
  ...
  public DBInstance readReplicaDBClusterIdentifiers(List readReplicaDBClusterIdentifiers) {
  ...
  public DBInstance licenseModel(String licenseModel) {
  ...
  public DBInstance iops(Integer iops) {
    this.iops = iops;
    return this;
  }
  ...
  public DBInstance optionGroupMemberships(List optionGroupMemberships) {
  ...
  public DBInstance characterSetName(String characterSetName) {
  ...
  public DBInstance secondaryAvailabilityZone(String secondaryAvailabilityZone) {
  ...
  public DBInstance storageType(String storageType) {
  ...
  public DBInstance tdeCredentialArn(String tdeCredentialArn) {
  ...
  public DBInstance dbInstancePort(Integer dbInstancePort) {
  ...
  public DBInstance domainMemberships(List domainMemberships) {
  ...
  public DBInstance monitoringInterval(Integer monitoringInterval) {
  ...
  public DBInstance enhancedMonitoringResourceArn(String enhancedMonitoringResourceArn) {
  ...
  public DBInstance monitoringRoleArn(String monitoringRoleArn) {
  ...
  public DBInstance timezone(String timezone) {
  ...
  public DBInstance iaMDatabaseAuthenticationEnabled(Boolean iaMDatabaseAuthenticationEnabled) {
  ...
  public DBInstance performanceInsightsEnabled(Boolean performanceInsightsEnabled) {
  ...
  public DBInstance performanceInsightsKMSKeyId(String performanceInsightsKMSKeyId) {
  ...
  public DBInstance deletionProtection(Boolean deletionProtection) {
