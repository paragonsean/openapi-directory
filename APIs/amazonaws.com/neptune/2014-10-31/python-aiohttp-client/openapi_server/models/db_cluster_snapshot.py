...
class DBClusterSnapshot(Model):
    ...
    def __init__(self, availability_zones: List=None, db_cluster_snapshot_identifier: str=None, db_cluster_identifier: str=None, snapshot_create_time: datetime=None, engine: str=None, allocated_storage: int=None, status: str=None, port: int=None, vpc_id: str=None, cluster_create_time: datetime=None, master_username: str=None, engine_version: str=None, license_model: str=None, snapshot_type: str=None, percent_progress: int=None, storage_encrypted: bool=None, kms_key_id: str=None, db_cluster_snapshot_arn: str=None, source_db_cluster_snapshot_arn: str=None, iam_database_authentication_enabled: bool=None):
        ...
        :param allocated_storage: The allocated_storage of this DBClusterSnapshot.
        ...
        :param license_model: The license_model of this DBClusterSnapshot.
        ...
        :param iam_database_authentication_enabled: The iam_database_authentication_enabled of this DBClusterSnapshot.
        """
        self.openapi_types = {
    ...
    def allocated_storage(self):
        """Gets the allocated_storage of this DBClusterSnapshot.


        :return: The allocated_storage of this DBClusterSnapshot.
        :rtype: int
        """
    ...
    def allocated_storage(self, allocated_storage):
        """Sets the allocated_storage of this DBClusterSnapshot.
    ...
    def license_model(self):
        """Gets the license_model of this DBClusterSnapshot.


        :return: The license_model of this DBClusterSnapshot.
        :rtype: str
        """
    ...
    def license_model(self, license_model):
        """Sets the license_model of this DBClusterSnapshot.
    ...
    def iam_database_authentication_enabled(self):
        """Gets the iam_database_authentication_enabled of this DBClusterSnapshot.


        :return: The iam_database_authentication_enabled of this DBClusterSnapshot.
        :rtype: bool
        """
    ...
    def iam_database_authentication_enabled(self, iam_database_authentication_enabled):
        """Sets the iam_database_authentication_enabled of this DBClusterSnapshot.
