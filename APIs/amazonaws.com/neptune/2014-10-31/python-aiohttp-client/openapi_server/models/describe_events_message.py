...
class DescribeEventsMessage(Model):
    ...
    def __init__(self, source_identifier: str=None, source_type: SourceType=None, start_time: datetime=None, end_time: datetime=None, duration: int=None, event_categories: List=None, filters: List=None, max_records: int=None, marker: str=None):
        ...
        :param event_categories: The event_categories of this DescribeEventsMessage.
        :param filters: The filters of this DescribeEventsMessage.
    ...
    def event_categories(self):
        """Gets the event_categories of this DescribeEventsMessage.


        :return: The event_categories of this DescribeEventsMessage.
        :rtype: List
        """
    ...
    def event_categories(self, event_categories):
        """Sets the event_categories of this DescribeEventsMessage.
    ...
    @property
    def filters(self):
        """Gets the filters of this DescribeEventsMessage.


        :return: The filters of this DescribeEventsMessage.
        :rtype: List
        """
    ...
    def filters(self, filters):
        """Sets the filters of this DescribeEventsMessage.
