...
class DBEngineVersion(Model):
    ...
    def __init__(self, engine: str=None, engine_version: str=None, db_parameter_group_family: str=None, db_engine_description: str=None, db_engine_version_description: str=None, default_character_set: DBEngineVersionDefaultCharacterSet=None, supported_character_sets: List=None, valid_upgrade_target: List=None, supported_timezones: List=None, exportable_log_types: List=None, supports_log_exports_to_cloudwatch_logs: bool=None, supports_read_replica: bool=None, supports_global_databases: bool=None):
        ...
        :param default_character_set: The default_character_set of this DBEngineVersion.
        :param supported_character_sets: The supported_character_sets of this DBEngineVersion.
        :param valid_upgrade_target: The valid_upgrade_target of this DBEngineVersion.
        :param supported_timezones: The supported_timezones of this DBEngineVersion.
        ...
        :param supports_read_replica: The supports_read_replica of this DBEngineVersion.
        :param supports_global_databases: The supports_global_databases of this DBEngineVersion.
        """
        self.openapi_types = {
            'engine': str,
            'engine_version': str,
    ...
    def default_character_set(self):
        """Gets the default_character_set of this DBEngineVersion.


        :return: The default_character_set of this DBEngineVersion.
    ...
    def default_character_set(self, default_character_set):
        """Sets the default_character_set of this DBEngineVersion.
    ...
    def supported_character_sets(self):
        """Gets the supported_character_sets of this DBEngineVersion.


        :return: The supported_character_sets of this DBEngineVersion.
        :rtype: List
        """
    ...
    def supported_character_sets(self, supported_character_sets):
        """Sets the supported_character_sets of this DBEngineVersion.
    ...
    def supported_timezones(self):
        """Gets the supported_timezones of this DBEngineVersion.


        :return: The supported_timezones of this DBEngineVersion.
        :rtype: List
        """
    ...
    def supported_timezones(self, supported_timezones):
        """Sets the supported_timezones of this DBEngineVersion.
    ...
    def supports_read_replica(self):
        """Gets the supports_read_replica of this DBEngineVersion.


        :return: The supports_read_replica of this DBEngineVersion.
        :rtype: bool
        """
    ...
    def supports_read_replica(self, supports_read_replica):
        """Sets the supports_read_replica of this DBEngineVersion.
    ...
    def supports_global_databases(self):
        """Gets the supports_global_databases of this DBEngineVersion.


        :return: The supports_global_databases of this DBEngineVersion.
        :rtype: bool
        """
    ...
    def supports_global_databases(self, supports_global_databases):
        """Sets the supports_global_databases of this DBEngineVersion.
