...
#include "OAICreateDBParameterGroupMessage.h"
...
#include "OAIFailoverGlobalClusterMessage.h"
...
#include "OAIPromoteReadReplicaDBClusterResult.h"
...
public:
    ...
    * @param[in]  feature_name QString [optional]
    */
    virtual void gETAddRoleToDBCluster(const QString &db_cluster_identifier, const QString &role_arn, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &feature_name = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    ...
    /**
    * @param[in]  source_db_parameter_group_identifier QString [required]
    * @param[in]  target_db_parameter_group_identifier QString [required]
    * @param[in]  target_db_parameter_group_description QString [required]
    * @param[in]  action QString [required]
    * @param[in]  version QString [required]
    * @param[in]  x_amz_content_sha256 QString [optional]
    * @param[in]  x_amz_date QString [optional]
    ...
    * @param[in]  tags QList<OAIGET_AddTagsToResource_Tags_parameter_inner> [optional]
    */
    virtual void gETCopyDBParameterGroup(const QString &source_db_parameter_group_identifier, const QString &target_db_parameter_group_identifier, const QString &target_db_parameter_group_description, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>> &tags = ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>>());
    ...
    * @param[in]  character_set_name QString [optional]
    ...
    * @param[in]  option_group_name QString [optional]
    * @param[in]  preferred_backup_window QString [optional]
    * @param[in]  preferred_maintenance_window QString [optional]
    * @param[in]  replication_source_identifier QString [optional]
    * @param[in]  tags QList<OAIGET_AddTagsToResource_Tags_parameter_inner> [optional]
    * @param[in]  storage_encrypted bool [optional]
    * @param[in]  kms_key_id QString [optional]
    * @param[in]  pre_signed_url QString [optional]
    * @param[in]  enable_iam_database_authentication bool [optional]
    * @param[in]  enable_cloudwatch_logs_exports QList<QString> [optional]
    * @param[in]  deletion_protection bool [optional]
    * @param[in]  serverless_v2_scaling_configuration OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter [optional]
    * @param[in]  global_cluster_identifier QString [optional]
    */
    virtual void gETCreateDBCluster(const QString &db_cluster_identifier, const QString &engine, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &availability_zones = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &backup_retention_period = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &character_set_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &copy_tags_to_snapshot = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &database_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &vpc_security_group_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &db_subnet_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &port = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &master_username = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &master_user_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &option_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &preferred_backup_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &preferred_maintenance_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &replication_source_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>> &tags = ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>>(), const ::OpenAPI::OptionalParam<bool> &storage_encrypted = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &kms_key_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &pre_signed_url = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &enable_iam_database_authentication = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QList<QString>> &enable_cloudwatch_logs_exports = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter> &serverless_v2_scaling_configuration = ::OpenAPI::OptionalParam<OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter>(), const ::OpenAPI::OptionalParam<QString> &global_cluster_identifier = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  db_cluster_identifier QString [required]
    * @param[in]  db_cluster_endpoint_identifier QString [required]
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  static_members QList<QString> [optional]
    * @param[in]  excluded_members QList<QString> [optional]
    * @param[in]  tags QList<OAIGET_AddTagsToResource_Tags_parameter_inner> [optional]
    */
    virtual void gETCreateDBClusterEndpoint(const QString &db_cluster_identifier, const QString &db_cluster_endpoint_identifier, const QString &endpoint_type, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &static_members = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &excluded_members = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>> &tags = ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>>());
    ...
    * @param[in]  allocated_storage qint32 [optional]
    * @param[in]  master_username QString [optional]
    * @param[in]  master_user_password QString [optional]
    * @param[in]  db_security_groups QList<QString> [optional]
    * @param[in]  vpc_security_group_ids QList<QString> [optional]
    * @param[in]  availability_zone QString [optional]
    * @param[in]  db_subnet_group_name QString [optional]
    * @param[in]  preferred_maintenance_window QString [optional]
    * @param[in]  db_parameter_group_name QString [optional]
    * @param[in]  backup_retention_period qint32 [optional]
    * @param[in]  preferred_backup_window QString [optional]
    * @param[in]  port qint32 [optional]
    * @param[in]  multi_az bool [optional]
    * @param[in]  engine_version QString [optional]
    * @param[in]  auto_minor_version_upgrade bool [optional]
    * @param[in]  license_model QString [optional]
    * @param[in]  iops qint32 [optional]
    * @param[in]  option_group_name QString [optional]
    * @param[in]  character_set_name QString [optional]
    * @param[in]  publicly_accessible bool [optional]
    * @param[in]  tags QList<OAIGET_AddTagsToResource_Tags_parameter_inner> [optional]
    * @param[in]  storage_type QString [optional]
    * @param[in]  tde_credential_arn QString [optional]
    * @param[in]  tde_credential_password QString [optional]
    * @param[in]  storage_encrypted bool [optional]
    * @param[in]  kms_key_id QString [optional]
    * @param[in]  domain QString [optional]
    * @param[in]  copy_tags_to_snapshot bool [optional]
    * @param[in]  monitoring_interval qint32 [optional]
    * @param[in]  monitoring_role_arn QString [optional]
    * @param[in]  domain_iam_role_name QString [optional]
    ...
    * @param[in]  deletion_protection bool [optional]
    */
    virtual void gETCreateDBInstance(const QString &db_instance_identifier, const QString &db_instance_class, const QString &engine, const QString &db_cluster_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &allocated_storage = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &master_username = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &master_user_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &db_security_groups = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &vpc_security_group_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &availability_zone = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_subnet_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &preferred_maintenance_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &backup_retention_period = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &preferred_backup_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &port = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<bool> &multi_az = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &auto_minor_version_upgrade = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &license_model = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &iops = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &option_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &character_set_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &publicly_accessible = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>> &tags = ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>>(), const ::OpenAPI::OptionalParam<QString> &storage_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tde_credential_arn = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tde_credential_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &storage_encrypted = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &kms_key_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &copy_tags_to_snapshot = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint32> &monitoring_interval = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &monitoring_role_arn = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain_iam_role_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &promotion_tier = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &timezone = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &enable_iam_database_authentication = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &enable_performance_insights = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &performance_insights_kms_key_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &enable_cloudwatch_logs_exports = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>());

    /**
    * @param[in]  db_parameter_group_name QString [required]
    * @param[in]  db_parameter_group_family QString [required]
    * @param[in]  description QString [required]
    * @param[in]  action QString [required]
    * @param[in]  version QString [required]
    ...
    * @param[in]  tags QList<OAIGET_AddTagsToResource_Tags_parameter_inner> [optional]
    */
    virtual void gETCreateDBParameterGroup(const QString &db_parameter_group_name, const QString &db_parameter_group_family, const QString &description, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>> &tags = ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>>());
    ...
    * @param[in]  storage_encrypted bool [optional]
    */
    virtual void gETCreateGlobalCluster(const QString &global_cluster_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &source_db_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &engine = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &storage_encrypted = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  x_amz_signed_headers QString [optional]
    */
    virtual void gETDeleteDBClusterEndpoint(const QString &db_cluster_endpoint_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  x_amz_signed_headers QString [optional]
    */
    virtual void gETDeleteDBParameterGroup(const QString &db_parameter_group_name, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  db_cluster_endpoint_identifier QString [optional]
    * @param[in]  filters QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner> [optional]
    * @param[in]  max_records qint32 [optional]
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBClusterEndpoints(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_endpoint_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBClusterParameterGroups(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void gETDescribeDBClusterSnapshots(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_snapshot_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &snapshot_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &include_shared = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &include_public = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBClusters(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    virtual void gETDescribeDBEngineVersions(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &engine = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_parameter_group_family = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &default_only = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &list_supported_character_sets = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &list_supported_timezones = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBInstances(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_instance_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBParameterGroups(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBParameters(const QString &db_parameter_group_name, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &source = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeDBSubnetGroups(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_subnet_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeEngineDefaultClusterParameters(const QString &db_parameter_group_family, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeEngineDefaultParameters(const QString &db_parameter_group_family, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  filters QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner> [optional]
    */
    virtual void gETDescribeEventCategories(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &source_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeGlobalClusters(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &global_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  marker QString [optional]
    */
    virtual void gETDescribeOrderableDBInstanceOptions(const QString &engine, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_instance_class = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &license_model = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &vpc = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  max_records qint32 [optional]
    */
    virtual void gETDescribePendingMaintenanceActions(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &resource_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &max_records = ::OpenAPI::OptionalParam<qint32>());
    ...
    * @param[in]  x_amz_signed_headers QString [optional]
    */
    virtual void gETDescribeValidDBInstanceModifications(const QString &db_instance_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    ...
    /**
    * @param[in]  global_cluster_identifier QString [required]
    * @param[in]  target_db_cluster_identifier QString [required]
    * @param[in]  action QString [required]
    * @param[in]  version QString [required]
    * @param[in]  x_amz_content_sha256 QString [optional]
    * @param[in]  x_amz_date QString [optional]
    ...
    * @param[in]  x_amz_signed_headers QString [optional]
    */
    virtual void gETFailoverGlobalCluster(const QString &global_cluster_identifier, const QString &target_db_cluster_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  filters QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner> [optional]
    */
    virtual void gETListTagsForResource(const QString &resource_name, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>> &filters = ::OpenAPI::OptionalParam<QList<OAIGET_DescribeDBClusterEndpoints_Filters_parameter_inner>>());
    ...
    * @param[in]  db_instance_parameter_group_name QString [optional]
    * @param[in]  deletion_protection bool [optional]
    * @param[in]  copy_tags_to_snapshot bool [optional]
    * @param[in]  serverless_v2_scaling_configuration OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter [optional]
    */
    virtual void gETModifyDBCluster(const QString &db_cluster_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &new_db_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &apply_immediately = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint32> &backup_retention_period = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &vpc_security_group_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<qint32> &port = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &master_user_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &option_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &preferred_backup_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &preferred_maintenance_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &enable_iam_database_authentication = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<OAIGET_ModifyDBCluster_CloudwatchLogsExportConfiguration_parameter> &cloudwatch_logs_export_configuration = ::OpenAPI::OptionalParam<OAIGET_ModifyDBCluster_CloudwatchLogsExportConfiguration_parameter>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &allow_major_version_upgrade = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &db_instance_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &copy_tags_to_snapshot = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter> &serverless_v2_scaling_configuration = ::OpenAPI::OptionalParam<OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  endpoint_type QString [optional]
    * @param[in]  static_members QList<QString> [optional]
    * @param[in]  excluded_members QList<QString> [optional]
    */
    virtual void gETModifyDBClusterEndpoint(const QString &db_cluster_endpoint_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &endpoint_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &static_members = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &excluded_members = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    * @param[in]  copy_tags_to_snapshot bool [optional]
    * @param[in]  monitoring_interval qint32 [optional]
    * @param[in]  db_port_number qint32 [optional]
    * @param[in]  publicly_accessible bool [optional]
    * @param[in]  monitoring_role_arn QString [optional]
    * @param[in]  domain_iam_role_name QString [optional]
    * @param[in]  promotion_tier qint32 [optional]
    ...
    * @param[in]  deletion_protection bool [optional]
    */
    virtual void gETModifyDBInstance(const QString &db_instance_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &allocated_storage = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &db_instance_class = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_subnet_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &db_security_groups = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<QString>> &vpc_security_group_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<bool> &apply_immediately = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &master_user_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &db_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &backup_retention_period = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &preferred_backup_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &preferred_maintenance_window = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &multi_az = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &allow_major_version_upgrade = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &auto_minor_version_upgrade = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &license_model = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &iops = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &option_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &new_db_instance_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &storage_type = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tde_credential_arn = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &tde_credential_password = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &ca_certificate_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &copy_tags_to_snapshot = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<qint32> &monitoring_interval = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<qint32> &db_port_number = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<bool> &publicly_accessible = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &monitoring_role_arn = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &domain_iam_role_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &promotion_tier = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<bool> &enable_iam_database_authentication = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &enable_performance_insights = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &performance_insights_kms_key_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIGET_ModifyDBCluster_CloudwatchLogsExportConfiguration_parameter> &cloudwatch_logs_export_configuration = ::OpenAPI::OptionalParam<OAIGET_ModifyDBCluster_CloudwatchLogsExportConfiguration_parameter>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  x_amz_signed_headers QString [optional]
    */
    virtual void gETModifyDBParameterGroup(const QString &db_parameter_group_name, const QList<OAIGET_ModifyDBClusterParameterGroup_Parameters_parameter_inner> &parameters, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  allow_major_version_upgrade bool [optional]
    */
    virtual void gETModifyGlobalCluster(const QString &global_cluster_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &new_global_cluster_identifier = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &allow_major_version_upgrade = ::OpenAPI::OptionalParam<bool>());
    ...
    * @param[in]  x_amz_signed_headers QString [optional]
    */
    virtual void gETPromoteReadReplicaDBCluster(const QString &db_cluster_identifier, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  feature_name QString [optional]
    */
    virtual void gETRemoveRoleFromDBCluster(const QString &db_cluster_identifier, const QString &role_arn, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &feature_name = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  parameters QList<OAIGET_ModifyDBClusterParameterGroup_Parameters_parameter_inner> [optional]
    */
    virtual void gETResetDBParameterGroup(const QString &db_parameter_group_name, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &reset_all_parameters = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QList<OAIGET_ModifyDBClusterParameterGroup_Parameters_parameter_inner>> &parameters = ::OpenAPI::OptionalParam<QList<OAIGET_ModifyDBClusterParameterGroup_Parameters_parameter_inner>>());
    ...
    * @param[in]  serverless_v2_scaling_configuration OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter [optional]
    */
    virtual void gETRestoreDBClusterFromSnapshot(const QString &db_cluster_identifier, const QString &snapshot_identifier, const QString &engine, const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &availability_zones = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &engine_version = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<qint32> &port = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &db_subnet_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &database_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &option_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QList<QString>> &vpc_security_group_ids = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>> &tags = ::OpenAPI::OptionalParam<QList<OAIGET_AddTagsToResource_Tags_parameter_inner>>(), const ::OpenAPI::OptionalParam<QString> &kms_key_id = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &enable_iam_database_authentication = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<QList<QString>> &enable_cloudwatch_logs_exports = ::OpenAPI::OptionalParam<QList<QString>>(), const ::OpenAPI::OptionalParam<QString> &db_cluster_parameter_group_name = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<bool> &deletion_protection = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<bool> &copy_tags_to_snapshot = ::OpenAPI::OptionalParam<bool>(), const ::OpenAPI::OptionalParam<OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter> &serverless_v2_scaling_configuration = ::OpenAPI::OptionalParam<OAIGET_CreateDBCluster_ServerlessV2ScalingConfiguration_parameter>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_add_role_to_db_cluster_message OAIAddRoleToDBClusterMessage [optional]
    */
    virtual void pOSTAddRoleToDBCluster(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIAddRoleToDBClusterMessage> &oai_add_role_to_db_cluster_message = ::OpenAPI::OptionalParam<OAIAddRoleToDBClusterMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_copy_db_parameter_group_message OAICopyDBParameterGroupMessage [optional]
    */
    virtual void pOSTCopyDBParameterGroup(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICopyDBParameterGroupMessage> &oai_copy_db_parameter_group_message = ::OpenAPI::OptionalParam<OAICopyDBParameterGroupMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_create_db_cluster_endpoint_message OAICreateDBClusterEndpointMessage [optional]
    */
    virtual void pOSTCreateDBClusterEndpoint(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICreateDBClusterEndpointMessage> &oai_create_db_cluster_endpoint_message = ::OpenAPI::OptionalParam<OAICreateDBClusterEndpointMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_create_db_parameter_group_message OAICreateDBParameterGroupMessage [optional]
    */
    virtual void pOSTCreateDBParameterGroup(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAICreateDBParameterGroupMessage> &oai_create_db_parameter_group_message = ::OpenAPI::OptionalParam<OAICreateDBParameterGroupMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_delete_db_cluster_endpoint_message OAIDeleteDBClusterEndpointMessage [optional]
    */
    virtual void pOSTDeleteDBClusterEndpoint(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDeleteDBClusterEndpointMessage> &oai_delete_db_cluster_endpoint_message = ::OpenAPI::OptionalParam<OAIDeleteDBClusterEndpointMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_delete_db_parameter_group_message OAIDeleteDBParameterGroupMessage [optional]
    */
    virtual void pOSTDeleteDBParameterGroup(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDeleteDBParameterGroupMessage> &oai_delete_db_parameter_group_message = ::OpenAPI::OptionalParam<OAIDeleteDBParameterGroupMessage>());
    ...
    * @param[in]  marker QString [optional]
    * @param[in]  oai_describe_db_cluster_endpoints_message OAIDescribeDBClusterEndpointsMessage [optional]
    */
    virtual void pOSTDescribeDBClusterEndpoints(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &max_records = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDescribeDBClusterEndpointsMessage> &oai_describe_db_cluster_endpoints_message = ::OpenAPI::OptionalParam<OAIDescribeDBClusterEndpointsMessage>());
    ...
    * @param[in]  max_records QString [optional]
    * @param[in]  marker QString [optional]
    * @param[in]  oai_describe_db_parameter_groups_message OAIDescribeDBParameterGroupsMessage [optional]
    */
    virtual void pOSTDescribeDBParameterGroups(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &max_records = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDescribeDBParameterGroupsMessage> &oai_describe_db_parameter_groups_message = ::OpenAPI::OptionalParam<OAIDescribeDBParameterGroupsMessage>());
    ...
    * @param[in]  max_records QString [optional]
    * @param[in]  marker QString [optional]
    * @param[in]  oai_describe_db_parameters_message OAIDescribeDBParametersMessage [optional]
    */
    virtual void pOSTDescribeDBParameters(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &max_records = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDescribeDBParametersMessage> &oai_describe_db_parameters_message = ::OpenAPI::OptionalParam<OAIDescribeDBParametersMessage>());
    ...
    * @param[in]  max_records QString [optional]
    * @param[in]  marker QString [optional]
    * @param[in]  oai_describe_engine_default_parameters_message OAIDescribeEngineDefaultParametersMessage [optional]
    */
    virtual void pOSTDescribeEngineDefaultParameters(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &max_records = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &marker = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDescribeEngineDefaultParametersMessage> &oai_describe_engine_default_parameters_message = ::OpenAPI::OptionalParam<OAIDescribeEngineDefaultParametersMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_describe_valid_db_instance_modifications_message OAIDescribeValidDBInstanceModificationsMessage [optional]
    */
    virtual void pOSTDescribeValidDBInstanceModifications(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIDescribeValidDBInstanceModificationsMessage> &oai_describe_valid_db_instance_modifications_message = ::OpenAPI::OptionalParam<OAIDescribeValidDBInstanceModificationsMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_failover_global_cluster_message OAIFailoverGlobalClusterMessage [optional]
    */
    virtual void pOSTFailoverGlobalCluster(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIFailoverGlobalClusterMessage> &oai_failover_global_cluster_message = ::OpenAPI::OptionalParam<OAIFailoverGlobalClusterMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_modify_db_cluster_endpoint_message OAIModifyDBClusterEndpointMessage [optional]
    */
    virtual void pOSTModifyDBClusterEndpoint(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIModifyDBClusterEndpointMessage> &oai_modify_db_cluster_endpoint_message = ::OpenAPI::OptionalParam<OAIModifyDBClusterEndpointMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_modify_db_parameter_group_message OAIModifyDBParameterGroupMessage [optional]
    */
    virtual void pOSTModifyDBParameterGroup(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIModifyDBParameterGroupMessage> &oai_modify_db_parameter_group_message = ::OpenAPI::OptionalParam<OAIModifyDBParameterGroupMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_promote_read_replica_db_cluster_message OAIPromoteReadReplicaDBClusterMessage [optional]
    */
    virtual void pOSTPromoteReadReplicaDBCluster(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIPromoteReadReplicaDBClusterMessage> &oai_promote_read_replica_db_cluster_message = ::OpenAPI::OptionalParam<OAIPromoteReadReplicaDBClusterMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_remove_role_from_db_cluster_message OAIRemoveRoleFromDBClusterMessage [optional]
    */
    virtual void pOSTRemoveRoleFromDBCluster(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIRemoveRoleFromDBClusterMessage> &oai_remove_role_from_db_cluster_message = ::OpenAPI::OptionalParam<OAIRemoveRoleFromDBClusterMessage>());
    ...
    * @param[in]  x_amz_signature QString [optional]
    * @param[in]  x_amz_signed_headers QString [optional]
    * @param[in]  oai_reset_db_parameter_group_message OAIResetDBParameterGroupMessage [optional]
    */
    virtual void pOSTResetDBParameterGroup(const QString &action, const QString &version, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256 = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_date = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_credential = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_security_token = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signature = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIResetDBParameterGroupMessage> &oai_reset_db_parameter_group_message = ::OpenAPI::OptionalParam<OAIResetDBParameterGroupMessage>());
...
private:
    ...
    void gETAddRoleToDBClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void gETCopyDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    void gETCreateDBClusterCallback(OAIHttpRequestWorker *worker);
    void gETCreateDBClusterEndpointCallback(OAIHttpRequestWorker *worker);
    ...
    void gETCreateDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void gETDeleteDBClusterEndpointCallback(OAIHttpRequestWorker *worker);
    ...
    void gETDeleteDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void gETDescribeDBClusterEndpointsCallback(OAIHttpRequestWorker *worker);
    ...
    void gETDescribeDBParameterGroupsCallback(OAIHttpRequestWorker *worker);
    void gETDescribeDBParametersCallback(OAIHttpRequestWorker *worker);
    ...
    void gETDescribeEngineDefaultParametersCallback(OAIHttpRequestWorker *worker);
    ...
    void gETDescribeValidDBInstanceModificationsCallback(OAIHttpRequestWorker *worker);
    void gETFailoverDBClusterCallback(OAIHttpRequestWorker *worker);
    void gETFailoverGlobalClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void gETModifyDBClusterEndpointCallback(OAIHttpRequestWorker *worker);
    ...
    void gETModifyDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void gETPromoteReadReplicaDBClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void gETRemoveRoleFromDBClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void gETResetDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTAddRoleToDBClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTCopyDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    void pOSTCreateDBClusterCallback(OAIHttpRequestWorker *worker);
    void pOSTCreateDBClusterEndpointCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTCreateDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTDeleteDBClusterEndpointCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTDeleteDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTDescribeDBClusterEndpointsCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTDescribeDBParameterGroupsCallback(OAIHttpRequestWorker *worker);
    void pOSTDescribeDBParametersCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTDescribeEngineDefaultParametersCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTDescribeValidDBInstanceModificationsCallback(OAIHttpRequestWorker *worker);
    void pOSTFailoverDBClusterCallback(OAIHttpRequestWorker *worker);
    void pOSTFailoverGlobalClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTModifyDBClusterEndpointCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTModifyDBParameterGroupCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTPromoteReadReplicaDBClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTRemoveRoleFromDBClusterCallback(OAIHttpRequestWorker *worker);
    ...
    void pOSTResetDBParameterGroupCallback(OAIHttpRequestWorker *worker);
...
Q_SIGNALS:
    ...
    void gETAddRoleToDBClusterSignal();
    ...
    void gETCopyDBParameterGroupSignal(OAICopyDBParameterGroupResult summary);
    void gETCreateDBClusterSignal(OAICreateDBClusterResult summary);
    void gETCreateDBClusterEndpointSignal(OAICreateDBClusterEndpointOutput summary);
    ...
    void gETCreateDBParameterGroupSignal(OAICreateDBParameterGroupResult summary);
    ...
    void gETDeleteDBClusterEndpointSignal(OAIDeleteDBClusterEndpointOutput summary);
    ...
    void gETDeleteDBParameterGroupSignal();
    ...
    void gETDescribeDBClusterEndpointsSignal(OAIDBClusterEndpointMessage summary);
    ...
    void gETDescribeDBParameterGroupsSignal(OAIDBParameterGroupsMessage summary);
    void gETDescribeDBParametersSignal(OAIDBParameterGroupDetails summary);
    ...
    void gETDescribeEngineDefaultParametersSignal(OAIDescribeEngineDefaultParametersResult summary);
    ...
    void gETDescribeValidDBInstanceModificationsSignal(OAIDescribeValidDBInstanceModificationsResult summary);
    void gETFailoverDBClusterSignal(OAIFailoverDBClusterResult summary);
    void gETFailoverGlobalClusterSignal(OAIFailoverGlobalClusterResult summary);
    ...
    void gETModifyDBClusterEndpointSignal(OAIModifyDBClusterEndpointOutput summary);
    ...
    void gETModifyDBParameterGroupSignal(OAIDBParameterGroupNameMessage summary);
    ...
    void gETPromoteReadReplicaDBClusterSignal(OAIPromoteReadReplicaDBClusterResult summary);
    ...
    void gETRemoveRoleFromDBClusterSignal();
    ...
    void gETResetDBParameterGroupSignal(OAIDBParameterGroupNameMessage summary);
    ...
    void pOSTAddRoleToDBClusterSignal();
    ...
    void pOSTCopyDBParameterGroupSignal(OAICopyDBParameterGroupResult summary);
    void pOSTCreateDBClusterSignal(OAICreateDBClusterResult summary);
    void pOSTCreateDBClusterEndpointSignal(OAICreateDBClusterEndpointOutput summary);
    ...
    void pOSTCreateDBParameterGroupSignal(OAICreateDBParameterGroupResult summary);
    ...
    void pOSTDeleteDBClusterEndpointSignal(OAIDeleteDBClusterEndpointOutput summary);
    ...
    void pOSTDeleteDBParameterGroupSignal();
    ...
    void pOSTDescribeDBClusterEndpointsSignal(OAIDBClusterEndpointMessage summary);
    ...
    void pOSTDescribeDBParameterGroupsSignal(OAIDBParameterGroupsMessage summary);
    void pOSTDescribeDBParametersSignal(OAIDBParameterGroupDetails summary);
    ...
    void pOSTDescribeEngineDefaultParametersSignal(OAIDescribeEngineDefaultParametersResult summary);
    ...
    void pOSTDescribeValidDBInstanceModificationsSignal(OAIDescribeValidDBInstanceModificationsResult summary);
    void pOSTFailoverDBClusterSignal(OAIFailoverDBClusterResult summary);
    void pOSTFailoverGlobalClusterSignal(OAIFailoverGlobalClusterResult summary);
    ...
    void pOSTModifyDBClusterEndpointSignal(OAIModifyDBClusterEndpointOutput summary);
    ...
    void pOSTModifyDBParameterGroupSignal(OAIDBParameterGroupNameMessage summary);
    ...
    void pOSTPromoteReadReplicaDBClusterSignal(OAIPromoteReadReplicaDBClusterResult summary);
    ...
    void pOSTRemoveRoleFromDBClusterSignal();
    ...
    void pOSTResetDBParameterGroupSignal(OAIDBParameterGroupNameMessage summary);
    ...
    void gETAddRoleToDBClusterSignalFull(OAIHttpRequestWorker *worker);
    ...
    void gETCopyDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAICopyDBParameterGroupResult summary);
    void gETCreateDBClusterSignalFull(OAIHttpRequestWorker *worker, OAICreateDBClusterResult summary);
    void gETCreateDBClusterEndpointSignalFull(OAIHttpRequestWorker *worker, OAICreateDBClusterEndpointOutput summary);
    ...
    void gETCreateDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAICreateDBParameterGroupResult summary);
    ...
    void gETDeleteDBClusterEndpointSignalFull(OAIHttpRequestWorker *worker, OAIDeleteDBClusterEndpointOutput summary);
    ...
    void gETDeleteDBParameterGroupSignalFull(OAIHttpRequestWorker *worker);
    ...
    void gETDescribeDBClusterEndpointsSignalFull(OAIHttpRequestWorker *worker, OAIDBClusterEndpointMessage summary);
    ...
    void gETDescribeDBParameterGroupsSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupsMessage summary);
    void gETDescribeDBParametersSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupDetails summary);
    ...
    void gETDescribeEngineDefaultParametersSignalFull(OAIHttpRequestWorker *worker, OAIDescribeEngineDefaultParametersResult summary);
    ...
    void gETDescribeValidDBInstanceModificationsSignalFull(OAIHttpRequestWorker *worker, OAIDescribeValidDBInstanceModificationsResult summary);
    void gETFailoverDBClusterSignalFull(OAIHttpRequestWorker *worker, OAIFailoverDBClusterResult summary);
    void gETFailoverGlobalClusterSignalFull(OAIHttpRequestWorker *worker, OAIFailoverGlobalClusterResult summary);
    ...
    void gETModifyDBClusterEndpointSignalFull(OAIHttpRequestWorker *worker, OAIModifyDBClusterEndpointOutput summary);
    ...
    void gETModifyDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupNameMessage summary);
    ...
    void gETPromoteReadReplicaDBClusterSignalFull(OAIHttpRequestWorker *worker, OAIPromoteReadReplicaDBClusterResult summary);
    ...
    void gETRemoveRoleFromDBClusterSignalFull(OAIHttpRequestWorker *worker);
    ...
    void gETResetDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupNameMessage summary);
    ...
    void pOSTAddRoleToDBClusterSignalFull(OAIHttpRequestWorker *worker);
    ...
    void pOSTCopyDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAICopyDBParameterGroupResult summary);
    void pOSTCreateDBClusterSignalFull(OAIHttpRequestWorker *worker, OAICreateDBClusterResult summary);
    void pOSTCreateDBClusterEndpointSignalFull(OAIHttpRequestWorker *worker, OAICreateDBClusterEndpointOutput summary);
    ...
    void pOSTCreateDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAICreateDBParameterGroupResult summary);
    ...
    void pOSTDeleteDBClusterEndpointSignalFull(OAIHttpRequestWorker *worker, OAIDeleteDBClusterEndpointOutput summary);
    ...
    void pOSTDeleteDBParameterGroupSignalFull(OAIHttpRequestWorker *worker);
    ...
    void pOSTDescribeDBClusterEndpointsSignalFull(OAIHttpRequestWorker *worker, OAIDBClusterEndpointMessage summary);
    ...
    void pOSTDescribeDBParameterGroupsSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupsMessage summary);
    void pOSTDescribeDBParametersSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupDetails summary);
    ...
    void pOSTDescribeEngineDefaultParametersSignalFull(OAIHttpRequestWorker *worker, OAIDescribeEngineDefaultParametersResult summary);
    ...
    void pOSTDescribeValidDBInstanceModificationsSignalFull(OAIHttpRequestWorker *worker, OAIDescribeValidDBInstanceModificationsResult summary);
    void pOSTFailoverDBClusterSignalFull(OAIHttpRequestWorker *worker, OAIFailoverDBClusterResult summary);
    void pOSTFailoverGlobalClusterSignalFull(OAIHttpRequestWorker *worker, OAIFailoverGlobalClusterResult summary);
    ...
    void pOSTModifyDBClusterEndpointSignalFull(OAIHttpRequestWorker *worker, OAIModifyDBClusterEndpointOutput summary);
    ...
    void pOSTModifyDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupNameMessage summary);
    ...
    void pOSTPromoteReadReplicaDBClusterSignalFull(OAIHttpRequestWorker *worker, OAIPromoteReadReplicaDBClusterResult summary);
    ...
    void pOSTRemoveRoleFromDBClusterSignalFull(OAIHttpRequestWorker *worker);
    ...
    void pOSTResetDBParameterGroupSignalFull(OAIHttpRequestWorker *worker, OAIDBParameterGroupNameMessage summary);
    ...
    Q_DECL_DEPRECATED_X("Use gETAddRoleToDBClusterSignalError() instead")
    void gETAddRoleToDBClusterSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void gETAddRoleToDBClusterSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETCopyDBParameterGroupSignalError() instead")
    void gETCopyDBParameterGroupSignalE(OAICopyDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETCopyDBParameterGroupSignalError(OAICopyDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETCreateDBClusterEndpointSignalError() instead")
    void gETCreateDBClusterEndpointSignalE(OAICreateDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETCreateDBClusterEndpointSignalError(OAICreateDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETCreateDBParameterGroupSignalError() instead")
    void gETCreateDBParameterGroupSignalE(OAICreateDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETCreateDBParameterGroupSignalError(OAICreateDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDeleteDBClusterEndpointSignalError() instead")
    void gETDeleteDBClusterEndpointSignalE(OAIDeleteDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDeleteDBClusterEndpointSignalError(OAIDeleteDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDeleteDBParameterGroupSignalError() instead")
    void gETDeleteDBParameterGroupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void gETDeleteDBParameterGroupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeDBClusterEndpointsSignalError() instead")
    void gETDescribeDBClusterEndpointsSignalE(OAIDBClusterEndpointMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeDBClusterEndpointsSignalError(OAIDBClusterEndpointMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeDBParameterGroupsSignalError() instead")
    void gETDescribeDBParameterGroupsSignalE(OAIDBParameterGroupsMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeDBParameterGroupsSignalError(OAIDBParameterGroupsMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use gETDescribeDBParametersSignalError() instead")
    void gETDescribeDBParametersSignalE(OAIDBParameterGroupDetails summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeDBParametersSignalError(OAIDBParameterGroupDetails summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeEngineDefaultParametersSignalError() instead")
    void gETDescribeEngineDefaultParametersSignalE(OAIDescribeEngineDefaultParametersResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeEngineDefaultParametersSignalError(OAIDescribeEngineDefaultParametersResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeValidDBInstanceModificationsSignalError() instead")
    void gETDescribeValidDBInstanceModificationsSignalE(OAIDescribeValidDBInstanceModificationsResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeValidDBInstanceModificationsSignalError(OAIDescribeValidDBInstanceModificationsResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETFailoverGlobalClusterSignalError() instead")
    void gETFailoverGlobalClusterSignalE(OAIFailoverGlobalClusterResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETFailoverGlobalClusterSignalError(OAIFailoverGlobalClusterResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETModifyDBClusterEndpointSignalError() instead")
    void gETModifyDBClusterEndpointSignalE(OAIModifyDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETModifyDBClusterEndpointSignalError(OAIModifyDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETModifyDBParameterGroupSignalError() instead")
    void gETModifyDBParameterGroupSignalE(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETModifyDBParameterGroupSignalError(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETPromoteReadReplicaDBClusterSignalError() instead")
    void gETPromoteReadReplicaDBClusterSignalE(OAIPromoteReadReplicaDBClusterResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETPromoteReadReplicaDBClusterSignalError(OAIPromoteReadReplicaDBClusterResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETRemoveRoleFromDBClusterSignalError() instead")
    void gETRemoveRoleFromDBClusterSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void gETRemoveRoleFromDBClusterSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETResetDBParameterGroupSignalError() instead")
    void gETResetDBParameterGroupSignalE(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void gETResetDBParameterGroupSignalError(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTAddRoleToDBClusterSignalError() instead")
    void pOSTAddRoleToDBClusterSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTAddRoleToDBClusterSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTCopyDBParameterGroupSignalError() instead")
    void pOSTCopyDBParameterGroupSignalE(OAICopyDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTCopyDBParameterGroupSignalError(OAICopyDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTCreateDBClusterEndpointSignalError() instead")
    void pOSTCreateDBClusterEndpointSignalE(OAICreateDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTCreateDBClusterEndpointSignalError(OAICreateDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTCreateDBParameterGroupSignalError() instead")
    void pOSTCreateDBParameterGroupSignalE(OAICreateDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTCreateDBParameterGroupSignalError(OAICreateDBParameterGroupResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDeleteDBClusterEndpointSignalError() instead")
    void pOSTDeleteDBClusterEndpointSignalE(OAIDeleteDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDeleteDBClusterEndpointSignalError(OAIDeleteDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDeleteDBParameterGroupSignalError() instead")
    void pOSTDeleteDBParameterGroupSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDeleteDBParameterGroupSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeDBClusterEndpointsSignalError() instead")
    void pOSTDescribeDBClusterEndpointsSignalE(OAIDBClusterEndpointMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeDBClusterEndpointsSignalError(OAIDBClusterEndpointMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeDBParameterGroupsSignalError() instead")
    void pOSTDescribeDBParameterGroupsSignalE(OAIDBParameterGroupsMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeDBParameterGroupsSignalError(OAIDBParameterGroupsMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use pOSTDescribeDBParametersSignalError() instead")
    void pOSTDescribeDBParametersSignalE(OAIDBParameterGroupDetails summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeDBParametersSignalError(OAIDBParameterGroupDetails summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeEngineDefaultParametersSignalError() instead")
    void pOSTDescribeEngineDefaultParametersSignalE(OAIDescribeEngineDefaultParametersResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeEngineDefaultParametersSignalError(OAIDescribeEngineDefaultParametersResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeValidDBInstanceModificationsSignalError() instead")
    void pOSTDescribeValidDBInstanceModificationsSignalE(OAIDescribeValidDBInstanceModificationsResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeValidDBInstanceModificationsSignalError(OAIDescribeValidDBInstanceModificationsResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTFailoverGlobalClusterSignalError() instead")
    void pOSTFailoverGlobalClusterSignalE(OAIFailoverGlobalClusterResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTFailoverGlobalClusterSignalError(OAIFailoverGlobalClusterResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTModifyDBClusterEndpointSignalError() instead")
    void pOSTModifyDBClusterEndpointSignalE(OAIModifyDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTModifyDBClusterEndpointSignalError(OAIModifyDBClusterEndpointOutput summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTModifyDBParameterGroupSignalError() instead")
    void pOSTModifyDBParameterGroupSignalE(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTModifyDBParameterGroupSignalError(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTPromoteReadReplicaDBClusterSignalError() instead")
    void pOSTPromoteReadReplicaDBClusterSignalE(OAIPromoteReadReplicaDBClusterResult summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTPromoteReadReplicaDBClusterSignalError(OAIPromoteReadReplicaDBClusterResult summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTRemoveRoleFromDBClusterSignalError() instead")
    void pOSTRemoveRoleFromDBClusterSignalE(QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTRemoveRoleFromDBClusterSignalError(QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTResetDBParameterGroupSignalError() instead")
    void pOSTResetDBParameterGroupSignalE(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTResetDBParameterGroupSignalError(OAIDBParameterGroupNameMessage summary, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETAddRoleToDBClusterSignalErrorFull() instead")
    void gETAddRoleToDBClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETAddRoleToDBClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETCopyDBParameterGroupSignalErrorFull() instead")
    void gETCopyDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETCopyDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETCreateDBClusterEndpointSignalErrorFull() instead")
    void gETCreateDBClusterEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETCreateDBClusterEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETCreateDBParameterGroupSignalErrorFull() instead")
    void gETCreateDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETCreateDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDeleteDBClusterEndpointSignalErrorFull() instead")
    void gETDeleteDBClusterEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDeleteDBClusterEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDeleteDBParameterGroupSignalErrorFull() instead")
    void gETDeleteDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDeleteDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeDBClusterEndpointsSignalErrorFull() instead")
    void gETDescribeDBClusterEndpointsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeDBClusterEndpointsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeDBParameterGroupsSignalErrorFull() instead")
    void gETDescribeDBParameterGroupsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeDBParameterGroupsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use gETDescribeDBParametersSignalErrorFull() instead")
    void gETDescribeDBParametersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeDBParametersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeEngineDefaultParametersSignalErrorFull() instead")
    void gETDescribeEngineDefaultParametersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeEngineDefaultParametersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETDescribeValidDBInstanceModificationsSignalErrorFull() instead")
    void gETDescribeValidDBInstanceModificationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETDescribeValidDBInstanceModificationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETFailoverGlobalClusterSignalErrorFull() instead")
    void gETFailoverGlobalClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETFailoverGlobalClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETModifyDBClusterEndpointSignalErrorFull() instead")
    void gETModifyDBClusterEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETModifyDBClusterEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETModifyDBParameterGroupSignalErrorFull() instead")
    void gETModifyDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETModifyDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETPromoteReadReplicaDBClusterSignalErrorFull() instead")
    void gETPromoteReadReplicaDBClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETPromoteReadReplicaDBClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETRemoveRoleFromDBClusterSignalErrorFull() instead")
    void gETRemoveRoleFromDBClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETRemoveRoleFromDBClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use gETResetDBParameterGroupSignalErrorFull() instead")
    void gETResetDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void gETResetDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTAddRoleToDBClusterSignalErrorFull() instead")
    void pOSTAddRoleToDBClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTAddRoleToDBClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTCopyDBParameterGroupSignalErrorFull() instead")
    void pOSTCopyDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTCopyDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTCreateDBClusterEndpointSignalErrorFull() instead")
    void pOSTCreateDBClusterEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTCreateDBClusterEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTCreateDBParameterGroupSignalErrorFull() instead")
    void pOSTCreateDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTCreateDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDeleteDBClusterEndpointSignalErrorFull() instead")
    void pOSTDeleteDBClusterEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDeleteDBClusterEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDeleteDBParameterGroupSignalErrorFull() instead")
    void pOSTDeleteDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDeleteDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeDBClusterEndpointsSignalErrorFull() instead")
    void pOSTDescribeDBClusterEndpointsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeDBClusterEndpointsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeDBParameterGroupsSignalErrorFull() instead")
    void pOSTDescribeDBParameterGroupsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeDBParameterGroupsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    Q_DECL_DEPRECATED_X("Use pOSTDescribeDBParametersSignalErrorFull() instead")
    void pOSTDescribeDBParametersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeDBParametersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeEngineDefaultParametersSignalErrorFull() instead")
    void pOSTDescribeEngineDefaultParametersSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeEngineDefaultParametersSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTDescribeValidDBInstanceModificationsSignalErrorFull() instead")
    void pOSTDescribeValidDBInstanceModificationsSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTDescribeValidDBInstanceModificationsSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTFailoverGlobalClusterSignalErrorFull() instead")
    void pOSTFailoverGlobalClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTFailoverGlobalClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTModifyDBClusterEndpointSignalErrorFull() instead")
    void pOSTModifyDBClusterEndpointSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTModifyDBClusterEndpointSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTModifyDBParameterGroupSignalErrorFull() instead")
    void pOSTModifyDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTModifyDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTPromoteReadReplicaDBClusterSignalErrorFull() instead")
    void pOSTPromoteReadReplicaDBClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTPromoteReadReplicaDBClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTRemoveRoleFromDBClusterSignalErrorFull() instead")
    void pOSTRemoveRoleFromDBClusterSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTRemoveRoleFromDBClusterSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
    ...
    Q_DECL_DEPRECATED_X("Use pOSTResetDBParameterGroupSignalErrorFull() instead")
    void pOSTResetDBParameterGroupSignalEFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, QString error_str);
    void pOSTResetDBParameterGroupSignalErrorFull(OAIHttpRequestWorker *worker, QNetworkReply::NetworkError error_type, const QString &error_str);
