...
/*
 * OAIDescribeDBClusterEndpointsMessage.h
 *
 * 
 */

#ifndef OAIDescribeDBClusterEndpointsMessage_H
#define OAIDescribeDBClusterEndpointsMessage_H
...
class OAIDescribeDBClusterEndpointsMessage : public OAIObject {
public:
    OAIDescribeDBClusterEndpointsMessage();
    OAIDescribeDBClusterEndpointsMessage(QString json);
    ~OAIDescribeDBClusterEndpointsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDBClusterEndpointsMessage)

#endif // OAIDescribeDBClusterEndpointsMessage_H
