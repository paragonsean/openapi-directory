...
#ifndef OAIDBParameterGroup_H
#define OAIDBParameterGroup_H
...
class OAIDBParameterGroup : public OAIObject {
public:
    OAIDBParameterGroup();
    OAIDBParameterGroup(QString json);
    ~OAIDBParameterGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDBParameterGroup)

#endif // OAIDBParameterGroup_H
