...
/*
 * OAIAddRoleToDBClusterMessage.h
 *
 * 
 */

#ifndef OAIAddRoleToDBClusterMessage_H
#define OAIAddRoleToDBClusterMessage_H
...
class OAIAddRoleToDBClusterMessage : public OAIObject {
public:
    OAIAddRoleToDBClusterMessage();
    OAIAddRoleToDBClusterMessage(QString json);
    ~OAIAddRoleToDBClusterMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAddRoleToDBClusterMessage)

#endif // OAIAddRoleToDBClusterMessage_H
