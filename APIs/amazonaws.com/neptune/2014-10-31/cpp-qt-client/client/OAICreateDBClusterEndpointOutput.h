...
/*
 * OAICreateDBClusterEndpointOutput.h
 *
...
#ifndef OAICreateDBClusterEndpointOutput_H
#define OAICreateDBClusterEndpointOutput_H
...
class OAICreateDBClusterEndpointOutput : public OAIObject {
public:
    OAICreateDBClusterEndpointOutput();
    OAICreateDBClusterEndpointOutput(QString json);
    ~OAICreateDBClusterEndpointOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDBClusterEndpointOutput)

#endif // OAICreateDBClusterEndpointOutput_H
