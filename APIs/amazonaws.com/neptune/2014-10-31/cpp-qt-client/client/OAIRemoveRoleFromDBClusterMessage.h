...
/*
 * OAIRemoveRoleFromDBClusterMessage.h
 *
 * 
 */

#ifndef OAIRemoveRoleFromDBClusterMessage_H
#define OAIRemoveRoleFromDBClusterMessage_H
...
class OAIRemoveRoleFromDBClusterMessage : public OAIObject {
public:
    OAIRemoveRoleFromDBClusterMessage();
    OAIRemoveRoleFromDBClusterMessage(QString json);
    ~OAIRemoveRoleFromDBClusterMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveRoleFromDBClusterMessage)

#endif // OAIRemoveRoleFromDBClusterMessage_H
