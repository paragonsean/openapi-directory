...
/*
 * OAIClusterPendingModifiedValues.h
 *
...
#ifndef OAIClusterPendingModifiedValues_H
#define OAIClusterPendingModifiedValues_H
...
class OAIClusterPendingModifiedValues : public OAIObject {
public:
    OAIClusterPendingModifiedValues();
    OAIClusterPendingModifiedValues(QString json);
    ~OAIClusterPendingModifiedValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterPendingModifiedValues)

#endif // OAIClusterPendingModifiedValues_H
