...
/*
 * OAIDBClusterEndpointList_inner.h
 *
 * 
 */

#ifndef OAIDBClusterEndpointList_inner_H
#define OAIDBClusterEndpointList_inner_H
...
class OAIDBClusterEndpointList_inner : public OAIObject {
public:
    OAIDBClusterEndpointList_inner();
    OAIDBClusterEndpointList_inner(QString json);
    ~OAIDBClusterEndpointList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDBClusterEndpointList_inner)

#endif // OAIDBClusterEndpointList_inner_H
