...
/*
 * OAIDescribeDBParameterGroupsMessage.h
 *
 * 
 */

#ifndef OAIDescribeDBParameterGroupsMessage_H
#define OAIDescribeDBParameterGroupsMessage_H
...
class OAIDescribeDBParameterGroupsMessage : public OAIObject {
public:
    OAIDescribeDBParameterGroupsMessage();
    OAIDescribeDBParameterGroupsMessage(QString json);
    ~OAIDescribeDBParameterGroupsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDBParameterGroupsMessage)

#endif // OAIDescribeDBParameterGroupsMessage_H
