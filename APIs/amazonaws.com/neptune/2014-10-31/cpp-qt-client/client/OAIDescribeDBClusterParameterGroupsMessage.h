...
/*
 * OAIDescribeDBClusterParameterGroupsMessage.h
 *
 * 
 */

#ifndef OAIDescribeDBClusterParameterGroupsMessage_H
#define OAIDescribeDBClusterParameterGroupsMessage_H
...
class OAIDescribeDBClusterParameterGroupsMessage : public OAIObject {
public:
    OAIDescribeDBClusterParameterGroupsMessage();
    OAIDescribeDBClusterParameterGroupsMessage(QString json);
    ~OAIDescribeDBClusterParameterGroupsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDBClusterParameterGroupsMessage)

#endif // OAIDescribeDBClusterParameterGroupsMessage_H
