...
OAIDBInstance::OAIDBInstance(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDBInstance::OAIDBInstance() {
    this->initializeModel();
}

OAIDBInstance::~OAIDBInstance() {}

void OAIDBInstance::initializeModel() {
...
void OAIDBInstance::fromJson(QString jsonString) {
...
void OAIDBInstance::fromJsonObject(QJsonObject json) {
...
QString OAIDBInstance::asJson() const {
...
QJsonObject OAIDBInstance::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDBInstance::getDbInstanceIdentifier() const {
    return m_db_instance_identifier;
}
void OAIDBInstance::setDbInstanceIdentifier(const QString &db_instance_identifier) {
    m_db_instance_identifier = db_instance_identifier;
    m_db_instance_identifier_isSet = true;
}

bool OAIDBInstance::is_db_instance_identifier_Set() const{
    return m_db_instance_identifier_isSet;
}

bool OAIDBInstance::is_db_instance_identifier_Valid() const{
    return m_db_instance_identifier_isValid;
}

QString OAIDBInstance::getDbInstanceClass() const {
    return m_db_instance_class;
}
void OAIDBInstance::setDbInstanceClass(const QString &db_instance_class) {
    m_db_instance_class = db_instance_class;
    m_db_instance_class_isSet = true;
}

bool OAIDBInstance::is_db_instance_class_Set() const{
    return m_db_instance_class_isSet;
}

bool OAIDBInstance::is_db_instance_class_Valid() const{
    return m_db_instance_class_isValid;
}

QString OAIDBInstance::getEngine() const {
    return m_engine;
}
void OAIDBInstance::setEngine(const QString &engine) {
    m_engine = engine;
    m_engine_isSet = true;
}

bool OAIDBInstance::is_engine_Set() const{
    return m_engine_isSet;
}

bool OAIDBInstance::is_engine_Valid() const{
    return m_engine_isValid;
}

QString OAIDBInstance::getDbInstanceStatus() const {
    return m_db_instance_status;
}
void OAIDBInstance::setDbInstanceStatus(const QString &db_instance_status) {
    m_db_instance_status = db_instance_status;
    m_db_instance_status_isSet = true;
}

bool OAIDBInstance::is_db_instance_status_Set() const{
    return m_db_instance_status_isSet;
}

bool OAIDBInstance::is_db_instance_status_Valid() const{
    return m_db_instance_status_isValid;
}

QString OAIDBInstance::getMasterUsername() const {
    return m_master_username;
}
void OAIDBInstance::setMasterUsername(const QString &master_username) {
    m_master_username = master_username;
    m_master_username_isSet = true;
}

bool OAIDBInstance::is_master_username_Set() const{
    return m_master_username_isSet;
}

bool OAIDBInstance::is_master_username_Valid() const{
    return m_master_username_isValid;
}

QString OAIDBInstance::getDbName() const {
    return m_db_name;
}
void OAIDBInstance::setDbName(const QString &db_name) {
    m_db_name = db_name;
    m_db_name_isSet = true;
}

bool OAIDBInstance::is_db_name_Set() const{
    return m_db_name_isSet;
}

bool OAIDBInstance::is_db_name_Valid() const{
    return m_db_name_isValid;
}

OAIDBInstance_Endpoint OAIDBInstance::getEndpoint() const {
    return m_endpoint;
}
void OAIDBInstance::setEndpoint(const OAIDBInstance_Endpoint &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIDBInstance::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIDBInstance::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

qint32 OAIDBInstance::getAllocatedStorage() const {
    return m_allocated_storage;
}
void OAIDBInstance::setAllocatedStorage(const qint32 &allocated_storage) {
    m_allocated_storage = allocated_storage;
    m_allocated_storage_isSet = true;
}

bool OAIDBInstance::is_allocated_storage_Set() const{
    return m_allocated_storage_isSet;
}

bool OAIDBInstance::is_allocated_storage_Valid() const{
    return m_allocated_storage_isValid;
}

QDateTime OAIDBInstance::getInstanceCreateTime() const {
    return m_instance_create_time;
}
void OAIDBInstance::setInstanceCreateTime(const QDateTime &instance_create_time) {
    m_instance_create_time = instance_create_time;
    m_instance_create_time_isSet = true;
}

bool OAIDBInstance::is_instance_create_time_Set() const{
    return m_instance_create_time_isSet;
}

bool OAIDBInstance::is_instance_create_time_Valid() const{
    return m_instance_create_time_isValid;
}

QString OAIDBInstance::getPreferredBackupWindow() const {
    return m_preferred_backup_window;
}
void OAIDBInstance::setPreferredBackupWindow(const QString &preferred_backup_window) {
    m_preferred_backup_window = preferred_backup_window;
    m_preferred_backup_window_isSet = true;
}

bool OAIDBInstance::is_preferred_backup_window_Set() const{
    return m_preferred_backup_window_isSet;
}

bool OAIDBInstance::is_preferred_backup_window_Valid() const{
    return m_preferred_backup_window_isValid;
}

qint32 OAIDBInstance::getBackupRetentionPeriod() const {
    return m_backup_retention_period;
}
void OAIDBInstance::setBackupRetentionPeriod(const qint32 &backup_retention_period) {
    m_backup_retention_period = backup_retention_period;
    m_backup_retention_period_isSet = true;
}

bool OAIDBInstance::is_backup_retention_period_Set() const{
    return m_backup_retention_period_isSet;
}

bool OAIDBInstance::is_backup_retention_period_Valid() const{
    return m_backup_retention_period_isValid;
}

QList OAIDBInstance::getDbSecurityGroups() const {
    return m_db_security_groups;
}
void OAIDBInstance::setDbSecurityGroups(const QList &db_security_groups) {
    m_db_security_groups = db_security_groups;
    m_db_security_groups_isSet = true;
}

bool OAIDBInstance::is_db_security_groups_Set() const{
    return m_db_security_groups_isSet;
}

bool OAIDBInstance::is_db_security_groups_Valid() const{
    return m_db_security_groups_isValid;
}

QList OAIDBInstance::getVpcSecurityGroups() const {
    return m_vpc_security_groups;
}
void OAIDBInstance::setVpcSecurityGroups(const QList &vpc_security_groups) {
    m_vpc_security_groups = vpc_security_groups;
    m_vpc_security_groups_isSet = true;
}

bool OAIDBInstance::is_vpc_security_groups_Set() const{
    return m_vpc_security_groups_isSet;
}

bool OAIDBInstance::is_vpc_security_groups_Valid() const{
    return m_vpc_security_groups_isValid;
}

QList OAIDBInstance::getDbParameterGroups() const {
    return m_db_parameter_groups;
}
void OAIDBInstance::setDbParameterGroups(const QList &db_parameter_groups) {
    m_db_parameter_groups = db_parameter_groups;
    m_db_parameter_groups_isSet = true;
}

bool OAIDBInstance::is_db_parameter_groups_Set() const{
    return m_db_parameter_groups_isSet;
}

bool OAIDBInstance::is_db_parameter_groups_Valid() const{
    return m_db_parameter_groups_isValid;
}

QString OAIDBInstance::getAvailabilityZone() const {
    return m_availability_zone;
}
void OAIDBInstance::setAvailabilityZone(const QString &availability_zone) {
    m_availability_zone = availability_zone;
    m_availability_zone_isSet = true;
}

bool OAIDBInstance::is_availability_zone_Set() const{
    return m_availability_zone_isSet;
}

bool OAIDBInstance::is_availability_zone_Valid() const{
    return m_availability_zone_isValid;
}

OAIDBInstance_DBSubnetGroup OAIDBInstance::getDbSubnetGroup() const {
    return m_db_subnet_group;
}
void OAIDBInstance::setDbSubnetGroup(const OAIDBInstance_DBSubnetGroup &db_subnet_group) {
    m_db_subnet_group = db_subnet_group;
    m_db_subnet_group_isSet = true;
}

bool OAIDBInstance::is_db_subnet_group_Set() const{
    return m_db_subnet_group_isSet;
}

bool OAIDBInstance::is_db_subnet_group_Valid() const{
    return m_db_subnet_group_isValid;
}

QString OAIDBInstance::getPreferredMaintenanceWindow() const {
    return m_preferred_maintenance_window;
}
void OAIDBInstance::setPreferredMaintenanceWindow(const QString &preferred_maintenance_window) {
    m_preferred_maintenance_window = preferred_maintenance_window;
    m_preferred_maintenance_window_isSet = true;
}

bool OAIDBInstance::is_preferred_maintenance_window_Set() const{
    return m_preferred_maintenance_window_isSet;
}

bool OAIDBInstance::is_preferred_maintenance_window_Valid() const{
    return m_preferred_maintenance_window_isValid;
}

OAIDBInstance_PendingModifiedValues OAIDBInstance::getPendingModifiedValues() const {
    return m_pending_modified_values;
}
void OAIDBInstance::setPendingModifiedValues(const OAIDBInstance_PendingModifiedValues &pending_modified_values) {
    m_pending_modified_values = pending_modified_values;
    m_pending_modified_values_isSet = true;
}

bool OAIDBInstance::is_pending_modified_values_Set() const{
    return m_pending_modified_values_isSet;
}

bool OAIDBInstance::is_pending_modified_values_Valid() const{
    return m_pending_modified_values_isValid;
}

QDateTime OAIDBInstance::getLatestRestorableTime() const {
    return m_latest_restorable_time;
}
void OAIDBInstance::setLatestRestorableTime(const QDateTime &latest_restorable_time) {
    m_latest_restorable_time = latest_restorable_time;
    m_latest_restorable_time_isSet = true;
}

bool OAIDBInstance::is_latest_restorable_time_Set() const{
    return m_latest_restorable_time_isSet;
}

bool OAIDBInstance::is_latest_restorable_time_Valid() const{
    return m_latest_restorable_time_isValid;
}

bool OAIDBInstance::getMultiAz() const {
    return m_multi_az;
}
void OAIDBInstance::setMultiAz(const bool &multi_az) {
    m_multi_az = multi_az;
    m_multi_az_isSet = true;
}

bool OAIDBInstance::is_multi_az_Set() const{
    return m_multi_az_isSet;
}

bool OAIDBInstance::is_multi_az_Valid() const{
    return m_multi_az_isValid;
}

QString OAIDBInstance::getEngineVersion() const {
    return m_engine_version;
}
void OAIDBInstance::setEngineVersion(const QString &engine_version) {
    m_engine_version = engine_version;
    m_engine_version_isSet = true;
}

bool OAIDBInstance::is_engine_version_Set() const{
    return m_engine_version_isSet;
}

bool OAIDBInstance::is_engine_version_Valid() const{
    return m_engine_version_isValid;
}

bool OAIDBInstance::getAutoMinorVersionUpgrade() const {
    return m_auto_minor_version_upgrade;
}
void OAIDBInstance::setAutoMinorVersionUpgrade(const bool &auto_minor_version_upgrade) {
    m_auto_minor_version_upgrade = auto_minor_version_upgrade;
    m_auto_minor_version_upgrade_isSet = true;
}

bool OAIDBInstance::is_auto_minor_version_upgrade_Set() const{
    return m_auto_minor_version_upgrade_isSet;
}

bool OAIDBInstance::is_auto_minor_version_upgrade_Valid() const{
    return m_auto_minor_version_upgrade_isValid;
}

QString OAIDBInstance::getReadReplicaSourceDbInstanceIdentifier() const {
    return m_read_replica_source_db_instance_identifier;
}
void OAIDBInstance::setReadReplicaSourceDbInstanceIdentifier(const QString &read_replica_source_db_instance_identifier) {
...
bool OAIDBInstance::is_read_replica_source_db_instance_identifier_Set() const{
    return m_read_replica_source_db_instance_identifier_isSet;
}

bool OAIDBInstance::is_read_replica_source_db_instance_identifier_Valid() const{
    return m_read_replica_source_db_instance_identifier_isValid;
}

QList OAIDBInstance::getReadReplicaDbInstanceIdentifiers() const {
    return m_read_replica_db_instance_identifiers;
}
void OAIDBInstance::setReadReplicaDbInstanceIdentifiers(const QList &read_replica_db_instance_identifiers) {
...
bool OAIDBInstance::is_read_replica_db_instance_identifiers_Set() const{
    return m_read_replica_db_instance_identifiers_isSet;
}

bool OAIDBInstance::is_read_replica_db_instance_identifiers_Valid() const{
    return m_read_replica_db_instance_identifiers_isValid;
}

QList OAIDBInstance::getReadReplicaDbClusterIdentifiers() const {
    return m_read_replica_db_cluster_identifiers;
}
void OAIDBInstance::setReadReplicaDbClusterIdentifiers(const QList &read_replica_db_cluster_identifiers) {
...
bool OAIDBInstance::is_read_replica_db_cluster_identifiers_Set() const{
    return m_read_replica_db_cluster_identifiers_isSet;
}

bool OAIDBInstance::is_read_replica_db_cluster_identifiers_Valid() const{
    return m_read_replica_db_cluster_identifiers_isValid;
}

QString OAIDBInstance::getLicenseModel() const {
    return m_license_model;
}
void OAIDBInstance::setLicenseModel(const QString &license_model) {
    m_license_model = license_model;
    m_license_model_isSet = true;
}

bool OAIDBInstance::is_license_model_Set() const{
    return m_license_model_isSet;
}

bool OAIDBInstance::is_license_model_Valid() const{
    return m_license_model_isValid;
}

qint32 OAIDBInstance::getIops() const {
    return m_iops;
}
void OAIDBInstance::setIops(const qint32 &iops) {
    m_iops = iops;
    m_iops_isSet = true;
}

bool OAIDBInstance::is_iops_Set() const{
    return m_iops_isSet;
}

bool OAIDBInstance::is_iops_Valid() const{
    return m_iops_isValid;
}

QList OAIDBInstance::getOptionGroupMemberships() const {
    return m_option_group_memberships;
}
void OAIDBInstance::setOptionGroupMemberships(const QList &option_group_memberships) {
    m_option_group_memberships = option_group_memberships;
    m_option_group_memberships_isSet = true;
}

bool OAIDBInstance::is_option_group_memberships_Set() const{
    return m_option_group_memberships_isSet;
}

bool OAIDBInstance::is_option_group_memberships_Valid() const{
    return m_option_group_memberships_isValid;
}

QString OAIDBInstance::getCharacterSetName() const {
    return m_character_set_name;
}
void OAIDBInstance::setCharacterSetName(const QString &character_set_name) {
    m_character_set_name = character_set_name;
    m_character_set_name_isSet = true;
}

bool OAIDBInstance::is_character_set_name_Set() const{
    return m_character_set_name_isSet;
}

bool OAIDBInstance::is_character_set_name_Valid() const{
    return m_character_set_name_isValid;
}

QString OAIDBInstance::getSecondaryAvailabilityZone() const {
    return m_secondary_availability_zone;
}
void OAIDBInstance::setSecondaryAvailabilityZone(const QString &secondary_availability_zone) {
    m_secondary_availability_zone = secondary_availability_zone;
    m_secondary_availability_zone_isSet = true;
}

bool OAIDBInstance::is_secondary_availability_zone_Set() const{
    return m_secondary_availability_zone_isSet;
}

bool OAIDBInstance::is_secondary_availability_zone_Valid() const{
    return m_secondary_availability_zone_isValid;
}

bool OAIDBInstance::getPubliclyAccessible() const {
    return m_publicly_accessible;
}
void OAIDBInstance::setPubliclyAccessible(const bool &publicly_accessible) {
    m_publicly_accessible = publicly_accessible;
    m_publicly_accessible_isSet = true;
}

bool OAIDBInstance::is_publicly_accessible_Set() const{
    return m_publicly_accessible_isSet;
}

bool OAIDBInstance::is_publicly_accessible_Valid() const{
    return m_publicly_accessible_isValid;
}

QList OAIDBInstance::getStatusInfos() const {
    return m_status_infos;
}
void OAIDBInstance::setStatusInfos(const QList &status_infos) {
    m_status_infos = status_infos;
    m_status_infos_isSet = true;
}

bool OAIDBInstance::is_status_infos_Set() const{
    return m_status_infos_isSet;
}

bool OAIDBInstance::is_status_infos_Valid() const{
    return m_status_infos_isValid;
}

QString OAIDBInstance::getStorageType() const {
    return m_storage_type;
}
void OAIDBInstance::setStorageType(const QString &storage_type) {
    m_storage_type = storage_type;
    m_storage_type_isSet = true;
}

bool OAIDBInstance::is_storage_type_Set() const{
    return m_storage_type_isSet;
}

bool OAIDBInstance::is_storage_type_Valid() const{
    return m_storage_type_isValid;
}

QString OAIDBInstance::getTdeCredentialArn() const {
    return m_tde_credential_arn;
}
void OAIDBInstance::setTdeCredentialArn(const QString &tde_credential_arn) {
    m_tde_credential_arn = tde_credential_arn;
    m_tde_credential_arn_isSet = true;
}

bool OAIDBInstance::is_tde_credential_arn_Set() const{
    return m_tde_credential_arn_isSet;
}

bool OAIDBInstance::is_tde_credential_arn_Valid() const{
    return m_tde_credential_arn_isValid;
}

qint32 OAIDBInstance::getDbInstancePort() const {
    return m_db_instance_port;
}
void OAIDBInstance::setDbInstancePort(const qint32 &db_instance_port) {
    m_db_instance_port = db_instance_port;
    m_db_instance_port_isSet = true;
}

bool OAIDBInstance::is_db_instance_port_Set() const{
    return m_db_instance_port_isSet;
}

bool OAIDBInstance::is_db_instance_port_Valid() const{
    return m_db_instance_port_isValid;
}

QString OAIDBInstance::getDbClusterIdentifier() const {
    return m_db_cluster_identifier;
}
void OAIDBInstance::setDbClusterIdentifier(const QString &db_cluster_identifier) {
    m_db_cluster_identifier = db_cluster_identifier;
    m_db_cluster_identifier_isSet = true;
}

bool OAIDBInstance::is_db_cluster_identifier_Set() const{
    return m_db_cluster_identifier_isSet;
}

bool OAIDBInstance::is_db_cluster_identifier_Valid() const{
    return m_db_cluster_identifier_isValid;
}

bool OAIDBInstance::getStorageEncrypted() const {
    return m_storage_encrypted;
}
void OAIDBInstance::setStorageEncrypted(const bool &storage_encrypted) {
    m_storage_encrypted = storage_encrypted;
    m_storage_encrypted_isSet = true;
}

bool OAIDBInstance::is_storage_encrypted_Set() const{
    return m_storage_encrypted_isSet;
}

bool OAIDBInstance::is_storage_encrypted_Valid() const{
    return m_storage_encrypted_isValid;
}

QString OAIDBInstance::getKmsKeyId() const {
    return m_kms_key_id;
}
void OAIDBInstance::setKmsKeyId(const QString &kms_key_id) {
    m_kms_key_id = kms_key_id;
    m_kms_key_id_isSet = true;
}

bool OAIDBInstance::is_kms_key_id_Set() const{
    return m_kms_key_id_isSet;
}

bool OAIDBInstance::is_kms_key_id_Valid() const{
    return m_kms_key_id_isValid;
}

QString OAIDBInstance::getDbiResourceId() const {
    return m_dbi_resource_id;
}
void OAIDBInstance::setDbiResourceId(const QString &dbi_resource_id) {
    m_dbi_resource_id = dbi_resource_id;
    m_dbi_resource_id_isSet = true;
}

bool OAIDBInstance::is_dbi_resource_id_Set() const{
    return m_dbi_resource_id_isSet;
}

bool OAIDBInstance::is_dbi_resource_id_Valid() const{
    return m_dbi_resource_id_isValid;
}

QString OAIDBInstance::getCaCertificateIdentifier() const {
    return m_ca_certificate_identifier;
}
void OAIDBInstance::setCaCertificateIdentifier(const QString &ca_certificate_identifier) {
    m_ca_certificate_identifier = ca_certificate_identifier;
    m_ca_certificate_identifier_isSet = true;
}

bool OAIDBInstance::is_ca_certificate_identifier_Set() const{
    return m_ca_certificate_identifier_isSet;
}

bool OAIDBInstance::is_ca_certificate_identifier_Valid() const{
    return m_ca_certificate_identifier_isValid;
}

QList OAIDBInstance::getDomainMemberships() const {
    return m_domain_memberships;
}
void OAIDBInstance::setDomainMemberships(const QList &domain_memberships) {
    m_domain_memberships = domain_memberships;
    m_domain_memberships_isSet = true;
}

bool OAIDBInstance::is_domain_memberships_Set() const{
    return m_domain_memberships_isSet;
}

bool OAIDBInstance::is_domain_memberships_Valid() const{
    return m_domain_memberships_isValid;
}

bool OAIDBInstance::getCopyTagsToSnapshot() const {
    return m_copy_tags_to_snapshot;
}
void OAIDBInstance::setCopyTagsToSnapshot(const bool &copy_tags_to_snapshot) {
    m_copy_tags_to_snapshot = copy_tags_to_snapshot;
    m_copy_tags_to_snapshot_isSet = true;
}

bool OAIDBInstance::is_copy_tags_to_snapshot_Set() const{
    return m_copy_tags_to_snapshot_isSet;
}

bool OAIDBInstance::is_copy_tags_to_snapshot_Valid() const{
    return m_copy_tags_to_snapshot_isValid;
}

qint32 OAIDBInstance::getMonitoringInterval() const {
    return m_monitoring_interval;
}
void OAIDBInstance::setMonitoringInterval(const qint32 &monitoring_interval) {
    m_monitoring_interval = monitoring_interval;
    m_monitoring_interval_isSet = true;
}

bool OAIDBInstance::is_monitoring_interval_Set() const{
    return m_monitoring_interval_isSet;
}

bool OAIDBInstance::is_monitoring_interval_Valid() const{
    return m_monitoring_interval_isValid;
}

QString OAIDBInstance::getEnhancedMonitoringResourceArn() const {
    return m_enhanced_monitoring_resource_arn;
}
void OAIDBInstance::setEnhancedMonitoringResourceArn(const QString &enhanced_monitoring_resource_arn) {
    m_enhanced_monitoring_resource_arn = enhanced_monitoring_resource_arn;
    m_enhanced_monitoring_resource_arn_isSet = true;
}

bool OAIDBInstance::is_enhanced_monitoring_resource_arn_Set() const{
    return m_enhanced_monitoring_resource_arn_isSet;
}

bool OAIDBInstance::is_enhanced_monitoring_resource_arn_Valid() const{
    return m_enhanced_monitoring_resource_arn_isValid;
}

QString OAIDBInstance::getMonitoringRoleArn() const {
    return m_monitoring_role_arn;
}
void OAIDBInstance::setMonitoringRoleArn(const QString &monitoring_role_arn) {
    m_monitoring_role_arn = monitoring_role_arn;
    m_monitoring_role_arn_isSet = true;
}

bool OAIDBInstance::is_monitoring_role_arn_Set() const{
    return m_monitoring_role_arn_isSet;
}

bool OAIDBInstance::is_monitoring_role_arn_Valid() const{
    return m_monitoring_role_arn_isValid;
}

qint32 OAIDBInstance::getPromotionTier() const {
    return m_promotion_tier;
}
void OAIDBInstance::setPromotionTier(const qint32 &promotion_tier) {
    m_promotion_tier = promotion_tier;
    m_promotion_tier_isSet = true;
}

bool OAIDBInstance::is_promotion_tier_Set() const{
    return m_promotion_tier_isSet;
}

bool OAIDBInstance::is_promotion_tier_Valid() const{
    return m_promotion_tier_isValid;
}

QString OAIDBInstance::getDbInstanceArn() const {
    return m_db_instance_arn;
}
void OAIDBInstance::setDbInstanceArn(const QString &db_instance_arn) {
    m_db_instance_arn = db_instance_arn;
    m_db_instance_arn_isSet = true;
}

bool OAIDBInstance::is_db_instance_arn_Set() const{
    return m_db_instance_arn_isSet;
}

bool OAIDBInstance::is_db_instance_arn_Valid() const{
    return m_db_instance_arn_isValid;
}

QString OAIDBInstance::getTimezone() const {
    return m_timezone;
}
void OAIDBInstance::setTimezone(const QString &timezone) {
    m_timezone = timezone;
    m_timezone_isSet = true;
}

bool OAIDBInstance::is_timezone_Set() const{
    return m_timezone_isSet;
}

bool OAIDBInstance::is_timezone_Valid() const{
    return m_timezone_isValid;
}

bool OAIDBInstance::getIamDatabaseAuthenticationEnabled() const {
    return m_iam_database_authentication_enabled;
}
void OAIDBInstance::setIamDatabaseAuthenticationEnabled(const bool &iam_database_authentication_enabled) {
...
bool OAIDBInstance::is_iam_database_authentication_enabled_Set() const{
    return m_iam_database_authentication_enabled_isSet;
}

bool OAIDBInstance::is_iam_database_authentication_enabled_Valid() const{
    return m_iam_database_authentication_enabled_isValid;
}

bool OAIDBInstance::getPerformanceInsightsEnabled() const {
    return m_performance_insights_enabled;
}
void OAIDBInstance::setPerformanceInsightsEnabled(const bool &performance_insights_enabled) {
    m_performance_insights_enabled = performance_insights_enabled;
    m_performance_insights_enabled_isSet = true;
}

bool OAIDBInstance::is_performance_insights_enabled_Set() const{
    return m_performance_insights_enabled_isSet;
}

bool OAIDBInstance::is_performance_insights_enabled_Valid() const{
    return m_performance_insights_enabled_isValid;
}

QString OAIDBInstance::getPerformanceInsightsKmsKeyId() const {
    return m_performance_insights_kms_key_id;
}
void OAIDBInstance::setPerformanceInsightsKmsKeyId(const QString &performance_insights_kms_key_id) {
    m_performance_insights_kms_key_id = performance_insights_kms_key_id;
    m_performance_insights_kms_key_id_isSet = true;
}

bool OAIDBInstance::is_performance_insights_kms_key_id_Set() const{
    return m_performance_insights_kms_key_id_isSet;
}

bool OAIDBInstance::is_performance_insights_kms_key_id_Valid() const{
    return m_performance_insights_kms_key_id_isValid;
}

QList OAIDBInstance::getEnabledCloudwatchLogsExports() const {
    return m_enabled_cloudwatch_logs_exports;
}
void OAIDBInstance::setEnabledCloudwatchLogsExports(const QList &enabled_cloudwatch_logs_exports) {
    m_enabled_cloudwatch_logs_exports = enabled_cloudwatch_logs_exports;
    m_enabled_cloudwatch_logs_exports_isSet = true;
}

bool OAIDBInstance::is_enabled_cloudwatch_logs_exports_Set() const{
    return m_enabled_cloudwatch_logs_exports_isSet;
}

bool OAIDBInstance::is_enabled_cloudwatch_logs_exports_Valid() const{
    return m_enabled_cloudwatch_logs_exports_isValid;
}

bool OAIDBInstance::getDeletionProtection() const {
    return m_deletion_protection;
}
void OAIDBInstance::setDeletionProtection(const bool &deletion_protection) {
    m_deletion_protection = deletion_protection;
    m_deletion_protection_isSet = true;
}

bool OAIDBInstance::is_deletion_protection_Set() const{
    return m_deletion_protection_isSet;
}

bool OAIDBInstance::is_deletion_protection_Valid() const{
    return m_deletion_protection_isValid;
}

bool OAIDBInstance::isSet() const {
...
bool OAIDBInstance::isValid() const {
