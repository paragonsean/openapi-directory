...
/*
 * OAIDescribeEngineDefaultParametersMessage.h
 *
 * 
 */

#ifndef OAIDescribeEngineDefaultParametersMessage_H
#define OAIDescribeEngineDefaultParametersMessage_H
...
class OAIDescribeEngineDefaultParametersMessage : public OAIObject {
public:
    OAIDescribeEngineDefaultParametersMessage();
    OAIDescribeEngineDefaultParametersMessage(QString json);
    ~OAIDescribeEngineDefaultParametersMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEngineDefaultParametersMessage)

#endif // OAIDescribeEngineDefaultParametersMessage_H
