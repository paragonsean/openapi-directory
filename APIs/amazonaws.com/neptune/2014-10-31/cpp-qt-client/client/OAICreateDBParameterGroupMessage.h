...
/*
 * OAICreateDBParameterGroupMessage.h
 *
 * 
 */

#ifndef OAICreateDBParameterGroupMessage_H
#define OAICreateDBParameterGroupMessage_H
...
class OAICreateDBParameterGroupMessage : public OAIObject {
public:
    OAICreateDBParameterGroupMessage();
    OAICreateDBParameterGroupMessage(QString json);
    ~OAICreateDBParameterGroupMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDBParameterGroupMessage)

#endif // OAICreateDBParameterGroupMessage_H
