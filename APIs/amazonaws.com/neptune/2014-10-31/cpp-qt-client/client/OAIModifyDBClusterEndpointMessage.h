...
/*
 * OAIModifyDBClusterEndpointMessage.h
 *
 * 
 */

#ifndef OAIModifyDBClusterEndpointMessage_H
#define OAIModifyDBClusterEndpointMessage_H
...
class OAIModifyDBClusterEndpointMessage : public OAIObject {
public:
    OAIModifyDBClusterEndpointMessage();
    OAIModifyDBClusterEndpointMessage(QString json);
    ~OAIModifyDBClusterEndpointMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyDBClusterEndpointMessage)

#endif // OAIModifyDBClusterEndpointMessage_H
