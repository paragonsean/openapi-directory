...
OAIClusterPendingModifiedValues_PendingCloudwatchLogsExports OAIPendingModifiedValues::getPendingCloudwatchLogsExports() const {
    return m_pending_cloudwatch_logs_exports;
}
void OAIPendingModifiedValues::setPendingCloudwatchLogsExports(const OAIClusterPendingModifiedValues_PendingCloudwatchLogsExports &pending_cloudwatch_logs_exports) {
