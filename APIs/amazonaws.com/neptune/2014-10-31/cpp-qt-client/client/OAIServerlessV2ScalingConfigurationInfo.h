...
/*
 * OAIServerlessV2ScalingConfigurationInfo.h
 *
...
#ifndef OAIServerlessV2ScalingConfigurationInfo_H
#define OAIServerlessV2ScalingConfigurationInfo_H
...
class OAIServerlessV2ScalingConfigurationInfo : public OAIObject {
public:
    OAIServerlessV2ScalingConfigurationInfo();
    OAIServerlessV2ScalingConfigurationInfo(QString json);
    ~OAIServerlessV2ScalingConfigurationInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerlessV2ScalingConfigurationInfo)

#endif // OAIServerlessV2ScalingConfigurationInfo_H
