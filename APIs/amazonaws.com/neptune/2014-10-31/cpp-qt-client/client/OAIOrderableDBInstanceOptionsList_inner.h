...
/*
 * OAIOrderableDBInstanceOptionsList_inner.h
 *
 * 
 */

#ifndef OAIOrderableDBInstanceOptionsList_inner_H
#define OAIOrderableDBInstanceOptionsList_inner_H
...
class OAIOrderableDBInstanceOptionsList_inner : public OAIObject {
public:
    OAIOrderableDBInstanceOptionsList_inner();
    OAIOrderableDBInstanceOptionsList_inner(QString json);
    ~OAIOrderableDBInstanceOptionsList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderableDBInstanceOptionsList_inner)

#endif // OAIOrderableDBInstanceOptionsList_inner_H
