...
#ifndef OAIGlobalCluster_H
#define OAIGlobalCluster_H
...
class OAIGlobalCluster : public OAIObject {
public:
    OAIGlobalCluster();
    OAIGlobalCluster(QString json);
    ~OAIGlobalCluster() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGlobalCluster)

#endif // OAIGlobalCluster_H
