...
/*
 * OAIRangeList_inner.h
 *
 * 
 */

#ifndef OAIRangeList_inner_H
#define OAIRangeList_inner_H
...
class OAIRangeList_inner : public OAIObject {
public:
    OAIRangeList_inner();
    OAIRangeList_inner(QString json);
    ~OAIRangeList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRangeList_inner)

#endif // OAIRangeList_inner_H
