...
#ifndef OAIDBClusterSnapshot_H
#define OAIDBClusterSnapshot_H
...
class OAIDBClusterSnapshot : public OAIObject {
public:
    OAIDBClusterSnapshot();
    OAIDBClusterSnapshot(QString json);
    ~OAIDBClusterSnapshot() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDBClusterSnapshot)

#endif // OAIDBClusterSnapshot_H
