...
/*
 * OAICreateDBClusterEndpointMessage.h
 *
 * 
 */

#ifndef OAICreateDBClusterEndpointMessage_H
#define OAICreateDBClusterEndpointMessage_H
...
class OAICreateDBClusterEndpointMessage : public OAIObject {
public:
    OAICreateDBClusterEndpointMessage();
    OAICreateDBClusterEndpointMessage(QString json);
    ~OAICreateDBClusterEndpointMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateDBClusterEndpointMessage)

#endif // OAICreateDBClusterEndpointMessage_H
