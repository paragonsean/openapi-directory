...
/*
 * OAIServerlessV2ScalingConfiguration.h
 *
...
#ifndef OAIServerlessV2ScalingConfiguration_H
#define OAIServerlessV2ScalingConfiguration_H
...
class OAIServerlessV2ScalingConfiguration : public OAIObject {
public:
    OAIServerlessV2ScalingConfiguration();
    OAIServerlessV2ScalingConfiguration(QString json);
    ~OAIServerlessV2ScalingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerlessV2ScalingConfiguration)

#endif // OAIServerlessV2ScalingConfiguration_H
