...
class OAIEventCategoriesMap : public OAIObject {
public:
    OAIEventCategoriesMap();
    OAIEventCategoriesMap(QString json);
    ~OAIEventCategoriesMap() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventCategoriesMap)

#endif // OAIEventCategoriesMap_H
