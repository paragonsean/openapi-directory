...
/*
 * OAIDBParameterGroupsMessage.h
 *
 * 
 */

#ifndef OAIDBParameterGroupsMessage_H
#define OAIDBParameterGroupsMessage_H
...
class OAIDBParameterGroupsMessage : public OAIObject {
public:
    OAIDBParameterGroupsMessage();
    OAIDBParameterGroupsMessage(QString json);
    ~OAIDBParameterGroupsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDBParameterGroupsMessage)

#endif // OAIDBParameterGroupsMessage_H
