...
QString OAITimezone::getTimezoneName() const {
    return m_timezone_name;
}
void OAITimezone::setTimezoneName(const QString &timezone_name) {
    m_timezone_name = timezone_name;
    m_timezone_name_isSet = true;
}

bool OAITimezone::is_timezone_name_Set() const{
    return m_timezone_name_isSet;
}

bool OAITimezone::is_timezone_name_Valid() const{
