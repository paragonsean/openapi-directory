...
OAIDBEngineVersion_DefaultCharacterSet OAIDBEngineVersion::getDefaultCharacterSet() const {
    return m_default_character_set;
}
void OAIDBEngineVersion::setDefaultCharacterSet(const OAIDBEngineVersion_DefaultCharacterSet &default_character_set) {
    m_default_character_set = default_character_set;
    m_default_character_set_isSet = true;
}

bool OAIDBEngineVersion::is_default_character_set_Set() const{
    return m_default_character_set_isSet;
}

bool OAIDBEngineVersion::is_default_character_set_Valid() const{
    return m_default_character_set_isValid;
}

QList OAIDBEngineVersion::getSupportedCharacterSets() const {
    return m_supported_character_sets;
}
void OAIDBEngineVersion::setSupportedCharacterSets(const QList &supported_character_sets) {
    m_supported_character_sets = supported_character_sets;
    m_supported_character_sets_isSet = true;
}

bool OAIDBEngineVersion::is_supported_character_sets_Set() const{
    return m_supported_character_sets_isSet;
}

bool OAIDBEngineVersion::is_supported_character_sets_Valid() const{
...
QList OAIDBEngineVersion::getSupportedTimezones() const {
    return m_supported_timezones;
}
void OAIDBEngineVersion::setSupportedTimezones(const QList &supported_timezones) {
    m_supported_timezones = supported_timezones;
    m_supported_timezones_isSet = true;
}

bool OAIDBEngineVersion::is_supported_timezones_Set() const{
    return m_supported_timezones_isSet;
}

bool OAIDBEngineVersion::is_supported_timezones_Valid() const{
...
bool OAIDBEngineVersion::getSupportsReadReplica() const {
    return m_supports_read_replica;
}
void OAIDBEngineVersion::setSupportsReadReplica(const bool &supports_read_replica) {
    m_supports_read_replica = supports_read_replica;
    m_supports_read_replica_isSet = true;
}

bool OAIDBEngineVersion::is_supports_read_replica_Set() const{
    return m_supports_read_replica_isSet;
}

bool OAIDBEngineVersion::is_supports_read_replica_Valid() const{
    return m_supports_read_replica_isValid;
}

bool OAIDBEngineVersion::getSupportsGlobalDatabases() const {
    return m_supports_global_databases;
}
void OAIDBEngineVersion::setSupportsGlobalDatabases(const bool &supports_global_databases) {
    m_supports_global_databases = supports_global_databases;
    m_supports_global_databases_isSet = true;
}

bool OAIDBEngineVersion::is_supports_global_databases_Set() const{
    return m_supports_global_databases_isSet;
}

bool OAIDBEngineVersion::is_supports_global_databases_Valid() const{
