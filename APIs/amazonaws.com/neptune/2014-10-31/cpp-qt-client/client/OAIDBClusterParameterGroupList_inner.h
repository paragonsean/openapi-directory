...
/*
 * OAIDBClusterParameterGroupList_inner.h
 *
 * 
 */

#ifndef OAIDBClusterParameterGroupList_inner_H
#define OAIDBClusterParameterGroupList_inner_H
...
class OAIDBClusterParameterGroupList_inner : public OAIObject {
public:
    OAIDBClusterParameterGroupList_inner();
    OAIDBClusterParameterGroupList_inner(QString json);
    ~OAIDBClusterParameterGroupList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDBClusterParameterGroupList_inner)

#endif // OAIDBClusterParameterGroupList_inner_H
