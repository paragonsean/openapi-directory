...
#include "OAIDBClusterEndpoint.h"
...
OAIDBClusterEndpoint::OAIDBClusterEndpoint(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDBClusterEndpoint::OAIDBClusterEndpoint() {
    this->initializeModel();
}

OAIDBClusterEndpoint::~OAIDBClusterEndpoint() {}

void OAIDBClusterEndpoint::initializeModel() {
...
void OAIDBClusterEndpoint::fromJson(QString jsonString) {
...
void OAIDBClusterEndpoint::fromJsonObject(QJsonObject json) {
...
QString OAIDBClusterEndpoint::asJson() const {
...
QJsonObject OAIDBClusterEndpoint::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDBClusterEndpoint::getDbClusterEndpointIdentifier() const {
    return m_db_cluster_endpoint_identifier;
}
void OAIDBClusterEndpoint::setDbClusterEndpointIdentifier(const QString &db_cluster_endpoint_identifier) {
    m_db_cluster_endpoint_identifier = db_cluster_endpoint_identifier;
    m_db_cluster_endpoint_identifier_isSet = true;
}

bool OAIDBClusterEndpoint::is_db_cluster_endpoint_identifier_Set() const{
    return m_db_cluster_endpoint_identifier_isSet;
}

bool OAIDBClusterEndpoint::is_db_cluster_endpoint_identifier_Valid() const{
    return m_db_cluster_endpoint_identifier_isValid;
}

QString OAIDBClusterEndpoint::getDbClusterIdentifier() const {
    return m_db_cluster_identifier;
}
void OAIDBClusterEndpoint::setDbClusterIdentifier(const QString &db_cluster_identifier) {
    m_db_cluster_identifier = db_cluster_identifier;
    m_db_cluster_identifier_isSet = true;
}

bool OAIDBClusterEndpoint::is_db_cluster_identifier_Set() const{
    return m_db_cluster_identifier_isSet;
}

bool OAIDBClusterEndpoint::is_db_cluster_identifier_Valid() const{
    return m_db_cluster_identifier_isValid;
}

QString OAIDBClusterEndpoint::getDbClusterEndpointResourceIdentifier() const {
    return m_db_cluster_endpoint_resource_identifier;
}
void OAIDBClusterEndpoint::setDbClusterEndpointResourceIdentifier(const QString &db_cluster_endpoint_resource_identifier) {
...
bool OAIDBClusterEndpoint::is_db_cluster_endpoint_resource_identifier_Set() const{
    return m_db_cluster_endpoint_resource_identifier_isSet;
}

bool OAIDBClusterEndpoint::is_db_cluster_endpoint_resource_identifier_Valid() const{
    return m_db_cluster_endpoint_resource_identifier_isValid;
}

QString OAIDBClusterEndpoint::getEndpoint() const {
    return m_endpoint;
}
void OAIDBClusterEndpoint::setEndpoint(const QString &endpoint) {
    m_endpoint = endpoint;
    m_endpoint_isSet = true;
}

bool OAIDBClusterEndpoint::is_endpoint_Set() const{
    return m_endpoint_isSet;
}

bool OAIDBClusterEndpoint::is_endpoint_Valid() const{
    return m_endpoint_isValid;
}

QString OAIDBClusterEndpoint::getStatus() const {
    return m_status;
}
void OAIDBClusterEndpoint::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDBClusterEndpoint::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDBClusterEndpoint::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDBClusterEndpoint::getEndpointType() const {
    return m_endpoint_type;
}
void OAIDBClusterEndpoint::setEndpointType(const QString &endpoint_type) {
    m_endpoint_type = endpoint_type;
    m_endpoint_type_isSet = true;
}

bool OAIDBClusterEndpoint::is_endpoint_type_Set() const{
    return m_endpoint_type_isSet;
}

bool OAIDBClusterEndpoint::is_endpoint_type_Valid() const{
    return m_endpoint_type_isValid;
}

QString OAIDBClusterEndpoint::getCustomEndpointType() const {
    return m_custom_endpoint_type;
}
void OAIDBClusterEndpoint::setCustomEndpointType(const QString &custom_endpoint_type) {
    m_custom_endpoint_type = custom_endpoint_type;
    m_custom_endpoint_type_isSet = true;
}

bool OAIDBClusterEndpoint::is_custom_endpoint_type_Set() const{
    return m_custom_endpoint_type_isSet;
}

bool OAIDBClusterEndpoint::is_custom_endpoint_type_Valid() const{
    return m_custom_endpoint_type_isValid;
}

QList OAIDBClusterEndpoint::getStaticMembers() const {
    return m_static_members;
}
void OAIDBClusterEndpoint::setStaticMembers(const QList &static_members) {
    m_static_members = static_members;
    m_static_members_isSet = true;
}

bool OAIDBClusterEndpoint::is_static_members_Set() const{
    return m_static_members_isSet;
}

bool OAIDBClusterEndpoint::is_static_members_Valid() const{
    return m_static_members_isValid;
}

QList OAIDBClusterEndpoint::getExcludedMembers() const {
    return m_excluded_members;
}
void OAIDBClusterEndpoint::setExcludedMembers(const QList &excluded_members) {
    m_excluded_members = excluded_members;
    m_excluded_members_isSet = true;
}

bool OAIDBClusterEndpoint::is_excluded_members_Set() const{
    return m_excluded_members_isSet;
}

bool OAIDBClusterEndpoint::is_excluded_members_Valid() const{
    return m_excluded_members_isValid;
}

QString OAIDBClusterEndpoint::getDbClusterEndpointArn() const {
    return m_db_cluster_endpoint_arn;
}
void OAIDBClusterEndpoint::setDbClusterEndpointArn(const QString &db_cluster_endpoint_arn) {
    m_db_cluster_endpoint_arn = db_cluster_endpoint_arn;
    m_db_cluster_endpoint_arn_isSet = true;
}

bool OAIDBClusterEndpoint::is_db_cluster_endpoint_arn_Set() const{
    return m_db_cluster_endpoint_arn_isSet;
}

bool OAIDBClusterEndpoint::is_db_cluster_endpoint_arn_Valid() const{
    return m_db_cluster_endpoint_arn_isValid;
}

bool OAIDBClusterEndpoint::isSet() const {
...
bool OAIDBClusterEndpoint::isValid() const {
