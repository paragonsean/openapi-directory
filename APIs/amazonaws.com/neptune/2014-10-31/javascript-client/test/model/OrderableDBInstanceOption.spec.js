...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.OrderableDBInstanceOption();
  });
  ...
  describe('OrderableDBInstanceOption', function() {
    it('should create an instance of OrderableDBInstanceOption', function() {
      // uncomment below and update the code to test OrderableDBInstanceOption
      //var instance = new AmazonNeptune.OrderableDBInstanceOption();
      //expect(instance).to.be.a(AmazonNeptune.OrderableDBInstanceOption);
    });
