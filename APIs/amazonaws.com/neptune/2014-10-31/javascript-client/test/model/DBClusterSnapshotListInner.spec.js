...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.DBClusterSnapshotListInner();
  });
  ...
  describe('DBClusterSnapshotListInner', function() {
    it('should create an instance of DBClusterSnapshotListInner', function() {
      // uncomment below and update the code to test DBClusterSnapshotListInner
      //var instance = new AmazonNeptune.DBClusterSnapshotListInner();
      //expect(instance).to.be.a(AmazonNeptune.DBClusterSnapshotListInner);
    });
