...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.RestoreDBClusterToPointInTimeMessage();
  });
  ...
  describe('RestoreDBClusterToPointInTimeMessage', function() {
    it('should create an instance of RestoreDBClusterToPointInTimeMessage', function() {
      ...
      //var instance = new AmazonNeptune.RestoreDBClusterToPointInTimeMessage();
      //expect(instance).to.be.a(AmazonNeptune.RestoreDBClusterToPointInTimeMessage);
    });
