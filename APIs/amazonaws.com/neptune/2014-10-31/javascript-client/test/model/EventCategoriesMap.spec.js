...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.EventCategoriesMap();
  });
  ...
  describe('EventCategoriesMap', function() {
    it('should create an instance of EventCategoriesMap', function() {
      // uncomment below and update the code to test EventCategoriesMap
      //var instance = new AmazonNeptune.EventCategoriesMap();
      //expect(instance).to.be.a(AmazonNeptune.EventCategoriesMap);
    });
