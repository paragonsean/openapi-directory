...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.DBInstanceStatusInfo();
  });
  ...
  describe('DBInstanceStatusInfo', function() {
    it('should create an instance of DBInstanceStatusInfo', function() {
      // uncomment below and update the code to test DBInstanceStatusInfo
      //var instance = new AmazonNeptune.DBInstanceStatusInfo();
      //expect(instance).to.be.a(AmazonNeptune.DBInstanceStatusInfo);
    });
