...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.CreateGlobalClusterMessage();
  });
  ...
  describe('CreateGlobalClusterMessage', function() {
    it('should create an instance of CreateGlobalClusterMessage', function() {
      // uncomment below and update the code to test CreateGlobalClusterMessage
      //var instance = new AmazonNeptune.CreateGlobalClusterMessage();
      //expect(instance).to.be.a(AmazonNeptune.CreateGlobalClusterMessage);
    });
