...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.AddRoleToDBClusterMessage();
  });
  ...
  describe('AddRoleToDBClusterMessage', function() {
    it('should create an instance of AddRoleToDBClusterMessage', function() {
      // uncomment below and update the code to test AddRoleToDBClusterMessage
      //var instance = new AmazonNeptune.AddRoleToDBClusterMessage();
      //expect(instance).to.be.a(AmazonNeptune.AddRoleToDBClusterMessage);
    });
