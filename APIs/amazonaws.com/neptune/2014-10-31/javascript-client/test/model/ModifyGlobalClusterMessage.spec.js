...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.ModifyGlobalClusterMessage();
  });
  ...
  describe('ModifyGlobalClusterMessage', function() {
    it('should create an instance of ModifyGlobalClusterMessage', function() {
      // uncomment below and update the code to test ModifyGlobalClusterMessage
      //var instance = new AmazonNeptune.ModifyGlobalClusterMessage();
      //expect(instance).to.be.a(AmazonNeptune.ModifyGlobalClusterMessage);
    });
    ...
    it('should have the property newGlobalClusterIdentifier (base name: "NewGlobalClusterIdentifier")', function() {
      // uncomment below and update the code to test the property newGlobalClusterIdentifier
      //var instance = new AmazonNeptune.ModifyGlobalClusterMessage();
      //expect(instance).to.be();
    });
