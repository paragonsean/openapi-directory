...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.DBClusterListInner();
  });
  ...
  describe('DBClusterListInner', function() {
    it('should create an instance of DBClusterListInner', function() {
      ...
      //var instance = new AmazonNeptune.DBClusterListInner();
      //expect(instance).to.be.a(AmazonNeptune.DBClusterListInner);
    });
