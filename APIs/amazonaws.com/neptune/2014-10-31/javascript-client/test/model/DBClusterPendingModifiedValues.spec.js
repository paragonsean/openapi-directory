...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.DBClusterPendingModifiedValues();
  });
  ...
  describe('DBClusterPendingModifiedValues', function() {
    it('should create an instance of DBClusterPendingModifiedValues', function() {
      // uncomment below and update the code to test DBClusterPendingModifiedValues
      //var instance = new AmazonNeptune.DBClusterPendingModifiedValues();
      //expect(instance).to.be.a(AmazonNeptune.DBClusterPendingModifiedValues);
    });
