...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.GlobalClusterListInner();
  });
  ...
  describe('GlobalClusterListInner', function() {
    it('should create an instance of GlobalClusterListInner', function() {
      // uncomment below and update the code to test GlobalClusterListInner
      //var instance = new AmazonNeptune.GlobalClusterListInner();
      //expect(instance).to.be.a(AmazonNeptune.GlobalClusterListInner);
    });
