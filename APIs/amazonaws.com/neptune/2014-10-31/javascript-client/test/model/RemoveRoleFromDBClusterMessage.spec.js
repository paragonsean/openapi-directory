...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonNeptune.RemoveRoleFromDBClusterMessage();
  });
  ...
  describe('RemoveRoleFromDBClusterMessage', function() {
    it('should create an instance of RemoveRoleFromDBClusterMessage', function() {
      // uncomment below and update the code to test RemoveRoleFromDBClusterMessage
      //var instance = new AmazonNeptune.RemoveRoleFromDBClusterMessage();
      //expect(instance).to.be.a(AmazonNeptune.RemoveRoleFromDBClusterMessage);
    });
