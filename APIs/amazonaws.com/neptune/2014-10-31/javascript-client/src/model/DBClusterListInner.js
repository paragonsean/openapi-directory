...
/**
 * The DBClusterListInner model module.
 * @module model/DBClusterListInner
 * @version 2014-10-31
 */
class DBClusterListInner {
    /**
     * Constructs a new <code>DBClusterListInner</code>.
     * @alias module:model/DBClusterListInner
     * @implements module:model/DBCluster
     */
    constructor() { 
        DBCluster.initialize(this);
        DBClusterListInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DBClusterListInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DBClusterListInner} obj Optional instance to populate.
     * @return {module:model/DBClusterListInner} The populated <code>DBClusterListInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DBClusterListInner();
            DBCluster.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DBClusterListInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DBClusterListInner</code>.
     */
 ...
 */
DBClusterListInner.prototype['AllocatedStorage'] = undefined;

/**
 * @member {Array} AvailabilityZones
 */
DBClusterListInner.prototype['AvailabilityZones'] = undefined;

/**
 * @member {Number} BackupRetentionPeriod
 */
DBClusterListInner.prototype['BackupRetentionPeriod'] = undefined;

/**
 * @member {String} CharacterSetName
 */
DBClusterListInner.prototype['CharacterSetName'] = undefined;

/**
 * @member {String} DatabaseName
 */
DBClusterListInner.prototype['DatabaseName'] = undefined;

/**
 * @member {String} DBClusterIdentifier
 */
DBClusterListInner.prototype['DBClusterIdentifier'] = undefined;

/**
 * @member {String} DBClusterParameterGroup
 */
DBClusterListInner.prototype['DBClusterParameterGroup'] = undefined;

/**
 * @member {String} DBSubnetGroup
 */
DBClusterListInner.prototype['DBSubnetGroup'] = undefined;

/**
 * @member {String} Status
 */
DBClusterListInner.prototype['Status'] = undefined;

/**
 * @member {String} PercentProgress
 */
DBClusterListInner.prototype['PercentProgress'] = undefined;

/**
 * @member {Date} EarliestRestorableTime
 */
DBClusterListInner.prototype['EarliestRestorableTime'] = undefined;

/**
 * @member {String} Endpoint
 */
DBClusterListInner.prototype['Endpoint'] = undefined;

/**
 * @member {String} ReaderEndpoint
 */
DBClusterListInner.prototype['ReaderEndpoint'] = undefined;

/**
 * @member {Boolean} MultiAZ
 */
DBClusterListInner.prototype['MultiAZ'] = undefined;

/**
 * @member {String} Engine
 */
DBClusterListInner.prototype['Engine'] = undefined;

/**
 * @member {String} EngineVersion
 */
DBClusterListInner.prototype['EngineVersion'] = undefined;

/**
 * @member {Date} LatestRestorableTime
 */
DBClusterListInner.prototype['LatestRestorableTime'] = undefined;

/**
 * @member {Number} Port
 */
DBClusterListInner.prototype['Port'] = undefined;

/**
 * @member {String} MasterUsername
 */
DBClusterListInner.prototype['MasterUsername'] = undefined;

/**
 * @member {Array} DBClusterOptionGroupMemberships
 */
DBClusterListInner.prototype['DBClusterOptionGroupMemberships'] = undefined;

/**
 * @member {String} PreferredBackupWindow
 */
DBClusterListInner.prototype['PreferredBackupWindow'] = undefined;

/**
 * @member {String} PreferredMaintenanceWindow
 */
DBClusterListInner.prototype['PreferredMaintenanceWindow'] = undefined;

/**
 * @member {String} ReplicationSourceIdentifier
 */
DBClusterListInner.prototype['ReplicationSourceIdentifier'] = undefined;

/**
 * @member {Array} ReadReplicaIdentifiers
 */
DBClusterListInner.prototype['ReadReplicaIdentifiers'] = undefined;

/**
 * @member {Array} DBClusterMembers
 */
DBClusterListInner.prototype['DBClusterMembers'] = undefined;

/**
 * @member {Array} VpcSecurityGroups
 */
DBClusterListInner.prototype['VpcSecurityGroups'] = undefined;

/**
 * @member {String} HostedZoneId
 */
DBClusterListInner.prototype['HostedZoneId'] = undefined;

/**
 * @member {Boolean} StorageEncrypted
 */
DBClusterListInner.prototype['StorageEncrypted'] = undefined;

/**
 * @member {String} KmsKeyId
 */
DBClusterListInner.prototype['KmsKeyId'] = undefined;

/**
 * @member {String} DbClusterResourceId
 */
DBClusterListInner.prototype['DbClusterResourceId'] = undefined;

/**
 * @member {String} DBClusterArn
 */
DBClusterListInner.prototype['DBClusterArn'] = undefined;

/**
 * @member {Array} AssociatedRoles
 */
DBClusterListInner.prototype['AssociatedRoles'] = undefined;

/**
 * @member {Boolean} IAMDatabaseAuthenticationEnabled
 */
DBClusterListInner.prototype['IAMDatabaseAuthenticationEnabled'] = undefined;

/**
 * @member {String} CloneGroupId
 */
DBClusterListInner.prototype['CloneGroupId'] = undefined;

/**
 * @member {Date} ClusterCreateTime
 */
DBClusterListInner.prototype['ClusterCreateTime'] = undefined;

/**
 * @member {Boolean} CopyTagsToSnapshot
 */
DBClusterListInner.prototype['CopyTagsToSnapshot'] = undefined;

/**
 * @member {Array} EnabledCloudwatchLogsExports
 */
DBClusterListInner.prototype['EnabledCloudwatchLogsExports'] = undefined;

/**
 * @member {module:model/DBClusterPendingModifiedValues} PendingModifiedValues
 */
DBClusterListInner.prototype['PendingModifiedValues'] = undefined;

/**
 * @member {Boolean} DeletionProtection
 */
DBClusterListInner.prototype['DeletionProtection'] = undefined;

/**
 * @member {Boolean} CrossAccountClone
 */
DBClusterListInner.prototype['CrossAccountClone'] = undefined;

/**
 * @member {Date} AutomaticRestartTime
 */
DBClusterListInner.prototype['AutomaticRestartTime'] = undefined;

/**
 * @member {module:model/ServerlessV2ScalingConfigurationInfo} ServerlessV2ScalingConfiguration
 */
DBClusterListInner.prototype['ServerlessV2ScalingConfiguration'] = undefined;

/**
 * @member {String} GlobalClusterIdentifier
 */
DBClusterListInner.prototype['GlobalClusterIdentifier'] = undefined;


// Implement DBCluster interface:
/**
 * @member {Number} AllocatedStorage
 */
...
export default DBClusterListInner;
