...
/**
 * The EventListInner model module.
 * @module model/EventListInner
 * @version 2014-10-31
 */
class EventListInner {
    /**
     * Constructs a new <code>EventListInner</code>.
     * @alias module:model/EventListInner
     * @implements module:model/Event
     */
    constructor() { 
        Event.initialize(this);
        EventListInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EventListInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventListInner} obj Optional instance to populate.
     * @return {module:model/EventListInner} The populated <code>EventListInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EventListInner();
    ...
    /**
     * Validates the JSON data with respect to <code>EventListInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EventListInner</code>.
     */
 ...
 */
EventListInner.prototype['SourceIdentifier'] = undefined;

/**
 * @member {module:model/SourceType} SourceType
 */
EventListInner.prototype['SourceType'] = undefined;

/**
 * @member {String} Message
 */
EventListInner.prototype['Message'] = undefined;

/**
 * @member {Array} EventCategories
 */
EventListInner.prototype['EventCategories'] = undefined;

/**
 * @member {Date} Date
 */
EventListInner.prototype['Date'] = undefined;

/**
 * @member {String} SourceArn
 */
EventListInner.prototype['SourceArn'] = undefined;
