...
public class GetGrantResponseGrant {
  ...
  public GetGrantResponseGrant() {
  }

  public GetGrantResponseGrant grantArn(String grantArn) {
  ...
  public GetGrantResponseGrant grantName(String grantName) {
  ...
  public GetGrantResponseGrant parentArn(String parentArn) {
  ...
  public GetGrantResponseGrant licenseArn(String licenseArn) {
  ...
  public GetGrantResponseGrant granteePrincipalArn(String granteePrincipalArn) {
  ...
  public GetGrantResponseGrant homeRegion(String homeRegion) {
  ...
  public GetGrantResponseGrant grantStatus(GrantStatus grantStatus) {
  ...
  public GetGrantResponseGrant statusReason(String statusReason) {
  ...
  public GetGrantResponseGrant version(String version) {
  ...
  public GetGrantResponseGrant grantedOperations(List grantedOperations) {
  ...
  public GetGrantResponseGrant options(CreateGrantVersionRequestOptions options) {
  ...
  public boolean equals(Object o) {
    ...
    GetGrantResponseGrant getGrantResponseGrant = (GetGrantResponseGrant) o;
    return Objects.equals(this.grantArn, getGrantResponseGrant.grantArn) &&
        Objects.equals(this.grantName, getGrantResponseGrant.grantName) &&
        Objects.equals(this.parentArn, getGrantResponseGrant.parentArn) &&
        Objects.equals(this.licenseArn, getGrantResponseGrant.licenseArn) &&
        Objects.equals(this.granteePrincipalArn, getGrantResponseGrant.granteePrincipalArn) &&
        Objects.equals(this.homeRegion, getGrantResponseGrant.homeRegion) &&
        Objects.equals(this.grantStatus, getGrantResponseGrant.grantStatus) &&
        Objects.equals(this.statusReason, getGrantResponseGrant.statusReason) &&
        Objects.equals(this.version, getGrantResponseGrant.version) &&
        Objects.equals(this.grantedOperations, getGrantResponseGrant.grantedOperations) &&
        Objects.equals(this.options, getGrantResponseGrant.options);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetGrantResponseGrant {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetGrantResponseGrant
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetGrantResponseGrant.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetGrantResponseGrant is not found in the empty JSON string", GetGrantResponseGrant.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetGrantResponseGrant.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetGrantResponseGrant` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetGrantResponseGrant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetGrantResponseGrant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetGrantResponseGrant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetGrantResponseGrant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetGrantResponseGrant.class));

       return (TypeAdapter<T>) new TypeAdapter<GetGrantResponseGrant>() {
           @Override
           public void write(JsonWriter out, GetGrantResponseGrant value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetGrantResponseGrant read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetGrantResponseGrant given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetGrantResponseGrant
   * @throws IOException if the JSON string is invalid with respect to GetGrantResponseGrant
   */
  public static GetGrantResponseGrant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetGrantResponseGrant.class);
  }

  /**
   * Convert an instance of GetGrantResponseGrant to an JSON string
   *
   * @return JSON string
   */
