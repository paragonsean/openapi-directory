...
public class ReportGenerator {
  ...
  public ReportGenerator reportGeneratorName(String reportGeneratorName) {
  ...
  public ReportGenerator reportType(List reportType) {
  ...
  public ReportGenerator reportContext(ReportGeneratorReportContext reportContext) {
  ...
  public ReportGenerator reportFrequency(ReportGeneratorReportFrequency reportFrequency) {
  ...
  public ReportGenerator licenseManagerReportGeneratorArn(String licenseManagerReportGeneratorArn) {
  ...
  public ReportGenerator lastRunStatus(String lastRunStatus) {
  ...
  public ReportGenerator lastRunFailureReason(String lastRunFailureReason) {
  ...
  public ReportGenerator lastReportGenerationTime(String lastReportGenerationTime) {
  ...
  public ReportGenerator reportCreatorAccount(String reportCreatorAccount) {
  ...
  public ReportGenerator s3Location(ReportGeneratorS3Location s3Location) {
  ...
  public ReportGenerator createTime(String createTime) {
  ...
  public ReportGenerator tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reportGeneratorName, reportGenerator.reportGeneratorName) &&
        Objects.equals(this.reportType, reportGenerator.reportType) &&
        Objects.equals(this.reportContext, reportGenerator.reportContext) &&
        Objects.equals(this.reportFrequency, reportGenerator.reportFrequency) &&
        Objects.equals(this.licenseManagerReportGeneratorArn, reportGenerator.licenseManagerReportGeneratorArn) &&
        Objects.equals(this.lastRunStatus, reportGenerator.lastRunStatus) &&
        Objects.equals(this.lastRunFailureReason, reportGenerator.lastRunFailureReason) &&
        Objects.equals(this.lastReportGenerationTime, reportGenerator.lastReportGenerationTime) &&
        Objects.equals(this.reportCreatorAccount, reportGenerator.reportCreatorAccount) &&
        Objects.equals(this.description, reportGenerator.description) &&
        Objects.equals(this.s3Location, reportGenerator.s3Location) &&
        Objects.equals(this.createTime, reportGenerator.createTime) &&
        Objects.equals(this.tags, reportGenerator.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportGenerator {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportGenerator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportGenerator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportGenerator is not found in the empty JSON string", ReportGenerator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportGenerator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportGenerator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportGenerator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportGenerator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportGenerator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportGenerator.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportGenerator>() {
           @Override
           public void write(JsonWriter out, ReportGenerator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportGenerator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportGenerator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportGenerator
   * @throws IOException if the JSON string is invalid with respect to ReportGenerator
   */
  public static ReportGenerator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportGenerator.class);
  }

  /**
   * Convert an instance of ReportGenerator to an JSON string
   *
   * @return JSON string
   */
