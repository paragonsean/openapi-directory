...
/*
 * OAICheckInLicenseRequest.h
 *
 * 
 */

#ifndef OAICheckInLicenseRequest_H
#define OAICheckInLicenseRequest_H
...
class OAICheckInLicenseRequest : public OAIObject {
public:
    OAICheckInLicenseRequest();
    OAICheckInLicenseRequest(QString json);
    ~OAICheckInLicenseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICheckInLicenseRequest)

#endif // OAICheckInLicenseRequest_H
