...
/*
 * OAIDeleteGrantRequest.h
 *
 * 
 */

#ifndef OAIDeleteGrantRequest_H
#define OAIDeleteGrantRequest_H
...
class OAIDeleteGrantRequest : public OAIObject {
public:
    OAIDeleteGrantRequest();
    OAIDeleteGrantRequest(QString json);
    ~OAIDeleteGrantRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteGrantRequest)

#endif // OAIDeleteGrantRequest_H
