...
/*
 * OAICreateLicenseRequest_ConsumptionConfiguration.h
 *
 * 
 */

#ifndef OAICreateLicenseRequest_ConsumptionConfiguration_H
#define OAICreateLicenseRequest_ConsumptionConfiguration_H
...
class OAICreateLicenseRequest_ConsumptionConfiguration : public OAIObject {
public:
    OAICreateLicenseRequest_ConsumptionConfiguration();
    OAICreateLicenseRequest_ConsumptionConfiguration(QString json);
    ~OAICreateLicenseRequest_ConsumptionConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLicenseRequest_ConsumptionConfiguration)

#endif // OAICreateLicenseRequest_ConsumptionConfiguration_H
