...
/*
 * OAIDeleteLicenseRequest.h
 *
 * 
 */

#ifndef OAIDeleteLicenseRequest_H
#define OAIDeleteLicenseRequest_H
...
class OAIDeleteLicenseRequest : public OAIObject {
public:
    OAIDeleteLicenseRequest();
    OAIDeleteLicenseRequest(QString json);
    ~OAIDeleteLicenseRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteLicenseRequest)

#endif // OAIDeleteLicenseRequest_H
