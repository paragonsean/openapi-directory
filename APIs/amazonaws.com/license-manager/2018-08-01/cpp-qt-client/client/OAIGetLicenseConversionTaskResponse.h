...
/*
 * OAIGetLicenseConversionTaskResponse.h
 *
 * 
 */

#ifndef OAIGetLicenseConversionTaskResponse_H
#define OAIGetLicenseConversionTaskResponse_H
...
namespace OpenAPI {
class OAIGetLicenseConversionTaskResponse_SourceLicenseContext;
class OAIGetLicenseConversionTaskResponse_DestinationLicenseContext;

class OAIGetLicenseConversionTaskResponse : public OAIObject {
public:
    OAIGetLicenseConversionTaskResponse();
    OAIGetLicenseConversionTaskResponse(QString json);
    ~OAIGetLicenseConversionTaskResponse() override;
    ...
    OAIGetLicenseConversionTaskResponse_SourceLicenseContext getSourceLicenseContext() const;
    void setSourceLicenseContext(const OAIGetLicenseConversionTaskResponse_SourceLicenseContext &source_license_context);
    bool is_source_license_context_Set() const;
    bool is_source_license_context_Valid() const;

    OAIGetLicenseConversionTaskResponse_DestinationLicenseContext getDestinationLicenseContext() const;
    void setDestinationLicenseContext(const OAIGetLicenseConversionTaskResponse_DestinationLicenseContext &destination_license_context);
...
private:
    ...
    OAIGetLicenseConversionTaskResponse_SourceLicenseContext m_source_license_context;
    bool m_source_license_context_isSet;
    bool m_source_license_context_isValid;

    OAIGetLicenseConversionTaskResponse_DestinationLicenseContext m_destination_license_context;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLicenseConversionTaskResponse)

#endif // OAIGetLicenseConversionTaskResponse_H
