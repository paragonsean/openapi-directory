...
/*
 * OAIGetGrantResponse_Grant.h
 *
 * 
 */

#ifndef OAIGetGrantResponse_Grant_H
#define OAIGetGrantResponse_Grant_H
...
class OAIGetGrantResponse_Grant : public OAIObject {
public:
    OAIGetGrantResponse_Grant();
    OAIGetGrantResponse_Grant(QString json);
    ~OAIGetGrantResponse_Grant() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetGrantResponse_Grant)

#endif // OAIGetGrantResponse_Grant_H
