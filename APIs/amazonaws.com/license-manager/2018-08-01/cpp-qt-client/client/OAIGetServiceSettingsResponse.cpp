...
void OAIGetServiceSettingsResponse::initializeModel() {
    ...
    m_license_manager_resource_share_arn_isSet = false;
    m_license_manager_resource_share_arn_isValid = false;
}
...
void OAIGetServiceSettingsResponse::fromJsonObject(QJsonObject json) {
    ...
    m_license_manager_resource_share_arn_isValid = ::OpenAPI::fromJsonValue(m_license_manager_resource_share_arn, json[QString("LicenseManagerResourceShareArn")]);
    m_license_manager_resource_share_arn_isSet = !json[QString("LicenseManagerResourceShareArn")].isNull() && m_license_manager_resource_share_arn_isValid;
}
...
QJsonObject OAIGetServiceSettingsResponse::asJsonObject() const {
    ...
    if (m_license_manager_resource_share_arn_isSet) {
        obj.insert(QString("LicenseManagerResourceShareArn"), ::OpenAPI::toJsonValue(m_license_manager_resource_share_arn));
    }
    return obj;
}

QString OAIGetServiceSettingsResponse::getS3BucketArn() const {
    return m_s3_bucket_arn;
}
void OAIGetServiceSettingsResponse::setS3BucketArn(const QString &s3_bucket_arn) {
    m_s3_bucket_arn = s3_bucket_arn;
    m_s3_bucket_arn_isSet = true;
}

bool OAIGetServiceSettingsResponse::is_s3_bucket_arn_Set() const{
    return m_s3_bucket_arn_isSet;
}

bool OAIGetServiceSettingsResponse::is_s3_bucket_arn_Valid() const{
    return m_s3_bucket_arn_isValid;
}

QString OAIGetServiceSettingsResponse::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIGetServiceSettingsResponse::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIGetServiceSettingsResponse::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIGetServiceSettingsResponse::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

OAIGetServiceSettingsResponse_OrganizationConfiguration OAIGetServiceSettingsResponse::getOrganizationConfiguration() const {
    return m_organization_configuration;
}
void OAIGetServiceSettingsResponse::setOrganizationConfiguration(const OAIGetServiceSettingsResponse_OrganizationConfiguration &organization_configuration) {
    m_organization_configuration = organization_configuration;
    m_organization_configuration_isSet = true;
}

bool OAIGetServiceSettingsResponse::is_organization_configuration_Set() const{
    return m_organization_configuration_isSet;
}

bool OAIGetServiceSettingsResponse::is_organization_configuration_Valid() const{
    return m_organization_configuration_isValid;
}

bool OAIGetServiceSettingsResponse::getEnableCrossAccountsDiscovery() const {
    return m_enable_cross_accounts_discovery;
}
void OAIGetServiceSettingsResponse::setEnableCrossAccountsDiscovery(const bool &enable_cross_accounts_discovery) {
    m_enable_cross_accounts_discovery = enable_cross_accounts_discovery;
    m_enable_cross_accounts_discovery_isSet = true;
}

bool OAIGetServiceSettingsResponse::is_enable_cross_accounts_discovery_Set() const{
    return m_enable_cross_accounts_discovery_isSet;
}

bool OAIGetServiceSettingsResponse::is_enable_cross_accounts_discovery_Valid() const{
    return m_enable_cross_accounts_discovery_isValid;
}

QString OAIGetServiceSettingsResponse::getLicenseManagerResourceShareArn() const {
    return m_license_manager_resource_share_arn;
}
void OAIGetServiceSettingsResponse::setLicenseManagerResourceShareArn(const QString &license_manager_resource_share_arn) {
    m_license_manager_resource_share_arn = license_manager_resource_share_arn;
    m_license_manager_resource_share_arn_isSet = true;
}

bool OAIGetServiceSettingsResponse::is_license_manager_resource_share_arn_Set() const{
    return m_license_manager_resource_share_arn_isSet;
}

bool OAIGetServiceSettingsResponse::is_license_manager_resource_share_arn_Valid() const{
    return m_license_manager_resource_share_arn_isValid;
}
