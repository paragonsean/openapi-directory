...
QString Example::create(){
    QString obj;
OAIAcceptGrantRequest Example::create(){
    OAIAcceptGrantRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::acceptGrantSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::acceptGrantSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAcceptGrantRequest oai_accept_grant_request = create(); // OAIAcceptGrantRequest | 
      ...
      apiInstance.acceptGrant(x_amz_targetoai_accept_grant_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
