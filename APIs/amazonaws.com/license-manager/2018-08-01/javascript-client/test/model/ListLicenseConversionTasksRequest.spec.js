...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListLicenseConversionTasksRequest();
  });
  ...
  describe('ListLicenseConversionTasksRequest', function() {
    it('should create an instance of ListLicenseConversionTasksRequest', function() {
      // uncomment below and update the code to test ListLicenseConversionTasksRequest
      //var instance = new AwsLicenseManager.ListLicenseConversionTasksRequest();
      //expect(instance).to.be.a(AwsLicenseManager.ListLicenseConversionTasksRequest);
    });
