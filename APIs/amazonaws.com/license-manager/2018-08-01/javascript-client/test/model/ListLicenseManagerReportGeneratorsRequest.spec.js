...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListLicenseManagerReportGeneratorsRequest();
  });
  ...
  describe('ListLicenseManagerReportGeneratorsRequest', function() {
    it('should create an instance of ListLicenseManagerReportGeneratorsRequest', function() {
      // uncomment below and update the code to test ListLicenseManagerReportGeneratorsRequest
      //var instance = new AwsLicenseManager.ListLicenseManagerReportGeneratorsRequest();
      //expect(instance).to.be.a(AwsLicenseManager.ListLicenseManagerReportGeneratorsRequest);
    });
