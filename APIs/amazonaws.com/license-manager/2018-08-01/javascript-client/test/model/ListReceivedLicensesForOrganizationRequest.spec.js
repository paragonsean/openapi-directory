...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListReceivedLicensesForOrganizationRequest();
  });
  ...
  describe('ListReceivedLicensesForOrganizationRequest', function() {
    it('should create an instance of ListReceivedLicensesForOrganizationRequest', function() {
      // uncomment below and update the code to test ListReceivedLicensesForOrganizationRequest
      //var instance = new AwsLicenseManager.ListReceivedLicensesForOrganizationRequest();
      //expect(instance).to.be.a(AwsLicenseManager.ListReceivedLicensesForOrganizationRequest);
    });
