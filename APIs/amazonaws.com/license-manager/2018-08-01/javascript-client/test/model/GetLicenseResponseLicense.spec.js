...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.GetLicenseResponseLicense();
  });
  ...
  describe('GetLicenseResponseLicense', function() {
    it('should create an instance of GetLicenseResponseLicense', function() {
      // uncomment below and update the code to test GetLicenseResponseLicense
      //var instance = new AwsLicenseManager.GetLicenseResponseLicense();
      //expect(instance).to.be.a(AwsLicenseManager.GetLicenseResponseLicense);
    });
