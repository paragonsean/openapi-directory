...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListTokensRequest();
  });
  ...
  describe('ListTokensRequest', function() {
    it('should create an instance of ListTokensRequest', function() {
      ...
      //var instance = new AwsLicenseManager.ListTokensRequest();
      //expect(instance).to.be.a(AwsLicenseManager.ListTokensRequest);
    });
