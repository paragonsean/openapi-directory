...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListLicensesResponse();
  });
  ...
  describe('ListLicensesResponse', function() {
    it('should create an instance of ListLicensesResponse', function() {
      // uncomment below and update the code to test ListLicensesResponse
      //var instance = new AwsLicenseManager.ListLicensesResponse();
      //expect(instance).to.be.a(AwsLicenseManager.ListLicensesResponse);
    });
