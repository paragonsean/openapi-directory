...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ProductInformation();
  });
  ...
  describe('ProductInformation', function() {
    it('should create an instance of ProductInformation', function() {
      ...
      //var instance = new AwsLicenseManager.ProductInformation();
      //expect(instance).to.be.a(AwsLicenseManager.ProductInformation);
    });
    ...
    it('should have the property productInformationFilterList (base name: "ProductInformationFilterList")', function() {
      // uncomment below and update the code to test the property productInformationFilterList
      //var instance = new AwsLicenseManager.ProductInformation();
      //expect(instance).to.be();
    });
