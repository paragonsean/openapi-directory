...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.CreateGrantVersionRequest();
  });
  ...
  describe('CreateGrantVersionRequest', function() {
    it('should create an instance of CreateGrantVersionRequest', function() {
      // uncomment below and update the code to test CreateGrantVersionRequest
      //var instance = new AwsLicenseManager.CreateGrantVersionRequest();
      //expect(instance).to.be.a(AwsLicenseManager.CreateGrantVersionRequest);
    });
