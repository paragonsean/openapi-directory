...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.GrantedLicense();
  });
  ...
  describe('GrantedLicense', function() {
    it('should create an instance of GrantedLicense', function() {
      // uncomment below and update the code to test GrantedLicense
      //var instance = new AwsLicenseManager.GrantedLicense();
      //expect(instance).to.be.a(AwsLicenseManager.GrantedLicense);
    });
    ...
    it('should have the property receivedMetadata (base name: "ReceivedMetadata")', function() {
      // uncomment below and update the code to test the property receivedMetadata
      //var instance = new AwsLicenseManager.GrantedLicense();
      //expect(instance).to.be();
    });
