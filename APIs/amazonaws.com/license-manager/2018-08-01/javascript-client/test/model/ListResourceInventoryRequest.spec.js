...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListResourceInventoryRequest();
  });
  ...
  describe('ListResourceInventoryRequest', function() {
    it('should create an instance of ListResourceInventoryRequest', function() {
      // uncomment below and update the code to test ListResourceInventoryRequest
      //var instance = new AwsLicenseManager.ListResourceInventoryRequest();
      //expect(instance).to.be.a(AwsLicenseManager.ListResourceInventoryRequest);
    });
