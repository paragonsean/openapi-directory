...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.CreateTokenResponse();
  });
  ...
  describe('CreateTokenResponse', function() {
    it('should create an instance of CreateTokenResponse', function() {
      ...
      //var instance = new AwsLicenseManager.CreateTokenResponse();
      //expect(instance).to.be.a(AwsLicenseManager.CreateTokenResponse);
    });
