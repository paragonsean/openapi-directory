...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListLicensesRequest();
  });
  ...
  describe('ListLicensesRequest', function() {
    it('should create an instance of ListLicensesRequest', function() {
      // uncomment below and update the code to test ListLicensesRequest
      //var instance = new AwsLicenseManager.ListLicensesRequest();
      //expect(instance).to.be.a(AwsLicenseManager.ListLicensesRequest);
    });
