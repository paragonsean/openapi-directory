...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsLicenseManager.ListTokensResponse();
  });
  ...
  describe('ListTokensResponse', function() {
    it('should create an instance of ListTokensResponse', function() {
      // uncomment below and update the code to test ListTokensResponse
      //var instance = new AwsLicenseManager.ListTokensResponse();
      //expect(instance).to.be.a(AwsLicenseManager.ListTokensResponse);
    });
