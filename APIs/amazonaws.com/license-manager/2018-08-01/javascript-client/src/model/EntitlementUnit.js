...
* @readonly
*/
export default class EntitlementUnit {
    ...
    /**
    * Returns a <code>EntitlementUnit</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EntitlementUnit} The enum <code>EntitlementUnit</code> value.
    */
