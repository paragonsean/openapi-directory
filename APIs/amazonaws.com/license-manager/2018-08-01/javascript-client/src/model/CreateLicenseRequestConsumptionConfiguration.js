...
/**
 * The CreateLicenseRequestConsumptionConfiguration model module.
 * @module model/CreateLicenseRequestConsumptionConfiguration
 * @version 2018-08-01
 */
class CreateLicenseRequestConsumptionConfiguration {
    /**
     * Constructs a new <code>CreateLicenseRequestConsumptionConfiguration</code>.
     * @alias module:model/CreateLicenseRequestConsumptionConfiguration
     * @implements module:model/ConsumptionConfiguration
     */
    constructor() { 
        ConsumptionConfiguration.initialize(this);
        CreateLicenseRequestConsumptionConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateLicenseRequestConsumptionConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLicenseRequestConsumptionConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateLicenseRequestConsumptionConfiguration} The populated <code>CreateLicenseRequestConsumptionConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLicenseRequestConsumptionConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLicenseRequestConsumptionConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLicenseRequestConsumptionConfiguration</code>.
     */
 ...
 */
CreateLicenseRequestConsumptionConfiguration.prototype['RenewType'] = undefined;

/**
 * @member {module:model/ConsumptionConfigurationProvisionalConfiguration} ProvisionalConfiguration
 */
CreateLicenseRequestConsumptionConfiguration.prototype['ProvisionalConfiguration'] = undefined;

/**
 * @member {module:model/ConsumptionConfigurationBorrowConfiguration} BorrowConfiguration
 */
CreateLicenseRequestConsumptionConfiguration.prototype['BorrowConfiguration'] = undefined;
...
export default CreateLicenseRequestConsumptionConfiguration;
