...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://license-manager.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://license-manager.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-08-01/Javascript'
        };
