...
class CreateLicenseRequestConsumptionConfiguration(Model):
    ...
    def __init__(self, renew_type: RenewType=None, provisional_configuration: ConsumptionConfigurationProvisionalConfiguration=None, borrow_configuration: ConsumptionConfigurationBorrowConfiguration=None):
        """CreateLicenseRequestConsumptionConfiguration - a model defined in OpenAPI

        :param renew_type: The renew_type of this CreateLicenseRequestConsumptionConfiguration.
        :param provisional_configuration: The provisional_configuration of this CreateLicenseRequestConsumptionConfiguration.
        :param borrow_configuration: The borrow_configuration of this CreateLicenseRequestConsumptionConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateLicenseRequestConsumptionConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateLicenseRequest_ConsumptionConfiguration of this CreateLicenseRequestConsumptionConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def renew_type(self):
        """Gets the renew_type of this CreateLicenseRequestConsumptionConfiguration.


        :return: The renew_type of this CreateLicenseRequestConsumptionConfiguration.
        :rtype: RenewType
        """
    ...
    def renew_type(self, renew_type):
        """Sets the renew_type of this CreateLicenseRequestConsumptionConfiguration.
    ...
    def provisional_configuration(self):
        """Gets the provisional_configuration of this CreateLicenseRequestConsumptionConfiguration.


        :return: The provisional_configuration of this CreateLicenseRequestConsumptionConfiguration.
    ...
    def provisional_configuration(self, provisional_configuration):
        """Sets the provisional_configuration of this CreateLicenseRequestConsumptionConfiguration.
    ...
    def borrow_configuration(self):
        """Gets the borrow_configuration of this CreateLicenseRequestConsumptionConfiguration.


        :return: The borrow_configuration of this CreateLicenseRequestConsumptionConfiguration.
    ...
    def borrow_configuration(self, borrow_configuration):
        """Sets the borrow_configuration of this CreateLicenseRequestConsumptionConfiguration.
