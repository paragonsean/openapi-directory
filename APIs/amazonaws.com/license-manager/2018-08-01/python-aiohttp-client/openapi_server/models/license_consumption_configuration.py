...
class LicenseConsumptionConfiguration(Model):
    ...
    def __init__(self, renew_type: RenewType=None, provisional_configuration: ConsumptionConfigurationProvisionalConfiguration=None, borrow_configuration: ConsumptionConfigurationBorrowConfiguration=None):
        """LicenseConsumptionConfiguration - a model defined in OpenAPI

        :param renew_type: The renew_type of this LicenseConsumptionConfiguration.
        :param provisional_configuration: The provisional_configuration of this LicenseConsumptionConfiguration.
        :param borrow_configuration: The borrow_configuration of this LicenseConsumptionConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'LicenseConsumptionConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The License_ConsumptionConfiguration of this LicenseConsumptionConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def renew_type(self):
        """Gets the renew_type of this LicenseConsumptionConfiguration.


        :return: The renew_type of this LicenseConsumptionConfiguration.
        :rtype: RenewType
        """
    ...
    def renew_type(self, renew_type):
        """Sets the renew_type of this LicenseConsumptionConfiguration.
    ...
    def provisional_configuration(self):
        """Gets the provisional_configuration of this LicenseConsumptionConfiguration.


        :return: The provisional_configuration of this LicenseConsumptionConfiguration.
    ...
    def provisional_configuration(self, provisional_configuration):
        """Sets the provisional_configuration of this LicenseConsumptionConfiguration.
    ...
    def borrow_configuration(self):
        """Gets the borrow_configuration of this LicenseConsumptionConfiguration.


        :return: The borrow_configuration of this LicenseConsumptionConfiguration.
    ...
    def borrow_configuration(self, borrow_configuration):
        """Sets the borrow_configuration of this LicenseConsumptionConfiguration.
