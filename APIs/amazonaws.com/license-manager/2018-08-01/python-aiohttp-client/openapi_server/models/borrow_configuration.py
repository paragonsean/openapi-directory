...
class BorrowConfiguration(Model):
    ...
    def __init__(self, allow_early_check_in: bool=None, max_time_to_live_in_minutes: int=None):
        """BorrowConfiguration - a model defined in OpenAPI

        :param allow_early_check_in: The allow_early_check_in of this BorrowConfiguration.
        :param max_time_to_live_in_minutes: The max_time_to_live_in_minutes of this BorrowConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BorrowConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BorrowConfiguration of this BorrowConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def allow_early_check_in(self):
        """Gets the allow_early_check_in of this BorrowConfiguration.


        :return: The allow_early_check_in of this BorrowConfiguration.
        :rtype: bool
        """
    ...
    def allow_early_check_in(self, allow_early_check_in):
        """Sets the allow_early_check_in of this BorrowConfiguration.
    ...
    def max_time_to_live_in_minutes(self):
        """Gets the max_time_to_live_in_minutes of this BorrowConfiguration.


        :return: The max_time_to_live_in_minutes of this BorrowConfiguration.
        :rtype: int
        """
    ...
    def max_time_to_live_in_minutes(self, max_time_to_live_in_minutes):
        """Sets the max_time_to_live_in_minutes of this BorrowConfiguration.
