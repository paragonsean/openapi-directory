...
public class GetCellResponse {
  ...
  public GetCellResponse cellArn(String cellArn) {
  ...
  public GetCellResponse cellName(String cellName) {
  ...
  public GetCellResponse cells(List cells) {
    this.cells = cells;
    return this;
  }
  ...
  public GetCellResponse parentReadinessScopes(List parentReadinessScopes) {
  ...
  public GetCellResponse tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCellResponse getCellResponse = (GetCellResponse) o;
    return Objects.equals(this.cellArn, getCellResponse.cellArn) &&
        Objects.equals(this.cellName, getCellResponse.cellName) &&
        Objects.equals(this.cells, getCellResponse.cells) &&
        Objects.equals(this.parentReadinessScopes, getCellResponse.parentReadinessScopes) &&
        Objects.equals(this.tags, getCellResponse.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCellResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCellResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCellResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetCellResponse is not found in the empty JSON string", GetCellResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCellResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetCellResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCellResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCellResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCellResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCellResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCellResponse>() {
           @Override
           public void write(JsonWriter out, GetCellResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCellResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCellResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCellResponse
   * @throws IOException if the JSON string is invalid with respect to GetCellResponse
   */
  public static GetCellResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCellResponse.class);
  }

  /**
   * Convert an instance of GetCellResponse to an JSON string
   *
   * @return JSON string
   */
