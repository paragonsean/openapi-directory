...
public class ApiClient {
    ...
    private String basePath = "http://route53-recovery-readiness.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://route53-recovery-readiness.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://route53-recovery-readiness.{region}.amazonaws.com",
      "The AWS Route53 Recovery Readiness multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://route53-recovery-readiness.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://route53-recovery-readiness.{region}.amazonaws.com.cn",
      "The AWS Route53 Recovery Readiness endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://route53-recovery-readiness.us-east-1.amazonaws.com
