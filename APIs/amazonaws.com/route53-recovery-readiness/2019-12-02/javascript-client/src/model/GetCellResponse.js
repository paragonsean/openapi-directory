...
/**
 * The GetCellResponse model module.
 * @module model/GetCellResponse
 * @version 2019-12-02
 */
class GetCellResponse {
    /**
     * Constructs a new <code>GetCellResponse</code>.
     * @alias module:model/GetCellResponse
     */
    constructor() { 
        
        GetCellResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetCellResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetCellResponse} obj Optional instance to populate.
     * @return {module:model/GetCellResponse} The populated <code>GetCellResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetCellResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GetCellResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetCellResponse</code>.
     */
 ...
 */
GetCellResponse.prototype['CellArn'] = undefined;

/**
 * @member {String} CellName
 */
GetCellResponse.prototype['CellName'] = undefined;

/**
 * @member {Array} Cells
 */
GetCellResponse.prototype['Cells'] = undefined;

/**
 * @member {Array} ParentReadinessScopes
 */
GetCellResponse.prototype['ParentReadinessScopes'] = undefined;

/**
 * @member {Object} Tags
 */
GetCellResponse.prototype['Tags'] = undefined;
...
export default GetCellResponse;
