...
/**
 * The CreateCellResponse model module.
 * @module model/CreateCellResponse
 * @version 2019-12-02
 */
class CreateCellResponse {
    /**
     * Constructs a new <code>CreateCellResponse</code>.
     * @alias module:model/CreateCellResponse
     */
    constructor() { 
        
        CreateCellResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateCellResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateCellResponse} obj Optional instance to populate.
     * @return {module:model/CreateCellResponse} The populated <code>CreateCellResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateCellResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCellResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCellResponse</code>.
     */
 ...
 */
CreateCellResponse.prototype['CellArn'] = undefined;

/**
 * @member {String} CellName
 */
CreateCellResponse.prototype['CellName'] = undefined;

/**
 * @member {Array} Cells
 */
CreateCellResponse.prototype['Cells'] = undefined;

/**
 * @member {Array} ParentReadinessScopes
 */
CreateCellResponse.prototype['ParentReadinessScopes'] = undefined;

/**
 * @member {Object} Tags
 */
CreateCellResponse.prototype['Tags'] = undefined;
...
export default CreateCellResponse;
