...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryReadiness.ListRulesOutput();
  });
  ...
  describe('ListRulesOutput', function() {
    it('should create an instance of ListRulesOutput', function() {
      // uncomment below and update the code to test ListRulesOutput
      //var instance = new AwsRoute53RecoveryReadiness.ListRulesOutput();
      //expect(instance).to.be.a(AwsRoute53RecoveryReadiness.ListRulesOutput);
    });
