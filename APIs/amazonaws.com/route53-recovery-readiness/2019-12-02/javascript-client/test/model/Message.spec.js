...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryReadiness.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new AwsRoute53RecoveryReadiness.Message();
      //expect(instance).to.be.a(AwsRoute53RecoveryReadiness.Message);
    });
