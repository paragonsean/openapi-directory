...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryReadiness.ListCellsResponse();
  });
  ...
  describe('ListCellsResponse', function() {
    it('should create an instance of ListCellsResponse', function() {
      // uncomment below and update the code to test ListCellsResponse
      //var instance = new AwsRoute53RecoveryReadiness.ListCellsResponse();
      //expect(instance).to.be.a(AwsRoute53RecoveryReadiness.ListCellsResponse);
    });
