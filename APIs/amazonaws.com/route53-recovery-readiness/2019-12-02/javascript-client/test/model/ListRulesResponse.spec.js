...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsRoute53RecoveryReadiness.ListRulesResponse();
  });
  ...
  describe('ListRulesResponse', function() {
    it('should create an instance of ListRulesResponse', function() {
      ...
      //var instance = new AwsRoute53RecoveryReadiness.ListRulesResponse();
      //expect(instance).to.be.a(AwsRoute53RecoveryReadiness.ListRulesResponse);
    });
