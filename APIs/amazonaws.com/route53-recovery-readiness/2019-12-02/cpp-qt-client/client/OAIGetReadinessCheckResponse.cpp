...
OAIGetReadinessCheckResponse::OAIGetReadinessCheckResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetReadinessCheckResponse::OAIGetReadinessCheckResponse() {
    this->initializeModel();
}

OAIGetReadinessCheckResponse::~OAIGetReadinessCheckResponse() {}

void OAIGetReadinessCheckResponse::initializeModel() {
...
void OAIGetReadinessCheckResponse::fromJson(QString jsonString) {
...
void OAIGetReadinessCheckResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetReadinessCheckResponse::asJson() const {
...
QJsonObject OAIGetReadinessCheckResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetReadinessCheckResponse::getReadinessCheckArn() const {
    return m_readiness_check_arn;
}
void OAIGetReadinessCheckResponse::setReadinessCheckArn(const QString &readiness_check_arn) {
    m_readiness_check_arn = readiness_check_arn;
    m_readiness_check_arn_isSet = true;
}

bool OAIGetReadinessCheckResponse::is_readiness_check_arn_Set() const{
    return m_readiness_check_arn_isSet;
}

bool OAIGetReadinessCheckResponse::is_readiness_check_arn_Valid() const{
    return m_readiness_check_arn_isValid;
}

QString OAIGetReadinessCheckResponse::getReadinessCheckName() const {
    return m_readiness_check_name;
}
void OAIGetReadinessCheckResponse::setReadinessCheckName(const QString &readiness_check_name) {
    m_readiness_check_name = readiness_check_name;
    m_readiness_check_name_isSet = true;
}

bool OAIGetReadinessCheckResponse::is_readiness_check_name_Set() const{
    return m_readiness_check_name_isSet;
}

bool OAIGetReadinessCheckResponse::is_readiness_check_name_Valid() const{
    return m_readiness_check_name_isValid;
}

QString OAIGetReadinessCheckResponse::getResourceSet() const {
    return m_resource_set;
}
void OAIGetReadinessCheckResponse::setResourceSet(const QString &resource_set) {
    m_resource_set = resource_set;
    m_resource_set_isSet = true;
}

bool OAIGetReadinessCheckResponse::is_resource_set_Set() const{
    return m_resource_set_isSet;
}

bool OAIGetReadinessCheckResponse::is_resource_set_Valid() const{
    return m_resource_set_isValid;
}

QMap OAIGetReadinessCheckResponse::getTags() const {
    return m_tags;
}
void OAIGetReadinessCheckResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIGetReadinessCheckResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIGetReadinessCheckResponse::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAIGetReadinessCheckResponse::isSet() const {
...
bool OAIGetReadinessCheckResponse::isValid() const {
