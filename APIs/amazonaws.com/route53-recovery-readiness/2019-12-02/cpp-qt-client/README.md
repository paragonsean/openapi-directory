...
OAICreateCell_request Example::create(){
    OAICreateCell_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createCellSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createCellSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateCell_request oai_create_cell_request = create(); // OAICreateCell_request | 
      ...
      apiInstance.createCell(oai_create_cell_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
