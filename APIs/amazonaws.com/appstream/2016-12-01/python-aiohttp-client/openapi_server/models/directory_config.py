...
class DirectoryConfig(Model):
    ...
    def __init__(self, directory_name: str=None, organizational_unit_distinguished_names: List=None, service_account_credentials: CreateDirectoryConfigRequestServiceAccountCredentials=None, created_time: datetime=None, certificate_based_auth_properties: CreateDirectoryConfigRequestCertificateBasedAuthProperties=None):
        """DirectoryConfig - a model defined in OpenAPI

        :param directory_name: The directory_name of this DirectoryConfig.
        :param organizational_unit_distinguished_names: The organizational_unit_distinguished_names of this DirectoryConfig.
        :param service_account_credentials: The service_account_credentials of this DirectoryConfig.
        :param created_time: The created_time of this DirectoryConfig.
        :param certificate_based_auth_properties: The certificate_based_auth_properties of this DirectoryConfig.
        """
        self.openapi_types = {
            'directory_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DirectoryConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DirectoryConfig of this DirectoryConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def directory_name(self):
        """Gets the directory_name of this DirectoryConfig.


        :return: The directory_name of this DirectoryConfig.
        :rtype: str
        """
    ...
    def directory_name(self, directory_name):
        """Sets the directory_name of this DirectoryConfig.
    ...
    def organizational_unit_distinguished_names(self):
        """Gets the organizational_unit_distinguished_names of this DirectoryConfig.


        :return: The organizational_unit_distinguished_names of this DirectoryConfig.
        :rtype: List
        """
    ...
    def organizational_unit_distinguished_names(self, organizational_unit_distinguished_names):
        """Sets the organizational_unit_distinguished_names of this DirectoryConfig.
    ...
    def service_account_credentials(self):
        """Gets the service_account_credentials of this DirectoryConfig.


        :return: The service_account_credentials of this DirectoryConfig.
    ...
    def service_account_credentials(self, service_account_credentials):
        """Sets the service_account_credentials of this DirectoryConfig.
    ...
    def created_time(self):
        """Gets the created_time of this DirectoryConfig.


        :return: The created_time of this DirectoryConfig.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        """Sets the created_time of this DirectoryConfig.
    ...
    def certificate_based_auth_properties(self):
        """Gets the certificate_based_auth_properties of this DirectoryConfig.


        :return: The certificate_based_auth_properties of this DirectoryConfig.
    ...
    def certificate_based_auth_properties(self, certificate_based_auth_properties):
        """Sets the certificate_based_auth_properties of this DirectoryConfig.
