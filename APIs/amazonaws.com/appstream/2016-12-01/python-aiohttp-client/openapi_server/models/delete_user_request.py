...
class DeleteUserRequest(Model):
    ...
    def __init__(self, user_name: str=None, authentication_type: AuthenticationType=None):
        ...
        :param authentication_type: The authentication_type of this DeleteUserRequest.
        """
        self.openapi_types = {
            'user_name': str,
    ...
    def authentication_type(self):
        """Gets the authentication_type of this DeleteUserRequest.


        :return: The authentication_type of this DeleteUserRequest.
    ...
    def authentication_type(self, authentication_type):
        """Sets the authentication_type of this DeleteUserRequest.
