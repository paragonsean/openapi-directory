...
class DescribeFleetsResult {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Fleets')) {
                obj['Fleets'] = ApiClient.convertToType(data['Fleets'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeFleetsResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeFleetsResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Fleets`
        if (data['Fleets']) { // data not null
          Array.validateJSON(data['Fleets']);
        }
...
export default DescribeFleetsResult;
