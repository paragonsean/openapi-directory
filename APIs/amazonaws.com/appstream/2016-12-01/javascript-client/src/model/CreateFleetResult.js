...
import CreateFleetResultFleet from './CreateFleetResultFleet';
...
class CreateFleetResult {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Fleet')) {
                obj['Fleet'] = CreateFleetResultFleet.constructFromObject(data['Fleet']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFleetResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFleetResult</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Fleet`
        if (data['Fleet']) { // data not null
          CreateFleetResultFleet.validateJSON(data['Fleet']);
        }
...
/**
 * @member {module:model/CreateFleetResultFleet} Fleet
 */
CreateFleetResult.prototype['Fleet'] = undefined;
