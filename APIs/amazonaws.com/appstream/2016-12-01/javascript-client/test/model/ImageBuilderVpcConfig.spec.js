...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.ImageBuilderVpcConfig();
  });
  ...
  describe('ImageBuilderVpcConfig', function() {
    it('should create an instance of ImageBuilderVpcConfig', function() {
      // uncomment below and update the code to test ImageBuilderVpcConfig
      //var instance = new AmazonAppStream.ImageBuilderVpcConfig();
      //expect(instance).to.be.a(AmazonAppStream.ImageBuilderVpcConfig);
    });
