...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeImageBuildersRequest();
  });
  ...
  describe('DescribeImageBuildersRequest', function() {
    it('should create an instance of DescribeImageBuildersRequest', function() {
      // uncomment below and update the code to test DescribeImageBuildersRequest
      //var instance = new AmazonAppStream.DescribeImageBuildersRequest();
      //expect(instance).to.be.a(AmazonAppStream.DescribeImageBuildersRequest);
    });
