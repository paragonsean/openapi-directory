...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeSessionsResult();
  });
  ...
  describe('DescribeSessionsResult', function() {
    it('should create an instance of DescribeSessionsResult', function() {
      // uncomment below and update the code to test DescribeSessionsResult
      //var instance = new AmazonAppStream.DescribeSessionsResult();
      //expect(instance).to.be.a(AmazonAppStream.DescribeSessionsResult);
    });
