...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.FleetVpcConfig();
  });
  ...
  describe('FleetVpcConfig', function() {
    it('should create an instance of FleetVpcConfig', function() {
      // uncomment below and update the code to test FleetVpcConfig
      //var instance = new AmazonAppStream.FleetVpcConfig();
      //expect(instance).to.be.a(AmazonAppStream.FleetVpcConfig);
    });
