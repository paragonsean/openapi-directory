...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateImageBuilderResultImageBuilder();
  });
  ...
  describe('CreateImageBuilderResultImageBuilder', function() {
    it('should create an instance of CreateImageBuilderResultImageBuilder', function() {
      // uncomment below and update the code to test CreateImageBuilderResultImageBuilder
      //var instance = new AmazonAppStream.CreateImageBuilderResultImageBuilder();
      //expect(instance).to.be.a(AmazonAppStream.CreateImageBuilderResultImageBuilder);
    });
    ...
    it('should have the property imageBuilderErrors (base name: "ImageBuilderErrors")', function() {
      // uncomment below and update the code to test the property imageBuilderErrors
      //var instance = new AmazonAppStream.CreateImageBuilderResultImageBuilder();
      //expect(instance).to.be();
    });
