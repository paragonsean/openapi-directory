...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateStackResultStack();
  });
  ...
  describe('CreateStackResultStack', function() {
    it('should create an instance of CreateStackResultStack', function() {
      // uncomment below and update the code to test CreateStackResultStack
      //var instance = new AmazonAppStream.CreateStackResultStack();
      //expect(instance).to.be.a(AmazonAppStream.CreateStackResultStack);
    });
