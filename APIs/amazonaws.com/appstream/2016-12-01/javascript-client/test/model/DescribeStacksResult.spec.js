...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeStacksResult();
  });
  ...
  describe('DescribeStacksResult', function() {
    it('should create an instance of DescribeStacksResult', function() {
      // uncomment below and update the code to test DescribeStacksResult
      //var instance = new AmazonAppStream.DescribeStacksResult();
      //expect(instance).to.be.a(AmazonAppStream.DescribeStacksResult);
    });
