...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeEntitlementsRequest();
  });
  ...
  describe('DescribeEntitlementsRequest', function() {
    it('should create an instance of DescribeEntitlementsRequest', function() {
      // uncomment below and update the code to test DescribeEntitlementsRequest
      //var instance = new AmazonAppStream.DescribeEntitlementsRequest();
      //expect(instance).to.be.a(AmazonAppStream.DescribeEntitlementsRequest);
    });
