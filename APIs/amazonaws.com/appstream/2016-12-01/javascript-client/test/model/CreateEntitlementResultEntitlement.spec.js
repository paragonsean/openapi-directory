...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateEntitlementResultEntitlement();
  });
  ...
  describe('CreateEntitlementResultEntitlement', function() {
    it('should create an instance of CreateEntitlementResultEntitlement', function() {
      // uncomment below and update the code to test CreateEntitlementResultEntitlement
      //var instance = new AmazonAppStream.CreateEntitlementResultEntitlement();
      //expect(instance).to.be.a(AmazonAppStream.CreateEntitlementResultEntitlement);
    });
