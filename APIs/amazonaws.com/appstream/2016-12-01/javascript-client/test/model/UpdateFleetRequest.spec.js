...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.UpdateFleetRequest();
  });
  ...
  describe('UpdateFleetRequest', function() {
    it('should create an instance of UpdateFleetRequest', function() {
      ...
      //var instance = new AmazonAppStream.UpdateFleetRequest();
      //expect(instance).to.be.a(AmazonAppStream.UpdateFleetRequest);
    });
    ...
    it('should have the property deleteVpcConfig (base name: "DeleteVpcConfig")', function() {
      // uncomment below and update the code to test the property deleteVpcConfig
      //var instance = new AmazonAppStream.UpdateFleetRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property attributesToDelete (base name: "AttributesToDelete")', function() {
      // uncomment below and update the code to test the property attributesToDelete
      //var instance = new AmazonAppStream.UpdateFleetRequest();
      //expect(instance).to.be();
    });
