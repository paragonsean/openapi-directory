...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateUserRequest();
  });
  ...
  describe('CreateUserRequest', function() {
    it('should create an instance of CreateUserRequest', function() {
      ...
      //var instance = new AmazonAppStream.CreateUserRequest();
      //expect(instance).to.be.a(AmazonAppStream.CreateUserRequest);
    });
    ...
    it('should have the property messageAction (base name: "MessageAction")', function() {
      // uncomment below and update the code to test the property messageAction
      //var instance = new AmazonAppStream.CreateUserRequest();
      //expect(instance).to.be();
    });
