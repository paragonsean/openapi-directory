...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.AppBlockBuilderVpcConfig();
  });
  ...
  describe('AppBlockBuilderVpcConfig', function() {
    it('should create an instance of AppBlockBuilderVpcConfig', function() {
      // uncomment below and update the code to test AppBlockBuilderVpcConfig
      //var instance = new AmazonAppStream.AppBlockBuilderVpcConfig();
      //expect(instance).to.be.a(AmazonAppStream.AppBlockBuilderVpcConfig);
    });
