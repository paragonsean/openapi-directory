...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateFleetResultFleet();
  });
  ...
  describe('CreateFleetResultFleet', function() {
    it('should create an instance of CreateFleetResultFleet', function() {
      // uncomment below and update the code to test CreateFleetResultFleet
      //var instance = new AmazonAppStream.CreateFleetResultFleet();
      //expect(instance).to.be.a(AmazonAppStream.CreateFleetResultFleet);
    });
