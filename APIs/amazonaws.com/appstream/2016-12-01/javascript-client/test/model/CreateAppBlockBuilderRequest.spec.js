...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateAppBlockBuilderRequest();
  });
  ...
  describe('CreateAppBlockBuilderRequest', function() {
    it('should create an instance of CreateAppBlockBuilderRequest', function() {
      // uncomment below and update the code to test CreateAppBlockBuilderRequest
      //var instance = new AmazonAppStream.CreateAppBlockBuilderRequest();
      //expect(instance).to.be.a(AmazonAppStream.CreateAppBlockBuilderRequest);
    });
