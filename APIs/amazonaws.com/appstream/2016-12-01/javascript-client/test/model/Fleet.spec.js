...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.Fleet();
  });
  ...
  describe('Fleet', function() {
    it('should create an instance of Fleet', function() {
      ...
      //var instance = new AmazonAppStream.Fleet();
      //expect(instance).to.be.a(AmazonAppStream.Fleet);
    });
    ...
    it('should have the property computeCapacityStatus (base name: "ComputeCapacityStatus")', function() {
      // uncomment below and update the code to test the property computeCapacityStatus
      //var instance = new AmazonAppStream.Fleet();
      //expect(instance).to.be();
    });
    ...
    it('should have the property fleetErrors (base name: "FleetErrors")', function() {
      // uncomment below and update the code to test the property fleetErrors
      //var instance = new AmazonAppStream.Fleet();
      //expect(instance).to.be();
    });
