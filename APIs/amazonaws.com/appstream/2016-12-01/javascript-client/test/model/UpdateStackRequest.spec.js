...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.UpdateStackRequest();
  });
  ...
  describe('UpdateStackRequest', function() {
    it('should create an instance of UpdateStackRequest', function() {
      // uncomment below and update the code to test UpdateStackRequest
      //var instance = new AmazonAppStream.UpdateStackRequest();
      //expect(instance).to.be.a(AmazonAppStream.UpdateStackRequest);
    });
    ...
    it('should have the property deleteStorageConnectors (base name: "DeleteStorageConnectors")', function() {
      // uncomment below and update the code to test the property deleteStorageConnectors
      //var instance = new AmazonAppStream.UpdateStackRequest();
      //expect(instance).to.be();
    });
