...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.FleetComputeCapacityStatus();
  });
  ...
  describe('FleetComputeCapacityStatus', function() {
    it('should create an instance of FleetComputeCapacityStatus', function() {
      // uncomment below and update the code to test FleetComputeCapacityStatus
      //var instance = new AmazonAppStream.FleetComputeCapacityStatus();
      //expect(instance).to.be.a(AmazonAppStream.FleetComputeCapacityStatus);
    });
