...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.Entitlement();
  });
  ...
  describe('Entitlement', function() {
    it('should create an instance of Entitlement', function() {
      ...
      //var instance = new AmazonAppStream.Entitlement();
      //expect(instance).to.be.a(AmazonAppStream.Entitlement);
    });
    ...
    it('should have the property appVisibility (base name: "AppVisibility")', function() {
