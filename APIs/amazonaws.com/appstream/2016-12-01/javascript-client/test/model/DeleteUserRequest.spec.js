...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DeleteUserRequest();
  });
  ...
  describe('DeleteUserRequest', function() {
    it('should create an instance of DeleteUserRequest', function() {
      ...
      //var instance = new AmazonAppStream.DeleteUserRequest();
      //expect(instance).to.be.a(AmazonAppStream.DeleteUserRequest);
    });
