...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.AppBlockBuilder();
  });
  ...
  describe('AppBlockBuilder', function() {
    it('should create an instance of AppBlockBuilder', function() {
      // uncomment below and update the code to test AppBlockBuilder
      //var instance = new AmazonAppStream.AppBlockBuilder();
      //expect(instance).to.be.a(AmazonAppStream.AppBlockBuilder);
    });
    ...
    it('should have the property appBlockBuilderErrors (base name: "AppBlockBuilderErrors")', function() {
      // uncomment below and update the code to test the property appBlockBuilderErrors
      //var instance = new AmazonAppStream.AppBlockBuilder();
      //expect(instance).to.be();
    });

    it('should have the property stateChangeReason (base name: "StateChangeReason")', function() {
      // uncomment below and update the code to test the property stateChangeReason
      //var instance = new AmazonAppStream.AppBlockBuilder();
      //expect(instance).to.be();
    });
