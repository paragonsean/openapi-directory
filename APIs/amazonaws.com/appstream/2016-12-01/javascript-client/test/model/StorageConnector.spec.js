...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.StorageConnector();
  });
  ...
  describe('StorageConnector', function() {
    it('should create an instance of StorageConnector', function() {
      // uncomment below and update the code to test StorageConnector
      //var instance = new AmazonAppStream.StorageConnector();
      //expect(instance).to.be.a(AmazonAppStream.StorageConnector);
    });
