...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeUserStackAssociationsRequest();
  });
  ...
  describe('DescribeUserStackAssociationsRequest', function() {
    it('should create an instance of DescribeUserStackAssociationsRequest', function() {
      // uncomment below and update the code to test DescribeUserStackAssociationsRequest
      //var instance = new AmazonAppStream.DescribeUserStackAssociationsRequest();
      //expect(instance).to.be.a(AmazonAppStream.DescribeUserStackAssociationsRequest);
    });
