...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeAppBlockBuildersRequest();
  });
  ...
  describe('DescribeAppBlockBuildersRequest', function() {
    it('should create an instance of DescribeAppBlockBuildersRequest', function() {
      // uncomment below and update the code to test DescribeAppBlockBuildersRequest
      //var instance = new AmazonAppStream.DescribeAppBlockBuildersRequest();
      //expect(instance).to.be.a(AmazonAppStream.DescribeAppBlockBuildersRequest);
    });
