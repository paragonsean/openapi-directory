...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.CreateImageBuilderRequest();
  });
  ...
  describe('CreateImageBuilderRequest', function() {
    it('should create an instance of CreateImageBuilderRequest', function() {
      // uncomment below and update the code to test CreateImageBuilderRequest
      //var instance = new AmazonAppStream.CreateImageBuilderRequest();
      //expect(instance).to.be.a(AmazonAppStream.CreateImageBuilderRequest);
    });
    ...
    it('should have the property appstreamAgentVersion (base name: "AppstreamAgentVersion")', function() {
      // uncomment below and update the code to test the property appstreamAgentVersion
      //var instance = new AmazonAppStream.CreateImageBuilderRequest();
      //expect(instance).to.be();
    });
