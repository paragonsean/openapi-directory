...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.UpdateAppBlockBuilderRequest();
  });
  ...
  describe('UpdateAppBlockBuilderRequest', function() {
    it('should create an instance of UpdateAppBlockBuilderRequest', function() {
      // uncomment below and update the code to test UpdateAppBlockBuilderRequest
      //var instance = new AmazonAppStream.UpdateAppBlockBuilderRequest();
      //expect(instance).to.be.a(AmazonAppStream.UpdateAppBlockBuilderRequest);
    });
