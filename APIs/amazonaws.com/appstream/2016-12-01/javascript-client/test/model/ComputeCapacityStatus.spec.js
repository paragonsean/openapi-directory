...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.ComputeCapacityStatus();
  });
  ...
  describe('ComputeCapacityStatus', function() {
    it('should create an instance of ComputeCapacityStatus', function() {
      // uncomment below and update the code to test ComputeCapacityStatus
      //var instance = new AmazonAppStream.ComputeCapacityStatus();
      //expect(instance).to.be.a(AmazonAppStream.ComputeCapacityStatus);
    });
