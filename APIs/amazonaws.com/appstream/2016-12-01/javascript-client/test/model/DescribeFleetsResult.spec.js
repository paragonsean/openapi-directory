...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonAppStream.DescribeFleetsResult();
  });
  ...
  describe('DescribeFleetsResult', function() {
    it('should create an instance of DescribeFleetsResult', function() {
      // uncomment below and update the code to test DescribeFleetsResult
      //var instance = new AmazonAppStream.DescribeFleetsResult();
      //expect(instance).to.be.a(AmazonAppStream.DescribeFleetsResult);
    });
