...
public class AppBlock {
  ...
  public AppBlock name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AppBlock arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public AppBlock description(String description) {
  ...
  public AppBlock displayName(String displayName) {
  ...
  public AppBlock sourceS3Location(CreateAppBlockRequestSourceS3Location sourceS3Location) {
  ...
  public AppBlock setupScriptDetails(AppBlockSetupScriptDetails setupScriptDetails) {
  ...
  public AppBlock createdTime(OffsetDateTime createdTime) {
  ...
  public AppBlock postSetupScriptDetails(AppBlockPostSetupScriptDetails postSetupScriptDetails) {
  ...
  public AppBlock packagingType(PackagingType packagingType) {
  ...
  public AppBlock state(AppBlockState state) {
    this.state = state;
    return this;
  }
  ...
  public AppBlock appBlockErrors(List appBlockErrors) {
  ...
  public boolean equals(Object o) {
    ...
    AppBlock appBlock = (AppBlock) o;
    return Objects.equals(this.name, appBlock.name) &&
        Objects.equals(this.arn, appBlock.arn) &&
        Objects.equals(this.description, appBlock.description) &&
        Objects.equals(this.displayName, appBlock.displayName) &&
        Objects.equals(this.sourceS3Location, appBlock.sourceS3Location) &&
        Objects.equals(this.setupScriptDetails, appBlock.setupScriptDetails) &&
        Objects.equals(this.createdTime, appBlock.createdTime) &&
        Objects.equals(this.postSetupScriptDetails, appBlock.postSetupScriptDetails) &&
        Objects.equals(this.packagingType, appBlock.packagingType) &&
        Objects.equals(this.state, appBlock.state) &&
        Objects.equals(this.appBlockErrors, appBlock.appBlockErrors);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AppBlock
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AppBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppBlock is not found in the empty JSON string", AppBlock.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AppBlock.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AppBlock` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppBlock.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<AppBlock>() {
           @Override
           public void write(JsonWriter out, AppBlock value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AppBlock read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AppBlock given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AppBlock
   * @throws IOException if the JSON string is invalid with respect to AppBlock
   */
  public static AppBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppBlock.class);
  }

  /**
   * Convert an instance of AppBlock to an JSON string
   *
   * @return JSON string
   */
