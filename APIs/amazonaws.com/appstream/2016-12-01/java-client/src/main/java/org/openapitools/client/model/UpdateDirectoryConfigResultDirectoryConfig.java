...
public class UpdateDirectoryConfigResultDirectoryConfig {
  ...
  public UpdateDirectoryConfigResultDirectoryConfig() {
  }

  public UpdateDirectoryConfigResultDirectoryConfig directoryName(String directoryName) {
  ...
  public UpdateDirectoryConfigResultDirectoryConfig organizationalUnitDistinguishedNames(List organizationalUnitDistinguishedNames) {
  ...
  public UpdateDirectoryConfigResultDirectoryConfig serviceAccountCredentials(CreateDirectoryConfigRequestServiceAccountCredentials serviceAccountCredentials) {
  ...
  public UpdateDirectoryConfigResultDirectoryConfig createdTime(OffsetDateTime createdTime) {
  ...
  public UpdateDirectoryConfigResultDirectoryConfig certificateBasedAuthProperties(CreateDirectoryConfigRequestCertificateBasedAuthProperties certificateBasedAuthProperties) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDirectoryConfigResultDirectoryConfig updateDirectoryConfigResultDirectoryConfig = (UpdateDirectoryConfigResultDirectoryConfig) o;
    return Objects.equals(this.directoryName, updateDirectoryConfigResultDirectoryConfig.directoryName) &&
        Objects.equals(this.organizationalUnitDistinguishedNames, updateDirectoryConfigResultDirectoryConfig.organizationalUnitDistinguishedNames) &&
        Objects.equals(this.serviceAccountCredentials, updateDirectoryConfigResultDirectoryConfig.serviceAccountCredentials) &&
        Objects.equals(this.createdTime, updateDirectoryConfigResultDirectoryConfig.createdTime) &&
        Objects.equals(this.certificateBasedAuthProperties, updateDirectoryConfigResultDirectoryConfig.certificateBasedAuthProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDirectoryConfigResultDirectoryConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDirectoryConfigResultDirectoryConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDirectoryConfigResultDirectoryConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDirectoryConfigResultDirectoryConfig is not found in the empty JSON string", UpdateDirectoryConfigResultDirectoryConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDirectoryConfigResultDirectoryConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDirectoryConfigResultDirectoryConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDirectoryConfigResultDirectoryConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDirectoryConfigResultDirectoryConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDirectoryConfigResultDirectoryConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDirectoryConfigResultDirectoryConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDirectoryConfigResultDirectoryConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDirectoryConfigResultDirectoryConfig>() {
           @Override
           public void write(JsonWriter out, UpdateDirectoryConfigResultDirectoryConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDirectoryConfigResultDirectoryConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDirectoryConfigResultDirectoryConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDirectoryConfigResultDirectoryConfig
   * @throws IOException if the JSON string is invalid with respect to UpdateDirectoryConfigResultDirectoryConfig
   */
  public static UpdateDirectoryConfigResultDirectoryConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDirectoryConfigResultDirectoryConfig.class);
  }

  /**
   * Convert an instance of UpdateDirectoryConfigResultDirectoryConfig to an JSON string
   *
   * @return JSON string
   */
