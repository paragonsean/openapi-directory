...
public class UpdateDirectoryConfigRequest {
  ...
  public UpdateDirectoryConfigRequest() {
  }

  public UpdateDirectoryConfigRequest directoryName(String directoryName) {
  ...
  public UpdateDirectoryConfigRequest organizationalUnitDistinguishedNames(List organizationalUnitDistinguishedNames) {
  ...
  public UpdateDirectoryConfigRequest serviceAccountCredentials(CreateDirectoryConfigRequestServiceAccountCredentials serviceAccountCredentials) {
  ...
  public UpdateDirectoryConfigRequest certificateBasedAuthProperties(CreateDirectoryConfigRequestCertificateBasedAuthProperties certificateBasedAuthProperties) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDirectoryConfigRequest updateDirectoryConfigRequest = (UpdateDirectoryConfigRequest) o;
    return Objects.equals(this.directoryName, updateDirectoryConfigRequest.directoryName) &&
        Objects.equals(this.organizationalUnitDistinguishedNames, updateDirectoryConfigRequest.organizationalUnitDistinguishedNames) &&
        Objects.equals(this.serviceAccountCredentials, updateDirectoryConfigRequest.serviceAccountCredentials) &&
        Objects.equals(this.certificateBasedAuthProperties, updateDirectoryConfigRequest.certificateBasedAuthProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDirectoryConfigRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDirectoryConfigRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDirectoryConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDirectoryConfigRequest is not found in the empty JSON string", UpdateDirectoryConfigRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDirectoryConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDirectoryConfigRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDirectoryConfigRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDirectoryConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDirectoryConfigRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDirectoryConfigRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDirectoryConfigRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDirectoryConfigRequest>() {
           @Override
           public void write(JsonWriter out, UpdateDirectoryConfigRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDirectoryConfigRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDirectoryConfigRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDirectoryConfigRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateDirectoryConfigRequest
   */
  public static UpdateDirectoryConfigRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDirectoryConfigRequest.class);
  }

  /**
   * Convert an instance of UpdateDirectoryConfigRequest to an JSON string
   *
   * @return JSON string
   */
