...
public class DeleteImageResultImage {
  ...
  public DeleteImageResultImage() {
  }

  public DeleteImageResultImage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeleteImageResultImage arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DeleteImageResultImage baseImageArn(String baseImageArn) {
  ...
  public DeleteImageResultImage displayName(String displayName) {
  ...
  public DeleteImageResultImage state(ImageState state) {
    this.state = state;
    return this;
  }
  ...
  public DeleteImageResultImage visibility(VisibilityType visibility) {
  ...
  public DeleteImageResultImage imageBuilderSupported(Boolean imageBuilderSupported) {
  ...
  public DeleteImageResultImage imageBuilderName(String imageBuilderName) {
  ...
  public DeleteImageResultImage platform(PlatformType platform) {
  ...
  public DeleteImageResultImage description(String description) {
  ...
  public DeleteImageResultImage stateChangeReason(ImageStateChangeReason stateChangeReason) {
  ...
  public DeleteImageResultImage applications(List applications) {
  ...
  public DeleteImageResultImage createdTime(OffsetDateTime createdTime) {
  ...
  public DeleteImageResultImage publicBaseImageReleasedDate(OffsetDateTime publicBaseImageReleasedDate) {
  ...
  public DeleteImageResultImage appstreamAgentVersion(String appstreamAgentVersion) {
  ...
  public DeleteImageResultImage imagePermissions(ImageImagePermissions imagePermissions) {
  ...
  public DeleteImageResultImage imageErrors(List imageErrors) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteImageResultImage deleteImageResultImage = (DeleteImageResultImage) o;
    return Objects.equals(this.name, deleteImageResultImage.name) &&
        Objects.equals(this.arn, deleteImageResultImage.arn) &&
        Objects.equals(this.baseImageArn, deleteImageResultImage.baseImageArn) &&
        Objects.equals(this.displayName, deleteImageResultImage.displayName) &&
        Objects.equals(this.state, deleteImageResultImage.state) &&
        Objects.equals(this.visibility, deleteImageResultImage.visibility) &&
        Objects.equals(this.imageBuilderSupported, deleteImageResultImage.imageBuilderSupported) &&
        Objects.equals(this.imageBuilderName, deleteImageResultImage.imageBuilderName) &&
        Objects.equals(this.platform, deleteImageResultImage.platform) &&
        Objects.equals(this.description, deleteImageResultImage.description) &&
        Objects.equals(this.stateChangeReason, deleteImageResultImage.stateChangeReason) &&
        Objects.equals(this.applications, deleteImageResultImage.applications) &&
        Objects.equals(this.createdTime, deleteImageResultImage.createdTime) &&
        Objects.equals(this.publicBaseImageReleasedDate, deleteImageResultImage.publicBaseImageReleasedDate) &&
        Objects.equals(this.appstreamAgentVersion, deleteImageResultImage.appstreamAgentVersion) &&
        Objects.equals(this.imagePermissions, deleteImageResultImage.imagePermissions) &&
        Objects.equals(this.imageErrors, deleteImageResultImage.imageErrors);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteImageResultImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteImageResultImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteImageResultImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteImageResultImage is not found in the empty JSON string", DeleteImageResultImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteImageResultImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteImageResultImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteImageResultImage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteImageResultImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteImageResultImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteImageResultImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteImageResultImage.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteImageResultImage>() {
           @Override
           public void write(JsonWriter out, DeleteImageResultImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteImageResultImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteImageResultImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteImageResultImage
   * @throws IOException if the JSON string is invalid with respect to DeleteImageResultImage
   */
  public static DeleteImageResultImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteImageResultImage.class);
  }

  /**
   * Convert an instance of DeleteImageResultImage to an JSON string
   *
   * @return JSON string
   */
