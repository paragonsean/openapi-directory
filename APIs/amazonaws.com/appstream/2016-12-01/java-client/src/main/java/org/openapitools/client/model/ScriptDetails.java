...
public class ScriptDetails {
  ...
  public ScriptDetails scriptS3Location(ScriptDetailsScriptS3Location scriptS3Location) {
  ...
  public ScriptDetails executablePath(String executablePath) {
  ...
  public ScriptDetails executableParameters(String executableParameters) {
  ...
  public ScriptDetails timeoutInSeconds(Integer timeoutInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    ScriptDetails scriptDetails = (ScriptDetails) o;
    return Objects.equals(this.scriptS3Location, scriptDetails.scriptS3Location) &&
        Objects.equals(this.executablePath, scriptDetails.executablePath) &&
        Objects.equals(this.executableParameters, scriptDetails.executableParameters) &&
        Objects.equals(this.timeoutInSeconds, scriptDetails.timeoutInSeconds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScriptDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScriptDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScriptDetails is not found in the empty JSON string", ScriptDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScriptDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScriptDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScriptDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScriptDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScriptDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScriptDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScriptDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ScriptDetails>() {
           @Override
           public void write(JsonWriter out, ScriptDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScriptDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScriptDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScriptDetails
   * @throws IOException if the JSON string is invalid with respect to ScriptDetails
   */
  public static ScriptDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScriptDetails.class);
  }

  /**
   * Convert an instance of ScriptDetails to an JSON string
   *
   * @return JSON string
   */
