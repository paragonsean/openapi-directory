...
/*
 * OAIUpdateFleetRequest_VpcConfig.h
 *
 * 
 */

#ifndef OAIUpdateFleetRequest_VpcConfig_H
#define OAIUpdateFleetRequest_VpcConfig_H
...
class OAIUpdateFleetRequest_VpcConfig : public OAIObject {
public:
    OAIUpdateFleetRequest_VpcConfig();
    OAIUpdateFleetRequest_VpcConfig(QString json);
    ~OAIUpdateFleetRequest_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateFleetRequest_VpcConfig)

#endif // OAIUpdateFleetRequest_VpcConfig_H
