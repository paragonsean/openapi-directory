...
/*
 * OAICreateFleetResult_Fleet.h
 *
 * 
 */

#ifndef OAICreateFleetResult_Fleet_H
#define OAICreateFleetResult_Fleet_H
...
class OAICreateFleetResult_Fleet : public OAIObject {
public:
    OAICreateFleetResult_Fleet();
    OAICreateFleetResult_Fleet(QString json);
    ~OAICreateFleetResult_Fleet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetResult_Fleet)

#endif // OAICreateFleetResult_Fleet_H
