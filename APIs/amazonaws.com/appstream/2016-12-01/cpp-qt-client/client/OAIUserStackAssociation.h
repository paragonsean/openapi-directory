...
/*
 * OAIUserStackAssociation.h
 *
 * Describes a user in the user pool and the associated stack.
 */

#ifndef OAIUserStackAssociation_H
#define OAIUserStackAssociation_H
...
class OAIUserStackAssociation : public OAIObject {
public:
    OAIUserStackAssociation();
    OAIUserStackAssociation(QString json);
    ~OAIUserStackAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserStackAssociation)

#endif // OAIUserStackAssociation_H
