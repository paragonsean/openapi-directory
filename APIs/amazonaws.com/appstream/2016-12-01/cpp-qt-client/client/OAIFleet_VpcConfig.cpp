...
OAIFleet_VpcConfig::OAIFleet_VpcConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFleet_VpcConfig::OAIFleet_VpcConfig() {
    this->initializeModel();
}

OAIFleet_VpcConfig::~OAIFleet_VpcConfig() {}

void OAIFleet_VpcConfig::initializeModel() {
...
void OAIFleet_VpcConfig::fromJson(QString jsonString) {
...
void OAIFleet_VpcConfig::fromJsonObject(QJsonObject json) {
...
QString OAIFleet_VpcConfig::asJson() const {
...
QJsonObject OAIFleet_VpcConfig::asJsonObject() const {
    QJsonObject obj;
...
QList OAIFleet_VpcConfig::getSubnetIds() const {
    return m_subnet_ids;
}
void OAIFleet_VpcConfig::setSubnetIds(const QList &subnet_ids) {
    m_subnet_ids = subnet_ids;
    m_subnet_ids_isSet = true;
}

bool OAIFleet_VpcConfig::is_subnet_ids_Set() const{
    return m_subnet_ids_isSet;
}

bool OAIFleet_VpcConfig::is_subnet_ids_Valid() const{
    return m_subnet_ids_isValid;
}

QList OAIFleet_VpcConfig::getSecurityGroupIds() const {
    return m_security_group_ids;
}
void OAIFleet_VpcConfig::setSecurityGroupIds(const QList &security_group_ids) {
    m_security_group_ids = security_group_ids;
    m_security_group_ids_isSet = true;
}

bool OAIFleet_VpcConfig::is_security_group_ids_Set() const{
    return m_security_group_ids_isSet;
}

bool OAIFleet_VpcConfig::is_security_group_ids_Valid() const{
    return m_security_group_ids_isValid;
}

bool OAIFleet_VpcConfig::isSet() const {
...
bool OAIFleet_VpcConfig::isValid() const {
