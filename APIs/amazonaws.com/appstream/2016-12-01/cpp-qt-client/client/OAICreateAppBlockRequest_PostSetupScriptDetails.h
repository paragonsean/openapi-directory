...
/*
 * OAICreateAppBlockRequest_PostSetupScriptDetails.h
 *
 * 
 */

#ifndef OAICreateAppBlockRequest_PostSetupScriptDetails_H
#define OAICreateAppBlockRequest_PostSetupScriptDetails_H
...
class OAICreateAppBlockRequest_PostSetupScriptDetails : public OAIObject {
public:
    OAICreateAppBlockRequest_PostSetupScriptDetails();
    OAICreateAppBlockRequest_PostSetupScriptDetails(QString json);
    ~OAICreateAppBlockRequest_PostSetupScriptDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAppBlockRequest_PostSetupScriptDetails)

#endif // OAICreateAppBlockRequest_PostSetupScriptDetails_H
