...
QString OAIDeleteApplicationRequest::getName() const {
    return m_name;
}
void OAIDeleteApplicationRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDeleteApplicationRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDeleteApplicationRequest::is_name_Valid() const{
