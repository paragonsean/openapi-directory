...
OAIDirectoryConfig::OAIDirectoryConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDirectoryConfig::OAIDirectoryConfig() {
    this->initializeModel();
}

OAIDirectoryConfig::~OAIDirectoryConfig() {}

void OAIDirectoryConfig::initializeModel() {
...
void OAIDirectoryConfig::fromJson(QString jsonString) {
...
void OAIDirectoryConfig::fromJsonObject(QJsonObject json) {
...
QString OAIDirectoryConfig::asJson() const {
...
QJsonObject OAIDirectoryConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDirectoryConfig::getDirectoryName() const {
    return m_directory_name;
}
void OAIDirectoryConfig::setDirectoryName(const QString &directory_name) {
    m_directory_name = directory_name;
    m_directory_name_isSet = true;
}

bool OAIDirectoryConfig::is_directory_name_Set() const{
    return m_directory_name_isSet;
}

bool OAIDirectoryConfig::is_directory_name_Valid() const{
    return m_directory_name_isValid;
}

QList OAIDirectoryConfig::getOrganizationalUnitDistinguishedNames() const {
    return m_organizational_unit_distinguished_names;
}
void OAIDirectoryConfig::setOrganizationalUnitDistinguishedNames(const QList &organizational_unit_distinguished_names) {
...
bool OAIDirectoryConfig::is_organizational_unit_distinguished_names_Set() const{
    return m_organizational_unit_distinguished_names_isSet;
}

bool OAIDirectoryConfig::is_organizational_unit_distinguished_names_Valid() const{
    return m_organizational_unit_distinguished_names_isValid;
}

OAICreateDirectoryConfigRequest_ServiceAccountCredentials OAIDirectoryConfig::getServiceAccountCredentials() const {
    return m_service_account_credentials;
}
void OAIDirectoryConfig::setServiceAccountCredentials(const OAICreateDirectoryConfigRequest_ServiceAccountCredentials &service_account_credentials) {
    m_service_account_credentials = service_account_credentials;
    m_service_account_credentials_isSet = true;
}

bool OAIDirectoryConfig::is_service_account_credentials_Set() const{
    return m_service_account_credentials_isSet;
}

bool OAIDirectoryConfig::is_service_account_credentials_Valid() const{
    return m_service_account_credentials_isValid;
}

QDateTime OAIDirectoryConfig::getCreatedTime() const {
    return m_created_time;
}
void OAIDirectoryConfig::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAIDirectoryConfig::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAIDirectoryConfig::is_created_time_Valid() const{
    return m_created_time_isValid;
}

OAICreateDirectoryConfigRequest_CertificateBasedAuthProperties OAIDirectoryConfig::getCertificateBasedAuthProperties() const {
    return m_certificate_based_auth_properties;
}
void OAIDirectoryConfig::setCertificateBasedAuthProperties(const OAICreateDirectoryConfigRequest_CertificateBasedAuthProperties &certificate_based_auth_properties) {
    m_certificate_based_auth_properties = certificate_based_auth_properties;
    m_certificate_based_auth_properties_isSet = true;
}

bool OAIDirectoryConfig::is_certificate_based_auth_properties_Set() const{
    return m_certificate_based_auth_properties_isSet;
}

bool OAIDirectoryConfig::is_certificate_based_auth_properties_Valid() const{
    return m_certificate_based_auth_properties_isValid;
}

bool OAIDirectoryConfig::isSet() const {
...
bool OAIDirectoryConfig::isValid() const {
