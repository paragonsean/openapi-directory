...
/*
 * OAIAppBlockBuilder_VpcConfig.h
 *
 * 
 */

#ifndef OAIAppBlockBuilder_VpcConfig_H
#define OAIAppBlockBuilder_VpcConfig_H
...
class OAIAppBlockBuilder_VpcConfig : public OAIObject {
public:
    OAIAppBlockBuilder_VpcConfig();
    OAIAppBlockBuilder_VpcConfig(QString json);
    ~OAIAppBlockBuilder_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppBlockBuilder_VpcConfig)

#endif // OAIAppBlockBuilder_VpcConfig_H
