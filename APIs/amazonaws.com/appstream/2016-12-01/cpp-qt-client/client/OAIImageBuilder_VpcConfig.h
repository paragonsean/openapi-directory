...
/*
 * OAIImageBuilder_VpcConfig.h
 *
 * 
 */

#ifndef OAIImageBuilder_VpcConfig_H
#define OAIImageBuilder_VpcConfig_H
...
class OAIImageBuilder_VpcConfig : public OAIObject {
public:
    OAIImageBuilder_VpcConfig();
    OAIImageBuilder_VpcConfig(QString json);
    ~OAIImageBuilder_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageBuilder_VpcConfig)

#endif // OAIImageBuilder_VpcConfig_H
