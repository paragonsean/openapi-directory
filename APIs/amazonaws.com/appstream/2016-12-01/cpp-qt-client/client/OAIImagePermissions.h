...
/*
 * OAIImagePermissions.h
 *
 * Describes the permissions for an image. 
 */

#ifndef OAIImagePermissions_H
#define OAIImagePermissions_H
...
class OAIImagePermissions : public OAIObject {
public:
    OAIImagePermissions();
    OAIImagePermissions(QString json);
    ~OAIImagePermissions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImagePermissions)

#endif // OAIImagePermissions_H
