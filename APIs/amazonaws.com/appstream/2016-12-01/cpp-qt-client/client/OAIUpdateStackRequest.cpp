...
OAIUpdateStackRequest::OAIUpdateStackRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateStackRequest::OAIUpdateStackRequest() {
    this->initializeModel();
}

OAIUpdateStackRequest::~OAIUpdateStackRequest() {}

void OAIUpdateStackRequest::initializeModel() {
    ...
    m_delete_storage_connectors_isSet = false;
    m_delete_storage_connectors_isValid = false;
...
void OAIUpdateStackRequest::fromJson(QString jsonString) {
...
void OAIUpdateStackRequest::fromJsonObject(QJsonObject json) {
    ...
    m_delete_storage_connectors_isValid = ::OpenAPI::fromJsonValue(m_delete_storage_connectors, json[QString("DeleteStorageConnectors")]);
    m_delete_storage_connectors_isSet = !json[QString("DeleteStorageConnectors")].isNull() && m_delete_storage_connectors_isValid;
...
QString OAIUpdateStackRequest::asJson() const {
...
QJsonObject OAIUpdateStackRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_delete_storage_connectors_isSet) {
        obj.insert(QString("DeleteStorageConnectors"), ::OpenAPI::toJsonValue(m_delete_storage_connectors));
    }
...
QString OAIUpdateStackRequest::getDisplayName() const {
    return m_display_name;
}
void OAIUpdateStackRequest::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAIUpdateStackRequest::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAIUpdateStackRequest::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAIUpdateStackRequest::getDescription() const {
    return m_description;
}
void OAIUpdateStackRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateStackRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateStackRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateStackRequest::getName() const {
    return m_name;
}
void OAIUpdateStackRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIUpdateStackRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIUpdateStackRequest::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIUpdateStackRequest::getStorageConnectors() const {
    return m_storage_connectors;
}
void OAIUpdateStackRequest::setStorageConnectors(const QList &storage_connectors) {
    m_storage_connectors = storage_connectors;
    m_storage_connectors_isSet = true;
}

bool OAIUpdateStackRequest::is_storage_connectors_Set() const{
    return m_storage_connectors_isSet;
}

bool OAIUpdateStackRequest::is_storage_connectors_Valid() const{
    return m_storage_connectors_isValid;
}

bool OAIUpdateStackRequest::getDeleteStorageConnectors() const {
    return m_delete_storage_connectors;
}
void OAIUpdateStackRequest::setDeleteStorageConnectors(const bool &delete_storage_connectors) {
    m_delete_storage_connectors = delete_storage_connectors;
    m_delete_storage_connectors_isSet = true;
}

bool OAIUpdateStackRequest::is_delete_storage_connectors_Set() const{
    return m_delete_storage_connectors_isSet;
}

bool OAIUpdateStackRequest::is_delete_storage_connectors_Valid() const{
    return m_delete_storage_connectors_isValid;
}

QString OAIUpdateStackRequest::getRedirectUrl() const {
    return m_redirect_url;
}
void OAIUpdateStackRequest::setRedirectUrl(const QString &redirect_url) {
    m_redirect_url = redirect_url;
    m_redirect_url_isSet = true;
}

bool OAIUpdateStackRequest::is_redirect_url_Set() const{
    return m_redirect_url_isSet;
}

bool OAIUpdateStackRequest::is_redirect_url_Valid() const{
    return m_redirect_url_isValid;
}

QString OAIUpdateStackRequest::getFeedbackUrl() const {
    return m_feedback_url;
}
void OAIUpdateStackRequest::setFeedbackUrl(const QString &feedback_url) {
    m_feedback_url = feedback_url;
    m_feedback_url_isSet = true;
}

bool OAIUpdateStackRequest::is_feedback_url_Set() const{
    return m_feedback_url_isSet;
}

bool OAIUpdateStackRequest::is_feedback_url_Valid() const{
    return m_feedback_url_isValid;
}

QList OAIUpdateStackRequest::getAttributesToDelete() const {
    return m_attributes_to_delete;
}
void OAIUpdateStackRequest::setAttributesToDelete(const QList &attributes_to_delete) {
    m_attributes_to_delete = attributes_to_delete;
    m_attributes_to_delete_isSet = true;
}

bool OAIUpdateStackRequest::is_attributes_to_delete_Set() const{
    return m_attributes_to_delete_isSet;
}

bool OAIUpdateStackRequest::is_attributes_to_delete_Valid() const{
    return m_attributes_to_delete_isValid;
}

QList OAIUpdateStackRequest::getUserSettings() const {
    return m_user_settings;
}
void OAIUpdateStackRequest::setUserSettings(const QList &user_settings) {
    m_user_settings = user_settings;
    m_user_settings_isSet = true;
}

bool OAIUpdateStackRequest::is_user_settings_Set() const{
    return m_user_settings_isSet;
}

bool OAIUpdateStackRequest::is_user_settings_Valid() const{
    return m_user_settings_isValid;
}

OAICreateStackRequest_ApplicationSettings OAIUpdateStackRequest::getApplicationSettings() const {
    return m_application_settings;
}
void OAIUpdateStackRequest::setApplicationSettings(const OAICreateStackRequest_ApplicationSettings &application_settings) {
    m_application_settings = application_settings;
    m_application_settings_isSet = true;
}

bool OAIUpdateStackRequest::is_application_settings_Set() const{
    return m_application_settings_isSet;
}

bool OAIUpdateStackRequest::is_application_settings_Valid() const{
    return m_application_settings_isValid;
}

QList OAIUpdateStackRequest::getAccessEndpoints() const {
    return m_access_endpoints;
}
void OAIUpdateStackRequest::setAccessEndpoints(const QList &access_endpoints) {
    m_access_endpoints = access_endpoints;
    m_access_endpoints_isSet = true;
}

bool OAIUpdateStackRequest::is_access_endpoints_Set() const{
    return m_access_endpoints_isSet;
}

bool OAIUpdateStackRequest::is_access_endpoints_Valid() const{
    return m_access_endpoints_isValid;
}

QList OAIUpdateStackRequest::getEmbedHostDomains() const {
    return m_embed_host_domains;
}
void OAIUpdateStackRequest::setEmbedHostDomains(const QList &embed_host_domains) {
    m_embed_host_domains = embed_host_domains;
    m_embed_host_domains_isSet = true;
}

bool OAIUpdateStackRequest::is_embed_host_domains_Set() const{
    return m_embed_host_domains_isSet;
}

bool OAIUpdateStackRequest::is_embed_host_domains_Valid() const{
    return m_embed_host_domains_isValid;
}

OAICreateStackRequest_StreamingExperienceSettings OAIUpdateStackRequest::getStreamingExperienceSettings() const {
    return m_streaming_experience_settings;
}
void OAIUpdateStackRequest::setStreamingExperienceSettings(const OAICreateStackRequest_StreamingExperienceSettings &streaming_experience_settings) {
    m_streaming_experience_settings = streaming_experience_settings;
    m_streaming_experience_settings_isSet = true;
}

bool OAIUpdateStackRequest::is_streaming_experience_settings_Set() const{
    return m_streaming_experience_settings_isSet;
}

bool OAIUpdateStackRequest::is_streaming_experience_settings_Valid() const{
    return m_streaming_experience_settings_isValid;
}

bool OAIUpdateStackRequest::isSet() const {
...
bool OAIUpdateStackRequest::isValid() const {
