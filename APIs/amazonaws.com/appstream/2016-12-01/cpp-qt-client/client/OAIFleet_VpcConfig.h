...
/*
 * OAIFleet_VpcConfig.h
 *
 * 
 */

#ifndef OAIFleet_VpcConfig_H
#define OAIFleet_VpcConfig_H
...
class OAIFleet_VpcConfig : public OAIObject {
public:
    OAIFleet_VpcConfig();
    OAIFleet_VpcConfig(QString json);
    ~OAIFleet_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleet_VpcConfig)

#endif // OAIFleet_VpcConfig_H
