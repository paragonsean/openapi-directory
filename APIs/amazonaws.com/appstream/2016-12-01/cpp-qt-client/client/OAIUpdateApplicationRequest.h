...
#include "OAIUpdateApplicationRequest_IconS3Location.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIUpdateApplicationRequest_IconS3Location;
...
public:
    ...
    OAIUpdateApplicationRequest_IconS3Location getIconS3Location() const;
    void setIconS3Location(const OAIUpdateApplicationRequest_IconS3Location &icon_s3_location);
...
private:
    ...
    OAIUpdateApplicationRequest_IconS3Location m_icon_s3_location;
