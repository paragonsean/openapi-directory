...
/*
 * OAIDescribeUserStackAssociationsRequest.h
 *
 * 
 */

#ifndef OAIDescribeUserStackAssociationsRequest_H
#define OAIDescribeUserStackAssociationsRequest_H
...
class OAIDescribeUserStackAssociationsRequest : public OAIObject {
public:
    OAIDescribeUserStackAssociationsRequest();
    OAIDescribeUserStackAssociationsRequest(QString json);
    ~OAIDescribeUserStackAssociationsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUserStackAssociationsRequest)

#endif // OAIDescribeUserStackAssociationsRequest_H
