...
/*
 * OAIAppBlock_PostSetupScriptDetails.h
 *
 * 
 */

#ifndef OAIAppBlock_PostSetupScriptDetails_H
#define OAIAppBlock_PostSetupScriptDetails_H
...
class OAIAppBlock_PostSetupScriptDetails : public OAIObject {
public:
    OAIAppBlock_PostSetupScriptDetails();
    OAIAppBlock_PostSetupScriptDetails(QString json);
    ~OAIAppBlock_PostSetupScriptDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppBlock_PostSetupScriptDetails)

#endif // OAIAppBlock_PostSetupScriptDetails_H
