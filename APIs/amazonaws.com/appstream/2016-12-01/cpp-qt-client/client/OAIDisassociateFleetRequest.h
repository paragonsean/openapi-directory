...
/*
 * OAIDisassociateFleetRequest.h
 *
 * 
 */

#ifndef OAIDisassociateFleetRequest_H
#define OAIDisassociateFleetRequest_H
...
class OAIDisassociateFleetRequest : public OAIObject {
public:
    OAIDisassociateFleetRequest();
    OAIDisassociateFleetRequest(QString json);
    ~OAIDisassociateFleetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateFleetRequest)

#endif // OAIDisassociateFleetRequest_H
