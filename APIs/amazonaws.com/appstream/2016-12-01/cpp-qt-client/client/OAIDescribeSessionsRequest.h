...
/*
 * OAIDescribeSessionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeSessionsRequest_H
#define OAIDescribeSessionsRequest_H
...
class OAIDescribeSessionsRequest : public OAIObject {
public:
    OAIDescribeSessionsRequest();
    OAIDescribeSessionsRequest(QString json);
    ~OAIDescribeSessionsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSessionsRequest)

#endif // OAIDescribeSessionsRequest_H
