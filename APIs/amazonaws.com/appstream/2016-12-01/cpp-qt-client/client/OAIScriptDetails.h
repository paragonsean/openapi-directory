...
#ifndef OAIScriptDetails_H
#define OAIScriptDetails_H
...
class OAIScriptDetails : public OAIObject {
public:
    OAIScriptDetails();
    OAIScriptDetails(QString json);
    ~OAIScriptDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScriptDetails)

#endif // OAIScriptDetails_H
