...
QString OAICreateFleetRequest::getImageName() const {
    return m_image_name;
}
void OAICreateFleetRequest::setImageName(const QString &image_name) {
    m_image_name = image_name;
    m_image_name_isSet = true;
}

bool OAICreateFleetRequest::is_image_name_Set() const{
    return m_image_name_isSet;
}

bool OAICreateFleetRequest::is_image_name_Valid() const{
    return m_image_name_isValid;
}

QString OAICreateFleetRequest::getImageArn() const {
    return m_image_arn;
}
void OAICreateFleetRequest::setImageArn(const QString &image_arn) {
    m_image_arn = image_arn;
    m_image_arn_isSet = true;
}

bool OAICreateFleetRequest::is_image_arn_Set() const{
    return m_image_arn_isSet;
}

bool OAICreateFleetRequest::is_image_arn_Valid() const{
    return m_image_arn_isValid;
}

QString OAICreateFleetRequest::getInstanceType() const {
    return m_instance_type;
}
void OAICreateFleetRequest::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAICreateFleetRequest::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAICreateFleetRequest::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

OAIFleetType OAICreateFleetRequest::getFleetType() const {
    return m_fleet_type;
}
void OAICreateFleetRequest::setFleetType(const OAIFleetType &fleet_type) {
    m_fleet_type = fleet_type;
    m_fleet_type_isSet = true;
}

bool OAICreateFleetRequest::is_fleet_type_Set() const{
    return m_fleet_type_isSet;
}

bool OAICreateFleetRequest::is_fleet_type_Valid() const{
    return m_fleet_type_isValid;
}

OAICreateFleetRequest_ComputeCapacity OAICreateFleetRequest::getComputeCapacity() const {
    return m_compute_capacity;
}
void OAICreateFleetRequest::setComputeCapacity(const OAICreateFleetRequest_ComputeCapacity &compute_capacity) {
    m_compute_capacity = compute_capacity;
    m_compute_capacity_isSet = true;
}

bool OAICreateFleetRequest::is_compute_capacity_Set() const{
    return m_compute_capacity_isSet;
}

bool OAICreateFleetRequest::is_compute_capacity_Valid() const{
    return m_compute_capacity_isValid;
}

OAICreateFleetRequest_VpcConfig OAICreateFleetRequest::getVpcConfig() const {
    return m_vpc_config;
}
void OAICreateFleetRequest::setVpcConfig(const OAICreateFleetRequest_VpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAICreateFleetRequest::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAICreateFleetRequest::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

qint32 OAICreateFleetRequest::getMaxUserDurationInSeconds() const {
    return m_max_user_duration_in_seconds;
}
void OAICreateFleetRequest::setMaxUserDurationInSeconds(const qint32 &max_user_duration_in_seconds) {
    m_max_user_duration_in_seconds = max_user_duration_in_seconds;
    m_max_user_duration_in_seconds_isSet = true;
}

bool OAICreateFleetRequest::is_max_user_duration_in_seconds_Set() const{
    return m_max_user_duration_in_seconds_isSet;
}

bool OAICreateFleetRequest::is_max_user_duration_in_seconds_Valid() const{
    return m_max_user_duration_in_seconds_isValid;
}

qint32 OAICreateFleetRequest::getDisconnectTimeoutInSeconds() const {
    return m_disconnect_timeout_in_seconds;
}
void OAICreateFleetRequest::setDisconnectTimeoutInSeconds(const qint32 &disconnect_timeout_in_seconds) {
    m_disconnect_timeout_in_seconds = disconnect_timeout_in_seconds;
    m_disconnect_timeout_in_seconds_isSet = true;
}

bool OAICreateFleetRequest::is_disconnect_timeout_in_seconds_Set() const{
    return m_disconnect_timeout_in_seconds_isSet;
}

bool OAICreateFleetRequest::is_disconnect_timeout_in_seconds_Valid() const{
    return m_disconnect_timeout_in_seconds_isValid;
}

QString OAICreateFleetRequest::getDescription() const {
    return m_description;
}
void OAICreateFleetRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateFleetRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateFleetRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateFleetRequest::getDisplayName() const {
    return m_display_name;
}
void OAICreateFleetRequest::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAICreateFleetRequest::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAICreateFleetRequest::is_display_name_Valid() const{
    return m_display_name_isValid;
}

bool OAICreateFleetRequest::getEnableDefaultInternetAccess() const {
    return m_enable_default_internet_access;
}
void OAICreateFleetRequest::setEnableDefaultInternetAccess(const bool &enable_default_internet_access) {
    m_enable_default_internet_access = enable_default_internet_access;
    m_enable_default_internet_access_isSet = true;
}

bool OAICreateFleetRequest::is_enable_default_internet_access_Set() const{
    return m_enable_default_internet_access_isSet;
}

bool OAICreateFleetRequest::is_enable_default_internet_access_Valid() const{
    return m_enable_default_internet_access_isValid;
}

OAICreateFleetRequest_DomainJoinInfo OAICreateFleetRequest::getDomainJoinInfo() const {
    return m_domain_join_info;
}
void OAICreateFleetRequest::setDomainJoinInfo(const OAICreateFleetRequest_DomainJoinInfo &domain_join_info) {
    m_domain_join_info = domain_join_info;
    m_domain_join_info_isSet = true;
}

bool OAICreateFleetRequest::is_domain_join_info_Set() const{
    return m_domain_join_info_isSet;
}

bool OAICreateFleetRequest::is_domain_join_info_Valid() const{
...
qint32 OAICreateFleetRequest::getIdleDisconnectTimeoutInSeconds() const {
    return m_idle_disconnect_timeout_in_seconds;
}
void OAICreateFleetRequest::setIdleDisconnectTimeoutInSeconds(const qint32 &idle_disconnect_timeout_in_seconds) {
    m_idle_disconnect_timeout_in_seconds = idle_disconnect_timeout_in_seconds;
    m_idle_disconnect_timeout_in_seconds_isSet = true;
}

bool OAICreateFleetRequest::is_idle_disconnect_timeout_in_seconds_Set() const{
    return m_idle_disconnect_timeout_in_seconds_isSet;
}

bool OAICreateFleetRequest::is_idle_disconnect_timeout_in_seconds_Valid() const{
    return m_idle_disconnect_timeout_in_seconds_isValid;
}

QString OAICreateFleetRequest::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAICreateFleetRequest::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAICreateFleetRequest::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAICreateFleetRequest::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

OAIStreamView OAICreateFleetRequest::getStreamView() const {
    return m_stream_view;
}
void OAICreateFleetRequest::setStreamView(const OAIStreamView &stream_view) {
    m_stream_view = stream_view;
    m_stream_view_isSet = true;
}

bool OAICreateFleetRequest::is_stream_view_Set() const{
    return m_stream_view_isSet;
}

bool OAICreateFleetRequest::is_stream_view_Valid() const{
    return m_stream_view_isValid;
}

OAIPlatformType OAICreateFleetRequest::getPlatform() const {
    return m_platform;
}
void OAICreateFleetRequest::setPlatform(const OAIPlatformType &platform) {
    m_platform = platform;
    m_platform_isSet = true;
}

bool OAICreateFleetRequest::is_platform_Set() const{
    return m_platform_isSet;
}

bool OAICreateFleetRequest::is_platform_Valid() const{
    return m_platform_isValid;
}

qint32 OAICreateFleetRequest::getMaxConcurrentSessions() const {
    return m_max_concurrent_sessions;
}
void OAICreateFleetRequest::setMaxConcurrentSessions(const qint32 &max_concurrent_sessions) {
    m_max_concurrent_sessions = max_concurrent_sessions;
    m_max_concurrent_sessions_isSet = true;
}

bool OAICreateFleetRequest::is_max_concurrent_sessions_Set() const{
    return m_max_concurrent_sessions_isSet;
}

bool OAICreateFleetRequest::is_max_concurrent_sessions_Valid() const{
    return m_max_concurrent_sessions_isValid;
}

QList OAICreateFleetRequest::getUsbDeviceFilterStrings() const {
    return m_usb_device_filter_strings;
}
void OAICreateFleetRequest::setUsbDeviceFilterStrings(const QList &usb_device_filter_strings) {
    m_usb_device_filter_strings = usb_device_filter_strings;
    m_usb_device_filter_strings_isSet = true;
}

bool OAICreateFleetRequest::is_usb_device_filter_strings_Set() const{
    return m_usb_device_filter_strings_isSet;
}

bool OAICreateFleetRequest::is_usb_device_filter_strings_Valid() const{
    return m_usb_device_filter_strings_isValid;
}

OAICreateFleetRequest_SessionScriptS3Location OAICreateFleetRequest::getSessionScriptS3Location() const {
    return m_session_script_s3_location;
}
void OAICreateFleetRequest::setSessionScriptS3Location(const OAICreateFleetRequest_SessionScriptS3Location &session_script_s3_location) {
    m_session_script_s3_location = session_script_s3_location;
    m_session_script_s3_location_isSet = true;
}

bool OAICreateFleetRequest::is_session_script_s3_location_Set() const{
    return m_session_script_s3_location_isSet;
}

bool OAICreateFleetRequest::is_session_script_s3_location_Valid() const{
