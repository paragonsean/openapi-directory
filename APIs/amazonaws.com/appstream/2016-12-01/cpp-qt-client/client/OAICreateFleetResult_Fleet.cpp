...
OAICreateFleetResult_Fleet::OAICreateFleetResult_Fleet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFleetResult_Fleet::OAICreateFleetResult_Fleet() {
    this->initializeModel();
}

OAICreateFleetResult_Fleet::~OAICreateFleetResult_Fleet() {}

void OAICreateFleetResult_Fleet::initializeModel() {
...
void OAICreateFleetResult_Fleet::fromJson(QString jsonString) {
...
void OAICreateFleetResult_Fleet::fromJsonObject(QJsonObject json) {
...
QString OAICreateFleetResult_Fleet::asJson() const {
...
QJsonObject OAICreateFleetResult_Fleet::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAICreateFleetResult_Fleet::getArn() const {
    return m_arn;
}
void OAICreateFleetResult_Fleet::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreateFleetResult_Fleet::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAICreateFleetResult_Fleet::getName() const {
    return m_name;
}
void OAICreateFleetResult_Fleet::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateFleetResult_Fleet::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICreateFleetResult_Fleet::getDisplayName() const {
    return m_display_name;
}
void OAICreateFleetResult_Fleet::setDisplayName(const QString &display_name) {
    m_display_name = display_name;
    m_display_name_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_display_name_Set() const{
    return m_display_name_isSet;
}

bool OAICreateFleetResult_Fleet::is_display_name_Valid() const{
    return m_display_name_isValid;
}

QString OAICreateFleetResult_Fleet::getDescription() const {
    return m_description;
}
void OAICreateFleetResult_Fleet::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateFleetResult_Fleet::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateFleetResult_Fleet::getImageName() const {
    return m_image_name;
}
void OAICreateFleetResult_Fleet::setImageName(const QString &image_name) {
    m_image_name = image_name;
    m_image_name_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_image_name_Set() const{
    return m_image_name_isSet;
}

bool OAICreateFleetResult_Fleet::is_image_name_Valid() const{
    return m_image_name_isValid;
}

QString OAICreateFleetResult_Fleet::getImageArn() const {
    return m_image_arn;
}
void OAICreateFleetResult_Fleet::setImageArn(const QString &image_arn) {
    m_image_arn = image_arn;
    m_image_arn_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_image_arn_Set() const{
    return m_image_arn_isSet;
}

bool OAICreateFleetResult_Fleet::is_image_arn_Valid() const{
    return m_image_arn_isValid;
}

QString OAICreateFleetResult_Fleet::getInstanceType() const {
    return m_instance_type;
}
void OAICreateFleetResult_Fleet::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAICreateFleetResult_Fleet::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

OAIFleetType OAICreateFleetResult_Fleet::getFleetType() const {
    return m_fleet_type;
}
void OAICreateFleetResult_Fleet::setFleetType(const OAIFleetType &fleet_type) {
    m_fleet_type = fleet_type;
    m_fleet_type_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_fleet_type_Set() const{
    return m_fleet_type_isSet;
}

bool OAICreateFleetResult_Fleet::is_fleet_type_Valid() const{
    return m_fleet_type_isValid;
}

OAIFleet_ComputeCapacityStatus OAICreateFleetResult_Fleet::getComputeCapacityStatus() const {
    return m_compute_capacity_status;
}
void OAICreateFleetResult_Fleet::setComputeCapacityStatus(const OAIFleet_ComputeCapacityStatus &compute_capacity_status) {
    m_compute_capacity_status = compute_capacity_status;
    m_compute_capacity_status_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_compute_capacity_status_Set() const{
    return m_compute_capacity_status_isSet;
}

bool OAICreateFleetResult_Fleet::is_compute_capacity_status_Valid() const{
    return m_compute_capacity_status_isValid;
}

qint32 OAICreateFleetResult_Fleet::getMaxUserDurationInSeconds() const {
    return m_max_user_duration_in_seconds;
}
void OAICreateFleetResult_Fleet::setMaxUserDurationInSeconds(const qint32 &max_user_duration_in_seconds) {
    m_max_user_duration_in_seconds = max_user_duration_in_seconds;
    m_max_user_duration_in_seconds_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_max_user_duration_in_seconds_Set() const{
    return m_max_user_duration_in_seconds_isSet;
}

bool OAICreateFleetResult_Fleet::is_max_user_duration_in_seconds_Valid() const{
    return m_max_user_duration_in_seconds_isValid;
}

qint32 OAICreateFleetResult_Fleet::getDisconnectTimeoutInSeconds() const {
    return m_disconnect_timeout_in_seconds;
}
void OAICreateFleetResult_Fleet::setDisconnectTimeoutInSeconds(const qint32 &disconnect_timeout_in_seconds) {
    m_disconnect_timeout_in_seconds = disconnect_timeout_in_seconds;
    m_disconnect_timeout_in_seconds_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_disconnect_timeout_in_seconds_Set() const{
    return m_disconnect_timeout_in_seconds_isSet;
}

bool OAICreateFleetResult_Fleet::is_disconnect_timeout_in_seconds_Valid() const{
    return m_disconnect_timeout_in_seconds_isValid;
}

OAIFleetState OAICreateFleetResult_Fleet::getState() const {
    return m_state;
}
void OAICreateFleetResult_Fleet::setState(const OAIFleetState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_state_Set() const{
    return m_state_isSet;
}

bool OAICreateFleetResult_Fleet::is_state_Valid() const{
    return m_state_isValid;
}

OAIFleet_VpcConfig OAICreateFleetResult_Fleet::getVpcConfig() const {
    return m_vpc_config;
}
void OAICreateFleetResult_Fleet::setVpcConfig(const OAIFleet_VpcConfig &vpc_config) {
    m_vpc_config = vpc_config;
    m_vpc_config_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_vpc_config_Set() const{
    return m_vpc_config_isSet;
}

bool OAICreateFleetResult_Fleet::is_vpc_config_Valid() const{
    return m_vpc_config_isValid;
}

QDateTime OAICreateFleetResult_Fleet::getCreatedTime() const {
    return m_created_time;
}
void OAICreateFleetResult_Fleet::setCreatedTime(const QDateTime &created_time) {
    m_created_time = created_time;
    m_created_time_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_created_time_Set() const{
    return m_created_time_isSet;
}

bool OAICreateFleetResult_Fleet::is_created_time_Valid() const{
    return m_created_time_isValid;
}

QList OAICreateFleetResult_Fleet::getFleetErrors() const {
    return m_fleet_errors;
}
void OAICreateFleetResult_Fleet::setFleetErrors(const QList &fleet_errors) {
    m_fleet_errors = fleet_errors;
    m_fleet_errors_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_fleet_errors_Set() const{
    return m_fleet_errors_isSet;
}

bool OAICreateFleetResult_Fleet::is_fleet_errors_Valid() const{
    return m_fleet_errors_isValid;
}

bool OAICreateFleetResult_Fleet::getEnableDefaultInternetAccess() const {
    return m_enable_default_internet_access;
}
void OAICreateFleetResult_Fleet::setEnableDefaultInternetAccess(const bool &enable_default_internet_access) {
    m_enable_default_internet_access = enable_default_internet_access;
    m_enable_default_internet_access_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_enable_default_internet_access_Set() const{
    return m_enable_default_internet_access_isSet;
}

bool OAICreateFleetResult_Fleet::is_enable_default_internet_access_Valid() const{
    return m_enable_default_internet_access_isValid;
}

OAIUpdateFleetRequest_DomainJoinInfo OAICreateFleetResult_Fleet::getDomainJoinInfo() const {
    return m_domain_join_info;
}
void OAICreateFleetResult_Fleet::setDomainJoinInfo(const OAIUpdateFleetRequest_DomainJoinInfo &domain_join_info) {
    m_domain_join_info = domain_join_info;
    m_domain_join_info_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_domain_join_info_Set() const{
    return m_domain_join_info_isSet;
}

bool OAICreateFleetResult_Fleet::is_domain_join_info_Valid() const{
    return m_domain_join_info_isValid;
}

qint32 OAICreateFleetResult_Fleet::getIdleDisconnectTimeoutInSeconds() const {
    return m_idle_disconnect_timeout_in_seconds;
}
void OAICreateFleetResult_Fleet::setIdleDisconnectTimeoutInSeconds(const qint32 &idle_disconnect_timeout_in_seconds) {
    m_idle_disconnect_timeout_in_seconds = idle_disconnect_timeout_in_seconds;
    m_idle_disconnect_timeout_in_seconds_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_idle_disconnect_timeout_in_seconds_Set() const{
    return m_idle_disconnect_timeout_in_seconds_isSet;
}

bool OAICreateFleetResult_Fleet::is_idle_disconnect_timeout_in_seconds_Valid() const{
    return m_idle_disconnect_timeout_in_seconds_isValid;
}

QString OAICreateFleetResult_Fleet::getIamRoleArn() const {
    return m_iam_role_arn;
}
void OAICreateFleetResult_Fleet::setIamRoleArn(const QString &iam_role_arn) {
    m_iam_role_arn = iam_role_arn;
    m_iam_role_arn_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_iam_role_arn_Set() const{
    return m_iam_role_arn_isSet;
}

bool OAICreateFleetResult_Fleet::is_iam_role_arn_Valid() const{
    return m_iam_role_arn_isValid;
}

OAIStreamView OAICreateFleetResult_Fleet::getStreamView() const {
    return m_stream_view;
}
void OAICreateFleetResult_Fleet::setStreamView(const OAIStreamView &stream_view) {
    m_stream_view = stream_view;
    m_stream_view_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_stream_view_Set() const{
    return m_stream_view_isSet;
}

bool OAICreateFleetResult_Fleet::is_stream_view_Valid() const{
    return m_stream_view_isValid;
}

OAIPlatformType OAICreateFleetResult_Fleet::getPlatform() const {
    return m_platform;
}
void OAICreateFleetResult_Fleet::setPlatform(const OAIPlatformType &platform) {
    m_platform = platform;
    m_platform_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_platform_Set() const{
    return m_platform_isSet;
}

bool OAICreateFleetResult_Fleet::is_platform_Valid() const{
    return m_platform_isValid;
}

qint32 OAICreateFleetResult_Fleet::getMaxConcurrentSessions() const {
    return m_max_concurrent_sessions;
}
void OAICreateFleetResult_Fleet::setMaxConcurrentSessions(const qint32 &max_concurrent_sessions) {
    m_max_concurrent_sessions = max_concurrent_sessions;
    m_max_concurrent_sessions_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_max_concurrent_sessions_Set() const{
    return m_max_concurrent_sessions_isSet;
}

bool OAICreateFleetResult_Fleet::is_max_concurrent_sessions_Valid() const{
    return m_max_concurrent_sessions_isValid;
}

QList OAICreateFleetResult_Fleet::getUsbDeviceFilterStrings() const {
    return m_usb_device_filter_strings;
}
void OAICreateFleetResult_Fleet::setUsbDeviceFilterStrings(const QList &usb_device_filter_strings) {
    m_usb_device_filter_strings = usb_device_filter_strings;
    m_usb_device_filter_strings_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_usb_device_filter_strings_Set() const{
    return m_usb_device_filter_strings_isSet;
}

bool OAICreateFleetResult_Fleet::is_usb_device_filter_strings_Valid() const{
    return m_usb_device_filter_strings_isValid;
}

OAICreateFleetRequest_SessionScriptS3Location OAICreateFleetResult_Fleet::getSessionScriptS3Location() const {
    return m_session_script_s3_location;
}
void OAICreateFleetResult_Fleet::setSessionScriptS3Location(const OAICreateFleetRequest_SessionScriptS3Location &session_script_s3_location) {
    m_session_script_s3_location = session_script_s3_location;
    m_session_script_s3_location_isSet = true;
}

bool OAICreateFleetResult_Fleet::is_session_script_s3_location_Set() const{
    return m_session_script_s3_location_isSet;
}

bool OAICreateFleetResult_Fleet::is_session_script_s3_location_Valid() const{
    return m_session_script_s3_location_isValid;
}

bool OAICreateFleetResult_Fleet::isSet() const {
...
bool OAICreateFleetResult_Fleet::isValid() const {
