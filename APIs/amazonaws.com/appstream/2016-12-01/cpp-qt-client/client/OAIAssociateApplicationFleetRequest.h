...
/*
 * OAIAssociateApplicationFleetRequest.h
 *
 * 
 */

#ifndef OAIAssociateApplicationFleetRequest_H
#define OAIAssociateApplicationFleetRequest_H
...
class OAIAssociateApplicationFleetRequest : public OAIObject {
public:
    OAIAssociateApplicationFleetRequest();
    OAIAssociateApplicationFleetRequest(QString json);
    ~OAIAssociateApplicationFleetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateApplicationFleetRequest)

#endif // OAIAssociateApplicationFleetRequest_H
