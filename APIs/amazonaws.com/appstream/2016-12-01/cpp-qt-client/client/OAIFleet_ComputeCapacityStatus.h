...
/*
 * OAIFleet_ComputeCapacityStatus.h
 *
 * 
 */

#ifndef OAIFleet_ComputeCapacityStatus_H
#define OAIFleet_ComputeCapacityStatus_H
...
class OAIFleet_ComputeCapacityStatus : public OAIObject {
public:
    OAIFleet_ComputeCapacityStatus();
    OAIFleet_ComputeCapacityStatus(QString json);
    ~OAIFleet_ComputeCapacityStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFleet_ComputeCapacityStatus)

#endif // OAIFleet_ComputeCapacityStatus_H
