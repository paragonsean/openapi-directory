...
OAICreateDirectoryConfigRequest::OAICreateDirectoryConfigRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateDirectoryConfigRequest::OAICreateDirectoryConfigRequest() {
    this->initializeModel();
}

OAICreateDirectoryConfigRequest::~OAICreateDirectoryConfigRequest() {}

void OAICreateDirectoryConfigRequest::initializeModel() {
...
void OAICreateDirectoryConfigRequest::fromJson(QString jsonString) {
...
void OAICreateDirectoryConfigRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateDirectoryConfigRequest::asJson() const {
...
QJsonObject OAICreateDirectoryConfigRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateDirectoryConfigRequest::getDirectoryName() const {
    return m_directory_name;
}
void OAICreateDirectoryConfigRequest::setDirectoryName(const QString &directory_name) {
    m_directory_name = directory_name;
    m_directory_name_isSet = true;
}

bool OAICreateDirectoryConfigRequest::is_directory_name_Set() const{
    return m_directory_name_isSet;
}

bool OAICreateDirectoryConfigRequest::is_directory_name_Valid() const{
    return m_directory_name_isValid;
}

QList OAICreateDirectoryConfigRequest::getOrganizationalUnitDistinguishedNames() const {
    return m_organizational_unit_distinguished_names;
}
void OAICreateDirectoryConfigRequest::setOrganizationalUnitDistinguishedNames(const QList &organizational_unit_distinguished_names) {
...
bool OAICreateDirectoryConfigRequest::is_organizational_unit_distinguished_names_Set() const{
    return m_organizational_unit_distinguished_names_isSet;
}

bool OAICreateDirectoryConfigRequest::is_organizational_unit_distinguished_names_Valid() const{
    return m_organizational_unit_distinguished_names_isValid;
}

OAICreateDirectoryConfigRequest_ServiceAccountCredentials OAICreateDirectoryConfigRequest::getServiceAccountCredentials() const {
    return m_service_account_credentials;
}
void OAICreateDirectoryConfigRequest::setServiceAccountCredentials(const OAICreateDirectoryConfigRequest_ServiceAccountCredentials &service_account_credentials) {
    m_service_account_credentials = service_account_credentials;
    m_service_account_credentials_isSet = true;
}

bool OAICreateDirectoryConfigRequest::is_service_account_credentials_Set() const{
    return m_service_account_credentials_isSet;
}

bool OAICreateDirectoryConfigRequest::is_service_account_credentials_Valid() const{
    return m_service_account_credentials_isValid;
}

OAICreateDirectoryConfigRequest_CertificateBasedAuthProperties OAICreateDirectoryConfigRequest::getCertificateBasedAuthProperties() const {
    return m_certificate_based_auth_properties;
}
void OAICreateDirectoryConfigRequest::setCertificateBasedAuthProperties(const OAICreateDirectoryConfigRequest_CertificateBasedAuthProperties &certificate_based_auth_properties) {
    m_certificate_based_auth_properties = certificate_based_auth_properties;
    m_certificate_based_auth_properties_isSet = true;
}

bool OAICreateDirectoryConfigRequest::is_certificate_based_auth_properties_Set() const{
    return m_certificate_based_auth_properties_isSet;
}

bool OAICreateDirectoryConfigRequest::is_certificate_based_auth_properties_Valid() const{
    return m_certificate_based_auth_properties_isValid;
}

bool OAICreateDirectoryConfigRequest::isSet() const {
...
bool OAICreateDirectoryConfigRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_directory_name_isValid && m_organizational_unit_distinguished_names_isValid && true;
}
