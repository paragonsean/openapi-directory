...
class OAIEntitledApplication : public OAIObject {
public:
    OAIEntitledApplication();
    OAIEntitledApplication(QString json);
    ~OAIEntitledApplication() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntitledApplication)

#endif // OAIEntitledApplication_H
