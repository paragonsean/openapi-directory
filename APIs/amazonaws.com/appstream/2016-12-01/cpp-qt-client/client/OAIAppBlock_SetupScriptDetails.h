...
/*
 * OAIAppBlock_SetupScriptDetails.h
 *
 * 
 */

#ifndef OAIAppBlock_SetupScriptDetails_H
#define OAIAppBlock_SetupScriptDetails_H
...
class OAIAppBlock_SetupScriptDetails : public OAIObject {
public:
    OAIAppBlock_SetupScriptDetails();
    OAIAppBlock_SetupScriptDetails(QString json);
    ~OAIAppBlock_SetupScriptDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppBlock_SetupScriptDetails)

#endif // OAIAppBlock_SetupScriptDetails_H
