...
#ifndef OAIImageBuilder_H
#define OAIImageBuilder_H
...
class OAIImageBuilder : public OAIObject {
public:
    OAIImageBuilder();
    OAIImageBuilder(QString json);
    ~OAIImageBuilder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageBuilder)

#endif // OAIImageBuilder_H
