...
QString OAIS3Location::getS3Bucket() const {
    return m_s3_bucket;
}
void OAIS3Location::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAIS3Location::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAIS3Location::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAIS3Location::getS3Key() const {
    return m_s3_key;
}
void OAIS3Location::setS3Key(const QString &s3_key) {
    m_s3_key = s3_key;
    m_s3_key_isSet = true;
}

bool OAIS3Location::is_s3_key_Set() const{
    return m_s3_key_isSet;
}

bool OAIS3Location::is_s3_key_Valid() const{
