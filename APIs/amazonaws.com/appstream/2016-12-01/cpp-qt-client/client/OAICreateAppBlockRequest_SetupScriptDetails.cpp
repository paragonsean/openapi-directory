...
OAICreateAppBlockRequest_SetupScriptDetails::OAICreateAppBlockRequest_SetupScriptDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAppBlockRequest_SetupScriptDetails::OAICreateAppBlockRequest_SetupScriptDetails() {
    this->initializeModel();
}

OAICreateAppBlockRequest_SetupScriptDetails::~OAICreateAppBlockRequest_SetupScriptDetails() {}

void OAICreateAppBlockRequest_SetupScriptDetails::initializeModel() {
...
void OAICreateAppBlockRequest_SetupScriptDetails::fromJson(QString jsonString) {
...
void OAICreateAppBlockRequest_SetupScriptDetails::fromJsonObject(QJsonObject json) {
...
QString OAICreateAppBlockRequest_SetupScriptDetails::asJson() const {
...
QJsonObject OAICreateAppBlockRequest_SetupScriptDetails::asJsonObject() const {
    QJsonObject obj;
...
OAIScriptDetails_ScriptS3Location OAICreateAppBlockRequest_SetupScriptDetails::getScriptS3Location() const {
    return m_script_s3_location;
}
void OAICreateAppBlockRequest_SetupScriptDetails::setScriptS3Location(const OAIScriptDetails_ScriptS3Location &script_s3_location) {
    m_script_s3_location = script_s3_location;
    m_script_s3_location_isSet = true;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_script_s3_location_Set() const{
    return m_script_s3_location_isSet;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_script_s3_location_Valid() const{
    return m_script_s3_location_isValid;
}

QString OAICreateAppBlockRequest_SetupScriptDetails::getExecutablePath() const {
    return m_executable_path;
}
void OAICreateAppBlockRequest_SetupScriptDetails::setExecutablePath(const QString &executable_path) {
    m_executable_path = executable_path;
    m_executable_path_isSet = true;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_executable_path_Set() const{
    return m_executable_path_isSet;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_executable_path_Valid() const{
    return m_executable_path_isValid;
}

QString OAICreateAppBlockRequest_SetupScriptDetails::getExecutableParameters() const {
    return m_executable_parameters;
}
void OAICreateAppBlockRequest_SetupScriptDetails::setExecutableParameters(const QString &executable_parameters) {
    m_executable_parameters = executable_parameters;
    m_executable_parameters_isSet = true;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_executable_parameters_Set() const{
    return m_executable_parameters_isSet;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_executable_parameters_Valid() const{
    return m_executable_parameters_isValid;
}

qint32 OAICreateAppBlockRequest_SetupScriptDetails::getTimeoutInSeconds() const {
    return m_timeout_in_seconds;
}
void OAICreateAppBlockRequest_SetupScriptDetails::setTimeoutInSeconds(const qint32 &timeout_in_seconds) {
    m_timeout_in_seconds = timeout_in_seconds;
    m_timeout_in_seconds_isSet = true;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_timeout_in_seconds_Set() const{
    return m_timeout_in_seconds_isSet;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::is_timeout_in_seconds_Valid() const{
    return m_timeout_in_seconds_isValid;
}

bool OAICreateAppBlockRequest_SetupScriptDetails::isSet() const {
...
bool OAICreateAppBlockRequest_SetupScriptDetails::isValid() const {
