...
OAIImagePermissions::OAIImagePermissions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIImagePermissions::OAIImagePermissions() {
    this->initializeModel();
}

OAIImagePermissions::~OAIImagePermissions() {}

void OAIImagePermissions::initializeModel() {
...
void OAIImagePermissions::fromJson(QString jsonString) {
...
void OAIImagePermissions::fromJsonObject(QJsonObject json) {
...
QString OAIImagePermissions::asJson() const {
...
QJsonObject OAIImagePermissions::asJsonObject() const {
    QJsonObject obj;
...
bool OAIImagePermissions::getAllowFleet() const {
    return m_allow_fleet;
}
void OAIImagePermissions::setAllowFleet(const bool &allow_fleet) {
    m_allow_fleet = allow_fleet;
    m_allow_fleet_isSet = true;
}

bool OAIImagePermissions::is_allow_fleet_Set() const{
    return m_allow_fleet_isSet;
}

bool OAIImagePermissions::is_allow_fleet_Valid() const{
    return m_allow_fleet_isValid;
}

bool OAIImagePermissions::getAllowImageBuilder() const {
    return m_allow_image_builder;
}
void OAIImagePermissions::setAllowImageBuilder(const bool &allow_image_builder) {
    m_allow_image_builder = allow_image_builder;
    m_allow_image_builder_isSet = true;
}

bool OAIImagePermissions::is_allow_image_builder_Set() const{
    return m_allow_image_builder_isSet;
}

bool OAIImagePermissions::is_allow_image_builder_Valid() const{
    return m_allow_image_builder_isValid;
}

bool OAIImagePermissions::isSet() const {
...
bool OAIImagePermissions::isValid() const {
