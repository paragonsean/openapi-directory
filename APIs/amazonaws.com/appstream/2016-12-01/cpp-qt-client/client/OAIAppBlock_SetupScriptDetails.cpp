...
OAIAppBlock_SetupScriptDetails::OAIAppBlock_SetupScriptDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAppBlock_SetupScriptDetails::OAIAppBlock_SetupScriptDetails() {
    this->initializeModel();
}

OAIAppBlock_SetupScriptDetails::~OAIAppBlock_SetupScriptDetails() {}

void OAIAppBlock_SetupScriptDetails::initializeModel() {
...
void OAIAppBlock_SetupScriptDetails::fromJson(QString jsonString) {
...
void OAIAppBlock_SetupScriptDetails::fromJsonObject(QJsonObject json) {
...
QString OAIAppBlock_SetupScriptDetails::asJson() const {
...
QJsonObject OAIAppBlock_SetupScriptDetails::asJsonObject() const {
    QJsonObject obj;
...
OAIScriptDetails_ScriptS3Location OAIAppBlock_SetupScriptDetails::getScriptS3Location() const {
    return m_script_s3_location;
}
void OAIAppBlock_SetupScriptDetails::setScriptS3Location(const OAIScriptDetails_ScriptS3Location &script_s3_location) {
    m_script_s3_location = script_s3_location;
    m_script_s3_location_isSet = true;
}

bool OAIAppBlock_SetupScriptDetails::is_script_s3_location_Set() const{
    return m_script_s3_location_isSet;
}

bool OAIAppBlock_SetupScriptDetails::is_script_s3_location_Valid() const{
    return m_script_s3_location_isValid;
}

QString OAIAppBlock_SetupScriptDetails::getExecutablePath() const {
    return m_executable_path;
}
void OAIAppBlock_SetupScriptDetails::setExecutablePath(const QString &executable_path) {
    m_executable_path = executable_path;
    m_executable_path_isSet = true;
}

bool OAIAppBlock_SetupScriptDetails::is_executable_path_Set() const{
    return m_executable_path_isSet;
}

bool OAIAppBlock_SetupScriptDetails::is_executable_path_Valid() const{
    return m_executable_path_isValid;
}

QString OAIAppBlock_SetupScriptDetails::getExecutableParameters() const {
    return m_executable_parameters;
}
void OAIAppBlock_SetupScriptDetails::setExecutableParameters(const QString &executable_parameters) {
    m_executable_parameters = executable_parameters;
    m_executable_parameters_isSet = true;
}

bool OAIAppBlock_SetupScriptDetails::is_executable_parameters_Set() const{
    return m_executable_parameters_isSet;
}

bool OAIAppBlock_SetupScriptDetails::is_executable_parameters_Valid() const{
    return m_executable_parameters_isValid;
}

qint32 OAIAppBlock_SetupScriptDetails::getTimeoutInSeconds() const {
    return m_timeout_in_seconds;
}
void OAIAppBlock_SetupScriptDetails::setTimeoutInSeconds(const qint32 &timeout_in_seconds) {
    m_timeout_in_seconds = timeout_in_seconds;
    m_timeout_in_seconds_isSet = true;
}

bool OAIAppBlock_SetupScriptDetails::is_timeout_in_seconds_Set() const{
    return m_timeout_in_seconds_isSet;
}

bool OAIAppBlock_SetupScriptDetails::is_timeout_in_seconds_Valid() const{
    return m_timeout_in_seconds_isValid;
}

bool OAIAppBlock_SetupScriptDetails::isSet() const {
...
bool OAIAppBlock_SetupScriptDetails::isValid() const {
