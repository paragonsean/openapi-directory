...
OAIScriptDetails::OAIScriptDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIScriptDetails::OAIScriptDetails() {
    this->initializeModel();
}

OAIScriptDetails::~OAIScriptDetails() {}

void OAIScriptDetails::initializeModel() {
...
void OAIScriptDetails::fromJson(QString jsonString) {
...
void OAIScriptDetails::fromJsonObject(QJsonObject json) {
...
QString OAIScriptDetails::asJson() const {
...
QJsonObject OAIScriptDetails::asJsonObject() const {
    QJsonObject obj;
...
OAIScriptDetails_ScriptS3Location OAIScriptDetails::getScriptS3Location() const {
    return m_script_s3_location;
}
void OAIScriptDetails::setScriptS3Location(const OAIScriptDetails_ScriptS3Location &script_s3_location) {
    m_script_s3_location = script_s3_location;
    m_script_s3_location_isSet = true;
}

bool OAIScriptDetails::is_script_s3_location_Set() const{
    return m_script_s3_location_isSet;
}

bool OAIScriptDetails::is_script_s3_location_Valid() const{
    return m_script_s3_location_isValid;
}

QString OAIScriptDetails::getExecutablePath() const {
    return m_executable_path;
}
void OAIScriptDetails::setExecutablePath(const QString &executable_path) {
    m_executable_path = executable_path;
    m_executable_path_isSet = true;
}

bool OAIScriptDetails::is_executable_path_Set() const{
    return m_executable_path_isSet;
}

bool OAIScriptDetails::is_executable_path_Valid() const{
    return m_executable_path_isValid;
}

QString OAIScriptDetails::getExecutableParameters() const {
    return m_executable_parameters;
}
void OAIScriptDetails::setExecutableParameters(const QString &executable_parameters) {
    m_executable_parameters = executable_parameters;
    m_executable_parameters_isSet = true;
}

bool OAIScriptDetails::is_executable_parameters_Set() const{
    return m_executable_parameters_isSet;
}

bool OAIScriptDetails::is_executable_parameters_Valid() const{
    return m_executable_parameters_isValid;
}

qint32 OAIScriptDetails::getTimeoutInSeconds() const {
    return m_timeout_in_seconds;
}
void OAIScriptDetails::setTimeoutInSeconds(const qint32 &timeout_in_seconds) {
    m_timeout_in_seconds = timeout_in_seconds;
    m_timeout_in_seconds_isSet = true;
}

bool OAIScriptDetails::is_timeout_in_seconds_Set() const{
    return m_timeout_in_seconds_isSet;
}

bool OAIScriptDetails::is_timeout_in_seconds_Valid() const{
    return m_timeout_in_seconds_isValid;
}

bool OAIScriptDetails::isSet() const {
...
bool OAIScriptDetails::isValid() const {
