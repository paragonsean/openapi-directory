...
/*
 * OAIAppBlockBuilderAppBlockAssociation.h
 *
 * Describes an association between an app block builder and app block.
 */

#ifndef OAIAppBlockBuilderAppBlockAssociation_H
#define OAIAppBlockBuilderAppBlockAssociation_H
...
class OAIAppBlockBuilderAppBlockAssociation : public OAIObject {
public:
    OAIAppBlockBuilderAppBlockAssociation();
    OAIAppBlockBuilderAppBlockAssociation(QString json);
    ~OAIAppBlockBuilderAppBlockAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAppBlockBuilderAppBlockAssociation)

#endif // OAIAppBlockBuilderAppBlockAssociation_H
