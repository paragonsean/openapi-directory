...
OAIUpdateFleetRequest_DomainJoinInfo::OAIUpdateFleetRequest_DomainJoinInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateFleetRequest_DomainJoinInfo::OAIUpdateFleetRequest_DomainJoinInfo() {
    this->initializeModel();
}

OAIUpdateFleetRequest_DomainJoinInfo::~OAIUpdateFleetRequest_DomainJoinInfo() {}

void OAIUpdateFleetRequest_DomainJoinInfo::initializeModel() {
...
void OAIUpdateFleetRequest_DomainJoinInfo::fromJson(QString jsonString) {
...
void OAIUpdateFleetRequest_DomainJoinInfo::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateFleetRequest_DomainJoinInfo::asJson() const {
...
QJsonObject OAIUpdateFleetRequest_DomainJoinInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateFleetRequest_DomainJoinInfo::getDirectoryName() const {
    return m_directory_name;
}
void OAIUpdateFleetRequest_DomainJoinInfo::setDirectoryName(const QString &directory_name) {
    m_directory_name = directory_name;
    m_directory_name_isSet = true;
}

bool OAIUpdateFleetRequest_DomainJoinInfo::is_directory_name_Set() const{
    return m_directory_name_isSet;
}

bool OAIUpdateFleetRequest_DomainJoinInfo::is_directory_name_Valid() const{
    return m_directory_name_isValid;
}

QString OAIUpdateFleetRequest_DomainJoinInfo::getOrganizationalUnitDistinguishedName() const {
    return m_organizational_unit_distinguished_name;
}
void OAIUpdateFleetRequest_DomainJoinInfo::setOrganizationalUnitDistinguishedName(const QString &organizational_unit_distinguished_name) {
...
bool OAIUpdateFleetRequest_DomainJoinInfo::is_organizational_unit_distinguished_name_Set() const{
    return m_organizational_unit_distinguished_name_isSet;
}

bool OAIUpdateFleetRequest_DomainJoinInfo::is_organizational_unit_distinguished_name_Valid() const{
    return m_organizational_unit_distinguished_name_isValid;
}

bool OAIUpdateFleetRequest_DomainJoinInfo::isSet() const {
...
bool OAIUpdateFleetRequest_DomainJoinInfo::isValid() const {
