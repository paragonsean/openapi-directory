...
/*
 * OAICreateFleetRequest_VpcConfig.h
 *
 * 
 */

#ifndef OAICreateFleetRequest_VpcConfig_H
#define OAICreateFleetRequest_VpcConfig_H
...
class OAICreateFleetRequest_VpcConfig : public OAIObject {
public:
    OAICreateFleetRequest_VpcConfig();
    OAICreateFleetRequest_VpcConfig(QString json);
    ~OAICreateFleetRequest_VpcConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFleetRequest_VpcConfig)

#endif // OAICreateFleetRequest_VpcConfig_H
