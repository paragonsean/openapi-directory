...
public class RefreshPreferences {
  ...
  public RefreshPreferences minHealthyPercentage(Integer minHealthyPercentage) {
  ...
  public RefreshPreferences instanceWarmup(Integer instanceWarmup) {
  ...
  public RefreshPreferences checkpointPercentages(List checkpointPercentages) {
  ...
  public RefreshPreferences checkpointDelay(Integer checkpointDelay) {
  ...
  public RefreshPreferences skipMatching(Boolean skipMatching) {
  ...
  public RefreshPreferences autoRollback(Boolean autoRollback) {
  ...
  public RefreshPreferences scaleInProtectedInstances(ScaleInProtectedInstances scaleInProtectedInstances) {
  ...
  public RefreshPreferences standbyInstances(StandbyInstances standbyInstances) {
  ...
  public RefreshPreferences alarmSpecification(GETStartInstanceRefreshPreferencesParameterAlarmSpecification alarmSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    RefreshPreferences refreshPreferences = (RefreshPreferences) o;
    return Objects.equals(this.minHealthyPercentage, refreshPreferences.minHealthyPercentage) &&
        Objects.equals(this.instanceWarmup, refreshPreferences.instanceWarmup) &&
        Objects.equals(this.checkpointPercentages, refreshPreferences.checkpointPercentages) &&
        Objects.equals(this.checkpointDelay, refreshPreferences.checkpointDelay) &&
        Objects.equals(this.skipMatching, refreshPreferences.skipMatching) &&
        Objects.equals(this.autoRollback, refreshPreferences.autoRollback) &&
        Objects.equals(this.scaleInProtectedInstances, refreshPreferences.scaleInProtectedInstances) &&
        Objects.equals(this.standbyInstances, refreshPreferences.standbyInstances) &&
        Objects.equals(this.alarmSpecification, refreshPreferences.alarmSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class RefreshPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefreshPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RefreshPreferences is not found in the empty JSON string", RefreshPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RefreshPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefreshPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefreshPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefreshPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefreshPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<RefreshPreferences>() {
           @Override
           public void write(JsonWriter out, RefreshPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefreshPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RefreshPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RefreshPreferences
   * @throws IOException if the JSON string is invalid with respect to RefreshPreferences
   */
  public static RefreshPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefreshPreferences.class);
  }

  /**
   * Convert an instance of RefreshPreferences to an JSON string
   *
   * @return JSON string
   */
