...
public class Ebs {
  ...
  public Ebs snapshotId(String snapshotId) {
  ...
  public Ebs volumeSize(Integer volumeSize) {
  ...
  public Ebs volumeType(String volumeType) {
  ...
  public Ebs deleteOnTermination(Boolean deleteOnTermination) {
  ...
  public Ebs encrypted(Boolean encrypted) {
  ...
  public Ebs throughput(Integer throughput) {
  ...
  public boolean equals(Object o) {
    ...
    Ebs ebs = (Ebs) o;
    return Objects.equals(this.snapshotId, ebs.snapshotId) &&
        Objects.equals(this.volumeSize, ebs.volumeSize) &&
        Objects.equals(this.volumeType, ebs.volumeType) &&
        Objects.equals(this.deleteOnTermination, ebs.deleteOnTermination) &&
        Objects.equals(this.iops, ebs.iops) &&
        Objects.equals(this.encrypted, ebs.encrypted) &&
        Objects.equals(this.throughput, ebs.throughput);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ebs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ebs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ebs is not found in the empty JSON string", Ebs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ebs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ebs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ebs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ebs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ebs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ebs.class));

       return (TypeAdapter<T>) new TypeAdapter<Ebs>() {
           @Override
           public void write(JsonWriter out, Ebs value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ebs read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ebs given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ebs
   * @throws IOException if the JSON string is invalid with respect to Ebs
   */
  public static Ebs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ebs.class);
  }

  /**
   * Convert an instance of Ebs to an JSON string
   *
   * @return JSON string
   */
