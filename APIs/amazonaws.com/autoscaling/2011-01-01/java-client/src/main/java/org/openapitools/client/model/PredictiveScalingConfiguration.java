...
public class PredictiveScalingConfiguration {
  ...
  public PredictiveScalingConfiguration metricSpecifications(List metricSpecifications) {
  ...
  public PredictiveScalingConfiguration mode(PredictiveScalingMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public PredictiveScalingConfiguration schedulingBufferTime(Integer schedulingBufferTime) {
  ...
  public PredictiveScalingConfiguration maxCapacityBreachBehavior(PredictiveScalingMaxCapacityBreachBehavior maxCapacityBreachBehavior) {
  ...
  public PredictiveScalingConfiguration maxCapacityBuffer(Integer maxCapacityBuffer) {
  ...
  public boolean equals(Object o) {
    ...
    PredictiveScalingConfiguration predictiveScalingConfiguration = (PredictiveScalingConfiguration) o;
    return Objects.equals(this.metricSpecifications, predictiveScalingConfiguration.metricSpecifications) &&
        Objects.equals(this.mode, predictiveScalingConfiguration.mode) &&
        Objects.equals(this.schedulingBufferTime, predictiveScalingConfiguration.schedulingBufferTime) &&
        Objects.equals(this.maxCapacityBreachBehavior, predictiveScalingConfiguration.maxCapacityBreachBehavior) &&
        Objects.equals(this.maxCapacityBuffer, predictiveScalingConfiguration.maxCapacityBuffer);
  }
  ...
  public String toString() {
    ...
    sb.append("class PredictiveScalingConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PredictiveScalingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PredictiveScalingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PredictiveScalingConfiguration is not found in the empty JSON string", PredictiveScalingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PredictiveScalingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PredictiveScalingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PredictiveScalingConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PredictiveScalingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PredictiveScalingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PredictiveScalingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PredictiveScalingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PredictiveScalingConfiguration>() {
           @Override
           public void write(JsonWriter out, PredictiveScalingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PredictiveScalingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PredictiveScalingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PredictiveScalingConfiguration
   * @throws IOException if the JSON string is invalid with respect to PredictiveScalingConfiguration
   */
  public static PredictiveScalingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PredictiveScalingConfiguration.class);
  }

  /**
   * Convert an instance of PredictiveScalingConfiguration to an JSON string
   *
   * @return JSON string
   */
