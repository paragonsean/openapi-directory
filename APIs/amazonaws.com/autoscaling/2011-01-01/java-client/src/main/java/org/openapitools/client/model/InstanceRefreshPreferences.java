...
public class InstanceRefreshPreferences {
  ...
  public InstanceRefreshPreferences() {
  }

  public InstanceRefreshPreferences minHealthyPercentage(Integer minHealthyPercentage) {
  ...
  public InstanceRefreshPreferences instanceWarmup(Integer instanceWarmup) {
  ...
  public InstanceRefreshPreferences checkpointPercentages(List checkpointPercentages) {
  ...
  public InstanceRefreshPreferences checkpointDelay(Integer checkpointDelay) {
  ...
  public InstanceRefreshPreferences skipMatching(Boolean skipMatching) {
  ...
  public InstanceRefreshPreferences autoRollback(Boolean autoRollback) {
  ...
  public InstanceRefreshPreferences scaleInProtectedInstances(ScaleInProtectedInstances scaleInProtectedInstances) {
  ...
  public InstanceRefreshPreferences standbyInstances(StandbyInstances standbyInstances) {
  ...
  public InstanceRefreshPreferences alarmSpecification(GETStartInstanceRefreshPreferencesParameterAlarmSpecification alarmSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceRefreshPreferences instanceRefreshPreferences = (InstanceRefreshPreferences) o;
    return Objects.equals(this.minHealthyPercentage, instanceRefreshPreferences.minHealthyPercentage) &&
        Objects.equals(this.instanceWarmup, instanceRefreshPreferences.instanceWarmup) &&
        Objects.equals(this.checkpointPercentages, instanceRefreshPreferences.checkpointPercentages) &&
        Objects.equals(this.checkpointDelay, instanceRefreshPreferences.checkpointDelay) &&
        Objects.equals(this.skipMatching, instanceRefreshPreferences.skipMatching) &&
        Objects.equals(this.autoRollback, instanceRefreshPreferences.autoRollback) &&
        Objects.equals(this.scaleInProtectedInstances, instanceRefreshPreferences.scaleInProtectedInstances) &&
        Objects.equals(this.standbyInstances, instanceRefreshPreferences.standbyInstances) &&
        Objects.equals(this.alarmSpecification, instanceRefreshPreferences.alarmSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceRefreshPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceRefreshPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceRefreshPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceRefreshPreferences is not found in the empty JSON string", InstanceRefreshPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceRefreshPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceRefreshPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceRefreshPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceRefreshPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceRefreshPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceRefreshPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceRefreshPreferences>() {
           @Override
           public void write(JsonWriter out, InstanceRefreshPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceRefreshPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceRefreshPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceRefreshPreferences
   * @throws IOException if the JSON string is invalid with respect to InstanceRefreshPreferences
   */
  public static InstanceRefreshPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceRefreshPreferences.class);
  }

  /**
   * Convert an instance of InstanceRefreshPreferences to an JSON string
   *
   * @return JSON string
   */
