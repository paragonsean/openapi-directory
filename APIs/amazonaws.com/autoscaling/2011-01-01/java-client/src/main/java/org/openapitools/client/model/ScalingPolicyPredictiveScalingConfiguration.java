...
public class ScalingPolicyPredictiveScalingConfiguration {
  ...
  public ScalingPolicyPredictiveScalingConfiguration() {
  }

  public ScalingPolicyPredictiveScalingConfiguration metricSpecifications(List metricSpecifications) {
  ...
  public ScalingPolicyPredictiveScalingConfiguration mode(PredictiveScalingMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public ScalingPolicyPredictiveScalingConfiguration schedulingBufferTime(Integer schedulingBufferTime) {
  ...
  public ScalingPolicyPredictiveScalingConfiguration maxCapacityBreachBehavior(PredictiveScalingMaxCapacityBreachBehavior maxCapacityBreachBehavior) {
  ...
  public ScalingPolicyPredictiveScalingConfiguration maxCapacityBuffer(Integer maxCapacityBuffer) {
  ...
  public boolean equals(Object o) {
    ...
    ScalingPolicyPredictiveScalingConfiguration scalingPolicyPredictiveScalingConfiguration = (ScalingPolicyPredictiveScalingConfiguration) o;
    return Objects.equals(this.metricSpecifications, scalingPolicyPredictiveScalingConfiguration.metricSpecifications) &&
        Objects.equals(this.mode, scalingPolicyPredictiveScalingConfiguration.mode) &&
        Objects.equals(this.schedulingBufferTime, scalingPolicyPredictiveScalingConfiguration.schedulingBufferTime) &&
        Objects.equals(this.maxCapacityBreachBehavior, scalingPolicyPredictiveScalingConfiguration.maxCapacityBreachBehavior) &&
        Objects.equals(this.maxCapacityBuffer, scalingPolicyPredictiveScalingConfiguration.maxCapacityBuffer);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScalingPolicyPredictiveScalingConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScalingPolicyPredictiveScalingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScalingPolicyPredictiveScalingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScalingPolicyPredictiveScalingConfiguration is not found in the empty JSON string", ScalingPolicyPredictiveScalingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScalingPolicyPredictiveScalingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScalingPolicyPredictiveScalingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScalingPolicyPredictiveScalingConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScalingPolicyPredictiveScalingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScalingPolicyPredictiveScalingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScalingPolicyPredictiveScalingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScalingPolicyPredictiveScalingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ScalingPolicyPredictiveScalingConfiguration>() {
           @Override
           public void write(JsonWriter out, ScalingPolicyPredictiveScalingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScalingPolicyPredictiveScalingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScalingPolicyPredictiveScalingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScalingPolicyPredictiveScalingConfiguration
   * @throws IOException if the JSON string is invalid with respect to ScalingPolicyPredictiveScalingConfiguration
   */
  public static ScalingPolicyPredictiveScalingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScalingPolicyPredictiveScalingConfiguration.class);
  }

  /**
   * Convert an instance of ScalingPolicyPredictiveScalingConfiguration to an JSON string
   *
   * @return JSON string
   */
