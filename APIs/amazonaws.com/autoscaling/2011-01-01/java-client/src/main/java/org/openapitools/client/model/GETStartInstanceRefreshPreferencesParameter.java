...
public class GETStartInstanceRefreshPreferencesParameter {
  ...
  public GETStartInstanceRefreshPreferencesParameter() {
  }

  public GETStartInstanceRefreshPreferencesParameter minHealthyPercentage(Integer minHealthyPercentage) {
  ...
  public GETStartInstanceRefreshPreferencesParameter instanceWarmup(Integer instanceWarmup) {
  ...
  public GETStartInstanceRefreshPreferencesParameter checkpointPercentages(List checkpointPercentages) {
  ...
  public GETStartInstanceRefreshPreferencesParameter checkpointDelay(Integer checkpointDelay) {
  ...
  public GETStartInstanceRefreshPreferencesParameter skipMatching(Boolean skipMatching) {
  ...
  public GETStartInstanceRefreshPreferencesParameter autoRollback(Boolean autoRollback) {
  ...
  public GETStartInstanceRefreshPreferencesParameter scaleInProtectedInstances(ScaleInProtectedInstances scaleInProtectedInstances) {
  ...
  public GETStartInstanceRefreshPreferencesParameter standbyInstances(StandbyInstances standbyInstances) {
  ...
  public GETStartInstanceRefreshPreferencesParameter alarmSpecification(GETStartInstanceRefreshPreferencesParameterAlarmSpecification alarmSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    GETStartInstanceRefreshPreferencesParameter geTStartInstanceRefreshPreferencesParameter = (GETStartInstanceRefreshPreferencesParameter) o;
    return Objects.equals(this.minHealthyPercentage, geTStartInstanceRefreshPreferencesParameter.minHealthyPercentage) &&
        Objects.equals(this.instanceWarmup, geTStartInstanceRefreshPreferencesParameter.instanceWarmup) &&
        Objects.equals(this.checkpointPercentages, geTStartInstanceRefreshPreferencesParameter.checkpointPercentages) &&
        Objects.equals(this.checkpointDelay, geTStartInstanceRefreshPreferencesParameter.checkpointDelay) &&
        Objects.equals(this.skipMatching, geTStartInstanceRefreshPreferencesParameter.skipMatching) &&
        Objects.equals(this.autoRollback, geTStartInstanceRefreshPreferencesParameter.autoRollback) &&
        Objects.equals(this.scaleInProtectedInstances, geTStartInstanceRefreshPreferencesParameter.scaleInProtectedInstances) &&
        Objects.equals(this.standbyInstances, geTStartInstanceRefreshPreferencesParameter.standbyInstances) &&
        Objects.equals(this.alarmSpecification, geTStartInstanceRefreshPreferencesParameter.alarmSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class GETStartInstanceRefreshPreferencesParameter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GETStartInstanceRefreshPreferencesParameter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GETStartInstanceRefreshPreferencesParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GETStartInstanceRefreshPreferencesParameter is not found in the empty JSON string", GETStartInstanceRefreshPreferencesParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GETStartInstanceRefreshPreferencesParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GETStartInstanceRefreshPreferencesParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GETStartInstanceRefreshPreferencesParameter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GETStartInstanceRefreshPreferencesParameter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GETStartInstanceRefreshPreferencesParameter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GETStartInstanceRefreshPreferencesParameter.class));

       return (TypeAdapter<T>) new TypeAdapter<GETStartInstanceRefreshPreferencesParameter>() {
           @Override
           public void write(JsonWriter out, GETStartInstanceRefreshPreferencesParameter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GETStartInstanceRefreshPreferencesParameter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GETStartInstanceRefreshPreferencesParameter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GETStartInstanceRefreshPreferencesParameter
   * @throws IOException if the JSON string is invalid with respect to GETStartInstanceRefreshPreferencesParameter
   */
  public static GETStartInstanceRefreshPreferencesParameter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GETStartInstanceRefreshPreferencesParameter.class);
  }

  /**
   * Convert an instance of GETStartInstanceRefreshPreferencesParameter to an JSON string
   *
   * @return JSON string
   */
