...
public class InstancesDistribution {
  ...
  public InstancesDistribution onDemandAllocationStrategy(String onDemandAllocationStrategy) {
  ...
  public InstancesDistribution onDemandBaseCapacity(Integer onDemandBaseCapacity) {
  ...
  public InstancesDistribution onDemandPercentageAboveBaseCapacity(Integer onDemandPercentageAboveBaseCapacity) {
  ...
  public InstancesDistribution spotAllocationStrategy(String spotAllocationStrategy) {
  ...
  public InstancesDistribution spotInstancePools(Integer spotInstancePools) {
  ...
  public InstancesDistribution spotMaxPrice(String spotMaxPrice) {
  ...
  public boolean equals(Object o) {
    ...
    InstancesDistribution instancesDistribution = (InstancesDistribution) o;
    return Objects.equals(this.onDemandAllocationStrategy, instancesDistribution.onDemandAllocationStrategy) &&
        Objects.equals(this.onDemandBaseCapacity, instancesDistribution.onDemandBaseCapacity) &&
        Objects.equals(this.onDemandPercentageAboveBaseCapacity, instancesDistribution.onDemandPercentageAboveBaseCapacity) &&
        Objects.equals(this.spotAllocationStrategy, instancesDistribution.spotAllocationStrategy) &&
        Objects.equals(this.spotInstancePools, instancesDistribution.spotInstancePools) &&
        Objects.equals(this.spotMaxPrice, instancesDistribution.spotMaxPrice);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstancesDistribution {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstancesDistribution
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstancesDistribution.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstancesDistribution is not found in the empty JSON string", InstancesDistribution.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstancesDistribution.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstancesDistribution` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstancesDistribution.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstancesDistribution' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstancesDistribution> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstancesDistribution.class));

       return (TypeAdapter<T>) new TypeAdapter<InstancesDistribution>() {
           @Override
           public void write(JsonWriter out, InstancesDistribution value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstancesDistribution read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstancesDistribution given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstancesDistribution
   * @throws IOException if the JSON string is invalid with respect to InstancesDistribution
   */
  public static InstancesDistribution fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstancesDistribution.class);
  }

  /**
   * Convert an instance of InstancesDistribution to an JSON string
   *
   * @return JSON string
   */
