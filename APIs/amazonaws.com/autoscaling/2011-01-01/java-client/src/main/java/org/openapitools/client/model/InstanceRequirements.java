...
public class InstanceRequirements {
  ...
  public InstanceRequirements vcpuCount(InstanceRequirementsVCpuCount vcpuCount) {
  ...
  public InstanceRequirements memoryMiB(InstanceRequirementsMemoryMiB memoryMiB) {
  ...
  public InstanceRequirements cpuManufacturers(List cpuManufacturers) {
  ...
  public InstanceRequirements memoryGiBPerVCpu(InstanceRequirementsMemoryGiBPerVCpu memoryGiBPerVCpu) {
  ...
  public InstanceRequirements excludedInstanceTypes(List excludedInstanceTypes) {
  ...
  public InstanceRequirements instanceGenerations(List instanceGenerations) {
  ...
  public InstanceRequirements spotMaxPricePercentageOverLowestPrice(Integer spotMaxPricePercentageOverLowestPrice) {
  ...
  public InstanceRequirements onDemandMaxPricePercentageOverLowestPrice(Integer onDemandMaxPricePercentageOverLowestPrice) {
  ...
  public InstanceRequirements bareMetal(BareMetal bareMetal) {
  ...
  public InstanceRequirements burstablePerformance(BurstablePerformance burstablePerformance) {
  ...
  public InstanceRequirements requireHibernateSupport(Boolean requireHibernateSupport) {
  ...
  public InstanceRequirements networkInterfaceCount(InstanceRequirementsNetworkInterfaceCount networkInterfaceCount) {
  ...
  public InstanceRequirements localStorage(LocalStorage localStorage) {
  ...
  public InstanceRequirements localStorageTypes(List localStorageTypes) {
  ...
  public InstanceRequirements totalLocalStorageGB(InstanceRequirementsTotalLocalStorageGB totalLocalStorageGB) {
  ...
  public InstanceRequirements baselineEbsBandwidthMbps(InstanceRequirementsBaselineEbsBandwidthMbps baselineEbsBandwidthMbps) {
  ...
  public InstanceRequirements acceleratorTypes(List acceleratorTypes) {
  ...
  public InstanceRequirements acceleratorCount(InstanceRequirementsAcceleratorCount acceleratorCount) {
  ...
  public InstanceRequirements acceleratorManufacturers(List acceleratorManufacturers) {
  ...
  public InstanceRequirements acceleratorNames(List acceleratorNames) {
  ...
  public InstanceRequirements acceleratorTotalMemoryMiB(InstanceRequirementsAcceleratorTotalMemoryMiB acceleratorTotalMemoryMiB) {
  ...
  public InstanceRequirements networkBandwidthGbps(InstanceRequirementsNetworkBandwidthGbps networkBandwidthGbps) {
  ...
  public InstanceRequirements allowedInstanceTypes(List allowedInstanceTypes) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceRequirements instanceRequirements = (InstanceRequirements) o;
    return Objects.equals(this.vcpuCount, instanceRequirements.vcpuCount) &&
        Objects.equals(this.memoryMiB, instanceRequirements.memoryMiB) &&
        Objects.equals(this.cpuManufacturers, instanceRequirements.cpuManufacturers) &&
        Objects.equals(this.memoryGiBPerVCpu, instanceRequirements.memoryGiBPerVCpu) &&
        Objects.equals(this.excludedInstanceTypes, instanceRequirements.excludedInstanceTypes) &&
        Objects.equals(this.instanceGenerations, instanceRequirements.instanceGenerations) &&
        Objects.equals(this.spotMaxPricePercentageOverLowestPrice, instanceRequirements.spotMaxPricePercentageOverLowestPrice) &&
        Objects.equals(this.onDemandMaxPricePercentageOverLowestPrice, instanceRequirements.onDemandMaxPricePercentageOverLowestPrice) &&
        Objects.equals(this.bareMetal, instanceRequirements.bareMetal) &&
        Objects.equals(this.burstablePerformance, instanceRequirements.burstablePerformance) &&
        Objects.equals(this.requireHibernateSupport, instanceRequirements.requireHibernateSupport) &&
        Objects.equals(this.networkInterfaceCount, instanceRequirements.networkInterfaceCount) &&
        Objects.equals(this.localStorage, instanceRequirements.localStorage) &&
        Objects.equals(this.localStorageTypes, instanceRequirements.localStorageTypes) &&
        Objects.equals(this.totalLocalStorageGB, instanceRequirements.totalLocalStorageGB) &&
        Objects.equals(this.baselineEbsBandwidthMbps, instanceRequirements.baselineEbsBandwidthMbps) &&
        Objects.equals(this.acceleratorTypes, instanceRequirements.acceleratorTypes) &&
        Objects.equals(this.acceleratorCount, instanceRequirements.acceleratorCount) &&
        Objects.equals(this.acceleratorManufacturers, instanceRequirements.acceleratorManufacturers) &&
        Objects.equals(this.acceleratorNames, instanceRequirements.acceleratorNames) &&
        Objects.equals(this.acceleratorTotalMemoryMiB, instanceRequirements.acceleratorTotalMemoryMiB) &&
        Objects.equals(this.networkBandwidthGbps, instanceRequirements.networkBandwidthGbps) &&
        Objects.equals(this.allowedInstanceTypes, instanceRequirements.allowedInstanceTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceRequirements {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstanceRequirements
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstanceRequirements.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceRequirements is not found in the empty JSON string", InstanceRequirements.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstanceRequirements.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstanceRequirements` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstanceRequirements.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceRequirements.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceRequirements' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceRequirements> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceRequirements.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceRequirements>() {
           @Override
           public void write(JsonWriter out, InstanceRequirements value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstanceRequirements read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstanceRequirements given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstanceRequirements
   * @throws IOException if the JSON string is invalid with respect to InstanceRequirements
   */
  public static InstanceRequirements fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceRequirements.class);
  }

  /**
   * Convert an instance of InstanceRequirements to an JSON string
   *
   * @return JSON string
   */
