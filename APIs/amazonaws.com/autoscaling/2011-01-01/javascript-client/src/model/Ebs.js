...
/**
 * The Ebs model module.
 * @module model/Ebs
 * @version 2011-01-01
 */
class Ebs {
    /**
     * Constructs a new <code>Ebs</code>.
     * Describes information used to set up an Amazon EBS volume specified in a block device mapping.
     * @alias module:model/Ebs
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>Ebs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Ebs} obj Optional instance to populate.
     * @return {module:model/Ebs} The populated <code>Ebs</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>Ebs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Ebs</code>.
     */
