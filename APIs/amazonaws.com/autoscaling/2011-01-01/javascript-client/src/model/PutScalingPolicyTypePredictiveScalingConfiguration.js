...
/**
 * The PutScalingPolicyTypePredictiveScalingConfiguration model module.
 * @module model/PutScalingPolicyTypePredictiveScalingConfiguration
 * @version 2011-01-01
 */
class PutScalingPolicyTypePredictiveScalingConfiguration {
    /**
     * Constructs a new <code>PutScalingPolicyTypePredictiveScalingConfiguration</code>.
     * @alias module:model/PutScalingPolicyTypePredictiveScalingConfiguration
    ...
    constructor(metricSpecifications) { 
        ...
        PutScalingPolicyTypePredictiveScalingConfiguration.initialize(this, metricSpecifications);
    }
    ...
    /**
     * Constructs a <code>PutScalingPolicyTypePredictiveScalingConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutScalingPolicyTypePredictiveScalingConfiguration} obj Optional instance to populate.
     * @return {module:model/PutScalingPolicyTypePredictiveScalingConfiguration} The populated <code>PutScalingPolicyTypePredictiveScalingConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutScalingPolicyTypePredictiveScalingConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>PutScalingPolicyTypePredictiveScalingConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutScalingPolicyTypePredictiveScalingConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutScalingPolicyTypePredictiveScalingConfiguration.RequiredProperties) {
...
PutScalingPolicyTypePredictiveScalingConfiguration.RequiredProperties = ["MetricSpecifications"];

/**
 * @member {Array} MetricSpecifications
 */
PutScalingPolicyTypePredictiveScalingConfiguration.prototype['MetricSpecifications'] = undefined;

/**
 * @member {module:model/PredictiveScalingMode} Mode
 */
PutScalingPolicyTypePredictiveScalingConfiguration.prototype['Mode'] = undefined;

/**
 * @member {Number} SchedulingBufferTime
 */
PutScalingPolicyTypePredictiveScalingConfiguration.prototype['SchedulingBufferTime'] = undefined;

/**
 * @member {module:model/PredictiveScalingMaxCapacityBreachBehavior} MaxCapacityBreachBehavior
 */
PutScalingPolicyTypePredictiveScalingConfiguration.prototype['MaxCapacityBreachBehavior'] = undefined;

/**
 * @member {Number} MaxCapacityBuffer
 */
PutScalingPolicyTypePredictiveScalingConfiguration.prototype['MaxCapacityBuffer'] = undefined;
...
export default PutScalingPolicyTypePredictiveScalingConfiguration;
