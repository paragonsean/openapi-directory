...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://autoscaling.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://autoscaling.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2011-01-01/Javascript'
        };
