...
(function(root, factory) {
  ...
  describe('Ebs', function() {
    it('should create an instance of Ebs', function() {
      // uncomment below and update the code to test Ebs
      //var instance = new AutoScaling.Ebs();
      //expect(instance).to.be.a(AutoScaling.Ebs);
    });
