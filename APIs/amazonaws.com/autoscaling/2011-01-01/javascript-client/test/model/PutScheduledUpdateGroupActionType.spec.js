...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.PutScheduledUpdateGroupActionType();
  });
  ...
  describe('PutScheduledUpdateGroupActionType', function() {
    it('should create an instance of PutScheduledUpdateGroupActionType', function() {
      // uncomment below and update the code to test PutScheduledUpdateGroupActionType
      //var instance = new AutoScaling.PutScheduledUpdateGroupActionType();
      //expect(instance).to.be.a(AutoScaling.PutScheduledUpdateGroupActionType);
    });
