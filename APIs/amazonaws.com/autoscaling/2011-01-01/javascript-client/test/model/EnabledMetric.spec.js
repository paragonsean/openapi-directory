...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.EnabledMetric();
  });
  ...
  describe('EnabledMetric', function() {
    it('should create an instance of EnabledMetric', function() {
      // uncomment below and update the code to test EnabledMetric
      //var instance = new AutoScaling.EnabledMetric();
      //expect(instance).to.be.a(AutoScaling.EnabledMetric);
    });
