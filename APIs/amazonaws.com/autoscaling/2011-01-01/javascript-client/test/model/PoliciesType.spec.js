...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.PoliciesType();
  });
  ...
  describe('PoliciesType', function() {
    it('should create an instance of PoliciesType', function() {
      // uncomment below and update the code to test PoliciesType
      //var instance = new AutoScaling.PoliciesType();
      //expect(instance).to.be.a(AutoScaling.PoliciesType);
    });
