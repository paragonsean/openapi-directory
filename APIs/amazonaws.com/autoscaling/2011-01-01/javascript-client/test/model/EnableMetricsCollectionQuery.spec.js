...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.EnableMetricsCollectionQuery();
  });
  ...
  describe('EnableMetricsCollectionQuery', function() {
    it('should create an instance of EnableMetricsCollectionQuery', function() {
      // uncomment below and update the code to test EnableMetricsCollectionQuery
      //var instance = new AutoScaling.EnableMetricsCollectionQuery();
      //expect(instance).to.be.a(AutoScaling.EnableMetricsCollectionQuery);
    });
