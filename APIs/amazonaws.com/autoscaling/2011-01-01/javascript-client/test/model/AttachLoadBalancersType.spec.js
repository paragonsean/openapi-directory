...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.AttachLoadBalancersType();
  });
  ...
  describe('AttachLoadBalancersType', function() {
    it('should create an instance of AttachLoadBalancersType', function() {
      // uncomment below and update the code to test AttachLoadBalancersType
      //var instance = new AutoScaling.AttachLoadBalancersType();
      //expect(instance).to.be.a(AutoScaling.AttachLoadBalancersType);
    });
