...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.CreateLaunchConfigurationType();
  });
  ...
  describe('CreateLaunchConfigurationType', function() {
    it('should create an instance of CreateLaunchConfigurationType', function() {
      // uncomment below and update the code to test CreateLaunchConfigurationType
      //var instance = new AutoScaling.CreateLaunchConfigurationType();
      //expect(instance).to.be.a(AutoScaling.CreateLaunchConfigurationType);
    });
