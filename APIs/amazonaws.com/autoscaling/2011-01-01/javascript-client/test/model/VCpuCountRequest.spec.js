...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.VCpuCountRequest();
  });
  ...
  describe('VCpuCountRequest', function() {
    it('should create an instance of VCpuCountRequest', function() {
      // uncomment below and update the code to test VCpuCountRequest
      //var instance = new AutoScaling.VCpuCountRequest();
      //expect(instance).to.be.a(AutoScaling.VCpuCountRequest);
    });
