...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.UpdateAutoScalingGroupType();
  });
  ...
  describe('UpdateAutoScalingGroupType', function() {
    it('should create an instance of UpdateAutoScalingGroupType', function() {
      // uncomment below and update the code to test UpdateAutoScalingGroupType
      //var instance = new AutoScaling.UpdateAutoScalingGroupType();
      //expect(instance).to.be.a(AutoScaling.UpdateAutoScalingGroupType);
    });
