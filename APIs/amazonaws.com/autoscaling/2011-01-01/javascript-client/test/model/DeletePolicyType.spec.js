...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.DeletePolicyType();
  });
  ...
  describe('DeletePolicyType', function() {
    it('should create an instance of DeletePolicyType', function() {
      // uncomment below and update the code to test DeletePolicyType
      //var instance = new AutoScaling.DeletePolicyType();
      //expect(instance).to.be.a(AutoScaling.DeletePolicyType);
    });
