...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.AttachTrafficSourcesType();
  });
  ...
  describe('AttachTrafficSourcesType', function() {
    it('should create an instance of AttachTrafficSourcesType', function() {
      // uncomment below and update the code to test AttachTrafficSourcesType
      //var instance = new AutoScaling.AttachTrafficSourcesType();
      //expect(instance).to.be.a(AutoScaling.AttachTrafficSourcesType);
    });
