...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.MemoryMiBRequest();
  });
  ...
  describe('MemoryMiBRequest', function() {
    it('should create an instance of MemoryMiBRequest', function() {
      // uncomment below and update the code to test MemoryMiBRequest
      //var instance = new AutoScaling.MemoryMiBRequest();
      //expect(instance).to.be.a(AutoScaling.MemoryMiBRequest);
    });
