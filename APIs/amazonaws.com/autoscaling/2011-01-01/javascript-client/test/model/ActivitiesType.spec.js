...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.ActivitiesType();
  });
  ...
  describe('ActivitiesType', function() {
    it('should create an instance of ActivitiesType', function() {
      // uncomment below and update the code to test ActivitiesType
      //var instance = new AutoScaling.ActivitiesType();
      //expect(instance).to.be.a(AutoScaling.ActivitiesType);
    });
