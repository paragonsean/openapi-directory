...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.TargetTrackingMetricStatMetric();
  });
  ...
  describe('TargetTrackingMetricStatMetric', function() {
    it('should create an instance of TargetTrackingMetricStatMetric', function() {
      // uncomment below and update the code to test TargetTrackingMetricStatMetric
      //var instance = new AutoScaling.TargetTrackingMetricStatMetric();
      //expect(instance).to.be.a(AutoScaling.TargetTrackingMetricStatMetric);
    });
