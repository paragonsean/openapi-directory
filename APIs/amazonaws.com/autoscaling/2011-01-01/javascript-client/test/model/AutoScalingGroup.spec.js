...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.AutoScalingGroup();
  });
  ...
  describe('AutoScalingGroup', function() {
    it('should create an instance of AutoScalingGroup', function() {
      // uncomment below and update the code to test AutoScalingGroup
      //var instance = new AutoScaling.AutoScalingGroup();
      //expect(instance).to.be.a(AutoScaling.AutoScalingGroup);
    });
    ...
    it('should have the property predictedCapacity (base name: "PredictedCapacity")', function() {
      // uncomment below and update the code to test the property predictedCapacity
      //var instance = new AutoScaling.AutoScalingGroup();
      //expect(instance).to.be();
    });
    ...
    it('should have the property suspendedProcesses (base name: "SuspendedProcesses")', function() {
      // uncomment below and update the code to test the property suspendedProcesses
      //var instance = new AutoScaling.AutoScalingGroup();
      //expect(instance).to.be();
    });
    ...
    it('should have the property enabledMetrics (base name: "EnabledMetrics")', function() {
      // uncomment below and update the code to test the property enabledMetrics
      //var instance = new AutoScaling.AutoScalingGroup();
      //expect(instance).to.be();
    });
    ...
    it('should have the property warmPoolConfiguration (base name: "WarmPoolConfiguration")', function() {
      // uncomment below and update the code to test the property warmPoolConfiguration
      //var instance = new AutoScaling.AutoScalingGroup();
      //expect(instance).to.be();
    });

    it('should have the property warmPoolSize (base name: "WarmPoolSize")', function() {
      // uncomment below and update the code to test the property warmPoolSize
      //var instance = new AutoScaling.AutoScalingGroup();
      //expect(instance).to.be();
    });
