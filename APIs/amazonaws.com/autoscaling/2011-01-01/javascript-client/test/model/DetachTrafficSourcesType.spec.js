...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.DetachTrafficSourcesType();
  });
  ...
  describe('DetachTrafficSourcesType', function() {
    it('should create an instance of DetachTrafficSourcesType', function() {
      // uncomment below and update the code to test DetachTrafficSourcesType
      //var instance = new AutoScaling.DetachTrafficSourcesType();
      //expect(instance).to.be.a(AutoScaling.DetachTrafficSourcesType);
    });
