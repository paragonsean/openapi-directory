...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.PolicyARNType();
  });
  ...
  describe('PolicyARNType', function() {
    it('should create an instance of PolicyARNType', function() {
      // uncomment below and update the code to test PolicyARNType
      //var instance = new AutoScaling.PolicyARNType();
      //expect(instance).to.be.a(AutoScaling.PolicyARNType);
    });
