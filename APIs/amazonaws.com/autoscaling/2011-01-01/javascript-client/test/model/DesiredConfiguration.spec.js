...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.DesiredConfiguration();
  });
  ...
  describe('DesiredConfiguration', function() {
    it('should create an instance of DesiredConfiguration', function() {
      // uncomment below and update the code to test DesiredConfiguration
      //var instance = new AutoScaling.DesiredConfiguration();
      //expect(instance).to.be.a(AutoScaling.DesiredConfiguration);
    });
