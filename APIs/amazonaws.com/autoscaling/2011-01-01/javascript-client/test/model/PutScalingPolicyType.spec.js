...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.PutScalingPolicyType();
  });
  ...
  describe('PutScalingPolicyType', function() {
    it('should create an instance of PutScalingPolicyType', function() {
      // uncomment below and update the code to test PutScalingPolicyType
      //var instance = new AutoScaling.PutScalingPolicyType();
      //expect(instance).to.be.a(AutoScaling.PutScalingPolicyType);
    });
