...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AutoScaling.DetachLoadBalancersType();
  });
  ...
  describe('DetachLoadBalancersType', function() {
    it('should create an instance of DetachLoadBalancersType', function() {
      // uncomment below and update the code to test DetachLoadBalancersType
      //var instance = new AutoScaling.DetachLoadBalancersType();
      //expect(instance).to.be.a(AutoScaling.DetachLoadBalancersType);
    });
