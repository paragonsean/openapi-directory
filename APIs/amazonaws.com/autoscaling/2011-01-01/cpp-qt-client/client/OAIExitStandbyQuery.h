...
/*
 * OAIExitStandbyQuery.h
 *
 * 
 */

#ifndef OAIExitStandbyQuery_H
#define OAIExitStandbyQuery_H
...
class OAIExitStandbyQuery : public OAIObject {
public:
    OAIExitStandbyQuery();
    OAIExitStandbyQuery(QString json);
    ~OAIExitStandbyQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExitStandbyQuery)

#endif // OAIExitStandbyQuery_H
