...
/*
 * OAIAutoScalingGroup_WarmPoolConfiguration.h
 *
 * 
 */

#ifndef OAIAutoScalingGroup_WarmPoolConfiguration_H
#define OAIAutoScalingGroup_WarmPoolConfiguration_H
...
class OAIAutoScalingGroup_WarmPoolConfiguration : public OAIObject {
public:
    OAIAutoScalingGroup_WarmPoolConfiguration();
    OAIAutoScalingGroup_WarmPoolConfiguration(QString json);
    ~OAIAutoScalingGroup_WarmPoolConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingGroup_WarmPoolConfiguration)

#endif // OAIAutoScalingGroup_WarmPoolConfiguration_H
