...
/*
 * OAILaunchTemplateOverrides_InstanceRequirements.h
 *
 * 
 */

#ifndef OAILaunchTemplateOverrides_InstanceRequirements_H
#define OAILaunchTemplateOverrides_InstanceRequirements_H
...
class OAILaunchTemplateOverrides_InstanceRequirements : public OAIObject {
public:
    OAILaunchTemplateOverrides_InstanceRequirements();
    OAILaunchTemplateOverrides_InstanceRequirements(QString json);
    ~OAILaunchTemplateOverrides_InstanceRequirements() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchTemplateOverrides_InstanceRequirements)

#endif // OAILaunchTemplateOverrides_InstanceRequirements_H
