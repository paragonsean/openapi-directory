...
/*
 * OAICreateLaunchConfigurationType.h
 *
 * 
 */

#ifndef OAICreateLaunchConfigurationType_H
#define OAICreateLaunchConfigurationType_H
...
namespace OpenAPI {
class OAICreateLaunchConfigurationType_InstanceMonitoring;
class OAICreateLaunchConfigurationType_MetadataOptions;

class OAICreateLaunchConfigurationType : public OAIObject {
public:
    OAICreateLaunchConfigurationType();
    OAICreateLaunchConfigurationType(QString json);
    ~OAICreateLaunchConfigurationType() override;
    ...
    OAICreateLaunchConfigurationType_InstanceMonitoring getInstanceMonitoring() const;
    void setInstanceMonitoring(const OAICreateLaunchConfigurationType_InstanceMonitoring &instance_monitoring);
...
private:
    ...
    OAICreateLaunchConfigurationType_InstanceMonitoring m_instance_monitoring;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLaunchConfigurationType)

#endif // OAICreateLaunchConfigurationType_H
