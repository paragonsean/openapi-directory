...
/*
 * OAIPutScalingPolicyType_PredictiveScalingConfiguration.h
 *
 * 
 */

#ifndef OAIPutScalingPolicyType_PredictiveScalingConfiguration_H
#define OAIPutScalingPolicyType_PredictiveScalingConfiguration_H
...
class OAIPutScalingPolicyType_PredictiveScalingConfiguration : public OAIObject {
public:
    OAIPutScalingPolicyType_PredictiveScalingConfiguration();
    OAIPutScalingPolicyType_PredictiveScalingConfiguration(QString json);
    ~OAIPutScalingPolicyType_PredictiveScalingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScalingPolicyType_PredictiveScalingConfiguration)

#endif // OAIPutScalingPolicyType_PredictiveScalingConfiguration_H
