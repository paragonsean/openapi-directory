...
/*
 * OAIDetachLoadBalancersType.h
 *
 * 
 */

#ifndef OAIDetachLoadBalancersType_H
#define OAIDetachLoadBalancersType_H
...
class OAIDetachLoadBalancersType : public OAIObject {
public:
    OAIDetachLoadBalancersType();
    OAIDetachLoadBalancersType(QString json);
    ~OAIDetachLoadBalancersType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetachLoadBalancersType)

#endif // OAIDetachLoadBalancersType_H
