...
void OAIEbs::fromJson(QString jsonString) {
...
void OAIEbs::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIEbs::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEbs::getSnapshotId() const {
    return m_snapshot_id;
}
void OAIEbs::setSnapshotId(const QString &snapshot_id) {
    m_snapshot_id = snapshot_id;
    m_snapshot_id_isSet = true;
}

bool OAIEbs::is_snapshot_id_Set() const{
    return m_snapshot_id_isSet;
}

bool OAIEbs::is_snapshot_id_Valid() const{
    return m_snapshot_id_isValid;
}

qint32 OAIEbs::getVolumeSize() const {
    return m_volume_size;
}
void OAIEbs::setVolumeSize(const qint32 &volume_size) {
    m_volume_size = volume_size;
    m_volume_size_isSet = true;
}

bool OAIEbs::is_volume_size_Set() const{
    return m_volume_size_isSet;
}

bool OAIEbs::is_volume_size_Valid() const{
    return m_volume_size_isValid;
}

QString OAIEbs::getVolumeType() const {
    return m_volume_type;
}
void OAIEbs::setVolumeType(const QString &volume_type) {
    m_volume_type = volume_type;
    m_volume_type_isSet = true;
}

bool OAIEbs::is_volume_type_Set() const{
    return m_volume_type_isSet;
}

bool OAIEbs::is_volume_type_Valid() const{
    return m_volume_type_isValid;
}

bool OAIEbs::getDeleteOnTermination() const {
    return m_delete_on_termination;
}
void OAIEbs::setDeleteOnTermination(const bool &delete_on_termination) {
    m_delete_on_termination = delete_on_termination;
    m_delete_on_termination_isSet = true;
}

bool OAIEbs::is_delete_on_termination_Set() const{
    return m_delete_on_termination_isSet;
}

bool OAIEbs::is_delete_on_termination_Valid() const{
    return m_delete_on_termination_isValid;
}

qint32 OAIEbs::getIops() const {
    return m_iops;
}
void OAIEbs::setIops(const qint32 &iops) {
    m_iops = iops;
    m_iops_isSet = true;
}

bool OAIEbs::is_iops_Set() const{
    return m_iops_isSet;
}

bool OAIEbs::is_iops_Valid() const{
    return m_iops_isValid;
}

bool OAIEbs::getEncrypted() const {
    return m_encrypted;
}
void OAIEbs::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAIEbs::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAIEbs::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

qint32 OAIEbs::getThroughput() const {
    return m_throughput;
}
void OAIEbs::setThroughput(const qint32 &throughput) {
    m_throughput = throughput;
    m_throughput_isSet = true;
}

bool OAIEbs::is_throughput_Set() const{
    return m_throughput_isSet;
}

bool OAIEbs::is_throughput_Valid() const{
    return m_throughput_isValid;
}

bool OAIEbs::isSet() const {
