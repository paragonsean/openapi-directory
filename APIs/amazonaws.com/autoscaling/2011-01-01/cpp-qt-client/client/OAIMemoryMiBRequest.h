...
#ifndef OAIMemoryMiBRequest_H
#define OAIMemoryMiBRequest_H
...
class OAIMemoryMiBRequest : public OAIObject {
public:
    OAIMemoryMiBRequest();
    OAIMemoryMiBRequest(QString json);
    ~OAIMemoryMiBRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemoryMiBRequest)

#endif // OAIMemoryMiBRequest_H
