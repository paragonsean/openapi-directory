...
/*
 * OAIDetachLoadBalancerTargetGroupsType.h
 *
 * 
 */

#ifndef OAIDetachLoadBalancerTargetGroupsType_H
#define OAIDetachLoadBalancerTargetGroupsType_H
...
class OAIDetachLoadBalancerTargetGroupsType : public OAIObject {
public:
    OAIDetachLoadBalancerTargetGroupsType();
    OAIDetachLoadBalancerTargetGroupsType(QString json);
    ~OAIDetachLoadBalancerTargetGroupsType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetachLoadBalancerTargetGroupsType)

#endif // OAIDetachLoadBalancerTargetGroupsType_H
