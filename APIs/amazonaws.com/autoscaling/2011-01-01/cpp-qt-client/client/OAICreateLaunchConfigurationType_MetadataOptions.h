...
/*
 * OAICreateLaunchConfigurationType_MetadataOptions.h
 *
 * 
 */

#ifndef OAICreateLaunchConfigurationType_MetadataOptions_H
#define OAICreateLaunchConfigurationType_MetadataOptions_H
...
class OAICreateLaunchConfigurationType_MetadataOptions : public OAIObject {
public:
    OAICreateLaunchConfigurationType_MetadataOptions();
    OAICreateLaunchConfigurationType_MetadataOptions(QString json);
    ~OAICreateLaunchConfigurationType_MetadataOptions() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLaunchConfigurationType_MetadataOptions)

#endif // OAICreateLaunchConfigurationType_MetadataOptions_H
