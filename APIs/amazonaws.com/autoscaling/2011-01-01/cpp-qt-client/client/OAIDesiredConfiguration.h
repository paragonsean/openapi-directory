...
#ifndef OAIDesiredConfiguration_H
#define OAIDesiredConfiguration_H
...
class OAIDesiredConfiguration : public OAIObject {
public:
    OAIDesiredConfiguration();
    OAIDesiredConfiguration(QString json);
    ~OAIDesiredConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDesiredConfiguration)

#endif // OAIDesiredConfiguration_H
