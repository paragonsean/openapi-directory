...
/*
 * OAIEnableMetricsCollectionQuery.h
 *
 * 
 */

#ifndef OAIEnableMetricsCollectionQuery_H
#define OAIEnableMetricsCollectionQuery_H
...
class OAIEnableMetricsCollectionQuery : public OAIObject {
public:
    OAIEnableMetricsCollectionQuery();
    OAIEnableMetricsCollectionQuery(QString json);
    ~OAIEnableMetricsCollectionQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableMetricsCollectionQuery)

#endif // OAIEnableMetricsCollectionQuery_H
