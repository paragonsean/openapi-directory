...
#include "OAIScalingPolicy_TargetTrackingConfiguration.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIScalingPolicy_TargetTrackingConfiguration;
class OAIScalingPolicy_PredictiveScalingConfiguration;
...
public:
    ...
    OAIScalingPolicy_TargetTrackingConfiguration getTargetTrackingConfiguration() const;
    void setTargetTrackingConfiguration(const OAIScalingPolicy_TargetTrackingConfiguration &target_tracking_configuration);
    ...
    OAIScalingPolicy_PredictiveScalingConfiguration getPredictiveScalingConfiguration() const;
    void setPredictiveScalingConfiguration(const OAIScalingPolicy_PredictiveScalingConfiguration &predictive_scaling_configuration);
...
private:
    ...
    OAIScalingPolicy_TargetTrackingConfiguration m_target_tracking_configuration;
    ...
    OAIScalingPolicy_PredictiveScalingConfiguration m_predictive_scaling_configuration;
