...
/*
 * OAIAttachInstancesQuery.h
 *
 * 
 */

#ifndef OAIAttachInstancesQuery_H
#define OAIAttachInstancesQuery_H
...
class OAIAttachInstancesQuery : public OAIObject {
public:
    OAIAttachInstancesQuery();
    OAIAttachInstancesQuery(QString json);
    ~OAIAttachInstancesQuery() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachInstancesQuery)

#endif // OAIAttachInstancesQuery_H
