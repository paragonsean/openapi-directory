...
/*
 * OAIAttachLoadBalancersType.h
 *
 * 
 */

#ifndef OAIAttachLoadBalancersType_H
#define OAIAttachLoadBalancersType_H
...
class OAIAttachLoadBalancersType : public OAIObject {
public:
    OAIAttachLoadBalancersType();
    OAIAttachLoadBalancersType(QString json);
    ~OAIAttachLoadBalancersType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttachLoadBalancersType)

#endif // OAIAttachLoadBalancersType_H
