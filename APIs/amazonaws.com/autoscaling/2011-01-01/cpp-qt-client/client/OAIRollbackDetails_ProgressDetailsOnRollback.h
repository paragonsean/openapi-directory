...
/*
 * OAIRollbackDetails_ProgressDetailsOnRollback.h
 *
 * 
 */

#ifndef OAIRollbackDetails_ProgressDetailsOnRollback_H
#define OAIRollbackDetails_ProgressDetailsOnRollback_H
...
class OAIRollbackDetails_ProgressDetailsOnRollback : public OAIObject {
public:
    OAIRollbackDetails_ProgressDetailsOnRollback();
    OAIRollbackDetails_ProgressDetailsOnRollback(QString json);
    ~OAIRollbackDetails_ProgressDetailsOnRollback() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRollbackDetails_ProgressDetailsOnRollback)

#endif // OAIRollbackDetails_ProgressDetailsOnRollback_H
