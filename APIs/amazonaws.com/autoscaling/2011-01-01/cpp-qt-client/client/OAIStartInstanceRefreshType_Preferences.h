...
/*
 * OAIStartInstanceRefreshType_Preferences.h
 *
 * 
 */

#ifndef OAIStartInstanceRefreshType_Preferences_H
#define OAIStartInstanceRefreshType_Preferences_H
...
class OAIStartInstanceRefreshType_Preferences : public OAIObject {
public:
    OAIStartInstanceRefreshType_Preferences();
    OAIStartInstanceRefreshType_Preferences(QString json);
    ~OAIStartInstanceRefreshType_Preferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartInstanceRefreshType_Preferences)

#endif // OAIStartInstanceRefreshType_Preferences_H
