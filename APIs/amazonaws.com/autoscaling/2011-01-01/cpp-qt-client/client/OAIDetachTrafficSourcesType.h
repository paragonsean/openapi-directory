...
/*
 * OAIDetachTrafficSourcesType.h
 *
 * 
 */

#ifndef OAIDetachTrafficSourcesType_H
#define OAIDetachTrafficSourcesType_H
...
class OAIDetachTrafficSourcesType : public OAIObject {
public:
    OAIDetachTrafficSourcesType();
    OAIDetachTrafficSourcesType(QString json);
    ~OAIDetachTrafficSourcesType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetachTrafficSourcesType)

#endif // OAIDetachTrafficSourcesType_H
