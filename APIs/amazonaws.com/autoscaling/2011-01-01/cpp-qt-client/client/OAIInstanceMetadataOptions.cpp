...
#include "OAIInstanceMetadataOptions.h"
...
OAIInstanceMetadataOptions::OAIInstanceMetadataOptions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstanceMetadataOptions::OAIInstanceMetadataOptions() {
    this->initializeModel();
}

OAIInstanceMetadataOptions::~OAIInstanceMetadataOptions() {}

void OAIInstanceMetadataOptions::initializeModel() {
...
void OAIInstanceMetadataOptions::fromJson(QString jsonString) {
...
void OAIInstanceMetadataOptions::fromJsonObject(QJsonObject json) {
...
QString OAIInstanceMetadataOptions::asJson() const {
...
QJsonObject OAIInstanceMetadataOptions::asJsonObject() const {
    QJsonObject obj;
...
OAIInstanceMetadataHttpTokensState OAIInstanceMetadataOptions::getHttpTokens() const {
    return m_http_tokens;
}
void OAIInstanceMetadataOptions::setHttpTokens(const OAIInstanceMetadataHttpTokensState &http_tokens) {
    m_http_tokens = http_tokens;
    m_http_tokens_isSet = true;
}

bool OAIInstanceMetadataOptions::is_http_tokens_Set() const{
    return m_http_tokens_isSet;
}

bool OAIInstanceMetadataOptions::is_http_tokens_Valid() const{
    return m_http_tokens_isValid;
}

qint32 OAIInstanceMetadataOptions::getHttpPutResponseHopLimit() const {
    return m_http_put_response_hop_limit;
}
void OAIInstanceMetadataOptions::setHttpPutResponseHopLimit(const qint32 &http_put_response_hop_limit) {
    m_http_put_response_hop_limit = http_put_response_hop_limit;
    m_http_put_response_hop_limit_isSet = true;
}

bool OAIInstanceMetadataOptions::is_http_put_response_hop_limit_Set() const{
    return m_http_put_response_hop_limit_isSet;
}

bool OAIInstanceMetadataOptions::is_http_put_response_hop_limit_Valid() const{
    return m_http_put_response_hop_limit_isValid;
}

OAIInstanceMetadataEndpointState OAIInstanceMetadataOptions::getHttpEndpoint() const {
    return m_http_endpoint;
}
void OAIInstanceMetadataOptions::setHttpEndpoint(const OAIInstanceMetadataEndpointState &http_endpoint) {
    m_http_endpoint = http_endpoint;
    m_http_endpoint_isSet = true;
}

bool OAIInstanceMetadataOptions::is_http_endpoint_Set() const{
    return m_http_endpoint_isSet;
}

bool OAIInstanceMetadataOptions::is_http_endpoint_Valid() const{
    return m_http_endpoint_isValid;
}

bool OAIInstanceMetadataOptions::isSet() const {
...
bool OAIInstanceMetadataOptions::isValid() const {
