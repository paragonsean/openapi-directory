...
OAILifecycleHook::OAILifecycleHook(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILifecycleHook::OAILifecycleHook() {
    this->initializeModel();
}

OAILifecycleHook::~OAILifecycleHook() {}

void OAILifecycleHook::initializeModel() {
...
void OAILifecycleHook::fromJson(QString jsonString) {
...
void OAILifecycleHook::fromJsonObject(QJsonObject json) {
...
QString OAILifecycleHook::asJson() const {
...
QJsonObject OAILifecycleHook::asJsonObject() const {
    QJsonObject obj;
...
QString OAILifecycleHook::getLifecycleHookName() const {
    return m_lifecycle_hook_name;
}
void OAILifecycleHook::setLifecycleHookName(const QString &lifecycle_hook_name) {
    m_lifecycle_hook_name = lifecycle_hook_name;
    m_lifecycle_hook_name_isSet = true;
}

bool OAILifecycleHook::is_lifecycle_hook_name_Set() const{
    return m_lifecycle_hook_name_isSet;
}

bool OAILifecycleHook::is_lifecycle_hook_name_Valid() const{
    return m_lifecycle_hook_name_isValid;
}

QString OAILifecycleHook::getAutoScalingGroupName() const {
    return m_auto_scaling_group_name;
}
void OAILifecycleHook::setAutoScalingGroupName(const QString &auto_scaling_group_name) {
    m_auto_scaling_group_name = auto_scaling_group_name;
    m_auto_scaling_group_name_isSet = true;
}

bool OAILifecycleHook::is_auto_scaling_group_name_Set() const{
    return m_auto_scaling_group_name_isSet;
}

bool OAILifecycleHook::is_auto_scaling_group_name_Valid() const{
    return m_auto_scaling_group_name_isValid;
}

QString OAILifecycleHook::getLifecycleTransition() const {
    return m_lifecycle_transition;
}
void OAILifecycleHook::setLifecycleTransition(const QString &lifecycle_transition) {
    m_lifecycle_transition = lifecycle_transition;
    m_lifecycle_transition_isSet = true;
}

bool OAILifecycleHook::is_lifecycle_transition_Set() const{
    return m_lifecycle_transition_isSet;
}

bool OAILifecycleHook::is_lifecycle_transition_Valid() const{
    return m_lifecycle_transition_isValid;
}

QString OAILifecycleHook::getNotificationTargetArn() const {
    return m_notification_target_arn;
}
void OAILifecycleHook::setNotificationTargetArn(const QString &notification_target_arn) {
    m_notification_target_arn = notification_target_arn;
    m_notification_target_arn_isSet = true;
}

bool OAILifecycleHook::is_notification_target_arn_Set() const{
    return m_notification_target_arn_isSet;
}

bool OAILifecycleHook::is_notification_target_arn_Valid() const{
    return m_notification_target_arn_isValid;
}

QString OAILifecycleHook::getRoleArn() const {
    return m_role_arn;
}
void OAILifecycleHook::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAILifecycleHook::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAILifecycleHook::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAILifecycleHook::getNotificationMetadata() const {
    return m_notification_metadata;
}
void OAILifecycleHook::setNotificationMetadata(const QString &notification_metadata) {
    m_notification_metadata = notification_metadata;
    m_notification_metadata_isSet = true;
}

bool OAILifecycleHook::is_notification_metadata_Set() const{
    return m_notification_metadata_isSet;
}

bool OAILifecycleHook::is_notification_metadata_Valid() const{
    return m_notification_metadata_isValid;
}

qint32 OAILifecycleHook::getHeartbeatTimeout() const {
    return m_heartbeat_timeout;
}
void OAILifecycleHook::setHeartbeatTimeout(const qint32 &heartbeat_timeout) {
    m_heartbeat_timeout = heartbeat_timeout;
    m_heartbeat_timeout_isSet = true;
}

bool OAILifecycleHook::is_heartbeat_timeout_Set() const{
    return m_heartbeat_timeout_isSet;
}

bool OAILifecycleHook::is_heartbeat_timeout_Valid() const{
    return m_heartbeat_timeout_isValid;
}

qint32 OAILifecycleHook::getGlobalTimeout() const {
    return m_global_timeout;
}
void OAILifecycleHook::setGlobalTimeout(const qint32 &global_timeout) {
    m_global_timeout = global_timeout;
    m_global_timeout_isSet = true;
}

bool OAILifecycleHook::is_global_timeout_Set() const{
    return m_global_timeout_isSet;
}

bool OAILifecycleHook::is_global_timeout_Valid() const{
    return m_global_timeout_isValid;
}

QString OAILifecycleHook::getDefaultResult() const {
    return m_default_result;
}
void OAILifecycleHook::setDefaultResult(const QString &default_result) {
    m_default_result = default_result;
    m_default_result_isSet = true;
}

bool OAILifecycleHook::is_default_result_Set() const{
    return m_default_result_isSet;
}

bool OAILifecycleHook::is_default_result_Valid() const{
    return m_default_result_isValid;
}

bool OAILifecycleHook::isSet() const {
...
bool OAILifecycleHook::isValid() const {
