...
/*
 * OAIInstanceRefresh_ProgressDetails.h
 *
 * 
 */

#ifndef OAIInstanceRefresh_ProgressDetails_H
#define OAIInstanceRefresh_ProgressDetails_H
...
class OAIInstanceRefresh_ProgressDetails : public OAIObject {
public:
    OAIInstanceRefresh_ProgressDetails();
    OAIInstanceRefresh_ProgressDetails(QString json);
    ~OAIInstanceRefresh_ProgressDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceRefresh_ProgressDetails)

#endif // OAIInstanceRefresh_ProgressDetails_H
