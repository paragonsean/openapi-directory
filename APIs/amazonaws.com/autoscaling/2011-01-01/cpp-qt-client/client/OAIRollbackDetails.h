...
/*
 * OAIRollbackDetails.h
 *
 * Details about an instance refresh rollback.
 */

#ifndef OAIRollbackDetails_H
#define OAIRollbackDetails_H
...
class OAIRollbackDetails : public OAIObject {
public:
    OAIRollbackDetails();
    OAIRollbackDetails(QString json);
    ~OAIRollbackDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRollbackDetails)

#endif // OAIRollbackDetails_H
