...
/*
 * OAIDeleteNotificationConfigurationType.h
 *
 * 
 */

#ifndef OAIDeleteNotificationConfigurationType_H
#define OAIDeleteNotificationConfigurationType_H
...
class OAIDeleteNotificationConfigurationType : public OAIObject {
public:
    OAIDeleteNotificationConfigurationType();
    OAIDeleteNotificationConfigurationType(QString json);
    ~OAIDeleteNotificationConfigurationType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteNotificationConfigurationType)

#endif // OAIDeleteNotificationConfigurationType_H
