...
OAIInstanceRefresh_RollbackDetails::OAIInstanceRefresh_RollbackDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstanceRefresh_RollbackDetails::OAIInstanceRefresh_RollbackDetails() {
    this->initializeModel();
}

OAIInstanceRefresh_RollbackDetails::~OAIInstanceRefresh_RollbackDetails() {}

void OAIInstanceRefresh_RollbackDetails::initializeModel() {
...
void OAIInstanceRefresh_RollbackDetails::fromJson(QString jsonString) {
...
void OAIInstanceRefresh_RollbackDetails::fromJsonObject(QJsonObject json) {
...
QString OAIInstanceRefresh_RollbackDetails::asJson() const {
...
QJsonObject OAIInstanceRefresh_RollbackDetails::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInstanceRefresh_RollbackDetails::getRollbackReason() const {
    return m_rollback_reason;
}
void OAIInstanceRefresh_RollbackDetails::setRollbackReason(const QString &rollback_reason) {
    m_rollback_reason = rollback_reason;
    m_rollback_reason_isSet = true;
}

bool OAIInstanceRefresh_RollbackDetails::is_rollback_reason_Set() const{
    return m_rollback_reason_isSet;
}

bool OAIInstanceRefresh_RollbackDetails::is_rollback_reason_Valid() const{
    return m_rollback_reason_isValid;
}

QDateTime OAIInstanceRefresh_RollbackDetails::getRollbackStartTime() const {
    return m_rollback_start_time;
}
void OAIInstanceRefresh_RollbackDetails::setRollbackStartTime(const QDateTime &rollback_start_time) {
    m_rollback_start_time = rollback_start_time;
    m_rollback_start_time_isSet = true;
}

bool OAIInstanceRefresh_RollbackDetails::is_rollback_start_time_Set() const{
    return m_rollback_start_time_isSet;
}

bool OAIInstanceRefresh_RollbackDetails::is_rollback_start_time_Valid() const{
    return m_rollback_start_time_isValid;
}

qint32 OAIInstanceRefresh_RollbackDetails::getPercentageCompleteOnRollback() const {
    return m_percentage_complete_on_rollback;
}
void OAIInstanceRefresh_RollbackDetails::setPercentageCompleteOnRollback(const qint32 &percentage_complete_on_rollback) {
    m_percentage_complete_on_rollback = percentage_complete_on_rollback;
    m_percentage_complete_on_rollback_isSet = true;
}

bool OAIInstanceRefresh_RollbackDetails::is_percentage_complete_on_rollback_Set() const{
    return m_percentage_complete_on_rollback_isSet;
}

bool OAIInstanceRefresh_RollbackDetails::is_percentage_complete_on_rollback_Valid() const{
    return m_percentage_complete_on_rollback_isValid;
}

qint32 OAIInstanceRefresh_RollbackDetails::getInstancesToUpdateOnRollback() const {
    return m_instances_to_update_on_rollback;
}
void OAIInstanceRefresh_RollbackDetails::setInstancesToUpdateOnRollback(const qint32 &instances_to_update_on_rollback) {
    m_instances_to_update_on_rollback = instances_to_update_on_rollback;
    m_instances_to_update_on_rollback_isSet = true;
}

bool OAIInstanceRefresh_RollbackDetails::is_instances_to_update_on_rollback_Set() const{
    return m_instances_to_update_on_rollback_isSet;
}

bool OAIInstanceRefresh_RollbackDetails::is_instances_to_update_on_rollback_Valid() const{
    return m_instances_to_update_on_rollback_isValid;
}

OAIRollbackDetails_ProgressDetailsOnRollback OAIInstanceRefresh_RollbackDetails::getProgressDetailsOnRollback() const {
    return m_progress_details_on_rollback;
}
void OAIInstanceRefresh_RollbackDetails::setProgressDetailsOnRollback(const OAIRollbackDetails_ProgressDetailsOnRollback &progress_details_on_rollback) {
    m_progress_details_on_rollback = progress_details_on_rollback;
    m_progress_details_on_rollback_isSet = true;
}

bool OAIInstanceRefresh_RollbackDetails::is_progress_details_on_rollback_Set() const{
    return m_progress_details_on_rollback_isSet;
}

bool OAIInstanceRefresh_RollbackDetails::is_progress_details_on_rollback_Valid() const{
    return m_progress_details_on_rollback_isValid;
}

bool OAIInstanceRefresh_RollbackDetails::isSet() const {
...
bool OAIInstanceRefresh_RollbackDetails::isValid() const {
