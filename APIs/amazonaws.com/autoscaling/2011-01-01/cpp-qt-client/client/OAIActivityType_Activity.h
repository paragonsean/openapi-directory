...
/*
 * OAIActivityType_Activity.h
 *
 * 
 */

#ifndef OAIActivityType_Activity_H
#define OAIActivityType_Activity_H
...
class OAIActivityType_Activity : public OAIObject {
public:
    OAIActivityType_Activity();
    OAIActivityType_Activity(QString json);
    ~OAIActivityType_Activity() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityType_Activity)

#endif // OAIActivityType_Activity_H
