...
/*
 * OAIRefreshPreferences.h
 *
 * Describes the preferences for an instance refresh.
 */

#ifndef OAIRefreshPreferences_H
#define OAIRefreshPreferences_H
...
class OAIRefreshPreferences : public OAIObject {
public:
    OAIRefreshPreferences();
    OAIRefreshPreferences(QString json);
    ~OAIRefreshPreferences() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRefreshPreferences)

#endif // OAIRefreshPreferences_H
