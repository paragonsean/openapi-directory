...
/*
 * OAIPutScheduledUpdateGroupActionType.h
 *
 * 
 */

#ifndef OAIPutScheduledUpdateGroupActionType_H
#define OAIPutScheduledUpdateGroupActionType_H
...
class OAIPutScheduledUpdateGroupActionType : public OAIObject {
public:
    OAIPutScheduledUpdateGroupActionType();
    OAIPutScheduledUpdateGroupActionType(QString json);
    ~OAIPutScheduledUpdateGroupActionType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutScheduledUpdateGroupActionType)

#endif // OAIPutScheduledUpdateGroupActionType_H
