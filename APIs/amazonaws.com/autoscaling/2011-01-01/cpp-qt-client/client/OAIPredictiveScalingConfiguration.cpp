...
#include "OAIPredictiveScalingConfiguration.h"
...
OAIPredictiveScalingConfiguration::OAIPredictiveScalingConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPredictiveScalingConfiguration::OAIPredictiveScalingConfiguration() {
    this->initializeModel();
}

OAIPredictiveScalingConfiguration::~OAIPredictiveScalingConfiguration() {}

void OAIPredictiveScalingConfiguration::initializeModel() {
...
void OAIPredictiveScalingConfiguration::fromJson(QString jsonString) {
...
void OAIPredictiveScalingConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIPredictiveScalingConfiguration::asJson() const {
...
QJsonObject OAIPredictiveScalingConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QList OAIPredictiveScalingConfiguration::getMetricSpecifications() const {
    return m_metric_specifications;
}
void OAIPredictiveScalingConfiguration::setMetricSpecifications(const QList &metric_specifications) {
    m_metric_specifications = metric_specifications;
    m_metric_specifications_isSet = true;
}

bool OAIPredictiveScalingConfiguration::is_metric_specifications_Set() const{
    return m_metric_specifications_isSet;
}

bool OAIPredictiveScalingConfiguration::is_metric_specifications_Valid() const{
    return m_metric_specifications_isValid;
}

OAIPredictiveScalingMode OAIPredictiveScalingConfiguration::getMode() const {
    return m_mode;
}
void OAIPredictiveScalingConfiguration::setMode(const OAIPredictiveScalingMode &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIPredictiveScalingConfiguration::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIPredictiveScalingConfiguration::is_mode_Valid() const{
    return m_mode_isValid;
}

qint32 OAIPredictiveScalingConfiguration::getSchedulingBufferTime() const {
    return m_scheduling_buffer_time;
}
void OAIPredictiveScalingConfiguration::setSchedulingBufferTime(const qint32 &scheduling_buffer_time) {
    m_scheduling_buffer_time = scheduling_buffer_time;
    m_scheduling_buffer_time_isSet = true;
}

bool OAIPredictiveScalingConfiguration::is_scheduling_buffer_time_Set() const{
    return m_scheduling_buffer_time_isSet;
}

bool OAIPredictiveScalingConfiguration::is_scheduling_buffer_time_Valid() const{
    return m_scheduling_buffer_time_isValid;
}

OAIPredictiveScalingMaxCapacityBreachBehavior OAIPredictiveScalingConfiguration::getMaxCapacityBreachBehavior() const {
    return m_max_capacity_breach_behavior;
}
void OAIPredictiveScalingConfiguration::setMaxCapacityBreachBehavior(const OAIPredictiveScalingMaxCapacityBreachBehavior &max_capacity_breach_behavior) {
    m_max_capacity_breach_behavior = max_capacity_breach_behavior;
    m_max_capacity_breach_behavior_isSet = true;
}

bool OAIPredictiveScalingConfiguration::is_max_capacity_breach_behavior_Set() const{
    return m_max_capacity_breach_behavior_isSet;
}

bool OAIPredictiveScalingConfiguration::is_max_capacity_breach_behavior_Valid() const{
    return m_max_capacity_breach_behavior_isValid;
}

qint32 OAIPredictiveScalingConfiguration::getMaxCapacityBuffer() const {
    return m_max_capacity_buffer;
}
void OAIPredictiveScalingConfiguration::setMaxCapacityBuffer(const qint32 &max_capacity_buffer) {
    m_max_capacity_buffer = max_capacity_buffer;
    m_max_capacity_buffer_isSet = true;
}

bool OAIPredictiveScalingConfiguration::is_max_capacity_buffer_Set() const{
    return m_max_capacity_buffer_isSet;
}

bool OAIPredictiveScalingConfiguration::is_max_capacity_buffer_Valid() const{
    return m_max_capacity_buffer_isValid;
}

bool OAIPredictiveScalingConfiguration::isSet() const {
...
bool OAIPredictiveScalingConfiguration::isValid() const {
