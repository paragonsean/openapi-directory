...
OAIDeleteAutoScalingGroupType::OAIDeleteAutoScalingGroupType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteAutoScalingGroupType::OAIDeleteAutoScalingGroupType() {
    this->initializeModel();
}

OAIDeleteAutoScalingGroupType::~OAIDeleteAutoScalingGroupType() {}

void OAIDeleteAutoScalingGroupType::initializeModel() {
...
void OAIDeleteAutoScalingGroupType::fromJson(QString jsonString) {
...
void OAIDeleteAutoScalingGroupType::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteAutoScalingGroupType::asJson() const {
...
QJsonObject OAIDeleteAutoScalingGroupType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteAutoScalingGroupType::getAutoScalingGroupName() const {
    return m_auto_scaling_group_name;
}
void OAIDeleteAutoScalingGroupType::setAutoScalingGroupName(const QString &auto_scaling_group_name) {
    m_auto_scaling_group_name = auto_scaling_group_name;
    m_auto_scaling_group_name_isSet = true;
}

bool OAIDeleteAutoScalingGroupType::is_auto_scaling_group_name_Set() const{
    return m_auto_scaling_group_name_isSet;
}

bool OAIDeleteAutoScalingGroupType::is_auto_scaling_group_name_Valid() const{
    return m_auto_scaling_group_name_isValid;
}

bool OAIDeleteAutoScalingGroupType::getForceDelete() const {
    return m_force_delete;
}
void OAIDeleteAutoScalingGroupType::setForceDelete(const bool &force_delete) {
    m_force_delete = force_delete;
    m_force_delete_isSet = true;
}

bool OAIDeleteAutoScalingGroupType::is_force_delete_Set() const{
    return m_force_delete_isSet;
}

bool OAIDeleteAutoScalingGroupType::is_force_delete_Valid() const{
    return m_force_delete_isValid;
}

bool OAIDeleteAutoScalingGroupType::isSet() const {
...
bool OAIDeleteAutoScalingGroupType::isValid() const {
