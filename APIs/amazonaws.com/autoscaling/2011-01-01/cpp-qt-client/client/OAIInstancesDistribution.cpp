...
#include "OAIInstancesDistribution.h"
...
OAIInstancesDistribution::OAIInstancesDistribution(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstancesDistribution::OAIInstancesDistribution() {
    this->initializeModel();
}

OAIInstancesDistribution::~OAIInstancesDistribution() {}

void OAIInstancesDistribution::initializeModel() {
...
void OAIInstancesDistribution::fromJson(QString jsonString) {
...
void OAIInstancesDistribution::fromJsonObject(QJsonObject json) {
...
QString OAIInstancesDistribution::asJson() const {
...
QJsonObject OAIInstancesDistribution::asJsonObject() const {
    QJsonObject obj;
...
QString OAIInstancesDistribution::getOnDemandAllocationStrategy() const {
    return m_on_demand_allocation_strategy;
}
void OAIInstancesDistribution::setOnDemandAllocationStrategy(const QString &on_demand_allocation_strategy) {
    m_on_demand_allocation_strategy = on_demand_allocation_strategy;
    m_on_demand_allocation_strategy_isSet = true;
}

bool OAIInstancesDistribution::is_on_demand_allocation_strategy_Set() const{
    return m_on_demand_allocation_strategy_isSet;
}

bool OAIInstancesDistribution::is_on_demand_allocation_strategy_Valid() const{
    return m_on_demand_allocation_strategy_isValid;
}

qint32 OAIInstancesDistribution::getOnDemandBaseCapacity() const {
    return m_on_demand_base_capacity;
}
void OAIInstancesDistribution::setOnDemandBaseCapacity(const qint32 &on_demand_base_capacity) {
    m_on_demand_base_capacity = on_demand_base_capacity;
    m_on_demand_base_capacity_isSet = true;
}

bool OAIInstancesDistribution::is_on_demand_base_capacity_Set() const{
    return m_on_demand_base_capacity_isSet;
}

bool OAIInstancesDistribution::is_on_demand_base_capacity_Valid() const{
    return m_on_demand_base_capacity_isValid;
}

qint32 OAIInstancesDistribution::getOnDemandPercentageAboveBaseCapacity() const {
    return m_on_demand_percentage_above_base_capacity;
}
void OAIInstancesDistribution::setOnDemandPercentageAboveBaseCapacity(const qint32 &on_demand_percentage_above_base_capacity) {
...
bool OAIInstancesDistribution::is_on_demand_percentage_above_base_capacity_Set() const{
    return m_on_demand_percentage_above_base_capacity_isSet;
}

bool OAIInstancesDistribution::is_on_demand_percentage_above_base_capacity_Valid() const{
    return m_on_demand_percentage_above_base_capacity_isValid;
}

QString OAIInstancesDistribution::getSpotAllocationStrategy() const {
    return m_spot_allocation_strategy;
}
void OAIInstancesDistribution::setSpotAllocationStrategy(const QString &spot_allocation_strategy) {
    m_spot_allocation_strategy = spot_allocation_strategy;
    m_spot_allocation_strategy_isSet = true;
}

bool OAIInstancesDistribution::is_spot_allocation_strategy_Set() const{
    return m_spot_allocation_strategy_isSet;
}

bool OAIInstancesDistribution::is_spot_allocation_strategy_Valid() const{
    return m_spot_allocation_strategy_isValid;
}

qint32 OAIInstancesDistribution::getSpotInstancePools() const {
    return m_spot_instance_pools;
}
void OAIInstancesDistribution::setSpotInstancePools(const qint32 &spot_instance_pools) {
    m_spot_instance_pools = spot_instance_pools;
    m_spot_instance_pools_isSet = true;
}

bool OAIInstancesDistribution::is_spot_instance_pools_Set() const{
    return m_spot_instance_pools_isSet;
}

bool OAIInstancesDistribution::is_spot_instance_pools_Valid() const{
    return m_spot_instance_pools_isValid;
}

QString OAIInstancesDistribution::getSpotMaxPrice() const {
    return m_spot_max_price;
}
void OAIInstancesDistribution::setSpotMaxPrice(const QString &spot_max_price) {
    m_spot_max_price = spot_max_price;
    m_spot_max_price_isSet = true;
}

bool OAIInstancesDistribution::is_spot_max_price_Set() const{
    return m_spot_max_price_isSet;
}

bool OAIInstancesDistribution::is_spot_max_price_Valid() const{
    return m_spot_max_price_isValid;
}

bool OAIInstancesDistribution::isSet() const {
...
bool OAIInstancesDistribution::isValid() const {
