...
/*
 * OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter.h
 *
 * Represents a predictive scaling policy configuration to use with Amazon EC2 Auto Scaling.
 */

#ifndef OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter_H
#define OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter_H
...
class OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter : public OAIObject {
public:
    OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter();
    OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter(QString json);
    ~OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter)

#endif // OAIGET_PutScalingPolicy_PredictiveScalingConfiguration_parameter_H
