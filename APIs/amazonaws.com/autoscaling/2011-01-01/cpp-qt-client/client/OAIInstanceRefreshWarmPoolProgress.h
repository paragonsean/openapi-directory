...
/*
 * OAIInstanceRefreshWarmPoolProgress.h
 *
 * Reports progress on replacing instances that are in the warm pool.
 */

#ifndef OAIInstanceRefreshWarmPoolProgress_H
#define OAIInstanceRefreshWarmPoolProgress_H
...
class OAIInstanceRefreshWarmPoolProgress : public OAIObject {
public:
    OAIInstanceRefreshWarmPoolProgress();
    OAIInstanceRefreshWarmPoolProgress(QString json);
    ~OAIInstanceRefreshWarmPoolProgress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceRefreshWarmPoolProgress)

#endif // OAIInstanceRefreshWarmPoolProgress_H
