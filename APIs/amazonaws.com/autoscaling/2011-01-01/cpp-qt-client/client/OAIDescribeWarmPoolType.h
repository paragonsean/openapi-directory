...
/*
 * OAIDescribeWarmPoolType.h
 *
 * 
 */

#ifndef OAIDescribeWarmPoolType_H
#define OAIDescribeWarmPoolType_H
...
class OAIDescribeWarmPoolType : public OAIObject {
public:
    OAIDescribeWarmPoolType();
    OAIDescribeWarmPoolType(QString json);
    ~OAIDescribeWarmPoolType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeWarmPoolType)

#endif // OAIDescribeWarmPoolType_H
