...
OAIDeleteScheduledActionType::OAIDeleteScheduledActionType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteScheduledActionType::OAIDeleteScheduledActionType() {
    this->initializeModel();
}

OAIDeleteScheduledActionType::~OAIDeleteScheduledActionType() {}

void OAIDeleteScheduledActionType::initializeModel() {
...
void OAIDeleteScheduledActionType::fromJson(QString jsonString) {
...
void OAIDeleteScheduledActionType::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteScheduledActionType::asJson() const {
...
QJsonObject OAIDeleteScheduledActionType::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteScheduledActionType::getAutoScalingGroupName() const {
    return m_auto_scaling_group_name;
}
void OAIDeleteScheduledActionType::setAutoScalingGroupName(const QString &auto_scaling_group_name) {
    m_auto_scaling_group_name = auto_scaling_group_name;
    m_auto_scaling_group_name_isSet = true;
}

bool OAIDeleteScheduledActionType::is_auto_scaling_group_name_Set() const{
    return m_auto_scaling_group_name_isSet;
}

bool OAIDeleteScheduledActionType::is_auto_scaling_group_name_Valid() const{
    return m_auto_scaling_group_name_isValid;
}

QString OAIDeleteScheduledActionType::getScheduledActionName() const {
    return m_scheduled_action_name;
}
void OAIDeleteScheduledActionType::setScheduledActionName(const QString &scheduled_action_name) {
    m_scheduled_action_name = scheduled_action_name;
    m_scheduled_action_name_isSet = true;
}

bool OAIDeleteScheduledActionType::is_scheduled_action_name_Set() const{
    return m_scheduled_action_name_isSet;
}

bool OAIDeleteScheduledActionType::is_scheduled_action_name_Valid() const{
    return m_scheduled_action_name_isValid;
}

bool OAIDeleteScheduledActionType::isSet() const {
...
bool OAIDeleteScheduledActionType::isValid() const {
