...
/*
 * OAIDescribeLoadBalancerTargetGroupsRequest.h
 *
 * 
 */

#ifndef OAIDescribeLoadBalancerTargetGroupsRequest_H
#define OAIDescribeLoadBalancerTargetGroupsRequest_H
...
class OAIDescribeLoadBalancerTargetGroupsRequest : public OAIObject {
public:
    OAIDescribeLoadBalancerTargetGroupsRequest();
    OAIDescribeLoadBalancerTargetGroupsRequest(QString json);
    ~OAIDescribeLoadBalancerTargetGroupsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeLoadBalancerTargetGroupsRequest)

#endif // OAIDescribeLoadBalancerTargetGroupsRequest_H
