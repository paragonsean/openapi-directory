...
/*
 * OAIPredictiveScalingConfiguration.h
 *
 * Represents a predictive scaling policy configuration to use with Amazon EC2 Auto Scaling.
 */

#ifndef OAIPredictiveScalingConfiguration_H
#define OAIPredictiveScalingConfiguration_H
...
class OAIPredictiveScalingConfiguration : public OAIObject {
public:
    OAIPredictiveScalingConfiguration();
    OAIPredictiveScalingConfiguration(QString json);
    ~OAIPredictiveScalingConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPredictiveScalingConfiguration)

#endif // OAIPredictiveScalingConfiguration_H
