...
/*
 * OAIInstanceRefresh_DesiredConfiguration.h
 *
 * 
 */

#ifndef OAIInstanceRefresh_DesiredConfiguration_H
#define OAIInstanceRefresh_DesiredConfiguration_H
...
class OAIInstanceRefresh_DesiredConfiguration : public OAIObject {
public:
    OAIInstanceRefresh_DesiredConfiguration();
    OAIInstanceRefresh_DesiredConfiguration(QString json);
    ~OAIInstanceRefresh_DesiredConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceRefresh_DesiredConfiguration)

#endif // OAIInstanceRefresh_DesiredConfiguration_H
