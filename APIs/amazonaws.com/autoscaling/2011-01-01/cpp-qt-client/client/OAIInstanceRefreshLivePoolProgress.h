...
/*
 * OAIInstanceRefreshLivePoolProgress.h
 *
 * Reports progress on replacing instances that are in the Auto Scaling group.
 */

#ifndef OAIInstanceRefreshLivePoolProgress_H
#define OAIInstanceRefreshLivePoolProgress_H
...
class OAIInstanceRefreshLivePoolProgress : public OAIObject {
public:
    OAIInstanceRefreshLivePoolProgress();
    OAIInstanceRefreshLivePoolProgress(QString json);
    ~OAIInstanceRefreshLivePoolProgress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInstanceRefreshLivePoolProgress)

#endif // OAIInstanceRefreshLivePoolProgress_H
