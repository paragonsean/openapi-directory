...
/*
 * OAIWarmPoolConfiguration.h
 *
 * Describes a warm pool configuration. 
 */

#ifndef OAIWarmPoolConfiguration_H
#define OAIWarmPoolConfiguration_H
...
class OAIWarmPoolConfiguration : public OAIObject {
public:
    OAIWarmPoolConfiguration();
    OAIWarmPoolConfiguration(QString json);
    ~OAIWarmPoolConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWarmPoolConfiguration)

#endif // OAIWarmPoolConfiguration_H
