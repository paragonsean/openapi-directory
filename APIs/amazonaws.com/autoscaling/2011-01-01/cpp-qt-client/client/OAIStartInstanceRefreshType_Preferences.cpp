...
OAIStartInstanceRefreshType_Preferences::OAIStartInstanceRefreshType_Preferences(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartInstanceRefreshType_Preferences::OAIStartInstanceRefreshType_Preferences() {
    this->initializeModel();
}

OAIStartInstanceRefreshType_Preferences::~OAIStartInstanceRefreshType_Preferences() {}

void OAIStartInstanceRefreshType_Preferences::initializeModel() {
...
void OAIStartInstanceRefreshType_Preferences::fromJson(QString jsonString) {
...
void OAIStartInstanceRefreshType_Preferences::fromJsonObject(QJsonObject json) {
...
QString OAIStartInstanceRefreshType_Preferences::asJson() const {
...
QJsonObject OAIStartInstanceRefreshType_Preferences::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStartInstanceRefreshType_Preferences::getMinHealthyPercentage() const {
    return m_min_healthy_percentage;
}
void OAIStartInstanceRefreshType_Preferences::setMinHealthyPercentage(const qint32 &min_healthy_percentage) {
    m_min_healthy_percentage = min_healthy_percentage;
    m_min_healthy_percentage_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_min_healthy_percentage_Set() const{
    return m_min_healthy_percentage_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_min_healthy_percentage_Valid() const{
    return m_min_healthy_percentage_isValid;
}

qint32 OAIStartInstanceRefreshType_Preferences::getInstanceWarmup() const {
    return m_instance_warmup;
}
void OAIStartInstanceRefreshType_Preferences::setInstanceWarmup(const qint32 &instance_warmup) {
    m_instance_warmup = instance_warmup;
    m_instance_warmup_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_instance_warmup_Set() const{
    return m_instance_warmup_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_instance_warmup_Valid() const{
    return m_instance_warmup_isValid;
}

QList OAIStartInstanceRefreshType_Preferences::getCheckpointPercentages() const {
    return m_checkpoint_percentages;
}
void OAIStartInstanceRefreshType_Preferences::setCheckpointPercentages(const QList &checkpoint_percentages) {
    m_checkpoint_percentages = checkpoint_percentages;
    m_checkpoint_percentages_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_checkpoint_percentages_Set() const{
    return m_checkpoint_percentages_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_checkpoint_percentages_Valid() const{
    return m_checkpoint_percentages_isValid;
}

qint32 OAIStartInstanceRefreshType_Preferences::getCheckpointDelay() const {
    return m_checkpoint_delay;
}
void OAIStartInstanceRefreshType_Preferences::setCheckpointDelay(const qint32 &checkpoint_delay) {
    m_checkpoint_delay = checkpoint_delay;
    m_checkpoint_delay_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_checkpoint_delay_Set() const{
    return m_checkpoint_delay_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_checkpoint_delay_Valid() const{
    return m_checkpoint_delay_isValid;
}

bool OAIStartInstanceRefreshType_Preferences::getSkipMatching() const {
    return m_skip_matching;
}
void OAIStartInstanceRefreshType_Preferences::setSkipMatching(const bool &skip_matching) {
    m_skip_matching = skip_matching;
    m_skip_matching_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_skip_matching_Set() const{
    return m_skip_matching_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_skip_matching_Valid() const{
    return m_skip_matching_isValid;
}

bool OAIStartInstanceRefreshType_Preferences::getAutoRollback() const {
    return m_auto_rollback;
}
void OAIStartInstanceRefreshType_Preferences::setAutoRollback(const bool &auto_rollback) {
    m_auto_rollback = auto_rollback;
    m_auto_rollback_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_auto_rollback_Set() const{
    return m_auto_rollback_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_auto_rollback_Valid() const{
    return m_auto_rollback_isValid;
}

OAIScaleInProtectedInstances OAIStartInstanceRefreshType_Preferences::getScaleInProtectedInstances() const {
    return m_scale_in_protected_instances;
}
void OAIStartInstanceRefreshType_Preferences::setScaleInProtectedInstances(const OAIScaleInProtectedInstances &scale_in_protected_instances) {
    m_scale_in_protected_instances = scale_in_protected_instances;
    m_scale_in_protected_instances_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_scale_in_protected_instances_Set() const{
    return m_scale_in_protected_instances_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_scale_in_protected_instances_Valid() const{
    return m_scale_in_protected_instances_isValid;
}

OAIStandbyInstances OAIStartInstanceRefreshType_Preferences::getStandbyInstances() const {
    return m_standby_instances;
}
void OAIStartInstanceRefreshType_Preferences::setStandbyInstances(const OAIStandbyInstances &standby_instances) {
    m_standby_instances = standby_instances;
    m_standby_instances_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_standby_instances_Set() const{
    return m_standby_instances_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_standby_instances_Valid() const{
    return m_standby_instances_isValid;
}

OAIGET_StartInstanceRefresh_Preferences_parameter_AlarmSpecification OAIStartInstanceRefreshType_Preferences::getAlarmSpecification() const {
    return m_alarm_specification;
}
void OAIStartInstanceRefreshType_Preferences::setAlarmSpecification(const OAIGET_StartInstanceRefresh_Preferences_parameter_AlarmSpecification &alarm_specification) {
    m_alarm_specification = alarm_specification;
    m_alarm_specification_isSet = true;
}

bool OAIStartInstanceRefreshType_Preferences::is_alarm_specification_Set() const{
    return m_alarm_specification_isSet;
}

bool OAIStartInstanceRefreshType_Preferences::is_alarm_specification_Valid() const{
    return m_alarm_specification_isValid;
}

bool OAIStartInstanceRefreshType_Preferences::isSet() const {
...
bool OAIStartInstanceRefreshType_Preferences::isValid() const {
