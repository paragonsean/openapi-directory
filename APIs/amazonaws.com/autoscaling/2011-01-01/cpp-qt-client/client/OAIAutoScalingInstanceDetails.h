...
/*
 * OAIAutoScalingInstanceDetails.h
 *
 * Describes an EC2 instance associated with an Auto Scaling group.
 */

#ifndef OAIAutoScalingInstanceDetails_H
#define OAIAutoScalingInstanceDetails_H
...
class OAIAutoScalingInstanceDetails : public OAIObject {
public:
    OAIAutoScalingInstanceDetails();
    OAIAutoScalingInstanceDetails(QString json);
    ~OAIAutoScalingInstanceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAutoScalingInstanceDetails)

#endif // OAIAutoScalingInstanceDetails_H
