...
class GETStartInstanceRefreshDesiredConfigurationParameter(Model):
    ...
    def __init__(self, launch_template: GETStartInstanceRefreshDesiredConfigurationParameterLaunchTemplate=None, mixed_instances_policy: GETStartInstanceRefreshDesiredConfigurationParameterMixedInstancesPolicy=None):
        """GETStartInstanceRefreshDesiredConfigurationParameter - a model defined in OpenAPI

        :param launch_template: The launch_template of this GETStartInstanceRefreshDesiredConfigurationParameter.
        :param mixed_instances_policy: The mixed_instances_policy of this GETStartInstanceRefreshDesiredConfigurationParameter.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GETStartInstanceRefreshDesiredConfigurationParameter':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GET_StartInstanceRefresh_DesiredConfiguration_parameter of this GETStartInstanceRefreshDesiredConfigurationParameter.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def launch_template(self):
        """Gets the launch_template of this GETStartInstanceRefreshDesiredConfigurationParameter.


        :return: The launch_template of this GETStartInstanceRefreshDesiredConfigurationParameter.
    ...
    def launch_template(self, launch_template):
        """Sets the launch_template of this GETStartInstanceRefreshDesiredConfigurationParameter.
    ...
    def mixed_instances_policy(self):
        """Gets the mixed_instances_policy of this GETStartInstanceRefreshDesiredConfigurationParameter.


        :return: The mixed_instances_policy of this GETStartInstanceRefreshDesiredConfigurationParameter.
    ...
    def mixed_instances_policy(self, mixed_instances_policy):
        """Sets the mixed_instances_policy of this GETStartInstanceRefreshDesiredConfigurationParameter.
