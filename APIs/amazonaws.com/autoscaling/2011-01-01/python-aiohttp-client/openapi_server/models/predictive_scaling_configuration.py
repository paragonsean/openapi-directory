...
class PredictiveScalingConfiguration(Model):
    ...
    def __init__(self, metric_specifications: List=None, mode: PredictiveScalingMode=None, scheduling_buffer_time: int=None, max_capacity_breach_behavior: PredictiveScalingMaxCapacityBreachBehavior=None, max_capacity_buffer: int=None):
        """PredictiveScalingConfiguration - a model defined in OpenAPI

        :param metric_specifications: The metric_specifications of this PredictiveScalingConfiguration.
        :param mode: The mode of this PredictiveScalingConfiguration.
        :param scheduling_buffer_time: The scheduling_buffer_time of this PredictiveScalingConfiguration.
        :param max_capacity_breach_behavior: The max_capacity_breach_behavior of this PredictiveScalingConfiguration.
        :param max_capacity_buffer: The max_capacity_buffer of this PredictiveScalingConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PredictiveScalingConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PredictiveScalingConfiguration of this PredictiveScalingConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def metric_specifications(self):
        """Gets the metric_specifications of this PredictiveScalingConfiguration.


        :return: The metric_specifications of this PredictiveScalingConfiguration.
        :rtype: List
        """
    ...
    def metric_specifications(self, metric_specifications):
        """Sets the metric_specifications of this PredictiveScalingConfiguration.
    ...
    @property
    def mode(self):
        """Gets the mode of this PredictiveScalingConfiguration.


        :return: The mode of this PredictiveScalingConfiguration.
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this PredictiveScalingConfiguration.
    ...
    def scheduling_buffer_time(self):
        """Gets the scheduling_buffer_time of this PredictiveScalingConfiguration.


        :return: The scheduling_buffer_time of this PredictiveScalingConfiguration.
        :rtype: int
        """
    ...
    def scheduling_buffer_time(self, scheduling_buffer_time):
        """Sets the scheduling_buffer_time of this PredictiveScalingConfiguration.
    ...
    def max_capacity_breach_behavior(self):
        """Gets the max_capacity_breach_behavior of this PredictiveScalingConfiguration.


        :return: The max_capacity_breach_behavior of this PredictiveScalingConfiguration.
    ...
    def max_capacity_breach_behavior(self, max_capacity_breach_behavior):
        """Sets the max_capacity_breach_behavior of this PredictiveScalingConfiguration.
    ...
    def max_capacity_buffer(self):
        """Gets the max_capacity_buffer of this PredictiveScalingConfiguration.


        :return: The max_capacity_buffer of this PredictiveScalingConfiguration.
        :rtype: int
        """
    ...
    def max_capacity_buffer(self, max_capacity_buffer):
        """Sets the max_capacity_buffer of this PredictiveScalingConfiguration.
