...
class SpecificationsValueElicitationSetting(Model):
    ...
    def __init__(self, default_value_specification: SlotDefaultValueSpecification=None, prompt_specification: PromptSpecification=None, sample_utterances: List=None, wait_and_continue_specification: WaitAndContinueSpecification=None):
        """SpecificationsValueElicitationSetting - a model defined in OpenAPI

        :param default_value_specification: The default_value_specification of this SpecificationsValueElicitationSetting.
        :param prompt_specification: The prompt_specification of this SpecificationsValueElicitationSetting.
        :param sample_utterances: The sample_utterances of this SpecificationsValueElicitationSetting.
        :param wait_and_continue_specification: The wait_and_continue_specification of this SpecificationsValueElicitationSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SpecificationsValueElicitationSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Specifications_valueElicitationSetting of this SpecificationsValueElicitationSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def default_value_specification(self):
        """Gets the default_value_specification of this SpecificationsValueElicitationSetting.


        :return: The default_value_specification of this SpecificationsValueElicitationSetting.
    ...
    def default_value_specification(self, default_value_specification):
        """Sets the default_value_specification of this SpecificationsValueElicitationSetting.
    ...
    def prompt_specification(self):
        """Gets the prompt_specification of this SpecificationsValueElicitationSetting.


        :return: The prompt_specification of this SpecificationsValueElicitationSetting.
    ...
    def prompt_specification(self, prompt_specification):
        """Sets the prompt_specification of this SpecificationsValueElicitationSetting.
    ...
    def sample_utterances(self):
        """Gets the sample_utterances of this SpecificationsValueElicitationSetting.


        :return: The sample_utterances of this SpecificationsValueElicitationSetting.
        :rtype: List
        """
    ...
    def sample_utterances(self, sample_utterances):
        """Sets the sample_utterances of this SpecificationsValueElicitationSetting.
    ...
    def wait_and_continue_specification(self):
        """Gets the wait_and_continue_specification of this SpecificationsValueElicitationSetting.


        :return: The wait_and_continue_specification of this SpecificationsValueElicitationSetting.
    ...
    def wait_and_continue_specification(self, wait_and_continue_specification):
        """Sets the wait_and_continue_specification of this SpecificationsValueElicitationSetting.
