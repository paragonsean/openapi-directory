...
class AudioSpecification(Model):
    ...
    def __init__(self, max_length_ms: int=None, end_timeout_ms: int=None):
        """AudioSpecification - a model defined in OpenAPI

        :param max_length_ms: The max_length_ms of this AudioSpecification.
        :param end_timeout_ms: The end_timeout_ms of this AudioSpecification.
        """
        self.openapi_types = {
            'max_length_ms': int,
            'end_timeout_ms': int
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AudioSpecification':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The AudioSpecification of this AudioSpecification.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_length_ms(self):
        """Gets the max_length_ms of this AudioSpecification.


        :return: The max_length_ms of this AudioSpecification.
        :rtype: int
        """
    ...
    def max_length_ms(self, max_length_ms):
        """Sets the max_length_ms of this AudioSpecification.
    ...
    def end_timeout_ms(self):
        """Gets the end_timeout_ms of this AudioSpecification.


        :return: The end_timeout_ms of this AudioSpecification.
        :rtype: int
        """
    ...
    def end_timeout_ms(self, end_timeout_ms):
        """Sets the end_timeout_ms of this AudioSpecification.
