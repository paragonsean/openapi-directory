...
class DialogCodeHookInvocationSetting(Model):
    ...
    def __init__(self, enable_code_hook_invocation: bool=None, active: bool=None, invocation_label: str=None, post_code_hook_specification: DialogCodeHookInvocationSettingPostCodeHookSpecification=None):
        """DialogCodeHookInvocationSetting - a model defined in OpenAPI

        :param enable_code_hook_invocation: The enable_code_hook_invocation of this DialogCodeHookInvocationSetting.
        :param active: The active of this DialogCodeHookInvocationSetting.
        :param invocation_label: The invocation_label of this DialogCodeHookInvocationSetting.
        :param post_code_hook_specification: The post_code_hook_specification of this DialogCodeHookInvocationSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DialogCodeHookInvocationSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DialogCodeHookInvocationSetting of this DialogCodeHookInvocationSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def enable_code_hook_invocation(self):
        """Gets the enable_code_hook_invocation of this DialogCodeHookInvocationSetting.


        :return: The enable_code_hook_invocation of this DialogCodeHookInvocationSetting.
        :rtype: bool
        """
    ...
    def enable_code_hook_invocation(self, enable_code_hook_invocation):
        """Sets the enable_code_hook_invocation of this DialogCodeHookInvocationSetting.
    ...
    @property
    def active(self):
        """Gets the active of this DialogCodeHookInvocationSetting.


        :return: The active of this DialogCodeHookInvocationSetting.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this DialogCodeHookInvocationSetting.
    ...
    def invocation_label(self):
        """Gets the invocation_label of this DialogCodeHookInvocationSetting.


        :return: The invocation_label of this DialogCodeHookInvocationSetting.
        :rtype: str
        """
    ...
    def invocation_label(self, invocation_label):
        """Sets the invocation_label of this DialogCodeHookInvocationSetting.
    ...
    def post_code_hook_specification(self):
        """Gets the post_code_hook_specification of this DialogCodeHookInvocationSetting.


        :return: The post_code_hook_specification of this DialogCodeHookInvocationSetting.
    ...
    def post_code_hook_specification(self, post_code_hook_specification):
        """Sets the post_code_hook_specification of this DialogCodeHookInvocationSetting.
