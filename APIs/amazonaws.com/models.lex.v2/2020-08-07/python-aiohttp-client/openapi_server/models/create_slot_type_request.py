...
class CreateSlotTypeRequest(Model):
    ...
    def __init__(self, slot_type_name: str=None, description: str=None, slot_type_values: List[SlotTypeValue]=None, value_selection_setting: CreateSlotTypeRequestValueSelectionSetting=None, parent_slot_type_signature: str=None, external_source_setting: CreateSlotTypeRequestExternalSourceSetting=None, composite_slot_type_setting: CreateSlotTypeRequestCompositeSlotTypeSetting=None):
        """CreateSlotTypeRequest - a model defined in OpenAPI

        :param slot_type_name: The slot_type_name of this CreateSlotTypeRequest.
        :param description: The description of this CreateSlotTypeRequest.
        :param slot_type_values: The slot_type_values of this CreateSlotTypeRequest.
        :param value_selection_setting: The value_selection_setting of this CreateSlotTypeRequest.
        :param parent_slot_type_signature: The parent_slot_type_signature of this CreateSlotTypeRequest.
        :param external_source_setting: The external_source_setting of this CreateSlotTypeRequest.
        :param composite_slot_type_setting: The composite_slot_type_setting of this CreateSlotTypeRequest.
        """
        self.openapi_types = {
            'slot_type_name': str,
            'description': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateSlotTypeRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateSlotType_request of this CreateSlotTypeRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def slot_type_name(self):
        """Gets the slot_type_name of this CreateSlotTypeRequest.

        The name for the slot. A slot type name must be unique within the intent.

        :return: The slot_type_name of this CreateSlotTypeRequest.
        :rtype: str
        """
    ...
    def slot_type_name(self, slot_type_name):
        """Sets the slot_type_name of this CreateSlotTypeRequest.
    ...
    def description(self):
        """Gets the description of this CreateSlotTypeRequest.

        A description of the slot type. Use the description to help identify the slot type in lists.

        :return: The description of this CreateSlotTypeRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateSlotTypeRequest.
    ...
    def slot_type_values(self):
        """Gets the slot_type_values of this CreateSlotTypeRequest.
        ...
        :return: The slot_type_values of this CreateSlotTypeRequest.
    ...
    def slot_type_values(self, slot_type_values):
        """Sets the slot_type_values of this CreateSlotTypeRequest.
    ...
    def value_selection_setting(self):
        """Gets the value_selection_setting of this CreateSlotTypeRequest.


        :return: The value_selection_setting of this CreateSlotTypeRequest.
    ...
    def value_selection_setting(self, value_selection_setting):
        """Sets the value_selection_setting of this CreateSlotTypeRequest.
    ...
    def parent_slot_type_signature(self):
        """Gets the parent_slot_type_signature of this CreateSlotTypeRequest.
        ...
        :return: The parent_slot_type_signature of this CreateSlotTypeRequest.
        :rtype: str
        """
    ...
    def parent_slot_type_signature(self, parent_slot_type_signature):
        """Sets the parent_slot_type_signature of this CreateSlotTypeRequest.
    ...
    def external_source_setting(self):
        """Gets the external_source_setting of this CreateSlotTypeRequest.


        :return: The external_source_setting of this CreateSlotTypeRequest.
    ...
    def external_source_setting(self, external_source_setting):
        """Sets the external_source_setting of this CreateSlotTypeRequest.
    ...
    def composite_slot_type_setting(self):
        """Gets the composite_slot_type_setting of this CreateSlotTypeRequest.


        :return: The composite_slot_type_setting of this CreateSlotTypeRequest.
    ...
    def composite_slot_type_setting(self, composite_slot_type_setting):
        """Sets the composite_slot_type_setting of this CreateSlotTypeRequest.
