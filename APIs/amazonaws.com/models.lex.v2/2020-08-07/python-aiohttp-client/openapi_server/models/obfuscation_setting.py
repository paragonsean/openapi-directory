...
class ObfuscationSetting(Model):
    ...
    def __init__(self, obfuscation_setting_type: ObfuscationSettingType=None):
        ...
        :param obfuscation_setting_type: The obfuscation_setting_type of this ObfuscationSetting.
        """
        self.openapi_types = {
    ...
    def obfuscation_setting_type(self):
        """Gets the obfuscation_setting_type of this ObfuscationSetting.


        :return: The obfuscation_setting_type of this ObfuscationSetting.
    ...
    def obfuscation_setting_type(self, obfuscation_setting_type):
        """Sets the obfuscation_setting_type of this ObfuscationSetting.
