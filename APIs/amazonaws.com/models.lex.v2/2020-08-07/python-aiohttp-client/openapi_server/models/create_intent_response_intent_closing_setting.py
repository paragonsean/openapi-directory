...
class CreateIntentResponseIntentClosingSetting(Model):
    ...
    def __init__(self, closing_response: CreateIntentRequestIntentClosingSettingClosingResponse=None, active: bool=None, next_step: CreateIntentRequestIntentClosingSettingNextStep=None, conditional: CreateIntentRequestIntentClosingSettingConditional=None):
        """CreateIntentResponseIntentClosingSetting - a model defined in OpenAPI

        :param closing_response: The closing_response of this CreateIntentResponseIntentClosingSetting.
        :param active: The active of this CreateIntentResponseIntentClosingSetting.
        :param next_step: The next_step of this CreateIntentResponseIntentClosingSetting.
        :param conditional: The conditional of this CreateIntentResponseIntentClosingSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateIntentResponseIntentClosingSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateIntentResponse_intentClosingSetting of this CreateIntentResponseIntentClosingSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def closing_response(self):
        """Gets the closing_response of this CreateIntentResponseIntentClosingSetting.


        :return: The closing_response of this CreateIntentResponseIntentClosingSetting.
    ...
    def closing_response(self, closing_response):
        """Sets the closing_response of this CreateIntentResponseIntentClosingSetting.
    ...
    @property
    def active(self):
        """Gets the active of this CreateIntentResponseIntentClosingSetting.


        :return: The active of this CreateIntentResponseIntentClosingSetting.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        """Sets the active of this CreateIntentResponseIntentClosingSetting.
    ...
    @property
    def next_step(self):
        """Gets the next_step of this CreateIntentResponseIntentClosingSetting.


        :return: The next_step of this CreateIntentResponseIntentClosingSetting.
    ...
    def next_step(self, next_step):
        """Sets the next_step of this CreateIntentResponseIntentClosingSetting.
    ...
    def conditional(self):
        """Gets the conditional of this CreateIntentResponseIntentClosingSetting.


        :return: The conditional of this CreateIntentResponseIntentClosingSetting.
    ...
    def conditional(self, conditional):
        """Sets the conditional of this CreateIntentResponseIntentClosingSetting.
