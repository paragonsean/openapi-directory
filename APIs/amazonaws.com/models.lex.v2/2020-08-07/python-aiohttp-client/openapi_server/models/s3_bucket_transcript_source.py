...
class S3BucketTranscriptSource(Model):
    ...
    def __init__(self, s3_bucket_name: str=None, path_format: S3BucketTranscriptSourcePathFormat=None, transcript_format: TranscriptFormat=None, transcript_filter: S3BucketTranscriptSourceTranscriptFilter=None, kms_key_arn: str=None):
        """S3BucketTranscriptSource - a model defined in OpenAPI

        :param s3_bucket_name: The s3_bucket_name of this S3BucketTranscriptSource.
        :param path_format: The path_format of this S3BucketTranscriptSource.
        :param transcript_format: The transcript_format of this S3BucketTranscriptSource.
        :param transcript_filter: The transcript_filter of this S3BucketTranscriptSource.
        :param kms_key_arn: The kms_key_arn of this S3BucketTranscriptSource.
        """
        self.openapi_types = {
            's3_bucket_name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'S3BucketTranscriptSource':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The S3BucketTranscriptSource of this S3BucketTranscriptSource.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def s3_bucket_name(self):
        """Gets the s3_bucket_name of this S3BucketTranscriptSource.


        :return: The s3_bucket_name of this S3BucketTranscriptSource.
        :rtype: str
        """
    ...
    def s3_bucket_name(self, s3_bucket_name):
        """Sets the s3_bucket_name of this S3BucketTranscriptSource.
    ...
    def path_format(self):
        """Gets the path_format of this S3BucketTranscriptSource.


        :return: The path_format of this S3BucketTranscriptSource.
    ...
    def path_format(self, path_format):
        """Sets the path_format of this S3BucketTranscriptSource.
    ...
    def transcript_format(self):
        """Gets the transcript_format of this S3BucketTranscriptSource.


        :return: The transcript_format of this S3BucketTranscriptSource.
    ...
    def transcript_format(self, transcript_format):
        """Sets the transcript_format of this S3BucketTranscriptSource.
    ...
    def transcript_filter(self):
        """Gets the transcript_filter of this S3BucketTranscriptSource.


        :return: The transcript_filter of this S3BucketTranscriptSource.
    ...
    def transcript_filter(self, transcript_filter):
        """Sets the transcript_filter of this S3BucketTranscriptSource.
    ...
    def kms_key_arn(self):
        """Gets the kms_key_arn of this S3BucketTranscriptSource.


        :return: The kms_key_arn of this S3BucketTranscriptSource.
        :rtype: str
        """
    ...
    def kms_key_arn(self, kms_key_arn):
        """Sets the kms_key_arn of this S3BucketTranscriptSource.
