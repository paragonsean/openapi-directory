...
class SlotValueElicitationSetting(Model):
    ...
    def __init__(self, default_value_specification: CreateSlotRequestValueElicitationSettingDefaultValueSpecification=None, slot_constraint: SlotConstraint=None, prompt_specification: CreateSlotRequestValueElicitationSettingPromptSpecification=None, sample_utterances: List=None, wait_and_continue_specification: WaitAndContinueSpecification=None, slot_capture_setting: CreateSlotRequestValueElicitationSettingSlotCaptureSetting=None):
        """SlotValueElicitationSetting - a model defined in OpenAPI

        :param default_value_specification: The default_value_specification of this SlotValueElicitationSetting.
        :param slot_constraint: The slot_constraint of this SlotValueElicitationSetting.
        :param prompt_specification: The prompt_specification of this SlotValueElicitationSetting.
        :param sample_utterances: The sample_utterances of this SlotValueElicitationSetting.
        :param wait_and_continue_specification: The wait_and_continue_specification of this SlotValueElicitationSetting.
        :param slot_capture_setting: The slot_capture_setting of this SlotValueElicitationSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SlotValueElicitationSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SlotValueElicitationSetting of this SlotValueElicitationSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def default_value_specification(self):
        """Gets the default_value_specification of this SlotValueElicitationSetting.


        :return: The default_value_specification of this SlotValueElicitationSetting.
    ...
    def default_value_specification(self, default_value_specification):
        """Sets the default_value_specification of this SlotValueElicitationSetting.
    ...
    def slot_constraint(self):
        """Gets the slot_constraint of this SlotValueElicitationSetting.


        :return: The slot_constraint of this SlotValueElicitationSetting.
    ...
    def slot_constraint(self, slot_constraint):
        """Sets the slot_constraint of this SlotValueElicitationSetting.
    ...
    def prompt_specification(self):
        """Gets the prompt_specification of this SlotValueElicitationSetting.


        :return: The prompt_specification of this SlotValueElicitationSetting.
    ...
    def prompt_specification(self, prompt_specification):
        """Sets the prompt_specification of this SlotValueElicitationSetting.
    ...
    def sample_utterances(self):
        """Gets the sample_utterances of this SlotValueElicitationSetting.


        :return: The sample_utterances of this SlotValueElicitationSetting.
        :rtype: List
        """
    ...
    def sample_utterances(self, sample_utterances):
        """Sets the sample_utterances of this SlotValueElicitationSetting.
    ...
    def wait_and_continue_specification(self):
        """Gets the wait_and_continue_specification of this SlotValueElicitationSetting.


        :return: The wait_and_continue_specification of this SlotValueElicitationSetting.
    ...
    def wait_and_continue_specification(self, wait_and_continue_specification):
        """Sets the wait_and_continue_specification of this SlotValueElicitationSetting.
    ...
    def slot_capture_setting(self):
        """Gets the slot_capture_setting of this SlotValueElicitationSetting.


        :return: The slot_capture_setting of this SlotValueElicitationSetting.
    ...
    def slot_capture_setting(self, slot_capture_setting):
        """Sets the slot_capture_setting of this SlotValueElicitationSetting.
