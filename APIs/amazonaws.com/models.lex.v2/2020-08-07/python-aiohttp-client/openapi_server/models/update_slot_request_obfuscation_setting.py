...
class UpdateSlotRequestObfuscationSetting(Model):
    ...
    def __init__(self, obfuscation_setting_type: ObfuscationSettingType=None):
        """UpdateSlotRequestObfuscationSetting - a model defined in OpenAPI

        :param obfuscation_setting_type: The obfuscation_setting_type of this UpdateSlotRequestObfuscationSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSlotRequestObfuscationSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSlotRequest_obfuscationSetting of this UpdateSlotRequestObfuscationSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def obfuscation_setting_type(self):
        """Gets the obfuscation_setting_type of this UpdateSlotRequestObfuscationSetting.


        :return: The obfuscation_setting_type of this UpdateSlotRequestObfuscationSetting.
    ...
    def obfuscation_setting_type(self, obfuscation_setting_type):
        """Sets the obfuscation_setting_type of this UpdateSlotRequestObfuscationSetting.
