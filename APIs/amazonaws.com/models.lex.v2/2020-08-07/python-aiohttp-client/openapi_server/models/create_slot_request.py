...
class CreateSlotRequest(Model):
    ...
    def __init__(self, slot_name: str=None, description: str=None, slot_type_id: str=None, value_elicitation_setting: CreateSlotRequestValueElicitationSetting=None, obfuscation_setting: CreateSlotRequestObfuscationSetting=None, multiple_values_setting: CreateSlotRequestMultipleValuesSetting=None, sub_slot_setting: CreateSlotRequestSubSlotSetting=None):
        """CreateSlotRequest - a model defined in OpenAPI

        :param slot_name: The slot_name of this CreateSlotRequest.
        :param description: The description of this CreateSlotRequest.
        :param slot_type_id: The slot_type_id of this CreateSlotRequest.
        :param value_elicitation_setting: The value_elicitation_setting of this CreateSlotRequest.
        :param obfuscation_setting: The obfuscation_setting of this CreateSlotRequest.
        :param multiple_values_setting: The multiple_values_setting of this CreateSlotRequest.
        :param sub_slot_setting: The sub_slot_setting of this CreateSlotRequest.
        """
        self.openapi_types = {
            'slot_name': str,
            'description': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateSlotRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateSlot_request of this CreateSlotRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def slot_name(self):
        """Gets the slot_name of this CreateSlotRequest.

        The name of the slot. Slot names must be unique within the bot that contains the slot.

        :return: The slot_name of this CreateSlotRequest.
        :rtype: str
        """
    ...
    def slot_name(self, slot_name):
        """Sets the slot_name of this CreateSlotRequest.
    ...
    def description(self):
        """Gets the description of this CreateSlotRequest.

        A description of the slot. Use this to help identify the slot in lists.

        :return: The description of this CreateSlotRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateSlotRequest.
    ...
    def slot_type_id(self):
        """Gets the slot_type_id of this CreateSlotRequest.

        The unique identifier for the slot type associated with this slot. The slot type determines the values that can be entered into the slot.

        :return: The slot_type_id of this CreateSlotRequest.
        :rtype: str
        """
    ...
    def slot_type_id(self, slot_type_id):
        """Sets the slot_type_id of this CreateSlotRequest.
    ...
    def value_elicitation_setting(self):
        """Gets the value_elicitation_setting of this CreateSlotRequest.


        :return: The value_elicitation_setting of this CreateSlotRequest.
    ...
    def value_elicitation_setting(self, value_elicitation_setting):
        """Sets the value_elicitation_setting of this CreateSlotRequest.
    ...
    def obfuscation_setting(self):
        """Gets the obfuscation_setting of this CreateSlotRequest.


        :return: The obfuscation_setting of this CreateSlotRequest.
    ...
    def obfuscation_setting(self, obfuscation_setting):
        """Sets the obfuscation_setting of this CreateSlotRequest.
    ...
    def multiple_values_setting(self):
        """Gets the multiple_values_setting of this CreateSlotRequest.


        :return: The multiple_values_setting of this CreateSlotRequest.
    ...
    def multiple_values_setting(self, multiple_values_setting):
        """Sets the multiple_values_setting of this CreateSlotRequest.
    ...
    def sub_slot_setting(self):
        """Gets the sub_slot_setting of this CreateSlotRequest.


        :return: The sub_slot_setting of this CreateSlotRequest.
    ...
    def sub_slot_setting(self, sub_slot_setting):
        """Sets the sub_slot_setting of this CreateSlotRequest.
