...
class CreateSlotTypeResponseValueSelectionSetting(Model):
    ...
    def __init__(self, resolution_strategy: SlotValueResolutionStrategy=None, regex_filter: CreateSlotTypeRequestValueSelectionSettingRegexFilter=None, advanced_recognition_setting: CreateSlotTypeRequestValueSelectionSettingAdvancedRecognitionSetting=None):
        """CreateSlotTypeResponseValueSelectionSetting - a model defined in OpenAPI

        :param resolution_strategy: The resolution_strategy of this CreateSlotTypeResponseValueSelectionSetting.
        :param regex_filter: The regex_filter of this CreateSlotTypeResponseValueSelectionSetting.
        :param advanced_recognition_setting: The advanced_recognition_setting of this CreateSlotTypeResponseValueSelectionSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateSlotTypeResponseValueSelectionSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateSlotTypeResponse_valueSelectionSetting of this CreateSlotTypeResponseValueSelectionSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def resolution_strategy(self):
        """Gets the resolution_strategy of this CreateSlotTypeResponseValueSelectionSetting.


        :return: The resolution_strategy of this CreateSlotTypeResponseValueSelectionSetting.
    ...
    def resolution_strategy(self, resolution_strategy):
        """Sets the resolution_strategy of this CreateSlotTypeResponseValueSelectionSetting.
    ...
    def regex_filter(self):
        """Gets the regex_filter of this CreateSlotTypeResponseValueSelectionSetting.


        :return: The regex_filter of this CreateSlotTypeResponseValueSelectionSetting.
    ...
    def regex_filter(self, regex_filter):
        """Sets the regex_filter of this CreateSlotTypeResponseValueSelectionSetting.
    ...
    def advanced_recognition_setting(self):
        """Gets the advanced_recognition_setting of this CreateSlotTypeResponseValueSelectionSetting.


        :return: The advanced_recognition_setting of this CreateSlotTypeResponseValueSelectionSetting.
    ...
    def advanced_recognition_setting(self, advanced_recognition_setting):
        """Sets the advanced_recognition_setting of this CreateSlotTypeResponseValueSelectionSetting.
