...
class DTMFSpecification(Model):
    ...
    def __init__(self, max_length: int=None, end_timeout_ms: int=None, deletion_character: str=None, end_character: str=None):
        """DTMFSpecification - a model defined in OpenAPI

        :param max_length: The max_length of this DTMFSpecification.
        :param end_timeout_ms: The end_timeout_ms of this DTMFSpecification.
        :param deletion_character: The deletion_character of this DTMFSpecification.
        :param end_character: The end_character of this DTMFSpecification.
        """
        self.openapi_types = {
            'max_length': int,
            'end_timeout_ms': int,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DTMFSpecification':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DTMFSpecification of this DTMFSpecification.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_length(self):
        """Gets the max_length of this DTMFSpecification.


        :return: The max_length of this DTMFSpecification.
        :rtype: int
        """
    ...
    def max_length(self, max_length):
        """Sets the max_length of this DTMFSpecification.
    ...
    def end_timeout_ms(self):
        """Gets the end_timeout_ms of this DTMFSpecification.


        :return: The end_timeout_ms of this DTMFSpecification.
        :rtype: int
        """
    ...
    def end_timeout_ms(self, end_timeout_ms):
        """Sets the end_timeout_ms of this DTMFSpecification.
    ...
    def deletion_character(self):
        """Gets the deletion_character of this DTMFSpecification.


        :return: The deletion_character of this DTMFSpecification.
        :rtype: str
        """
    ...
    def deletion_character(self, deletion_character):
        """Sets the deletion_character of this DTMFSpecification.
    ...
    def end_character(self):
        """Gets the end_character of this DTMFSpecification.


        :return: The end_character of this DTMFSpecification.
        :rtype: str
        """
    ...
    def end_character(self, end_character):
        """Sets the end_character of this DTMFSpecification.
