...
class UpdateSlotTypeResponseValueSelectionSetting(Model):
    ...
    def __init__(self, resolution_strategy: SlotValueResolutionStrategy=None, regex_filter: CreateSlotTypeRequestValueSelectionSettingRegexFilter=None, advanced_recognition_setting: CreateSlotTypeRequestValueSelectionSettingAdvancedRecognitionSetting=None):
        """UpdateSlotTypeResponseValueSelectionSetting - a model defined in OpenAPI

        :param resolution_strategy: The resolution_strategy of this UpdateSlotTypeResponseValueSelectionSetting.
        :param regex_filter: The regex_filter of this UpdateSlotTypeResponseValueSelectionSetting.
        :param advanced_recognition_setting: The advanced_recognition_setting of this UpdateSlotTypeResponseValueSelectionSetting.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateSlotTypeResponseValueSelectionSetting':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateSlotTypeResponse_valueSelectionSetting of this UpdateSlotTypeResponseValueSelectionSetting.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def resolution_strategy(self):
        """Gets the resolution_strategy of this UpdateSlotTypeResponseValueSelectionSetting.


        :return: The resolution_strategy of this UpdateSlotTypeResponseValueSelectionSetting.
    ...
    def resolution_strategy(self, resolution_strategy):
        """Sets the resolution_strategy of this UpdateSlotTypeResponseValueSelectionSetting.
    ...
    def regex_filter(self):
        """Gets the regex_filter of this UpdateSlotTypeResponseValueSelectionSetting.


        :return: The regex_filter of this UpdateSlotTypeResponseValueSelectionSetting.
    ...
    def regex_filter(self, regex_filter):
        """Sets the regex_filter of this UpdateSlotTypeResponseValueSelectionSetting.
    ...
    def advanced_recognition_setting(self):
        """Gets the advanced_recognition_setting of this UpdateSlotTypeResponseValueSelectionSetting.


        :return: The advanced_recognition_setting of this UpdateSlotTypeResponseValueSelectionSetting.
    ...
    def advanced_recognition_setting(self, advanced_recognition_setting):
        """Sets the advanced_recognition_setting of this UpdateSlotTypeResponseValueSelectionSetting.
