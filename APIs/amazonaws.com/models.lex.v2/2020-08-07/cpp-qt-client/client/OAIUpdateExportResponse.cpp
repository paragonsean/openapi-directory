...
OAIUpdateExportResponse::OAIUpdateExportResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateExportResponse::OAIUpdateExportResponse() {
    this->initializeModel();
}

OAIUpdateExportResponse::~OAIUpdateExportResponse() {}

void OAIUpdateExportResponse::initializeModel() {
...
void OAIUpdateExportResponse::fromJson(QString jsonString) {
...
void OAIUpdateExportResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateExportResponse::asJson() const {
...
QJsonObject OAIUpdateExportResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateExportResponse::getExportId() const {
    return m_export_id;
}
void OAIUpdateExportResponse::setExportId(const QString &export_id) {
    m_export_id = export_id;
    m_export_id_isSet = true;
}

bool OAIUpdateExportResponse::is_export_id_Set() const{
    return m_export_id_isSet;
}

bool OAIUpdateExportResponse::is_export_id_Valid() const{
    return m_export_id_isValid;
}

OAICreateExportResponse_resourceSpecification OAIUpdateExportResponse::getResourceSpecification() const {
    return m_resource_specification;
}
void OAIUpdateExportResponse::setResourceSpecification(const OAICreateExportResponse_resourceSpecification &resource_specification) {
    m_resource_specification = resource_specification;
    m_resource_specification_isSet = true;
}

bool OAIUpdateExportResponse::is_resource_specification_Set() const{
    return m_resource_specification_isSet;
}

bool OAIUpdateExportResponse::is_resource_specification_Valid() const{
    return m_resource_specification_isValid;
}

OAIImportExportFileFormat OAIUpdateExportResponse::getFileFormat() const {
    return m_file_format;
}
void OAIUpdateExportResponse::setFileFormat(const OAIImportExportFileFormat &file_format) {
    m_file_format = file_format;
    m_file_format_isSet = true;
}

bool OAIUpdateExportResponse::is_file_format_Set() const{
    return m_file_format_isSet;
}

bool OAIUpdateExportResponse::is_file_format_Valid() const{
    return m_file_format_isValid;
}

OAIExportStatus OAIUpdateExportResponse::getExportStatus() const {
    return m_export_status;
}
void OAIUpdateExportResponse::setExportStatus(const OAIExportStatus &export_status) {
    m_export_status = export_status;
    m_export_status_isSet = true;
}

bool OAIUpdateExportResponse::is_export_status_Set() const{
    return m_export_status_isSet;
}

bool OAIUpdateExportResponse::is_export_status_Valid() const{
    return m_export_status_isValid;
}

QDateTime OAIUpdateExportResponse::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAIUpdateExportResponse::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAIUpdateExportResponse::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAIUpdateExportResponse::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

QDateTime OAIUpdateExportResponse::getLastUpdatedDateTime() const {
    return m_last_updated_date_time;
}
void OAIUpdateExportResponse::setLastUpdatedDateTime(const QDateTime &last_updated_date_time) {
    m_last_updated_date_time = last_updated_date_time;
    m_last_updated_date_time_isSet = true;
}

bool OAIUpdateExportResponse::is_last_updated_date_time_Set() const{
    return m_last_updated_date_time_isSet;
}

bool OAIUpdateExportResponse::is_last_updated_date_time_Valid() const{
    return m_last_updated_date_time_isValid;
}

bool OAIUpdateExportResponse::isSet() const {
...
bool OAIUpdateExportResponse::isValid() const {
