...
OAICreateIntentResponse::OAICreateIntentResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIntentResponse::OAICreateIntentResponse() {
    this->initializeModel();
}

OAICreateIntentResponse::~OAICreateIntentResponse() {}

void OAICreateIntentResponse::initializeModel() {
...
void OAICreateIntentResponse::fromJson(QString jsonString) {
...
void OAICreateIntentResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateIntentResponse::asJson() const {
...
QJsonObject OAICreateIntentResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateIntentResponse::getIntentId() const {
    return m_intent_id;
}
void OAICreateIntentResponse::setIntentId(const QString &intent_id) {
    m_intent_id = intent_id;
    m_intent_id_isSet = true;
}

bool OAICreateIntentResponse::is_intent_id_Set() const{
    return m_intent_id_isSet;
}

bool OAICreateIntentResponse::is_intent_id_Valid() const{
    return m_intent_id_isValid;
}

QString OAICreateIntentResponse::getIntentName() const {
    return m_intent_name;
}
void OAICreateIntentResponse::setIntentName(const QString &intent_name) {
    m_intent_name = intent_name;
    m_intent_name_isSet = true;
}

bool OAICreateIntentResponse::is_intent_name_Set() const{
    return m_intent_name_isSet;
}

bool OAICreateIntentResponse::is_intent_name_Valid() const{
    return m_intent_name_isValid;
}

QString OAICreateIntentResponse::getDescription() const {
    return m_description;
}
void OAICreateIntentResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateIntentResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateIntentResponse::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateIntentResponse::getParentIntentSignature() const {
    return m_parent_intent_signature;
}
void OAICreateIntentResponse::setParentIntentSignature(const QString &parent_intent_signature) {
    m_parent_intent_signature = parent_intent_signature;
    m_parent_intent_signature_isSet = true;
}

bool OAICreateIntentResponse::is_parent_intent_signature_Set() const{
    return m_parent_intent_signature_isSet;
}

bool OAICreateIntentResponse::is_parent_intent_signature_Valid() const{
    return m_parent_intent_signature_isValid;
}

QList OAICreateIntentResponse::getSampleUtterances() const {
    return m_sample_utterances;
}
void OAICreateIntentResponse::setSampleUtterances(const QList &sample_utterances) {
    m_sample_utterances = sample_utterances;
    m_sample_utterances_isSet = true;
}

bool OAICreateIntentResponse::is_sample_utterances_Set() const{
    return m_sample_utterances_isSet;
}

bool OAICreateIntentResponse::is_sample_utterances_Valid() const{
    return m_sample_utterances_isValid;
}

OAICreateIntentResponse_dialogCodeHook OAICreateIntentResponse::getDialogCodeHook() const {
    return m_dialog_code_hook;
}
void OAICreateIntentResponse::setDialogCodeHook(const OAICreateIntentResponse_dialogCodeHook &dialog_code_hook) {
    m_dialog_code_hook = dialog_code_hook;
    m_dialog_code_hook_isSet = true;
}

bool OAICreateIntentResponse::is_dialog_code_hook_Set() const{
    return m_dialog_code_hook_isSet;
}

bool OAICreateIntentResponse::is_dialog_code_hook_Valid() const{
    return m_dialog_code_hook_isValid;
}

OAICreateIntentResponse_fulfillmentCodeHook OAICreateIntentResponse::getFulfillmentCodeHook() const {
    return m_fulfillment_code_hook;
}
void OAICreateIntentResponse::setFulfillmentCodeHook(const OAICreateIntentResponse_fulfillmentCodeHook &fulfillment_code_hook) {
    m_fulfillment_code_hook = fulfillment_code_hook;
    m_fulfillment_code_hook_isSet = true;
}

bool OAICreateIntentResponse::is_fulfillment_code_hook_Set() const{
    return m_fulfillment_code_hook_isSet;
}

bool OAICreateIntentResponse::is_fulfillment_code_hook_Valid() const{
    return m_fulfillment_code_hook_isValid;
}

OAICreateIntentResponse_intentConfirmationSetting OAICreateIntentResponse::getIntentConfirmationSetting() const {
    return m_intent_confirmation_setting;
}
void OAICreateIntentResponse::setIntentConfirmationSetting(const OAICreateIntentResponse_intentConfirmationSetting &intent_confirmation_setting) {
    m_intent_confirmation_setting = intent_confirmation_setting;
    m_intent_confirmation_setting_isSet = true;
}

bool OAICreateIntentResponse::is_intent_confirmation_setting_Set() const{
    return m_intent_confirmation_setting_isSet;
}

bool OAICreateIntentResponse::is_intent_confirmation_setting_Valid() const{
    return m_intent_confirmation_setting_isValid;
}

OAICreateIntentResponse_intentClosingSetting OAICreateIntentResponse::getIntentClosingSetting() const {
    return m_intent_closing_setting;
}
void OAICreateIntentResponse::setIntentClosingSetting(const OAICreateIntentResponse_intentClosingSetting &intent_closing_setting) {
    m_intent_closing_setting = intent_closing_setting;
    m_intent_closing_setting_isSet = true;
}

bool OAICreateIntentResponse::is_intent_closing_setting_Set() const{
    return m_intent_closing_setting_isSet;
}

bool OAICreateIntentResponse::is_intent_closing_setting_Valid() const{
    return m_intent_closing_setting_isValid;
}

QList OAICreateIntentResponse::getInputContexts() const {
    return m_input_contexts;
}
void OAICreateIntentResponse::setInputContexts(const QList &input_contexts) {
    m_input_contexts = input_contexts;
    m_input_contexts_isSet = true;
}

bool OAICreateIntentResponse::is_input_contexts_Set() const{
    return m_input_contexts_isSet;
}

bool OAICreateIntentResponse::is_input_contexts_Valid() const{
    return m_input_contexts_isValid;
}

QList OAICreateIntentResponse::getOutputContexts() const {
    return m_output_contexts;
}
void OAICreateIntentResponse::setOutputContexts(const QList &output_contexts) {
    m_output_contexts = output_contexts;
    m_output_contexts_isSet = true;
}

bool OAICreateIntentResponse::is_output_contexts_Set() const{
    return m_output_contexts_isSet;
}

bool OAICreateIntentResponse::is_output_contexts_Valid() const{
    return m_output_contexts_isValid;
}

OAICreateIntentResponse_kendraConfiguration OAICreateIntentResponse::getKendraConfiguration() const {
    return m_kendra_configuration;
}
void OAICreateIntentResponse::setKendraConfiguration(const OAICreateIntentResponse_kendraConfiguration &kendra_configuration) {
    m_kendra_configuration = kendra_configuration;
    m_kendra_configuration_isSet = true;
}

bool OAICreateIntentResponse::is_kendra_configuration_Set() const{
    return m_kendra_configuration_isSet;
}

bool OAICreateIntentResponse::is_kendra_configuration_Valid() const{
    return m_kendra_configuration_isValid;
}

QString OAICreateIntentResponse::getBotId() const {
    return m_bot_id;
}
void OAICreateIntentResponse::setBotId(const QString &bot_id) {
    m_bot_id = bot_id;
    m_bot_id_isSet = true;
}

bool OAICreateIntentResponse::is_bot_id_Set() const{
    return m_bot_id_isSet;
}

bool OAICreateIntentResponse::is_bot_id_Valid() const{
    return m_bot_id_isValid;
}

QString OAICreateIntentResponse::getBotVersion() const {
    return m_bot_version;
}
void OAICreateIntentResponse::setBotVersion(const QString &bot_version) {
    m_bot_version = bot_version;
    m_bot_version_isSet = true;
}

bool OAICreateIntentResponse::is_bot_version_Set() const{
    return m_bot_version_isSet;
}

bool OAICreateIntentResponse::is_bot_version_Valid() const{
    return m_bot_version_isValid;
}

QString OAICreateIntentResponse::getLocaleId() const {
    return m_locale_id;
}
void OAICreateIntentResponse::setLocaleId(const QString &locale_id) {
    m_locale_id = locale_id;
    m_locale_id_isSet = true;
}

bool OAICreateIntentResponse::is_locale_id_Set() const{
    return m_locale_id_isSet;
}

bool OAICreateIntentResponse::is_locale_id_Valid() const{
    return m_locale_id_isValid;
}

QDateTime OAICreateIntentResponse::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAICreateIntentResponse::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAICreateIntentResponse::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAICreateIntentResponse::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

OAICreateIntentResponse_initialResponseSetting OAICreateIntentResponse::getInitialResponseSetting() const {
    return m_initial_response_setting;
}
void OAICreateIntentResponse::setInitialResponseSetting(const OAICreateIntentResponse_initialResponseSetting &initial_response_setting) {
    m_initial_response_setting = initial_response_setting;
    m_initial_response_setting_isSet = true;
}

bool OAICreateIntentResponse::is_initial_response_setting_Set() const{
    return m_initial_response_setting_isSet;
}

bool OAICreateIntentResponse::is_initial_response_setting_Valid() const{
    return m_initial_response_setting_isValid;
}

bool OAICreateIntentResponse::isSet() const {
...
bool OAICreateIntentResponse::isValid() const {
