...
/*
 * OAIBotLocaleExportSpecification.h
 *
 * Provides the bot locale parameters required for exporting a bot locale.
 */

#ifndef OAIBotLocaleExportSpecification_H
#define OAIBotLocaleExportSpecification_H
...
class OAIBotLocaleExportSpecification : public OAIObject {
public:
    OAIBotLocaleExportSpecification();
    OAIBotLocaleExportSpecification(QString json);
    ~OAIBotLocaleExportSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBotLocaleExportSpecification)

#endif // OAIBotLocaleExportSpecification_H
