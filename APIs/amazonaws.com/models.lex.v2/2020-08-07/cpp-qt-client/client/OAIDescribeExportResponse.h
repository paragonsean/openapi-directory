...
/*
 * OAIDescribeExportResponse.h
 *
 * 
 */

#ifndef OAIDescribeExportResponse_H
#define OAIDescribeExportResponse_H
...
namespace OpenAPI {
class OAIDescribeExportResponse_resourceSpecification;

class OAIDescribeExportResponse : public OAIObject {
public:
    OAIDescribeExportResponse();
    OAIDescribeExportResponse(QString json);
    ~OAIDescribeExportResponse() override;
    ...
    OAIDescribeExportResponse_resourceSpecification getResourceSpecification() const;
    void setResourceSpecification(const OAIDescribeExportResponse_resourceSpecification &resource_specification);
...
private:
    ...
    OAIDescribeExportResponse_resourceSpecification m_resource_specification;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeExportResponse)

#endif // OAIDescribeExportResponse_H
