...
OAIUpdateSlotType_request::OAIUpdateSlotType_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSlotType_request::OAIUpdateSlotType_request() {
    this->initializeModel();
}

OAIUpdateSlotType_request::~OAIUpdateSlotType_request() {}

void OAIUpdateSlotType_request::initializeModel() {
...
void OAIUpdateSlotType_request::fromJson(QString jsonString) {
...
void OAIUpdateSlotType_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSlotType_request::asJson() const {
...
QJsonObject OAIUpdateSlotType_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSlotType_request::getSlotTypeName() const {
    return m_slot_type_name;
}
void OAIUpdateSlotType_request::setSlotTypeName(const QString &slot_type_name) {
    m_slot_type_name = slot_type_name;
    m_slot_type_name_isSet = true;
}

bool OAIUpdateSlotType_request::is_slot_type_name_Set() const{
    return m_slot_type_name_isSet;
}

bool OAIUpdateSlotType_request::is_slot_type_name_Valid() const{
    return m_slot_type_name_isValid;
}

QString OAIUpdateSlotType_request::getDescription() const {
    return m_description;
}
void OAIUpdateSlotType_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateSlotType_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateSlotType_request::is_description_Valid() const{
    return m_description_isValid;
}

QList<OAISlotTypeValue> OAIUpdateSlotType_request::getSlotTypeValues() const {
    return m_slot_type_values;
}
void OAIUpdateSlotType_request::setSlotTypeValues(const QList<OAISlotTypeValue> &slot_type_values) {
    m_slot_type_values = slot_type_values;
    m_slot_type_values_isSet = true;
}

bool OAIUpdateSlotType_request::is_slot_type_values_Set() const{
    return m_slot_type_values_isSet;
}

bool OAIUpdateSlotType_request::is_slot_type_values_Valid() const{
    return m_slot_type_values_isValid;
}

OAICreateSlotType_request_valueSelectionSetting OAIUpdateSlotType_request::getValueSelectionSetting() const {
    return m_value_selection_setting;
}
void OAIUpdateSlotType_request::setValueSelectionSetting(const OAICreateSlotType_request_valueSelectionSetting &value_selection_setting) {
    m_value_selection_setting = value_selection_setting;
    m_value_selection_setting_isSet = true;
}

bool OAIUpdateSlotType_request::is_value_selection_setting_Set() const{
    return m_value_selection_setting_isSet;
}

bool OAIUpdateSlotType_request::is_value_selection_setting_Valid() const{
    return m_value_selection_setting_isValid;
}

QString OAIUpdateSlotType_request::getParentSlotTypeSignature() const {
    return m_parent_slot_type_signature;
}
void OAIUpdateSlotType_request::setParentSlotTypeSignature(const QString &parent_slot_type_signature) {
    m_parent_slot_type_signature = parent_slot_type_signature;
    m_parent_slot_type_signature_isSet = true;
}

bool OAIUpdateSlotType_request::is_parent_slot_type_signature_Set() const{
    return m_parent_slot_type_signature_isSet;
}

bool OAIUpdateSlotType_request::is_parent_slot_type_signature_Valid() const{
    return m_parent_slot_type_signature_isValid;
}

OAICreateSlotType_request_externalSourceSetting OAIUpdateSlotType_request::getExternalSourceSetting() const {
    return m_external_source_setting;
}
void OAIUpdateSlotType_request::setExternalSourceSetting(const OAICreateSlotType_request_externalSourceSetting &external_source_setting) {
    m_external_source_setting = external_source_setting;
    m_external_source_setting_isSet = true;
}

bool OAIUpdateSlotType_request::is_external_source_setting_Set() const{
    return m_external_source_setting_isSet;
}

bool OAIUpdateSlotType_request::is_external_source_setting_Valid() const{
    return m_external_source_setting_isValid;
}

OAICreateSlotType_request_compositeSlotTypeSetting OAIUpdateSlotType_request::getCompositeSlotTypeSetting() const {
    return m_composite_slot_type_setting;
}
void OAIUpdateSlotType_request::setCompositeSlotTypeSetting(const OAICreateSlotType_request_compositeSlotTypeSetting &composite_slot_type_setting) {
    m_composite_slot_type_setting = composite_slot_type_setting;
    m_composite_slot_type_setting_isSet = true;
}

bool OAIUpdateSlotType_request::is_composite_slot_type_setting_Set() const{
    return m_composite_slot_type_setting_isSet;
}

bool OAIUpdateSlotType_request::is_composite_slot_type_setting_Valid() const{
    return m_composite_slot_type_setting_isValid;
}

bool OAIUpdateSlotType_request::isSet() const {
...
bool OAIUpdateSlotType_request::isValid() const {
