...
OAISubSlotSetting::OAISubSlotSetting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISubSlotSetting::OAISubSlotSetting() {
    this->initializeModel();
}

OAISubSlotSetting::~OAISubSlotSetting() {}

void OAISubSlotSetting::initializeModel() {
...
void OAISubSlotSetting::fromJson(QString jsonString) {
...
void OAISubSlotSetting::fromJsonObject(QJsonObject json) {
...
QString OAISubSlotSetting::asJson() const {
...
QJsonObject OAISubSlotSetting::asJsonObject() const {
    QJsonObject obj;
...
QString OAISubSlotSetting::getExpression() const {
    return m_expression;
}
void OAISubSlotSetting::setExpression(const QString &expression) {
    m_expression = expression;
    m_expression_isSet = true;
}

bool OAISubSlotSetting::is_expression_Set() const{
    return m_expression_isSet;
}

bool OAISubSlotSetting::is_expression_Valid() const{
    return m_expression_isValid;
}

QMap OAISubSlotSetting::getSlotSpecifications() const {
    return m_slot_specifications;
}
void OAISubSlotSetting::setSlotSpecifications(const QMap &slot_specifications) {
    m_slot_specifications = slot_specifications;
    m_slot_specifications_isSet = true;
}

bool OAISubSlotSetting::is_slot_specifications_Set() const{
    return m_slot_specifications_isSet;
}

bool OAISubSlotSetting::is_slot_specifications_Valid() const{
    return m_slot_specifications_isValid;
}

bool OAISubSlotSetting::isSet() const {
...
bool OAISubSlotSetting::isValid() const {
