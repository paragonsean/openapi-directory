...
/*
 * OAICreateIntent_request_intentConfirmationSetting_promptSpecification.h
 *
 * 
 */

#ifndef OAICreateIntent_request_intentConfirmationSetting_promptSpecification_H
#define OAICreateIntent_request_intentConfirmationSetting_promptSpecification_H
...
class OAICreateIntent_request_intentConfirmationSetting_promptSpecification : public OAIObject {
public:
    OAICreateIntent_request_intentConfirmationSetting_promptSpecification();
    OAICreateIntent_request_intentConfirmationSetting_promptSpecification(QString json);
    ~OAICreateIntent_request_intentConfirmationSetting_promptSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntent_request_intentConfirmationSetting_promptSpecification)

#endif // OAICreateIntent_request_intentConfirmationSetting_promptSpecification_H
