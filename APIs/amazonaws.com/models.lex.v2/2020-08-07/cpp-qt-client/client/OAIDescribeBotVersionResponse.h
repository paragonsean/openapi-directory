...
/*
 * OAIDescribeBotVersionResponse.h
 *
 * 
 */

#ifndef OAIDescribeBotVersionResponse_H
#define OAIDescribeBotVersionResponse_H
...
namespace OpenAPI {
class OAIDescribeBotVersionResponse_dataPrivacy;

class OAIDescribeBotVersionResponse : public OAIObject {
public:
    OAIDescribeBotVersionResponse();
    OAIDescribeBotVersionResponse(QString json);
    ~OAIDescribeBotVersionResponse() override;
    ...
    OAIDescribeBotVersionResponse_dataPrivacy getDataPrivacy() const;
    void setDataPrivacy(const OAIDescribeBotVersionResponse_dataPrivacy &data_privacy);
...
private:
    ...
    OAIDescribeBotVersionResponse_dataPrivacy m_data_privacy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBotVersionResponse)

#endif // OAIDescribeBotVersionResponse_H
