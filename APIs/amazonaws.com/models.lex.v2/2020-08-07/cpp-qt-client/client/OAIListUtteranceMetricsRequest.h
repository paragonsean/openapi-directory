...
/*
 * OAIListUtteranceMetricsRequest.h
 *
 * 
 */

#ifndef OAIListUtteranceMetricsRequest_H
#define OAIListUtteranceMetricsRequest_H
...
class OAIListUtteranceMetricsRequest : public OAIObject {
public:
    OAIListUtteranceMetricsRequest();
    OAIListUtteranceMetricsRequest(QString json);
    ~OAIListUtteranceMetricsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListUtteranceMetricsRequest)

#endif // OAIListUtteranceMetricsRequest_H
