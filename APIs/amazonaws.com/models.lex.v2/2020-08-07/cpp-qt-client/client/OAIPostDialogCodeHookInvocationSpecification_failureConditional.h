...
/*
 * OAIPostDialogCodeHookInvocationSpecification_failureConditional.h
 *
 * 
 */

#ifndef OAIPostDialogCodeHookInvocationSpecification_failureConditional_H
#define OAIPostDialogCodeHookInvocationSpecification_failureConditional_H
...
class OAIPostDialogCodeHookInvocationSpecification_failureConditional : public OAIObject {
public:
    OAIPostDialogCodeHookInvocationSpecification_failureConditional();
    OAIPostDialogCodeHookInvocationSpecification_failureConditional(QString json);
    ~OAIPostDialogCodeHookInvocationSpecification_failureConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostDialogCodeHookInvocationSpecification_failureConditional)

#endif // OAIPostDialogCodeHookInvocationSpecification_failureConditional_H
