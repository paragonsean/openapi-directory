...
OAIIntentFilterName OAIIntentFilter::getName() const {
    return m_name;
}
void OAIIntentFilter::setName(const OAIIntentFilterName &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIIntentFilter::is_name_Set() const{
    return m_name_isSet;
}

bool OAIIntentFilter::is_name_Valid() const{
    return m_name_isValid;
}

QList OAIIntentFilter::getValues() const {
    return m_values;
}
void OAIIntentFilter::setValues(const QList &values) {
    m_values = values;
    m_values_isSet = true;
}

bool OAIIntentFilter::is_values_Set() const{
    return m_values_isSet;
}

bool OAIIntentFilter::is_values_Valid() const{
    return m_values_isValid;
}

OAIIntentFilterOperator OAIIntentFilter::getROperator() const {
    return m_r_operator;
}
void OAIIntentFilter::setROperator(const OAIIntentFilterOperator &r_operator) {
    m_r_operator = r_operator;
    m_r_operator_isSet = true;
}

bool OAIIntentFilter::is_r_operator_Set() const{
    return m_r_operator_isSet;
}

bool OAIIntentFilter::is_r_operator_Valid() const{
