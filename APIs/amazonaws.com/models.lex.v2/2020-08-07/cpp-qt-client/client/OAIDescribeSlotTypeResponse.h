...
/*
 * OAIDescribeSlotTypeResponse.h
 *
 * 
 */

#ifndef OAIDescribeSlotTypeResponse_H
#define OAIDescribeSlotTypeResponse_H
...
namespace OpenAPI {
class OAIDescribeSlotTypeResponse_valueSelectionSetting;
class OAIExternalSourceSetting;
class OAICreateSlotTypeResponse_compositeSlotTypeSetting;

class OAIDescribeSlotTypeResponse : public OAIObject {
public:
    OAIDescribeSlotTypeResponse();
    OAIDescribeSlotTypeResponse(QString json);
    ~OAIDescribeSlotTypeResponse() override;
    ...
    OAIDescribeSlotTypeResponse_valueSelectionSetting getValueSelectionSetting() const;
    void setValueSelectionSetting(const OAIDescribeSlotTypeResponse_valueSelectionSetting &value_selection_setting);
...
private:
    ...
    OAIDescribeSlotTypeResponse_valueSelectionSetting m_value_selection_setting;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSlotTypeResponse)

#endif // OAIDescribeSlotTypeResponse_H
