...
#include "OAICreateBotAliasRequest.h"
...
OAICreateBotAliasRequest::OAICreateBotAliasRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBotAliasRequest::OAICreateBotAliasRequest() {
    this->initializeModel();
}

OAICreateBotAliasRequest::~OAICreateBotAliasRequest() {}

void OAICreateBotAliasRequest::initializeModel() {
...
void OAICreateBotAliasRequest::fromJson(QString jsonString) {
...
void OAICreateBotAliasRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateBotAliasRequest::asJson() const {
...
QJsonObject OAICreateBotAliasRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBotAliasRequest::getBotAliasName() const {
    return m_bot_alias_name;
}
void OAICreateBotAliasRequest::setBotAliasName(const QString &bot_alias_name) {
    m_bot_alias_name = bot_alias_name;
    m_bot_alias_name_isSet = true;
}

bool OAICreateBotAliasRequest::is_bot_alias_name_Set() const{
    return m_bot_alias_name_isSet;
}

bool OAICreateBotAliasRequest::is_bot_alias_name_Valid() const{
    return m_bot_alias_name_isValid;
}

QString OAICreateBotAliasRequest::getDescription() const {
    return m_description;
}
void OAICreateBotAliasRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateBotAliasRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateBotAliasRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateBotAliasRequest::getBotVersion() const {
    return m_bot_version;
}
void OAICreateBotAliasRequest::setBotVersion(const QString &bot_version) {
    m_bot_version = bot_version;
    m_bot_version_isSet = true;
}

bool OAICreateBotAliasRequest::is_bot_version_Set() const{
    return m_bot_version_isSet;
}

bool OAICreateBotAliasRequest::is_bot_version_Valid() const{
    return m_bot_version_isValid;
}

QMap OAICreateBotAliasRequest::getBotAliasLocaleSettings() const {
    return m_bot_alias_locale_settings;
}
void OAICreateBotAliasRequest::setBotAliasLocaleSettings(const QMap &bot_alias_locale_settings) {
    m_bot_alias_locale_settings = bot_alias_locale_settings;
    m_bot_alias_locale_settings_isSet = true;
}

bool OAICreateBotAliasRequest::is_bot_alias_locale_settings_Set() const{
    return m_bot_alias_locale_settings_isSet;
}

bool OAICreateBotAliasRequest::is_bot_alias_locale_settings_Valid() const{
    return m_bot_alias_locale_settings_isValid;
}

OAICreateBotAliasRequest_conversationLogSettings OAICreateBotAliasRequest::getConversationLogSettings() const {
    return m_conversation_log_settings;
}
void OAICreateBotAliasRequest::setConversationLogSettings(const OAICreateBotAliasRequest_conversationLogSettings &conversation_log_settings) {
    m_conversation_log_settings = conversation_log_settings;
    m_conversation_log_settings_isSet = true;
}

bool OAICreateBotAliasRequest::is_conversation_log_settings_Set() const{
    return m_conversation_log_settings_isSet;
}

bool OAICreateBotAliasRequest::is_conversation_log_settings_Valid() const{
    return m_conversation_log_settings_isValid;
}

OAISentimentAnalysisSettings OAICreateBotAliasRequest::getSentimentAnalysisSettings() const {
    return m_sentiment_analysis_settings;
}
void OAICreateBotAliasRequest::setSentimentAnalysisSettings(const OAISentimentAnalysisSettings &sentiment_analysis_settings) {
    m_sentiment_analysis_settings = sentiment_analysis_settings;
    m_sentiment_analysis_settings_isSet = true;
}

bool OAICreateBotAliasRequest::is_sentiment_analysis_settings_Set() const{
    return m_sentiment_analysis_settings_isSet;
}

bool OAICreateBotAliasRequest::is_sentiment_analysis_settings_Valid() const{
    return m_sentiment_analysis_settings_isValid;
}

QMap OAICreateBotAliasRequest::getTags() const {
    return m_tags;
}
void OAICreateBotAliasRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAICreateBotAliasRequest::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAICreateBotAliasRequest::is_tags_Valid() const{
    return m_tags_isValid;
}

bool OAICreateBotAliasRequest::isSet() const {
...
bool OAICreateBotAliasRequest::isValid() const {
