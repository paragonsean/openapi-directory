...
/*
 * OAIBotAliasTestExecutionTarget.h
 *
 * The target Amazon S3 location for the test set execution using a bot alias.
 */

#ifndef OAIBotAliasTestExecutionTarget_H
#define OAIBotAliasTestExecutionTarget_H
...
class OAIBotAliasTestExecutionTarget : public OAIObject {
public:
    OAIBotAliasTestExecutionTarget();
    OAIBotAliasTestExecutionTarget(QString json);
    ~OAIBotAliasTestExecutionTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBotAliasTestExecutionTarget)

#endif // OAIBotAliasTestExecutionTarget_H
