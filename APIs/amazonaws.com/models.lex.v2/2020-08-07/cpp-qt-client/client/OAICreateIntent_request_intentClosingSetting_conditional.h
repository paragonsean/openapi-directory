...
/*
 * OAICreateIntent_request_intentClosingSetting_conditional.h
 *
 * 
 */

#ifndef OAICreateIntent_request_intentClosingSetting_conditional_H
#define OAICreateIntent_request_intentClosingSetting_conditional_H
...
class OAICreateIntent_request_intentClosingSetting_conditional : public OAIObject {
public:
    OAICreateIntent_request_intentClosingSetting_conditional();
    OAICreateIntent_request_intentClosingSetting_conditional(QString json);
    ~OAICreateIntent_request_intentClosingSetting_conditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntent_request_intentClosingSetting_conditional)

#endif // OAICreateIntent_request_intentClosingSetting_conditional_H
