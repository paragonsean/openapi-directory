...
/*
 * OAINewCustomVocabularyItem.h
 *
 * The new custom vocabulary item from the custom vocabulary list.
 */

#ifndef OAINewCustomVocabularyItem_H
#define OAINewCustomVocabularyItem_H
...
class OAINewCustomVocabularyItem : public OAIObject {
public:
    OAINewCustomVocabularyItem();
    OAINewCustomVocabularyItem(QString json);
    ~OAINewCustomVocabularyItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINewCustomVocabularyItem)

#endif // OAINewCustomVocabularyItem_H
