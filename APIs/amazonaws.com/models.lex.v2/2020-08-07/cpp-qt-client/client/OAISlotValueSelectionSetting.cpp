...
#include "OAISlotValueSelectionSetting.h"
...
OAISlotValueSelectionSetting::OAISlotValueSelectionSetting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISlotValueSelectionSetting::OAISlotValueSelectionSetting() {
    this->initializeModel();
}

OAISlotValueSelectionSetting::~OAISlotValueSelectionSetting() {}

void OAISlotValueSelectionSetting::initializeModel() {
...
void OAISlotValueSelectionSetting::fromJson(QString jsonString) {
...
void OAISlotValueSelectionSetting::fromJsonObject(QJsonObject json) {
...
QString OAISlotValueSelectionSetting::asJson() const {
...
QJsonObject OAISlotValueSelectionSetting::asJsonObject() const {
    QJsonObject obj;
...
OAISlotValueResolutionStrategy OAISlotValueSelectionSetting::getResolutionStrategy() const {
    return m_resolution_strategy;
}
void OAISlotValueSelectionSetting::setResolutionStrategy(const OAISlotValueResolutionStrategy &resolution_strategy) {
    m_resolution_strategy = resolution_strategy;
    m_resolution_strategy_isSet = true;
}

bool OAISlotValueSelectionSetting::is_resolution_strategy_Set() const{
    return m_resolution_strategy_isSet;
}

bool OAISlotValueSelectionSetting::is_resolution_strategy_Valid() const{
    return m_resolution_strategy_isValid;
}

OAICreateSlotType_request_valueSelectionSetting_regexFilter OAISlotValueSelectionSetting::getRegexFilter() const {
    return m_regex_filter;
}
void OAISlotValueSelectionSetting::setRegexFilter(const OAICreateSlotType_request_valueSelectionSetting_regexFilter &regex_filter) {
    m_regex_filter = regex_filter;
    m_regex_filter_isSet = true;
}

bool OAISlotValueSelectionSetting::is_regex_filter_Set() const{
    return m_regex_filter_isSet;
}

bool OAISlotValueSelectionSetting::is_regex_filter_Valid() const{
    return m_regex_filter_isValid;
}

OAICreateSlotType_request_valueSelectionSetting_advancedRecognitionSetting OAISlotValueSelectionSetting::getAdvancedRecognitionSetting() const {
    return m_advanced_recognition_setting;
}
void OAISlotValueSelectionSetting::setAdvancedRecognitionSetting(const OAICreateSlotType_request_valueSelectionSetting_advancedRecognitionSetting &advanced_recognition_setting) {
    m_advanced_recognition_setting = advanced_recognition_setting;
    m_advanced_recognition_setting_isSet = true;
}

bool OAISlotValueSelectionSetting::is_advanced_recognition_setting_Set() const{
    return m_advanced_recognition_setting_isSet;
}

bool OAISlotValueSelectionSetting::is_advanced_recognition_setting_Valid() const{
    return m_advanced_recognition_setting_isValid;
}

bool OAISlotValueSelectionSetting::isSet() const {
...
bool OAISlotValueSelectionSetting::isValid() const {
