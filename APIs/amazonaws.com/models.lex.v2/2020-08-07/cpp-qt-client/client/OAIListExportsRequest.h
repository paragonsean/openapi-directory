...
namespace OpenAPI {
class OAIListExportsRequest_sortBy;
...
public:
    ...
    OAIListExportsRequest_sortBy getSortBy() const;
    void setSortBy(const OAIListExportsRequest_sortBy &sort_by);
...
private:
    ...
    OAIListExportsRequest_sortBy m_sort_by;
