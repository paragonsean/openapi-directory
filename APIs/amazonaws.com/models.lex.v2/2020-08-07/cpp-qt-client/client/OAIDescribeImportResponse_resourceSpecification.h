...
/*
 * OAIDescribeImportResponse_resourceSpecification.h
 *
 * 
 */

#ifndef OAIDescribeImportResponse_resourceSpecification_H
#define OAIDescribeImportResponse_resourceSpecification_H
...
class OAIDescribeImportResponse_resourceSpecification : public OAIObject {
public:
    OAIDescribeImportResponse_resourceSpecification();
    OAIDescribeImportResponse_resourceSpecification(QString json);
    ~OAIDescribeImportResponse_resourceSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeImportResponse_resourceSpecification)

#endif // OAIDescribeImportResponse_resourceSpecification_H
