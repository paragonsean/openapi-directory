...
namespace OpenAPI {
class OAIExportSummary_resourceSpecification;
...
public:
    ...
    OAIExportSummary_resourceSpecification getResourceSpecification() const;
    void setResourceSpecification(const OAIExportSummary_resourceSpecification &resource_specification);
...
private:
    ...
    OAIExportSummary_resourceSpecification m_resource_specification;
