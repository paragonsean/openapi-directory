...
/*
 * OAIBotExportSpecification.h
 *
 * Provides the identity of a the bot that was exported.
 */

#ifndef OAIBotExportSpecification_H
#define OAIBotExportSpecification_H
...
class OAIBotExportSpecification : public OAIObject {
public:
    OAIBotExportSpecification();
    OAIBotExportSpecification(QString json);
    ~OAIBotExportSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBotExportSpecification)

#endif // OAIBotExportSpecification_H
