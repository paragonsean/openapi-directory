...
/*
 * OAIDescribeIntentResponse_intentClosingSetting.h
 *
 * 
 */

#ifndef OAIDescribeIntentResponse_intentClosingSetting_H
#define OAIDescribeIntentResponse_intentClosingSetting_H
...
class OAIDescribeIntentResponse_intentClosingSetting : public OAIObject {
public:
    OAIDescribeIntentResponse_intentClosingSetting();
    OAIDescribeIntentResponse_intentClosingSetting(QString json);
    ~OAIDescribeIntentResponse_intentClosingSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeIntentResponse_intentClosingSetting)

#endif // OAIDescribeIntentResponse_intentClosingSetting_H
