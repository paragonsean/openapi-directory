...
OAISlotCaptureSetting_codeHook::OAISlotCaptureSetting_codeHook(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISlotCaptureSetting_codeHook::OAISlotCaptureSetting_codeHook() {
    this->initializeModel();
}

OAISlotCaptureSetting_codeHook::~OAISlotCaptureSetting_codeHook() {}

void OAISlotCaptureSetting_codeHook::initializeModel() {
...
void OAISlotCaptureSetting_codeHook::fromJson(QString jsonString) {
...
void OAISlotCaptureSetting_codeHook::fromJsonObject(QJsonObject json) {
...
QString OAISlotCaptureSetting_codeHook::asJson() const {
...
QJsonObject OAISlotCaptureSetting_codeHook::asJsonObject() const {
    QJsonObject obj;
...
bool OAISlotCaptureSetting_codeHook::getEnableCodeHookInvocation() const {
    return m_enable_code_hook_invocation;
}
void OAISlotCaptureSetting_codeHook::setEnableCodeHookInvocation(const bool &enable_code_hook_invocation) {
    m_enable_code_hook_invocation = enable_code_hook_invocation;
    m_enable_code_hook_invocation_isSet = true;
}

bool OAISlotCaptureSetting_codeHook::is_enable_code_hook_invocation_Set() const{
    return m_enable_code_hook_invocation_isSet;
}

bool OAISlotCaptureSetting_codeHook::is_enable_code_hook_invocation_Valid() const{
    return m_enable_code_hook_invocation_isValid;
}

bool OAISlotCaptureSetting_codeHook::getActive() const {
    return m_active;
}
void OAISlotCaptureSetting_codeHook::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAISlotCaptureSetting_codeHook::is_active_Set() const{
    return m_active_isSet;
}

bool OAISlotCaptureSetting_codeHook::is_active_Valid() const{
    return m_active_isValid;
}

QString OAISlotCaptureSetting_codeHook::getInvocationLabel() const {
    return m_invocation_label;
}
void OAISlotCaptureSetting_codeHook::setInvocationLabel(const QString &invocation_label) {
    m_invocation_label = invocation_label;
    m_invocation_label_isSet = true;
}

bool OAISlotCaptureSetting_codeHook::is_invocation_label_Set() const{
    return m_invocation_label_isSet;
}

bool OAISlotCaptureSetting_codeHook::is_invocation_label_Valid() const{
    return m_invocation_label_isValid;
}

OAIDialogCodeHookInvocationSetting_postCodeHookSpecification OAISlotCaptureSetting_codeHook::getPostCodeHookSpecification() const {
    return m_post_code_hook_specification;
}
void OAISlotCaptureSetting_codeHook::setPostCodeHookSpecification(const OAIDialogCodeHookInvocationSetting_postCodeHookSpecification &post_code_hook_specification) {
    m_post_code_hook_specification = post_code_hook_specification;
    m_post_code_hook_specification_isSet = true;
}

bool OAISlotCaptureSetting_codeHook::is_post_code_hook_specification_Set() const{
    return m_post_code_hook_specification_isSet;
}

bool OAISlotCaptureSetting_codeHook::is_post_code_hook_specification_Valid() const{
    return m_post_code_hook_specification_isValid;
}

bool OAISlotCaptureSetting_codeHook::isSet() const {
...
bool OAISlotCaptureSetting_codeHook::isValid() const {
