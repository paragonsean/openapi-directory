...
/*
 * OAIUpdateBot_request.h
 *
 * 
 */

#ifndef OAIUpdateBot_request_H
#define OAIUpdateBot_request_H
...
class OAIUpdateBot_request : public OAIObject {
public:
    OAIUpdateBot_request();
    OAIUpdateBot_request(QString json);
    ~OAIUpdateBot_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBot_request)

#endif // OAIUpdateBot_request_H
