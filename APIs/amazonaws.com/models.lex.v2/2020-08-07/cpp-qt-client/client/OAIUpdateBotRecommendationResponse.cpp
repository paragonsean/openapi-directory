...
OAIUpdateBotRecommendationResponse::OAIUpdateBotRecommendationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBotRecommendationResponse::OAIUpdateBotRecommendationResponse() {
    this->initializeModel();
}

OAIUpdateBotRecommendationResponse::~OAIUpdateBotRecommendationResponse() {}

void OAIUpdateBotRecommendationResponse::initializeModel() {
...
void OAIUpdateBotRecommendationResponse::fromJson(QString jsonString) {
...
void OAIUpdateBotRecommendationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBotRecommendationResponse::asJson() const {
...
QJsonObject OAIUpdateBotRecommendationResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_bot_id_isSet) {
...
QString OAIUpdateBotRecommendationResponse::getBotId() const {
    return m_bot_id;
}
void OAIUpdateBotRecommendationResponse::setBotId(const QString &bot_id) {
    m_bot_id = bot_id;
    m_bot_id_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_bot_id_Set() const{
    return m_bot_id_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_bot_id_Valid() const{
    return m_bot_id_isValid;
}

QString OAIUpdateBotRecommendationResponse::getBotVersion() const {
    return m_bot_version;
}
void OAIUpdateBotRecommendationResponse::setBotVersion(const QString &bot_version) {
    m_bot_version = bot_version;
    m_bot_version_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_bot_version_Set() const{
    return m_bot_version_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_bot_version_Valid() const{
    return m_bot_version_isValid;
}

QString OAIUpdateBotRecommendationResponse::getLocaleId() const {
    return m_locale_id;
}
void OAIUpdateBotRecommendationResponse::setLocaleId(const QString &locale_id) {
    m_locale_id = locale_id;
    m_locale_id_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_locale_id_Set() const{
    return m_locale_id_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_locale_id_Valid() const{
    return m_locale_id_isValid;
}

OAIBotRecommendationStatus OAIUpdateBotRecommendationResponse::getBotRecommendationStatus() const {
    return m_bot_recommendation_status;
}
void OAIUpdateBotRecommendationResponse::setBotRecommendationStatus(const OAIBotRecommendationStatus &bot_recommendation_status) {
    m_bot_recommendation_status = bot_recommendation_status;
    m_bot_recommendation_status_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_bot_recommendation_status_Set() const{
    return m_bot_recommendation_status_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_bot_recommendation_status_Valid() const{
    return m_bot_recommendation_status_isValid;
}

QString OAIUpdateBotRecommendationResponse::getBotRecommendationId() const {
    return m_bot_recommendation_id;
}
void OAIUpdateBotRecommendationResponse::setBotRecommendationId(const QString &bot_recommendation_id) {
    m_bot_recommendation_id = bot_recommendation_id;
    m_bot_recommendation_id_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_bot_recommendation_id_Set() const{
    return m_bot_recommendation_id_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_bot_recommendation_id_Valid() const{
    return m_bot_recommendation_id_isValid;
}

QDateTime OAIUpdateBotRecommendationResponse::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAIUpdateBotRecommendationResponse::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

QDateTime OAIUpdateBotRecommendationResponse::getLastUpdatedDateTime() const {
    return m_last_updated_date_time;
}
void OAIUpdateBotRecommendationResponse::setLastUpdatedDateTime(const QDateTime &last_updated_date_time) {
    m_last_updated_date_time = last_updated_date_time;
    m_last_updated_date_time_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_last_updated_date_time_Set() const{
    return m_last_updated_date_time_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_last_updated_date_time_Valid() const{
    return m_last_updated_date_time_isValid;
}

OAIDescribeBotRecommendationResponse_transcriptSourceSetting OAIUpdateBotRecommendationResponse::getTranscriptSourceSetting() const {
    return m_transcript_source_setting;
}
void OAIUpdateBotRecommendationResponse::setTranscriptSourceSetting(const OAIDescribeBotRecommendationResponse_transcriptSourceSetting &transcript_source_setting) {
    m_transcript_source_setting = transcript_source_setting;
    m_transcript_source_setting_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_transcript_source_setting_Set() const{
    return m_transcript_source_setting_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_transcript_source_setting_Valid() const{
    return m_transcript_source_setting_isValid;
}

OAIDescribeBotRecommendationResponse_encryptionSetting OAIUpdateBotRecommendationResponse::getEncryptionSetting() const {
    return m_encryption_setting;
}
void OAIUpdateBotRecommendationResponse::setEncryptionSetting(const OAIDescribeBotRecommendationResponse_encryptionSetting &encryption_setting) {
    m_encryption_setting = encryption_setting;
    m_encryption_setting_isSet = true;
}

bool OAIUpdateBotRecommendationResponse::is_encryption_setting_Set() const{
    return m_encryption_setting_isSet;
}

bool OAIUpdateBotRecommendationResponse::is_encryption_setting_Valid() const{
    return m_encryption_setting_isValid;
}

bool OAIUpdateBotRecommendationResponse::isSet() const {
...
bool OAIUpdateBotRecommendationResponse::isValid() const {
