...
/*
 * OAICreateSlotTypeResponse.h
 *
 * 
 */

#ifndef OAICreateSlotTypeResponse_H
#define OAICreateSlotTypeResponse_H

#include <QJsonObject>

#include "OAICreateSlotTypeResponse_compositeSlotTypeSetting.h"
#include "OAICreateSlotTypeResponse_externalSourceSetting.h"
#include "OAICreateSlotTypeResponse_valueSelectionSetting.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICreateSlotTypeResponse_valueSelectionSetting;
class OAICreateSlotTypeResponse_externalSourceSetting;
class OAICreateSlotTypeResponse_compositeSlotTypeSetting;

class OAICreateSlotTypeResponse : public OAIObject {
public:
    OAICreateSlotTypeResponse();
    OAICreateSlotTypeResponse(QString json);
    ~OAICreateSlotTypeResponse() override;
    ...
    OAICreateSlotTypeResponse_valueSelectionSetting getValueSelectionSetting() const;
    void setValueSelectionSetting(const OAICreateSlotTypeResponse_valueSelectionSetting &value_selection_setting);
    ...
    OAICreateSlotTypeResponse_externalSourceSetting getExternalSourceSetting() const;
    void setExternalSourceSetting(const OAICreateSlotTypeResponse_externalSourceSetting &external_source_setting);
...
private:
    ...
    OAICreateSlotTypeResponse_valueSelectionSetting m_value_selection_setting;
    ...
    OAICreateSlotTypeResponse_externalSourceSetting m_external_source_setting;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateSlotTypeResponse)

#endif // OAICreateSlotTypeResponse_H
