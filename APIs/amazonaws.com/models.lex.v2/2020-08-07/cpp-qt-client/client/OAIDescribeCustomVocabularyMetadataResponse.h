...
/*
 * OAIDescribeCustomVocabularyMetadataResponse.h
 *
 * 
 */

#ifndef OAIDescribeCustomVocabularyMetadataResponse_H
#define OAIDescribeCustomVocabularyMetadataResponse_H
...
class OAIDescribeCustomVocabularyMetadataResponse : public OAIObject {
public:
    OAIDescribeCustomVocabularyMetadataResponse();
    OAIDescribeCustomVocabularyMetadataResponse(QString json);
    ~OAIDescribeCustomVocabularyMetadataResponse() override;
    ...
    OAICustomVocabularyStatus getCustomVocabularyStatus() const;
    void setCustomVocabularyStatus(const OAICustomVocabularyStatus &custom_vocabulary_status);
    bool is_custom_vocabulary_status_Set() const;
    bool is_custom_vocabulary_status_Valid() const;
...
private:
    ...
    OAICustomVocabularyStatus m_custom_vocabulary_status;
    bool m_custom_vocabulary_status_isSet;
    bool m_custom_vocabulary_status_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomVocabularyMetadataResponse)

#endif // OAIDescribeCustomVocabularyMetadataResponse_H
