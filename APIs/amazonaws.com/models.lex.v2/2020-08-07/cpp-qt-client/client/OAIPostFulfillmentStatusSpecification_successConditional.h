...
/*
 * OAIPostFulfillmentStatusSpecification_successConditional.h
 *
 * 
 */

#ifndef OAIPostFulfillmentStatusSpecification_successConditional_H
#define OAIPostFulfillmentStatusSpecification_successConditional_H
...
class OAIPostFulfillmentStatusSpecification_successConditional : public OAIObject {
public:
    OAIPostFulfillmentStatusSpecification_successConditional();
    OAIPostFulfillmentStatusSpecification_successConditional(QString json);
    ~OAIPostFulfillmentStatusSpecification_successConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostFulfillmentStatusSpecification_successConditional)

#endif // OAIPostFulfillmentStatusSpecification_successConditional_H
