...
/*
 * OAIPromptSpecification.h
 *
 * Specifies a list of message groups that Amazon Lex sends to a user to elicit a response.
 */

#ifndef OAIPromptSpecification_H
#define OAIPromptSpecification_H
...
class OAIPromptSpecification : public OAIObject {
public:
    OAIPromptSpecification();
    OAIPromptSpecification(QString json);
    ~OAIPromptSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPromptSpecification)

#endif // OAIPromptSpecification_H
