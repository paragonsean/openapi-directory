...
/*
 * OAISlotCaptureSetting_failureConditional.h
 *
 * 
 */

#ifndef OAISlotCaptureSetting_failureConditional_H
#define OAISlotCaptureSetting_failureConditional_H
...
class OAISlotCaptureSetting_failureConditional : public OAIObject {
public:
    OAISlotCaptureSetting_failureConditional();
    OAISlotCaptureSetting_failureConditional(QString json);
    ~OAISlotCaptureSetting_failureConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlotCaptureSetting_failureConditional)

#endif // OAISlotCaptureSetting_failureConditional_H
