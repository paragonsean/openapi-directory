...
/*
 * OAIIntentClassificationTestResultItem_resultCounts.h
 *
 * 
 */

#ifndef OAIIntentClassificationTestResultItem_resultCounts_H
#define OAIIntentClassificationTestResultItem_resultCounts_H
...
class OAIIntentClassificationTestResultItem_resultCounts : public OAIObject {
public:
    OAIIntentClassificationTestResultItem_resultCounts();
    OAIIntentClassificationTestResultItem_resultCounts(QString json);
    ~OAIIntentClassificationTestResultItem_resultCounts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntentClassificationTestResultItem_resultCounts)

#endif // OAIIntentClassificationTestResultItem_resultCounts_H
