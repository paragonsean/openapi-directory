...
OAIUpdateIntent_request::OAIUpdateIntent_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIntent_request::OAIUpdateIntent_request() {
    this->initializeModel();
}

OAIUpdateIntent_request::~OAIUpdateIntent_request() {}

void OAIUpdateIntent_request::initializeModel() {
...
void OAIUpdateIntent_request::fromJson(QString jsonString) {
...
void OAIUpdateIntent_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIntent_request::asJson() const {
...
QJsonObject OAIUpdateIntent_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateIntent_request::getIntentName() const {
    return m_intent_name;
}
void OAIUpdateIntent_request::setIntentName(const QString &intent_name) {
    m_intent_name = intent_name;
    m_intent_name_isSet = true;
}

bool OAIUpdateIntent_request::is_intent_name_Set() const{
    return m_intent_name_isSet;
}

bool OAIUpdateIntent_request::is_intent_name_Valid() const{
    return m_intent_name_isValid;
}

QString OAIUpdateIntent_request::getDescription() const {
    return m_description;
}
void OAIUpdateIntent_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateIntent_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateIntent_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateIntent_request::getParentIntentSignature() const {
    return m_parent_intent_signature;
}
void OAIUpdateIntent_request::setParentIntentSignature(const QString &parent_intent_signature) {
    m_parent_intent_signature = parent_intent_signature;
    m_parent_intent_signature_isSet = true;
}

bool OAIUpdateIntent_request::is_parent_intent_signature_Set() const{
    return m_parent_intent_signature_isSet;
}

bool OAIUpdateIntent_request::is_parent_intent_signature_Valid() const{
    return m_parent_intent_signature_isValid;
}

QList<OAISampleUtterance> OAIUpdateIntent_request::getSampleUtterances() const {
    return m_sample_utterances;
}
void OAIUpdateIntent_request::setSampleUtterances(const QList<OAISampleUtterance> &sample_utterances) {
    m_sample_utterances = sample_utterances;
    m_sample_utterances_isSet = true;
}

bool OAIUpdateIntent_request::is_sample_utterances_Set() const{
    return m_sample_utterances_isSet;
}

bool OAIUpdateIntent_request::is_sample_utterances_Valid() const{
    return m_sample_utterances_isValid;
}

OAICreateIntent_request_dialogCodeHook OAIUpdateIntent_request::getDialogCodeHook() const {
    return m_dialog_code_hook;
}
void OAIUpdateIntent_request::setDialogCodeHook(const OAICreateIntent_request_dialogCodeHook &dialog_code_hook) {
    m_dialog_code_hook = dialog_code_hook;
    m_dialog_code_hook_isSet = true;
}

bool OAIUpdateIntent_request::is_dialog_code_hook_Set() const{
    return m_dialog_code_hook_isSet;
}

bool OAIUpdateIntent_request::is_dialog_code_hook_Valid() const{
    return m_dialog_code_hook_isValid;
}

OAICreateIntent_request_fulfillmentCodeHook OAIUpdateIntent_request::getFulfillmentCodeHook() const {
    return m_fulfillment_code_hook;
}
void OAIUpdateIntent_request::setFulfillmentCodeHook(const OAICreateIntent_request_fulfillmentCodeHook &fulfillment_code_hook) {
    m_fulfillment_code_hook = fulfillment_code_hook;
    m_fulfillment_code_hook_isSet = true;
}

bool OAIUpdateIntent_request::is_fulfillment_code_hook_Set() const{
    return m_fulfillment_code_hook_isSet;
}

bool OAIUpdateIntent_request::is_fulfillment_code_hook_Valid() const{
    return m_fulfillment_code_hook_isValid;
}

QList<OAISlotPriority> OAIUpdateIntent_request::getSlotPriorities() const {
    return m_slot_priorities;
}
void OAIUpdateIntent_request::setSlotPriorities(const QList<OAISlotPriority> &slot_priorities) {
    m_slot_priorities = slot_priorities;
    m_slot_priorities_isSet = true;
}

bool OAIUpdateIntent_request::is_slot_priorities_Set() const{
    return m_slot_priorities_isSet;
}

bool OAIUpdateIntent_request::is_slot_priorities_Valid() const{
    return m_slot_priorities_isValid;
}

OAICreateIntent_request_intentConfirmationSetting OAIUpdateIntent_request::getIntentConfirmationSetting() const {
    return m_intent_confirmation_setting;
}
void OAIUpdateIntent_request::setIntentConfirmationSetting(const OAICreateIntent_request_intentConfirmationSetting &intent_confirmation_setting) {
    m_intent_confirmation_setting = intent_confirmation_setting;
    m_intent_confirmation_setting_isSet = true;
}

bool OAIUpdateIntent_request::is_intent_confirmation_setting_Set() const{
    return m_intent_confirmation_setting_isSet;
}

bool OAIUpdateIntent_request::is_intent_confirmation_setting_Valid() const{
    return m_intent_confirmation_setting_isValid;
}

OAICreateIntent_request_intentClosingSetting OAIUpdateIntent_request::getIntentClosingSetting() const {
    return m_intent_closing_setting;
}
void OAIUpdateIntent_request::setIntentClosingSetting(const OAICreateIntent_request_intentClosingSetting &intent_closing_setting) {
    m_intent_closing_setting = intent_closing_setting;
    m_intent_closing_setting_isSet = true;
}

bool OAIUpdateIntent_request::is_intent_closing_setting_Set() const{
    return m_intent_closing_setting_isSet;
}

bool OAIUpdateIntent_request::is_intent_closing_setting_Valid() const{
    return m_intent_closing_setting_isValid;
}

QList<OAIInputContext> OAIUpdateIntent_request::getInputContexts() const {
    return m_input_contexts;
}
void OAIUpdateIntent_request::setInputContexts(const QList<OAIInputContext> &input_contexts) {
    m_input_contexts = input_contexts;
    m_input_contexts_isSet = true;
}

bool OAIUpdateIntent_request::is_input_contexts_Set() const{
    return m_input_contexts_isSet;
}

bool OAIUpdateIntent_request::is_input_contexts_Valid() const{
    return m_input_contexts_isValid;
}

QList<OAIOutputContext> OAIUpdateIntent_request::getOutputContexts() const {
    return m_output_contexts;
}
void OAIUpdateIntent_request::setOutputContexts(const QList<OAIOutputContext> &output_contexts) {
    m_output_contexts = output_contexts;
    m_output_contexts_isSet = true;
}

bool OAIUpdateIntent_request::is_output_contexts_Set() const{
    return m_output_contexts_isSet;
}

bool OAIUpdateIntent_request::is_output_contexts_Valid() const{
    return m_output_contexts_isValid;
}

OAICreateIntent_request_kendraConfiguration OAIUpdateIntent_request::getKendraConfiguration() const {
    return m_kendra_configuration;
}
void OAIUpdateIntent_request::setKendraConfiguration(const OAICreateIntent_request_kendraConfiguration &kendra_configuration) {
    m_kendra_configuration = kendra_configuration;
    m_kendra_configuration_isSet = true;
}

bool OAIUpdateIntent_request::is_kendra_configuration_Set() const{
    return m_kendra_configuration_isSet;
}

bool OAIUpdateIntent_request::is_kendra_configuration_Valid() const{
    return m_kendra_configuration_isValid;
}

OAICreateIntent_request_initialResponseSetting OAIUpdateIntent_request::getInitialResponseSetting() const {
    return m_initial_response_setting;
}
void OAIUpdateIntent_request::setInitialResponseSetting(const OAICreateIntent_request_initialResponseSetting &initial_response_setting) {
    m_initial_response_setting = initial_response_setting;
    m_initial_response_setting_isSet = true;
}

bool OAIUpdateIntent_request::is_initial_response_setting_Set() const{
    return m_initial_response_setting_isSet;
}

bool OAIUpdateIntent_request::is_initial_response_setting_Valid() const{
    return m_initial_response_setting_isValid;
}

bool OAIUpdateIntent_request::isSet() const {
...
bool OAIUpdateIntent_request::isValid() const {
