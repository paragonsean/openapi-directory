...
/*
 * OAIDeleteResourcePolicyResponse.h
 *
 * 
 */

#ifndef OAIDeleteResourcePolicyResponse_H
#define OAIDeleteResourcePolicyResponse_H
...
class OAIDeleteResourcePolicyResponse : public OAIObject {
public:
    OAIDeleteResourcePolicyResponse();
    OAIDeleteResourcePolicyResponse(QString json);
    ~OAIDeleteResourcePolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteResourcePolicyResponse)

#endif // OAIDeleteResourcePolicyResponse_H
