...
/*
 * OAIListSessionMetricsRequest.h
 *
 * 
 */

#ifndef OAIListSessionMetricsRequest_H
#define OAIListSessionMetricsRequest_H
...
class OAIListSessionMetricsRequest : public OAIObject {
public:
    OAIListSessionMetricsRequest();
    OAIListSessionMetricsRequest(QString json);
    ~OAIListSessionMetricsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSessionMetricsRequest)

#endif // OAIListSessionMetricsRequest_H
