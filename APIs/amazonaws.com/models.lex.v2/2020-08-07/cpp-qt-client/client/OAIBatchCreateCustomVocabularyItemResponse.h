...
/*
 * OAIBatchCreateCustomVocabularyItemResponse.h
 *
 * 
 */

#ifndef OAIBatchCreateCustomVocabularyItemResponse_H
#define OAIBatchCreateCustomVocabularyItemResponse_H
...
class OAIBatchCreateCustomVocabularyItemResponse : public OAIObject {
public:
    OAIBatchCreateCustomVocabularyItemResponse();
    OAIBatchCreateCustomVocabularyItemResponse(QString json);
    ~OAIBatchCreateCustomVocabularyItemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchCreateCustomVocabularyItemResponse)

#endif // OAIBatchCreateCustomVocabularyItemResponse_H
