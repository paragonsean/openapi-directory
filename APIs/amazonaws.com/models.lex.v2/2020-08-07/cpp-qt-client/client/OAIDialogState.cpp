...
void OAIDialogState::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIDialogState::asJsonObject() const {
    QJsonObject obj;
...
OAIDialogAction OAIDialogState::getDialogAction() const {
    return m_dialog_action;
}
void OAIDialogState::setDialogAction(const OAIDialogAction &dialog_action) {
    m_dialog_action = dialog_action;
    m_dialog_action_isSet = true;
}

bool OAIDialogState::is_dialog_action_Set() const{
    return m_dialog_action_isSet;
}

bool OAIDialogState::is_dialog_action_Valid() const{
    return m_dialog_action_isValid;
}

OAIIntentOverride OAIDialogState::getIntent() const {
    return m_intent;
}
void OAIDialogState::setIntent(const OAIIntentOverride &intent) {
    m_intent = intent;
    m_intent_isSet = true;
}

bool OAIDialogState::is_intent_Set() const{
    return m_intent_isSet;
}

bool OAIDialogState::is_intent_Valid() const{
    return m_intent_isValid;
}

QMap OAIDialogState::getSessionAttributes() const {
    return m_session_attributes;
}
void OAIDialogState::setSessionAttributes(const QMap &session_attributes) {
    m_session_attributes = session_attributes;
    m_session_attributes_isSet = true;
}

bool OAIDialogState::is_session_attributes_Set() const{
    return m_session_attributes_isSet;
}

bool OAIDialogState::is_session_attributes_Valid() const{
