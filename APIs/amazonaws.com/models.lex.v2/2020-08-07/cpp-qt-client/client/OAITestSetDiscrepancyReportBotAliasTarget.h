...
/*
 * OAITestSetDiscrepancyReportBotAliasTarget.h
 *
 * Contains information about the bot alias used for the test set discrepancy report.
 */

#ifndef OAITestSetDiscrepancyReportBotAliasTarget_H
#define OAITestSetDiscrepancyReportBotAliasTarget_H
...
class OAITestSetDiscrepancyReportBotAliasTarget : public OAIObject {
public:
    OAITestSetDiscrepancyReportBotAliasTarget();
    OAITestSetDiscrepancyReportBotAliasTarget(QString json);
    ~OAITestSetDiscrepancyReportBotAliasTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestSetDiscrepancyReportBotAliasTarget)

#endif // OAITestSetDiscrepancyReportBotAliasTarget_H
