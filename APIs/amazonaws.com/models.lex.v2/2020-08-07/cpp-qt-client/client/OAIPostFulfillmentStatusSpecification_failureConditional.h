...
/*
 * OAIPostFulfillmentStatusSpecification_failureConditional.h
 *
 * 
 */

#ifndef OAIPostFulfillmentStatusSpecification_failureConditional_H
#define OAIPostFulfillmentStatusSpecification_failureConditional_H
...
class OAIPostFulfillmentStatusSpecification_failureConditional : public OAIObject {
public:
    OAIPostFulfillmentStatusSpecification_failureConditional();
    OAIPostFulfillmentStatusSpecification_failureConditional(QString json);
    ~OAIPostFulfillmentStatusSpecification_failureConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostFulfillmentStatusSpecification_failureConditional)

#endif // OAIPostFulfillmentStatusSpecification_failureConditional_H
