...
/*
 * OAIStillWaitingResponseSpecification.h
 *
 * Defines the messages that Amazon Lex sends to a user to remind them that the bot is waiting for a response.
 */

#ifndef OAIStillWaitingResponseSpecification_H
#define OAIStillWaitingResponseSpecification_H
...
class OAIStillWaitingResponseSpecification : public OAIObject {
public:
    OAIStillWaitingResponseSpecification();
    OAIStillWaitingResponseSpecification(QString json);
    ~OAIStillWaitingResponseSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStillWaitingResponseSpecification)

#endif // OAIStillWaitingResponseSpecification_H
