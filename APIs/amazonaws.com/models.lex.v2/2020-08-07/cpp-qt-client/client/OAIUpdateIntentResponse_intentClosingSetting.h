...
/*
 * OAIUpdateIntentResponse_intentClosingSetting.h
 *
 * 
 */

#ifndef OAIUpdateIntentResponse_intentClosingSetting_H
#define OAIUpdateIntentResponse_intentClosingSetting_H
...
class OAIUpdateIntentResponse_intentClosingSetting : public OAIObject {
public:
    OAIUpdateIntentResponse_intentClosingSetting();
    OAIUpdateIntentResponse_intentClosingSetting(QString json);
    ~OAIUpdateIntentResponse_intentClosingSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIntentResponse_intentClosingSetting)

#endif // OAIUpdateIntentResponse_intentClosingSetting_H
