...
/*
 * OAIResponseSpecification.h
 *
 * Specifies a list of message groups that Amazon Lex uses to respond the user input.
 */

#ifndef OAIResponseSpecification_H
#define OAIResponseSpecification_H
...
class OAIResponseSpecification : public OAIObject {
public:
    OAIResponseSpecification();
    OAIResponseSpecification(QString json);
    ~OAIResponseSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResponseSpecification)

#endif // OAIResponseSpecification_H
