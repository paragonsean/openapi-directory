...
/*
 * OAIBatchDeleteCustomVocabularyItemResponse.h
 *
 * 
 */

#ifndef OAIBatchDeleteCustomVocabularyItemResponse_H
#define OAIBatchDeleteCustomVocabularyItemResponse_H
...
class OAIBatchDeleteCustomVocabularyItemResponse : public OAIObject {
public:
    OAIBatchDeleteCustomVocabularyItemResponse();
    OAIBatchDeleteCustomVocabularyItemResponse(QString json);
    ~OAIBatchDeleteCustomVocabularyItemResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBatchDeleteCustomVocabularyItemResponse)

#endif // OAIBatchDeleteCustomVocabularyItemResponse_H
