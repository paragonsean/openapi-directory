...
#include "OAITestSetStorageLocation.h"
...
OAITestSetStorageLocation::OAITestSetStorageLocation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestSetStorageLocation::OAITestSetStorageLocation() {
    this->initializeModel();
}

OAITestSetStorageLocation::~OAITestSetStorageLocation() {}

void OAITestSetStorageLocation::initializeModel() {
...
void OAITestSetStorageLocation::fromJson(QString jsonString) {
...
void OAITestSetStorageLocation::fromJsonObject(QJsonObject json) {
...
QString OAITestSetStorageLocation::asJson() const {
...
QJsonObject OAITestSetStorageLocation::asJsonObject() const {
    QJsonObject obj;
...
QString OAITestSetStorageLocation::getS3BucketName() const {
    return m_s3_bucket_name;
}
void OAITestSetStorageLocation::setS3BucketName(const QString &s3_bucket_name) {
    m_s3_bucket_name = s3_bucket_name;
    m_s3_bucket_name_isSet = true;
}

bool OAITestSetStorageLocation::is_s3_bucket_name_Set() const{
    return m_s3_bucket_name_isSet;
}

bool OAITestSetStorageLocation::is_s3_bucket_name_Valid() const{
    return m_s3_bucket_name_isValid;
}

QString OAITestSetStorageLocation::getS3Path() const {
    return m_s3_path;
}
void OAITestSetStorageLocation::setS3Path(const QString &s3_path) {
    m_s3_path = s3_path;
    m_s3_path_isSet = true;
}

bool OAITestSetStorageLocation::is_s3_path_Set() const{
    return m_s3_path_isSet;
}

bool OAITestSetStorageLocation::is_s3_path_Valid() const{
    return m_s3_path_isValid;
}

QString OAITestSetStorageLocation::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAITestSetStorageLocation::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAITestSetStorageLocation::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAITestSetStorageLocation::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

bool OAITestSetStorageLocation::isSet() const {
...
bool OAITestSetStorageLocation::isValid() const {
