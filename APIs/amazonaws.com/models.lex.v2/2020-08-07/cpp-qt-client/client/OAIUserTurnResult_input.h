...
/*
 * OAIUserTurnResult_input.h
 *
 * 
 */

#ifndef OAIUserTurnResult_input_H
#define OAIUserTurnResult_input_H
...
class OAIUserTurnResult_input : public OAIObject {
public:
    OAIUserTurnResult_input();
    OAIUserTurnResult_input(QString json);
    ~OAIUserTurnResult_input() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserTurnResult_input)

#endif // OAIUserTurnResult_input_H
