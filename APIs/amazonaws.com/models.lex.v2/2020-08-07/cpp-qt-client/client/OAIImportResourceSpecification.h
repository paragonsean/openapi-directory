...
/*
 * OAIImportResourceSpecification.h
 *
...
#ifndef OAIImportResourceSpecification_H
#define OAIImportResourceSpecification_H
...
class OAIImportResourceSpecification : public OAIObject {
public:
    OAIImportResourceSpecification();
    OAIImportResourceSpecification(QString json);
    ~OAIImportResourceSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImportResourceSpecification)

#endif // OAIImportResourceSpecification_H
