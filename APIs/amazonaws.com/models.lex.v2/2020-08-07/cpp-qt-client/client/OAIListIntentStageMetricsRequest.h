...
/*
 * OAIListIntentStageMetricsRequest.h
 *
 * 
 */

#ifndef OAIListIntentStageMetricsRequest_H
#define OAIListIntentStageMetricsRequest_H
...
class OAIListIntentStageMetricsRequest : public OAIObject {
public:
    OAIListIntentStageMetricsRequest();
    OAIListIntentStageMetricsRequest(QString json);
    ~OAIListIntentStageMetricsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIntentStageMetricsRequest)

#endif // OAIListIntentStageMetricsRequest_H
