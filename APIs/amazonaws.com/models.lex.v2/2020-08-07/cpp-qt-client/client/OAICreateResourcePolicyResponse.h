...
/*
 * OAICreateResourcePolicyResponse.h
 *
 * 
 */

#ifndef OAICreateResourcePolicyResponse_H
#define OAICreateResourcePolicyResponse_H
...
class OAICreateResourcePolicyResponse : public OAIObject {
public:
    OAICreateResourcePolicyResponse();
    OAICreateResourcePolicyResponse(QString json);
    ~OAICreateResourcePolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateResourcePolicyResponse)

#endif // OAICreateResourcePolicyResponse_H
