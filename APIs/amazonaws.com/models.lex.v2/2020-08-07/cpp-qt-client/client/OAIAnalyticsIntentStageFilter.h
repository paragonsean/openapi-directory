...
/*
 * OAIAnalyticsIntentStageFilter.h
 *
...
#ifndef OAIAnalyticsIntentStageFilter_H
#define OAIAnalyticsIntentStageFilter_H
...
class OAIAnalyticsIntentStageFilter : public OAIObject {
public:
    OAIAnalyticsIntentStageFilter();
    OAIAnalyticsIntentStageFilter(QString json);
    ~OAIAnalyticsIntentStageFilter() override;
    ...
    OAIAnalyticsIntentStageFilterName getName() const;
    void setName(const OAIAnalyticsIntentStageFilterName &name);
...
private:
    ...
    OAIAnalyticsIntentStageFilterName m_name;
    bool m_name_isSet;
    bool m_name_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAnalyticsIntentStageFilter)

#endif // OAIAnalyticsIntentStageFilter_H
