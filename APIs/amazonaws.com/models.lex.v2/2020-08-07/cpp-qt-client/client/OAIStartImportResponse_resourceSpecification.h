...
/*
 * OAIStartImportResponse_resourceSpecification.h
 *
 * 
 */

#ifndef OAIStartImportResponse_resourceSpecification_H
#define OAIStartImportResponse_resourceSpecification_H
...
class OAIStartImportResponse_resourceSpecification : public OAIObject {
public:
    OAIStartImportResponse_resourceSpecification();
    OAIStartImportResponse_resourceSpecification(QString json);
    ~OAIStartImportResponse_resourceSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImportResponse_resourceSpecification)

#endif // OAIStartImportResponse_resourceSpecification_H
