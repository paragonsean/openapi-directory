...
/*
 * OAIParentBotNetwork.h
 *
 * A network of bots.
 */

#ifndef OAIParentBotNetwork_H
#define OAIParentBotNetwork_H
...
class OAIParentBotNetwork : public OAIObject {
public:
    OAIParentBotNetwork();
    OAIParentBotNetwork(QString json);
    ~OAIParentBotNetwork() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParentBotNetwork)

#endif // OAIParentBotNetwork_H
