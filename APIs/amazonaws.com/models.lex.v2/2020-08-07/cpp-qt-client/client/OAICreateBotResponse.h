...
namespace OpenAPI {
class OAICreateBotResponse_dataPrivacy;
...
public:
    ...
    OAICreateBotResponse_dataPrivacy getDataPrivacy() const;
    void setDataPrivacy(const OAICreateBotResponse_dataPrivacy &data_privacy);
...
private:
    ...
    OAICreateBotResponse_dataPrivacy m_data_privacy;
