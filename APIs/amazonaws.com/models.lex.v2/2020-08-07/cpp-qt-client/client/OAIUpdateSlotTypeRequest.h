...
/*
 * OAIUpdateSlotTypeRequest.h
 *
 * 
 */

#ifndef OAIUpdateSlotTypeRequest_H
#define OAIUpdateSlotTypeRequest_H
...
namespace OpenAPI {
class OAIUpdateSlotTypeRequest_valueSelectionSetting;
class OAIExternalSourceSetting;
class OAICreateSlotTypeResponse_compositeSlotTypeSetting;

class OAIUpdateSlotTypeRequest : public OAIObject {
public:
    OAIUpdateSlotTypeRequest();
    OAIUpdateSlotTypeRequest(QString json);
    ~OAIUpdateSlotTypeRequest() override;
    ...
    OAIUpdateSlotTypeRequest_valueSelectionSetting getValueSelectionSetting() const;
    void setValueSelectionSetting(const OAIUpdateSlotTypeRequest_valueSelectionSetting &value_selection_setting);
...
private:
    ...
    OAIUpdateSlotTypeRequest_valueSelectionSetting m_value_selection_setting;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateSlotTypeRequest)

#endif // OAIUpdateSlotTypeRequest_H
