...
/*
 * OAIDescribeBotResponse.h
 *
 * 
 */

#ifndef OAIDescribeBotResponse_H
#define OAIDescribeBotResponse_H
...
namespace OpenAPI {
class OAIDescribeBotResponse_dataPrivacy;

class OAIDescribeBotResponse : public OAIObject {
public:
    OAIDescribeBotResponse();
    OAIDescribeBotResponse(QString json);
    ~OAIDescribeBotResponse() override;
    ...
    OAIDescribeBotResponse_dataPrivacy getDataPrivacy() const;
    void setDataPrivacy(const OAIDescribeBotResponse_dataPrivacy &data_privacy);
...
private:
    ...
    OAIDescribeBotResponse_dataPrivacy m_data_privacy;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeBotResponse)

#endif // OAIDescribeBotResponse_H
