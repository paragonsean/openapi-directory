...
OAIUpdateSlot_request::OAIUpdateSlot_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSlot_request::OAIUpdateSlot_request() {
    this->initializeModel();
}

OAIUpdateSlot_request::~OAIUpdateSlot_request() {}

void OAIUpdateSlot_request::initializeModel() {
...
void OAIUpdateSlot_request::fromJson(QString jsonString) {
...
void OAIUpdateSlot_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSlot_request::asJson() const {
...
QJsonObject OAIUpdateSlot_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSlot_request::getSlotName() const {
    return m_slot_name;
}
void OAIUpdateSlot_request::setSlotName(const QString &slot_name) {
    m_slot_name = slot_name;
    m_slot_name_isSet = true;
}

bool OAIUpdateSlot_request::is_slot_name_Set() const{
    return m_slot_name_isSet;
}

bool OAIUpdateSlot_request::is_slot_name_Valid() const{
    return m_slot_name_isValid;
}

QString OAIUpdateSlot_request::getDescription() const {
    return m_description;
}
void OAIUpdateSlot_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateSlot_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateSlot_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateSlot_request::getSlotTypeId() const {
    return m_slot_type_id;
}
void OAIUpdateSlot_request::setSlotTypeId(const QString &slot_type_id) {
    m_slot_type_id = slot_type_id;
    m_slot_type_id_isSet = true;
}

bool OAIUpdateSlot_request::is_slot_type_id_Set() const{
    return m_slot_type_id_isSet;
}

bool OAIUpdateSlot_request::is_slot_type_id_Valid() const{
    return m_slot_type_id_isValid;
}

OAICreateSlot_request_valueElicitationSetting OAIUpdateSlot_request::getValueElicitationSetting() const {
    return m_value_elicitation_setting;
}
void OAIUpdateSlot_request::setValueElicitationSetting(const OAICreateSlot_request_valueElicitationSetting &value_elicitation_setting) {
    m_value_elicitation_setting = value_elicitation_setting;
    m_value_elicitation_setting_isSet = true;
}

bool OAIUpdateSlot_request::is_value_elicitation_setting_Set() const{
    return m_value_elicitation_setting_isSet;
}

bool OAIUpdateSlot_request::is_value_elicitation_setting_Valid() const{
    return m_value_elicitation_setting_isValid;
}

OAICreateSlot_request_obfuscationSetting OAIUpdateSlot_request::getObfuscationSetting() const {
    return m_obfuscation_setting;
}
void OAIUpdateSlot_request::setObfuscationSetting(const OAICreateSlot_request_obfuscationSetting &obfuscation_setting) {
    m_obfuscation_setting = obfuscation_setting;
    m_obfuscation_setting_isSet = true;
}

bool OAIUpdateSlot_request::is_obfuscation_setting_Set() const{
    return m_obfuscation_setting_isSet;
}

bool OAIUpdateSlot_request::is_obfuscation_setting_Valid() const{
    return m_obfuscation_setting_isValid;
}

OAICreateSlot_request_multipleValuesSetting OAIUpdateSlot_request::getMultipleValuesSetting() const {
    return m_multiple_values_setting;
}
void OAIUpdateSlot_request::setMultipleValuesSetting(const OAICreateSlot_request_multipleValuesSetting &multiple_values_setting) {
    m_multiple_values_setting = multiple_values_setting;
    m_multiple_values_setting_isSet = true;
}

bool OAIUpdateSlot_request::is_multiple_values_setting_Set() const{
    return m_multiple_values_setting_isSet;
}

bool OAIUpdateSlot_request::is_multiple_values_setting_Valid() const{
    return m_multiple_values_setting_isValid;
}

OAICreateSlot_request_subSlotSetting OAIUpdateSlot_request::getSubSlotSetting() const {
    return m_sub_slot_setting;
}
void OAIUpdateSlot_request::setSubSlotSetting(const OAICreateSlot_request_subSlotSetting &sub_slot_setting) {
    m_sub_slot_setting = sub_slot_setting;
    m_sub_slot_setting_isSet = true;
}

bool OAIUpdateSlot_request::is_sub_slot_setting_Set() const{
    return m_sub_slot_setting_isSet;
}

bool OAIUpdateSlot_request::is_sub_slot_setting_Valid() const{
    return m_sub_slot_setting_isValid;
}

bool OAIUpdateSlot_request::isSet() const {
...
bool OAIUpdateSlot_request::isValid() const {
