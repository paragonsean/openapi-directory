...
/*
 * OAICreateIntent_request_intentClosingSetting.h
 *
 * Provides a statement the Amazon Lex conveys to the user when the intent is successfully fulfilled.
 */

#ifndef OAICreateIntent_request_intentClosingSetting_H
#define OAICreateIntent_request_intentClosingSetting_H
...
class OAICreateIntent_request_intentClosingSetting : public OAIObject {
public:
    OAICreateIntent_request_intentClosingSetting();
    OAICreateIntent_request_intentClosingSetting(QString json);
    ~OAICreateIntent_request_intentClosingSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntent_request_intentClosingSetting)

#endif // OAICreateIntent_request_intentClosingSetting_H
