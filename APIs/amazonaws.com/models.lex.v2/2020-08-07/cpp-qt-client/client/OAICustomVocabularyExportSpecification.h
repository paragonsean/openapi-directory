...
/*
 * OAICustomVocabularyExportSpecification.h
 *
 * Provides the parameters required for exporting a custom vocabulary.
 */

#ifndef OAICustomVocabularyExportSpecification_H
#define OAICustomVocabularyExportSpecification_H
...
class OAICustomVocabularyExportSpecification : public OAIObject {
public:
    OAICustomVocabularyExportSpecification();
    OAICustomVocabularyExportSpecification(QString json);
    ~OAICustomVocabularyExportSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomVocabularyExportSpecification)

#endif // OAICustomVocabularyExportSpecification_H
