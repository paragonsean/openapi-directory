...
/*
 * OAIStartImportRequest_resourceSpecification.h
 *
 * 
 */

#ifndef OAIStartImportRequest_resourceSpecification_H
#define OAIStartImportRequest_resourceSpecification_H
...
class OAIStartImportRequest_resourceSpecification : public OAIObject {
public:
    OAIStartImportRequest_resourceSpecification();
    OAIStartImportRequest_resourceSpecification(QString json);
    ~OAIStartImportRequest_resourceSpecification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImportRequest_resourceSpecification)

#endif // OAIStartImportRequest_resourceSpecification_H
