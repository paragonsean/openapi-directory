...
/*
 * OAITestSetTurnResult_user.h
 *
 * 
 */

#ifndef OAITestSetTurnResult_user_H
#define OAITestSetTurnResult_user_H
...
class OAITestSetTurnResult_user : public OAIObject {
public:
    OAITestSetTurnResult_user();
    OAITestSetTurnResult_user(QString json);
    ~OAITestSetTurnResult_user() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestSetTurnResult_user)

#endif // OAITestSetTurnResult_user_H
