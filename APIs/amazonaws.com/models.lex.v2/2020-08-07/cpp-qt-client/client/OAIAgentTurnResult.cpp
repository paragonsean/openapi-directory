...
OAIAgentTurnResult::OAIAgentTurnResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAgentTurnResult::OAIAgentTurnResult() {
    this->initializeModel();
}

OAIAgentTurnResult::~OAIAgentTurnResult() {}

void OAIAgentTurnResult::initializeModel() {
...
void OAIAgentTurnResult::fromJson(QString jsonString) {
...
void OAIAgentTurnResult::fromJsonObject(QJsonObject json) {
...
QString OAIAgentTurnResult::asJson() const {
...
QJsonObject OAIAgentTurnResult::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAgentTurnResult::getExpectedAgentPrompt() const {
    return m_expected_agent_prompt;
}
void OAIAgentTurnResult::setExpectedAgentPrompt(const QString &expected_agent_prompt) {
    m_expected_agent_prompt = expected_agent_prompt;
    m_expected_agent_prompt_isSet = true;
}

bool OAIAgentTurnResult::is_expected_agent_prompt_Set() const{
    return m_expected_agent_prompt_isSet;
}

bool OAIAgentTurnResult::is_expected_agent_prompt_Valid() const{
    return m_expected_agent_prompt_isValid;
}

QString OAIAgentTurnResult::getActualAgentPrompt() const {
    return m_actual_agent_prompt;
}
void OAIAgentTurnResult::setActualAgentPrompt(const QString &actual_agent_prompt) {
    m_actual_agent_prompt = actual_agent_prompt;
    m_actual_agent_prompt_isSet = true;
}

bool OAIAgentTurnResult::is_actual_agent_prompt_Set() const{
    return m_actual_agent_prompt_isSet;
}

bool OAIAgentTurnResult::is_actual_agent_prompt_Valid() const{
    return m_actual_agent_prompt_isValid;
}

OAIExecutionErrorDetails OAIAgentTurnResult::getErrorDetails() const {
    return m_error_details;
}
void OAIAgentTurnResult::setErrorDetails(const OAIExecutionErrorDetails &error_details) {
    m_error_details = error_details;
    m_error_details_isSet = true;
}

bool OAIAgentTurnResult::is_error_details_Set() const{
    return m_error_details_isSet;
}

bool OAIAgentTurnResult::is_error_details_Valid() const{
    return m_error_details_isValid;
}

QString OAIAgentTurnResult::getActualElicitedSlot() const {
    return m_actual_elicited_slot;
}
void OAIAgentTurnResult::setActualElicitedSlot(const QString &actual_elicited_slot) {
    m_actual_elicited_slot = actual_elicited_slot;
    m_actual_elicited_slot_isSet = true;
}

bool OAIAgentTurnResult::is_actual_elicited_slot_Set() const{
    return m_actual_elicited_slot_isSet;
}

bool OAIAgentTurnResult::is_actual_elicited_slot_Valid() const{
    return m_actual_elicited_slot_isValid;
}

QString OAIAgentTurnResult::getActualIntent() const {
    return m_actual_intent;
}
void OAIAgentTurnResult::setActualIntent(const QString &actual_intent) {
    m_actual_intent = actual_intent;
    m_actual_intent_isSet = true;
}

bool OAIAgentTurnResult::is_actual_intent_Set() const{
    return m_actual_intent_isSet;
}

bool OAIAgentTurnResult::is_actual_intent_Valid() const{
    return m_actual_intent_isValid;
}

bool OAIAgentTurnResult::isSet() const {
...
bool OAIAgentTurnResult::isValid() const {
