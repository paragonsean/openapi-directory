...
/*
 * OAICreateIntentResponse_intentClosingSetting.h
 *
 * 
 */

#ifndef OAICreateIntentResponse_intentClosingSetting_H
#define OAICreateIntentResponse_intentClosingSetting_H
...
class OAICreateIntentResponse_intentClosingSetting : public OAIObject {
public:
    OAICreateIntentResponse_intentClosingSetting();
    OAICreateIntentResponse_intentClosingSetting(QString json);
    ~OAICreateIntentResponse_intentClosingSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntentResponse_intentClosingSetting)

#endif // OAICreateIntentResponse_intentClosingSetting_H
