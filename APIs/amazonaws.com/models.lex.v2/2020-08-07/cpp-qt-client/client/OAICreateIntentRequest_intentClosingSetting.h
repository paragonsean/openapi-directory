...
/*
 * OAICreateIntentRequest_intentClosingSetting.h
 *
 * 
 */

#ifndef OAICreateIntentRequest_intentClosingSetting_H
#define OAICreateIntentRequest_intentClosingSetting_H
...
class OAICreateIntentRequest_intentClosingSetting : public OAIObject {
public:
    OAICreateIntentRequest_intentClosingSetting();
    OAICreateIntentRequest_intentClosingSetting(QString json);
    ~OAICreateIntentRequest_intentClosingSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIntentRequest_intentClosingSetting)

#endif // OAICreateIntentRequest_intentClosingSetting_H
