...
/*
 * OAISlotCaptureSetting_captureConditional.h
 *
 * 
 */

#ifndef OAISlotCaptureSetting_captureConditional_H
#define OAISlotCaptureSetting_captureConditional_H
...
class OAISlotCaptureSetting_captureConditional : public OAIObject {
public:
    OAISlotCaptureSetting_captureConditional();
    OAISlotCaptureSetting_captureConditional(QString json);
    ~OAISlotCaptureSetting_captureConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISlotCaptureSetting_captureConditional)

#endif // OAISlotCaptureSetting_captureConditional_H
