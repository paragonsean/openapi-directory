...
/*
 * OAITestSetIntentDiscrepancyItem.h
 *
 * Contains information about discrepancy in an intent information between the test set and the bot.
 */

#ifndef OAITestSetIntentDiscrepancyItem_H
#define OAITestSetIntentDiscrepancyItem_H
...
class OAITestSetIntentDiscrepancyItem : public OAIObject {
public:
    OAITestSetIntentDiscrepancyItem();
    OAITestSetIntentDiscrepancyItem(QString json);
    ~OAITestSetIntentDiscrepancyItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestSetIntentDiscrepancyItem)

#endif // OAITestSetIntentDiscrepancyItem_H
