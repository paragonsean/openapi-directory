...
/*
 * OAIIntentClosingSetting.h
 *
 * Provides a statement the Amazon Lex conveys to the user when the intent is successfully fulfilled.
 */

#ifndef OAIIntentClosingSetting_H
#define OAIIntentClosingSetting_H
...
class OAIIntentClosingSetting : public OAIObject {
public:
    OAIIntentClosingSetting();
    OAIIntentClosingSetting(QString json);
    ~OAIIntentClosingSetting() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIntentClosingSetting)

#endif // OAIIntentClosingSetting_H
