...
/*
 * OAIUpdateResourcePolicyResponse.h
 *
 * 
 */

#ifndef OAIUpdateResourcePolicyResponse_H
#define OAIUpdateResourcePolicyResponse_H
...
class OAIUpdateResourcePolicyResponse : public OAIObject {
public:
    OAIUpdateResourcePolicyResponse();
    OAIUpdateResourcePolicyResponse(QString json);
    ~OAIUpdateResourcePolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateResourcePolicyResponse)

#endif // OAIUpdateResourcePolicyResponse_H
