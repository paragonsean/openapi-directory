...
/*
 * OAIDeleteBotLocaleResponse.h
 *
 * 
 */

#ifndef OAIDeleteBotLocaleResponse_H
#define OAIDeleteBotLocaleResponse_H
...
class OAIDeleteBotLocaleResponse : public OAIObject {
public:
    OAIDeleteBotLocaleResponse();
    OAIDeleteBotLocaleResponse(QString json);
    ~OAIDeleteBotLocaleResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBotLocaleResponse)

#endif // OAIDeleteBotLocaleResponse_H
