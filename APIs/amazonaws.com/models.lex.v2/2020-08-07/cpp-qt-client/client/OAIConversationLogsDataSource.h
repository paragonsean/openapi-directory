...
/*
 * OAIConversationLogsDataSource.h
 *
 * The data source that uses conversation logs.
 */

#ifndef OAIConversationLogsDataSource_H
#define OAIConversationLogsDataSource_H
...
class OAIConversationLogsDataSource : public OAIObject {
public:
    OAIConversationLogsDataSource();
    OAIConversationLogsDataSource(QString json);
    ~OAIConversationLogsDataSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConversationLogsDataSource)

#endif // OAIConversationLogsDataSource_H
