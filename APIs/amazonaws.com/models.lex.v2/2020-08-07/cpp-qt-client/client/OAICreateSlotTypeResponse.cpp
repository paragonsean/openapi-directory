...
OAICreateSlotTypeResponse::OAICreateSlotTypeResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateSlotTypeResponse::OAICreateSlotTypeResponse() {
    this->initializeModel();
}

OAICreateSlotTypeResponse::~OAICreateSlotTypeResponse() {}

void OAICreateSlotTypeResponse::initializeModel() {
...
void OAICreateSlotTypeResponse::fromJson(QString jsonString) {
...
void OAICreateSlotTypeResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateSlotTypeResponse::asJson() const {
...
QJsonObject OAICreateSlotTypeResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateSlotTypeResponse::getSlotTypeId() const {
    return m_slot_type_id;
}
void OAICreateSlotTypeResponse::setSlotTypeId(const QString &slot_type_id) {
    m_slot_type_id = slot_type_id;
    m_slot_type_id_isSet = true;
}

bool OAICreateSlotTypeResponse::is_slot_type_id_Set() const{
    return m_slot_type_id_isSet;
}

bool OAICreateSlotTypeResponse::is_slot_type_id_Valid() const{
    return m_slot_type_id_isValid;
}

QString OAICreateSlotTypeResponse::getSlotTypeName() const {
    return m_slot_type_name;
}
void OAICreateSlotTypeResponse::setSlotTypeName(const QString &slot_type_name) {
    m_slot_type_name = slot_type_name;
    m_slot_type_name_isSet = true;
}

bool OAICreateSlotTypeResponse::is_slot_type_name_Set() const{
    return m_slot_type_name_isSet;
}

bool OAICreateSlotTypeResponse::is_slot_type_name_Valid() const{
    return m_slot_type_name_isValid;
}

QString OAICreateSlotTypeResponse::getDescription() const {
    return m_description;
}
void OAICreateSlotTypeResponse::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateSlotTypeResponse::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateSlotTypeResponse::is_description_Valid() const{
    return m_description_isValid;
}

QList OAICreateSlotTypeResponse::getSlotTypeValues() const {
    return m_slot_type_values;
}
void OAICreateSlotTypeResponse::setSlotTypeValues(const QList &slot_type_values) {
    m_slot_type_values = slot_type_values;
    m_slot_type_values_isSet = true;
}

bool OAICreateSlotTypeResponse::is_slot_type_values_Set() const{
    return m_slot_type_values_isSet;
}

bool OAICreateSlotTypeResponse::is_slot_type_values_Valid() const{
    return m_slot_type_values_isValid;
}

OAICreateSlotTypeResponse_valueSelectionSetting OAICreateSlotTypeResponse::getValueSelectionSetting() const {
    return m_value_selection_setting;
}
void OAICreateSlotTypeResponse::setValueSelectionSetting(const OAICreateSlotTypeResponse_valueSelectionSetting &value_selection_setting) {
    m_value_selection_setting = value_selection_setting;
    m_value_selection_setting_isSet = true;
}

bool OAICreateSlotTypeResponse::is_value_selection_setting_Set() const{
    return m_value_selection_setting_isSet;
}

bool OAICreateSlotTypeResponse::is_value_selection_setting_Valid() const{
    return m_value_selection_setting_isValid;
}

QString OAICreateSlotTypeResponse::getParentSlotTypeSignature() const {
    return m_parent_slot_type_signature;
}
void OAICreateSlotTypeResponse::setParentSlotTypeSignature(const QString &parent_slot_type_signature) {
    m_parent_slot_type_signature = parent_slot_type_signature;
    m_parent_slot_type_signature_isSet = true;
}

bool OAICreateSlotTypeResponse::is_parent_slot_type_signature_Set() const{
    return m_parent_slot_type_signature_isSet;
}

bool OAICreateSlotTypeResponse::is_parent_slot_type_signature_Valid() const{
    return m_parent_slot_type_signature_isValid;
}

QString OAICreateSlotTypeResponse::getBotId() const {
    return m_bot_id;
}
void OAICreateSlotTypeResponse::setBotId(const QString &bot_id) {
    m_bot_id = bot_id;
    m_bot_id_isSet = true;
}

bool OAICreateSlotTypeResponse::is_bot_id_Set() const{
    return m_bot_id_isSet;
}

bool OAICreateSlotTypeResponse::is_bot_id_Valid() const{
    return m_bot_id_isValid;
}

QString OAICreateSlotTypeResponse::getBotVersion() const {
    return m_bot_version;
}
void OAICreateSlotTypeResponse::setBotVersion(const QString &bot_version) {
    m_bot_version = bot_version;
    m_bot_version_isSet = true;
}

bool OAICreateSlotTypeResponse::is_bot_version_Set() const{
    return m_bot_version_isSet;
}

bool OAICreateSlotTypeResponse::is_bot_version_Valid() const{
    return m_bot_version_isValid;
}

QString OAICreateSlotTypeResponse::getLocaleId() const {
    return m_locale_id;
}
void OAICreateSlotTypeResponse::setLocaleId(const QString &locale_id) {
    m_locale_id = locale_id;
    m_locale_id_isSet = true;
}

bool OAICreateSlotTypeResponse::is_locale_id_Set() const{
    return m_locale_id_isSet;
}

bool OAICreateSlotTypeResponse::is_locale_id_Valid() const{
    return m_locale_id_isValid;
}

QDateTime OAICreateSlotTypeResponse::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAICreateSlotTypeResponse::setCreationDateTime(const QDateTime &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAICreateSlotTypeResponse::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAICreateSlotTypeResponse::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

OAICreateSlotTypeResponse_externalSourceSetting OAICreateSlotTypeResponse::getExternalSourceSetting() const {
    return m_external_source_setting;
}
void OAICreateSlotTypeResponse::setExternalSourceSetting(const OAICreateSlotTypeResponse_externalSourceSetting &external_source_setting) {
    m_external_source_setting = external_source_setting;
    m_external_source_setting_isSet = true;
}

bool OAICreateSlotTypeResponse::is_external_source_setting_Set() const{
    return m_external_source_setting_isSet;
}

bool OAICreateSlotTypeResponse::is_external_source_setting_Valid() const{
    return m_external_source_setting_isValid;
}

OAICreateSlotTypeResponse_compositeSlotTypeSetting OAICreateSlotTypeResponse::getCompositeSlotTypeSetting() const {
    return m_composite_slot_type_setting;
}
void OAICreateSlotTypeResponse::setCompositeSlotTypeSetting(const OAICreateSlotTypeResponse_compositeSlotTypeSetting &composite_slot_type_setting) {
    m_composite_slot_type_setting = composite_slot_type_setting;
    m_composite_slot_type_setting_isSet = true;
}

bool OAICreateSlotTypeResponse::is_composite_slot_type_setting_Set() const{
    return m_composite_slot_type_setting_isSet;
}

bool OAICreateSlotTypeResponse::is_composite_slot_type_setting_Valid() const{
    return m_composite_slot_type_setting_isValid;
}

bool OAICreateSlotTypeResponse::isSet() const {
...
bool OAICreateSlotTypeResponse::isValid() const {
