...
/*
 * OAIListSessionAnalyticsDataRequest.h
 *
 * 
 */

#ifndef OAIListSessionAnalyticsDataRequest_H
#define OAIListSessionAnalyticsDataRequest_H

#include <QJsonObject>

#include "OAIListSessionAnalyticsDataRequest_sortBy.h"
#include <QDateTime>
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIListSessionAnalyticsDataRequest_sortBy;

class OAIListSessionAnalyticsDataRequest : public OAIObject {
public:
    OAIListSessionAnalyticsDataRequest();
    OAIListSessionAnalyticsDataRequest(QString json);
    ~OAIListSessionAnalyticsDataRequest() override;
    ...
    OAIListSessionAnalyticsDataRequest_sortBy getSortBy() const;
    void setSortBy(const OAIListSessionAnalyticsDataRequest_sortBy &sort_by);
...
private:
    ...
    OAIListSessionAnalyticsDataRequest_sortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSessionAnalyticsDataRequest)

#endif // OAIListSessionAnalyticsDataRequest_H
