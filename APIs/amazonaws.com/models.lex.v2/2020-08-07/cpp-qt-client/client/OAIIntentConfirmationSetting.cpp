...
#include "OAIIntentConfirmationSetting.h"
...
OAIIntentConfirmationSetting::OAIIntentConfirmationSetting(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIntentConfirmationSetting::OAIIntentConfirmationSetting() {
    this->initializeModel();
}

OAIIntentConfirmationSetting::~OAIIntentConfirmationSetting() {}

void OAIIntentConfirmationSetting::initializeModel() {
...
void OAIIntentConfirmationSetting::fromJson(QString jsonString) {
...
void OAIIntentConfirmationSetting::fromJsonObject(QJsonObject json) {
...
QString OAIIntentConfirmationSetting::asJson() const {
...
QJsonObject OAIIntentConfirmationSetting::asJsonObject() const {
    QJsonObject obj;
...
OAICreateIntent_request_intentConfirmationSetting_promptSpecification OAIIntentConfirmationSetting::getPromptSpecification() const {
    return m_prompt_specification;
}
void OAIIntentConfirmationSetting::setPromptSpecification(const OAICreateIntent_request_intentConfirmationSetting_promptSpecification &prompt_specification) {
    m_prompt_specification = prompt_specification;
    m_prompt_specification_isSet = true;
}

bool OAIIntentConfirmationSetting::is_prompt_specification_Set() const{
    return m_prompt_specification_isSet;
}

bool OAIIntentConfirmationSetting::is_prompt_specification_Valid() const{
    return m_prompt_specification_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_declinationResponse OAIIntentConfirmationSetting::getDeclinationResponse() const {
    return m_declination_response;
}
void OAIIntentConfirmationSetting::setDeclinationResponse(const OAICreateIntent_request_intentConfirmationSetting_declinationResponse &declination_response) {
    m_declination_response = declination_response;
    m_declination_response_isSet = true;
}

bool OAIIntentConfirmationSetting::is_declination_response_Set() const{
    return m_declination_response_isSet;
}

bool OAIIntentConfirmationSetting::is_declination_response_Valid() const{
    return m_declination_response_isValid;
}

bool OAIIntentConfirmationSetting::getActive() const {
    return m_active;
}
void OAIIntentConfirmationSetting::setActive(const bool &active) {
    m_active = active;
    m_active_isSet = true;
}

bool OAIIntentConfirmationSetting::is_active_Set() const{
    return m_active_isSet;
}

bool OAIIntentConfirmationSetting::is_active_Valid() const{
    return m_active_isValid;
}

OAIResponseSpecification OAIIntentConfirmationSetting::getConfirmationResponse() const {
    return m_confirmation_response;
}
void OAIIntentConfirmationSetting::setConfirmationResponse(const OAIResponseSpecification &confirmation_response) {
    m_confirmation_response = confirmation_response;
    m_confirmation_response_isSet = true;
}

bool OAIIntentConfirmationSetting::is_confirmation_response_Set() const{
    return m_confirmation_response_isSet;
}

bool OAIIntentConfirmationSetting::is_confirmation_response_Valid() const{
    return m_confirmation_response_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_confirmationNextStep OAIIntentConfirmationSetting::getConfirmationNextStep() const {
    return m_confirmation_next_step;
}
void OAIIntentConfirmationSetting::setConfirmationNextStep(const OAICreateIntent_request_intentConfirmationSetting_confirmationNextStep &confirmation_next_step) {
    m_confirmation_next_step = confirmation_next_step;
    m_confirmation_next_step_isSet = true;
}

bool OAIIntentConfirmationSetting::is_confirmation_next_step_Set() const{
    return m_confirmation_next_step_isSet;
}

bool OAIIntentConfirmationSetting::is_confirmation_next_step_Valid() const{
    return m_confirmation_next_step_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_confirmationConditional OAIIntentConfirmationSetting::getConfirmationConditional() const {
    return m_confirmation_conditional;
}
void OAIIntentConfirmationSetting::setConfirmationConditional(const OAICreateIntent_request_intentConfirmationSetting_confirmationConditional &confirmation_conditional) {
    m_confirmation_conditional = confirmation_conditional;
    m_confirmation_conditional_isSet = true;
}

bool OAIIntentConfirmationSetting::is_confirmation_conditional_Set() const{
    return m_confirmation_conditional_isSet;
}

bool OAIIntentConfirmationSetting::is_confirmation_conditional_Valid() const{
    return m_confirmation_conditional_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_declinationNextStep OAIIntentConfirmationSetting::getDeclinationNextStep() const {
    return m_declination_next_step;
}
void OAIIntentConfirmationSetting::setDeclinationNextStep(const OAICreateIntent_request_intentConfirmationSetting_declinationNextStep &declination_next_step) {
    m_declination_next_step = declination_next_step;
    m_declination_next_step_isSet = true;
}

bool OAIIntentConfirmationSetting::is_declination_next_step_Set() const{
    return m_declination_next_step_isSet;
}

bool OAIIntentConfirmationSetting::is_declination_next_step_Valid() const{
    return m_declination_next_step_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_declinationConditional OAIIntentConfirmationSetting::getDeclinationConditional() const {
    return m_declination_conditional;
}
void OAIIntentConfirmationSetting::setDeclinationConditional(const OAICreateIntent_request_intentConfirmationSetting_declinationConditional &declination_conditional) {
    m_declination_conditional = declination_conditional;
    m_declination_conditional_isSet = true;
}

bool OAIIntentConfirmationSetting::is_declination_conditional_Set() const{
    return m_declination_conditional_isSet;
}

bool OAIIntentConfirmationSetting::is_declination_conditional_Valid() const{
    return m_declination_conditional_isValid;
}

OAIResponseSpecification OAIIntentConfirmationSetting::getFailureResponse() const {
    return m_failure_response;
}
void OAIIntentConfirmationSetting::setFailureResponse(const OAIResponseSpecification &failure_response) {
    m_failure_response = failure_response;
    m_failure_response_isSet = true;
}

bool OAIIntentConfirmationSetting::is_failure_response_Set() const{
    return m_failure_response_isSet;
}

bool OAIIntentConfirmationSetting::is_failure_response_Valid() const{
    return m_failure_response_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_failureNextStep OAIIntentConfirmationSetting::getFailureNextStep() const {
    return m_failure_next_step;
}
void OAIIntentConfirmationSetting::setFailureNextStep(const OAICreateIntent_request_intentConfirmationSetting_failureNextStep &failure_next_step) {
    m_failure_next_step = failure_next_step;
    m_failure_next_step_isSet = true;
}

bool OAIIntentConfirmationSetting::is_failure_next_step_Set() const{
    return m_failure_next_step_isSet;
}

bool OAIIntentConfirmationSetting::is_failure_next_step_Valid() const{
    return m_failure_next_step_isValid;
}

OAIConditionalSpecification OAIIntentConfirmationSetting::getFailureConditional() const {
    return m_failure_conditional;
}
void OAIIntentConfirmationSetting::setFailureConditional(const OAIConditionalSpecification &failure_conditional) {
    m_failure_conditional = failure_conditional;
    m_failure_conditional_isSet = true;
}

bool OAIIntentConfirmationSetting::is_failure_conditional_Set() const{
    return m_failure_conditional_isSet;
}

bool OAIIntentConfirmationSetting::is_failure_conditional_Valid() const{
    return m_failure_conditional_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_codeHook OAIIntentConfirmationSetting::getCodeHook() const {
    return m_code_hook;
}
void OAIIntentConfirmationSetting::setCodeHook(const OAICreateIntent_request_intentConfirmationSetting_codeHook &code_hook) {
    m_code_hook = code_hook;
    m_code_hook_isSet = true;
}

bool OAIIntentConfirmationSetting::is_code_hook_Set() const{
    return m_code_hook_isSet;
}

bool OAIIntentConfirmationSetting::is_code_hook_Valid() const{
    return m_code_hook_isValid;
}

OAICreateIntent_request_intentConfirmationSetting_elicitationCodeHook OAIIntentConfirmationSetting::getElicitationCodeHook() const {
    return m_elicitation_code_hook;
}
void OAIIntentConfirmationSetting::setElicitationCodeHook(const OAICreateIntent_request_intentConfirmationSetting_elicitationCodeHook &elicitation_code_hook) {
    m_elicitation_code_hook = elicitation_code_hook;
    m_elicitation_code_hook_isSet = true;
}

bool OAIIntentConfirmationSetting::is_elicitation_code_hook_Set() const{
    return m_elicitation_code_hook_isSet;
}

bool OAIIntentConfirmationSetting::is_elicitation_code_hook_Valid() const{
    return m_elicitation_code_hook_isValid;
}

bool OAIIntentConfirmationSetting::isSet() const {
...
bool OAIIntentConfirmationSetting::isValid() const {
