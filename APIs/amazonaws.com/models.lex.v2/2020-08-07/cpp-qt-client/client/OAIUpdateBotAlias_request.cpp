...
OAIUpdateBotAlias_request::OAIUpdateBotAlias_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBotAlias_request::OAIUpdateBotAlias_request() {
    this->initializeModel();
}

OAIUpdateBotAlias_request::~OAIUpdateBotAlias_request() {}

void OAIUpdateBotAlias_request::initializeModel() {
...
void OAIUpdateBotAlias_request::fromJson(QString jsonString) {
...
void OAIUpdateBotAlias_request::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBotAlias_request::asJson() const {
...
QJsonObject OAIUpdateBotAlias_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateBotAlias_request::getBotAliasName() const {
    return m_bot_alias_name;
}
void OAIUpdateBotAlias_request::setBotAliasName(const QString &bot_alias_name) {
    m_bot_alias_name = bot_alias_name;
    m_bot_alias_name_isSet = true;
}

bool OAIUpdateBotAlias_request::is_bot_alias_name_Set() const{
    return m_bot_alias_name_isSet;
}

bool OAIUpdateBotAlias_request::is_bot_alias_name_Valid() const{
    return m_bot_alias_name_isValid;
}

QString OAIUpdateBotAlias_request::getDescription() const {
    return m_description;
}
void OAIUpdateBotAlias_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateBotAlias_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateBotAlias_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateBotAlias_request::getBotVersion() const {
    return m_bot_version;
}
void OAIUpdateBotAlias_request::setBotVersion(const QString &bot_version) {
    m_bot_version = bot_version;
    m_bot_version_isSet = true;
}

bool OAIUpdateBotAlias_request::is_bot_version_Set() const{
    return m_bot_version_isSet;
}

bool OAIUpdateBotAlias_request::is_bot_version_Valid() const{
    return m_bot_version_isValid;
}

QMap<QString, OAIBotAliasLocaleSettings> OAIUpdateBotAlias_request::getBotAliasLocaleSettings() const {
    return m_bot_alias_locale_settings;
}
void OAIUpdateBotAlias_request::setBotAliasLocaleSettings(const QMap<QString, OAIBotAliasLocaleSettings> &bot_alias_locale_settings) {
    m_bot_alias_locale_settings = bot_alias_locale_settings;
    m_bot_alias_locale_settings_isSet = true;
}

bool OAIUpdateBotAlias_request::is_bot_alias_locale_settings_Set() const{
    return m_bot_alias_locale_settings_isSet;
}

bool OAIUpdateBotAlias_request::is_bot_alias_locale_settings_Valid() const{
    return m_bot_alias_locale_settings_isValid;
}

OAICreateBotAlias_request_conversationLogSettings OAIUpdateBotAlias_request::getConversationLogSettings() const {
    return m_conversation_log_settings;
}
void OAIUpdateBotAlias_request::setConversationLogSettings(const OAICreateBotAlias_request_conversationLogSettings &conversation_log_settings) {
    m_conversation_log_settings = conversation_log_settings;
    m_conversation_log_settings_isSet = true;
}

bool OAIUpdateBotAlias_request::is_conversation_log_settings_Set() const{
    return m_conversation_log_settings_isSet;
}

bool OAIUpdateBotAlias_request::is_conversation_log_settings_Valid() const{
    return m_conversation_log_settings_isValid;
}

OAICreateBotAlias_request_sentimentAnalysisSettings OAIUpdateBotAlias_request::getSentimentAnalysisSettings() const {
    return m_sentiment_analysis_settings;
}
void OAIUpdateBotAlias_request::setSentimentAnalysisSettings(const OAICreateBotAlias_request_sentimentAnalysisSettings &sentiment_analysis_settings) {
    m_sentiment_analysis_settings = sentiment_analysis_settings;
    m_sentiment_analysis_settings_isSet = true;
}

bool OAIUpdateBotAlias_request::is_sentiment_analysis_settings_Set() const{
    return m_sentiment_analysis_settings_isSet;
}

bool OAIUpdateBotAlias_request::is_sentiment_analysis_settings_Valid() const{
    return m_sentiment_analysis_settings_isValid;
}

bool OAIUpdateBotAlias_request::isSet() const {
...
bool OAIUpdateBotAlias_request::isValid() const {
