...
/*
 * OAIListExports_request.h
 *
 * 
 */

#ifndef OAIListExports_request_H
#define OAIListExports_request_H

#include <QJsonObject>

#include "OAIExportFilter.h"
#include "OAIListExports_request_sortBy.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIListExports_request_sortBy;
class OAIExportFilter;

class OAIListExports_request : public OAIObject {
public:
    OAIListExports_request();
    OAIListExports_request(QString json);
    ~OAIListExports_request() override;
    ...
    OAIListExports_request_sortBy getSortBy() const;
    void setSortBy(const OAIListExports_request_sortBy &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    QList<OAIExportFilter> getFilters() const;
    void setFilters(const QList<OAIExportFilter> &filters);
...
private:
    ...
    OAIListExports_request_sortBy m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    QList<OAIExportFilter> m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListExports_request)

#endif // OAIListExports_request_H
