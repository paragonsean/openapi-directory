...
#ifndef OAIDateRangeFilter_H
#define OAIDateRangeFilter_H
...
class OAIDateRangeFilter : public OAIObject {
public:
    OAIDateRangeFilter();
    OAIDateRangeFilter(QString json);
    ~OAIDateRangeFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDateRangeFilter)

#endif // OAIDateRangeFilter_H
