...
/*
 * OAICreateBotRequest.h
 *
 * 
 */

#ifndef OAICreateBotRequest_H
#define OAICreateBotRequest_H
...
class OAICreateBotRequest : public OAIObject {
public:
    OAICreateBotRequest();
    OAICreateBotRequest(QString json);
    ~OAICreateBotRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBotRequest)

#endif // OAICreateBotRequest_H
