...
/*
 * OAIPostDialogCodeHookInvocationSpecification_timeoutConditional.h
 *
 * 
 */

#ifndef OAIPostDialogCodeHookInvocationSpecification_timeoutConditional_H
#define OAIPostDialogCodeHookInvocationSpecification_timeoutConditional_H
...
class OAIPostDialogCodeHookInvocationSpecification_timeoutConditional : public OAIObject {
public:
    OAIPostDialogCodeHookInvocationSpecification_timeoutConditional();
    OAIPostDialogCodeHookInvocationSpecification_timeoutConditional(QString json);
    ~OAIPostDialogCodeHookInvocationSpecification_timeoutConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostDialogCodeHookInvocationSpecification_timeoutConditional)

#endif // OAIPostDialogCodeHookInvocationSpecification_timeoutConditional_H
