...
#ifndef OAIImageResponseCard_H
#define OAIImageResponseCard_H
...
class OAIImageResponseCard : public OAIObject {
public:
    OAIImageResponseCard();
    OAIImageResponseCard(QString json);
    ~OAIImageResponseCard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIImageResponseCard)

#endif // OAIImageResponseCard_H
