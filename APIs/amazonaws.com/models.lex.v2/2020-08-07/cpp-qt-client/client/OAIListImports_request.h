...
namespace OpenAPI {
class OAIListImports_request_sortBy;
class OAIImportFilter;
...
public:
    ...
    OAIListImports_request_sortBy getSortBy() const;
    void setSortBy(const OAIListImports_request_sortBy &sort_by);
    bool is_sort_by_Set() const;
    bool is_sort_by_Valid() const;

    QList<OAIImportFilter> getFilters() const;
    void setFilters(const QList<OAIImportFilter> &filters);
...
private:
    ...
    OAIListImports_request_sortBy m_sort_by;
    bool m_sort_by_isSet;
    bool m_sort_by_isValid;

    QList<OAIImportFilter> m_filters;
