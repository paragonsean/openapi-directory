...
#include "OAIAudioSpecification.h"
...
OAIAudioSpecification::OAIAudioSpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAudioSpecification::OAIAudioSpecification() {
    this->initializeModel();
}

OAIAudioSpecification::~OAIAudioSpecification() {}

void OAIAudioSpecification::initializeModel() {
...
void OAIAudioSpecification::fromJson(QString jsonString) {
...
void OAIAudioSpecification::fromJsonObject(QJsonObject json) {
...
QString OAIAudioSpecification::asJson() const {
...
QJsonObject OAIAudioSpecification::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIAudioSpecification::getMaxLengthMs() const {
    return m_max_length_ms;
}
void OAIAudioSpecification::setMaxLengthMs(const qint32 &max_length_ms) {
    m_max_length_ms = max_length_ms;
    m_max_length_ms_isSet = true;
}

bool OAIAudioSpecification::is_max_length_ms_Set() const{
    return m_max_length_ms_isSet;
}

bool OAIAudioSpecification::is_max_length_ms_Valid() const{
    return m_max_length_ms_isValid;
}

qint32 OAIAudioSpecification::getEndTimeoutMs() const {
    return m_end_timeout_ms;
}
void OAIAudioSpecification::setEndTimeoutMs(const qint32 &end_timeout_ms) {
    m_end_timeout_ms = end_timeout_ms;
    m_end_timeout_ms_isSet = true;
}

bool OAIAudioSpecification::is_end_timeout_ms_Set() const{
    return m_end_timeout_ms_isSet;
}

bool OAIAudioSpecification::is_end_timeout_ms_Valid() const{
    return m_end_timeout_ms_isValid;
}

bool OAIAudioSpecification::isSet() const {
...
bool OAIAudioSpecification::isValid() const {
