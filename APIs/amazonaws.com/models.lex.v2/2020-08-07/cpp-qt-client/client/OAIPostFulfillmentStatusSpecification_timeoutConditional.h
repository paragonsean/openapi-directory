...
/*
 * OAIPostFulfillmentStatusSpecification_timeoutConditional.h
 *
 * 
 */

#ifndef OAIPostFulfillmentStatusSpecification_timeoutConditional_H
#define OAIPostFulfillmentStatusSpecification_timeoutConditional_H
...
class OAIPostFulfillmentStatusSpecification_timeoutConditional : public OAIObject {
public:
    OAIPostFulfillmentStatusSpecification_timeoutConditional();
    OAIPostFulfillmentStatusSpecification_timeoutConditional(QString json);
    ~OAIPostFulfillmentStatusSpecification_timeoutConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostFulfillmentStatusSpecification_timeoutConditional)

#endif // OAIPostFulfillmentStatusSpecification_timeoutConditional_H
