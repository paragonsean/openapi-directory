...
/*
 * OAIPostDialogCodeHookInvocationSpecification_successConditional.h
 *
 * 
 */

#ifndef OAIPostDialogCodeHookInvocationSpecification_successConditional_H
#define OAIPostDialogCodeHookInvocationSpecification_successConditional_H
...
class OAIPostDialogCodeHookInvocationSpecification_successConditional : public OAIObject {
public:
    OAIPostDialogCodeHookInvocationSpecification_successConditional();
    OAIPostDialogCodeHookInvocationSpecification_successConditional(QString json);
    ~OAIPostDialogCodeHookInvocationSpecification_successConditional() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPostDialogCodeHookInvocationSpecification_successConditional)

#endif // OAIPostDialogCodeHookInvocationSpecification_successConditional_H
