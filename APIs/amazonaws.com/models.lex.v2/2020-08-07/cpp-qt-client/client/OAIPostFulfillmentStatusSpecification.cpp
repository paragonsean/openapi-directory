...
#include "OAIPostFulfillmentStatusSpecification.h"
...
OAIPostFulfillmentStatusSpecification::OAIPostFulfillmentStatusSpecification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPostFulfillmentStatusSpecification::OAIPostFulfillmentStatusSpecification() {
    this->initializeModel();
}

OAIPostFulfillmentStatusSpecification::~OAIPostFulfillmentStatusSpecification() {}

void OAIPostFulfillmentStatusSpecification::initializeModel() {
...
void OAIPostFulfillmentStatusSpecification::fromJson(QString jsonString) {
...
void OAIPostFulfillmentStatusSpecification::fromJsonObject(QJsonObject json) {
...
QString OAIPostFulfillmentStatusSpecification::asJson() const {
...
QJsonObject OAIPostFulfillmentStatusSpecification::asJsonObject() const {
    QJsonObject obj;
...
OAIResponseSpecification OAIPostFulfillmentStatusSpecification::getSuccessResponse() const {
    return m_success_response;
}
void OAIPostFulfillmentStatusSpecification::setSuccessResponse(const OAIResponseSpecification &success_response) {
    m_success_response = success_response;
    m_success_response_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_success_response_Set() const{
    return m_success_response_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_success_response_Valid() const{
    return m_success_response_isValid;
}

OAIResponseSpecification OAIPostFulfillmentStatusSpecification::getFailureResponse() const {
    return m_failure_response;
}
void OAIPostFulfillmentStatusSpecification::setFailureResponse(const OAIResponseSpecification &failure_response) {
    m_failure_response = failure_response;
    m_failure_response_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_failure_response_Set() const{
    return m_failure_response_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_failure_response_Valid() const{
    return m_failure_response_isValid;
}

OAIResponseSpecification OAIPostFulfillmentStatusSpecification::getTimeoutResponse() const {
    return m_timeout_response;
}
void OAIPostFulfillmentStatusSpecification::setTimeoutResponse(const OAIResponseSpecification &timeout_response) {
    m_timeout_response = timeout_response;
    m_timeout_response_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_timeout_response_Set() const{
    return m_timeout_response_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_timeout_response_Valid() const{
    return m_timeout_response_isValid;
}

OAIPostFulfillmentStatusSpecification_successNextStep OAIPostFulfillmentStatusSpecification::getSuccessNextStep() const {
    return m_success_next_step;
}
void OAIPostFulfillmentStatusSpecification::setSuccessNextStep(const OAIPostFulfillmentStatusSpecification_successNextStep &success_next_step) {
    m_success_next_step = success_next_step;
    m_success_next_step_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_success_next_step_Set() const{
    return m_success_next_step_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_success_next_step_Valid() const{
    return m_success_next_step_isValid;
}

OAIPostFulfillmentStatusSpecification_successConditional OAIPostFulfillmentStatusSpecification::getSuccessConditional() const {
    return m_success_conditional;
}
void OAIPostFulfillmentStatusSpecification::setSuccessConditional(const OAIPostFulfillmentStatusSpecification_successConditional &success_conditional) {
    m_success_conditional = success_conditional;
    m_success_conditional_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_success_conditional_Set() const{
    return m_success_conditional_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_success_conditional_Valid() const{
    return m_success_conditional_isValid;
}

OAIPostFulfillmentStatusSpecification_failureNextStep OAIPostFulfillmentStatusSpecification::getFailureNextStep() const {
    return m_failure_next_step;
}
void OAIPostFulfillmentStatusSpecification::setFailureNextStep(const OAIPostFulfillmentStatusSpecification_failureNextStep &failure_next_step) {
    m_failure_next_step = failure_next_step;
    m_failure_next_step_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_failure_next_step_Set() const{
    return m_failure_next_step_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_failure_next_step_Valid() const{
    return m_failure_next_step_isValid;
}

OAIPostFulfillmentStatusSpecification_failureConditional OAIPostFulfillmentStatusSpecification::getFailureConditional() const {
    return m_failure_conditional;
}
void OAIPostFulfillmentStatusSpecification::setFailureConditional(const OAIPostFulfillmentStatusSpecification_failureConditional &failure_conditional) {
    m_failure_conditional = failure_conditional;
    m_failure_conditional_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_failure_conditional_Set() const{
    return m_failure_conditional_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_failure_conditional_Valid() const{
    return m_failure_conditional_isValid;
}

OAIPostFulfillmentStatusSpecification_timeoutNextStep OAIPostFulfillmentStatusSpecification::getTimeoutNextStep() const {
    return m_timeout_next_step;
}
void OAIPostFulfillmentStatusSpecification::setTimeoutNextStep(const OAIPostFulfillmentStatusSpecification_timeoutNextStep &timeout_next_step) {
    m_timeout_next_step = timeout_next_step;
    m_timeout_next_step_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_timeout_next_step_Set() const{
    return m_timeout_next_step_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_timeout_next_step_Valid() const{
    return m_timeout_next_step_isValid;
}

OAIPostFulfillmentStatusSpecification_timeoutConditional OAIPostFulfillmentStatusSpecification::getTimeoutConditional() const {
    return m_timeout_conditional;
}
void OAIPostFulfillmentStatusSpecification::setTimeoutConditional(const OAIPostFulfillmentStatusSpecification_timeoutConditional &timeout_conditional) {
    m_timeout_conditional = timeout_conditional;
    m_timeout_conditional_isSet = true;
}

bool OAIPostFulfillmentStatusSpecification::is_timeout_conditional_Set() const{
    return m_timeout_conditional_isSet;
}

bool OAIPostFulfillmentStatusSpecification::is_timeout_conditional_Valid() const{
    return m_timeout_conditional_isValid;
}

bool OAIPostFulfillmentStatusSpecification::isSet() const {
...
bool OAIPostFulfillmentStatusSpecification::isValid() const {
