...
|------------ | ------------- | ------------- | -------------|
|**startDateTime** | **OffsetDateTime** | The date and time that marks the beginning of the range of time for which you want to see utterance metrics. |  |
|**endDateTime** | **OffsetDateTime** | The date and time that marks the end of the range of time for which you want to see utterance metrics. |  |
|**metrics** | [**List&lt;AnalyticsUtteranceMetric&gt;**](AnalyticsUtteranceMetric.md) | A list of objects, each of which contains a metric you want to list, the statistic for the metric you want to return, and the method by which to organize the results. |  |
