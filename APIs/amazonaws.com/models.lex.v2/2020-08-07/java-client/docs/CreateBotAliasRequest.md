...
|**botAliasLocaleSettings** | [**Map&lt;String, BotAliasLocaleSettings&gt;**](BotAliasLocaleSettings.md) | Maps configuration information to a specific locale. You can use this parameter to specify a specific Lambda function to run different functions in different locales. |  [optional] |
...
|**tags** | **Map&lt;String, String&gt;** | A list of tags to add to the bot alias. You can only add tags when you create an alias, you can&#39;t use the &lt;code&gt;UpdateBotAlias&lt;/code&gt; operation to update the tags on a bot alias. To update tags, use the &lt;code&gt;TagResource&lt;/code&gt; operation. |  [optional] |
