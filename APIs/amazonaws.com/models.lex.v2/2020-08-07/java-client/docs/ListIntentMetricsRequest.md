...
|------------ | ------------- | ------------- | -------------|
|**startDateTime** | **OffsetDateTime** | The timestamp that marks the beginning of the range of time for which you want to see intent metrics. |  |
|**endDateTime** | **OffsetDateTime** | The date and time that marks the end of the range of time for which you want to see intent metrics. |  |
|**metrics** | [**List&lt;AnalyticsIntentMetric&gt;**](AnalyticsIntentMetric.md) | A list of objects, each of which contains a metric you want to list, the statistic for the metric you want to return, and the order by which to organize the results. |  |
