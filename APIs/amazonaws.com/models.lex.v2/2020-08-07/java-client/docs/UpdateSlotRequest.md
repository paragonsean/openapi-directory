...
|**description** | **String** | The new description for the slot. |  [optional] |
|**slotTypeId** | **String** | The unique identifier of the new slot type to associate with this slot.  |  [optional] |
