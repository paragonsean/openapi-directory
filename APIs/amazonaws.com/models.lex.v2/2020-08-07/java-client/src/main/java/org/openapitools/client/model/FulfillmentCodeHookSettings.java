...
public class FulfillmentCodeHookSettings {
  ...
  public FulfillmentCodeHookSettings() {
  }

  public FulfillmentCodeHookSettings enabled(Boolean enabled) {
  ...
  public FulfillmentCodeHookSettings postFulfillmentStatusSpecification(CreateIntentRequestFulfillmentCodeHookPostFulfillmentStatusSpecification postFulfillmentStatusSpecification) {
  ...
  public FulfillmentCodeHookSettings fulfillmentUpdatesSpecification(CreateIntentRequestFulfillmentCodeHookFulfillmentUpdatesSpecification fulfillmentUpdatesSpecification) {
  ...
  public FulfillmentCodeHookSettings active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    FulfillmentCodeHookSettings fulfillmentCodeHookSettings = (FulfillmentCodeHookSettings) o;
    return Objects.equals(this.enabled, fulfillmentCodeHookSettings.enabled) &&
        Objects.equals(this.postFulfillmentStatusSpecification, fulfillmentCodeHookSettings.postFulfillmentStatusSpecification) &&
        Objects.equals(this.fulfillmentUpdatesSpecification, fulfillmentCodeHookSettings.fulfillmentUpdatesSpecification) &&
        Objects.equals(this.active, fulfillmentCodeHookSettings.active);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentCodeHookSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FulfillmentCodeHookSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FulfillmentCodeHookSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FulfillmentCodeHookSettings is not found in the empty JSON string", FulfillmentCodeHookSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FulfillmentCodeHookSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FulfillmentCodeHookSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FulfillmentCodeHookSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FulfillmentCodeHookSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FulfillmentCodeHookSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FulfillmentCodeHookSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FulfillmentCodeHookSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<FulfillmentCodeHookSettings>() {
           @Override
           public void write(JsonWriter out, FulfillmentCodeHookSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FulfillmentCodeHookSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FulfillmentCodeHookSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FulfillmentCodeHookSettings
   * @throws IOException if the JSON string is invalid with respect to FulfillmentCodeHookSettings
   */
  public static FulfillmentCodeHookSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FulfillmentCodeHookSettings.class);
  }

  /**
   * Convert an instance of FulfillmentCodeHookSettings to an JSON string
   *
   * @return JSON string
   */
