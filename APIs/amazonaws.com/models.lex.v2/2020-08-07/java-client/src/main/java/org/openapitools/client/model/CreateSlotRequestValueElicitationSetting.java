...
public class CreateSlotRequestValueElicitationSetting {
  ...
  public CreateSlotRequestValueElicitationSetting() {
  }

  public CreateSlotRequestValueElicitationSetting defaultValueSpecification(CreateSlotRequestValueElicitationSettingDefaultValueSpecification defaultValueSpecification) {
  ...
  public CreateSlotRequestValueElicitationSetting slotConstraint(SlotConstraint slotConstraint) {
  ...
  public CreateSlotRequestValueElicitationSetting promptSpecification(CreateSlotRequestValueElicitationSettingPromptSpecification promptSpecification) {
  ...
  public CreateSlotRequestValueElicitationSetting sampleUtterances(List sampleUtterances) {
  ...
  public CreateSlotRequestValueElicitationSetting waitAndContinueSpecification(WaitAndContinueSpecification waitAndContinueSpecification) {
  ...
  public CreateSlotRequestValueElicitationSetting slotCaptureSetting(CreateSlotRequestValueElicitationSettingSlotCaptureSetting slotCaptureSetting) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSlotRequestValueElicitationSetting createSlotRequestValueElicitationSetting = (CreateSlotRequestValueElicitationSetting) o;
    return Objects.equals(this.defaultValueSpecification, createSlotRequestValueElicitationSetting.defaultValueSpecification) &&
        Objects.equals(this.slotConstraint, createSlotRequestValueElicitationSetting.slotConstraint) &&
        Objects.equals(this.promptSpecification, createSlotRequestValueElicitationSetting.promptSpecification) &&
        Objects.equals(this.sampleUtterances, createSlotRequestValueElicitationSetting.sampleUtterances) &&
        Objects.equals(this.waitAndContinueSpecification, createSlotRequestValueElicitationSetting.waitAndContinueSpecification) &&
        Objects.equals(this.slotCaptureSetting, createSlotRequestValueElicitationSetting.slotCaptureSetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSlotRequestValueElicitationSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSlotRequestValueElicitationSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSlotRequestValueElicitationSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSlotRequestValueElicitationSetting is not found in the empty JSON string", CreateSlotRequestValueElicitationSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSlotRequestValueElicitationSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSlotRequestValueElicitationSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSlotRequestValueElicitationSetting.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSlotRequestValueElicitationSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSlotRequestValueElicitationSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSlotRequestValueElicitationSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSlotRequestValueElicitationSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSlotRequestValueElicitationSetting>() {
           @Override
           public void write(JsonWriter out, CreateSlotRequestValueElicitationSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSlotRequestValueElicitationSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSlotRequestValueElicitationSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSlotRequestValueElicitationSetting
   * @throws IOException if the JSON string is invalid with respect to CreateSlotRequestValueElicitationSetting
   */
  public static CreateSlotRequestValueElicitationSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSlotRequestValueElicitationSetting.class);
  }

  /**
   * Convert an instance of CreateSlotRequestValueElicitationSetting to an JSON string
   *
   * @return JSON string
   */
