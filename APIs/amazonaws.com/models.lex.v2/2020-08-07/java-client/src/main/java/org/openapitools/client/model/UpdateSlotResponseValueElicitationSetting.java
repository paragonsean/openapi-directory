...
public class UpdateSlotResponseValueElicitationSetting {
  ...
  public UpdateSlotResponseValueElicitationSetting() {
  }

  public UpdateSlotResponseValueElicitationSetting defaultValueSpecification(CreateSlotRequestValueElicitationSettingDefaultValueSpecification defaultValueSpecification) {
  ...
  public UpdateSlotResponseValueElicitationSetting slotConstraint(SlotConstraint slotConstraint) {
  ...
  public UpdateSlotResponseValueElicitationSetting promptSpecification(CreateSlotRequestValueElicitationSettingPromptSpecification promptSpecification) {
  ...
  public UpdateSlotResponseValueElicitationSetting sampleUtterances(List sampleUtterances) {
  ...
  public UpdateSlotResponseValueElicitationSetting waitAndContinueSpecification(WaitAndContinueSpecification waitAndContinueSpecification) {
  ...
  public UpdateSlotResponseValueElicitationSetting slotCaptureSetting(CreateSlotRequestValueElicitationSettingSlotCaptureSetting slotCaptureSetting) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSlotResponseValueElicitationSetting updateSlotResponseValueElicitationSetting = (UpdateSlotResponseValueElicitationSetting) o;
    return Objects.equals(this.defaultValueSpecification, updateSlotResponseValueElicitationSetting.defaultValueSpecification) &&
        Objects.equals(this.slotConstraint, updateSlotResponseValueElicitationSetting.slotConstraint) &&
        Objects.equals(this.promptSpecification, updateSlotResponseValueElicitationSetting.promptSpecification) &&
        Objects.equals(this.sampleUtterances, updateSlotResponseValueElicitationSetting.sampleUtterances) &&
        Objects.equals(this.waitAndContinueSpecification, updateSlotResponseValueElicitationSetting.waitAndContinueSpecification) &&
        Objects.equals(this.slotCaptureSetting, updateSlotResponseValueElicitationSetting.slotCaptureSetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSlotResponseValueElicitationSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSlotResponseValueElicitationSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSlotResponseValueElicitationSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSlotResponseValueElicitationSetting is not found in the empty JSON string", UpdateSlotResponseValueElicitationSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSlotResponseValueElicitationSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSlotResponseValueElicitationSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateSlotResponseValueElicitationSetting.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSlotResponseValueElicitationSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSlotResponseValueElicitationSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSlotResponseValueElicitationSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSlotResponseValueElicitationSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSlotResponseValueElicitationSetting>() {
           @Override
           public void write(JsonWriter out, UpdateSlotResponseValueElicitationSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSlotResponseValueElicitationSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSlotResponseValueElicitationSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSlotResponseValueElicitationSetting
   * @throws IOException if the JSON string is invalid with respect to UpdateSlotResponseValueElicitationSetting
   */
  public static UpdateSlotResponseValueElicitationSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSlotResponseValueElicitationSetting.class);
  }

  /**
   * Convert an instance of UpdateSlotResponseValueElicitationSetting to an JSON string
   *
   * @return JSON string
   */
