...
public class CreateSlotRequestValueElicitationSettingSlotCaptureSetting {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting() {
  }

  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting captureResponse(ResponseSpecification captureResponse) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting captureNextStep(SlotCaptureSettingCaptureNextStep captureNextStep) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting captureConditional(SlotCaptureSettingCaptureConditional captureConditional) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting failureResponse(ResponseSpecification failureResponse) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting failureNextStep(SlotCaptureSettingFailureNextStep failureNextStep) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting failureConditional(SlotCaptureSettingFailureConditional failureConditional) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting codeHook(SlotCaptureSettingCodeHook codeHook) {
  ...
  public CreateSlotRequestValueElicitationSettingSlotCaptureSetting elicitationCodeHook(SlotCaptureSettingElicitationCodeHook elicitationCodeHook) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSlotRequestValueElicitationSettingSlotCaptureSetting createSlotRequestValueElicitationSettingSlotCaptureSetting = (CreateSlotRequestValueElicitationSettingSlotCaptureSetting) o;
    return Objects.equals(this.captureResponse, createSlotRequestValueElicitationSettingSlotCaptureSetting.captureResponse) &&
        Objects.equals(this.captureNextStep, createSlotRequestValueElicitationSettingSlotCaptureSetting.captureNextStep) &&
        Objects.equals(this.captureConditional, createSlotRequestValueElicitationSettingSlotCaptureSetting.captureConditional) &&
        Objects.equals(this.failureResponse, createSlotRequestValueElicitationSettingSlotCaptureSetting.failureResponse) &&
        Objects.equals(this.failureNextStep, createSlotRequestValueElicitationSettingSlotCaptureSetting.failureNextStep) &&
        Objects.equals(this.failureConditional, createSlotRequestValueElicitationSettingSlotCaptureSetting.failureConditional) &&
        Objects.equals(this.codeHook, createSlotRequestValueElicitationSettingSlotCaptureSetting.codeHook) &&
        Objects.equals(this.elicitationCodeHook, createSlotRequestValueElicitationSettingSlotCaptureSetting.elicitationCodeHook);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSlotRequestValueElicitationSettingSlotCaptureSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSlotRequestValueElicitationSettingSlotCaptureSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSlotRequestValueElicitationSettingSlotCaptureSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSlotRequestValueElicitationSettingSlotCaptureSetting is not found in the empty JSON string", CreateSlotRequestValueElicitationSettingSlotCaptureSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSlotRequestValueElicitationSettingSlotCaptureSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSlotRequestValueElicitationSettingSlotCaptureSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSlotRequestValueElicitationSettingSlotCaptureSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSlotRequestValueElicitationSettingSlotCaptureSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSlotRequestValueElicitationSettingSlotCaptureSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSlotRequestValueElicitationSettingSlotCaptureSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSlotRequestValueElicitationSettingSlotCaptureSetting>() {
           @Override
           public void write(JsonWriter out, CreateSlotRequestValueElicitationSettingSlotCaptureSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSlotRequestValueElicitationSettingSlotCaptureSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSlotRequestValueElicitationSettingSlotCaptureSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSlotRequestValueElicitationSettingSlotCaptureSetting
   * @throws IOException if the JSON string is invalid with respect to CreateSlotRequestValueElicitationSettingSlotCaptureSetting
   */
  public static CreateSlotRequestValueElicitationSettingSlotCaptureSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSlotRequestValueElicitationSettingSlotCaptureSetting.class);
  }

  /**
   * Convert an instance of CreateSlotRequestValueElicitationSettingSlotCaptureSetting to an JSON string
   *
   * @return JSON string
   */
