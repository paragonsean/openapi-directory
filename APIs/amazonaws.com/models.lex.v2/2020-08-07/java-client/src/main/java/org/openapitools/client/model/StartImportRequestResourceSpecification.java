...
public class StartImportRequestResourceSpecification {
  ...
  public StartImportRequestResourceSpecification() {
  }

  public StartImportRequestResourceSpecification botImportSpecification(StartImportRequestResourceSpecificationBotImportSpecification botImportSpecification) {
  ...
  public StartImportRequestResourceSpecification botLocaleImportSpecification(StartImportRequestResourceSpecificationBotLocaleImportSpecification botLocaleImportSpecification) {
  ...
  public StartImportRequestResourceSpecification customVocabularyImportSpecification(CustomVocabularyImportSpecification customVocabularyImportSpecification) {
  ...
  public StartImportRequestResourceSpecification testSetImportResourceSpecification(StartImportRequestResourceSpecificationTestSetImportResourceSpecification testSetImportResourceSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    StartImportRequestResourceSpecification startImportRequestResourceSpecification = (StartImportRequestResourceSpecification) o;
    return Objects.equals(this.botImportSpecification, startImportRequestResourceSpecification.botImportSpecification) &&
        Objects.equals(this.botLocaleImportSpecification, startImportRequestResourceSpecification.botLocaleImportSpecification) &&
        Objects.equals(this.customVocabularyImportSpecification, startImportRequestResourceSpecification.customVocabularyImportSpecification) &&
        Objects.equals(this.testSetImportResourceSpecification, startImportRequestResourceSpecification.testSetImportResourceSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartImportRequestResourceSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartImportRequestResourceSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartImportRequestResourceSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartImportRequestResourceSpecification is not found in the empty JSON string", StartImportRequestResourceSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartImportRequestResourceSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartImportRequestResourceSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartImportRequestResourceSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartImportRequestResourceSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartImportRequestResourceSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartImportRequestResourceSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<StartImportRequestResourceSpecification>() {
           @Override
           public void write(JsonWriter out, StartImportRequestResourceSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartImportRequestResourceSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartImportRequestResourceSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartImportRequestResourceSpecification
   * @throws IOException if the JSON string is invalid with respect to StartImportRequestResourceSpecification
   */
  public static StartImportRequestResourceSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartImportRequestResourceSpecification.class);
  }

  /**
   * Convert an instance of StartImportRequestResourceSpecification to an JSON string
   *
   * @return JSON string
   */
