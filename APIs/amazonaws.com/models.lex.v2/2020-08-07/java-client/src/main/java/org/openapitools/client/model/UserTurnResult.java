...
public class UserTurnResult {
  ...
  public UserTurnResult() {
  }

  public UserTurnResult input(UserTurnResultInput input) {
    this.input = input;
    return this;
  }
  ...
  public UserTurnResult expectedOutput(UserTurnResultExpectedOutput expectedOutput) {
  ...
  public UserTurnResult actualOutput(UserTurnResultActualOutput actualOutput) {
  ...
  public UserTurnResult errorDetails(ExecutionErrorDetails errorDetails) {
  ...
  public UserTurnResult endToEndResult(TestResultMatchStatus endToEndResult) {
  ...
  public UserTurnResult intentMatchResult(TestResultMatchStatus intentMatchResult) {
  ...
  public UserTurnResult slotMatchResult(TestResultMatchStatus slotMatchResult) {
  ...
  public UserTurnResult speechTranscriptionResult(TestResultMatchStatus speechTranscriptionResult) {
  ...
  public UserTurnResult conversationLevelResult(UserTurnResultConversationLevelResult conversationLevelResult) {
  ...
  public boolean equals(Object o) {
    ...
    UserTurnResult userTurnResult = (UserTurnResult) o;
    return Objects.equals(this.input, userTurnResult.input) &&
        Objects.equals(this.expectedOutput, userTurnResult.expectedOutput) &&
        Objects.equals(this.actualOutput, userTurnResult.actualOutput) &&
        Objects.equals(this.errorDetails, userTurnResult.errorDetails) &&
        Objects.equals(this.endToEndResult, userTurnResult.endToEndResult) &&
        Objects.equals(this.intentMatchResult, userTurnResult.intentMatchResult) &&
        Objects.equals(this.slotMatchResult, userTurnResult.slotMatchResult) &&
        Objects.equals(this.speechTranscriptionResult, userTurnResult.speechTranscriptionResult) &&
        Objects.equals(this.conversationLevelResult, userTurnResult.conversationLevelResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserTurnResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserTurnResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserTurnResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserTurnResult is not found in the empty JSON string", UserTurnResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserTurnResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserTurnResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserTurnResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserTurnResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserTurnResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserTurnResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserTurnResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UserTurnResult>() {
           @Override
           public void write(JsonWriter out, UserTurnResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserTurnResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserTurnResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserTurnResult
   * @throws IOException if the JSON string is invalid with respect to UserTurnResult
   */
  public static UserTurnResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserTurnResult.class);
  }

  /**
   * Convert an instance of UserTurnResult to an JSON string
   *
   * @return JSON string
   */
