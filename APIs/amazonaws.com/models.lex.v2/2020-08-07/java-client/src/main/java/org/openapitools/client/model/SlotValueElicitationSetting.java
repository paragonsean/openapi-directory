...
public class SlotValueElicitationSetting {
  ...
  public SlotValueElicitationSetting() {
  }

  public SlotValueElicitationSetting defaultValueSpecification(CreateSlotRequestValueElicitationSettingDefaultValueSpecification defaultValueSpecification) {
  ...
  public SlotValueElicitationSetting slotConstraint(SlotConstraint slotConstraint) {
  ...
  public SlotValueElicitationSetting promptSpecification(CreateSlotRequestValueElicitationSettingPromptSpecification promptSpecification) {
  ...
  public SlotValueElicitationSetting sampleUtterances(List sampleUtterances) {
  ...
  public SlotValueElicitationSetting waitAndContinueSpecification(WaitAndContinueSpecification waitAndContinueSpecification) {
  ...
  public SlotValueElicitationSetting slotCaptureSetting(CreateSlotRequestValueElicitationSettingSlotCaptureSetting slotCaptureSetting) {
  ...
  public boolean equals(Object o) {
    ...
    SlotValueElicitationSetting slotValueElicitationSetting = (SlotValueElicitationSetting) o;
    return Objects.equals(this.defaultValueSpecification, slotValueElicitationSetting.defaultValueSpecification) &&
        Objects.equals(this.slotConstraint, slotValueElicitationSetting.slotConstraint) &&
        Objects.equals(this.promptSpecification, slotValueElicitationSetting.promptSpecification) &&
        Objects.equals(this.sampleUtterances, slotValueElicitationSetting.sampleUtterances) &&
        Objects.equals(this.waitAndContinueSpecification, slotValueElicitationSetting.waitAndContinueSpecification) &&
        Objects.equals(this.slotCaptureSetting, slotValueElicitationSetting.slotCaptureSetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class SlotValueElicitationSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SlotValueElicitationSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SlotValueElicitationSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SlotValueElicitationSetting is not found in the empty JSON string", SlotValueElicitationSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SlotValueElicitationSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SlotValueElicitationSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SlotValueElicitationSetting.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SlotValueElicitationSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SlotValueElicitationSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SlotValueElicitationSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SlotValueElicitationSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<SlotValueElicitationSetting>() {
           @Override
           public void write(JsonWriter out, SlotValueElicitationSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SlotValueElicitationSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SlotValueElicitationSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SlotValueElicitationSetting
   * @throws IOException if the JSON string is invalid with respect to SlotValueElicitationSetting
   */
  public static SlotValueElicitationSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SlotValueElicitationSetting.class);
  }

  /**
   * Convert an instance of SlotValueElicitationSetting to an JSON string
   *
   * @return JSON string
   */
