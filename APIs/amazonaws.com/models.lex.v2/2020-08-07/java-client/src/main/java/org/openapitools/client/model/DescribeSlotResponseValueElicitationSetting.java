...
public class DescribeSlotResponseValueElicitationSetting {
  ...
  public DescribeSlotResponseValueElicitationSetting() {
  }

  public DescribeSlotResponseValueElicitationSetting defaultValueSpecification(CreateSlotRequestValueElicitationSettingDefaultValueSpecification defaultValueSpecification) {
  ...
  public DescribeSlotResponseValueElicitationSetting slotConstraint(SlotConstraint slotConstraint) {
  ...
  public DescribeSlotResponseValueElicitationSetting promptSpecification(CreateSlotRequestValueElicitationSettingPromptSpecification promptSpecification) {
  ...
  public DescribeSlotResponseValueElicitationSetting sampleUtterances(List sampleUtterances) {
  ...
  public DescribeSlotResponseValueElicitationSetting waitAndContinueSpecification(WaitAndContinueSpecification waitAndContinueSpecification) {
  ...
  public DescribeSlotResponseValueElicitationSetting slotCaptureSetting(CreateSlotRequestValueElicitationSettingSlotCaptureSetting slotCaptureSetting) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSlotResponseValueElicitationSetting describeSlotResponseValueElicitationSetting = (DescribeSlotResponseValueElicitationSetting) o;
    return Objects.equals(this.defaultValueSpecification, describeSlotResponseValueElicitationSetting.defaultValueSpecification) &&
        Objects.equals(this.slotConstraint, describeSlotResponseValueElicitationSetting.slotConstraint) &&
        Objects.equals(this.promptSpecification, describeSlotResponseValueElicitationSetting.promptSpecification) &&
        Objects.equals(this.sampleUtterances, describeSlotResponseValueElicitationSetting.sampleUtterances) &&
        Objects.equals(this.waitAndContinueSpecification, describeSlotResponseValueElicitationSetting.waitAndContinueSpecification) &&
        Objects.equals(this.slotCaptureSetting, describeSlotResponseValueElicitationSetting.slotCaptureSetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeSlotResponseValueElicitationSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSlotResponseValueElicitationSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSlotResponseValueElicitationSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSlotResponseValueElicitationSetting is not found in the empty JSON string", DescribeSlotResponseValueElicitationSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSlotResponseValueElicitationSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSlotResponseValueElicitationSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeSlotResponseValueElicitationSetting.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSlotResponseValueElicitationSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSlotResponseValueElicitationSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSlotResponseValueElicitationSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSlotResponseValueElicitationSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSlotResponseValueElicitationSetting>() {
           @Override
           public void write(JsonWriter out, DescribeSlotResponseValueElicitationSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSlotResponseValueElicitationSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSlotResponseValueElicitationSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSlotResponseValueElicitationSetting
   * @throws IOException if the JSON string is invalid with respect to DescribeSlotResponseValueElicitationSetting
   */
  public static DescribeSlotResponseValueElicitationSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSlotResponseValueElicitationSetting.class);
  }

  /**
   * Convert an instance of DescribeSlotResponseValueElicitationSetting to an JSON string
   *
   * @return JSON string
   */
