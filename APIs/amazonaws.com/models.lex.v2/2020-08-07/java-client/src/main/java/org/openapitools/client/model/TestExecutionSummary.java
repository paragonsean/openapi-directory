...
import org.openapitools.client.model.TestExecutionSummaryTarget;
...
public class TestExecutionSummary {
  ...
  private TestExecutionSummaryTarget target;
  ...
  public TestExecutionSummary testExecutionId(String testExecutionId) {
  ...
  public TestExecutionSummary creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public TestExecutionSummary lastUpdatedDateTime(OffsetDateTime lastUpdatedDateTime) {
  ...
  public TestExecutionSummary testExecutionStatus(TestExecutionStatus testExecutionStatus) {
  ...
  public TestExecutionSummary testSetId(String testSetId) {
  ...
  public TestExecutionSummary testSetName(String testSetName) {
  ...
  public TestExecutionSummary target(TestExecutionSummaryTarget target) {
    this.target = target;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public TestExecutionSummaryTarget getTarget() {
    return target;
  }

  public void setTarget(TestExecutionSummaryTarget target) {
    this.target = target;
  }


  public TestExecutionSummary apiMode(TestExecutionApiMode apiMode) {
  ...
  public TestExecutionSummary testExecutionModality(TestExecutionModality testExecutionModality) {
  ...
  public boolean equals(Object o) {
    ...
    TestExecutionSummary testExecutionSummary = (TestExecutionSummary) o;
    return Objects.equals(this.testExecutionId, testExecutionSummary.testExecutionId) &&
        Objects.equals(this.creationDateTime, testExecutionSummary.creationDateTime) &&
        Objects.equals(this.lastUpdatedDateTime, testExecutionSummary.lastUpdatedDateTime) &&
        Objects.equals(this.testExecutionStatus, testExecutionSummary.testExecutionStatus) &&
        Objects.equals(this.testSetId, testExecutionSummary.testSetId) &&
        Objects.equals(this.testSetName, testExecutionSummary.testSetName) &&
        Objects.equals(this.target, testExecutionSummary.target) &&
        Objects.equals(this.apiMode, testExecutionSummary.apiMode) &&
        Objects.equals(this.testExecutionModality, testExecutionSummary.testExecutionModality);
  }

  @Override
  public int hashCode() {
    return Objects.hash(testExecutionId, creationDateTime, lastUpdatedDateTime, testExecutionStatus, testSetId, testSetName, target, apiMode, testExecutionModality);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestExecutionSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestExecutionSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestExecutionSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TestExecutionSummary is not found in the empty JSON string", TestExecutionSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestExecutionSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestExecutionSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("target") != null && !jsonObj.get("target").isJsonNull()) {
        TestExecutionSummaryTarget.validateJsonElement(jsonObj.get("target"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestExecutionSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestExecutionSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestExecutionSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestExecutionSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<TestExecutionSummary>() {
           @Override
           public void write(JsonWriter out, TestExecutionSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestExecutionSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestExecutionSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestExecutionSummary
   * @throws IOException if the JSON string is invalid with respect to TestExecutionSummary
   */
  public static TestExecutionSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestExecutionSummary.class);
  }

  /**
   * Convert an instance of TestExecutionSummary to an JSON string
   *
   * @return JSON string
   */
