...
public class CreateSlotResponseValueElicitationSetting {
  ...
  public CreateSlotResponseValueElicitationSetting() {
  }

  public CreateSlotResponseValueElicitationSetting defaultValueSpecification(CreateSlotRequestValueElicitationSettingDefaultValueSpecification defaultValueSpecification) {
  ...
  public CreateSlotResponseValueElicitationSetting slotConstraint(SlotConstraint slotConstraint) {
  ...
  public CreateSlotResponseValueElicitationSetting promptSpecification(CreateSlotRequestValueElicitationSettingPromptSpecification promptSpecification) {
  ...
  public CreateSlotResponseValueElicitationSetting sampleUtterances(List sampleUtterances) {
  ...
  public CreateSlotResponseValueElicitationSetting waitAndContinueSpecification(WaitAndContinueSpecification waitAndContinueSpecification) {
  ...
  public CreateSlotResponseValueElicitationSetting slotCaptureSetting(CreateSlotRequestValueElicitationSettingSlotCaptureSetting slotCaptureSetting) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSlotResponseValueElicitationSetting createSlotResponseValueElicitationSetting = (CreateSlotResponseValueElicitationSetting) o;
    return Objects.equals(this.defaultValueSpecification, createSlotResponseValueElicitationSetting.defaultValueSpecification) &&
        Objects.equals(this.slotConstraint, createSlotResponseValueElicitationSetting.slotConstraint) &&
        Objects.equals(this.promptSpecification, createSlotResponseValueElicitationSetting.promptSpecification) &&
        Objects.equals(this.sampleUtterances, createSlotResponseValueElicitationSetting.sampleUtterances) &&
        Objects.equals(this.waitAndContinueSpecification, createSlotResponseValueElicitationSetting.waitAndContinueSpecification) &&
        Objects.equals(this.slotCaptureSetting, createSlotResponseValueElicitationSetting.slotCaptureSetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSlotResponseValueElicitationSetting {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSlotResponseValueElicitationSetting
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSlotResponseValueElicitationSetting.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSlotResponseValueElicitationSetting is not found in the empty JSON string", CreateSlotResponseValueElicitationSetting.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSlotResponseValueElicitationSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSlotResponseValueElicitationSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSlotResponseValueElicitationSetting.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSlotResponseValueElicitationSetting.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSlotResponseValueElicitationSetting' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSlotResponseValueElicitationSetting> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSlotResponseValueElicitationSetting.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSlotResponseValueElicitationSetting>() {
           @Override
           public void write(JsonWriter out, CreateSlotResponseValueElicitationSetting value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSlotResponseValueElicitationSetting read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSlotResponseValueElicitationSetting given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSlotResponseValueElicitationSetting
   * @throws IOException if the JSON string is invalid with respect to CreateSlotResponseValueElicitationSetting
   */
  public static CreateSlotResponseValueElicitationSetting fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSlotResponseValueElicitationSetting.class);
  }

  /**
   * Convert an instance of CreateSlotResponseValueElicitationSetting to an JSON string
   *
   * @return JSON string
   */
