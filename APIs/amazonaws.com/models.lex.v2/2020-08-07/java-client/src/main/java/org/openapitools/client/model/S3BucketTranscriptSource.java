...
public class S3BucketTranscriptSource {
  ...
  public S3BucketTranscriptSource() {
  }

  public S3BucketTranscriptSource s3BucketName(String s3BucketName) {
  ...
  public S3BucketTranscriptSource pathFormat(S3BucketTranscriptSourcePathFormat pathFormat) {
  ...
  public S3BucketTranscriptSource transcriptFormat(TranscriptFormat transcriptFormat) {
  ...
  public S3BucketTranscriptSource transcriptFilter(S3BucketTranscriptSourceTranscriptFilter transcriptFilter) {
  ...
  public S3BucketTranscriptSource kmsKeyArn(String kmsKeyArn) {
  ...
  public boolean equals(Object o) {
    ...
    S3BucketTranscriptSource s3BucketTranscriptSource = (S3BucketTranscriptSource) o;
    return Objects.equals(this.s3BucketName, s3BucketTranscriptSource.s3BucketName) &&
        Objects.equals(this.pathFormat, s3BucketTranscriptSource.pathFormat) &&
        Objects.equals(this.transcriptFormat, s3BucketTranscriptSource.transcriptFormat) &&
        Objects.equals(this.transcriptFilter, s3BucketTranscriptSource.transcriptFilter) &&
        Objects.equals(this.kmsKeyArn, s3BucketTranscriptSource.kmsKeyArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3BucketTranscriptSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3BucketTranscriptSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3BucketTranscriptSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3BucketTranscriptSource is not found in the empty JSON string", S3BucketTranscriptSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3BucketTranscriptSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3BucketTranscriptSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : S3BucketTranscriptSource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3BucketTranscriptSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3BucketTranscriptSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3BucketTranscriptSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3BucketTranscriptSource.class));

       return (TypeAdapter<T>) new TypeAdapter<S3BucketTranscriptSource>() {
           @Override
           public void write(JsonWriter out, S3BucketTranscriptSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3BucketTranscriptSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3BucketTranscriptSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3BucketTranscriptSource
   * @throws IOException if the JSON string is invalid with respect to S3BucketTranscriptSource
   */
  public static S3BucketTranscriptSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3BucketTranscriptSource.class);
  }

  /**
   * Convert an instance of S3BucketTranscriptSource to an JSON string
   *
   * @return JSON string
   */
