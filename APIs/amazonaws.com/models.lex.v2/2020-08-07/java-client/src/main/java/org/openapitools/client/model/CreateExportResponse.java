...
public class CreateExportResponse {
  ...
  public CreateExportResponse exportId(String exportId) {
  ...
  public CreateExportResponse resourceSpecification(CreateExportResponseResourceSpecification resourceSpecification) {
  ...
  public CreateExportResponse fileFormat(ImportExportFileFormat fileFormat) {
  ...
  public CreateExportResponse exportStatus(ExportStatus exportStatus) {
  ...
  public CreateExportResponse creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    CreateExportResponse createExportResponse = (CreateExportResponse) o;
    return Objects.equals(this.exportId, createExportResponse.exportId) &&
        Objects.equals(this.resourceSpecification, createExportResponse.resourceSpecification) &&
        Objects.equals(this.fileFormat, createExportResponse.fileFormat) &&
        Objects.equals(this.exportStatus, createExportResponse.exportStatus) &&
        Objects.equals(this.creationDateTime, createExportResponse.creationDateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exportId, resourceSpecification, fileFormat, exportStatus, creationDateTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateExportResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateExportResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateExportResponse is not found in the empty JSON string", CreateExportResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateExportResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateExportResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateExportResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateExportResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateExportResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateExportResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateExportResponse>() {
           @Override
           public void write(JsonWriter out, CreateExportResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateExportResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateExportResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateExportResponse
   * @throws IOException if the JSON string is invalid with respect to CreateExportResponse
   */
  public static CreateExportResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateExportResponse.class);
  }

  /**
   * Convert an instance of CreateExportResponse to an JSON string
   *
   * @return JSON string
   */
