...
public class CreateSlotTypeRequest {
  ...
  public CreateSlotTypeRequest() {
  }

  public CreateSlotTypeRequest slotTypeName(String slotTypeName) {
  ...
  public CreateSlotTypeRequest description(String description) {
  ...
  public CreateSlotTypeRequest slotTypeValues(List<SlotTypeValue> slotTypeValues) {
    this.slotTypeValues = slotTypeValues;
    return this;
  }

  public CreateSlotTypeRequest addSlotTypeValuesItem(SlotTypeValue slotTypeValuesItem) {
  ...
  public CreateSlotTypeRequest valueSelectionSetting(CreateSlotTypeRequestValueSelectionSetting valueSelectionSetting) {
  ...
  public CreateSlotTypeRequest parentSlotTypeSignature(String parentSlotTypeSignature) {
  ...
  public CreateSlotTypeRequest externalSourceSetting(CreateSlotTypeRequestExternalSourceSetting externalSourceSetting) {
  ...
  public CreateSlotTypeRequest compositeSlotTypeSetting(CreateSlotTypeRequestCompositeSlotTypeSetting compositeSlotTypeSetting) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSlotTypeRequest createSlotTypeRequest = (CreateSlotTypeRequest) o;
    return Objects.equals(this.slotTypeName, createSlotTypeRequest.slotTypeName) &&
        Objects.equals(this.description, createSlotTypeRequest.description) &&
        Objects.equals(this.slotTypeValues, createSlotTypeRequest.slotTypeValues) &&
        Objects.equals(this.valueSelectionSetting, createSlotTypeRequest.valueSelectionSetting) &&
        Objects.equals(this.parentSlotTypeSignature, createSlotTypeRequest.parentSlotTypeSignature) &&
        Objects.equals(this.externalSourceSetting, createSlotTypeRequest.externalSourceSetting) &&
        Objects.equals(this.compositeSlotTypeSetting, createSlotTypeRequest.compositeSlotTypeSetting);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSlotTypeRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSlotTypeRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSlotTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSlotTypeRequest is not found in the empty JSON string", CreateSlotTypeRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSlotTypeRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateSlotTypeRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSlotTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSlotTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSlotTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSlotTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSlotTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSlotTypeRequest>() {
           @Override
           public void write(JsonWriter out, CreateSlotTypeRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSlotTypeRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSlotTypeRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSlotTypeRequest
   * @throws IOException if the JSON string is invalid with respect to CreateSlotTypeRequest
   */
  public static CreateSlotTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSlotTypeRequest.class);
  }

  /**
   * Convert an instance of CreateSlotTypeRequest to an JSON string
   *
   * @return JSON string
   */
