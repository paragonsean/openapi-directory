...
import org.openapitools.client.model.UpdateBotAliasResponseConversationLogSettings;
...
public class UpdateBotAliasResponse {
  ...
  private UpdateBotAliasResponseConversationLogSettings conversationLogSettings;
  ...
  public UpdateBotAliasResponse botAliasId(String botAliasId) {
  ...
  public UpdateBotAliasResponse botAliasName(String botAliasName) {
  ...
  public UpdateBotAliasResponse description(String description) {
  ...
  public UpdateBotAliasResponse botVersion(String botVersion) {
  ...
  public UpdateBotAliasResponse botAliasLocaleSettings(Map botAliasLocaleSettings) {
  ...
  public UpdateBotAliasResponse conversationLogSettings(UpdateBotAliasResponseConversationLogSettings conversationLogSettings) {
   ...
   */
  @javax.annotation.Nullable
  public UpdateBotAliasResponseConversationLogSettings getConversationLogSettings() {
    return conversationLogSettings;
  }

  public void setConversationLogSettings(UpdateBotAliasResponseConversationLogSettings conversationLogSettings) {
    this.conversationLogSettings = conversationLogSettings;
  }


  public UpdateBotAliasResponse sentimentAnalysisSettings(SentimentAnalysisSettings sentimentAnalysisSettings) {
  ...
  public UpdateBotAliasResponse botAliasStatus(BotAliasStatus botAliasStatus) {
  ...
  public UpdateBotAliasResponse botId(String botId) {
    this.botId = botId;
    return this;
  }
  ...
  public UpdateBotAliasResponse creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public UpdateBotAliasResponse lastUpdatedDateTime(OffsetDateTime lastUpdatedDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBotAliasResponse updateBotAliasResponse = (UpdateBotAliasResponse) o;
    return Objects.equals(this.botAliasId, updateBotAliasResponse.botAliasId) &&
        Objects.equals(this.botAliasName, updateBotAliasResponse.botAliasName) &&
        Objects.equals(this.description, updateBotAliasResponse.description) &&
        Objects.equals(this.botVersion, updateBotAliasResponse.botVersion) &&
        Objects.equals(this.botAliasLocaleSettings, updateBotAliasResponse.botAliasLocaleSettings) &&
        Objects.equals(this.conversationLogSettings, updateBotAliasResponse.conversationLogSettings) &&
        Objects.equals(this.sentimentAnalysisSettings, updateBotAliasResponse.sentimentAnalysisSettings) &&
        Objects.equals(this.botAliasStatus, updateBotAliasResponse.botAliasStatus) &&
        Objects.equals(this.botId, updateBotAliasResponse.botId) &&
        Objects.equals(this.creationDateTime, updateBotAliasResponse.creationDateTime) &&
        Objects.equals(this.lastUpdatedDateTime, updateBotAliasResponse.lastUpdatedDateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(botAliasId, botAliasName, description, botVersion, botAliasLocaleSettings, conversationLogSettings, sentimentAnalysisSettings, botAliasStatus, botId, creationDateTime, lastUpdatedDateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateBotAliasResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBotAliasResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBotAliasResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBotAliasResponse is not found in the empty JSON string", UpdateBotAliasResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBotAliasResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBotAliasResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("conversationLogSettings") != null && !jsonObj.get("conversationLogSettings").isJsonNull()) {
        UpdateBotAliasResponseConversationLogSettings.validateJsonElement(jsonObj.get("conversationLogSettings"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBotAliasResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBotAliasResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBotAliasResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBotAliasResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBotAliasResponse>() {
           @Override
           public void write(JsonWriter out, UpdateBotAliasResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBotAliasResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBotAliasResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBotAliasResponse
   * @throws IOException if the JSON string is invalid with respect to UpdateBotAliasResponse
   */
  public static UpdateBotAliasResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBotAliasResponse.class);
  }

  /**
   * Convert an instance of UpdateBotAliasResponse to an JSON string
   *
   * @return JSON string
   */
