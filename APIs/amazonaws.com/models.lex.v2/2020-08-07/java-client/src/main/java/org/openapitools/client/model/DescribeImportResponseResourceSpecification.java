...
public class DescribeImportResponseResourceSpecification {
  ...
  public DescribeImportResponseResourceSpecification() {
  }

  public DescribeImportResponseResourceSpecification botImportSpecification(StartImportRequestResourceSpecificationBotImportSpecification botImportSpecification) {
  ...
  public DescribeImportResponseResourceSpecification botLocaleImportSpecification(StartImportRequestResourceSpecificationBotLocaleImportSpecification botLocaleImportSpecification) {
  ...
  public DescribeImportResponseResourceSpecification customVocabularyImportSpecification(CustomVocabularyImportSpecification customVocabularyImportSpecification) {
  ...
  public DescribeImportResponseResourceSpecification testSetImportResourceSpecification(StartImportRequestResourceSpecificationTestSetImportResourceSpecification testSetImportResourceSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeImportResponseResourceSpecification describeImportResponseResourceSpecification = (DescribeImportResponseResourceSpecification) o;
    return Objects.equals(this.botImportSpecification, describeImportResponseResourceSpecification.botImportSpecification) &&
        Objects.equals(this.botLocaleImportSpecification, describeImportResponseResourceSpecification.botLocaleImportSpecification) &&
        Objects.equals(this.customVocabularyImportSpecification, describeImportResponseResourceSpecification.customVocabularyImportSpecification) &&
        Objects.equals(this.testSetImportResourceSpecification, describeImportResponseResourceSpecification.testSetImportResourceSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeImportResponseResourceSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeImportResponseResourceSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeImportResponseResourceSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeImportResponseResourceSpecification is not found in the empty JSON string", DescribeImportResponseResourceSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeImportResponseResourceSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeImportResponseResourceSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeImportResponseResourceSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeImportResponseResourceSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeImportResponseResourceSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeImportResponseResourceSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeImportResponseResourceSpecification>() {
           @Override
           public void write(JsonWriter out, DescribeImportResponseResourceSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeImportResponseResourceSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeImportResponseResourceSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeImportResponseResourceSpecification
   * @throws IOException if the JSON string is invalid with respect to DescribeImportResponseResourceSpecification
   */
  public static DescribeImportResponseResourceSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeImportResponseResourceSpecification.class);
  }

  /**
   * Convert an instance of DescribeImportResponseResourceSpecification to an JSON string
   *
   * @return JSON string
   */
