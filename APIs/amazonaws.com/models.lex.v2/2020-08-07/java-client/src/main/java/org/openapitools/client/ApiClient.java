...
public class ApiClient {
    ...
    private String basePath = "http://models-v2-lex.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-08-07/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://models-v2-lex.us-east-1.amazonaws.com
