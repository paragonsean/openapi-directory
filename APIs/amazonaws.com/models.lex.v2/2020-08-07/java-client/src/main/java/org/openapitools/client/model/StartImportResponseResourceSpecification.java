...
public class StartImportResponseResourceSpecification {
  ...
  public StartImportResponseResourceSpecification() {
  }

  public StartImportResponseResourceSpecification botImportSpecification(StartImportRequestResourceSpecificationBotImportSpecification botImportSpecification) {
  ...
  public StartImportResponseResourceSpecification botLocaleImportSpecification(StartImportRequestResourceSpecificationBotLocaleImportSpecification botLocaleImportSpecification) {
  ...
  public StartImportResponseResourceSpecification customVocabularyImportSpecification(CustomVocabularyImportSpecification customVocabularyImportSpecification) {
  ...
  public StartImportResponseResourceSpecification testSetImportResourceSpecification(StartImportRequestResourceSpecificationTestSetImportResourceSpecification testSetImportResourceSpecification) {
  ...
  public boolean equals(Object o) {
    ...
    StartImportResponseResourceSpecification startImportResponseResourceSpecification = (StartImportResponseResourceSpecification) o;
    return Objects.equals(this.botImportSpecification, startImportResponseResourceSpecification.botImportSpecification) &&
        Objects.equals(this.botLocaleImportSpecification, startImportResponseResourceSpecification.botLocaleImportSpecification) &&
        Objects.equals(this.customVocabularyImportSpecification, startImportResponseResourceSpecification.customVocabularyImportSpecification) &&
        Objects.equals(this.testSetImportResourceSpecification, startImportResponseResourceSpecification.testSetImportResourceSpecification);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartImportResponseResourceSpecification {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartImportResponseResourceSpecification
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartImportResponseResourceSpecification.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartImportResponseResourceSpecification is not found in the empty JSON string", StartImportResponseResourceSpecification.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartImportResponseResourceSpecification.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartImportResponseResourceSpecification` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartImportResponseResourceSpecification.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartImportResponseResourceSpecification' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartImportResponseResourceSpecification> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartImportResponseResourceSpecification.class));

       return (TypeAdapter<T>) new TypeAdapter<StartImportResponseResourceSpecification>() {
           @Override
           public void write(JsonWriter out, StartImportResponseResourceSpecification value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartImportResponseResourceSpecification read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartImportResponseResourceSpecification given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartImportResponseResourceSpecification
   * @throws IOException if the JSON string is invalid with respect to StartImportResponseResourceSpecification
   */
  public static StartImportResponseResourceSpecification fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartImportResponseResourceSpecification.class);
  }

  /**
   * Convert an instance of StartImportResponseResourceSpecification to an JSON string
   *
   * @return JSON string
   */
