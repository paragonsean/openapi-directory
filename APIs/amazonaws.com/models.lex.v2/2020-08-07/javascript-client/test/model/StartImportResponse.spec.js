...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.StartImportResponse();
  });
  ...
  describe('StartImportResponse', function() {
    it('should create an instance of StartImportResponse', function() {
      ...
      //var instance = new AmazonLexModelBuildingV2.StartImportResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.StartImportResponse);
    });
