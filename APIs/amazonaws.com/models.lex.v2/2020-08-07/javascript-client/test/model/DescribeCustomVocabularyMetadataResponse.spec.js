...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.DescribeCustomVocabularyMetadataResponse();
  });
  ...
  describe('DescribeCustomVocabularyMetadataResponse', function() {
    it('should create an instance of DescribeCustomVocabularyMetadataResponse', function() {
      // uncomment below and update the code to test DescribeCustomVocabularyMetadataResponse
      //var instance = new AmazonLexModelBuildingV2.DescribeCustomVocabularyMetadataResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.DescribeCustomVocabularyMetadataResponse);
    });
