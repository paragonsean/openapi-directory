...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListIntentsRequest();
  });
  ...
  describe('ListIntentsRequest', function() {
    it('should create an instance of ListIntentsRequest', function() {
      // uncomment below and update the code to test ListIntentsRequest
      //var instance = new AmazonLexModelBuildingV2.ListIntentsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListIntentsRequest);
    });
