...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListUtteranceAnalyticsDataRequest();
  });
  ...
  describe('ListUtteranceAnalyticsDataRequest', function() {
    it('should create an instance of ListUtteranceAnalyticsDataRequest', function() {
      // uncomment below and update the code to test ListUtteranceAnalyticsDataRequest
      //var instance = new AmazonLexModelBuildingV2.ListUtteranceAnalyticsDataRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListUtteranceAnalyticsDataRequest);
    });
