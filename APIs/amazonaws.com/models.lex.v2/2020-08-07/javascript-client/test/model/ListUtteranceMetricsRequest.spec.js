...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListUtteranceMetricsRequest();
  });
  ...
  describe('ListUtteranceMetricsRequest', function() {
    it('should create an instance of ListUtteranceMetricsRequest', function() {
      // uncomment below and update the code to test ListUtteranceMetricsRequest
      //var instance = new AmazonLexModelBuildingV2.ListUtteranceMetricsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListUtteranceMetricsRequest);
    });
