...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListBotAliasesRequest();
  });
  ...
  describe('ListBotAliasesRequest', function() {
    it('should create an instance of ListBotAliasesRequest', function() {
      // uncomment below and update the code to test ListBotAliasesRequest
      //var instance = new AmazonLexModelBuildingV2.ListBotAliasesRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListBotAliasesRequest);
    });
