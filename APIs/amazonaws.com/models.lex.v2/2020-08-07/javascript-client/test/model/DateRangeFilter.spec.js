...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.DateRangeFilter();
  });
  ...
  describe('DateRangeFilter', function() {
    it('should create an instance of DateRangeFilter', function() {
      // uncomment below and update the code to test DateRangeFilter
      //var instance = new AmazonLexModelBuildingV2.DateRangeFilter();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.DateRangeFilter);
    });
