...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.TestSetSummary();
  });
  ...
  describe('TestSetSummary', function() {
    it('should create an instance of TestSetSummary', function() {
      // uncomment below and update the code to test TestSetSummary
      //var instance = new AmazonLexModelBuildingV2.TestSetSummary();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.TestSetSummary);
    });
