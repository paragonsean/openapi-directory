...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ConditionalBranch();
  });
  ...
  describe('ConditionalBranch', function() {
    it('should create an instance of ConditionalBranch', function() {
      // uncomment below and update the code to test ConditionalBranch
      //var instance = new AmazonLexModelBuildingV2.ConditionalBranch();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ConditionalBranch);
    });
