...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ExportSummary();
  });
  ...
  describe('ExportSummary', function() {
    it('should create an instance of ExportSummary', function() {
      ...
      //var instance = new AmazonLexModelBuildingV2.ExportSummary();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ExportSummary);
    });
