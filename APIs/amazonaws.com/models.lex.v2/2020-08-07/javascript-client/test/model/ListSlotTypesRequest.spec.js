...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListSlotTypesRequest();
  });
  ...
  describe('ListSlotTypesRequest', function() {
    it('should create an instance of ListSlotTypesRequest', function() {
      // uncomment below and update the code to test ListSlotTypesRequest
      //var instance = new AmazonLexModelBuildingV2.ListSlotTypesRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListSlotTypesRequest);
    });
