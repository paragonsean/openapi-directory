...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListBuiltInIntentsRequest();
  });
  ...
  describe('ListBuiltInIntentsRequest', function() {
    it('should create an instance of ListBuiltInIntentsRequest', function() {
      // uncomment below and update the code to test ListBuiltInIntentsRequest
      //var instance = new AmazonLexModelBuildingV2.ListBuiltInIntentsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListBuiltInIntentsRequest);
    });
