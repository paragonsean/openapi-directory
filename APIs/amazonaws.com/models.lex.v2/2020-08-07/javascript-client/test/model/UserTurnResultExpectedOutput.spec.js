...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.UserTurnResultExpectedOutput();
  });
  ...
  describe('UserTurnResultExpectedOutput', function() {
    it('should create an instance of UserTurnResultExpectedOutput', function() {
      // uncomment below and update the code to test UserTurnResultExpectedOutput
      //var instance = new AmazonLexModelBuildingV2.UserTurnResultExpectedOutput();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.UserTurnResultExpectedOutput);
    });
