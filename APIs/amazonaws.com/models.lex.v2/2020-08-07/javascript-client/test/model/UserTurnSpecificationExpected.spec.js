...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.UserTurnSpecificationExpected();
  });
  ...
  describe('UserTurnSpecificationExpected', function() {
    it('should create an instance of UserTurnSpecificationExpected', function() {
      // uncomment below and update the code to test UserTurnSpecificationExpected
      //var instance = new AmazonLexModelBuildingV2.UserTurnSpecificationExpected();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.UserTurnSpecificationExpected);
    });
