...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.UserTurnOutputSpecification();
  });
  ...
  describe('UserTurnOutputSpecification', function() {
    it('should create an instance of UserTurnOutputSpecification', function() {
      // uncomment below and update the code to test UserTurnOutputSpecification
      //var instance = new AmazonLexModelBuildingV2.UserTurnOutputSpecification();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.UserTurnOutputSpecification);
    });
