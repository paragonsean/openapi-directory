...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListIntentStageMetricsRequest();
  });
  ...
  describe('ListIntentStageMetricsRequest', function() {
    it('should create an instance of ListIntentStageMetricsRequest', function() {
      // uncomment below and update the code to test ListIntentStageMetricsRequest
      //var instance = new AmazonLexModelBuildingV2.ListIntentStageMetricsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListIntentStageMetricsRequest);
    });
