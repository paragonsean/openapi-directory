...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListSlotsRequest();
  });
  ...
  describe('ListSlotsRequest', function() {
    it('should create an instance of ListSlotsRequest', function() {
      // uncomment below and update the code to test ListSlotsRequest
      //var instance = new AmazonLexModelBuildingV2.ListSlotsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListSlotsRequest);
    });
