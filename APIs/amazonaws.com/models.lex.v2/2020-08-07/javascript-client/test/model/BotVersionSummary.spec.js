...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.BotVersionSummary();
  });
  ...
  describe('BotVersionSummary', function() {
    it('should create an instance of BotVersionSummary', function() {
      // uncomment below and update the code to test BotVersionSummary
      //var instance = new AmazonLexModelBuildingV2.BotVersionSummary();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.BotVersionSummary);
    });
