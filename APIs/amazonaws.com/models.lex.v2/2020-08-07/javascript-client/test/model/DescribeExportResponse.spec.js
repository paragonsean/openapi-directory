...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.DescribeExportResponse();
  });
  ...
  describe('DescribeExportResponse', function() {
    it('should create an instance of DescribeExportResponse', function() {
      // uncomment below and update the code to test DescribeExportResponse
      //var instance = new AmazonLexModelBuildingV2.DescribeExportResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.DescribeExportResponse);
    });
