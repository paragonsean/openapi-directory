...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListSessionAnalyticsDataRequest();
  });
  ...
  describe('ListSessionAnalyticsDataRequest', function() {
    it('should create an instance of ListSessionAnalyticsDataRequest', function() {
      // uncomment below and update the code to test ListSessionAnalyticsDataRequest
      //var instance = new AmazonLexModelBuildingV2.ListSessionAnalyticsDataRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListSessionAnalyticsDataRequest);
    });
