...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.Principal();
  });
  ...
  describe('Principal', function() {
    it('should create an instance of Principal', function() {
      ...
      //var instance = new AmazonLexModelBuildingV2.Principal();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.Principal);
    });
