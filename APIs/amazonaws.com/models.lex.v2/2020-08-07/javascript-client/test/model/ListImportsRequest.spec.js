...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListImportsRequest();
  });
  ...
  describe('ListImportsRequest', function() {
    it('should create an instance of ListImportsRequest', function() {
      ...
      //var instance = new AmazonLexModelBuildingV2.ListImportsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListImportsRequest);
    });
