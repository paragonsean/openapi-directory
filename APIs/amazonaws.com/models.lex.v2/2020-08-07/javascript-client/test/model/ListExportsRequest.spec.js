...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListExportsRequest();
  });
  ...
  describe('ListExportsRequest', function() {
    it('should create an instance of ListExportsRequest', function() {
      ...
      //var instance = new AmazonLexModelBuildingV2.ListExportsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListExportsRequest);
    });
