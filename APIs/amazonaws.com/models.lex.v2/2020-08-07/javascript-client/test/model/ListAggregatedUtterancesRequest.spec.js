...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListAggregatedUtterancesRequest();
  });
  ...
  describe('ListAggregatedUtterancesRequest', function() {
    it('should create an instance of ListAggregatedUtterancesRequest', function() {
      // uncomment below and update the code to test ListAggregatedUtterancesRequest
      //var instance = new AmazonLexModelBuildingV2.ListAggregatedUtterancesRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListAggregatedUtterancesRequest);
    });
