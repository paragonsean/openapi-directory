...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.SlotTypeValue();
  });
  ...
  describe('SlotTypeValue', function() {
    it('should create an instance of SlotTypeValue', function() {
      // uncomment below and update the code to test SlotTypeValue
      //var instance = new AmazonLexModelBuildingV2.SlotTypeValue();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.SlotTypeValue);
    });
