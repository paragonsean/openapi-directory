...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.DeleteImportResponse();
  });
  ...
  describe('DeleteImportResponse', function() {
    it('should create an instance of DeleteImportResponse', function() {
      // uncomment below and update the code to test DeleteImportResponse
      //var instance = new AmazonLexModelBuildingV2.DeleteImportResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.DeleteImportResponse);
    });
