...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.BotAliasSummary();
  });
  ...
  describe('BotAliasSummary', function() {
    it('should create an instance of BotAliasSummary', function() {
      // uncomment below and update the code to test BotAliasSummary
      //var instance = new AmazonLexModelBuildingV2.BotAliasSummary();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.BotAliasSummary);
    });
