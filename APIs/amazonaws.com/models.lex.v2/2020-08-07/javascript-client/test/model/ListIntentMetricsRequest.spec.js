...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListIntentMetricsRequest();
  });
  ...
  describe('ListIntentMetricsRequest', function() {
    it('should create an instance of ListIntentMetricsRequest', function() {
      // uncomment below and update the code to test ListIntentMetricsRequest
      //var instance = new AmazonLexModelBuildingV2.ListIntentMetricsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListIntentMetricsRequest);
    });
