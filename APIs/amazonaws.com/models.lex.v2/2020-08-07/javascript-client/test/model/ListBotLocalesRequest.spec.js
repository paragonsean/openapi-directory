...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListBotLocalesRequest();
  });
  ...
  describe('ListBotLocalesRequest', function() {
    it('should create an instance of ListBotLocalesRequest', function() {
      // uncomment below and update the code to test ListBotLocalesRequest
      //var instance = new AmazonLexModelBuildingV2.ListBotLocalesRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListBotLocalesRequest);
    });
