...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListTestSetsRequest();
  });
  ...
  describe('ListTestSetsRequest', function() {
    it('should create an instance of ListTestSetsRequest', function() {
      // uncomment below and update the code to test ListTestSetsRequest
      //var instance = new AmazonLexModelBuildingV2.ListTestSetsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListTestSetsRequest);
    });
