...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListBuiltInSlotTypesRequest();
  });
  ...
  describe('ListBuiltInSlotTypesRequest', function() {
    it('should create an instance of ListBuiltInSlotTypesRequest', function() {
      // uncomment below and update the code to test ListBuiltInSlotTypesRequest
      //var instance = new AmazonLexModelBuildingV2.ListBuiltInSlotTypesRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListBuiltInSlotTypesRequest);
    });
