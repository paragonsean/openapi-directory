...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListTestExecutionsRequest();
  });
  ...
  describe('ListTestExecutionsRequest', function() {
    it('should create an instance of ListTestExecutionsRequest', function() {
      // uncomment below and update the code to test ListTestExecutionsRequest
      //var instance = new AmazonLexModelBuildingV2.ListTestExecutionsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListTestExecutionsRequest);
    });
