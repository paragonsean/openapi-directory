...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.UserTurnResultActualOutput();
  });
  ...
  describe('UserTurnResultActualOutput', function() {
    it('should create an instance of UserTurnResultActualOutput', function() {
      // uncomment below and update the code to test UserTurnResultActualOutput
      //var instance = new AmazonLexModelBuildingV2.UserTurnResultActualOutput();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.UserTurnResultActualOutput);
    });
