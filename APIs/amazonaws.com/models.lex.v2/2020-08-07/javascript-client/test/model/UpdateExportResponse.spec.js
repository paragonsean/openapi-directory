...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.UpdateExportResponse();
  });
  ...
  describe('UpdateExportResponse', function() {
    it('should create an instance of UpdateExportResponse', function() {
      // uncomment below and update the code to test UpdateExportResponse
      //var instance = new AmazonLexModelBuildingV2.UpdateExportResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.UpdateExportResponse);
    });
