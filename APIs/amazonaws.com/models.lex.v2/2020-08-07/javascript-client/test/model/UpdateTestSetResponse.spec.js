...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.UpdateTestSetResponse();
  });
  ...
  describe('UpdateTestSetResponse', function() {
    it('should create an instance of UpdateTestSetResponse', function() {
      // uncomment below and update the code to test UpdateTestSetResponse
      //var instance = new AmazonLexModelBuildingV2.UpdateTestSetResponse();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.UpdateTestSetResponse);
    });
