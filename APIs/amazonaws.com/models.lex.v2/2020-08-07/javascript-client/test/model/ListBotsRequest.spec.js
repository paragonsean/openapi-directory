...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListBotsRequest();
  });
  ...
  describe('ListBotsRequest', function() {
    it('should create an instance of ListBotsRequest', function() {
      // uncomment below and update the code to test ListBotsRequest
      //var instance = new AmazonLexModelBuildingV2.ListBotsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListBotsRequest);
    });
