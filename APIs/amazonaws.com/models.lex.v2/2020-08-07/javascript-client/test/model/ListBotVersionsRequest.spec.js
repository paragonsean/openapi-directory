...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ListBotVersionsRequest();
  });
  ...
  describe('ListBotVersionsRequest', function() {
    it('should create an instance of ListBotVersionsRequest', function() {
      // uncomment below and update the code to test ListBotVersionsRequest
      //var instance = new AmazonLexModelBuildingV2.ListBotVersionsRequest();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ListBotVersionsRequest);
    });
