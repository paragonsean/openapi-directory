...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonLexModelBuildingV2.ImageResponseCard();
  });
  ...
  describe('ImageResponseCard', function() {
    it('should create an instance of ImageResponseCard', function() {
      // uncomment below and update the code to test ImageResponseCard
      //var instance = new AmazonLexModelBuildingV2.ImageResponseCard();
      //expect(instance).to.be.a(AmazonLexModelBuildingV2.ImageResponseCard);
    });
