# AmazonLexModelBuildingV2.StartTestSetGenerationRequest
...
**testSetTags** | **{String: String}** | A list of tags to add to the test set. You can only add tags when you import/generate a new test set. You can&#39;t use the &lt;code&gt;UpdateTestSet&lt;/code&gt; operation to update tags. To update tags, use the &lt;code&gt;TagResource&lt;/code&gt; operation. | [optional] 
