# AmazonLexModelBuildingV2.UpdateSlotTypeRequest
...
**slotTypeValues** | [**[SlotTypeValue]**](SlotTypeValue.md) | A new list of values and their optional synonyms that define the values that the slot type can take. | [optional] 
