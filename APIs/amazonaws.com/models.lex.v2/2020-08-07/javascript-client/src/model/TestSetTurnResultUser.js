...
import UserTurnResult from './UserTurnResult';
...
/**
 * The TestSetTurnResultUser model module.
 * @module model/TestSetTurnResultUser
 * @version 2020-08-07
 */
class TestSetTurnResultUser {
    /**
     * Constructs a new <code>TestSetTurnResultUser</code>.
     * @alias module:model/TestSetTurnResultUser
     * @implements module:model/UserTurnResult
    ...
    constructor(input, expectedOutput) { 
        ...
        TestSetTurnResultUser.initialize(this, input, expectedOutput);
    }
    ...
    /**
     * Constructs a <code>TestSetTurnResultUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestSetTurnResultUser} obj Optional instance to populate.
     * @return {module:model/TestSetTurnResultUser} The populated <code>TestSetTurnResultUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestSetTurnResultUser();
            UserTurnResult.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>TestSetTurnResultUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestSetTurnResultUser</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestSetTurnResultUser.RequiredProperties) {
...
TestSetTurnResultUser.RequiredProperties = ["input", "expectedOutput"];

/**
 * @member {module:model/UserTurnResultInput} input
 */
TestSetTurnResultUser.prototype['input'] = undefined;

/**
 * @member {module:model/UserTurnResultExpectedOutput} expectedOutput
 */
TestSetTurnResultUser.prototype['expectedOutput'] = undefined;

/**
 * @member {module:model/UserTurnResultActualOutput} actualOutput
 */
TestSetTurnResultUser.prototype['actualOutput'] = undefined;

/**
 * @member {module:model/ExecutionErrorDetails} errorDetails
 */
TestSetTurnResultUser.prototype['errorDetails'] = undefined;

/**
 * @member {module:model/TestResultMatchStatus} endToEndResult
 */
TestSetTurnResultUser.prototype['endToEndResult'] = undefined;

/**
 * @member {module:model/TestResultMatchStatus} intentMatchResult
 */
TestSetTurnResultUser.prototype['intentMatchResult'] = undefined;

/**
 * @member {module:model/TestResultMatchStatus} slotMatchResult
 */
TestSetTurnResultUser.prototype['slotMatchResult'] = undefined;

/**
 * @member {module:model/TestResultMatchStatus} speechTranscriptionResult
 */
TestSetTurnResultUser.prototype['speechTranscriptionResult'] = undefined;

/**
 * @member {module:model/UserTurnResultConversationLevelResult} conversationLevelResult
 */
TestSetTurnResultUser.prototype['conversationLevelResult'] = undefined;


// Implement UserTurnResult interface:
/**
 * @member {module:model/UserTurnResultInput} input
 */
...
export default TestSetTurnResultUser;
