...
/**
 * The SlotCaptureSettingCaptureConditional model module.
 * @module model/SlotCaptureSettingCaptureConditional
 * @version 2020-08-07
 */
class SlotCaptureSettingCaptureConditional {
    /**
     * Constructs a new <code>SlotCaptureSettingCaptureConditional</code>.
     * @alias module:model/SlotCaptureSettingCaptureConditional
    ...
    constructor(active, conditionalBranches, defaultBranch) { 
        ...
        SlotCaptureSettingCaptureConditional.initialize(this, active, conditionalBranches, defaultBranch);
    }
    ...
    /**
     * Constructs a <code>SlotCaptureSettingCaptureConditional</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SlotCaptureSettingCaptureConditional} obj Optional instance to populate.
     * @return {module:model/SlotCaptureSettingCaptureConditional} The populated <code>SlotCaptureSettingCaptureConditional</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlotCaptureSettingCaptureConditional();
    ...
    /**
     * Validates the JSON data with respect to <code>SlotCaptureSettingCaptureConditional</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SlotCaptureSettingCaptureConditional</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SlotCaptureSettingCaptureConditional.RequiredProperties) {
...
SlotCaptureSettingCaptureConditional.RequiredProperties = ["active", "conditionalBranches", "defaultBranch"];

/**
 * @member {Boolean} active
 */
SlotCaptureSettingCaptureConditional.prototype['active'] = undefined;

/**
 * @member {Array} conditionalBranches
 */
SlotCaptureSettingCaptureConditional.prototype['conditionalBranches'] = undefined;

/**
 * @member {module:model/ConditionalSpecificationDefaultBranch} defaultBranch
 */
SlotCaptureSettingCaptureConditional.prototype['defaultBranch'] = undefined;
...
export default SlotCaptureSettingCaptureConditional;
