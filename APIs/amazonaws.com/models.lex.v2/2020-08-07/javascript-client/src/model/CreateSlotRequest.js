...
/**
 * The CreateSlotRequest model module.
 * @module model/CreateSlotRequest
 * @version 2020-08-07
 */
class CreateSlotRequest {
    /**
     * Constructs a new <code>CreateSlotRequest</code>.
     * @alias module:model/CreateSlotRequest
     * @param slotName {String} The name of the slot. Slot names must be unique within the bot that contains the slot.
    ...
    constructor(slotName, valueElicitationSetting) { 
        ...
        CreateSlotRequest.initialize(this, slotName, valueElicitationSetting);
    }
    ...
    /**
     * Constructs a <code>CreateSlotRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateSlotRequest} obj Optional instance to populate.
     * @return {module:model/CreateSlotRequest} The populated <code>CreateSlotRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateSlotRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSlotRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSlotRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSlotRequest.RequiredProperties) {
...
CreateSlotRequest.RequiredProperties = ["slotName", "valueElicitationSetting"];

/**
 * The name of the slot. Slot names must be unique within the bot that contains the slot.
 * @member {String} slotName
 */
CreateSlotRequest.prototype['slotName'] = undefined;

/**
 * A description of the slot. Use this to help identify the slot in lists.
 * @member {String} description
 */
CreateSlotRequest.prototype['description'] = undefined;

/**
 * The unique identifier for the slot type associated with this slot. The slot type determines the values that can be entered into the slot.
 * @member {String} slotTypeId
 */
CreateSlotRequest.prototype['slotTypeId'] = undefined;

/**
 * @member {module:model/CreateSlotRequestValueElicitationSetting} valueElicitationSetting
 */
CreateSlotRequest.prototype['valueElicitationSetting'] = undefined;

/**
 * @member {module:model/CreateSlotRequestObfuscationSetting} obfuscationSetting
 */
CreateSlotRequest.prototype['obfuscationSetting'] = undefined;

/**
 * @member {module:model/CreateSlotRequestMultipleValuesSetting} multipleValuesSetting
 */
CreateSlotRequest.prototype['multipleValuesSetting'] = undefined;

/**
 * @member {module:model/CreateSlotRequestSubSlotSetting} subSlotSetting
 */
CreateSlotRequest.prototype['subSlotSetting'] = undefined;
