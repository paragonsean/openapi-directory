...
/**
 * The SlotCaptureSettingFailureConditional model module.
 * @module model/SlotCaptureSettingFailureConditional
 * @version 2020-08-07
 */
class SlotCaptureSettingFailureConditional {
    /**
     * Constructs a new <code>SlotCaptureSettingFailureConditional</code>.
     * @alias module:model/SlotCaptureSettingFailureConditional
    ...
    constructor(active, conditionalBranches, defaultBranch) { 
        ...
        SlotCaptureSettingFailureConditional.initialize(this, active, conditionalBranches, defaultBranch);
    }
    ...
    /**
     * Constructs a <code>SlotCaptureSettingFailureConditional</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SlotCaptureSettingFailureConditional} obj Optional instance to populate.
     * @return {module:model/SlotCaptureSettingFailureConditional} The populated <code>SlotCaptureSettingFailureConditional</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlotCaptureSettingFailureConditional();
    ...
    /**
     * Validates the JSON data with respect to <code>SlotCaptureSettingFailureConditional</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SlotCaptureSettingFailureConditional</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SlotCaptureSettingFailureConditional.RequiredProperties) {
...
SlotCaptureSettingFailureConditional.RequiredProperties = ["active", "conditionalBranches", "defaultBranch"];

/**
 * @member {Boolean} active
 */
SlotCaptureSettingFailureConditional.prototype['active'] = undefined;

/**
 * @member {Array} conditionalBranches
 */
SlotCaptureSettingFailureConditional.prototype['conditionalBranches'] = undefined;

/**
 * @member {module:model/ConditionalSpecificationDefaultBranch} defaultBranch
 */
SlotCaptureSettingFailureConditional.prototype['defaultBranch'] = undefined;
...
export default SlotCaptureSettingFailureConditional;
