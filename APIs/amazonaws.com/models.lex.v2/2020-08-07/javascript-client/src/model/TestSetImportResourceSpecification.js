...
/**
 * The TestSetImportResourceSpecification model module.
 * @module model/TestSetImportResourceSpecification
 * @version 2020-08-07
 */
class TestSetImportResourceSpecification {
    /**
     * Constructs a new <code>TestSetImportResourceSpecification</code>.
     * Contains information about the test set that is imported.
     * @alias module:model/TestSetImportResourceSpecification
    ...
    /**
     * Constructs a <code>TestSetImportResourceSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TestSetImportResourceSpecification} obj Optional instance to populate.
     * @return {module:model/TestSetImportResourceSpecification} The populated <code>TestSetImportResourceSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestSetImportResourceSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>TestSetImportResourceSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestSetImportResourceSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TestSetImportResourceSpecification.RequiredProperties) {
...
TestSetImportResourceSpecification.RequiredProperties = ["testSetName", "roleArn", "storageLocation", "importInputLocation", "modality"];
...
export default TestSetImportResourceSpecification;
