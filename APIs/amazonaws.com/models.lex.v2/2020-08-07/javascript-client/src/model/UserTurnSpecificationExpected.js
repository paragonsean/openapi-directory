...
/**
 * The UserTurnSpecificationExpected model module.
 * @module model/UserTurnSpecificationExpected
 * @version 2020-08-07
 */
class UserTurnSpecificationExpected {
    /**
     * Constructs a new <code>UserTurnSpecificationExpected</code>.
     * @alias module:model/UserTurnSpecificationExpected
    ...
    constructor(intent) { 
        ...
        UserTurnSpecificationExpected.initialize(this, intent);
    }
    ...
    /**
     * Constructs a <code>UserTurnSpecificationExpected</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserTurnSpecificationExpected} obj Optional instance to populate.
     * @return {module:model/UserTurnSpecificationExpected} The populated <code>UserTurnSpecificationExpected</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserTurnSpecificationExpected();
    ...
    /**
     * Validates the JSON data with respect to <code>UserTurnSpecificationExpected</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserTurnSpecificationExpected</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserTurnSpecificationExpected.RequiredProperties) {
...
UserTurnSpecificationExpected.RequiredProperties = ["intent"];

/**
 * @member {module:model/UserTurnOutputSpecificationIntent} intent
 */
UserTurnSpecificationExpected.prototype['intent'] = undefined;

/**
 * @member {Array} activeContexts
 */
UserTurnSpecificationExpected.prototype['activeContexts'] = undefined;

/**
 * @member {String} transcript
 */
UserTurnSpecificationExpected.prototype['transcript'] = undefined;
...
export default UserTurnSpecificationExpected;
