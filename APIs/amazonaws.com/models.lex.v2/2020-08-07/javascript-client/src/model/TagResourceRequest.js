...
class TagResourceRequest {
     ...
     * @param tags {Object.<String, String>} A list of tag keys to add to the resource. If a tag key already exists, the existing value is replaced with the new value.
     */
    constructor(tags) { 
