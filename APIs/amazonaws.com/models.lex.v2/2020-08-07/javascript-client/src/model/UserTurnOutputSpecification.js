...
/**
 * The UserTurnOutputSpecification model module.
 * @module model/UserTurnOutputSpecification
 * @version 2020-08-07
 */
class UserTurnOutputSpecification {
    /**
     * Constructs a new <code>UserTurnOutputSpecification</code>.
     * Contains results that are output for the user turn by the test execution.
     * @alias module:model/UserTurnOutputSpecification
    ...
    /**
     * Constructs a <code>UserTurnOutputSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserTurnOutputSpecification} obj Optional instance to populate.
     * @return {module:model/UserTurnOutputSpecification} The populated <code>UserTurnOutputSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserTurnOutputSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>UserTurnOutputSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserTurnOutputSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserTurnOutputSpecification.RequiredProperties) {
...
UserTurnOutputSpecification.RequiredProperties = ["intent"];
...
export default UserTurnOutputSpecification;
