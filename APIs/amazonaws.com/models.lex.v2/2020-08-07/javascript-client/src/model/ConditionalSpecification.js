...
/**
 * The ConditionalSpecification model module.
 * @module model/ConditionalSpecification
 * @version 2020-08-07
 */
class ConditionalSpecification {
    /**
     * Constructs a new <code>ConditionalSpecification</code>.
     * Provides a list of conditional branches. Branches are evaluated in the order that they are entered in the list. The first branch with a condition that evaluates to true is executed. The last branch in the list is the default branch. The default branch should not have any condition expression. The default branch is executed if no other branch has a matching condition.
     * @alias module:model/ConditionalSpecification
    ...
    /**
     * Constructs a <code>ConditionalSpecification</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConditionalSpecification} obj Optional instance to populate.
     * @return {module:model/ConditionalSpecification} The populated <code>ConditionalSpecification</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConditionalSpecification();
    ...
    /**
     * Validates the JSON data with respect to <code>ConditionalSpecification</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConditionalSpecification</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConditionalSpecification.RequiredProperties) {
...
ConditionalSpecification.RequiredProperties = ["active", "conditionalBranches", "defaultBranch"];
...
export default ConditionalSpecification;
