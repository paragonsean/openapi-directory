...
/**
 * The UpdateSlotTypeRequestValueSelectionSetting model module.
 * @module model/UpdateSlotTypeRequestValueSelectionSetting
 * @version 2020-08-07
 */
class UpdateSlotTypeRequestValueSelectionSetting {
    /**
     * Constructs a new <code>UpdateSlotTypeRequestValueSelectionSetting</code>.
     * @alias module:model/UpdateSlotTypeRequestValueSelectionSetting
    ...
    constructor(resolutionStrategy) { 
        ...
        UpdateSlotTypeRequestValueSelectionSetting.initialize(this, resolutionStrategy);
    }
    ...
    /**
     * Constructs a <code>UpdateSlotTypeRequestValueSelectionSetting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateSlotTypeRequestValueSelectionSetting} obj Optional instance to populate.
     * @return {module:model/UpdateSlotTypeRequestValueSelectionSetting} The populated <code>UpdateSlotTypeRequestValueSelectionSetting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateSlotTypeRequestValueSelectionSetting();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateSlotTypeRequestValueSelectionSetting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateSlotTypeRequestValueSelectionSetting</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateSlotTypeRequestValueSelectionSetting.RequiredProperties) {
...
UpdateSlotTypeRequestValueSelectionSetting.RequiredProperties = ["resolutionStrategy"];

/**
 * @member {module:model/SlotValueResolutionStrategy} resolutionStrategy
 */
UpdateSlotTypeRequestValueSelectionSetting.prototype['resolutionStrategy'] = undefined;

/**
 * @member {module:model/CreateSlotTypeRequestValueSelectionSettingRegexFilter} regexFilter
 */
UpdateSlotTypeRequestValueSelectionSetting.prototype['regexFilter'] = undefined;

/**
 * @member {module:model/CreateSlotTypeRequestValueSelectionSettingAdvancedRecognitionSetting} advancedRecognitionSetting
 */
UpdateSlotTypeRequestValueSelectionSetting.prototype['advancedRecognitionSetting'] = undefined;
...
export default UpdateSlotTypeRequestValueSelectionSetting;
