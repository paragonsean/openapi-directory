...
/**
 * The SlotValueSelectionSetting model module.
 * @module model/SlotValueSelectionSetting
 * @version 2020-08-07
 */
class SlotValueSelectionSetting {
    /**
     * Constructs a new <code>SlotValueSelectionSetting</code>.
     * Contains settings used by Amazon Lex to select a slot value.
     * @alias module:model/SlotValueSelectionSetting
    ...
    /**
     * Constructs a <code>SlotValueSelectionSetting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SlotValueSelectionSetting} obj Optional instance to populate.
     * @return {module:model/SlotValueSelectionSetting} The populated <code>SlotValueSelectionSetting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SlotValueSelectionSetting();
    ...
    /**
     * Validates the JSON data with respect to <code>SlotValueSelectionSetting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SlotValueSelectionSetting</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SlotValueSelectionSetting.RequiredProperties) {
...
SlotValueSelectionSetting.RequiredProperties = ["resolutionStrategy"];
...
export default SlotValueSelectionSetting;
