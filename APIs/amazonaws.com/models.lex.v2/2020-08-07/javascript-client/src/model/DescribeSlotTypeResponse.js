...
import DescribeSlotTypeResponseValueSelectionSetting from './DescribeSlotTypeResponseValueSelectionSetting';
import ExternalSourceSetting from './ExternalSourceSetting';

/**
 * The DescribeSlotTypeResponse model module.
 * @module model/DescribeSlotTypeResponse
 * @version 2020-08-07
 */
class DescribeSlotTypeResponse {
    /**
     * Constructs a new <code>DescribeSlotTypeResponse</code>.
     * @alias module:model/DescribeSlotTypeResponse
     */
    constructor() { 
        
        DescribeSlotTypeResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DescribeSlotTypeResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeSlotTypeResponse} obj Optional instance to populate.
     * @return {module:model/DescribeSlotTypeResponse} The populated <code>DescribeSlotTypeResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeSlotTypeResponse();
            ...
            if (data.hasOwnProperty('valueSelectionSetting')) {
                obj['valueSelectionSetting'] = DescribeSlotTypeResponseValueSelectionSetting.constructFromObject(data['valueSelectionSetting']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeSlotTypeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeSlotTypeResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['valueSelectionSetting']) { // data not null
          DescribeSlotTypeResponseValueSelectionSetting.validateJSON(data['valueSelectionSetting']);
        }
 ...
 */
DescribeSlotTypeResponse.prototype['slotTypeId'] = undefined;

/**
 * @member {String} slotTypeName
 */
DescribeSlotTypeResponse.prototype['slotTypeName'] = undefined;

/**
 * @member {String} description
 */
DescribeSlotTypeResponse.prototype['description'] = undefined;

/**
 * @member {Array} slotTypeValues
 */
DescribeSlotTypeResponse.prototype['slotTypeValues'] = undefined;

/**
 * @member {module:model/DescribeSlotTypeResponseValueSelectionSetting} valueSelectionSetting
 */
DescribeSlotTypeResponse.prototype['valueSelectionSetting'] = undefined;

/**
 * @member {String} parentSlotTypeSignature
 */
DescribeSlotTypeResponse.prototype['parentSlotTypeSignature'] = undefined;

/**
 * @member {String} botId
 */
DescribeSlotTypeResponse.prototype['botId'] = undefined;

/**
 * @member {String} botVersion
 */
DescribeSlotTypeResponse.prototype['botVersion'] = undefined;

/**
 * @member {String} localeId
 */
DescribeSlotTypeResponse.prototype['localeId'] = undefined;

/**
 * @member {Date} creationDateTime
 */
DescribeSlotTypeResponse.prototype['creationDateTime'] = undefined;

/**
 * @member {Date} lastUpdatedDateTime
 */
DescribeSlotTypeResponse.prototype['lastUpdatedDateTime'] = undefined;

/**
 * @member {module:model/ExternalSourceSetting} externalSourceSetting
 */
DescribeSlotTypeResponse.prototype['externalSourceSetting'] = undefined;

/**
 * @member {module:model/CreateSlotTypeResponseCompositeSlotTypeSetting} compositeSlotTypeSetting
 */
DescribeSlotTypeResponse.prototype['compositeSlotTypeSetting'] = undefined;
...
export default DescribeSlotTypeResponse;
