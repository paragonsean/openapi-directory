...
public class CreateAddressRequestAddress {
  ...
  public CreateAddressRequestAddress() {
  }

  public CreateAddressRequestAddress addressId(String addressId) {
  ...
  public CreateAddressRequestAddress name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAddressRequestAddress company(String company) {
  ...
  public CreateAddressRequestAddress street1(String street1) {
  ...
  public CreateAddressRequestAddress street2(String street2) {
  ...
  public CreateAddressRequestAddress street3(String street3) {
  ...
  public CreateAddressRequestAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public CreateAddressRequestAddress stateOrProvince(String stateOrProvince) {
  ...
  public CreateAddressRequestAddress prefectureOrDistrict(String prefectureOrDistrict) {
  ...
  public CreateAddressRequestAddress landmark(String landmark) {
  ...
  public CreateAddressRequestAddress country(String country) {
  ...
  public CreateAddressRequestAddress postalCode(String postalCode) {
  ...
  public CreateAddressRequestAddress phoneNumber(String phoneNumber) {
  ...
  public CreateAddressRequestAddress isRestricted(Boolean isRestricted) {
  ...
  public CreateAddressRequestAddress type(AddressType type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAddressRequestAddress createAddressRequestAddress = (CreateAddressRequestAddress) o;
    return Objects.equals(this.addressId, createAddressRequestAddress.addressId) &&
        Objects.equals(this.name, createAddressRequestAddress.name) &&
        Objects.equals(this.company, createAddressRequestAddress.company) &&
        Objects.equals(this.street1, createAddressRequestAddress.street1) &&
        Objects.equals(this.street2, createAddressRequestAddress.street2) &&
        Objects.equals(this.street3, createAddressRequestAddress.street3) &&
        Objects.equals(this.city, createAddressRequestAddress.city) &&
        Objects.equals(this.stateOrProvince, createAddressRequestAddress.stateOrProvince) &&
        Objects.equals(this.prefectureOrDistrict, createAddressRequestAddress.prefectureOrDistrict) &&
        Objects.equals(this.landmark, createAddressRequestAddress.landmark) &&
        Objects.equals(this.country, createAddressRequestAddress.country) &&
        Objects.equals(this.postalCode, createAddressRequestAddress.postalCode) &&
        Objects.equals(this.phoneNumber, createAddressRequestAddress.phoneNumber) &&
        Objects.equals(this.isRestricted, createAddressRequestAddress.isRestricted) &&
        Objects.equals(this.type, createAddressRequestAddress.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAddressRequestAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAddressRequestAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAddressRequestAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAddressRequestAddress is not found in the empty JSON string", CreateAddressRequestAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAddressRequestAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAddressRequestAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAddressRequestAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAddressRequestAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAddressRequestAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAddressRequestAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAddressRequestAddress>() {
           @Override
           public void write(JsonWriter out, CreateAddressRequestAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAddressRequestAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAddressRequestAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAddressRequestAddress
   * @throws IOException if the JSON string is invalid with respect to CreateAddressRequestAddress
   */
  public static CreateAddressRequestAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAddressRequestAddress.class);
  }

  /**
   * Convert an instance of CreateAddressRequestAddress to an JSON string
   *
   * @return JSON string
   */
