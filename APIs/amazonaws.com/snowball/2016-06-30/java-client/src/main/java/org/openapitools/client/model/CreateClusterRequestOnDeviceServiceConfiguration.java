...
public class CreateClusterRequestOnDeviceServiceConfiguration {
  ...
  public CreateClusterRequestOnDeviceServiceConfiguration() {
  }

  public CreateClusterRequestOnDeviceServiceConfiguration nfSOnDeviceService(OnDeviceServiceConfigurationNFSOnDeviceService nfSOnDeviceService) {
  ...
  public CreateClusterRequestOnDeviceServiceConfiguration tgWOnDeviceService(OnDeviceServiceConfigurationTGWOnDeviceService tgWOnDeviceService) {
  ...
  public CreateClusterRequestOnDeviceServiceConfiguration ekSOnDeviceService(OnDeviceServiceConfigurationEKSOnDeviceService ekSOnDeviceService) {
  ...
  public CreateClusterRequestOnDeviceServiceConfiguration s3OnDeviceService(OnDeviceServiceConfigurationS3OnDeviceService s3OnDeviceService) {
  ...
  public boolean equals(Object o) {
    ...
    CreateClusterRequestOnDeviceServiceConfiguration createClusterRequestOnDeviceServiceConfiguration = (CreateClusterRequestOnDeviceServiceConfiguration) o;
    return Objects.equals(this.nfSOnDeviceService, createClusterRequestOnDeviceServiceConfiguration.nfSOnDeviceService) &&
        Objects.equals(this.tgWOnDeviceService, createClusterRequestOnDeviceServiceConfiguration.tgWOnDeviceService) &&
        Objects.equals(this.ekSOnDeviceService, createClusterRequestOnDeviceServiceConfiguration.ekSOnDeviceService) &&
        Objects.equals(this.s3OnDeviceService, createClusterRequestOnDeviceServiceConfiguration.s3OnDeviceService);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateClusterRequestOnDeviceServiceConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClusterRequestOnDeviceServiceConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClusterRequestOnDeviceServiceConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateClusterRequestOnDeviceServiceConfiguration is not found in the empty JSON string", CreateClusterRequestOnDeviceServiceConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClusterRequestOnDeviceServiceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateClusterRequestOnDeviceServiceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClusterRequestOnDeviceServiceConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClusterRequestOnDeviceServiceConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClusterRequestOnDeviceServiceConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClusterRequestOnDeviceServiceConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClusterRequestOnDeviceServiceConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateClusterRequestOnDeviceServiceConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClusterRequestOnDeviceServiceConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClusterRequestOnDeviceServiceConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClusterRequestOnDeviceServiceConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateClusterRequestOnDeviceServiceConfiguration
   */
  public static CreateClusterRequestOnDeviceServiceConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClusterRequestOnDeviceServiceConfiguration.class);
  }

  /**
   * Convert an instance of CreateClusterRequestOnDeviceServiceConfiguration to an JSON string
   *
   * @return JSON string
   */
