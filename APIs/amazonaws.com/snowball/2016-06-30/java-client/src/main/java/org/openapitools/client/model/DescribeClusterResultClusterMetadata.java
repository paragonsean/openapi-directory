...
public class DescribeClusterResultClusterMetadata {
  ...
  public DescribeClusterResultClusterMetadata() {
  }

  public DescribeClusterResultClusterMetadata clusterId(String clusterId) {
  ...
  public DescribeClusterResultClusterMetadata description(String description) {
  ...
  public DescribeClusterResultClusterMetadata kmsKeyARN(String kmsKeyARN) {
  ...
  public DescribeClusterResultClusterMetadata roleARN(String roleARN) {
  ...
  public DescribeClusterResultClusterMetadata clusterState(ClusterState clusterState) {
  ...
  public DescribeClusterResultClusterMetadata jobType(JobType jobType) {
  ...
  public DescribeClusterResultClusterMetadata snowballType(SnowballType snowballType) {
  ...
  public DescribeClusterResultClusterMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeClusterResultClusterMetadata resources(ClusterMetadataResources resources) {
  ...
  public DescribeClusterResultClusterMetadata addressId(String addressId) {
  ...
  public DescribeClusterResultClusterMetadata shippingOption(ShippingOption shippingOption) {
  ...
  public DescribeClusterResultClusterMetadata notification(CreateClusterRequestNotification notification) {
  ...
  public DescribeClusterResultClusterMetadata forwardingAddressId(String forwardingAddressId) {
  ...
  public DescribeClusterResultClusterMetadata taxDocuments(CreateClusterRequestTaxDocuments taxDocuments) {
  ...
  public DescribeClusterResultClusterMetadata onDeviceServiceConfiguration(ClusterMetadataOnDeviceServiceConfiguration onDeviceServiceConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeClusterResultClusterMetadata describeClusterResultClusterMetadata = (DescribeClusterResultClusterMetadata) o;
    return Objects.equals(this.clusterId, describeClusterResultClusterMetadata.clusterId) &&
        Objects.equals(this.description, describeClusterResultClusterMetadata.description) &&
        Objects.equals(this.kmsKeyARN, describeClusterResultClusterMetadata.kmsKeyARN) &&
        Objects.equals(this.roleARN, describeClusterResultClusterMetadata.roleARN) &&
        Objects.equals(this.clusterState, describeClusterResultClusterMetadata.clusterState) &&
        Objects.equals(this.jobType, describeClusterResultClusterMetadata.jobType) &&
        Objects.equals(this.snowballType, describeClusterResultClusterMetadata.snowballType) &&
        Objects.equals(this.creationDate, describeClusterResultClusterMetadata.creationDate) &&
        Objects.equals(this.resources, describeClusterResultClusterMetadata.resources) &&
        Objects.equals(this.addressId, describeClusterResultClusterMetadata.addressId) &&
        Objects.equals(this.shippingOption, describeClusterResultClusterMetadata.shippingOption) &&
        Objects.equals(this.notification, describeClusterResultClusterMetadata.notification) &&
        Objects.equals(this.forwardingAddressId, describeClusterResultClusterMetadata.forwardingAddressId) &&
        Objects.equals(this.taxDocuments, describeClusterResultClusterMetadata.taxDocuments) &&
        Objects.equals(this.onDeviceServiceConfiguration, describeClusterResultClusterMetadata.onDeviceServiceConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeClusterResultClusterMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeClusterResultClusterMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeClusterResultClusterMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeClusterResultClusterMetadata is not found in the empty JSON string", DescribeClusterResultClusterMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeClusterResultClusterMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeClusterResultClusterMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeClusterResultClusterMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeClusterResultClusterMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeClusterResultClusterMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeClusterResultClusterMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeClusterResultClusterMetadata>() {
           @Override
           public void write(JsonWriter out, DescribeClusterResultClusterMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeClusterResultClusterMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeClusterResultClusterMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeClusterResultClusterMetadata
   * @throws IOException if the JSON string is invalid with respect to DescribeClusterResultClusterMetadata
   */
  public static DescribeClusterResultClusterMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeClusterResultClusterMetadata.class);
  }

  /**
   * Convert an instance of DescribeClusterResultClusterMetadata to an JSON string
   *
   * @return JSON string
   */
