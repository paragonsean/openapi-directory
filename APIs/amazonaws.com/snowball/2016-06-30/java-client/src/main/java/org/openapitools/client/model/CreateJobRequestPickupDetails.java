...
public class CreateJobRequestPickupDetails {
  ...
  public CreateJobRequestPickupDetails() {
  }

  public CreateJobRequestPickupDetails name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateJobRequestPickupDetails phoneNumber(String phoneNumber) {
  ...
  public CreateJobRequestPickupDetails email(String email) {
    this.email = email;
    return this;
  }
  ...
  public CreateJobRequestPickupDetails identificationNumber(String identificationNumber) {
  ...
  public CreateJobRequestPickupDetails identificationExpirationDate(OffsetDateTime identificationExpirationDate) {
  ...
  public CreateJobRequestPickupDetails identificationIssuingOrg(String identificationIssuingOrg) {
  ...
  public CreateJobRequestPickupDetails devicePickupId(String devicePickupId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobRequestPickupDetails createJobRequestPickupDetails = (CreateJobRequestPickupDetails) o;
    return Objects.equals(this.name, createJobRequestPickupDetails.name) &&
        Objects.equals(this.phoneNumber, createJobRequestPickupDetails.phoneNumber) &&
        Objects.equals(this.email, createJobRequestPickupDetails.email) &&
        Objects.equals(this.identificationNumber, createJobRequestPickupDetails.identificationNumber) &&
        Objects.equals(this.identificationExpirationDate, createJobRequestPickupDetails.identificationExpirationDate) &&
        Objects.equals(this.identificationIssuingOrg, createJobRequestPickupDetails.identificationIssuingOrg) &&
        Objects.equals(this.devicePickupId, createJobRequestPickupDetails.devicePickupId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobRequestPickupDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobRequestPickupDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobRequestPickupDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobRequestPickupDetails is not found in the empty JSON string", CreateJobRequestPickupDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobRequestPickupDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobRequestPickupDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobRequestPickupDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobRequestPickupDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobRequestPickupDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobRequestPickupDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobRequestPickupDetails>() {
           @Override
           public void write(JsonWriter out, CreateJobRequestPickupDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobRequestPickupDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobRequestPickupDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobRequestPickupDetails
   * @throws IOException if the JSON string is invalid with respect to CreateJobRequestPickupDetails
   */
  public static CreateJobRequestPickupDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobRequestPickupDetails.class);
  }

  /**
   * Convert an instance of CreateJobRequestPickupDetails to an JSON string
   *
   * @return JSON string
   */
