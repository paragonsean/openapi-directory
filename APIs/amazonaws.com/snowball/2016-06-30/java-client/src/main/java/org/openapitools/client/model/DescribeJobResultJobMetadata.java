...
public class DescribeJobResultJobMetadata {
  ...
  public DescribeJobResultJobMetadata() {
  }

  public DescribeJobResultJobMetadata jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public DescribeJobResultJobMetadata jobState(JobState jobState) {
  ...
  public DescribeJobResultJobMetadata jobType(JobType jobType) {
  ...
  public DescribeJobResultJobMetadata snowballType(SnowballType snowballType) {
  ...
  public DescribeJobResultJobMetadata creationDate(OffsetDateTime creationDate) {
  ...
  public DescribeJobResultJobMetadata resources(JobMetadataResources resources) {
  ...
  public DescribeJobResultJobMetadata description(String description) {
  ...
  public DescribeJobResultJobMetadata kmsKeyARN(String kmsKeyARN) {
  ...
  public DescribeJobResultJobMetadata roleARN(String roleARN) {
  ...
  public DescribeJobResultJobMetadata addressId(String addressId) {
  ...
  public DescribeJobResultJobMetadata shippingDetails(JobMetadataShippingDetails shippingDetails) {
  ...
  public DescribeJobResultJobMetadata snowballCapacityPreference(SnowballCapacity snowballCapacityPreference) {
  ...
  public DescribeJobResultJobMetadata notification(JobMetadataNotification notification) {
  ...
  public DescribeJobResultJobMetadata dataTransferProgress(JobMetadataDataTransferProgress dataTransferProgress) {
  ...
  public DescribeJobResultJobMetadata jobLogInfo(JobMetadataJobLogInfo jobLogInfo) {
  ...
  public DescribeJobResultJobMetadata clusterId(String clusterId) {
  ...
  public DescribeJobResultJobMetadata forwardingAddressId(String forwardingAddressId) {
  ...
  public DescribeJobResultJobMetadata taxDocuments(JobMetadataTaxDocuments taxDocuments) {
  ...
  public DescribeJobResultJobMetadata deviceConfiguration(DeviceConfiguration deviceConfiguration) {
  ...
  public DescribeJobResultJobMetadata remoteManagement(RemoteManagement remoteManagement) {
  ...
  public DescribeJobResultJobMetadata longTermPricingId(String longTermPricingId) {
  ...
  public DescribeJobResultJobMetadata onDeviceServiceConfiguration(ClusterMetadataOnDeviceServiceConfiguration onDeviceServiceConfiguration) {
  ...
  public DescribeJobResultJobMetadata impactLevel(ImpactLevel impactLevel) {
  ...
  public DescribeJobResultJobMetadata pickupDetails(CreateJobRequestPickupDetails pickupDetails) {
  ...
  public DescribeJobResultJobMetadata snowballId(String snowballId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeJobResultJobMetadata describeJobResultJobMetadata = (DescribeJobResultJobMetadata) o;
    return Objects.equals(this.jobId, describeJobResultJobMetadata.jobId) &&
        Objects.equals(this.jobState, describeJobResultJobMetadata.jobState) &&
        Objects.equals(this.jobType, describeJobResultJobMetadata.jobType) &&
        Objects.equals(this.snowballType, describeJobResultJobMetadata.snowballType) &&
        Objects.equals(this.creationDate, describeJobResultJobMetadata.creationDate) &&
        Objects.equals(this.resources, describeJobResultJobMetadata.resources) &&
        Objects.equals(this.description, describeJobResultJobMetadata.description) &&
        Objects.equals(this.kmsKeyARN, describeJobResultJobMetadata.kmsKeyARN) &&
        Objects.equals(this.roleARN, describeJobResultJobMetadata.roleARN) &&
        Objects.equals(this.addressId, describeJobResultJobMetadata.addressId) &&
        Objects.equals(this.shippingDetails, describeJobResultJobMetadata.shippingDetails) &&
        Objects.equals(this.snowballCapacityPreference, describeJobResultJobMetadata.snowballCapacityPreference) &&
        Objects.equals(this.notification, describeJobResultJobMetadata.notification) &&
        Objects.equals(this.dataTransferProgress, describeJobResultJobMetadata.dataTransferProgress) &&
        Objects.equals(this.jobLogInfo, describeJobResultJobMetadata.jobLogInfo) &&
        Objects.equals(this.clusterId, describeJobResultJobMetadata.clusterId) &&
        Objects.equals(this.forwardingAddressId, describeJobResultJobMetadata.forwardingAddressId) &&
        Objects.equals(this.taxDocuments, describeJobResultJobMetadata.taxDocuments) &&
        Objects.equals(this.deviceConfiguration, describeJobResultJobMetadata.deviceConfiguration) &&
        Objects.equals(this.remoteManagement, describeJobResultJobMetadata.remoteManagement) &&
        Objects.equals(this.longTermPricingId, describeJobResultJobMetadata.longTermPricingId) &&
        Objects.equals(this.onDeviceServiceConfiguration, describeJobResultJobMetadata.onDeviceServiceConfiguration) &&
        Objects.equals(this.impactLevel, describeJobResultJobMetadata.impactLevel) &&
        Objects.equals(this.pickupDetails, describeJobResultJobMetadata.pickupDetails) &&
        Objects.equals(this.snowballId, describeJobResultJobMetadata.snowballId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeJobResultJobMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeJobResultJobMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeJobResultJobMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeJobResultJobMetadata is not found in the empty JSON string", DescribeJobResultJobMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeJobResultJobMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeJobResultJobMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeJobResultJobMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeJobResultJobMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeJobResultJobMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeJobResultJobMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeJobResultJobMetadata>() {
           @Override
           public void write(JsonWriter out, DescribeJobResultJobMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeJobResultJobMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeJobResultJobMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeJobResultJobMetadata
   * @throws IOException if the JSON string is invalid with respect to DescribeJobResultJobMetadata
   */
  public static DescribeJobResultJobMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeJobResultJobMetadata.class);
  }

  /**
   * Convert an instance of DescribeJobResultJobMetadata to an JSON string
   *
   * @return JSON string
   */
