...
public class ClusterMetadataOnDeviceServiceConfiguration {
  ...
  public ClusterMetadataOnDeviceServiceConfiguration() {
  }

  public ClusterMetadataOnDeviceServiceConfiguration nfSOnDeviceService(OnDeviceServiceConfigurationNFSOnDeviceService nfSOnDeviceService) {
  ...
  public ClusterMetadataOnDeviceServiceConfiguration tgWOnDeviceService(OnDeviceServiceConfigurationTGWOnDeviceService tgWOnDeviceService) {
  ...
  public ClusterMetadataOnDeviceServiceConfiguration ekSOnDeviceService(OnDeviceServiceConfigurationEKSOnDeviceService ekSOnDeviceService) {
  ...
  public ClusterMetadataOnDeviceServiceConfiguration s3OnDeviceService(OnDeviceServiceConfigurationS3OnDeviceService s3OnDeviceService) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterMetadataOnDeviceServiceConfiguration clusterMetadataOnDeviceServiceConfiguration = (ClusterMetadataOnDeviceServiceConfiguration) o;
    return Objects.equals(this.nfSOnDeviceService, clusterMetadataOnDeviceServiceConfiguration.nfSOnDeviceService) &&
        Objects.equals(this.tgWOnDeviceService, clusterMetadataOnDeviceServiceConfiguration.tgWOnDeviceService) &&
        Objects.equals(this.ekSOnDeviceService, clusterMetadataOnDeviceServiceConfiguration.ekSOnDeviceService) &&
        Objects.equals(this.s3OnDeviceService, clusterMetadataOnDeviceServiceConfiguration.s3OnDeviceService);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterMetadataOnDeviceServiceConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterMetadataOnDeviceServiceConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterMetadataOnDeviceServiceConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterMetadataOnDeviceServiceConfiguration is not found in the empty JSON string", ClusterMetadataOnDeviceServiceConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterMetadataOnDeviceServiceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterMetadataOnDeviceServiceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterMetadataOnDeviceServiceConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterMetadataOnDeviceServiceConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterMetadataOnDeviceServiceConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterMetadataOnDeviceServiceConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterMetadataOnDeviceServiceConfiguration>() {
           @Override
           public void write(JsonWriter out, ClusterMetadataOnDeviceServiceConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterMetadataOnDeviceServiceConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterMetadataOnDeviceServiceConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterMetadataOnDeviceServiceConfiguration
   * @throws IOException if the JSON string is invalid with respect to ClusterMetadataOnDeviceServiceConfiguration
   */
  public static ClusterMetadataOnDeviceServiceConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterMetadataOnDeviceServiceConfiguration.class);
  }

  /**
   * Convert an instance of ClusterMetadataOnDeviceServiceConfiguration to an JSON string
   *
   * @return JSON string
   */
