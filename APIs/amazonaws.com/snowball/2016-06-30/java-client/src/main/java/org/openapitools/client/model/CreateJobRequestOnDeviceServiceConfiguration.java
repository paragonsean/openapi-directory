...
public class CreateJobRequestOnDeviceServiceConfiguration {
  ...
  public CreateJobRequestOnDeviceServiceConfiguration() {
  }

  public CreateJobRequestOnDeviceServiceConfiguration nfSOnDeviceService(OnDeviceServiceConfigurationNFSOnDeviceService nfSOnDeviceService) {
  ...
  public CreateJobRequestOnDeviceServiceConfiguration tgWOnDeviceService(OnDeviceServiceConfigurationTGWOnDeviceService tgWOnDeviceService) {
  ...
  public CreateJobRequestOnDeviceServiceConfiguration ekSOnDeviceService(OnDeviceServiceConfigurationEKSOnDeviceService ekSOnDeviceService) {
  ...
  public CreateJobRequestOnDeviceServiceConfiguration s3OnDeviceService(OnDeviceServiceConfigurationS3OnDeviceService s3OnDeviceService) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobRequestOnDeviceServiceConfiguration createJobRequestOnDeviceServiceConfiguration = (CreateJobRequestOnDeviceServiceConfiguration) o;
    return Objects.equals(this.nfSOnDeviceService, createJobRequestOnDeviceServiceConfiguration.nfSOnDeviceService) &&
        Objects.equals(this.tgWOnDeviceService, createJobRequestOnDeviceServiceConfiguration.tgWOnDeviceService) &&
        Objects.equals(this.ekSOnDeviceService, createJobRequestOnDeviceServiceConfiguration.ekSOnDeviceService) &&
        Objects.equals(this.s3OnDeviceService, createJobRequestOnDeviceServiceConfiguration.s3OnDeviceService);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobRequestOnDeviceServiceConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobRequestOnDeviceServiceConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobRequestOnDeviceServiceConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobRequestOnDeviceServiceConfiguration is not found in the empty JSON string", CreateJobRequestOnDeviceServiceConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobRequestOnDeviceServiceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobRequestOnDeviceServiceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobRequestOnDeviceServiceConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobRequestOnDeviceServiceConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobRequestOnDeviceServiceConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobRequestOnDeviceServiceConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobRequestOnDeviceServiceConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateJobRequestOnDeviceServiceConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobRequestOnDeviceServiceConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobRequestOnDeviceServiceConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobRequestOnDeviceServiceConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateJobRequestOnDeviceServiceConfiguration
   */
  public static CreateJobRequestOnDeviceServiceConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobRequestOnDeviceServiceConfiguration.class);
  }

  /**
   * Convert an instance of CreateJobRequestOnDeviceServiceConfiguration to an JSON string
   *
   * @return JSON string
   */
