...
class CreateJobRequestOnDeviceServiceConfiguration(Model):
    ...
    def __init__(self, nfson_device_service: OnDeviceServiceConfigurationNFSOnDeviceService=None, tgwon_device_service: OnDeviceServiceConfigurationTGWOnDeviceService=None, ekson_device_service: OnDeviceServiceConfigurationEKSOnDeviceService=None, s3_on_device_service: OnDeviceServiceConfigurationS3OnDeviceService=None):
        """CreateJobRequestOnDeviceServiceConfiguration - a model defined in OpenAPI

        :param nfson_device_service: The nfson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
        :param tgwon_device_service: The tgwon_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
        :param ekson_device_service: The ekson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
        :param s3_on_device_service: The s3_on_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateJobRequestOnDeviceServiceConfiguration':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateJobRequest_OnDeviceServiceConfiguration of this CreateJobRequestOnDeviceServiceConfiguration.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def nfson_device_service(self):
        """Gets the nfson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.


        :return: The nfson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def nfson_device_service(self, nfson_device_service):
        """Sets the nfson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def tgwon_device_service(self):
        """Gets the tgwon_device_service of this CreateJobRequestOnDeviceServiceConfiguration.


        :return: The tgwon_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def tgwon_device_service(self, tgwon_device_service):
        """Sets the tgwon_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def ekson_device_service(self):
        """Gets the ekson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.


        :return: The ekson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def ekson_device_service(self, ekson_device_service):
        """Sets the ekson_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def s3_on_device_service(self):
        """Gets the s3_on_device_service of this CreateJobRequestOnDeviceServiceConfiguration.


        :return: The s3_on_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
    ...
    def s3_on_device_service(self, s3_on_device_service):
        """Sets the s3_on_device_service of this CreateJobRequestOnDeviceServiceConfiguration.
