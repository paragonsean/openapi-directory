...
class JobResource(Model):
    ...
    def __init__(self, s3_resources: List=None, lambda_resources: List=None, ec2_ami_resources: List=None):
        ...
        :param s3_resources: The s3_resources of this JobResource.
        :param lambda_resources: The lambda_resources of this JobResource.
        :param ec2_ami_resources: The ec2_ami_resources of this JobResource.
        """
        self.openapi_types = {
            's3_resources': List,
    ...
    def s3_resources(self):
        """Gets the s3_resources of this JobResource.


        :return: The s3_resources of this JobResource.
        :rtype: List
        """
    ...
    def s3_resources(self, s3_resources):
        """Sets the s3_resources of this JobResource.
    ...
    def lambda_resources(self):
        """Gets the lambda_resources of this JobResource.


        :return: The lambda_resources of this JobResource.
        :rtype: List
        """
    ...
    def lambda_resources(self, lambda_resources):
        """Sets the lambda_resources of this JobResource.
    ...
    def ec2_ami_resources(self):
        """Gets the ec2_ami_resources of this JobResource.


        :return: The ec2_ami_resources of this JobResource.
        :rtype: List
        """
    ...
    def ec2_ami_resources(self, ec2_ami_resources):
        """Sets the ec2_ami_resources of this JobResource.
