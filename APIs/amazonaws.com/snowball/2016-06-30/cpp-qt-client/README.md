...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICancelClusterRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICancelClusterRequest Example::create(){
    OAICancelClusterRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::cancelClusterSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::cancelClusterSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICancelClusterRequest oai_cancel_cluster_request = create(); // OAICancelClusterRequest | 
      ...
      apiInstance.cancelCluster(x_amz_targetoai_cancel_cluster_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
