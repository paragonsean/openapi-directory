...
/*
 * OAINFSOnDeviceServiceConfiguration.h
 *
...
#ifndef OAINFSOnDeviceServiceConfiguration_H
#define OAINFSOnDeviceServiceConfiguration_H
...
class OAINFSOnDeviceServiceConfiguration : public OAIObject {
public:
    OAINFSOnDeviceServiceConfiguration();
    OAINFSOnDeviceServiceConfiguration(QString json);
    ~OAINFSOnDeviceServiceConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINFSOnDeviceServiceConfiguration)

#endif // OAINFSOnDeviceServiceConfiguration_H
