...
/*
 * OAIUpdateClusterRequest_Notification.h
 *
 * 
 */

#ifndef OAIUpdateClusterRequest_Notification_H
#define OAIUpdateClusterRequest_Notification_H
...
class OAIUpdateClusterRequest_Notification : public OAIObject {
public:
    OAIUpdateClusterRequest_Notification();
    OAIUpdateClusterRequest_Notification(QString json);
    ~OAIUpdateClusterRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateClusterRequest_Notification)

#endif // OAIUpdateClusterRequest_Notification_H
