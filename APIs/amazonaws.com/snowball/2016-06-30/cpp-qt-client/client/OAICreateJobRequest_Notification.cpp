...
OAICreateJobRequest_Notification::OAICreateJobRequest_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateJobRequest_Notification::OAICreateJobRequest_Notification() {
    this->initializeModel();
}

OAICreateJobRequest_Notification::~OAICreateJobRequest_Notification() {}

void OAICreateJobRequest_Notification::initializeModel() {
...
void OAICreateJobRequest_Notification::fromJson(QString jsonString) {
...
void OAICreateJobRequest_Notification::fromJsonObject(QJsonObject json) {
...
QString OAICreateJobRequest_Notification::asJson() const {
...
QJsonObject OAICreateJobRequest_Notification::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateJobRequest_Notification::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAICreateJobRequest_Notification::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAICreateJobRequest_Notification::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAICreateJobRequest_Notification::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QList OAICreateJobRequest_Notification::getJobStatesToNotify() const {
    return m_job_states_to_notify;
}
void OAICreateJobRequest_Notification::setJobStatesToNotify(const QList &job_states_to_notify) {
    m_job_states_to_notify = job_states_to_notify;
    m_job_states_to_notify_isSet = true;
}

bool OAICreateJobRequest_Notification::is_job_states_to_notify_Set() const{
    return m_job_states_to_notify_isSet;
}

bool OAICreateJobRequest_Notification::is_job_states_to_notify_Valid() const{
    return m_job_states_to_notify_isValid;
}

bool OAICreateJobRequest_Notification::getNotifyAll() const {
    return m_notify_all;
}
void OAICreateJobRequest_Notification::setNotifyAll(const bool &notify_all) {
    m_notify_all = notify_all;
    m_notify_all_isSet = true;
}

bool OAICreateJobRequest_Notification::is_notify_all_Set() const{
    return m_notify_all_isSet;
}

bool OAICreateJobRequest_Notification::is_notify_all_Valid() const{
    return m_notify_all_isValid;
}

QString OAICreateJobRequest_Notification::getDevicePickupSnsTopicArn() const {
    return m_device_pickup_sns_topic_arn;
}
void OAICreateJobRequest_Notification::setDevicePickupSnsTopicArn(const QString &device_pickup_sns_topic_arn) {
    m_device_pickup_sns_topic_arn = device_pickup_sns_topic_arn;
    m_device_pickup_sns_topic_arn_isSet = true;
}

bool OAICreateJobRequest_Notification::is_device_pickup_sns_topic_arn_Set() const{
    return m_device_pickup_sns_topic_arn_isSet;
}

bool OAICreateJobRequest_Notification::is_device_pickup_sns_topic_arn_Valid() const{
    return m_device_pickup_sns_topic_arn_isValid;
}

bool OAICreateJobRequest_Notification::isSet() const {
...
bool OAICreateJobRequest_Notification::isValid() const {
