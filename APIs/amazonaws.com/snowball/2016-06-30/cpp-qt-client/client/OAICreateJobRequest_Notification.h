...
/*
 * OAICreateJobRequest_Notification.h
 *
 * 
 */

#ifndef OAICreateJobRequest_Notification_H
#define OAICreateJobRequest_Notification_H
...
class OAICreateJobRequest_Notification : public OAIObject {
public:
    OAICreateJobRequest_Notification();
    OAICreateJobRequest_Notification(QString json);
    ~OAICreateJobRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateJobRequest_Notification)

#endif // OAICreateJobRequest_Notification_H
