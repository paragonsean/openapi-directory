...
/*
 * OAICreateClusterRequest_Notification.h
 *
 * 
 */

#ifndef OAICreateClusterRequest_Notification_H
#define OAICreateClusterRequest_Notification_H
...
class OAICreateClusterRequest_Notification : public OAIObject {
public:
    OAICreateClusterRequest_Notification();
    OAICreateClusterRequest_Notification(QString json);
    ~OAICreateClusterRequest_Notification() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterRequest_Notification)

#endif // OAICreateClusterRequest_Notification_H
