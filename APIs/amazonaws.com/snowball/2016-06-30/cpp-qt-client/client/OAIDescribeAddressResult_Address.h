...
/*
 * OAIDescribeAddressResult_Address.h
 *
 * 
 */

#ifndef OAIDescribeAddressResult_Address_H
#define OAIDescribeAddressResult_Address_H
...
class OAIDescribeAddressResult_Address : public OAIObject {
public:
    OAIDescribeAddressResult_Address();
    OAIDescribeAddressResult_Address(QString json);
    ~OAIDescribeAddressResult_Address() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeAddressResult_Address)

#endif // OAIDescribeAddressResult_Address_H
