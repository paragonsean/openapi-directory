...
OAIUpdateJobRequest_Resources::OAIUpdateJobRequest_Resources(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateJobRequest_Resources::OAIUpdateJobRequest_Resources() {
    this->initializeModel();
}

OAIUpdateJobRequest_Resources::~OAIUpdateJobRequest_Resources() {}

void OAIUpdateJobRequest_Resources::initializeModel() {
...
void OAIUpdateJobRequest_Resources::fromJson(QString jsonString) {
...
void OAIUpdateJobRequest_Resources::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateJobRequest_Resources::asJson() const {
...
QJsonObject OAIUpdateJobRequest_Resources::asJsonObject() const {
    QJsonObject obj;
...
QList OAIUpdateJobRequest_Resources::getS3Resources() const {
    return m_s3_resources;
}
void OAIUpdateJobRequest_Resources::setS3Resources(const QList &s3_resources) {
    m_s3_resources = s3_resources;
    m_s3_resources_isSet = true;
}

bool OAIUpdateJobRequest_Resources::is_s3_resources_Set() const{
    return m_s3_resources_isSet;
}

bool OAIUpdateJobRequest_Resources::is_s3_resources_Valid() const{
    return m_s3_resources_isValid;
}

QList OAIUpdateJobRequest_Resources::getLambdaResources() const {
    return m_lambda_resources;
}
void OAIUpdateJobRequest_Resources::setLambdaResources(const QList &lambda_resources) {
    m_lambda_resources = lambda_resources;
    m_lambda_resources_isSet = true;
}

bool OAIUpdateJobRequest_Resources::is_lambda_resources_Set() const{
    return m_lambda_resources_isSet;
}

bool OAIUpdateJobRequest_Resources::is_lambda_resources_Valid() const{
    return m_lambda_resources_isValid;
}

QList OAIUpdateJobRequest_Resources::getEc2AmiResources() const {
    return m_ec2_ami_resources;
}
void OAIUpdateJobRequest_Resources::setEc2AmiResources(const QList &ec2_ami_resources) {
    m_ec2_ami_resources = ec2_ami_resources;
    m_ec2_ami_resources_isSet = true;
}

bool OAIUpdateJobRequest_Resources::is_ec2_ami_resources_Set() const{
    return m_ec2_ami_resources_isSet;
}

bool OAIUpdateJobRequest_Resources::is_ec2_ami_resources_Valid() const{
    return m_ec2_ami_resources_isValid;
}

bool OAIUpdateJobRequest_Resources::isSet() const {
...
bool OAIUpdateJobRequest_Resources::isValid() const {
