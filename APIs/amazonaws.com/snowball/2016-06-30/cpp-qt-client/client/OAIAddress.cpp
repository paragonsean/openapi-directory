...
QString OAIAddress::getCompany() const {
    return m_company;
}
void OAIAddress::setCompany(const QString &company) {
    m_company = company;
    m_company_isSet = true;
}

bool OAIAddress::is_company_Set() const{
    return m_company_isSet;
}

bool OAIAddress::is_company_Valid() const{
...
QString OAIAddress::getStreet3() const {
    return m_street3;
}
void OAIAddress::setStreet3(const QString &street3) {
    m_street3 = street3;
    m_street3_isSet = true;
}

bool OAIAddress::is_street3_Set() const{
    return m_street3_isSet;
}

bool OAIAddress::is_street3_Valid() const{
...
QString OAIAddress::getPrefectureOrDistrict() const {
    return m_prefecture_or_district;
}
void OAIAddress::setPrefectureOrDistrict(const QString &prefecture_or_district) {
    m_prefecture_or_district = prefecture_or_district;
    m_prefecture_or_district_isSet = true;
}

bool OAIAddress::is_prefecture_or_district_Set() const{
    return m_prefecture_or_district_isSet;
}

bool OAIAddress::is_prefecture_or_district_Valid() const{
    return m_prefecture_or_district_isValid;
}

QString OAIAddress::getLandmark() const {
    return m_landmark;
}
void OAIAddress::setLandmark(const QString &landmark) {
    m_landmark = landmark;
    m_landmark_isSet = true;
}

bool OAIAddress::is_landmark_Set() const{
    return m_landmark_isSet;
}

bool OAIAddress::is_landmark_Valid() const{
...
bool OAIAddress::getIsRestricted() const {
    return m_is_restricted;
}
void OAIAddress::setIsRestricted(const bool &is_restricted) {
    m_is_restricted = is_restricted;
    m_is_restricted_isSet = true;
}

bool OAIAddress::is_is_restricted_Set() const{
    return m_is_restricted_isSet;
}

bool OAIAddress::is_is_restricted_Valid() const{
    return m_is_restricted_isValid;
}

OAIAddressType OAIAddress::getType() const {
    return m_type;
}
void OAIAddress::setType(const OAIAddressType &type) {
    m_type = type;
    m_type_isSet = true;
}
