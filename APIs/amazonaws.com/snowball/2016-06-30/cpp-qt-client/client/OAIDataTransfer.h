...
#ifndef OAIDataTransfer_H
#define OAIDataTransfer_H
...
class OAIDataTransfer : public OAIObject {
public:
    OAIDataTransfer();
    OAIDataTransfer(QString json);
    ~OAIDataTransfer() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataTransfer)

#endif // OAIDataTransfer_H
