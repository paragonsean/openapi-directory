...
OAIPickupDetails::OAIPickupDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPickupDetails::OAIPickupDetails() {
    this->initializeModel();
}

OAIPickupDetails::~OAIPickupDetails() {}

void OAIPickupDetails::initializeModel() {
...
void OAIPickupDetails::fromJson(QString jsonString) {
...
void OAIPickupDetails::fromJsonObject(QJsonObject json) {
...
QString OAIPickupDetails::asJson() const {
...
QJsonObject OAIPickupDetails::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIPickupDetails::getName() const {
    return m_name;
}
void OAIPickupDetails::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIPickupDetails::is_name_Set() const{
    return m_name_isSet;
}

bool OAIPickupDetails::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIPickupDetails::getPhoneNumber() const {
    return m_phone_number;
}
void OAIPickupDetails::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIPickupDetails::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIPickupDetails::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

QString OAIPickupDetails::getEmail() const {
    return m_email;
}
void OAIPickupDetails::setEmail(const QString &email) {
    m_email = email;
    m_email_isSet = true;
}

bool OAIPickupDetails::is_email_Set() const{
    return m_email_isSet;
}

bool OAIPickupDetails::is_email_Valid() const{
    return m_email_isValid;
}

QString OAIPickupDetails::getIdentificationNumber() const {
    return m_identification_number;
}
void OAIPickupDetails::setIdentificationNumber(const QString &identification_number) {
    m_identification_number = identification_number;
    m_identification_number_isSet = true;
}

bool OAIPickupDetails::is_identification_number_Set() const{
    return m_identification_number_isSet;
}

bool OAIPickupDetails::is_identification_number_Valid() const{
    return m_identification_number_isValid;
}

QDateTime OAIPickupDetails::getIdentificationExpirationDate() const {
    return m_identification_expiration_date;
}
void OAIPickupDetails::setIdentificationExpirationDate(const QDateTime &identification_expiration_date) {
    m_identification_expiration_date = identification_expiration_date;
    m_identification_expiration_date_isSet = true;
}

bool OAIPickupDetails::is_identification_expiration_date_Set() const{
    return m_identification_expiration_date_isSet;
}

bool OAIPickupDetails::is_identification_expiration_date_Valid() const{
    return m_identification_expiration_date_isValid;
}

QString OAIPickupDetails::getIdentificationIssuingOrg() const {
    return m_identification_issuing_org;
}
void OAIPickupDetails::setIdentificationIssuingOrg(const QString &identification_issuing_org) {
    m_identification_issuing_org = identification_issuing_org;
    m_identification_issuing_org_isSet = true;
}

bool OAIPickupDetails::is_identification_issuing_org_Set() const{
    return m_identification_issuing_org_isSet;
}

bool OAIPickupDetails::is_identification_issuing_org_Valid() const{
    return m_identification_issuing_org_isValid;
}

QString OAIPickupDetails::getDevicePickupId() const {
    return m_device_pickup_id;
}
void OAIPickupDetails::setDevicePickupId(const QString &device_pickup_id) {
    m_device_pickup_id = device_pickup_id;
    m_device_pickup_id_isSet = true;
}

bool OAIPickupDetails::is_device_pickup_id_Set() const{
    return m_device_pickup_id_isSet;
}

bool OAIPickupDetails::is_device_pickup_id_Valid() const{
    return m_device_pickup_id_isValid;
}

bool OAIPickupDetails::isSet() const {
...
bool OAIPickupDetails::isValid() const {
