...
OAIUpdateClusterRequest_Notification::OAIUpdateClusterRequest_Notification(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateClusterRequest_Notification::OAIUpdateClusterRequest_Notification() {
    this->initializeModel();
}

OAIUpdateClusterRequest_Notification::~OAIUpdateClusterRequest_Notification() {}

void OAIUpdateClusterRequest_Notification::initializeModel() {
...
void OAIUpdateClusterRequest_Notification::fromJson(QString jsonString) {
...
void OAIUpdateClusterRequest_Notification::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateClusterRequest_Notification::asJson() const {
...
QJsonObject OAIUpdateClusterRequest_Notification::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateClusterRequest_Notification::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIUpdateClusterRequest_Notification::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIUpdateClusterRequest_Notification::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIUpdateClusterRequest_Notification::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QList OAIUpdateClusterRequest_Notification::getJobStatesToNotify() const {
    return m_job_states_to_notify;
}
void OAIUpdateClusterRequest_Notification::setJobStatesToNotify(const QList &job_states_to_notify) {
    m_job_states_to_notify = job_states_to_notify;
    m_job_states_to_notify_isSet = true;
}

bool OAIUpdateClusterRequest_Notification::is_job_states_to_notify_Set() const{
    return m_job_states_to_notify_isSet;
}

bool OAIUpdateClusterRequest_Notification::is_job_states_to_notify_Valid() const{
    return m_job_states_to_notify_isValid;
}

bool OAIUpdateClusterRequest_Notification::getNotifyAll() const {
    return m_notify_all;
}
void OAIUpdateClusterRequest_Notification::setNotifyAll(const bool &notify_all) {
    m_notify_all = notify_all;
    m_notify_all_isSet = true;
}

bool OAIUpdateClusterRequest_Notification::is_notify_all_Set() const{
    return m_notify_all_isSet;
}

bool OAIUpdateClusterRequest_Notification::is_notify_all_Valid() const{
    return m_notify_all_isValid;
}

QString OAIUpdateClusterRequest_Notification::getDevicePickupSnsTopicArn() const {
    return m_device_pickup_sns_topic_arn;
}
void OAIUpdateClusterRequest_Notification::setDevicePickupSnsTopicArn(const QString &device_pickup_sns_topic_arn) {
    m_device_pickup_sns_topic_arn = device_pickup_sns_topic_arn;
    m_device_pickup_sns_topic_arn_isSet = true;
}

bool OAIUpdateClusterRequest_Notification::is_device_pickup_sns_topic_arn_Set() const{
    return m_device_pickup_sns_topic_arn_isSet;
}

bool OAIUpdateClusterRequest_Notification::is_device_pickup_sns_topic_arn_Valid() const{
    return m_device_pickup_sns_topic_arn_isValid;
}

bool OAIUpdateClusterRequest_Notification::isSet() const {
...
bool OAIUpdateClusterRequest_Notification::isValid() const {
