...
OAIJobState OAIJobMetadata::getJobState() const {
    return m_job_state;
}
void OAIJobMetadata::setJobState(const OAIJobState &job_state) {
    m_job_state = job_state;
    m_job_state_isSet = true;
}

bool OAIJobMetadata::is_job_state_Set() const{
    return m_job_state_isSet;
}

bool OAIJobMetadata::is_job_state_Valid() const{
    return m_job_state_isValid;
}

OAIJobType OAIJobMetadata::getJobType() const {
    return m_job_type;
}
void OAIJobMetadata::setJobType(const OAIJobType &job_type) {
    m_job_type = job_type;
    m_job_type_isSet = true;
}

bool OAIJobMetadata::is_job_type_Set() const{
    return m_job_type_isSet;
}

bool OAIJobMetadata::is_job_type_Valid() const{
    return m_job_type_isValid;
}

OAISnowballType OAIJobMetadata::getSnowballType() const {
    return m_snowball_type;
}
void OAIJobMetadata::setSnowballType(const OAISnowballType &snowball_type) {
    m_snowball_type = snowball_type;
    m_snowball_type_isSet = true;
}

bool OAIJobMetadata::is_snowball_type_Set() const{
    return m_snowball_type_isSet;
}

bool OAIJobMetadata::is_snowball_type_Valid() const{
    return m_snowball_type_isValid;
}

QDateTime OAIJobMetadata::getCreationDate() const {
    return m_creation_date;
}
void OAIJobMetadata::setCreationDate(const QDateTime &creation_date) {
    m_creation_date = creation_date;
    m_creation_date_isSet = true;
}

bool OAIJobMetadata::is_creation_date_Set() const{
    return m_creation_date_isSet;
}

bool OAIJobMetadata::is_creation_date_Valid() const{
    return m_creation_date_isValid;
}

OAIJobMetadata_Resources OAIJobMetadata::getResources() const {
    return m_resources;
}
void OAIJobMetadata::setResources(const OAIJobMetadata_Resources &resources) {
    m_resources = resources;
    m_resources_isSet = true;
}

bool OAIJobMetadata::is_resources_Set() const{
    return m_resources_isSet;
}

bool OAIJobMetadata::is_resources_Valid() const{
    return m_resources_isValid;
}

QString OAIJobMetadata::getDescription() const {
    return m_description;
}
void OAIJobMetadata::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIJobMetadata::is_description_Set() const{
    return m_description_isSet;
}

bool OAIJobMetadata::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIJobMetadata::getKmsKeyArn() const {
    return m_kms_key_arn;
}
void OAIJobMetadata::setKmsKeyArn(const QString &kms_key_arn) {
    m_kms_key_arn = kms_key_arn;
    m_kms_key_arn_isSet = true;
}

bool OAIJobMetadata::is_kms_key_arn_Set() const{
    return m_kms_key_arn_isSet;
}

bool OAIJobMetadata::is_kms_key_arn_Valid() const{
    return m_kms_key_arn_isValid;
}

QString OAIJobMetadata::getRoleArn() const {
    return m_role_arn;
}
void OAIJobMetadata::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIJobMetadata::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIJobMetadata::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

QString OAIJobMetadata::getAddressId() const {
    return m_address_id;
}
void OAIJobMetadata::setAddressId(const QString &address_id) {
    m_address_id = address_id;
    m_address_id_isSet = true;
}

bool OAIJobMetadata::is_address_id_Set() const{
    return m_address_id_isSet;
}

bool OAIJobMetadata::is_address_id_Valid() const{
    return m_address_id_isValid;
}

OAIJobMetadata_ShippingDetails OAIJobMetadata::getShippingDetails() const {
    return m_shipping_details;
}
void OAIJobMetadata::setShippingDetails(const OAIJobMetadata_ShippingDetails &shipping_details) {
    m_shipping_details = shipping_details;
    m_shipping_details_isSet = true;
}

bool OAIJobMetadata::is_shipping_details_Set() const{
    return m_shipping_details_isSet;
}

bool OAIJobMetadata::is_shipping_details_Valid() const{
    return m_shipping_details_isValid;
}

OAISnowballCapacity OAIJobMetadata::getSnowballCapacityPreference() const {
    return m_snowball_capacity_preference;
}
void OAIJobMetadata::setSnowballCapacityPreference(const OAISnowballCapacity &snowball_capacity_preference) {
    m_snowball_capacity_preference = snowball_capacity_preference;
    m_snowball_capacity_preference_isSet = true;
}

bool OAIJobMetadata::is_snowball_capacity_preference_Set() const{
    return m_snowball_capacity_preference_isSet;
}

bool OAIJobMetadata::is_snowball_capacity_preference_Valid() const{
    return m_snowball_capacity_preference_isValid;
}

OAIJobMetadata_Notification OAIJobMetadata::getNotification() const {
    return m_notification;
}
void OAIJobMetadata::setNotification(const OAIJobMetadata_Notification &notification) {
    m_notification = notification;
    m_notification_isSet = true;
}

bool OAIJobMetadata::is_notification_Set() const{
    return m_notification_isSet;
}

bool OAIJobMetadata::is_notification_Valid() const{
    return m_notification_isValid;
}

OAIJobMetadata_DataTransferProgress OAIJobMetadata::getDataTransferProgress() const {
    return m_data_transfer_progress;
}
void OAIJobMetadata::setDataTransferProgress(const OAIJobMetadata_DataTransferProgress &data_transfer_progress) {
    m_data_transfer_progress = data_transfer_progress;
    m_data_transfer_progress_isSet = true;
}

bool OAIJobMetadata::is_data_transfer_progress_Set() const{
    return m_data_transfer_progress_isSet;
}

bool OAIJobMetadata::is_data_transfer_progress_Valid() const{
    return m_data_transfer_progress_isValid;
}

OAIJobMetadata_JobLogInfo OAIJobMetadata::getJobLogInfo() const {
    return m_job_log_info;
}
void OAIJobMetadata::setJobLogInfo(const OAIJobMetadata_JobLogInfo &job_log_info) {
    m_job_log_info = job_log_info;
    m_job_log_info_isSet = true;
}

bool OAIJobMetadata::is_job_log_info_Set() const{
    return m_job_log_info_isSet;
}

bool OAIJobMetadata::is_job_log_info_Valid() const{
    return m_job_log_info_isValid;
}

QString OAIJobMetadata::getClusterId() const {
    return m_cluster_id;
}
void OAIJobMetadata::setClusterId(const QString &cluster_id) {
    m_cluster_id = cluster_id;
    m_cluster_id_isSet = true;
}

bool OAIJobMetadata::is_cluster_id_Set() const{
    return m_cluster_id_isSet;
}

bool OAIJobMetadata::is_cluster_id_Valid() const{
    return m_cluster_id_isValid;
}

QString OAIJobMetadata::getForwardingAddressId() const {
    return m_forwarding_address_id;
}
void OAIJobMetadata::setForwardingAddressId(const QString &forwarding_address_id) {
    m_forwarding_address_id = forwarding_address_id;
    m_forwarding_address_id_isSet = true;
}

bool OAIJobMetadata::is_forwarding_address_id_Set() const{
    return m_forwarding_address_id_isSet;
}

bool OAIJobMetadata::is_forwarding_address_id_Valid() const{
    return m_forwarding_address_id_isValid;
}

OAIJobMetadata_TaxDocuments OAIJobMetadata::getTaxDocuments() const {
    return m_tax_documents;
}
void OAIJobMetadata::setTaxDocuments(const OAIJobMetadata_TaxDocuments &tax_documents) {
    m_tax_documents = tax_documents;
    m_tax_documents_isSet = true;
}

bool OAIJobMetadata::is_tax_documents_Set() const{
    return m_tax_documents_isSet;
}

bool OAIJobMetadata::is_tax_documents_Valid() const{
    return m_tax_documents_isValid;
}

OAIDeviceConfiguration OAIJobMetadata::getDeviceConfiguration() const {
    return m_device_configuration;
}
void OAIJobMetadata::setDeviceConfiguration(const OAIDeviceConfiguration &device_configuration) {
    m_device_configuration = device_configuration;
    m_device_configuration_isSet = true;
}

bool OAIJobMetadata::is_device_configuration_Set() const{
    return m_device_configuration_isSet;
}

bool OAIJobMetadata::is_device_configuration_Valid() const{
    return m_device_configuration_isValid;
}

OAIRemoteManagement OAIJobMetadata::getRemoteManagement() const {
    return m_remote_management;
}
void OAIJobMetadata::setRemoteManagement(const OAIRemoteManagement &remote_management) {
    m_remote_management = remote_management;
    m_remote_management_isSet = true;
}

bool OAIJobMetadata::is_remote_management_Set() const{
    return m_remote_management_isSet;
}

bool OAIJobMetadata::is_remote_management_Valid() const{
    return m_remote_management_isValid;
}

QString OAIJobMetadata::getLongTermPricingId() const {
    return m_long_term_pricing_id;
}
void OAIJobMetadata::setLongTermPricingId(const QString &long_term_pricing_id) {
    m_long_term_pricing_id = long_term_pricing_id;
    m_long_term_pricing_id_isSet = true;
}

bool OAIJobMetadata::is_long_term_pricing_id_Set() const{
    return m_long_term_pricing_id_isSet;
}

bool OAIJobMetadata::is_long_term_pricing_id_Valid() const{
    return m_long_term_pricing_id_isValid;
}

OAIClusterMetadata_OnDeviceServiceConfiguration OAIJobMetadata::getOnDeviceServiceConfiguration() const {
    return m_on_device_service_configuration;
}
void OAIJobMetadata::setOnDeviceServiceConfiguration(const OAIClusterMetadata_OnDeviceServiceConfiguration &on_device_service_configuration) {
    m_on_device_service_configuration = on_device_service_configuration;
    m_on_device_service_configuration_isSet = true;
}

bool OAIJobMetadata::is_on_device_service_configuration_Set() const{
    return m_on_device_service_configuration_isSet;
}

bool OAIJobMetadata::is_on_device_service_configuration_Valid() const{
    return m_on_device_service_configuration_isValid;
}

OAIImpactLevel OAIJobMetadata::getImpactLevel() const {
    return m_impact_level;
}
void OAIJobMetadata::setImpactLevel(const OAIImpactLevel &impact_level) {
    m_impact_level = impact_level;
    m_impact_level_isSet = true;
}

bool OAIJobMetadata::is_impact_level_Set() const{
    return m_impact_level_isSet;
}

bool OAIJobMetadata::is_impact_level_Valid() const{
    return m_impact_level_isValid;
}

OAICreateJobRequest_PickupDetails OAIJobMetadata::getPickupDetails() const {
    return m_pickup_details;
}
void OAIJobMetadata::setPickupDetails(const OAICreateJobRequest_PickupDetails &pickup_details) {
    m_pickup_details = pickup_details;
    m_pickup_details_isSet = true;
}

bool OAIJobMetadata::is_pickup_details_Set() const{
    return m_pickup_details_isSet;
}

bool OAIJobMetadata::is_pickup_details_Valid() const{
    return m_pickup_details_isValid;
}

QString OAIJobMetadata::getSnowballId() const {
    return m_snowball_id;
}
void OAIJobMetadata::setSnowballId(const QString &snowball_id) {
    m_snowball_id = snowball_id;
    m_snowball_id_isSet = true;
}

bool OAIJobMetadata::is_snowball_id_Set() const{
    return m_snowball_id_isSet;
}

bool OAIJobMetadata::is_snowball_id_Valid() const{
