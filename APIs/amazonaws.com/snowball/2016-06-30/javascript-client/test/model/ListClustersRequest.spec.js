...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.ListClustersRequest();
  });
  ...
  describe('ListClustersRequest', function() {
    it('should create an instance of ListClustersRequest', function() {
      // uncomment below and update the code to test ListClustersRequest
      //var instance = new AmazonImportExportSnowball.ListClustersRequest();
      //expect(instance).to.be.a(AmazonImportExportSnowball.ListClustersRequest);
    });
