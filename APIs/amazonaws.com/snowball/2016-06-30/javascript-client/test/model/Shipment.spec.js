...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.Shipment();
  });
  ...
  describe('Shipment', function() {
    it('should create an instance of Shipment', function() {
      ...
      //var instance = new AmazonImportExportSnowball.Shipment();
      //expect(instance).to.be.a(AmazonImportExportSnowball.Shipment);
    });
