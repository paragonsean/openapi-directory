...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.DependentService();
  });
  ...
  describe('DependentService', function() {
    it('should create an instance of DependentService', function() {
      // uncomment below and update the code to test DependentService
      //var instance = new AmazonImportExportSnowball.DependentService();
      //expect(instance).to.be.a(AmazonImportExportSnowball.DependentService);
    });
