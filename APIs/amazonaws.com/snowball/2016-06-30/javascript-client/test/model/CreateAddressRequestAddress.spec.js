...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.CreateAddressRequestAddress();
  });
  ...
  describe('CreateAddressRequestAddress', function() {
    it('should create an instance of CreateAddressRequestAddress', function() {
      // uncomment below and update the code to test CreateAddressRequestAddress
      //var instance = new AmazonImportExportSnowball.CreateAddressRequestAddress();
      //expect(instance).to.be.a(AmazonImportExportSnowball.CreateAddressRequestAddress);
    });
