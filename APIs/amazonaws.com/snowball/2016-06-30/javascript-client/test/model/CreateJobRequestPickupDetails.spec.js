...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.CreateJobRequestPickupDetails();
  });
  ...
  describe('CreateJobRequestPickupDetails', function() {
    it('should create an instance of CreateJobRequestPickupDetails', function() {
      // uncomment below and update the code to test CreateJobRequestPickupDetails
      //var instance = new AmazonImportExportSnowball.CreateJobRequestPickupDetails();
      //expect(instance).to.be.a(AmazonImportExportSnowball.CreateJobRequestPickupDetails);
    });
