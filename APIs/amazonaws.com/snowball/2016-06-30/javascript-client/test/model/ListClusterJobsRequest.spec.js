...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.ListClusterJobsRequest();
  });
  ...
  describe('ListClusterJobsRequest', function() {
    it('should create an instance of ListClusterJobsRequest', function() {
      // uncomment below and update the code to test ListClusterJobsRequest
      //var instance = new AmazonImportExportSnowball.ListClusterJobsRequest();
      //expect(instance).to.be.a(AmazonImportExportSnowball.ListClusterJobsRequest);
    });
