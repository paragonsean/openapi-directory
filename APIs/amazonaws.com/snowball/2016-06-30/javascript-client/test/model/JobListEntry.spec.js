...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonImportExportSnowball.JobListEntry();
  });
  ...
  describe('JobListEntry', function() {
    it('should create an instance of JobListEntry', function() {
      // uncomment below and update the code to test JobListEntry
      //var instance = new AmazonImportExportSnowball.JobListEntry();
      //expect(instance).to.be.a(AmazonImportExportSnowball.JobListEntry);
    });
