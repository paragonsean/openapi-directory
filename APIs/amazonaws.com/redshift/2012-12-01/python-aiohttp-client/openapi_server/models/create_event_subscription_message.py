...
class CreateEventSubscriptionMessage(Model):
    ...
    def __init__(self, subscription_name: str=None, sns_topic_arn: str=None, source_type: str=None, source_ids: List=None, event_categories: List=None, severity: str=None, enabled: bool=None, tags: List=None):
        ...
        :param severity: The severity of this CreateEventSubscriptionMessage.
    ...
    @property
    def severity(self):
        """Gets the severity of this CreateEventSubscriptionMessage.


        :return: The severity of this CreateEventSubscriptionMessage.
        :rtype: str
        """
    ...
    def severity(self, severity):
        """Sets the severity of this CreateEventSubscriptionMessage.
