...
class ReservedNodeConfigurationOption(Model):
    ...
    def __init__(self, source_reserved_node: ReservedNode=None, target_reserved_node_count: int=None, target_reserved_node_offering: ReservedNodeOffering=None):
        """ReservedNodeConfigurationOption - a model defined in OpenAPI

        :param source_reserved_node: The source_reserved_node of this ReservedNodeConfigurationOption.
        :param target_reserved_node_count: The target_reserved_node_count of this ReservedNodeConfigurationOption.
        :param target_reserved_node_offering: The target_reserved_node_offering of this ReservedNodeConfigurationOption.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ReservedNodeConfigurationOption':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ReservedNodeConfigurationOption of this ReservedNodeConfigurationOption.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def source_reserved_node(self):
        """Gets the source_reserved_node of this ReservedNodeConfigurationOption.


        :return: The source_reserved_node of this ReservedNodeConfigurationOption.
        :rtype: ReservedNode
        """
    ...
    def source_reserved_node(self, source_reserved_node):
        """Sets the source_reserved_node of this ReservedNodeConfigurationOption.
    ...
    def target_reserved_node_count(self):
        """Gets the target_reserved_node_count of this ReservedNodeConfigurationOption.


        :return: The target_reserved_node_count of this ReservedNodeConfigurationOption.
        :rtype: int
        """
    ...
    def target_reserved_node_count(self, target_reserved_node_count):
        """Sets the target_reserved_node_count of this ReservedNodeConfigurationOption.
    ...
    def target_reserved_node_offering(self):
        """Gets the target_reserved_node_offering of this ReservedNodeConfigurationOption.


        :return: The target_reserved_node_offering of this ReservedNodeConfigurationOption.
    ...
    def target_reserved_node_offering(self, target_reserved_node_offering):
        """Sets the target_reserved_node_offering of this ReservedNodeConfigurationOption.
