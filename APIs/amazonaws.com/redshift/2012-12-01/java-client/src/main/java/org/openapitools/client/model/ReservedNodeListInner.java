...
public class ReservedNodeListInner {
  ...
  public ReservedNodeListInner() {
  }

  public ReservedNodeListInner reservedNodeId(String reservedNodeId) {
  ...
  public ReservedNodeListInner reservedNodeOfferingId(String reservedNodeOfferingId) {
  ...
  public ReservedNodeListInner nodeType(String nodeType) {
  ...
  public ReservedNodeListInner startTime(OffsetDateTime startTime) {
  ...
  public ReservedNodeListInner duration(Integer duration) {
  ...
  public ReservedNodeListInner fixedPrice(Double fixedPrice) {
  ...
  public ReservedNodeListInner usagePrice(Double usagePrice) {
  ...
  public ReservedNodeListInner currencyCode(String currencyCode) {
  ...
  public ReservedNodeListInner nodeCount(Integer nodeCount) {
  ...
  public ReservedNodeListInner state(String state) {
    this.state = state;
    return this;
  }
  ...
  public ReservedNodeListInner offeringType(String offeringType) {
  ...
  public ReservedNodeListInner recurringCharges(List recurringCharges) {
  ...
  public ReservedNodeListInner reservedNodeOfferingType(ReservedNodeOfferingType reservedNodeOfferingType) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedNodeListInner reservedNodeListInner = (ReservedNodeListInner) o;
    return Objects.equals(this.reservedNodeId, reservedNodeListInner.reservedNodeId) &&
        Objects.equals(this.reservedNodeOfferingId, reservedNodeListInner.reservedNodeOfferingId) &&
        Objects.equals(this.nodeType, reservedNodeListInner.nodeType) &&
        Objects.equals(this.startTime, reservedNodeListInner.startTime) &&
        Objects.equals(this.duration, reservedNodeListInner.duration) &&
        Objects.equals(this.fixedPrice, reservedNodeListInner.fixedPrice) &&
        Objects.equals(this.usagePrice, reservedNodeListInner.usagePrice) &&
        Objects.equals(this.currencyCode, reservedNodeListInner.currencyCode) &&
        Objects.equals(this.nodeCount, reservedNodeListInner.nodeCount) &&
        Objects.equals(this.state, reservedNodeListInner.state) &&
        Objects.equals(this.offeringType, reservedNodeListInner.offeringType) &&
        Objects.equals(this.recurringCharges, reservedNodeListInner.recurringCharges) &&
        Objects.equals(this.reservedNodeOfferingType, reservedNodeListInner.reservedNodeOfferingType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservedNodeListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedNodeListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedNodeListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedNodeListInner is not found in the empty JSON string", ReservedNodeListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedNodeListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedNodeListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedNodeListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedNodeListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedNodeListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedNodeListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedNodeListInner>() {
           @Override
           public void write(JsonWriter out, ReservedNodeListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedNodeListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedNodeListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedNodeListInner
   * @throws IOException if the JSON string is invalid with respect to ReservedNodeListInner
   */
  public static ReservedNodeListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedNodeListInner.class);
  }

  /**
   * Convert an instance of ReservedNodeListInner to an JSON string
   *
   * @return JSON string
   */
