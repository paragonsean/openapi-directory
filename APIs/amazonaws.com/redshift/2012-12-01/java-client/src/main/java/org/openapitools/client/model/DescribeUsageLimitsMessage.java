...
public class DescribeUsageLimitsMessage {
  ...
  public DescribeUsageLimitsMessage usageLimitId(String usageLimitId) {
  ...
  public DescribeUsageLimitsMessage clusterIdentifier(String clusterIdentifier) {
  ...
  public DescribeUsageLimitsMessage featureType(UsageLimitFeatureType featureType) {
  ...
  public DescribeUsageLimitsMessage maxRecords(Integer maxRecords) {
  ...
  public DescribeUsageLimitsMessage marker(String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeUsageLimitsMessage tagKeys(List tagKeys) {
  ...
  public DescribeUsageLimitsMessage tagValues(List tagValues) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeUsageLimitsMessage describeUsageLimitsMessage = (DescribeUsageLimitsMessage) o;
    return Objects.equals(this.usageLimitId, describeUsageLimitsMessage.usageLimitId) &&
        Objects.equals(this.clusterIdentifier, describeUsageLimitsMessage.clusterIdentifier) &&
        Objects.equals(this.featureType, describeUsageLimitsMessage.featureType) &&
        Objects.equals(this.maxRecords, describeUsageLimitsMessage.maxRecords) &&
        Objects.equals(this.marker, describeUsageLimitsMessage.marker) &&
        Objects.equals(this.tagKeys, describeUsageLimitsMessage.tagKeys) &&
        Objects.equals(this.tagValues, describeUsageLimitsMessage.tagValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usageLimitId, clusterIdentifier, featureType, maxRecords, marker, tagKeys, tagValues);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeUsageLimitsMessage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeUsageLimitsMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeUsageLimitsMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeUsageLimitsMessage is not found in the empty JSON string", DescribeUsageLimitsMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeUsageLimitsMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeUsageLimitsMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeUsageLimitsMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeUsageLimitsMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeUsageLimitsMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeUsageLimitsMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeUsageLimitsMessage>() {
           @Override
           public void write(JsonWriter out, DescribeUsageLimitsMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeUsageLimitsMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeUsageLimitsMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeUsageLimitsMessage
   * @throws IOException if the JSON string is invalid with respect to DescribeUsageLimitsMessage
   */
  public static DescribeUsageLimitsMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeUsageLimitsMessage.class);
  }

  /**
   * Convert an instance of DescribeUsageLimitsMessage to an JSON string
   *
   * @return JSON string
   */
