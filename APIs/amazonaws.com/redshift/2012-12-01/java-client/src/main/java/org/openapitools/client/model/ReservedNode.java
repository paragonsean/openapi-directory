...
public class ReservedNode {
  ...
  public ReservedNode reservedNodeId(String reservedNodeId) {
  ...
  public ReservedNode reservedNodeOfferingId(String reservedNodeOfferingId) {
  ...
  public ReservedNode nodeType(String nodeType) {
  ...
  public ReservedNode startTime(OffsetDateTime startTime) {
  ...
  public ReservedNode duration(Integer duration) {
  ...
  public ReservedNode fixedPrice(Double fixedPrice) {
  ...
  public ReservedNode usagePrice(Double usagePrice) {
  ...
  public ReservedNode currencyCode(String currencyCode) {
  ...
  public ReservedNode nodeCount(Integer nodeCount) {
  ...
  public ReservedNode state(String state) {
    this.state = state;
    return this;
  }
  ...
  public ReservedNode offeringType(String offeringType) {
  ...
  public ReservedNode recurringCharges(List recurringCharges) {
  ...
  public ReservedNode reservedNodeOfferingType(ReservedNodeOfferingType reservedNodeOfferingType) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedNode reservedNode = (ReservedNode) o;
    return Objects.equals(this.reservedNodeId, reservedNode.reservedNodeId) &&
        Objects.equals(this.reservedNodeOfferingId, reservedNode.reservedNodeOfferingId) &&
        Objects.equals(this.nodeType, reservedNode.nodeType) &&
        Objects.equals(this.startTime, reservedNode.startTime) &&
        Objects.equals(this.duration, reservedNode.duration) &&
        Objects.equals(this.fixedPrice, reservedNode.fixedPrice) &&
        Objects.equals(this.usagePrice, reservedNode.usagePrice) &&
        Objects.equals(this.currencyCode, reservedNode.currencyCode) &&
        Objects.equals(this.nodeCount, reservedNode.nodeCount) &&
        Objects.equals(this.state, reservedNode.state) &&
        Objects.equals(this.offeringType, reservedNode.offeringType) &&
        Objects.equals(this.recurringCharges, reservedNode.recurringCharges) &&
        Objects.equals(this.reservedNodeOfferingType, reservedNode.reservedNodeOfferingType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedNode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedNode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedNode is not found in the empty JSON string", ReservedNode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedNode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedNode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedNode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedNode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedNode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedNode.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedNode>() {
           @Override
           public void write(JsonWriter out, ReservedNode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedNode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedNode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedNode
   * @throws IOException if the JSON string is invalid with respect to ReservedNode
   */
  public static ReservedNode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedNode.class);
  }

  /**
   * Convert an instance of ReservedNode to an JSON string
   *
   * @return JSON string
   */
