...
public class ClusterRestoreStatus {
  ...
  public ClusterRestoreStatus status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ClusterRestoreStatus currentRestoreRateInMegaBytesPerSecond(Double currentRestoreRateInMegaBytesPerSecond) {
  ...
  public ClusterRestoreStatus snapshotSizeInMegaBytes(Integer snapshotSizeInMegaBytes) {
  ...
  public ClusterRestoreStatus progressInMegaBytes(Integer progressInMegaBytes) {
  ...
  public ClusterRestoreStatus elapsedTimeInSeconds(Integer elapsedTimeInSeconds) {
  ...
  public ClusterRestoreStatus estimatedTimeToCompletionInSeconds(Integer estimatedTimeToCompletionInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, clusterRestoreStatus.status) &&
        Objects.equals(this.currentRestoreRateInMegaBytesPerSecond, clusterRestoreStatus.currentRestoreRateInMegaBytesPerSecond) &&
        Objects.equals(this.snapshotSizeInMegaBytes, clusterRestoreStatus.snapshotSizeInMegaBytes) &&
        Objects.equals(this.progressInMegaBytes, clusterRestoreStatus.progressInMegaBytes) &&
        Objects.equals(this.elapsedTimeInSeconds, clusterRestoreStatus.elapsedTimeInSeconds) &&
        Objects.equals(this.estimatedTimeToCompletionInSeconds, clusterRestoreStatus.estimatedTimeToCompletionInSeconds);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterRestoreStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterRestoreStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterRestoreStatus is not found in the empty JSON string", ClusterRestoreStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterRestoreStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterRestoreStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterRestoreStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterRestoreStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterRestoreStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterRestoreStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterRestoreStatus>() {
           @Override
           public void write(JsonWriter out, ClusterRestoreStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterRestoreStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterRestoreStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterRestoreStatus
   * @throws IOException if the JSON string is invalid with respect to ClusterRestoreStatus
   */
  public static ClusterRestoreStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterRestoreStatus.class);
  }

  /**
   * Convert an instance of ClusterRestoreStatus to an JSON string
   *
   * @return JSON string
   */
