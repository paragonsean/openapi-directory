...
public class RevokeSnapshotAccessMessage {
  ...
  public RevokeSnapshotAccessMessage() {
  }

  public RevokeSnapshotAccessMessage snapshotIdentifier(String snapshotIdentifier) {
  ...
  public RevokeSnapshotAccessMessage snapshotArn(String snapshotArn) {
  ...
  public RevokeSnapshotAccessMessage snapshotClusterIdentifier(String snapshotClusterIdentifier) {
  ...
  public RevokeSnapshotAccessMessage accountWithRestoreAccess(String accountWithRestoreAccess) {
  ...
  public boolean equals(Object o) {
    ...
    RevokeSnapshotAccessMessage revokeSnapshotAccessMessage = (RevokeSnapshotAccessMessage) o;
    return Objects.equals(this.snapshotIdentifier, revokeSnapshotAccessMessage.snapshotIdentifier) &&
        Objects.equals(this.snapshotArn, revokeSnapshotAccessMessage.snapshotArn) &&
        Objects.equals(this.snapshotClusterIdentifier, revokeSnapshotAccessMessage.snapshotClusterIdentifier) &&
        Objects.equals(this.accountWithRestoreAccess, revokeSnapshotAccessMessage.accountWithRestoreAccess);
  }
  ...
  public String toString() {
    ...
    sb.append("class RevokeSnapshotAccessMessage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RevokeSnapshotAccessMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RevokeSnapshotAccessMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RevokeSnapshotAccessMessage is not found in the empty JSON string", RevokeSnapshotAccessMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RevokeSnapshotAccessMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RevokeSnapshotAccessMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RevokeSnapshotAccessMessage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RevokeSnapshotAccessMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RevokeSnapshotAccessMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RevokeSnapshotAccessMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RevokeSnapshotAccessMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<RevokeSnapshotAccessMessage>() {
           @Override
           public void write(JsonWriter out, RevokeSnapshotAccessMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RevokeSnapshotAccessMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RevokeSnapshotAccessMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RevokeSnapshotAccessMessage
   * @throws IOException if the JSON string is invalid with respect to RevokeSnapshotAccessMessage
   */
  public static RevokeSnapshotAccessMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RevokeSnapshotAccessMessage.class);
  }

  /**
   * Convert an instance of RevokeSnapshotAccessMessage to an JSON string
   *
   * @return JSON string
   */
