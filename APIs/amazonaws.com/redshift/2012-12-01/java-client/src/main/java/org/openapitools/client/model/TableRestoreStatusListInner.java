...
public class TableRestoreStatusListInner {
  ...
  public TableRestoreStatusListInner() {
  }

  public TableRestoreStatusListInner tableRestoreRequestId(String tableRestoreRequestId) {
  ...
  public TableRestoreStatusListInner status(TableRestoreStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public TableRestoreStatusListInner message(String message) {
  ...
  public TableRestoreStatusListInner requestTime(OffsetDateTime requestTime) {
  ...
  public TableRestoreStatusListInner progressInMegaBytes(Integer progressInMegaBytes) {
  ...
  public TableRestoreStatusListInner totalDataInMegaBytes(Integer totalDataInMegaBytes) {
  ...
  public TableRestoreStatusListInner clusterIdentifier(String clusterIdentifier) {
  ...
  public TableRestoreStatusListInner snapshotIdentifier(String snapshotIdentifier) {
  ...
  public TableRestoreStatusListInner sourceDatabaseName(String sourceDatabaseName) {
  ...
  public TableRestoreStatusListInner sourceSchemaName(String sourceSchemaName) {
  ...
  public TableRestoreStatusListInner sourceTableName(String sourceTableName) {
  ...
  public TableRestoreStatusListInner targetDatabaseName(String targetDatabaseName) {
  ...
  public TableRestoreStatusListInner targetSchemaName(String targetSchemaName) {
  ...
  public TableRestoreStatusListInner newTableName(String newTableName) {
  ...
  public boolean equals(Object o) {
    ...
    TableRestoreStatusListInner tableRestoreStatusListInner = (TableRestoreStatusListInner) o;
    return Objects.equals(this.tableRestoreRequestId, tableRestoreStatusListInner.tableRestoreRequestId) &&
        Objects.equals(this.status, tableRestoreStatusListInner.status) &&
        Objects.equals(this.message, tableRestoreStatusListInner.message) &&
        Objects.equals(this.requestTime, tableRestoreStatusListInner.requestTime) &&
        Objects.equals(this.progressInMegaBytes, tableRestoreStatusListInner.progressInMegaBytes) &&
        Objects.equals(this.totalDataInMegaBytes, tableRestoreStatusListInner.totalDataInMegaBytes) &&
        Objects.equals(this.clusterIdentifier, tableRestoreStatusListInner.clusterIdentifier) &&
        Objects.equals(this.snapshotIdentifier, tableRestoreStatusListInner.snapshotIdentifier) &&
        Objects.equals(this.sourceDatabaseName, tableRestoreStatusListInner.sourceDatabaseName) &&
        Objects.equals(this.sourceSchemaName, tableRestoreStatusListInner.sourceSchemaName) &&
        Objects.equals(this.sourceTableName, tableRestoreStatusListInner.sourceTableName) &&
        Objects.equals(this.targetDatabaseName, tableRestoreStatusListInner.targetDatabaseName) &&
        Objects.equals(this.targetSchemaName, tableRestoreStatusListInner.targetSchemaName) &&
        Objects.equals(this.newTableName, tableRestoreStatusListInner.newTableName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TableRestoreStatusListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TableRestoreStatusListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TableRestoreStatusListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TableRestoreStatusListInner is not found in the empty JSON string", TableRestoreStatusListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TableRestoreStatusListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TableRestoreStatusListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TableRestoreStatusListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TableRestoreStatusListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TableRestoreStatusListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TableRestoreStatusListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TableRestoreStatusListInner>() {
           @Override
           public void write(JsonWriter out, TableRestoreStatusListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TableRestoreStatusListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TableRestoreStatusListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TableRestoreStatusListInner
   * @throws IOException if the JSON string is invalid with respect to TableRestoreStatusListInner
   */
  public static TableRestoreStatusListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TableRestoreStatusListInner.class);
  }

  /**
   * Convert an instance of TableRestoreStatusListInner to an JSON string
   *
   * @return JSON string
   */
