...
public enum AuthorizationStatus {
  ...
  public static class Adapter extends TypeAdapter<AuthorizationStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuthorizationStatus enumeration) throws IOException {
    ...
    public AuthorizationStatus read(final JsonReader jsonReader) throws IOException {
      ...
      return AuthorizationStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuthorizationStatus.fromValue(value);
  }
}
