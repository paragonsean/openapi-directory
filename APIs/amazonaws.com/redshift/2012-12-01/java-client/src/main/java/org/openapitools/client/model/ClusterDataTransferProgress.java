...
public class ClusterDataTransferProgress {
  ...
  public ClusterDataTransferProgress() {
  }

  public ClusterDataTransferProgress status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ClusterDataTransferProgress currentRateInMegaBytesPerSecond(Double currentRateInMegaBytesPerSecond) {
  ...
  public ClusterDataTransferProgress totalDataInMegaBytes(Integer totalDataInMegaBytes) {
  ...
  public ClusterDataTransferProgress dataTransferredInMegaBytes(Integer dataTransferredInMegaBytes) {
  ...
  public ClusterDataTransferProgress estimatedTimeToCompletionInSeconds(Integer estimatedTimeToCompletionInSeconds) {
  ...
  public ClusterDataTransferProgress elapsedTimeInSeconds(Integer elapsedTimeInSeconds) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterDataTransferProgress clusterDataTransferProgress = (ClusterDataTransferProgress) o;
    return Objects.equals(this.status, clusterDataTransferProgress.status) &&
        Objects.equals(this.currentRateInMegaBytesPerSecond, clusterDataTransferProgress.currentRateInMegaBytesPerSecond) &&
        Objects.equals(this.totalDataInMegaBytes, clusterDataTransferProgress.totalDataInMegaBytes) &&
        Objects.equals(this.dataTransferredInMegaBytes, clusterDataTransferProgress.dataTransferredInMegaBytes) &&
        Objects.equals(this.estimatedTimeToCompletionInSeconds, clusterDataTransferProgress.estimatedTimeToCompletionInSeconds) &&
        Objects.equals(this.elapsedTimeInSeconds, clusterDataTransferProgress.elapsedTimeInSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterDataTransferProgress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterDataTransferProgress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterDataTransferProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterDataTransferProgress is not found in the empty JSON string", ClusterDataTransferProgress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterDataTransferProgress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterDataTransferProgress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterDataTransferProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterDataTransferProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterDataTransferProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterDataTransferProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterDataTransferProgress>() {
           @Override
           public void write(JsonWriter out, ClusterDataTransferProgress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterDataTransferProgress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterDataTransferProgress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterDataTransferProgress
   * @throws IOException if the JSON string is invalid with respect to ClusterDataTransferProgress
   */
  public static ClusterDataTransferProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterDataTransferProgress.class);
  }

  /**
   * Convert an instance of ClusterDataTransferProgress to an JSON string
   *
   * @return JSON string
   */
