...
public class ReservedNodeOffering {
  ...
  public ReservedNodeOffering reservedNodeOfferingId(String reservedNodeOfferingId) {
  ...
  public ReservedNodeOffering nodeType(String nodeType) {
  ...
  public ReservedNodeOffering duration(Integer duration) {
  ...
  public ReservedNodeOffering fixedPrice(Double fixedPrice) {
  ...
  public ReservedNodeOffering usagePrice(Double usagePrice) {
  ...
  public ReservedNodeOffering currencyCode(String currencyCode) {
  ...
  public ReservedNodeOffering offeringType(String offeringType) {
  ...
  public ReservedNodeOffering recurringCharges(List recurringCharges) {
  ...
  public ReservedNodeOffering reservedNodeOfferingType(ReservedNodeOfferingType reservedNodeOfferingType) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedNodeOffering reservedNodeOffering = (ReservedNodeOffering) o;
    return Objects.equals(this.reservedNodeOfferingId, reservedNodeOffering.reservedNodeOfferingId) &&
        Objects.equals(this.nodeType, reservedNodeOffering.nodeType) &&
        Objects.equals(this.duration, reservedNodeOffering.duration) &&
        Objects.equals(this.fixedPrice, reservedNodeOffering.fixedPrice) &&
        Objects.equals(this.usagePrice, reservedNodeOffering.usagePrice) &&
        Objects.equals(this.currencyCode, reservedNodeOffering.currencyCode) &&
        Objects.equals(this.offeringType, reservedNodeOffering.offeringType) &&
        Objects.equals(this.recurringCharges, reservedNodeOffering.recurringCharges) &&
        Objects.equals(this.reservedNodeOfferingType, reservedNodeOffering.reservedNodeOfferingType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservedNodeOffering {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedNodeOffering
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedNodeOffering.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedNodeOffering is not found in the empty JSON string", ReservedNodeOffering.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedNodeOffering.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedNodeOffering` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedNodeOffering.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedNodeOffering' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedNodeOffering> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedNodeOffering.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedNodeOffering>() {
           @Override
           public void write(JsonWriter out, ReservedNodeOffering value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedNodeOffering read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedNodeOffering given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedNodeOffering
   * @throws IOException if the JSON string is invalid with respect to ReservedNodeOffering
   */
  public static ReservedNodeOffering fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedNodeOffering.class);
  }

  /**
   * Convert an instance of ReservedNodeOffering to an JSON string
   *
   * @return JSON string
   */
