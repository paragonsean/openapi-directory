...
/*
 * OAIDescribeTagsMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeTagsMessage_H
#define OAIDescribeTagsMessage_H
...
class OAIDescribeTagsMessage : public OAIObject {
public:
    OAIDescribeTagsMessage();
    OAIDescribeTagsMessage(QString json);
    ~OAIDescribeTagsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTagsMessage)

#endif // OAIDescribeTagsMessage_H
