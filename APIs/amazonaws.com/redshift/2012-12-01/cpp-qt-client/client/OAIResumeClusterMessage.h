...
class OAIResumeClusterMessage : public OAIObject {
public:
    OAIResumeClusterMessage();
    OAIResumeClusterMessage(QString json);
    ~OAIResumeClusterMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResumeClusterMessage)

#endif // OAIResumeClusterMessage_H
