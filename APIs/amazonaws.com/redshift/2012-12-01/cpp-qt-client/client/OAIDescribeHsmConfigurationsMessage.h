...
/*
 * OAIDescribeHsmConfigurationsMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeHsmConfigurationsMessage_H
#define OAIDescribeHsmConfigurationsMessage_H
...
class OAIDescribeHsmConfigurationsMessage : public OAIObject {
public:
    OAIDescribeHsmConfigurationsMessage();
    OAIDescribeHsmConfigurationsMessage(QString json);
    ~OAIDescribeHsmConfigurationsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHsmConfigurationsMessage)

#endif // OAIDescribeHsmConfigurationsMessage_H
