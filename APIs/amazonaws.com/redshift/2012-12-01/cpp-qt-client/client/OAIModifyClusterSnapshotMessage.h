...
/*
 * OAIModifyClusterSnapshotMessage.h
 *
 * 
 */

#ifndef OAIModifyClusterSnapshotMessage_H
#define OAIModifyClusterSnapshotMessage_H
...
class OAIModifyClusterSnapshotMessage : public OAIObject {
public:
    OAIModifyClusterSnapshotMessage();
    OAIModifyClusterSnapshotMessage(QString json);
    ~OAIModifyClusterSnapshotMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyClusterSnapshotMessage)

#endif // OAIModifyClusterSnapshotMessage_H
