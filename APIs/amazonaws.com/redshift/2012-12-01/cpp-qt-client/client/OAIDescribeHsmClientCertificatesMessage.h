...
/*
 * OAIDescribeHsmClientCertificatesMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeHsmClientCertificatesMessage_H
#define OAIDescribeHsmClientCertificatesMessage_H
...
class OAIDescribeHsmClientCertificatesMessage : public OAIObject {
public:
    OAIDescribeHsmClientCertificatesMessage();
    OAIDescribeHsmClientCertificatesMessage(QString json);
    ~OAIDescribeHsmClientCertificatesMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeHsmClientCertificatesMessage)

#endif // OAIDescribeHsmClientCertificatesMessage_H
