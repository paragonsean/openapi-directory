...
/*
 * OAIDescribeClusterTracksMessage.h
 *
 * 
 */

#ifndef OAIDescribeClusterTracksMessage_H
#define OAIDescribeClusterTracksMessage_H
...
class OAIDescribeClusterTracksMessage : public OAIObject {
public:
    OAIDescribeClusterTracksMessage();
    OAIDescribeClusterTracksMessage(QString json);
    ~OAIDescribeClusterTracksMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClusterTracksMessage)

#endif // OAIDescribeClusterTracksMessage_H
