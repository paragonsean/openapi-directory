...
/*
 * OAIDescribeClusterDbRevisionsMessage.h
 *
 * 
 */

#ifndef OAIDescribeClusterDbRevisionsMessage_H
#define OAIDescribeClusterDbRevisionsMessage_H
...
class OAIDescribeClusterDbRevisionsMessage : public OAIObject {
public:
    OAIDescribeClusterDbRevisionsMessage();
    OAIDescribeClusterDbRevisionsMessage(QString json);
    ~OAIDescribeClusterDbRevisionsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClusterDbRevisionsMessage)

#endif // OAIDescribeClusterDbRevisionsMessage_H
