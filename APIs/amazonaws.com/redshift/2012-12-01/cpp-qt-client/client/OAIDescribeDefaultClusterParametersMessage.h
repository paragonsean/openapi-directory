...
/*
 * OAIDescribeDefaultClusterParametersMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeDefaultClusterParametersMessage_H
#define OAIDescribeDefaultClusterParametersMessage_H
...
class OAIDescribeDefaultClusterParametersMessage : public OAIObject {
public:
    OAIDescribeDefaultClusterParametersMessage();
    OAIDescribeDefaultClusterParametersMessage(QString json);
    ~OAIDescribeDefaultClusterParametersMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDefaultClusterParametersMessage)

#endif // OAIDescribeDefaultClusterParametersMessage_H
