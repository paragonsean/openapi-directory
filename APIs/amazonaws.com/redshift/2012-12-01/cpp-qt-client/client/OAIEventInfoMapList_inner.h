...
/*
 * OAIEventInfoMapList_inner.h
 *
 * 
 */

#ifndef OAIEventInfoMapList_inner_H
#define OAIEventInfoMapList_inner_H
...
class OAIEventInfoMapList_inner : public OAIObject {
public:
    OAIEventInfoMapList_inner();
    OAIEventInfoMapList_inner(QString json);
    ~OAIEventInfoMapList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEventInfoMapList_inner)

#endif // OAIEventInfoMapList_inner_H
