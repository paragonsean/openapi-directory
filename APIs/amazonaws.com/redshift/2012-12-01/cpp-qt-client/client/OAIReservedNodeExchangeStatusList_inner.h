...
/*
 * OAIReservedNodeExchangeStatusList_inner.h
 *
 * 
 */

#ifndef OAIReservedNodeExchangeStatusList_inner_H
#define OAIReservedNodeExchangeStatusList_inner_H
...
class OAIReservedNodeExchangeStatusList_inner : public OAIObject {
public:
    OAIReservedNodeExchangeStatusList_inner();
    OAIReservedNodeExchangeStatusList_inner(QString json);
    ~OAIReservedNodeExchangeStatusList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservedNodeExchangeStatusList_inner)

#endif // OAIReservedNodeExchangeStatusList_inner_H
