...
/*
 * OAITrackList_inner.h
 *
 * 
 */

#ifndef OAITrackList_inner_H
#define OAITrackList_inner_H
...
class OAITrackList_inner : public OAIObject {
public:
    OAITrackList_inner();
    OAITrackList_inner(QString json);
    ~OAITrackList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrackList_inner)

#endif // OAITrackList_inner_H
