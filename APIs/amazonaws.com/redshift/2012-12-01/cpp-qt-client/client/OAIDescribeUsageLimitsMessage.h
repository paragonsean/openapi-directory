...
/*
 * OAIDescribeUsageLimitsMessage.h
 *
 * 
 */

#ifndef OAIDescribeUsageLimitsMessage_H
#define OAIDescribeUsageLimitsMessage_H
...
class OAIDescribeUsageLimitsMessage : public OAIObject {
public:
    OAIDescribeUsageLimitsMessage();
    OAIDescribeUsageLimitsMessage(QString json);
    ~OAIDescribeUsageLimitsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeUsageLimitsMessage)

#endif // OAIDescribeUsageLimitsMessage_H
