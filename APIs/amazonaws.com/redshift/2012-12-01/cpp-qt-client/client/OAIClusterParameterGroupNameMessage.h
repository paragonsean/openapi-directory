...
/*
 * OAIClusterParameterGroupNameMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIClusterParameterGroupNameMessage_H
#define OAIClusterParameterGroupNameMessage_H
...
class OAIClusterParameterGroupNameMessage : public OAIObject {
public:
    OAIClusterParameterGroupNameMessage();
    OAIClusterParameterGroupNameMessage(QString json);
    ~OAIClusterParameterGroupNameMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterParameterGroupNameMessage)

#endif // OAIClusterParameterGroupNameMessage_H
