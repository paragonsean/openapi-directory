...
OAIDescribeClustersMessage::OAIDescribeClustersMessage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeClustersMessage::OAIDescribeClustersMessage() {
    this->initializeModel();
}

OAIDescribeClustersMessage::~OAIDescribeClustersMessage() {}

void OAIDescribeClustersMessage::initializeModel() {
...
void OAIDescribeClustersMessage::fromJson(QString jsonString) {
...
void OAIDescribeClustersMessage::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeClustersMessage::asJson() const {
...
QJsonObject OAIDescribeClustersMessage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeClustersMessage::getClusterIdentifier() const {
    return m_cluster_identifier;
}
void OAIDescribeClustersMessage::setClusterIdentifier(const QString &cluster_identifier) {
    m_cluster_identifier = cluster_identifier;
    m_cluster_identifier_isSet = true;
}

bool OAIDescribeClustersMessage::is_cluster_identifier_Set() const{
    return m_cluster_identifier_isSet;
}

bool OAIDescribeClustersMessage::is_cluster_identifier_Valid() const{
    return m_cluster_identifier_isValid;
}

qint32 OAIDescribeClustersMessage::getMaxRecords() const {
    return m_max_records;
}
void OAIDescribeClustersMessage::setMaxRecords(const qint32 &max_records) {
    m_max_records = max_records;
    m_max_records_isSet = true;
}

bool OAIDescribeClustersMessage::is_max_records_Set() const{
    return m_max_records_isSet;
}

bool OAIDescribeClustersMessage::is_max_records_Valid() const{
    return m_max_records_isValid;
}

QString OAIDescribeClustersMessage::getMarker() const {
    return m_marker;
}
void OAIDescribeClustersMessage::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeClustersMessage::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeClustersMessage::is_marker_Valid() const{
    return m_marker_isValid;
}

QList OAIDescribeClustersMessage::getTagKeys() const {
    return m_tag_keys;
}
void OAIDescribeClustersMessage::setTagKeys(const QList &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIDescribeClustersMessage::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIDescribeClustersMessage::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

QList OAIDescribeClustersMessage::getTagValues() const {
    return m_tag_values;
}
void OAIDescribeClustersMessage::setTagValues(const QList &tag_values) {
    m_tag_values = tag_values;
    m_tag_values_isSet = true;
}

bool OAIDescribeClustersMessage::is_tag_values_Set() const{
    return m_tag_values_isSet;
}

bool OAIDescribeClustersMessage::is_tag_values_Valid() const{
    return m_tag_values_isValid;
}

bool OAIDescribeClustersMessage::isSet() const {
...
bool OAIDescribeClustersMessage::isValid() const {
