...
/*
 * OAISnapshotErrorMessage.h
 *
 * Describes the errors returned by a snapshot.
 */

#ifndef OAISnapshotErrorMessage_H
#define OAISnapshotErrorMessage_H
...
class OAISnapshotErrorMessage : public OAIObject {
public:
    OAISnapshotErrorMessage();
    OAISnapshotErrorMessage(QString json);
    ~OAISnapshotErrorMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnapshotErrorMessage)

#endif // OAISnapshotErrorMessage_H
