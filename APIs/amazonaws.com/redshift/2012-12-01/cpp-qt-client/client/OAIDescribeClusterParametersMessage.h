...
/*
 * OAIDescribeClusterParametersMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeClusterParametersMessage_H
#define OAIDescribeClusterParametersMessage_H
...
class OAIDescribeClusterParametersMessage : public OAIObject {
public:
    OAIDescribeClusterParametersMessage();
    OAIDescribeClusterParametersMessage(QString json);
    ~OAIDescribeClusterParametersMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClusterParametersMessage)

#endif // OAIDescribeClusterParametersMessage_H
