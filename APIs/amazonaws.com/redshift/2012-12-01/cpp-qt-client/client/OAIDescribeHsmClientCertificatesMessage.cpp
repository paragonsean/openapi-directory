...
OAIDescribeHsmClientCertificatesMessage::OAIDescribeHsmClientCertificatesMessage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeHsmClientCertificatesMessage::OAIDescribeHsmClientCertificatesMessage() {
    this->initializeModel();
}

OAIDescribeHsmClientCertificatesMessage::~OAIDescribeHsmClientCertificatesMessage() {}

void OAIDescribeHsmClientCertificatesMessage::initializeModel() {
...
void OAIDescribeHsmClientCertificatesMessage::fromJson(QString jsonString) {
...
void OAIDescribeHsmClientCertificatesMessage::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeHsmClientCertificatesMessage::asJson() const {
...
QJsonObject OAIDescribeHsmClientCertificatesMessage::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeHsmClientCertificatesMessage::getHsmClientCertificateIdentifier() const {
    return m_hsm_client_certificate_identifier;
}
void OAIDescribeHsmClientCertificatesMessage::setHsmClientCertificateIdentifier(const QString &hsm_client_certificate_identifier) {
    m_hsm_client_certificate_identifier = hsm_client_certificate_identifier;
    m_hsm_client_certificate_identifier_isSet = true;
}

bool OAIDescribeHsmClientCertificatesMessage::is_hsm_client_certificate_identifier_Set() const{
    return m_hsm_client_certificate_identifier_isSet;
}

bool OAIDescribeHsmClientCertificatesMessage::is_hsm_client_certificate_identifier_Valid() const{
    return m_hsm_client_certificate_identifier_isValid;
}

qint32 OAIDescribeHsmClientCertificatesMessage::getMaxRecords() const {
    return m_max_records;
}
void OAIDescribeHsmClientCertificatesMessage::setMaxRecords(const qint32 &max_records) {
    m_max_records = max_records;
    m_max_records_isSet = true;
}

bool OAIDescribeHsmClientCertificatesMessage::is_max_records_Set() const{
    return m_max_records_isSet;
}

bool OAIDescribeHsmClientCertificatesMessage::is_max_records_Valid() const{
    return m_max_records_isValid;
}

QString OAIDescribeHsmClientCertificatesMessage::getMarker() const {
    return m_marker;
}
void OAIDescribeHsmClientCertificatesMessage::setMarker(const QString &marker) {
    m_marker = marker;
    m_marker_isSet = true;
}

bool OAIDescribeHsmClientCertificatesMessage::is_marker_Set() const{
    return m_marker_isSet;
}

bool OAIDescribeHsmClientCertificatesMessage::is_marker_Valid() const{
    return m_marker_isValid;
}

QList OAIDescribeHsmClientCertificatesMessage::getTagKeys() const {
    return m_tag_keys;
}
void OAIDescribeHsmClientCertificatesMessage::setTagKeys(const QList &tag_keys) {
    m_tag_keys = tag_keys;
    m_tag_keys_isSet = true;
}

bool OAIDescribeHsmClientCertificatesMessage::is_tag_keys_Set() const{
    return m_tag_keys_isSet;
}

bool OAIDescribeHsmClientCertificatesMessage::is_tag_keys_Valid() const{
    return m_tag_keys_isValid;
}

QList OAIDescribeHsmClientCertificatesMessage::getTagValues() const {
    return m_tag_values;
}
void OAIDescribeHsmClientCertificatesMessage::setTagValues(const QList &tag_values) {
    m_tag_values = tag_values;
    m_tag_values_isSet = true;
}

bool OAIDescribeHsmClientCertificatesMessage::is_tag_values_Set() const{
    return m_tag_values_isSet;
}

bool OAIDescribeHsmClientCertificatesMessage::is_tag_values_Valid() const{
    return m_tag_values_isValid;
}

bool OAIDescribeHsmClientCertificatesMessage::isSet() const {
...
bool OAIDescribeHsmClientCertificatesMessage::isValid() const {
