...
/*
 * OAIDescribeCustomDomainAssociationsMessage.h
 *
 * 
 */

#ifndef OAIDescribeCustomDomainAssociationsMessage_H
#define OAIDescribeCustomDomainAssociationsMessage_H
...
class OAIDescribeCustomDomainAssociationsMessage : public OAIObject {
public:
    OAIDescribeCustomDomainAssociationsMessage();
    OAIDescribeCustomDomainAssociationsMessage(QString json);
    ~OAIDescribeCustomDomainAssociationsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCustomDomainAssociationsMessage)

#endif // OAIDescribeCustomDomainAssociationsMessage_H
