...
#ifndef OAIUpdateTarget_H
#define OAIUpdateTarget_H
...
class OAIUpdateTarget : public OAIObject {
public:
    OAIUpdateTarget();
    OAIUpdateTarget(QString json);
    ~OAIUpdateTarget() override;
    ...
    QList getSupportedOperations() const;
    void setSupportedOperations(const QList &supported_operations);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateTarget)

#endif // OAIUpdateTarget_H
