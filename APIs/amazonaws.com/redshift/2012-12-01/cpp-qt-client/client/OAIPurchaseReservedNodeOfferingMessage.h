...
/*
 * OAIPurchaseReservedNodeOfferingMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIPurchaseReservedNodeOfferingMessage_H
#define OAIPurchaseReservedNodeOfferingMessage_H
...
class OAIPurchaseReservedNodeOfferingMessage : public OAIObject {
public:
    OAIPurchaseReservedNodeOfferingMessage();
    OAIPurchaseReservedNodeOfferingMessage(QString json);
    ~OAIPurchaseReservedNodeOfferingMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPurchaseReservedNodeOfferingMessage)

#endif // OAIPurchaseReservedNodeOfferingMessage_H
