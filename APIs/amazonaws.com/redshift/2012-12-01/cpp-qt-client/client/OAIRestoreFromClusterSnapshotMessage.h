...
/*
 * OAIRestoreFromClusterSnapshotMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIRestoreFromClusterSnapshotMessage_H
#define OAIRestoreFromClusterSnapshotMessage_H
...
class OAIRestoreFromClusterSnapshotMessage : public OAIObject {
public:
    OAIRestoreFromClusterSnapshotMessage();
    OAIRestoreFromClusterSnapshotMessage(QString json);
    ~OAIRestoreFromClusterSnapshotMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRestoreFromClusterSnapshotMessage)

#endif // OAIRestoreFromClusterSnapshotMessage_H
