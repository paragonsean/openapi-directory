...
/*
 * OAIDataTransferProgress.h
 *
 * Describes the status of a cluster while it is in the process of resizing with an incremental resize.
 */

#ifndef OAIDataTransferProgress_H
#define OAIDataTransferProgress_H
...
class OAIDataTransferProgress : public OAIObject {
public:
    OAIDataTransferProgress();
    OAIDataTransferProgress(QString json);
    ~OAIDataTransferProgress() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDataTransferProgress)

#endif // OAIDataTransferProgress_H
