...
/*
 * OAIDescribeClusterSubnetGroupsMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeClusterSubnetGroupsMessage_H
#define OAIDescribeClusterSubnetGroupsMessage_H
...
class OAIDescribeClusterSubnetGroupsMessage : public OAIObject {
public:
    OAIDescribeClusterSubnetGroupsMessage();
    OAIDescribeClusterSubnetGroupsMessage(QString json);
    ~OAIDescribeClusterSubnetGroupsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClusterSubnetGroupsMessage)

#endif // OAIDescribeClusterSubnetGroupsMessage_H
