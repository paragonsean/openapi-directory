...
/*
 * OAIReservedNodeOfferingList_inner.h
 *
 * 
 */

#ifndef OAIReservedNodeOfferingList_inner_H
#define OAIReservedNodeOfferingList_inner_H
...
class OAIReservedNodeOfferingList_inner : public OAIObject {
public:
    OAIReservedNodeOfferingList_inner();
    OAIReservedNodeOfferingList_inner(QString json);
    ~OAIReservedNodeOfferingList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReservedNodeOfferingList_inner)

#endif // OAIReservedNodeOfferingList_inner_H
