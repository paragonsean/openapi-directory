...
/*
 * OAIModifyCustomDomainAssociationMessage.h
 *
 * 
 */

#ifndef OAIModifyCustomDomainAssociationMessage_H
#define OAIModifyCustomDomainAssociationMessage_H
...
class OAIModifyCustomDomainAssociationMessage : public OAIObject {
public:
    OAIModifyCustomDomainAssociationMessage();
    OAIModifyCustomDomainAssociationMessage(QString json);
    ~OAIModifyCustomDomainAssociationMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyCustomDomainAssociationMessage)

#endif // OAIModifyCustomDomainAssociationMessage_H
