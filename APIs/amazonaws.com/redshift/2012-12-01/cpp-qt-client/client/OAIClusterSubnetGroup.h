...
/*
 * OAIClusterSubnetGroup.h
 *
 * Describes a subnet group.
 */

#ifndef OAIClusterSubnetGroup_H
#define OAIClusterSubnetGroup_H
...
class OAIClusterSubnetGroup : public OAIObject {
public:
    OAIClusterSubnetGroup();
    OAIClusterSubnetGroup(QString json);
    ~OAIClusterSubnetGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterSubnetGroup)

#endif // OAIClusterSubnetGroup_H
