...
QDateTime OAIEventSubscriptionsList_inner::getSubscriptionCreationTime() const {
    return m_subscription_creation_time;
}
void OAIEventSubscriptionsList_inner::setSubscriptionCreationTime(const QDateTime &subscription_creation_time) {
...
QString OAIEventSubscriptionsList_inner::getSeverity() const {
    return m_severity;
}
void OAIEventSubscriptionsList_inner::setSeverity(const QString &severity) {
    m_severity = severity;
    m_severity_isSet = true;
}

bool OAIEventSubscriptionsList_inner::is_severity_Set() const{
    return m_severity_isSet;
}

bool OAIEventSubscriptionsList_inner::is_severity_Valid() const{
...
QList OAIEventSubscriptionsList_inner::getTags() const {
    return m_tags;
}
void OAIEventSubscriptionsList_inner::setTags(const QList &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIEventSubscriptionsList_inner::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIEventSubscriptionsList_inner::is_tags_Valid() const{
