...
class OAICertificateAssociation : public OAIObject {
public:
    OAICertificateAssociation();
    OAICertificateAssociation(QString json);
    ~OAICertificateAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICertificateAssociation)

#endif // OAICertificateAssociation_H
