...
/*
 * OAIDescribeClustersMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeClustersMessage_H
#define OAIDescribeClustersMessage_H
...
class OAIDescribeClustersMessage : public OAIObject {
public:
    OAIDescribeClustersMessage();
    OAIDescribeClustersMessage(QString json);
    ~OAIDescribeClustersMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClustersMessage)

#endif // OAIDescribeClustersMessage_H
