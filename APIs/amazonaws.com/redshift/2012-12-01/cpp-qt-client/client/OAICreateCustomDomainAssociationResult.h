...
/*
 * OAICreateCustomDomainAssociationResult.h
 *
 * 
 */

#ifndef OAICreateCustomDomainAssociationResult_H
#define OAICreateCustomDomainAssociationResult_H
...
class OAICreateCustomDomainAssociationResult : public OAIObject {
public:
    OAICreateCustomDomainAssociationResult();
    OAICreateCustomDomainAssociationResult(QString json);
    ~OAICreateCustomDomainAssociationResult() override;
    ...
    QString getCustomDomainCertExpiryTime() const;
    void setCustomDomainCertExpiryTime(const QString &custom_domain_cert_expiry_time);
    bool is_custom_domain_cert_expiry_time_Set() const;
    bool is_custom_domain_cert_expiry_time_Valid() const;
...
private:
    ...
    QString m_custom_domain_cert_expiry_time;
    bool m_custom_domain_cert_expiry_time_isSet;
    bool m_custom_domain_cert_expiry_time_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomDomainAssociationResult)

#endif // OAICreateCustomDomainAssociationResult_H
