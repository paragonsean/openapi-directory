...
#ifndef OAIAquaConfiguration_H
#define OAIAquaConfiguration_H
...
class OAIAquaConfiguration : public OAIObject {
public:
    OAIAquaConfiguration();
    OAIAquaConfiguration(QString json);
    ~OAIAquaConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAquaConfiguration)

#endif // OAIAquaConfiguration_H
