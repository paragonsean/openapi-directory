...
/*
 * OAIClusterParameterGroup.h
 *
 * Describes a parameter group.
 */

#ifndef OAIClusterParameterGroup_H
#define OAIClusterParameterGroup_H
...
class OAIClusterParameterGroup : public OAIObject {
public:
    OAIClusterParameterGroup();
    OAIClusterParameterGroup(QString json);
    ~OAIClusterParameterGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterParameterGroup)

#endif // OAIClusterParameterGroup_H
