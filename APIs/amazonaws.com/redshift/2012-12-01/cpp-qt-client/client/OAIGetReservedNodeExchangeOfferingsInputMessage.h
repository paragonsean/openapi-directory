...
/*
 * OAIGetReservedNodeExchangeOfferingsInputMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIGetReservedNodeExchangeOfferingsInputMessage_H
#define OAIGetReservedNodeExchangeOfferingsInputMessage_H
...
class OAIGetReservedNodeExchangeOfferingsInputMessage : public OAIObject {
public:
    OAIGetReservedNodeExchangeOfferingsInputMessage();
    OAIGetReservedNodeExchangeOfferingsInputMessage(QString json);
    ~OAIGetReservedNodeExchangeOfferingsInputMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReservedNodeExchangeOfferingsInputMessage)

#endif // OAIGetReservedNodeExchangeOfferingsInputMessage_H
