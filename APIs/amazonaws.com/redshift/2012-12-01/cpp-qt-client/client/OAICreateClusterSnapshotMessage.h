...
/*
 * OAICreateClusterSnapshotMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAICreateClusterSnapshotMessage_H
#define OAICreateClusterSnapshotMessage_H
...
class OAICreateClusterSnapshotMessage : public OAIObject {
public:
    OAICreateClusterSnapshotMessage();
    OAICreateClusterSnapshotMessage(QString json);
    ~OAICreateClusterSnapshotMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterSnapshotMessage)

#endif // OAICreateClusterSnapshotMessage_H
