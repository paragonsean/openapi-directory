...
/*
 * OAIDescribeOrderableClusterOptionsMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeOrderableClusterOptionsMessage_H
#define OAIDescribeOrderableClusterOptionsMessage_H
...
class OAIDescribeOrderableClusterOptionsMessage : public OAIObject {
public:
    OAIDescribeOrderableClusterOptionsMessage();
    OAIDescribeOrderableClusterOptionsMessage(QString json);
    ~OAIDescribeOrderableClusterOptionsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeOrderableClusterOptionsMessage)

#endif // OAIDescribeOrderableClusterOptionsMessage_H
