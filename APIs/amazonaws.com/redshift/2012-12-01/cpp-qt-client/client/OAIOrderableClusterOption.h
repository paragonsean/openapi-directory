...
/*
 * OAIOrderableClusterOption.h
 *
 * Describes an orderable cluster option.
 */

#ifndef OAIOrderableClusterOption_H
#define OAIOrderableClusterOption_H
...
class OAIOrderableClusterOption : public OAIObject {
public:
    OAIOrderableClusterOption();
    OAIOrderableClusterOption(QString json);
    ~OAIOrderableClusterOption() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrderableClusterOption)

#endif // OAIOrderableClusterOption_H
