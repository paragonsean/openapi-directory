...
/*
 * OAIAcceptReservedNodeExchangeInputMessage.h
 *
 * 
 */

#ifndef OAIAcceptReservedNodeExchangeInputMessage_H
#define OAIAcceptReservedNodeExchangeInputMessage_H
...
class OAIAcceptReservedNodeExchangeInputMessage : public OAIObject {
public:
    OAIAcceptReservedNodeExchangeInputMessage();
    OAIAcceptReservedNodeExchangeInputMessage(QString json);
    ~OAIAcceptReservedNodeExchangeInputMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptReservedNodeExchangeInputMessage)

#endif // OAIAcceptReservedNodeExchangeInputMessage_H
