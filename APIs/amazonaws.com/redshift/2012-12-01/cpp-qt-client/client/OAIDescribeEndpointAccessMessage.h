...
/*
 * OAIDescribeEndpointAccessMessage.h
 *
 * 
 */

#ifndef OAIDescribeEndpointAccessMessage_H
#define OAIDescribeEndpointAccessMessage_H
...
class OAIDescribeEndpointAccessMessage : public OAIObject {
public:
    OAIDescribeEndpointAccessMessage();
    OAIDescribeEndpointAccessMessage(QString json);
    ~OAIDescribeEndpointAccessMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndpointAccessMessage)

#endif // OAIDescribeEndpointAccessMessage_H
