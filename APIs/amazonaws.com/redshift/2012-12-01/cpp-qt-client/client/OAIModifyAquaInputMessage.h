...
/*
 * OAIModifyAquaInputMessage.h
 *
 * 
 */

#ifndef OAIModifyAquaInputMessage_H
#define OAIModifyAquaInputMessage_H
...
class OAIModifyAquaInputMessage : public OAIObject {
public:
    OAIModifyAquaInputMessage();
    OAIModifyAquaInputMessage(QString json);
    ~OAIModifyAquaInputMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyAquaInputMessage)

#endif // OAIModifyAquaInputMessage_H
