...
/*
 * OAICreateUsageLimitMessage.h
 *
 * 
 */

#ifndef OAICreateUsageLimitMessage_H
#define OAICreateUsageLimitMessage_H
...
class OAICreateUsageLimitMessage : public OAIObject {
public:
    OAICreateUsageLimitMessage();
    OAICreateUsageLimitMessage(QString json);
    ~OAICreateUsageLimitMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateUsageLimitMessage)

#endif // OAICreateUsageLimitMessage_H
