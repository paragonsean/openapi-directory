...
QString OAICluster::getClusterIdentifier() const {
    return m_cluster_identifier;
}
void OAICluster::setClusterIdentifier(const QString &cluster_identifier) {
    m_cluster_identifier = cluster_identifier;
    m_cluster_identifier_isSet = true;
}

bool OAICluster::is_cluster_identifier_Set() const{
    return m_cluster_identifier_isSet;
}

bool OAICluster::is_cluster_identifier_Valid() const{
...
QString OAICluster::getClusterStatus() const {
    return m_cluster_status;
}
void OAICluster::setClusterStatus(const QString &cluster_status) {
    m_cluster_status = cluster_status;
    m_cluster_status_isSet = true;
}

bool OAICluster::is_cluster_status_Set() const{
    return m_cluster_status_isSet;
}

bool OAICluster::is_cluster_status_Valid() const{
    return m_cluster_status_isValid;
}

QString OAICluster::getClusterAvailabilityStatus() const {
    return m_cluster_availability_status;
}
void OAICluster::setClusterAvailabilityStatus(const QString &cluster_availability_status) {
    m_cluster_availability_status = cluster_availability_status;
    m_cluster_availability_status_isSet = true;
}

bool OAICluster::is_cluster_availability_status_Set() const{
    return m_cluster_availability_status_isSet;
}

bool OAICluster::is_cluster_availability_status_Valid() const{
    return m_cluster_availability_status_isValid;
}

QString OAICluster::getModifyStatus() const {
    return m_modify_status;
}
void OAICluster::setModifyStatus(const QString &modify_status) {
    m_modify_status = modify_status;
    m_modify_status_isSet = true;
}

bool OAICluster::is_modify_status_Set() const{
    return m_modify_status_isSet;
}

bool OAICluster::is_modify_status_Valid() const{
    return m_modify_status_isValid;
}

QString OAICluster::getMasterUsername() const {
    return m_master_username;
}
void OAICluster::setMasterUsername(const QString &master_username) {
    m_master_username = master_username;
    m_master_username_isSet = true;
}

bool OAICluster::is_master_username_Set() const{
    return m_master_username_isSet;
}

bool OAICluster::is_master_username_Valid() const{
    return m_master_username_isValid;
}

QString OAICluster::getDbName() const {
    return m_db_name;
}
void OAICluster::setDbName(const QString &db_name) {
    m_db_name = db_name;
    m_db_name_isSet = true;
}

bool OAICluster::is_db_name_Set() const{
    return m_db_name_isSet;
}

bool OAICluster::is_db_name_Valid() const{
    return m_db_name_isValid;
}

OAICluster_Endpoint OAICluster::getEndpoint() const {
    return m_endpoint;
}
void OAICluster::setEndpoint(const OAICluster_Endpoint &endpoint) {
    m_endpoint = endpoint;
...
QDateTime OAICluster::getClusterCreateTime() const {
    return m_cluster_create_time;
}
void OAICluster::setClusterCreateTime(const QDateTime &cluster_create_time) {
    m_cluster_create_time = cluster_create_time;
    m_cluster_create_time_isSet = true;
}

bool OAICluster::is_cluster_create_time_Set() const{
    return m_cluster_create_time_isSet;
}

bool OAICluster::is_cluster_create_time_Valid() const{
    return m_cluster_create_time_isValid;
}

qint32 OAICluster::getAutomatedSnapshotRetentionPeriod() const {
    return m_automated_snapshot_retention_period;
}
void OAICluster::setAutomatedSnapshotRetentionPeriod(const qint32 &automated_snapshot_retention_period) {
...
bool OAICluster::is_automated_snapshot_retention_period_Set() const{
    return m_automated_snapshot_retention_period_isSet;
}

bool OAICluster::is_automated_snapshot_retention_period_Valid() const{
    return m_automated_snapshot_retention_period_isValid;
}

qint32 OAICluster::getManualSnapshotRetentionPeriod() const {
    return m_manual_snapshot_retention_period;
}
void OAICluster::setManualSnapshotRetentionPeriod(const qint32 &manual_snapshot_retention_period) {
    m_manual_snapshot_retention_period = manual_snapshot_retention_period;
    m_manual_snapshot_retention_period_isSet = true;
}

bool OAICluster::is_manual_snapshot_retention_period_Set() const{
    return m_manual_snapshot_retention_period_isSet;
}

bool OAICluster::is_manual_snapshot_retention_period_Valid() const{
    return m_manual_snapshot_retention_period_isValid;
}

QList OAICluster::getClusterSecurityGroups() const {
    return m_cluster_security_groups;
}
void OAICluster::setClusterSecurityGroups(const QList &cluster_security_groups) {
    m_cluster_security_groups = cluster_security_groups;
    m_cluster_security_groups_isSet = true;
}

bool OAICluster::is_cluster_security_groups_Set() const{
    return m_cluster_security_groups_isSet;
}

bool OAICluster::is_cluster_security_groups_Valid() const{
    return m_cluster_security_groups_isValid;
}

QList OAICluster::getVpcSecurityGroups() const {
    return m_vpc_security_groups;
}
void OAICluster::setVpcSecurityGroups(const QList &vpc_security_groups) {
    m_vpc_security_groups = vpc_security_groups;
    m_vpc_security_groups_isSet = true;
}

bool OAICluster::is_vpc_security_groups_Set() const{
    return m_vpc_security_groups_isSet;
}

bool OAICluster::is_vpc_security_groups_Valid() const{
    return m_vpc_security_groups_isValid;
}

QList OAICluster::getClusterParameterGroups() const {
    return m_cluster_parameter_groups;
}
void OAICluster::setClusterParameterGroups(const QList &cluster_parameter_groups) {
    m_cluster_parameter_groups = cluster_parameter_groups;
    m_cluster_parameter_groups_isSet = true;
}

bool OAICluster::is_cluster_parameter_groups_Set() const{
    return m_cluster_parameter_groups_isSet;
}

bool OAICluster::is_cluster_parameter_groups_Valid() const{
    return m_cluster_parameter_groups_isValid;
}

QString OAICluster::getClusterSubnetGroupName() const {
    return m_cluster_subnet_group_name;
}
void OAICluster::setClusterSubnetGroupName(const QString &cluster_subnet_group_name) {
    m_cluster_subnet_group_name = cluster_subnet_group_name;
    m_cluster_subnet_group_name_isSet = true;
}

bool OAICluster::is_cluster_subnet_group_name_Set() const{
    return m_cluster_subnet_group_name_isSet;
}

bool OAICluster::is_cluster_subnet_group_name_Valid() const{
    return m_cluster_subnet_group_name_isValid;
}

QString OAICluster::getVpcId() const {
    return m_vpc_id;
}
void OAICluster::setVpcId(const QString &vpc_id) {
    m_vpc_id = vpc_id;
    m_vpc_id_isSet = true;
}

bool OAICluster::is_vpc_id_Set() const{
    return m_vpc_id_isSet;
}

bool OAICluster::is_vpc_id_Valid() const{
    return m_vpc_id_isValid;
}

QString OAICluster::getAvailabilityZone() const {
    return m_availability_zone;
}
void OAICluster::setAvailabilityZone(const QString &availability_zone) {
    m_availability_zone = availability_zone;
    m_availability_zone_isSet = true;
}

bool OAICluster::is_availability_zone_Set() const{
    return m_availability_zone_isSet;
}

bool OAICluster::is_availability_zone_Valid() const{
...
OAICluster_PendingModifiedValues OAICluster::getPendingModifiedValues() const {
    return m_pending_modified_values;
}
void OAICluster::setPendingModifiedValues(const OAICluster_PendingModifiedValues &pending_modified_values) {
    m_pending_modified_values = pending_modified_values;
    m_pending_modified_values_isSet = true;
}

bool OAICluster::is_pending_modified_values_Set() const{
    return m_pending_modified_values_isSet;
}

bool OAICluster::is_pending_modified_values_Valid() const{
    return m_pending_modified_values_isValid;
}

QString OAICluster::getClusterVersion() const {
    return m_cluster_version;
}
void OAICluster::setClusterVersion(const QString &cluster_version) {
    m_cluster_version = cluster_version;
    m_cluster_version_isSet = true;
}

bool OAICluster::is_cluster_version_Set() const{
    return m_cluster_version_isSet;
}

bool OAICluster::is_cluster_version_Valid() const{
    return m_cluster_version_isValid;
}

bool OAICluster::getAllowVersionUpgrade() const {
    return m_allow_version_upgrade;
}
void OAICluster::setAllowVersionUpgrade(const bool &allow_version_upgrade) {
    m_allow_version_upgrade = allow_version_upgrade;
    m_allow_version_upgrade_isSet = true;
}

bool OAICluster::is_allow_version_upgrade_Set() const{
    return m_allow_version_upgrade_isSet;
}

bool OAICluster::is_allow_version_upgrade_Valid() const{
    return m_allow_version_upgrade_isValid;
}

qint32 OAICluster::getNumberOfNodes() const {
    return m_number_of_nodes;
}
void OAICluster::setNumberOfNodes(const qint32 &number_of_nodes) {
    m_number_of_nodes = number_of_nodes;
    m_number_of_nodes_isSet = true;
}

bool OAICluster::is_number_of_nodes_Set() const{
    return m_number_of_nodes_isSet;
}

bool OAICluster::is_number_of_nodes_Valid() const{
    return m_number_of_nodes_isValid;
}

bool OAICluster::getPubliclyAccessible() const {
    return m_publicly_accessible;
}
void OAICluster::setPubliclyAccessible(const bool &publicly_accessible) {
    m_publicly_accessible = publicly_accessible;
    m_publicly_accessible_isSet = true;
}

bool OAICluster::is_publicly_accessible_Set() const{
    return m_publicly_accessible_isSet;
}

bool OAICluster::is_publicly_accessible_Valid() const{
    return m_publicly_accessible_isValid;
}

bool OAICluster::getEncrypted() const {
    return m_encrypted;
}
void OAICluster::setEncrypted(const bool &encrypted) {
    m_encrypted = encrypted;
    m_encrypted_isSet = true;
}

bool OAICluster::is_encrypted_Set() const{
    return m_encrypted_isSet;
}

bool OAICluster::is_encrypted_Valid() const{
    return m_encrypted_isValid;
}

OAICluster_RestoreStatus OAICluster::getRestoreStatus() const {
    return m_restore_status;
}
void OAICluster::setRestoreStatus(const OAICluster_RestoreStatus &restore_status) {
    m_restore_status = restore_status;
    m_restore_status_isSet = true;
}

bool OAICluster::is_restore_status_Set() const{
    return m_restore_status_isSet;
}

bool OAICluster::is_restore_status_Valid() const{
    return m_restore_status_isValid;
}

OAICluster_DataTransferProgress OAICluster::getDataTransferProgress() const {
    return m_data_transfer_progress;
}
void OAICluster::setDataTransferProgress(const OAICluster_DataTransferProgress &data_transfer_progress) {
    m_data_transfer_progress = data_transfer_progress;
    m_data_transfer_progress_isSet = true;
}

bool OAICluster::is_data_transfer_progress_Set() const{
    return m_data_transfer_progress_isSet;
}

bool OAICluster::is_data_transfer_progress_Valid() const{
    return m_data_transfer_progress_isValid;
}

OAICluster_HsmStatus OAICluster::getHsmStatus() const {
    return m_hsm_status;
}
void OAICluster::setHsmStatus(const OAICluster_HsmStatus &hsm_status) {
    m_hsm_status = hsm_status;
    m_hsm_status_isSet = true;
}

bool OAICluster::is_hsm_status_Set() const{
    return m_hsm_status_isSet;
}

bool OAICluster::is_hsm_status_Valid() const{
    return m_hsm_status_isValid;
}

OAICluster_ClusterSnapshotCopyStatus OAICluster::getClusterSnapshotCopyStatus() const {
    return m_cluster_snapshot_copy_status;
}
void OAICluster::setClusterSnapshotCopyStatus(const OAICluster_ClusterSnapshotCopyStatus &cluster_snapshot_copy_status) {
    m_cluster_snapshot_copy_status = cluster_snapshot_copy_status;
    m_cluster_snapshot_copy_status_isSet = true;
}

bool OAICluster::is_cluster_snapshot_copy_status_Set() const{
    return m_cluster_snapshot_copy_status_isSet;
}

bool OAICluster::is_cluster_snapshot_copy_status_Valid() const{
    return m_cluster_snapshot_copy_status_isValid;
}

QString OAICluster::getClusterPublicKey() const {
    return m_cluster_public_key;
}
void OAICluster::setClusterPublicKey(const QString &cluster_public_key) {
    m_cluster_public_key = cluster_public_key;
    m_cluster_public_key_isSet = true;
}

bool OAICluster::is_cluster_public_key_Set() const{
    return m_cluster_public_key_isSet;
}

bool OAICluster::is_cluster_public_key_Valid() const{
    return m_cluster_public_key_isValid;
}

QList OAICluster::getClusterNodes() const {
    return m_cluster_nodes;
}
void OAICluster::setClusterNodes(const QList &cluster_nodes) {
    m_cluster_nodes = cluster_nodes;
    m_cluster_nodes_isSet = true;
}

bool OAICluster::is_cluster_nodes_Set() const{
    return m_cluster_nodes_isSet;
}

bool OAICluster::is_cluster_nodes_Valid() const{
    return m_cluster_nodes_isValid;
}

OAICluster_ElasticIpStatus OAICluster::getElasticIpStatus() const {
    return m_elastic_ip_status;
}
void OAICluster::setElasticIpStatus(const OAICluster_ElasticIpStatus &elastic_ip_status) {
    m_elastic_ip_status = elastic_ip_status;
    m_elastic_ip_status_isSet = true;
}

bool OAICluster::is_elastic_ip_status_Set() const{
    return m_elastic_ip_status_isSet;
}

bool OAICluster::is_elastic_ip_status_Valid() const{
    return m_elastic_ip_status_isValid;
}

QString OAICluster::getClusterRevisionNumber() const {
    return m_cluster_revision_number;
}
void OAICluster::setClusterRevisionNumber(const QString &cluster_revision_number) {
    m_cluster_revision_number = cluster_revision_number;
    m_cluster_revision_number_isSet = true;
}

bool OAICluster::is_cluster_revision_number_Set() const{
    return m_cluster_revision_number_isSet;
}

bool OAICluster::is_cluster_revision_number_Valid() const{
...
bool OAICluster::getEnhancedVpcRouting() const {
    return m_enhanced_vpc_routing;
}
void OAICluster::setEnhancedVpcRouting(const bool &enhanced_vpc_routing) {
    m_enhanced_vpc_routing = enhanced_vpc_routing;
    m_enhanced_vpc_routing_isSet = true;
}

bool OAICluster::is_enhanced_vpc_routing_Set() const{
    return m_enhanced_vpc_routing_isSet;
}

bool OAICluster::is_enhanced_vpc_routing_Valid() const{
    return m_enhanced_vpc_routing_isValid;
}

QList OAICluster::getIamRoles() const {
    return m_iam_roles;
}
void OAICluster::setIamRoles(const QList &iam_roles) {
    m_iam_roles = iam_roles;
    m_iam_roles_isSet = true;
}

bool OAICluster::is_iam_roles_Set() const{
    return m_iam_roles_isSet;
}

bool OAICluster::is_iam_roles_Valid() const{
    return m_iam_roles_isValid;
}

QList OAICluster::getPendingActions() const {
    return m_pending_actions;
}
void OAICluster::setPendingActions(const QList &pending_actions) {
    m_pending_actions = pending_actions;
    m_pending_actions_isSet = true;
}

bool OAICluster::is_pending_actions_Set() const{
    return m_pending_actions_isSet;
}

bool OAICluster::is_pending_actions_Valid() const{
    return m_pending_actions_isValid;
}

QString OAICluster::getMaintenanceTrackName() const {
    return m_maintenance_track_name;
}
void OAICluster::setMaintenanceTrackName(const QString &maintenance_track_name) {
    m_maintenance_track_name = maintenance_track_name;
    m_maintenance_track_name_isSet = true;
}

bool OAICluster::is_maintenance_track_name_Set() const{
    return m_maintenance_track_name_isSet;
}

bool OAICluster::is_maintenance_track_name_Valid() const{
    return m_maintenance_track_name_isValid;
}

QString OAICluster::getElasticResizeNumberOfNodeOptions() const {
    return m_elastic_resize_number_of_node_options;
}
void OAICluster::setElasticResizeNumberOfNodeOptions(const QString &elastic_resize_number_of_node_options) {
...
bool OAICluster::is_elastic_resize_number_of_node_options_Set() const{
    return m_elastic_resize_number_of_node_options_isSet;
}

bool OAICluster::is_elastic_resize_number_of_node_options_Valid() const{
    return m_elastic_resize_number_of_node_options_isValid;
}

QList OAICluster::getDeferredMaintenanceWindows() const {
    return m_deferred_maintenance_windows;
}
void OAICluster::setDeferredMaintenanceWindows(const QList &deferred_maintenance_windows) {
    m_deferred_maintenance_windows = deferred_maintenance_windows;
    m_deferred_maintenance_windows_isSet = true;
}

bool OAICluster::is_deferred_maintenance_windows_Set() const{
    return m_deferred_maintenance_windows_isSet;
}

bool OAICluster::is_deferred_maintenance_windows_Valid() const{
    return m_deferred_maintenance_windows_isValid;
}

QString OAICluster::getSnapshotScheduleIdentifier() const {
    return m_snapshot_schedule_identifier;
}
void OAICluster::setSnapshotScheduleIdentifier(const QString &snapshot_schedule_identifier) {
    m_snapshot_schedule_identifier = snapshot_schedule_identifier;
    m_snapshot_schedule_identifier_isSet = true;
}

bool OAICluster::is_snapshot_schedule_identifier_Set() const{
    return m_snapshot_schedule_identifier_isSet;
}

bool OAICluster::is_snapshot_schedule_identifier_Valid() const{
    return m_snapshot_schedule_identifier_isValid;
}

OAIScheduleState OAICluster::getSnapshotScheduleState() const {
    return m_snapshot_schedule_state;
}
void OAICluster::setSnapshotScheduleState(const OAIScheduleState &snapshot_schedule_state) {
    m_snapshot_schedule_state = snapshot_schedule_state;
    m_snapshot_schedule_state_isSet = true;
}

bool OAICluster::is_snapshot_schedule_state_Set() const{
    return m_snapshot_schedule_state_isSet;
}

bool OAICluster::is_snapshot_schedule_state_Valid() const{
    return m_snapshot_schedule_state_isValid;
}

QDateTime OAICluster::getExpectedNextSnapshotScheduleTime() const {
    return m_expected_next_snapshot_schedule_time;
}
void OAICluster::setExpectedNextSnapshotScheduleTime(const QDateTime &expected_next_snapshot_schedule_time) {
...
bool OAICluster::is_expected_next_snapshot_schedule_time_Set() const{
    return m_expected_next_snapshot_schedule_time_isSet;
}

bool OAICluster::is_expected_next_snapshot_schedule_time_Valid() const{
    return m_expected_next_snapshot_schedule_time_isValid;
}

QString OAICluster::getExpectedNextSnapshotScheduleTimeStatus() const {
    return m_expected_next_snapshot_schedule_time_status;
}
void OAICluster::setExpectedNextSnapshotScheduleTimeStatus(const QString &expected_next_snapshot_schedule_time_status) {
...
bool OAICluster::is_expected_next_snapshot_schedule_time_status_Set() const{
    return m_expected_next_snapshot_schedule_time_status_isSet;
}

bool OAICluster::is_expected_next_snapshot_schedule_time_status_Valid() const{
    return m_expected_next_snapshot_schedule_time_status_isValid;
}

QDateTime OAICluster::getNextMaintenanceWindowStartTime() const {
    return m_next_maintenance_window_start_time;
}
void OAICluster::setNextMaintenanceWindowStartTime(const QDateTime &next_maintenance_window_start_time) {
    m_next_maintenance_window_start_time = next_maintenance_window_start_time;
    m_next_maintenance_window_start_time_isSet = true;
}

bool OAICluster::is_next_maintenance_window_start_time_Set() const{
    return m_next_maintenance_window_start_time_isSet;
}

bool OAICluster::is_next_maintenance_window_start_time_Valid() const{
    return m_next_maintenance_window_start_time_isValid;
}

OAICluster_ResizeInfo OAICluster::getResizeInfo() const {
    return m_resize_info;
}
void OAICluster::setResizeInfo(const OAICluster_ResizeInfo &resize_info) {
    m_resize_info = resize_info;
    m_resize_info_isSet = true;
}

bool OAICluster::is_resize_info_Set() const{
    return m_resize_info_isSet;
}

bool OAICluster::is_resize_info_Valid() const{
    return m_resize_info_isValid;
}

QString OAICluster::getAvailabilityZoneRelocationStatus() const {
    return m_availability_zone_relocation_status;
}
void OAICluster::setAvailabilityZoneRelocationStatus(const QString &availability_zone_relocation_status) {
...
bool OAICluster::is_availability_zone_relocation_status_Set() const{
    return m_availability_zone_relocation_status_isSet;
}

bool OAICluster::is_availability_zone_relocation_status_Valid() const{
    return m_availability_zone_relocation_status_isValid;
}

QString OAICluster::getClusterNamespaceArn() const {
    return m_cluster_namespace_arn;
}
void OAICluster::setClusterNamespaceArn(const QString &cluster_namespace_arn) {
    m_cluster_namespace_arn = cluster_namespace_arn;
    m_cluster_namespace_arn_isSet = true;
}

bool OAICluster::is_cluster_namespace_arn_Set() const{
    return m_cluster_namespace_arn_isSet;
}

bool OAICluster::is_cluster_namespace_arn_Valid() const{
    return m_cluster_namespace_arn_isValid;
}

qint32 OAICluster::getTotalStorageCapacityInMegaBytes() const {
    return m_total_storage_capacity_in_mega_bytes;
}
void OAICluster::setTotalStorageCapacityInMegaBytes(const qint32 &total_storage_capacity_in_mega_bytes) {
...
bool OAICluster::is_total_storage_capacity_in_mega_bytes_Set() const{
    return m_total_storage_capacity_in_mega_bytes_isSet;
}

bool OAICluster::is_total_storage_capacity_in_mega_bytes_Valid() const{
    return m_total_storage_capacity_in_mega_bytes_isValid;
}

OAICluster_AquaConfiguration OAICluster::getAquaConfiguration() const {
    return m_aqua_configuration;
}
void OAICluster::setAquaConfiguration(const OAICluster_AquaConfiguration &aqua_configuration) {
    m_aqua_configuration = aqua_configuration;
    m_aqua_configuration_isSet = true;
}

bool OAICluster::is_aqua_configuration_Set() const{
    return m_aqua_configuration_isSet;
}

bool OAICluster::is_aqua_configuration_Valid() const{
    return m_aqua_configuration_isValid;
}

QString OAICluster::getDefaultIamRoleArn() const {
    return m_default_iam_role_arn;
}
void OAICluster::setDefaultIamRoleArn(const QString &default_iam_role_arn) {
    m_default_iam_role_arn = default_iam_role_arn;
    m_default_iam_role_arn_isSet = true;
}

bool OAICluster::is_default_iam_role_arn_Set() const{
    return m_default_iam_role_arn_isSet;
}

bool OAICluster::is_default_iam_role_arn_Valid() const{
    return m_default_iam_role_arn_isValid;
}

OAICluster_ReservedNodeExchangeStatus OAICluster::getReservedNodeExchangeStatus() const {
    return m_reserved_node_exchange_status;
}
void OAICluster::setReservedNodeExchangeStatus(const OAICluster_ReservedNodeExchangeStatus &reserved_node_exchange_status) {
    m_reserved_node_exchange_status = reserved_node_exchange_status;
    m_reserved_node_exchange_status_isSet = true;
}

bool OAICluster::is_reserved_node_exchange_status_Set() const{
    return m_reserved_node_exchange_status_isSet;
}

bool OAICluster::is_reserved_node_exchange_status_Valid() const{
    return m_reserved_node_exchange_status_isValid;
}

QString OAICluster::getCustomDomainName() const {
    return m_custom_domain_name;
}
void OAICluster::setCustomDomainName(const QString &custom_domain_name) {
    m_custom_domain_name = custom_domain_name;
    m_custom_domain_name_isSet = true;
}

bool OAICluster::is_custom_domain_name_Set() const{
    return m_custom_domain_name_isSet;
}

bool OAICluster::is_custom_domain_name_Valid() const{
    return m_custom_domain_name_isValid;
}

QString OAICluster::getCustomDomainCertificateArn() const {
    return m_custom_domain_certificate_arn;
}
void OAICluster::setCustomDomainCertificateArn(const QString &custom_domain_certificate_arn) {
    m_custom_domain_certificate_arn = custom_domain_certificate_arn;
    m_custom_domain_certificate_arn_isSet = true;
}

bool OAICluster::is_custom_domain_certificate_arn_Set() const{
    return m_custom_domain_certificate_arn_isSet;
}

bool OAICluster::is_custom_domain_certificate_arn_Valid() const{
    return m_custom_domain_certificate_arn_isValid;
}

QDateTime OAICluster::getCustomDomainCertificateExpiryDate() const {
    return m_custom_domain_certificate_expiry_date;
}
void OAICluster::setCustomDomainCertificateExpiryDate(const QDateTime &custom_domain_certificate_expiry_date) {
...
bool OAICluster::is_custom_domain_certificate_expiry_date_Set() const{
    return m_custom_domain_certificate_expiry_date_isSet;
}

bool OAICluster::is_custom_domain_certificate_expiry_date_Valid() const{
