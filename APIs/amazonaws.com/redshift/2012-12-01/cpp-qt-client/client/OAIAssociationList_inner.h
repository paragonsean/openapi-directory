...
/*
 * OAIAssociationList_inner.h
 *
 * 
 */

#ifndef OAIAssociationList_inner_H
#define OAIAssociationList_inner_H
...
class OAIAssociationList_inner : public OAIObject {
public:
    OAIAssociationList_inner();
    OAIAssociationList_inner(QString json);
    ~OAIAssociationList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociationList_inner)

#endif // OAIAssociationList_inner_H
