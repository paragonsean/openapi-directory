...
/*
 * OAICluster_PendingModifiedValues.h
 *
 * 
 */

#ifndef OAICluster_PendingModifiedValues_H
#define OAICluster_PendingModifiedValues_H
...
class OAICluster_PendingModifiedValues : public OAIObject {
public:
    OAICluster_PendingModifiedValues();
    OAICluster_PendingModifiedValues(QString json);
    ~OAICluster_PendingModifiedValues() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICluster_PendingModifiedValues)

#endif // OAICluster_PendingModifiedValues_H
