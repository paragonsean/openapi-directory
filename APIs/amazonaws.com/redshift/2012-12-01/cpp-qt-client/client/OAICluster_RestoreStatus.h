...
/*
 * OAICluster_RestoreStatus.h
 *
 * 
 */

#ifndef OAICluster_RestoreStatus_H
#define OAICluster_RestoreStatus_H
...
class OAICluster_RestoreStatus : public OAIObject {
public:
    OAICluster_RestoreStatus();
    OAICluster_RestoreStatus(QString json);
    ~OAICluster_RestoreStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICluster_RestoreStatus)

#endif // OAICluster_RestoreStatus_H
