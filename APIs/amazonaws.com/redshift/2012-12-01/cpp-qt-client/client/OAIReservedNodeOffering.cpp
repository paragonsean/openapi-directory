...
OAIReservedNodeOffering::OAIReservedNodeOffering(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReservedNodeOffering::OAIReservedNodeOffering() {
    this->initializeModel();
}

OAIReservedNodeOffering::~OAIReservedNodeOffering() {}

void OAIReservedNodeOffering::initializeModel() {
...
void OAIReservedNodeOffering::fromJson(QString jsonString) {
...
void OAIReservedNodeOffering::fromJsonObject(QJsonObject json) {
...
QString OAIReservedNodeOffering::asJson() const {
...
QJsonObject OAIReservedNodeOffering::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReservedNodeOffering::getReservedNodeOfferingId() const {
    return m_reserved_node_offering_id;
}
void OAIReservedNodeOffering::setReservedNodeOfferingId(const QString &reserved_node_offering_id) {
    m_reserved_node_offering_id = reserved_node_offering_id;
    m_reserved_node_offering_id_isSet = true;
}

bool OAIReservedNodeOffering::is_reserved_node_offering_id_Set() const{
    return m_reserved_node_offering_id_isSet;
}

bool OAIReservedNodeOffering::is_reserved_node_offering_id_Valid() const{
    return m_reserved_node_offering_id_isValid;
}

QString OAIReservedNodeOffering::getNodeType() const {
    return m_node_type;
}
void OAIReservedNodeOffering::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAIReservedNodeOffering::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAIReservedNodeOffering::is_node_type_Valid() const{
    return m_node_type_isValid;
}

qint32 OAIReservedNodeOffering::getDuration() const {
    return m_duration;
}
void OAIReservedNodeOffering::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIReservedNodeOffering::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIReservedNodeOffering::is_duration_Valid() const{
    return m_duration_isValid;
}

double OAIReservedNodeOffering::getFixedPrice() const {
    return m_fixed_price;
}
void OAIReservedNodeOffering::setFixedPrice(const double &fixed_price) {
    m_fixed_price = fixed_price;
    m_fixed_price_isSet = true;
}

bool OAIReservedNodeOffering::is_fixed_price_Set() const{
    return m_fixed_price_isSet;
}

bool OAIReservedNodeOffering::is_fixed_price_Valid() const{
    return m_fixed_price_isValid;
}

double OAIReservedNodeOffering::getUsagePrice() const {
    return m_usage_price;
}
void OAIReservedNodeOffering::setUsagePrice(const double &usage_price) {
    m_usage_price = usage_price;
    m_usage_price_isSet = true;
}

bool OAIReservedNodeOffering::is_usage_price_Set() const{
    return m_usage_price_isSet;
}

bool OAIReservedNodeOffering::is_usage_price_Valid() const{
    return m_usage_price_isValid;
}

QString OAIReservedNodeOffering::getCurrencyCode() const {
    return m_currency_code;
}
void OAIReservedNodeOffering::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIReservedNodeOffering::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIReservedNodeOffering::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

QString OAIReservedNodeOffering::getOfferingType() const {
    return m_offering_type;
}
void OAIReservedNodeOffering::setOfferingType(const QString &offering_type) {
    m_offering_type = offering_type;
    m_offering_type_isSet = true;
}

bool OAIReservedNodeOffering::is_offering_type_Set() const{
    return m_offering_type_isSet;
}

bool OAIReservedNodeOffering::is_offering_type_Valid() const{
    return m_offering_type_isValid;
}

QList OAIReservedNodeOffering::getRecurringCharges() const {
    return m_recurring_charges;
}
void OAIReservedNodeOffering::setRecurringCharges(const QList &recurring_charges) {
    m_recurring_charges = recurring_charges;
    m_recurring_charges_isSet = true;
}

bool OAIReservedNodeOffering::is_recurring_charges_Set() const{
    return m_recurring_charges_isSet;
}

bool OAIReservedNodeOffering::is_recurring_charges_Valid() const{
    return m_recurring_charges_isValid;
}

OAIReservedNodeOfferingType OAIReservedNodeOffering::getReservedNodeOfferingType() const {
    return m_reserved_node_offering_type;
}
void OAIReservedNodeOffering::setReservedNodeOfferingType(const OAIReservedNodeOfferingType &reserved_node_offering_type) {
    m_reserved_node_offering_type = reserved_node_offering_type;
    m_reserved_node_offering_type_isSet = true;
}

bool OAIReservedNodeOffering::is_reserved_node_offering_type_Set() const{
    return m_reserved_node_offering_type_isSet;
}

bool OAIReservedNodeOffering::is_reserved_node_offering_type_Valid() const{
    return m_reserved_node_offering_type_isValid;
}

bool OAIReservedNodeOffering::isSet() const {
...
bool OAIReservedNodeOffering::isValid() const {
