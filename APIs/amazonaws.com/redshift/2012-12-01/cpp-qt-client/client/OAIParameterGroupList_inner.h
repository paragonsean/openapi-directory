...
/*
 * OAIParameterGroupList_inner.h
 *
 * 
 */

#ifndef OAIParameterGroupList_inner_H
#define OAIParameterGroupList_inner_H
...
class OAIParameterGroupList_inner : public OAIObject {
public:
    OAIParameterGroupList_inner();
    OAIParameterGroupList_inner(QString json);
    ~OAIParameterGroupList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIParameterGroupList_inner)

#endif // OAIParameterGroupList_inner_H
