...
QString OAIPendingModifiedValues::getNodeType() const {
    return m_node_type;
}
void OAIPendingModifiedValues::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAIPendingModifiedValues::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAIPendingModifiedValues::is_node_type_Valid() const{
    return m_node_type_isValid;
}

qint32 OAIPendingModifiedValues::getNumberOfNodes() const {
    return m_number_of_nodes;
}
void OAIPendingModifiedValues::setNumberOfNodes(const qint32 &number_of_nodes) {
    m_number_of_nodes = number_of_nodes;
    m_number_of_nodes_isSet = true;
}

bool OAIPendingModifiedValues::is_number_of_nodes_Set() const{
    return m_number_of_nodes_isSet;
}

bool OAIPendingModifiedValues::is_number_of_nodes_Valid() const{
    return m_number_of_nodes_isValid;
}

QString OAIPendingModifiedValues::getClusterType() const {
    return m_cluster_type;
}
void OAIPendingModifiedValues::setClusterType(const QString &cluster_type) {
    m_cluster_type = cluster_type;
    m_cluster_type_isSet = true;
}

bool OAIPendingModifiedValues::is_cluster_type_Set() const{
    return m_cluster_type_isSet;
}

bool OAIPendingModifiedValues::is_cluster_type_Valid() const{
    return m_cluster_type_isValid;
}

QString OAIPendingModifiedValues::getClusterVersion() const {
    return m_cluster_version;
}
void OAIPendingModifiedValues::setClusterVersion(const QString &cluster_version) {
    m_cluster_version = cluster_version;
    m_cluster_version_isSet = true;
}

bool OAIPendingModifiedValues::is_cluster_version_Set() const{
    return m_cluster_version_isSet;
}

bool OAIPendingModifiedValues::is_cluster_version_Valid() const{
    return m_cluster_version_isValid;
}

qint32 OAIPendingModifiedValues::getAutomatedSnapshotRetentionPeriod() const {
    return m_automated_snapshot_retention_period;
}
void OAIPendingModifiedValues::setAutomatedSnapshotRetentionPeriod(const qint32 &automated_snapshot_retention_period) {
...
bool OAIPendingModifiedValues::is_automated_snapshot_retention_period_Set() const{
    return m_automated_snapshot_retention_period_isSet;
}

bool OAIPendingModifiedValues::is_automated_snapshot_retention_period_Valid() const{
    return m_automated_snapshot_retention_period_isValid;
}

QString OAIPendingModifiedValues::getClusterIdentifier() const {
    return m_cluster_identifier;
}
void OAIPendingModifiedValues::setClusterIdentifier(const QString &cluster_identifier) {
    m_cluster_identifier = cluster_identifier;
    m_cluster_identifier_isSet = true;
}

bool OAIPendingModifiedValues::is_cluster_identifier_Set() const{
    return m_cluster_identifier_isSet;
}

bool OAIPendingModifiedValues::is_cluster_identifier_Valid() const{
    return m_cluster_identifier_isValid;
}

bool OAIPendingModifiedValues::getPubliclyAccessible() const {
    return m_publicly_accessible;
}
void OAIPendingModifiedValues::setPubliclyAccessible(const bool &publicly_accessible) {
    m_publicly_accessible = publicly_accessible;
    m_publicly_accessible_isSet = true;
}

bool OAIPendingModifiedValues::is_publicly_accessible_Set() const{
    return m_publicly_accessible_isSet;
}

bool OAIPendingModifiedValues::is_publicly_accessible_Valid() const{
    return m_publicly_accessible_isValid;
}

bool OAIPendingModifiedValues::getEnhancedVpcRouting() const {
    return m_enhanced_vpc_routing;
}
void OAIPendingModifiedValues::setEnhancedVpcRouting(const bool &enhanced_vpc_routing) {
    m_enhanced_vpc_routing = enhanced_vpc_routing;
    m_enhanced_vpc_routing_isSet = true;
}

bool OAIPendingModifiedValues::is_enhanced_vpc_routing_Set() const{
    return m_enhanced_vpc_routing_isSet;
}

bool OAIPendingModifiedValues::is_enhanced_vpc_routing_Valid() const{
    return m_enhanced_vpc_routing_isValid;
}

QString OAIPendingModifiedValues::getMaintenanceTrackName() const {
    return m_maintenance_track_name;
}
void OAIPendingModifiedValues::setMaintenanceTrackName(const QString &maintenance_track_name) {
    m_maintenance_track_name = maintenance_track_name;
    m_maintenance_track_name_isSet = true;
}

bool OAIPendingModifiedValues::is_maintenance_track_name_Set() const{
    return m_maintenance_track_name_isSet;
}

bool OAIPendingModifiedValues::is_maintenance_track_name_Valid() const{
    return m_maintenance_track_name_isValid;
}

QString OAIPendingModifiedValues::getEncryptionType() const {
    return m_encryption_type;
}
void OAIPendingModifiedValues::setEncryptionType(const QString &encryption_type) {
    m_encryption_type = encryption_type;
    m_encryption_type_isSet = true;
}

bool OAIPendingModifiedValues::is_encryption_type_Set() const{
    return m_encryption_type_isSet;
}

bool OAIPendingModifiedValues::is_encryption_type_Valid() const{
