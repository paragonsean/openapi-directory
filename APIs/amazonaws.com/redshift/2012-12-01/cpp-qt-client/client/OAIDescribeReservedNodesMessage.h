...
/*
 * OAIDescribeReservedNodesMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeReservedNodesMessage_H
#define OAIDescribeReservedNodesMessage_H
...
class OAIDescribeReservedNodesMessage : public OAIObject {
public:
    OAIDescribeReservedNodesMessage();
    OAIDescribeReservedNodesMessage(QString json);
    ~OAIDescribeReservedNodesMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeReservedNodesMessage)

#endif // OAIDescribeReservedNodesMessage_H
