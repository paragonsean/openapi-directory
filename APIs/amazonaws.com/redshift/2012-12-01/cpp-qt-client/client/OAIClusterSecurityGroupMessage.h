...
/*
 * OAIClusterSecurityGroupMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIClusterSecurityGroupMessage_H
#define OAIClusterSecurityGroupMessage_H
...
class OAIClusterSecurityGroupMessage : public OAIObject {
public:
    OAIClusterSecurityGroupMessage();
    OAIClusterSecurityGroupMessage(QString json);
    ~OAIClusterSecurityGroupMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterSecurityGroupMessage)

#endif // OAIClusterSecurityGroupMessage_H
