...
/*
 * OAIGetReservedNodeExchangeConfigurationOptionsInputMessage.h
 *
 * 
 */

#ifndef OAIGetReservedNodeExchangeConfigurationOptionsInputMessage_H
#define OAIGetReservedNodeExchangeConfigurationOptionsInputMessage_H
...
class OAIGetReservedNodeExchangeConfigurationOptionsInputMessage : public OAIObject {
public:
    OAIGetReservedNodeExchangeConfigurationOptionsInputMessage();
    OAIGetReservedNodeExchangeConfigurationOptionsInputMessage(QString json);
    ~OAIGetReservedNodeExchangeConfigurationOptionsInputMessage() override;
    ...
    OAIReservedNodeExchangeActionType getActionType() const;
    void setActionType(const OAIReservedNodeExchangeActionType &action_type);
...
private:
    ...
    OAIReservedNodeExchangeActionType m_action_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetReservedNodeExchangeConfigurationOptionsInputMessage)

#endif // OAIGetReservedNodeExchangeConfigurationOptionsInputMessage_H
