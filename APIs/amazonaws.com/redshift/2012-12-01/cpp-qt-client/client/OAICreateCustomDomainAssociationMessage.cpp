...
OAICreateCustomDomainAssociationMessage::OAICreateCustomDomainAssociationMessage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateCustomDomainAssociationMessage::OAICreateCustomDomainAssociationMessage() {
    this->initializeModel();
}

OAICreateCustomDomainAssociationMessage::~OAICreateCustomDomainAssociationMessage() {}

void OAICreateCustomDomainAssociationMessage::initializeModel() {
...
void OAICreateCustomDomainAssociationMessage::fromJson(QString jsonString) {
...
void OAICreateCustomDomainAssociationMessage::fromJsonObject(QJsonObject json) {
...
QString OAICreateCustomDomainAssociationMessage::asJson() const {
...
QJsonObject OAICreateCustomDomainAssociationMessage::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateCustomDomainAssociationMessage::getCustomDomainName() const {
    return m_custom_domain_name;
}
void OAICreateCustomDomainAssociationMessage::setCustomDomainName(const QString &custom_domain_name) {
    m_custom_domain_name = custom_domain_name;
    m_custom_domain_name_isSet = true;
}

bool OAICreateCustomDomainAssociationMessage::is_custom_domain_name_Set() const{
    return m_custom_domain_name_isSet;
}

bool OAICreateCustomDomainAssociationMessage::is_custom_domain_name_Valid() const{
    return m_custom_domain_name_isValid;
}

QString OAICreateCustomDomainAssociationMessage::getCustomDomainCertificateArn() const {
    return m_custom_domain_certificate_arn;
}
void OAICreateCustomDomainAssociationMessage::setCustomDomainCertificateArn(const QString &custom_domain_certificate_arn) {
    m_custom_domain_certificate_arn = custom_domain_certificate_arn;
    m_custom_domain_certificate_arn_isSet = true;
}

bool OAICreateCustomDomainAssociationMessage::is_custom_domain_certificate_arn_Set() const{
    return m_custom_domain_certificate_arn_isSet;
}

bool OAICreateCustomDomainAssociationMessage::is_custom_domain_certificate_arn_Valid() const{
    return m_custom_domain_certificate_arn_isValid;
}

QString OAICreateCustomDomainAssociationMessage::getClusterIdentifier() const {
    return m_cluster_identifier;
}
void OAICreateCustomDomainAssociationMessage::setClusterIdentifier(const QString &cluster_identifier) {
    m_cluster_identifier = cluster_identifier;
    m_cluster_identifier_isSet = true;
}

bool OAICreateCustomDomainAssociationMessage::is_cluster_identifier_Set() const{
    return m_cluster_identifier_isSet;
}

bool OAICreateCustomDomainAssociationMessage::is_cluster_identifier_Valid() const{
    return m_cluster_identifier_isValid;
}

bool OAICreateCustomDomainAssociationMessage::isSet() const {
...
bool OAICreateCustomDomainAssociationMessage::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_custom_domain_name_isValid && m_custom_domain_certificate_arn_isValid && m_cluster_identifier_isValid && true;
}
