...
/*
 * OAICreateEndpointAccessMessage.h
 *
 * 
 */

#ifndef OAICreateEndpointAccessMessage_H
#define OAICreateEndpointAccessMessage_H
...
class OAICreateEndpointAccessMessage : public OAIObject {
public:
    OAICreateEndpointAccessMessage();
    OAICreateEndpointAccessMessage(QString json);
    ~OAICreateEndpointAccessMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEndpointAccessMessage)

#endif // OAICreateEndpointAccessMessage_H
