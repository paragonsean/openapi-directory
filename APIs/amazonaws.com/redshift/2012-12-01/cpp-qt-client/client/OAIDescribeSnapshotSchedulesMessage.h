...
/*
 * OAIDescribeSnapshotSchedulesMessage.h
 *
 * 
 */

#ifndef OAIDescribeSnapshotSchedulesMessage_H
#define OAIDescribeSnapshotSchedulesMessage_H
...
class OAIDescribeSnapshotSchedulesMessage : public OAIObject {
public:
    OAIDescribeSnapshotSchedulesMessage();
    OAIDescribeSnapshotSchedulesMessage(QString json);
    ~OAIDescribeSnapshotSchedulesMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSnapshotSchedulesMessage)

#endif // OAIDescribeSnapshotSchedulesMessage_H
