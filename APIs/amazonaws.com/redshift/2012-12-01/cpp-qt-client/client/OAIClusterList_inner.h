...
/*
 * OAIClusterList_inner.h
 *
 * 
 */

#ifndef OAIClusterList_inner_H
#define OAIClusterList_inner_H
...
class OAIClusterList_inner : public OAIObject {
public:
    OAIClusterList_inner();
    OAIClusterList_inner(QString json);
    ~OAIClusterList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterList_inner)

#endif // OAIClusterList_inner_H
