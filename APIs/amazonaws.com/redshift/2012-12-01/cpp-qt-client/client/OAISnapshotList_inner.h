...
/*
 * OAISnapshotList_inner.h
 *
 * 
 */

#ifndef OAISnapshotList_inner_H
#define OAISnapshotList_inner_H
...
class OAISnapshotList_inner : public OAIObject {
public:
    OAISnapshotList_inner();
    OAISnapshotList_inner(QString json);
    ~OAISnapshotList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISnapshotList_inner)

#endif // OAISnapshotList_inner_H
