...
/*
 * OAIDescribeTableRestoreStatusMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeTableRestoreStatusMessage_H
#define OAIDescribeTableRestoreStatusMessage_H
...
class OAIDescribeTableRestoreStatusMessage : public OAIObject {
public:
    OAIDescribeTableRestoreStatusMessage();
    OAIDescribeTableRestoreStatusMessage(QString json);
    ~OAIDescribeTableRestoreStatusMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeTableRestoreStatusMessage)

#endif // OAIDescribeTableRestoreStatusMessage_H
