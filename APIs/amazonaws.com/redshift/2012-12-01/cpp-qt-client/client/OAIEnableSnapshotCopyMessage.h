...
/*
 * OAIEnableSnapshotCopyMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIEnableSnapshotCopyMessage_H
#define OAIEnableSnapshotCopyMessage_H
...
class OAIEnableSnapshotCopyMessage : public OAIObject {
public:
    OAIEnableSnapshotCopyMessage();
    OAIEnableSnapshotCopyMessage(QString json);
    ~OAIEnableSnapshotCopyMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnableSnapshotCopyMessage)

#endif // OAIEnableSnapshotCopyMessage_H
