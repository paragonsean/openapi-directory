...
/*
 * OAIUpdatePartnerStatusInputMessage.h
 *
 * 
 */

#ifndef OAIUpdatePartnerStatusInputMessage_H
#define OAIUpdatePartnerStatusInputMessage_H
...
class OAIUpdatePartnerStatusInputMessage : public OAIObject {
public:
    OAIUpdatePartnerStatusInputMessage();
    OAIUpdatePartnerStatusInputMessage(QString json);
    ~OAIUpdatePartnerStatusInputMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePartnerStatusInputMessage)

#endif // OAIUpdatePartnerStatusInputMessage_H
