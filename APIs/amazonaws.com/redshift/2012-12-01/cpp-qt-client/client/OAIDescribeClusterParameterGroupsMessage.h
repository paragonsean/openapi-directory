...
/*
 * OAIDescribeClusterParameterGroupsMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeClusterParameterGroupsMessage_H
#define OAIDescribeClusterParameterGroupsMessage_H
...
class OAIDescribeClusterParameterGroupsMessage : public OAIObject {
public:
    OAIDescribeClusterParameterGroupsMessage();
    OAIDescribeClusterParameterGroupsMessage(QString json);
    ~OAIDescribeClusterParameterGroupsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClusterParameterGroupsMessage)

#endif // OAIDescribeClusterParameterGroupsMessage_H
