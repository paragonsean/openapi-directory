...
#ifndef OAITaggedResource_H
#define OAITaggedResource_H
...
class OAITaggedResource : public OAIObject {
public:
    OAITaggedResource();
    OAITaggedResource(QString json);
    ~OAITaggedResource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITaggedResource)

#endif // OAITaggedResource_H
