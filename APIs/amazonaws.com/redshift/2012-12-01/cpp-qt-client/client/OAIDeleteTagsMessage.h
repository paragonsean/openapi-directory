...
/*
 * OAIDeleteTagsMessage.h
 *
 * Contains the output from the &lt;code&gt;DeleteTags&lt;/code&gt; action. 
 */

#ifndef OAIDeleteTagsMessage_H
#define OAIDeleteTagsMessage_H
...
class OAIDeleteTagsMessage : public OAIObject {
public:
    OAIDeleteTagsMessage();
    OAIDeleteTagsMessage(QString json);
    ~OAIDeleteTagsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteTagsMessage)

#endif // OAIDeleteTagsMessage_H
