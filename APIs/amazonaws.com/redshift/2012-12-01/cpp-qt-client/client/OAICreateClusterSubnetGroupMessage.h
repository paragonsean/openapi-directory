...
/*
 * OAICreateClusterSubnetGroupMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAICreateClusterSubnetGroupMessage_H
#define OAICreateClusterSubnetGroupMessage_H
...
class OAICreateClusterSubnetGroupMessage : public OAIObject {
public:
    OAICreateClusterSubnetGroupMessage();
    OAICreateClusterSubnetGroupMessage(QString json);
    ~OAICreateClusterSubnetGroupMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterSubnetGroupMessage)

#endif // OAICreateClusterSubnetGroupMessage_H
