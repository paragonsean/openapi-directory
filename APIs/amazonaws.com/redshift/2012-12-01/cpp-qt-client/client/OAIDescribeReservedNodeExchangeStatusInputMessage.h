...
/*
 * OAIDescribeReservedNodeExchangeStatusInputMessage.h
 *
 * 
 */

#ifndef OAIDescribeReservedNodeExchangeStatusInputMessage_H
#define OAIDescribeReservedNodeExchangeStatusInputMessage_H
...
class OAIDescribeReservedNodeExchangeStatusInputMessage : public OAIObject {
public:
    OAIDescribeReservedNodeExchangeStatusInputMessage();
    OAIDescribeReservedNodeExchangeStatusInputMessage(QString json);
    ~OAIDescribeReservedNodeExchangeStatusInputMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeReservedNodeExchangeStatusInputMessage)

#endif // OAIDescribeReservedNodeExchangeStatusInputMessage_H
