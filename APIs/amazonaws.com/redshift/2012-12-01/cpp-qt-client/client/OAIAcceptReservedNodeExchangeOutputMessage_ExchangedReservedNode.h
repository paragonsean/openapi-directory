...
/*
 * OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode.h
 *
 * 
 */

#ifndef OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode_H
#define OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode_H
...
class OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode : public OAIObject {
public:
    OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode();
    OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode(QString json);
    ~OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode)

#endif // OAIAcceptReservedNodeExchangeOutputMessage_ExchangedReservedNode_H
