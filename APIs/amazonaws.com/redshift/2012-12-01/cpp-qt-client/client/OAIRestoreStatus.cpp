...
OAIRestoreStatus::OAIRestoreStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRestoreStatus::OAIRestoreStatus() {
    this->initializeModel();
}

OAIRestoreStatus::~OAIRestoreStatus() {}

void OAIRestoreStatus::initializeModel() {
...
void OAIRestoreStatus::fromJson(QString jsonString) {
...
void OAIRestoreStatus::fromJsonObject(QJsonObject json) {
...
QString OAIRestoreStatus::asJson() const {
...
QJsonObject OAIRestoreStatus::asJsonObject() const {
    QJsonObject obj;
    if (m_status_isSet) {
...
QString OAIRestoreStatus::getStatus() const {
    return m_status;
}
void OAIRestoreStatus::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIRestoreStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIRestoreStatus::is_status_Valid() const{
    return m_status_isValid;
}

double OAIRestoreStatus::getCurrentRestoreRateInMegaBytesPerSecond() const {
    return m_current_restore_rate_in_mega_bytes_per_second;
}
void OAIRestoreStatus::setCurrentRestoreRateInMegaBytesPerSecond(const double &current_restore_rate_in_mega_bytes_per_second) {
...
bool OAIRestoreStatus::is_current_restore_rate_in_mega_bytes_per_second_Set() const{
    return m_current_restore_rate_in_mega_bytes_per_second_isSet;
}

bool OAIRestoreStatus::is_current_restore_rate_in_mega_bytes_per_second_Valid() const{
    return m_current_restore_rate_in_mega_bytes_per_second_isValid;
}

qint32 OAIRestoreStatus::getSnapshotSizeInMegaBytes() const {
    return m_snapshot_size_in_mega_bytes;
}
void OAIRestoreStatus::setSnapshotSizeInMegaBytes(const qint32 &snapshot_size_in_mega_bytes) {
    m_snapshot_size_in_mega_bytes = snapshot_size_in_mega_bytes;
    m_snapshot_size_in_mega_bytes_isSet = true;
}

bool OAIRestoreStatus::is_snapshot_size_in_mega_bytes_Set() const{
    return m_snapshot_size_in_mega_bytes_isSet;
}

bool OAIRestoreStatus::is_snapshot_size_in_mega_bytes_Valid() const{
    return m_snapshot_size_in_mega_bytes_isValid;
}

qint32 OAIRestoreStatus::getProgressInMegaBytes() const {
    return m_progress_in_mega_bytes;
}
void OAIRestoreStatus::setProgressInMegaBytes(const qint32 &progress_in_mega_bytes) {
    m_progress_in_mega_bytes = progress_in_mega_bytes;
    m_progress_in_mega_bytes_isSet = true;
}

bool OAIRestoreStatus::is_progress_in_mega_bytes_Set() const{
    return m_progress_in_mega_bytes_isSet;
}

bool OAIRestoreStatus::is_progress_in_mega_bytes_Valid() const{
    return m_progress_in_mega_bytes_isValid;
}

qint32 OAIRestoreStatus::getElapsedTimeInSeconds() const {
    return m_elapsed_time_in_seconds;
}
void OAIRestoreStatus::setElapsedTimeInSeconds(const qint32 &elapsed_time_in_seconds) {
    m_elapsed_time_in_seconds = elapsed_time_in_seconds;
    m_elapsed_time_in_seconds_isSet = true;
}

bool OAIRestoreStatus::is_elapsed_time_in_seconds_Set() const{
    return m_elapsed_time_in_seconds_isSet;
}

bool OAIRestoreStatus::is_elapsed_time_in_seconds_Valid() const{
    return m_elapsed_time_in_seconds_isValid;
}

qint32 OAIRestoreStatus::getEstimatedTimeToCompletionInSeconds() const {
    return m_estimated_time_to_completion_in_seconds;
}
void OAIRestoreStatus::setEstimatedTimeToCompletionInSeconds(const qint32 &estimated_time_to_completion_in_seconds) {
...
bool OAIRestoreStatus::is_estimated_time_to_completion_in_seconds_Set() const{
    return m_estimated_time_to_completion_in_seconds_isSet;
}

bool OAIRestoreStatus::is_estimated_time_to_completion_in_seconds_Valid() const{
    return m_estimated_time_to_completion_in_seconds_isValid;
}

bool OAIRestoreStatus::isSet() const {
...
bool OAIRestoreStatus::isValid() const {
