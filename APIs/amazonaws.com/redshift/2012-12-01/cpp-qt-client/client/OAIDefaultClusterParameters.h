...
/*
 * OAIDefaultClusterParameters.h
 *
 * Describes the default cluster parameters for a parameter group family.
 */

#ifndef OAIDefaultClusterParameters_H
#define OAIDefaultClusterParameters_H
...
class OAIDefaultClusterParameters : public OAIObject {
public:
    OAIDefaultClusterParameters();
    OAIDefaultClusterParameters(QString json);
    ~OAIDefaultClusterParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDefaultClusterParameters)

#endif // OAIDefaultClusterParameters_H
