...
/*
 * OAICluster_ReservedNodeExchangeStatus.h
 *
 * 
 */

#ifndef OAICluster_ReservedNodeExchangeStatus_H
#define OAICluster_ReservedNodeExchangeStatus_H
...
class OAICluster_ReservedNodeExchangeStatus : public OAIObject {
public:
    OAICluster_ReservedNodeExchangeStatus();
    OAICluster_ReservedNodeExchangeStatus(QString json);
    ~OAICluster_ReservedNodeExchangeStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICluster_ReservedNodeExchangeStatus)

#endif // OAICluster_ReservedNodeExchangeStatus_H
