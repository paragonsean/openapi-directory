...
#include "OAIReservedNodeOfferingList_inner.h"
...
OAIReservedNodeOfferingList_inner::OAIReservedNodeOfferingList_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReservedNodeOfferingList_inner::OAIReservedNodeOfferingList_inner() {
    this->initializeModel();
}

OAIReservedNodeOfferingList_inner::~OAIReservedNodeOfferingList_inner() {}

void OAIReservedNodeOfferingList_inner::initializeModel() {
...
void OAIReservedNodeOfferingList_inner::fromJson(QString jsonString) {
...
void OAIReservedNodeOfferingList_inner::fromJsonObject(QJsonObject json) {
...
QString OAIReservedNodeOfferingList_inner::asJson() const {
...
QJsonObject OAIReservedNodeOfferingList_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReservedNodeOfferingList_inner::getReservedNodeOfferingId() const {
    return m_reserved_node_offering_id;
}
void OAIReservedNodeOfferingList_inner::setReservedNodeOfferingId(const QString &reserved_node_offering_id) {
    m_reserved_node_offering_id = reserved_node_offering_id;
    m_reserved_node_offering_id_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_reserved_node_offering_id_Set() const{
    return m_reserved_node_offering_id_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_reserved_node_offering_id_Valid() const{
    return m_reserved_node_offering_id_isValid;
}

QString OAIReservedNodeOfferingList_inner::getNodeType() const {
    return m_node_type;
}
void OAIReservedNodeOfferingList_inner::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_node_type_Valid() const{
    return m_node_type_isValid;
}

qint32 OAIReservedNodeOfferingList_inner::getDuration() const {
    return m_duration;
}
void OAIReservedNodeOfferingList_inner::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_duration_Valid() const{
    return m_duration_isValid;
}

double OAIReservedNodeOfferingList_inner::getFixedPrice() const {
    return m_fixed_price;
}
void OAIReservedNodeOfferingList_inner::setFixedPrice(const double &fixed_price) {
    m_fixed_price = fixed_price;
    m_fixed_price_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_fixed_price_Set() const{
    return m_fixed_price_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_fixed_price_Valid() const{
    return m_fixed_price_isValid;
}

double OAIReservedNodeOfferingList_inner::getUsagePrice() const {
    return m_usage_price;
}
void OAIReservedNodeOfferingList_inner::setUsagePrice(const double &usage_price) {
    m_usage_price = usage_price;
    m_usage_price_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_usage_price_Set() const{
    return m_usage_price_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_usage_price_Valid() const{
    return m_usage_price_isValid;
}

QString OAIReservedNodeOfferingList_inner::getCurrencyCode() const {
    return m_currency_code;
}
void OAIReservedNodeOfferingList_inner::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

QString OAIReservedNodeOfferingList_inner::getOfferingType() const {
    return m_offering_type;
}
void OAIReservedNodeOfferingList_inner::setOfferingType(const QString &offering_type) {
    m_offering_type = offering_type;
    m_offering_type_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_offering_type_Set() const{
    return m_offering_type_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_offering_type_Valid() const{
    return m_offering_type_isValid;
}

QList OAIReservedNodeOfferingList_inner::getRecurringCharges() const {
    return m_recurring_charges;
}
void OAIReservedNodeOfferingList_inner::setRecurringCharges(const QList &recurring_charges) {
    m_recurring_charges = recurring_charges;
    m_recurring_charges_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_recurring_charges_Set() const{
    return m_recurring_charges_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_recurring_charges_Valid() const{
    return m_recurring_charges_isValid;
}

OAIReservedNodeOfferingType OAIReservedNodeOfferingList_inner::getReservedNodeOfferingType() const {
    return m_reserved_node_offering_type;
}
void OAIReservedNodeOfferingList_inner::setReservedNodeOfferingType(const OAIReservedNodeOfferingType &reserved_node_offering_type) {
    m_reserved_node_offering_type = reserved_node_offering_type;
    m_reserved_node_offering_type_isSet = true;
}

bool OAIReservedNodeOfferingList_inner::is_reserved_node_offering_type_Set() const{
    return m_reserved_node_offering_type_isSet;
}

bool OAIReservedNodeOfferingList_inner::is_reserved_node_offering_type_Valid() const{
    return m_reserved_node_offering_type_isValid;
}

bool OAIReservedNodeOfferingList_inner::isSet() const {
...
bool OAIReservedNodeOfferingList_inner::isValid() const {
