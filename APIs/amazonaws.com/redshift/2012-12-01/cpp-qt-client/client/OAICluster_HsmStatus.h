...
/*
 * OAICluster_HsmStatus.h
 *
 * 
 */

#ifndef OAICluster_HsmStatus_H
#define OAICluster_HsmStatus_H
...
class OAICluster_HsmStatus : public OAIObject {
public:
    OAICluster_HsmStatus();
    OAICluster_HsmStatus(QString json);
    ~OAICluster_HsmStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICluster_HsmStatus)

#endif // OAICluster_HsmStatus_H
