...
/*
 * OAIRevokeEndpointAccessMessage.h
 *
 * 
 */

#ifndef OAIRevokeEndpointAccessMessage_H
#define OAIRevokeEndpointAccessMessage_H
...
class OAIRevokeEndpointAccessMessage : public OAIObject {
public:
    OAIRevokeEndpointAccessMessage();
    OAIRevokeEndpointAccessMessage(QString json);
    ~OAIRevokeEndpointAccessMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRevokeEndpointAccessMessage)

#endif // OAIRevokeEndpointAccessMessage_H
