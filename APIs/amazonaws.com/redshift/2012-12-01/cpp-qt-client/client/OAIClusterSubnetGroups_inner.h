...
/*
 * OAIClusterSubnetGroups_inner.h
 *
 * 
 */

#ifndef OAIClusterSubnetGroups_inner_H
#define OAIClusterSubnetGroups_inner_H
...
class OAIClusterSubnetGroups_inner : public OAIObject {
public:
    OAIClusterSubnetGroups_inner();
    OAIClusterSubnetGroups_inner(QString json);
    ~OAIClusterSubnetGroups_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterSubnetGroups_inner)

#endif // OAIClusterSubnetGroups_inner_H
