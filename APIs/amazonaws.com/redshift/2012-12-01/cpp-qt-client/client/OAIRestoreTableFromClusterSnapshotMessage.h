...
/*
 * OAIRestoreTableFromClusterSnapshotMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIRestoreTableFromClusterSnapshotMessage_H
#define OAIRestoreTableFromClusterSnapshotMessage_H
...
class OAIRestoreTableFromClusterSnapshotMessage : public OAIObject {
public:
    OAIRestoreTableFromClusterSnapshotMessage();
    OAIRestoreTableFromClusterSnapshotMessage(QString json);
    ~OAIRestoreTableFromClusterSnapshotMessage() override;
    ...
    void setEnableCaseSensitiveIdentifier(const bool &enable_case_sensitive_identifier);
    bool is_enable_case_sensitive_identifier_Set() const;
    bool is_enable_case_sensitive_identifier_Valid() const;
...
private:
    ...
    bool m_enable_case_sensitive_identifier;
    bool m_enable_case_sensitive_identifier_isSet;
    bool m_enable_case_sensitive_identifier_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIRestoreTableFromClusterSnapshotMessage)

#endif // OAIRestoreTableFromClusterSnapshotMessage_H
