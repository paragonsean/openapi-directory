...
void OAIHsmStatus::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIHsmStatus::asJsonObject() const {
    QJsonObject obj;
...
QString OAIHsmStatus::getHsmClientCertificateIdentifier() const {
    return m_hsm_client_certificate_identifier;
}
void OAIHsmStatus::setHsmClientCertificateIdentifier(const QString &hsm_client_certificate_identifier) {
    m_hsm_client_certificate_identifier = hsm_client_certificate_identifier;
    m_hsm_client_certificate_identifier_isSet = true;
}

bool OAIHsmStatus::is_hsm_client_certificate_identifier_Set() const{
    return m_hsm_client_certificate_identifier_isSet;
}

bool OAIHsmStatus::is_hsm_client_certificate_identifier_Valid() const{
    return m_hsm_client_certificate_identifier_isValid;
}

QString OAIHsmStatus::getHsmConfigurationIdentifier() const {
    return m_hsm_configuration_identifier;
}
void OAIHsmStatus::setHsmConfigurationIdentifier(const QString &hsm_configuration_identifier) {
    m_hsm_configuration_identifier = hsm_configuration_identifier;
    m_hsm_configuration_identifier_isSet = true;
}

bool OAIHsmStatus::is_hsm_configuration_identifier_Set() const{
    return m_hsm_configuration_identifier_isSet;
}

bool OAIHsmStatus::is_hsm_configuration_identifier_Valid() const{
    return m_hsm_configuration_identifier_isValid;
}

QString OAIHsmStatus::getStatus() const {
    return m_status;
}
void OAIHsmStatus::setStatus(const QString &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIHsmStatus::is_status_Set() const{
    return m_status_isSet;
}

bool OAIHsmStatus::is_status_Valid() const{
