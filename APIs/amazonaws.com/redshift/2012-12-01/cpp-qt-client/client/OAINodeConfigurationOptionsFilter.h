...
/*
 * OAINodeConfigurationOptionsFilter.h
 *
 * A set of elements to filter the returned node configurations.
 */

#ifndef OAINodeConfigurationOptionsFilter_H
#define OAINodeConfigurationOptionsFilter_H
...
class OAINodeConfigurationOptionsFilter : public OAIObject {
public:
    OAINodeConfigurationOptionsFilter();
    OAINodeConfigurationOptionsFilter(QString json);
    ~OAINodeConfigurationOptionsFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeConfigurationOptionsFilter)

#endif // OAINodeConfigurationOptionsFilter_H
