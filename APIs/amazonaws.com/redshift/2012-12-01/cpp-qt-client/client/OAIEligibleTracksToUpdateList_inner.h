...
/*
 * OAIEligibleTracksToUpdateList_inner.h
 *
 * 
 */

#ifndef OAIEligibleTracksToUpdateList_inner_H
#define OAIEligibleTracksToUpdateList_inner_H
...
class OAIEligibleTracksToUpdateList_inner : public OAIObject {
public:
    OAIEligibleTracksToUpdateList_inner();
    OAIEligibleTracksToUpdateList_inner(QString json);
    ~OAIEligibleTracksToUpdateList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEligibleTracksToUpdateList_inner)

#endif // OAIEligibleTracksToUpdateList_inner_H
