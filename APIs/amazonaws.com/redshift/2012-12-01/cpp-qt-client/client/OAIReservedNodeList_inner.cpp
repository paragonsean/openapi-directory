...
#include "OAIReservedNodeList_inner.h"
...
OAIReservedNodeList_inner::OAIReservedNodeList_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIReservedNodeList_inner::OAIReservedNodeList_inner() {
    this->initializeModel();
}

OAIReservedNodeList_inner::~OAIReservedNodeList_inner() {}

void OAIReservedNodeList_inner::initializeModel() {
...
void OAIReservedNodeList_inner::fromJson(QString jsonString) {
...
void OAIReservedNodeList_inner::fromJsonObject(QJsonObject json) {
...
QString OAIReservedNodeList_inner::asJson() const {
...
QJsonObject OAIReservedNodeList_inner::asJsonObject() const {
    QJsonObject obj;
...
QString OAIReservedNodeList_inner::getReservedNodeId() const {
    return m_reserved_node_id;
}
void OAIReservedNodeList_inner::setReservedNodeId(const QString &reserved_node_id) {
    m_reserved_node_id = reserved_node_id;
    m_reserved_node_id_isSet = true;
}

bool OAIReservedNodeList_inner::is_reserved_node_id_Set() const{
    return m_reserved_node_id_isSet;
}

bool OAIReservedNodeList_inner::is_reserved_node_id_Valid() const{
    return m_reserved_node_id_isValid;
}

QString OAIReservedNodeList_inner::getReservedNodeOfferingId() const {
    return m_reserved_node_offering_id;
}
void OAIReservedNodeList_inner::setReservedNodeOfferingId(const QString &reserved_node_offering_id) {
    m_reserved_node_offering_id = reserved_node_offering_id;
    m_reserved_node_offering_id_isSet = true;
}

bool OAIReservedNodeList_inner::is_reserved_node_offering_id_Set() const{
    return m_reserved_node_offering_id_isSet;
}

bool OAIReservedNodeList_inner::is_reserved_node_offering_id_Valid() const{
    return m_reserved_node_offering_id_isValid;
}

QString OAIReservedNodeList_inner::getNodeType() const {
    return m_node_type;
}
void OAIReservedNodeList_inner::setNodeType(const QString &node_type) {
    m_node_type = node_type;
    m_node_type_isSet = true;
}

bool OAIReservedNodeList_inner::is_node_type_Set() const{
    return m_node_type_isSet;
}

bool OAIReservedNodeList_inner::is_node_type_Valid() const{
    return m_node_type_isValid;
}

QDateTime OAIReservedNodeList_inner::getStartTime() const {
    return m_start_time;
}
void OAIReservedNodeList_inner::setStartTime(const QDateTime &start_time) {
    m_start_time = start_time;
    m_start_time_isSet = true;
}

bool OAIReservedNodeList_inner::is_start_time_Set() const{
    return m_start_time_isSet;
}

bool OAIReservedNodeList_inner::is_start_time_Valid() const{
    return m_start_time_isValid;
}

qint32 OAIReservedNodeList_inner::getDuration() const {
    return m_duration;
}
void OAIReservedNodeList_inner::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAIReservedNodeList_inner::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAIReservedNodeList_inner::is_duration_Valid() const{
    return m_duration_isValid;
}

double OAIReservedNodeList_inner::getFixedPrice() const {
    return m_fixed_price;
}
void OAIReservedNodeList_inner::setFixedPrice(const double &fixed_price) {
    m_fixed_price = fixed_price;
    m_fixed_price_isSet = true;
}

bool OAIReservedNodeList_inner::is_fixed_price_Set() const{
    return m_fixed_price_isSet;
}

bool OAIReservedNodeList_inner::is_fixed_price_Valid() const{
    return m_fixed_price_isValid;
}

double OAIReservedNodeList_inner::getUsagePrice() const {
    return m_usage_price;
}
void OAIReservedNodeList_inner::setUsagePrice(const double &usage_price) {
    m_usage_price = usage_price;
    m_usage_price_isSet = true;
}

bool OAIReservedNodeList_inner::is_usage_price_Set() const{
    return m_usage_price_isSet;
}

bool OAIReservedNodeList_inner::is_usage_price_Valid() const{
    return m_usage_price_isValid;
}

QString OAIReservedNodeList_inner::getCurrencyCode() const {
    return m_currency_code;
}
void OAIReservedNodeList_inner::setCurrencyCode(const QString &currency_code) {
    m_currency_code = currency_code;
    m_currency_code_isSet = true;
}

bool OAIReservedNodeList_inner::is_currency_code_Set() const{
    return m_currency_code_isSet;
}

bool OAIReservedNodeList_inner::is_currency_code_Valid() const{
    return m_currency_code_isValid;
}

qint32 OAIReservedNodeList_inner::getNodeCount() const {
    return m_node_count;
}
void OAIReservedNodeList_inner::setNodeCount(const qint32 &node_count) {
    m_node_count = node_count;
    m_node_count_isSet = true;
}

bool OAIReservedNodeList_inner::is_node_count_Set() const{
    return m_node_count_isSet;
}

bool OAIReservedNodeList_inner::is_node_count_Valid() const{
    return m_node_count_isValid;
}

QString OAIReservedNodeList_inner::getState() const {
    return m_state;
}
void OAIReservedNodeList_inner::setState(const QString &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIReservedNodeList_inner::is_state_Set() const{
    return m_state_isSet;
}

bool OAIReservedNodeList_inner::is_state_Valid() const{
    return m_state_isValid;
}

QString OAIReservedNodeList_inner::getOfferingType() const {
    return m_offering_type;
}
void OAIReservedNodeList_inner::setOfferingType(const QString &offering_type) {
    m_offering_type = offering_type;
    m_offering_type_isSet = true;
}

bool OAIReservedNodeList_inner::is_offering_type_Set() const{
    return m_offering_type_isSet;
}

bool OAIReservedNodeList_inner::is_offering_type_Valid() const{
    return m_offering_type_isValid;
}

QList OAIReservedNodeList_inner::getRecurringCharges() const {
    return m_recurring_charges;
}
void OAIReservedNodeList_inner::setRecurringCharges(const QList &recurring_charges) {
    m_recurring_charges = recurring_charges;
    m_recurring_charges_isSet = true;
}

bool OAIReservedNodeList_inner::is_recurring_charges_Set() const{
    return m_recurring_charges_isSet;
}

bool OAIReservedNodeList_inner::is_recurring_charges_Valid() const{
    return m_recurring_charges_isValid;
}

OAIReservedNodeOfferingType OAIReservedNodeList_inner::getReservedNodeOfferingType() const {
    return m_reserved_node_offering_type;
}
void OAIReservedNodeList_inner::setReservedNodeOfferingType(const OAIReservedNodeOfferingType &reserved_node_offering_type) {
    m_reserved_node_offering_type = reserved_node_offering_type;
    m_reserved_node_offering_type_isSet = true;
}

bool OAIReservedNodeList_inner::is_reserved_node_offering_type_Set() const{
    return m_reserved_node_offering_type_isSet;
}

bool OAIReservedNodeList_inner::is_reserved_node_offering_type_Valid() const{
    return m_reserved_node_offering_type_isValid;
}

bool OAIReservedNodeList_inner::isSet() const {
...
bool OAIReservedNodeList_inner::isValid() const {
