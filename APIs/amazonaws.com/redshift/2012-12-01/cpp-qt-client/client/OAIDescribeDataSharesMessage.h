...
/*
 * OAIDescribeDataSharesMessage.h
 *
 * 
 */

#ifndef OAIDescribeDataSharesMessage_H
#define OAIDescribeDataSharesMessage_H
...
class OAIDescribeDataSharesMessage : public OAIObject {
public:
    OAIDescribeDataSharesMessage();
    OAIDescribeDataSharesMessage(QString json);
    ~OAIDescribeDataSharesMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeDataSharesMessage)

#endif // OAIDescribeDataSharesMessage_H
