...
/*
 * OAIDeferredMaintenanceWindowsList_inner.h
 *
 * 
 */

#ifndef OAIDeferredMaintenanceWindowsList_inner_H
#define OAIDeferredMaintenanceWindowsList_inner_H
...
class OAIDeferredMaintenanceWindowsList_inner : public OAIObject {
public:
    OAIDeferredMaintenanceWindowsList_inner();
    OAIDeferredMaintenanceWindowsList_inner(QString json);
    ~OAIDeferredMaintenanceWindowsList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeferredMaintenanceWindowsList_inner)

#endif // OAIDeferredMaintenanceWindowsList_inner_H
