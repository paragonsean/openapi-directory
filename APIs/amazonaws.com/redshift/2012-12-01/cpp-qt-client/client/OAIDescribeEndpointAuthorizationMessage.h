...
/*
 * OAIDescribeEndpointAuthorizationMessage.h
 *
 * 
 */

#ifndef OAIDescribeEndpointAuthorizationMessage_H
#define OAIDescribeEndpointAuthorizationMessage_H
...
class OAIDescribeEndpointAuthorizationMessage : public OAIObject {
public:
    OAIDescribeEndpointAuthorizationMessage();
    OAIDescribeEndpointAuthorizationMessage(QString json);
    ~OAIDescribeEndpointAuthorizationMessage() override;
    ...
    void setGrantee(const bool &grantee);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEndpointAuthorizationMessage)

#endif // OAIDescribeEndpointAuthorizationMessage_H
