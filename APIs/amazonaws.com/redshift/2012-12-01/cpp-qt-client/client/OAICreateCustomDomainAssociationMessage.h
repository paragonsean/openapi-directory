...
/*
 * OAICreateCustomDomainAssociationMessage.h
 *
 * 
 */

#ifndef OAICreateCustomDomainAssociationMessage_H
#define OAICreateCustomDomainAssociationMessage_H
...
class OAICreateCustomDomainAssociationMessage : public OAIObject {
public:
    OAICreateCustomDomainAssociationMessage();
    OAICreateCustomDomainAssociationMessage(QString json);
    ~OAICreateCustomDomainAssociationMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCustomDomainAssociationMessage)

#endif // OAICreateCustomDomainAssociationMessage_H
