...
/*
 * OAIModifyUsageLimitMessage.h
 *
 * 
 */

#ifndef OAIModifyUsageLimitMessage_H
#define OAIModifyUsageLimitMessage_H
...
class OAIModifyUsageLimitMessage : public OAIObject {
public:
    OAIModifyUsageLimitMessage();
    OAIModifyUsageLimitMessage(QString json);
    ~OAIModifyUsageLimitMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIModifyUsageLimitMessage)

#endif // OAIModifyUsageLimitMessage_H
