...
/*
 * OAIGetClusterCredentialsWithIAMMessage.h
 *
 * 
 */

#ifndef OAIGetClusterCredentialsWithIAMMessage_H
#define OAIGetClusterCredentialsWithIAMMessage_H
...
class OAIGetClusterCredentialsWithIAMMessage : public OAIObject {
public:
    OAIGetClusterCredentialsWithIAMMessage();
    OAIGetClusterCredentialsWithIAMMessage(QString json);
    ~OAIGetClusterCredentialsWithIAMMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetClusterCredentialsWithIAMMessage)

#endif // OAIGetClusterCredentialsWithIAMMessage_H
