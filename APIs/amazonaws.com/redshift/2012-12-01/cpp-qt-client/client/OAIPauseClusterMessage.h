...
class OAIPauseClusterMessage : public OAIObject {
public:
    OAIPauseClusterMessage();
    OAIPauseClusterMessage(QString json);
    ~OAIPauseClusterMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPauseClusterMessage)

#endif // OAIPauseClusterMessage_H
