...
/*
 * OAIVpcEndpointsList_inner.h
 *
 * 
 */

#ifndef OAIVpcEndpointsList_inner_H
#define OAIVpcEndpointsList_inner_H
...
class OAIVpcEndpointsList_inner : public OAIObject {
public:
    OAIVpcEndpointsList_inner();
    OAIVpcEndpointsList_inner(QString json);
    ~OAIVpcEndpointsList_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpcEndpointsList_inner)

#endif // OAIVpcEndpointsList_inner_H
