...
/*
 * OAIDescribePartnersInputMessage.h
 *
 * 
 */

#ifndef OAIDescribePartnersInputMessage_H
#define OAIDescribePartnersInputMessage_H
...
class OAIDescribePartnersInputMessage : public OAIObject {
public:
    OAIDescribePartnersInputMessage();
    OAIDescribePartnersInputMessage(QString json);
    ~OAIDescribePartnersInputMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribePartnersInputMessage)

#endif // OAIDescribePartnersInputMessage_H
