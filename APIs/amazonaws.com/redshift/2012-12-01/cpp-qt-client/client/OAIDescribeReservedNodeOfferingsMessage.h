...
/*
 * OAIDescribeReservedNodeOfferingsMessage.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIDescribeReservedNodeOfferingsMessage_H
#define OAIDescribeReservedNodeOfferingsMessage_H
...
class OAIDescribeReservedNodeOfferingsMessage : public OAIObject {
public:
    OAIDescribeReservedNodeOfferingsMessage();
    OAIDescribeReservedNodeOfferingsMessage(QString json);
    ~OAIDescribeReservedNodeOfferingsMessage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeReservedNodeOfferingsMessage)

#endif // OAIDescribeReservedNodeOfferingsMessage_H
