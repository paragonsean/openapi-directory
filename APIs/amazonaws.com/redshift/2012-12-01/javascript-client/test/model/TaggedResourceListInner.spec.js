...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.TaggedResourceListInner();
  });
  ...
  describe('TaggedResourceListInner', function() {
    it('should create an instance of TaggedResourceListInner', function() {
      // uncomment below and update the code to test TaggedResourceListInner
      //var instance = new AmazonRedshift.TaggedResourceListInner();
      //expect(instance).to.be.a(AmazonRedshift.TaggedResourceListInner);
    });
