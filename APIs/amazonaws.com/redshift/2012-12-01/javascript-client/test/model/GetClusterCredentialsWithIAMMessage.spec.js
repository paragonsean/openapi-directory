...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.GetClusterCredentialsWithIAMMessage();
  });
  ...
  describe('GetClusterCredentialsWithIAMMessage', function() {
    it('should create an instance of GetClusterCredentialsWithIAMMessage', function() {
      // uncomment below and update the code to test GetClusterCredentialsWithIAMMessage
      //var instance = new AmazonRedshift.GetClusterCredentialsWithIAMMessage();
      //expect(instance).to.be.a(AmazonRedshift.GetClusterCredentialsWithIAMMessage);
    });
