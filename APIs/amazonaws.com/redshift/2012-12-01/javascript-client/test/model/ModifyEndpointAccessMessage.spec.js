...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ModifyEndpointAccessMessage();
  });
  ...
  describe('ModifyEndpointAccessMessage', function() {
    it('should create an instance of ModifyEndpointAccessMessage', function() {
      // uncomment below and update the code to test ModifyEndpointAccessMessage
      //var instance = new AmazonRedshift.ModifyEndpointAccessMessage();
      //expect(instance).to.be.a(AmazonRedshift.ModifyEndpointAccessMessage);
    });
