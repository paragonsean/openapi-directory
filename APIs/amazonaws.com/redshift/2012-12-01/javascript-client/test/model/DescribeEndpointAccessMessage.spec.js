...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.DescribeEndpointAccessMessage();
  });
  ...
  describe('DescribeEndpointAccessMessage', function() {
    it('should create an instance of DescribeEndpointAccessMessage', function() {
      // uncomment below and update the code to test DescribeEndpointAccessMessage
      //var instance = new AmazonRedshift.DescribeEndpointAccessMessage();
      //expect(instance).to.be.a(AmazonRedshift.DescribeEndpointAccessMessage);
    });
