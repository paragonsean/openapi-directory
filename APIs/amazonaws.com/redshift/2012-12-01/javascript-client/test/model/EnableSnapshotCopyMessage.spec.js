...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.EnableSnapshotCopyMessage();
  });
  ...
  describe('EnableSnapshotCopyMessage', function() {
    it('should create an instance of EnableSnapshotCopyMessage', function() {
      // uncomment below and update the code to test EnableSnapshotCopyMessage
      //var instance = new AmazonRedshift.EnableSnapshotCopyMessage();
      //expect(instance).to.be.a(AmazonRedshift.EnableSnapshotCopyMessage);
    });
