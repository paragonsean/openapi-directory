...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.PartnerIntegrationInputMessage();
  });
  ...
  describe('PartnerIntegrationInputMessage', function() {
    it('should create an instance of PartnerIntegrationInputMessage', function() {
      // uncomment below and update the code to test PartnerIntegrationInputMessage
      //var instance = new AmazonRedshift.PartnerIntegrationInputMessage();
      //expect(instance).to.be.a(AmazonRedshift.PartnerIntegrationInputMessage);
    });
