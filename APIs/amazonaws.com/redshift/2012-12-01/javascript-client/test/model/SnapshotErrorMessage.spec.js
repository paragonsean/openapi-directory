...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.SnapshotErrorMessage();
  });
  ...
  describe('SnapshotErrorMessage', function() {
    it('should create an instance of SnapshotErrorMessage', function() {
      // uncomment below and update the code to test SnapshotErrorMessage
      //var instance = new AmazonRedshift.SnapshotErrorMessage();
      //expect(instance).to.be.a(AmazonRedshift.SnapshotErrorMessage);
    });
