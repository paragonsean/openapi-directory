...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.SnapshotSortingEntity();
  });
  ...
  describe('SnapshotSortingEntity', function() {
    it('should create an instance of SnapshotSortingEntity', function() {
      // uncomment below and update the code to test SnapshotSortingEntity
      //var instance = new AmazonRedshift.SnapshotSortingEntity();
      //expect(instance).to.be.a(AmazonRedshift.SnapshotSortingEntity);
    });
