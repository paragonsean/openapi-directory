...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.UpdateTarget();
  });
  ...
  describe('UpdateTarget', function() {
    it('should create an instance of UpdateTarget', function() {
      // uncomment below and update the code to test UpdateTarget
      //var instance = new AmazonRedshift.UpdateTarget();
      //expect(instance).to.be.a(AmazonRedshift.UpdateTarget);
    });
    ...
    it('should have the property supportedOperations (base name: "SupportedOperations")', function() {
