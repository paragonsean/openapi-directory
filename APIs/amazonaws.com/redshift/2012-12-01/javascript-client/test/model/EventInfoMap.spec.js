...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.EventInfoMap();
  });
  ...
  describe('EventInfoMap', function() {
    it('should create an instance of EventInfoMap', function() {
      // uncomment below and update the code to test EventInfoMap
      //var instance = new AmazonRedshift.EventInfoMap();
      //expect(instance).to.be.a(AmazonRedshift.EventInfoMap);
    });
