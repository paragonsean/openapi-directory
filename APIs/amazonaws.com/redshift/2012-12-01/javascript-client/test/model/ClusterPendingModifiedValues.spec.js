...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterPendingModifiedValues();
  });
  ...
  describe('ClusterPendingModifiedValues', function() {
    it('should create an instance of ClusterPendingModifiedValues', function() {
      // uncomment below and update the code to test ClusterPendingModifiedValues
      //var instance = new AmazonRedshift.ClusterPendingModifiedValues();
      //expect(instance).to.be.a(AmazonRedshift.ClusterPendingModifiedValues);
    });
