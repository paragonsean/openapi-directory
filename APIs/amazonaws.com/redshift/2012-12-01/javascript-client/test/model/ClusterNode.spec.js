...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterNode();
  });
  ...
  describe('ClusterNode', function() {
    it('should create an instance of ClusterNode', function() {
      // uncomment below and update the code to test ClusterNode
      //var instance = new AmazonRedshift.ClusterNode();
      //expect(instance).to.be.a(AmazonRedshift.ClusterNode);
    });
