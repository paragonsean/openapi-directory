...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ReservedNodeOffering();
  });
  ...
  describe('ReservedNodeOffering', function() {
    it('should create an instance of ReservedNodeOffering', function() {
      // uncomment below and update the code to test ReservedNodeOffering
      //var instance = new AmazonRedshift.ReservedNodeOffering();
      //expect(instance).to.be.a(AmazonRedshift.ReservedNodeOffering);
    });
