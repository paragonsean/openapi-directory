...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.TableRestoreStatus();
  });
  ...
  describe('TableRestoreStatus', function() {
    it('should create an instance of TableRestoreStatus', function() {
      // uncomment below and update the code to test TableRestoreStatus
      //var instance = new AmazonRedshift.TableRestoreStatus();
      //expect(instance).to.be.a(AmazonRedshift.TableRestoreStatus);
    });
