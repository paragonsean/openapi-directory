...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterSnapshotCopyStatus();
  });
  ...
  describe('ClusterSnapshotCopyStatus', function() {
    it('should create an instance of ClusterSnapshotCopyStatus', function() {
      // uncomment below and update the code to test ClusterSnapshotCopyStatus
      //var instance = new AmazonRedshift.ClusterSnapshotCopyStatus();
      //expect(instance).to.be.a(AmazonRedshift.ClusterSnapshotCopyStatus);
    });
