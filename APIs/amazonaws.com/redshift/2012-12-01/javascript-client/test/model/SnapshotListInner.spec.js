...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.SnapshotListInner();
  });
  ...
  describe('SnapshotListInner', function() {
    it('should create an instance of SnapshotListInner', function() {
      // uncomment below and update the code to test SnapshotListInner
      //var instance = new AmazonRedshift.SnapshotListInner();
      //expect(instance).to.be.a(AmazonRedshift.SnapshotListInner);
    });
