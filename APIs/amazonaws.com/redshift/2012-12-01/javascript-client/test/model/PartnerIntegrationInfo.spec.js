...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.PartnerIntegrationInfo();
  });
  ...
  describe('PartnerIntegrationInfo', function() {
    it('should create an instance of PartnerIntegrationInfo', function() {
      // uncomment below and update the code to test PartnerIntegrationInfo
      //var instance = new AmazonRedshift.PartnerIntegrationInfo();
      //expect(instance).to.be.a(AmazonRedshift.PartnerIntegrationInfo);
    });
