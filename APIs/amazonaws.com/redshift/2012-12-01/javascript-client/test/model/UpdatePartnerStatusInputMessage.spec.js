...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.UpdatePartnerStatusInputMessage();
  });
  ...
  describe('UpdatePartnerStatusInputMessage', function() {
    it('should create an instance of UpdatePartnerStatusInputMessage', function() {
      // uncomment below and update the code to test UpdatePartnerStatusInputMessage
      //var instance = new AmazonRedshift.UpdatePartnerStatusInputMessage();
      //expect(instance).to.be.a(AmazonRedshift.UpdatePartnerStatusInputMessage);
    });
