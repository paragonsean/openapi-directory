...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.OrderableClusterOption();
  });
  ...
  describe('OrderableClusterOption', function() {
    it('should create an instance of OrderableClusterOption', function() {
      // uncomment below and update the code to test OrderableClusterOption
      //var instance = new AmazonRedshift.OrderableClusterOption();
      //expect(instance).to.be.a(AmazonRedshift.OrderableClusterOption);
    });
