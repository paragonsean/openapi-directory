...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.CreateUsageLimitMessage();
  });
  ...
  describe('CreateUsageLimitMessage', function() {
    it('should create an instance of CreateUsageLimitMessage', function() {
      // uncomment below and update the code to test CreateUsageLimitMessage
      //var instance = new AmazonRedshift.CreateUsageLimitMessage();
      //expect(instance).to.be.a(AmazonRedshift.CreateUsageLimitMessage);
    });
