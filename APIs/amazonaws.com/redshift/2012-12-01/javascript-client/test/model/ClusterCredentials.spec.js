...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterCredentials();
  });
  ...
  describe('ClusterCredentials', function() {
    it('should create an instance of ClusterCredentials', function() {
      // uncomment below and update the code to test ClusterCredentials
      //var instance = new AmazonRedshift.ClusterCredentials();
      //expect(instance).to.be.a(AmazonRedshift.ClusterCredentials);
    });
