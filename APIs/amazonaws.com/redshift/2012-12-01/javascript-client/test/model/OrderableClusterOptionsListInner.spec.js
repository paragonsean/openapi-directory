...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.OrderableClusterOptionsListInner();
  });
  ...
  describe('OrderableClusterOptionsListInner', function() {
    it('should create an instance of OrderableClusterOptionsListInner', function() {
      // uncomment below and update the code to test OrderableClusterOptionsListInner
      //var instance = new AmazonRedshift.OrderableClusterOptionsListInner();
      //expect(instance).to.be.a(AmazonRedshift.OrderableClusterOptionsListInner);
    });
