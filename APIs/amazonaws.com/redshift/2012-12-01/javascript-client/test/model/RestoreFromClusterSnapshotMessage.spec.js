...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.RestoreFromClusterSnapshotMessage();
  });
  ...
  describe('RestoreFromClusterSnapshotMessage', function() {
    it('should create an instance of RestoreFromClusterSnapshotMessage', function() {
      // uncomment below and update the code to test RestoreFromClusterSnapshotMessage
      //var instance = new AmazonRedshift.RestoreFromClusterSnapshotMessage();
      //expect(instance).to.be.a(AmazonRedshift.RestoreFromClusterSnapshotMessage);
    });
    ...
    it('should have the property aquaConfigurationStatus (base name: "AquaConfigurationStatus")', function() {
      // uncomment below and update the code to test the property aquaConfigurationStatus
      //var instance = new AmazonRedshift.RestoreFromClusterSnapshotMessage();
      //expect(instance).to.be();
    });
