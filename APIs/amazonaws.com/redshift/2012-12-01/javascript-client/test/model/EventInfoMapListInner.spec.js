...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.EventInfoMapListInner();
  });
  ...
  describe('EventInfoMapListInner', function() {
    it('should create an instance of EventInfoMapListInner', function() {
      // uncomment below and update the code to test EventInfoMapListInner
      //var instance = new AmazonRedshift.EventInfoMapListInner();
      //expect(instance).to.be.a(AmazonRedshift.EventInfoMapListInner);
    });
