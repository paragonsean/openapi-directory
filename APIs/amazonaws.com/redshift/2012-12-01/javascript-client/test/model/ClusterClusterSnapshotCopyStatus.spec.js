...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterClusterSnapshotCopyStatus();
  });
  ...
  describe('ClusterClusterSnapshotCopyStatus', function() {
    it('should create an instance of ClusterClusterSnapshotCopyStatus', function() {
      // uncomment below and update the code to test ClusterClusterSnapshotCopyStatus
      //var instance = new AmazonRedshift.ClusterClusterSnapshotCopyStatus();
      //expect(instance).to.be.a(AmazonRedshift.ClusterClusterSnapshotCopyStatus);
    });
