...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.DescribePartnersInputMessage();
  });
  ...
  describe('DescribePartnersInputMessage', function() {
    it('should create an instance of DescribePartnersInputMessage', function() {
      // uncomment below and update the code to test DescribePartnersInputMessage
      //var instance = new AmazonRedshift.DescribePartnersInputMessage();
      //expect(instance).to.be.a(AmazonRedshift.DescribePartnersInputMessage);
    });
