...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterListInner();
  });
  ...
  describe('ClusterListInner', function() {
    it('should create an instance of ClusterListInner', function() {
      // uncomment below and update the code to test ClusterListInner
      //var instance = new AmazonRedshift.ClusterListInner();
      //expect(instance).to.be.a(AmazonRedshift.ClusterListInner);
    });
