...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ResizeClusterMessage();
  });
  ...
  describe('ResizeClusterMessage', function() {
    it('should create an instance of ResizeClusterMessage', function() {
      // uncomment below and update the code to test ResizeClusterMessage
      //var instance = new AmazonRedshift.ResizeClusterMessage();
      //expect(instance).to.be.a(AmazonRedshift.ResizeClusterMessage);
    });
