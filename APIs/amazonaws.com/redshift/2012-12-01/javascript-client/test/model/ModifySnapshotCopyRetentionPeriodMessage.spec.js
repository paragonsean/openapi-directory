...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ModifySnapshotCopyRetentionPeriodMessage();
  });
  ...
  describe('ModifySnapshotCopyRetentionPeriodMessage', function() {
    it('should create an instance of ModifySnapshotCopyRetentionPeriodMessage', function() {
      // uncomment below and update the code to test ModifySnapshotCopyRetentionPeriodMessage
      //var instance = new AmazonRedshift.ModifySnapshotCopyRetentionPeriodMessage();
      //expect(instance).to.be.a(AmazonRedshift.ModifySnapshotCopyRetentionPeriodMessage);
    });
