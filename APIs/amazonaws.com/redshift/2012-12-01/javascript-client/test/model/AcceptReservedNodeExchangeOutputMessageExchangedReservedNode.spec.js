...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.AcceptReservedNodeExchangeOutputMessageExchangedReservedNode();
  });
  ...
  describe('AcceptReservedNodeExchangeOutputMessageExchangedReservedNode', function() {
    it('should create an instance of AcceptReservedNodeExchangeOutputMessageExchangedReservedNode', function() {
      // uncomment below and update the code to test AcceptReservedNodeExchangeOutputMessageExchangedReservedNode
      //var instance = new AmazonRedshift.AcceptReservedNodeExchangeOutputMessageExchangedReservedNode();
      //expect(instance).to.be.a(AmazonRedshift.AcceptReservedNodeExchangeOutputMessageExchangedReservedNode);
    });
