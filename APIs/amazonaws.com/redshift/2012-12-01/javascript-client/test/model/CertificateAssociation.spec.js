...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.CertificateAssociation();
  });
  ...
  describe('CertificateAssociation', function() {
    it('should create an instance of CertificateAssociation', function() {
      // uncomment below and update the code to test CertificateAssociation
      //var instance = new AmazonRedshift.CertificateAssociation();
      //expect(instance).to.be.a(AmazonRedshift.CertificateAssociation);
    });
