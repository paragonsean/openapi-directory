...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ModifyClusterSnapshotMessage();
  });
  ...
  describe('ModifyClusterSnapshotMessage', function() {
    it('should create an instance of ModifyClusterSnapshotMessage', function() {
      // uncomment below and update the code to test ModifyClusterSnapshotMessage
      //var instance = new AmazonRedshift.ModifyClusterSnapshotMessage();
      //expect(instance).to.be.a(AmazonRedshift.ModifyClusterSnapshotMessage);
    });
