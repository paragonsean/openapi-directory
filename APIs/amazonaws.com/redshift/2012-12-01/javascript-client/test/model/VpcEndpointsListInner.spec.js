...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.VpcEndpointsListInner();
  });
  ...
  describe('VpcEndpointsListInner', function() {
    it('should create an instance of VpcEndpointsListInner', function() {
      // uncomment below and update the code to test VpcEndpointsListInner
      //var instance = new AmazonRedshift.VpcEndpointsListInner();
      //expect(instance).to.be.a(AmazonRedshift.VpcEndpointsListInner);
    });
