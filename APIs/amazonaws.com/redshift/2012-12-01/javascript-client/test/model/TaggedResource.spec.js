...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.TaggedResource();
  });
  ...
  describe('TaggedResource', function() {
    it('should create an instance of TaggedResource', function() {
      // uncomment below and update the code to test TaggedResource
      //var instance = new AmazonRedshift.TaggedResource();
      //expect(instance).to.be.a(AmazonRedshift.TaggedResource);
    });
