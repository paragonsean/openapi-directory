...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ReservedNodeOfferingListInner();
  });
  ...
  describe('ReservedNodeOfferingListInner', function() {
    it('should create an instance of ReservedNodeOfferingListInner', function() {
      // uncomment below and update the code to test ReservedNodeOfferingListInner
      //var instance = new AmazonRedshift.ReservedNodeOfferingListInner();
      //expect(instance).to.be.a(AmazonRedshift.ReservedNodeOfferingListInner);
    });
