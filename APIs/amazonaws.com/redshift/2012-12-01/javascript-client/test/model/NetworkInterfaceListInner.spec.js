...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.NetworkInterfaceListInner();
  });
  ...
  describe('NetworkInterfaceListInner', function() {
    it('should create an instance of NetworkInterfaceListInner', function() {
      // uncomment below and update the code to test NetworkInterfaceListInner
      //var instance = new AmazonRedshift.NetworkInterfaceListInner();
      //expect(instance).to.be.a(AmazonRedshift.NetworkInterfaceListInner);
    });
