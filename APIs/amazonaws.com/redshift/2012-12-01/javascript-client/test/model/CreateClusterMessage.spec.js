...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.CreateClusterMessage();
  });
  ...
  describe('CreateClusterMessage', function() {
    it('should create an instance of CreateClusterMessage', function() {
      // uncomment below and update the code to test CreateClusterMessage
      //var instance = new AmazonRedshift.CreateClusterMessage();
      //expect(instance).to.be.a(AmazonRedshift.CreateClusterMessage);
    });
    ...
    it('should have the property loadSampleData (base name: "LoadSampleData")', function() {
      // uncomment below and update the code to test the property loadSampleData
      //var instance = new AmazonRedshift.CreateClusterMessage();
      //expect(instance).to.be();
    });
