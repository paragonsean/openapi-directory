...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.PartnerIntegrationInfoListInner();
  });
  ...
  describe('PartnerIntegrationInfoListInner', function() {
    it('should create an instance of PartnerIntegrationInfoListInner', function() {
      // uncomment below and update the code to test PartnerIntegrationInfoListInner
      //var instance = new AmazonRedshift.PartnerIntegrationInfoListInner();
      //expect(instance).to.be.a(AmazonRedshift.PartnerIntegrationInfoListInner);
    });
