...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.CreateEndpointAccessMessage();
  });
  ...
  describe('CreateEndpointAccessMessage', function() {
    it('should create an instance of CreateEndpointAccessMessage', function() {
      // uncomment below and update the code to test CreateEndpointAccessMessage
      //var instance = new AmazonRedshift.CreateEndpointAccessMessage();
      //expect(instance).to.be.a(AmazonRedshift.CreateEndpointAccessMessage);
    });
