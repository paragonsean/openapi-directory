...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRedshift.ClusterHsmStatus();
  });
  ...
  describe('ClusterHsmStatus', function() {
    it('should create an instance of ClusterHsmStatus', function() {
      // uncomment below and update the code to test ClusterHsmStatus
      //var instance = new AmazonRedshift.ClusterHsmStatus();
      //expect(instance).to.be.a(AmazonRedshift.ClusterHsmStatus);
    });
