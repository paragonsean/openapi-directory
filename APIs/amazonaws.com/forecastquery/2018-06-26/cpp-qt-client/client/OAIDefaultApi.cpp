...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("http://forecastquery.{region}.amazonaws.com"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://forecastquery.{region}.amazonaws.com"),
    "The Amazon Forecast Query Service multi-region endpoint",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","us-east-1",
    QSet<QString>{ {"us-east-1"},{"us-east-2"},{"us-west-1"},{"us-west-2"},{"us-gov-west-1"},{"us-gov-east-1"},{"ca-central-1"},{"eu-north-1"},{"eu-west-1"},{"eu-west-2"},{"eu-west-3"},{"eu-central-1"},{"eu-south-1"},{"af-south-1"},{"ap-northeast-1"},{"ap-northeast-2"},{"ap-northeast-3"},{"ap-southeast-1"},{"ap-southeast-2"},{"ap-east-1"},{"ap-south-1"},{"sa-east-1"},{"me-south-1"} })}, }));
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("http://forecastquery.{region}.amazonaws.com.cn"),
    ...
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://forecastquery.{region}.amazonaws.com.cn"),
    "The Amazon Forecast Query Service endpoint for China (Beijing) and China (Ningxia)",
    QMap<QString, OAIServerVariable>{ 
    {"region", OAIServerVariable("The AWS region","cn-north-1",
    QSet<QString>{ {"cn-north-1"},{"cn-northwest-1"} })}, }));
    
    _serverConfigs.insert("queryForecast", defaultConf);
    _serverIndices.insert("queryForecast", 0);
    _serverConfigs.insert("queryWhatIfForecast", defaultConf);
    _serverIndices.insert("queryWhatIfForecast", 0);
}
...
void OAIDefaultApi::queryForecast(const QString &x_amz_target, const OAIQueryForecastRequest &oai_query_forecast_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["queryForecast"][_serverIndices.value("queryForecast")].URL()+"/#X-Amz-Target=AmazonForecastRuntime.QueryForecast");
...

    {
        ...
        QByteArray output = oai_query_forecast_request.asJson().toUtf8();
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::queryForecastCallback);
...
void OAIDefaultApi::queryForecastCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIQueryForecastResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryForecastSignal(output);
        Q_EMIT queryForecastSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryForecastSignalE(output, error_type, error_str);
        Q_EMIT queryForecastSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryForecastSignalError(output, error_type, error_str);
        Q_EMIT queryForecastSignalErrorFull(worker, error_type, error_str);
    }
}

void OAIDefaultApi::queryWhatIfForecast(const QString &x_amz_target, const OAIQueryWhatIfForecastRequest &oai_query_what_if_forecast_request, const ::OpenAPI::OptionalParam<QString> &x_amz_content_sha256, const ::OpenAPI::OptionalParam<QString> &x_amz_date, const ::OpenAPI::OptionalParam<QString> &x_amz_algorithm, const ::OpenAPI::OptionalParam<QString> &x_amz_credential, const ::OpenAPI::OptionalParam<QString> &x_amz_security_token, const ::OpenAPI::OptionalParam<QString> &x_amz_signature, const ::OpenAPI::OptionalParam<QString> &x_amz_signed_headers) {
    QString fullPath = QString(_serverConfigs["queryWhatIfForecast"][_serverIndices.value("queryWhatIfForecast")].URL()+"/#X-Amz-Target=AmazonForecastRuntime.QueryWhatIfForecast");
...

    {
        ...
        QByteArray output = oai_query_what_if_forecast_request.asJson().toUtf8();
        input.request_body.append(output);
    }
    if (x_amz_content_sha256.hasValue())
    {
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::queryWhatIfForecastCallback);
    connect(this, &OAIDefaultApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this]() {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIDefaultApi::queryWhatIfForecastCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    OAIQueryWhatIfForecastResponse output(QString(worker->response));
    worker->deleteLater();

    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT queryWhatIfForecastSignal(output);
        Q_EMIT queryWhatIfForecastSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT queryWhatIfForecastSignalE(output, error_type, error_str);
        Q_EMIT queryWhatIfForecastSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT queryWhatIfForecastSignalError(output, error_type, error_str);
        Q_EMIT queryWhatIfForecastSignalErrorFull(worker, error_type, error_str);
    }
}
