...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAIQueryForecastRequest create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAIQueryForecastRequest Example::create(){
    OAIQueryForecastRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::queryForecastSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::queryForecastSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIQueryForecastRequest oai_query_forecast_request = create(); // OAIQueryForecastRequest | 
      ...
      apiInstance.queryForecast(x_amz_targetoai_query_forecast_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
