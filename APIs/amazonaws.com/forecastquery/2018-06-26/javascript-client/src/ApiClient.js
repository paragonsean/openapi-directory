...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://forecastquery.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://forecastquery.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-06-26/Javascript'
        };
