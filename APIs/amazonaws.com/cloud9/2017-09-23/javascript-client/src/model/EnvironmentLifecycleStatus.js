...
* @readonly
*/
export default class EnvironmentLifecycleStatus {
    ...
    /**
    * Returns a <code>EnvironmentLifecycleStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EnvironmentLifecycleStatus} The enum <code>EnvironmentLifecycleStatus</code> value.
    */
