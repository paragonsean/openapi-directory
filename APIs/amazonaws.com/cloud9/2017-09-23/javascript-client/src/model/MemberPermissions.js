...
* @readonly
*/
export default class MemberPermissions {
    ...
    /**
    * Returns a <code>MemberPermissions</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/MemberPermissions} The enum <code>MemberPermissions</code> value.
    */
