...
* @readonly
*/
export default class ManagedCredentialsAction {
    ...
    /**
    * Returns a <code>ManagedCredentialsAction</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ManagedCredentialsAction} The enum <code>ManagedCredentialsAction</code> value.
    */
