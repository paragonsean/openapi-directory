...
/**
 * The DescribeEnvironmentStatusRequest model module.
 * @module model/DescribeEnvironmentStatusRequest
 * @version 2017-09-23
 */
class DescribeEnvironmentStatusRequest {
    /**
     * Constructs a new <code>DescribeEnvironmentStatusRequest</code>.
     * @alias module:model/DescribeEnvironmentStatusRequest
     * @param environmentId {String} 
     */
    constructor(environmentId) { 
        
        DescribeEnvironmentStatusRequest.initialize(this, environmentId);
    }
    ...
    /**
     * Constructs a <code>DescribeEnvironmentStatusRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DescribeEnvironmentStatusRequest} obj Optional instance to populate.
     * @return {module:model/DescribeEnvironmentStatusRequest} The populated <code>DescribeEnvironmentStatusRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DescribeEnvironmentStatusRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>DescribeEnvironmentStatusRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DescribeEnvironmentStatusRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DescribeEnvironmentStatusRequest.RequiredProperties) {
...
DescribeEnvironmentStatusRequest.RequiredProperties = ["environmentId"];

/**
 * @member {String} environmentId
 */
DescribeEnvironmentStatusRequest.prototype['environmentId'] = undefined;
...
export default DescribeEnvironmentStatusRequest;
