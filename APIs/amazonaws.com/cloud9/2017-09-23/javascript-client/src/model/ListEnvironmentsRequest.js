...
/**
 * The ListEnvironmentsRequest model module.
 * @module model/ListEnvironmentsRequest
 * @version 2017-09-23
 */
class ListEnvironmentsRequest {
    /**
     * Constructs a new <code>ListEnvironmentsRequest</code>.
     * @alias module:model/ListEnvironmentsRequest
     */
    constructor() { 
        
        ListEnvironmentsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListEnvironmentsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListEnvironmentsRequest} obj Optional instance to populate.
     * @return {module:model/ListEnvironmentsRequest} The populated <code>ListEnvironmentsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListEnvironmentsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListEnvironmentsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListEnvironmentsRequest</code>.
     */
 ...
 */
ListEnvironmentsRequest.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListEnvironmentsRequest.prototype['maxResults'] = undefined;
...
export default ListEnvironmentsRequest;
