...
* @readonly
*/
export default class ManagedCredentialsStatus {
    ...
    /**
    * Returns a <code>ManagedCredentialsStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ManagedCredentialsStatus} The enum <code>ManagedCredentialsStatus</code> value.
    */
