...
/**
 * The EnvironmentMember model module.
 * @module model/EnvironmentMember
 * @version 2017-09-23
 */
class EnvironmentMember {
    /**
     * Constructs a new <code>EnvironmentMember</code>.
     * Information about an environment member for an Cloud9 development environment.
     * @alias module:model/EnvironmentMember
    ...
    /**
     * Constructs a <code>EnvironmentMember</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EnvironmentMember} obj Optional instance to populate.
     * @return {module:model/EnvironmentMember} The populated <code>EnvironmentMember</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnvironmentMember();
    ...
    /**
     * Validates the JSON data with respect to <code>EnvironmentMember</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EnvironmentMember</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EnvironmentMember.RequiredProperties) {
...
EnvironmentMember.RequiredProperties = ["permissions", "userId", "userArn", "environmentId"];
