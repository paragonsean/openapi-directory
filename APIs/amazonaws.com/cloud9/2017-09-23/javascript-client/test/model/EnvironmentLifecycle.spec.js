...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.EnvironmentLifecycle();
  });
  ...
  describe('EnvironmentLifecycle', function() {
    it('should create an instance of EnvironmentLifecycle', function() {
      // uncomment below and update the code to test EnvironmentLifecycle
      //var instance = new AwsCloud9.EnvironmentLifecycle();
      //expect(instance).to.be.a(AwsCloud9.EnvironmentLifecycle);
    });
    ...
    it('should have the property failureResource (base name: "failureResource")', function() {
      // uncomment below and update the code to test the property failureResource
      //var instance = new AwsCloud9.EnvironmentLifecycle();
      //expect(instance).to.be();
    });
