...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DeleteEnvironmentMembershipRequest();
  });
  ...
  describe('DeleteEnvironmentMembershipRequest', function() {
    it('should create an instance of DeleteEnvironmentMembershipRequest', function() {
      // uncomment below and update the code to test DeleteEnvironmentMembershipRequest
      //var instance = new AwsCloud9.DeleteEnvironmentMembershipRequest();
      //expect(instance).to.be.a(AwsCloud9.DeleteEnvironmentMembershipRequest);
    });
