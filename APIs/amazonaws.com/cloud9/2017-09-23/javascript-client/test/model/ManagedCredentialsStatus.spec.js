...
(function(root, factory) {
  ...
  describe('ManagedCredentialsStatus', function() {
    it('should create an instance of ManagedCredentialsStatus', function() {
      // uncomment below and update the code to test ManagedCredentialsStatus
      //var instance = new AwsCloud9.ManagedCredentialsStatus();
      //expect(instance).to.be.a(AwsCloud9.ManagedCredentialsStatus);
    });
