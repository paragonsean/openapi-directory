...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.ListEnvironmentsRequest();
  });
  ...
  describe('ListEnvironmentsRequest', function() {
    it('should create an instance of ListEnvironmentsRequest', function() {
      // uncomment below and update the code to test ListEnvironmentsRequest
      //var instance = new AwsCloud9.ListEnvironmentsRequest();
      //expect(instance).to.be.a(AwsCloud9.ListEnvironmentsRequest);
    });
