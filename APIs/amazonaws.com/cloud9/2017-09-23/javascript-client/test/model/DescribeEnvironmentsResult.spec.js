...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DescribeEnvironmentsResult();
  });
  ...
  describe('DescribeEnvironmentsResult', function() {
    it('should create an instance of DescribeEnvironmentsResult', function() {
      // uncomment below and update the code to test DescribeEnvironmentsResult
      //var instance = new AwsCloud9.DescribeEnvironmentsResult();
      //expect(instance).to.be.a(AwsCloud9.DescribeEnvironmentsResult);
    });
