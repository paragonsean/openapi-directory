...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DescribeEnvironmentMembershipsResult();
  });
  ...
  describe('DescribeEnvironmentMembershipsResult', function() {
    it('should create an instance of DescribeEnvironmentMembershipsResult', function() {
      // uncomment below and update the code to test DescribeEnvironmentMembershipsResult
      //var instance = new AwsCloud9.DescribeEnvironmentMembershipsResult();
      //expect(instance).to.be.a(AwsCloud9.DescribeEnvironmentMembershipsResult);
    });
