...
(function(root, factory) {
  ...
  describe('ManagedCredentialsAction', function() {
    it('should create an instance of ManagedCredentialsAction', function() {
      // uncomment below and update the code to test ManagedCredentialsAction
      //var instance = new AwsCloud9.ManagedCredentialsAction();
      //expect(instance).to.be.a(AwsCloud9.ManagedCredentialsAction);
    });
