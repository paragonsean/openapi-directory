...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.UpdateEnvironmentMembershipRequest();
  });
  ...
  describe('UpdateEnvironmentMembershipRequest', function() {
    it('should create an instance of UpdateEnvironmentMembershipRequest', function() {
      // uncomment below and update the code to test UpdateEnvironmentMembershipRequest
      //var instance = new AwsCloud9.UpdateEnvironmentMembershipRequest();
      //expect(instance).to.be.a(AwsCloud9.UpdateEnvironmentMembershipRequest);
    });
