...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.ListTagsForResourceRequest();
  });
  ...
  describe('ListTagsForResourceRequest', function() {
    it('should create an instance of ListTagsForResourceRequest', function() {
      ...
      //var instance = new AwsCloud9.ListTagsForResourceRequest();
      //expect(instance).to.be.a(AwsCloud9.ListTagsForResourceRequest);
    });
