...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DeleteEnvironmentRequest();
  });
  ...
  describe('DeleteEnvironmentRequest', function() {
    it('should create an instance of DeleteEnvironmentRequest', function() {
      // uncomment below and update the code to test DeleteEnvironmentRequest
      //var instance = new AwsCloud9.DeleteEnvironmentRequest();
      //expect(instance).to.be.a(AwsCloud9.DeleteEnvironmentRequest);
    });
