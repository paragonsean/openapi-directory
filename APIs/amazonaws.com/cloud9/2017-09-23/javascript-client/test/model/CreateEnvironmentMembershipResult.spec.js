...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.CreateEnvironmentMembershipResult();
  });
  ...
  describe('CreateEnvironmentMembershipResult', function() {
    it('should create an instance of CreateEnvironmentMembershipResult', function() {
      // uncomment below and update the code to test CreateEnvironmentMembershipResult
      //var instance = new AwsCloud9.CreateEnvironmentMembershipResult();
      //expect(instance).to.be.a(AwsCloud9.CreateEnvironmentMembershipResult);
    });
