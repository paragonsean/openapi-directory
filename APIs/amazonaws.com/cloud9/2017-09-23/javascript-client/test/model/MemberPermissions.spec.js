...
(function(root, factory) {
  ...
  describe('MemberPermissions', function() {
    it('should create an instance of MemberPermissions', function() {
      // uncomment below and update the code to test MemberPermissions
      //var instance = new AwsCloud9.MemberPermissions();
      //expect(instance).to.be.a(AwsCloud9.MemberPermissions);
    });
