...
(function(root, factory) {
  ...
  describe('EnvironmentLifecycleStatus', function() {
    it('should create an instance of EnvironmentLifecycleStatus', function() {
      // uncomment below and update the code to test EnvironmentLifecycleStatus
      //var instance = new AwsCloud9.EnvironmentLifecycleStatus();
      //expect(instance).to.be.a(AwsCloud9.EnvironmentLifecycleStatus);
    });
