...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.UpdateEnvironmentMembershipResultMembership();
  });
  ...
  describe('UpdateEnvironmentMembershipResultMembership', function() {
    it('should create an instance of UpdateEnvironmentMembershipResultMembership', function() {
      // uncomment below and update the code to test UpdateEnvironmentMembershipResultMembership
      //var instance = new AwsCloud9.UpdateEnvironmentMembershipResultMembership();
      //expect(instance).to.be.a(AwsCloud9.UpdateEnvironmentMembershipResultMembership);
    });
