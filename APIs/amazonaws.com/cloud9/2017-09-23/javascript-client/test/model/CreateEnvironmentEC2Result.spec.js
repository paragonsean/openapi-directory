...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.CreateEnvironmentEC2Result();
  });
  ...
  describe('CreateEnvironmentEC2Result', function() {
    it('should create an instance of CreateEnvironmentEC2Result', function() {
      // uncomment below and update the code to test CreateEnvironmentEC2Result
      //var instance = new AwsCloud9.CreateEnvironmentEC2Result();
      //expect(instance).to.be.a(AwsCloud9.CreateEnvironmentEC2Result);
    });
