...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DescribeEnvironmentsRequest();
  });
  ...
  describe('DescribeEnvironmentsRequest', function() {
    it('should create an instance of DescribeEnvironmentsRequest', function() {
      // uncomment below and update the code to test DescribeEnvironmentsRequest
      //var instance = new AwsCloud9.DescribeEnvironmentsRequest();
      //expect(instance).to.be.a(AwsCloud9.DescribeEnvironmentsRequest);
    });
