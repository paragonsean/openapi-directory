...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DescribeEnvironmentMembershipsRequest();
  });
  ...
  describe('DescribeEnvironmentMembershipsRequest', function() {
    it('should create an instance of DescribeEnvironmentMembershipsRequest', function() {
      // uncomment below and update the code to test DescribeEnvironmentMembershipsRequest
      //var instance = new AwsCloud9.DescribeEnvironmentMembershipsRequest();
      //expect(instance).to.be.a(AwsCloud9.DescribeEnvironmentMembershipsRequest);
    });
