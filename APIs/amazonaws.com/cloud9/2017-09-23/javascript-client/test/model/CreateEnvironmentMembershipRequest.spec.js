...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.CreateEnvironmentMembershipRequest();
  });
  ...
  describe('CreateEnvironmentMembershipRequest', function() {
    it('should create an instance of CreateEnvironmentMembershipRequest', function() {
      // uncomment below and update the code to test CreateEnvironmentMembershipRequest
      //var instance = new AwsCloud9.CreateEnvironmentMembershipRequest();
      //expect(instance).to.be.a(AwsCloud9.CreateEnvironmentMembershipRequest);
    });
