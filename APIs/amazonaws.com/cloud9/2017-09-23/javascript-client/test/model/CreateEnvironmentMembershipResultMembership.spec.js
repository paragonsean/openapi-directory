...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.CreateEnvironmentMembershipResultMembership();
  });
  ...
  describe('CreateEnvironmentMembershipResultMembership', function() {
    it('should create an instance of CreateEnvironmentMembershipResultMembership', function() {
      // uncomment below and update the code to test CreateEnvironmentMembershipResultMembership
      //var instance = new AwsCloud9.CreateEnvironmentMembershipResultMembership();
      //expect(instance).to.be.a(AwsCloud9.CreateEnvironmentMembershipResultMembership);
    });
