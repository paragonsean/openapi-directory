...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.UpdateEnvironmentMembershipResult();
  });
  ...
  describe('UpdateEnvironmentMembershipResult', function() {
    it('should create an instance of UpdateEnvironmentMembershipResult', function() {
      // uncomment below and update the code to test UpdateEnvironmentMembershipResult
      //var instance = new AwsCloud9.UpdateEnvironmentMembershipResult();
      //expect(instance).to.be.a(AwsCloud9.UpdateEnvironmentMembershipResult);
    });
