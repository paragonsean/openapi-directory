...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.DescribeEnvironmentStatusRequest();
  });
  ...
  describe('DescribeEnvironmentStatusRequest', function() {
    it('should create an instance of DescribeEnvironmentStatusRequest', function() {
      // uncomment below and update the code to test DescribeEnvironmentStatusRequest
      //var instance = new AwsCloud9.DescribeEnvironmentStatusRequest();
      //expect(instance).to.be.a(AwsCloud9.DescribeEnvironmentStatusRequest);
    });
