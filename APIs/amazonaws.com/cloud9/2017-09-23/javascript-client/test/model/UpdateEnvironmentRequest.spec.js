...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.UpdateEnvironmentRequest();
  });
  ...
  describe('UpdateEnvironmentRequest', function() {
    it('should create an instance of UpdateEnvironmentRequest', function() {
      ...
      //var instance = new AwsCloud9.UpdateEnvironmentRequest();
      //expect(instance).to.be.a(AwsCloud9.UpdateEnvironmentRequest);
    });
    ...
    it('should have the property managedCredentialsAction (base name: "managedCredentialsAction")', function() {
      // uncomment below and update the code to test the property managedCredentialsAction
      //var instance = new AwsCloud9.UpdateEnvironmentRequest();
      //expect(instance).to.be();
    });
