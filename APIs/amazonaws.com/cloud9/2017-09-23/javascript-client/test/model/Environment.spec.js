...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.Environment();
  });
  ...
  describe('Environment', function() {
    it('should create an instance of Environment', function() {
      ...
      //var instance = new AwsCloud9.Environment();
      //expect(instance).to.be.a(AwsCloud9.Environment);
    });
    ...
    it('should have the property managedCredentialsStatus (base name: "managedCredentialsStatus")', function() {
      // uncomment below and update the code to test the property managedCredentialsStatus
      //var instance = new AwsCloud9.Environment();
      //expect(instance).to.be();
    });
