...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.CreateEnvironmentEC2Request();
  });
  ...
  describe('CreateEnvironmentEC2Request', function() {
    it('should create an instance of CreateEnvironmentEC2Request', function() {
      // uncomment below and update the code to test CreateEnvironmentEC2Request
      //var instance = new AwsCloud9.CreateEnvironmentEC2Request();
      //expect(instance).to.be.a(AwsCloud9.CreateEnvironmentEC2Request);
    });
    ...
    it('should have the property automaticStopTimeMinutes (base name: "automaticStopTimeMinutes")', function() {
      // uncomment below and update the code to test the property automaticStopTimeMinutes
      //var instance = new AwsCloud9.CreateEnvironmentEC2Request();
      //expect(instance).to.be();
    });

    it('should have the property ownerArn (base name: "ownerArn")', function() {
      // uncomment below and update the code to test the property ownerArn
      //var instance = new AwsCloud9.CreateEnvironmentEC2Request();
      //expect(instance).to.be();
    });
