...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.ListEnvironmentsResult();
  });
  ...
  describe('ListEnvironmentsResult', function() {
    it('should create an instance of ListEnvironmentsResult', function() {
      // uncomment below and update the code to test ListEnvironmentsResult
      //var instance = new AwsCloud9.ListEnvironmentsResult();
      //expect(instance).to.be.a(AwsCloud9.ListEnvironmentsResult);
    });
