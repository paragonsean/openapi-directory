...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.EnvironmentMember();
  });
  ...
  describe('EnvironmentMember', function() {
    it('should create an instance of EnvironmentMember', function() {
      // uncomment below and update the code to test EnvironmentMember
      //var instance = new AwsCloud9.EnvironmentMember();
      //expect(instance).to.be.a(AwsCloud9.EnvironmentMember);
    });
