...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsCloud9.ListTagsForResourceResponse();
  });
  ...
  describe('ListTagsForResourceResponse', function() {
    it('should create an instance of ListTagsForResourceResponse', function() {
      ...
      //var instance = new AwsCloud9.ListTagsForResourceResponse();
      //expect(instance).to.be.a(AwsCloud9.ListTagsForResourceResponse);
    });
