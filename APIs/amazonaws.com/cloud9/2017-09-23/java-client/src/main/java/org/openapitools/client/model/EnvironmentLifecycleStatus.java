...
/**
 * Gets or Sets EnvironmentLifecycleStatus
 */
@JsonAdapter(EnvironmentLifecycleStatus.Adapter.class)
public enum EnvironmentLifecycleStatus {
  ...
  EnvironmentLifecycleStatus(String value) {
    this.value = value;
  }
  ...
  public static EnvironmentLifecycleStatus fromValue(String value) {
    for (EnvironmentLifecycleStatus b : EnvironmentLifecycleStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnvironmentLifecycleStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnvironmentLifecycleStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnvironmentLifecycleStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnvironmentLifecycleStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EnvironmentLifecycleStatus.fromValue(value);
  }
}
