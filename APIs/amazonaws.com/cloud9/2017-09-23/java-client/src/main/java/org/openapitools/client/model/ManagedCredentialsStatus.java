...
/**
 * Gets or Sets ManagedCredentialsStatus
 */
@JsonAdapter(ManagedCredentialsStatus.Adapter.class)
public enum ManagedCredentialsStatus {
  ...
  ManagedCredentialsStatus(String value) {
    this.value = value;
  }
  ...
  public static ManagedCredentialsStatus fromValue(String value) {
    for (ManagedCredentialsStatus b : ManagedCredentialsStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ManagedCredentialsStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ManagedCredentialsStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ManagedCredentialsStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ManagedCredentialsStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ManagedCredentialsStatus.fromValue(value);
  }
}
