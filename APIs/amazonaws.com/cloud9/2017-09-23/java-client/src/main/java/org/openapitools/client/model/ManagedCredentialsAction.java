...
/**
 * Gets or Sets ManagedCredentialsAction
 */
@JsonAdapter(ManagedCredentialsAction.Adapter.class)
public enum ManagedCredentialsAction {
  ...
  ManagedCredentialsAction(String value) {
    this.value = value;
  }
  ...
  public static ManagedCredentialsAction fromValue(String value) {
    for (ManagedCredentialsAction b : ManagedCredentialsAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ManagedCredentialsAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ManagedCredentialsAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ManagedCredentialsAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ManagedCredentialsAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ManagedCredentialsAction.fromValue(value);
  }
}
