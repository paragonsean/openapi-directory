...
public class DeleteEnvironmentRequest {
  ...
  public DeleteEnvironmentRequest environmentId(String environmentId) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteEnvironmentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteEnvironmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteEnvironmentRequest is not found in the empty JSON string", DeleteEnvironmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteEnvironmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteEnvironmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteEnvironmentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteEnvironmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteEnvironmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteEnvironmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteEnvironmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteEnvironmentRequest>() {
           @Override
           public void write(JsonWriter out, DeleteEnvironmentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteEnvironmentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteEnvironmentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteEnvironmentRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteEnvironmentRequest
   */
  public static DeleteEnvironmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteEnvironmentRequest.class);
  }

  /**
   * Convert an instance of DeleteEnvironmentRequest to an JSON string
   *
   * @return JSON string
   */
