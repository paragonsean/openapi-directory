...
class Example : public QObject {
    Q_OBJECT
    QString create();
    OAICreateEnvironmentEC2Request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
QString Example::create(){
    QString obj;
OAICreateEnvironmentEC2Request Example::create(){
    OAICreateEnvironmentEC2Request obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createEnvironmentEC2Signal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createEnvironmentEC2SignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAICreateEnvironmentEC2Request oai_create_environment_ec2_request = create(); // OAICreateEnvironmentEC2Request | 
      ...
      apiInstance.createEnvironmentEC2(x_amz_targetoai_create_environment_ec2_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
