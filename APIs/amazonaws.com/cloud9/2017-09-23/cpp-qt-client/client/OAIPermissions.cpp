...
void OAIPermissions::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("owner", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermissions::OWNER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("read-write", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermissions::READ_WRITE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("read-only", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPermissions::READ_ONLY;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPermissions::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPermissions::OWNER:
            val = "owner";
            break;
        case eOAIPermissions::READ_WRITE:
            val = "read-write";
            break;
        case eOAIPermissions::READ_ONLY:
            val = "read-only";
            break;
        default:
            break;
