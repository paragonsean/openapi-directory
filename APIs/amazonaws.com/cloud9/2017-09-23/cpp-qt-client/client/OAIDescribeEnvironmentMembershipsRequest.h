...
/*
 * OAIDescribeEnvironmentMembershipsRequest.h
 *
 * 
 */

#ifndef OAIDescribeEnvironmentMembershipsRequest_H
#define OAIDescribeEnvironmentMembershipsRequest_H
...
class OAIDescribeEnvironmentMembershipsRequest : public OAIObject {
public:
    OAIDescribeEnvironmentMembershipsRequest();
    OAIDescribeEnvironmentMembershipsRequest(QString json);
    ~OAIDescribeEnvironmentMembershipsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentMembershipsRequest)

#endif // OAIDescribeEnvironmentMembershipsRequest_H
