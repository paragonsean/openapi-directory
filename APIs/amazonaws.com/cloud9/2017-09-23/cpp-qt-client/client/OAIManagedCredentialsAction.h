...
/*
 * OAIManagedCredentialsAction.h
 *
 * 
 */

#ifndef OAIManagedCredentialsAction_H
#define OAIManagedCredentialsAction_H
...
class OAIManagedCredentialsAction : public OAIEnum {
public:
    OAIManagedCredentialsAction();
    OAIManagedCredentialsAction(QString json);
    ~OAIManagedCredentialsAction() override;
    ...
    enum class eOAIManagedCredentialsAction {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ENABLE, 
        DISABLE
    };
    OAIManagedCredentialsAction::eOAIManagedCredentialsAction getValue() const;
    void setValue(const OAIManagedCredentialsAction::eOAIManagedCredentialsAction& value);
...
private:
    ...
    eOAIManagedCredentialsAction m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManagedCredentialsAction)

#endif // OAIManagedCredentialsAction_H
