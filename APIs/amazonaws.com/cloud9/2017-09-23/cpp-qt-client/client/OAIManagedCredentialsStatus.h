...
/*
 * OAIManagedCredentialsStatus.h
 *
 * 
 */

#ifndef OAIManagedCredentialsStatus_H
#define OAIManagedCredentialsStatus_H
...
class OAIManagedCredentialsStatus : public OAIEnum {
public:
    OAIManagedCredentialsStatus();
    OAIManagedCredentialsStatus(QString json);
    ~OAIManagedCredentialsStatus() override;
    ...
    enum class eOAIManagedCredentialsStatus {
    ...
    OAIManagedCredentialsStatus::eOAIManagedCredentialsStatus getValue() const;
    void setValue(const OAIManagedCredentialsStatus::eOAIManagedCredentialsStatus& value);
...
private:
    ...
    eOAIManagedCredentialsStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIManagedCredentialsStatus)

#endif // OAIManagedCredentialsStatus_H
