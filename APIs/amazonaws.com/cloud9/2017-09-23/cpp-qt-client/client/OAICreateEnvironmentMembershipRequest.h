...
/*
 * OAICreateEnvironmentMembershipRequest.h
 *
 * 
 */

#ifndef OAICreateEnvironmentMembershipRequest_H
#define OAICreateEnvironmentMembershipRequest_H
...
class OAICreateEnvironmentMembershipRequest : public OAIObject {
public:
    OAICreateEnvironmentMembershipRequest();
    OAICreateEnvironmentMembershipRequest(QString json);
    ~OAICreateEnvironmentMembershipRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironmentMembershipRequest)

#endif // OAICreateEnvironmentMembershipRequest_H
