...
/*
 * OAIDeleteEnvironmentMembershipRequest.h
 *
 * 
 */

#ifndef OAIDeleteEnvironmentMembershipRequest_H
#define OAIDeleteEnvironmentMembershipRequest_H
...
class OAIDeleteEnvironmentMembershipRequest : public OAIObject {
public:
    OAIDeleteEnvironmentMembershipRequest();
    OAIDeleteEnvironmentMembershipRequest(QString json);
    ~OAIDeleteEnvironmentMembershipRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEnvironmentMembershipRequest)

#endif // OAIDeleteEnvironmentMembershipRequest_H
