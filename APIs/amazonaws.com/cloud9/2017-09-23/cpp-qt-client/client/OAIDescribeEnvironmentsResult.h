...
/*
 * OAIDescribeEnvironmentsResult.h
 *
 * 
 */

#ifndef OAIDescribeEnvironmentsResult_H
#define OAIDescribeEnvironmentsResult_H
...
class OAIDescribeEnvironmentsResult : public OAIObject {
public:
    OAIDescribeEnvironmentsResult();
    OAIDescribeEnvironmentsResult(QString json);
    ~OAIDescribeEnvironmentsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentsResult)

#endif // OAIDescribeEnvironmentsResult_H
