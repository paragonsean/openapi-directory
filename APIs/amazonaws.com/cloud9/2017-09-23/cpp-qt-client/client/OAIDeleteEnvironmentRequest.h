...
/*
 * OAIDeleteEnvironmentRequest.h
 *
 * 
 */

#ifndef OAIDeleteEnvironmentRequest_H
#define OAIDeleteEnvironmentRequest_H
...
class OAIDeleteEnvironmentRequest : public OAIObject {
public:
    OAIDeleteEnvironmentRequest();
    OAIDeleteEnvironmentRequest(QString json);
    ~OAIDeleteEnvironmentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteEnvironmentRequest)

#endif // OAIDeleteEnvironmentRequest_H
