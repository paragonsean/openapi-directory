...
/*
 * OAIDescribeEnvironmentStatusRequest.h
 *
 * 
 */

#ifndef OAIDescribeEnvironmentStatusRequest_H
#define OAIDescribeEnvironmentStatusRequest_H
...
class OAIDescribeEnvironmentStatusRequest : public OAIObject {
public:
    OAIDescribeEnvironmentStatusRequest();
    OAIDescribeEnvironmentStatusRequest(QString json);
    ~OAIDescribeEnvironmentStatusRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentStatusRequest)

#endif // OAIDescribeEnvironmentStatusRequest_H
