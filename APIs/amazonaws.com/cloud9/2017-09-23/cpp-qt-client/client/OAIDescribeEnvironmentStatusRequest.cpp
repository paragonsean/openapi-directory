...
OAIDescribeEnvironmentStatusRequest::OAIDescribeEnvironmentStatusRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEnvironmentStatusRequest::OAIDescribeEnvironmentStatusRequest() {
    this->initializeModel();
}

OAIDescribeEnvironmentStatusRequest::~OAIDescribeEnvironmentStatusRequest() {}

void OAIDescribeEnvironmentStatusRequest::initializeModel() {

    m_environment_id_isSet = false;
    m_environment_id_isValid = false;
}

void OAIDescribeEnvironmentStatusRequest::fromJson(QString jsonString) {
...
void OAIDescribeEnvironmentStatusRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEnvironmentStatusRequest::asJson() const {
...
QJsonObject OAIDescribeEnvironmentStatusRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeEnvironmentStatusRequest::getEnvironmentId() const {
    return m_environment_id;
}
void OAIDescribeEnvironmentStatusRequest::setEnvironmentId(const QString &environment_id) {
    m_environment_id = environment_id;
    m_environment_id_isSet = true;
}

bool OAIDescribeEnvironmentStatusRequest::is_environment_id_Set() const{
    return m_environment_id_isSet;
}

bool OAIDescribeEnvironmentStatusRequest::is_environment_id_Valid() const{
    return m_environment_id_isValid;
}

bool OAIDescribeEnvironmentStatusRequest::isSet() const {
...
bool OAIDescribeEnvironmentStatusRequest::isValid() const {
