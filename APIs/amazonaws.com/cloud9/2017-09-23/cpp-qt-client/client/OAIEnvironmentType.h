...
/*
 * OAIEnvironmentType.h
 *
 * 
 */

#ifndef OAIEnvironmentType_H
#define OAIEnvironmentType_H
...
class OAIEnvironmentType : public OAIEnum {
public:
    OAIEnvironmentType();
    OAIEnvironmentType(QString json);
    ~OAIEnvironmentType() override;
    ...
    enum class eOAIEnvironmentType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SSH, 
        EC2
    };
    OAIEnvironmentType::eOAIEnvironmentType getValue() const;
    void setValue(const OAIEnvironmentType::eOAIEnvironmentType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentType)

#endif // OAIEnvironmentType_H
