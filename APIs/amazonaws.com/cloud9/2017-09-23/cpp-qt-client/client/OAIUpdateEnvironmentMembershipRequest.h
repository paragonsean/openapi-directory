...
/*
 * OAIUpdateEnvironmentMembershipRequest.h
 *
 * 
 */

#ifndef OAIUpdateEnvironmentMembershipRequest_H
#define OAIUpdateEnvironmentMembershipRequest_H
...
class OAIUpdateEnvironmentMembershipRequest : public OAIObject {
public:
    OAIUpdateEnvironmentMembershipRequest();
    OAIUpdateEnvironmentMembershipRequest(QString json);
    ~OAIUpdateEnvironmentMembershipRequest() override;
    ...
    OAIMemberPermissions getPermissions() const;
    void setPermissions(const OAIMemberPermissions &permissions);
...
private:
    ...
    OAIMemberPermissions m_permissions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEnvironmentMembershipRequest)

#endif // OAIUpdateEnvironmentMembershipRequest_H
