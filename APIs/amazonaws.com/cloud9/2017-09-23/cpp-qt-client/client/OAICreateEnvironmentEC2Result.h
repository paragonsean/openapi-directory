...
/*
 * OAICreateEnvironmentEC2Result.h
 *
 * 
 */

#ifndef OAICreateEnvironmentEC2Result_H
#define OAICreateEnvironmentEC2Result_H
...
class OAICreateEnvironmentEC2Result : public OAIObject {
public:
    OAICreateEnvironmentEC2Result();
    OAICreateEnvironmentEC2Result(QString json);
    ~OAICreateEnvironmentEC2Result() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironmentEC2Result)

#endif // OAICreateEnvironmentEC2Result_H
