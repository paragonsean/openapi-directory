...
/*
 * OAIDescribeEnvironmentMembershipsResult.h
 *
 * 
 */

#ifndef OAIDescribeEnvironmentMembershipsResult_H
#define OAIDescribeEnvironmentMembershipsResult_H
...
class OAIDescribeEnvironmentMembershipsResult : public OAIObject {
public:
    OAIDescribeEnvironmentMembershipsResult();
    OAIDescribeEnvironmentMembershipsResult(QString json);
    ~OAIDescribeEnvironmentMembershipsResult() override;
    ...
    QList getMemberships() const;
    void setMemberships(const QList &memberships);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentMembershipsResult)

#endif // OAIDescribeEnvironmentMembershipsResult_H
