...
class OAIEnvironmentStatus : public OAIEnum {
public:
    ...
    enum class eOAIEnvironmentStatus {
    ...
    OAIEnvironmentStatus::eOAIEnvironmentStatus getValue() const;
    void setValue(const OAIEnvironmentStatus::eOAIEnvironmentStatus& value);
