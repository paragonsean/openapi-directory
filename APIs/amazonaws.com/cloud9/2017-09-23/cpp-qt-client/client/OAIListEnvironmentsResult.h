...
/*
 * OAIListEnvironmentsResult.h
 *
 * 
 */

#ifndef OAIListEnvironmentsResult_H
#define OAIListEnvironmentsResult_H
...
class OAIListEnvironmentsResult : public OAIObject {
public:
    OAIListEnvironmentsResult();
    OAIListEnvironmentsResult(QString json);
    ~OAIListEnvironmentsResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEnvironmentsResult)

#endif // OAIListEnvironmentsResult_H
