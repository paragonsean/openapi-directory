...
/*
 * OAIListEnvironmentsRequest.h
 *
 * 
 */

#ifndef OAIListEnvironmentsRequest_H
#define OAIListEnvironmentsRequest_H
...
class OAIListEnvironmentsRequest : public OAIObject {
public:
    OAIListEnvironmentsRequest();
    OAIListEnvironmentsRequest(QString json);
    ~OAIListEnvironmentsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListEnvironmentsRequest)

#endif // OAIListEnvironmentsRequest_H
