...
OAIDeleteEnvironmentRequest::OAIDeleteEnvironmentRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteEnvironmentRequest::OAIDeleteEnvironmentRequest() {
    this->initializeModel();
}

OAIDeleteEnvironmentRequest::~OAIDeleteEnvironmentRequest() {}

void OAIDeleteEnvironmentRequest::initializeModel() {

    m_environment_id_isSet = false;
    m_environment_id_isValid = false;
}

void OAIDeleteEnvironmentRequest::fromJson(QString jsonString) {
...
void OAIDeleteEnvironmentRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteEnvironmentRequest::asJson() const {
...
QJsonObject OAIDeleteEnvironmentRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteEnvironmentRequest::getEnvironmentId() const {
    return m_environment_id;
}
void OAIDeleteEnvironmentRequest::setEnvironmentId(const QString &environment_id) {
    m_environment_id = environment_id;
    m_environment_id_isSet = true;
}

bool OAIDeleteEnvironmentRequest::is_environment_id_Set() const{
    return m_environment_id_isSet;
}

bool OAIDeleteEnvironmentRequest::is_environment_id_Valid() const{
    return m_environment_id_isValid;
}

bool OAIDeleteEnvironmentRequest::isSet() const {
...
bool OAIDeleteEnvironmentRequest::isValid() const {
