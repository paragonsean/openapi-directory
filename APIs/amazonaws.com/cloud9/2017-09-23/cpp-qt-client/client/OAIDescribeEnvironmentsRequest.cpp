...
OAIDescribeEnvironmentsRequest::OAIDescribeEnvironmentsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeEnvironmentsRequest::OAIDescribeEnvironmentsRequest() {
    this->initializeModel();
}

OAIDescribeEnvironmentsRequest::~OAIDescribeEnvironmentsRequest() {}

void OAIDescribeEnvironmentsRequest::initializeModel() {

    m_environment_ids_isSet = false;
    m_environment_ids_isValid = false;
}

void OAIDescribeEnvironmentsRequest::fromJson(QString jsonString) {
...
void OAIDescribeEnvironmentsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeEnvironmentsRequest::asJson() const {
...
QJsonObject OAIDescribeEnvironmentsRequest::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDescribeEnvironmentsRequest::getEnvironmentIds() const {
    return m_environment_ids;
}
void OAIDescribeEnvironmentsRequest::setEnvironmentIds(const QList &environment_ids) {
    m_environment_ids = environment_ids;
    m_environment_ids_isSet = true;
}

bool OAIDescribeEnvironmentsRequest::is_environment_ids_Set() const{
    return m_environment_ids_isSet;
}

bool OAIDescribeEnvironmentsRequest::is_environment_ids_Valid() const{
    return m_environment_ids_isValid;
}

bool OAIDescribeEnvironmentsRequest::isSet() const {
...
bool OAIDescribeEnvironmentsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_environment_ids_isValid && true;
}
