...
/*
 * OAIDescribeEnvironmentStatusResult.h
 *
 * 
 */

#ifndef OAIDescribeEnvironmentStatusResult_H
#define OAIDescribeEnvironmentStatusResult_H
...
class OAIDescribeEnvironmentStatusResult : public OAIObject {
public:
    OAIDescribeEnvironmentStatusResult();
    OAIDescribeEnvironmentStatusResult(QString json);
    ~OAIDescribeEnvironmentStatusResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeEnvironmentStatusResult)

#endif // OAIDescribeEnvironmentStatusResult_H
