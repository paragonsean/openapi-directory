...
/*
 * OAICreateEnvironmentMembershipResult.h
 *
 * 
 */

#ifndef OAICreateEnvironmentMembershipResult_H
#define OAICreateEnvironmentMembershipResult_H
...
namespace OpenAPI {
class OAICreateEnvironmentMembershipResult_membership;

class OAICreateEnvironmentMembershipResult : public OAIObject {
public:
    OAICreateEnvironmentMembershipResult();
    OAICreateEnvironmentMembershipResult(QString json);
    ~OAICreateEnvironmentMembershipResult() override;
    ...
    OAICreateEnvironmentMembershipResult_membership getMembership() const;
    void setMembership(const OAICreateEnvironmentMembershipResult_membership &membership);
...
private:
    ...
    OAICreateEnvironmentMembershipResult_membership m_membership;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateEnvironmentMembershipResult)

#endif // OAICreateEnvironmentMembershipResult_H
