...
/*
 * OAIEnvironmentLifecycleStatus.h
 *
 * 
 */

#ifndef OAIEnvironmentLifecycleStatus_H
#define OAIEnvironmentLifecycleStatus_H
...
class OAIEnvironmentLifecycleStatus : public OAIEnum {
public:
    OAIEnvironmentLifecycleStatus();
    OAIEnvironmentLifecycleStatus(QString json);
    ~OAIEnvironmentLifecycleStatus() override;
    ...
    enum class eOAIEnvironmentLifecycleStatus {
    ...
    OAIEnvironmentLifecycleStatus::eOAIEnvironmentLifecycleStatus getValue() const;
    void setValue(const OAIEnvironmentLifecycleStatus::eOAIEnvironmentLifecycleStatus& value);
...
private:
    ...
    eOAIEnvironmentLifecycleStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentLifecycleStatus)

#endif // OAIEnvironmentLifecycleStatus_H
