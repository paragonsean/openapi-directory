...
/*
 * OAIMemberPermissions.h
 *
 * 
 */

#ifndef OAIMemberPermissions_H
#define OAIMemberPermissions_H
...
class OAIMemberPermissions : public OAIEnum {
public:
    OAIMemberPermissions();
    OAIMemberPermissions(QString json);
    ~OAIMemberPermissions() override;
    ...
    enum class eOAIMemberPermissions {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        WRITE, 
        ONLY
    };
    OAIMemberPermissions::eOAIMemberPermissions getValue() const;
    void setValue(const OAIMemberPermissions::eOAIMemberPermissions& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIMemberPermissions)

#endif // OAIMemberPermissions_H
