...
/*
 * OAIUpdateEnvironmentMembershipResult.h
 *
 * 
 */

#ifndef OAIUpdateEnvironmentMembershipResult_H
#define OAIUpdateEnvironmentMembershipResult_H

#include <QJsonObject>

#include "OAIUpdateEnvironmentMembershipResult_membership.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateEnvironmentMembershipResult_membership;

class OAIUpdateEnvironmentMembershipResult : public OAIObject {
public:
    OAIUpdateEnvironmentMembershipResult();
    OAIUpdateEnvironmentMembershipResult(QString json);
    ~OAIUpdateEnvironmentMembershipResult() override;
    ...
    OAIUpdateEnvironmentMembershipResult_membership getMembership() const;
    void setMembership(const OAIUpdateEnvironmentMembershipResult_membership &membership);
...
private:
    ...
    OAIUpdateEnvironmentMembershipResult_membership m_membership;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateEnvironmentMembershipResult)

#endif // OAIUpdateEnvironmentMembershipResult_H
