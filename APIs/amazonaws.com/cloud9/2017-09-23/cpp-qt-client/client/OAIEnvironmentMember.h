...
/*
 * OAIEnvironmentMember.h
 *
 * Information about an environment member for an Cloud9 development environment.
 */

#ifndef OAIEnvironmentMember_H
#define OAIEnvironmentMember_H
...
class OAIEnvironmentMember : public OAIObject {
public:
    OAIEnvironmentMember();
    OAIEnvironmentMember(QString json);
    ~OAIEnvironmentMember() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEnvironmentMember)

#endif // OAIEnvironmentMember_H
