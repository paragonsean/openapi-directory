...
public class ApiClient {
    ...
    private String basePath = "http://fis.us-east-1.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-12-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://fis.us-east-1.amazonaws.com
