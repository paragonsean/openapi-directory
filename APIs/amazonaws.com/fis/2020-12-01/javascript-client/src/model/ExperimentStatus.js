...
* @readonly
*/
export default class ExperimentStatus {
    ...
    /**
    * Returns a <code>ExperimentStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ExperimentStatus} The enum <code>ExperimentStatus</code> value.
    */
