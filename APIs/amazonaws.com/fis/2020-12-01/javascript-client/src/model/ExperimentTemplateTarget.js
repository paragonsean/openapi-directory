...
/**
 * The ExperimentTemplateTarget model module.
 * @module model/ExperimentTemplateTarget
 * @version 2020-12-01
 */
class ExperimentTemplateTarget {
    /**
     * Constructs a new <code>ExperimentTemplateTarget</code>.
     * Describes a target for an experiment template.
     * @alias module:model/ExperimentTemplateTarget
     */
    constructor() { 
        
        ExperimentTemplateTarget.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExperimentTemplateTarget</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExperimentTemplateTarget} obj Optional instance to populate.
     * @return {module:model/ExperimentTemplateTarget} The populated <code>ExperimentTemplateTarget</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExperimentTemplateTarget();
    ...
    /**
     * Validates the JSON data with respect to <code>ExperimentTemplateTarget</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExperimentTemplateTarget</code>.
     */
 ...
 */
ExperimentTemplateTarget.prototype['resourceType'] = undefined;

/**
 * @member {Array} resourceArns
 */
ExperimentTemplateTarget.prototype['resourceArns'] = undefined;

/**
 * @member {Object} resourceTags
 */
ExperimentTemplateTarget.prototype['resourceTags'] = undefined;

/**
 * @member {Array} filters
 */
ExperimentTemplateTarget.prototype['filters'] = undefined;

/**
 * @member {String} selectionMode
 */
ExperimentTemplateTarget.prototype['selectionMode'] = undefined;

/**
 * @member {Object} parameters
 */
ExperimentTemplateTarget.prototype['parameters'] = undefined;
...
export default ExperimentTemplateTarget;
