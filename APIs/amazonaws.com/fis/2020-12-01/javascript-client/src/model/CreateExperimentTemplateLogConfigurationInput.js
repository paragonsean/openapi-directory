...
/**
 * The CreateExperimentTemplateLogConfigurationInput model module.
 * @module model/CreateExperimentTemplateLogConfigurationInput
 * @version 2020-12-01
 */
class CreateExperimentTemplateLogConfigurationInput {
    /**
     * Constructs a new <code>CreateExperimentTemplateLogConfigurationInput</code>.
     * Specifies the configuration for experiment logging.
     * @alias module:model/CreateExperimentTemplateLogConfigurationInput
    ...
    /**
     * Constructs a <code>CreateExperimentTemplateLogConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateExperimentTemplateLogConfigurationInput} obj Optional instance to populate.
     * @return {module:model/CreateExperimentTemplateLogConfigurationInput} The populated <code>CreateExperimentTemplateLogConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateExperimentTemplateLogConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateExperimentTemplateLogConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateExperimentTemplateLogConfigurationInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateExperimentTemplateLogConfigurationInput.RequiredProperties) {
...
CreateExperimentTemplateLogConfigurationInput.RequiredProperties = ["logSchemaVersion"];
...
export default CreateExperimentTemplateLogConfigurationInput;
