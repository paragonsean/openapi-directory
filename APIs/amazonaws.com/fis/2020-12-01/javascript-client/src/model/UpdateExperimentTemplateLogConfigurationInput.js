...
/**
 * The UpdateExperimentTemplateLogConfigurationInput model module.
 * @module model/UpdateExperimentTemplateLogConfigurationInput
 * @version 2020-12-01
 */
class UpdateExperimentTemplateLogConfigurationInput {
    /**
     * Constructs a new <code>UpdateExperimentTemplateLogConfigurationInput</code>.
     * Specifies the configuration for experiment logging.
     * @alias module:model/UpdateExperimentTemplateLogConfigurationInput
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UpdateExperimentTemplateLogConfigurationInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExperimentTemplateLogConfigurationInput} obj Optional instance to populate.
     * @return {module:model/UpdateExperimentTemplateLogConfigurationInput} The populated <code>UpdateExperimentTemplateLogConfigurationInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExperimentTemplateLogConfigurationInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateExperimentTemplateLogConfigurationInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateExperimentTemplateLogConfigurationInput</code>.
     */
...
export default UpdateExperimentTemplateLogConfigurationInput;
