...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.TargetResourceTypeSummary();
  });
  ...
  describe('TargetResourceTypeSummary', function() {
    it('should create an instance of TargetResourceTypeSummary', function() {
      // uncomment below and update the code to test TargetResourceTypeSummary
      //var instance = new AwsFaultInjectionSimulator.TargetResourceTypeSummary();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.TargetResourceTypeSummary);
    });
