...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTemplateTarget();
  });
  ...
  describe('ExperimentTemplateTarget', function() {
    it('should create an instance of ExperimentTemplateTarget', function() {
      // uncomment below and update the code to test ExperimentTemplateTarget
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplateTarget();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTemplateTarget);
    });
    ...
    it('should have the property selectionMode (base name: "selectionMode")', function() {
      // uncomment below and update the code to test the property selectionMode
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplateTarget();
      //expect(instance).to.be();
    });
