...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateRequestLogConfigurationS3Configuration();
  });
  ...
  describe('CreateExperimentTemplateRequestLogConfigurationS3Configuration', function() {
    it('should create an instance of CreateExperimentTemplateRequestLogConfigurationS3Configuration', function() {
      // uncomment below and update the code to test CreateExperimentTemplateRequestLogConfigurationS3Configuration
      //var instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateRequestLogConfigurationS3Configuration();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.CreateExperimentTemplateRequestLogConfigurationS3Configuration);
    });
