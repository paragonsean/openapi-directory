...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.GetExperimentResponseExperiment();
  });
  ...
  describe('GetExperimentResponseExperiment', function() {
    it('should create an instance of GetExperimentResponseExperiment', function() {
      // uncomment below and update the code to test GetExperimentResponseExperiment
      //var instance = new AwsFaultInjectionSimulator.GetExperimentResponseExperiment();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.GetExperimentResponseExperiment);
    });
