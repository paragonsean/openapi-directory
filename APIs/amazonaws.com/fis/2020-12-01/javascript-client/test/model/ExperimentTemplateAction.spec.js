...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTemplateAction();
  });
  ...
  describe('ExperimentTemplateAction', function() {
    it('should create an instance of ExperimentTemplateAction', function() {
      // uncomment below and update the code to test ExperimentTemplateAction
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplateAction();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTemplateAction);
    });
