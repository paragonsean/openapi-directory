...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTemplateS3LogConfigurationInput();
  });
  ...
  describe('ExperimentTemplateS3LogConfigurationInput', function() {
    it('should create an instance of ExperimentTemplateS3LogConfigurationInput', function() {
      // uncomment below and update the code to test ExperimentTemplateS3LogConfigurationInput
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplateS3LogConfigurationInput();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTemplateS3LogConfigurationInput);
    });
