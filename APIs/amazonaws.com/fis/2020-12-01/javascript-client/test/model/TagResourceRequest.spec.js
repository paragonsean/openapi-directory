...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsFaultInjectionSimulator.TagResourceRequest();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.TagResourceRequest);
    });
