...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentLogConfigurationS3Configuration();
  });
  ...
  describe('ExperimentLogConfigurationS3Configuration', function() {
    it('should create an instance of ExperimentLogConfigurationS3Configuration', function() {
      // uncomment below and update the code to test ExperimentLogConfigurationS3Configuration
      //var instance = new AwsFaultInjectionSimulator.ExperimentLogConfigurationS3Configuration();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentLogConfigurationS3Configuration);
    });
