...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTemplate();
  });
  ...
  describe('ExperimentTemplate', function() {
    it('should create an instance of ExperimentTemplate', function() {
      // uncomment below and update the code to test ExperimentTemplate
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplate();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTemplate);
    });
