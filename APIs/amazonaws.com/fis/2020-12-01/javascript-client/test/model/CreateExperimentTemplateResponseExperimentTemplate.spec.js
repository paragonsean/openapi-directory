...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateResponseExperimentTemplate();
  });
  ...
  describe('CreateExperimentTemplateResponseExperimentTemplate', function() {
    it('should create an instance of CreateExperimentTemplateResponseExperimentTemplate', function() {
      // uncomment below and update the code to test CreateExperimentTemplateResponseExperimentTemplate
      //var instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateResponseExperimentTemplate();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.CreateExperimentTemplateResponseExperimentTemplate);
    });
