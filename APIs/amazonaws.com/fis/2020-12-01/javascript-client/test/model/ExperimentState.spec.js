...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentState();
  });
  ...
  describe('ExperimentState', function() {
    it('should create an instance of ExperimentState', function() {
      // uncomment below and update the code to test ExperimentState
      //var instance = new AwsFaultInjectionSimulator.ExperimentState();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentState);
    });
