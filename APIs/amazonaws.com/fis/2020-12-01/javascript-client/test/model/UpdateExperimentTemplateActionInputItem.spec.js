...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateActionInputItem();
  });
  ...
  describe('UpdateExperimentTemplateActionInputItem', function() {
    it('should create an instance of UpdateExperimentTemplateActionInputItem', function() {
      // uncomment below and update the code to test UpdateExperimentTemplateActionInputItem
      //var instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateActionInputItem();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.UpdateExperimentTemplateActionInputItem);
    });
