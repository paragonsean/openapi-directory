...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.GetActionResponseAction();
  });
  ...
  describe('GetActionResponseAction', function() {
    it('should create an instance of GetActionResponseAction', function() {
      // uncomment below and update the code to test GetActionResponseAction
      //var instance = new AwsFaultInjectionSimulator.GetActionResponseAction();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.GetActionResponseAction);
    });
