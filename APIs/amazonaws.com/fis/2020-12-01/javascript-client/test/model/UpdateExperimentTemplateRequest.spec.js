...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateRequest();
  });
  ...
  describe('UpdateExperimentTemplateRequest', function() {
    it('should create an instance of UpdateExperimentTemplateRequest', function() {
      // uncomment below and update the code to test UpdateExperimentTemplateRequest
      //var instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateRequest();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.UpdateExperimentTemplateRequest);
    });
    ...
    it('should have the property stopConditions (base name: "stopConditions")', function() {
      // uncomment below and update the code to test the property stopConditions
      //var instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateRequest();
      //expect(instance).to.be();
    });
