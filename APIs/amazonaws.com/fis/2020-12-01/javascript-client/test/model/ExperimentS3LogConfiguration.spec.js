...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentS3LogConfiguration();
  });
  ...
  describe('ExperimentS3LogConfiguration', function() {
    it('should create an instance of ExperimentS3LogConfiguration', function() {
      // uncomment below and update the code to test ExperimentS3LogConfiguration
      //var instance = new AwsFaultInjectionSimulator.ExperimentS3LogConfiguration();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentS3LogConfiguration);
    });
