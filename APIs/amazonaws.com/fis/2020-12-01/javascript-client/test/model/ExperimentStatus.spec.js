...
(function(root, factory) {
  ...
  describe('ExperimentStatus', function() {
    it('should create an instance of ExperimentStatus', function() {
      // uncomment below and update the code to test ExperimentStatus
      //var instance = new AwsFaultInjectionSimulator.ExperimentStatus();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentStatus);
    });
