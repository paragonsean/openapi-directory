...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.Action();
  });
  ...
  describe('Action', function() {
    it('should create an instance of Action', function() {
      ...
      //var instance = new AwsFaultInjectionSimulator.Action();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.Action);
    });
