...
(function(root, factory) {
  ...
  describe('ExperimentActionStatus', function() {
    it('should create an instance of ExperimentActionStatus', function() {
      // uncomment below and update the code to test ExperimentActionStatus
      //var instance = new AwsFaultInjectionSimulator.ExperimentActionStatus();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentActionStatus);
    });
