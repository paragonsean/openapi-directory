...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateRequest();
  });
  ...
  describe('CreateExperimentTemplateRequest', function() {
    it('should create an instance of CreateExperimentTemplateRequest', function() {
      // uncomment below and update the code to test CreateExperimentTemplateRequest
      //var instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateRequest();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.CreateExperimentTemplateRequest);
    });
