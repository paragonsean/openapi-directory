...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.TargetResourceType();
  });
  ...
  describe('TargetResourceType', function() {
    it('should create an instance of TargetResourceType', function() {
      // uncomment below and update the code to test TargetResourceType
      //var instance = new AwsFaultInjectionSimulator.TargetResourceType();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.TargetResourceType);
    });
