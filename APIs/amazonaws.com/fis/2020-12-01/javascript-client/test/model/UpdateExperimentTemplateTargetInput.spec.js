...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateTargetInput();
  });
  ...
  describe('UpdateExperimentTemplateTargetInput', function() {
    it('should create an instance of UpdateExperimentTemplateTargetInput', function() {
      // uncomment below and update the code to test UpdateExperimentTemplateTargetInput
      //var instance = new AwsFaultInjectionSimulator.UpdateExperimentTemplateTargetInput();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.UpdateExperimentTemplateTargetInput);
    });
