...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentAction();
  });
  ...
  describe('ExperimentAction', function() {
    it('should create an instance of ExperimentAction', function() {
      // uncomment below and update the code to test ExperimentAction
      //var instance = new AwsFaultInjectionSimulator.ExperimentAction();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentAction);
    });
