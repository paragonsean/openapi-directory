...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ActionTarget();
  });
  ...
  describe('ActionTarget', function() {
    it('should create an instance of ActionTarget', function() {
      // uncomment below and update the code to test ActionTarget
      //var instance = new AwsFaultInjectionSimulator.ActionTarget();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ActionTarget);
    });
