...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.TargetResourceTypeParameter();
  });
  ...
  describe('TargetResourceTypeParameter', function() {
    it('should create an instance of TargetResourceTypeParameter', function() {
      // uncomment below and update the code to test TargetResourceTypeParameter
      //var instance = new AwsFaultInjectionSimulator.TargetResourceTypeParameter();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.TargetResourceTypeParameter);
    });
