...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateTargetInput();
  });
  ...
  describe('CreateExperimentTemplateTargetInput', function() {
    it('should create an instance of CreateExperimentTemplateTargetInput', function() {
      // uncomment below and update the code to test CreateExperimentTemplateTargetInput
      //var instance = new AwsFaultInjectionSimulator.CreateExperimentTemplateTargetInput();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.CreateExperimentTemplateTargetInput);
    });
