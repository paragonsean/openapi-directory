...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ListActionsResponse();
  });
  ...
  describe('ListActionsResponse', function() {
    it('should create an instance of ListActionsResponse', function() {
      // uncomment below and update the code to test ListActionsResponse
      //var instance = new AwsFaultInjectionSimulator.ListActionsResponse();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ListActionsResponse);
    });
