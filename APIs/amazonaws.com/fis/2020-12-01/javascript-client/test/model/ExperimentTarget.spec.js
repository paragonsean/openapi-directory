...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTarget();
  });
  ...
  describe('ExperimentTarget', function() {
    it('should create an instance of ExperimentTarget', function() {
      // uncomment below and update the code to test ExperimentTarget
      //var instance = new AwsFaultInjectionSimulator.ExperimentTarget();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTarget);
    });
