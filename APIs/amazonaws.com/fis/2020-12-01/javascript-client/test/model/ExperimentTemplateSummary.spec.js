...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTemplateSummary();
  });
  ...
  describe('ExperimentTemplateSummary', function() {
    it('should create an instance of ExperimentTemplateSummary', function() {
      // uncomment below and update the code to test ExperimentTemplateSummary
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplateSummary();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTemplateSummary);
    });
