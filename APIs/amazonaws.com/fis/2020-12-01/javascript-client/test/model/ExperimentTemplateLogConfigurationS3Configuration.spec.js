...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ExperimentTemplateLogConfigurationS3Configuration();
  });
  ...
  describe('ExperimentTemplateLogConfigurationS3Configuration', function() {
    it('should create an instance of ExperimentTemplateLogConfigurationS3Configuration', function() {
      // uncomment below and update the code to test ExperimentTemplateLogConfigurationS3Configuration
      //var instance = new AwsFaultInjectionSimulator.ExperimentTemplateLogConfigurationS3Configuration();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ExperimentTemplateLogConfigurationS3Configuration);
    });
