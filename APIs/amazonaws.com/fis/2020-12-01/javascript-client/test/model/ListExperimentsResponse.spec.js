...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.ListExperimentsResponse();
  });
  ...
  describe('ListExperimentsResponse', function() {
    it('should create an instance of ListExperimentsResponse', function() {
      // uncomment below and update the code to test ListExperimentsResponse
      //var instance = new AwsFaultInjectionSimulator.ListExperimentsResponse();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.ListExperimentsResponse);
    });
