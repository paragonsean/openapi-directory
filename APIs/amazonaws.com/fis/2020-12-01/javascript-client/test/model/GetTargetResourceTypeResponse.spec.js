...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsFaultInjectionSimulator.GetTargetResourceTypeResponse();
  });
  ...
  describe('GetTargetResourceTypeResponse', function() {
    it('should create an instance of GetTargetResourceTypeResponse', function() {
      // uncomment below and update the code to test GetTargetResourceTypeResponse
      //var instance = new AwsFaultInjectionSimulator.GetTargetResourceTypeResponse();
      //expect(instance).to.be.a(AwsFaultInjectionSimulator.GetTargetResourceTypeResponse);
    });
