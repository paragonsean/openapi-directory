...
/*
 * OAITargetResourceType.h
 *
 * Describes a resource type.
 */

#ifndef OAITargetResourceType_H
#define OAITargetResourceType_H
...
class OAITargetResourceType : public OAIObject {
public:
    OAITargetResourceType();
    OAITargetResourceType(QString json);
    ~OAITargetResourceType() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITargetResourceType)

#endif // OAITargetResourceType_H
