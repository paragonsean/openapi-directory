...
/*
 * OAIExperiment_state.h
 *
 * 
 */

#ifndef OAIExperiment_state_H
#define OAIExperiment_state_H
...
class OAIExperiment_state : public OAIObject {
public:
    OAIExperiment_state();
    OAIExperiment_state(QString json);
    ~OAIExperiment_state() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperiment_state)

#endif // OAIExperiment_state_H
