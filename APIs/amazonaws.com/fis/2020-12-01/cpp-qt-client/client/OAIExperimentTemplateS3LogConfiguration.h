...
/*
 * OAIExperimentTemplateS3LogConfiguration.h
 *
 * Describes the configuration for experiment logging to Amazon S3.
 */

#ifndef OAIExperimentTemplateS3LogConfiguration_H
#define OAIExperimentTemplateS3LogConfiguration_H
...
class OAIExperimentTemplateS3LogConfiguration : public OAIObject {
public:
    OAIExperimentTemplateS3LogConfiguration();
    OAIExperimentTemplateS3LogConfiguration(QString json);
    ~OAIExperimentTemplateS3LogConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentTemplateS3LogConfiguration)

#endif // OAIExperimentTemplateS3LogConfiguration_H
