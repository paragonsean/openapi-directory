...
/*
 * OAIExperimentTargetFilter.h
 *
 * Describes a filter used for the target resources in an experiment.
 */

#ifndef OAIExperimentTargetFilter_H
#define OAIExperimentTargetFilter_H
...
class OAIExperimentTargetFilter : public OAIObject {
public:
    OAIExperimentTargetFilter();
    OAIExperimentTargetFilter(QString json);
    ~OAIExperimentTargetFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentTargetFilter)

#endif // OAIExperimentTargetFilter_H
