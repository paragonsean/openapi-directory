...
OAIExperimentTemplate_logConfiguration::OAIExperimentTemplate_logConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIExperimentTemplate_logConfiguration::OAIExperimentTemplate_logConfiguration() {
    this->initializeModel();
}

OAIExperimentTemplate_logConfiguration::~OAIExperimentTemplate_logConfiguration() {}

void OAIExperimentTemplate_logConfiguration::initializeModel() {
...
void OAIExperimentTemplate_logConfiguration::fromJson(QString jsonString) {
...
void OAIExperimentTemplate_logConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIExperimentTemplate_logConfiguration::asJson() const {
...
QJsonObject OAIExperimentTemplate_logConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIExperimentTemplateLogConfiguration_cloudWatchLogsConfiguration OAIExperimentTemplate_logConfiguration::getCloudWatchLogsConfiguration() const {
    return m_cloud_watch_logs_configuration;
}
void OAIExperimentTemplate_logConfiguration::setCloudWatchLogsConfiguration(const OAIExperimentTemplateLogConfiguration_cloudWatchLogsConfiguration &cloud_watch_logs_configuration) {
    m_cloud_watch_logs_configuration = cloud_watch_logs_configuration;
    m_cloud_watch_logs_configuration_isSet = true;
}

bool OAIExperimentTemplate_logConfiguration::is_cloud_watch_logs_configuration_Set() const{
    return m_cloud_watch_logs_configuration_isSet;
}

bool OAIExperimentTemplate_logConfiguration::is_cloud_watch_logs_configuration_Valid() const{
    return m_cloud_watch_logs_configuration_isValid;
}

OAIExperimentTemplateLogConfiguration_s3Configuration OAIExperimentTemplate_logConfiguration::getS3Configuration() const {
    return m_s3_configuration;
}
void OAIExperimentTemplate_logConfiguration::setS3Configuration(const OAIExperimentTemplateLogConfiguration_s3Configuration &s3_configuration) {
    m_s3_configuration = s3_configuration;
    m_s3_configuration_isSet = true;
}

bool OAIExperimentTemplate_logConfiguration::is_s3_configuration_Set() const{
    return m_s3_configuration_isSet;
}

bool OAIExperimentTemplate_logConfiguration::is_s3_configuration_Valid() const{
    return m_s3_configuration_isValid;
}

qint32 OAIExperimentTemplate_logConfiguration::getLogSchemaVersion() const {
    return m_log_schema_version;
}
void OAIExperimentTemplate_logConfiguration::setLogSchemaVersion(const qint32 &log_schema_version) {
    m_log_schema_version = log_schema_version;
    m_log_schema_version_isSet = true;
}

bool OAIExperimentTemplate_logConfiguration::is_log_schema_version_Set() const{
    return m_log_schema_version_isSet;
}

bool OAIExperimentTemplate_logConfiguration::is_log_schema_version_Valid() const{
    return m_log_schema_version_isValid;
}

bool OAIExperimentTemplate_logConfiguration::isSet() const {
...
bool OAIExperimentTemplate_logConfiguration::isValid() const {
