...
/*
 * OAICreateExperimentTemplateTargetInput.h
 *
...
#ifndef OAICreateExperimentTemplateTargetInput_H
#define OAICreateExperimentTemplateTargetInput_H
...
class OAICreateExperimentTemplateTargetInput : public OAIObject {
public:
    OAICreateExperimentTemplateTargetInput();
    OAICreateExperimentTemplateTargetInput(QString json);
    ~OAICreateExperimentTemplateTargetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateExperimentTemplateTargetInput)

#endif // OAICreateExperimentTemplateTargetInput_H
