...
/*
 * OAIExperimentTarget.h
 *
 * Describes a target for an experiment.
 */

#ifndef OAIExperimentTarget_H
#define OAIExperimentTarget_H
...
class OAIExperimentTarget : public OAIObject {
public:
    OAIExperimentTarget();
    OAIExperimentTarget(QString json);
    ~OAIExperimentTarget() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentTarget)

#endif // OAIExperimentTarget_H
