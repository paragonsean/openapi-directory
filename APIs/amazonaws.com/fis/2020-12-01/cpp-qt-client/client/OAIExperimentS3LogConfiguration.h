...
/*
 * OAIExperimentS3LogConfiguration.h
 *
 * Describes the configuration for experiment logging to Amazon S3.
 */

#ifndef OAIExperimentS3LogConfiguration_H
#define OAIExperimentS3LogConfiguration_H
...
class OAIExperimentS3LogConfiguration : public OAIObject {
public:
    OAIExperimentS3LogConfiguration();
    OAIExperimentS3LogConfiguration(QString json);
    ~OAIExperimentS3LogConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentS3LogConfiguration)

#endif // OAIExperimentS3LogConfiguration_H
