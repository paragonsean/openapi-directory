...
/*
 * OAIExperimentLogConfiguration_s3Configuration.h
 *
 * 
 */

#ifndef OAIExperimentLogConfiguration_s3Configuration_H
#define OAIExperimentLogConfiguration_s3Configuration_H
...
class OAIExperimentLogConfiguration_s3Configuration : public OAIObject {
public:
    OAIExperimentLogConfiguration_s3Configuration();
    OAIExperimentLogConfiguration_s3Configuration(QString json);
    ~OAIExperimentLogConfiguration_s3Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentLogConfiguration_s3Configuration)

#endif // OAIExperimentLogConfiguration_s3Configuration_H
