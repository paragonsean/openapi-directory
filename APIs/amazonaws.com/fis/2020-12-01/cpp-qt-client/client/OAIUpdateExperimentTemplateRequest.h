...
/*
 * OAIUpdateExperimentTemplateRequest.h
 *
 * 
 */

#ifndef OAIUpdateExperimentTemplateRequest_H
#define OAIUpdateExperimentTemplateRequest_H
...
namespace OpenAPI {
class OAIUpdateExperimentTemplateRequest_logConfiguration;

class OAIUpdateExperimentTemplateRequest : public OAIObject {
public:
    OAIUpdateExperimentTemplateRequest();
    OAIUpdateExperimentTemplateRequest(QString json);
    ~OAIUpdateExperimentTemplateRequest() override;
    ...
    OAIUpdateExperimentTemplateRequest_logConfiguration getLogConfiguration() const;
    void setLogConfiguration(const OAIUpdateExperimentTemplateRequest_logConfiguration &log_configuration);
...
private:
    ...
    OAIUpdateExperimentTemplateRequest_logConfiguration m_log_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperimentTemplateRequest)

#endif // OAIUpdateExperimentTemplateRequest_H
