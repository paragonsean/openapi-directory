...
/*
 * OAIUpdateExperimentTemplateActionInputItem.h
 *
 * Specifies an action for an experiment template.
 */

#ifndef OAIUpdateExperimentTemplateActionInputItem_H
#define OAIUpdateExperimentTemplateActionInputItem_H
...
class OAIUpdateExperimentTemplateActionInputItem : public OAIObject {
public:
    OAIUpdateExperimentTemplateActionInputItem();
    OAIUpdateExperimentTemplateActionInputItem(QString json);
    ~OAIUpdateExperimentTemplateActionInputItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperimentTemplateActionInputItem)

#endif // OAIUpdateExperimentTemplateActionInputItem_H
