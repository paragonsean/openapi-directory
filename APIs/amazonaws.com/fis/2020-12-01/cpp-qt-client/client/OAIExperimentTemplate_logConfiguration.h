...
/*
 * OAIExperimentTemplate_logConfiguration.h
 *
 * 
 */

#ifndef OAIExperimentTemplate_logConfiguration_H
#define OAIExperimentTemplate_logConfiguration_H
...
class OAIExperimentTemplate_logConfiguration : public OAIObject {
public:
    OAIExperimentTemplate_logConfiguration();
    OAIExperimentTemplate_logConfiguration(QString json);
    ~OAIExperimentTemplate_logConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentTemplate_logConfiguration)

#endif // OAIExperimentTemplate_logConfiguration_H
