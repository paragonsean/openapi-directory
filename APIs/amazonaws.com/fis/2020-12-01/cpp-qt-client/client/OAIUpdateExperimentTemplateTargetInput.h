...
/*
 * OAIUpdateExperimentTemplateTargetInput.h
 *
 * Specifies a target for an experiment. You must specify at least one Amazon Resource Name (ARN) or at least one resource tag. You cannot specify both.
 */

#ifndef OAIUpdateExperimentTemplateTargetInput_H
#define OAIUpdateExperimentTemplateTargetInput_H
...
class OAIUpdateExperimentTemplateTargetInput : public OAIObject {
public:
    OAIUpdateExperimentTemplateTargetInput();
    OAIUpdateExperimentTemplateTargetInput(QString json);
    ~OAIUpdateExperimentTemplateTargetInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateExperimentTemplateTargetInput)

#endif // OAIUpdateExperimentTemplateTargetInput_H
