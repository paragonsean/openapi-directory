...
/*
 * OAIExperimentTemplateAction.h
 *
 * Describes an action for an experiment template.
 */

#ifndef OAIExperimentTemplateAction_H
#define OAIExperimentTemplateAction_H
...
class OAIExperimentTemplateAction : public OAIObject {
public:
    OAIExperimentTemplateAction();
    OAIExperimentTemplateAction(QString json);
    ~OAIExperimentTemplateAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentTemplateAction)

#endif // OAIExperimentTemplateAction_H
