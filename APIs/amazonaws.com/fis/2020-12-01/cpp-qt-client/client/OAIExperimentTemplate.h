...
/*
 * OAIExperimentTemplate.h
 *
 * Describes an experiment template.
 */

#ifndef OAIExperimentTemplate_H
#define OAIExperimentTemplate_H
...
class OAIExperimentTemplate : public OAIObject {
public:
    OAIExperimentTemplate();
    OAIExperimentTemplate(QString json);
    ~OAIExperimentTemplate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExperimentTemplate)

#endif // OAIExperimentTemplate_H
