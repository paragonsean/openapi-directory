...
class Example : public QObject {
    Q_OBJECT
    OAICreateExperimentTemplate_request create();
    QString create();
    QString create();
    QString create();
    QString create();
...
OAICreateExperimentTemplate_request Example::create(){
    OAICreateExperimentTemplate_request obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::createExperimentTemplateSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::createExperimentTemplateSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      OAICreateExperimentTemplate_request oai_create_experiment_template_request = create(); // OAICreateExperimentTemplate_request | 
      ...
      apiInstance.createExperimentTemplate(oai_create_experiment_template_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
