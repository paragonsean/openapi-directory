...
public class CreateBackendAuthResourceConfig {
  ...
  public CreateBackendAuthResourceConfig() {
  }

  public CreateBackendAuthResourceConfig authResources(AuthResources authResources) {
  ...
  public CreateBackendAuthResourceConfig identityPoolConfigs(CreateBackendAuthRequestResourceConfigIdentityPoolConfigs identityPoolConfigs) {
  ...
  public CreateBackendAuthResourceConfig service(Service service) {
  ...
  public CreateBackendAuthResourceConfig userPoolConfigs(CreateBackendAuthRequestResourceConfigUserPoolConfigs userPoolConfigs) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBackendAuthResourceConfig createBackendAuthResourceConfig = (CreateBackendAuthResourceConfig) o;
    return Objects.equals(this.authResources, createBackendAuthResourceConfig.authResources) &&
        Objects.equals(this.identityPoolConfigs, createBackendAuthResourceConfig.identityPoolConfigs) &&
        Objects.equals(this.service, createBackendAuthResourceConfig.service) &&
        Objects.equals(this.userPoolConfigs, createBackendAuthResourceConfig.userPoolConfigs);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateBackendAuthResourceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBackendAuthResourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBackendAuthResourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBackendAuthResourceConfig is not found in the empty JSON string", CreateBackendAuthResourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBackendAuthResourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBackendAuthResourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateBackendAuthResourceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBackendAuthResourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBackendAuthResourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBackendAuthResourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBackendAuthResourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBackendAuthResourceConfig>() {
           @Override
           public void write(JsonWriter out, CreateBackendAuthResourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBackendAuthResourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBackendAuthResourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBackendAuthResourceConfig
   * @throws IOException if the JSON string is invalid with respect to CreateBackendAuthResourceConfig
   */
  public static CreateBackendAuthResourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBackendAuthResourceConfig.class);
  }

  /**
   * Convert an instance of CreateBackendAuthResourceConfig to an JSON string
   *
   * @return JSON string
   */
