...
public class GetBackendAPIResponseResourceConfig {
  ...
  public GetBackendAPIResponseResourceConfig additionalAuthTypes(List additionalAuthTypes) {
  ...
  public GetBackendAPIResponseResourceConfig apiName(String apiName) {
  ...
  public GetBackendAPIResponseResourceConfig conflictResolution(CreateBackendAPIRequestResourceConfigConflictResolution conflictResolution) {
  ...
  public GetBackendAPIResponseResourceConfig defaultAuthType(CreateBackendAPIRequestResourceConfigDefaultAuthType defaultAuthType) {
  ...
  public GetBackendAPIResponseResourceConfig service(String service) {
  ...
  public GetBackendAPIResponseResourceConfig transformSchema(String transformSchema) {
  ...
  public boolean equals(Object o) {
    ...
    GetBackendAPIResponseResourceConfig getBackendAPIResponseResourceConfig = (GetBackendAPIResponseResourceConfig) o;
    return Objects.equals(this.additionalAuthTypes, getBackendAPIResponseResourceConfig.additionalAuthTypes) &&
        Objects.equals(this.apiName, getBackendAPIResponseResourceConfig.apiName) &&
        Objects.equals(this.conflictResolution, getBackendAPIResponseResourceConfig.conflictResolution) &&
        Objects.equals(this.defaultAuthType, getBackendAPIResponseResourceConfig.defaultAuthType) &&
        Objects.equals(this.service, getBackendAPIResponseResourceConfig.service) &&
        Objects.equals(this.transformSchema, getBackendAPIResponseResourceConfig.transformSchema);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBackendAPIResponseResourceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBackendAPIResponseResourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBackendAPIResponseResourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetBackendAPIResponseResourceConfig is not found in the empty JSON string", GetBackendAPIResponseResourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBackendAPIResponseResourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetBackendAPIResponseResourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBackendAPIResponseResourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBackendAPIResponseResourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBackendAPIResponseResourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBackendAPIResponseResourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBackendAPIResponseResourceConfig>() {
           @Override
           public void write(JsonWriter out, GetBackendAPIResponseResourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBackendAPIResponseResourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBackendAPIResponseResourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBackendAPIResponseResourceConfig
   * @throws IOException if the JSON string is invalid with respect to GetBackendAPIResponseResourceConfig
   */
  public static GetBackendAPIResponseResourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBackendAPIResponseResourceConfig.class);
  }

  /**
   * Convert an instance of GetBackendAPIResponseResourceConfig to an JSON string
   *
   * @return JSON string
   */
