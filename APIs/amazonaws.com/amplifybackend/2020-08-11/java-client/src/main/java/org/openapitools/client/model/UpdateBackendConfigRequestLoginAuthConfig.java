...
public class UpdateBackendConfigRequestLoginAuthConfig {
  ...
  public UpdateBackendConfigRequestLoginAuthConfig() {
  }

  public UpdateBackendConfigRequestLoginAuthConfig awsCognitoIdentityPoolId(String awsCognitoIdentityPoolId) {
  ...
  public UpdateBackendConfigRequestLoginAuthConfig awsCognitoRegion(String awsCognitoRegion) {
  ...
  public UpdateBackendConfigRequestLoginAuthConfig awsUserPoolsId(String awsUserPoolsId) {
  ...
  public UpdateBackendConfigRequestLoginAuthConfig awsUserPoolsWebClientId(String awsUserPoolsWebClientId) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateBackendConfigRequestLoginAuthConfig updateBackendConfigRequestLoginAuthConfig = (UpdateBackendConfigRequestLoginAuthConfig) o;
    return Objects.equals(this.awsCognitoIdentityPoolId, updateBackendConfigRequestLoginAuthConfig.awsCognitoIdentityPoolId) &&
        Objects.equals(this.awsCognitoRegion, updateBackendConfigRequestLoginAuthConfig.awsCognitoRegion) &&
        Objects.equals(this.awsUserPoolsId, updateBackendConfigRequestLoginAuthConfig.awsUserPoolsId) &&
        Objects.equals(this.awsUserPoolsWebClientId, updateBackendConfigRequestLoginAuthConfig.awsUserPoolsWebClientId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateBackendConfigRequestLoginAuthConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateBackendConfigRequestLoginAuthConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateBackendConfigRequestLoginAuthConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateBackendConfigRequestLoginAuthConfig is not found in the empty JSON string", UpdateBackendConfigRequestLoginAuthConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateBackendConfigRequestLoginAuthConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateBackendConfigRequestLoginAuthConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateBackendConfigRequestLoginAuthConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateBackendConfigRequestLoginAuthConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateBackendConfigRequestLoginAuthConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateBackendConfigRequestLoginAuthConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateBackendConfigRequestLoginAuthConfig>() {
           @Override
           public void write(JsonWriter out, UpdateBackendConfigRequestLoginAuthConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateBackendConfigRequestLoginAuthConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateBackendConfigRequestLoginAuthConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateBackendConfigRequestLoginAuthConfig
   * @throws IOException if the JSON string is invalid with respect to UpdateBackendConfigRequestLoginAuthConfig
   */
  public static UpdateBackendConfigRequestLoginAuthConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateBackendConfigRequestLoginAuthConfig.class);
  }

  /**
   * Convert an instance of UpdateBackendConfigRequestLoginAuthConfig to an JSON string
   *
   * @return JSON string
   */
