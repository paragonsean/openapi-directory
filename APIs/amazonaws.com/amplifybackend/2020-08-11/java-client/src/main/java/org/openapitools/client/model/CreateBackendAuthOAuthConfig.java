...
public class CreateBackendAuthOAuthConfig {
  ...
  public CreateBackendAuthOAuthConfig domainPrefix(String domainPrefix) {
  ...
  public CreateBackendAuthOAuthConfig oauthGrantType(OAuthGrantType oauthGrantType) {
  ...
  public CreateBackendAuthOAuthConfig oauthScopes(List oauthScopes) {
  ...
  public CreateBackendAuthOAuthConfig redirectSignInURIs(List redirectSignInURIs) {
  ...
  public CreateBackendAuthOAuthConfig redirectSignOutURIs(List redirectSignOutURIs) {
  ...
  public CreateBackendAuthOAuthConfig socialProviderSettings(CreateBackendAuthOAuthConfigSocialProviderSettings socialProviderSettings) {
