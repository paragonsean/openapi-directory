...
public class BackendAPIAppSyncAuthSettings {
  ...
  public BackendAPIAppSyncAuthSettings cognitoUserPoolId(String cognitoUserPoolId) {
  ...
  public BackendAPIAppSyncAuthSettings description(String description) {
  ...
  public BackendAPIAppSyncAuthSettings expirationTime(Double expirationTime) {
  ...
  public BackendAPIAppSyncAuthSettings openIDAuthTTL(String openIDAuthTTL) {
  ...
  public BackendAPIAppSyncAuthSettings openIDClientId(String openIDClientId) {
  ...
  public BackendAPIAppSyncAuthSettings openIDIatTTL(String openIDIatTTL) {
  ...
  public BackendAPIAppSyncAuthSettings openIDIssueURL(String openIDIssueURL) {
  ...
  public BackendAPIAppSyncAuthSettings openIDProviderName(String openIDProviderName) {
