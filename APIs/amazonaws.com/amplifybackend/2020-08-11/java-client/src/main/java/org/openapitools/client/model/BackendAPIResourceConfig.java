...
public class BackendAPIResourceConfig {
  ...
  public BackendAPIResourceConfig additionalAuthTypes(List additionalAuthTypes) {
  ...
  public BackendAPIResourceConfig apiName(String apiName) {
  ...
  public BackendAPIResourceConfig conflictResolution(CreateBackendAPIRequestResourceConfigConflictResolution conflictResolution) {
  ...
  public BackendAPIResourceConfig defaultAuthType(CreateBackendAPIRequestResourceConfigDefaultAuthType defaultAuthType) {
  ...
  public BackendAPIResourceConfig service(String service) {
  ...
  public BackendAPIResourceConfig transformSchema(String transformSchema) {
  ...
  public boolean equals(Object o) {
    ...
    BackendAPIResourceConfig backendAPIResourceConfig = (BackendAPIResourceConfig) o;
    return Objects.equals(this.additionalAuthTypes, backendAPIResourceConfig.additionalAuthTypes) &&
        Objects.equals(this.apiName, backendAPIResourceConfig.apiName) &&
        Objects.equals(this.conflictResolution, backendAPIResourceConfig.conflictResolution) &&
        Objects.equals(this.defaultAuthType, backendAPIResourceConfig.defaultAuthType) &&
        Objects.equals(this.service, backendAPIResourceConfig.service) &&
        Objects.equals(this.transformSchema, backendAPIResourceConfig.transformSchema);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackendAPIResourceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BackendAPIResourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BackendAPIResourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackendAPIResourceConfig is not found in the empty JSON string", BackendAPIResourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BackendAPIResourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BackendAPIResourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackendAPIResourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackendAPIResourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackendAPIResourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackendAPIResourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<BackendAPIResourceConfig>() {
           @Override
           public void write(JsonWriter out, BackendAPIResourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BackendAPIResourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BackendAPIResourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BackendAPIResourceConfig
   * @throws IOException if the JSON string is invalid with respect to BackendAPIResourceConfig
   */
  public static BackendAPIResourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackendAPIResourceConfig.class);
  }

  /**
   * Convert an instance of BackendAPIResourceConfig to an JSON string
   *
   * @return JSON string
   */
