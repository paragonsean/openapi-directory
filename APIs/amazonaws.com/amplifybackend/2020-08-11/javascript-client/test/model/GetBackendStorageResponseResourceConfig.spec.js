...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.GetBackendStorageResponseResourceConfig();
  });
  ...
  describe('GetBackendStorageResponseResourceConfig', function() {
    it('should create an instance of GetBackendStorageResponseResourceConfig', function() {
      // uncomment below and update the code to test GetBackendStorageResponseResourceConfig
      //var instance = new AmplifyBackend.GetBackendStorageResponseResourceConfig();
      //expect(instance).to.be.a(AmplifyBackend.GetBackendStorageResponseResourceConfig);
    });
