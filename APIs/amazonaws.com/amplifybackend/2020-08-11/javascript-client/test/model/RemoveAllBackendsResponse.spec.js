...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.RemoveAllBackendsResponse();
  });
  ...
  describe('RemoveAllBackendsResponse', function() {
    it('should create an instance of RemoveAllBackendsResponse', function() {
      // uncomment below and update the code to test RemoveAllBackendsResponse
      //var instance = new AmplifyBackend.RemoveAllBackendsResponse();
      //expect(instance).to.be.a(AmplifyBackend.RemoveAllBackendsResponse);
    });
