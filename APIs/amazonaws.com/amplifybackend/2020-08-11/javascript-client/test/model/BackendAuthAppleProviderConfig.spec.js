...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.BackendAuthAppleProviderConfig();
  });
  ...
  describe('BackendAuthAppleProviderConfig', function() {
    it('should create an instance of BackendAuthAppleProviderConfig', function() {
      // uncomment below and update the code to test BackendAuthAppleProviderConfig
      //var instance = new AmplifyBackend.BackendAuthAppleProviderConfig();
      //expect(instance).to.be.a(AmplifyBackend.BackendAuthAppleProviderConfig);
    });
