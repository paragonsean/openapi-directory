...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.BackendJobRespObj();
  });
  ...
  describe('BackendJobRespObj', function() {
    it('should create an instance of BackendJobRespObj', function() {
      // uncomment below and update the code to test BackendJobRespObj
      //var instance = new AmplifyBackend.BackendJobRespObj();
      //expect(instance).to.be.a(AmplifyBackend.BackendJobRespObj);
    });
