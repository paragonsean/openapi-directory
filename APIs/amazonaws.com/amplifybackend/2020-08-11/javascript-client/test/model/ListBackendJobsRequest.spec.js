...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.ListBackendJobsRequest();
  });
  ...
  describe('ListBackendJobsRequest', function() {
    it('should create an instance of ListBackendJobsRequest', function() {
      // uncomment below and update the code to test ListBackendJobsRequest
      //var instance = new AmplifyBackend.ListBackendJobsRequest();
      //expect(instance).to.be.a(AmplifyBackend.ListBackendJobsRequest);
    });
