...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.ImportBackendStorageRequest();
  });
  ...
  describe('ImportBackendStorageRequest', function() {
    it('should create an instance of ImportBackendStorageRequest', function() {
      // uncomment below and update the code to test ImportBackendStorageRequest
      //var instance = new AmplifyBackend.ImportBackendStorageRequest();
      //expect(instance).to.be.a(AmplifyBackend.ImportBackendStorageRequest);
    });
