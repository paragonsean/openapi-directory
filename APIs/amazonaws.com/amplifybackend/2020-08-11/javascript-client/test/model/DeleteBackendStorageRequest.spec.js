...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.DeleteBackendStorageRequest();
  });
  ...
  describe('DeleteBackendStorageRequest', function() {
    it('should create an instance of DeleteBackendStorageRequest', function() {
      // uncomment below and update the code to test DeleteBackendStorageRequest
      //var instance = new AmplifyBackend.DeleteBackendStorageRequest();
      //expect(instance).to.be.a(AmplifyBackend.DeleteBackendStorageRequest);
    });
