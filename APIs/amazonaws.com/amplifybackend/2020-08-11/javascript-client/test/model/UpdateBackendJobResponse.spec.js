...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.UpdateBackendJobResponse();
  });
  ...
  describe('UpdateBackendJobResponse', function() {
    it('should create an instance of UpdateBackendJobResponse', function() {
      // uncomment below and update the code to test UpdateBackendJobResponse
      //var instance = new AmplifyBackend.UpdateBackendJobResponse();
      //expect(instance).to.be.a(AmplifyBackend.UpdateBackendJobResponse);
    });
