...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.GetBackendJobResponse();
  });
  ...
  describe('GetBackendJobResponse', function() {
    it('should create an instance of GetBackendJobResponse', function() {
      // uncomment below and update the code to test GetBackendJobResponse
      //var instance = new AmplifyBackend.GetBackendJobResponse();
      //expect(instance).to.be.a(AmplifyBackend.GetBackendJobResponse);
    });
