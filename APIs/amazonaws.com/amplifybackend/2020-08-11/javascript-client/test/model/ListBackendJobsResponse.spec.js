...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.ListBackendJobsResponse();
  });
  ...
  describe('ListBackendJobsResponse', function() {
    it('should create an instance of ListBackendJobsResponse', function() {
      // uncomment below and update the code to test ListBackendJobsResponse
      //var instance = new AmplifyBackend.ListBackendJobsResponse();
      //expect(instance).to.be.a(AmplifyBackend.ListBackendJobsResponse);
    });
