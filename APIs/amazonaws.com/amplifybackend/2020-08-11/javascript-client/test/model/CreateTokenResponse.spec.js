...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.CreateTokenResponse();
  });
  ...
  describe('CreateTokenResponse', function() {
    it('should create an instance of CreateTokenResponse', function() {
      ...
      //var instance = new AmplifyBackend.CreateTokenResponse();
      //expect(instance).to.be.a(AmplifyBackend.CreateTokenResponse);
    });
