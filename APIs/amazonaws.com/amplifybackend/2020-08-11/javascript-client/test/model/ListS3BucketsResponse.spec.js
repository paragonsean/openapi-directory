...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmplifyBackend.ListS3BucketsResponse();
  });
  ...
  describe('ListS3BucketsResponse', function() {
    it('should create an instance of ListS3BucketsResponse', function() {
      // uncomment below and update the code to test ListS3BucketsResponse
      //var instance = new AmplifyBackend.ListS3BucketsResponse();
      //expect(instance).to.be.a(AmplifyBackend.ListS3BucketsResponse);
    });
