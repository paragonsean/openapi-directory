...
class CreateBackendAuthRequestResourceConfig(Model):
    ...
    def __init__(self, auth_resources: AuthResources=None, identity_pool_configs: CreateBackendAuthRequestResourceConfigIdentityPoolConfigs=None, service: Service=None, user_pool_configs: CreateBackendAuthRequestResourceConfigUserPoolConfigs=None):
        """CreateBackendAuthRequestResourceConfig - a model defined in OpenAPI

        :param auth_resources: The auth_resources of this CreateBackendAuthRequestResourceConfig.
        :param identity_pool_configs: The identity_pool_configs of this CreateBackendAuthRequestResourceConfig.
        :param service: The service of this CreateBackendAuthRequestResourceConfig.
        :param user_pool_configs: The user_pool_configs of this CreateBackendAuthRequestResourceConfig.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateBackendAuthRequestResourceConfig':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateBackendAuthRequest_ResourceConfig of this CreateBackendAuthRequestResourceConfig.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def auth_resources(self):
        """Gets the auth_resources of this CreateBackendAuthRequestResourceConfig.


        :return: The auth_resources of this CreateBackendAuthRequestResourceConfig.
        :rtype: AuthResources
        """
    ...
    def auth_resources(self, auth_resources):
        """Sets the auth_resources of this CreateBackendAuthRequestResourceConfig.
    ...
    def identity_pool_configs(self):
        """Gets the identity_pool_configs of this CreateBackendAuthRequestResourceConfig.


        :return: The identity_pool_configs of this CreateBackendAuthRequestResourceConfig.
    ...
    def identity_pool_configs(self, identity_pool_configs):
        """Sets the identity_pool_configs of this CreateBackendAuthRequestResourceConfig.
    ...
    @property
    def service(self):
        """Gets the service of this CreateBackendAuthRequestResourceConfig.


        :return: The service of this CreateBackendAuthRequestResourceConfig.
        :rtype: Service
        """
    ...
    def service(self, service):
        """Sets the service of this CreateBackendAuthRequestResourceConfig.
    ...
    def user_pool_configs(self):
        """Gets the user_pool_configs of this CreateBackendAuthRequestResourceConfig.


        :return: The user_pool_configs of this CreateBackendAuthRequestResourceConfig.
    ...
    def user_pool_configs(self, user_pool_configs):
        """Sets the user_pool_configs of this CreateBackendAuthRequestResourceConfig.
