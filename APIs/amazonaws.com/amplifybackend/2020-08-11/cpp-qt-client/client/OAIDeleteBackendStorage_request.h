...
/*
 * OAIDeleteBackendStorage_request.h
 *
 * 
 */

#ifndef OAIDeleteBackendStorage_request_H
#define OAIDeleteBackendStorage_request_H
...
class OAIDeleteBackendStorage_request : public OAIObject {
public:
    OAIDeleteBackendStorage_request();
    OAIDeleteBackendStorage_request(QString json);
    ~OAIDeleteBackendStorage_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteBackendStorage_request)

#endif // OAIDeleteBackendStorage_request_H
