...
/*
 * OAIListBackendJobs_request.h
 *
 * 
 */

#ifndef OAIListBackendJobs_request_H
#define OAIListBackendJobs_request_H
...
class OAIListBackendJobs_request : public OAIObject {
public:
    OAIListBackendJobs_request();
    OAIListBackendJobs_request(QString json);
    ~OAIListBackendJobs_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListBackendJobs_request)

#endif // OAIListBackendJobs_request_H
