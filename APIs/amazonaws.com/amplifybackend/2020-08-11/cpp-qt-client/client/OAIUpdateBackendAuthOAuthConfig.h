...
/*
 * OAIUpdateBackendAuthOAuthConfig.h
 *
 * The OAuth configurations for authenticating users into your Amplify app.
 */

#ifndef OAIUpdateBackendAuthOAuthConfig_H
#define OAIUpdateBackendAuthOAuthConfig_H
...
namespace OpenAPI {
class OAIUpdateBackendAuthOAuthConfig_SocialProviderSettings;

class OAIUpdateBackendAuthOAuthConfig : public OAIObject {
public:
    OAIUpdateBackendAuthOAuthConfig();
    OAIUpdateBackendAuthOAuthConfig(QString json);
    ~OAIUpdateBackendAuthOAuthConfig() override;
    ...
    OAIUpdateBackendAuthOAuthConfig_SocialProviderSettings getSocialProviderSettings() const;
    void setSocialProviderSettings(const OAIUpdateBackendAuthOAuthConfig_SocialProviderSettings &social_provider_settings);
...
private:
    ...
    OAIUpdateBackendAuthOAuthConfig_SocialProviderSettings m_social_provider_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBackendAuthOAuthConfig)

#endif // OAIUpdateBackendAuthOAuthConfig_H
