...
OAIUpdateBackendAuthUserPoolConfig_OAuth::OAIUpdateBackendAuthUserPoolConfig_OAuth(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateBackendAuthUserPoolConfig_OAuth::OAIUpdateBackendAuthUserPoolConfig_OAuth() {
    this->initializeModel();
}

OAIUpdateBackendAuthUserPoolConfig_OAuth::~OAIUpdateBackendAuthUserPoolConfig_OAuth() {}

void OAIUpdateBackendAuthUserPoolConfig_OAuth::initializeModel() {
...
void OAIUpdateBackendAuthUserPoolConfig_OAuth::fromJson(QString jsonString) {
...
void OAIUpdateBackendAuthUserPoolConfig_OAuth::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateBackendAuthUserPoolConfig_OAuth::asJson() const {
...
QJsonObject OAIUpdateBackendAuthUserPoolConfig_OAuth::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateBackendAuthUserPoolConfig_OAuth::getDomainPrefix() const {
    return m_domain_prefix;
}
void OAIUpdateBackendAuthUserPoolConfig_OAuth::setDomainPrefix(const QString &domain_prefix) {
    m_domain_prefix = domain_prefix;
    m_domain_prefix_isSet = true;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_domain_prefix_Set() const{
    return m_domain_prefix_isSet;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_domain_prefix_Valid() const{
    return m_domain_prefix_isValid;
}

OAIOAuthGrantType OAIUpdateBackendAuthUserPoolConfig_OAuth::getOAuthGrantType() const {
    return m_o_auth_grant_type;
}
void OAIUpdateBackendAuthUserPoolConfig_OAuth::setOAuthGrantType(const OAIOAuthGrantType &o_auth_grant_type) {
    m_o_auth_grant_type = o_auth_grant_type;
    m_o_auth_grant_type_isSet = true;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_o_auth_grant_type_Set() const{
    return m_o_auth_grant_type_isSet;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_o_auth_grant_type_Valid() const{
    return m_o_auth_grant_type_isValid;
}

QList OAIUpdateBackendAuthUserPoolConfig_OAuth::getOAuthScopes() const {
    return m_o_auth_scopes;
}
void OAIUpdateBackendAuthUserPoolConfig_OAuth::setOAuthScopes(const QList &o_auth_scopes) {
    m_o_auth_scopes = o_auth_scopes;
    m_o_auth_scopes_isSet = true;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_o_auth_scopes_Set() const{
    return m_o_auth_scopes_isSet;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_o_auth_scopes_Valid() const{
    return m_o_auth_scopes_isValid;
}

QList OAIUpdateBackendAuthUserPoolConfig_OAuth::getRedirectSignInUris() const {
    return m_redirect_sign_in_uris;
}
void OAIUpdateBackendAuthUserPoolConfig_OAuth::setRedirectSignInUris(const QList &redirect_sign_in_uris) {
    m_redirect_sign_in_uris = redirect_sign_in_uris;
    m_redirect_sign_in_uris_isSet = true;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_redirect_sign_in_uris_Set() const{
    return m_redirect_sign_in_uris_isSet;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_redirect_sign_in_uris_Valid() const{
    return m_redirect_sign_in_uris_isValid;
}

QList OAIUpdateBackendAuthUserPoolConfig_OAuth::getRedirectSignOutUris() const {
    return m_redirect_sign_out_uris;
}
void OAIUpdateBackendAuthUserPoolConfig_OAuth::setRedirectSignOutUris(const QList &redirect_sign_out_uris) {
    m_redirect_sign_out_uris = redirect_sign_out_uris;
    m_redirect_sign_out_uris_isSet = true;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_redirect_sign_out_uris_Set() const{
    return m_redirect_sign_out_uris_isSet;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_redirect_sign_out_uris_Valid() const{
    return m_redirect_sign_out_uris_isValid;
}

OAIUpdateBackendAuthOAuthConfig_SocialProviderSettings OAIUpdateBackendAuthUserPoolConfig_OAuth::getSocialProviderSettings() const {
    return m_social_provider_settings;
}
void OAIUpdateBackendAuthUserPoolConfig_OAuth::setSocialProviderSettings(const OAIUpdateBackendAuthOAuthConfig_SocialProviderSettings &social_provider_settings) {
    m_social_provider_settings = social_provider_settings;
    m_social_provider_settings_isSet = true;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_social_provider_settings_Set() const{
    return m_social_provider_settings_isSet;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::is_social_provider_settings_Valid() const{
    return m_social_provider_settings_isValid;
}

bool OAIUpdateBackendAuthUserPoolConfig_OAuth::isSet() const {
...
bool OAIUpdateBackendAuthUserPoolConfig_OAuth::isValid() const {
