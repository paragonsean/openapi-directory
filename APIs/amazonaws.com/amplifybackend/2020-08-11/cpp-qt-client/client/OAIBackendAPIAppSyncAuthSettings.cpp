...
#include "OAIBackendAPIAppSyncAuthSettings.h"
...
OAIBackendAPIAppSyncAuthSettings::OAIBackendAPIAppSyncAuthSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBackendAPIAppSyncAuthSettings::OAIBackendAPIAppSyncAuthSettings() {
    this->initializeModel();
}

OAIBackendAPIAppSyncAuthSettings::~OAIBackendAPIAppSyncAuthSettings() {}

void OAIBackendAPIAppSyncAuthSettings::initializeModel() {
...
void OAIBackendAPIAppSyncAuthSettings::fromJson(QString jsonString) {
...
void OAIBackendAPIAppSyncAuthSettings::fromJsonObject(QJsonObject json) {
...
QString OAIBackendAPIAppSyncAuthSettings::asJson() const {
...
QJsonObject OAIBackendAPIAppSyncAuthSettings::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBackendAPIAppSyncAuthSettings::getCognitoUserPoolId() const {
    return m_cognito_user_pool_id;
}
void OAIBackendAPIAppSyncAuthSettings::setCognitoUserPoolId(const QString &cognito_user_pool_id) {
    m_cognito_user_pool_id = cognito_user_pool_id;
    m_cognito_user_pool_id_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_cognito_user_pool_id_Set() const{
    return m_cognito_user_pool_id_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_cognito_user_pool_id_Valid() const{
    return m_cognito_user_pool_id_isValid;
}

QString OAIBackendAPIAppSyncAuthSettings::getDescription() const {
    return m_description;
}
void OAIBackendAPIAppSyncAuthSettings::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_description_Set() const{
    return m_description_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_description_Valid() const{
    return m_description_isValid;
}

double OAIBackendAPIAppSyncAuthSettings::getExpirationTime() const {
    return m_expiration_time;
}
void OAIBackendAPIAppSyncAuthSettings::setExpirationTime(const double &expiration_time) {
    m_expiration_time = expiration_time;
    m_expiration_time_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_expiration_time_Set() const{
    return m_expiration_time_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_expiration_time_Valid() const{
    return m_expiration_time_isValid;
}

QString OAIBackendAPIAppSyncAuthSettings::getOpenIdAuthTtl() const {
    return m_open_id_auth_ttl;
}
void OAIBackendAPIAppSyncAuthSettings::setOpenIdAuthTtl(const QString &open_id_auth_ttl) {
    m_open_id_auth_ttl = open_id_auth_ttl;
    m_open_id_auth_ttl_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_auth_ttl_Set() const{
    return m_open_id_auth_ttl_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_auth_ttl_Valid() const{
    return m_open_id_auth_ttl_isValid;
}

QString OAIBackendAPIAppSyncAuthSettings::getOpenIdClientId() const {
    return m_open_id_client_id;
}
void OAIBackendAPIAppSyncAuthSettings::setOpenIdClientId(const QString &open_id_client_id) {
    m_open_id_client_id = open_id_client_id;
    m_open_id_client_id_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_client_id_Set() const{
    return m_open_id_client_id_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_client_id_Valid() const{
    return m_open_id_client_id_isValid;
}

QString OAIBackendAPIAppSyncAuthSettings::getOpenIdIatTtl() const {
    return m_open_id_iat_ttl;
}
void OAIBackendAPIAppSyncAuthSettings::setOpenIdIatTtl(const QString &open_id_iat_ttl) {
    m_open_id_iat_ttl = open_id_iat_ttl;
    m_open_id_iat_ttl_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_iat_ttl_Set() const{
    return m_open_id_iat_ttl_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_iat_ttl_Valid() const{
    return m_open_id_iat_ttl_isValid;
}

QString OAIBackendAPIAppSyncAuthSettings::getOpenIdIssueUrl() const {
    return m_open_id_issue_url;
}
void OAIBackendAPIAppSyncAuthSettings::setOpenIdIssueUrl(const QString &open_id_issue_url) {
    m_open_id_issue_url = open_id_issue_url;
    m_open_id_issue_url_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_issue_url_Set() const{
    return m_open_id_issue_url_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_issue_url_Valid() const{
    return m_open_id_issue_url_isValid;
}

QString OAIBackendAPIAppSyncAuthSettings::getOpenIdProviderName() const {
    return m_open_id_provider_name;
}
void OAIBackendAPIAppSyncAuthSettings::setOpenIdProviderName(const QString &open_id_provider_name) {
    m_open_id_provider_name = open_id_provider_name;
    m_open_id_provider_name_isSet = true;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_provider_name_Set() const{
    return m_open_id_provider_name_isSet;
}

bool OAIBackendAPIAppSyncAuthSettings::is_open_id_provider_name_Valid() const{
    return m_open_id_provider_name_isValid;
}

bool OAIBackendAPIAppSyncAuthSettings::isSet() const {
...
bool OAIBackendAPIAppSyncAuthSettings::isValid() const {
