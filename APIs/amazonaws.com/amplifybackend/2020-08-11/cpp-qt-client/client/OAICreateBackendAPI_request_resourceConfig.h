...
/*
 * OAICreateBackendAPI_request_resourceConfig.h
 *
 * The resource config for the data model, configured as a part of the Amplify project.
 */

#ifndef OAICreateBackendAPI_request_resourceConfig_H
#define OAICreateBackendAPI_request_resourceConfig_H
...
class OAICreateBackendAPI_request_resourceConfig : public OAIObject {
public:
    OAICreateBackendAPI_request_resourceConfig();
    OAICreateBackendAPI_request_resourceConfig(QString json);
    ~OAICreateBackendAPI_request_resourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBackendAPI_request_resourceConfig)

#endif // OAICreateBackendAPI_request_resourceConfig_H
