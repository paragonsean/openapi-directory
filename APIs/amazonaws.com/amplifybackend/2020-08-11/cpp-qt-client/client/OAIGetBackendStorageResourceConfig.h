...
/*
 * OAIGetBackendStorageResourceConfig.h
 *
 * The details for a backend storage resource.
 */

#ifndef OAIGetBackendStorageResourceConfig_H
#define OAIGetBackendStorageResourceConfig_H
...
class OAIGetBackendStorageResourceConfig : public OAIObject {
public:
    OAIGetBackendStorageResourceConfig();
    OAIGetBackendStorageResourceConfig(QString json);
    ~OAIGetBackendStorageResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBackendStorageResourceConfig)

#endif // OAIGetBackendStorageResourceConfig_H
