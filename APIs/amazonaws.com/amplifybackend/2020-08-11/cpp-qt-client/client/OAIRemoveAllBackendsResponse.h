...
/*
 * OAIRemoveAllBackendsResponse.h
 *
 * 
 */

#ifndef OAIRemoveAllBackendsResponse_H
#define OAIRemoveAllBackendsResponse_H
...
class OAIRemoveAllBackendsResponse : public OAIObject {
public:
    OAIRemoveAllBackendsResponse();
    OAIRemoveAllBackendsResponse(QString json);
    ~OAIRemoveAllBackendsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRemoveAllBackendsResponse)

#endif // OAIRemoveAllBackendsResponse_H
