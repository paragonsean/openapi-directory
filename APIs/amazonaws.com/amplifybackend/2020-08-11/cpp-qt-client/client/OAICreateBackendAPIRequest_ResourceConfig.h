...
/*
 * OAICreateBackendAPIRequest_ResourceConfig.h
 *
 * 
 */

#ifndef OAICreateBackendAPIRequest_ResourceConfig_H
#define OAICreateBackendAPIRequest_ResourceConfig_H
...
class OAICreateBackendAPIRequest_ResourceConfig : public OAIObject {
public:
    OAICreateBackendAPIRequest_ResourceConfig();
    OAICreateBackendAPIRequest_ResourceConfig(QString json);
    ~OAICreateBackendAPIRequest_ResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBackendAPIRequest_ResourceConfig)

#endif // OAICreateBackendAPIRequest_ResourceConfig_H
