...
#include "OAICreateBackendAuthRequest.h"
...
OAICreateBackendAuthRequest::OAICreateBackendAuthRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateBackendAuthRequest::OAICreateBackendAuthRequest() {
    this->initializeModel();
}

OAICreateBackendAuthRequest::~OAICreateBackendAuthRequest() {}

void OAICreateBackendAuthRequest::initializeModel() {
...
void OAICreateBackendAuthRequest::fromJson(QString jsonString) {
...
void OAICreateBackendAuthRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateBackendAuthRequest::asJson() const {
...
QJsonObject OAICreateBackendAuthRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateBackendAuthRequest::getBackendEnvironmentName() const {
    return m_backend_environment_name;
}
void OAICreateBackendAuthRequest::setBackendEnvironmentName(const QString &backend_environment_name) {
    m_backend_environment_name = backend_environment_name;
    m_backend_environment_name_isSet = true;
}

bool OAICreateBackendAuthRequest::is_backend_environment_name_Set() const{
    return m_backend_environment_name_isSet;
}

bool OAICreateBackendAuthRequest::is_backend_environment_name_Valid() const{
    return m_backend_environment_name_isValid;
}

OAICreateBackendAuthRequest_ResourceConfig OAICreateBackendAuthRequest::getResourceConfig() const {
    return m_resource_config;
}
void OAICreateBackendAuthRequest::setResourceConfig(const OAICreateBackendAuthRequest_ResourceConfig &resource_config) {
    m_resource_config = resource_config;
    m_resource_config_isSet = true;
}

bool OAICreateBackendAuthRequest::is_resource_config_Set() const{
    return m_resource_config_isSet;
}

bool OAICreateBackendAuthRequest::is_resource_config_Valid() const{
    return m_resource_config_isValid;
}

QString OAICreateBackendAuthRequest::getResourceName() const {
    return m_resource_name;
}
void OAICreateBackendAuthRequest::setResourceName(const QString &resource_name) {
    m_resource_name = resource_name;
    m_resource_name_isSet = true;
}

bool OAICreateBackendAuthRequest::is_resource_name_Set() const{
    return m_resource_name_isSet;
}

bool OAICreateBackendAuthRequest::is_resource_name_Valid() const{
    return m_resource_name_isValid;
}

bool OAICreateBackendAuthRequest::isSet() const {
...
bool OAICreateBackendAuthRequest::isValid() const {
