...
/*
 * OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs.h
 *
 * 
 */

#ifndef OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs_H
#define OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs_H
...
class OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs : public OAIObject {
public:
    OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs();
    OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs(QString json);
    ~OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs)

#endif // OAIUpdateBackendAuth_request_resourceConfig_UserPoolConfigs_H
