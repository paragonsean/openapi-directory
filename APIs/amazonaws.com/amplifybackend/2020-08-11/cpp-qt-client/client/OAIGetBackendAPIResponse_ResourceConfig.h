...
/*
 * OAIGetBackendAPIResponse_ResourceConfig.h
 *
 * 
 */

#ifndef OAIGetBackendAPIResponse_ResourceConfig_H
#define OAIGetBackendAPIResponse_ResourceConfig_H
...
class OAIGetBackendAPIResponse_ResourceConfig : public OAIObject {
public:
    OAIGetBackendAPIResponse_ResourceConfig();
    OAIGetBackendAPIResponse_ResourceConfig(QString json);
    ~OAIGetBackendAPIResponse_ResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetBackendAPIResponse_ResourceConfig)

#endif // OAIGetBackendAPIResponse_ResourceConfig_H
