...
/*
 * OAIBackendAPIResourceConfig.h
 *
 * The resource config for the data model, configured as a part of the Amplify project.
 */

#ifndef OAIBackendAPIResourceConfig_H
#define OAIBackendAPIResourceConfig_H
...
class OAIBackendAPIResourceConfig : public OAIObject {
public:
    OAIBackendAPIResourceConfig();
    OAIBackendAPIResourceConfig(QString json);
    ~OAIBackendAPIResourceConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackendAPIResourceConfig)

#endif // OAIBackendAPIResourceConfig_H
