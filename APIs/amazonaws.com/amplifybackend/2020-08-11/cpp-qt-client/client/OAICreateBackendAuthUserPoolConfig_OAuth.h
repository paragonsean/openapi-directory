...
/*
 * OAICreateBackendAuthUserPoolConfig_OAuth.h
 *
 * 
 */

#ifndef OAICreateBackendAuthUserPoolConfig_OAuth_H
#define OAICreateBackendAuthUserPoolConfig_OAuth_H
...
class OAICreateBackendAuthUserPoolConfig_OAuth : public OAIObject {
public:
    OAICreateBackendAuthUserPoolConfig_OAuth();
    OAICreateBackendAuthUserPoolConfig_OAuth(QString json);
    ~OAICreateBackendAuthUserPoolConfig_OAuth() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateBackendAuthUserPoolConfig_OAuth)

#endif // OAICreateBackendAuthUserPoolConfig_OAuth_H
