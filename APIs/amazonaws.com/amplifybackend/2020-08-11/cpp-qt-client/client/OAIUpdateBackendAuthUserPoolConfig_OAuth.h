...
/*
 * OAIUpdateBackendAuthUserPoolConfig_OAuth.h
 *
 * 
 */

#ifndef OAIUpdateBackendAuthUserPoolConfig_OAuth_H
#define OAIUpdateBackendAuthUserPoolConfig_OAuth_H
...
class OAIUpdateBackendAuthUserPoolConfig_OAuth : public OAIObject {
public:
    OAIUpdateBackendAuthUserPoolConfig_OAuth();
    OAIUpdateBackendAuthUserPoolConfig_OAuth(QString json);
    ~OAIUpdateBackendAuthUserPoolConfig_OAuth() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateBackendAuthUserPoolConfig_OAuth)

#endif // OAIUpdateBackendAuthUserPoolConfig_OAuth_H
