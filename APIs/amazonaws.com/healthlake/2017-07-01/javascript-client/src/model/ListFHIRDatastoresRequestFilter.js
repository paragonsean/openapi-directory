...
/**
 * The ListFHIRDatastoresRequestFilter model module.
 * @module model/ListFHIRDatastoresRequestFilter
 * @version 2017-07-01
 */
class ListFHIRDatastoresRequestFilter {
    /**
     * Constructs a new <code>ListFHIRDatastoresRequestFilter</code>.
     * @alias module:model/ListFHIRDatastoresRequestFilter
     * @implements module:model/DatastoreFilter
     */
    constructor() { 
        DatastoreFilter.initialize(this);
        ListFHIRDatastoresRequestFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListFHIRDatastoresRequestFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListFHIRDatastoresRequestFilter} obj Optional instance to populate.
     * @return {module:model/ListFHIRDatastoresRequestFilter} The populated <code>ListFHIRDatastoresRequestFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListFHIRDatastoresRequestFilter();
            DatastoreFilter.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ListFHIRDatastoresRequestFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListFHIRDatastoresRequestFilter</code>.
     */
 ...
 */
ListFHIRDatastoresRequestFilter.prototype['DatastoreName'] = undefined;

/**
 * @member {module:model/DatastoreStatus} DatastoreStatus
 */
ListFHIRDatastoresRequestFilter.prototype['DatastoreStatus'] = undefined;

/**
 * @member {Date} CreatedBefore
 */
ListFHIRDatastoresRequestFilter.prototype['CreatedBefore'] = undefined;

/**
 * @member {Date} CreatedAfter
 */
ListFHIRDatastoresRequestFilter.prototype['CreatedAfter'] = undefined;


// Implement DatastoreFilter interface:
/**
 * @member {String} DatastoreName
 */
...
export default ListFHIRDatastoresRequestFilter;
