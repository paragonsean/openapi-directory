...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.StartFHIRExportJobResponse();
  });
  ...
  describe('StartFHIRExportJobResponse', function() {
    it('should create an instance of StartFHIRExportJobResponse', function() {
      // uncomment below and update the code to test StartFHIRExportJobResponse
      //var instance = new AmazonHealthLake.StartFHIRExportJobResponse();
      //expect(instance).to.be.a(AmazonHealthLake.StartFHIRExportJobResponse);
    });
