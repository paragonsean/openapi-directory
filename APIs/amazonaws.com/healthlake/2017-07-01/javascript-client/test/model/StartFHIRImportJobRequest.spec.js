...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.StartFHIRImportJobRequest();
  });
  ...
  describe('StartFHIRImportJobRequest', function() {
    it('should create an instance of StartFHIRImportJobRequest', function() {
      // uncomment below and update the code to test StartFHIRImportJobRequest
      //var instance = new AmazonHealthLake.StartFHIRImportJobRequest();
      //expect(instance).to.be.a(AmazonHealthLake.StartFHIRImportJobRequest);
    });
