...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.ListFHIRImportJobsRequest();
  });
  ...
  describe('ListFHIRImportJobsRequest', function() {
    it('should create an instance of ListFHIRImportJobsRequest', function() {
      // uncomment below and update the code to test ListFHIRImportJobsRequest
      //var instance = new AmazonHealthLake.ListFHIRImportJobsRequest();
      //expect(instance).to.be.a(AmazonHealthLake.ListFHIRImportJobsRequest);
    });
    ...
    it('should have the property submittedBefore (base name: "SubmittedBefore")', function() {
      // uncomment below and update the code to test the property submittedBefore
      //var instance = new AmazonHealthLake.ListFHIRImportJobsRequest();
      //expect(instance).to.be();
    });

    it('should have the property submittedAfter (base name: "SubmittedAfter")', function() {
      // uncomment below and update the code to test the property submittedAfter
      //var instance = new AmazonHealthLake.ListFHIRImportJobsRequest();
      //expect(instance).to.be();
    });
