...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.StartFHIRImportJobResponse();
  });
  ...
  describe('StartFHIRImportJobResponse', function() {
    it('should create an instance of StartFHIRImportJobResponse', function() {
      // uncomment below and update the code to test StartFHIRImportJobResponse
      //var instance = new AmazonHealthLake.StartFHIRImportJobResponse();
      //expect(instance).to.be.a(AmazonHealthLake.StartFHIRImportJobResponse);
    });
