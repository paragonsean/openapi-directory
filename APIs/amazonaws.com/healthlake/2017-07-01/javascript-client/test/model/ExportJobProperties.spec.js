...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.ExportJobProperties();
  });
  ...
  describe('ExportJobProperties', function() {
    it('should create an instance of ExportJobProperties', function() {
      // uncomment below and update the code to test ExportJobProperties
      //var instance = new AmazonHealthLake.ExportJobProperties();
      //expect(instance).to.be.a(AmazonHealthLake.ExportJobProperties);
    });
