...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.DescribeFHIRExportJobResponseExportJobProperties();
  });
  ...
  describe('DescribeFHIRExportJobResponseExportJobProperties', function() {
    it('should create an instance of DescribeFHIRExportJobResponseExportJobProperties', function() {
      // uncomment below and update the code to test DescribeFHIRExportJobResponseExportJobProperties
      //var instance = new AmazonHealthLake.DescribeFHIRExportJobResponseExportJobProperties();
      //expect(instance).to.be.a(AmazonHealthLake.DescribeFHIRExportJobResponseExportJobProperties);
    });
