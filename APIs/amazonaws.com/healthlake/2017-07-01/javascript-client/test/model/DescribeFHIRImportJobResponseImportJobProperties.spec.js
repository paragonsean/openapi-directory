...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.DescribeFHIRImportJobResponseImportJobProperties();
  });
  ...
  describe('DescribeFHIRImportJobResponseImportJobProperties', function() {
    it('should create an instance of DescribeFHIRImportJobResponseImportJobProperties', function() {
      // uncomment below and update the code to test DescribeFHIRImportJobResponseImportJobProperties
      //var instance = new AmazonHealthLake.DescribeFHIRImportJobResponseImportJobProperties();
      //expect(instance).to.be.a(AmazonHealthLake.DescribeFHIRImportJobResponseImportJobProperties);
    });
