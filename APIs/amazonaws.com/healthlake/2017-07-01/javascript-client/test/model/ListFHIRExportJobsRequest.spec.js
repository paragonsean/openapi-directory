...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonHealthLake.ListFHIRExportJobsRequest();
  });
  ...
  describe('ListFHIRExportJobsRequest', function() {
    it('should create an instance of ListFHIRExportJobsRequest', function() {
      // uncomment below and update the code to test ListFHIRExportJobsRequest
      //var instance = new AmazonHealthLake.ListFHIRExportJobsRequest();
      //expect(instance).to.be.a(AmazonHealthLake.ListFHIRExportJobsRequest);
    });
