...
public class ExportJobProperties {
  ...
  public ExportJobProperties jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public ExportJobProperties jobName(String jobName) {
  ...
  public ExportJobProperties jobStatus(JobStatus jobStatus) {
  ...
  public ExportJobProperties submitTime(OffsetDateTime submitTime) {
  ...
  public ExportJobProperties endTime(OffsetDateTime endTime) {
  ...
  public ExportJobProperties datastoreId(String datastoreId) {
  ...
  public ExportJobProperties outputDataConfig(StartFHIRExportJobRequestOutputDataConfig outputDataConfig) {
  ...
  public ExportJobProperties dataAccessRoleArn(String dataAccessRoleArn) {
  ...
  public ExportJobProperties message(String message) {
  ...
  public boolean equals(Object o) {
    ...
    ExportJobProperties exportJobProperties = (ExportJobProperties) o;
    return Objects.equals(this.jobId, exportJobProperties.jobId) &&
        Objects.equals(this.jobName, exportJobProperties.jobName) &&
        Objects.equals(this.jobStatus, exportJobProperties.jobStatus) &&
        Objects.equals(this.submitTime, exportJobProperties.submitTime) &&
        Objects.equals(this.endTime, exportJobProperties.endTime) &&
        Objects.equals(this.datastoreId, exportJobProperties.datastoreId) &&
        Objects.equals(this.outputDataConfig, exportJobProperties.outputDataConfig) &&
        Objects.equals(this.dataAccessRoleArn, exportJobProperties.dataAccessRoleArn) &&
        Objects.equals(this.message, exportJobProperties.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportJobProperties {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportJobProperties
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportJobProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportJobProperties is not found in the empty JSON string", ExportJobProperties.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportJobProperties.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportJobProperties` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExportJobProperties.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportJobProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportJobProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportJobProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportJobProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportJobProperties>() {
           @Override
           public void write(JsonWriter out, ExportJobProperties value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportJobProperties read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportJobProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportJobProperties
   * @throws IOException if the JSON string is invalid with respect to ExportJobProperties
   */
  public static ExportJobProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportJobProperties.class);
  }

  /**
   * Convert an instance of ExportJobProperties to an JSON string
   *
   * @return JSON string
   */
