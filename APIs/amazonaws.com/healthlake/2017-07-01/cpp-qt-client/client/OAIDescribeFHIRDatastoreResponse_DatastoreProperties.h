...
/*
 * OAIDescribeFHIRDatastoreResponse_DatastoreProperties.h
 *
 * 
 */

#ifndef OAIDescribeFHIRDatastoreResponse_DatastoreProperties_H
#define OAIDescribeFHIRDatastoreResponse_DatastoreProperties_H
...
class OAIDescribeFHIRDatastoreResponse_DatastoreProperties : public OAIObject {
public:
    OAIDescribeFHIRDatastoreResponse_DatastoreProperties();
    OAIDescribeFHIRDatastoreResponse_DatastoreProperties(QString json);
    ~OAIDescribeFHIRDatastoreResponse_DatastoreProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeFHIRDatastoreResponse_DatastoreProperties)

#endif // OAIDescribeFHIRDatastoreResponse_DatastoreProperties_H
