...
/*
 * OAIExportJobProperties.h
 *
 * The properties of a FHIR export job, including the ID, ARN, name, and the status of the job.
 */

#ifndef OAIExportJobProperties_H
#define OAIExportJobProperties_H
...
class OAIExportJobProperties : public OAIObject {
public:
    OAIExportJobProperties();
    OAIExportJobProperties(QString json);
    ~OAIExportJobProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIExportJobProperties)

#endif // OAIExportJobProperties_H
