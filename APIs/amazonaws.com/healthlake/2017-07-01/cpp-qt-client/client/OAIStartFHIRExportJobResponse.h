...
/*
 * OAIStartFHIRExportJobResponse.h
 *
 * 
 */

#ifndef OAIStartFHIRExportJobResponse_H
#define OAIStartFHIRExportJobResponse_H
...
class OAIStartFHIRExportJobResponse : public OAIObject {
public:
    OAIStartFHIRExportJobResponse();
    OAIStartFHIRExportJobResponse(QString json);
    ~OAIStartFHIRExportJobResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFHIRExportJobResponse)

#endif // OAIStartFHIRExportJobResponse_H
