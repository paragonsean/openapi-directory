...
OAIFHIRVersion OAIDatastoreProperties::getDatastoreTypeVersion() const {
    return m_datastore_type_version;
}
void OAIDatastoreProperties::setDatastoreTypeVersion(const OAIFHIRVersion &datastore_type_version) {
    m_datastore_type_version = datastore_type_version;
    m_datastore_type_version_isSet = true;
}

bool OAIDatastoreProperties::is_datastore_type_version_Set() const{
    return m_datastore_type_version_isSet;
}

bool OAIDatastoreProperties::is_datastore_type_version_Valid() const{
    return m_datastore_type_version_isValid;
}

QString OAIDatastoreProperties::getDatastoreEndpoint() const {
    return m_datastore_endpoint;
}
void OAIDatastoreProperties::setDatastoreEndpoint(const QString &datastore_endpoint) {
    m_datastore_endpoint = datastore_endpoint;
    m_datastore_endpoint_isSet = true;
}

bool OAIDatastoreProperties::is_datastore_endpoint_Set() const{
    return m_datastore_endpoint_isSet;
}

bool OAIDatastoreProperties::is_datastore_endpoint_Valid() const{
    return m_datastore_endpoint_isValid;
}

OAIDatastoreProperties_SseConfiguration OAIDatastoreProperties::getSseConfiguration() const {
    return m_sse_configuration;
}
void OAIDatastoreProperties::setSseConfiguration(const OAIDatastoreProperties_SseConfiguration &sse_configuration) {
    m_sse_configuration = sse_configuration;
    m_sse_configuration_isSet = true;
}

bool OAIDatastoreProperties::is_sse_configuration_Set() const{
    return m_sse_configuration_isSet;
}

bool OAIDatastoreProperties::is_sse_configuration_Valid() const{
    return m_sse_configuration_isValid;
}

OAIDatastoreProperties_PreloadDataConfig OAIDatastoreProperties::getPreloadDataConfig() const {
    return m_preload_data_config;
}
void OAIDatastoreProperties::setPreloadDataConfig(const OAIDatastoreProperties_PreloadDataConfig &preload_data_config) {
    m_preload_data_config = preload_data_config;
    m_preload_data_config_isSet = true;
}

bool OAIDatastoreProperties::is_preload_data_config_Set() const{
    return m_preload_data_config_isSet;
}

bool OAIDatastoreProperties::is_preload_data_config_Valid() const{
    return m_preload_data_config_isValid;
}

OAIDatastoreProperties_IdentityProviderConfiguration OAIDatastoreProperties::getIdentityProviderConfiguration() const {
    return m_identity_provider_configuration;
}
void OAIDatastoreProperties::setIdentityProviderConfiguration(const OAIDatastoreProperties_IdentityProviderConfiguration &identity_provider_configuration) {
    m_identity_provider_configuration = identity_provider_configuration;
    m_identity_provider_configuration_isSet = true;
}

bool OAIDatastoreProperties::is_identity_provider_configuration_Set() const{
    return m_identity_provider_configuration_isSet;
}

bool OAIDatastoreProperties::is_identity_provider_configuration_Valid() const{
