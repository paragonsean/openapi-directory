...
/*
 * OAICreateFHIRDatastoreResponse.h
 *
 * 
 */

#ifndef OAICreateFHIRDatastoreResponse_H
#define OAICreateFHIRDatastoreResponse_H
...
class OAICreateFHIRDatastoreResponse : public OAIObject {
public:
    OAICreateFHIRDatastoreResponse();
    OAICreateFHIRDatastoreResponse(QString json);
    ~OAICreateFHIRDatastoreResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFHIRDatastoreResponse)

#endif // OAICreateFHIRDatastoreResponse_H
