...
/*
 * OAICreateStreamingSessionResponse_session.h
 *
 * 
 */

#ifndef OAICreateStreamingSessionResponse_session_H
#define OAICreateStreamingSessionResponse_session_H
...
class OAICreateStreamingSessionResponse_session : public OAIObject {
public:
    OAICreateStreamingSessionResponse_session();
    OAICreateStreamingSessionResponse_session(QString json);
    ~OAICreateStreamingSessionResponse_session() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamingSessionResponse_session)

#endif // OAICreateStreamingSessionResponse_session_H
