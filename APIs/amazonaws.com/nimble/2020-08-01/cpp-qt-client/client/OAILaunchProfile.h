...
#ifndef OAILaunchProfile_H
#define OAILaunchProfile_H
...
class OAILaunchProfile : public OAIObject {
public:
    OAILaunchProfile();
    OAILaunchProfile(QString json);
    ~OAILaunchProfile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchProfile)

#endif // OAILaunchProfile_H
