...
/*
 * OAIUpdateStudioComponent_request.h
 *
 * 
 */

#ifndef OAIUpdateStudioComponent_request_H
#define OAIUpdateStudioComponent_request_H
...
class OAIUpdateStudioComponent_request : public OAIObject {
public:
    OAIUpdateStudioComponent_request();
    OAIUpdateStudioComponent_request(QString json);
    ~OAIUpdateStudioComponent_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStudioComponent_request)

#endif // OAIUpdateStudioComponent_request_H
