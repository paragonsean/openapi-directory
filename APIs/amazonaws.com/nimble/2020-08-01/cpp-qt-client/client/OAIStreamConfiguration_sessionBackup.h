...
/*
 * OAIStreamConfiguration_sessionBackup.h
 *
 * 
 */

#ifndef OAIStreamConfiguration_sessionBackup_H
#define OAIStreamConfiguration_sessionBackup_H
...
class OAIStreamConfiguration_sessionBackup : public OAIObject {
public:
    OAIStreamConfiguration_sessionBackup();
    OAIStreamConfiguration_sessionBackup(QString json);
    ~OAIStreamConfiguration_sessionBackup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamConfiguration_sessionBackup)

#endif // OAIStreamConfiguration_sessionBackup_H
