...
OAIAutomaticTerminationMode OAIStreamConfiguration::getAutomaticTerminationMode() const {
    return m_automatic_termination_mode;
}
void OAIStreamConfiguration::setAutomaticTerminationMode(const OAIAutomaticTerminationMode &automatic_termination_mode) {
    m_automatic_termination_mode = automatic_termination_mode;
    m_automatic_termination_mode_isSet = true;
}

bool OAIStreamConfiguration::is_automatic_termination_mode_Set() const{
    return m_automatic_termination_mode_isSet;
}

bool OAIStreamConfiguration::is_automatic_termination_mode_Valid() const{
    return m_automatic_termination_mode_isValid;
}

OAIStreamingClipboardMode OAIStreamConfiguration::getClipboardMode() const {
    return m_clipboard_mode;
}
void OAIStreamConfiguration::setClipboardMode(const OAIStreamingClipboardMode &clipboard_mode) {
    m_clipboard_mode = clipboard_mode;
    m_clipboard_mode_isSet = true;
}

bool OAIStreamConfiguration::is_clipboard_mode_Set() const{
    return m_clipboard_mode_isSet;
}

bool OAIStreamConfiguration::is_clipboard_mode_Valid() const{
    return m_clipboard_mode_isValid;
}

QList OAIStreamConfiguration::getEc2InstanceTypes() const {
    return m_ec2_instance_types;
}
void OAIStreamConfiguration::setEc2InstanceTypes(const QList &ec2_instance_types) {
    m_ec2_instance_types = ec2_instance_types;
    m_ec2_instance_types_isSet = true;
}

bool OAIStreamConfiguration::is_ec2_instance_types_Set() const{
    return m_ec2_instance_types_isSet;
}

bool OAIStreamConfiguration::is_ec2_instance_types_Valid() const{
    return m_ec2_instance_types_isValid;
}

qint32 OAIStreamConfiguration::getMaxSessionLengthInMinutes() const {
    return m_max_session_length_in_minutes;
}
void OAIStreamConfiguration::setMaxSessionLengthInMinutes(const qint32 &max_session_length_in_minutes) {
    m_max_session_length_in_minutes = max_session_length_in_minutes;
    m_max_session_length_in_minutes_isSet = true;
}

bool OAIStreamConfiguration::is_max_session_length_in_minutes_Set() const{
    return m_max_session_length_in_minutes_isSet;
}

bool OAIStreamConfiguration::is_max_session_length_in_minutes_Valid() const{
    return m_max_session_length_in_minutes_isValid;
}

qint32 OAIStreamConfiguration::getMaxStoppedSessionLengthInMinutes() const {
    return m_max_stopped_session_length_in_minutes;
}
void OAIStreamConfiguration::setMaxStoppedSessionLengthInMinutes(const qint32 &max_stopped_session_length_in_minutes) {
...
bool OAIStreamConfiguration::is_max_stopped_session_length_in_minutes_Set() const{
    return m_max_stopped_session_length_in_minutes_isSet;
}

bool OAIStreamConfiguration::is_max_stopped_session_length_in_minutes_Valid() const{
    return m_max_stopped_session_length_in_minutes_isValid;
}

OAIStreamConfiguration_sessionBackup OAIStreamConfiguration::getSessionBackup() const {
    return m_session_backup;
}
void OAIStreamConfiguration::setSessionBackup(const OAIStreamConfiguration_sessionBackup &session_backup) {
    m_session_backup = session_backup;
    m_session_backup_isSet = true;
}

bool OAIStreamConfiguration::is_session_backup_Set() const{
    return m_session_backup_isSet;
}

bool OAIStreamConfiguration::is_session_backup_Valid() const{
    return m_session_backup_isValid;
}

OAISessionPersistenceMode OAIStreamConfiguration::getSessionPersistenceMode() const {
    return m_session_persistence_mode;
}
void OAIStreamConfiguration::setSessionPersistenceMode(const OAISessionPersistenceMode &session_persistence_mode) {
    m_session_persistence_mode = session_persistence_mode;
    m_session_persistence_mode_isSet = true;
}

bool OAIStreamConfiguration::is_session_persistence_mode_Set() const{
    return m_session_persistence_mode_isSet;
}

bool OAIStreamConfiguration::is_session_persistence_mode_Valid() const{
    return m_session_persistence_mode_isValid;
}

OAIStreamConfiguration_sessionStorage OAIStreamConfiguration::getSessionStorage() const {
    return m_session_storage;
}
void OAIStreamConfiguration::setSessionStorage(const OAIStreamConfiguration_sessionStorage &session_storage) {
    m_session_storage = session_storage;
    m_session_storage_isSet = true;
}

bool OAIStreamConfiguration::is_session_storage_Set() const{
    return m_session_storage_isSet;
}

bool OAIStreamConfiguration::is_session_storage_Valid() const{
    return m_session_storage_isValid;
}

QList OAIStreamConfiguration::getStreamingImageIds() const {
    return m_streaming_image_ids;
}
void OAIStreamConfiguration::setStreamingImageIds(const QList &streaming_image_ids) {
    m_streaming_image_ids = streaming_image_ids;
    m_streaming_image_ids_isSet = true;
}

bool OAIStreamConfiguration::is_streaming_image_ids_Set() const{
    return m_streaming_image_ids_isSet;
}

bool OAIStreamConfiguration::is_streaming_image_ids_Valid() const{
    return m_streaming_image_ids_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration OAIStreamConfiguration::getVolumeConfiguration() const {
    return m_volume_configuration;
}
void OAIStreamConfiguration::setVolumeConfiguration(const OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration &volume_configuration) {
    m_volume_configuration = volume_configuration;
    m_volume_configuration_isSet = true;
}

bool OAIStreamConfiguration::is_volume_configuration_Set() const{
    return m_volume_configuration_isSet;
}

bool OAIStreamConfiguration::is_volume_configuration_Valid() const{
