...
#include "OAIStreamConfigurationCreate.h"
...
OAIStreamConfigurationCreate::OAIStreamConfigurationCreate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamConfigurationCreate::OAIStreamConfigurationCreate() {
    this->initializeModel();
}

OAIStreamConfigurationCreate::~OAIStreamConfigurationCreate() {}

void OAIStreamConfigurationCreate::initializeModel() {
...
void OAIStreamConfigurationCreate::fromJson(QString jsonString) {
...
void OAIStreamConfigurationCreate::fromJsonObject(QJsonObject json) {
...
QString OAIStreamConfigurationCreate::asJson() const {
...
QJsonObject OAIStreamConfigurationCreate::asJsonObject() const {
    QJsonObject obj;
...
OAIAutomaticTerminationMode OAIStreamConfigurationCreate::getAutomaticTerminationMode() const {
    return m_automatic_termination_mode;
}
void OAIStreamConfigurationCreate::setAutomaticTerminationMode(const OAIAutomaticTerminationMode &automatic_termination_mode) {
    m_automatic_termination_mode = automatic_termination_mode;
    m_automatic_termination_mode_isSet = true;
}

bool OAIStreamConfigurationCreate::is_automatic_termination_mode_Set() const{
    return m_automatic_termination_mode_isSet;
}

bool OAIStreamConfigurationCreate::is_automatic_termination_mode_Valid() const{
    return m_automatic_termination_mode_isValid;
}

OAIStreamingClipboardMode OAIStreamConfigurationCreate::getClipboardMode() const {
    return m_clipboard_mode;
}
void OAIStreamConfigurationCreate::setClipboardMode(const OAIStreamingClipboardMode &clipboard_mode) {
    m_clipboard_mode = clipboard_mode;
    m_clipboard_mode_isSet = true;
}

bool OAIStreamConfigurationCreate::is_clipboard_mode_Set() const{
    return m_clipboard_mode_isSet;
}

bool OAIStreamConfigurationCreate::is_clipboard_mode_Valid() const{
    return m_clipboard_mode_isValid;
}

QList OAIStreamConfigurationCreate::getEc2InstanceTypes() const {
    return m_ec2_instance_types;
}
void OAIStreamConfigurationCreate::setEc2InstanceTypes(const QList &ec2_instance_types) {
    m_ec2_instance_types = ec2_instance_types;
    m_ec2_instance_types_isSet = true;
}

bool OAIStreamConfigurationCreate::is_ec2_instance_types_Set() const{
    return m_ec2_instance_types_isSet;
}

bool OAIStreamConfigurationCreate::is_ec2_instance_types_Valid() const{
    return m_ec2_instance_types_isValid;
}

qint32 OAIStreamConfigurationCreate::getMaxSessionLengthInMinutes() const {
    return m_max_session_length_in_minutes;
}
void OAIStreamConfigurationCreate::setMaxSessionLengthInMinutes(const qint32 &max_session_length_in_minutes) {
    m_max_session_length_in_minutes = max_session_length_in_minutes;
    m_max_session_length_in_minutes_isSet = true;
}

bool OAIStreamConfigurationCreate::is_max_session_length_in_minutes_Set() const{
    return m_max_session_length_in_minutes_isSet;
}

bool OAIStreamConfigurationCreate::is_max_session_length_in_minutes_Valid() const{
    return m_max_session_length_in_minutes_isValid;
}

qint32 OAIStreamConfigurationCreate::getMaxStoppedSessionLengthInMinutes() const {
    return m_max_stopped_session_length_in_minutes;
}
void OAIStreamConfigurationCreate::setMaxStoppedSessionLengthInMinutes(const qint32 &max_stopped_session_length_in_minutes) {
...
bool OAIStreamConfigurationCreate::is_max_stopped_session_length_in_minutes_Set() const{
    return m_max_stopped_session_length_in_minutes_isSet;
}

bool OAIStreamConfigurationCreate::is_max_stopped_session_length_in_minutes_Valid() const{
    return m_max_stopped_session_length_in_minutes_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_sessionBackup OAIStreamConfigurationCreate::getSessionBackup() const {
    return m_session_backup;
}
void OAIStreamConfigurationCreate::setSessionBackup(const OAICreateLaunchProfile_request_streamConfiguration_sessionBackup &session_backup) {
    m_session_backup = session_backup;
    m_session_backup_isSet = true;
}

bool OAIStreamConfigurationCreate::is_session_backup_Set() const{
    return m_session_backup_isSet;
}

bool OAIStreamConfigurationCreate::is_session_backup_Valid() const{
    return m_session_backup_isValid;
}

OAISessionPersistenceMode OAIStreamConfigurationCreate::getSessionPersistenceMode() const {
    return m_session_persistence_mode;
}
void OAIStreamConfigurationCreate::setSessionPersistenceMode(const OAISessionPersistenceMode &session_persistence_mode) {
    m_session_persistence_mode = session_persistence_mode;
    m_session_persistence_mode_isSet = true;
}

bool OAIStreamConfigurationCreate::is_session_persistence_mode_Set() const{
    return m_session_persistence_mode_isSet;
}

bool OAIStreamConfigurationCreate::is_session_persistence_mode_Valid() const{
    return m_session_persistence_mode_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_sessionStorage OAIStreamConfigurationCreate::getSessionStorage() const {
    return m_session_storage;
}
void OAIStreamConfigurationCreate::setSessionStorage(const OAICreateLaunchProfile_request_streamConfiguration_sessionStorage &session_storage) {
    m_session_storage = session_storage;
    m_session_storage_isSet = true;
}

bool OAIStreamConfigurationCreate::is_session_storage_Set() const{
    return m_session_storage_isSet;
}

bool OAIStreamConfigurationCreate::is_session_storage_Valid() const{
    return m_session_storage_isValid;
}

QList OAIStreamConfigurationCreate::getStreamingImageIds() const {
    return m_streaming_image_ids;
}
void OAIStreamConfigurationCreate::setStreamingImageIds(const QList &streaming_image_ids) {
    m_streaming_image_ids = streaming_image_ids;
    m_streaming_image_ids_isSet = true;
}

bool OAIStreamConfigurationCreate::is_streaming_image_ids_Set() const{
    return m_streaming_image_ids_isSet;
}

bool OAIStreamConfigurationCreate::is_streaming_image_ids_Valid() const{
    return m_streaming_image_ids_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration OAIStreamConfigurationCreate::getVolumeConfiguration() const {
    return m_volume_configuration;
}
void OAIStreamConfigurationCreate::setVolumeConfiguration(const OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration &volume_configuration) {
    m_volume_configuration = volume_configuration;
    m_volume_configuration_isSet = true;
}

bool OAIStreamConfigurationCreate::is_volume_configuration_Set() const{
    return m_volume_configuration_isSet;
}

bool OAIStreamConfigurationCreate::is_volume_configuration_Valid() const{
    return m_volume_configuration_isValid;
}

bool OAIStreamConfigurationCreate::isSet() const {
...
bool OAIStreamConfigurationCreate::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_clipboard_mode_isValid && m_ec2_instance_types_isValid && m_streaming_image_ids_isValid && true;
}
