...
/*
 * OAIUpdateStudioComponentRequest.h
 *
 * 
 */

#ifndef OAIUpdateStudioComponentRequest_H
#define OAIUpdateStudioComponentRequest_H
...
class OAIUpdateStudioComponentRequest : public OAIObject {
public:
    OAIUpdateStudioComponentRequest();
    OAIUpdateStudioComponentRequest(QString json);
    ~OAIUpdateStudioComponentRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStudioComponentRequest)

#endif // OAIUpdateStudioComponentRequest_H
