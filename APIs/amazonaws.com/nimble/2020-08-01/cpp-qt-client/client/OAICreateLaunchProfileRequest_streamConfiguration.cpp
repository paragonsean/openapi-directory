...
OAICreateLaunchProfileRequest_streamConfiguration::OAICreateLaunchProfileRequest_streamConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateLaunchProfileRequest_streamConfiguration::OAICreateLaunchProfileRequest_streamConfiguration() {
    this->initializeModel();
}

OAICreateLaunchProfileRequest_streamConfiguration::~OAICreateLaunchProfileRequest_streamConfiguration() {}

void OAICreateLaunchProfileRequest_streamConfiguration::initializeModel() {
...
void OAICreateLaunchProfileRequest_streamConfiguration::fromJson(QString jsonString) {
...
void OAICreateLaunchProfileRequest_streamConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICreateLaunchProfileRequest_streamConfiguration::asJson() const {
...
QJsonObject OAICreateLaunchProfileRequest_streamConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIAutomaticTerminationMode OAICreateLaunchProfileRequest_streamConfiguration::getAutomaticTerminationMode() const {
    return m_automatic_termination_mode;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setAutomaticTerminationMode(const OAIAutomaticTerminationMode &automatic_termination_mode) {
    m_automatic_termination_mode = automatic_termination_mode;
    m_automatic_termination_mode_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_automatic_termination_mode_Set() const{
    return m_automatic_termination_mode_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_automatic_termination_mode_Valid() const{
    return m_automatic_termination_mode_isValid;
}

OAIStreamingClipboardMode OAICreateLaunchProfileRequest_streamConfiguration::getClipboardMode() const {
    return m_clipboard_mode;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setClipboardMode(const OAIStreamingClipboardMode &clipboard_mode) {
    m_clipboard_mode = clipboard_mode;
    m_clipboard_mode_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_clipboard_mode_Set() const{
    return m_clipboard_mode_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_clipboard_mode_Valid() const{
    return m_clipboard_mode_isValid;
}

QList OAICreateLaunchProfileRequest_streamConfiguration::getEc2InstanceTypes() const {
    return m_ec2_instance_types;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setEc2InstanceTypes(const QList &ec2_instance_types) {
    m_ec2_instance_types = ec2_instance_types;
    m_ec2_instance_types_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_ec2_instance_types_Set() const{
    return m_ec2_instance_types_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_ec2_instance_types_Valid() const{
    return m_ec2_instance_types_isValid;
}

qint32 OAICreateLaunchProfileRequest_streamConfiguration::getMaxSessionLengthInMinutes() const {
    return m_max_session_length_in_minutes;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setMaxSessionLengthInMinutes(const qint32 &max_session_length_in_minutes) {
    m_max_session_length_in_minutes = max_session_length_in_minutes;
    m_max_session_length_in_minutes_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_max_session_length_in_minutes_Set() const{
    return m_max_session_length_in_minutes_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_max_session_length_in_minutes_Valid() const{
    return m_max_session_length_in_minutes_isValid;
}

qint32 OAICreateLaunchProfileRequest_streamConfiguration::getMaxStoppedSessionLengthInMinutes() const {
    return m_max_stopped_session_length_in_minutes;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setMaxStoppedSessionLengthInMinutes(const qint32 &max_stopped_session_length_in_minutes) {
...
bool OAICreateLaunchProfileRequest_streamConfiguration::is_max_stopped_session_length_in_minutes_Set() const{
    return m_max_stopped_session_length_in_minutes_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_max_stopped_session_length_in_minutes_Valid() const{
    return m_max_stopped_session_length_in_minutes_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_sessionBackup OAICreateLaunchProfileRequest_streamConfiguration::getSessionBackup() const {
    return m_session_backup;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setSessionBackup(const OAICreateLaunchProfile_request_streamConfiguration_sessionBackup &session_backup) {
    m_session_backup = session_backup;
    m_session_backup_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_session_backup_Set() const{
    return m_session_backup_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_session_backup_Valid() const{
    return m_session_backup_isValid;
}

OAISessionPersistenceMode OAICreateLaunchProfileRequest_streamConfiguration::getSessionPersistenceMode() const {
    return m_session_persistence_mode;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setSessionPersistenceMode(const OAISessionPersistenceMode &session_persistence_mode) {
    m_session_persistence_mode = session_persistence_mode;
    m_session_persistence_mode_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_session_persistence_mode_Set() const{
    return m_session_persistence_mode_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_session_persistence_mode_Valid() const{
    return m_session_persistence_mode_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_sessionStorage OAICreateLaunchProfileRequest_streamConfiguration::getSessionStorage() const {
    return m_session_storage;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setSessionStorage(const OAICreateLaunchProfile_request_streamConfiguration_sessionStorage &session_storage) {
    m_session_storage = session_storage;
    m_session_storage_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_session_storage_Set() const{
    return m_session_storage_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_session_storage_Valid() const{
    return m_session_storage_isValid;
}

QList OAICreateLaunchProfileRequest_streamConfiguration::getStreamingImageIds() const {
    return m_streaming_image_ids;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setStreamingImageIds(const QList &streaming_image_ids) {
    m_streaming_image_ids = streaming_image_ids;
    m_streaming_image_ids_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_streaming_image_ids_Set() const{
    return m_streaming_image_ids_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_streaming_image_ids_Valid() const{
    return m_streaming_image_ids_isValid;
}

OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration OAICreateLaunchProfileRequest_streamConfiguration::getVolumeConfiguration() const {
    return m_volume_configuration;
}
void OAICreateLaunchProfileRequest_streamConfiguration::setVolumeConfiguration(const OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration &volume_configuration) {
    m_volume_configuration = volume_configuration;
    m_volume_configuration_isSet = true;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_volume_configuration_Set() const{
    return m_volume_configuration_isSet;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::is_volume_configuration_Valid() const{
    return m_volume_configuration_isValid;
}

bool OAICreateLaunchProfileRequest_streamConfiguration::isSet() const {
...
bool OAICreateLaunchProfileRequest_streamConfiguration::isValid() const {
