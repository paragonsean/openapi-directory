...
#ifndef OAIStreamingSessionStream_H
#define OAIStreamingSessionStream_H
...
class OAIStreamingSessionStream : public OAIObject {
public:
    OAIStreamingSessionStream();
    OAIStreamingSessionStream(QString json);
    ~OAIStreamingSessionStream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamingSessionStream)

#endif // OAIStreamingSessionStream_H
