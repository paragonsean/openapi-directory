...
/*
 * OAICreateLaunchProfileRequest_streamConfiguration.h
 *
 * 
 */

#ifndef OAICreateLaunchProfileRequest_streamConfiguration_H
#define OAICreateLaunchProfileRequest_streamConfiguration_H
...
class OAICreateLaunchProfileRequest_streamConfiguration : public OAIObject {
public:
    OAICreateLaunchProfileRequest_streamConfiguration();
    OAICreateLaunchProfileRequest_streamConfiguration(QString json);
    ~OAICreateLaunchProfileRequest_streamConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLaunchProfileRequest_streamConfiguration)

#endif // OAICreateLaunchProfileRequest_streamConfiguration_H
