...
/*
 * OAILaunchProfile_streamConfiguration.h
 *
 * 
 */

#ifndef OAILaunchProfile_streamConfiguration_H
#define OAILaunchProfile_streamConfiguration_H
...
namespace OpenAPI {
class OAIStreamConfiguration_sessionBackup;
class OAIStreamConfiguration_sessionStorage;
class OAICreateLaunchProfile_request_streamConfiguration_volumeConfiguration;

class OAILaunchProfile_streamConfiguration : public OAIObject {
public:
    OAILaunchProfile_streamConfiguration();
    OAILaunchProfile_streamConfiguration(QString json);
    ~OAILaunchProfile_streamConfiguration() override;
    ...
    OAIStreamConfiguration_sessionBackup getSessionBackup() const;
    void setSessionBackup(const OAIStreamConfiguration_sessionBackup &session_backup);
    ...
    OAIStreamConfiguration_sessionStorage getSessionStorage() const;
    void setSessionStorage(const OAIStreamConfiguration_sessionStorage &session_storage);
...
private:
    ...
    OAIStreamConfiguration_sessionBackup m_session_backup;
    ...
    OAIStreamConfiguration_sessionStorage m_session_storage;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchProfile_streamConfiguration)

#endif // OAILaunchProfile_streamConfiguration_H
