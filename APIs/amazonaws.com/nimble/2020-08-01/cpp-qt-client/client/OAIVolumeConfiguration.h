...
#ifndef OAIVolumeConfiguration_H
#define OAIVolumeConfiguration_H
...
class OAIVolumeConfiguration : public OAIObject {
public:
    OAIVolumeConfiguration();
    OAIVolumeConfiguration(QString json);
    ~OAIVolumeConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVolumeConfiguration)

#endif // OAIVolumeConfiguration_H
