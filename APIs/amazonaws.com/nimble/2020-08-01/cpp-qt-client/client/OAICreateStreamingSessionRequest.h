...
/*
 * OAICreateStreamingSessionRequest.h
 *
 * 
 */

#ifndef OAICreateStreamingSessionRequest_H
#define OAICreateStreamingSessionRequest_H
...
class OAICreateStreamingSessionRequest : public OAIObject {
public:
    OAICreateStreamingSessionRequest();
    OAICreateStreamingSessionRequest(QString json);
    ~OAICreateStreamingSessionRequest() override;
    ...
    OAIStreamingInstanceType getEc2InstanceType() const;
    void setEc2InstanceType(const OAIStreamingInstanceType &ec2_instance_type);
...
private:
    ...
    OAIStreamingInstanceType m_ec2_instance_type;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamingSessionRequest)

#endif // OAICreateStreamingSessionRequest_H
