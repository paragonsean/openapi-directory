...
/*
 * OAIStreamingSessionBackup.h
 *
 * Information about the streaming session backup.
 */

#ifndef OAIStreamingSessionBackup_H
#define OAIStreamingSessionBackup_H
...
class OAIStreamingSessionBackup : public OAIObject {
public:
    OAIStreamingSessionBackup();
    OAIStreamingSessionBackup(QString json);
    ~OAIStreamingSessionBackup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamingSessionBackup)

#endif // OAIStreamingSessionBackup_H
