...
#ifndef OAIStreamingImage_H
#define OAIStreamingImage_H
...
class OAIStreamingImage : public OAIObject {
public:
    OAIStreamingImage();
    OAIStreamingImage(QString json);
    ~OAIStreamingImage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamingImage)

#endif // OAIStreamingImage_H
