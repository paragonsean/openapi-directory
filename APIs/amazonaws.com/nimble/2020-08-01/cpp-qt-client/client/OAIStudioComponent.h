...
#ifndef OAIStudioComponent_H
#define OAIStudioComponent_H
...
class OAIStudioComponent : public OAIObject {
public:
    OAIStudioComponent();
    OAIStudioComponent(QString json);
    ~OAIStudioComponent() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStudioComponent)

#endif // OAIStudioComponent_H
