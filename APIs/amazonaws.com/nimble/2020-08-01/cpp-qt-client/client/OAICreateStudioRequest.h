...
/*
 * OAICreateStudioRequest.h
 *
 * 
 */

#ifndef OAICreateStudioRequest_H
#define OAICreateStudioRequest_H
...
namespace OpenAPI {
class OAICreateStudioRequest_studioEncryptionConfiguration;

class OAICreateStudioRequest : public OAIObject {
public:
    OAICreateStudioRequest();
    OAICreateStudioRequest(QString json);
    ~OAICreateStudioRequest() override;
    ...
    OAICreateStudioRequest_studioEncryptionConfiguration getStudioEncryptionConfiguration() const;
    void setStudioEncryptionConfiguration(const OAICreateStudioRequest_studioEncryptionConfiguration &studio_encryption_configuration);
...
private:
    ...
    OAICreateStudioRequest_studioEncryptionConfiguration m_studio_encryption_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStudioRequest)

#endif // OAICreateStudioRequest_H
