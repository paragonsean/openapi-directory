...
public class CreateLaunchProfileRequestStreamConfiguration {
  ...
  public CreateLaunchProfileRequestStreamConfiguration() {
  }

  public CreateLaunchProfileRequestStreamConfiguration automaticTerminationMode(AutomaticTerminationMode automaticTerminationMode) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration clipboardMode(StreamingClipboardMode clipboardMode) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration ec2InstanceTypes(List ec2InstanceTypes) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration maxSessionLengthInMinutes(Integer maxSessionLengthInMinutes) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration maxStoppedSessionLengthInMinutes(Integer maxStoppedSessionLengthInMinutes) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration sessionBackup(CreateLaunchProfileRequestStreamConfigurationSessionBackup sessionBackup) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration sessionPersistenceMode(SessionPersistenceMode sessionPersistenceMode) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration sessionStorage(CreateLaunchProfileRequestStreamConfigurationSessionStorage sessionStorage) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration streamingImageIds(List streamingImageIds) {
  ...
  public CreateLaunchProfileRequestStreamConfiguration volumeConfiguration(CreateLaunchProfileRequestStreamConfigurationVolumeConfiguration volumeConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLaunchProfileRequestStreamConfiguration createLaunchProfileRequestStreamConfiguration = (CreateLaunchProfileRequestStreamConfiguration) o;
    return Objects.equals(this.automaticTerminationMode, createLaunchProfileRequestStreamConfiguration.automaticTerminationMode) &&
        Objects.equals(this.clipboardMode, createLaunchProfileRequestStreamConfiguration.clipboardMode) &&
        Objects.equals(this.ec2InstanceTypes, createLaunchProfileRequestStreamConfiguration.ec2InstanceTypes) &&
        Objects.equals(this.maxSessionLengthInMinutes, createLaunchProfileRequestStreamConfiguration.maxSessionLengthInMinutes) &&
        Objects.equals(this.maxStoppedSessionLengthInMinutes, createLaunchProfileRequestStreamConfiguration.maxStoppedSessionLengthInMinutes) &&
        Objects.equals(this.sessionBackup, createLaunchProfileRequestStreamConfiguration.sessionBackup) &&
        Objects.equals(this.sessionPersistenceMode, createLaunchProfileRequestStreamConfiguration.sessionPersistenceMode) &&
        Objects.equals(this.sessionStorage, createLaunchProfileRequestStreamConfiguration.sessionStorage) &&
        Objects.equals(this.streamingImageIds, createLaunchProfileRequestStreamConfiguration.streamingImageIds) &&
        Objects.equals(this.volumeConfiguration, createLaunchProfileRequestStreamConfiguration.volumeConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateLaunchProfileRequestStreamConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLaunchProfileRequestStreamConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLaunchProfileRequestStreamConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLaunchProfileRequestStreamConfiguration is not found in the empty JSON string", CreateLaunchProfileRequestStreamConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLaunchProfileRequestStreamConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLaunchProfileRequestStreamConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLaunchProfileRequestStreamConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLaunchProfileRequestStreamConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLaunchProfileRequestStreamConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLaunchProfileRequestStreamConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLaunchProfileRequestStreamConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLaunchProfileRequestStreamConfiguration>() {
           @Override
           public void write(JsonWriter out, CreateLaunchProfileRequestStreamConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLaunchProfileRequestStreamConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLaunchProfileRequestStreamConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLaunchProfileRequestStreamConfiguration
   * @throws IOException if the JSON string is invalid with respect to CreateLaunchProfileRequestStreamConfiguration
   */
  public static CreateLaunchProfileRequestStreamConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLaunchProfileRequestStreamConfiguration.class);
  }

  /**
   * Convert an instance of CreateLaunchProfileRequestStreamConfiguration to an JSON string
   *
   * @return JSON string
   */
