...
/**
 * Gets or Sets StreamingSessionStatusCode
 */
@JsonAdapter(StreamingSessionStatusCode.Adapter.class)
public enum StreamingSessionStatusCode {
  ...
  StreamingSessionStatusCode(String value) {
    this.value = value;
  }
  ...
  public static StreamingSessionStatusCode fromValue(String value) {
    for (StreamingSessionStatusCode b : StreamingSessionStatusCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<StreamingSessionStatusCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final StreamingSessionStatusCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public StreamingSessionStatusCode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return StreamingSessionStatusCode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    StreamingSessionStatusCode.fromValue(value);
  }
}
