...
public class StreamingImage {
  ...
  public StreamingImage arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public StreamingImage description(String description) {
  ...
  public StreamingImage ec2ImageId(String ec2ImageId) {
  ...
  public StreamingImage encryptionConfiguration(StreamingImageEncryptionConfiguration encryptionConfiguration) {
  ...
  public StreamingImage eulaIds(List eulaIds) {
  ...
  public StreamingImage name(String name) {
    this.name = name;
    return this;
  }
  ...
  public StreamingImage owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public StreamingImage platform(String platform) {
  ...
  public StreamingImage state(StreamingImageState state) {
    this.state = state;
    return this;
  }
  ...
  public StreamingImage statusCode(StreamingImageStatusCode statusCode) {
  ...
  public StreamingImage statusMessage(String statusMessage) {
  ...
  public StreamingImage streamingImageId(String streamingImageId) {
  ...
  public StreamingImage tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StreamingImage streamingImage = (StreamingImage) o;
    return Objects.equals(this.arn, streamingImage.arn) &&
        Objects.equals(this.description, streamingImage.description) &&
        Objects.equals(this.ec2ImageId, streamingImage.ec2ImageId) &&
        Objects.equals(this.encryptionConfiguration, streamingImage.encryptionConfiguration) &&
        Objects.equals(this.eulaIds, streamingImage.eulaIds) &&
        Objects.equals(this.name, streamingImage.name) &&
        Objects.equals(this.owner, streamingImage.owner) &&
        Objects.equals(this.platform, streamingImage.platform) &&
        Objects.equals(this.state, streamingImage.state) &&
        Objects.equals(this.statusCode, streamingImage.statusCode) &&
        Objects.equals(this.statusMessage, streamingImage.statusMessage) &&
        Objects.equals(this.streamingImageId, streamingImage.streamingImageId) &&
        Objects.equals(this.tags, streamingImage.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamingImage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamingImage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamingImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamingImage is not found in the empty JSON string", StreamingImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamingImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamingImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StreamingImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StreamingImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StreamingImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamingImage.class));

       return (TypeAdapter<T>) new TypeAdapter<StreamingImage>() {
           @Override
           public void write(JsonWriter out, StreamingImage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StreamingImage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StreamingImage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StreamingImage
   * @throws IOException if the JSON string is invalid with respect to StreamingImage
   */
  public static StreamingImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StreamingImage.class);
  }

  /**
   * Convert an instance of StreamingImage to an JSON string
   *
   * @return JSON string
   */
