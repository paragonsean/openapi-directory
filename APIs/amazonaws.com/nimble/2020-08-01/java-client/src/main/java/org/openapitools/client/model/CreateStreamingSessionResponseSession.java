...
public class CreateStreamingSessionResponseSession {
  ...
  public CreateStreamingSessionResponseSession() {
  }

  public CreateStreamingSessionResponseSession arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreateStreamingSessionResponseSession automaticTerminationMode(AutomaticTerminationMode automaticTerminationMode) {
  ...
  public CreateStreamingSessionResponseSession backupMode(SessionBackupMode backupMode) {
  ...
  public CreateStreamingSessionResponseSession createdAt(OffsetDateTime createdAt) {
  ...
  public CreateStreamingSessionResponseSession createdBy(String createdBy) {
  ...
  public CreateStreamingSessionResponseSession ec2InstanceType(String ec2InstanceType) {
  ...
  public CreateStreamingSessionResponseSession launchProfileId(String launchProfileId) {
  ...
  public CreateStreamingSessionResponseSession maxBackupsToRetain(Integer maxBackupsToRetain) {
  ...
  public CreateStreamingSessionResponseSession ownedBy(String ownedBy) {
  ...
  public CreateStreamingSessionResponseSession sessionId(String sessionId) {
  ...
  public CreateStreamingSessionResponseSession sessionPersistenceMode(SessionPersistenceMode sessionPersistenceMode) {
  ...
  public CreateStreamingSessionResponseSession startedAt(OffsetDateTime startedAt) {
  ...
  public CreateStreamingSessionResponseSession startedBy(String startedBy) {
  ...
  public CreateStreamingSessionResponseSession startedFromBackupId(String startedFromBackupId) {
  ...
  public CreateStreamingSessionResponseSession state(StreamingSessionState state) {
    this.state = state;
    return this;
  }
  ...
  public CreateStreamingSessionResponseSession statusCode(StreamingSessionStatusCode statusCode) {
  ...
  public CreateStreamingSessionResponseSession statusMessage(String statusMessage) {
  ...
  public CreateStreamingSessionResponseSession stopAt(OffsetDateTime stopAt) {
    this.stopAt = stopAt;
    return this;
  }
  ...
  public CreateStreamingSessionResponseSession stoppedAt(OffsetDateTime stoppedAt) {
  ...
  public CreateStreamingSessionResponseSession stoppedBy(String stoppedBy) {
  ...
  public CreateStreamingSessionResponseSession streamingImageId(String streamingImageId) {
  ...
  public CreateStreamingSessionResponseSession tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateStreamingSessionResponseSession terminateAt(OffsetDateTime terminateAt) {
  ...
  public CreateStreamingSessionResponseSession updatedAt(OffsetDateTime updatedAt) {
  ...
  public CreateStreamingSessionResponseSession updatedBy(String updatedBy) {
  ...
  public CreateStreamingSessionResponseSession volumeConfiguration(CreateLaunchProfileRequestStreamConfigurationVolumeConfiguration volumeConfiguration) {
  ...
  public CreateStreamingSessionResponseSession volumeRetentionMode(VolumeRetentionMode volumeRetentionMode) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStreamingSessionResponseSession createStreamingSessionResponseSession = (CreateStreamingSessionResponseSession) o;
    return Objects.equals(this.arn, createStreamingSessionResponseSession.arn) &&
        Objects.equals(this.automaticTerminationMode, createStreamingSessionResponseSession.automaticTerminationMode) &&
        Objects.equals(this.backupMode, createStreamingSessionResponseSession.backupMode) &&
        Objects.equals(this.createdAt, createStreamingSessionResponseSession.createdAt) &&
        Objects.equals(this.createdBy, createStreamingSessionResponseSession.createdBy) &&
        Objects.equals(this.ec2InstanceType, createStreamingSessionResponseSession.ec2InstanceType) &&
        Objects.equals(this.launchProfileId, createStreamingSessionResponseSession.launchProfileId) &&
        Objects.equals(this.maxBackupsToRetain, createStreamingSessionResponseSession.maxBackupsToRetain) &&
        Objects.equals(this.ownedBy, createStreamingSessionResponseSession.ownedBy) &&
        Objects.equals(this.sessionId, createStreamingSessionResponseSession.sessionId) &&
        Objects.equals(this.sessionPersistenceMode, createStreamingSessionResponseSession.sessionPersistenceMode) &&
        Objects.equals(this.startedAt, createStreamingSessionResponseSession.startedAt) &&
        Objects.equals(this.startedBy, createStreamingSessionResponseSession.startedBy) &&
        Objects.equals(this.startedFromBackupId, createStreamingSessionResponseSession.startedFromBackupId) &&
        Objects.equals(this.state, createStreamingSessionResponseSession.state) &&
        Objects.equals(this.statusCode, createStreamingSessionResponseSession.statusCode) &&
        Objects.equals(this.statusMessage, createStreamingSessionResponseSession.statusMessage) &&
        Objects.equals(this.stopAt, createStreamingSessionResponseSession.stopAt) &&
        Objects.equals(this.stoppedAt, createStreamingSessionResponseSession.stoppedAt) &&
        Objects.equals(this.stoppedBy, createStreamingSessionResponseSession.stoppedBy) &&
        Objects.equals(this.streamingImageId, createStreamingSessionResponseSession.streamingImageId) &&
        Objects.equals(this.tags, createStreamingSessionResponseSession.tags) &&
        Objects.equals(this.terminateAt, createStreamingSessionResponseSession.terminateAt) &&
        Objects.equals(this.updatedAt, createStreamingSessionResponseSession.updatedAt) &&
        Objects.equals(this.updatedBy, createStreamingSessionResponseSession.updatedBy) &&
        Objects.equals(this.volumeConfiguration, createStreamingSessionResponseSession.volumeConfiguration) &&
        Objects.equals(this.volumeRetentionMode, createStreamingSessionResponseSession.volumeRetentionMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStreamingSessionResponseSession {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStreamingSessionResponseSession
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStreamingSessionResponseSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateStreamingSessionResponseSession is not found in the empty JSON string", CreateStreamingSessionResponseSession.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStreamingSessionResponseSession.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateStreamingSessionResponseSession` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStreamingSessionResponseSession.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStreamingSessionResponseSession' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStreamingSessionResponseSession> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStreamingSessionResponseSession.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStreamingSessionResponseSession>() {
           @Override
           public void write(JsonWriter out, CreateStreamingSessionResponseSession value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStreamingSessionResponseSession read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStreamingSessionResponseSession given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStreamingSessionResponseSession
   * @throws IOException if the JSON string is invalid with respect to CreateStreamingSessionResponseSession
   */
  public static CreateStreamingSessionResponseSession fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStreamingSessionResponseSession.class);
  }

  /**
   * Convert an instance of CreateStreamingSessionResponseSession to an JSON string
   *
   * @return JSON string
   */
