...
public class LaunchProfileInitialization {
  ...
  public LaunchProfileInitialization activeDirectory(LaunchProfileInitializationActiveDirectory activeDirectory) {
  ...
  public LaunchProfileInitialization ec2SecurityGroupIds(List ec2SecurityGroupIds) {
  ...
  public LaunchProfileInitialization launchProfileId(String launchProfileId) {
  ...
  public LaunchProfileInitialization launchProfileProtocolVersion(String launchProfileProtocolVersion) {
  ...
  public LaunchProfileInitialization launchPurpose(String launchPurpose) {
  ...
  public LaunchProfileInitialization name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LaunchProfileInitialization platform(LaunchProfilePlatform platform) {
  ...
  public LaunchProfileInitialization systemInitializationScripts(List systemInitializationScripts) {
  ...
  public LaunchProfileInitialization userInitializationScripts(List userInitializationScripts) {
  ...
  public boolean equals(Object o) {
    ...
    LaunchProfileInitialization launchProfileInitialization = (LaunchProfileInitialization) o;
    return Objects.equals(this.activeDirectory, launchProfileInitialization.activeDirectory) &&
        Objects.equals(this.ec2SecurityGroupIds, launchProfileInitialization.ec2SecurityGroupIds) &&
        Objects.equals(this.launchProfileId, launchProfileInitialization.launchProfileId) &&
        Objects.equals(this.launchProfileProtocolVersion, launchProfileInitialization.launchProfileProtocolVersion) &&
        Objects.equals(this.launchPurpose, launchProfileInitialization.launchPurpose) &&
        Objects.equals(this.name, launchProfileInitialization.name) &&
        Objects.equals(this.platform, launchProfileInitialization.platform) &&
        Objects.equals(this.systemInitializationScripts, launchProfileInitialization.systemInitializationScripts) &&
        Objects.equals(this.userInitializationScripts, launchProfileInitialization.userInitializationScripts);
  }
  ...
  public String toString() {
    ...
    sb.append("class LaunchProfileInitialization {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LaunchProfileInitialization
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LaunchProfileInitialization.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LaunchProfileInitialization is not found in the empty JSON string", LaunchProfileInitialization.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LaunchProfileInitialization.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LaunchProfileInitialization` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LaunchProfileInitialization.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LaunchProfileInitialization' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LaunchProfileInitialization> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LaunchProfileInitialization.class));

       return (TypeAdapter<T>) new TypeAdapter<LaunchProfileInitialization>() {
           @Override
           public void write(JsonWriter out, LaunchProfileInitialization value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LaunchProfileInitialization read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LaunchProfileInitialization given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LaunchProfileInitialization
   * @throws IOException if the JSON string is invalid with respect to LaunchProfileInitialization
   */
  public static LaunchProfileInitialization fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LaunchProfileInitialization.class);
  }

  /**
   * Convert an instance of LaunchProfileInitialization to an JSON string
   *
   * @return JSON string
   */
