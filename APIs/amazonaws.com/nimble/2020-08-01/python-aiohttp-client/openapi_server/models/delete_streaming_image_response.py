...
class DeleteStreamingImageResponse(Model):
    ...
    def __init__(self, streaming_image: CreateStreamingImageResponseStreamingImage=None):
        """DeleteStreamingImageResponse - a model defined in OpenAPI

        :param streaming_image: The streaming_image of this DeleteStreamingImageResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteStreamingImageResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteStreamingImageResponse of this DeleteStreamingImageResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def streaming_image(self):
        """Gets the streaming_image of this DeleteStreamingImageResponse.


        :return: The streaming_image of this DeleteStreamingImageResponse.
    ...
    def streaming_image(self, streaming_image):
        """Sets the streaming_image of this DeleteStreamingImageResponse.
