...
class CreateStreamingImageResponse(Model):
    ...
    def __init__(self, streaming_image: CreateStreamingImageResponseStreamingImage=None):
        """CreateStreamingImageResponse - a model defined in OpenAPI

        :param streaming_image: The streaming_image of this CreateStreamingImageResponse.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateStreamingImageResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateStreamingImageResponse of this CreateStreamingImageResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def streaming_image(self):
        """Gets the streaming_image of this CreateStreamingImageResponse.


        :return: The streaming_image of this CreateStreamingImageResponse.
    ...
    def streaming_image(self, streaming_image):
        """Sets the streaming_image of this CreateStreamingImageResponse.
