...
/**
 * The StreamingSession model module.
 * @module model/StreamingSession
 * @version 2020-08-01
 */
class StreamingSession {
    /**
     * Constructs a new <code>StreamingSession</code>.
     * A streaming session is a virtual workstation created using a particular launch profile.
     * @alias module:model/StreamingSession
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>StreamingSession</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StreamingSession} obj Optional instance to populate.
     * @return {module:model/StreamingSession} The populated <code>StreamingSession</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StreamingSession();
    ...
    /**
     * Validates the JSON data with respect to <code>StreamingSession</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StreamingSession</code>.
     */
