...
import StreamConfigurationCreate from './StreamConfigurationCreate';
import StreamingClipboardMode from './StreamingClipboardMode';

/**
 * The CreateLaunchProfileRequestStreamConfiguration model module.
 * @module model/CreateLaunchProfileRequestStreamConfiguration
 * @version 2020-08-01
 */
class CreateLaunchProfileRequestStreamConfiguration {
    /**
     * Constructs a new <code>CreateLaunchProfileRequestStreamConfiguration</code>.
     * @alias module:model/CreateLaunchProfileRequestStreamConfiguration
     * @implements module:model/StreamConfigurationCreate
    ...
    constructor(clipboardMode, ec2InstanceTypes, streamingImageIds) { 
        ...
        CreateLaunchProfileRequestStreamConfiguration.initialize(this, clipboardMode, ec2InstanceTypes, streamingImageIds);
    }
    ...
    /**
     * Constructs a <code>CreateLaunchProfileRequestStreamConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateLaunchProfileRequestStreamConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateLaunchProfileRequestStreamConfiguration} The populated <code>CreateLaunchProfileRequestStreamConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateLaunchProfileRequestStreamConfiguration();
            StreamConfigurationCreate.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateLaunchProfileRequestStreamConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateLaunchProfileRequestStreamConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateLaunchProfileRequestStreamConfiguration.RequiredProperties) {
...
CreateLaunchProfileRequestStreamConfiguration.RequiredProperties = ["clipboardMode", "ec2InstanceTypes", "streamingImageIds"];

/**
 * @member {module:model/AutomaticTerminationMode} automaticTerminationMode
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['automaticTerminationMode'] = undefined;

/**
 * @member {module:model/StreamingClipboardMode} clipboardMode
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['clipboardMode'] = undefined;

/**
 * @member {Array} ec2InstanceTypes
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['ec2InstanceTypes'] = undefined;

/**
 * @member {Number} maxSessionLengthInMinutes
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['maxSessionLengthInMinutes'] = undefined;

/**
 * @member {Number} maxStoppedSessionLengthInMinutes
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['maxStoppedSessionLengthInMinutes'] = undefined;

/**
 * @member {module:model/CreateLaunchProfileRequestStreamConfigurationSessionBackup} sessionBackup
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['sessionBackup'] = undefined;

/**
 * @member {module:model/SessionPersistenceMode} sessionPersistenceMode
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['sessionPersistenceMode'] = undefined;

/**
 * @member {module:model/CreateLaunchProfileRequestStreamConfigurationSessionStorage} sessionStorage
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['sessionStorage'] = undefined;

/**
 * @member {Array} streamingImageIds
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['streamingImageIds'] = undefined;

/**
 * @member {module:model/CreateLaunchProfileRequestStreamConfigurationVolumeConfiguration} volumeConfiguration
 */
CreateLaunchProfileRequestStreamConfiguration.prototype['volumeConfiguration'] = undefined;


// Implement StreamConfigurationCreate interface:
/**
 * @member {module:model/AutomaticTerminationMode} automaticTerminationMode
 */
...
export default CreateLaunchProfileRequestStreamConfiguration;
