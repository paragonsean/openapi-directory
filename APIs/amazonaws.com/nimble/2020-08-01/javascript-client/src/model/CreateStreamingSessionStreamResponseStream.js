...
/**
 * The CreateStreamingSessionStreamResponseStream model module.
 * @module model/CreateStreamingSessionStreamResponseStream
 * @version 2020-08-01
 */
class CreateStreamingSessionStreamResponseStream {
    /**
     * Constructs a new <code>CreateStreamingSessionStreamResponseStream</code>.
     * @alias module:model/CreateStreamingSessionStreamResponseStream
     * @implements module:model/StreamingSessionStream
     */
    constructor() { 
        StreamingSessionStream.initialize(this);
        CreateStreamingSessionStreamResponseStream.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateStreamingSessionStreamResponseStream</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateStreamingSessionStreamResponseStream} obj Optional instance to populate.
     * @return {module:model/CreateStreamingSessionStreamResponseStream} The populated <code>CreateStreamingSessionStreamResponseStream</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateStreamingSessionStreamResponseStream();
            StreamingSessionStream.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateStreamingSessionStreamResponseStream</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateStreamingSessionStreamResponseStream</code>.
     */
 ...
 */
CreateStreamingSessionStreamResponseStream.prototype['createdAt'] = undefined;

/**
 * @member {String} createdBy
 */
CreateStreamingSessionStreamResponseStream.prototype['createdBy'] = undefined;

/**
 * @member {Date} expiresAt
 */
CreateStreamingSessionStreamResponseStream.prototype['expiresAt'] = undefined;

/**
 * @member {String} ownedBy
 */
CreateStreamingSessionStreamResponseStream.prototype['ownedBy'] = undefined;

/**
 * @member {module:model/StreamingSessionStreamState} state
 */
CreateStreamingSessionStreamResponseStream.prototype['state'] = undefined;

/**
 * @member {module:model/StreamingSessionStreamStatusCode} statusCode
 */
CreateStreamingSessionStreamResponseStream.prototype['statusCode'] = undefined;

/**
 * @member {String} streamId
 */
CreateStreamingSessionStreamResponseStream.prototype['streamId'] = undefined;

/**
 * @member {String} url
 */
CreateStreamingSessionStreamResponseStream.prototype['url'] = undefined;


// Implement StreamingSessionStream interface:
/**
 * @member {Date} createdAt
 */
...
export default CreateStreamingSessionStreamResponseStream;
