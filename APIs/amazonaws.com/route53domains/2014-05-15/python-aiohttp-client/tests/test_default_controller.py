...
async def test_accept_domain_transfer_from_another_aws_account(client):
    """Test case for accept_domain_transfer_from_another_aws_account

    
    """
    body = {"DomainName":"","Password":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount',
        headers=headers,
        json=body,
        )
...
async def test_associate_delegation_signer_to_domain(client):
    """Test case for associate_delegation_signer_to_domain

    
    """
    body = {"DomainName":"","SigningAttributes":{"PublicKey":"","Flags":"","Algorithm":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.AssociateDelegationSignerToDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_cancel_domain_transfer_to_another_aws_account(client):
    """Test case for cancel_domain_transfer_to_another_aws_account
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.CancelDomainTransferToAnotherAwsAccount',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_check_domain_availability(client):
    """Test case for check_domain_availability

    
    """
    body = {"DomainName":"","IdnLangCode":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.CheckDomainAvailability',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_check_domain_transferability(client):
    """Test case for check_domain_transferability

    
    """
    body = {"AuthCode":"","DomainName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.CheckDomainTransferability',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_domain(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.DeleteDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_tags_for_domain(client):
    """Test case for delete_tags_for_domain

    
    """
    body = {"TagsToDelete":"","DomainName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.DeleteTagsForDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disable_domain_auto_renew(client):
    """Test case for disable_domain_auto_renew
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.DisableDomainAutoRenew',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disable_domain_transfer_lock(client):
    """Test case for disable_domain_transfer_lock
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.DisableDomainTransferLock',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disassociate_delegation_signer_from_domain(client):
    """Test case for disassociate_delegation_signer_from_domain
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.DisassociateDelegationSignerFromDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enable_domain_auto_renew(client):
    """Test case for enable_domain_auto_renew
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.EnableDomainAutoRenew',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_enable_domain_transfer_lock(client):
    """Test case for enable_domain_transfer_lock
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.EnableDomainTransferLock',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_contact_reachability_status(client):
    """Test case for get_contact_reachability_status
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.GetContactReachabilityStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_domain_detail(client):
    """Test case for get_domain_detail
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.GetDomainDetail',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_domain_suggestions(client):
    """Test case for get_domain_suggestions

    
    """
    body = {"OnlyAvailable":"","DomainName":"","SuggestionCount":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.GetDomainSuggestions',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_operation_detail(client):
    """Test case for get_operation_detail
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.GetOperationDetail',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_domains(client):
    ...
    """
    body = {"SortCondition":{"SortOrder":"","Name":""},"FilterConditions":"","Marker":"","MaxItems":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ListDomains',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_operations(client):
    ...
    """
    body = {"Status":"","Type":"","SortBy":"","SortOrder":"","Marker":"","MaxItems":"","SubmittedSince":""}
    params = [('MaxItems', 'max_items_example'),
                    ('Marker', 'marker_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ListOperations',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_prices(client):
    """Test case for list_prices

    
    """
    body = {"Marker":"","MaxItems":"","Tld":""}
    params = [('MaxItems', 'max_items_example'),
                    ('Marker', 'marker_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ListPrices',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_tags_for_domain(client):
    """Test case for list_tags_for_domain
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ListTagsForDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_push_domain(client):
    """Test case for push_domain
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.PushDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_register_domain(client):
    ...
    """
    body = {"DurationInYears":"","DomainName":"","AutoRenew":"","PrivacyProtectAdminContact":"","PrivacyProtectRegistrantContact":"","AdminContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""},"IdnLangCode":"","PrivacyProtectTechContact":"","RegistrantContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""},"TechContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.RegisterDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_reject_domain_transfer_from_another_aws_account(client):
    """Test case for reject_domain_transfer_from_another_aws_account
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.RejectDomainTransferFromAnotherAwsAccount',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_renew_domain(client):
    """Test case for renew_domain

    
    """
    body = {"DurationInYears":"","CurrentExpiryYear":"","DomainName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.RenewDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_resend_contact_reachability_email(client):
    """Test case for resend_contact_reachability_email
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ResendContactReachabilityEmail',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_resend_operation_authorization(client):
    """Test case for resend_operation_authorization
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ResendOperationAuthorization',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_retrieve_domain_auth_code(client):
    """Test case for retrieve_domain_auth_code
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.RetrieveDomainAuthCode',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_transfer_domain(client):
    """Test case for transfer_domain

    
    """
    body = {"DurationInYears":"","AuthCode":"","DomainName":"","Nameservers":"","AutoRenew":"","PrivacyProtectAdminContact":"","PrivacyProtectRegistrantContact":"","AdminContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""},"IdnLangCode":"","PrivacyProtectTechContact":"","RegistrantContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""},"TechContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.TransferDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_transfer_domain_to_another_aws_account(client):
    """Test case for transfer_domain_to_another_aws_account

    
    """
    body = {"AccountId":"","DomainName":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.TransferDomainToAnotherAwsAccount',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_domain_contact(client):
    """Test case for update_domain_contact

    
    """
    body = {"DomainName":"","Consent":{"Currency":"","MaxPrice":""},"AdminContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""},"RegistrantContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""},"TechContact":{"OrganizationName":"","ContactType":"","Email":"","FirstName":"","ZipCode":"","City":"","AddressLine2":"","AddressLine1":"","ExtraParams":"","State":"","PhoneNumber":"","LastName":"","CountryCode":"","Fax":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContact',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_domain_contact_privacy(client):
    """Test case for update_domain_contact_privacy

    
    """
    body = {"DomainName":"","RegistrantPrivacy":"","AdminPrivacy":"","TechPrivacy":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContactPrivacy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_domain_nameservers(client):
    """Test case for update_domain_nameservers

    
    """
    body = {"DomainName":"","Nameservers":"","FIAuthKey":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainNameservers',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_tags_for_domain(client):
    """Test case for update_tags_for_domain

    
    """
    body = {"DomainName":"","TagsToUpdate":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.UpdateTagsForDomain',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_view_billing(client):
    """Test case for view_billing

    
    """
    body = {"Start":"","End":"","Marker":"","MaxItems":""}
    params = [('MaxItems', 'max_items_example'),
                    ('Marker', 'marker_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=Route53Domains_v20140515.ViewBilling',
        headers=headers,
        json=body,
        params=params,
        )
