...
/**
 * The TransferDomainRequestAdminContact model module.
 * @module model/TransferDomainRequestAdminContact
 * @version 2014-05-15
 */
class TransferDomainRequestAdminContact {
    /**
     * Constructs a new <code>TransferDomainRequestAdminContact</code>.
     * @alias module:model/TransferDomainRequestAdminContact
     * @implements module:model/ContactDetail
     */
    constructor() { 
        ContactDetail.initialize(this);
        TransferDomainRequestAdminContact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TransferDomainRequestAdminContact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransferDomainRequestAdminContact} obj Optional instance to populate.
     * @return {module:model/TransferDomainRequestAdminContact} The populated <code>TransferDomainRequestAdminContact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TransferDomainRequestAdminContact();
    ...
    /**
     * Validates the JSON data with respect to <code>TransferDomainRequestAdminContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransferDomainRequestAdminContact</code>.
     */
 ...
 */
TransferDomainRequestAdminContact.prototype['FirstName'] = undefined;

/**
 * @member {String} LastName
 */
TransferDomainRequestAdminContact.prototype['LastName'] = undefined;

/**
 * @member {module:model/ContactType} ContactType
 */
TransferDomainRequestAdminContact.prototype['ContactType'] = undefined;

/**
 * @member {String} OrganizationName
 */
TransferDomainRequestAdminContact.prototype['OrganizationName'] = undefined;

/**
 * @member {String} AddressLine1
 */
TransferDomainRequestAdminContact.prototype['AddressLine1'] = undefined;

/**
 * @member {String} AddressLine2
 */
TransferDomainRequestAdminContact.prototype['AddressLine2'] = undefined;

/**
 * @member {String} City
 */
TransferDomainRequestAdminContact.prototype['City'] = undefined;

/**
 * @member {String} State
 */
TransferDomainRequestAdminContact.prototype['State'] = undefined;

/**
 * @member {module:model/CountryCode} CountryCode
 */
TransferDomainRequestAdminContact.prototype['CountryCode'] = undefined;

/**
 * @member {String} ZipCode
 */
TransferDomainRequestAdminContact.prototype['ZipCode'] = undefined;

/**
 * @member {String} PhoneNumber
 */
TransferDomainRequestAdminContact.prototype['PhoneNumber'] = undefined;

/**
 * @member {String} Email
 */
TransferDomainRequestAdminContact.prototype['Email'] = undefined;

/**
 * @member {String} Fax
 */
TransferDomainRequestAdminContact.prototype['Fax'] = undefined;

/**
 * @member {Array} ExtraParams
 */
TransferDomainRequestAdminContact.prototype['ExtraParams'] = undefined;
...
export default TransferDomainRequestAdminContact;
