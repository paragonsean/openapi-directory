...
/**
 * The RegisterDomainRequestAdminContact model module.
 * @module model/RegisterDomainRequestAdminContact
 * @version 2014-05-15
 */
class RegisterDomainRequestAdminContact {
    /**
     * Constructs a new <code>RegisterDomainRequestAdminContact</code>.
     * @alias module:model/RegisterDomainRequestAdminContact
     * @implements module:model/ContactDetail
     */
    constructor() { 
        ContactDetail.initialize(this);
        RegisterDomainRequestAdminContact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RegisterDomainRequestAdminContact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegisterDomainRequestAdminContact} obj Optional instance to populate.
     * @return {module:model/RegisterDomainRequestAdminContact} The populated <code>RegisterDomainRequestAdminContact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RegisterDomainRequestAdminContact();
    ...
    /**
     * Validates the JSON data with respect to <code>RegisterDomainRequestAdminContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegisterDomainRequestAdminContact</code>.
     */
 ...
 */
RegisterDomainRequestAdminContact.prototype['FirstName'] = undefined;

/**
 * @member {String} LastName
 */
RegisterDomainRequestAdminContact.prototype['LastName'] = undefined;

/**
 * @member {module:model/ContactType} ContactType
 */
RegisterDomainRequestAdminContact.prototype['ContactType'] = undefined;

/**
 * @member {String} OrganizationName
 */
RegisterDomainRequestAdminContact.prototype['OrganizationName'] = undefined;

/**
 * @member {String} AddressLine1
 */
RegisterDomainRequestAdminContact.prototype['AddressLine1'] = undefined;

/**
 * @member {String} AddressLine2
 */
RegisterDomainRequestAdminContact.prototype['AddressLine2'] = undefined;

/**
 * @member {String} City
 */
RegisterDomainRequestAdminContact.prototype['City'] = undefined;

/**
 * @member {String} State
 */
RegisterDomainRequestAdminContact.prototype['State'] = undefined;

/**
 * @member {module:model/CountryCode} CountryCode
 */
RegisterDomainRequestAdminContact.prototype['CountryCode'] = undefined;

/**
 * @member {String} ZipCode
 */
RegisterDomainRequestAdminContact.prototype['ZipCode'] = undefined;

/**
 * @member {String} PhoneNumber
 */
RegisterDomainRequestAdminContact.prototype['PhoneNumber'] = undefined;

/**
 * @member {String} Email
 */
RegisterDomainRequestAdminContact.prototype['Email'] = undefined;

/**
 * @member {String} Fax
 */
RegisterDomainRequestAdminContact.prototype['Fax'] = undefined;

/**
 * @member {Array} ExtraParams
 */
RegisterDomainRequestAdminContact.prototype['ExtraParams'] = undefined;
...
export default RegisterDomainRequestAdminContact;
