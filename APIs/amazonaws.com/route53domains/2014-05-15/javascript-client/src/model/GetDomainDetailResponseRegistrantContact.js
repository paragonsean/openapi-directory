...
/**
 * The GetDomainDetailResponseRegistrantContact model module.
 * @module model/GetDomainDetailResponseRegistrantContact
 * @version 2014-05-15
 */
class GetDomainDetailResponseRegistrantContact {
    /**
     * Constructs a new <code>GetDomainDetailResponseRegistrantContact</code>.
     * @alias module:model/GetDomainDetailResponseRegistrantContact
     * @implements module:model/ContactDetail
     */
    constructor() { 
        ContactDetail.initialize(this);
        GetDomainDetailResponseRegistrantContact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDomainDetailResponseRegistrantContact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDomainDetailResponseRegistrantContact} obj Optional instance to populate.
     * @return {module:model/GetDomainDetailResponseRegistrantContact} The populated <code>GetDomainDetailResponseRegistrantContact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDomainDetailResponseRegistrantContact();
    ...
    /**
     * Validates the JSON data with respect to <code>GetDomainDetailResponseRegistrantContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDomainDetailResponseRegistrantContact</code>.
     */
 ...
 */
GetDomainDetailResponseRegistrantContact.prototype['FirstName'] = undefined;

/**
 * @member {String} LastName
 */
GetDomainDetailResponseRegistrantContact.prototype['LastName'] = undefined;

/**
 * @member {module:model/ContactType} ContactType
 */
GetDomainDetailResponseRegistrantContact.prototype['ContactType'] = undefined;

/**
 * @member {String} OrganizationName
 */
GetDomainDetailResponseRegistrantContact.prototype['OrganizationName'] = undefined;

/**
 * @member {String} AddressLine1
 */
GetDomainDetailResponseRegistrantContact.prototype['AddressLine1'] = undefined;

/**
 * @member {String} AddressLine2
 */
GetDomainDetailResponseRegistrantContact.prototype['AddressLine2'] = undefined;

/**
 * @member {String} City
 */
GetDomainDetailResponseRegistrantContact.prototype['City'] = undefined;

/**
 * @member {String} State
 */
GetDomainDetailResponseRegistrantContact.prototype['State'] = undefined;

/**
 * @member {module:model/CountryCode} CountryCode
 */
GetDomainDetailResponseRegistrantContact.prototype['CountryCode'] = undefined;

/**
 * @member {String} ZipCode
 */
GetDomainDetailResponseRegistrantContact.prototype['ZipCode'] = undefined;

/**
 * @member {String} PhoneNumber
 */
GetDomainDetailResponseRegistrantContact.prototype['PhoneNumber'] = undefined;

/**
 * @member {String} Email
 */
GetDomainDetailResponseRegistrantContact.prototype['Email'] = undefined;

/**
 * @member {String} Fax
 */
GetDomainDetailResponseRegistrantContact.prototype['Fax'] = undefined;

/**
 * @member {Array} ExtraParams
 */
GetDomainDetailResponseRegistrantContact.prototype['ExtraParams'] = undefined;
...
export default GetDomainDetailResponseRegistrantContact;
