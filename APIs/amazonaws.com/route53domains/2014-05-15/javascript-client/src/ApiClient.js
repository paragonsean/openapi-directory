...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://route53domains.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://route53domains.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2014-05-15/Javascript'
        };
