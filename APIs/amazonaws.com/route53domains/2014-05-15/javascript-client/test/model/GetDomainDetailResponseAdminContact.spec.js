...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.GetDomainDetailResponseAdminContact();
  });
  ...
  describe('GetDomainDetailResponseAdminContact', function() {
    it('should create an instance of GetDomainDetailResponseAdminContact', function() {
      // uncomment below and update the code to test GetDomainDetailResponseAdminContact
      //var instance = new AmazonRoute53Domains.GetDomainDetailResponseAdminContact();
      //expect(instance).to.be.a(AmazonRoute53Domains.GetDomainDetailResponseAdminContact);
    });
