...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.BillingRecord();
  });
  ...
  describe('BillingRecord', function() {
    it('should create an instance of BillingRecord', function() {
      // uncomment below and update the code to test BillingRecord
      //var instance = new AmazonRoute53Domains.BillingRecord();
      //expect(instance).to.be.a(AmazonRoute53Domains.BillingRecord);
    });
    ...
    it('should have the property billDate (base name: "BillDate")', function() {
