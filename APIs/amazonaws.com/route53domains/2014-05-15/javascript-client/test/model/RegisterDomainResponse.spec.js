...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.RegisterDomainResponse();
  });
  ...
  describe('RegisterDomainResponse', function() {
    it('should create an instance of RegisterDomainResponse', function() {
      ...
      //var instance = new AmazonRoute53Domains.RegisterDomainResponse();
      //expect(instance).to.be.a(AmazonRoute53Domains.RegisterDomainResponse);
    });
