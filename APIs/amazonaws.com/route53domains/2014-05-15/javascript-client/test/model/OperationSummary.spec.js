...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.OperationSummary();
  });
  ...
  describe('OperationSummary', function() {
    it('should create an instance of OperationSummary', function() {
      ...
      //var instance = new AmazonRoute53Domains.OperationSummary();
      //expect(instance).to.be.a(AmazonRoute53Domains.OperationSummary);
    });
