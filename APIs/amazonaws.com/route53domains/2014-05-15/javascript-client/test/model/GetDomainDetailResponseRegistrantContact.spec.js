...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.GetDomainDetailResponseRegistrantContact();
  });
  ...
  describe('GetDomainDetailResponseRegistrantContact', function() {
    it('should create an instance of GetDomainDetailResponseRegistrantContact', function() {
      // uncomment below and update the code to test GetDomainDetailResponseRegistrantContact
      //var instance = new AmazonRoute53Domains.GetDomainDetailResponseRegistrantContact();
      //expect(instance).to.be.a(AmazonRoute53Domains.GetDomainDetailResponseRegistrantContact);
    });
