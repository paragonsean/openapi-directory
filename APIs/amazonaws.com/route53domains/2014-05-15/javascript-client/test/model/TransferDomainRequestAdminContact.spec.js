...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.TransferDomainRequestAdminContact();
  });
  ...
  describe('TransferDomainRequestAdminContact', function() {
    it('should create an instance of TransferDomainRequestAdminContact', function() {
      // uncomment below and update the code to test TransferDomainRequestAdminContact
      //var instance = new AmazonRoute53Domains.TransferDomainRequestAdminContact();
      //expect(instance).to.be.a(AmazonRoute53Domains.TransferDomainRequestAdminContact);
    });
