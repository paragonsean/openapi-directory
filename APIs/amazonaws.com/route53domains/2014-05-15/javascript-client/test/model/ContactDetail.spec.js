...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.ContactDetail();
  });
  ...
  describe('ContactDetail', function() {
    it('should create an instance of ContactDetail', function() {
      ...
      //var instance = new AmazonRoute53Domains.ContactDetail();
      //expect(instance).to.be.a(AmazonRoute53Domains.ContactDetail);
    });
