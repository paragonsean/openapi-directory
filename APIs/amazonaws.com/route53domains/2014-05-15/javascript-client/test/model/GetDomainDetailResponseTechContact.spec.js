...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonRoute53Domains.GetDomainDetailResponseTechContact();
  });
  ...
  describe('GetDomainDetailResponseTechContact', function() {
    it('should create an instance of GetDomainDetailResponseTechContact', function() {
      // uncomment below and update the code to test GetDomainDetailResponseTechContact
      //var instance = new AmazonRoute53Domains.GetDomainDetailResponseTechContact();
      //expect(instance).to.be.a(AmazonRoute53Domains.GetDomainDetailResponseTechContact);
    });
