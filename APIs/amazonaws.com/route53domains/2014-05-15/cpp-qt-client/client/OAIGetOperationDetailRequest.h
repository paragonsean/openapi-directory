...
/*
 * OAIGetOperationDetailRequest.h
 *
...
#ifndef OAIGetOperationDetailRequest_H
#define OAIGetOperationDetailRequest_H
...
class OAIGetOperationDetailRequest : public OAIObject {
public:
    OAIGetOperationDetailRequest();
    OAIGetOperationDetailRequest(QString json);
    ~OAIGetOperationDetailRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOperationDetailRequest)

#endif // OAIGetOperationDetailRequest_H
