...
/*
 * OAIGetOperationDetailResponse.h
 *
 * The GetOperationDetail response includes the following elements.
 */

#ifndef OAIGetOperationDetailResponse_H
#define OAIGetOperationDetailResponse_H
...
class OAIGetOperationDetailResponse : public OAIObject {
public:
    OAIGetOperationDetailResponse();
    OAIGetOperationDetailResponse(QString json);
    ~OAIGetOperationDetailResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOperationDetailResponse)

#endif // OAIGetOperationDetailResponse_H
