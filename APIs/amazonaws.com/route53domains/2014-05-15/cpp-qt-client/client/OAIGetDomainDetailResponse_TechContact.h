...
/*
 * OAIGetDomainDetailResponse_TechContact.h
 *
 * 
 */

#ifndef OAIGetDomainDetailResponse_TechContact_H
#define OAIGetDomainDetailResponse_TechContact_H
...
class OAIGetDomainDetailResponse_TechContact : public OAIObject {
public:
    OAIGetDomainDetailResponse_TechContact();
    OAIGetDomainDetailResponse_TechContact(QString json);
    ~OAIGetDomainDetailResponse_TechContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDomainDetailResponse_TechContact)

#endif // OAIGetDomainDetailResponse_TechContact_H
