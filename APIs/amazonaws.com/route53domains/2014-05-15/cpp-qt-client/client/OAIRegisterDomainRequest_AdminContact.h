...
/*
 * OAIRegisterDomainRequest_AdminContact.h
 *
 * 
 */

#ifndef OAIRegisterDomainRequest_AdminContact_H
#define OAIRegisterDomainRequest_AdminContact_H
...
class OAIRegisterDomainRequest_AdminContact : public OAIObject {
public:
    OAIRegisterDomainRequest_AdminContact();
    OAIRegisterDomainRequest_AdminContact(QString json);
    ~OAIRegisterDomainRequest_AdminContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegisterDomainRequest_AdminContact)

#endif // OAIRegisterDomainRequest_AdminContact_H
