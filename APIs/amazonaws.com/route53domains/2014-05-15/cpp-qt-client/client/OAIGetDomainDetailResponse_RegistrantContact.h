...
/*
 * OAIGetDomainDetailResponse_RegistrantContact.h
 *
 * 
 */

#ifndef OAIGetDomainDetailResponse_RegistrantContact_H
#define OAIGetDomainDetailResponse_RegistrantContact_H
...
class OAIGetDomainDetailResponse_RegistrantContact : public OAIObject {
public:
    OAIGetDomainDetailResponse_RegistrantContact();
    OAIGetDomainDetailResponse_RegistrantContact(QString json);
    ~OAIGetDomainDetailResponse_RegistrantContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetDomainDetailResponse_RegistrantContact)

#endif // OAIGetDomainDetailResponse_RegistrantContact_H
