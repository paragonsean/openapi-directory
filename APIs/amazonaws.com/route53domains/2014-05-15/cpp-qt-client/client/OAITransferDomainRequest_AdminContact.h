...
/*
 * OAITransferDomainRequest_AdminContact.h
 *
 * 
 */

#ifndef OAITransferDomainRequest_AdminContact_H
#define OAITransferDomainRequest_AdminContact_H
...
class OAITransferDomainRequest_AdminContact : public OAIObject {
public:
    OAITransferDomainRequest_AdminContact();
    OAITransferDomainRequest_AdminContact(QString json);
    ~OAITransferDomainRequest_AdminContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITransferDomainRequest_AdminContact)

#endif // OAITransferDomainRequest_AdminContact_H
