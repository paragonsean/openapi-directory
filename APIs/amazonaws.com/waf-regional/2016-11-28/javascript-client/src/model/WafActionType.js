...
* @readonly
*/
export default class WafActionType {
    ...
    /**
    * Returns a <code>WafActionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WafActionType} The enum <code>WafActionType</code> value.
    */
