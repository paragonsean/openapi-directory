...
export default class RateKey {
    ...
    /**
    * Returns a <code>RateKey</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RateKey} The enum <code>RateKey</code> value.
    */
