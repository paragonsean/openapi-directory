...
* @readonly
*/
export default class WafOverrideActionType {
    ...
    /**
    * Returns a <code>WafOverrideActionType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WafOverrideActionType} The enum <code>WafOverrideActionType</code> value.
    */
