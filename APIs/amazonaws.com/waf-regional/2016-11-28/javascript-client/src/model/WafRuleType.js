...
* @readonly
*/
export default class WafRuleType {
    ...
    /**
    * Returns a <code>WafRuleType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WafRuleType} The enum <code>WafRuleType</code> value.
    */
