...
* @readonly
*/
export default class GeoMatchConstraintType {
    ...
    /**
    * Returns a <code>GeoMatchConstraintType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GeoMatchConstraintType} The enum <code>GeoMatchConstraintType</code> value.
    */
