...
/**
 * The ListWebACLsRequest model module.
 * @module model/ListWebACLsRequest
 * @version 2016-11-28
 */
class ListWebACLsRequest {
    /**
     * Constructs a new <code>ListWebACLsRequest</code>.
     * @alias module:model/ListWebACLsRequest
     */
    constructor() { 
        
        ListWebACLsRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListWebACLsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListWebACLsRequest} obj Optional instance to populate.
     * @return {module:model/ListWebACLsRequest} The populated <code>ListWebACLsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListWebACLsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ListWebACLsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListWebACLsRequest</code>.
     */
 ...
 */
ListWebACLsRequest.prototype['NextMarker'] = undefined;

/**
 * @member {Number} Limit
 */
ListWebACLsRequest.prototype['Limit'] = undefined;
...
export default ListWebACLsRequest;
