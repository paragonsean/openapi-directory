...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.ActivatedRuleAction();
  });
  ...
  describe('ActivatedRuleAction', function() {
    it('should create an instance of ActivatedRuleAction', function() {
      // uncomment below and update the code to test ActivatedRuleAction
      //var instance = new AwsWafRegional.ActivatedRuleAction();
      //expect(instance).to.be.a(AwsWafRegional.ActivatedRuleAction);
    });
