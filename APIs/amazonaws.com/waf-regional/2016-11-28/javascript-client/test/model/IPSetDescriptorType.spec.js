...
(function(root, factory) {
  ...
  describe('IPSetDescriptorType', function() {
    it('should create an instance of IPSetDescriptorType', function() {
      // uncomment below and update the code to test IPSetDescriptorType
      //var instance = new AwsWafRegional.IPSetDescriptorType();
      //expect(instance).to.be.a(AwsWafRegional.IPSetDescriptorType);
    });
