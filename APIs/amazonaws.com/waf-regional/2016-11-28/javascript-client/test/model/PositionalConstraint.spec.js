...
(function(root, factory) {
  ...
  describe('PositionalConstraint', function() {
    it('should create an instance of PositionalConstraint', function() {
      // uncomment below and update the code to test PositionalConstraint
      //var instance = new AwsWafRegional.PositionalConstraint();
      //expect(instance).to.be.a(AwsWafRegional.PositionalConstraint);
    });
