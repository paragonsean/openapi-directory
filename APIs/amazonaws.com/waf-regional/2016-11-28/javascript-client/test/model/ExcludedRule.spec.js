...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.ExcludedRule();
  });
  ...
  describe('ExcludedRule', function() {
    it('should create an instance of ExcludedRule', function() {
      // uncomment below and update the code to test ExcludedRule
      //var instance = new AwsWafRegional.ExcludedRule();
      //expect(instance).to.be.a(AwsWafRegional.ExcludedRule);
    });
