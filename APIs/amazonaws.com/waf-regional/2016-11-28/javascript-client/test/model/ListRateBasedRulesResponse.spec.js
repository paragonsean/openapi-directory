...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.ListRateBasedRulesResponse();
  });
  ...
  describe('ListRateBasedRulesResponse', function() {
    it('should create an instance of ListRateBasedRulesResponse', function() {
      // uncomment below and update the code to test ListRateBasedRulesResponse
      //var instance = new AwsWafRegional.ListRateBasedRulesResponse();
      //expect(instance).to.be.a(AwsWafRegional.ListRateBasedRulesResponse);
    });
