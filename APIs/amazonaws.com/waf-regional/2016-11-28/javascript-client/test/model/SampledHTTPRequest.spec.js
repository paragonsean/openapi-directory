...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.SampledHTTPRequest();
  });
  ...
  describe('SampledHTTPRequest', function() {
    it('should create an instance of SampledHTTPRequest', function() {
      ...
      //var instance = new AwsWafRegional.SampledHTTPRequest();
      //expect(instance).to.be.a(AwsWafRegional.SampledHTTPRequest);
    });
