...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.CreateRateBasedRuleResponseRule();
  });
  ...
  describe('CreateRateBasedRuleResponseRule', function() {
    it('should create an instance of CreateRateBasedRuleResponseRule', function() {
      // uncomment below and update the code to test CreateRateBasedRuleResponseRule
      //var instance = new AwsWafRegional.CreateRateBasedRuleResponseRule();
      //expect(instance).to.be.a(AwsWafRegional.CreateRateBasedRuleResponseRule);
    });
