...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.RuleUpdatePredicate();
  });
  ...
  describe('RuleUpdatePredicate', function() {
    it('should create an instance of RuleUpdatePredicate', function() {
      ...
      //var instance = new AwsWafRegional.RuleUpdatePredicate();
      //expect(instance).to.be.a(AwsWafRegional.RuleUpdatePredicate);
    });
