...
(function(root, factory) {
  ...
  describe('PredicateType', function() {
    it('should create an instance of PredicateType', function() {
      // uncomment below and update the code to test PredicateType
      //var instance = new AwsWafRegional.PredicateType();
      //expect(instance).to.be.a(AwsWafRegional.PredicateType);
    });
