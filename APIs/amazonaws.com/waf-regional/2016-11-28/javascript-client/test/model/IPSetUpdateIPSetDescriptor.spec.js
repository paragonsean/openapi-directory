...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.IPSetUpdateIPSetDescriptor();
  });
  ...
  describe('IPSetUpdateIPSetDescriptor', function() {
    it('should create an instance of IPSetUpdateIPSetDescriptor', function() {
      // uncomment below and update the code to test IPSetUpdateIPSetDescriptor
      //var instance = new AwsWafRegional.IPSetUpdateIPSetDescriptor();
      //expect(instance).to.be.a(AwsWafRegional.IPSetUpdateIPSetDescriptor);
    });
