...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetLoggingConfigurationRequest();
  });
  ...
  describe('GetLoggingConfigurationRequest', function() {
    it('should create an instance of GetLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test GetLoggingConfigurationRequest
      //var instance = new AwsWafRegional.GetLoggingConfigurationRequest();
      //expect(instance).to.be.a(AwsWafRegional.GetLoggingConfigurationRequest);
    });
