...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.WafOverrideAction();
  });
  ...
  describe('WafOverrideAction', function() {
    it('should create an instance of WafOverrideAction', function() {
      // uncomment below and update the code to test WafOverrideAction
      //var instance = new AwsWafRegional.WafOverrideAction();
      //expect(instance).to.be.a(AwsWafRegional.WafOverrideAction);
    });
