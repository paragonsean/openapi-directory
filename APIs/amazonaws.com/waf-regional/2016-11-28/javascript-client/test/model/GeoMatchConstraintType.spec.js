...
(function(root, factory) {
  ...
  describe('GeoMatchConstraintType', function() {
    it('should create an instance of GeoMatchConstraintType', function() {
      // uncomment below and update the code to test GeoMatchConstraintType
      //var instance = new AwsWafRegional.GeoMatchConstraintType();
      //expect(instance).to.be.a(AwsWafRegional.GeoMatchConstraintType);
    });
