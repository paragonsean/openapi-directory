...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.CreateRuleResponseRule();
  });
  ...
  describe('CreateRuleResponseRule', function() {
    it('should create an instance of CreateRuleResponseRule', function() {
      ...
      //var instance = new AwsWafRegional.CreateRuleResponseRule();
      //expect(instance).to.be.a(AwsWafRegional.CreateRuleResponseRule);
    });
