...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.ListResourcesForWebACLRequest();
  });
  ...
  describe('ListResourcesForWebACLRequest', function() {
    it('should create an instance of ListResourcesForWebACLRequest', function() {
      // uncomment below and update the code to test ListResourcesForWebACLRequest
      //var instance = new AwsWafRegional.ListResourcesForWebACLRequest();
      //expect(instance).to.be.a(AwsWafRegional.ListResourcesForWebACLRequest);
    });
