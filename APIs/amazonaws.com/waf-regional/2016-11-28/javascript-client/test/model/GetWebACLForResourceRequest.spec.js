...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetWebACLForResourceRequest();
  });
  ...
  describe('GetWebACLForResourceRequest', function() {
    it('should create an instance of GetWebACLForResourceRequest', function() {
      // uncomment below and update the code to test GetWebACLForResourceRequest
      //var instance = new AwsWafRegional.GetWebACLForResourceRequest();
      //expect(instance).to.be.a(AwsWafRegional.GetWebACLForResourceRequest);
    });
