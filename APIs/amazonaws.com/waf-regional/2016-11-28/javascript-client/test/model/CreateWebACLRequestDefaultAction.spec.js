...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.CreateWebACLRequestDefaultAction();
  });
  ...
  describe('CreateWebACLRequestDefaultAction', function() {
    it('should create an instance of CreateWebACLRequestDefaultAction', function() {
      // uncomment below and update the code to test CreateWebACLRequestDefaultAction
      //var instance = new AwsWafRegional.CreateWebACLRequestDefaultAction();
      //expect(instance).to.be.a(AwsWafRegional.CreateWebACLRequestDefaultAction);
    });
