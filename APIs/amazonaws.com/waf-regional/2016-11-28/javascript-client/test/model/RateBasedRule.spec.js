...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.RateBasedRule();
  });
  ...
  describe('RateBasedRule', function() {
    it('should create an instance of RateBasedRule', function() {
      // uncomment below and update the code to test RateBasedRule
      //var instance = new AwsWafRegional.RateBasedRule();
      //expect(instance).to.be.a(AwsWafRegional.RateBasedRule);
    });
