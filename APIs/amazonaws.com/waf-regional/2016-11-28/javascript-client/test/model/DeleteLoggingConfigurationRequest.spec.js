...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.DeleteLoggingConfigurationRequest();
  });
  ...
  describe('DeleteLoggingConfigurationRequest', function() {
    it('should create an instance of DeleteLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test DeleteLoggingConfigurationRequest
      //var instance = new AwsWafRegional.DeleteLoggingConfigurationRequest();
      //expect(instance).to.be.a(AwsWafRegional.DeleteLoggingConfigurationRequest);
    });
