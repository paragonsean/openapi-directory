...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.FieldToMatch();
  });
  ...
  describe('FieldToMatch', function() {
    it('should create an instance of FieldToMatch', function() {
      // uncomment below and update the code to test FieldToMatch
      //var instance = new AwsWafRegional.FieldToMatch();
      //expect(instance).to.be.a(AwsWafRegional.FieldToMatch);
    });
