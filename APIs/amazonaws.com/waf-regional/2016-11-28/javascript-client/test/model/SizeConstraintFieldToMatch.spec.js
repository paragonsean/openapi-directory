...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.SizeConstraintFieldToMatch();
  });
  ...
  describe('SizeConstraintFieldToMatch', function() {
    it('should create an instance of SizeConstraintFieldToMatch', function() {
      // uncomment below and update the code to test SizeConstraintFieldToMatch
      //var instance = new AwsWafRegional.SizeConstraintFieldToMatch();
      //expect(instance).to.be.a(AwsWafRegional.SizeConstraintFieldToMatch);
    });
