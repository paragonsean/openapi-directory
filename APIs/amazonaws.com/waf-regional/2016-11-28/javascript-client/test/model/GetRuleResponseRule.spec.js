...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetRuleResponseRule();
  });
  ...
  describe('GetRuleResponseRule', function() {
    it('should create an instance of GetRuleResponseRule', function() {
      ...
      //var instance = new AwsWafRegional.GetRuleResponseRule();
      //expect(instance).to.be.a(AwsWafRegional.GetRuleResponseRule);
    });
