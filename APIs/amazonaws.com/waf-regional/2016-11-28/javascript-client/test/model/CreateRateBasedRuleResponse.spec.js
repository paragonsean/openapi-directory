...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.CreateRateBasedRuleResponse();
  });
  ...
  describe('CreateRateBasedRuleResponse', function() {
    it('should create an instance of CreateRateBasedRuleResponse', function() {
      // uncomment below and update the code to test CreateRateBasedRuleResponse
      //var instance = new AwsWafRegional.CreateRateBasedRuleResponse();
      //expect(instance).to.be.a(AwsWafRegional.CreateRateBasedRuleResponse);
    });
