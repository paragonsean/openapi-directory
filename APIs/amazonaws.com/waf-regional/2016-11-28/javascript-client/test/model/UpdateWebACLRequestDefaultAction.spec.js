...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.UpdateWebACLRequestDefaultAction();
  });
  ...
  describe('UpdateWebACLRequestDefaultAction', function() {
    it('should create an instance of UpdateWebACLRequestDefaultAction', function() {
      // uncomment below and update the code to test UpdateWebACLRequestDefaultAction
      //var instance = new AwsWafRegional.UpdateWebACLRequestDefaultAction();
      //expect(instance).to.be.a(AwsWafRegional.UpdateWebACLRequestDefaultAction);
    });
