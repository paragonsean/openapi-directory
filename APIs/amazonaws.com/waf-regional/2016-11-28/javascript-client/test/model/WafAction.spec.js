...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.WafAction();
  });
  ...
  describe('WafAction', function() {
    it('should create an instance of WafAction', function() {
      // uncomment below and update the code to test WafAction
      //var instance = new AwsWafRegional.WafAction();
      //expect(instance).to.be.a(AwsWafRegional.WafAction);
    });
