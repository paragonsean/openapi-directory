...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetRateBasedRuleRequest();
  });
  ...
  describe('GetRateBasedRuleRequest', function() {
    it('should create an instance of GetRateBasedRuleRequest', function() {
      ...
      //var instance = new AwsWafRegional.GetRateBasedRuleRequest();
      //expect(instance).to.be.a(AwsWafRegional.GetRateBasedRuleRequest);
    });
