...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.ListRulesResponse();
  });
  ...
  describe('ListRulesResponse', function() {
    it('should create an instance of ListRulesResponse', function() {
      // uncomment below and update the code to test ListRulesResponse
      //var instance = new AwsWafRegional.ListRulesResponse();
      //expect(instance).to.be.a(AwsWafRegional.ListRulesResponse);
    });
