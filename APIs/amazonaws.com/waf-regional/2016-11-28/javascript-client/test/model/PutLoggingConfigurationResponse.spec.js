...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.PutLoggingConfigurationResponse();
  });
  ...
  describe('PutLoggingConfigurationResponse', function() {
    it('should create an instance of PutLoggingConfigurationResponse', function() {
      // uncomment below and update the code to test PutLoggingConfigurationResponse
      //var instance = new AwsWafRegional.PutLoggingConfigurationResponse();
      //expect(instance).to.be.a(AwsWafRegional.PutLoggingConfigurationResponse);
    });
