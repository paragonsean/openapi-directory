...
(function(root, factory) {
  ...
  describe('WafOverrideActionType', function() {
    it('should create an instance of WafOverrideActionType', function() {
      // uncomment below and update the code to test WafOverrideActionType
      //var instance = new AwsWafRegional.WafOverrideActionType();
      //expect(instance).to.be.a(AwsWafRegional.WafOverrideActionType);
    });
