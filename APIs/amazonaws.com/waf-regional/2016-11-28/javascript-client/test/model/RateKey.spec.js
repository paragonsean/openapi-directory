...
(function(root, factory) {
  ...
  describe('RateKey', function() {
    it('should create an instance of RateKey', function() {
      // uncomment below and update the code to test RateKey
      //var instance = new AwsWafRegional.RateKey();
      //expect(instance).to.be.a(AwsWafRegional.RateKey);
    });
