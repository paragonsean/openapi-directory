...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.TagInfoForResource();
  });
  ...
  describe('TagInfoForResource', function() {
    it('should create an instance of TagInfoForResource', function() {
      ...
      //var instance = new AwsWafRegional.TagInfoForResource();
      //expect(instance).to.be.a(AwsWafRegional.TagInfoForResource);
    });
