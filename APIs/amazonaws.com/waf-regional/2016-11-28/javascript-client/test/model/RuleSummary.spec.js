...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.RuleSummary();
  });
  ...
  describe('RuleSummary', function() {
    it('should create an instance of RuleSummary', function() {
      // uncomment below and update the code to test RuleSummary
      //var instance = new AwsWafRegional.RuleSummary();
      //expect(instance).to.be.a(AwsWafRegional.RuleSummary);
    });
