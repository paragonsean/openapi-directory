...
(function(root, factory) {
  ...
  describe('ChangeTokenStatus', function() {
    it('should create an instance of ChangeTokenStatus', function() {
      // uncomment below and update the code to test ChangeTokenStatus
      //var instance = new AwsWafRegional.ChangeTokenStatus();
      //expect(instance).to.be.a(AwsWafRegional.ChangeTokenStatus);
    });
