...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.ByteMatchTupleFieldToMatch();
  });
  ...
  describe('ByteMatchTupleFieldToMatch', function() {
    it('should create an instance of ByteMatchTupleFieldToMatch', function() {
      // uncomment below and update the code to test ByteMatchTupleFieldToMatch
      //var instance = new AwsWafRegional.ByteMatchTupleFieldToMatch();
      //expect(instance).to.be.a(AwsWafRegional.ByteMatchTupleFieldToMatch);
    });
