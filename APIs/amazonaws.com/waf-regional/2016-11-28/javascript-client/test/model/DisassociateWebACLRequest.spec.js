...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.DisassociateWebACLRequest();
  });
  ...
  describe('DisassociateWebACLRequest', function() {
    it('should create an instance of DisassociateWebACLRequest', function() {
      // uncomment below and update the code to test DisassociateWebACLRequest
      //var instance = new AwsWafRegional.DisassociateWebACLRequest();
      //expect(instance).to.be.a(AwsWafRegional.DisassociateWebACLRequest);
    });
