...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.SubscribedRuleGroupSummary();
  });
  ...
  describe('SubscribedRuleGroupSummary', function() {
    it('should create an instance of SubscribedRuleGroupSummary', function() {
      // uncomment below and update the code to test SubscribedRuleGroupSummary
      //var instance = new AwsWafRegional.SubscribedRuleGroupSummary();
      //expect(instance).to.be.a(AwsWafRegional.SubscribedRuleGroupSummary);
    });
