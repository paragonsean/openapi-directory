...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.DeleteRuleRequest();
  });
  ...
  describe('DeleteRuleRequest', function() {
    it('should create an instance of DeleteRuleRequest', function() {
      ...
      //var instance = new AwsWafRegional.DeleteRuleRequest();
      //expect(instance).to.be.a(AwsWafRegional.DeleteRuleRequest);
    });
