...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetRuleGroupResponse();
  });
  ...
  describe('GetRuleGroupResponse', function() {
    it('should create an instance of GetRuleGroupResponse', function() {
      // uncomment below and update the code to test GetRuleGroupResponse
      //var instance = new AwsWafRegional.GetRuleGroupResponse();
      //expect(instance).to.be.a(AwsWafRegional.GetRuleGroupResponse);
    });
