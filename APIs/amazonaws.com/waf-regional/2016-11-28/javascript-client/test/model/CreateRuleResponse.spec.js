...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.CreateRuleResponse();
  });
  ...
  describe('CreateRuleResponse', function() {
    it('should create an instance of CreateRuleResponse', function() {
      ...
      //var instance = new AwsWafRegional.CreateRuleResponse();
      //expect(instance).to.be.a(AwsWafRegional.CreateRuleResponse);
    });
