...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.UpdateRuleResponse();
  });
  ...
  describe('UpdateRuleResponse', function() {
    it('should create an instance of UpdateRuleResponse', function() {
      ...
      //var instance = new AwsWafRegional.UpdateRuleResponse();
      //expect(instance).to.be.a(AwsWafRegional.UpdateRuleResponse);
    });
