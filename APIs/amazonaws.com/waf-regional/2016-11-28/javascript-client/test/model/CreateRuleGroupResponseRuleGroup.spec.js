...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.CreateRuleGroupResponseRuleGroup();
  });
  ...
  describe('CreateRuleGroupResponseRuleGroup', function() {
    it('should create an instance of CreateRuleGroupResponseRuleGroup', function() {
      // uncomment below and update the code to test CreateRuleGroupResponseRuleGroup
      //var instance = new AwsWafRegional.CreateRuleGroupResponseRuleGroup();
      //expect(instance).to.be.a(AwsWafRegional.CreateRuleGroupResponseRuleGroup);
    });
