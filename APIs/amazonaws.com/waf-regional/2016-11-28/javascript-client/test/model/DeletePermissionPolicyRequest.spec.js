...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.DeletePermissionPolicyRequest();
  });
  ...
  describe('DeletePermissionPolicyRequest', function() {
    it('should create an instance of DeletePermissionPolicyRequest', function() {
      // uncomment below and update the code to test DeletePermissionPolicyRequest
      //var instance = new AwsWafRegional.DeletePermissionPolicyRequest();
      //expect(instance).to.be.a(AwsWafRegional.DeletePermissionPolicyRequest);
    });
