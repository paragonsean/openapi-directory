...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.AssociateWebACLRequest();
  });
  ...
  describe('AssociateWebACLRequest', function() {
    it('should create an instance of AssociateWebACLRequest', function() {
      // uncomment below and update the code to test AssociateWebACLRequest
      //var instance = new AwsWafRegional.AssociateWebACLRequest();
      //expect(instance).to.be.a(AwsWafRegional.AssociateWebACLRequest);
    });
