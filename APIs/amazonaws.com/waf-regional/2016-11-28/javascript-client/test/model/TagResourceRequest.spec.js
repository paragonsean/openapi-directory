...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.TagResourceRequest();
  });
  ...
  describe('TagResourceRequest', function() {
    it('should create an instance of TagResourceRequest', function() {
      ...
      //var instance = new AwsWafRegional.TagResourceRequest();
      //expect(instance).to.be.a(AwsWafRegional.TagResourceRequest);
    });
