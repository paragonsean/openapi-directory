...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.UpdateRateBasedRuleRequest();
  });
  ...
  describe('UpdateRateBasedRuleRequest', function() {
    it('should create an instance of UpdateRateBasedRuleRequest', function() {
      // uncomment below and update the code to test UpdateRateBasedRuleRequest
      //var instance = new AwsWafRegional.UpdateRateBasedRuleRequest();
      //expect(instance).to.be.a(AwsWafRegional.UpdateRateBasedRuleRequest);
    });
