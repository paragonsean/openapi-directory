...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.UpdateRuleRequest();
  });
  ...
  describe('UpdateRuleRequest', function() {
    it('should create an instance of UpdateRuleRequest', function() {
      ...
      //var instance = new AwsWafRegional.UpdateRuleRequest();
      //expect(instance).to.be.a(AwsWafRegional.UpdateRuleRequest);
    });
