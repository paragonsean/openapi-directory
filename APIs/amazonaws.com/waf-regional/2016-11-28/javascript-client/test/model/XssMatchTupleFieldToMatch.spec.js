...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.XssMatchTupleFieldToMatch();
  });
  ...
  describe('XssMatchTupleFieldToMatch', function() {
    it('should create an instance of XssMatchTupleFieldToMatch', function() {
      // uncomment below and update the code to test XssMatchTupleFieldToMatch
      //var instance = new AwsWafRegional.XssMatchTupleFieldToMatch();
      //expect(instance).to.be.a(AwsWafRegional.XssMatchTupleFieldToMatch);
    });
