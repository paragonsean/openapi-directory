...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.WebACL();
  });
  ...
  describe('WebACL', function() {
    it('should create an instance of WebACL', function() {
      // uncomment below and update the code to test WebACL
      //var instance = new AwsWafRegional.WebACL();
      //expect(instance).to.be.a(AwsWafRegional.WebACL);
    });
