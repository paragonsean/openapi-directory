...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.RegexMatchTupleFieldToMatch();
  });
  ...
  describe('RegexMatchTupleFieldToMatch', function() {
    it('should create an instance of RegexMatchTupleFieldToMatch', function() {
      // uncomment below and update the code to test RegexMatchTupleFieldToMatch
      //var instance = new AwsWafRegional.RegexMatchTupleFieldToMatch();
      //expect(instance).to.be.a(AwsWafRegional.RegexMatchTupleFieldToMatch);
    });
