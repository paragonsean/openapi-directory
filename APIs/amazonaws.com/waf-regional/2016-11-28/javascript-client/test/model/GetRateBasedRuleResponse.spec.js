...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetRateBasedRuleResponse();
  });
  ...
  describe('GetRateBasedRuleResponse', function() {
    it('should create an instance of GetRateBasedRuleResponse', function() {
      // uncomment below and update the code to test GetRateBasedRuleResponse
      //var instance = new AwsWafRegional.GetRateBasedRuleResponse();
      //expect(instance).to.be.a(AwsWafRegional.GetRateBasedRuleResponse);
    });
