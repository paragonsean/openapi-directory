...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GeoMatchConstraint();
  });
  ...
  describe('GeoMatchConstraint', function() {
    it('should create an instance of GeoMatchConstraint', function() {
      // uncomment below and update the code to test GeoMatchConstraint
      //var instance = new AwsWafRegional.GeoMatchConstraint();
      //expect(instance).to.be.a(AwsWafRegional.GeoMatchConstraint);
    });
