...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.GetPermissionPolicyResponse();
  });
  ...
  describe('GetPermissionPolicyResponse', function() {
    it('should create an instance of GetPermissionPolicyResponse', function() {
      // uncomment below and update the code to test GetPermissionPolicyResponse
      //var instance = new AwsWafRegional.GetPermissionPolicyResponse();
      //expect(instance).to.be.a(AwsWafRegional.GetPermissionPolicyResponse);
    });
