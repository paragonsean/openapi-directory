...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsWafRegional.PutLoggingConfigurationRequest();
  });
  ...
  describe('PutLoggingConfigurationRequest', function() {
    it('should create an instance of PutLoggingConfigurationRequest', function() {
      // uncomment below and update the code to test PutLoggingConfigurationRequest
      //var instance = new AwsWafRegional.PutLoggingConfigurationRequest();
      //expect(instance).to.be.a(AwsWafRegional.PutLoggingConfigurationRequest);
    });
