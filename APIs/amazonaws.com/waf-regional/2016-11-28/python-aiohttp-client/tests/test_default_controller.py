...
async def test_associate_web_acl(client):
    """Test case for associate_web_acl

    
    """
    body = {"ResourceArn":"","WebACLId":""}
    headers = { 
...
async def test_create_byte_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateByteMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_geo_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateGeoMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_ip_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateIPSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_rate_based_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateRateBasedRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_regex_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateRegexMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_regex_pattern_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateRegexPatternSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_rule_group(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateRuleGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_size_constraint_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateSizeConstraintSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_sql_injection_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateSqlInjectionMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_web_acl(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateWebACL',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_web_acl_migration_stack(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateWebACLMigrationStack',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_xss_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.CreateXssMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_byte_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteByteMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_geo_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteGeoMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_ip_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteIPSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_logging_configuration(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteLoggingConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_permission_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeletePermissionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_rate_based_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteRateBasedRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_regex_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteRegexMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_rule_group(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteRuleGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_size_constraint_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteSizeConstraintSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_sql_injection_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteSqlInjectionMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_web_acl(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DeleteWebACL',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_disassociate_web_acl(client):
    """Test case for disassociate_web_acl
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.DisassociateWebACL',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_byte_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetByteMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_change_token(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetChangeToken',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_change_token_status(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetChangeTokenStatus',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_geo_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetGeoMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_ip_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetIPSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_logging_configuration(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetLoggingConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_permission_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetPermissionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_rate_based_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetRateBasedRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_rate_based_rule_managed_keys(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetRateBasedRuleManagedKeys',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_regex_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetRegexMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_rule_group(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetRuleGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_sampled_requests(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetSampledRequests',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_size_constraint_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetSizeConstraintSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_sql_injection_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetSqlInjectionMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_web_acl(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetWebACL',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_web_acl_for_resource(client):
    """Test case for get_web_acl_for_resource
...
async def test_get_xss_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.GetXssMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_activated_rules_in_rule_group(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListActivatedRulesInRuleGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_byte_match_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListByteMatchSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_geo_match_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListGeoMatchSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_ip_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListIPSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_logging_configurations(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListLoggingConfigurations',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_regex_match_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListRegexMatchSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_regex_pattern_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListRegexPatternSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_resources_for_web_acl(client):
    """Test case for list_resources_for_web_acl

    
    """
    body = {"ResourceType":"","WebACLId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListResourcesForWebACL',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_rule_groups(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListRuleGroups',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_rules(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListRules',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_size_constraint_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListSizeConstraintSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_sql_injection_match_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListSqlInjectionMatchSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_tags_for_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListTagsForResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_web_acls(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListWebACLs',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_xss_match_sets(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.ListXssMatchSets',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_logging_configuration(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.PutLoggingConfiguration',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_put_permission_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.PutPermissionPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_tag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.TagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_untag_resource(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UntagResource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_byte_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateByteMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_geo_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateGeoMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_ip_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateIPSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_rate_based_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateRateBasedRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_regex_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateRegexMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_rule(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateRule',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_rule_group(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateRuleGroup',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_size_constraint_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateSizeConstraintSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_sql_injection_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateSqlInjectionMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_web_acl(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateWebACL',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_xss_match_set(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=AWSWAF_Regional_20161128.UpdateXssMatchSet',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
