...
/*
 * OAIDeleteWebACLRequest.h
 *
 * 
 */

#ifndef OAIDeleteWebACLRequest_H
#define OAIDeleteWebACLRequest_H
...
class OAIDeleteWebACLRequest : public OAIObject {
public:
    OAIDeleteWebACLRequest();
    OAIDeleteWebACLRequest(QString json);
    ~OAIDeleteWebACLRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteWebACLRequest)

#endif // OAIDeleteWebACLRequest_H
