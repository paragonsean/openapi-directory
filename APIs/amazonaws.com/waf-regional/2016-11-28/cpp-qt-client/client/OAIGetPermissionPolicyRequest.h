...
/*
 * OAIGetPermissionPolicyRequest.h
 *
 * 
 */

#ifndef OAIGetPermissionPolicyRequest_H
#define OAIGetPermissionPolicyRequest_H
...
class OAIGetPermissionPolicyRequest : public OAIObject {
public:
    OAIGetPermissionPolicyRequest();
    OAIGetPermissionPolicyRequest(QString json);
    ~OAIGetPermissionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPermissionPolicyRequest)

#endif // OAIGetPermissionPolicyRequest_H
