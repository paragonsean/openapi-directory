...
OAIListRuleGroupsResponse::OAIListRuleGroupsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListRuleGroupsResponse::OAIListRuleGroupsResponse() {
    this->initializeModel();
}

OAIListRuleGroupsResponse::~OAIListRuleGroupsResponse() {}

void OAIListRuleGroupsResponse::initializeModel() {
...
void OAIListRuleGroupsResponse::fromJson(QString jsonString) {
...
void OAIListRuleGroupsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIListRuleGroupsResponse::asJson() const {
...
QJsonObject OAIListRuleGroupsResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListRuleGroupsResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListRuleGroupsResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListRuleGroupsResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListRuleGroupsResponse::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

QList OAIListRuleGroupsResponse::getRuleGroups() const {
    return m_rule_groups;
}
void OAIListRuleGroupsResponse::setRuleGroups(const QList &rule_groups) {
    m_rule_groups = rule_groups;
    m_rule_groups_isSet = true;
}

bool OAIListRuleGroupsResponse::is_rule_groups_Set() const{
    return m_rule_groups_isSet;
}

bool OAIListRuleGroupsResponse::is_rule_groups_Valid() const{
    return m_rule_groups_isValid;
}

bool OAIListRuleGroupsResponse::isSet() const {
...
bool OAIListRuleGroupsResponse::isValid() const {
