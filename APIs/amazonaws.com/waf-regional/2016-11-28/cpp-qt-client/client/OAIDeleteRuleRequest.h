...
/*
 * OAIDeleteRuleRequest.h
 *
 * 
 */

#ifndef OAIDeleteRuleRequest_H
#define OAIDeleteRuleRequest_H
...
class OAIDeleteRuleRequest : public OAIObject {
public:
    OAIDeleteRuleRequest();
    OAIDeleteRuleRequest(QString json);
    ~OAIDeleteRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteRuleRequest)

#endif // OAIDeleteRuleRequest_H
