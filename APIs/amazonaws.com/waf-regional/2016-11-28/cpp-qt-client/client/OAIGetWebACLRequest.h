...
/*
 * OAIGetWebACLRequest.h
 *
 * 
 */

#ifndef OAIGetWebACLRequest_H
#define OAIGetWebACLRequest_H
...
class OAIGetWebACLRequest : public OAIObject {
public:
    OAIGetWebACLRequest();
    OAIGetWebACLRequest(QString json);
    ~OAIGetWebACLRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWebACLRequest)

#endif // OAIGetWebACLRequest_H
