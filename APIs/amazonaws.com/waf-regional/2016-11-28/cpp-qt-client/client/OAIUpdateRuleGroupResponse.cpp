...
QString OAIUpdateRuleGroupResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateRuleGroupResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateRuleGroupResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateRuleGroupResponse::is_change_token_Valid() const{
