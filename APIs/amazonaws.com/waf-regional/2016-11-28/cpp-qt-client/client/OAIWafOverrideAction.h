...
#ifndef OAIWafOverrideAction_H
#define OAIWafOverrideAction_H
...
class OAIWafOverrideAction : public OAIObject {
public:
    OAIWafOverrideAction();
    OAIWafOverrideAction(QString json);
    ~OAIWafOverrideAction() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIWafOverrideAction)

#endif // OAIWafOverrideAction_H
