...
#ifndef OAIGeoMatchSetSummary_H
#define OAIGeoMatchSetSummary_H
...
class OAIGeoMatchSetSummary : public OAIObject {
public:
    OAIGeoMatchSetSummary();
    OAIGeoMatchSetSummary(QString json);
    ~OAIGeoMatchSetSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGeoMatchSetSummary)

#endif // OAIGeoMatchSetSummary_H
