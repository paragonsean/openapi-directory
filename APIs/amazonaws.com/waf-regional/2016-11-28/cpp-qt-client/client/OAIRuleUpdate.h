...
public:
    ...
    OAIRuleUpdate_Predicate getPredicate() const;
    void setPredicate(const OAIRuleUpdate_Predicate &predicate);
...
private:
    ...
    OAIRuleUpdate_Predicate m_predicate;
