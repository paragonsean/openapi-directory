...
OAIUpdateSizeConstraintSetResponse::OAIUpdateSizeConstraintSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateSizeConstraintSetResponse::OAIUpdateSizeConstraintSetResponse() {
    this->initializeModel();
}

OAIUpdateSizeConstraintSetResponse::~OAIUpdateSizeConstraintSetResponse() {}

void OAIUpdateSizeConstraintSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateSizeConstraintSetResponse::fromJson(QString jsonString) {
...
void OAIUpdateSizeConstraintSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateSizeConstraintSetResponse::asJson() const {
...
QJsonObject OAIUpdateSizeConstraintSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateSizeConstraintSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateSizeConstraintSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateSizeConstraintSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateSizeConstraintSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateSizeConstraintSetResponse::isSet() const {
...
bool OAIUpdateSizeConstraintSetResponse::isValid() const {
