...
OAIGetRuleGroupRequest::OAIGetRuleGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRuleGroupRequest::OAIGetRuleGroupRequest() {
    this->initializeModel();
}

OAIGetRuleGroupRequest::~OAIGetRuleGroupRequest() {}

void OAIGetRuleGroupRequest::initializeModel() {

    m_rule_group_id_isSet = false;
    m_rule_group_id_isValid = false;
}

void OAIGetRuleGroupRequest::fromJson(QString jsonString) {
...
void OAIGetRuleGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetRuleGroupRequest::asJson() const {
...
QJsonObject OAIGetRuleGroupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetRuleGroupRequest::getRuleGroupId() const {
    return m_rule_group_id;
}
void OAIGetRuleGroupRequest::setRuleGroupId(const QString &rule_group_id) {
    m_rule_group_id = rule_group_id;
    m_rule_group_id_isSet = true;
}

bool OAIGetRuleGroupRequest::is_rule_group_id_Set() const{
    return m_rule_group_id_isSet;
}

bool OAIGetRuleGroupRequest::is_rule_group_id_Valid() const{
    return m_rule_group_id_isValid;
}

bool OAIGetRuleGroupRequest::isSet() const {
...
bool OAIGetRuleGroupRequest::isValid() const {
