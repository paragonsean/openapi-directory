...
/*
 * OAIPutPermissionPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutPermissionPolicyRequest_H
#define OAIPutPermissionPolicyRequest_H
...
class OAIPutPermissionPolicyRequest : public OAIObject {
public:
    OAIPutPermissionPolicyRequest();
    OAIPutPermissionPolicyRequest(QString json);
    ~OAIPutPermissionPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutPermissionPolicyRequest)

#endif // OAIPutPermissionPolicyRequest_H
