...
OAIDeleteSqlInjectionMatchSetResponse::OAIDeleteSqlInjectionMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteSqlInjectionMatchSetResponse::OAIDeleteSqlInjectionMatchSetResponse() {
    this->initializeModel();
}

OAIDeleteSqlInjectionMatchSetResponse::~OAIDeleteSqlInjectionMatchSetResponse() {}

void OAIDeleteSqlInjectionMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteSqlInjectionMatchSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteSqlInjectionMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteSqlInjectionMatchSetResponse::asJson() const {
...
QJsonObject OAIDeleteSqlInjectionMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteSqlInjectionMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteSqlInjectionMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteSqlInjectionMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteSqlInjectionMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteSqlInjectionMatchSetResponse::isSet() const {
...
bool OAIDeleteSqlInjectionMatchSetResponse::isValid() const {
