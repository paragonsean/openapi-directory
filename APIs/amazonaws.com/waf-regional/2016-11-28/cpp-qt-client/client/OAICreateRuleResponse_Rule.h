...
/*
 * OAICreateRuleResponse_Rule.h
 *
 * 
 */

#ifndef OAICreateRuleResponse_Rule_H
#define OAICreateRuleResponse_Rule_H
...
class OAICreateRuleResponse_Rule : public OAIObject {
public:
    OAICreateRuleResponse_Rule();
    OAICreateRuleResponse_Rule(QString json);
    ~OAICreateRuleResponse_Rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleResponse_Rule)

#endif // OAICreateRuleResponse_Rule_H
