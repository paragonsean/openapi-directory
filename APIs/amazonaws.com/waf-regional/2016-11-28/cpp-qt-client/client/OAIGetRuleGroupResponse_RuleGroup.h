...
/*
 * OAIGetRuleGroupResponse_RuleGroup.h
 *
 * 
 */

#ifndef OAIGetRuleGroupResponse_RuleGroup_H
#define OAIGetRuleGroupResponse_RuleGroup_H
...
class OAIGetRuleGroupResponse_RuleGroup : public OAIObject {
public:
    OAIGetRuleGroupResponse_RuleGroup();
    OAIGetRuleGroupResponse_RuleGroup(QString json);
    ~OAIGetRuleGroupResponse_RuleGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRuleGroupResponse_RuleGroup)

#endif // OAIGetRuleGroupResponse_RuleGroup_H
