...
/*
 * OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple.h
 *
 * 
 */

#ifndef OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple_H
#define OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple_H
...
class OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple : public OAIObject {
public:
    OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple();
    OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple(QString json);
    ~OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple)

#endif // OAISqlInjectionMatchSetUpdate_SqlInjectionMatchTuple_H
