...
/*
 * OAIGetWebACLResponse_WebACL.h
 *
 * 
 */

#ifndef OAIGetWebACLResponse_WebACL_H
#define OAIGetWebACLResponse_WebACL_H
...
class OAIGetWebACLResponse_WebACL : public OAIObject {
public:
    OAIGetWebACLResponse_WebACL();
    OAIGetWebACLResponse_WebACL(QString json);
    ~OAIGetWebACLResponse_WebACL() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWebACLResponse_WebACL)

#endif // OAIGetWebACLResponse_WebACL_H
