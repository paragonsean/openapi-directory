...
#ifndef OAISampledHTTPRequest_H
#define OAISampledHTTPRequest_H
...
namespace OpenAPI {
class OAISampledHTTPRequest_Request;

class OAISampledHTTPRequest : public OAIObject {
public:
    OAISampledHTTPRequest();
    OAISampledHTTPRequest(QString json);
    ~OAISampledHTTPRequest() override;
    ...
    OAISampledHTTPRequest_Request getRequest() const;
    void setRequest(const OAISampledHTTPRequest_Request &request);
    ...
    QString getRuleWithinRuleGroup() const;
    void setRuleWithinRuleGroup(const QString &rule_within_rule_group);
    bool is_rule_within_rule_group_Set() const;
    bool is_rule_within_rule_group_Valid() const;
...
private:
    ...
    OAISampledHTTPRequest_Request m_request;
    ...
    QString m_rule_within_rule_group;
    bool m_rule_within_rule_group_isSet;
    bool m_rule_within_rule_group_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISampledHTTPRequest)

#endif // OAISampledHTTPRequest_H
