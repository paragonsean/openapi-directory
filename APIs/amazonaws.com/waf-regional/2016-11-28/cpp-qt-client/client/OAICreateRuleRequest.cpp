...
QString OAICreateRuleRequest::getMetricName() const {
    return m_metric_name;
}
void OAICreateRuleRequest::setMetricName(const QString &metric_name) {
    m_metric_name = metric_name;
    m_metric_name_isSet = true;
}

bool OAICreateRuleRequest::is_metric_name_Set() const{
    return m_metric_name_isSet;
}

bool OAICreateRuleRequest::is_metric_name_Valid() const{
    return m_metric_name_isValid;
}

QString OAICreateRuleRequest::getChangeToken() const {
    return m_change_token;
}
void OAICreateRuleRequest::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAICreateRuleRequest::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAICreateRuleRequest::is_change_token_Valid() const{
