...
/*
 * OAIListGeoMatchSetsRequest.h
 *
 * 
 */

#ifndef OAIListGeoMatchSetsRequest_H
#define OAIListGeoMatchSetsRequest_H
...
class OAIListGeoMatchSetsRequest : public OAIObject {
public:
    OAIListGeoMatchSetsRequest();
    OAIListGeoMatchSetsRequest(QString json);
    ~OAIListGeoMatchSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListGeoMatchSetsRequest)

#endif // OAIListGeoMatchSetsRequest_H
