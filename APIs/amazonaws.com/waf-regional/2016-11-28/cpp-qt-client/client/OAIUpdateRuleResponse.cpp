...
QString OAIUpdateRuleResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateRuleResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateRuleResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateRuleResponse::is_change_token_Valid() const{
