...
/*
 * OAIListResourcesForWebACLRequest.h
 *
 * 
 */

#ifndef OAIListResourcesForWebACLRequest_H
#define OAIListResourcesForWebACLRequest_H
...
class OAIListResourcesForWebACLRequest : public OAIObject {
public:
    OAIListResourcesForWebACLRequest();
    OAIListResourcesForWebACLRequest(QString json);
    ~OAIListResourcesForWebACLRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourcesForWebACLRequest)

#endif // OAIListResourcesForWebACLRequest_H
