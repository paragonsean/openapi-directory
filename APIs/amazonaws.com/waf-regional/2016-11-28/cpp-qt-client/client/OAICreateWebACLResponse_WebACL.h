...
/*
 * OAICreateWebACLResponse_WebACL.h
 *
 * 
 */

#ifndef OAICreateWebACLResponse_WebACL_H
#define OAICreateWebACLResponse_WebACL_H
...
class OAICreateWebACLResponse_WebACL : public OAIObject {
public:
    OAICreateWebACLResponse_WebACL();
    OAICreateWebACLResponse_WebACL(QString json);
    ~OAICreateWebACLResponse_WebACL() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateWebACLResponse_WebACL)

#endif // OAICreateWebACLResponse_WebACL_H
