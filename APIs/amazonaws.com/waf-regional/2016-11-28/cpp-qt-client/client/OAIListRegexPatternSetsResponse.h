...
/*
 * OAIListRegexPatternSetsResponse.h
 *
 * 
 */

#ifndef OAIListRegexPatternSetsResponse_H
#define OAIListRegexPatternSetsResponse_H
...
class OAIListRegexPatternSetsResponse : public OAIObject {
public:
    OAIListRegexPatternSetsResponse();
    OAIListRegexPatternSetsResponse(QString json);
    ~OAIListRegexPatternSetsResponse() override;
    ...
    QList getRegexPatternSets() const;
    void setRegexPatternSets(const QList &regex_pattern_sets);
    bool is_regex_pattern_sets_Set() const;
    bool is_regex_pattern_sets_Valid() const;
...
private:
    ...
    QList m_regex_pattern_sets;
    bool m_regex_pattern_sets_isSet;
    bool m_regex_pattern_sets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListRegexPatternSetsResponse)

#endif // OAIListRegexPatternSetsResponse_H
