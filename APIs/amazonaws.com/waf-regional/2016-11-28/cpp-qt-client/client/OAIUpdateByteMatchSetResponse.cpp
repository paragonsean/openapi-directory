...
OAIUpdateByteMatchSetResponse::OAIUpdateByteMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateByteMatchSetResponse::OAIUpdateByteMatchSetResponse() {
    this->initializeModel();
}

OAIUpdateByteMatchSetResponse::~OAIUpdateByteMatchSetResponse() {}

void OAIUpdateByteMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateByteMatchSetResponse::fromJson(QString jsonString) {
...
void OAIUpdateByteMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateByteMatchSetResponse::asJson() const {
...
QJsonObject OAIUpdateByteMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateByteMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateByteMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateByteMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateByteMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateByteMatchSetResponse::isSet() const {
...
bool OAIUpdateByteMatchSetResponse::isValid() const {
