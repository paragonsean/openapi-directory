...
/*
 * OAIDeleteXssMatchSetResponse.h
 *
 * The response to a request to delete an &lt;a&gt;XssMatchSet&lt;/a&gt; from AWS WAF.
 */

#ifndef OAIDeleteXssMatchSetResponse_H
#define OAIDeleteXssMatchSetResponse_H
...
class OAIDeleteXssMatchSetResponse : public OAIObject {
public:
    OAIDeleteXssMatchSetResponse();
    OAIDeleteXssMatchSetResponse(QString json);
    ~OAIDeleteXssMatchSetResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteXssMatchSetResponse)

#endif // OAIDeleteXssMatchSetResponse_H
