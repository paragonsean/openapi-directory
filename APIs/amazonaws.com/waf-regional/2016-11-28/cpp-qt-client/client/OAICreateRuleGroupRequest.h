...
/*
 * OAICreateRuleGroupRequest.h
 *
 * 
 */

#ifndef OAICreateRuleGroupRequest_H
#define OAICreateRuleGroupRequest_H
...
class OAICreateRuleGroupRequest : public OAIObject {
public:
    OAICreateRuleGroupRequest();
    OAICreateRuleGroupRequest(QString json);
    ~OAICreateRuleGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateRuleGroupRequest)

#endif // OAICreateRuleGroupRequest_H
