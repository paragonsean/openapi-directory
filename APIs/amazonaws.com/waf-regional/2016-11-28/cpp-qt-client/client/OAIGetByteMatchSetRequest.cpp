...
OAIGetByteMatchSetRequest::OAIGetByteMatchSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetByteMatchSetRequest::OAIGetByteMatchSetRequest() {
    this->initializeModel();
}

OAIGetByteMatchSetRequest::~OAIGetByteMatchSetRequest() {}

void OAIGetByteMatchSetRequest::initializeModel() {

    m_byte_match_set_id_isSet = false;
    m_byte_match_set_id_isValid = false;
}

void OAIGetByteMatchSetRequest::fromJson(QString jsonString) {
...
void OAIGetByteMatchSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetByteMatchSetRequest::asJson() const {
...
QJsonObject OAIGetByteMatchSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetByteMatchSetRequest::getByteMatchSetId() const {
    return m_byte_match_set_id;
}
void OAIGetByteMatchSetRequest::setByteMatchSetId(const QString &byte_match_set_id) {
    m_byte_match_set_id = byte_match_set_id;
    m_byte_match_set_id_isSet = true;
}

bool OAIGetByteMatchSetRequest::is_byte_match_set_id_Set() const{
    return m_byte_match_set_id_isSet;
}

bool OAIGetByteMatchSetRequest::is_byte_match_set_id_Valid() const{
    return m_byte_match_set_id_isValid;
}

bool OAIGetByteMatchSetRequest::isSet() const {
...
bool OAIGetByteMatchSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_byte_match_set_id_isValid && true;
}
