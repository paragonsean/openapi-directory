...
/*
 * OAICreateIPSetRequest.h
 *
 * 
 */

#ifndef OAICreateIPSetRequest_H
#define OAICreateIPSetRequest_H
...
class OAICreateIPSetRequest : public OAIObject {
public:
    OAICreateIPSetRequest();
    OAICreateIPSetRequest(QString json);
    ~OAICreateIPSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIPSetRequest)

#endif // OAICreateIPSetRequest_H
