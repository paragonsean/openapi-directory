...
/*
 * OAIListSubscribedRuleGroupsResponse.h
 *
 * 
 */

#ifndef OAIListSubscribedRuleGroupsResponse_H
#define OAIListSubscribedRuleGroupsResponse_H
...
class OAIListSubscribedRuleGroupsResponse : public OAIObject {
public:
    OAIListSubscribedRuleGroupsResponse();
    OAIListSubscribedRuleGroupsResponse(QString json);
    ~OAIListSubscribedRuleGroupsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListSubscribedRuleGroupsResponse)

#endif // OAIListSubscribedRuleGroupsResponse_H
