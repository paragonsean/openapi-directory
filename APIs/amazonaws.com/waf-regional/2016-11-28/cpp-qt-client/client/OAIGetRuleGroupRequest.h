...
/*
 * OAIGetRuleGroupRequest.h
 *
 * 
 */

#ifndef OAIGetRuleGroupRequest_H
#define OAIGetRuleGroupRequest_H
...
class OAIGetRuleGroupRequest : public OAIObject {
public:
    OAIGetRuleGroupRequest();
    OAIGetRuleGroupRequest(QString json);
    ~OAIGetRuleGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRuleGroupRequest)

#endif // OAIGetRuleGroupRequest_H
