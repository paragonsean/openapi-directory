...
OAIGetRuleRequest::OAIGetRuleRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRuleRequest::OAIGetRuleRequest() {
    this->initializeModel();
}

OAIGetRuleRequest::~OAIGetRuleRequest() {}

void OAIGetRuleRequest::initializeModel() {

    m_rule_id_isSet = false;
    m_rule_id_isValid = false;
}

void OAIGetRuleRequest::fromJson(QString jsonString) {
...
void OAIGetRuleRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetRuleRequest::asJson() const {
...
QJsonObject OAIGetRuleRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_rule_id_isSet) {
...
QString OAIGetRuleRequest::getRuleId() const {
    return m_rule_id;
}
void OAIGetRuleRequest::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIGetRuleRequest::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIGetRuleRequest::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

bool OAIGetRuleRequest::isSet() const {
...
bool OAIGetRuleRequest::isValid() const {
