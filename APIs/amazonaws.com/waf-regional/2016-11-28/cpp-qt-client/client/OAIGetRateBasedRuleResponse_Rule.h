...
/*
 * OAIGetRateBasedRuleResponse_Rule.h
 *
 * 
 */

#ifndef OAIGetRateBasedRuleResponse_Rule_H
#define OAIGetRateBasedRuleResponse_Rule_H
...
class OAIGetRateBasedRuleResponse_Rule : public OAIObject {
public:
    OAIGetRateBasedRuleResponse_Rule();
    OAIGetRateBasedRuleResponse_Rule(QString json);
    ~OAIGetRateBasedRuleResponse_Rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRateBasedRuleResponse_Rule)

#endif // OAIGetRateBasedRuleResponse_Rule_H
