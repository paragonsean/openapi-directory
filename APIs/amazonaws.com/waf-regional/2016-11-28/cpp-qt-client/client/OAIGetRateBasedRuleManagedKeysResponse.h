...
/*
 * OAIGetRateBasedRuleManagedKeysResponse.h
 *
 * 
 */

#ifndef OAIGetRateBasedRuleManagedKeysResponse_H
#define OAIGetRateBasedRuleManagedKeysResponse_H
...
class OAIGetRateBasedRuleManagedKeysResponse : public OAIObject {
public:
    OAIGetRateBasedRuleManagedKeysResponse();
    OAIGetRateBasedRuleManagedKeysResponse(QString json);
    ~OAIGetRateBasedRuleManagedKeysResponse() override;
    ...
    QList getManagedKeys() const;
    void setManagedKeys(const QList &managed_keys);
    bool is_managed_keys_Set() const;
    bool is_managed_keys_Valid() const;
...
private:
    ...
    QList m_managed_keys;
    bool m_managed_keys_isSet;
    bool m_managed_keys_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRateBasedRuleManagedKeysResponse)

#endif // OAIGetRateBasedRuleManagedKeysResponse_H
