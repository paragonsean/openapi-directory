...
#ifndef OAIGetRuleRequest_H
#define OAIGetRuleRequest_H
...
class OAIGetRuleRequest : public OAIObject {
public:
    OAIGetRuleRequest();
    OAIGetRuleRequest(QString json);
    ~OAIGetRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRuleRequest)

#endif // OAIGetRuleRequest_H
