...
/*
 * OAIListWebACLsRequest.h
 *
 * 
 */

#ifndef OAIListWebACLsRequest_H
#define OAIListWebACLsRequest_H
...
class OAIListWebACLsRequest : public OAIObject {
public:
    OAIListWebACLsRequest();
    OAIListWebACLsRequest(QString json);
    ~OAIListWebACLsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListWebACLsRequest)

#endif // OAIListWebACLsRequest_H
