...
#ifndef OAIFieldToMatch_H
#define OAIFieldToMatch_H
...
class OAIFieldToMatch : public OAIObject {
public:
    OAIFieldToMatch();
    OAIFieldToMatch(QString json);
    ~OAIFieldToMatch() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFieldToMatch)

#endif // OAIFieldToMatch_H
