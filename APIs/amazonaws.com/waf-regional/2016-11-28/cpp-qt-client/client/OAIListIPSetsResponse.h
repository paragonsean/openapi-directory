...
/*
 * OAIListIPSetsResponse.h
 *
 * 
 */

#ifndef OAIListIPSetsResponse_H
#define OAIListIPSetsResponse_H
...
class OAIListIPSetsResponse : public OAIObject {
public:
    OAIListIPSetsResponse();
    OAIListIPSetsResponse(QString json);
    ~OAIListIPSetsResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIPSetsResponse)

#endif // OAIListIPSetsResponse_H
