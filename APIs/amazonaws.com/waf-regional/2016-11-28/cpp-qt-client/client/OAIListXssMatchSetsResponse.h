...
/*
 * OAIListXssMatchSetsResponse.h
 *
 * The response to a &lt;a&gt;ListXssMatchSets&lt;/a&gt; request.
 */

#ifndef OAIListXssMatchSetsResponse_H
#define OAIListXssMatchSetsResponse_H
...
class OAIListXssMatchSetsResponse : public OAIObject {
public:
    OAIListXssMatchSetsResponse();
    OAIListXssMatchSetsResponse(QString json);
    ~OAIListXssMatchSetsResponse() override;
    ...
    QList getXssMatchSets() const;
    void setXssMatchSets(const QList &xss_match_sets);
    bool is_xss_match_sets_Set() const;
    bool is_xss_match_sets_Valid() const;
...
private:
    ...
    QList m_xss_match_sets;
    bool m_xss_match_sets_isSet;
    bool m_xss_match_sets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListXssMatchSetsResponse)

#endif // OAIListXssMatchSetsResponse_H
