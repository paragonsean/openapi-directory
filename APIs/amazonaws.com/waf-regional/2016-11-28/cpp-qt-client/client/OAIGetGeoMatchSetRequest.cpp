...
OAIGetGeoMatchSetRequest::OAIGetGeoMatchSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetGeoMatchSetRequest::OAIGetGeoMatchSetRequest() {
    this->initializeModel();
}

OAIGetGeoMatchSetRequest::~OAIGetGeoMatchSetRequest() {}

void OAIGetGeoMatchSetRequest::initializeModel() {

    m_geo_match_set_id_isSet = false;
    m_geo_match_set_id_isValid = false;
}

void OAIGetGeoMatchSetRequest::fromJson(QString jsonString) {
...
void OAIGetGeoMatchSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetGeoMatchSetRequest::asJson() const {
...
QJsonObject OAIGetGeoMatchSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetGeoMatchSetRequest::getGeoMatchSetId() const {
    return m_geo_match_set_id;
}
void OAIGetGeoMatchSetRequest::setGeoMatchSetId(const QString &geo_match_set_id) {
    m_geo_match_set_id = geo_match_set_id;
    m_geo_match_set_id_isSet = true;
}

bool OAIGetGeoMatchSetRequest::is_geo_match_set_id_Set() const{
    return m_geo_match_set_id_isSet;
}

bool OAIGetGeoMatchSetRequest::is_geo_match_set_id_Valid() const{
    return m_geo_match_set_id_isValid;
}

bool OAIGetGeoMatchSetRequest::isSet() const {
...
bool OAIGetGeoMatchSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_geo_match_set_id_isValid && true;
}
