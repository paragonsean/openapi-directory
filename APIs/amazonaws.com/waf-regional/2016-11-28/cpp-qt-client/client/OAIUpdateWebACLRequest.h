...
/*
 * OAIUpdateWebACLRequest.h
 *
 * 
 */

#ifndef OAIUpdateWebACLRequest_H
#define OAIUpdateWebACLRequest_H
...
namespace OpenAPI {
class OAIUpdateWebACLRequest_DefaultAction;

class OAIUpdateWebACLRequest : public OAIObject {
public:
    OAIUpdateWebACLRequest();
    OAIUpdateWebACLRequest(QString json);
    ~OAIUpdateWebACLRequest() override;
    ...
    OAIUpdateWebACLRequest_DefaultAction getDefaultAction() const;
    void setDefaultAction(const OAIUpdateWebACLRequest_DefaultAction &default_action);
...
private:
    ...
    OAIUpdateWebACLRequest_DefaultAction m_default_action;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWebACLRequest)

#endif // OAIUpdateWebACLRequest_H
