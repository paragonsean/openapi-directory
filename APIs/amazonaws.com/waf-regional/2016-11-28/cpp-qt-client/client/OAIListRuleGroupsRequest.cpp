...
QString OAIListRuleGroupsRequest::getNextMarker() const {
    return m_next_marker;
}
void OAIListRuleGroupsRequest::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListRuleGroupsRequest::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListRuleGroupsRequest::is_next_marker_Valid() const{
    return m_next_marker_isValid;
}

qint32 OAIListRuleGroupsRequest::getLimit() const {
    return m_limit;
}
void OAIListRuleGroupsRequest::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIListRuleGroupsRequest::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIListRuleGroupsRequest::is_limit_Valid() const{
