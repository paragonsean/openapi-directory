...
OAIGetChangeTokenResponse::OAIGetChangeTokenResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetChangeTokenResponse::OAIGetChangeTokenResponse() {
    this->initializeModel();
}

OAIGetChangeTokenResponse::~OAIGetChangeTokenResponse() {}

void OAIGetChangeTokenResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIGetChangeTokenResponse::fromJson(QString jsonString) {
...
void OAIGetChangeTokenResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetChangeTokenResponse::asJson() const {
...
QJsonObject OAIGetChangeTokenResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetChangeTokenResponse::getChangeToken() const {
    return m_change_token;
}
void OAIGetChangeTokenResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIGetChangeTokenResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIGetChangeTokenResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIGetChangeTokenResponse::isSet() const {
...
bool OAIGetChangeTokenResponse::isValid() const {
