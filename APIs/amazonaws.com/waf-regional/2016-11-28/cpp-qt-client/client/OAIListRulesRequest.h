...
/*
 * OAIListRulesRequest.h
 *
 * 
 */

#ifndef OAIListRulesRequest_H
#define OAIListRulesRequest_H
...
class OAIListRulesRequest : public OAIObject {
public:
    OAIListRulesRequest();
    OAIListRulesRequest(QString json);
    ~OAIListRulesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRulesRequest)

#endif // OAIListRulesRequest_H
