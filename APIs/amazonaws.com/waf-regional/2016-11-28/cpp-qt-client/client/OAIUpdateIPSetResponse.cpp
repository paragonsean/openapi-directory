...
OAIUpdateIPSetResponse::OAIUpdateIPSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIPSetResponse::OAIUpdateIPSetResponse() {
    this->initializeModel();
}

OAIUpdateIPSetResponse::~OAIUpdateIPSetResponse() {}

void OAIUpdateIPSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIUpdateIPSetResponse::fromJson(QString jsonString) {
...
void OAIUpdateIPSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIPSetResponse::asJson() const {
...
QJsonObject OAIUpdateIPSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateIPSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateIPSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateIPSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateIPSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIUpdateIPSetResponse::isSet() const {
...
bool OAIUpdateIPSetResponse::isValid() const {
