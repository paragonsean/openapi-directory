...
#ifndef OAIIPSetDescriptor_H
#define OAIIPSetDescriptor_H
...
class OAIIPSetDescriptor : public OAIObject {
public:
    OAIIPSetDescriptor();
    OAIIPSetDescriptor(QString json);
    ~OAIIPSetDescriptor() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIPSetDescriptor)

#endif // OAIIPSetDescriptor_H
