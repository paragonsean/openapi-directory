...
/*
 * OAIAssociateWebACLRequest.h
 *
 * 
 */

#ifndef OAIAssociateWebACLRequest_H
#define OAIAssociateWebACLRequest_H
...
class OAIAssociateWebACLRequest : public OAIObject {
public:
    OAIAssociateWebACLRequest();
    OAIAssociateWebACLRequest(QString json);
    ~OAIAssociateWebACLRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateWebACLRequest)

#endif // OAIAssociateWebACLRequest_H
