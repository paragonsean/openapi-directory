...
/*
 * OAIGetRuleResponse_Rule.h
 *
 * 
 */

#ifndef OAIGetRuleResponse_Rule_H
#define OAIGetRuleResponse_Rule_H
...
class OAIGetRuleResponse_Rule : public OAIObject {
public:
    OAIGetRuleResponse_Rule();
    OAIGetRuleResponse_Rule(QString json);
    ~OAIGetRuleResponse_Rule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRuleResponse_Rule)

#endif // OAIGetRuleResponse_Rule_H
