...
/*
 * OAIListRegexMatchSetsResponse.h
 *
 * 
 */

#ifndef OAIListRegexMatchSetsResponse_H
#define OAIListRegexMatchSetsResponse_H
...
class OAIListRegexMatchSetsResponse : public OAIObject {
public:
    OAIListRegexMatchSetsResponse();
    OAIListRegexMatchSetsResponse(QString json);
    ~OAIListRegexMatchSetsResponse() override;
    ...
    QList getRegexMatchSets() const;
    void setRegexMatchSets(const QList &regex_match_sets);
    bool is_regex_match_sets_Set() const;
    bool is_regex_match_sets_Valid() const;
...
private:
    ...
    QList m_regex_match_sets;
    bool m_regex_match_sets_isSet;
    bool m_regex_match_sets_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListRegexMatchSetsResponse)

#endif // OAIListRegexMatchSetsResponse_H
