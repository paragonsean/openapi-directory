...
OAIDeleteRegexPatternSetResponse::OAIDeleteRegexPatternSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRegexPatternSetResponse::OAIDeleteRegexPatternSetResponse() {
    this->initializeModel();
}

OAIDeleteRegexPatternSetResponse::~OAIDeleteRegexPatternSetResponse() {}

void OAIDeleteRegexPatternSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteRegexPatternSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteRegexPatternSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRegexPatternSetResponse::asJson() const {
...
QJsonObject OAIDeleteRegexPatternSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRegexPatternSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteRegexPatternSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteRegexPatternSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteRegexPatternSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteRegexPatternSetResponse::isSet() const {
...
bool OAIDeleteRegexPatternSetResponse::isValid() const {
