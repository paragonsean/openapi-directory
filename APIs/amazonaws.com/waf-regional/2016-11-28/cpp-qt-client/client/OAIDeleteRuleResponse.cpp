...
OAIDeleteRuleResponse::OAIDeleteRuleResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRuleResponse::OAIDeleteRuleResponse() {
    this->initializeModel();
}

OAIDeleteRuleResponse::~OAIDeleteRuleResponse() {}

void OAIDeleteRuleResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteRuleResponse::fromJson(QString jsonString) {
...
void OAIDeleteRuleResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRuleResponse::asJson() const {
...
QJsonObject OAIDeleteRuleResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRuleResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteRuleResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteRuleResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteRuleResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteRuleResponse::isSet() const {
...
bool OAIDeleteRuleResponse::isValid() const {
