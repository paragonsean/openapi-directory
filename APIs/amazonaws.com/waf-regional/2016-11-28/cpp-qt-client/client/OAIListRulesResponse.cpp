...
QString OAIListRulesResponse::getNextMarker() const {
    return m_next_marker;
}
void OAIListRulesResponse::setNextMarker(const QString &next_marker) {
    m_next_marker = next_marker;
    m_next_marker_isSet = true;
}

bool OAIListRulesResponse::is_next_marker_Set() const{
    return m_next_marker_isSet;
}

bool OAIListRulesResponse::is_next_marker_Valid() const{
