...
QString OAIUpdateRuleRequest::getRuleId() const {
    return m_rule_id;
}
void OAIUpdateRuleRequest::setRuleId(const QString &rule_id) {
    m_rule_id = rule_id;
    m_rule_id_isSet = true;
}

bool OAIUpdateRuleRequest::is_rule_id_Set() const{
    return m_rule_id_isSet;
}

bool OAIUpdateRuleRequest::is_rule_id_Valid() const{
    return m_rule_id_isValid;
}

QString OAIUpdateRuleRequest::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateRuleRequest::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateRuleRequest::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateRuleRequest::is_change_token_Valid() const{
    return m_change_token_isValid;
}

QList OAIUpdateRuleRequest::getUpdates() const {
    return m_updates;
}
void OAIUpdateRuleRequest::setUpdates(const QList &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIUpdateRuleRequest::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIUpdateRuleRequest::is_updates_Valid() const{
...
bool OAIUpdateRuleRequest::isValid() const {
    ...
    return m_rule_id_isValid && m_change_token_isValid && m_updates_isValid && true;
}
