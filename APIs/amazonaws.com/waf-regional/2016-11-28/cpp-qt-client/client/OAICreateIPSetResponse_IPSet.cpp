...
#include "OAICreateIPSetResponse_IPSet.h"
...
OAICreateIPSetResponse_IPSet::OAICreateIPSetResponse_IPSet(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIPSetResponse_IPSet::OAICreateIPSetResponse_IPSet() {
    this->initializeModel();
}

OAICreateIPSetResponse_IPSet::~OAICreateIPSetResponse_IPSet() {}

void OAICreateIPSetResponse_IPSet::initializeModel() {
...
void OAICreateIPSetResponse_IPSet::fromJson(QString jsonString) {
...
void OAICreateIPSetResponse_IPSet::fromJsonObject(QJsonObject json) {
...
QString OAICreateIPSetResponse_IPSet::asJson() const {
...
QJsonObject OAICreateIPSetResponse_IPSet::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateIPSetResponse_IPSet::getIpSetId() const {
    return m_ip_set_id;
}
void OAICreateIPSetResponse_IPSet::setIpSetId(const QString &ip_set_id) {
    m_ip_set_id = ip_set_id;
    m_ip_set_id_isSet = true;
}

bool OAICreateIPSetResponse_IPSet::is_ip_set_id_Set() const{
    return m_ip_set_id_isSet;
}

bool OAICreateIPSetResponse_IPSet::is_ip_set_id_Valid() const{
    return m_ip_set_id_isValid;
}

QString OAICreateIPSetResponse_IPSet::getName() const {
    return m_name;
}
void OAICreateIPSetResponse_IPSet::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICreateIPSetResponse_IPSet::is_name_Set() const{
    return m_name_isSet;
}

bool OAICreateIPSetResponse_IPSet::is_name_Valid() const{
    return m_name_isValid;
}

QList OAICreateIPSetResponse_IPSet::getIpSetDescriptors() const {
    return m_ip_set_descriptors;
}
void OAICreateIPSetResponse_IPSet::setIpSetDescriptors(const QList &ip_set_descriptors) {
    m_ip_set_descriptors = ip_set_descriptors;
    m_ip_set_descriptors_isSet = true;
}

bool OAICreateIPSetResponse_IPSet::is_ip_set_descriptors_Set() const{
    return m_ip_set_descriptors_isSet;
}

bool OAICreateIPSetResponse_IPSet::is_ip_set_descriptors_Valid() const{
    return m_ip_set_descriptors_isValid;
}

bool OAICreateIPSetResponse_IPSet::isSet() const {
...
bool OAICreateIPSetResponse_IPSet::isValid() const {
