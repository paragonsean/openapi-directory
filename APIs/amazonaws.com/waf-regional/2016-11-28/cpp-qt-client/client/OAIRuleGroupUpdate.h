...
#ifndef OAIRuleGroupUpdate_H
#define OAIRuleGroupUpdate_H
...
namespace OpenAPI {
class OAIRuleGroupUpdate_ActivatedRule;

class OAIRuleGroupUpdate : public OAIObject {
public:
    OAIRuleGroupUpdate();
    OAIRuleGroupUpdate(QString json);
    ~OAIRuleGroupUpdate() override;
    ...
    OAIRuleGroupUpdate_ActivatedRule getActivatedRule() const;
    void setActivatedRule(const OAIRuleGroupUpdate_ActivatedRule &activated_rule);
...
private:
    ...
    OAIRuleGroupUpdate_ActivatedRule m_activated_rule;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupUpdate)

#endif // OAIRuleGroupUpdate_H
