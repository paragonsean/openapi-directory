...
OAIGetLoggingConfigurationResponse_LoggingConfiguration OAIGetLoggingConfigurationResponse::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIGetLoggingConfigurationResponse::setLoggingConfiguration(const OAIGetLoggingConfigurationResponse_LoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIGetLoggingConfigurationResponse::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIGetLoggingConfigurationResponse::is_logging_configuration_Valid() const{
