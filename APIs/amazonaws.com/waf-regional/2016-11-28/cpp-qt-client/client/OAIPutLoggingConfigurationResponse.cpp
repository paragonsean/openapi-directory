...
OAIPutLoggingConfigurationResponse::OAIPutLoggingConfigurationResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutLoggingConfigurationResponse::OAIPutLoggingConfigurationResponse() {
    this->initializeModel();
}

OAIPutLoggingConfigurationResponse::~OAIPutLoggingConfigurationResponse() {}

void OAIPutLoggingConfigurationResponse::initializeModel() {

    m_logging_configuration_isSet = false;
    m_logging_configuration_isValid = false;
}

void OAIPutLoggingConfigurationResponse::fromJson(QString jsonString) {
...
void OAIPutLoggingConfigurationResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutLoggingConfigurationResponse::asJson() const {
...
QJsonObject OAIPutLoggingConfigurationResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIPutLoggingConfigurationResponse_LoggingConfiguration OAIPutLoggingConfigurationResponse::getLoggingConfiguration() const {
    return m_logging_configuration;
}
void OAIPutLoggingConfigurationResponse::setLoggingConfiguration(const OAIPutLoggingConfigurationResponse_LoggingConfiguration &logging_configuration) {
    m_logging_configuration = logging_configuration;
    m_logging_configuration_isSet = true;
}

bool OAIPutLoggingConfigurationResponse::is_logging_configuration_Set() const{
    return m_logging_configuration_isSet;
}

bool OAIPutLoggingConfigurationResponse::is_logging_configuration_Valid() const{
    return m_logging_configuration_isValid;
}

bool OAIPutLoggingConfigurationResponse::isSet() const {
...
bool OAIPutLoggingConfigurationResponse::isValid() const {
