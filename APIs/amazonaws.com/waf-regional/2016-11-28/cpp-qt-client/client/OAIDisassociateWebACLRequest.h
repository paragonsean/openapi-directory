...
/*
 * OAIDisassociateWebACLRequest.h
 *
 * 
 */

#ifndef OAIDisassociateWebACLRequest_H
#define OAIDisassociateWebACLRequest_H
...
class OAIDisassociateWebACLRequest : public OAIObject {
public:
    OAIDisassociateWebACLRequest();
    OAIDisassociateWebACLRequest(QString json);
    ~OAIDisassociateWebACLRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociateWebACLRequest)

#endif // OAIDisassociateWebACLRequest_H
