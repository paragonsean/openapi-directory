...
/*
 * OAIListWebACLsResponse.h
 *
 * 
 */

#ifndef OAIListWebACLsResponse_H
#define OAIListWebACLsResponse_H
...
class OAIListWebACLsResponse : public OAIObject {
public:
    OAIListWebACLsResponse();
    OAIListWebACLsResponse(QString json);
    ~OAIListWebACLsResponse() override;
    ...
    QList getWebAcls() const;
    void setWebAcls(const QList &web_acls);
    bool is_web_acls_Set() const;
    bool is_web_acls_Valid() const;
...
private:
    ...
    QList m_web_acls;
    bool m_web_acls_isSet;
    bool m_web_acls_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListWebACLsResponse)

#endif // OAIListWebACLsResponse_H
