...
OAIDeleteByteMatchSetResponse::OAIDeleteByteMatchSetResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteByteMatchSetResponse::OAIDeleteByteMatchSetResponse() {
    this->initializeModel();
}

OAIDeleteByteMatchSetResponse::~OAIDeleteByteMatchSetResponse() {}

void OAIDeleteByteMatchSetResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteByteMatchSetResponse::fromJson(QString jsonString) {
...
void OAIDeleteByteMatchSetResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteByteMatchSetResponse::asJson() const {
...
QJsonObject OAIDeleteByteMatchSetResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteByteMatchSetResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteByteMatchSetResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteByteMatchSetResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteByteMatchSetResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteByteMatchSetResponse::isSet() const {
...
bool OAIDeleteByteMatchSetResponse::isValid() const {
