...
OAIUpdateIPSetRequest::OAIUpdateIPSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIPSetRequest::OAIUpdateIPSetRequest() {
    this->initializeModel();
}

OAIUpdateIPSetRequest::~OAIUpdateIPSetRequest() {}

void OAIUpdateIPSetRequest::initializeModel() {
...
void OAIUpdateIPSetRequest::fromJson(QString jsonString) {
...
void OAIUpdateIPSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIPSetRequest::asJson() const {
...
QJsonObject OAIUpdateIPSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateIPSetRequest::getIpSetId() const {
    return m_ip_set_id;
}
void OAIUpdateIPSetRequest::setIpSetId(const QString &ip_set_id) {
    m_ip_set_id = ip_set_id;
    m_ip_set_id_isSet = true;
}

bool OAIUpdateIPSetRequest::is_ip_set_id_Set() const{
    return m_ip_set_id_isSet;
}

bool OAIUpdateIPSetRequest::is_ip_set_id_Valid() const{
    return m_ip_set_id_isValid;
}

QString OAIUpdateIPSetRequest::getChangeToken() const {
    return m_change_token;
}
void OAIUpdateIPSetRequest::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIUpdateIPSetRequest::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIUpdateIPSetRequest::is_change_token_Valid() const{
    return m_change_token_isValid;
}

QList OAIUpdateIPSetRequest::getUpdates() const {
    return m_updates;
}
void OAIUpdateIPSetRequest::setUpdates(const QList &updates) {
    m_updates = updates;
    m_updates_isSet = true;
}

bool OAIUpdateIPSetRequest::is_updates_Set() const{
    return m_updates_isSet;
}

bool OAIUpdateIPSetRequest::is_updates_Valid() const{
    return m_updates_isValid;
}

bool OAIUpdateIPSetRequest::isSet() const {
...
bool OAIUpdateIPSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ip_set_id_isValid && m_change_token_isValid && m_updates_isValid && true;
}
