...
#ifndef OAIRuleGroup_H
#define OAIRuleGroup_H
...
class OAIRuleGroup : public OAIObject {
public:
    OAIRuleGroup();
    OAIRuleGroup(QString json);
    ~OAIRuleGroup() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroup)

#endif // OAIRuleGroup_H
