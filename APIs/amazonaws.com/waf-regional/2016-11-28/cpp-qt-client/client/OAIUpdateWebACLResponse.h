...
/*
 * OAIUpdateWebACLResponse.h
 *
 * 
 */

#ifndef OAIUpdateWebACLResponse_H
#define OAIUpdateWebACLResponse_H
...
class OAIUpdateWebACLResponse : public OAIObject {
public:
    OAIUpdateWebACLResponse();
    OAIUpdateWebACLResponse(QString json);
    ~OAIUpdateWebACLResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateWebACLResponse)

#endif // OAIUpdateWebACLResponse_H
