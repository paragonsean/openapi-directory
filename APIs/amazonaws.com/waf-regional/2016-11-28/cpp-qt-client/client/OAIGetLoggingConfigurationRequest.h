...
/*
 * OAIGetLoggingConfigurationRequest.h
 *
 * 
 */

#ifndef OAIGetLoggingConfigurationRequest_H
#define OAIGetLoggingConfigurationRequest_H
...
class OAIGetLoggingConfigurationRequest : public OAIObject {
public:
    OAIGetLoggingConfigurationRequest();
    OAIGetLoggingConfigurationRequest(QString json);
    ~OAIGetLoggingConfigurationRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetLoggingConfigurationRequest)

#endif // OAIGetLoggingConfigurationRequest_H
