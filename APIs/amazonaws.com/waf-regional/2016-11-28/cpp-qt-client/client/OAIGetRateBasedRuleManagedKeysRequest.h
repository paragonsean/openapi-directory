...
/*
 * OAIGetRateBasedRuleManagedKeysRequest.h
 *
 * 
 */

#ifndef OAIGetRateBasedRuleManagedKeysRequest_H
#define OAIGetRateBasedRuleManagedKeysRequest_H
...
class OAIGetRateBasedRuleManagedKeysRequest : public OAIObject {
public:
    OAIGetRateBasedRuleManagedKeysRequest();
    OAIGetRateBasedRuleManagedKeysRequest(QString json);
    ~OAIGetRateBasedRuleManagedKeysRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRateBasedRuleManagedKeysRequest)

#endif // OAIGetRateBasedRuleManagedKeysRequest_H
