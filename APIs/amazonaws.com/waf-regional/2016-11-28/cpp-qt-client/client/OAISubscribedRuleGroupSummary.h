...
class OAISubscribedRuleGroupSummary : public OAIObject {
public:
    OAISubscribedRuleGroupSummary();
    OAISubscribedRuleGroupSummary(QString json);
    ~OAISubscribedRuleGroupSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISubscribedRuleGroupSummary)

#endif // OAISubscribedRuleGroupSummary_H
