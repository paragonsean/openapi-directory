...
OAIGetRuleResponse_Rule OAIGetRuleResponse::getRule() const {
    return m_rule;
}
void OAIGetRuleResponse::setRule(const OAIGetRuleResponse_Rule &rule) {
    m_rule = rule;
    m_rule_isSet = true;
}

bool OAIGetRuleResponse::is_rule_Set() const{
    return m_rule_isSet;
}

bool OAIGetRuleResponse::is_rule_Valid() const{
