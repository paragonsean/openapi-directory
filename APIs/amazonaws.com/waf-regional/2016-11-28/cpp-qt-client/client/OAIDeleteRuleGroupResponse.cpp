...
OAIDeleteRuleGroupResponse::OAIDeleteRuleGroupResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteRuleGroupResponse::OAIDeleteRuleGroupResponse() {
    this->initializeModel();
}

OAIDeleteRuleGroupResponse::~OAIDeleteRuleGroupResponse() {}

void OAIDeleteRuleGroupResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteRuleGroupResponse::fromJson(QString jsonString) {
...
void OAIDeleteRuleGroupResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteRuleGroupResponse::asJson() const {
...
QJsonObject OAIDeleteRuleGroupResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteRuleGroupResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteRuleGroupResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteRuleGroupResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteRuleGroupResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteRuleGroupResponse::isSet() const {
...
bool OAIDeleteRuleGroupResponse::isValid() const {
