...
/*
 * OAIGetWebACLForResourceRequest.h
 *
 * 
 */

#ifndef OAIGetWebACLForResourceRequest_H
#define OAIGetWebACLForResourceRequest_H
...
class OAIGetWebACLForResourceRequest : public OAIObject {
public:
    OAIGetWebACLForResourceRequest();
    OAIGetWebACLForResourceRequest(QString json);
    ~OAIGetWebACLForResourceRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetWebACLForResourceRequest)

#endif // OAIGetWebACLForResourceRequest_H
