...
#ifndef OAIWafActionType_H
#define OAIWafActionType_H
...
class OAIWafActionType : public OAIEnum {
public:
    OAIWafActionType();
    OAIWafActionType(QString json);
    ~OAIWafActionType() override;
    ...
    enum class eOAIWafActionType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        BLOCK, 
        ALLOW, 
        COUNT
    };
    OAIWafActionType::eOAIWafActionType getValue() const;
    void setValue(const OAIWafActionType::eOAIWafActionType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIWafActionType)

#endif // OAIWafActionType_H
