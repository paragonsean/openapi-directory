...
class OAIRateKey : public OAIEnum {
public:
    OAIRateKey();
    OAIRateKey(QString json);
    ~OAIRateKey() override;
    ...
    enum class eOAIRateKey {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        IP
    };
    OAIRateKey::eOAIRateKey getValue() const;
    void setValue(const OAIRateKey::eOAIRateKey& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIRateKey)
