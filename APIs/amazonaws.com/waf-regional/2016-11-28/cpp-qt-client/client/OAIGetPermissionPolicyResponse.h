...
/*
 * OAIGetPermissionPolicyResponse.h
 *
 * 
 */

#ifndef OAIGetPermissionPolicyResponse_H
#define OAIGetPermissionPolicyResponse_H
...
class OAIGetPermissionPolicyResponse : public OAIObject {
public:
    OAIGetPermissionPolicyResponse();
    OAIGetPermissionPolicyResponse(QString json);
    ~OAIGetPermissionPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPermissionPolicyResponse)

#endif // OAIGetPermissionPolicyResponse_H
