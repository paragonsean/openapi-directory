...
#ifndef OAISqlInjectionMatchSet_H
#define OAISqlInjectionMatchSet_H
...
class OAISqlInjectionMatchSet : public OAIObject {
public:
    OAISqlInjectionMatchSet();
    OAISqlInjectionMatchSet(QString json);
    ~OAISqlInjectionMatchSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISqlInjectionMatchSet)

#endif // OAISqlInjectionMatchSet_H
