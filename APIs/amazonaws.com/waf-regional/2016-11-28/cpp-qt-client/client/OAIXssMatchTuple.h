...
#ifndef OAIXssMatchTuple_H
#define OAIXssMatchTuple_H
...
class OAIXssMatchTuple : public OAIObject {
public:
    OAIXssMatchTuple();
    OAIXssMatchTuple(QString json);
    ~OAIXssMatchTuple() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIXssMatchTuple)

#endif // OAIXssMatchTuple_H
