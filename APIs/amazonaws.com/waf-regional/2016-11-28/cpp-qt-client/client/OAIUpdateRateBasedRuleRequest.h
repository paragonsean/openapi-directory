...
/*
 * OAIUpdateRateBasedRuleRequest.h
 *
 * 
 */

#ifndef OAIUpdateRateBasedRuleRequest_H
#define OAIUpdateRateBasedRuleRequest_H
...
class OAIUpdateRateBasedRuleRequest : public OAIObject {
public:
    OAIUpdateRateBasedRuleRequest();
    OAIUpdateRateBasedRuleRequest(QString json);
    ~OAIUpdateRateBasedRuleRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateRateBasedRuleRequest)

#endif // OAIUpdateRateBasedRuleRequest_H
