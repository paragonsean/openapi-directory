...
#ifndef OAIIPSetSummary_H
#define OAIIPSetSummary_H
...
class OAIIPSetSummary : public OAIObject {
public:
    OAIIPSetSummary();
    OAIIPSetSummary(QString json);
    ~OAIIPSetSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIPSetSummary)

#endif // OAIIPSetSummary_H
