...
OAIDeleteWebACLResponse::OAIDeleteWebACLResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteWebACLResponse::OAIDeleteWebACLResponse() {
    this->initializeModel();
}

OAIDeleteWebACLResponse::~OAIDeleteWebACLResponse() {}

void OAIDeleteWebACLResponse::initializeModel() {

    m_change_token_isSet = false;
    m_change_token_isValid = false;
}

void OAIDeleteWebACLResponse::fromJson(QString jsonString) {
...
void OAIDeleteWebACLResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteWebACLResponse::asJson() const {
...
QJsonObject OAIDeleteWebACLResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteWebACLResponse::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteWebACLResponse::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteWebACLResponse::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteWebACLResponse::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteWebACLResponse::isSet() const {
...
bool OAIDeleteWebACLResponse::isValid() const {
