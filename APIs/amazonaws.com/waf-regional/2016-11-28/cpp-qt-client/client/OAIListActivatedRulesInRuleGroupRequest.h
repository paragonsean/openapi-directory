...
/*
 * OAIListActivatedRulesInRuleGroupRequest.h
 *
 * 
 */

#ifndef OAIListActivatedRulesInRuleGroupRequest_H
#define OAIListActivatedRulesInRuleGroupRequest_H
...
class OAIListActivatedRulesInRuleGroupRequest : public OAIObject {
public:
    OAIListActivatedRulesInRuleGroupRequest();
    OAIListActivatedRulesInRuleGroupRequest(QString json);
    ~OAIListActivatedRulesInRuleGroupRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListActivatedRulesInRuleGroupRequest)

#endif // OAIListActivatedRulesInRuleGroupRequest_H
