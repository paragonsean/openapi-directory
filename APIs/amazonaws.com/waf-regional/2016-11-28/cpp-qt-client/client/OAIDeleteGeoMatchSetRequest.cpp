...
OAIDeleteGeoMatchSetRequest::OAIDeleteGeoMatchSetRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteGeoMatchSetRequest::OAIDeleteGeoMatchSetRequest() {
    this->initializeModel();
}

OAIDeleteGeoMatchSetRequest::~OAIDeleteGeoMatchSetRequest() {}

void OAIDeleteGeoMatchSetRequest::initializeModel() {
...
void OAIDeleteGeoMatchSetRequest::fromJson(QString jsonString) {
...
void OAIDeleteGeoMatchSetRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteGeoMatchSetRequest::asJson() const {
...
QJsonObject OAIDeleteGeoMatchSetRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteGeoMatchSetRequest::getGeoMatchSetId() const {
    return m_geo_match_set_id;
}
void OAIDeleteGeoMatchSetRequest::setGeoMatchSetId(const QString &geo_match_set_id) {
    m_geo_match_set_id = geo_match_set_id;
    m_geo_match_set_id_isSet = true;
}

bool OAIDeleteGeoMatchSetRequest::is_geo_match_set_id_Set() const{
    return m_geo_match_set_id_isSet;
}

bool OAIDeleteGeoMatchSetRequest::is_geo_match_set_id_Valid() const{
    return m_geo_match_set_id_isValid;
}

QString OAIDeleteGeoMatchSetRequest::getChangeToken() const {
    return m_change_token;
}
void OAIDeleteGeoMatchSetRequest::setChangeToken(const QString &change_token) {
    m_change_token = change_token;
    m_change_token_isSet = true;
}

bool OAIDeleteGeoMatchSetRequest::is_change_token_Set() const{
    return m_change_token_isSet;
}

bool OAIDeleteGeoMatchSetRequest::is_change_token_Valid() const{
    return m_change_token_isValid;
}

bool OAIDeleteGeoMatchSetRequest::isSet() const {
...
bool OAIDeleteGeoMatchSetRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_geo_match_set_id_isValid && m_change_token_isValid && true;
}
