...
#ifndef OAIRuleGroupSummary_H
#define OAIRuleGroupSummary_H
...
class OAIRuleGroupSummary : public OAIObject {
public:
    OAIRuleGroupSummary();
    OAIRuleGroupSummary(QString json);
    ~OAIRuleGroupSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRuleGroupSummary)

#endif // OAIRuleGroupSummary_H
