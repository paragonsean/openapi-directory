...
/*
 * OAIListRegexMatchSetsRequest.h
 *
 * 
 */

#ifndef OAIListRegexMatchSetsRequest_H
#define OAIListRegexMatchSetsRequest_H
...
class OAIListRegexMatchSetsRequest : public OAIObject {
public:
    OAIListRegexMatchSetsRequest();
    OAIListRegexMatchSetsRequest(QString json);
    ~OAIListRegexMatchSetsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListRegexMatchSetsRequest)

#endif // OAIListRegexMatchSetsRequest_H
