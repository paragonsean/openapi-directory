...
/*
 * OAICreateXssMatchSetRequest.h
 *
 * A request to create an &lt;a&gt;XssMatchSet&lt;/a&gt;.
 */

#ifndef OAICreateXssMatchSetRequest_H
#define OAICreateXssMatchSetRequest_H
...
class OAICreateXssMatchSetRequest : public OAIObject {
public:
    OAICreateXssMatchSetRequest();
    OAICreateXssMatchSetRequest(QString json);
    ~OAICreateXssMatchSetRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateXssMatchSetRequest)

#endif // OAICreateXssMatchSetRequest_H
