...
/*
 * OAIListResourcesForWebACLResponse.h
 *
 * 
 */

#ifndef OAIListResourcesForWebACLResponse_H
#define OAIListResourcesForWebACLResponse_H
...
class OAIListResourcesForWebACLResponse : public OAIObject {
public:
    OAIListResourcesForWebACLResponse();
    OAIListResourcesForWebACLResponse(QString json);
    ~OAIListResourcesForWebACLResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListResourcesForWebACLResponse)

#endif // OAIListResourcesForWebACLResponse_H
