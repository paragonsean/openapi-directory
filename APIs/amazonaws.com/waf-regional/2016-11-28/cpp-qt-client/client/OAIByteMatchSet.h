...
#ifndef OAIByteMatchSet_H
#define OAIByteMatchSet_H
...
class OAIByteMatchSet : public OAIObject {
public:
    OAIByteMatchSet();
    OAIByteMatchSet(QString json);
    ~OAIByteMatchSet() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIByteMatchSet)

#endif // OAIByteMatchSet_H
