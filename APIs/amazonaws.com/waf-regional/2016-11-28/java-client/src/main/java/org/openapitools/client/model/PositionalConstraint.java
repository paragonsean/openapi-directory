...
/**
 * Gets or Sets PositionalConstraint
 */
@JsonAdapter(PositionalConstraint.Adapter.class)
public enum PositionalConstraint {
  ...
  public static PositionalConstraint fromValue(String value) {
    for (PositionalConstraint b : PositionalConstraint.values()) {
  ...
  public static class Adapter extends TypeAdapter<PositionalConstraint> {
    @Override
    public void write(final JsonWriter jsonWriter, final PositionalConstraint enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PositionalConstraint read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PositionalConstraint.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PositionalConstraint.fromValue(value);
  }
}
