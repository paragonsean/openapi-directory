...
import org.openapitools.client.model.CreateRuleResponseRule;
...
public class CreateRuleResponse {
  ...
  private CreateRuleResponseRule rule;
  ...
  public CreateRuleResponse rule(CreateRuleResponseRule rule) {
    this.rule = rule;
    return this;
  }
  ...
  public CreateRuleResponseRule getRule() {
    return rule;
  }

  public void setRule(CreateRuleResponseRule rule) {
    this.rule = rule;
  }


  public CreateRuleResponse changeToken(String changeToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rule, createRuleResponse.rule) &&
        Objects.equals(this.changeToken, createRuleResponse.changeToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rule, changeToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Rule") != null && !jsonObj.get("Rule").isJsonNull()) {
        CreateRuleResponseRule.validateJsonElement(jsonObj.get("Rule"));
      }
