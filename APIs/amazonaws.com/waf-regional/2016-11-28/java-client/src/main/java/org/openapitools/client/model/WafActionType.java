...
/**
 * Gets or Sets WafActionType
 */
@JsonAdapter(WafActionType.Adapter.class)
public enum WafActionType {
  ...
  public static WafActionType fromValue(String value) {
    for (WafActionType b : WafActionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<WafActionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final WafActionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WafActionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WafActionType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WafActionType.fromValue(value);
  }
}
