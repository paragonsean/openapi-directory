...
/**
 * Gets or Sets MatchFieldType
 */
@JsonAdapter(MatchFieldType.Adapter.class)
public enum MatchFieldType {
  ...
  public static MatchFieldType fromValue(String value) {
    for (MatchFieldType b : MatchFieldType.values()) {
  ...
  public static class Adapter extends TypeAdapter<MatchFieldType> {
    @Override
    public void write(final JsonWriter jsonWriter, final MatchFieldType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MatchFieldType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MatchFieldType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    MatchFieldType.fromValue(value);
  }
}
