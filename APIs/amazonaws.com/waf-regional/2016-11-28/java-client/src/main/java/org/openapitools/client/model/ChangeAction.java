...
/**
 * Gets or Sets ChangeAction
 */
@JsonAdapter(ChangeAction.Adapter.class)
public enum ChangeAction {
  ...
  public static ChangeAction fromValue(String value) {
    for (ChangeAction b : ChangeAction.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChangeAction> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChangeAction enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChangeAction read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChangeAction.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChangeAction.fromValue(value);
  }
}
