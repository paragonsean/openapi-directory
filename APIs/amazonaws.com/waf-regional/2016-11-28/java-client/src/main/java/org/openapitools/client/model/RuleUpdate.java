...
import org.openapitools.client.model.RuleUpdatePredicate;
...
public class RuleUpdate {
  ...
  private RuleUpdatePredicate predicate;

  public RuleUpdate() {
  }

  public RuleUpdate action(ChangeAction action) {
    this.action = action;
    return this;
  }
  ...
  public RuleUpdate predicate(RuleUpdatePredicate predicate) {
   ...
   */
  @javax.annotation.Nonnull
  public RuleUpdatePredicate getPredicate() {
    return predicate;
  }

  public void setPredicate(RuleUpdatePredicate predicate) {
    this.predicate = predicate;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.action, ruleUpdate.action) &&
        Objects.equals(this.predicate, ruleUpdate.predicate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(action, predicate);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("Predicate");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      RuleUpdatePredicate.validateJsonElement(jsonObj.get("Predicate"));
  }
