...
/**
 * Gets or Sets TextTransformation
 */
@JsonAdapter(TextTransformation.Adapter.class)
public enum TextTransformation {
  ...
  public static TextTransformation fromValue(String value) {
    for (TextTransformation b : TextTransformation.values()) {
  ...
  public static class Adapter extends TypeAdapter<TextTransformation> {
    @Override
    public void write(final JsonWriter jsonWriter, final TextTransformation enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TextTransformation read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TextTransformation.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TextTransformation.fromValue(value);
  }
}
