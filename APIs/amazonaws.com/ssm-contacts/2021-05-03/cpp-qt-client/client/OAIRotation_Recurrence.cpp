...
#include "OAIRotation_Recurrence.h"
...
OAIRotation_Recurrence::OAIRotation_Recurrence(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRotation_Recurrence::OAIRotation_Recurrence() {
    this->initializeModel();
}

OAIRotation_Recurrence::~OAIRotation_Recurrence() {}

void OAIRotation_Recurrence::initializeModel() {
...
void OAIRotation_Recurrence::fromJson(QString jsonString) {
...
void OAIRotation_Recurrence::fromJsonObject(QJsonObject json) {
...
QString OAIRotation_Recurrence::asJson() const {
...
QJsonObject OAIRotation_Recurrence::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRotation_Recurrence::getMonthlySettings() const {
    return m_monthly_settings;
}
void OAIRotation_Recurrence::setMonthlySettings(const QList &monthly_settings) {
    m_monthly_settings = monthly_settings;
    m_monthly_settings_isSet = true;
}

bool OAIRotation_Recurrence::is_monthly_settings_Set() const{
    return m_monthly_settings_isSet;
}

bool OAIRotation_Recurrence::is_monthly_settings_Valid() const{
    return m_monthly_settings_isValid;
}

QList OAIRotation_Recurrence::getWeeklySettings() const {
    return m_weekly_settings;
}
void OAIRotation_Recurrence::setWeeklySettings(const QList &weekly_settings) {
    m_weekly_settings = weekly_settings;
    m_weekly_settings_isSet = true;
}

bool OAIRotation_Recurrence::is_weekly_settings_Set() const{
    return m_weekly_settings_isSet;
}

bool OAIRotation_Recurrence::is_weekly_settings_Valid() const{
    return m_weekly_settings_isValid;
}

QList OAIRotation_Recurrence::getDailySettings() const {
    return m_daily_settings;
}
void OAIRotation_Recurrence::setDailySettings(const QList &daily_settings) {
    m_daily_settings = daily_settings;
    m_daily_settings_isSet = true;
}

bool OAIRotation_Recurrence::is_daily_settings_Set() const{
    return m_daily_settings_isSet;
}

bool OAIRotation_Recurrence::is_daily_settings_Valid() const{
    return m_daily_settings_isValid;
}

qint32 OAIRotation_Recurrence::getNumberOfOnCalls() const {
    return m_number_of_on_calls;
}
void OAIRotation_Recurrence::setNumberOfOnCalls(const qint32 &number_of_on_calls) {
    m_number_of_on_calls = number_of_on_calls;
    m_number_of_on_calls_isSet = true;
}

bool OAIRotation_Recurrence::is_number_of_on_calls_Set() const{
    return m_number_of_on_calls_isSet;
}

bool OAIRotation_Recurrence::is_number_of_on_calls_Valid() const{
    return m_number_of_on_calls_isValid;
}

QMap OAIRotation_Recurrence::getShiftCoverages() const {
    return m_shift_coverages;
}
void OAIRotation_Recurrence::setShiftCoverages(const QMap &shift_coverages) {
    m_shift_coverages = shift_coverages;
    m_shift_coverages_isSet = true;
}

bool OAIRotation_Recurrence::is_shift_coverages_Set() const{
    return m_shift_coverages_isSet;
}

bool OAIRotation_Recurrence::is_shift_coverages_Valid() const{
    return m_shift_coverages_isValid;
}

qint32 OAIRotation_Recurrence::getRecurrenceMultiplier() const {
    return m_recurrence_multiplier;
}
void OAIRotation_Recurrence::setRecurrenceMultiplier(const qint32 &recurrence_multiplier) {
    m_recurrence_multiplier = recurrence_multiplier;
    m_recurrence_multiplier_isSet = true;
}

bool OAIRotation_Recurrence::is_recurrence_multiplier_Set() const{
    return m_recurrence_multiplier_isSet;
}

bool OAIRotation_Recurrence::is_recurrence_multiplier_Valid() const{
    return m_recurrence_multiplier_isValid;
}

bool OAIRotation_Recurrence::isSet() const {
...
bool OAIRotation_Recurrence::isValid() const {
