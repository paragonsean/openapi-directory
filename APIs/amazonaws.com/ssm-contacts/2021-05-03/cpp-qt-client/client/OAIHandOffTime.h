...
#ifndef OAIHandOffTime_H
#define OAIHandOffTime_H
...
class OAIHandOffTime : public OAIObject {
public:
    OAIHandOffTime();
    OAIHandOffTime(QString json);
    ~OAIHandOffTime() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHandOffTime)

#endif // OAIHandOffTime_H
