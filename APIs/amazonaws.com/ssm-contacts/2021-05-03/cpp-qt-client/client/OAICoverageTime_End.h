...
/*
 * OAICoverageTime_End.h
 *
 * 
 */

#ifndef OAICoverageTime_End_H
#define OAICoverageTime_End_H
...
class OAICoverageTime_End : public OAIObject {
public:
    OAICoverageTime_End();
    OAICoverageTime_End(QString json);
    ~OAICoverageTime_End() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoverageTime_End)

#endif // OAICoverageTime_End_H
