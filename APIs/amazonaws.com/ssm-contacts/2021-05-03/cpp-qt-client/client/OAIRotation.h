...
#ifndef OAIRotation_H
#define OAIRotation_H
...
namespace OpenAPI {
class OAIRotation_Recurrence;

class OAIRotation : public OAIObject {
public:
    OAIRotation();
    OAIRotation(QString json);
    ~OAIRotation() override;
    ...
    OAIRotation_Recurrence getRecurrence() const;
    void setRecurrence(const OAIRotation_Recurrence &recurrence);
...
private:
    ...
    OAIRotation_Recurrence m_recurrence;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRotation)
