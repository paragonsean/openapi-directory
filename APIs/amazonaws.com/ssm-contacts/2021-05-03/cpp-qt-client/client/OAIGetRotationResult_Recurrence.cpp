...
OAIGetRotationResult_Recurrence::OAIGetRotationResult_Recurrence(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetRotationResult_Recurrence::OAIGetRotationResult_Recurrence() {
    this->initializeModel();
}

OAIGetRotationResult_Recurrence::~OAIGetRotationResult_Recurrence() {}

void OAIGetRotationResult_Recurrence::initializeModel() {
...
void OAIGetRotationResult_Recurrence::fromJson(QString jsonString) {
...
void OAIGetRotationResult_Recurrence::fromJsonObject(QJsonObject json) {
...
QString OAIGetRotationResult_Recurrence::asJson() const {
...
QJsonObject OAIGetRotationResult_Recurrence::asJsonObject() const {
    QJsonObject obj;
...
QList OAIGetRotationResult_Recurrence::getMonthlySettings() const {
    return m_monthly_settings;
}
void OAIGetRotationResult_Recurrence::setMonthlySettings(const QList &monthly_settings) {
    m_monthly_settings = monthly_settings;
    m_monthly_settings_isSet = true;
}

bool OAIGetRotationResult_Recurrence::is_monthly_settings_Set() const{
    return m_monthly_settings_isSet;
}

bool OAIGetRotationResult_Recurrence::is_monthly_settings_Valid() const{
    return m_monthly_settings_isValid;
}

QList OAIGetRotationResult_Recurrence::getWeeklySettings() const {
    return m_weekly_settings;
}
void OAIGetRotationResult_Recurrence::setWeeklySettings(const QList &weekly_settings) {
    m_weekly_settings = weekly_settings;
    m_weekly_settings_isSet = true;
}

bool OAIGetRotationResult_Recurrence::is_weekly_settings_Set() const{
    return m_weekly_settings_isSet;
}

bool OAIGetRotationResult_Recurrence::is_weekly_settings_Valid() const{
    return m_weekly_settings_isValid;
}

QList OAIGetRotationResult_Recurrence::getDailySettings() const {
    return m_daily_settings;
}
void OAIGetRotationResult_Recurrence::setDailySettings(const QList &daily_settings) {
    m_daily_settings = daily_settings;
    m_daily_settings_isSet = true;
}

bool OAIGetRotationResult_Recurrence::is_daily_settings_Set() const{
    return m_daily_settings_isSet;
}

bool OAIGetRotationResult_Recurrence::is_daily_settings_Valid() const{
    return m_daily_settings_isValid;
}

qint32 OAIGetRotationResult_Recurrence::getNumberOfOnCalls() const {
    return m_number_of_on_calls;
}
void OAIGetRotationResult_Recurrence::setNumberOfOnCalls(const qint32 &number_of_on_calls) {
    m_number_of_on_calls = number_of_on_calls;
    m_number_of_on_calls_isSet = true;
}

bool OAIGetRotationResult_Recurrence::is_number_of_on_calls_Set() const{
    return m_number_of_on_calls_isSet;
}

bool OAIGetRotationResult_Recurrence::is_number_of_on_calls_Valid() const{
    return m_number_of_on_calls_isValid;
}

QMap OAIGetRotationResult_Recurrence::getShiftCoverages() const {
    return m_shift_coverages;
}
void OAIGetRotationResult_Recurrence::setShiftCoverages(const QMap &shift_coverages) {
    m_shift_coverages = shift_coverages;
    m_shift_coverages_isSet = true;
}

bool OAIGetRotationResult_Recurrence::is_shift_coverages_Set() const{
    return m_shift_coverages_isSet;
}

bool OAIGetRotationResult_Recurrence::is_shift_coverages_Valid() const{
    return m_shift_coverages_isValid;
}

qint32 OAIGetRotationResult_Recurrence::getRecurrenceMultiplier() const {
    return m_recurrence_multiplier;
}
void OAIGetRotationResult_Recurrence::setRecurrenceMultiplier(const qint32 &recurrence_multiplier) {
    m_recurrence_multiplier = recurrence_multiplier;
    m_recurrence_multiplier_isSet = true;
}

bool OAIGetRotationResult_Recurrence::is_recurrence_multiplier_Set() const{
    return m_recurrence_multiplier_isSet;
}

bool OAIGetRotationResult_Recurrence::is_recurrence_multiplier_Valid() const{
    return m_recurrence_multiplier_isValid;
}

bool OAIGetRotationResult_Recurrence::isSet() const {
...
bool OAIGetRotationResult_Recurrence::isValid() const {
