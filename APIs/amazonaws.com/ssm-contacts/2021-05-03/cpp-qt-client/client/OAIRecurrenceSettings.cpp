...
#include "OAIRecurrenceSettings.h"
...
OAIRecurrenceSettings::OAIRecurrenceSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecurrenceSettings::OAIRecurrenceSettings() {
    this->initializeModel();
}

OAIRecurrenceSettings::~OAIRecurrenceSettings() {}

void OAIRecurrenceSettings::initializeModel() {
...
void OAIRecurrenceSettings::fromJson(QString jsonString) {
...
void OAIRecurrenceSettings::fromJsonObject(QJsonObject json) {
...
QString OAIRecurrenceSettings::asJson() const {
...
QJsonObject OAIRecurrenceSettings::asJsonObject() const {
    QJsonObject obj;
...
QList OAIRecurrenceSettings::getMonthlySettings() const {
    return m_monthly_settings;
}
void OAIRecurrenceSettings::setMonthlySettings(const QList &monthly_settings) {
    m_monthly_settings = monthly_settings;
    m_monthly_settings_isSet = true;
}

bool OAIRecurrenceSettings::is_monthly_settings_Set() const{
    return m_monthly_settings_isSet;
}

bool OAIRecurrenceSettings::is_monthly_settings_Valid() const{
    return m_monthly_settings_isValid;
}

QList OAIRecurrenceSettings::getWeeklySettings() const {
    return m_weekly_settings;
}
void OAIRecurrenceSettings::setWeeklySettings(const QList &weekly_settings) {
    m_weekly_settings = weekly_settings;
    m_weekly_settings_isSet = true;
}

bool OAIRecurrenceSettings::is_weekly_settings_Set() const{
    return m_weekly_settings_isSet;
}

bool OAIRecurrenceSettings::is_weekly_settings_Valid() const{
    return m_weekly_settings_isValid;
}

QList OAIRecurrenceSettings::getDailySettings() const {
    return m_daily_settings;
}
void OAIRecurrenceSettings::setDailySettings(const QList &daily_settings) {
    m_daily_settings = daily_settings;
    m_daily_settings_isSet = true;
}

bool OAIRecurrenceSettings::is_daily_settings_Set() const{
    return m_daily_settings_isSet;
}

bool OAIRecurrenceSettings::is_daily_settings_Valid() const{
    return m_daily_settings_isValid;
}

qint32 OAIRecurrenceSettings::getNumberOfOnCalls() const {
    return m_number_of_on_calls;
}
void OAIRecurrenceSettings::setNumberOfOnCalls(const qint32 &number_of_on_calls) {
    m_number_of_on_calls = number_of_on_calls;
    m_number_of_on_calls_isSet = true;
}

bool OAIRecurrenceSettings::is_number_of_on_calls_Set() const{
    return m_number_of_on_calls_isSet;
}

bool OAIRecurrenceSettings::is_number_of_on_calls_Valid() const{
    return m_number_of_on_calls_isValid;
}

QMap OAIRecurrenceSettings::getShiftCoverages() const {
    return m_shift_coverages;
}
void OAIRecurrenceSettings::setShiftCoverages(const QMap &shift_coverages) {
    m_shift_coverages = shift_coverages;
    m_shift_coverages_isSet = true;
}

bool OAIRecurrenceSettings::is_shift_coverages_Set() const{
    return m_shift_coverages_isSet;
}

bool OAIRecurrenceSettings::is_shift_coverages_Valid() const{
    return m_shift_coverages_isValid;
}

qint32 OAIRecurrenceSettings::getRecurrenceMultiplier() const {
    return m_recurrence_multiplier;
}
void OAIRecurrenceSettings::setRecurrenceMultiplier(const qint32 &recurrence_multiplier) {
    m_recurrence_multiplier = recurrence_multiplier;
    m_recurrence_multiplier_isSet = true;
}

bool OAIRecurrenceSettings::is_recurrence_multiplier_Set() const{
    return m_recurrence_multiplier_isSet;
}

bool OAIRecurrenceSettings::is_recurrence_multiplier_Valid() const{
    return m_recurrence_multiplier_isValid;
}

bool OAIRecurrenceSettings::isSet() const {
...
bool OAIRecurrenceSettings::isValid() const {
