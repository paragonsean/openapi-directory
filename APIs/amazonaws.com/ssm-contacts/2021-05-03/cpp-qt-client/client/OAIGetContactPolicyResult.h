...
/*
 * OAIGetContactPolicyResult.h
 *
 * 
 */

#ifndef OAIGetContactPolicyResult_H
#define OAIGetContactPolicyResult_H
...
class OAIGetContactPolicyResult : public OAIObject {
public:
    OAIGetContactPolicyResult();
    OAIGetContactPolicyResult(QString json);
    ~OAIGetContactPolicyResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetContactPolicyResult)

#endif // OAIGetContactPolicyResult_H
