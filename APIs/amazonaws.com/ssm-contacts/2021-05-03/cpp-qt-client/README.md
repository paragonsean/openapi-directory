...
QString Example::create(){
    QString obj;
OAIAcceptPageRequest Example::create(){
    OAIAcceptPageRequest obj;
QString Example::create(){
    QString obj;
QString Example::create(){
    QString obj;
...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::acceptPageSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::acceptPageSignalE, [&](QNetworkReply::NetworkError, QString error_str) {
      ...
      OAIAcceptPageRequest oai_accept_page_request = create(); // OAIAcceptPageRequest | 
      ...
      apiInstance.acceptPage(x_amz_targetoai_accept_page_requestx_amz_content_sha256x_amz_datex_amz_algorithmx_amz_credentialx_amz_security_tokenx_amz_signaturex_amz_signed_headers);
