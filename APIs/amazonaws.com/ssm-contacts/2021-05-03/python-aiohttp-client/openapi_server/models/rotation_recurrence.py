...
class RotationRecurrence(Model):
    ...
    def __init__(self, monthly_settings: List=None, weekly_settings: List=None, daily_settings: List=None, number_of_on_calls: int=None, shift_coverages: Dict=None, recurrence_multiplier: int=None):
        """RotationRecurrence - a model defined in OpenAPI

        :param monthly_settings: The monthly_settings of this RotationRecurrence.
        :param weekly_settings: The weekly_settings of this RotationRecurrence.
        :param daily_settings: The daily_settings of this RotationRecurrence.
        :param number_of_on_calls: The number_of_on_calls of this RotationRecurrence.
        :param shift_coverages: The shift_coverages of this RotationRecurrence.
        :param recurrence_multiplier: The recurrence_multiplier of this RotationRecurrence.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RotationRecurrence':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Rotation_Recurrence of this RotationRecurrence.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def monthly_settings(self):
        """Gets the monthly_settings of this RotationRecurrence.


        :return: The monthly_settings of this RotationRecurrence.
        :rtype: List
        """
    ...
    def monthly_settings(self, monthly_settings):
        """Sets the monthly_settings of this RotationRecurrence.
    ...
    def weekly_settings(self):
        """Gets the weekly_settings of this RotationRecurrence.


        :return: The weekly_settings of this RotationRecurrence.
        :rtype: List
        """
    ...
    def weekly_settings(self, weekly_settings):
        """Sets the weekly_settings of this RotationRecurrence.
    ...
    def daily_settings(self):
        """Gets the daily_settings of this RotationRecurrence.


        :return: The daily_settings of this RotationRecurrence.
        :rtype: List
        """
    ...
    def daily_settings(self, daily_settings):
        """Sets the daily_settings of this RotationRecurrence.
    ...
    def number_of_on_calls(self):
        """Gets the number_of_on_calls of this RotationRecurrence.


        :return: The number_of_on_calls of this RotationRecurrence.
        :rtype: int
        """
    ...
    def number_of_on_calls(self, number_of_on_calls):
        """Sets the number_of_on_calls of this RotationRecurrence.
    ...
    def shift_coverages(self):
        """Gets the shift_coverages of this RotationRecurrence.


        :return: The shift_coverages of this RotationRecurrence.
        :rtype: Dict
        """
    ...
    def shift_coverages(self, shift_coverages):
        """Sets the shift_coverages of this RotationRecurrence.
    ...
    def recurrence_multiplier(self):
        """Gets the recurrence_multiplier of this RotationRecurrence.


        :return: The recurrence_multiplier of this RotationRecurrence.
        :rtype: int
        """
    ...
    def recurrence_multiplier(self, recurrence_multiplier):
        """Sets the recurrence_multiplier of this RotationRecurrence.
