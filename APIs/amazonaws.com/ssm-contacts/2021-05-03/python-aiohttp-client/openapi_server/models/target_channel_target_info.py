...
class TargetChannelTargetInfo(Model):
    ...
    def __init__(self, contact_channel_id: str=None, retry_interval_in_minutes: int=None):
        """TargetChannelTargetInfo - a model defined in OpenAPI

        :param contact_channel_id: The contact_channel_id of this TargetChannelTargetInfo.
        :param retry_interval_in_minutes: The retry_interval_in_minutes of this TargetChannelTargetInfo.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TargetChannelTargetInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Target_ChannelTargetInfo of this TargetChannelTargetInfo.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def contact_channel_id(self):
        """Gets the contact_channel_id of this TargetChannelTargetInfo.


        :return: The contact_channel_id of this TargetChannelTargetInfo.
        :rtype: str
        """
    ...
    def contact_channel_id(self, contact_channel_id):
        """Sets the contact_channel_id of this TargetChannelTargetInfo.
    ...
    def retry_interval_in_minutes(self):
        """Gets the retry_interval_in_minutes of this TargetChannelTargetInfo.


        :return: The retry_interval_in_minutes of this TargetChannelTargetInfo.
        :rtype: int
        """
    ...
    def retry_interval_in_minutes(self, retry_interval_in_minutes):
        """Sets the retry_interval_in_minutes of this TargetChannelTargetInfo.
