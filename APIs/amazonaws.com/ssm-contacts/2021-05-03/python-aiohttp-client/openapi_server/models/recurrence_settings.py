...
class RecurrenceSettings(Model):
    ...
    def __init__(self, monthly_settings: List=None, weekly_settings: List=None, daily_settings: List=None, number_of_on_calls: int=None, shift_coverages: Dict=None, recurrence_multiplier: int=None):
        """RecurrenceSettings - a model defined in OpenAPI

        :param monthly_settings: The monthly_settings of this RecurrenceSettings.
        :param weekly_settings: The weekly_settings of this RecurrenceSettings.
        :param daily_settings: The daily_settings of this RecurrenceSettings.
        :param number_of_on_calls: The number_of_on_calls of this RecurrenceSettings.
        :param shift_coverages: The shift_coverages of this RecurrenceSettings.
        :param recurrence_multiplier: The recurrence_multiplier of this RecurrenceSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RecurrenceSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RecurrenceSettings of this RecurrenceSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def monthly_settings(self):
        """Gets the monthly_settings of this RecurrenceSettings.


        :return: The monthly_settings of this RecurrenceSettings.
        :rtype: List
        """
    ...
    def monthly_settings(self, monthly_settings):
        """Sets the monthly_settings of this RecurrenceSettings.
    ...
    def weekly_settings(self):
        """Gets the weekly_settings of this RecurrenceSettings.


        :return: The weekly_settings of this RecurrenceSettings.
        :rtype: List
        """
    ...
    def weekly_settings(self, weekly_settings):
        """Sets the weekly_settings of this RecurrenceSettings.
    ...
    def daily_settings(self):
        """Gets the daily_settings of this RecurrenceSettings.


        :return: The daily_settings of this RecurrenceSettings.
        :rtype: List
        """
    ...
    def daily_settings(self, daily_settings):
        """Sets the daily_settings of this RecurrenceSettings.
    ...
    def number_of_on_calls(self):
        """Gets the number_of_on_calls of this RecurrenceSettings.


        :return: The number_of_on_calls of this RecurrenceSettings.
        :rtype: int
        """
    ...
    def number_of_on_calls(self, number_of_on_calls):
        """Sets the number_of_on_calls of this RecurrenceSettings.
    ...
    def shift_coverages(self):
        """Gets the shift_coverages of this RecurrenceSettings.


        :return: The shift_coverages of this RecurrenceSettings.
        :rtype: Dict
        """
    ...
    def shift_coverages(self, shift_coverages):
        """Sets the shift_coverages of this RecurrenceSettings.
    ...
    def recurrence_multiplier(self):
        """Gets the recurrence_multiplier of this RecurrenceSettings.


        :return: The recurrence_multiplier of this RecurrenceSettings.
        :rtype: int
        """
    ...
    def recurrence_multiplier(self, recurrence_multiplier):
        """Sets the recurrence_multiplier of this RecurrenceSettings.
