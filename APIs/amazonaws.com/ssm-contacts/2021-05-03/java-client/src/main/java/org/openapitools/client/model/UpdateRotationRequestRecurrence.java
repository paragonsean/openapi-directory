...
public class UpdateRotationRequestRecurrence {
  ...
  public UpdateRotationRequestRecurrence() {
  }

  public UpdateRotationRequestRecurrence monthlySettings(List monthlySettings) {
  ...
  public UpdateRotationRequestRecurrence weeklySettings(List weeklySettings) {
  ...
  public UpdateRotationRequestRecurrence dailySettings(List dailySettings) {
  ...
  public UpdateRotationRequestRecurrence numberOfOnCalls(Integer numberOfOnCalls) {
  ...
  public UpdateRotationRequestRecurrence shiftCoverages(Map shiftCoverages) {
  ...
  public UpdateRotationRequestRecurrence recurrenceMultiplier(Integer recurrenceMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateRotationRequestRecurrence updateRotationRequestRecurrence = (UpdateRotationRequestRecurrence) o;
    return Objects.equals(this.monthlySettings, updateRotationRequestRecurrence.monthlySettings) &&
        Objects.equals(this.weeklySettings, updateRotationRequestRecurrence.weeklySettings) &&
        Objects.equals(this.dailySettings, updateRotationRequestRecurrence.dailySettings) &&
        Objects.equals(this.numberOfOnCalls, updateRotationRequestRecurrence.numberOfOnCalls) &&
        Objects.equals(this.shiftCoverages, updateRotationRequestRecurrence.shiftCoverages) &&
        Objects.equals(this.recurrenceMultiplier, updateRotationRequestRecurrence.recurrenceMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateRotationRequestRecurrence {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRotationRequestRecurrence
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRotationRequestRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRotationRequestRecurrence is not found in the empty JSON string", UpdateRotationRequestRecurrence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRotationRequestRecurrence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateRotationRequestRecurrence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateRotationRequestRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRotationRequestRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRotationRequestRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRotationRequestRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRotationRequestRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRotationRequestRecurrence>() {
           @Override
           public void write(JsonWriter out, UpdateRotationRequestRecurrence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRotationRequestRecurrence read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRotationRequestRecurrence given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRotationRequestRecurrence
   * @throws IOException if the JSON string is invalid with respect to UpdateRotationRequestRecurrence
   */
  public static UpdateRotationRequestRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRotationRequestRecurrence.class);
  }

  /**
   * Convert an instance of UpdateRotationRequestRecurrence to an JSON string
   *
   * @return JSON string
   */
