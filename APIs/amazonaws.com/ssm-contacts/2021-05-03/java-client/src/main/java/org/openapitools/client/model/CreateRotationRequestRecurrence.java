...
public class CreateRotationRequestRecurrence {
  ...
  public CreateRotationRequestRecurrence() {
  }

  public CreateRotationRequestRecurrence monthlySettings(List monthlySettings) {
  ...
  public CreateRotationRequestRecurrence weeklySettings(List weeklySettings) {
  ...
  public CreateRotationRequestRecurrence dailySettings(List dailySettings) {
  ...
  public CreateRotationRequestRecurrence numberOfOnCalls(Integer numberOfOnCalls) {
  ...
  public CreateRotationRequestRecurrence shiftCoverages(Map shiftCoverages) {
  ...
  public CreateRotationRequestRecurrence recurrenceMultiplier(Integer recurrenceMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRotationRequestRecurrence createRotationRequestRecurrence = (CreateRotationRequestRecurrence) o;
    return Objects.equals(this.monthlySettings, createRotationRequestRecurrence.monthlySettings) &&
        Objects.equals(this.weeklySettings, createRotationRequestRecurrence.weeklySettings) &&
        Objects.equals(this.dailySettings, createRotationRequestRecurrence.dailySettings) &&
        Objects.equals(this.numberOfOnCalls, createRotationRequestRecurrence.numberOfOnCalls) &&
        Objects.equals(this.shiftCoverages, createRotationRequestRecurrence.shiftCoverages) &&
        Objects.equals(this.recurrenceMultiplier, createRotationRequestRecurrence.recurrenceMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRotationRequestRecurrence {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRotationRequestRecurrence
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRotationRequestRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateRotationRequestRecurrence is not found in the empty JSON string", CreateRotationRequestRecurrence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRotationRequestRecurrence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateRotationRequestRecurrence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateRotationRequestRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRotationRequestRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRotationRequestRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRotationRequestRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRotationRequestRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRotationRequestRecurrence>() {
           @Override
           public void write(JsonWriter out, CreateRotationRequestRecurrence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRotationRequestRecurrence read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRotationRequestRecurrence given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRotationRequestRecurrence
   * @throws IOException if the JSON string is invalid with respect to CreateRotationRequestRecurrence
   */
  public static CreateRotationRequestRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRotationRequestRecurrence.class);
  }

  /**
   * Convert an instance of CreateRotationRequestRecurrence to an JSON string
   *
   * @return JSON string
   */
