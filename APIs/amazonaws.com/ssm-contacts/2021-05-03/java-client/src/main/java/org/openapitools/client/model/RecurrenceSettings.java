...
public class RecurrenceSettings {
  ...
  public RecurrenceSettings monthlySettings(List monthlySettings) {
  ...
  public RecurrenceSettings weeklySettings(List weeklySettings) {
  ...
  public RecurrenceSettings dailySettings(List dailySettings) {
  ...
  public RecurrenceSettings numberOfOnCalls(Integer numberOfOnCalls) {
  ...
  public RecurrenceSettings shiftCoverages(Map shiftCoverages) {
  ...
  public RecurrenceSettings recurrenceMultiplier(Integer recurrenceMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.monthlySettings, recurrenceSettings.monthlySettings) &&
        Objects.equals(this.weeklySettings, recurrenceSettings.weeklySettings) &&
        Objects.equals(this.dailySettings, recurrenceSettings.dailySettings) &&
        Objects.equals(this.numberOfOnCalls, recurrenceSettings.numberOfOnCalls) &&
        Objects.equals(this.shiftCoverages, recurrenceSettings.shiftCoverages) &&
        Objects.equals(this.recurrenceMultiplier, recurrenceSettings.recurrenceMultiplier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RecurrenceSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecurrenceSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurrenceSettings is not found in the empty JSON string", RecurrenceSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecurrenceSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecurrenceSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecurrenceSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurrenceSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurrenceSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurrenceSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurrenceSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurrenceSettings>() {
           @Override
           public void write(JsonWriter out, RecurrenceSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RecurrenceSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RecurrenceSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RecurrenceSettings
   * @throws IOException if the JSON string is invalid with respect to RecurrenceSettings
   */
  public static RecurrenceSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurrenceSettings.class);
  }

  /**
   * Convert an instance of RecurrenceSettings to an JSON string
   *
   * @return JSON string
   */
