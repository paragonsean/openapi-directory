...
public class ListPreviewRotationShiftsRequestRecurrence {
  ...
  public ListPreviewRotationShiftsRequestRecurrence() {
  }

  public ListPreviewRotationShiftsRequestRecurrence monthlySettings(List monthlySettings) {
  ...
  public ListPreviewRotationShiftsRequestRecurrence weeklySettings(List weeklySettings) {
  ...
  public ListPreviewRotationShiftsRequestRecurrence dailySettings(List dailySettings) {
  ...
  public ListPreviewRotationShiftsRequestRecurrence numberOfOnCalls(Integer numberOfOnCalls) {
  ...
  public ListPreviewRotationShiftsRequestRecurrence shiftCoverages(Map shiftCoverages) {
  ...
  public ListPreviewRotationShiftsRequestRecurrence recurrenceMultiplier(Integer recurrenceMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    ListPreviewRotationShiftsRequestRecurrence listPreviewRotationShiftsRequestRecurrence = (ListPreviewRotationShiftsRequestRecurrence) o;
    return Objects.equals(this.monthlySettings, listPreviewRotationShiftsRequestRecurrence.monthlySettings) &&
        Objects.equals(this.weeklySettings, listPreviewRotationShiftsRequestRecurrence.weeklySettings) &&
        Objects.equals(this.dailySettings, listPreviewRotationShiftsRequestRecurrence.dailySettings) &&
        Objects.equals(this.numberOfOnCalls, listPreviewRotationShiftsRequestRecurrence.numberOfOnCalls) &&
        Objects.equals(this.shiftCoverages, listPreviewRotationShiftsRequestRecurrence.shiftCoverages) &&
        Objects.equals(this.recurrenceMultiplier, listPreviewRotationShiftsRequestRecurrence.recurrenceMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPreviewRotationShiftsRequestRecurrence {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPreviewRotationShiftsRequestRecurrence
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPreviewRotationShiftsRequestRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPreviewRotationShiftsRequestRecurrence is not found in the empty JSON string", ListPreviewRotationShiftsRequestRecurrence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPreviewRotationShiftsRequestRecurrence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPreviewRotationShiftsRequestRecurrence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPreviewRotationShiftsRequestRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPreviewRotationShiftsRequestRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPreviewRotationShiftsRequestRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPreviewRotationShiftsRequestRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPreviewRotationShiftsRequestRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPreviewRotationShiftsRequestRecurrence>() {
           @Override
           public void write(JsonWriter out, ListPreviewRotationShiftsRequestRecurrence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPreviewRotationShiftsRequestRecurrence read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPreviewRotationShiftsRequestRecurrence given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPreviewRotationShiftsRequestRecurrence
   * @throws IOException if the JSON string is invalid with respect to ListPreviewRotationShiftsRequestRecurrence
   */
  public static ListPreviewRotationShiftsRequestRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPreviewRotationShiftsRequestRecurrence.class);
  }

  /**
   * Convert an instance of ListPreviewRotationShiftsRequestRecurrence to an JSON string
   *
   * @return JSON string
   */
