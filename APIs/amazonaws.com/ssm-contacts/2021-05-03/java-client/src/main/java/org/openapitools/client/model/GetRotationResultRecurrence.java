...
public class GetRotationResultRecurrence {
  ...
  public GetRotationResultRecurrence() {
  }

  public GetRotationResultRecurrence monthlySettings(List monthlySettings) {
  ...
  public GetRotationResultRecurrence weeklySettings(List weeklySettings) {
  ...
  public GetRotationResultRecurrence dailySettings(List dailySettings) {
  ...
  public GetRotationResultRecurrence numberOfOnCalls(Integer numberOfOnCalls) {
  ...
  public GetRotationResultRecurrence shiftCoverages(Map shiftCoverages) {
  ...
  public GetRotationResultRecurrence recurrenceMultiplier(Integer recurrenceMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    GetRotationResultRecurrence getRotationResultRecurrence = (GetRotationResultRecurrence) o;
    return Objects.equals(this.monthlySettings, getRotationResultRecurrence.monthlySettings) &&
        Objects.equals(this.weeklySettings, getRotationResultRecurrence.weeklySettings) &&
        Objects.equals(this.dailySettings, getRotationResultRecurrence.dailySettings) &&
        Objects.equals(this.numberOfOnCalls, getRotationResultRecurrence.numberOfOnCalls) &&
        Objects.equals(this.shiftCoverages, getRotationResultRecurrence.shiftCoverages) &&
        Objects.equals(this.recurrenceMultiplier, getRotationResultRecurrence.recurrenceMultiplier);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRotationResultRecurrence {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRotationResultRecurrence
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRotationResultRecurrence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetRotationResultRecurrence is not found in the empty JSON string", GetRotationResultRecurrence.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRotationResultRecurrence.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetRotationResultRecurrence` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetRotationResultRecurrence.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRotationResultRecurrence.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRotationResultRecurrence' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRotationResultRecurrence> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRotationResultRecurrence.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRotationResultRecurrence>() {
           @Override
           public void write(JsonWriter out, GetRotationResultRecurrence value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRotationResultRecurrence read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRotationResultRecurrence given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRotationResultRecurrence
   * @throws IOException if the JSON string is invalid with respect to GetRotationResultRecurrence
   */
  public static GetRotationResultRecurrence fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRotationResultRecurrence.class);
  }

  /**
   * Convert an instance of GetRotationResultRecurrence to an JSON string
   *
   * @return JSON string
   */
