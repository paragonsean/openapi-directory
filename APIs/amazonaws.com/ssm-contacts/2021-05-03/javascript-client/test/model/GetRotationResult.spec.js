...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.GetRotationResult();
  });
  ...
  describe('GetRotationResult', function() {
    it('should create an instance of GetRotationResult', function() {
      // uncomment below and update the code to test GetRotationResult
      //var instance = new AwsSystemsManagerIncidentManagerContacts.GetRotationResult();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.GetRotationResult);
    });
