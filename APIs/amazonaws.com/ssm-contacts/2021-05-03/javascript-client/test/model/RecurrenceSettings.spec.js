...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.RecurrenceSettings();
  });
  ...
  describe('RecurrenceSettings', function() {
    it('should create an instance of RecurrenceSettings', function() {
      // uncomment below and update the code to test RecurrenceSettings
      //var instance = new AwsSystemsManagerIncidentManagerContacts.RecurrenceSettings();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.RecurrenceSettings);
    });
