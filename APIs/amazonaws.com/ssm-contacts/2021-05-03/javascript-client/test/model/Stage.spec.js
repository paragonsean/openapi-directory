...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.Stage();
  });
  ...
  describe('Stage', function() {
    it('should create an instance of Stage', function() {
      ...
      //var instance = new AwsSystemsManagerIncidentManagerContacts.Stage();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.Stage);
    });
