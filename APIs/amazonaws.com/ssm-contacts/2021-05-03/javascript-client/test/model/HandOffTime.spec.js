...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.HandOffTime();
  });
  ...
  describe('HandOffTime', function() {
    it('should create an instance of HandOffTime', function() {
      // uncomment below and update the code to test HandOffTime
      //var instance = new AwsSystemsManagerIncidentManagerContacts.HandOffTime();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.HandOffTime);
    });
