...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.CreateRotationRequestRecurrence();
  });
  ...
  describe('CreateRotationRequestRecurrence', function() {
    it('should create an instance of CreateRotationRequestRecurrence', function() {
      // uncomment below and update the code to test CreateRotationRequestRecurrence
      //var instance = new AwsSystemsManagerIncidentManagerContacts.CreateRotationRequestRecurrence();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.CreateRotationRequestRecurrence);
    });
