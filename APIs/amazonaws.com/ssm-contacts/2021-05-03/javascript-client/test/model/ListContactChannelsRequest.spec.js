...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.ListContactChannelsRequest();
  });
  ...
  describe('ListContactChannelsRequest', function() {
    it('should create an instance of ListContactChannelsRequest', function() {
      // uncomment below and update the code to test ListContactChannelsRequest
      //var instance = new AwsSystemsManagerIncidentManagerContacts.ListContactChannelsRequest();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.ListContactChannelsRequest);
    });
