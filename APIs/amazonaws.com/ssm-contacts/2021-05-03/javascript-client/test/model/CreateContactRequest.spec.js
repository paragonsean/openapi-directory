...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.CreateContactRequest();
  });
  ...
  describe('CreateContactRequest', function() {
    it('should create an instance of CreateContactRequest', function() {
      // uncomment below and update the code to test CreateContactRequest
      //var instance = new AwsSystemsManagerIncidentManagerContacts.CreateContactRequest();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.CreateContactRequest);
    });
