...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.CoverageTimeStart();
  });
  ...
  describe('CoverageTimeStart', function() {
    it('should create an instance of CoverageTimeStart', function() {
      // uncomment below and update the code to test CoverageTimeStart
      //var instance = new AwsSystemsManagerIncidentManagerContacts.CoverageTimeStart();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.CoverageTimeStart);
    });
