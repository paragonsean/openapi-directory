...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.Tag();
  });
  ...
  describe('Tag', function() {
    it('should create an instance of Tag', function() {
      ...
      //var instance = new AwsSystemsManagerIncidentManagerContacts.Tag();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.Tag);
    });
