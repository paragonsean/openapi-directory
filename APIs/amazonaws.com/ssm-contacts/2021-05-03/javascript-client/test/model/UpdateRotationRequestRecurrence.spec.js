...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.UpdateRotationRequestRecurrence();
  });
  ...
  describe('UpdateRotationRequestRecurrence', function() {
    it('should create an instance of UpdateRotationRequestRecurrence', function() {
      // uncomment below and update the code to test UpdateRotationRequestRecurrence
      //var instance = new AwsSystemsManagerIncidentManagerContacts.UpdateRotationRequestRecurrence();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.UpdateRotationRequestRecurrence);
    });
