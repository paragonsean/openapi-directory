...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.CreateRotationRequest();
  });
  ...
  describe('CreateRotationRequest', function() {
    it('should create an instance of CreateRotationRequest', function() {
      // uncomment below and update the code to test CreateRotationRequest
      //var instance = new AwsSystemsManagerIncidentManagerContacts.CreateRotationRequest();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.CreateRotationRequest);
    });
