...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.ListPagesByContactRequest();
  });
  ...
  describe('ListPagesByContactRequest', function() {
    it('should create an instance of ListPagesByContactRequest', function() {
      // uncomment below and update the code to test ListPagesByContactRequest
      //var instance = new AwsSystemsManagerIncidentManagerContacts.ListPagesByContactRequest();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.ListPagesByContactRequest);
    });
