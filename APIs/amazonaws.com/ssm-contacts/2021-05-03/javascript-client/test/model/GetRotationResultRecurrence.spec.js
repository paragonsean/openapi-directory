...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.GetRotationResultRecurrence();
  });
  ...
  describe('GetRotationResultRecurrence', function() {
    it('should create an instance of GetRotationResultRecurrence', function() {
      // uncomment below and update the code to test GetRotationResultRecurrence
      //var instance = new AwsSystemsManagerIncidentManagerContacts.GetRotationResultRecurrence();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.GetRotationResultRecurrence);
    });
