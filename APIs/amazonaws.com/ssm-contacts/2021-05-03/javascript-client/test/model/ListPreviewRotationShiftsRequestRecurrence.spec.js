...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequestRecurrence();
  });
  ...
  describe('ListPreviewRotationShiftsRequestRecurrence', function() {
    it('should create an instance of ListPreviewRotationShiftsRequestRecurrence', function() {
      // uncomment below and update the code to test ListPreviewRotationShiftsRequestRecurrence
      //var instance = new AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequestRecurrence();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequestRecurrence);
    });
