...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.Plan();
  });
  ...
  describe('Plan', function() {
    it('should create an instance of Plan', function() {
      ...
      //var instance = new AwsSystemsManagerIncidentManagerContacts.Plan();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.Plan);
    });
    ...
    it('should have the property rotationIds (base name: "RotationIds")', function() {
      // uncomment below and update the code to test the property rotationIds
      //var instance = new AwsSystemsManagerIncidentManagerContacts.Plan();
      //expect(instance).to.be();
    });
