...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequest();
  });
  ...
  describe('ListPreviewRotationShiftsRequest', function() {
    it('should create an instance of ListPreviewRotationShiftsRequest', function() {
      // uncomment below and update the code to test ListPreviewRotationShiftsRequest
      //var instance = new AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequest();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequest);
    });

    it('should have the property rotationStartTime (base name: "RotationStartTime")', function() {
      // uncomment below and update the code to test the property rotationStartTime
      //var instance = new AwsSystemsManagerIncidentManagerContacts.ListPreviewRotationShiftsRequest();
