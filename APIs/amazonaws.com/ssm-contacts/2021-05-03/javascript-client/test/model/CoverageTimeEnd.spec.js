...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.CoverageTimeEnd();
  });
  ...
  describe('CoverageTimeEnd', function() {
    it('should create an instance of CoverageTimeEnd', function() {
      // uncomment below and update the code to test CoverageTimeEnd
      //var instance = new AwsSystemsManagerIncidentManagerContacts.CoverageTimeEnd();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.CoverageTimeEnd);
    });
