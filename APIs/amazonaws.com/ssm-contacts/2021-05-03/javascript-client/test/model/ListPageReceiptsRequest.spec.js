...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsSystemsManagerIncidentManagerContacts.ListPageReceiptsRequest();
  });
  ...
  describe('ListPageReceiptsRequest', function() {
    it('should create an instance of ListPageReceiptsRequest', function() {
      // uncomment below and update the code to test ListPageReceiptsRequest
      //var instance = new AwsSystemsManagerIncidentManagerContacts.ListPageReceiptsRequest();
      //expect(instance).to.be.a(AwsSystemsManagerIncidentManagerContacts.ListPageReceiptsRequest);
    });
