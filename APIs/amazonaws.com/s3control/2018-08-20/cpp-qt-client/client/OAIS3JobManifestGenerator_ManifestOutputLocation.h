...
/*
 * OAIS3JobManifestGenerator_ManifestOutputLocation.h
 *
 * 
 */

#ifndef OAIS3JobManifestGenerator_ManifestOutputLocation_H
#define OAIS3JobManifestGenerator_ManifestOutputLocation_H
...
class OAIS3JobManifestGenerator_ManifestOutputLocation : public OAIObject {
public:
    OAIS3JobManifestGenerator_ManifestOutputLocation();
    OAIS3JobManifestGenerator_ManifestOutputLocation(QString json);
    ~OAIS3JobManifestGenerator_ManifestOutputLocation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3JobManifestGenerator_ManifestOutputLocation)

#endif // OAIS3JobManifestGenerator_ManifestOutputLocation_H
