...
/*
 * OAIReplicationRules_inner.h
 *
 * 
 */

#ifndef OAIReplicationRules_inner_H
#define OAIReplicationRules_inner_H
...
class OAIReplicationRules_inner : public OAIObject {
public:
    OAIReplicationRules_inner();
    OAIReplicationRules_inner(QString json);
    ~OAIReplicationRules_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIReplicationRules_inner)

#endif // OAIReplicationRules_inner_H
