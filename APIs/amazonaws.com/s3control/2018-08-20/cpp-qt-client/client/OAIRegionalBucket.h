...
#ifndef OAIRegionalBucket_H
#define OAIRegionalBucket_H
...
class OAIRegionalBucket : public OAIObject {
public:
    OAIRegionalBucket();
    OAIRegionalBucket(QString json);
    ~OAIRegionalBucket() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRegionalBucket)

#endif // OAIRegionalBucket_H
