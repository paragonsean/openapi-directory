...
/*
 * OAIDetailedStatusCodesMetrics.h
 *
...
#ifndef OAIDetailedStatusCodesMetrics_H
#define OAIDetailedStatusCodesMetrics_H
...
class OAIDetailedStatusCodesMetrics : public OAIObject {
public:
    OAIDetailedStatusCodesMetrics();
    OAIDetailedStatusCodesMetrics(QString json);
    ~OAIDetailedStatusCodesMetrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetailedStatusCodesMetrics)

#endif // OAIDetailedStatusCodesMetrics_H
