...
OAIJobOperation::OAIJobOperation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIJobOperation::OAIJobOperation() {
    this->initializeModel();
}

OAIJobOperation::~OAIJobOperation() {}

void OAIJobOperation::initializeModel() {
...
void OAIJobOperation::fromJson(QString jsonString) {
...
void OAIJobOperation::fromJsonObject(QJsonObject json) {
...
QString OAIJobOperation::asJson() const {
...
QJsonObject OAIJobOperation::asJsonObject() const {
    QJsonObject obj;
...
OAICreateJob_request_Operation_LambdaInvoke OAIJobOperation::getLambdaInvoke() const {
    return m_lambda_invoke;
}
void OAIJobOperation::setLambdaInvoke(const OAICreateJob_request_Operation_LambdaInvoke &lambda_invoke) {
    m_lambda_invoke = lambda_invoke;
    m_lambda_invoke_isSet = true;
}

bool OAIJobOperation::is_lambda_invoke_Set() const{
    return m_lambda_invoke_isSet;
}

bool OAIJobOperation::is_lambda_invoke_Valid() const{
    return m_lambda_invoke_isValid;
}

OAICreateJob_request_Operation_S3PutObjectCopy OAIJobOperation::getS3PutObjectCopy() const {
    return m_s3_put_object_copy;
}
void OAIJobOperation::setS3PutObjectCopy(const OAICreateJob_request_Operation_S3PutObjectCopy &s3_put_object_copy) {
    m_s3_put_object_copy = s3_put_object_copy;
    m_s3_put_object_copy_isSet = true;
}

bool OAIJobOperation::is_s3_put_object_copy_Set() const{
    return m_s3_put_object_copy_isSet;
}

bool OAIJobOperation::is_s3_put_object_copy_Valid() const{
    return m_s3_put_object_copy_isValid;
}

OAICreateJob_request_Operation_S3PutObjectAcl OAIJobOperation::getS3PutObjectAcl() const {
    return m_s3_put_object_acl;
}
void OAIJobOperation::setS3PutObjectAcl(const OAICreateJob_request_Operation_S3PutObjectAcl &s3_put_object_acl) {
    m_s3_put_object_acl = s3_put_object_acl;
    m_s3_put_object_acl_isSet = true;
}

bool OAIJobOperation::is_s3_put_object_acl_Set() const{
    return m_s3_put_object_acl_isSet;
}

bool OAIJobOperation::is_s3_put_object_acl_Valid() const{
    return m_s3_put_object_acl_isValid;
}

OAICreateJob_request_Operation_S3PutObjectTagging OAIJobOperation::getS3PutObjectTagging() const {
    return m_s3_put_object_tagging;
}
void OAIJobOperation::setS3PutObjectTagging(const OAICreateJob_request_Operation_S3PutObjectTagging &s3_put_object_tagging) {
    m_s3_put_object_tagging = s3_put_object_tagging;
    m_s3_put_object_tagging_isSet = true;
}

bool OAIJobOperation::is_s3_put_object_tagging_Set() const{
    return m_s3_put_object_tagging_isSet;
}

bool OAIJobOperation::is_s3_put_object_tagging_Valid() const{
    return m_s3_put_object_tagging_isValid;
}

OAIObject OAIJobOperation::getS3DeleteObjectTagging() const {
    return m_s3_delete_object_tagging;
}
void OAIJobOperation::setS3DeleteObjectTagging(const OAIObject &s3_delete_object_tagging) {
    m_s3_delete_object_tagging = s3_delete_object_tagging;
    m_s3_delete_object_tagging_isSet = true;
}

bool OAIJobOperation::is_s3_delete_object_tagging_Set() const{
    return m_s3_delete_object_tagging_isSet;
}

bool OAIJobOperation::is_s3_delete_object_tagging_Valid() const{
    return m_s3_delete_object_tagging_isValid;
}

OAICreateJob_request_Operation_S3InitiateRestoreObject OAIJobOperation::getS3InitiateRestoreObject() const {
    return m_s3_initiate_restore_object;
}
void OAIJobOperation::setS3InitiateRestoreObject(const OAICreateJob_request_Operation_S3InitiateRestoreObject &s3_initiate_restore_object) {
    m_s3_initiate_restore_object = s3_initiate_restore_object;
    m_s3_initiate_restore_object_isSet = true;
}

bool OAIJobOperation::is_s3_initiate_restore_object_Set() const{
    return m_s3_initiate_restore_object_isSet;
}

bool OAIJobOperation::is_s3_initiate_restore_object_Valid() const{
    return m_s3_initiate_restore_object_isValid;
}

OAIS3SetObjectLegalHoldOperation OAIJobOperation::getS3PutObjectLegalHold() const {
    return m_s3_put_object_legal_hold;
}
void OAIJobOperation::setS3PutObjectLegalHold(const OAIS3SetObjectLegalHoldOperation &s3_put_object_legal_hold) {
    m_s3_put_object_legal_hold = s3_put_object_legal_hold;
    m_s3_put_object_legal_hold_isSet = true;
}

bool OAIJobOperation::is_s3_put_object_legal_hold_Set() const{
    return m_s3_put_object_legal_hold_isSet;
}

bool OAIJobOperation::is_s3_put_object_legal_hold_Valid() const{
    return m_s3_put_object_legal_hold_isValid;
}

OAIS3SetObjectRetentionOperation OAIJobOperation::getS3PutObjectRetention() const {
    return m_s3_put_object_retention;
}
void OAIJobOperation::setS3PutObjectRetention(const OAIS3SetObjectRetentionOperation &s3_put_object_retention) {
    m_s3_put_object_retention = s3_put_object_retention;
    m_s3_put_object_retention_isSet = true;
}

bool OAIJobOperation::is_s3_put_object_retention_Set() const{
    return m_s3_put_object_retention_isSet;
}

bool OAIJobOperation::is_s3_put_object_retention_Valid() const{
    return m_s3_put_object_retention_isValid;
}

OAIObject OAIJobOperation::getS3ReplicateObject() const {
    return m_s3_replicate_object;
}
void OAIJobOperation::setS3ReplicateObject(const OAIObject &s3_replicate_object) {
    m_s3_replicate_object = s3_replicate_object;
    m_s3_replicate_object_isSet = true;
}

bool OAIJobOperation::is_s3_replicate_object_Set() const{
    return m_s3_replicate_object_isSet;
}

bool OAIJobOperation::is_s3_replicate_object_Valid() const{
    return m_s3_replicate_object_isValid;
}

bool OAIJobOperation::isSet() const {
...
bool OAIJobOperation::isValid() const {
