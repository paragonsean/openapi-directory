...
QString OAIReplicationConfiguration::getRole() const {
    return m_role;
}
void OAIReplicationConfiguration::setRole(const QString &role) {
    m_role = role;
    m_role_isSet = true;
}

bool OAIReplicationConfiguration::is_role_Set() const{
    return m_role_isSet;
}

bool OAIReplicationConfiguration::is_role_Valid() const{
