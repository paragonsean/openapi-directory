...
/*
 * OAIS3ObjectMetadata.h
 *
 * &lt;p/&gt;
 */

#ifndef OAIS3ObjectMetadata_H
#define OAIS3ObjectMetadata_H
...
class OAIS3ObjectMetadata : public OAIObject {
public:
    OAIS3ObjectMetadata();
    OAIS3ObjectMetadata(QString json);
    ~OAIS3ObjectMetadata() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIS3ObjectMetadata)

#endif // OAIS3ObjectMetadata_H
