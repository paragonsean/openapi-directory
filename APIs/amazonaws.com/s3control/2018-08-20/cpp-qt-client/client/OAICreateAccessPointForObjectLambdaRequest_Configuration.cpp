...
OAICreateAccessPointForObjectLambdaRequest_Configuration::OAICreateAccessPointForObjectLambdaRequest_Configuration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateAccessPointForObjectLambdaRequest_Configuration::OAICreateAccessPointForObjectLambdaRequest_Configuration() {
    this->initializeModel();
}

OAICreateAccessPointForObjectLambdaRequest_Configuration::~OAICreateAccessPointForObjectLambdaRequest_Configuration() {}

void OAICreateAccessPointForObjectLambdaRequest_Configuration::initializeModel() {
...
void OAICreateAccessPointForObjectLambdaRequest_Configuration::fromJson(QString jsonString) {
...
void OAICreateAccessPointForObjectLambdaRequest_Configuration::fromJsonObject(QJsonObject json) {
...
QString OAICreateAccessPointForObjectLambdaRequest_Configuration::asJson() const {
...
QJsonObject OAICreateAccessPointForObjectLambdaRequest_Configuration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateAccessPointForObjectLambdaRequest_Configuration::getSupportingAccessPoint() const {
    return m_supporting_access_point;
}
void OAICreateAccessPointForObjectLambdaRequest_Configuration::setSupportingAccessPoint(const QString &supporting_access_point) {
    m_supporting_access_point = supporting_access_point;
    m_supporting_access_point_isSet = true;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_supporting_access_point_Set() const{
    return m_supporting_access_point_isSet;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_supporting_access_point_Valid() const{
    return m_supporting_access_point_isValid;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::getCloudWatchMetricsEnabled() const {
    return m_cloud_watch_metrics_enabled;
}
void OAICreateAccessPointForObjectLambdaRequest_Configuration::setCloudWatchMetricsEnabled(const bool &cloud_watch_metrics_enabled) {
    m_cloud_watch_metrics_enabled = cloud_watch_metrics_enabled;
    m_cloud_watch_metrics_enabled_isSet = true;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_cloud_watch_metrics_enabled_Set() const{
    return m_cloud_watch_metrics_enabled_isSet;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_cloud_watch_metrics_enabled_Valid() const{
    return m_cloud_watch_metrics_enabled_isValid;
}

QList OAICreateAccessPointForObjectLambdaRequest_Configuration::getAllowedFeatures() const {
    return m_allowed_features;
}
void OAICreateAccessPointForObjectLambdaRequest_Configuration::setAllowedFeatures(const QList &allowed_features) {
    m_allowed_features = allowed_features;
    m_allowed_features_isSet = true;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_allowed_features_Set() const{
    return m_allowed_features_isSet;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_allowed_features_Valid() const{
    return m_allowed_features_isValid;
}

QList OAICreateAccessPointForObjectLambdaRequest_Configuration::getTransformationConfigurations() const {
    return m_transformation_configurations;
}
void OAICreateAccessPointForObjectLambdaRequest_Configuration::setTransformationConfigurations(const QList &transformation_configurations) {
    m_transformation_configurations = transformation_configurations;
    m_transformation_configurations_isSet = true;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_transformation_configurations_Set() const{
    return m_transformation_configurations_isSet;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::is_transformation_configurations_Valid() const{
    return m_transformation_configurations_isValid;
}

bool OAICreateAccessPointForObjectLambdaRequest_Configuration::isSet() const {
...
bool OAICreateAccessPointForObjectLambdaRequest_Configuration::isValid() const {
