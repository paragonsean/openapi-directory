...
/*
 * OAICreateAccessPointForObjectLambdaRequest_Configuration.h
 *
 * 
 */

#ifndef OAICreateAccessPointForObjectLambdaRequest_Configuration_H
#define OAICreateAccessPointForObjectLambdaRequest_Configuration_H
...
class OAICreateAccessPointForObjectLambdaRequest_Configuration : public OAIObject {
public:
    OAICreateAccessPointForObjectLambdaRequest_Configuration();
    OAICreateAccessPointForObjectLambdaRequest_Configuration(QString json);
    ~OAICreateAccessPointForObjectLambdaRequest_Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessPointForObjectLambdaRequest_Configuration)

#endif // OAICreateAccessPointForObjectLambdaRequest_Configuration_H
