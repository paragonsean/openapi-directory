...
/*
 * OAIAdvancedCostOptimizationMetrics.h
 *
...
#ifndef OAIAdvancedCostOptimizationMetrics_H
#define OAIAdvancedCostOptimizationMetrics_H
...
class OAIAdvancedCostOptimizationMetrics : public OAIObject {
public:
    OAIAdvancedCostOptimizationMetrics();
    OAIAdvancedCostOptimizationMetrics(QString json);
    ~OAIAdvancedCostOptimizationMetrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAdvancedCostOptimizationMetrics)

#endif // OAIAdvancedCostOptimizationMetrics_H
