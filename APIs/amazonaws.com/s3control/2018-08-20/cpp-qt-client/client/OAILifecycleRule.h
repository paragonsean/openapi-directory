...
#ifndef OAILifecycleRule_H
#define OAILifecycleRule_H
...
class OAILifecycleRule : public OAIObject {
public:
    OAILifecycleRule();
    OAILifecycleRule(QString json);
    ~OAILifecycleRule() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILifecycleRule)

#endif // OAILifecycleRule_H
