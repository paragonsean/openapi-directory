...
/*
 * OAIStorageLensDataExport_S3BucketDestination.h
 *
 * 
 */

#ifndef OAIStorageLensDataExport_S3BucketDestination_H
#define OAIStorageLensDataExport_S3BucketDestination_H
...
class OAIStorageLensDataExport_S3BucketDestination : public OAIObject {
public:
    OAIStorageLensDataExport_S3BucketDestination();
    OAIStorageLensDataExport_S3BucketDestination(QString json);
    ~OAIStorageLensDataExport_S3BucketDestination() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStorageLensDataExport_S3BucketDestination)

#endif // OAIStorageLensDataExport_S3BucketDestination_H
