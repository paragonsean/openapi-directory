...
/*
 * OAILifecycleRuleFilter.h
 *
 * The container for the filter of the lifecycle rule.
 */

#ifndef OAILifecycleRuleFilter_H
#define OAILifecycleRuleFilter_H
...
class OAILifecycleRuleFilter : public OAIObject {
public:
    OAILifecycleRuleFilter();
    OAILifecycleRuleFilter(QString json);
    ~OAILifecycleRuleFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILifecycleRuleFilter)

#endif // OAILifecycleRuleFilter_H
