...
/*
 * OAICreateAccessPointForObjectLambda_request_Configuration.h
 *
 * A configuration used when creating an Object Lambda Access Point.
 */

#ifndef OAICreateAccessPointForObjectLambda_request_Configuration_H
#define OAICreateAccessPointForObjectLambda_request_Configuration_H
...
class OAICreateAccessPointForObjectLambda_request_Configuration : public OAIObject {
public:
    OAICreateAccessPointForObjectLambda_request_Configuration();
    OAICreateAccessPointForObjectLambda_request_Configuration(QString json);
    ~OAICreateAccessPointForObjectLambda_request_Configuration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateAccessPointForObjectLambda_request_Configuration)

#endif // OAICreateAccessPointForObjectLambda_request_Configuration_H
