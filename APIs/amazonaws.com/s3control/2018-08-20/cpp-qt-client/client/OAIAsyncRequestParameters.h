...
/*
 * OAIAsyncRequestParameters.h
 *
 * A container for the request parameters associated with an asynchronous request.
 */

#ifndef OAIAsyncRequestParameters_H
#define OAIAsyncRequestParameters_H
...
class OAIAsyncRequestParameters : public OAIObject {
public:
    OAIAsyncRequestParameters();
    OAIAsyncRequestParameters(QString json);
    ~OAIAsyncRequestParameters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAsyncRequestParameters)

#endif // OAIAsyncRequestParameters_H
