...
/*
 * OAILifecycleRuleAndOperator.h
 *
 * The container for the Outposts bucket lifecycle rule and operator.
 */

#ifndef OAILifecycleRuleAndOperator_H
#define OAILifecycleRuleAndOperator_H
...
class OAILifecycleRuleAndOperator : public OAIObject {
public:
    OAILifecycleRuleAndOperator();
    OAILifecycleRuleAndOperator(QString json);
    ~OAILifecycleRuleAndOperator() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILifecycleRuleAndOperator)

#endif // OAILifecycleRuleAndOperator_H
