...
/*
 * OAIEstablishedMultiRegionAccessPointPolicy.h
 *
...
#ifndef OAIEstablishedMultiRegionAccessPointPolicy_H
#define OAIEstablishedMultiRegionAccessPointPolicy_H
...
class OAIEstablishedMultiRegionAccessPointPolicy : public OAIObject {
public:
    OAIEstablishedMultiRegionAccessPointPolicy();
    OAIEstablishedMultiRegionAccessPointPolicy(QString json);
    ~OAIEstablishedMultiRegionAccessPointPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEstablishedMultiRegionAccessPointPolicy)

#endif // OAIEstablishedMultiRegionAccessPointPolicy_H
