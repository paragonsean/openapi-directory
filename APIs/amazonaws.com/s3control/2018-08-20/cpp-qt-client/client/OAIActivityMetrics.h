...
#ifndef OAIActivityMetrics_H
#define OAIActivityMetrics_H
...
class OAIActivityMetrics : public OAIObject {
public:
    OAIActivityMetrics();
    OAIActivityMetrics(QString json);
    ~OAIActivityMetrics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActivityMetrics)

#endif // OAIActivityMetrics_H
