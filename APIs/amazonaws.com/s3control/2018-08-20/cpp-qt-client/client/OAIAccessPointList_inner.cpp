...
#include "OAIAccessPointList_inner.h"
...
OAIAccessPointList_inner::OAIAccessPointList_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAccessPointList_inner::OAIAccessPointList_inner() {
    this->initializeModel();
}

OAIAccessPointList_inner::~OAIAccessPointList_inner() {}

void OAIAccessPointList_inner::initializeModel() {
...
void OAIAccessPointList_inner::fromJson(QString jsonString) {
...
void OAIAccessPointList_inner::fromJsonObject(QJsonObject json) {
...
QString OAIAccessPointList_inner::asJson() const {
...
QJsonObject OAIAccessPointList_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIAccessPointList_inner::getName() const {
    return m_name;
}
void OAIAccessPointList_inner::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIAccessPointList_inner::is_name_Set() const{
    return m_name_isSet;
}

bool OAIAccessPointList_inner::is_name_Valid() const{
    return m_name_isValid;
}

OAINetworkOrigin OAIAccessPointList_inner::getNetworkOrigin() const {
    return m_network_origin;
}
void OAIAccessPointList_inner::setNetworkOrigin(const OAINetworkOrigin &network_origin) {
    m_network_origin = network_origin;
    m_network_origin_isSet = true;
}

bool OAIAccessPointList_inner::is_network_origin_Set() const{
    return m_network_origin_isSet;
}

bool OAIAccessPointList_inner::is_network_origin_Valid() const{
    return m_network_origin_isValid;
}

OAIAccessPoint_VpcConfiguration OAIAccessPointList_inner::getVpcConfiguration() const {
    return m_vpc_configuration;
}
void OAIAccessPointList_inner::setVpcConfiguration(const OAIAccessPoint_VpcConfiguration &vpc_configuration) {
    m_vpc_configuration = vpc_configuration;
    m_vpc_configuration_isSet = true;
}

bool OAIAccessPointList_inner::is_vpc_configuration_Set() const{
    return m_vpc_configuration_isSet;
}

bool OAIAccessPointList_inner::is_vpc_configuration_Valid() const{
    return m_vpc_configuration_isValid;
}

QString OAIAccessPointList_inner::getBucket() const {
    return m_bucket;
}
void OAIAccessPointList_inner::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAIAccessPointList_inner::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAIAccessPointList_inner::is_bucket_Valid() const{
    return m_bucket_isValid;
}

QString OAIAccessPointList_inner::getAccessPointArn() const {
    return m_access_point_arn;
}
void OAIAccessPointList_inner::setAccessPointArn(const QString &access_point_arn) {
    m_access_point_arn = access_point_arn;
    m_access_point_arn_isSet = true;
}

bool OAIAccessPointList_inner::is_access_point_arn_Set() const{
    return m_access_point_arn_isSet;
}

bool OAIAccessPointList_inner::is_access_point_arn_Valid() const{
    return m_access_point_arn_isValid;
}

QString OAIAccessPointList_inner::getAlias() const {
    return m_alias;
}
void OAIAccessPointList_inner::setAlias(const QString &alias) {
    m_alias = alias;
    m_alias_isSet = true;
}

bool OAIAccessPointList_inner::is_alias_Set() const{
    return m_alias_isSet;
}

bool OAIAccessPointList_inner::is_alias_Valid() const{
    return m_alias_isValid;
}

QString OAIAccessPointList_inner::getBucketAccountId() const {
    return m_bucket_account_id;
}
void OAIAccessPointList_inner::setBucketAccountId(const QString &bucket_account_id) {
    m_bucket_account_id = bucket_account_id;
    m_bucket_account_id_isSet = true;
}

bool OAIAccessPointList_inner::is_bucket_account_id_Set() const{
    return m_bucket_account_id_isSet;
}

bool OAIAccessPointList_inner::is_bucket_account_id_Valid() const{
    return m_bucket_account_id_isValid;
}

bool OAIAccessPointList_inner::isSet() const {
...
bool OAIAccessPointList_inner::isValid() const {
