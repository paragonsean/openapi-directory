...
public class DescribeJobResultJob {
  ...
  public DescribeJobResultJob() {
  }

  public DescribeJobResultJob jobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public DescribeJobResultJob confirmationRequired(Boolean confirmationRequired) {
  ...
  public DescribeJobResultJob description(String description) {
  ...
  public DescribeJobResultJob jobArn(String jobArn) {
    this.jobArn = jobArn;
    return this;
  }
  ...
  public DescribeJobResultJob status(JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeJobResultJob manifest(JobDescriptorManifest manifest) {
  ...
  public DescribeJobResultJob operation(JobDescriptorOperation operation) {
  ...
  public DescribeJobResultJob priority(Integer priority) {
  ...
  public DescribeJobResultJob progressSummary(JobDescriptorProgressSummary progressSummary) {
  ...
  public DescribeJobResultJob statusUpdateReason(String statusUpdateReason) {
  ...
  public DescribeJobResultJob failureReasons(List failureReasons) {
  ...
  public DescribeJobResultJob report(JobDescriptorReport report) {
    this.report = report;
    return this;
  }
  ...
  public DescribeJobResultJob creationTime(OffsetDateTime creationTime) {
  ...
  public DescribeJobResultJob terminationDate(OffsetDateTime terminationDate) {
  ...
  public DescribeJobResultJob roleArn(String roleArn) {
  ...
  public DescribeJobResultJob suspendedDate(OffsetDateTime suspendedDate) {
  ...
  public DescribeJobResultJob suspendedCause(String suspendedCause) {
  ...
  public DescribeJobResultJob manifestGenerator(JobDescriptorManifestGenerator manifestGenerator) {
  ...
  public DescribeJobResultJob generatedManifestDescriptor(JobDescriptorGeneratedManifestDescriptor generatedManifestDescriptor) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeJobResultJob describeJobResultJob = (DescribeJobResultJob) o;
    return Objects.equals(this.jobId, describeJobResultJob.jobId) &&
        Objects.equals(this.confirmationRequired, describeJobResultJob.confirmationRequired) &&
        Objects.equals(this.description, describeJobResultJob.description) &&
        Objects.equals(this.jobArn, describeJobResultJob.jobArn) &&
        Objects.equals(this.status, describeJobResultJob.status) &&
        Objects.equals(this.manifest, describeJobResultJob.manifest) &&
        Objects.equals(this.operation, describeJobResultJob.operation) &&
        Objects.equals(this.priority, describeJobResultJob.priority) &&
        Objects.equals(this.progressSummary, describeJobResultJob.progressSummary) &&
        Objects.equals(this.statusUpdateReason, describeJobResultJob.statusUpdateReason) &&
        Objects.equals(this.failureReasons, describeJobResultJob.failureReasons) &&
        Objects.equals(this.report, describeJobResultJob.report) &&
        Objects.equals(this.creationTime, describeJobResultJob.creationTime) &&
        Objects.equals(this.terminationDate, describeJobResultJob.terminationDate) &&
        Objects.equals(this.roleArn, describeJobResultJob.roleArn) &&
        Objects.equals(this.suspendedDate, describeJobResultJob.suspendedDate) &&
        Objects.equals(this.suspendedCause, describeJobResultJob.suspendedCause) &&
        Objects.equals(this.manifestGenerator, describeJobResultJob.manifestGenerator) &&
        Objects.equals(this.generatedManifestDescriptor, describeJobResultJob.generatedManifestDescriptor);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeJobResultJob {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeJobResultJob
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeJobResultJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeJobResultJob is not found in the empty JSON string", DescribeJobResultJob.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeJobResultJob.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeJobResultJob` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeJobResultJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeJobResultJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeJobResultJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeJobResultJob.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeJobResultJob>() {
           @Override
           public void write(JsonWriter out, DescribeJobResultJob value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeJobResultJob read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeJobResultJob given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeJobResultJob
   * @throws IOException if the JSON string is invalid with respect to DescribeJobResultJob
   */
  public static DescribeJobResultJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeJobResultJob.class);
  }

  /**
   * Convert an instance of DescribeJobResultJob to an JSON string
   *
   * @return JSON string
   */
