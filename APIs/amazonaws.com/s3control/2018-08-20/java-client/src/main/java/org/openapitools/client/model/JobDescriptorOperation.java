...
public class JobDescriptorOperation {
  ...
  public JobDescriptorOperation() {
  }

  public JobDescriptorOperation lambdaInvoke(CreateJobRequestOperationLambdaInvoke lambdaInvoke) {
  ...
  public JobDescriptorOperation s3PutObjectCopy(CreateJobRequestOperationS3PutObjectCopy s3PutObjectCopy) {
  ...
  public JobDescriptorOperation s3PutObjectAcl(CreateJobRequestOperationS3PutObjectAcl s3PutObjectAcl) {
  ...
  public JobDescriptorOperation s3PutObjectTagging(CreateJobRequestOperationS3PutObjectTagging s3PutObjectTagging) {
  ...
  public JobDescriptorOperation s3DeleteObjectTagging(Object s3DeleteObjectTagging) {
  ...
  public JobDescriptorOperation s3InitiateRestoreObject(CreateJobRequestOperationS3InitiateRestoreObject s3InitiateRestoreObject) {
  ...
  public JobDescriptorOperation s3PutObjectLegalHold(S3SetObjectLegalHoldOperation s3PutObjectLegalHold) {
  ...
  public JobDescriptorOperation s3PutObjectRetention(S3SetObjectRetentionOperation s3PutObjectRetention) {
  ...
  public JobDescriptorOperation s3ReplicateObject(Object s3ReplicateObject) {
  ...
  public boolean equals(Object o) {
    ...
    JobDescriptorOperation jobDescriptorOperation = (JobDescriptorOperation) o;
    return Objects.equals(this.lambdaInvoke, jobDescriptorOperation.lambdaInvoke) &&
        Objects.equals(this.s3PutObjectCopy, jobDescriptorOperation.s3PutObjectCopy) &&
        Objects.equals(this.s3PutObjectAcl, jobDescriptorOperation.s3PutObjectAcl) &&
        Objects.equals(this.s3PutObjectTagging, jobDescriptorOperation.s3PutObjectTagging) &&
        Objects.equals(this.s3DeleteObjectTagging, jobDescriptorOperation.s3DeleteObjectTagging) &&
        Objects.equals(this.s3InitiateRestoreObject, jobDescriptorOperation.s3InitiateRestoreObject) &&
        Objects.equals(this.s3PutObjectLegalHold, jobDescriptorOperation.s3PutObjectLegalHold) &&
        Objects.equals(this.s3PutObjectRetention, jobDescriptorOperation.s3PutObjectRetention) &&
        Objects.equals(this.s3ReplicateObject, jobDescriptorOperation.s3ReplicateObject);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobDescriptorOperation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to JobDescriptorOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JobDescriptorOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobDescriptorOperation is not found in the empty JSON string", JobDescriptorOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JobDescriptorOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JobDescriptorOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobDescriptorOperation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobDescriptorOperation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobDescriptorOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobDescriptorOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<JobDescriptorOperation>() {
           @Override
           public void write(JsonWriter out, JobDescriptorOperation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public JobDescriptorOperation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of JobDescriptorOperation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of JobDescriptorOperation
   * @throws IOException if the JSON string is invalid with respect to JobDescriptorOperation
   */
  public static JobDescriptorOperation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobDescriptorOperation.class);
  }

  /**
   * Convert an instance of JobDescriptorOperation to an JSON string
   *
   * @return JSON string
   */
