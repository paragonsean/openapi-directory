...
public class ApiClient {
    ...
    private String basePath = "http://s3-control.us-east-1.amazonaws.com";
    ...
    new ServerConfiguration(
      "https://s3-control.{region}.amazonaws.com",
      "The AWS S3 Control multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://s3-control.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://s3-control.{region}.amazonaws.com.cn",
      "The AWS S3 Control endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-08-20/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://s3-control.us-east-1.amazonaws.com
