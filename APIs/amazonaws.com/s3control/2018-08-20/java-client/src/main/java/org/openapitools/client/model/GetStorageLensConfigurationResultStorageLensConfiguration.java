...
public class GetStorageLensConfigurationResultStorageLensConfiguration {
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration() {
  }

  public GetStorageLensConfigurationResultStorageLensConfiguration id(String id) {
    this.id = id;
    return this;
  }
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration accountLevel(PutStorageLensConfigurationRequestStorageLensConfigurationAccountLevel accountLevel) {
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration include(PutStorageLensConfigurationRequestStorageLensConfigurationInclude include) {
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration exclude(PutStorageLensConfigurationRequestStorageLensConfigurationExclude exclude) {
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration dataExport(PutStorageLensConfigurationRequestStorageLensConfigurationDataExport dataExport) {
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration isEnabled(Boolean isEnabled) {
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration awsOrg(PutStorageLensConfigurationRequestStorageLensConfigurationAwsOrg awsOrg) {
    this.awsOrg = awsOrg;
    return this;
  }
  ...
  public GetStorageLensConfigurationResultStorageLensConfiguration storageLensArn(String storageLensArn) {
  ...
  public boolean equals(Object o) {
    ...
    GetStorageLensConfigurationResultStorageLensConfiguration getStorageLensConfigurationResultStorageLensConfiguration = (GetStorageLensConfigurationResultStorageLensConfiguration) o;
    return Objects.equals(this.id, getStorageLensConfigurationResultStorageLensConfiguration.id) &&
        Objects.equals(this.accountLevel, getStorageLensConfigurationResultStorageLensConfiguration.accountLevel) &&
        Objects.equals(this.include, getStorageLensConfigurationResultStorageLensConfiguration.include) &&
        Objects.equals(this.exclude, getStorageLensConfigurationResultStorageLensConfiguration.exclude) &&
        Objects.equals(this.dataExport, getStorageLensConfigurationResultStorageLensConfiguration.dataExport) &&
        Objects.equals(this.isEnabled, getStorageLensConfigurationResultStorageLensConfiguration.isEnabled) &&
        Objects.equals(this.awsOrg, getStorageLensConfigurationResultStorageLensConfiguration.awsOrg) &&
        Objects.equals(this.storageLensArn, getStorageLensConfigurationResultStorageLensConfiguration.storageLensArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetStorageLensConfigurationResultStorageLensConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetStorageLensConfigurationResultStorageLensConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetStorageLensConfigurationResultStorageLensConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetStorageLensConfigurationResultStorageLensConfiguration is not found in the empty JSON string", GetStorageLensConfigurationResultStorageLensConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetStorageLensConfigurationResultStorageLensConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetStorageLensConfigurationResultStorageLensConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetStorageLensConfigurationResultStorageLensConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetStorageLensConfigurationResultStorageLensConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetStorageLensConfigurationResultStorageLensConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetStorageLensConfigurationResultStorageLensConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetStorageLensConfigurationResultStorageLensConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<GetStorageLensConfigurationResultStorageLensConfiguration>() {
           @Override
           public void write(JsonWriter out, GetStorageLensConfigurationResultStorageLensConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetStorageLensConfigurationResultStorageLensConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetStorageLensConfigurationResultStorageLensConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetStorageLensConfigurationResultStorageLensConfiguration
   * @throws IOException if the JSON string is invalid with respect to GetStorageLensConfigurationResultStorageLensConfiguration
   */
  public static GetStorageLensConfigurationResultStorageLensConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetStorageLensConfigurationResultStorageLensConfiguration.class);
  }

  /**
   * Convert an instance of GetStorageLensConfigurationResultStorageLensConfiguration to an JSON string
   *
   * @return JSON string
   */
