...
public class CreateJobRequestOperation {
  ...
  public CreateJobRequestOperation() {
  }

  public CreateJobRequestOperation lambdaInvoke(CreateJobRequestOperationLambdaInvoke lambdaInvoke) {
  ...
  public CreateJobRequestOperation s3PutObjectCopy(CreateJobRequestOperationS3PutObjectCopy s3PutObjectCopy) {
  ...
  public CreateJobRequestOperation s3PutObjectAcl(CreateJobRequestOperationS3PutObjectAcl s3PutObjectAcl) {
  ...
  public CreateJobRequestOperation s3PutObjectTagging(CreateJobRequestOperationS3PutObjectTagging s3PutObjectTagging) {
  ...
  public CreateJobRequestOperation s3DeleteObjectTagging(Object s3DeleteObjectTagging) {
  ...
  public CreateJobRequestOperation s3InitiateRestoreObject(CreateJobRequestOperationS3InitiateRestoreObject s3InitiateRestoreObject) {
  ...
  public CreateJobRequestOperation s3PutObjectLegalHold(S3SetObjectLegalHoldOperation s3PutObjectLegalHold) {
  ...
  public CreateJobRequestOperation s3PutObjectRetention(S3SetObjectRetentionOperation s3PutObjectRetention) {
  ...
  public CreateJobRequestOperation s3ReplicateObject(Object s3ReplicateObject) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobRequestOperation createJobRequestOperation = (CreateJobRequestOperation) o;
    return Objects.equals(this.lambdaInvoke, createJobRequestOperation.lambdaInvoke) &&
        Objects.equals(this.s3PutObjectCopy, createJobRequestOperation.s3PutObjectCopy) &&
        Objects.equals(this.s3PutObjectAcl, createJobRequestOperation.s3PutObjectAcl) &&
        Objects.equals(this.s3PutObjectTagging, createJobRequestOperation.s3PutObjectTagging) &&
        Objects.equals(this.s3DeleteObjectTagging, createJobRequestOperation.s3DeleteObjectTagging) &&
        Objects.equals(this.s3InitiateRestoreObject, createJobRequestOperation.s3InitiateRestoreObject) &&
        Objects.equals(this.s3PutObjectLegalHold, createJobRequestOperation.s3PutObjectLegalHold) &&
        Objects.equals(this.s3PutObjectRetention, createJobRequestOperation.s3PutObjectRetention) &&
        Objects.equals(this.s3ReplicateObject, createJobRequestOperation.s3ReplicateObject);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobRequestOperation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateJobRequestOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateJobRequestOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobRequestOperation is not found in the empty JSON string", CreateJobRequestOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateJobRequestOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateJobRequestOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobRequestOperation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobRequestOperation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobRequestOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobRequestOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobRequestOperation>() {
           @Override
           public void write(JsonWriter out, CreateJobRequestOperation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateJobRequestOperation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateJobRequestOperation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateJobRequestOperation
   * @throws IOException if the JSON string is invalid with respect to CreateJobRequestOperation
   */
  public static CreateJobRequestOperation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobRequestOperation.class);
  }

  /**
   * Convert an instance of CreateJobRequestOperation to an JSON string
   *
   * @return JSON string
   */
