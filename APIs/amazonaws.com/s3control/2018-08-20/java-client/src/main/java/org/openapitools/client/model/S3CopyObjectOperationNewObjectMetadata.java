...
public class S3CopyObjectOperationNewObjectMetadata {
  ...
  public S3CopyObjectOperationNewObjectMetadata() {
  }

  public S3CopyObjectOperationNewObjectMetadata cacheControl(String cacheControl) {
  ...
  public S3CopyObjectOperationNewObjectMetadata contentDisposition(String contentDisposition) {
  ...
  public S3CopyObjectOperationNewObjectMetadata contentEncoding(String contentEncoding) {
  ...
  public S3CopyObjectOperationNewObjectMetadata contentLanguage(String contentLanguage) {
  ...
  public S3CopyObjectOperationNewObjectMetadata userMetadata(Map userMetadata) {
  ...
  public S3CopyObjectOperationNewObjectMetadata contentLength(Integer contentLength) {
  ...
  public S3CopyObjectOperationNewObjectMetadata contentMD5(String contentMD5) {
  ...
  public S3CopyObjectOperationNewObjectMetadata contentType(String contentType) {
  ...
  public S3CopyObjectOperationNewObjectMetadata httpExpiresDate(OffsetDateTime httpExpiresDate) {
  ...
  public S3CopyObjectOperationNewObjectMetadata requesterCharged(Boolean requesterCharged) {
  ...
  public S3CopyObjectOperationNewObjectMetadata ssEAlgorithm(S3SSEAlgorithm ssEAlgorithm) {
  ...
  public boolean equals(Object o) {
    ...
    S3CopyObjectOperationNewObjectMetadata s3CopyObjectOperationNewObjectMetadata = (S3CopyObjectOperationNewObjectMetadata) o;
    return Objects.equals(this.cacheControl, s3CopyObjectOperationNewObjectMetadata.cacheControl) &&
        Objects.equals(this.contentDisposition, s3CopyObjectOperationNewObjectMetadata.contentDisposition) &&
        Objects.equals(this.contentEncoding, s3CopyObjectOperationNewObjectMetadata.contentEncoding) &&
        Objects.equals(this.contentLanguage, s3CopyObjectOperationNewObjectMetadata.contentLanguage) &&
        Objects.equals(this.userMetadata, s3CopyObjectOperationNewObjectMetadata.userMetadata) &&
        Objects.equals(this.contentLength, s3CopyObjectOperationNewObjectMetadata.contentLength) &&
        Objects.equals(this.contentMD5, s3CopyObjectOperationNewObjectMetadata.contentMD5) &&
        Objects.equals(this.contentType, s3CopyObjectOperationNewObjectMetadata.contentType) &&
        Objects.equals(this.httpExpiresDate, s3CopyObjectOperationNewObjectMetadata.httpExpiresDate) &&
        Objects.equals(this.requesterCharged, s3CopyObjectOperationNewObjectMetadata.requesterCharged) &&
        Objects.equals(this.ssEAlgorithm, s3CopyObjectOperationNewObjectMetadata.ssEAlgorithm);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3CopyObjectOperationNewObjectMetadata {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3CopyObjectOperationNewObjectMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3CopyObjectOperationNewObjectMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3CopyObjectOperationNewObjectMetadata is not found in the empty JSON string", S3CopyObjectOperationNewObjectMetadata.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3CopyObjectOperationNewObjectMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3CopyObjectOperationNewObjectMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3CopyObjectOperationNewObjectMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3CopyObjectOperationNewObjectMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3CopyObjectOperationNewObjectMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3CopyObjectOperationNewObjectMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<S3CopyObjectOperationNewObjectMetadata>() {
           @Override
           public void write(JsonWriter out, S3CopyObjectOperationNewObjectMetadata value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3CopyObjectOperationNewObjectMetadata read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3CopyObjectOperationNewObjectMetadata given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3CopyObjectOperationNewObjectMetadata
   * @throws IOException if the JSON string is invalid with respect to S3CopyObjectOperationNewObjectMetadata
   */
  public static S3CopyObjectOperationNewObjectMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3CopyObjectOperationNewObjectMetadata.class);
  }

  /**
   * Convert an instance of S3CopyObjectOperationNewObjectMetadata to an JSON string
   *
   * @return JSON string
   */
