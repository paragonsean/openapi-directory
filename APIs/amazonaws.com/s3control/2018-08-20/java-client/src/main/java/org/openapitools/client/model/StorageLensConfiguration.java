...
public class StorageLensConfiguration {
  ...
  public StorageLensConfiguration() {
  }

  public StorageLensConfiguration id(String id) {
    this.id = id;
    return this;
  }
  ...
  public StorageLensConfiguration accountLevel(PutStorageLensConfigurationRequestStorageLensConfigurationAccountLevel accountLevel) {
  ...
  public StorageLensConfiguration include(PutStorageLensConfigurationRequestStorageLensConfigurationInclude include) {
  ...
  public StorageLensConfiguration exclude(PutStorageLensConfigurationRequestStorageLensConfigurationExclude exclude) {
  ...
  public StorageLensConfiguration dataExport(PutStorageLensConfigurationRequestStorageLensConfigurationDataExport dataExport) {
  ...
  public StorageLensConfiguration isEnabled(Boolean isEnabled) {
  ...
  public StorageLensConfiguration awsOrg(PutStorageLensConfigurationRequestStorageLensConfigurationAwsOrg awsOrg) {
    this.awsOrg = awsOrg;
    return this;
  }
  ...
  public StorageLensConfiguration storageLensArn(String storageLensArn) {
  ...
  public boolean equals(Object o) {
    ...
    StorageLensConfiguration storageLensConfiguration = (StorageLensConfiguration) o;
    return Objects.equals(this.id, storageLensConfiguration.id) &&
        Objects.equals(this.accountLevel, storageLensConfiguration.accountLevel) &&
        Objects.equals(this.include, storageLensConfiguration.include) &&
        Objects.equals(this.exclude, storageLensConfiguration.exclude) &&
        Objects.equals(this.dataExport, storageLensConfiguration.dataExport) &&
        Objects.equals(this.isEnabled, storageLensConfiguration.isEnabled) &&
        Objects.equals(this.awsOrg, storageLensConfiguration.awsOrg) &&
        Objects.equals(this.storageLensArn, storageLensConfiguration.storageLensArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageLensConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StorageLensConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageLensConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StorageLensConfiguration is not found in the empty JSON string", StorageLensConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StorageLensConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StorageLensConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StorageLensConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StorageLensConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StorageLensConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StorageLensConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StorageLensConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<StorageLensConfiguration>() {
           @Override
           public void write(JsonWriter out, StorageLensConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StorageLensConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StorageLensConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StorageLensConfiguration
   * @throws IOException if the JSON string is invalid with respect to StorageLensConfiguration
   */
  public static StorageLensConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StorageLensConfiguration.class);
  }

  /**
   * Convert an instance of StorageLensConfiguration to an JSON string
   *
   * @return JSON string
   */
