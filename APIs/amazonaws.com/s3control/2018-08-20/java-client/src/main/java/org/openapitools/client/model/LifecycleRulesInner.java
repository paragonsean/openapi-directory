...
public class LifecycleRulesInner {
  ...
  public LifecycleRulesInner() {
  }

  public LifecycleRulesInner expiration(LifecycleRuleExpiration expiration) {
  ...
  public LifecycleRulesInner ID(String ID) {
    this.ID = ID;
    return this;
  }
  ...
  public LifecycleRulesInner filter(LifecycleRuleFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public LifecycleRulesInner status(ExpirationStatus status) {
    this.status = status;
    return this;
  }
  ...
  public LifecycleRulesInner transitions(List transitions) {
  ...
  public LifecycleRulesInner noncurrentVersionTransitions(List noncurrentVersionTransitions) {
  ...
  public LifecycleRulesInner noncurrentVersionExpiration(LifecycleRuleNoncurrentVersionExpiration noncurrentVersionExpiration) {
  ...
  public LifecycleRulesInner abortIncompleteMultipartUpload(LifecycleRuleAbortIncompleteMultipartUpload abortIncompleteMultipartUpload) {
  ...
  public boolean equals(Object o) {
    ...
    LifecycleRulesInner lifecycleRulesInner = (LifecycleRulesInner) o;
    return Objects.equals(this.expiration, lifecycleRulesInner.expiration) &&
        Objects.equals(this.ID, lifecycleRulesInner.ID) &&
        Objects.equals(this.filter, lifecycleRulesInner.filter) &&
        Objects.equals(this.status, lifecycleRulesInner.status) &&
        Objects.equals(this.transitions, lifecycleRulesInner.transitions) &&
        Objects.equals(this.noncurrentVersionTransitions, lifecycleRulesInner.noncurrentVersionTransitions) &&
        Objects.equals(this.noncurrentVersionExpiration, lifecycleRulesInner.noncurrentVersionExpiration) &&
        Objects.equals(this.abortIncompleteMultipartUpload, lifecycleRulesInner.abortIncompleteMultipartUpload);
  }
  ...
  public String toString() {
    ...
    sb.append("class LifecycleRulesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LifecycleRulesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LifecycleRulesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LifecycleRulesInner is not found in the empty JSON string", LifecycleRulesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LifecycleRulesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LifecycleRulesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LifecycleRulesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LifecycleRulesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LifecycleRulesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LifecycleRulesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LifecycleRulesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<LifecycleRulesInner>() {
           @Override
           public void write(JsonWriter out, LifecycleRulesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LifecycleRulesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LifecycleRulesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LifecycleRulesInner
   * @throws IOException if the JSON string is invalid with respect to LifecycleRulesInner
   */
  public static LifecycleRulesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LifecycleRulesInner.class);
  }

  /**
   * Convert an instance of LifecycleRulesInner to an JSON string
   *
   * @return JSON string
   */
