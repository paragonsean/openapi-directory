...
public class ReplicationRule {
  ...
  public ReplicationRule ID(String ID) {
    this.ID = ID;
    return this;
  }
  ...
  public ReplicationRule priority(Integer priority) {
  ...
  public ReplicationRule prefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public ReplicationRule filter(ReplicationRuleFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ReplicationRule status(ReplicationRuleStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ReplicationRule sourceSelectionCriteria(ReplicationRuleSourceSelectionCriteria sourceSelectionCriteria) {
  ...
  public ReplicationRule existingObjectReplication(ReplicationRuleExistingObjectReplication existingObjectReplication) {
  ...
  public ReplicationRule destination(ReplicationRuleDestination destination) {
  ...
  public ReplicationRule deleteMarkerReplication(ReplicationRuleDeleteMarkerReplication deleteMarkerReplication) {
  ...
  public ReplicationRule bucket(String bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReplicationRule replicationRule = (ReplicationRule) o;
    return Objects.equals(this.ID, replicationRule.ID) &&
        Objects.equals(this.priority, replicationRule.priority) &&
        Objects.equals(this.prefix, replicationRule.prefix) &&
        Objects.equals(this.filter, replicationRule.filter) &&
        Objects.equals(this.status, replicationRule.status) &&
        Objects.equals(this.sourceSelectionCriteria, replicationRule.sourceSelectionCriteria) &&
        Objects.equals(this.existingObjectReplication, replicationRule.existingObjectReplication) &&
        Objects.equals(this.destination, replicationRule.destination) &&
        Objects.equals(this.deleteMarkerReplication, replicationRule.deleteMarkerReplication) &&
        Objects.equals(this.bucket, replicationRule.bucket);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicationRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicationRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicationRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicationRule is not found in the empty JSON string", ReplicationRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicationRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicationRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplicationRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicationRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicationRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicationRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicationRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicationRule>() {
           @Override
           public void write(JsonWriter out, ReplicationRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicationRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicationRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicationRule
   * @throws IOException if the JSON string is invalid with respect to ReplicationRule
   */
  public static ReplicationRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicationRule.class);
  }

  /**
   * Convert an instance of ReplicationRule to an JSON string
   *
   * @return JSON string
   */
