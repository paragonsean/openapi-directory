...
public class PublicAccessBlockConfiguration {
  ...
  public PublicAccessBlockConfiguration blockPublicAcls(Boolean blockPublicAcls) {
  ...
  public PublicAccessBlockConfiguration ignorePublicAcls(Boolean ignorePublicAcls) {
  ...
  public PublicAccessBlockConfiguration blockPublicPolicy(Boolean blockPublicPolicy) {
  ...
  public PublicAccessBlockConfiguration restrictPublicBuckets(Boolean restrictPublicBuckets) {
  ...
  public boolean equals(Object o) {
    ...
    PublicAccessBlockConfiguration publicAccessBlockConfiguration = (PublicAccessBlockConfiguration) o;
    return Objects.equals(this.blockPublicAcls, publicAccessBlockConfiguration.blockPublicAcls) &&
        Objects.equals(this.ignorePublicAcls, publicAccessBlockConfiguration.ignorePublicAcls) &&
        Objects.equals(this.blockPublicPolicy, publicAccessBlockConfiguration.blockPublicPolicy) &&
        Objects.equals(this.restrictPublicBuckets, publicAccessBlockConfiguration.restrictPublicBuckets);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicAccessBlockConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublicAccessBlockConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublicAccessBlockConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublicAccessBlockConfiguration is not found in the empty JSON string", PublicAccessBlockConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublicAccessBlockConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublicAccessBlockConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublicAccessBlockConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublicAccessBlockConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublicAccessBlockConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublicAccessBlockConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<PublicAccessBlockConfiguration>() {
           @Override
           public void write(JsonWriter out, PublicAccessBlockConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublicAccessBlockConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublicAccessBlockConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublicAccessBlockConfiguration
   * @throws IOException if the JSON string is invalid with respect to PublicAccessBlockConfiguration
   */
  public static PublicAccessBlockConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublicAccessBlockConfiguration.class);
  }

  /**
   * Convert an instance of PublicAccessBlockConfiguration to an JSON string
   *
   * @return JSON string
   */
