...
public class S3CopyObjectOperation {
  ...
  public S3CopyObjectOperation() {
  }

  public S3CopyObjectOperation targetResource(String targetResource) {
  ...
  public S3CopyObjectOperation cannedAccessControlList(S3CannedAccessControlList cannedAccessControlList) {
  ...
  public S3CopyObjectOperation accessControlGrants(List accessControlGrants) {
  ...
  public S3CopyObjectOperation metadataDirective(S3MetadataDirective metadataDirective) {
  ...
  public S3CopyObjectOperation modifiedSinceConstraint(OffsetDateTime modifiedSinceConstraint) {
  ...
  public S3CopyObjectOperation newObjectMetadata(S3CopyObjectOperationNewObjectMetadata newObjectMetadata) {
  ...
  public S3CopyObjectOperation newObjectTagging(List newObjectTagging) {
  ...
  public S3CopyObjectOperation redirectLocation(String redirectLocation) {
  ...
  public S3CopyObjectOperation requesterPays(Boolean requesterPays) {
  ...
  public S3CopyObjectOperation storageClass(S3StorageClass storageClass) {
  ...
  public S3CopyObjectOperation unModifiedSinceConstraint(OffsetDateTime unModifiedSinceConstraint) {
  ...
  public S3CopyObjectOperation ssEAwsKmsKeyId(String ssEAwsKmsKeyId) {
  ...
  public S3CopyObjectOperation targetKeyPrefix(String targetKeyPrefix) {
  ...
  public S3CopyObjectOperation objectLockLegalHoldStatus(S3ObjectLockLegalHoldStatus objectLockLegalHoldStatus) {
  ...
  public S3CopyObjectOperation objectLockMode(S3ObjectLockMode objectLockMode) {
  ...
  public S3CopyObjectOperation objectLockRetainUntilDate(OffsetDateTime objectLockRetainUntilDate) {
  ...
  public S3CopyObjectOperation bucketKeyEnabled(Boolean bucketKeyEnabled) {
  ...
  public S3CopyObjectOperation checksumAlgorithm(S3ChecksumAlgorithm checksumAlgorithm) {
  ...
  public boolean equals(Object o) {
    ...
    S3CopyObjectOperation s3CopyObjectOperation = (S3CopyObjectOperation) o;
    return Objects.equals(this.targetResource, s3CopyObjectOperation.targetResource) &&
        Objects.equals(this.cannedAccessControlList, s3CopyObjectOperation.cannedAccessControlList) &&
        Objects.equals(this.accessControlGrants, s3CopyObjectOperation.accessControlGrants) &&
        Objects.equals(this.metadataDirective, s3CopyObjectOperation.metadataDirective) &&
        Objects.equals(this.modifiedSinceConstraint, s3CopyObjectOperation.modifiedSinceConstraint) &&
        Objects.equals(this.newObjectMetadata, s3CopyObjectOperation.newObjectMetadata) &&
        Objects.equals(this.newObjectTagging, s3CopyObjectOperation.newObjectTagging) &&
        Objects.equals(this.redirectLocation, s3CopyObjectOperation.redirectLocation) &&
        Objects.equals(this.requesterPays, s3CopyObjectOperation.requesterPays) &&
        Objects.equals(this.storageClass, s3CopyObjectOperation.storageClass) &&
        Objects.equals(this.unModifiedSinceConstraint, s3CopyObjectOperation.unModifiedSinceConstraint) &&
        Objects.equals(this.ssEAwsKmsKeyId, s3CopyObjectOperation.ssEAwsKmsKeyId) &&
        Objects.equals(this.targetKeyPrefix, s3CopyObjectOperation.targetKeyPrefix) &&
        Objects.equals(this.objectLockLegalHoldStatus, s3CopyObjectOperation.objectLockLegalHoldStatus) &&
        Objects.equals(this.objectLockMode, s3CopyObjectOperation.objectLockMode) &&
        Objects.equals(this.objectLockRetainUntilDate, s3CopyObjectOperation.objectLockRetainUntilDate) &&
        Objects.equals(this.bucketKeyEnabled, s3CopyObjectOperation.bucketKeyEnabled) &&
        Objects.equals(this.checksumAlgorithm, s3CopyObjectOperation.checksumAlgorithm);
  }
  ...
  public String toString() {
    ...
    sb.append("class S3CopyObjectOperation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3CopyObjectOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3CopyObjectOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3CopyObjectOperation is not found in the empty JSON string", S3CopyObjectOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3CopyObjectOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3CopyObjectOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3CopyObjectOperation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3CopyObjectOperation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3CopyObjectOperation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3CopyObjectOperation.class));

       return (TypeAdapter<T>) new TypeAdapter<S3CopyObjectOperation>() {
           @Override
           public void write(JsonWriter out, S3CopyObjectOperation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3CopyObjectOperation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3CopyObjectOperation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3CopyObjectOperation
   * @throws IOException if the JSON string is invalid with respect to S3CopyObjectOperation
   */
  public static S3CopyObjectOperation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3CopyObjectOperation.class);
  }

  /**
   * Convert an instance of S3CopyObjectOperation to an JSON string
   *
   * @return JSON string
   */
