...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.JobListDescriptor();
  });
  ...
  describe('JobListDescriptor', function() {
    it('should create an instance of JobListDescriptor', function() {
      // uncomment below and update the code to test JobListDescriptor
      //var instance = new AwsS3Control.JobListDescriptor();
      //expect(instance).to.be.a(AwsS3Control.JobListDescriptor);
    });
