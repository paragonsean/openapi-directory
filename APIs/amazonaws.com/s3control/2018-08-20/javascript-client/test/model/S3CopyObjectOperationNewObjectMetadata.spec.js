...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.S3CopyObjectOperationNewObjectMetadata();
  });
  ...
  describe('S3CopyObjectOperationNewObjectMetadata', function() {
    it('should create an instance of S3CopyObjectOperationNewObjectMetadata', function() {
      // uncomment below and update the code to test S3CopyObjectOperationNewObjectMetadata
      //var instance = new AwsS3Control.S3CopyObjectOperationNewObjectMetadata();
      //expect(instance).to.be.a(AwsS3Control.S3CopyObjectOperationNewObjectMetadata);
    });
