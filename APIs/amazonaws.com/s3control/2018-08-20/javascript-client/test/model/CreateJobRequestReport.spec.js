...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.CreateJobRequestReport();
  });
  ...
  describe('CreateJobRequestReport', function() {
    it('should create an instance of CreateJobRequestReport', function() {
      // uncomment below and update the code to test CreateJobRequestReport
      //var instance = new AwsS3Control.CreateJobRequestReport();
      //expect(instance).to.be.a(AwsS3Control.CreateJobRequestReport);
    });
