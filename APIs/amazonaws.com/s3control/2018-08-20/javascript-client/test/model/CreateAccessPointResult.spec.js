...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.CreateAccessPointResult();
  });
  ...
  describe('CreateAccessPointResult', function() {
    it('should create an instance of CreateAccessPointResult', function() {
      // uncomment below and update the code to test CreateAccessPointResult
      //var instance = new AwsS3Control.CreateAccessPointResult();
      //expect(instance).to.be.a(AwsS3Control.CreateAccessPointResult);
    });
