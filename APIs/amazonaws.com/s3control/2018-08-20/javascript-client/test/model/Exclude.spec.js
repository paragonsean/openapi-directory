...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.Exclude();
  });
  ...
  describe('Exclude', function() {
    it('should create an instance of Exclude', function() {
      // uncomment below and update the code to test Exclude
      //var instance = new AwsS3Control.Exclude();
      //expect(instance).to.be.a(AwsS3Control.Exclude);
    });
