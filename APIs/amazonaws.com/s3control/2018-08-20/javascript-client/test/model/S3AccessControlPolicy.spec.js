...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.S3AccessControlPolicy();
  });
  ...
  describe('S3AccessControlPolicy', function() {
    it('should create an instance of S3AccessControlPolicy', function() {
      // uncomment below and update the code to test S3AccessControlPolicy
      //var instance = new AwsS3Control.S3AccessControlPolicy();
      //expect(instance).to.be.a(AwsS3Control.S3AccessControlPolicy);
    });
