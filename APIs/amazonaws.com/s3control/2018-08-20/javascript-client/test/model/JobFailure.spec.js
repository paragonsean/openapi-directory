...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.JobFailure();
  });
  ...
  describe('JobFailure', function() {
    it('should create an instance of JobFailure', function() {
      // uncomment below and update the code to test JobFailure
      //var instance = new AwsS3Control.JobFailure();
      //expect(instance).to.be.a(AwsS3Control.JobFailure);
    });
