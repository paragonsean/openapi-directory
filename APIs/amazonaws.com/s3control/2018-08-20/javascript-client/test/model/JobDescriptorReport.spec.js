...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.JobDescriptorReport();
  });
  ...
  describe('JobDescriptorReport', function() {
    it('should create an instance of JobDescriptorReport', function() {
      // uncomment below and update the code to test JobDescriptorReport
      //var instance = new AwsS3Control.JobDescriptorReport();
      //expect(instance).to.be.a(AwsS3Control.JobDescriptorReport);
    });
