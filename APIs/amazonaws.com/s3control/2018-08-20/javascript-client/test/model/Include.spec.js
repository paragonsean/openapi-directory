...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.Include();
  });
  ...
  describe('Include', function() {
    it('should create an instance of Include', function() {
      // uncomment below and update the code to test Include
      //var instance = new AwsS3Control.Include();
      //expect(instance).to.be.a(AwsS3Control.Include);
    });
