...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.TransitionListInner();
  });
  ...
  describe('TransitionListInner', function() {
    it('should create an instance of TransitionListInner', function() {
      // uncomment below and update the code to test TransitionListInner
      //var instance = new AwsS3Control.TransitionListInner();
      //expect(instance).to.be.a(AwsS3Control.TransitionListInner);
    });
