...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsS3Control.JobReport();
  });
  ...
  describe('JobReport', function() {
    it('should create an instance of JobReport', function() {
      // uncomment below and update the code to test JobReport
      //var instance = new AwsS3Control.JobReport();
      //expect(instance).to.be.a(AwsS3Control.JobReport);
    });
