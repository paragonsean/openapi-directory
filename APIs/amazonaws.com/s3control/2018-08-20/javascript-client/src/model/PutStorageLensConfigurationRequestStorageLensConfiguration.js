...
import StorageLensConfiguration from './StorageLensConfiguration';

/**
 * The PutStorageLensConfigurationRequestStorageLensConfiguration model module.
 * @module model/PutStorageLensConfigurationRequestStorageLensConfiguration
 * @version 2018-08-20
 */
class PutStorageLensConfigurationRequestStorageLensConfiguration {
    /**
     * Constructs a new <code>PutStorageLensConfigurationRequestStorageLensConfiguration</code>.
     * @alias module:model/PutStorageLensConfigurationRequestStorageLensConfiguration
     * @implements module:model/StorageLensConfiguration
     * @param id {String} 
    ...
    constructor(id, accountLevel, isEnabled) { 
        ...
        PutStorageLensConfigurationRequestStorageLensConfiguration.initialize(this, id, accountLevel, isEnabled);
    }
    ...
    /**
     * Constructs a <code>PutStorageLensConfigurationRequestStorageLensConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutStorageLensConfigurationRequestStorageLensConfiguration} obj Optional instance to populate.
     * @return {module:model/PutStorageLensConfigurationRequestStorageLensConfiguration} The populated <code>PutStorageLensConfigurationRequestStorageLensConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutStorageLensConfigurationRequestStorageLensConfiguration();
            StorageLensConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PutStorageLensConfigurationRequestStorageLensConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutStorageLensConfigurationRequestStorageLensConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutStorageLensConfigurationRequestStorageLensConfiguration.RequiredProperties) {
...
PutStorageLensConfigurationRequestStorageLensConfiguration.RequiredProperties = ["Id", "AccountLevel", "IsEnabled"];

/**
 * @member {String} Id
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['Id'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationAccountLevel} AccountLevel
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['AccountLevel'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationInclude} Include
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['Include'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationExclude} Exclude
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['Exclude'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationDataExport} DataExport
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['DataExport'] = undefined;

/**
 * @member {Boolean} IsEnabled
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['IsEnabled'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationAwsOrg} AwsOrg
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['AwsOrg'] = undefined;

/**
 * @member {String} StorageLensArn
 */
PutStorageLensConfigurationRequestStorageLensConfiguration.prototype['StorageLensArn'] = undefined;


// Implement StorageLensConfiguration interface:
/**
 * @member {String} Id
 */
...
export default PutStorageLensConfigurationRequestStorageLensConfiguration;
