...
/**
 * The JobDescriptorOperation model module.
 * @module model/JobDescriptorOperation
 * @version 2018-08-20
 */
class JobDescriptorOperation {
    /**
     * Constructs a new <code>JobDescriptorOperation</code>.
     * @alias module:model/JobDescriptorOperation
     * @implements module:model/JobOperation
     */
    constructor() { 
        JobOperation.initialize(this);
        JobDescriptorOperation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>JobDescriptorOperation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JobDescriptorOperation} obj Optional instance to populate.
     * @return {module:model/JobDescriptorOperation} The populated <code>JobDescriptorOperation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JobDescriptorOperation();
    ...
    /**
     * Validates the JSON data with respect to <code>JobDescriptorOperation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JobDescriptorOperation</code>.
     */
 ...
 */
JobDescriptorOperation.prototype['LambdaInvoke'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3PutObjectCopy} S3PutObjectCopy
 */
JobDescriptorOperation.prototype['S3PutObjectCopy'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3PutObjectAcl} S3PutObjectAcl
 */
JobDescriptorOperation.prototype['S3PutObjectAcl'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3PutObjectTagging} S3PutObjectTagging
 */
JobDescriptorOperation.prototype['S3PutObjectTagging'] = undefined;

/**
 * @member {Object} S3DeleteObjectTagging
 */
JobDescriptorOperation.prototype['S3DeleteObjectTagging'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3InitiateRestoreObject} S3InitiateRestoreObject
 */
JobDescriptorOperation.prototype['S3InitiateRestoreObject'] = undefined;

/**
 * @member {module:model/S3SetObjectLegalHoldOperation} S3PutObjectLegalHold
 */
JobDescriptorOperation.prototype['S3PutObjectLegalHold'] = undefined;

/**
 * @member {module:model/S3SetObjectRetentionOperation} S3PutObjectRetention
 */
JobDescriptorOperation.prototype['S3PutObjectRetention'] = undefined;

/**
 * @member {Object} S3ReplicateObject
 */
JobDescriptorOperation.prototype['S3ReplicateObject'] = undefined;
...
export default JobDescriptorOperation;
