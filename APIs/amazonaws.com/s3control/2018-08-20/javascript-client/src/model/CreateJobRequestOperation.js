...
/**
 * The CreateJobRequestOperation model module.
 * @module model/CreateJobRequestOperation
 * @version 2018-08-20
 */
class CreateJobRequestOperation {
    /**
     * Constructs a new <code>CreateJobRequestOperation</code>.
     * @alias module:model/CreateJobRequestOperation
     * @implements module:model/JobOperation
     */
    constructor() { 
        JobOperation.initialize(this);
        CreateJobRequestOperation.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateJobRequestOperation</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateJobRequestOperation} obj Optional instance to populate.
     * @return {module:model/CreateJobRequestOperation} The populated <code>CreateJobRequestOperation</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateJobRequestOperation();
            JobOperation.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreateJobRequestOperation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateJobRequestOperation</code>.
     */
 ...
 */
CreateJobRequestOperation.prototype['LambdaInvoke'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3PutObjectCopy} S3PutObjectCopy
 */
CreateJobRequestOperation.prototype['S3PutObjectCopy'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3PutObjectAcl} S3PutObjectAcl
 */
CreateJobRequestOperation.prototype['S3PutObjectAcl'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3PutObjectTagging} S3PutObjectTagging
 */
CreateJobRequestOperation.prototype['S3PutObjectTagging'] = undefined;

/**
 * @member {Object} S3DeleteObjectTagging
 */
CreateJobRequestOperation.prototype['S3DeleteObjectTagging'] = undefined;

/**
 * @member {module:model/CreateJobRequestOperationS3InitiateRestoreObject} S3InitiateRestoreObject
 */
CreateJobRequestOperation.prototype['S3InitiateRestoreObject'] = undefined;

/**
 * @member {module:model/S3SetObjectLegalHoldOperation} S3PutObjectLegalHold
 */
CreateJobRequestOperation.prototype['S3PutObjectLegalHold'] = undefined;

/**
 * @member {module:model/S3SetObjectRetentionOperation} S3PutObjectRetention
 */
CreateJobRequestOperation.prototype['S3PutObjectRetention'] = undefined;

/**
 * @member {Object} S3ReplicateObject
 */
CreateJobRequestOperation.prototype['S3ReplicateObject'] = undefined;


// Implement JobOperation interface:
/**
 * @member {module:model/CreateJobRequestOperationLambdaInvoke} LambdaInvoke
 */
...
export default CreateJobRequestOperation;
