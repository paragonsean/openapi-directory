...
/**
 * The S3CopyObjectOperationNewObjectMetadata model module.
 * @module model/S3CopyObjectOperationNewObjectMetadata
 * @version 2018-08-20
 */
class S3CopyObjectOperationNewObjectMetadata {
    /**
     * Constructs a new <code>S3CopyObjectOperationNewObjectMetadata</code>.
     * @alias module:model/S3CopyObjectOperationNewObjectMetadata
     * @implements module:model/S3ObjectMetadata
     */
    constructor() { 
        S3ObjectMetadata.initialize(this);
        S3CopyObjectOperationNewObjectMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>S3CopyObjectOperationNewObjectMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/S3CopyObjectOperationNewObjectMetadata} obj Optional instance to populate.
     * @return {module:model/S3CopyObjectOperationNewObjectMetadata} The populated <code>S3CopyObjectOperationNewObjectMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new S3CopyObjectOperationNewObjectMetadata();
            S3ObjectMetadata.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>S3CopyObjectOperationNewObjectMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>S3CopyObjectOperationNewObjectMetadata</code>.
     */
 ...
 */
S3CopyObjectOperationNewObjectMetadata.prototype['CacheControl'] = undefined;

/**
 * @member {String} ContentDisposition
 */
S3CopyObjectOperationNewObjectMetadata.prototype['ContentDisposition'] = undefined;

/**
 * @member {String} ContentEncoding
 */
S3CopyObjectOperationNewObjectMetadata.prototype['ContentEncoding'] = undefined;

/**
 * @member {String} ContentLanguage
 */
S3CopyObjectOperationNewObjectMetadata.prototype['ContentLanguage'] = undefined;

/**
 * @member {Object} UserMetadata
 */
S3CopyObjectOperationNewObjectMetadata.prototype['UserMetadata'] = undefined;

/**
 * @member {Number} ContentLength
 */
S3CopyObjectOperationNewObjectMetadata.prototype['ContentLength'] = undefined;

/**
 * @member {String} ContentMD5
 */
S3CopyObjectOperationNewObjectMetadata.prototype['ContentMD5'] = undefined;

/**
 * @member {String} ContentType
 */
S3CopyObjectOperationNewObjectMetadata.prototype['ContentType'] = undefined;

/**
 * @member {Date} HttpExpiresDate
 */
S3CopyObjectOperationNewObjectMetadata.prototype['HttpExpiresDate'] = undefined;

/**
 * @member {Boolean} RequesterCharged
 */
S3CopyObjectOperationNewObjectMetadata.prototype['RequesterCharged'] = undefined;

/**
 * @member {module:model/S3SSEAlgorithm} SSEAlgorithm
 */
S3CopyObjectOperationNewObjectMetadata.prototype['SSEAlgorithm'] = undefined;


// Implement S3ObjectMetadata interface:
/**
 * @member {String} CacheControl
 */
...
export default S3CopyObjectOperationNewObjectMetadata;
