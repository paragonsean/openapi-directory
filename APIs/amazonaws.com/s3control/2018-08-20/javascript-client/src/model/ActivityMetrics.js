...
/**
 * The ActivityMetrics model module.
 * @module model/ActivityMetrics
 * @version 2018-08-20
 */
class ActivityMetrics {
    /**
     * Constructs a new <code>ActivityMetrics</code>.
     ...
     * @alias module:model/ActivityMetrics
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>ActivityMetrics</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActivityMetrics} obj Optional instance to populate.
     * @return {module:model/ActivityMetrics} The populated <code>ActivityMetrics</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActivityMetrics();
    ...
    /**
     * Validates the JSON data with respect to <code>ActivityMetrics</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivityMetrics</code>.
     */
