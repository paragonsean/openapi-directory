...
/**
 * The GetStorageLensConfigurationResultStorageLensConfiguration model module.
 * @module model/GetStorageLensConfigurationResultStorageLensConfiguration
 * @version 2018-08-20
 */
class GetStorageLensConfigurationResultStorageLensConfiguration {
    /**
     * Constructs a new <code>GetStorageLensConfigurationResultStorageLensConfiguration</code>.
     * @alias module:model/GetStorageLensConfigurationResultStorageLensConfiguration
    ...
    constructor(id, accountLevel, isEnabled) { 
        ...
        GetStorageLensConfigurationResultStorageLensConfiguration.initialize(this, id, accountLevel, isEnabled);
    }
    ...
    /**
     * Constructs a <code>GetStorageLensConfigurationResultStorageLensConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetStorageLensConfigurationResultStorageLensConfiguration} obj Optional instance to populate.
     * @return {module:model/GetStorageLensConfigurationResultStorageLensConfiguration} The populated <code>GetStorageLensConfigurationResultStorageLensConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetStorageLensConfigurationResultStorageLensConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>GetStorageLensConfigurationResultStorageLensConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetStorageLensConfigurationResultStorageLensConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetStorageLensConfigurationResultStorageLensConfiguration.RequiredProperties) {
...
GetStorageLensConfigurationResultStorageLensConfiguration.RequiredProperties = ["Id", "AccountLevel", "IsEnabled"];

/**
 * @member {String} Id
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['Id'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationAccountLevel} AccountLevel
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['AccountLevel'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationInclude} Include
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['Include'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationExclude} Exclude
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['Exclude'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationDataExport} DataExport
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['DataExport'] = undefined;

/**
 * @member {Boolean} IsEnabled
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['IsEnabled'] = undefined;

/**
 * @member {module:model/PutStorageLensConfigurationRequestStorageLensConfigurationAwsOrg} AwsOrg
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['AwsOrg'] = undefined;

/**
 * @member {String} StorageLensArn
 */
GetStorageLensConfigurationResultStorageLensConfiguration.prototype['StorageLensArn'] = undefined;
...
export default GetStorageLensConfigurationResultStorageLensConfiguration;
