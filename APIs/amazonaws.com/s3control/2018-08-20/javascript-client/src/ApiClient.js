...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://s3-control.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://s3-control.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2018-08-20/Javascript'
        };
