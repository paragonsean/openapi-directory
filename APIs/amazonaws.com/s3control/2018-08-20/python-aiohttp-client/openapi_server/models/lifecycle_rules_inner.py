...
class LifecycleRulesInner(Model):
    ...
    def __init__(self, expiration: LifecycleRuleExpiration=None, id: str=None, filter: LifecycleRuleFilter=None, status: ExpirationStatus=None, transitions: List=None, noncurrent_version_transitions: List=None, noncurrent_version_expiration: LifecycleRuleNoncurrentVersionExpiration=None, abort_incomplete_multipart_upload: LifecycleRuleAbortIncompleteMultipartUpload=None):
        """LifecycleRulesInner - a model defined in OpenAPI

        :param expiration: The expiration of this LifecycleRulesInner.
        :param id: The id of this LifecycleRulesInner.
        :param filter: The filter of this LifecycleRulesInner.
        :param status: The status of this LifecycleRulesInner.
        :param transitions: The transitions of this LifecycleRulesInner.
        :param noncurrent_version_transitions: The noncurrent_version_transitions of this LifecycleRulesInner.
        :param noncurrent_version_expiration: The noncurrent_version_expiration of this LifecycleRulesInner.
        :param abort_incomplete_multipart_upload: The abort_incomplete_multipart_upload of this LifecycleRulesInner.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'LifecycleRulesInner':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The LifecycleRules_inner of this LifecycleRulesInner.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def expiration(self):
        """Gets the expiration of this LifecycleRulesInner.


        :return: The expiration of this LifecycleRulesInner.
    ...
    def expiration(self, expiration):
        """Sets the expiration of this LifecycleRulesInner.
    ...
    @property
    def id(self):
        """Gets the id of this LifecycleRulesInner.


        :return: The id of this LifecycleRulesInner.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this LifecycleRulesInner.
    ...
    @property
    def filter(self):
        """Gets the filter of this LifecycleRulesInner.


        :return: The filter of this LifecycleRulesInner.
    ...
    def filter(self, filter):
        """Sets the filter of this LifecycleRulesInner.
    ...
    @property
    def status(self):
        """Gets the status of this LifecycleRulesInner.


        :return: The status of this LifecycleRulesInner.
    ...
    def status(self, status):
        """Sets the status of this LifecycleRulesInner.
    ...
    def transitions(self):
        """Gets the transitions of this LifecycleRulesInner.


        :return: The transitions of this LifecycleRulesInner.
        :rtype: List
        """
    ...
    def transitions(self, transitions):
        """Sets the transitions of this LifecycleRulesInner.
    ...
    def noncurrent_version_transitions(self):
        """Gets the noncurrent_version_transitions of this LifecycleRulesInner.


        :return: The noncurrent_version_transitions of this LifecycleRulesInner.
        :rtype: List
        """
    ...
    def noncurrent_version_transitions(self, noncurrent_version_transitions):
        """Sets the noncurrent_version_transitions of this LifecycleRulesInner.
    ...
    def noncurrent_version_expiration(self):
        """Gets the noncurrent_version_expiration of this LifecycleRulesInner.


        :return: The noncurrent_version_expiration of this LifecycleRulesInner.
    ...
    def noncurrent_version_expiration(self, noncurrent_version_expiration):
        """Sets the noncurrent_version_expiration of this LifecycleRulesInner.
    ...
    def abort_incomplete_multipart_upload(self):
        """Gets the abort_incomplete_multipart_upload of this LifecycleRulesInner.


        :return: The abort_incomplete_multipart_upload of this LifecycleRulesInner.
    ...
    def abort_incomplete_multipart_upload(self, abort_incomplete_multipart_upload):
        """Sets the abort_incomplete_multipart_upload of this LifecycleRulesInner.
