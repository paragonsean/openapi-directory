...
public class DataSourceDynamodbConfig {
  ...
  public DataSourceDynamodbConfig tableName(String tableName) {
  ...
  public DataSourceDynamodbConfig awsRegion(String awsRegion) {
  ...
  public DataSourceDynamodbConfig useCallerCredentials(Boolean useCallerCredentials) {
  ...
  public DataSourceDynamodbConfig deltaSyncConfig(CreateDataSourceRequestDynamodbConfigDeltaSyncConfig deltaSyncConfig) {
  ...
  public DataSourceDynamodbConfig versioned(Boolean versioned) {
  ...
  public boolean equals(Object o) {
    ...
    DataSourceDynamodbConfig dataSourceDynamodbConfig = (DataSourceDynamodbConfig) o;
    return Objects.equals(this.tableName, dataSourceDynamodbConfig.tableName) &&
        Objects.equals(this.awsRegion, dataSourceDynamodbConfig.awsRegion) &&
        Objects.equals(this.useCallerCredentials, dataSourceDynamodbConfig.useCallerCredentials) &&
        Objects.equals(this.deltaSyncConfig, dataSourceDynamodbConfig.deltaSyncConfig) &&
        Objects.equals(this.versioned, dataSourceDynamodbConfig.versioned);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataSourceDynamodbConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataSourceDynamodbConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataSourceDynamodbConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataSourceDynamodbConfig is not found in the empty JSON string", DataSourceDynamodbConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataSourceDynamodbConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataSourceDynamodbConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DataSourceDynamodbConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataSourceDynamodbConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataSourceDynamodbConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataSourceDynamodbConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataSourceDynamodbConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DataSourceDynamodbConfig>() {
           @Override
           public void write(JsonWriter out, DataSourceDynamodbConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataSourceDynamodbConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataSourceDynamodbConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataSourceDynamodbConfig
   * @throws IOException if the JSON string is invalid with respect to DataSourceDynamodbConfig
   */
  public static DataSourceDynamodbConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataSourceDynamodbConfig.class);
  }

  /**
   * Convert an instance of DataSourceDynamodbConfig to an JSON string
   *
   * @return JSON string
   */
