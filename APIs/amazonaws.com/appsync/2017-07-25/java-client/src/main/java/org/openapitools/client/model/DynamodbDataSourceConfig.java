...
public class DynamodbDataSourceConfig {
  ...
  public DynamodbDataSourceConfig() {
  }

  public DynamodbDataSourceConfig tableName(String tableName) {
  ...
  public DynamodbDataSourceConfig awsRegion(String awsRegion) {
  ...
  public DynamodbDataSourceConfig useCallerCredentials(Boolean useCallerCredentials) {
  ...
  public DynamodbDataSourceConfig deltaSyncConfig(CreateDataSourceRequestDynamodbConfigDeltaSyncConfig deltaSyncConfig) {
  ...
  public DynamodbDataSourceConfig versioned(Boolean versioned) {
  ...
  public boolean equals(Object o) {
    ...
    DynamodbDataSourceConfig dynamodbDataSourceConfig = (DynamodbDataSourceConfig) o;
    return Objects.equals(this.tableName, dynamodbDataSourceConfig.tableName) &&
        Objects.equals(this.awsRegion, dynamodbDataSourceConfig.awsRegion) &&
        Objects.equals(this.useCallerCredentials, dynamodbDataSourceConfig.useCallerCredentials) &&
        Objects.equals(this.deltaSyncConfig, dynamodbDataSourceConfig.deltaSyncConfig) &&
        Objects.equals(this.versioned, dynamodbDataSourceConfig.versioned);
  }
  ...
  public String toString() {
    ...
    sb.append("class DynamodbDataSourceConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamodbDataSourceConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamodbDataSourceConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DynamodbDataSourceConfig is not found in the empty JSON string", DynamodbDataSourceConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamodbDataSourceConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DynamodbDataSourceConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamodbDataSourceConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamodbDataSourceConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamodbDataSourceConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamodbDataSourceConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamodbDataSourceConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamodbDataSourceConfig>() {
           @Override
           public void write(JsonWriter out, DynamodbDataSourceConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamodbDataSourceConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamodbDataSourceConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamodbDataSourceConfig
   * @throws IOException if the JSON string is invalid with respect to DynamodbDataSourceConfig
   */
  public static DynamodbDataSourceConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamodbDataSourceConfig.class);
  }

  /**
   * Convert an instance of DynamodbDataSourceConfig to an JSON string
   *
   * @return JSON string
   */
