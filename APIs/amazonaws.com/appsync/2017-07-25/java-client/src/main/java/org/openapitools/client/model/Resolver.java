...
public class Resolver {
  ...
  public Resolver typeName(String typeName) {
  ...
  public Resolver fieldName(String fieldName) {
  ...
  public Resolver dataSourceName(String dataSourceName) {
  ...
  public Resolver resolverArn(String resolverArn) {
  ...
  public Resolver requestMappingTemplate(String requestMappingTemplate) {
  ...
  public Resolver responseMappingTemplate(String responseMappingTemplate) {
  ...
  public Resolver kind(ResolverKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public Resolver pipelineConfig(CreateResolverRequestPipelineConfig pipelineConfig) {
  ...
  public Resolver syncConfig(CreateResolverRequestSyncConfig syncConfig) {
  ...
  public Resolver cachingConfig(CreateResolverRequestCachingConfig cachingConfig) {
  ...
  public Resolver maxBatchSize(Integer maxBatchSize) {
  ...
  public Resolver runtime(AppSyncRuntime runtime) {
  ...
  public Resolver code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.typeName, resolver.typeName) &&
        Objects.equals(this.fieldName, resolver.fieldName) &&
        Objects.equals(this.dataSourceName, resolver.dataSourceName) &&
        Objects.equals(this.resolverArn, resolver.resolverArn) &&
        Objects.equals(this.requestMappingTemplate, resolver.requestMappingTemplate) &&
        Objects.equals(this.responseMappingTemplate, resolver.responseMappingTemplate) &&
        Objects.equals(this.kind, resolver.kind) &&
        Objects.equals(this.pipelineConfig, resolver.pipelineConfig) &&
        Objects.equals(this.syncConfig, resolver.syncConfig) &&
        Objects.equals(this.cachingConfig, resolver.cachingConfig) &&
        Objects.equals(this.maxBatchSize, resolver.maxBatchSize) &&
        Objects.equals(this.runtime, resolver.runtime) &&
        Objects.equals(this.code, resolver.code);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Resolver
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Resolver.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Resolver is not found in the empty JSON string", Resolver.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Resolver.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Resolver` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Resolver.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Resolver' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Resolver> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Resolver.class));

       return (TypeAdapter<T>) new TypeAdapter<Resolver>() {
           @Override
           public void write(JsonWriter out, Resolver value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Resolver read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Resolver given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Resolver
   * @throws IOException if the JSON string is invalid with respect to Resolver
   */
  public static Resolver fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Resolver.class);
  }

  /**
   * Convert an instance of Resolver to an JSON string
   *
   * @return JSON string
   */
