...
/**
 * GetGraphqlApiResponseGraphqlApi
 */
...
public class GetGraphqlApiResponseGraphqlApi {
  ...
  public GetGraphqlApiResponseGraphqlApi() {
  }

  public GetGraphqlApiResponseGraphqlApi name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi authenticationType(AuthenticationType authenticationType) {
  ...
  public GetGraphqlApiResponseGraphqlApi logConfig(CreateGraphqlApiRequestLogConfig logConfig) {
  ...
  public GetGraphqlApiResponseGraphqlApi userPoolConfig(CreateGraphqlApiRequestUserPoolConfig userPoolConfig) {
  ...
  public GetGraphqlApiResponseGraphqlApi openIDConnectConfig(GraphqlApiOpenIDConnectConfig openIDConnectConfig) {
  ...
  public GetGraphqlApiResponseGraphqlApi arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi uris(Map uris) {
    this.uris = uris;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi additionalAuthenticationProviders(List additionalAuthenticationProviders) {
  ...
  public GetGraphqlApiResponseGraphqlApi xrayEnabled(Boolean xrayEnabled) {
  ...
  public GetGraphqlApiResponseGraphqlApi wafWebAclArn(String wafWebAclArn) {
  ...
  public GetGraphqlApiResponseGraphqlApi lambdaAuthorizerConfig(AdditionalAuthenticationProviderLambdaAuthorizerConfig lambdaAuthorizerConfig) {
  ...
  public GetGraphqlApiResponseGraphqlApi dns(Map dns) {
    this.dns = dns;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi visibility(GraphQLApiVisibility visibility) {
  ...
  public GetGraphqlApiResponseGraphqlApi apiType(GraphQLApiType apiType) {
  ...
  public GetGraphqlApiResponseGraphqlApi mergedApiExecutionRoleArn(String mergedApiExecutionRoleArn) {
  ...
  public GetGraphqlApiResponseGraphqlApi owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GetGraphqlApiResponseGraphqlApi ownerContact(String ownerContact) {
  ...
  public boolean equals(Object o) {
    ...
    GetGraphqlApiResponseGraphqlApi getGraphqlApiResponseGraphqlApi = (GetGraphqlApiResponseGraphqlApi) o;
    return Objects.equals(this.name, getGraphqlApiResponseGraphqlApi.name) &&
        Objects.equals(this.apiId, getGraphqlApiResponseGraphqlApi.apiId) &&
        Objects.equals(this.authenticationType, getGraphqlApiResponseGraphqlApi.authenticationType) &&
        Objects.equals(this.logConfig, getGraphqlApiResponseGraphqlApi.logConfig) &&
        Objects.equals(this.userPoolConfig, getGraphqlApiResponseGraphqlApi.userPoolConfig) &&
        Objects.equals(this.openIDConnectConfig, getGraphqlApiResponseGraphqlApi.openIDConnectConfig) &&
        Objects.equals(this.arn, getGraphqlApiResponseGraphqlApi.arn) &&
        Objects.equals(this.uris, getGraphqlApiResponseGraphqlApi.uris) &&
        Objects.equals(this.tags, getGraphqlApiResponseGraphqlApi.tags) &&
        Objects.equals(this.additionalAuthenticationProviders, getGraphqlApiResponseGraphqlApi.additionalAuthenticationProviders) &&
        Objects.equals(this.xrayEnabled, getGraphqlApiResponseGraphqlApi.xrayEnabled) &&
        Objects.equals(this.wafWebAclArn, getGraphqlApiResponseGraphqlApi.wafWebAclArn) &&
        Objects.equals(this.lambdaAuthorizerConfig, getGraphqlApiResponseGraphqlApi.lambdaAuthorizerConfig) &&
        Objects.equals(this.dns, getGraphqlApiResponseGraphqlApi.dns) &&
        Objects.equals(this.visibility, getGraphqlApiResponseGraphqlApi.visibility) &&
        Objects.equals(this.apiType, getGraphqlApiResponseGraphqlApi.apiType) &&
        Objects.equals(this.mergedApiExecutionRoleArn, getGraphqlApiResponseGraphqlApi.mergedApiExecutionRoleArn) &&
        Objects.equals(this.owner, getGraphqlApiResponseGraphqlApi.owner) &&
        Objects.equals(this.ownerContact, getGraphqlApiResponseGraphqlApi.ownerContact);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetGraphqlApiResponseGraphqlApi {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetGraphqlApiResponseGraphqlApi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetGraphqlApiResponseGraphqlApi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetGraphqlApiResponseGraphqlApi is not found in the empty JSON string", GetGraphqlApiResponseGraphqlApi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetGraphqlApiResponseGraphqlApi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetGraphqlApiResponseGraphqlApi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetGraphqlApiResponseGraphqlApi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetGraphqlApiResponseGraphqlApi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetGraphqlApiResponseGraphqlApi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetGraphqlApiResponseGraphqlApi.class));

       return (TypeAdapter<T>) new TypeAdapter<GetGraphqlApiResponseGraphqlApi>() {
           @Override
           public void write(JsonWriter out, GetGraphqlApiResponseGraphqlApi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetGraphqlApiResponseGraphqlApi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetGraphqlApiResponseGraphqlApi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetGraphqlApiResponseGraphqlApi
   * @throws IOException if the JSON string is invalid with respect to GetGraphqlApiResponseGraphqlApi
   */
  public static GetGraphqlApiResponseGraphqlApi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetGraphqlApiResponseGraphqlApi.class);
  }

  /**
   * Convert an instance of GetGraphqlApiResponseGraphqlApi to an JSON string
   *
   * @return JSON string
   */
