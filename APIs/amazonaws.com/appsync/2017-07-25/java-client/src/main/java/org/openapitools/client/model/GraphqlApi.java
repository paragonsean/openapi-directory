...
public class GraphqlApi {
  ...
  public GraphqlApi name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GraphqlApi apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public GraphqlApi authenticationType(AuthenticationType authenticationType) {
  ...
  public GraphqlApi logConfig(CreateGraphqlApiRequestLogConfig logConfig) {
  ...
  public GraphqlApi userPoolConfig(CreateGraphqlApiRequestUserPoolConfig userPoolConfig) {
  ...
  public GraphqlApi openIDConnectConfig(GraphqlApiOpenIDConnectConfig openIDConnectConfig) {
  ...
  public GraphqlApi arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GraphqlApi uris(Map uris) {
    this.uris = uris;
    return this;
  }
  ...
  public GraphqlApi tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GraphqlApi additionalAuthenticationProviders(List additionalAuthenticationProviders) {
  ...
  public GraphqlApi xrayEnabled(Boolean xrayEnabled) {
  ...
  public GraphqlApi wafWebAclArn(String wafWebAclArn) {
  ...
  public GraphqlApi lambdaAuthorizerConfig(AdditionalAuthenticationProviderLambdaAuthorizerConfig lambdaAuthorizerConfig) {
  ...
  public GraphqlApi visibility(GraphQLApiVisibility visibility) {
  ...
  public GraphqlApi apiType(GraphQLApiType apiType) {
  ...
  public GraphqlApi mergedApiExecutionRoleArn(String mergedApiExecutionRoleArn) {
  ...
  public GraphqlApi owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GraphqlApi ownerContact(String ownerContact) {
  ...
  public boolean equals(Object o) {
    ...
    GraphqlApi graphqlApi = (GraphqlApi) o;
    return Objects.equals(this.name, graphqlApi.name) &&
        Objects.equals(this.apiId, graphqlApi.apiId) &&
        Objects.equals(this.authenticationType, graphqlApi.authenticationType) &&
        Objects.equals(this.logConfig, graphqlApi.logConfig) &&
        Objects.equals(this.userPoolConfig, graphqlApi.userPoolConfig) &&
        Objects.equals(this.openIDConnectConfig, graphqlApi.openIDConnectConfig) &&
        Objects.equals(this.arn, graphqlApi.arn) &&
        Objects.equals(this.uris, graphqlApi.uris) &&
        Objects.equals(this.tags, graphqlApi.tags) &&
        Objects.equals(this.additionalAuthenticationProviders, graphqlApi.additionalAuthenticationProviders) &&
        Objects.equals(this.xrayEnabled, graphqlApi.xrayEnabled) &&
        Objects.equals(this.wafWebAclArn, graphqlApi.wafWebAclArn) &&
        Objects.equals(this.lambdaAuthorizerConfig, graphqlApi.lambdaAuthorizerConfig) &&
        Objects.equals(this.dns, graphqlApi.dns) &&
        Objects.equals(this.visibility, graphqlApi.visibility) &&
        Objects.equals(this.apiType, graphqlApi.apiType) &&
        Objects.equals(this.mergedApiExecutionRoleArn, graphqlApi.mergedApiExecutionRoleArn) &&
        Objects.equals(this.owner, graphqlApi.owner) &&
        Objects.equals(this.ownerContact, graphqlApi.ownerContact);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GraphqlApi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GraphqlApi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GraphqlApi is not found in the empty JSON string", GraphqlApi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GraphqlApi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GraphqlApi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GraphqlApi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GraphqlApi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GraphqlApi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GraphqlApi.class));

       return (TypeAdapter<T>) new TypeAdapter<GraphqlApi>() {
           @Override
           public void write(JsonWriter out, GraphqlApi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GraphqlApi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GraphqlApi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GraphqlApi
   * @throws IOException if the JSON string is invalid with respect to GraphqlApi
   */
  public static GraphqlApi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GraphqlApi.class);
  }

  /**
   * Convert an instance of GraphqlApi to an JSON string
   *
   * @return JSON string
   */
