...
/**
 * UpdateResolverResponseResolver
 */
...
public class UpdateResolverResponseResolver {
  ...
  public UpdateResolverResponseResolver() {
  }

  public UpdateResolverResponseResolver typeName(String typeName) {
  ...
  public UpdateResolverResponseResolver fieldName(String fieldName) {
  ...
  public UpdateResolverResponseResolver dataSourceName(String dataSourceName) {
  ...
  public UpdateResolverResponseResolver resolverArn(String resolverArn) {
  ...
  public UpdateResolverResponseResolver requestMappingTemplate(String requestMappingTemplate) {
  ...
  public UpdateResolverResponseResolver responseMappingTemplate(String responseMappingTemplate) {
  ...
  public UpdateResolverResponseResolver kind(ResolverKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  public UpdateResolverResponseResolver pipelineConfig(CreateResolverRequestPipelineConfig pipelineConfig) {
  ...
  public UpdateResolverResponseResolver syncConfig(CreateResolverRequestSyncConfig syncConfig) {
  ...
  public UpdateResolverResponseResolver cachingConfig(CreateResolverRequestCachingConfig cachingConfig) {
  ...
  public UpdateResolverResponseResolver maxBatchSize(Integer maxBatchSize) {
  ...
  public UpdateResolverResponseResolver runtime(AppSyncRuntime runtime) {
  ...
  public UpdateResolverResponseResolver code(String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateResolverResponseResolver updateResolverResponseResolver = (UpdateResolverResponseResolver) o;
    return Objects.equals(this.typeName, updateResolverResponseResolver.typeName) &&
        Objects.equals(this.fieldName, updateResolverResponseResolver.fieldName) &&
        Objects.equals(this.dataSourceName, updateResolverResponseResolver.dataSourceName) &&
        Objects.equals(this.resolverArn, updateResolverResponseResolver.resolverArn) &&
        Objects.equals(this.requestMappingTemplate, updateResolverResponseResolver.requestMappingTemplate) &&
        Objects.equals(this.responseMappingTemplate, updateResolverResponseResolver.responseMappingTemplate) &&
        Objects.equals(this.kind, updateResolverResponseResolver.kind) &&
        Objects.equals(this.pipelineConfig, updateResolverResponseResolver.pipelineConfig) &&
        Objects.equals(this.syncConfig, updateResolverResponseResolver.syncConfig) &&
        Objects.equals(this.cachingConfig, updateResolverResponseResolver.cachingConfig) &&
        Objects.equals(this.maxBatchSize, updateResolverResponseResolver.maxBatchSize) &&
        Objects.equals(this.runtime, updateResolverResponseResolver.runtime) &&
        Objects.equals(this.code, updateResolverResponseResolver.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateResolverResponseResolver {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateResolverResponseResolver
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateResolverResponseResolver.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateResolverResponseResolver is not found in the empty JSON string", UpdateResolverResponseResolver.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateResolverResponseResolver.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateResolverResponseResolver` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateResolverResponseResolver.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateResolverResponseResolver' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateResolverResponseResolver> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateResolverResponseResolver.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateResolverResponseResolver>() {
           @Override
           public void write(JsonWriter out, UpdateResolverResponseResolver value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateResolverResponseResolver read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateResolverResponseResolver given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateResolverResponseResolver
   * @throws IOException if the JSON string is invalid with respect to UpdateResolverResponseResolver
   */
  public static UpdateResolverResponseResolver fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateResolverResponseResolver.class);
  }

  /**
   * Convert an instance of UpdateResolverResponseResolver to an JSON string
   *
   * @return JSON string
   */
