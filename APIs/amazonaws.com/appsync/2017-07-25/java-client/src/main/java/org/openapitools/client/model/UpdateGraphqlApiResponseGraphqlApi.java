...
public class UpdateGraphqlApiResponseGraphqlApi {
  ...
  public UpdateGraphqlApiResponseGraphqlApi() {
  }

  public UpdateGraphqlApiResponseGraphqlApi name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi apiId(String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi authenticationType(AuthenticationType authenticationType) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi logConfig(CreateGraphqlApiRequestLogConfig logConfig) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi userPoolConfig(CreateGraphqlApiRequestUserPoolConfig userPoolConfig) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi openIDConnectConfig(GraphqlApiOpenIDConnectConfig openIDConnectConfig) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi uris(Map uris) {
    this.uris = uris;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi additionalAuthenticationProviders(List additionalAuthenticationProviders) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi xrayEnabled(Boolean xrayEnabled) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi wafWebAclArn(String wafWebAclArn) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi lambdaAuthorizerConfig(AdditionalAuthenticationProviderLambdaAuthorizerConfig lambdaAuthorizerConfig) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi dns(Map dns) {
    this.dns = dns;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi visibility(GraphQLApiVisibility visibility) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi apiType(GraphQLApiType apiType) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi mergedApiExecutionRoleArn(String mergedApiExecutionRoleArn) {
  ...
  public UpdateGraphqlApiResponseGraphqlApi owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public UpdateGraphqlApiResponseGraphqlApi ownerContact(String ownerContact) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateGraphqlApiResponseGraphqlApi updateGraphqlApiResponseGraphqlApi = (UpdateGraphqlApiResponseGraphqlApi) o;
    return Objects.equals(this.name, updateGraphqlApiResponseGraphqlApi.name) &&
        Objects.equals(this.apiId, updateGraphqlApiResponseGraphqlApi.apiId) &&
        Objects.equals(this.authenticationType, updateGraphqlApiResponseGraphqlApi.authenticationType) &&
        Objects.equals(this.logConfig, updateGraphqlApiResponseGraphqlApi.logConfig) &&
        Objects.equals(this.userPoolConfig, updateGraphqlApiResponseGraphqlApi.userPoolConfig) &&
        Objects.equals(this.openIDConnectConfig, updateGraphqlApiResponseGraphqlApi.openIDConnectConfig) &&
        Objects.equals(this.arn, updateGraphqlApiResponseGraphqlApi.arn) &&
        Objects.equals(this.uris, updateGraphqlApiResponseGraphqlApi.uris) &&
        Objects.equals(this.tags, updateGraphqlApiResponseGraphqlApi.tags) &&
        Objects.equals(this.additionalAuthenticationProviders, updateGraphqlApiResponseGraphqlApi.additionalAuthenticationProviders) &&
        Objects.equals(this.xrayEnabled, updateGraphqlApiResponseGraphqlApi.xrayEnabled) &&
        Objects.equals(this.wafWebAclArn, updateGraphqlApiResponseGraphqlApi.wafWebAclArn) &&
        Objects.equals(this.lambdaAuthorizerConfig, updateGraphqlApiResponseGraphqlApi.lambdaAuthorizerConfig) &&
        Objects.equals(this.dns, updateGraphqlApiResponseGraphqlApi.dns) &&
        Objects.equals(this.visibility, updateGraphqlApiResponseGraphqlApi.visibility) &&
        Objects.equals(this.apiType, updateGraphqlApiResponseGraphqlApi.apiType) &&
        Objects.equals(this.mergedApiExecutionRoleArn, updateGraphqlApiResponseGraphqlApi.mergedApiExecutionRoleArn) &&
        Objects.equals(this.owner, updateGraphqlApiResponseGraphqlApi.owner) &&
        Objects.equals(this.ownerContact, updateGraphqlApiResponseGraphqlApi.ownerContact);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateGraphqlApiResponseGraphqlApi {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGraphqlApiResponseGraphqlApi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGraphqlApiResponseGraphqlApi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGraphqlApiResponseGraphqlApi is not found in the empty JSON string", UpdateGraphqlApiResponseGraphqlApi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGraphqlApiResponseGraphqlApi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGraphqlApiResponseGraphqlApi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGraphqlApiResponseGraphqlApi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGraphqlApiResponseGraphqlApi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGraphqlApiResponseGraphqlApi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGraphqlApiResponseGraphqlApi.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGraphqlApiResponseGraphqlApi>() {
           @Override
           public void write(JsonWriter out, UpdateGraphqlApiResponseGraphqlApi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGraphqlApiResponseGraphqlApi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGraphqlApiResponseGraphqlApi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGraphqlApiResponseGraphqlApi
   * @throws IOException if the JSON string is invalid with respect to UpdateGraphqlApiResponseGraphqlApi
   */
  public static UpdateGraphqlApiResponseGraphqlApi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGraphqlApiResponseGraphqlApi.class);
  }

  /**
   * Convert an instance of UpdateGraphqlApiResponseGraphqlApi to an JSON string
   *
   * @return JSON string
   */
