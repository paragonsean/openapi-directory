...
/**
 * UpdateDataSourceResponseDataSource
 */
...
public class UpdateDataSourceResponseDataSource {
  ...
  public UpdateDataSourceResponseDataSource() {
  }

  public UpdateDataSourceResponseDataSource dataSourceArn(String dataSourceArn) {
  ...
  public UpdateDataSourceResponseDataSource name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateDataSourceResponseDataSource description(String description) {
  ...
  public UpdateDataSourceResponseDataSource type(DataSourceType type) {
    this.type = type;
    return this;
  }
  ...
  public UpdateDataSourceResponseDataSource serviceRoleArn(String serviceRoleArn) {
  ...
  public UpdateDataSourceResponseDataSource dynamodbConfig(DataSourceDynamodbConfig dynamodbConfig) {
  ...
  public UpdateDataSourceResponseDataSource lambdaConfig(CreateDataSourceRequestLambdaConfig lambdaConfig) {
  ...
  public UpdateDataSourceResponseDataSource elasticsearchConfig(DataSourceElasticsearchConfig elasticsearchConfig) {
  ...
  public UpdateDataSourceResponseDataSource openSearchServiceConfig(CreateDataSourceRequestOpenSearchServiceConfig openSearchServiceConfig) {
  ...
  public UpdateDataSourceResponseDataSource httpConfig(CreateDataSourceRequestHttpConfig httpConfig) {
  ...
  public UpdateDataSourceResponseDataSource relationalDatabaseConfig(CreateDataSourceRequestRelationalDatabaseConfig relationalDatabaseConfig) {
  ...
  public UpdateDataSourceResponseDataSource eventBridgeConfig(CreateDataSourceRequestEventBridgeConfig eventBridgeConfig) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDataSourceResponseDataSource updateDataSourceResponseDataSource = (UpdateDataSourceResponseDataSource) o;
    return Objects.equals(this.dataSourceArn, updateDataSourceResponseDataSource.dataSourceArn) &&
        Objects.equals(this.name, updateDataSourceResponseDataSource.name) &&
        Objects.equals(this.description, updateDataSourceResponseDataSource.description) &&
        Objects.equals(this.type, updateDataSourceResponseDataSource.type) &&
        Objects.equals(this.serviceRoleArn, updateDataSourceResponseDataSource.serviceRoleArn) &&
        Objects.equals(this.dynamodbConfig, updateDataSourceResponseDataSource.dynamodbConfig) &&
        Objects.equals(this.lambdaConfig, updateDataSourceResponseDataSource.lambdaConfig) &&
        Objects.equals(this.elasticsearchConfig, updateDataSourceResponseDataSource.elasticsearchConfig) &&
        Objects.equals(this.openSearchServiceConfig, updateDataSourceResponseDataSource.openSearchServiceConfig) &&
        Objects.equals(this.httpConfig, updateDataSourceResponseDataSource.httpConfig) &&
        Objects.equals(this.relationalDatabaseConfig, updateDataSourceResponseDataSource.relationalDatabaseConfig) &&
        Objects.equals(this.eventBridgeConfig, updateDataSourceResponseDataSource.eventBridgeConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDataSourceResponseDataSource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDataSourceResponseDataSource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDataSourceResponseDataSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDataSourceResponseDataSource is not found in the empty JSON string", UpdateDataSourceResponseDataSource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDataSourceResponseDataSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDataSourceResponseDataSource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDataSourceResponseDataSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDataSourceResponseDataSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDataSourceResponseDataSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDataSourceResponseDataSource.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDataSourceResponseDataSource>() {
           @Override
           public void write(JsonWriter out, UpdateDataSourceResponseDataSource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDataSourceResponseDataSource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDataSourceResponseDataSource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDataSourceResponseDataSource
   * @throws IOException if the JSON string is invalid with respect to UpdateDataSourceResponseDataSource
   */
  public static UpdateDataSourceResponseDataSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDataSourceResponseDataSource.class);
  }

  /**
   * Convert an instance of UpdateDataSourceResponseDataSource to an JSON string
   *
   * @return JSON string
   */
