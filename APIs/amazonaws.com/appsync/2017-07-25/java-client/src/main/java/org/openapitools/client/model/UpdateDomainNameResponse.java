...
public class UpdateDomainNameResponse {
  public static final String SERIALIZED_NAME_DOMAIN_NAME_CONFIG = "domainNameConfig";
  @SerializedName(SERIALIZED_NAME_DOMAIN_NAME_CONFIG)
  private CreateDomainNameResponseDomainNameConfig domainNameConfig;

  public UpdateDomainNameResponse() {
  }

  public UpdateDomainNameResponse domainNameConfig(CreateDomainNameResponseDomainNameConfig domainNameConfig) {
    this.domainNameConfig = domainNameConfig;
    return this;
  }

  /**
   * Get domainNameConfig
   * @return domainNameConfig
   */
  @javax.annotation.Nullable
  public CreateDomainNameResponseDomainNameConfig getDomainNameConfig() {
    return domainNameConfig;
  }

  public void setDomainNameConfig(CreateDomainNameResponseDomainNameConfig domainNameConfig) {
    this.domainNameConfig = domainNameConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domainNameConfig, updateDomainNameResponse.domainNameConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domainNameConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("    domainNameConfig: ").append(toIndentedString(domainNameConfig)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("domainNameConfig");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `domainNameConfig`
      if (jsonObj.get("domainNameConfig") != null && !jsonObj.get("domainNameConfig").isJsonNull()) {
        CreateDomainNameResponseDomainNameConfig.validateJsonElement(jsonObj.get("domainNameConfig"));
      }
  }
