...
#ifndef OAIBrokerNodeInfo_H
#define OAIBrokerNodeInfo_H
...
class OAIBrokerNodeInfo : public OAIObject {
public:
    OAIBrokerNodeInfo();
    OAIBrokerNodeInfo(QString json);
    ~OAIBrokerNodeInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrokerNodeInfo)

#endif // OAIBrokerNodeInfo_H
