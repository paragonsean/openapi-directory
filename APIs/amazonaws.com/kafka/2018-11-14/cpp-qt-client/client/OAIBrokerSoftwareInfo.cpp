...
#include "OAIBrokerSoftwareInfo.h"
...
OAIBrokerSoftwareInfo::OAIBrokerSoftwareInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBrokerSoftwareInfo::OAIBrokerSoftwareInfo() {
    this->initializeModel();
}

OAIBrokerSoftwareInfo::~OAIBrokerSoftwareInfo() {}

void OAIBrokerSoftwareInfo::initializeModel() {
...
void OAIBrokerSoftwareInfo::fromJson(QString jsonString) {
...
void OAIBrokerSoftwareInfo::fromJsonObject(QJsonObject json) {
...
QString OAIBrokerSoftwareInfo::asJson() const {
...
QJsonObject OAIBrokerSoftwareInfo::asJsonObject() const {
    QJsonObject obj;
...
QString OAIBrokerSoftwareInfo::getConfigurationArn() const {
    return m_configuration_arn;
}
void OAIBrokerSoftwareInfo::setConfigurationArn(const QString &configuration_arn) {
    m_configuration_arn = configuration_arn;
    m_configuration_arn_isSet = true;
}

bool OAIBrokerSoftwareInfo::is_configuration_arn_Set() const{
    return m_configuration_arn_isSet;
}

bool OAIBrokerSoftwareInfo::is_configuration_arn_Valid() const{
    return m_configuration_arn_isValid;
}

qint32 OAIBrokerSoftwareInfo::getConfigurationRevision() const {
    return m_configuration_revision;
}
void OAIBrokerSoftwareInfo::setConfigurationRevision(const qint32 &configuration_revision) {
    m_configuration_revision = configuration_revision;
    m_configuration_revision_isSet = true;
}

bool OAIBrokerSoftwareInfo::is_configuration_revision_Set() const{
    return m_configuration_revision_isSet;
}

bool OAIBrokerSoftwareInfo::is_configuration_revision_Valid() const{
    return m_configuration_revision_isValid;
}

QString OAIBrokerSoftwareInfo::getKafkaVersion() const {
    return m_kafka_version;
}
void OAIBrokerSoftwareInfo::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAIBrokerSoftwareInfo::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAIBrokerSoftwareInfo::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

bool OAIBrokerSoftwareInfo::isSet() const {
...
bool OAIBrokerSoftwareInfo::isValid() const {
