...
#include "OAIProvisionedRequest.h"
...
OAIProvisionedRequest::OAIProvisionedRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProvisionedRequest::OAIProvisionedRequest() {
    this->initializeModel();
}

OAIProvisionedRequest::~OAIProvisionedRequest() {}

void OAIProvisionedRequest::initializeModel() {
...
void OAIProvisionedRequest::fromJson(QString jsonString) {
...
void OAIProvisionedRequest::fromJsonObject(QJsonObject json) {
...
QString OAIProvisionedRequest::asJson() const {
...
QJsonObject OAIProvisionedRequest::asJsonObject() const {
    QJsonObject obj;
...
OAICreateClusterV2_request_provisioned_BrokerNodeGroupInfo OAIProvisionedRequest::getBrokerNodeGroupInfo() const {
    return m_broker_node_group_info;
}
void OAIProvisionedRequest::setBrokerNodeGroupInfo(const OAICreateClusterV2_request_provisioned_BrokerNodeGroupInfo &broker_node_group_info) {
    m_broker_node_group_info = broker_node_group_info;
    m_broker_node_group_info_isSet = true;
}

bool OAIProvisionedRequest::is_broker_node_group_info_Set() const{
    return m_broker_node_group_info_isSet;
}

bool OAIProvisionedRequest::is_broker_node_group_info_Valid() const{
    return m_broker_node_group_info_isValid;
}

OAICreateClusterV2_request_provisioned_ClientAuthentication OAIProvisionedRequest::getClientAuthentication() const {
    return m_client_authentication;
}
void OAIProvisionedRequest::setClientAuthentication(const OAICreateClusterV2_request_provisioned_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAIProvisionedRequest::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAIProvisionedRequest::is_client_authentication_Valid() const{
    return m_client_authentication_isValid;
}

OAICreateClusterV2_request_provisioned_ConfigurationInfo OAIProvisionedRequest::getConfigurationInfo() const {
    return m_configuration_info;
}
void OAIProvisionedRequest::setConfigurationInfo(const OAICreateClusterV2_request_provisioned_ConfigurationInfo &configuration_info) {
    m_configuration_info = configuration_info;
    m_configuration_info_isSet = true;
}

bool OAIProvisionedRequest::is_configuration_info_Set() const{
    return m_configuration_info_isSet;
}

bool OAIProvisionedRequest::is_configuration_info_Valid() const{
    return m_configuration_info_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAIProvisionedRequest::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAIProvisionedRequest::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAIProvisionedRequest::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAIProvisionedRequest::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAIEnhancedMonitoring OAIProvisionedRequest::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAIProvisionedRequest::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAIProvisionedRequest::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAIProvisionedRequest::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAICreateClusterV2_request_provisioned_OpenMonitoring OAIProvisionedRequest::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAIProvisionedRequest::setOpenMonitoring(const OAICreateClusterV2_request_provisioned_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAIProvisionedRequest::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAIProvisionedRequest::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

QString OAIProvisionedRequest::getKafkaVersion() const {
    return m_kafka_version;
}
void OAIProvisionedRequest::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAIProvisionedRequest::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAIProvisionedRequest::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

OAICreateClusterV2_request_provisioned_LoggingInfo OAIProvisionedRequest::getLoggingInfo() const {
    return m_logging_info;
}
void OAIProvisionedRequest::setLoggingInfo(const OAICreateClusterV2_request_provisioned_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAIProvisionedRequest::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAIProvisionedRequest::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

qint32 OAIProvisionedRequest::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAIProvisionedRequest::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAIProvisionedRequest::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAIProvisionedRequest::is_number_of_broker_nodes_Valid() const{
    return m_number_of_broker_nodes_isValid;
}

OAIStorageMode OAIProvisionedRequest::getStorageMode() const {
    return m_storage_mode;
}
void OAIProvisionedRequest::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAIProvisionedRequest::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAIProvisionedRequest::is_storage_mode_Valid() const{
    return m_storage_mode_isValid;
}

bool OAIProvisionedRequest::isSet() const {
...
bool OAIProvisionedRequest::isValid() const {
