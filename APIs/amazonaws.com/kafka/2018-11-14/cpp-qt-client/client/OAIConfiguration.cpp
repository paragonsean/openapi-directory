...
QDateTime OAIConfiguration::getCreationTime() const {
    return m_creation_time;
}
void OAIConfiguration::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIConfiguration::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIConfiguration::is_creation_time_Valid() const{
...
QList OAIConfiguration::getKafkaVersions() const {
    return m_kafka_versions;
}
void OAIConfiguration::setKafkaVersions(const QList &kafka_versions) {
    m_kafka_versions = kafka_versions;
    m_kafka_versions_isSet = true;
}

bool OAIConfiguration::is_kafka_versions_Set() const{
    return m_kafka_versions_isSet;
}

bool OAIConfiguration::is_kafka_versions_Valid() const{
    return m_kafka_versions_isValid;
}

OAICreateConfigurationResponse_LatestRevision OAIConfiguration::getLatestRevision() const {
    return m_latest_revision;
}
void OAIConfiguration::setLatestRevision(const OAICreateConfigurationResponse_LatestRevision &latest_revision) {
...
OAIConfigurationState OAIConfiguration::getState() const {
    return m_state;
}
void OAIConfiguration::setState(const OAIConfigurationState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIConfiguration::is_state_Set() const{
    return m_state_isSet;
}

bool OAIConfiguration::is_state_Valid() const{
...
bool OAIConfiguration::isValid() const {
    ...
    return m_arn_isValid && m_creation_time_isValid && m_description_isValid && m_kafka_versions_isValid && m_latest_revision_isValid && m_name_isValid && m_state_isValid && true;
}
