...
/*
 * OAIClusterOperationInfo.h
 *
 *              &lt;p&gt;Returns information about a cluster operation.&lt;/p&gt;          
 */

#ifndef OAIClusterOperationInfo_H
#define OAIClusterOperationInfo_H
...
class OAIClusterOperationInfo : public OAIObject {
public:
    OAIClusterOperationInfo();
    OAIClusterOperationInfo(QString json);
    ~OAIClusterOperationInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterOperationInfo)

#endif // OAIClusterOperationInfo_H
