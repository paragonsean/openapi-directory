...
/*
 * OAIClusterOperationV2Provisioned_TargetClusterInfo.h
 *
 * 
 */

#ifndef OAIClusterOperationV2Provisioned_TargetClusterInfo_H
#define OAIClusterOperationV2Provisioned_TargetClusterInfo_H
...
class OAIClusterOperationV2Provisioned_TargetClusterInfo : public OAIObject {
public:
    OAIClusterOperationV2Provisioned_TargetClusterInfo();
    OAIClusterOperationV2Provisioned_TargetClusterInfo(QString json);
    ~OAIClusterOperationV2Provisioned_TargetClusterInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterOperationV2Provisioned_TargetClusterInfo)

#endif // OAIClusterOperationV2Provisioned_TargetClusterInfo_H
