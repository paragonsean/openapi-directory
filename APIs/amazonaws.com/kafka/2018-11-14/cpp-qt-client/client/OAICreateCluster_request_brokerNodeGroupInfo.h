...
/*
 * OAICreateCluster_request_brokerNodeGroupInfo.h
 *
 *              &lt;p&gt;Describes the setup to be used for Apache Kafka broker nodes in the cluster.&lt;/p&gt;          
 */

#ifndef OAICreateCluster_request_brokerNodeGroupInfo_H
#define OAICreateCluster_request_brokerNodeGroupInfo_H
...
class OAICreateCluster_request_brokerNodeGroupInfo : public OAIObject {
public:
    OAICreateCluster_request_brokerNodeGroupInfo();
    OAICreateCluster_request_brokerNodeGroupInfo(QString json);
    ~OAICreateCluster_request_brokerNodeGroupInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateCluster_request_brokerNodeGroupInfo)

#endif // OAICreateCluster_request_brokerNodeGroupInfo_H
