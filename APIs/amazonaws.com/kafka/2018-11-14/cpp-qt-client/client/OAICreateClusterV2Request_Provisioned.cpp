...
OAICreateClusterV2Request_Provisioned::OAICreateClusterV2Request_Provisioned(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateClusterV2Request_Provisioned::OAICreateClusterV2Request_Provisioned() {
    this->initializeModel();
}

OAICreateClusterV2Request_Provisioned::~OAICreateClusterV2Request_Provisioned() {}

void OAICreateClusterV2Request_Provisioned::initializeModel() {
...
void OAICreateClusterV2Request_Provisioned::fromJson(QString jsonString) {
...
void OAICreateClusterV2Request_Provisioned::fromJsonObject(QJsonObject json) {
...
QString OAICreateClusterV2Request_Provisioned::asJson() const {
...
QJsonObject OAICreateClusterV2Request_Provisioned::asJsonObject() const {
    QJsonObject obj;
...
OAICreateClusterV2_request_provisioned_BrokerNodeGroupInfo OAICreateClusterV2Request_Provisioned::getBrokerNodeGroupInfo() const {
    return m_broker_node_group_info;
}
void OAICreateClusterV2Request_Provisioned::setBrokerNodeGroupInfo(const OAICreateClusterV2_request_provisioned_BrokerNodeGroupInfo &broker_node_group_info) {
    m_broker_node_group_info = broker_node_group_info;
    m_broker_node_group_info_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_broker_node_group_info_Set() const{
    return m_broker_node_group_info_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_broker_node_group_info_Valid() const{
    return m_broker_node_group_info_isValid;
}

OAICreateClusterV2_request_provisioned_ClientAuthentication OAICreateClusterV2Request_Provisioned::getClientAuthentication() const {
    return m_client_authentication;
}
void OAICreateClusterV2Request_Provisioned::setClientAuthentication(const OAICreateClusterV2_request_provisioned_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_client_authentication_Valid() const{
    return m_client_authentication_isValid;
}

OAICreateClusterV2_request_provisioned_ConfigurationInfo OAICreateClusterV2Request_Provisioned::getConfigurationInfo() const {
    return m_configuration_info;
}
void OAICreateClusterV2Request_Provisioned::setConfigurationInfo(const OAICreateClusterV2_request_provisioned_ConfigurationInfo &configuration_info) {
    m_configuration_info = configuration_info;
    m_configuration_info_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_configuration_info_Set() const{
    return m_configuration_info_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_configuration_info_Valid() const{
    return m_configuration_info_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAICreateClusterV2Request_Provisioned::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAICreateClusterV2Request_Provisioned::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAIEnhancedMonitoring OAICreateClusterV2Request_Provisioned::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAICreateClusterV2Request_Provisioned::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAICreateClusterV2_request_provisioned_OpenMonitoring OAICreateClusterV2Request_Provisioned::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAICreateClusterV2Request_Provisioned::setOpenMonitoring(const OAICreateClusterV2_request_provisioned_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

QString OAICreateClusterV2Request_Provisioned::getKafkaVersion() const {
    return m_kafka_version;
}
void OAICreateClusterV2Request_Provisioned::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

OAICreateClusterV2_request_provisioned_LoggingInfo OAICreateClusterV2Request_Provisioned::getLoggingInfo() const {
    return m_logging_info;
}
void OAICreateClusterV2Request_Provisioned::setLoggingInfo(const OAICreateClusterV2_request_provisioned_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

qint32 OAICreateClusterV2Request_Provisioned::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAICreateClusterV2Request_Provisioned::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_number_of_broker_nodes_Valid() const{
    return m_number_of_broker_nodes_isValid;
}

OAIStorageMode OAICreateClusterV2Request_Provisioned::getStorageMode() const {
    return m_storage_mode;
}
void OAICreateClusterV2Request_Provisioned::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAICreateClusterV2Request_Provisioned::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAICreateClusterV2Request_Provisioned::is_storage_mode_Valid() const{
    return m_storage_mode_isValid;
}

bool OAICreateClusterV2Request_Provisioned::isSet() const {
...
bool OAICreateClusterV2Request_Provisioned::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_broker_node_group_info_isValid && m_kafka_version_isValid && m_number_of_broker_nodes_isValid && true;
}
