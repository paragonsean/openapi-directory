...
OAIClusterOperationInfo_SourceClusterInfo::OAIClusterOperationInfo_SourceClusterInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClusterOperationInfo_SourceClusterInfo::OAIClusterOperationInfo_SourceClusterInfo() {
    this->initializeModel();
}

OAIClusterOperationInfo_SourceClusterInfo::~OAIClusterOperationInfo_SourceClusterInfo() {}

void OAIClusterOperationInfo_SourceClusterInfo::initializeModel() {
...
void OAIClusterOperationInfo_SourceClusterInfo::fromJson(QString jsonString) {
...
void OAIClusterOperationInfo_SourceClusterInfo::fromJsonObject(QJsonObject json) {
...
QString OAIClusterOperationInfo_SourceClusterInfo::asJson() const {
...
QJsonObject OAIClusterOperationInfo_SourceClusterInfo::asJsonObject() const {
    QJsonObject obj;
...
QList OAIClusterOperationInfo_SourceClusterInfo::getBrokerEbsVolumeInfo() const {
    return m_broker_ebs_volume_info;
}
void OAIClusterOperationInfo_SourceClusterInfo::setBrokerEbsVolumeInfo(const QList &broker_ebs_volume_info) {
    m_broker_ebs_volume_info = broker_ebs_volume_info;
    m_broker_ebs_volume_info_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_broker_ebs_volume_info_Set() const{
    return m_broker_ebs_volume_info_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_broker_ebs_volume_info_Valid() const{
    return m_broker_ebs_volume_info_isValid;
}

OAIMutableClusterInfo_ConfigurationInfo OAIClusterOperationInfo_SourceClusterInfo::getConfigurationInfo() const {
    return m_configuration_info;
}
void OAIClusterOperationInfo_SourceClusterInfo::setConfigurationInfo(const OAIMutableClusterInfo_ConfigurationInfo &configuration_info) {
    m_configuration_info = configuration_info;
    m_configuration_info_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_configuration_info_Set() const{
    return m_configuration_info_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_configuration_info_Valid() const{
    return m_configuration_info_isValid;
}

qint32 OAIClusterOperationInfo_SourceClusterInfo::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAIClusterOperationInfo_SourceClusterInfo::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_number_of_broker_nodes_Valid() const{
    return m_number_of_broker_nodes_isValid;
}

OAIEnhancedMonitoring OAIClusterOperationInfo_SourceClusterInfo::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAIClusterOperationInfo_SourceClusterInfo::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAIMutableClusterInfo_OpenMonitoring OAIClusterOperationInfo_SourceClusterInfo::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAIClusterOperationInfo_SourceClusterInfo::setOpenMonitoring(const OAIMutableClusterInfo_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

QString OAIClusterOperationInfo_SourceClusterInfo::getKafkaVersion() const {
    return m_kafka_version;
}
void OAIClusterOperationInfo_SourceClusterInfo::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

OAIMutableClusterInfo_LoggingInfo OAIClusterOperationInfo_SourceClusterInfo::getLoggingInfo() const {
    return m_logging_info;
}
void OAIClusterOperationInfo_SourceClusterInfo::setLoggingInfo(const OAIMutableClusterInfo_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

QString OAIClusterOperationInfo_SourceClusterInfo::getInstanceType() const {
    return m_instance_type;
}
void OAIClusterOperationInfo_SourceClusterInfo::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

OAICreateClusterV2_request_provisioned_ClientAuthentication OAIClusterOperationInfo_SourceClusterInfo::getClientAuthentication() const {
    return m_client_authentication;
}
void OAIClusterOperationInfo_SourceClusterInfo::setClientAuthentication(const OAICreateClusterV2_request_provisioned_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_client_authentication_Valid() const{
    return m_client_authentication_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAIClusterOperationInfo_SourceClusterInfo::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAIClusterOperationInfo_SourceClusterInfo::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAICreateCluster_request_brokerNodeGroupInfo_ConnectivityInfo OAIClusterOperationInfo_SourceClusterInfo::getConnectivityInfo() const {
    return m_connectivity_info;
}
void OAIClusterOperationInfo_SourceClusterInfo::setConnectivityInfo(const OAICreateCluster_request_brokerNodeGroupInfo_ConnectivityInfo &connectivity_info) {
    m_connectivity_info = connectivity_info;
    m_connectivity_info_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_connectivity_info_Set() const{
    return m_connectivity_info_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_connectivity_info_Valid() const{
    return m_connectivity_info_isValid;
}

OAIStorageMode OAIClusterOperationInfo_SourceClusterInfo::getStorageMode() const {
    return m_storage_mode;
}
void OAIClusterOperationInfo_SourceClusterInfo::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAIClusterOperationInfo_SourceClusterInfo::is_storage_mode_Valid() const{
    return m_storage_mode_isValid;
}

bool OAIClusterOperationInfo_SourceClusterInfo::isSet() const {
...
bool OAIClusterOperationInfo_SourceClusterInfo::isValid() const {
