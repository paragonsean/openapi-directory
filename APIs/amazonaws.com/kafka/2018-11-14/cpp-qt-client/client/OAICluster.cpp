...
QString OAICluster::getActiveOperationArn() const {
    return m_active_operation_arn;
}
void OAICluster::setActiveOperationArn(const QString &active_operation_arn) {
    m_active_operation_arn = active_operation_arn;
    m_active_operation_arn_isSet = true;
}

bool OAICluster::is_active_operation_arn_Set() const{
    return m_active_operation_arn_isSet;
}

bool OAICluster::is_active_operation_arn_Valid() const{
    return m_active_operation_arn_isValid;
}

OAIClusterType OAICluster::getClusterType() const {
    return m_cluster_type;
}
void OAICluster::setClusterType(const OAIClusterType &cluster_type) {
...
QDateTime OAICluster::getCreationTime() const {
    return m_creation_time;
}
void OAICluster::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAICluster::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAICluster::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

QString OAICluster::getCurrentVersion() const {
    return m_current_version;
}
void OAICluster::setCurrentVersion(const QString &current_version) {
    m_current_version = current_version;
    m_current_version_isSet = true;
}

bool OAICluster::is_current_version_Set() const{
    return m_current_version_isSet;
}

bool OAICluster::is_current_version_Valid() const{
    return m_current_version_isValid;
}

OAIClusterState OAICluster::getState() const {
    return m_state;
}
void OAICluster::setState(const OAIClusterState &state) {
    m_state = state;
    m_state_isSet = true;
}
...
OAICluster_StateInfo OAICluster::getStateInfo() const {
    return m_state_info;
}
void OAICluster::setStateInfo(const OAICluster_StateInfo &state_info) {
...
QMap OAICluster::getTags() const {
    return m_tags;
}
void OAICluster::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
OAICluster_Provisioned OAICluster::getProvisioned() const {
    return m_provisioned;
}
void OAICluster::setProvisioned(const OAICluster_Provisioned &provisioned) {
    m_provisioned = provisioned;
    m_provisioned_isSet = true;
}

bool OAICluster::is_provisioned_Set() const{
    return m_provisioned_isSet;
}

bool OAICluster::is_provisioned_Valid() const{
    return m_provisioned_isValid;
}

OAICluster_Serverless OAICluster::getServerless() const {
    return m_serverless;
}
void OAICluster::setServerless(const OAICluster_Serverless &serverless) {
    m_serverless = serverless;
    m_serverless_isSet = true;
}

bool OAICluster::is_serverless_Set() const{
    return m_serverless_isSet;
}

bool OAICluster::is_serverless_Valid() const{
