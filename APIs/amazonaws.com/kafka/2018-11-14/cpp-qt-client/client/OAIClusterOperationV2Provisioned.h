...
/*
 * OAIClusterOperationV2Provisioned.h
 *
 *              &lt;p&gt;Returns information about a provisioned cluster operation.&lt;/p&gt;
 */

#ifndef OAIClusterOperationV2Provisioned_H
#define OAIClusterOperationV2Provisioned_H
...
class OAIClusterOperationV2Provisioned : public OAIObject {
public:
    OAIClusterOperationV2Provisioned();
    OAIClusterOperationV2Provisioned(QString json);
    ~OAIClusterOperationV2Provisioned() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterOperationV2Provisioned)

#endif // OAIClusterOperationV2Provisioned_H
