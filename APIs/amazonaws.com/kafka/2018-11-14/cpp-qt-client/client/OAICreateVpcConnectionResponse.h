...
/*
 * OAICreateVpcConnectionResponse.h
 *
 * 
 */

#ifndef OAICreateVpcConnectionResponse_H
#define OAICreateVpcConnectionResponse_H
...
class OAICreateVpcConnectionResponse : public OAIObject {
public:
    OAICreateVpcConnectionResponse();
    OAICreateVpcConnectionResponse(QString json);
    ~OAICreateVpcConnectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateVpcConnectionResponse)

#endif // OAICreateVpcConnectionResponse_H
