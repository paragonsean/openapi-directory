...
/*
 * OAIStorageInfo_EbsStorageInfo.h
 *
 * 
 */

#ifndef OAIStorageInfo_EbsStorageInfo_H
#define OAIStorageInfo_EbsStorageInfo_H
...
class OAIStorageInfo_EbsStorageInfo : public OAIObject {
public:
    OAIStorageInfo_EbsStorageInfo();
    OAIStorageInfo_EbsStorageInfo(QString json);
    ~OAIStorageInfo_EbsStorageInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStorageInfo_EbsStorageInfo)

#endif // OAIStorageInfo_EbsStorageInfo_H
