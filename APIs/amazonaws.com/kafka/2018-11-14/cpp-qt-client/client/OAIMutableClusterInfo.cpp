...
#include "OAIMutableClusterInfo.h"
...
OAIMutableClusterInfo::OAIMutableClusterInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMutableClusterInfo::OAIMutableClusterInfo() {
    this->initializeModel();
}

OAIMutableClusterInfo::~OAIMutableClusterInfo() {}

void OAIMutableClusterInfo::initializeModel() {
...
void OAIMutableClusterInfo::fromJson(QString jsonString) {
...
void OAIMutableClusterInfo::fromJsonObject(QJsonObject json) {
...
QString OAIMutableClusterInfo::asJson() const {
...
QJsonObject OAIMutableClusterInfo::asJsonObject() const {
    QJsonObject obj;
...
QList OAIMutableClusterInfo::getBrokerEbsVolumeInfo() const {
    return m_broker_ebs_volume_info;
}
void OAIMutableClusterInfo::setBrokerEbsVolumeInfo(const QList &broker_ebs_volume_info) {
    m_broker_ebs_volume_info = broker_ebs_volume_info;
    m_broker_ebs_volume_info_isSet = true;
}

bool OAIMutableClusterInfo::is_broker_ebs_volume_info_Set() const{
    return m_broker_ebs_volume_info_isSet;
}

bool OAIMutableClusterInfo::is_broker_ebs_volume_info_Valid() const{
    return m_broker_ebs_volume_info_isValid;
}

OAIMutableClusterInfo_ConfigurationInfo OAIMutableClusterInfo::getConfigurationInfo() const {
    return m_configuration_info;
}
void OAIMutableClusterInfo::setConfigurationInfo(const OAIMutableClusterInfo_ConfigurationInfo &configuration_info) {
    m_configuration_info = configuration_info;
    m_configuration_info_isSet = true;
}

bool OAIMutableClusterInfo::is_configuration_info_Set() const{
    return m_configuration_info_isSet;
}

bool OAIMutableClusterInfo::is_configuration_info_Valid() const{
    return m_configuration_info_isValid;
}

qint32 OAIMutableClusterInfo::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAIMutableClusterInfo::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAIMutableClusterInfo::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAIMutableClusterInfo::is_number_of_broker_nodes_Valid() const{
    return m_number_of_broker_nodes_isValid;
}

OAIEnhancedMonitoring OAIMutableClusterInfo::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAIMutableClusterInfo::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAIMutableClusterInfo::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAIMutableClusterInfo::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAIMutableClusterInfo_OpenMonitoring OAIMutableClusterInfo::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAIMutableClusterInfo::setOpenMonitoring(const OAIMutableClusterInfo_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAIMutableClusterInfo::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAIMutableClusterInfo::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

QString OAIMutableClusterInfo::getKafkaVersion() const {
    return m_kafka_version;
}
void OAIMutableClusterInfo::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAIMutableClusterInfo::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAIMutableClusterInfo::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

OAIMutableClusterInfo_LoggingInfo OAIMutableClusterInfo::getLoggingInfo() const {
    return m_logging_info;
}
void OAIMutableClusterInfo::setLoggingInfo(const OAIMutableClusterInfo_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAIMutableClusterInfo::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAIMutableClusterInfo::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

QString OAIMutableClusterInfo::getInstanceType() const {
    return m_instance_type;
}
void OAIMutableClusterInfo::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIMutableClusterInfo::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIMutableClusterInfo::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

OAICreateClusterV2_request_provisioned_ClientAuthentication OAIMutableClusterInfo::getClientAuthentication() const {
    return m_client_authentication;
}
void OAIMutableClusterInfo::setClientAuthentication(const OAICreateClusterV2_request_provisioned_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAIMutableClusterInfo::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAIMutableClusterInfo::is_client_authentication_Valid() const{
    return m_client_authentication_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAIMutableClusterInfo::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAIMutableClusterInfo::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAIMutableClusterInfo::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAIMutableClusterInfo::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAICreateCluster_request_brokerNodeGroupInfo_ConnectivityInfo OAIMutableClusterInfo::getConnectivityInfo() const {
    return m_connectivity_info;
}
void OAIMutableClusterInfo::setConnectivityInfo(const OAICreateCluster_request_brokerNodeGroupInfo_ConnectivityInfo &connectivity_info) {
    m_connectivity_info = connectivity_info;
    m_connectivity_info_isSet = true;
}

bool OAIMutableClusterInfo::is_connectivity_info_Set() const{
    return m_connectivity_info_isSet;
}

bool OAIMutableClusterInfo::is_connectivity_info_Valid() const{
    return m_connectivity_info_isValid;
}

OAIStorageMode OAIMutableClusterInfo::getStorageMode() const {
    return m_storage_mode;
}
void OAIMutableClusterInfo::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAIMutableClusterInfo::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAIMutableClusterInfo::is_storage_mode_Valid() const{
    return m_storage_mode_isValid;
}

bool OAIMutableClusterInfo::isSet() const {
...
bool OAIMutableClusterInfo::isValid() const {
