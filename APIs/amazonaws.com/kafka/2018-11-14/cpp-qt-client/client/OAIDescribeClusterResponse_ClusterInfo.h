...
/*
 * OAIDescribeClusterResponse_ClusterInfo.h
 *
 * 
 */

#ifndef OAIDescribeClusterResponse_ClusterInfo_H
#define OAIDescribeClusterResponse_ClusterInfo_H
...
class OAIDescribeClusterResponse_ClusterInfo : public OAIObject {
public:
    OAIDescribeClusterResponse_ClusterInfo();
    OAIDescribeClusterResponse_ClusterInfo(QString json);
    ~OAIDescribeClusterResponse_ClusterInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeClusterResponse_ClusterInfo)

#endif // OAIDescribeClusterResponse_ClusterInfo_H
