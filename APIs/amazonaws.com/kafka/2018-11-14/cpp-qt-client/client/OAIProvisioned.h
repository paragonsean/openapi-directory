...
#ifndef OAIProvisioned_H
#define OAIProvisioned_H
...
class OAIProvisioned : public OAIObject {
public:
    OAIProvisioned();
    OAIProvisioned(QString json);
    ~OAIProvisioned() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisioned)

#endif // OAIProvisioned_H
