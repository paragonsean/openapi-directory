...
/*
 * OAIMutableClusterInfo.h
 *
 *              &lt;p&gt;Information about cluster attributes that can be updated via update APIs.&lt;/p&gt;          
 */

#ifndef OAIMutableClusterInfo_H
#define OAIMutableClusterInfo_H
...
class OAIMutableClusterInfo : public OAIObject {
public:
    OAIMutableClusterInfo();
    OAIMutableClusterInfo(QString json);
    ~OAIMutableClusterInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMutableClusterInfo)

#endif // OAIMutableClusterInfo_H
