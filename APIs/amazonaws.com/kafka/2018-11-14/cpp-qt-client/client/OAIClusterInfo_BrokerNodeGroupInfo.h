...
/*
 * OAIClusterInfo_BrokerNodeGroupInfo.h
 *
 * 
 */

#ifndef OAIClusterInfo_BrokerNodeGroupInfo_H
#define OAIClusterInfo_BrokerNodeGroupInfo_H
...
class OAIClusterInfo_BrokerNodeGroupInfo : public OAIObject {
public:
    OAIClusterInfo_BrokerNodeGroupInfo();
    OAIClusterInfo_BrokerNodeGroupInfo(QString json);
    ~OAIClusterInfo_BrokerNodeGroupInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterInfo_BrokerNodeGroupInfo)

#endif // OAIClusterInfo_BrokerNodeGroupInfo_H
