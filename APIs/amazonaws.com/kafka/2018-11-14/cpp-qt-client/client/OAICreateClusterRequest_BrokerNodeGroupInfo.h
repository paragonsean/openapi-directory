...
/*
 * OAICreateClusterRequest_BrokerNodeGroupInfo.h
 *
 * 
 */

#ifndef OAICreateClusterRequest_BrokerNodeGroupInfo_H
#define OAICreateClusterRequest_BrokerNodeGroupInfo_H
...
class OAICreateClusterRequest_BrokerNodeGroupInfo : public OAIObject {
public:
    OAICreateClusterRequest_BrokerNodeGroupInfo();
    OAICreateClusterRequest_BrokerNodeGroupInfo(QString json);
    ~OAICreateClusterRequest_BrokerNodeGroupInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterRequest_BrokerNodeGroupInfo)

#endif // OAICreateClusterRequest_BrokerNodeGroupInfo_H
