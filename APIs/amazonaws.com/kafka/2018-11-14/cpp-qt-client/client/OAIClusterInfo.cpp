...
QString OAIClusterInfo::getActiveOperationArn() const {
    return m_active_operation_arn;
}
void OAIClusterInfo::setActiveOperationArn(const QString &active_operation_arn) {
    m_active_operation_arn = active_operation_arn;
    m_active_operation_arn_isSet = true;
}

bool OAIClusterInfo::is_active_operation_arn_Set() const{
    return m_active_operation_arn_isSet;
}

bool OAIClusterInfo::is_active_operation_arn_Valid() const{
    return m_active_operation_arn_isValid;
}

OAIClusterInfo_BrokerNodeGroupInfo OAIClusterInfo::getBrokerNodeGroupInfo() const {
    return m_broker_node_group_info;
}
void OAIClusterInfo::setBrokerNodeGroupInfo(const OAIClusterInfo_BrokerNodeGroupInfo &broker_node_group_info) {
    m_broker_node_group_info = broker_node_group_info;
    m_broker_node_group_info_isSet = true;
}

bool OAIClusterInfo::is_broker_node_group_info_Set() const{
    return m_broker_node_group_info_isSet;
}

bool OAIClusterInfo::is_broker_node_group_info_Valid() const{
    return m_broker_node_group_info_isValid;
}

OAICreateClusterV2_request_provisioned_ClientAuthentication OAIClusterInfo::getClientAuthentication() const {
    return m_client_authentication;
}
void OAIClusterInfo::setClientAuthentication(const OAICreateClusterV2_request_provisioned_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAIClusterInfo::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAIClusterInfo::is_client_authentication_Valid() const{
    return m_client_authentication_isValid;
}

QString OAIClusterInfo::getClusterArn() const {
    return m_cluster_arn;
}
void OAIClusterInfo::setClusterArn(const QString &cluster_arn) {
    m_cluster_arn = cluster_arn;
    m_cluster_arn_isSet = true;
}

bool OAIClusterInfo::is_cluster_arn_Set() const{
    return m_cluster_arn_isSet;
}

bool OAIClusterInfo::is_cluster_arn_Valid() const{
    return m_cluster_arn_isValid;
}

QString OAIClusterInfo::getClusterName() const {
    return m_cluster_name;
}
void OAIClusterInfo::setClusterName(const QString &cluster_name) {
    m_cluster_name = cluster_name;
    m_cluster_name_isSet = true;
}

bool OAIClusterInfo::is_cluster_name_Set() const{
    return m_cluster_name_isSet;
}

bool OAIClusterInfo::is_cluster_name_Valid() const{
    return m_cluster_name_isValid;
}

QDateTime OAIClusterInfo::getCreationTime() const {
    return m_creation_time;
}
void OAIClusterInfo::setCreationTime(const QDateTime &creation_time) {
    m_creation_time = creation_time;
    m_creation_time_isSet = true;
}

bool OAIClusterInfo::is_creation_time_Set() const{
    return m_creation_time_isSet;
}

bool OAIClusterInfo::is_creation_time_Valid() const{
    return m_creation_time_isValid;
}

OAIBrokerNodeInfo_CurrentBrokerSoftwareInfo OAIClusterInfo::getCurrentBrokerSoftwareInfo() const {
    return m_current_broker_software_info;
}
void OAIClusterInfo::setCurrentBrokerSoftwareInfo(const OAIBrokerNodeInfo_CurrentBrokerSoftwareInfo &current_broker_software_info) {
    m_current_broker_software_info = current_broker_software_info;
    m_current_broker_software_info_isSet = true;
}

bool OAIClusterInfo::is_current_broker_software_info_Set() const{
    return m_current_broker_software_info_isSet;
}

bool OAIClusterInfo::is_current_broker_software_info_Valid() const{
    return m_current_broker_software_info_isValid;
}

QString OAIClusterInfo::getCurrentVersion() const {
    return m_current_version;
}
void OAIClusterInfo::setCurrentVersion(const QString &current_version) {
    m_current_version = current_version;
    m_current_version_isSet = true;
}

bool OAIClusterInfo::is_current_version_Set() const{
    return m_current_version_isSet;
}

bool OAIClusterInfo::is_current_version_Valid() const{
    return m_current_version_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAIClusterInfo::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAIClusterInfo::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAIClusterInfo::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAIClusterInfo::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAIEnhancedMonitoring OAIClusterInfo::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAIClusterInfo::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAIClusterInfo::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAIClusterInfo::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAIClusterInfo_OpenMonitoring OAIClusterInfo::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAIClusterInfo::setOpenMonitoring(const OAIClusterInfo_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAIClusterInfo::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAIClusterInfo::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

OAIClusterInfo_LoggingInfo OAIClusterInfo::getLoggingInfo() const {
    return m_logging_info;
}
void OAIClusterInfo::setLoggingInfo(const OAIClusterInfo_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAIClusterInfo::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAIClusterInfo::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

qint32 OAIClusterInfo::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAIClusterInfo::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAIClusterInfo::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAIClusterInfo::is_number_of_broker_nodes_Valid() const{
    return m_number_of_broker_nodes_isValid;
}

OAIClusterState OAIClusterInfo::getState() const {
    return m_state;
}
void OAIClusterInfo::setState(const OAIClusterState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAIClusterInfo::is_state_Set() const{
    return m_state_isSet;
}

bool OAIClusterInfo::is_state_Valid() const{
    return m_state_isValid;
}

OAIClusterInfo_StateInfo OAIClusterInfo::getStateInfo() const {
    return m_state_info;
}
void OAIClusterInfo::setStateInfo(const OAIClusterInfo_StateInfo &state_info) {
    m_state_info = state_info;
    m_state_info_isSet = true;
}

bool OAIClusterInfo::is_state_info_Set() const{
    return m_state_info_isSet;
}

bool OAIClusterInfo::is_state_info_Valid() const{
    return m_state_info_isValid;
}

QMap OAIClusterInfo::getTags() const {
    return m_tags;
}
void OAIClusterInfo::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIClusterInfo::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIClusterInfo::is_tags_Valid() const{
    return m_tags_isValid;
}

QString OAIClusterInfo::getZookeeperConnectString() const {
    return m_zookeeper_connect_string;
}
void OAIClusterInfo::setZookeeperConnectString(const QString &zookeeper_connect_string) {
    m_zookeeper_connect_string = zookeeper_connect_string;
    m_zookeeper_connect_string_isSet = true;
}

bool OAIClusterInfo::is_zookeeper_connect_string_Set() const{
    return m_zookeeper_connect_string_isSet;
}

bool OAIClusterInfo::is_zookeeper_connect_string_Valid() const{
    return m_zookeeper_connect_string_isValid;
}

QString OAIClusterInfo::getZookeeperConnectStringTls() const {
    return m_zookeeper_connect_string_tls;
}
void OAIClusterInfo::setZookeeperConnectStringTls(const QString &zookeeper_connect_string_tls) {
    m_zookeeper_connect_string_tls = zookeeper_connect_string_tls;
    m_zookeeper_connect_string_tls_isSet = true;
}

bool OAIClusterInfo::is_zookeeper_connect_string_tls_Set() const{
    return m_zookeeper_connect_string_tls_isSet;
}

bool OAIClusterInfo::is_zookeeper_connect_string_tls_Valid() const{
    return m_zookeeper_connect_string_tls_isValid;
}

OAIStorageMode OAIClusterInfo::getStorageMode() const {
    return m_storage_mode;
}
void OAIClusterInfo::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAIClusterInfo::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAIClusterInfo::is_storage_mode_Valid() const{
