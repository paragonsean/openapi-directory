...
OAICreateClusterRequest_BrokerNodeGroupInfo OAICreateClusterRequest::getBrokerNodeGroupInfo() const {
    return m_broker_node_group_info;
}
void OAICreateClusterRequest::setBrokerNodeGroupInfo(const OAICreateClusterRequest_BrokerNodeGroupInfo &broker_node_group_info) {
    m_broker_node_group_info = broker_node_group_info;
    m_broker_node_group_info_isSet = true;
}

bool OAICreateClusterRequest::is_broker_node_group_info_Set() const{
    return m_broker_node_group_info_isSet;
}

bool OAICreateClusterRequest::is_broker_node_group_info_Valid() const{
    return m_broker_node_group_info_isValid;
}

OAICreateClusterRequest_ClientAuthentication OAICreateClusterRequest::getClientAuthentication() const {
    return m_client_authentication;
}
void OAICreateClusterRequest::setClientAuthentication(const OAICreateClusterRequest_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAICreateClusterRequest::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAICreateClusterRequest::is_client_authentication_Valid() const{
...
OAICreateClusterRequest_ConfigurationInfo OAICreateClusterRequest::getConfigurationInfo() const {
    return m_configuration_info;
}
void OAICreateClusterRequest::setConfigurationInfo(const OAICreateClusterRequest_ConfigurationInfo &configuration_info) {
    m_configuration_info = configuration_info;
    m_configuration_info_isSet = true;
}

bool OAICreateClusterRequest::is_configuration_info_Set() const{
    return m_configuration_info_isSet;
}

bool OAICreateClusterRequest::is_configuration_info_Valid() const{
    return m_configuration_info_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAICreateClusterRequest::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAICreateClusterRequest::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAICreateClusterRequest::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAICreateClusterRequest::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAIEnhancedMonitoring OAICreateClusterRequest::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAICreateClusterRequest::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAICreateClusterRequest::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAICreateClusterRequest::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAICreateClusterV2_request_provisioned_OpenMonitoring OAICreateClusterRequest::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAICreateClusterRequest::setOpenMonitoring(const OAICreateClusterV2_request_provisioned_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAICreateClusterRequest::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAICreateClusterRequest::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

QString OAICreateClusterRequest::getKafkaVersion() const {
    return m_kafka_version;
}
void OAICreateClusterRequest::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAICreateClusterRequest::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAICreateClusterRequest::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

OAIClusterInfo_LoggingInfo OAICreateClusterRequest::getLoggingInfo() const {
    return m_logging_info;
}
void OAICreateClusterRequest::setLoggingInfo(const OAIClusterInfo_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAICreateClusterRequest::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAICreateClusterRequest::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

qint32 OAICreateClusterRequest::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAICreateClusterRequest::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAICreateClusterRequest::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAICreateClusterRequest::is_number_of_broker_nodes_Valid() const{
...
OAIStorageMode OAICreateClusterRequest::getStorageMode() const {
    return m_storage_mode;
}
void OAICreateClusterRequest::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAICreateClusterRequest::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAICreateClusterRequest::is_storage_mode_Valid() const{
