...
/*
 * OAIBrokerNodeGroupInfo.h
 *
 *              &lt;p&gt;Describes the setup to be used for Apache Kafka broker nodes in the cluster.&lt;/p&gt;          
 */

#ifndef OAIBrokerNodeGroupInfo_H
#define OAIBrokerNodeGroupInfo_H
...
class OAIBrokerNodeGroupInfo : public OAIObject {
public:
    OAIBrokerNodeGroupInfo();
    OAIBrokerNodeGroupInfo(QString json);
    ~OAIBrokerNodeGroupInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBrokerNodeGroupInfo)

#endif // OAIBrokerNodeGroupInfo_H
