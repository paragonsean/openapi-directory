...
/*
 * OAIClusterOperationV2Provisioned_SourceClusterInfo.h
 *
 * 
 */

#ifndef OAIClusterOperationV2Provisioned_SourceClusterInfo_H
#define OAIClusterOperationV2Provisioned_SourceClusterInfo_H
...
class OAIClusterOperationV2Provisioned_SourceClusterInfo : public OAIObject {
public:
    OAIClusterOperationV2Provisioned_SourceClusterInfo();
    OAIClusterOperationV2Provisioned_SourceClusterInfo(QString json);
    ~OAIClusterOperationV2Provisioned_SourceClusterInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIClusterOperationV2Provisioned_SourceClusterInfo)

#endif // OAIClusterOperationV2Provisioned_SourceClusterInfo_H
