...
OAIClusterOperationV2Provisioned_SourceClusterInfo::OAIClusterOperationV2Provisioned_SourceClusterInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIClusterOperationV2Provisioned_SourceClusterInfo::OAIClusterOperationV2Provisioned_SourceClusterInfo() {
    this->initializeModel();
}

OAIClusterOperationV2Provisioned_SourceClusterInfo::~OAIClusterOperationV2Provisioned_SourceClusterInfo() {}

void OAIClusterOperationV2Provisioned_SourceClusterInfo::initializeModel() {
...
void OAIClusterOperationV2Provisioned_SourceClusterInfo::fromJson(QString jsonString) {
...
void OAIClusterOperationV2Provisioned_SourceClusterInfo::fromJsonObject(QJsonObject json) {
...
QString OAIClusterOperationV2Provisioned_SourceClusterInfo::asJson() const {
...
QJsonObject OAIClusterOperationV2Provisioned_SourceClusterInfo::asJsonObject() const {
    QJsonObject obj;
...
QList OAIClusterOperationV2Provisioned_SourceClusterInfo::getBrokerEbsVolumeInfo() const {
    return m_broker_ebs_volume_info;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setBrokerEbsVolumeInfo(const QList &broker_ebs_volume_info) {
    m_broker_ebs_volume_info = broker_ebs_volume_info;
    m_broker_ebs_volume_info_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_broker_ebs_volume_info_Set() const{
    return m_broker_ebs_volume_info_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_broker_ebs_volume_info_Valid() const{
    return m_broker_ebs_volume_info_isValid;
}

OAIMutableClusterInfo_ConfigurationInfo OAIClusterOperationV2Provisioned_SourceClusterInfo::getConfigurationInfo() const {
    return m_configuration_info;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setConfigurationInfo(const OAIMutableClusterInfo_ConfigurationInfo &configuration_info) {
    m_configuration_info = configuration_info;
    m_configuration_info_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_configuration_info_Set() const{
    return m_configuration_info_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_configuration_info_Valid() const{
    return m_configuration_info_isValid;
}

qint32 OAIClusterOperationV2Provisioned_SourceClusterInfo::getNumberOfBrokerNodes() const {
    return m_number_of_broker_nodes;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setNumberOfBrokerNodes(const qint32 &number_of_broker_nodes) {
    m_number_of_broker_nodes = number_of_broker_nodes;
    m_number_of_broker_nodes_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_number_of_broker_nodes_Set() const{
    return m_number_of_broker_nodes_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_number_of_broker_nodes_Valid() const{
    return m_number_of_broker_nodes_isValid;
}

OAIEnhancedMonitoring OAIClusterOperationV2Provisioned_SourceClusterInfo::getEnhancedMonitoring() const {
    return m_enhanced_monitoring;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setEnhancedMonitoring(const OAIEnhancedMonitoring &enhanced_monitoring) {
    m_enhanced_monitoring = enhanced_monitoring;
    m_enhanced_monitoring_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_enhanced_monitoring_Set() const{
    return m_enhanced_monitoring_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_enhanced_monitoring_Valid() const{
    return m_enhanced_monitoring_isValid;
}

OAIMutableClusterInfo_OpenMonitoring OAIClusterOperationV2Provisioned_SourceClusterInfo::getOpenMonitoring() const {
    return m_open_monitoring;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setOpenMonitoring(const OAIMutableClusterInfo_OpenMonitoring &open_monitoring) {
    m_open_monitoring = open_monitoring;
    m_open_monitoring_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_open_monitoring_Set() const{
    return m_open_monitoring_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_open_monitoring_Valid() const{
    return m_open_monitoring_isValid;
}

QString OAIClusterOperationV2Provisioned_SourceClusterInfo::getKafkaVersion() const {
    return m_kafka_version;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setKafkaVersion(const QString &kafka_version) {
    m_kafka_version = kafka_version;
    m_kafka_version_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_kafka_version_Set() const{
    return m_kafka_version_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_kafka_version_Valid() const{
    return m_kafka_version_isValid;
}

OAIMutableClusterInfo_LoggingInfo OAIClusterOperationV2Provisioned_SourceClusterInfo::getLoggingInfo() const {
    return m_logging_info;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setLoggingInfo(const OAIMutableClusterInfo_LoggingInfo &logging_info) {
    m_logging_info = logging_info;
    m_logging_info_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_logging_info_Set() const{
    return m_logging_info_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_logging_info_Valid() const{
    return m_logging_info_isValid;
}

QString OAIClusterOperationV2Provisioned_SourceClusterInfo::getInstanceType() const {
    return m_instance_type;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setInstanceType(const QString &instance_type) {
    m_instance_type = instance_type;
    m_instance_type_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_instance_type_Set() const{
    return m_instance_type_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_instance_type_Valid() const{
    return m_instance_type_isValid;
}

OAICreateClusterV2_request_provisioned_ClientAuthentication OAIClusterOperationV2Provisioned_SourceClusterInfo::getClientAuthentication() const {
    return m_client_authentication;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setClientAuthentication(const OAICreateClusterV2_request_provisioned_ClientAuthentication &client_authentication) {
    m_client_authentication = client_authentication;
    m_client_authentication_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_client_authentication_Set() const{
    return m_client_authentication_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_client_authentication_Valid() const{
    return m_client_authentication_isValid;
}

OAICreateClusterV2_request_provisioned_EncryptionInfo OAIClusterOperationV2Provisioned_SourceClusterInfo::getEncryptionInfo() const {
    return m_encryption_info;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setEncryptionInfo(const OAICreateClusterV2_request_provisioned_EncryptionInfo &encryption_info) {
    m_encryption_info = encryption_info;
    m_encryption_info_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_encryption_info_Set() const{
    return m_encryption_info_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_encryption_info_Valid() const{
    return m_encryption_info_isValid;
}

OAICreateCluster_request_brokerNodeGroupInfo_ConnectivityInfo OAIClusterOperationV2Provisioned_SourceClusterInfo::getConnectivityInfo() const {
    return m_connectivity_info;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setConnectivityInfo(const OAICreateCluster_request_brokerNodeGroupInfo_ConnectivityInfo &connectivity_info) {
    m_connectivity_info = connectivity_info;
    m_connectivity_info_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_connectivity_info_Set() const{
    return m_connectivity_info_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_connectivity_info_Valid() const{
    return m_connectivity_info_isValid;
}

OAIStorageMode OAIClusterOperationV2Provisioned_SourceClusterInfo::getStorageMode() const {
    return m_storage_mode;
}
void OAIClusterOperationV2Provisioned_SourceClusterInfo::setStorageMode(const OAIStorageMode &storage_mode) {
    m_storage_mode = storage_mode;
    m_storage_mode_isSet = true;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_storage_mode_Set() const{
    return m_storage_mode_isSet;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::is_storage_mode_Valid() const{
    return m_storage_mode_isValid;
}

bool OAIClusterOperationV2Provisioned_SourceClusterInfo::isSet() const {
...
bool OAIClusterOperationV2Provisioned_SourceClusterInfo::isValid() const {
