...
/*
 * OAICreateClusterV2Request_Provisioned.h
 *
 * 
 */

#ifndef OAICreateClusterV2Request_Provisioned_H
#define OAICreateClusterV2Request_Provisioned_H
...
class OAICreateClusterV2Request_Provisioned : public OAIObject {
public:
    OAICreateClusterV2Request_Provisioned();
    OAICreateClusterV2Request_Provisioned(QString json);
    ~OAICreateClusterV2Request_Provisioned() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateClusterV2Request_Provisioned)

#endif // OAICreateClusterV2Request_Provisioned_H
