...
/*
 * OAIProvisionedRequest.h
 *
 *              &lt;p&gt;Provisioned cluster request.&lt;/p&gt;          
 */

#ifndef OAIProvisionedRequest_H
#define OAIProvisionedRequest_H
...
class OAIProvisionedRequest : public OAIObject {
public:
    OAIProvisionedRequest();
    OAIProvisionedRequest(QString json);
    ~OAIProvisionedRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProvisionedRequest)

#endif // OAIProvisionedRequest_H
