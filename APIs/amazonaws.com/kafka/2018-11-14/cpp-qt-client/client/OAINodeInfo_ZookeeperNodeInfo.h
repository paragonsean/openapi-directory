...
/*
 * OAINodeInfo_ZookeeperNodeInfo.h
 *
 * 
 */

#ifndef OAINodeInfo_ZookeeperNodeInfo_H
#define OAINodeInfo_ZookeeperNodeInfo_H
...
class OAINodeInfo_ZookeeperNodeInfo : public OAIObject {
public:
    OAINodeInfo_ZookeeperNodeInfo();
    OAINodeInfo_ZookeeperNodeInfo(QString json);
    ~OAINodeInfo_ZookeeperNodeInfo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAINodeInfo_ZookeeperNodeInfo)

#endif // OAINodeInfo_ZookeeperNodeInfo_H
