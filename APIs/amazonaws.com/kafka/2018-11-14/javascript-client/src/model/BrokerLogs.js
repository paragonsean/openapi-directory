...
/**
 * The BrokerLogs model module.
 * @module model/BrokerLogs
 * @version 2018-11-14
 */
class BrokerLogs {
    /**
     * Constructs a new <code>BrokerLogs</code>.
     * @alias module:model/BrokerLogs
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>BrokerLogs</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BrokerLogs} obj Optional instance to populate.
     * @return {module:model/BrokerLogs} The populated <code>BrokerLogs</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BrokerLogs();
    ...
    /**
     * Validates the JSON data with respect to <code>BrokerLogs</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BrokerLogs</code>.
     */
