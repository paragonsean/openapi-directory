...
/**
 * The CreateClusterRequestBrokerNodeGroupInfo model module.
 * @module model/CreateClusterRequestBrokerNodeGroupInfo
 * @version 2018-11-14
 */
class CreateClusterRequestBrokerNodeGroupInfo {
    /**
     * Constructs a new <code>CreateClusterRequestBrokerNodeGroupInfo</code>.
     * @alias module:model/CreateClusterRequestBrokerNodeGroupInfo
    ...
    constructor(clientSubnets, instanceType) { 
        ...
        CreateClusterRequestBrokerNodeGroupInfo.initialize(this, clientSubnets, instanceType);
    }
    ...
    /**
     * Constructs a <code>CreateClusterRequestBrokerNodeGroupInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateClusterRequestBrokerNodeGroupInfo} obj Optional instance to populate.
     * @return {module:model/CreateClusterRequestBrokerNodeGroupInfo} The populated <code>CreateClusterRequestBrokerNodeGroupInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateClusterRequestBrokerNodeGroupInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateClusterRequestBrokerNodeGroupInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateClusterRequestBrokerNodeGroupInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateClusterRequestBrokerNodeGroupInfo.RequiredProperties) {
...
CreateClusterRequestBrokerNodeGroupInfo.RequiredProperties = ["ClientSubnets", "InstanceType"];

/**
 * @member {module:model/BrokerAZDistribution} BrokerAZDistribution
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['BrokerAZDistribution'] = undefined;

/**
 * @member {Array} ClientSubnets
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['ClientSubnets'] = undefined;

/**
 * @member {String} InstanceType
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['InstanceType'] = undefined;

/**
 * @member {Array} SecurityGroups
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['SecurityGroups'] = undefined;

/**
 * @member {module:model/CreateClusterRequestBrokerNodeGroupInfoStorageInfo} StorageInfo
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['StorageInfo'] = undefined;

/**
 * @member {module:model/CreateClusterRequestBrokerNodeGroupInfoConnectivityInfo} ConnectivityInfo
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['ConnectivityInfo'] = undefined;

/**
 * @member {Array} ZoneIds
 */
CreateClusterRequestBrokerNodeGroupInfo.prototype['ZoneIds'] = undefined;
...
export default CreateClusterRequestBrokerNodeGroupInfo;
