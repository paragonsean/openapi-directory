...
/**
 * The ClusterInfoBrokerNodeGroupInfo model module.
 * @module model/ClusterInfoBrokerNodeGroupInfo
 * @version 2018-11-14
 */
class ClusterInfoBrokerNodeGroupInfo {
    /**
     * Constructs a new <code>ClusterInfoBrokerNodeGroupInfo</code>.
     * @alias module:model/ClusterInfoBrokerNodeGroupInfo
    ...
    constructor(clientSubnets, instanceType) { 
        ...
        ClusterInfoBrokerNodeGroupInfo.initialize(this, clientSubnets, instanceType);
    }
    ...
    /**
     * Constructs a <code>ClusterInfoBrokerNodeGroupInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ClusterInfoBrokerNodeGroupInfo} obj Optional instance to populate.
     * @return {module:model/ClusterInfoBrokerNodeGroupInfo} The populated <code>ClusterInfoBrokerNodeGroupInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterInfoBrokerNodeGroupInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterInfoBrokerNodeGroupInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterInfoBrokerNodeGroupInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ClusterInfoBrokerNodeGroupInfo.RequiredProperties) {
...
ClusterInfoBrokerNodeGroupInfo.RequiredProperties = ["ClientSubnets", "InstanceType"];

/**
 * @member {module:model/BrokerAZDistribution} BrokerAZDistribution
 */
ClusterInfoBrokerNodeGroupInfo.prototype['BrokerAZDistribution'] = undefined;

/**
 * @member {Array} ClientSubnets
 */
ClusterInfoBrokerNodeGroupInfo.prototype['ClientSubnets'] = undefined;

/**
 * @member {String} InstanceType
 */
ClusterInfoBrokerNodeGroupInfo.prototype['InstanceType'] = undefined;

/**
 * @member {Array} SecurityGroups
 */
ClusterInfoBrokerNodeGroupInfo.prototype['SecurityGroups'] = undefined;

/**
 * @member {module:model/CreateClusterRequestBrokerNodeGroupInfoStorageInfo} StorageInfo
 */
ClusterInfoBrokerNodeGroupInfo.prototype['StorageInfo'] = undefined;

/**
 * @member {module:model/CreateClusterRequestBrokerNodeGroupInfoConnectivityInfo} ConnectivityInfo
 */
ClusterInfoBrokerNodeGroupInfo.prototype['ConnectivityInfo'] = undefined;

/**
 * @member {Array} ZoneIds
 */
ClusterInfoBrokerNodeGroupInfo.prototype['ZoneIds'] = undefined;
...
export default ClusterInfoBrokerNodeGroupInfo;
