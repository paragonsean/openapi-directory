...
/**
 * The Provisioned model module.
 * @module model/Provisioned
 * @version 2018-11-14
 */
class Provisioned {
    /**
     * Constructs a new <code>Provisioned</code>.
     *              &lt;p&gt;Provisioned cluster.&lt;/p&gt;          
     * @alias module:model/Provisioned
    ...
    /**
     * Constructs a <code>Provisioned</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Provisioned} obj Optional instance to populate.
     * @return {module:model/Provisioned} The populated <code>Provisioned</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Provisioned();
    ...
    /**
     * Validates the JSON data with respect to <code>Provisioned</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Provisioned</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Provisioned.RequiredProperties) {
...
Provisioned.RequiredProperties = ["BrokerNodeGroupInfo", "NumberOfBrokerNodes"];
