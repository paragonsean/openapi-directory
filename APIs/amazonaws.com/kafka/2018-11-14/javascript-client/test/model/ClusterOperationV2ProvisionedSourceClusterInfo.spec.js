...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.ClusterOperationV2ProvisionedSourceClusterInfo();
  });
  ...
  describe('ClusterOperationV2ProvisionedSourceClusterInfo', function() {
    it('should create an instance of ClusterOperationV2ProvisionedSourceClusterInfo', function() {
      // uncomment below and update the code to test ClusterOperationV2ProvisionedSourceClusterInfo
      //var instance = new ManagedStreamingForKafka.ClusterOperationV2ProvisionedSourceClusterInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.ClusterOperationV2ProvisionedSourceClusterInfo);
    });
