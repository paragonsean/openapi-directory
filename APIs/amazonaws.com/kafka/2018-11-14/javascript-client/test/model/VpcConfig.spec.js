...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.VpcConfig();
  });
  ...
  describe('VpcConfig', function() {
    it('should create an instance of VpcConfig', function() {
      ...
      //var instance = new ManagedStreamingForKafka.VpcConfig();
      //expect(instance).to.be.a(ManagedStreamingForKafka.VpcConfig);
    });
