...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.ProvisionedRequest();
  });
  ...
  describe('ProvisionedRequest', function() {
    it('should create an instance of ProvisionedRequest', function() {
      // uncomment below and update the code to test ProvisionedRequest
      //var instance = new ManagedStreamingForKafka.ProvisionedRequest();
      //expect(instance).to.be.a(ManagedStreamingForKafka.ProvisionedRequest);
    });
