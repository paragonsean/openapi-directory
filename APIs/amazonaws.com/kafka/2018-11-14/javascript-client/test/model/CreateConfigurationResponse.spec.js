...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.CreateConfigurationResponse();
  });
  ...
  describe('CreateConfigurationResponse', function() {
    it('should create an instance of CreateConfigurationResponse', function() {
      // uncomment below and update the code to test CreateConfigurationResponse
      //var instance = new ManagedStreamingForKafka.CreateConfigurationResponse();
      //expect(instance).to.be.a(ManagedStreamingForKafka.CreateConfigurationResponse);
    });
