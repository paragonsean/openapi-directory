...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.UserIdentity();
  });
  ...
  describe('UserIdentity', function() {
    it('should create an instance of UserIdentity', function() {
      ...
      //var instance = new ManagedStreamingForKafka.UserIdentity();
      //expect(instance).to.be.a(ManagedStreamingForKafka.UserIdentity);
    });
