...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.CreateClusterV2Response();
  });
  ...
  describe('CreateClusterV2Response', function() {
    it('should create an instance of CreateClusterV2Response', function() {
      // uncomment below and update the code to test CreateClusterV2Response
      //var instance = new ManagedStreamingForKafka.CreateClusterV2Response();
      //expect(instance).to.be.a(ManagedStreamingForKafka.CreateClusterV2Response);
    });
