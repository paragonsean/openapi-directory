...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.CreateClusterResponse();
  });
  ...
  describe('CreateClusterResponse', function() {
    it('should create an instance of CreateClusterResponse', function() {
      ...
      //var instance = new ManagedStreamingForKafka.CreateClusterResponse();
      //expect(instance).to.be.a(ManagedStreamingForKafka.CreateClusterResponse);
    });
