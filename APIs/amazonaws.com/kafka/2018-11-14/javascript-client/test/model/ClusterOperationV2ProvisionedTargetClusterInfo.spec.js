...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.ClusterOperationV2ProvisionedTargetClusterInfo();
  });
  ...
  describe('ClusterOperationV2ProvisionedTargetClusterInfo', function() {
    it('should create an instance of ClusterOperationV2ProvisionedTargetClusterInfo', function() {
      // uncomment below and update the code to test ClusterOperationV2ProvisionedTargetClusterInfo
      //var instance = new ManagedStreamingForKafka.ClusterOperationV2ProvisionedTargetClusterInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.ClusterOperationV2ProvisionedTargetClusterInfo);
    });
