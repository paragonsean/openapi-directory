...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.EBSStorageInfo();
  });
  ...
  describe('EBSStorageInfo', function() {
    it('should create an instance of EBSStorageInfo', function() {
      // uncomment below and update the code to test EBSStorageInfo
      //var instance = new ManagedStreamingForKafka.EBSStorageInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.EBSStorageInfo);
    });
