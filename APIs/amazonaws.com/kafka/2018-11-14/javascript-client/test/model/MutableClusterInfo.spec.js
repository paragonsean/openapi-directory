...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.MutableClusterInfo();
  });
  ...
  describe('MutableClusterInfo', function() {
    it('should create an instance of MutableClusterInfo', function() {
      // uncomment below and update the code to test MutableClusterInfo
      //var instance = new ManagedStreamingForKafka.MutableClusterInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.MutableClusterInfo);
    });
