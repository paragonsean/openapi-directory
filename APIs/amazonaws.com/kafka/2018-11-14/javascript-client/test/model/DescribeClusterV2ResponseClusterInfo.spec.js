...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.DescribeClusterV2ResponseClusterInfo();
  });
  ...
  describe('DescribeClusterV2ResponseClusterInfo', function() {
    it('should create an instance of DescribeClusterV2ResponseClusterInfo', function() {
      // uncomment below and update the code to test DescribeClusterV2ResponseClusterInfo
      //var instance = new ManagedStreamingForKafka.DescribeClusterV2ResponseClusterInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.DescribeClusterV2ResponseClusterInfo);
    });
