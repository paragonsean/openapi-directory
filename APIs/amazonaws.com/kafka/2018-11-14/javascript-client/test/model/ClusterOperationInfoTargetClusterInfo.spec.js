...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.ClusterOperationInfoTargetClusterInfo();
  });
  ...
  describe('ClusterOperationInfoTargetClusterInfo', function() {
    it('should create an instance of ClusterOperationInfoTargetClusterInfo', function() {
      // uncomment below and update the code to test ClusterOperationInfoTargetClusterInfo
      //var instance = new ManagedStreamingForKafka.ClusterOperationInfoTargetClusterInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.ClusterOperationInfoTargetClusterInfo);
    });
