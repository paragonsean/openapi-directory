...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.ConfigurationInfo();
  });
  ...
  describe('ConfigurationInfo', function() {
    it('should create an instance of ConfigurationInfo', function() {
      // uncomment below and update the code to test ConfigurationInfo
      //var instance = new ManagedStreamingForKafka.ConfigurationInfo();
      //expect(instance).to.be.a(ManagedStreamingForKafka.ConfigurationInfo);
    });
