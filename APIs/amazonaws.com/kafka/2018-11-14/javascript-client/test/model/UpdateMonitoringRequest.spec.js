...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.UpdateMonitoringRequest();
  });
  ...
  describe('UpdateMonitoringRequest', function() {
    it('should create an instance of UpdateMonitoringRequest', function() {
      // uncomment below and update the code to test UpdateMonitoringRequest
      //var instance = new ManagedStreamingForKafka.UpdateMonitoringRequest();
      //expect(instance).to.be.a(ManagedStreamingForKafka.UpdateMonitoringRequest);
    });
