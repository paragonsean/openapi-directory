...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.Provisioned();
  });
  ...
  describe('Provisioned', function() {
    it('should create an instance of Provisioned', function() {
      // uncomment below and update the code to test Provisioned
      //var instance = new ManagedStreamingForKafka.Provisioned();
      //expect(instance).to.be.a(ManagedStreamingForKafka.Provisioned);
    });
