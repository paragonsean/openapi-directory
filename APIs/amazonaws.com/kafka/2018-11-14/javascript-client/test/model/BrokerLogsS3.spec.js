...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.BrokerLogsS3();
  });
  ...
  describe('BrokerLogsS3', function() {
    it('should create an instance of BrokerLogsS3', function() {
      // uncomment below and update the code to test BrokerLogsS3
      //var instance = new ManagedStreamingForKafka.BrokerLogsS3();
      //expect(instance).to.be.a(ManagedStreamingForKafka.BrokerLogsS3);
    });
