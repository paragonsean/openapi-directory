...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.CreateClusterV2RequestProvisioned();
  });
  ...
  describe('CreateClusterV2RequestProvisioned', function() {
    it('should create an instance of CreateClusterV2RequestProvisioned', function() {
      // uncomment below and update the code to test CreateClusterV2RequestProvisioned
      //var instance = new ManagedStreamingForKafka.CreateClusterV2RequestProvisioned();
      //expect(instance).to.be.a(ManagedStreamingForKafka.CreateClusterV2RequestProvisioned);
    });
