...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ManagedStreamingForKafka.UpdateSecurityRequest();
  });
  ...
  describe('UpdateSecurityRequest', function() {
    it('should create an instance of UpdateSecurityRequest', function() {
      // uncomment below and update the code to test UpdateSecurityRequest
      //var instance = new ManagedStreamingForKafka.UpdateSecurityRequest();
      //expect(instance).to.be.a(ManagedStreamingForKafka.UpdateSecurityRequest);
    });
