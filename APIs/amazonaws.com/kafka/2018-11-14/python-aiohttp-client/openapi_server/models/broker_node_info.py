...
class BrokerNodeInfo(Model):
    ...
    def __init__(self, attached_eniid: str=None, broker_id: float=None, client_subnet: str=None, client_vpc_ip_address: str=None, current_broker_software_info: BrokerNodeInfoCurrentBrokerSoftwareInfo=None, endpoints: List=None):
        """BrokerNodeInfo - a model defined in OpenAPI

        :param attached_eniid: The attached_eniid of this BrokerNodeInfo.
        :param broker_id: The broker_id of this BrokerNodeInfo.
        :param client_subnet: The client_subnet of this BrokerNodeInfo.
        :param client_vpc_ip_address: The client_vpc_ip_address of this BrokerNodeInfo.
        :param current_broker_software_info: The current_broker_software_info of this BrokerNodeInfo.
        :param endpoints: The endpoints of this BrokerNodeInfo.
        """
        self.openapi_types = {
            'attached_eniid': str,
            'broker_id': float,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'BrokerNodeInfo':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The BrokerNodeInfo of this BrokerNodeInfo.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def attached_eniid(self):
        """Gets the attached_eniid of this BrokerNodeInfo.


        :return: The attached_eniid of this BrokerNodeInfo.
        :rtype: str
        """
    ...
    def attached_eniid(self, attached_eniid):
        """Sets the attached_eniid of this BrokerNodeInfo.
    ...
    @property
    def broker_id(self):
        """Gets the broker_id of this BrokerNodeInfo.


        :return: The broker_id of this BrokerNodeInfo.
        :rtype: float
        """
    ...
    def broker_id(self, broker_id):
        """Sets the broker_id of this BrokerNodeInfo.
    ...
    def client_subnet(self):
        """Gets the client_subnet of this BrokerNodeInfo.


        :return: The client_subnet of this BrokerNodeInfo.
        :rtype: str
        """
    ...
    def client_subnet(self, client_subnet):
        """Sets the client_subnet of this BrokerNodeInfo.
    ...
    def client_vpc_ip_address(self):
        """Gets the client_vpc_ip_address of this BrokerNodeInfo.


        :return: The client_vpc_ip_address of this BrokerNodeInfo.
        :rtype: str
        """
    ...
    def client_vpc_ip_address(self, client_vpc_ip_address):
        """Sets the client_vpc_ip_address of this BrokerNodeInfo.
    ...
    def current_broker_software_info(self):
        """Gets the current_broker_software_info of this BrokerNodeInfo.


        :return: The current_broker_software_info of this BrokerNodeInfo.
    ...
    def current_broker_software_info(self, current_broker_software_info):
        """Sets the current_broker_software_info of this BrokerNodeInfo.
    ...
    @property
    def endpoints(self):
        """Gets the endpoints of this BrokerNodeInfo.


        :return: The endpoints of this BrokerNodeInfo.
        :rtype: List
        """
    ...
    def endpoints(self, endpoints):
        """Sets the endpoints of this BrokerNodeInfo.
