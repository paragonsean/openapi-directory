...
public class DescribeClusterResponseClusterInfo {
  ...
  public DescribeClusterResponseClusterInfo() {
  }

  public DescribeClusterResponseClusterInfo activeOperationArn(String activeOperationArn) {
  ...
  public DescribeClusterResponseClusterInfo brokerNodeGroupInfo(ClusterInfoBrokerNodeGroupInfo brokerNodeGroupInfo) {
  ...
  public DescribeClusterResponseClusterInfo clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public DescribeClusterResponseClusterInfo clusterArn(String clusterArn) {
  ...
  public DescribeClusterResponseClusterInfo clusterName(String clusterName) {
  ...
  public DescribeClusterResponseClusterInfo creationTime(OffsetDateTime creationTime) {
  ...
  public DescribeClusterResponseClusterInfo currentBrokerSoftwareInfo(BrokerNodeInfoCurrentBrokerSoftwareInfo currentBrokerSoftwareInfo) {
  ...
  public DescribeClusterResponseClusterInfo currentVersion(String currentVersion) {
  ...
  public DescribeClusterResponseClusterInfo encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public DescribeClusterResponseClusterInfo enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public DescribeClusterResponseClusterInfo openMonitoring(ClusterInfoOpenMonitoring openMonitoring) {
  ...
  public DescribeClusterResponseClusterInfo loggingInfo(ClusterInfoLoggingInfo loggingInfo) {
  ...
  public DescribeClusterResponseClusterInfo numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public DescribeClusterResponseClusterInfo state(ClusterState state) {
    this.state = state;
    return this;
  }
  ...
  public DescribeClusterResponseClusterInfo stateInfo(ClusterInfoStateInfo stateInfo) {
  ...
  public DescribeClusterResponseClusterInfo tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DescribeClusterResponseClusterInfo zookeeperConnectString(String zookeeperConnectString) {
  ...
  public DescribeClusterResponseClusterInfo zookeeperConnectStringTls(String zookeeperConnectStringTls) {
  ...
  public DescribeClusterResponseClusterInfo storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeClusterResponseClusterInfo describeClusterResponseClusterInfo = (DescribeClusterResponseClusterInfo) o;
    return Objects.equals(this.activeOperationArn, describeClusterResponseClusterInfo.activeOperationArn) &&
        Objects.equals(this.brokerNodeGroupInfo, describeClusterResponseClusterInfo.brokerNodeGroupInfo) &&
        Objects.equals(this.clientAuthentication, describeClusterResponseClusterInfo.clientAuthentication) &&
        Objects.equals(this.clusterArn, describeClusterResponseClusterInfo.clusterArn) &&
        Objects.equals(this.clusterName, describeClusterResponseClusterInfo.clusterName) &&
        Objects.equals(this.creationTime, describeClusterResponseClusterInfo.creationTime) &&
        Objects.equals(this.currentBrokerSoftwareInfo, describeClusterResponseClusterInfo.currentBrokerSoftwareInfo) &&
        Objects.equals(this.currentVersion, describeClusterResponseClusterInfo.currentVersion) &&
        Objects.equals(this.encryptionInfo, describeClusterResponseClusterInfo.encryptionInfo) &&
        Objects.equals(this.enhancedMonitoring, describeClusterResponseClusterInfo.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, describeClusterResponseClusterInfo.openMonitoring) &&
        Objects.equals(this.loggingInfo, describeClusterResponseClusterInfo.loggingInfo) &&
        Objects.equals(this.numberOfBrokerNodes, describeClusterResponseClusterInfo.numberOfBrokerNodes) &&
        Objects.equals(this.state, describeClusterResponseClusterInfo.state) &&
        Objects.equals(this.stateInfo, describeClusterResponseClusterInfo.stateInfo) &&
        Objects.equals(this.tags, describeClusterResponseClusterInfo.tags) &&
        Objects.equals(this.zookeeperConnectString, describeClusterResponseClusterInfo.zookeeperConnectString) &&
        Objects.equals(this.zookeeperConnectStringTls, describeClusterResponseClusterInfo.zookeeperConnectStringTls) &&
        Objects.equals(this.storageMode, describeClusterResponseClusterInfo.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeClusterResponseClusterInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeClusterResponseClusterInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeClusterResponseClusterInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeClusterResponseClusterInfo is not found in the empty JSON string", DescribeClusterResponseClusterInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeClusterResponseClusterInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeClusterResponseClusterInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeClusterResponseClusterInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeClusterResponseClusterInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeClusterResponseClusterInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeClusterResponseClusterInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeClusterResponseClusterInfo>() {
           @Override
           public void write(JsonWriter out, DescribeClusterResponseClusterInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeClusterResponseClusterInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeClusterResponseClusterInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeClusterResponseClusterInfo
   * @throws IOException if the JSON string is invalid with respect to DescribeClusterResponseClusterInfo
   */
  public static DescribeClusterResponseClusterInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeClusterResponseClusterInfo.class);
  }

  /**
   * Convert an instance of DescribeClusterResponseClusterInfo to an JSON string
   *
   * @return JSON string
   */
