...
public class MutableClusterInfo {
  ...
  public MutableClusterInfo() {
  }

  public MutableClusterInfo brokerEBSVolumeInfo(List brokerEBSVolumeInfo) {
  ...
  public MutableClusterInfo configurationInfo(MutableClusterInfoConfigurationInfo configurationInfo) {
  ...
  public MutableClusterInfo numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public MutableClusterInfo enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public MutableClusterInfo openMonitoring(MutableClusterInfoOpenMonitoring openMonitoring) {
  ...
  public MutableClusterInfo kafkaVersion(String kafkaVersion) {
  ...
  public MutableClusterInfo loggingInfo(MutableClusterInfoLoggingInfo loggingInfo) {
  ...
  public MutableClusterInfo instanceType(String instanceType) {
  ...
  public MutableClusterInfo clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public MutableClusterInfo encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public MutableClusterInfo connectivityInfo(CreateClusterRequestBrokerNodeGroupInfoConnectivityInfo connectivityInfo) {
  ...
  public MutableClusterInfo storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    MutableClusterInfo mutableClusterInfo = (MutableClusterInfo) o;
    return Objects.equals(this.brokerEBSVolumeInfo, mutableClusterInfo.brokerEBSVolumeInfo) &&
        Objects.equals(this.configurationInfo, mutableClusterInfo.configurationInfo) &&
        Objects.equals(this.numberOfBrokerNodes, mutableClusterInfo.numberOfBrokerNodes) &&
        Objects.equals(this.enhancedMonitoring, mutableClusterInfo.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, mutableClusterInfo.openMonitoring) &&
        Objects.equals(this.kafkaVersion, mutableClusterInfo.kafkaVersion) &&
        Objects.equals(this.loggingInfo, mutableClusterInfo.loggingInfo) &&
        Objects.equals(this.instanceType, mutableClusterInfo.instanceType) &&
        Objects.equals(this.clientAuthentication, mutableClusterInfo.clientAuthentication) &&
        Objects.equals(this.encryptionInfo, mutableClusterInfo.encryptionInfo) &&
        Objects.equals(this.connectivityInfo, mutableClusterInfo.connectivityInfo) &&
        Objects.equals(this.storageMode, mutableClusterInfo.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class MutableClusterInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MutableClusterInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MutableClusterInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MutableClusterInfo is not found in the empty JSON string", MutableClusterInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MutableClusterInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MutableClusterInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MutableClusterInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MutableClusterInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MutableClusterInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MutableClusterInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<MutableClusterInfo>() {
           @Override
           public void write(JsonWriter out, MutableClusterInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MutableClusterInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MutableClusterInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MutableClusterInfo
   * @throws IOException if the JSON string is invalid with respect to MutableClusterInfo
   */
  public static MutableClusterInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MutableClusterInfo.class);
  }

  /**
   * Convert an instance of MutableClusterInfo to an JSON string
   *
   * @return JSON string
   */
