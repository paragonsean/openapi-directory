...
public class ClusterProvisioned {
  ...
  public ClusterProvisioned() {
  }

  public ClusterProvisioned brokerNodeGroupInfo(CreateClusterV2RequestProvisionedBrokerNodeGroupInfo brokerNodeGroupInfo) {
  ...
  public ClusterProvisioned currentBrokerSoftwareInfo(ProvisionedCurrentBrokerSoftwareInfo currentBrokerSoftwareInfo) {
  ...
  public ClusterProvisioned clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public ClusterProvisioned encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public ClusterProvisioned enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public ClusterProvisioned openMonitoring(CreateClusterV2RequestProvisionedOpenMonitoring openMonitoring) {
  ...
  public ClusterProvisioned loggingInfo(CreateClusterV2RequestProvisionedLoggingInfo loggingInfo) {
  ...
  public ClusterProvisioned numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public ClusterProvisioned zookeeperConnectString(String zookeeperConnectString) {
  ...
  public ClusterProvisioned zookeeperConnectStringTls(String zookeeperConnectStringTls) {
  ...
  public ClusterProvisioned storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterProvisioned clusterProvisioned = (ClusterProvisioned) o;
    return Objects.equals(this.brokerNodeGroupInfo, clusterProvisioned.brokerNodeGroupInfo) &&
        Objects.equals(this.currentBrokerSoftwareInfo, clusterProvisioned.currentBrokerSoftwareInfo) &&
        Objects.equals(this.clientAuthentication, clusterProvisioned.clientAuthentication) &&
        Objects.equals(this.encryptionInfo, clusterProvisioned.encryptionInfo) &&
        Objects.equals(this.enhancedMonitoring, clusterProvisioned.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, clusterProvisioned.openMonitoring) &&
        Objects.equals(this.loggingInfo, clusterProvisioned.loggingInfo) &&
        Objects.equals(this.numberOfBrokerNodes, clusterProvisioned.numberOfBrokerNodes) &&
        Objects.equals(this.zookeeperConnectString, clusterProvisioned.zookeeperConnectString) &&
        Objects.equals(this.zookeeperConnectStringTls, clusterProvisioned.zookeeperConnectStringTls) &&
        Objects.equals(this.storageMode, clusterProvisioned.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterProvisioned {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterProvisioned
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterProvisioned.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterProvisioned is not found in the empty JSON string", ClusterProvisioned.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterProvisioned.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterProvisioned` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ClusterProvisioned.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterProvisioned.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterProvisioned' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterProvisioned> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterProvisioned.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterProvisioned>() {
           @Override
           public void write(JsonWriter out, ClusterProvisioned value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterProvisioned read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterProvisioned given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterProvisioned
   * @throws IOException if the JSON string is invalid with respect to ClusterProvisioned
   */
  public static ClusterProvisioned fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterProvisioned.class);
  }

  /**
   * Convert an instance of ClusterProvisioned to an JSON string
   *
   * @return JSON string
   */
