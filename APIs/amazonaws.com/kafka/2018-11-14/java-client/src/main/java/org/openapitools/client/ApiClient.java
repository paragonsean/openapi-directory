...
public class ApiClient {
    ...
    private String basePath = "http://kafka.us-east-1.amazonaws.com";
    ...
    new ServerConfiguration(
      "http://kafka.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://kafka.{region}.amazonaws.com.cn",
      "The Kafka endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-11-14/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://kafka.us-east-1.amazonaws.com
