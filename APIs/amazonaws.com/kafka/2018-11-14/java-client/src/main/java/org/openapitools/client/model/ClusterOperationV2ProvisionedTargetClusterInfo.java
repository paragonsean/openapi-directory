...
public class ClusterOperationV2ProvisionedTargetClusterInfo {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo() {
  }

  public ClusterOperationV2ProvisionedTargetClusterInfo brokerEBSVolumeInfo(List brokerEBSVolumeInfo) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo configurationInfo(MutableClusterInfoConfigurationInfo configurationInfo) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo openMonitoring(MutableClusterInfoOpenMonitoring openMonitoring) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo kafkaVersion(String kafkaVersion) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo loggingInfo(MutableClusterInfoLoggingInfo loggingInfo) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo instanceType(String instanceType) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo connectivityInfo(CreateClusterRequestBrokerNodeGroupInfoConnectivityInfo connectivityInfo) {
  ...
  public ClusterOperationV2ProvisionedTargetClusterInfo storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterOperationV2ProvisionedTargetClusterInfo clusterOperationV2ProvisionedTargetClusterInfo = (ClusterOperationV2ProvisionedTargetClusterInfo) o;
    return Objects.equals(this.brokerEBSVolumeInfo, clusterOperationV2ProvisionedTargetClusterInfo.brokerEBSVolumeInfo) &&
        Objects.equals(this.configurationInfo, clusterOperationV2ProvisionedTargetClusterInfo.configurationInfo) &&
        Objects.equals(this.numberOfBrokerNodes, clusterOperationV2ProvisionedTargetClusterInfo.numberOfBrokerNodes) &&
        Objects.equals(this.enhancedMonitoring, clusterOperationV2ProvisionedTargetClusterInfo.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, clusterOperationV2ProvisionedTargetClusterInfo.openMonitoring) &&
        Objects.equals(this.kafkaVersion, clusterOperationV2ProvisionedTargetClusterInfo.kafkaVersion) &&
        Objects.equals(this.loggingInfo, clusterOperationV2ProvisionedTargetClusterInfo.loggingInfo) &&
        Objects.equals(this.instanceType, clusterOperationV2ProvisionedTargetClusterInfo.instanceType) &&
        Objects.equals(this.clientAuthentication, clusterOperationV2ProvisionedTargetClusterInfo.clientAuthentication) &&
        Objects.equals(this.encryptionInfo, clusterOperationV2ProvisionedTargetClusterInfo.encryptionInfo) &&
        Objects.equals(this.connectivityInfo, clusterOperationV2ProvisionedTargetClusterInfo.connectivityInfo) &&
        Objects.equals(this.storageMode, clusterOperationV2ProvisionedTargetClusterInfo.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterOperationV2ProvisionedTargetClusterInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterOperationV2ProvisionedTargetClusterInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterOperationV2ProvisionedTargetClusterInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterOperationV2ProvisionedTargetClusterInfo is not found in the empty JSON string", ClusterOperationV2ProvisionedTargetClusterInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterOperationV2ProvisionedTargetClusterInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterOperationV2ProvisionedTargetClusterInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterOperationV2ProvisionedTargetClusterInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterOperationV2ProvisionedTargetClusterInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterOperationV2ProvisionedTargetClusterInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterOperationV2ProvisionedTargetClusterInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterOperationV2ProvisionedTargetClusterInfo>() {
           @Override
           public void write(JsonWriter out, ClusterOperationV2ProvisionedTargetClusterInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterOperationV2ProvisionedTargetClusterInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterOperationV2ProvisionedTargetClusterInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterOperationV2ProvisionedTargetClusterInfo
   * @throws IOException if the JSON string is invalid with respect to ClusterOperationV2ProvisionedTargetClusterInfo
   */
  public static ClusterOperationV2ProvisionedTargetClusterInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterOperationV2ProvisionedTargetClusterInfo.class);
  }

  /**
   * Convert an instance of ClusterOperationV2ProvisionedTargetClusterInfo to an JSON string
   *
   * @return JSON string
   */
