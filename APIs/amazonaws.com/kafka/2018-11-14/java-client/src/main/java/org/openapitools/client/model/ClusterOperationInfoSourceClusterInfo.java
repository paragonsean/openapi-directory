...
public class ClusterOperationInfoSourceClusterInfo {
  ...
  public ClusterOperationInfoSourceClusterInfo() {
  }

  public ClusterOperationInfoSourceClusterInfo brokerEBSVolumeInfo(List brokerEBSVolumeInfo) {
  ...
  public ClusterOperationInfoSourceClusterInfo configurationInfo(MutableClusterInfoConfigurationInfo configurationInfo) {
  ...
  public ClusterOperationInfoSourceClusterInfo numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public ClusterOperationInfoSourceClusterInfo enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public ClusterOperationInfoSourceClusterInfo openMonitoring(MutableClusterInfoOpenMonitoring openMonitoring) {
  ...
  public ClusterOperationInfoSourceClusterInfo kafkaVersion(String kafkaVersion) {
  ...
  public ClusterOperationInfoSourceClusterInfo loggingInfo(MutableClusterInfoLoggingInfo loggingInfo) {
  ...
  public ClusterOperationInfoSourceClusterInfo instanceType(String instanceType) {
  ...
  public ClusterOperationInfoSourceClusterInfo clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public ClusterOperationInfoSourceClusterInfo encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public ClusterOperationInfoSourceClusterInfo connectivityInfo(CreateClusterRequestBrokerNodeGroupInfoConnectivityInfo connectivityInfo) {
  ...
  public ClusterOperationInfoSourceClusterInfo storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterOperationInfoSourceClusterInfo clusterOperationInfoSourceClusterInfo = (ClusterOperationInfoSourceClusterInfo) o;
    return Objects.equals(this.brokerEBSVolumeInfo, clusterOperationInfoSourceClusterInfo.brokerEBSVolumeInfo) &&
        Objects.equals(this.configurationInfo, clusterOperationInfoSourceClusterInfo.configurationInfo) &&
        Objects.equals(this.numberOfBrokerNodes, clusterOperationInfoSourceClusterInfo.numberOfBrokerNodes) &&
        Objects.equals(this.enhancedMonitoring, clusterOperationInfoSourceClusterInfo.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, clusterOperationInfoSourceClusterInfo.openMonitoring) &&
        Objects.equals(this.kafkaVersion, clusterOperationInfoSourceClusterInfo.kafkaVersion) &&
        Objects.equals(this.loggingInfo, clusterOperationInfoSourceClusterInfo.loggingInfo) &&
        Objects.equals(this.instanceType, clusterOperationInfoSourceClusterInfo.instanceType) &&
        Objects.equals(this.clientAuthentication, clusterOperationInfoSourceClusterInfo.clientAuthentication) &&
        Objects.equals(this.encryptionInfo, clusterOperationInfoSourceClusterInfo.encryptionInfo) &&
        Objects.equals(this.connectivityInfo, clusterOperationInfoSourceClusterInfo.connectivityInfo) &&
        Objects.equals(this.storageMode, clusterOperationInfoSourceClusterInfo.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterOperationInfoSourceClusterInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterOperationInfoSourceClusterInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterOperationInfoSourceClusterInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterOperationInfoSourceClusterInfo is not found in the empty JSON string", ClusterOperationInfoSourceClusterInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterOperationInfoSourceClusterInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterOperationInfoSourceClusterInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterOperationInfoSourceClusterInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterOperationInfoSourceClusterInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterOperationInfoSourceClusterInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterOperationInfoSourceClusterInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterOperationInfoSourceClusterInfo>() {
           @Override
           public void write(JsonWriter out, ClusterOperationInfoSourceClusterInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterOperationInfoSourceClusterInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterOperationInfoSourceClusterInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterOperationInfoSourceClusterInfo
   * @throws IOException if the JSON string is invalid with respect to ClusterOperationInfoSourceClusterInfo
   */
  public static ClusterOperationInfoSourceClusterInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterOperationInfoSourceClusterInfo.class);
  }

  /**
   * Convert an instance of ClusterOperationInfoSourceClusterInfo to an JSON string
   *
   * @return JSON string
   */
