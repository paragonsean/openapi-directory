...
public class ClusterOperationV2ProvisionedSourceClusterInfo {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo() {
  }

  public ClusterOperationV2ProvisionedSourceClusterInfo brokerEBSVolumeInfo(List brokerEBSVolumeInfo) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo configurationInfo(MutableClusterInfoConfigurationInfo configurationInfo) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo openMonitoring(MutableClusterInfoOpenMonitoring openMonitoring) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo kafkaVersion(String kafkaVersion) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo loggingInfo(MutableClusterInfoLoggingInfo loggingInfo) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo instanceType(String instanceType) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo connectivityInfo(CreateClusterRequestBrokerNodeGroupInfoConnectivityInfo connectivityInfo) {
  ...
  public ClusterOperationV2ProvisionedSourceClusterInfo storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    ClusterOperationV2ProvisionedSourceClusterInfo clusterOperationV2ProvisionedSourceClusterInfo = (ClusterOperationV2ProvisionedSourceClusterInfo) o;
    return Objects.equals(this.brokerEBSVolumeInfo, clusterOperationV2ProvisionedSourceClusterInfo.brokerEBSVolumeInfo) &&
        Objects.equals(this.configurationInfo, clusterOperationV2ProvisionedSourceClusterInfo.configurationInfo) &&
        Objects.equals(this.numberOfBrokerNodes, clusterOperationV2ProvisionedSourceClusterInfo.numberOfBrokerNodes) &&
        Objects.equals(this.enhancedMonitoring, clusterOperationV2ProvisionedSourceClusterInfo.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, clusterOperationV2ProvisionedSourceClusterInfo.openMonitoring) &&
        Objects.equals(this.kafkaVersion, clusterOperationV2ProvisionedSourceClusterInfo.kafkaVersion) &&
        Objects.equals(this.loggingInfo, clusterOperationV2ProvisionedSourceClusterInfo.loggingInfo) &&
        Objects.equals(this.instanceType, clusterOperationV2ProvisionedSourceClusterInfo.instanceType) &&
        Objects.equals(this.clientAuthentication, clusterOperationV2ProvisionedSourceClusterInfo.clientAuthentication) &&
        Objects.equals(this.encryptionInfo, clusterOperationV2ProvisionedSourceClusterInfo.encryptionInfo) &&
        Objects.equals(this.connectivityInfo, clusterOperationV2ProvisionedSourceClusterInfo.connectivityInfo) &&
        Objects.equals(this.storageMode, clusterOperationV2ProvisionedSourceClusterInfo.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterOperationV2ProvisionedSourceClusterInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClusterOperationV2ProvisionedSourceClusterInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterOperationV2ProvisionedSourceClusterInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterOperationV2ProvisionedSourceClusterInfo is not found in the empty JSON string", ClusterOperationV2ProvisionedSourceClusterInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClusterOperationV2ProvisionedSourceClusterInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ClusterOperationV2ProvisionedSourceClusterInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterOperationV2ProvisionedSourceClusterInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterOperationV2ProvisionedSourceClusterInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterOperationV2ProvisionedSourceClusterInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterOperationV2ProvisionedSourceClusterInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterOperationV2ProvisionedSourceClusterInfo>() {
           @Override
           public void write(JsonWriter out, ClusterOperationV2ProvisionedSourceClusterInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClusterOperationV2ProvisionedSourceClusterInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClusterOperationV2ProvisionedSourceClusterInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClusterOperationV2ProvisionedSourceClusterInfo
   * @throws IOException if the JSON string is invalid with respect to ClusterOperationV2ProvisionedSourceClusterInfo
   */
  public static ClusterOperationV2ProvisionedSourceClusterInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterOperationV2ProvisionedSourceClusterInfo.class);
  }

  /**
   * Convert an instance of ClusterOperationV2ProvisionedSourceClusterInfo to an JSON string
   *
   * @return JSON string
   */
