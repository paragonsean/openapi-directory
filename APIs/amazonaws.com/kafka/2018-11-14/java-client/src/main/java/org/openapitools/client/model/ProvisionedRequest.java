...
public class ProvisionedRequest {
  ...
  public ProvisionedRequest brokerNodeGroupInfo(CreateClusterV2RequestProvisionedBrokerNodeGroupInfo brokerNodeGroupInfo) {
  ...
  public ProvisionedRequest clientAuthentication(CreateClusterV2RequestProvisionedClientAuthentication clientAuthentication) {
  ...
  public ProvisionedRequest configurationInfo(CreateClusterV2RequestProvisionedConfigurationInfo configurationInfo) {
  ...
  public ProvisionedRequest encryptionInfo(CreateClusterV2RequestProvisionedEncryptionInfo encryptionInfo) {
  ...
  public ProvisionedRequest enhancedMonitoring(EnhancedMonitoring enhancedMonitoring) {
  ...
  public ProvisionedRequest openMonitoring(CreateClusterV2RequestProvisionedOpenMonitoring openMonitoring) {
  ...
  public ProvisionedRequest kafkaVersion(String kafkaVersion) {
  ...
  public ProvisionedRequest loggingInfo(CreateClusterV2RequestProvisionedLoggingInfo loggingInfo) {
  ...
  public ProvisionedRequest numberOfBrokerNodes(Integer numberOfBrokerNodes) {
  ...
  public ProvisionedRequest storageMode(StorageMode storageMode) {
  ...
  public boolean equals(Object o) {
    ...
    ProvisionedRequest provisionedRequest = (ProvisionedRequest) o;
    return Objects.equals(this.brokerNodeGroupInfo, provisionedRequest.brokerNodeGroupInfo) &&
        Objects.equals(this.clientAuthentication, provisionedRequest.clientAuthentication) &&
        Objects.equals(this.configurationInfo, provisionedRequest.configurationInfo) &&
        Objects.equals(this.encryptionInfo, provisionedRequest.encryptionInfo) &&
        Objects.equals(this.enhancedMonitoring, provisionedRequest.enhancedMonitoring) &&
        Objects.equals(this.openMonitoring, provisionedRequest.openMonitoring) &&
        Objects.equals(this.kafkaVersion, provisionedRequest.kafkaVersion) &&
        Objects.equals(this.loggingInfo, provisionedRequest.loggingInfo) &&
        Objects.equals(this.numberOfBrokerNodes, provisionedRequest.numberOfBrokerNodes) &&
        Objects.equals(this.storageMode, provisionedRequest.storageMode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvisionedRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvisionedRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionedRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvisionedRequest is not found in the empty JSON string", ProvisionedRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionedRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvisionedRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProvisionedRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvisionedRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvisionedRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvisionedRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvisionedRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvisionedRequest>() {
           @Override
           public void write(JsonWriter out, ProvisionedRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvisionedRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvisionedRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvisionedRequest
   * @throws IOException if the JSON string is invalid with respect to ProvisionedRequest
   */
  public static ProvisionedRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvisionedRequest.class);
  }

  /**
   * Convert an instance of ProvisionedRequest to an JSON string
   *
   * @return JSON string
   */
