...
async def test_create_identity_source(client):
    """Test case for create_identity_source

    
    """
    body = {"configuration":{"cognitoUserPoolConfiguration":{"userPoolArn":"","clientIds":""}},"clientToken":"","policyStoreId":"","principalEntityType":""}
    headers = { 
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.CreateIdentitySource',
        headers=headers,
        json=body,
        )
...
async def test_create_policy(client):
    ...
    """
    body = {"clientToken":"","policyStoreId":"","definition":{"static":{"statement":"","description":""},"templateLinked":{"principal":{"entityType":"","entityId":""},"resource":{"entityType":"","entityId":""},"policyTemplateId":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.CreatePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_policy_store(client):
    """Test case for create_policy_store

    
    """
    body = {"clientToken":"","validationSettings":{"mode":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.CreatePolicyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_create_policy_template(client):
    """Test case for create_policy_template

    
    """
    body = {"clientToken":"","policyStoreId":"","statement":"","description":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.CreatePolicyTemplate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_identity_source(client):
    """Test case for delete_identity_source

    
    """
    body = {"identitySourceId":"","policyStoreId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.DeleteIdentitySource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.DeletePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_policy_store(client):
    """Test case for delete_policy_store
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.DeletePolicyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_delete_policy_template(client):
    """Test case for delete_policy_template

    
    """
    body = {"policyStoreId":"","policyTemplateId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.DeletePolicyTemplate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_identity_source(client):
    """Test case for get_identity_source
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.GetIdentitySource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_policy(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.GetPolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_policy_store(client):
    """Test case for get_policy_store
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.GetPolicyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_policy_template(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.GetPolicyTemplate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_get_schema(client):
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.GetSchema',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_is_authorized(client):
    """Test case for is_authorized

    
    """
    body = {"principal":{"entityType":"","entityId":""},"resource":{"entityType":"","entityId":""},"entities":{"entityList":""},"policyStoreId":"","context":{"contextMap":""},"action":{"actionType":"","actionId":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.IsAuthorized',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_is_authorized_with_token(client):
    """Test case for is_authorized_with_token

    
    """
    body = {"identityToken":"","resource":{"entityType":"","entityId":""},"entities":{"entityList":""},"policyStoreId":"","context":{"contextMap":""},"action":{"actionType":"","actionId":""},"accessToken":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.IsAuthorizedWithToken',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_list_identity_sources(client):
    """Test case for list_identity_sources

    
    """
    body = {"nextToken":"","maxResults":"","policyStoreId":"","filters":""}
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.ListIdentitySources',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_policies(client):
    ...
    """
    body = {"filter":{"principal":{"identifier":{"entityType":"","entityId":""},"unspecified":""},"resource":{"identifier":{"entityType":"","entityId":""},"unspecified":""},"policyType":"","policyTemplateId":""},"nextToken":"","maxResults":"","policyStoreId":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.ListPolicies',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_policy_stores(client):
    """Test case for list_policy_stores
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.ListPolicyStores',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_list_policy_templates(client):
    """Test case for list_policy_templates

    
    """
    body = {"nextToken":"","maxResults":"","policyStoreId":""}
    params = [('maxResults', 'max_results_example'),
                    ('nextToken', 'next_token_example')]
    headers = { 
        'Accept': 'application/json',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.ListPolicyTemplates',
        headers=headers,
        json=body,
        params=params,
        )
...
async def test_put_schema(client):
    """Test case for put_schema

    
    """
    body = {"policyStoreId":"","definition":{"cedarJson":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.PutSchema',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_identity_source(client):
    """Test case for update_identity_source

    
    """
    body = {"identitySourceId":"","policyStoreId":"","principalEntityType":"","updateConfiguration":{"cognitoUserPoolConfiguration":{"userPoolArn":"","clientIds":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.UpdateIdentitySource',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_policy(client):
    ...
    """
    body = {"policyId":"","policyStoreId":"","definition":{"static":{"statement":"","description":""}}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.UpdatePolicy',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_policy_store(client):
    """Test case for update_policy_store

    
    """
    body = {"policyStoreId":"","validationSettings":{"mode":""}}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.UpdatePolicyStore',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
...
async def test_update_policy_template(client):
    """Test case for update_policy_template

    
    """
    body = {"policyStoreId":"","statement":"","description":"","policyTemplateId":""}
    headers = { 
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'x_amz_content_sha256': 'x_amz_content_sha256_example',
    ...
    response = await client.request(
        method='POST',
        path='/#X-Amz-Target=VerifiedPermissions.UpdatePolicyTemplate',
        headers=headers,
        json=body,
        )
    assert response.status == 200, 'Response body is : ' + (await response.read()).decode('utf-8')
