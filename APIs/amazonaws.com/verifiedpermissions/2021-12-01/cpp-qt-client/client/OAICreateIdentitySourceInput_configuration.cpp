...
OAICreateIdentitySourceInput_configuration::OAICreateIdentitySourceInput_configuration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIdentitySourceInput_configuration::OAICreateIdentitySourceInput_configuration() {
    this->initializeModel();
}

OAICreateIdentitySourceInput_configuration::~OAICreateIdentitySourceInput_configuration() {}

void OAICreateIdentitySourceInput_configuration::initializeModel() {

    m_cognito_user_pool_configuration_isSet = false;
    m_cognito_user_pool_configuration_isValid = false;
}

void OAICreateIdentitySourceInput_configuration::fromJson(QString jsonString) {
...
void OAICreateIdentitySourceInput_configuration::fromJsonObject(QJsonObject json) {
...
QString OAICreateIdentitySourceInput_configuration::asJson() const {
...
QJsonObject OAICreateIdentitySourceInput_configuration::asJsonObject() const {
    QJsonObject obj;
...
OAIConfiguration_cognitoUserPoolConfiguration OAICreateIdentitySourceInput_configuration::getCognitoUserPoolConfiguration() const {
    return m_cognito_user_pool_configuration;
}
void OAICreateIdentitySourceInput_configuration::setCognitoUserPoolConfiguration(const OAIConfiguration_cognitoUserPoolConfiguration &cognito_user_pool_configuration) {
    m_cognito_user_pool_configuration = cognito_user_pool_configuration;
    m_cognito_user_pool_configuration_isSet = true;
}

bool OAICreateIdentitySourceInput_configuration::is_cognito_user_pool_configuration_Set() const{
    return m_cognito_user_pool_configuration_isSet;
}

bool OAICreateIdentitySourceInput_configuration::is_cognito_user_pool_configuration_Valid() const{
    return m_cognito_user_pool_configuration_isValid;
}

bool OAICreateIdentitySourceInput_configuration::isSet() const {
...
bool OAICreateIdentitySourceInput_configuration::isValid() const {
