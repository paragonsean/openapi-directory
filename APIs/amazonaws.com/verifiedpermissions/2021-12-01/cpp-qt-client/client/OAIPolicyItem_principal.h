...
/*
 * OAIPolicyItem_principal.h
 *
 * 
 */

#ifndef OAIPolicyItem_principal_H
#define OAIPolicyItem_principal_H
...
class OAIPolicyItem_principal : public OAIObject {
public:
    OAIPolicyItem_principal();
    OAIPolicyItem_principal(QString json);
    ~OAIPolicyItem_principal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyItem_principal)

#endif // OAIPolicyItem_principal_H
