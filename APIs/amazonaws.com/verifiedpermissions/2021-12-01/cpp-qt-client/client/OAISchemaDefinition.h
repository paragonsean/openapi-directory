...
public:
    ...
    QString getCedarJson() const;
    void setCedarJson(const QString &cedar_json);
    bool is_cedar_json_Set() const;
    bool is_cedar_json_Valid() const;
...
private:
    ...
    QString m_cedar_json;
    bool m_cedar_json_isSet;
    bool m_cedar_json_isValid;
};
