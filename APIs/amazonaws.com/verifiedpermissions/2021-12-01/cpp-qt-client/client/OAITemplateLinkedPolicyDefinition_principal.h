...
/*
 * OAITemplateLinkedPolicyDefinition_principal.h
 *
 * 
 */

#ifndef OAITemplateLinkedPolicyDefinition_principal_H
#define OAITemplateLinkedPolicyDefinition_principal_H
...
class OAITemplateLinkedPolicyDefinition_principal : public OAIObject {
public:
    OAITemplateLinkedPolicyDefinition_principal();
    OAITemplateLinkedPolicyDefinition_principal(QString json);
    ~OAITemplateLinkedPolicyDefinition_principal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateLinkedPolicyDefinition_principal)

#endif // OAITemplateLinkedPolicyDefinition_principal_H
