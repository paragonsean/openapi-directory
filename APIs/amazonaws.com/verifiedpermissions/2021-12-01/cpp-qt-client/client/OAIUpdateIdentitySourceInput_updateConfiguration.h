...
/*
 * OAIUpdateIdentitySourceInput_updateConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateIdentitySourceInput_updateConfiguration_H
#define OAIUpdateIdentitySourceInput_updateConfiguration_H
...
class OAIUpdateIdentitySourceInput_updateConfiguration : public OAIObject {
public:
    OAIUpdateIdentitySourceInput_updateConfiguration();
    OAIUpdateIdentitySourceInput_updateConfiguration(QString json);
    ~OAIUpdateIdentitySourceInput_updateConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIdentitySourceInput_updateConfiguration)

#endif // OAIUpdateIdentitySourceInput_updateConfiguration_H
