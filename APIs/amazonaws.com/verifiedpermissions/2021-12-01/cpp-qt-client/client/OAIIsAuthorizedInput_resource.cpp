...
OAIIsAuthorizedInput_resource::OAIIsAuthorizedInput_resource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedInput_resource::OAIIsAuthorizedInput_resource() {
    this->initializeModel();
}

OAIIsAuthorizedInput_resource::~OAIIsAuthorizedInput_resource() {}

void OAIIsAuthorizedInput_resource::initializeModel() {
...
void OAIIsAuthorizedInput_resource::fromJson(QString jsonString) {
...
void OAIIsAuthorizedInput_resource::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedInput_resource::asJson() const {
...
QJsonObject OAIIsAuthorizedInput_resource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIsAuthorizedInput_resource::getEntityType() const {
    return m_entity_type;
}
void OAIIsAuthorizedInput_resource::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIIsAuthorizedInput_resource::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIIsAuthorizedInput_resource::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIIsAuthorizedInput_resource::getEntityId() const {
    return m_entity_id;
}
void OAIIsAuthorizedInput_resource::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIIsAuthorizedInput_resource::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIIsAuthorizedInput_resource::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIIsAuthorizedInput_resource::isSet() const {
...
bool OAIIsAuthorizedInput_resource::isValid() const {
