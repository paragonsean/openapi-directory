...
/*
 * OAIGetIdentitySourceOutput_details.h
 *
 * 
 */

#ifndef OAIGetIdentitySourceOutput_details_H
#define OAIGetIdentitySourceOutput_details_H

#include <QJsonObject>

#include "OAIOpenIdIssuer.h"
#include <QList>
#include <QString>
...
class OAIGetIdentitySourceOutput_details : public OAIObject {
public:
    OAIGetIdentitySourceOutput_details();
    OAIGetIdentitySourceOutput_details(QString json);
    ~OAIGetIdentitySourceOutput_details() override;
    ...
    QList getClientIds() const;
    void setClientIds(const QList &client_ids);
    bool is_client_ids_Set() const;
    bool is_client_ids_Valid() const;
    ...
    OAIOpenIdIssuer getOpenIdIssuer() const;
    void setOpenIdIssuer(const OAIOpenIdIssuer &open_id_issuer);
...
private:
    ...
    QList m_client_ids;
    bool m_client_ids_isSet;
    bool m_client_ids_isValid;
    ...
    OAIOpenIdIssuer m_open_id_issuer;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIdentitySourceOutput_details)

#endif // OAIGetIdentitySourceOutput_details_H
