...
namespace OpenAPI {
class OAICreatePolicyInput_definition;
...
public:
    ...
    OAICreatePolicyInput_definition getDefinition() const;
    void setDefinition(const OAICreatePolicyInput_definition &definition);
...
private:
    ...
    OAICreatePolicyInput_definition m_definition;
