...
OAICreatePolicyStoreInput::OAICreatePolicyStoreInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyStoreInput::OAICreatePolicyStoreInput() {
    this->initializeModel();
}

OAICreatePolicyStoreInput::~OAICreatePolicyStoreInput() {}

void OAICreatePolicyStoreInput::initializeModel() {
...
void OAICreatePolicyStoreInput::fromJson(QString jsonString) {
...
void OAICreatePolicyStoreInput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyStoreInput::asJson() const {
...
QJsonObject OAICreatePolicyStoreInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePolicyStoreInput::getClientToken() const {
    return m_client_token;
}
void OAICreatePolicyStoreInput::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreatePolicyStoreInput::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreatePolicyStoreInput::is_client_token_Valid() const{
    return m_client_token_isValid;
}

OAICreatePolicyStoreInput_validationSettings OAICreatePolicyStoreInput::getValidationSettings() const {
    return m_validation_settings;
}
void OAICreatePolicyStoreInput::setValidationSettings(const OAICreatePolicyStoreInput_validationSettings &validation_settings) {
    m_validation_settings = validation_settings;
    m_validation_settings_isSet = true;
}

bool OAICreatePolicyStoreInput::is_validation_settings_Set() const{
    return m_validation_settings_isSet;
}

bool OAICreatePolicyStoreInput::is_validation_settings_Valid() const{
    return m_validation_settings_isValid;
}

bool OAICreatePolicyStoreInput::isSet() const {
...
bool OAICreatePolicyStoreInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_validation_settings_isValid && true;
}
