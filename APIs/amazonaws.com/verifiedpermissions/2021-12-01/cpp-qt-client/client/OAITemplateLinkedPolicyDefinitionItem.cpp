...
#include "OAITemplateLinkedPolicyDefinitionItem.h"
...
OAITemplateLinkedPolicyDefinitionItem::OAITemplateLinkedPolicyDefinitionItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateLinkedPolicyDefinitionItem::OAITemplateLinkedPolicyDefinitionItem() {
    this->initializeModel();
}

OAITemplateLinkedPolicyDefinitionItem::~OAITemplateLinkedPolicyDefinitionItem() {}

void OAITemplateLinkedPolicyDefinitionItem::initializeModel() {
...
void OAITemplateLinkedPolicyDefinitionItem::fromJson(QString jsonString) {
...
void OAITemplateLinkedPolicyDefinitionItem::fromJsonObject(QJsonObject json) {
...
QString OAITemplateLinkedPolicyDefinitionItem::asJson() const {
...
QJsonObject OAITemplateLinkedPolicyDefinitionItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAITemplateLinkedPolicyDefinitionItem::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAITemplateLinkedPolicyDefinitionItem::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAITemplateLinkedPolicyDefinitionItem::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAITemplateLinkedPolicyDefinitionItem::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

OAITemplateLinkedPolicyDefinition_principal OAITemplateLinkedPolicyDefinitionItem::getPrincipal() const {
    return m_principal;
}
void OAITemplateLinkedPolicyDefinitionItem::setPrincipal(const OAITemplateLinkedPolicyDefinition_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAITemplateLinkedPolicyDefinitionItem::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAITemplateLinkedPolicyDefinitionItem::is_principal_Valid() const{
    return m_principal_isValid;
}

OAITemplateLinkedPolicyDefinition_resource OAITemplateLinkedPolicyDefinitionItem::getResource() const {
    return m_resource;
}
void OAITemplateLinkedPolicyDefinitionItem::setResource(const OAITemplateLinkedPolicyDefinition_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAITemplateLinkedPolicyDefinitionItem::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAITemplateLinkedPolicyDefinitionItem::is_resource_Valid() const{
    return m_resource_isValid;
}

bool OAITemplateLinkedPolicyDefinitionItem::isSet() const {
...
bool OAITemplateLinkedPolicyDefinitionItem::isValid() const {
