...
#ifndef OAIContextDefinition_H
#define OAIContextDefinition_H
...
class OAIContextDefinition : public OAIObject {
public:
    OAIContextDefinition();
    OAIContextDefinition(QString json);
    ~OAIContextDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContextDefinition)

#endif // OAIContextDefinition_H
