...
/*
 * OAIPolicyDefinitionItem_templateLinked.h
 *
 * 
 */

#ifndef OAIPolicyDefinitionItem_templateLinked_H
#define OAIPolicyDefinitionItem_templateLinked_H
...
class OAIPolicyDefinitionItem_templateLinked : public OAIObject {
public:
    OAIPolicyDefinitionItem_templateLinked();
    OAIPolicyDefinitionItem_templateLinked(QString json);
    ~OAIPolicyDefinitionItem_templateLinked() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinitionItem_templateLinked)

#endif // OAIPolicyDefinitionItem_templateLinked_H
