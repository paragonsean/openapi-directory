...
OAIIsAuthorizedWithTokenInput_action::OAIIsAuthorizedWithTokenInput_action(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedWithTokenInput_action::OAIIsAuthorizedWithTokenInput_action() {
    this->initializeModel();
}

OAIIsAuthorizedWithTokenInput_action::~OAIIsAuthorizedWithTokenInput_action() {}

void OAIIsAuthorizedWithTokenInput_action::initializeModel() {
...
void OAIIsAuthorizedWithTokenInput_action::fromJson(QString jsonString) {
...
void OAIIsAuthorizedWithTokenInput_action::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedWithTokenInput_action::asJson() const {
...
QJsonObject OAIIsAuthorizedWithTokenInput_action::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIsAuthorizedWithTokenInput_action::getActionType() const {
    return m_action_type;
}
void OAIIsAuthorizedWithTokenInput_action::setActionType(const QString &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIIsAuthorizedWithTokenInput_action::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIIsAuthorizedWithTokenInput_action::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QString OAIIsAuthorizedWithTokenInput_action::getActionId() const {
    return m_action_id;
}
void OAIIsAuthorizedWithTokenInput_action::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIIsAuthorizedWithTokenInput_action::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIIsAuthorizedWithTokenInput_action::is_action_id_Valid() const{
    return m_action_id_isValid;
}

bool OAIIsAuthorizedWithTokenInput_action::isSet() const {
...
bool OAIIsAuthorizedWithTokenInput_action::isValid() const {
