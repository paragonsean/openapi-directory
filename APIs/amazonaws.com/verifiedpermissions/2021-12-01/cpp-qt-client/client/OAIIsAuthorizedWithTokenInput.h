...
/*
 * OAIIsAuthorizedWithTokenInput.h
 *
 * 
 */

#ifndef OAIIsAuthorizedWithTokenInput_H
#define OAIIsAuthorizedWithTokenInput_H

#include <QJsonObject>

#include "OAIIsAuthorizedInput_context.h"
#include "OAIIsAuthorizedInput_entities.h"
#include "OAIIsAuthorizedWithTokenInput_action.h"
...
namespace OpenAPI {
class OAIIsAuthorizedWithTokenInput_action;
class OAIIsAuthorizedWithTokenInput_resource;
class OAIIsAuthorizedInput_context;
class OAIIsAuthorizedInput_entities;

class OAIIsAuthorizedWithTokenInput : public OAIObject {
public:
    OAIIsAuthorizedWithTokenInput();
    OAIIsAuthorizedWithTokenInput(QString json);
    ~OAIIsAuthorizedWithTokenInput() override;
    ...
    OAIIsAuthorizedWithTokenInput_action getAction() const;
    void setAction(const OAIIsAuthorizedWithTokenInput_action &action);
    bool is_action_Set() const;
    bool is_action_Valid() const;

    OAIIsAuthorizedWithTokenInput_resource getResource() const;
    void setResource(const OAIIsAuthorizedWithTokenInput_resource &resource);
    bool is_resource_Set() const;
    bool is_resource_Valid() const;

    OAIIsAuthorizedInput_context getContext() const;
    void setContext(const OAIIsAuthorizedInput_context &context);
    bool is_context_Set() const;
    bool is_context_Valid() const;

    OAIIsAuthorizedInput_entities getEntities() const;
    void setEntities(const OAIIsAuthorizedInput_entities &entities);
...
private:
    ...
    OAIIsAuthorizedWithTokenInput_action m_action;
    bool m_action_isSet;
    bool m_action_isValid;

    OAIIsAuthorizedWithTokenInput_resource m_resource;
    bool m_resource_isSet;
    bool m_resource_isValid;

    OAIIsAuthorizedInput_context m_context;
    bool m_context_isSet;
    bool m_context_isValid;

    OAIIsAuthorizedInput_entities m_entities;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedWithTokenInput)

#endif // OAIIsAuthorizedWithTokenInput_H
