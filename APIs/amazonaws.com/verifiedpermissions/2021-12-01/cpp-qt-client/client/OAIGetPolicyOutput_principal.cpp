...
#include "OAIGetPolicyOutput_principal.h"
...
OAIGetPolicyOutput_principal::OAIGetPolicyOutput_principal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyOutput_principal::OAIGetPolicyOutput_principal() {
    this->initializeModel();
}

OAIGetPolicyOutput_principal::~OAIGetPolicyOutput_principal() {}

void OAIGetPolicyOutput_principal::initializeModel() {
...
void OAIGetPolicyOutput_principal::fromJson(QString jsonString) {
...
void OAIGetPolicyOutput_principal::fromJsonObject(QJsonObject json) {
...
QString OAIGetPolicyOutput_principal::asJson() const {
...
QJsonObject OAIGetPolicyOutput_principal::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPolicyOutput_principal::getEntityType() const {
    return m_entity_type;
}
void OAIGetPolicyOutput_principal::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIGetPolicyOutput_principal::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIGetPolicyOutput_principal::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIGetPolicyOutput_principal::getEntityId() const {
    return m_entity_id;
}
void OAIGetPolicyOutput_principal::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIGetPolicyOutput_principal::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIGetPolicyOutput_principal::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIGetPolicyOutput_principal::isSet() const {
...
bool OAIGetPolicyOutput_principal::isValid() const {
