...
#ifndef OAIStaticPolicyDefinition_H
#define OAIStaticPolicyDefinition_H
...
class OAIStaticPolicyDefinition : public OAIObject {
public:
    OAIStaticPolicyDefinition();
    OAIStaticPolicyDefinition(QString json);
    ~OAIStaticPolicyDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStaticPolicyDefinition)

#endif // OAIStaticPolicyDefinition_H
