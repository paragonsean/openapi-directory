...
OAIListPoliciesInput::OAIListPoliciesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPoliciesInput::OAIListPoliciesInput() {
    this->initializeModel();
}

OAIListPoliciesInput::~OAIListPoliciesInput() {}

void OAIListPoliciesInput::initializeModel() {
...
void OAIListPoliciesInput::fromJson(QString jsonString) {
...
void OAIListPoliciesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListPoliciesInput::asJson() const {
...
QJsonObject OAIListPoliciesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListPoliciesInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIListPoliciesInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIListPoliciesInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIListPoliciesInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIListPoliciesInput::getNextToken() const {
    return m_next_token;
}
void OAIListPoliciesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPoliciesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPoliciesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPoliciesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListPoliciesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPoliciesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPoliciesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

OAIListPoliciesInput_filter OAIListPoliciesInput::getFilter() const {
    return m_filter;
}
void OAIListPoliciesInput::setFilter(const OAIListPoliciesInput_filter &filter) {
    m_filter = filter;
    m_filter_isSet = true;
}

bool OAIListPoliciesInput::is_filter_Set() const{
    return m_filter_isSet;
}

bool OAIListPoliciesInput::is_filter_Valid() const{
    return m_filter_isValid;
}

bool OAIListPoliciesInput::isSet() const {
...
bool OAIListPoliciesInput::isValid() const {
