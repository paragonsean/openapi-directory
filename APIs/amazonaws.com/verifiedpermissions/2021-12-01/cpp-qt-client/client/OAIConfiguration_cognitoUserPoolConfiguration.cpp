...
#include "OAIConfiguration_cognitoUserPoolConfiguration.h"
...
OAIConfiguration_cognitoUserPoolConfiguration::OAIConfiguration_cognitoUserPoolConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConfiguration_cognitoUserPoolConfiguration::OAIConfiguration_cognitoUserPoolConfiguration() {
    this->initializeModel();
}

OAIConfiguration_cognitoUserPoolConfiguration::~OAIConfiguration_cognitoUserPoolConfiguration() {}

void OAIConfiguration_cognitoUserPoolConfiguration::initializeModel() {
...
void OAIConfiguration_cognitoUserPoolConfiguration::fromJson(QString jsonString) {
...
void OAIConfiguration_cognitoUserPoolConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIConfiguration_cognitoUserPoolConfiguration::asJson() const {
...
QJsonObject OAIConfiguration_cognitoUserPoolConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConfiguration_cognitoUserPoolConfiguration::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAIConfiguration_cognitoUserPoolConfiguration::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAIConfiguration_cognitoUserPoolConfiguration::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAIConfiguration_cognitoUserPoolConfiguration::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QList OAIConfiguration_cognitoUserPoolConfiguration::getClientIds() const {
    return m_client_ids;
}
void OAIConfiguration_cognitoUserPoolConfiguration::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAIConfiguration_cognitoUserPoolConfiguration::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAIConfiguration_cognitoUserPoolConfiguration::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

bool OAIConfiguration_cognitoUserPoolConfiguration::isSet() const {
...
bool OAIConfiguration_cognitoUserPoolConfiguration::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_user_pool_arn_isValid && true;
}
