...
#include "OAIUpdateStaticPolicyDefinition.h"
...
OAIUpdateStaticPolicyDefinition::OAIUpdateStaticPolicyDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateStaticPolicyDefinition::OAIUpdateStaticPolicyDefinition() {
    this->initializeModel();
}

OAIUpdateStaticPolicyDefinition::~OAIUpdateStaticPolicyDefinition() {}

void OAIUpdateStaticPolicyDefinition::initializeModel() {
...
void OAIUpdateStaticPolicyDefinition::fromJson(QString jsonString) {
...
void OAIUpdateStaticPolicyDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateStaticPolicyDefinition::asJson() const {
...
QJsonObject OAIUpdateStaticPolicyDefinition::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateStaticPolicyDefinition::getDescription() const {
    return m_description;
}
void OAIUpdateStaticPolicyDefinition::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdateStaticPolicyDefinition::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdateStaticPolicyDefinition::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdateStaticPolicyDefinition::getStatement() const {
    return m_statement;
}
void OAIUpdateStaticPolicyDefinition::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIUpdateStaticPolicyDefinition::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIUpdateStaticPolicyDefinition::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIUpdateStaticPolicyDefinition::isSet() const {
...
bool OAIUpdateStaticPolicyDefinition::isValid() const {
