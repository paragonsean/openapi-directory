...
/*
 * OAIUpdateConfiguration_cognitoUserPoolConfiguration.h
 *
 * 
 */

#ifndef OAIUpdateConfiguration_cognitoUserPoolConfiguration_H
#define OAIUpdateConfiguration_cognitoUserPoolConfiguration_H
...
class OAIUpdateConfiguration_cognitoUserPoolConfiguration : public OAIObject {
public:
    OAIUpdateConfiguration_cognitoUserPoolConfiguration();
    OAIUpdateConfiguration_cognitoUserPoolConfiguration(QString json);
    ~OAIUpdateConfiguration_cognitoUserPoolConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateConfiguration_cognitoUserPoolConfiguration)

#endif // OAIUpdateConfiguration_cognitoUserPoolConfiguration_H
