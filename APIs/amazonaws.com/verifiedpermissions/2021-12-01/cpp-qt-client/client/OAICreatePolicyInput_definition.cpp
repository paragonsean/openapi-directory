...
#include "OAICreatePolicyInput_definition.h"
...
OAICreatePolicyInput_definition::OAICreatePolicyInput_definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyInput_definition::OAICreatePolicyInput_definition() {
    this->initializeModel();
}

OAICreatePolicyInput_definition::~OAICreatePolicyInput_definition() {}

void OAICreatePolicyInput_definition::initializeModel() {
...
void OAICreatePolicyInput_definition::fromJson(QString jsonString) {
...
void OAICreatePolicyInput_definition::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyInput_definition::asJson() const {
...
QJsonObject OAICreatePolicyInput_definition::asJsonObject() const {
    QJsonObject obj;
    if (m_r_static.isSet()) {
...
OAIPolicyDefinition_static OAICreatePolicyInput_definition::getRStatic() const {
    return m_r_static;
}
void OAICreatePolicyInput_definition::setRStatic(const OAIPolicyDefinition_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAICreatePolicyInput_definition::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAICreatePolicyInput_definition::is_r_static_Valid() const{
    return m_r_static_isValid;
}

OAIPolicyDefinition_templateLinked OAICreatePolicyInput_definition::getTemplateLinked() const {
    return m_template_linked;
}
void OAICreatePolicyInput_definition::setTemplateLinked(const OAIPolicyDefinition_templateLinked &template_linked) {
    m_template_linked = template_linked;
    m_template_linked_isSet = true;
}

bool OAICreatePolicyInput_definition::is_template_linked_Set() const{
    return m_template_linked_isSet;
}

bool OAICreatePolicyInput_definition::is_template_linked_Valid() const{
    return m_template_linked_isValid;
}

bool OAICreatePolicyInput_definition::isSet() const {
...
bool OAICreatePolicyInput_definition::isValid() const {
