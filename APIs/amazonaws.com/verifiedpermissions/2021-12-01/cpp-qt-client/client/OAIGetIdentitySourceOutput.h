...
/*
 * OAIGetIdentitySourceOutput.h
 *
 * 
 */

#ifndef OAIGetIdentitySourceOutput_H
#define OAIGetIdentitySourceOutput_H

#include <QJsonObject>

#include "OAIGetIdentitySourceOutput_details.h"
#include <QDateTime>
#include <QString>
...
namespace OpenAPI {
class OAIGetIdentitySourceOutput_details;

class OAIGetIdentitySourceOutput : public OAIObject {
public:
    OAIGetIdentitySourceOutput();
    OAIGetIdentitySourceOutput(QString json);
    ~OAIGetIdentitySourceOutput() override;
    ...
    OAIGetIdentitySourceOutput_details getDetails() const;
    void setDetails(const OAIGetIdentitySourceOutput_details &details);
...
private:
    ...
    OAIGetIdentitySourceOutput_details m_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIdentitySourceOutput)

#endif // OAIGetIdentitySourceOutput_H
