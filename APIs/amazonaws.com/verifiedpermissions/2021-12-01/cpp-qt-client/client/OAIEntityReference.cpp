...
bool OAIEntityReference::getUnspecified() const {
    return m_unspecified;
}
void OAIEntityReference::setUnspecified(const bool &unspecified) {
    m_unspecified = unspecified;
    m_unspecified_isSet = true;
}

bool OAIEntityReference::is_unspecified_Set() const{
    return m_unspecified_isSet;
}

bool OAIEntityReference::is_unspecified_Valid() const{
    return m_unspecified_isValid;
}

OAIEntityReference_identifier OAIEntityReference::getIdentifier() const {
    return m_identifier;
}
void OAIEntityReference::setIdentifier(const OAIEntityReference_identifier &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIEntityReference::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIEntityReference::is_identifier_Valid() const{
