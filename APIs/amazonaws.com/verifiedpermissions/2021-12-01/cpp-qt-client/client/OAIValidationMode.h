...
#ifndef OAIValidationMode_H
#define OAIValidationMode_H
...
class OAIValidationMode : public OAIEnum {
public:
    OAIValidationMode();
    OAIValidationMode(QString json);
    ~OAIValidationMode() override;
    ...
    enum class eOAIValidationMode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        OFF, 
        STRICT
    };
    OAIValidationMode::eOAIValidationMode getValue() const;
    void setValue(const OAIValidationMode::eOAIValidationMode& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidationMode)

#endif // OAIValidationMode_H
