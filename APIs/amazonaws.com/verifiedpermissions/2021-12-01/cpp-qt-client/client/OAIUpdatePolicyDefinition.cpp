...
#include "OAIUpdatePolicyDefinition.h"
...
OAIUpdatePolicyDefinition::OAIUpdatePolicyDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyDefinition::OAIUpdatePolicyDefinition() {
    this->initializeModel();
}

OAIUpdatePolicyDefinition::~OAIUpdatePolicyDefinition() {}

void OAIUpdatePolicyDefinition::initializeModel() {

    m_r_static_isSet = false;
    m_r_static_isValid = false;
}

void OAIUpdatePolicyDefinition::fromJson(QString jsonString) {
...
void OAIUpdatePolicyDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyDefinition::asJson() const {
...
QJsonObject OAIUpdatePolicyDefinition::asJsonObject() const {
    QJsonObject obj;
    if (m_r_static.isSet()) {
...
OAIUpdatePolicyDefinition_static OAIUpdatePolicyDefinition::getRStatic() const {
    return m_r_static;
}
void OAIUpdatePolicyDefinition::setRStatic(const OAIUpdatePolicyDefinition_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAIUpdatePolicyDefinition::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAIUpdatePolicyDefinition::is_r_static_Valid() const{
    return m_r_static_isValid;
}

bool OAIUpdatePolicyDefinition::isSet() const {
...
bool OAIUpdatePolicyDefinition::isValid() const {
