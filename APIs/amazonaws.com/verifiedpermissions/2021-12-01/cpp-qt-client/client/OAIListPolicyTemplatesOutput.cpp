...
OAIListPolicyTemplatesOutput::OAIListPolicyTemplatesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPolicyTemplatesOutput::OAIListPolicyTemplatesOutput() {
    this->initializeModel();
}

OAIListPolicyTemplatesOutput::~OAIListPolicyTemplatesOutput() {}

void OAIListPolicyTemplatesOutput::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_policy_templates_isSet = false;
    m_policy_templates_isValid = false;
}

void OAIListPolicyTemplatesOutput::fromJson(QString jsonString) {
...
void OAIListPolicyTemplatesOutput::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_policy_templates_isValid = ::OpenAPI::fromJsonValue(m_policy_templates, json[QString("policyTemplates")]);
    m_policy_templates_isSet = !json[QString("policyTemplates")].isNull() && m_policy_templates_isValid;
}

QString OAIListPolicyTemplatesOutput::asJson() const {
...
QJsonObject OAIListPolicyTemplatesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_policy_templates.isSet()) {
        obj.insert(QString("policyTemplates"), ::OpenAPI::toJsonValue(m_policy_templates));
    }
    return obj;
}

QString OAIListPolicyTemplatesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListPolicyTemplatesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPolicyTemplatesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPolicyTemplatesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListPolicyTemplatesOutput::getPolicyTemplates() const {
    return m_policy_templates;
}
void OAIListPolicyTemplatesOutput::setPolicyTemplates(const QList &policy_templates) {
    m_policy_templates = policy_templates;
    m_policy_templates_isSet = true;
}

bool OAIListPolicyTemplatesOutput::is_policy_templates_Set() const{
    return m_policy_templates_isSet;
}

bool OAIListPolicyTemplatesOutput::is_policy_templates_Valid() const{
    return m_policy_templates_isValid;
}

bool OAIListPolicyTemplatesOutput::isSet() const {
...
bool OAIListPolicyTemplatesOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_templates_isValid && true;
}
