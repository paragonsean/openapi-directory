...
OAIPolicyDefinitionItem_templateLinked::OAIPolicyDefinitionItem_templateLinked(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyDefinitionItem_templateLinked::OAIPolicyDefinitionItem_templateLinked() {
    this->initializeModel();
}

OAIPolicyDefinitionItem_templateLinked::~OAIPolicyDefinitionItem_templateLinked() {}

void OAIPolicyDefinitionItem_templateLinked::initializeModel() {
...
void OAIPolicyDefinitionItem_templateLinked::fromJson(QString jsonString) {
...
void OAIPolicyDefinitionItem_templateLinked::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyDefinitionItem_templateLinked::asJson() const {
...
QJsonObject OAIPolicyDefinitionItem_templateLinked::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyDefinitionItem_templateLinked::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIPolicyDefinitionItem_templateLinked::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIPolicyDefinitionItem_templateLinked::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIPolicyDefinitionItem_templateLinked::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

OAITemplateLinkedPolicyDefinition_principal OAIPolicyDefinitionItem_templateLinked::getPrincipal() const {
    return m_principal;
}
void OAIPolicyDefinitionItem_templateLinked::setPrincipal(const OAITemplateLinkedPolicyDefinition_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIPolicyDefinitionItem_templateLinked::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIPolicyDefinitionItem_templateLinked::is_principal_Valid() const{
    return m_principal_isValid;
}

OAITemplateLinkedPolicyDefinition_resource OAIPolicyDefinitionItem_templateLinked::getResource() const {
    return m_resource;
}
void OAIPolicyDefinitionItem_templateLinked::setResource(const OAITemplateLinkedPolicyDefinition_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIPolicyDefinitionItem_templateLinked::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIPolicyDefinitionItem_templateLinked::is_resource_Valid() const{
    return m_resource_isValid;
}

bool OAIPolicyDefinitionItem_templateLinked::isSet() const {
...
bool OAIPolicyDefinitionItem_templateLinked::isValid() const {
