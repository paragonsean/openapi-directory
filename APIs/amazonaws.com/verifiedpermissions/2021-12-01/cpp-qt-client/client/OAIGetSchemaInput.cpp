...
QString OAIGetSchemaInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIGetSchemaInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIGetSchemaInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIGetSchemaInput::is_policy_store_id_Valid() const{
