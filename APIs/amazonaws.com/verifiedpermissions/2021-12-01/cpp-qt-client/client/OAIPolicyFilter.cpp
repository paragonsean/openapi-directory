...
OAIPolicyFilter::OAIPolicyFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyFilter::OAIPolicyFilter() {
    this->initializeModel();
}

OAIPolicyFilter::~OAIPolicyFilter() {}

void OAIPolicyFilter::initializeModel() {
...
void OAIPolicyFilter::fromJson(QString jsonString) {
...
void OAIPolicyFilter::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyFilter::asJson() const {
...
QJsonObject OAIPolicyFilter::asJsonObject() const {
    QJsonObject obj;
...
OAIPolicyFilter_principal OAIPolicyFilter::getPrincipal() const {
    return m_principal;
}
void OAIPolicyFilter::setPrincipal(const OAIPolicyFilter_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIPolicyFilter::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIPolicyFilter::is_principal_Valid() const{
    return m_principal_isValid;
}

OAIPolicyFilter_resource OAIPolicyFilter::getResource() const {
    return m_resource;
}
void OAIPolicyFilter::setResource(const OAIPolicyFilter_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIPolicyFilter::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIPolicyFilter::is_resource_Valid() const{
    return m_resource_isValid;
}

OAIPolicyType OAIPolicyFilter::getPolicyType() const {
    return m_policy_type;
}
void OAIPolicyFilter::setPolicyType(const OAIPolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIPolicyFilter::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIPolicyFilter::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

QString OAIPolicyFilter::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIPolicyFilter::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIPolicyFilter::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIPolicyFilter::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

bool OAIPolicyFilter::isSet() const {
...
bool OAIPolicyFilter::isValid() const {
