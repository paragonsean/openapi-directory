...
/*
 * OAIAttributeValue_entityIdentifier.h
 *
 * 
 */

#ifndef OAIAttributeValue_entityIdentifier_H
#define OAIAttributeValue_entityIdentifier_H
...
class OAIAttributeValue_entityIdentifier : public OAIObject {
public:
    OAIAttributeValue_entityIdentifier();
    OAIAttributeValue_entityIdentifier(QString json);
    ~OAIAttributeValue_entityIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAttributeValue_entityIdentifier)

#endif // OAIAttributeValue_entityIdentifier_H
