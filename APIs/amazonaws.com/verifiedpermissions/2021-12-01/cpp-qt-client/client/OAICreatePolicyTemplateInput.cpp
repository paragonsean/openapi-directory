...
OAICreatePolicyTemplateInput::OAICreatePolicyTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyTemplateInput::OAICreatePolicyTemplateInput() {
    this->initializeModel();
}

OAICreatePolicyTemplateInput::~OAICreatePolicyTemplateInput() {}

void OAICreatePolicyTemplateInput::initializeModel() {
...
void OAICreatePolicyTemplateInput::fromJson(QString jsonString) {
...
void OAICreatePolicyTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyTemplateInput::asJson() const {
...
QJsonObject OAICreatePolicyTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePolicyTemplateInput::getClientToken() const {
    return m_client_token;
}
void OAICreatePolicyTemplateInput::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreatePolicyTemplateInput::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreatePolicyTemplateInput::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QString OAICreatePolicyTemplateInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAICreatePolicyTemplateInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAICreatePolicyTemplateInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAICreatePolicyTemplateInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAICreatePolicyTemplateInput::getDescription() const {
    return m_description;
}
void OAICreatePolicyTemplateInput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreatePolicyTemplateInput::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreatePolicyTemplateInput::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreatePolicyTemplateInput::getStatement() const {
    return m_statement;
}
void OAICreatePolicyTemplateInput::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAICreatePolicyTemplateInput::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAICreatePolicyTemplateInput::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAICreatePolicyTemplateInput::isSet() const {
...
bool OAICreatePolicyTemplateInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_statement_isValid && true;
}
