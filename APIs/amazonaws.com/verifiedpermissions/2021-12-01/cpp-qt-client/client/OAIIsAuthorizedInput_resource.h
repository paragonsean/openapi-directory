...
/*
 * OAIIsAuthorizedInput_resource.h
 *
 * 
 */

#ifndef OAIIsAuthorizedInput_resource_H
#define OAIIsAuthorizedInput_resource_H
...
class OAIIsAuthorizedInput_resource : public OAIObject {
public:
    OAIIsAuthorizedInput_resource();
    OAIIsAuthorizedInput_resource(QString json);
    ~OAIIsAuthorizedInput_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedInput_resource)

#endif // OAIIsAuthorizedInput_resource_H
