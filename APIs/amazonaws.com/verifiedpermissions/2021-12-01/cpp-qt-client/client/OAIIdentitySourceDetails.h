...
#ifndef OAIIdentitySourceDetails_H
#define OAIIdentitySourceDetails_H
...
class OAIIdentitySourceDetails : public OAIObject {
public:
    OAIIdentitySourceDetails();
    OAIIdentitySourceDetails(QString json);
    ~OAIIdentitySourceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentitySourceDetails)

#endif // OAIIdentitySourceDetails_H
