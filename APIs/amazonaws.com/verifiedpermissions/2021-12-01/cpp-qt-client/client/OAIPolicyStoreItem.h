...
#ifndef OAIPolicyStoreItem_H
#define OAIPolicyStoreItem_H
...
class OAIPolicyStoreItem : public OAIObject {
public:
    OAIPolicyStoreItem();
    OAIPolicyStoreItem(QString json);
    ~OAIPolicyStoreItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyStoreItem)

#endif // OAIPolicyStoreItem_H
