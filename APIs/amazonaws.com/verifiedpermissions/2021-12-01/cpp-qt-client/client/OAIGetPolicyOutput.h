...
/*
 * OAIGetPolicyOutput.h
 *
 * 
 */

#ifndef OAIGetPolicyOutput_H
#define OAIGetPolicyOutput_H

#include <QJsonObject>

#include "OAIGetPolicyOutput_definition.h"
...
namespace OpenAPI {
class OAIGetPolicyOutput_principal;
class OAIGetPolicyOutput_resource;
class OAIGetPolicyOutput_definition;

class OAIGetPolicyOutput : public OAIObject {
public:
    OAIGetPolicyOutput();
    OAIGetPolicyOutput(QString json);
    ~OAIGetPolicyOutput() override;
    ...
    OAIGetPolicyOutput_principal getPrincipal() const;
    void setPrincipal(const OAIGetPolicyOutput_principal &principal);
    bool is_principal_Set() const;
    bool is_principal_Valid() const;

    OAIGetPolicyOutput_resource getResource() const;
    void setResource(const OAIGetPolicyOutput_resource &resource);
    bool is_resource_Set() const;
    bool is_resource_Valid() const;

    OAIGetPolicyOutput_definition getDefinition() const;
    void setDefinition(const OAIGetPolicyOutput_definition &definition);
...
private:
    ...
    OAIGetPolicyOutput_principal m_principal;
    bool m_principal_isSet;
    bool m_principal_isValid;

    OAIGetPolicyOutput_resource m_resource;
    bool m_resource_isSet;
    bool m_resource_isValid;

    OAIGetPolicyOutput_definition m_definition;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyOutput)

#endif // OAIGetPolicyOutput_H
