...
/*
 * OAIPolicyItem_definition.h
 *
 * 
 */

#ifndef OAIPolicyItem_definition_H
#define OAIPolicyItem_definition_H

#include <QJsonObject>

#include "OAIPolicyDefinitionItem_static.h"
#include "OAIPolicyDefinitionItem_templateLinked.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIPolicyDefinitionItem_static;
class OAIPolicyDefinitionItem_templateLinked;

class OAIPolicyItem_definition : public OAIObject {
public:
    OAIPolicyItem_definition();
    OAIPolicyItem_definition(QString json);
    ~OAIPolicyItem_definition() override;
    ...
    OAIPolicyDefinitionItem_static getRStatic() const;
    void setRStatic(const OAIPolicyDefinitionItem_static &r_static);
    bool is_r_static_Set() const;
    bool is_r_static_Valid() const;

    OAIPolicyDefinitionItem_templateLinked getTemplateLinked() const;
    void setTemplateLinked(const OAIPolicyDefinitionItem_templateLinked &template_linked);
    bool is_template_linked_Set() const;
    bool is_template_linked_Valid() const;
...
private:
    ...
    OAIPolicyDefinitionItem_static m_r_static;
    bool m_r_static_isSet;
    bool m_r_static_isValid;

    OAIPolicyDefinitionItem_templateLinked m_template_linked;
    bool m_template_linked_isSet;
    bool m_template_linked_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIPolicyItem_definition)

#endif // OAIPolicyItem_definition_H
