...
OAIEntityIdentifier::OAIEntityIdentifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityIdentifier::OAIEntityIdentifier() {
    this->initializeModel();
}

OAIEntityIdentifier::~OAIEntityIdentifier() {}

void OAIEntityIdentifier::initializeModel() {
...
void OAIEntityIdentifier::fromJson(QString jsonString) {
...
void OAIEntityIdentifier::fromJsonObject(QJsonObject json) {
...
QString OAIEntityIdentifier::asJson() const {
...
QJsonObject OAIEntityIdentifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEntityIdentifier::getEntityType() const {
    return m_entity_type;
}
void OAIEntityIdentifier::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIEntityIdentifier::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIEntityIdentifier::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIEntityIdentifier::getEntityId() const {
    return m_entity_id;
}
void OAIEntityIdentifier::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIEntityIdentifier::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIEntityIdentifier::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIEntityIdentifier::isSet() const {
...
bool OAIEntityIdentifier::isValid() const {
