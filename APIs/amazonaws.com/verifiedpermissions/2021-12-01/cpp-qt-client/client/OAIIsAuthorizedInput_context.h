...
/*
 * OAIIsAuthorizedInput_context.h
 *
 * 
 */

#ifndef OAIIsAuthorizedInput_context_H
#define OAIIsAuthorizedInput_context_H
...
class OAIIsAuthorizedInput_context : public OAIObject {
public:
    OAIIsAuthorizedInput_context();
    OAIIsAuthorizedInput_context(QString json);
    ~OAIIsAuthorizedInput_context() override;
    ...
    QMap getContextMap() const;
    void setContextMap(const QMap &context_map);
    bool is_context_map_Set() const;
    bool is_context_map_Valid() const;
...
private:
    ...
    QMap m_context_map;
    bool m_context_map_isSet;
    bool m_context_map_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedInput_context)

#endif // OAIIsAuthorizedInput_context_H
