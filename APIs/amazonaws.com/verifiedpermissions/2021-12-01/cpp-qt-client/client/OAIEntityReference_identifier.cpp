...
#include "OAIEntityReference_identifier.h"
...
OAIEntityReference_identifier::OAIEntityReference_identifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityReference_identifier::OAIEntityReference_identifier() {
    this->initializeModel();
}

OAIEntityReference_identifier::~OAIEntityReference_identifier() {}

void OAIEntityReference_identifier::initializeModel() {
...
void OAIEntityReference_identifier::fromJson(QString jsonString) {
...
void OAIEntityReference_identifier::fromJsonObject(QJsonObject json) {
...
QString OAIEntityReference_identifier::asJson() const {
...
QJsonObject OAIEntityReference_identifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEntityReference_identifier::getEntityType() const {
    return m_entity_type;
}
void OAIEntityReference_identifier::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIEntityReference_identifier::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIEntityReference_identifier::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIEntityReference_identifier::getEntityId() const {
    return m_entity_id;
}
void OAIEntityReference_identifier::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIEntityReference_identifier::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIEntityReference_identifier::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIEntityReference_identifier::isSet() const {
...
bool OAIEntityReference_identifier::isValid() const {
