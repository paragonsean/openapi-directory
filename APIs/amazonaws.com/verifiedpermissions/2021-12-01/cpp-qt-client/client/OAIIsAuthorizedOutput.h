...
/*
 * OAIIsAuthorizedOutput.h
 *
 * 
 */

#ifndef OAIIsAuthorizedOutput_H
#define OAIIsAuthorizedOutput_H
...
class OAIIsAuthorizedOutput : public OAIObject {
public:
    OAIIsAuthorizedOutput();
    OAIIsAuthorizedOutput(QString json);
    ~OAIIsAuthorizedOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedOutput)

#endif // OAIIsAuthorizedOutput_H
