...
/*
 * OAIPolicyDefinitionDetail_templateLinked.h
 *
 * 
 */

#ifndef OAIPolicyDefinitionDetail_templateLinked_H
#define OAIPolicyDefinitionDetail_templateLinked_H
...
class OAIPolicyDefinitionDetail_templateLinked : public OAIObject {
public:
    OAIPolicyDefinitionDetail_templateLinked();
    OAIPolicyDefinitionDetail_templateLinked(QString json);
    ~OAIPolicyDefinitionDetail_templateLinked() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinitionDetail_templateLinked)

#endif // OAIPolicyDefinitionDetail_templateLinked_H
