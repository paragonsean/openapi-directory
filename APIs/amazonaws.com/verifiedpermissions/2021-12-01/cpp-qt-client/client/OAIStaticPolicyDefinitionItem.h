...
/*
 * OAIStaticPolicyDefinitionItem.h
 *
...
#ifndef OAIStaticPolicyDefinitionItem_H
#define OAIStaticPolicyDefinitionItem_H
...
class OAIStaticPolicyDefinitionItem : public OAIObject {
public:
    OAIStaticPolicyDefinitionItem();
    OAIStaticPolicyDefinitionItem(QString json);
    ~OAIStaticPolicyDefinitionItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStaticPolicyDefinitionItem)

#endif // OAIStaticPolicyDefinitionItem_H
