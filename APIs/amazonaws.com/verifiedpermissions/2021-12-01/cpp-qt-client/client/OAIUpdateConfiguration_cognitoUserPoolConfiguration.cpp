...
OAIUpdateConfiguration_cognitoUserPoolConfiguration::OAIUpdateConfiguration_cognitoUserPoolConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateConfiguration_cognitoUserPoolConfiguration::OAIUpdateConfiguration_cognitoUserPoolConfiguration() {
    this->initializeModel();
}

OAIUpdateConfiguration_cognitoUserPoolConfiguration::~OAIUpdateConfiguration_cognitoUserPoolConfiguration() {}

void OAIUpdateConfiguration_cognitoUserPoolConfiguration::initializeModel() {
...
void OAIUpdateConfiguration_cognitoUserPoolConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateConfiguration_cognitoUserPoolConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateConfiguration_cognitoUserPoolConfiguration::asJson() const {
...
QJsonObject OAIUpdateConfiguration_cognitoUserPoolConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateConfiguration_cognitoUserPoolConfiguration::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAIUpdateConfiguration_cognitoUserPoolConfiguration::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAIUpdateConfiguration_cognitoUserPoolConfiguration::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAIUpdateConfiguration_cognitoUserPoolConfiguration::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QList OAIUpdateConfiguration_cognitoUserPoolConfiguration::getClientIds() const {
    return m_client_ids;
}
void OAIUpdateConfiguration_cognitoUserPoolConfiguration::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAIUpdateConfiguration_cognitoUserPoolConfiguration::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAIUpdateConfiguration_cognitoUserPoolConfiguration::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

bool OAIUpdateConfiguration_cognitoUserPoolConfiguration::isSet() const {
...
bool OAIUpdateConfiguration_cognitoUserPoolConfiguration::isValid() const {
