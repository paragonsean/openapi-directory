...
/*
 * OAIPolicyDefinition_static.h
 *
 * 
 */

#ifndef OAIPolicyDefinition_static_H
#define OAIPolicyDefinition_static_H
...
class OAIPolicyDefinition_static : public OAIObject {
public:
    OAIPolicyDefinition_static();
    OAIPolicyDefinition_static(QString json);
    ~OAIPolicyDefinition_static() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinition_static)

#endif // OAIPolicyDefinition_static_H
