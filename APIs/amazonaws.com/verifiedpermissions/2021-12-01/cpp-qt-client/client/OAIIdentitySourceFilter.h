...
#ifndef OAIIdentitySourceFilter_H
#define OAIIdentitySourceFilter_H
...
class OAIIdentitySourceFilter : public OAIObject {
public:
    OAIIdentitySourceFilter();
    OAIIdentitySourceFilter(QString json);
    ~OAIIdentitySourceFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentitySourceFilter)

#endif // OAIIdentitySourceFilter_H
