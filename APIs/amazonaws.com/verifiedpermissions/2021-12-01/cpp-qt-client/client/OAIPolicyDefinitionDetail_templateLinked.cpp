...
#include "OAIPolicyDefinitionDetail_templateLinked.h"
...
OAIPolicyDefinitionDetail_templateLinked::OAIPolicyDefinitionDetail_templateLinked(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyDefinitionDetail_templateLinked::OAIPolicyDefinitionDetail_templateLinked() {
    this->initializeModel();
}

OAIPolicyDefinitionDetail_templateLinked::~OAIPolicyDefinitionDetail_templateLinked() {}

void OAIPolicyDefinitionDetail_templateLinked::initializeModel() {
...
void OAIPolicyDefinitionDetail_templateLinked::fromJson(QString jsonString) {
...
void OAIPolicyDefinitionDetail_templateLinked::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyDefinitionDetail_templateLinked::asJson() const {
...
QJsonObject OAIPolicyDefinitionDetail_templateLinked::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyDefinitionDetail_templateLinked::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIPolicyDefinitionDetail_templateLinked::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIPolicyDefinitionDetail_templateLinked::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIPolicyDefinitionDetail_templateLinked::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

OAITemplateLinkedPolicyDefinition_principal OAIPolicyDefinitionDetail_templateLinked::getPrincipal() const {
    return m_principal;
}
void OAIPolicyDefinitionDetail_templateLinked::setPrincipal(const OAITemplateLinkedPolicyDefinition_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIPolicyDefinitionDetail_templateLinked::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIPolicyDefinitionDetail_templateLinked::is_principal_Valid() const{
    return m_principal_isValid;
}

OAITemplateLinkedPolicyDefinition_resource OAIPolicyDefinitionDetail_templateLinked::getResource() const {
    return m_resource;
}
void OAIPolicyDefinitionDetail_templateLinked::setResource(const OAITemplateLinkedPolicyDefinition_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIPolicyDefinitionDetail_templateLinked::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIPolicyDefinitionDetail_templateLinked::is_resource_Valid() const{
    return m_resource_isValid;
}

bool OAIPolicyDefinitionDetail_templateLinked::isSet() const {
...
bool OAIPolicyDefinitionDetail_templateLinked::isValid() const {
