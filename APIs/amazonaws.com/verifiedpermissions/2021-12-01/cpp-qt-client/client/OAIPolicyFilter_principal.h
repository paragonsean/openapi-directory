...
/*
 * OAIPolicyFilter_principal.h
 *
 * 
 */

#ifndef OAIPolicyFilter_principal_H
#define OAIPolicyFilter_principal_H
...
namespace OpenAPI {
class OAIEntityReference_identifier;

class OAIPolicyFilter_principal : public OAIObject {
public:
    OAIPolicyFilter_principal();
    OAIPolicyFilter_principal(QString json);
    ~OAIPolicyFilter_principal() override;
    ...
    void setUnspecified(const bool &unspecified);
    bool is_unspecified_Set() const;
    bool is_unspecified_Valid() const;

    OAIEntityReference_identifier getIdentifier() const;
    void setIdentifier(const OAIEntityReference_identifier &identifier);
...
private:
    ...
    OAIEntityReference_identifier m_identifier;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyFilter_principal)

#endif // OAIPolicyFilter_principal_H
