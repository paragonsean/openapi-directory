...
#ifndef OAIActionIdentifier_H
#define OAIActionIdentifier_H
...
class OAIActionIdentifier : public OAIObject {
public:
    OAIActionIdentifier();
    OAIActionIdentifier(QString json);
    ~OAIActionIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIActionIdentifier)

#endif // OAIActionIdentifier_H
