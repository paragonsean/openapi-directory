...
/*
 * OAICognitoUserPoolConfiguration.h
 *
...
#ifndef OAICognitoUserPoolConfiguration_H
#define OAICognitoUserPoolConfiguration_H
...
class OAICognitoUserPoolConfiguration : public OAIObject {
public:
    OAICognitoUserPoolConfiguration();
    OAICognitoUserPoolConfiguration(QString json);
    ~OAICognitoUserPoolConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICognitoUserPoolConfiguration)

#endif // OAICognitoUserPoolConfiguration_H
