...
#include "OAIUpdatePolicyDefinition_static.h"
...
OAIUpdatePolicyDefinition_static::OAIUpdatePolicyDefinition_static(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyDefinition_static::OAIUpdatePolicyDefinition_static() {
    this->initializeModel();
}

OAIUpdatePolicyDefinition_static::~OAIUpdatePolicyDefinition_static() {}

void OAIUpdatePolicyDefinition_static::initializeModel() {
...
void OAIUpdatePolicyDefinition_static::fromJson(QString jsonString) {
...
void OAIUpdatePolicyDefinition_static::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyDefinition_static::asJson() const {
...
QJsonObject OAIUpdatePolicyDefinition_static::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePolicyDefinition_static::getDescription() const {
    return m_description;
}
void OAIUpdatePolicyDefinition_static::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdatePolicyDefinition_static::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdatePolicyDefinition_static::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdatePolicyDefinition_static::getStatement() const {
    return m_statement;
}
void OAIUpdatePolicyDefinition_static::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIUpdatePolicyDefinition_static::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIUpdatePolicyDefinition_static::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIUpdatePolicyDefinition_static::isSet() const {
...
bool OAIUpdatePolicyDefinition_static::isValid() const {
