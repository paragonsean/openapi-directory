...
#include "OAIIdentitySourceItemDetails.h"
...
OAIIdentitySourceItemDetails::OAIIdentitySourceItemDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentitySourceItemDetails::OAIIdentitySourceItemDetails() {
    this->initializeModel();
}

OAIIdentitySourceItemDetails::~OAIIdentitySourceItemDetails() {}

void OAIIdentitySourceItemDetails::initializeModel() {
...
void OAIIdentitySourceItemDetails::fromJson(QString jsonString) {
...
void OAIIdentitySourceItemDetails::fromJsonObject(QJsonObject json) {
...
QString OAIIdentitySourceItemDetails::asJson() const {
...
QJsonObject OAIIdentitySourceItemDetails::asJsonObject() const {
    QJsonObject obj;
...
QList OAIIdentitySourceItemDetails::getClientIds() const {
    return m_client_ids;
}
void OAIIdentitySourceItemDetails::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAIIdentitySourceItemDetails::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAIIdentitySourceItemDetails::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

QString OAIIdentitySourceItemDetails::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAIIdentitySourceItemDetails::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAIIdentitySourceItemDetails::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAIIdentitySourceItemDetails::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QString OAIIdentitySourceItemDetails::getDiscoveryUrl() const {
    return m_discovery_url;
}
void OAIIdentitySourceItemDetails::setDiscoveryUrl(const QString &discovery_url) {
    m_discovery_url = discovery_url;
    m_discovery_url_isSet = true;
}

bool OAIIdentitySourceItemDetails::is_discovery_url_Set() const{
    return m_discovery_url_isSet;
}

bool OAIIdentitySourceItemDetails::is_discovery_url_Valid() const{
    return m_discovery_url_isValid;
}

OAIOpenIdIssuer OAIIdentitySourceItemDetails::getOpenIdIssuer() const {
    return m_open_id_issuer;
}
void OAIIdentitySourceItemDetails::setOpenIdIssuer(const OAIOpenIdIssuer &open_id_issuer) {
    m_open_id_issuer = open_id_issuer;
    m_open_id_issuer_isSet = true;
}

bool OAIIdentitySourceItemDetails::is_open_id_issuer_Set() const{
    return m_open_id_issuer_isSet;
}

bool OAIIdentitySourceItemDetails::is_open_id_issuer_Valid() const{
    return m_open_id_issuer_isValid;
}

bool OAIIdentitySourceItemDetails::isSet() const {
...
bool OAIIdentitySourceItemDetails::isValid() const {
