...
#include "OAIIdentitySourceFilter.h"
...
OAIIdentitySourceFilter::OAIIdentitySourceFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentitySourceFilter::OAIIdentitySourceFilter() {
    this->initializeModel();
}

OAIIdentitySourceFilter::~OAIIdentitySourceFilter() {}

void OAIIdentitySourceFilter::initializeModel() {

    m_principal_entity_type_isSet = false;
    m_principal_entity_type_isValid = false;
}

void OAIIdentitySourceFilter::fromJson(QString jsonString) {
...
void OAIIdentitySourceFilter::fromJsonObject(QJsonObject json) {
...
QString OAIIdentitySourceFilter::asJson() const {
...
QJsonObject OAIIdentitySourceFilter::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIdentitySourceFilter::getPrincipalEntityType() const {
    return m_principal_entity_type;
}
void OAIIdentitySourceFilter::setPrincipalEntityType(const QString &principal_entity_type) {
    m_principal_entity_type = principal_entity_type;
    m_principal_entity_type_isSet = true;
}

bool OAIIdentitySourceFilter::is_principal_entity_type_Set() const{
    return m_principal_entity_type_isSet;
}

bool OAIIdentitySourceFilter::is_principal_entity_type_Valid() const{
    return m_principal_entity_type_isValid;
}

bool OAIIdentitySourceFilter::isSet() const {
...
bool OAIIdentitySourceFilter::isValid() const {
