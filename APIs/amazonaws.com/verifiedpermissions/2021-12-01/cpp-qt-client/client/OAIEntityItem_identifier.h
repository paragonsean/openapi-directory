...
/*
 * OAIEntityItem_identifier.h
 *
 * 
 */

#ifndef OAIEntityItem_identifier_H
#define OAIEntityItem_identifier_H
...
class OAIEntityItem_identifier : public OAIObject {
public:
    OAIEntityItem_identifier();
    OAIEntityItem_identifier(QString json);
    ~OAIEntityItem_identifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityItem_identifier)

#endif // OAIEntityItem_identifier_H
