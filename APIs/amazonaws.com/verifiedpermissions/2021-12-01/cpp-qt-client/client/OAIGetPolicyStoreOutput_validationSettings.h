...
/*
 * OAIGetPolicyStoreOutput_validationSettings.h
 *
 * 
 */

#ifndef OAIGetPolicyStoreOutput_validationSettings_H
#define OAIGetPolicyStoreOutput_validationSettings_H
...
class OAIGetPolicyStoreOutput_validationSettings : public OAIObject {
public:
    OAIGetPolicyStoreOutput_validationSettings();
    OAIGetPolicyStoreOutput_validationSettings(QString json);
    ~OAIGetPolicyStoreOutput_validationSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyStoreOutput_validationSettings)

#endif // OAIGetPolicyStoreOutput_validationSettings_H
