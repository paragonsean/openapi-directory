...
/*
 * OAIListPoliciesOutput.h
 *
 * 
 */

#ifndef OAIListPoliciesOutput_H
#define OAIListPoliciesOutput_H
...
class OAIListPoliciesOutput : public OAIObject {
public:
    OAIListPoliciesOutput();
    OAIListPoliciesOutput(QString json);
    ~OAIListPoliciesOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoliciesOutput)

#endif // OAIListPoliciesOutput_H
