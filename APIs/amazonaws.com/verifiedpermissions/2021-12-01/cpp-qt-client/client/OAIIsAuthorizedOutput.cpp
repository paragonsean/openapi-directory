...
OAIIsAuthorizedOutput::OAIIsAuthorizedOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedOutput::OAIIsAuthorizedOutput() {
    this->initializeModel();
}

OAIIsAuthorizedOutput::~OAIIsAuthorizedOutput() {}

void OAIIsAuthorizedOutput::initializeModel() {
...
void OAIIsAuthorizedOutput::fromJson(QString jsonString) {
...
void OAIIsAuthorizedOutput::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedOutput::asJson() const {
...
QJsonObject OAIIsAuthorizedOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_decision.isSet()) {
...
OAIDecision OAIIsAuthorizedOutput::getDecision() const {
    return m_decision;
}
void OAIIsAuthorizedOutput::setDecision(const OAIDecision &decision) {
    m_decision = decision;
    m_decision_isSet = true;
}

bool OAIIsAuthorizedOutput::is_decision_Set() const{
    return m_decision_isSet;
}

bool OAIIsAuthorizedOutput::is_decision_Valid() const{
    return m_decision_isValid;
}

QList OAIIsAuthorizedOutput::getDeterminingPolicies() const {
    return m_determining_policies;
}
void OAIIsAuthorizedOutput::setDeterminingPolicies(const QList &determining_policies) {
    m_determining_policies = determining_policies;
    m_determining_policies_isSet = true;
}

bool OAIIsAuthorizedOutput::is_determining_policies_Set() const{
    return m_determining_policies_isSet;
}

bool OAIIsAuthorizedOutput::is_determining_policies_Valid() const{
    return m_determining_policies_isValid;
}

QList OAIIsAuthorizedOutput::getErrors() const {
    return m_errors;
}
void OAIIsAuthorizedOutput::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIIsAuthorizedOutput::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIIsAuthorizedOutput::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIIsAuthorizedOutput::isSet() const {
...
bool OAIIsAuthorizedOutput::isValid() const {
