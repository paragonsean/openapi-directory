...
OAIUpdateIdentitySourceInput_updateConfiguration::OAIUpdateIdentitySourceInput_updateConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIdentitySourceInput_updateConfiguration::OAIUpdateIdentitySourceInput_updateConfiguration() {
    this->initializeModel();
}

OAIUpdateIdentitySourceInput_updateConfiguration::~OAIUpdateIdentitySourceInput_updateConfiguration() {}

void OAIUpdateIdentitySourceInput_updateConfiguration::initializeModel() {

    m_cognito_user_pool_configuration_isSet = false;
    m_cognito_user_pool_configuration_isValid = false;
}

void OAIUpdateIdentitySourceInput_updateConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateIdentitySourceInput_updateConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIdentitySourceInput_updateConfiguration::asJson() const {
...
QJsonObject OAIUpdateIdentitySourceInput_updateConfiguration::asJsonObject() const {
    QJsonObject obj;
...
OAIUpdateConfiguration_cognitoUserPoolConfiguration OAIUpdateIdentitySourceInput_updateConfiguration::getCognitoUserPoolConfiguration() const {
    return m_cognito_user_pool_configuration;
}
void OAIUpdateIdentitySourceInput_updateConfiguration::setCognitoUserPoolConfiguration(const OAIUpdateConfiguration_cognitoUserPoolConfiguration &cognito_user_pool_configuration) {
    m_cognito_user_pool_configuration = cognito_user_pool_configuration;
    m_cognito_user_pool_configuration_isSet = true;
}

bool OAIUpdateIdentitySourceInput_updateConfiguration::is_cognito_user_pool_configuration_Set() const{
    return m_cognito_user_pool_configuration_isSet;
}

bool OAIUpdateIdentitySourceInput_updateConfiguration::is_cognito_user_pool_configuration_Valid() const{
    return m_cognito_user_pool_configuration_isValid;
}

bool OAIUpdateIdentitySourceInput_updateConfiguration::isSet() const {
...
bool OAIUpdateIdentitySourceInput_updateConfiguration::isValid() const {
