...
/*
 * OAICreatePolicyOutput_principal.h
 *
 * 
 */

#ifndef OAICreatePolicyOutput_principal_H
#define OAICreatePolicyOutput_principal_H
...
class OAICreatePolicyOutput_principal : public OAIObject {
public:
    OAICreatePolicyOutput_principal();
    OAICreatePolicyOutput_principal(QString json);
    ~OAICreatePolicyOutput_principal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyOutput_principal)

#endif // OAICreatePolicyOutput_principal_H
