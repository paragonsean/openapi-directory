...
/*
 * OAIIsAuthorizedWithTokenOutput.h
 *
 * 
 */

#ifndef OAIIsAuthorizedWithTokenOutput_H
#define OAIIsAuthorizedWithTokenOutput_H
...
class OAIIsAuthorizedWithTokenOutput : public OAIObject {
public:
    OAIIsAuthorizedWithTokenOutput();
    OAIIsAuthorizedWithTokenOutput(QString json);
    ~OAIIsAuthorizedWithTokenOutput() override;
    ...
    OAIDecision getDecision() const;
    void setDecision(const OAIDecision &decision);
    bool is_decision_Set() const;
    bool is_decision_Valid() const;

    QList getDeterminingPolicies() const;
    void setDeterminingPolicies(const QList &determining_policies);
    bool is_determining_policies_Set() const;
    bool is_determining_policies_Valid() const;
...
private:
    ...
    OAIDecision m_decision;
    bool m_decision_isSet;
    bool m_decision_isValid;

    QList m_determining_policies;
    bool m_determining_policies_isSet;
    bool m_determining_policies_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedWithTokenOutput)

#endif // OAIIsAuthorizedWithTokenOutput_H
