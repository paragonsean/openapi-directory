...
/*
 * OAIIsAuthorizedWithTokenInput_resource.h
 *
 * 
 */

#ifndef OAIIsAuthorizedWithTokenInput_resource_H
#define OAIIsAuthorizedWithTokenInput_resource_H
...
class OAIIsAuthorizedWithTokenInput_resource : public OAIObject {
public:
    OAIIsAuthorizedWithTokenInput_resource();
    OAIIsAuthorizedWithTokenInput_resource(QString json);
    ~OAIIsAuthorizedWithTokenInput_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedWithTokenInput_resource)

#endif // OAIIsAuthorizedWithTokenInput_resource_H
