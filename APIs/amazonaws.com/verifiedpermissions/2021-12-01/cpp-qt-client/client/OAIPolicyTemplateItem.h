...
#ifndef OAIPolicyTemplateItem_H
#define OAIPolicyTemplateItem_H
...
class OAIPolicyTemplateItem : public OAIObject {
public:
    OAIPolicyTemplateItem();
    OAIPolicyTemplateItem(QString json);
    ~OAIPolicyTemplateItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyTemplateItem)

#endif // OAIPolicyTemplateItem_H
