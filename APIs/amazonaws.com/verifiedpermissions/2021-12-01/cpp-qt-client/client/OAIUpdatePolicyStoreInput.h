...
/*
 * OAIUpdatePolicyStoreInput.h
 *
 * 
 */

#ifndef OAIUpdatePolicyStoreInput_H
#define OAIUpdatePolicyStoreInput_H
...
namespace OpenAPI {
class OAIUpdatePolicyStoreInput_validationSettings;

class OAIUpdatePolicyStoreInput : public OAIObject {
public:
    OAIUpdatePolicyStoreInput();
    OAIUpdatePolicyStoreInput(QString json);
    ~OAIUpdatePolicyStoreInput() override;
    ...
    OAIUpdatePolicyStoreInput_validationSettings getValidationSettings() const;
    void setValidationSettings(const OAIUpdatePolicyStoreInput_validationSettings &validation_settings);
...
private:
    ...
    OAIUpdatePolicyStoreInput_validationSettings m_validation_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyStoreInput)

#endif // OAIUpdatePolicyStoreInput_H
