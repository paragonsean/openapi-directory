...
#include "OAIIsAuthorizedWithTokenInput_resource.h"
...
OAIIsAuthorizedWithTokenInput_resource::OAIIsAuthorizedWithTokenInput_resource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedWithTokenInput_resource::OAIIsAuthorizedWithTokenInput_resource() {
    this->initializeModel();
}

OAIIsAuthorizedWithTokenInput_resource::~OAIIsAuthorizedWithTokenInput_resource() {}

void OAIIsAuthorizedWithTokenInput_resource::initializeModel() {
...
void OAIIsAuthorizedWithTokenInput_resource::fromJson(QString jsonString) {
...
void OAIIsAuthorizedWithTokenInput_resource::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedWithTokenInput_resource::asJson() const {
...
QJsonObject OAIIsAuthorizedWithTokenInput_resource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIsAuthorizedWithTokenInput_resource::getEntityType() const {
    return m_entity_type;
}
void OAIIsAuthorizedWithTokenInput_resource::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIIsAuthorizedWithTokenInput_resource::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIIsAuthorizedWithTokenInput_resource::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIIsAuthorizedWithTokenInput_resource::getEntityId() const {
    return m_entity_id;
}
void OAIIsAuthorizedWithTokenInput_resource::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIIsAuthorizedWithTokenInput_resource::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIIsAuthorizedWithTokenInput_resource::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIIsAuthorizedWithTokenInput_resource::isSet() const {
...
bool OAIIsAuthorizedWithTokenInput_resource::isValid() const {
