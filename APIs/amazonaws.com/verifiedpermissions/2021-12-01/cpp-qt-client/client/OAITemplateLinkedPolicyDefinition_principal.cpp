...
OAITemplateLinkedPolicyDefinition_principal::OAITemplateLinkedPolicyDefinition_principal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateLinkedPolicyDefinition_principal::OAITemplateLinkedPolicyDefinition_principal() {
    this->initializeModel();
}

OAITemplateLinkedPolicyDefinition_principal::~OAITemplateLinkedPolicyDefinition_principal() {}

void OAITemplateLinkedPolicyDefinition_principal::initializeModel() {
...
void OAITemplateLinkedPolicyDefinition_principal::fromJson(QString jsonString) {
...
void OAITemplateLinkedPolicyDefinition_principal::fromJsonObject(QJsonObject json) {
...
QString OAITemplateLinkedPolicyDefinition_principal::asJson() const {
...
QJsonObject OAITemplateLinkedPolicyDefinition_principal::asJsonObject() const {
    QJsonObject obj;
...
QString OAITemplateLinkedPolicyDefinition_principal::getEntityType() const {
    return m_entity_type;
}
void OAITemplateLinkedPolicyDefinition_principal::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition_principal::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAITemplateLinkedPolicyDefinition_principal::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAITemplateLinkedPolicyDefinition_principal::getEntityId() const {
    return m_entity_id;
}
void OAITemplateLinkedPolicyDefinition_principal::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition_principal::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAITemplateLinkedPolicyDefinition_principal::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAITemplateLinkedPolicyDefinition_principal::isSet() const {
...
bool OAITemplateLinkedPolicyDefinition_principal::isValid() const {
