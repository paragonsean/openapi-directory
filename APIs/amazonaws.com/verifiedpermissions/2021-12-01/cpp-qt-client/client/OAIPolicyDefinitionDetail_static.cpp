...
OAIPolicyDefinitionDetail_static::OAIPolicyDefinitionDetail_static(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyDefinitionDetail_static::OAIPolicyDefinitionDetail_static() {
    this->initializeModel();
}

OAIPolicyDefinitionDetail_static::~OAIPolicyDefinitionDetail_static() {}

void OAIPolicyDefinitionDetail_static::initializeModel() {
...
void OAIPolicyDefinitionDetail_static::fromJson(QString jsonString) {
...
void OAIPolicyDefinitionDetail_static::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyDefinitionDetail_static::asJson() const {
...
QJsonObject OAIPolicyDefinitionDetail_static::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyDefinitionDetail_static::getDescription() const {
    return m_description;
}
void OAIPolicyDefinitionDetail_static::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPolicyDefinitionDetail_static::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPolicyDefinitionDetail_static::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIPolicyDefinitionDetail_static::getStatement() const {
    return m_statement;
}
void OAIPolicyDefinitionDetail_static::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIPolicyDefinitionDetail_static::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIPolicyDefinitionDetail_static::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIPolicyDefinitionDetail_static::isSet() const {
...
bool OAIPolicyDefinitionDetail_static::isValid() const {
