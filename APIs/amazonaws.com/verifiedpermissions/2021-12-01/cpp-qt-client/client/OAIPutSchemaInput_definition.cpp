...
OAIPutSchemaInput_definition::OAIPutSchemaInput_definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutSchemaInput_definition::OAIPutSchemaInput_definition() {
    this->initializeModel();
}

OAIPutSchemaInput_definition::~OAIPutSchemaInput_definition() {}

void OAIPutSchemaInput_definition::initializeModel() {

    m_cedar_json_isSet = false;
    m_cedar_json_isValid = false;
}

void OAIPutSchemaInput_definition::fromJson(QString jsonString) {
...
void OAIPutSchemaInput_definition::fromJsonObject(QJsonObject json) {
...
QString OAIPutSchemaInput_definition::asJson() const {
...
QJsonObject OAIPutSchemaInput_definition::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutSchemaInput_definition::getCedarJson() const {
    return m_cedar_json;
}
void OAIPutSchemaInput_definition::setCedarJson(const QString &cedar_json) {
    m_cedar_json = cedar_json;
    m_cedar_json_isSet = true;
}

bool OAIPutSchemaInput_definition::is_cedar_json_Set() const{
    return m_cedar_json_isSet;
}

bool OAIPutSchemaInput_definition::is_cedar_json_Valid() const{
    return m_cedar_json_isValid;
}

bool OAIPutSchemaInput_definition::isSet() const {
...
bool OAIPutSchemaInput_definition::isValid() const {
