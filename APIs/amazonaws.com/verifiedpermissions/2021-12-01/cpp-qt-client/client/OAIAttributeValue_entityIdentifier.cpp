...
OAIAttributeValue_entityIdentifier::OAIAttributeValue_entityIdentifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAttributeValue_entityIdentifier::OAIAttributeValue_entityIdentifier() {
    this->initializeModel();
}

OAIAttributeValue_entityIdentifier::~OAIAttributeValue_entityIdentifier() {}

void OAIAttributeValue_entityIdentifier::initializeModel() {
...
void OAIAttributeValue_entityIdentifier::fromJson(QString jsonString) {
...
void OAIAttributeValue_entityIdentifier::fromJsonObject(QJsonObject json) {
...
QString OAIAttributeValue_entityIdentifier::asJson() const {
...
QJsonObject OAIAttributeValue_entityIdentifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAttributeValue_entityIdentifier::getEntityType() const {
    return m_entity_type;
}
void OAIAttributeValue_entityIdentifier::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIAttributeValue_entityIdentifier::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIAttributeValue_entityIdentifier::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIAttributeValue_entityIdentifier::getEntityId() const {
    return m_entity_id;
}
void OAIAttributeValue_entityIdentifier::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIAttributeValue_entityIdentifier::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIAttributeValue_entityIdentifier::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIAttributeValue_entityIdentifier::isSet() const {
...
bool OAIAttributeValue_entityIdentifier::isValid() const {
