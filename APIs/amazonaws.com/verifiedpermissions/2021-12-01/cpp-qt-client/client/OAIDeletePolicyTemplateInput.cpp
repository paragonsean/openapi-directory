...
OAIDeletePolicyTemplateInput::OAIDeletePolicyTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePolicyTemplateInput::OAIDeletePolicyTemplateInput() {
    this->initializeModel();
}

OAIDeletePolicyTemplateInput::~OAIDeletePolicyTemplateInput() {}

void OAIDeletePolicyTemplateInput::initializeModel() {
...
void OAIDeletePolicyTemplateInput::fromJson(QString jsonString) {
...
void OAIDeletePolicyTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePolicyTemplateInput::asJson() const {
...
QJsonObject OAIDeletePolicyTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeletePolicyTemplateInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIDeletePolicyTemplateInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIDeletePolicyTemplateInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIDeletePolicyTemplateInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIDeletePolicyTemplateInput::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIDeletePolicyTemplateInput::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIDeletePolicyTemplateInput::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIDeletePolicyTemplateInput::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

bool OAIDeletePolicyTemplateInput::isSet() const {
...
bool OAIDeletePolicyTemplateInput::isValid() const {
