...
/*
 * OAIUpdateStaticPolicyDefinition.h
 *
 * Contains information about an update to a static policy.
 */

#ifndef OAIUpdateStaticPolicyDefinition_H
#define OAIUpdateStaticPolicyDefinition_H
...
class OAIUpdateStaticPolicyDefinition : public OAIObject {
public:
    OAIUpdateStaticPolicyDefinition();
    OAIUpdateStaticPolicyDefinition(QString json);
    ~OAIUpdateStaticPolicyDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStaticPolicyDefinition)

#endif // OAIUpdateStaticPolicyDefinition_H
