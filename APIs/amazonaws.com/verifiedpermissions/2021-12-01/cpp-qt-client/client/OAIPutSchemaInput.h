...
#ifndef OAIPutSchemaInput_H
#define OAIPutSchemaInput_H

#include <QJsonObject>

#include "OAIPutSchemaInput_definition.h"
#include <QString>
...
namespace OpenAPI {
class OAIPutSchemaInput_definition;

class OAIPutSchemaInput : public OAIObject {
public:
    OAIPutSchemaInput();
    OAIPutSchemaInput(QString json);
    ~OAIPutSchemaInput() override;
    ...
    OAIPutSchemaInput_definition getDefinition() const;
    void setDefinition(const OAIPutSchemaInput_definition &definition);
...
private:
    ...
    OAIPutSchemaInput_definition m_definition;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSchemaInput)

#endif // OAIPutSchemaInput_H
