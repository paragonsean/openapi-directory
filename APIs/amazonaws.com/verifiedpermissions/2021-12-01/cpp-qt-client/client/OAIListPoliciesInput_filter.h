...
/*
 * OAIListPoliciesInput_filter.h
 *
 * 
 */

#ifndef OAIListPoliciesInput_filter_H
#define OAIListPoliciesInput_filter_H

#include <QJsonObject>

#include "OAIPolicyFilter_principal.h"
#include "OAIPolicyFilter_resource.h"
...
namespace OpenAPI {
class OAIPolicyFilter_principal;
class OAIPolicyFilter_resource;

class OAIListPoliciesInput_filter : public OAIObject {
public:
    OAIListPoliciesInput_filter();
    OAIListPoliciesInput_filter(QString json);
    ~OAIListPoliciesInput_filter() override;
    ...
    OAIPolicyFilter_principal getPrincipal() const;
    void setPrincipal(const OAIPolicyFilter_principal &principal);
    bool is_principal_Set() const;
    bool is_principal_Valid() const;

    OAIPolicyFilter_resource getResource() const;
    void setResource(const OAIPolicyFilter_resource &resource);
...
private:
    ...
    OAIPolicyFilter_principal m_principal;
    bool m_principal_isSet;
    bool m_principal_isValid;

    OAIPolicyFilter_resource m_resource;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoliciesInput_filter)

#endif // OAIListPoliciesInput_filter_H
