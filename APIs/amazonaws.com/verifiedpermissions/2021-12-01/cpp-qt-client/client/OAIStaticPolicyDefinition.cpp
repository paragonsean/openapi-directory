...
#include "OAIStaticPolicyDefinition.h"
...
OAIStaticPolicyDefinition::OAIStaticPolicyDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStaticPolicyDefinition::OAIStaticPolicyDefinition() {
    this->initializeModel();
}

OAIStaticPolicyDefinition::~OAIStaticPolicyDefinition() {}

void OAIStaticPolicyDefinition::initializeModel() {
...
void OAIStaticPolicyDefinition::fromJson(QString jsonString) {
...
void OAIStaticPolicyDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIStaticPolicyDefinition::asJson() const {
...
QJsonObject OAIStaticPolicyDefinition::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStaticPolicyDefinition::getDescription() const {
    return m_description;
}
void OAIStaticPolicyDefinition::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIStaticPolicyDefinition::is_description_Set() const{
    return m_description_isSet;
}

bool OAIStaticPolicyDefinition::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIStaticPolicyDefinition::getStatement() const {
    return m_statement;
}
void OAIStaticPolicyDefinition::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIStaticPolicyDefinition::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIStaticPolicyDefinition::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIStaticPolicyDefinition::isSet() const {
...
bool OAIStaticPolicyDefinition::isValid() const {
