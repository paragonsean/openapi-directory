...
#include "OAIUpdatePolicyStoreInput_validationSettings.h"
...
OAIUpdatePolicyStoreInput_validationSettings::OAIUpdatePolicyStoreInput_validationSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyStoreInput_validationSettings::OAIUpdatePolicyStoreInput_validationSettings() {
    this->initializeModel();
}

OAIUpdatePolicyStoreInput_validationSettings::~OAIUpdatePolicyStoreInput_validationSettings() {}

void OAIUpdatePolicyStoreInput_validationSettings::initializeModel() {

    m_mode_isSet = false;
    m_mode_isValid = false;
}

void OAIUpdatePolicyStoreInput_validationSettings::fromJson(QString jsonString) {
...
void OAIUpdatePolicyStoreInput_validationSettings::fromJsonObject(QJsonObject json) {

    m_mode_isValid = ::OpenAPI::fromJsonValue(m_mode, json[QString("mode")]);
    m_mode_isSet = !json[QString("mode")].isNull() && m_mode_isValid;
}

QString OAIUpdatePolicyStoreInput_validationSettings::asJson() const {
...
QJsonObject OAIUpdatePolicyStoreInput_validationSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_mode.isSet()) {
...
OAIValidationMode OAIUpdatePolicyStoreInput_validationSettings::getMode() const {
    return m_mode;
}
void OAIUpdatePolicyStoreInput_validationSettings::setMode(const OAIValidationMode &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIUpdatePolicyStoreInput_validationSettings::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIUpdatePolicyStoreInput_validationSettings::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIUpdatePolicyStoreInput_validationSettings::isSet() const {
...
bool OAIUpdatePolicyStoreInput_validationSettings::isValid() const {
