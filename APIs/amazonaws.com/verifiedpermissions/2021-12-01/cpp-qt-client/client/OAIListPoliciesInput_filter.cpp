...
OAIListPoliciesInput_filter::OAIListPoliciesInput_filter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPoliciesInput_filter::OAIListPoliciesInput_filter() {
    this->initializeModel();
}

OAIListPoliciesInput_filter::~OAIListPoliciesInput_filter() {}

void OAIListPoliciesInput_filter::initializeModel() {
...
void OAIListPoliciesInput_filter::fromJson(QString jsonString) {
...
void OAIListPoliciesInput_filter::fromJsonObject(QJsonObject json) {
...
QString OAIListPoliciesInput_filter::asJson() const {
...
QJsonObject OAIListPoliciesInput_filter::asJsonObject() const {
    QJsonObject obj;
...
OAIPolicyFilter_principal OAIListPoliciesInput_filter::getPrincipal() const {
    return m_principal;
}
void OAIListPoliciesInput_filter::setPrincipal(const OAIPolicyFilter_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIListPoliciesInput_filter::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIListPoliciesInput_filter::is_principal_Valid() const{
    return m_principal_isValid;
}

OAIPolicyFilter_resource OAIListPoliciesInput_filter::getResource() const {
    return m_resource;
}
void OAIListPoliciesInput_filter::setResource(const OAIPolicyFilter_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIListPoliciesInput_filter::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIListPoliciesInput_filter::is_resource_Valid() const{
    return m_resource_isValid;
}

OAIPolicyType OAIListPoliciesInput_filter::getPolicyType() const {
    return m_policy_type;
}
void OAIListPoliciesInput_filter::setPolicyType(const OAIPolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIListPoliciesInput_filter::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIListPoliciesInput_filter::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

QString OAIListPoliciesInput_filter::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIListPoliciesInput_filter::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIListPoliciesInput_filter::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIListPoliciesInput_filter::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

bool OAIListPoliciesInput_filter::isSet() const {
...
bool OAIListPoliciesInput_filter::isValid() const {
