...
OAIUpdatePolicyTemplateOutput::OAIUpdatePolicyTemplateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyTemplateOutput::OAIUpdatePolicyTemplateOutput() {
    this->initializeModel();
}

OAIUpdatePolicyTemplateOutput::~OAIUpdatePolicyTemplateOutput() {}

void OAIUpdatePolicyTemplateOutput::initializeModel() {
...
void OAIUpdatePolicyTemplateOutput::fromJson(QString jsonString) {
...
void OAIUpdatePolicyTemplateOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyTemplateOutput::asJson() const {
...
QJsonObject OAIUpdatePolicyTemplateOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePolicyTemplateOutput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIUpdatePolicyTemplateOutput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIUpdatePolicyTemplateOutput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIUpdatePolicyTemplateOutput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIUpdatePolicyTemplateOutput::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIUpdatePolicyTemplateOutput::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIUpdatePolicyTemplateOutput::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIUpdatePolicyTemplateOutput::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

QDateTime OAIUpdatePolicyTemplateOutput::getCreatedDate() const {
    return m_created_date;
}
void OAIUpdatePolicyTemplateOutput::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIUpdatePolicyTemplateOutput::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIUpdatePolicyTemplateOutput::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAIUpdatePolicyTemplateOutput::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIUpdatePolicyTemplateOutput::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIUpdatePolicyTemplateOutput::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIUpdatePolicyTemplateOutput::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAIUpdatePolicyTemplateOutput::isSet() const {
...
bool OAIUpdatePolicyTemplateOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_policy_template_id_isValid && m_created_date_isValid && m_last_updated_date_isValid && true;
}
