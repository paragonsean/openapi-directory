...
/*
 * OAIDeletePolicyInput.h
 *
 * 
 */

#ifndef OAIDeletePolicyInput_H
#define OAIDeletePolicyInput_H
...
class OAIDeletePolicyInput : public OAIObject {
public:
    OAIDeletePolicyInput();
    OAIDeletePolicyInput(QString json);
    ~OAIDeletePolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePolicyInput)

#endif // OAIDeletePolicyInput_H
