...
OAIActionIdentifier::OAIActionIdentifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIActionIdentifier::OAIActionIdentifier() {
    this->initializeModel();
}

OAIActionIdentifier::~OAIActionIdentifier() {}

void OAIActionIdentifier::initializeModel() {
...
void OAIActionIdentifier::fromJson(QString jsonString) {
...
void OAIActionIdentifier::fromJsonObject(QJsonObject json) {
...
QString OAIActionIdentifier::asJson() const {
...
QJsonObject OAIActionIdentifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAIActionIdentifier::getActionType() const {
    return m_action_type;
}
void OAIActionIdentifier::setActionType(const QString &action_type) {
    m_action_type = action_type;
    m_action_type_isSet = true;
}

bool OAIActionIdentifier::is_action_type_Set() const{
    return m_action_type_isSet;
}

bool OAIActionIdentifier::is_action_type_Valid() const{
    return m_action_type_isValid;
}

QString OAIActionIdentifier::getActionId() const {
    return m_action_id;
}
void OAIActionIdentifier::setActionId(const QString &action_id) {
    m_action_id = action_id;
    m_action_id_isSet = true;
}

bool OAIActionIdentifier::is_action_id_Set() const{
    return m_action_id_isSet;
}

bool OAIActionIdentifier::is_action_id_Valid() const{
    return m_action_id_isValid;
}

bool OAIActionIdentifier::isSet() const {
...
bool OAIActionIdentifier::isValid() const {
