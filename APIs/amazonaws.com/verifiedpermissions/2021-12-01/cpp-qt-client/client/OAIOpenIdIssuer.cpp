...
OAIOpenIdIssuer::OAIOpenIdIssuer(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIOpenIdIssuer::OAIOpenIdIssuer() {
    this->initializeModel();
}

OAIOpenIdIssuer::~OAIOpenIdIssuer() {}

void OAIOpenIdIssuer::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIOpenIdIssuer::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIOpenIdIssuer::fromJson(QString jsonString) {
    
    if ( jsonString.compare("COGNITO", Qt::CaseInsensitive) == 0) {
        m_value = eOAIOpenIdIssuer::COGNITO;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIOpenIdIssuer::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIOpenIdIssuer::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIOpenIdIssuer::COGNITO:
            val = "COGNITO";
            break;
        default:
            break;
...
QJsonValue OAIOpenIdIssuer::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIOpenIdIssuer::eOAIOpenIdIssuer OAIOpenIdIssuer::getValue() const {
    return m_value;
}

void OAIOpenIdIssuer::setValue(const OAIOpenIdIssuer::eOAIOpenIdIssuer& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIOpenIdIssuer::isSet() const {
    
    return m_value_isSet;
}

bool OAIOpenIdIssuer::isValid() const {
