...
OAIGetPolicyStoreInput::OAIGetPolicyStoreInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyStoreInput::OAIGetPolicyStoreInput() {
    this->initializeModel();
}

OAIGetPolicyStoreInput::~OAIGetPolicyStoreInput() {}

void OAIGetPolicyStoreInput::initializeModel() {

    m_policy_store_id_isSet = false;
    m_policy_store_id_isValid = false;
}

void OAIGetPolicyStoreInput::fromJson(QString jsonString) {
...
void OAIGetPolicyStoreInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPolicyStoreInput::asJson() const {
...
QJsonObject OAIGetPolicyStoreInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPolicyStoreInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIGetPolicyStoreInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIGetPolicyStoreInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIGetPolicyStoreInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

bool OAIGetPolicyStoreInput::isSet() const {
...
bool OAIGetPolicyStoreInput::isValid() const {
