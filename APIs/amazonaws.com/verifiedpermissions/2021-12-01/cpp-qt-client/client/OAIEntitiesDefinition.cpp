...
#include "OAIEntitiesDefinition.h"
...
OAIEntitiesDefinition::OAIEntitiesDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntitiesDefinition::OAIEntitiesDefinition() {
    this->initializeModel();
}

OAIEntitiesDefinition::~OAIEntitiesDefinition() {}

void OAIEntitiesDefinition::initializeModel() {

    m_entity_list_isSet = false;
    m_entity_list_isValid = false;
}

void OAIEntitiesDefinition::fromJson(QString jsonString) {
...
void OAIEntitiesDefinition::fromJsonObject(QJsonObject json) {
...
QString OAIEntitiesDefinition::asJson() const {
...
QJsonObject OAIEntitiesDefinition::asJsonObject() const {
    QJsonObject obj;
...
QList OAIEntitiesDefinition::getEntityList() const {
    return m_entity_list;
}
void OAIEntitiesDefinition::setEntityList(const QList &entity_list) {
    m_entity_list = entity_list;
    m_entity_list_isSet = true;
}

bool OAIEntitiesDefinition::is_entity_list_Set() const{
    return m_entity_list_isSet;
}

bool OAIEntitiesDefinition::is_entity_list_Valid() const{
    return m_entity_list_isValid;
}

bool OAIEntitiesDefinition::isSet() const {
...
bool OAIEntitiesDefinition::isValid() const {
