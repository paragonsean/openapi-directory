...
OAIGetPolicyTemplateInput::OAIGetPolicyTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyTemplateInput::OAIGetPolicyTemplateInput() {
    this->initializeModel();
}

OAIGetPolicyTemplateInput::~OAIGetPolicyTemplateInput() {}

void OAIGetPolicyTemplateInput::initializeModel() {
...
void OAIGetPolicyTemplateInput::fromJson(QString jsonString) {
...
void OAIGetPolicyTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPolicyTemplateInput::asJson() const {
...
QJsonObject OAIGetPolicyTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPolicyTemplateInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIGetPolicyTemplateInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIGetPolicyTemplateInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIGetPolicyTemplateInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIGetPolicyTemplateInput::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIGetPolicyTemplateInput::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIGetPolicyTemplateInput::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIGetPolicyTemplateInput::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

bool OAIGetPolicyTemplateInput::isSet() const {
...
bool OAIGetPolicyTemplateInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_policy_template_id_isValid && true;
}
