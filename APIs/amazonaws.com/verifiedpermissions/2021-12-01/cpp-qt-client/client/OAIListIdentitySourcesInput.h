...
/*
 * OAIListIdentitySourcesInput.h
 *
 * 
 */

#ifndef OAIListIdentitySourcesInput_H
#define OAIListIdentitySourcesInput_H
...
class OAIListIdentitySourcesInput : public OAIObject {
public:
    OAIListIdentitySourcesInput();
    OAIListIdentitySourcesInput(QString json);
    ~OAIListIdentitySourcesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListIdentitySourcesInput)

#endif // OAIListIdentitySourcesInput_H
