...
#ifndef OAIPolicyDefinitionItem_H
#define OAIPolicyDefinitionItem_H
...
class OAIPolicyDefinitionItem : public OAIObject {
public:
    OAIPolicyDefinitionItem();
    OAIPolicyDefinitionItem(QString json);
    ~OAIPolicyDefinitionItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinitionItem)

#endif // OAIPolicyDefinitionItem_H
