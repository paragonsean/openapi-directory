...
/*
 * OAICreateIdentitySourceInput_configuration.h
 *
 * 
 */

#ifndef OAICreateIdentitySourceInput_configuration_H
#define OAICreateIdentitySourceInput_configuration_H
...
namespace OpenAPI {
class OAIConfiguration_cognitoUserPoolConfiguration;

class OAICreateIdentitySourceInput_configuration : public OAIObject {
public:
    OAICreateIdentitySourceInput_configuration();
    OAICreateIdentitySourceInput_configuration(QString json);
    ~OAICreateIdentitySourceInput_configuration() override;
    ...
    OAIConfiguration_cognitoUserPoolConfiguration getCognitoUserPoolConfiguration() const;
    void setCognitoUserPoolConfiguration(const OAIConfiguration_cognitoUserPoolConfiguration &cognito_user_pool_configuration);
...
private:
    ...
    OAIConfiguration_cognitoUserPoolConfiguration m_cognito_user_pool_configuration;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIdentitySourceInput_configuration)

#endif // OAICreateIdentitySourceInput_configuration_H
