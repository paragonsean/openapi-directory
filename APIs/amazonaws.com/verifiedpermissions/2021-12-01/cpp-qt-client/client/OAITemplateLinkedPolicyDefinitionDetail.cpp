...
#include "OAITemplateLinkedPolicyDefinitionDetail.h"
...
OAITemplateLinkedPolicyDefinitionDetail::OAITemplateLinkedPolicyDefinitionDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateLinkedPolicyDefinitionDetail::OAITemplateLinkedPolicyDefinitionDetail() {
    this->initializeModel();
}

OAITemplateLinkedPolicyDefinitionDetail::~OAITemplateLinkedPolicyDefinitionDetail() {}

void OAITemplateLinkedPolicyDefinitionDetail::initializeModel() {
...
void OAITemplateLinkedPolicyDefinitionDetail::fromJson(QString jsonString) {
...
void OAITemplateLinkedPolicyDefinitionDetail::fromJsonObject(QJsonObject json) {
...
QString OAITemplateLinkedPolicyDefinitionDetail::asJson() const {
...
QJsonObject OAITemplateLinkedPolicyDefinitionDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAITemplateLinkedPolicyDefinitionDetail::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAITemplateLinkedPolicyDefinitionDetail::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAITemplateLinkedPolicyDefinitionDetail::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAITemplateLinkedPolicyDefinitionDetail::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

OAITemplateLinkedPolicyDefinition_principal OAITemplateLinkedPolicyDefinitionDetail::getPrincipal() const {
    return m_principal;
}
void OAITemplateLinkedPolicyDefinitionDetail::setPrincipal(const OAITemplateLinkedPolicyDefinition_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAITemplateLinkedPolicyDefinitionDetail::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAITemplateLinkedPolicyDefinitionDetail::is_principal_Valid() const{
    return m_principal_isValid;
}

OAITemplateLinkedPolicyDefinition_resource OAITemplateLinkedPolicyDefinitionDetail::getResource() const {
    return m_resource;
}
void OAITemplateLinkedPolicyDefinitionDetail::setResource(const OAITemplateLinkedPolicyDefinition_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAITemplateLinkedPolicyDefinitionDetail::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAITemplateLinkedPolicyDefinitionDetail::is_resource_Valid() const{
    return m_resource_isValid;
}

bool OAITemplateLinkedPolicyDefinitionDetail::isSet() const {
...
bool OAITemplateLinkedPolicyDefinitionDetail::isValid() const {
