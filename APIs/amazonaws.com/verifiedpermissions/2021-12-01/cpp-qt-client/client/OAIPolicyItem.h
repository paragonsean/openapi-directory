...
#ifndef OAIPolicyItem_H
#define OAIPolicyItem_H

#include <QJsonObject>

#include "OAIPolicyItem_definition.h"
#include "OAIPolicyItem_principal.h"
#include "OAIPolicyItem_resource.h"
...
namespace OpenAPI {
class OAIPolicyItem_principal;
class OAIPolicyItem_resource;
class OAIPolicyItem_definition;

class OAIPolicyItem : public OAIObject {
public:
    OAIPolicyItem();
    OAIPolicyItem(QString json);
    ~OAIPolicyItem() override;
    ...
    OAIPolicyItem_principal getPrincipal() const;
    void setPrincipal(const OAIPolicyItem_principal &principal);
    bool is_principal_Set() const;
    bool is_principal_Valid() const;

    OAIPolicyItem_resource getResource() const;
    void setResource(const OAIPolicyItem_resource &resource);
    bool is_resource_Set() const;
    bool is_resource_Valid() const;

    OAIPolicyItem_definition getDefinition() const;
    void setDefinition(const OAIPolicyItem_definition &definition);
...
private:
    ...
    OAIPolicyItem_principal m_principal;
    bool m_principal_isSet;
    bool m_principal_isValid;

    OAIPolicyItem_resource m_resource;
    bool m_resource_isSet;
    bool m_resource_isValid;

    OAIPolicyItem_definition m_definition;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyItem)

#endif // OAIPolicyItem_H
