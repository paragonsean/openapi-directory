...
#ifndef OAIValidationSettings_H
#define OAIValidationSettings_H
...
class OAIValidationSettings : public OAIObject {
public:
    OAIValidationSettings();
    OAIValidationSettings(QString json);
    ~OAIValidationSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIValidationSettings)

#endif // OAIValidationSettings_H
