...
#include "OAIPolicyTemplateItem.h"
...
OAIPolicyTemplateItem::OAIPolicyTemplateItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyTemplateItem::OAIPolicyTemplateItem() {
    this->initializeModel();
}

OAIPolicyTemplateItem::~OAIPolicyTemplateItem() {}

void OAIPolicyTemplateItem::initializeModel() {
...
void OAIPolicyTemplateItem::fromJson(QString jsonString) {
...
void OAIPolicyTemplateItem::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyTemplateItem::asJson() const {
...
QJsonObject OAIPolicyTemplateItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyTemplateItem::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIPolicyTemplateItem::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIPolicyTemplateItem::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIPolicyTemplateItem::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIPolicyTemplateItem::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIPolicyTemplateItem::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIPolicyTemplateItem::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIPolicyTemplateItem::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

QString OAIPolicyTemplateItem::getDescription() const {
    return m_description;
}
void OAIPolicyTemplateItem::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPolicyTemplateItem::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPolicyTemplateItem::is_description_Valid() const{
    return m_description_isValid;
}

QDateTime OAIPolicyTemplateItem::getCreatedDate() const {
    return m_created_date;
}
void OAIPolicyTemplateItem::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIPolicyTemplateItem::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIPolicyTemplateItem::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAIPolicyTemplateItem::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIPolicyTemplateItem::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIPolicyTemplateItem::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIPolicyTemplateItem::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAIPolicyTemplateItem::isSet() const {
...
bool OAIPolicyTemplateItem::isValid() const {
