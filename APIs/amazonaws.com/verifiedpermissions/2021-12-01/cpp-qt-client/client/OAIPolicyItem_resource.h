...
/*
 * OAIPolicyItem_resource.h
 *
 * 
 */

#ifndef OAIPolicyItem_resource_H
#define OAIPolicyItem_resource_H
...
class OAIPolicyItem_resource : public OAIObject {
public:
    OAIPolicyItem_resource();
    OAIPolicyItem_resource(QString json);
    ~OAIPolicyItem_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyItem_resource)

#endif // OAIPolicyItem_resource_H
