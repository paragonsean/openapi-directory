...
/*
 * OAIGetPolicyTemplateInput.h
 *
 * 
 */

#ifndef OAIGetPolicyTemplateInput_H
#define OAIGetPolicyTemplateInput_H
...
class OAIGetPolicyTemplateInput : public OAIObject {
public:
    OAIGetPolicyTemplateInput();
    OAIGetPolicyTemplateInput(QString json);
    ~OAIGetPolicyTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyTemplateInput)

#endif // OAIGetPolicyTemplateInput_H
