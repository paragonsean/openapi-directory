...
/*
 * OAIEntityReference_identifier.h
 *
 * 
 */

#ifndef OAIEntityReference_identifier_H
#define OAIEntityReference_identifier_H
...
class OAIEntityReference_identifier : public OAIObject {
public:
    OAIEntityReference_identifier();
    OAIEntityReference_identifier(QString json);
    ~OAIEntityReference_identifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityReference_identifier)

#endif // OAIEntityReference_identifier_H
