...
/*
 * OAITemplateLinkedPolicyDefinitionDetail.h
 *
 * &lt;p&gt;Contains information about a policy that was &lt;/p&gt; &lt;p/&gt; &lt;p&gt;created by instantiating a policy template. &lt;/p&gt; &lt;p&gt;This &lt;/p&gt;
 */

#ifndef OAITemplateLinkedPolicyDefinitionDetail_H
#define OAITemplateLinkedPolicyDefinitionDetail_H
...
class OAITemplateLinkedPolicyDefinitionDetail : public OAIObject {
public:
    OAITemplateLinkedPolicyDefinitionDetail();
    OAITemplateLinkedPolicyDefinitionDetail(QString json);
    ~OAITemplateLinkedPolicyDefinitionDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateLinkedPolicyDefinitionDetail)

#endif // OAITemplateLinkedPolicyDefinitionDetail_H
