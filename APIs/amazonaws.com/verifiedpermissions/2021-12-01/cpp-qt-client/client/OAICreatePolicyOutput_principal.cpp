...
#include "OAICreatePolicyOutput_principal.h"
...
OAICreatePolicyOutput_principal::OAICreatePolicyOutput_principal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyOutput_principal::OAICreatePolicyOutput_principal() {
    this->initializeModel();
}

OAICreatePolicyOutput_principal::~OAICreatePolicyOutput_principal() {}

void OAICreatePolicyOutput_principal::initializeModel() {
...
void OAICreatePolicyOutput_principal::fromJson(QString jsonString) {
...
void OAICreatePolicyOutput_principal::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyOutput_principal::asJson() const {
...
QJsonObject OAICreatePolicyOutput_principal::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePolicyOutput_principal::getEntityType() const {
    return m_entity_type;
}
void OAICreatePolicyOutput_principal::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAICreatePolicyOutput_principal::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAICreatePolicyOutput_principal::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAICreatePolicyOutput_principal::getEntityId() const {
    return m_entity_id;
}
void OAICreatePolicyOutput_principal::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAICreatePolicyOutput_principal::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAICreatePolicyOutput_principal::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAICreatePolicyOutput_principal::isSet() const {
...
bool OAICreatePolicyOutput_principal::isValid() const {
