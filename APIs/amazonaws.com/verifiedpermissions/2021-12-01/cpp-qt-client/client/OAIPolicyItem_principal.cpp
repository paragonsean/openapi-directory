...
OAIPolicyItem_principal::OAIPolicyItem_principal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyItem_principal::OAIPolicyItem_principal() {
    this->initializeModel();
}

OAIPolicyItem_principal::~OAIPolicyItem_principal() {}

void OAIPolicyItem_principal::initializeModel() {
...
void OAIPolicyItem_principal::fromJson(QString jsonString) {
...
void OAIPolicyItem_principal::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyItem_principal::asJson() const {
...
QJsonObject OAIPolicyItem_principal::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyItem_principal::getEntityType() const {
    return m_entity_type;
}
void OAIPolicyItem_principal::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIPolicyItem_principal::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIPolicyItem_principal::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIPolicyItem_principal::getEntityId() const {
    return m_entity_id;
}
void OAIPolicyItem_principal::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIPolicyItem_principal::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIPolicyItem_principal::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIPolicyItem_principal::isSet() const {
...
bool OAIPolicyItem_principal::isValid() const {
