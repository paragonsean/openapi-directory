...
OAIUpdatePolicyStoreInput::OAIUpdatePolicyStoreInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyStoreInput::OAIUpdatePolicyStoreInput() {
    this->initializeModel();
}

OAIUpdatePolicyStoreInput::~OAIUpdatePolicyStoreInput() {}

void OAIUpdatePolicyStoreInput::initializeModel() {
...
void OAIUpdatePolicyStoreInput::fromJson(QString jsonString) {
...
void OAIUpdatePolicyStoreInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyStoreInput::asJson() const {
...
QJsonObject OAIUpdatePolicyStoreInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePolicyStoreInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIUpdatePolicyStoreInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIUpdatePolicyStoreInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIUpdatePolicyStoreInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

OAIUpdatePolicyStoreInput_validationSettings OAIUpdatePolicyStoreInput::getValidationSettings() const {
    return m_validation_settings;
}
void OAIUpdatePolicyStoreInput::setValidationSettings(const OAIUpdatePolicyStoreInput_validationSettings &validation_settings) {
    m_validation_settings = validation_settings;
    m_validation_settings_isSet = true;
}

bool OAIUpdatePolicyStoreInput::is_validation_settings_Set() const{
    return m_validation_settings_isSet;
}

bool OAIUpdatePolicyStoreInput::is_validation_settings_Valid() const{
    return m_validation_settings_isValid;
}

bool OAIUpdatePolicyStoreInput::isSet() const {
...
bool OAIUpdatePolicyStoreInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_validation_settings_isValid && true;
}
