...
#include "OAIUpdateConfiguration_cognitoUserPoolConfiguration.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUpdateConfiguration_cognitoUserPoolConfiguration;
...
public:
    ...
    OAIUpdateConfiguration_cognitoUserPoolConfiguration getCognitoUserPoolConfiguration() const;
    void setCognitoUserPoolConfiguration(const OAIUpdateConfiguration_cognitoUserPoolConfiguration &cognito_user_pool_configuration);
    bool is_cognito_user_pool_configuration_Set() const;
    bool is_cognito_user_pool_configuration_Valid() const;
...
private:
    ...
    OAIUpdateConfiguration_cognitoUserPoolConfiguration m_cognito_user_pool_configuration;
    bool m_cognito_user_pool_configuration_isSet;
    bool m_cognito_user_pool_configuration_isValid;
};
