...
#include "OAIGetPolicyOutput_resource.h"
...
OAIGetPolicyOutput_resource::OAIGetPolicyOutput_resource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyOutput_resource::OAIGetPolicyOutput_resource() {
    this->initializeModel();
}

OAIGetPolicyOutput_resource::~OAIGetPolicyOutput_resource() {}

void OAIGetPolicyOutput_resource::initializeModel() {
...
void OAIGetPolicyOutput_resource::fromJson(QString jsonString) {
...
void OAIGetPolicyOutput_resource::fromJsonObject(QJsonObject json) {
...
QString OAIGetPolicyOutput_resource::asJson() const {
...
QJsonObject OAIGetPolicyOutput_resource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPolicyOutput_resource::getEntityType() const {
    return m_entity_type;
}
void OAIGetPolicyOutput_resource::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIGetPolicyOutput_resource::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIGetPolicyOutput_resource::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIGetPolicyOutput_resource::getEntityId() const {
    return m_entity_id;
}
void OAIGetPolicyOutput_resource::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIGetPolicyOutput_resource::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIGetPolicyOutput_resource::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIGetPolicyOutput_resource::isSet() const {
...
bool OAIGetPolicyOutput_resource::isValid() const {
