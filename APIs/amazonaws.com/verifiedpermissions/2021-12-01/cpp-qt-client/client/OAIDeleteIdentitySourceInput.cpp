...
OAIDeleteIdentitySourceInput::OAIDeleteIdentitySourceInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteIdentitySourceInput::OAIDeleteIdentitySourceInput() {
    this->initializeModel();
}

OAIDeleteIdentitySourceInput::~OAIDeleteIdentitySourceInput() {}

void OAIDeleteIdentitySourceInput::initializeModel() {
...
void OAIDeleteIdentitySourceInput::fromJson(QString jsonString) {
...
void OAIDeleteIdentitySourceInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteIdentitySourceInput::asJson() const {
...
QJsonObject OAIDeleteIdentitySourceInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteIdentitySourceInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIDeleteIdentitySourceInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIDeleteIdentitySourceInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIDeleteIdentitySourceInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIDeleteIdentitySourceInput::getIdentitySourceId() const {
    return m_identity_source_id;
}
void OAIDeleteIdentitySourceInput::setIdentitySourceId(const QString &identity_source_id) {
    m_identity_source_id = identity_source_id;
    m_identity_source_id_isSet = true;
}

bool OAIDeleteIdentitySourceInput::is_identity_source_id_Set() const{
    return m_identity_source_id_isSet;
}

bool OAIDeleteIdentitySourceInput::is_identity_source_id_Valid() const{
    return m_identity_source_id_isValid;
}

bool OAIDeleteIdentitySourceInput::isSet() const {
...
bool OAIDeleteIdentitySourceInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_identity_source_id_isValid && true;
}
