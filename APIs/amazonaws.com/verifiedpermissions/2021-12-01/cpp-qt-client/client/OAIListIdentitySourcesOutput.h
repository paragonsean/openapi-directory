...
/*
 * OAIListIdentitySourcesOutput.h
 *
 * 
 */

#ifndef OAIListIdentitySourcesOutput_H
#define OAIListIdentitySourcesOutput_H
...
class OAIListIdentitySourcesOutput : public OAIObject {
public:
    OAIListIdentitySourcesOutput();
    OAIListIdentitySourcesOutput(QString json);
    ~OAIListIdentitySourcesOutput() override;
    ...
    QList getIdentitySources() const;
    void setIdentitySources(const QList &identity_sources);
    bool is_identity_sources_Set() const;
    bool is_identity_sources_Valid() const;
...
private:
    ...
    QList m_identity_sources;
    bool m_identity_sources_isSet;
    bool m_identity_sources_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListIdentitySourcesOutput)

#endif // OAIListIdentitySourcesOutput_H
