...
/*
 * OAIGetPolicyTemplateOutput.h
 *
 * 
 */

#ifndef OAIGetPolicyTemplateOutput_H
#define OAIGetPolicyTemplateOutput_H
...
class OAIGetPolicyTemplateOutput : public OAIObject {
public:
    OAIGetPolicyTemplateOutput();
    OAIGetPolicyTemplateOutput(QString json);
    ~OAIGetPolicyTemplateOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyTemplateOutput)

#endif // OAIGetPolicyTemplateOutput_H
