...
/*
 * OAIUpdatePolicyStoreInput_validationSettings.h
 *
 * 
 */

#ifndef OAIUpdatePolicyStoreInput_validationSettings_H
#define OAIUpdatePolicyStoreInput_validationSettings_H
...
class OAIUpdatePolicyStoreInput_validationSettings : public OAIObject {
public:
    OAIUpdatePolicyStoreInput_validationSettings();
    OAIUpdatePolicyStoreInput_validationSettings(QString json);
    ~OAIUpdatePolicyStoreInput_validationSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyStoreInput_validationSettings)

#endif // OAIUpdatePolicyStoreInput_validationSettings_H
