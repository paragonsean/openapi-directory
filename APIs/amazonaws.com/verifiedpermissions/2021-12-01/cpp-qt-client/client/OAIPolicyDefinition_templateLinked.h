...
/*
 * OAIPolicyDefinition_templateLinked.h
 *
 * 
 */

#ifndef OAIPolicyDefinition_templateLinked_H
#define OAIPolicyDefinition_templateLinked_H
...
class OAIPolicyDefinition_templateLinked : public OAIObject {
public:
    OAIPolicyDefinition_templateLinked();
    OAIPolicyDefinition_templateLinked(QString json);
    ~OAIPolicyDefinition_templateLinked() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinition_templateLinked)

#endif // OAIPolicyDefinition_templateLinked_H
