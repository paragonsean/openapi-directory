...
/*
 * OAITemplateLinkedPolicyDefinitionItem.h
 *
 * &lt;p&gt;Contains information about a policy created by instantiating a policy template. &lt;/p&gt; &lt;p&gt;This &lt;/p&gt;
 */

#ifndef OAITemplateLinkedPolicyDefinitionItem_H
#define OAITemplateLinkedPolicyDefinitionItem_H

#include <QJsonObject>

#include "OAITemplateLinkedPolicyDefinition_principal.h"
#include "OAITemplateLinkedPolicyDefinition_resource.h"
#include <QString>
...
namespace OpenAPI {
class OAITemplateLinkedPolicyDefinition_principal;
class OAITemplateLinkedPolicyDefinition_resource;

class OAITemplateLinkedPolicyDefinitionItem : public OAIObject {
public:
    OAITemplateLinkedPolicyDefinitionItem();
    OAITemplateLinkedPolicyDefinitionItem(QString json);
    ~OAITemplateLinkedPolicyDefinitionItem() override;
    ...
    QString getPolicyTemplateId() const;
    void setPolicyTemplateId(const QString &policy_template_id);
    bool is_policy_template_id_Set() const;
    bool is_policy_template_id_Valid() const;

    OAITemplateLinkedPolicyDefinition_principal getPrincipal() const;
    void setPrincipal(const OAITemplateLinkedPolicyDefinition_principal &principal);
    bool is_principal_Set() const;
    bool is_principal_Valid() const;

    OAITemplateLinkedPolicyDefinition_resource getResource() const;
    void setResource(const OAITemplateLinkedPolicyDefinition_resource &resource);
...
private:
    ...
    QString m_policy_template_id;
    bool m_policy_template_id_isSet;
    bool m_policy_template_id_isValid;

    OAITemplateLinkedPolicyDefinition_principal m_principal;
    bool m_principal_isSet;
    bool m_principal_isValid;

    OAITemplateLinkedPolicyDefinition_resource m_resource;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateLinkedPolicyDefinitionItem)

#endif // OAITemplateLinkedPolicyDefinitionItem_H
