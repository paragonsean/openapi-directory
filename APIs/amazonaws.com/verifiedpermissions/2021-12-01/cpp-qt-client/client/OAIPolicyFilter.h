...
#ifndef OAIPolicyFilter_H
#define OAIPolicyFilter_H
...
class OAIPolicyFilter : public OAIObject {
public:
    OAIPolicyFilter();
    OAIPolicyFilter(QString json);
    ~OAIPolicyFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyFilter)

#endif // OAIPolicyFilter_H
