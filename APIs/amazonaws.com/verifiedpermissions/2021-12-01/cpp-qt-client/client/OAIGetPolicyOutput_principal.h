...
/*
 * OAIGetPolicyOutput_principal.h
 *
 * 
 */

#ifndef OAIGetPolicyOutput_principal_H
#define OAIGetPolicyOutput_principal_H
...
class OAIGetPolicyOutput_principal : public OAIObject {
public:
    OAIGetPolicyOutput_principal();
    OAIGetPolicyOutput_principal(QString json);
    ~OAIGetPolicyOutput_principal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyOutput_principal)

#endif // OAIGetPolicyOutput_principal_H
