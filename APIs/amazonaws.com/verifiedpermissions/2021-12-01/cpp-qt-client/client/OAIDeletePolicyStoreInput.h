...
/*
 * OAIDeletePolicyStoreInput.h
 *
 * 
 */

#ifndef OAIDeletePolicyStoreInput_H
#define OAIDeletePolicyStoreInput_H
...
class OAIDeletePolicyStoreInput : public OAIObject {
public:
    OAIDeletePolicyStoreInput();
    OAIDeletePolicyStoreInput(QString json);
    ~OAIDeletePolicyStoreInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePolicyStoreInput)

#endif // OAIDeletePolicyStoreInput_H
