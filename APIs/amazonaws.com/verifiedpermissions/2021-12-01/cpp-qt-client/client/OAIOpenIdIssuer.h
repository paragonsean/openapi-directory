...
#ifndef OAIOpenIdIssuer_H
#define OAIOpenIdIssuer_H
...
class OAIOpenIdIssuer : public OAIEnum {
public:
    OAIOpenIdIssuer();
    OAIOpenIdIssuer(QString json);
    ~OAIOpenIdIssuer() override;
    ...
    enum class eOAIOpenIdIssuer {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        COGNITO
    };
    OAIOpenIdIssuer::eOAIOpenIdIssuer getValue() const;
    void setValue(const OAIOpenIdIssuer::eOAIOpenIdIssuer& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIOpenIdIssuer)

#endif // OAIOpenIdIssuer_H
