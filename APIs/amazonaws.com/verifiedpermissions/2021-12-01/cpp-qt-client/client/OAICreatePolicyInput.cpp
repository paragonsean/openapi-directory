...
QString OAICreatePolicyInput::getClientToken() const {
    return m_client_token;
}
void OAICreatePolicyInput::setClientToken(const QString &client_token) {
    m_client_token = client_token;
    m_client_token_isSet = true;
}

bool OAICreatePolicyInput::is_client_token_Set() const{
    return m_client_token_isSet;
}

bool OAICreatePolicyInput::is_client_token_Valid() const{
    return m_client_token_isValid;
}

QString OAICreatePolicyInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAICreatePolicyInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAICreatePolicyInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAICreatePolicyInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

OAICreatePolicyInput_definition OAICreatePolicyInput::getDefinition() const {
    return m_definition;
}
void OAICreatePolicyInput::setDefinition(const OAICreatePolicyInput_definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAICreatePolicyInput::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAICreatePolicyInput::is_definition_Valid() const{
...
bool OAICreatePolicyInput::isValid() const {
    ...
    return m_policy_store_id_isValid && m_definition_isValid && true;
}
