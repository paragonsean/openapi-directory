...
/*
 * OAICreatePolicyStoreInput.h
 *
 * 
 */

#ifndef OAICreatePolicyStoreInput_H
#define OAICreatePolicyStoreInput_H

#include <QJsonObject>

#include "OAICreatePolicyStoreInput_validationSettings.h"
#include <QString>
...
namespace OpenAPI {
class OAICreatePolicyStoreInput_validationSettings;

class OAICreatePolicyStoreInput : public OAIObject {
public:
    OAICreatePolicyStoreInput();
    OAICreatePolicyStoreInput(QString json);
    ~OAICreatePolicyStoreInput() override;
    ...
    OAICreatePolicyStoreInput_validationSettings getValidationSettings() const;
    void setValidationSettings(const OAICreatePolicyStoreInput_validationSettings &validation_settings);
...
private:
    ...
    OAICreatePolicyStoreInput_validationSettings m_validation_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyStoreInput)

#endif // OAICreatePolicyStoreInput_H
