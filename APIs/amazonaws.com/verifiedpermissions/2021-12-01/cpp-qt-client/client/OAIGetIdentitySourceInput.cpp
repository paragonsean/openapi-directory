...
OAIGetIdentitySourceInput::OAIGetIdentitySourceInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetIdentitySourceInput::OAIGetIdentitySourceInput() {
    this->initializeModel();
}

OAIGetIdentitySourceInput::~OAIGetIdentitySourceInput() {}

void OAIGetIdentitySourceInput::initializeModel() {
...
void OAIGetIdentitySourceInput::fromJson(QString jsonString) {
...
void OAIGetIdentitySourceInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetIdentitySourceInput::asJson() const {
...
QJsonObject OAIGetIdentitySourceInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetIdentitySourceInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIGetIdentitySourceInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIGetIdentitySourceInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIGetIdentitySourceInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIGetIdentitySourceInput::getIdentitySourceId() const {
    return m_identity_source_id;
}
void OAIGetIdentitySourceInput::setIdentitySourceId(const QString &identity_source_id) {
    m_identity_source_id = identity_source_id;
    m_identity_source_id_isSet = true;
}

bool OAIGetIdentitySourceInput::is_identity_source_id_Set() const{
    return m_identity_source_id_isSet;
}

bool OAIGetIdentitySourceInput::is_identity_source_id_Valid() const{
    return m_identity_source_id_isValid;
}

bool OAIGetIdentitySourceInput::isSet() const {
...
bool OAIGetIdentitySourceInput::isValid() const {
