...
/*
 * OAIListPolicyStoresInput.h
 *
 * 
 */

#ifndef OAIListPolicyStoresInput_H
#define OAIListPolicyStoresInput_H
...
class OAIListPolicyStoresInput : public OAIObject {
public:
    OAIListPolicyStoresInput();
    OAIListPolicyStoresInput(QString json);
    ~OAIListPolicyStoresInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPolicyStoresInput)

#endif // OAIListPolicyStoresInput_H
