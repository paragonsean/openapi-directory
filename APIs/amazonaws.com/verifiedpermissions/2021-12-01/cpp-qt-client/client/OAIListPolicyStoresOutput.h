...
/*
 * OAIListPolicyStoresOutput.h
 *
 * 
 */

#ifndef OAIListPolicyStoresOutput_H
#define OAIListPolicyStoresOutput_H
...
class OAIListPolicyStoresOutput : public OAIObject {
public:
    OAIListPolicyStoresOutput();
    OAIListPolicyStoresOutput(QString json);
    ~OAIListPolicyStoresOutput() override;
    ...
    QList getPolicyStores() const;
    void setPolicyStores(const QList &policy_stores);
    bool is_policy_stores_Set() const;
    bool is_policy_stores_Valid() const;
...
private:
    ...
    QList m_policy_stores;
    bool m_policy_stores_isSet;
    bool m_policy_stores_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListPolicyStoresOutput)

#endif // OAIListPolicyStoresOutput_H
