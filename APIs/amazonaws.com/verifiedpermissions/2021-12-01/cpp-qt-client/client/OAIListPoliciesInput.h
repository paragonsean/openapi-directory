...
/*
 * OAIListPoliciesInput.h
 *
 * 
 */

#ifndef OAIListPoliciesInput_H
#define OAIListPoliciesInput_H

#include <QJsonObject>

#include "OAIListPoliciesInput_filter.h"
#include <QString>
...
namespace OpenAPI {
class OAIListPoliciesInput_filter;

class OAIListPoliciesInput : public OAIObject {
public:
    OAIListPoliciesInput();
    OAIListPoliciesInput(QString json);
    ~OAIListPoliciesInput() override;
    ...
    OAIListPoliciesInput_filter getFilter() const;
    void setFilter(const OAIListPoliciesInput_filter &filter);
...
private:
    ...
    OAIListPoliciesInput_filter m_filter;
    bool m_filter_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPoliciesInput)

#endif // OAIListPoliciesInput_H
