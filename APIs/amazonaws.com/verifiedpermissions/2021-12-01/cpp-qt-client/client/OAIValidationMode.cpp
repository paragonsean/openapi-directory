...
OAIValidationMode::OAIValidationMode(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValidationMode::OAIValidationMode() {
    this->initializeModel();
}

OAIValidationMode::~OAIValidationMode() {}

void OAIValidationMode::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIValidationMode::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIValidationMode::fromJson(QString jsonString) {
    
    if ( jsonString.compare("OFF", Qt::CaseInsensitive) == 0) {
        m_value = eOAIValidationMode::OFF;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STRICT", Qt::CaseInsensitive) == 0) {
        m_value = eOAIValidationMode::STRICT;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIValidationMode::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIValidationMode::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIValidationMode::OFF:
            val = "OFF";
            break;
        case eOAIValidationMode::STRICT:
            val = "STRICT";
            break;
        default:
            break;
...
QJsonValue OAIValidationMode::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIValidationMode::eOAIValidationMode OAIValidationMode::getValue() const {
    return m_value;
}

void OAIValidationMode::setValue(const OAIValidationMode::eOAIValidationMode& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIValidationMode::isSet() const {
    
    return m_value_isSet;
}

bool OAIValidationMode::isValid() const {
