...
/*
 * OAIDeletePolicyTemplateInput.h
 *
 * 
 */

#ifndef OAIDeletePolicyTemplateInput_H
#define OAIDeletePolicyTemplateInput_H
...
class OAIDeletePolicyTemplateInput : public OAIObject {
public:
    OAIDeletePolicyTemplateInput();
    OAIDeletePolicyTemplateInput(QString json);
    ~OAIDeletePolicyTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeletePolicyTemplateInput)

#endif // OAIDeletePolicyTemplateInput_H
