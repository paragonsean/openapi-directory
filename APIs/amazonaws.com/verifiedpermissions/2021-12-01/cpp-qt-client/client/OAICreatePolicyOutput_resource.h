...
/*
 * OAICreatePolicyOutput_resource.h
 *
 * 
 */

#ifndef OAICreatePolicyOutput_resource_H
#define OAICreatePolicyOutput_resource_H
...
class OAICreatePolicyOutput_resource : public OAIObject {
public:
    OAICreatePolicyOutput_resource();
    OAICreatePolicyOutput_resource(QString json);
    ~OAICreatePolicyOutput_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyOutput_resource)

#endif // OAICreatePolicyOutput_resource_H
