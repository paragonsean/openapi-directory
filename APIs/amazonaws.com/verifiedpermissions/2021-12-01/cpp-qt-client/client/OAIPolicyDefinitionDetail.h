...
#ifndef OAIPolicyDefinitionDetail_H
#define OAIPolicyDefinitionDetail_H
...
class OAIPolicyDefinitionDetail : public OAIObject {
public:
    OAIPolicyDefinitionDetail();
    OAIPolicyDefinitionDetail(QString json);
    ~OAIPolicyDefinitionDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinitionDetail)

#endif // OAIPolicyDefinitionDetail_H
