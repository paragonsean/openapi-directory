...
#include "OAIGetPolicyStoreOutput_validationSettings.h"
...
OAIGetPolicyStoreOutput_validationSettings::OAIGetPolicyStoreOutput_validationSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyStoreOutput_validationSettings::OAIGetPolicyStoreOutput_validationSettings() {
    this->initializeModel();
}

OAIGetPolicyStoreOutput_validationSettings::~OAIGetPolicyStoreOutput_validationSettings() {}

void OAIGetPolicyStoreOutput_validationSettings::initializeModel() {

    m_mode_isSet = false;
    m_mode_isValid = false;
}

void OAIGetPolicyStoreOutput_validationSettings::fromJson(QString jsonString) {
...
void OAIGetPolicyStoreOutput_validationSettings::fromJsonObject(QJsonObject json) {

    m_mode_isValid = ::OpenAPI::fromJsonValue(m_mode, json[QString("mode")]);
    m_mode_isSet = !json[QString("mode")].isNull() && m_mode_isValid;
}

QString OAIGetPolicyStoreOutput_validationSettings::asJson() const {
...
QJsonObject OAIGetPolicyStoreOutput_validationSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_mode.isSet()) {
...
OAIValidationMode OAIGetPolicyStoreOutput_validationSettings::getMode() const {
    return m_mode;
}
void OAIGetPolicyStoreOutput_validationSettings::setMode(const OAIValidationMode &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIGetPolicyStoreOutput_validationSettings::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIGetPolicyStoreOutput_validationSettings::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIGetPolicyStoreOutput_validationSettings::isSet() const {
...
bool OAIGetPolicyStoreOutput_validationSettings::isValid() const {
