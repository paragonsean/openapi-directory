...
#ifndef OAIEntityIdentifier_H
#define OAIEntityIdentifier_H
...
class OAIEntityIdentifier : public OAIObject {
public:
    OAIEntityIdentifier();
    OAIEntityIdentifier(QString json);
    ~OAIEntityIdentifier() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityIdentifier)

#endif // OAIEntityIdentifier_H
