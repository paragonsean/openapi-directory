...
OAIPolicyFilter_resource::OAIPolicyFilter_resource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyFilter_resource::OAIPolicyFilter_resource() {
    this->initializeModel();
}

OAIPolicyFilter_resource::~OAIPolicyFilter_resource() {}

void OAIPolicyFilter_resource::initializeModel() {
...
void OAIPolicyFilter_resource::fromJson(QString jsonString) {
...
void OAIPolicyFilter_resource::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyFilter_resource::asJson() const {
...
QJsonObject OAIPolicyFilter_resource::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPolicyFilter_resource::getUnspecified() const {
    return m_unspecified;
}
void OAIPolicyFilter_resource::setUnspecified(const bool &unspecified) {
    m_unspecified = unspecified;
    m_unspecified_isSet = true;
}

bool OAIPolicyFilter_resource::is_unspecified_Set() const{
    return m_unspecified_isSet;
}

bool OAIPolicyFilter_resource::is_unspecified_Valid() const{
    return m_unspecified_isValid;
}

OAIEntityReference_identifier OAIPolicyFilter_resource::getIdentifier() const {
    return m_identifier;
}
void OAIPolicyFilter_resource::setIdentifier(const OAIEntityReference_identifier &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIPolicyFilter_resource::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIPolicyFilter_resource::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIPolicyFilter_resource::isSet() const {
...
bool OAIPolicyFilter_resource::isValid() const {
