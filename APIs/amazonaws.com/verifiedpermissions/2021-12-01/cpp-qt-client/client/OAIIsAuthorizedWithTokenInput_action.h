...
/*
 * OAIIsAuthorizedWithTokenInput_action.h
 *
 * 
 */

#ifndef OAIIsAuthorizedWithTokenInput_action_H
#define OAIIsAuthorizedWithTokenInput_action_H
...
class OAIIsAuthorizedWithTokenInput_action : public OAIObject {
public:
    OAIIsAuthorizedWithTokenInput_action();
    OAIIsAuthorizedWithTokenInput_action(QString json);
    ~OAIIsAuthorizedWithTokenInput_action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedWithTokenInput_action)

#endif // OAIIsAuthorizedWithTokenInput_action_H
