...
/*
 * OAIIsAuthorizedInput.h
 *
 * 
 */

#ifndef OAIIsAuthorizedInput_H
#define OAIIsAuthorizedInput_H
...
#include "OAIIsAuthorizedInput_principal.h"
#include "OAIIsAuthorizedInput_resource.h"
#include <QString>
...
namespace OpenAPI {
class OAIIsAuthorizedInput_principal;
class OAIIsAuthorizedInput_action;
class OAIIsAuthorizedInput_resource;
class OAIIsAuthorizedInput_context;
class OAIIsAuthorizedInput_entities;

class OAIIsAuthorizedInput : public OAIObject {
public:
    OAIIsAuthorizedInput();
    OAIIsAuthorizedInput(QString json);
    ~OAIIsAuthorizedInput() override;
    ...
    OAIIsAuthorizedInput_principal getPrincipal() const;
    void setPrincipal(const OAIIsAuthorizedInput_principal &principal);
    bool is_principal_Set() const;
    bool is_principal_Valid() const;

    OAIIsAuthorizedInput_action getAction() const;
    void setAction(const OAIIsAuthorizedInput_action &action);
    bool is_action_Set() const;
    bool is_action_Valid() const;

    OAIIsAuthorizedInput_resource getResource() const;
    void setResource(const OAIIsAuthorizedInput_resource &resource);
...
private:
    ...
    OAIIsAuthorizedInput_principal m_principal;
    bool m_principal_isSet;
    bool m_principal_isValid;

    OAIIsAuthorizedInput_action m_action;
    bool m_action_isSet;
    bool m_action_isValid;

    OAIIsAuthorizedInput_resource m_resource;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedInput)

#endif // OAIIsAuthorizedInput_H
