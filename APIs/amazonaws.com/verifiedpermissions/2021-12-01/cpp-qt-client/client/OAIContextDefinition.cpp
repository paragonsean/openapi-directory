...
#include "OAIContextDefinition.h"
...
OAIContextDefinition::OAIContextDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContextDefinition::OAIContextDefinition() {
    this->initializeModel();
}

OAIContextDefinition::~OAIContextDefinition() {}

void OAIContextDefinition::initializeModel() {

    m_context_map_isSet = false;
    m_context_map_isValid = false;
}

void OAIContextDefinition::fromJson(QString jsonString) {
...
void OAIContextDefinition::fromJsonObject(QJsonObject json) {

    m_context_map_isValid = ::OpenAPI::fromJsonValue(m_context_map, json[QString("contextMap")]);
    m_context_map_isSet = !json[QString("contextMap")].isNull() && m_context_map_isValid;
}

QString OAIContextDefinition::asJson() const {
...
QJsonObject OAIContextDefinition::asJsonObject() const {
    QJsonObject obj;
    if (m_context_map.isSet()) {
        obj.insert(QString("contextMap"), ::OpenAPI::toJsonValue(m_context_map));
    }
    return obj;
}

QMap OAIContextDefinition::getContextMap() const {
    return m_context_map;
}
void OAIContextDefinition::setContextMap(const QMap &context_map) {
    m_context_map = context_map;
    m_context_map_isSet = true;
}

bool OAIContextDefinition::is_context_map_Set() const{
    return m_context_map_isSet;
}

bool OAIContextDefinition::is_context_map_Valid() const{
    return m_context_map_isValid;
}

bool OAIContextDefinition::isSet() const {
...
bool OAIContextDefinition::isValid() const {
