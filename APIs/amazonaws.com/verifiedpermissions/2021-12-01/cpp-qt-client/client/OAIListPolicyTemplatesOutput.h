...
/*
 * OAIListPolicyTemplatesOutput.h
 *
 * 
 */

#ifndef OAIListPolicyTemplatesOutput_H
#define OAIListPolicyTemplatesOutput_H
...
class OAIListPolicyTemplatesOutput : public OAIObject {
public:
    OAIListPolicyTemplatesOutput();
    OAIListPolicyTemplatesOutput(QString json);
    ~OAIListPolicyTemplatesOutput() override;
    ...
    QList getPolicyTemplates() const;
    void setPolicyTemplates(const QList &policy_templates);
    bool is_policy_templates_Set() const;
    bool is_policy_templates_Valid() const;
...
private:
    ...
    QList m_policy_templates;
    bool m_policy_templates_isSet;
    bool m_policy_templates_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListPolicyTemplatesOutput)

#endif // OAIListPolicyTemplatesOutput_H
