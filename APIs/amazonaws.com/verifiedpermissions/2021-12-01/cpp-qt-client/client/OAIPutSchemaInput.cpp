...
OAIPutSchemaInput::OAIPutSchemaInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutSchemaInput::OAIPutSchemaInput() {
    this->initializeModel();
}

OAIPutSchemaInput::~OAIPutSchemaInput() {}

void OAIPutSchemaInput::initializeModel() {
...
void OAIPutSchemaInput::fromJson(QString jsonString) {
...
void OAIPutSchemaInput::fromJsonObject(QJsonObject json) {
...
QString OAIPutSchemaInput::asJson() const {
...
QJsonObject OAIPutSchemaInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutSchemaInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIPutSchemaInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIPutSchemaInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIPutSchemaInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

OAIPutSchemaInput_definition OAIPutSchemaInput::getDefinition() const {
    return m_definition;
}
void OAIPutSchemaInput::setDefinition(const OAIPutSchemaInput_definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIPutSchemaInput::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIPutSchemaInput::is_definition_Valid() const{
    return m_definition_isValid;
}

bool OAIPutSchemaInput::isSet() const {
...
bool OAIPutSchemaInput::isValid() const {
