...
OAIUpdateIdentitySourceOutput::OAIUpdateIdentitySourceOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateIdentitySourceOutput::OAIUpdateIdentitySourceOutput() {
    this->initializeModel();
}

OAIUpdateIdentitySourceOutput::~OAIUpdateIdentitySourceOutput() {}

void OAIUpdateIdentitySourceOutput::initializeModel() {
...
void OAIUpdateIdentitySourceOutput::fromJson(QString jsonString) {
...
void OAIUpdateIdentitySourceOutput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateIdentitySourceOutput::asJson() const {
...
QJsonObject OAIUpdateIdentitySourceOutput::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAIUpdateIdentitySourceOutput::getCreatedDate() const {
    return m_created_date;
}
void OAIUpdateIdentitySourceOutput::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIUpdateIdentitySourceOutput::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIUpdateIdentitySourceOutput::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAIUpdateIdentitySourceOutput::getIdentitySourceId() const {
    return m_identity_source_id;
}
void OAIUpdateIdentitySourceOutput::setIdentitySourceId(const QString &identity_source_id) {
    m_identity_source_id = identity_source_id;
    m_identity_source_id_isSet = true;
}

bool OAIUpdateIdentitySourceOutput::is_identity_source_id_Set() const{
    return m_identity_source_id_isSet;
}

bool OAIUpdateIdentitySourceOutput::is_identity_source_id_Valid() const{
    return m_identity_source_id_isValid;
}

QDateTime OAIUpdateIdentitySourceOutput::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIUpdateIdentitySourceOutput::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIUpdateIdentitySourceOutput::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIUpdateIdentitySourceOutput::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

QString OAIUpdateIdentitySourceOutput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIUpdateIdentitySourceOutput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIUpdateIdentitySourceOutput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIUpdateIdentitySourceOutput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

bool OAIUpdateIdentitySourceOutput::isSet() const {
...
bool OAIUpdateIdentitySourceOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_created_date_isValid && m_identity_source_id_isValid && m_last_updated_date_isValid && m_policy_store_id_isValid && true;
}
