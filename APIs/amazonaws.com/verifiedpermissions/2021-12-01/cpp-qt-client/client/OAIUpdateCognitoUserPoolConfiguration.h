...
/*
 * OAIUpdateCognitoUserPoolConfiguration.h
 *
 * Contains configuration details of a Amazon Cognito user pool for use with an identity source.
 */

#ifndef OAIUpdateCognitoUserPoolConfiguration_H
#define OAIUpdateCognitoUserPoolConfiguration_H
...
class OAIUpdateCognitoUserPoolConfiguration : public OAIObject {
public:
    OAIUpdateCognitoUserPoolConfiguration();
    OAIUpdateCognitoUserPoolConfiguration(QString json);
    ~OAIUpdateCognitoUserPoolConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateCognitoUserPoolConfiguration)

#endif // OAIUpdateCognitoUserPoolConfiguration_H
