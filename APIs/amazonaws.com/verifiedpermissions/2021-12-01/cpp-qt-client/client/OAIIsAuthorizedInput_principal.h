...
/*
 * OAIIsAuthorizedInput_principal.h
 *
 * 
 */

#ifndef OAIIsAuthorizedInput_principal_H
#define OAIIsAuthorizedInput_principal_H
...
class OAIIsAuthorizedInput_principal : public OAIObject {
public:
    OAIIsAuthorizedInput_principal();
    OAIIsAuthorizedInput_principal(QString json);
    ~OAIIsAuthorizedInput_principal() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedInput_principal)

#endif // OAIIsAuthorizedInput_principal_H
