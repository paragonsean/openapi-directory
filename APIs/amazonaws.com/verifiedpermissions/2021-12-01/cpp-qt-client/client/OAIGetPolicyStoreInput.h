...
/*
 * OAIGetPolicyStoreInput.h
 *
 * 
 */

#ifndef OAIGetPolicyStoreInput_H
#define OAIGetPolicyStoreInput_H
...
class OAIGetPolicyStoreInput : public OAIObject {
public:
    OAIGetPolicyStoreInput();
    OAIGetPolicyStoreInput(QString json);
    ~OAIGetPolicyStoreInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyStoreInput)

#endif // OAIGetPolicyStoreInput_H
