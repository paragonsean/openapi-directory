...
#include "OAIEvaluationErrorItem.h"
...
OAIEvaluationErrorItem::OAIEvaluationErrorItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvaluationErrorItem::OAIEvaluationErrorItem() {
    this->initializeModel();
}

OAIEvaluationErrorItem::~OAIEvaluationErrorItem() {}

void OAIEvaluationErrorItem::initializeModel() {

    m_error_description_isSet = false;
    m_error_description_isValid = false;
}

void OAIEvaluationErrorItem::fromJson(QString jsonString) {
...
void OAIEvaluationErrorItem::fromJsonObject(QJsonObject json) {
...
QString OAIEvaluationErrorItem::asJson() const {
...
QJsonObject OAIEvaluationErrorItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEvaluationErrorItem::getErrorDescription() const {
    return m_error_description;
}
void OAIEvaluationErrorItem::setErrorDescription(const QString &error_description) {
    m_error_description = error_description;
    m_error_description_isSet = true;
}

bool OAIEvaluationErrorItem::is_error_description_Set() const{
    return m_error_description_isSet;
}

bool OAIEvaluationErrorItem::is_error_description_Valid() const{
    return m_error_description_isValid;
}

bool OAIEvaluationErrorItem::isSet() const {
...
bool OAIEvaluationErrorItem::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_error_description_isValid && true;
}
