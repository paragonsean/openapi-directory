...
#include "OAIEntityItem_identifier.h"
...
OAIEntityItem_identifier::OAIEntityItem_identifier(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityItem_identifier::OAIEntityItem_identifier() {
    this->initializeModel();
}

OAIEntityItem_identifier::~OAIEntityItem_identifier() {}

void OAIEntityItem_identifier::initializeModel() {
...
void OAIEntityItem_identifier::fromJson(QString jsonString) {
...
void OAIEntityItem_identifier::fromJsonObject(QJsonObject json) {
...
QString OAIEntityItem_identifier::asJson() const {
...
QJsonObject OAIEntityItem_identifier::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEntityItem_identifier::getEntityType() const {
    return m_entity_type;
}
void OAIEntityItem_identifier::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIEntityItem_identifier::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIEntityItem_identifier::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIEntityItem_identifier::getEntityId() const {
    return m_entity_id;
}
void OAIEntityItem_identifier::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIEntityItem_identifier::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIEntityItem_identifier::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIEntityItem_identifier::isSet() const {
...
bool OAIEntityItem_identifier::isValid() const {
