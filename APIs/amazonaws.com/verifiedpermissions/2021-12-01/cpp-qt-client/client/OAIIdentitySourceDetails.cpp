...
#include "OAIIdentitySourceDetails.h"
...
OAIIdentitySourceDetails::OAIIdentitySourceDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIdentitySourceDetails::OAIIdentitySourceDetails() {
    this->initializeModel();
}

OAIIdentitySourceDetails::~OAIIdentitySourceDetails() {}

void OAIIdentitySourceDetails::initializeModel() {
...
void OAIIdentitySourceDetails::fromJson(QString jsonString) {
...
void OAIIdentitySourceDetails::fromJsonObject(QJsonObject json) {
...
QString OAIIdentitySourceDetails::asJson() const {
...
QJsonObject OAIIdentitySourceDetails::asJsonObject() const {
    QJsonObject obj;
...
QList OAIIdentitySourceDetails::getClientIds() const {
    return m_client_ids;
}
void OAIIdentitySourceDetails::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAIIdentitySourceDetails::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAIIdentitySourceDetails::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

QString OAIIdentitySourceDetails::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAIIdentitySourceDetails::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAIIdentitySourceDetails::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAIIdentitySourceDetails::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QString OAIIdentitySourceDetails::getDiscoveryUrl() const {
    return m_discovery_url;
}
void OAIIdentitySourceDetails::setDiscoveryUrl(const QString &discovery_url) {
    m_discovery_url = discovery_url;
    m_discovery_url_isSet = true;
}

bool OAIIdentitySourceDetails::is_discovery_url_Set() const{
    return m_discovery_url_isSet;
}

bool OAIIdentitySourceDetails::is_discovery_url_Valid() const{
    return m_discovery_url_isValid;
}

OAIOpenIdIssuer OAIIdentitySourceDetails::getOpenIdIssuer() const {
    return m_open_id_issuer;
}
void OAIIdentitySourceDetails::setOpenIdIssuer(const OAIOpenIdIssuer &open_id_issuer) {
    m_open_id_issuer = open_id_issuer;
    m_open_id_issuer_isSet = true;
}

bool OAIIdentitySourceDetails::is_open_id_issuer_Set() const{
    return m_open_id_issuer_isSet;
}

bool OAIIdentitySourceDetails::is_open_id_issuer_Valid() const{
    return m_open_id_issuer_isValid;
}

bool OAIIdentitySourceDetails::isSet() const {
...
bool OAIIdentitySourceDetails::isValid() const {
