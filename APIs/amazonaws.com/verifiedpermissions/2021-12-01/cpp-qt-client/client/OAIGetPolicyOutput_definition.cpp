...
OAIGetPolicyOutput_definition::OAIGetPolicyOutput_definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyOutput_definition::OAIGetPolicyOutput_definition() {
    this->initializeModel();
}

OAIGetPolicyOutput_definition::~OAIGetPolicyOutput_definition() {}

void OAIGetPolicyOutput_definition::initializeModel() {
...
void OAIGetPolicyOutput_definition::fromJson(QString jsonString) {
...
void OAIGetPolicyOutput_definition::fromJsonObject(QJsonObject json) {
...
QString OAIGetPolicyOutput_definition::asJson() const {
...
QJsonObject OAIGetPolicyOutput_definition::asJsonObject() const {
    QJsonObject obj;
    if (m_r_static.isSet()) {
...
OAIPolicyDefinitionDetail_static OAIGetPolicyOutput_definition::getRStatic() const {
    return m_r_static;
}
void OAIGetPolicyOutput_definition::setRStatic(const OAIPolicyDefinitionDetail_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAIGetPolicyOutput_definition::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAIGetPolicyOutput_definition::is_r_static_Valid() const{
    return m_r_static_isValid;
}

OAIPolicyDefinitionDetail_templateLinked OAIGetPolicyOutput_definition::getTemplateLinked() const {
    return m_template_linked;
}
void OAIGetPolicyOutput_definition::setTemplateLinked(const OAIPolicyDefinitionDetail_templateLinked &template_linked) {
    m_template_linked = template_linked;
    m_template_linked_isSet = true;
}

bool OAIGetPolicyOutput_definition::is_template_linked_Set() const{
    return m_template_linked_isSet;
}

bool OAIGetPolicyOutput_definition::is_template_linked_Valid() const{
    return m_template_linked_isValid;
}

bool OAIGetPolicyOutput_definition::isSet() const {
...
bool OAIGetPolicyOutput_definition::isValid() const {
