...
/*
 * OAICreatePolicyTemplateOutput.h
 *
 * 
 */

#ifndef OAICreatePolicyTemplateOutput_H
#define OAICreatePolicyTemplateOutput_H
...
class OAICreatePolicyTemplateOutput : public OAIObject {
public:
    OAICreatePolicyTemplateOutput();
    OAICreatePolicyTemplateOutput(QString json);
    ~OAICreatePolicyTemplateOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyTemplateOutput)

#endif // OAICreatePolicyTemplateOutput_H
