...
OAITemplateLinkedPolicyDefinition_resource::OAITemplateLinkedPolicyDefinition_resource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateLinkedPolicyDefinition_resource::OAITemplateLinkedPolicyDefinition_resource() {
    this->initializeModel();
}

OAITemplateLinkedPolicyDefinition_resource::~OAITemplateLinkedPolicyDefinition_resource() {}

void OAITemplateLinkedPolicyDefinition_resource::initializeModel() {
...
void OAITemplateLinkedPolicyDefinition_resource::fromJson(QString jsonString) {
...
void OAITemplateLinkedPolicyDefinition_resource::fromJsonObject(QJsonObject json) {
...
QString OAITemplateLinkedPolicyDefinition_resource::asJson() const {
...
QJsonObject OAITemplateLinkedPolicyDefinition_resource::asJsonObject() const {
    QJsonObject obj;
...
QString OAITemplateLinkedPolicyDefinition_resource::getEntityType() const {
    return m_entity_type;
}
void OAITemplateLinkedPolicyDefinition_resource::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition_resource::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAITemplateLinkedPolicyDefinition_resource::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAITemplateLinkedPolicyDefinition_resource::getEntityId() const {
    return m_entity_id;
}
void OAITemplateLinkedPolicyDefinition_resource::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition_resource::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAITemplateLinkedPolicyDefinition_resource::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAITemplateLinkedPolicyDefinition_resource::isSet() const {
...
bool OAITemplateLinkedPolicyDefinition_resource::isValid() const {
