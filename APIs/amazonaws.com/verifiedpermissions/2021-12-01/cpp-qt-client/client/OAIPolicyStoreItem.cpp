...
OAIPolicyStoreItem::OAIPolicyStoreItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyStoreItem::OAIPolicyStoreItem() {
    this->initializeModel();
}

OAIPolicyStoreItem::~OAIPolicyStoreItem() {}

void OAIPolicyStoreItem::initializeModel() {
...
void OAIPolicyStoreItem::fromJson(QString jsonString) {
...
void OAIPolicyStoreItem::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyStoreItem::asJson() const {
...
QJsonObject OAIPolicyStoreItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyStoreItem::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIPolicyStoreItem::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIPolicyStoreItem::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIPolicyStoreItem::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIPolicyStoreItem::getArn() const {
    return m_arn;
}
void OAIPolicyStoreItem::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIPolicyStoreItem::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIPolicyStoreItem::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAIPolicyStoreItem::getCreatedDate() const {
    return m_created_date;
}
void OAIPolicyStoreItem::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIPolicyStoreItem::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIPolicyStoreItem::is_created_date_Valid() const{
    return m_created_date_isValid;
}

bool OAIPolicyStoreItem::isSet() const {
...
bool OAIPolicyStoreItem::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_arn_isValid && m_created_date_isValid && true;
}
