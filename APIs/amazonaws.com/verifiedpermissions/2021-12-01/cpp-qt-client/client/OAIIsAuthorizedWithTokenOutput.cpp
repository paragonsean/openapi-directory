...
OAIIsAuthorizedWithTokenOutput::OAIIsAuthorizedWithTokenOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedWithTokenOutput::OAIIsAuthorizedWithTokenOutput() {
    this->initializeModel();
}

OAIIsAuthorizedWithTokenOutput::~OAIIsAuthorizedWithTokenOutput() {}

void OAIIsAuthorizedWithTokenOutput::initializeModel() {

    m_decision_isSet = false;
    m_decision_isValid = false;

    m_determining_policies_isSet = false;
    m_determining_policies_isValid = false;

    m_errors_isSet = false;
    m_errors_isValid = false;
}

void OAIIsAuthorizedWithTokenOutput::fromJson(QString jsonString) {
...
void OAIIsAuthorizedWithTokenOutput::fromJsonObject(QJsonObject json) {
    ...
    m_determining_policies_isValid = ::OpenAPI::fromJsonValue(m_determining_policies, json[QString("determiningPolicies")]);
    m_determining_policies_isSet = !json[QString("determiningPolicies")].isNull() && m_determining_policies_isValid;

    m_errors_isValid = ::OpenAPI::fromJsonValue(m_errors, json[QString("errors")]);
    m_errors_isSet = !json[QString("errors")].isNull() && m_errors_isValid;
}

QString OAIIsAuthorizedWithTokenOutput::asJson() const {
...
QJsonObject OAIIsAuthorizedWithTokenOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_decision.isSet()) {
        obj.insert(QString("decision"), ::OpenAPI::toJsonValue(m_decision));
    }
    if (m_determining_policies.isSet()) {
        obj.insert(QString("determiningPolicies"), ::OpenAPI::toJsonValue(m_determining_policies));
    }
    if (m_errors.isSet()) {
...
OAIDecision OAIIsAuthorizedWithTokenOutput::getDecision() const {
    return m_decision;
}
void OAIIsAuthorizedWithTokenOutput::setDecision(const OAIDecision &decision) {
    m_decision = decision;
    m_decision_isSet = true;
}

bool OAIIsAuthorizedWithTokenOutput::is_decision_Set() const{
    return m_decision_isSet;
}

bool OAIIsAuthorizedWithTokenOutput::is_decision_Valid() const{
    return m_decision_isValid;
}

QList OAIIsAuthorizedWithTokenOutput::getDeterminingPolicies() const {
    return m_determining_policies;
}
void OAIIsAuthorizedWithTokenOutput::setDeterminingPolicies(const QList &determining_policies) {
    m_determining_policies = determining_policies;
    m_determining_policies_isSet = true;
}

bool OAIIsAuthorizedWithTokenOutput::is_determining_policies_Set() const{
    return m_determining_policies_isSet;
}

bool OAIIsAuthorizedWithTokenOutput::is_determining_policies_Valid() const{
    return m_determining_policies_isValid;
}

QList OAIIsAuthorizedWithTokenOutput::getErrors() const {
    return m_errors;
}
void OAIIsAuthorizedWithTokenOutput::setErrors(const QList &errors) {
    m_errors = errors;
    m_errors_isSet = true;
}

bool OAIIsAuthorizedWithTokenOutput::is_errors_Set() const{
    return m_errors_isSet;
}

bool OAIIsAuthorizedWithTokenOutput::is_errors_Valid() const{
    return m_errors_isValid;
}

bool OAIIsAuthorizedWithTokenOutput::isSet() const {
...
bool OAIIsAuthorizedWithTokenOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_decision_isValid && m_determining_policies_isValid && m_errors_isValid && true;
}
