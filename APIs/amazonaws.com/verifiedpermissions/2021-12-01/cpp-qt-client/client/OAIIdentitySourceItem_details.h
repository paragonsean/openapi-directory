...
/*
 * OAIIdentitySourceItem_details.h
 *
 * 
 */

#ifndef OAIIdentitySourceItem_details_H
#define OAIIdentitySourceItem_details_H
...
class OAIIdentitySourceItem_details : public OAIObject {
public:
    OAIIdentitySourceItem_details();
    OAIIdentitySourceItem_details(QString json);
    ~OAIIdentitySourceItem_details() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentitySourceItem_details)

#endif // OAIIdentitySourceItem_details_H
