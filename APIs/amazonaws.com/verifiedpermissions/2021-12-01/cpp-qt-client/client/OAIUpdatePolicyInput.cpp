...
QString OAIUpdatePolicyInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIUpdatePolicyInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIUpdatePolicyInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIUpdatePolicyInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIUpdatePolicyInput::getPolicyId() const {
    return m_policy_id;
}
void OAIUpdatePolicyInput::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIUpdatePolicyInput::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIUpdatePolicyInput::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

OAIUpdatePolicyInput_definition OAIUpdatePolicyInput::getDefinition() const {
    return m_definition;
}
void OAIUpdatePolicyInput::setDefinition(const OAIUpdatePolicyInput_definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIUpdatePolicyInput::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIUpdatePolicyInput::is_definition_Valid() const{
...
bool OAIUpdatePolicyInput::isValid() const {
    ...
    return m_policy_store_id_isValid && m_policy_id_isValid && m_definition_isValid && true;
}
