...
OAIGetPolicyInput::OAIGetPolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPolicyInput::OAIGetPolicyInput() {
    this->initializeModel();
}

OAIGetPolicyInput::~OAIGetPolicyInput() {}

void OAIGetPolicyInput::initializeModel() {
...
void OAIGetPolicyInput::fromJson(QString jsonString) {
...
void OAIGetPolicyInput::fromJsonObject(QJsonObject json) {
...
QString OAIGetPolicyInput::asJson() const {
...
QJsonObject OAIGetPolicyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIGetPolicyInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIGetPolicyInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIGetPolicyInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIGetPolicyInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIGetPolicyInput::getPolicyId() const {
    return m_policy_id;
}
void OAIGetPolicyInput::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIGetPolicyInput::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIGetPolicyInput::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

bool OAIGetPolicyInput::isSet() const {
...
bool OAIGetPolicyInput::isValid() const {
