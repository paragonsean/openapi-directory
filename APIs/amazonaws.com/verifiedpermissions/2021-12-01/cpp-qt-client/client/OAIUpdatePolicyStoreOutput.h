...
/*
 * OAIUpdatePolicyStoreOutput.h
 *
 * 
 */

#ifndef OAIUpdatePolicyStoreOutput_H
#define OAIUpdatePolicyStoreOutput_H
...
class OAIUpdatePolicyStoreOutput : public OAIObject {
public:
    OAIUpdatePolicyStoreOutput();
    OAIUpdatePolicyStoreOutput(QString json);
    ~OAIUpdatePolicyStoreOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyStoreOutput)

#endif // OAIUpdatePolicyStoreOutput_H
