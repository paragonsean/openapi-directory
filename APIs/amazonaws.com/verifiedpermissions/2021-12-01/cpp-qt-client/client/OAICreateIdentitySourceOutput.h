...
/*
 * OAICreateIdentitySourceOutput.h
 *
 * 
 */

#ifndef OAICreateIdentitySourceOutput_H
#define OAICreateIdentitySourceOutput_H
...
class OAICreateIdentitySourceOutput : public OAIObject {
public:
    OAICreateIdentitySourceOutput();
    OAICreateIdentitySourceOutput(QString json);
    ~OAICreateIdentitySourceOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateIdentitySourceOutput)

#endif // OAICreateIdentitySourceOutput_H
