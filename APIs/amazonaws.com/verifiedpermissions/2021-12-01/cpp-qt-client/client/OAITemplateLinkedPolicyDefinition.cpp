...
#include "OAITemplateLinkedPolicyDefinition.h"
...
OAITemplateLinkedPolicyDefinition::OAITemplateLinkedPolicyDefinition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITemplateLinkedPolicyDefinition::OAITemplateLinkedPolicyDefinition() {
    this->initializeModel();
}

OAITemplateLinkedPolicyDefinition::~OAITemplateLinkedPolicyDefinition() {}

void OAITemplateLinkedPolicyDefinition::initializeModel() {
...
void OAITemplateLinkedPolicyDefinition::fromJson(QString jsonString) {
...
void OAITemplateLinkedPolicyDefinition::fromJsonObject(QJsonObject json) {
...
QString OAITemplateLinkedPolicyDefinition::asJson() const {
...
QJsonObject OAITemplateLinkedPolicyDefinition::asJsonObject() const {
    QJsonObject obj;
...
QString OAITemplateLinkedPolicyDefinition::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAITemplateLinkedPolicyDefinition::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAITemplateLinkedPolicyDefinition::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

OAITemplateLinkedPolicyDefinition_principal OAITemplateLinkedPolicyDefinition::getPrincipal() const {
    return m_principal;
}
void OAITemplateLinkedPolicyDefinition::setPrincipal(const OAITemplateLinkedPolicyDefinition_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAITemplateLinkedPolicyDefinition::is_principal_Valid() const{
    return m_principal_isValid;
}

OAITemplateLinkedPolicyDefinition_resource OAITemplateLinkedPolicyDefinition::getResource() const {
    return m_resource;
}
void OAITemplateLinkedPolicyDefinition::setResource(const OAITemplateLinkedPolicyDefinition_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAITemplateLinkedPolicyDefinition::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAITemplateLinkedPolicyDefinition::is_resource_Valid() const{
    return m_resource_isValid;
}

bool OAITemplateLinkedPolicyDefinition::isSet() const {
...
bool OAITemplateLinkedPolicyDefinition::isValid() const {
