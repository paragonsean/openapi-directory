...
OAIListPolicyStoresOutput::OAIListPolicyStoresOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPolicyStoresOutput::OAIListPolicyStoresOutput() {
    this->initializeModel();
}

OAIListPolicyStoresOutput::~OAIListPolicyStoresOutput() {}

void OAIListPolicyStoresOutput::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_policy_stores_isSet = false;
    m_policy_stores_isValid = false;
}

void OAIListPolicyStoresOutput::fromJson(QString jsonString) {
...
void OAIListPolicyStoresOutput::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_policy_stores_isValid = ::OpenAPI::fromJsonValue(m_policy_stores, json[QString("policyStores")]);
    m_policy_stores_isSet = !json[QString("policyStores")].isNull() && m_policy_stores_isValid;
}

QString OAIListPolicyStoresOutput::asJson() const {
...
QJsonObject OAIListPolicyStoresOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_policy_stores.isSet()) {
        obj.insert(QString("policyStores"), ::OpenAPI::toJsonValue(m_policy_stores));
    }
    return obj;
}

QString OAIListPolicyStoresOutput::getNextToken() const {
    return m_next_token;
}
void OAIListPolicyStoresOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPolicyStoresOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPolicyStoresOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListPolicyStoresOutput::getPolicyStores() const {
    return m_policy_stores;
}
void OAIListPolicyStoresOutput::setPolicyStores(const QList &policy_stores) {
    m_policy_stores = policy_stores;
    m_policy_stores_isSet = true;
}

bool OAIListPolicyStoresOutput::is_policy_stores_Set() const{
    return m_policy_stores_isSet;
}

bool OAIListPolicyStoresOutput::is_policy_stores_Valid() const{
    return m_policy_stores_isValid;
}

bool OAIListPolicyStoresOutput::isSet() const {
...
bool OAIListPolicyStoresOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_stores_isValid && true;
}
