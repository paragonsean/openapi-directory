...
OAIDeletePolicyInput::OAIDeletePolicyInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePolicyInput::OAIDeletePolicyInput() {
    this->initializeModel();
}

OAIDeletePolicyInput::~OAIDeletePolicyInput() {}

void OAIDeletePolicyInput::initializeModel() {
...
void OAIDeletePolicyInput::fromJson(QString jsonString) {
...
void OAIDeletePolicyInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePolicyInput::asJson() const {
...
QJsonObject OAIDeletePolicyInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeletePolicyInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIDeletePolicyInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIDeletePolicyInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIDeletePolicyInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIDeletePolicyInput::getPolicyId() const {
    return m_policy_id;
}
void OAIDeletePolicyInput::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIDeletePolicyInput::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIDeletePolicyInput::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

bool OAIDeletePolicyInput::isSet() const {
...
bool OAIDeletePolicyInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_policy_id_isValid && true;
}
