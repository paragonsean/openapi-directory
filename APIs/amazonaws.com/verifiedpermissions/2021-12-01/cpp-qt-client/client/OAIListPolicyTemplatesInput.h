...
/*
 * OAIListPolicyTemplatesInput.h
 *
 * 
 */

#ifndef OAIListPolicyTemplatesInput_H
#define OAIListPolicyTemplatesInput_H
...
class OAIListPolicyTemplatesInput : public OAIObject {
public:
    OAIListPolicyTemplatesInput();
    OAIListPolicyTemplatesInput(QString json);
    ~OAIListPolicyTemplatesInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListPolicyTemplatesInput)

#endif // OAIListPolicyTemplatesInput_H
