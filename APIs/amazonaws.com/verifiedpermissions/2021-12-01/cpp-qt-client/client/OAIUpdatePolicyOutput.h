...
/*
 * OAIUpdatePolicyOutput.h
 *
 * 
 */

#ifndef OAIUpdatePolicyOutput_H
#define OAIUpdatePolicyOutput_H
...
class OAIUpdatePolicyOutput : public OAIObject {
public:
    OAIUpdatePolicyOutput();
    OAIUpdatePolicyOutput(QString json);
    ~OAIUpdatePolicyOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyOutput)

#endif // OAIUpdatePolicyOutput_H
