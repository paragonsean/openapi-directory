...
OAIGetIdentitySourceOutput_details::OAIGetIdentitySourceOutput_details(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetIdentitySourceOutput_details::OAIGetIdentitySourceOutput_details() {
    this->initializeModel();
}

OAIGetIdentitySourceOutput_details::~OAIGetIdentitySourceOutput_details() {}

void OAIGetIdentitySourceOutput_details::initializeModel() {
...
void OAIGetIdentitySourceOutput_details::fromJson(QString jsonString) {
...
void OAIGetIdentitySourceOutput_details::fromJsonObject(QJsonObject json) {
...
QString OAIGetIdentitySourceOutput_details::asJson() const {
...
QJsonObject OAIGetIdentitySourceOutput_details::asJsonObject() const {
    QJsonObject obj;
...
QList OAIGetIdentitySourceOutput_details::getClientIds() const {
    return m_client_ids;
}
void OAIGetIdentitySourceOutput_details::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAIGetIdentitySourceOutput_details::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAIGetIdentitySourceOutput_details::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

QString OAIGetIdentitySourceOutput_details::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAIGetIdentitySourceOutput_details::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAIGetIdentitySourceOutput_details::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAIGetIdentitySourceOutput_details::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QString OAIGetIdentitySourceOutput_details::getDiscoveryUrl() const {
    return m_discovery_url;
}
void OAIGetIdentitySourceOutput_details::setDiscoveryUrl(const QString &discovery_url) {
    m_discovery_url = discovery_url;
    m_discovery_url_isSet = true;
}

bool OAIGetIdentitySourceOutput_details::is_discovery_url_Set() const{
    return m_discovery_url_isSet;
}

bool OAIGetIdentitySourceOutput_details::is_discovery_url_Valid() const{
    return m_discovery_url_isValid;
}

OAIOpenIdIssuer OAIGetIdentitySourceOutput_details::getOpenIdIssuer() const {
    return m_open_id_issuer;
}
void OAIGetIdentitySourceOutput_details::setOpenIdIssuer(const OAIOpenIdIssuer &open_id_issuer) {
    m_open_id_issuer = open_id_issuer;
    m_open_id_issuer_isSet = true;
}

bool OAIGetIdentitySourceOutput_details::is_open_id_issuer_Set() const{
    return m_open_id_issuer_isSet;
}

bool OAIGetIdentitySourceOutput_details::is_open_id_issuer_Valid() const{
    return m_open_id_issuer_isValid;
}

bool OAIGetIdentitySourceOutput_details::isSet() const {
...
bool OAIGetIdentitySourceOutput_details::isValid() const {
