...
/*
 * OAIPolicyDefinitionItem_static.h
 *
 * 
 */

#ifndef OAIPolicyDefinitionItem_static_H
#define OAIPolicyDefinitionItem_static_H
...
class OAIPolicyDefinitionItem_static : public OAIObject {
public:
    OAIPolicyDefinitionItem_static();
    OAIPolicyDefinitionItem_static(QString json);
    ~OAIPolicyDefinitionItem_static() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyDefinitionItem_static)

#endif // OAIPolicyDefinitionItem_static_H
