...
OAIPolicyDefinition_static::OAIPolicyDefinition_static(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyDefinition_static::OAIPolicyDefinition_static() {
    this->initializeModel();
}

OAIPolicyDefinition_static::~OAIPolicyDefinition_static() {}

void OAIPolicyDefinition_static::initializeModel() {
...
void OAIPolicyDefinition_static::fromJson(QString jsonString) {
...
void OAIPolicyDefinition_static::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyDefinition_static::asJson() const {
...
QJsonObject OAIPolicyDefinition_static::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyDefinition_static::getDescription() const {
    return m_description;
}
void OAIPolicyDefinition_static::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPolicyDefinition_static::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPolicyDefinition_static::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIPolicyDefinition_static::getStatement() const {
    return m_statement;
}
void OAIPolicyDefinition_static::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIPolicyDefinition_static::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIPolicyDefinition_static::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIPolicyDefinition_static::isSet() const {
...
bool OAIPolicyDefinition_static::isValid() const {
