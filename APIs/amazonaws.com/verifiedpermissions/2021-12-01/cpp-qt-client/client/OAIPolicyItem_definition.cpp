...
OAIPolicyItem_definition::OAIPolicyItem_definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyItem_definition::OAIPolicyItem_definition() {
    this->initializeModel();
}

OAIPolicyItem_definition::~OAIPolicyItem_definition() {}

void OAIPolicyItem_definition::initializeModel() {
...
void OAIPolicyItem_definition::fromJson(QString jsonString) {
...
void OAIPolicyItem_definition::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyItem_definition::asJson() const {
...
QJsonObject OAIPolicyItem_definition::asJsonObject() const {
    QJsonObject obj;
    if (m_r_static.isSet()) {
...
OAIPolicyDefinitionItem_static OAIPolicyItem_definition::getRStatic() const {
    return m_r_static;
}
void OAIPolicyItem_definition::setRStatic(const OAIPolicyDefinitionItem_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAIPolicyItem_definition::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAIPolicyItem_definition::is_r_static_Valid() const{
    return m_r_static_isValid;
}

OAIPolicyDefinitionItem_templateLinked OAIPolicyItem_definition::getTemplateLinked() const {
    return m_template_linked;
}
void OAIPolicyItem_definition::setTemplateLinked(const OAIPolicyDefinitionItem_templateLinked &template_linked) {
    m_template_linked = template_linked;
    m_template_linked_isSet = true;
}

bool OAIPolicyItem_definition::is_template_linked_Set() const{
    return m_template_linked_isSet;
}

bool OAIPolicyItem_definition::is_template_linked_Valid() const{
    return m_template_linked_isValid;
}

bool OAIPolicyItem_definition::isSet() const {
...
bool OAIPolicyItem_definition::isValid() const {
