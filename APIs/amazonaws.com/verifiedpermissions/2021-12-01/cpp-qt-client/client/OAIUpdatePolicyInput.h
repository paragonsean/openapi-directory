...
namespace OpenAPI {
class OAIUpdatePolicyInput_definition;
...
public:
    ...
    OAIUpdatePolicyInput_definition getDefinition() const;
    void setDefinition(const OAIUpdatePolicyInput_definition &definition);
...
private:
    ...
    OAIUpdatePolicyInput_definition m_definition;
