...
OAICreatePolicyStoreOutput::OAICreatePolicyStoreOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyStoreOutput::OAICreatePolicyStoreOutput() {
    this->initializeModel();
}

OAICreatePolicyStoreOutput::~OAICreatePolicyStoreOutput() {}

void OAICreatePolicyStoreOutput::initializeModel() {
...
void OAICreatePolicyStoreOutput::fromJson(QString jsonString) {
...
void OAICreatePolicyStoreOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyStoreOutput::asJson() const {
...
QJsonObject OAICreatePolicyStoreOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePolicyStoreOutput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAICreatePolicyStoreOutput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAICreatePolicyStoreOutput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAICreatePolicyStoreOutput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAICreatePolicyStoreOutput::getArn() const {
    return m_arn;
}
void OAICreatePolicyStoreOutput::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAICreatePolicyStoreOutput::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAICreatePolicyStoreOutput::is_arn_Valid() const{
    return m_arn_isValid;
}

QDateTime OAICreatePolicyStoreOutput::getCreatedDate() const {
    return m_created_date;
}
void OAICreatePolicyStoreOutput::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICreatePolicyStoreOutput::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICreatePolicyStoreOutput::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAICreatePolicyStoreOutput::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAICreatePolicyStoreOutput::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAICreatePolicyStoreOutput::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAICreatePolicyStoreOutput::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAICreatePolicyStoreOutput::isSet() const {
...
bool OAICreatePolicyStoreOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_arn_isValid && m_created_date_isValid && m_last_updated_date_isValid && true;
}
