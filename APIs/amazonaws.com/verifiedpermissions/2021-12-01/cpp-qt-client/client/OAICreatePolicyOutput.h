...
/*
 * OAICreatePolicyOutput.h
 *
 * 
 */

#ifndef OAICreatePolicyOutput_H
#define OAICreatePolicyOutput_H
...
namespace OpenAPI {
class OAICreatePolicyOutput_principal;
class OAICreatePolicyOutput_resource;

class OAICreatePolicyOutput : public OAIObject {
public:
    OAICreatePolicyOutput();
    OAICreatePolicyOutput(QString json);
    ~OAICreatePolicyOutput() override;
    ...
    OAICreatePolicyOutput_principal getPrincipal() const;
    void setPrincipal(const OAICreatePolicyOutput_principal &principal);
    bool is_principal_Set() const;
    bool is_principal_Valid() const;

    OAICreatePolicyOutput_resource getResource() const;
    void setResource(const OAICreatePolicyOutput_resource &resource);
...
private:
    ...
    OAICreatePolicyOutput_principal m_principal;
    bool m_principal_isSet;
    bool m_principal_isValid;

    OAICreatePolicyOutput_resource m_resource;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyOutput)

#endif // OAICreatePolicyOutput_H
