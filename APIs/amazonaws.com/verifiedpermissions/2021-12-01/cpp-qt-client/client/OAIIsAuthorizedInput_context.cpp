...
OAIIsAuthorizedInput_context::OAIIsAuthorizedInput_context(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedInput_context::OAIIsAuthorizedInput_context() {
    this->initializeModel();
}

OAIIsAuthorizedInput_context::~OAIIsAuthorizedInput_context() {}

void OAIIsAuthorizedInput_context::initializeModel() {

    m_context_map_isSet = false;
    m_context_map_isValid = false;
}

void OAIIsAuthorizedInput_context::fromJson(QString jsonString) {
...
void OAIIsAuthorizedInput_context::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedInput_context::asJson() const {
...
QJsonObject OAIIsAuthorizedInput_context::asJsonObject() const {
    QJsonObject obj;
...
QMap OAIIsAuthorizedInput_context::getContextMap() const {
    return m_context_map;
}
void OAIIsAuthorizedInput_context::setContextMap(const QMap &context_map) {
    m_context_map = context_map;
    m_context_map_isSet = true;
}

bool OAIIsAuthorizedInput_context::is_context_map_Set() const{
    return m_context_map_isSet;
}

bool OAIIsAuthorizedInput_context::is_context_map_Valid() const{
    return m_context_map_isValid;
}

bool OAIIsAuthorizedInput_context::isSet() const {
...
bool OAIIsAuthorizedInput_context::isValid() const {
