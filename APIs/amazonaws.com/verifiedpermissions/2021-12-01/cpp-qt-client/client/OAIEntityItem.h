...
#ifndef OAIEntityItem_H
#define OAIEntityItem_H
...
namespace OpenAPI {
class OAIEntityItem_identifier;

class OAIEntityItem : public OAIObject {
public:
    OAIEntityItem();
    OAIEntityItem(QString json);
    ~OAIEntityItem() override;
    ...
    OAIEntityItem_identifier getIdentifier() const;
    void setIdentifier(const OAIEntityItem_identifier &identifier);
...
private:
    ...
    OAIEntityItem_identifier m_identifier;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntityItem)

#endif // OAIEntityItem_H
