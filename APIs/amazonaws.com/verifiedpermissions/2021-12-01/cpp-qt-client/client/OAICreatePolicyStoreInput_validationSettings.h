...
/*
 * OAICreatePolicyStoreInput_validationSettings.h
 *
 * 
 */

#ifndef OAICreatePolicyStoreInput_validationSettings_H
#define OAICreatePolicyStoreInput_validationSettings_H
...
class OAICreatePolicyStoreInput_validationSettings : public OAIObject {
public:
    OAICreatePolicyStoreInput_validationSettings();
    OAICreatePolicyStoreInput_validationSettings(QString json);
    ~OAICreatePolicyStoreInput_validationSettings() override;
    ...
    OAIValidationMode getMode() const;
    void setMode(const OAIValidationMode &mode);
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyStoreInput_validationSettings)

#endif // OAICreatePolicyStoreInput_validationSettings_H
