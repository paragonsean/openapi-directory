...
/*
 * OAIGetIdentitySourceInput.h
 *
 * 
 */

#ifndef OAIGetIdentitySourceInput_H
#define OAIGetIdentitySourceInput_H
...
class OAIGetIdentitySourceInput : public OAIObject {
public:
    OAIGetIdentitySourceInput();
    OAIGetIdentitySourceInput(QString json);
    ~OAIGetIdentitySourceInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetIdentitySourceInput)

#endif // OAIGetIdentitySourceInput_H
