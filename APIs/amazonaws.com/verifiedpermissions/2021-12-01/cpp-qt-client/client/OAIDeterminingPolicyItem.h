...
#ifndef OAIDeterminingPolicyItem_H
#define OAIDeterminingPolicyItem_H
...
class OAIDeterminingPolicyItem : public OAIObject {
public:
    OAIDeterminingPolicyItem();
    OAIDeterminingPolicyItem(QString json);
    ~OAIDeterminingPolicyItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeterminingPolicyItem)

#endif // OAIDeterminingPolicyItem_H
