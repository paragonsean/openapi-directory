...
/*
 * OAIConfiguration_cognitoUserPoolConfiguration.h
 *
 * 
 */

#ifndef OAIConfiguration_cognitoUserPoolConfiguration_H
#define OAIConfiguration_cognitoUserPoolConfiguration_H
...
class OAIConfiguration_cognitoUserPoolConfiguration : public OAIObject {
public:
    OAIConfiguration_cognitoUserPoolConfiguration();
    OAIConfiguration_cognitoUserPoolConfiguration(QString json);
    ~OAIConfiguration_cognitoUserPoolConfiguration() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConfiguration_cognitoUserPoolConfiguration)

#endif // OAIConfiguration_cognitoUserPoolConfiguration_H
