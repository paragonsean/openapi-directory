...
OAIIsAuthorizedInput_principal::OAIIsAuthorizedInput_principal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedInput_principal::OAIIsAuthorizedInput_principal() {
    this->initializeModel();
}

OAIIsAuthorizedInput_principal::~OAIIsAuthorizedInput_principal() {}

void OAIIsAuthorizedInput_principal::initializeModel() {
...
void OAIIsAuthorizedInput_principal::fromJson(QString jsonString) {
...
void OAIIsAuthorizedInput_principal::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedInput_principal::asJson() const {
...
QJsonObject OAIIsAuthorizedInput_principal::asJsonObject() const {
    QJsonObject obj;
...
QString OAIIsAuthorizedInput_principal::getEntityType() const {
    return m_entity_type;
}
void OAIIsAuthorizedInput_principal::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIIsAuthorizedInput_principal::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIIsAuthorizedInput_principal::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIIsAuthorizedInput_principal::getEntityId() const {
    return m_entity_id;
}
void OAIIsAuthorizedInput_principal::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIIsAuthorizedInput_principal::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIIsAuthorizedInput_principal::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIIsAuthorizedInput_principal::isSet() const {
...
bool OAIIsAuthorizedInput_principal::isValid() const {
