...
#include "OAIPolicyDefinitionItem.h"
...
OAIPolicyDefinitionItem::OAIPolicyDefinitionItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyDefinitionItem::OAIPolicyDefinitionItem() {
    this->initializeModel();
}

OAIPolicyDefinitionItem::~OAIPolicyDefinitionItem() {}

void OAIPolicyDefinitionItem::initializeModel() {
...
void OAIPolicyDefinitionItem::fromJson(QString jsonString) {
...
void OAIPolicyDefinitionItem::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyDefinitionItem::asJson() const {
...
QJsonObject OAIPolicyDefinitionItem::asJsonObject() const {
    QJsonObject obj;
    if (m_r_static.isSet()) {
...
OAIPolicyDefinitionItem_static OAIPolicyDefinitionItem::getRStatic() const {
    return m_r_static;
}
void OAIPolicyDefinitionItem::setRStatic(const OAIPolicyDefinitionItem_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAIPolicyDefinitionItem::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAIPolicyDefinitionItem::is_r_static_Valid() const{
    return m_r_static_isValid;
}

OAIPolicyDefinitionItem_templateLinked OAIPolicyDefinitionItem::getTemplateLinked() const {
    return m_template_linked;
}
void OAIPolicyDefinitionItem::setTemplateLinked(const OAIPolicyDefinitionItem_templateLinked &template_linked) {
    m_template_linked = template_linked;
    m_template_linked_isSet = true;
}

bool OAIPolicyDefinitionItem::is_template_linked_Set() const{
    return m_template_linked_isSet;
}

bool OAIPolicyDefinitionItem::is_template_linked_Valid() const{
    return m_template_linked_isValid;
}

bool OAIPolicyDefinitionItem::isSet() const {
...
bool OAIPolicyDefinitionItem::isValid() const {
