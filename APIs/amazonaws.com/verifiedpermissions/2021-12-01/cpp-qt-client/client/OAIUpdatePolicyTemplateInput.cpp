...
OAIUpdatePolicyTemplateInput::OAIUpdatePolicyTemplateInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyTemplateInput::OAIUpdatePolicyTemplateInput() {
    this->initializeModel();
}

OAIUpdatePolicyTemplateInput::~OAIUpdatePolicyTemplateInput() {}

void OAIUpdatePolicyTemplateInput::initializeModel() {
...
void OAIUpdatePolicyTemplateInput::fromJson(QString jsonString) {
...
void OAIUpdatePolicyTemplateInput::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyTemplateInput::asJson() const {
...
QJsonObject OAIUpdatePolicyTemplateInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdatePolicyTemplateInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIUpdatePolicyTemplateInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIUpdatePolicyTemplateInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIUpdatePolicyTemplateInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIUpdatePolicyTemplateInput::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAIUpdatePolicyTemplateInput::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAIUpdatePolicyTemplateInput::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAIUpdatePolicyTemplateInput::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

QString OAIUpdatePolicyTemplateInput::getDescription() const {
    return m_description;
}
void OAIUpdatePolicyTemplateInput::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIUpdatePolicyTemplateInput::is_description_Set() const{
    return m_description_isSet;
}

bool OAIUpdatePolicyTemplateInput::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIUpdatePolicyTemplateInput::getStatement() const {
    return m_statement;
}
void OAIUpdatePolicyTemplateInput::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIUpdatePolicyTemplateInput::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIUpdatePolicyTemplateInput::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIUpdatePolicyTemplateInput::isSet() const {
...
bool OAIUpdatePolicyTemplateInput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_policy_store_id_isValid && m_policy_template_id_isValid && m_statement_isValid && true;
}
