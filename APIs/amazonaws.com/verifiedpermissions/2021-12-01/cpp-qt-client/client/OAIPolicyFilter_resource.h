...
/*
 * OAIPolicyFilter_resource.h
 *
 * 
 */

#ifndef OAIPolicyFilter_resource_H
#define OAIPolicyFilter_resource_H
...
class OAIPolicyFilter_resource : public OAIObject {
public:
    OAIPolicyFilter_resource();
    OAIPolicyFilter_resource(QString json);
    ~OAIPolicyFilter_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPolicyFilter_resource)

#endif // OAIPolicyFilter_resource_H
