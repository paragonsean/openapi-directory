...
OAIPolicyDefinitionItem_static::OAIPolicyDefinitionItem_static(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyDefinitionItem_static::OAIPolicyDefinitionItem_static() {
    this->initializeModel();
}

OAIPolicyDefinitionItem_static::~OAIPolicyDefinitionItem_static() {}

void OAIPolicyDefinitionItem_static::initializeModel() {

    m_description_isSet = false;
    m_description_isValid = false;
}

void OAIPolicyDefinitionItem_static::fromJson(QString jsonString) {
...
void OAIPolicyDefinitionItem_static::fromJsonObject(QJsonObject json) {

    m_description_isValid = ::OpenAPI::fromJsonValue(m_description, json[QString("description")]);
    m_description_isSet = !json[QString("description")].isNull() && m_description_isValid;
}

QString OAIPolicyDefinitionItem_static::asJson() const {
...
QJsonObject OAIPolicyDefinitionItem_static::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyDefinitionItem_static::getDescription() const {
    return m_description;
}
void OAIPolicyDefinitionItem_static::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPolicyDefinitionItem_static::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPolicyDefinitionItem_static::is_description_Valid() const{
    return m_description_isValid;
}

bool OAIPolicyDefinitionItem_static::isSet() const {
...
bool OAIPolicyDefinitionItem_static::isValid() const {
