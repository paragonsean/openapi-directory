...
OAICreatePolicyTemplateOutput::OAICreatePolicyTemplateOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyTemplateOutput::OAICreatePolicyTemplateOutput() {
    this->initializeModel();
}

OAICreatePolicyTemplateOutput::~OAICreatePolicyTemplateOutput() {}

void OAICreatePolicyTemplateOutput::initializeModel() {
...
void OAICreatePolicyTemplateOutput::fromJson(QString jsonString) {
...
void OAICreatePolicyTemplateOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyTemplateOutput::asJson() const {
...
QJsonObject OAICreatePolicyTemplateOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePolicyTemplateOutput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAICreatePolicyTemplateOutput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAICreatePolicyTemplateOutput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAICreatePolicyTemplateOutput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAICreatePolicyTemplateOutput::getPolicyTemplateId() const {
    return m_policy_template_id;
}
void OAICreatePolicyTemplateOutput::setPolicyTemplateId(const QString &policy_template_id) {
    m_policy_template_id = policy_template_id;
    m_policy_template_id_isSet = true;
}

bool OAICreatePolicyTemplateOutput::is_policy_template_id_Set() const{
    return m_policy_template_id_isSet;
}

bool OAICreatePolicyTemplateOutput::is_policy_template_id_Valid() const{
    return m_policy_template_id_isValid;
}

QDateTime OAICreatePolicyTemplateOutput::getCreatedDate() const {
    return m_created_date;
}
void OAICreatePolicyTemplateOutput::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICreatePolicyTemplateOutput::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICreatePolicyTemplateOutput::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAICreatePolicyTemplateOutput::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAICreatePolicyTemplateOutput::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAICreatePolicyTemplateOutput::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAICreatePolicyTemplateOutput::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAICreatePolicyTemplateOutput::isSet() const {
...
bool OAICreatePolicyTemplateOutput::isValid() const {
