...
/*
 * OAIGetPolicyStoreOutput.h
 *
 * 
 */

#ifndef OAIGetPolicyStoreOutput_H
#define OAIGetPolicyStoreOutput_H
...
namespace OpenAPI {
class OAIGetPolicyStoreOutput_validationSettings;

class OAIGetPolicyStoreOutput : public OAIObject {
public:
    OAIGetPolicyStoreOutput();
    OAIGetPolicyStoreOutput(QString json);
    ~OAIGetPolicyStoreOutput() override;
    ...
    OAIGetPolicyStoreOutput_validationSettings getValidationSettings() const;
    void setValidationSettings(const OAIGetPolicyStoreOutput_validationSettings &validation_settings);
...
private:
    ...
    OAIGetPolicyStoreOutput_validationSettings m_validation_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyStoreOutput)

#endif // OAIGetPolicyStoreOutput_H
