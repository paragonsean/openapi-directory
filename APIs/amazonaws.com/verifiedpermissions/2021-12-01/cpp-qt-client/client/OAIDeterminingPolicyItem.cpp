...
#include "OAIDeterminingPolicyItem.h"
...
OAIDeterminingPolicyItem::OAIDeterminingPolicyItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeterminingPolicyItem::OAIDeterminingPolicyItem() {
    this->initializeModel();
}

OAIDeterminingPolicyItem::~OAIDeterminingPolicyItem() {}

void OAIDeterminingPolicyItem::initializeModel() {

    m_policy_id_isSet = false;
    m_policy_id_isValid = false;
}

void OAIDeterminingPolicyItem::fromJson(QString jsonString) {
...
void OAIDeterminingPolicyItem::fromJsonObject(QJsonObject json) {
...
QString OAIDeterminingPolicyItem::asJson() const {
...
QJsonObject OAIDeterminingPolicyItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeterminingPolicyItem::getPolicyId() const {
    return m_policy_id;
}
void OAIDeterminingPolicyItem::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIDeterminingPolicyItem::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIDeterminingPolicyItem::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

bool OAIDeterminingPolicyItem::isSet() const {
...
bool OAIDeterminingPolicyItem::isValid() const {
