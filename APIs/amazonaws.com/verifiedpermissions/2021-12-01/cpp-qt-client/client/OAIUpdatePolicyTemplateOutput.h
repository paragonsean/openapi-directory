...
/*
 * OAIUpdatePolicyTemplateOutput.h
 *
 * 
 */

#ifndef OAIUpdatePolicyTemplateOutput_H
#define OAIUpdatePolicyTemplateOutput_H
...
class OAIUpdatePolicyTemplateOutput : public OAIObject {
public:
    OAIUpdatePolicyTemplateOutput();
    OAIUpdatePolicyTemplateOutput(QString json);
    ~OAIUpdatePolicyTemplateOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyTemplateOutput)

#endif // OAIUpdatePolicyTemplateOutput_H
