...
OAICreatePolicyStoreInput_validationSettings::OAICreatePolicyStoreInput_validationSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyStoreInput_validationSettings::OAICreatePolicyStoreInput_validationSettings() {
    this->initializeModel();
}

OAICreatePolicyStoreInput_validationSettings::~OAICreatePolicyStoreInput_validationSettings() {}

void OAICreatePolicyStoreInput_validationSettings::initializeModel() {

    m_mode_isSet = false;
    m_mode_isValid = false;
}

void OAICreatePolicyStoreInput_validationSettings::fromJson(QString jsonString) {
...
void OAICreatePolicyStoreInput_validationSettings::fromJsonObject(QJsonObject json) {

    m_mode_isValid = ::OpenAPI::fromJsonValue(m_mode, json[QString("mode")]);
    m_mode_isSet = !json[QString("mode")].isNull() && m_mode_isValid;
}

QString OAICreatePolicyStoreInput_validationSettings::asJson() const {
...
QJsonObject OAICreatePolicyStoreInput_validationSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_mode.isSet()) {
...
OAIValidationMode OAICreatePolicyStoreInput_validationSettings::getMode() const {
    return m_mode;
}
void OAICreatePolicyStoreInput_validationSettings::setMode(const OAIValidationMode &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAICreatePolicyStoreInput_validationSettings::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAICreatePolicyStoreInput_validationSettings::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAICreatePolicyStoreInput_validationSettings::isSet() const {
...
bool OAICreatePolicyStoreInput_validationSettings::isValid() const {
