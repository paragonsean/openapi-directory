...
#include "OAIUpdatePolicyInput_definition.h"
...
OAIUpdatePolicyInput_definition::OAIUpdatePolicyInput_definition(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdatePolicyInput_definition::OAIUpdatePolicyInput_definition() {
    this->initializeModel();
}

OAIUpdatePolicyInput_definition::~OAIUpdatePolicyInput_definition() {}

void OAIUpdatePolicyInput_definition::initializeModel() {

    m_r_static_isSet = false;
    m_r_static_isValid = false;
}

void OAIUpdatePolicyInput_definition::fromJson(QString jsonString) {
...
void OAIUpdatePolicyInput_definition::fromJsonObject(QJsonObject json) {
...
QString OAIUpdatePolicyInput_definition::asJson() const {
...
QJsonObject OAIUpdatePolicyInput_definition::asJsonObject() const {
    QJsonObject obj;
    if (m_r_static.isSet()) {
...
OAIUpdatePolicyDefinition_static OAIUpdatePolicyInput_definition::getRStatic() const {
    return m_r_static;
}
void OAIUpdatePolicyInput_definition::setRStatic(const OAIUpdatePolicyDefinition_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAIUpdatePolicyInput_definition::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAIUpdatePolicyInput_definition::is_r_static_Valid() const{
    return m_r_static_isValid;
}

bool OAIUpdatePolicyInput_definition::isSet() const {
...
bool OAIUpdatePolicyInput_definition::isValid() const {
