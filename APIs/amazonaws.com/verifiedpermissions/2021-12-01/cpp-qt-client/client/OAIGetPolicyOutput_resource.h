...
/*
 * OAIGetPolicyOutput_resource.h
 *
 * 
 */

#ifndef OAIGetPolicyOutput_resource_H
#define OAIGetPolicyOutput_resource_H
...
class OAIGetPolicyOutput_resource : public OAIObject {
public:
    OAIGetPolicyOutput_resource();
    OAIGetPolicyOutput_resource(QString json);
    ~OAIGetPolicyOutput_resource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyOutput_resource)

#endif // OAIGetPolicyOutput_resource_H
