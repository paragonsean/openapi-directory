...
/*
 * OAIIsAuthorizedInput_action.h
 *
 * 
 */

#ifndef OAIIsAuthorizedInput_action_H
#define OAIIsAuthorizedInput_action_H
...
class OAIIsAuthorizedInput_action : public OAIObject {
public:
    OAIIsAuthorizedInput_action();
    OAIIsAuthorizedInput_action(QString json);
    ~OAIIsAuthorizedInput_action() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIsAuthorizedInput_action)

#endif // OAIIsAuthorizedInput_action_H
