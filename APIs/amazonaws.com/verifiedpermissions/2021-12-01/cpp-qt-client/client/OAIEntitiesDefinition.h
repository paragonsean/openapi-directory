...
#ifndef OAIEntitiesDefinition_H
#define OAIEntitiesDefinition_H
...
class OAIEntitiesDefinition : public OAIObject {
public:
    OAIEntitiesDefinition();
    OAIEntitiesDefinition(QString json);
    ~OAIEntitiesDefinition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEntitiesDefinition)

#endif // OAIEntitiesDefinition_H
