...
OAIIsAuthorizedInput_entities::OAIIsAuthorizedInput_entities(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIsAuthorizedInput_entities::OAIIsAuthorizedInput_entities() {
    this->initializeModel();
}

OAIIsAuthorizedInput_entities::~OAIIsAuthorizedInput_entities() {}

void OAIIsAuthorizedInput_entities::initializeModel() {

    m_entity_list_isSet = false;
    m_entity_list_isValid = false;
}

void OAIIsAuthorizedInput_entities::fromJson(QString jsonString) {
...
void OAIIsAuthorizedInput_entities::fromJsonObject(QJsonObject json) {
...
QString OAIIsAuthorizedInput_entities::asJson() const {
...
QJsonObject OAIIsAuthorizedInput_entities::asJsonObject() const {
    QJsonObject obj;
...
QList OAIIsAuthorizedInput_entities::getEntityList() const {
    return m_entity_list;
}
void OAIIsAuthorizedInput_entities::setEntityList(const QList &entity_list) {
    m_entity_list = entity_list;
    m_entity_list_isSet = true;
}

bool OAIIsAuthorizedInput_entities::is_entity_list_Set() const{
    return m_entity_list_isSet;
}

bool OAIIsAuthorizedInput_entities::is_entity_list_Valid() const{
    return m_entity_list_isValid;
}

bool OAIIsAuthorizedInput_entities::isSet() const {
...
bool OAIIsAuthorizedInput_entities::isValid() const {
