...
#ifndef OAIIdentitySourceItem_H
#define OAIIdentitySourceItem_H
...
namespace OpenAPI {
class OAIIdentitySourceItem_details;

class OAIIdentitySourceItem : public OAIObject {
public:
    OAIIdentitySourceItem();
    OAIIdentitySourceItem(QString json);
    ~OAIIdentitySourceItem() override;
    ...
    OAIIdentitySourceItem_details getDetails() const;
    void setDetails(const OAIIdentitySourceItem_details &details);
...
private:
    ...
    OAIIdentitySourceItem_details m_details;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIdentitySourceItem)

#endif // OAIIdentitySourceItem_H
