...
/*
 * OAICreatePolicyTemplateInput.h
 *
 * 
 */

#ifndef OAICreatePolicyTemplateInput_H
#define OAICreatePolicyTemplateInput_H
...
class OAICreatePolicyTemplateInput : public OAIObject {
public:
    OAICreatePolicyTemplateInput();
    OAICreatePolicyTemplateInput(QString json);
    ~OAICreatePolicyTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyTemplateInput)

#endif // OAICreatePolicyTemplateInput_H
