...
/*
 * OAICreatePolicyInput_definition.h
 *
 * 
 */

#ifndef OAICreatePolicyInput_definition_H
#define OAICreatePolicyInput_definition_H
...
class OAICreatePolicyInput_definition : public OAIObject {
public:
    OAICreatePolicyInput_definition();
    OAICreatePolicyInput_definition(QString json);
    ~OAICreatePolicyInput_definition() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreatePolicyInput_definition)

#endif // OAICreatePolicyInput_definition_H
