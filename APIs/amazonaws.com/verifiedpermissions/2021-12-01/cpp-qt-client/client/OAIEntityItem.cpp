...
OAIEntityItem::OAIEntityItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEntityItem::OAIEntityItem() {
    this->initializeModel();
}

OAIEntityItem::~OAIEntityItem() {}

void OAIEntityItem::initializeModel() {
...
void OAIEntityItem::fromJson(QString jsonString) {
...
void OAIEntityItem::fromJsonObject(QJsonObject json) {
...
QString OAIEntityItem::asJson() const {
...
QJsonObject OAIEntityItem::asJsonObject() const {
    QJsonObject obj;
...
OAIEntityItem_identifier OAIEntityItem::getIdentifier() const {
    return m_identifier;
}
void OAIEntityItem::setIdentifier(const OAIEntityItem_identifier &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIEntityItem::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIEntityItem::is_identifier_Valid() const{
    return m_identifier_isValid;
}

QMap OAIEntityItem::getAttributes() const {
    return m_attributes;
}
void OAIEntityItem::setAttributes(const QMap &attributes) {
    m_attributes = attributes;
    m_attributes_isSet = true;
}

bool OAIEntityItem::is_attributes_Set() const{
    return m_attributes_isSet;
}

bool OAIEntityItem::is_attributes_Valid() const{
    return m_attributes_isValid;
}

QList OAIEntityItem::getParents() const {
    return m_parents;
}
void OAIEntityItem::setParents(const QList &parents) {
    m_parents = parents;
    m_parents_isSet = true;
}

bool OAIEntityItem::is_parents_Set() const{
    return m_parents_isSet;
}

bool OAIEntityItem::is_parents_Valid() const{
    return m_parents_isValid;
}

bool OAIEntityItem::isSet() const {
...
bool OAIEntityItem::isValid() const {
