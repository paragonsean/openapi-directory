...
OAIPolicyItem_resource::OAIPolicyItem_resource(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyItem_resource::OAIPolicyItem_resource() {
    this->initializeModel();
}

OAIPolicyItem_resource::~OAIPolicyItem_resource() {}

void OAIPolicyItem_resource::initializeModel() {
...
void OAIPolicyItem_resource::fromJson(QString jsonString) {
...
void OAIPolicyItem_resource::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyItem_resource::asJson() const {
...
QJsonObject OAIPolicyItem_resource::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyItem_resource::getEntityType() const {
    return m_entity_type;
}
void OAIPolicyItem_resource::setEntityType(const QString &entity_type) {
    m_entity_type = entity_type;
    m_entity_type_isSet = true;
}

bool OAIPolicyItem_resource::is_entity_type_Set() const{
    return m_entity_type_isSet;
}

bool OAIPolicyItem_resource::is_entity_type_Valid() const{
    return m_entity_type_isValid;
}

QString OAIPolicyItem_resource::getEntityId() const {
    return m_entity_id;
}
void OAIPolicyItem_resource::setEntityId(const QString &entity_id) {
    m_entity_id = entity_id;
    m_entity_id_isSet = true;
}

bool OAIPolicyItem_resource::is_entity_id_Set() const{
    return m_entity_id_isSet;
}

bool OAIPolicyItem_resource::is_entity_id_Valid() const{
    return m_entity_id_isValid;
}

bool OAIPolicyItem_resource::isSet() const {
...
bool OAIPolicyItem_resource::isValid() const {
