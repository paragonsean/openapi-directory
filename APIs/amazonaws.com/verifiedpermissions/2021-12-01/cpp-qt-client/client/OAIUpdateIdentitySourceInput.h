...
/*
 * OAIUpdateIdentitySourceInput.h
 *
 * 
 */

#ifndef OAIUpdateIdentitySourceInput_H
#define OAIUpdateIdentitySourceInput_H

#include <QJsonObject>

#include "OAIUpdateIdentitySourceInput_updateConfiguration.h"
#include <QString>
...
namespace OpenAPI {
class OAIUpdateIdentitySourceInput_updateConfiguration;

class OAIUpdateIdentitySourceInput : public OAIObject {
public:
    OAIUpdateIdentitySourceInput();
    OAIUpdateIdentitySourceInput(QString json);
    ~OAIUpdateIdentitySourceInput() override;
    ...
    QString getIdentitySourceId() const;
    void setIdentitySourceId(const QString &identity_source_id);
    bool is_identity_source_id_Set() const;
    bool is_identity_source_id_Valid() const;

    OAIUpdateIdentitySourceInput_updateConfiguration getUpdateConfiguration() const;
    void setUpdateConfiguration(const OAIUpdateIdentitySourceInput_updateConfiguration &update_configuration);
    bool is_update_configuration_Set() const;
    bool is_update_configuration_Valid() const;

    QString getPrincipalEntityType() const;
    void setPrincipalEntityType(const QString &principal_entity_type);
    bool is_principal_entity_type_Set() const;
    bool is_principal_entity_type_Valid() const;
...
private:
    ...
    QString m_identity_source_id;
    bool m_identity_source_id_isSet;
    bool m_identity_source_id_isValid;

    OAIUpdateIdentitySourceInput_updateConfiguration m_update_configuration;
    bool m_update_configuration_isSet;
    bool m_update_configuration_isValid;

    QString m_principal_entity_type;
    bool m_principal_entity_type_isSet;
    bool m_principal_entity_type_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIdentitySourceInput)

#endif // OAIUpdateIdentitySourceInput_H
