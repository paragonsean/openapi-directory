...
#ifndef OAIEvaluationErrorItem_H
#define OAIEvaluationErrorItem_H
...
class OAIEvaluationErrorItem : public OAIObject {
public:
    OAIEvaluationErrorItem();
    OAIEvaluationErrorItem(QString json);
    ~OAIEvaluationErrorItem() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluationErrorItem)

#endif // OAIEvaluationErrorItem_H
