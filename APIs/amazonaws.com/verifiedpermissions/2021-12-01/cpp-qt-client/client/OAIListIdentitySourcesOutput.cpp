...
OAIListIdentitySourcesOutput::OAIListIdentitySourcesOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListIdentitySourcesOutput::OAIListIdentitySourcesOutput() {
    this->initializeModel();
}

OAIListIdentitySourcesOutput::~OAIListIdentitySourcesOutput() {}

void OAIListIdentitySourcesOutput::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_identity_sources_isSet = false;
    m_identity_sources_isValid = false;
}

void OAIListIdentitySourcesOutput::fromJson(QString jsonString) {
...
void OAIListIdentitySourcesOutput::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("nextToken")]);
    m_next_token_isSet = !json[QString("nextToken")].isNull() && m_next_token_isValid;

    m_identity_sources_isValid = ::OpenAPI::fromJsonValue(m_identity_sources, json[QString("identitySources")]);
    m_identity_sources_isSet = !json[QString("identitySources")].isNull() && m_identity_sources_isValid;
}

QString OAIListIdentitySourcesOutput::asJson() const {
...
QJsonObject OAIListIdentitySourcesOutput::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("nextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_identity_sources.isSet()) {
        obj.insert(QString("identitySources"), ::OpenAPI::toJsonValue(m_identity_sources));
    }
    return obj;
}

QString OAIListIdentitySourcesOutput::getNextToken() const {
    return m_next_token;
}
void OAIListIdentitySourcesOutput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListIdentitySourcesOutput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListIdentitySourcesOutput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListIdentitySourcesOutput::getIdentitySources() const {
    return m_identity_sources;
}
void OAIListIdentitySourcesOutput::setIdentitySources(const QList &identity_sources) {
    m_identity_sources = identity_sources;
    m_identity_sources_isSet = true;
}

bool OAIListIdentitySourcesOutput::is_identity_sources_Set() const{
    return m_identity_sources_isSet;
}

bool OAIListIdentitySourcesOutput::is_identity_sources_Valid() const{
    return m_identity_sources_isValid;
}

bool OAIListIdentitySourcesOutput::isSet() const {
...
bool OAIListIdentitySourcesOutput::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_identity_sources_isValid && true;
}
