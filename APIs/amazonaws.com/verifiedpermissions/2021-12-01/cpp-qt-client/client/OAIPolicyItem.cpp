...
OAIPolicyItem::OAIPolicyItem(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyItem::OAIPolicyItem() {
    this->initializeModel();
}

OAIPolicyItem::~OAIPolicyItem() {}

void OAIPolicyItem::initializeModel() {
...
void OAIPolicyItem::fromJson(QString jsonString) {
...
void OAIPolicyItem::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyItem::asJson() const {
...
QJsonObject OAIPolicyItem::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPolicyItem::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIPolicyItem::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIPolicyItem::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIPolicyItem::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIPolicyItem::getPolicyId() const {
    return m_policy_id;
}
void OAIPolicyItem::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAIPolicyItem::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAIPolicyItem::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

OAIPolicyType OAIPolicyItem::getPolicyType() const {
    return m_policy_type;
}
void OAIPolicyItem::setPolicyType(const OAIPolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAIPolicyItem::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAIPolicyItem::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

OAIPolicyItem_principal OAIPolicyItem::getPrincipal() const {
    return m_principal;
}
void OAIPolicyItem::setPrincipal(const OAIPolicyItem_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAIPolicyItem::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAIPolicyItem::is_principal_Valid() const{
    return m_principal_isValid;
}

OAIPolicyItem_resource OAIPolicyItem::getResource() const {
    return m_resource;
}
void OAIPolicyItem::setResource(const OAIPolicyItem_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAIPolicyItem::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAIPolicyItem::is_resource_Valid() const{
    return m_resource_isValid;
}

OAIPolicyItem_definition OAIPolicyItem::getDefinition() const {
    return m_definition;
}
void OAIPolicyItem::setDefinition(const OAIPolicyItem_definition &definition) {
    m_definition = definition;
    m_definition_isSet = true;
}

bool OAIPolicyItem::is_definition_Set() const{
    return m_definition_isSet;
}

bool OAIPolicyItem::is_definition_Valid() const{
    return m_definition_isValid;
}

QDateTime OAIPolicyItem::getCreatedDate() const {
    return m_created_date;
}
void OAIPolicyItem::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAIPolicyItem::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAIPolicyItem::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAIPolicyItem::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAIPolicyItem::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAIPolicyItem::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAIPolicyItem::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAIPolicyItem::isSet() const {
...
bool OAIPolicyItem::isValid() const {
