...
#ifndef OAIGetPolicyInput_H
#define OAIGetPolicyInput_H
...
class OAIGetPolicyInput : public OAIObject {
public:
    OAIGetPolicyInput();
    OAIGetPolicyInput(QString json);
    ~OAIGetPolicyInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyInput)

#endif // OAIGetPolicyInput_H
