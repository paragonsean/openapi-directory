...
/*
 * OAIUpdatePolicyTemplateInput.h
 *
 * 
 */

#ifndef OAIUpdatePolicyTemplateInput_H
#define OAIUpdatePolicyTemplateInput_H
...
class OAIUpdatePolicyTemplateInput : public OAIObject {
public:
    OAIUpdatePolicyTemplateInput();
    OAIUpdatePolicyTemplateInput(QString json);
    ~OAIUpdatePolicyTemplateInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyTemplateInput)

#endif // OAIUpdatePolicyTemplateInput_H
