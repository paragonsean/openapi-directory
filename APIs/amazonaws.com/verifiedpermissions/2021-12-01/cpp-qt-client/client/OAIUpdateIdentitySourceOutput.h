...
/*
 * OAIUpdateIdentitySourceOutput.h
 *
 * 
 */

#ifndef OAIUpdateIdentitySourceOutput_H
#define OAIUpdateIdentitySourceOutput_H
...
class OAIUpdateIdentitySourceOutput : public OAIObject {
public:
    OAIUpdateIdentitySourceOutput();
    OAIUpdateIdentitySourceOutput(QString json);
    ~OAIUpdateIdentitySourceOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateIdentitySourceOutput)

#endif // OAIUpdateIdentitySourceOutput_H
