...
OAIConfiguration_cognitoUserPoolConfiguration OAIConfiguration::getCognitoUserPoolConfiguration() const {
    return m_cognito_user_pool_configuration;
}
void OAIConfiguration::setCognitoUserPoolConfiguration(const OAIConfiguration_cognitoUserPoolConfiguration &cognito_user_pool_configuration) {
    m_cognito_user_pool_configuration = cognito_user_pool_configuration;
    m_cognito_user_pool_configuration_isSet = true;
}

bool OAIConfiguration::is_cognito_user_pool_configuration_Set() const{
    return m_cognito_user_pool_configuration_isSet;
}

bool OAIConfiguration::is_cognito_user_pool_configuration_Valid() const{
