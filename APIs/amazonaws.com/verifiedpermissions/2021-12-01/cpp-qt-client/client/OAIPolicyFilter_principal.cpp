...
OAIPolicyFilter_principal::OAIPolicyFilter_principal(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPolicyFilter_principal::OAIPolicyFilter_principal() {
    this->initializeModel();
}

OAIPolicyFilter_principal::~OAIPolicyFilter_principal() {}

void OAIPolicyFilter_principal::initializeModel() {
...
void OAIPolicyFilter_principal::fromJson(QString jsonString) {
...
void OAIPolicyFilter_principal::fromJsonObject(QJsonObject json) {
...
QString OAIPolicyFilter_principal::asJson() const {
...
QJsonObject OAIPolicyFilter_principal::asJsonObject() const {
    QJsonObject obj;
...
bool OAIPolicyFilter_principal::getUnspecified() const {
    return m_unspecified;
}
void OAIPolicyFilter_principal::setUnspecified(const bool &unspecified) {
    m_unspecified = unspecified;
    m_unspecified_isSet = true;
}

bool OAIPolicyFilter_principal::is_unspecified_Set() const{
    return m_unspecified_isSet;
}

bool OAIPolicyFilter_principal::is_unspecified_Valid() const{
    return m_unspecified_isValid;
}

OAIEntityReference_identifier OAIPolicyFilter_principal::getIdentifier() const {
    return m_identifier;
}
void OAIPolicyFilter_principal::setIdentifier(const OAIEntityReference_identifier &identifier) {
    m_identifier = identifier;
    m_identifier_isSet = true;
}

bool OAIPolicyFilter_principal::is_identifier_Set() const{
    return m_identifier_isSet;
}

bool OAIPolicyFilter_principal::is_identifier_Valid() const{
    return m_identifier_isValid;
}

bool OAIPolicyFilter_principal::isSet() const {
...
bool OAIPolicyFilter_principal::isValid() const {
