...
#include "OAIPolicyDefinition_static.h"
...
namespace OpenAPI {
class OAIPolicyDefinition_static;
class OAIPolicyDefinition_templateLinked;
...
public:
    ...
    OAIPolicyDefinition_static getRStatic() const;
    void setRStatic(const OAIPolicyDefinition_static &r_static);
    bool is_r_static_Set() const;
    bool is_r_static_Valid() const;

    OAIPolicyDefinition_templateLinked getTemplateLinked() const;
    void setTemplateLinked(const OAIPolicyDefinition_templateLinked &template_linked);
...
private:
    ...
    OAIPolicyDefinition_static m_r_static;
    bool m_r_static_isSet;
    bool m_r_static_isValid;

    OAIPolicyDefinition_templateLinked m_template_linked;
