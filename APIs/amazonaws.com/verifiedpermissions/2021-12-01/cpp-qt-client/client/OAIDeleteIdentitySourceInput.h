...
/*
 * OAIDeleteIdentitySourceInput.h
 *
 * 
 */

#ifndef OAIDeleteIdentitySourceInput_H
#define OAIDeleteIdentitySourceInput_H
...
class OAIDeleteIdentitySourceInput : public OAIObject {
public:
    OAIDeleteIdentitySourceInput();
    OAIDeleteIdentitySourceInput(QString json);
    ~OAIDeleteIdentitySourceInput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteIdentitySourceInput)

#endif // OAIDeleteIdentitySourceInput_H
