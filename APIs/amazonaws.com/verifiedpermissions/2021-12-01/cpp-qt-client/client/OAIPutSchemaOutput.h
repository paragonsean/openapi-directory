...
/*
 * OAIPutSchemaOutput.h
 *
 * 
 */

#ifndef OAIPutSchemaOutput_H
#define OAIPutSchemaOutput_H
...
class OAIPutSchemaOutput : public OAIObject {
public:
    OAIPutSchemaOutput();
    OAIPutSchemaOutput(QString json);
    ~OAIPutSchemaOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSchemaOutput)

#endif // OAIPutSchemaOutput_H
