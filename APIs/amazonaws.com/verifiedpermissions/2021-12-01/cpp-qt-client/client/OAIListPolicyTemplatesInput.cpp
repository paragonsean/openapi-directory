...
OAIListPolicyTemplatesInput::OAIListPolicyTemplatesInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPolicyTemplatesInput::OAIListPolicyTemplatesInput() {
    this->initializeModel();
}

OAIListPolicyTemplatesInput::~OAIListPolicyTemplatesInput() {}

void OAIListPolicyTemplatesInput::initializeModel() {
...
void OAIListPolicyTemplatesInput::fromJson(QString jsonString) {
...
void OAIListPolicyTemplatesInput::fromJsonObject(QJsonObject json) {
...
QString OAIListPolicyTemplatesInput::asJson() const {
...
QJsonObject OAIListPolicyTemplatesInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListPolicyTemplatesInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIListPolicyTemplatesInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIListPolicyTemplatesInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIListPolicyTemplatesInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAIListPolicyTemplatesInput::getNextToken() const {
    return m_next_token;
}
void OAIListPolicyTemplatesInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPolicyTemplatesInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPolicyTemplatesInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPolicyTemplatesInput::getMaxResults() const {
    return m_max_results;
}
void OAIListPolicyTemplatesInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPolicyTemplatesInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPolicyTemplatesInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListPolicyTemplatesInput::isSet() const {
...
bool OAIListPolicyTemplatesInput::isValid() const {
