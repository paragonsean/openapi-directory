...
OAIDeletePolicyStoreInput::OAIDeletePolicyStoreInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeletePolicyStoreInput::OAIDeletePolicyStoreInput() {
    this->initializeModel();
}

OAIDeletePolicyStoreInput::~OAIDeletePolicyStoreInput() {}

void OAIDeletePolicyStoreInput::initializeModel() {

    m_policy_store_id_isSet = false;
    m_policy_store_id_isValid = false;
}

void OAIDeletePolicyStoreInput::fromJson(QString jsonString) {
...
void OAIDeletePolicyStoreInput::fromJsonObject(QJsonObject json) {
...
QString OAIDeletePolicyStoreInput::asJson() const {
...
QJsonObject OAIDeletePolicyStoreInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeletePolicyStoreInput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAIDeletePolicyStoreInput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAIDeletePolicyStoreInput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAIDeletePolicyStoreInput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

bool OAIDeletePolicyStoreInput::isSet() const {
...
bool OAIDeletePolicyStoreInput::isValid() const {
