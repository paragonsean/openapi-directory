...
void OAISchemaDefinition::initializeModel() {
    ...
    m_cedar_json_isSet = false;
    m_cedar_json_isValid = false;
}
...
void OAISchemaDefinition::fromJsonObject(QJsonObject json) {
    ...
    m_cedar_json_isValid = ::OpenAPI::fromJsonValue(m_cedar_json, json[QString("cedarJson")]);
    m_cedar_json_isSet = !json[QString("cedarJson")].isNull() && m_cedar_json_isValid;
}
...
QJsonObject OAISchemaDefinition::asJsonObject() const {
    QJsonObject obj;
    if (m_cedar_json_isSet) {
        obj.insert(QString("cedarJson"), ::OpenAPI::toJsonValue(m_cedar_json));
    }
    return obj;
}

QString OAISchemaDefinition::getCedarJson() const {
    return m_cedar_json;
}
void OAISchemaDefinition::setCedarJson(const QString &cedar_json) {
    m_cedar_json = cedar_json;
    m_cedar_json_isSet = true;
}

bool OAISchemaDefinition::is_cedar_json_Set() const{
    return m_cedar_json_isSet;
}

bool OAISchemaDefinition::is_cedar_json_Valid() const{
    return m_cedar_json_isValid;
}
