...
OAICreatePolicyOutput::OAICreatePolicyOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreatePolicyOutput::OAICreatePolicyOutput() {
    this->initializeModel();
}

OAICreatePolicyOutput::~OAICreatePolicyOutput() {}

void OAICreatePolicyOutput::initializeModel() {
...
void OAICreatePolicyOutput::fromJson(QString jsonString) {
...
void OAICreatePolicyOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreatePolicyOutput::asJson() const {
...
QJsonObject OAICreatePolicyOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreatePolicyOutput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAICreatePolicyOutput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAICreatePolicyOutput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAICreatePolicyOutput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

QString OAICreatePolicyOutput::getPolicyId() const {
    return m_policy_id;
}
void OAICreatePolicyOutput::setPolicyId(const QString &policy_id) {
    m_policy_id = policy_id;
    m_policy_id_isSet = true;
}

bool OAICreatePolicyOutput::is_policy_id_Set() const{
    return m_policy_id_isSet;
}

bool OAICreatePolicyOutput::is_policy_id_Valid() const{
    return m_policy_id_isValid;
}

OAIPolicyType OAICreatePolicyOutput::getPolicyType() const {
    return m_policy_type;
}
void OAICreatePolicyOutput::setPolicyType(const OAIPolicyType &policy_type) {
    m_policy_type = policy_type;
    m_policy_type_isSet = true;
}

bool OAICreatePolicyOutput::is_policy_type_Set() const{
    return m_policy_type_isSet;
}

bool OAICreatePolicyOutput::is_policy_type_Valid() const{
    return m_policy_type_isValid;
}

OAICreatePolicyOutput_principal OAICreatePolicyOutput::getPrincipal() const {
    return m_principal;
}
void OAICreatePolicyOutput::setPrincipal(const OAICreatePolicyOutput_principal &principal) {
    m_principal = principal;
    m_principal_isSet = true;
}

bool OAICreatePolicyOutput::is_principal_Set() const{
    return m_principal_isSet;
}

bool OAICreatePolicyOutput::is_principal_Valid() const{
    return m_principal_isValid;
}

OAICreatePolicyOutput_resource OAICreatePolicyOutput::getResource() const {
    return m_resource;
}
void OAICreatePolicyOutput::setResource(const OAICreatePolicyOutput_resource &resource) {
    m_resource = resource;
    m_resource_isSet = true;
}

bool OAICreatePolicyOutput::is_resource_Set() const{
    return m_resource_isSet;
}

bool OAICreatePolicyOutput::is_resource_Valid() const{
    return m_resource_isValid;
}

QDateTime OAICreatePolicyOutput::getCreatedDate() const {
    return m_created_date;
}
void OAICreatePolicyOutput::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICreatePolicyOutput::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICreatePolicyOutput::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QDateTime OAICreatePolicyOutput::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAICreatePolicyOutput::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAICreatePolicyOutput::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAICreatePolicyOutput::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

bool OAICreatePolicyOutput::isSet() const {
...
bool OAICreatePolicyOutput::isValid() const {
