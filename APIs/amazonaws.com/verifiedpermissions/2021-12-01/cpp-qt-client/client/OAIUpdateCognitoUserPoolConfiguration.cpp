...
#include "OAIUpdateCognitoUserPoolConfiguration.h"
...
OAIUpdateCognitoUserPoolConfiguration::OAIUpdateCognitoUserPoolConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateCognitoUserPoolConfiguration::OAIUpdateCognitoUserPoolConfiguration() {
    this->initializeModel();
}

OAIUpdateCognitoUserPoolConfiguration::~OAIUpdateCognitoUserPoolConfiguration() {}

void OAIUpdateCognitoUserPoolConfiguration::initializeModel() {
...
void OAIUpdateCognitoUserPoolConfiguration::fromJson(QString jsonString) {
...
void OAIUpdateCognitoUserPoolConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateCognitoUserPoolConfiguration::asJson() const {
...
QJsonObject OAIUpdateCognitoUserPoolConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAIUpdateCognitoUserPoolConfiguration::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAIUpdateCognitoUserPoolConfiguration::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAIUpdateCognitoUserPoolConfiguration::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAIUpdateCognitoUserPoolConfiguration::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QList OAIUpdateCognitoUserPoolConfiguration::getClientIds() const {
    return m_client_ids;
}
void OAIUpdateCognitoUserPoolConfiguration::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAIUpdateCognitoUserPoolConfiguration::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAIUpdateCognitoUserPoolConfiguration::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

bool OAIUpdateCognitoUserPoolConfiguration::isSet() const {
...
bool OAIUpdateCognitoUserPoolConfiguration::isValid() const {
