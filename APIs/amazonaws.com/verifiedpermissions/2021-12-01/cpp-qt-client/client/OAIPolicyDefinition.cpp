...
OAIPolicyDefinition_static OAIPolicyDefinition::getRStatic() const {
    return m_r_static;
}
void OAIPolicyDefinition::setRStatic(const OAIPolicyDefinition_static &r_static) {
    m_r_static = r_static;
    m_r_static_isSet = true;
}

bool OAIPolicyDefinition::is_r_static_Set() const{
    return m_r_static_isSet;
}

bool OAIPolicyDefinition::is_r_static_Valid() const{
    return m_r_static_isValid;
}

OAIPolicyDefinition_templateLinked OAIPolicyDefinition::getTemplateLinked() const {
    return m_template_linked;
}
void OAIPolicyDefinition::setTemplateLinked(const OAIPolicyDefinition_templateLinked &template_linked) {
    m_template_linked = template_linked;
    m_template_linked_isSet = true;
}

bool OAIPolicyDefinition::is_template_linked_Set() const{
    return m_template_linked_isSet;
}

bool OAIPolicyDefinition::is_template_linked_Valid() const{
