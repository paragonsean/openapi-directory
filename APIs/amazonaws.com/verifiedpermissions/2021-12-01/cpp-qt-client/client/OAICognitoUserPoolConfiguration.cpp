...
#include "OAICognitoUserPoolConfiguration.h"
...
OAICognitoUserPoolConfiguration::OAICognitoUserPoolConfiguration(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICognitoUserPoolConfiguration::OAICognitoUserPoolConfiguration() {
    this->initializeModel();
}

OAICognitoUserPoolConfiguration::~OAICognitoUserPoolConfiguration() {}

void OAICognitoUserPoolConfiguration::initializeModel() {
...
void OAICognitoUserPoolConfiguration::fromJson(QString jsonString) {
...
void OAICognitoUserPoolConfiguration::fromJsonObject(QJsonObject json) {
...
QString OAICognitoUserPoolConfiguration::asJson() const {
...
QJsonObject OAICognitoUserPoolConfiguration::asJsonObject() const {
    QJsonObject obj;
...
QString OAICognitoUserPoolConfiguration::getUserPoolArn() const {
    return m_user_pool_arn;
}
void OAICognitoUserPoolConfiguration::setUserPoolArn(const QString &user_pool_arn) {
    m_user_pool_arn = user_pool_arn;
    m_user_pool_arn_isSet = true;
}

bool OAICognitoUserPoolConfiguration::is_user_pool_arn_Set() const{
    return m_user_pool_arn_isSet;
}

bool OAICognitoUserPoolConfiguration::is_user_pool_arn_Valid() const{
    return m_user_pool_arn_isValid;
}

QList OAICognitoUserPoolConfiguration::getClientIds() const {
    return m_client_ids;
}
void OAICognitoUserPoolConfiguration::setClientIds(const QList &client_ids) {
    m_client_ids = client_ids;
    m_client_ids_isSet = true;
}

bool OAICognitoUserPoolConfiguration::is_client_ids_Set() const{
    return m_client_ids_isSet;
}

bool OAICognitoUserPoolConfiguration::is_client_ids_Valid() const{
    return m_client_ids_isValid;
}

bool OAICognitoUserPoolConfiguration::isSet() const {
...
bool OAICognitoUserPoolConfiguration::isValid() const {
