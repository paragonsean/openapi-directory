...
void OAIPolicyType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("STATIC", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::STATIC;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TEMPLATE_LINKED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPolicyType::TEMPLATE_LINKED;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAIPolicyType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIPolicyType::STATIC:
            val = "STATIC";
            break;
        case eOAIPolicyType::TEMPLATE_LINKED:
            val = "TEMPLATE_LINKED";
            break;
        default:
            break;
