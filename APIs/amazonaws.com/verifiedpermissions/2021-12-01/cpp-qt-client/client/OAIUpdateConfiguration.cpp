...
void OAIUpdateConfiguration::initializeModel() {
    ...
    m_cognito_user_pool_configuration_isSet = false;
    m_cognito_user_pool_configuration_isValid = false;
}
...
void OAIUpdateConfiguration::fromJsonObject(QJsonObject json) {
    ...
    m_cognito_user_pool_configuration_isValid = ::OpenAPI::fromJsonValue(m_cognito_user_pool_configuration, json[QString("cognitoUserPoolConfiguration")]);
    m_cognito_user_pool_configuration_isSet = !json[QString("cognitoUserPoolConfiguration")].isNull() && m_cognito_user_pool_configuration_isValid;
}
...
QJsonObject OAIUpdateConfiguration::asJsonObject() const {
    QJsonObject obj;
    if (m_cognito_user_pool_configuration.isSet()) {
        obj.insert(QString("cognitoUserPoolConfiguration"), ::OpenAPI::toJsonValue(m_cognito_user_pool_configuration));
    }
    return obj;
}

OAIUpdateConfiguration_cognitoUserPoolConfiguration OAIUpdateConfiguration::getCognitoUserPoolConfiguration() const {
    return m_cognito_user_pool_configuration;
}
void OAIUpdateConfiguration::setCognitoUserPoolConfiguration(const OAIUpdateConfiguration_cognitoUserPoolConfiguration &cognito_user_pool_configuration) {
    m_cognito_user_pool_configuration = cognito_user_pool_configuration;
    m_cognito_user_pool_configuration_isSet = true;
}

bool OAIUpdateConfiguration::is_cognito_user_pool_configuration_Set() const{
    return m_cognito_user_pool_configuration_isSet;
}

bool OAIUpdateConfiguration::is_cognito_user_pool_configuration_Valid() const{
    return m_cognito_user_pool_configuration_isValid;
}
