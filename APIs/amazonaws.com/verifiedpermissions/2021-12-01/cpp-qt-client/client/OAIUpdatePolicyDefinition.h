...
#ifndef OAIUpdatePolicyDefinition_H
#define OAIUpdatePolicyDefinition_H
...
namespace OpenAPI {
class OAIUpdatePolicyDefinition_static;

class OAIUpdatePolicyDefinition : public OAIObject {
public:
    OAIUpdatePolicyDefinition();
    OAIUpdatePolicyDefinition(QString json);
    ~OAIUpdatePolicyDefinition() override;
    ...
    OAIUpdatePolicyDefinition_static getRStatic() const;
    void setRStatic(const OAIUpdatePolicyDefinition_static &r_static);
...
private:
    ...
    OAIUpdatePolicyDefinition_static m_r_static;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdatePolicyDefinition)

#endif // OAIUpdatePolicyDefinition_H
