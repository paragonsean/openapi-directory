...
OAIListPolicyStoresInput::OAIListPolicyStoresInput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListPolicyStoresInput::OAIListPolicyStoresInput() {
    this->initializeModel();
}

OAIListPolicyStoresInput::~OAIListPolicyStoresInput() {}

void OAIListPolicyStoresInput::initializeModel() {
...
void OAIListPolicyStoresInput::fromJson(QString jsonString) {
...
void OAIListPolicyStoresInput::fromJsonObject(QJsonObject json) {
...
QString OAIListPolicyStoresInput::asJson() const {
...
QJsonObject OAIListPolicyStoresInput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListPolicyStoresInput::getNextToken() const {
    return m_next_token;
}
void OAIListPolicyStoresInput::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListPolicyStoresInput::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListPolicyStoresInput::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListPolicyStoresInput::getMaxResults() const {
    return m_max_results;
}
void OAIListPolicyStoresInput::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListPolicyStoresInput::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListPolicyStoresInput::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListPolicyStoresInput::isSet() const {
...
bool OAIListPolicyStoresInput::isValid() const {
