...
#include "OAIStaticPolicyDefinitionDetail.h"
...
OAIStaticPolicyDefinitionDetail::OAIStaticPolicyDefinitionDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStaticPolicyDefinitionDetail::OAIStaticPolicyDefinitionDetail() {
    this->initializeModel();
}

OAIStaticPolicyDefinitionDetail::~OAIStaticPolicyDefinitionDetail() {}

void OAIStaticPolicyDefinitionDetail::initializeModel() {
...
void OAIStaticPolicyDefinitionDetail::fromJson(QString jsonString) {
...
void OAIStaticPolicyDefinitionDetail::fromJsonObject(QJsonObject json) {
...
QString OAIStaticPolicyDefinitionDetail::asJson() const {
...
QJsonObject OAIStaticPolicyDefinitionDetail::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStaticPolicyDefinitionDetail::getDescription() const {
    return m_description;
}
void OAIStaticPolicyDefinitionDetail::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIStaticPolicyDefinitionDetail::is_description_Set() const{
    return m_description_isSet;
}

bool OAIStaticPolicyDefinitionDetail::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIStaticPolicyDefinitionDetail::getStatement() const {
    return m_statement;
}
void OAIStaticPolicyDefinitionDetail::setStatement(const QString &statement) {
    m_statement = statement;
    m_statement_isSet = true;
}

bool OAIStaticPolicyDefinitionDetail::is_statement_Set() const{
    return m_statement_isSet;
}

bool OAIStaticPolicyDefinitionDetail::is_statement_Valid() const{
    return m_statement_isValid;
}

bool OAIStaticPolicyDefinitionDetail::isSet() const {
...
bool OAIStaticPolicyDefinitionDetail::isValid() const {
