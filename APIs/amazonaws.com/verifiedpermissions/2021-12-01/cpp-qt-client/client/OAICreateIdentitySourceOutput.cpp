...
OAICreateIdentitySourceOutput::OAICreateIdentitySourceOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateIdentitySourceOutput::OAICreateIdentitySourceOutput() {
    this->initializeModel();
}

OAICreateIdentitySourceOutput::~OAICreateIdentitySourceOutput() {}

void OAICreateIdentitySourceOutput::initializeModel() {
...
void OAICreateIdentitySourceOutput::fromJson(QString jsonString) {
...
void OAICreateIdentitySourceOutput::fromJsonObject(QJsonObject json) {
...
QString OAICreateIdentitySourceOutput::asJson() const {
...
QJsonObject OAICreateIdentitySourceOutput::asJsonObject() const {
    QJsonObject obj;
...
QDateTime OAICreateIdentitySourceOutput::getCreatedDate() const {
    return m_created_date;
}
void OAICreateIdentitySourceOutput::setCreatedDate(const QDateTime &created_date) {
    m_created_date = created_date;
    m_created_date_isSet = true;
}

bool OAICreateIdentitySourceOutput::is_created_date_Set() const{
    return m_created_date_isSet;
}

bool OAICreateIdentitySourceOutput::is_created_date_Valid() const{
    return m_created_date_isValid;
}

QString OAICreateIdentitySourceOutput::getIdentitySourceId() const {
    return m_identity_source_id;
}
void OAICreateIdentitySourceOutput::setIdentitySourceId(const QString &identity_source_id) {
    m_identity_source_id = identity_source_id;
    m_identity_source_id_isSet = true;
}

bool OAICreateIdentitySourceOutput::is_identity_source_id_Set() const{
    return m_identity_source_id_isSet;
}

bool OAICreateIdentitySourceOutput::is_identity_source_id_Valid() const{
    return m_identity_source_id_isValid;
}

QDateTime OAICreateIdentitySourceOutput::getLastUpdatedDate() const {
    return m_last_updated_date;
}
void OAICreateIdentitySourceOutput::setLastUpdatedDate(const QDateTime &last_updated_date) {
    m_last_updated_date = last_updated_date;
    m_last_updated_date_isSet = true;
}

bool OAICreateIdentitySourceOutput::is_last_updated_date_Set() const{
    return m_last_updated_date_isSet;
}

bool OAICreateIdentitySourceOutput::is_last_updated_date_Valid() const{
    return m_last_updated_date_isValid;
}

QString OAICreateIdentitySourceOutput::getPolicyStoreId() const {
    return m_policy_store_id;
}
void OAICreateIdentitySourceOutput::setPolicyStoreId(const QString &policy_store_id) {
    m_policy_store_id = policy_store_id;
    m_policy_store_id_isSet = true;
}

bool OAICreateIdentitySourceOutput::is_policy_store_id_Set() const{
    return m_policy_store_id_isSet;
}

bool OAICreateIdentitySourceOutput::is_policy_store_id_Valid() const{
    return m_policy_store_id_isValid;
}

bool OAICreateIdentitySourceOutput::isSet() const {
...
bool OAICreateIdentitySourceOutput::isValid() const {
