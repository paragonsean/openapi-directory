...
/*
 * OAIGetPolicyOutput_definition.h
 *
 * 
 */

#ifndef OAIGetPolicyOutput_definition_H
#define OAIGetPolicyOutput_definition_H

#include <QJsonObject>

#include "OAIPolicyDefinitionDetail_static.h"
...
namespace OpenAPI {
class OAIPolicyDefinitionDetail_static;
class OAIPolicyDefinitionDetail_templateLinked;

class OAIGetPolicyOutput_definition : public OAIObject {
public:
    OAIGetPolicyOutput_definition();
    OAIGetPolicyOutput_definition(QString json);
    ~OAIGetPolicyOutput_definition() override;
    ...
    OAIPolicyDefinitionDetail_static getRStatic() const;
    void setRStatic(const OAIPolicyDefinitionDetail_static &r_static);
    bool is_r_static_Set() const;
    bool is_r_static_Valid() const;

    OAIPolicyDefinitionDetail_templateLinked getTemplateLinked() const;
    void setTemplateLinked(const OAIPolicyDefinitionDetail_templateLinked &template_linked);
...
private:
    ...
    OAIPolicyDefinitionDetail_static m_r_static;
    bool m_r_static_isSet;
    bool m_r_static_isValid;

    OAIPolicyDefinitionDetail_templateLinked m_template_linked;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPolicyOutput_definition)

#endif // OAIGetPolicyOutput_definition_H
