...
#include "OAIValidationSettings.h"
...
OAIValidationSettings::OAIValidationSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValidationSettings::OAIValidationSettings() {
    this->initializeModel();
}

OAIValidationSettings::~OAIValidationSettings() {}

void OAIValidationSettings::initializeModel() {

    m_mode_isSet = false;
    m_mode_isValid = false;
}

void OAIValidationSettings::fromJson(QString jsonString) {
...
void OAIValidationSettings::fromJsonObject(QJsonObject json) {

    m_mode_isValid = ::OpenAPI::fromJsonValue(m_mode, json[QString("mode")]);
    m_mode_isSet = !json[QString("mode")].isNull() && m_mode_isValid;
}

QString OAIValidationSettings::asJson() const {
...
QJsonObject OAIValidationSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_mode.isSet()) {
...
OAIValidationMode OAIValidationSettings::getMode() const {
    return m_mode;
}
void OAIValidationSettings::setMode(const OAIValidationMode &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIValidationSettings::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIValidationSettings::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIValidationSettings::isSet() const {
...
bool OAIValidationSettings::isValid() const {
