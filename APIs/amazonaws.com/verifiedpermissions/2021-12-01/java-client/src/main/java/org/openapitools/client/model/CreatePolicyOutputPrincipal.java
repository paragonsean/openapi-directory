...
public class CreatePolicyOutputPrincipal {
  ...
  public CreatePolicyOutputPrincipal() {
  }

  public CreatePolicyOutputPrincipal entityType(String entityType) {
  ...
  public CreatePolicyOutputPrincipal entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyOutputPrincipal createPolicyOutputPrincipal = (CreatePolicyOutputPrincipal) o;
    return Objects.equals(this.entityType, createPolicyOutputPrincipal.entityType) &&
        Objects.equals(this.entityId, createPolicyOutputPrincipal.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePolicyOutputPrincipal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyOutputPrincipal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyOutputPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyOutputPrincipal is not found in the empty JSON string", CreatePolicyOutputPrincipal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyOutputPrincipal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyOutputPrincipal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyOutputPrincipal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyOutputPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyOutputPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyOutputPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyOutputPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyOutputPrincipal>() {
           @Override
           public void write(JsonWriter out, CreatePolicyOutputPrincipal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyOutputPrincipal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyOutputPrincipal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyOutputPrincipal
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyOutputPrincipal
   */
  public static CreatePolicyOutputPrincipal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyOutputPrincipal.class);
  }

  /**
   * Convert an instance of CreatePolicyOutputPrincipal to an JSON string
   *
   * @return JSON string
   */
