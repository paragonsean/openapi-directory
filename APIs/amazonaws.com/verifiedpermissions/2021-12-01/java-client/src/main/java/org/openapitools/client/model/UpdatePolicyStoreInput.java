...
import org.openapitools.client.model.UpdatePolicyStoreInputValidationSettings;
...
public class UpdatePolicyStoreInput {
  ...
  private UpdatePolicyStoreInputValidationSettings validationSettings;

  public UpdatePolicyStoreInput() {
  }

  public UpdatePolicyStoreInput policyStoreId(String policyStoreId) {
  ...
  public UpdatePolicyStoreInput validationSettings(UpdatePolicyStoreInputValidationSettings validationSettings) {
   ...
   */
  @javax.annotation.Nonnull
  public UpdatePolicyStoreInputValidationSettings getValidationSettings() {
    return validationSettings;
  }

  public void setValidationSettings(UpdatePolicyStoreInputValidationSettings validationSettings) {
    this.validationSettings = validationSettings;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyStoreInput updatePolicyStoreInput = (UpdatePolicyStoreInput) o;
    return Objects.equals(this.policyStoreId, updatePolicyStoreInput.policyStoreId) &&
        Objects.equals(this.validationSettings, updatePolicyStoreInput.validationSettings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, validationSettings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePolicyStoreInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyStoreInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyStoreInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyStoreInput is not found in the empty JSON string", UpdatePolicyStoreInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyStoreInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyStoreInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePolicyStoreInput.openapiRequiredFields) {
      ...
      UpdatePolicyStoreInputValidationSettings.validateJsonElement(jsonObj.get("validationSettings"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyStoreInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyStoreInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyStoreInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyStoreInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyStoreInput>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyStoreInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyStoreInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyStoreInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyStoreInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyStoreInput
   */
  public static UpdatePolicyStoreInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyStoreInput.class);
  }

  /**
   * Convert an instance of UpdatePolicyStoreInput to an JSON string
   *
   * @return JSON string
   */
