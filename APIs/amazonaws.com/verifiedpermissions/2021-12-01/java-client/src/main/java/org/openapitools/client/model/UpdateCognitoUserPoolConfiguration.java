...
public class UpdateCognitoUserPoolConfiguration {
  ...
  public UpdateCognitoUserPoolConfiguration() {
  }

  public UpdateCognitoUserPoolConfiguration userPoolArn(String userPoolArn) {
  ...
  public UpdateCognitoUserPoolConfiguration clientIds(List clientIds) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCognitoUserPoolConfiguration updateCognitoUserPoolConfiguration = (UpdateCognitoUserPoolConfiguration) o;
    return Objects.equals(this.userPoolArn, updateCognitoUserPoolConfiguration.userPoolArn) &&
        Objects.equals(this.clientIds, updateCognitoUserPoolConfiguration.clientIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCognitoUserPoolConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCognitoUserPoolConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCognitoUserPoolConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCognitoUserPoolConfiguration is not found in the empty JSON string", UpdateCognitoUserPoolConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCognitoUserPoolConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCognitoUserPoolConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCognitoUserPoolConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCognitoUserPoolConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCognitoUserPoolConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCognitoUserPoolConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCognitoUserPoolConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCognitoUserPoolConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateCognitoUserPoolConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCognitoUserPoolConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCognitoUserPoolConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCognitoUserPoolConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateCognitoUserPoolConfiguration
   */
  public static UpdateCognitoUserPoolConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCognitoUserPoolConfiguration.class);
  }

  /**
   * Convert an instance of UpdateCognitoUserPoolConfiguration to an JSON string
   *
   * @return JSON string
   */
