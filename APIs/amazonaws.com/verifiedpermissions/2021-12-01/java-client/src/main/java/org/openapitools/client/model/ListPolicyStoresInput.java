...
public class ListPolicyStoresInput {
  ...
  public ListPolicyStoresInput() {
  }

  public ListPolicyStoresInput nextToken(String nextToken) {
  ...
  public ListPolicyStoresInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListPolicyStoresInput listPolicyStoresInput = (ListPolicyStoresInput) o;
    return Objects.equals(this.nextToken, listPolicyStoresInput.nextToken) &&
        Objects.equals(this.maxResults, listPolicyStoresInput.maxResults);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPolicyStoresInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPolicyStoresInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPolicyStoresInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPolicyStoresInput is not found in the empty JSON string", ListPolicyStoresInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPolicyStoresInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPolicyStoresInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPolicyStoresInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPolicyStoresInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPolicyStoresInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPolicyStoresInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPolicyStoresInput>() {
           @Override
           public void write(JsonWriter out, ListPolicyStoresInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPolicyStoresInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPolicyStoresInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPolicyStoresInput
   * @throws IOException if the JSON string is invalid with respect to ListPolicyStoresInput
   */
  public static ListPolicyStoresInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPolicyStoresInput.class);
  }

  /**
   * Convert an instance of ListPolicyStoresInput to an JSON string
   *
   * @return JSON string
   */
