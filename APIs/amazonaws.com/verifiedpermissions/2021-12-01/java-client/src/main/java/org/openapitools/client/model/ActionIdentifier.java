...
public class ActionIdentifier {
  ...
  public ActionIdentifier actionType(String actionType) {
  ...
  public ActionIdentifier actionId(String actionId) {
  ...
  public boolean equals(Object o) {
    ...
    ActionIdentifier actionIdentifier = (ActionIdentifier) o;
    return Objects.equals(this.actionType, actionIdentifier.actionType) &&
        Objects.equals(this.actionId, actionIdentifier.actionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionType, actionId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActionIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ActionIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActionIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActionIdentifier is not found in the empty JSON string", ActionIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ActionIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ActionIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActionIdentifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActionIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActionIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActionIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActionIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<ActionIdentifier>() {
           @Override
           public void write(JsonWriter out, ActionIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ActionIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ActionIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ActionIdentifier
   * @throws IOException if the JSON string is invalid with respect to ActionIdentifier
   */
  public static ActionIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActionIdentifier.class);
  }

  /**
   * Convert an instance of ActionIdentifier to an JSON string
   *
   * @return JSON string
   */
