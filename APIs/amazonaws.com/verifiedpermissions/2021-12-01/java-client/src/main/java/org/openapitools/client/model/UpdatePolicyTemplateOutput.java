...
public class UpdatePolicyTemplateOutput {
  ...
  public UpdatePolicyTemplateOutput() {
  }

  public UpdatePolicyTemplateOutput policyStoreId(String policyStoreId) {
  ...
  public UpdatePolicyTemplateOutput policyTemplateId(String policyTemplateId) {
  ...
  public UpdatePolicyTemplateOutput createdDate(OffsetDateTime createdDate) {
  ...
  public UpdatePolicyTemplateOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyTemplateOutput updatePolicyTemplateOutput = (UpdatePolicyTemplateOutput) o;
    return Objects.equals(this.policyStoreId, updatePolicyTemplateOutput.policyStoreId) &&
        Objects.equals(this.policyTemplateId, updatePolicyTemplateOutput.policyTemplateId) &&
        Objects.equals(this.createdDate, updatePolicyTemplateOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, updatePolicyTemplateOutput.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyTemplateId, createdDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePolicyTemplateOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyTemplateOutput is not found in the empty JSON string", UpdatePolicyTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePolicyTemplateOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyTemplateOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyTemplateOutput
   */
  public static UpdatePolicyTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyTemplateOutput.class);
  }

  /**
   * Convert an instance of UpdatePolicyTemplateOutput to an JSON string
   *
   * @return JSON string
   */
