...
import org.openapitools.client.model.PutSchemaInputDefinition;
...
public class PutSchemaInput {
  ...
  private PutSchemaInputDefinition definition;

  public PutSchemaInput() {
  }

  public PutSchemaInput policyStoreId(String policyStoreId) {
  ...
  public PutSchemaInput definition(PutSchemaInputDefinition definition) {
   ...
   */
  @javax.annotation.Nonnull
  public PutSchemaInputDefinition getDefinition() {
    return definition;
  }

  public void setDefinition(PutSchemaInputDefinition definition) {
    this.definition = definition;
  }
  ...
  public boolean equals(Object o) {
    ...
    PutSchemaInput putSchemaInput = (PutSchemaInput) o;
    return Objects.equals(this.policyStoreId, putSchemaInput.policyStoreId) &&
        Objects.equals(this.definition, putSchemaInput.definition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, definition);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutSchemaInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutSchemaInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutSchemaInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutSchemaInput is not found in the empty JSON string", PutSchemaInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutSchemaInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutSchemaInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutSchemaInput.openapiRequiredFields) {
      ...
      PutSchemaInputDefinition.validateJsonElement(jsonObj.get("definition"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutSchemaInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutSchemaInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutSchemaInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutSchemaInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutSchemaInput>() {
           @Override
           public void write(JsonWriter out, PutSchemaInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutSchemaInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutSchemaInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutSchemaInput
   * @throws IOException if the JSON string is invalid with respect to PutSchemaInput
   */
  public static PutSchemaInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutSchemaInput.class);
  }

  /**
   * Convert an instance of PutSchemaInput to an JSON string
   *
   * @return JSON string
   */
