...
public class CreatePolicyOutputResource {
  ...
  public CreatePolicyOutputResource() {
  }

  public CreatePolicyOutputResource entityType(String entityType) {
  ...
  public CreatePolicyOutputResource entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyOutputResource createPolicyOutputResource = (CreatePolicyOutputResource) o;
    return Objects.equals(this.entityType, createPolicyOutputResource.entityType) &&
        Objects.equals(this.entityId, createPolicyOutputResource.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePolicyOutputResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyOutputResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyOutputResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyOutputResource is not found in the empty JSON string", CreatePolicyOutputResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyOutputResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyOutputResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyOutputResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyOutputResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyOutputResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyOutputResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyOutputResource.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyOutputResource>() {
           @Override
           public void write(JsonWriter out, CreatePolicyOutputResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyOutputResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyOutputResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyOutputResource
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyOutputResource
   */
  public static CreatePolicyOutputResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyOutputResource.class);
  }

  /**
   * Convert an instance of CreatePolicyOutputResource to an JSON string
   *
   * @return JSON string
   */
