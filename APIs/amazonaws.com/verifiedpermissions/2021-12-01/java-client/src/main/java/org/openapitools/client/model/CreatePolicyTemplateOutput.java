...
public class CreatePolicyTemplateOutput {
  ...
  public CreatePolicyTemplateOutput() {
  }

  public CreatePolicyTemplateOutput policyStoreId(String policyStoreId) {
  ...
  public CreatePolicyTemplateOutput policyTemplateId(String policyTemplateId) {
  ...
  public CreatePolicyTemplateOutput createdDate(OffsetDateTime createdDate) {
  ...
  public CreatePolicyTemplateOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyTemplateOutput createPolicyTemplateOutput = (CreatePolicyTemplateOutput) o;
    return Objects.equals(this.policyStoreId, createPolicyTemplateOutput.policyStoreId) &&
        Objects.equals(this.policyTemplateId, createPolicyTemplateOutput.policyTemplateId) &&
        Objects.equals(this.createdDate, createPolicyTemplateOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, createPolicyTemplateOutput.lastUpdatedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePolicyTemplateOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyTemplateOutput is not found in the empty JSON string", CreatePolicyTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyTemplateOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyTemplateOutput>() {
           @Override
           public void write(JsonWriter out, CreatePolicyTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyTemplateOutput
   */
  public static CreatePolicyTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyTemplateOutput.class);
  }

  /**
   * Convert an instance of CreatePolicyTemplateOutput to an JSON string
   *
   * @return JSON string
   */
