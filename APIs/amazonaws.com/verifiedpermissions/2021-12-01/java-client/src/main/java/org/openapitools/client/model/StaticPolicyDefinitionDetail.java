...
public class StaticPolicyDefinitionDetail {
  ...
  public StaticPolicyDefinitionDetail() {
  }

  public StaticPolicyDefinitionDetail description(String description) {
  ...
  public StaticPolicyDefinitionDetail statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    StaticPolicyDefinitionDetail staticPolicyDefinitionDetail = (StaticPolicyDefinitionDetail) o;
    return Objects.equals(this.description, staticPolicyDefinitionDetail.description) &&
        Objects.equals(this.statement, staticPolicyDefinitionDetail.statement);
  }
  ...
  public String toString() {
    ...
    sb.append("class StaticPolicyDefinitionDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaticPolicyDefinitionDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticPolicyDefinitionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StaticPolicyDefinitionDetail is not found in the empty JSON string", StaticPolicyDefinitionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticPolicyDefinitionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StaticPolicyDefinitionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StaticPolicyDefinitionDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaticPolicyDefinitionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaticPolicyDefinitionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaticPolicyDefinitionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaticPolicyDefinitionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<StaticPolicyDefinitionDetail>() {
           @Override
           public void write(JsonWriter out, StaticPolicyDefinitionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StaticPolicyDefinitionDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StaticPolicyDefinitionDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StaticPolicyDefinitionDetail
   * @throws IOException if the JSON string is invalid with respect to StaticPolicyDefinitionDetail
   */
  public static StaticPolicyDefinitionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaticPolicyDefinitionDetail.class);
  }

  /**
   * Convert an instance of StaticPolicyDefinitionDetail to an JSON string
   *
   * @return JSON string
   */
