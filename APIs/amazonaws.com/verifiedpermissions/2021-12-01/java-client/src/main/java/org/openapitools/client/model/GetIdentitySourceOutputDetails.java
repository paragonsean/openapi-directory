...
public class GetIdentitySourceOutputDetails {
  ...
  public GetIdentitySourceOutputDetails() {
  }

  public GetIdentitySourceOutputDetails clientIds(List clientIds) {
  ...
  public GetIdentitySourceOutputDetails userPoolArn(String userPoolArn) {
  ...
  public GetIdentitySourceOutputDetails discoveryUrl(String discoveryUrl) {
  ...
  public GetIdentitySourceOutputDetails openIdIssuer(OpenIdIssuer openIdIssuer) {
  ...
  public boolean equals(Object o) {
    ...
    GetIdentitySourceOutputDetails getIdentitySourceOutputDetails = (GetIdentitySourceOutputDetails) o;
    return Objects.equals(this.clientIds, getIdentitySourceOutputDetails.clientIds) &&
        Objects.equals(this.userPoolArn, getIdentitySourceOutputDetails.userPoolArn) &&
        Objects.equals(this.discoveryUrl, getIdentitySourceOutputDetails.discoveryUrl) &&
        Objects.equals(this.openIdIssuer, getIdentitySourceOutputDetails.openIdIssuer);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIdentitySourceOutputDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIdentitySourceOutputDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIdentitySourceOutputDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIdentitySourceOutputDetails is not found in the empty JSON string", GetIdentitySourceOutputDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIdentitySourceOutputDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIdentitySourceOutputDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIdentitySourceOutputDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIdentitySourceOutputDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIdentitySourceOutputDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIdentitySourceOutputDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIdentitySourceOutputDetails>() {
           @Override
           public void write(JsonWriter out, GetIdentitySourceOutputDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIdentitySourceOutputDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIdentitySourceOutputDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIdentitySourceOutputDetails
   * @throws IOException if the JSON string is invalid with respect to GetIdentitySourceOutputDetails
   */
  public static GetIdentitySourceOutputDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIdentitySourceOutputDetails.class);
  }

  /**
   * Convert an instance of GetIdentitySourceOutputDetails to an JSON string
   *
   * @return JSON string
   */
