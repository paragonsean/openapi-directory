...
public class IsAuthorizedInputResource {
  ...
  public IsAuthorizedInputResource() {
  }

  public IsAuthorizedInputResource entityType(String entityType) {
  ...
  public IsAuthorizedInputResource entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedInputResource isAuthorizedInputResource = (IsAuthorizedInputResource) o;
    return Objects.equals(this.entityType, isAuthorizedInputResource.entityType) &&
        Objects.equals(this.entityId, isAuthorizedInputResource.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedInputResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedInputResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedInputResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedInputResource is not found in the empty JSON string", IsAuthorizedInputResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedInputResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedInputResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsAuthorizedInputResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedInputResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedInputResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedInputResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedInputResource.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedInputResource>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedInputResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedInputResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedInputResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedInputResource
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedInputResource
   */
  public static IsAuthorizedInputResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedInputResource.class);
  }

  /**
   * Convert an instance of IsAuthorizedInputResource to an JSON string
   *
   * @return JSON string
   */
