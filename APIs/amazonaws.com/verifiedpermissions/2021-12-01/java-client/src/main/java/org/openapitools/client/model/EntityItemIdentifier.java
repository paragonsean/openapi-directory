...
public class EntityItemIdentifier {
  ...
  public EntityItemIdentifier() {
  }

  public EntityItemIdentifier entityType(String entityType) {
  ...
  public EntityItemIdentifier entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    EntityItemIdentifier entityItemIdentifier = (EntityItemIdentifier) o;
    return Objects.equals(this.entityType, entityItemIdentifier.entityType) &&
        Objects.equals(this.entityId, entityItemIdentifier.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityItemIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityItemIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityItemIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityItemIdentifier is not found in the empty JSON string", EntityItemIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityItemIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityItemIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntityItemIdentifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityItemIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityItemIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityItemIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityItemIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityItemIdentifier>() {
           @Override
           public void write(JsonWriter out, EntityItemIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityItemIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityItemIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityItemIdentifier
   * @throws IOException if the JSON string is invalid with respect to EntityItemIdentifier
   */
  public static EntityItemIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityItemIdentifier.class);
  }

  /**
   * Convert an instance of EntityItemIdentifier to an JSON string
   *
   * @return JSON string
   */
