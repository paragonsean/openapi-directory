...
public class CreatePolicyStoreInputValidationSettings {
  public static final String SERIALIZED_NAME_MODE = "mode";
  @SerializedName(SERIALIZED_NAME_MODE)
  private ValidationMode mode;

  public CreatePolicyStoreInputValidationSettings() {
  }

  public CreatePolicyStoreInputValidationSettings mode(ValidationMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyStoreInputValidationSettings createPolicyStoreInputValidationSettings = (CreatePolicyStoreInputValidationSettings) o;
    return Objects.equals(this.mode, createPolicyStoreInputValidationSettings.mode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePolicyStoreInputValidationSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyStoreInputValidationSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyStoreInputValidationSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyStoreInputValidationSettings is not found in the empty JSON string", CreatePolicyStoreInputValidationSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyStoreInputValidationSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyStoreInputValidationSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyStoreInputValidationSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyStoreInputValidationSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyStoreInputValidationSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyStoreInputValidationSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyStoreInputValidationSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyStoreInputValidationSettings>() {
           @Override
           public void write(JsonWriter out, CreatePolicyStoreInputValidationSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyStoreInputValidationSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyStoreInputValidationSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyStoreInputValidationSettings
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyStoreInputValidationSettings
   */
  public static CreatePolicyStoreInputValidationSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyStoreInputValidationSettings.class);
  }

  /**
   * Convert an instance of CreatePolicyStoreInputValidationSettings to an JSON string
   *
   * @return JSON string
   */
