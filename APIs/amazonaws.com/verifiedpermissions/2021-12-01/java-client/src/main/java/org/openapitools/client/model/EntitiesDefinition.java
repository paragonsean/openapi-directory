...
public class EntitiesDefinition {
  ...
  public EntitiesDefinition() {
  }

  public EntitiesDefinition entityList(List entityList) {
  ...
  public boolean equals(Object o) {
    ...
    EntitiesDefinition entitiesDefinition = (EntitiesDefinition) o;
    return Objects.equals(this.entityList, entitiesDefinition.entityList);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntitiesDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntitiesDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntitiesDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntitiesDefinition is not found in the empty JSON string", EntitiesDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntitiesDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntitiesDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntitiesDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntitiesDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntitiesDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntitiesDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<EntitiesDefinition>() {
           @Override
           public void write(JsonWriter out, EntitiesDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntitiesDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntitiesDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntitiesDefinition
   * @throws IOException if the JSON string is invalid with respect to EntitiesDefinition
   */
  public static EntitiesDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntitiesDefinition.class);
  }

  /**
   * Convert an instance of EntitiesDefinition to an JSON string
   *
   * @return JSON string
   */
