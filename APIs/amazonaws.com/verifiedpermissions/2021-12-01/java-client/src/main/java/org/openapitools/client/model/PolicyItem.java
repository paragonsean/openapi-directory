...
import org.openapitools.client.model.PolicyItemDefinition;
import org.openapitools.client.model.PolicyItemPrincipal;
import org.openapitools.client.model.PolicyItemResource;
...
public class PolicyItem {
  ...
  private PolicyItemPrincipal principal;

  public static final String SERIALIZED_NAME_RESOURCE = "resource";
  @SerializedName(SERIALIZED_NAME_RESOURCE)
  private PolicyItemResource resource;

  public static final String SERIALIZED_NAME_DEFINITION = "definition";
  @SerializedName(SERIALIZED_NAME_DEFINITION)
  private PolicyItemDefinition definition;
  ...
  public PolicyItem policyStoreId(String policyStoreId) {
  ...
  public PolicyItem policyId(String policyId) {
  ...
  public PolicyItem policyType(PolicyType policyType) {
  ...
  public PolicyItem principal(PolicyItemPrincipal principal) {
  ...
  public PolicyItemPrincipal getPrincipal() {
    return principal;
  }

  public void setPrincipal(PolicyItemPrincipal principal) {
    this.principal = principal;
  }


  public PolicyItem resource(PolicyItemResource resource) {
   ...
   */
  @javax.annotation.Nullable
  public PolicyItemResource getResource() {
    return resource;
  }

  public void setResource(PolicyItemResource resource) {
    this.resource = resource;
  }


  public PolicyItem definition(PolicyItemDefinition definition) {
   ...
   */
  @javax.annotation.Nonnull
  public PolicyItemDefinition getDefinition() {
    return definition;
  }

  public void setDefinition(PolicyItemDefinition definition) {
    this.definition = definition;
  }


  public PolicyItem createdDate(OffsetDateTime createdDate) {
  ...
  public PolicyItem lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policyStoreId, policyItem.policyStoreId) &&
        Objects.equals(this.policyId, policyItem.policyId) &&
        Objects.equals(this.policyType, policyItem.policyType) &&
        Objects.equals(this.principal, policyItem.principal) &&
        Objects.equals(this.resource, policyItem.resource) &&
        Objects.equals(this.definition, policyItem.definition) &&
        Objects.equals(this.createdDate, policyItem.createdDate) &&
        Objects.equals(this.lastUpdatedDate, policyItem.lastUpdatedDate);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyItem is not found in the empty JSON string", PolicyItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyItem.openapiRequiredFields) {
      ...
      if (jsonObj.get("principal") != null && !jsonObj.get("principal").isJsonNull()) {
        PolicyItemPrincipal.validateJsonElement(jsonObj.get("principal"));
      }
      // validate the optional field `resource`
      if (jsonObj.get("resource") != null && !jsonObj.get("resource").isJsonNull()) {
        PolicyItemResource.validateJsonElement(jsonObj.get("resource"));
      }
      // validate the required field `definition`
      PolicyItemDefinition.validateJsonElement(jsonObj.get("definition"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyItem.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyItem>() {
           @Override
           public void write(JsonWriter out, PolicyItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyItem
   * @throws IOException if the JSON string is invalid with respect to PolicyItem
   */
  public static PolicyItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyItem.class);
  }

  /**
   * Convert an instance of PolicyItem to an JSON string
   *
   * @return JSON string
   */
