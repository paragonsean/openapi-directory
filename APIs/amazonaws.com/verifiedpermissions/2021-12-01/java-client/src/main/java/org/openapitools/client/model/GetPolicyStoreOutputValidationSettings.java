...
public class GetPolicyStoreOutputValidationSettings {
  public static final String SERIALIZED_NAME_MODE = "mode";
  @SerializedName(SERIALIZED_NAME_MODE)
  private ValidationMode mode;

  public GetPolicyStoreOutputValidationSettings() {
  }

  public GetPolicyStoreOutputValidationSettings mode(ValidationMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyStoreOutputValidationSettings getPolicyStoreOutputValidationSettings = (GetPolicyStoreOutputValidationSettings) o;
    return Objects.equals(this.mode, getPolicyStoreOutputValidationSettings.mode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPolicyStoreOutputValidationSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyStoreOutputValidationSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyStoreOutputValidationSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyStoreOutputValidationSettings is not found in the empty JSON string", GetPolicyStoreOutputValidationSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyStoreOutputValidationSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyStoreOutputValidationSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyStoreOutputValidationSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyStoreOutputValidationSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyStoreOutputValidationSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyStoreOutputValidationSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyStoreOutputValidationSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyStoreOutputValidationSettings>() {
           @Override
           public void write(JsonWriter out, GetPolicyStoreOutputValidationSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyStoreOutputValidationSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyStoreOutputValidationSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyStoreOutputValidationSettings
   * @throws IOException if the JSON string is invalid with respect to GetPolicyStoreOutputValidationSettings
   */
  public static GetPolicyStoreOutputValidationSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyStoreOutputValidationSettings.class);
  }

  /**
   * Convert an instance of GetPolicyStoreOutputValidationSettings to an JSON string
   *
   * @return JSON string
   */
