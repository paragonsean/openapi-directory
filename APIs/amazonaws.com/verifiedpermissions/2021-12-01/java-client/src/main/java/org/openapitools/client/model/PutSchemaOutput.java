...
public class PutSchemaOutput {
  ...
  public PutSchemaOutput() {
  }

  public PutSchemaOutput policyStoreId(String policyStoreId) {
  ...
  public PutSchemaOutput namespaces(List namespaces) {
  ...
  public PutSchemaOutput createdDate(OffsetDateTime createdDate) {
  ...
  public PutSchemaOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    PutSchemaOutput putSchemaOutput = (PutSchemaOutput) o;
    return Objects.equals(this.policyStoreId, putSchemaOutput.policyStoreId) &&
        Objects.equals(this.namespaces, putSchemaOutput.namespaces) &&
        Objects.equals(this.createdDate, putSchemaOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, putSchemaOutput.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, namespaces, createdDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutSchemaOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutSchemaOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutSchemaOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutSchemaOutput is not found in the empty JSON string", PutSchemaOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutSchemaOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutSchemaOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PutSchemaOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutSchemaOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutSchemaOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutSchemaOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutSchemaOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<PutSchemaOutput>() {
           @Override
           public void write(JsonWriter out, PutSchemaOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutSchemaOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutSchemaOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutSchemaOutput
   * @throws IOException if the JSON string is invalid with respect to PutSchemaOutput
   */
  public static PutSchemaOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutSchemaOutput.class);
  }

  /**
   * Convert an instance of PutSchemaOutput to an JSON string
   *
   * @return JSON string
   */
