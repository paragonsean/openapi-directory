...
public class ListPolicyStoresOutput {
  ...
  public static final String SERIALIZED_NAME_POLICY_STORES = "policyStores";
  @SerializedName(SERIALIZED_NAME_POLICY_STORES)
  private List policyStores;

  public ListPolicyStoresOutput() {
  }

  public ListPolicyStoresOutput nextToken(String nextToken) {
  ...
  public ListPolicyStoresOutput policyStores(List policyStores) {
  ...
  public List getPolicyStores() {
    return policyStores;
  }

  public void setPolicyStores(List policyStores) {
    this.policyStores = policyStores;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListPolicyStoresOutput listPolicyStoresOutput = (ListPolicyStoresOutput) o;
    return Objects.equals(this.nextToken, listPolicyStoresOutput.nextToken) &&
        Objects.equals(this.policyStores, listPolicyStoresOutput.policyStores);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, policyStores);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPolicyStoresOutput {\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    policyStores: ").append(toIndentedString(policyStores)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("policyStores");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("policyStores");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPolicyStoresOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPolicyStoresOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPolicyStoresOutput is not found in the empty JSON string", ListPolicyStoresOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPolicyStoresOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPolicyStoresOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPolicyStoresOutput.openapiRequiredFields) {
      ...
      // validate the required field `policyStores`
      List.validateJsonElement(jsonObj.get("policyStores"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPolicyStoresOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPolicyStoresOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPolicyStoresOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPolicyStoresOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPolicyStoresOutput>() {
           @Override
           public void write(JsonWriter out, ListPolicyStoresOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPolicyStoresOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPolicyStoresOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPolicyStoresOutput
   * @throws IOException if the JSON string is invalid with respect to ListPolicyStoresOutput
   */
  public static ListPolicyStoresOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPolicyStoresOutput.class);
  }

  /**
   * Convert an instance of ListPolicyStoresOutput to an JSON string
   *
   * @return JSON string
   */
