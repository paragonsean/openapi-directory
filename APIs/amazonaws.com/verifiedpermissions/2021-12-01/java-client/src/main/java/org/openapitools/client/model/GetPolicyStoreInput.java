...
public class GetPolicyStoreInput {
  ...
  public GetPolicyStoreInput() {
  }

  public GetPolicyStoreInput policyStoreId(String policyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyStoreInput getPolicyStoreInput = (GetPolicyStoreInput) o;
    return Objects.equals(this.policyStoreId, getPolicyStoreInput.policyStoreId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPolicyStoreInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyStoreInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyStoreInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyStoreInput is not found in the empty JSON string", GetPolicyStoreInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyStoreInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyStoreInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyStoreInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyStoreInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyStoreInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyStoreInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyStoreInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyStoreInput>() {
           @Override
           public void write(JsonWriter out, GetPolicyStoreInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyStoreInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyStoreInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyStoreInput
   * @throws IOException if the JSON string is invalid with respect to GetPolicyStoreInput
   */
  public static GetPolicyStoreInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyStoreInput.class);
  }

  /**
   * Convert an instance of GetPolicyStoreInput to an JSON string
   *
   * @return JSON string
   */
