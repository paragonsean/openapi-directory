...
public class UpdatePolicyTemplateInput {
  ...
  public UpdatePolicyTemplateInput() {
  }

  public UpdatePolicyTemplateInput policyStoreId(String policyStoreId) {
  ...
  public UpdatePolicyTemplateInput policyTemplateId(String policyTemplateId) {
  ...
  public UpdatePolicyTemplateInput description(String description) {
  ...
  public UpdatePolicyTemplateInput statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyTemplateInput updatePolicyTemplateInput = (UpdatePolicyTemplateInput) o;
    return Objects.equals(this.policyStoreId, updatePolicyTemplateInput.policyStoreId) &&
        Objects.equals(this.policyTemplateId, updatePolicyTemplateInput.policyTemplateId) &&
        Objects.equals(this.description, updatePolicyTemplateInput.description) &&
        Objects.equals(this.statement, updatePolicyTemplateInput.statement);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyTemplateId, description, statement);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdatePolicyTemplateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyTemplateInput is not found in the empty JSON string", UpdatePolicyTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePolicyTemplateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyTemplateInput>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyTemplateInput
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyTemplateInput
   */
  public static UpdatePolicyTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyTemplateInput.class);
  }

  /**
   * Convert an instance of UpdatePolicyTemplateInput to an JSON string
   *
   * @return JSON string
   */
