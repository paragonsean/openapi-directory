...
public class UpdateIdentitySourceOutput {
  ...
  public UpdateIdentitySourceOutput() {
  }

  public UpdateIdentitySourceOutput createdDate(OffsetDateTime createdDate) {
  ...
  public UpdateIdentitySourceOutput identitySourceId(String identitySourceId) {
  ...
  public UpdateIdentitySourceOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public UpdateIdentitySourceOutput policyStoreId(String policyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateIdentitySourceOutput updateIdentitySourceOutput = (UpdateIdentitySourceOutput) o;
    return Objects.equals(this.createdDate, updateIdentitySourceOutput.createdDate) &&
        Objects.equals(this.identitySourceId, updateIdentitySourceOutput.identitySourceId) &&
        Objects.equals(this.lastUpdatedDate, updateIdentitySourceOutput.lastUpdatedDate) &&
        Objects.equals(this.policyStoreId, updateIdentitySourceOutput.policyStoreId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdDate, identitySourceId, lastUpdatedDate, policyStoreId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateIdentitySourceOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateIdentitySourceOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateIdentitySourceOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateIdentitySourceOutput is not found in the empty JSON string", UpdateIdentitySourceOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateIdentitySourceOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateIdentitySourceOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateIdentitySourceOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateIdentitySourceOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateIdentitySourceOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateIdentitySourceOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateIdentitySourceOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateIdentitySourceOutput>() {
           @Override
           public void write(JsonWriter out, UpdateIdentitySourceOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateIdentitySourceOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateIdentitySourceOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateIdentitySourceOutput
   * @throws IOException if the JSON string is invalid with respect to UpdateIdentitySourceOutput
   */
  public static UpdateIdentitySourceOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateIdentitySourceOutput.class);
  }

  /**
   * Convert an instance of UpdateIdentitySourceOutput to an JSON string
   *
   * @return JSON string
   */
