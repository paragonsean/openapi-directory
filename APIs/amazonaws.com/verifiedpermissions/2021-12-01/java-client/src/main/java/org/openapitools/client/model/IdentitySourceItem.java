...
import org.openapitools.client.model.IdentitySourceItemDetails;
...
public class IdentitySourceItem {
  ...
  public IdentitySourceItem() {
  }

  public IdentitySourceItem createdDate(OffsetDateTime createdDate) {
  ...
  public IdentitySourceItem details(IdentitySourceItemDetails details) {
  ...
  public IdentitySourceItem identitySourceId(String identitySourceId) {
  ...
  public IdentitySourceItem lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public IdentitySourceItem policyStoreId(String policyStoreId) {
  ...
  public IdentitySourceItem principalEntityType(String principalEntityType) {
  ...
  public boolean equals(Object o) {
    ...
    IdentitySourceItem identitySourceItem = (IdentitySourceItem) o;
    return Objects.equals(this.createdDate, identitySourceItem.createdDate) &&
        Objects.equals(this.details, identitySourceItem.details) &&
        Objects.equals(this.identitySourceId, identitySourceItem.identitySourceId) &&
        Objects.equals(this.lastUpdatedDate, identitySourceItem.lastUpdatedDate) &&
        Objects.equals(this.policyStoreId, identitySourceItem.policyStoreId) &&
        Objects.equals(this.principalEntityType, identitySourceItem.principalEntityType);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentitySourceItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IdentitySourceItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IdentitySourceItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IdentitySourceItem is not found in the empty JSON string", IdentitySourceItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IdentitySourceItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IdentitySourceItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IdentitySourceItem.openapiRequiredFields) {
      ...
      IdentitySourceItemDetails.validateJsonElement(jsonObj.get("details"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdentitySourceItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdentitySourceItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdentitySourceItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdentitySourceItem.class));

       return (TypeAdapter<T>) new TypeAdapter<IdentitySourceItem>() {
           @Override
           public void write(JsonWriter out, IdentitySourceItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IdentitySourceItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IdentitySourceItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IdentitySourceItem
   * @throws IOException if the JSON string is invalid with respect to IdentitySourceItem
   */
  public static IdentitySourceItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdentitySourceItem.class);
  }

  /**
   * Convert an instance of IdentitySourceItem to an JSON string
   *
   * @return JSON string
   */
