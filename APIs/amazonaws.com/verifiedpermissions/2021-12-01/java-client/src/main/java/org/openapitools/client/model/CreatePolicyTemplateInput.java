...
public class CreatePolicyTemplateInput {
  ...
  public CreatePolicyTemplateInput() {
  }

  public CreatePolicyTemplateInput clientToken(String clientToken) {
  ...
  public CreatePolicyTemplateInput policyStoreId(String policyStoreId) {
  ...
  public CreatePolicyTemplateInput description(String description) {
  ...
  public CreatePolicyTemplateInput statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyTemplateInput createPolicyTemplateInput = (CreatePolicyTemplateInput) o;
    return Objects.equals(this.clientToken, createPolicyTemplateInput.clientToken) &&
        Objects.equals(this.policyStoreId, createPolicyTemplateInput.policyStoreId) &&
        Objects.equals(this.description, createPolicyTemplateInput.description) &&
        Objects.equals(this.statement, createPolicyTemplateInput.statement);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientToken, policyStoreId, description, statement);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePolicyTemplateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyTemplateInput is not found in the empty JSON string", CreatePolicyTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyTemplateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyTemplateInput>() {
           @Override
           public void write(JsonWriter out, CreatePolicyTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyTemplateInput
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyTemplateInput
   */
  public static CreatePolicyTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyTemplateInput.class);
  }

  /**
   * Convert an instance of CreatePolicyTemplateInput to an JSON string
   *
   * @return JSON string
   */
