...
public class DeterminingPolicyItem {
  ...
  public DeterminingPolicyItem() {
  }

  public DeterminingPolicyItem policyId(String policyId) {
  ...
  public boolean equals(Object o) {
    ...
    DeterminingPolicyItem determiningPolicyItem = (DeterminingPolicyItem) o;
    return Objects.equals(this.policyId, determiningPolicyItem.policyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeterminingPolicyItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeterminingPolicyItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeterminingPolicyItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeterminingPolicyItem is not found in the empty JSON string", DeterminingPolicyItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeterminingPolicyItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeterminingPolicyItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeterminingPolicyItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeterminingPolicyItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeterminingPolicyItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeterminingPolicyItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeterminingPolicyItem.class));

       return (TypeAdapter<T>) new TypeAdapter<DeterminingPolicyItem>() {
           @Override
           public void write(JsonWriter out, DeterminingPolicyItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeterminingPolicyItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeterminingPolicyItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeterminingPolicyItem
   * @throws IOException if the JSON string is invalid with respect to DeterminingPolicyItem
   */
  public static DeterminingPolicyItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeterminingPolicyItem.class);
  }

  /**
   * Convert an instance of DeterminingPolicyItem to an JSON string
   *
   * @return JSON string
   */
