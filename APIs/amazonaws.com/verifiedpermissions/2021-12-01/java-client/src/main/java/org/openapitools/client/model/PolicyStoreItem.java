...
public class PolicyStoreItem {
  ...
  public PolicyStoreItem() {
  }

  public PolicyStoreItem policyStoreId(String policyStoreId) {
  ...
  public PolicyStoreItem arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public PolicyStoreItem createdDate(OffsetDateTime createdDate) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyStoreItem policyStoreItem = (PolicyStoreItem) o;
    return Objects.equals(this.policyStoreId, policyStoreItem.policyStoreId) &&
        Objects.equals(this.arn, policyStoreItem.arn) &&
        Objects.equals(this.createdDate, policyStoreItem.createdDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, arn, createdDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PolicyStoreItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyStoreItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyStoreItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyStoreItem is not found in the empty JSON string", PolicyStoreItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyStoreItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyStoreItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyStoreItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyStoreItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyStoreItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyStoreItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyStoreItem.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyStoreItem>() {
           @Override
           public void write(JsonWriter out, PolicyStoreItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyStoreItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyStoreItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyStoreItem
   * @throws IOException if the JSON string is invalid with respect to PolicyStoreItem
   */
  public static PolicyStoreItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyStoreItem.class);
  }

  /**
   * Convert an instance of PolicyStoreItem to an JSON string
   *
   * @return JSON string
   */
