...
public class CreatePolicyInputDefinition {
  ...
  public CreatePolicyInputDefinition() {
  }

  public CreatePolicyInputDefinition _static(PolicyDefinitionStatic _static) {
  ...
  public CreatePolicyInputDefinition templateLinked(PolicyDefinitionTemplateLinked templateLinked) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyInputDefinition createPolicyInputDefinition = (CreatePolicyInputDefinition) o;
    return Objects.equals(this._static, createPolicyInputDefinition._static) &&
        Objects.equals(this.templateLinked, createPolicyInputDefinition.templateLinked);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePolicyInputDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyInputDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyInputDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyInputDefinition is not found in the empty JSON string", CreatePolicyInputDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyInputDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyInputDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyInputDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyInputDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyInputDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyInputDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyInputDefinition>() {
           @Override
           public void write(JsonWriter out, CreatePolicyInputDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyInputDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyInputDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyInputDefinition
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyInputDefinition
   */
  public static CreatePolicyInputDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyInputDefinition.class);
  }

  /**
   * Convert an instance of CreatePolicyInputDefinition to an JSON string
   *
   * @return JSON string
   */
