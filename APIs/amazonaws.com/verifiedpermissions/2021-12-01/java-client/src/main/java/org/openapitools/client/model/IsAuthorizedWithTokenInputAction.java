...
public class IsAuthorizedWithTokenInputAction {
  ...
  public IsAuthorizedWithTokenInputAction() {
  }

  public IsAuthorizedWithTokenInputAction actionType(String actionType) {
  ...
  public IsAuthorizedWithTokenInputAction actionId(String actionId) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedWithTokenInputAction isAuthorizedWithTokenInputAction = (IsAuthorizedWithTokenInputAction) o;
    return Objects.equals(this.actionType, isAuthorizedWithTokenInputAction.actionType) &&
        Objects.equals(this.actionId, isAuthorizedWithTokenInputAction.actionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedWithTokenInputAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedWithTokenInputAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedWithTokenInputAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedWithTokenInputAction is not found in the empty JSON string", IsAuthorizedWithTokenInputAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedWithTokenInputAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedWithTokenInputAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsAuthorizedWithTokenInputAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedWithTokenInputAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedWithTokenInputAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedWithTokenInputAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedWithTokenInputAction.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedWithTokenInputAction>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedWithTokenInputAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedWithTokenInputAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedWithTokenInputAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedWithTokenInputAction
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedWithTokenInputAction
   */
  public static IsAuthorizedWithTokenInputAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedWithTokenInputAction.class);
  }

  /**
   * Convert an instance of IsAuthorizedWithTokenInputAction to an JSON string
   *
   * @return JSON string
   */
