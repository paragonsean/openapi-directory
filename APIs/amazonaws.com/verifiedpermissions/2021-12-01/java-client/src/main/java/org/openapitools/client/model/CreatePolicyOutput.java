...
import org.openapitools.client.model.CreatePolicyOutputPrincipal;
import org.openapitools.client.model.CreatePolicyOutputResource;
...
public class CreatePolicyOutput {
  ...
  private CreatePolicyOutputPrincipal principal;

  public static final String SERIALIZED_NAME_RESOURCE = "resource";
  @SerializedName(SERIALIZED_NAME_RESOURCE)
  private CreatePolicyOutputResource resource;
  ...
  public CreatePolicyOutput() {
  }

  public CreatePolicyOutput policyStoreId(String policyStoreId) {
  ...
  public CreatePolicyOutput policyId(String policyId) {
  ...
  public CreatePolicyOutput policyType(PolicyType policyType) {
  ...
  public CreatePolicyOutput principal(CreatePolicyOutputPrincipal principal) {
  ...
  public CreatePolicyOutputPrincipal getPrincipal() {
    return principal;
  }

  public void setPrincipal(CreatePolicyOutputPrincipal principal) {
    this.principal = principal;
  }


  public CreatePolicyOutput resource(CreatePolicyOutputResource resource) {
   ...
   */
  @javax.annotation.Nullable
  public CreatePolicyOutputResource getResource() {
    return resource;
  }

  public void setResource(CreatePolicyOutputResource resource) {
    this.resource = resource;
  }


  public CreatePolicyOutput createdDate(OffsetDateTime createdDate) {
  ...
  public CreatePolicyOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyOutput createPolicyOutput = (CreatePolicyOutput) o;
    return Objects.equals(this.policyStoreId, createPolicyOutput.policyStoreId) &&
        Objects.equals(this.policyId, createPolicyOutput.policyId) &&
        Objects.equals(this.policyType, createPolicyOutput.policyType) &&
        Objects.equals(this.principal, createPolicyOutput.principal) &&
        Objects.equals(this.resource, createPolicyOutput.resource) &&
        Objects.equals(this.createdDate, createPolicyOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, createPolicyOutput.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyId, policyType, principal, resource, createdDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePolicyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyOutput is not found in the empty JSON string", CreatePolicyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyOutput.openapiRequiredFields) {
      ...
      if (jsonObj.get("principal") != null && !jsonObj.get("principal").isJsonNull()) {
        CreatePolicyOutputPrincipal.validateJsonElement(jsonObj.get("principal"));
      }
      // validate the optional field `resource`
      if (jsonObj.get("resource") != null && !jsonObj.get("resource").isJsonNull()) {
        CreatePolicyOutputResource.validateJsonElement(jsonObj.get("resource"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyOutput>() {
           @Override
           public void write(JsonWriter out, CreatePolicyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyOutput
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyOutput
   */
  public static CreatePolicyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyOutput.class);
  }

  /**
   * Convert an instance of CreatePolicyOutput to an JSON string
   *
   * @return JSON string
   */
