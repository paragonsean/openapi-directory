...
public class ListIdentitySourcesInput {
  ...
  public ListIdentitySourcesInput() {
  }

  public ListIdentitySourcesInput policyStoreId(String policyStoreId) {
  ...
  public ListIdentitySourcesInput nextToken(String nextToken) {
  ...
  public ListIdentitySourcesInput maxResults(Integer maxResults) {
  ...
  public ListIdentitySourcesInput filters(List filters) {
  ...
  public boolean equals(Object o) {
    ...
    ListIdentitySourcesInput listIdentitySourcesInput = (ListIdentitySourcesInput) o;
    return Objects.equals(this.policyStoreId, listIdentitySourcesInput.policyStoreId) &&
        Objects.equals(this.nextToken, listIdentitySourcesInput.nextToken) &&
        Objects.equals(this.maxResults, listIdentitySourcesInput.maxResults) &&
        Objects.equals(this.filters, listIdentitySourcesInput.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, nextToken, maxResults, filters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListIdentitySourcesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListIdentitySourcesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListIdentitySourcesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListIdentitySourcesInput is not found in the empty JSON string", ListIdentitySourcesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListIdentitySourcesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListIdentitySourcesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListIdentitySourcesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListIdentitySourcesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListIdentitySourcesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListIdentitySourcesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListIdentitySourcesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListIdentitySourcesInput>() {
           @Override
           public void write(JsonWriter out, ListIdentitySourcesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListIdentitySourcesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListIdentitySourcesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListIdentitySourcesInput
   * @throws IOException if the JSON string is invalid with respect to ListIdentitySourcesInput
   */
  public static ListIdentitySourcesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListIdentitySourcesInput.class);
  }

  /**
   * Convert an instance of ListIdentitySourcesInput to an JSON string
   *
   * @return JSON string
   */
