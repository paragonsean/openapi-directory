...
public class GetPolicyStoreOutput {
  ...
  private GetPolicyStoreOutputValidationSettings validationSettings;
  ...
  public GetPolicyStoreOutput() {
  }

  public GetPolicyStoreOutput policyStoreId(String policyStoreId) {
  ...
  public GetPolicyStoreOutput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public GetPolicyStoreOutput validationSettings(GetPolicyStoreOutputValidationSettings validationSettings) {
   ...
   */
  @javax.annotation.Nonnull
  public GetPolicyStoreOutputValidationSettings getValidationSettings() {
    return validationSettings;
  }

  public void setValidationSettings(GetPolicyStoreOutputValidationSettings validationSettings) {
    this.validationSettings = validationSettings;
  }


  public GetPolicyStoreOutput createdDate(OffsetDateTime createdDate) {
  ...
  public GetPolicyStoreOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyStoreOutput getPolicyStoreOutput = (GetPolicyStoreOutput) o;
    return Objects.equals(this.policyStoreId, getPolicyStoreOutput.policyStoreId) &&
        Objects.equals(this.arn, getPolicyStoreOutput.arn) &&
        Objects.equals(this.validationSettings, getPolicyStoreOutput.validationSettings) &&
        Objects.equals(this.createdDate, getPolicyStoreOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, getPolicyStoreOutput.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, arn, validationSettings, createdDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPolicyStoreOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyStoreOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyStoreOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyStoreOutput is not found in the empty JSON string", GetPolicyStoreOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyStoreOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyStoreOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyStoreOutput.openapiRequiredFields) {
      ...
      GetPolicyStoreOutputValidationSettings.validateJsonElement(jsonObj.get("validationSettings"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyStoreOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyStoreOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyStoreOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyStoreOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyStoreOutput>() {
           @Override
           public void write(JsonWriter out, GetPolicyStoreOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyStoreOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyStoreOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyStoreOutput
   * @throws IOException if the JSON string is invalid with respect to GetPolicyStoreOutput
   */
  public static GetPolicyStoreOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyStoreOutput.class);
  }

  /**
   * Convert an instance of GetPolicyStoreOutput to an JSON string
   *
   * @return JSON string
   */
