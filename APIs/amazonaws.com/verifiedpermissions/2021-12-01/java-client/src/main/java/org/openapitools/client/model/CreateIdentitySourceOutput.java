...
public class CreateIdentitySourceOutput {
  ...
  public CreateIdentitySourceOutput() {
  }

  public CreateIdentitySourceOutput createdDate(OffsetDateTime createdDate) {
  ...
  public CreateIdentitySourceOutput identitySourceId(String identitySourceId) {
  ...
  public CreateIdentitySourceOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public CreateIdentitySourceOutput policyStoreId(String policyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIdentitySourceOutput createIdentitySourceOutput = (CreateIdentitySourceOutput) o;
    return Objects.equals(this.createdDate, createIdentitySourceOutput.createdDate) &&
        Objects.equals(this.identitySourceId, createIdentitySourceOutput.identitySourceId) &&
        Objects.equals(this.lastUpdatedDate, createIdentitySourceOutput.lastUpdatedDate) &&
        Objects.equals(this.policyStoreId, createIdentitySourceOutput.policyStoreId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIdentitySourceOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateIdentitySourceOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIdentitySourceOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateIdentitySourceOutput is not found in the empty JSON string", CreateIdentitySourceOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIdentitySourceOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateIdentitySourceOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateIdentitySourceOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateIdentitySourceOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateIdentitySourceOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateIdentitySourceOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateIdentitySourceOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateIdentitySourceOutput>() {
           @Override
           public void write(JsonWriter out, CreateIdentitySourceOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateIdentitySourceOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateIdentitySourceOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateIdentitySourceOutput
   * @throws IOException if the JSON string is invalid with respect to CreateIdentitySourceOutput
   */
  public static CreateIdentitySourceOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateIdentitySourceOutput.class);
  }

  /**
   * Convert an instance of CreateIdentitySourceOutput to an JSON string
   *
   * @return JSON string
   */
