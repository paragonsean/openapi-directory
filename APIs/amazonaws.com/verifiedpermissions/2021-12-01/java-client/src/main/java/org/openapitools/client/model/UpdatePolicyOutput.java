...
public class UpdatePolicyOutput {
  ...
  public UpdatePolicyOutput() {
  }

  public UpdatePolicyOutput policyStoreId(String policyStoreId) {
  ...
  public UpdatePolicyOutput policyId(String policyId) {
  ...
  public UpdatePolicyOutput policyType(PolicyType policyType) {
  ...
  public UpdatePolicyOutput principal(GetPolicyOutputPrincipal principal) {
  ...
  public UpdatePolicyOutput resource(GetPolicyOutputResource resource) {
  ...
  public UpdatePolicyOutput createdDate(OffsetDateTime createdDate) {
  ...
  public UpdatePolicyOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyOutput updatePolicyOutput = (UpdatePolicyOutput) o;
    return Objects.equals(this.policyStoreId, updatePolicyOutput.policyStoreId) &&
        Objects.equals(this.policyId, updatePolicyOutput.policyId) &&
        Objects.equals(this.policyType, updatePolicyOutput.policyType) &&
        Objects.equals(this.principal, updatePolicyOutput.principal) &&
        Objects.equals(this.resource, updatePolicyOutput.resource) &&
        Objects.equals(this.createdDate, updatePolicyOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, updatePolicyOutput.lastUpdatedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePolicyOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyOutput is not found in the empty JSON string", UpdatePolicyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePolicyOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyOutput>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyOutput
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyOutput
   */
  public static UpdatePolicyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyOutput.class);
  }

  /**
   * Convert an instance of UpdatePolicyOutput to an JSON string
   *
   * @return JSON string
   */
