...
public class ListPolicyTemplatesInput {
  ...
  public ListPolicyTemplatesInput() {
  }

  public ListPolicyTemplatesInput policyStoreId(String policyStoreId) {
  ...
  public ListPolicyTemplatesInput nextToken(String nextToken) {
  ...
  public ListPolicyTemplatesInput maxResults(Integer maxResults) {
  ...
  public boolean equals(Object o) {
    ...
    ListPolicyTemplatesInput listPolicyTemplatesInput = (ListPolicyTemplatesInput) o;
    return Objects.equals(this.policyStoreId, listPolicyTemplatesInput.policyStoreId) &&
        Objects.equals(this.nextToken, listPolicyTemplatesInput.nextToken) &&
        Objects.equals(this.maxResults, listPolicyTemplatesInput.maxResults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, nextToken, maxResults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPolicyTemplatesInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPolicyTemplatesInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPolicyTemplatesInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPolicyTemplatesInput is not found in the empty JSON string", ListPolicyTemplatesInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPolicyTemplatesInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPolicyTemplatesInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPolicyTemplatesInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPolicyTemplatesInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPolicyTemplatesInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPolicyTemplatesInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPolicyTemplatesInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPolicyTemplatesInput>() {
           @Override
           public void write(JsonWriter out, ListPolicyTemplatesInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPolicyTemplatesInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPolicyTemplatesInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPolicyTemplatesInput
   * @throws IOException if the JSON string is invalid with respect to ListPolicyTemplatesInput
   */
  public static ListPolicyTemplatesInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPolicyTemplatesInput.class);
  }

  /**
   * Convert an instance of ListPolicyTemplatesInput to an JSON string
   *
   * @return JSON string
   */
