...
public class ListPoliciesInputFilter {
  ...
  public ListPoliciesInputFilter() {
  }

  public ListPoliciesInputFilter principal(PolicyFilterPrincipal principal) {
  ...
  public ListPoliciesInputFilter resource(PolicyFilterResource resource) {
  ...
  public ListPoliciesInputFilter policyType(PolicyType policyType) {
  ...
  public ListPoliciesInputFilter policyTemplateId(String policyTemplateId) {
  ...
  public boolean equals(Object o) {
    ...
    ListPoliciesInputFilter listPoliciesInputFilter = (ListPoliciesInputFilter) o;
    return Objects.equals(this.principal, listPoliciesInputFilter.principal) &&
        Objects.equals(this.resource, listPoliciesInputFilter.resource) &&
        Objects.equals(this.policyType, listPoliciesInputFilter.policyType) &&
        Objects.equals(this.policyTemplateId, listPoliciesInputFilter.policyTemplateId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPoliciesInputFilter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPoliciesInputFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPoliciesInputFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPoliciesInputFilter is not found in the empty JSON string", ListPoliciesInputFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPoliciesInputFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPoliciesInputFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPoliciesInputFilter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPoliciesInputFilter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPoliciesInputFilter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPoliciesInputFilter.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPoliciesInputFilter>() {
           @Override
           public void write(JsonWriter out, ListPoliciesInputFilter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPoliciesInputFilter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPoliciesInputFilter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPoliciesInputFilter
   * @throws IOException if the JSON string is invalid with respect to ListPoliciesInputFilter
   */
  public static ListPoliciesInputFilter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPoliciesInputFilter.class);
  }

  /**
   * Convert an instance of ListPoliciesInputFilter to an JSON string
   *
   * @return JSON string
   */
