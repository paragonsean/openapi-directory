...
public class PolicyItemDefinition {
  ...
  private PolicyDefinitionItemStatic _static;

  public static final String SERIALIZED_NAME_TEMPLATE_LINKED = "templateLinked";
  @SerializedName(SERIALIZED_NAME_TEMPLATE_LINKED)
  private PolicyDefinitionItemTemplateLinked templateLinked;

  public PolicyItemDefinition() {
  }

  public PolicyItemDefinition _static(PolicyDefinitionItemStatic _static) {
  ...
  public PolicyDefinitionItemStatic getStatic() {
    return _static;
  }

  public void setStatic(PolicyDefinitionItemStatic _static) {
    this._static = _static;
  }


  public PolicyItemDefinition templateLinked(PolicyDefinitionItemTemplateLinked templateLinked) {
   ...
   */
  @javax.annotation.Nullable
  public PolicyDefinitionItemTemplateLinked getTemplateLinked() {
    return templateLinked;
  }

  public void setTemplateLinked(PolicyDefinitionItemTemplateLinked templateLinked) {
    this.templateLinked = templateLinked;
  }
  ...
  public boolean equals(Object o) {
    ...
    PolicyItemDefinition policyItemDefinition = (PolicyItemDefinition) o;
    return Objects.equals(this._static, policyItemDefinition._static) &&
        Objects.equals(this.templateLinked, policyItemDefinition.templateLinked);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyItemDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyItemDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyItemDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyItemDefinition is not found in the empty JSON string", PolicyItemDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyItemDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyItemDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `static`
      if (jsonObj.get("static") != null && !jsonObj.get("static").isJsonNull()) {
        PolicyDefinitionItemStatic.validateJsonElement(jsonObj.get("static"));
      }
      // validate the optional field `templateLinked`
      if (jsonObj.get("templateLinked") != null && !jsonObj.get("templateLinked").isJsonNull()) {
        PolicyDefinitionItemTemplateLinked.validateJsonElement(jsonObj.get("templateLinked"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyItemDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyItemDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyItemDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyItemDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyItemDefinition>() {
           @Override
           public void write(JsonWriter out, PolicyItemDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyItemDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyItemDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyItemDefinition
   * @throws IOException if the JSON string is invalid with respect to PolicyItemDefinition
   */
  public static PolicyItemDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyItemDefinition.class);
  }

  /**
   * Convert an instance of PolicyItemDefinition to an JSON string
   *
   * @return JSON string
   */
