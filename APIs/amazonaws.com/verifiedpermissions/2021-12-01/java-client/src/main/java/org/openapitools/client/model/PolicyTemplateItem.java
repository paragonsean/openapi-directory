...
public class PolicyTemplateItem {
  ...
  public PolicyTemplateItem policyStoreId(String policyStoreId) {
  ...
  public PolicyTemplateItem policyTemplateId(String policyTemplateId) {
  ...
  public PolicyTemplateItem description(String description) {
  ...
  public PolicyTemplateItem createdDate(OffsetDateTime createdDate) {
  ...
  public PolicyTemplateItem lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyTemplateItem policyTemplateItem = (PolicyTemplateItem) o;
    return Objects.equals(this.policyStoreId, policyTemplateItem.policyStoreId) &&
        Objects.equals(this.policyTemplateId, policyTemplateItem.policyTemplateId) &&
        Objects.equals(this.description, policyTemplateItem.description) &&
        Objects.equals(this.createdDate, policyTemplateItem.createdDate) &&
        Objects.equals(this.lastUpdatedDate, policyTemplateItem.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyTemplateId, description, createdDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PolicyTemplateItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyTemplateItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyTemplateItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyTemplateItem is not found in the empty JSON string", PolicyTemplateItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyTemplateItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyTemplateItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyTemplateItem.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyTemplateItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyTemplateItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyTemplateItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyTemplateItem.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyTemplateItem>() {
           @Override
           public void write(JsonWriter out, PolicyTemplateItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyTemplateItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyTemplateItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyTemplateItem
   * @throws IOException if the JSON string is invalid with respect to PolicyTemplateItem
   */
  public static PolicyTemplateItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyTemplateItem.class);
  }

  /**
   * Convert an instance of PolicyTemplateItem to an JSON string
   *
   * @return JSON string
   */
