...
public class PolicyDefinitionDetail {
  ...
  public PolicyDefinitionDetail() {
  }

  public PolicyDefinitionDetail _static(PolicyDefinitionDetailStatic _static) {
  ...
  public PolicyDefinitionDetail templateLinked(PolicyDefinitionDetailTemplateLinked templateLinked) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyDefinitionDetail policyDefinitionDetail = (PolicyDefinitionDetail) o;
    return Objects.equals(this._static, policyDefinitionDetail._static) &&
        Objects.equals(this.templateLinked, policyDefinitionDetail.templateLinked);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyDefinitionDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyDefinitionDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyDefinitionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyDefinitionDetail is not found in the empty JSON string", PolicyDefinitionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyDefinitionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyDefinitionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyDefinitionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyDefinitionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyDefinitionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyDefinitionDetail>() {
           @Override
           public void write(JsonWriter out, PolicyDefinitionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyDefinitionDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyDefinitionDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyDefinitionDetail
   * @throws IOException if the JSON string is invalid with respect to PolicyDefinitionDetail
   */
  public static PolicyDefinitionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyDefinitionDetail.class);
  }

  /**
   * Convert an instance of PolicyDefinitionDetail to an JSON string
   *
   * @return JSON string
   */
