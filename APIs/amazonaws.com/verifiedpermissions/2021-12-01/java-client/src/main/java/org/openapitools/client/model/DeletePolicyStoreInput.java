...
public class DeletePolicyStoreInput {
  ...
  public DeletePolicyStoreInput() {
  }

  public DeletePolicyStoreInput policyStoreId(String policyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePolicyStoreInput deletePolicyStoreInput = (DeletePolicyStoreInput) o;
    return Objects.equals(this.policyStoreId, deletePolicyStoreInput.policyStoreId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeletePolicyStoreInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePolicyStoreInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePolicyStoreInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePolicyStoreInput is not found in the empty JSON string", DeletePolicyStoreInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePolicyStoreInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePolicyStoreInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePolicyStoreInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePolicyStoreInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePolicyStoreInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePolicyStoreInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePolicyStoreInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePolicyStoreInput>() {
           @Override
           public void write(JsonWriter out, DeletePolicyStoreInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePolicyStoreInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePolicyStoreInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePolicyStoreInput
   * @throws IOException if the JSON string is invalid with respect to DeletePolicyStoreInput
   */
  public static DeletePolicyStoreInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePolicyStoreInput.class);
  }

  /**
   * Convert an instance of DeletePolicyStoreInput to an JSON string
   *
   * @return JSON string
   */
