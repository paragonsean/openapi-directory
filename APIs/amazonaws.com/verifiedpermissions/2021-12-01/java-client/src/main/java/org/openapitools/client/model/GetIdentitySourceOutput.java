...
import org.openapitools.client.model.GetIdentitySourceOutputDetails;
...
public class GetIdentitySourceOutput {
  ...
  private GetIdentitySourceOutputDetails details;
  ...
  public GetIdentitySourceOutput() {
  }

  public GetIdentitySourceOutput createdDate(OffsetDateTime createdDate) {
  ...
  public GetIdentitySourceOutput details(GetIdentitySourceOutputDetails details) {
   ...
   */
  @javax.annotation.Nonnull
  public GetIdentitySourceOutputDetails getDetails() {
    return details;
  }

  public void setDetails(GetIdentitySourceOutputDetails details) {
    this.details = details;
  }


  public GetIdentitySourceOutput identitySourceId(String identitySourceId) {
  ...
  public GetIdentitySourceOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public GetIdentitySourceOutput policyStoreId(String policyStoreId) {
  ...
  public GetIdentitySourceOutput principalEntityType(String principalEntityType) {
  ...
  public boolean equals(Object o) {
    ...
    GetIdentitySourceOutput getIdentitySourceOutput = (GetIdentitySourceOutput) o;
    return Objects.equals(this.createdDate, getIdentitySourceOutput.createdDate) &&
        Objects.equals(this.details, getIdentitySourceOutput.details) &&
        Objects.equals(this.identitySourceId, getIdentitySourceOutput.identitySourceId) &&
        Objects.equals(this.lastUpdatedDate, getIdentitySourceOutput.lastUpdatedDate) &&
        Objects.equals(this.policyStoreId, getIdentitySourceOutput.policyStoreId) &&
        Objects.equals(this.principalEntityType, getIdentitySourceOutput.principalEntityType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdDate, details, identitySourceId, lastUpdatedDate, policyStoreId, principalEntityType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetIdentitySourceOutput {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("principalEntityType");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIdentitySourceOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIdentitySourceOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIdentitySourceOutput is not found in the empty JSON string", GetIdentitySourceOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIdentitySourceOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIdentitySourceOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIdentitySourceOutput.openapiRequiredFields) {
      ...
      GetIdentitySourceOutputDetails.validateJsonElement(jsonObj.get("details"));
      ...
      // validate the required field `principalEntityType`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIdentitySourceOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIdentitySourceOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIdentitySourceOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIdentitySourceOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIdentitySourceOutput>() {
           @Override
           public void write(JsonWriter out, GetIdentitySourceOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIdentitySourceOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIdentitySourceOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIdentitySourceOutput
   * @throws IOException if the JSON string is invalid with respect to GetIdentitySourceOutput
   */
  public static GetIdentitySourceOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIdentitySourceOutput.class);
  }

  /**
   * Convert an instance of GetIdentitySourceOutput to an JSON string
   *
   * @return JSON string
   */
