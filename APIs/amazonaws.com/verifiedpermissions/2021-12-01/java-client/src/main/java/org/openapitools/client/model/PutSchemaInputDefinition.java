...
public class PutSchemaInputDefinition {
  public static final String SERIALIZED_NAME_CEDAR_JSON = "cedarJson";
  @SerializedName(SERIALIZED_NAME_CEDAR_JSON)
  private String cedarJson;

  public PutSchemaInputDefinition() {
  }

  public PutSchemaInputDefinition cedarJson(String cedarJson) {
  ...
  public boolean equals(Object o) {
    ...
    PutSchemaInputDefinition putSchemaInputDefinition = (PutSchemaInputDefinition) o;
    return Objects.equals(this.cedarJson, putSchemaInputDefinition.cedarJson);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cedarJson);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PutSchemaInputDefinition {\n");
    sb.append("    cedarJson: ").append(toIndentedString(cedarJson)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PutSchemaInputDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutSchemaInputDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutSchemaInputDefinition is not found in the empty JSON string", PutSchemaInputDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PutSchemaInputDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PutSchemaInputDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `cedarJson`
      if (jsonObj.get("cedarJson") != null && !jsonObj.get("cedarJson").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("cedarJson"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutSchemaInputDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutSchemaInputDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PutSchemaInputDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PutSchemaInputDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<PutSchemaInputDefinition>() {
           @Override
           public void write(JsonWriter out, PutSchemaInputDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PutSchemaInputDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PutSchemaInputDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PutSchemaInputDefinition
   * @throws IOException if the JSON string is invalid with respect to PutSchemaInputDefinition
   */
  public static PutSchemaInputDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PutSchemaInputDefinition.class);
  }

  /**
   * Convert an instance of PutSchemaInputDefinition to an JSON string
   *
   * @return JSON string
   */
