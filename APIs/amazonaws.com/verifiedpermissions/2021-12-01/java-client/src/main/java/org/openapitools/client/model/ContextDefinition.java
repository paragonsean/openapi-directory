...
public class ContextDefinition {
  public static final String SERIALIZED_NAME_CONTEXT_MAP = "contextMap";
  @SerializedName(SERIALIZED_NAME_CONTEXT_MAP)
  private Map contextMap;

  public ContextDefinition() {
  }

  public ContextDefinition contextMap(Map contextMap) {
  ...
  public boolean equals(Object o) {
    ...
    ContextDefinition contextDefinition = (ContextDefinition) o;
    return Objects.equals(this.contextMap, contextDefinition.contextMap);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContextDefinition {\n");
    sb.append("    contextMap: ").append(toIndentedString(contextMap)).append("\n");
    sb.append("}");
    return sb.toString();
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContextDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContextDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContextDefinition is not found in the empty JSON string", ContextDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `contextMap`
      if (jsonObj.get("contextMap") != null && !jsonObj.get("contextMap").isJsonNull()) {
        Map.validateJsonElement(jsonObj.get("contextMap"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContextDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContextDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContextDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContextDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<ContextDefinition>() {
           @Override
           public void write(JsonWriter out, ContextDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContextDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContextDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContextDefinition
   * @throws IOException if the JSON string is invalid with respect to ContextDefinition
   */
  public static ContextDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContextDefinition.class);
  }

  /**
   * Convert an instance of ContextDefinition to an JSON string
   *
   * @return JSON string
   */
