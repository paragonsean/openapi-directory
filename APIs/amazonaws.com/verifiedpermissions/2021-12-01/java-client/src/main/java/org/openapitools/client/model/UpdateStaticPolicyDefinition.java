...
public class UpdateStaticPolicyDefinition {
  ...
  public UpdateStaticPolicyDefinition() {
  }

  public UpdateStaticPolicyDefinition description(String description) {
  ...
  public UpdateStaticPolicyDefinition statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateStaticPolicyDefinition updateStaticPolicyDefinition = (UpdateStaticPolicyDefinition) o;
    return Objects.equals(this.description, updateStaticPolicyDefinition.description) &&
        Objects.equals(this.statement, updateStaticPolicyDefinition.statement);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateStaticPolicyDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateStaticPolicyDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateStaticPolicyDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateStaticPolicyDefinition is not found in the empty JSON string", UpdateStaticPolicyDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateStaticPolicyDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateStaticPolicyDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateStaticPolicyDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateStaticPolicyDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateStaticPolicyDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateStaticPolicyDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateStaticPolicyDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateStaticPolicyDefinition>() {
           @Override
           public void write(JsonWriter out, UpdateStaticPolicyDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateStaticPolicyDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateStaticPolicyDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateStaticPolicyDefinition
   * @throws IOException if the JSON string is invalid with respect to UpdateStaticPolicyDefinition
   */
  public static UpdateStaticPolicyDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateStaticPolicyDefinition.class);
  }

  /**
   * Convert an instance of UpdateStaticPolicyDefinition to an JSON string
   *
   * @return JSON string
   */
