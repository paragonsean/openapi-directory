...
public class ListIdentitySourcesOutput {
  ...
  public static final String SERIALIZED_NAME_IDENTITY_SOURCES = "identitySources";
  @SerializedName(SERIALIZED_NAME_IDENTITY_SOURCES)
  private List identitySources;

  public ListIdentitySourcesOutput() {
  }

  public ListIdentitySourcesOutput nextToken(String nextToken) {
  ...
  public ListIdentitySourcesOutput identitySources(List identitySources) {
  ...
  public List getIdentitySources() {
    return identitySources;
  }

  public void setIdentitySources(List identitySources) {
    this.identitySources = identitySources;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListIdentitySourcesOutput listIdentitySourcesOutput = (ListIdentitySourcesOutput) o;
    return Objects.equals(this.nextToken, listIdentitySourcesOutput.nextToken) &&
        Objects.equals(this.identitySources, listIdentitySourcesOutput.identitySources);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, identitySources);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListIdentitySourcesOutput {\n");
    sb.append("    nextToken: ").append(toIndentedString(nextToken)).append("\n");
    sb.append("    identitySources: ").append(toIndentedString(identitySources)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("identitySources");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("identitySources");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListIdentitySourcesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListIdentitySourcesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListIdentitySourcesOutput is not found in the empty JSON string", ListIdentitySourcesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListIdentitySourcesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListIdentitySourcesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListIdentitySourcesOutput.openapiRequiredFields) {
      ...
      // validate the required field `identitySources`
      List.validateJsonElement(jsonObj.get("identitySources"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListIdentitySourcesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListIdentitySourcesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListIdentitySourcesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListIdentitySourcesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListIdentitySourcesOutput>() {
           @Override
           public void write(JsonWriter out, ListIdentitySourcesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListIdentitySourcesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListIdentitySourcesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListIdentitySourcesOutput
   * @throws IOException if the JSON string is invalid with respect to ListIdentitySourcesOutput
   */
  public static ListIdentitySourcesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListIdentitySourcesOutput.class);
  }

  /**
   * Convert an instance of ListIdentitySourcesOutput to an JSON string
   *
   * @return JSON string
   */
