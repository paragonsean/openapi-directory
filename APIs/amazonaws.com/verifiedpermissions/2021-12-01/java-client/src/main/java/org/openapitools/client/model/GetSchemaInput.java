...
public class GetSchemaInput {
  ...
  public GetSchemaInput policyStoreId(String policyStoreId) {
  ...
  public boolean equals(Object o) {
    ...
    GetSchemaInput getSchemaInput = (GetSchemaInput) o;
    return Objects.equals(this.policyStoreId, getSchemaInput.policyStoreId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSchemaInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSchemaInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSchemaInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetSchemaInput is not found in the empty JSON string", GetSchemaInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSchemaInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetSchemaInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetSchemaInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSchemaInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSchemaInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSchemaInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSchemaInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSchemaInput>() {
           @Override
           public void write(JsonWriter out, GetSchemaInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSchemaInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSchemaInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSchemaInput
   * @throws IOException if the JSON string is invalid with respect to GetSchemaInput
   */
  public static GetSchemaInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSchemaInput.class);
  }

  /**
   * Convert an instance of GetSchemaInput to an JSON string
   *
   * @return JSON string
   */
