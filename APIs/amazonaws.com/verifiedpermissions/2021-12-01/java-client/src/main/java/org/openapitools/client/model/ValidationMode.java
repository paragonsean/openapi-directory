 ...
 */
@JsonAdapter(ValidationMode.Adapter.class)
public enum ValidationMode {
  ...
  public static ValidationMode fromValue(String value) {
    for (ValidationMode b : ValidationMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ValidationMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ValidationMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ValidationMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ValidationMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ValidationMode.fromValue(value);
  }
}
