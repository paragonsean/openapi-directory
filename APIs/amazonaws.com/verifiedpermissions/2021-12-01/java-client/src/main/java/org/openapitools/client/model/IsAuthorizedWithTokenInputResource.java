...
public class IsAuthorizedWithTokenInputResource {
  ...
  public IsAuthorizedWithTokenInputResource() {
  }

  public IsAuthorizedWithTokenInputResource entityType(String entityType) {
  ...
  public IsAuthorizedWithTokenInputResource entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedWithTokenInputResource isAuthorizedWithTokenInputResource = (IsAuthorizedWithTokenInputResource) o;
    return Objects.equals(this.entityType, isAuthorizedWithTokenInputResource.entityType) &&
        Objects.equals(this.entityId, isAuthorizedWithTokenInputResource.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedWithTokenInputResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedWithTokenInputResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedWithTokenInputResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedWithTokenInputResource is not found in the empty JSON string", IsAuthorizedWithTokenInputResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedWithTokenInputResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedWithTokenInputResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsAuthorizedWithTokenInputResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedWithTokenInputResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedWithTokenInputResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedWithTokenInputResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedWithTokenInputResource.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedWithTokenInputResource>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedWithTokenInputResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedWithTokenInputResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedWithTokenInputResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedWithTokenInputResource
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedWithTokenInputResource
   */
  public static IsAuthorizedWithTokenInputResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedWithTokenInputResource.class);
  }

  /**
   * Convert an instance of IsAuthorizedWithTokenInputResource to an JSON string
   *
   * @return JSON string
   */
