...
public class GetIdentitySourceInput {
  ...
  public GetIdentitySourceInput() {
  }

  public GetIdentitySourceInput policyStoreId(String policyStoreId) {
  ...
  public GetIdentitySourceInput identitySourceId(String identitySourceId) {
  ...
  public boolean equals(Object o) {
    ...
    GetIdentitySourceInput getIdentitySourceInput = (GetIdentitySourceInput) o;
    return Objects.equals(this.policyStoreId, getIdentitySourceInput.policyStoreId) &&
        Objects.equals(this.identitySourceId, getIdentitySourceInput.identitySourceId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetIdentitySourceInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetIdentitySourceInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetIdentitySourceInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetIdentitySourceInput is not found in the empty JSON string", GetIdentitySourceInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetIdentitySourceInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetIdentitySourceInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetIdentitySourceInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetIdentitySourceInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetIdentitySourceInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetIdentitySourceInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetIdentitySourceInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetIdentitySourceInput>() {
           @Override
           public void write(JsonWriter out, GetIdentitySourceInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetIdentitySourceInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetIdentitySourceInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetIdentitySourceInput
   * @throws IOException if the JSON string is invalid with respect to GetIdentitySourceInput
   */
  public static GetIdentitySourceInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetIdentitySourceInput.class);
  }

  /**
   * Convert an instance of GetIdentitySourceInput to an JSON string
   *
   * @return JSON string
   */
