...
public class UpdatePolicyInputDefinition {
  ...
  public UpdatePolicyInputDefinition() {
  }

  public UpdatePolicyInputDefinition _static(UpdatePolicyDefinitionStatic _static) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyInputDefinition updatePolicyInputDefinition = (UpdatePolicyInputDefinition) o;
    return Objects.equals(this._static, updatePolicyInputDefinition._static);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePolicyInputDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyInputDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyInputDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyInputDefinition is not found in the empty JSON string", UpdatePolicyInputDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyInputDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyInputDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyInputDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyInputDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyInputDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyInputDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyInputDefinition>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyInputDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyInputDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyInputDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyInputDefinition
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyInputDefinition
   */
  public static UpdatePolicyInputDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyInputDefinition.class);
  }

  /**
   * Convert an instance of UpdatePolicyInputDefinition to an JSON string
   *
   * @return JSON string
   */
