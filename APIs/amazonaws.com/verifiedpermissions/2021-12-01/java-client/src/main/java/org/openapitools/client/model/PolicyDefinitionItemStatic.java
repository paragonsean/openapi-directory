...
public class PolicyDefinitionItemStatic {
  public static final String SERIALIZED_NAME_DESCRIPTION = "description";
  @SerializedName(SERIALIZED_NAME_DESCRIPTION)
  private String description;

  public PolicyDefinitionItemStatic() {
  }

  public PolicyDefinitionItemStatic description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyDefinitionItemStatic policyDefinitionItemStatic = (PolicyDefinitionItemStatic) o;
    return Objects.equals(this.description, policyDefinitionItemStatic.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyDefinitionItemStatic {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyDefinitionItemStatic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyDefinitionItemStatic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyDefinitionItemStatic is not found in the empty JSON string", PolicyDefinitionItemStatic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyDefinitionItemStatic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyDefinitionItemStatic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyDefinitionItemStatic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyDefinitionItemStatic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyDefinitionItemStatic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionItemStatic.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyDefinitionItemStatic>() {
           @Override
           public void write(JsonWriter out, PolicyDefinitionItemStatic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyDefinitionItemStatic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyDefinitionItemStatic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyDefinitionItemStatic
   * @throws IOException if the JSON string is invalid with respect to PolicyDefinitionItemStatic
   */
  public static PolicyDefinitionItemStatic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyDefinitionItemStatic.class);
  }

  /**
   * Convert an instance of PolicyDefinitionItemStatic to an JSON string
   *
   * @return JSON string
   */
