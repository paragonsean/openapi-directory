...
public class UpdatePolicyStoreInputValidationSettings {
  public static final String SERIALIZED_NAME_MODE = "mode";
  @SerializedName(SERIALIZED_NAME_MODE)
  private ValidationMode mode;

  public UpdatePolicyStoreInputValidationSettings() {
  }

  public UpdatePolicyStoreInputValidationSettings mode(ValidationMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyStoreInputValidationSettings updatePolicyStoreInputValidationSettings = (UpdatePolicyStoreInputValidationSettings) o;
    return Objects.equals(this.mode, updatePolicyStoreInputValidationSettings.mode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePolicyStoreInputValidationSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyStoreInputValidationSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyStoreInputValidationSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyStoreInputValidationSettings is not found in the empty JSON string", UpdatePolicyStoreInputValidationSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyStoreInputValidationSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyStoreInputValidationSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePolicyStoreInputValidationSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyStoreInputValidationSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyStoreInputValidationSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyStoreInputValidationSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyStoreInputValidationSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyStoreInputValidationSettings>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyStoreInputValidationSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyStoreInputValidationSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyStoreInputValidationSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyStoreInputValidationSettings
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyStoreInputValidationSettings
   */
  public static UpdatePolicyStoreInputValidationSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyStoreInputValidationSettings.class);
  }

  /**
   * Convert an instance of UpdatePolicyStoreInputValidationSettings to an JSON string
   *
   * @return JSON string
   */
