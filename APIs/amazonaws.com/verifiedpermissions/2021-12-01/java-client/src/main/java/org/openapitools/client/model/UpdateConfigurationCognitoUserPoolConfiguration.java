...
public class UpdateConfigurationCognitoUserPoolConfiguration {
  ...
  public UpdateConfigurationCognitoUserPoolConfiguration() {
  }

  public UpdateConfigurationCognitoUserPoolConfiguration userPoolArn(String userPoolArn) {
  ...
  public UpdateConfigurationCognitoUserPoolConfiguration clientIds(List clientIds) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateConfigurationCognitoUserPoolConfiguration updateConfigurationCognitoUserPoolConfiguration = (UpdateConfigurationCognitoUserPoolConfiguration) o;
    return Objects.equals(this.userPoolArn, updateConfigurationCognitoUserPoolConfiguration.userPoolArn) &&
        Objects.equals(this.clientIds, updateConfigurationCognitoUserPoolConfiguration.clientIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateConfigurationCognitoUserPoolConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateConfigurationCognitoUserPoolConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConfigurationCognitoUserPoolConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateConfigurationCognitoUserPoolConfiguration is not found in the empty JSON string", UpdateConfigurationCognitoUserPoolConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateConfigurationCognitoUserPoolConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateConfigurationCognitoUserPoolConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateConfigurationCognitoUserPoolConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateConfigurationCognitoUserPoolConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateConfigurationCognitoUserPoolConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateConfigurationCognitoUserPoolConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateConfigurationCognitoUserPoolConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateConfigurationCognitoUserPoolConfiguration>() {
           @Override
           public void write(JsonWriter out, UpdateConfigurationCognitoUserPoolConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateConfigurationCognitoUserPoolConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateConfigurationCognitoUserPoolConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateConfigurationCognitoUserPoolConfiguration
   * @throws IOException if the JSON string is invalid with respect to UpdateConfigurationCognitoUserPoolConfiguration
   */
  public static UpdateConfigurationCognitoUserPoolConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateConfigurationCognitoUserPoolConfiguration.class);
  }

  /**
   * Convert an instance of UpdateConfigurationCognitoUserPoolConfiguration to an JSON string
   *
   * @return JSON string
   */
