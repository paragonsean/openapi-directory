...
public class PolicyItemPrincipal {
  ...
  public PolicyItemPrincipal() {
  }

  public PolicyItemPrincipal entityType(String entityType) {
  ...
  public PolicyItemPrincipal entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyItemPrincipal policyItemPrincipal = (PolicyItemPrincipal) o;
    return Objects.equals(this.entityType, policyItemPrincipal.entityType) &&
        Objects.equals(this.entityId, policyItemPrincipal.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyItemPrincipal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyItemPrincipal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyItemPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyItemPrincipal is not found in the empty JSON string", PolicyItemPrincipal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyItemPrincipal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyItemPrincipal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyItemPrincipal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyItemPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyItemPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyItemPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyItemPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyItemPrincipal>() {
           @Override
           public void write(JsonWriter out, PolicyItemPrincipal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyItemPrincipal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyItemPrincipal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyItemPrincipal
   * @throws IOException if the JSON string is invalid with respect to PolicyItemPrincipal
   */
  public static PolicyItemPrincipal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyItemPrincipal.class);
  }

  /**
   * Convert an instance of PolicyItemPrincipal to an JSON string
   *
   * @return JSON string
   */
