...
public class ListPoliciesOutput {
  ...
  public ListPoliciesOutput() {
  }

  public ListPoliciesOutput nextToken(String nextToken) {
  ...
  public ListPoliciesOutput policies(List policies) {
  ...
  public boolean equals(Object o) {
    ...
    ListPoliciesOutput listPoliciesOutput = (ListPoliciesOutput) o;
    return Objects.equals(this.nextToken, listPoliciesOutput.nextToken) &&
        Objects.equals(this.policies, listPoliciesOutput.policies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextToken, policies);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListPoliciesOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListPoliciesOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListPoliciesOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPoliciesOutput is not found in the empty JSON string", ListPoliciesOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListPoliciesOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPoliciesOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListPoliciesOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListPoliciesOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListPoliciesOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListPoliciesOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListPoliciesOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ListPoliciesOutput>() {
           @Override
           public void write(JsonWriter out, ListPoliciesOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListPoliciesOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListPoliciesOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListPoliciesOutput
   * @throws IOException if the JSON string is invalid with respect to ListPoliciesOutput
   */
  public static ListPoliciesOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListPoliciesOutput.class);
  }

  /**
   * Convert an instance of ListPoliciesOutput to an JSON string
   *
   * @return JSON string
   */
