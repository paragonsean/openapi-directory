...
public class GetPolicyTemplateInput {
  ...
  public GetPolicyTemplateInput() {
  }

  public GetPolicyTemplateInput policyStoreId(String policyStoreId) {
  ...
  public GetPolicyTemplateInput policyTemplateId(String policyTemplateId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyTemplateInput getPolicyTemplateInput = (GetPolicyTemplateInput) o;
    return Objects.equals(this.policyStoreId, getPolicyTemplateInput.policyStoreId) &&
        Objects.equals(this.policyTemplateId, getPolicyTemplateInput.policyTemplateId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyTemplateId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPolicyTemplateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyTemplateInput is not found in the empty JSON string", GetPolicyTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyTemplateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyTemplateInput>() {
           @Override
           public void write(JsonWriter out, GetPolicyTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyTemplateInput
   * @throws IOException if the JSON string is invalid with respect to GetPolicyTemplateInput
   */
  public static GetPolicyTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyTemplateInput.class);
  }

  /**
   * Convert an instance of GetPolicyTemplateInput to an JSON string
   *
   * @return JSON string
   */
