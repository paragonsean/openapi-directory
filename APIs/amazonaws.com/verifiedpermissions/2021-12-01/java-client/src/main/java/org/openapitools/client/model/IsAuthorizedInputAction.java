...
public class IsAuthorizedInputAction {
  ...
  public IsAuthorizedInputAction() {
  }

  public IsAuthorizedInputAction actionType(String actionType) {
  ...
  public IsAuthorizedInputAction actionId(String actionId) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedInputAction isAuthorizedInputAction = (IsAuthorizedInputAction) o;
    return Objects.equals(this.actionType, isAuthorizedInputAction.actionType) &&
        Objects.equals(this.actionId, isAuthorizedInputAction.actionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedInputAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedInputAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedInputAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedInputAction is not found in the empty JSON string", IsAuthorizedInputAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedInputAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedInputAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsAuthorizedInputAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedInputAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedInputAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedInputAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedInputAction.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedInputAction>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedInputAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedInputAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedInputAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedInputAction
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedInputAction
   */
  public static IsAuthorizedInputAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedInputAction.class);
  }

  /**
   * Convert an instance of IsAuthorizedInputAction to an JSON string
   *
   * @return JSON string
   */
