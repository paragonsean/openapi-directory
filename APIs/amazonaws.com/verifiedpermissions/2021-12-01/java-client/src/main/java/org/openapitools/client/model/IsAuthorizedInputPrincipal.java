...
public class IsAuthorizedInputPrincipal {
  ...
  public IsAuthorizedInputPrincipal() {
  }

  public IsAuthorizedInputPrincipal entityType(String entityType) {
  ...
  public IsAuthorizedInputPrincipal entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedInputPrincipal isAuthorizedInputPrincipal = (IsAuthorizedInputPrincipal) o;
    return Objects.equals(this.entityType, isAuthorizedInputPrincipal.entityType) &&
        Objects.equals(this.entityId, isAuthorizedInputPrincipal.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedInputPrincipal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedInputPrincipal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedInputPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedInputPrincipal is not found in the empty JSON string", IsAuthorizedInputPrincipal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedInputPrincipal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedInputPrincipal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsAuthorizedInputPrincipal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedInputPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedInputPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedInputPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedInputPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedInputPrincipal>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedInputPrincipal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedInputPrincipal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedInputPrincipal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedInputPrincipal
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedInputPrincipal
   */
  public static IsAuthorizedInputPrincipal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedInputPrincipal.class);
  }

  /**
   * Convert an instance of IsAuthorizedInputPrincipal to an JSON string
   *
   * @return JSON string
   */
