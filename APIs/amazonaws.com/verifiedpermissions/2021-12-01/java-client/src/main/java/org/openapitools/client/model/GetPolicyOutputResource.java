...
public class GetPolicyOutputResource {
  ...
  public GetPolicyOutputResource() {
  }

  public GetPolicyOutputResource entityType(String entityType) {
  ...
  public GetPolicyOutputResource entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyOutputResource getPolicyOutputResource = (GetPolicyOutputResource) o;
    return Objects.equals(this.entityType, getPolicyOutputResource.entityType) &&
        Objects.equals(this.entityId, getPolicyOutputResource.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPolicyOutputResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyOutputResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyOutputResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyOutputResource is not found in the empty JSON string", GetPolicyOutputResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyOutputResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyOutputResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyOutputResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyOutputResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyOutputResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyOutputResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyOutputResource.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyOutputResource>() {
           @Override
           public void write(JsonWriter out, GetPolicyOutputResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyOutputResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyOutputResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyOutputResource
   * @throws IOException if the JSON string is invalid with respect to GetPolicyOutputResource
   */
  public static GetPolicyOutputResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyOutputResource.class);
  }

  /**
   * Convert an instance of GetPolicyOutputResource to an JSON string
   *
   * @return JSON string
   */
