...
/**
 * Gets or Sets OpenIdIssuer
 */
@JsonAdapter(OpenIdIssuer.Adapter.class)
public enum OpenIdIssuer {
  ...
  public static OpenIdIssuer fromValue(String value) {
    for (OpenIdIssuer b : OpenIdIssuer.values()) {
  ...
  public static class Adapter extends TypeAdapter<OpenIdIssuer> {
    @Override
    public void write(final JsonWriter jsonWriter, final OpenIdIssuer enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public OpenIdIssuer read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return OpenIdIssuer.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    OpenIdIssuer.fromValue(value);
  }
}
