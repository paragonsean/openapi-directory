...
public class GetPolicyInput {
  ...
  public GetPolicyInput() {
  }

  public GetPolicyInput policyStoreId(String policyStoreId) {
  ...
  public GetPolicyInput policyId(String policyId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyInput getPolicyInput = (GetPolicyInput) o;
    return Objects.equals(this.policyStoreId, getPolicyInput.policyStoreId) &&
        Objects.equals(this.policyId, getPolicyInput.policyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPolicyInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyInput is not found in the empty JSON string", GetPolicyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyInput>() {
           @Override
           public void write(JsonWriter out, GetPolicyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyInput
   * @throws IOException if the JSON string is invalid with respect to GetPolicyInput
   */
  public static GetPolicyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyInput.class);
  }

  /**
   * Convert an instance of GetPolicyInput to an JSON string
   *
   * @return JSON string
   */
