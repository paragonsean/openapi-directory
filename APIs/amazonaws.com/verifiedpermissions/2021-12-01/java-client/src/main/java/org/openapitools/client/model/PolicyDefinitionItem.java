...
public class PolicyDefinitionItem {
  ...
  public PolicyDefinitionItem() {
  }

  public PolicyDefinitionItem _static(PolicyDefinitionItemStatic _static) {
  ...
  public PolicyDefinitionItem templateLinked(PolicyDefinitionItemTemplateLinked templateLinked) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyDefinitionItem policyDefinitionItem = (PolicyDefinitionItem) o;
    return Objects.equals(this._static, policyDefinitionItem._static) &&
        Objects.equals(this.templateLinked, policyDefinitionItem.templateLinked);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyDefinitionItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyDefinitionItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyDefinitionItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyDefinitionItem is not found in the empty JSON string", PolicyDefinitionItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyDefinitionItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyDefinitionItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyDefinitionItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyDefinitionItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyDefinitionItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionItem.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyDefinitionItem>() {
           @Override
           public void write(JsonWriter out, PolicyDefinitionItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyDefinitionItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyDefinitionItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyDefinitionItem
   * @throws IOException if the JSON string is invalid with respect to PolicyDefinitionItem
   */
  public static PolicyDefinitionItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyDefinitionItem.class);
  }

  /**
   * Convert an instance of PolicyDefinitionItem to an JSON string
   *
   * @return JSON string
   */
