...
import org.openapitools.client.model.EntityItemIdentifier;
...
public class EntityItem {
  ...
  private EntityItemIdentifier identifier;
  ...
  public EntityItem identifier(EntityItemIdentifier identifier) {
  ...
  public EntityItemIdentifier getIdentifier() {
    return identifier;
  }

  public void setIdentifier(EntityItemIdentifier identifier) {
    this.identifier = identifier;
  }


  public EntityItem attributes(Map attributes) {
  ...
  public EntityItem parents(List parents) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, entityItem.identifier) &&
        Objects.equals(this.attributes, entityItem.attributes) &&
        Objects.equals(this.parents, entityItem.parents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, attributes, parents);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityItem is not found in the empty JSON string", EntityItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntityItem.openapiRequiredFields) {
      ...
      EntityItemIdentifier.validateJsonElement(jsonObj.get("identifier"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityItem>() {
           @Override
           public void write(JsonWriter out, EntityItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityItem
   * @throws IOException if the JSON string is invalid with respect to EntityItem
   */
  public static EntityItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityItem.class);
  }

  /**
   * Convert an instance of EntityItem to an JSON string
   *
   * @return JSON string
   */
