...
public class IsAuthorizedInputContext {
  public static final String SERIALIZED_NAME_CONTEXT_MAP = "contextMap";
  @SerializedName(SERIALIZED_NAME_CONTEXT_MAP)
  private Map contextMap;

  public IsAuthorizedInputContext() {
  }

  public IsAuthorizedInputContext contextMap(Map contextMap) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedInputContext isAuthorizedInputContext = (IsAuthorizedInputContext) o;
    return Objects.equals(this.contextMap, isAuthorizedInputContext.contextMap);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedInputContext {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedInputContext
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedInputContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedInputContext is not found in the empty JSON string", IsAuthorizedInputContext.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedInputContext.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedInputContext` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedInputContext.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedInputContext' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedInputContext> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedInputContext.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedInputContext>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedInputContext value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedInputContext read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedInputContext given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedInputContext
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedInputContext
   */
  public static IsAuthorizedInputContext fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedInputContext.class);
  }

  /**
   * Convert an instance of IsAuthorizedInputContext to an JSON string
   *
   * @return JSON string
   */
