...
public class ApiClient {
    ...
    private String basePath = "http://verifiedpermissions.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://verifiedpermissions.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://verifiedpermissions.{region}.amazonaws.com",
      "The Amazon Verified Permissions multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://verifiedpermissions.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://verifiedpermissions.{region}.amazonaws.com.cn",
      "The Amazon Verified Permissions endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021-12-01/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://verifiedpermissions.us-east-1.amazonaws.com
