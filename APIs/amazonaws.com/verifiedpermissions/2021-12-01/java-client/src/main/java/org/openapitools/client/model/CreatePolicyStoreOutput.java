...
public class CreatePolicyStoreOutput {
  ...
  public CreatePolicyStoreOutput() {
  }

  public CreatePolicyStoreOutput policyStoreId(String policyStoreId) {
  ...
  public CreatePolicyStoreOutput arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public CreatePolicyStoreOutput createdDate(OffsetDateTime createdDate) {
  ...
  public CreatePolicyStoreOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePolicyStoreOutput createPolicyStoreOutput = (CreatePolicyStoreOutput) o;
    return Objects.equals(this.policyStoreId, createPolicyStoreOutput.policyStoreId) &&
        Objects.equals(this.arn, createPolicyStoreOutput.arn) &&
        Objects.equals(this.createdDate, createPolicyStoreOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, createPolicyStoreOutput.lastUpdatedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePolicyStoreOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePolicyStoreOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePolicyStoreOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePolicyStoreOutput is not found in the empty JSON string", CreatePolicyStoreOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePolicyStoreOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePolicyStoreOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePolicyStoreOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePolicyStoreOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePolicyStoreOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePolicyStoreOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePolicyStoreOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePolicyStoreOutput>() {
           @Override
           public void write(JsonWriter out, CreatePolicyStoreOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePolicyStoreOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePolicyStoreOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePolicyStoreOutput
   * @throws IOException if the JSON string is invalid with respect to CreatePolicyStoreOutput
   */
  public static CreatePolicyStoreOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePolicyStoreOutput.class);
  }

  /**
   * Convert an instance of CreatePolicyStoreOutput to an JSON string
   *
   * @return JSON string
   */
