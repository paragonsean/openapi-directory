...
import org.openapitools.client.model.UpdatePolicyDefinitionStatic;
...
public class UpdatePolicyDefinition {
  ...
  private UpdatePolicyDefinitionStatic _static;

  public UpdatePolicyDefinition() {
  }

  public UpdatePolicyDefinition _static(UpdatePolicyDefinitionStatic _static) {
  ...
  public UpdatePolicyDefinitionStatic getStatic() {
    return _static;
  }

  public void setStatic(UpdatePolicyDefinitionStatic _static) {
    this._static = _static;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyDefinition updatePolicyDefinition = (UpdatePolicyDefinition) o;
    return Objects.equals(this._static, updatePolicyDefinition._static);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePolicyDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyDefinition is not found in the empty JSON string", UpdatePolicyDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `static`
      if (jsonObj.get("static") != null && !jsonObj.get("static").isJsonNull()) {
        UpdatePolicyDefinitionStatic.validateJsonElement(jsonObj.get("static"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyDefinition>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyDefinition
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyDefinition
   */
  public static UpdatePolicyDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyDefinition.class);
  }

  /**
   * Convert an instance of UpdatePolicyDefinition to an JSON string
   *
   * @return JSON string
   */
