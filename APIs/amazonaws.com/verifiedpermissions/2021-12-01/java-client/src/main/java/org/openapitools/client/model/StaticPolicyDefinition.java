...
public class StaticPolicyDefinition {
  ...
  public StaticPolicyDefinition() {
  }

  public StaticPolicyDefinition description(String description) {
  ...
  public StaticPolicyDefinition statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    StaticPolicyDefinition staticPolicyDefinition = (StaticPolicyDefinition) o;
    return Objects.equals(this.description, staticPolicyDefinition.description) &&
        Objects.equals(this.statement, staticPolicyDefinition.statement);
  }
  ...
  public String toString() {
    ...
    sb.append("class StaticPolicyDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaticPolicyDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticPolicyDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StaticPolicyDefinition is not found in the empty JSON string", StaticPolicyDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticPolicyDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StaticPolicyDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StaticPolicyDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaticPolicyDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaticPolicyDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaticPolicyDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaticPolicyDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<StaticPolicyDefinition>() {
           @Override
           public void write(JsonWriter out, StaticPolicyDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StaticPolicyDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StaticPolicyDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StaticPolicyDefinition
   * @throws IOException if the JSON string is invalid with respect to StaticPolicyDefinition
   */
  public static StaticPolicyDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaticPolicyDefinition.class);
  }

  /**
   * Convert an instance of StaticPolicyDefinition to an JSON string
   *
   * @return JSON string
   */
