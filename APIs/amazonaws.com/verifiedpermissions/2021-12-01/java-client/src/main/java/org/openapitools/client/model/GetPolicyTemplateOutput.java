...
public class GetPolicyTemplateOutput {
  ...
  public GetPolicyTemplateOutput() {
  }

  public GetPolicyTemplateOutput policyStoreId(String policyStoreId) {
  ...
  public GetPolicyTemplateOutput policyTemplateId(String policyTemplateId) {
  ...
  public GetPolicyTemplateOutput description(String description) {
  ...
  public GetPolicyTemplateOutput statement(String statement) {
  ...
  public GetPolicyTemplateOutput createdDate(OffsetDateTime createdDate) {
  ...
  public GetPolicyTemplateOutput lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyTemplateOutput getPolicyTemplateOutput = (GetPolicyTemplateOutput) o;
    return Objects.equals(this.policyStoreId, getPolicyTemplateOutput.policyStoreId) &&
        Objects.equals(this.policyTemplateId, getPolicyTemplateOutput.policyTemplateId) &&
        Objects.equals(this.description, getPolicyTemplateOutput.description) &&
        Objects.equals(this.statement, getPolicyTemplateOutput.statement) &&
        Objects.equals(this.createdDate, getPolicyTemplateOutput.createdDate) &&
        Objects.equals(this.lastUpdatedDate, getPolicyTemplateOutput.lastUpdatedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyStoreId, policyTemplateId, description, statement, createdDate, lastUpdatedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPolicyTemplateOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyTemplateOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyTemplateOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyTemplateOutput is not found in the empty JSON string", GetPolicyTemplateOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyTemplateOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyTemplateOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyTemplateOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyTemplateOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyTemplateOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyTemplateOutput>() {
           @Override
           public void write(JsonWriter out, GetPolicyTemplateOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyTemplateOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyTemplateOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyTemplateOutput
   * @throws IOException if the JSON string is invalid with respect to GetPolicyTemplateOutput
   */
  public static GetPolicyTemplateOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyTemplateOutput.class);
  }

  /**
   * Convert an instance of GetPolicyTemplateOutput to an JSON string
   *
   * @return JSON string
   */
