...
public class AttributeValueEntityIdentifier {
  ...
  public AttributeValueEntityIdentifier() {
  }

  public AttributeValueEntityIdentifier entityType(String entityType) {
  ...
  public AttributeValueEntityIdentifier entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    AttributeValueEntityIdentifier attributeValueEntityIdentifier = (AttributeValueEntityIdentifier) o;
    return Objects.equals(this.entityType, attributeValueEntityIdentifier.entityType) &&
        Objects.equals(this.entityId, attributeValueEntityIdentifier.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributeValueEntityIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttributeValueEntityIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttributeValueEntityIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributeValueEntityIdentifier is not found in the empty JSON string", AttributeValueEntityIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttributeValueEntityIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributeValueEntityIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttributeValueEntityIdentifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributeValueEntityIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributeValueEntityIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributeValueEntityIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributeValueEntityIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributeValueEntityIdentifier>() {
           @Override
           public void write(JsonWriter out, AttributeValueEntityIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttributeValueEntityIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttributeValueEntityIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttributeValueEntityIdentifier
   * @throws IOException if the JSON string is invalid with respect to AttributeValueEntityIdentifier
   */
  public static AttributeValueEntityIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributeValueEntityIdentifier.class);
  }

  /**
   * Convert an instance of AttributeValueEntityIdentifier to an JSON string
   *
   * @return JSON string
   */
