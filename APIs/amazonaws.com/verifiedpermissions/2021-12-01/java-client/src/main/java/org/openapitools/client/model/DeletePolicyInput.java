...
public class DeletePolicyInput {
  ...
  public DeletePolicyInput() {
  }

  public DeletePolicyInput policyStoreId(String policyStoreId) {
  ...
  public DeletePolicyInput policyId(String policyId) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePolicyInput deletePolicyInput = (DeletePolicyInput) o;
    return Objects.equals(this.policyStoreId, deletePolicyInput.policyStoreId) &&
        Objects.equals(this.policyId, deletePolicyInput.policyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePolicyInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePolicyInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePolicyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePolicyInput is not found in the empty JSON string", DeletePolicyInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePolicyInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePolicyInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePolicyInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePolicyInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePolicyInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePolicyInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePolicyInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePolicyInput>() {
           @Override
           public void write(JsonWriter out, DeletePolicyInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePolicyInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePolicyInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePolicyInput
   * @throws IOException if the JSON string is invalid with respect to DeletePolicyInput
   */
  public static DeletePolicyInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePolicyInput.class);
  }

  /**
   * Convert an instance of DeletePolicyInput to an JSON string
   *
   * @return JSON string
   */
