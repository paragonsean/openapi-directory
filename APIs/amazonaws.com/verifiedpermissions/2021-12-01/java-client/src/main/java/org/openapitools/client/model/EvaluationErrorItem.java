...
public class EvaluationErrorItem {
  ...
  public EvaluationErrorItem() {
  }

  public EvaluationErrorItem errorDescription(String errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    EvaluationErrorItem evaluationErrorItem = (EvaluationErrorItem) o;
    return Objects.equals(this.errorDescription, evaluationErrorItem.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvaluationErrorItem {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("errorDescription");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EvaluationErrorItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EvaluationErrorItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EvaluationErrorItem is not found in the empty JSON string", EvaluationErrorItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluationErrorItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluationErrorItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EvaluationErrorItem.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `errorDescription`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EvaluationErrorItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EvaluationErrorItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EvaluationErrorItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EvaluationErrorItem.class));

       return (TypeAdapter<T>) new TypeAdapter<EvaluationErrorItem>() {
           @Override
           public void write(JsonWriter out, EvaluationErrorItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EvaluationErrorItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EvaluationErrorItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EvaluationErrorItem
   * @throws IOException if the JSON string is invalid with respect to EvaluationErrorItem
   */
  public static EvaluationErrorItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EvaluationErrorItem.class);
  }

  /**
   * Convert an instance of EvaluationErrorItem to an JSON string
   *
   * @return JSON string
   */
