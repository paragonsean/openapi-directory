...
public class PolicyDefinitionStatic {
  ...
  public PolicyDefinitionStatic() {
  }

  public PolicyDefinitionStatic description(String description) {
  ...
  public PolicyDefinitionStatic statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyDefinitionStatic policyDefinitionStatic = (PolicyDefinitionStatic) o;
    return Objects.equals(this.description, policyDefinitionStatic.description) &&
        Objects.equals(this.statement, policyDefinitionStatic.statement);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyDefinitionStatic {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyDefinitionStatic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyDefinitionStatic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyDefinitionStatic is not found in the empty JSON string", PolicyDefinitionStatic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyDefinitionStatic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyDefinitionStatic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyDefinitionStatic.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyDefinitionStatic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyDefinitionStatic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyDefinitionStatic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionStatic.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyDefinitionStatic>() {
           @Override
           public void write(JsonWriter out, PolicyDefinitionStatic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyDefinitionStatic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyDefinitionStatic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyDefinitionStatic
   * @throws IOException if the JSON string is invalid with respect to PolicyDefinitionStatic
   */
  public static PolicyDefinitionStatic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyDefinitionStatic.class);
  }

  /**
   * Convert an instance of PolicyDefinitionStatic to an JSON string
   *
   * @return JSON string
   */
