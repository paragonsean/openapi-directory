...
public class IsAuthorizedWithTokenOutput {
  ...
  public IsAuthorizedWithTokenOutput decision(Decision decision) {
  ...
  public IsAuthorizedWithTokenOutput determiningPolicies(List determiningPolicies) {
  ...
  public IsAuthorizedWithTokenOutput errors(List errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedWithTokenOutput isAuthorizedWithTokenOutput = (IsAuthorizedWithTokenOutput) o;
    return Objects.equals(this.decision, isAuthorizedWithTokenOutput.decision) &&
        Objects.equals(this.determiningPolicies, isAuthorizedWithTokenOutput.determiningPolicies) &&
        Objects.equals(this.errors, isAuthorizedWithTokenOutput.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedWithTokenOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedWithTokenOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedWithTokenOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedWithTokenOutput is not found in the empty JSON string", IsAuthorizedWithTokenOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedWithTokenOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedWithTokenOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsAuthorizedWithTokenOutput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedWithTokenOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedWithTokenOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedWithTokenOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedWithTokenOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedWithTokenOutput>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedWithTokenOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedWithTokenOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedWithTokenOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedWithTokenOutput
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedWithTokenOutput
   */
  public static IsAuthorizedWithTokenOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedWithTokenOutput.class);
  }

  /**
   * Convert an instance of IsAuthorizedWithTokenOutput to an JSON string
   *
   * @return JSON string
   */
