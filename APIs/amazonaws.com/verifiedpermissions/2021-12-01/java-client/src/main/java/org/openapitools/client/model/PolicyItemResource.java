...
public class PolicyItemResource {
  ...
  public PolicyItemResource() {
  }

  public PolicyItemResource entityType(String entityType) {
  ...
  public PolicyItemResource entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyItemResource policyItemResource = (PolicyItemResource) o;
    return Objects.equals(this.entityType, policyItemResource.entityType) &&
        Objects.equals(this.entityId, policyItemResource.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyItemResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyItemResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyItemResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyItemResource is not found in the empty JSON string", PolicyItemResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyItemResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyItemResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyItemResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyItemResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyItemResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyItemResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyItemResource.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyItemResource>() {
           @Override
           public void write(JsonWriter out, PolicyItemResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyItemResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyItemResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyItemResource
   * @throws IOException if the JSON string is invalid with respect to PolicyItemResource
   */
  public static PolicyItemResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyItemResource.class);
  }

  /**
   * Convert an instance of PolicyItemResource to an JSON string
   *
   * @return JSON string
   */
