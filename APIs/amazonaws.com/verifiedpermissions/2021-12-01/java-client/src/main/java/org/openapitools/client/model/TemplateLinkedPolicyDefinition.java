...
public class TemplateLinkedPolicyDefinition {
  ...
  public TemplateLinkedPolicyDefinition() {
  }

  public TemplateLinkedPolicyDefinition policyTemplateId(String policyTemplateId) {
  ...
  public TemplateLinkedPolicyDefinition principal(TemplateLinkedPolicyDefinitionPrincipal principal) {
  ...
  public TemplateLinkedPolicyDefinition resource(TemplateLinkedPolicyDefinitionResource resource) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateLinkedPolicyDefinition templateLinkedPolicyDefinition = (TemplateLinkedPolicyDefinition) o;
    return Objects.equals(this.policyTemplateId, templateLinkedPolicyDefinition.policyTemplateId) &&
        Objects.equals(this.principal, templateLinkedPolicyDefinition.principal) &&
        Objects.equals(this.resource, templateLinkedPolicyDefinition.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateLinkedPolicyDefinition {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateLinkedPolicyDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateLinkedPolicyDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateLinkedPolicyDefinition is not found in the empty JSON string", TemplateLinkedPolicyDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateLinkedPolicyDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateLinkedPolicyDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateLinkedPolicyDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateLinkedPolicyDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateLinkedPolicyDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateLinkedPolicyDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateLinkedPolicyDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateLinkedPolicyDefinition>() {
           @Override
           public void write(JsonWriter out, TemplateLinkedPolicyDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateLinkedPolicyDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateLinkedPolicyDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateLinkedPolicyDefinition
   * @throws IOException if the JSON string is invalid with respect to TemplateLinkedPolicyDefinition
   */
  public static TemplateLinkedPolicyDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateLinkedPolicyDefinition.class);
  }

  /**
   * Convert an instance of TemplateLinkedPolicyDefinition to an JSON string
   *
   * @return JSON string
   */
