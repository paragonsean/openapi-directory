...
public class PolicyDefinitionTemplateLinked {
  ...
  public PolicyDefinitionTemplateLinked() {
  }

  public PolicyDefinitionTemplateLinked policyTemplateId(String policyTemplateId) {
  ...
  public PolicyDefinitionTemplateLinked principal(TemplateLinkedPolicyDefinitionPrincipal principal) {
  ...
  public PolicyDefinitionTemplateLinked resource(TemplateLinkedPolicyDefinitionResource resource) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyDefinitionTemplateLinked policyDefinitionTemplateLinked = (PolicyDefinitionTemplateLinked) o;
    return Objects.equals(this.policyTemplateId, policyDefinitionTemplateLinked.policyTemplateId) &&
        Objects.equals(this.principal, policyDefinitionTemplateLinked.principal) &&
        Objects.equals(this.resource, policyDefinitionTemplateLinked.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyDefinitionTemplateLinked {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyDefinitionTemplateLinked
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyDefinitionTemplateLinked.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyDefinitionTemplateLinked is not found in the empty JSON string", PolicyDefinitionTemplateLinked.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyDefinitionTemplateLinked.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyDefinitionTemplateLinked` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PolicyDefinitionTemplateLinked.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyDefinitionTemplateLinked.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyDefinitionTemplateLinked' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyDefinitionTemplateLinked> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionTemplateLinked.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyDefinitionTemplateLinked>() {
           @Override
           public void write(JsonWriter out, PolicyDefinitionTemplateLinked value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyDefinitionTemplateLinked read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyDefinitionTemplateLinked given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyDefinitionTemplateLinked
   * @throws IOException if the JSON string is invalid with respect to PolicyDefinitionTemplateLinked
   */
  public static PolicyDefinitionTemplateLinked fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyDefinitionTemplateLinked.class);
  }

  /**
   * Convert an instance of PolicyDefinitionTemplateLinked to an JSON string
   *
   * @return JSON string
   */
