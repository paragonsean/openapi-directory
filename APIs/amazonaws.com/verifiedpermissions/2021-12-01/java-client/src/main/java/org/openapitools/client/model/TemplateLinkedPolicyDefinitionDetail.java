...
public class TemplateLinkedPolicyDefinitionDetail {
  ...
  public TemplateLinkedPolicyDefinitionDetail() {
  }

  public TemplateLinkedPolicyDefinitionDetail policyTemplateId(String policyTemplateId) {
  ...
  public TemplateLinkedPolicyDefinitionDetail principal(TemplateLinkedPolicyDefinitionPrincipal principal) {
  ...
  public TemplateLinkedPolicyDefinitionDetail resource(TemplateLinkedPolicyDefinitionResource resource) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateLinkedPolicyDefinitionDetail templateLinkedPolicyDefinitionDetail = (TemplateLinkedPolicyDefinitionDetail) o;
    return Objects.equals(this.policyTemplateId, templateLinkedPolicyDefinitionDetail.policyTemplateId) &&
        Objects.equals(this.principal, templateLinkedPolicyDefinitionDetail.principal) &&
        Objects.equals(this.resource, templateLinkedPolicyDefinitionDetail.resource);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateLinkedPolicyDefinitionDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateLinkedPolicyDefinitionDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateLinkedPolicyDefinitionDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateLinkedPolicyDefinitionDetail is not found in the empty JSON string", TemplateLinkedPolicyDefinitionDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateLinkedPolicyDefinitionDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateLinkedPolicyDefinitionDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateLinkedPolicyDefinitionDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateLinkedPolicyDefinitionDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateLinkedPolicyDefinitionDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateLinkedPolicyDefinitionDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateLinkedPolicyDefinitionDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateLinkedPolicyDefinitionDetail>() {
           @Override
           public void write(JsonWriter out, TemplateLinkedPolicyDefinitionDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateLinkedPolicyDefinitionDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateLinkedPolicyDefinitionDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateLinkedPolicyDefinitionDetail
   * @throws IOException if the JSON string is invalid with respect to TemplateLinkedPolicyDefinitionDetail
   */
  public static TemplateLinkedPolicyDefinitionDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateLinkedPolicyDefinitionDetail.class);
  }

  /**
   * Convert an instance of TemplateLinkedPolicyDefinitionDetail to an JSON string
   *
   * @return JSON string
   */
