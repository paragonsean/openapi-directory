...
public class UpdatePolicyDefinitionStatic {
  ...
  public UpdatePolicyDefinitionStatic() {
  }

  public UpdatePolicyDefinitionStatic description(String description) {
  ...
  public UpdatePolicyDefinitionStatic statement(String statement) {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePolicyDefinitionStatic updatePolicyDefinitionStatic = (UpdatePolicyDefinitionStatic) o;
    return Objects.equals(this.description, updatePolicyDefinitionStatic.description) &&
        Objects.equals(this.statement, updatePolicyDefinitionStatic.statement);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePolicyDefinitionStatic {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePolicyDefinitionStatic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePolicyDefinitionStatic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdatePolicyDefinitionStatic is not found in the empty JSON string", UpdatePolicyDefinitionStatic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePolicyDefinitionStatic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePolicyDefinitionStatic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePolicyDefinitionStatic.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePolicyDefinitionStatic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePolicyDefinitionStatic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePolicyDefinitionStatic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePolicyDefinitionStatic.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePolicyDefinitionStatic>() {
           @Override
           public void write(JsonWriter out, UpdatePolicyDefinitionStatic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePolicyDefinitionStatic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePolicyDefinitionStatic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePolicyDefinitionStatic
   * @throws IOException if the JSON string is invalid with respect to UpdatePolicyDefinitionStatic
   */
  public static UpdatePolicyDefinitionStatic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePolicyDefinitionStatic.class);
  }

  /**
   * Convert an instance of UpdatePolicyDefinitionStatic to an JSON string
   *
   * @return JSON string
   */
