...
public class StaticPolicyDefinitionItem {
  ...
  public StaticPolicyDefinitionItem() {
  }

  public StaticPolicyDefinitionItem description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    StaticPolicyDefinitionItem staticPolicyDefinitionItem = (StaticPolicyDefinitionItem) o;
    return Objects.equals(this.description, staticPolicyDefinitionItem.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class StaticPolicyDefinitionItem {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StaticPolicyDefinitionItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticPolicyDefinitionItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StaticPolicyDefinitionItem is not found in the empty JSON string", StaticPolicyDefinitionItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticPolicyDefinitionItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StaticPolicyDefinitionItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaticPolicyDefinitionItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaticPolicyDefinitionItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaticPolicyDefinitionItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaticPolicyDefinitionItem.class));

       return (TypeAdapter<T>) new TypeAdapter<StaticPolicyDefinitionItem>() {
           @Override
           public void write(JsonWriter out, StaticPolicyDefinitionItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StaticPolicyDefinitionItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StaticPolicyDefinitionItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StaticPolicyDefinitionItem
   * @throws IOException if the JSON string is invalid with respect to StaticPolicyDefinitionItem
   */
  public static StaticPolicyDefinitionItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaticPolicyDefinitionItem.class);
  }

  /**
   * Convert an instance of StaticPolicyDefinitionItem to an JSON string
   *
   * @return JSON string
   */
