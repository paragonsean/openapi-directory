...
public class PolicyFilterPrincipal {
  ...
  public PolicyFilterPrincipal() {
  }

  public PolicyFilterPrincipal unspecified(Boolean unspecified) {
  ...
  public PolicyFilterPrincipal identifier(EntityReferenceIdentifier identifier) {
  ...
  public boolean equals(Object o) {
    ...
    PolicyFilterPrincipal policyFilterPrincipal = (PolicyFilterPrincipal) o;
    return Objects.equals(this.unspecified, policyFilterPrincipal.unspecified) &&
        Objects.equals(this.identifier, policyFilterPrincipal.identifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class PolicyFilterPrincipal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PolicyFilterPrincipal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyFilterPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyFilterPrincipal is not found in the empty JSON string", PolicyFilterPrincipal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PolicyFilterPrincipal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyFilterPrincipal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PolicyFilterPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PolicyFilterPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PolicyFilterPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PolicyFilterPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<PolicyFilterPrincipal>() {
           @Override
           public void write(JsonWriter out, PolicyFilterPrincipal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PolicyFilterPrincipal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PolicyFilterPrincipal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PolicyFilterPrincipal
   * @throws IOException if the JSON string is invalid with respect to PolicyFilterPrincipal
   */
  public static PolicyFilterPrincipal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PolicyFilterPrincipal.class);
  }

  /**
   * Convert an instance of PolicyFilterPrincipal to an JSON string
   *
   * @return JSON string
   */
