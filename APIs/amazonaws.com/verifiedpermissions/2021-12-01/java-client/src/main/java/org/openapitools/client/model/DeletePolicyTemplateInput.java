...
public class DeletePolicyTemplateInput {
  ...
  public DeletePolicyTemplateInput() {
  }

  public DeletePolicyTemplateInput policyStoreId(String policyStoreId) {
  ...
  public DeletePolicyTemplateInput policyTemplateId(String policyTemplateId) {
  ...
  public boolean equals(Object o) {
    ...
    DeletePolicyTemplateInput deletePolicyTemplateInput = (DeletePolicyTemplateInput) o;
    return Objects.equals(this.policyStoreId, deletePolicyTemplateInput.policyStoreId) &&
        Objects.equals(this.policyTemplateId, deletePolicyTemplateInput.policyTemplateId);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeletePolicyTemplateInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeletePolicyTemplateInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeletePolicyTemplateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeletePolicyTemplateInput is not found in the empty JSON string", DeletePolicyTemplateInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeletePolicyTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeletePolicyTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeletePolicyTemplateInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeletePolicyTemplateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeletePolicyTemplateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeletePolicyTemplateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeletePolicyTemplateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeletePolicyTemplateInput>() {
           @Override
           public void write(JsonWriter out, DeletePolicyTemplateInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeletePolicyTemplateInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeletePolicyTemplateInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeletePolicyTemplateInput
   * @throws IOException if the JSON string is invalid with respect to DeletePolicyTemplateInput
   */
  public static DeletePolicyTemplateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeletePolicyTemplateInput.class);
  }

  /**
   * Convert an instance of DeletePolicyTemplateInput to an JSON string
   *
   * @return JSON string
   */
