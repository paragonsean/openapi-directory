...
public class EntityReferenceIdentifier {
  ...
  public EntityReferenceIdentifier() {
  }

  public EntityReferenceIdentifier entityType(String entityType) {
  ...
  public EntityReferenceIdentifier entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    EntityReferenceIdentifier entityReferenceIdentifier = (EntityReferenceIdentifier) o;
    return Objects.equals(this.entityType, entityReferenceIdentifier.entityType) &&
        Objects.equals(this.entityId, entityReferenceIdentifier.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityReferenceIdentifier {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityReferenceIdentifier
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityReferenceIdentifier.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityReferenceIdentifier is not found in the empty JSON string", EntityReferenceIdentifier.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EntityReferenceIdentifier.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityReferenceIdentifier` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntityReferenceIdentifier.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityReferenceIdentifier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityReferenceIdentifier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityReferenceIdentifier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityReferenceIdentifier.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityReferenceIdentifier>() {
           @Override
           public void write(JsonWriter out, EntityReferenceIdentifier value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EntityReferenceIdentifier read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EntityReferenceIdentifier given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityReferenceIdentifier
   * @throws IOException if the JSON string is invalid with respect to EntityReferenceIdentifier
   */
  public static EntityReferenceIdentifier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityReferenceIdentifier.class);
  }

  /**
   * Convert an instance of EntityReferenceIdentifier to an JSON string
   *
   * @return JSON string
   */
