...
public class TemplateLinkedPolicyDefinitionResource {
  ...
  public TemplateLinkedPolicyDefinitionResource() {
  }

  public TemplateLinkedPolicyDefinitionResource entityType(String entityType) {
  ...
  public TemplateLinkedPolicyDefinitionResource entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateLinkedPolicyDefinitionResource templateLinkedPolicyDefinitionResource = (TemplateLinkedPolicyDefinitionResource) o;
    return Objects.equals(this.entityType, templateLinkedPolicyDefinitionResource.entityType) &&
        Objects.equals(this.entityId, templateLinkedPolicyDefinitionResource.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateLinkedPolicyDefinitionResource {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateLinkedPolicyDefinitionResource
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateLinkedPolicyDefinitionResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateLinkedPolicyDefinitionResource is not found in the empty JSON string", TemplateLinkedPolicyDefinitionResource.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateLinkedPolicyDefinitionResource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateLinkedPolicyDefinitionResource` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateLinkedPolicyDefinitionResource.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateLinkedPolicyDefinitionResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateLinkedPolicyDefinitionResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateLinkedPolicyDefinitionResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateLinkedPolicyDefinitionResource.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateLinkedPolicyDefinitionResource>() {
           @Override
           public void write(JsonWriter out, TemplateLinkedPolicyDefinitionResource value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateLinkedPolicyDefinitionResource read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateLinkedPolicyDefinitionResource given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateLinkedPolicyDefinitionResource
   * @throws IOException if the JSON string is invalid with respect to TemplateLinkedPolicyDefinitionResource
   */
  public static TemplateLinkedPolicyDefinitionResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateLinkedPolicyDefinitionResource.class);
  }

  /**
   * Convert an instance of TemplateLinkedPolicyDefinitionResource to an JSON string
   *
   * @return JSON string
   */
