...
public class IsAuthorizedInputEntities {
  public static final String SERIALIZED_NAME_ENTITY_LIST = "entityList";
  @SerializedName(SERIALIZED_NAME_ENTITY_LIST)
  private List entityList;

  public IsAuthorizedInputEntities() {
  }

  public IsAuthorizedInputEntities entityList(List entityList) {
  ...
  public boolean equals(Object o) {
    ...
    IsAuthorizedInputEntities isAuthorizedInputEntities = (IsAuthorizedInputEntities) o;
    return Objects.equals(this.entityList, isAuthorizedInputEntities.entityList);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsAuthorizedInputEntities {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IsAuthorizedInputEntities
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsAuthorizedInputEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsAuthorizedInputEntities is not found in the empty JSON string", IsAuthorizedInputEntities.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IsAuthorizedInputEntities.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IsAuthorizedInputEntities` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `entityList`
      if (jsonObj.get("entityList") != null && !jsonObj.get("entityList").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsAuthorizedInputEntities.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsAuthorizedInputEntities' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsAuthorizedInputEntities> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsAuthorizedInputEntities.class));

       return (TypeAdapter<T>) new TypeAdapter<IsAuthorizedInputEntities>() {
           @Override
           public void write(JsonWriter out, IsAuthorizedInputEntities value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IsAuthorizedInputEntities read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IsAuthorizedInputEntities given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IsAuthorizedInputEntities
   * @throws IOException if the JSON string is invalid with respect to IsAuthorizedInputEntities
   */
  public static IsAuthorizedInputEntities fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsAuthorizedInputEntities.class);
  }

  /**
   * Convert an instance of IsAuthorizedInputEntities to an JSON string
   *
   * @return JSON string
   */
