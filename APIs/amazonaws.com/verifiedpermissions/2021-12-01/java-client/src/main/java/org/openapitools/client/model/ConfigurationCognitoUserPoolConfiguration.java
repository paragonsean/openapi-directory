...
public class ConfigurationCognitoUserPoolConfiguration {
  ...
  public ConfigurationCognitoUserPoolConfiguration() {
  }

  public ConfigurationCognitoUserPoolConfiguration userPoolArn(String userPoolArn) {
  ...
  public ConfigurationCognitoUserPoolConfiguration clientIds(List clientIds) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationCognitoUserPoolConfiguration configurationCognitoUserPoolConfiguration = (ConfigurationCognitoUserPoolConfiguration) o;
    return Objects.equals(this.userPoolArn, configurationCognitoUserPoolConfiguration.userPoolArn) &&
        Objects.equals(this.clientIds, configurationCognitoUserPoolConfiguration.clientIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigurationCognitoUserPoolConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigurationCognitoUserPoolConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigurationCognitoUserPoolConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigurationCognitoUserPoolConfiguration is not found in the empty JSON string", ConfigurationCognitoUserPoolConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfigurationCognitoUserPoolConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConfigurationCognitoUserPoolConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfigurationCognitoUserPoolConfiguration.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigurationCognitoUserPoolConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigurationCognitoUserPoolConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigurationCognitoUserPoolConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigurationCognitoUserPoolConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigurationCognitoUserPoolConfiguration>() {
           @Override
           public void write(JsonWriter out, ConfigurationCognitoUserPoolConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfigurationCognitoUserPoolConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfigurationCognitoUserPoolConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfigurationCognitoUserPoolConfiguration
   * @throws IOException if the JSON string is invalid with respect to ConfigurationCognitoUserPoolConfiguration
   */
  public static ConfigurationCognitoUserPoolConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigurationCognitoUserPoolConfiguration.class);
  }

  /**
   * Convert an instance of ConfigurationCognitoUserPoolConfiguration to an JSON string
   *
   * @return JSON string
   */
