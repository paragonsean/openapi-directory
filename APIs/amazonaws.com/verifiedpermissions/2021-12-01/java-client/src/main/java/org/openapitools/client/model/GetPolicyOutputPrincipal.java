...
public class GetPolicyOutputPrincipal {
  ...
  public GetPolicyOutputPrincipal() {
  }

  public GetPolicyOutputPrincipal entityType(String entityType) {
  ...
  public GetPolicyOutputPrincipal entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyOutputPrincipal getPolicyOutputPrincipal = (GetPolicyOutputPrincipal) o;
    return Objects.equals(this.entityType, getPolicyOutputPrincipal.entityType) &&
        Objects.equals(this.entityId, getPolicyOutputPrincipal.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPolicyOutputPrincipal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyOutputPrincipal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyOutputPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyOutputPrincipal is not found in the empty JSON string", GetPolicyOutputPrincipal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyOutputPrincipal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyOutputPrincipal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPolicyOutputPrincipal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyOutputPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyOutputPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyOutputPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyOutputPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyOutputPrincipal>() {
           @Override
           public void write(JsonWriter out, GetPolicyOutputPrincipal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyOutputPrincipal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyOutputPrincipal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyOutputPrincipal
   * @throws IOException if the JSON string is invalid with respect to GetPolicyOutputPrincipal
   */
  public static GetPolicyOutputPrincipal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyOutputPrincipal.class);
  }

  /**
   * Convert an instance of GetPolicyOutputPrincipal to an JSON string
   *
   * @return JSON string
   */
