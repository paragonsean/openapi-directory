...
import org.openapitools.client.model.PolicyDefinitionDetailStatic;
import org.openapitools.client.model.PolicyDefinitionDetailTemplateLinked;
...
public class GetPolicyOutputDefinition {
  public static final String SERIALIZED_NAME_STATIC = "static";
  @SerializedName(SERIALIZED_NAME_STATIC)
  private PolicyDefinitionDetailStatic _static;

  public static final String SERIALIZED_NAME_TEMPLATE_LINKED = "templateLinked";
  @SerializedName(SERIALIZED_NAME_TEMPLATE_LINKED)
  private PolicyDefinitionDetailTemplateLinked templateLinked;

  public GetPolicyOutputDefinition() {
  }

  public GetPolicyOutputDefinition _static(PolicyDefinitionDetailStatic _static) {
  ...
  public PolicyDefinitionDetailStatic getStatic() {
    return _static;
  }

  public void setStatic(PolicyDefinitionDetailStatic _static) {
    this._static = _static;
  }


  public GetPolicyOutputDefinition templateLinked(PolicyDefinitionDetailTemplateLinked templateLinked) {
   ...
   */
  @javax.annotation.Nullable
  public PolicyDefinitionDetailTemplateLinked getTemplateLinked() {
    return templateLinked;
  }

  public void setTemplateLinked(PolicyDefinitionDetailTemplateLinked templateLinked) {
    this.templateLinked = templateLinked;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPolicyOutputDefinition getPolicyOutputDefinition = (GetPolicyOutputDefinition) o;
    return Objects.equals(this._static, getPolicyOutputDefinition._static) &&
        Objects.equals(this.templateLinked, getPolicyOutputDefinition.templateLinked);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_static, templateLinked);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPolicyOutputDefinition {\n");
    sb.append("    _static: ").append(toIndentedString(_static)).append("\n");
    sb.append("    templateLinked: ").append(toIndentedString(templateLinked)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("templateLinked");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPolicyOutputDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPolicyOutputDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPolicyOutputDefinition is not found in the empty JSON string", GetPolicyOutputDefinition.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPolicyOutputDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPolicyOutputDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `static`
      if (jsonObj.get("static") != null && !jsonObj.get("static").isJsonNull()) {
        PolicyDefinitionDetailStatic.validateJsonElement(jsonObj.get("static"));
      }
      // validate the optional field `templateLinked`
      if (jsonObj.get("templateLinked") != null && !jsonObj.get("templateLinked").isJsonNull()) {
        PolicyDefinitionDetailTemplateLinked.validateJsonElement(jsonObj.get("templateLinked"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPolicyOutputDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPolicyOutputDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPolicyOutputDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPolicyOutputDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPolicyOutputDefinition>() {
           @Override
           public void write(JsonWriter out, GetPolicyOutputDefinition value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPolicyOutputDefinition read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPolicyOutputDefinition given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPolicyOutputDefinition
   * @throws IOException if the JSON string is invalid with respect to GetPolicyOutputDefinition
   */
  public static GetPolicyOutputDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPolicyOutputDefinition.class);
  }

  /**
   * Convert an instance of GetPolicyOutputDefinition to an JSON string
   *
   * @return JSON string
   */
