...
import org.openapitools.client.model.ValidationMode;
...
public class ValidationSettings {
  ...
  public ValidationSettings mode(ValidationMode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidationSettings validationSettings = (ValidationSettings) o;
    return Objects.equals(this.mode, validationSettings.mode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidationSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidationSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidationSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidationSettings is not found in the empty JSON string", ValidationSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidationSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidationSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidationSettings.openapiRequiredFields) {
      ...
      ValidationMode.validateJsonElement(jsonObj.get("mode"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidationSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidationSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidationSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidationSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidationSettings>() {
           @Override
           public void write(JsonWriter out, ValidationSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidationSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValidationSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValidationSettings
   * @throws IOException if the JSON string is invalid with respect to ValidationSettings
   */
  public static ValidationSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidationSettings.class);
  }

  /**
   * Convert an instance of ValidationSettings to an JSON string
   *
   * @return JSON string
   */
