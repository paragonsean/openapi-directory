...
public class TemplateLinkedPolicyDefinitionPrincipal {
  ...
  public TemplateLinkedPolicyDefinitionPrincipal() {
  }

  public TemplateLinkedPolicyDefinitionPrincipal entityType(String entityType) {
  ...
  public TemplateLinkedPolicyDefinitionPrincipal entityId(String entityId) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateLinkedPolicyDefinitionPrincipal templateLinkedPolicyDefinitionPrincipal = (TemplateLinkedPolicyDefinitionPrincipal) o;
    return Objects.equals(this.entityType, templateLinkedPolicyDefinitionPrincipal.entityType) &&
        Objects.equals(this.entityId, templateLinkedPolicyDefinitionPrincipal.entityId);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateLinkedPolicyDefinitionPrincipal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateLinkedPolicyDefinitionPrincipal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateLinkedPolicyDefinitionPrincipal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateLinkedPolicyDefinitionPrincipal is not found in the empty JSON string", TemplateLinkedPolicyDefinitionPrincipal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateLinkedPolicyDefinitionPrincipal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateLinkedPolicyDefinitionPrincipal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateLinkedPolicyDefinitionPrincipal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateLinkedPolicyDefinitionPrincipal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateLinkedPolicyDefinitionPrincipal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateLinkedPolicyDefinitionPrincipal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateLinkedPolicyDefinitionPrincipal.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateLinkedPolicyDefinitionPrincipal>() {
           @Override
           public void write(JsonWriter out, TemplateLinkedPolicyDefinitionPrincipal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateLinkedPolicyDefinitionPrincipal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateLinkedPolicyDefinitionPrincipal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateLinkedPolicyDefinitionPrincipal
   * @throws IOException if the JSON string is invalid with respect to TemplateLinkedPolicyDefinitionPrincipal
   */
  public static TemplateLinkedPolicyDefinitionPrincipal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateLinkedPolicyDefinitionPrincipal.class);
  }

  /**
   * Convert an instance of TemplateLinkedPolicyDefinitionPrincipal to an JSON string
   *
   * @return JSON string
   */
