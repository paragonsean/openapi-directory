...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PutSchemaOutput();
  });
  ...
  describe('PutSchemaOutput', function() {
    it('should create an instance of PutSchemaOutput', function() {
      // uncomment below and update the code to test PutSchemaOutput
      //var instance = new AmazonVerifiedPermissions.PutSchemaOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PutSchemaOutput);
    });
