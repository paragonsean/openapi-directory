...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedInputResource();
  });
  ...
  describe('IsAuthorizedInputResource', function() {
    it('should create an instance of IsAuthorizedInputResource', function() {
      // uncomment below and update the code to test IsAuthorizedInputResource
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInputResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedInputResource);
    });
