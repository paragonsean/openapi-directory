...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateConfiguration();
  });
  ...
  describe('UpdateConfiguration', function() {
    it('should create an instance of UpdateConfiguration', function() {
      ...
      //var instance = new AmazonVerifiedPermissions.UpdateConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateConfiguration);
    });

    it('should have the property cognitoUserPoolConfiguration (base name: "cognitoUserPoolConfiguration")', function() {
      // uncomment below and update the code to test the property cognitoUserPoolConfiguration
      //var instance = new AmazonVerifiedPermissions.UpdateConfiguration();
