...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IdentitySourceItem();
  });
  ...
  describe('IdentitySourceItem', function() {
    it('should create an instance of IdentitySourceItem', function() {
      // uncomment below and update the code to test IdentitySourceItem
      //var instance = new AmazonVerifiedPermissions.IdentitySourceItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IdentitySourceItem);
    });
