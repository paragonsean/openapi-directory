...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyItemResource();
  });
  ...
  describe('PolicyItemResource', function() {
    it('should create an instance of PolicyItemResource', function() {
      // uncomment below and update the code to test PolicyItemResource
      //var instance = new AmazonVerifiedPermissions.PolicyItemResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyItemResource);
    });
