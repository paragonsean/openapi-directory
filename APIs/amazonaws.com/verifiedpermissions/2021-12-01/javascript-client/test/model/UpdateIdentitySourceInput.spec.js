...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateIdentitySourceInput();
  });
  ...
  describe('UpdateIdentitySourceInput', function() {
    it('should create an instance of UpdateIdentitySourceInput', function() {
      // uncomment below and update the code to test UpdateIdentitySourceInput
      //var instance = new AmazonVerifiedPermissions.UpdateIdentitySourceInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateIdentitySourceInput);
    });
