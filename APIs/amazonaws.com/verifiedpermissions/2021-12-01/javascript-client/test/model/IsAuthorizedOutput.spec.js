...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedOutput();
  });
  ...
  describe('IsAuthorizedOutput', function() {
    it('should create an instance of IsAuthorizedOutput', function() {
      // uncomment below and update the code to test IsAuthorizedOutput
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedOutput);
    });
    ...
    it('should have the property determiningPolicies (base name: "determiningPolicies")', function() {
      // uncomment below and update the code to test the property determiningPolicies
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedOutput();
      //expect(instance).to.be();
    });
