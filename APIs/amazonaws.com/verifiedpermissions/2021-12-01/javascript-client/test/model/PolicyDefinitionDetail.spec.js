...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionDetail();
  });
  ...
  describe('PolicyDefinitionDetail', function() {
    it('should create an instance of PolicyDefinitionDetail', function() {
      // uncomment below and update the code to test PolicyDefinitionDetail
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionDetail();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionDetail);
    });
