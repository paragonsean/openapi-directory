...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetSchemaOutput();
  });
  ...
  describe('GetSchemaOutput', function() {
    it('should create an instance of GetSchemaOutput', function() {
      // uncomment below and update the code to test GetSchemaOutput
      //var instance = new AmazonVerifiedPermissions.GetSchemaOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetSchemaOutput);
    });
