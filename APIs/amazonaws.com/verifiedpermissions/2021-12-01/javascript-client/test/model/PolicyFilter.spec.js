...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyFilter();
  });
  ...
  describe('PolicyFilter', function() {
    it('should create an instance of PolicyFilter', function() {
      // uncomment below and update the code to test PolicyFilter
      //var instance = new AmazonVerifiedPermissions.PolicyFilter();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyFilter);
    });
