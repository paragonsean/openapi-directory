...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyOutput();
  });
  ...
  describe('GetPolicyOutput', function() {
    it('should create an instance of GetPolicyOutput', function() {
      // uncomment below and update the code to test GetPolicyOutput
      //var instance = new AmazonVerifiedPermissions.GetPolicyOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyOutput);
    });
