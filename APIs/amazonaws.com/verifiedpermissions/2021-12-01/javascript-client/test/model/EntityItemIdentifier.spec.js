...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EntityItemIdentifier();
  });
  ...
  describe('EntityItemIdentifier', function() {
    it('should create an instance of EntityItemIdentifier', function() {
      // uncomment below and update the code to test EntityItemIdentifier
      //var instance = new AmazonVerifiedPermissions.EntityItemIdentifier();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EntityItemIdentifier);
    });
