...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EvaluationErrorItem();
  });
  ...
  describe('EvaluationErrorItem', function() {
    it('should create an instance of EvaluationErrorItem', function() {
      // uncomment below and update the code to test EvaluationErrorItem
      //var instance = new AmazonVerifiedPermissions.EvaluationErrorItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EvaluationErrorItem);
    });
