...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.StaticPolicyDefinitionDetail();
  });
  ...
  describe('StaticPolicyDefinitionDetail', function() {
    it('should create an instance of StaticPolicyDefinitionDetail', function() {
      // uncomment below and update the code to test StaticPolicyDefinitionDetail
      //var instance = new AmazonVerifiedPermissions.StaticPolicyDefinitionDetail();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.StaticPolicyDefinitionDetail);
    });
