...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PutSchemaInput();
  });
  ...
  describe('PutSchemaInput', function() {
    it('should create an instance of PutSchemaInput', function() {
      // uncomment below and update the code to test PutSchemaInput
      //var instance = new AmazonVerifiedPermissions.PutSchemaInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PutSchemaInput);
    });
