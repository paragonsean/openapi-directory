...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedInput();
  });
  ...
  describe('IsAuthorizedInput', function() {
    it('should create an instance of IsAuthorizedInput', function() {
      // uncomment below and update the code to test IsAuthorizedInput
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedInput);
    });
