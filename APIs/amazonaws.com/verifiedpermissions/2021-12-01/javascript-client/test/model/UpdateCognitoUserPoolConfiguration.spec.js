...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateCognitoUserPoolConfiguration();
  });
  ...
  describe('UpdateCognitoUserPoolConfiguration', function() {
    it('should create an instance of UpdateCognitoUserPoolConfiguration', function() {
      // uncomment below and update the code to test UpdateCognitoUserPoolConfiguration
      //var instance = new AmazonVerifiedPermissions.UpdateCognitoUserPoolConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateCognitoUserPoolConfiguration);
    });
