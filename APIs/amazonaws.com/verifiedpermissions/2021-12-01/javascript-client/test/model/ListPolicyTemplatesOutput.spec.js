...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPolicyTemplatesOutput();
  });
  ...
  describe('ListPolicyTemplatesOutput', function() {
    it('should create an instance of ListPolicyTemplatesOutput', function() {
      // uncomment below and update the code to test ListPolicyTemplatesOutput
      //var instance = new AmazonVerifiedPermissions.ListPolicyTemplatesOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPolicyTemplatesOutput);
    });
    ...
    it('should have the property policyTemplates (base name: "policyTemplates")', function() {
      // uncomment below and update the code to test the property policyTemplates
      //var instance = new AmazonVerifiedPermissions.ListPolicyTemplatesOutput();
      //expect(instance).to.be();
    });
