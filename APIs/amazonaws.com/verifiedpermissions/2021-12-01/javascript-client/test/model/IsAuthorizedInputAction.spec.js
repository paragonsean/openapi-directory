...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedInputAction();
  });
  ...
  describe('IsAuthorizedInputAction', function() {
    it('should create an instance of IsAuthorizedInputAction', function() {
      // uncomment below and update the code to test IsAuthorizedInputAction
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInputAction();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedInputAction);
    });
