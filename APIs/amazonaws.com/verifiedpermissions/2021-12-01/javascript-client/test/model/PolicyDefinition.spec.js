...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinition();
  });
  ...
  describe('PolicyDefinition', function() {
    it('should create an instance of PolicyDefinition', function() {
      ...
      //var instance = new AmazonVerifiedPermissions.PolicyDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinition);
    });
