...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPolicyTemplatesInput();
  });
  ...
  describe('ListPolicyTemplatesInput', function() {
    it('should create an instance of ListPolicyTemplatesInput', function() {
      // uncomment below and update the code to test ListPolicyTemplatesInput
      //var instance = new AmazonVerifiedPermissions.ListPolicyTemplatesInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPolicyTemplatesInput);
    });
