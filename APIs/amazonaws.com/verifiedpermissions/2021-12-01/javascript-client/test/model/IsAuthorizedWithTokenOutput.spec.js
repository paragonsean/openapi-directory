...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenOutput();
  });
  ...
  describe('IsAuthorizedWithTokenOutput', function() {
    it('should create an instance of IsAuthorizedWithTokenOutput', function() {
      // uncomment below and update the code to test IsAuthorizedWithTokenOutput
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedWithTokenOutput);
    });
