...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPolicyStoresOutput();
  });
  ...
  describe('ListPolicyStoresOutput', function() {
    it('should create an instance of ListPolicyStoresOutput', function() {
      // uncomment below and update the code to test ListPolicyStoresOutput
      //var instance = new AmazonVerifiedPermissions.ListPolicyStoresOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPolicyStoresOutput);
    });
    ...
    it('should have the property policyStores (base name: "policyStores")', function() {
      // uncomment below and update the code to test the property policyStores
      //var instance = new AmazonVerifiedPermissions.ListPolicyStoresOutput();
      //expect(instance).to.be();
    });
