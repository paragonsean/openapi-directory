...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.SchemaDefinition();
  });
  ...
  describe('SchemaDefinition', function() {
    it('should create an instance of SchemaDefinition', function() {
      ...
      //var instance = new AmazonVerifiedPermissions.SchemaDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.SchemaDefinition);
    });

    it('should have the property cedarJson (base name: "cedarJson")', function() {
      // uncomment below and update the code to test the property cedarJson
      //var instance = new AmazonVerifiedPermissions.SchemaDefinition();
