...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyOutput();
  });
  ...
  describe('UpdatePolicyOutput', function() {
    it('should create an instance of UpdatePolicyOutput', function() {
      // uncomment below and update the code to test UpdatePolicyOutput
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyOutput);
    });
