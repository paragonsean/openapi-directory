...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionItemTemplateLinked();
  });
  ...
  describe('PolicyDefinitionItemTemplateLinked', function() {
    it('should create an instance of PolicyDefinitionItemTemplateLinked', function() {
      // uncomment below and update the code to test PolicyDefinitionItemTemplateLinked
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionItemTemplateLinked();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionItemTemplateLinked);
    });
