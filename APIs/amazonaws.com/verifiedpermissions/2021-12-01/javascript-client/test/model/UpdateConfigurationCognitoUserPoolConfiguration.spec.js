...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateConfigurationCognitoUserPoolConfiguration();
  });
  ...
  describe('UpdateConfigurationCognitoUserPoolConfiguration', function() {
    it('should create an instance of UpdateConfigurationCognitoUserPoolConfiguration', function() {
      // uncomment below and update the code to test UpdateConfigurationCognitoUserPoolConfiguration
      //var instance = new AmazonVerifiedPermissions.UpdateConfigurationCognitoUserPoolConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateConfigurationCognitoUserPoolConfiguration);
    });
