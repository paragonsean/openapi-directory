...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.AttributeValue();
  });
  ...
  describe('AttributeValue', function() {
    it('should create an instance of AttributeValue', function() {
      ...
      //var instance = new AmazonVerifiedPermissions.AttributeValue();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.AttributeValue);
    });
