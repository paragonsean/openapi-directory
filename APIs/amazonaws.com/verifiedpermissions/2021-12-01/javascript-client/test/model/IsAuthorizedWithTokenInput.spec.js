...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenInput();
  });
  ...
  describe('IsAuthorizedWithTokenInput', function() {
    it('should create an instance of IsAuthorizedWithTokenInput', function() {
      // uncomment below and update the code to test IsAuthorizedWithTokenInput
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedWithTokenInput);
    });
