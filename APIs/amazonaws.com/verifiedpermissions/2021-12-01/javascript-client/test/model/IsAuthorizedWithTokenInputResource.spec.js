...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenInputResource();
  });
  ...
  describe('IsAuthorizedWithTokenInputResource', function() {
    it('should create an instance of IsAuthorizedWithTokenInputResource', function() {
      // uncomment below and update the code to test IsAuthorizedWithTokenInputResource
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenInputResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedWithTokenInputResource);
    });
