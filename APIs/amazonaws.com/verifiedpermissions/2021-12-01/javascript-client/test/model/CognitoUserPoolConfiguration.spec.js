...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CognitoUserPoolConfiguration();
  });
  ...
  describe('CognitoUserPoolConfiguration', function() {
    it('should create an instance of CognitoUserPoolConfiguration', function() {
      // uncomment below and update the code to test CognitoUserPoolConfiguration
      //var instance = new AmazonVerifiedPermissions.CognitoUserPoolConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CognitoUserPoolConfiguration);
    });
