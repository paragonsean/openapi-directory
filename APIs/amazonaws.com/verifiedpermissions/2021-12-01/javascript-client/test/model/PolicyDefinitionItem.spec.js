...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionItem();
  });
  ...
  describe('PolicyDefinitionItem', function() {
    it('should create an instance of PolicyDefinitionItem', function() {
      // uncomment below and update the code to test PolicyDefinitionItem
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionItem);
    });
