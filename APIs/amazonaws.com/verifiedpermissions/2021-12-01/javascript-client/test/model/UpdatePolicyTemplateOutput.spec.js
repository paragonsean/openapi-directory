...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyTemplateOutput();
  });
  ...
  describe('UpdatePolicyTemplateOutput', function() {
    it('should create an instance of UpdatePolicyTemplateOutput', function() {
      // uncomment below and update the code to test UpdatePolicyTemplateOutput
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyTemplateOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyTemplateOutput);
    });
