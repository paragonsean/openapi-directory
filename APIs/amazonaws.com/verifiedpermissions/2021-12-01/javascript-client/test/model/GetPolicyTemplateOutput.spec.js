...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyTemplateOutput();
  });
  ...
  describe('GetPolicyTemplateOutput', function() {
    it('should create an instance of GetPolicyTemplateOutput', function() {
      // uncomment below and update the code to test GetPolicyTemplateOutput
      //var instance = new AmazonVerifiedPermissions.GetPolicyTemplateOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyTemplateOutput);
    });
