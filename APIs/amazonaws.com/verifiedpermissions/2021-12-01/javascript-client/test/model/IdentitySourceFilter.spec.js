...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IdentitySourceFilter();
  });
  ...
  describe('IdentitySourceFilter', function() {
    it('should create an instance of IdentitySourceFilter', function() {
      // uncomment below and update the code to test IdentitySourceFilter
      //var instance = new AmazonVerifiedPermissions.IdentitySourceFilter();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IdentitySourceFilter);
    });

    it('should have the property principalEntityType (base name: "principalEntityType")', function() {
      // uncomment below and update the code to test the property principalEntityType
      //var instance = new AmazonVerifiedPermissions.IdentitySourceFilter();
