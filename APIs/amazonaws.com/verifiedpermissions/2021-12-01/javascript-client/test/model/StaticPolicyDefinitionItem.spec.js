...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.StaticPolicyDefinitionItem();
  });
  ...
  describe('StaticPolicyDefinitionItem', function() {
    it('should create an instance of StaticPolicyDefinitionItem', function() {
      // uncomment below and update the code to test StaticPolicyDefinitionItem
      //var instance = new AmazonVerifiedPermissions.StaticPolicyDefinitionItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.StaticPolicyDefinitionItem);
    });
