...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyStoreOutput();
  });
  ...
  describe('GetPolicyStoreOutput', function() {
    it('should create an instance of GetPolicyStoreOutput', function() {
      // uncomment below and update the code to test GetPolicyStoreOutput
      //var instance = new AmazonVerifiedPermissions.GetPolicyStoreOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyStoreOutput);
    });
