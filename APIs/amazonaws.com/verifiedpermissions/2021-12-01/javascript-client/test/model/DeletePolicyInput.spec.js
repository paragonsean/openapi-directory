...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.DeletePolicyInput();
  });
  ...
  describe('DeletePolicyInput', function() {
    it('should create an instance of DeletePolicyInput', function() {
      // uncomment below and update the code to test DeletePolicyInput
      //var instance = new AmazonVerifiedPermissions.DeletePolicyInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.DeletePolicyInput);
    });
