...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyItemDefinition();
  });
  ...
  describe('PolicyItemDefinition', function() {
    it('should create an instance of PolicyItemDefinition', function() {
      // uncomment below and update the code to test PolicyItemDefinition
      //var instance = new AmazonVerifiedPermissions.PolicyItemDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyItemDefinition);
    });
