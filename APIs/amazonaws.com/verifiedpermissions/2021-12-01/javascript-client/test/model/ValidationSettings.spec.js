...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ValidationSettings();
  });
  ...
  describe('ValidationSettings', function() {
    it('should create an instance of ValidationSettings', function() {
      // uncomment below and update the code to test ValidationSettings
      //var instance = new AmazonVerifiedPermissions.ValidationSettings();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ValidationSettings);
    });
