...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedInputPrincipal();
  });
  ...
  describe('IsAuthorizedInputPrincipal', function() {
    it('should create an instance of IsAuthorizedInputPrincipal', function() {
      // uncomment below and update the code to test IsAuthorizedInputPrincipal
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInputPrincipal();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedInputPrincipal);
    });
