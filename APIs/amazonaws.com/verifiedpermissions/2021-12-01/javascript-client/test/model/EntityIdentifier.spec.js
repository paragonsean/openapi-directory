...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EntityIdentifier();
  });
  ...
  describe('EntityIdentifier', function() {
    it('should create an instance of EntityIdentifier', function() {
      // uncomment below and update the code to test EntityIdentifier
      //var instance = new AmazonVerifiedPermissions.EntityIdentifier();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EntityIdentifier);
    });
