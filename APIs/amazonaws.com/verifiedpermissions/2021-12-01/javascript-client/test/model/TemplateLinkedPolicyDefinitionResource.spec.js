...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionResource();
  });
  ...
  describe('TemplateLinkedPolicyDefinitionResource', function() {
    it('should create an instance of TemplateLinkedPolicyDefinitionResource', function() {
      // uncomment below and update the code to test TemplateLinkedPolicyDefinitionResource
      //var instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionResource);
    });
