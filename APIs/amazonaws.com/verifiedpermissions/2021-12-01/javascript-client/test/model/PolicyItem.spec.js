...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyItem();
  });
  ...
  describe('PolicyItem', function() {
    it('should create an instance of PolicyItem', function() {
      // uncomment below and update the code to test PolicyItem
      //var instance = new AmazonVerifiedPermissions.PolicyItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyItem);
    });
