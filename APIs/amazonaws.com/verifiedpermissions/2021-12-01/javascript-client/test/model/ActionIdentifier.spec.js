...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ActionIdentifier();
  });
  ...
  describe('ActionIdentifier', function() {
    it('should create an instance of ActionIdentifier', function() {
      // uncomment below and update the code to test ActionIdentifier
      //var instance = new AmazonVerifiedPermissions.ActionIdentifier();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ActionIdentifier);
    });
