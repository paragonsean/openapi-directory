...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedInputEntities();
  });
  ...
  describe('IsAuthorizedInputEntities', function() {
    it('should create an instance of IsAuthorizedInputEntities', function() {
      // uncomment below and update the code to test IsAuthorizedInputEntities
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInputEntities();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedInputEntities);
    });
