...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyTemplateOutput();
  });
  ...
  describe('CreatePolicyTemplateOutput', function() {
    it('should create an instance of CreatePolicyTemplateOutput', function() {
      // uncomment below and update the code to test CreatePolicyTemplateOutput
      //var instance = new AmazonVerifiedPermissions.CreatePolicyTemplateOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyTemplateOutput);
    });
