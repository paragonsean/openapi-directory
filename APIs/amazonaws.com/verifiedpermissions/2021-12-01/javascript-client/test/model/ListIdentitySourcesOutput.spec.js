...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListIdentitySourcesOutput();
  });
  ...
  describe('ListIdentitySourcesOutput', function() {
    it('should create an instance of ListIdentitySourcesOutput', function() {
      // uncomment below and update the code to test ListIdentitySourcesOutput
      //var instance = new AmazonVerifiedPermissions.ListIdentitySourcesOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListIdentitySourcesOutput);
    });
    ...
    it('should have the property identitySources (base name: "identitySources")', function() {
      // uncomment below and update the code to test the property identitySources
      //var instance = new AmazonVerifiedPermissions.ListIdentitySourcesOutput();
      //expect(instance).to.be();
    });
