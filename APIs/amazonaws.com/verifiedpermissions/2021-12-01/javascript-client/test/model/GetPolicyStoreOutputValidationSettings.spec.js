...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyStoreOutputValidationSettings();
  });
  ...
  describe('GetPolicyStoreOutputValidationSettings', function() {
    it('should create an instance of GetPolicyStoreOutputValidationSettings', function() {
      // uncomment below and update the code to test GetPolicyStoreOutputValidationSettings
      //var instance = new AmazonVerifiedPermissions.GetPolicyStoreOutputValidationSettings();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyStoreOutputValidationSettings);
    });
