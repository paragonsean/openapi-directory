...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyTemplateInput();
  });
  ...
  describe('GetPolicyTemplateInput', function() {
    it('should create an instance of GetPolicyTemplateInput', function() {
      // uncomment below and update the code to test GetPolicyTemplateInput
      //var instance = new AmazonVerifiedPermissions.GetPolicyTemplateInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyTemplateInput);
    });
