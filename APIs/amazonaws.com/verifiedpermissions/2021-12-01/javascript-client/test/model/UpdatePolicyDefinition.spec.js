...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyDefinition();
  });
  ...
  describe('UpdatePolicyDefinition', function() {
    it('should create an instance of UpdatePolicyDefinition', function() {
      // uncomment below and update the code to test UpdatePolicyDefinition
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyDefinition);
    });
