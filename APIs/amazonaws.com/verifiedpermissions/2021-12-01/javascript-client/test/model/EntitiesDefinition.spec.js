...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EntitiesDefinition();
  });
  ...
  describe('EntitiesDefinition', function() {
    it('should create an instance of EntitiesDefinition', function() {
      // uncomment below and update the code to test EntitiesDefinition
      //var instance = new AmazonVerifiedPermissions.EntitiesDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EntitiesDefinition);
    });
