...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.DeletePolicyTemplateInput();
  });
  ...
  describe('DeletePolicyTemplateInput', function() {
    it('should create an instance of DeletePolicyTemplateInput', function() {
      // uncomment below and update the code to test DeletePolicyTemplateInput
      //var instance = new AmazonVerifiedPermissions.DeletePolicyTemplateInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.DeletePolicyTemplateInput);
    });
    ...
    it('should have the property policyTemplateId (base name: "policyTemplateId")', function() {
      // uncomment below and update the code to test the property policyTemplateId
      //var instance = new AmazonVerifiedPermissions.DeletePolicyTemplateInput();
      //expect(instance).to.be();
    });
