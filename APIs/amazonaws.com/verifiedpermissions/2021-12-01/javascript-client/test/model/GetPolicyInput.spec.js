...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyInput();
  });
  ...
  describe('GetPolicyInput', function() {
    it('should create an instance of GetPolicyInput', function() {
      // uncomment below and update the code to test GetPolicyInput
      //var instance = new AmazonVerifiedPermissions.GetPolicyInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyInput);
    });
