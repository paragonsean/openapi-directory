...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EntityReferenceIdentifier();
  });
  ...
  describe('EntityReferenceIdentifier', function() {
    it('should create an instance of EntityReferenceIdentifier', function() {
      // uncomment below and update the code to test EntityReferenceIdentifier
      //var instance = new AmazonVerifiedPermissions.EntityReferenceIdentifier();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EntityReferenceIdentifier);
    });
