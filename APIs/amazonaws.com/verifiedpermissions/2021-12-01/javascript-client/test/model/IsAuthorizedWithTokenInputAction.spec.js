...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenInputAction();
  });
  ...
  describe('IsAuthorizedWithTokenInputAction', function() {
    it('should create an instance of IsAuthorizedWithTokenInputAction', function() {
      // uncomment below and update the code to test IsAuthorizedWithTokenInputAction
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedWithTokenInputAction();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedWithTokenInputAction);
    });
