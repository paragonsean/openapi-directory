...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.DeletePolicyStoreInput();
  });
  ...
  describe('DeletePolicyStoreInput', function() {
    it('should create an instance of DeletePolicyStoreInput', function() {
      // uncomment below and update the code to test DeletePolicyStoreInput
      //var instance = new AmazonVerifiedPermissions.DeletePolicyStoreInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.DeletePolicyStoreInput);
    });
