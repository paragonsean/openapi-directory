...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyOutputPrincipal();
  });
  ...
  describe('CreatePolicyOutputPrincipal', function() {
    it('should create an instance of CreatePolicyOutputPrincipal', function() {
      // uncomment below and update the code to test CreatePolicyOutputPrincipal
      //var instance = new AmazonVerifiedPermissions.CreatePolicyOutputPrincipal();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyOutputPrincipal);
    });
