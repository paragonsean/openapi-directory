...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyInputDefinition();
  });
  ...
  describe('UpdatePolicyInputDefinition', function() {
    it('should create an instance of UpdatePolicyInputDefinition', function() {
      // uncomment below and update the code to test UpdatePolicyInputDefinition
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyInputDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyInputDefinition);
    });
