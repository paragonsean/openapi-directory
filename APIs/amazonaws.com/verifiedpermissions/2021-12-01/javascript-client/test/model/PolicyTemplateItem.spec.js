...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyTemplateItem();
  });
  ...
  describe('PolicyTemplateItem', function() {
    it('should create an instance of PolicyTemplateItem', function() {
      // uncomment below and update the code to test PolicyTemplateItem
      //var instance = new AmazonVerifiedPermissions.PolicyTemplateItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyTemplateItem);
    });
