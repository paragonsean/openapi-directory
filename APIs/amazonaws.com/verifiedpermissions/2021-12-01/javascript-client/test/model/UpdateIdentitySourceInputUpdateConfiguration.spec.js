...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateIdentitySourceInputUpdateConfiguration();
  });
  ...
  describe('UpdateIdentitySourceInputUpdateConfiguration', function() {
    it('should create an instance of UpdateIdentitySourceInputUpdateConfiguration', function() {
      // uncomment below and update the code to test UpdateIdentitySourceInputUpdateConfiguration
      //var instance = new AmazonVerifiedPermissions.UpdateIdentitySourceInputUpdateConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateIdentitySourceInputUpdateConfiguration);
    });
