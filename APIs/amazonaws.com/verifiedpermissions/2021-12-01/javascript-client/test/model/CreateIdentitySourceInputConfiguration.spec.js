...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreateIdentitySourceInputConfiguration();
  });
  ...
  describe('CreateIdentitySourceInputConfiguration', function() {
    it('should create an instance of CreateIdentitySourceInputConfiguration', function() {
      // uncomment below and update the code to test CreateIdentitySourceInputConfiguration
      //var instance = new AmazonVerifiedPermissions.CreateIdentitySourceInputConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreateIdentitySourceInputConfiguration);
    });
