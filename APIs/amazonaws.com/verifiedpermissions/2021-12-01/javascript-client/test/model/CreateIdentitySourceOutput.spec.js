...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreateIdentitySourceOutput();
  });
  ...
  describe('CreateIdentitySourceOutput', function() {
    it('should create an instance of CreateIdentitySourceOutput', function() {
      // uncomment below and update the code to test CreateIdentitySourceOutput
      //var instance = new AmazonVerifiedPermissions.CreateIdentitySourceOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreateIdentitySourceOutput);
    });
