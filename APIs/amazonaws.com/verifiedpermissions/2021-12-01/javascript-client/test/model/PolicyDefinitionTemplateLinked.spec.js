...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionTemplateLinked();
  });
  ...
  describe('PolicyDefinitionTemplateLinked', function() {
    it('should create an instance of PolicyDefinitionTemplateLinked', function() {
      // uncomment below and update the code to test PolicyDefinitionTemplateLinked
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionTemplateLinked();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionTemplateLinked);
    });
