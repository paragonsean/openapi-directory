...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateStaticPolicyDefinition();
  });
  ...
  describe('UpdateStaticPolicyDefinition', function() {
    it('should create an instance of UpdateStaticPolicyDefinition', function() {
      // uncomment below and update the code to test UpdateStaticPolicyDefinition
      //var instance = new AmazonVerifiedPermissions.UpdateStaticPolicyDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateStaticPolicyDefinition);
    });
