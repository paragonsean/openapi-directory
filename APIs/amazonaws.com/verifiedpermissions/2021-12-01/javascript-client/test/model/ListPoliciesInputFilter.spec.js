...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPoliciesInputFilter();
  });
  ...
  describe('ListPoliciesInputFilter', function() {
    it('should create an instance of ListPoliciesInputFilter', function() {
      // uncomment below and update the code to test ListPoliciesInputFilter
      //var instance = new AmazonVerifiedPermissions.ListPoliciesInputFilter();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPoliciesInputFilter);
    });
