...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPolicyStoresInput();
  });
  ...
  describe('ListPolicyStoresInput', function() {
    it('should create an instance of ListPolicyStoresInput', function() {
      // uncomment below and update the code to test ListPolicyStoresInput
      //var instance = new AmazonVerifiedPermissions.ListPolicyStoresInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPolicyStoresInput);
    });
