...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionPrincipal();
  });
  ...
  describe('TemplateLinkedPolicyDefinitionPrincipal', function() {
    it('should create an instance of TemplateLinkedPolicyDefinitionPrincipal', function() {
      // uncomment below and update the code to test TemplateLinkedPolicyDefinitionPrincipal
      //var instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionPrincipal();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionPrincipal);
    });
