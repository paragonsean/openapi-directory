...
(function(root, factory) {
  ...
  describe('ValidationMode', function() {
    it('should create an instance of ValidationMode', function() {
      // uncomment below and update the code to test ValidationMode
      //var instance = new AmazonVerifiedPermissions.ValidationMode();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ValidationMode);
    });
