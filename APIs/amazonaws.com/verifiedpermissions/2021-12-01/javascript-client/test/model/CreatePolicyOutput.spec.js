...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyOutput();
  });
  ...
  describe('CreatePolicyOutput', function() {
    it('should create an instance of CreatePolicyOutput', function() {
      // uncomment below and update the code to test CreatePolicyOutput
      //var instance = new AmazonVerifiedPermissions.CreatePolicyOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyOutput);
    });
