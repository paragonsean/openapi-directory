...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PutSchemaInputDefinition();
  });
  ...
  describe('PutSchemaInputDefinition', function() {
    it('should create an instance of PutSchemaInputDefinition', function() {
      // uncomment below and update the code to test PutSchemaInputDefinition
      //var instance = new AmazonVerifiedPermissions.PutSchemaInputDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PutSchemaInputDefinition);
    });
