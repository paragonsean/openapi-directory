...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPoliciesInput();
  });
  ...
  describe('ListPoliciesInput', function() {
    it('should create an instance of ListPoliciesInput', function() {
      // uncomment below and update the code to test ListPoliciesInput
      //var instance = new AmazonVerifiedPermissions.ListPoliciesInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPoliciesInput);
    });
