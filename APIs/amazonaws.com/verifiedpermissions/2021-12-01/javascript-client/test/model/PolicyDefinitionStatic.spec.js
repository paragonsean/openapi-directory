...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionStatic();
  });
  ...
  describe('PolicyDefinitionStatic', function() {
    it('should create an instance of PolicyDefinitionStatic', function() {
      // uncomment below and update the code to test PolicyDefinitionStatic
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionStatic();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionStatic);
    });
