...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyStoreInputValidationSettings();
  });
  ...
  describe('CreatePolicyStoreInputValidationSettings', function() {
    it('should create an instance of CreatePolicyStoreInputValidationSettings', function() {
      // uncomment below and update the code to test CreatePolicyStoreInputValidationSettings
      //var instance = new AmazonVerifiedPermissions.CreatePolicyStoreInputValidationSettings();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyStoreInputValidationSettings);
    });
