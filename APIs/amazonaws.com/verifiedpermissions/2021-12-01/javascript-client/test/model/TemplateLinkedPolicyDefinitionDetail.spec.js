...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionDetail();
  });
  ...
  describe('TemplateLinkedPolicyDefinitionDetail', function() {
    it('should create an instance of TemplateLinkedPolicyDefinitionDetail', function() {
      // uncomment below and update the code to test TemplateLinkedPolicyDefinitionDetail
      //var instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionDetail();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionDetail);
    });
