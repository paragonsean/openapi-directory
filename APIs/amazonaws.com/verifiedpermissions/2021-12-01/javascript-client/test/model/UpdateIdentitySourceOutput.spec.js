...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdateIdentitySourceOutput();
  });
  ...
  describe('UpdateIdentitySourceOutput', function() {
    it('should create an instance of UpdateIdentitySourceOutput', function() {
      // uncomment below and update the code to test UpdateIdentitySourceOutput
      //var instance = new AmazonVerifiedPermissions.UpdateIdentitySourceOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdateIdentitySourceOutput);
    });
    ...
    it('should have the property identitySourceId (base name: "identitySourceId")', function() {
      // uncomment below and update the code to test the property identitySourceId
      //var instance = new AmazonVerifiedPermissions.UpdateIdentitySourceOutput();
      //expect(instance).to.be();
    });
    ...
    it('should have the property policyStoreId (base name: "policyStoreId")', function() {
      // uncomment below and update the code to test the property policyStoreId
      //var instance = new AmazonVerifiedPermissions.UpdateIdentitySourceOutput();
      //expect(instance).to.be();
    });
