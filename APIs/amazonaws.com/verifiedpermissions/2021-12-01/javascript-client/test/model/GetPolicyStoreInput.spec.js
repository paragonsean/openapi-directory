...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyStoreInput();
  });
  ...
  describe('GetPolicyStoreInput', function() {
    it('should create an instance of GetPolicyStoreInput', function() {
      // uncomment below and update the code to test GetPolicyStoreInput
      //var instance = new AmazonVerifiedPermissions.GetPolicyStoreInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyStoreInput);
    });
