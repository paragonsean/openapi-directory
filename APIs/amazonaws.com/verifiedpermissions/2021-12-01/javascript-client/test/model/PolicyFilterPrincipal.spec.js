...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyFilterPrincipal();
  });
  ...
  describe('PolicyFilterPrincipal', function() {
    it('should create an instance of PolicyFilterPrincipal', function() {
      // uncomment below and update the code to test PolicyFilterPrincipal
      //var instance = new AmazonVerifiedPermissions.PolicyFilterPrincipal();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyFilterPrincipal);
    });
