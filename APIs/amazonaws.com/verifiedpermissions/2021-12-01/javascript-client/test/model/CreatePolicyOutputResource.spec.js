...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyOutputResource();
  });
  ...
  describe('CreatePolicyOutputResource', function() {
    it('should create an instance of CreatePolicyOutputResource', function() {
      // uncomment below and update the code to test CreatePolicyOutputResource
      //var instance = new AmazonVerifiedPermissions.CreatePolicyOutputResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyOutputResource);
    });
