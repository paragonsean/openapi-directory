...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyTemplateInput();
  });
  ...
  describe('UpdatePolicyTemplateInput', function() {
    it('should create an instance of UpdatePolicyTemplateInput', function() {
      // uncomment below and update the code to test UpdatePolicyTemplateInput
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyTemplateInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyTemplateInput);
    });
