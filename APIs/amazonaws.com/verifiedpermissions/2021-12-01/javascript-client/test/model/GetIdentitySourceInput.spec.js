...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetIdentitySourceInput();
  });
  ...
  describe('GetIdentitySourceInput', function() {
    it('should create an instance of GetIdentitySourceInput', function() {
      // uncomment below and update the code to test GetIdentitySourceInput
      //var instance = new AmazonVerifiedPermissions.GetIdentitySourceInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetIdentitySourceInput);
    });
