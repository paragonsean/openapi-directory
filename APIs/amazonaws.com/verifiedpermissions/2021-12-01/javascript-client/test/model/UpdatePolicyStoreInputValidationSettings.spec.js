...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyStoreInputValidationSettings();
  });
  ...
  describe('UpdatePolicyStoreInputValidationSettings', function() {
    it('should create an instance of UpdatePolicyStoreInputValidationSettings', function() {
      // uncomment below and update the code to test UpdatePolicyStoreInputValidationSettings
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyStoreInputValidationSettings();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyStoreInputValidationSettings);
    });
