...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinition();
  });
  ...
  describe('TemplateLinkedPolicyDefinition', function() {
    it('should create an instance of TemplateLinkedPolicyDefinition', function() {
      // uncomment below and update the code to test TemplateLinkedPolicyDefinition
      //var instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.TemplateLinkedPolicyDefinition);
    });
