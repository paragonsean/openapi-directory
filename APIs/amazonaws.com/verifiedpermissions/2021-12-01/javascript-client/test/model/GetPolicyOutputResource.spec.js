...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyOutputResource();
  });
  ...
  describe('GetPolicyOutputResource', function() {
    it('should create an instance of GetPolicyOutputResource', function() {
      // uncomment below and update the code to test GetPolicyOutputResource
      //var instance = new AmazonVerifiedPermissions.GetPolicyOutputResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyOutputResource);
    });
