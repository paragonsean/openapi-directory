...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IsAuthorizedInputContext();
  });
  ...
  describe('IsAuthorizedInputContext', function() {
    it('should create an instance of IsAuthorizedInputContext', function() {
      // uncomment below and update the code to test IsAuthorizedInputContext
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInputContext();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IsAuthorizedInputContext);
    });

    it('should have the property contextMap (base name: "contextMap")', function() {
      // uncomment below and update the code to test the property contextMap
      //var instance = new AmazonVerifiedPermissions.IsAuthorizedInputContext();
