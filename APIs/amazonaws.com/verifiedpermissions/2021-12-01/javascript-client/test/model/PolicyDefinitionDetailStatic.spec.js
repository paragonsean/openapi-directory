...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionDetailStatic();
  });
  ...
  describe('PolicyDefinitionDetailStatic', function() {
    it('should create an instance of PolicyDefinitionDetailStatic', function() {
      // uncomment below and update the code to test PolicyDefinitionDetailStatic
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionDetailStatic();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionDetailStatic);
    });
