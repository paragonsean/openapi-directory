...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EntityItem();
  });
  ...
  describe('EntityItem', function() {
    it('should create an instance of EntityItem', function() {
      // uncomment below and update the code to test EntityItem
      //var instance = new AmazonVerifiedPermissions.EntityItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EntityItem);
    });
