...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetSchemaInput();
  });
  ...
  describe('GetSchemaInput', function() {
    it('should create an instance of GetSchemaInput', function() {
      // uncomment below and update the code to test GetSchemaInput
      //var instance = new AmazonVerifiedPermissions.GetSchemaInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetSchemaInput);
    });
