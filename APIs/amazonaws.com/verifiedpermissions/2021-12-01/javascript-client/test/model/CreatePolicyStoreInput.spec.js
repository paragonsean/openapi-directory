...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyStoreInput();
  });
  ...
  describe('CreatePolicyStoreInput', function() {
    it('should create an instance of CreatePolicyStoreInput', function() {
      // uncomment below and update the code to test CreatePolicyStoreInput
      //var instance = new AmazonVerifiedPermissions.CreatePolicyStoreInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyStoreInput);
    });
