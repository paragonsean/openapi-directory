...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetPolicyOutputDefinition();
  });
  ...
  describe('GetPolicyOutputDefinition', function() {
    it('should create an instance of GetPolicyOutputDefinition', function() {
      // uncomment below and update the code to test GetPolicyOutputDefinition
      //var instance = new AmazonVerifiedPermissions.GetPolicyOutputDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetPolicyOutputDefinition);
    });
    ...
    it('should have the property templateLinked (base name: "templateLinked")', function() {
      // uncomment below and update the code to test the property templateLinked
      //var instance = new AmazonVerifiedPermissions.GetPolicyOutputDefinition();
      //expect(instance).to.be();
    });
