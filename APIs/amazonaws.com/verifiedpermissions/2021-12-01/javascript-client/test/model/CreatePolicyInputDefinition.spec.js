...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyInputDefinition();
  });
  ...
  describe('CreatePolicyInputDefinition', function() {
    it('should create an instance of CreatePolicyInputDefinition', function() {
      // uncomment below and update the code to test CreatePolicyInputDefinition
      //var instance = new AmazonVerifiedPermissions.CreatePolicyInputDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyInputDefinition);
    });
