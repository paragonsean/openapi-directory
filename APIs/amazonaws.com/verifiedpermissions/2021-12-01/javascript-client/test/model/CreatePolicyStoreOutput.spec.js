...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyStoreOutput();
  });
  ...
  describe('CreatePolicyStoreOutput', function() {
    it('should create an instance of CreatePolicyStoreOutput', function() {
      // uncomment below and update the code to test CreatePolicyStoreOutput
      //var instance = new AmazonVerifiedPermissions.CreatePolicyStoreOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyStoreOutput);
    });
