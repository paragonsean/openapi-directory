...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionDetailTemplateLinked();
  });
  ...
  describe('PolicyDefinitionDetailTemplateLinked', function() {
    it('should create an instance of PolicyDefinitionDetailTemplateLinked', function() {
      // uncomment below and update the code to test PolicyDefinitionDetailTemplateLinked
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionDetailTemplateLinked();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionDetailTemplateLinked);
    });
