...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyInput();
  });
  ...
  describe('CreatePolicyInput', function() {
    it('should create an instance of CreatePolicyInput', function() {
      ...
      //var instance = new AmazonVerifiedPermissions.CreatePolicyInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyInput);
    });
