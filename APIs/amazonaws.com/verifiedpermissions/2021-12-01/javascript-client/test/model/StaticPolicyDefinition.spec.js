...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.StaticPolicyDefinition();
  });
  ...
  describe('StaticPolicyDefinition', function() {
    it('should create an instance of StaticPolicyDefinition', function() {
      // uncomment below and update the code to test StaticPolicyDefinition
      //var instance = new AmazonVerifiedPermissions.StaticPolicyDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.StaticPolicyDefinition);
    });
