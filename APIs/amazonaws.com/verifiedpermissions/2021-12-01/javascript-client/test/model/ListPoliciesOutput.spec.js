...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListPoliciesOutput();
  });
  ...
  describe('ListPoliciesOutput', function() {
    it('should create an instance of ListPoliciesOutput', function() {
      // uncomment below and update the code to test ListPoliciesOutput
      //var instance = new AmazonVerifiedPermissions.ListPoliciesOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListPoliciesOutput);
    });
