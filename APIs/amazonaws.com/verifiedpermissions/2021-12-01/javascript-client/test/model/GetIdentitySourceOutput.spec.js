...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetIdentitySourceOutput();
  });
  ...
  describe('GetIdentitySourceOutput', function() {
    it('should create an instance of GetIdentitySourceOutput', function() {
      // uncomment below and update the code to test GetIdentitySourceOutput
      //var instance = new AmazonVerifiedPermissions.GetIdentitySourceOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetIdentitySourceOutput);
    });
