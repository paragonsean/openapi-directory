...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.DeleteIdentitySourceInput();
  });
  ...
  describe('DeleteIdentitySourceInput', function() {
    it('should create an instance of DeleteIdentitySourceInput', function() {
      // uncomment below and update the code to test DeleteIdentitySourceInput
      //var instance = new AmazonVerifiedPermissions.DeleteIdentitySourceInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.DeleteIdentitySourceInput);
    });
