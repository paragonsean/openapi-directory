...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyFilterResource();
  });
  ...
  describe('PolicyFilterResource', function() {
    it('should create an instance of PolicyFilterResource', function() {
      // uncomment below and update the code to test PolicyFilterResource
      //var instance = new AmazonVerifiedPermissions.PolicyFilterResource();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyFilterResource);
    });
