...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyInput();
  });
  ...
  describe('UpdatePolicyInput', function() {
    it('should create an instance of UpdatePolicyInput', function() {
      ...
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyInput);
    });
