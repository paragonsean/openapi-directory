...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IdentitySourceItemDetails();
  });
  ...
  describe('IdentitySourceItemDetails', function() {
    it('should create an instance of IdentitySourceItemDetails', function() {
      // uncomment below and update the code to test IdentitySourceItemDetails
      //var instance = new AmazonVerifiedPermissions.IdentitySourceItemDetails();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IdentitySourceItemDetails);
    });
