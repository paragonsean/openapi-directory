...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.EntityReference();
  });
  ...
  describe('EntityReference', function() {
    it('should create an instance of EntityReference', function() {
      // uncomment below and update the code to test EntityReference
      //var instance = new AmazonVerifiedPermissions.EntityReference();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.EntityReference);
    });

    it('should have the property unspecified (base name: "unspecified")', function() {
      // uncomment below and update the code to test the property unspecified
      //var instance = new AmazonVerifiedPermissions.EntityReference();
