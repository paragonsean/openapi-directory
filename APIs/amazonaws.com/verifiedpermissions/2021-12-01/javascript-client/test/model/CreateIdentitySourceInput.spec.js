...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreateIdentitySourceInput();
  });
  ...
  describe('CreateIdentitySourceInput', function() {
    it('should create an instance of CreateIdentitySourceInput', function() {
      // uncomment below and update the code to test CreateIdentitySourceInput
      //var instance = new AmazonVerifiedPermissions.CreateIdentitySourceInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreateIdentitySourceInput);
    });
