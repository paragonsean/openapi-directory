...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyStoreItem();
  });
  ...
  describe('PolicyStoreItem', function() {
    it('should create an instance of PolicyStoreItem', function() {
      // uncomment below and update the code to test PolicyStoreItem
      //var instance = new AmazonVerifiedPermissions.PolicyStoreItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyStoreItem);
    });
