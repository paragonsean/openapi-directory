...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ConfigurationCognitoUserPoolConfiguration();
  });
  ...
  describe('ConfigurationCognitoUserPoolConfiguration', function() {
    it('should create an instance of ConfigurationCognitoUserPoolConfiguration', function() {
      // uncomment below and update the code to test ConfigurationCognitoUserPoolConfiguration
      //var instance = new AmazonVerifiedPermissions.ConfigurationCognitoUserPoolConfiguration();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ConfigurationCognitoUserPoolConfiguration);
    });
