...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.CreatePolicyTemplateInput();
  });
  ...
  describe('CreatePolicyTemplateInput', function() {
    it('should create an instance of CreatePolicyTemplateInput', function() {
      // uncomment below and update the code to test CreatePolicyTemplateInput
      //var instance = new AmazonVerifiedPermissions.CreatePolicyTemplateInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.CreatePolicyTemplateInput);
    });
