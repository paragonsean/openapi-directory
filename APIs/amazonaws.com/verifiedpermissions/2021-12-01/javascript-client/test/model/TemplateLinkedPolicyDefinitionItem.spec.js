...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionItem();
  });
  ...
  describe('TemplateLinkedPolicyDefinitionItem', function() {
    it('should create an instance of TemplateLinkedPolicyDefinitionItem', function() {
      // uncomment below and update the code to test TemplateLinkedPolicyDefinitionItem
      //var instance = new AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.TemplateLinkedPolicyDefinitionItem);
    });
