...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.GetIdentitySourceOutputDetails();
  });
  ...
  describe('GetIdentitySourceOutputDetails', function() {
    it('should create an instance of GetIdentitySourceOutputDetails', function() {
      // uncomment below and update the code to test GetIdentitySourceOutputDetails
      //var instance = new AmazonVerifiedPermissions.GetIdentitySourceOutputDetails();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.GetIdentitySourceOutputDetails);
    });
