...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyStoreInput();
  });
  ...
  describe('UpdatePolicyStoreInput', function() {
    it('should create an instance of UpdatePolicyStoreInput', function() {
      // uncomment below and update the code to test UpdatePolicyStoreInput
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyStoreInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyStoreInput);
    });
