...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ContextDefinition();
  });
  ...
  describe('ContextDefinition', function() {
    it('should create an instance of ContextDefinition', function() {
      // uncomment below and update the code to test ContextDefinition
      //var instance = new AmazonVerifiedPermissions.ContextDefinition();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ContextDefinition);
    });
