...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyStoreOutput();
  });
  ...
  describe('UpdatePolicyStoreOutput', function() {
    it('should create an instance of UpdatePolicyStoreOutput', function() {
      // uncomment below and update the code to test UpdatePolicyStoreOutput
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyStoreOutput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyStoreOutput);
    });
