...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.ListIdentitySourcesInput();
  });
  ...
  describe('ListIdentitySourcesInput', function() {
    it('should create an instance of ListIdentitySourcesInput', function() {
      // uncomment below and update the code to test ListIdentitySourcesInput
      //var instance = new AmazonVerifiedPermissions.ListIdentitySourcesInput();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.ListIdentitySourcesInput);
    });
