...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyDefinitionItemStatic();
  });
  ...
  describe('PolicyDefinitionItemStatic', function() {
    it('should create an instance of PolicyDefinitionItemStatic', function() {
      // uncomment below and update the code to test PolicyDefinitionItemStatic
      //var instance = new AmazonVerifiedPermissions.PolicyDefinitionItemStatic();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyDefinitionItemStatic);
    });
