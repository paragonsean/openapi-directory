...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.IdentitySourceDetails();
  });
  ...
  describe('IdentitySourceDetails', function() {
    it('should create an instance of IdentitySourceDetails', function() {
      // uncomment below and update the code to test IdentitySourceDetails
      //var instance = new AmazonVerifiedPermissions.IdentitySourceDetails();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.IdentitySourceDetails);
    });
