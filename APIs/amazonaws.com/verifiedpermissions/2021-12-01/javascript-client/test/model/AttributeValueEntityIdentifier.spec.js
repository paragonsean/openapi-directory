...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.AttributeValueEntityIdentifier();
  });
  ...
  describe('AttributeValueEntityIdentifier', function() {
    it('should create an instance of AttributeValueEntityIdentifier', function() {
      // uncomment below and update the code to test AttributeValueEntityIdentifier
      //var instance = new AmazonVerifiedPermissions.AttributeValueEntityIdentifier();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.AttributeValueEntityIdentifier);
    });
