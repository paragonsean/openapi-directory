...
(function(root, factory) {
  ...
  describe('OpenIdIssuer', function() {
    it('should create an instance of OpenIdIssuer', function() {
      // uncomment below and update the code to test OpenIdIssuer
      //var instance = new AmazonVerifiedPermissions.OpenIdIssuer();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.OpenIdIssuer);
    });
