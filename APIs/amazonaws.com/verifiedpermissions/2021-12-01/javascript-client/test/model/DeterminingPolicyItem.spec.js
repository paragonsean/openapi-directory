...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.DeterminingPolicyItem();
  });
  ...
  describe('DeterminingPolicyItem', function() {
    it('should create an instance of DeterminingPolicyItem', function() {
      // uncomment below and update the code to test DeterminingPolicyItem
      //var instance = new AmazonVerifiedPermissions.DeterminingPolicyItem();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.DeterminingPolicyItem);
    });
