...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.PolicyItemPrincipal();
  });
  ...
  describe('PolicyItemPrincipal', function() {
    it('should create an instance of PolicyItemPrincipal', function() {
      // uncomment below and update the code to test PolicyItemPrincipal
      //var instance = new AmazonVerifiedPermissions.PolicyItemPrincipal();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.PolicyItemPrincipal);
    });
