...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AmazonVerifiedPermissions.UpdatePolicyDefinitionStatic();
  });
  ...
  describe('UpdatePolicyDefinitionStatic', function() {
    it('should create an instance of UpdatePolicyDefinitionStatic', function() {
      // uncomment below and update the code to test UpdatePolicyDefinitionStatic
      //var instance = new AmazonVerifiedPermissions.UpdatePolicyDefinitionStatic();
      //expect(instance).to.be.a(AmazonVerifiedPermissions.UpdatePolicyDefinitionStatic);
    });
