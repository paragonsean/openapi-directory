...
/**
 * The GetPolicyStoreOutputValidationSettings model module.
 * @module model/GetPolicyStoreOutputValidationSettings
 * @version 2021-12-01
 */
class GetPolicyStoreOutputValidationSettings {
    /**
     * Constructs a new <code>GetPolicyStoreOutputValidationSettings</code>.
     * @alias module:model/GetPolicyStoreOutputValidationSettings
     * @implements module:model/ValidationSettings
     * @param mode {module:model/ValidationMode} 
     */
    constructor(mode) { 
        ValidationSettings.initialize(this, mode);
        GetPolicyStoreOutputValidationSettings.initialize(this, mode);
    }
    ...
    /**
     * Constructs a <code>GetPolicyStoreOutputValidationSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyStoreOutputValidationSettings} obj Optional instance to populate.
     * @return {module:model/GetPolicyStoreOutputValidationSettings} The populated <code>GetPolicyStoreOutputValidationSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyStoreOutputValidationSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyStoreOutputValidationSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyStoreOutputValidationSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyStoreOutputValidationSettings.RequiredProperties) {
...
GetPolicyStoreOutputValidationSettings.RequiredProperties = ["mode"];

/**
 * @member {module:model/ValidationMode} mode
 */
GetPolicyStoreOutputValidationSettings.prototype['mode'] = undefined;
...
export default GetPolicyStoreOutputValidationSettings;
