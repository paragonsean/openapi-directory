...
/**
 * The CreatePolicyOutputPrincipal model module.
 * @module model/CreatePolicyOutputPrincipal
 * @version 2021-12-01
 */
class CreatePolicyOutputPrincipal {
    /**
     * Constructs a new <code>CreatePolicyOutputPrincipal</code>.
     * @alias module:model/CreatePolicyOutputPrincipal
     * @implements module:model/EntityIdentifier
     * @param entityType {String} 
     * @param entityId {String} 
     */
    constructor(entityType, entityId) { 
        EntityIdentifier.initialize(this, entityType, entityId);
        CreatePolicyOutputPrincipal.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyOutputPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyOutputPrincipal} obj Optional instance to populate.
     * @return {module:model/CreatePolicyOutputPrincipal} The populated <code>CreatePolicyOutputPrincipal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyOutputPrincipal();
            EntityIdentifier.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyOutputPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyOutputPrincipal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyOutputPrincipal.RequiredProperties) {
...
CreatePolicyOutputPrincipal.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
CreatePolicyOutputPrincipal.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
CreatePolicyOutputPrincipal.prototype['entityId'] = undefined;


// Implement EntityIdentifier interface:
/**
 * @member {String} entityType
 */
EntityIdentifier.prototype['entityType'] = undefined;
/**
 * @member {String} entityId
 */
EntityIdentifier.prototype['entityId'] = undefined;




export default CreatePolicyOutputPrincipal;
