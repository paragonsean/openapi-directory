...
/**
 * The ListPolicyTemplatesInput model module.
 * @module model/ListPolicyTemplatesInput
 * @version 2021-12-01
 */
class ListPolicyTemplatesInput {
    /**
     * Constructs a new <code>ListPolicyTemplatesInput</code>.
     * @alias module:model/ListPolicyTemplatesInput
     * @param policyStoreId {String} 
     */
    constructor(policyStoreId) { 
        
        ListPolicyTemplatesInput.initialize(this, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>ListPolicyTemplatesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPolicyTemplatesInput} obj Optional instance to populate.
     * @return {module:model/ListPolicyTemplatesInput} The populated <code>ListPolicyTemplatesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPolicyTemplatesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPolicyTemplatesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPolicyTemplatesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPolicyTemplatesInput.RequiredProperties) {
...
ListPolicyTemplatesInput.RequiredProperties = ["policyStoreId"];

/**
 * @member {String} policyStoreId
 */
ListPolicyTemplatesInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} nextToken
 */
ListPolicyTemplatesInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListPolicyTemplatesInput.prototype['maxResults'] = undefined;
...
export default ListPolicyTemplatesInput;
