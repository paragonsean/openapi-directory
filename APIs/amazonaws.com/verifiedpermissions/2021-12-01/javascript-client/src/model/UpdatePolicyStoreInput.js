...
import UpdatePolicyStoreInputValidationSettings from './UpdatePolicyStoreInputValidationSettings';

/**
 * The UpdatePolicyStoreInput model module.
 * @module model/UpdatePolicyStoreInput
 * @version 2021-12-01
 */
class UpdatePolicyStoreInput {
    /**
     * Constructs a new <code>UpdatePolicyStoreInput</code>.
     * @alias module:model/UpdatePolicyStoreInput
     * @param policyStoreId {String} 
     * @param validationSettings {module:model/UpdatePolicyStoreInputValidationSettings} 
     */
    constructor(policyStoreId, validationSettings) { 
        
        UpdatePolicyStoreInput.initialize(this, policyStoreId, validationSettings);
    }
     ...
     */
    static initialize(obj, policyStoreId, validationSettings) { 
        obj['policyStoreId'] = policyStoreId;
        obj['validationSettings'] = validationSettings;
    }

    /**
     * Constructs a <code>UpdatePolicyStoreInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyStoreInput} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyStoreInput} The populated <code>UpdatePolicyStoreInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyStoreInput();
            ...
            if (data.hasOwnProperty('validationSettings')) {
                obj['validationSettings'] = UpdatePolicyStoreInputValidationSettings.constructFromObject(data['validationSettings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyStoreInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyStoreInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyStoreInput.RequiredProperties) {
        ...
        if (data['validationSettings']) { // data not null
          UpdatePolicyStoreInputValidationSettings.validateJSON(data['validationSettings']);
        }
...
UpdatePolicyStoreInput.RequiredProperties = ["policyStoreId", "validationSettings"];

/**
 * @member {String} policyStoreId
 */
UpdatePolicyStoreInput.prototype['policyStoreId'] = undefined;

/**
 * @member {module:model/UpdatePolicyStoreInputValidationSettings} validationSettings
 */
UpdatePolicyStoreInput.prototype['validationSettings'] = undefined;
...
export default UpdatePolicyStoreInput;
