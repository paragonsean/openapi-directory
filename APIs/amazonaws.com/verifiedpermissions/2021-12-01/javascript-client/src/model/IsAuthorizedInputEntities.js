...
import EntitiesDefinition from './EntitiesDefinition';

/**
 * The IsAuthorizedInputEntities model module.
 * @module model/IsAuthorizedInputEntities
 * @version 2021-12-01
 */
class IsAuthorizedInputEntities {
    /**
     * Constructs a new <code>IsAuthorizedInputEntities</code>.
     * @alias module:model/IsAuthorizedInputEntities
     * @implements module:model/EntitiesDefinition
     */
    constructor() { 
        EntitiesDefinition.initialize(this);
        IsAuthorizedInputEntities.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedInputEntities</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedInputEntities} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedInputEntities} The populated <code>IsAuthorizedInputEntities</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedInputEntities();
            EntitiesDefinition.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedInputEntities</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedInputEntities</code>.
     */
 ...
 */
IsAuthorizedInputEntities.prototype['entityList'] = undefined;


// Implement EntitiesDefinition interface:
/**
 * @member {Array} entityList
 */
...
export default IsAuthorizedInputEntities;
