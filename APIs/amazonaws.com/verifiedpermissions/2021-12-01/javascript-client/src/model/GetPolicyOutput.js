...
import GetPolicyOutputDefinition from './GetPolicyOutputDefinition';
...
/**
 * The GetPolicyOutput model module.
 * @module model/GetPolicyOutput
 * @version 2021-12-01
 */
class GetPolicyOutput {
    /**
     * Constructs a new <code>GetPolicyOutput</code>.
     * @alias module:model/GetPolicyOutput
     * @param policyStoreId {String} 
     * @param policyId {String} 
     * @param policyType {module:model/PolicyType} 
     * @param definition {module:model/GetPolicyOutputDefinition} 
     * @param createdDate {Date} 
     * @param lastUpdatedDate {Date} 
     */
    constructor(policyStoreId, policyId, policyType, definition, createdDate, lastUpdatedDate) { 
        
        GetPolicyOutput.initialize(this, policyStoreId, policyId, policyType, definition, createdDate, lastUpdatedDate);
    }
     ...
     */
    static initialize(obj, policyStoreId, policyId, policyType, definition, createdDate, lastUpdatedDate) { 
    ...
    /**
     * Constructs a <code>GetPolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyOutput} obj Optional instance to populate.
     * @return {module:model/GetPolicyOutput} The populated <code>GetPolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyOutput();
            ...
            if (data.hasOwnProperty('definition')) {
                obj['definition'] = GetPolicyOutputDefinition.constructFromObject(data['definition']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyOutput.RequiredProperties) {
        ...
        if (data['definition']) { // data not null
          GetPolicyOutputDefinition.validateJSON(data['definition']);
        }
...
GetPolicyOutput.RequiredProperties = ["policyStoreId", "policyId", "policyType", "definition", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
GetPolicyOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyId
 */
GetPolicyOutput.prototype['policyId'] = undefined;

/**
 * @member {module:model/PolicyType} policyType
 */
GetPolicyOutput.prototype['policyType'] = undefined;

/**
 * @member {module:model/GetPolicyOutputPrincipal} principal
 */
GetPolicyOutput.prototype['principal'] = undefined;

/**
 * @member {module:model/GetPolicyOutputResource} resource
 */
GetPolicyOutput.prototype['resource'] = undefined;

/**
 * @member {module:model/GetPolicyOutputDefinition} definition
 */
GetPolicyOutput.prototype['definition'] = undefined;

/**
 * @member {Date} createdDate
 */
GetPolicyOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
GetPolicyOutput.prototype['lastUpdatedDate'] = undefined;
...
export default GetPolicyOutput;
