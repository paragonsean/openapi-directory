...
/**
 * The GetPolicyStoreInput model module.
 * @module model/GetPolicyStoreInput
 * @version 2021-12-01
 */
class GetPolicyStoreInput {
    /**
     * Constructs a new <code>GetPolicyStoreInput</code>.
     * @alias module:model/GetPolicyStoreInput
     * @param policyStoreId {String} 
     */
    constructor(policyStoreId) { 
        
        GetPolicyStoreInput.initialize(this, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>GetPolicyStoreInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyStoreInput} obj Optional instance to populate.
     * @return {module:model/GetPolicyStoreInput} The populated <code>GetPolicyStoreInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyStoreInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyStoreInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyStoreInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyStoreInput.RequiredProperties) {
...
GetPolicyStoreInput.RequiredProperties = ["policyStoreId"];

/**
 * @member {String} policyStoreId
 */
GetPolicyStoreInput.prototype['policyStoreId'] = undefined;
...
export default GetPolicyStoreInput;
