...
/**
 * The GetIdentitySourceInput model module.
 * @module model/GetIdentitySourceInput
 * @version 2021-12-01
 */
class GetIdentitySourceInput {
    /**
     * Constructs a new <code>GetIdentitySourceInput</code>.
     * @alias module:model/GetIdentitySourceInput
     * @param policyStoreId {String} 
     * @param identitySourceId {String} 
     */
    constructor(policyStoreId, identitySourceId) { 
        
        GetIdentitySourceInput.initialize(this, policyStoreId, identitySourceId);
    }
     ...
     */
    static initialize(obj, policyStoreId, identitySourceId) { 
        obj['policyStoreId'] = policyStoreId;
        obj['identitySourceId'] = identitySourceId;
    }

    /**
     * Constructs a <code>GetIdentitySourceInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIdentitySourceInput} obj Optional instance to populate.
     * @return {module:model/GetIdentitySourceInput} The populated <code>GetIdentitySourceInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdentitySourceInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdentitySourceInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdentitySourceInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetIdentitySourceInput.RequiredProperties) {
...
GetIdentitySourceInput.RequiredProperties = ["policyStoreId", "identitySourceId"];

/**
 * @member {String} policyStoreId
 */
GetIdentitySourceInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} identitySourceId
 */
GetIdentitySourceInput.prototype['identitySourceId'] = undefined;
...
export default GetIdentitySourceInput;
