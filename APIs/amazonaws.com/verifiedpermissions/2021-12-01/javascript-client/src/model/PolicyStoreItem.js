...
/**
 * The PolicyStoreItem model module.
 * @module model/PolicyStoreItem
 * @version 2021-12-01
 */
class PolicyStoreItem {
    /**
     * Constructs a new <code>PolicyStoreItem</code>.
     ...
     * @alias module:model/PolicyStoreItem
     * @param policyStoreId {String} 
     * @param arn {String} 
     * @param createdDate {Date} 
     */
    constructor(policyStoreId, arn, createdDate) { 
        
        PolicyStoreItem.initialize(this, policyStoreId, arn, createdDate);
    }
     ...
     */
    static initialize(obj, policyStoreId, arn, createdDate) { 
    ...
    /**
     * Constructs a <code>PolicyStoreItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyStoreItem} obj Optional instance to populate.
     * @return {module:model/PolicyStoreItem} The populated <code>PolicyStoreItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyStoreItem();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyStoreItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyStoreItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyStoreItem.RequiredProperties) {
...
PolicyStoreItem.RequiredProperties = ["policyStoreId", "arn", "createdDate"];

/**
 * @member {String} policyStoreId
 */
PolicyStoreItem.prototype['policyStoreId'] = undefined;

/**
 * @member {String} arn
 */
PolicyStoreItem.prototype['arn'] = undefined;

/**
 * @member {Date} createdDate
 */
PolicyStoreItem.prototype['createdDate'] = undefined;
...
export default PolicyStoreItem;
