...
/**
 * The ListIdentitySourcesInput model module.
 * @module model/ListIdentitySourcesInput
 * @version 2021-12-01
 */
class ListIdentitySourcesInput {
    /**
     * Constructs a new <code>ListIdentitySourcesInput</code>.
     * @alias module:model/ListIdentitySourcesInput
     * @param policyStoreId {String} 
     */
    constructor(policyStoreId) { 
        
        ListIdentitySourcesInput.initialize(this, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>ListIdentitySourcesInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListIdentitySourcesInput} obj Optional instance to populate.
     * @return {module:model/ListIdentitySourcesInput} The populated <code>ListIdentitySourcesInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListIdentitySourcesInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListIdentitySourcesInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListIdentitySourcesInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListIdentitySourcesInput.RequiredProperties) {
...
ListIdentitySourcesInput.RequiredProperties = ["policyStoreId"];

/**
 * @member {String} policyStoreId
 */
ListIdentitySourcesInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} nextToken
 */
ListIdentitySourcesInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListIdentitySourcesInput.prototype['maxResults'] = undefined;

/**
 * @member {Array} filters
 */
ListIdentitySourcesInput.prototype['filters'] = undefined;
...
export default ListIdentitySourcesInput;
