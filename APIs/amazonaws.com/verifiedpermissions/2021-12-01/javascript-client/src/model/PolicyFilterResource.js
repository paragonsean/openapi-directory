...
import EntityReferenceIdentifier from './EntityReferenceIdentifier';

/**
 * The PolicyFilterResource model module.
 * @module model/PolicyFilterResource
 * @version 2021-12-01
 */
class PolicyFilterResource {
    /**
     * Constructs a new <code>PolicyFilterResource</code>.
     * @alias module:model/PolicyFilterResource
     * @implements module:model/EntityReference
     */
    constructor() { 
        EntityReference.initialize(this);
        PolicyFilterResource.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyFilterResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyFilterResource} obj Optional instance to populate.
     * @return {module:model/PolicyFilterResource} The populated <code>PolicyFilterResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyFilterResource();
            EntityReference.constructFromObject(data, obj);

            if (data.hasOwnProperty('unspecified')) {
                obj['unspecified'] = ApiClient.convertToType(data['unspecified'], 'Boolean');
            }
            if (data.hasOwnProperty('identifier')) {
                obj['identifier'] = EntityReferenceIdentifier.constructFromObject(data['identifier']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyFilterResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyFilterResource</code>.
     */
    static validateJSON(data) {
        // validate the optional field `unspecified`
        if (data['unspecified']) { // data not null
          Boolean.validateJSON(data['unspecified']);
        }
        // validate the optional field `identifier`
        if (data['identifier']) { // data not null
          EntityReferenceIdentifier.validateJSON(data['identifier']);
        }
...
/**
 * @member {Boolean} unspecified
 */
PolicyFilterResource.prototype['unspecified'] = undefined;

/**
 * @member {module:model/EntityReferenceIdentifier} identifier
 */
PolicyFilterResource.prototype['identifier'] = undefined;


// Implement EntityReference interface:
/**
 * @member {Boolean} unspecified
 */
EntityReference.prototype['unspecified'] = undefined;
/**
 * @member {module:model/EntityReferenceIdentifier} identifier
 */
EntityReference.prototype['identifier'] = undefined;




export default PolicyFilterResource;
