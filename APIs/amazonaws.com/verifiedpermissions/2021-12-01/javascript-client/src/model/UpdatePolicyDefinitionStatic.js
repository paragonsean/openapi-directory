...
import UpdateStaticPolicyDefinition from './UpdateStaticPolicyDefinition';

/**
 * The UpdatePolicyDefinitionStatic model module.
 * @module model/UpdatePolicyDefinitionStatic
 * @version 2021-12-01
 */
class UpdatePolicyDefinitionStatic {
    /**
     * Constructs a new <code>UpdatePolicyDefinitionStatic</code>.
     * @alias module:model/UpdatePolicyDefinitionStatic
     * @implements module:model/UpdateStaticPolicyDefinition
     * @param statement {String} 
     */
    constructor(statement) { 
        UpdateStaticPolicyDefinition.initialize(this, statement);
        UpdatePolicyDefinitionStatic.initialize(this, statement);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyDefinitionStatic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyDefinitionStatic} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyDefinitionStatic} The populated <code>UpdatePolicyDefinitionStatic</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyDefinitionStatic();
            UpdateStaticPolicyDefinition.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyDefinitionStatic</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyDefinitionStatic</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyDefinitionStatic.RequiredProperties) {
...
UpdatePolicyDefinitionStatic.RequiredProperties = ["statement"];

/**
 * @member {String} description
 */
UpdatePolicyDefinitionStatic.prototype['description'] = undefined;

/**
 * @member {String} statement
 */
UpdatePolicyDefinitionStatic.prototype['statement'] = undefined;


// Implement UpdateStaticPolicyDefinition interface:
/**
 * @member {String} description
 */
...
export default UpdatePolicyDefinitionStatic;
