...
import UpdateIdentitySourceInputUpdateConfiguration from './UpdateIdentitySourceInputUpdateConfiguration';

/**
 * The UpdateIdentitySourceInput model module.
 * @module model/UpdateIdentitySourceInput
 * @version 2021-12-01
 */
class UpdateIdentitySourceInput {
    /**
     * Constructs a new <code>UpdateIdentitySourceInput</code>.
     * @alias module:model/UpdateIdentitySourceInput
     * @param policyStoreId {String} 
     * @param identitySourceId {String} 
     * @param updateConfiguration {module:model/UpdateIdentitySourceInputUpdateConfiguration} 
     */
    constructor(policyStoreId, identitySourceId, updateConfiguration) { 
        
        UpdateIdentitySourceInput.initialize(this, policyStoreId, identitySourceId, updateConfiguration);
    }
     ...
     */
    static initialize(obj, policyStoreId, identitySourceId, updateConfiguration) { 
        obj['policyStoreId'] = policyStoreId;
        obj['identitySourceId'] = identitySourceId;
        obj['updateConfiguration'] = updateConfiguration;
    }

    /**
     * Constructs a <code>UpdateIdentitySourceInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIdentitySourceInput} obj Optional instance to populate.
     * @return {module:model/UpdateIdentitySourceInput} The populated <code>UpdateIdentitySourceInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIdentitySourceInput();

            if (data.hasOwnProperty('policyStoreId')) {
                obj['policyStoreId'] = ApiClient.convertToType(data['policyStoreId'], 'String');
            }
            if (data.hasOwnProperty('identitySourceId')) {
                obj['identitySourceId'] = ApiClient.convertToType(data['identitySourceId'], 'String');
            }
            if (data.hasOwnProperty('updateConfiguration')) {
                obj['updateConfiguration'] = UpdateIdentitySourceInputUpdateConfiguration.constructFromObject(data['updateConfiguration']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIdentitySourceInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIdentitySourceInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateIdentitySourceInput.RequiredProperties) {
        ...
        // validate the optional field `identitySourceId`
        if (data['identitySourceId']) { // data not null
          String.validateJSON(data['identitySourceId']);
        }
        // validate the optional field `updateConfiguration`
        if (data['updateConfiguration']) { // data not null
          UpdateIdentitySourceInputUpdateConfiguration.validateJSON(data['updateConfiguration']);
        }
...
UpdateIdentitySourceInput.RequiredProperties = ["policyStoreId", "identitySourceId", "updateConfiguration"];

/**
 * @member {String} policyStoreId
 */
UpdateIdentitySourceInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} identitySourceId
 */
UpdateIdentitySourceInput.prototype['identitySourceId'] = undefined;

/**
 * @member {module:model/UpdateIdentitySourceInputUpdateConfiguration} updateConfiguration
 */
UpdateIdentitySourceInput.prototype['updateConfiguration'] = undefined;

/**
 * @member {String} principalEntityType
 */
UpdateIdentitySourceInput.prototype['principalEntityType'] = undefined;
...
export default UpdateIdentitySourceInput;
