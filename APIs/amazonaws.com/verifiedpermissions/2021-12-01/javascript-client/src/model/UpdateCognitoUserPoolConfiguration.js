...
/**
 * The UpdateCognitoUserPoolConfiguration model module.
 * @module model/UpdateCognitoUserPoolConfiguration
 * @version 2021-12-01
 */
class UpdateCognitoUserPoolConfiguration {
    /**
     * Constructs a new <code>UpdateCognitoUserPoolConfiguration</code>.
     * Contains configuration details of a Amazon Cognito user pool for use with an identity source.
     * @alias module:model/UpdateCognitoUserPoolConfiguration
     * @param userPoolArn {String} 
     */
    constructor(userPoolArn) { 
        
        UpdateCognitoUserPoolConfiguration.initialize(this, userPoolArn);
    }
     ...
     */
    static initialize(obj, userPoolArn) { 
        obj['userPoolArn'] = userPoolArn;
    }

    /**
     * Constructs a <code>UpdateCognitoUserPoolConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateCognitoUserPoolConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateCognitoUserPoolConfiguration} The populated <code>UpdateCognitoUserPoolConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateCognitoUserPoolConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateCognitoUserPoolConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateCognitoUserPoolConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateCognitoUserPoolConfiguration.RequiredProperties) {
...
UpdateCognitoUserPoolConfiguration.RequiredProperties = ["userPoolArn"];

/**
 * @member {String} userPoolArn
 */
UpdateCognitoUserPoolConfiguration.prototype['userPoolArn'] = undefined;

/**
 * @member {Array} clientIds
 */
UpdateCognitoUserPoolConfiguration.prototype['clientIds'] = undefined;
...
export default UpdateCognitoUserPoolConfiguration;
