...
/**
 * The GetPolicyOutputPrincipal model module.
 * @module model/GetPolicyOutputPrincipal
 * @version 2021-12-01
 */
class GetPolicyOutputPrincipal {
    /**
     * Constructs a new <code>GetPolicyOutputPrincipal</code>.
     * @alias module:model/GetPolicyOutputPrincipal
    ...
    constructor(entityType, entityId) { 
        ...
        GetPolicyOutputPrincipal.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>GetPolicyOutputPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyOutputPrincipal} obj Optional instance to populate.
     * @return {module:model/GetPolicyOutputPrincipal} The populated <code>GetPolicyOutputPrincipal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyOutputPrincipal();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyOutputPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyOutputPrincipal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyOutputPrincipal.RequiredProperties) {
...
GetPolicyOutputPrincipal.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
GetPolicyOutputPrincipal.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
GetPolicyOutputPrincipal.prototype['entityId'] = undefined;
...
export default GetPolicyOutputPrincipal;
