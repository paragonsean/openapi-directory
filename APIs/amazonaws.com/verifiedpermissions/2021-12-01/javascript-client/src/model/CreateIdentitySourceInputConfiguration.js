...
/**
 * The CreateIdentitySourceInputConfiguration model module.
 * @module model/CreateIdentitySourceInputConfiguration
 * @version 2021-12-01
 */
class CreateIdentitySourceInputConfiguration {
    /**
     * Constructs a new <code>CreateIdentitySourceInputConfiguration</code>.
     * @alias module:model/CreateIdentitySourceInputConfiguration
     * @implements module:model/Configuration
     */
    constructor() { 
        Configuration.initialize(this);
        CreateIdentitySourceInputConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateIdentitySourceInputConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentitySourceInputConfiguration} obj Optional instance to populate.
     * @return {module:model/CreateIdentitySourceInputConfiguration} The populated <code>CreateIdentitySourceInputConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentitySourceInputConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentitySourceInputConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentitySourceInputConfiguration</code>.
     */
 ...
 */
CreateIdentitySourceInputConfiguration.prototype['cognitoUserPoolConfiguration'] = undefined;
...
export default CreateIdentitySourceInputConfiguration;
