...
import PolicyDefinitionItem from './PolicyDefinitionItem';
...
/**
 * The PolicyItemDefinition model module.
 * @module model/PolicyItemDefinition
 * @version 2021-12-01
 */
class PolicyItemDefinition {
    /**
     * Constructs a new <code>PolicyItemDefinition</code>.
     * @alias module:model/PolicyItemDefinition
     * @implements module:model/PolicyDefinitionItem
     */
    constructor() { 
        PolicyDefinitionItem.initialize(this);
        PolicyItemDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyItemDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyItemDefinition} obj Optional instance to populate.
     * @return {module:model/PolicyItemDefinition} The populated <code>PolicyItemDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyItemDefinition();
            PolicyDefinitionItem.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyItemDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyItemDefinition</code>.
     */
 ...
 */
PolicyItemDefinition.prototype['static'] = undefined;

/**
 * @member {module:model/PolicyDefinitionItemTemplateLinked} templateLinked
 */
PolicyItemDefinition.prototype['templateLinked'] = undefined;


// Implement PolicyDefinitionItem interface:
/**
 * @member {module:model/PolicyDefinitionItemStatic} static
 */
...
export default PolicyItemDefinition;
