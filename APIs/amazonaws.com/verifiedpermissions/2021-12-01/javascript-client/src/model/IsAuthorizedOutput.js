...
/**
 * The IsAuthorizedOutput model module.
 * @module model/IsAuthorizedOutput
 * @version 2021-12-01
 */
class IsAuthorizedOutput {
    /**
     * Constructs a new <code>IsAuthorizedOutput</code>.
     * @alias module:model/IsAuthorizedOutput
     * @param decision {module:model/Decision} 
     * @param determiningPolicies {Array} 
     * @param errors {Array} 
     */
    constructor(decision, determiningPolicies, errors) { 
        
        IsAuthorizedOutput.initialize(this, decision, determiningPolicies, errors);
    }
     ...
     */
    static initialize(obj, decision, determiningPolicies, errors) { 
        obj['decision'] = decision;
        obj['determiningPolicies'] = determiningPolicies;
        obj['errors'] = errors;
    }

    /**
     * Constructs a <code>IsAuthorizedOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedOutput} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedOutput} The populated <code>IsAuthorizedOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedOutput();

            if (data.hasOwnProperty('decision')) {
                obj['decision'] = ApiClient.convertToType(data['decision'], Decision);
            }
            if (data.hasOwnProperty('determiningPolicies')) {
                obj['determiningPolicies'] = ApiClient.convertToType(data['determiningPolicies'], Array);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedOutput.RequiredProperties) {
        ...
        if (data['decision']) { // data not null
          Decision.validateJSON(data['decision']);
        }
        // validate the optional field `determiningPolicies`
        if (data['determiningPolicies']) { // data not null
          Array.validateJSON(data['determiningPolicies']);
        }
...
IsAuthorizedOutput.RequiredProperties = ["decision", "determiningPolicies", "errors"];

/**
 * @member {module:model/Decision} decision
 */
IsAuthorizedOutput.prototype['decision'] = undefined;

/**
 * @member {Array} determiningPolicies
 */
IsAuthorizedOutput.prototype['determiningPolicies'] = undefined;

/**
 * @member {Array} errors
 */
IsAuthorizedOutput.prototype['errors'] = undefined;
...
export default IsAuthorizedOutput;
