...
import UpdateConfigurationCognitoUserPoolConfiguration from './UpdateConfigurationCognitoUserPoolConfiguration';

/**
 * The UpdateIdentitySourceInputUpdateConfiguration model module.
 * @module model/UpdateIdentitySourceInputUpdateConfiguration
 * @version 2021-12-01
 */
class UpdateIdentitySourceInputUpdateConfiguration {
    /**
     * Constructs a new <code>UpdateIdentitySourceInputUpdateConfiguration</code>.
     * @alias module:model/UpdateIdentitySourceInputUpdateConfiguration
     * @implements module:model/UpdateConfiguration
     */
    constructor() { 
        UpdateConfiguration.initialize(this);
        UpdateIdentitySourceInputUpdateConfiguration.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdateIdentitySourceInputUpdateConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIdentitySourceInputUpdateConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateIdentitySourceInputUpdateConfiguration} The populated <code>UpdateIdentitySourceInputUpdateConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIdentitySourceInputUpdateConfiguration();
            UpdateConfiguration.constructFromObject(data, obj);

            if (data.hasOwnProperty('cognitoUserPoolConfiguration')) {
                obj['cognitoUserPoolConfiguration'] = UpdateConfigurationCognitoUserPoolConfiguration.constructFromObject(data['cognitoUserPoolConfiguration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIdentitySourceInputUpdateConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIdentitySourceInputUpdateConfiguration</code>.
     */
    static validateJSON(data) {
        // validate the optional field `cognitoUserPoolConfiguration`
        if (data['cognitoUserPoolConfiguration']) { // data not null
          UpdateConfigurationCognitoUserPoolConfiguration.validateJSON(data['cognitoUserPoolConfiguration']);
        }
...
/**
 * @member {module:model/UpdateConfigurationCognitoUserPoolConfiguration} cognitoUserPoolConfiguration
 */
UpdateIdentitySourceInputUpdateConfiguration.prototype['cognitoUserPoolConfiguration'] = undefined;


// Implement UpdateConfiguration interface:
/**
 * @member {module:model/UpdateConfigurationCognitoUserPoolConfiguration} cognitoUserPoolConfiguration
 */
UpdateConfiguration.prototype['cognitoUserPoolConfiguration'] = undefined;




export default UpdateIdentitySourceInputUpdateConfiguration;
