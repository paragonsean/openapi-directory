...
/**
 * The PolicyItemPrincipal model module.
 * @module model/PolicyItemPrincipal
 * @version 2021-12-01
 */
class PolicyItemPrincipal {
    /**
     * Constructs a new <code>PolicyItemPrincipal</code>.
     * @alias module:model/PolicyItemPrincipal
    ...
    constructor(entityType, entityId) { 
        ...
        PolicyItemPrincipal.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>PolicyItemPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyItemPrincipal} obj Optional instance to populate.
     * @return {module:model/PolicyItemPrincipal} The populated <code>PolicyItemPrincipal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyItemPrincipal();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyItemPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyItemPrincipal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyItemPrincipal.RequiredProperties) {
...
PolicyItemPrincipal.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
PolicyItemPrincipal.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
PolicyItemPrincipal.prototype['entityId'] = undefined;
...
export default PolicyItemPrincipal;
