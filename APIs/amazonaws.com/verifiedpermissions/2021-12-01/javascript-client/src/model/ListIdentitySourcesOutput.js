...
/**
 * The ListIdentitySourcesOutput model module.
 * @module model/ListIdentitySourcesOutput
 * @version 2021-12-01
 */
class ListIdentitySourcesOutput {
    /**
     * Constructs a new <code>ListIdentitySourcesOutput</code>.
     * @alias module:model/ListIdentitySourcesOutput
     * @param identitySources {Array} 
     */
    constructor(identitySources) { 
        
        ListIdentitySourcesOutput.initialize(this, identitySources);
    }
     ...
     */
    static initialize(obj, identitySources) { 
        obj['identitySources'] = identitySources;
    }

    /**
     * Constructs a <code>ListIdentitySourcesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListIdentitySourcesOutput} obj Optional instance to populate.
     * @return {module:model/ListIdentitySourcesOutput} The populated <code>ListIdentitySourcesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListIdentitySourcesOutput();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('identitySources')) {
                obj['identitySources'] = ApiClient.convertToType(data['identitySources'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListIdentitySourcesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListIdentitySourcesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListIdentitySourcesOutput.RequiredProperties) {
        ...
        // validate the optional field `identitySources`
        if (data['identitySources']) { // data not null
          Array.validateJSON(data['identitySources']);
        }
...
ListIdentitySourcesOutput.RequiredProperties = ["identitySources"];

/**
 * @member {String} nextToken
 */
ListIdentitySourcesOutput.prototype['nextToken'] = undefined;

/**
 * @member {Array} identitySources
 */
ListIdentitySourcesOutput.prototype['identitySources'] = undefined;
...
export default ListIdentitySourcesOutput;
