...
import UpdateCognitoUserPoolConfiguration from './UpdateCognitoUserPoolConfiguration';

/**
 * The UpdateConfigurationCognitoUserPoolConfiguration model module.
 * @module model/UpdateConfigurationCognitoUserPoolConfiguration
 * @version 2021-12-01
 */
class UpdateConfigurationCognitoUserPoolConfiguration {
    /**
     * Constructs a new <code>UpdateConfigurationCognitoUserPoolConfiguration</code>.
     * @alias module:model/UpdateConfigurationCognitoUserPoolConfiguration
     * @implements module:model/UpdateCognitoUserPoolConfiguration
     * @param userPoolArn {String} 
     */
    constructor(userPoolArn) { 
        UpdateCognitoUserPoolConfiguration.initialize(this, userPoolArn);
        UpdateConfigurationCognitoUserPoolConfiguration.initialize(this, userPoolArn);
    }
    ...
    /**
     * Constructs a <code>UpdateConfigurationCognitoUserPoolConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateConfigurationCognitoUserPoolConfiguration} obj Optional instance to populate.
     * @return {module:model/UpdateConfigurationCognitoUserPoolConfiguration} The populated <code>UpdateConfigurationCognitoUserPoolConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateConfigurationCognitoUserPoolConfiguration();
            UpdateCognitoUserPoolConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateConfigurationCognitoUserPoolConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateConfigurationCognitoUserPoolConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateConfigurationCognitoUserPoolConfiguration.RequiredProperties) {
...
UpdateConfigurationCognitoUserPoolConfiguration.RequiredProperties = ["userPoolArn"];

/**
 * @member {String} userPoolArn
 */
UpdateConfigurationCognitoUserPoolConfiguration.prototype['userPoolArn'] = undefined;

/**
 * @member {Array} clientIds
 */
UpdateConfigurationCognitoUserPoolConfiguration.prototype['clientIds'] = undefined;


// Implement UpdateCognitoUserPoolConfiguration interface:
/**
 * @member {String} userPoolArn
 */
...
export default UpdateConfigurationCognitoUserPoolConfiguration;
