...
/**
 * The PolicyItemResource model module.
 * @module model/PolicyItemResource
 * @version 2021-12-01
 */
class PolicyItemResource {
    /**
     * Constructs a new <code>PolicyItemResource</code>.
     * @alias module:model/PolicyItemResource
    ...
    constructor(entityType, entityId) { 
        ...
        PolicyItemResource.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>PolicyItemResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyItemResource} obj Optional instance to populate.
     * @return {module:model/PolicyItemResource} The populated <code>PolicyItemResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyItemResource();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyItemResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyItemResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyItemResource.RequiredProperties) {
...
PolicyItemResource.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
PolicyItemResource.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
PolicyItemResource.prototype['entityId'] = undefined;
...
export default PolicyItemResource;
