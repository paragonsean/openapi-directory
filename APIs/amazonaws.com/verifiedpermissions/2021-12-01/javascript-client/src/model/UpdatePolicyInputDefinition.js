...
import UpdatePolicyDefinition from './UpdatePolicyDefinition';
import UpdatePolicyDefinitionStatic from './UpdatePolicyDefinitionStatic';

/**
 * The UpdatePolicyInputDefinition model module.
 * @module model/UpdatePolicyInputDefinition
 * @version 2021-12-01
 */
class UpdatePolicyInputDefinition {
    /**
     * Constructs a new <code>UpdatePolicyInputDefinition</code>.
     * @alias module:model/UpdatePolicyInputDefinition
     * @implements module:model/UpdatePolicyDefinition
     */
    constructor() { 
        UpdatePolicyDefinition.initialize(this);
        UpdatePolicyInputDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyInputDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyInputDefinition} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyInputDefinition} The populated <code>UpdatePolicyInputDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyInputDefinition();
            UpdatePolicyDefinition.constructFromObject(data, obj);

            if (data.hasOwnProperty('static')) {
                obj['static'] = UpdatePolicyDefinitionStatic.constructFromObject(data['static']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyInputDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyInputDefinition</code>.
     */
    static validateJSON(data) {
        // validate the optional field `static`
        if (data['static']) { // data not null
          UpdatePolicyDefinitionStatic.validateJSON(data['static']);
        }
...
/**
 * @member {module:model/UpdatePolicyDefinitionStatic} static
 */
UpdatePolicyInputDefinition.prototype['static'] = undefined;


// Implement UpdatePolicyDefinition interface:
/**
 * @member {module:model/UpdatePolicyDefinitionStatic} static
 */
UpdatePolicyDefinition.prototype['static'] = undefined;




export default UpdatePolicyInputDefinition;
