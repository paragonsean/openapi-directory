...
/**
 * The DeleteIdentitySourceInput model module.
 * @module model/DeleteIdentitySourceInput
 * @version 2021-12-01
 */
class DeleteIdentitySourceInput {
    /**
     * Constructs a new <code>DeleteIdentitySourceInput</code>.
     * @alias module:model/DeleteIdentitySourceInput
     * @param policyStoreId {String} 
     * @param identitySourceId {String} 
     */
    constructor(policyStoreId, identitySourceId) { 
        
        DeleteIdentitySourceInput.initialize(this, policyStoreId, identitySourceId);
    }
    ...
    /**
     * Constructs a <code>DeleteIdentitySourceInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteIdentitySourceInput} obj Optional instance to populate.
     * @return {module:model/DeleteIdentitySourceInput} The populated <code>DeleteIdentitySourceInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteIdentitySourceInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteIdentitySourceInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteIdentitySourceInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteIdentitySourceInput.RequiredProperties) {
...
DeleteIdentitySourceInput.RequiredProperties = ["policyStoreId", "identitySourceId"];

/**
 * @member {String} policyStoreId
 */
DeleteIdentitySourceInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} identitySourceId
 */
DeleteIdentitySourceInput.prototype['identitySourceId'] = undefined;
...
export default DeleteIdentitySourceInput;
