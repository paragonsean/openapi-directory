...
/**
 * The IsAuthorizedInputAction model module.
 * @module model/IsAuthorizedInputAction
 * @version 2021-12-01
 */
class IsAuthorizedInputAction {
    /**
     * Constructs a new <code>IsAuthorizedInputAction</code>.
     * @alias module:model/IsAuthorizedInputAction
     * @implements module:model/ActionIdentifier
     * @param actionType {String} 
     * @param actionId {String} 
     */
    constructor(actionType, actionId) { 
        ActionIdentifier.initialize(this, actionType, actionId);
        IsAuthorizedInputAction.initialize(this, actionType, actionId);
    }
     ...
     */
    static initialize(obj, actionType, actionId) { 
        obj['actionType'] = actionType;
        obj['actionId'] = actionId;
    }

    /**
     * Constructs a <code>IsAuthorizedInputAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedInputAction} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedInputAction} The populated <code>IsAuthorizedInputAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedInputAction();
            ActionIdentifier.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedInputAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedInputAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedInputAction.RequiredProperties) {
...
IsAuthorizedInputAction.RequiredProperties = ["actionType", "actionId"];

/**
 * @member {String} actionType
 */
IsAuthorizedInputAction.prototype['actionType'] = undefined;

/**
 * @member {String} actionId
 */
IsAuthorizedInputAction.prototype['actionId'] = undefined;


// Implement ActionIdentifier interface:
/**
 * @member {String} actionType
 */
ActionIdentifier.prototype['actionType'] = undefined;
/**
 * @member {String} actionId
 */
ActionIdentifier.prototype['actionId'] = undefined;




export default IsAuthorizedInputAction;
