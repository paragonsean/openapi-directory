...
/**
 * The UpdatePolicyStoreOutput model module.
 * @module model/UpdatePolicyStoreOutput
 * @version 2021-12-01
 */
class UpdatePolicyStoreOutput {
    /**
     * Constructs a new <code>UpdatePolicyStoreOutput</code>.
     * @alias module:model/UpdatePolicyStoreOutput
     * @param policyStoreId {String} 
     * @param arn {String} 
     * @param createdDate {Date} 
     * @param lastUpdatedDate {Date} 
     */
    constructor(policyStoreId, arn, createdDate, lastUpdatedDate) { 
        
        UpdatePolicyStoreOutput.initialize(this, policyStoreId, arn, createdDate, lastUpdatedDate);
    }
     ...
     */
    static initialize(obj, policyStoreId, arn, createdDate, lastUpdatedDate) { 
    ...
    /**
     * Constructs a <code>UpdatePolicyStoreOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyStoreOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyStoreOutput} The populated <code>UpdatePolicyStoreOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyStoreOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyStoreOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyStoreOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyStoreOutput.RequiredProperties) {
...
UpdatePolicyStoreOutput.RequiredProperties = ["policyStoreId", "arn", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
UpdatePolicyStoreOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} arn
 */
UpdatePolicyStoreOutput.prototype['arn'] = undefined;

/**
 * @member {Date} createdDate
 */
UpdatePolicyStoreOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
UpdatePolicyStoreOutput.prototype['lastUpdatedDate'] = undefined;
...
export default UpdatePolicyStoreOutput;
