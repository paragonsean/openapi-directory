...
/**
 * The UpdatePolicyDefinition model module.
 * @module model/UpdatePolicyDefinition
 * @version 2021-12-01
 */
class UpdatePolicyDefinition {
    /**
     * Constructs a new <code>UpdatePolicyDefinition</code>.
     ...
     * @alias module:model/UpdatePolicyDefinition
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>UpdatePolicyDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyDefinition} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyDefinition} The populated <code>UpdatePolicyDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyDefinition</code>.
     */
...
export default UpdatePolicyDefinition;
