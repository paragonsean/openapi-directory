...
/**
 * The GetSchemaInput model module.
 * @module model/GetSchemaInput
 * @version 2021-12-01
 */
class GetSchemaInput {
    /**
     * Constructs a new <code>GetSchemaInput</code>.
     * @alias module:model/GetSchemaInput
     * @param policyStoreId {String} 
     */
    constructor(policyStoreId) { 
        
        GetSchemaInput.initialize(this, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>GetSchemaInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetSchemaInput} obj Optional instance to populate.
     * @return {module:model/GetSchemaInput} The populated <code>GetSchemaInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetSchemaInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetSchemaInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetSchemaInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetSchemaInput.RequiredProperties) {
...
GetSchemaInput.RequiredProperties = ["policyStoreId"];

/**
 * @member {String} policyStoreId
 */
GetSchemaInput.prototype['policyStoreId'] = undefined;
