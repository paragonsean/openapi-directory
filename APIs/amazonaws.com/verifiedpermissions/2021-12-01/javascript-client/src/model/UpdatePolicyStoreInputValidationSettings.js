...
/**
 * The UpdatePolicyStoreInputValidationSettings model module.
 * @module model/UpdatePolicyStoreInputValidationSettings
 * @version 2021-12-01
 */
class UpdatePolicyStoreInputValidationSettings {
    /**
     * Constructs a new <code>UpdatePolicyStoreInputValidationSettings</code>.
     * @alias module:model/UpdatePolicyStoreInputValidationSettings
     * @implements module:model/ValidationSettings
     * @param mode {module:model/ValidationMode} 
     */
    constructor(mode) { 
        ValidationSettings.initialize(this, mode);
        UpdatePolicyStoreInputValidationSettings.initialize(this, mode);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyStoreInputValidationSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyStoreInputValidationSettings} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyStoreInputValidationSettings} The populated <code>UpdatePolicyStoreInputValidationSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyStoreInputValidationSettings();
            ValidationSettings.constructFromObject(data, obj);

            if (data.hasOwnProperty('mode')) {
                obj['mode'] = ApiClient.convertToType(data['mode'], ValidationMode);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyStoreInputValidationSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyStoreInputValidationSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyStoreInputValidationSettings.RequiredProperties) {
        ...
        if (data['mode']) { // data not null
          ValidationMode.validateJSON(data['mode']);
        }
...
UpdatePolicyStoreInputValidationSettings.RequiredProperties = ["mode"];

/**
 * @member {module:model/ValidationMode} mode
 */
UpdatePolicyStoreInputValidationSettings.prototype['mode'] = undefined;


// Implement ValidationSettings interface:
/**
 * @member {module:model/ValidationMode} mode
 */
ValidationSettings.prototype['mode'] = undefined;




export default UpdatePolicyStoreInputValidationSettings;
