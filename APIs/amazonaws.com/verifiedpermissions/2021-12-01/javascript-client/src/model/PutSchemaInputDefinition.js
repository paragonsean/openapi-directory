...
/**
 * The PutSchemaInputDefinition model module.
 * @module model/PutSchemaInputDefinition
 * @version 2021-12-01
 */
class PutSchemaInputDefinition {
    /**
     * Constructs a new <code>PutSchemaInputDefinition</code>.
     * @alias module:model/PutSchemaInputDefinition
     * @implements module:model/SchemaDefinition
     */
    constructor() { 
        SchemaDefinition.initialize(this);
        PutSchemaInputDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PutSchemaInputDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutSchemaInputDefinition} obj Optional instance to populate.
     * @return {module:model/PutSchemaInputDefinition} The populated <code>PutSchemaInputDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutSchemaInputDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>PutSchemaInputDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutSchemaInputDefinition</code>.
     */
 ...
 */
PutSchemaInputDefinition.prototype['cedarJson'] = undefined;
...
export default PutSchemaInputDefinition;
