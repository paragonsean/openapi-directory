...
/**
 * The IdentitySourceDetails model module.
 * @module model/IdentitySourceDetails
 * @version 2021-12-01
 */
class IdentitySourceDetails {
    /**
     * Constructs a new <code>IdentitySourceDetails</code>.
     ...
     * @alias module:model/IdentitySourceDetails
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>IdentitySourceDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentitySourceDetails} obj Optional instance to populate.
     * @return {module:model/IdentitySourceDetails} The populated <code>IdentitySourceDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentitySourceDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>IdentitySourceDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentitySourceDetails</code>.
     */
...
export default IdentitySourceDetails;
