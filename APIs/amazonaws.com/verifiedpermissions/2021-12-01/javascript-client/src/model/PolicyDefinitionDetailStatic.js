...
import StaticPolicyDefinitionDetail from './StaticPolicyDefinitionDetail';

/**
 * The PolicyDefinitionDetailStatic model module.
 * @module model/PolicyDefinitionDetailStatic
 * @version 2021-12-01
 */
class PolicyDefinitionDetailStatic {
    /**
     * Constructs a new <code>PolicyDefinitionDetailStatic</code>.
     * @alias module:model/PolicyDefinitionDetailStatic
     * @implements module:model/StaticPolicyDefinitionDetail
     * @param statement {String} 
     */
    constructor(statement) { 
        StaticPolicyDefinitionDetail.initialize(this, statement);
        PolicyDefinitionDetailStatic.initialize(this, statement);
    }
    ...
    /**
     * Constructs a <code>PolicyDefinitionDetailStatic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyDefinitionDetailStatic} obj Optional instance to populate.
     * @return {module:model/PolicyDefinitionDetailStatic} The populated <code>PolicyDefinitionDetailStatic</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyDefinitionDetailStatic();
            StaticPolicyDefinitionDetail.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyDefinitionDetailStatic</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyDefinitionDetailStatic</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyDefinitionDetailStatic.RequiredProperties) {
...
PolicyDefinitionDetailStatic.RequiredProperties = ["statement"];

/**
 * @member {String} description
 */
PolicyDefinitionDetailStatic.prototype['description'] = undefined;

/**
 * @member {String} statement
 */
PolicyDefinitionDetailStatic.prototype['statement'] = undefined;


// Implement StaticPolicyDefinitionDetail interface:
/**
 * @member {String} description
 */
StaticPolicyDefinitionDetail.prototype['description'] = undefined;
/**
 * @member {String} statement
 */
StaticPolicyDefinitionDetail.prototype['statement'] = undefined;




export default PolicyDefinitionDetailStatic;
