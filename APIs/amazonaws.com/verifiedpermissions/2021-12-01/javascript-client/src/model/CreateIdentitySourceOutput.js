...
/**
 * The CreateIdentitySourceOutput model module.
 * @module model/CreateIdentitySourceOutput
 * @version 2021-12-01
 */
class CreateIdentitySourceOutput {
    /**
     * Constructs a new <code>CreateIdentitySourceOutput</code>.
     * @alias module:model/CreateIdentitySourceOutput
     * @param createdDate {Date} 
     * @param identitySourceId {String} 
     * @param lastUpdatedDate {Date} 
     * @param policyStoreId {String} 
     */
    constructor(createdDate, identitySourceId, lastUpdatedDate, policyStoreId) { 
        
        CreateIdentitySourceOutput.initialize(this, createdDate, identitySourceId, lastUpdatedDate, policyStoreId);
    }
     ...
     */
    static initialize(obj, createdDate, identitySourceId, lastUpdatedDate, policyStoreId) { 
    ...
    /**
     * Constructs a <code>CreateIdentitySourceOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentitySourceOutput} obj Optional instance to populate.
     * @return {module:model/CreateIdentitySourceOutput} The populated <code>CreateIdentitySourceOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentitySourceOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentitySourceOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentitySourceOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateIdentitySourceOutput.RequiredProperties) {
...
CreateIdentitySourceOutput.RequiredProperties = ["createdDate", "identitySourceId", "lastUpdatedDate", "policyStoreId"];

/**
 * @member {Date} createdDate
 */
CreateIdentitySourceOutput.prototype['createdDate'] = undefined;

/**
 * @member {String} identitySourceId
 */
CreateIdentitySourceOutput.prototype['identitySourceId'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
CreateIdentitySourceOutput.prototype['lastUpdatedDate'] = undefined;

/**
 * @member {String} policyStoreId
 */
CreateIdentitySourceOutput.prototype['policyStoreId'] = undefined;
...
export default CreateIdentitySourceOutput;
