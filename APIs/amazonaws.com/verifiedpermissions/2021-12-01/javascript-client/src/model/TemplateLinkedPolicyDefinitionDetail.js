...
/**
 * The TemplateLinkedPolicyDefinitionDetail model module.
 * @module model/TemplateLinkedPolicyDefinitionDetail
 * @version 2021-12-01
 */
class TemplateLinkedPolicyDefinitionDetail {
    /**
     * Constructs a new <code>TemplateLinkedPolicyDefinitionDetail</code>.
     * &lt;p&gt;Contains information about a policy that was &lt;/p&gt; &lt;p/&gt; &lt;p&gt;created by instantiating a policy template. &lt;/p&gt; &lt;p&gt;This &lt;/p&gt;
     * @alias module:model/TemplateLinkedPolicyDefinitionDetail
    ...
    /**
     * Constructs a <code>TemplateLinkedPolicyDefinitionDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateLinkedPolicyDefinitionDetail} obj Optional instance to populate.
     * @return {module:model/TemplateLinkedPolicyDefinitionDetail} The populated <code>TemplateLinkedPolicyDefinitionDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateLinkedPolicyDefinitionDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateLinkedPolicyDefinitionDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateLinkedPolicyDefinitionDetail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateLinkedPolicyDefinitionDetail.RequiredProperties) {
...
TemplateLinkedPolicyDefinitionDetail.RequiredProperties = ["policyTemplateId"];
...
export default TemplateLinkedPolicyDefinitionDetail;
