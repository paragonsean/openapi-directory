...
/**
 * The IsAuthorizedWithTokenInputAction model module.
 * @module model/IsAuthorizedWithTokenInputAction
 * @version 2021-12-01
 */
class IsAuthorizedWithTokenInputAction {
    /**
     * Constructs a new <code>IsAuthorizedWithTokenInputAction</code>.
     * @alias module:model/IsAuthorizedWithTokenInputAction
    ...
    constructor(actionType, actionId) { 
        ...
        IsAuthorizedWithTokenInputAction.initialize(this, actionType, actionId);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedWithTokenInputAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedWithTokenInputAction} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedWithTokenInputAction} The populated <code>IsAuthorizedWithTokenInputAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedWithTokenInputAction();
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedWithTokenInputAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedWithTokenInputAction</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedWithTokenInputAction.RequiredProperties) {
...
IsAuthorizedWithTokenInputAction.RequiredProperties = ["actionType", "actionId"];

/**
 * @member {String} actionType
 */
IsAuthorizedWithTokenInputAction.prototype['actionType'] = undefined;

/**
 * @member {String} actionId
 */
IsAuthorizedWithTokenInputAction.prototype['actionId'] = undefined;
...
export default IsAuthorizedWithTokenInputAction;
