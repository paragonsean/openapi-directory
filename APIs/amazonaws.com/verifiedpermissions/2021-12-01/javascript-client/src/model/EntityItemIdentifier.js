...
/**
 * The EntityItemIdentifier model module.
 * @module model/EntityItemIdentifier
 * @version 2021-12-01
 */
class EntityItemIdentifier {
    /**
     * Constructs a new <code>EntityItemIdentifier</code>.
     * @alias module:model/EntityItemIdentifier
    ...
    constructor(entityType, entityId) { 
        ...
        EntityItemIdentifier.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>EntityItemIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntityItemIdentifier} obj Optional instance to populate.
     * @return {module:model/EntityItemIdentifier} The populated <code>EntityItemIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntityItemIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>EntityItemIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityItemIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EntityItemIdentifier.RequiredProperties) {
...
EntityItemIdentifier.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
EntityItemIdentifier.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
EntityItemIdentifier.prototype['entityId'] = undefined;
...
export default EntityItemIdentifier;
