...
/**
 * The DeletePolicyTemplateInput model module.
 * @module model/DeletePolicyTemplateInput
 * @version 2021-12-01
 */
class DeletePolicyTemplateInput {
    /**
     * Constructs a new <code>DeletePolicyTemplateInput</code>.
     * @alias module:model/DeletePolicyTemplateInput
     * @param policyStoreId {String} 
     * @param policyTemplateId {String} 
     */
    constructor(policyStoreId, policyTemplateId) { 
        
        DeletePolicyTemplateInput.initialize(this, policyStoreId, policyTemplateId);
    }
    ...
    /**
     * Constructs a <code>DeletePolicyTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePolicyTemplateInput} obj Optional instance to populate.
     * @return {module:model/DeletePolicyTemplateInput} The populated <code>DeletePolicyTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePolicyTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePolicyTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePolicyTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePolicyTemplateInput.RequiredProperties) {
...
DeletePolicyTemplateInput.RequiredProperties = ["policyStoreId", "policyTemplateId"];

/**
 * @member {String} policyStoreId
 */
DeletePolicyTemplateInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyTemplateId
 */
DeletePolicyTemplateInput.prototype['policyTemplateId'] = undefined;
...
export default DeletePolicyTemplateInput;
