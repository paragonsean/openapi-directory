...
/**
 * The UpdateStaticPolicyDefinition model module.
 * @module model/UpdateStaticPolicyDefinition
 * @version 2021-12-01
 */
class UpdateStaticPolicyDefinition {
    /**
     * Constructs a new <code>UpdateStaticPolicyDefinition</code>.
     * Contains information about an update to a static policy.
     * @alias module:model/UpdateStaticPolicyDefinition
     * @param statement {String} 
     */
    constructor(statement) { 
        
        UpdateStaticPolicyDefinition.initialize(this, statement);
    }
    ...
    /**
     * Constructs a <code>UpdateStaticPolicyDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateStaticPolicyDefinition} obj Optional instance to populate.
     * @return {module:model/UpdateStaticPolicyDefinition} The populated <code>UpdateStaticPolicyDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateStaticPolicyDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateStaticPolicyDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateStaticPolicyDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateStaticPolicyDefinition.RequiredProperties) {
...
UpdateStaticPolicyDefinition.RequiredProperties = ["statement"];

/**
 * @member {String} description
 */
UpdateStaticPolicyDefinition.prototype['description'] = undefined;

/**
 * @member {String} statement
 */
UpdateStaticPolicyDefinition.prototype['statement'] = undefined;
...
export default UpdateStaticPolicyDefinition;
