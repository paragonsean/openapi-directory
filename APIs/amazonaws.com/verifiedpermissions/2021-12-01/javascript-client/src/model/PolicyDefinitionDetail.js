...
import PolicyDefinitionDetailStatic from './PolicyDefinitionDetailStatic';
import PolicyDefinitionDetailTemplateLinked from './PolicyDefinitionDetailTemplateLinked';

/**
 * The PolicyDefinitionDetail model module.
 * @module model/PolicyDefinitionDetail
 * @version 2021-12-01
 */
class PolicyDefinitionDetail {
    /**
     * Constructs a new <code>PolicyDefinitionDetail</code>.
     ...
     * @alias module:model/PolicyDefinitionDetail
     */
    constructor() { 
        
        PolicyDefinitionDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyDefinitionDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyDefinitionDetail} obj Optional instance to populate.
     * @return {module:model/PolicyDefinitionDetail} The populated <code>PolicyDefinitionDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyDefinitionDetail();

            if (data.hasOwnProperty('static')) {
                obj['static'] = PolicyDefinitionDetailStatic.constructFromObject(data['static']);
            }
            if (data.hasOwnProperty('templateLinked')) {
                obj['templateLinked'] = PolicyDefinitionDetailTemplateLinked.constructFromObject(data['templateLinked']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyDefinitionDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyDefinitionDetail</code>.
     */
    static validateJSON(data) {
        // validate the optional field `static`
        if (data['static']) { // data not null
          PolicyDefinitionDetailStatic.validateJSON(data['static']);
        }
        // validate the optional field `templateLinked`
        if (data['templateLinked']) { // data not null
          PolicyDefinitionDetailTemplateLinked.validateJSON(data['templateLinked']);
        }
...
/**
 * @member {module:model/PolicyDefinitionDetailStatic} static
 */
PolicyDefinitionDetail.prototype['static'] = undefined;

/**
 * @member {module:model/PolicyDefinitionDetailTemplateLinked} templateLinked
 */
PolicyDefinitionDetail.prototype['templateLinked'] = undefined;
...
export default PolicyDefinitionDetail;
