...
/**
 * The IsAuthorizedInputPrincipal model module.
 * @module model/IsAuthorizedInputPrincipal
 * @version 2021-12-01
 */
class IsAuthorizedInputPrincipal {
    /**
     * Constructs a new <code>IsAuthorizedInputPrincipal</code>.
     * @alias module:model/IsAuthorizedInputPrincipal
    ...
    constructor(entityType, entityId) { 
        ...
        IsAuthorizedInputPrincipal.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedInputPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedInputPrincipal} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedInputPrincipal} The populated <code>IsAuthorizedInputPrincipal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedInputPrincipal();
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedInputPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedInputPrincipal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedInputPrincipal.RequiredProperties) {
...
IsAuthorizedInputPrincipal.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
IsAuthorizedInputPrincipal.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
IsAuthorizedInputPrincipal.prototype['entityId'] = undefined;
...
export default IsAuthorizedInputPrincipal;
