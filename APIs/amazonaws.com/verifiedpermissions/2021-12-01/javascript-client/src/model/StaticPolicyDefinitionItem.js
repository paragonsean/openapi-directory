...
/**
 * The StaticPolicyDefinitionItem model module.
 * @module model/StaticPolicyDefinitionItem
 * @version 2021-12-01
 */
class StaticPolicyDefinitionItem {
    /**
     * Constructs a new <code>StaticPolicyDefinitionItem</code>.
     ...
     * @alias module:model/StaticPolicyDefinitionItem
     */
    constructor() { 
        
        StaticPolicyDefinitionItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StaticPolicyDefinitionItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaticPolicyDefinitionItem} obj Optional instance to populate.
     * @return {module:model/StaticPolicyDefinitionItem} The populated <code>StaticPolicyDefinitionItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaticPolicyDefinitionItem();
    ...
    /**
     * Validates the JSON data with respect to <code>StaticPolicyDefinitionItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaticPolicyDefinitionItem</code>.
     */
 ...
 */
StaticPolicyDefinitionItem.prototype['description'] = undefined;
...
export default StaticPolicyDefinitionItem;
