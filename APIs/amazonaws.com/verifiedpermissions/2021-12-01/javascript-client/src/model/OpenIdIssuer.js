...
* @readonly
*/
export default class OpenIdIssuer {
    ...
    /**
    * Returns a <code>OpenIdIssuer</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/OpenIdIssuer} The enum <code>OpenIdIssuer</code> value.
    */
