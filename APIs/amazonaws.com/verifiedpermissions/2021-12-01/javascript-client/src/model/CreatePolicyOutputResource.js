...
/**
 * The CreatePolicyOutputResource model module.
 * @module model/CreatePolicyOutputResource
 * @version 2021-12-01
 */
class CreatePolicyOutputResource {
    /**
     * Constructs a new <code>CreatePolicyOutputResource</code>.
     * @alias module:model/CreatePolicyOutputResource
    ...
    constructor(entityType, entityId) { 
        ...
        CreatePolicyOutputResource.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyOutputResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyOutputResource} obj Optional instance to populate.
     * @return {module:model/CreatePolicyOutputResource} The populated <code>CreatePolicyOutputResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyOutputResource();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyOutputResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyOutputResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyOutputResource.RequiredProperties) {
...
CreatePolicyOutputResource.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
CreatePolicyOutputResource.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
CreatePolicyOutputResource.prototype['entityId'] = undefined;
...
export default CreatePolicyOutputResource;
