...
/**
 * The GetPolicyOutputResource model module.
 * @module model/GetPolicyOutputResource
 * @version 2021-12-01
 */
class GetPolicyOutputResource {
    /**
     * Constructs a new <code>GetPolicyOutputResource</code>.
     * @alias module:model/GetPolicyOutputResource
    ...
    constructor(entityType, entityId) { 
        ...
        GetPolicyOutputResource.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>GetPolicyOutputResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyOutputResource} obj Optional instance to populate.
     * @return {module:model/GetPolicyOutputResource} The populated <code>GetPolicyOutputResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyOutputResource();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyOutputResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyOutputResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyOutputResource.RequiredProperties) {
...
GetPolicyOutputResource.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
GetPolicyOutputResource.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
GetPolicyOutputResource.prototype['entityId'] = undefined;
...
export default GetPolicyOutputResource;
