...
/**
 * The TemplateLinkedPolicyDefinition model module.
 * @module model/TemplateLinkedPolicyDefinition
 * @version 2021-12-01
 */
class TemplateLinkedPolicyDefinition {
    /**
     * Constructs a new <code>TemplateLinkedPolicyDefinition</code>.
     * Contains information about a policy created by instantiating a policy template.
     * @alias module:model/TemplateLinkedPolicyDefinition
    ...
    /**
     * Constructs a <code>TemplateLinkedPolicyDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateLinkedPolicyDefinition} obj Optional instance to populate.
     * @return {module:model/TemplateLinkedPolicyDefinition} The populated <code>TemplateLinkedPolicyDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateLinkedPolicyDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateLinkedPolicyDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateLinkedPolicyDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateLinkedPolicyDefinition.RequiredProperties) {
...
TemplateLinkedPolicyDefinition.RequiredProperties = ["policyTemplateId"];
...
export default TemplateLinkedPolicyDefinition;
