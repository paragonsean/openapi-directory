...
import TemplateLinkedPolicyDefinitionItem from './TemplateLinkedPolicyDefinitionItem';
...
/**
 * The PolicyDefinitionItemTemplateLinked model module.
 * @module model/PolicyDefinitionItemTemplateLinked
 * @version 2021-12-01
 */
class PolicyDefinitionItemTemplateLinked {
    /**
     * Constructs a new <code>PolicyDefinitionItemTemplateLinked</code>.
     * @alias module:model/PolicyDefinitionItemTemplateLinked
     * @implements module:model/TemplateLinkedPolicyDefinitionItem
     * @param policyTemplateId {String} 
     */
    constructor(policyTemplateId) { 
        TemplateLinkedPolicyDefinitionItem.initialize(this, policyTemplateId);
        PolicyDefinitionItemTemplateLinked.initialize(this, policyTemplateId);
    }
    ...
    /**
     * Constructs a <code>PolicyDefinitionItemTemplateLinked</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyDefinitionItemTemplateLinked} obj Optional instance to populate.
     * @return {module:model/PolicyDefinitionItemTemplateLinked} The populated <code>PolicyDefinitionItemTemplateLinked</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyDefinitionItemTemplateLinked();
            TemplateLinkedPolicyDefinitionItem.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyDefinitionItemTemplateLinked</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyDefinitionItemTemplateLinked</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyDefinitionItemTemplateLinked.RequiredProperties) {
...
PolicyDefinitionItemTemplateLinked.RequiredProperties = ["policyTemplateId"];

/**
 * @member {String} policyTemplateId
 */
PolicyDefinitionItemTemplateLinked.prototype['policyTemplateId'] = undefined;

/**
 * @member {module:model/TemplateLinkedPolicyDefinitionPrincipal} principal
 */
PolicyDefinitionItemTemplateLinked.prototype['principal'] = undefined;

/**
 * @member {module:model/TemplateLinkedPolicyDefinitionResource} resource
 */
PolicyDefinitionItemTemplateLinked.prototype['resource'] = undefined;


// Implement TemplateLinkedPolicyDefinitionItem interface:
/**
 * @member {String} policyTemplateId
 */
TemplateLinkedPolicyDefinitionItem.prototype['policyTemplateId'] = undefined;
/**
 * @member {module:model/TemplateLinkedPolicyDefinitionPrincipal} principal
 */
TemplateLinkedPolicyDefinitionItem.prototype['principal'] = undefined;
/**
 * @member {module:model/TemplateLinkedPolicyDefinitionResource} resource
 */
TemplateLinkedPolicyDefinitionItem.prototype['resource'] = undefined;




export default PolicyDefinitionItemTemplateLinked;
