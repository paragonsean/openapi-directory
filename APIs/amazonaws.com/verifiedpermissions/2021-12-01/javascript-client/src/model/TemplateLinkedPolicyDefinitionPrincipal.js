...
/**
 * The TemplateLinkedPolicyDefinitionPrincipal model module.
 * @module model/TemplateLinkedPolicyDefinitionPrincipal
 * @version 2021-12-01
 */
class TemplateLinkedPolicyDefinitionPrincipal {
    /**
     * Constructs a new <code>TemplateLinkedPolicyDefinitionPrincipal</code>.
     * @alias module:model/TemplateLinkedPolicyDefinitionPrincipal
    ...
    constructor(entityType, entityId) { 
        ...
        TemplateLinkedPolicyDefinitionPrincipal.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>TemplateLinkedPolicyDefinitionPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateLinkedPolicyDefinitionPrincipal} obj Optional instance to populate.
     * @return {module:model/TemplateLinkedPolicyDefinitionPrincipal} The populated <code>TemplateLinkedPolicyDefinitionPrincipal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateLinkedPolicyDefinitionPrincipal();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateLinkedPolicyDefinitionPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateLinkedPolicyDefinitionPrincipal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateLinkedPolicyDefinitionPrincipal.RequiredProperties) {
...
TemplateLinkedPolicyDefinitionPrincipal.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
TemplateLinkedPolicyDefinitionPrincipal.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
TemplateLinkedPolicyDefinitionPrincipal.prototype['entityId'] = undefined;
...
export default TemplateLinkedPolicyDefinitionPrincipal;
