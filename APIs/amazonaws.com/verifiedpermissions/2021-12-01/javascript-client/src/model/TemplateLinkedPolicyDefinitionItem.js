...
/**
 * The TemplateLinkedPolicyDefinitionItem model module.
 * @module model/TemplateLinkedPolicyDefinitionItem
 * @version 2021-12-01
 */
class TemplateLinkedPolicyDefinitionItem {
    /**
     * Constructs a new <code>TemplateLinkedPolicyDefinitionItem</code>.
     * &lt;p&gt;Contains information about a policy created by instantiating a policy template. &lt;/p&gt; &lt;p&gt;This &lt;/p&gt;
     * @alias module:model/TemplateLinkedPolicyDefinitionItem
    ...
    /**
     * Constructs a <code>TemplateLinkedPolicyDefinitionItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateLinkedPolicyDefinitionItem} obj Optional instance to populate.
     * @return {module:model/TemplateLinkedPolicyDefinitionItem} The populated <code>TemplateLinkedPolicyDefinitionItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateLinkedPolicyDefinitionItem();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateLinkedPolicyDefinitionItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateLinkedPolicyDefinitionItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateLinkedPolicyDefinitionItem.RequiredProperties) {
...
TemplateLinkedPolicyDefinitionItem.RequiredProperties = ["policyTemplateId"];
...
export default TemplateLinkedPolicyDefinitionItem;
