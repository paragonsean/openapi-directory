...
/**
 * The GetPolicyInput model module.
 * @module model/GetPolicyInput
 * @version 2021-12-01
 */
class GetPolicyInput {
    /**
     * Constructs a new <code>GetPolicyInput</code>.
     * @alias module:model/GetPolicyInput
     * @param policyStoreId {String} 
     * @param policyId {String} 
     */
    constructor(policyStoreId, policyId) { 
        
        GetPolicyInput.initialize(this, policyStoreId, policyId);
    }
    ...
    /**
     * Constructs a <code>GetPolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyInput} obj Optional instance to populate.
     * @return {module:model/GetPolicyInput} The populated <code>GetPolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyInput.RequiredProperties) {
...
GetPolicyInput.RequiredProperties = ["policyStoreId", "policyId"];

/**
 * @member {String} policyStoreId
 */
GetPolicyInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyId
 */
GetPolicyInput.prototype['policyId'] = undefined;
