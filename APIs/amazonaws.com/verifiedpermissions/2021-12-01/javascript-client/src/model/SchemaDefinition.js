...
class SchemaDefinition {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('cedarJson')) {
                obj['cedarJson'] = ApiClient.convertToType(data['cedarJson'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['cedarJson']) { // data not null
          String.validateJSON(data['cedarJson']);
        }
...
/**
 * @member {String} cedarJson
 */
SchemaDefinition.prototype['cedarJson'] = undefined;
