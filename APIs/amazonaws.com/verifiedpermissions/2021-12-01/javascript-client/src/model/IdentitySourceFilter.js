...
/**
 * The IdentitySourceFilter model module.
 * @module model/IdentitySourceFilter
 * @version 2021-12-01
 */
class IdentitySourceFilter {
    /**
     * Constructs a new <code>IdentitySourceFilter</code>.
     ...
     * @alias module:model/IdentitySourceFilter
     */
    constructor() { 
        
        IdentitySourceFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IdentitySourceFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentitySourceFilter} obj Optional instance to populate.
     * @return {module:model/IdentitySourceFilter} The populated <code>IdentitySourceFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentitySourceFilter();

            if (data.hasOwnProperty('principalEntityType')) {
                obj['principalEntityType'] = ApiClient.convertToType(data['principalEntityType'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IdentitySourceFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentitySourceFilter</code>.
     */
    static validateJSON(data) {
        // validate the optional field `principalEntityType`
        if (data['principalEntityType']) { // data not null
          String.validateJSON(data['principalEntityType']);
        }
...
/**
 * @member {String} principalEntityType
 */
IdentitySourceFilter.prototype['principalEntityType'] = undefined;
...
export default IdentitySourceFilter;
