...
/**
 * The IsAuthorizedWithTokenInputResource model module.
 * @module model/IsAuthorizedWithTokenInputResource
 * @version 2021-12-01
 */
class IsAuthorizedWithTokenInputResource {
    /**
     * Constructs a new <code>IsAuthorizedWithTokenInputResource</code>.
     * @alias module:model/IsAuthorizedWithTokenInputResource
    ...
    constructor(entityType, entityId) { 
        ...
        IsAuthorizedWithTokenInputResource.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedWithTokenInputResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedWithTokenInputResource} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedWithTokenInputResource} The populated <code>IsAuthorizedWithTokenInputResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedWithTokenInputResource();
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedWithTokenInputResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedWithTokenInputResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedWithTokenInputResource.RequiredProperties) {
...
IsAuthorizedWithTokenInputResource.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
IsAuthorizedWithTokenInputResource.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
IsAuthorizedWithTokenInputResource.prototype['entityId'] = undefined;
...
export default IsAuthorizedWithTokenInputResource;
