...
import CreateIdentitySourceInputConfiguration from './CreateIdentitySourceInputConfiguration';

/**
 * The CreateIdentitySourceInput model module.
 * @module model/CreateIdentitySourceInput
 * @version 2021-12-01
 */
class CreateIdentitySourceInput {
    /**
     * Constructs a new <code>CreateIdentitySourceInput</code>.
     * @alias module:model/CreateIdentitySourceInput
     * @param policyStoreId {String} 
     * @param configuration {module:model/CreateIdentitySourceInputConfiguration} 
     */
    constructor(policyStoreId, configuration) { 
        
        CreateIdentitySourceInput.initialize(this, policyStoreId, configuration);
    }
     ...
     */
    static initialize(obj, policyStoreId, configuration) { 
        obj['policyStoreId'] = policyStoreId;
        obj['configuration'] = configuration;
    }

    /**
     * Constructs a <code>CreateIdentitySourceInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateIdentitySourceInput} obj Optional instance to populate.
     * @return {module:model/CreateIdentitySourceInput} The populated <code>CreateIdentitySourceInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateIdentitySourceInput();
            ...
            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = CreateIdentitySourceInputConfiguration.constructFromObject(data['configuration']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateIdentitySourceInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateIdentitySourceInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateIdentitySourceInput.RequiredProperties) {
        ...
        if (data['configuration']) { // data not null
          CreateIdentitySourceInputConfiguration.validateJSON(data['configuration']);
        }
...
CreateIdentitySourceInput.RequiredProperties = ["policyStoreId", "configuration"];

/**
 * @member {String} clientToken
 */
CreateIdentitySourceInput.prototype['clientToken'] = undefined;

/**
 * @member {String} policyStoreId
 */
CreateIdentitySourceInput.prototype['policyStoreId'] = undefined;

/**
 * @member {module:model/CreateIdentitySourceInputConfiguration} configuration
 */
CreateIdentitySourceInput.prototype['configuration'] = undefined;

/**
 * @member {String} principalEntityType
 */
CreateIdentitySourceInput.prototype['principalEntityType'] = undefined;
...
export default CreateIdentitySourceInput;
