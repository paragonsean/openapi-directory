...
/**
 * The UpdateIdentitySourceOutput model module.
 * @module model/UpdateIdentitySourceOutput
 * @version 2021-12-01
 */
class UpdateIdentitySourceOutput {
    /**
     * Constructs a new <code>UpdateIdentitySourceOutput</code>.
     * @alias module:model/UpdateIdentitySourceOutput
    ...
    constructor(createdDate, identitySourceId, lastUpdatedDate, policyStoreId) { 
        ...
        UpdateIdentitySourceOutput.initialize(this, createdDate, identitySourceId, lastUpdatedDate, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>UpdateIdentitySourceOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateIdentitySourceOutput} obj Optional instance to populate.
     * @return {module:model/UpdateIdentitySourceOutput} The populated <code>UpdateIdentitySourceOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateIdentitySourceOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdateIdentitySourceOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdateIdentitySourceOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdateIdentitySourceOutput.RequiredProperties) {
...
UpdateIdentitySourceOutput.RequiredProperties = ["createdDate", "identitySourceId", "lastUpdatedDate", "policyStoreId"];

/**
 * @member {Date} createdDate
 */
UpdateIdentitySourceOutput.prototype['createdDate'] = undefined;

/**
 * @member {String} identitySourceId
 */
UpdateIdentitySourceOutput.prototype['identitySourceId'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
UpdateIdentitySourceOutput.prototype['lastUpdatedDate'] = undefined;

/**
 * @member {String} policyStoreId
 */
UpdateIdentitySourceOutput.prototype['policyStoreId'] = undefined;
...
export default UpdateIdentitySourceOutput;
