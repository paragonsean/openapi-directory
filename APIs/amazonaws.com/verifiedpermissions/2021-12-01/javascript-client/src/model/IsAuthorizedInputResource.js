...
/**
 * The IsAuthorizedInputResource model module.
 * @module model/IsAuthorizedInputResource
 * @version 2021-12-01
 */
class IsAuthorizedInputResource {
    /**
     * Constructs a new <code>IsAuthorizedInputResource</code>.
     * @alias module:model/IsAuthorizedInputResource
    ...
    constructor(entityType, entityId) { 
        ...
        IsAuthorizedInputResource.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedInputResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedInputResource} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedInputResource} The populated <code>IsAuthorizedInputResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedInputResource();
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedInputResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedInputResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedInputResource.RequiredProperties) {
...
IsAuthorizedInputResource.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
IsAuthorizedInputResource.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
IsAuthorizedInputResource.prototype['entityId'] = undefined;
...
export default IsAuthorizedInputResource;
