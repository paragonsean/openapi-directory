...
/**
 * The TemplateLinkedPolicyDefinitionResource model module.
 * @module model/TemplateLinkedPolicyDefinitionResource
 * @version 2021-12-01
 */
class TemplateLinkedPolicyDefinitionResource {
    /**
     * Constructs a new <code>TemplateLinkedPolicyDefinitionResource</code>.
     * @alias module:model/TemplateLinkedPolicyDefinitionResource
    ...
    constructor(entityType, entityId) { 
        ...
        TemplateLinkedPolicyDefinitionResource.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>TemplateLinkedPolicyDefinitionResource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateLinkedPolicyDefinitionResource} obj Optional instance to populate.
     * @return {module:model/TemplateLinkedPolicyDefinitionResource} The populated <code>TemplateLinkedPolicyDefinitionResource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateLinkedPolicyDefinitionResource();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateLinkedPolicyDefinitionResource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateLinkedPolicyDefinitionResource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TemplateLinkedPolicyDefinitionResource.RequiredProperties) {
...
TemplateLinkedPolicyDefinitionResource.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
TemplateLinkedPolicyDefinitionResource.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
TemplateLinkedPolicyDefinitionResource.prototype['entityId'] = undefined;
...
export default TemplateLinkedPolicyDefinitionResource;
