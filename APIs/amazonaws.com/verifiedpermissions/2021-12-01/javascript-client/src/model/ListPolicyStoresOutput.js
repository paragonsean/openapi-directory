...
/**
 * The ListPolicyStoresOutput model module.
 * @module model/ListPolicyStoresOutput
 * @version 2021-12-01
 */
class ListPolicyStoresOutput {
    /**
     * Constructs a new <code>ListPolicyStoresOutput</code>.
     * @alias module:model/ListPolicyStoresOutput
     * @param policyStores {Array} 
     */
    constructor(policyStores) { 
        
        ListPolicyStoresOutput.initialize(this, policyStores);
    }
     ...
     */
    static initialize(obj, policyStores) { 
        obj['policyStores'] = policyStores;
    }

    /**
     * Constructs a <code>ListPolicyStoresOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPolicyStoresOutput} obj Optional instance to populate.
     * @return {module:model/ListPolicyStoresOutput} The populated <code>ListPolicyStoresOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPolicyStoresOutput();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('policyStores')) {
                obj['policyStores'] = ApiClient.convertToType(data['policyStores'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPolicyStoresOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPolicyStoresOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPolicyStoresOutput.RequiredProperties) {
        ...
        // validate the optional field `policyStores`
        if (data['policyStores']) { // data not null
          Array.validateJSON(data['policyStores']);
        }
...
ListPolicyStoresOutput.RequiredProperties = ["policyStores"];

/**
 * @member {String} nextToken
 */
ListPolicyStoresOutput.prototype['nextToken'] = undefined;

/**
 * @member {Array} policyStores
 */
ListPolicyStoresOutput.prototype['policyStores'] = undefined;
...
export default ListPolicyStoresOutput;
