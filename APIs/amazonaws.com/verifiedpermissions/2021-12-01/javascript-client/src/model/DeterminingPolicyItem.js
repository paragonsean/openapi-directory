...
/**
 * The DeterminingPolicyItem model module.
 * @module model/DeterminingPolicyItem
 * @version 2021-12-01
 */
class DeterminingPolicyItem {
    /**
     * Constructs a new <code>DeterminingPolicyItem</code>.
     ...
     * @alias module:model/DeterminingPolicyItem
     * @param policyId {String} 
     */
    constructor(policyId) { 
        
        DeterminingPolicyItem.initialize(this, policyId);
    }
    ...
    /**
     * Constructs a <code>DeterminingPolicyItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeterminingPolicyItem} obj Optional instance to populate.
     * @return {module:model/DeterminingPolicyItem} The populated <code>DeterminingPolicyItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeterminingPolicyItem();
    ...
    /**
     * Validates the JSON data with respect to <code>DeterminingPolicyItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeterminingPolicyItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeterminingPolicyItem.RequiredProperties) {
...
DeterminingPolicyItem.RequiredProperties = ["policyId"];

/**
 * @member {String} policyId
 */
DeterminingPolicyItem.prototype['policyId'] = undefined;
...
export default DeterminingPolicyItem;
