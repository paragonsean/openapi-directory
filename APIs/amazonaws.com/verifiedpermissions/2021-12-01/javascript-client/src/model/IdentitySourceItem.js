...
/**
 * The IdentitySourceItem model module.
 * @module model/IdentitySourceItem
 * @version 2021-12-01
 */
class IdentitySourceItem {
    /**
     * Constructs a new <code>IdentitySourceItem</code>.
     ...
     * @alias module:model/IdentitySourceItem
     * @param createdDate {Date} 
     * @param details {module:model/IdentitySourceItemDetails} 
     * @param identitySourceId {String} 
     * @param lastUpdatedDate {Date} 
     * @param policyStoreId {String} 
     * @param principalEntityType {String} 
     */
    constructor(createdDate, details, identitySourceId, lastUpdatedDate, policyStoreId, principalEntityType) { 
        
        IdentitySourceItem.initialize(this, createdDate, details, identitySourceId, lastUpdatedDate, policyStoreId, principalEntityType);
    }
     ...
     */
    static initialize(obj, createdDate, details, identitySourceId, lastUpdatedDate, policyStoreId, principalEntityType) { 
        obj['createdDate'] = createdDate;
        obj['details'] = details;
        obj['identitySourceId'] = identitySourceId;
        obj['lastUpdatedDate'] = lastUpdatedDate;
        obj['policyStoreId'] = policyStoreId;
        obj['principalEntityType'] = principalEntityType;
    }

    /**
     * Constructs a <code>IdentitySourceItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IdentitySourceItem} obj Optional instance to populate.
     * @return {module:model/IdentitySourceItem} The populated <code>IdentitySourceItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IdentitySourceItem();

            if (data.hasOwnProperty('createdDate')) {
                obj['createdDate'] = ApiClient.convertToType(data['createdDate'], 'Date');
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = IdentitySourceItemDetails.constructFromObject(data['details']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IdentitySourceItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IdentitySourceItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IdentitySourceItem.RequiredProperties) {
        ...
        if (data['details']) { // data not null
          IdentitySourceItemDetails.validateJSON(data['details']);
        }
...
IdentitySourceItem.RequiredProperties = ["createdDate", "details", "identitySourceId", "lastUpdatedDate", "policyStoreId", "principalEntityType"];

/**
 * @member {Date} createdDate
 */
IdentitySourceItem.prototype['createdDate'] = undefined;

/**
 * @member {module:model/IdentitySourceItemDetails} details
 */
IdentitySourceItem.prototype['details'] = undefined;

/**
 * @member {String} identitySourceId
 */
IdentitySourceItem.prototype['identitySourceId'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
IdentitySourceItem.prototype['lastUpdatedDate'] = undefined;

/**
 * @member {String} policyStoreId
 */
IdentitySourceItem.prototype['policyStoreId'] = undefined;

/**
 * @member {String} principalEntityType
 */
IdentitySourceItem.prototype['principalEntityType'] = undefined;
...
export default IdentitySourceItem;
