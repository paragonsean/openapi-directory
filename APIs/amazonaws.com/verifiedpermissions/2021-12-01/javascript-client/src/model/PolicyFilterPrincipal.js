...
/**
 * The PolicyFilterPrincipal model module.
 * @module model/PolicyFilterPrincipal
 * @version 2021-12-01
 */
class PolicyFilterPrincipal {
    /**
     * Constructs a new <code>PolicyFilterPrincipal</code>.
     * @alias module:model/PolicyFilterPrincipal
     * @implements module:model/EntityReference
     */
    constructor() { 
        EntityReference.initialize(this);
        PolicyFilterPrincipal.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyFilterPrincipal</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyFilterPrincipal} obj Optional instance to populate.
     * @return {module:model/PolicyFilterPrincipal} The populated <code>PolicyFilterPrincipal</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyFilterPrincipal();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyFilterPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyFilterPrincipal</code>.
     */
 ...
 */
PolicyFilterPrincipal.prototype['unspecified'] = undefined;

/**
 * @member {module:model/EntityReferenceIdentifier} identifier
 */
PolicyFilterPrincipal.prototype['identifier'] = undefined;
...
export default PolicyFilterPrincipal;
