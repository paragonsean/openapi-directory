...
/**
 * The PutSchemaOutput model module.
 * @module model/PutSchemaOutput
 * @version 2021-12-01
 */
class PutSchemaOutput {
    /**
     * Constructs a new <code>PutSchemaOutput</code>.
     * @alias module:model/PutSchemaOutput
     * @param policyStoreId {String} 
     * @param namespaces {Array} 
     * @param createdDate {Date} 
     * @param lastUpdatedDate {Date} 
     */
    constructor(policyStoreId, namespaces, createdDate, lastUpdatedDate) { 
        
        PutSchemaOutput.initialize(this, policyStoreId, namespaces, createdDate, lastUpdatedDate);
    }
     ...
     */
    static initialize(obj, policyStoreId, namespaces, createdDate, lastUpdatedDate) { 
    ...
    /**
     * Constructs a <code>PutSchemaOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutSchemaOutput} obj Optional instance to populate.
     * @return {module:model/PutSchemaOutput} The populated <code>PutSchemaOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutSchemaOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>PutSchemaOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutSchemaOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutSchemaOutput.RequiredProperties) {
...
PutSchemaOutput.RequiredProperties = ["policyStoreId", "namespaces", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
PutSchemaOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {Array} namespaces
 */
PutSchemaOutput.prototype['namespaces'] = undefined;

/**
 * @member {Date} createdDate
 */
PutSchemaOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
PutSchemaOutput.prototype['lastUpdatedDate'] = undefined;
...
export default PutSchemaOutput;
