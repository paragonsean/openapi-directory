...
/**
 * The ValidationSettings model module.
 * @module model/ValidationSettings
 * @version 2021-12-01
 */
class ValidationSettings {
    /**
     * Constructs a new <code>ValidationSettings</code>.
     ...
     * @alias module:model/ValidationSettings
    ...
    /**
     * Constructs a <code>ValidationSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidationSettings} obj Optional instance to populate.
     * @return {module:model/ValidationSettings} The populated <code>ValidationSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidationSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidationSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidationSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ValidationSettings.RequiredProperties) {
...
ValidationSettings.RequiredProperties = ["mode"];
