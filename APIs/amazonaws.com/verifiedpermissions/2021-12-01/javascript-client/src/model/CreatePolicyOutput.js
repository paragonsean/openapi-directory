...
import CreatePolicyOutputPrincipal from './CreatePolicyOutputPrincipal';
import CreatePolicyOutputResource from './CreatePolicyOutputResource';
import PolicyType from './PolicyType';

/**
 * The CreatePolicyOutput model module.
 * @module model/CreatePolicyOutput
 * @version 2021-12-01
 */
class CreatePolicyOutput {
    /**
     * Constructs a new <code>CreatePolicyOutput</code>.
     * @alias module:model/CreatePolicyOutput
    ...
    constructor(policyStoreId, policyId, policyType, createdDate, lastUpdatedDate) { 
        ...
        CreatePolicyOutput.initialize(this, policyStoreId, policyId, policyType, createdDate, lastUpdatedDate);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyOutput} obj Optional instance to populate.
     * @return {module:model/CreatePolicyOutput} The populated <code>CreatePolicyOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyOutput();
            ...
            if (data.hasOwnProperty('principal')) {
                obj['principal'] = CreatePolicyOutputPrincipal.constructFromObject(data['principal']);
            }
            if (data.hasOwnProperty('resource')) {
                obj['resource'] = CreatePolicyOutputResource.constructFromObject(data['resource']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyOutput.RequiredProperties) {
        ...
        if (data['principal']) { // data not null
          CreatePolicyOutputPrincipal.validateJSON(data['principal']);
        }
        // validate the optional field `resource`
        if (data['resource']) { // data not null
          CreatePolicyOutputResource.validateJSON(data['resource']);
        }
...
CreatePolicyOutput.RequiredProperties = ["policyStoreId", "policyId", "policyType", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
CreatePolicyOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyId
 */
CreatePolicyOutput.prototype['policyId'] = undefined;

/**
 * @member {module:model/PolicyType} policyType
 */
CreatePolicyOutput.prototype['policyType'] = undefined;

/**
 * @member {module:model/CreatePolicyOutputPrincipal} principal
 */
CreatePolicyOutput.prototype['principal'] = undefined;

/**
 * @member {module:model/CreatePolicyOutputResource} resource
 */
CreatePolicyOutput.prototype['resource'] = undefined;

/**
 * @member {Date} createdDate
 */
CreatePolicyOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
CreatePolicyOutput.prototype['lastUpdatedDate'] = undefined;
...
export default CreatePolicyOutput;
