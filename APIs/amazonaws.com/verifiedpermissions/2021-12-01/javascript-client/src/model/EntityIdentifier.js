...
/**
 * The EntityIdentifier model module.
 * @module model/EntityIdentifier
 * @version 2021-12-01
 */
class EntityIdentifier {
    /**
     * Constructs a new <code>EntityIdentifier</code>.
     ...
     * @alias module:model/EntityIdentifier
    ...
    /**
     * Constructs a <code>EntityIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntityIdentifier} obj Optional instance to populate.
     * @return {module:model/EntityIdentifier} The populated <code>EntityIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntityIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>EntityIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EntityIdentifier.RequiredProperties) {
...
EntityIdentifier.RequiredProperties = ["entityType", "entityId"];
