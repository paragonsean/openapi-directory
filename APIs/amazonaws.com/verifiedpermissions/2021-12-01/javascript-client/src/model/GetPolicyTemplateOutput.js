...
/**
 * The GetPolicyTemplateOutput model module.
 * @module model/GetPolicyTemplateOutput
 * @version 2021-12-01
 */
class GetPolicyTemplateOutput {
    /**
     * Constructs a new <code>GetPolicyTemplateOutput</code>.
     * @alias module:model/GetPolicyTemplateOutput
     ...
     */
    constructor(policyStoreId, policyTemplateId, statement, createdDate, lastUpdatedDate) { 
        
        GetPolicyTemplateOutput.initialize(this, policyStoreId, policyTemplateId, statement, createdDate, lastUpdatedDate);
    }
     ...
     */
    static initialize(obj, policyStoreId, policyTemplateId, statement, createdDate, lastUpdatedDate) { 
    ...
    /**
     * Constructs a <code>GetPolicyTemplateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyTemplateOutput} obj Optional instance to populate.
     * @return {module:model/GetPolicyTemplateOutput} The populated <code>GetPolicyTemplateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyTemplateOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyTemplateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyTemplateOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyTemplateOutput.RequiredProperties) {
...
GetPolicyTemplateOutput.RequiredProperties = ["policyStoreId", "policyTemplateId", "statement", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
GetPolicyTemplateOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyTemplateId
 */
GetPolicyTemplateOutput.prototype['policyTemplateId'] = undefined;

/**
 * @member {String} description
 */
GetPolicyTemplateOutput.prototype['description'] = undefined;

/**
 * @member {String} statement
 */
GetPolicyTemplateOutput.prototype['statement'] = undefined;

/**
 * @member {Date} createdDate
 */
GetPolicyTemplateOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
GetPolicyTemplateOutput.prototype['lastUpdatedDate'] = undefined;
...
export default GetPolicyTemplateOutput;
