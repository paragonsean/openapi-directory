...
import IdentitySourceDetails from './IdentitySourceDetails';
import OpenIdIssuer from './OpenIdIssuer';

/**
 * The GetIdentitySourceOutputDetails model module.
 * @module model/GetIdentitySourceOutputDetails
 * @version 2021-12-01
 */
class GetIdentitySourceOutputDetails {
    /**
     * Constructs a new <code>GetIdentitySourceOutputDetails</code>.
     * @alias module:model/GetIdentitySourceOutputDetails
     * @implements module:model/IdentitySourceDetails
     */
    constructor() { 
        IdentitySourceDetails.initialize(this);
        GetIdentitySourceOutputDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetIdentitySourceOutputDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIdentitySourceOutputDetails} obj Optional instance to populate.
     * @return {module:model/GetIdentitySourceOutputDetails} The populated <code>GetIdentitySourceOutputDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdentitySourceOutputDetails();
            IdentitySourceDetails.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdentitySourceOutputDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdentitySourceOutputDetails</code>.
     */
 ...
 */
GetIdentitySourceOutputDetails.prototype['clientIds'] = undefined;

/**
 * @member {String} userPoolArn
 */
GetIdentitySourceOutputDetails.prototype['userPoolArn'] = undefined;

/**
 * @member {String} discoveryUrl
 */
GetIdentitySourceOutputDetails.prototype['discoveryUrl'] = undefined;

/**
 * @member {module:model/OpenIdIssuer} openIdIssuer
 */
GetIdentitySourceOutputDetails.prototype['openIdIssuer'] = undefined;


// Implement IdentitySourceDetails interface:
/**
 * @member {Array} clientIds
 */
IdentitySourceDetails.prototype['clientIds'] = undefined;
/**
 * @member {String} userPoolArn
 */
IdentitySourceDetails.prototype['userPoolArn'] = undefined;
/**
 * @member {String} discoveryUrl
 */
IdentitySourceDetails.prototype['discoveryUrl'] = undefined;
/**
 * @member {module:model/OpenIdIssuer} openIdIssuer
 */
IdentitySourceDetails.prototype['openIdIssuer'] = undefined;




export default GetIdentitySourceOutputDetails;
