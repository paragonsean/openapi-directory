...
/**
 * The AttributeValueEntityIdentifier model module.
 * @module model/AttributeValueEntityIdentifier
 * @version 2021-12-01
 */
class AttributeValueEntityIdentifier {
    /**
     * Constructs a new <code>AttributeValueEntityIdentifier</code>.
     * @alias module:model/AttributeValueEntityIdentifier
    ...
    constructor(entityType, entityId) { 
        ...
        AttributeValueEntityIdentifier.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>AttributeValueEntityIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttributeValueEntityIdentifier} obj Optional instance to populate.
     * @return {module:model/AttributeValueEntityIdentifier} The populated <code>AttributeValueEntityIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttributeValueEntityIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>AttributeValueEntityIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AttributeValueEntityIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AttributeValueEntityIdentifier.RequiredProperties) {
...
AttributeValueEntityIdentifier.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
AttributeValueEntityIdentifier.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
AttributeValueEntityIdentifier.prototype['entityId'] = undefined;
...
export default AttributeValueEntityIdentifier;
