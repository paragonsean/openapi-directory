...
import IsAuthorizedWithTokenInputAction from './IsAuthorizedWithTokenInputAction';
import IsAuthorizedWithTokenInputResource from './IsAuthorizedWithTokenInputResource';

/**
 * The IsAuthorizedWithTokenInput model module.
 * @module model/IsAuthorizedWithTokenInput
 * @version 2021-12-01
 */
class IsAuthorizedWithTokenInput {
    /**
     * Constructs a new <code>IsAuthorizedWithTokenInput</code>.
     * @alias module:model/IsAuthorizedWithTokenInput
     * @param policyStoreId {String} 
     */
    constructor(policyStoreId) { 
        
        IsAuthorizedWithTokenInput.initialize(this, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedWithTokenInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedWithTokenInput} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedWithTokenInput} The populated <code>IsAuthorizedWithTokenInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedWithTokenInput();
            ...
            if (data.hasOwnProperty('action')) {
                obj['action'] = IsAuthorizedWithTokenInputAction.constructFromObject(data['action']);
            }
            if (data.hasOwnProperty('resource')) {
                obj['resource'] = IsAuthorizedWithTokenInputResource.constructFromObject(data['resource']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedWithTokenInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedWithTokenInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedWithTokenInput.RequiredProperties) {
        ...
        if (data['identityToken']) { // data not null
          String.validateJSON(data['identityToken']);
        }
        ...
        if (data['action']) { // data not null
          IsAuthorizedWithTokenInputAction.validateJSON(data['action']);
        }
        // validate the optional field `resource`
        if (data['resource']) { // data not null
          IsAuthorizedWithTokenInputResource.validateJSON(data['resource']);
        }
...
IsAuthorizedWithTokenInput.RequiredProperties = ["policyStoreId"];

/**
 * @member {String} policyStoreId
 */
IsAuthorizedWithTokenInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} identityToken
 */
IsAuthorizedWithTokenInput.prototype['identityToken'] = undefined;

/**
 * @member {String} accessToken
 */
IsAuthorizedWithTokenInput.prototype['accessToken'] = undefined;

/**
 * @member {module:model/IsAuthorizedWithTokenInputAction} action
 */
IsAuthorizedWithTokenInput.prototype['action'] = undefined;

/**
 * @member {module:model/IsAuthorizedWithTokenInputResource} resource
 */
IsAuthorizedWithTokenInput.prototype['resource'] = undefined;

/**
 * @member {module:model/IsAuthorizedInputContext} context
 */
IsAuthorizedWithTokenInput.prototype['context'] = undefined;

/**
 * @member {module:model/IsAuthorizedInputEntities} entities
 */
IsAuthorizedWithTokenInput.prototype['entities'] = undefined;
...
export default IsAuthorizedWithTokenInput;
