...
/**
 * The IsAuthorizedWithTokenOutput model module.
 * @module model/IsAuthorizedWithTokenOutput
 * @version 2021-12-01
 */
class IsAuthorizedWithTokenOutput {
    /**
     * Constructs a new <code>IsAuthorizedWithTokenOutput</code>.
     * @alias module:model/IsAuthorizedWithTokenOutput
    ...
    constructor(decision, determiningPolicies, errors) { 
        ...
        IsAuthorizedWithTokenOutput.initialize(this, decision, determiningPolicies, errors);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedWithTokenOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedWithTokenOutput} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedWithTokenOutput} The populated <code>IsAuthorizedWithTokenOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedWithTokenOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedWithTokenOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedWithTokenOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IsAuthorizedWithTokenOutput.RequiredProperties) {
...
IsAuthorizedWithTokenOutput.RequiredProperties = ["decision", "determiningPolicies", "errors"];

/**
 * @member {module:model/Decision} decision
 */
IsAuthorizedWithTokenOutput.prototype['decision'] = undefined;

/**
 * @member {Array} determiningPolicies
 */
IsAuthorizedWithTokenOutput.prototype['determiningPolicies'] = undefined;

/**
 * @member {Array} errors
 */
IsAuthorizedWithTokenOutput.prototype['errors'] = undefined;
...
export default IsAuthorizedWithTokenOutput;
