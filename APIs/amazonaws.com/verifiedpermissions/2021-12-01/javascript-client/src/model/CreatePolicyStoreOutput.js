...
/**
 * The CreatePolicyStoreOutput model module.
 * @module model/CreatePolicyStoreOutput
 * @version 2021-12-01
 */
class CreatePolicyStoreOutput {
    /**
     * Constructs a new <code>CreatePolicyStoreOutput</code>.
     * @alias module:model/CreatePolicyStoreOutput
    ...
    constructor(policyStoreId, arn, createdDate, lastUpdatedDate) { 
        ...
        CreatePolicyStoreOutput.initialize(this, policyStoreId, arn, createdDate, lastUpdatedDate);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyStoreOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyStoreOutput} obj Optional instance to populate.
     * @return {module:model/CreatePolicyStoreOutput} The populated <code>CreatePolicyStoreOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyStoreOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyStoreOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyStoreOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyStoreOutput.RequiredProperties) {
...
CreatePolicyStoreOutput.RequiredProperties = ["policyStoreId", "arn", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
CreatePolicyStoreOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} arn
 */
CreatePolicyStoreOutput.prototype['arn'] = undefined;

/**
 * @member {Date} createdDate
 */
CreatePolicyStoreOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
CreatePolicyStoreOutput.prototype['lastUpdatedDate'] = undefined;
...
export default CreatePolicyStoreOutput;
