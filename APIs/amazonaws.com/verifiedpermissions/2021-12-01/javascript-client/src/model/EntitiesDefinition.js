...
/**
 * The EntitiesDefinition model module.
 * @module model/EntitiesDefinition
 * @version 2021-12-01
 */
class EntitiesDefinition {
    /**
     * Constructs a new <code>EntitiesDefinition</code>.
     ...
     * @alias module:model/EntitiesDefinition
     */
    constructor() { 
        
        EntitiesDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>EntitiesDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntitiesDefinition} obj Optional instance to populate.
     * @return {module:model/EntitiesDefinition} The populated <code>EntitiesDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntitiesDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>EntitiesDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntitiesDefinition</code>.
     */
 ...
 */
EntitiesDefinition.prototype['entityList'] = undefined;
