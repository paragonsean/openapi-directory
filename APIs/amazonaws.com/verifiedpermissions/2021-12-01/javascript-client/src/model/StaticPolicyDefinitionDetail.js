...
/**
 * The StaticPolicyDefinitionDetail model module.
 * @module model/StaticPolicyDefinitionDetail
 * @version 2021-12-01
 */
class StaticPolicyDefinitionDetail {
    /**
     * Constructs a new <code>StaticPolicyDefinitionDetail</code>.
     ...
     * @alias module:model/StaticPolicyDefinitionDetail
    ...
    /**
     * Constructs a <code>StaticPolicyDefinitionDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaticPolicyDefinitionDetail} obj Optional instance to populate.
     * @return {module:model/StaticPolicyDefinitionDetail} The populated <code>StaticPolicyDefinitionDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaticPolicyDefinitionDetail();
    ...
    /**
     * Validates the JSON data with respect to <code>StaticPolicyDefinitionDetail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaticPolicyDefinitionDetail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StaticPolicyDefinitionDetail.RequiredProperties) {
...
StaticPolicyDefinitionDetail.RequiredProperties = ["statement"];
...
export default StaticPolicyDefinitionDetail;
