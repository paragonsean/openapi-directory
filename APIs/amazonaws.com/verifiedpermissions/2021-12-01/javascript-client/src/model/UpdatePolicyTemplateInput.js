...
/**
 * The UpdatePolicyTemplateInput model module.
 * @module model/UpdatePolicyTemplateInput
 * @version 2021-12-01
 */
class UpdatePolicyTemplateInput {
    /**
     * Constructs a new <code>UpdatePolicyTemplateInput</code>.
     * @alias module:model/UpdatePolicyTemplateInput
     * @param policyStoreId {String} 
     * @param policyTemplateId {String} 
     * @param statement {String} 
     */
    constructor(policyStoreId, policyTemplateId, statement) { 
        
        UpdatePolicyTemplateInput.initialize(this, policyStoreId, policyTemplateId, statement);
    }
     ...
     */
    static initialize(obj, policyStoreId, policyTemplateId, statement) { 
    ...
    /**
     * Constructs a <code>UpdatePolicyTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyTemplateInput} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyTemplateInput} The populated <code>UpdatePolicyTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyTemplateInput.RequiredProperties) {
...
UpdatePolicyTemplateInput.RequiredProperties = ["policyStoreId", "policyTemplateId", "statement"];

/**
 * @member {String} policyStoreId
 */
UpdatePolicyTemplateInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyTemplateId
 */
UpdatePolicyTemplateInput.prototype['policyTemplateId'] = undefined;

/**
 * @member {String} description
 */
UpdatePolicyTemplateInput.prototype['description'] = undefined;

/**
 * @member {String} statement
 */
UpdatePolicyTemplateInput.prototype['statement'] = undefined;
...
export default UpdatePolicyTemplateInput;
