...
/**
 * The IsAuthorizedInputContext model module.
 * @module model/IsAuthorizedInputContext
 * @version 2021-12-01
 */
class IsAuthorizedInputContext {
    /**
     * Constructs a new <code>IsAuthorizedInputContext</code>.
     * @alias module:model/IsAuthorizedInputContext
     * @implements module:model/ContextDefinition
     */
    constructor() { 
        ContextDefinition.initialize(this);
        IsAuthorizedInputContext.initialize(this);
    }
    ...
    /**
     * Constructs a <code>IsAuthorizedInputContext</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IsAuthorizedInputContext} obj Optional instance to populate.
     * @return {module:model/IsAuthorizedInputContext} The populated <code>IsAuthorizedInputContext</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsAuthorizedInputContext();
            ContextDefinition.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>IsAuthorizedInputContext</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IsAuthorizedInputContext</code>.
     */
 ...
 */
IsAuthorizedInputContext.prototype['contextMap'] = undefined;


// Implement ContextDefinition interface:
/**
 * @member {Object} contextMap
 */
...
export default IsAuthorizedInputContext;
