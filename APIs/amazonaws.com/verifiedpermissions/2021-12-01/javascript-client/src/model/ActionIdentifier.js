...
/**
 * The ActionIdentifier model module.
 * @module model/ActionIdentifier
 * @version 2021-12-01
 */
class ActionIdentifier {
    /**
     * Constructs a new <code>ActionIdentifier</code>.
     ...
     * @alias module:model/ActionIdentifier
    ...
    /**
     * Constructs a <code>ActionIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ActionIdentifier} obj Optional instance to populate.
     * @return {module:model/ActionIdentifier} The populated <code>ActionIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ActionIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>ActionIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActionIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ActionIdentifier.RequiredProperties) {
...
ActionIdentifier.RequiredProperties = ["actionType", "actionId"];
