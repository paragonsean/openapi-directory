...
import StaticPolicyDefinitionItem from './StaticPolicyDefinitionItem';

/**
 * The PolicyDefinitionItemStatic model module.
 * @module model/PolicyDefinitionItemStatic
 * @version 2021-12-01
 */
class PolicyDefinitionItemStatic {
    /**
     * Constructs a new <code>PolicyDefinitionItemStatic</code>.
     * @alias module:model/PolicyDefinitionItemStatic
     * @implements module:model/StaticPolicyDefinitionItem
     */
    constructor() { 
        StaticPolicyDefinitionItem.initialize(this);
        PolicyDefinitionItemStatic.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PolicyDefinitionItemStatic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyDefinitionItemStatic} obj Optional instance to populate.
     * @return {module:model/PolicyDefinitionItemStatic} The populated <code>PolicyDefinitionItemStatic</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyDefinitionItemStatic();
            StaticPolicyDefinitionItem.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyDefinitionItemStatic</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyDefinitionItemStatic</code>.
     */
 ...
 */
PolicyDefinitionItemStatic.prototype['description'] = undefined;


// Implement StaticPolicyDefinitionItem interface:
/**
 * @member {String} description
 */
...
export default PolicyDefinitionItemStatic;
