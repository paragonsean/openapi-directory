...
import CognitoUserPoolConfiguration from './CognitoUserPoolConfiguration';

/**
 * The ConfigurationCognitoUserPoolConfiguration model module.
 * @module model/ConfigurationCognitoUserPoolConfiguration
 * @version 2021-12-01
 */
class ConfigurationCognitoUserPoolConfiguration {
    /**
     * Constructs a new <code>ConfigurationCognitoUserPoolConfiguration</code>.
     * @alias module:model/ConfigurationCognitoUserPoolConfiguration
     * @implements module:model/CognitoUserPoolConfiguration
     * @param userPoolArn {String} 
     */
    constructor(userPoolArn) { 
        CognitoUserPoolConfiguration.initialize(this, userPoolArn);
        ConfigurationCognitoUserPoolConfiguration.initialize(this, userPoolArn);
    }
    ...
    /**
     * Constructs a <code>ConfigurationCognitoUserPoolConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConfigurationCognitoUserPoolConfiguration} obj Optional instance to populate.
     * @return {module:model/ConfigurationCognitoUserPoolConfiguration} The populated <code>ConfigurationCognitoUserPoolConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigurationCognitoUserPoolConfiguration();
            CognitoUserPoolConfiguration.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ConfigurationCognitoUserPoolConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfigurationCognitoUserPoolConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfigurationCognitoUserPoolConfiguration.RequiredProperties) {
...
ConfigurationCognitoUserPoolConfiguration.RequiredProperties = ["userPoolArn"];

/**
 * @member {String} userPoolArn
 */
ConfigurationCognitoUserPoolConfiguration.prototype['userPoolArn'] = undefined;

/**
 * @member {Array} clientIds
 */
ConfigurationCognitoUserPoolConfiguration.prototype['clientIds'] = undefined;


// Implement CognitoUserPoolConfiguration interface:
/**
 * @member {String} userPoolArn
 */
CognitoUserPoolConfiguration.prototype['userPoolArn'] = undefined;
/**
 * @member {Array} clientIds
 */
CognitoUserPoolConfiguration.prototype['clientIds'] = undefined;




export default ConfigurationCognitoUserPoolConfiguration;
