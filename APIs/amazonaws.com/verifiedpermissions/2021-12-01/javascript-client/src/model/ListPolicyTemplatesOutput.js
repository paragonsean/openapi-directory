...
/**
 * The ListPolicyTemplatesOutput model module.
 * @module model/ListPolicyTemplatesOutput
 * @version 2021-12-01
 */
class ListPolicyTemplatesOutput {
    /**
     * Constructs a new <code>ListPolicyTemplatesOutput</code>.
     * @alias module:model/ListPolicyTemplatesOutput
     * @param policyTemplates {Array} 
     */
    constructor(policyTemplates) { 
        
        ListPolicyTemplatesOutput.initialize(this, policyTemplates);
    }
     ...
     */
    static initialize(obj, policyTemplates) { 
        obj['policyTemplates'] = policyTemplates;
    }

    /**
     * Constructs a <code>ListPolicyTemplatesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPolicyTemplatesOutput} obj Optional instance to populate.
     * @return {module:model/ListPolicyTemplatesOutput} The populated <code>ListPolicyTemplatesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPolicyTemplatesOutput();

            if (data.hasOwnProperty('nextToken')) {
                obj['nextToken'] = ApiClient.convertToType(data['nextToken'], 'String');
            }
            if (data.hasOwnProperty('policyTemplates')) {
                obj['policyTemplates'] = ApiClient.convertToType(data['policyTemplates'], Array);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListPolicyTemplatesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPolicyTemplatesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPolicyTemplatesOutput.RequiredProperties) {
        ...
        // validate the optional field `policyTemplates`
        if (data['policyTemplates']) { // data not null
          Array.validateJSON(data['policyTemplates']);
        }
...
ListPolicyTemplatesOutput.RequiredProperties = ["policyTemplates"];

/**
 * @member {String} nextToken
 */
ListPolicyTemplatesOutput.prototype['nextToken'] = undefined;

/**
 * @member {Array} policyTemplates
 */
ListPolicyTemplatesOutput.prototype['policyTemplates'] = undefined;
...
export default ListPolicyTemplatesOutput;
