...
/**
 * The CreatePolicyTemplateInput model module.
 * @module model/CreatePolicyTemplateInput
 * @version 2021-12-01
 */
class CreatePolicyTemplateInput {
    /**
     * Constructs a new <code>CreatePolicyTemplateInput</code>.
     * @alias module:model/CreatePolicyTemplateInput
     * @param policyStoreId {String} 
     * @param statement {String} 
     */
    constructor(policyStoreId, statement) { 
        
        CreatePolicyTemplateInput.initialize(this, policyStoreId, statement);
    }
     ...
     */
    static initialize(obj, policyStoreId, statement) { 
        obj['policyStoreId'] = policyStoreId;
        obj['statement'] = statement;
    }

    /**
     * Constructs a <code>CreatePolicyTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyTemplateInput} obj Optional instance to populate.
     * @return {module:model/CreatePolicyTemplateInput} The populated <code>CreatePolicyTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyTemplateInput.RequiredProperties) {
...
CreatePolicyTemplateInput.RequiredProperties = ["policyStoreId", "statement"];

/**
 * @member {String} clientToken
 */
CreatePolicyTemplateInput.prototype['clientToken'] = undefined;

/**
 * @member {String} policyStoreId
 */
CreatePolicyTemplateInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} description
 */
CreatePolicyTemplateInput.prototype['description'] = undefined;

/**
 * @member {String} statement
 */
CreatePolicyTemplateInput.prototype['statement'] = undefined;
...
export default CreatePolicyTemplateInput;
