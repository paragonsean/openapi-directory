...
import PolicyDefinitionDetail from './PolicyDefinitionDetail';
...
/**
 * The GetPolicyOutputDefinition model module.
 * @module model/GetPolicyOutputDefinition
 * @version 2021-12-01
 */
class GetPolicyOutputDefinition {
    /**
     * Constructs a new <code>GetPolicyOutputDefinition</code>.
     * @alias module:model/GetPolicyOutputDefinition
     * @implements module:model/PolicyDefinitionDetail
     */
    constructor() { 
        PolicyDefinitionDetail.initialize(this);
        GetPolicyOutputDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetPolicyOutputDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyOutputDefinition} obj Optional instance to populate.
     * @return {module:model/GetPolicyOutputDefinition} The populated <code>GetPolicyOutputDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyOutputDefinition();
            PolicyDefinitionDetail.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyOutputDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyOutputDefinition</code>.
     */
 ...
 */
GetPolicyOutputDefinition.prototype['static'] = undefined;

/**
 * @member {module:model/PolicyDefinitionDetailTemplateLinked} templateLinked
 */
GetPolicyOutputDefinition.prototype['templateLinked'] = undefined;


// Implement PolicyDefinitionDetail interface:
/**
 * @member {module:model/PolicyDefinitionDetailStatic} static
 */
...
export default GetPolicyOutputDefinition;
