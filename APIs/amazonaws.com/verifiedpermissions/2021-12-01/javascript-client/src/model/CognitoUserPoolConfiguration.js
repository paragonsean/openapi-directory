...
/**
 * The CognitoUserPoolConfiguration model module.
 * @module model/CognitoUserPoolConfiguration
 * @version 2021-12-01
 */
class CognitoUserPoolConfiguration {
    /**
     * Constructs a new <code>CognitoUserPoolConfiguration</code>.
     ...
     * @alias module:model/CognitoUserPoolConfiguration
    ...
    /**
     * Constructs a <code>CognitoUserPoolConfiguration</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CognitoUserPoolConfiguration} obj Optional instance to populate.
     * @return {module:model/CognitoUserPoolConfiguration} The populated <code>CognitoUserPoolConfiguration</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CognitoUserPoolConfiguration();
    ...
    /**
     * Validates the JSON data with respect to <code>CognitoUserPoolConfiguration</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CognitoUserPoolConfiguration</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CognitoUserPoolConfiguration.RequiredProperties) {
...
CognitoUserPoolConfiguration.RequiredProperties = ["userPoolArn"];
...
export default CognitoUserPoolConfiguration;
