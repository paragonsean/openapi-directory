...
import PolicyDefinitionStatic from './PolicyDefinitionStatic';
import PolicyDefinitionTemplateLinked from './PolicyDefinitionTemplateLinked';

/**
 * The CreatePolicyInputDefinition model module.
 * @module model/CreatePolicyInputDefinition
 * @version 2021-12-01
 */
class CreatePolicyInputDefinition {
    /**
     * Constructs a new <code>CreatePolicyInputDefinition</code>.
     * @alias module:model/CreatePolicyInputDefinition
     * @implements module:model/PolicyDefinition
     */
    constructor() { 
        PolicyDefinition.initialize(this);
        CreatePolicyInputDefinition.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyInputDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyInputDefinition} obj Optional instance to populate.
     * @return {module:model/CreatePolicyInputDefinition} The populated <code>CreatePolicyInputDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyInputDefinition();
            PolicyDefinition.constructFromObject(data, obj);

            if (data.hasOwnProperty('static')) {
                obj['static'] = PolicyDefinitionStatic.constructFromObject(data['static']);
            }
            if (data.hasOwnProperty('templateLinked')) {
                obj['templateLinked'] = PolicyDefinitionTemplateLinked.constructFromObject(data['templateLinked']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyInputDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyInputDefinition</code>.
     */
    static validateJSON(data) {
        // validate the optional field `static`
        if (data['static']) { // data not null
          PolicyDefinitionStatic.validateJSON(data['static']);
        }
        // validate the optional field `templateLinked`
        if (data['templateLinked']) { // data not null
          PolicyDefinitionTemplateLinked.validateJSON(data['templateLinked']);
        }
...
/**
 * @member {module:model/PolicyDefinitionStatic} static
 */
CreatePolicyInputDefinition.prototype['static'] = undefined;

/**
 * @member {module:model/PolicyDefinitionTemplateLinked} templateLinked
 */
CreatePolicyInputDefinition.prototype['templateLinked'] = undefined;


// Implement PolicyDefinition interface:
/**
 * @member {module:model/PolicyDefinitionStatic} static
 */
PolicyDefinition.prototype['static'] = undefined;
/**
 * @member {module:model/PolicyDefinitionTemplateLinked} templateLinked
 */
PolicyDefinition.prototype['templateLinked'] = undefined;




export default CreatePolicyInputDefinition;
