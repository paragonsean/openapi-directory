...
import CreatePolicyStoreInputValidationSettings from './CreatePolicyStoreInputValidationSettings';

/**
 * The CreatePolicyStoreInput model module.
 * @module model/CreatePolicyStoreInput
 * @version 2021-12-01
 */
class CreatePolicyStoreInput {
    /**
     * Constructs a new <code>CreatePolicyStoreInput</code>.
     * @alias module:model/CreatePolicyStoreInput
     * @param validationSettings {module:model/CreatePolicyStoreInputValidationSettings} 
     */
    constructor(validationSettings) { 
        
        CreatePolicyStoreInput.initialize(this, validationSettings);
    }
     ...
     */
    static initialize(obj, validationSettings) { 
        obj['validationSettings'] = validationSettings;
    }

    /**
     * Constructs a <code>CreatePolicyStoreInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyStoreInput} obj Optional instance to populate.
     * @return {module:model/CreatePolicyStoreInput} The populated <code>CreatePolicyStoreInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyStoreInput();

            if (data.hasOwnProperty('clientToken')) {
                obj['clientToken'] = ApiClient.convertToType(data['clientToken'], 'String');
            }
            if (data.hasOwnProperty('validationSettings')) {
                obj['validationSettings'] = CreatePolicyStoreInputValidationSettings.constructFromObject(data['validationSettings']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyStoreInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyStoreInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyStoreInput.RequiredProperties) {
        ...
        if (data['validationSettings']) { // data not null
          CreatePolicyStoreInputValidationSettings.validateJSON(data['validationSettings']);
        }
...
CreatePolicyStoreInput.RequiredProperties = ["validationSettings"];

/**
 * @member {String} clientToken
 */
CreatePolicyStoreInput.prototype['clientToken'] = undefined;

/**
 * @member {module:model/CreatePolicyStoreInputValidationSettings} validationSettings
 */
CreatePolicyStoreInput.prototype['validationSettings'] = undefined;
...
export default CreatePolicyStoreInput;
