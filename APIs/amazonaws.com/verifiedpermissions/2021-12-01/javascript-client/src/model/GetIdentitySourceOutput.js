...
import GetIdentitySourceOutputDetails from './GetIdentitySourceOutputDetails';

/**
 * The GetIdentitySourceOutput model module.
 * @module model/GetIdentitySourceOutput
 * @version 2021-12-01
 */
class GetIdentitySourceOutput {
    /**
     * Constructs a new <code>GetIdentitySourceOutput</code>.
     * @alias module:model/GetIdentitySourceOutput
     * @param createdDate {Date} 
     * @param details {module:model/GetIdentitySourceOutputDetails} 
    ...
    constructor(createdDate, details, identitySourceId, lastUpdatedDate, policyStoreId, principalEntityType) { 
        ...
        GetIdentitySourceOutput.initialize(this, createdDate, details, identitySourceId, lastUpdatedDate, policyStoreId, principalEntityType);
    }
    ...
    /**
     * Constructs a <code>GetIdentitySourceOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetIdentitySourceOutput} obj Optional instance to populate.
     * @return {module:model/GetIdentitySourceOutput} The populated <code>GetIdentitySourceOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetIdentitySourceOutput();

            if (data.hasOwnProperty('createdDate')) {
                obj['createdDate'] = ApiClient.convertToType(data['createdDate'], 'Date');
            }
            if (data.hasOwnProperty('details')) {
                obj['details'] = GetIdentitySourceOutputDetails.constructFromObject(data['details']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetIdentitySourceOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetIdentitySourceOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetIdentitySourceOutput.RequiredProperties) {
        ...
        if (data['details']) { // data not null
          GetIdentitySourceOutputDetails.validateJSON(data['details']);
        }
...
GetIdentitySourceOutput.RequiredProperties = ["createdDate", "details", "identitySourceId", "lastUpdatedDate", "policyStoreId", "principalEntityType"];

/**
 * @member {Date} createdDate
 */
GetIdentitySourceOutput.prototype['createdDate'] = undefined;

/**
 * @member {module:model/GetIdentitySourceOutputDetails} details
 */
GetIdentitySourceOutput.prototype['details'] = undefined;

/**
 * @member {String} identitySourceId
 */
GetIdentitySourceOutput.prototype['identitySourceId'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
GetIdentitySourceOutput.prototype['lastUpdatedDate'] = undefined;

/**
 * @member {String} policyStoreId
 */
GetIdentitySourceOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} principalEntityType
 */
GetIdentitySourceOutput.prototype['principalEntityType'] = undefined;
...
export default GetIdentitySourceOutput;
