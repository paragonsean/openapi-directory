...
/**
 * The ListPoliciesOutput model module.
 * @module model/ListPoliciesOutput
 * @version 2021-12-01
 */
class ListPoliciesOutput {
    /**
     * Constructs a new <code>ListPoliciesOutput</code>.
     * @alias module:model/ListPoliciesOutput
     * @param policies {Array} 
     */
    constructor(policies) { 
        
        ListPoliciesOutput.initialize(this, policies);
    }
    ...
    /**
     * Constructs a <code>ListPoliciesOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPoliciesOutput} obj Optional instance to populate.
     * @return {module:model/ListPoliciesOutput} The populated <code>ListPoliciesOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPoliciesOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPoliciesOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPoliciesOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListPoliciesOutput.RequiredProperties) {
...
ListPoliciesOutput.RequiredProperties = ["policies"];

/**
 * @member {String} nextToken
 */
ListPoliciesOutput.prototype['nextToken'] = undefined;

/**
 * @member {Array} policies
 */
ListPoliciesOutput.prototype['policies'] = undefined;
...
export default ListPoliciesOutput;
