...
/**
 * The EvaluationErrorItem model module.
 * @module model/EvaluationErrorItem
 * @version 2021-12-01
 */
class EvaluationErrorItem {
    /**
     * Constructs a new <code>EvaluationErrorItem</code>.
     ...
     * @alias module:model/EvaluationErrorItem
     * @param errorDescription {String} 
     */
    constructor(errorDescription) { 
        
        EvaluationErrorItem.initialize(this, errorDescription);
    }
    ...
    /**
     * Constructs a <code>EvaluationErrorItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EvaluationErrorItem} obj Optional instance to populate.
     * @return {module:model/EvaluationErrorItem} The populated <code>EvaluationErrorItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EvaluationErrorItem();
    ...
    /**
     * Validates the JSON data with respect to <code>EvaluationErrorItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EvaluationErrorItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EvaluationErrorItem.RequiredProperties) {
...
EvaluationErrorItem.RequiredProperties = ["errorDescription"];

/**
 * @member {String} errorDescription
 */
EvaluationErrorItem.prototype['errorDescription'] = undefined;
...
export default EvaluationErrorItem;
