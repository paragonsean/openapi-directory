...
/**
 * The StaticPolicyDefinition model module.
 * @module model/StaticPolicyDefinition
 * @version 2021-12-01
 */
class StaticPolicyDefinition {
    /**
     * Constructs a new <code>StaticPolicyDefinition</code>.
     ...
     * @alias module:model/StaticPolicyDefinition
    ...
    /**
     * Constructs a <code>StaticPolicyDefinition</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StaticPolicyDefinition} obj Optional instance to populate.
     * @return {module:model/StaticPolicyDefinition} The populated <code>StaticPolicyDefinition</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StaticPolicyDefinition();
    ...
    /**
     * Validates the JSON data with respect to <code>StaticPolicyDefinition</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StaticPolicyDefinition</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StaticPolicyDefinition.RequiredProperties) {
...
StaticPolicyDefinition.RequiredProperties = ["statement"];
...
export default StaticPolicyDefinition;
