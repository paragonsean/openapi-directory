...
/**
 * The EntityReferenceIdentifier model module.
 * @module model/EntityReferenceIdentifier
 * @version 2021-12-01
 */
class EntityReferenceIdentifier {
    /**
     * Constructs a new <code>EntityReferenceIdentifier</code>.
     * @alias module:model/EntityReferenceIdentifier
    ...
    constructor(entityType, entityId) { 
        ...
        EntityReferenceIdentifier.initialize(this, entityType, entityId);
    }
    ...
    /**
     * Constructs a <code>EntityReferenceIdentifier</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EntityReferenceIdentifier} obj Optional instance to populate.
     * @return {module:model/EntityReferenceIdentifier} The populated <code>EntityReferenceIdentifier</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EntityReferenceIdentifier();
    ...
    /**
     * Validates the JSON data with respect to <code>EntityReferenceIdentifier</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityReferenceIdentifier</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EntityReferenceIdentifier.RequiredProperties) {
...
EntityReferenceIdentifier.RequiredProperties = ["entityType", "entityId"];

/**
 * @member {String} entityType
 */
EntityReferenceIdentifier.prototype['entityType'] = undefined;

/**
 * @member {String} entityId
 */
EntityReferenceIdentifier.prototype['entityId'] = undefined;
...
export default EntityReferenceIdentifier;
