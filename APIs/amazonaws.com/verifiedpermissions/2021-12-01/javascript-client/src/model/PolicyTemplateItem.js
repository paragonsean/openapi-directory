...
/**
 * The PolicyTemplateItem model module.
 * @module model/PolicyTemplateItem
 * @version 2021-12-01
 */
class PolicyTemplateItem {
    /**
     * Constructs a new <code>PolicyTemplateItem</code>.
     ...
     * @alias module:model/PolicyTemplateItem
    ...
    constructor(policyStoreId, policyTemplateId, createdDate, lastUpdatedDate) { 
        ...
        PolicyTemplateItem.initialize(this, policyStoreId, policyTemplateId, createdDate, lastUpdatedDate);
    }
    ...
    /**
     * Constructs a <code>PolicyTemplateItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyTemplateItem} obj Optional instance to populate.
     * @return {module:model/PolicyTemplateItem} The populated <code>PolicyTemplateItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyTemplateItem();
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyTemplateItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyTemplateItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyTemplateItem.RequiredProperties) {
...
PolicyTemplateItem.RequiredProperties = ["policyStoreId", "policyTemplateId", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
PolicyTemplateItem.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyTemplateId
 */
PolicyTemplateItem.prototype['policyTemplateId'] = undefined;

/**
 * @member {String} description
 */
PolicyTemplateItem.prototype['description'] = undefined;

/**
 * @member {Date} createdDate
 */
PolicyTemplateItem.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
PolicyTemplateItem.prototype['lastUpdatedDate'] = undefined;
