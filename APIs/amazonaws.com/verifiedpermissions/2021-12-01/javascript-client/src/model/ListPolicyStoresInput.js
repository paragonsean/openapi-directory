...
/**
 * The ListPolicyStoresInput model module.
 * @module model/ListPolicyStoresInput
 * @version 2021-12-01
 */
class ListPolicyStoresInput {
    /**
     * Constructs a new <code>ListPolicyStoresInput</code>.
     * @alias module:model/ListPolicyStoresInput
     */
    constructor() { 
        
        ListPolicyStoresInput.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ListPolicyStoresInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListPolicyStoresInput} obj Optional instance to populate.
     * @return {module:model/ListPolicyStoresInput} The populated <code>ListPolicyStoresInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ListPolicyStoresInput();
    ...
    /**
     * Validates the JSON data with respect to <code>ListPolicyStoresInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListPolicyStoresInput</code>.
     */
 ...
 */
ListPolicyStoresInput.prototype['nextToken'] = undefined;

/**
 * @member {Number} maxResults
 */
ListPolicyStoresInput.prototype['maxResults'] = undefined;
...
export default ListPolicyStoresInput;
