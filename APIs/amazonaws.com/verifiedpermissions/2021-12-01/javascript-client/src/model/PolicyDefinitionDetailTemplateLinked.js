...
import TemplateLinkedPolicyDefinitionDetail from './TemplateLinkedPolicyDefinitionDetail';
...
/**
 * The PolicyDefinitionDetailTemplateLinked model module.
 * @module model/PolicyDefinitionDetailTemplateLinked
 * @version 2021-12-01
 */
class PolicyDefinitionDetailTemplateLinked {
    /**
     * Constructs a new <code>PolicyDefinitionDetailTemplateLinked</code>.
     * @alias module:model/PolicyDefinitionDetailTemplateLinked
     * @implements module:model/TemplateLinkedPolicyDefinitionDetail
     * @param policyTemplateId {String} 
     */
    constructor(policyTemplateId) { 
        TemplateLinkedPolicyDefinitionDetail.initialize(this, policyTemplateId);
        PolicyDefinitionDetailTemplateLinked.initialize(this, policyTemplateId);
    }
    ...
    /**
     * Constructs a <code>PolicyDefinitionDetailTemplateLinked</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PolicyDefinitionDetailTemplateLinked} obj Optional instance to populate.
     * @return {module:model/PolicyDefinitionDetailTemplateLinked} The populated <code>PolicyDefinitionDetailTemplateLinked</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PolicyDefinitionDetailTemplateLinked();
            TemplateLinkedPolicyDefinitionDetail.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>PolicyDefinitionDetailTemplateLinked</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PolicyDefinitionDetailTemplateLinked</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PolicyDefinitionDetailTemplateLinked.RequiredProperties) {
...
PolicyDefinitionDetailTemplateLinked.RequiredProperties = ["policyTemplateId"];

/**
 * @member {String} policyTemplateId
 */
PolicyDefinitionDetailTemplateLinked.prototype['policyTemplateId'] = undefined;

/**
 * @member {module:model/TemplateLinkedPolicyDefinitionPrincipal} principal
 */
PolicyDefinitionDetailTemplateLinked.prototype['principal'] = undefined;

/**
 * @member {module:model/TemplateLinkedPolicyDefinitionResource} resource
 */
PolicyDefinitionDetailTemplateLinked.prototype['resource'] = undefined;


// Implement TemplateLinkedPolicyDefinitionDetail interface:
/**
 * @member {String} policyTemplateId
 */
TemplateLinkedPolicyDefinitionDetail.prototype['policyTemplateId'] = undefined;
/**
 * @member {module:model/TemplateLinkedPolicyDefinitionPrincipal} principal
 */
TemplateLinkedPolicyDefinitionDetail.prototype['principal'] = undefined;
/**
 * @member {module:model/TemplateLinkedPolicyDefinitionResource} resource
 */
TemplateLinkedPolicyDefinitionDetail.prototype['resource'] = undefined;




export default PolicyDefinitionDetailTemplateLinked;
