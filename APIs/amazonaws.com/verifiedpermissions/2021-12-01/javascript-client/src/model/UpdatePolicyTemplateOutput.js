...
/**
 * The UpdatePolicyTemplateOutput model module.
 * @module model/UpdatePolicyTemplateOutput
 * @version 2021-12-01
 */
class UpdatePolicyTemplateOutput {
    /**
     * Constructs a new <code>UpdatePolicyTemplateOutput</code>.
     * @alias module:model/UpdatePolicyTemplateOutput
    ...
    constructor(policyStoreId, policyTemplateId, createdDate, lastUpdatedDate) { 
        ...
        UpdatePolicyTemplateOutput.initialize(this, policyStoreId, policyTemplateId, createdDate, lastUpdatedDate);
    }
    ...
    /**
     * Constructs a <code>UpdatePolicyTemplateOutput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePolicyTemplateOutput} obj Optional instance to populate.
     * @return {module:model/UpdatePolicyTemplateOutput} The populated <code>UpdatePolicyTemplateOutput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePolicyTemplateOutput();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePolicyTemplateOutput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePolicyTemplateOutput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UpdatePolicyTemplateOutput.RequiredProperties) {
...
UpdatePolicyTemplateOutput.RequiredProperties = ["policyStoreId", "policyTemplateId", "createdDate", "lastUpdatedDate"];

/**
 * @member {String} policyStoreId
 */
UpdatePolicyTemplateOutput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyTemplateId
 */
UpdatePolicyTemplateOutput.prototype['policyTemplateId'] = undefined;

/**
 * @member {Date} createdDate
 */
UpdatePolicyTemplateOutput.prototype['createdDate'] = undefined;

/**
 * @member {Date} lastUpdatedDate
 */
UpdatePolicyTemplateOutput.prototype['lastUpdatedDate'] = undefined;
...
export default UpdatePolicyTemplateOutput;
