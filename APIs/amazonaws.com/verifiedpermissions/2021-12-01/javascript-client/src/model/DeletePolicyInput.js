...
/**
 * The DeletePolicyInput model module.
 * @module model/DeletePolicyInput
 * @version 2021-12-01
 */
class DeletePolicyInput {
    /**
     * Constructs a new <code>DeletePolicyInput</code>.
     * @alias module:model/DeletePolicyInput
     * @param policyStoreId {String} 
     * @param policyId {String} 
     */
    constructor(policyStoreId, policyId) { 
        
        DeletePolicyInput.initialize(this, policyStoreId, policyId);
    }
     ...
     */
    static initialize(obj, policyStoreId, policyId) { 
        obj['policyStoreId'] = policyStoreId;
        obj['policyId'] = policyId;
    }

    /**
     * Constructs a <code>DeletePolicyInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePolicyInput} obj Optional instance to populate.
     * @return {module:model/DeletePolicyInput} The populated <code>DeletePolicyInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePolicyInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePolicyInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePolicyInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePolicyInput.RequiredProperties) {
...
DeletePolicyInput.RequiredProperties = ["policyStoreId", "policyId"];

/**
 * @member {String} policyStoreId
 */
DeletePolicyInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyId
 */
DeletePolicyInput.prototype['policyId'] = undefined;
...
export default DeletePolicyInput;
