...
/**
 * The DeletePolicyStoreInput model module.
 * @module model/DeletePolicyStoreInput
 * @version 2021-12-01
 */
class DeletePolicyStoreInput {
    /**
     * Constructs a new <code>DeletePolicyStoreInput</code>.
     * @alias module:model/DeletePolicyStoreInput
     * @param policyStoreId {String} 
     */
    constructor(policyStoreId) { 
        
        DeletePolicyStoreInput.initialize(this, policyStoreId);
    }
    ...
    /**
     * Constructs a <code>DeletePolicyStoreInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeletePolicyStoreInput} obj Optional instance to populate.
     * @return {module:model/DeletePolicyStoreInput} The populated <code>DeletePolicyStoreInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeletePolicyStoreInput();
    ...
    /**
     * Validates the JSON data with respect to <code>DeletePolicyStoreInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeletePolicyStoreInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeletePolicyStoreInput.RequiredProperties) {
...
DeletePolicyStoreInput.RequiredProperties = ["policyStoreId"];

/**
 * @member {String} policyStoreId
 */
DeletePolicyStoreInput.prototype['policyStoreId'] = undefined;
...
export default DeletePolicyStoreInput;
