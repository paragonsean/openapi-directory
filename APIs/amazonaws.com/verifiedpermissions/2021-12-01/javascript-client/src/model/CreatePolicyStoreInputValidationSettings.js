...
/**
 * The CreatePolicyStoreInputValidationSettings model module.
 * @module model/CreatePolicyStoreInputValidationSettings
 * @version 2021-12-01
 */
class CreatePolicyStoreInputValidationSettings {
    /**
     * Constructs a new <code>CreatePolicyStoreInputValidationSettings</code>.
     * @alias module:model/CreatePolicyStoreInputValidationSettings
     * @implements module:model/ValidationSettings
     * @param mode {module:model/ValidationMode} 
     */
    constructor(mode) { 
        ValidationSettings.initialize(this, mode);
        CreatePolicyStoreInputValidationSettings.initialize(this, mode);
    }
    ...
    /**
     * Constructs a <code>CreatePolicyStoreInputValidationSettings</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePolicyStoreInputValidationSettings} obj Optional instance to populate.
     * @return {module:model/CreatePolicyStoreInputValidationSettings} The populated <code>CreatePolicyStoreInputValidationSettings</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePolicyStoreInputValidationSettings();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePolicyStoreInputValidationSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePolicyStoreInputValidationSettings</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePolicyStoreInputValidationSettings.RequiredProperties) {
...
CreatePolicyStoreInputValidationSettings.RequiredProperties = ["mode"];

/**
 * @member {module:model/ValidationMode} mode
 */
CreatePolicyStoreInputValidationSettings.prototype['mode'] = undefined;
...
export default CreatePolicyStoreInputValidationSettings;
