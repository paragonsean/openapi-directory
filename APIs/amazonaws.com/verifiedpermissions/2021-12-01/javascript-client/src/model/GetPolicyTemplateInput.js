...
/**
 * The GetPolicyTemplateInput model module.
 * @module model/GetPolicyTemplateInput
 * @version 2021-12-01
 */
class GetPolicyTemplateInput {
    /**
     * Constructs a new <code>GetPolicyTemplateInput</code>.
     * @alias module:model/GetPolicyTemplateInput
     * @param policyStoreId {String} 
     * @param policyTemplateId {String} 
     */
    constructor(policyStoreId, policyTemplateId) { 
        
        GetPolicyTemplateInput.initialize(this, policyStoreId, policyTemplateId);
    }
     ...
     */
    static initialize(obj, policyStoreId, policyTemplateId) { 
        obj['policyStoreId'] = policyStoreId;
        obj['policyTemplateId'] = policyTemplateId;
    }

    /**
     * Constructs a <code>GetPolicyTemplateInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetPolicyTemplateInput} obj Optional instance to populate.
     * @return {module:model/GetPolicyTemplateInput} The populated <code>GetPolicyTemplateInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetPolicyTemplateInput();
    ...
    /**
     * Validates the JSON data with respect to <code>GetPolicyTemplateInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPolicyTemplateInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetPolicyTemplateInput.RequiredProperties) {
...
GetPolicyTemplateInput.RequiredProperties = ["policyStoreId", "policyTemplateId"];

/**
 * @member {String} policyStoreId
 */
GetPolicyTemplateInput.prototype['policyStoreId'] = undefined;

/**
 * @member {String} policyTemplateId
 */
GetPolicyTemplateInput.prototype['policyTemplateId'] = undefined;
...
export default GetPolicyTemplateInput;
