...
* @readonly
*/
export default class ValidationMode {
    ...
    /**
    * Returns a <code>ValidationMode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ValidationMode} The enum <code>ValidationMode</code> value.
    */
