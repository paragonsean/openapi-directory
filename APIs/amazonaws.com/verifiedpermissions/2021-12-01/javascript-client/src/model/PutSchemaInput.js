...
import PutSchemaInputDefinition from './PutSchemaInputDefinition';

/**
 * The PutSchemaInput model module.
 * @module model/PutSchemaInput
 * @version 2021-12-01
 */
class PutSchemaInput {
    /**
     * Constructs a new <code>PutSchemaInput</code>.
     * @alias module:model/PutSchemaInput
     * @param policyStoreId {String} 
     * @param definition {module:model/PutSchemaInputDefinition} 
     */
    constructor(policyStoreId, definition) { 
        
        PutSchemaInput.initialize(this, policyStoreId, definition);
    }
     ...
     */
    static initialize(obj, policyStoreId, definition) { 
        obj['policyStoreId'] = policyStoreId;
        obj['definition'] = definition;
    }

    /**
     * Constructs a <code>PutSchemaInput</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PutSchemaInput} obj Optional instance to populate.
     * @return {module:model/PutSchemaInput} The populated <code>PutSchemaInput</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PutSchemaInput();

            if (data.hasOwnProperty('policyStoreId')) {
                obj['policyStoreId'] = ApiClient.convertToType(data['policyStoreId'], 'String');
            }
            if (data.hasOwnProperty('definition')) {
                obj['definition'] = PutSchemaInputDefinition.constructFromObject(data['definition']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PutSchemaInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PutSchemaInput</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PutSchemaInput.RequiredProperties) {
        ...
        if (data['definition']) { // data not null
          PutSchemaInputDefinition.validateJSON(data['definition']);
        }
...
PutSchemaInput.RequiredProperties = ["policyStoreId", "definition"];

/**
 * @member {String} policyStoreId
 */
PutSchemaInput.prototype['policyStoreId'] = undefined;

/**
 * @member {module:model/PutSchemaInputDefinition} definition
 */
PutSchemaInput.prototype['definition'] = undefined;
