...
class ApiClient {
     ...
     */
    constructor(basePath = 'http://verifiedpermissions.us-east-1.amazonaws.com') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default http://verifiedpermissions.us-east-1.amazonaws.com
         */
         ...
         */
        this.defaultHeaders = {
            'User-Agent': 'OpenAPI-Generator/2021-12-01/Javascript'
        };
    ...
    hostSettings() {
        return [
            ...
            },
            {
              ...
              'description': "The Amazon Verified Permissions endpoint for China (Beijing) and China (Ningxia)",
              'variables': {
                region: {
                    'description': "The AWS region",
