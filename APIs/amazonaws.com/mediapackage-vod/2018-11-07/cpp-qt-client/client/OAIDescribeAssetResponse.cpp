...
QString OAIDescribeAssetResponse::getArn() const {
    return m_arn;
}
void OAIDescribeAssetResponse::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIDescribeAssetResponse::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIDescribeAssetResponse::is_arn_Valid() const{
    return m_arn_isValid;
}

QString OAIDescribeAssetResponse::getCreatedAt() const {
    return m_created_at;
}
void OAIDescribeAssetResponse::setCreatedAt(const QString &created_at) {
    m_created_at = created_at;
    m_created_at_isSet = true;
}

bool OAIDescribeAssetResponse::is_created_at_Set() const{
    return m_created_at_isSet;
}

bool OAIDescribeAssetResponse::is_created_at_Valid() const{
    return m_created_at_isValid;
}

QList OAIDescribeAssetResponse::getEgressEndpoints() const {
    return m_egress_endpoints;
}
void OAIDescribeAssetResponse::setEgressEndpoints(const QList &egress_endpoints) {
    m_egress_endpoints = egress_endpoints;
    m_egress_endpoints_isSet = true;
}

bool OAIDescribeAssetResponse::is_egress_endpoints_Set() const{
    return m_egress_endpoints_isSet;
}

bool OAIDescribeAssetResponse::is_egress_endpoints_Valid() const{
    return m_egress_endpoints_isValid;
}

QString OAIDescribeAssetResponse::getId() const {
    return m_id;
}
void OAIDescribeAssetResponse::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIDescribeAssetResponse::is_id_Set() const{
    return m_id_isSet;
}

bool OAIDescribeAssetResponse::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIDescribeAssetResponse::getPackagingGroupId() const {
    return m_packaging_group_id;
}
void OAIDescribeAssetResponse::setPackagingGroupId(const QString &packaging_group_id) {
    m_packaging_group_id = packaging_group_id;
    m_packaging_group_id_isSet = true;
}

bool OAIDescribeAssetResponse::is_packaging_group_id_Set() const{
    return m_packaging_group_id_isSet;
}

bool OAIDescribeAssetResponse::is_packaging_group_id_Valid() const{
    return m_packaging_group_id_isValid;
}

QString OAIDescribeAssetResponse::getResourceId() const {
    return m_resource_id;
}
void OAIDescribeAssetResponse::setResourceId(const QString &resource_id) {
    m_resource_id = resource_id;
    m_resource_id_isSet = true;
}

bool OAIDescribeAssetResponse::is_resource_id_Set() const{
    return m_resource_id_isSet;
}

bool OAIDescribeAssetResponse::is_resource_id_Valid() const{
    return m_resource_id_isValid;
}

QString OAIDescribeAssetResponse::getSourceArn() const {
    return m_source_arn;
}
void OAIDescribeAssetResponse::setSourceArn(const QString &source_arn) {
    m_source_arn = source_arn;
    m_source_arn_isSet = true;
}

bool OAIDescribeAssetResponse::is_source_arn_Set() const{
    return m_source_arn_isSet;
}

bool OAIDescribeAssetResponse::is_source_arn_Valid() const{
    return m_source_arn_isValid;
}

QString OAIDescribeAssetResponse::getSourceRoleArn() const {
    return m_source_role_arn;
}
void OAIDescribeAssetResponse::setSourceRoleArn(const QString &source_role_arn) {
    m_source_role_arn = source_role_arn;
    m_source_role_arn_isSet = true;
}

bool OAIDescribeAssetResponse::is_source_role_arn_Set() const{
    return m_source_role_arn_isSet;
}

bool OAIDescribeAssetResponse::is_source_role_arn_Valid() const{
    return m_source_role_arn_isValid;
}

QMap OAIDescribeAssetResponse::getTags() const {
    return m_tags;
}
void OAIDescribeAssetResponse::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAIDescribeAssetResponse::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAIDescribeAssetResponse::is_tags_Valid() const{
