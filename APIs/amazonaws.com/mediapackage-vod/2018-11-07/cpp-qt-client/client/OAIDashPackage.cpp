...
OAIDashPackage::OAIDashPackage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDashPackage::OAIDashPackage() {
    this->initializeModel();
}

OAIDashPackage::~OAIDashPackage() {}

void OAIDashPackage::initializeModel() {
...
void OAIDashPackage::fromJson(QString jsonString) {
...
void OAIDashPackage::fromJsonObject(QJsonObject json) {
...
QString OAIDashPackage::asJson() const {
...
QJsonObject OAIDashPackage::asJsonObject() const {
    QJsonObject obj;
...
QList OAIDashPackage::getDashManifests() const {
    return m_dash_manifests;
}
void OAIDashPackage::setDashManifests(const QList &dash_manifests) {
    m_dash_manifests = dash_manifests;
    m_dash_manifests_isSet = true;
}

bool OAIDashPackage::is_dash_manifests_Set() const{
    return m_dash_manifests_isSet;
}

bool OAIDashPackage::is_dash_manifests_Valid() const{
    return m_dash_manifests_isValid;
}

OAICreatePackagingConfiguration_request_dashPackage_Encryption OAIDashPackage::getEncryption() const {
    return m_encryption;
}
void OAIDashPackage::setEncryption(const OAICreatePackagingConfiguration_request_dashPackage_Encryption &encryption) {
    m_encryption = encryption;
    m_encryption_isSet = true;
}

bool OAIDashPackage::is_encryption_Set() const{
    return m_encryption_isSet;
}

bool OAIDashPackage::is_encryption_Valid() const{
    return m_encryption_isValid;
}

bool OAIDashPackage::getIncludeEncoderConfigurationInSegments() const {
    return m_include_encoder_configuration_in_segments;
}
void OAIDashPackage::setIncludeEncoderConfigurationInSegments(const bool &include_encoder_configuration_in_segments) {
...
bool OAIDashPackage::is_include_encoder_configuration_in_segments_Set() const{
    return m_include_encoder_configuration_in_segments_isSet;
}

bool OAIDashPackage::is_include_encoder_configuration_in_segments_Valid() const{
    return m_include_encoder_configuration_in_segments_isValid;
}

bool OAIDashPackage::getIncludeIframeOnlyStream() const {
    return m_include_iframe_only_stream;
}
void OAIDashPackage::setIncludeIframeOnlyStream(const bool &include_iframe_only_stream) {
    m_include_iframe_only_stream = include_iframe_only_stream;
    m_include_iframe_only_stream_isSet = true;
}

bool OAIDashPackage::is_include_iframe_only_stream_Set() const{
    return m_include_iframe_only_stream_isSet;
}

bool OAIDashPackage::is_include_iframe_only_stream_Valid() const{
    return m_include_iframe_only_stream_isValid;
}

QList OAIDashPackage::getPeriodTriggers() const {
    return m_period_triggers;
}
void OAIDashPackage::setPeriodTriggers(const QList &period_triggers) {
    m_period_triggers = period_triggers;
    m_period_triggers_isSet = true;
}

bool OAIDashPackage::is_period_triggers_Set() const{
    return m_period_triggers_isSet;
}

bool OAIDashPackage::is_period_triggers_Valid() const{
    return m_period_triggers_isValid;
}

qint32 OAIDashPackage::getSegmentDurationSeconds() const {
    return m_segment_duration_seconds;
}
void OAIDashPackage::setSegmentDurationSeconds(const qint32 &segment_duration_seconds) {
    m_segment_duration_seconds = segment_duration_seconds;
    m_segment_duration_seconds_isSet = true;
}

bool OAIDashPackage::is_segment_duration_seconds_Set() const{
    return m_segment_duration_seconds_isSet;
}

bool OAIDashPackage::is_segment_duration_seconds_Valid() const{
    return m_segment_duration_seconds_isValid;
}

OAISegmentTemplateFormat OAIDashPackage::getSegmentTemplateFormat() const {
    return m_segment_template_format;
}
void OAIDashPackage::setSegmentTemplateFormat(const OAISegmentTemplateFormat &segment_template_format) {
    m_segment_template_format = segment_template_format;
    m_segment_template_format_isSet = true;
}

bool OAIDashPackage::is_segment_template_format_Set() const{
    return m_segment_template_format_isSet;
}

bool OAIDashPackage::is_segment_template_format_Valid() const{
    return m_segment_template_format_isValid;
}

bool OAIDashPackage::isSet() const {
...
bool OAIDashPackage::isValid() const {
