...
public class ApiClient {
    ...
    private String basePath = "http://mediapackage-vod.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://mediapackage-vod.{region}.amazonaws.com",
    ...
    new ServerConfiguration(
      "https://mediapackage-vod.{region}.amazonaws.com",
      "The MediaPackage Vod multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://mediapackage-vod.{region}.amazonaws.com.cn",
    ...
    new ServerConfiguration(
      "https://mediapackage-vod.{region}.amazonaws.com.cn",
      "The MediaPackage Vod endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2018-11-07/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://mediapackage-vod.us-east-1.amazonaws.com
