...
public class CreatePackagingConfigurationResponseDashPackage {
  ...
  public CreatePackagingConfigurationResponseDashPackage() {
  }

  public CreatePackagingConfigurationResponseDashPackage dashManifests(List dashManifests) {
  ...
  public CreatePackagingConfigurationResponseDashPackage encryption(CreatePackagingConfigurationRequestDashPackageEncryption encryption) {
  ...
  public CreatePackagingConfigurationResponseDashPackage includeEncoderConfigurationInSegments(Boolean includeEncoderConfigurationInSegments) {
  ...
  public CreatePackagingConfigurationResponseDashPackage includeIframeOnlyStream(Boolean includeIframeOnlyStream) {
  ...
  public CreatePackagingConfigurationResponseDashPackage periodTriggers(List periodTriggers) {
  ...
  public CreatePackagingConfigurationResponseDashPackage segmentDurationSeconds(Integer segmentDurationSeconds) {
  ...
  public CreatePackagingConfigurationResponseDashPackage segmentTemplateFormat(SegmentTemplateFormat segmentTemplateFormat) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePackagingConfigurationResponseDashPackage createPackagingConfigurationResponseDashPackage = (CreatePackagingConfigurationResponseDashPackage) o;
    return Objects.equals(this.dashManifests, createPackagingConfigurationResponseDashPackage.dashManifests) &&
        Objects.equals(this.encryption, createPackagingConfigurationResponseDashPackage.encryption) &&
        Objects.equals(this.includeEncoderConfigurationInSegments, createPackagingConfigurationResponseDashPackage.includeEncoderConfigurationInSegments) &&
        Objects.equals(this.includeIframeOnlyStream, createPackagingConfigurationResponseDashPackage.includeIframeOnlyStream) &&
        Objects.equals(this.periodTriggers, createPackagingConfigurationResponseDashPackage.periodTriggers) &&
        Objects.equals(this.segmentDurationSeconds, createPackagingConfigurationResponseDashPackage.segmentDurationSeconds) &&
        Objects.equals(this.segmentTemplateFormat, createPackagingConfigurationResponseDashPackage.segmentTemplateFormat);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePackagingConfigurationResponseDashPackage {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("DashManifests");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePackagingConfigurationResponseDashPackage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePackagingConfigurationResponseDashPackage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePackagingConfigurationResponseDashPackage is not found in the empty JSON string", CreatePackagingConfigurationResponseDashPackage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePackagingConfigurationResponseDashPackage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePackagingConfigurationResponseDashPackage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePackagingConfigurationResponseDashPackage.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `DashManifests`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePackagingConfigurationResponseDashPackage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePackagingConfigurationResponseDashPackage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePackagingConfigurationResponseDashPackage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePackagingConfigurationResponseDashPackage.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePackagingConfigurationResponseDashPackage>() {
           @Override
           public void write(JsonWriter out, CreatePackagingConfigurationResponseDashPackage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePackagingConfigurationResponseDashPackage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePackagingConfigurationResponseDashPackage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePackagingConfigurationResponseDashPackage
   * @throws IOException if the JSON string is invalid with respect to CreatePackagingConfigurationResponseDashPackage
   */
  public static CreatePackagingConfigurationResponseDashPackage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePackagingConfigurationResponseDashPackage.class);
  }

  /**
   * Convert an instance of CreatePackagingConfigurationResponseDashPackage to an JSON string
   *
   * @return JSON string
   */
