...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AwsElementalMediaPackageVod.ListAssetsResponse();
  });
  ...
  describe('ListAssetsResponse', function() {
    it('should create an instance of ListAssetsResponse', function() {
      ...
      //var instance = new AwsElementalMediaPackageVod.ListAssetsResponse();
      //expect(instance).to.be.a(AwsElementalMediaPackageVod.ListAssetsResponse);
    });
