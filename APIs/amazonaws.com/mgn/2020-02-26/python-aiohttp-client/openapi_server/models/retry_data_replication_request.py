...
class RetryDataReplicationRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """RetryDataReplicationRequest - a model defined in OpenAPI

        :param account_id: The account_id of this RetryDataReplicationRequest.
        :param source_server_id: The source_server_id of this RetryDataReplicationRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RetryDataReplicationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RetryDataReplication_request of this RetryDataReplicationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this RetryDataReplicationRequest.

        Retry data replication for Account ID.

        :return: The account_id of this RetryDataReplicationRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this RetryDataReplicationRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this RetryDataReplicationRequest.

        Retry data replication for Source Server ID.

        :return: The source_server_id of this RetryDataReplicationRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this RetryDataReplicationRequest.
