...
class StartReplicationRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """StartReplicationRequest - a model defined in OpenAPI

        :param account_id: The account_id of this StartReplicationRequest.
        :param source_server_id: The source_server_id of this StartReplicationRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StartReplicationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StartReplication_request of this StartReplicationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this StartReplicationRequest.

        Account ID on which to start replication.

        :return: The account_id of this StartReplicationRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this StartReplicationRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this StartReplicationRequest.

        ID of source server on which to start replication.

        :return: The source_server_id of this StartReplicationRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this StartReplicationRequest.
