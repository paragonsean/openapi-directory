...
class FinalizeCutoverRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """FinalizeCutoverRequest - a model defined in OpenAPI

        :param account_id: The account_id of this FinalizeCutoverRequest.
        :param source_server_id: The source_server_id of this FinalizeCutoverRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FinalizeCutoverRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FinalizeCutover_request of this FinalizeCutoverRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this FinalizeCutoverRequest.

        Request to finalize Cutover by Source Account ID.

        :return: The account_id of this FinalizeCutoverRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this FinalizeCutoverRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this FinalizeCutoverRequest.

        Request to finalize Cutover by Source Server ID.

        :return: The source_server_id of this FinalizeCutoverRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this FinalizeCutoverRequest.
