...
class GetLaunchConfigurationRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """GetLaunchConfigurationRequest - a model defined in OpenAPI

        :param account_id: The account_id of this GetLaunchConfigurationRequest.
        :param source_server_id: The source_server_id of this GetLaunchConfigurationRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetLaunchConfigurationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetLaunchConfiguration_request of this GetLaunchConfigurationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this GetLaunchConfigurationRequest.

        Request to get Launch Configuration information by Account ID.

        :return: The account_id of this GetLaunchConfigurationRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GetLaunchConfigurationRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this GetLaunchConfigurationRequest.

        Request to get Launch Configuration information by Source Server ID.

        :return: The source_server_id of this GetLaunchConfigurationRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this GetLaunchConfigurationRequest.
