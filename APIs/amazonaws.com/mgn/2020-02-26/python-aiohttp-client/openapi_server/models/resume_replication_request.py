...
class ResumeReplicationRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """ResumeReplicationRequest - a model defined in OpenAPI

        :param account_id: The account_id of this ResumeReplicationRequest.
        :param source_server_id: The source_server_id of this ResumeReplicationRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ResumeReplicationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ResumeReplication_request of this ResumeReplicationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this ResumeReplicationRequest.

        Resume Replication Request account ID.

        :return: The account_id of this ResumeReplicationRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this ResumeReplicationRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this ResumeReplicationRequest.

        Resume Replication Request source server ID.

        :return: The source_server_id of this ResumeReplicationRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this ResumeReplicationRequest.
