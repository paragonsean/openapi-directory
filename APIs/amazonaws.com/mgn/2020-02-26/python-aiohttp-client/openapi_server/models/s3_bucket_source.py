...
class S3BucketSource(Model):
    ...
    def __init__(self, s3_bucket: str=None, s3_bucket_owner: str=None, s3_key: str=None):
        ...
        :param s3_key: The s3_key of this S3BucketSource.
        """
        self.openapi_types = {
            's3_bucket': str,
            's3_bucket_owner': str,
    ...
    @property
    def s3_key(self):
        """Gets the s3_key of this S3BucketSource.


        :return: The s3_key of this S3BucketSource.
        :rtype: str
        """
        return self._s3_key
    ...
    def s3_key(self, s3_key):
        """Sets the s3_key of this S3BucketSource.
