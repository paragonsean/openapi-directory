...
class GetReplicationConfigurationRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """GetReplicationConfigurationRequest - a model defined in OpenAPI

        :param account_id: The account_id of this GetReplicationConfigurationRequest.
        :param source_server_id: The source_server_id of this GetReplicationConfigurationRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'GetReplicationConfigurationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The GetReplicationConfiguration_request of this GetReplicationConfigurationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this GetReplicationConfigurationRequest.

        Request to get Replication Configuration by Account ID.

        :return: The account_id of this GetReplicationConfigurationRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GetReplicationConfigurationRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this GetReplicationConfigurationRequest.

        Request to get Replication Configuration by Source Server ID.

        :return: The source_server_id of this GetReplicationConfigurationRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this GetReplicationConfigurationRequest.
