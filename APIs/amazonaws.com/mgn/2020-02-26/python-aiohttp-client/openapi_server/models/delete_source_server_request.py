...
class DeleteSourceServerRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """DeleteSourceServerRequest - a model defined in OpenAPI

        :param account_id: The account_id of this DeleteSourceServerRequest.
        :param source_server_id: The source_server_id of this DeleteSourceServerRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DeleteSourceServerRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DeleteSourceServer_request of this DeleteSourceServerRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this DeleteSourceServerRequest.

        Request to delete Source Server from service by Account ID.

        :return: The account_id of this DeleteSourceServerRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this DeleteSourceServerRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this DeleteSourceServerRequest.

        Request to delete Source Server from service by Server ID.

        :return: The source_server_id of this DeleteSourceServerRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this DeleteSourceServerRequest.
