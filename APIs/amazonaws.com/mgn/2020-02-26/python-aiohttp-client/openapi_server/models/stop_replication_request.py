...
class StopReplicationRequest(Model):
    ...
    def __init__(self, account_id: str=None, source_server_id: str=None):
        """StopReplicationRequest - a model defined in OpenAPI

        :param account_id: The account_id of this StopReplicationRequest.
        :param source_server_id: The source_server_id of this StopReplicationRequest.
        """
        self.openapi_types = {
            'account_id': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StopReplicationRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The StopReplication_request of this StopReplicationRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def account_id(self):
        """Gets the account_id of this StopReplicationRequest.

        Stop Replication Request account ID.

        :return: The account_id of this StopReplicationRequest.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this StopReplicationRequest.
    ...
    def source_server_id(self):
        """Gets the source_server_id of this StopReplicationRequest.

        Stop Replication Request source server ID.

        :return: The source_server_id of this StopReplicationRequest.
        :rtype: str
        """
    ...
    def source_server_id(self, source_server_id):
        """Sets the source_server_id of this StopReplicationRequest.
