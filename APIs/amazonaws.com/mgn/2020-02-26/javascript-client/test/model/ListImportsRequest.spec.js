...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.ListImportsRequest();
  });
  ...
  describe('ListImportsRequest', function() {
    it('should create an instance of ListImportsRequest', function() {
      // uncomment below and update the code to test ListImportsRequest
      //var instance = new ApplicationMigrationService.ListImportsRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.ListImportsRequest);
    });
