...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.DescribeSourceServersRequest();
  });
  ...
  describe('DescribeSourceServersRequest', function() {
    it('should create an instance of DescribeSourceServersRequest', function() {
      // uncomment below and update the code to test DescribeSourceServersRequest
      //var instance = new ApplicationMigrationService.DescribeSourceServersRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.DescribeSourceServersRequest);
    });
