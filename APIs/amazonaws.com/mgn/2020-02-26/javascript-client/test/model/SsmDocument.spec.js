...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.SsmDocument();
  });
  ...
  describe('SsmDocument', function() {
    it('should create an instance of SsmDocument', function() {
      // uncomment below and update the code to test SsmDocument
      //var instance = new ApplicationMigrationService.SsmDocument();
      //expect(instance).to.be.a(ApplicationMigrationService.SsmDocument);
    });
    ...
    it('should have the property ssmDocumentName (base name: "ssmDocumentName")', function() {
      // uncomment below and update the code to test the property ssmDocumentName
      //var instance = new ApplicationMigrationService.SsmDocument();
      //expect(instance).to.be();
    });
