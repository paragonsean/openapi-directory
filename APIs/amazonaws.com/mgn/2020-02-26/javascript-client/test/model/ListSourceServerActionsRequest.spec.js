...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.ListSourceServerActionsRequest();
  });
  ...
  describe('ListSourceServerActionsRequest', function() {
    it('should create an instance of ListSourceServerActionsRequest', function() {
      // uncomment below and update the code to test ListSourceServerActionsRequest
      //var instance = new ApplicationMigrationService.ListSourceServerActionsRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.ListSourceServerActionsRequest);
    });
