...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.TemplateActionDocument();
  });
  ...
  describe('TemplateActionDocument', function() {
    it('should create an instance of TemplateActionDocument', function() {
      // uncomment below and update the code to test TemplateActionDocument
      //var instance = new ApplicationMigrationService.TemplateActionDocument();
      //expect(instance).to.be.a(ApplicationMigrationService.TemplateActionDocument);
    });
