...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.PutTemplateActionRequest();
  });
  ...
  describe('PutTemplateActionRequest', function() {
    it('should create an instance of PutTemplateActionRequest', function() {
      // uncomment below and update the code to test PutTemplateActionRequest
      //var instance = new ApplicationMigrationService.PutTemplateActionRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.PutTemplateActionRequest);
    });
