...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.ListWavesRequest();
  });
  ...
  describe('ListWavesRequest', function() {
    it('should create an instance of ListWavesRequest', function() {
      // uncomment below and update the code to test ListWavesRequest
      //var instance = new ApplicationMigrationService.ListWavesRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.ListWavesRequest);
    });
