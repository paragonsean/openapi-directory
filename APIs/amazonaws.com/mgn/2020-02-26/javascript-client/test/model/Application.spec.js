...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.Application();
  });
  ...
  describe('Application', function() {
    it('should create an instance of Application', function() {
      ...
      //var instance = new ApplicationMigrationService.Application();
      //expect(instance).to.be.a(ApplicationMigrationService.Application);
    });

    it('should have the property applicationAggregatedStatus (base name: "applicationAggregatedStatus")', function() {
      // uncomment below and update the code to test the property applicationAggregatedStatus
      //var instance = new ApplicationMigrationService.Application();
