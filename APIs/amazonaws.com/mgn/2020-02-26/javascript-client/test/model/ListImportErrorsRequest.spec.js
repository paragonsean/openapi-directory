...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.ListImportErrorsRequest();
  });
  ...
  describe('ListImportErrorsRequest', function() {
    it('should create an instance of ListImportErrorsRequest', function() {
      // uncomment below and update the code to test ListImportErrorsRequest
      //var instance = new ApplicationMigrationService.ListImportErrorsRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.ListImportErrorsRequest);
    });
