...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.StartCutoverResponseJob();
  });
  ...
  describe('StartCutoverResponseJob', function() {
    it('should create an instance of StartCutoverResponseJob', function() {
      // uncomment below and update the code to test StartCutoverResponseJob
      //var instance = new ApplicationMigrationService.StartCutoverResponseJob();
      //expect(instance).to.be.a(ApplicationMigrationService.StartCutoverResponseJob);
    });
