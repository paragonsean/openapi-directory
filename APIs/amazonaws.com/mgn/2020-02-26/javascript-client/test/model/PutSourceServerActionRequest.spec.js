...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.PutSourceServerActionRequest();
  });
  ...
  describe('PutSourceServerActionRequest', function() {
    it('should create an instance of PutSourceServerActionRequest', function() {
      // uncomment below and update the code to test PutSourceServerActionRequest
      //var instance = new ApplicationMigrationService.PutSourceServerActionRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.PutSourceServerActionRequest);
    });
