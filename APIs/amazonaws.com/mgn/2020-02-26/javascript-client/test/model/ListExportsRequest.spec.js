...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.ListExportsRequest();
  });
  ...
  describe('ListExportsRequest', function() {
    it('should create an instance of ListExportsRequest', function() {
      // uncomment below and update the code to test ListExportsRequest
      //var instance = new ApplicationMigrationService.ListExportsRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.ListExportsRequest);
    });
