...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.JobPostLaunchActionsLaunchStatusSsmDocument();
  });
  ...
  describe('JobPostLaunchActionsLaunchStatusSsmDocument', function() {
    it('should create an instance of JobPostLaunchActionsLaunchStatusSsmDocument', function() {
      // uncomment below and update the code to test JobPostLaunchActionsLaunchStatusSsmDocument
      //var instance = new ApplicationMigrationService.JobPostLaunchActionsLaunchStatusSsmDocument();
      //expect(instance).to.be.a(ApplicationMigrationService.JobPostLaunchActionsLaunchStatusSsmDocument);
    });
