...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.CreateReplicationConfigurationTemplateRequest();
  });
  ...
  describe('CreateReplicationConfigurationTemplateRequest', function() {
    it('should create an instance of CreateReplicationConfigurationTemplateRequest', function() {
      // uncomment below and update the code to test CreateReplicationConfigurationTemplateRequest
      //var instance = new ApplicationMigrationService.CreateReplicationConfigurationTemplateRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.CreateReplicationConfigurationTemplateRequest);
    });
