...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.TerminateTargetInstancesResponseJob();
  });
  ...
  describe('TerminateTargetInstancesResponseJob', function() {
    it('should create an instance of TerminateTargetInstancesResponseJob', function() {
      // uncomment below and update the code to test TerminateTargetInstancesResponseJob
      //var instance = new ApplicationMigrationService.TerminateTargetInstancesResponseJob();
      //expect(instance).to.be.a(ApplicationMigrationService.TerminateTargetInstancesResponseJob);
    });
