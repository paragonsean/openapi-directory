...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.Disk();
  });
  ...
  describe('Disk', function() {
    it('should create an instance of Disk', function() {
      ...
      //var instance = new ApplicationMigrationService.Disk();
      //expect(instance).to.be.a(ApplicationMigrationService.Disk);
    });
