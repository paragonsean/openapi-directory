...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.ListExportErrorsRequest();
  });
  ...
  describe('ListExportErrorsRequest', function() {
    it('should create an instance of ListExportErrorsRequest', function() {
      // uncomment below and update the code to test ListExportErrorsRequest
      //var instance = new ApplicationMigrationService.ListExportErrorsRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.ListExportErrorsRequest);
    });
