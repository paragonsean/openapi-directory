...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApplicationMigrationService.UpdateReplicationConfigurationTemplateRequest();
  });
  ...
  describe('UpdateReplicationConfigurationTemplateRequest', function() {
    it('should create an instance of UpdateReplicationConfigurationTemplateRequest', function() {
      // uncomment below and update the code to test UpdateReplicationConfigurationTemplateRequest
      //var instance = new ApplicationMigrationService.UpdateReplicationConfigurationTemplateRequest();
      //expect(instance).to.be.a(ApplicationMigrationService.UpdateReplicationConfigurationTemplateRequest);
    });
