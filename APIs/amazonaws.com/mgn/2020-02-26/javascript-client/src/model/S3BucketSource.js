...
/**
 * The S3BucketSource model module.
 * @module model/S3BucketSource
 * @version 2020-02-26
 */
class S3BucketSource {
    /**
     * Constructs a new <code>S3BucketSource</code>.
     * S3 bucket source.
     * @alias module:model/S3BucketSource
    ...
    /**
     * Constructs a <code>S3BucketSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/S3BucketSource} obj Optional instance to populate.
     * @return {module:model/S3BucketSource} The populated <code>S3BucketSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new S3BucketSource();
    ...
    /**
     * Validates the JSON data with respect to <code>S3BucketSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>S3BucketSource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of S3BucketSource.RequiredProperties) {
...
S3BucketSource.RequiredProperties = ["s3Bucket", "s3Key"];
