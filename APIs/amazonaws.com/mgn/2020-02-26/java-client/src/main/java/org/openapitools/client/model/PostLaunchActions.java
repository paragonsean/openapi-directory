...
public class PostLaunchActions {
  ...
  public PostLaunchActions cloudWatchLogGroupName(String cloudWatchLogGroupName) {
  ...
  public PostLaunchActions deployment(PostLaunchActionsDeploymentType deployment) {
  ...
  public PostLaunchActions s3LogBucket(String s3LogBucket) {
  ...
  public PostLaunchActions s3OutputKeyPrefix(String s3OutputKeyPrefix) {
  ...
  public PostLaunchActions ssmDocuments(List ssmDocuments) {
  ...
  public boolean equals(Object o) {
    ...
    PostLaunchActions postLaunchActions = (PostLaunchActions) o;
    return Objects.equals(this.cloudWatchLogGroupName, postLaunchActions.cloudWatchLogGroupName) &&
        Objects.equals(this.deployment, postLaunchActions.deployment) &&
        Objects.equals(this.s3LogBucket, postLaunchActions.s3LogBucket) &&
        Objects.equals(this.s3OutputKeyPrefix, postLaunchActions.s3OutputKeyPrefix) &&
        Objects.equals(this.ssmDocuments, postLaunchActions.ssmDocuments);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostLaunchActions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostLaunchActions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostLaunchActions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostLaunchActions is not found in the empty JSON string", PostLaunchActions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostLaunchActions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostLaunchActions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostLaunchActions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostLaunchActions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostLaunchActions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostLaunchActions.class));

       return (TypeAdapter<T>) new TypeAdapter<PostLaunchActions>() {
           @Override
           public void write(JsonWriter out, PostLaunchActions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostLaunchActions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostLaunchActions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostLaunchActions
   * @throws IOException if the JSON string is invalid with respect to PostLaunchActions
   */
  public static PostLaunchActions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostLaunchActions.class);
  }

  /**
   * Convert an instance of PostLaunchActions to an JSON string
   *
   * @return JSON string
   */
