...
public class NetworkInterface {
  ...
  public NetworkInterface ips(List ips) {
    this.ips = ips;
    return this;
  }
  ...
  public NetworkInterface isPrimary(Boolean isPrimary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ips, networkInterface.ips) &&
        Objects.equals(this.isPrimary, networkInterface.isPrimary) &&
        Objects.equals(this.macAddress, networkInterface.macAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ips, isPrimary, macAddress);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("ips") != null && !jsonObj.get("ips").isJsonNull()) {
        List.validateJsonElement(jsonObj.get("ips"));
      }
