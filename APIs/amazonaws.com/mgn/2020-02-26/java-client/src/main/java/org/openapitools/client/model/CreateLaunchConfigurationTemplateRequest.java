...
public class CreateLaunchConfigurationTemplateRequest {
  ...
  public CreateLaunchConfigurationTemplateRequest associatePublicIpAddress(Boolean associatePublicIpAddress) {
  ...
  public CreateLaunchConfigurationTemplateRequest bootMode(BootModeEnum bootMode) {
  ...
  public CreateLaunchConfigurationTemplateRequest copyPrivateIp(Boolean copyPrivateIp) {
  ...
  public CreateLaunchConfigurationTemplateRequest copyTags(Boolean copyTags) {
  ...
  public CreateLaunchConfigurationTemplateRequest enableMapAutoTagging(Boolean enableMapAutoTagging) {
  ...
  public CreateLaunchConfigurationTemplateRequest largeVolumeConf(CreateLaunchConfigurationTemplateRequestLargeVolumeConf largeVolumeConf) {
  ...
  public CreateLaunchConfigurationTemplateRequest launchDisposition(LaunchDispositionEnum launchDisposition) {
  ...
  public CreateLaunchConfigurationTemplateRequest licensing(CreateLaunchConfigurationTemplateRequestLicensing licensing) {
  ...
  public CreateLaunchConfigurationTemplateRequest mapAutoTaggingMpeID(String mapAutoTaggingMpeID) {
  ...
  public CreateLaunchConfigurationTemplateRequest postLaunchActions(CreateLaunchConfigurationTemplateRequestPostLaunchActions postLaunchActions) {
  ...
  public CreateLaunchConfigurationTemplateRequest smallVolumeConf(CreateLaunchConfigurationTemplateRequestLargeVolumeConf smallVolumeConf) {
  ...
  public CreateLaunchConfigurationTemplateRequest smallVolumeMaxSize(Integer smallVolumeMaxSize) {
  ...
  public CreateLaunchConfigurationTemplateRequest tags(Map<String, String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateLaunchConfigurationTemplateRequest putTagsItem(String key, String tagsItem) {
    if (this.tags == null) {
  ...
  public CreateLaunchConfigurationTemplateRequest targetInstanceTypeRightSizingMethod(TargetInstanceTypeRightSizingMethodEnum targetInstanceTypeRightSizingMethod) {
  ...
  public boolean equals(Object o) {
    ...
    CreateLaunchConfigurationTemplateRequest createLaunchConfigurationTemplateRequest = (CreateLaunchConfigurationTemplateRequest) o;
    return Objects.equals(this.associatePublicIpAddress, createLaunchConfigurationTemplateRequest.associatePublicIpAddress) &&
        Objects.equals(this.bootMode, createLaunchConfigurationTemplateRequest.bootMode) &&
        Objects.equals(this.copyPrivateIp, createLaunchConfigurationTemplateRequest.copyPrivateIp) &&
        Objects.equals(this.copyTags, createLaunchConfigurationTemplateRequest.copyTags) &&
        Objects.equals(this.enableMapAutoTagging, createLaunchConfigurationTemplateRequest.enableMapAutoTagging) &&
        Objects.equals(this.largeVolumeConf, createLaunchConfigurationTemplateRequest.largeVolumeConf) &&
        Objects.equals(this.launchDisposition, createLaunchConfigurationTemplateRequest.launchDisposition) &&
        Objects.equals(this.licensing, createLaunchConfigurationTemplateRequest.licensing) &&
        Objects.equals(this.mapAutoTaggingMpeID, createLaunchConfigurationTemplateRequest.mapAutoTaggingMpeID) &&
        Objects.equals(this.postLaunchActions, createLaunchConfigurationTemplateRequest.postLaunchActions) &&
        Objects.equals(this.smallVolumeConf, createLaunchConfigurationTemplateRequest.smallVolumeConf) &&
        Objects.equals(this.smallVolumeMaxSize, createLaunchConfigurationTemplateRequest.smallVolumeMaxSize) &&
        Objects.equals(this.tags, createLaunchConfigurationTemplateRequest.tags) &&
        Objects.equals(this.targetInstanceTypeRightSizingMethod, createLaunchConfigurationTemplateRequest.targetInstanceTypeRightSizingMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(associatePublicIpAddress, bootMode, copyPrivateIp, copyTags, enableMapAutoTagging, largeVolumeConf, launchDisposition, licensing, mapAutoTaggingMpeID, postLaunchActions, smallVolumeConf, smallVolumeMaxSize, tags, targetInstanceTypeRightSizingMethod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateLaunchConfigurationTemplateRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLaunchConfigurationTemplateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLaunchConfigurationTemplateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLaunchConfigurationTemplateRequest is not found in the empty JSON string", CreateLaunchConfigurationTemplateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLaunchConfigurationTemplateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLaunchConfigurationTemplateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLaunchConfigurationTemplateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLaunchConfigurationTemplateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLaunchConfigurationTemplateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLaunchConfigurationTemplateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLaunchConfigurationTemplateRequest>() {
           @Override
           public void write(JsonWriter out, CreateLaunchConfigurationTemplateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLaunchConfigurationTemplateRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLaunchConfigurationTemplateRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLaunchConfigurationTemplateRequest
   * @throws IOException if the JSON string is invalid with respect to CreateLaunchConfigurationTemplateRequest
   */
  public static CreateLaunchConfigurationTemplateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLaunchConfigurationTemplateRequest.class);
  }

  /**
   * Convert an instance of CreateLaunchConfigurationTemplateRequest to an JSON string
   *
   * @return JSON string
   */
