...
public class WaveAggregatedStatus {
  ...
  public WaveAggregatedStatus healthStatus(WaveHealthStatus healthStatus) {
  ...
  public WaveAggregatedStatus lastUpdateDateTime(String lastUpdateDateTime) {
  ...
  public WaveAggregatedStatus progressStatus(WaveProgressStatus progressStatus) {
  ...
  public WaveAggregatedStatus replicationStartedDateTime(String replicationStartedDateTime) {
  ...
  public WaveAggregatedStatus totalApplications(Integer totalApplications) {
  ...
  public boolean equals(Object o) {
    ...
    WaveAggregatedStatus waveAggregatedStatus = (WaveAggregatedStatus) o;
    return Objects.equals(this.healthStatus, waveAggregatedStatus.healthStatus) &&
        Objects.equals(this.lastUpdateDateTime, waveAggregatedStatus.lastUpdateDateTime) &&
        Objects.equals(this.progressStatus, waveAggregatedStatus.progressStatus) &&
        Objects.equals(this.replicationStartedDateTime, waveAggregatedStatus.replicationStartedDateTime) &&
        Objects.equals(this.totalApplications, waveAggregatedStatus.totalApplications);
  }
  ...
  public String toString() {
    ...
    sb.append("class WaveAggregatedStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WaveAggregatedStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WaveAggregatedStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WaveAggregatedStatus is not found in the empty JSON string", WaveAggregatedStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WaveAggregatedStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WaveAggregatedStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WaveAggregatedStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WaveAggregatedStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WaveAggregatedStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WaveAggregatedStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<WaveAggregatedStatus>() {
           @Override
           public void write(JsonWriter out, WaveAggregatedStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WaveAggregatedStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WaveAggregatedStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WaveAggregatedStatus
   * @throws IOException if the JSON string is invalid with respect to WaveAggregatedStatus
   */
  public static WaveAggregatedStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WaveAggregatedStatus.class);
  }

  /**
   * Convert an instance of WaveAggregatedStatus to an JSON string
   *
   * @return JSON string
   */
