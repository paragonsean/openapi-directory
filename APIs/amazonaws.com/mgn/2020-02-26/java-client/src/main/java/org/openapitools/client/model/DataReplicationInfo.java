...
public class DataReplicationInfo {
  ...
  public DataReplicationInfo dataReplicationError(DataReplicationInfoDataReplicationError dataReplicationError) {
  ...
  public DataReplicationInfo dataReplicationInitiation(DataReplicationInfoDataReplicationInitiation dataReplicationInitiation) {
  ...
  public DataReplicationInfo dataReplicationState(DataReplicationState dataReplicationState) {
  ...
  public DataReplicationInfo etaDateTime(String etaDateTime) {
  ...
  public DataReplicationInfo lagDuration(String lagDuration) {
  ...
  public DataReplicationInfo lastSnapshotDateTime(String lastSnapshotDateTime) {
  ...
  public DataReplicationInfo replicatedDisks(List replicatedDisks) {
  ...
  public boolean equals(Object o) {
    ...
    DataReplicationInfo dataReplicationInfo = (DataReplicationInfo) o;
    return Objects.equals(this.dataReplicationError, dataReplicationInfo.dataReplicationError) &&
        Objects.equals(this.dataReplicationInitiation, dataReplicationInfo.dataReplicationInitiation) &&
        Objects.equals(this.dataReplicationState, dataReplicationInfo.dataReplicationState) &&
        Objects.equals(this.etaDateTime, dataReplicationInfo.etaDateTime) &&
        Objects.equals(this.lagDuration, dataReplicationInfo.lagDuration) &&
        Objects.equals(this.lastSnapshotDateTime, dataReplicationInfo.lastSnapshotDateTime) &&
        Objects.equals(this.replicatedDisks, dataReplicationInfo.replicatedDisks);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataReplicationInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DataReplicationInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataReplicationInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataReplicationInfo is not found in the empty JSON string", DataReplicationInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DataReplicationInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataReplicationInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DataReplicationInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DataReplicationInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DataReplicationInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataReplicationInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<DataReplicationInfo>() {
           @Override
           public void write(JsonWriter out, DataReplicationInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DataReplicationInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DataReplicationInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DataReplicationInfo
   * @throws IOException if the JSON string is invalid with respect to DataReplicationInfo
   */
  public static DataReplicationInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DataReplicationInfo.class);
  }

  /**
   * Convert an instance of DataReplicationInfo to an JSON string
   *
   * @return JSON string
   */
