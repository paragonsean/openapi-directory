...
/*
 * OAIUpdateLaunchConfigurationTemplateRequest.h
 *
 * 
 */

#ifndef OAIUpdateLaunchConfigurationTemplateRequest_H
#define OAIUpdateLaunchConfigurationTemplateRequest_H
...
class OAILicensing;
class OAIUpdateLaunchConfigurationTemplateRequest_postLaunchActions;
class OAILaunchConfigurationTemplate_smallVolumeConf;

class OAIUpdateLaunchConfigurationTemplateRequest : public OAIObject {
public:
    OAIUpdateLaunchConfigurationTemplateRequest();
    OAIUpdateLaunchConfigurationTemplateRequest(QString json);
    ~OAIUpdateLaunchConfigurationTemplateRequest() override;
    ...
    OAIUpdateLaunchConfigurationTemplateRequest_postLaunchActions getPostLaunchActions() const;
    void setPostLaunchActions(const OAIUpdateLaunchConfigurationTemplateRequest_postLaunchActions &post_launch_actions);
...
private:
    ...
    OAIUpdateLaunchConfigurationTemplateRequest_postLaunchActions m_post_launch_actions;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLaunchConfigurationTemplateRequest)

#endif // OAIUpdateLaunchConfigurationTemplateRequest_H
