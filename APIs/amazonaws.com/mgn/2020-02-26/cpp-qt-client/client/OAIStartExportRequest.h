...
/*
 * OAIStartExportRequest.h
 *
 * Start export request.
 */

#ifndef OAIStartExportRequest_H
#define OAIStartExportRequest_H
...
class OAIStartExportRequest : public OAIObject {
public:
    OAIStartExportRequest();
    OAIStartExportRequest(QString json);
    ~OAIStartExportRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartExportRequest)

#endif // OAIStartExportRequest_H
