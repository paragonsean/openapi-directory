...
/*
 * OAIDescribeSourceServersRequestFilters.h
 *
 * Request to filter Source Servers list.
 */

#ifndef OAIDescribeSourceServersRequestFilters_H
#define OAIDescribeSourceServersRequestFilters_H
...
class OAIDescribeSourceServersRequestFilters : public OAIObject {
public:
    OAIDescribeSourceServersRequestFilters();
    OAIDescribeSourceServersRequestFilters(QString json);
    ~OAIDescribeSourceServersRequestFilters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSourceServersRequestFilters)

#endif // OAIDescribeSourceServersRequestFilters_H
