...
/*
 * OAIPutSourceServerActionRequest.h
 *
 * 
 */

#ifndef OAIPutSourceServerActionRequest_H
#define OAIPutSourceServerActionRequest_H
...
class OAIPutSourceServerActionRequest : public OAIObject {
public:
    OAIPutSourceServerActionRequest();
    OAIPutSourceServerActionRequest(QString json);
    ~OAIPutSourceServerActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutSourceServerActionRequest)

#endif // OAIPutSourceServerActionRequest_H
