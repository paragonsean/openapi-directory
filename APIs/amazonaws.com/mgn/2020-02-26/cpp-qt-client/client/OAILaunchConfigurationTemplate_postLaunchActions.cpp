...
OAILaunchConfigurationTemplate_postLaunchActions::OAILaunchConfigurationTemplate_postLaunchActions(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILaunchConfigurationTemplate_postLaunchActions::OAILaunchConfigurationTemplate_postLaunchActions() {
    this->initializeModel();
}

OAILaunchConfigurationTemplate_postLaunchActions::~OAILaunchConfigurationTemplate_postLaunchActions() {}

void OAILaunchConfigurationTemplate_postLaunchActions::initializeModel() {
...
void OAILaunchConfigurationTemplate_postLaunchActions::fromJson(QString jsonString) {
...
void OAILaunchConfigurationTemplate_postLaunchActions::fromJsonObject(QJsonObject json) {
...
QString OAILaunchConfigurationTemplate_postLaunchActions::asJson() const {
...
QJsonObject OAILaunchConfigurationTemplate_postLaunchActions::asJsonObject() const {
    QJsonObject obj;
...
QString OAILaunchConfigurationTemplate_postLaunchActions::getCloudWatchLogGroupName() const {
    return m_cloud_watch_log_group_name;
}
void OAILaunchConfigurationTemplate_postLaunchActions::setCloudWatchLogGroupName(const QString &cloud_watch_log_group_name) {
    m_cloud_watch_log_group_name = cloud_watch_log_group_name;
    m_cloud_watch_log_group_name_isSet = true;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_cloud_watch_log_group_name_Set() const{
    return m_cloud_watch_log_group_name_isSet;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_cloud_watch_log_group_name_Valid() const{
    return m_cloud_watch_log_group_name_isValid;
}

OAIPostLaunchActionsDeploymentType OAILaunchConfigurationTemplate_postLaunchActions::getDeployment() const {
    return m_deployment;
}
void OAILaunchConfigurationTemplate_postLaunchActions::setDeployment(const OAIPostLaunchActionsDeploymentType &deployment) {
    m_deployment = deployment;
    m_deployment_isSet = true;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_deployment_Set() const{
    return m_deployment_isSet;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_deployment_Valid() const{
    return m_deployment_isValid;
}

QString OAILaunchConfigurationTemplate_postLaunchActions::getS3LogBucket() const {
    return m_s3_log_bucket;
}
void OAILaunchConfigurationTemplate_postLaunchActions::setS3LogBucket(const QString &s3_log_bucket) {
    m_s3_log_bucket = s3_log_bucket;
    m_s3_log_bucket_isSet = true;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_s3_log_bucket_Set() const{
    return m_s3_log_bucket_isSet;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_s3_log_bucket_Valid() const{
    return m_s3_log_bucket_isValid;
}

QString OAILaunchConfigurationTemplate_postLaunchActions::getS3OutputKeyPrefix() const {
    return m_s3_output_key_prefix;
}
void OAILaunchConfigurationTemplate_postLaunchActions::setS3OutputKeyPrefix(const QString &s3_output_key_prefix) {
    m_s3_output_key_prefix = s3_output_key_prefix;
    m_s3_output_key_prefix_isSet = true;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_s3_output_key_prefix_Set() const{
    return m_s3_output_key_prefix_isSet;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_s3_output_key_prefix_Valid() const{
    return m_s3_output_key_prefix_isValid;
}

QList OAILaunchConfigurationTemplate_postLaunchActions::getSsmDocuments() const {
    return m_ssm_documents;
}
void OAILaunchConfigurationTemplate_postLaunchActions::setSsmDocuments(const QList &ssm_documents) {
    m_ssm_documents = ssm_documents;
    m_ssm_documents_isSet = true;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_ssm_documents_Set() const{
    return m_ssm_documents_isSet;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::is_ssm_documents_Valid() const{
    return m_ssm_documents_isValid;
}

bool OAILaunchConfigurationTemplate_postLaunchActions::isSet() const {
...
bool OAILaunchConfigurationTemplate_postLaunchActions::isValid() const {
