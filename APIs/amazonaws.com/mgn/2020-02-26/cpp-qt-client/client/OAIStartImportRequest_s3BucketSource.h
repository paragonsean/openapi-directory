...
/*
 * OAIStartImportRequest_s3BucketSource.h
 *
 * 
 */

#ifndef OAIStartImportRequest_s3BucketSource_H
#define OAIStartImportRequest_s3BucketSource_H
...
class OAIStartImportRequest_s3BucketSource : public OAIObject {
public:
    OAIStartImportRequest_s3BucketSource();
    OAIStartImportRequest_s3BucketSource(QString json);
    ~OAIStartImportRequest_s3BucketSource() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartImportRequest_s3BucketSource)

#endif // OAIStartImportRequest_s3BucketSource_H
