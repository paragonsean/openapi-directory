...
OAILaunchConfigurationTemplate::OAILaunchConfigurationTemplate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILaunchConfigurationTemplate::OAILaunchConfigurationTemplate() {
    this->initializeModel();
}

OAILaunchConfigurationTemplate::~OAILaunchConfigurationTemplate() {}

void OAILaunchConfigurationTemplate::initializeModel() {
...
void OAILaunchConfigurationTemplate::fromJson(QString jsonString) {
...
void OAILaunchConfigurationTemplate::fromJsonObject(QJsonObject json) {
...
QString OAILaunchConfigurationTemplate::asJson() const {
...
QJsonObject OAILaunchConfigurationTemplate::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAILaunchConfigurationTemplate::getArn() const {
    return m_arn;
}
void OAILaunchConfigurationTemplate::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAILaunchConfigurationTemplate::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAILaunchConfigurationTemplate::getAssociatePublicIpAddress() const {
    return m_associate_public_ip_address;
}
void OAILaunchConfigurationTemplate::setAssociatePublicIpAddress(const bool &associate_public_ip_address) {
    m_associate_public_ip_address = associate_public_ip_address;
    m_associate_public_ip_address_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_associate_public_ip_address_Set() const{
    return m_associate_public_ip_address_isSet;
}

bool OAILaunchConfigurationTemplate::is_associate_public_ip_address_Valid() const{
    return m_associate_public_ip_address_isValid;
}

OAIBootMode OAILaunchConfigurationTemplate::getBootMode() const {
    return m_boot_mode;
}
void OAILaunchConfigurationTemplate::setBootMode(const OAIBootMode &boot_mode) {
    m_boot_mode = boot_mode;
    m_boot_mode_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_boot_mode_Set() const{
    return m_boot_mode_isSet;
}

bool OAILaunchConfigurationTemplate::is_boot_mode_Valid() const{
    return m_boot_mode_isValid;
}

bool OAILaunchConfigurationTemplate::getCopyPrivateIp() const {
    return m_copy_private_ip;
}
void OAILaunchConfigurationTemplate::setCopyPrivateIp(const bool &copy_private_ip) {
    m_copy_private_ip = copy_private_ip;
    m_copy_private_ip_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_copy_private_ip_Set() const{
    return m_copy_private_ip_isSet;
}

bool OAILaunchConfigurationTemplate::is_copy_private_ip_Valid() const{
    return m_copy_private_ip_isValid;
}

bool OAILaunchConfigurationTemplate::getCopyTags() const {
    return m_copy_tags;
}
void OAILaunchConfigurationTemplate::setCopyTags(const bool &copy_tags) {
    m_copy_tags = copy_tags;
    m_copy_tags_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_copy_tags_Set() const{
    return m_copy_tags_isSet;
}

bool OAILaunchConfigurationTemplate::is_copy_tags_Valid() const{
    return m_copy_tags_isValid;
}

QString OAILaunchConfigurationTemplate::getEc2LaunchTemplateId() const {
    return m_ec2_launch_template_id;
}
void OAILaunchConfigurationTemplate::setEc2LaunchTemplateId(const QString &ec2_launch_template_id) {
    m_ec2_launch_template_id = ec2_launch_template_id;
    m_ec2_launch_template_id_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_ec2_launch_template_id_Set() const{
    return m_ec2_launch_template_id_isSet;
}

bool OAILaunchConfigurationTemplate::is_ec2_launch_template_id_Valid() const{
    return m_ec2_launch_template_id_isValid;
}

bool OAILaunchConfigurationTemplate::getEnableMapAutoTagging() const {
    return m_enable_map_auto_tagging;
}
void OAILaunchConfigurationTemplate::setEnableMapAutoTagging(const bool &enable_map_auto_tagging) {
    m_enable_map_auto_tagging = enable_map_auto_tagging;
    m_enable_map_auto_tagging_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_enable_map_auto_tagging_Set() const{
    return m_enable_map_auto_tagging_isSet;
}

bool OAILaunchConfigurationTemplate::is_enable_map_auto_tagging_Valid() const{
    return m_enable_map_auto_tagging_isValid;
}

OAILaunchConfigurationTemplate_largeVolumeConf OAILaunchConfigurationTemplate::getLargeVolumeConf() const {
    return m_large_volume_conf;
}
void OAILaunchConfigurationTemplate::setLargeVolumeConf(const OAILaunchConfigurationTemplate_largeVolumeConf &large_volume_conf) {
    m_large_volume_conf = large_volume_conf;
    m_large_volume_conf_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_large_volume_conf_Set() const{
    return m_large_volume_conf_isSet;
}

bool OAILaunchConfigurationTemplate::is_large_volume_conf_Valid() const{
    return m_large_volume_conf_isValid;
}

QString OAILaunchConfigurationTemplate::getLaunchConfigurationTemplateId() const {
    return m_launch_configuration_template_id;
}
void OAILaunchConfigurationTemplate::setLaunchConfigurationTemplateId(const QString &launch_configuration_template_id) {
    m_launch_configuration_template_id = launch_configuration_template_id;
    m_launch_configuration_template_id_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_launch_configuration_template_id_Set() const{
    return m_launch_configuration_template_id_isSet;
}

bool OAILaunchConfigurationTemplate::is_launch_configuration_template_id_Valid() const{
    return m_launch_configuration_template_id_isValid;
}

OAILaunchDisposition OAILaunchConfigurationTemplate::getLaunchDisposition() const {
    return m_launch_disposition;
}
void OAILaunchConfigurationTemplate::setLaunchDisposition(const OAILaunchDisposition &launch_disposition) {
    m_launch_disposition = launch_disposition;
    m_launch_disposition_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_launch_disposition_Set() const{
    return m_launch_disposition_isSet;
}

bool OAILaunchConfigurationTemplate::is_launch_disposition_Valid() const{
    return m_launch_disposition_isValid;
}

OAILicensing OAILaunchConfigurationTemplate::getLicensing() const {
    return m_licensing;
}
void OAILaunchConfigurationTemplate::setLicensing(const OAILicensing &licensing) {
    m_licensing = licensing;
    m_licensing_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_licensing_Set() const{
    return m_licensing_isSet;
}

bool OAILaunchConfigurationTemplate::is_licensing_Valid() const{
    return m_licensing_isValid;
}

QString OAILaunchConfigurationTemplate::getMapAutoTaggingMpeId() const {
    return m_map_auto_tagging_mpe_id;
}
void OAILaunchConfigurationTemplate::setMapAutoTaggingMpeId(const QString &map_auto_tagging_mpe_id) {
    m_map_auto_tagging_mpe_id = map_auto_tagging_mpe_id;
    m_map_auto_tagging_mpe_id_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_map_auto_tagging_mpe_id_Set() const{
    return m_map_auto_tagging_mpe_id_isSet;
}

bool OAILaunchConfigurationTemplate::is_map_auto_tagging_mpe_id_Valid() const{
    return m_map_auto_tagging_mpe_id_isValid;
}

OAILaunchConfigurationTemplate_postLaunchActions OAILaunchConfigurationTemplate::getPostLaunchActions() const {
    return m_post_launch_actions;
}
void OAILaunchConfigurationTemplate::setPostLaunchActions(const OAILaunchConfigurationTemplate_postLaunchActions &post_launch_actions) {
    m_post_launch_actions = post_launch_actions;
    m_post_launch_actions_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_post_launch_actions_Set() const{
    return m_post_launch_actions_isSet;
}

bool OAILaunchConfigurationTemplate::is_post_launch_actions_Valid() const{
    return m_post_launch_actions_isValid;
}

OAILaunchConfigurationTemplate_smallVolumeConf OAILaunchConfigurationTemplate::getSmallVolumeConf() const {
    return m_small_volume_conf;
}
void OAILaunchConfigurationTemplate::setSmallVolumeConf(const OAILaunchConfigurationTemplate_smallVolumeConf &small_volume_conf) {
    m_small_volume_conf = small_volume_conf;
    m_small_volume_conf_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_small_volume_conf_Set() const{
    return m_small_volume_conf_isSet;
}

bool OAILaunchConfigurationTemplate::is_small_volume_conf_Valid() const{
    return m_small_volume_conf_isValid;
}

qint32 OAILaunchConfigurationTemplate::getSmallVolumeMaxSize() const {
    return m_small_volume_max_size;
}
void OAILaunchConfigurationTemplate::setSmallVolumeMaxSize(const qint32 &small_volume_max_size) {
    m_small_volume_max_size = small_volume_max_size;
    m_small_volume_max_size_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_small_volume_max_size_Set() const{
    return m_small_volume_max_size_isSet;
}

bool OAILaunchConfigurationTemplate::is_small_volume_max_size_Valid() const{
    return m_small_volume_max_size_isValid;
}

QMap OAILaunchConfigurationTemplate::getTags() const {
    return m_tags;
}
void OAILaunchConfigurationTemplate::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}

bool OAILaunchConfigurationTemplate::is_tags_Set() const{
    return m_tags_isSet;
}

bool OAILaunchConfigurationTemplate::is_tags_Valid() const{
    return m_tags_isValid;
}

OAITargetInstanceTypeRightSizingMethod OAILaunchConfigurationTemplate::getTargetInstanceTypeRightSizingMethod() const {
    return m_target_instance_type_right_sizing_method;
}
void OAILaunchConfigurationTemplate::setTargetInstanceTypeRightSizingMethod(const OAITargetInstanceTypeRightSizingMethod &target_instance_type_right_sizing_method) {
...
bool OAILaunchConfigurationTemplate::is_target_instance_type_right_sizing_method_Set() const{
    return m_target_instance_type_right_sizing_method_isSet;
}

bool OAILaunchConfigurationTemplate::is_target_instance_type_right_sizing_method_Valid() const{
    return m_target_instance_type_right_sizing_method_isValid;
}

bool OAILaunchConfigurationTemplate::isSet() const {
...
bool OAILaunchConfigurationTemplate::isValid() const {
