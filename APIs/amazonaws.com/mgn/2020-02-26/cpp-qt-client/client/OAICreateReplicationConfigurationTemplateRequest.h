...
/*
 * OAICreateReplicationConfigurationTemplateRequest.h
 *
 * 
 */

#ifndef OAICreateReplicationConfigurationTemplateRequest_H
#define OAICreateReplicationConfigurationTemplateRequest_H
...
class OAICreateReplicationConfigurationTemplateRequest : public OAIObject {
public:
    OAICreateReplicationConfigurationTemplateRequest();
    OAICreateReplicationConfigurationTemplateRequest(QString json);
    ~OAICreateReplicationConfigurationTemplateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateReplicationConfigurationTemplateRequest)

#endif // OAICreateReplicationConfigurationTemplateRequest_H
