...
/*
 * OAIUpdateReplicationConfigurationTemplateRequest.h
 *
 * 
 */

#ifndef OAIUpdateReplicationConfigurationTemplateRequest_H
#define OAIUpdateReplicationConfigurationTemplateRequest_H
...
class OAIUpdateReplicationConfigurationTemplateRequest : public OAIObject {
public:
    OAIUpdateReplicationConfigurationTemplateRequest();
    OAIUpdateReplicationConfigurationTemplateRequest(QString json);
    ~OAIUpdateReplicationConfigurationTemplateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateReplicationConfigurationTemplateRequest)

#endif // OAIUpdateReplicationConfigurationTemplateRequest_H
