...
/*
 * OAIUpdateReplicationConfiguration_request.h
 *
 * 
 */

#ifndef OAIUpdateReplicationConfiguration_request_H
#define OAIUpdateReplicationConfiguration_request_H
...
namespace OpenAPI {
class OAIReplicationConfigurationReplicatedDisk;

class OAIUpdateReplicationConfiguration_request : public OAIObject {
public:
    OAIUpdateReplicationConfiguration_request();
    OAIUpdateReplicationConfiguration_request(QString json);
    ~OAIUpdateReplicationConfiguration_request() override;
    ...
    bool isAssociateDefaultSecurityGroup() const;
    ...
    bool isCreatePublicIp() const;
    void setCreatePublicIp(const bool &create_public_ip);
    bool is_create_public_ip_Set() const;
    bool is_create_public_ip_Valid() const;

    QString getDataPlaneRouting() const;
    void setDataPlaneRouting(const QString &data_plane_routing);
    bool is_data_plane_routing_Set() const;
    bool is_data_plane_routing_Valid() const;

    QString getDefaultLargeStagingDiskType() const;
    void setDefaultLargeStagingDiskType(const QString &default_large_staging_disk_type);
    bool is_default_large_staging_disk_type_Set() const;
    bool is_default_large_staging_disk_type_Valid() const;

    QString getEbsEncryption() const;
    void setEbsEncryption(const QString &ebs_encryption);
    ...
    QList<OAIReplicationConfigurationReplicatedDisk> getReplicatedDisks() const;
    void setReplicatedDisks(const QList<OAIReplicationConfigurationReplicatedDisk> &replicated_disks);
    ...
    QList<QString> getReplicationServersSecurityGroupsIds() const;
    void setReplicationServersSecurityGroupsIds(const QList<QString> &replication_servers_security_groups_ids);
    ...
    QMap<QString, QString> getStagingAreaTags() const;
    void setStagingAreaTags(const QMap<QString, QString> &staging_area_tags);
    bool is_staging_area_tags_Set() const;
    bool is_staging_area_tags_Valid() const;

    bool isUseDedicatedReplicationServer() const;
...
private:
    ...
    QList<OAIReplicationConfigurationReplicatedDisk> m_replicated_disks;
    ...
    QList<QString> m_replication_servers_security_groups_ids;
    ...
    QMap<QString, QString> m_staging_area_tags;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateReplicationConfiguration_request)

#endif // OAIUpdateReplicationConfiguration_request_H
