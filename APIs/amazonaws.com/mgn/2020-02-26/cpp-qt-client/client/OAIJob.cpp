...
QString OAIJob::getCreationDateTime() const {
    return m_creation_date_time;
}
void OAIJob::setCreationDateTime(const QString &creation_date_time) {
    m_creation_date_time = creation_date_time;
    m_creation_date_time_isSet = true;
}

bool OAIJob::is_creation_date_time_Set() const{
    return m_creation_date_time_isSet;
}

bool OAIJob::is_creation_date_time_Valid() const{
    return m_creation_date_time_isValid;
}

QString OAIJob::getEndDateTime() const {
    return m_end_date_time;
}
void OAIJob::setEndDateTime(const QString &end_date_time) {
    m_end_date_time = end_date_time;
    m_end_date_time_isSet = true;
}

bool OAIJob::is_end_date_time_Set() const{
    return m_end_date_time_isSet;
}

bool OAIJob::is_end_date_time_Valid() const{
    return m_end_date_time_isValid;
}

OAIInitiatedBy OAIJob::getInitiatedBy() const {
    return m_initiated_by;
}
void OAIJob::setInitiatedBy(const OAIInitiatedBy &initiated_by) {
    m_initiated_by = initiated_by;
    m_initiated_by_isSet = true;
}

bool OAIJob::is_initiated_by_Set() const{
    return m_initiated_by_isSet;
}

bool OAIJob::is_initiated_by_Valid() const{
...
QList OAIJob::getParticipatingServers() const {
    return m_participating_servers;
}
void OAIJob::setParticipatingServers(const QList &participating_servers) {
    m_participating_servers = participating_servers;
    m_participating_servers_isSet = true;
}

bool OAIJob::is_participating_servers_Set() const{
    return m_participating_servers_isSet;
}

bool OAIJob::is_participating_servers_Valid() const{
...
QMap OAIJob::getTags() const {
    return m_tags;
}
void OAIJob::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
...
OAIJobType OAIJob::getType() const {
    return m_type;
}
void OAIJob::setType(const OAIJobType &type) {
    m_type = type;
    m_type_isSet = true;
}
