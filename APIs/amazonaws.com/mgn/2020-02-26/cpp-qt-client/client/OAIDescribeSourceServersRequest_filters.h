...
/*
 * OAIDescribeSourceServersRequest_filters.h
 *
 * 
 */

#ifndef OAIDescribeSourceServersRequest_filters_H
#define OAIDescribeSourceServersRequest_filters_H
...
class OAIDescribeSourceServersRequest_filters : public OAIObject {
public:
    OAIDescribeSourceServersRequest_filters();
    OAIDescribeSourceServersRequest_filters(QString json);
    ~OAIDescribeSourceServersRequest_filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeSourceServersRequest_filters)

#endif // OAIDescribeSourceServersRequest_filters_H
