...
/*
 * OAIStartTestRequest.h
 *
 * 
 */

#ifndef OAIStartTestRequest_H
#define OAIStartTestRequest_H
...
class OAIStartTestRequest : public OAIObject {
public:
    OAIStartTestRequest();
    OAIStartTestRequest(QString json);
    ~OAIStartTestRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTestRequest)

#endif // OAIStartTestRequest_H
