...
namespace OpenAPI {
class OAILaunchConfiguration_licensing;
class OAIPostLaunchActions;
...
public:
    ...
    OAILaunchConfiguration_licensing getLicensing() const;
    void setLicensing(const OAILaunchConfiguration_licensing &licensing);
    ...
    OAIPostLaunchActions getPostLaunchActions() const;
    void setPostLaunchActions(const OAIPostLaunchActions &post_launch_actions);
...
private:
    ...
    OAILaunchConfiguration_licensing m_licensing;
    ...
    OAIPostLaunchActions m_post_launch_actions;
