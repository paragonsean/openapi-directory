...
OAISourceServer_lifeCycle::OAISourceServer_lifeCycle(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISourceServer_lifeCycle::OAISourceServer_lifeCycle() {
    this->initializeModel();
}

OAISourceServer_lifeCycle::~OAISourceServer_lifeCycle() {}

void OAISourceServer_lifeCycle::initializeModel() {
...
void OAISourceServer_lifeCycle::fromJson(QString jsonString) {
...
void OAISourceServer_lifeCycle::fromJsonObject(QJsonObject json) {
...
QString OAISourceServer_lifeCycle::asJson() const {
...
QJsonObject OAISourceServer_lifeCycle::asJsonObject() const {
    QJsonObject obj;
...
QString OAISourceServer_lifeCycle::getAddedToServiceDateTime() const {
    return m_added_to_service_date_time;
}
void OAISourceServer_lifeCycle::setAddedToServiceDateTime(const QString &added_to_service_date_time) {
    m_added_to_service_date_time = added_to_service_date_time;
    m_added_to_service_date_time_isSet = true;
}

bool OAISourceServer_lifeCycle::is_added_to_service_date_time_Set() const{
    return m_added_to_service_date_time_isSet;
}

bool OAISourceServer_lifeCycle::is_added_to_service_date_time_Valid() const{
    return m_added_to_service_date_time_isValid;
}

QString OAISourceServer_lifeCycle::getElapsedReplicationDuration() const {
    return m_elapsed_replication_duration;
}
void OAISourceServer_lifeCycle::setElapsedReplicationDuration(const QString &elapsed_replication_duration) {
    m_elapsed_replication_duration = elapsed_replication_duration;
    m_elapsed_replication_duration_isSet = true;
}

bool OAISourceServer_lifeCycle::is_elapsed_replication_duration_Set() const{
    return m_elapsed_replication_duration_isSet;
}

bool OAISourceServer_lifeCycle::is_elapsed_replication_duration_Valid() const{
    return m_elapsed_replication_duration_isValid;
}

QString OAISourceServer_lifeCycle::getFirstByteDateTime() const {
    return m_first_byte_date_time;
}
void OAISourceServer_lifeCycle::setFirstByteDateTime(const QString &first_byte_date_time) {
    m_first_byte_date_time = first_byte_date_time;
    m_first_byte_date_time_isSet = true;
}

bool OAISourceServer_lifeCycle::is_first_byte_date_time_Set() const{
    return m_first_byte_date_time_isSet;
}

bool OAISourceServer_lifeCycle::is_first_byte_date_time_Valid() const{
    return m_first_byte_date_time_isValid;
}

OAILifeCycle_lastCutover OAISourceServer_lifeCycle::getLastCutover() const {
    return m_last_cutover;
}
void OAISourceServer_lifeCycle::setLastCutover(const OAILifeCycle_lastCutover &last_cutover) {
    m_last_cutover = last_cutover;
    m_last_cutover_isSet = true;
}

bool OAISourceServer_lifeCycle::is_last_cutover_Set() const{
    return m_last_cutover_isSet;
}

bool OAISourceServer_lifeCycle::is_last_cutover_Valid() const{
    return m_last_cutover_isValid;
}

QString OAISourceServer_lifeCycle::getLastSeenByServiceDateTime() const {
    return m_last_seen_by_service_date_time;
}
void OAISourceServer_lifeCycle::setLastSeenByServiceDateTime(const QString &last_seen_by_service_date_time) {
    m_last_seen_by_service_date_time = last_seen_by_service_date_time;
    m_last_seen_by_service_date_time_isSet = true;
}

bool OAISourceServer_lifeCycle::is_last_seen_by_service_date_time_Set() const{
    return m_last_seen_by_service_date_time_isSet;
}

bool OAISourceServer_lifeCycle::is_last_seen_by_service_date_time_Valid() const{
    return m_last_seen_by_service_date_time_isValid;
}

OAILifeCycle_lastTest OAISourceServer_lifeCycle::getLastTest() const {
    return m_last_test;
}
void OAISourceServer_lifeCycle::setLastTest(const OAILifeCycle_lastTest &last_test) {
    m_last_test = last_test;
    m_last_test_isSet = true;
}

bool OAISourceServer_lifeCycle::is_last_test_Set() const{
    return m_last_test_isSet;
}

bool OAISourceServer_lifeCycle::is_last_test_Valid() const{
    return m_last_test_isValid;
}

OAILifeCycleState OAISourceServer_lifeCycle::getState() const {
    return m_state;
}
void OAISourceServer_lifeCycle::setState(const OAILifeCycleState &state) {
    m_state = state;
    m_state_isSet = true;
}

bool OAISourceServer_lifeCycle::is_state_Set() const{
    return m_state_isSet;
}

bool OAISourceServer_lifeCycle::is_state_Valid() const{
    return m_state_isValid;
}

bool OAISourceServer_lifeCycle::isSet() const {
...
bool OAISourceServer_lifeCycle::isValid() const {
