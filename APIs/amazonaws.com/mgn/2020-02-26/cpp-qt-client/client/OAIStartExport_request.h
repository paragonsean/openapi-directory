...
/*
 * OAIStartExport_request.h
 *
 * 
 */

#ifndef OAIStartExport_request_H
#define OAIStartExport_request_H
...
class OAIStartExport_request : public OAIObject {
public:
    OAIStartExport_request();
    OAIStartExport_request(QString json);
    ~OAIStartExport_request() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartExport_request)

#endif // OAIStartExport_request_H
