...
/*
 * OAIUpdateLaunchConfigurationRequest.h
 *
 * 
 */

#ifndef OAIUpdateLaunchConfigurationRequest_H
#define OAIUpdateLaunchConfigurationRequest_H
...
namespace OpenAPI {
class OAIUpdateLaunchConfigurationRequest_licensing;
class OAIPostLaunchActions;

class OAIUpdateLaunchConfigurationRequest : public OAIObject {
public:
    OAIUpdateLaunchConfigurationRequest();
    OAIUpdateLaunchConfigurationRequest(QString json);
    ~OAIUpdateLaunchConfigurationRequest() override;
    ...
    OAIUpdateLaunchConfigurationRequest_licensing getLicensing() const;
    void setLicensing(const OAIUpdateLaunchConfigurationRequest_licensing &licensing);
...
private:
    ...
    OAIUpdateLaunchConfigurationRequest_licensing m_licensing;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateLaunchConfigurationRequest)

#endif // OAIUpdateLaunchConfigurationRequest_H
