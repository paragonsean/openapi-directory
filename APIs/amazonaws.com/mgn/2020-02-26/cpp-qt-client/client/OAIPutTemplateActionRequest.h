...
/*
 * OAIPutTemplateActionRequest.h
 *
 * 
 */

#ifndef OAIPutTemplateActionRequest_H
#define OAIPutTemplateActionRequest_H
...
class OAIPutTemplateActionRequest : public OAIObject {
public:
    OAIPutTemplateActionRequest();
    OAIPutTemplateActionRequest(QString json);
    ~OAIPutTemplateActionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutTemplateActionRequest)

#endif // OAIPutTemplateActionRequest_H
