...
QList OAISourceProperties::getCpus() const {
    return m_cpus;
}
void OAISourceProperties::setCpus(const QList &cpus) {
    m_cpus = cpus;
    m_cpus_isSet = true;
}

bool OAISourceProperties::is_cpus_Set() const{
    return m_cpus_isSet;
}

bool OAISourceProperties::is_cpus_Valid() const{
    return m_cpus_isValid;
}

QList OAISourceProperties::getDisks() const {
    return m_disks;
}
void OAISourceProperties::setDisks(const QList &disks) {
    m_disks = disks;
    m_disks_isSet = true;
}

bool OAISourceProperties::is_disks_Set() const{
    return m_disks_isSet;
}

bool OAISourceProperties::is_disks_Valid() const{
    return m_disks_isValid;
}

OAISourceProperties_identificationHints OAISourceProperties::getIdentificationHints() const {
    return m_identification_hints;
}
void OAISourceProperties::setIdentificationHints(const OAISourceProperties_identificationHints &identification_hints) {
    m_identification_hints = identification_hints;
    m_identification_hints_isSet = true;
}

bool OAISourceProperties::is_identification_hints_Set() const{
    return m_identification_hints_isSet;
}

bool OAISourceProperties::is_identification_hints_Valid() const{
    return m_identification_hints_isValid;
}

QString OAISourceProperties::getLastUpdatedDateTime() const {
    return m_last_updated_date_time;
}
void OAISourceProperties::setLastUpdatedDateTime(const QString &last_updated_date_time) {
    m_last_updated_date_time = last_updated_date_time;
    m_last_updated_date_time_isSet = true;
}

bool OAISourceProperties::is_last_updated_date_time_Set() const{
    return m_last_updated_date_time_isSet;
}

bool OAISourceProperties::is_last_updated_date_time_Valid() const{
    return m_last_updated_date_time_isValid;
}

QList OAISourceProperties::getNetworkInterfaces() const {
    return m_network_interfaces;
}
void OAISourceProperties::setNetworkInterfaces(const QList &network_interfaces) {
    m_network_interfaces = network_interfaces;
    m_network_interfaces_isSet = true;
}

bool OAISourceProperties::is_network_interfaces_Set() const{
    return m_network_interfaces_isSet;
}

bool OAISourceProperties::is_network_interfaces_Valid() const{
    return m_network_interfaces_isValid;
}

OAISourceProperties_os OAISourceProperties::getOs() const {
    return m_os;
}
void OAISourceProperties::setOs(const OAISourceProperties_os &os) {
    m_os = os;
    m_os_isSet = true;
}

bool OAISourceProperties::is_os_Set() const{
    return m_os_isSet;
}

bool OAISourceProperties::is_os_Valid() const{
    return m_os_isValid;
}

qint32 OAISourceProperties::getRamBytes() const {
    return m_ram_bytes;
}
void OAISourceProperties::setRamBytes(const qint32 &ram_bytes) {
    m_ram_bytes = ram_bytes;
    m_ram_bytes_isSet = true;
}

bool OAISourceProperties::is_ram_bytes_Set() const{
    return m_ram_bytes_isSet;
}

bool OAISourceProperties::is_ram_bytes_Valid() const{
    return m_ram_bytes_isValid;
}

QString OAISourceProperties::getRecommendedInstanceType() const {
    return m_recommended_instance_type;
}
void OAISourceProperties::setRecommendedInstanceType(const QString &recommended_instance_type) {
    m_recommended_instance_type = recommended_instance_type;
    m_recommended_instance_type_isSet = true;
}

bool OAISourceProperties::is_recommended_instance_type_Set() const{
    return m_recommended_instance_type_isSet;
}

bool OAISourceProperties::is_recommended_instance_type_Valid() const{
