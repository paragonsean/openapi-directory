...
/*
 * OAITemplateActionDocument.h
 *
 * 
 */

#ifndef OAITemplateActionDocument_H
#define OAITemplateActionDocument_H
...
class OAITemplateActionDocument : public OAIObject {
public:
    OAITemplateActionDocument();
    OAITemplateActionDocument(QString json);
    ~OAITemplateActionDocument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITemplateActionDocument)

#endif // OAITemplateActionDocument_H
