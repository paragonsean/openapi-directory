...
/*
 * OAILaunchTemplateDiskConf.h
 *
 * Launch template disk configuration.
 */

#ifndef OAILaunchTemplateDiskConf_H
#define OAILaunchTemplateDiskConf_H
...
class OAILaunchTemplateDiskConf : public OAIObject {
public:
    OAILaunchTemplateDiskConf();
    OAILaunchTemplateDiskConf(QString json);
    ~OAILaunchTemplateDiskConf() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILaunchTemplateDiskConf)

#endif // OAILaunchTemplateDiskConf_H
