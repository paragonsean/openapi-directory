...
/*
 * OAIAssociateSourceServersRequest.h
 *
 * 
 */

#ifndef OAIAssociateSourceServersRequest_H
#define OAIAssociateSourceServersRequest_H
...
class OAIAssociateSourceServersRequest : public OAIObject {
public:
    OAIAssociateSourceServersRequest();
    OAIAssociateSourceServersRequest(QString json);
    ~OAIAssociateSourceServersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateSourceServersRequest)

#endif // OAIAssociateSourceServersRequest_H
