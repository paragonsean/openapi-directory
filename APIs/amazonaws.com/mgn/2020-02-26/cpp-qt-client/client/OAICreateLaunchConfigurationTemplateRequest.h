...
/*
 * OAICreateLaunchConfigurationTemplateRequest.h
 *
 * 
 */

#ifndef OAICreateLaunchConfigurationTemplateRequest_H
#define OAICreateLaunchConfigurationTemplateRequest_H
...
class OAILicensing;
class OAICreateLaunchConfigurationTemplateRequest_postLaunchActions;
class OAILaunchConfigurationTemplate_smallVolumeConf;

class OAICreateLaunchConfigurationTemplateRequest : public OAIObject {
public:
    OAICreateLaunchConfigurationTemplateRequest();
    OAICreateLaunchConfigurationTemplateRequest(QString json);
    ~OAICreateLaunchConfigurationTemplateRequest() override;
    ...
    OAICreateLaunchConfigurationTemplateRequest_postLaunchActions getPostLaunchActions() const;
    void setPostLaunchActions(const OAICreateLaunchConfigurationTemplateRequest_postLaunchActions &post_launch_actions);
...
private:
    ...
    OAICreateLaunchConfigurationTemplateRequest_postLaunchActions m_post_launch_actions;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateLaunchConfigurationTemplateRequest)

#endif // OAICreateLaunchConfigurationTemplateRequest_H
