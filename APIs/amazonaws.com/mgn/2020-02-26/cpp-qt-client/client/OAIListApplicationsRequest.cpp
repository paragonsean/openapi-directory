...
QString OAIListApplicationsRequest::getAccountId() const {
    return m_account_id;
}
void OAIListApplicationsRequest::setAccountId(const QString &account_id) {
    m_account_id = account_id;
    m_account_id_isSet = true;
}

bool OAIListApplicationsRequest::is_account_id_Set() const{
    return m_account_id_isSet;
}

bool OAIListApplicationsRequest::is_account_id_Valid() const{
    return m_account_id_isValid;
}

OAIListApplicationsRequest_filters OAIListApplicationsRequest::getFilters() const {
    return m_filters;
}
void OAIListApplicationsRequest::setFilters(const OAIListApplicationsRequest_filters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIListApplicationsRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIListApplicationsRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

qint32 OAIListApplicationsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListApplicationsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListApplicationsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListApplicationsRequest::is_max_results_Valid() const{
