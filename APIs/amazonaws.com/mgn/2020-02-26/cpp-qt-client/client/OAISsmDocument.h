...
#ifndef OAISsmDocument_H
#define OAISsmDocument_H
...
class OAISsmDocument : public OAIObject {
public:
    OAISsmDocument();
    OAISsmDocument(QString json);
    ~OAISsmDocument() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISsmDocument)

#endif // OAISsmDocument_H
