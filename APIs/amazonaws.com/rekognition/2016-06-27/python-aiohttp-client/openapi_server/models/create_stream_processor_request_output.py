...
class CreateStreamProcessorRequestOutput(Model):
    ...
    def __init__(self, kinesis_data_stream: StreamProcessorOutputKinesisDataStream=None, s3_destination: StreamProcessorOutputS3Destination=None):
        """CreateStreamProcessorRequestOutput - a model defined in OpenAPI

        :param kinesis_data_stream: The kinesis_data_stream of this CreateStreamProcessorRequestOutput.
        :param s3_destination: The s3_destination of this CreateStreamProcessorRequestOutput.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateStreamProcessorRequestOutput':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateStreamProcessorRequest_Output of this CreateStreamProcessorRequestOutput.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def kinesis_data_stream(self):
        """Gets the kinesis_data_stream of this CreateStreamProcessorRequestOutput.


        :return: The kinesis_data_stream of this CreateStreamProcessorRequestOutput.
    ...
    def kinesis_data_stream(self, kinesis_data_stream):
        """Sets the kinesis_data_stream of this CreateStreamProcessorRequestOutput.
    ...
    def s3_destination(self):
        """Gets the s3_destination of this CreateStreamProcessorRequestOutput.


        :return: The s3_destination of this CreateStreamProcessorRequestOutput.
    ...
    def s3_destination(self, s3_destination):
        """Sets the s3_destination of this CreateStreamProcessorRequestOutput.
