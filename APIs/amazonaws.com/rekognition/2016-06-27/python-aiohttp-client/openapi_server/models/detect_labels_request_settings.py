...
class DetectLabelsRequestSettings(Model):
    ...
    def __init__(self, general_labels: DetectLabelsSettingsGeneralLabels=None, image_properties: DetectLabelsSettingsImageProperties=None):
        """DetectLabelsRequestSettings - a model defined in OpenAPI

        :param general_labels: The general_labels of this DetectLabelsRequestSettings.
        :param image_properties: The image_properties of this DetectLabelsRequestSettings.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DetectLabelsRequestSettings':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DetectLabelsRequest_Settings of this DetectLabelsRequestSettings.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def general_labels(self):
        """Gets the general_labels of this DetectLabelsRequestSettings.


        :return: The general_labels of this DetectLabelsRequestSettings.
    ...
    def general_labels(self, general_labels):
        """Sets the general_labels of this DetectLabelsRequestSettings.
    ...
    def image_properties(self):
        """Gets the image_properties of this DetectLabelsRequestSettings.


        :return: The image_properties of this DetectLabelsRequestSettings.
    ...
    def image_properties(self, image_properties):
        """Sets the image_properties of this DetectLabelsRequestSettings.
