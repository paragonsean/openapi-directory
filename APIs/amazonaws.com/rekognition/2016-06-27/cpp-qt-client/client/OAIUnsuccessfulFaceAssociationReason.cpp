...
#include "OAIUnsuccessfulFaceAssociationReason.h"
...
OAIUnsuccessfulFaceAssociationReason::OAIUnsuccessfulFaceAssociationReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsuccessfulFaceAssociationReason::OAIUnsuccessfulFaceAssociationReason() {
    this->initializeModel();
}

OAIUnsuccessfulFaceAssociationReason::~OAIUnsuccessfulFaceAssociationReason() {}

void OAIUnsuccessfulFaceAssociationReason::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUnsuccessfulFaceAssociationReason::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUnsuccessfulFaceAssociationReason::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FACE_NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceAssociationReason::FACE_NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("ASSOCIATED_TO_A_DIFFERENT_USER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceAssociationReason::ASSOCIATED_TO_A_DIFFERENT_USER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW_MATCH_CONFIDENCE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceAssociationReason::LOW_MATCH_CONFIDENCE;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUnsuccessfulFaceAssociationReason::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUnsuccessfulFaceAssociationReason::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUnsuccessfulFaceAssociationReason::FACE_NOT_FOUND:
            val = "FACE_NOT_FOUND";
            break;
        case eOAIUnsuccessfulFaceAssociationReason::ASSOCIATED_TO_A_DIFFERENT_USER:
            val = "ASSOCIATED_TO_A_DIFFERENT_USER";
            break;
        case eOAIUnsuccessfulFaceAssociationReason::LOW_MATCH_CONFIDENCE:
            val = "LOW_MATCH_CONFIDENCE";
            break;
        default:
            break;
    }
...
QJsonValue OAIUnsuccessfulFaceAssociationReason::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUnsuccessfulFaceAssociationReason::eOAIUnsuccessfulFaceAssociationReason OAIUnsuccessfulFaceAssociationReason::getValue() const {
    return m_value;
}

void OAIUnsuccessfulFaceAssociationReason::setValue(const OAIUnsuccessfulFaceAssociationReason::eOAIUnsuccessfulFaceAssociationReason& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUnsuccessfulFaceAssociationReason::isSet() const {
    
    return m_value_isSet;
}

bool OAIUnsuccessfulFaceAssociationReason::isValid() const {
