...
/*
 * OAIStartProjectVersionRequest.h
 *
 * 
 */

#ifndef OAIStartProjectVersionRequest_H
#define OAIStartProjectVersionRequest_H
...
class OAIStartProjectVersionRequest : public OAIObject {
public:
    OAIStartProjectVersionRequest();
    OAIStartProjectVersionRequest(QString json);
    ~OAIStartProjectVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartProjectVersionRequest)

#endif // OAIStartProjectVersionRequest_H
