...
OAIStartSegmentDetectionFilters_ShotFilter::OAIStartSegmentDetectionFilters_ShotFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSegmentDetectionFilters_ShotFilter::OAIStartSegmentDetectionFilters_ShotFilter() {
    this->initializeModel();
}

OAIStartSegmentDetectionFilters_ShotFilter::~OAIStartSegmentDetectionFilters_ShotFilter() {}

void OAIStartSegmentDetectionFilters_ShotFilter::initializeModel() {

    m_min_segment_confidence_isSet = false;
    m_min_segment_confidence_isValid = false;
}

void OAIStartSegmentDetectionFilters_ShotFilter::fromJson(QString jsonString) {
...
void OAIStartSegmentDetectionFilters_ShotFilter::fromJsonObject(QJsonObject json) {
...
QString OAIStartSegmentDetectionFilters_ShotFilter::asJson() const {
...
QJsonObject OAIStartSegmentDetectionFilters_ShotFilter::asJsonObject() const {
    QJsonObject obj;
...
float OAIStartSegmentDetectionFilters_ShotFilter::getMinSegmentConfidence() const {
    return m_min_segment_confidence;
}
void OAIStartSegmentDetectionFilters_ShotFilter::setMinSegmentConfidence(const float &min_segment_confidence) {
    m_min_segment_confidence = min_segment_confidence;
    m_min_segment_confidence_isSet = true;
}

bool OAIStartSegmentDetectionFilters_ShotFilter::is_min_segment_confidence_Set() const{
    return m_min_segment_confidence_isSet;
}

bool OAIStartSegmentDetectionFilters_ShotFilter::is_min_segment_confidence_Valid() const{
    return m_min_segment_confidence_isValid;
}

bool OAIStartSegmentDetectionFilters_ShotFilter::isSet() const {
...
bool OAIStartSegmentDetectionFilters_ShotFilter::isValid() const {
