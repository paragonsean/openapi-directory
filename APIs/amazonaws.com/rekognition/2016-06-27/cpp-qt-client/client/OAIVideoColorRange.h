...
/*
 * OAIVideoColorRange.h
 *
 * 
 */

#ifndef OAIVideoColorRange_H
#define OAIVideoColorRange_H
...
class OAIVideoColorRange : public OAIEnum {
public:
    OAIVideoColorRange();
    OAIVideoColorRange(QString json);
    ~OAIVideoColorRange() override;
    ...
    enum class eOAIVideoColorRange {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FULL, 
        LIMITED
    };
    OAIVideoColorRange::eOAIVideoColorRange getValue() const;
    void setValue(const OAIVideoColorRange::eOAIVideoColorRange& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIVideoColorRange)

#endif // OAIVideoColorRange_H
