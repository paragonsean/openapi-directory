...
/*
 * OAIPersonMatch_Person.h
 *
 * 
 */

#ifndef OAIPersonMatch_Person_H
#define OAIPersonMatch_Person_H
...
class OAIPersonMatch_Person : public OAIObject {
public:
    OAIPersonMatch_Person();
    OAIPersonMatch_Person(QString json);
    ~OAIPersonMatch_Person() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonMatch_Person)

#endif // OAIPersonMatch_Person_H
