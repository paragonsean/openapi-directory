...
/*
 * OAIDetectTextRequest_Filters.h
 *
 * 
 */

#ifndef OAIDetectTextRequest_Filters_H
#define OAIDetectTextRequest_Filters_H
...
class OAIDetectTextRequest_Filters : public OAIObject {
public:
    OAIDetectTextRequest_Filters();
    OAIDetectTextRequest_Filters(QString json);
    ~OAIDetectTextRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectTextRequest_Filters)

#endif // OAIDetectTextRequest_Filters_H
