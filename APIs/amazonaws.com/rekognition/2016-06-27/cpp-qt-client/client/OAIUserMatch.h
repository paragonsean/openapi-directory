...
#ifndef OAIUserMatch_H
#define OAIUserMatch_H

#include <QJsonObject>

#include "OAIUserMatch_User.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIUserMatch_User;

class OAIUserMatch : public OAIObject {
public:
    OAIUserMatch();
    OAIUserMatch(QString json);
    ~OAIUserMatch() override;
    ...
    OAIUserMatch_User getUser() const;
    void setUser(const OAIUserMatch_User &user);
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserMatch)

#endif // OAIUserMatch_H
