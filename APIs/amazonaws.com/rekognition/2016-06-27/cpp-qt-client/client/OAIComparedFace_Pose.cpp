...
OAIComparedFace_Pose::OAIComparedFace_Pose(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComparedFace_Pose::OAIComparedFace_Pose() {
    this->initializeModel();
}

OAIComparedFace_Pose::~OAIComparedFace_Pose() {}

void OAIComparedFace_Pose::initializeModel() {
...
void OAIComparedFace_Pose::fromJson(QString jsonString) {
...
void OAIComparedFace_Pose::fromJsonObject(QJsonObject json) {
...
QString OAIComparedFace_Pose::asJson() const {
...
QJsonObject OAIComparedFace_Pose::asJsonObject() const {
    QJsonObject obj;
    if (m_roll_isSet) {
...
float OAIComparedFace_Pose::getRoll() const {
    return m_roll;
}
void OAIComparedFace_Pose::setRoll(const float &roll) {
    m_roll = roll;
    m_roll_isSet = true;
}

bool OAIComparedFace_Pose::is_roll_Set() const{
    return m_roll_isSet;
}

bool OAIComparedFace_Pose::is_roll_Valid() const{
    return m_roll_isValid;
}

float OAIComparedFace_Pose::getYaw() const {
    return m_yaw;
}
void OAIComparedFace_Pose::setYaw(const float &yaw) {
    m_yaw = yaw;
    m_yaw_isSet = true;
}

bool OAIComparedFace_Pose::is_yaw_Set() const{
    return m_yaw_isSet;
}

bool OAIComparedFace_Pose::is_yaw_Valid() const{
    return m_yaw_isValid;
}

float OAIComparedFace_Pose::getPitch() const {
    return m_pitch;
}
void OAIComparedFace_Pose::setPitch(const float &pitch) {
    m_pitch = pitch;
    m_pitch_isSet = true;
}

bool OAIComparedFace_Pose::is_pitch_Set() const{
    return m_pitch_isSet;
}

bool OAIComparedFace_Pose::is_pitch_Valid() const{
    return m_pitch_isValid;
}

bool OAIComparedFace_Pose::isSet() const {
...
bool OAIComparedFace_Pose::isValid() const {
