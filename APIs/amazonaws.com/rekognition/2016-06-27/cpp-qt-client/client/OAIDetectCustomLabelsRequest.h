...
/*
 * OAIDetectCustomLabelsRequest.h
 *
 * 
 */

#ifndef OAIDetectCustomLabelsRequest_H
#define OAIDetectCustomLabelsRequest_H
...
class OAIDetectCustomLabelsRequest : public OAIObject {
public:
    OAIDetectCustomLabelsRequest();
    OAIDetectCustomLabelsRequest(QString json);
    ~OAIDetectCustomLabelsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectCustomLabelsRequest)

#endif // OAIDetectCustomLabelsRequest_H
