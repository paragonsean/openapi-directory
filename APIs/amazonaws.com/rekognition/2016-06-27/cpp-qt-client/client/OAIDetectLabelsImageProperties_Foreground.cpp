...
OAIDetectLabelsImageProperties_Foreground::OAIDetectLabelsImageProperties_Foreground(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageProperties_Foreground::OAIDetectLabelsImageProperties_Foreground() {
    this->initializeModel();
}

OAIDetectLabelsImageProperties_Foreground::~OAIDetectLabelsImageProperties_Foreground() {}

void OAIDetectLabelsImageProperties_Foreground::initializeModel() {
...
void OAIDetectLabelsImageProperties_Foreground::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageProperties_Foreground::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageProperties_Foreground::asJson() const {
...
QJsonObject OAIDetectLabelsImageProperties_Foreground::asJsonObject() const {
    QJsonObject obj;
    if (m_quality.isSet()) {
...
OAIDetectLabelsImageForeground_Quality OAIDetectLabelsImageProperties_Foreground::getQuality() const {
    return m_quality;
}
void OAIDetectLabelsImageProperties_Foreground::setQuality(const OAIDetectLabelsImageForeground_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIDetectLabelsImageProperties_Foreground::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIDetectLabelsImageProperties_Foreground::is_quality_Valid() const{
    return m_quality_isValid;
}

QList OAIDetectLabelsImageProperties_Foreground::getDominantColors() const {
    return m_dominant_colors;
}
void OAIDetectLabelsImageProperties_Foreground::setDominantColors(const QList &dominant_colors) {
    m_dominant_colors = dominant_colors;
    m_dominant_colors_isSet = true;
}

bool OAIDetectLabelsImageProperties_Foreground::is_dominant_colors_Set() const{
    return m_dominant_colors_isSet;
}

bool OAIDetectLabelsImageProperties_Foreground::is_dominant_colors_Valid() const{
    return m_dominant_colors_isValid;
}

bool OAIDetectLabelsImageProperties_Foreground::isSet() const {
...
bool OAIDetectLabelsImageProperties_Foreground::isValid() const {
