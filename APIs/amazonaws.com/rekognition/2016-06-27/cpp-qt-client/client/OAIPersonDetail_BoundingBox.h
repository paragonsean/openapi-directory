...
/*
 * OAIPersonDetail_BoundingBox.h
 *
 * 
 */

#ifndef OAIPersonDetail_BoundingBox_H
#define OAIPersonDetail_BoundingBox_H
...
class OAIPersonDetail_BoundingBox : public OAIObject {
public:
    OAIPersonDetail_BoundingBox();
    OAIPersonDetail_BoundingBox(QString json);
    ~OAIPersonDetail_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonDetail_BoundingBox)

#endif // OAIPersonDetail_BoundingBox_H
