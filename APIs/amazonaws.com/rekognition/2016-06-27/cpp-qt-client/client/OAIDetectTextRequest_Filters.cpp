...
#include "OAIDetectTextRequest_Filters.h"
...
OAIDetectTextRequest_Filters::OAIDetectTextRequest_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectTextRequest_Filters::OAIDetectTextRequest_Filters() {
    this->initializeModel();
}

OAIDetectTextRequest_Filters::~OAIDetectTextRequest_Filters() {}

void OAIDetectTextRequest_Filters::initializeModel() {
...
void OAIDetectTextRequest_Filters::fromJson(QString jsonString) {
...
void OAIDetectTextRequest_Filters::fromJsonObject(QJsonObject json) {
...
QString OAIDetectTextRequest_Filters::asJson() const {
...
QJsonObject OAIDetectTextRequest_Filters::asJsonObject() const {
    QJsonObject obj;
...
OAIDetectionFilter OAIDetectTextRequest_Filters::getWordFilter() const {
    return m_word_filter;
}
void OAIDetectTextRequest_Filters::setWordFilter(const OAIDetectionFilter &word_filter) {
    m_word_filter = word_filter;
    m_word_filter_isSet = true;
}

bool OAIDetectTextRequest_Filters::is_word_filter_Set() const{
    return m_word_filter_isSet;
}

bool OAIDetectTextRequest_Filters::is_word_filter_Valid() const{
    return m_word_filter_isValid;
}

QList OAIDetectTextRequest_Filters::getRegionsOfInterest() const {
    return m_regions_of_interest;
}
void OAIDetectTextRequest_Filters::setRegionsOfInterest(const QList &regions_of_interest) {
    m_regions_of_interest = regions_of_interest;
    m_regions_of_interest_isSet = true;
}

bool OAIDetectTextRequest_Filters::is_regions_of_interest_Set() const{
    return m_regions_of_interest_isSet;
}

bool OAIDetectTextRequest_Filters::is_regions_of_interest_Valid() const{
    return m_regions_of_interest_isValid;
}

bool OAIDetectTextRequest_Filters::isSet() const {
...
bool OAIDetectTextRequest_Filters::isValid() const {
