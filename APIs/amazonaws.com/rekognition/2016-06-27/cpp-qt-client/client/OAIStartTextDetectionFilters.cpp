...
#include "OAIStartTextDetectionFilters.h"
...
OAIStartTextDetectionFilters::OAIStartTextDetectionFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTextDetectionFilters::OAIStartTextDetectionFilters() {
    this->initializeModel();
}

OAIStartTextDetectionFilters::~OAIStartTextDetectionFilters() {}

void OAIStartTextDetectionFilters::initializeModel() {
...
void OAIStartTextDetectionFilters::fromJson(QString jsonString) {
...
void OAIStartTextDetectionFilters::fromJsonObject(QJsonObject json) {
...
QString OAIStartTextDetectionFilters::asJson() const {
...
QJsonObject OAIStartTextDetectionFilters::asJsonObject() const {
    QJsonObject obj;
...
OAIStartTextDetectionFilters_WordFilter OAIStartTextDetectionFilters::getWordFilter() const {
    return m_word_filter;
}
void OAIStartTextDetectionFilters::setWordFilter(const OAIStartTextDetectionFilters_WordFilter &word_filter) {
    m_word_filter = word_filter;
    m_word_filter_isSet = true;
}

bool OAIStartTextDetectionFilters::is_word_filter_Set() const{
    return m_word_filter_isSet;
}

bool OAIStartTextDetectionFilters::is_word_filter_Valid() const{
    return m_word_filter_isValid;
}

QList OAIStartTextDetectionFilters::getRegionsOfInterest() const {
    return m_regions_of_interest;
}
void OAIStartTextDetectionFilters::setRegionsOfInterest(const QList &regions_of_interest) {
    m_regions_of_interest = regions_of_interest;
    m_regions_of_interest_isSet = true;
}

bool OAIStartTextDetectionFilters::is_regions_of_interest_Set() const{
    return m_regions_of_interest_isSet;
}

bool OAIStartTextDetectionFilters::is_regions_of_interest_Valid() const{
    return m_regions_of_interest_isValid;
}

bool OAIStartTextDetectionFilters::isSet() const {
...
bool OAIStartTextDetectionFilters::isValid() const {
