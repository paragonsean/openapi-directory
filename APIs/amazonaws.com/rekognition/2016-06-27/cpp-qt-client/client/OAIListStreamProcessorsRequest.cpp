...
#include "OAIListStreamProcessorsRequest.h"
...
OAIListStreamProcessorsRequest::OAIListStreamProcessorsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamProcessorsRequest::OAIListStreamProcessorsRequest() {
    this->initializeModel();
}

OAIListStreamProcessorsRequest::~OAIListStreamProcessorsRequest() {}

void OAIListStreamProcessorsRequest::initializeModel() {
...
void OAIListStreamProcessorsRequest::fromJson(QString jsonString) {
...
void OAIListStreamProcessorsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListStreamProcessorsRequest::asJson() const {
...
QJsonObject OAIListStreamProcessorsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListStreamProcessorsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListStreamProcessorsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamProcessorsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamProcessorsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListStreamProcessorsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListStreamProcessorsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListStreamProcessorsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListStreamProcessorsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListStreamProcessorsRequest::isSet() const {
...
bool OAIListStreamProcessorsRequest::isValid() const {
