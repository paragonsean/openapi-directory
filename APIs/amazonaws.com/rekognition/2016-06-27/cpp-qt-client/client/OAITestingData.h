...
#ifndef OAITestingData_H
#define OAITestingData_H
...
class OAITestingData : public OAIObject {
public:
    OAITestingData();
    OAITestingData(QString json);
    ~OAITestingData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestingData)

#endif // OAITestingData_H
