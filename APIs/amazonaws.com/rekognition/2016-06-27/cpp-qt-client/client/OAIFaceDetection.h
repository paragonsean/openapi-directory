...
#ifndef OAIFaceDetection_H
#define OAIFaceDetection_H
...
namespace OpenAPI {
class OAIFaceDetection_Face;

class OAIFaceDetection : public OAIObject {
public:
    OAIFaceDetection();
    OAIFaceDetection(QString json);
    ~OAIFaceDetection() override;
    ...
    OAIFaceDetection_Face getFace() const;
    void setFace(const OAIFaceDetection_Face &face);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetection)

#endif // OAIFaceDetection_H
