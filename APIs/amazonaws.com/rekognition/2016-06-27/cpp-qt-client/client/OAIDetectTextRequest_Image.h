...
/*
 * OAIDetectTextRequest_Image.h
 *
 * 
 */

#ifndef OAIDetectTextRequest_Image_H
#define OAIDetectTextRequest_Image_H
...
class OAIDetectTextRequest_Image : public OAIObject {
public:
    OAIDetectTextRequest_Image();
    OAIDetectTextRequest_Image(QString json);
    ~OAIDetectTextRequest_Image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectTextRequest_Image)

#endif // OAIDetectTextRequest_Image_H
