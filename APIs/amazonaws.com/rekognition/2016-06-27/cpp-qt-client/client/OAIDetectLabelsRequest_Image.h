...
/*
 * OAIDetectLabelsRequest_Image.h
 *
 * 
 */

#ifndef OAIDetectLabelsRequest_Image_H
#define OAIDetectLabelsRequest_Image_H
...
class OAIDetectLabelsRequest_Image : public OAIObject {
public:
    OAIDetectLabelsRequest_Image();
    OAIDetectLabelsRequest_Image(QString json);
    ~OAIDetectLabelsRequest_Image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsRequest_Image)

#endif // OAIDetectLabelsRequest_Image_H
