...
/*
 * OAIStartStreamProcessorResponse.h
 *
 * 
 */

#ifndef OAIStartStreamProcessorResponse_H
#define OAIStartStreamProcessorResponse_H
...
class OAIStartStreamProcessorResponse : public OAIObject {
public:
    OAIStartStreamProcessorResponse();
    OAIStartStreamProcessorResponse(QString json);
    ~OAIStartStreamProcessorResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartStreamProcessorResponse)

#endif // OAIStartStreamProcessorResponse_H
