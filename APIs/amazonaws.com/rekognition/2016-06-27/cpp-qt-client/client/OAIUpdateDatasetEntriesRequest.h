...
/*
 * OAIUpdateDatasetEntriesRequest.h
 *
 * 
 */

#ifndef OAIUpdateDatasetEntriesRequest_H
#define OAIUpdateDatasetEntriesRequest_H
...
namespace OpenAPI {
class OAIUpdateDatasetEntriesRequest_Changes;

class OAIUpdateDatasetEntriesRequest : public OAIObject {
public:
    OAIUpdateDatasetEntriesRequest();
    OAIUpdateDatasetEntriesRequest(QString json);
    ~OAIUpdateDatasetEntriesRequest() override;
    ...
    OAIUpdateDatasetEntriesRequest_Changes getChanges() const;
    void setChanges(const OAIUpdateDatasetEntriesRequest_Changes &changes);
...
private:
    ...
    OAIUpdateDatasetEntriesRequest_Changes m_changes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUpdateDatasetEntriesRequest)

#endif // OAIUpdateDatasetEntriesRequest_H
