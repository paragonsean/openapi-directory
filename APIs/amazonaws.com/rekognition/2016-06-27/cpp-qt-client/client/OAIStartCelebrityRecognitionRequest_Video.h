...
/*
 * OAIStartCelebrityRecognitionRequest_Video.h
 *
 * 
 */

#ifndef OAIStartCelebrityRecognitionRequest_Video_H
#define OAIStartCelebrityRecognitionRequest_Video_H
...
class OAIStartCelebrityRecognitionRequest_Video : public OAIObject {
public:
    OAIStartCelebrityRecognitionRequest_Video();
    OAIStartCelebrityRecognitionRequest_Video(QString json);
    ~OAIStartCelebrityRecognitionRequest_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartCelebrityRecognitionRequest_Video)

#endif // OAIStartCelebrityRecognitionRequest_Video_H
