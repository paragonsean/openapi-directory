...
/*
 * OAIProtectiveEquipmentPerson_BoundingBox.h
 *
 * 
 */

#ifndef OAIProtectiveEquipmentPerson_BoundingBox_H
#define OAIProtectiveEquipmentPerson_BoundingBox_H
...
class OAIProtectiveEquipmentPerson_BoundingBox : public OAIObject {
public:
    OAIProtectiveEquipmentPerson_BoundingBox();
    OAIProtectiveEquipmentPerson_BoundingBox(QString json);
    ~OAIProtectiveEquipmentPerson_BoundingBox() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProtectiveEquipmentPerson_BoundingBox)

#endif // OAIProtectiveEquipmentPerson_BoundingBox_H
