...
#include "OAIGroundTruthManifest.h"
#include <QString>
...
public:
    ...
    OAIGroundTruthManifest getGroundTruthManifest() const;
    void setGroundTruthManifest(const OAIGroundTruthManifest &ground_truth_manifest);
...
private:
    ...
    OAIGroundTruthManifest m_ground_truth_manifest;
