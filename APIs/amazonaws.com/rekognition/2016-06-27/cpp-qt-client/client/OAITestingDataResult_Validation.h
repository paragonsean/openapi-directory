...
/*
 * OAITestingDataResult_Validation.h
 *
 * 
 */

#ifndef OAITestingDataResult_Validation_H
#define OAITestingDataResult_Validation_H
...
class OAITestingDataResult_Validation : public OAIObject {
public:
    OAITestingDataResult_Validation();
    OAITestingDataResult_Validation(QString json);
    ~OAITestingDataResult_Validation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestingDataResult_Validation)

#endif // OAITestingDataResult_Validation_H
