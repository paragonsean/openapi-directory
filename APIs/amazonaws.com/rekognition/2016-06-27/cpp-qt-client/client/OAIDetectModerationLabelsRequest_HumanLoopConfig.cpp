...
#include "OAIDetectModerationLabelsRequest_HumanLoopConfig.h"
...
OAIDetectModerationLabelsRequest_HumanLoopConfig::OAIDetectModerationLabelsRequest_HumanLoopConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectModerationLabelsRequest_HumanLoopConfig::OAIDetectModerationLabelsRequest_HumanLoopConfig() {
    this->initializeModel();
}

OAIDetectModerationLabelsRequest_HumanLoopConfig::~OAIDetectModerationLabelsRequest_HumanLoopConfig() {}

void OAIDetectModerationLabelsRequest_HumanLoopConfig::initializeModel() {
...
void OAIDetectModerationLabelsRequest_HumanLoopConfig::fromJson(QString jsonString) {
...
void OAIDetectModerationLabelsRequest_HumanLoopConfig::fromJsonObject(QJsonObject json) {
...
QString OAIDetectModerationLabelsRequest_HumanLoopConfig::asJson() const {
...
QJsonObject OAIDetectModerationLabelsRequest_HumanLoopConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDetectModerationLabelsRequest_HumanLoopConfig::getHumanLoopName() const {
    return m_human_loop_name;
}
void OAIDetectModerationLabelsRequest_HumanLoopConfig::setHumanLoopName(const QString &human_loop_name) {
    m_human_loop_name = human_loop_name;
    m_human_loop_name_isSet = true;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::is_human_loop_name_Set() const{
    return m_human_loop_name_isSet;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::is_human_loop_name_Valid() const{
    return m_human_loop_name_isValid;
}

QString OAIDetectModerationLabelsRequest_HumanLoopConfig::getFlowDefinitionArn() const {
    return m_flow_definition_arn;
}
void OAIDetectModerationLabelsRequest_HumanLoopConfig::setFlowDefinitionArn(const QString &flow_definition_arn) {
    m_flow_definition_arn = flow_definition_arn;
    m_flow_definition_arn_isSet = true;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::is_flow_definition_arn_Set() const{
    return m_flow_definition_arn_isSet;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::is_flow_definition_arn_Valid() const{
    return m_flow_definition_arn_isValid;
}

OAIHumanLoopConfig_DataAttributes OAIDetectModerationLabelsRequest_HumanLoopConfig::getDataAttributes() const {
    return m_data_attributes;
}
void OAIDetectModerationLabelsRequest_HumanLoopConfig::setDataAttributes(const OAIHumanLoopConfig_DataAttributes &data_attributes) {
    m_data_attributes = data_attributes;
    m_data_attributes_isSet = true;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::is_data_attributes_Set() const{
    return m_data_attributes_isSet;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::is_data_attributes_Valid() const{
    return m_data_attributes_isValid;
}

bool OAIDetectModerationLabelsRequest_HumanLoopConfig::isSet() const {
...
bool OAIDetectModerationLabelsRequest_HumanLoopConfig::isValid() const {
