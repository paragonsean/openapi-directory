...
/*
 * OAIDescribeProjectVersionsResponse.h
 *
 * 
 */

#ifndef OAIDescribeProjectVersionsResponse_H
#define OAIDescribeProjectVersionsResponse_H
...
class OAIDescribeProjectVersionsResponse : public OAIObject {
public:
    OAIDescribeProjectVersionsResponse();
    OAIDescribeProjectVersionsResponse(QString json);
    ~OAIDescribeProjectVersionsResponse() override;
    ...
    QList getProjectVersionDescriptions() const;
    void setProjectVersionDescriptions(const QList &project_version_descriptions);
    bool is_project_version_descriptions_Set() const;
    bool is_project_version_descriptions_Valid() const;
...
private:
    ...
    QList m_project_version_descriptions;
    bool m_project_version_descriptions_isSet;
    bool m_project_version_descriptions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectVersionsResponse)

#endif // OAIDescribeProjectVersionsResponse_H
