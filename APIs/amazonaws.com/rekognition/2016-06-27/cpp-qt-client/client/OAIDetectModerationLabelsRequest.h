...
/*
 * OAIDetectModerationLabelsRequest.h
 *
 * 
 */

#ifndef OAIDetectModerationLabelsRequest_H
#define OAIDetectModerationLabelsRequest_H
...
class OAIDetectModerationLabelsRequest_HumanLoopConfig;

class OAIDetectModerationLabelsRequest : public OAIObject {
public:
    OAIDetectModerationLabelsRequest();
    OAIDetectModerationLabelsRequest(QString json);
    ~OAIDetectModerationLabelsRequest() override;
    ...
    OAIDetectModerationLabelsRequest_HumanLoopConfig getHumanLoopConfig() const;
    void setHumanLoopConfig(const OAIDetectModerationLabelsRequest_HumanLoopConfig &human_loop_config);
...
private:
    ...
    OAIDetectModerationLabelsRequest_HumanLoopConfig m_human_loop_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectModerationLabelsRequest)

#endif // OAIDetectModerationLabelsRequest_H
