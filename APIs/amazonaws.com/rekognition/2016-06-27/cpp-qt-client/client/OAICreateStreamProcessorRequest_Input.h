...
/*
 * OAICreateStreamProcessorRequest_Input.h
 *
 * 
 */

#ifndef OAICreateStreamProcessorRequest_Input_H
#define OAICreateStreamProcessorRequest_Input_H
...
namespace OpenAPI {
class OAIStreamProcessorInput_KinesisVideoStream;

class OAICreateStreamProcessorRequest_Input : public OAIObject {
public:
    OAICreateStreamProcessorRequest_Input();
    OAICreateStreamProcessorRequest_Input(QString json);
    ~OAICreateStreamProcessorRequest_Input() override;
    ...
    OAIStreamProcessorInput_KinesisVideoStream getKinesisVideoStream() const;
    void setKinesisVideoStream(const OAIStreamProcessorInput_KinesisVideoStream &kinesis_video_stream);
    bool is_kinesis_video_stream_Set() const;
    bool is_kinesis_video_stream_Valid() const;
...
private:
    ...
    OAIStreamProcessorInput_KinesisVideoStream m_kinesis_video_stream;
    bool m_kinesis_video_stream_isSet;
    bool m_kinesis_video_stream_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamProcessorRequest_Input)

#endif // OAICreateStreamProcessorRequest_Input_H
