...
#ifndef OAISegmentTypeInfo_H
#define OAISegmentTypeInfo_H
...
class OAISegmentTypeInfo : public OAIObject {
public:
    OAISegmentTypeInfo();
    OAISegmentTypeInfo(QString json);
    ~OAISegmentTypeInfo() override;
    ...
    OAISegmentType getType() const;
    void setType(const OAISegmentType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAISegmentTypeInfo)

#endif // OAISegmentTypeInfo_H
