...
/*
 * OAITestingDataResult.h
 *
 * Sagemaker Groundtruth format manifest files for the input, output and validation datasets that are used and created during testing.
 */

#ifndef OAITestingDataResult_H
#define OAITestingDataResult_H

#include <QJsonObject>

#include "OAITestingDataResult_Input.h"
#include "OAITestingDataResult_Output.h"
#include "OAITestingDataResult_Validation.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAITestingDataResult_Input;
class OAITestingDataResult_Output;
class OAITestingDataResult_Validation;

class OAITestingDataResult : public OAIObject {
public:
    OAITestingDataResult();
    OAITestingDataResult(QString json);
    ~OAITestingDataResult() override;
    ...
    OAITestingDataResult_Input getInput() const;
    void setInput(const OAITestingDataResult_Input &input);
    bool is_input_Set() const;
    bool is_input_Valid() const;

    OAITestingDataResult_Output getOutput() const;
    void setOutput(const OAITestingDataResult_Output &output);
    bool is_output_Set() const;
    bool is_output_Valid() const;

    OAITestingDataResult_Validation getValidation() const;
    void setValidation(const OAITestingDataResult_Validation &validation);
...
private:
    ...
    OAITestingDataResult_Input m_input;
    bool m_input_isSet;
    bool m_input_isValid;

    OAITestingDataResult_Output m_output;
    bool m_output_isSet;
    bool m_output_isValid;

    OAITestingDataResult_Validation m_validation;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestingDataResult)

#endif // OAITestingDataResult_H
