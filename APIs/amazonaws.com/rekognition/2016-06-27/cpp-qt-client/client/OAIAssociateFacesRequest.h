...
/*
 * OAIAssociateFacesRequest.h
 *
 * 
 */

#ifndef OAIAssociateFacesRequest_H
#define OAIAssociateFacesRequest_H
...
class OAIAssociateFacesRequest : public OAIObject {
public:
    OAIAssociateFacesRequest();
    OAIAssociateFacesRequest(QString json);
    ~OAIAssociateFacesRequest() override;
    ...
    QList getFaceIds() const;
    void setFaceIds(const QList &face_ids);
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateFacesRequest)

#endif // OAIAssociateFacesRequest_H
