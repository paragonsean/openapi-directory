...
/*
 * OAIProjectVersionDescription_EvaluationResult.h
 *
 * 
 */

#ifndef OAIProjectVersionDescription_EvaluationResult_H
#define OAIProjectVersionDescription_EvaluationResult_H
...
class OAIProjectVersionDescription_EvaluationResult : public OAIObject {
public:
    OAIProjectVersionDescription_EvaluationResult();
    OAIProjectVersionDescription_EvaluationResult(QString json);
    ~OAIProjectVersionDescription_EvaluationResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectVersionDescription_EvaluationResult)

#endif // OAIProjectVersionDescription_EvaluationResult_H
