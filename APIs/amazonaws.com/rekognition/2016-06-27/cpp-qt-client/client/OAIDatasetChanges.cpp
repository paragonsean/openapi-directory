...
OAIDatasetChanges::OAIDatasetChanges(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetChanges::OAIDatasetChanges() {
    this->initializeModel();
}

OAIDatasetChanges::~OAIDatasetChanges() {}

void OAIDatasetChanges::initializeModel() {

    m_ground_truth_isSet = false;
    m_ground_truth_isValid = false;
}

void OAIDatasetChanges::fromJson(QString jsonString) {
...
void OAIDatasetChanges::fromJsonObject(QJsonObject json) {
...
QString OAIDatasetChanges::asJson() const {
...
QJsonObject OAIDatasetChanges::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDatasetChanges::getGroundTruth() const {
    return m_ground_truth;
}
void OAIDatasetChanges::setGroundTruth(const QString &ground_truth) {
    m_ground_truth = ground_truth;
    m_ground_truth_isSet = true;
}

bool OAIDatasetChanges::is_ground_truth_Set() const{
    return m_ground_truth_isSet;
}

bool OAIDatasetChanges::is_ground_truth_Valid() const{
    return m_ground_truth_isValid;
}

bool OAIDatasetChanges::isSet() const {
...
bool OAIDatasetChanges::isValid() const {
