...
/*
 * OAITextDetection_Geometry.h
 *
 * 
 */

#ifndef OAITextDetection_Geometry_H
#define OAITextDetection_Geometry_H
...
class OAITextDetection_Geometry : public OAIObject {
public:
    OAITextDetection_Geometry();
    OAITextDetection_Geometry(QString json);
    ~OAITextDetection_Geometry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITextDetection_Geometry)

#endif // OAITextDetection_Geometry_H
