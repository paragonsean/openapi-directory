...
/*
 * OAITrainingDataResult_Output.h
 *
 * 
 */

#ifndef OAITrainingDataResult_Output_H
#define OAITrainingDataResult_Output_H
...
class OAITrainingDataResult_Output : public OAIObject {
public:
    OAITrainingDataResult_Output();
    OAITrainingDataResult_Output(QString json);
    ~OAITrainingDataResult_Output() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingDataResult_Output)

#endif // OAITrainingDataResult_Output_H
