...
/*
 * OAIDetectLabelsImageForeground_Quality.h
 *
 * 
 */

#ifndef OAIDetectLabelsImageForeground_Quality_H
#define OAIDetectLabelsImageForeground_Quality_H
...
class OAIDetectLabelsImageForeground_Quality : public OAIObject {
public:
    OAIDetectLabelsImageForeground_Quality();
    OAIDetectLabelsImageForeground_Quality(QString json);
    ~OAIDetectLabelsImageForeground_Quality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageForeground_Quality)

#endif // OAIDetectLabelsImageForeground_Quality_H
