...
/*
 * OAIStartStreamProcessorRequest.h
 *
 * 
 */

#ifndef OAIStartStreamProcessorRequest_H
#define OAIStartStreamProcessorRequest_H

#include <QJsonObject>

#include "OAIStartStreamProcessorRequest_StartSelector.h"
#include "OAIStartStreamProcessorRequest_StopSelector.h"
#include <QString>
...
namespace OpenAPI {
class OAIStartStreamProcessorRequest_StartSelector;
class OAIStartStreamProcessorRequest_StopSelector;

class OAIStartStreamProcessorRequest : public OAIObject {
public:
    OAIStartStreamProcessorRequest();
    OAIStartStreamProcessorRequest(QString json);
    ~OAIStartStreamProcessorRequest() override;
    ...
    OAIStartStreamProcessorRequest_StartSelector getStartSelector() const;
    void setStartSelector(const OAIStartStreamProcessorRequest_StartSelector &start_selector);
    bool is_start_selector_Set() const;
    bool is_start_selector_Valid() const;

    OAIStartStreamProcessorRequest_StopSelector getStopSelector() const;
    void setStopSelector(const OAIStartStreamProcessorRequest_StopSelector &stop_selector);
    bool is_stop_selector_Set() const;
    bool is_stop_selector_Valid() const;
...
private:
    ...
    OAIStartStreamProcessorRequest_StartSelector m_start_selector;
    bool m_start_selector_isSet;
    bool m_start_selector_isValid;

    OAIStartStreamProcessorRequest_StopSelector m_stop_selector;
    bool m_stop_selector_isSet;
    bool m_stop_selector_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartStreamProcessorRequest)

#endif // OAIStartStreamProcessorRequest_H
