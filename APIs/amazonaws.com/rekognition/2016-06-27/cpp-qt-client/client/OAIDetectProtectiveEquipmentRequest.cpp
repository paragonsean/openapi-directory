...
#include "OAIDetectProtectiveEquipmentRequest.h"
...
OAIDetectProtectiveEquipmentRequest::OAIDetectProtectiveEquipmentRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectProtectiveEquipmentRequest::OAIDetectProtectiveEquipmentRequest() {
    this->initializeModel();
}

OAIDetectProtectiveEquipmentRequest::~OAIDetectProtectiveEquipmentRequest() {}

void OAIDetectProtectiveEquipmentRequest::initializeModel() {

    m_image_isSet = false;
    m_image_isValid = false;

    m_summarization_attributes_isSet = false;
    m_summarization_attributes_isValid = false;
}

void OAIDetectProtectiveEquipmentRequest::fromJson(QString jsonString) {
...
void OAIDetectProtectiveEquipmentRequest::fromJsonObject(QJsonObject json) {

    m_image_isValid = ::OpenAPI::fromJsonValue(m_image, json[QString("Image")]);
    m_image_isSet = !json[QString("Image")].isNull() && m_image_isValid;

    m_summarization_attributes_isValid = ::OpenAPI::fromJsonValue(m_summarization_attributes, json[QString("SummarizationAttributes")]);
    m_summarization_attributes_isSet = !json[QString("SummarizationAttributes")].isNull() && m_summarization_attributes_isValid;
}

QString OAIDetectProtectiveEquipmentRequest::asJson() const {
...
QJsonObject OAIDetectProtectiveEquipmentRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_image.isSet()) {
        obj.insert(QString("Image"), ::OpenAPI::toJsonValue(m_image));
    }
    if (m_summarization_attributes.isSet()) {
        obj.insert(QString("SummarizationAttributes"), ::OpenAPI::toJsonValue(m_summarization_attributes));
    }
    return obj;
}

OAIDetectProtectiveEquipmentRequest_Image OAIDetectProtectiveEquipmentRequest::getImage() const {
    return m_image;
}
void OAIDetectProtectiveEquipmentRequest::setImage(const OAIDetectProtectiveEquipmentRequest_Image &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIDetectProtectiveEquipmentRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIDetectProtectiveEquipmentRequest::is_image_Valid() const{
    return m_image_isValid;
}

OAIDetectProtectiveEquipmentRequest_SummarizationAttributes OAIDetectProtectiveEquipmentRequest::getSummarizationAttributes() const {
    return m_summarization_attributes;
}
void OAIDetectProtectiveEquipmentRequest::setSummarizationAttributes(const OAIDetectProtectiveEquipmentRequest_SummarizationAttributes &summarization_attributes) {
    m_summarization_attributes = summarization_attributes;
    m_summarization_attributes_isSet = true;
}

bool OAIDetectProtectiveEquipmentRequest::is_summarization_attributes_Set() const{
    return m_summarization_attributes_isSet;
}

bool OAIDetectProtectiveEquipmentRequest::is_summarization_attributes_Valid() const{
    return m_summarization_attributes_isValid;
}

bool OAIDetectProtectiveEquipmentRequest::isSet() const {
...
bool OAIDetectProtectiveEquipmentRequest::isValid() const {
