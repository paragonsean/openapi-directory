...
OAIPersonMatch::OAIPersonMatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonMatch::OAIPersonMatch() {
    this->initializeModel();
}

OAIPersonMatch::~OAIPersonMatch() {}

void OAIPersonMatch::initializeModel() {
    ...
    m_face_matches_isSet = false;
    m_face_matches_isValid = false;
}

void OAIPersonMatch::fromJson(QString jsonString) {
...
void OAIPersonMatch::fromJsonObject(QJsonObject json) {
    ...
    m_face_matches_isValid = ::OpenAPI::fromJsonValue(m_face_matches, json[QString("FaceMatches")]);
    m_face_matches_isSet = !json[QString("FaceMatches")].isNull() && m_face_matches_isValid;
}

QString OAIPersonMatch::asJson() const {
...
QJsonObject OAIPersonMatch::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_face_matches.isSet()) {
        obj.insert(QString("FaceMatches"), ::OpenAPI::toJsonValue(m_face_matches));
    }
    return obj;
}

qint32 OAIPersonMatch::getTimestamp() const {
    return m_timestamp;
}
void OAIPersonMatch::setTimestamp(const qint32 &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIPersonMatch::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIPersonMatch::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAIPersonMatch_Person OAIPersonMatch::getPerson() const {
    return m_person;
}
void OAIPersonMatch::setPerson(const OAIPersonMatch_Person &person) {
    m_person = person;
    m_person_isSet = true;
}

bool OAIPersonMatch::is_person_Set() const{
    return m_person_isSet;
}

bool OAIPersonMatch::is_person_Valid() const{
    return m_person_isValid;
}

QList OAIPersonMatch::getFaceMatches() const {
    return m_face_matches;
}
void OAIPersonMatch::setFaceMatches(const QList &face_matches) {
    m_face_matches = face_matches;
    m_face_matches_isSet = true;
}

bool OAIPersonMatch::is_face_matches_Set() const{
    return m_face_matches_isSet;
}

bool OAIPersonMatch::is_face_matches_Valid() const{
    return m_face_matches_isValid;
}

bool OAIPersonMatch::isSet() const {
...
bool OAIPersonMatch::isValid() const {
