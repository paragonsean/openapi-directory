...
#include "OAIGetTextDetectionRequest.h"
...
OAIGetTextDetectionRequest::OAIGetTextDetectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetTextDetectionRequest::OAIGetTextDetectionRequest() {
    this->initializeModel();
}

OAIGetTextDetectionRequest::~OAIGetTextDetectionRequest() {}

void OAIGetTextDetectionRequest::initializeModel() {
...
void OAIGetTextDetectionRequest::fromJson(QString jsonString) {
...
void OAIGetTextDetectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetTextDetectionRequest::asJson() const {
...
QJsonObject OAIGetTextDetectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetTextDetectionRequest::getJobId() const {
    return m_job_id;
}
void OAIGetTextDetectionRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetTextDetectionRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetTextDetectionRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetTextDetectionRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetTextDetectionRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetTextDetectionRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetTextDetectionRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetTextDetectionRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetTextDetectionRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetTextDetectionRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetTextDetectionRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetTextDetectionRequest::isSet() const {
...
bool OAIGetTextDetectionRequest::isValid() const {
