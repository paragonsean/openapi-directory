...
#include "OAICreateStreamProcessorResponse.h"
...
OAICreateStreamProcessorResponse::OAICreateStreamProcessorResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamProcessorResponse::OAICreateStreamProcessorResponse() {
    this->initializeModel();
}

OAICreateStreamProcessorResponse::~OAICreateStreamProcessorResponse() {}

void OAICreateStreamProcessorResponse::initializeModel() {

    m_stream_processor_arn_isSet = false;
    m_stream_processor_arn_isValid = false;
}

void OAICreateStreamProcessorResponse::fromJson(QString jsonString) {
...
void OAICreateStreamProcessorResponse::fromJsonObject(QJsonObject json) {

    m_stream_processor_arn_isValid = ::OpenAPI::fromJsonValue(m_stream_processor_arn, json[QString("StreamProcessorArn")]);
    m_stream_processor_arn_isSet = !json[QString("StreamProcessorArn")].isNull() && m_stream_processor_arn_isValid;
}

QString OAICreateStreamProcessorResponse::asJson() const {
...
QJsonObject OAICreateStreamProcessorResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_stream_processor_arn_isSet) {
        obj.insert(QString("StreamProcessorArn"), ::OpenAPI::toJsonValue(m_stream_processor_arn));
    }
    return obj;
}

QString OAICreateStreamProcessorResponse::getStreamProcessorArn() const {
    return m_stream_processor_arn;
}
void OAICreateStreamProcessorResponse::setStreamProcessorArn(const QString &stream_processor_arn) {
    m_stream_processor_arn = stream_processor_arn;
    m_stream_processor_arn_isSet = true;
}

bool OAICreateStreamProcessorResponse::is_stream_processor_arn_Set() const{
    return m_stream_processor_arn_isSet;
}

bool OAICreateStreamProcessorResponse::is_stream_processor_arn_Valid() const{
    return m_stream_processor_arn_isValid;
}

bool OAICreateStreamProcessorResponse::isSet() const {
...
bool OAICreateStreamProcessorResponse::isValid() const {
