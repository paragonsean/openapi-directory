...
#ifndef OAIDetectLabelsSettings_H
#define OAIDetectLabelsSettings_H
...
class OAIDetectLabelsSettings : public OAIObject {
public:
    OAIDetectLabelsSettings();
    OAIDetectLabelsSettings(QString json);
    ~OAIDetectLabelsSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsSettings)

#endif // OAIDetectLabelsSettings_H
