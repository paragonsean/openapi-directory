...
/*
 * OAIStartContentModerationRequest_NotificationChannel.h
 *
 * 
 */

#ifndef OAIStartContentModerationRequest_NotificationChannel_H
#define OAIStartContentModerationRequest_NotificationChannel_H
...
class OAIStartContentModerationRequest_NotificationChannel : public OAIObject {
public:
    OAIStartContentModerationRequest_NotificationChannel();
    OAIStartContentModerationRequest_NotificationChannel(QString json);
    ~OAIStartContentModerationRequest_NotificationChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartContentModerationRequest_NotificationChannel)

#endif // OAIStartContentModerationRequest_NotificationChannel_H
