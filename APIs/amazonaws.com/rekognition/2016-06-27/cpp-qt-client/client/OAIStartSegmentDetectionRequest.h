...
/*
 * OAIStartSegmentDetectionRequest.h
 *
 * 
 */

#ifndef OAIStartSegmentDetectionRequest_H
#define OAIStartSegmentDetectionRequest_H
...
namespace OpenAPI {
class OAIVideo;
class OAIStartSegmentDetectionRequest_NotificationChannel;
class OAIStartSegmentDetectionRequest_Filters;

class OAIStartSegmentDetectionRequest : public OAIObject {
public:
    OAIStartSegmentDetectionRequest();
    OAIStartSegmentDetectionRequest(QString json);
    ~OAIStartSegmentDetectionRequest() override;
    ...
    OAIStartSegmentDetectionRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartSegmentDetectionRequest_NotificationChannel &notification_channel);
    ...
    OAIStartSegmentDetectionRequest_Filters getFilters() const;
    void setFilters(const OAIStartSegmentDetectionRequest_Filters &filters);
    bool is_filters_Set() const;
    bool is_filters_Valid() const;

    QList getSegmentTypes() const;
    void setSegmentTypes(const QList &segment_types);
    bool is_segment_types_Set() const;
    bool is_segment_types_Valid() const;
...
private:
    ...
    OAIStartSegmentDetectionRequest_NotificationChannel m_notification_channel;
    ...
    OAIStartSegmentDetectionRequest_Filters m_filters;
    bool m_filters_isSet;
    bool m_filters_isValid;

    QList m_segment_types;
    bool m_segment_types_isSet;
    bool m_segment_types_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartSegmentDetectionRequest)

#endif // OAIStartSegmentDetectionRequest_H
