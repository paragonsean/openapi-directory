...
#include "OAIStartCelebrityRecognitionRequest.h"
...
OAIStartCelebrityRecognitionRequest::OAIStartCelebrityRecognitionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartCelebrityRecognitionRequest::OAIStartCelebrityRecognitionRequest() {
    this->initializeModel();
}

OAIStartCelebrityRecognitionRequest::~OAIStartCelebrityRecognitionRequest() {}

void OAIStartCelebrityRecognitionRequest::initializeModel() {
...
void OAIStartCelebrityRecognitionRequest::fromJson(QString jsonString) {
...
void OAIStartCelebrityRecognitionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartCelebrityRecognitionRequest::asJson() const {
...
QJsonObject OAIStartCelebrityRecognitionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_video.isSet()) {
...
OAIStartCelebrityRecognitionRequest_Video OAIStartCelebrityRecognitionRequest::getVideo() const {
    return m_video;
}
void OAIStartCelebrityRecognitionRequest::setVideo(const OAIStartCelebrityRecognitionRequest_Video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStartCelebrityRecognitionRequest::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIStartCelebrityRecognitionRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIStartCelebrityRecognitionRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIStartCelebrityRecognitionRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAIStartCelebrityRecognitionRequest_NotificationChannel OAIStartCelebrityRecognitionRequest::getNotificationChannel() const {
    return m_notification_channel;
}
void OAIStartCelebrityRecognitionRequest::setNotificationChannel(const OAIStartCelebrityRecognitionRequest_NotificationChannel &notification_channel) {
    m_notification_channel = notification_channel;
    m_notification_channel_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest::is_notification_channel_Set() const{
    return m_notification_channel_isSet;
}

bool OAIStartCelebrityRecognitionRequest::is_notification_channel_Valid() const{
    return m_notification_channel_isValid;
}

QString OAIStartCelebrityRecognitionRequest::getJobTag() const {
    return m_job_tag;
}
void OAIStartCelebrityRecognitionRequest::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIStartCelebrityRecognitionRequest::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIStartCelebrityRecognitionRequest::isSet() const {
...
bool OAIStartCelebrityRecognitionRequest::isValid() const {
