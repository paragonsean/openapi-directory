...
OAIPersonTrackingSortBy::OAIPersonTrackingSortBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonTrackingSortBy::OAIPersonTrackingSortBy() {
    this->initializeModel();
}

OAIPersonTrackingSortBy::~OAIPersonTrackingSortBy() {}

void OAIPersonTrackingSortBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIPersonTrackingSortBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIPersonTrackingSortBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("INDEX", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPersonTrackingSortBy::INDEX;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMESTAMP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIPersonTrackingSortBy::TIMESTAMP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIPersonTrackingSortBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIPersonTrackingSortBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIPersonTrackingSortBy::INDEX:
            val = "INDEX";
            break;
        case eOAIPersonTrackingSortBy::TIMESTAMP:
            val = "TIMESTAMP";
            break;
        default:
            break;
...
QJsonValue OAIPersonTrackingSortBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIPersonTrackingSortBy::eOAIPersonTrackingSortBy OAIPersonTrackingSortBy::getValue() const {
    return m_value;
}

void OAIPersonTrackingSortBy::setValue(const OAIPersonTrackingSortBy::eOAIPersonTrackingSortBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIPersonTrackingSortBy::isSet() const {
    
    return m_value_isSet;
}

bool OAIPersonTrackingSortBy::isValid() const {
