...
/*
 * OAIDescribeCollectionResponse.h
 *
 * 
 */

#ifndef OAIDescribeCollectionResponse_H
#define OAIDescribeCollectionResponse_H
...
class OAIDescribeCollectionResponse : public OAIObject {
public:
    OAIDescribeCollectionResponse();
    OAIDescribeCollectionResponse(QString json);
    ~OAIDescribeCollectionResponse() override;
    ...
    qint32 getFaceCount() const;
    void setFaceCount(const qint32 &face_count);
    bool is_face_count_Set() const;
    bool is_face_count_Valid() const;
...
private:
    ...
    qint32 m_face_count;
    bool m_face_count_isSet;
    bool m_face_count_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCollectionResponse)

#endif // OAIDescribeCollectionResponse_H
