...
/*
 * OAIDeleteFacesRequest.h
 *
 * 
 */

#ifndef OAIDeleteFacesRequest_H
#define OAIDeleteFacesRequest_H
...
class OAIDeleteFacesRequest : public OAIObject {
public:
    OAIDeleteFacesRequest();
    OAIDeleteFacesRequest(QString json);
    ~OAIDeleteFacesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFacesRequest)

#endif // OAIDeleteFacesRequest_H
