...
#include "OAIKinesisVideoStream.h"
...
OAIKinesisVideoStream::OAIKinesisVideoStream(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKinesisVideoStream::OAIKinesisVideoStream() {
    this->initializeModel();
}

OAIKinesisVideoStream::~OAIKinesisVideoStream() {}

void OAIKinesisVideoStream::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIKinesisVideoStream::fromJson(QString jsonString) {
...
void OAIKinesisVideoStream::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIKinesisVideoStream::asJson() const {
...
QJsonObject OAIKinesisVideoStream::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIKinesisVideoStream::getArn() const {
    return m_arn;
}
void OAIKinesisVideoStream::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIKinesisVideoStream::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIKinesisVideoStream::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIKinesisVideoStream::isSet() const {
...
bool OAIKinesisVideoStream::isValid() const {
