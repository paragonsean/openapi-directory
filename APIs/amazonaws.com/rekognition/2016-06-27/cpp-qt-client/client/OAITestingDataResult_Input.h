...
/*
 * OAITestingDataResult_Input.h
 *
 * 
 */

#ifndef OAITestingDataResult_Input_H
#define OAITestingDataResult_Input_H
...
class OAITestingDataResult_Input : public OAIObject {
public:
    OAITestingDataResult_Input();
    OAITestingDataResult_Input(QString json);
    ~OAITestingDataResult_Input() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestingDataResult_Input)

#endif // OAITestingDataResult_Input_H
