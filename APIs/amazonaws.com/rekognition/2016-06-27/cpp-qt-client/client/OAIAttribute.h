...
class OAIAttribute : public OAIEnum {
public:
    OAIAttribute();
    ...
    OAIAttribute::eOAIAttribute getValue() const;
    void setValue(const OAIAttribute::eOAIAttribute& value);
