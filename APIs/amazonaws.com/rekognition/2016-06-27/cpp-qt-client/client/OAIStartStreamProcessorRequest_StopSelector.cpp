...
OAIStartStreamProcessorRequest_StopSelector::OAIStartStreamProcessorRequest_StopSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartStreamProcessorRequest_StopSelector::OAIStartStreamProcessorRequest_StopSelector() {
    this->initializeModel();
}

OAIStartStreamProcessorRequest_StopSelector::~OAIStartStreamProcessorRequest_StopSelector() {}

void OAIStartStreamProcessorRequest_StopSelector::initializeModel() {

    m_max_duration_in_seconds_isSet = false;
    m_max_duration_in_seconds_isValid = false;
}

void OAIStartStreamProcessorRequest_StopSelector::fromJson(QString jsonString) {
...
void OAIStartStreamProcessorRequest_StopSelector::fromJsonObject(QJsonObject json) {

    m_max_duration_in_seconds_isValid = ::OpenAPI::fromJsonValue(m_max_duration_in_seconds, json[QString("MaxDurationInSeconds")]);
    m_max_duration_in_seconds_isSet = !json[QString("MaxDurationInSeconds")].isNull() && m_max_duration_in_seconds_isValid;
}

QString OAIStartStreamProcessorRequest_StopSelector::asJson() const {
...
QJsonObject OAIStartStreamProcessorRequest_StopSelector::asJsonObject() const {
    QJsonObject obj;
    if (m_max_duration_in_seconds_isSet) {
        obj.insert(QString("MaxDurationInSeconds"), ::OpenAPI::toJsonValue(m_max_duration_in_seconds));
    }
    return obj;
}

qint32 OAIStartStreamProcessorRequest_StopSelector::getMaxDurationInSeconds() const {
    return m_max_duration_in_seconds;
}
void OAIStartStreamProcessorRequest_StopSelector::setMaxDurationInSeconds(const qint32 &max_duration_in_seconds) {
    m_max_duration_in_seconds = max_duration_in_seconds;
    m_max_duration_in_seconds_isSet = true;
}

bool OAIStartStreamProcessorRequest_StopSelector::is_max_duration_in_seconds_Set() const{
    return m_max_duration_in_seconds_isSet;
}

bool OAIStartStreamProcessorRequest_StopSelector::is_max_duration_in_seconds_Valid() const{
    return m_max_duration_in_seconds_isValid;
}

bool OAIStartStreamProcessorRequest_StopSelector::isSet() const {
...
bool OAIStartStreamProcessorRequest_StopSelector::isValid() const {
