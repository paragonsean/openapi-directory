...
class OAIDisassociatedFace : public OAIObject {
public:
    OAIDisassociatedFace();
    OAIDisassociatedFace(QString json);
    ~OAIDisassociatedFace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDisassociatedFace)

#endif // OAIDisassociatedFace_H
