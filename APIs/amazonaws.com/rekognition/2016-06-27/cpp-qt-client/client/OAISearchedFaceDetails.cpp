...
#include "OAISearchedFaceDetails.h"
...
OAISearchedFaceDetails::OAISearchedFaceDetails(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchedFaceDetails::OAISearchedFaceDetails() {
    this->initializeModel();
}

OAISearchedFaceDetails::~OAISearchedFaceDetails() {}

void OAISearchedFaceDetails::initializeModel() {

    m_face_detail_isSet = false;
    m_face_detail_isValid = false;
}

void OAISearchedFaceDetails::fromJson(QString jsonString) {
...
void OAISearchedFaceDetails::fromJsonObject(QJsonObject json) {
...
QString OAISearchedFaceDetails::asJson() const {
...
QJsonObject OAISearchedFaceDetails::asJsonObject() const {
    QJsonObject obj;
...
OAIFaceDetail OAISearchedFaceDetails::getFaceDetail() const {
    return m_face_detail;
}
void OAISearchedFaceDetails::setFaceDetail(const OAIFaceDetail &face_detail) {
    m_face_detail = face_detail;
    m_face_detail_isSet = true;
}

bool OAISearchedFaceDetails::is_face_detail_Set() const{
    return m_face_detail_isSet;
}

bool OAISearchedFaceDetails::is_face_detail_Valid() const{
    return m_face_detail_isValid;
}

bool OAISearchedFaceDetails::isSet() const {
...
bool OAISearchedFaceDetails::isValid() const {
