...
OAISegmentTypeInfo::OAISegmentTypeInfo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISegmentTypeInfo::OAISegmentTypeInfo() {
    this->initializeModel();
}

OAISegmentTypeInfo::~OAISegmentTypeInfo() {}

void OAISegmentTypeInfo::initializeModel() {
...
void OAISegmentTypeInfo::fromJson(QString jsonString) {
...
void OAISegmentTypeInfo::fromJsonObject(QJsonObject json) {
...
QString OAISegmentTypeInfo::asJson() const {
...
QJsonObject OAISegmentTypeInfo::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAISegmentType OAISegmentTypeInfo::getType() const {
    return m_type;
}
void OAISegmentTypeInfo::setType(const OAISegmentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISegmentTypeInfo::is_type_Set() const{
    return m_type_isSet;
}

bool OAISegmentTypeInfo::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISegmentTypeInfo::getModelVersion() const {
    return m_model_version;
}
void OAISegmentTypeInfo::setModelVersion(const QString &model_version) {
    m_model_version = model_version;
    m_model_version_isSet = true;
}

bool OAISegmentTypeInfo::is_model_version_Set() const{
    return m_model_version_isSet;
}

bool OAISegmentTypeInfo::is_model_version_Valid() const{
    return m_model_version_isValid;
}

bool OAISegmentTypeInfo::isSet() const {
...
bool OAISegmentTypeInfo::isValid() const {
