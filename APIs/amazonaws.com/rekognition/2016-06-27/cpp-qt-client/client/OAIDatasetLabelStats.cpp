...
#include "OAIDatasetLabelStats.h"
...
OAIDatasetLabelStats::OAIDatasetLabelStats(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetLabelStats::OAIDatasetLabelStats() {
    this->initializeModel();
}

OAIDatasetLabelStats::~OAIDatasetLabelStats() {}

void OAIDatasetLabelStats::initializeModel() {
...
void OAIDatasetLabelStats::fromJson(QString jsonString) {
...
void OAIDatasetLabelStats::fromJsonObject(QJsonObject json) {
...
QString OAIDatasetLabelStats::asJson() const {
...
QJsonObject OAIDatasetLabelStats::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDatasetLabelStats::getEntryCount() const {
    return m_entry_count;
}
void OAIDatasetLabelStats::setEntryCount(const qint32 &entry_count) {
    m_entry_count = entry_count;
    m_entry_count_isSet = true;
}

bool OAIDatasetLabelStats::is_entry_count_Set() const{
    return m_entry_count_isSet;
}

bool OAIDatasetLabelStats::is_entry_count_Valid() const{
    return m_entry_count_isValid;
}

qint32 OAIDatasetLabelStats::getBoundingBoxCount() const {
    return m_bounding_box_count;
}
void OAIDatasetLabelStats::setBoundingBoxCount(const qint32 &bounding_box_count) {
    m_bounding_box_count = bounding_box_count;
    m_bounding_box_count_isSet = true;
}

bool OAIDatasetLabelStats::is_bounding_box_count_Set() const{
    return m_bounding_box_count_isSet;
}

bool OAIDatasetLabelStats::is_bounding_box_count_Valid() const{
    return m_bounding_box_count_isValid;
}

bool OAIDatasetLabelStats::isSet() const {
...
bool OAIDatasetLabelStats::isValid() const {
