...
#include "OAIUpdateDatasetEntriesRequest_Changes.h"
...
OAIUpdateDatasetEntriesRequest_Changes::OAIUpdateDatasetEntriesRequest_Changes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateDatasetEntriesRequest_Changes::OAIUpdateDatasetEntriesRequest_Changes() {
    this->initializeModel();
}

OAIUpdateDatasetEntriesRequest_Changes::~OAIUpdateDatasetEntriesRequest_Changes() {}

void OAIUpdateDatasetEntriesRequest_Changes::initializeModel() {

    m_ground_truth_isSet = false;
    m_ground_truth_isValid = false;
}

void OAIUpdateDatasetEntriesRequest_Changes::fromJson(QString jsonString) {
...
void OAIUpdateDatasetEntriesRequest_Changes::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateDatasetEntriesRequest_Changes::asJson() const {
...
QJsonObject OAIUpdateDatasetEntriesRequest_Changes::asJsonObject() const {
    QJsonObject obj;
    if (m_ground_truth_isSet) {
        obj.insert(QString("GroundTruth"), ::OpenAPI::toJsonValue(m_ground_truth));
    }
    return obj;
}

QString OAIUpdateDatasetEntriesRequest_Changes::getGroundTruth() const {
    return m_ground_truth;
}
void OAIUpdateDatasetEntriesRequest_Changes::setGroundTruth(const QString &ground_truth) {
    m_ground_truth = ground_truth;
    m_ground_truth_isSet = true;
}

bool OAIUpdateDatasetEntriesRequest_Changes::is_ground_truth_Set() const{
    return m_ground_truth_isSet;
}

bool OAIUpdateDatasetEntriesRequest_Changes::is_ground_truth_Valid() const{
    return m_ground_truth_isValid;
}

bool OAIUpdateDatasetEntriesRequest_Changes::isSet() const {
...
bool OAIUpdateDatasetEntriesRequest_Changes::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_ground_truth_isValid && true;
}
