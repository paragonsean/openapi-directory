...
#include "OAIListProjectPoliciesResponse.h"
...
OAIListProjectPoliciesResponse::OAIListProjectPoliciesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListProjectPoliciesResponse::OAIListProjectPoliciesResponse() {
    this->initializeModel();
}

OAIListProjectPoliciesResponse::~OAIListProjectPoliciesResponse() {}

void OAIListProjectPoliciesResponse::initializeModel() {

    m_project_policies_isSet = false;
    m_project_policies_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIListProjectPoliciesResponse::fromJson(QString jsonString) {
...
void OAIListProjectPoliciesResponse::fromJsonObject(QJsonObject json) {

    m_project_policies_isValid = ::OpenAPI::fromJsonValue(m_project_policies, json[QString("ProjectPolicies")]);
    m_project_policies_isSet = !json[QString("ProjectPolicies")].isNull() && m_project_policies_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIListProjectPoliciesResponse::asJson() const {
...
QJsonObject OAIListProjectPoliciesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_project_policies.isSet()) {
        obj.insert(QString("ProjectPolicies"), ::OpenAPI::toJsonValue(m_project_policies));
    }
...
QList OAIListProjectPoliciesResponse::getProjectPolicies() const {
    return m_project_policies;
}
void OAIListProjectPoliciesResponse::setProjectPolicies(const QList &project_policies) {
    m_project_policies = project_policies;
    m_project_policies_isSet = true;
}

bool OAIListProjectPoliciesResponse::is_project_policies_Set() const{
    return m_project_policies_isSet;
}

bool OAIListProjectPoliciesResponse::is_project_policies_Valid() const{
    return m_project_policies_isValid;
}

QString OAIListProjectPoliciesResponse::getNextToken() const {
    return m_next_token;
}
void OAIListProjectPoliciesResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListProjectPoliciesResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListProjectPoliciesResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIListProjectPoliciesResponse::isSet() const {
...
bool OAIListProjectPoliciesResponse::isValid() const {
