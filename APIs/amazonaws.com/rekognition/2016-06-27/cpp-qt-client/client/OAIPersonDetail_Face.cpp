...
#include "OAIPersonDetail_Face.h"
...
OAIPersonDetail_Face::OAIPersonDetail_Face(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonDetail_Face::OAIPersonDetail_Face() {
    this->initializeModel();
}

OAIPersonDetail_Face::~OAIPersonDetail_Face() {}

void OAIPersonDetail_Face::initializeModel() {
    ...
    m_eyeglasses_isSet = false;
    m_eyeglasses_isValid = false;

    m_sunglasses_isSet = false;
    m_sunglasses_isValid = false;
    ...
    m_mustache_isSet = false;
    m_mustache_isValid = false;

    m_eyes_open_isSet = false;
    m_eyes_open_isValid = false;

    m_mouth_open_isSet = false;
    m_mouth_open_isValid = false;
    ...
    m_face_occluded_isSet = false;
    m_face_occluded_isValid = false;

    m_eye_direction_isSet = false;
    m_eye_direction_isValid = false;
}

void OAIPersonDetail_Face::fromJson(QString jsonString) {
...
void OAIPersonDetail_Face::fromJsonObject(QJsonObject json) {
    ...
    m_eyeglasses_isValid = ::OpenAPI::fromJsonValue(m_eyeglasses, json[QString("Eyeglasses")]);
    m_eyeglasses_isSet = !json[QString("Eyeglasses")].isNull() && m_eyeglasses_isValid;

    m_sunglasses_isValid = ::OpenAPI::fromJsonValue(m_sunglasses, json[QString("Sunglasses")]);
    m_sunglasses_isSet = !json[QString("Sunglasses")].isNull() && m_sunglasses_isValid;
    ...
    m_mustache_isValid = ::OpenAPI::fromJsonValue(m_mustache, json[QString("Mustache")]);
    m_mustache_isSet = !json[QString("Mustache")].isNull() && m_mustache_isValid;

    m_eyes_open_isValid = ::OpenAPI::fromJsonValue(m_eyes_open, json[QString("EyesOpen")]);
    m_eyes_open_isSet = !json[QString("EyesOpen")].isNull() && m_eyes_open_isValid;

    m_mouth_open_isValid = ::OpenAPI::fromJsonValue(m_mouth_open, json[QString("MouthOpen")]);
    m_mouth_open_isSet = !json[QString("MouthOpen")].isNull() && m_mouth_open_isValid;
    ...
    m_face_occluded_isValid = ::OpenAPI::fromJsonValue(m_face_occluded, json[QString("FaceOccluded")]);
    m_face_occluded_isSet = !json[QString("FaceOccluded")].isNull() && m_face_occluded_isValid;

    m_eye_direction_isValid = ::OpenAPI::fromJsonValue(m_eye_direction, json[QString("EyeDirection")]);
    m_eye_direction_isSet = !json[QString("EyeDirection")].isNull() && m_eye_direction_isValid;
}

QString OAIPersonDetail_Face::asJson() const {
...
QJsonObject OAIPersonDetail_Face::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_eyeglasses.isSet()) {
        obj.insert(QString("Eyeglasses"), ::OpenAPI::toJsonValue(m_eyeglasses));
    }
    if (m_sunglasses.isSet()) {
        obj.insert(QString("Sunglasses"), ::OpenAPI::toJsonValue(m_sunglasses));
    }
    if (m_gender.isSet()) {
    ...
    if (m_mustache.isSet()) {
        obj.insert(QString("Mustache"), ::OpenAPI::toJsonValue(m_mustache));
    }
    if (m_eyes_open.isSet()) {
        obj.insert(QString("EyesOpen"), ::OpenAPI::toJsonValue(m_eyes_open));
    }
    if (m_mouth_open.isSet()) {
        obj.insert(QString("MouthOpen"), ::OpenAPI::toJsonValue(m_mouth_open));
    }
    if (m_emotions.isSet()) {
        obj.insert(QString("Emotions"), ::OpenAPI::toJsonValue(m_emotions));
    }
    if (m_landmarks.isSet()) {
    ...
    if (m_face_occluded.isSet()) {
        obj.insert(QString("FaceOccluded"), ::OpenAPI::toJsonValue(m_face_occluded));
    }
    if (m_eye_direction.isSet()) {
        obj.insert(QString("EyeDirection"), ::OpenAPI::toJsonValue(m_eye_direction));
    }
    return obj;
}

OAIFaceDetail_BoundingBox OAIPersonDetail_Face::getBoundingBox() const {
    return m_bounding_box;
}
void OAIPersonDetail_Face::setBoundingBox(const OAIFaceDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIPersonDetail_Face::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIPersonDetail_Face::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAIFaceDetail_AgeRange OAIPersonDetail_Face::getAgeRange() const {
    return m_age_range;
}
void OAIPersonDetail_Face::setAgeRange(const OAIFaceDetail_AgeRange &age_range) {
    m_age_range = age_range;
    m_age_range_isSet = true;
}

bool OAIPersonDetail_Face::is_age_range_Set() const{
    return m_age_range_isSet;
}

bool OAIPersonDetail_Face::is_age_range_Valid() const{
    return m_age_range_isValid;
}

OAIFaceDetail_Smile OAIPersonDetail_Face::getSmile() const {
    return m_smile;
}
void OAIPersonDetail_Face::setSmile(const OAIFaceDetail_Smile &smile) {
    m_smile = smile;
    m_smile_isSet = true;
}

bool OAIPersonDetail_Face::is_smile_Set() const{
    return m_smile_isSet;
}

bool OAIPersonDetail_Face::is_smile_Valid() const{
    return m_smile_isValid;
}

OAIFaceDetail_Eyeglasses OAIPersonDetail_Face::getEyeglasses() const {
    return m_eyeglasses;
}
void OAIPersonDetail_Face::setEyeglasses(const OAIFaceDetail_Eyeglasses &eyeglasses) {
    m_eyeglasses = eyeglasses;
    m_eyeglasses_isSet = true;
}

bool OAIPersonDetail_Face::is_eyeglasses_Set() const{
    return m_eyeglasses_isSet;
}

bool OAIPersonDetail_Face::is_eyeglasses_Valid() const{
    return m_eyeglasses_isValid;
}

OAIFaceDetail_Sunglasses OAIPersonDetail_Face::getSunglasses() const {
    return m_sunglasses;
}
void OAIPersonDetail_Face::setSunglasses(const OAIFaceDetail_Sunglasses &sunglasses) {
    m_sunglasses = sunglasses;
    m_sunglasses_isSet = true;
}

bool OAIPersonDetail_Face::is_sunglasses_Set() const{
    return m_sunglasses_isSet;
}

bool OAIPersonDetail_Face::is_sunglasses_Valid() const{
    return m_sunglasses_isValid;
}

OAIFaceDetail_Gender OAIPersonDetail_Face::getGender() const {
    return m_gender;
}
void OAIPersonDetail_Face::setGender(const OAIFaceDetail_Gender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIPersonDetail_Face::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIPersonDetail_Face::is_gender_Valid() const{
    return m_gender_isValid;
}

OAIFaceDetail_Beard OAIPersonDetail_Face::getBeard() const {
    return m_beard;
}
void OAIPersonDetail_Face::setBeard(const OAIFaceDetail_Beard &beard) {
    m_beard = beard;
    m_beard_isSet = true;
}

bool OAIPersonDetail_Face::is_beard_Set() const{
    return m_beard_isSet;
}

bool OAIPersonDetail_Face::is_beard_Valid() const{
    return m_beard_isValid;
}

OAIFaceDetail_Mustache OAIPersonDetail_Face::getMustache() const {
    return m_mustache;
}
void OAIPersonDetail_Face::setMustache(const OAIFaceDetail_Mustache &mustache) {
    m_mustache = mustache;
    m_mustache_isSet = true;
}

bool OAIPersonDetail_Face::is_mustache_Set() const{
    return m_mustache_isSet;
}

bool OAIPersonDetail_Face::is_mustache_Valid() const{
    return m_mustache_isValid;
}

OAIFaceDetail_EyesOpen OAIPersonDetail_Face::getEyesOpen() const {
    return m_eyes_open;
}
void OAIPersonDetail_Face::setEyesOpen(const OAIFaceDetail_EyesOpen &eyes_open) {
    m_eyes_open = eyes_open;
    m_eyes_open_isSet = true;
}

bool OAIPersonDetail_Face::is_eyes_open_Set() const{
    return m_eyes_open_isSet;
}

bool OAIPersonDetail_Face::is_eyes_open_Valid() const{
    return m_eyes_open_isValid;
}

OAIFaceDetail_MouthOpen OAIPersonDetail_Face::getMouthOpen() const {
    return m_mouth_open;
}
void OAIPersonDetail_Face::setMouthOpen(const OAIFaceDetail_MouthOpen &mouth_open) {
    m_mouth_open = mouth_open;
    m_mouth_open_isSet = true;
}

bool OAIPersonDetail_Face::is_mouth_open_Set() const{
    return m_mouth_open_isSet;
}

bool OAIPersonDetail_Face::is_mouth_open_Valid() const{
    return m_mouth_open_isValid;
}

QList OAIPersonDetail_Face::getEmotions() const {
    return m_emotions;
}
void OAIPersonDetail_Face::setEmotions(const QList &emotions) {
    m_emotions = emotions;
    m_emotions_isSet = true;
}

bool OAIPersonDetail_Face::is_emotions_Set() const{
    return m_emotions_isSet;
}

bool OAIPersonDetail_Face::is_emotions_Valid() const{
    return m_emotions_isValid;
}

QList OAIPersonDetail_Face::getLandmarks() const {
    return m_landmarks;
}
void OAIPersonDetail_Face::setLandmarks(const QList &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAIPersonDetail_Face::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAIPersonDetail_Face::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

OAIFaceDetail_Pose OAIPersonDetail_Face::getPose() const {
    return m_pose;
}
void OAIPersonDetail_Face::setPose(const OAIFaceDetail_Pose &pose) {
    m_pose = pose;
    m_pose_isSet = true;
}

bool OAIPersonDetail_Face::is_pose_Set() const{
    return m_pose_isSet;
}

bool OAIPersonDetail_Face::is_pose_Valid() const{
    return m_pose_isValid;
}

OAIFaceDetail_Quality OAIPersonDetail_Face::getQuality() const {
    return m_quality;
}
void OAIPersonDetail_Face::setQuality(const OAIFaceDetail_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIPersonDetail_Face::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIPersonDetail_Face::is_quality_Valid() const{
    return m_quality_isValid;
}

float OAIPersonDetail_Face::getConfidence() const {
    return m_confidence;
}
void OAIPersonDetail_Face::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIPersonDetail_Face::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIPersonDetail_Face::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAIFaceDetail_FaceOccluded OAIPersonDetail_Face::getFaceOccluded() const {
    return m_face_occluded;
}
void OAIPersonDetail_Face::setFaceOccluded(const OAIFaceDetail_FaceOccluded &face_occluded) {
    m_face_occluded = face_occluded;
    m_face_occluded_isSet = true;
}

bool OAIPersonDetail_Face::is_face_occluded_Set() const{
    return m_face_occluded_isSet;
}

bool OAIPersonDetail_Face::is_face_occluded_Valid() const{
    return m_face_occluded_isValid;
}

OAIFaceDetail_EyeDirection OAIPersonDetail_Face::getEyeDirection() const {
    return m_eye_direction;
}
void OAIPersonDetail_Face::setEyeDirection(const OAIFaceDetail_EyeDirection &eye_direction) {
    m_eye_direction = eye_direction;
    m_eye_direction_isSet = true;
}

bool OAIPersonDetail_Face::is_eye_direction_Set() const{
    return m_eye_direction_isSet;
}

bool OAIPersonDetail_Face::is_eye_direction_Valid() const{
    return m_eye_direction_isValid;
}

bool OAIPersonDetail_Face::isSet() const {
...
bool OAIPersonDetail_Face::isValid() const {
