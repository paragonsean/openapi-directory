...
/*
 * OAIStartPersonTrackingRequest_Video.h
 *
 * 
 */

#ifndef OAIStartPersonTrackingRequest_Video_H
#define OAIStartPersonTrackingRequest_Video_H

#include <QJsonObject>

#include "OAIVideo_S3Object.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIVideo_S3Object;

class OAIStartPersonTrackingRequest_Video : public OAIObject {
public:
    OAIStartPersonTrackingRequest_Video();
    OAIStartPersonTrackingRequest_Video(QString json);
    ~OAIStartPersonTrackingRequest_Video() override;
    ...
    OAIVideo_S3Object getS3Object() const;
    void setS3Object(const OAIVideo_S3Object &s3_object);
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPersonTrackingRequest_Video)

#endif // OAIStartPersonTrackingRequest_Video_H
