...
/*
 * OAIProtectiveEquipmentType.h
 *
 * 
 */

#ifndef OAIProtectiveEquipmentType_H
#define OAIProtectiveEquipmentType_H
...
class OAIProtectiveEquipmentType : public OAIEnum {
public:
    OAIProtectiveEquipmentType();
    OAIProtectiveEquipmentType(QString json);
    ~OAIProtectiveEquipmentType() override;
    ...
    enum class eOAIProtectiveEquipmentType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        FACE_COVER, 
        HAND_COVER, 
        HEAD_COVER
    };
    OAIProtectiveEquipmentType::eOAIProtectiveEquipmentType getValue() const;
    void setValue(const OAIProtectiveEquipmentType::eOAIProtectiveEquipmentType& value);
...
private:
    ...
    eOAIProtectiveEquipmentType m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProtectiveEquipmentType)

#endif // OAIProtectiveEquipmentType_H
