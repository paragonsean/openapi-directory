...
void OAISegmentType::fromJson(QString jsonString) {
    ...
    if ( jsonString.compare("TECHNICAL_CUE", Qt::CaseInsensitive) == 0) {
        m_value = eOAISegmentType::TECHNICAL_CUE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SHOT", Qt::CaseInsensitive) == 0) {
        m_value = eOAISegmentType::SHOT;
        m_value_isSet = m_value_isValid = true;
    }
}
...
QString OAISegmentType::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAISegmentType::TECHNICAL_CUE:
            val = "TECHNICAL_CUE";
            break;
        case eOAISegmentType::SHOT:
            val = "SHOT";
            break;
        default:
            break;
