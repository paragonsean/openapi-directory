...
/*
 * OAIListDatasetLabelsResponse.h
 *
 * 
 */

#ifndef OAIListDatasetLabelsResponse_H
#define OAIListDatasetLabelsResponse_H
...
class OAIListDatasetLabelsResponse : public OAIObject {
public:
    OAIListDatasetLabelsResponse();
    OAIListDatasetLabelsResponse(QString json);
    ~OAIListDatasetLabelsResponse() override;
    ...
    QList getDatasetLabelDescriptions() const;
    void setDatasetLabelDescriptions(const QList &dataset_label_descriptions);
    bool is_dataset_label_descriptions_Set() const;
    bool is_dataset_label_descriptions_Valid() const;
...
private:
    ...
    QList m_dataset_label_descriptions;
    bool m_dataset_label_descriptions_isSet;
    bool m_dataset_label_descriptions_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatasetLabelsResponse)

#endif // OAIListDatasetLabelsResponse_H
