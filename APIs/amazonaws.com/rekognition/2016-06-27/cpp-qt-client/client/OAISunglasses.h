...
#ifndef OAISunglasses_H
#define OAISunglasses_H
...
class OAISunglasses : public OAIObject {
public:
    OAISunglasses();
    OAISunglasses(QString json);
    ~OAISunglasses() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISunglasses)

#endif // OAISunglasses_H
