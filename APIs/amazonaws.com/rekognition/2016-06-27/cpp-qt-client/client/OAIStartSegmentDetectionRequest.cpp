...
#include "OAIStartSegmentDetectionRequest.h"
...
OAIStartSegmentDetectionRequest::OAIStartSegmentDetectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSegmentDetectionRequest::OAIStartSegmentDetectionRequest() {
    this->initializeModel();
}

OAIStartSegmentDetectionRequest::~OAIStartSegmentDetectionRequest() {}

void OAIStartSegmentDetectionRequest::initializeModel() {
    ...
    m_segment_types_isSet = false;
    m_segment_types_isValid = false;
}

void OAIStartSegmentDetectionRequest::fromJson(QString jsonString) {
...
void OAIStartSegmentDetectionRequest::fromJsonObject(QJsonObject json) {
    ...
    m_segment_types_isValid = ::OpenAPI::fromJsonValue(m_segment_types, json[QString("SegmentTypes")]);
    m_segment_types_isSet = !json[QString("SegmentTypes")].isNull() && m_segment_types_isValid;
}

QString OAIStartSegmentDetectionRequest::asJson() const {
...
QJsonObject OAIStartSegmentDetectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_video.isSet()) {
    ...
    if (m_segment_types.isSet()) {
        obj.insert(QString("SegmentTypes"), ::OpenAPI::toJsonValue(m_segment_types));
    }
    return obj;
}

OAIVideo OAIStartSegmentDetectionRequest::getVideo() const {
    return m_video;
}
void OAIStartSegmentDetectionRequest::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStartSegmentDetectionRequest::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStartSegmentDetectionRequest::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIStartSegmentDetectionRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIStartSegmentDetectionRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIStartSegmentDetectionRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIStartSegmentDetectionRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAIStartSegmentDetectionRequest_NotificationChannel OAIStartSegmentDetectionRequest::getNotificationChannel() const {
    return m_notification_channel;
}
void OAIStartSegmentDetectionRequest::setNotificationChannel(const OAIStartSegmentDetectionRequest_NotificationChannel &notification_channel) {
    m_notification_channel = notification_channel;
    m_notification_channel_isSet = true;
}

bool OAIStartSegmentDetectionRequest::is_notification_channel_Set() const{
    return m_notification_channel_isSet;
}

bool OAIStartSegmentDetectionRequest::is_notification_channel_Valid() const{
    return m_notification_channel_isValid;
}

QString OAIStartSegmentDetectionRequest::getJobTag() const {
    return m_job_tag;
}
void OAIStartSegmentDetectionRequest::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIStartSegmentDetectionRequest::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIStartSegmentDetectionRequest::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

OAIStartSegmentDetectionRequest_Filters OAIStartSegmentDetectionRequest::getFilters() const {
    return m_filters;
}
void OAIStartSegmentDetectionRequest::setFilters(const OAIStartSegmentDetectionRequest_Filters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIStartSegmentDetectionRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIStartSegmentDetectionRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

QList OAIStartSegmentDetectionRequest::getSegmentTypes() const {
    return m_segment_types;
}
void OAIStartSegmentDetectionRequest::setSegmentTypes(const QList &segment_types) {
    m_segment_types = segment_types;
    m_segment_types_isSet = true;
}

bool OAIStartSegmentDetectionRequest::is_segment_types_Set() const{
    return m_segment_types_isSet;
}

bool OAIStartSegmentDetectionRequest::is_segment_types_Valid() const{
    return m_segment_types_isValid;
}

bool OAIStartSegmentDetectionRequest::isSet() const {
...
bool OAIStartSegmentDetectionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_video_isValid && m_segment_types_isValid && true;
}
