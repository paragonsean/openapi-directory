...
OAISearchUsersByImageResponse_SearchedFace::OAISearchUsersByImageResponse_SearchedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchUsersByImageResponse_SearchedFace::OAISearchUsersByImageResponse_SearchedFace() {
    this->initializeModel();
}

OAISearchUsersByImageResponse_SearchedFace::~OAISearchUsersByImageResponse_SearchedFace() {}

void OAISearchUsersByImageResponse_SearchedFace::initializeModel() {

    m_face_detail_isSet = false;
    m_face_detail_isValid = false;
}

void OAISearchUsersByImageResponse_SearchedFace::fromJson(QString jsonString) {
...
void OAISearchUsersByImageResponse_SearchedFace::fromJsonObject(QJsonObject json) {
...
QString OAISearchUsersByImageResponse_SearchedFace::asJson() const {
...
QJsonObject OAISearchUsersByImageResponse_SearchedFace::asJsonObject() const {
    QJsonObject obj;
...
OAIFaceDetail OAISearchUsersByImageResponse_SearchedFace::getFaceDetail() const {
    return m_face_detail;
}
void OAISearchUsersByImageResponse_SearchedFace::setFaceDetail(const OAIFaceDetail &face_detail) {
    m_face_detail = face_detail;
    m_face_detail_isSet = true;
}

bool OAISearchUsersByImageResponse_SearchedFace::is_face_detail_Set() const{
    return m_face_detail_isSet;
}

bool OAISearchUsersByImageResponse_SearchedFace::is_face_detail_Valid() const{
    return m_face_detail_isValid;
}

bool OAISearchUsersByImageResponse_SearchedFace::isSet() const {
...
bool OAISearchUsersByImageResponse_SearchedFace::isValid() const {
