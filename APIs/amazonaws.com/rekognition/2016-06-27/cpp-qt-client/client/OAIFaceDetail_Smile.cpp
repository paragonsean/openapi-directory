...
OAIFaceDetail_Smile::OAIFaceDetail_Smile(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_Smile::OAIFaceDetail_Smile() {
    this->initializeModel();
}

OAIFaceDetail_Smile::~OAIFaceDetail_Smile() {}

void OAIFaceDetail_Smile::initializeModel() {
...
void OAIFaceDetail_Smile::fromJson(QString jsonString) {
...
void OAIFaceDetail_Smile::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_Smile::asJson() const {
...
QJsonObject OAIFaceDetail_Smile::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIFaceDetail_Smile::getValue() const {
    return m_value;
}
void OAIFaceDetail_Smile::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFaceDetail_Smile::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFaceDetail_Smile::is_value_Valid() const{
    return m_value_isValid;
}

float OAIFaceDetail_Smile::getConfidence() const {
    return m_confidence;
}
void OAIFaceDetail_Smile::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceDetail_Smile::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceDetail_Smile::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIFaceDetail_Smile::isSet() const {
...
bool OAIFaceDetail_Smile::isValid() const {
