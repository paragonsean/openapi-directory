...
/*
 * OAIFaceDetail_Gender.h
 *
 * 
 */

#ifndef OAIFaceDetail_Gender_H
#define OAIFaceDetail_Gender_H

#include <QJsonObject>

#include "OAIGenderType.h"
...
class OAIFaceDetail_Gender : public OAIObject {
public:
    OAIFaceDetail_Gender();
    OAIFaceDetail_Gender(QString json);
    ~OAIFaceDetail_Gender() override;
    ...
    OAIGenderType getValue() const;
    void setValue(const OAIGenderType &value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Gender)

#endif // OAIFaceDetail_Gender_H
