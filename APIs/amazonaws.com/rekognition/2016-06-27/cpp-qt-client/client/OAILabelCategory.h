...
#ifndef OAILabelCategory_H
#define OAILabelCategory_H
...
class OAILabelCategory : public OAIObject {
public:
    OAILabelCategory();
    OAILabelCategory(QString json);
    ~OAILabelCategory() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelCategory)

#endif // OAILabelCategory_H
