...
#ifndef OAIAgeRange_H
#define OAIAgeRange_H
...
class OAIAgeRange : public OAIObject {
public:
    OAIAgeRange();
    OAIAgeRange(QString json);
    ~OAIAgeRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAgeRange)
