...
/*
 * OAIDeleteProjectPolicyRequest.h
 *
 * 
 */

#ifndef OAIDeleteProjectPolicyRequest_H
#define OAIDeleteProjectPolicyRequest_H
...
class OAIDeleteProjectPolicyRequest : public OAIObject {
public:
    OAIDeleteProjectPolicyRequest();
    OAIDeleteProjectPolicyRequest(QString json);
    ~OAIDeleteProjectPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProjectPolicyRequest)

#endif // OAIDeleteProjectPolicyRequest_H
