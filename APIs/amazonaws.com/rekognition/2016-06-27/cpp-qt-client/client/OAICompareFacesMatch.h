...
#ifndef OAICompareFacesMatch_H
#define OAICompareFacesMatch_H

#include <QJsonObject>

#include "OAICompareFacesMatch_Face.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICompareFacesMatch_Face;

class OAICompareFacesMatch : public OAIObject {
public:
    OAICompareFacesMatch();
    OAICompareFacesMatch(QString json);
    ~OAICompareFacesMatch() override;
    ...
    OAICompareFacesMatch_Face getFace() const;
    void setFace(const OAICompareFacesMatch_Face &face);
...
private:
    ...
    OAICompareFacesMatch_Face m_face;
    bool m_face_isSet;
    bool m_face_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesMatch)

#endif // OAICompareFacesMatch_H
