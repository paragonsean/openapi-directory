...
OAIStartTextDetectionFilters_WordFilter::OAIStartTextDetectionFilters_WordFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTextDetectionFilters_WordFilter::OAIStartTextDetectionFilters_WordFilter() {
    this->initializeModel();
}

OAIStartTextDetectionFilters_WordFilter::~OAIStartTextDetectionFilters_WordFilter() {}

void OAIStartTextDetectionFilters_WordFilter::initializeModel() {

    m_min_confidence_isSet = false;
    m_min_confidence_isValid = false;

    m_min_bounding_box_height_isSet = false;
    m_min_bounding_box_height_isValid = false;

    m_min_bounding_box_width_isSet = false;
    m_min_bounding_box_width_isValid = false;
}

void OAIStartTextDetectionFilters_WordFilter::fromJson(QString jsonString) {
...
void OAIStartTextDetectionFilters_WordFilter::fromJsonObject(QJsonObject json) {
    ...
    m_min_bounding_box_height_isValid = ::OpenAPI::fromJsonValue(m_min_bounding_box_height, json[QString("MinBoundingBoxHeight")]);
    m_min_bounding_box_height_isSet = !json[QString("MinBoundingBoxHeight")].isNull() && m_min_bounding_box_height_isValid;

    m_min_bounding_box_width_isValid = ::OpenAPI::fromJsonValue(m_min_bounding_box_width, json[QString("MinBoundingBoxWidth")]);
    m_min_bounding_box_width_isSet = !json[QString("MinBoundingBoxWidth")].isNull() && m_min_bounding_box_width_isValid;
}

QString OAIStartTextDetectionFilters_WordFilter::asJson() const {
...
QJsonObject OAIStartTextDetectionFilters_WordFilter::asJsonObject() const {
    QJsonObject obj;
    if (m_min_confidence_isSet) {
        obj.insert(QString("MinConfidence"), ::OpenAPI::toJsonValue(m_min_confidence));
    }
    if (m_min_bounding_box_height_isSet) {
        obj.insert(QString("MinBoundingBoxHeight"), ::OpenAPI::toJsonValue(m_min_bounding_box_height));
    }
    if (m_min_bounding_box_width_isSet) {
        obj.insert(QString("MinBoundingBoxWidth"), ::OpenAPI::toJsonValue(m_min_bounding_box_width));
    }
    return obj;
}

float OAIStartTextDetectionFilters_WordFilter::getMinConfidence() const {
    return m_min_confidence;
}
void OAIStartTextDetectionFilters_WordFilter::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIStartTextDetectionFilters_WordFilter::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIStartTextDetectionFilters_WordFilter::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

float OAIStartTextDetectionFilters_WordFilter::getMinBoundingBoxHeight() const {
    return m_min_bounding_box_height;
}
void OAIStartTextDetectionFilters_WordFilter::setMinBoundingBoxHeight(const float &min_bounding_box_height) {
    m_min_bounding_box_height = min_bounding_box_height;
    m_min_bounding_box_height_isSet = true;
}

bool OAIStartTextDetectionFilters_WordFilter::is_min_bounding_box_height_Set() const{
    return m_min_bounding_box_height_isSet;
}

bool OAIStartTextDetectionFilters_WordFilter::is_min_bounding_box_height_Valid() const{
    return m_min_bounding_box_height_isValid;
}

float OAIStartTextDetectionFilters_WordFilter::getMinBoundingBoxWidth() const {
    return m_min_bounding_box_width;
}
void OAIStartTextDetectionFilters_WordFilter::setMinBoundingBoxWidth(const float &min_bounding_box_width) {
    m_min_bounding_box_width = min_bounding_box_width;
    m_min_bounding_box_width_isSet = true;
}

bool OAIStartTextDetectionFilters_WordFilter::is_min_bounding_box_width_Set() const{
    return m_min_bounding_box_width_isSet;
}

bool OAIStartTextDetectionFilters_WordFilter::is_min_bounding_box_width_Valid() const{
    return m_min_bounding_box_width_isValid;
}

bool OAIStartTextDetectionFilters_WordFilter::isSet() const {
...
bool OAIStartTextDetectionFilters_WordFilter::isValid() const {
