...
#ifndef OAIUnindexedFace_H
#define OAIUnindexedFace_H

#include <QJsonObject>

#include "OAIUnindexedFace_FaceDetail.h"
#include <QList>
...
namespace OpenAPI {
class OAIUnindexedFace_FaceDetail;

class OAIUnindexedFace : public OAIObject {
public:
    OAIUnindexedFace();
    OAIUnindexedFace(QString json);
    ~OAIUnindexedFace() override;
    ...
    OAIUnindexedFace_FaceDetail getFaceDetail() const;
    void setFaceDetail(const OAIUnindexedFace_FaceDetail &face_detail);
...
private:
    ...
    OAIUnindexedFace_FaceDetail m_face_detail;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnindexedFace)

#endif // OAIUnindexedFace_H
