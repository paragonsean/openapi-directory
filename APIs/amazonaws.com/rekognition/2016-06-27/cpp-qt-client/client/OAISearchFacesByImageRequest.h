...
/*
 * OAISearchFacesByImageRequest.h
 *
 * 
 */

#ifndef OAISearchFacesByImageRequest_H
#define OAISearchFacesByImageRequest_H
...
class OAISearchFacesByImageRequest : public OAIObject {
public:
    OAISearchFacesByImageRequest();
    OAISearchFacesByImageRequest(QString json);
    ~OAISearchFacesByImageRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchFacesByImageRequest)

#endif // OAISearchFacesByImageRequest_H
