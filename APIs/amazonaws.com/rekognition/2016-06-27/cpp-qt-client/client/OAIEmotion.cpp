...
OAIEmotionName OAIEmotion::getType() const {
    return m_type;
}
void OAIEmotion::setType(const OAIEmotionName &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEmotion::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEmotion::is_type_Valid() const{
    return m_type_isValid;
}

float OAIEmotion::getConfidence() const {
    return m_confidence;
}
void OAIEmotion::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIEmotion::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIEmotion::is_confidence_Valid() const{
