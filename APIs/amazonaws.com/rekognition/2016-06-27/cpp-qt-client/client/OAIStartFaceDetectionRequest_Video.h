...
/*
 * OAIStartFaceDetectionRequest_Video.h
 *
 * 
 */

#ifndef OAIStartFaceDetectionRequest_Video_H
#define OAIStartFaceDetectionRequest_Video_H
...
class OAIStartFaceDetectionRequest_Video : public OAIObject {
public:
    OAIStartFaceDetectionRequest_Video();
    OAIStartFaceDetectionRequest_Video(QString json);
    ~OAIStartFaceDetectionRequest_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceDetectionRequest_Video)

#endif // OAIStartFaceDetectionRequest_Video_H
