...
/*
 * OAICreateProjectVersionResponse.h
 *
 * 
 */

#ifndef OAICreateProjectVersionResponse_H
#define OAICreateProjectVersionResponse_H
...
class OAICreateProjectVersionResponse : public OAIObject {
public:
    OAICreateProjectVersionResponse();
    OAICreateProjectVersionResponse(QString json);
    ~OAICreateProjectVersionResponse() override;
    ...
    QString getProjectVersionArn() const;
    void setProjectVersionArn(const QString &project_version_arn);
    bool is_project_version_arn_Set() const;
    bool is_project_version_arn_Valid() const;
...
private:
    ...
    QString m_project_version_arn;
    bool m_project_version_arn_isSet;
    bool m_project_version_arn_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectVersionResponse)

#endif // OAICreateProjectVersionResponse_H
