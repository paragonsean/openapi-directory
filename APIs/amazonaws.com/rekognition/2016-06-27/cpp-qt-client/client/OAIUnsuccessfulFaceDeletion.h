...
/*
 * OAIUnsuccessfulFaceDeletion.h
 *
 * Contains metadata like FaceId, UserID, and Reasons, for a face that was unsuccessfully deleted.
 */

#ifndef OAIUnsuccessfulFaceDeletion_H
#define OAIUnsuccessfulFaceDeletion_H
...
class OAIUnsuccessfulFaceDeletion : public OAIObject {
public:
    OAIUnsuccessfulFaceDeletion();
    OAIUnsuccessfulFaceDeletion(QString json);
    ~OAIUnsuccessfulFaceDeletion() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsuccessfulFaceDeletion)

#endif // OAIUnsuccessfulFaceDeletion_H
