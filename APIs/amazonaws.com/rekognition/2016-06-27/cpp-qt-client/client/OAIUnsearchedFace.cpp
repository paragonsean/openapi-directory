...
OAIUnsearchedFace::OAIUnsearchedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsearchedFace::OAIUnsearchedFace() {
    this->initializeModel();
}

OAIUnsearchedFace::~OAIUnsearchedFace() {}

void OAIUnsearchedFace::initializeModel() {
...
void OAIUnsearchedFace::fromJson(QString jsonString) {
...
void OAIUnsearchedFace::fromJsonObject(QJsonObject json) {
...
QString OAIUnsearchedFace::asJson() const {
...
QJsonObject OAIUnsearchedFace::asJsonObject() const {
    QJsonObject obj;
...
OAIFaceDetail OAIUnsearchedFace::getFaceDetails() const {
    return m_face_details;
}
void OAIUnsearchedFace::setFaceDetails(const OAIFaceDetail &face_details) {
    m_face_details = face_details;
    m_face_details_isSet = true;
}

bool OAIUnsearchedFace::is_face_details_Set() const{
    return m_face_details_isSet;
}

bool OAIUnsearchedFace::is_face_details_Valid() const{
    return m_face_details_isValid;
}

QList OAIUnsearchedFace::getReasons() const {
    return m_reasons;
}
void OAIUnsearchedFace::setReasons(const QList &reasons) {
    m_reasons = reasons;
    m_reasons_isSet = true;
}

bool OAIUnsearchedFace::is_reasons_Set() const{
    return m_reasons_isSet;
}

bool OAIUnsearchedFace::is_reasons_Valid() const{
    return m_reasons_isValid;
}

bool OAIUnsearchedFace::isSet() const {
...
bool OAIUnsearchedFace::isValid() const {
