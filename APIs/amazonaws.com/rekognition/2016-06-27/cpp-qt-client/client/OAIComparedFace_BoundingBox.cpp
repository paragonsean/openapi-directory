...
OAIComparedFace_BoundingBox::OAIComparedFace_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComparedFace_BoundingBox::OAIComparedFace_BoundingBox() {
    this->initializeModel();
}

OAIComparedFace_BoundingBox::~OAIComparedFace_BoundingBox() {}

void OAIComparedFace_BoundingBox::initializeModel() {
...
void OAIComparedFace_BoundingBox::fromJson(QString jsonString) {
...
void OAIComparedFace_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAIComparedFace_BoundingBox::asJson() const {
...
QJsonObject OAIComparedFace_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAIComparedFace_BoundingBox::getWidth() const {
    return m_width;
}
void OAIComparedFace_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIComparedFace_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAIComparedFace_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAIComparedFace_BoundingBox::getHeight() const {
    return m_height;
}
void OAIComparedFace_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIComparedFace_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAIComparedFace_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAIComparedFace_BoundingBox::getLeft() const {
    return m_left;
}
void OAIComparedFace_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIComparedFace_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAIComparedFace_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAIComparedFace_BoundingBox::getTop() const {
    return m_top;
}
void OAIComparedFace_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIComparedFace_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAIComparedFace_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAIComparedFace_BoundingBox::isSet() const {
...
bool OAIComparedFace_BoundingBox::isValid() const {
