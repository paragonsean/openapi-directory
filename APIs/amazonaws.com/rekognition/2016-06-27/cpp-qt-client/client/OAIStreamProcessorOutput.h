...
/*
 * OAIStreamProcessorOutput.h
 *
 * Information about the Amazon Kinesis Data Streams stream to which a Amazon Rekognition Video stream processor streams the results of a video analysis. For more information, see CreateStreamProcessor in the Amazon Rekognition Developer Guide.
 */

#ifndef OAIStreamProcessorOutput_H
#define OAIStreamProcessorOutput_H
...
class OAIStreamProcessorOutput : public OAIObject {
public:
    OAIStreamProcessorOutput();
    OAIStreamProcessorOutput(QString json);
    ~OAIStreamProcessorOutput() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorOutput)

#endif // OAIStreamProcessorOutput_H
