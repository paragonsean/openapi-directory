...
/*
 * OAIDetectModerationLabelsResponse.h
 *
 * 
 */

#ifndef OAIDetectModerationLabelsResponse_H
#define OAIDetectModerationLabelsResponse_H

#include <QJsonObject>

#include "OAIDetectModerationLabelsResponse_HumanLoopActivationOutput.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIDetectModerationLabelsResponse_HumanLoopActivationOutput;

class OAIDetectModerationLabelsResponse : public OAIObject {
public:
    OAIDetectModerationLabelsResponse();
    OAIDetectModerationLabelsResponse(QString json);
    ~OAIDetectModerationLabelsResponse() override;
    ...
    QList getModerationLabels() const;
    void setModerationLabels(const QList &moderation_labels);
    bool is_moderation_labels_Set() const;
    bool is_moderation_labels_Valid() const;

    QString getModerationModelVersion() const;
    void setModerationModelVersion(const QString &moderation_model_version);
    bool is_moderation_model_version_Set() const;
    bool is_moderation_model_version_Valid() const;

    OAIDetectModerationLabelsResponse_HumanLoopActivationOutput getHumanLoopActivationOutput() const;
    void setHumanLoopActivationOutput(const OAIDetectModerationLabelsResponse_HumanLoopActivationOutput &human_loop_activation_output);
...
private:
    ...
    QList m_moderation_labels;
    bool m_moderation_labels_isSet;
    bool m_moderation_labels_isValid;

    QString m_moderation_model_version;
    bool m_moderation_model_version_isSet;
    bool m_moderation_model_version_isValid;

    OAIDetectModerationLabelsResponse_HumanLoopActivationOutput m_human_loop_activation_output;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectModerationLabelsResponse)

#endif // OAIDetectModerationLabelsResponse_H
