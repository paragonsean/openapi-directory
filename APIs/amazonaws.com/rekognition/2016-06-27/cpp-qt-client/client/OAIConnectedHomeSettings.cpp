...
OAIConnectedHomeSettings::OAIConnectedHomeSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConnectedHomeSettings::OAIConnectedHomeSettings() {
    this->initializeModel();
}

OAIConnectedHomeSettings::~OAIConnectedHomeSettings() {}

void OAIConnectedHomeSettings::initializeModel() {
...
void OAIConnectedHomeSettings::fromJson(QString jsonString) {
...
void OAIConnectedHomeSettings::fromJsonObject(QJsonObject json) {
...
QString OAIConnectedHomeSettings::asJson() const {
...
QJsonObject OAIConnectedHomeSettings::asJsonObject() const {
    QJsonObject obj;
    if (m_labels.isSet()) {
...
QList OAIConnectedHomeSettings::getLabels() const {
    return m_labels;
}
void OAIConnectedHomeSettings::setLabels(const QList &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIConnectedHomeSettings::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIConnectedHomeSettings::is_labels_Valid() const{
    return m_labels_isValid;
}

float OAIConnectedHomeSettings::getMinConfidence() const {
    return m_min_confidence;
}
void OAIConnectedHomeSettings::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIConnectedHomeSettings::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIConnectedHomeSettings::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

bool OAIConnectedHomeSettings::isSet() const {
...
bool OAIConnectedHomeSettings::isValid() const {
