...
/*
 * OAITestingDataResult_Output.h
 *
 * 
 */

#ifndef OAITestingDataResult_Output_H
#define OAITestingDataResult_Output_H
...
class OAITestingDataResult_Output : public OAIObject {
public:
    OAITestingDataResult_Output();
    OAITestingDataResult_Output(QString json);
    ~OAITestingDataResult_Output() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITestingDataResult_Output)

#endif // OAITestingDataResult_Output_H
