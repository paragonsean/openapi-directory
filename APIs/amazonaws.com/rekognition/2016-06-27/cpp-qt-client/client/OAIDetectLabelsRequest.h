...
/*
 * OAIDetectLabelsRequest.h
 *
 * 
 */

#ifndef OAIDetectLabelsRequest_H
#define OAIDetectLabelsRequest_H
...
namespace OpenAPI {
class OAIDetectLabelsRequest_Image;
class OAIDetectLabelsRequest_Settings;

class OAIDetectLabelsRequest : public OAIObject {
public:
    OAIDetectLabelsRequest();
    OAIDetectLabelsRequest(QString json);
    ~OAIDetectLabelsRequest() override;
    ...
    OAIDetectLabelsRequest_Image getImage() const;
    void setImage(const OAIDetectLabelsRequest_Image &image);
    bool is_image_Set() const;
    bool is_image_Valid() const;

    qint32 getMaxLabels() const;
    void setMaxLabels(const qint32 &max_labels);
    bool is_max_labels_Set() const;
    bool is_max_labels_Valid() const;
    ...
    OAIDetectLabelsRequest_Settings getSettings() const;
    void setSettings(const OAIDetectLabelsRequest_Settings &settings);
...
private:
    ...
    OAIDetectLabelsRequest_Image m_image;
    bool m_image_isSet;
    bool m_image_isValid;

    qint32 m_max_labels;
    bool m_max_labels_isSet;
    bool m_max_labels_isValid;
    ...
    OAIDetectLabelsRequest_Settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsRequest)

#endif // OAIDetectLabelsRequest_H
