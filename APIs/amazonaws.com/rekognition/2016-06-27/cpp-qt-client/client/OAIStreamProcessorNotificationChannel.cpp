...
#include "OAIStreamProcessorNotificationChannel.h"
...
OAIStreamProcessorNotificationChannel::OAIStreamProcessorNotificationChannel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorNotificationChannel::OAIStreamProcessorNotificationChannel() {
    this->initializeModel();
}

OAIStreamProcessorNotificationChannel::~OAIStreamProcessorNotificationChannel() {}

void OAIStreamProcessorNotificationChannel::initializeModel() {

    m_sns_topic_arn_isSet = false;
    m_sns_topic_arn_isValid = false;
}

void OAIStreamProcessorNotificationChannel::fromJson(QString jsonString) {
...
void OAIStreamProcessorNotificationChannel::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessorNotificationChannel::asJson() const {
...
QJsonObject OAIStreamProcessorNotificationChannel::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStreamProcessorNotificationChannel::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIStreamProcessorNotificationChannel::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIStreamProcessorNotificationChannel::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIStreamProcessorNotificationChannel::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

bool OAIStreamProcessorNotificationChannel::isSet() const {
...
bool OAIStreamProcessorNotificationChannel::isValid() const {
