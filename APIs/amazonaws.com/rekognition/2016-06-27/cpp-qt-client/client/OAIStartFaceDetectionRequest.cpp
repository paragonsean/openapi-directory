...
#include "OAIStartFaceDetectionRequest.h"
...
OAIStartFaceDetectionRequest::OAIStartFaceDetectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceDetectionRequest::OAIStartFaceDetectionRequest() {
    this->initializeModel();
}

OAIStartFaceDetectionRequest::~OAIStartFaceDetectionRequest() {}

void OAIStartFaceDetectionRequest::initializeModel() {
...
void OAIStartFaceDetectionRequest::fromJson(QString jsonString) {
...
void OAIStartFaceDetectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartFaceDetectionRequest::asJson() const {
...
QJsonObject OAIStartFaceDetectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_video.isSet()) {
...
OAIStartFaceDetectionRequest_Video OAIStartFaceDetectionRequest::getVideo() const {
    return m_video;
}
void OAIStartFaceDetectionRequest::setVideo(const OAIStartFaceDetectionRequest_Video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStartFaceDetectionRequest::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStartFaceDetectionRequest::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIStartFaceDetectionRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIStartFaceDetectionRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIStartFaceDetectionRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIStartFaceDetectionRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAIStartFaceDetectionRequest_NotificationChannel OAIStartFaceDetectionRequest::getNotificationChannel() const {
    return m_notification_channel;
}
void OAIStartFaceDetectionRequest::setNotificationChannel(const OAIStartFaceDetectionRequest_NotificationChannel &notification_channel) {
    m_notification_channel = notification_channel;
    m_notification_channel_isSet = true;
}

bool OAIStartFaceDetectionRequest::is_notification_channel_Set() const{
    return m_notification_channel_isSet;
}

bool OAIStartFaceDetectionRequest::is_notification_channel_Valid() const{
    return m_notification_channel_isValid;
}

OAIFaceAttributes OAIStartFaceDetectionRequest::getFaceAttributes() const {
    return m_face_attributes;
}
void OAIStartFaceDetectionRequest::setFaceAttributes(const OAIFaceAttributes &face_attributes) {
    m_face_attributes = face_attributes;
    m_face_attributes_isSet = true;
}

bool OAIStartFaceDetectionRequest::is_face_attributes_Set() const{
    return m_face_attributes_isSet;
}

bool OAIStartFaceDetectionRequest::is_face_attributes_Valid() const{
    return m_face_attributes_isValid;
}

QString OAIStartFaceDetectionRequest::getJobTag() const {
    return m_job_tag;
}
void OAIStartFaceDetectionRequest::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIStartFaceDetectionRequest::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIStartFaceDetectionRequest::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIStartFaceDetectionRequest::isSet() const {
...
bool OAIStartFaceDetectionRequest::isValid() const {
