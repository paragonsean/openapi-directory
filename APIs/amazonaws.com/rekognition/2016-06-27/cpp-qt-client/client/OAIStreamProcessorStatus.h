...
/*
 * OAIStreamProcessorStatus.h
 *
 * 
 */

#ifndef OAIStreamProcessorStatus_H
#define OAIStreamProcessorStatus_H
...
class OAIStreamProcessorStatus : public OAIEnum {
public:
    OAIStreamProcessorStatus();
    OAIStreamProcessorStatus(QString json);
    ~OAIStreamProcessorStatus() override;
    ...
    enum class eOAIStreamProcessorStatus {
    ...
    OAIStreamProcessorStatus::eOAIStreamProcessorStatus getValue() const;
    void setValue(const OAIStreamProcessorStatus::eOAIStreamProcessorStatus& value);
...
private:
    ...
    eOAIStreamProcessorStatus m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorStatus)

#endif // OAIStreamProcessorStatus_H
