...
OAIEyeglasses::OAIEyeglasses(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEyeglasses::OAIEyeglasses() {
    this->initializeModel();
}

OAIEyeglasses::~OAIEyeglasses() {}

void OAIEyeglasses::initializeModel() {
...
void OAIEyeglasses::fromJson(QString jsonString) {
...
void OAIEyeglasses::fromJsonObject(QJsonObject json) {
...
QString OAIEyeglasses::asJson() const {
...
QJsonObject OAIEyeglasses::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIEyeglasses::getValue() const {
    return m_value;
}
void OAIEyeglasses::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIEyeglasses::is_value_Set() const{
    return m_value_isSet;
}

bool OAIEyeglasses::is_value_Valid() const{
    return m_value_isValid;
}

float OAIEyeglasses::getConfidence() const {
    return m_confidence;
}
void OAIEyeglasses::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIEyeglasses::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIEyeglasses::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIEyeglasses::isSet() const {
...
bool OAIEyeglasses::isValid() const {
