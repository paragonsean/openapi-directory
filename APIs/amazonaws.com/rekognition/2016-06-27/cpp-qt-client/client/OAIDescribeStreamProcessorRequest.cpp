...
#include "OAIDescribeStreamProcessorRequest.h"
...
OAIDescribeStreamProcessorRequest::OAIDescribeStreamProcessorRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeStreamProcessorRequest::OAIDescribeStreamProcessorRequest() {
    this->initializeModel();
}

OAIDescribeStreamProcessorRequest::~OAIDescribeStreamProcessorRequest() {}

void OAIDescribeStreamProcessorRequest::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAIDescribeStreamProcessorRequest::fromJson(QString jsonString) {
...
void OAIDescribeStreamProcessorRequest::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAIDescribeStreamProcessorRequest::asJson() const {
...
QJsonObject OAIDescribeStreamProcessorRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIDescribeStreamProcessorRequest::getName() const {
    return m_name;
}
void OAIDescribeStreamProcessorRequest::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIDescribeStreamProcessorRequest::is_name_Set() const{
    return m_name_isSet;
}

bool OAIDescribeStreamProcessorRequest::is_name_Valid() const{
    return m_name_isValid;
}

bool OAIDescribeStreamProcessorRequest::isSet() const {
...
bool OAIDescribeStreamProcessorRequest::isValid() const {
