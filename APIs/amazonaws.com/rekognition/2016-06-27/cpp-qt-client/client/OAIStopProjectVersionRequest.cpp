...
#include "OAIStopProjectVersionRequest.h"
...
OAIStopProjectVersionRequest::OAIStopProjectVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopProjectVersionRequest::OAIStopProjectVersionRequest() {
    this->initializeModel();
}

OAIStopProjectVersionRequest::~OAIStopProjectVersionRequest() {}

void OAIStopProjectVersionRequest::initializeModel() {

    m_project_version_arn_isSet = false;
    m_project_version_arn_isValid = false;
}

void OAIStopProjectVersionRequest::fromJson(QString jsonString) {
...
void OAIStopProjectVersionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopProjectVersionRequest::asJson() const {
...
QJsonObject OAIStopProjectVersionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStopProjectVersionRequest::getProjectVersionArn() const {
    return m_project_version_arn;
}
void OAIStopProjectVersionRequest::setProjectVersionArn(const QString &project_version_arn) {
    m_project_version_arn = project_version_arn;
    m_project_version_arn_isSet = true;
}

bool OAIStopProjectVersionRequest::is_project_version_arn_Set() const{
    return m_project_version_arn_isSet;
}

bool OAIStopProjectVersionRequest::is_project_version_arn_Valid() const{
    return m_project_version_arn_isValid;
}

bool OAIStopProjectVersionRequest::isSet() const {
...
bool OAIStopProjectVersionRequest::isValid() const {
