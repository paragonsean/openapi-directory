...
/*
 * OAIDescribeProjectsRequest.h
 *
 * 
 */

#ifndef OAIDescribeProjectsRequest_H
#define OAIDescribeProjectsRequest_H
...
class OAIDescribeProjectsRequest : public OAIObject {
public:
    OAIDescribeProjectsRequest();
    OAIDescribeProjectsRequest(QString json);
    ~OAIDescribeProjectsRequest() override;
    ...
    QList getProjectNames() const;
    void setProjectNames(const QList &project_names);
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectsRequest)

#endif // OAIDescribeProjectsRequest_H
