...
/*
 * OAICopyProjectVersionResponse.h
 *
 * 
 */

#ifndef OAICopyProjectVersionResponse_H
#define OAICopyProjectVersionResponse_H
...
class OAICopyProjectVersionResponse : public OAIObject {
public:
    OAICopyProjectVersionResponse();
    OAICopyProjectVersionResponse(QString json);
    ~OAICopyProjectVersionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyProjectVersionResponse)

#endif // OAICopyProjectVersionResponse_H
