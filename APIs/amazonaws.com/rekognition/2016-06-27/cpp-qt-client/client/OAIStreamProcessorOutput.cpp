...
#include "OAIStreamProcessorOutput.h"
...
OAIStreamProcessorOutput::OAIStreamProcessorOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorOutput::OAIStreamProcessorOutput() {
    this->initializeModel();
}

OAIStreamProcessorOutput::~OAIStreamProcessorOutput() {}

void OAIStreamProcessorOutput::initializeModel() {
...
void OAIStreamProcessorOutput::fromJson(QString jsonString) {
...
void OAIStreamProcessorOutput::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessorOutput::asJson() const {
...
QJsonObject OAIStreamProcessorOutput::asJsonObject() const {
    QJsonObject obj;
...
OAIStreamProcessorOutput_KinesisDataStream OAIStreamProcessorOutput::getKinesisDataStream() const {
    return m_kinesis_data_stream;
}
void OAIStreamProcessorOutput::setKinesisDataStream(const OAIStreamProcessorOutput_KinesisDataStream &kinesis_data_stream) {
    m_kinesis_data_stream = kinesis_data_stream;
    m_kinesis_data_stream_isSet = true;
}

bool OAIStreamProcessorOutput::is_kinesis_data_stream_Set() const{
    return m_kinesis_data_stream_isSet;
}

bool OAIStreamProcessorOutput::is_kinesis_data_stream_Valid() const{
    return m_kinesis_data_stream_isValid;
}

OAIStreamProcessorOutput_S3Destination OAIStreamProcessorOutput::getS3Destination() const {
    return m_s3_destination;
}
void OAIStreamProcessorOutput::setS3Destination(const OAIStreamProcessorOutput_S3Destination &s3_destination) {
    m_s3_destination = s3_destination;
    m_s3_destination_isSet = true;
}

bool OAIStreamProcessorOutput::is_s3_destination_Set() const{
    return m_s3_destination_isSet;
}

bool OAIStreamProcessorOutput::is_s3_destination_Valid() const{
    return m_s3_destination_isValid;
}

bool OAIStreamProcessorOutput::isSet() const {
...
bool OAIStreamProcessorOutput::isValid() const {
