...
#include "OAIProjectVersionDescription_EvaluationResult.h"
...
OAIProjectVersionDescription_EvaluationResult::OAIProjectVersionDescription_EvaluationResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectVersionDescription_EvaluationResult::OAIProjectVersionDescription_EvaluationResult() {
    this->initializeModel();
}

OAIProjectVersionDescription_EvaluationResult::~OAIProjectVersionDescription_EvaluationResult() {}

void OAIProjectVersionDescription_EvaluationResult::initializeModel() {
...
void OAIProjectVersionDescription_EvaluationResult::fromJson(QString jsonString) {
...
void OAIProjectVersionDescription_EvaluationResult::fromJsonObject(QJsonObject json) {
...
QString OAIProjectVersionDescription_EvaluationResult::asJson() const {
...
QJsonObject OAIProjectVersionDescription_EvaluationResult::asJsonObject() const {
    QJsonObject obj;
    if (m_f1_score_isSet) {
...
float OAIProjectVersionDescription_EvaluationResult::getF1Score() const {
    return m_f1_score;
}
void OAIProjectVersionDescription_EvaluationResult::setF1Score(const float &f1_score) {
    m_f1_score = f1_score;
    m_f1_score_isSet = true;
}

bool OAIProjectVersionDescription_EvaluationResult::is_f1_score_Set() const{
    return m_f1_score_isSet;
}

bool OAIProjectVersionDescription_EvaluationResult::is_f1_score_Valid() const{
    return m_f1_score_isValid;
}

OAIEvaluationResult_Summary OAIProjectVersionDescription_EvaluationResult::getSummary() const {
    return m_summary;
}
void OAIProjectVersionDescription_EvaluationResult::setSummary(const OAIEvaluationResult_Summary &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIProjectVersionDescription_EvaluationResult::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIProjectVersionDescription_EvaluationResult::is_summary_Valid() const{
    return m_summary_isValid;
}

bool OAIProjectVersionDescription_EvaluationResult::isSet() const {
...
bool OAIProjectVersionDescription_EvaluationResult::isValid() const {
