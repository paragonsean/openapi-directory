...
/*
 * OAIStartTechnicalCueDetectionFilter.h
 *
...
#ifndef OAIStartTechnicalCueDetectionFilter_H
#define OAIStartTechnicalCueDetectionFilter_H
...
class OAIStartTechnicalCueDetectionFilter : public OAIObject {
public:
    OAIStartTechnicalCueDetectionFilter();
    OAIStartTechnicalCueDetectionFilter(QString json);
    ~OAIStartTechnicalCueDetectionFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTechnicalCueDetectionFilter)

#endif // OAIStartTechnicalCueDetectionFilter_H
