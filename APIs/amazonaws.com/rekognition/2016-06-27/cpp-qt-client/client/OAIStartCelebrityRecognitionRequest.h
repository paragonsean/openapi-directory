...
/*
 * OAIStartCelebrityRecognitionRequest.h
 *
 * 
 */

#ifndef OAIStartCelebrityRecognitionRequest_H
#define OAIStartCelebrityRecognitionRequest_H

#include <QJsonObject>

#include "OAIStartCelebrityRecognitionRequest_NotificationChannel.h"
#include "OAIStartCelebrityRecognitionRequest_Video.h"
#include <QString>
...
namespace OpenAPI {
class OAIStartCelebrityRecognitionRequest_Video;
class OAIStartCelebrityRecognitionRequest_NotificationChannel;

class OAIStartCelebrityRecognitionRequest : public OAIObject {
public:
    OAIStartCelebrityRecognitionRequest();
    OAIStartCelebrityRecognitionRequest(QString json);
    ~OAIStartCelebrityRecognitionRequest() override;
    ...
    OAIStartCelebrityRecognitionRequest_Video getVideo() const;
    void setVideo(const OAIStartCelebrityRecognitionRequest_Video &video);
    ...
    OAIStartCelebrityRecognitionRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartCelebrityRecognitionRequest_NotificationChannel &notification_channel);
...
private:
    ...
    OAIStartCelebrityRecognitionRequest_Video m_video;
    bool m_video_isSet;
    ...
    OAIStartCelebrityRecognitionRequest_NotificationChannel m_notification_channel;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartCelebrityRecognitionRequest)

#endif // OAIStartCelebrityRecognitionRequest_H
