...
OAIGroundTruthManifest OAIDatasetSource::getGroundTruthManifest() const {
    return m_ground_truth_manifest;
}
void OAIDatasetSource::setGroundTruthManifest(const OAIGroundTruthManifest &ground_truth_manifest) {
...
QString OAIDatasetSource::getDatasetArn() const {
    return m_dataset_arn;
}
void OAIDatasetSource::setDatasetArn(const QString &dataset_arn) {
    m_dataset_arn = dataset_arn;
    m_dataset_arn_isSet = true;
}

bool OAIDatasetSource::is_dataset_arn_Set() const{
    return m_dataset_arn_isSet;
}

bool OAIDatasetSource::is_dataset_arn_Valid() const{
