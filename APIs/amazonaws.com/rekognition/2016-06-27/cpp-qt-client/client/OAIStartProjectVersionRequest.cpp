...
#include "OAIStartProjectVersionRequest.h"
...
OAIStartProjectVersionRequest::OAIStartProjectVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartProjectVersionRequest::OAIStartProjectVersionRequest() {
    this->initializeModel();
}

OAIStartProjectVersionRequest::~OAIStartProjectVersionRequest() {}

void OAIStartProjectVersionRequest::initializeModel() {
...
void OAIStartProjectVersionRequest::fromJson(QString jsonString) {
...
void OAIStartProjectVersionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartProjectVersionRequest::asJson() const {
...
QJsonObject OAIStartProjectVersionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartProjectVersionRequest::getProjectVersionArn() const {
    return m_project_version_arn;
}
void OAIStartProjectVersionRequest::setProjectVersionArn(const QString &project_version_arn) {
    m_project_version_arn = project_version_arn;
    m_project_version_arn_isSet = true;
}

bool OAIStartProjectVersionRequest::is_project_version_arn_Set() const{
    return m_project_version_arn_isSet;
}

bool OAIStartProjectVersionRequest::is_project_version_arn_Valid() const{
    return m_project_version_arn_isValid;
}

qint32 OAIStartProjectVersionRequest::getMinInferenceUnits() const {
    return m_min_inference_units;
}
void OAIStartProjectVersionRequest::setMinInferenceUnits(const qint32 &min_inference_units) {
    m_min_inference_units = min_inference_units;
    m_min_inference_units_isSet = true;
}

bool OAIStartProjectVersionRequest::is_min_inference_units_Set() const{
    return m_min_inference_units_isSet;
}

bool OAIStartProjectVersionRequest::is_min_inference_units_Valid() const{
    return m_min_inference_units_isValid;
}

qint32 OAIStartProjectVersionRequest::getMaxInferenceUnits() const {
    return m_max_inference_units;
}
void OAIStartProjectVersionRequest::setMaxInferenceUnits(const qint32 &max_inference_units) {
    m_max_inference_units = max_inference_units;
    m_max_inference_units_isSet = true;
}

bool OAIStartProjectVersionRequest::is_max_inference_units_Set() const{
    return m_max_inference_units_isSet;
}

bool OAIStartProjectVersionRequest::is_max_inference_units_Valid() const{
    return m_max_inference_units_isValid;
}

bool OAIStartProjectVersionRequest::isSet() const {
...
bool OAIStartProjectVersionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_project_version_arn_isValid && m_min_inference_units_isValid && true;
}
