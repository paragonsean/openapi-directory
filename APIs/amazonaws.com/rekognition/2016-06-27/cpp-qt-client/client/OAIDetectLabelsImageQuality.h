...
/*
 * OAIDetectLabelsImageQuality.h
 *
 * The quality of an image provided for label detection, with regard to brightness, sharpness, and contrast.
 */

#ifndef OAIDetectLabelsImageQuality_H
#define OAIDetectLabelsImageQuality_H
...
class OAIDetectLabelsImageQuality : public OAIObject {
public:
    OAIDetectLabelsImageQuality();
    OAIDetectLabelsImageQuality(QString json);
    ~OAIDetectLabelsImageQuality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageQuality)

#endif // OAIDetectLabelsImageQuality_H
