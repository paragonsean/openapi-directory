...
#include "OAITrainingDataResult_Validation.h"
...
OAITrainingDataResult_Validation::OAITrainingDataResult_Validation(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingDataResult_Validation::OAITrainingDataResult_Validation() {
    this->initializeModel();
}

OAITrainingDataResult_Validation::~OAITrainingDataResult_Validation() {}

void OAITrainingDataResult_Validation::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAITrainingDataResult_Validation::fromJson(QString jsonString) {
...
void OAITrainingDataResult_Validation::fromJsonObject(QJsonObject json) {
...
QString OAITrainingDataResult_Validation::asJson() const {
...
QJsonObject OAITrainingDataResult_Validation::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITrainingDataResult_Validation::getAssets() const {
    return m_assets;
}
void OAITrainingDataResult_Validation::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITrainingDataResult_Validation::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITrainingDataResult_Validation::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITrainingDataResult_Validation::isSet() const {
...
bool OAITrainingDataResult_Validation::isValid() const {
