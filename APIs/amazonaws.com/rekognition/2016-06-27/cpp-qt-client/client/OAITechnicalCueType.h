...
/*
 * OAITechnicalCueType.h
 *
 * 
 */

#ifndef OAITechnicalCueType_H
#define OAITechnicalCueType_H
...
class OAITechnicalCueType : public OAIEnum {
public:
    OAITechnicalCueType();
    OAITechnicalCueType(QString json);
    ~OAITechnicalCueType() override;
    ...
    enum class eOAITechnicalCueType {
    ...
    OAITechnicalCueType::eOAITechnicalCueType getValue() const;
    void setValue(const OAITechnicalCueType::eOAITechnicalCueType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITechnicalCueType)

#endif // OAITechnicalCueType_H
