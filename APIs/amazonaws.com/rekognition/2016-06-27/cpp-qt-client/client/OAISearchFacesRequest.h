...
/*
 * OAISearchFacesRequest.h
 *
 * 
 */

#ifndef OAISearchFacesRequest_H
#define OAISearchFacesRequest_H
...
class OAISearchFacesRequest : public OAIObject {
public:
    OAISearchFacesRequest();
    OAISearchFacesRequest(QString json);
    ~OAISearchFacesRequest() override;
    ...
    qint32 getMaxFaces() const;
    void setMaxFaces(const qint32 &max_faces);
    bool is_max_faces_Set() const;
    bool is_max_faces_Valid() const;

    float getFaceMatchThreshold() const;
    void setFaceMatchThreshold(const float &face_match_threshold);
    bool is_face_match_threshold_Set() const;
    bool is_face_match_threshold_Valid() const;
...
private:
    ...
    qint32 m_max_faces;
    bool m_max_faces_isSet;
    bool m_max_faces_isValid;

    float m_face_match_threshold;
    bool m_face_match_threshold_isSet;
    bool m_face_match_threshold_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISearchFacesRequest)

#endif // OAISearchFacesRequest_H
