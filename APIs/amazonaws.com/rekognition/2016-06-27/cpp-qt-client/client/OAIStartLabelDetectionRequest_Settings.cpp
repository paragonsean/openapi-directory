...
OAIStartLabelDetectionRequest_Settings::OAIStartLabelDetectionRequest_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartLabelDetectionRequest_Settings::OAIStartLabelDetectionRequest_Settings() {
    this->initializeModel();
}

OAIStartLabelDetectionRequest_Settings::~OAIStartLabelDetectionRequest_Settings() {}

void OAIStartLabelDetectionRequest_Settings::initializeModel() {

    m_general_labels_isSet = false;
    m_general_labels_isValid = false;
}

void OAIStartLabelDetectionRequest_Settings::fromJson(QString jsonString) {
...
void OAIStartLabelDetectionRequest_Settings::fromJsonObject(QJsonObject json) {
...
QString OAIStartLabelDetectionRequest_Settings::asJson() const {
...
QJsonObject OAIStartLabelDetectionRequest_Settings::asJsonObject() const {
    QJsonObject obj;
...
OAIGeneralLabelsSettings OAIStartLabelDetectionRequest_Settings::getGeneralLabels() const {
    return m_general_labels;
}
void OAIStartLabelDetectionRequest_Settings::setGeneralLabels(const OAIGeneralLabelsSettings &general_labels) {
    m_general_labels = general_labels;
    m_general_labels_isSet = true;
}

bool OAIStartLabelDetectionRequest_Settings::is_general_labels_Set() const{
    return m_general_labels_isSet;
}

bool OAIStartLabelDetectionRequest_Settings::is_general_labels_Valid() const{
    return m_general_labels_isValid;
}

bool OAIStartLabelDetectionRequest_Settings::isSet() const {
...
bool OAIStartLabelDetectionRequest_Settings::isValid() const {
