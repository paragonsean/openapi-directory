...
/*
 * OAIStartCelebrityRecognitionRequest_NotificationChannel.h
 *
 * 
 */

#ifndef OAIStartCelebrityRecognitionRequest_NotificationChannel_H
#define OAIStartCelebrityRecognitionRequest_NotificationChannel_H
...
class OAIStartCelebrityRecognitionRequest_NotificationChannel : public OAIObject {
public:
    OAIStartCelebrityRecognitionRequest_NotificationChannel();
    OAIStartCelebrityRecognitionRequest_NotificationChannel(QString json);
    ~OAIStartCelebrityRecognitionRequest_NotificationChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartCelebrityRecognitionRequest_NotificationChannel)

#endif // OAIStartCelebrityRecognitionRequest_NotificationChannel_H
