...
/*
 * OAISearchedFaceDetails.h
 *
 * Contains data regarding the input face used for a search.
 */

#ifndef OAISearchedFaceDetails_H
#define OAISearchedFaceDetails_H
...
class OAISearchedFaceDetails : public OAIObject {
public:
    OAISearchedFaceDetails();
    OAISearchedFaceDetails(QString json);
    ~OAISearchedFaceDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchedFaceDetails)

#endif // OAISearchedFaceDetails_H
