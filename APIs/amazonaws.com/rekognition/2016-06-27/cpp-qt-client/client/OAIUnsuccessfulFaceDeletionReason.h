...
/*
 * OAIUnsuccessfulFaceDeletionReason.h
 *
 * 
 */

#ifndef OAIUnsuccessfulFaceDeletionReason_H
#define OAIUnsuccessfulFaceDeletionReason_H
...
class OAIUnsuccessfulFaceDeletionReason : public OAIEnum {
public:
    OAIUnsuccessfulFaceDeletionReason();
    OAIUnsuccessfulFaceDeletionReason(QString json);
    ~OAIUnsuccessfulFaceDeletionReason() override;
    ...
    enum class eOAIUnsuccessfulFaceDeletionReason {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ASSOCIATED_TO_AN_EXISTING_USER, 
        FACE_NOT_FOUND
    };
    OAIUnsuccessfulFaceDeletionReason::eOAIUnsuccessfulFaceDeletionReason getValue() const;
    void setValue(const OAIUnsuccessfulFaceDeletionReason::eOAIUnsuccessfulFaceDeletionReason& value);
...
private:
    ...
    eOAIUnsuccessfulFaceDeletionReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsuccessfulFaceDeletionReason)

#endif // OAIUnsuccessfulFaceDeletionReason_H
