...
OAICreateProjectVersionRequest_TrainingData::OAICreateProjectVersionRequest_TrainingData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateProjectVersionRequest_TrainingData::OAICreateProjectVersionRequest_TrainingData() {
    this->initializeModel();
}

OAICreateProjectVersionRequest_TrainingData::~OAICreateProjectVersionRequest_TrainingData() {}

void OAICreateProjectVersionRequest_TrainingData::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAICreateProjectVersionRequest_TrainingData::fromJson(QString jsonString) {
...
void OAICreateProjectVersionRequest_TrainingData::fromJsonObject(QJsonObject json) {
...
QString OAICreateProjectVersionRequest_TrainingData::asJson() const {
...
QJsonObject OAICreateProjectVersionRequest_TrainingData::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAICreateProjectVersionRequest_TrainingData::getAssets() const {
    return m_assets;
}
void OAICreateProjectVersionRequest_TrainingData::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAICreateProjectVersionRequest_TrainingData::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAICreateProjectVersionRequest_TrainingData::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAICreateProjectVersionRequest_TrainingData::isSet() const {
...
bool OAICreateProjectVersionRequest_TrainingData::isValid() const {
