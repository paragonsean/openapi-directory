...
/*
 * OAIDetectProtectiveEquipmentRequest_Image.h
 *
 * 
 */

#ifndef OAIDetectProtectiveEquipmentRequest_Image_H
#define OAIDetectProtectiveEquipmentRequest_Image_H
...
class OAIDetectProtectiveEquipmentRequest_Image : public OAIObject {
public:
    OAIDetectProtectiveEquipmentRequest_Image();
    OAIDetectProtectiveEquipmentRequest_Image(QString json);
    ~OAIDetectProtectiveEquipmentRequest_Image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectProtectiveEquipmentRequest_Image)

#endif // OAIDetectProtectiveEquipmentRequest_Image_H
