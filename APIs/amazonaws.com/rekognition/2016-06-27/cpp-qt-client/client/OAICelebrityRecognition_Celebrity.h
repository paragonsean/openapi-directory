...
/*
 * OAICelebrityRecognition_Celebrity.h
 *
 * 
 */

#ifndef OAICelebrityRecognition_Celebrity_H
#define OAICelebrityRecognition_Celebrity_H

#include <QJsonObject>

#include "OAICelebrityDetail_BoundingBox.h"
#include "OAICelebrityDetail_Face.h"
#include "OAIGetCelebrityInfoResponse_KnownGender.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICelebrityDetail_BoundingBox;
class OAICelebrityDetail_Face;
class OAIGetCelebrityInfoResponse_KnownGender;

class OAICelebrityRecognition_Celebrity : public OAIObject {
public:
    OAICelebrityRecognition_Celebrity();
    OAICelebrityRecognition_Celebrity(QString json);
    ~OAICelebrityRecognition_Celebrity() override;
    ...
    OAICelebrityDetail_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAICelebrityDetail_BoundingBox &bounding_box);
    bool is_bounding_box_Set() const;
    bool is_bounding_box_Valid() const;

    OAICelebrityDetail_Face getFace() const;
    void setFace(const OAICelebrityDetail_Face &face);
    bool is_face_Set() const;
    bool is_face_Valid() const;

    OAIGetCelebrityInfoResponse_KnownGender getKnownGender() const;
    void setKnownGender(const OAIGetCelebrityInfoResponse_KnownGender &known_gender);
...
private:
    ...
    OAICelebrityDetail_BoundingBox m_bounding_box;
    bool m_bounding_box_isSet;
    bool m_bounding_box_isValid;

    OAICelebrityDetail_Face m_face;
    bool m_face_isSet;
    bool m_face_isValid;

    OAIGetCelebrityInfoResponse_KnownGender m_known_gender;
...
Q_DECLARE_METATYPE(OpenAPI::OAICelebrityRecognition_Celebrity)

#endif // OAICelebrityRecognition_Celebrity_H
