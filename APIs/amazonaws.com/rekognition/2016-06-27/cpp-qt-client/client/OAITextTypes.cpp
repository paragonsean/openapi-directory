...
OAITextTypes::OAITextTypes(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITextTypes::OAITextTypes() {
    this->initializeModel();
}

OAITextTypes::~OAITextTypes() {}

void OAITextTypes::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAITextTypes::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAITextTypes::fromJson(QString jsonString) {
    
    if ( jsonString.compare("LINE", Qt::CaseInsensitive) == 0) {
        m_value = eOAITextTypes::LINE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("WORD", Qt::CaseInsensitive) == 0) {
        m_value = eOAITextTypes::WORD;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAITextTypes::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAITextTypes::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAITextTypes::LINE:
            val = "LINE";
            break;
        case eOAITextTypes::WORD:
            val = "WORD";
            break;
        default:
            break;
...
QJsonValue OAITextTypes::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAITextTypes::eOAITextTypes OAITextTypes::getValue() const {
    return m_value;
}

void OAITextTypes::setValue(const OAITextTypes::eOAITextTypes& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAITextTypes::isSet() const {
    
    return m_value_isSet;
}

bool OAITextTypes::isValid() const {
