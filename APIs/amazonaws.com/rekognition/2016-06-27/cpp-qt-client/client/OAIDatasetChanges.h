...
#ifndef OAIDatasetChanges_H
#define OAIDatasetChanges_H
...
class OAIDatasetChanges : public OAIObject {
public:
    OAIDatasetChanges();
    OAIDatasetChanges(QString json);
    ~OAIDatasetChanges() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetChanges)

#endif // OAIDatasetChanges_H
