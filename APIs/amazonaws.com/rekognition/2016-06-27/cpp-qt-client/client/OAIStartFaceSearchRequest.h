...
/*
 * OAIStartFaceSearchRequest.h
 *
 * 
 */

#ifndef OAIStartFaceSearchRequest_H
#define OAIStartFaceSearchRequest_H

#include <QJsonObject>

#include "OAIStartFaceSearchRequest_NotificationChannel.h"
#include "OAIStartFaceSearchRequest_Video.h"
#include <QString>
...
namespace OpenAPI {
class OAIStartFaceSearchRequest_Video;
class OAIStartFaceSearchRequest_NotificationChannel;

class OAIStartFaceSearchRequest : public OAIObject {
public:
    OAIStartFaceSearchRequest();
    OAIStartFaceSearchRequest(QString json);
    ~OAIStartFaceSearchRequest() override;
    ...
    OAIStartFaceSearchRequest_Video getVideo() const;
    void setVideo(const OAIStartFaceSearchRequest_Video &video);
    ...
    OAIStartFaceSearchRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartFaceSearchRequest_NotificationChannel &notification_channel);
...
private:
    ...
    OAIStartFaceSearchRequest_Video m_video;
    bool m_video_isSet;
    ...
    OAIStartFaceSearchRequest_NotificationChannel m_notification_channel;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceSearchRequest)

#endif // OAIStartFaceSearchRequest_H
