...
/*
 * OAIStreamProcessingStartSelector.h
 *
 * This is a required parameter for label detection stream processors and should not be used to start a face search stream processor.
 */

#ifndef OAIStreamProcessingStartSelector_H
#define OAIStreamProcessingStartSelector_H
...
class OAIStreamProcessingStartSelector : public OAIObject {
public:
    OAIStreamProcessingStartSelector();
    OAIStreamProcessingStartSelector(QString json);
    ~OAIStreamProcessingStartSelector() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessingStartSelector)

#endif // OAIStreamProcessingStartSelector_H
