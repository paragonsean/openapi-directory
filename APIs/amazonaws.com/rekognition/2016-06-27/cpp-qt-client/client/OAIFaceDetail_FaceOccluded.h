...
/*
 * OAIFaceDetail_FaceOccluded.h
 *
 * 
 */

#ifndef OAIFaceDetail_FaceOccluded_H
#define OAIFaceDetail_FaceOccluded_H
...
class OAIFaceDetail_FaceOccluded : public OAIObject {
public:
    OAIFaceDetail_FaceOccluded();
    OAIFaceDetail_FaceOccluded(QString json);
    ~OAIFaceDetail_FaceOccluded() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_FaceOccluded)

#endif // OAIFaceDetail_FaceOccluded_H
