...
OAIStartContentModerationRequest_Video::OAIStartContentModerationRequest_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartContentModerationRequest_Video::OAIStartContentModerationRequest_Video() {
    this->initializeModel();
}

OAIStartContentModerationRequest_Video::~OAIStartContentModerationRequest_Video() {}

void OAIStartContentModerationRequest_Video::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIStartContentModerationRequest_Video::fromJson(QString jsonString) {
...
void OAIStartContentModerationRequest_Video::fromJsonObject(QJsonObject json) {
...
QString OAIStartContentModerationRequest_Video::asJson() const {
...
QJsonObject OAIStartContentModerationRequest_Video::asJsonObject() const {
    QJsonObject obj;
...
OAIVideo_S3Object OAIStartContentModerationRequest_Video::getS3Object() const {
    return m_s3_object;
}
void OAIStartContentModerationRequest_Video::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIStartContentModerationRequest_Video::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIStartContentModerationRequest_Video::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIStartContentModerationRequest_Video::isSet() const {
...
bool OAIStartContentModerationRequest_Video::isValid() const {
