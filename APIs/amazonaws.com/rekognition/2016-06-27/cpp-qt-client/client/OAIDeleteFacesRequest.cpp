...
#include "OAIDeleteFacesRequest.h"
...
OAIDeleteFacesRequest::OAIDeleteFacesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteFacesRequest::OAIDeleteFacesRequest() {
    this->initializeModel();
}

OAIDeleteFacesRequest::~OAIDeleteFacesRequest() {}

void OAIDeleteFacesRequest::initializeModel() {
...
void OAIDeleteFacesRequest::fromJson(QString jsonString) {
...
void OAIDeleteFacesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDeleteFacesRequest::asJson() const {
...
QJsonObject OAIDeleteFacesRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDeleteFacesRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIDeleteFacesRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIDeleteFacesRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIDeleteFacesRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QList OAIDeleteFacesRequest::getFaceIds() const {
    return m_face_ids;
}
void OAIDeleteFacesRequest::setFaceIds(const QList &face_ids) {
    m_face_ids = face_ids;
    m_face_ids_isSet = true;
}

bool OAIDeleteFacesRequest::is_face_ids_Set() const{
    return m_face_ids_isSet;
}

bool OAIDeleteFacesRequest::is_face_ids_Valid() const{
    return m_face_ids_isValid;
}

bool OAIDeleteFacesRequest::isSet() const {
...
bool OAIDeleteFacesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_collection_id_isValid && m_face_ids_isValid && true;
}
