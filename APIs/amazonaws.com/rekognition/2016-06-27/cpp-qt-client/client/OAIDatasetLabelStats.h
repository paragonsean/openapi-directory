...
class OAIDatasetLabelStats : public OAIObject {
public:
    OAIDatasetLabelStats();
    OAIDatasetLabelStats(QString json);
    ~OAIDatasetLabelStats() override;
    ...
    qint32 getBoundingBoxCount() const;
    void setBoundingBoxCount(const qint32 &bounding_box_count);
    bool is_bounding_box_count_Set() const;
    bool is_bounding_box_count_Valid() const;
...
private:
    ...
    qint32 m_bounding_box_count;
    bool m_bounding_box_count_isSet;
    bool m_bounding_box_count_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDatasetLabelStats)

#endif // OAIDatasetLabelStats_H
