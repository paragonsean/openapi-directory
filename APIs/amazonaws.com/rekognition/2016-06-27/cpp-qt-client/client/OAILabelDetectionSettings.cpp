...
#include "OAILabelDetectionSettings.h"
...
OAILabelDetectionSettings::OAILabelDetectionSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelDetectionSettings::OAILabelDetectionSettings() {
    this->initializeModel();
}

OAILabelDetectionSettings::~OAILabelDetectionSettings() {}

void OAILabelDetectionSettings::initializeModel() {

    m_general_labels_isSet = false;
    m_general_labels_isValid = false;
}

void OAILabelDetectionSettings::fromJson(QString jsonString) {
...
void OAILabelDetectionSettings::fromJsonObject(QJsonObject json) {
...
QString OAILabelDetectionSettings::asJson() const {
...
QJsonObject OAILabelDetectionSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIGeneralLabelsSettings OAILabelDetectionSettings::getGeneralLabels() const {
    return m_general_labels;
}
void OAILabelDetectionSettings::setGeneralLabels(const OAIGeneralLabelsSettings &general_labels) {
    m_general_labels = general_labels;
    m_general_labels_isSet = true;
}

bool OAILabelDetectionSettings::is_general_labels_Set() const{
    return m_general_labels_isSet;
}

bool OAILabelDetectionSettings::is_general_labels_Valid() const{
    return m_general_labels_isValid;
}

bool OAILabelDetectionSettings::isSet() const {
...
bool OAILabelDetectionSettings::isValid() const {
