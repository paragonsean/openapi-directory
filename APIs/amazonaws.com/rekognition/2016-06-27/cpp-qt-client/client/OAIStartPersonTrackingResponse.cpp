...
#include "OAIStartPersonTrackingResponse.h"
...
OAIStartPersonTrackingResponse::OAIStartPersonTrackingResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartPersonTrackingResponse::OAIStartPersonTrackingResponse() {
    this->initializeModel();
}

OAIStartPersonTrackingResponse::~OAIStartPersonTrackingResponse() {}

void OAIStartPersonTrackingResponse::initializeModel() {

    m_job_id_isSet = false;
    m_job_id_isValid = false;
}

void OAIStartPersonTrackingResponse::fromJson(QString jsonString) {
...
void OAIStartPersonTrackingResponse::fromJsonObject(QJsonObject json) {

    m_job_id_isValid = ::OpenAPI::fromJsonValue(m_job_id, json[QString("JobId")]);
    m_job_id_isSet = !json[QString("JobId")].isNull() && m_job_id_isValid;
}

QString OAIStartPersonTrackingResponse::asJson() const {
...
QJsonObject OAIStartPersonTrackingResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIStartPersonTrackingResponse::getJobId() const {
    return m_job_id;
}
void OAIStartPersonTrackingResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIStartPersonTrackingResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIStartPersonTrackingResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

bool OAIStartPersonTrackingResponse::isSet() const {
...
bool OAIStartPersonTrackingResponse::isValid() const {
