...
OAIVideoJobStatus::OAIVideoJobStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIVideoJobStatus::OAIVideoJobStatus() {
    this->initializeModel();
}

OAIVideoJobStatus::~OAIVideoJobStatus() {}

void OAIVideoJobStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIVideoJobStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIVideoJobStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("IN_PROGRESS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVideoJobStatus::IN_PROGRESS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("SUCCEEDED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVideoJobStatus::SUCCEEDED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIVideoJobStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIVideoJobStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIVideoJobStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIVideoJobStatus::IN_PROGRESS:
            val = "IN_PROGRESS";
            break;
        case eOAIVideoJobStatus::SUCCEEDED:
            val = "SUCCEEDED";
            break;
        case eOAIVideoJobStatus::FAILED:
            val = "FAILED";
            break;
        default:
            break;
...
QJsonValue OAIVideoJobStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIVideoJobStatus::eOAIVideoJobStatus OAIVideoJobStatus::getValue() const {
    return m_value;
}

void OAIVideoJobStatus::setValue(const OAIVideoJobStatus::eOAIVideoJobStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIVideoJobStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIVideoJobStatus::isValid() const {
