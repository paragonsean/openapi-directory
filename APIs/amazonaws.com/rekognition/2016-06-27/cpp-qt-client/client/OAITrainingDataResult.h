...
/*
 * OAITrainingDataResult.h
 *
 * Sagemaker Groundtruth format manifest files for the input, output and validation datasets that are used and created during testing.
 */

#ifndef OAITrainingDataResult_H
#define OAITrainingDataResult_H
...
class OAITrainingDataResult : public OAIObject {
public:
    OAITrainingDataResult();
    OAITrainingDataResult(QString json);
    ~OAITrainingDataResult() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingDataResult)

#endif // OAITrainingDataResult_H
