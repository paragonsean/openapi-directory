...
/*
 * OAIStartPersonTrackingRequest_NotificationChannel.h
 *
 * 
 */

#ifndef OAIStartPersonTrackingRequest_NotificationChannel_H
#define OAIStartPersonTrackingRequest_NotificationChannel_H
...
class OAIStartPersonTrackingRequest_NotificationChannel : public OAIObject {
public:
    OAIStartPersonTrackingRequest_NotificationChannel();
    OAIStartPersonTrackingRequest_NotificationChannel(QString json);
    ~OAIStartPersonTrackingRequest_NotificationChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartPersonTrackingRequest_NotificationChannel)

#endif // OAIStartPersonTrackingRequest_NotificationChannel_H
