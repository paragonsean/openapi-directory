...
/*
 * OAISearchUsersRequest.h
 *
 * 
 */

#ifndef OAISearchUsersRequest_H
#define OAISearchUsersRequest_H
...
class OAISearchUsersRequest : public OAIObject {
public:
    OAISearchUsersRequest();
    OAISearchUsersRequest(QString json);
    ~OAISearchUsersRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchUsersRequest)

#endif // OAISearchUsersRequest_H
