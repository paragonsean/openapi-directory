...
QString OAICreateUserRequest::getCollectionId() const {
    return m_collection_id;
}
void OAICreateUserRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAICreateUserRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAICreateUserRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAICreateUserRequest::getUserId() const {
    return m_user_id;
}
void OAICreateUserRequest::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAICreateUserRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAICreateUserRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAICreateUserRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAICreateUserRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAICreateUserRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAICreateUserRequest::is_client_request_token_Valid() const{
