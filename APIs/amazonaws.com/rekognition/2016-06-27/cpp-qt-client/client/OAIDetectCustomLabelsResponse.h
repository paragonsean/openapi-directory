...
/*
 * OAIDetectCustomLabelsResponse.h
 *
 * 
 */

#ifndef OAIDetectCustomLabelsResponse_H
#define OAIDetectCustomLabelsResponse_H
...
class OAIDetectCustomLabelsResponse : public OAIObject {
public:
    OAIDetectCustomLabelsResponse();
    OAIDetectCustomLabelsResponse(QString json);
    ~OAIDetectCustomLabelsResponse() override;
    ...
    QList getCustomLabels() const;
    void setCustomLabels(const QList &custom_labels);
    bool is_custom_labels_Set() const;
    bool is_custom_labels_Valid() const;
...
private:
    ...
    QList m_custom_labels;
    bool m_custom_labels_isSet;
    bool m_custom_labels_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDetectCustomLabelsResponse)

#endif // OAIDetectCustomLabelsResponse_H
