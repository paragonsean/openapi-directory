...
/*
 * OAIListDatasetEntriesResponse.h
 *
 * 
 */

#ifndef OAIListDatasetEntriesResponse_H
#define OAIListDatasetEntriesResponse_H
...
class OAIListDatasetEntriesResponse : public OAIObject {
public:
    OAIListDatasetEntriesResponse();
    OAIListDatasetEntriesResponse(QString json);
    ~OAIListDatasetEntriesResponse() override;
    ...
    QList getDatasetEntries() const;
    void setDatasetEntries(const QList &dataset_entries);
    bool is_dataset_entries_Set() const;
    bool is_dataset_entries_Valid() const;
...
private:
    ...
    QList m_dataset_entries;
    bool m_dataset_entries_isSet;
    bool m_dataset_entries_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatasetEntriesResponse)

#endif // OAIListDatasetEntriesResponse_H
