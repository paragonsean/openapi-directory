...
#ifndef OAIPersonMatch_H
#define OAIPersonMatch_H

#include <QJsonObject>

#include "OAIPersonMatch_Person.h"
#include <QList>
...
namespace OpenAPI {
class OAIPersonMatch_Person;

class OAIPersonMatch : public OAIObject {
public:
    OAIPersonMatch();
    OAIPersonMatch(QString json);
    ~OAIPersonMatch() override;
    ...
    OAIPersonMatch_Person getPerson() const;
    void setPerson(const OAIPersonMatch_Person &person);
...
private:
    ...
    OAIPersonMatch_Person m_person;
    bool m_person_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonMatch)

#endif // OAIPersonMatch_H
