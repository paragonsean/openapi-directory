...
#include "OAICreateStreamProcessorRequest_Output.h"
...
OAICreateStreamProcessorRequest_Output::OAICreateStreamProcessorRequest_Output(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamProcessorRequest_Output::OAICreateStreamProcessorRequest_Output() {
    this->initializeModel();
}

OAICreateStreamProcessorRequest_Output::~OAICreateStreamProcessorRequest_Output() {}

void OAICreateStreamProcessorRequest_Output::initializeModel() {

    m_kinesis_data_stream_isSet = false;
    m_kinesis_data_stream_isValid = false;

    m_s3_destination_isSet = false;
    m_s3_destination_isValid = false;
}

void OAICreateStreamProcessorRequest_Output::fromJson(QString jsonString) {
...
void OAICreateStreamProcessorRequest_Output::fromJsonObject(QJsonObject json) {

    m_kinesis_data_stream_isValid = ::OpenAPI::fromJsonValue(m_kinesis_data_stream, json[QString("KinesisDataStream")]);
    m_kinesis_data_stream_isSet = !json[QString("KinesisDataStream")].isNull() && m_kinesis_data_stream_isValid;
...
QString OAICreateStreamProcessorRequest_Output::asJson() const {
...
QJsonObject OAICreateStreamProcessorRequest_Output::asJsonObject() const {
    QJsonObject obj;
    if (m_kinesis_data_stream.isSet()) {
        obj.insert(QString("KinesisDataStream"), ::OpenAPI::toJsonValue(m_kinesis_data_stream));
    }
...
OAIStreamProcessorOutput_KinesisDataStream OAICreateStreamProcessorRequest_Output::getKinesisDataStream() const {
    return m_kinesis_data_stream;
}
void OAICreateStreamProcessorRequest_Output::setKinesisDataStream(const OAIStreamProcessorOutput_KinesisDataStream &kinesis_data_stream) {
    m_kinesis_data_stream = kinesis_data_stream;
    m_kinesis_data_stream_isSet = true;
}

bool OAICreateStreamProcessorRequest_Output::is_kinesis_data_stream_Set() const{
    return m_kinesis_data_stream_isSet;
}

bool OAICreateStreamProcessorRequest_Output::is_kinesis_data_stream_Valid() const{
    return m_kinesis_data_stream_isValid;
}

OAIStreamProcessorOutput_S3Destination OAICreateStreamProcessorRequest_Output::getS3Destination() const {
    return m_s3_destination;
}
void OAICreateStreamProcessorRequest_Output::setS3Destination(const OAIStreamProcessorOutput_S3Destination &s3_destination) {
    m_s3_destination = s3_destination;
    m_s3_destination_isSet = true;
}

bool OAICreateStreamProcessorRequest_Output::is_s3_destination_Set() const{
    return m_s3_destination_isSet;
}

bool OAICreateStreamProcessorRequest_Output::is_s3_destination_Valid() const{
    return m_s3_destination_isValid;
}

bool OAICreateStreamProcessorRequest_Output::isSet() const {
...
bool OAICreateStreamProcessorRequest_Output::isValid() const {
