...
/*
 * OAILabelDetectionFeatureName.h
 *
 * 
 */

#ifndef OAILabelDetectionFeatureName_H
#define OAILabelDetectionFeatureName_H
...
class OAILabelDetectionFeatureName : public OAIEnum {
public:
    OAILabelDetectionFeatureName();
    OAILabelDetectionFeatureName(QString json);
    ~OAILabelDetectionFeatureName() override;
    ...
    enum class eOAILabelDetectionFeatureName {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        GENERAL_LABELS
    };
    OAILabelDetectionFeatureName::eOAILabelDetectionFeatureName getValue() const;
    void setValue(const OAILabelDetectionFeatureName::eOAILabelDetectionFeatureName& value);
...
private:
    ...
    eOAILabelDetectionFeatureName m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelDetectionFeatureName)

#endif // OAILabelDetectionFeatureName_H
