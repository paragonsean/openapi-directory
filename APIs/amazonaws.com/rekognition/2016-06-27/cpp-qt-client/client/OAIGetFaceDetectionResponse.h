...
/*
 * OAIGetFaceDetectionResponse.h
 *
 * 
 */

#ifndef OAIGetFaceDetectionResponse_H
#define OAIGetFaceDetectionResponse_H
...
class OAIGetFaceDetectionResponse : public OAIObject {
public:
    OAIGetFaceDetectionResponse();
    OAIGetFaceDetectionResponse(QString json);
    ~OAIGetFaceDetectionResponse() override;
    ...
    QList getFaces() const;
    void setFaces(const QList &faces);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceDetectionResponse)

#endif // OAIGetFaceDetectionResponse_H
