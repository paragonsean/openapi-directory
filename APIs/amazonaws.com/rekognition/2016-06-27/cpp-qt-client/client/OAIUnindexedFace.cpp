...
OAIUnindexedFace::OAIUnindexedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnindexedFace::OAIUnindexedFace() {
    this->initializeModel();
}

OAIUnindexedFace::~OAIUnindexedFace() {}

void OAIUnindexedFace::initializeModel() {

    m_reasons_isSet = false;
    m_reasons_isValid = false;

    m_face_detail_isSet = false;
    m_face_detail_isValid = false;
}

void OAIUnindexedFace::fromJson(QString jsonString) {
...
void OAIUnindexedFace::fromJsonObject(QJsonObject json) {
    ...
    m_face_detail_isValid = ::OpenAPI::fromJsonValue(m_face_detail, json[QString("FaceDetail")]);
    m_face_detail_isSet = !json[QString("FaceDetail")].isNull() && m_face_detail_isValid;
}

QString OAIUnindexedFace::asJson() const {
...
QJsonObject OAIUnindexedFace::asJsonObject() const {
    QJsonObject obj;
    if (m_reasons.isSet()) {
        obj.insert(QString("Reasons"), ::OpenAPI::toJsonValue(m_reasons));
    }
    if (m_face_detail.isSet()) {
        obj.insert(QString("FaceDetail"), ::OpenAPI::toJsonValue(m_face_detail));
    }
    return obj;
}

QList OAIUnindexedFace::getReasons() const {
    return m_reasons;
}
void OAIUnindexedFace::setReasons(const QList &reasons) {
    m_reasons = reasons;
    m_reasons_isSet = true;
}

bool OAIUnindexedFace::is_reasons_Set() const{
    return m_reasons_isSet;
}

bool OAIUnindexedFace::is_reasons_Valid() const{
    return m_reasons_isValid;
}

OAIUnindexedFace_FaceDetail OAIUnindexedFace::getFaceDetail() const {
    return m_face_detail;
}
void OAIUnindexedFace::setFaceDetail(const OAIUnindexedFace_FaceDetail &face_detail) {
    m_face_detail = face_detail;
    m_face_detail_isSet = true;
}

bool OAIUnindexedFace::is_face_detail_Set() const{
    return m_face_detail_isSet;
}

bool OAIUnindexedFace::is_face_detail_Valid() const{
    return m_face_detail_isValid;
}

bool OAIUnindexedFace::isSet() const {
...
bool OAIUnindexedFace::isValid() const {
