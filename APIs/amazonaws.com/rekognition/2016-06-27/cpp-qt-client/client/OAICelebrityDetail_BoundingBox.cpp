...
OAICelebrityDetail_BoundingBox::OAICelebrityDetail_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICelebrityDetail_BoundingBox::OAICelebrityDetail_BoundingBox() {
    this->initializeModel();
}

OAICelebrityDetail_BoundingBox::~OAICelebrityDetail_BoundingBox() {}

void OAICelebrityDetail_BoundingBox::initializeModel() {
...
void OAICelebrityDetail_BoundingBox::fromJson(QString jsonString) {
...
void OAICelebrityDetail_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAICelebrityDetail_BoundingBox::asJson() const {
...
QJsonObject OAICelebrityDetail_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAICelebrityDetail_BoundingBox::getWidth() const {
    return m_width;
}
void OAICelebrityDetail_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAICelebrityDetail_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAICelebrityDetail_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAICelebrityDetail_BoundingBox::getHeight() const {
    return m_height;
}
void OAICelebrityDetail_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAICelebrityDetail_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAICelebrityDetail_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAICelebrityDetail_BoundingBox::getLeft() const {
    return m_left;
}
void OAICelebrityDetail_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAICelebrityDetail_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAICelebrityDetail_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAICelebrityDetail_BoundingBox::getTop() const {
    return m_top;
}
void OAICelebrityDetail_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAICelebrityDetail_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAICelebrityDetail_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAICelebrityDetail_BoundingBox::isSet() const {
...
bool OAICelebrityDetail_BoundingBox::isValid() const {
