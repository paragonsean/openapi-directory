...
/*
 * OAITrainingDataResult_Validation.h
 *
 * 
 */

#ifndef OAITrainingDataResult_Validation_H
#define OAITrainingDataResult_Validation_H
...
class OAITrainingDataResult_Validation : public OAIObject {
public:
    OAITrainingDataResult_Validation();
    OAITrainingDataResult_Validation(QString json);
    ~OAITrainingDataResult_Validation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingDataResult_Validation)

#endif // OAITrainingDataResult_Validation_H
