...
OAIUpdateStreamProcessorRequest_SettingsForUpdate::OAIUpdateStreamProcessorRequest_SettingsForUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUpdateStreamProcessorRequest_SettingsForUpdate::OAIUpdateStreamProcessorRequest_SettingsForUpdate() {
    this->initializeModel();
}

OAIUpdateStreamProcessorRequest_SettingsForUpdate::~OAIUpdateStreamProcessorRequest_SettingsForUpdate() {}

void OAIUpdateStreamProcessorRequest_SettingsForUpdate::initializeModel() {

    m_connected_home_for_update_isSet = false;
    m_connected_home_for_update_isValid = false;
}

void OAIUpdateStreamProcessorRequest_SettingsForUpdate::fromJson(QString jsonString) {
...
void OAIUpdateStreamProcessorRequest_SettingsForUpdate::fromJsonObject(QJsonObject json) {
...
QString OAIUpdateStreamProcessorRequest_SettingsForUpdate::asJson() const {
...
QJsonObject OAIUpdateStreamProcessorRequest_SettingsForUpdate::asJsonObject() const {
    QJsonObject obj;
...
OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate OAIUpdateStreamProcessorRequest_SettingsForUpdate::getConnectedHomeForUpdate() const {
    return m_connected_home_for_update;
}
void OAIUpdateStreamProcessorRequest_SettingsForUpdate::setConnectedHomeForUpdate(const OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate &connected_home_for_update) {
    m_connected_home_for_update = connected_home_for_update;
    m_connected_home_for_update_isSet = true;
}

bool OAIUpdateStreamProcessorRequest_SettingsForUpdate::is_connected_home_for_update_Set() const{
    return m_connected_home_for_update_isSet;
}

bool OAIUpdateStreamProcessorRequest_SettingsForUpdate::is_connected_home_for_update_Valid() const{
    return m_connected_home_for_update_isValid;
}

bool OAIUpdateStreamProcessorRequest_SettingsForUpdate::isSet() const {
...
bool OAIUpdateStreamProcessorRequest_SettingsForUpdate::isValid() const {
