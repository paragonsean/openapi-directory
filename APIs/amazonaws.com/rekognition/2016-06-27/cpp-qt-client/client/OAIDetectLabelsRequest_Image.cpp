...
#include "OAIDetectLabelsRequest_Image.h"
...
OAIDetectLabelsRequest_Image::OAIDetectLabelsRequest_Image(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsRequest_Image::OAIDetectLabelsRequest_Image() {
    this->initializeModel();
}

OAIDetectLabelsRequest_Image::~OAIDetectLabelsRequest_Image() {}

void OAIDetectLabelsRequest_Image::initializeModel() {
...
void OAIDetectLabelsRequest_Image::fromJson(QString jsonString) {
...
void OAIDetectLabelsRequest_Image::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsRequest_Image::asJson() const {
...
QJsonObject OAIDetectLabelsRequest_Image::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAIDetectLabelsRequest_Image::getBytes() const {
    return m_bytes;
}
void OAIDetectLabelsRequest_Image::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIDetectLabelsRequest_Image::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIDetectLabelsRequest_Image::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAIDetectLabelsRequest_Image::getS3Object() const {
    return m_s3_object;
}
void OAIDetectLabelsRequest_Image::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIDetectLabelsRequest_Image::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIDetectLabelsRequest_Image::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIDetectLabelsRequest_Image::isSet() const {
...
bool OAIDetectLabelsRequest_Image::isValid() const {
