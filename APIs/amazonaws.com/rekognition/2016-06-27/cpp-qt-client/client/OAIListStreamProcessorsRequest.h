...
/*
 * OAIListStreamProcessorsRequest.h
 *
 * 
 */

#ifndef OAIListStreamProcessorsRequest_H
#define OAIListStreamProcessorsRequest_H
...
class OAIListStreamProcessorsRequest : public OAIObject {
public:
    OAIListStreamProcessorsRequest();
    OAIListStreamProcessorsRequest(QString json);
    ~OAIListStreamProcessorsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListStreamProcessorsRequest)

#endif // OAIListStreamProcessorsRequest_H
