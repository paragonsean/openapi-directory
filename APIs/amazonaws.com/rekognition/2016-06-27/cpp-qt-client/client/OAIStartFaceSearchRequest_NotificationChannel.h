...
/*
 * OAIStartFaceSearchRequest_NotificationChannel.h
 *
 * 
 */

#ifndef OAIStartFaceSearchRequest_NotificationChannel_H
#define OAIStartFaceSearchRequest_NotificationChannel_H
...
class OAIStartFaceSearchRequest_NotificationChannel : public OAIObject {
public:
    OAIStartFaceSearchRequest_NotificationChannel();
    OAIStartFaceSearchRequest_NotificationChannel(QString json);
    ~OAIStartFaceSearchRequest_NotificationChannel() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceSearchRequest_NotificationChannel)

#endif // OAIStartFaceSearchRequest_NotificationChannel_H
