...
/*
 * OAIStartStreamProcessorRequest_StopSelector.h
 *
 * 
 */

#ifndef OAIStartStreamProcessorRequest_StopSelector_H
#define OAIStartStreamProcessorRequest_StopSelector_H
...
class OAIStartStreamProcessorRequest_StopSelector : public OAIObject {
public:
    OAIStartStreamProcessorRequest_StopSelector();
    OAIStartStreamProcessorRequest_StopSelector(QString json);
    ~OAIStartStreamProcessorRequest_StopSelector() override;
    ...
    qint32 getMaxDurationInSeconds() const;
    void setMaxDurationInSeconds(const qint32 &max_duration_in_seconds);
    bool is_max_duration_in_seconds_Set() const;
    bool is_max_duration_in_seconds_Valid() const;
...
private:
    ...
    qint32 m_max_duration_in_seconds;
    bool m_max_duration_in_seconds_isSet;
    bool m_max_duration_in_seconds_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartStreamProcessorRequest_StopSelector)

#endif // OAIStartStreamProcessorRequest_StopSelector_H
