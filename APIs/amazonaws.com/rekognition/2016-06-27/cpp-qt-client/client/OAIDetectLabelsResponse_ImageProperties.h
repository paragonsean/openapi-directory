...
/*
 * OAIDetectLabelsResponse_ImageProperties.h
 *
 * 
 */

#ifndef OAIDetectLabelsResponse_ImageProperties_H
#define OAIDetectLabelsResponse_ImageProperties_H
...
class OAIDetectLabelsResponse_ImageProperties : public OAIObject {
public:
    OAIDetectLabelsResponse_ImageProperties();
    OAIDetectLabelsResponse_ImageProperties(QString json);
    ~OAIDetectLabelsResponse_ImageProperties() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsResponse_ImageProperties)

#endif // OAIDetectLabelsResponse_ImageProperties_H
