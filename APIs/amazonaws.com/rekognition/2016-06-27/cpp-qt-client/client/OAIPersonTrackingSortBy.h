...
/*
 * OAIPersonTrackingSortBy.h
 *
 * 
 */

#ifndef OAIPersonTrackingSortBy_H
#define OAIPersonTrackingSortBy_H
...
class OAIPersonTrackingSortBy : public OAIEnum {
public:
    OAIPersonTrackingSortBy();
    OAIPersonTrackingSortBy(QString json);
    ~OAIPersonTrackingSortBy() override;
    ...
    enum class eOAIPersonTrackingSortBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INDEX, 
        TIMESTAMP
    };
    OAIPersonTrackingSortBy::eOAIPersonTrackingSortBy getValue() const;
    void setValue(const OAIPersonTrackingSortBy::eOAIPersonTrackingSortBy& value);
...
private:
    ...
    eOAIPersonTrackingSortBy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonTrackingSortBy)

#endif // OAIPersonTrackingSortBy_H
