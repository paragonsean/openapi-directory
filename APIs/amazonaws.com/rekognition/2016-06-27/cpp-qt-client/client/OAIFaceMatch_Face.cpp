...
OAIFaceMatch_Face::OAIFaceMatch_Face(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceMatch_Face::OAIFaceMatch_Face() {
    this->initializeModel();
}

OAIFaceMatch_Face::~OAIFaceMatch_Face() {}

void OAIFaceMatch_Face::initializeModel() {
...
void OAIFaceMatch_Face::fromJson(QString jsonString) {
...
void OAIFaceMatch_Face::fromJsonObject(QJsonObject json) {
...
QString OAIFaceMatch_Face::asJson() const {
...
QJsonObject OAIFaceMatch_Face::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAIFaceMatch_Face::getFaceId() const {
    return m_face_id;
}
void OAIFaceMatch_Face::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAIFaceMatch_Face::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAIFaceMatch_Face::is_face_id_Valid() const{
    return m_face_id_isValid;
}

OAIComparedFace_BoundingBox OAIFaceMatch_Face::getBoundingBox() const {
    return m_bounding_box;
}
void OAIFaceMatch_Face::setBoundingBox(const OAIComparedFace_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIFaceMatch_Face::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIFaceMatch_Face::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

QString OAIFaceMatch_Face::getImageId() const {
    return m_image_id;
}
void OAIFaceMatch_Face::setImageId(const QString &image_id) {
    m_image_id = image_id;
    m_image_id_isSet = true;
}

bool OAIFaceMatch_Face::is_image_id_Set() const{
    return m_image_id_isSet;
}

bool OAIFaceMatch_Face::is_image_id_Valid() const{
    return m_image_id_isValid;
}

QString OAIFaceMatch_Face::getExternalImageId() const {
    return m_external_image_id;
}
void OAIFaceMatch_Face::setExternalImageId(const QString &external_image_id) {
    m_external_image_id = external_image_id;
    m_external_image_id_isSet = true;
}

bool OAIFaceMatch_Face::is_external_image_id_Set() const{
    return m_external_image_id_isSet;
}

bool OAIFaceMatch_Face::is_external_image_id_Valid() const{
    return m_external_image_id_isValid;
}

float OAIFaceMatch_Face::getConfidence() const {
    return m_confidence;
}
void OAIFaceMatch_Face::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceMatch_Face::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceMatch_Face::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QString OAIFaceMatch_Face::getIndexFacesModelVersion() const {
    return m_index_faces_model_version;
}
void OAIFaceMatch_Face::setIndexFacesModelVersion(const QString &index_faces_model_version) {
    m_index_faces_model_version = index_faces_model_version;
    m_index_faces_model_version_isSet = true;
}

bool OAIFaceMatch_Face::is_index_faces_model_version_Set() const{
    return m_index_faces_model_version_isSet;
}

bool OAIFaceMatch_Face::is_index_faces_model_version_Valid() const{
    return m_index_faces_model_version_isValid;
}

QString OAIFaceMatch_Face::getUserId() const {
    return m_user_id;
}
void OAIFaceMatch_Face::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIFaceMatch_Face::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIFaceMatch_Face::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIFaceMatch_Face::isSet() const {
...
bool OAIFaceMatch_Face::isValid() const {
