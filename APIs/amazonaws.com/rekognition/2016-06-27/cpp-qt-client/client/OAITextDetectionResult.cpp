...
#include "OAITextDetectionResult.h"
...
OAITextDetectionResult::OAITextDetectionResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITextDetectionResult::OAITextDetectionResult() {
    this->initializeModel();
}

OAITextDetectionResult::~OAITextDetectionResult() {}

void OAITextDetectionResult::initializeModel() {

    m_timestamp_isSet = false;
    m_timestamp_isValid = false;

    m_text_detection_isSet = false;
    m_text_detection_isValid = false;
}

void OAITextDetectionResult::fromJson(QString jsonString) {
...
void OAITextDetectionResult::fromJsonObject(QJsonObject json) {

    m_timestamp_isValid = ::OpenAPI::fromJsonValue(m_timestamp, json[QString("Timestamp")]);
    m_timestamp_isSet = !json[QString("Timestamp")].isNull() && m_timestamp_isValid;

    m_text_detection_isValid = ::OpenAPI::fromJsonValue(m_text_detection, json[QString("TextDetection")]);
    m_text_detection_isSet = !json[QString("TextDetection")].isNull() && m_text_detection_isValid;
}

QString OAITextDetectionResult::asJson() const {
...
QJsonObject OAITextDetectionResult::asJsonObject() const {
    QJsonObject obj;
    if (m_timestamp_isSet) {
        obj.insert(QString("Timestamp"), ::OpenAPI::toJsonValue(m_timestamp));
    }
    if (m_text_detection.isSet()) {
        obj.insert(QString("TextDetection"), ::OpenAPI::toJsonValue(m_text_detection));
    }
    return obj;
}

qint32 OAITextDetectionResult::getTimestamp() const {
    return m_timestamp;
}
void OAITextDetectionResult::setTimestamp(const qint32 &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAITextDetectionResult::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAITextDetectionResult::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAITextDetectionResult_TextDetection OAITextDetectionResult::getTextDetection() const {
    return m_text_detection;
}
void OAITextDetectionResult::setTextDetection(const OAITextDetectionResult_TextDetection &text_detection) {
    m_text_detection = text_detection;
    m_text_detection_isSet = true;
}

bool OAITextDetectionResult::is_text_detection_Set() const{
    return m_text_detection_isSet;
}

bool OAITextDetectionResult::is_text_detection_Valid() const{
    return m_text_detection_isValid;
}

bool OAITextDetectionResult::isSet() const {
...
bool OAITextDetectionResult::isValid() const {
