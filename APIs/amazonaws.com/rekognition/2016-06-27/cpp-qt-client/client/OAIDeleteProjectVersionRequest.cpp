...
#include "OAIDeleteProjectVersionRequest.h"
...
OAIDeleteProjectVersionRequest::OAIDeleteProjectVersionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDeleteProjectVersionRequest::OAIDeleteProjectVersionRequest() {
    this->initializeModel();
}

OAIDeleteProjectVersionRequest::~OAIDeleteProjectVersionRequest() {}

void OAIDeleteProjectVersionRequest::initializeModel() {

    m_project_version_arn_isSet = false;
    m_project_version_arn_isValid = false;
}

void OAIDeleteProjectVersionRequest::fromJson(QString jsonString) {
...
void OAIDeleteProjectVersionRequest::fromJsonObject(QJsonObject json) {

    m_project_version_arn_isValid = ::OpenAPI::fromJsonValue(m_project_version_arn, json[QString("ProjectVersionArn")]);
    m_project_version_arn_isSet = !json[QString("ProjectVersionArn")].isNull() && m_project_version_arn_isValid;
}

QString OAIDeleteProjectVersionRequest::asJson() const {
...
QJsonObject OAIDeleteProjectVersionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_project_version_arn_isSet) {
        obj.insert(QString("ProjectVersionArn"), ::OpenAPI::toJsonValue(m_project_version_arn));
    }
    return obj;
}

QString OAIDeleteProjectVersionRequest::getProjectVersionArn() const {
    return m_project_version_arn;
}
void OAIDeleteProjectVersionRequest::setProjectVersionArn(const QString &project_version_arn) {
    m_project_version_arn = project_version_arn;
    m_project_version_arn_isSet = true;
}

bool OAIDeleteProjectVersionRequest::is_project_version_arn_Set() const{
    return m_project_version_arn_isSet;
}

bool OAIDeleteProjectVersionRequest::is_project_version_arn_Valid() const{
    return m_project_version_arn_isValid;
}

bool OAIDeleteProjectVersionRequest::isSet() const {
...
bool OAIDeleteProjectVersionRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_project_version_arn_isValid && true;
}
