...
/*
 * OAIDatasetLabelDescription.h
 *
 *  Describes a dataset label. For more information, see &lt;a&gt;ListDatasetLabels&lt;/a&gt;. 
 */

#ifndef OAIDatasetLabelDescription_H
#define OAIDatasetLabelDescription_H

#include <QJsonObject>

#include "OAIDatasetLabelDescription_LabelStats.h"
#include <QString>
...
namespace OpenAPI {
class OAIDatasetLabelDescription_LabelStats;

class OAIDatasetLabelDescription : public OAIObject {
public:
    OAIDatasetLabelDescription();
    OAIDatasetLabelDescription(QString json);
    ~OAIDatasetLabelDescription() override;
    ...
    OAIDatasetLabelDescription_LabelStats getLabelStats() const;
    void setLabelStats(const OAIDatasetLabelDescription_LabelStats &label_stats);
...
private:
    ...
    OAIDatasetLabelDescription_LabelStats m_label_stats;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetLabelDescription)

#endif // OAIDatasetLabelDescription_H
