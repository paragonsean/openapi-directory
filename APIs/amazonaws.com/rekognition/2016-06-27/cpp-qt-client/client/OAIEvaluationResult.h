...
namespace OpenAPI {
class OAIEvaluationResult_Summary;
...
public:
    ...
    OAIEvaluationResult_Summary getSummary() const;
    void setSummary(const OAIEvaluationResult_Summary &summary);
...
private:
    ...
    OAIEvaluationResult_Summary m_summary;
