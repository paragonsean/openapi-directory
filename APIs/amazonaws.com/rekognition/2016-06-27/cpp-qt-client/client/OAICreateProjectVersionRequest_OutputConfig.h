...
/*
 * OAICreateProjectVersionRequest_OutputConfig.h
 *
 * 
 */

#ifndef OAICreateProjectVersionRequest_OutputConfig_H
#define OAICreateProjectVersionRequest_OutputConfig_H
...
class OAICreateProjectVersionRequest_OutputConfig : public OAIObject {
public:
    OAICreateProjectVersionRequest_OutputConfig();
    OAICreateProjectVersionRequest_OutputConfig(QString json);
    ~OAICreateProjectVersionRequest_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectVersionRequest_OutputConfig)

#endif // OAICreateProjectVersionRequest_OutputConfig_H
