...
#include "OAIComparedSourceImageFace.h"
...
OAIComparedSourceImageFace::OAIComparedSourceImageFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComparedSourceImageFace::OAIComparedSourceImageFace() {
    this->initializeModel();
}

OAIComparedSourceImageFace::~OAIComparedSourceImageFace() {}

void OAIComparedSourceImageFace::initializeModel() {
...
void OAIComparedSourceImageFace::fromJson(QString jsonString) {
...
void OAIComparedSourceImageFace::fromJsonObject(QJsonObject json) {
...
QString OAIComparedSourceImageFace::asJson() const {
...
QJsonObject OAIComparedSourceImageFace::asJsonObject() const {
    QJsonObject obj;
...
OAIComparedFace_BoundingBox OAIComparedSourceImageFace::getBoundingBox() const {
    return m_bounding_box;
}
void OAIComparedSourceImageFace::setBoundingBox(const OAIComparedFace_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIComparedSourceImageFace::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIComparedSourceImageFace::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

float OAIComparedSourceImageFace::getConfidence() const {
    return m_confidence;
}
void OAIComparedSourceImageFace::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIComparedSourceImageFace::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIComparedSourceImageFace::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIComparedSourceImageFace::isSet() const {
...
bool OAIComparedSourceImageFace::isValid() const {
