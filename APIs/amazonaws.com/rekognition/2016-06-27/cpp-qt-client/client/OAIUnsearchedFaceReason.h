...
/*
 * OAIUnsearchedFaceReason.h
 *
 * 
 */

#ifndef OAIUnsearchedFaceReason_H
#define OAIUnsearchedFaceReason_H
...
class OAIUnsearchedFaceReason : public OAIEnum {
public:
    OAIUnsearchedFaceReason();
    OAIUnsearchedFaceReason(QString json);
    ~OAIUnsearchedFaceReason() override;
    ...
    enum class eOAIUnsearchedFaceReason {
    ...
    OAIUnsearchedFaceReason::eOAIUnsearchedFaceReason getValue() const;
    void setValue(const OAIUnsearchedFaceReason::eOAIUnsearchedFaceReason& value);
...
private:
    ...
    eOAIUnsearchedFaceReason m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsearchedFaceReason)

#endif // OAIUnsearchedFaceReason_H
