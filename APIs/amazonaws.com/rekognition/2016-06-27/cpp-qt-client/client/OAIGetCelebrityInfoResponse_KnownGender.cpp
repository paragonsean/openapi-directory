...
OAIGetCelebrityInfoResponse_KnownGender::OAIGetCelebrityInfoResponse_KnownGender(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCelebrityInfoResponse_KnownGender::OAIGetCelebrityInfoResponse_KnownGender() {
    this->initializeModel();
}

OAIGetCelebrityInfoResponse_KnownGender::~OAIGetCelebrityInfoResponse_KnownGender() {}

void OAIGetCelebrityInfoResponse_KnownGender::initializeModel() {

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAIGetCelebrityInfoResponse_KnownGender::fromJson(QString jsonString) {
...
void OAIGetCelebrityInfoResponse_KnownGender::fromJsonObject(QJsonObject json) {

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("Type")]);
    m_type_isSet = !json[QString("Type")].isNull() && m_type_isValid;
}

QString OAIGetCelebrityInfoResponse_KnownGender::asJson() const {
...
QJsonObject OAIGetCelebrityInfoResponse_KnownGender::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIKnownGenderType OAIGetCelebrityInfoResponse_KnownGender::getType() const {
    return m_type;
}
void OAIGetCelebrityInfoResponse_KnownGender::setType(const OAIKnownGenderType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIGetCelebrityInfoResponse_KnownGender::is_type_Set() const{
    return m_type_isSet;
}

bool OAIGetCelebrityInfoResponse_KnownGender::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIGetCelebrityInfoResponse_KnownGender::isSet() const {
...
bool OAIGetCelebrityInfoResponse_KnownGender::isValid() const {
