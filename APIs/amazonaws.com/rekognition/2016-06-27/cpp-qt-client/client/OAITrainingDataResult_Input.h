...
/*
 * OAITrainingDataResult_Input.h
 *
 * 
 */

#ifndef OAITrainingDataResult_Input_H
#define OAITrainingDataResult_Input_H
...
class OAITrainingDataResult_Input : public OAIObject {
public:
    OAITrainingDataResult_Input();
    OAITrainingDataResult_Input(QString json);
    ~OAITrainingDataResult_Input() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingDataResult_Input)

#endif // OAITrainingDataResult_Input_H
