...
#include "OAIGetLabelDetectionResponse.h"
...
OAIGetLabelDetectionResponse::OAIGetLabelDetectionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLabelDetectionResponse::OAIGetLabelDetectionResponse() {
    this->initializeModel();
}

OAIGetLabelDetectionResponse::~OAIGetLabelDetectionResponse() {}

void OAIGetLabelDetectionResponse::initializeModel() {
    ...
    m_label_model_version_isSet = false;
    m_label_model_version_isValid = false;
    ...
    m_get_request_metadata_isSet = false;
    m_get_request_metadata_isValid = false;
}

void OAIGetLabelDetectionResponse::fromJson(QString jsonString) {
...
void OAIGetLabelDetectionResponse::fromJsonObject(QJsonObject json) {
    ...
    m_label_model_version_isValid = ::OpenAPI::fromJsonValue(m_label_model_version, json[QString("LabelModelVersion")]);
    m_label_model_version_isSet = !json[QString("LabelModelVersion")].isNull() && m_label_model_version_isValid;
    ...
    m_get_request_metadata_isValid = ::OpenAPI::fromJsonValue(m_get_request_metadata, json[QString("GetRequestMetadata")]);
    m_get_request_metadata_isSet = !json[QString("GetRequestMetadata")].isNull() && m_get_request_metadata_isValid;
}

QString OAIGetLabelDetectionResponse::asJson() const {
...
QJsonObject OAIGetLabelDetectionResponse::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_label_model_version_isSet) {
        obj.insert(QString("LabelModelVersion"), ::OpenAPI::toJsonValue(m_label_model_version));
    }
    if (m_job_id_isSet) {
    ...
    if (m_get_request_metadata.isSet()) {
        obj.insert(QString("GetRequestMetadata"), ::OpenAPI::toJsonValue(m_get_request_metadata));
    }
    return obj;
}

OAIVideoJobStatus OAIGetLabelDetectionResponse::getJobStatus() const {
    return m_job_status;
}
void OAIGetLabelDetectionResponse::setJobStatus(const OAIVideoJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIGetLabelDetectionResponse::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIGetLabelDetectionResponse::getStatusMessage() const {
    return m_status_message;
}
void OAIGetLabelDetectionResponse::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIGetLabelDetectionResponse::is_status_message_Valid() const{
    return m_status_message_isValid;
}

OAIGetFaceDetectionResponse_VideoMetadata OAIGetLabelDetectionResponse::getVideoMetadata() const {
    return m_video_metadata;
}
void OAIGetLabelDetectionResponse::setVideoMetadata(const OAIGetFaceDetectionResponse_VideoMetadata &video_metadata) {
    m_video_metadata = video_metadata;
    m_video_metadata_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_video_metadata_Set() const{
    return m_video_metadata_isSet;
}

bool OAIGetLabelDetectionResponse::is_video_metadata_Valid() const{
    return m_video_metadata_isValid;
}

QString OAIGetLabelDetectionResponse::getNextToken() const {
    return m_next_token;
}
void OAIGetLabelDetectionResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetLabelDetectionResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIGetLabelDetectionResponse::getLabels() const {
    return m_labels;
}
void OAIGetLabelDetectionResponse::setLabels(const QList &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIGetLabelDetectionResponse::is_labels_Valid() const{
    return m_labels_isValid;
}

QString OAIGetLabelDetectionResponse::getLabelModelVersion() const {
    return m_label_model_version;
}
void OAIGetLabelDetectionResponse::setLabelModelVersion(const QString &label_model_version) {
    m_label_model_version = label_model_version;
    m_label_model_version_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_label_model_version_Set() const{
    return m_label_model_version_isSet;
}

bool OAIGetLabelDetectionResponse::is_label_model_version_Valid() const{
    return m_label_model_version_isValid;
}

QString OAIGetLabelDetectionResponse::getJobId() const {
    return m_job_id;
}
void OAIGetLabelDetectionResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetLabelDetectionResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIVideo OAIGetLabelDetectionResponse::getVideo() const {
    return m_video;
}
void OAIGetLabelDetectionResponse::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_video_Set() const{
    return m_video_isSet;
}

bool OAIGetLabelDetectionResponse::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIGetLabelDetectionResponse::getJobTag() const {
    return m_job_tag;
}
void OAIGetLabelDetectionResponse::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIGetLabelDetectionResponse::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

OAIGetLabelDetectionResponse_GetRequestMetadata OAIGetLabelDetectionResponse::getGetRequestMetadata() const {
    return m_get_request_metadata;
}
void OAIGetLabelDetectionResponse::setGetRequestMetadata(const OAIGetLabelDetectionResponse_GetRequestMetadata &get_request_metadata) {
    m_get_request_metadata = get_request_metadata;
    m_get_request_metadata_isSet = true;
}

bool OAIGetLabelDetectionResponse::is_get_request_metadata_Set() const{
    return m_get_request_metadata_isSet;
}

bool OAIGetLabelDetectionResponse::is_get_request_metadata_Valid() const{
    return m_get_request_metadata_isValid;
}

bool OAIGetLabelDetectionResponse::isSet() const {
...
bool OAIGetLabelDetectionResponse::isValid() const {
