...
#include "OAIPutProjectPolicyRequest.h"
...
OAIPutProjectPolicyRequest::OAIPutProjectPolicyRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutProjectPolicyRequest::OAIPutProjectPolicyRequest() {
    this->initializeModel();
}

OAIPutProjectPolicyRequest::~OAIPutProjectPolicyRequest() {}

void OAIPutProjectPolicyRequest::initializeModel() {
...
void OAIPutProjectPolicyRequest::fromJson(QString jsonString) {
...
void OAIPutProjectPolicyRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPutProjectPolicyRequest::asJson() const {
...
QJsonObject OAIPutProjectPolicyRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutProjectPolicyRequest::getProjectArn() const {
    return m_project_arn;
}
void OAIPutProjectPolicyRequest::setProjectArn(const QString &project_arn) {
    m_project_arn = project_arn;
    m_project_arn_isSet = true;
}

bool OAIPutProjectPolicyRequest::is_project_arn_Set() const{
    return m_project_arn_isSet;
}

bool OAIPutProjectPolicyRequest::is_project_arn_Valid() const{
    return m_project_arn_isValid;
}

QString OAIPutProjectPolicyRequest::getPolicyName() const {
    return m_policy_name;
}
void OAIPutProjectPolicyRequest::setPolicyName(const QString &policy_name) {
    m_policy_name = policy_name;
    m_policy_name_isSet = true;
}

bool OAIPutProjectPolicyRequest::is_policy_name_Set() const{
    return m_policy_name_isSet;
}

bool OAIPutProjectPolicyRequest::is_policy_name_Valid() const{
    return m_policy_name_isValid;
}

QString OAIPutProjectPolicyRequest::getPolicyRevisionId() const {
    return m_policy_revision_id;
}
void OAIPutProjectPolicyRequest::setPolicyRevisionId(const QString &policy_revision_id) {
    m_policy_revision_id = policy_revision_id;
    m_policy_revision_id_isSet = true;
}

bool OAIPutProjectPolicyRequest::is_policy_revision_id_Set() const{
    return m_policy_revision_id_isSet;
}

bool OAIPutProjectPolicyRequest::is_policy_revision_id_Valid() const{
    return m_policy_revision_id_isValid;
}

QString OAIPutProjectPolicyRequest::getPolicyDocument() const {
    return m_policy_document;
}
void OAIPutProjectPolicyRequest::setPolicyDocument(const QString &policy_document) {
    m_policy_document = policy_document;
    m_policy_document_isSet = true;
}

bool OAIPutProjectPolicyRequest::is_policy_document_Set() const{
    return m_policy_document_isSet;
}

bool OAIPutProjectPolicyRequest::is_policy_document_Valid() const{
    return m_policy_document_isValid;
}

bool OAIPutProjectPolicyRequest::isSet() const {
...
bool OAIPutProjectPolicyRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_project_arn_isValid && m_policy_name_isValid && m_policy_document_isValid && true;
}
