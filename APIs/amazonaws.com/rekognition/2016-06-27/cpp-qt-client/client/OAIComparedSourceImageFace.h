...
/*
 * OAIComparedSourceImageFace.h
 *
 * Type that describes the face Amazon Rekognition chose to compare with the faces in the target. This contains a bounding box for the selected face and confidence level that the bounding box contains a face. Note that Amazon Rekognition selects the largest face in the source image for this comparison. 
 */

#ifndef OAIComparedSourceImageFace_H
#define OAIComparedSourceImageFace_H
...
class OAIComparedSourceImageFace : public OAIObject {
public:
    OAIComparedSourceImageFace();
    OAIComparedSourceImageFace(QString json);
    ~OAIComparedSourceImageFace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparedSourceImageFace)

#endif // OAIComparedSourceImageFace_H
