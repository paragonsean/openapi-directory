...
/*
 * OAIDetectLabelsSettings_ImageProperties.h
 *
 * 
 */

#ifndef OAIDetectLabelsSettings_ImageProperties_H
#define OAIDetectLabelsSettings_ImageProperties_H
...
class OAIDetectLabelsSettings_ImageProperties : public OAIObject {
public:
    OAIDetectLabelsSettings_ImageProperties();
    OAIDetectLabelsSettings_ImageProperties(QString json);
    ~OAIDetectLabelsSettings_ImageProperties() override;
    ...
    qint32 getMaxDominantColors() const;
    void setMaxDominantColors(const qint32 &max_dominant_colors);
    bool is_max_dominant_colors_Set() const;
    bool is_max_dominant_colors_Valid() const;
...
private:
    ...
    qint32 m_max_dominant_colors;
    bool m_max_dominant_colors_isSet;
    bool m_max_dominant_colors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsSettings_ImageProperties)

#endif // OAIDetectLabelsSettings_ImageProperties_H
