...
#include "OAIStreamProcessorSettings.h"
...
OAIStreamProcessorSettings::OAIStreamProcessorSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorSettings::OAIStreamProcessorSettings() {
    this->initializeModel();
}

OAIStreamProcessorSettings::~OAIStreamProcessorSettings() {}

void OAIStreamProcessorSettings::initializeModel() {
...
void OAIStreamProcessorSettings::fromJson(QString jsonString) {
...
void OAIStreamProcessorSettings::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessorSettings::asJson() const {
...
QJsonObject OAIStreamProcessorSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIStreamProcessorSettings_FaceSearch OAIStreamProcessorSettings::getFaceSearch() const {
    return m_face_search;
}
void OAIStreamProcessorSettings::setFaceSearch(const OAIStreamProcessorSettings_FaceSearch &face_search) {
    m_face_search = face_search;
    m_face_search_isSet = true;
}

bool OAIStreamProcessorSettings::is_face_search_Set() const{
    return m_face_search_isSet;
}

bool OAIStreamProcessorSettings::is_face_search_Valid() const{
    return m_face_search_isValid;
}

OAIConnectedHomeSettings OAIStreamProcessorSettings::getConnectedHome() const {
    return m_connected_home;
}
void OAIStreamProcessorSettings::setConnectedHome(const OAIConnectedHomeSettings &connected_home) {
    m_connected_home = connected_home;
    m_connected_home_isSet = true;
}

bool OAIStreamProcessorSettings::is_connected_home_Set() const{
    return m_connected_home_isSet;
}

bool OAIStreamProcessorSettings::is_connected_home_Valid() const{
    return m_connected_home_isValid;
}

bool OAIStreamProcessorSettings::isSet() const {
...
bool OAIStreamProcessorSettings::isValid() const {
