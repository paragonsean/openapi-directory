...
OAIFaceRecord::OAIFaceRecord(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceRecord::OAIFaceRecord() {
    this->initializeModel();
}

OAIFaceRecord::~OAIFaceRecord() {}

void OAIFaceRecord::initializeModel() {
...
void OAIFaceRecord::fromJson(QString jsonString) {
...
void OAIFaceRecord::fromJsonObject(QJsonObject json) {
...
QString OAIFaceRecord::asJson() const {
...
QJsonObject OAIFaceRecord::asJsonObject() const {
    QJsonObject obj;
    if (m_face.isSet()) {
...
OAIFaceRecord_Face OAIFaceRecord::getFace() const {
    return m_face;
}
void OAIFaceRecord::setFace(const OAIFaceRecord_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAIFaceRecord::is_face_Set() const{
    return m_face_isSet;
}

bool OAIFaceRecord::is_face_Valid() const{
    return m_face_isValid;
}

OAIFaceRecord_FaceDetail OAIFaceRecord::getFaceDetail() const {
    return m_face_detail;
}
void OAIFaceRecord::setFaceDetail(const OAIFaceRecord_FaceDetail &face_detail) {
    m_face_detail = face_detail;
    m_face_detail_isSet = true;
}

bool OAIFaceRecord::is_face_detail_Set() const{
    return m_face_detail_isSet;
}

bool OAIFaceRecord::is_face_detail_Valid() const{
    return m_face_detail_isValid;
}

bool OAIFaceRecord::isSet() const {
...
bool OAIFaceRecord::isValid() const {
