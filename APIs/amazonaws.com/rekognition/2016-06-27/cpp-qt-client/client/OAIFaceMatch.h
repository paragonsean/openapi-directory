...
#ifndef OAIFaceMatch_H
#define OAIFaceMatch_H

#include <QJsonObject>

#include "OAIFaceMatch_Face.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIFaceMatch_Face;

class OAIFaceMatch : public OAIObject {
public:
    OAIFaceMatch();
    OAIFaceMatch(QString json);
    ~OAIFaceMatch() override;
    ...
    OAIFaceMatch_Face getFace() const;
    void setFace(const OAIFaceMatch_Face &face);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceMatch)

#endif // OAIFaceMatch_H
