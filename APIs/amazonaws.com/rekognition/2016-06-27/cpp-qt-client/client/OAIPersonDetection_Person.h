...
/*
 * OAIPersonDetection_Person.h
 *
 * 
 */

#ifndef OAIPersonDetection_Person_H
#define OAIPersonDetection_Person_H
...
namespace OpenAPI {
class OAIPersonDetail_BoundingBox;
class OAIPersonDetail_Face;

class OAIPersonDetection_Person : public OAIObject {
public:
    OAIPersonDetection_Person();
    OAIPersonDetection_Person(QString json);
    ~OAIPersonDetection_Person() override;
    ...
    OAIPersonDetail_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAIPersonDetail_BoundingBox &bounding_box);
    bool is_bounding_box_Set() const;
    bool is_bounding_box_Valid() const;

    OAIPersonDetail_Face getFace() const;
    void setFace(const OAIPersonDetail_Face &face);
...
private:
    ...
    OAIPersonDetail_BoundingBox m_bounding_box;
    bool m_bounding_box_isSet;
    bool m_bounding_box_isValid;

    OAIPersonDetail_Face m_face;
    bool m_face_isSet;
    bool m_face_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonDetection_Person)

#endif // OAIPersonDetection_Person_H
