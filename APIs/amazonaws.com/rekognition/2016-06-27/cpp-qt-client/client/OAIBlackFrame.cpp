...
OAIBlackFrame::OAIBlackFrame(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIBlackFrame::OAIBlackFrame() {
    this->initializeModel();
}

OAIBlackFrame::~OAIBlackFrame() {}

void OAIBlackFrame::initializeModel() {

    m_max_pixel_threshold_isSet = false;
    m_max_pixel_threshold_isValid = false;

    m_min_coverage_percentage_isSet = false;
    m_min_coverage_percentage_isValid = false;
}

void OAIBlackFrame::fromJson(QString jsonString) {
...
void OAIBlackFrame::fromJsonObject(QJsonObject json) {

    m_max_pixel_threshold_isValid = ::OpenAPI::fromJsonValue(m_max_pixel_threshold, json[QString("MaxPixelThreshold")]);
    m_max_pixel_threshold_isSet = !json[QString("MaxPixelThreshold")].isNull() && m_max_pixel_threshold_isValid;

    m_min_coverage_percentage_isValid = ::OpenAPI::fromJsonValue(m_min_coverage_percentage, json[QString("MinCoveragePercentage")]);
    m_min_coverage_percentage_isSet = !json[QString("MinCoveragePercentage")].isNull() && m_min_coverage_percentage_isValid;
}

QString OAIBlackFrame::asJson() const {
...
QJsonObject OAIBlackFrame::asJsonObject() const {
    QJsonObject obj;
    if (m_max_pixel_threshold_isSet) {
        obj.insert(QString("MaxPixelThreshold"), ::OpenAPI::toJsonValue(m_max_pixel_threshold));
    }
    if (m_min_coverage_percentage_isSet) {
        obj.insert(QString("MinCoveragePercentage"), ::OpenAPI::toJsonValue(m_min_coverage_percentage));
    }
    return obj;
}

float OAIBlackFrame::getMaxPixelThreshold() const {
    return m_max_pixel_threshold;
}
void OAIBlackFrame::setMaxPixelThreshold(const float &max_pixel_threshold) {
    m_max_pixel_threshold = max_pixel_threshold;
    m_max_pixel_threshold_isSet = true;
}

bool OAIBlackFrame::is_max_pixel_threshold_Set() const{
    return m_max_pixel_threshold_isSet;
}

bool OAIBlackFrame::is_max_pixel_threshold_Valid() const{
    return m_max_pixel_threshold_isValid;
}

float OAIBlackFrame::getMinCoveragePercentage() const {
    return m_min_coverage_percentage;
}
void OAIBlackFrame::setMinCoveragePercentage(const float &min_coverage_percentage) {
    m_min_coverage_percentage = min_coverage_percentage;
    m_min_coverage_percentage_isSet = true;
}

bool OAIBlackFrame::is_min_coverage_percentage_Set() const{
    return m_min_coverage_percentage_isSet;
}

bool OAIBlackFrame::is_min_coverage_percentage_Valid() const{
    return m_min_coverage_percentage_isValid;
}

bool OAIBlackFrame::isSet() const {
...
bool OAIBlackFrame::isValid() const {
