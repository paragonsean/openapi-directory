...
#ifndef OAISearchedUser_H
#define OAISearchedUser_H
...
class OAISearchedUser : public OAIObject {
public:
    OAISearchedUser();
    OAISearchedUser(QString json);
    ~OAISearchedUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchedUser)

#endif // OAISearchedUser_H
