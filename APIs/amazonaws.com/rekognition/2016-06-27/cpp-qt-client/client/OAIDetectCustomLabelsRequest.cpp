...
#include "OAIDetectCustomLabelsRequest.h"
...
OAIDetectCustomLabelsRequest::OAIDetectCustomLabelsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectCustomLabelsRequest::OAIDetectCustomLabelsRequest() {
    this->initializeModel();
}

OAIDetectCustomLabelsRequest::~OAIDetectCustomLabelsRequest() {}

void OAIDetectCustomLabelsRequest::initializeModel() {
...
void OAIDetectCustomLabelsRequest::fromJson(QString jsonString) {
...
void OAIDetectCustomLabelsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDetectCustomLabelsRequest::asJson() const {
...
QJsonObject OAIDetectCustomLabelsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDetectCustomLabelsRequest::getProjectVersionArn() const {
    return m_project_version_arn;
}
void OAIDetectCustomLabelsRequest::setProjectVersionArn(const QString &project_version_arn) {
    m_project_version_arn = project_version_arn;
    m_project_version_arn_isSet = true;
}

bool OAIDetectCustomLabelsRequest::is_project_version_arn_Set() const{
    return m_project_version_arn_isSet;
}

bool OAIDetectCustomLabelsRequest::is_project_version_arn_Valid() const{
    return m_project_version_arn_isValid;
}

OAIImage OAIDetectCustomLabelsRequest::getImage() const {
    return m_image;
}
void OAIDetectCustomLabelsRequest::setImage(const OAIImage &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIDetectCustomLabelsRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIDetectCustomLabelsRequest::is_image_Valid() const{
    return m_image_isValid;
}

qint32 OAIDetectCustomLabelsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDetectCustomLabelsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDetectCustomLabelsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDetectCustomLabelsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

float OAIDetectCustomLabelsRequest::getMinConfidence() const {
    return m_min_confidence;
}
void OAIDetectCustomLabelsRequest::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIDetectCustomLabelsRequest::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIDetectCustomLabelsRequest::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

bool OAIDetectCustomLabelsRequest::isSet() const {
...
bool OAIDetectCustomLabelsRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_project_version_arn_isValid && m_image_isValid && true;
}
