...
/*
 * OAISearchUsersByImageResponse.h
 *
 * 
 */

#ifndef OAISearchUsersByImageResponse_H
#define OAISearchUsersByImageResponse_H

#include <QJsonObject>

#include "OAISearchUsersByImageResponse_SearchedFace.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAISearchUsersByImageResponse_SearchedFace;

class OAISearchUsersByImageResponse : public OAIObject {
public:
    OAISearchUsersByImageResponse();
    OAISearchUsersByImageResponse(QString json);
    ~OAISearchUsersByImageResponse() override;
    ...
    QList getUserMatches() const;
    void setUserMatches(const QList &user_matches);
    bool is_user_matches_Set() const;
    bool is_user_matches_Valid() const;
    ...
    OAISearchUsersByImageResponse_SearchedFace getSearchedFace() const;
    void setSearchedFace(const OAISearchUsersByImageResponse_SearchedFace &searched_face);
    bool is_searched_face_Set() const;
    bool is_searched_face_Valid() const;

    QList getUnsearchedFaces() const;
    void setUnsearchedFaces(const QList &unsearched_faces);
    bool is_unsearched_faces_Set() const;
    bool is_unsearched_faces_Valid() const;
...
private:
    ...
    QList m_user_matches;
    bool m_user_matches_isSet;
    bool m_user_matches_isValid;

    QString m_face_model_version;
    bool m_face_model_version_isSet;
    bool m_face_model_version_isValid;

    OAISearchUsersByImageResponse_SearchedFace m_searched_face;
    bool m_searched_face_isSet;
    bool m_searched_face_isValid;

    QList m_unsearched_faces;
    bool m_unsearched_faces_isSet;
    bool m_unsearched_faces_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISearchUsersByImageResponse)

#endif // OAISearchUsersByImageResponse_H
