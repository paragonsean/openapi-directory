...
OAIGetFaceDetectionResponse_VideoMetadata::OAIGetFaceDetectionResponse_VideoMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFaceDetectionResponse_VideoMetadata::OAIGetFaceDetectionResponse_VideoMetadata() {
    this->initializeModel();
}

OAIGetFaceDetectionResponse_VideoMetadata::~OAIGetFaceDetectionResponse_VideoMetadata() {}

void OAIGetFaceDetectionResponse_VideoMetadata::initializeModel() {
...
void OAIGetFaceDetectionResponse_VideoMetadata::fromJson(QString jsonString) {
...
void OAIGetFaceDetectionResponse_VideoMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetFaceDetectionResponse_VideoMetadata::asJson() const {
...
QJsonObject OAIGetFaceDetectionResponse_VideoMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_codec_isSet) {
...
QString OAIGetFaceDetectionResponse_VideoMetadata::getCodec() const {
    return m_codec;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIGetFaceDetectionResponse_VideoMetadata::getDurationMillis() const {
    return m_duration_millis;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setDurationMillis(const qint32 &duration_millis) {
    m_duration_millis = duration_millis;
    m_duration_millis_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_duration_millis_Set() const{
    return m_duration_millis_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_duration_millis_Valid() const{
    return m_duration_millis_isValid;
}

QString OAIGetFaceDetectionResponse_VideoMetadata::getFormat() const {
    return m_format;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_format_Set() const{
    return m_format_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_format_Valid() const{
    return m_format_isValid;
}

float OAIGetFaceDetectionResponse_VideoMetadata::getFrameRate() const {
    return m_frame_rate;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setFrameRate(const float &frame_rate) {
    m_frame_rate = frame_rate;
    m_frame_rate_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_frame_rate_Set() const{
    return m_frame_rate_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_frame_rate_Valid() const{
    return m_frame_rate_isValid;
}

qint32 OAIGetFaceDetectionResponse_VideoMetadata::getFrameHeight() const {
    return m_frame_height;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setFrameHeight(const qint32 &frame_height) {
    m_frame_height = frame_height;
    m_frame_height_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_frame_height_Set() const{
    return m_frame_height_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_frame_height_Valid() const{
    return m_frame_height_isValid;
}

qint32 OAIGetFaceDetectionResponse_VideoMetadata::getFrameWidth() const {
    return m_frame_width;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setFrameWidth(const qint32 &frame_width) {
    m_frame_width = frame_width;
    m_frame_width_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_frame_width_Set() const{
    return m_frame_width_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_frame_width_Valid() const{
    return m_frame_width_isValid;
}

OAIVideoColorRange OAIGetFaceDetectionResponse_VideoMetadata::getColorRange() const {
    return m_color_range;
}
void OAIGetFaceDetectionResponse_VideoMetadata::setColorRange(const OAIVideoColorRange &color_range) {
    m_color_range = color_range;
    m_color_range_isSet = true;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_color_range_Set() const{
    return m_color_range_isSet;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::is_color_range_Valid() const{
    return m_color_range_isValid;
}

bool OAIGetFaceDetectionResponse_VideoMetadata::isSet() const {
...
bool OAIGetFaceDetectionResponse_VideoMetadata::isValid() const {
