...
#ifndef OAIAuditImage_H
#define OAIAuditImage_H
...
class OAIAuditImage : public OAIObject {
public:
    OAIAuditImage();
    OAIAuditImage(QString json);
    ~OAIAuditImage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuditImage)

#endif // OAIAuditImage_H
