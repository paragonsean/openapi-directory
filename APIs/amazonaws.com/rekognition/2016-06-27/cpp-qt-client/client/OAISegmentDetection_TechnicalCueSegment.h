...
/*
 * OAISegmentDetection_TechnicalCueSegment.h
 *
 * 
 */

#ifndef OAISegmentDetection_TechnicalCueSegment_H
#define OAISegmentDetection_TechnicalCueSegment_H
...
class OAISegmentDetection_TechnicalCueSegment : public OAIObject {
public:
    OAISegmentDetection_TechnicalCueSegment();
    OAISegmentDetection_TechnicalCueSegment(QString json);
    ~OAISegmentDetection_TechnicalCueSegment() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISegmentDetection_TechnicalCueSegment)

#endif // OAISegmentDetection_TechnicalCueSegment_H
