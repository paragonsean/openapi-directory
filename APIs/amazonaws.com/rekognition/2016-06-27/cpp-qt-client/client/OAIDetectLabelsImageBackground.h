...
/*
 * OAIDetectLabelsImageBackground.h
 *
 * The background of the image with regard to image quality and dominant colors.
 */

#ifndef OAIDetectLabelsImageBackground_H
#define OAIDetectLabelsImageBackground_H
...
class OAIDetectLabelsImageBackground : public OAIObject {
public:
    OAIDetectLabelsImageBackground();
    OAIDetectLabelsImageBackground(QString json);
    ~OAIDetectLabelsImageBackground() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageBackground)

#endif // OAIDetectLabelsImageBackground_H
