...
#include "OAIDistributeDatasetEntriesRequest.h"
...
OAIDistributeDatasetEntriesRequest::OAIDistributeDatasetEntriesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDistributeDatasetEntriesRequest::OAIDistributeDatasetEntriesRequest() {
    this->initializeModel();
}

OAIDistributeDatasetEntriesRequest::~OAIDistributeDatasetEntriesRequest() {}

void OAIDistributeDatasetEntriesRequest::initializeModel() {

    m_datasets_isSet = false;
    m_datasets_isValid = false;
}

void OAIDistributeDatasetEntriesRequest::fromJson(QString jsonString) {
...
void OAIDistributeDatasetEntriesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDistributeDatasetEntriesRequest::asJson() const {
...
QJsonObject OAIDistributeDatasetEntriesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_datasets.isSet()) {
...
QList OAIDistributeDatasetEntriesRequest::getDatasets() const {
    return m_datasets;
}
void OAIDistributeDatasetEntriesRequest::setDatasets(const QList &datasets) {
    m_datasets = datasets;
    m_datasets_isSet = true;
}

bool OAIDistributeDatasetEntriesRequest::is_datasets_Set() const{
    return m_datasets_isSet;
}

bool OAIDistributeDatasetEntriesRequest::is_datasets_Valid() const{
    return m_datasets_isValid;
}

bool OAIDistributeDatasetEntriesRequest::isSet() const {
...
bool OAIDistributeDatasetEntriesRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_datasets_isValid && true;
}
