...
#ifndef OAIFaceRecord_H
#define OAIFaceRecord_H

#include <QJsonObject>

#include "OAIFaceRecord_Face.h"
#include "OAIFaceRecord_FaceDetail.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIFaceRecord_Face;
class OAIFaceRecord_FaceDetail;

class OAIFaceRecord : public OAIObject {
public:
    OAIFaceRecord();
    OAIFaceRecord(QString json);
    ~OAIFaceRecord() override;
    ...
    OAIFaceRecord_Face getFace() const;
    void setFace(const OAIFaceRecord_Face &face);
    bool is_face_Set() const;
    bool is_face_Valid() const;

    OAIFaceRecord_FaceDetail getFaceDetail() const;
    void setFaceDetail(const OAIFaceRecord_FaceDetail &face_detail);
    bool is_face_detail_Set() const;
    bool is_face_detail_Valid() const;
...
private:
    ...
    OAIFaceRecord_Face m_face;
    bool m_face_isSet;
    bool m_face_isValid;

    OAIFaceRecord_FaceDetail m_face_detail;
    bool m_face_detail_isSet;
    bool m_face_detail_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIFaceRecord)

#endif // OAIFaceRecord_H
