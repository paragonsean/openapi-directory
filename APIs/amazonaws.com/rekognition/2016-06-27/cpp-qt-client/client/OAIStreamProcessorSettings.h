...
#ifndef OAIStreamProcessorSettings_H
#define OAIStreamProcessorSettings_H

#include <QJsonObject>

#include "OAIConnectedHomeSettings.h"
#include "OAIStreamProcessorSettings_FaceSearch.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStreamProcessorSettings_FaceSearch;
class OAIConnectedHomeSettings;

class OAIStreamProcessorSettings : public OAIObject {
public:
    OAIStreamProcessorSettings();
    OAIStreamProcessorSettings(QString json);
    ~OAIStreamProcessorSettings() override;
    ...
    OAIStreamProcessorSettings_FaceSearch getFaceSearch() const;
    void setFaceSearch(const OAIStreamProcessorSettings_FaceSearch &face_search);
    bool is_face_search_Set() const;
    bool is_face_search_Valid() const;

    OAIConnectedHomeSettings getConnectedHome() const;
    void setConnectedHome(const OAIConnectedHomeSettings &connected_home);
    bool is_connected_home_Set() const;
    bool is_connected_home_Valid() const;
...
private:
    ...
    OAIStreamProcessorSettings_FaceSearch m_face_search;
    bool m_face_search_isSet;
    bool m_face_search_isValid;

    OAIConnectedHomeSettings m_connected_home;
    bool m_connected_home_isSet;
    bool m_connected_home_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorSettings)

#endif // OAIStreamProcessorSettings_H
