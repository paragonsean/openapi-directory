...
/*
 * OAIComparedFace_Pose.h
 *
 * 
 */

#ifndef OAIComparedFace_Pose_H
#define OAIComparedFace_Pose_H
...
class OAIComparedFace_Pose : public OAIObject {
public:
    OAIComparedFace_Pose();
    OAIComparedFace_Pose(QString json);
    ~OAIComparedFace_Pose() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIComparedFace_Pose)

#endif // OAIComparedFace_Pose_H
