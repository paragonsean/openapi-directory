...
#include "OAIIndexFacesRequest_Image.h"
...
OAIIndexFacesRequest_Image::OAIIndexFacesRequest_Image(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIIndexFacesRequest_Image::OAIIndexFacesRequest_Image() {
    this->initializeModel();
}

OAIIndexFacesRequest_Image::~OAIIndexFacesRequest_Image() {}

void OAIIndexFacesRequest_Image::initializeModel() {
...
void OAIIndexFacesRequest_Image::fromJson(QString jsonString) {
...
void OAIIndexFacesRequest_Image::fromJsonObject(QJsonObject json) {
...
QString OAIIndexFacesRequest_Image::asJson() const {
...
QJsonObject OAIIndexFacesRequest_Image::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAIIndexFacesRequest_Image::getBytes() const {
    return m_bytes;
}
void OAIIndexFacesRequest_Image::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIIndexFacesRequest_Image::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIIndexFacesRequest_Image::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAIIndexFacesRequest_Image::getS3Object() const {
    return m_s3_object;
}
void OAIIndexFacesRequest_Image::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIIndexFacesRequest_Image::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIIndexFacesRequest_Image::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIIndexFacesRequest_Image::isSet() const {
...
bool OAIIndexFacesRequest_Image::isValid() const {
