...
/*
 * OAIFaceDetail_Eyeglasses.h
 *
 * 
 */

#ifndef OAIFaceDetail_Eyeglasses_H
#define OAIFaceDetail_Eyeglasses_H
...
class OAIFaceDetail_Eyeglasses : public OAIObject {
public:
    OAIFaceDetail_Eyeglasses();
    OAIFaceDetail_Eyeglasses(QString json);
    ~OAIFaceDetail_Eyeglasses() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Eyeglasses)

#endif // OAIFaceDetail_Eyeglasses_H
