...
#include "OAICopyProjectVersionResponse.h"
...
OAICopyProjectVersionResponse::OAICopyProjectVersionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyProjectVersionResponse::OAICopyProjectVersionResponse() {
    this->initializeModel();
}

OAICopyProjectVersionResponse::~OAICopyProjectVersionResponse() {}

void OAICopyProjectVersionResponse::initializeModel() {

    m_project_version_arn_isSet = false;
    m_project_version_arn_isValid = false;
}

void OAICopyProjectVersionResponse::fromJson(QString jsonString) {
...
void OAICopyProjectVersionResponse::fromJsonObject(QJsonObject json) {
...
QString OAICopyProjectVersionResponse::asJson() const {
...
QJsonObject OAICopyProjectVersionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopyProjectVersionResponse::getProjectVersionArn() const {
    return m_project_version_arn;
}
void OAICopyProjectVersionResponse::setProjectVersionArn(const QString &project_version_arn) {
    m_project_version_arn = project_version_arn;
    m_project_version_arn_isSet = true;
}

bool OAICopyProjectVersionResponse::is_project_version_arn_Set() const{
    return m_project_version_arn_isSet;
}

bool OAICopyProjectVersionResponse::is_project_version_arn_Valid() const{
    return m_project_version_arn_isValid;
}

bool OAICopyProjectVersionResponse::isSet() const {
...
bool OAICopyProjectVersionResponse::isValid() const {
