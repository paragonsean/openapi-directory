...
OAILabelDetection::OAILabelDetection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelDetection::OAILabelDetection() {
    this->initializeModel();
}

OAILabelDetection::~OAILabelDetection() {}

void OAILabelDetection::initializeModel() {
    ...
    m_start_timestamp_millis_isSet = false;
    m_start_timestamp_millis_isValid = false;

    m_end_timestamp_millis_isSet = false;
    m_end_timestamp_millis_isValid = false;

    m_duration_millis_isSet = false;
    m_duration_millis_isValid = false;
}

void OAILabelDetection::fromJson(QString jsonString) {
...
void OAILabelDetection::fromJsonObject(QJsonObject json) {
    ...
    m_start_timestamp_millis_isValid = ::OpenAPI::fromJsonValue(m_start_timestamp_millis, json[QString("StartTimestampMillis")]);
    m_start_timestamp_millis_isSet = !json[QString("StartTimestampMillis")].isNull() && m_start_timestamp_millis_isValid;

    m_end_timestamp_millis_isValid = ::OpenAPI::fromJsonValue(m_end_timestamp_millis, json[QString("EndTimestampMillis")]);
    m_end_timestamp_millis_isSet = !json[QString("EndTimestampMillis")].isNull() && m_end_timestamp_millis_isValid;
...
QString OAILabelDetection::asJson() const {
...
QJsonObject OAILabelDetection::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_start_timestamp_millis_isSet) {
        obj.insert(QString("StartTimestampMillis"), ::OpenAPI::toJsonValue(m_start_timestamp_millis));
    }
    if (m_end_timestamp_millis_isSet) {
        obj.insert(QString("EndTimestampMillis"), ::OpenAPI::toJsonValue(m_end_timestamp_millis));
    }
...
qint32 OAILabelDetection::getTimestamp() const {
    return m_timestamp;
}
void OAILabelDetection::setTimestamp(const qint32 &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAILabelDetection::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAILabelDetection::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAILabelDetection_Label OAILabelDetection::getLabel() const {
    return m_label;
}
void OAILabelDetection::setLabel(const OAILabelDetection_Label &label) {
    m_label = label;
    m_label_isSet = true;
}

bool OAILabelDetection::is_label_Set() const{
    return m_label_isSet;
}

bool OAILabelDetection::is_label_Valid() const{
    return m_label_isValid;
}

qint32 OAILabelDetection::getStartTimestampMillis() const {
    return m_start_timestamp_millis;
}
void OAILabelDetection::setStartTimestampMillis(const qint32 &start_timestamp_millis) {
    m_start_timestamp_millis = start_timestamp_millis;
    m_start_timestamp_millis_isSet = true;
}

bool OAILabelDetection::is_start_timestamp_millis_Set() const{
    return m_start_timestamp_millis_isSet;
}

bool OAILabelDetection::is_start_timestamp_millis_Valid() const{
    return m_start_timestamp_millis_isValid;
}

qint32 OAILabelDetection::getEndTimestampMillis() const {
    return m_end_timestamp_millis;
}
void OAILabelDetection::setEndTimestampMillis(const qint32 &end_timestamp_millis) {
    m_end_timestamp_millis = end_timestamp_millis;
    m_end_timestamp_millis_isSet = true;
}

bool OAILabelDetection::is_end_timestamp_millis_Set() const{
    return m_end_timestamp_millis_isSet;
}

bool OAILabelDetection::is_end_timestamp_millis_Valid() const{
    return m_end_timestamp_millis_isValid;
}

qint32 OAILabelDetection::getDurationMillis() const {
    return m_duration_millis;
}
void OAILabelDetection::setDurationMillis(const qint32 &duration_millis) {
    m_duration_millis = duration_millis;
    m_duration_millis_isSet = true;
}

bool OAILabelDetection::is_duration_millis_Set() const{
    return m_duration_millis_isSet;
}

bool OAILabelDetection::is_duration_millis_Valid() const{
    return m_duration_millis_isValid;
}

bool OAILabelDetection::isSet() const {
...
bool OAILabelDetection::isValid() const {
