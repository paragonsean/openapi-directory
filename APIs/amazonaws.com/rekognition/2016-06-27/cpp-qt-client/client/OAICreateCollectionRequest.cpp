...
QString OAICreateCollectionRequest::getCollectionId() const {
    return m_collection_id;
}
void OAICreateCollectionRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAICreateCollectionRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAICreateCollectionRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QMap OAICreateCollectionRequest::getTags() const {
    return m_tags;
}
void OAICreateCollectionRequest::setTags(const QMap &tags) {
    m_tags = tags;
    m_tags_isSet = true;
}
