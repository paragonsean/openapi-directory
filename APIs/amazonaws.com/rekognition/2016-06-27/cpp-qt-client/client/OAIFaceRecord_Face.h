...
/*
 * OAIFaceRecord_Face.h
 *
 * 
 */

#ifndef OAIFaceRecord_Face_H
#define OAIFaceRecord_Face_H

#include <QJsonObject>

#include "OAIComparedFace_BoundingBox.h"
#include <QString>
...
namespace OpenAPI {
class OAIComparedFace_BoundingBox;

class OAIFaceRecord_Face : public OAIObject {
public:
    OAIFaceRecord_Face();
    OAIFaceRecord_Face(QString json);
    ~OAIFaceRecord_Face() override;
    ...
    OAIComparedFace_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAIComparedFace_BoundingBox &bounding_box);
    ...
    QString getExternalImageId() const;
    void setExternalImageId(const QString &external_image_id);
    bool is_external_image_id_Set() const;
    bool is_external_image_id_Valid() const;
    ...
    QString getIndexFacesModelVersion() const;
    void setIndexFacesModelVersion(const QString &index_faces_model_version);
    bool is_index_faces_model_version_Set() const;
    bool is_index_faces_model_version_Valid() const;
...
private:
    ...
    OAIComparedFace_BoundingBox m_bounding_box;
    ...
    QString m_external_image_id;
    bool m_external_image_id_isSet;
    bool m_external_image_id_isValid;

    float m_confidence;
    bool m_confidence_isSet;
    bool m_confidence_isValid;

    QString m_index_faces_model_version;
    bool m_index_faces_model_version_isSet;
    bool m_index_faces_model_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceRecord_Face)

#endif // OAIFaceRecord_Face_H
