...
#ifndef OAIFaceSearchSettings_H
#define OAIFaceSearchSettings_H
...
class OAIFaceSearchSettings : public OAIObject {
public:
    OAIFaceSearchSettings();
    OAIFaceSearchSettings(QString json);
    ~OAIFaceSearchSettings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceSearchSettings)

#endif // OAIFaceSearchSettings_H
