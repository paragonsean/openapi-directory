...
OAIS3Object OAISummary::getS3Object() const {
    return m_s3_object;
}
void OAISummary::setS3Object(const OAIS3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAISummary::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAISummary::is_s3_object_Valid() const{
