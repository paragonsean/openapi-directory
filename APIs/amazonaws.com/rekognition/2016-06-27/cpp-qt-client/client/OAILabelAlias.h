...
#ifndef OAILabelAlias_H
#define OAILabelAlias_H
...
class OAILabelAlias : public OAIObject {
public:
    OAILabelAlias();
    OAILabelAlias(QString json);
    ~OAILabelAlias() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelAlias)

#endif // OAILabelAlias_H
