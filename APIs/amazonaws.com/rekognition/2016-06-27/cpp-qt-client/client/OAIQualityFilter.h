...
#ifndef OAIQualityFilter_H
#define OAIQualityFilter_H
...
class OAIQualityFilter : public OAIEnum {
public:
    OAIQualityFilter();
    OAIQualityFilter(QString json);
    ~OAIQualityFilter() override;
    ...
    OAIQualityFilter::eOAIQualityFilter getValue() const;
    void setValue(const OAIQualityFilter::eOAIQualityFilter& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIQualityFilter)

#endif // OAIQualityFilter_H
