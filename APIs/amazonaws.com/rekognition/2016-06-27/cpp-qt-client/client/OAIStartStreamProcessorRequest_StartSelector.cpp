...
OAIStartStreamProcessorRequest_StartSelector::OAIStartStreamProcessorRequest_StartSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartStreamProcessorRequest_StartSelector::OAIStartStreamProcessorRequest_StartSelector() {
    this->initializeModel();
}

OAIStartStreamProcessorRequest_StartSelector::~OAIStartStreamProcessorRequest_StartSelector() {}

void OAIStartStreamProcessorRequest_StartSelector::initializeModel() {

    m_kvs_stream_start_selector_isSet = false;
    m_kvs_stream_start_selector_isValid = false;
}

void OAIStartStreamProcessorRequest_StartSelector::fromJson(QString jsonString) {
...
void OAIStartStreamProcessorRequest_StartSelector::fromJsonObject(QJsonObject json) {
...
QString OAIStartStreamProcessorRequest_StartSelector::asJson() const {
...
QJsonObject OAIStartStreamProcessorRequest_StartSelector::asJsonObject() const {
    QJsonObject obj;
...
OAIStreamProcessingStartSelector_KVSStreamStartSelector OAIStartStreamProcessorRequest_StartSelector::getKvsStreamStartSelector() const {
    return m_kvs_stream_start_selector;
}
void OAIStartStreamProcessorRequest_StartSelector::setKvsStreamStartSelector(const OAIStreamProcessingStartSelector_KVSStreamStartSelector &kvs_stream_start_selector) {
    m_kvs_stream_start_selector = kvs_stream_start_selector;
    m_kvs_stream_start_selector_isSet = true;
}

bool OAIStartStreamProcessorRequest_StartSelector::is_kvs_stream_start_selector_Set() const{
    return m_kvs_stream_start_selector_isSet;
}

bool OAIStartStreamProcessorRequest_StartSelector::is_kvs_stream_start_selector_Valid() const{
    return m_kvs_stream_start_selector_isValid;
}

bool OAIStartStreamProcessorRequest_StartSelector::isSet() const {
...
bool OAIStartStreamProcessorRequest_StartSelector::isValid() const {
