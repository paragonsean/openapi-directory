...
#include "OAIDetectFacesResponse.h"
...
OAIDetectFacesResponse::OAIDetectFacesResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectFacesResponse::OAIDetectFacesResponse() {
    this->initializeModel();
}

OAIDetectFacesResponse::~OAIDetectFacesResponse() {}

void OAIDetectFacesResponse::initializeModel() {

    m_face_details_isSet = false;
    m_face_details_isValid = false;

    m_orientation_correction_isSet = false;
    m_orientation_correction_isValid = false;
}

void OAIDetectFacesResponse::fromJson(QString jsonString) {
...
void OAIDetectFacesResponse::fromJsonObject(QJsonObject json) {

    m_face_details_isValid = ::OpenAPI::fromJsonValue(m_face_details, json[QString("FaceDetails")]);
    m_face_details_isSet = !json[QString("FaceDetails")].isNull() && m_face_details_isValid;

    m_orientation_correction_isValid = ::OpenAPI::fromJsonValue(m_orientation_correction, json[QString("OrientationCorrection")]);
    m_orientation_correction_isSet = !json[QString("OrientationCorrection")].isNull() && m_orientation_correction_isValid;
}

QString OAIDetectFacesResponse::asJson() const {
...
QJsonObject OAIDetectFacesResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_face_details.isSet()) {
        obj.insert(QString("FaceDetails"), ::OpenAPI::toJsonValue(m_face_details));
    }
    if (m_orientation_correction.isSet()) {
        obj.insert(QString("OrientationCorrection"), ::OpenAPI::toJsonValue(m_orientation_correction));
    }
    return obj;
}

QList OAIDetectFacesResponse::getFaceDetails() const {
    return m_face_details;
}
void OAIDetectFacesResponse::setFaceDetails(const QList &face_details) {
    m_face_details = face_details;
    m_face_details_isSet = true;
}

bool OAIDetectFacesResponse::is_face_details_Set() const{
    return m_face_details_isSet;
}

bool OAIDetectFacesResponse::is_face_details_Valid() const{
    return m_face_details_isValid;
}

OAIOrientationCorrection OAIDetectFacesResponse::getOrientationCorrection() const {
    return m_orientation_correction;
}
void OAIDetectFacesResponse::setOrientationCorrection(const OAIOrientationCorrection &orientation_correction) {
    m_orientation_correction = orientation_correction;
    m_orientation_correction_isSet = true;
}

bool OAIDetectFacesResponse::is_orientation_correction_Set() const{
    return m_orientation_correction_isSet;
}

bool OAIDetectFacesResponse::is_orientation_correction_Valid() const{
    return m_orientation_correction_isValid;
}

bool OAIDetectFacesResponse::isSet() const {
...
bool OAIDetectFacesResponse::isValid() const {
