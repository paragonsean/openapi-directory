...
OAIValidationData::OAIValidationData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIValidationData::OAIValidationData() {
    this->initializeModel();
}

OAIValidationData::~OAIValidationData() {}

void OAIValidationData::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAIValidationData::fromJson(QString jsonString) {
...
void OAIValidationData::fromJsonObject(QJsonObject json) {
...
QString OAIValidationData::asJson() const {
...
QJsonObject OAIValidationData::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAIValidationData::getAssets() const {
    return m_assets;
}
void OAIValidationData::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAIValidationData::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAIValidationData::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAIValidationData::isSet() const {
...
bool OAIValidationData::isValid() const {
