...
/*
 * OAIDescribeStreamProcessorResponse_Output.h
 *
 * 
 */

#ifndef OAIDescribeStreamProcessorResponse_Output_H
#define OAIDescribeStreamProcessorResponse_Output_H

#include <QJsonObject>

#include "OAIStreamProcessorOutput_KinesisDataStream.h"
#include "OAIStreamProcessorOutput_S3Destination.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStreamProcessorOutput_KinesisDataStream;
class OAIStreamProcessorOutput_S3Destination;

class OAIDescribeStreamProcessorResponse_Output : public OAIObject {
public:
    OAIDescribeStreamProcessorResponse_Output();
    OAIDescribeStreamProcessorResponse_Output(QString json);
    ~OAIDescribeStreamProcessorResponse_Output() override;
    ...
    OAIStreamProcessorOutput_KinesisDataStream getKinesisDataStream() const;
    void setKinesisDataStream(const OAIStreamProcessorOutput_KinesisDataStream &kinesis_data_stream);
    bool is_kinesis_data_stream_Set() const;
    bool is_kinesis_data_stream_Valid() const;

    OAIStreamProcessorOutput_S3Destination getS3Destination() const;
    void setS3Destination(const OAIStreamProcessorOutput_S3Destination &s3_destination);
...
private:
    ...
    OAIStreamProcessorOutput_KinesisDataStream m_kinesis_data_stream;
    bool m_kinesis_data_stream_isSet;
    bool m_kinesis_data_stream_isValid;

    OAIStreamProcessorOutput_S3Destination m_s3_destination;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeStreamProcessorResponse_Output)

#endif // OAIDescribeStreamProcessorResponse_Output_H
