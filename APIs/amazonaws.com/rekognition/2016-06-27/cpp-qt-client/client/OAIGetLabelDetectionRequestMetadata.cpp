...
#include "OAIGetLabelDetectionRequestMetadata.h"
...
OAIGetLabelDetectionRequestMetadata::OAIGetLabelDetectionRequestMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLabelDetectionRequestMetadata::OAIGetLabelDetectionRequestMetadata() {
    this->initializeModel();
}

OAIGetLabelDetectionRequestMetadata::~OAIGetLabelDetectionRequestMetadata() {}

void OAIGetLabelDetectionRequestMetadata::initializeModel() {
...
void OAIGetLabelDetectionRequestMetadata::fromJson(QString jsonString) {
...
void OAIGetLabelDetectionRequestMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetLabelDetectionRequestMetadata::asJson() const {
...
QJsonObject OAIGetLabelDetectionRequestMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_sort_by.isSet()) {
...
OAILabelDetectionSortBy OAIGetLabelDetectionRequestMetadata::getSortBy() const {
    return m_sort_by;
}
void OAIGetLabelDetectionRequestMetadata::setSortBy(const OAILabelDetectionSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetLabelDetectionRequestMetadata::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetLabelDetectionRequestMetadata::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAILabelDetectionAggregateBy OAIGetLabelDetectionRequestMetadata::getAggregateBy() const {
    return m_aggregate_by;
}
void OAIGetLabelDetectionRequestMetadata::setAggregateBy(const OAILabelDetectionAggregateBy &aggregate_by) {
    m_aggregate_by = aggregate_by;
    m_aggregate_by_isSet = true;
}

bool OAIGetLabelDetectionRequestMetadata::is_aggregate_by_Set() const{
    return m_aggregate_by_isSet;
}

bool OAIGetLabelDetectionRequestMetadata::is_aggregate_by_Valid() const{
    return m_aggregate_by_isValid;
}

bool OAIGetLabelDetectionRequestMetadata::isSet() const {
...
bool OAIGetLabelDetectionRequestMetadata::isValid() const {
