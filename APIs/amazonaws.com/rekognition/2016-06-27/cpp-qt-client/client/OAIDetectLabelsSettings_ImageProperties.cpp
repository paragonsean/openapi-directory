...
#include "OAIDetectLabelsSettings_ImageProperties.h"
...
OAIDetectLabelsSettings_ImageProperties::OAIDetectLabelsSettings_ImageProperties(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsSettings_ImageProperties::OAIDetectLabelsSettings_ImageProperties() {
    this->initializeModel();
}

OAIDetectLabelsSettings_ImageProperties::~OAIDetectLabelsSettings_ImageProperties() {}

void OAIDetectLabelsSettings_ImageProperties::initializeModel() {

    m_max_dominant_colors_isSet = false;
    m_max_dominant_colors_isValid = false;
}

void OAIDetectLabelsSettings_ImageProperties::fromJson(QString jsonString) {
...
void OAIDetectLabelsSettings_ImageProperties::fromJsonObject(QJsonObject json) {

    m_max_dominant_colors_isValid = ::OpenAPI::fromJsonValue(m_max_dominant_colors, json[QString("MaxDominantColors")]);
    m_max_dominant_colors_isSet = !json[QString("MaxDominantColors")].isNull() && m_max_dominant_colors_isValid;
}

QString OAIDetectLabelsSettings_ImageProperties::asJson() const {
...
QJsonObject OAIDetectLabelsSettings_ImageProperties::asJsonObject() const {
    QJsonObject obj;
    if (m_max_dominant_colors_isSet) {
        obj.insert(QString("MaxDominantColors"), ::OpenAPI::toJsonValue(m_max_dominant_colors));
    }
    return obj;
}

qint32 OAIDetectLabelsSettings_ImageProperties::getMaxDominantColors() const {
    return m_max_dominant_colors;
}
void OAIDetectLabelsSettings_ImageProperties::setMaxDominantColors(const qint32 &max_dominant_colors) {
    m_max_dominant_colors = max_dominant_colors;
    m_max_dominant_colors_isSet = true;
}

bool OAIDetectLabelsSettings_ImageProperties::is_max_dominant_colors_Set() const{
    return m_max_dominant_colors_isSet;
}

bool OAIDetectLabelsSettings_ImageProperties::is_max_dominant_colors_Valid() const{
    return m_max_dominant_colors_isValid;
}

bool OAIDetectLabelsSettings_ImageProperties::isSet() const {
...
bool OAIDetectLabelsSettings_ImageProperties::isValid() const {
