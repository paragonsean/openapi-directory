...
#ifndef OAIBlackFrame_H
#define OAIBlackFrame_H
...
class OAIBlackFrame : public OAIObject {
public:
    OAIBlackFrame();
    OAIBlackFrame(QString json);
    ~OAIBlackFrame() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIBlackFrame)

#endif // OAIBlackFrame_H
