...
#include "OAIListDatasetLabelsRequest.h"
...
OAIListDatasetLabelsRequest::OAIListDatasetLabelsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListDatasetLabelsRequest::OAIListDatasetLabelsRequest() {
    this->initializeModel();
}

OAIListDatasetLabelsRequest::~OAIListDatasetLabelsRequest() {}

void OAIListDatasetLabelsRequest::initializeModel() {
...
void OAIListDatasetLabelsRequest::fromJson(QString jsonString) {
...
void OAIListDatasetLabelsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIListDatasetLabelsRequest::asJson() const {
...
QJsonObject OAIListDatasetLabelsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIListDatasetLabelsRequest::getDatasetArn() const {
    return m_dataset_arn;
}
void OAIListDatasetLabelsRequest::setDatasetArn(const QString &dataset_arn) {
    m_dataset_arn = dataset_arn;
    m_dataset_arn_isSet = true;
}

bool OAIListDatasetLabelsRequest::is_dataset_arn_Set() const{
    return m_dataset_arn_isSet;
}

bool OAIListDatasetLabelsRequest::is_dataset_arn_Valid() const{
    return m_dataset_arn_isValid;
}

QString OAIListDatasetLabelsRequest::getNextToken() const {
    return m_next_token;
}
void OAIListDatasetLabelsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListDatasetLabelsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListDatasetLabelsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIListDatasetLabelsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIListDatasetLabelsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIListDatasetLabelsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIListDatasetLabelsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIListDatasetLabelsRequest::isSet() const {
...
bool OAIListDatasetLabelsRequest::isValid() const {
