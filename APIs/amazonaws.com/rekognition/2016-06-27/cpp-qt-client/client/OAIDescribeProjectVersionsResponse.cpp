...
#include "OAIDescribeProjectVersionsResponse.h"
...
OAIDescribeProjectVersionsResponse::OAIDescribeProjectVersionsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeProjectVersionsResponse::OAIDescribeProjectVersionsResponse() {
    this->initializeModel();
}

OAIDescribeProjectVersionsResponse::~OAIDescribeProjectVersionsResponse() {}

void OAIDescribeProjectVersionsResponse::initializeModel() {

    m_project_version_descriptions_isSet = false;
    m_project_version_descriptions_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeProjectVersionsResponse::fromJson(QString jsonString) {
...
void OAIDescribeProjectVersionsResponse::fromJsonObject(QJsonObject json) {

    m_project_version_descriptions_isValid = ::OpenAPI::fromJsonValue(m_project_version_descriptions, json[QString("ProjectVersionDescriptions")]);
    m_project_version_descriptions_isSet = !json[QString("ProjectVersionDescriptions")].isNull() && m_project_version_descriptions_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeProjectVersionsResponse::asJson() const {
...
QJsonObject OAIDescribeProjectVersionsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_project_version_descriptions.isSet()) {
        obj.insert(QString("ProjectVersionDescriptions"), ::OpenAPI::toJsonValue(m_project_version_descriptions));
    }
...
QList OAIDescribeProjectVersionsResponse::getProjectVersionDescriptions() const {
    return m_project_version_descriptions;
}
void OAIDescribeProjectVersionsResponse::setProjectVersionDescriptions(const QList &project_version_descriptions) {
    m_project_version_descriptions = project_version_descriptions;
    m_project_version_descriptions_isSet = true;
}

bool OAIDescribeProjectVersionsResponse::is_project_version_descriptions_Set() const{
    return m_project_version_descriptions_isSet;
}

bool OAIDescribeProjectVersionsResponse::is_project_version_descriptions_Valid() const{
    return m_project_version_descriptions_isValid;
}

QString OAIDescribeProjectVersionsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeProjectVersionsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeProjectVersionsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeProjectVersionsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeProjectVersionsResponse::isSet() const {
...
bool OAIDescribeProjectVersionsResponse::isValid() const {
