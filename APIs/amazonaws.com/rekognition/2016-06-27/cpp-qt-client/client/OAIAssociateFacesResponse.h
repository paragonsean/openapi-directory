...
/*
 * OAIAssociateFacesResponse.h
 *
 * 
 */

#ifndef OAIAssociateFacesResponse_H
#define OAIAssociateFacesResponse_H
...
class OAIAssociateFacesResponse : public OAIObject {
public:
    OAIAssociateFacesResponse();
    OAIAssociateFacesResponse(QString json);
    ~OAIAssociateFacesResponse() override;
    ...
    QList getAssociatedFaces() const;
    void setAssociatedFaces(const QList &associated_faces);
    bool is_associated_faces_Set() const;
    bool is_associated_faces_Valid() const;

    QList getUnsuccessfulFaceAssociations() const;
    void setUnsuccessfulFaceAssociations(const QList &unsuccessful_face_associations);
    bool is_unsuccessful_face_associations_Set() const;
    bool is_unsuccessful_face_associations_Valid() const;
...
private:
    ...
    QList m_associated_faces;
    bool m_associated_faces_isSet;
    bool m_associated_faces_isValid;

    QList m_unsuccessful_face_associations;
    bool m_unsuccessful_face_associations_isSet;
    bool m_unsuccessful_face_associations_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssociateFacesResponse)

#endif // OAIAssociateFacesResponse_H
