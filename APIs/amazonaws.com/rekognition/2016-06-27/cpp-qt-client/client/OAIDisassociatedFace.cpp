...
#include "OAIDisassociatedFace.h"
...
OAIDisassociatedFace::OAIDisassociatedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDisassociatedFace::OAIDisassociatedFace() {
    this->initializeModel();
}

OAIDisassociatedFace::~OAIDisassociatedFace() {}

void OAIDisassociatedFace::initializeModel() {

    m_face_id_isSet = false;
    m_face_id_isValid = false;
}

void OAIDisassociatedFace::fromJson(QString jsonString) {
...
void OAIDisassociatedFace::fromJsonObject(QJsonObject json) {
...
QString OAIDisassociatedFace::asJson() const {
...
QJsonObject OAIDisassociatedFace::asJsonObject() const {
    QJsonObject obj;
    if (m_face_id_isSet) {
...
QString OAIDisassociatedFace::getFaceId() const {
    return m_face_id;
}
void OAIDisassociatedFace::setFaceId(const QString &face_id) {
    m_face_id = face_id;
    m_face_id_isSet = true;
}

bool OAIDisassociatedFace::is_face_id_Set() const{
    return m_face_id_isSet;
}

bool OAIDisassociatedFace::is_face_id_Valid() const{
    return m_face_id_isValid;
}

bool OAIDisassociatedFace::isSet() const {
...
bool OAIDisassociatedFace::isValid() const {
