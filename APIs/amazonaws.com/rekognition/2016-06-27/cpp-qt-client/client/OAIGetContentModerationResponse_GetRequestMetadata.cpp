...
#include "OAIGetContentModerationResponse_GetRequestMetadata.h"
...
OAIGetContentModerationResponse_GetRequestMetadata::OAIGetContentModerationResponse_GetRequestMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetContentModerationResponse_GetRequestMetadata::OAIGetContentModerationResponse_GetRequestMetadata() {
    this->initializeModel();
}

OAIGetContentModerationResponse_GetRequestMetadata::~OAIGetContentModerationResponse_GetRequestMetadata() {}

void OAIGetContentModerationResponse_GetRequestMetadata::initializeModel() {
...
void OAIGetContentModerationResponse_GetRequestMetadata::fromJson(QString jsonString) {
...
void OAIGetContentModerationResponse_GetRequestMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetContentModerationResponse_GetRequestMetadata::asJson() const {
...
QJsonObject OAIGetContentModerationResponse_GetRequestMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_sort_by.isSet()) {
        obj.insert(QString("SortBy"), ::OpenAPI::toJsonValue(m_sort_by));
    }
    if (m_aggregate_by.isSet()) {
        obj.insert(QString("AggregateBy"), ::OpenAPI::toJsonValue(m_aggregate_by));
    }
    return obj;
}

OAIContentModerationSortBy OAIGetContentModerationResponse_GetRequestMetadata::getSortBy() const {
    return m_sort_by;
}
void OAIGetContentModerationResponse_GetRequestMetadata::setSortBy(const OAIContentModerationSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetContentModerationResponse_GetRequestMetadata::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetContentModerationResponse_GetRequestMetadata::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAIContentModerationAggregateBy OAIGetContentModerationResponse_GetRequestMetadata::getAggregateBy() const {
    return m_aggregate_by;
}
void OAIGetContentModerationResponse_GetRequestMetadata::setAggregateBy(const OAIContentModerationAggregateBy &aggregate_by) {
    m_aggregate_by = aggregate_by;
    m_aggregate_by_isSet = true;
}

bool OAIGetContentModerationResponse_GetRequestMetadata::is_aggregate_by_Set() const{
    return m_aggregate_by_isSet;
}

bool OAIGetContentModerationResponse_GetRequestMetadata::is_aggregate_by_Valid() const{
    return m_aggregate_by_isValid;
}

bool OAIGetContentModerationResponse_GetRequestMetadata::isSet() const {
...
bool OAIGetContentModerationResponse_GetRequestMetadata::isValid() const {
