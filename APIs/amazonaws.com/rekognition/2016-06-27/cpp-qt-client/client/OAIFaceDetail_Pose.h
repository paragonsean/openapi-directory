...
/*
 * OAIFaceDetail_Pose.h
 *
 * 
 */

#ifndef OAIFaceDetail_Pose_H
#define OAIFaceDetail_Pose_H
...
class OAIFaceDetail_Pose : public OAIObject {
public:
    OAIFaceDetail_Pose();
    OAIFaceDetail_Pose(QString json);
    ~OAIFaceDetail_Pose() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Pose)

#endif // OAIFaceDetail_Pose_H
