...
/*
 * OAIGetSegmentDetectionResponse.h
 *
 * 
 */

#ifndef OAIGetSegmentDetectionResponse_H
#define OAIGetSegmentDetectionResponse_H
...
class OAIGetSegmentDetectionResponse : public OAIObject {
public:
    OAIGetSegmentDetectionResponse();
    OAIGetSegmentDetectionResponse(QString json);
    ~OAIGetSegmentDetectionResponse() override;
    ...
    QList getVideoMetadata() const;
    void setVideoMetadata(const QList &video_metadata);
    bool is_video_metadata_Set() const;
    bool is_video_metadata_Valid() const;

    QList getAudioMetadata() const;
    void setAudioMetadata(const QList &audio_metadata);
    bool is_audio_metadata_Set() const;
    bool is_audio_metadata_Valid() const;
    ...
    QList getSelectedSegmentTypes() const;
    void setSelectedSegmentTypes(const QList &selected_segment_types);
    bool is_selected_segment_types_Set() const;
    bool is_selected_segment_types_Valid() const;
...
private:
    ...
    QList m_video_metadata;
    bool m_video_metadata_isSet;
    bool m_video_metadata_isValid;

    QList m_audio_metadata;
    bool m_audio_metadata_isSet;
    bool m_audio_metadata_isValid;
    ...
    QList m_selected_segment_types;
    bool m_selected_segment_types_isSet;
    bool m_selected_segment_types_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetSegmentDetectionResponse)

#endif // OAIGetSegmentDetectionResponse_H
