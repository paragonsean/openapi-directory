...
/*
 * OAIDistributeDatasetEntriesRequest.h
 *
 * 
 */

#ifndef OAIDistributeDatasetEntriesRequest_H
#define OAIDistributeDatasetEntriesRequest_H
...
class OAIDistributeDatasetEntriesRequest : public OAIObject {
public:
    OAIDistributeDatasetEntriesRequest();
    OAIDistributeDatasetEntriesRequest(QString json);
    ~OAIDistributeDatasetEntriesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDistributeDatasetEntriesRequest)

#endif // OAIDistributeDatasetEntriesRequest_H
