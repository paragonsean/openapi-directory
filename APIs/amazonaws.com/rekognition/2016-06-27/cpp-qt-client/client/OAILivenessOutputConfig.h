...
#ifndef OAILivenessOutputConfig_H
#define OAILivenessOutputConfig_H
...
class OAILivenessOutputConfig : public OAIObject {
public:
    OAILivenessOutputConfig();
    OAILivenessOutputConfig(QString json);
    ~OAILivenessOutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILivenessOutputConfig)

#endif // OAILivenessOutputConfig_H
