...
OAIGetLabelDetectionResponse_GetRequestMetadata::OAIGetLabelDetectionResponse_GetRequestMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetLabelDetectionResponse_GetRequestMetadata::OAIGetLabelDetectionResponse_GetRequestMetadata() {
    this->initializeModel();
}

OAIGetLabelDetectionResponse_GetRequestMetadata::~OAIGetLabelDetectionResponse_GetRequestMetadata() {}

void OAIGetLabelDetectionResponse_GetRequestMetadata::initializeModel() {
...
void OAIGetLabelDetectionResponse_GetRequestMetadata::fromJson(QString jsonString) {
...
void OAIGetLabelDetectionResponse_GetRequestMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetLabelDetectionResponse_GetRequestMetadata::asJson() const {
...
QJsonObject OAIGetLabelDetectionResponse_GetRequestMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_sort_by.isSet()) {
...
OAILabelDetectionSortBy OAIGetLabelDetectionResponse_GetRequestMetadata::getSortBy() const {
    return m_sort_by;
}
void OAIGetLabelDetectionResponse_GetRequestMetadata::setSortBy(const OAILabelDetectionSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetLabelDetectionResponse_GetRequestMetadata::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetLabelDetectionResponse_GetRequestMetadata::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAILabelDetectionAggregateBy OAIGetLabelDetectionResponse_GetRequestMetadata::getAggregateBy() const {
    return m_aggregate_by;
}
void OAIGetLabelDetectionResponse_GetRequestMetadata::setAggregateBy(const OAILabelDetectionAggregateBy &aggregate_by) {
    m_aggregate_by = aggregate_by;
    m_aggregate_by_isSet = true;
}

bool OAIGetLabelDetectionResponse_GetRequestMetadata::is_aggregate_by_Set() const{
    return m_aggregate_by_isSet;
}

bool OAIGetLabelDetectionResponse_GetRequestMetadata::is_aggregate_by_Valid() const{
    return m_aggregate_by_isValid;
}

bool OAIGetLabelDetectionResponse_GetRequestMetadata::isSet() const {
...
bool OAIGetLabelDetectionResponse_GetRequestMetadata::isValid() const {
