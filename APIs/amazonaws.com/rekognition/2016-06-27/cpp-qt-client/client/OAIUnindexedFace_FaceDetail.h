...
/*
 * OAIUnindexedFace_FaceDetail.h
 *
 * 
 */

#ifndef OAIUnindexedFace_FaceDetail_H
#define OAIUnindexedFace_FaceDetail_H
...
class OAIUnindexedFace_FaceDetail : public OAIObject {
public:
    OAIUnindexedFace_FaceDetail();
    OAIUnindexedFace_FaceDetail(QString json);
    ~OAIUnindexedFace_FaceDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnindexedFace_FaceDetail)

#endif // OAIUnindexedFace_FaceDetail_H
