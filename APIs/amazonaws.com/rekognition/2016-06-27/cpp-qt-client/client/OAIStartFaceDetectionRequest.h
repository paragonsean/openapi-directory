...
/*
 * OAIStartFaceDetectionRequest.h
 *
 * 
 */

#ifndef OAIStartFaceDetectionRequest_H
#define OAIStartFaceDetectionRequest_H
...
namespace OpenAPI {
class OAIStartFaceDetectionRequest_Video;
class OAIStartFaceDetectionRequest_NotificationChannel;

class OAIStartFaceDetectionRequest : public OAIObject {
public:
    OAIStartFaceDetectionRequest();
    OAIStartFaceDetectionRequest(QString json);
    ~OAIStartFaceDetectionRequest() override;
    ...
    OAIStartFaceDetectionRequest_Video getVideo() const;
    void setVideo(const OAIStartFaceDetectionRequest_Video &video);
    ...
    OAIStartFaceDetectionRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartFaceDetectionRequest_NotificationChannel &notification_channel);
...
private:
    ...
    OAIStartFaceDetectionRequest_Video m_video;
    bool m_video_isSet;
    ...
    OAIStartFaceDetectionRequest_NotificationChannel m_notification_channel;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartFaceDetectionRequest)

#endif // OAIStartFaceDetectionRequest_H
