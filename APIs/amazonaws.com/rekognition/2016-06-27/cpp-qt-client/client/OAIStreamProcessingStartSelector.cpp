...
#include "OAIStreamProcessingStartSelector.h"
...
OAIStreamProcessingStartSelector::OAIStreamProcessingStartSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessingStartSelector::OAIStreamProcessingStartSelector() {
    this->initializeModel();
}

OAIStreamProcessingStartSelector::~OAIStreamProcessingStartSelector() {}

void OAIStreamProcessingStartSelector::initializeModel() {

    m_kvs_stream_start_selector_isSet = false;
    m_kvs_stream_start_selector_isValid = false;
}

void OAIStreamProcessingStartSelector::fromJson(QString jsonString) {
...
void OAIStreamProcessingStartSelector::fromJsonObject(QJsonObject json) {

    m_kvs_stream_start_selector_isValid = ::OpenAPI::fromJsonValue(m_kvs_stream_start_selector, json[QString("KVSStreamStartSelector")]);
    m_kvs_stream_start_selector_isSet = !json[QString("KVSStreamStartSelector")].isNull() && m_kvs_stream_start_selector_isValid;
}

QString OAIStreamProcessingStartSelector::asJson() const {
...
QJsonObject OAIStreamProcessingStartSelector::asJsonObject() const {
    QJsonObject obj;
    if (m_kvs_stream_start_selector.isSet()) {
        obj.insert(QString("KVSStreamStartSelector"), ::OpenAPI::toJsonValue(m_kvs_stream_start_selector));
    }
    return obj;
}

OAIStreamProcessingStartSelector_KVSStreamStartSelector OAIStreamProcessingStartSelector::getKvsStreamStartSelector() const {
    return m_kvs_stream_start_selector;
}
void OAIStreamProcessingStartSelector::setKvsStreamStartSelector(const OAIStreamProcessingStartSelector_KVSStreamStartSelector &kvs_stream_start_selector) {
    m_kvs_stream_start_selector = kvs_stream_start_selector;
    m_kvs_stream_start_selector_isSet = true;
}

bool OAIStreamProcessingStartSelector::is_kvs_stream_start_selector_Set() const{
    return m_kvs_stream_start_selector_isSet;
}

bool OAIStreamProcessingStartSelector::is_kvs_stream_start_selector_Valid() const{
    return m_kvs_stream_start_selector_isValid;
}

bool OAIStreamProcessingStartSelector::isSet() const {
...
bool OAIStreamProcessingStartSelector::isValid() const {
