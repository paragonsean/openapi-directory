...
/*
 * OAICreateStreamProcessorRequest_Settings.h
 *
 * 
 */

#ifndef OAICreateStreamProcessorRequest_Settings_H
#define OAICreateStreamProcessorRequest_Settings_H
...
class OAICreateStreamProcessorRequest_Settings : public OAIObject {
public:
    OAICreateStreamProcessorRequest_Settings();
    OAICreateStreamProcessorRequest_Settings(QString json);
    ~OAICreateStreamProcessorRequest_Settings() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateStreamProcessorRequest_Settings)

#endif // OAICreateStreamProcessorRequest_Settings_H
