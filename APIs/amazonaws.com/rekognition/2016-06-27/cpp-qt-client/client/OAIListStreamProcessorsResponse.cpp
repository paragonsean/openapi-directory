...
#include "OAIListStreamProcessorsResponse.h"
...
OAIListStreamProcessorsResponse::OAIListStreamProcessorsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIListStreamProcessorsResponse::OAIListStreamProcessorsResponse() {
    this->initializeModel();
}

OAIListStreamProcessorsResponse::~OAIListStreamProcessorsResponse() {}

void OAIListStreamProcessorsResponse::initializeModel() {

    m_next_token_isSet = false;
    m_next_token_isValid = false;

    m_stream_processors_isSet = false;
    m_stream_processors_isValid = false;
}

void OAIListStreamProcessorsResponse::fromJson(QString jsonString) {
...
void OAIListStreamProcessorsResponse::fromJsonObject(QJsonObject json) {

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;

    m_stream_processors_isValid = ::OpenAPI::fromJsonValue(m_stream_processors, json[QString("StreamProcessors")]);
    m_stream_processors_isSet = !json[QString("StreamProcessors")].isNull() && m_stream_processors_isValid;
}

QString OAIListStreamProcessorsResponse::asJson() const {
...
QJsonObject OAIListStreamProcessorsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_next_token_isSet) {
        obj.insert(QString("NextToken"), ::OpenAPI::toJsonValue(m_next_token));
    }
    if (m_stream_processors.isSet()) {
        obj.insert(QString("StreamProcessors"), ::OpenAPI::toJsonValue(m_stream_processors));
    }
    return obj;
}

QString OAIListStreamProcessorsResponse::getNextToken() const {
    return m_next_token;
}
void OAIListStreamProcessorsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIListStreamProcessorsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIListStreamProcessorsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIListStreamProcessorsResponse::getStreamProcessors() const {
    return m_stream_processors;
}
void OAIListStreamProcessorsResponse::setStreamProcessors(const QList &stream_processors) {
    m_stream_processors = stream_processors;
    m_stream_processors_isSet = true;
}

bool OAIListStreamProcessorsResponse::is_stream_processors_Set() const{
    return m_stream_processors_isSet;
}

bool OAIListStreamProcessorsResponse::is_stream_processors_Valid() const{
    return m_stream_processors_isValid;
}

bool OAIListStreamProcessorsResponse::isSet() const {
...
bool OAIListStreamProcessorsResponse::isValid() const {
