...
/*
 * OAIDeleteStreamProcessorRequest.h
 *
 * 
 */

#ifndef OAIDeleteStreamProcessorRequest_H
#define OAIDeleteStreamProcessorRequest_H
...
class OAIDeleteStreamProcessorRequest : public OAIObject {
public:
    OAIDeleteStreamProcessorRequest();
    OAIDeleteStreamProcessorRequest(QString json);
    ~OAIDeleteStreamProcessorRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteStreamProcessorRequest)

#endif // OAIDeleteStreamProcessorRequest_H
