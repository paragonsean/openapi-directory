...
public:
    ...
    OAIInstance_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAIInstance_BoundingBox &bounding_box);
...
private:
    ...
    OAIInstance_BoundingBox m_bounding_box;
