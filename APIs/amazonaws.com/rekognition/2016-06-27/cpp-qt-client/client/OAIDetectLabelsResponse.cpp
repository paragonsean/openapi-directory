...
#include "OAIDetectLabelsResponse.h"
...
OAIDetectLabelsResponse::OAIDetectLabelsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsResponse::OAIDetectLabelsResponse() {
    this->initializeModel();
}

OAIDetectLabelsResponse::~OAIDetectLabelsResponse() {}

void OAIDetectLabelsResponse::initializeModel() {
...
void OAIDetectLabelsResponse::fromJson(QString jsonString) {
...
void OAIDetectLabelsResponse::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsResponse::asJson() const {
...
QJsonObject OAIDetectLabelsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_labels.isSet()) {
...
QList OAIDetectLabelsResponse::getLabels() const {
    return m_labels;
}
void OAIDetectLabelsResponse::setLabels(const QList &labels) {
    m_labels = labels;
    m_labels_isSet = true;
}

bool OAIDetectLabelsResponse::is_labels_Set() const{
    return m_labels_isSet;
}

bool OAIDetectLabelsResponse::is_labels_Valid() const{
    return m_labels_isValid;
}

OAIOrientationCorrection OAIDetectLabelsResponse::getOrientationCorrection() const {
    return m_orientation_correction;
}
void OAIDetectLabelsResponse::setOrientationCorrection(const OAIOrientationCorrection &orientation_correction) {
    m_orientation_correction = orientation_correction;
    m_orientation_correction_isSet = true;
}

bool OAIDetectLabelsResponse::is_orientation_correction_Set() const{
    return m_orientation_correction_isSet;
}

bool OAIDetectLabelsResponse::is_orientation_correction_Valid() const{
    return m_orientation_correction_isValid;
}

QString OAIDetectLabelsResponse::getLabelModelVersion() const {
    return m_label_model_version;
}
void OAIDetectLabelsResponse::setLabelModelVersion(const QString &label_model_version) {
    m_label_model_version = label_model_version;
    m_label_model_version_isSet = true;
}

bool OAIDetectLabelsResponse::is_label_model_version_Set() const{
    return m_label_model_version_isSet;
}

bool OAIDetectLabelsResponse::is_label_model_version_Valid() const{
    return m_label_model_version_isValid;
}

OAIDetectLabelsResponse_ImageProperties OAIDetectLabelsResponse::getImageProperties() const {
    return m_image_properties;
}
void OAIDetectLabelsResponse::setImageProperties(const OAIDetectLabelsResponse_ImageProperties &image_properties) {
    m_image_properties = image_properties;
    m_image_properties_isSet = true;
}

bool OAIDetectLabelsResponse::is_image_properties_Set() const{
    return m_image_properties_isSet;
}

bool OAIDetectLabelsResponse::is_image_properties_Valid() const{
    return m_image_properties_isValid;
}

bool OAIDetectLabelsResponse::isSet() const {
...
bool OAIDetectLabelsResponse::isValid() const {
