...
/*
 * OAIFaceDetail_Quality.h
 *
 * 
 */

#ifndef OAIFaceDetail_Quality_H
#define OAIFaceDetail_Quality_H
...
class OAIFaceDetail_Quality : public OAIObject {
public:
    OAIFaceDetail_Quality();
    OAIFaceDetail_Quality(QString json);
    ~OAIFaceDetail_Quality() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Quality)

#endif // OAIFaceDetail_Quality_H
