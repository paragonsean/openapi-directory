...
#include "OAISearchFacesByImageRequest.h"
...
OAISearchFacesByImageRequest::OAISearchFacesByImageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchFacesByImageRequest::OAISearchFacesByImageRequest() {
    this->initializeModel();
}

OAISearchFacesByImageRequest::~OAISearchFacesByImageRequest() {}

void OAISearchFacesByImageRequest::initializeModel() {
    ...
    m_max_faces_isSet = false;
    m_max_faces_isValid = false;

    m_face_match_threshold_isSet = false;
    m_face_match_threshold_isValid = false;

    m_quality_filter_isSet = false;
    m_quality_filter_isValid = false;
}

void OAISearchFacesByImageRequest::fromJson(QString jsonString) {
...
void OAISearchFacesByImageRequest::fromJsonObject(QJsonObject json) {
    ...
    m_max_faces_isValid = ::OpenAPI::fromJsonValue(m_max_faces, json[QString("MaxFaces")]);
    m_max_faces_isSet = !json[QString("MaxFaces")].isNull() && m_max_faces_isValid;

    m_face_match_threshold_isValid = ::OpenAPI::fromJsonValue(m_face_match_threshold, json[QString("FaceMatchThreshold")]);
    m_face_match_threshold_isSet = !json[QString("FaceMatchThreshold")].isNull() && m_face_match_threshold_isValid;

    m_quality_filter_isValid = ::OpenAPI::fromJsonValue(m_quality_filter, json[QString("QualityFilter")]);
    m_quality_filter_isSet = !json[QString("QualityFilter")].isNull() && m_quality_filter_isValid;
}

QString OAISearchFacesByImageRequest::asJson() const {
...
QJsonObject OAISearchFacesByImageRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_max_faces_isSet) {
        obj.insert(QString("MaxFaces"), ::OpenAPI::toJsonValue(m_max_faces));
    }
    if (m_face_match_threshold_isSet) {
        obj.insert(QString("FaceMatchThreshold"), ::OpenAPI::toJsonValue(m_face_match_threshold));
    }
    if (m_quality_filter.isSet()) {
        obj.insert(QString("QualityFilter"), ::OpenAPI::toJsonValue(m_quality_filter));
    }
    return obj;
}

QString OAISearchFacesByImageRequest::getCollectionId() const {
    return m_collection_id;
}
void OAISearchFacesByImageRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAISearchFacesByImageRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAISearchFacesByImageRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

OAICompareFacesRequest_SourceImage OAISearchFacesByImageRequest::getImage() const {
    return m_image;
}
void OAISearchFacesByImageRequest::setImage(const OAICompareFacesRequest_SourceImage &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAISearchFacesByImageRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAISearchFacesByImageRequest::is_image_Valid() const{
    return m_image_isValid;
}

qint32 OAISearchFacesByImageRequest::getMaxFaces() const {
    return m_max_faces;
}
void OAISearchFacesByImageRequest::setMaxFaces(const qint32 &max_faces) {
    m_max_faces = max_faces;
    m_max_faces_isSet = true;
}

bool OAISearchFacesByImageRequest::is_max_faces_Set() const{
    return m_max_faces_isSet;
}

bool OAISearchFacesByImageRequest::is_max_faces_Valid() const{
    return m_max_faces_isValid;
}

float OAISearchFacesByImageRequest::getFaceMatchThreshold() const {
    return m_face_match_threshold;
}
void OAISearchFacesByImageRequest::setFaceMatchThreshold(const float &face_match_threshold) {
    m_face_match_threshold = face_match_threshold;
    m_face_match_threshold_isSet = true;
}

bool OAISearchFacesByImageRequest::is_face_match_threshold_Set() const{
    return m_face_match_threshold_isSet;
}

bool OAISearchFacesByImageRequest::is_face_match_threshold_Valid() const{
    return m_face_match_threshold_isValid;
}

OAIQualityFilter OAISearchFacesByImageRequest::getQualityFilter() const {
    return m_quality_filter;
}
void OAISearchFacesByImageRequest::setQualityFilter(const OAIQualityFilter &quality_filter) {
    m_quality_filter = quality_filter;
    m_quality_filter_isSet = true;
}

bool OAISearchFacesByImageRequest::is_quality_filter_Set() const{
    return m_quality_filter_isSet;
}

bool OAISearchFacesByImageRequest::is_quality_filter_Valid() const{
    return m_quality_filter_isValid;
}

bool OAISearchFacesByImageRequest::isSet() const {
...
bool OAISearchFacesByImageRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_collection_id_isValid && m_image_isValid && true;
}
