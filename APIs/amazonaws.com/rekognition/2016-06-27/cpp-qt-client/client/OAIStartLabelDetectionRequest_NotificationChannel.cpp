...
#include "OAIStartLabelDetectionRequest_NotificationChannel.h"
...
OAIStartLabelDetectionRequest_NotificationChannel::OAIStartLabelDetectionRequest_NotificationChannel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartLabelDetectionRequest_NotificationChannel::OAIStartLabelDetectionRequest_NotificationChannel() {
    this->initializeModel();
}

OAIStartLabelDetectionRequest_NotificationChannel::~OAIStartLabelDetectionRequest_NotificationChannel() {}

void OAIStartLabelDetectionRequest_NotificationChannel::initializeModel() {
...
void OAIStartLabelDetectionRequest_NotificationChannel::fromJson(QString jsonString) {
...
void OAIStartLabelDetectionRequest_NotificationChannel::fromJsonObject(QJsonObject json) {
...
QString OAIStartLabelDetectionRequest_NotificationChannel::asJson() const {
...
QJsonObject OAIStartLabelDetectionRequest_NotificationChannel::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartLabelDetectionRequest_NotificationChannel::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIStartLabelDetectionRequest_NotificationChannel::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIStartLabelDetectionRequest_NotificationChannel::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIStartLabelDetectionRequest_NotificationChannel::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QString OAIStartLabelDetectionRequest_NotificationChannel::getRoleArn() const {
    return m_role_arn;
}
void OAIStartLabelDetectionRequest_NotificationChannel::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIStartLabelDetectionRequest_NotificationChannel::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIStartLabelDetectionRequest_NotificationChannel::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIStartLabelDetectionRequest_NotificationChannel::isSet() const {
...
bool OAIStartLabelDetectionRequest_NotificationChannel::isValid() const {
