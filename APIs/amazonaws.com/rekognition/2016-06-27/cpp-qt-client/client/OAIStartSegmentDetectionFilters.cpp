...
#include "OAIStartSegmentDetectionFilters.h"
...
OAIStartSegmentDetectionFilters::OAIStartSegmentDetectionFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartSegmentDetectionFilters::OAIStartSegmentDetectionFilters() {
    this->initializeModel();
}

OAIStartSegmentDetectionFilters::~OAIStartSegmentDetectionFilters() {}

void OAIStartSegmentDetectionFilters::initializeModel() {
...
void OAIStartSegmentDetectionFilters::fromJson(QString jsonString) {
...
void OAIStartSegmentDetectionFilters::fromJsonObject(QJsonObject json) {
...
QString OAIStartSegmentDetectionFilters::asJson() const {
...
QJsonObject OAIStartSegmentDetectionFilters::asJsonObject() const {
    QJsonObject obj;
...
OAIStartSegmentDetectionFilters_TechnicalCueFilter OAIStartSegmentDetectionFilters::getTechnicalCueFilter() const {
    return m_technical_cue_filter;
}
void OAIStartSegmentDetectionFilters::setTechnicalCueFilter(const OAIStartSegmentDetectionFilters_TechnicalCueFilter &technical_cue_filter) {
    m_technical_cue_filter = technical_cue_filter;
    m_technical_cue_filter_isSet = true;
}

bool OAIStartSegmentDetectionFilters::is_technical_cue_filter_Set() const{
    return m_technical_cue_filter_isSet;
}

bool OAIStartSegmentDetectionFilters::is_technical_cue_filter_Valid() const{
    return m_technical_cue_filter_isValid;
}

OAIStartSegmentDetectionFilters_ShotFilter OAIStartSegmentDetectionFilters::getShotFilter() const {
    return m_shot_filter;
}
void OAIStartSegmentDetectionFilters::setShotFilter(const OAIStartSegmentDetectionFilters_ShotFilter &shot_filter) {
    m_shot_filter = shot_filter;
    m_shot_filter_isSet = true;
}

bool OAIStartSegmentDetectionFilters::is_shot_filter_Set() const{
    return m_shot_filter_isSet;
}

bool OAIStartSegmentDetectionFilters::is_shot_filter_Valid() const{
    return m_shot_filter_isValid;
}

bool OAIStartSegmentDetectionFilters::isSet() const {
...
bool OAIStartSegmentDetectionFilters::isValid() const {
