...
OAIStreamProcessorSettings_FaceSearch::OAIStreamProcessorSettings_FaceSearch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorSettings_FaceSearch::OAIStreamProcessorSettings_FaceSearch() {
    this->initializeModel();
}

OAIStreamProcessorSettings_FaceSearch::~OAIStreamProcessorSettings_FaceSearch() {}

void OAIStreamProcessorSettings_FaceSearch::initializeModel() {
...
void OAIStreamProcessorSettings_FaceSearch::fromJson(QString jsonString) {
...
void OAIStreamProcessorSettings_FaceSearch::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessorSettings_FaceSearch::asJson() const {
...
QJsonObject OAIStreamProcessorSettings_FaceSearch::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStreamProcessorSettings_FaceSearch::getCollectionId() const {
    return m_collection_id;
}
void OAIStreamProcessorSettings_FaceSearch::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIStreamProcessorSettings_FaceSearch::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIStreamProcessorSettings_FaceSearch::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

float OAIStreamProcessorSettings_FaceSearch::getFaceMatchThreshold() const {
    return m_face_match_threshold;
}
void OAIStreamProcessorSettings_FaceSearch::setFaceMatchThreshold(const float &face_match_threshold) {
    m_face_match_threshold = face_match_threshold;
    m_face_match_threshold_isSet = true;
}

bool OAIStreamProcessorSettings_FaceSearch::is_face_match_threshold_Set() const{
    return m_face_match_threshold_isSet;
}

bool OAIStreamProcessorSettings_FaceSearch::is_face_match_threshold_Valid() const{
    return m_face_match_threshold_isValid;
}

bool OAIStreamProcessorSettings_FaceSearch::isSet() const {
...
bool OAIStreamProcessorSettings_FaceSearch::isValid() const {
