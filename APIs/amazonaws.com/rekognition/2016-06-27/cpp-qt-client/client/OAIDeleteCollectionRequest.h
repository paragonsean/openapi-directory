...
/*
 * OAIDeleteCollectionRequest.h
 *
 * 
 */

#ifndef OAIDeleteCollectionRequest_H
#define OAIDeleteCollectionRequest_H
...
class OAIDeleteCollectionRequest : public OAIObject {
public:
    OAIDeleteCollectionRequest();
    OAIDeleteCollectionRequest(QString json);
    ~OAIDeleteCollectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCollectionRequest)

#endif // OAIDeleteCollectionRequest_H
