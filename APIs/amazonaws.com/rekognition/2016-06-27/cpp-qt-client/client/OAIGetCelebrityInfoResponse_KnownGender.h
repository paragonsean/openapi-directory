...
/*
 * OAIGetCelebrityInfoResponse_KnownGender.h
 *
 * 
 */

#ifndef OAIGetCelebrityInfoResponse_KnownGender_H
#define OAIGetCelebrityInfoResponse_KnownGender_H
...
class OAIGetCelebrityInfoResponse_KnownGender : public OAIObject {
public:
    OAIGetCelebrityInfoResponse_KnownGender();
    OAIGetCelebrityInfoResponse_KnownGender(QString json);
    ~OAIGetCelebrityInfoResponse_KnownGender() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetCelebrityInfoResponse_KnownGender)

#endif // OAIGetCelebrityInfoResponse_KnownGender_H
