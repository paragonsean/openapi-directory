...
OAICreateFaceLivenessSessionRequestSettings_OutputConfig::OAICreateFaceLivenessSessionRequestSettings_OutputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFaceLivenessSessionRequestSettings_OutputConfig::OAICreateFaceLivenessSessionRequestSettings_OutputConfig() {
    this->initializeModel();
}

OAICreateFaceLivenessSessionRequestSettings_OutputConfig::~OAICreateFaceLivenessSessionRequestSettings_OutputConfig() {}

void OAICreateFaceLivenessSessionRequestSettings_OutputConfig::initializeModel() {
...
void OAICreateFaceLivenessSessionRequestSettings_OutputConfig::fromJson(QString jsonString) {
...
void OAICreateFaceLivenessSessionRequestSettings_OutputConfig::fromJsonObject(QJsonObject json) {
...
QString OAICreateFaceLivenessSessionRequestSettings_OutputConfig::asJson() const {
...
QJsonObject OAICreateFaceLivenessSessionRequestSettings_OutputConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateFaceLivenessSessionRequestSettings_OutputConfig::getS3Bucket() const {
    return m_s3_bucket;
}
void OAICreateFaceLivenessSessionRequestSettings_OutputConfig::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAICreateFaceLivenessSessionRequestSettings_OutputConfig::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAICreateFaceLivenessSessionRequestSettings_OutputConfig::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAICreateFaceLivenessSessionRequestSettings_OutputConfig::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAICreateFaceLivenessSessionRequestSettings_OutputConfig::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAICreateFaceLivenessSessionRequestSettings_OutputConfig::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAICreateFaceLivenessSessionRequestSettings_OutputConfig::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

bool OAICreateFaceLivenessSessionRequestSettings_OutputConfig::isSet() const {
...
bool OAICreateFaceLivenessSessionRequestSettings_OutputConfig::isValid() const {
