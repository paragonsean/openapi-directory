...
/*
 * OAIStartTextDetectionFilters.h
 *
...
#ifndef OAIStartTextDetectionFilters_H
#define OAIStartTextDetectionFilters_H

#include <QJsonObject>

#include "OAIStartTextDetectionFilters_WordFilter.h"
#include <QList>
...
namespace OpenAPI {
class OAIStartTextDetectionFilters_WordFilter;

class OAIStartTextDetectionFilters : public OAIObject {
public:
    OAIStartTextDetectionFilters();
    OAIStartTextDetectionFilters(QString json);
    ~OAIStartTextDetectionFilters() override;
    ...
    OAIStartTextDetectionFilters_WordFilter getWordFilter() const;
    void setWordFilter(const OAIStartTextDetectionFilters_WordFilter &word_filter);
    bool is_word_filter_Set() const;
    bool is_word_filter_Valid() const;

    QList getRegionsOfInterest() const;
    void setRegionsOfInterest(const QList &regions_of_interest);
...
private:
    ...
    OAIStartTextDetectionFilters_WordFilter m_word_filter;
    bool m_word_filter_isSet;
    bool m_word_filter_isValid;

    QList m_regions_of_interest;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartTextDetectionFilters)

#endif // OAIStartTextDetectionFilters_H
