...
#include "OAIDetectTextFilters.h"
...
OAIDetectTextFilters::OAIDetectTextFilters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectTextFilters::OAIDetectTextFilters() {
    this->initializeModel();
}

OAIDetectTextFilters::~OAIDetectTextFilters() {}

void OAIDetectTextFilters::initializeModel() {
...
void OAIDetectTextFilters::fromJson(QString jsonString) {
...
void OAIDetectTextFilters::fromJsonObject(QJsonObject json) {
...
QString OAIDetectTextFilters::asJson() const {
...
QJsonObject OAIDetectTextFilters::asJsonObject() const {
    QJsonObject obj;
...
OAIDetectionFilter OAIDetectTextFilters::getWordFilter() const {
    return m_word_filter;
}
void OAIDetectTextFilters::setWordFilter(const OAIDetectionFilter &word_filter) {
    m_word_filter = word_filter;
    m_word_filter_isSet = true;
}

bool OAIDetectTextFilters::is_word_filter_Set() const{
    return m_word_filter_isSet;
}

bool OAIDetectTextFilters::is_word_filter_Valid() const{
    return m_word_filter_isValid;
}

QList OAIDetectTextFilters::getRegionsOfInterest() const {
    return m_regions_of_interest;
}
void OAIDetectTextFilters::setRegionsOfInterest(const QList &regions_of_interest) {
    m_regions_of_interest = regions_of_interest;
    m_regions_of_interest_isSet = true;
}

bool OAIDetectTextFilters::is_regions_of_interest_Set() const{
    return m_regions_of_interest_isSet;
}

bool OAIDetectTextFilters::is_regions_of_interest_Valid() const{
    return m_regions_of_interest_isValid;
}

bool OAIDetectTextFilters::isSet() const {
...
bool OAIDetectTextFilters::isValid() const {
