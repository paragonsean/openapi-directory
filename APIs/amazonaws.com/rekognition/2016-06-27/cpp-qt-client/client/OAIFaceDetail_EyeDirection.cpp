...
OAIFaceDetail_EyeDirection::OAIFaceDetail_EyeDirection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_EyeDirection::OAIFaceDetail_EyeDirection() {
    this->initializeModel();
}

OAIFaceDetail_EyeDirection::~OAIFaceDetail_EyeDirection() {}

void OAIFaceDetail_EyeDirection::initializeModel() {
...
void OAIFaceDetail_EyeDirection::fromJson(QString jsonString) {
...
void OAIFaceDetail_EyeDirection::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_EyeDirection::asJson() const {
...
QJsonObject OAIFaceDetail_EyeDirection::asJsonObject() const {
    QJsonObject obj;
    if (m_yaw_isSet) {
...
float OAIFaceDetail_EyeDirection::getYaw() const {
    return m_yaw;
}
void OAIFaceDetail_EyeDirection::setYaw(const float &yaw) {
    m_yaw = yaw;
    m_yaw_isSet = true;
}

bool OAIFaceDetail_EyeDirection::is_yaw_Set() const{
    return m_yaw_isSet;
}

bool OAIFaceDetail_EyeDirection::is_yaw_Valid() const{
    return m_yaw_isValid;
}

float OAIFaceDetail_EyeDirection::getPitch() const {
    return m_pitch;
}
void OAIFaceDetail_EyeDirection::setPitch(const float &pitch) {
    m_pitch = pitch;
    m_pitch_isSet = true;
}

bool OAIFaceDetail_EyeDirection::is_pitch_Set() const{
    return m_pitch_isSet;
}

bool OAIFaceDetail_EyeDirection::is_pitch_Valid() const{
    return m_pitch_isValid;
}

float OAIFaceDetail_EyeDirection::getConfidence() const {
    return m_confidence;
}
void OAIFaceDetail_EyeDirection::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceDetail_EyeDirection::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceDetail_EyeDirection::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIFaceDetail_EyeDirection::isSet() const {
...
bool OAIFaceDetail_EyeDirection::isValid() const {
