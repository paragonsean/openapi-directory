...
#include "OAIDetectCustomLabelsResponse.h"
...
OAIDetectCustomLabelsResponse::OAIDetectCustomLabelsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectCustomLabelsResponse::OAIDetectCustomLabelsResponse() {
    this->initializeModel();
}

OAIDetectCustomLabelsResponse::~OAIDetectCustomLabelsResponse() {}

void OAIDetectCustomLabelsResponse::initializeModel() {

    m_custom_labels_isSet = false;
    m_custom_labels_isValid = false;
}

void OAIDetectCustomLabelsResponse::fromJson(QString jsonString) {
...
void OAIDetectCustomLabelsResponse::fromJsonObject(QJsonObject json) {

    m_custom_labels_isValid = ::OpenAPI::fromJsonValue(m_custom_labels, json[QString("CustomLabels")]);
    m_custom_labels_isSet = !json[QString("CustomLabels")].isNull() && m_custom_labels_isValid;
}

QString OAIDetectCustomLabelsResponse::asJson() const {
...
QJsonObject OAIDetectCustomLabelsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_custom_labels.isSet()) {
        obj.insert(QString("CustomLabels"), ::OpenAPI::toJsonValue(m_custom_labels));
    }
    return obj;
}

QList OAIDetectCustomLabelsResponse::getCustomLabels() const {
    return m_custom_labels;
}
void OAIDetectCustomLabelsResponse::setCustomLabels(const QList &custom_labels) {
    m_custom_labels = custom_labels;
    m_custom_labels_isSet = true;
}

bool OAIDetectCustomLabelsResponse::is_custom_labels_Set() const{
    return m_custom_labels_isSet;
}

bool OAIDetectCustomLabelsResponse::is_custom_labels_Valid() const{
    return m_custom_labels_isValid;
}

bool OAIDetectCustomLabelsResponse::isSet() const {
...
bool OAIDetectCustomLabelsResponse::isValid() const {
