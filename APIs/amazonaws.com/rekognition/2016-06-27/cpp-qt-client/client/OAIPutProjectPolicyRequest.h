...
/*
 * OAIPutProjectPolicyRequest.h
 *
 * 
 */

#ifndef OAIPutProjectPolicyRequest_H
#define OAIPutProjectPolicyRequest_H
...
class OAIPutProjectPolicyRequest : public OAIObject {
public:
    OAIPutProjectPolicyRequest();
    OAIPutProjectPolicyRequest(QString json);
    ~OAIPutProjectPolicyRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutProjectPolicyRequest)

#endif // OAIPutProjectPolicyRequest_H
