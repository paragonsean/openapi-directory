...
#include "OAIGetPersonTrackingRequest.h"
...
OAIGetPersonTrackingRequest::OAIGetPersonTrackingRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetPersonTrackingRequest::OAIGetPersonTrackingRequest() {
    this->initializeModel();
}

OAIGetPersonTrackingRequest::~OAIGetPersonTrackingRequest() {}

void OAIGetPersonTrackingRequest::initializeModel() {
...
void OAIGetPersonTrackingRequest::fromJson(QString jsonString) {
...
void OAIGetPersonTrackingRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetPersonTrackingRequest::asJson() const {
...
QJsonObject OAIGetPersonTrackingRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetPersonTrackingRequest::getJobId() const {
    return m_job_id;
}
void OAIGetPersonTrackingRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetPersonTrackingRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetPersonTrackingRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetPersonTrackingRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetPersonTrackingRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetPersonTrackingRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetPersonTrackingRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetPersonTrackingRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetPersonTrackingRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetPersonTrackingRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetPersonTrackingRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAIPersonTrackingSortBy OAIGetPersonTrackingRequest::getSortBy() const {
    return m_sort_by;
}
void OAIGetPersonTrackingRequest::setSortBy(const OAIPersonTrackingSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetPersonTrackingRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetPersonTrackingRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

bool OAIGetPersonTrackingRequest::isSet() const {
...
bool OAIGetPersonTrackingRequest::isValid() const {
