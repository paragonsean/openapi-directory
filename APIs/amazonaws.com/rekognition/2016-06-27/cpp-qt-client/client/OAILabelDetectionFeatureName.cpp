...
#include "OAILabelDetectionFeatureName.h"
...
OAILabelDetectionFeatureName::OAILabelDetectionFeatureName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelDetectionFeatureName::OAILabelDetectionFeatureName() {
    this->initializeModel();
}

OAILabelDetectionFeatureName::~OAILabelDetectionFeatureName() {}

void OAILabelDetectionFeatureName::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAILabelDetectionFeatureName::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAILabelDetectionFeatureName::fromJson(QString jsonString) {
    
    if ( jsonString.compare("GENERAL_LABELS", Qt::CaseInsensitive) == 0) {
        m_value = eOAILabelDetectionFeatureName::GENERAL_LABELS;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAILabelDetectionFeatureName::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAILabelDetectionFeatureName::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAILabelDetectionFeatureName::GENERAL_LABELS:
            val = "GENERAL_LABELS";
            break;
        default:
            break;
...
QJsonValue OAILabelDetectionFeatureName::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAILabelDetectionFeatureName::eOAILabelDetectionFeatureName OAILabelDetectionFeatureName::getValue() const {
    return m_value;
}

void OAILabelDetectionFeatureName::setValue(const OAILabelDetectionFeatureName::eOAILabelDetectionFeatureName& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAILabelDetectionFeatureName::isSet() const {
    
    return m_value_isSet;
}

bool OAILabelDetectionFeatureName::isValid() const {
