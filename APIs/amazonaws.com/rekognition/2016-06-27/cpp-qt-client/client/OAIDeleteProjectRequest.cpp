...
QString OAIDeleteProjectRequest::getProjectArn() const {
    return m_project_arn;
}
void OAIDeleteProjectRequest::setProjectArn(const QString &project_arn) {
    m_project_arn = project_arn;
    m_project_arn_isSet = true;
}

bool OAIDeleteProjectRequest::is_project_arn_Set() const{
    return m_project_arn_isSet;
}

bool OAIDeleteProjectRequest::is_project_arn_Valid() const{
