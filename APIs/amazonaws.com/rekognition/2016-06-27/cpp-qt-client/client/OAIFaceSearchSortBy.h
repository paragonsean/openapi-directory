...
/*
 * OAIFaceSearchSortBy.h
 *
 * 
 */

#ifndef OAIFaceSearchSortBy_H
#define OAIFaceSearchSortBy_H
...
class OAIFaceSearchSortBy : public OAIEnum {
public:
    OAIFaceSearchSortBy();
    OAIFaceSearchSortBy(QString json);
    ~OAIFaceSearchSortBy() override;
    ...
    enum class eOAIFaceSearchSortBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        INDEX, 
        TIMESTAMP
    };
    OAIFaceSearchSortBy::eOAIFaceSearchSortBy getValue() const;
    void setValue(const OAIFaceSearchSortBy::eOAIFaceSearchSortBy& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceSearchSortBy)

#endif // OAIFaceSearchSortBy_H
