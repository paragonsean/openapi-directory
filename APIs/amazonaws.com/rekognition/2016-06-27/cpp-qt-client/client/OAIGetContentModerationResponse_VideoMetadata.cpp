...
#include "OAIGetContentModerationResponse_VideoMetadata.h"
...
OAIGetContentModerationResponse_VideoMetadata::OAIGetContentModerationResponse_VideoMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetContentModerationResponse_VideoMetadata::OAIGetContentModerationResponse_VideoMetadata() {
    this->initializeModel();
}

OAIGetContentModerationResponse_VideoMetadata::~OAIGetContentModerationResponse_VideoMetadata() {}

void OAIGetContentModerationResponse_VideoMetadata::initializeModel() {
...
void OAIGetContentModerationResponse_VideoMetadata::fromJson(QString jsonString) {
...
void OAIGetContentModerationResponse_VideoMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetContentModerationResponse_VideoMetadata::asJson() const {
...
QJsonObject OAIGetContentModerationResponse_VideoMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_codec_isSet) {
...
QString OAIGetContentModerationResponse_VideoMetadata::getCodec() const {
    return m_codec;
}
void OAIGetContentModerationResponse_VideoMetadata::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIGetContentModerationResponse_VideoMetadata::getDurationMillis() const {
    return m_duration_millis;
}
void OAIGetContentModerationResponse_VideoMetadata::setDurationMillis(const qint32 &duration_millis) {
    m_duration_millis = duration_millis;
    m_duration_millis_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_duration_millis_Set() const{
    return m_duration_millis_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_duration_millis_Valid() const{
    return m_duration_millis_isValid;
}

QString OAIGetContentModerationResponse_VideoMetadata::getFormat() const {
    return m_format;
}
void OAIGetContentModerationResponse_VideoMetadata::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_format_Set() const{
    return m_format_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_format_Valid() const{
    return m_format_isValid;
}

float OAIGetContentModerationResponse_VideoMetadata::getFrameRate() const {
    return m_frame_rate;
}
void OAIGetContentModerationResponse_VideoMetadata::setFrameRate(const float &frame_rate) {
    m_frame_rate = frame_rate;
    m_frame_rate_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_frame_rate_Set() const{
    return m_frame_rate_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_frame_rate_Valid() const{
    return m_frame_rate_isValid;
}

qint32 OAIGetContentModerationResponse_VideoMetadata::getFrameHeight() const {
    return m_frame_height;
}
void OAIGetContentModerationResponse_VideoMetadata::setFrameHeight(const qint32 &frame_height) {
    m_frame_height = frame_height;
    m_frame_height_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_frame_height_Set() const{
    return m_frame_height_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_frame_height_Valid() const{
    return m_frame_height_isValid;
}

qint32 OAIGetContentModerationResponse_VideoMetadata::getFrameWidth() const {
    return m_frame_width;
}
void OAIGetContentModerationResponse_VideoMetadata::setFrameWidth(const qint32 &frame_width) {
    m_frame_width = frame_width;
    m_frame_width_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_frame_width_Set() const{
    return m_frame_width_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_frame_width_Valid() const{
    return m_frame_width_isValid;
}

OAIVideoColorRange OAIGetContentModerationResponse_VideoMetadata::getColorRange() const {
    return m_color_range;
}
void OAIGetContentModerationResponse_VideoMetadata::setColorRange(const OAIVideoColorRange &color_range) {
    m_color_range = color_range;
    m_color_range_isSet = true;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_color_range_Set() const{
    return m_color_range_isSet;
}

bool OAIGetContentModerationResponse_VideoMetadata::is_color_range_Valid() const{
    return m_color_range_isValid;
}

bool OAIGetContentModerationResponse_VideoMetadata::isSet() const {
...
bool OAIGetContentModerationResponse_VideoMetadata::isValid() const {
