...
#include "OAICreateFaceLivenessSessionResponse.h"
...
OAICreateFaceLivenessSessionResponse::OAICreateFaceLivenessSessionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFaceLivenessSessionResponse::OAICreateFaceLivenessSessionResponse() {
    this->initializeModel();
}

OAICreateFaceLivenessSessionResponse::~OAICreateFaceLivenessSessionResponse() {}

void OAICreateFaceLivenessSessionResponse::initializeModel() {

    m_session_id_isSet = false;
    m_session_id_isValid = false;
}

void OAICreateFaceLivenessSessionResponse::fromJson(QString jsonString) {
...
void OAICreateFaceLivenessSessionResponse::fromJsonObject(QJsonObject json) {
...
QString OAICreateFaceLivenessSessionResponse::asJson() const {
...
QJsonObject OAICreateFaceLivenessSessionResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAICreateFaceLivenessSessionResponse::getSessionId() const {
    return m_session_id;
}
void OAICreateFaceLivenessSessionResponse::setSessionId(const QString &session_id) {
    m_session_id = session_id;
    m_session_id_isSet = true;
}

bool OAICreateFaceLivenessSessionResponse::is_session_id_Set() const{
    return m_session_id_isSet;
}

bool OAICreateFaceLivenessSessionResponse::is_session_id_Valid() const{
    return m_session_id_isValid;
}

bool OAICreateFaceLivenessSessionResponse::isSet() const {
...
bool OAICreateFaceLivenessSessionResponse::isValid() const {
