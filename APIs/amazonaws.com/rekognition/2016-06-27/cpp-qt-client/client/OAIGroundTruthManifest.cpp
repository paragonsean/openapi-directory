...
OAIGroundTruthManifest::OAIGroundTruthManifest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGroundTruthManifest::OAIGroundTruthManifest() {
    this->initializeModel();
}

OAIGroundTruthManifest::~OAIGroundTruthManifest() {}

void OAIGroundTruthManifest::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIGroundTruthManifest::fromJson(QString jsonString) {
...
void OAIGroundTruthManifest::fromJsonObject(QJsonObject json) {
...
QString OAIGroundTruthManifest::asJson() const {
...
QJsonObject OAIGroundTruthManifest::asJsonObject() const {
    QJsonObject obj;
...
OAIS3Object OAIGroundTruthManifest::getS3Object() const {
    return m_s3_object;
}
void OAIGroundTruthManifest::setS3Object(const OAIS3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIGroundTruthManifest::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIGroundTruthManifest::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIGroundTruthManifest::isSet() const {
...
bool OAIGroundTruthManifest::isValid() const {
