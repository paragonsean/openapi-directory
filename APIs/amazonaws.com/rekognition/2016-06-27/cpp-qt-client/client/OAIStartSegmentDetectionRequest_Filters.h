...
/*
 * OAIStartSegmentDetectionRequest_Filters.h
 *
 * 
 */

#ifndef OAIStartSegmentDetectionRequest_Filters_H
#define OAIStartSegmentDetectionRequest_Filters_H
...
class OAIStartSegmentDetectionRequest_Filters : public OAIObject {
public:
    OAIStartSegmentDetectionRequest_Filters();
    OAIStartSegmentDetectionRequest_Filters(QString json);
    ~OAIStartSegmentDetectionRequest_Filters() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSegmentDetectionRequest_Filters)

#endif // OAIStartSegmentDetectionRequest_Filters_H
