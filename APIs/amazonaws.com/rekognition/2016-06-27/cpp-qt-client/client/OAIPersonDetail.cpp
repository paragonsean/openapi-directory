...
OAIPersonDetail::OAIPersonDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonDetail::OAIPersonDetail() {
    this->initializeModel();
}

OAIPersonDetail::~OAIPersonDetail() {}

void OAIPersonDetail::initializeModel() {
...
void OAIPersonDetail::fromJson(QString jsonString) {
...
void OAIPersonDetail::fromJsonObject(QJsonObject json) {
...
QString OAIPersonDetail::asJson() const {
...
QJsonObject OAIPersonDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_index_isSet) {
...
qint32 OAIPersonDetail::getIndex() const {
    return m_index;
}
void OAIPersonDetail::setIndex(const qint32 &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAIPersonDetail::is_index_Set() const{
    return m_index_isSet;
}

bool OAIPersonDetail::is_index_Valid() const{
    return m_index_isValid;
}

OAIPersonDetail_BoundingBox OAIPersonDetail::getBoundingBox() const {
    return m_bounding_box;
}
void OAIPersonDetail::setBoundingBox(const OAIPersonDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIPersonDetail::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIPersonDetail::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAIPersonDetail_Face OAIPersonDetail::getFace() const {
    return m_face;
}
void OAIPersonDetail::setFace(const OAIPersonDetail_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAIPersonDetail::is_face_Set() const{
    return m_face_isSet;
}

bool OAIPersonDetail::is_face_Valid() const{
    return m_face_isValid;
}

bool OAIPersonDetail::isSet() const {
...
bool OAIPersonDetail::isValid() const {
