...
#include "OAIGetFaceDetectionResponse.h"
...
OAIGetFaceDetectionResponse::OAIGetFaceDetectionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetFaceDetectionResponse::OAIGetFaceDetectionResponse() {
    this->initializeModel();
}

OAIGetFaceDetectionResponse::~OAIGetFaceDetectionResponse() {}

void OAIGetFaceDetectionResponse::initializeModel() {
...
void OAIGetFaceDetectionResponse::fromJson(QString jsonString) {
...
void OAIGetFaceDetectionResponse::fromJsonObject(QJsonObject json) {
...
QString OAIGetFaceDetectionResponse::asJson() const {
...
QJsonObject OAIGetFaceDetectionResponse::asJsonObject() const {
    QJsonObject obj;
...
OAIVideoJobStatus OAIGetFaceDetectionResponse::getJobStatus() const {
    return m_job_status;
}
void OAIGetFaceDetectionResponse::setJobStatus(const OAIVideoJobStatus &job_status) {
    m_job_status = job_status;
    m_job_status_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_job_status_Set() const{
    return m_job_status_isSet;
}

bool OAIGetFaceDetectionResponse::is_job_status_Valid() const{
    return m_job_status_isValid;
}

QString OAIGetFaceDetectionResponse::getStatusMessage() const {
    return m_status_message;
}
void OAIGetFaceDetectionResponse::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIGetFaceDetectionResponse::is_status_message_Valid() const{
    return m_status_message_isValid;
}

OAIGetFaceDetectionResponse_VideoMetadata OAIGetFaceDetectionResponse::getVideoMetadata() const {
    return m_video_metadata;
}
void OAIGetFaceDetectionResponse::setVideoMetadata(const OAIGetFaceDetectionResponse_VideoMetadata &video_metadata) {
    m_video_metadata = video_metadata;
    m_video_metadata_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_video_metadata_Set() const{
    return m_video_metadata_isSet;
}

bool OAIGetFaceDetectionResponse::is_video_metadata_Valid() const{
    return m_video_metadata_isValid;
}

QString OAIGetFaceDetectionResponse::getNextToken() const {
    return m_next_token;
}
void OAIGetFaceDetectionResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetFaceDetectionResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

QList OAIGetFaceDetectionResponse::getFaces() const {
    return m_faces;
}
void OAIGetFaceDetectionResponse::setFaces(const QList &faces) {
    m_faces = faces;
    m_faces_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_faces_Set() const{
    return m_faces_isSet;
}

bool OAIGetFaceDetectionResponse::is_faces_Valid() const{
    return m_faces_isValid;
}

QString OAIGetFaceDetectionResponse::getJobId() const {
    return m_job_id;
}
void OAIGetFaceDetectionResponse::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetFaceDetectionResponse::is_job_id_Valid() const{
    return m_job_id_isValid;
}

OAIVideo OAIGetFaceDetectionResponse::getVideo() const {
    return m_video;
}
void OAIGetFaceDetectionResponse::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_video_Set() const{
    return m_video_isSet;
}

bool OAIGetFaceDetectionResponse::is_video_Valid() const{
    return m_video_isValid;
}

QString OAIGetFaceDetectionResponse::getJobTag() const {
    return m_job_tag;
}
void OAIGetFaceDetectionResponse::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIGetFaceDetectionResponse::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIGetFaceDetectionResponse::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIGetFaceDetectionResponse::isSet() const {
...
bool OAIGetFaceDetectionResponse::isValid() const {
