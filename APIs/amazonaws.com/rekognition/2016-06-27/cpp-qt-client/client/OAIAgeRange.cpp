...
OAIAgeRange::OAIAgeRange(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAgeRange::OAIAgeRange() {
    this->initializeModel();
}

OAIAgeRange::~OAIAgeRange() {}

void OAIAgeRange::initializeModel() {
...
void OAIAgeRange::fromJson(QString jsonString) {
...
void OAIAgeRange::fromJsonObject(QJsonObject json) {
...
QString OAIAgeRange::asJson() const {
...
QJsonObject OAIAgeRange::asJsonObject() const {
    QJsonObject obj;
    if (m_low_isSet) {
...
qint32 OAIAgeRange::getLow() const {
    return m_low;
}
void OAIAgeRange::setLow(const qint32 &low) {
    m_low = low;
    m_low_isSet = true;
}

bool OAIAgeRange::is_low_Set() const{
    return m_low_isSet;
}

bool OAIAgeRange::is_low_Valid() const{
    return m_low_isValid;
}

qint32 OAIAgeRange::getHigh() const {
    return m_high;
}
void OAIAgeRange::setHigh(const qint32 &high) {
    m_high = high;
    m_high_isSet = true;
}

bool OAIAgeRange::is_high_Set() const{
    return m_high_isSet;
}

bool OAIAgeRange::is_high_Valid() const{
    return m_high_isValid;
}

bool OAIAgeRange::isSet() const {
...
bool OAIAgeRange::isValid() const {
