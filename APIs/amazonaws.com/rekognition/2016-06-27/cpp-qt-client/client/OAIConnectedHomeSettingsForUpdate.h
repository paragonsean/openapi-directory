...
/*
 * OAIConnectedHomeSettingsForUpdate.h
 *
...
#ifndef OAIConnectedHomeSettingsForUpdate_H
#define OAIConnectedHomeSettingsForUpdate_H
...
class OAIConnectedHomeSettingsForUpdate : public OAIObject {
public:
    OAIConnectedHomeSettingsForUpdate();
    OAIConnectedHomeSettingsForUpdate(QString json);
    ~OAIConnectedHomeSettingsForUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIConnectedHomeSettingsForUpdate)

#endif // OAIConnectedHomeSettingsForUpdate_H
