...
/*
 * OAIStartTechnicalCueDetectionFilter_BlackFrame.h
 *
 * 
 */

#ifndef OAIStartTechnicalCueDetectionFilter_BlackFrame_H
#define OAIStartTechnicalCueDetectionFilter_BlackFrame_H
...
class OAIStartTechnicalCueDetectionFilter_BlackFrame : public OAIObject {
public:
    OAIStartTechnicalCueDetectionFilter_BlackFrame();
    OAIStartTechnicalCueDetectionFilter_BlackFrame(QString json);
    ~OAIStartTechnicalCueDetectionFilter_BlackFrame() override;
    ...
    float getMaxPixelThreshold() const;
    void setMaxPixelThreshold(const float &max_pixel_threshold);
    bool is_max_pixel_threshold_Set() const;
    bool is_max_pixel_threshold_Valid() const;

    float getMinCoveragePercentage() const;
    void setMinCoveragePercentage(const float &min_coverage_percentage);
    bool is_min_coverage_percentage_Set() const;
    bool is_min_coverage_percentage_Valid() const;
...
private:
    ...
    float m_max_pixel_threshold;
    bool m_max_pixel_threshold_isSet;
    bool m_max_pixel_threshold_isValid;

    float m_min_coverage_percentage;
    bool m_min_coverage_percentage_isSet;
    bool m_min_coverage_percentage_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartTechnicalCueDetectionFilter_BlackFrame)

#endif // OAIStartTechnicalCueDetectionFilter_BlackFrame_H
