...
/*
 * OAIDeleteFacesResponse.h
 *
 * 
 */

#ifndef OAIDeleteFacesResponse_H
#define OAIDeleteFacesResponse_H
...
class OAIDeleteFacesResponse : public OAIObject {
public:
    OAIDeleteFacesResponse();
    OAIDeleteFacesResponse(QString json);
    ~OAIDeleteFacesResponse() override;
    ...
    QList getDeletedFaces() const;
    void setDeletedFaces(const QList &deleted_faces);
    bool is_deleted_faces_Set() const;
    bool is_deleted_faces_Valid() const;

    QList getUnsuccessfulFaceDeletions() const;
    void setUnsuccessfulFaceDeletions(const QList &unsuccessful_face_deletions);
    bool is_unsuccessful_face_deletions_Set() const;
    bool is_unsuccessful_face_deletions_Valid() const;
...
private:
    ...
    QList m_deleted_faces;
    bool m_deleted_faces_isSet;
    bool m_deleted_faces_isValid;

    QList m_unsuccessful_face_deletions;
    bool m_unsuccessful_face_deletions_isSet;
    bool m_unsuccessful_face_deletions_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDeleteFacesResponse)

#endif // OAIDeleteFacesResponse_H
