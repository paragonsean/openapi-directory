...
#include "OAIKinesisVideoStreamStartSelector.h"
...
OAIKinesisVideoStreamStartSelector::OAIKinesisVideoStreamStartSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKinesisVideoStreamStartSelector::OAIKinesisVideoStreamStartSelector() {
    this->initializeModel();
}

OAIKinesisVideoStreamStartSelector::~OAIKinesisVideoStreamStartSelector() {}

void OAIKinesisVideoStreamStartSelector::initializeModel() {
...
void OAIKinesisVideoStreamStartSelector::fromJson(QString jsonString) {
...
void OAIKinesisVideoStreamStartSelector::fromJsonObject(QJsonObject json) {
...
QString OAIKinesisVideoStreamStartSelector::asJson() const {
...
QJsonObject OAIKinesisVideoStreamStartSelector::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIKinesisVideoStreamStartSelector::getProducerTimestamp() const {
    return m_producer_timestamp;
}
void OAIKinesisVideoStreamStartSelector::setProducerTimestamp(const qint32 &producer_timestamp) {
    m_producer_timestamp = producer_timestamp;
    m_producer_timestamp_isSet = true;
}

bool OAIKinesisVideoStreamStartSelector::is_producer_timestamp_Set() const{
    return m_producer_timestamp_isSet;
}

bool OAIKinesisVideoStreamStartSelector::is_producer_timestamp_Valid() const{
    return m_producer_timestamp_isValid;
}

QString OAIKinesisVideoStreamStartSelector::getFragmentNumber() const {
    return m_fragment_number;
}
void OAIKinesisVideoStreamStartSelector::setFragmentNumber(const QString &fragment_number) {
    m_fragment_number = fragment_number;
    m_fragment_number_isSet = true;
}

bool OAIKinesisVideoStreamStartSelector::is_fragment_number_Set() const{
    return m_fragment_number_isSet;
}

bool OAIKinesisVideoStreamStartSelector::is_fragment_number_Valid() const{
    return m_fragment_number_isValid;
}

bool OAIKinesisVideoStreamStartSelector::isSet() const {
...
bool OAIKinesisVideoStreamStartSelector::isValid() const {
