...
#include "OAIDatasetDescription.h"
...
OAIDatasetDescription::OAIDatasetDescription(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDatasetDescription::OAIDatasetDescription() {
    this->initializeModel();
}

OAIDatasetDescription::~OAIDatasetDescription() {}

void OAIDatasetDescription::initializeModel() {
    ...
    m_status_message_code_isSet = false;
    m_status_message_code_isValid = false;

    m_dataset_stats_isSet = false;
    m_dataset_stats_isValid = false;
}

void OAIDatasetDescription::fromJson(QString jsonString) {
...
void OAIDatasetDescription::fromJsonObject(QJsonObject json) {
    ...
    m_status_message_code_isValid = ::OpenAPI::fromJsonValue(m_status_message_code, json[QString("StatusMessageCode")]);
    m_status_message_code_isSet = !json[QString("StatusMessageCode")].isNull() && m_status_message_code_isValid;

    m_dataset_stats_isValid = ::OpenAPI::fromJsonValue(m_dataset_stats, json[QString("DatasetStats")]);
    m_dataset_stats_isSet = !json[QString("DatasetStats")].isNull() && m_dataset_stats_isValid;
}

QString OAIDatasetDescription::asJson() const {
...
QJsonObject OAIDatasetDescription::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_status_message_code.isSet()) {
        obj.insert(QString("StatusMessageCode"), ::OpenAPI::toJsonValue(m_status_message_code));
    }
    if (m_dataset_stats.isSet()) {
        obj.insert(QString("DatasetStats"), ::OpenAPI::toJsonValue(m_dataset_stats));
    }
    return obj;
}

QDateTime OAIDatasetDescription::getCreationTimestamp() const {
    return m_creation_timestamp;
}
void OAIDatasetDescription::setCreationTimestamp(const QDateTime &creation_timestamp) {
    m_creation_timestamp = creation_timestamp;
    m_creation_timestamp_isSet = true;
}

bool OAIDatasetDescription::is_creation_timestamp_Set() const{
    return m_creation_timestamp_isSet;
}

bool OAIDatasetDescription::is_creation_timestamp_Valid() const{
    return m_creation_timestamp_isValid;
}

QDateTime OAIDatasetDescription::getLastUpdatedTimestamp() const {
    return m_last_updated_timestamp;
}
void OAIDatasetDescription::setLastUpdatedTimestamp(const QDateTime &last_updated_timestamp) {
    m_last_updated_timestamp = last_updated_timestamp;
    m_last_updated_timestamp_isSet = true;
}

bool OAIDatasetDescription::is_last_updated_timestamp_Set() const{
    return m_last_updated_timestamp_isSet;
}

bool OAIDatasetDescription::is_last_updated_timestamp_Valid() const{
    return m_last_updated_timestamp_isValid;
}

OAIDatasetStatus OAIDatasetDescription::getStatus() const {
    return m_status;
}
void OAIDatasetDescription::setStatus(const OAIDatasetStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIDatasetDescription::is_status_Set() const{
    return m_status_isSet;
}

bool OAIDatasetDescription::is_status_Valid() const{
    return m_status_isValid;
}

QString OAIDatasetDescription::getStatusMessage() const {
    return m_status_message;
}
void OAIDatasetDescription::setStatusMessage(const QString &status_message) {
    m_status_message = status_message;
    m_status_message_isSet = true;
}

bool OAIDatasetDescription::is_status_message_Set() const{
    return m_status_message_isSet;
}

bool OAIDatasetDescription::is_status_message_Valid() const{
    return m_status_message_isValid;
}

OAIDatasetStatusMessageCode OAIDatasetDescription::getStatusMessageCode() const {
    return m_status_message_code;
}
void OAIDatasetDescription::setStatusMessageCode(const OAIDatasetStatusMessageCode &status_message_code) {
    m_status_message_code = status_message_code;
    m_status_message_code_isSet = true;
}

bool OAIDatasetDescription::is_status_message_code_Set() const{
    return m_status_message_code_isSet;
}

bool OAIDatasetDescription::is_status_message_code_Valid() const{
    return m_status_message_code_isValid;
}

OAIDatasetDescription_DatasetStats OAIDatasetDescription::getDatasetStats() const {
    return m_dataset_stats;
}
void OAIDatasetDescription::setDatasetStats(const OAIDatasetDescription_DatasetStats &dataset_stats) {
    m_dataset_stats = dataset_stats;
    m_dataset_stats_isSet = true;
}

bool OAIDatasetDescription::is_dataset_stats_Set() const{
    return m_dataset_stats_isSet;
}

bool OAIDatasetDescription::is_dataset_stats_Valid() const{
    return m_dataset_stats_isValid;
}

bool OAIDatasetDescription::isSet() const {
...
bool OAIDatasetDescription::isValid() const {
