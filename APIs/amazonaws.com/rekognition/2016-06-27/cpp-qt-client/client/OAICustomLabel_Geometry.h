...
/*
 * OAICustomLabel_Geometry.h
 *
 * 
 */

#ifndef OAICustomLabel_Geometry_H
#define OAICustomLabel_Geometry_H
...
class OAICustomLabel_Geometry : public OAIObject {
public:
    OAICustomLabel_Geometry();
    OAICustomLabel_Geometry(QString json);
    ~OAICustomLabel_Geometry() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICustomLabel_Geometry)

#endif // OAICustomLabel_Geometry_H
