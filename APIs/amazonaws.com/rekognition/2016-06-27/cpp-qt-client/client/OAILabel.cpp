...
float OAILabel::getConfidence() const {
    return m_confidence;
}
void OAILabel::setConfidence(const float &confidence) {
...
QList OAILabel::getInstances() const {
    return m_instances;
}
void OAILabel::setInstances(const QList &instances) {
    m_instances = instances;
    m_instances_isSet = true;
}

bool OAILabel::is_instances_Set() const{
    return m_instances_isSet;
}

bool OAILabel::is_instances_Valid() const{
    return m_instances_isValid;
}

QList OAILabel::getParents() const {
    return m_parents;
}
void OAILabel::setParents(const QList &parents) {
    m_parents = parents;
    m_parents_isSet = true;
}

bool OAILabel::is_parents_Set() const{
    return m_parents_isSet;
}

bool OAILabel::is_parents_Valid() const{
    return m_parents_isValid;
}

QList OAILabel::getAliases() const {
    return m_aliases;
}
void OAILabel::setAliases(const QList &aliases) {
    m_aliases = aliases;
    m_aliases_isSet = true;
}

bool OAILabel::is_aliases_Set() const{
    return m_aliases_isSet;
}

bool OAILabel::is_aliases_Valid() const{
    return m_aliases_isValid;
}

QList OAILabel::getCategories() const {
    return m_categories;
}
void OAILabel::setCategories(const QList &categories) {
    m_categories = categories;
    m_categories_isSet = true;
}

bool OAILabel::is_categories_Set() const{
    return m_categories_isSet;
}

bool OAILabel::is_categories_Valid() const{
