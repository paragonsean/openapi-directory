...
/*
 * OAIPutProjectPolicyResponse.h
 *
 * 
 */

#ifndef OAIPutProjectPolicyResponse_H
#define OAIPutProjectPolicyResponse_H
...
class OAIPutProjectPolicyResponse : public OAIObject {
public:
    OAIPutProjectPolicyResponse();
    OAIPutProjectPolicyResponse(QString json);
    ~OAIPutProjectPolicyResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPutProjectPolicyResponse)

#endif // OAIPutProjectPolicyResponse_H
