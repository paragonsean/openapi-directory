...
/*
 * OAIDetectModerationLabelsRequest_HumanLoopConfig.h
 *
 * 
 */

#ifndef OAIDetectModerationLabelsRequest_HumanLoopConfig_H
#define OAIDetectModerationLabelsRequest_HumanLoopConfig_H
...
class OAIDetectModerationLabelsRequest_HumanLoopConfig : public OAIObject {
public:
    OAIDetectModerationLabelsRequest_HumanLoopConfig();
    OAIDetectModerationLabelsRequest_HumanLoopConfig(QString json);
    ~OAIDetectModerationLabelsRequest_HumanLoopConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectModerationLabelsRequest_HumanLoopConfig)

#endif // OAIDetectModerationLabelsRequest_HumanLoopConfig_H
