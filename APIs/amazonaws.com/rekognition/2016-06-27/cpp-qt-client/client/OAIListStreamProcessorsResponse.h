...
/*
 * OAIListStreamProcessorsResponse.h
 *
 * 
 */

#ifndef OAIListStreamProcessorsResponse_H
#define OAIListStreamProcessorsResponse_H
...
class OAIListStreamProcessorsResponse : public OAIObject {
public:
    OAIListStreamProcessorsResponse();
    OAIListStreamProcessorsResponse(QString json);
    ~OAIListStreamProcessorsResponse() override;
    ...
    QList getStreamProcessors() const;
    void setStreamProcessors(const QList &stream_processors);
    bool is_stream_processors_Set() const;
    bool is_stream_processors_Valid() const;
...
private:
    ...
    QList m_stream_processors;
    bool m_stream_processors_isSet;
    bool m_stream_processors_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIListStreamProcessorsResponse)

#endif // OAIListStreamProcessorsResponse_H
