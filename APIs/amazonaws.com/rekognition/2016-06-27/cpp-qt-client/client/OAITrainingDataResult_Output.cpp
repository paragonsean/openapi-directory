...
#include "OAITrainingDataResult_Output.h"
...
OAITrainingDataResult_Output::OAITrainingDataResult_Output(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingDataResult_Output::OAITrainingDataResult_Output() {
    this->initializeModel();
}

OAITrainingDataResult_Output::~OAITrainingDataResult_Output() {}

void OAITrainingDataResult_Output::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAITrainingDataResult_Output::fromJson(QString jsonString) {
...
void OAITrainingDataResult_Output::fromJsonObject(QJsonObject json) {
...
QString OAITrainingDataResult_Output::asJson() const {
...
QJsonObject OAITrainingDataResult_Output::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITrainingDataResult_Output::getAssets() const {
    return m_assets;
}
void OAITrainingDataResult_Output::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITrainingDataResult_Output::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITrainingDataResult_Output::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITrainingDataResult_Output::isSet() const {
...
bool OAITrainingDataResult_Output::isValid() const {
