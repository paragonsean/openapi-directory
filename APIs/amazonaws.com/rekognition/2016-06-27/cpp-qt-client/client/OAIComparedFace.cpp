...
OAIComparedFace::OAIComparedFace(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIComparedFace::OAIComparedFace() {
    this->initializeModel();
}

OAIComparedFace::~OAIComparedFace() {}

void OAIComparedFace::initializeModel() {
...
void OAIComparedFace::fromJson(QString jsonString) {
...
void OAIComparedFace::fromJsonObject(QJsonObject json) {
...
QString OAIComparedFace::asJson() const {
...
QJsonObject OAIComparedFace::asJsonObject() const {
    QJsonObject obj;
...
OAIComparedFace_BoundingBox OAIComparedFace::getBoundingBox() const {
    return m_bounding_box;
}
void OAIComparedFace::setBoundingBox(const OAIComparedFace_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIComparedFace::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIComparedFace::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

float OAIComparedFace::getConfidence() const {
    return m_confidence;
}
void OAIComparedFace::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIComparedFace::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIComparedFace::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QList OAIComparedFace::getLandmarks() const {
    return m_landmarks;
}
void OAIComparedFace::setLandmarks(const QList &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAIComparedFace::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAIComparedFace::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

OAIComparedFace_Pose OAIComparedFace::getPose() const {
    return m_pose;
}
void OAIComparedFace::setPose(const OAIComparedFace_Pose &pose) {
    m_pose = pose;
    m_pose_isSet = true;
}

bool OAIComparedFace::is_pose_Set() const{
    return m_pose_isSet;
}

bool OAIComparedFace::is_pose_Valid() const{
    return m_pose_isValid;
}

OAIComparedFace_Quality OAIComparedFace::getQuality() const {
    return m_quality;
}
void OAIComparedFace::setQuality(const OAIComparedFace_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIComparedFace::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIComparedFace::is_quality_Valid() const{
    return m_quality_isValid;
}

QList OAIComparedFace::getEmotions() const {
    return m_emotions;
}
void OAIComparedFace::setEmotions(const QList &emotions) {
    m_emotions = emotions;
    m_emotions_isSet = true;
}

bool OAIComparedFace::is_emotions_Set() const{
    return m_emotions_isSet;
}

bool OAIComparedFace::is_emotions_Valid() const{
    return m_emotions_isValid;
}

OAIComparedFace_Smile OAIComparedFace::getSmile() const {
    return m_smile;
}
void OAIComparedFace::setSmile(const OAIComparedFace_Smile &smile) {
    m_smile = smile;
    m_smile_isSet = true;
}

bool OAIComparedFace::is_smile_Set() const{
    return m_smile_isSet;
}

bool OAIComparedFace::is_smile_Valid() const{
    return m_smile_isValid;
}

bool OAIComparedFace::isSet() const {
...
bool OAIComparedFace::isValid() const {
