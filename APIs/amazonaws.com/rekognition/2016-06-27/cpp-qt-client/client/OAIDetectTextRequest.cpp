...
#include "OAIDetectTextRequest.h"
...
OAIDetectTextRequest::OAIDetectTextRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectTextRequest::OAIDetectTextRequest() {
    this->initializeModel();
}

OAIDetectTextRequest::~OAIDetectTextRequest() {}

void OAIDetectTextRequest::initializeModel() {
...
void OAIDetectTextRequest::fromJson(QString jsonString) {
...
void OAIDetectTextRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDetectTextRequest::asJson() const {
...
QJsonObject OAIDetectTextRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_image.isSet()) {
...
OAIDetectTextRequest_Image OAIDetectTextRequest::getImage() const {
    return m_image;
}
void OAIDetectTextRequest::setImage(const OAIDetectTextRequest_Image &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIDetectTextRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIDetectTextRequest::is_image_Valid() const{
    return m_image_isValid;
}

OAIDetectTextRequest_Filters OAIDetectTextRequest::getFilters() const {
    return m_filters;
}
void OAIDetectTextRequest::setFilters(const OAIDetectTextRequest_Filters &filters) {
    m_filters = filters;
    m_filters_isSet = true;
}

bool OAIDetectTextRequest::is_filters_Set() const{
    return m_filters_isSet;
}

bool OAIDetectTextRequest::is_filters_Valid() const{
    return m_filters_isValid;
}

bool OAIDetectTextRequest::isSet() const {
...
bool OAIDetectTextRequest::isValid() const {
