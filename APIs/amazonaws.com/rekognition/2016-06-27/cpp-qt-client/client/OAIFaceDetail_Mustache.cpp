...
#include "OAIFaceDetail_Mustache.h"
...
OAIFaceDetail_Mustache::OAIFaceDetail_Mustache(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_Mustache::OAIFaceDetail_Mustache() {
    this->initializeModel();
}

OAIFaceDetail_Mustache::~OAIFaceDetail_Mustache() {}

void OAIFaceDetail_Mustache::initializeModel() {
...
void OAIFaceDetail_Mustache::fromJson(QString jsonString) {
...
void OAIFaceDetail_Mustache::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_Mustache::asJson() const {
...
QJsonObject OAIFaceDetail_Mustache::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAIFaceDetail_Mustache::getValue() const {
    return m_value;
}
void OAIFaceDetail_Mustache::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAIFaceDetail_Mustache::is_value_Set() const{
    return m_value_isSet;
}

bool OAIFaceDetail_Mustache::is_value_Valid() const{
    return m_value_isValid;
}

float OAIFaceDetail_Mustache::getConfidence() const {
    return m_confidence;
}
void OAIFaceDetail_Mustache::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceDetail_Mustache::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceDetail_Mustache::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAIFaceDetail_Mustache::isSet() const {
...
bool OAIFaceDetail_Mustache::isValid() const {
