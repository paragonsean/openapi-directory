...
/*
 * OAISearchFacesByImageResponse.h
 *
 * 
 */

#ifndef OAISearchFacesByImageResponse_H
#define OAISearchFacesByImageResponse_H
...
namespace OpenAPI {
class OAISearchFacesByImageResponse_SearchedFaceBoundingBox;

class OAISearchFacesByImageResponse : public OAIObject {
public:
    OAISearchFacesByImageResponse();
    OAISearchFacesByImageResponse(QString json);
    ~OAISearchFacesByImageResponse() override;
    ...
    OAISearchFacesByImageResponse_SearchedFaceBoundingBox getSearchedFaceBoundingBox() const;
    void setSearchedFaceBoundingBox(const OAISearchFacesByImageResponse_SearchedFaceBoundingBox &searched_face_bounding_box);
    bool is_searched_face_bounding_box_Set() const;
    bool is_searched_face_bounding_box_Valid() const;

    float getSearchedFaceConfidence() const;
    void setSearchedFaceConfidence(const float &searched_face_confidence);
    bool is_searched_face_confidence_Set() const;
    bool is_searched_face_confidence_Valid() const;
    ...
    QString getFaceModelVersion() const;
    void setFaceModelVersion(const QString &face_model_version);
    bool is_face_model_version_Set() const;
    bool is_face_model_version_Valid() const;
...
private:
    ...
    OAISearchFacesByImageResponse_SearchedFaceBoundingBox m_searched_face_bounding_box;
    bool m_searched_face_bounding_box_isSet;
    bool m_searched_face_bounding_box_isValid;

    float m_searched_face_confidence;
    bool m_searched_face_confidence_isSet;
    bool m_searched_face_confidence_isValid;

    QList m_face_matches;
    bool m_face_matches_isSet;
    bool m_face_matches_isValid;

    QString m_face_model_version;
    bool m_face_model_version_isSet;
    bool m_face_model_version_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISearchFacesByImageResponse)

#endif // OAISearchFacesByImageResponse_H
