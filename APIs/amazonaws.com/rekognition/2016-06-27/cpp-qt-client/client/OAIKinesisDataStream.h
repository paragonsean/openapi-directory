...
/*
 * OAIKinesisDataStream.h
 *
 * The Kinesis data stream Amazon Rekognition to which the analysis results of a Amazon Rekognition stream processor are streamed. For more information, see CreateStreamProcessor in the Amazon Rekognition Developer Guide.
 */

#ifndef OAIKinesisDataStream_H
#define OAIKinesisDataStream_H
...
class OAIKinesisDataStream : public OAIObject {
public:
    OAIKinesisDataStream();
    OAIKinesisDataStream(QString json);
    ~OAIKinesisDataStream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIKinesisDataStream)

#endif // OAIKinesisDataStream_H
