...
/*
 * OAIDetectProtectiveEquipmentResponse_Summary.h
 *
 * 
 */

#ifndef OAIDetectProtectiveEquipmentResponse_Summary_H
#define OAIDetectProtectiveEquipmentResponse_Summary_H
...
class OAIDetectProtectiveEquipmentResponse_Summary : public OAIObject {
public:
    OAIDetectProtectiveEquipmentResponse_Summary();
    OAIDetectProtectiveEquipmentResponse_Summary(QString json);
    ~OAIDetectProtectiveEquipmentResponse_Summary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectProtectiveEquipmentResponse_Summary)

#endif // OAIDetectProtectiveEquipmentResponse_Summary_H
