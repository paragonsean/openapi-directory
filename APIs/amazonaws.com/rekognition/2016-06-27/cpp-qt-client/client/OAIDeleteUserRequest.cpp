...
QString OAIDeleteUserRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIDeleteUserRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIDeleteUserRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIDeleteUserRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

QString OAIDeleteUserRequest::getUserId() const {
    return m_user_id;
}
void OAIDeleteUserRequest::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIDeleteUserRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIDeleteUserRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIDeleteUserRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIDeleteUserRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIDeleteUserRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIDeleteUserRequest::is_client_request_token_Valid() const{
...
bool OAIDeleteUserRequest::isValid() const {
    ...
    return m_collection_id_isValid && m_user_id_isValid && true;
}
