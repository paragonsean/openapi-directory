...
/*
 * OAIStartLabelDetectionResponse.h
 *
 * 
 */

#ifndef OAIStartLabelDetectionResponse_H
#define OAIStartLabelDetectionResponse_H
...
class OAIStartLabelDetectionResponse : public OAIObject {
public:
    OAIStartLabelDetectionResponse();
    OAIStartLabelDetectionResponse(QString json);
    ~OAIStartLabelDetectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLabelDetectionResponse)

#endif // OAIStartLabelDetectionResponse_H
