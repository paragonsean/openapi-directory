...
OAICelebrity::OAICelebrity(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICelebrity::OAICelebrity() {
    this->initializeModel();
}

OAICelebrity::~OAICelebrity() {}

void OAICelebrity::initializeModel() {
...
void OAICelebrity::fromJson(QString jsonString) {
...
void OAICelebrity::fromJsonObject(QJsonObject json) {
...
QString OAICelebrity::asJson() const {
...
QJsonObject OAICelebrity::asJsonObject() const {
    QJsonObject obj;
    if (m_urls.isSet()) {
...
QList OAICelebrity::getUrls() const {
    return m_urls;
}
void OAICelebrity::setUrls(const QList &urls) {
    m_urls = urls;
    m_urls_isSet = true;
}

bool OAICelebrity::is_urls_Set() const{
    return m_urls_isSet;
}

bool OAICelebrity::is_urls_Valid() const{
    return m_urls_isValid;
}

QString OAICelebrity::getName() const {
    return m_name;
}
void OAICelebrity::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICelebrity::is_name_Set() const{
    return m_name_isSet;
}

bool OAICelebrity::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICelebrity::getId() const {
    return m_id;
}
void OAICelebrity::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICelebrity::is_id_Set() const{
    return m_id_isSet;
}

bool OAICelebrity::is_id_Valid() const{
    return m_id_isValid;
}

OAICelebrity_Face OAICelebrity::getFace() const {
    return m_face;
}
void OAICelebrity::setFace(const OAICelebrity_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAICelebrity::is_face_Set() const{
    return m_face_isSet;
}

bool OAICelebrity::is_face_Valid() const{
    return m_face_isValid;
}

float OAICelebrity::getMatchConfidence() const {
    return m_match_confidence;
}
void OAICelebrity::setMatchConfidence(const float &match_confidence) {
    m_match_confidence = match_confidence;
    m_match_confidence_isSet = true;
}

bool OAICelebrity::is_match_confidence_Set() const{
    return m_match_confidence_isSet;
}

bool OAICelebrity::is_match_confidence_Valid() const{
    return m_match_confidence_isValid;
}

OAIKnownGender OAICelebrity::getKnownGender() const {
    return m_known_gender;
}
void OAICelebrity::setKnownGender(const OAIKnownGender &known_gender) {
    m_known_gender = known_gender;
    m_known_gender_isSet = true;
}

bool OAICelebrity::is_known_gender_Set() const{
    return m_known_gender_isSet;
}

bool OAICelebrity::is_known_gender_Valid() const{
    return m_known_gender_isValid;
}

bool OAICelebrity::isSet() const {
...
bool OAICelebrity::isValid() const {
