...
/*
 * OAIDatasetStatusMessageCode.h
 *
 * 
 */

#ifndef OAIDatasetStatusMessageCode_H
#define OAIDatasetStatusMessageCode_H
...
class OAIDatasetStatusMessageCode : public OAIEnum {
public:
    OAIDatasetStatusMessageCode();
    OAIDatasetStatusMessageCode(QString json);
    ~OAIDatasetStatusMessageCode() override;
    ...
    enum class eOAIDatasetStatusMessageCode {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        SUCCESS, 
        SERVICE_ERROR, 
        CLIENT_ERROR
    };
    OAIDatasetStatusMessageCode::eOAIDatasetStatusMessageCode getValue() const;
    void setValue(const OAIDatasetStatusMessageCode::eOAIDatasetStatusMessageCode& value);
...
private:
    ...
    eOAIDatasetStatusMessageCode m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDatasetStatusMessageCode)

#endif // OAIDatasetStatusMessageCode_H
