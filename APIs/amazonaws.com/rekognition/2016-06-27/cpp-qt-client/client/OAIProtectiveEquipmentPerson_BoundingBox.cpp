...
OAIProtectiveEquipmentPerson_BoundingBox::OAIProtectiveEquipmentPerson_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProtectiveEquipmentPerson_BoundingBox::OAIProtectiveEquipmentPerson_BoundingBox() {
    this->initializeModel();
}

OAIProtectiveEquipmentPerson_BoundingBox::~OAIProtectiveEquipmentPerson_BoundingBox() {}

void OAIProtectiveEquipmentPerson_BoundingBox::initializeModel() {
...
void OAIProtectiveEquipmentPerson_BoundingBox::fromJson(QString jsonString) {
...
void OAIProtectiveEquipmentPerson_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAIProtectiveEquipmentPerson_BoundingBox::asJson() const {
...
QJsonObject OAIProtectiveEquipmentPerson_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAIProtectiveEquipmentPerson_BoundingBox::getWidth() const {
    return m_width;
}
void OAIProtectiveEquipmentPerson_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAIProtectiveEquipmentPerson_BoundingBox::getHeight() const {
    return m_height;
}
void OAIProtectiveEquipmentPerson_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAIProtectiveEquipmentPerson_BoundingBox::getLeft() const {
    return m_left;
}
void OAIProtectiveEquipmentPerson_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAIProtectiveEquipmentPerson_BoundingBox::getTop() const {
    return m_top;
}
void OAIProtectiveEquipmentPerson_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAIProtectiveEquipmentPerson_BoundingBox::isSet() const {
...
bool OAIProtectiveEquipmentPerson_BoundingBox::isValid() const {
