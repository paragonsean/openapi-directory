...
OAICelebrityRecognitionSortBy::OAICelebrityRecognitionSortBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICelebrityRecognitionSortBy::OAICelebrityRecognitionSortBy() {
    this->initializeModel();
}

OAICelebrityRecognitionSortBy::~OAICelebrityRecognitionSortBy() {}

void OAICelebrityRecognitionSortBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAICelebrityRecognitionSortBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAICelebrityRecognitionSortBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ID", Qt::CaseInsensitive) == 0) {
        m_value = eOAICelebrityRecognitionSortBy::ID;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMESTAMP", Qt::CaseInsensitive) == 0) {
        m_value = eOAICelebrityRecognitionSortBy::TIMESTAMP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAICelebrityRecognitionSortBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAICelebrityRecognitionSortBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAICelebrityRecognitionSortBy::ID:
            val = "ID";
            break;
        case eOAICelebrityRecognitionSortBy::TIMESTAMP:
            val = "TIMESTAMP";
            break;
        default:
            break;
...
QJsonValue OAICelebrityRecognitionSortBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAICelebrityRecognitionSortBy::eOAICelebrityRecognitionSortBy OAICelebrityRecognitionSortBy::getValue() const {
    return m_value;
}

void OAICelebrityRecognitionSortBy::setValue(const OAICelebrityRecognitionSortBy::eOAICelebrityRecognitionSortBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAICelebrityRecognitionSortBy::isSet() const {
    
    return m_value_isSet;
}

bool OAICelebrityRecognitionSortBy::isValid() const {
