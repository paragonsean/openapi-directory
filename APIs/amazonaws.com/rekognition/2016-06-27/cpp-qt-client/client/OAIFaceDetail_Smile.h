...
/*
 * OAIFaceDetail_Smile.h
 *
 * 
 */

#ifndef OAIFaceDetail_Smile_H
#define OAIFaceDetail_Smile_H
...
class OAIFaceDetail_Smile : public OAIObject {
public:
    OAIFaceDetail_Smile();
    OAIFaceDetail_Smile(QString json);
    ~OAIFaceDetail_Smile() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Smile)

#endif // OAIFaceDetail_Smile_H
