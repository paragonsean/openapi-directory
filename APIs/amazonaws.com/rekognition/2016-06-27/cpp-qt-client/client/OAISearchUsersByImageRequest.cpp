...
#include "OAISearchUsersByImageRequest.h"
...
OAISearchUsersByImageRequest::OAISearchUsersByImageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchUsersByImageRequest::OAISearchUsersByImageRequest() {
    this->initializeModel();
}

OAISearchUsersByImageRequest::~OAISearchUsersByImageRequest() {}

void OAISearchUsersByImageRequest::initializeModel() {
...
void OAISearchUsersByImageRequest::fromJson(QString jsonString) {
...
void OAISearchUsersByImageRequest::fromJsonObject(QJsonObject json) {
...
QString OAISearchUsersByImageRequest::asJson() const {
...
QJsonObject OAISearchUsersByImageRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAISearchUsersByImageRequest::getCollectionId() const {
    return m_collection_id;
}
void OAISearchUsersByImageRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAISearchUsersByImageRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAISearchUsersByImageRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

OAIImage OAISearchUsersByImageRequest::getImage() const {
    return m_image;
}
void OAISearchUsersByImageRequest::setImage(const OAIImage &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAISearchUsersByImageRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAISearchUsersByImageRequest::is_image_Valid() const{
    return m_image_isValid;
}

float OAISearchUsersByImageRequest::getUserMatchThreshold() const {
    return m_user_match_threshold;
}
void OAISearchUsersByImageRequest::setUserMatchThreshold(const float &user_match_threshold) {
    m_user_match_threshold = user_match_threshold;
    m_user_match_threshold_isSet = true;
}

bool OAISearchUsersByImageRequest::is_user_match_threshold_Set() const{
    return m_user_match_threshold_isSet;
}

bool OAISearchUsersByImageRequest::is_user_match_threshold_Valid() const{
    return m_user_match_threshold_isValid;
}

qint32 OAISearchUsersByImageRequest::getMaxUsers() const {
    return m_max_users;
}
void OAISearchUsersByImageRequest::setMaxUsers(const qint32 &max_users) {
    m_max_users = max_users;
    m_max_users_isSet = true;
}

bool OAISearchUsersByImageRequest::is_max_users_Set() const{
    return m_max_users_isSet;
}

bool OAISearchUsersByImageRequest::is_max_users_Valid() const{
    return m_max_users_isValid;
}

OAIQualityFilter OAISearchUsersByImageRequest::getQualityFilter() const {
    return m_quality_filter;
}
void OAISearchUsersByImageRequest::setQualityFilter(const OAIQualityFilter &quality_filter) {
    m_quality_filter = quality_filter;
    m_quality_filter_isSet = true;
}

bool OAISearchUsersByImageRequest::is_quality_filter_Set() const{
    return m_quality_filter_isSet;
}

bool OAISearchUsersByImageRequest::is_quality_filter_Valid() const{
    return m_quality_filter_isValid;
}

bool OAISearchUsersByImageRequest::isSet() const {
...
bool OAISearchUsersByImageRequest::isValid() const {
