...
/*
 * OAIRecognizeCelebritiesRequest.h
 *
 * 
 */

#ifndef OAIRecognizeCelebritiesRequest_H
#define OAIRecognizeCelebritiesRequest_H

#include <QJsonObject>

#include "OAICompareFacesRequest_SourceImage.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICompareFacesRequest_SourceImage;

class OAIRecognizeCelebritiesRequest : public OAIObject {
public:
    OAIRecognizeCelebritiesRequest();
    OAIRecognizeCelebritiesRequest(QString json);
    ~OAIRecognizeCelebritiesRequest() override;
    ...
    OAICompareFacesRequest_SourceImage getImage() const;
    void setImage(const OAICompareFacesRequest_SourceImage &image);
...
private:
    ...
    OAICompareFacesRequest_SourceImage m_image;
    bool m_image_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecognizeCelebritiesRequest)

#endif // OAIRecognizeCelebritiesRequest_H
