...
/*
 * OAILabelDetectionSettings.h
 *
 * Contains the specified filters that should be applied to a list of returned GENERAL_LABELS.
 */

#ifndef OAILabelDetectionSettings_H
#define OAILabelDetectionSettings_H

#include <QJsonObject>

#include "OAIGeneralLabelsSettings.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIGeneralLabelsSettings;

class OAILabelDetectionSettings : public OAIObject {
public:
    OAILabelDetectionSettings();
    OAILabelDetectionSettings(QString json);
    ~OAILabelDetectionSettings() override;
    ...
    OAIGeneralLabelsSettings getGeneralLabels() const;
    void setGeneralLabels(const OAIGeneralLabelsSettings &general_labels);
    bool is_general_labels_Set() const;
    bool is_general_labels_Valid() const;
...
private:
    ...
    OAIGeneralLabelsSettings m_general_labels;
    bool m_general_labels_isSet;
    bool m_general_labels_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAILabelDetectionSettings)

#endif // OAILabelDetectionSettings_H
