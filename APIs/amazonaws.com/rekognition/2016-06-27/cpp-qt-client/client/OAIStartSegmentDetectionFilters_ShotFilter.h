...
/*
 * OAIStartSegmentDetectionFilters_ShotFilter.h
 *
 * 
 */

#ifndef OAIStartSegmentDetectionFilters_ShotFilter_H
#define OAIStartSegmentDetectionFilters_ShotFilter_H
...
class OAIStartSegmentDetectionFilters_ShotFilter : public OAIObject {
public:
    OAIStartSegmentDetectionFilters_ShotFilter();
    OAIStartSegmentDetectionFilters_ShotFilter(QString json);
    ~OAIStartSegmentDetectionFilters_ShotFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSegmentDetectionFilters_ShotFilter)

#endif // OAIStartSegmentDetectionFilters_ShotFilter_H
