...
#include "OAIDetectProtectiveEquipmentResponse_Summary.h"
...
OAIDetectProtectiveEquipmentResponse_Summary::OAIDetectProtectiveEquipmentResponse_Summary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectProtectiveEquipmentResponse_Summary::OAIDetectProtectiveEquipmentResponse_Summary() {
    this->initializeModel();
}

OAIDetectProtectiveEquipmentResponse_Summary::~OAIDetectProtectiveEquipmentResponse_Summary() {}

void OAIDetectProtectiveEquipmentResponse_Summary::initializeModel() {

    m_persons_with_required_equipment_isSet = false;
    m_persons_with_required_equipment_isValid = false;

    m_persons_without_required_equipment_isSet = false;
    m_persons_without_required_equipment_isValid = false;

    m_persons_indeterminate_isSet = false;
    m_persons_indeterminate_isValid = false;
}

void OAIDetectProtectiveEquipmentResponse_Summary::fromJson(QString jsonString) {
...
void OAIDetectProtectiveEquipmentResponse_Summary::fromJsonObject(QJsonObject json) {

    m_persons_with_required_equipment_isValid = ::OpenAPI::fromJsonValue(m_persons_with_required_equipment, json[QString("PersonsWithRequiredEquipment")]);
    m_persons_with_required_equipment_isSet = !json[QString("PersonsWithRequiredEquipment")].isNull() && m_persons_with_required_equipment_isValid;

    m_persons_without_required_equipment_isValid = ::OpenAPI::fromJsonValue(m_persons_without_required_equipment, json[QString("PersonsWithoutRequiredEquipment")]);
    m_persons_without_required_equipment_isSet = !json[QString("PersonsWithoutRequiredEquipment")].isNull() && m_persons_without_required_equipment_isValid;

    m_persons_indeterminate_isValid = ::OpenAPI::fromJsonValue(m_persons_indeterminate, json[QString("PersonsIndeterminate")]);
    m_persons_indeterminate_isSet = !json[QString("PersonsIndeterminate")].isNull() && m_persons_indeterminate_isValid;
}

QString OAIDetectProtectiveEquipmentResponse_Summary::asJson() const {
...
QJsonObject OAIDetectProtectiveEquipmentResponse_Summary::asJsonObject() const {
    QJsonObject obj;
    if (m_persons_with_required_equipment.isSet()) {
        obj.insert(QString("PersonsWithRequiredEquipment"), ::OpenAPI::toJsonValue(m_persons_with_required_equipment));
    }
    if (m_persons_without_required_equipment.isSet()) {
        obj.insert(QString("PersonsWithoutRequiredEquipment"), ::OpenAPI::toJsonValue(m_persons_without_required_equipment));
    }
    if (m_persons_indeterminate.isSet()) {
        obj.insert(QString("PersonsIndeterminate"), ::OpenAPI::toJsonValue(m_persons_indeterminate));
    }
    return obj;
}

QList OAIDetectProtectiveEquipmentResponse_Summary::getPersonsWithRequiredEquipment() const {
    return m_persons_with_required_equipment;
}
void OAIDetectProtectiveEquipmentResponse_Summary::setPersonsWithRequiredEquipment(const QList &persons_with_required_equipment) {
    m_persons_with_required_equipment = persons_with_required_equipment;
    m_persons_with_required_equipment_isSet = true;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::is_persons_with_required_equipment_Set() const{
    return m_persons_with_required_equipment_isSet;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::is_persons_with_required_equipment_Valid() const{
    return m_persons_with_required_equipment_isValid;
}

QList OAIDetectProtectiveEquipmentResponse_Summary::getPersonsWithoutRequiredEquipment() const {
    return m_persons_without_required_equipment;
}
void OAIDetectProtectiveEquipmentResponse_Summary::setPersonsWithoutRequiredEquipment(const QList &persons_without_required_equipment) {
    m_persons_without_required_equipment = persons_without_required_equipment;
    m_persons_without_required_equipment_isSet = true;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::is_persons_without_required_equipment_Set() const{
    return m_persons_without_required_equipment_isSet;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::is_persons_without_required_equipment_Valid() const{
    return m_persons_without_required_equipment_isValid;
}

QList OAIDetectProtectiveEquipmentResponse_Summary::getPersonsIndeterminate() const {
    return m_persons_indeterminate;
}
void OAIDetectProtectiveEquipmentResponse_Summary::setPersonsIndeterminate(const QList &persons_indeterminate) {
    m_persons_indeterminate = persons_indeterminate;
    m_persons_indeterminate_isSet = true;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::is_persons_indeterminate_Set() const{
    return m_persons_indeterminate_isSet;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::is_persons_indeterminate_Valid() const{
    return m_persons_indeterminate_isValid;
}

bool OAIDetectProtectiveEquipmentResponse_Summary::isSet() const {
...
bool OAIDetectProtectiveEquipmentResponse_Summary::isValid() const {
