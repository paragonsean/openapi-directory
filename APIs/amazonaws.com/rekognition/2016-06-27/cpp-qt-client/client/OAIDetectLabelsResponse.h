...
/*
 * OAIDetectLabelsResponse.h
 *
 * 
 */

#ifndef OAIDetectLabelsResponse_H
#define OAIDetectLabelsResponse_H

#include <QJsonObject>

#include "OAIDetectLabelsResponse_ImageProperties.h"
...
namespace OpenAPI {
class OAIDetectLabelsResponse_ImageProperties;

class OAIDetectLabelsResponse : public OAIObject {
public:
    OAIDetectLabelsResponse();
    OAIDetectLabelsResponse(QString json);
    ~OAIDetectLabelsResponse() override;
    ...
    OAIDetectLabelsResponse_ImageProperties getImageProperties() const;
    void setImageProperties(const OAIDetectLabelsResponse_ImageProperties &image_properties);
...
private:
    ...
    OAIDetectLabelsResponse_ImageProperties m_image_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsResponse)

#endif // OAIDetectLabelsResponse_H
