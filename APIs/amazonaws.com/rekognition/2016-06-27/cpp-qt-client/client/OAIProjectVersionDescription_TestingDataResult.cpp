...
#include "OAIProjectVersionDescription_TestingDataResult.h"
...
OAIProjectVersionDescription_TestingDataResult::OAIProjectVersionDescription_TestingDataResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectVersionDescription_TestingDataResult::OAIProjectVersionDescription_TestingDataResult() {
    this->initializeModel();
}

OAIProjectVersionDescription_TestingDataResult::~OAIProjectVersionDescription_TestingDataResult() {}

void OAIProjectVersionDescription_TestingDataResult::initializeModel() {
...
void OAIProjectVersionDescription_TestingDataResult::fromJson(QString jsonString) {
...
void OAIProjectVersionDescription_TestingDataResult::fromJsonObject(QJsonObject json) {
...
QString OAIProjectVersionDescription_TestingDataResult::asJson() const {
...
QJsonObject OAIProjectVersionDescription_TestingDataResult::asJsonObject() const {
    QJsonObject obj;
    if (m_input.isSet()) {
...
OAITestingDataResult_Input OAIProjectVersionDescription_TestingDataResult::getInput() const {
    return m_input;
}
void OAIProjectVersionDescription_TestingDataResult::setInput(const OAITestingDataResult_Input &input) {
    m_input = input;
    m_input_isSet = true;
}

bool OAIProjectVersionDescription_TestingDataResult::is_input_Set() const{
    return m_input_isSet;
}

bool OAIProjectVersionDescription_TestingDataResult::is_input_Valid() const{
    return m_input_isValid;
}

OAITestingDataResult_Output OAIProjectVersionDescription_TestingDataResult::getOutput() const {
    return m_output;
}
void OAIProjectVersionDescription_TestingDataResult::setOutput(const OAITestingDataResult_Output &output) {
    m_output = output;
    m_output_isSet = true;
}

bool OAIProjectVersionDescription_TestingDataResult::is_output_Set() const{
    return m_output_isSet;
}

bool OAIProjectVersionDescription_TestingDataResult::is_output_Valid() const{
    return m_output_isValid;
}

OAITestingDataResult_Validation OAIProjectVersionDescription_TestingDataResult::getValidation() const {
    return m_validation;
}
void OAIProjectVersionDescription_TestingDataResult::setValidation(const OAITestingDataResult_Validation &validation) {
    m_validation = validation;
    m_validation_isSet = true;
}

bool OAIProjectVersionDescription_TestingDataResult::is_validation_Set() const{
    return m_validation_isSet;
}

bool OAIProjectVersionDescription_TestingDataResult::is_validation_Valid() const{
    return m_validation_isValid;
}

bool OAIProjectVersionDescription_TestingDataResult::isSet() const {
...
bool OAIProjectVersionDescription_TestingDataResult::isValid() const {
