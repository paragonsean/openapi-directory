...
/*
 * OAIUnsuccessfulFaceAssociation.h
 *
 * Contains metadata like FaceId, UserID, and Reasons, for a face that was unsuccessfully associated.
 */

#ifndef OAIUnsuccessfulFaceAssociation_H
#define OAIUnsuccessfulFaceAssociation_H
...
class OAIUnsuccessfulFaceAssociation : public OAIObject {
public:
    OAIUnsuccessfulFaceAssociation();
    OAIUnsuccessfulFaceAssociation(QString json);
    ~OAIUnsuccessfulFaceAssociation() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUnsuccessfulFaceAssociation)

#endif // OAIUnsuccessfulFaceAssociation_H
