...
/*
 * OAIDescribeProjectVersionsRequest.h
 *
 * 
 */

#ifndef OAIDescribeProjectVersionsRequest_H
#define OAIDescribeProjectVersionsRequest_H
...
class OAIDescribeProjectVersionsRequest : public OAIObject {
public:
    OAIDescribeProjectVersionsRequest();
    OAIDescribeProjectVersionsRequest(QString json);
    ~OAIDescribeProjectVersionsRequest() override;
    ...
    QList getVersionNames() const;
    void setVersionNames(const QList &version_names);
    bool is_version_names_Set() const;
    bool is_version_names_Valid() const;
...
private:
    ...
    QList m_version_names;
    bool m_version_names_isSet;
    bool m_version_names_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeProjectVersionsRequest)

#endif // OAIDescribeProjectVersionsRequest_H
