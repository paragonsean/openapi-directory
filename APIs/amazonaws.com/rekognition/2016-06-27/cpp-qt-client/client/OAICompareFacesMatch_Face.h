...
/*
 * OAICompareFacesMatch_Face.h
 *
 * 
 */

#ifndef OAICompareFacesMatch_Face_H
#define OAICompareFacesMatch_Face_H
...
class OAICompareFacesMatch_Face : public OAIObject {
public:
    OAICompareFacesMatch_Face();
    OAICompareFacesMatch_Face(QString json);
    ~OAICompareFacesMatch_Face() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesMatch_Face)

#endif // OAICompareFacesMatch_Face_H
