...
/*
 * OAICelebrityRecognitionSortBy.h
 *
 * 
 */

#ifndef OAICelebrityRecognitionSortBy_H
#define OAICelebrityRecognitionSortBy_H
...
class OAICelebrityRecognitionSortBy : public OAIEnum {
public:
    OAICelebrityRecognitionSortBy();
    OAICelebrityRecognitionSortBy(QString json);
    ~OAICelebrityRecognitionSortBy() override;
    ...
    enum class eOAICelebrityRecognitionSortBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        ID, 
        TIMESTAMP
    };
    OAICelebrityRecognitionSortBy::eOAICelebrityRecognitionSortBy getValue() const;
    void setValue(const OAICelebrityRecognitionSortBy::eOAICelebrityRecognitionSortBy& value);
...
private:
    ...
    eOAICelebrityRecognitionSortBy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAICelebrityRecognitionSortBy)

#endif // OAICelebrityRecognitionSortBy_H
