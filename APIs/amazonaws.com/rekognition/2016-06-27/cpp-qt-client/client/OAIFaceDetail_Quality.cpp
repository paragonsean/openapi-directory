...
OAIFaceDetail_Quality::OAIFaceDetail_Quality(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_Quality::OAIFaceDetail_Quality() {
    this->initializeModel();
}

OAIFaceDetail_Quality::~OAIFaceDetail_Quality() {}

void OAIFaceDetail_Quality::initializeModel() {
...
void OAIFaceDetail_Quality::fromJson(QString jsonString) {
...
void OAIFaceDetail_Quality::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_Quality::asJson() const {
...
QJsonObject OAIFaceDetail_Quality::asJsonObject() const {
    QJsonObject obj;
...
float OAIFaceDetail_Quality::getBrightness() const {
    return m_brightness;
}
void OAIFaceDetail_Quality::setBrightness(const float &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIFaceDetail_Quality::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIFaceDetail_Quality::is_brightness_Valid() const{
    return m_brightness_isValid;
}

float OAIFaceDetail_Quality::getSharpness() const {
    return m_sharpness;
}
void OAIFaceDetail_Quality::setSharpness(const float &sharpness) {
    m_sharpness = sharpness;
    m_sharpness_isSet = true;
}

bool OAIFaceDetail_Quality::is_sharpness_Set() const{
    return m_sharpness_isSet;
}

bool OAIFaceDetail_Quality::is_sharpness_Valid() const{
    return m_sharpness_isValid;
}

bool OAIFaceDetail_Quality::isSet() const {
...
bool OAIFaceDetail_Quality::isValid() const {
