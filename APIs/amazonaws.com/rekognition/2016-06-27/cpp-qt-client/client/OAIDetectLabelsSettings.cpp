...
#include "OAIDetectLabelsSettings.h"
...
OAIDetectLabelsSettings::OAIDetectLabelsSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsSettings::OAIDetectLabelsSettings() {
    this->initializeModel();
}

OAIDetectLabelsSettings::~OAIDetectLabelsSettings() {}

void OAIDetectLabelsSettings::initializeModel() {
...
void OAIDetectLabelsSettings::fromJson(QString jsonString) {
...
void OAIDetectLabelsSettings::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsSettings::asJson() const {
...
QJsonObject OAIDetectLabelsSettings::asJsonObject() const {
    QJsonObject obj;
...
OAIDetectLabelsSettings_GeneralLabels OAIDetectLabelsSettings::getGeneralLabels() const {
    return m_general_labels;
}
void OAIDetectLabelsSettings::setGeneralLabels(const OAIDetectLabelsSettings_GeneralLabels &general_labels) {
    m_general_labels = general_labels;
    m_general_labels_isSet = true;
}

bool OAIDetectLabelsSettings::is_general_labels_Set() const{
    return m_general_labels_isSet;
}

bool OAIDetectLabelsSettings::is_general_labels_Valid() const{
    return m_general_labels_isValid;
}

OAIDetectLabelsSettings_ImageProperties OAIDetectLabelsSettings::getImageProperties() const {
    return m_image_properties;
}
void OAIDetectLabelsSettings::setImageProperties(const OAIDetectLabelsSettings_ImageProperties &image_properties) {
    m_image_properties = image_properties;
    m_image_properties_isSet = true;
}

bool OAIDetectLabelsSettings::is_image_properties_Set() const{
    return m_image_properties_isSet;
}

bool OAIDetectLabelsSettings::is_image_properties_Valid() const{
    return m_image_properties_isValid;
}

bool OAIDetectLabelsSettings::isSet() const {
...
bool OAIDetectLabelsSettings::isValid() const {
