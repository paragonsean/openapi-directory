...
OAIPersonDetection::OAIPersonDetection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonDetection::OAIPersonDetection() {
    this->initializeModel();
}

OAIPersonDetection::~OAIPersonDetection() {}

void OAIPersonDetection::initializeModel() {
...
void OAIPersonDetection::fromJson(QString jsonString) {
...
void OAIPersonDetection::fromJsonObject(QJsonObject json) {
...
QString OAIPersonDetection::asJson() const {
...
QJsonObject OAIPersonDetection::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPersonDetection::getTimestamp() const {
    return m_timestamp;
}
void OAIPersonDetection::setTimestamp(const qint32 &timestamp) {
    m_timestamp = timestamp;
    m_timestamp_isSet = true;
}

bool OAIPersonDetection::is_timestamp_Set() const{
    return m_timestamp_isSet;
}

bool OAIPersonDetection::is_timestamp_Valid() const{
    return m_timestamp_isValid;
}

OAIPersonDetection_Person OAIPersonDetection::getPerson() const {
    return m_person;
}
void OAIPersonDetection::setPerson(const OAIPersonDetection_Person &person) {
    m_person = person;
    m_person_isSet = true;
}

bool OAIPersonDetection::is_person_Set() const{
    return m_person_isSet;
}

bool OAIPersonDetection::is_person_Valid() const{
    return m_person_isValid;
}

bool OAIPersonDetection::isSet() const {
...
bool OAIPersonDetection::isValid() const {
