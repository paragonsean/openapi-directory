...
#ifndef OAIDetectTextFilters_H
#define OAIDetectTextFilters_H

#include <QJsonObject>

#include "OAIDetectionFilter.h"
#include <QList>
...
namespace OpenAPI {
class OAIDetectionFilter;

class OAIDetectTextFilters : public OAIObject {
public:
    OAIDetectTextFilters();
    OAIDetectTextFilters(QString json);
    ~OAIDetectTextFilters() override;
    ...
    OAIDetectionFilter getWordFilter() const;
    void setWordFilter(const OAIDetectionFilter &word_filter);
...
private:
    ...
    OAIDetectionFilter m_word_filter;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectTextFilters)

#endif // OAIDetectTextFilters_H
