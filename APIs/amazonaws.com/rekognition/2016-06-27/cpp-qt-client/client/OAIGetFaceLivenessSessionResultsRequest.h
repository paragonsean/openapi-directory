...
/*
 * OAIGetFaceLivenessSessionResultsRequest.h
 *
 * 
 */

#ifndef OAIGetFaceLivenessSessionResultsRequest_H
#define OAIGetFaceLivenessSessionResultsRequest_H
...
class OAIGetFaceLivenessSessionResultsRequest : public OAIObject {
public:
    OAIGetFaceLivenessSessionResultsRequest();
    OAIGetFaceLivenessSessionResultsRequest(QString json);
    ~OAIGetFaceLivenessSessionResultsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceLivenessSessionResultsRequest)

#endif // OAIGetFaceLivenessSessionResultsRequest_H
