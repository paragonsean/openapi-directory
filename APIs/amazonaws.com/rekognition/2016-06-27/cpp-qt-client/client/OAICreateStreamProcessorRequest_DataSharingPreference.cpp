...
OAICreateStreamProcessorRequest_DataSharingPreference::OAICreateStreamProcessorRequest_DataSharingPreference(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamProcessorRequest_DataSharingPreference::OAICreateStreamProcessorRequest_DataSharingPreference() {
    this->initializeModel();
}

OAICreateStreamProcessorRequest_DataSharingPreference::~OAICreateStreamProcessorRequest_DataSharingPreference() {}

void OAICreateStreamProcessorRequest_DataSharingPreference::initializeModel() {

    m_opt_in_isSet = false;
    m_opt_in_isValid = false;
}

void OAICreateStreamProcessorRequest_DataSharingPreference::fromJson(QString jsonString) {
...
void OAICreateStreamProcessorRequest_DataSharingPreference::fromJsonObject(QJsonObject json) {
...
QString OAICreateStreamProcessorRequest_DataSharingPreference::asJson() const {
...
QJsonObject OAICreateStreamProcessorRequest_DataSharingPreference::asJsonObject() const {
    QJsonObject obj;
    if (m_opt_in_isSet) {
...
bool OAICreateStreamProcessorRequest_DataSharingPreference::getOptIn() const {
    return m_opt_in;
}
void OAICreateStreamProcessorRequest_DataSharingPreference::setOptIn(const bool &opt_in) {
    m_opt_in = opt_in;
    m_opt_in_isSet = true;
}

bool OAICreateStreamProcessorRequest_DataSharingPreference::is_opt_in_Set() const{
    return m_opt_in_isSet;
}

bool OAICreateStreamProcessorRequest_DataSharingPreference::is_opt_in_Valid() const{
    return m_opt_in_isValid;
}

bool OAICreateStreamProcessorRequest_DataSharingPreference::isSet() const {
...
bool OAICreateStreamProcessorRequest_DataSharingPreference::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_opt_in_isValid && true;
}
