...
/*
 * OAIFaceDetail_Mustache.h
 *
 * 
 */

#ifndef OAIFaceDetail_Mustache_H
#define OAIFaceDetail_Mustache_H
...
class OAIFaceDetail_Mustache : public OAIObject {
public:
    OAIFaceDetail_Mustache();
    OAIFaceDetail_Mustache(QString json);
    ~OAIFaceDetail_Mustache() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Mustache)

#endif // OAIFaceDetail_Mustache_H
