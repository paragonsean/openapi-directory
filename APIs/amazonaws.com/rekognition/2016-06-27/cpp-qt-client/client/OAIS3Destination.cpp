...
QString OAIS3Destination::getBucket() const {
    return m_bucket;
}
void OAIS3Destination::setBucket(const QString &bucket) {
    m_bucket = bucket;
    m_bucket_isSet = true;
}

bool OAIS3Destination::is_bucket_Set() const{
    return m_bucket_isSet;
}

bool OAIS3Destination::is_bucket_Valid() const{
