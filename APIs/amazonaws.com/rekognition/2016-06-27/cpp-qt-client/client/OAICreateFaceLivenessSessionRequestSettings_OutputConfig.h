...
/*
 * OAICreateFaceLivenessSessionRequestSettings_OutputConfig.h
 *
 * 
 */

#ifndef OAICreateFaceLivenessSessionRequestSettings_OutputConfig_H
#define OAICreateFaceLivenessSessionRequestSettings_OutputConfig_H
...
class OAICreateFaceLivenessSessionRequestSettings_OutputConfig : public OAIObject {
public:
    OAICreateFaceLivenessSessionRequestSettings_OutputConfig();
    OAICreateFaceLivenessSessionRequestSettings_OutputConfig(QString json);
    ~OAICreateFaceLivenessSessionRequestSettings_OutputConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateFaceLivenessSessionRequestSettings_OutputConfig)

#endif // OAICreateFaceLivenessSessionRequestSettings_OutputConfig_H
