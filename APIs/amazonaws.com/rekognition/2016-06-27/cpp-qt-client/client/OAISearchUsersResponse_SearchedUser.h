...
/*
 * OAISearchUsersResponse_SearchedUser.h
 *
 * 
 */

#ifndef OAISearchUsersResponse_SearchedUser_H
#define OAISearchUsersResponse_SearchedUser_H
...
class OAISearchUsersResponse_SearchedUser : public OAIObject {
public:
    OAISearchUsersResponse_SearchedUser();
    OAISearchUsersResponse_SearchedUser(QString json);
    ~OAISearchUsersResponse_SearchedUser() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchUsersResponse_SearchedUser)

#endif // OAISearchUsersResponse_SearchedUser_H
