...
#ifndef OAIKnownGender_H
#define OAIKnownGender_H
...
class OAIKnownGender : public OAIObject {
public:
    OAIKnownGender();
    OAIKnownGender(QString json);
    ~OAIKnownGender() override;
    ...
    OAIKnownGenderType getType() const;
    void setType(const OAIKnownGenderType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAIKnownGender)

#endif // OAIKnownGender_H
