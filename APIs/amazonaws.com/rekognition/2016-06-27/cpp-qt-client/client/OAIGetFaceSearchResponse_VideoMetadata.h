...
/*
 * OAIGetFaceSearchResponse_VideoMetadata.h
 *
 * 
 */

#ifndef OAIGetFaceSearchResponse_VideoMetadata_H
#define OAIGetFaceSearchResponse_VideoMetadata_H

#include <QJsonObject>

#include "OAIVideoColorRange.h"
#include <QString>
...
class OAIGetFaceSearchResponse_VideoMetadata : public OAIObject {
public:
    OAIGetFaceSearchResponse_VideoMetadata();
    OAIGetFaceSearchResponse_VideoMetadata(QString json);
    ~OAIGetFaceSearchResponse_VideoMetadata() override;
    ...
    void setFrameHeight(const qint32 &frame_height);
    bool is_frame_height_Set() const;
    bool is_frame_height_Valid() const;

    qint32 getFrameWidth() const;
    void setFrameWidth(const qint32 &frame_width);
    bool is_frame_width_Set() const;
    bool is_frame_width_Valid() const;

    OAIVideoColorRange getColorRange() const;
    void setColorRange(const OAIVideoColorRange &color_range);
...
private:
    ...
    qint32 m_frame_height;
    bool m_frame_height_isSet;
    bool m_frame_height_isValid;

    qint32 m_frame_width;
    bool m_frame_width_isSet;
    bool m_frame_width_isValid;

    OAIVideoColorRange m_color_range;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceSearchResponse_VideoMetadata)

#endif // OAIGetFaceSearchResponse_VideoMetadata_H
