...
#ifndef OAITextTypes_H
#define OAITextTypes_H
...
class OAITextTypes : public OAIEnum {
public:
    OAITextTypes();
    OAITextTypes(QString json);
    ~OAITextTypes() override;
    ...
    enum class eOAITextTypes {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        LINE, 
        WORD
    };
    OAITextTypes::eOAITextTypes getValue() const;
    void setValue(const OAITextTypes::eOAITextTypes& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAITextTypes)

#endif // OAITextTypes_H
