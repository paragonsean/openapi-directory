...
/*
 * OAIOrientationCorrection.h
 *
 * 
 */

#ifndef OAIOrientationCorrection_H
#define OAIOrientationCorrection_H
...
class OAIOrientationCorrection : public OAIEnum {
public:
    OAIOrientationCorrection();
    OAIOrientationCorrection(QString json);
    ~OAIOrientationCorrection() override;
    ...
    enum class eOAIOrientationCorrection {
    ...
    OAIOrientationCorrection::eOAIOrientationCorrection getValue() const;
    void setValue(const OAIOrientationCorrection::eOAIOrientationCorrection& value);
...
private:
    ...
    eOAIOrientationCorrection m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIOrientationCorrection)

#endif // OAIOrientationCorrection_H
