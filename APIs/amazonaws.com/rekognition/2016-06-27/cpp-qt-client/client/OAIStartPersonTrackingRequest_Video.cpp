...
OAIStartPersonTrackingRequest_Video::OAIStartPersonTrackingRequest_Video(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartPersonTrackingRequest_Video::OAIStartPersonTrackingRequest_Video() {
    this->initializeModel();
}

OAIStartPersonTrackingRequest_Video::~OAIStartPersonTrackingRequest_Video() {}

void OAIStartPersonTrackingRequest_Video::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIStartPersonTrackingRequest_Video::fromJson(QString jsonString) {
...
void OAIStartPersonTrackingRequest_Video::fromJsonObject(QJsonObject json) {
...
QString OAIStartPersonTrackingRequest_Video::asJson() const {
...
QJsonObject OAIStartPersonTrackingRequest_Video::asJsonObject() const {
    QJsonObject obj;
...
OAIVideo_S3Object OAIStartPersonTrackingRequest_Video::getS3Object() const {
    return m_s3_object;
}
void OAIStartPersonTrackingRequest_Video::setS3Object(const OAIVideo_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIStartPersonTrackingRequest_Video::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIStartPersonTrackingRequest_Video::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIStartPersonTrackingRequest_Video::isSet() const {
...
bool OAIStartPersonTrackingRequest_Video::isValid() const {
