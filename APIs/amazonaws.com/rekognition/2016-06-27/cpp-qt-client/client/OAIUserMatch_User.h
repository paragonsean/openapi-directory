...
#ifndef OAIUserMatch_User_H
#define OAIUserMatch_User_H
...
class OAIUserMatch_User : public OAIObject {
public:
    OAIUserMatch_User();
    OAIUserMatch_User(QString json);
    ~OAIUserMatch_User() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUserMatch_User)

#endif // OAIUserMatch_User_H
