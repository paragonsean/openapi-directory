...
OAIGroundTruthManifest OAIAsset::getGroundTruthManifest() const {
    return m_ground_truth_manifest;
}
void OAIAsset::setGroundTruthManifest(const OAIGroundTruthManifest &ground_truth_manifest) {
    m_ground_truth_manifest = ground_truth_manifest;
    m_ground_truth_manifest_isSet = true;
}

bool OAIAsset::is_ground_truth_manifest_Set() const{
    return m_ground_truth_manifest_isSet;
}

bool OAIAsset::is_ground_truth_manifest_Valid() const{
