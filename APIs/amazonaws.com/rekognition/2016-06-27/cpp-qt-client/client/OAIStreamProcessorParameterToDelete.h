...
/*
 * OAIStreamProcessorParameterToDelete.h
 *
 * 
 */

#ifndef OAIStreamProcessorParameterToDelete_H
#define OAIStreamProcessorParameterToDelete_H
...
class OAIStreamProcessorParameterToDelete : public OAIEnum {
public:
    OAIStreamProcessorParameterToDelete();
    OAIStreamProcessorParameterToDelete(QString json);
    ~OAIStreamProcessorParameterToDelete() override;
    ...
    enum class eOAIStreamProcessorParameterToDelete {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        CONNECTEDHOMEMINCONFIDENCE, 
        REGIONSOFINTEREST
    };
    OAIStreamProcessorParameterToDelete::eOAIStreamProcessorParameterToDelete getValue() const;
    void setValue(const OAIStreamProcessorParameterToDelete::eOAIStreamProcessorParameterToDelete& value);
...
private:
    ...
    eOAIStreamProcessorParameterToDelete m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorParameterToDelete)

#endif // OAIStreamProcessorParameterToDelete_H
