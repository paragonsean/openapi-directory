...
OAILabelCategory::OAILabelCategory(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAILabelCategory::OAILabelCategory() {
    this->initializeModel();
}

OAILabelCategory::~OAILabelCategory() {}

void OAILabelCategory::initializeModel() {

    m_name_isSet = false;
    m_name_isValid = false;
}

void OAILabelCategory::fromJson(QString jsonString) {
...
void OAILabelCategory::fromJsonObject(QJsonObject json) {

    m_name_isValid = ::OpenAPI::fromJsonValue(m_name, json[QString("Name")]);
    m_name_isSet = !json[QString("Name")].isNull() && m_name_isValid;
}

QString OAILabelCategory::asJson() const {
...
QJsonObject OAILabelCategory::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAILabelCategory::getName() const {
    return m_name;
}
void OAILabelCategory::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAILabelCategory::is_name_Set() const{
    return m_name_isSet;
}

bool OAILabelCategory::is_name_Valid() const{
    return m_name_isValid;
}

bool OAILabelCategory::isSet() const {
...
bool OAILabelCategory::isValid() const {
