...
QString OAIImage::getBytes() const {
    return m_bytes;
}
void OAIImage::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIImage::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIImage::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAIImage::getS3Object() const {
    return m_s3_object;
}
void OAIImage::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIImage::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIImage::is_s3_object_Valid() const{
