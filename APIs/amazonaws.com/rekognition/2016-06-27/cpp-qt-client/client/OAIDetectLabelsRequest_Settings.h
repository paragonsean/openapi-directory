...
/*
 * OAIDetectLabelsRequest_Settings.h
 *
 * 
 */

#ifndef OAIDetectLabelsRequest_Settings_H
#define OAIDetectLabelsRequest_Settings_H

#include <QJsonObject>

#include "OAIDetectLabelsSettings_GeneralLabels.h"
...
namespace OpenAPI {
class OAIDetectLabelsSettings_GeneralLabels;
class OAIDetectLabelsSettings_ImageProperties;

class OAIDetectLabelsRequest_Settings : public OAIObject {
public:
    OAIDetectLabelsRequest_Settings();
    OAIDetectLabelsRequest_Settings(QString json);
    ~OAIDetectLabelsRequest_Settings() override;
    ...
    OAIDetectLabelsSettings_GeneralLabels getGeneralLabels() const;
    void setGeneralLabels(const OAIDetectLabelsSettings_GeneralLabels &general_labels);
    bool is_general_labels_Set() const;
    bool is_general_labels_Valid() const;

    OAIDetectLabelsSettings_ImageProperties getImageProperties() const;
    void setImageProperties(const OAIDetectLabelsSettings_ImageProperties &image_properties);
...
private:
    ...
    OAIDetectLabelsSettings_GeneralLabels m_general_labels;
    bool m_general_labels_isSet;
    bool m_general_labels_isValid;

    OAIDetectLabelsSettings_ImageProperties m_image_properties;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsRequest_Settings)

#endif // OAIDetectLabelsRequest_Settings_H
