...
#include "OAISearchUsersByImageResponse.h"
...
OAISearchUsersByImageResponse::OAISearchUsersByImageResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchUsersByImageResponse::OAISearchUsersByImageResponse() {
    this->initializeModel();
}

OAISearchUsersByImageResponse::~OAISearchUsersByImageResponse() {}

void OAISearchUsersByImageResponse::initializeModel() {

    m_user_matches_isSet = false;
    m_user_matches_isValid = false;

    m_face_model_version_isSet = false;
    m_face_model_version_isValid = false;

    m_searched_face_isSet = false;
    m_searched_face_isValid = false;

    m_unsearched_faces_isSet = false;
    m_unsearched_faces_isValid = false;
}

void OAISearchUsersByImageResponse::fromJson(QString jsonString) {
...
void OAISearchUsersByImageResponse::fromJsonObject(QJsonObject json) {

    m_user_matches_isValid = ::OpenAPI::fromJsonValue(m_user_matches, json[QString("UserMatches")]);
    m_user_matches_isSet = !json[QString("UserMatches")].isNull() && m_user_matches_isValid;

    m_face_model_version_isValid = ::OpenAPI::fromJsonValue(m_face_model_version, json[QString("FaceModelVersion")]);
    m_face_model_version_isSet = !json[QString("FaceModelVersion")].isNull() && m_face_model_version_isValid;

    m_searched_face_isValid = ::OpenAPI::fromJsonValue(m_searched_face, json[QString("SearchedFace")]);
    m_searched_face_isSet = !json[QString("SearchedFace")].isNull() && m_searched_face_isValid;

    m_unsearched_faces_isValid = ::OpenAPI::fromJsonValue(m_unsearched_faces, json[QString("UnsearchedFaces")]);
    m_unsearched_faces_isSet = !json[QString("UnsearchedFaces")].isNull() && m_unsearched_faces_isValid;
}

QString OAISearchUsersByImageResponse::asJson() const {
...
QJsonObject OAISearchUsersByImageResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_user_matches.isSet()) {
        obj.insert(QString("UserMatches"), ::OpenAPI::toJsonValue(m_user_matches));
    }
    if (m_face_model_version_isSet) {
        obj.insert(QString("FaceModelVersion"), ::OpenAPI::toJsonValue(m_face_model_version));
    }
    if (m_searched_face.isSet()) {
        obj.insert(QString("SearchedFace"), ::OpenAPI::toJsonValue(m_searched_face));
    }
    if (m_unsearched_faces.isSet()) {
        obj.insert(QString("UnsearchedFaces"), ::OpenAPI::toJsonValue(m_unsearched_faces));
    }
    return obj;
}

QList OAISearchUsersByImageResponse::getUserMatches() const {
    return m_user_matches;
}
void OAISearchUsersByImageResponse::setUserMatches(const QList &user_matches) {
    m_user_matches = user_matches;
    m_user_matches_isSet = true;
}

bool OAISearchUsersByImageResponse::is_user_matches_Set() const{
    return m_user_matches_isSet;
}

bool OAISearchUsersByImageResponse::is_user_matches_Valid() const{
    return m_user_matches_isValid;
}

QString OAISearchUsersByImageResponse::getFaceModelVersion() const {
    return m_face_model_version;
}
void OAISearchUsersByImageResponse::setFaceModelVersion(const QString &face_model_version) {
    m_face_model_version = face_model_version;
    m_face_model_version_isSet = true;
}

bool OAISearchUsersByImageResponse::is_face_model_version_Set() const{
    return m_face_model_version_isSet;
}

bool OAISearchUsersByImageResponse::is_face_model_version_Valid() const{
    return m_face_model_version_isValid;
}

OAISearchUsersByImageResponse_SearchedFace OAISearchUsersByImageResponse::getSearchedFace() const {
    return m_searched_face;
}
void OAISearchUsersByImageResponse::setSearchedFace(const OAISearchUsersByImageResponse_SearchedFace &searched_face) {
    m_searched_face = searched_face;
    m_searched_face_isSet = true;
}

bool OAISearchUsersByImageResponse::is_searched_face_Set() const{
    return m_searched_face_isSet;
}

bool OAISearchUsersByImageResponse::is_searched_face_Valid() const{
    return m_searched_face_isValid;
}

QList OAISearchUsersByImageResponse::getUnsearchedFaces() const {
    return m_unsearched_faces;
}
void OAISearchUsersByImageResponse::setUnsearchedFaces(const QList &unsearched_faces) {
    m_unsearched_faces = unsearched_faces;
    m_unsearched_faces_isSet = true;
}

bool OAISearchUsersByImageResponse::is_unsearched_faces_Set() const{
    return m_unsearched_faces_isSet;
}

bool OAISearchUsersByImageResponse::is_unsearched_faces_Valid() const{
    return m_unsearched_faces_isValid;
}

bool OAISearchUsersByImageResponse::isSet() const {
...
bool OAISearchUsersByImageResponse::isValid() const {
