...
OAIQualityFilter::OAIQualityFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIQualityFilter::OAIQualityFilter() {
    this->initializeModel();
}

OAIQualityFilter::~OAIQualityFilter() {}

void OAIQualityFilter::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIQualityFilter::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIQualityFilter::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NONE", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQualityFilter::NONE;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("AUTO", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQualityFilter::AUTO;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("LOW", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQualityFilter::LOW;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("MEDIUM", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQualityFilter::MEDIUM;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HIGH", Qt::CaseInsensitive) == 0) {
        m_value = eOAIQualityFilter::HIGH;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIQualityFilter::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIQualityFilter::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIQualityFilter::NONE:
            val = "NONE";
            break;
        case eOAIQualityFilter::AUTO:
            val = "AUTO";
            break;
        case eOAIQualityFilter::LOW:
            val = "LOW";
            break;
        case eOAIQualityFilter::MEDIUM:
            val = "MEDIUM";
            break;
        case eOAIQualityFilter::HIGH:
            val = "HIGH";
            break;
        default:
            break;
...
QJsonValue OAIQualityFilter::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIQualityFilter::eOAIQualityFilter OAIQualityFilter::getValue() const {
    return m_value;
}

void OAIQualityFilter::setValue(const OAIQualityFilter::eOAIQualityFilter& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIQualityFilter::isSet() const {
    
    return m_value_isSet;
}

bool OAIQualityFilter::isValid() const {
