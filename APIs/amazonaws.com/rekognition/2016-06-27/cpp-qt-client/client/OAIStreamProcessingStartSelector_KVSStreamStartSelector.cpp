...
#include "OAIStreamProcessingStartSelector_KVSStreamStartSelector.h"
...
OAIStreamProcessingStartSelector_KVSStreamStartSelector::OAIStreamProcessingStartSelector_KVSStreamStartSelector(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessingStartSelector_KVSStreamStartSelector::OAIStreamProcessingStartSelector_KVSStreamStartSelector() {
    this->initializeModel();
}

OAIStreamProcessingStartSelector_KVSStreamStartSelector::~OAIStreamProcessingStartSelector_KVSStreamStartSelector() {}

void OAIStreamProcessingStartSelector_KVSStreamStartSelector::initializeModel() {
...
void OAIStreamProcessingStartSelector_KVSStreamStartSelector::fromJson(QString jsonString) {
...
void OAIStreamProcessingStartSelector_KVSStreamStartSelector::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessingStartSelector_KVSStreamStartSelector::asJson() const {
...
QJsonObject OAIStreamProcessingStartSelector_KVSStreamStartSelector::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIStreamProcessingStartSelector_KVSStreamStartSelector::getProducerTimestamp() const {
    return m_producer_timestamp;
}
void OAIStreamProcessingStartSelector_KVSStreamStartSelector::setProducerTimestamp(const qint32 &producer_timestamp) {
    m_producer_timestamp = producer_timestamp;
    m_producer_timestamp_isSet = true;
}

bool OAIStreamProcessingStartSelector_KVSStreamStartSelector::is_producer_timestamp_Set() const{
    return m_producer_timestamp_isSet;
}

bool OAIStreamProcessingStartSelector_KVSStreamStartSelector::is_producer_timestamp_Valid() const{
    return m_producer_timestamp_isValid;
}

QString OAIStreamProcessingStartSelector_KVSStreamStartSelector::getFragmentNumber() const {
    return m_fragment_number;
}
void OAIStreamProcessingStartSelector_KVSStreamStartSelector::setFragmentNumber(const QString &fragment_number) {
    m_fragment_number = fragment_number;
    m_fragment_number_isSet = true;
}

bool OAIStreamProcessingStartSelector_KVSStreamStartSelector::is_fragment_number_Set() const{
    return m_fragment_number_isSet;
}

bool OAIStreamProcessingStartSelector_KVSStreamStartSelector::is_fragment_number_Valid() const{
    return m_fragment_number_isValid;
}

bool OAIStreamProcessingStartSelector_KVSStreamStartSelector::isSet() const {
...
bool OAIStreamProcessingStartSelector_KVSStreamStartSelector::isValid() const {
