...
OAIGetCelebrityRecognitionResponse_VideoMetadata::OAIGetCelebrityRecognitionResponse_VideoMetadata(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetCelebrityRecognitionResponse_VideoMetadata::OAIGetCelebrityRecognitionResponse_VideoMetadata() {
    this->initializeModel();
}

OAIGetCelebrityRecognitionResponse_VideoMetadata::~OAIGetCelebrityRecognitionResponse_VideoMetadata() {}

void OAIGetCelebrityRecognitionResponse_VideoMetadata::initializeModel() {
...
void OAIGetCelebrityRecognitionResponse_VideoMetadata::fromJson(QString jsonString) {
...
void OAIGetCelebrityRecognitionResponse_VideoMetadata::fromJsonObject(QJsonObject json) {
...
QString OAIGetCelebrityRecognitionResponse_VideoMetadata::asJson() const {
...
QJsonObject OAIGetCelebrityRecognitionResponse_VideoMetadata::asJsonObject() const {
    QJsonObject obj;
    if (m_codec_isSet) {
...
QString OAIGetCelebrityRecognitionResponse_VideoMetadata::getCodec() const {
    return m_codec;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setCodec(const QString &codec) {
    m_codec = codec;
    m_codec_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_codec_Set() const{
    return m_codec_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_codec_Valid() const{
    return m_codec_isValid;
}

qint32 OAIGetCelebrityRecognitionResponse_VideoMetadata::getDurationMillis() const {
    return m_duration_millis;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setDurationMillis(const qint32 &duration_millis) {
    m_duration_millis = duration_millis;
    m_duration_millis_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_duration_millis_Set() const{
    return m_duration_millis_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_duration_millis_Valid() const{
    return m_duration_millis_isValid;
}

QString OAIGetCelebrityRecognitionResponse_VideoMetadata::getFormat() const {
    return m_format;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setFormat(const QString &format) {
    m_format = format;
    m_format_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_format_Set() const{
    return m_format_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_format_Valid() const{
    return m_format_isValid;
}

float OAIGetCelebrityRecognitionResponse_VideoMetadata::getFrameRate() const {
    return m_frame_rate;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setFrameRate(const float &frame_rate) {
    m_frame_rate = frame_rate;
    m_frame_rate_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_frame_rate_Set() const{
    return m_frame_rate_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_frame_rate_Valid() const{
    return m_frame_rate_isValid;
}

qint32 OAIGetCelebrityRecognitionResponse_VideoMetadata::getFrameHeight() const {
    return m_frame_height;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setFrameHeight(const qint32 &frame_height) {
    m_frame_height = frame_height;
    m_frame_height_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_frame_height_Set() const{
    return m_frame_height_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_frame_height_Valid() const{
    return m_frame_height_isValid;
}

qint32 OAIGetCelebrityRecognitionResponse_VideoMetadata::getFrameWidth() const {
    return m_frame_width;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setFrameWidth(const qint32 &frame_width) {
    m_frame_width = frame_width;
    m_frame_width_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_frame_width_Set() const{
    return m_frame_width_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_frame_width_Valid() const{
    return m_frame_width_isValid;
}

OAIVideoColorRange OAIGetCelebrityRecognitionResponse_VideoMetadata::getColorRange() const {
    return m_color_range;
}
void OAIGetCelebrityRecognitionResponse_VideoMetadata::setColorRange(const OAIVideoColorRange &color_range) {
    m_color_range = color_range;
    m_color_range_isSet = true;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_color_range_Set() const{
    return m_color_range_isSet;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::is_color_range_Valid() const{
    return m_color_range_isValid;
}

bool OAIGetCelebrityRecognitionResponse_VideoMetadata::isSet() const {
...
bool OAIGetCelebrityRecognitionResponse_VideoMetadata::isValid() const {
