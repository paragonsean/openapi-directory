...
/*
 * OAIDeleteCollectionResponse.h
 *
 * 
 */

#ifndef OAIDeleteCollectionResponse_H
#define OAIDeleteCollectionResponse_H
...
class OAIDeleteCollectionResponse : public OAIObject {
public:
    OAIDeleteCollectionResponse();
    OAIDeleteCollectionResponse(QString json);
    ~OAIDeleteCollectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteCollectionResponse)

#endif // OAIDeleteCollectionResponse_H
