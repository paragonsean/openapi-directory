...
/*
 * OAIDeleteProjectVersionResponse.h
 *
 * 
 */

#ifndef OAIDeleteProjectVersionResponse_H
#define OAIDeleteProjectVersionResponse_H
...
class OAIDeleteProjectVersionResponse : public OAIObject {
public:
    OAIDeleteProjectVersionResponse();
    OAIDeleteProjectVersionResponse(QString json);
    ~OAIDeleteProjectVersionResponse() override;
    ...
    OAIProjectVersionStatus getStatus() const;
    void setStatus(const OAIProjectVersionStatus &status);
...
private:
    ...
    OAIProjectVersionStatus m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProjectVersionResponse)

#endif // OAIDeleteProjectVersionResponse_H
