...
/*
 * OAICreateProjectVersionRequest_TrainingData.h
 *
 * 
 */

#ifndef OAICreateProjectVersionRequest_TrainingData_H
#define OAICreateProjectVersionRequest_TrainingData_H
...
class OAICreateProjectVersionRequest_TrainingData : public OAIObject {
public:
    OAICreateProjectVersionRequest_TrainingData();
    OAICreateProjectVersionRequest_TrainingData(QString json);
    ~OAICreateProjectVersionRequest_TrainingData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICreateProjectVersionRequest_TrainingData)

#endif // OAICreateProjectVersionRequest_TrainingData_H
