...
OAIDetectionFilter::OAIDetectionFilter(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectionFilter::OAIDetectionFilter() {
    this->initializeModel();
}

OAIDetectionFilter::~OAIDetectionFilter() {}

void OAIDetectionFilter::initializeModel() {
...
void OAIDetectionFilter::fromJson(QString jsonString) {
...
void OAIDetectionFilter::fromJsonObject(QJsonObject json) {
...
QString OAIDetectionFilter::asJson() const {
...
QJsonObject OAIDetectionFilter::asJsonObject() const {
    QJsonObject obj;
...
float OAIDetectionFilter::getMinConfidence() const {
    return m_min_confidence;
}
void OAIDetectionFilter::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIDetectionFilter::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIDetectionFilter::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

float OAIDetectionFilter::getMinBoundingBoxHeight() const {
    return m_min_bounding_box_height;
}
void OAIDetectionFilter::setMinBoundingBoxHeight(const float &min_bounding_box_height) {
    m_min_bounding_box_height = min_bounding_box_height;
    m_min_bounding_box_height_isSet = true;
}

bool OAIDetectionFilter::is_min_bounding_box_height_Set() const{
    return m_min_bounding_box_height_isSet;
}

bool OAIDetectionFilter::is_min_bounding_box_height_Valid() const{
    return m_min_bounding_box_height_isValid;
}

float OAIDetectionFilter::getMinBoundingBoxWidth() const {
    return m_min_bounding_box_width;
}
void OAIDetectionFilter::setMinBoundingBoxWidth(const float &min_bounding_box_width) {
    m_min_bounding_box_width = min_bounding_box_width;
    m_min_bounding_box_width_isSet = true;
}

bool OAIDetectionFilter::is_min_bounding_box_width_Set() const{
    return m_min_bounding_box_width_isSet;
}

bool OAIDetectionFilter::is_min_bounding_box_width_Valid() const{
    return m_min_bounding_box_width_isValid;
}

bool OAIDetectionFilter::isSet() const {
...
bool OAIDetectionFilter::isValid() const {
