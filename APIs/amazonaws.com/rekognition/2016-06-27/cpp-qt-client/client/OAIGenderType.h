...
#ifndef OAIGenderType_H
#define OAIGenderType_H
...
class OAIGenderType : public OAIEnum {
public:
    OAIGenderType();
    OAIGenderType(QString json);
    ~OAIGenderType() override;
    ...
    enum class eOAIGenderType {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        MALE, 
        FEMALE
    };
    OAIGenderType::eOAIGenderType getValue() const;
    void setValue(const OAIGenderType::eOAIGenderType& value);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGenderType)

#endif // OAIGenderType_H
