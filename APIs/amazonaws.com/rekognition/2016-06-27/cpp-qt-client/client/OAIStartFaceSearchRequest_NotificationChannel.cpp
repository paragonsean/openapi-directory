...
#include "OAIStartFaceSearchRequest_NotificationChannel.h"
...
OAIStartFaceSearchRequest_NotificationChannel::OAIStartFaceSearchRequest_NotificationChannel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartFaceSearchRequest_NotificationChannel::OAIStartFaceSearchRequest_NotificationChannel() {
    this->initializeModel();
}

OAIStartFaceSearchRequest_NotificationChannel::~OAIStartFaceSearchRequest_NotificationChannel() {}

void OAIStartFaceSearchRequest_NotificationChannel::initializeModel() {
...
void OAIStartFaceSearchRequest_NotificationChannel::fromJson(QString jsonString) {
...
void OAIStartFaceSearchRequest_NotificationChannel::fromJsonObject(QJsonObject json) {
...
QString OAIStartFaceSearchRequest_NotificationChannel::asJson() const {
...
QJsonObject OAIStartFaceSearchRequest_NotificationChannel::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartFaceSearchRequest_NotificationChannel::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIStartFaceSearchRequest_NotificationChannel::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIStartFaceSearchRequest_NotificationChannel::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIStartFaceSearchRequest_NotificationChannel::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QString OAIStartFaceSearchRequest_NotificationChannel::getRoleArn() const {
    return m_role_arn;
}
void OAIStartFaceSearchRequest_NotificationChannel::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIStartFaceSearchRequest_NotificationChannel::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIStartFaceSearchRequest_NotificationChannel::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIStartFaceSearchRequest_NotificationChannel::isSet() const {
...
bool OAIStartFaceSearchRequest_NotificationChannel::isValid() const {
