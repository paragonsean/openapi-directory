...
#include "OAICreateStreamProcessorRequest_Settings.h"
...
OAICreateStreamProcessorRequest_Settings::OAICreateStreamProcessorRequest_Settings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateStreamProcessorRequest_Settings::OAICreateStreamProcessorRequest_Settings() {
    this->initializeModel();
}

OAICreateStreamProcessorRequest_Settings::~OAICreateStreamProcessorRequest_Settings() {}

void OAICreateStreamProcessorRequest_Settings::initializeModel() {

    m_face_search_isSet = false;
    m_face_search_isValid = false;

    m_connected_home_isSet = false;
    m_connected_home_isValid = false;
}

void OAICreateStreamProcessorRequest_Settings::fromJson(QString jsonString) {
...
void OAICreateStreamProcessorRequest_Settings::fromJsonObject(QJsonObject json) {

    m_face_search_isValid = ::OpenAPI::fromJsonValue(m_face_search, json[QString("FaceSearch")]);
    m_face_search_isSet = !json[QString("FaceSearch")].isNull() && m_face_search_isValid;

    m_connected_home_isValid = ::OpenAPI::fromJsonValue(m_connected_home, json[QString("ConnectedHome")]);
    m_connected_home_isSet = !json[QString("ConnectedHome")].isNull() && m_connected_home_isValid;
}

QString OAICreateStreamProcessorRequest_Settings::asJson() const {
...
QJsonObject OAICreateStreamProcessorRequest_Settings::asJsonObject() const {
    QJsonObject obj;
    if (m_face_search.isSet()) {
        obj.insert(QString("FaceSearch"), ::OpenAPI::toJsonValue(m_face_search));
    }
    if (m_connected_home.isSet()) {
        obj.insert(QString("ConnectedHome"), ::OpenAPI::toJsonValue(m_connected_home));
    }
    return obj;
}

OAIStreamProcessorSettings_FaceSearch OAICreateStreamProcessorRequest_Settings::getFaceSearch() const {
    return m_face_search;
}
void OAICreateStreamProcessorRequest_Settings::setFaceSearch(const OAIStreamProcessorSettings_FaceSearch &face_search) {
    m_face_search = face_search;
    m_face_search_isSet = true;
}

bool OAICreateStreamProcessorRequest_Settings::is_face_search_Set() const{
    return m_face_search_isSet;
}

bool OAICreateStreamProcessorRequest_Settings::is_face_search_Valid() const{
    return m_face_search_isValid;
}

OAIConnectedHomeSettings OAICreateStreamProcessorRequest_Settings::getConnectedHome() const {
    return m_connected_home;
}
void OAICreateStreamProcessorRequest_Settings::setConnectedHome(const OAIConnectedHomeSettings &connected_home) {
    m_connected_home = connected_home;
    m_connected_home_isSet = true;
}

bool OAICreateStreamProcessorRequest_Settings::is_connected_home_Set() const{
    return m_connected_home_isSet;
}

bool OAICreateStreamProcessorRequest_Settings::is_connected_home_Valid() const{
    return m_connected_home_isValid;
}

bool OAICreateStreamProcessorRequest_Settings::isSet() const {
...
bool OAICreateStreamProcessorRequest_Settings::isValid() const {
