...
#ifndef OAICoversBodyPart_H
#define OAICoversBodyPart_H
...
class OAICoversBodyPart : public OAIObject {
public:
    OAICoversBodyPart();
    OAICoversBodyPart(QString json);
    ~OAICoversBodyPart() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICoversBodyPart)

#endif // OAICoversBodyPart_H
