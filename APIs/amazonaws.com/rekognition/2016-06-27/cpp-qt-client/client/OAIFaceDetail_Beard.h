...
/*
 * OAIFaceDetail_Beard.h
 *
 * 
 */

#ifndef OAIFaceDetail_Beard_H
#define OAIFaceDetail_Beard_H
...
class OAIFaceDetail_Beard : public OAIObject {
public:
    OAIFaceDetail_Beard();
    OAIFaceDetail_Beard(QString json);
    ~OAIFaceDetail_Beard() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_Beard)

#endif // OAIFaceDetail_Beard_H
