...
OAIGenderType OAIGender::getValue() const {
    return m_value;
}
void OAIGender::setValue(const OAIGenderType &value) {
    m_value = value;
    m_value_isSet = true;
}
...
float OAIGender::getConfidence() const {
    return m_confidence;
}
void OAIGender::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIGender::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIGender::is_confidence_Valid() const{
