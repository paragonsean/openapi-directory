...
OAIContentModerationSortBy::OAIContentModerationSortBy(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIContentModerationSortBy::OAIContentModerationSortBy() {
    this->initializeModel();
}

OAIContentModerationSortBy::~OAIContentModerationSortBy() {}

void OAIContentModerationSortBy::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIContentModerationSortBy::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIContentModerationSortBy::fromJson(QString jsonString) {
    
    if ( jsonString.compare("NAME", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContentModerationSortBy::NAME;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("TIMESTAMP", Qt::CaseInsensitive) == 0) {
        m_value = eOAIContentModerationSortBy::TIMESTAMP;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIContentModerationSortBy::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIContentModerationSortBy::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIContentModerationSortBy::NAME:
            val = "NAME";
            break;
        case eOAIContentModerationSortBy::TIMESTAMP:
            val = "TIMESTAMP";
            break;
        default:
            break;
...
QJsonValue OAIContentModerationSortBy::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIContentModerationSortBy::eOAIContentModerationSortBy OAIContentModerationSortBy::getValue() const {
    return m_value;
}

void OAIContentModerationSortBy::setValue(const OAIContentModerationSortBy::eOAIContentModerationSortBy& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIContentModerationSortBy::isSet() const {
    
    return m_value_isSet;
}

bool OAIContentModerationSortBy::isValid() const {
