...
/*
 * OAISearchFacesResponse.h
 *
 * 
 */

#ifndef OAISearchFacesResponse_H
#define OAISearchFacesResponse_H
...
class OAISearchFacesResponse : public OAIObject {
public:
    OAISearchFacesResponse();
    OAISearchFacesResponse(QString json);
    ~OAISearchFacesResponse() override;
    ...
    QString getSearchedFaceId() const;
    void setSearchedFaceId(const QString &searched_face_id);
    bool is_searched_face_id_Set() const;
    bool is_searched_face_id_Valid() const;
...
private:
    ...
    QString m_searched_face_id;
    bool m_searched_face_id_isSet;
    bool m_searched_face_id_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchFacesResponse)

#endif // OAISearchFacesResponse_H
