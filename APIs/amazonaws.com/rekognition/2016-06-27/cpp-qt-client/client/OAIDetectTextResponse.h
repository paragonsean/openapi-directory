...
/*
 * OAIDetectTextResponse.h
 *
 * 
 */

#ifndef OAIDetectTextResponse_H
#define OAIDetectTextResponse_H
...
class OAIDetectTextResponse : public OAIObject {
public:
    OAIDetectTextResponse();
    OAIDetectTextResponse(QString json);
    ~OAIDetectTextResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectTextResponse)

#endif // OAIDetectTextResponse_H
