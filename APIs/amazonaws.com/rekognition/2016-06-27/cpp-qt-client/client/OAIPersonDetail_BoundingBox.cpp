...
#include "OAIPersonDetail_BoundingBox.h"
...
OAIPersonDetail_BoundingBox::OAIPersonDetail_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPersonDetail_BoundingBox::OAIPersonDetail_BoundingBox() {
    this->initializeModel();
}

OAIPersonDetail_BoundingBox::~OAIPersonDetail_BoundingBox() {}

void OAIPersonDetail_BoundingBox::initializeModel() {
...
void OAIPersonDetail_BoundingBox::fromJson(QString jsonString) {
...
void OAIPersonDetail_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAIPersonDetail_BoundingBox::asJson() const {
...
QJsonObject OAIPersonDetail_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAIPersonDetail_BoundingBox::getWidth() const {
    return m_width;
}
void OAIPersonDetail_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIPersonDetail_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAIPersonDetail_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAIPersonDetail_BoundingBox::getHeight() const {
    return m_height;
}
void OAIPersonDetail_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIPersonDetail_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAIPersonDetail_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAIPersonDetail_BoundingBox::getLeft() const {
    return m_left;
}
void OAIPersonDetail_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIPersonDetail_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAIPersonDetail_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAIPersonDetail_BoundingBox::getTop() const {
    return m_top;
}
void OAIPersonDetail_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIPersonDetail_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAIPersonDetail_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAIPersonDetail_BoundingBox::isSet() const {
...
bool OAIPersonDetail_BoundingBox::isValid() const {
