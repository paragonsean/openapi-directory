...
QString OAIListUsersRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIListUsersRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIListUsersRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIListUsersRequest::is_collection_id_Valid() const{
