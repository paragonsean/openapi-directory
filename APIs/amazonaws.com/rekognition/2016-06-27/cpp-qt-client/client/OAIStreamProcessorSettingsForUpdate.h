...
/*
 * OAIStreamProcessorSettingsForUpdate.h
 *
...
#ifndef OAIStreamProcessorSettingsForUpdate_H
#define OAIStreamProcessorSettingsForUpdate_H

#include <QJsonObject>

#include "OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate;

class OAIStreamProcessorSettingsForUpdate : public OAIObject {
public:
    OAIStreamProcessorSettingsForUpdate();
    OAIStreamProcessorSettingsForUpdate(QString json);
    ~OAIStreamProcessorSettingsForUpdate() override;
    ...
    OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate getConnectedHomeForUpdate() const;
    void setConnectedHomeForUpdate(const OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate &connected_home_for_update);
    bool is_connected_home_for_update_Set() const;
    bool is_connected_home_for_update_Valid() const;
...
private:
    ...
    OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate m_connected_home_for_update;
    bool m_connected_home_for_update_isSet;
    bool m_connected_home_for_update_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorSettingsForUpdate)

#endif // OAIStreamProcessorSettingsForUpdate_H
