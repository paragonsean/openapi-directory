...
#include "OAICompareFacesMatch.h"
...
OAICompareFacesMatch::OAICompareFacesMatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICompareFacesMatch::OAICompareFacesMatch() {
    this->initializeModel();
}

OAICompareFacesMatch::~OAICompareFacesMatch() {}

void OAICompareFacesMatch::initializeModel() {
...
void OAICompareFacesMatch::fromJson(QString jsonString) {
...
void OAICompareFacesMatch::fromJsonObject(QJsonObject json) {
...
QString OAICompareFacesMatch::asJson() const {
...
QJsonObject OAICompareFacesMatch::asJsonObject() const {
    QJsonObject obj;
...
float OAICompareFacesMatch::getSimilarity() const {
    return m_similarity;
}
void OAICompareFacesMatch::setSimilarity(const float &similarity) {
    m_similarity = similarity;
    m_similarity_isSet = true;
}

bool OAICompareFacesMatch::is_similarity_Set() const{
    return m_similarity_isSet;
}

bool OAICompareFacesMatch::is_similarity_Valid() const{
    return m_similarity_isValid;
}

OAICompareFacesMatch_Face OAICompareFacesMatch::getFace() const {
    return m_face;
}
void OAICompareFacesMatch::setFace(const OAICompareFacesMatch_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAICompareFacesMatch::is_face_Set() const{
    return m_face_isSet;
}

bool OAICompareFacesMatch::is_face_Valid() const{
    return m_face_isValid;
}

bool OAICompareFacesMatch::isSet() const {
...
bool OAICompareFacesMatch::isValid() const {
