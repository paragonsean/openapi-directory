...
/*
 * OAICopyProjectVersionRequest.h
 *
 * 
 */

#ifndef OAICopyProjectVersionRequest_H
#define OAICopyProjectVersionRequest_H

#include <QJsonObject>

#include "OAICopyProjectVersionRequest_OutputConfig.h"
#include <QMap>
#include <QString>
...
namespace OpenAPI {
class OAICopyProjectVersionRequest_OutputConfig;

class OAICopyProjectVersionRequest : public OAIObject {
public:
    OAICopyProjectVersionRequest();
    OAICopyProjectVersionRequest(QString json);
    ~OAICopyProjectVersionRequest() override;
    ...
    QString getSourceProjectArn() const;
    void setSourceProjectArn(const QString &source_project_arn);
    bool is_source_project_arn_Set() const;
    bool is_source_project_arn_Valid() const;

    QString getSourceProjectVersionArn() const;
    void setSourceProjectVersionArn(const QString &source_project_version_arn);
    bool is_source_project_version_arn_Set() const;
    bool is_source_project_version_arn_Valid() const;

    QString getDestinationProjectArn() const;
    void setDestinationProjectArn(const QString &destination_project_arn);
    bool is_destination_project_arn_Set() const;
    bool is_destination_project_arn_Valid() const;
    ...
    OAICopyProjectVersionRequest_OutputConfig getOutputConfig() const;
    void setOutputConfig(const OAICopyProjectVersionRequest_OutputConfig &output_config);
...
private:
    ...
    QString m_source_project_arn;
    bool m_source_project_arn_isSet;
    bool m_source_project_arn_isValid;

    QString m_source_project_version_arn;
    bool m_source_project_version_arn_isSet;
    bool m_source_project_version_arn_isValid;

    QString m_destination_project_arn;
    bool m_destination_project_arn_isSet;
    bool m_destination_project_arn_isValid;

    QString m_version_name;
    bool m_version_name_isSet;
    bool m_version_name_isValid;

    OAICopyProjectVersionRequest_OutputConfig m_output_config;
...
Q_DECLARE_METATYPE(OpenAPI::OAICopyProjectVersionRequest)

#endif // OAICopyProjectVersionRequest_H
