...
#include "OAIHumanLoopActivationOutput.h"
...
OAIHumanLoopActivationOutput::OAIHumanLoopActivationOutput(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIHumanLoopActivationOutput::OAIHumanLoopActivationOutput() {
    this->initializeModel();
}

OAIHumanLoopActivationOutput::~OAIHumanLoopActivationOutput() {}

void OAIHumanLoopActivationOutput::initializeModel() {
...
void OAIHumanLoopActivationOutput::fromJson(QString jsonString) {
...
void OAIHumanLoopActivationOutput::fromJsonObject(QJsonObject json) {
...
QString OAIHumanLoopActivationOutput::asJson() const {
...
QJsonObject OAIHumanLoopActivationOutput::asJsonObject() const {
    QJsonObject obj;
...
QString OAIHumanLoopActivationOutput::getHumanLoopArn() const {
    return m_human_loop_arn;
}
void OAIHumanLoopActivationOutput::setHumanLoopArn(const QString &human_loop_arn) {
    m_human_loop_arn = human_loop_arn;
    m_human_loop_arn_isSet = true;
}

bool OAIHumanLoopActivationOutput::is_human_loop_arn_Set() const{
    return m_human_loop_arn_isSet;
}

bool OAIHumanLoopActivationOutput::is_human_loop_arn_Valid() const{
    return m_human_loop_arn_isValid;
}

QList OAIHumanLoopActivationOutput::getHumanLoopActivationReasons() const {
    return m_human_loop_activation_reasons;
}
void OAIHumanLoopActivationOutput::setHumanLoopActivationReasons(const QList &human_loop_activation_reasons) {
    m_human_loop_activation_reasons = human_loop_activation_reasons;
    m_human_loop_activation_reasons_isSet = true;
}

bool OAIHumanLoopActivationOutput::is_human_loop_activation_reasons_Set() const{
    return m_human_loop_activation_reasons_isSet;
}

bool OAIHumanLoopActivationOutput::is_human_loop_activation_reasons_Valid() const{
    return m_human_loop_activation_reasons_isValid;
}

QString OAIHumanLoopActivationOutput::getHumanLoopActivationConditionsEvaluationResults() const {
    return m_human_loop_activation_conditions_evaluation_results;
}
void OAIHumanLoopActivationOutput::setHumanLoopActivationConditionsEvaluationResults(const QString &human_loop_activation_conditions_evaluation_results) {
...
bool OAIHumanLoopActivationOutput::is_human_loop_activation_conditions_evaluation_results_Set() const{
    return m_human_loop_activation_conditions_evaluation_results_isSet;
}

bool OAIHumanLoopActivationOutput::is_human_loop_activation_conditions_evaluation_results_Valid() const{
    return m_human_loop_activation_conditions_evaluation_results_isValid;
}

bool OAIHumanLoopActivationOutput::isSet() const {
...
bool OAIHumanLoopActivationOutput::isValid() const {
