...
OAIAuditImage::OAIAuditImage(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAuditImage::OAIAuditImage() {
    this->initializeModel();
}

OAIAuditImage::~OAIAuditImage() {}

void OAIAuditImage::initializeModel() {
...
void OAIAuditImage::fromJson(QString jsonString) {
...
void OAIAuditImage::fromJsonObject(QJsonObject json) {
...
QString OAIAuditImage::asJson() const {
...
QJsonObject OAIAuditImage::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAIAuditImage::getBytes() const {
    return m_bytes;
}
void OAIAuditImage::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIAuditImage::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIAuditImage::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIS3Object OAIAuditImage::getS3Object() const {
    return m_s3_object;
}
void OAIAuditImage::setS3Object(const OAIS3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIAuditImage::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIAuditImage::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

OAIBoundingBox OAIAuditImage::getBoundingBox() const {
    return m_bounding_box;
}
void OAIAuditImage::setBoundingBox(const OAIBoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIAuditImage::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIAuditImage::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

bool OAIAuditImage::isSet() const {
...
bool OAIAuditImage::isValid() const {
