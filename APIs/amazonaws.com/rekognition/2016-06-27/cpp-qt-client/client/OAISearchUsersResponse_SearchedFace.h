...
/*
 * OAISearchUsersResponse_SearchedFace.h
 *
 * 
 */

#ifndef OAISearchUsersResponse_SearchedFace_H
#define OAISearchUsersResponse_SearchedFace_H
...
class OAISearchUsersResponse_SearchedFace : public OAIObject {
public:
    OAISearchUsersResponse_SearchedFace();
    OAISearchUsersResponse_SearchedFace(QString json);
    ~OAISearchUsersResponse_SearchedFace() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchUsersResponse_SearchedFace)

#endif // OAISearchUsersResponse_SearchedFace_H
