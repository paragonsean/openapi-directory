...
OAISmile::OAISmile(QString json) {
...
void OAISmile::fromJson(QString jsonString) {
...
void OAISmile::fromJsonObject(QJsonObject json) {
...
QJsonObject OAISmile::asJsonObject() const {
    QJsonObject obj;
    if (m_value_isSet) {
...
bool OAISmile::getValue() const {
    return m_value;
}
void OAISmile::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAISmile::is_value_Set() const{
    return m_value_isSet;
}

bool OAISmile::is_value_Valid() const{
    return m_value_isValid;
}

float OAISmile::getConfidence() const {
    return m_confidence;
}
void OAISmile::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAISmile::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAISmile::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAISmile::isSet() const {
