...
#include "OAIFaceDetail_BoundingBox.h"
...
OAIFaceDetail_BoundingBox::OAIFaceDetail_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_BoundingBox::OAIFaceDetail_BoundingBox() {
    this->initializeModel();
}

OAIFaceDetail_BoundingBox::~OAIFaceDetail_BoundingBox() {}

void OAIFaceDetail_BoundingBox::initializeModel() {
...
void OAIFaceDetail_BoundingBox::fromJson(QString jsonString) {
...
void OAIFaceDetail_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_BoundingBox::asJson() const {
...
QJsonObject OAIFaceDetail_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAIFaceDetail_BoundingBox::getWidth() const {
    return m_width;
}
void OAIFaceDetail_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIFaceDetail_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAIFaceDetail_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAIFaceDetail_BoundingBox::getHeight() const {
    return m_height;
}
void OAIFaceDetail_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIFaceDetail_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAIFaceDetail_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAIFaceDetail_BoundingBox::getLeft() const {
    return m_left;
}
void OAIFaceDetail_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIFaceDetail_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAIFaceDetail_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAIFaceDetail_BoundingBox::getTop() const {
    return m_top;
}
void OAIFaceDetail_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIFaceDetail_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAIFaceDetail_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAIFaceDetail_BoundingBox::isSet() const {
...
bool OAIFaceDetail_BoundingBox::isValid() const {
