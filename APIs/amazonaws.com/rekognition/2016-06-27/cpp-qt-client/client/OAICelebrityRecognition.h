...
/*
 * OAICelebrityRecognition.h
 *
 * Information about a detected celebrity and the time the celebrity was detected in a stored video. For more information, see GetCelebrityRecognition in the Amazon Rekognition Developer Guide.
 */

#ifndef OAICelebrityRecognition_H
#define OAICelebrityRecognition_H

#include <QJsonObject>

#include "OAICelebrityRecognition_Celebrity.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICelebrityRecognition_Celebrity;

class OAICelebrityRecognition : public OAIObject {
public:
    OAICelebrityRecognition();
    OAICelebrityRecognition(QString json);
    ~OAICelebrityRecognition() override;
    ...
    OAICelebrityRecognition_Celebrity getCelebrity() const;
    void setCelebrity(const OAICelebrityRecognition_Celebrity &celebrity);
...
private:
    ...
    OAICelebrityRecognition_Celebrity m_celebrity;
...
Q_DECLARE_METATYPE(OpenAPI::OAICelebrityRecognition)

#endif // OAICelebrityRecognition_H
