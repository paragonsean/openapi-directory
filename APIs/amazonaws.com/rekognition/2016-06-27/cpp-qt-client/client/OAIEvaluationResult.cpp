...
float OAIEvaluationResult::getF1Score() const {
    return m_f1_score;
}
void OAIEvaluationResult::setF1Score(const float &f1_score) {
    m_f1_score = f1_score;
    m_f1_score_isSet = true;
}

bool OAIEvaluationResult::is_f1_score_Set() const{
    return m_f1_score_isSet;
}

bool OAIEvaluationResult::is_f1_score_Valid() const{
    return m_f1_score_isValid;
}

OAIEvaluationResult_Summary OAIEvaluationResult::getSummary() const {
    return m_summary;
}
void OAIEvaluationResult::setSummary(const OAIEvaluationResult_Summary &summary) {
    m_summary = summary;
    m_summary_isSet = true;
}

bool OAIEvaluationResult::is_summary_Set() const{
    return m_summary_isSet;
}

bool OAIEvaluationResult::is_summary_Valid() const{
