...
#include "OAIGetSegmentDetectionRequest.h"
...
OAIGetSegmentDetectionRequest::OAIGetSegmentDetectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetSegmentDetectionRequest::OAIGetSegmentDetectionRequest() {
    this->initializeModel();
}

OAIGetSegmentDetectionRequest::~OAIGetSegmentDetectionRequest() {}

void OAIGetSegmentDetectionRequest::initializeModel() {
...
void OAIGetSegmentDetectionRequest::fromJson(QString jsonString) {
...
void OAIGetSegmentDetectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetSegmentDetectionRequest::asJson() const {
...
QJsonObject OAIGetSegmentDetectionRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetSegmentDetectionRequest::getJobId() const {
    return m_job_id;
}
void OAIGetSegmentDetectionRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetSegmentDetectionRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetSegmentDetectionRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetSegmentDetectionRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetSegmentDetectionRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetSegmentDetectionRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetSegmentDetectionRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetSegmentDetectionRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetSegmentDetectionRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetSegmentDetectionRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetSegmentDetectionRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIGetSegmentDetectionRequest::isSet() const {
...
bool OAIGetSegmentDetectionRequest::isValid() const {
