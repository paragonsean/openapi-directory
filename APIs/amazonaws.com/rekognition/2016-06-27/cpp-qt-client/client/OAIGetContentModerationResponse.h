...
/*
 * OAIGetContentModerationResponse.h
 *
 * 
 */

#ifndef OAIGetContentModerationResponse_H
#define OAIGetContentModerationResponse_H
...
namespace OpenAPI {
class OAIGetContentModerationResponse_VideoMetadata;
class OAIVideo;
class OAIGetContentModerationResponse_GetRequestMetadata;

class OAIGetContentModerationResponse : public OAIObject {
public:
    OAIGetContentModerationResponse();
    OAIGetContentModerationResponse(QString json);
    ~OAIGetContentModerationResponse() override;
    ...
    OAIGetContentModerationResponse_VideoMetadata getVideoMetadata() const;
    void setVideoMetadata(const OAIGetContentModerationResponse_VideoMetadata &video_metadata);
    ...
    OAIGetContentModerationResponse_GetRequestMetadata getGetRequestMetadata() const;
    void setGetRequestMetadata(const OAIGetContentModerationResponse_GetRequestMetadata &get_request_metadata);
...
private:
    ...
    OAIGetContentModerationResponse_VideoMetadata m_video_metadata;
    ...
    OAIGetContentModerationResponse_GetRequestMetadata m_get_request_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetContentModerationResponse)

#endif // OAIGetContentModerationResponse_H
