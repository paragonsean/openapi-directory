...
OAIFaceDetail_Pose::OAIFaceDetail_Pose(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetail_Pose::OAIFaceDetail_Pose() {
    this->initializeModel();
}

OAIFaceDetail_Pose::~OAIFaceDetail_Pose() {}

void OAIFaceDetail_Pose::initializeModel() {
...
void OAIFaceDetail_Pose::fromJson(QString jsonString) {
...
void OAIFaceDetail_Pose::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetail_Pose::asJson() const {
...
QJsonObject OAIFaceDetail_Pose::asJsonObject() const {
    QJsonObject obj;
    if (m_roll_isSet) {
...
float OAIFaceDetail_Pose::getRoll() const {
    return m_roll;
}
void OAIFaceDetail_Pose::setRoll(const float &roll) {
    m_roll = roll;
    m_roll_isSet = true;
}

bool OAIFaceDetail_Pose::is_roll_Set() const{
    return m_roll_isSet;
}

bool OAIFaceDetail_Pose::is_roll_Valid() const{
    return m_roll_isValid;
}

float OAIFaceDetail_Pose::getYaw() const {
    return m_yaw;
}
void OAIFaceDetail_Pose::setYaw(const float &yaw) {
    m_yaw = yaw;
    m_yaw_isSet = true;
}

bool OAIFaceDetail_Pose::is_yaw_Set() const{
    return m_yaw_isSet;
}

bool OAIFaceDetail_Pose::is_yaw_Valid() const{
    return m_yaw_isValid;
}

float OAIFaceDetail_Pose::getPitch() const {
    return m_pitch;
}
void OAIFaceDetail_Pose::setPitch(const float &pitch) {
    m_pitch = pitch;
    m_pitch_isSet = true;
}

bool OAIFaceDetail_Pose::is_pitch_Set() const{
    return m_pitch_isSet;
}

bool OAIFaceDetail_Pose::is_pitch_Valid() const{
    return m_pitch_isValid;
}

bool OAIFaceDetail_Pose::isSet() const {
...
bool OAIFaceDetail_Pose::isValid() const {
