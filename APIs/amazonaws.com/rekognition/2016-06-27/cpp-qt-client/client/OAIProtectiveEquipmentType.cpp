...
#include "OAIProtectiveEquipmentType.h"
...
OAIProtectiveEquipmentType::OAIProtectiveEquipmentType(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProtectiveEquipmentType::OAIProtectiveEquipmentType() {
    this->initializeModel();
}

OAIProtectiveEquipmentType::~OAIProtectiveEquipmentType() {}

void OAIProtectiveEquipmentType::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIProtectiveEquipmentType::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIProtectiveEquipmentType::fromJson(QString jsonString) {
    
    if ( jsonString.compare("FACE_COVER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProtectiveEquipmentType::FACE_COVER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HAND_COVER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProtectiveEquipmentType::HAND_COVER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("HEAD_COVER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIProtectiveEquipmentType::HEAD_COVER;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIProtectiveEquipmentType::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIProtectiveEquipmentType::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIProtectiveEquipmentType::FACE_COVER:
            val = "FACE_COVER";
            break;
        case eOAIProtectiveEquipmentType::HAND_COVER:
            val = "HAND_COVER";
            break;
        case eOAIProtectiveEquipmentType::HEAD_COVER:
            val = "HEAD_COVER";
            break;
        default:
            break;
...
QJsonValue OAIProtectiveEquipmentType::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIProtectiveEquipmentType::eOAIProtectiveEquipmentType OAIProtectiveEquipmentType::getValue() const {
    return m_value;
}

void OAIProtectiveEquipmentType::setValue(const OAIProtectiveEquipmentType::eOAIProtectiveEquipmentType& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIProtectiveEquipmentType::isSet() const {
    
    return m_value_isSet;
}

bool OAIProtectiveEquipmentType::isValid() const {
