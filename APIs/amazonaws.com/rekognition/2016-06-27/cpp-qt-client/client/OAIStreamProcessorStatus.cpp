...
#include "OAIStreamProcessorStatus.h"
...
OAIStreamProcessorStatus::OAIStreamProcessorStatus(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorStatus::OAIStreamProcessorStatus() {
    this->initializeModel();
}

OAIStreamProcessorStatus::~OAIStreamProcessorStatus() {}

void OAIStreamProcessorStatus::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIStreamProcessorStatus::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIStreamProcessorStatus::fromJson(QString jsonString) {
    
    if ( jsonString.compare("STOPPED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorStatus::STOPPED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STARTING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorStatus::STARTING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("RUNNING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorStatus::RUNNING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FAILED", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorStatus::FAILED;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("STOPPING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorStatus::STOPPING;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("UPDATING", Qt::CaseInsensitive) == 0) {
        m_value = eOAIStreamProcessorStatus::UPDATING;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIStreamProcessorStatus::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIStreamProcessorStatus::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIStreamProcessorStatus::STOPPED:
            val = "STOPPED";
            break;
        case eOAIStreamProcessorStatus::STARTING:
            val = "STARTING";
            break;
        case eOAIStreamProcessorStatus::RUNNING:
            val = "RUNNING";
            break;
        case eOAIStreamProcessorStatus::FAILED:
            val = "FAILED";
            break;
        case eOAIStreamProcessorStatus::STOPPING:
            val = "STOPPING";
            break;
        case eOAIStreamProcessorStatus::UPDATING:
            val = "UPDATING";
            break;
        default:
            break;
...
QJsonValue OAIStreamProcessorStatus::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIStreamProcessorStatus::eOAIStreamProcessorStatus OAIStreamProcessorStatus::getValue() const {
    return m_value;
}

void OAIStreamProcessorStatus::setValue(const OAIStreamProcessorStatus::eOAIStreamProcessorStatus& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIStreamProcessorStatus::isSet() const {
    
    return m_value_isSet;
}

bool OAIStreamProcessorStatus::isValid() const {
