...
#include "OAIRecognizeCelebritiesRequest.h"
...
OAIRecognizeCelebritiesRequest::OAIRecognizeCelebritiesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIRecognizeCelebritiesRequest::OAIRecognizeCelebritiesRequest() {
    this->initializeModel();
}

OAIRecognizeCelebritiesRequest::~OAIRecognizeCelebritiesRequest() {}

void OAIRecognizeCelebritiesRequest::initializeModel() {

    m_image_isSet = false;
    m_image_isValid = false;
}

void OAIRecognizeCelebritiesRequest::fromJson(QString jsonString) {
...
void OAIRecognizeCelebritiesRequest::fromJsonObject(QJsonObject json) {

    m_image_isValid = ::OpenAPI::fromJsonValue(m_image, json[QString("Image")]);
    m_image_isSet = !json[QString("Image")].isNull() && m_image_isValid;
}

QString OAIRecognizeCelebritiesRequest::asJson() const {
...
QJsonObject OAIRecognizeCelebritiesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_image.isSet()) {
...
OAICompareFacesRequest_SourceImage OAIRecognizeCelebritiesRequest::getImage() const {
    return m_image;
}
void OAIRecognizeCelebritiesRequest::setImage(const OAICompareFacesRequest_SourceImage &image) {
    m_image = image;
    m_image_isSet = true;
}

bool OAIRecognizeCelebritiesRequest::is_image_Set() const{
    return m_image_isSet;
}

bool OAIRecognizeCelebritiesRequest::is_image_Valid() const{
    return m_image_isValid;
}

bool OAIRecognizeCelebritiesRequest::isSet() const {
...
bool OAIRecognizeCelebritiesRequest::isValid() const {
