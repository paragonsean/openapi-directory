...
/*
 * OAIProtectiveEquipmentPerson.h
 *
...
#ifndef OAIProtectiveEquipmentPerson_H
#define OAIProtectiveEquipmentPerson_H

#include <QJsonObject>

#include "OAIProtectiveEquipmentPerson_BoundingBox.h"
#include <QList>
...
namespace OpenAPI {
class OAIProtectiveEquipmentPerson_BoundingBox;

class OAIProtectiveEquipmentPerson : public OAIObject {
public:
    OAIProtectiveEquipmentPerson();
    OAIProtectiveEquipmentPerson(QString json);
    ~OAIProtectiveEquipmentPerson() override;
    ...
    QList getBodyParts() const;
    void setBodyParts(const QList &body_parts);
    bool is_body_parts_Set() const;
    bool is_body_parts_Valid() const;

    OAIProtectiveEquipmentPerson_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAIProtectiveEquipmentPerson_BoundingBox &bounding_box);
...
private:
    ...
    QList m_body_parts;
    bool m_body_parts_isSet;
    bool m_body_parts_isValid;

    OAIProtectiveEquipmentPerson_BoundingBox m_bounding_box;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProtectiveEquipmentPerson)

#endif // OAIProtectiveEquipmentPerson_H
