...
#include "OAIKinesisDataStream.h"
...
OAIKinesisDataStream::OAIKinesisDataStream(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKinesisDataStream::OAIKinesisDataStream() {
    this->initializeModel();
}

OAIKinesisDataStream::~OAIKinesisDataStream() {}

void OAIKinesisDataStream::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIKinesisDataStream::fromJson(QString jsonString) {
...
void OAIKinesisDataStream::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIKinesisDataStream::asJson() const {
...
QJsonObject OAIKinesisDataStream::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIKinesisDataStream::getArn() const {
    return m_arn;
}
void OAIKinesisDataStream::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIKinesisDataStream::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIKinesisDataStream::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIKinesisDataStream::isSet() const {
...
bool OAIKinesisDataStream::isValid() const {
