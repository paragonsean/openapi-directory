...
/*
 * OAIStartLabelDetectionRequest.h
 *
 * 
 */

#ifndef OAIStartLabelDetectionRequest_H
#define OAIStartLabelDetectionRequest_H

#include <QJsonObject>

#include "OAIStartLabelDetectionRequest_NotificationChannel.h"
#include "OAIStartLabelDetectionRequest_Settings.h"
...
namespace OpenAPI {
class OAIStartLabelDetectionRequest_Video;
class OAIStartLabelDetectionRequest_NotificationChannel;
class OAIStartLabelDetectionRequest_Settings;

class OAIStartLabelDetectionRequest : public OAIObject {
public:
    OAIStartLabelDetectionRequest();
    OAIStartLabelDetectionRequest(QString json);
    ~OAIStartLabelDetectionRequest() override;
    ...
    OAIStartLabelDetectionRequest_Video getVideo() const;
    void setVideo(const OAIStartLabelDetectionRequest_Video &video);
    ...
    OAIStartLabelDetectionRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartLabelDetectionRequest_NotificationChannel &notification_channel);
    ...
    OAIStartLabelDetectionRequest_Settings getSettings() const;
    void setSettings(const OAIStartLabelDetectionRequest_Settings &settings);
...
private:
    ...
    OAIStartLabelDetectionRequest_Video m_video;
    bool m_video_isSet;
    ...
    OAIStartLabelDetectionRequest_NotificationChannel m_notification_channel;
    ...
    OAIStartLabelDetectionRequest_Settings m_settings;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartLabelDetectionRequest)

#endif // OAIStartLabelDetectionRequest_H
