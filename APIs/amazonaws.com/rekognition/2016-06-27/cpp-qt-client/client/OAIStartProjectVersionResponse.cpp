...
#include "OAIStartProjectVersionResponse.h"
...
OAIStartProjectVersionResponse::OAIStartProjectVersionResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartProjectVersionResponse::OAIStartProjectVersionResponse() {
    this->initializeModel();
}

OAIStartProjectVersionResponse::~OAIStartProjectVersionResponse() {}

void OAIStartProjectVersionResponse::initializeModel() {

    m_status_isSet = false;
    m_status_isValid = false;
}

void OAIStartProjectVersionResponse::fromJson(QString jsonString) {
...
void OAIStartProjectVersionResponse::fromJsonObject(QJsonObject json) {

    m_status_isValid = ::OpenAPI::fromJsonValue(m_status, json[QString("Status")]);
    m_status_isSet = !json[QString("Status")].isNull() && m_status_isValid;
}

QString OAIStartProjectVersionResponse::asJson() const {
...
QJsonObject OAIStartProjectVersionResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_status.isSet()) {
...
OAIProjectVersionStatus OAIStartProjectVersionResponse::getStatus() const {
    return m_status;
}
void OAIStartProjectVersionResponse::setStatus(const OAIProjectVersionStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStartProjectVersionResponse::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStartProjectVersionResponse::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStartProjectVersionResponse::isSet() const {
...
bool OAIStartProjectVersionResponse::isValid() const {
