...
#include "OAIGetContentModerationRequest.h"
...
OAIGetContentModerationRequest::OAIGetContentModerationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIGetContentModerationRequest::OAIGetContentModerationRequest() {
    this->initializeModel();
}

OAIGetContentModerationRequest::~OAIGetContentModerationRequest() {}

void OAIGetContentModerationRequest::initializeModel() {
...
void OAIGetContentModerationRequest::fromJson(QString jsonString) {
...
void OAIGetContentModerationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIGetContentModerationRequest::asJson() const {
...
QJsonObject OAIGetContentModerationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_job_id_isSet) {
...
QString OAIGetContentModerationRequest::getJobId() const {
    return m_job_id;
}
void OAIGetContentModerationRequest::setJobId(const QString &job_id) {
    m_job_id = job_id;
    m_job_id_isSet = true;
}

bool OAIGetContentModerationRequest::is_job_id_Set() const{
    return m_job_id_isSet;
}

bool OAIGetContentModerationRequest::is_job_id_Valid() const{
    return m_job_id_isValid;
}

qint32 OAIGetContentModerationRequest::getMaxResults() const {
    return m_max_results;
}
void OAIGetContentModerationRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIGetContentModerationRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIGetContentModerationRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QString OAIGetContentModerationRequest::getNextToken() const {
    return m_next_token;
}
void OAIGetContentModerationRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIGetContentModerationRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIGetContentModerationRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

OAIContentModerationSortBy OAIGetContentModerationRequest::getSortBy() const {
    return m_sort_by;
}
void OAIGetContentModerationRequest::setSortBy(const OAIContentModerationSortBy &sort_by) {
    m_sort_by = sort_by;
    m_sort_by_isSet = true;
}

bool OAIGetContentModerationRequest::is_sort_by_Set() const{
    return m_sort_by_isSet;
}

bool OAIGetContentModerationRequest::is_sort_by_Valid() const{
    return m_sort_by_isValid;
}

OAIContentModerationAggregateBy OAIGetContentModerationRequest::getAggregateBy() const {
    return m_aggregate_by;
}
void OAIGetContentModerationRequest::setAggregateBy(const OAIContentModerationAggregateBy &aggregate_by) {
    m_aggregate_by = aggregate_by;
    m_aggregate_by_isSet = true;
}

bool OAIGetContentModerationRequest::is_aggregate_by_Set() const{
    return m_aggregate_by_isSet;
}

bool OAIGetContentModerationRequest::is_aggregate_by_Valid() const{
    return m_aggregate_by_isValid;
}

bool OAIGetContentModerationRequest::isSet() const {
...
bool OAIGetContentModerationRequest::isValid() const {
