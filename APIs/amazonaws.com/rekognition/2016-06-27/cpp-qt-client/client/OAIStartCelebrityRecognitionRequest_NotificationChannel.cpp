...
OAIStartCelebrityRecognitionRequest_NotificationChannel::OAIStartCelebrityRecognitionRequest_NotificationChannel(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartCelebrityRecognitionRequest_NotificationChannel::OAIStartCelebrityRecognitionRequest_NotificationChannel() {
    this->initializeModel();
}

OAIStartCelebrityRecognitionRequest_NotificationChannel::~OAIStartCelebrityRecognitionRequest_NotificationChannel() {}

void OAIStartCelebrityRecognitionRequest_NotificationChannel::initializeModel() {
...
void OAIStartCelebrityRecognitionRequest_NotificationChannel::fromJson(QString jsonString) {
...
void OAIStartCelebrityRecognitionRequest_NotificationChannel::fromJsonObject(QJsonObject json) {
...
QString OAIStartCelebrityRecognitionRequest_NotificationChannel::asJson() const {
...
QJsonObject OAIStartCelebrityRecognitionRequest_NotificationChannel::asJsonObject() const {
    QJsonObject obj;
...
QString OAIStartCelebrityRecognitionRequest_NotificationChannel::getSnsTopicArn() const {
    return m_sns_topic_arn;
}
void OAIStartCelebrityRecognitionRequest_NotificationChannel::setSnsTopicArn(const QString &sns_topic_arn) {
    m_sns_topic_arn = sns_topic_arn;
    m_sns_topic_arn_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest_NotificationChannel::is_sns_topic_arn_Set() const{
    return m_sns_topic_arn_isSet;
}

bool OAIStartCelebrityRecognitionRequest_NotificationChannel::is_sns_topic_arn_Valid() const{
    return m_sns_topic_arn_isValid;
}

QString OAIStartCelebrityRecognitionRequest_NotificationChannel::getRoleArn() const {
    return m_role_arn;
}
void OAIStartCelebrityRecognitionRequest_NotificationChannel::setRoleArn(const QString &role_arn) {
    m_role_arn = role_arn;
    m_role_arn_isSet = true;
}

bool OAIStartCelebrityRecognitionRequest_NotificationChannel::is_role_arn_Set() const{
    return m_role_arn_isSet;
}

bool OAIStartCelebrityRecognitionRequest_NotificationChannel::is_role_arn_Valid() const{
    return m_role_arn_isValid;
}

bool OAIStartCelebrityRecognitionRequest_NotificationChannel::isSet() const {
...
bool OAIStartCelebrityRecognitionRequest_NotificationChannel::isValid() const {
