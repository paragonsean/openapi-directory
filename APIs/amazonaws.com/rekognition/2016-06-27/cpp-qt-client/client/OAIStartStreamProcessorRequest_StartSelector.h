...
/*
 * OAIStartStreamProcessorRequest_StartSelector.h
 *
 * 
 */

#ifndef OAIStartStreamProcessorRequest_StartSelector_H
#define OAIStartStreamProcessorRequest_StartSelector_H
...
namespace OpenAPI {
class OAIStreamProcessingStartSelector_KVSStreamStartSelector;

class OAIStartStreamProcessorRequest_StartSelector : public OAIObject {
public:
    OAIStartStreamProcessorRequest_StartSelector();
    OAIStartStreamProcessorRequest_StartSelector(QString json);
    ~OAIStartStreamProcessorRequest_StartSelector() override;
    ...
    OAIStreamProcessingStartSelector_KVSStreamStartSelector getKvsStreamStartSelector() const;
    void setKvsStreamStartSelector(const OAIStreamProcessingStartSelector_KVSStreamStartSelector &kvs_stream_start_selector);
    bool is_kvs_stream_start_selector_Set() const;
    bool is_kvs_stream_start_selector_Valid() const;
...
private:
    ...
    OAIStreamProcessingStartSelector_KVSStreamStartSelector m_kvs_stream_start_selector;
    bool m_kvs_stream_start_selector_isSet;
    bool m_kvs_stream_start_selector_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartStreamProcessorRequest_StartSelector)

#endif // OAIStartStreamProcessorRequest_StartSelector_H
