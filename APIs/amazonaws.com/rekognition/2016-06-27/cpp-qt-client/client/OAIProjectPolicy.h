...
#ifndef OAIProjectPolicy_H
#define OAIProjectPolicy_H
...
class OAIProjectPolicy : public OAIObject {
public:
    OAIProjectPolicy();
    OAIProjectPolicy(QString json);
    ~OAIProjectPolicy() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectPolicy)

#endif // OAIProjectPolicy_H
