...
/*
 * OAIStartSegmentDetectionFilters.h
 *
 * Filters applied to the technical cue or shot detection segments. For more information, see &lt;a&gt;StartSegmentDetection&lt;/a&gt;. 
 */

#ifndef OAIStartSegmentDetectionFilters_H
#define OAIStartSegmentDetectionFilters_H

#include <QJsonObject>

#include "OAIStartSegmentDetectionFilters_ShotFilter.h"
#include "OAIStartSegmentDetectionFilters_TechnicalCueFilter.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStartSegmentDetectionFilters_TechnicalCueFilter;
class OAIStartSegmentDetectionFilters_ShotFilter;

class OAIStartSegmentDetectionFilters : public OAIObject {
public:
    OAIStartSegmentDetectionFilters();
    OAIStartSegmentDetectionFilters(QString json);
    ~OAIStartSegmentDetectionFilters() override;
    ...
    OAIStartSegmentDetectionFilters_TechnicalCueFilter getTechnicalCueFilter() const;
    void setTechnicalCueFilter(const OAIStartSegmentDetectionFilters_TechnicalCueFilter &technical_cue_filter);
    bool is_technical_cue_filter_Set() const;
    bool is_technical_cue_filter_Valid() const;

    OAIStartSegmentDetectionFilters_ShotFilter getShotFilter() const;
    void setShotFilter(const OAIStartSegmentDetectionFilters_ShotFilter &shot_filter);
    bool is_shot_filter_Set() const;
    bool is_shot_filter_Valid() const;
...
private:
    ...
    OAIStartSegmentDetectionFilters_TechnicalCueFilter m_technical_cue_filter;
    bool m_technical_cue_filter_isSet;
    bool m_technical_cue_filter_isValid;

    OAIStartSegmentDetectionFilters_ShotFilter m_shot_filter;
    bool m_shot_filter_isSet;
    bool m_shot_filter_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartSegmentDetectionFilters)

#endif // OAIStartSegmentDetectionFilters_H
