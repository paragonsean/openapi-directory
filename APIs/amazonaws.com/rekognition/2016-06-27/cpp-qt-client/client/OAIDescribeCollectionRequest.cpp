...
#include "OAIDescribeCollectionRequest.h"
...
OAIDescribeCollectionRequest::OAIDescribeCollectionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeCollectionRequest::OAIDescribeCollectionRequest() {
    this->initializeModel();
}

OAIDescribeCollectionRequest::~OAIDescribeCollectionRequest() {}

void OAIDescribeCollectionRequest::initializeModel() {

    m_collection_id_isSet = false;
    m_collection_id_isValid = false;
}

void OAIDescribeCollectionRequest::fromJson(QString jsonString) {
...
void OAIDescribeCollectionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeCollectionRequest::asJson() const {
...
QJsonObject OAIDescribeCollectionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIDescribeCollectionRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIDescribeCollectionRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIDescribeCollectionRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIDescribeCollectionRequest::is_collection_id_Valid() const{
    return m_collection_id_isValid;
}

bool OAIDescribeCollectionRequest::isSet() const {
...
bool OAIDescribeCollectionRequest::isValid() const {
