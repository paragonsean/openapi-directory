...
#include "OAIEquipmentDetection.h"
...
OAIEquipmentDetection::OAIEquipmentDetection(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEquipmentDetection::OAIEquipmentDetection() {
    this->initializeModel();
}

OAIEquipmentDetection::~OAIEquipmentDetection() {}

void OAIEquipmentDetection::initializeModel() {
    ...
    m_covers_body_part_isSet = false;
    m_covers_body_part_isValid = false;
}

void OAIEquipmentDetection::fromJson(QString jsonString) {
...
void OAIEquipmentDetection::fromJsonObject(QJsonObject json) {
    ...
    m_covers_body_part_isValid = ::OpenAPI::fromJsonValue(m_covers_body_part, json[QString("CoversBodyPart")]);
    m_covers_body_part_isSet = !json[QString("CoversBodyPart")].isNull() && m_covers_body_part_isValid;
}

QString OAIEquipmentDetection::asJson() const {
...
QJsonObject OAIEquipmentDetection::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_covers_body_part.isSet()) {
        obj.insert(QString("CoversBodyPart"), ::OpenAPI::toJsonValue(m_covers_body_part));
    }
    return obj;
}

OAIEquipmentDetection_BoundingBox OAIEquipmentDetection::getBoundingBox() const {
    return m_bounding_box;
}
void OAIEquipmentDetection::setBoundingBox(const OAIEquipmentDetection_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIEquipmentDetection::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIEquipmentDetection::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

float OAIEquipmentDetection::getConfidence() const {
    return m_confidence;
}
void OAIEquipmentDetection::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIEquipmentDetection::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIEquipmentDetection::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAIProtectiveEquipmentType OAIEquipmentDetection::getType() const {
    return m_type;
}
void OAIEquipmentDetection::setType(const OAIProtectiveEquipmentType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIEquipmentDetection::is_type_Set() const{
    return m_type_isSet;
}

bool OAIEquipmentDetection::is_type_Valid() const{
    return m_type_isValid;
}

OAIEquipmentDetection_CoversBodyPart OAIEquipmentDetection::getCoversBodyPart() const {
    return m_covers_body_part;
}
void OAIEquipmentDetection::setCoversBodyPart(const OAIEquipmentDetection_CoversBodyPart &covers_body_part) {
    m_covers_body_part = covers_body_part;
    m_covers_body_part_isSet = true;
}

bool OAIEquipmentDetection::is_covers_body_part_Set() const{
    return m_covers_body_part_isSet;
}

bool OAIEquipmentDetection::is_covers_body_part_Valid() const{
    return m_covers_body_part_isValid;
}

bool OAIEquipmentDetection::isSet() const {
...
bool OAIEquipmentDetection::isValid() const {
