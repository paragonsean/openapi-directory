...
/*
 * OAIListProjectPoliciesResponse.h
 *
 * 
 */

#ifndef OAIListProjectPoliciesResponse_H
#define OAIListProjectPoliciesResponse_H
...
class OAIListProjectPoliciesResponse : public OAIObject {
public:
    OAIListProjectPoliciesResponse();
    OAIListProjectPoliciesResponse(QString json);
    ~OAIListProjectPoliciesResponse() override;
    ...
    QList getProjectPolicies() const;
    void setProjectPolicies(const QList &project_policies);
    bool is_project_policies_Set() const;
    bool is_project_policies_Valid() const;
...
private:
    ...
    QList m_project_policies;
    bool m_project_policies_isSet;
    bool m_project_policies_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListProjectPoliciesResponse)

#endif // OAIListProjectPoliciesResponse_H
