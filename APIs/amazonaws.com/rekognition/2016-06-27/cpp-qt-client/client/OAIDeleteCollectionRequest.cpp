...
QString OAIDeleteCollectionRequest::getCollectionId() const {
    return m_collection_id;
}
void OAIDeleteCollectionRequest::setCollectionId(const QString &collection_id) {
    m_collection_id = collection_id;
    m_collection_id_isSet = true;
}

bool OAIDeleteCollectionRequest::is_collection_id_Set() const{
    return m_collection_id_isSet;
}

bool OAIDeleteCollectionRequest::is_collection_id_Valid() const{
