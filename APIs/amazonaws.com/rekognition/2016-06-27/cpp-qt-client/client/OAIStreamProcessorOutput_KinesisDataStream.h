...
/*
 * OAIStreamProcessorOutput_KinesisDataStream.h
 *
 * 
 */

#ifndef OAIStreamProcessorOutput_KinesisDataStream_H
#define OAIStreamProcessorOutput_KinesisDataStream_H
...
class OAIStreamProcessorOutput_KinesisDataStream : public OAIObject {
public:
    OAIStreamProcessorOutput_KinesisDataStream();
    OAIStreamProcessorOutput_KinesisDataStream(QString json);
    ~OAIStreamProcessorOutput_KinesisDataStream() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStreamProcessorOutput_KinesisDataStream)

#endif // OAIStreamProcessorOutput_KinesisDataStream_H
