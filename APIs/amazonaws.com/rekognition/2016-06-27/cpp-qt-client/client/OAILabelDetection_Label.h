...
/*
 * OAILabelDetection_Label.h
 *
 * 
 */

#ifndef OAILabelDetection_Label_H
#define OAILabelDetection_Label_H
...
class OAILabelDetection_Label : public OAIObject {
public:
    OAILabelDetection_Label();
    OAILabelDetection_Label(QString json);
    ~OAILabelDetection_Label() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelDetection_Label)

#endif // OAILabelDetection_Label_H
