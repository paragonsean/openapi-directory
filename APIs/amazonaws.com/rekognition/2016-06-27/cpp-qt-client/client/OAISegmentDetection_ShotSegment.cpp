...
#include "OAISegmentDetection_ShotSegment.h"
...
OAISegmentDetection_ShotSegment::OAISegmentDetection_ShotSegment(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISegmentDetection_ShotSegment::OAISegmentDetection_ShotSegment() {
    this->initializeModel();
}

OAISegmentDetection_ShotSegment::~OAISegmentDetection_ShotSegment() {}

void OAISegmentDetection_ShotSegment::initializeModel() {
...
void OAISegmentDetection_ShotSegment::fromJson(QString jsonString) {
...
void OAISegmentDetection_ShotSegment::fromJsonObject(QJsonObject json) {
...
QString OAISegmentDetection_ShotSegment::asJson() const {
...
QJsonObject OAISegmentDetection_ShotSegment::asJsonObject() const {
    QJsonObject obj;
    if (m_index_isSet) {
...
qint32 OAISegmentDetection_ShotSegment::getIndex() const {
    return m_index;
}
void OAISegmentDetection_ShotSegment::setIndex(const qint32 &index) {
    m_index = index;
    m_index_isSet = true;
}

bool OAISegmentDetection_ShotSegment::is_index_Set() const{
    return m_index_isSet;
}

bool OAISegmentDetection_ShotSegment::is_index_Valid() const{
    return m_index_isValid;
}

float OAISegmentDetection_ShotSegment::getConfidence() const {
    return m_confidence;
}
void OAISegmentDetection_ShotSegment::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAISegmentDetection_ShotSegment::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAISegmentDetection_ShotSegment::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAISegmentDetection_ShotSegment::isSet() const {
...
bool OAISegmentDetection_ShotSegment::isValid() const {
