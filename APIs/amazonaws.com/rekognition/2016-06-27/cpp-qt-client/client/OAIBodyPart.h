...
class OAIBodyPart : public OAIEnum {
public:
    OAIBodyPart();
    ...
    OAIBodyPart::eOAIBodyPart getValue() const;
    void setValue(const OAIBodyPart::eOAIBodyPart& value);
