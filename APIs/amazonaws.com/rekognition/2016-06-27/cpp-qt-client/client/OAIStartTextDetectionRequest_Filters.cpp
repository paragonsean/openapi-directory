...
#include "OAIStartTextDetectionRequest_Filters.h"
...
OAIStartTextDetectionRequest_Filters::OAIStartTextDetectionRequest_Filters(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartTextDetectionRequest_Filters::OAIStartTextDetectionRequest_Filters() {
    this->initializeModel();
}

OAIStartTextDetectionRequest_Filters::~OAIStartTextDetectionRequest_Filters() {}

void OAIStartTextDetectionRequest_Filters::initializeModel() {

    m_word_filter_isSet = false;
    m_word_filter_isValid = false;

    m_regions_of_interest_isSet = false;
    m_regions_of_interest_isValid = false;
}

void OAIStartTextDetectionRequest_Filters::fromJson(QString jsonString) {
...
void OAIStartTextDetectionRequest_Filters::fromJsonObject(QJsonObject json) {

    m_word_filter_isValid = ::OpenAPI::fromJsonValue(m_word_filter, json[QString("WordFilter")]);
    m_word_filter_isSet = !json[QString("WordFilter")].isNull() && m_word_filter_isValid;

    m_regions_of_interest_isValid = ::OpenAPI::fromJsonValue(m_regions_of_interest, json[QString("RegionsOfInterest")]);
    m_regions_of_interest_isSet = !json[QString("RegionsOfInterest")].isNull() && m_regions_of_interest_isValid;
}

QString OAIStartTextDetectionRequest_Filters::asJson() const {
...
QJsonObject OAIStartTextDetectionRequest_Filters::asJsonObject() const {
    QJsonObject obj;
    if (m_word_filter.isSet()) {
        obj.insert(QString("WordFilter"), ::OpenAPI::toJsonValue(m_word_filter));
    }
    if (m_regions_of_interest.isSet()) {
        obj.insert(QString("RegionsOfInterest"), ::OpenAPI::toJsonValue(m_regions_of_interest));
    }
    return obj;
}

OAIStartTextDetectionFilters_WordFilter OAIStartTextDetectionRequest_Filters::getWordFilter() const {
    return m_word_filter;
}
void OAIStartTextDetectionRequest_Filters::setWordFilter(const OAIStartTextDetectionFilters_WordFilter &word_filter) {
    m_word_filter = word_filter;
    m_word_filter_isSet = true;
}

bool OAIStartTextDetectionRequest_Filters::is_word_filter_Set() const{
    return m_word_filter_isSet;
}

bool OAIStartTextDetectionRequest_Filters::is_word_filter_Valid() const{
    return m_word_filter_isValid;
}

QList OAIStartTextDetectionRequest_Filters::getRegionsOfInterest() const {
    return m_regions_of_interest;
}
void OAIStartTextDetectionRequest_Filters::setRegionsOfInterest(const QList &regions_of_interest) {
    m_regions_of_interest = regions_of_interest;
    m_regions_of_interest_isSet = true;
}

bool OAIStartTextDetectionRequest_Filters::is_regions_of_interest_Set() const{
    return m_regions_of_interest_isSet;
}

bool OAIStartTextDetectionRequest_Filters::is_regions_of_interest_Valid() const{
    return m_regions_of_interest_isValid;
}

bool OAIStartTextDetectionRequest_Filters::isSet() const {
...
bool OAIStartTextDetectionRequest_Filters::isValid() const {
