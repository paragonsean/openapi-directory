...
/*
 * OAIListFacesResponse.h
 *
 * 
 */

#ifndef OAIListFacesResponse_H
#define OAIListFacesResponse_H
...
class OAIListFacesResponse : public OAIObject {
public:
    OAIListFacesResponse();
    OAIListFacesResponse(QString json);
    ~OAIListFacesResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFacesResponse)

#endif // OAIListFacesResponse_H
