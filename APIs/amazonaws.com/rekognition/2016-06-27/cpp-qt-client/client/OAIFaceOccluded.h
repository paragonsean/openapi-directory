...
#ifndef OAIFaceOccluded_H
#define OAIFaceOccluded_H
...
class OAIFaceOccluded : public OAIObject {
public:
    OAIFaceOccluded();
    OAIFaceOccluded(QString json);
    ~OAIFaceOccluded() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceOccluded)

#endif // OAIFaceOccluded_H
