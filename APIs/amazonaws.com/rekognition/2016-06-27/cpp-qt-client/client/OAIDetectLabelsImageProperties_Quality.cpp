...
#include "OAIDetectLabelsImageProperties_Quality.h"
...
OAIDetectLabelsImageProperties_Quality::OAIDetectLabelsImageProperties_Quality(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImageProperties_Quality::OAIDetectLabelsImageProperties_Quality() {
    this->initializeModel();
}

OAIDetectLabelsImageProperties_Quality::~OAIDetectLabelsImageProperties_Quality() {}

void OAIDetectLabelsImageProperties_Quality::initializeModel() {
...
void OAIDetectLabelsImageProperties_Quality::fromJson(QString jsonString) {
...
void OAIDetectLabelsImageProperties_Quality::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImageProperties_Quality::asJson() const {
...
QJsonObject OAIDetectLabelsImageProperties_Quality::asJsonObject() const {
    QJsonObject obj;
...
float OAIDetectLabelsImageProperties_Quality::getBrightness() const {
    return m_brightness;
}
void OAIDetectLabelsImageProperties_Quality::setBrightness(const float &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIDetectLabelsImageProperties_Quality::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIDetectLabelsImageProperties_Quality::is_brightness_Valid() const{
    return m_brightness_isValid;
}

float OAIDetectLabelsImageProperties_Quality::getSharpness() const {
    return m_sharpness;
}
void OAIDetectLabelsImageProperties_Quality::setSharpness(const float &sharpness) {
    m_sharpness = sharpness;
    m_sharpness_isSet = true;
}

bool OAIDetectLabelsImageProperties_Quality::is_sharpness_Set() const{
    return m_sharpness_isSet;
}

bool OAIDetectLabelsImageProperties_Quality::is_sharpness_Valid() const{
    return m_sharpness_isValid;
}

float OAIDetectLabelsImageProperties_Quality::getContrast() const {
    return m_contrast;
}
void OAIDetectLabelsImageProperties_Quality::setContrast(const float &contrast) {
    m_contrast = contrast;
    m_contrast_isSet = true;
}

bool OAIDetectLabelsImageProperties_Quality::is_contrast_Set() const{
    return m_contrast_isSet;
}

bool OAIDetectLabelsImageProperties_Quality::is_contrast_Valid() const{
    return m_contrast_isValid;
}

bool OAIDetectLabelsImageProperties_Quality::isSet() const {
...
bool OAIDetectLabelsImageProperties_Quality::isValid() const {
