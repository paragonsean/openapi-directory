...
#include "OAIDescribeProjectVersionsRequest.h"
...
OAIDescribeProjectVersionsRequest::OAIDescribeProjectVersionsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeProjectVersionsRequest::OAIDescribeProjectVersionsRequest() {
    this->initializeModel();
}

OAIDescribeProjectVersionsRequest::~OAIDescribeProjectVersionsRequest() {}

void OAIDescribeProjectVersionsRequest::initializeModel() {

    m_project_arn_isSet = false;
    m_project_arn_isValid = false;

    m_version_names_isSet = false;
    m_version_names_isValid = false;
...
void OAIDescribeProjectVersionsRequest::fromJson(QString jsonString) {
...
void OAIDescribeProjectVersionsRequest::fromJsonObject(QJsonObject json) {
    ...
    m_version_names_isValid = ::OpenAPI::fromJsonValue(m_version_names, json[QString("VersionNames")]);
    m_version_names_isSet = !json[QString("VersionNames")].isNull() && m_version_names_isValid;
...
QString OAIDescribeProjectVersionsRequest::asJson() const {
...
QJsonObject OAIDescribeProjectVersionsRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_project_arn_isSet) {
        obj.insert(QString("ProjectArn"), ::OpenAPI::toJsonValue(m_project_arn));
    }
    if (m_version_names.isSet()) {
        obj.insert(QString("VersionNames"), ::OpenAPI::toJsonValue(m_version_names));
    }
...
QString OAIDescribeProjectVersionsRequest::getProjectArn() const {
    return m_project_arn;
}
void OAIDescribeProjectVersionsRequest::setProjectArn(const QString &project_arn) {
    m_project_arn = project_arn;
    m_project_arn_isSet = true;
}

bool OAIDescribeProjectVersionsRequest::is_project_arn_Set() const{
    return m_project_arn_isSet;
}

bool OAIDescribeProjectVersionsRequest::is_project_arn_Valid() const{
    return m_project_arn_isValid;
}

QList OAIDescribeProjectVersionsRequest::getVersionNames() const {
    return m_version_names;
}
void OAIDescribeProjectVersionsRequest::setVersionNames(const QList &version_names) {
    m_version_names = version_names;
    m_version_names_isSet = true;
}

bool OAIDescribeProjectVersionsRequest::is_version_names_Set() const{
    return m_version_names_isSet;
}

bool OAIDescribeProjectVersionsRequest::is_version_names_Valid() const{
    return m_version_names_isValid;
}

QString OAIDescribeProjectVersionsRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeProjectVersionsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeProjectVersionsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeProjectVersionsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeProjectVersionsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeProjectVersionsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeProjectVersionsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeProjectVersionsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

bool OAIDescribeProjectVersionsRequest::isSet() const {
...
bool OAIDescribeProjectVersionsRequest::isValid() const {
