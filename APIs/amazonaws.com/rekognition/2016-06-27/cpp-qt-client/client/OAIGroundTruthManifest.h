...
/*
 * OAIGroundTruthManifest.h
 *
 * The S3 bucket that contains an Amazon Sagemaker Ground Truth format manifest file. 
 */

#ifndef OAIGroundTruthManifest_H
#define OAIGroundTruthManifest_H
...
class OAIGroundTruthManifest : public OAIObject {
public:
    OAIGroundTruthManifest();
    OAIGroundTruthManifest(QString json);
    ~OAIGroundTruthManifest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGroundTruthManifest)

#endif // OAIGroundTruthManifest_H
