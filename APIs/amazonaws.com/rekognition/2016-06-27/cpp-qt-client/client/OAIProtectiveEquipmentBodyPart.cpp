...
#include "OAIProtectiveEquipmentBodyPart.h"
...
OAIProtectiveEquipmentBodyPart::OAIProtectiveEquipmentBodyPart(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProtectiveEquipmentBodyPart::OAIProtectiveEquipmentBodyPart() {
    this->initializeModel();
}

OAIProtectiveEquipmentBodyPart::~OAIProtectiveEquipmentBodyPart() {}

void OAIProtectiveEquipmentBodyPart::initializeModel() {
    ...
    m_equipment_detections_isSet = false;
    m_equipment_detections_isValid = false;
}

void OAIProtectiveEquipmentBodyPart::fromJson(QString jsonString) {
...
void OAIProtectiveEquipmentBodyPart::fromJsonObject(QJsonObject json) {
    ...
    m_equipment_detections_isValid = ::OpenAPI::fromJsonValue(m_equipment_detections, json[QString("EquipmentDetections")]);
    m_equipment_detections_isSet = !json[QString("EquipmentDetections")].isNull() && m_equipment_detections_isValid;
}

QString OAIProtectiveEquipmentBodyPart::asJson() const {
...
QJsonObject OAIProtectiveEquipmentBodyPart::asJsonObject() const {
    QJsonObject obj;
    if (m_name.isSet()) {
    ...
    if (m_equipment_detections.isSet()) {
        obj.insert(QString("EquipmentDetections"), ::OpenAPI::toJsonValue(m_equipment_detections));
    }
    return obj;
}

OAIBodyPart OAIProtectiveEquipmentBodyPart::getName() const {
    return m_name;
}
void OAIProtectiveEquipmentBodyPart::setName(const OAIBodyPart &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIProtectiveEquipmentBodyPart::is_name_Set() const{
    return m_name_isSet;
}

bool OAIProtectiveEquipmentBodyPart::is_name_Valid() const{
    return m_name_isValid;
}

float OAIProtectiveEquipmentBodyPart::getConfidence() const {
    return m_confidence;
}
void OAIProtectiveEquipmentBodyPart::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIProtectiveEquipmentBodyPart::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIProtectiveEquipmentBodyPart::is_confidence_Valid() const{
    return m_confidence_isValid;
}

QList OAIProtectiveEquipmentBodyPart::getEquipmentDetections() const {
    return m_equipment_detections;
}
void OAIProtectiveEquipmentBodyPart::setEquipmentDetections(const QList &equipment_detections) {
    m_equipment_detections = equipment_detections;
    m_equipment_detections_isSet = true;
}

bool OAIProtectiveEquipmentBodyPart::is_equipment_detections_Set() const{
    return m_equipment_detections_isSet;
}

bool OAIProtectiveEquipmentBodyPart::is_equipment_detections_Valid() const{
    return m_equipment_detections_isValid;
}

bool OAIProtectiveEquipmentBodyPart::isSet() const {
...
bool OAIProtectiveEquipmentBodyPart::isValid() const {
