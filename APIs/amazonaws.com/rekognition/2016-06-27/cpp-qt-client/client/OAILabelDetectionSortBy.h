...
/*
 * OAILabelDetectionSortBy.h
 *
 * 
 */

#ifndef OAILabelDetectionSortBy_H
#define OAILabelDetectionSortBy_H
...
class OAILabelDetectionSortBy : public OAIEnum {
public:
    OAILabelDetectionSortBy();
    OAILabelDetectionSortBy(QString json);
    ~OAILabelDetectionSortBy() override;
    ...
    enum class eOAILabelDetectionSortBy {
        INVALID_VALUE_OPENAPI_GENERATED = 0,
        NAME, 
        TIMESTAMP
    };
    OAILabelDetectionSortBy::eOAILabelDetectionSortBy getValue() const;
    void setValue(const OAILabelDetectionSortBy::eOAILabelDetectionSortBy& value);
...
private:
    ...
    eOAILabelDetectionSortBy m_value;
    bool m_value_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILabelDetectionSortBy)

#endif // OAILabelDetectionSortBy_H
