...
OAIUnindexedFace_FaceDetail::OAIUnindexedFace_FaceDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnindexedFace_FaceDetail::OAIUnindexedFace_FaceDetail() {
    this->initializeModel();
}

OAIUnindexedFace_FaceDetail::~OAIUnindexedFace_FaceDetail() {}

void OAIUnindexedFace_FaceDetail::initializeModel() {
...
void OAIUnindexedFace_FaceDetail::fromJson(QString jsonString) {
...
void OAIUnindexedFace_FaceDetail::fromJsonObject(QJsonObject json) {
...
QString OAIUnindexedFace_FaceDetail::asJson() const {
...
QJsonObject OAIUnindexedFace_FaceDetail::asJsonObject() const {
    QJsonObject obj;
...
OAIFaceDetail_BoundingBox OAIUnindexedFace_FaceDetail::getBoundingBox() const {
    return m_bounding_box;
}
void OAIUnindexedFace_FaceDetail::setBoundingBox(const OAIFaceDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAIFaceDetail_AgeRange OAIUnindexedFace_FaceDetail::getAgeRange() const {
    return m_age_range;
}
void OAIUnindexedFace_FaceDetail::setAgeRange(const OAIFaceDetail_AgeRange &age_range) {
    m_age_range = age_range;
    m_age_range_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_age_range_Set() const{
    return m_age_range_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_age_range_Valid() const{
    return m_age_range_isValid;
}

OAIFaceDetail_Smile OAIUnindexedFace_FaceDetail::getSmile() const {
    return m_smile;
}
void OAIUnindexedFace_FaceDetail::setSmile(const OAIFaceDetail_Smile &smile) {
    m_smile = smile;
    m_smile_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_smile_Set() const{
    return m_smile_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_smile_Valid() const{
    return m_smile_isValid;
}

OAIFaceDetail_Eyeglasses OAIUnindexedFace_FaceDetail::getEyeglasses() const {
    return m_eyeglasses;
}
void OAIUnindexedFace_FaceDetail::setEyeglasses(const OAIFaceDetail_Eyeglasses &eyeglasses) {
    m_eyeglasses = eyeglasses;
    m_eyeglasses_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_eyeglasses_Set() const{
    return m_eyeglasses_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_eyeglasses_Valid() const{
    return m_eyeglasses_isValid;
}

OAIFaceDetail_Sunglasses OAIUnindexedFace_FaceDetail::getSunglasses() const {
    return m_sunglasses;
}
void OAIUnindexedFace_FaceDetail::setSunglasses(const OAIFaceDetail_Sunglasses &sunglasses) {
    m_sunglasses = sunglasses;
    m_sunglasses_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_sunglasses_Set() const{
    return m_sunglasses_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_sunglasses_Valid() const{
    return m_sunglasses_isValid;
}

OAIFaceDetail_Gender OAIUnindexedFace_FaceDetail::getGender() const {
    return m_gender;
}
void OAIUnindexedFace_FaceDetail::setGender(const OAIFaceDetail_Gender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_gender_Valid() const{
    return m_gender_isValid;
}

OAIFaceDetail_Beard OAIUnindexedFace_FaceDetail::getBeard() const {
    return m_beard;
}
void OAIUnindexedFace_FaceDetail::setBeard(const OAIFaceDetail_Beard &beard) {
    m_beard = beard;
    m_beard_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_beard_Set() const{
    return m_beard_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_beard_Valid() const{
    return m_beard_isValid;
}

OAIFaceDetail_Mustache OAIUnindexedFace_FaceDetail::getMustache() const {
    return m_mustache;
}
void OAIUnindexedFace_FaceDetail::setMustache(const OAIFaceDetail_Mustache &mustache) {
    m_mustache = mustache;
    m_mustache_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_mustache_Set() const{
    return m_mustache_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_mustache_Valid() const{
    return m_mustache_isValid;
}

OAIFaceDetail_EyesOpen OAIUnindexedFace_FaceDetail::getEyesOpen() const {
    return m_eyes_open;
}
void OAIUnindexedFace_FaceDetail::setEyesOpen(const OAIFaceDetail_EyesOpen &eyes_open) {
    m_eyes_open = eyes_open;
    m_eyes_open_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_eyes_open_Set() const{
    return m_eyes_open_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_eyes_open_Valid() const{
    return m_eyes_open_isValid;
}

OAIFaceDetail_MouthOpen OAIUnindexedFace_FaceDetail::getMouthOpen() const {
    return m_mouth_open;
}
void OAIUnindexedFace_FaceDetail::setMouthOpen(const OAIFaceDetail_MouthOpen &mouth_open) {
    m_mouth_open = mouth_open;
    m_mouth_open_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_mouth_open_Set() const{
    return m_mouth_open_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_mouth_open_Valid() const{
    return m_mouth_open_isValid;
}

QList OAIUnindexedFace_FaceDetail::getEmotions() const {
    return m_emotions;
}
void OAIUnindexedFace_FaceDetail::setEmotions(const QList &emotions) {
    m_emotions = emotions;
    m_emotions_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_emotions_Set() const{
    return m_emotions_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_emotions_Valid() const{
    return m_emotions_isValid;
}

QList OAIUnindexedFace_FaceDetail::getLandmarks() const {
    return m_landmarks;
}
void OAIUnindexedFace_FaceDetail::setLandmarks(const QList &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

OAIFaceDetail_Pose OAIUnindexedFace_FaceDetail::getPose() const {
    return m_pose;
}
void OAIUnindexedFace_FaceDetail::setPose(const OAIFaceDetail_Pose &pose) {
    m_pose = pose;
    m_pose_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_pose_Set() const{
    return m_pose_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_pose_Valid() const{
    return m_pose_isValid;
}

OAIFaceDetail_Quality OAIUnindexedFace_FaceDetail::getQuality() const {
    return m_quality;
}
void OAIUnindexedFace_FaceDetail::setQuality(const OAIFaceDetail_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_quality_Valid() const{
    return m_quality_isValid;
}

float OAIUnindexedFace_FaceDetail::getConfidence() const {
    return m_confidence;
}
void OAIUnindexedFace_FaceDetail::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAIFaceDetail_FaceOccluded OAIUnindexedFace_FaceDetail::getFaceOccluded() const {
    return m_face_occluded;
}
void OAIUnindexedFace_FaceDetail::setFaceOccluded(const OAIFaceDetail_FaceOccluded &face_occluded) {
    m_face_occluded = face_occluded;
    m_face_occluded_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_face_occluded_Set() const{
    return m_face_occluded_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_face_occluded_Valid() const{
    return m_face_occluded_isValid;
}

OAIFaceDetail_EyeDirection OAIUnindexedFace_FaceDetail::getEyeDirection() const {
    return m_eye_direction;
}
void OAIUnindexedFace_FaceDetail::setEyeDirection(const OAIFaceDetail_EyeDirection &eye_direction) {
    m_eye_direction = eye_direction;
    m_eye_direction_isSet = true;
}

bool OAIUnindexedFace_FaceDetail::is_eye_direction_Set() const{
    return m_eye_direction_isSet;
}

bool OAIUnindexedFace_FaceDetail::is_eye_direction_Valid() const{
    return m_eye_direction_isValid;
}

bool OAIUnindexedFace_FaceDetail::isSet() const {
...
bool OAIUnindexedFace_FaceDetail::isValid() const {
