...
/*
 * OAIListFacesRequest.h
 *
 * 
 */

#ifndef OAIListFacesRequest_H
#define OAIListFacesRequest_H
...
class OAIListFacesRequest : public OAIObject {
public:
    OAIListFacesRequest();
    OAIListFacesRequest(QString json);
    ~OAIListFacesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListFacesRequest)

#endif // OAIListFacesRequest_H
