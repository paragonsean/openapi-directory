...
OAITrainingData::OAITrainingData(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITrainingData::OAITrainingData() {
    this->initializeModel();
}

OAITrainingData::~OAITrainingData() {}

void OAITrainingData::initializeModel() {

    m_assets_isSet = false;
    m_assets_isValid = false;
}

void OAITrainingData::fromJson(QString jsonString) {
...
void OAITrainingData::fromJsonObject(QJsonObject json) {
...
QString OAITrainingData::asJson() const {
...
QJsonObject OAITrainingData::asJsonObject() const {
    QJsonObject obj;
    if (m_assets.isSet()) {
...
QList OAITrainingData::getAssets() const {
    return m_assets;
}
void OAITrainingData::setAssets(const QList &assets) {
    m_assets = assets;
    m_assets_isSet = true;
}

bool OAITrainingData::is_assets_Set() const{
    return m_assets_isSet;
}

bool OAITrainingData::is_assets_Valid() const{
    return m_assets_isValid;
}

bool OAITrainingData::isSet() const {
...
bool OAITrainingData::isValid() const {
