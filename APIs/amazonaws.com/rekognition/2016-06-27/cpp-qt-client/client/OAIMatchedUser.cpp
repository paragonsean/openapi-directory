...
OAIMatchedUser::OAIMatchedUser(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIMatchedUser::OAIMatchedUser() {
    this->initializeModel();
}

OAIMatchedUser::~OAIMatchedUser() {}

void OAIMatchedUser::initializeModel() {
...
void OAIMatchedUser::fromJson(QString jsonString) {
...
void OAIMatchedUser::fromJsonObject(QJsonObject json) {
...
QString OAIMatchedUser::asJson() const {
...
QJsonObject OAIMatchedUser::asJsonObject() const {
    QJsonObject obj;
    if (m_user_id_isSet) {
...
QString OAIMatchedUser::getUserId() const {
    return m_user_id;
}
void OAIMatchedUser::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIMatchedUser::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIMatchedUser::is_user_id_Valid() const{
    return m_user_id_isValid;
}

OAIUserStatus OAIMatchedUser::getUserStatus() const {
    return m_user_status;
}
void OAIMatchedUser::setUserStatus(const OAIUserStatus &user_status) {
    m_user_status = user_status;
    m_user_status_isSet = true;
}

bool OAIMatchedUser::is_user_status_Set() const{
    return m_user_status_isSet;
}

bool OAIMatchedUser::is_user_status_Valid() const{
    return m_user_status_isValid;
}

bool OAIMatchedUser::isSet() const {
...
bool OAIMatchedUser::isValid() const {
