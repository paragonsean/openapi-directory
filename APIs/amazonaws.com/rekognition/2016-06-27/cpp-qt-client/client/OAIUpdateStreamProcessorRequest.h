...
/*
 * OAIUpdateStreamProcessorRequest.h
 *
 * 
 */

#ifndef OAIUpdateStreamProcessorRequest_H
#define OAIUpdateStreamProcessorRequest_H

#include <QJsonObject>

#include "OAICreateStreamProcessorRequest_DataSharingPreference.h"
#include "OAIUpdateStreamProcessorRequest_SettingsForUpdate.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAIUpdateStreamProcessorRequest_SettingsForUpdate;
class OAICreateStreamProcessorRequest_DataSharingPreference;

class OAIUpdateStreamProcessorRequest : public OAIObject {
public:
    OAIUpdateStreamProcessorRequest();
    OAIUpdateStreamProcessorRequest(QString json);
    ~OAIUpdateStreamProcessorRequest() override;
    ...
    OAIUpdateStreamProcessorRequest_SettingsForUpdate getSettingsForUpdate() const;
    void setSettingsForUpdate(const OAIUpdateStreamProcessorRequest_SettingsForUpdate &settings_for_update);
    bool is_settings_for_update_Set() const;
    bool is_settings_for_update_Valid() const;

    QList getRegionsOfInterestForUpdate() const;
    void setRegionsOfInterestForUpdate(const QList &regions_of_interest_for_update);
    bool is_regions_of_interest_for_update_Set() const;
    bool is_regions_of_interest_for_update_Valid() const;

    OAICreateStreamProcessorRequest_DataSharingPreference getDataSharingPreferenceForUpdate() const;
    void setDataSharingPreferenceForUpdate(const OAICreateStreamProcessorRequest_DataSharingPreference &data_sharing_preference_for_update);
    bool is_data_sharing_preference_for_update_Set() const;
    bool is_data_sharing_preference_for_update_Valid() const;

    QList getParametersToDelete() const;
    void setParametersToDelete(const QList &parameters_to_delete);
    bool is_parameters_to_delete_Set() const;
    bool is_parameters_to_delete_Valid() const;
...
private:
    ...
    OAIUpdateStreamProcessorRequest_SettingsForUpdate m_settings_for_update;
    bool m_settings_for_update_isSet;
    bool m_settings_for_update_isValid;

    QList m_regions_of_interest_for_update;
    bool m_regions_of_interest_for_update_isSet;
    bool m_regions_of_interest_for_update_isValid;

    OAICreateStreamProcessorRequest_DataSharingPreference m_data_sharing_preference_for_update;
    bool m_data_sharing_preference_for_update_isSet;
    bool m_data_sharing_preference_for_update_isValid;

    QList m_parameters_to_delete;
    bool m_parameters_to_delete_isSet;
    bool m_parameters_to_delete_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIUpdateStreamProcessorRequest)

#endif // OAIUpdateStreamProcessorRequest_H
