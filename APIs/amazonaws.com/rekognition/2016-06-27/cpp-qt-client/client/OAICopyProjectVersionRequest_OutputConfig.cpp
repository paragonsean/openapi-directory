...
OAICopyProjectVersionRequest_OutputConfig::OAICopyProjectVersionRequest_OutputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyProjectVersionRequest_OutputConfig::OAICopyProjectVersionRequest_OutputConfig() {
    this->initializeModel();
}

OAICopyProjectVersionRequest_OutputConfig::~OAICopyProjectVersionRequest_OutputConfig() {}

void OAICopyProjectVersionRequest_OutputConfig::initializeModel() {
...
void OAICopyProjectVersionRequest_OutputConfig::fromJson(QString jsonString) {
...
void OAICopyProjectVersionRequest_OutputConfig::fromJsonObject(QJsonObject json) {
...
QString OAICopyProjectVersionRequest_OutputConfig::asJson() const {
...
QJsonObject OAICopyProjectVersionRequest_OutputConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAICopyProjectVersionRequest_OutputConfig::getS3Bucket() const {
    return m_s3_bucket;
}
void OAICopyProjectVersionRequest_OutputConfig::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAICopyProjectVersionRequest_OutputConfig::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAICopyProjectVersionRequest_OutputConfig::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAICopyProjectVersionRequest_OutputConfig::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAICopyProjectVersionRequest_OutputConfig::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAICopyProjectVersionRequest_OutputConfig::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAICopyProjectVersionRequest_OutputConfig::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

bool OAICopyProjectVersionRequest_OutputConfig::isSet() const {
...
bool OAICopyProjectVersionRequest_OutputConfig::isValid() const {
