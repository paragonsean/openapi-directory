...
/*
 * OAIProjectVersionDescription_ManifestSummary.h
 *
 * 
 */

#ifndef OAIProjectVersionDescription_ManifestSummary_H
#define OAIProjectVersionDescription_ManifestSummary_H
...
class OAIProjectVersionDescription_ManifestSummary : public OAIObject {
public:
    OAIProjectVersionDescription_ManifestSummary();
    OAIProjectVersionDescription_ManifestSummary(QString json);
    ~OAIProjectVersionDescription_ManifestSummary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIProjectVersionDescription_ManifestSummary)

#endif // OAIProjectVersionDescription_ManifestSummary_H
