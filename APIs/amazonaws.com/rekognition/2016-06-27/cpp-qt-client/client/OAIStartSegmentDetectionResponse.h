...
/*
 * OAIStartSegmentDetectionResponse.h
 *
 * 
 */

#ifndef OAIStartSegmentDetectionResponse_H
#define OAIStartSegmentDetectionResponse_H
...
class OAIStartSegmentDetectionResponse : public OAIObject {
public:
    OAIStartSegmentDetectionResponse();
    OAIStartSegmentDetectionResponse(QString json);
    ~OAIStartSegmentDetectionResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartSegmentDetectionResponse)

#endif // OAIStartSegmentDetectionResponse_H
