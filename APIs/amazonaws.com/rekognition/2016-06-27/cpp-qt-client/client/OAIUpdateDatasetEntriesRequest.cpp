...
QString OAIUpdateDatasetEntriesRequest::getDatasetArn() const {
    return m_dataset_arn;
}
void OAIUpdateDatasetEntriesRequest::setDatasetArn(const QString &dataset_arn) {
    m_dataset_arn = dataset_arn;
    m_dataset_arn_isSet = true;
}

bool OAIUpdateDatasetEntriesRequest::is_dataset_arn_Set() const{
    return m_dataset_arn_isSet;
}

bool OAIUpdateDatasetEntriesRequest::is_dataset_arn_Valid() const{
    return m_dataset_arn_isValid;
}

OAIUpdateDatasetEntriesRequest_Changes OAIUpdateDatasetEntriesRequest::getChanges() const {
    return m_changes;
}
void OAIUpdateDatasetEntriesRequest::setChanges(const OAIUpdateDatasetEntriesRequest_Changes &changes) {
    m_changes = changes;
...
bool OAIUpdateDatasetEntriesRequest::isValid() const {
    ...
    return m_dataset_arn_isValid && m_changes_isValid && true;
}
