...
/*
 * OAIFaceDetail_EyesOpen.h
 *
 * 
 */

#ifndef OAIFaceDetail_EyesOpen_H
#define OAIFaceDetail_EyesOpen_H
...
class OAIFaceDetail_EyesOpen : public OAIObject {
public:
    OAIFaceDetail_EyesOpen();
    OAIFaceDetail_EyesOpen(QString json);
    ~OAIFaceDetail_EyesOpen() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIFaceDetail_EyesOpen)

#endif // OAIFaceDetail_EyesOpen_H
