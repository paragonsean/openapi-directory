...
OAIKnownGender::OAIKnownGender(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIKnownGender::OAIKnownGender() {
    this->initializeModel();
}

OAIKnownGender::~OAIKnownGender() {}

void OAIKnownGender::initializeModel() {

    m_type_isSet = false;
    m_type_isValid = false;
}

void OAIKnownGender::fromJson(QString jsonString) {
...
void OAIKnownGender::fromJsonObject(QJsonObject json) {

    m_type_isValid = ::OpenAPI::fromJsonValue(m_type, json[QString("Type")]);
    m_type_isSet = !json[QString("Type")].isNull() && m_type_isValid;
}

QString OAIKnownGender::asJson() const {
...
QJsonObject OAIKnownGender::asJsonObject() const {
    QJsonObject obj;
    if (m_type.isSet()) {
...
OAIKnownGenderType OAIKnownGender::getType() const {
    return m_type;
}
void OAIKnownGender::setType(const OAIKnownGenderType &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIKnownGender::is_type_Set() const{
    return m_type_isSet;
}

bool OAIKnownGender::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIKnownGender::isSet() const {
...
bool OAIKnownGender::isValid() const {
