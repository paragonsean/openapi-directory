...
#include "OAIPutProjectPolicyResponse.h"
...
OAIPutProjectPolicyResponse::OAIPutProjectPolicyResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPutProjectPolicyResponse::OAIPutProjectPolicyResponse() {
    this->initializeModel();
}

OAIPutProjectPolicyResponse::~OAIPutProjectPolicyResponse() {}

void OAIPutProjectPolicyResponse::initializeModel() {

    m_policy_revision_id_isSet = false;
    m_policy_revision_id_isValid = false;
}

void OAIPutProjectPolicyResponse::fromJson(QString jsonString) {
...
void OAIPutProjectPolicyResponse::fromJsonObject(QJsonObject json) {
...
QString OAIPutProjectPolicyResponse::asJson() const {
...
QJsonObject OAIPutProjectPolicyResponse::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPutProjectPolicyResponse::getPolicyRevisionId() const {
    return m_policy_revision_id;
}
void OAIPutProjectPolicyResponse::setPolicyRevisionId(const QString &policy_revision_id) {
    m_policy_revision_id = policy_revision_id;
    m_policy_revision_id_isSet = true;
}

bool OAIPutProjectPolicyResponse::is_policy_revision_id_Set() const{
    return m_policy_revision_id_isSet;
}

bool OAIPutProjectPolicyResponse::is_policy_revision_id_Valid() const{
    return m_policy_revision_id_isValid;
}

bool OAIPutProjectPolicyResponse::isSet() const {
...
bool OAIPutProjectPolicyResponse::isValid() const {
