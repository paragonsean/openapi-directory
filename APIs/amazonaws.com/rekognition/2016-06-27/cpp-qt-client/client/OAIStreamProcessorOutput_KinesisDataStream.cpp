...
OAIStreamProcessorOutput_KinesisDataStream::OAIStreamProcessorOutput_KinesisDataStream(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorOutput_KinesisDataStream::OAIStreamProcessorOutput_KinesisDataStream() {
    this->initializeModel();
}

OAIStreamProcessorOutput_KinesisDataStream::~OAIStreamProcessorOutput_KinesisDataStream() {}

void OAIStreamProcessorOutput_KinesisDataStream::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIStreamProcessorOutput_KinesisDataStream::fromJson(QString jsonString) {
...
void OAIStreamProcessorOutput_KinesisDataStream::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIStreamProcessorOutput_KinesisDataStream::asJson() const {
...
QJsonObject OAIStreamProcessorOutput_KinesisDataStream::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStreamProcessorOutput_KinesisDataStream::getArn() const {
    return m_arn;
}
void OAIStreamProcessorOutput_KinesisDataStream::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStreamProcessorOutput_KinesisDataStream::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStreamProcessorOutput_KinesisDataStream::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIStreamProcessorOutput_KinesisDataStream::isSet() const {
...
bool OAIStreamProcessorOutput_KinesisDataStream::isValid() const {
