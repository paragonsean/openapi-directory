...
/*
 * OAIGetTextDetectionResponse.h
 *
 * 
 */

#ifndef OAIGetTextDetectionResponse_H
#define OAIGetTextDetectionResponse_H
...
class OAIGetTextDetectionResponse : public OAIObject {
public:
    OAIGetTextDetectionResponse();
    OAIGetTextDetectionResponse(QString json);
    ~OAIGetTextDetectionResponse() override;
    ...
    QList getTextDetections() const;
    void setTextDetections(const QList &text_detections);
    bool is_text_detections_Set() const;
    bool is_text_detections_Valid() const;
    ...
    QString getTextModelVersion() const;
    void setTextModelVersion(const QString &text_model_version);
    bool is_text_model_version_Set() const;
    bool is_text_model_version_Valid() const;
...
private:
    ...
    QList m_text_detections;
    bool m_text_detections_isSet;
    bool m_text_detections_isValid;

    QString m_next_token;
    bool m_next_token_isSet;
    bool m_next_token_isValid;

    QString m_text_model_version;
    bool m_text_model_version_isSet;
    bool m_text_model_version_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTextDetectionResponse)

#endif // OAIGetTextDetectionResponse_H
