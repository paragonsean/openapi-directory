...
#include "OAIDetectLabelsFeatureName.h"
...
OAIDetectLabelsFeatureName::OAIDetectLabelsFeatureName(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsFeatureName::OAIDetectLabelsFeatureName() {
    this->initializeModel();
}

OAIDetectLabelsFeatureName::~OAIDetectLabelsFeatureName() {}

void OAIDetectLabelsFeatureName::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIDetectLabelsFeatureName::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIDetectLabelsFeatureName::fromJson(QString jsonString) {
    
    if ( jsonString.compare("GENERAL_LABELS", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDetectLabelsFeatureName::GENERAL_LABELS;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("IMAGE_PROPERTIES", Qt::CaseInsensitive) == 0) {
        m_value = eOAIDetectLabelsFeatureName::IMAGE_PROPERTIES;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIDetectLabelsFeatureName::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIDetectLabelsFeatureName::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIDetectLabelsFeatureName::GENERAL_LABELS:
            val = "GENERAL_LABELS";
            break;
        case eOAIDetectLabelsFeatureName::IMAGE_PROPERTIES:
            val = "IMAGE_PROPERTIES";
            break;
        default:
            break;
    }
...
QJsonValue OAIDetectLabelsFeatureName::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIDetectLabelsFeatureName::eOAIDetectLabelsFeatureName OAIDetectLabelsFeatureName::getValue() const {
    return m_value;
}

void OAIDetectLabelsFeatureName::setValue(const OAIDetectLabelsFeatureName::eOAIDetectLabelsFeatureName& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIDetectLabelsFeatureName::isSet() const {
    
    return m_value_isSet;
}

bool OAIDetectLabelsFeatureName::isValid() const {
