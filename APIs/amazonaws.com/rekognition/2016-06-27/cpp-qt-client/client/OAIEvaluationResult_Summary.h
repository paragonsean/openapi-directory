...
/*
 * OAIEvaluationResult_Summary.h
 *
 * 
 */

#ifndef OAIEvaluationResult_Summary_H
#define OAIEvaluationResult_Summary_H
...
class OAIEvaluationResult_Summary : public OAIObject {
public:
    OAIEvaluationResult_Summary();
    OAIEvaluationResult_Summary(QString json);
    ~OAIEvaluationResult_Summary() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEvaluationResult_Summary)

#endif // OAIEvaluationResult_Summary_H
