...
void OAIImageQuality::fromJsonObject(QJsonObject json) {
...
QJsonObject OAIImageQuality::asJsonObject() const {
    QJsonObject obj;
...
float OAIImageQuality::getBrightness() const {
    return m_brightness;
}
void OAIImageQuality::setBrightness(const float &brightness) {
    m_brightness = brightness;
    m_brightness_isSet = true;
}

bool OAIImageQuality::is_brightness_Set() const{
    return m_brightness_isSet;
}

bool OAIImageQuality::is_brightness_Valid() const{
    return m_brightness_isValid;
}

float OAIImageQuality::getSharpness() const {
    return m_sharpness;
}
void OAIImageQuality::setSharpness(const float &sharpness) {
    m_sharpness = sharpness;
    m_sharpness_isSet = true;
}

bool OAIImageQuality::is_sharpness_Set() const{
    return m_sharpness_isSet;
}

bool OAIImageQuality::is_sharpness_Valid() const{
