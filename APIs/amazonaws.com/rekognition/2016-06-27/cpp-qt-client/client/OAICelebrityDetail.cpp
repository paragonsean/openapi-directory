...
OAICelebrityDetail::OAICelebrityDetail(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICelebrityDetail::OAICelebrityDetail() {
    this->initializeModel();
}

OAICelebrityDetail::~OAICelebrityDetail() {}

void OAICelebrityDetail::initializeModel() {
    ...
    m_known_gender_isSet = false;
    m_known_gender_isValid = false;
}

void OAICelebrityDetail::fromJson(QString jsonString) {
...
void OAICelebrityDetail::fromJsonObject(QJsonObject json) {
    ...
    m_known_gender_isValid = ::OpenAPI::fromJsonValue(m_known_gender, json[QString("KnownGender")]);
    m_known_gender_isSet = !json[QString("KnownGender")].isNull() && m_known_gender_isValid;
}

QString OAICelebrityDetail::asJson() const {
...
QJsonObject OAICelebrityDetail::asJsonObject() const {
    QJsonObject obj;
    if (m_urls.isSet()) {
    ...
    if (m_known_gender.isSet()) {
        obj.insert(QString("KnownGender"), ::OpenAPI::toJsonValue(m_known_gender));
    }
    return obj;
}

QList OAICelebrityDetail::getUrls() const {
    return m_urls;
}
void OAICelebrityDetail::setUrls(const QList &urls) {
    m_urls = urls;
    m_urls_isSet = true;
}

bool OAICelebrityDetail::is_urls_Set() const{
    return m_urls_isSet;
}

bool OAICelebrityDetail::is_urls_Valid() const{
    return m_urls_isValid;
}

QString OAICelebrityDetail::getName() const {
    return m_name;
}
void OAICelebrityDetail::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAICelebrityDetail::is_name_Set() const{
    return m_name_isSet;
}

bool OAICelebrityDetail::is_name_Valid() const{
    return m_name_isValid;
}

QString OAICelebrityDetail::getId() const {
    return m_id;
}
void OAICelebrityDetail::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAICelebrityDetail::is_id_Set() const{
    return m_id_isSet;
}

bool OAICelebrityDetail::is_id_Valid() const{
    return m_id_isValid;
}

float OAICelebrityDetail::getConfidence() const {
    return m_confidence;
}
void OAICelebrityDetail::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAICelebrityDetail::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAICelebrityDetail::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAICelebrityDetail_BoundingBox OAICelebrityDetail::getBoundingBox() const {
    return m_bounding_box;
}
void OAICelebrityDetail::setBoundingBox(const OAICelebrityDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAICelebrityDetail::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAICelebrityDetail::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAICelebrityDetail_Face OAICelebrityDetail::getFace() const {
    return m_face;
}
void OAICelebrityDetail::setFace(const OAICelebrityDetail_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAICelebrityDetail::is_face_Set() const{
    return m_face_isSet;
}

bool OAICelebrityDetail::is_face_Valid() const{
    return m_face_isValid;
}

OAIGetCelebrityInfoResponse_KnownGender OAICelebrityDetail::getKnownGender() const {
    return m_known_gender;
}
void OAICelebrityDetail::setKnownGender(const OAIGetCelebrityInfoResponse_KnownGender &known_gender) {
    m_known_gender = known_gender;
    m_known_gender_isSet = true;
}

bool OAICelebrityDetail::is_known_gender_Set() const{
    return m_known_gender_isSet;
}

bool OAICelebrityDetail::is_known_gender_Valid() const{
    return m_known_gender_isValid;
}

bool OAICelebrityDetail::isSet() const {
...
bool OAICelebrityDetail::isValid() const {
