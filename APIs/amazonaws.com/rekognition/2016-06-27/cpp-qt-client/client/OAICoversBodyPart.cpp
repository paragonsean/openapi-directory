...
OAICoversBodyPart::OAICoversBodyPart(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICoversBodyPart::OAICoversBodyPart() {
    this->initializeModel();
}

OAICoversBodyPart::~OAICoversBodyPart() {}

void OAICoversBodyPart::initializeModel() {
...
void OAICoversBodyPart::fromJson(QString jsonString) {
...
void OAICoversBodyPart::fromJsonObject(QJsonObject json) {
...
QString OAICoversBodyPart::asJson() const {
...
QJsonObject OAICoversBodyPart::asJsonObject() const {
    QJsonObject obj;
...
float OAICoversBodyPart::getConfidence() const {
    return m_confidence;
}
void OAICoversBodyPart::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAICoversBodyPart::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAICoversBodyPart::is_confidence_Valid() const{
    return m_confidence_isValid;
}

bool OAICoversBodyPart::getValue() const {
    return m_value;
}
void OAICoversBodyPart::setValue(const bool &value) {
    m_value = value;
    m_value_isSet = true;
}

bool OAICoversBodyPart::is_value_Set() const{
    return m_value_isSet;
}

bool OAICoversBodyPart::is_value_Valid() const{
    return m_value_isValid;
}

bool OAICoversBodyPart::isSet() const {
...
bool OAICoversBodyPart::isValid() const {
