...
/*
 * OAIStartContentModerationRequest_Video.h
 *
 * 
 */

#ifndef OAIStartContentModerationRequest_Video_H
#define OAIStartContentModerationRequest_Video_H
...
class OAIStartContentModerationRequest_Video : public OAIObject {
public:
    OAIStartContentModerationRequest_Video();
    OAIStartContentModerationRequest_Video(QString json);
    ~OAIStartContentModerationRequest_Video() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartContentModerationRequest_Video)

#endif // OAIStartContentModerationRequest_Video_H
