...
/*
 * OAIDetectLabelsSettings_GeneralLabels.h
 *
 * 
 */

#ifndef OAIDetectLabelsSettings_GeneralLabels_H
#define OAIDetectLabelsSettings_GeneralLabels_H
...
class OAIDetectLabelsSettings_GeneralLabels : public OAIObject {
public:
    OAIDetectLabelsSettings_GeneralLabels();
    OAIDetectLabelsSettings_GeneralLabels(QString json);
    ~OAIDetectLabelsSettings_GeneralLabels() override;
    ...
    QList getLabelInclusionFilters() const;
    void setLabelInclusionFilters(const QList &label_inclusion_filters);
    bool is_label_inclusion_filters_Set() const;
    bool is_label_inclusion_filters_Valid() const;

    QList getLabelExclusionFilters() const;
    void setLabelExclusionFilters(const QList &label_exclusion_filters);
    bool is_label_exclusion_filters_Set() const;
    bool is_label_exclusion_filters_Valid() const;

    QList getLabelCategoryInclusionFilters() const;
    void setLabelCategoryInclusionFilters(const QList &label_category_inclusion_filters);
    bool is_label_category_inclusion_filters_Set() const;
    bool is_label_category_inclusion_filters_Valid() const;

    QList getLabelCategoryExclusionFilters() const;
    void setLabelCategoryExclusionFilters(const QList &label_category_exclusion_filters);
    bool is_label_category_exclusion_filters_Set() const;
    bool is_label_category_exclusion_filters_Valid() const;
...
private:
    ...
    QList m_label_inclusion_filters;
    bool m_label_inclusion_filters_isSet;
    bool m_label_inclusion_filters_isValid;

    QList m_label_exclusion_filters;
    bool m_label_exclusion_filters_isSet;
    bool m_label_exclusion_filters_isValid;

    QList m_label_category_inclusion_filters;
    bool m_label_category_inclusion_filters_isSet;
    bool m_label_category_inclusion_filters_isValid;

    QList m_label_category_exclusion_filters;
    bool m_label_category_exclusion_filters_isSet;
    bool m_label_category_exclusion_filters_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsSettings_GeneralLabels)

#endif // OAIDetectLabelsSettings_GeneralLabels_H
