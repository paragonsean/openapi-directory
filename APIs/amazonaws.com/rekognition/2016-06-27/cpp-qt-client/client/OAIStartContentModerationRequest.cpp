...
#include "OAIStartContentModerationRequest.h"
...
OAIStartContentModerationRequest::OAIStartContentModerationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStartContentModerationRequest::OAIStartContentModerationRequest() {
    this->initializeModel();
}

OAIStartContentModerationRequest::~OAIStartContentModerationRequest() {}

void OAIStartContentModerationRequest::initializeModel() {
...
void OAIStartContentModerationRequest::fromJson(QString jsonString) {
...
void OAIStartContentModerationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStartContentModerationRequest::asJson() const {
...
QJsonObject OAIStartContentModerationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_video.isSet()) {
...
OAIStartContentModerationRequest_Video OAIStartContentModerationRequest::getVideo() const {
    return m_video;
}
void OAIStartContentModerationRequest::setVideo(const OAIStartContentModerationRequest_Video &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIStartContentModerationRequest::is_video_Set() const{
    return m_video_isSet;
}

bool OAIStartContentModerationRequest::is_video_Valid() const{
    return m_video_isValid;
}

float OAIStartContentModerationRequest::getMinConfidence() const {
    return m_min_confidence;
}
void OAIStartContentModerationRequest::setMinConfidence(const float &min_confidence) {
    m_min_confidence = min_confidence;
    m_min_confidence_isSet = true;
}

bool OAIStartContentModerationRequest::is_min_confidence_Set() const{
    return m_min_confidence_isSet;
}

bool OAIStartContentModerationRequest::is_min_confidence_Valid() const{
    return m_min_confidence_isValid;
}

QString OAIStartContentModerationRequest::getClientRequestToken() const {
    return m_client_request_token;
}
void OAIStartContentModerationRequest::setClientRequestToken(const QString &client_request_token) {
    m_client_request_token = client_request_token;
    m_client_request_token_isSet = true;
}

bool OAIStartContentModerationRequest::is_client_request_token_Set() const{
    return m_client_request_token_isSet;
}

bool OAIStartContentModerationRequest::is_client_request_token_Valid() const{
    return m_client_request_token_isValid;
}

OAIStartContentModerationRequest_NotificationChannel OAIStartContentModerationRequest::getNotificationChannel() const {
    return m_notification_channel;
}
void OAIStartContentModerationRequest::setNotificationChannel(const OAIStartContentModerationRequest_NotificationChannel &notification_channel) {
    m_notification_channel = notification_channel;
    m_notification_channel_isSet = true;
}

bool OAIStartContentModerationRequest::is_notification_channel_Set() const{
    return m_notification_channel_isSet;
}

bool OAIStartContentModerationRequest::is_notification_channel_Valid() const{
    return m_notification_channel_isValid;
}

QString OAIStartContentModerationRequest::getJobTag() const {
    return m_job_tag;
}
void OAIStartContentModerationRequest::setJobTag(const QString &job_tag) {
    m_job_tag = job_tag;
    m_job_tag_isSet = true;
}

bool OAIStartContentModerationRequest::is_job_tag_Set() const{
    return m_job_tag_isSet;
}

bool OAIStartContentModerationRequest::is_job_tag_Valid() const{
    return m_job_tag_isValid;
}

bool OAIStartContentModerationRequest::isSet() const {
...
bool OAIStartContentModerationRequest::isValid() const {
