...
QString OAIProjectStatus::asJson() const {
    ...
    QString val;
    switch (m_value){
        case eOAIProjectStatus::CREATING:
            val = "CREATING";
            break;
        case eOAIProjectStatus::CREATED:
            val = "CREATED";
            break;
        case eOAIProjectStatus::DELETING:
            val = "DELETING";
            break;
        default:
            break;
