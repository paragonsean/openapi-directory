...
/*
 * OAICreateFaceLivenessSessionRequest_Settings.h
 *
 * 
 */

#ifndef OAICreateFaceLivenessSessionRequest_Settings_H
#define OAICreateFaceLivenessSessionRequest_Settings_H

#include <QJsonObject>

#include "OAICreateFaceLivenessSessionRequestSettings_OutputConfig.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAICreateFaceLivenessSessionRequestSettings_OutputConfig;

class OAICreateFaceLivenessSessionRequest_Settings : public OAIObject {
public:
    OAICreateFaceLivenessSessionRequest_Settings();
    OAICreateFaceLivenessSessionRequest_Settings(QString json);
    ~OAICreateFaceLivenessSessionRequest_Settings() override;
    ...
    OAICreateFaceLivenessSessionRequestSettings_OutputConfig getOutputConfig() const;
    void setOutputConfig(const OAICreateFaceLivenessSessionRequestSettings_OutputConfig &output_config);
    bool is_output_config_Set() const;
    bool is_output_config_Valid() const;

    qint32 getAuditImagesLimit() const;
    void setAuditImagesLimit(const qint32 &audit_images_limit);
    bool is_audit_images_limit_Set() const;
    bool is_audit_images_limit_Valid() const;
...
private:
    ...
    OAICreateFaceLivenessSessionRequestSettings_OutputConfig m_output_config;
    bool m_output_config_isSet;
    bool m_output_config_isValid;

    qint32 m_audit_images_limit;
    bool m_audit_images_limit_isSet;
    bool m_audit_images_limit_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICreateFaceLivenessSessionRequest_Settings)

#endif // OAICreateFaceLivenessSessionRequest_Settings_H
