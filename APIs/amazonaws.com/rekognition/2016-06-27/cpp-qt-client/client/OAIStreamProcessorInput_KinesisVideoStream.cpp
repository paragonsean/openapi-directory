...
#include "OAIStreamProcessorInput_KinesisVideoStream.h"
...
OAIStreamProcessorInput_KinesisVideoStream::OAIStreamProcessorInput_KinesisVideoStream(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorInput_KinesisVideoStream::OAIStreamProcessorInput_KinesisVideoStream() {
    this->initializeModel();
}

OAIStreamProcessorInput_KinesisVideoStream::~OAIStreamProcessorInput_KinesisVideoStream() {}

void OAIStreamProcessorInput_KinesisVideoStream::initializeModel() {

    m_arn_isSet = false;
    m_arn_isValid = false;
}

void OAIStreamProcessorInput_KinesisVideoStream::fromJson(QString jsonString) {
...
void OAIStreamProcessorInput_KinesisVideoStream::fromJsonObject(QJsonObject json) {

    m_arn_isValid = ::OpenAPI::fromJsonValue(m_arn, json[QString("Arn")]);
    m_arn_isSet = !json[QString("Arn")].isNull() && m_arn_isValid;
}

QString OAIStreamProcessorInput_KinesisVideoStream::asJson() const {
...
QJsonObject OAIStreamProcessorInput_KinesisVideoStream::asJsonObject() const {
    QJsonObject obj;
    if (m_arn_isSet) {
...
QString OAIStreamProcessorInput_KinesisVideoStream::getArn() const {
    return m_arn;
}
void OAIStreamProcessorInput_KinesisVideoStream::setArn(const QString &arn) {
    m_arn = arn;
    m_arn_isSet = true;
}

bool OAIStreamProcessorInput_KinesisVideoStream::is_arn_Set() const{
    return m_arn_isSet;
}

bool OAIStreamProcessorInput_KinesisVideoStream::is_arn_Valid() const{
    return m_arn_isValid;
}

bool OAIStreamProcessorInput_KinesisVideoStream::isSet() const {
...
bool OAIStreamProcessorInput_KinesisVideoStream::isValid() const {
