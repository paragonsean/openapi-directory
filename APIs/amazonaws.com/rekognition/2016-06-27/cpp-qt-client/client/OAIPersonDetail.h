...
#ifndef OAIPersonDetail_H
#define OAIPersonDetail_H
...
class OAIPersonDetail : public OAIObject {
public:
    OAIPersonDetail();
    OAIPersonDetail(QString json);
    ~OAIPersonDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonDetail)

#endif // OAIPersonDetail_H
