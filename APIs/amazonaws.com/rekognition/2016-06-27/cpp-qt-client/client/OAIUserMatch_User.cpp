...
OAIUserMatch_User::OAIUserMatch_User(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUserMatch_User::OAIUserMatch_User() {
    this->initializeModel();
}

OAIUserMatch_User::~OAIUserMatch_User() {}

void OAIUserMatch_User::initializeModel() {
...
void OAIUserMatch_User::fromJson(QString jsonString) {
...
void OAIUserMatch_User::fromJsonObject(QJsonObject json) {
...
QString OAIUserMatch_User::asJson() const {
...
QJsonObject OAIUserMatch_User::asJsonObject() const {
    QJsonObject obj;
    if (m_user_id_isSet) {
...
QString OAIUserMatch_User::getUserId() const {
    return m_user_id;
}
void OAIUserMatch_User::setUserId(const QString &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIUserMatch_User::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIUserMatch_User::is_user_id_Valid() const{
    return m_user_id_isValid;
}

OAIUserStatus OAIUserMatch_User::getUserStatus() const {
    return m_user_status;
}
void OAIUserMatch_User::setUserStatus(const OAIUserStatus &user_status) {
    m_user_status = user_status;
    m_user_status_isSet = true;
}

bool OAIUserMatch_User::is_user_status_Set() const{
    return m_user_status_isSet;
}

bool OAIUserMatch_User::is_user_status_Valid() const{
    return m_user_status_isValid;
}

bool OAIUserMatch_User::isSet() const {
...
bool OAIUserMatch_User::isValid() const {
