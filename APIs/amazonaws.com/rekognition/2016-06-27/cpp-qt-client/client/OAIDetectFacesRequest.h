...
/*
 * OAIDetectFacesRequest.h
 *
 * 
 */

#ifndef OAIDetectFacesRequest_H
#define OAIDetectFacesRequest_H
...
class OAIDetectFacesRequest : public OAIObject {
public:
    OAIDetectFacesRequest();
    OAIDetectFacesRequest(QString json);
    ~OAIDetectFacesRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectFacesRequest)

#endif // OAIDetectFacesRequest_H
