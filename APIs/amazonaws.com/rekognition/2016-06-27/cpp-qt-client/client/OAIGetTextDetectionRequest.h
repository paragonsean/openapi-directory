...
/*
 * OAIGetTextDetectionRequest.h
 *
 * 
 */

#ifndef OAIGetTextDetectionRequest_H
#define OAIGetTextDetectionRequest_H
...
class OAIGetTextDetectionRequest : public OAIObject {
public:
    OAIGetTextDetectionRequest();
    OAIGetTextDetectionRequest(QString json);
    ~OAIGetTextDetectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetTextDetectionRequest)

#endif // OAIGetTextDetectionRequest_H
