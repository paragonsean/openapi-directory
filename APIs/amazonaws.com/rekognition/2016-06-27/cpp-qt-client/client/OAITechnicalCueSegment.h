...
/*
 * OAITechnicalCueSegment.h
 *
 * Information about a technical cue segment. For more information, see &lt;a&gt;SegmentDetection&lt;/a&gt;.
 */

#ifndef OAITechnicalCueSegment_H
#define OAITechnicalCueSegment_H

#include <QJsonObject>

#include "OAITechnicalCueType.h"
...
class OAITechnicalCueSegment : public OAIObject {
public:
    OAITechnicalCueSegment();
    OAITechnicalCueSegment(QString json);
    ~OAITechnicalCueSegment() override;
    ...
    OAITechnicalCueType getType() const;
    void setType(const OAITechnicalCueType &type);
...
Q_DECLARE_METATYPE(OpenAPI::OAITechnicalCueSegment)

#endif // OAITechnicalCueSegment_H
