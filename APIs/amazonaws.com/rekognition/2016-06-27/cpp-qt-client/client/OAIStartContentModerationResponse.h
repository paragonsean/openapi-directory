...
/*
 * OAIStartContentModerationResponse.h
 *
 * 
 */

#ifndef OAIStartContentModerationResponse_H
#define OAIStartContentModerationResponse_H
...
class OAIStartContentModerationResponse : public OAIObject {
public:
    OAIStartContentModerationResponse();
    OAIStartContentModerationResponse(QString json);
    ~OAIStartContentModerationResponse() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartContentModerationResponse)

#endif // OAIStartContentModerationResponse_H
