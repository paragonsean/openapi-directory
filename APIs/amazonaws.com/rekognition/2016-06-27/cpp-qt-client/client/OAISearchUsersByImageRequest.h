...
/*
 * OAISearchUsersByImageRequest.h
 *
 * 
 */

#ifndef OAISearchUsersByImageRequest_H
#define OAISearchUsersByImageRequest_H

#include <QJsonObject>

#include "OAIImage.h"
#include "OAIQualityFilter.h"
#include <QString>
...
class OAISearchUsersByImageRequest : public OAIObject {
public:
    OAISearchUsersByImageRequest();
    OAISearchUsersByImageRequest(QString json);
    ~OAISearchUsersByImageRequest() override;
    ...
    float getUserMatchThreshold() const;
    void setUserMatchThreshold(const float &user_match_threshold);
    bool is_user_match_threshold_Set() const;
    bool is_user_match_threshold_Valid() const;
    ...
    OAIQualityFilter getQualityFilter() const;
    void setQualityFilter(const OAIQualityFilter &quality_filter);
    bool is_quality_filter_Set() const;
    bool is_quality_filter_Valid() const;
...
private:
    ...
    float m_user_match_threshold;
    bool m_user_match_threshold_isSet;
    bool m_user_match_threshold_isValid;

    qint32 m_max_users;
    bool m_max_users_isSet;
    bool m_max_users_isValid;

    OAIQualityFilter m_quality_filter;
    bool m_quality_filter_isSet;
    bool m_quality_filter_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAISearchUsersByImageRequest)

#endif // OAISearchUsersByImageRequest_H
