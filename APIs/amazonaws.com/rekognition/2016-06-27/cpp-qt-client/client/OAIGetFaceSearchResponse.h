...
/*
 * OAIGetFaceSearchResponse.h
 *
 * 
 */

#ifndef OAIGetFaceSearchResponse_H
#define OAIGetFaceSearchResponse_H

#include <QJsonObject>

#include "OAIGetFaceSearchResponse_VideoMetadata.h"
#include "OAIVideo.h"
...
namespace OpenAPI {
class OAIGetFaceSearchResponse_VideoMetadata;
class OAIVideo;

class OAIGetFaceSearchResponse : public OAIObject {
public:
    OAIGetFaceSearchResponse();
    OAIGetFaceSearchResponse(QString json);
    ~OAIGetFaceSearchResponse() override;
    ...
    OAIGetFaceSearchResponse_VideoMetadata getVideoMetadata() const;
    void setVideoMetadata(const OAIGetFaceSearchResponse_VideoMetadata &video_metadata);
    bool is_video_metadata_Set() const;
    bool is_video_metadata_Valid() const;

    QList getPersons() const;
    void setPersons(const QList &persons);
...
private:
    ...
    OAIGetFaceSearchResponse_VideoMetadata m_video_metadata;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceSearchResponse)

#endif // OAIGetFaceSearchResponse_H
