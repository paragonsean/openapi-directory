...
#ifndef OAIStartShotDetectionFilter_H
#define OAIStartShotDetectionFilter_H
...
class OAIStartShotDetectionFilter : public OAIObject {
public:
    OAIStartShotDetectionFilter();
    OAIStartShotDetectionFilter(QString json);
    ~OAIStartShotDetectionFilter() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartShotDetectionFilter)

#endif // OAIStartShotDetectionFilter_H
