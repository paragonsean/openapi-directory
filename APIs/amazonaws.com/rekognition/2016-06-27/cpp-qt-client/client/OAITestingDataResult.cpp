...
#include "OAITestingDataResult.h"
...
OAITestingDataResult::OAITestingDataResult(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITestingDataResult::OAITestingDataResult() {
    this->initializeModel();
}

OAITestingDataResult::~OAITestingDataResult() {}

void OAITestingDataResult::initializeModel() {
...
void OAITestingDataResult::fromJson(QString jsonString) {
...
void OAITestingDataResult::fromJsonObject(QJsonObject json) {
...
QString OAITestingDataResult::asJson() const {
...
QJsonObject OAITestingDataResult::asJsonObject() const {
    QJsonObject obj;
    if (m_input.isSet()) {
...
OAITestingDataResult_Input OAITestingDataResult::getInput() const {
    return m_input;
}
void OAITestingDataResult::setInput(const OAITestingDataResult_Input &input) {
    m_input = input;
    m_input_isSet = true;
}

bool OAITestingDataResult::is_input_Set() const{
    return m_input_isSet;
}

bool OAITestingDataResult::is_input_Valid() const{
    return m_input_isValid;
}

OAITestingDataResult_Output OAITestingDataResult::getOutput() const {
    return m_output;
}
void OAITestingDataResult::setOutput(const OAITestingDataResult_Output &output) {
    m_output = output;
    m_output_isSet = true;
}

bool OAITestingDataResult::is_output_Set() const{
    return m_output_isSet;
}

bool OAITestingDataResult::is_output_Valid() const{
    return m_output_isValid;
}

OAITestingDataResult_Validation OAITestingDataResult::getValidation() const {
    return m_validation;
}
void OAITestingDataResult::setValidation(const OAITestingDataResult_Validation &validation) {
    m_validation = validation;
    m_validation_isSet = true;
}

bool OAITestingDataResult::is_validation_Set() const{
    return m_validation_isSet;
}

bool OAITestingDataResult::is_validation_Valid() const{
    return m_validation_isValid;
}

bool OAITestingDataResult::isSet() const {
...
bool OAITestingDataResult::isValid() const {
