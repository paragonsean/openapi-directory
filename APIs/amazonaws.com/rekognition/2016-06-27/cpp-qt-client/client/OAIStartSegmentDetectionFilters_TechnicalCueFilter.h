...
/*
 * OAIStartSegmentDetectionFilters_TechnicalCueFilter.h
 *
 * 
 */

#ifndef OAIStartSegmentDetectionFilters_TechnicalCueFilter_H
#define OAIStartSegmentDetectionFilters_TechnicalCueFilter_H

#include <QJsonObject>

#include "OAIStartTechnicalCueDetectionFilter_BlackFrame.h"

#include "OAIEnum.h"
#include "OAIObject.h"

namespace OpenAPI {
class OAIStartTechnicalCueDetectionFilter_BlackFrame;

class OAIStartSegmentDetectionFilters_TechnicalCueFilter : public OAIObject {
public:
    OAIStartSegmentDetectionFilters_TechnicalCueFilter();
    OAIStartSegmentDetectionFilters_TechnicalCueFilter(QString json);
    ~OAIStartSegmentDetectionFilters_TechnicalCueFilter() override;
    ...
    float getMinSegmentConfidence() const;
    void setMinSegmentConfidence(const float &min_segment_confidence);
    bool is_min_segment_confidence_Set() const;
    bool is_min_segment_confidence_Valid() const;

    OAIStartTechnicalCueDetectionFilter_BlackFrame getBlackFrame() const;
    void setBlackFrame(const OAIStartTechnicalCueDetectionFilter_BlackFrame &black_frame);
    bool is_black_frame_Set() const;
    bool is_black_frame_Valid() const;
...
private:
    ...
    float m_min_segment_confidence;
    bool m_min_segment_confidence_isSet;
    bool m_min_segment_confidence_isValid;

    OAIStartTechnicalCueDetectionFilter_BlackFrame m_black_frame;
    bool m_black_frame_isSet;
    bool m_black_frame_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIStartSegmentDetectionFilters_TechnicalCueFilter)

#endif // OAIStartSegmentDetectionFilters_TechnicalCueFilter_H
