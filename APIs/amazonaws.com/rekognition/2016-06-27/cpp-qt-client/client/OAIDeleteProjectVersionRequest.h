...
/*
 * OAIDeleteProjectVersionRequest.h
 *
 * 
 */

#ifndef OAIDeleteProjectVersionRequest_H
#define OAIDeleteProjectVersionRequest_H
...
class OAIDeleteProjectVersionRequest : public OAIObject {
public:
    OAIDeleteProjectVersionRequest();
    OAIDeleteProjectVersionRequest(QString json);
    ~OAIDeleteProjectVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDeleteProjectVersionRequest)

#endif // OAIDeleteProjectVersionRequest_H
