...
#ifndef OAITrainingData_H
#define OAITrainingData_H
...
class OAITrainingData : public OAIObject {
public:
    OAITrainingData();
    OAITrainingData(QString json);
    ~OAITrainingData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAITrainingData)

#endif // OAITrainingData_H
