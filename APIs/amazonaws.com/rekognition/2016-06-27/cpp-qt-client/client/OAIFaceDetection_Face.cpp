...
#include "OAIFaceDetection_Face.h"
...
OAIFaceDetection_Face::OAIFaceDetection_Face(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceDetection_Face::OAIFaceDetection_Face() {
    this->initializeModel();
}

OAIFaceDetection_Face::~OAIFaceDetection_Face() {}

void OAIFaceDetection_Face::initializeModel() {
...
void OAIFaceDetection_Face::fromJson(QString jsonString) {
...
void OAIFaceDetection_Face::fromJsonObject(QJsonObject json) {
...
QString OAIFaceDetection_Face::asJson() const {
...
QJsonObject OAIFaceDetection_Face::asJsonObject() const {
    QJsonObject obj;
...
OAIFaceDetail_BoundingBox OAIFaceDetection_Face::getBoundingBox() const {
    return m_bounding_box;
}
void OAIFaceDetection_Face::setBoundingBox(const OAIFaceDetail_BoundingBox &bounding_box) {
    m_bounding_box = bounding_box;
    m_bounding_box_isSet = true;
}

bool OAIFaceDetection_Face::is_bounding_box_Set() const{
    return m_bounding_box_isSet;
}

bool OAIFaceDetection_Face::is_bounding_box_Valid() const{
    return m_bounding_box_isValid;
}

OAIFaceDetail_AgeRange OAIFaceDetection_Face::getAgeRange() const {
    return m_age_range;
}
void OAIFaceDetection_Face::setAgeRange(const OAIFaceDetail_AgeRange &age_range) {
    m_age_range = age_range;
    m_age_range_isSet = true;
}

bool OAIFaceDetection_Face::is_age_range_Set() const{
    return m_age_range_isSet;
}

bool OAIFaceDetection_Face::is_age_range_Valid() const{
    return m_age_range_isValid;
}

OAIFaceDetail_Smile OAIFaceDetection_Face::getSmile() const {
    return m_smile;
}
void OAIFaceDetection_Face::setSmile(const OAIFaceDetail_Smile &smile) {
    m_smile = smile;
    m_smile_isSet = true;
}

bool OAIFaceDetection_Face::is_smile_Set() const{
    return m_smile_isSet;
}

bool OAIFaceDetection_Face::is_smile_Valid() const{
    return m_smile_isValid;
}

OAIFaceDetail_Eyeglasses OAIFaceDetection_Face::getEyeglasses() const {
    return m_eyeglasses;
}
void OAIFaceDetection_Face::setEyeglasses(const OAIFaceDetail_Eyeglasses &eyeglasses) {
    m_eyeglasses = eyeglasses;
    m_eyeglasses_isSet = true;
}

bool OAIFaceDetection_Face::is_eyeglasses_Set() const{
    return m_eyeglasses_isSet;
}

bool OAIFaceDetection_Face::is_eyeglasses_Valid() const{
    return m_eyeglasses_isValid;
}

OAIFaceDetail_Sunglasses OAIFaceDetection_Face::getSunglasses() const {
    return m_sunglasses;
}
void OAIFaceDetection_Face::setSunglasses(const OAIFaceDetail_Sunglasses &sunglasses) {
    m_sunglasses = sunglasses;
    m_sunglasses_isSet = true;
}

bool OAIFaceDetection_Face::is_sunglasses_Set() const{
    return m_sunglasses_isSet;
}

bool OAIFaceDetection_Face::is_sunglasses_Valid() const{
    return m_sunglasses_isValid;
}

OAIFaceDetail_Gender OAIFaceDetection_Face::getGender() const {
    return m_gender;
}
void OAIFaceDetection_Face::setGender(const OAIFaceDetail_Gender &gender) {
    m_gender = gender;
    m_gender_isSet = true;
}

bool OAIFaceDetection_Face::is_gender_Set() const{
    return m_gender_isSet;
}

bool OAIFaceDetection_Face::is_gender_Valid() const{
    return m_gender_isValid;
}

OAIFaceDetail_Beard OAIFaceDetection_Face::getBeard() const {
    return m_beard;
}
void OAIFaceDetection_Face::setBeard(const OAIFaceDetail_Beard &beard) {
    m_beard = beard;
    m_beard_isSet = true;
}

bool OAIFaceDetection_Face::is_beard_Set() const{
    return m_beard_isSet;
}

bool OAIFaceDetection_Face::is_beard_Valid() const{
    return m_beard_isValid;
}

OAIFaceDetail_Mustache OAIFaceDetection_Face::getMustache() const {
    return m_mustache;
}
void OAIFaceDetection_Face::setMustache(const OAIFaceDetail_Mustache &mustache) {
    m_mustache = mustache;
    m_mustache_isSet = true;
}

bool OAIFaceDetection_Face::is_mustache_Set() const{
    return m_mustache_isSet;
}

bool OAIFaceDetection_Face::is_mustache_Valid() const{
    return m_mustache_isValid;
}

OAIFaceDetail_EyesOpen OAIFaceDetection_Face::getEyesOpen() const {
    return m_eyes_open;
}
void OAIFaceDetection_Face::setEyesOpen(const OAIFaceDetail_EyesOpen &eyes_open) {
    m_eyes_open = eyes_open;
    m_eyes_open_isSet = true;
}

bool OAIFaceDetection_Face::is_eyes_open_Set() const{
    return m_eyes_open_isSet;
}

bool OAIFaceDetection_Face::is_eyes_open_Valid() const{
    return m_eyes_open_isValid;
}

OAIFaceDetail_MouthOpen OAIFaceDetection_Face::getMouthOpen() const {
    return m_mouth_open;
}
void OAIFaceDetection_Face::setMouthOpen(const OAIFaceDetail_MouthOpen &mouth_open) {
    m_mouth_open = mouth_open;
    m_mouth_open_isSet = true;
}

bool OAIFaceDetection_Face::is_mouth_open_Set() const{
    return m_mouth_open_isSet;
}

bool OAIFaceDetection_Face::is_mouth_open_Valid() const{
    return m_mouth_open_isValid;
}

QList OAIFaceDetection_Face::getEmotions() const {
    return m_emotions;
}
void OAIFaceDetection_Face::setEmotions(const QList &emotions) {
    m_emotions = emotions;
    m_emotions_isSet = true;
}

bool OAIFaceDetection_Face::is_emotions_Set() const{
    return m_emotions_isSet;
}

bool OAIFaceDetection_Face::is_emotions_Valid() const{
    return m_emotions_isValid;
}

QList OAIFaceDetection_Face::getLandmarks() const {
    return m_landmarks;
}
void OAIFaceDetection_Face::setLandmarks(const QList &landmarks) {
    m_landmarks = landmarks;
    m_landmarks_isSet = true;
}

bool OAIFaceDetection_Face::is_landmarks_Set() const{
    return m_landmarks_isSet;
}

bool OAIFaceDetection_Face::is_landmarks_Valid() const{
    return m_landmarks_isValid;
}

OAIFaceDetail_Pose OAIFaceDetection_Face::getPose() const {
    return m_pose;
}
void OAIFaceDetection_Face::setPose(const OAIFaceDetail_Pose &pose) {
    m_pose = pose;
    m_pose_isSet = true;
}

bool OAIFaceDetection_Face::is_pose_Set() const{
    return m_pose_isSet;
}

bool OAIFaceDetection_Face::is_pose_Valid() const{
    return m_pose_isValid;
}

OAIFaceDetail_Quality OAIFaceDetection_Face::getQuality() const {
    return m_quality;
}
void OAIFaceDetection_Face::setQuality(const OAIFaceDetail_Quality &quality) {
    m_quality = quality;
    m_quality_isSet = true;
}

bool OAIFaceDetection_Face::is_quality_Set() const{
    return m_quality_isSet;
}

bool OAIFaceDetection_Face::is_quality_Valid() const{
    return m_quality_isValid;
}

float OAIFaceDetection_Face::getConfidence() const {
    return m_confidence;
}
void OAIFaceDetection_Face::setConfidence(const float &confidence) {
    m_confidence = confidence;
    m_confidence_isSet = true;
}

bool OAIFaceDetection_Face::is_confidence_Set() const{
    return m_confidence_isSet;
}

bool OAIFaceDetection_Face::is_confidence_Valid() const{
    return m_confidence_isValid;
}

OAIFaceDetail_FaceOccluded OAIFaceDetection_Face::getFaceOccluded() const {
    return m_face_occluded;
}
void OAIFaceDetection_Face::setFaceOccluded(const OAIFaceDetail_FaceOccluded &face_occluded) {
    m_face_occluded = face_occluded;
    m_face_occluded_isSet = true;
}

bool OAIFaceDetection_Face::is_face_occluded_Set() const{
    return m_face_occluded_isSet;
}

bool OAIFaceDetection_Face::is_face_occluded_Valid() const{
    return m_face_occluded_isValid;
}

OAIFaceDetail_EyeDirection OAIFaceDetection_Face::getEyeDirection() const {
    return m_eye_direction;
}
void OAIFaceDetection_Face::setEyeDirection(const OAIFaceDetail_EyeDirection &eye_direction) {
    m_eye_direction = eye_direction;
    m_eye_direction_isSet = true;
}

bool OAIFaceDetection_Face::is_eye_direction_Set() const{
    return m_eye_direction_isSet;
}

bool OAIFaceDetection_Face::is_eye_direction_Valid() const{
    return m_eye_direction_isValid;
}

bool OAIFaceDetection_Face::isSet() const {
...
bool OAIFaceDetection_Face::isValid() const {
