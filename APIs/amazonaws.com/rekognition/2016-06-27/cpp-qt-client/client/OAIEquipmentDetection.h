...
#ifndef OAIEquipmentDetection_H
#define OAIEquipmentDetection_H

#include <QJsonObject>

#include "OAIEquipmentDetection_BoundingBox.h"
...
namespace OpenAPI {
class OAIEquipmentDetection_BoundingBox;
class OAIEquipmentDetection_CoversBodyPart;

class OAIEquipmentDetection : public OAIObject {
public:
    OAIEquipmentDetection();
    OAIEquipmentDetection(QString json);
    ~OAIEquipmentDetection() override;
    ...
    OAIEquipmentDetection_BoundingBox getBoundingBox() const;
    void setBoundingBox(const OAIEquipmentDetection_BoundingBox &bounding_box);
    ...
    OAIProtectiveEquipmentType getType() const;
    void setType(const OAIProtectiveEquipmentType &type);
    bool is_type_Set() const;
    bool is_type_Valid() const;

    OAIEquipmentDetection_CoversBodyPart getCoversBodyPart() const;
    void setCoversBodyPart(const OAIEquipmentDetection_CoversBodyPart &covers_body_part);
    bool is_covers_body_part_Set() const;
    bool is_covers_body_part_Valid() const;
...
private:
    ...
    OAIEquipmentDetection_BoundingBox m_bounding_box;
    ...
    OAIProtectiveEquipmentType m_type;
    bool m_type_isSet;
    bool m_type_isValid;

    OAIEquipmentDetection_CoversBodyPart m_covers_body_part;
    bool m_covers_body_part_isSet;
    bool m_covers_body_part_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIEquipmentDetection)

#endif // OAIEquipmentDetection_H
