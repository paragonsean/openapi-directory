...
#include "OAIDescribeProjectsRequest.h"
...
OAIDescribeProjectsRequest::OAIDescribeProjectsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeProjectsRequest::OAIDescribeProjectsRequest() {
    this->initializeModel();
}

OAIDescribeProjectsRequest::~OAIDescribeProjectsRequest() {}

void OAIDescribeProjectsRequest::initializeModel() {
...
void OAIDescribeProjectsRequest::fromJson(QString jsonString) {
...
void OAIDescribeProjectsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIDescribeProjectsRequest::asJson() const {
...
QJsonObject OAIDescribeProjectsRequest::asJsonObject() const {
    QJsonObject obj;
    ...
    if (m_project_names.isSet()) {
        obj.insert(QString("ProjectNames"), ::OpenAPI::toJsonValue(m_project_names));
    }
    return obj;
}

QString OAIDescribeProjectsRequest::getNextToken() const {
    return m_next_token;
}
void OAIDescribeProjectsRequest::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeProjectsRequest::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeProjectsRequest::is_next_token_Valid() const{
    return m_next_token_isValid;
}

qint32 OAIDescribeProjectsRequest::getMaxResults() const {
    return m_max_results;
}
void OAIDescribeProjectsRequest::setMaxResults(const qint32 &max_results) {
    m_max_results = max_results;
    m_max_results_isSet = true;
}

bool OAIDescribeProjectsRequest::is_max_results_Set() const{
    return m_max_results_isSet;
}

bool OAIDescribeProjectsRequest::is_max_results_Valid() const{
    return m_max_results_isValid;
}

QList OAIDescribeProjectsRequest::getProjectNames() const {
    return m_project_names;
}
void OAIDescribeProjectsRequest::setProjectNames(const QList &project_names) {
    m_project_names = project_names;
    m_project_names_isSet = true;
}

bool OAIDescribeProjectsRequest::is_project_names_Set() const{
    return m_project_names_isSet;
}

bool OAIDescribeProjectsRequest::is_project_names_Valid() const{
    return m_project_names_isValid;
}

bool OAIDescribeProjectsRequest::isSet() const {
...
bool OAIDescribeProjectsRequest::isValid() const {
