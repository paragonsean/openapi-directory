...
OAIFaceMatch::OAIFaceMatch(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIFaceMatch::OAIFaceMatch() {
    this->initializeModel();
}

OAIFaceMatch::~OAIFaceMatch() {}

void OAIFaceMatch::initializeModel() {
...
void OAIFaceMatch::fromJson(QString jsonString) {
...
void OAIFaceMatch::fromJsonObject(QJsonObject json) {
...
QString OAIFaceMatch::asJson() const {
...
QJsonObject OAIFaceMatch::asJsonObject() const {
    QJsonObject obj;
...
float OAIFaceMatch::getSimilarity() const {
    return m_similarity;
}
void OAIFaceMatch::setSimilarity(const float &similarity) {
    m_similarity = similarity;
    m_similarity_isSet = true;
}

bool OAIFaceMatch::is_similarity_Set() const{
    return m_similarity_isSet;
}

bool OAIFaceMatch::is_similarity_Valid() const{
    return m_similarity_isValid;
}

OAIFaceMatch_Face OAIFaceMatch::getFace() const {
    return m_face;
}
void OAIFaceMatch::setFace(const OAIFaceMatch_Face &face) {
    m_face = face;
    m_face_isSet = true;
}

bool OAIFaceMatch::is_face_Set() const{
    return m_face_isSet;
}

bool OAIFaceMatch::is_face_Valid() const{
    return m_face_isValid;
}

bool OAIFaceMatch::isSet() const {
...
bool OAIFaceMatch::isValid() const {
