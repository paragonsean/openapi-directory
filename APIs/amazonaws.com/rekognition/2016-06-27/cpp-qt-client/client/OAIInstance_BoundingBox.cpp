...
#include "OAIInstance_BoundingBox.h"
...
OAIInstance_BoundingBox::OAIInstance_BoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInstance_BoundingBox::OAIInstance_BoundingBox() {
    this->initializeModel();
}

OAIInstance_BoundingBox::~OAIInstance_BoundingBox() {}

void OAIInstance_BoundingBox::initializeModel() {
...
void OAIInstance_BoundingBox::fromJson(QString jsonString) {
...
void OAIInstance_BoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAIInstance_BoundingBox::asJson() const {
...
QJsonObject OAIInstance_BoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAIInstance_BoundingBox::getWidth() const {
    return m_width;
}
void OAIInstance_BoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAIInstance_BoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAIInstance_BoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAIInstance_BoundingBox::getHeight() const {
    return m_height;
}
void OAIInstance_BoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAIInstance_BoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAIInstance_BoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAIInstance_BoundingBox::getLeft() const {
    return m_left;
}
void OAIInstance_BoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAIInstance_BoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAIInstance_BoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAIInstance_BoundingBox::getTop() const {
    return m_top;
}
void OAIInstance_BoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAIInstance_BoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAIInstance_BoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAIInstance_BoundingBox::isSet() const {
...
bool OAIInstance_BoundingBox::isValid() const {
