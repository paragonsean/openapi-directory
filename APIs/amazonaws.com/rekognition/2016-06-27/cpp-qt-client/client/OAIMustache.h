...
#ifndef OAIMustache_H
#define OAIMustache_H
...
class OAIMustache : public OAIObject {
public:
    OAIMustache();
    OAIMustache(QString json);
    ~OAIMustache() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMustache)
