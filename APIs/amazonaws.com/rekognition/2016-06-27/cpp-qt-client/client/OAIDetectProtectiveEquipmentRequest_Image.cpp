...
#include "OAIDetectProtectiveEquipmentRequest_Image.h"
...
OAIDetectProtectiveEquipmentRequest_Image::OAIDetectProtectiveEquipmentRequest_Image(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectProtectiveEquipmentRequest_Image::OAIDetectProtectiveEquipmentRequest_Image() {
    this->initializeModel();
}

OAIDetectProtectiveEquipmentRequest_Image::~OAIDetectProtectiveEquipmentRequest_Image() {}

void OAIDetectProtectiveEquipmentRequest_Image::initializeModel() {
...
void OAIDetectProtectiveEquipmentRequest_Image::fromJson(QString jsonString) {
...
void OAIDetectProtectiveEquipmentRequest_Image::fromJsonObject(QJsonObject json) {
...
QString OAIDetectProtectiveEquipmentRequest_Image::asJson() const {
...
QJsonObject OAIDetectProtectiveEquipmentRequest_Image::asJsonObject() const {
    QJsonObject obj;
    if (m_bytes_isSet) {
...
QString OAIDetectProtectiveEquipmentRequest_Image::getBytes() const {
    return m_bytes;
}
void OAIDetectProtectiveEquipmentRequest_Image::setBytes(const QString &bytes) {
    m_bytes = bytes;
    m_bytes_isSet = true;
}

bool OAIDetectProtectiveEquipmentRequest_Image::is_bytes_Set() const{
    return m_bytes_isSet;
}

bool OAIDetectProtectiveEquipmentRequest_Image::is_bytes_Valid() const{
    return m_bytes_isValid;
}

OAIImage_S3Object OAIDetectProtectiveEquipmentRequest_Image::getS3Object() const {
    return m_s3_object;
}
void OAIDetectProtectiveEquipmentRequest_Image::setS3Object(const OAIImage_S3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIDetectProtectiveEquipmentRequest_Image::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIDetectProtectiveEquipmentRequest_Image::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIDetectProtectiveEquipmentRequest_Image::isSet() const {
...
bool OAIDetectProtectiveEquipmentRequest_Image::isValid() const {
