...
/*
 * OAICompareFacesRequest_TargetImage.h
 *
 * 
 */

#ifndef OAICompareFacesRequest_TargetImage_H
#define OAICompareFacesRequest_TargetImage_H
...
class OAICompareFacesRequest_TargetImage : public OAIObject {
public:
    OAICompareFacesRequest_TargetImage();
    OAICompareFacesRequest_TargetImage(QString json);
    ~OAICompareFacesRequest_TargetImage() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICompareFacesRequest_TargetImage)

#endif // OAICompareFacesRequest_TargetImage_H
