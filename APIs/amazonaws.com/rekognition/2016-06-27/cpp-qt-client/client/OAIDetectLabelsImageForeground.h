...
/*
 * OAIDetectLabelsImageForeground.h
 *
 * The foreground of the image with regard to image quality and dominant colors.
 */

#ifndef OAIDetectLabelsImageForeground_H
#define OAIDetectLabelsImageForeground_H
...
class OAIDetectLabelsImageForeground : public OAIObject {
public:
    OAIDetectLabelsImageForeground();
    OAIDetectLabelsImageForeground(QString json);
    ~OAIDetectLabelsImageForeground() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectLabelsImageForeground)

#endif // OAIDetectLabelsImageForeground_H
