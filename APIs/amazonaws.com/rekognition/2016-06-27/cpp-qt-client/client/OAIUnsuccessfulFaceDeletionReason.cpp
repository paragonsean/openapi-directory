...
#include "OAIUnsuccessfulFaceDeletionReason.h"
...
OAIUnsuccessfulFaceDeletionReason::OAIUnsuccessfulFaceDeletionReason(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIUnsuccessfulFaceDeletionReason::OAIUnsuccessfulFaceDeletionReason() {
    this->initializeModel();
}

OAIUnsuccessfulFaceDeletionReason::~OAIUnsuccessfulFaceDeletionReason() {}

void OAIUnsuccessfulFaceDeletionReason::initializeModel() {

    m_value_isSet = false;
    m_value_isValid = false;
    m_value = eOAIUnsuccessfulFaceDeletionReason::INVALID_VALUE_OPENAPI_GENERATED;
}

void OAIUnsuccessfulFaceDeletionReason::fromJson(QString jsonString) {
    
    if ( jsonString.compare("ASSOCIATED_TO_AN_EXISTING_USER", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceDeletionReason::ASSOCIATED_TO_AN_EXISTING_USER;
        m_value_isSet = m_value_isValid = true;
    }
    else if ( jsonString.compare("FACE_NOT_FOUND", Qt::CaseInsensitive) == 0) {
        m_value = eOAIUnsuccessfulFaceDeletionReason::FACE_NOT_FOUND;
        m_value_isSet = m_value_isValid = true;
    }
}

void OAIUnsuccessfulFaceDeletionReason::fromJsonValue(QJsonValue json) {
fromJson(json.toString());
}

QString OAIUnsuccessfulFaceDeletionReason::asJson() const {
    
    QString val;
    switch (m_value){
        case eOAIUnsuccessfulFaceDeletionReason::ASSOCIATED_TO_AN_EXISTING_USER:
            val = "ASSOCIATED_TO_AN_EXISTING_USER";
            break;
        case eOAIUnsuccessfulFaceDeletionReason::FACE_NOT_FOUND:
            val = "FACE_NOT_FOUND";
            break;
        default:
            break;
...
QJsonValue OAIUnsuccessfulFaceDeletionReason::asJsonValue() const {
    
    return QJsonValue(asJson());
}


OAIUnsuccessfulFaceDeletionReason::eOAIUnsuccessfulFaceDeletionReason OAIUnsuccessfulFaceDeletionReason::getValue() const {
    return m_value;
}

void OAIUnsuccessfulFaceDeletionReason::setValue(const OAIUnsuccessfulFaceDeletionReason::eOAIUnsuccessfulFaceDeletionReason& value){
    m_value = value;
    m_value_isSet = true;
}
bool OAIUnsuccessfulFaceDeletionReason::isSet() const {
    
    return m_value_isSet;
}

bool OAIUnsuccessfulFaceDeletionReason::isValid() const {
