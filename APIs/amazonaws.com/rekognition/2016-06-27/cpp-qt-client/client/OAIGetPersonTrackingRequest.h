...
/*
 * OAIGetPersonTrackingRequest.h
 *
 * 
 */

#ifndef OAIGetPersonTrackingRequest_H
#define OAIGetPersonTrackingRequest_H

#include <QJsonObject>

#include "OAIPersonTrackingSortBy.h"
#include <QString>
...
class OAIGetPersonTrackingRequest : public OAIObject {
public:
    OAIGetPersonTrackingRequest();
    OAIGetPersonTrackingRequest(QString json);
    ~OAIGetPersonTrackingRequest() override;
    ...
    OAIPersonTrackingSortBy getSortBy() const;
    void setSortBy(const OAIPersonTrackingSortBy &sort_by);
...
private:
    ...
    OAIPersonTrackingSortBy m_sort_by;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetPersonTrackingRequest)

#endif // OAIGetPersonTrackingRequest_H
