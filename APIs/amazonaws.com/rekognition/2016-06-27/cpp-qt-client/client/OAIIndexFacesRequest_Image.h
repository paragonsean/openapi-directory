...
/*
 * OAIIndexFacesRequest_Image.h
 *
 * 
 */

#ifndef OAIIndexFacesRequest_Image_H
#define OAIIndexFacesRequest_Image_H
...
class OAIIndexFacesRequest_Image : public OAIObject {
public:
    OAIIndexFacesRequest_Image();
    OAIIndexFacesRequest_Image(QString json);
    ~OAIIndexFacesRequest_Image() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIndexFacesRequest_Image)

#endif // OAIIndexFacesRequest_Image_H
