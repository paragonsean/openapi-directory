...
#include "OAIDescribeProjectsResponse.h"
...
OAIDescribeProjectsResponse::OAIDescribeProjectsResponse(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDescribeProjectsResponse::OAIDescribeProjectsResponse() {
    this->initializeModel();
}

OAIDescribeProjectsResponse::~OAIDescribeProjectsResponse() {}

void OAIDescribeProjectsResponse::initializeModel() {

    m_project_descriptions_isSet = false;
    m_project_descriptions_isValid = false;

    m_next_token_isSet = false;
    m_next_token_isValid = false;
}

void OAIDescribeProjectsResponse::fromJson(QString jsonString) {
...
void OAIDescribeProjectsResponse::fromJsonObject(QJsonObject json) {

    m_project_descriptions_isValid = ::OpenAPI::fromJsonValue(m_project_descriptions, json[QString("ProjectDescriptions")]);
    m_project_descriptions_isSet = !json[QString("ProjectDescriptions")].isNull() && m_project_descriptions_isValid;

    m_next_token_isValid = ::OpenAPI::fromJsonValue(m_next_token, json[QString("NextToken")]);
    m_next_token_isSet = !json[QString("NextToken")].isNull() && m_next_token_isValid;
}

QString OAIDescribeProjectsResponse::asJson() const {
...
QJsonObject OAIDescribeProjectsResponse::asJsonObject() const {
    QJsonObject obj;
    if (m_project_descriptions.isSet()) {
        obj.insert(QString("ProjectDescriptions"), ::OpenAPI::toJsonValue(m_project_descriptions));
    }
...
QList OAIDescribeProjectsResponse::getProjectDescriptions() const {
    return m_project_descriptions;
}
void OAIDescribeProjectsResponse::setProjectDescriptions(const QList &project_descriptions) {
    m_project_descriptions = project_descriptions;
    m_project_descriptions_isSet = true;
}

bool OAIDescribeProjectsResponse::is_project_descriptions_Set() const{
    return m_project_descriptions_isSet;
}

bool OAIDescribeProjectsResponse::is_project_descriptions_Valid() const{
    return m_project_descriptions_isValid;
}

QString OAIDescribeProjectsResponse::getNextToken() const {
    return m_next_token;
}
void OAIDescribeProjectsResponse::setNextToken(const QString &next_token) {
    m_next_token = next_token;
    m_next_token_isSet = true;
}

bool OAIDescribeProjectsResponse::is_next_token_Set() const{
    return m_next_token_isSet;
}

bool OAIDescribeProjectsResponse::is_next_token_Valid() const{
    return m_next_token_isValid;
}

bool OAIDescribeProjectsResponse::isSet() const {
...
bool OAIDescribeProjectsResponse::isValid() const {
