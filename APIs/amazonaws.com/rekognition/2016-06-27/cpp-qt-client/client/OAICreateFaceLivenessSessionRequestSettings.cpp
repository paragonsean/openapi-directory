...
#include "OAICreateFaceLivenessSessionRequestSettings.h"
...
OAICreateFaceLivenessSessionRequestSettings::OAICreateFaceLivenessSessionRequestSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateFaceLivenessSessionRequestSettings::OAICreateFaceLivenessSessionRequestSettings() {
    this->initializeModel();
}

OAICreateFaceLivenessSessionRequestSettings::~OAICreateFaceLivenessSessionRequestSettings() {}

void OAICreateFaceLivenessSessionRequestSettings::initializeModel() {
...
void OAICreateFaceLivenessSessionRequestSettings::fromJson(QString jsonString) {
...
void OAICreateFaceLivenessSessionRequestSettings::fromJsonObject(QJsonObject json) {
...
QString OAICreateFaceLivenessSessionRequestSettings::asJson() const {
...
QJsonObject OAICreateFaceLivenessSessionRequestSettings::asJsonObject() const {
    QJsonObject obj;
...
OAICreateFaceLivenessSessionRequestSettings_OutputConfig OAICreateFaceLivenessSessionRequestSettings::getOutputConfig() const {
    return m_output_config;
}
void OAICreateFaceLivenessSessionRequestSettings::setOutputConfig(const OAICreateFaceLivenessSessionRequestSettings_OutputConfig &output_config) {
    m_output_config = output_config;
    m_output_config_isSet = true;
}

bool OAICreateFaceLivenessSessionRequestSettings::is_output_config_Set() const{
    return m_output_config_isSet;
}

bool OAICreateFaceLivenessSessionRequestSettings::is_output_config_Valid() const{
    return m_output_config_isValid;
}

qint32 OAICreateFaceLivenessSessionRequestSettings::getAuditImagesLimit() const {
    return m_audit_images_limit;
}
void OAICreateFaceLivenessSessionRequestSettings::setAuditImagesLimit(const qint32 &audit_images_limit) {
    m_audit_images_limit = audit_images_limit;
    m_audit_images_limit_isSet = true;
}

bool OAICreateFaceLivenessSessionRequestSettings::is_audit_images_limit_Set() const{
    return m_audit_images_limit_isSet;
}

bool OAICreateFaceLivenessSessionRequestSettings::is_audit_images_limit_Valid() const{
    return m_audit_images_limit_isValid;
}

bool OAICreateFaceLivenessSessionRequestSettings::isSet() const {
...
bool OAICreateFaceLivenessSessionRequestSettings::isValid() const {
