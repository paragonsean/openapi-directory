...
OAIStreamProcessor::OAIStreamProcessor(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessor::OAIStreamProcessor() {
    this->initializeModel();
}

OAIStreamProcessor::~OAIStreamProcessor() {}

void OAIStreamProcessor::initializeModel() {
...
void OAIStreamProcessor::fromJson(QString jsonString) {
...
void OAIStreamProcessor::fromJsonObject(QJsonObject json) {
...
QString OAIStreamProcessor::asJson() const {
...
QJsonObject OAIStreamProcessor::asJsonObject() const {
    QJsonObject obj;
    if (m_name_isSet) {
...
QString OAIStreamProcessor::getName() const {
    return m_name;
}
void OAIStreamProcessor::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIStreamProcessor::is_name_Set() const{
    return m_name_isSet;
}

bool OAIStreamProcessor::is_name_Valid() const{
    return m_name_isValid;
}

OAIStreamProcessorStatus OAIStreamProcessor::getStatus() const {
    return m_status;
}
void OAIStreamProcessor::setStatus(const OAIStreamProcessorStatus &status) {
    m_status = status;
    m_status_isSet = true;
}

bool OAIStreamProcessor::is_status_Set() const{
    return m_status_isSet;
}

bool OAIStreamProcessor::is_status_Valid() const{
    return m_status_isValid;
}

bool OAIStreamProcessor::isSet() const {
...
bool OAIStreamProcessor::isValid() const {
