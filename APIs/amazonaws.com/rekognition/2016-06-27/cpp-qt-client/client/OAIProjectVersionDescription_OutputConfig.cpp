...
#include "OAIProjectVersionDescription_OutputConfig.h"
...
OAIProjectVersionDescription_OutputConfig::OAIProjectVersionDescription_OutputConfig(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIProjectVersionDescription_OutputConfig::OAIProjectVersionDescription_OutputConfig() {
    this->initializeModel();
}

OAIProjectVersionDescription_OutputConfig::~OAIProjectVersionDescription_OutputConfig() {}

void OAIProjectVersionDescription_OutputConfig::initializeModel() {
...
void OAIProjectVersionDescription_OutputConfig::fromJson(QString jsonString) {
...
void OAIProjectVersionDescription_OutputConfig::fromJsonObject(QJsonObject json) {
...
QString OAIProjectVersionDescription_OutputConfig::asJson() const {
...
QJsonObject OAIProjectVersionDescription_OutputConfig::asJsonObject() const {
    QJsonObject obj;
...
QString OAIProjectVersionDescription_OutputConfig::getS3Bucket() const {
    return m_s3_bucket;
}
void OAIProjectVersionDescription_OutputConfig::setS3Bucket(const QString &s3_bucket) {
    m_s3_bucket = s3_bucket;
    m_s3_bucket_isSet = true;
}

bool OAIProjectVersionDescription_OutputConfig::is_s3_bucket_Set() const{
    return m_s3_bucket_isSet;
}

bool OAIProjectVersionDescription_OutputConfig::is_s3_bucket_Valid() const{
    return m_s3_bucket_isValid;
}

QString OAIProjectVersionDescription_OutputConfig::getS3KeyPrefix() const {
    return m_s3_key_prefix;
}
void OAIProjectVersionDescription_OutputConfig::setS3KeyPrefix(const QString &s3_key_prefix) {
    m_s3_key_prefix = s3_key_prefix;
    m_s3_key_prefix_isSet = true;
}

bool OAIProjectVersionDescription_OutputConfig::is_s3_key_prefix_Set() const{
    return m_s3_key_prefix_isSet;
}

bool OAIProjectVersionDescription_OutputConfig::is_s3_key_prefix_Valid() const{
    return m_s3_key_prefix_isValid;
}

bool OAIProjectVersionDescription_OutputConfig::isSet() const {
...
bool OAIProjectVersionDescription_OutputConfig::isValid() const {
