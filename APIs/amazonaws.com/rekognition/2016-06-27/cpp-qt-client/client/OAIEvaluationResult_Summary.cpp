...
#include "OAIEvaluationResult_Summary.h"
...
OAIEvaluationResult_Summary::OAIEvaluationResult_Summary(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEvaluationResult_Summary::OAIEvaluationResult_Summary() {
    this->initializeModel();
}

OAIEvaluationResult_Summary::~OAIEvaluationResult_Summary() {}

void OAIEvaluationResult_Summary::initializeModel() {

    m_s3_object_isSet = false;
    m_s3_object_isValid = false;
}

void OAIEvaluationResult_Summary::fromJson(QString jsonString) {
...
void OAIEvaluationResult_Summary::fromJsonObject(QJsonObject json) {
...
QString OAIEvaluationResult_Summary::asJson() const {
...
QJsonObject OAIEvaluationResult_Summary::asJsonObject() const {
    QJsonObject obj;
...
OAIS3Object OAIEvaluationResult_Summary::getS3Object() const {
    return m_s3_object;
}
void OAIEvaluationResult_Summary::setS3Object(const OAIS3Object &s3_object) {
    m_s3_object = s3_object;
    m_s3_object_isSet = true;
}

bool OAIEvaluationResult_Summary::is_s3_object_Set() const{
    return m_s3_object_isSet;
}

bool OAIEvaluationResult_Summary::is_s3_object_Valid() const{
    return m_s3_object_isValid;
}

bool OAIEvaluationResult_Summary::isSet() const {
...
bool OAIEvaluationResult_Summary::isValid() const {
