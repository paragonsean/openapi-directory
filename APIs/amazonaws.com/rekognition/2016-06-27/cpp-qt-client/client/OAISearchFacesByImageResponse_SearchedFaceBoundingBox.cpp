...
#include "OAISearchFacesByImageResponse_SearchedFaceBoundingBox.h"
...
OAISearchFacesByImageResponse_SearchedFaceBoundingBox::OAISearchFacesByImageResponse_SearchedFaceBoundingBox(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISearchFacesByImageResponse_SearchedFaceBoundingBox::OAISearchFacesByImageResponse_SearchedFaceBoundingBox() {
    this->initializeModel();
}

OAISearchFacesByImageResponse_SearchedFaceBoundingBox::~OAISearchFacesByImageResponse_SearchedFaceBoundingBox() {}

void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::initializeModel() {
...
void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::fromJson(QString jsonString) {
...
void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::fromJsonObject(QJsonObject json) {
...
QString OAISearchFacesByImageResponse_SearchedFaceBoundingBox::asJson() const {
...
QJsonObject OAISearchFacesByImageResponse_SearchedFaceBoundingBox::asJsonObject() const {
    QJsonObject obj;
    if (m_width_isSet) {
...
float OAISearchFacesByImageResponse_SearchedFaceBoundingBox::getWidth() const {
    return m_width;
}
void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::setWidth(const float &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_width_Set() const{
    return m_width_isSet;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_width_Valid() const{
    return m_width_isValid;
}

float OAISearchFacesByImageResponse_SearchedFaceBoundingBox::getHeight() const {
    return m_height;
}
void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::setHeight(const float &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_height_Set() const{
    return m_height_isSet;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_height_Valid() const{
    return m_height_isValid;
}

float OAISearchFacesByImageResponse_SearchedFaceBoundingBox::getLeft() const {
    return m_left;
}
void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::setLeft(const float &left) {
    m_left = left;
    m_left_isSet = true;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_left_Set() const{
    return m_left_isSet;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_left_Valid() const{
    return m_left_isValid;
}

float OAISearchFacesByImageResponse_SearchedFaceBoundingBox::getTop() const {
    return m_top;
}
void OAISearchFacesByImageResponse_SearchedFaceBoundingBox::setTop(const float &top) {
    m_top = top;
    m_top_isSet = true;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_top_Set() const{
    return m_top_isSet;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::is_top_Valid() const{
    return m_top_isValid;
}

bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::isSet() const {
...
bool OAISearchFacesByImageResponse_SearchedFaceBoundingBox::isValid() const {
