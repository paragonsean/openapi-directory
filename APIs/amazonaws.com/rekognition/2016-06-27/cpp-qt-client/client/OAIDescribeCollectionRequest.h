...
/*
 * OAIDescribeCollectionRequest.h
 *
 * 
 */

#ifndef OAIDescribeCollectionRequest_H
#define OAIDescribeCollectionRequest_H
...
class OAIDescribeCollectionRequest : public OAIObject {
public:
    OAIDescribeCollectionRequest();
    OAIDescribeCollectionRequest(QString json);
    ~OAIDescribeCollectionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDescribeCollectionRequest)

#endif // OAIDescribeCollectionRequest_H
