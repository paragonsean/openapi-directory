...
#ifndef OAICelebrity_H
#define OAICelebrity_H

#include <QJsonObject>

#include "OAICelebrity_Face.h"
#include "OAIKnownGender.h"
#include <QList>
#include <QString>
...
namespace OpenAPI {
class OAICelebrity_Face;
class OAIKnownGender;

class OAICelebrity : public OAIObject {
public:
    OAICelebrity();
    OAICelebrity(QString json);
    ~OAICelebrity() override;
    ...
    OAICelebrity_Face getFace() const;
    void setFace(const OAICelebrity_Face &face);
    ...
    OAIKnownGender getKnownGender() const;
    void setKnownGender(const OAIKnownGender &known_gender);
    bool is_known_gender_Set() const;
    bool is_known_gender_Valid() const;
...
private:
    ...
    OAIKnownGender m_known_gender;
    bool m_known_gender_isSet;
    bool m_known_gender_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAICelebrity)

#endif // OAICelebrity_H
