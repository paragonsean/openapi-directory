...
/*
 * OAIStartContentModerationRequest.h
 *
 * 
 */

#ifndef OAIStartContentModerationRequest_H
#define OAIStartContentModerationRequest_H

#include <QJsonObject>

#include "OAIStartContentModerationRequest_NotificationChannel.h"
#include "OAIStartContentModerationRequest_Video.h"
#include <QString>
...
namespace OpenAPI {
class OAIStartContentModerationRequest_Video;
class OAIStartContentModerationRequest_NotificationChannel;

class OAIStartContentModerationRequest : public OAIObject {
public:
    OAIStartContentModerationRequest();
    OAIStartContentModerationRequest(QString json);
    ~OAIStartContentModerationRequest() override;
    ...
    OAIStartContentModerationRequest_Video getVideo() const;
    void setVideo(const OAIStartContentModerationRequest_Video &video);
    bool is_video_Set() const;
    bool is_video_Valid() const;

    float getMinConfidence() const;
    void setMinConfidence(const float &min_confidence);
    bool is_min_confidence_Set() const;
    bool is_min_confidence_Valid() const;
    ...
    OAIStartContentModerationRequest_NotificationChannel getNotificationChannel() const;
    void setNotificationChannel(const OAIStartContentModerationRequest_NotificationChannel &notification_channel);
...
private:
    ...
    OAIStartContentModerationRequest_Video m_video;
    bool m_video_isSet;
    bool m_video_isValid;

    float m_min_confidence;
    bool m_min_confidence_isSet;
    bool m_min_confidence_isValid;

    QString m_client_request_token;
    bool m_client_request_token_isSet;
    bool m_client_request_token_isValid;

    OAIStartContentModerationRequest_NotificationChannel m_notification_channel;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStartContentModerationRequest)

#endif // OAIStartContentModerationRequest_H
