...
/*
 * OAIGetFaceSearchRequest.h
 *
 * 
 */

#ifndef OAIGetFaceSearchRequest_H
#define OAIGetFaceSearchRequest_H

#include <QJsonObject>

#include "OAIFaceSearchSortBy.h"
#include <QString>
...
class OAIGetFaceSearchRequest : public OAIObject {
public:
    OAIGetFaceSearchRequest();
    OAIGetFaceSearchRequest(QString json);
    ~OAIGetFaceSearchRequest() override;
    ...
    OAIFaceSearchSortBy getSortBy() const;
    void setSortBy(const OAIFaceSearchSortBy &sort_by);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetFaceSearchRequest)

#endif // OAIGetFaceSearchRequest_H
