...
#include "OAIStreamProcessorSettingsForUpdate.h"
...
OAIStreamProcessorSettingsForUpdate::OAIStreamProcessorSettingsForUpdate(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStreamProcessorSettingsForUpdate::OAIStreamProcessorSettingsForUpdate() {
    this->initializeModel();
}

OAIStreamProcessorSettingsForUpdate::~OAIStreamProcessorSettingsForUpdate() {}

void OAIStreamProcessorSettingsForUpdate::initializeModel() {

    m_connected_home_for_update_isSet = false;
    m_connected_home_for_update_isValid = false;
}

void OAIStreamProcessorSettingsForUpdate::fromJson(QString jsonString) {
...
void OAIStreamProcessorSettingsForUpdate::fromJsonObject(QJsonObject json) {

    m_connected_home_for_update_isValid = ::OpenAPI::fromJsonValue(m_connected_home_for_update, json[QString("ConnectedHomeForUpdate")]);
    m_connected_home_for_update_isSet = !json[QString("ConnectedHomeForUpdate")].isNull() && m_connected_home_for_update_isValid;
}

QString OAIStreamProcessorSettingsForUpdate::asJson() const {
...
QJsonObject OAIStreamProcessorSettingsForUpdate::asJsonObject() const {
    QJsonObject obj;
    if (m_connected_home_for_update.isSet()) {
        obj.insert(QString("ConnectedHomeForUpdate"), ::OpenAPI::toJsonValue(m_connected_home_for_update));
    }
    return obj;
}

OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate OAIStreamProcessorSettingsForUpdate::getConnectedHomeForUpdate() const {
    return m_connected_home_for_update;
}
void OAIStreamProcessorSettingsForUpdate::setConnectedHomeForUpdate(const OAIStreamProcessorSettingsForUpdate_ConnectedHomeForUpdate &connected_home_for_update) {
    m_connected_home_for_update = connected_home_for_update;
    m_connected_home_for_update_isSet = true;
}

bool OAIStreamProcessorSettingsForUpdate::is_connected_home_for_update_Set() const{
    return m_connected_home_for_update_isSet;
}

bool OAIStreamProcessorSettingsForUpdate::is_connected_home_for_update_Valid() const{
    return m_connected_home_for_update_isValid;
}

bool OAIStreamProcessorSettingsForUpdate::isSet() const {
...
bool OAIStreamProcessorSettingsForUpdate::isValid() const {
