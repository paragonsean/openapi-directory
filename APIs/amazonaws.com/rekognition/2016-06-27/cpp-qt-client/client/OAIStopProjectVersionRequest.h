...
/*
 * OAIStopProjectVersionRequest.h
 *
 * 
 */

#ifndef OAIStopProjectVersionRequest_H
#define OAIStopProjectVersionRequest_H
...
class OAIStopProjectVersionRequest : public OAIObject {
public:
    OAIStopProjectVersionRequest();
    OAIStopProjectVersionRequest(QString json);
    ~OAIStopProjectVersionRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIStopProjectVersionRequest)

#endif // OAIStopProjectVersionRequest_H
