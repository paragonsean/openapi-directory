...
#include "OAIDetectLabelsImagePropertiesSettings.h"
...
OAIDetectLabelsImagePropertiesSettings::OAIDetectLabelsImagePropertiesSettings(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDetectLabelsImagePropertiesSettings::OAIDetectLabelsImagePropertiesSettings() {
    this->initializeModel();
}

OAIDetectLabelsImagePropertiesSettings::~OAIDetectLabelsImagePropertiesSettings() {}

void OAIDetectLabelsImagePropertiesSettings::initializeModel() {

    m_max_dominant_colors_isSet = false;
    m_max_dominant_colors_isValid = false;
}

void OAIDetectLabelsImagePropertiesSettings::fromJson(QString jsonString) {
...
void OAIDetectLabelsImagePropertiesSettings::fromJsonObject(QJsonObject json) {
...
QString OAIDetectLabelsImagePropertiesSettings::asJson() const {
...
QJsonObject OAIDetectLabelsImagePropertiesSettings::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIDetectLabelsImagePropertiesSettings::getMaxDominantColors() const {
    return m_max_dominant_colors;
}
void OAIDetectLabelsImagePropertiesSettings::setMaxDominantColors(const qint32 &max_dominant_colors) {
    m_max_dominant_colors = max_dominant_colors;
    m_max_dominant_colors_isSet = true;
}

bool OAIDetectLabelsImagePropertiesSettings::is_max_dominant_colors_Set() const{
    return m_max_dominant_colors_isSet;
}

bool OAIDetectLabelsImagePropertiesSettings::is_max_dominant_colors_Valid() const{
    return m_max_dominant_colors_isValid;
}

bool OAIDetectLabelsImagePropertiesSettings::isSet() const {
...
bool OAIDetectLabelsImagePropertiesSettings::isValid() const {
