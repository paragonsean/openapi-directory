...
/*
 * OAIListDatasetLabelsRequest.h
 *
 * 
 */

#ifndef OAIListDatasetLabelsRequest_H
#define OAIListDatasetLabelsRequest_H
...
class OAIListDatasetLabelsRequest : public OAIObject {
public:
    OAIListDatasetLabelsRequest();
    OAIListDatasetLabelsRequest(QString json);
    ~OAIListDatasetLabelsRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIListDatasetLabelsRequest)

#endif // OAIListDatasetLabelsRequest_H
