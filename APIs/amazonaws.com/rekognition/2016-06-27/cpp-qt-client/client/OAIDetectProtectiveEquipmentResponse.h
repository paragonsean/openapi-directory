...
/*
 * OAIDetectProtectiveEquipmentResponse.h
 *
 * 
 */

#ifndef OAIDetectProtectiveEquipmentResponse_H
#define OAIDetectProtectiveEquipmentResponse_H
...
namespace OpenAPI {
class OAIDetectProtectiveEquipmentResponse_Summary;

class OAIDetectProtectiveEquipmentResponse : public OAIObject {
public:
    OAIDetectProtectiveEquipmentResponse();
    OAIDetectProtectiveEquipmentResponse(QString json);
    ~OAIDetectProtectiveEquipmentResponse() override;
    ...
    QString getProtectiveEquipmentModelVersion() const;
    void setProtectiveEquipmentModelVersion(const QString &protective_equipment_model_version);
    bool is_protective_equipment_model_version_Set() const;
    bool is_protective_equipment_model_version_Valid() const;
    ...
    OAIDetectProtectiveEquipmentResponse_Summary getSummary() const;
    void setSummary(const OAIDetectProtectiveEquipmentResponse_Summary &summary);
...
private:
    ...
    QString m_protective_equipment_model_version;
    bool m_protective_equipment_model_version_isSet;
    bool m_protective_equipment_model_version_isValid;

    QList m_persons;
    bool m_persons_isSet;
    bool m_persons_isValid;

    OAIDetectProtectiveEquipmentResponse_Summary m_summary;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDetectProtectiveEquipmentResponse)

#endif // OAIDetectProtectiveEquipmentResponse_H
